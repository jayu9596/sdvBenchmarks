...
implementation {:origName "VPI1DataIn"} VPI1DataIn(actual_Extension_3: int) returns (Tmp_41: int)
{
  ...
  anon46_Else:
    ...
    call {:si_unique_call 57} sdv_17 := VPI1GetPhase(Extension_3, vslice_dummy_var_161);
  ...
  anon59_Else:
    ...
    call {:si_unique_call 58} vslice_dummy_var_7 := VPI1GetPhase(Extension_3, vslice_dummy_var_162);
  ...
  anon65_Else:
    ...
    call {:si_unique_call 64} Status_2 := VPI1ParallelRead(Extension_3, vslice_dummy_var_163, ChunkSize, BytesRead);
    assume {:nonnull} Extension_3 != 0;
    assume Extension_3 > 0;
...
implementation {:origName "VPI1DataOut"} VPI1DataOut(actual_Extension_7: int) returns (Tmp_67: int)
{
  ...
  anon28_Else:
    ...
    call {:si_unique_call 84} sdv_36 := VPI1GetPhase(Extension_7, vslice_dummy_var_164);
    goto anon29_Then, anon29_Else;
  ...
  L34:
    ...
    call {:si_unique_call 85} Status_4 := VPI1ParallelWrite(Extension_7, vslice_dummy_var_165, ChunkSize_1, BytesWritten);
    assume {:nonnull} Extension_7 != 0;
    assume Extension_7 > 0;
    goto anon34_Then, anon34_Else;
...
implementation {:origName "VPI1Command"} VPI1Command(actual_Extension_9: int) returns (Tmp_78: int)
{
  ...
  anon27_Else:
    ...
    call {:si_unique_call 93} sdv_41 := VPI1GetPhase(Extension_9, vslice_dummy_var_166);
    goto anon19_Then, anon19_Else;
...
implementation {:origName "VPI1ParallelWrite"} VPI1ParallelWrite(actual_Extension_13: int, actual_Buffer: int, actual_NumBytesToWrite: int, actual_BytesTransfered: int) returns (Tmp_122: int)
{
  ...
  L12:
    ...
    call {:si_unique_call 112} Status_8 := VPI1DataByteWrite(vslice_dummy_var_167, Buffer, NumBytesToWrite, BytesTransfered);
    goto L16;
...
implementation {:origName "VPI1ParallelRead"} VPI1ParallelRead(actual_Extension_16: int, actual_Buffer_1: int, actual_NumBytesToRead: int, actual_BytesTransfered_1: int) returns (Tmp_145: int)
{
  ...
  anon8_Else:
    ...
    call {:si_unique_call 117} Status_11 := VPI1DataNibbleRead(vslice_dummy_var_168, Buffer_1, NumBytesToRead, BytesTransfered_1);
    goto L16;
  ...
  anon9_Else:
    ...
    call {:si_unique_call 118} Status_11 := VPI1DataByteRead(vslice_dummy_var_169, Buffer_1, NumBytesToRead, BytesTransfered_1);
    goto L16;
...
procedure {:origName "sdv_RunAddDevice"} {:osmodel} sdv_RunAddDevice(actual_p1: int, actual_p2: int) returns (Tmp_180: int);
  modifies alloc;
  free ensures {:va_keep} Tmp_180 == -1073741637 || Tmp_180 == 0 || Tmp_180 == -1073741823 || Tmp_180 == -1073741824 || Tmp_180 == -1073741771 || Tmp_180 == -1073741670;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} false || old(t) == 1 || old(t) == 0;
  free ensures {:va_keep} alloc >= old(alloc);
  free ensures {:va_keep} false || t == 1 || t == 0;
...
implementation {:origName "sdv_RunAddDevice"} {:osmodel} sdv_RunAddDevice(actual_p1: int, actual_p2: int) returns (Tmp_180: int)
{
  var {:scalar} status: int;
  var {:pointer} p1: int;
  var {:pointer} p2: int;
  ...
  anon0:
    ...
    p2 := actual_p2;
    status := 0;
    call {:si_unique_call 130} sdv_stub_add_begin();
    call {:si_unique_call 131} status := PpaAddDevice(p1, p2);
    call {:si_unique_call 132} sdv_stub_add_end();
    Tmp_180 := status;
    return;
}
...
procedure {:origName "sdv_IoGetNextIrpStackLocation"} {:osmodel} sdv_IoGetNextIrpStackLocation(actual_pirp_1: int) returns (Tmp_182: int);
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} false || old(t) == 1 || old(t) == 0;
  free ensures {:va_keep} alloc >= old(alloc);
  free ensures {:va_keep} false || t == 1 || t == 0;
...
implementation {:origName "sdv_IoGetNextIrpStackLocation"} {:osmodel} sdv_IoGetNextIrpStackLocation(actual_pirp_1: int) returns (Tmp_182: int)
{
  ...
  anon5_Else:
    ...
    Tmp_182 := sdv_harnessStackLocation_next;
    goto L1;
  ...
  anon6_Else:
    ...
    Tmp_182 := sdv_other_harnessStackLocation_next;
    goto L1;

  anon6_Then:
    assume {:partition} pirp_1 != sdv_other_harnessIrp;
    Tmp_182 := sdv_harnessStackLocation;
    goto L1;
}
...
implementation {:origName "KeInitializeDpc"} {:osmodel} KeInitializeDpc(actual_Dpc: int, actual_DeferredRoutine: int, actual_DeferredContext: int)
{
  ...
  anon0:
    call {:si_unique_call 133} vslice_dummy_var_27 := __HAVOC_malloc(4);
    Dpc := actual_Dpc;
...
implementation {:origName "sdv_IoReleaseRemoveLockAndWait"} {:osmodel} sdv_IoReleaseRemoveLockAndWait(actual_RemoveLock: int, actual_Tag: int)
{
  ...
  anon0:
    call {:si_unique_call 134} vslice_dummy_var_28 := __HAVOC_malloc(4);
    call {:si_unique_call 135} SLIC_sdv_IoReleaseRemoveLockAndWait_entry(strConst__li2bpl10);
    goto anon3_Then, anon3_Else;
...
procedure {:origName "IoCreateDevice"} {:osmodel} IoCreateDevice(actual_DriverObject: int, actual_DeviceExtensionSize: int, actual_DeviceName: int, actual_DeviceType: int, actual_DeviceCharacteristics: int, actual_Exclusive: int, actual_DeviceObject_1: int) returns (Tmp_188: int);
  free ensures {:va_keep} Tmp_188 == -1073741824 || Tmp_188 == -1073741771 || Tmp_188 == -1073741670 || Tmp_188 == -1073741823 || Tmp_188 == 0;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} false || old(t) == 1 || old(t) == 0;
  free ensures {:va_keep} alloc >= old(alloc);
  free ensures {:va_keep} false || t == 1 || t == 0;
...
implementation {:origName "IoCreateDevice"} {:osmodel} IoCreateDevice(actual_DriverObject: int, actual_DeviceExtensionSize: int, actual_DeviceName: int, actual_DeviceType: int, actual_DeviceCharacteristics: int, actual_Exclusive: int, actual_DeviceObject_1: int) returns (Tmp_188: int)
{
...
procedure {:origName "sdv_RtlQueryRegistryValues"} {:osmodel} sdv_RtlQueryRegistryValues(actual_RelativeTo: int, actual_Path: int, actual_QueryTable: int, actual_Context: int, actual_Environment: int) returns (Tmp_198: int);
  free ensures {:va_keep} Tmp_198 == 0 || Tmp_198 == -1073741823;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} false || old(t) == 1 || old(t) == 0;
  free ensures {:va_keep} alloc >= old(alloc);
  free ensures {:va_keep} false || t == 1 || t == 0;
...
implementation {:origName "sdv_RtlQueryRegistryValues"} {:osmodel} sdv_RtlQueryRegistryValues(actual_RelativeTo: int, actual_Path: int, actual_QueryTable: int, actual_Context: int, actual_Environment: int) returns (Tmp_198: int)
{
...
implementation {:origName "sdv_main"} {:osmodel} sdv_main()
{
  ...
  anon0:
    call {:si_unique_call 140} vslice_dummy_var_33 := __HAVOC_malloc(4);
    assume {:nonnull} sdv_p_devobj_fdo != 0;
    assume sdv_p_devobj_fdo > 0;
    assume {:nonnull} sdv_p_devobj_child_pdo != 0;
    assume sdv_p_devobj_child_pdo > 0;
    call {:si_unique_call 141} status_1 := sdv_RunAddDevice(sdv_driver_object, sdv_p_devobj_pdo);
    goto anon5_Then, anon5_Else;
  ...
  L44:
    assume Tmp_202 != 0;
    call {:si_unique_call 142} sdv_stub_driver_init();
    call {:si_unique_call 143} vslice_dummy_var_34 := sdv_RunDispatchFunction(sdv_p_devobj_fdo, sdv_irp);
    goto anon6_Then, anon6_Else;
...
procedure {:origName "sdv_MmGetMdlVirtualAddress"} {:osmodel} sdv_MmGetMdlVirtualAddress(actual_Mdl: int) returns (Tmp_205: int);
  modifies alloc;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} false || old(t) == 1 || old(t) == 0;
  free ensures {:va_keep} alloc >= old(alloc);
...
implementation {:origName "sdv_MmGetMdlVirtualAddress"} {:osmodel} sdv_MmGetMdlVirtualAddress(actual_Mdl: int) returns (Tmp_205: int)
{
  var {:pointer} x_2: int;
  var {:pointer} sdv_83: int;

  anon0:
    call {:si_unique_call 144} sdv_83 := __HAVOC_malloc(1);
    x_2 := sdv_83;
    Tmp_205 := x_2;
    return;
}
...
procedure {:origName "PoCallDriver"} {:osmodel} PoCallDriver(actual_DeviceObject_2: int, actual_Irp: int) returns (Tmp_207: int);
...
implementation {:origName "PoCallDriver"} {:osmodel} PoCallDriver(actual_DeviceObject_2: int, actual_Irp: int) returns (Tmp_207: int)
{
  ...
  anon0:
    call {:si_unique_call 145} completion := __HAVOC_malloc(4);
    Irp := actual_Irp;
  ...
  anon56_Then:
    ...
    call {:si_unique_call 146} vslice_dummy_var_35 := sdv_RunIoCompletionRoutines#1(sdv_p_devobj_fdo, Irp, vslice_dummy_var_170, completion);
  ...
  anon68_Else:
    ...
    call {:si_unique_call 147} vslice_dummy_var_38 := sdv_RunIoCompletionRoutines#1(sdv_p_devobj_fdo, Irp, vslice_dummy_var_171, completion);
  ...
  anon60_Else:
    ...
    call {:si_unique_call 148} vslice_dummy_var_36 := sdv_RunIoCompletionRoutines#1(sdv_p_devobj_fdo, Irp, vslice_dummy_var_172, completion);
  ...
  anon64_Else:
    ...
    call {:si_unique_call 149} vslice_dummy_var_37 := sdv_RunIoCompletionRoutines#1(sdv_p_devobj_fdo, Irp, vslice_dummy_var_173, completion);
...
procedure {:origName "KeCancelTimer"} {:osmodel} KeCancelTimer(actual_Timer: int) returns (Tmp_209: int);
  free ensures {:va_keep} Tmp_209 == 1 || Tmp_209 == 0;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} false || old(t) == 1 || old(t) == 0;
  free ensures {:va_keep} alloc >= old(alloc);
  free ensures {:va_keep} false || t == 1 || t == 0;
...
implementation {:origName "KeCancelTimer"} {:osmodel} KeCancelTimer(actual_Timer: int) returns (Tmp_209: int)
{
...
implementation {:origName "sdv_IoSetCompletionRoutine"} {:osmodel} sdv_IoSetCompletionRoutine(actual_pirp_5: int, actual_CompletionRoutine: int, actual_Context_1: int, actual_InvokeOnSuccess: int, actual_InvokeOnError: int, actual_InvokeOnCancel: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 151} irpSp := sdv_IoGetNextIrpStackLocation(pirp_5);
...
implementation {:origName "_sdv_init9"} {:osmodel} _sdv_init9()
{
  ...
  anon0:
    call {:si_unique_call 152} vslice_dummy_var_40 := __HAVOC_malloc(4);
...
implementation {:origName "PoStartNextPowerIrp"} {:osmodel} PoStartNextPowerIrp(actual_Irp_1: int)
{
  ...
  anon0:
    call {:si_unique_call 154} vslice_dummy_var_42 := __HAVOC_malloc(4);
    return;
}



procedure {:origName "KeWaitForSingleObject"} {:osmodel} KeWaitForSingleObject(actual_Object: int, actual_WaitReason: int, actual_WaitMode: int, actual_Alertable: int, actual_Timeout: int) returns (Tmp_219: int);
  free ensures {:va_keep} Tmp_219 == 258 || Tmp_219 == 0;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} false || old(t) == 1 || old(t) == 0;
  free ensures {:va_keep} alloc >= old(alloc);
  free ensures {:va_keep} false || t == 1 || t == 0;
...
implementation {:origName "KeWaitForSingleObject"} {:osmodel} KeWaitForSingleObject(actual_Object: int, actual_WaitReason: int, actual_WaitMode: int, actual_Alertable: int, actual_Timeout: int) returns (Tmp_219: int)
{
...
implementation {:origName "IoDeleteDevice"} {:osmodel} IoDeleteDevice(actual_DeviceObject_3: int)
{
  ...
  anon0:
    call {:si_unique_call 155} vslice_dummy_var_43 := __HAVOC_malloc(4);
    return;
}



procedure {:origName "KeSetEvent"} {:osmodel} KeSetEvent(actual_Event: int, actual_Increment: int, actual_Wait: int) returns (Tmp_223: int);
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} false || old(t) == 1 || old(t) == 0;
  free ensures {:va_keep} alloc >= old(alloc);
  free ensures {:va_keep} false || t == 1 || t == 0;
...
implementation {:origName "KeSetEvent"} {:osmodel} KeSetEvent(actual_Event: int, actual_Increment: int, actual_Wait: int) returns (Tmp_223: int)
{
...
procedure {:origName "sdv_IoGetCurrentIrpStackLocation"} {:osmodel} sdv_IoGetCurrentIrpStackLocation(actual_pirp_6: int) returns (Tmp_227: int);
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} false || old(t) == 1 || old(t) == 0;
  free ensures {:va_keep} alloc >= old(alloc);
  free ensures {:va_keep} false || t == 1 || t == 0;
...
implementation {:origName "sdv_IoGetCurrentIrpStackLocation"} {:osmodel} sdv_IoGetCurrentIrpStackLocation(actual_pirp_6: int) returns (Tmp_227: int)
{
...
implementation {:origName "IoStartPacket"} {:osmodel} IoStartPacket(actual_DeviceObject_4: int, actual_Irp_2: int, actual_Key: int, actual_CancelFunction: int)
{
  ...
  anon0:
    call {:si_unique_call 156} vslice_dummy_var_44 := __HAVOC_malloc(4);
    return;
}



procedure {:origName "sdv_KeGetCurrentIrql"} {:osmodel} sdv_KeGetCurrentIrql() returns (Tmp_231: int);
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} false || old(t) == 1 || old(t) == 0;
  free ensures {:va_keep} alloc >= old(alloc);
  free ensures {:va_keep} false || t == 1 || t == 0;
...
implementation {:origName "sdv_KeGetCurrentIrql"} {:osmodel} sdv_KeGetCurrentIrql() returns (Tmp_231: int)
{
...
procedure {:nohoudini} {:origName "main"} {:osmodel} {:entrypoint} main() returns (Tmp_233: int, dup_assertVar: bool);
...
implementation {:origName "main"} {:osmodel} main() returns (Tmp_233: int, dup_assertVar: bool)
{
  ...
  anon0:
    dup_assertVar := true;
    assume alloc > 0;
    call {:si_unique_call 157} WHEA_ERROR_PACKET_SECTION_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume WHEA_ERROR_PACKET_SECTION_GUID__Loc == WHEA_ERROR_PACKET_SECTION_GUID;
    assume WHEA_ERROR_PACKET_SECTION_GUID != 0;
    call {:si_unique_call 158} sdv_harnessStackLocation_next__Loc := __HAVOC_malloc_or_null(496);
    assume sdv_harnessStackLocation_next__Loc == sdv_harnessStackLocation_next;
    assume sdv_harnessStackLocation_next != 0;
    call {:si_unique_call 159} sdv_IoReadPartitionTableEx_DRIVE_LAYOUT_INFORMATION_EX__Loc := __HAVOC_malloc_or_null(76);
    assume sdv_IoReadPartitionTableEx_DRIVE_LAYOUT_INFORMATION_EX__Loc == sdv_IoReadPartitionTableEx_DRIVE_LAYOUT_INFORMATION_EX;
    assume sdv_IoReadPartitionTableEx_DRIVE_LAYOUT_INFORMATION_EX != 0;
    call {:si_unique_call 160} sdv_IoBuildAsynchronousFsdRequest_harnessIrp__Loc := __HAVOC_malloc_or_null(248);
    assume sdv_IoBuildAsynchronousFsdRequest_harnessIrp__Loc == sdv_IoBuildAsynchronousFsdRequest_harnessIrp;
    assume sdv_IoBuildAsynchronousFsdRequest_harnessIrp != 0;
    call {:si_unique_call 161} sdv_IoGetDeviceToVerify_DEVICE_OBJECT__Loc := __HAVOC_malloc_or_null(320);
    assume sdv_IoGetDeviceToVerify_DEVICE_OBJECT__Loc == sdv_IoGetDeviceToVerify_DEVICE_OBJECT;
    assume sdv_IoGetDeviceToVerify_DEVICE_OBJECT != 0;
    call {:si_unique_call 162} sdv_IoBuildDeviceIoControlRequest_harnessStackLocation_next__Loc := __HAVOC_malloc_or_null(496);
    ...
    call {:si_unique_call 164} sdv_ControllerIrp__Loc := __HAVOC_malloc_or_null(248);
    assume sdv_ControllerIrp__Loc == sdv_ControllerIrp;
    assume sdv_ControllerIrp != 0;
    call {:si_unique_call 165} sdv_devobj_pdo__Loc := __HAVOC_malloc_or_null(320);
    ...
    call {:si_unique_call 167} sdv_IoInitializeIrp_harnessIrp__Loc := __HAVOC_malloc_or_null(248);
    assume sdv_IoInitializeIrp_harnessIrp__Loc == sdv_IoInitializeIrp_harnessIrp;
    assume sdv_IoInitializeIrp_harnessIrp != 0;
    call {:si_unique_call 168} sdv_IoGetRelatedDeviceObject_DEVICE_OBJECT__Loc := __HAVOC_malloc_or_null(320);
    assume sdv_IoGetRelatedDeviceObject_DEVICE_OBJECT__Loc == sdv_IoGetRelatedDeviceObject_DEVICE_OBJECT;
    assume sdv_IoGetRelatedDeviceObject_DEVICE_OBJECT != 0;
    call {:si_unique_call 169} sdv_IoBuildSynchronousFsdRequest_harnessStackLocation_next__Loc := __HAVOC_malloc_or_null(496);
    assume sdv_IoBuildSynchronousFsdRequest_harnessStackLocation_next__Loc == sdv_IoBuildSynchronousFsdRequest_harnessStackLocation_next;
    assume sdv_IoBuildSynchronousFsdRequest_harnessStackLocation_next != 0;
    call {:si_unique_call 170} sdv_IoCreateSynchronizationEvent_KEVENT__Loc := __HAVOC_malloc_or_null(124);
    assume sdv_IoCreateSynchronizationEvent_KEVENT__Loc == sdv_IoCreateSynchronizationEvent_KEVENT;
    assume sdv_IoCreateSynchronizationEvent_KEVENT != 0;
    call {:si_unique_call 171} sdv_other_harnessStackLocation_next__Loc := __HAVOC_malloc_or_null(496);
    assume sdv_other_harnessStackLocation_next__Loc == sdv_other_harnessStackLocation_next;
    assume sdv_other_harnessStackLocation_next != 0;
    call {:si_unique_call 172} sdv_harnessStackLocation__Loc := __HAVOC_malloc_or_null(496);
    ...
    call {:si_unique_call 174} sdv_devobj_top__Loc := __HAVOC_malloc_or_null(320);
    assume sdv_devobj_top__Loc == sdv_devobj_top;
    assume sdv_devobj_top != 0;
    call {:si_unique_call 175} sdv_kdpc_val3__Loc := __HAVOC_malloc_or_null(40);
    assume sdv_kdpc_val3__Loc == sdv_kdpc_val3;
    assume sdv_kdpc_val3 != 0;
    call {:si_unique_call 176} sdv_IoBuildSynchronousFsdRequest_harnessIrp__Loc := __HAVOC_malloc_or_null(248);
    assume sdv_IoBuildSynchronousFsdRequest_harnessIrp__Loc == sdv_IoBuildSynchronousFsdRequest_harnessIrp;
    assume sdv_IoBuildSynchronousFsdRequest_harnessIrp != 0;
    call {:si_unique_call 177} sdv_IoGetDeviceObjectPointer_DEVICE_OBJECT__Loc := __HAVOC_malloc_or_null(320);
    assume sdv_IoGetDeviceObjectPointer_DEVICE_OBJECT__Loc == sdv_IoGetDeviceObjectPointer_DEVICE_OBJECT;
    assume sdv_IoGetDeviceObjectPointer_DEVICE_OBJECT != 0;
    call {:si_unique_call 178} sdv_driver_object__Loc := __HAVOC_malloc_or_null(68);
    assume sdv_driver_object__Loc == sdv_driver_object;
    assume sdv_driver_object != 0;
    call {:si_unique_call 179} sdv_MapRegisterBase_val__Loc := __HAVOC_malloc_or_null(4);
    assume sdv_MapRegisterBase_val__Loc == sdv_MapRegisterBase_val;
    assume sdv_MapRegisterBase_val != 0;
    call {:si_unique_call 180} sdv_IoGetFileObjectGenericMapping_GENERIC_MAPPING__Loc := __HAVOC_malloc_or_null(16);
    assume sdv_IoGetFileObjectGenericMapping_GENERIC_MAPPING__Loc == sdv_IoGetFileObjectGenericMapping_GENERIC_MAPPING;
    assume sdv_IoGetFileObjectGenericMapping_GENERIC_MAPPING != 0;
    call {:si_unique_call 181} sdv_IoMakeAssociatedIrp_harnessIrp__Loc := __HAVOC_malloc_or_null(248);
    assume sdv_IoMakeAssociatedIrp_harnessIrp__Loc == sdv_IoMakeAssociatedIrp_harnessIrp;
    assume sdv_IoMakeAssociatedIrp_harnessIrp != 0;
    call {:si_unique_call 182} sdv_devobj_child_pdo__Loc := __HAVOC_malloc_or_null(320);
    assume sdv_devobj_child_pdo__Loc == sdv_devobj_child_pdo;
    assume sdv_devobj_child_pdo != 0;
    call {:si_unique_call 183} sdv_harnessIrp__Loc := __HAVOC_malloc_or_null(248);
    assume sdv_harnessIrp__Loc == sdv_harnessIrp;
    assume sdv_harnessIrp != 0;
    call {:si_unique_call 184} sdv_IoBuildAsynchronousFsdRequest_harnessStackLocation_next__Loc := __HAVOC_malloc_or_null(496);
    assume sdv_IoBuildAsynchronousFsdRequest_harnessStackLocation_next__Loc == sdv_IoBuildAsynchronousFsdRequest_harnessStackLocation_next;
    assume sdv_IoBuildAsynchronousFsdRequest_harnessStackLocation_next != 0;
    call {:si_unique_call 185} sdv_harness_IoBuildDeviceIoControlRequest_IoStatusBlock__Loc := __HAVOC_malloc_or_null(12);
    assume sdv_harness_IoBuildDeviceIoControlRequest_IoStatusBlock__Loc == sdv_harness_IoBuildDeviceIoControlRequest_IoStatusBlock;
    assume sdv_harness_IoBuildDeviceIoControlRequest_IoStatusBlock != 0;
    call {:si_unique_call 186} sdv_kinterrupt_val__Loc := __HAVOC_malloc_or_null(0);
    assume sdv_kinterrupt_val__Loc == sdv_kinterrupt_val;
    assume sdv_kinterrupt_val != 0;
    call {:si_unique_call 187} sdv_devobj_fdo__Loc := __HAVOC_malloc_or_null(320);
    assume sdv_devobj_fdo__Loc == sdv_devobj_fdo;
    assume sdv_devobj_fdo != 0;
    call {:si_unique_call 188} sdv_StartIoIrp__Loc := __HAVOC_malloc_or_null(248);
    ...
    call {:si_unique_call 190} sdv_PowerIrp__Loc := __HAVOC_malloc_or_null(248);
    assume sdv_PowerIrp__Loc == sdv_PowerIrp;
    assume sdv_PowerIrp != 0;
    call {:si_unique_call 191} sdv_IoBuildDeviceIoControlRequest_harnessIrp__Loc := __HAVOC_malloc_or_null(248);
    assume sdv_IoBuildDeviceIoControlRequest_harnessIrp__Loc == sdv_IoBuildDeviceIoControlRequest_harnessIrp;
    assume sdv_IoBuildDeviceIoControlRequest_harnessIrp != 0;
    call {:si_unique_call 192} sdv_other_harnessIrp__Loc := __HAVOC_malloc_or_null(248);
    assume sdv_other_harnessIrp__Loc == sdv_other_harnessIrp;
    assume sdv_other_harnessIrp != 0;
    call {:si_unique_call 193} sdv_IoCreateNotificationEvent_KEVENT__Loc := __HAVOC_malloc_or_null(124);
    assume sdv_IoCreateNotificationEvent_KEVENT__Loc == sdv_IoCreateNotificationEvent_KEVENT;
    assume sdv_IoCreateNotificationEvent_KEVENT != 0;
    call {:si_unique_call 194} sdv_other_harnessStackLocation__Loc := __HAVOC_malloc_or_null(496);
    assume sdv_other_harnessStackLocation__Loc == sdv_other_harnessStackLocation;
    assume sdv_other_harnessStackLocation != 0;
    call {:si_unique_call 195} KeTickCount__Loc := __HAVOC_malloc_or_null(12);
    ...
    call {:si_unique_call 209} boogieTmp := __HAVOC_malloc_or_null(248);
    ...
    call {:si_unique_call 220} vslice_dummy_var_127 := __HAVOC_malloc(4);
    call {:si_unique_call 221} vslice_dummy_var_174 := __HAVOC_malloc(28);
    call {:si_unique_call 222} vslice_dummy_var_128 := __HAVOC_malloc(4);
    call {:si_unique_call 223} vslice_dummy_var_129 := __HAVOC_malloc(4);
    call {:si_unique_call 224} vslice_dummy_var_130 := __HAVOC_malloc(4);
    call {:si_unique_call 225} vslice_dummy_var_131 := __HAVOC_malloc(4);
    call {:si_unique_call 226} vslice_dummy_var_175 := __HAVOC_malloc(12);
    call {:si_unique_call 227} vslice_dummy_var_132 := __HAVOC_malloc(4);
    call {:si_unique_call 228} vslice_dummy_var_176 := __HAVOC_malloc(28);
    call {:si_unique_call 229} vslice_dummy_var_133 := __HAVOC_malloc(4);
    call {:si_unique_call 230} vslice_dummy_var_134 := __HAVOC_malloc(4);
    call {:si_unique_call 231} vslice_dummy_var_135 := __HAVOC_malloc(4);
    call {:si_unique_call 232} vslice_dummy_var_136 := __HAVOC_malloc(4);
    call {:si_unique_call 233} vslice_dummy_var_177 := __HAVOC_malloc(12);
    call {:si_unique_call 234} vslice_dummy_var_137 := __HAVOC_malloc(4);
    call {:si_unique_call 235} vslice_dummy_var_178 := __HAVOC_malloc(28);
    call {:si_unique_call 236} vslice_dummy_var_138 := __HAVOC_malloc(4);
    call {:si_unique_call 237} vslice_dummy_var_139 := __HAVOC_malloc(4);
    call {:si_unique_call 238} vslice_dummy_var_140 := __HAVOC_malloc(4);
    call {:si_unique_call 239} vslice_dummy_var_141 := __HAVOC_malloc(4);
    call {:si_unique_call 240} vslice_dummy_var_179 := __HAVOC_malloc(12);
    call {:si_unique_call 241} vslice_dummy_var_142 := __HAVOC_malloc(4);
    call {:si_unique_call 242} vslice_dummy_var_143 := __HAVOC_malloc(4);
    call {:si_unique_call 243} vslice_dummy_var_144 := __HAVOC_malloc(4);
    call {:si_unique_call 244} vslice_dummy_var_145 := __HAVOC_malloc(4);
    call {:si_unique_call 245} vslice_dummy_var_146 := __HAVOC_malloc(4);
    call {:si_unique_call 246} vslice_dummy_var_147 := __HAVOC_malloc(4);
    call {:si_unique_call 247} vslice_dummy_var_180 := __HAVOC_malloc(28);
    call {:si_unique_call 248} vslice_dummy_var_148 := __HAVOC_malloc(4);
    call {:si_unique_call 249} vslice_dummy_var_149 := __HAVOC_malloc(4);
    call {:si_unique_call 250} vslice_dummy_var_150 := __HAVOC_malloc(4);
    call {:si_unique_call 251} vslice_dummy_var_151 := __HAVOC_malloc(4);
    call {:si_unique_call 252} vslice_dummy_var_181 := __HAVOC_malloc(12);
    call {:si_unique_call 253} vslice_dummy_var_152 := __HAVOC_malloc(4);
    call {:si_unique_call 254} vslice_dummy_var_182 := __HAVOC_malloc(28);
    call {:si_unique_call 255} vslice_dummy_var_153 := __HAVOC_malloc(4);
    call {:si_unique_call 256} vslice_dummy_var_154 := __HAVOC_malloc(4);
    call {:si_unique_call 257} vslice_dummy_var_155 := __HAVOC_malloc(4);
    call {:si_unique_call 258} vslice_dummy_var_156 := __HAVOC_malloc(4);
    call {:si_unique_call 259} vslice_dummy_var_183 := __HAVOC_malloc(12);
    call {:si_unique_call 260} vslice_dummy_var_157 := __HAVOC_malloc(4);
    call {:si_unique_call 261} vslice_dummy_var_184 := __HAVOC_malloc(28);
    call {:si_unique_call 262} vslice_dummy_var_158 := __HAVOC_malloc(4);
    call {:si_unique_call 263} vslice_dummy_var_159 := __HAVOC_malloc(4);
    call {:si_unique_call 264} vslice_dummy_var_160 := __HAVOC_malloc(4);
    call {:si_unique_call 265} vslice_dummy_var_161 := __HAVOC_malloc(4);
    call {:si_unique_call 266} vslice_dummy_var_185 := __HAVOC_malloc(12);
    call {:si_unique_call 267} vslice_dummy_var_162 := __HAVOC_malloc(4);
    call {:si_unique_call 268} vslice_dummy_var_186 := __HAVOC_malloc(28);
    call {:si_unique_call 269} vslice_dummy_var_163 := __HAVOC_malloc(4);
    call {:si_unique_call 270} vslice_dummy_var_164 := __HAVOC_malloc(4);
    call {:si_unique_call 271} vslice_dummy_var_165 := __HAVOC_malloc(4);
    call {:si_unique_call 272} vslice_dummy_var_166 := __HAVOC_malloc(4);
    call {:si_unique_call 273} vslice_dummy_var_187 := __HAVOC_malloc(12);
    call {:si_unique_call 274} vslice_dummy_var_167 := __HAVOC_malloc(4);
    call {:si_unique_call 275} vslice_dummy_var_188 := __HAVOC_malloc(28);
    call {:si_unique_call 276} vslice_dummy_var_168 := __HAVOC_malloc(4);
    call {:si_unique_call 277} vslice_dummy_var_169 := __HAVOC_malloc(4);
    call {:si_unique_call 278} vslice_dummy_var_170 := __HAVOC_malloc(4);
    call {:si_unique_call 279} vslice_dummy_var_171 := __HAVOC_malloc(4);
    call {:si_unique_call 280} vslice_dummy_var_189 := __HAVOC_malloc(12);
    assume {:mainInitDone} true;
    call {:si_unique_call 281} corralExtraInit();
    call {:si_unique_call 282} corralExplainErrorInit();
    call {:si_unique_call 283} _sdv_init11();
    call {:si_unique_call 284} _sdv_init1();
    call {:si_unique_call 285} _sdv_init4();
    call {:si_unique_call 286} _sdv_init5();
    call {:si_unique_call 287} _sdv_init3();
    call {:si_unique_call 288} _sdv_init6();
    call {:si_unique_call 289} _sdv_init9();
    call {:si_unique_call 290} _sdv_init7();
    call {:si_unique_call 291} _sdv_init8();
    call {:si_unique_call 292} _sdv_init2();
    goto anon9_Then, anon9_Else;
  ...
  L38:
    ...
    call {:si_unique_call 293} sdv_main();
    goto anon12_Then, anon12_Else;
...
procedure {:origName "IoCancelIrp"} {:osmodel} IoCancelIrp(actual_Irp_3: int) returns (Tmp_239: int);
  free ensures {:va_keep} Tmp_239 == 0 || Tmp_239 == 1;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} false || old(t) == 1 || old(t) == 0;
  free ensures {:va_keep} alloc >= old(alloc);
  free ensures {:va_keep} false || t == 1 || t == 0;
...
implementation {:origName "IoCancelIrp"} {:osmodel} IoCancelIrp(actual_Irp_3: int) returns (Tmp_239: int)
{
...
procedure {:origName "IoInitializeTimer"} {:osmodel} IoInitializeTimer(actual_DeviceObject_5: int, actual_TimerRoutine: int, actual_Context_2: int) returns (Tmp_241: int);
  free ensures {:va_keep} Tmp_241 == 0 || Tmp_241 == -1073741823;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} false || old(t) == 1 || old(t) == 0;
  free ensures {:va_keep} alloc >= old(alloc);
  free ensures {:va_keep} false || t == 1 || t == 0;
...
implementation {:origName "IoInitializeTimer"} {:osmodel} IoInitializeTimer(actual_DeviceObject_5: int, actual_TimerRoutine: int, actual_Context_2: int) returns (Tmp_241: int)
{
...
procedure {:origName "IoAttachDeviceToDeviceStack"} {:osmodel} IoAttachDeviceToDeviceStack(actual_SourceDevice: int, actual_TargetDevice_1: int) returns (Tmp_247: int);
  free ensures {:va_keep} Tmp_247 == 0 || Tmp_247 == actual_TargetDevice_1;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} false || old(t) == 1 || old(t) == 0;
  free ensures {:va_keep} alloc >= old(alloc);
  free ensures {:va_keep} false || t == 1 || t == 0;
...
implementation {:origName "IoAttachDeviceToDeviceStack"} {:osmodel} IoAttachDeviceToDeviceStack(actual_SourceDevice: int, actual_TargetDevice_1: int) returns (Tmp_247: int)
{
...
implementation {:origName "sdv_do_paged_code_check"} {:osmodel} sdv_do_paged_code_check()
{
  ...
  anon0:
    call {:si_unique_call 299} vslice_dummy_var_50 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "sdv_KeLowerIrql"} {:osmodel} sdv_KeLowerIrql(actual_NewIrql: int)
{
  ...
  anon0:
    call {:si_unique_call 300} vslice_dummy_var_51 := __HAVOC_malloc(4);
...
implementation {:origName "sdv_IoMarkIrpPending"} {:osmodel} sdv_IoMarkIrpPending(actual_pirp_8: int)
{
  ...
  anon0:
    call {:si_unique_call 301} vslice_dummy_var_52 := __HAVOC_malloc(4);
    return;
}



procedure {:origName "sdv_RunDispatchFunction"} {:osmodel} sdv_RunDispatchFunction(actual_po: int, actual_pirp_9: int) returns (Tmp_259: int);
  modifies alloc, Mem_T.CompletionRoutine__IO_STACK_LOCATION, t, LockDepth, yogi_error;
...
implementation {:origName "sdv_RunDispatchFunction"} {:osmodel} sdv_RunDispatchFunction(actual_po: int, actual_pirp_9: int) returns (Tmp_259: int)
{
  var {:pointer} ps: int;
  ...
  anon0:
    ...
    assume {:nonnull} pirp_9 != 0;
    assume pirp_9 > 0;
    call {:si_unique_call 302} sdv_SetStatus(pirp_9);
    assume {:nonnull} pirp_9 != 0;
    assume pirp_9 > 0;
    assume {:nonnull} pirp_9 != 0;
    assume pirp_9 > 0;
    ...
    call {:si_unique_call 303} sdv_stub_dispatch_begin();
    goto anon53_Then, anon53_Else;
  ...
  anon56_Else:
    call {:si_unique_call 304} SdvExit#1();
    goto L66;

  L66:
    call {:si_unique_call 305} status_3 := PpaPnpDeviceControl(po, pirp_9);
    goto anon78_Then, anon78_Else;
  ...
  L75:
    call {:si_unique_call 306} sdv_stub_dispatch_end(status_3, 0);
    assume {:nonnull} pirp_9 != 0;
    assume pirp_9 > 0;
    Tmp_259 := status_3;
    goto LM2;
  ...
  anon58_Then:
    call {:si_unique_call 307} status_3 := sdv_DoNothing();
    goto L75;

  anon59_Then:
    assume {:nonnull} ps != 0;
    assume ps > 0;
    call {:si_unique_call 308} status_3 := PpaSystemControl(po, pirp_9);
    goto anon76_Then, anon76_Else;
  ...
  anon60_Then:
    assume {:nonnull} ps != 0;
    assume ps > 0;
    call {:si_unique_call 309} sdv_SetPowerIrpMinorFunction(pirp_9);
    call {:si_unique_call 310} status_3 := PpaPowerControl(po, pirp_9);
    goto anon75_Then, anon75_Else;
  ...
  anon61_Then:
    assume {:nonnull} ps != 0;
    assume ps > 0;
    call {:si_unique_call 311} status_3 := PpaCreateCleanupClose(po, pirp_9);
    goto L75;

  anon62_Then:
    call {:si_unique_call 312} status_3 := sdv_DoNothing();
    goto L75;

  anon63_Then:
    assume {:nonnull} ps != 0;
    assume ps > 0;
    call {:si_unique_call 313} status_3 := sdv_DoNothing();
    goto L75;

  anon64_Then:
    assume {:nonnull} ps != 0;
    assume ps > 0;
    call {:si_unique_call 314} status_3 := PpaScsiRequests(po, pirp_9);
    goto anon74_Then, anon74_Else;
  ...
  anon65_Then:
    assume {:nonnull} ps != 0;
    assume ps > 0;
    call {:si_unique_call 315} status_3 := PpaDeviceControl(po, pirp_9);
    goto anon73_Then, anon73_Else;
  ...
  anon66_Then:
    call {:si_unique_call 316} status_3 := sdv_DoNothing();
    goto L75;

  anon67_Then:
    assume {:nonnull} ps != 0;
    assume ps > 0;
    call {:si_unique_call 317} status_3 := sdv_DoNothing();
    goto L75;

  anon68_Then:
    assume {:nonnull} ps != 0;
    assume ps > 0;
    call {:si_unique_call 318} status_3 := sdv_DoNothing();
    goto L75;

  anon69_Then:
    assume {:nonnull} ps != 0;
    assume ps > 0;
    call {:si_unique_call 319} status_3 := sdv_DoNothing();
    goto L75;

  anon70_Then:
    assume {:nonnull} ps != 0;
    assume ps > 0;
    call {:si_unique_call 320} status_3 := sdv_DoNothing();
    goto L75;

  anon71_Then:
    assume {:nonnull} ps != 0;
    assume ps > 0;
    call {:si_unique_call 321} status_3 := sdv_DoNothing();
    goto L75;

  anon72_Then:
    assume {:nonnull} ps != 0;
    assume ps > 0;
    call {:si_unique_call 322} status_3 := PpaCreateCleanupClose(po, pirp_9);
    goto L75;

  anon53_Then:
    assume {:nonnull} ps != 0;
    assume ps > 0;
    call {:si_unique_call 323} status_3 := PpaCreateCleanupClose(po, pirp_9);
    goto L75;
}
...
implementation {:origName "RtlFreeUnicodeString"} {:osmodel} RtlFreeUnicodeString(actual_UnicodeString: int)
{
  ...
  anon0:
    call {:si_unique_call 324} vslice_dummy_var_53 := __HAVOC_malloc(4);
    return;
}



procedure {:origName "IoBuildSynchronousFsdRequest"} {:osmodel} IoBuildSynchronousFsdRequest(actual_MajorFunction: int, actual_DeviceObject_6: int, actual_Buffer_5: int, actual_Length_1: int, actual_StartingOffset: int, actual_Event_1: int, actual_IoStatusBlock: int) returns (Tmp_265: int);
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} false || old(t) == 1 || old(t) == 0;
  free ensures {:va_keep} alloc >= old(alloc);
  free ensures {:va_keep} false || t == 1 || t == 0;
...
implementation {:origName "IoBuildSynchronousFsdRequest"} {:osmodel} IoBuildSynchronousFsdRequest(actual_MajorFunction: int, actual_DeviceObject_6: int, actual_Buffer_5: int, actual_Length_1: int, actual_StartingOffset: int, actual_Event_1: int, actual_IoStatusBlock: int) returns (Tmp_265: int)
{
  ...
  anon3_Else:
    ...
    assume {:nonnull} sdv_IoBuildSynchronousFsdRequest_irp != 0;
    assume sdv_IoBuildSynchronousFsdRequest_irp > 0;
    Tmp_265 := sdv_IoBuildSynchronousFsdRequest_irp;
    goto L1;
...
implementation {:origName "sdv_KeReleaseSpinLock"} {:osmodel} sdv_KeReleaseSpinLock(actual_SpinLock_1: int, actual_new: int)
{
  ...
  anon0:
    call {:si_unique_call 325} vslice_dummy_var_54 := __HAVOC_malloc(4);
    new := actual_new;
    return;
}
...
implementation {:origName "IoStopTimer"} {:osmodel} IoStopTimer(actual_DeviceObject_7: int)
{
  ...
  anon0:
    call {:si_unique_call 329} vslice_dummy_var_58 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "sdv_ExFreePool"} {:osmodel} sdv_ExFreePool(actual_P: int)
{
  ...
  anon0:
    call {:si_unique_call 330} vslice_dummy_var_59 := __HAVOC_malloc(4);
    return;
}



procedure {:origName "sdv_IoAcquireRemoveLock"} {:osmodel} sdv_IoAcquireRemoveLock(actual_RemoveLock_1: int, actual_Tag_1: int) returns (Tmp_282: int);
  modifies LockDepth;
  free ensures {:va_keep} LockDepth >= old(LockDepth);
  free ensures {:va_keep} Tmp_282 == -1073741823 || Tmp_282 == -1073741738 || Tmp_282 == 0;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} false || old(t) == 1 || old(t) == 0;
  free ensures {:va_keep} alloc >= old(alloc);
  free ensures {:va_keep} false || t == 1 || t == 0;
...
implementation {:origName "sdv_IoAcquireRemoveLock"} {:osmodel} sdv_IoAcquireRemoveLock(actual_RemoveLock_1: int, actual_Tag_1: int) returns (Tmp_282: int)
{
  ...
  L1:
    call {:si_unique_call 331} SLIC_sdv_IoAcquireRemoveLock_exit(0, Tmp_282);
    return;
...
procedure {:origName "IoAllocateIrp"} {:osmodel} IoAllocateIrp(actual_StackSize: int, actual_ChargeQuota: int) returns (Tmp_284: int);
...
implementation {:origName "IoAllocateIrp"} {:osmodel} IoAllocateIrp(actual_StackSize: int, actual_ChargeQuota: int) returns (Tmp_284: int)
{
  ...
  anon3_Else:
    assume {:nonnull} sdv_other_irp != 0;
    assume sdv_other_irp > 0;
    call {:si_unique_call 332} irpSp_1 := sdv_IoGetNextIrpStackLocation(sdv_other_irp);
    assume {:nonnull} irpSp_1 != 0;
    assume irpSp_1 > 0;
    Mem_T.CompletionRoutine__IO_STACK_LOCATION[CompletionRoutine__IO_STACK_LOCATION(irpSp_1)] := 0;
    Tmp_284 := sdv_other_irp;
    goto L1;
...
implementation {:origName "KeInitializeEvent"} {:osmodel} KeInitializeEvent(actual_Event_2: int, actual_Type: int, actual_State: int)
{
  ...
  anon0:
    call {:si_unique_call 333} vslice_dummy_var_60 := __HAVOC_malloc(4);
...
implementation {:origName "KeInitializeTimer"} {:osmodel} KeInitializeTimer(actual_Timer_1: int)
{
  ...
  anon0:
    call {:si_unique_call 334} vslice_dummy_var_61 := __HAVOC_malloc(4);
    return;
}



procedure {:origName "IoBuildDeviceIoControlRequest"} {:osmodel} IoBuildDeviceIoControlRequest(actual_IoControlCode: int, actual_DeviceObject_11: int, actual_InputBuffer: int, actual_InputBufferLength: int, actual_OutputBuffer: int, actual_OutputBufferLength: int, actual_InternalDeviceIoControl: int, actual_Event_3: int, actual_IoStatusBlock_1: int) returns (Tmp_296: int);
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} false || old(t) == 1 || old(t) == 0;
  free ensures {:va_keep} alloc >= old(alloc);
  free ensures {:va_keep} false || t == 1 || t == 0;
...
implementation {:origName "IoBuildDeviceIoControlRequest"} {:osmodel} IoBuildDeviceIoControlRequest(actual_IoControlCode: int, actual_DeviceObject_11: int, actual_InputBuffer: int, actual_InputBufferLength: int, actual_OutputBuffer: int, actual_OutputBufferLength: int, actual_InternalDeviceIoControl: int, actual_Event_3: int, actual_IoStatusBlock_1: int) returns (Tmp_296: int)
{
  ...
  L14:
    ...
    Tmp_296 := sdv_IoBuildDeviceIoControlRequest_irp;
    goto L1;
...
implementation {:origName "IoFreeIrp"} {:osmodel} IoFreeIrp(actual_pirp_11: int)
{
  ...
  anon0:
    call {:si_unique_call 335} vslice_dummy_var_62 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "sdv_KeInitializeSpinLock"} {:osmodel} sdv_KeInitializeSpinLock(actual_SpinLock_2: int)
{
  ...
  anon0:
    call {:si_unique_call 336} vslice_dummy_var_63 := __HAVOC_malloc(4);
...
procedure {:origName "ExAllocatePoolWithTag"} {:osmodel} ExAllocatePoolWithTag(actual_PoolType: int, actual_NumberOfBytes: int, actual_Tag_2: int) returns (Tmp_304: int);
  modifies alloc;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} false || old(t) == 1 || old(t) == 0;
  free ensures {:va_keep} alloc >= old(alloc);
...
implementation {:origName "ExAllocatePoolWithTag"} {:osmodel} ExAllocatePoolWithTag(actual_PoolType: int, actual_NumberOfBytes: int, actual_Tag_2: int) returns (Tmp_304: int)
{
  ...
  anon3_Else:
    call {:si_unique_call 337} sdv_129 := __HAVOC_malloc(NumberOfBytes);
    Tmp_304 := sdv_129;
    goto L1;
...
procedure {:origName "RtlWriteRegistryValue"} {:osmodel} RtlWriteRegistryValue(actual_RelativeTo_1: int, actual_Path_1: int, actual_ValueName: int, actual_ValueType: int, actual_ValueData: int, actual_ValueLength: int) returns (Tmp_306: int);
  free ensures {:va_keep} Tmp_306 == 0 || Tmp_306 == -1073741823;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} false || old(t) == 1 || old(t) == 0;
  free ensures {:va_keep} alloc >= old(alloc);
  free ensures {:va_keep} false || t == 1 || t == 0;
...
implementation {:origName "RtlWriteRegistryValue"} {:osmodel} RtlWriteRegistryValue(actual_RelativeTo_1: int, actual_Path_1: int, actual_ValueName: int, actual_ValueType: int, actual_ValueData: int, actual_ValueLength: int) returns (Tmp_306: int)
{
...
implementation {:origName "sdv_stub_dispatch_begin"} {:osmodel} sdv_stub_dispatch_begin()
{
  ...
  anon0:
    call {:si_unique_call 339} vslice_dummy_var_65 := __HAVOC_malloc(4);
    return;
}



procedure {:origName "IoOpenDeviceRegistryKey"} {:osmodel} IoOpenDeviceRegistryKey(actual_DeviceObject_12: int, actual_DevInstKeyType: int, actual_DesiredAccess: int, actual_DevInstRegKey: int) returns (Tmp_312: int);
  free ensures {:va_keep} Tmp_312 == -1073741811 || Tmp_312 == -1073741808 || Tmp_312 == -1073741823 || Tmp_312 == 0;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} false || old(t) == 1 || old(t) == 0;
  free ensures {:va_keep} alloc >= old(alloc);
  free ensures {:va_keep} false || t == 1 || t == 0;
...
implementation {:origName "IoOpenDeviceRegistryKey"} {:osmodel} IoOpenDeviceRegistryKey(actual_DeviceObject_12: int, actual_DevInstKeyType: int, actual_DesiredAccess: int, actual_DevInstRegKey: int) returns (Tmp_312: int)
{
...
implementation {:origName "IoStartTimer"} {:osmodel} IoStartTimer(actual_DeviceObject_13: int)
{
  ...
  anon0:
    call {:si_unique_call 340} vslice_dummy_var_66 := __HAVOC_malloc(4);
    return;
}



procedure {:origName "ZwClose"} {:osmodel} ZwClose(actual_Handle: int) returns (Tmp_316: int);
...
implementation {:origName "ZwClose"} {:osmodel} ZwClose(actual_Handle: int) returns (Tmp_316: int)
{
...
procedure {:origName "sdv_DoNothing"} {:osmodel} sdv_DoNothing() returns (Tmp_318: int);
  free ensures {:va_keep} Tmp_318 == -1073741823;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} false || old(t) == 1 || old(t) == 0;
  free ensures {:va_keep} alloc >= old(alloc);
  free ensures {:va_keep} false || t == 1 || t == 0;
...
implementation {:origName "sdv_DoNothing"} {:osmodel} sdv_DoNothing() returns (Tmp_318: int)
{
...
implementation {:origName "SLIC_PpaPnpDeviceControl_exit"} {:osmodel} SLIC_PpaPnpDeviceControl_exit(actual_caller: int, actual_PpaPnpDeviceControl_1: int)
{
  ...
  L6:
    call {:si_unique_call 341} SLIC_EXIT_ROUTINE(strConst__li2bpl11);
    goto L2;
  ...
  anon9_Then:
    assume {:partition} t == 1;
    call {:si_unique_call 342} SLIC_ABORT_9_0(caller, PpaPnpDeviceControl_1);
    goto anon12_Then, anon12_Else;
...
implementation {:origName "SLIC_ABORT_9_0"} SLIC_ABORT_9_0(actual_caller_1: int, actual_PpaPnpDeviceControl_2: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 343} SLIC_ERROR_ROUTINE(strConst__li2bpl12);
    return;
}
...
implementation {:origName "SLIC_sdv_IoReleaseRemoveLockAndWait_entry"} {:osmodel} SLIC_sdv_IoReleaseRemoveLockAndWait_entry(actual_caller_2: int)
{
  ...
  anon8_Then:
    assume {:partition} t == 1;
    call {:si_unique_call 344} SLIC_ABORT_5_0(caller_2);
    goto anon9_Then, anon9_Else;
...
implementation {:origName "SLIC_PpaPnpDeviceControl_entry"} {:osmodel} SLIC_PpaPnpDeviceControl_entry(actual_caller_3: int, actual_PpaPnpDeviceControl_3: int)
{
  ...
  anon3_Else:
    call {:si_unique_call 345} SLIC_EXIT_ROUTINE(strConst__li2bpl11);
    goto L2;
...
procedure {:origName "SLIC_sdv_IoAcquireRemoveLock_exit"} {:osmodel} SLIC_sdv_IoAcquireRemoveLock_exit(actual_caller_4: int, actual_sdv_132: int);
  modifies LockDepth;
  free ensures {:va_keep} LockDepth >= old(LockDepth);
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} false || old(t) == 1 || old(t) == 0;
...
implementation {:origName "SLIC_sdv_IoAcquireRemoveLock_exit"} {:osmodel} SLIC_sdv_IoAcquireRemoveLock_exit(actual_caller_4: int, actual_sdv_132: int)
{
  ...
  anon9_Then:
    assume {:partition} sdv_132 != 0;
    call {:si_unique_call 346} SLIC_EXIT_ROUTINE(strConst__li2bpl11);
    goto L2;
...
implementation {:origName "SLIC_ABORT_7_0"} SLIC_ABORT_7_0(actual_caller_6: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 347} SLIC_ERROR_ROUTINE(strConst__li2bpl13);
    return;
}
...
implementation {:origName "SLIC_ABORT_5_0"} SLIC_ABORT_5_0(actual_caller_8: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 348} SLIC_ERROR_ROUTINE(strConst__li2bpl14);
    return;
}
...
implementation {:origName "SLIC_sdv_IoReleaseRemoveLock_entry"} {:osmodel} SLIC_sdv_IoReleaseRemoveLock_entry(actual_caller_9: int)
{
  ...
  anon8_Then:
    assume {:partition} t == 1;
    call {:si_unique_call 349} SLIC_ABORT_7_0(caller_9);
    goto anon9_Then, anon9_Else;
...
procedure {:origName "sdv_IoReleaseRemoveLock"} sdv_IoReleaseRemoveLock(actual_sdv_137: int, actual_sdv_138: int) returns (Tmp_324: int);
  modifies alloc, LockDepth, yogi_error;
  free ensures {:va_keep} old(LockDepth) != 0 ==> yogi_error == 0;
  free ensures {:va_keep} old(t) == 0 ==> yogi_error == 0;
  free ensures {:va_keep} old(LockDepth) > 0 ==> LockDepth == old(LockDepth) - 1;
...
implementation {:origName "sdv_IoReleaseRemoveLock"} sdv_IoReleaseRemoveLock(actual_sdv_137: int, actual_sdv_138: int) returns (Tmp_324: int)
{
  var {:scalar} sdv_139: int;

  anon0:
    call {:si_unique_call 350} Tmp_324 := __HAVOC_malloc(4);
    call {:si_unique_call 351} sdv_139 := __HAVOC_malloc(4);
    call {:si_unique_call 352} SLIC_sdv_IoReleaseRemoveLock_entry(strConst__li2bpl10);
    goto anon3_Then, anon3_Else;
...
procedure {:origName "PpaCommand"} PpaCommand(actual_Extension_19: int) returns (Tmp_336: int);
  modifies alloc;
  free ensures {:va_keep} Tmp_336 == 0 || Tmp_336 == 1;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} false || old(t) == 1 || old(t) == 0;
  free ensures {:va_keep} alloc >= old(alloc);
  free ensures {:va_keep} false || t == 1 || t == 0;
...
implementation {:origName "PpaCommand"} PpaCommand(actual_Extension_19: int) returns (Tmp_336: int)
{
  ...
  anon3_Then:
    call {:si_unique_call 353} success_5 := VPI1Command(Extension_19);
    Tmp_336 := success_5;
    goto L1;
}
...
implementation {:origName "PpaPortLock"} PpaPortLock(actual_Extension_20: int, actual_Wait_1: int, actual_pDeviceObject: int)
{
  ...
  anon0:
    call {:si_unique_call 354} Event_4 := __HAVOC_malloc(124);
    call {:si_unique_call 355} vslice_dummy_var_67 := __HAVOC_malloc(4);
  ...
  anon17_Else:
    call {:si_unique_call 356} status_5 := sdv_IoAcquireRemoveLock(0, 0);
    goto anon18_Then, anon18_Else;

  anon18_Else:
    assume {:partition} status_5 >= 0;
    call {:si_unique_call 357} PpaInitializeLockIrp(Extension_20);
    goto anon19_Then, anon19_Else;

  anon19_Else:
    assume {:partition} Wait_1 != 0;
    call {:si_unique_call 358} KeInitializeEvent(Event_4, 0, 0);
    assume {:nonnull} Extension_20 != 0;
    assume Extension_20 > 0;
    havoc vslice_dummy_var_190;
    call {:si_unique_call 359} sdv_IoSetCompletionRoutine(vslice_dummy_var_190, li2bplFunctionConstant134, Event_4, 1, 1, 1);
    goto L26;
  ...
  L26:
    ...
    call {:si_unique_call 360} status_5 := sdv_IoCallDriver#1(vslice_dummy_var_191, vslice_dummy_var_192);
    goto anon22_Then, anon22_Else;
  ...
  anon21_Else:
    ...
    call {:si_unique_call 361} vslice_dummy_var_68 := KeWaitForSingleObject(0, 0, 0, 0, 0);
    goto L33;
  ...
  L37:
    assume {:nonnull} Extension_20 != 0;
    assume Extension_20 > 0;
    call {:si_unique_call 362} vslice_dummy_var_69 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(Extension_20), Extension_20);
    goto anon24_Then, anon24_Else;
  ...
  anon19_Then:
    ...
    call {:si_unique_call 363} sdv_IoSetCompletionRoutine(vslice_dummy_var_193, li2bplFunctionConstant199, pDeviceObject, 1, 1, 1);
    goto L26;
...
procedure {:origName "PpaStatus"} PpaStatus(actual_Extension_22: int) returns (Tmp_344: int);
  modifies alloc;
...
implementation {:origName "PpaStatus"} PpaStatus(actual_Extension_22: int) returns (Tmp_344: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 364} Tmp_346 := __HAVOC_malloc(64);
    goto anon21_Then, anon21_Else;
  ...
  anon21_Then:
    call {:si_unique_call 365} endingStatus_1 := VPI1Status(Extension_22);
...
implementation {:origName "_sdv_init6"} _sdv_init6()
{
  ...
  anon0:
    call {:si_unique_call 366} vslice_dummy_var_70 := __HAVOC_malloc(4);
    return;
}



procedure {:origName "PpaStartExecution"} PpaStartExecution(actual_Extension_23: int) returns (Tmp_353: int);
  modifies alloc;
  free ensures {:va_keep} Tmp_353 == 0 || Tmp_353 == -1073741823;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} false || old(t) == 1 || old(t) == 0;
  free ensures {:va_keep} alloc >= old(alloc);
  free ensures {:va_keep} false || t == 1 || t == 0;
...
implementation {:origName "PpaStartExecution"} PpaStartExecution(actual_Extension_23: int) returns (Tmp_353: int)
{
  ...
  anon12_Else:
    call {:si_unique_call 367} vslice_dummy_var_72 := PpaResetBus(Extension_23);
    goto L13;
  ...
  anon15_Then:
    call {:si_unique_call 368} vslice_dummy_var_71 := PpaContinueExecution(Extension_23);
    goto L13;
...
procedure {:origName "PpaContinueExecution"} PpaContinueExecution(actual_Extension_24: int) returns (Tmp_358: int);
  modifies alloc;
  free ensures {:va_keep} Tmp_358 == 0 || Tmp_358 == -1073741823;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} false || old(t) == 1 || old(t) == 0;
  free ensures {:va_keep} alloc >= old(alloc);
  free ensures {:va_keep} false || t == 1 || t == 0;
...
implementation {:origName "PpaContinueExecution"} PpaContinueExecution(actual_Extension_24: int) returns (Tmp_358: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 369} Tmp_362 := __HAVOC_malloc(64);
    call {:si_unique_call 370} Tmp_363 := __HAVOC_malloc(64);
    success_6 := 0;
    assume {:nonnull} Extension_24 != 0;
    assume Extension_24 > 0;
    call {:si_unique_call 371} success_6 := VPI1SetupDrive(Extension_24);
    goto anon5_Then, anon5_Else;
  ...
  L13:
    call {:si_unique_call 372} PpaPhaseMan(Extension_24);
    call {:si_unique_call 373} vslice_dummy_var_73 := VPI1RestoreDrive(Extension_24);
    assume {:nonnull} Extension_24 != 0;
    assume Extension_24 > 0;
    Tmp_358 := 0;
    goto L1;
...
implementation {:origName "PpaPhaseMan"} PpaPhaseMan(actual_Extension_25: int)
{
  ...
  anon0:
    call {:si_unique_call 374} vslice_dummy_var_74 := __HAVOC_malloc(4);
  ...
  L8:
    call {:si_unique_call 375} i_5, Tmp_364, sdv_166, sdv_170, sdv_171, sdv_172, sdv_173, sdv_174, Tmp_372, CurrPhase, busBusy, vslice_dummy_var_80 := PpaPhaseMan_loop_L8(i_5, Tmp_364, sdv_166, sdv_170, sdv_171, sdv_172, sdv_173, sdv_174, Tmp_372, CurrPhase, busBusy, Extension_25, vslice_dummy_var_80);
    goto L8_last;
  ...
  anon32_Else:
    call {:si_unique_call 376} sdv_166 := VPI1GetPhase(Extension_25, 0);
    goto anon33_Then, anon33_Else;
  ...
  anon42_Else:
    call {:si_unique_call 377} sdv_174 := PpaStatus(Extension_25);
    goto anon35_Then, anon35_Else;
  ...
  anon35_Then:
    assume {:partition} sdv_174 == 0;
    call {:si_unique_call 378} vslice_dummy_var_75 := PpaResetBus(Extension_25);
    assume {:nonnull} Extension_25 != 0;
    assume Extension_25 > 0;
    havoc Tmp_368;
  ...
  anon42_Then:
    busBusy := 0;
    call {:si_unique_call 379} vslice_dummy_var_80 := PpaResetBus(Extension_25);
    assume {:nonnull} Extension_25 != 0;
    assume Extension_25 > 0;
    havoc Tmp_372;
  ...
  anon43_Then:
    call {:si_unique_call 380} sdv_173 := PpaCommand(Extension_25);
    goto anon36_Then, anon36_Else;

  anon36_Else:
    assume {:partition} sdv_173 == 0;
    call {:si_unique_call 381} vslice_dummy_var_76 := PpaResetBus(Extension_25);
    assume {:nonnull} Extension_25 != 0;
    assume Extension_25 > 0;
    havoc Tmp_370;
  ...
  anon44_Then:
    call {:si_unique_call 382} sdv_172 := PpaDataIn(Extension_25);
    goto anon37_Then, anon37_Else;

  anon37_Else:
    assume {:partition} sdv_172 == 0;
    call {:si_unique_call 383} vslice_dummy_var_77 := PpaResetBus(Extension_25);
    assume {:nonnull} Extension_25 != 0;
    assume Extension_25 > 0;
    havoc Tmp_373;
  ...
  anon34_Then:
    call {:si_unique_call 384} sdv_170 := PpaDataOut(Extension_25);
    goto anon38_Then, anon38_Else;

  anon38_Else:
    assume {:partition} sdv_170 == 0;
    call {:si_unique_call 385} vslice_dummy_var_78 := PpaResetBus(Extension_25);
    assume {:nonnull} Extension_25 != 0;
    assume Extension_25 > 0;
    havoc Tmp_367;
  ...
  L65:
    call {:si_unique_call 386} i_5, sdv_171 := PpaPhaseMan_loop_L65(i_5, sdv_171, CurrPhase, Extension_25);
    goto L65_last;
  ...
  anon45_Else:
    ...
    call {:si_unique_call 387} sdv_171 := VPI1GetPhase(Extension_25, 0);
    goto anon40_Then, anon40_Else;
  ...
  anon39_Else:
    ...
    call {:si_unique_call 388} vslice_dummy_var_79 := PpaResetBus(Extension_25);
    assume {:nonnull} Extension_25 != 0;
    assume Extension_25 > 0;
    havoc Tmp_371;
...
procedure {:origName "PpaDataIn"} PpaDataIn(actual_Extension_26: int) returns (Tmp_374: int);
  modifies alloc;
  free ensures {:va_keep} Tmp_374 == 0 || Tmp_374 == 1;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} false || old(t) == 1 || old(t) == 0;
  free ensures {:va_keep} alloc >= old(alloc);
  free ensures {:va_keep} false || t == 1 || t == 0;
...
implementation {:origName "PpaDataIn"} PpaDataIn(actual_Extension_26: int) returns (Tmp_374: int)
{
  ...
  anon6_Else:
    call {:si_unique_call 389} success_7 := VPI1DataIn(Extension_26);
    Tmp_374 := success_7;
    goto L1;
...
procedure {:origName "PpaResetBus"} PpaResetBus(actual_Extension_27: int) returns (Tmp_376: int);
  free ensures {:va_keep} Tmp_376 == 0 || Tmp_376 == -1073741823;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} false || old(t) == 1 || old(t) == 0;
  free ensures {:va_keep} alloc >= old(alloc);
  free ensures {:va_keep} false || t == 1 || t == 0;
...
implementation {:origName "PpaResetBus"} PpaResetBus(actual_Extension_27: int) returns (Tmp_376: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 390} sdv_178 := VPI1ResetBus(Extension_27);
    goto anon3_Then, anon3_Else;
...
procedure {:origName "PpaDataOut"} PpaDataOut(actual_Extension_28: int) returns (Tmp_378: int);
  modifies alloc;
  free ensures {:va_keep} Tmp_378 == 0 || Tmp_378 == 1;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} false || old(t) == 1 || old(t) == 0;
  free ensures {:va_keep} alloc >= old(alloc);
  free ensures {:va_keep} false || t == 1 || t == 0;
...
implementation {:origName "PpaDataOut"} PpaDataOut(actual_Extension_28: int) returns (Tmp_378: int)
{
  ...
  anon6_Else:
    call {:si_unique_call 391} success_8 := VPI1DataOut(Extension_28);
    Tmp_378 := success_8;
    goto L1;
...
procedure {:origName "PpaGetDeviceInfo"} PpaGetDeviceInfo(actual_Extension_29: int) returns (Tmp_380: int);
  modifies alloc, LockDepth, yogi_error, Mem_T.CompletionRoutine__IO_STACK_LOCATION;
  free ensures {:va_keep} old(t) == 0 ==> yogi_error == 0;
  free ensures {:va_keep} LockDepth <= old(LockDepth);
  free ensures {:va_keep} yogi_error == 1 || yogi_error == old(yogi_error);
...
implementation {:origName "PpaGetDeviceInfo"} PpaGetDeviceInfo(actual_Extension_29: int) returns (Tmp_380: int)
{
  ...
  anon0:
    call {:si_unique_call 392} kEvent := __HAVOC_malloc(124);
    call {:si_unique_call 393} ioStatus := __HAVOC_malloc(12);
  ...
  anon9_Then:
    call {:si_unique_call 394} KeInitializeEvent(kEvent, 0, 0);
    call {:si_unique_call 395} Irp_8 := IoBuildDeviceIoControlRequest(1441912, 0, 0, 0, 0, 64, 1, 0, ioStatus);
    goto anon10_Then, anon10_Else;
  ...
  anon10_Else:
    ...
    call {:si_unique_call 396} Status_17 := sdv_IoCallDriver#1(vslice_dummy_var_194, Irp_8);
    goto anon12_Then, anon12_Else;
  ...
  anon11_Else:
    ...
    call {:si_unique_call 397} vslice_dummy_var_81 := KeWaitForSingleObject(0, 0, 0, 0, 0);
...
procedure {:origName "PpaCloseToParclass"} PpaCloseToParclass(actual_Extension_30: int) returns (Tmp_382: int);
  modifies alloc, LockDepth, yogi_error, Mem_T.CompletionRoutine__IO_STACK_LOCATION;
  free ensures {:va_keep} old(t) == 0 ==> yogi_error == 0;
  free ensures {:va_keep} LockDepth <= old(LockDepth);
  free ensures {:va_keep} yogi_error == 1 || yogi_error == old(yogi_error);
...
implementation {:origName "PpaCloseToParclass"} PpaCloseToParclass(actual_Extension_30: int) returns (Tmp_382: int)
{
  ...
  anon0:
    call {:si_unique_call 398} kEvent_1 := __HAVOC_malloc(124);
    call {:si_unique_call 399} ioStatus_1 := __HAVOC_malloc(12);
    Extension_30 := actual_Extension_30;
    call {:si_unique_call 400} KeInitializeEvent(kEvent_1, 0, 0);
    call {:si_unique_call 401} Irp_9 := IoBuildSynchronousFsdRequest(27, 0, 0, 0, 0, 0, ioStatus_1);
    goto anon7_Then, anon7_Else;

  anon7_Else:
    assume {:partition} Irp_9 != 0;
    call {:si_unique_call 402} pIrpStack := sdv_IoGetNextIrpStackLocation(Irp_9);
    assume {:nonnull} pIrpStack != 0;
    assume pIrpStack > 0;
    assume {:nonnull} Extension_30 != 0;
    assume Extension_30 > 0;
    havoc vslice_dummy_var_195;
    call {:si_unique_call 403} Status_18 := sdv_IoCallDriver#1(vslice_dummy_var_195, Irp_9);
    goto anon9_Then, anon9_Else;
  ...
  anon8_Else:
    ...
    call {:si_unique_call 404} vslice_dummy_var_82 := KeWaitForSingleObject(0, 0, 0, 0, 0);
...
procedure {:origName "CheckPort"} CheckPort(actual_wPortAddr: int, actual_bMask: int, actual_bValue: int, actual_msTimeDelay: int) returns (Tmp_384: int);
  modifies alloc;
  free ensures {:va_keep} Tmp_384 == 1 || Tmp_384 == 0;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} false || old(t) == 1 || old(t) == 0;
  free ensures {:va_keep} alloc >= old(alloc);
  free ensures {:va_keep} false || t == 1 || t == 0;
...
implementation {:origName "CheckPort"} CheckPort(actual_wPortAddr: int, actual_bMask: int, actual_bValue: int, actual_msTimeDelay: int) returns (Tmp_384: int)
{
  ...
  anon0:
    call {:si_unique_call 405} Wait_3 := __HAVOC_malloc(20);
    call {:si_unique_call 406} End := __HAVOC_malloc(20);
    call {:si_unique_call 407} Start := __HAVOC_malloc(20);
    bMask := actual_bMask;
    bValue := actual_bValue;
    msTimeDelay := actual_msTimeDelay;
    call {:si_unique_call 408} dsr := corral_nondet();
    Tmp_389 := BAND(dsr, bMask);
    goto anon12_Then, anon12_Else;

  anon12_Else:
    assume {:partition} Tmp_389 == bValue;
    Tmp_384 := 1;
    goto L1;
  ...
  anon12_Then:
    assume {:partition} Tmp_389 != bValue;
    call {:si_unique_call 409} sdv_188 := corral_nondet();
  ...
  L21:
    call {:si_unique_call 410} CheckPort_loop_L21(s_p_e_c_i_a_l_1, Start);
    goto L21_last;
  ...
  L29:
    call {:si_unique_call 411} Tmp_385, Tmp_387, s_p_e_c_i_a_l_2, sdv_190, dsr := CheckPort_loop_L29(Tmp_385, Tmp_387, Wait_3, s_p_e_c_i_a_l_2, sdv_190, End, Start, dsr, bMask, bValue);
    goto L29_last;
  ...
  L31:
    call {:si_unique_call 412} CheckPort_loop_L31(s_p_e_c_i_a_l_2, End);
    goto L31_last;
  ...
  anon14_Else:
    call {:si_unique_call 413} dsr := corral_nondet();
    Tmp_385 := BAND(dsr, bMask);
    goto anon15_Then, anon15_Else;

  anon15_Else:
    assume {:partition} Tmp_385 == bValue;
    Tmp_384 := 1;
    goto L1;

  anon15_Then:
    assume {:partition} Tmp_385 != bValue;
    call {:si_unique_call 414} sdv_190 := corral_nondet();
    assume {:nonnull} End != 0;
    assume End > 0;
    assume {:nonnull} Start != 0;
    assume Start > 0;
...
procedure {:origName "PpaHWTransferOk"} PpaHWTransferOk(actual_Extension_31: int) returns (Tmp_390: int);
  free ensures {:va_keep} Tmp_390 == 0 || Tmp_390 == 1;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} false || old(t) == 1 || old(t) == 0;
  free ensures {:va_keep} alloc >= old(alloc);
  free ensures {:va_keep} false || t == 1 || t == 0;
...
implementation {:origName "PpaHWTransferOk"} PpaHWTransferOk(actual_Extension_31: int) returns (Tmp_390: int)
{
...
implementation {:origName "_sdv_init3"} _sdv_init3()
{
  ...
  anon0:
    call {:si_unique_call 415} vslice_dummy_var_83 := __HAVOC_malloc(4);
    return;
}



procedure {:origName "PpaGetTransferMode"} PpaGetTransferMode(actual_Extension_32: int) returns (Tmp_394: int);
  modifies alloc, Mem_T.CompletionRoutine__IO_STACK_LOCATION, LockDepth, yogi_error;
  free ensures {:va_keep} old(t) == 0 ==> yogi_error == 0;
  free ensures {:va_keep} yogi_error == 1 || yogi_error == old(yogi_error);
  free ensures {:va_keep} old(yogi_error) == 0;
...
implementation {:origName "PpaGetTransferMode"} PpaGetTransferMode(actual_Extension_32: int) returns (Tmp_394: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 416} PpaPortLock(Extension_32, 1, 0);
    goto anon49_Then, anon49_Else;
  ...
  anon50_Else:
    ...
    call {:si_unique_call 417} sdv_192 := PpaHWTransferOk(Extension_32);
    goto anon37_Then, anon37_Else;
  ...
  anon41_Else:
    call {:si_unique_call 418} sdv_193 := PpaHWTransferOk(Extension_32);
    goto anon42_Then, anon42_Else;
  ...
  L39:
    call {:si_unique_call 419} PpaPortUnlock#1(Extension_32, 1, 0);
    goto anon51_Then, anon51_Else;
  ...
  anon36_Else:
    ...
    call {:si_unique_call 420} sdv_194 := PpaHWTransferOk(Extension_32);
    goto anon47_Then, anon47_Else;
...
procedure {:origName "PpaCreateToParclass"} PpaCreateToParclass(actual_Extension_33: int) returns (Tmp_396: int);
  modifies alloc, LockDepth, yogi_error, Mem_T.CompletionRoutine__IO_STACK_LOCATION;
  free ensures {:va_keep} old(t) == 0 ==> yogi_error == 0;
  free ensures {:va_keep} LockDepth <= old(LockDepth);
  free ensures {:va_keep} yogi_error == 1 || yogi_error == old(yogi_error);
...
implementation {:origName "PpaCreateToParclass"} PpaCreateToParclass(actual_Extension_33: int) returns (Tmp_396: int)
{
  ...
  anon0:
    call {:si_unique_call 421} kEvent_2 := __HAVOC_malloc(124);
    call {:si_unique_call 422} ioStatus_2 := __HAVOC_malloc(12);
    Extension_33 := actual_Extension_33;
    call {:si_unique_call 423} KeInitializeEvent(kEvent_2, 0, 0);
    call {:si_unique_call 424} Irp_10 := IoBuildSynchronousFsdRequest(27, 0, 0, 0, 0, 0, ioStatus_2);
    goto anon7_Then, anon7_Else;

  anon7_Else:
    assume {:partition} Irp_10 != 0;
    call {:si_unique_call 425} pIrpStack_1 := sdv_IoGetNextIrpStackLocation(Irp_10);
    ...
    call {:si_unique_call 426} Status_20 := sdv_IoCallDriver#1(vslice_dummy_var_196, Irp_10);
    goto anon9_Then, anon9_Else;
  ...
  anon8_Else:
    ...
    call {:si_unique_call 427} vslice_dummy_var_84 := KeWaitForSingleObject(0, 0, 0, 0, 0);
...
procedure {:origName "PpaRequestCompletionRoutine"} PpaRequestCompletionRoutine(actual_DeviceObject_14: int, actual_Irp_11: int, actual_EventIn: int) returns (Tmp_398: int);
  free ensures {:va_keep} Tmp_398 == -1073741802;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} false || old(t) == 1 || old(t) == 0;
  free ensures {:va_keep} alloc >= old(alloc);
  free ensures {:va_keep} false || t == 1 || t == 0;
...
implementation {:origName "PpaRequestCompletionRoutine"} PpaRequestCompletionRoutine(actual_DeviceObject_14: int, actual_Irp_11: int, actual_EventIn: int) returns (Tmp_398: int)
{
  ...
  anon0:
    ...
    Event_6 := EventIn;
    call {:si_unique_call 428} vslice_dummy_var_85 := KeSetEvent(Event_6, 1, 0);
    Tmp_398 := -1073741802;
    return;
}
...
procedure {:origName "PpaScsiSendPassThrough"} PpaScsiSendPassThrough(actual_Extension_34: int, actual_RequestIrp: int) returns (Tmp_400: int);
  modifies alloc, LockDepth, yogi_error, Mem_T.CompletionRoutine__IO_STACK_LOCATION;
  free ensures {:va_keep} old(t) == 0 ==> yogi_error == 0;
  free ensures {:va_keep} LockDepth <= old(LockDepth);
  free ensures {:va_keep} yogi_error == 1 || yogi_error == old(yogi_error);
...
implementation {:origName "PpaScsiSendPassThrough"} PpaScsiSendPassThrough(actual_Extension_34: int, actual_RequestIrp: int) returns (Tmp_400: int)
{
  ...
  anon0:
    call {:si_unique_call 429} startingOffset := __HAVOC_malloc(20);
    call {:si_unique_call 430} ioStatusBlock := __HAVOC_malloc(12);
    call {:si_unique_call 431} srb := __HAVOC_malloc(92);
    call {:si_unique_call 432} event := __HAVOC_malloc(124);
    Extension_34 := actual_Extension_34;
    RequestIrp := actual_RequestIrp;
    call {:si_unique_call 433} Tmp_406 := __HAVOC_malloc(64);
    call {:si_unique_call 434} Tmp_409 := __HAVOC_malloc(64);
    call {:si_unique_call 435} Tmp_412 := __HAVOC_malloc(64);
    call {:si_unique_call 436} sdv_do_paged_code_check();
    assume {:nonnull} startingOffset != 0;
    assume startingOffset > 0;
    call {:si_unique_call 437} irpStack := sdv_IoGetCurrentIrpStackLocation(RequestIrp);
  ...
  anon127_Else:
    ...
    assume srbControl > 0;
    havoc Tmp_410;
    call {:si_unique_call 438} senseBuffer := ExAllocatePoolWithTag(4, Tmp_410, -965582512);
  ...
  L87:
    call {:si_unique_call 439} KeInitializeEvent(event, 0, 0);
    Tmp_402 := majorCode;
    call {:si_unique_call 440} irp := IoBuildSynchronousFsdRequest(Tmp_402, 0, 0, length, 0, 0, ioStatusBlock);
    goto anon129_Then, anon129_Else;

  anon129_Else:
    assume {:partition} irp != 0;
    call {:si_unique_call 441} irpStack := sdv_IoGetNextIrpStackLocation(irp);
    assume {:nonnull} irpStack != 0;
    assume irpStack > 0;
    assume {:nonnull} irpStack != 0;
    assume irpStack > 0;
  ...
  anon133_Else:
    call {:si_unique_call 443} sdv_KeFlushIoBuffers(0, 0, 1);
    goto L135;
  ...
  L135:
    ...
    assume srbControl > 0;
    havoc Tmp_413;
    call {:si_unique_call 444} sdv_RtlCopyMemory(0, 0, Tmp_413);
  ...
  L146:
    ...
    call {:si_unique_call 445} status_8 := sdv_IoCallDriver#1(vslice_dummy_var_197, irp);
  ...
  anon135_Else:
    ...
    call {:si_unique_call 446} vslice_dummy_var_86 := KeWaitForSingleObject(0, 0, 0, 0, 0);
    goto L151;
  ...
  anon157_Else:
    ...
    assume srb > 0;
    havoc Tmp_405;
    call {:si_unique_call 447} sdv_RtlCopyMemory(0, 0, Tmp_405);
    goto L164;
...
implementation {:origName "PpaCompleteRequest"} PpaCompleteRequest(actual_Extension_35: int, actual_pIrp: int, actual_Status_21: int)
{
  ...
  anon0:
    call {:si_unique_call 450} vslice_dummy_var_87 := __HAVOC_malloc(4);
    Extension_35 := actual_Extension_35;
    pIrp := actual_pIrp;
    Status_21 := actual_Status_21;
    call {:si_unique_call 451} pIrpStack_2 := sdv_IoGetCurrentIrpStackLocation(pIrp);
  ...
  anon21_Else:
    call {:si_unique_call 452} sdv_209 := sdv_MmGetMdlVirtualAddress(0);
    assume {:nonnull} srb_1 != 0;
    assume srb_1 > 0;
    assume {:nonnull} srb_1 != 0;
    assume srb_1 > 0;
  ...
  anon28_Else:
    call {:si_unique_call 453} sdv_KeFlushIoBuffers(0, 1, 0);
    goto L11;
  ...
  anon25_Else:
    call {:si_unique_call 454} sdv_211 := PpaIssueRequestSense(Extension_35, pIrp);
    goto anon26_Then, anon26_Else;
  ...
  anon26_Else:
    ...
    assume {:nonnull} pIrp != 0;
    assume pIrp > 0;
    call {:si_unique_call 455} boogieTmp := PpaInterpretSenseInfo(srb_1);
    goto L1;
  ...
  anon26_Then:
    ...
    assume {:nonnull} pIrp != 0;
    assume pIrp > 0;
    call {:si_unique_call 456} boogieTmp := PpaTranslateScsiStatus(srb_1);
    goto L1;
  ...
  L28:
    assume {:nonnull} pIrp != 0;
    assume pIrp > 0;
    call {:si_unique_call 457} boogieTmp := PpaTranslateScsiStatus(srb_1);
    goto L1;
...
procedure {:origName "PpaInterpretSenseInfo"} PpaInterpretSenseInfo(actual_Srb: int) returns (Tmp_417: int);
  free ensures {:va_keep} Tmp_417 == -1073741435 || Tmp_417 == -1073741823 || Tmp_417 == -1073741790 || Tmp_417 == 32 || Tmp_417 == -1073741808 || Tmp_417 == 17 || Tmp_417 == -1073741805;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} false || old(t) == 1 || old(t) == 0;
  free ensures {:va_keep} alloc >= old(alloc);
  free ensures {:va_keep} false || t == 1 || t == 0;
...
implementation {:origName "PpaInterpretSenseInfo"} PpaInterpretSenseInfo(actual_Srb: int) returns (Tmp_417: int)
{
...
implementation {:origName "_sdv_init5"} _sdv_init5()
{
  ...
  anon0:
    call {:si_unique_call 458} vslice_dummy_var_88 := __HAVOC_malloc(4);
    return;
}



procedure {:origName "PpaScsiRequests"} PpaScsiRequests(actual_DeviceObject_15: int, actual_pIrp_1: int) returns (Tmp_421: int);
  modifies alloc, LockDepth, yogi_error;
  free ensures {:va_keep} old(t) == 0 ==> yogi_error == 0;
  free ensures {:va_keep} old(LockDepth) > 0 ==> yogi_error == 0;
  free ensures {:va_keep} yogi_error == 1 || yogi_error == old(yogi_error);
...
implementation {:origName "PpaScsiRequests"} PpaScsiRequests(actual_DeviceObject_15: int, actual_pIrp_1: int) returns (Tmp_421: int)
{
  ...
  anon0:
    ...
    pIrp_1 := actual_pIrp_1;
    call {:si_unique_call 459} pIrpStack_3 := sdv_IoGetCurrentIrpStackLocation(pIrp_1);
    assume {:nonnull} DeviceObject_15 != 0;
    assume DeviceObject_15 > 0;
    havoc Extension_36;
    call {:si_unique_call 460} Status_23 := sdv_IoAcquireRemoveLock(0, 0);
    goto anon31_Then, anon31_Else;
  ...
  anon32_Else:
    ...
    call {:si_unique_call 462} vslice_dummy_var_89 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(Extension_36), pIrp_1);
    goto anon44_Then, anon44_Else;
  ...
  anon38_Then:
    call {:si_unique_call 466} Tmp_422 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_422 != 0;
    assume Tmp_422 > 0;
    call {:si_unique_call 467} sdv_KeAcquireSpinLock(0, Tmp_422);
    assume {:nonnull} Tmp_422 != 0;
    assume Tmp_422 > 0;
    havoc cIrql;
    assume {:nonnull} Extension_36 != 0;
    assume Extension_36 > 0;
    call {:si_unique_call 468} sdv_KeReleaseSpinLock(0, cIrql);
    Status_23 := 0;
    assume {:nonnull} srb_2 != 0;
    assume srb_2 > 0;
    goto L19;
  ...
  anon39_Then:
    call {:si_unique_call 469} Tmp_422 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_422 != 0;
    assume Tmp_422 > 0;
    call {:si_unique_call 470} sdv_KeAcquireSpinLock(0, Tmp_422);
    assume {:nonnull} Tmp_422 != 0;
    assume Tmp_422 > 0;
    havoc cIrql;
    assume {:nonnull} Extension_36 != 0;
    ...
    assume {:nonnull} srb_2 != 0;
    assume srb_2 > 0;
    call {:si_unique_call 472} PpaInitializeQueueIrp(Extension_36);
    call {:si_unique_call 473} sdv_IoMarkIrpPending(0);
    call {:si_unique_call 474} IoStartPacket(0, 0, 0, 0);
    goto L19;
  ...
  anon42_Then:
    call {:si_unique_call 475} Tmp_422 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_422 != 0;
    assume Tmp_422 > 0;
    call {:si_unique_call 476} sdv_KeAcquireSpinLock(0, Tmp_422);
    assume {:nonnull} Tmp_422 != 0;
    assume Tmp_422 > 0;
    havoc cIrql;
    assume {:nonnull} Extension_36 != 0;
    assume Extension_36 > 0;
    call {:si_unique_call 477} sdv_KeReleaseSpinLock(0, cIrql);
    Status_23 := 0;
    assume {:nonnull} srb_2 != 0;
    assume srb_2 > 0;
    goto L19;
  ...
  anon43_Then:
    call {:si_unique_call 478} Tmp_422 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_422 != 0;
    assume Tmp_422 > 0;
    call {:si_unique_call 479} sdv_KeAcquireSpinLock(0, Tmp_422);
    assume {:nonnull} Tmp_422 != 0;
    assume Tmp_422 > 0;
    havoc cIrql;
    assume {:nonnull} Extension_36 != 0;
  ...
  anon36_Then:
    ...
    call {:si_unique_call 482} IoStartPacket(0, 0, 0, 0);
    goto L19;
}



procedure {:origName "PpaIssueInquiry"} PpaIssueInquiry(actual_Extension_37: int) returns (Tmp_423: int);
  modifies alloc;
  free ensures {:va_keep} Tmp_423 == 0 || Tmp_423 == -1073741823 || Tmp_423 == -1073741670;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} false || old(t) == 1 || old(t) == 0;
  free ensures {:va_keep} alloc >= old(alloc);
  free ensures {:va_keep} false || t == 1 || t == 0;
...
implementation {:origName "PpaIssueInquiry"} PpaIssueInquiry(actual_Extension_37: int) returns (Tmp_423: int)
{
  var {:pointer} cdb: int;
  ...
  anon0:
    ...
    retryCount := 0;
    call {:si_unique_call 483} sdv_215 := ExAllocatePoolWithTag(4, 64, -965582512);
    srb_3 := sdv_215;
    goto anon22_Then, anon22_Else;
  ...
  L14:
    call {:si_unique_call 484} cdb, Tmp_424, Tmp_425, Tmp_426, status_9, Tmp_428, retryCount := PpaIssueInquiry_loop_L14(cdb, Tmp_424, Tmp_425, Tmp_426, srb_3, status_9, Tmp_428, retryCount, Extension_37);
    goto L14_last;

  L14_last:
    call {:si_unique_call 486} sdv_RtlZeroMemory(0, 64);
    ...
    assume {:nonnull} Extension_37 != 0;
    assume Extension_37 > 0;
    call {:si_unique_call 487} IoStartTimer(0);
    call {:si_unique_call 488} status_9 := PpaStartExecution(Extension_37);
    assume {:nonnull} Extension_37 != 0;
    assume Extension_37 > 0;
    call {:si_unique_call 489} IoStopTimer(0);
    goto anon19_Then, anon19_Else;
...
procedure {:origName "PpaPortUnlockCompletionRoutine"} PpaPortUnlockCompletionRoutine(actual_pDeviceObject_2: int, actual_Irp_12: int, actual_ContextIn: int) returns (Tmp_429: int);
  modifies alloc;
  free ensures {:va_keep} Tmp_429 == -1073741802;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} false || old(t) == 1 || old(t) == 0;
  free ensures {:va_keep} alloc >= old(alloc);
  free ensures {:va_keep} false || t == 1 || t == 0;
...
implementation {:origName "PpaPortUnlockCompletionRoutine"} PpaPortUnlockCompletionRoutine(actual_pDeviceObject_2: int, actual_Irp_12: int, actual_ContextIn: int) returns (Tmp_429: int)
{
  ...
  L9:
    call {:si_unique_call 490} sdv_217 := sdv_KeGetCurrentIrql();
    goto anon5_Then, anon5_Else;

  anon5_Else:
    assume {:partition} 2 > sdv_217;
    call {:si_unique_call 491} oldIrql := KeRaiseIrqlToDpcLevel();
    call {:si_unique_call 492} IoStartNextPacket(0, 0);
    call {:si_unique_call 493} sdv_KeLowerIrql(oldIrql);
    goto L27;
  ...
  anon5_Then:
    ...
    call {:si_unique_call 494} IoStartNextPacket(0, 0);
    goto L27;
...
procedure {:origName "PpaIssueRequestSense"} PpaIssueRequestSense(actual_Extension_40: int, actual_pIrp_2: int) returns (Tmp_435: int);
  modifies alloc;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} false || old(t) == 1 || old(t) == 0;
  free ensures {:va_keep} alloc >= old(alloc);
...
implementation {:origName "PpaIssueRequestSense"} PpaIssueRequestSense(actual_Extension_40: int, actual_pIrp_2: int) returns (Tmp_435: int)
{
  ...
  anon0:
    ...
    pIrp_2 := actual_pIrp_2;
    call {:si_unique_call 495} Tmp_436 := __HAVOC_malloc(64);
    call {:si_unique_call 496} Tmp_443 := __HAVOC_malloc(64);
    call {:si_unique_call 497} Tmp_445 := __HAVOC_malloc(64);
    call {:si_unique_call 498} Tmp_447 := __HAVOC_malloc(64);
    call {:si_unique_call 499} Tmp_448 := __HAVOC_malloc(64);
    call {:si_unique_call 500} Tmp_450 := __HAVOC_malloc(64);
    call {:si_unique_call 501} pIrpStack_4 := sdv_IoGetCurrentIrpStackLocation(pIrp_2);
    retryCount_1 := 0;
    call {:si_unique_call 502} sdv_223 := ExAllocatePoolWithTag(0, 68, -965582512);
    srb_4 := sdv_223;
    goto anon20_Then, anon20_Else;
  ...
  L18:
    call {:si_unique_call 503} Tmp_436, Tmp_437, Tmp_438, Tmp_439, Tmp_440, Tmp_442, Tmp_443, Tmp_445, Tmp_446, status_11, Tmp_447, Tmp_448, retryCount_1, Tmp_449, Tmp_450 := PpaIssueRequestSense_loop_L18(Tmp_436, Tmp_437, Tmp_438, Tmp_439, Tmp_440, Tmp_442, pIrpStack_4, Tmp_443, Tmp_445, Tmp_446, srb_4, status_11, Tmp_447, Tmp_448, retryCount_1, Tmp_449, Tmp_450, Extension_40);
    goto L18_last;

  L18_last:
    call {:si_unique_call 505} sdv_RtlZeroMemory(0, 64);
    ...
    assume {:nonnull} Extension_40 != 0;
    assume Extension_40 > 0;
    call {:si_unique_call 506} IoStartTimer(0);
    call {:si_unique_call 507} status_11 := PpaStartExecution(Extension_40);
    assume {:nonnull} Extension_40 != 0;
    assume Extension_40 > 0;
    call {:si_unique_call 508} IoStopTimer(0);
    goto anon17_Then, anon17_Else;
...
procedure {:origName "PpaTranslateScsiStatus"} PpaTranslateScsiStatus(actual_Srb_1: int) returns (Tmp_451: int);
  free ensures {:va_keep} Tmp_451 == -1073741435;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} false || old(t) == 1 || old(t) == 0;
  free ensures {:va_keep} alloc >= old(alloc);
  free ensures {:va_keep} false || t == 1 || t == 0;
...
implementation {:origName "PpaTranslateScsiStatus"} PpaTranslateScsiStatus(actual_Srb_1: int) returns (Tmp_451: int)
{
...
procedure {:origName "PpaQueryProperty"} PpaQueryProperty(actual_pDeviceObject_4: int, actual_QueryIrp: int) returns (Tmp_453: int);
  modifies alloc;
  free ensures {:va_keep} Tmp_453 == -1073741585 || Tmp_453 == 0;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} false || old(t) == 1 || old(t) == 0;
  free ensures {:va_keep} alloc >= old(alloc);
  free ensures {:va_keep} false || t == 1 || t == 0;
...
implementation {:origName "PpaQueryProperty"} PpaQueryProperty(actual_pDeviceObject_4: int, actual_QueryIrp: int) returns (Tmp_453: int)
{
  ...
  anon0:
    call {:si_unique_call 509} queryLength := __HAVOC_malloc(4);
    pDeviceObject_4 := actual_pDeviceObject_4;
    QueryIrp := actual_QueryIrp;
    call {:si_unique_call 510} irpStack_1 := sdv_IoGetCurrentIrpStackLocation(QueryIrp);
  ...
  anon16_Else:
    ...
    assume {:nonnull} QueryIrp != 0;
    assume QueryIrp > 0;
    call {:si_unique_call 513} sdv_IoCompleteRequest(0, 1);
    goto L38;
  ...
  anon18_Then:
    assume {:nonnull} QueryIrp != 0;
    assume QueryIrp > 0;
    Tmp_455 := AssociatedIrp__IRP(QueryIrp);
    assume {:nonnull} Tmp_455 != 0;
    assume Tmp_455 > 0;
    havoc vslice_dummy_var_198;
    call {:si_unique_call 514} Status_25 := PpaBuildAdapterDescriptor(pDeviceObject_4, vslice_dummy_var_198, queryLength);
    assume {:nonnull} QueryIrp != 0;
    assume QueryIrp > 0;
    assume {:nonnull} queryLength != 0;
    assume queryLength > 0;
  ...
  anon15_Then:
    assume {:nonnull} QueryIrp != 0;
    assume QueryIrp > 0;
    Tmp_456 := AssociatedIrp__IRP(QueryIrp);
    assume {:nonnull} Tmp_456 != 0;
    assume Tmp_456 > 0;
    havoc vslice_dummy_var_199;
    call {:si_unique_call 515} Status_25 := PpaBuildDeviceDescriptor(pDeviceObject_4, vslice_dummy_var_199, queryLength);
    assume {:nonnull} QueryIrp != 0;
    assume QueryIrp > 0;
    assume {:nonnull} queryLength != 0;
    assume queryLength > 0;
...
procedure {:origName "PpaBuildAdapterDescriptor"} PpaBuildAdapterDescriptor(actual_pDeviceObject_5: int, actual_Descriptor: int, actual_DescriptorLength: int) returns (Tmp_457: int);
  modifies alloc;
  free ensures {:va_keep} Tmp_457 == 0;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} false || old(t) == 1 || old(t) == 0;
  free ensures {:va_keep} alloc >= old(alloc);
  free ensures {:va_keep} false || t == 1 || t == 0;
...
implementation {:origName "PpaBuildAdapterDescriptor"} PpaBuildAdapterDescriptor(actual_pDeviceObject_5: int, actual_Descriptor: int, actual_DescriptorLength: int) returns (Tmp_457: int)
{
  ...
  anon0:
    call {:si_unique_call 516} tmp := __HAVOC_malloc(48);
  ...
  L24:
    call {:si_unique_call 518} sdv_RtlCopyMemory(0, 0, Tmp_460);
    assume {:nonnull} DescriptorLength != 0;
    assume DescriptorLength > 0;
    goto anon5_Then, anon5_Else;
...
implementation {:origName "_sdv_init4"} _sdv_init4()
{
  ...
  anon0:
    call {:si_unique_call 519} vslice_dummy_var_90 := __HAVOC_malloc(4);
    return;
}



procedure {:origName "PpaBuildDeviceDescriptor"} PpaBuildDeviceDescriptor(actual_pDeviceObject_6: int, actual_Descriptor_1: int, actual_DescriptorLength_1: int) returns (Tmp_463: int);
  modifies alloc;
...
implementation {:origName "PpaBuildDeviceDescriptor"} PpaBuildDeviceDescriptor(actual_pDeviceObject_6: int, actual_Descriptor_1: int, actual_DescriptorLength_1: int) returns (Tmp_463: int)
{
  ...
  anon0:
    call {:si_unique_call 520} tmp_1 := __HAVOC_malloc(52);
  ...
  L22:
    ...
    call {:si_unique_call 522} sdv_RtlZeroMemory(0, vslice_dummy_var_200);
    call {:si_unique_call 523} sdv_RtlZeroMemory(0, 40);
  ...
  L42:
    call {:si_unique_call 524} sdv_RtlCopyMemory(0, 0, Tmp_465);
  ...
  anon31_Else:
    ...
    Tmp_468 := bytesRemaining;
    goto L53;

  L53:
    call {:si_unique_call 525} sdv_RtlCopyMemory(0, 0, Tmp_468);
  ...
  anon33_Else:
    ...
    Tmp_467 := bytesRemaining;
    goto L66;

  L66:
    call {:si_unique_call 526} sdv_RtlCopyMemory(0, 0, Tmp_467);
  ...
  anon35_Else:
    ...
    Tmp_466 := bytesRemaining;
    goto L79;

  L79:
    call {:si_unique_call 527} sdv_RtlCopyMemory(0, 0, Tmp_466);
...
procedure {:origName "PpaTrySlowerMode"} PpaTrySlowerMode(actual_Extension_44: int) returns (Tmp_469: int);
  modifies alloc;
  free ensures {:va_keep} Tmp_469 == 1 || Tmp_469 == 0;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} false || old(t) == 1 || old(t) == 0;
  free ensures {:va_keep} alloc >= old(alloc);
  free ensures {:va_keep} false || t == 1 || t == 0;
...
implementation {:origName "PpaTrySlowerMode"} PpaTrySlowerMode(actual_Extension_44: int) returns (Tmp_469: int)
{
  ...
  anon14_Else:
    ...
    assume {:nonnull} Extension_44 != 0;
    assume Extension_44 > 0;
    call {:si_unique_call 528} vslice_dummy_var_91 := PpaWriteRegistryModeValue(Extension_44);
    goto L14;
  ...
  anon15_Else:
    ...
    assume {:nonnull} Extension_44 != 0;
    assume Extension_44 > 0;
    call {:si_unique_call 529} vslice_dummy_var_92 := PpaWriteRegistryModeValue(Extension_44);
    goto L14;
  ...
  anon15_Then:
    ...
    assume {:nonnull} Extension_44 != 0;
    assume Extension_44 > 0;
    call {:si_unique_call 530} vslice_dummy_var_93 := PpaWriteRegistryModeValue(Extension_44);
    goto L14;
  ...
  anon17_Else:
    ...
    assume {:nonnull} Extension_44 != 0;
    assume Extension_44 > 0;
    call {:si_unique_call 531} vslice_dummy_var_94 := PpaWriteRegistryModeValue(Extension_44);
    goto L34;
  ...
  anon17_Then:
    ...
    assume {:nonnull} Extension_44 != 0;
    assume Extension_44 > 0;
    call {:si_unique_call 532} vslice_dummy_var_95 := PpaWriteRegistryModeValue(Extension_44);
    goto L34;
  ...
  anon16_Else:
    ...
    assume {:nonnull} Extension_44 != 0;
    assume Extension_44 > 0;
    call {:si_unique_call 533} vslice_dummy_var_96 := PpaWriteRegistryModeValue(Extension_44);
    trySlowerMode := 1;
    goto L15;
...
procedure {:origName "PpaPnpDeviceControl"} PpaPnpDeviceControl(actual_pDeviceObject_7: int, actual_pIrp_3: int) returns (Tmp_471: int);
...
implementation {:origName "PpaPnpDeviceControl"} PpaPnpDeviceControl(actual_pDeviceObject_7: int, actual_pIrp_3: int) returns (Tmp_471: int)
{
  ...
  anon0:
    call {:si_unique_call 534} Event_7 := __HAVOC_malloc(124);
    pDeviceObject_7 := actual_pDeviceObject_7;
    pIrp_3 := actual_pIrp_3;
    call {:si_unique_call 535} SLIC_PpaPnpDeviceControl_entry(0, pIrp_3);
  ...
  anon127_Else:
    call {:si_unique_call 538} Tmp_472 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_472 != 0;
    assume Tmp_472 > 0;
    call {:si_unique_call 539} sdv_KeAcquireSpinLock(0, Tmp_472);
    assume {:nonnull} Tmp_472 != 0;
    assume Tmp_472 > 0;
    havoc cIrql_1;
    ...
    call {:si_unique_call 542} Status_26 := sdv_IoCallDriver#1(vslice_dummy_var_201, pIrp_3);
  ...
  L66:
    Tmp_471 := Status_26;
    call {:si_unique_call 543} SLIC_PpaPnpDeviceControl_exit(strConst__li2bpl10, pIrp_3);
    goto anon142_Then, anon142_Else;
  ...
  L21:
    ...
    call {:si_unique_call 545} Status_26 := sdv_IoCallDriver#1(vslice_dummy_var_202, pIrp_3);
  ...
  anon131_Then:
    ...
    call {:si_unique_call 547} Status_26 := sdv_IoCallDriver#1(vslice_dummy_var_203, pIrp_3);
  ...
  anon133_Then:
    ...
    call {:si_unique_call 550} Status_26 := sdv_IoCallDriver#1(vslice_dummy_var_204, pIrp_3);
  ...
  anon112_Else:
    ...
    call {:si_unique_call 551} vslice_dummy_var_97 := KeWaitForSingleObject(0, 0, 0, 0, 0);
    goto L89;
  ...
  anon162_Else:
    ...
    call {:si_unique_call 552} Tmp_472 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_472 != 0;
    assume Tmp_472 > 0;
    call {:si_unique_call 553} sdv_KeAcquireSpinLock(0, Tmp_472);
    assume {:nonnull} Tmp_472 != 0;
    assume Tmp_472 > 0;
    havoc cIrql_1;
    assume {:nonnull} Extension_45 != 0;
  ...
  anon134_Then:
    call {:si_unique_call 556} sdv_IoCopyCurrentIrpStackLocationToNext(pIrp_3);
    call {:si_unique_call 557} sdv_IoSetCompletionRoutine(pIrp_3, li2bplFunctionConstant134, Event_7, 1, 1, 1);
    assume {:nonnull} Extension_45 != 0;
    assume Extension_45 > 0;
    havoc vslice_dummy_var_205;
    call {:si_unique_call 558} Status_26 := sdv_IoCallDriver#1(vslice_dummy_var_205, pIrp_3);
    goto anon159_Then, anon159_Else;
  ...
  anon113_Else:
    assume {:partition} Status_26 == 259;
    call {:si_unique_call 559} vslice_dummy_var_98 := KeWaitForSingleObject(0, 0, 0, 0, 0);
    goto L113;
  ...
  anon160_Else:
    assume {:partition} Status_26 >= 0;
    call {:si_unique_call 560} Tmp_472 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_472 != 0;
    assume Tmp_472 > 0;
    call {:si_unique_call 561} sdv_KeAcquireSpinLock(0, Tmp_472);
    assume {:nonnull} Tmp_472 != 0;
    assume Tmp_472 > 0;
    havoc cIrql_1;
    assume {:nonnull} Extension_45 != 0;
    assume Extension_45 > 0;
    call {:si_unique_call 562} sdv_KeReleaseSpinLock(0, cIrql_1);
    goto L118;

  L118:
    call {:si_unique_call 563} sdv_IoCompleteRequest(0, 0);
    goto L66;
  ...
  anon135_Then:
    call {:si_unique_call 564} sdv_IoCopyCurrentIrpStackLocationToNext(pIrp_3);
    call {:si_unique_call 565} sdv_IoSetCompletionRoutine(pIrp_3, li2bplFunctionConstant134, Event_7, 1, 1, 1);
    assume {:nonnull} Extension_45 != 0;
    assume Extension_45 > 0;
    havoc vslice_dummy_var_206;
    call {:si_unique_call 566} Status_26 := sdv_IoCallDriver#1(vslice_dummy_var_206, pIrp_3);
    goto anon157_Then, anon157_Else;
  ...
  anon114_Else:
    assume {:partition} Status_26 == 259;
    call {:si_unique_call 567} vslice_dummy_var_99 := KeWaitForSingleObject(0, 0, 0, 0, 0);
    goto L137;
  ...
  anon158_Else:
    assume {:partition} Status_26 >= 0;
    call {:si_unique_call 568} Tmp_472 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_472 != 0;
    assume Tmp_472 > 0;
    call {:si_unique_call 569} sdv_KeAcquireSpinLock(0, Tmp_472);
    assume {:nonnull} Tmp_472 != 0;
    assume Tmp_472 > 0;
    havoc cIrql_1;
    assume {:nonnull} Extension_45 != 0;
    assume Extension_45 > 0;
    call {:si_unique_call 570} sdv_KeReleaseSpinLock(0, cIrql_1);
    assume {:nonnull} pIrp_3 != 0;
    assume pIrp_3 > 0;
    assume {:nonnull} pIrp_3 != 0;
    assume pIrp_3 > 0;
  ...
  anon136_Then:
    call {:si_unique_call 572} sdv_IoCopyCurrentIrpStackLocationToNext(pIrp_3);
    assume {:nonnull} Extension_45 != 0;
    assume Extension_45 > 0;
    havoc vslice_dummy_var_207;
    call {:si_unique_call 573} Status_26 := sdv_IoCallDriver#1(vslice_dummy_var_207, pIrp_3);
    goto anon154_Then, anon154_Else;
  ...
  anon115_Else:
    assume {:partition} Status_26 >= 0;
    call {:si_unique_call 574} Tmp_472 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_472 != 0;
    assume Tmp_472 > 0;
    call {:si_unique_call 575} sdv_KeAcquireSpinLock(0, Tmp_472);
    assume {:nonnull} Tmp_472 != 0;
    assume Tmp_472 > 0;
    havoc cIrql_1;
    assume {:nonnull} Extension_45 != 0;
    assume Extension_45 > 0;
    call {:si_unique_call 576} sdv_KeReleaseSpinLock(0, cIrql_1);
    assume {:nonnull} Extension_45 != 0;
    assume Extension_45 > 0;
    goto anon155_Then, anon155_Else;

  anon155_Else:
    call {:si_unique_call 577} Status_26 := PpaCreateToParclass(Extension_45);
    goto anon156_Then, anon156_Else;
  ...
  anon116_Else:
    assume {:partition} Status_26 >= 0;
    call {:si_unique_call 578} Tmp_472 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_472 != 0;
    assume Tmp_472 > 0;
    call {:si_unique_call 579} sdv_KeAcquireSpinLock(0, Tmp_472);
    assume {:nonnull} Tmp_472 != 0;
    assume Tmp_472 > 0;
    havoc cIrql_1;
    assume {:nonnull} Extension_45 != 0;
    assume Extension_45 > 0;
    call {:si_unique_call 580} sdv_KeReleaseSpinLock(0, cIrql_1);
    goto L66;
  ...
  anon137_Then:
    call {:si_unique_call 581} Status_26 := sdv_IoAcquireRemoveLock(0, 0);
    goto anon117_Then, anon117_Else;
  ...
  anon118_Else:
    call {:si_unique_call 582} vslice_dummy_var_100 := IoCancelIrp(0);
    goto L187;
  ...
  anon119_Else:
    call {:si_unique_call 583} Status_26 := PpaCloseToParclass(Extension_45);
    goto anon148_Then, anon148_Else;
  ...
  anon120_Else:
    assume {:partition} Status_26 >= 0;
    call {:si_unique_call 584} Tmp_472 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_472 != 0;
    assume Tmp_472 > 0;
    call {:si_unique_call 585} sdv_KeAcquireSpinLock(0, Tmp_472);
    assume {:nonnull} Tmp_472 != 0;
    assume Tmp_472 > 0;
    havoc cIrql_1;
    assume {:nonnull} Extension_45 != 0;
    ...
    call {:si_unique_call 587} sdv_IoCopyCurrentIrpStackLocationToNext(pIrp_3);
    call {:si_unique_call 588} sdv_IoSetCompletionRoutine(pIrp_3, li2bplFunctionConstant134, Event_7, 1, 1, 1);
    assume {:nonnull} Extension_45 != 0;
    assume Extension_45 > 0;
    havoc vslice_dummy_var_208;
    call {:si_unique_call 589} Status_26 := sdv_IoCallDriver#1(vslice_dummy_var_208, pIrp_3);
    goto anon149_Then, anon149_Else;
  ...
  anon122_Else:
    assume {:partition} Status_26 == 259;
    call {:si_unique_call 590} vslice_dummy_var_101 := KeWaitForSingleObject(0, 0, 0, 0, 0);
    goto L220;
  ...
  anon123_Else:
    ...
    call {:si_unique_call 591} sdv_IoReleaseRemoveLockAndWait(0, 0);
    goto anon150_Then, anon150_Else;
  ...
  anon151_Else:
    assume {:partition} Status_26 >= 0;
    call {:si_unique_call 592} vslice_dummy_var_102 := KeCancelTimer(0);
    call {:si_unique_call 593} PpaCleanExtension(pDeviceObject_7, 1);
    goto anon152_Then, anon152_Else;

  anon152_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 594} IoDetachDevice(0);
    call {:si_unique_call 595} IoDeleteDevice(0);
    assume {:nonnull} pIrp_3 != 0;
    assume pIrp_3 > 0;
    goto L229;
  ...
  anon121_Else:
    assume {:partition} gotRemoveLock != 0;
    call {:si_unique_call 597} sdv_IoReleaseRemoveLockAndWait(0, 0);
    goto anon153_Then, anon153_Else;
  ...
  anon147_Then:
    call {:si_unique_call 598} Tmp_472 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_472 != 0;
    assume Tmp_472 > 0;
    call {:si_unique_call 599} sdv_KeAcquireSpinLock(0, Tmp_472);
    assume {:nonnull} Tmp_472 != 0;
    assume Tmp_472 > 0;
    havoc cIrql_1;
    assume {:nonnull} Extension_45 != 0;
    assume Extension_45 > 0;
    call {:si_unique_call 600} sdv_KeReleaseSpinLock(0, cIrql_1);
    goto L195;
  ...
  anon143_Else:
    call {:si_unique_call 601} Status_26 := PpaCloseToParclass(Extension_45);
    goto anon144_Then, anon144_Else;
  ...
  anon124_Else:
    assume {:partition} Status_26 >= 0;
    call {:si_unique_call 602} Tmp_472 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_472 != 0;
    assume Tmp_472 > 0;
    call {:si_unique_call 603} sdv_KeAcquireSpinLock(0, Tmp_472);
    assume {:nonnull} Tmp_472 != 0;
    assume Tmp_472 > 0;
    havoc cIrql_1;
    assume {:nonnull} Extension_45 != 0;
    assume Extension_45 > 0;
    call {:si_unique_call 604} sdv_KeReleaseSpinLock(0, cIrql_1);
    call {:si_unique_call 605} sdv_IoCopyCurrentIrpStackLocationToNext(pIrp_3);
    assume {:nonnull} Extension_45 != 0;
    assume Extension_45 > 0;
    havoc vslice_dummy_var_209;
    call {:si_unique_call 606} Status_26 := sdv_IoCallDriver#1(vslice_dummy_var_209, pIrp_3);
    goto anon145_Then, anon145_Else;
  ...
  anon125_Else:
    assume {:partition} Status_26 >= 0;
    call {:si_unique_call 607} Tmp_472 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_472 != 0;
    assume Tmp_472 > 0;
    call {:si_unique_call 608} sdv_KeAcquireSpinLock(0, Tmp_472);
    assume {:nonnull} Tmp_472 != 0;
    assume Tmp_472 > 0;
    havoc cIrql_1;
    assume {:nonnull} Extension_45 != 0;
    assume Extension_45 > 0;
    call {:si_unique_call 609} sdv_KeReleaseSpinLock(0, cIrql_1);
    goto L66;

  anon125_Then:
    assume {:partition} 0 > Status_26;
    call {:si_unique_call 610} Status_26 := PpaCreateToParclass(Extension_45);
    goto anon146_Then, anon146_Else;
  ...
  anon111_Then:
    call {:si_unique_call 612} sdv_IoCopyCurrentIrpStackLocationToNext(pIrp_3);
    call {:si_unique_call 613} sdv_IoSetCompletionRoutine(pIrp_3, li2bplFunctionConstant134, Event_7, 1, 1, 1);
    assume {:nonnull} Extension_45 != 0;
    assume Extension_45 > 0;
    havoc vslice_dummy_var_210;
    call {:si_unique_call 614} Status_26 := sdv_IoCallDriver#1(vslice_dummy_var_210, pIrp_3);
    goto anon139_Then, anon139_Else;
  ...
  anon126_Else:
    assume {:partition} Status_26 == 259;
    call {:si_unique_call 615} vslice_dummy_var_103 := KeWaitForSingleObject(0, 0, 0, 0, 0);
    goto L300;
  ...
  anon140_Else:
    assume {:partition} Status_26 >= 0;
    call {:si_unique_call 616} Status_26 := PpaStartDevice(pDeviceObject_7);
    goto anon141_Then, anon141_Else;
...
procedure {:origName "PpaCreateCleanupClose"} PpaCreateCleanupClose(actual_DeviceObject_16: int, actual_Irp_14: int) returns (Tmp_477: int);
  modifies alloc;
  free ensures {:va_keep} Tmp_477 == 0;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} false || old(t) == 1 || old(t) == 0;
  free ensures {:va_keep} alloc >= old(alloc);
  free ensures {:va_keep} false || t == 1 || t == 0;
...
implementation {:origName "PpaCreateCleanupClose"} PpaCreateCleanupClose(actual_DeviceObject_16: int, actual_Irp_14: int) returns (Tmp_477: int)
{
...
implementation {:origName "PpaInitializeQueueIrp"} PpaInitializeQueueIrp(actual_Extension_46: int)
{
  ...
  anon0:
    call {:si_unique_call 619} vslice_dummy_var_104 := __HAVOC_malloc(4);
    Extension_46 := actual_Extension_46;
    assume {:nonnull} Extension_46 != 0;
    assume Extension_46 > 0;
    havoc vslice_dummy_var_211;
    call {:si_unique_call 620} IoReuseIrp(vslice_dummy_var_211, 0);
    assume {:nonnull} Extension_46 != 0;
    assume Extension_46 > 0;
    havoc vslice_dummy_var_212;
    call {:si_unique_call 621} pNextIrpStack := sdv_IoGetNextIrpStackLocation(vslice_dummy_var_212);
    call {:si_unique_call 622} sdv_RtlZeroMemory(0, 64);
    assume {:nonnull} Extension_46 != 0;
    assume Extension_46 > 0;
...
procedure {:origName "PpaSystemControl"} PpaSystemControl(actual_pDeviceObject_8: int, actual_pIrp_4: int) returns (Tmp_482: int);
  modifies alloc, LockDepth, yogi_error, Mem_T.CompletionRoutine__IO_STACK_LOCATION;
  free ensures {:va_keep} old(t) == 0 ==> yogi_error == 0;
  free ensures {:va_keep} LockDepth <= old(LockDepth);
  free ensures {:va_keep} yogi_error == 1 || yogi_error == old(yogi_error);
...
implementation {:origName "PpaSystemControl"} PpaSystemControl(actual_pDeviceObject_8: int, actual_pIrp_4: int) returns (Tmp_482: int)
{
  ...
  anon0:
    ...
    havoc Extension_47;
    call {:si_unique_call 623} sdv_IoCopyCurrentIrpStackLocationToNext(pIrp_4);
    assume {:nonnull} Extension_47 != 0;
    assume Extension_47 > 0;
    havoc vslice_dummy_var_213;
    call {:si_unique_call 624} Tmp_482 := sdv_IoCallDriver#1(vslice_dummy_var_213, pIrp_4);
    goto anon3_Then, anon3_Else;
...
procedure {:origName "PpaPowerControl"} PpaPowerControl(actual_pDeviceObject_9: int, actual_pIrp_5: int) returns (Tmp_484: int);
  modifies alloc, LockDepth, yogi_error, Mem_T.CompletionRoutine__IO_STACK_LOCATION;
  free ensures {:va_keep} old(t) == 0 ==> yogi_error == 0;
  free ensures {:va_keep} LockDepth <= old(LockDepth);
  free ensures {:va_keep} yogi_error == 1 || yogi_error == old(yogi_error);
...
implementation {:origName "PpaPowerControl"} PpaPowerControl(actual_pDeviceObject_9: int, actual_pIrp_5: int) returns (Tmp_484: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 625} sdv_IoCopyCurrentIrpStackLocationToNext(pIrp_5);
    call {:si_unique_call 626} PoStartNextPowerIrp(0);
    call {:si_unique_call 627} Tmp_484 := PoCallDriver(0, pIrp_5);
    goto anon3_Then, anon3_Else;
...
procedure {:origName "PpaAddDevice"} PpaAddDevice(actual_pDriverObject: int, actual_pPhysicalDeviceObject: int) returns (Tmp_486: int);
  modifies alloc;
  free ensures {:va_keep} Tmp_486 == -1073741637 || Tmp_486 == 0 || Tmp_486 == -1073741823 || Tmp_486 == -1073741824 || Tmp_486 == -1073741771 || Tmp_486 == -1073741670;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} false || old(t) == 1 || old(t) == 0;
  free ensures {:va_keep} alloc >= old(alloc);
  free ensures {:va_keep} false || t == 1 || t == 0;
...
implementation {:origName "PpaAddDevice"} PpaAddDevice(actual_pDriverObject: int, actual_pPhysicalDeviceObject: int) returns (Tmp_486: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 628} Status_27 := PpaCreateDevObject(pDriverObject, pPhysicalDeviceObject);
    Tmp_486 := Status_27;
    return;
}
...
implementation {:origName "_sdv_init1"} _sdv_init1()
{
  ...
  anon0:
    call {:si_unique_call 629} vslice_dummy_var_105 := __HAVOC_malloc(4);
...
procedure {:origName "PpaStartDevice"} PpaStartDevice(actual_pDeviceObject_10: int) returns (Tmp_490: int);
  modifies alloc, Mem_T.CompletionRoutine__IO_STACK_LOCATION, LockDepth, yogi_error;
  free ensures {:va_keep} old(t) == 0 ==> yogi_error == 0;
  free ensures {:va_keep} yogi_error == 1 || yogi_error == old(yogi_error);
  free ensures {:va_keep} old(yogi_error) == 0;
...
implementation {:origName "PpaStartDevice"} PpaStartDevice(actual_pDeviceObject_10: int) returns (Tmp_490: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 630} Status_28 := PpaGetDeviceInfo(Extension_49);
    goto anon30_Then, anon30_Else;
  ...
  anon23_Else:
    ...
    call {:si_unique_call 631} Status_28 := PpaInitializeExtension(Extension_49);
    goto anon31_Then, anon31_Else;
  ...
  L20:
    call {:si_unique_call 632} Status_28, sdv_265 := PpaStartDevice_loop_L20(Status_28, Extension_49, sdv_265);
    goto L20_last;

  L20_last:
    call {:si_unique_call 637} PpaPortLock(Extension_49, 1, 0);
    goto anon32_Then, anon32_Else;
  ...
  L26:
    call {:si_unique_call 633} Status_28 := PpaStartDevice_loop_L26(Status_28, Extension_49);
    goto L26_last;
  ...
  anon26_Else:
    call {:si_unique_call 634} Status_28 := PpaIssueInquiry(Extension_49);
    goto anon27_Then, anon27_Else;
  ...
  L27:
    call {:si_unique_call 635} PpaPortUnlock#1(Extension_49, 1, 0);
    goto anon33_Then, anon33_Else;
  ...
  anon28_Else:
    assume {:partition} Status_28 != 0;
    call {:si_unique_call 636} sdv_265 := PpaTrySlowerMode(Extension_49);
    goto anon29_Then, anon29_Else;
...
procedure {:origName "PpaDeviceControl"} PpaDeviceControl(actual_pDeviceObject_11: int, actual_pIrp_6: int) returns (Tmp_492: int);
  modifies alloc, LockDepth, yogi_error, Mem_T.CompletionRoutine__IO_STACK_LOCATION;
  free ensures {:va_keep} old(t) == 0 ==> yogi_error == 0;
  free ensures {:va_keep} LockDepth <= old(LockDepth);
  free ensures {:va_keep} yogi_error == 1 || yogi_error == old(yogi_error);
...
implementation {:origName "PpaDeviceControl"} PpaDeviceControl(actual_pDeviceObject_11: int, actual_pIrp_6: int) returns (Tmp_492: int)
{
  ...
  anon0:
    ...
    pIrp_6 := actual_pIrp_6;
    call {:si_unique_call 638} pIrpStack_6 := sdv_IoGetCurrentIrpStackLocation(pIrp_6);
  ...
  anon90_Else:
    Status_29 := -1073741820;
    goto L43;

  anon90_Then:
    call {:si_unique_call 640} Status_29 := PpaQueryProperty(pDeviceObject_11, pIrp_6);
    Tmp_492 := Status_29;
    goto L1;
  ...
  L19:
    call {:si_unique_call 641} Status_29 := PpaScsiSendPassThrough(Extension_50, pIrp_6);
...
implementation {:origName "PpaInitializeUnlockIrp"} PpaInitializeUnlockIrp(actual_Extension_51: int)
{
  ...
  anon0:
    call {:si_unique_call 642} vslice_dummy_var_106 := __HAVOC_malloc(4);
    Extension_51 := actual_Extension_51;
    assume {:nonnull} Extension_51 != 0;
    assume Extension_51 > 0;
    havoc vslice_dummy_var_214;
    call {:si_unique_call 643} IoReuseIrp(vslice_dummy_var_214, 0);
    assume {:nonnull} Extension_51 != 0;
    assume Extension_51 > 0;
    havoc vslice_dummy_var_215;
    call {:si_unique_call 644} pNextIrpStack_1 := sdv_IoGetNextIrpStackLocation(vslice_dummy_var_215);
    assume {:nonnull} Extension_51 != 0;
    assume Extension_51 > 0;
...
procedure {:origName "PpaInitializeExtension"} PpaInitializeExtension(actual_Extension_52: int) returns (Tmp_496: int);
  modifies alloc, Mem_T.CompletionRoutine__IO_STACK_LOCATION, LockDepth, yogi_error;
  free ensures {:va_keep} old(t) == 0 ==> yogi_error == 0;
  free ensures {:va_keep} yogi_error == 1 || yogi_error == old(yogi_error);
  free ensures {:va_keep} old(yogi_error) == 0;
...
implementation {:origName "PpaInitializeExtension"} PpaInitializeExtension(actual_Extension_52: int) returns (Tmp_496: int)
{
  ...
  anon41_Else:
    call {:si_unique_call 645} Status_30 := PpaCreateToParclass(Extension_52);
    goto anon42_Then, anon42_Else;
  ...
  anon31_Else:
    ...
    call {:si_unique_call 646} Tmp_500 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_500 != 0;
    assume Tmp_500 > 0;
    call {:si_unique_call 647} sdv_KeAcquireSpinLock(0, Tmp_500);
    assume {:nonnull} Tmp_500 != 0;
    assume Tmp_500 > 0;
    havoc cIrql_2;
    assume {:nonnull} Extension_52 != 0;
    assume Extension_52 > 0;
    call {:si_unique_call 648} sdv_KeReleaseSpinLock(0, cIrql_2);
    assume {:nonnull} Extension_52 != 0;
    assume Extension_52 > 0;
    goto anon32_Then, anon32_Else;
  ...
  anon32_Else:
    assume {:nonnull} Extension_52 != 0;
    assume Extension_52 > 0;
    call {:si_unique_call 649} sdv_274 := ExAllocatePoolWithTag(4, 36, -965582512);
    assume {:nonnull} Extension_52 != 0;
    assume Extension_52 > 0;
    assume {:nonnull} Extension_52 != 0;
    assume Extension_52 > 0;
  ...
  anon43_Else:
    call {:si_unique_call 650} sdv_275 := ExAllocatePoolWithTag(4, 64, -965582512);
    assume {:nonnull} Extension_52 != 0;
    assume Extension_52 > 0;
    assume {:nonnull} Extension_52 != 0;
    assume Extension_52 > 0;
  ...
  anon44_Else:
    assume {:nonnull} Extension_52 != 0;
    assume Extension_52 > 0;
    call {:si_unique_call 651} boogieTmp := IoAllocateIrp(1, 0);
    assume {:nonnull} Extension_52 != 0;
    assume Extension_52 > 0;
    goto anon33_Then, anon33_Else;
  ...
  anon33_Else:
    ...
    call {:si_unique_call 652} boogieTmp := IoAllocateIrp(vslice_dummy_var_216, 0);
    assume {:nonnull} Extension_52 != 0;
    assume Extension_52 > 0;
    goto anon34_Then, anon34_Else;
  ...
  anon34_Else:
    ...
    call {:si_unique_call 653} boogieTmp := IoAllocateIrp(vslice_dummy_var_217, 0);
    assume {:nonnull} Extension_52 != 0;
    assume Extension_52 > 0;
    goto anon35_Then, anon35_Else;
  ...
  L27:
    ...
    assume {:nonnull} Extension_52 != 0;
    assume Extension_52 > 0;
    call {:si_unique_call 654} vslice_dummy_var_108 := PpaGetRegistryParameters(Extension_52);
    call {:si_unique_call 655} Status_30 := PpaGetTransferMode(Extension_52);
    goto anon45_Then, anon45_Else;

  anon45_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 656} vslice_dummy_var_107 := PpaWriteRegistryModeValue(Extension_52);
    goto anon36_Then, anon36_Else;
  ...
  anon39_Else:
    call {:si_unique_call 659} IoFreeIrp(0);
    assume {:nonnull} Extension_52 != 0;
    assume Extension_52 > 0;
    goto L115;
  ...
  anon35_Then:
    ...
    call {:si_unique_call 662} IoFreeIrp(0);
    assume {:nonnull} Extension_52 != 0;
    assume Extension_52 > 0;
    assume {:nonnull} Extension_52 != 0;
    assume Extension_52 > 0;
  ...
  anon34_Then:
    ...
    call {:si_unique_call 665} IoFreeIrp(0);
    assume {:nonnull} Extension_52 != 0;
    assume Extension_52 > 0;
    assume {:nonnull} Extension_52 != 0;
    assume Extension_52 > 0;
...
implementation {:origName "PpaCleanExtension"} PpaCleanExtension(actual_pDeviceObject_13: int, actual_DeviceRemoved: int)
{
  ...
  anon0:
    call {:si_unique_call 669} vslice_dummy_var_109 := __HAVOC_malloc(4);
  ...
  anon21_Else:
    call {:si_unique_call 673} IoFreeIrp(0);
    assume {:nonnull} Extension_53 != 0;
    assume Extension_53 > 0;
    goto L21;
  ...
  anon24_Else:
    call {:si_unique_call 676} Status_31 := PpaCloseToParclass(Extension_53);
    goto anon27_Then, anon27_Else;
  ...
  anon26_Else:
    ...
    call {:si_unique_call 677} Tmp_501 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_501 != 0;
    assume Tmp_501 > 0;
    call {:si_unique_call 678} sdv_KeAcquireSpinLock(0, Tmp_501);
    assume {:nonnull} Tmp_501 != 0;
    assume Tmp_501 > 0;
    havoc cIrql_3;
    assume {:nonnull} Extension_53 != 0;
    assume Extension_53 > 0;
    call {:si_unique_call 679} sdv_KeReleaseSpinLock(0, cIrql_3);
    goto L36;
...
implementation {:origName "PpaInitializeLockIrp"} PpaInitializeLockIrp(actual_Extension_54: int)
{
  ...
  anon0:
    call {:si_unique_call 681} vslice_dummy_var_110 := __HAVOC_malloc(4);
    Extension_54 := actual_Extension_54;
    assume {:nonnull} Extension_54 != 0;
    assume Extension_54 > 0;
    havoc vslice_dummy_var_218;
    call {:si_unique_call 682} IoReuseIrp(vslice_dummy_var_218, 0);
    assume {:nonnull} Extension_54 != 0;
    assume Extension_54 > 0;
    havoc vslice_dummy_var_219;
    call {:si_unique_call 683} pNextIrpStack_2 := sdv_IoGetNextIrpStackLocation(vslice_dummy_var_219);
    assume {:nonnull} Extension_54 != 0;
    assume Extension_54 > 0;
...
procedure {:origName "PpaCreateDevObject"} PpaCreateDevObject(actual_pDriverObject_1: int, actual_pPhysicalDeviceObject_1: int) returns (Tmp_506: int);
  modifies alloc;
  free ensures {:va_keep} Tmp_506 == -1073741637 || Tmp_506 == 0 || Tmp_506 == -1073741823 || Tmp_506 == -1073741824 || Tmp_506 == -1073741771 || Tmp_506 == -1073741670;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} false || old(t) == 1 || old(t) == 0;
  free ensures {:va_keep} alloc >= old(alloc);
  free ensures {:va_keep} false || t == 1 || t == 0;
...
implementation {:origName "PpaCreateDevObject"} PpaCreateDevObject(actual_pDriverObject_1: int, actual_pPhysicalDeviceObject_1: int) returns (Tmp_506: int)
{
  ...
  anon0:
    call {:si_unique_call 684} pDeviceObject_14 := __HAVOC_malloc(4);
    ...
    call {:si_unique_call 685} Status_32 := IoCreateDevice(0, 288, 0, 45, 257, 0, pDeviceObject_14);
    goto anon7_Then, anon7_Else;
  ...
  anon7_Else:
    ...
    assume pDeviceObject_14 > 0;
    havoc Extension_55;
    call {:si_unique_call 686} sdv_RtlZeroMemory(0, 288);
  ...
  anon9_Else:
    ...
    assume {:nonnull} Extension_55 != 0;
    assume Extension_55 > 0;
    call {:si_unique_call 687} boogieTmp := IoAttachDeviceToDeviceStack(0, pPhysicalDeviceObject_1);
    assume {:nonnull} Extension_55 != 0;
    assume Extension_55 > 0;
    goto anon8_Then, anon8_Else;
  ...
  L24:
    assume {:nonnull} Extension_55 != 0;
    assume Extension_55 > 0;
    call {:si_unique_call 689} Status_32 := IoInitializeTimer(0, li2bplFunctionConstant126, 0);
    assume {:nonnull} Extension_55 != 0;
    assume Extension_55 > 0;
    call {:si_unique_call 690} KeInitializeDpc(TimeoutDpc__DEVICE_EXTENSION(Extension_55), li2bplFunctionConstant127, 0);
    call {:si_unique_call 691} KeInitializeTimer(0);
    call {:si_unique_call 692} Tmp_507 := __HAVOC_malloc(4);
    assume {:nonnull} Extension_55 != 0;
    assume Extension_55 > 0;
    assume {:nonnull} Tmp_507 != 0;
    assume Tmp_507 > 0;
    call {:si_unique_call 693} sdv_KeInitializeSpinLock(Tmp_507);
    assume {:nonnull} Extension_55 != 0;
    assume Extension_55 > 0;
    assume {:nonnull} Tmp_507 != 0;
    assume Tmp_507 > 0;
    call {:si_unique_call 694} sdv_IoInitializeRemoveLock(0, 541151312, 0, 1024);
    assume {:nonnull} pDeviceObject_14 != 0;
    assume pDeviceObject_14 > 0;
    Tmp_506 := Status_32;
    goto L1;
...
implementation corralExtraInit()
{
  ...
  anon0:
    ...
    assume (forall x: int :: { Mem_T.CompletionRoutine__IO_STACK_LOCATION[x] } Mem_T.CompletionRoutine__IO_STACK_LOCATION[x] <= 0 || Mem_T.CompletionRoutine__IO_STACK_LOCATION[x] > 328);
    return;
}
...
const {:string "The driver is calling sdv_IoReleaseRemoveLock without first acquiring the Removelock."} unique strConst__li2bpl13: int;

const {:string "The driver is calling sdv_IoReleaseRemoveLockAndWait without first acquiring the Removelock."} unique strConst__li2bpl14: int;

const {:string "The routine has returned without releasing a Removelock."} unique strConst__li2bpl12: int;

const {:string "callee"} unique strConst__li2bpl10: int;
...
implementation {:origName "SdvExit"} {:osmodel} SdvExit#0()
{
  ...
  anon0:
    call {:si_unique_call 695} vslice_dummy_var_111 := __HAVOC_malloc(4);
    assume false;
    assume false;
    return;
}
...
implementation {:origName "SdvExit"} {:osmodel} SdvExit#1()
{
  ...
  anon0:
    call {:si_unique_call 696} vslice_dummy_var_112 := __HAVOC_malloc(4);
    assume false;
    call {:si_unique_call 697} SdvExit#0();
    return;
}
...
implementation {:origName "PpaPortLockCompletionRoutine"} PpaPortLockCompletionRoutine#0(actual_pDeviceObject_3: int, actual_Irp_13: int, actual_ContextIn_1: int) returns (Tmp_432: int)
{
  ...
  L10:
    call {:si_unique_call 698} status_10 := PpaStartExecution(Extension_39);
    assume {:nonnull} Extension_39 != 0;
    assume Extension_39 > 0;
    havoc vslice_dummy_var_220;
    call {:si_unique_call 699} PpaCompleteRequest(Extension_39, vslice_dummy_var_220, status_10);
    call {:si_unique_call 700} sdv_IoCompleteRequest(0, 0);
    assume {:nonnull} Extension_39 != 0;
    assume Extension_39 > 0;
    assume {:nonnull} Extension_39 != 0;
    assume Extension_39 > 0;
    call {:si_unique_call 701} vslice_dummy_var_113 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(Extension_39), Extension_39);
    goto anon14_Then, anon14_Else;
  ...
  anon11_Else:
    ...
    call {:si_unique_call 702} sdv_220 := sdv_KeGetCurrentIrql();
    goto anon12_Then, anon12_Else;

  anon12_Else:
    assume {:partition} 2 > sdv_220;
    call {:si_unique_call 703} oldIrql_1 := KeRaiseIrqlToDpcLevel();
    call {:si_unique_call 704} IoStartNextPacket(0, 0);
    call {:si_unique_call 705} sdv_KeLowerIrql(oldIrql_1);
    goto L30;
...
procedure {:origName "PpaPortLockCompletionRoutine"} PpaPortLockCompletionRoutine#0(actual_pDeviceObject_3: int, actual_Irp_13: int, actual_ContextIn_1: int) returns (Tmp_432: int);
  modifies alloc, LockDepth, yogi_error;
  free ensures {:va_keep} old(LockDepth) != 0 ==> yogi_error == 0;
  free ensures {:va_keep} old(t) == 0 ==> yogi_error == 0;
  free ensures {:va_keep} old(LockDepth) > 0 ==> LockDepth == old(LockDepth) - 1;
...
implementation {:origName "PpaPortLockCompletionRoutine"} PpaPortLockCompletionRoutine#1(actual_pDeviceObject_3: int, actual_Irp_13: int, actual_ContextIn_1: int) returns (Tmp_432: int)
{
  var {:scalar} sdv_220: int;
  var {:pointer} Context_5: int;
  var {:scalar} oldIrql_1: int;
  ...
  L10:
    call {:si_unique_call 707} status_10 := PpaStartExecution(Extension_39);
    assume {:nonnull} Extension_39 != 0;
    assume Extension_39 > 0;
    havoc vslice_dummy_var_221;
    call {:si_unique_call 708} PpaCompleteRequest(Extension_39, vslice_dummy_var_221, status_10);
    call {:si_unique_call 709} sdv_IoCompleteRequest(0, 0);
    assume {:nonnull} Extension_39 != 0;
    assume Extension_39 > 0;
    assume {:nonnull} Extension_39 != 0;
    assume Extension_39 > 0;
    call {:si_unique_call 710} vslice_dummy_var_114 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(Extension_39), Extension_39);
    goto anon14_Then, anon14_Else;
  ...
  anon11_Else:
    assume {:partition} status_10 < 0;
    call {:si_unique_call 711} sdv_220 := sdv_KeGetCurrentIrql();
    goto anon12_Then, anon12_Else;

  anon12_Else:
    assume {:partition} 2 > sdv_220;
    call {:si_unique_call 712} oldIrql_1 := KeRaiseIrqlToDpcLevel();
    call {:si_unique_call 713} IoStartNextPacket(0, 0);
    call {:si_unique_call 714} sdv_KeLowerIrql(oldIrql_1);
    goto L30;
  ...
  anon11_Then:
    assume {:partition} 0 <= status_10;
    call {:si_unique_call 716} PpaPortUnlock#0(Extension_39, 0, Context_5);
    goto anon15_Then, anon15_Else;
...
procedure {:origName "PpaPortLockCompletionRoutine"} PpaPortLockCompletionRoutine#1(actual_pDeviceObject_3: int, actual_Irp_13: int, actual_ContextIn_1: int) returns (Tmp_432: int);
  modifies alloc, LockDepth, yogi_error, Mem_T.CompletionRoutine__IO_STACK_LOCATION;
  free ensures {:va_keep} old(t) == 0 ==> yogi_error == 0;
  free ensures {:va_keep} LockDepth <= old(LockDepth);
  free ensures {:va_keep} yogi_error == 1 || yogi_error == old(yogi_error);
...
implementation {:origName "PpaPortUnlock"} PpaPortUnlock#0(actual_Extension_21: int, actual_Wait_2: int, actual_pDeviceObject_1: int)
{
  ...
  anon0:
    call {:si_unique_call 717} vslice_dummy_var_115 := __HAVOC_malloc(4);
    call {:si_unique_call 718} Event_5 := __HAVOC_malloc(124);
  ...
  anon13_Else:
    call {:si_unique_call 719} PpaInitializeUnlockIrp(Extension_21);
    goto anon14_Then, anon14_Else;

  anon14_Else:
    assume {:partition} Wait_2 != 0;
    call {:si_unique_call 720} KeInitializeEvent(Event_5, 0, 0);
    assume {:nonnull} Extension_21 != 0;
    assume Extension_21 > 0;
    havoc vslice_dummy_var_222;
    call {:si_unique_call 721} sdv_IoSetCompletionRoutine(vslice_dummy_var_222, li2bplFunctionConstant134, Event_5, 1, 1, 1);
    goto L20;
  ...
  L20:
    ...
    call {:si_unique_call 722} status_6 := sdv_IoCallDriver#0(vslice_dummy_var_223, vslice_dummy_var_224);
    goto anon17_Then, anon17_Else;
  ...
  anon16_Else:
    ...
    call {:si_unique_call 723} vslice_dummy_var_116 := KeWaitForSingleObject(0, 0, 0, 0, 0);
    goto L27;
  ...
  anon14_Then:
    ...
    call {:si_unique_call 724} sdv_IoSetCompletionRoutine(vslice_dummy_var_225, li2bplFunctionConstant200, pDeviceObject_1, 1, 1, 1);
    goto L20;
...
implementation {:origName "PpaPortUnlock"} PpaPortUnlock#1(actual_Extension_21: int, actual_Wait_2: int, actual_pDeviceObject_1: int)
{
  ...
  anon0:
    call {:si_unique_call 725} vslice_dummy_var_117 := __HAVOC_malloc(4);
    call {:si_unique_call 726} Event_5 := __HAVOC_malloc(124);
    Extension_21 := actual_Extension_21;
    Wait_2 := actual_Wait_2;
    pDeviceObject_1 := actual_pDeviceObject_1;
    assume {:nonnull} Extension_21 != 0;
  ...
  anon13_Else:
    call {:si_unique_call 727} PpaInitializeUnlockIrp(Extension_21);
    goto anon14_Then, anon14_Else;

  anon14_Else:
    assume {:partition} Wait_2 != 0;
    call {:si_unique_call 728} KeInitializeEvent(Event_5, 0, 0);
    assume {:nonnull} Extension_21 != 0;
    assume Extension_21 > 0;
    havoc vslice_dummy_var_226;
    call {:si_unique_call 729} sdv_IoSetCompletionRoutine(vslice_dummy_var_226, li2bplFunctionConstant134, Event_5, 1, 1, 1);
    goto L20;
  ...
  L20:
    ...
    call {:si_unique_call 730} status_6 := sdv_IoCallDriver#1(vslice_dummy_var_227, vslice_dummy_var_228);
    goto anon17_Then, anon17_Else;
  ...
  anon16_Else:
    assume {:partition} status_6 == 259;
    call {:si_unique_call 731} vslice_dummy_var_118 := KeWaitForSingleObject(0, 0, 0, 0, 0);
    goto L27;
  ...
  anon14_Then:
    ...
    call {:si_unique_call 732} sdv_IoSetCompletionRoutine(vslice_dummy_var_229, li2bplFunctionConstant200, pDeviceObject_1, 1, 1, 1);
    goto L20;
...
implementation {:origName "sdv_IoCallDriver"} {:osmodel} sdv_IoCallDriver#0(actual_DeviceObject_10: int, actual_Irp_7: int) returns (Tmp_294: int)
{
  var {:pointer} Irp_7: int;

  anon0:
    Irp_7 := actual_Irp_7;
    call {:si_unique_call 733} Tmp_294 := IofCallDriver#0(0, Irp_7);
    goto anon3_Then, anon3_Else;
...
procedure {:origName "sdv_IoCallDriver"} {:osmodel} sdv_IoCallDriver#0(actual_DeviceObject_10: int, actual_Irp_7: int) returns (Tmp_294: int);
  modifies alloc, LockDepth, yogi_error;
  free ensures {:va_keep} old(LockDepth) != 0 ==> yogi_error == 0;
  free ensures {:va_keep} old(t) == 0 ==> yogi_error == 0;
  free ensures {:va_keep} LockDepth <= old(LockDepth);
...
implementation {:origName "sdv_IoCallDriver"} {:osmodel} sdv_IoCallDriver#1(actual_DeviceObject_10: int, actual_Irp_7: int) returns (Tmp_294: int)
{
  var {:pointer} Irp_7: int;

  anon0:
    Irp_7 := actual_Irp_7;
    call {:si_unique_call 734} Tmp_294 := IofCallDriver#1(0, Irp_7);
    goto anon3_Then, anon3_Else;
...
procedure {:origName "sdv_IoCallDriver"} {:osmodel} sdv_IoCallDriver#1(actual_DeviceObject_10: int, actual_Irp_7: int) returns (Tmp_294: int);
  modifies alloc, LockDepth, yogi_error, Mem_T.CompletionRoutine__IO_STACK_LOCATION;
  free ensures {:va_keep} old(t) == 0 ==> yogi_error == 0;
  free ensures {:va_keep} LockDepth <= old(LockDepth);
  free ensures {:va_keep} yogi_error == 1 || yogi_error == old(yogi_error);
...
implementation {:origName "IofCallDriver"} {:osmodel} IofCallDriver#0(actual_DeviceObject_8: int, actual_Irp_5: int) returns (Tmp_286: int)
{
  ...
  anon0:
    call {:si_unique_call 735} completion_1 := __HAVOC_malloc(4);
    Irp_5 := actual_Irp_5;
  ...
  anon55_Then:
    ...
    call {:si_unique_call 736} vslice_dummy_var_119 := sdv_RunIoCompletionRoutines#0(sdv_p_devobj_fdo, Irp_5, vslice_dummy_var_230, completion_1);
    goto anon76_Then, anon76_Else;
  ...
  anon67_Else:
    ...
    call {:si_unique_call 737} vslice_dummy_var_122 := sdv_RunIoCompletionRoutines#0(sdv_p_devobj_fdo, Irp_5, vslice_dummy_var_231, completion_1);
    goto anon78_Then, anon78_Else;
  ...
  anon59_Else:
    ...
    call {:si_unique_call 738} vslice_dummy_var_120 := sdv_RunIoCompletionRoutines#0(sdv_p_devobj_fdo, Irp_5, vslice_dummy_var_232, completion_1);
    goto anon74_Then, anon74_Else;
  ...
  anon63_Else:
    ...
    call {:si_unique_call 739} vslice_dummy_var_121 := sdv_RunIoCompletionRoutines#0(sdv_p_devobj_fdo, Irp_5, vslice_dummy_var_233, completion_1);
    goto anon72_Then, anon72_Else;
...
procedure {:origName "IofCallDriver"} {:osmodel} IofCallDriver#0(actual_DeviceObject_8: int, actual_Irp_5: int) returns (Tmp_286: int);
  modifies alloc, LockDepth, yogi_error;
  free ensures {:va_keep} old(LockDepth) != 0 ==> yogi_error == 0;
  free ensures {:va_keep} old(t) == 0 ==> yogi_error == 0;
  free ensures {:va_keep} LockDepth <= old(LockDepth);
...
implementation {:origName "IofCallDriver"} {:osmodel} IofCallDriver#1(actual_DeviceObject_8: int, actual_Irp_5: int) returns (Tmp_286: int)
{
  var {:dopa} {:scalar} completion_1: int;
  var {:scalar} status_4: int;
  var {:pointer} Irp_5: int;
  ...
  anon0:
    call {:si_unique_call 740} completion_1 := __HAVOC_malloc(4);
    Irp_5 := actual_Irp_5;
    assume {:nonnull} completion_1 != 0;
    assume completion_1 > 0;
    status_4 := 259;
  ...
  anon55_Then:
    ...
    call {:si_unique_call 741} vslice_dummy_var_123 := sdv_RunIoCompletionRoutines#1(sdv_p_devobj_fdo, Irp_5, vslice_dummy_var_234, completion_1);
    goto anon76_Then, anon76_Else;
  ...
  anon67_Else:
    ...
    call {:si_unique_call 742} vslice_dummy_var_126 := sdv_RunIoCompletionRoutines#1(sdv_p_devobj_fdo, Irp_5, vslice_dummy_var_235, completion_1);
    goto anon78_Then, anon78_Else;
  ...
  anon59_Else:
    ...
    call {:si_unique_call 743} vslice_dummy_var_124 := sdv_RunIoCompletionRoutines#1(sdv_p_devobj_fdo, Irp_5, vslice_dummy_var_236, completion_1);
    goto anon74_Then, anon74_Else;
  ...
  anon63_Else:
    ...
    call {:si_unique_call 744} vslice_dummy_var_125 := sdv_RunIoCompletionRoutines#1(sdv_p_devobj_fdo, Irp_5, vslice_dummy_var_237, completion_1);
    goto anon72_Then, anon72_Else;
...
procedure {:origName "IofCallDriver"} {:osmodel} IofCallDriver#1(actual_DeviceObject_8: int, actual_Irp_5: int) returns (Tmp_286: int);
  modifies alloc, LockDepth, yogi_error, Mem_T.CompletionRoutine__IO_STACK_LOCATION;
  free ensures {:va_keep} old(t) == 0 ==> yogi_error == 0;
  free ensures {:va_keep} LockDepth <= old(LockDepth);
  free ensures {:va_keep} yogi_error == 1 || yogi_error == old(yogi_error);
...
implementation {:origName "sdv_RunIoCompletionRoutines"} {:osmodel} sdv_RunIoCompletionRoutines#0(actual_DeviceObject_9: int, actual_Irp_6: int, actual_Context_3: int, actual_Completion: int) returns (Tmp_288: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 745} irpsp := sdv_IoGetNextIrpStackLocation(Irp_6);
    Status_15 := 0;
    assume {:nonnull} irpsp != 0;
    assume irpsp > 0;
    goto anon11_Then, anon11_Else;
  ...
  anon11_Else:
    ...
    call {:si_unique_call 746} Status_15 := PpaPortLockCompletionRoutine#0(DeviceObject_9, Irp_6, Context_3);
    goto anon12_Then, anon12_Else;
  ...
  anon9_Else:
    ...
    call {:si_unique_call 747} Status_15 := PpaPortUnlockCompletionRoutine(DeviceObject_9, Irp_6, Context_3);
    assume {:nonnull} Completion != 0;
    assume Completion > 0;
    goto L28;
  ...
  anon10_Else:
    ...
    call {:si_unique_call 748} Status_15 := PpaRequestCompletionRoutine(DeviceObject_9, Irp_6, Context_3);
    assume {:nonnull} Completion != 0;
    assume Completion > 0;
    goto L45;
...
procedure {:origName "sdv_RunIoCompletionRoutines"} {:osmodel} sdv_RunIoCompletionRoutines#0(actual_DeviceObject_9: int, actual_Irp_6: int, actual_Context_3: int, actual_Completion: int) returns (Tmp_288: int);
  modifies alloc, LockDepth, yogi_error;
  free ensures {:va_keep} old(LockDepth) != 0 ==> yogi_error == 0;
  free ensures {:va_keep} old(t) == 0 ==> yogi_error == 0;
  free ensures {:va_keep} LockDepth <= old(LockDepth);
...
implementation {:origName "sdv_RunIoCompletionRoutines"} {:osmodel} sdv_RunIoCompletionRoutines#1(actual_DeviceObject_9: int, actual_Irp_6: int, actual_Context_3: int, actual_Completion: int) returns (Tmp_288: int)
{
  var {:scalar} Status_15: int;
  var {:pointer} irpsp: int;
  var {:pointer} DeviceObject_9: int;
  ...
  anon0:
    ...
    Context_3 := actual_Context_3;
    Completion := actual_Completion;
    call {:si_unique_call 749} irpsp := sdv_IoGetNextIrpStackLocation(Irp_6);
    Status_15 := 0;
    assume {:nonnull} irpsp != 0;
    assume irpsp > 0;
    goto anon11_Then, anon11_Else;
  ...
  anon11_Else:
    assume {:partition} Mem_T.CompletionRoutine__IO_STACK_LOCATION[CompletionRoutine__IO_STACK_LOCATION(irpsp)] == li2bplFunctionConstant199;
    call {:si_unique_call 750} Status_15 := PpaPortLockCompletionRoutine#1(DeviceObject_9, Irp_6, Context_3);
    goto anon12_Then, anon12_Else;
  ...
  anon9_Else:
    assume {:partition} Mem_T.CompletionRoutine__IO_STACK_LOCATION[CompletionRoutine__IO_STACK_LOCATION(irpsp)] == li2bplFunctionConstant200;
    call {:si_unique_call 751} Status_15 := PpaPortUnlockCompletionRoutine(DeviceObject_9, Irp_6, Context_3);
    assume {:nonnull} Completion != 0;
    assume Completion > 0;
    goto L28;
  ...
  anon10_Else:
    assume {:partition} Mem_T.CompletionRoutine__IO_STACK_LOCATION[CompletionRoutine__IO_STACK_LOCATION(irpsp)] == li2bplFunctionConstant134;
    call {:si_unique_call 752} Status_15 := PpaRequestCompletionRoutine(DeviceObject_9, Irp_6, Context_3);
    assume {:nonnull} Completion != 0;
    assume Completion > 0;
    goto L45;
...
procedure {:origName "sdv_RunIoCompletionRoutines"} {:osmodel} sdv_RunIoCompletionRoutines#1(actual_DeviceObject_9: int, actual_Irp_6: int, actual_Context_3: int, actual_Completion: int) returns (Tmp_288: int);
  modifies alloc, LockDepth, yogi_error, Mem_T.CompletionRoutine__IO_STACK_LOCATION;
  free ensures {:va_keep} old(t) == 0 ==> yogi_error == 0;
  free ensures {:va_keep} LockDepth <= old(LockDepth);
  free ensures {:va_keep} yogi_error == 1 || yogi_error == old(yogi_error);
...
implementation {:SIextraRecBound 5} PpaGetRegistryParameters_loop_L56(in_i: int, in_Tmp_4: int, in_CheckMode: int, in_sdv_1: int, in_Tmp_5: int, in_sdv_2: int, in_sdv_3: int, in_Tmp_7: int, in_sdv_7: int, in_sdv_8: int, in_Tmp_9: int, in_Tmp_10: int, in_Found: int, in_Extension: int) returns (out_i: int, out_Tmp_4: int, out_sdv_1: int, out_Tmp_5: int, out_sdv_2: int, out_sdv_3: int, out_Tmp_7: int, out_sdv_7: int, out_sdv_8: int, out_Tmp_9: int, out_Tmp_10: int, out_Found: int)
{
  ...
  anon41_Else:
    ...
    call {:si_unique_call 761} RtlInitUnicodeString(in_CheckMode, out_Tmp_5);
    call {:si_unique_call 762} out_sdv_7 := corral_nondet();
    goto anon36_Then, anon36_Else;
  ...
  anon42_Then:
    ...
    call {:si_unique_call 759} RtlInitUnicodeString(in_CheckMode, out_Tmp_9);
    call {:si_unique_call 760} out_sdv_1 := corral_nondet();
    goto anon37_Then, anon37_Else;
  ...
  anon43_Then:
    ...
    call {:si_unique_call 757} RtlInitUnicodeString(in_CheckMode, out_Tmp_10);
    call {:si_unique_call 758} out_sdv_8 := corral_nondet();
    goto anon38_Then, anon38_Else;
  ...
  anon44_Then:
    ...
    call {:si_unique_call 755} RtlInitUnicodeString(in_CheckMode, out_Tmp_4);
    call {:si_unique_call 756} out_sdv_3 := corral_nondet();
    goto anon39_Then, anon39_Else;
  ...
  anon35_Then:
    ...
    call {:si_unique_call 753} RtlInitUnicodeString(in_CheckMode, out_Tmp_7);
    call {:si_unique_call 754} out_sdv_2 := corral_nondet();
    goto anon40_Then, anon40_Else;
...
implementation VPI1Selection_loop_L71(in_i_1: int, in_Controller: int, in_sdv_16: int, in_Tmp_30: int) returns (out_i_1: int, out_sdv_16: int, out_Tmp_30: int)
{
  ...
  anon25_Else:
    ...
    call {:si_unique_call 764} out_sdv_16 := corral_nondet();
...
implementation VPI1Selection_loop_L33(in_i_1: int, in_Controller: int, in_sdv_15: int, in_Tmp_37: int) returns (out_i_1: int, out_sdv_15: int, out_Tmp_37: int)
{
  ...
  anon21_Else:
    assume {:partition} 25000 > out_i_1;
    call {:si_unique_call 765} out_sdv_15 := corral_nondet();
...
implementation VPI1DataIn_loop_L91(in_sdv_24: int, in_Extension_3: int, in_vslice_dummy_var_9: int) returns (out_sdv_24: int, out_vslice_dummy_var_9: int)
{
  ...
  L91:
    ...
    call {:si_unique_call 766} out_sdv_24 := corral_nondet();
    goto anon63_Else;
  ...
  anon63_Else:
    ...
    assume {:nonnull} in_Extension_3 != 0;
    assume in_Extension_3 > 0;
    call {:si_unique_call 767} out_vslice_dummy_var_9 := corral_nondet();
    goto anon63_Else_dummy;

  anon63_Else_dummy:
    call {:si_unique_call 768} {:si_old_unique_call 1} out_sdv_24, out_vslice_dummy_var_9 := VPI1DataIn_loop_L91(out_sdv_24, in_Extension_3, out_vslice_dummy_var_9);
    return;
}
...
implementation VPI1DataIn_loop_L16(in_ChunkSize: int, in_sdv_17: int, in_Status_2: int, in_sdv_20: int, in_BytesRead: int, in_Extension_3: int) returns (out_ChunkSize: int, out_sdv_17: int, out_Status_2: int, out_sdv_20: int)
{
  ...
  anon46_Else:
    ...
    call {:si_unique_call 770} out_sdv_17 := VPI1GetPhase(in_Extension_3, vslice_dummy_var_239);
    goto anon48_Else;
  ...
  anon53_Else:
    assume {:nonnull} in_Extension_3 != 0;
    assume in_Extension_3 > 0;
    call {:si_unique_call 771} out_sdv_20 := corral_nondet();
    goto anon54_Then;
  ...
  anon65_Else:
    ...
    call {:si_unique_call 769} out_Status_2 := VPI1ParallelRead(in_Extension_3, vslice_dummy_var_238, out_ChunkSize, in_BytesRead);
    assume {:nonnull} in_Extension_3 != 0;
    assume in_Extension_3 > 0;
    goto anon55_Then, anon55_Else;
  ...
  L_BAF_0:
    call {:si_unique_call 772} {:si_old_unique_call 1} out_ChunkSize, out_sdv_17, out_Status_2, out_sdv_20 := VPI1DataIn_loop_L16(out_ChunkSize, out_sdv_17, out_Status_2, out_sdv_20, in_BytesRead, in_Extension_3);
    return;
...
implementation VPI1Status_loop_L34(in_sdv_28: int, in_Extension_4: int, in_vslice_dummy_var_12: int) returns (out_sdv_28: int, out_vslice_dummy_var_12: int)
{
  ...
  L34:
    ...
    call {:si_unique_call 773} out_sdv_28 := corral_nondet();
    goto anon26_Then;
  ...
  anon26_Then:
    ...
    assume {:nonnull} in_Extension_4 != 0;
    assume in_Extension_4 > 0;
    call {:si_unique_call 774} out_vslice_dummy_var_12 := corral_nondet();
    goto anon26_Then_dummy;

  anon26_Then_dummy:
    call {:si_unique_call 775} {:si_old_unique_call 1} out_sdv_28, out_vslice_dummy_var_12 := VPI1Status_loop_L34(out_sdv_28, in_Extension_4, out_vslice_dummy_var_12);
    return;
}
...
implementation VPI1RestoreDrive_loop_L20(in_i_2: int, in_Tmp_57: int, in_Controller_1: int, in_sdv_32: int) returns (out_i_2: int, out_Tmp_57: int, out_sdv_32: int)
{
  ...
  anon5_Else:
    ...
    call {:si_unique_call 776} out_sdv_32 := corral_nondet();
...
implementation VPI1DataOut_loop_L13(in_ChunkSize_1: int, in_sdv_36: int, in_Status_4: int, in_BytesWritten: int, in_Extension_7: int) returns (out_ChunkSize_1: int, out_sdv_36: int, out_Status_4: int)
{
  ...
  anon28_Else:
    ...
    call {:si_unique_call 778} out_sdv_36 := VPI1GetPhase(in_Extension_7, vslice_dummy_var_241);
    goto anon29_Else;
  ...
  L34:
    ...
    call {:si_unique_call 777} out_Status_4 := VPI1ParallelWrite(in_Extension_7, vslice_dummy_var_240, out_ChunkSize_1, in_BytesWritten);
    assume {:nonnull} in_Extension_7 != 0;
    assume in_Extension_7 > 0;
    goto anon34_Then, anon34_Else;
  ...
  L_BAF_1:
    call {:si_unique_call 779} {:si_old_unique_call 1} out_ChunkSize_1, out_sdv_36, out_Status_4 := VPI1DataOut_loop_L13(out_ChunkSize_1, out_sdv_36, out_Status_4, in_BytesWritten, in_Extension_7);
    return;
...
implementation VPI1Command_loop_L10(in_i_3: int, in_Tmp_79: int, in_Tmp_81: int, in_Tmp_82: int, in_success_3: int, in_sdv_41: int, in_Status_6: int, in_BytesWritten_1: int, in_Tmp_83: int, in_Tmp_84: int, in_Extension_9: int) returns (out_i_3: int, out_Tmp_79: int, out_Tmp_81: int, out_Tmp_82: int, out_success_3: int, out_sdv_41: int, out_Status_6: int, out_Tmp_83: int, out_Tmp_84: int)
{
  ...
  anon27_Else:
    ...
    call {:si_unique_call 781} out_sdv_41 := VPI1GetPhase(in_Extension_9, vslice_dummy_var_242);
    goto anon19_Else;
  ...
  anon23_Then:
    ...
    call {:si_unique_call 780} out_Status_6 := VPI1ParallelWrite(in_Extension_9, out_Tmp_81, 1, in_BytesWritten_1);
    assume {:nonnull} in_Extension_9 != 0;
    assume in_Extension_9 > 0;
    goto anon24_Then, anon24_Else;
  ...
  L36_dummy:
    call {:si_unique_call 782} {:si_old_unique_call 1} out_i_3, out_Tmp_79, out_Tmp_81, out_Tmp_82, out_success_3, out_sdv_41, out_Status_6, out_Tmp_83, out_Tmp_84 := VPI1Command_loop_L10(out_i_3, out_Tmp_79, out_Tmp_81, out_Tmp_82, out_success_3, out_sdv_41, out_Status_6, in_BytesWritten_1, out_Tmp_83, out_Tmp_84, in_Extension_9);
    return;
...
implementation VPI1GetPhase_loop_L18(in_i_4: int, in_Tmp_87: int, in_Tmp_90: int, in_sdv_43: int, in_Controller_3: int, in_sdv_44: int, in_EcrController_1: int, in_phase: int) returns (out_i_4: int, out_Tmp_87: int, out_Tmp_90: int, out_sdv_43: int, out_sdv_44: int)
{
  ...
  anon35_Else:
    ...
    call {:si_unique_call 784} out_sdv_43 := corral_nondet();
  ...
  anon30_Then:
    assume {:partition} in_phase == 2;
    call {:si_unique_call 783} out_sdv_44 := corral_nondet();
...
implementation VPI1GetPhase_loop_L63(in_i_4: int, in_Tmp_92: int, in_Controller_3: int, in_sdv_47: int) returns (out_i_4: int, out_Tmp_92: int, out_sdv_47: int)
{
  ...
  anon38_Else:
    assume {:partition} out_i_4 != 0;
    call {:si_unique_call 785} out_sdv_47 := corral_nondet();
...
implementation VPI1DataNibbleRead_loop_L14(in_sdv_72: int, in_CharBufPtr_2: int, in_ByteRead: int, in_sdv_73: int, in_xferCount_2: int, in_Controller_8: int, in_ChunkSize_4: int) returns (out_sdv_72: int, out_ByteRead: int, out_sdv_73: int, out_xferCount_2: int)
{
  ...
  L14:
    call {:si_unique_call 786} out_sdv_72 := corral_nondet();
    call {:si_unique_call 787} out_sdv_73 := corral_nondet();
    call {:si_unique_call 788} out_ByteRead := corral_nondet();
...
implementation PpaPhaseMan_loop_L65(in_i_5: int, in_sdv_171: int, in_CurrPhase: int, in_Extension_25: int) returns (out_i_5: int, out_sdv_171: int)
{
  ...
  anon45_Else:
    ...
    call {:si_unique_call 789} out_sdv_171 := VPI1GetPhase(in_Extension_25, 0);
    goto anon40_Else;
  ...
  anon41_Else_dummy:
    call {:si_unique_call 790} {:si_old_unique_call 1} out_i_5, out_sdv_171 := PpaPhaseMan_loop_L65(out_i_5, out_sdv_171, in_CurrPhase, in_Extension_25);
    return;
}
...
implementation PpaPhaseMan_loop_L8(in_i_5: int, in_Tmp_364: int, in_sdv_166: int, in_sdv_170: int, in_sdv_171: int, in_sdv_172: int, in_sdv_173: int, in_sdv_174: int, in_Tmp_372: int, in_CurrPhase: int, in_busBusy: int, in_Extension_25: int, in_vslice_dummy_var_80: int) returns (out_i_5: int, out_Tmp_364: int, out_sdv_166: int, out_sdv_170: int, out_sdv_171: int, out_sdv_172: int, out_sdv_173: int, out_sdv_174: int, out_Tmp_372: int, out_CurrPhase: int, out_busBusy: int, out_vslice_dummy_var_80: int)
{

  entry:
    out_i_5, out_Tmp_364, out_sdv_166, out_sdv_170, out_sdv_171, out_sdv_172, out_sdv_173, out_sdv_174, out_Tmp_372, out_CurrPhase, out_busBusy, out_vslice_dummy_var_80 := in_i_5, in_Tmp_364, in_sdv_166, in_sdv_170, in_sdv_171, in_sdv_172, in_sdv_173, in_sdv_174, in_Tmp_372, in_CurrPhase, in_busBusy, in_vslice_dummy_var_80;
    goto L8, exit;
  ...
  anon32_Else:
    call {:si_unique_call 794} out_sdv_166 := VPI1GetPhase(in_Extension_25, 0);
    goto anon33_Else;
  ...
  anon42_Else:
    call {:si_unique_call 791} out_sdv_174 := PpaStatus(in_Extension_25);
    goto anon35_Else;
  ...
  L_BAF_2:
    call {:si_unique_call 799} {:si_old_unique_call 1} out_i_5, out_Tmp_364, out_sdv_166, out_sdv_170, out_sdv_171, out_sdv_172, out_sdv_173, out_sdv_174, out_Tmp_372, out_CurrPhase, out_busBusy, out_vslice_dummy_var_80 := PpaPhaseMan_loop_L8(out_i_5, out_Tmp_364, out_sdv_166, out_sdv_170, out_sdv_171, out_sdv_172, out_sdv_173, out_sdv_174, out_Tmp_372, out_CurrPhase, out_busBusy, in_Extension_25, out_vslice_dummy_var_80);
    return;

  anon42_Then:
    out_busBusy := 0;
    call {:si_unique_call 795} out_vslice_dummy_var_80 := PpaResetBus(in_Extension_25);
    assume {:nonnull} in_Extension_25 != 0;
    assume in_Extension_25 > 0;
    havoc out_Tmp_372;
  ...
  anon43_Then:
    call {:si_unique_call 796} out_sdv_173 := PpaCommand(in_Extension_25);
    goto anon36_Then;
  ...
  anon44_Then:
    call {:si_unique_call 797} out_sdv_172 := PpaDataIn(in_Extension_25);
    goto anon37_Then;
  ...
  anon34_Then:
    call {:si_unique_call 798} out_sdv_170 := PpaDataOut(in_Extension_25);
    goto anon38_Then;
  ...
  L65:
    call {:si_unique_call 792} out_i_5, out_sdv_171 := PpaPhaseMan_loop_L65(out_i_5, out_sdv_171, out_CurrPhase, in_Extension_25);
    goto L65_last;
  ...
  anon45_Else:
    assume {:partition} out_i_5 != 0;
    call {:si_unique_call 793} out_sdv_171 := VPI1GetPhase(in_Extension_25, 0);
    goto anon40_Then, anon40_Else;
...
procedure {:LoopProcedure} PpaPhaseMan_loop_L8(in_i_5: int, in_Tmp_364: int, in_sdv_166: int, in_sdv_170: int, in_sdv_171: int, in_sdv_172: int, in_sdv_173: int, in_sdv_174: int, in_Tmp_372: int, in_CurrPhase: int, in_busBusy: int, in_Extension_25: int, in_vslice_dummy_var_80: int) returns (out_i_5: int, out_Tmp_364: int, out_sdv_166: int, out_sdv_170: int, out_sdv_171: int, out_sdv_172: int, out_sdv_173: int, out_sdv_174: int, out_Tmp_372: int, out_CurrPhase: int, out_busBusy: int, out_vslice_dummy_var_80: int);
  modifies alloc;
...
implementation CheckPort_loop_L31(in_s_p_e_c_i_a_l_2: int, in_End: int)
{
  ...
  anon14_Then_dummy:
    call {:si_unique_call 800} {:si_old_unique_call 1} CheckPort_loop_L31(in_s_p_e_c_i_a_l_2, in_End);
    return;
}
...
implementation CheckPort_loop_L29(in_Tmp_385: int, in_Tmp_387: int, in_Wait_3: int, in_s_p_e_c_i_a_l_2: int, in_sdv_190: int, in_End: int, in_Start: int, in_dsr: int, in_bMask: int, in_bValue: int) returns (out_Tmp_385: int, out_Tmp_387: int, out_s_p_e_c_i_a_l_2: int, out_sdv_190: int, out_dsr: int)
{

  entry:
    out_Tmp_385, out_Tmp_387, out_s_p_e_c_i_a_l_2, out_sdv_190, out_dsr := in_Tmp_385, in_Tmp_387, in_s_p_e_c_i_a_l_2, in_sdv_190, in_dsr;
    goto L29, exit;
  ...
  L31:
    call {:si_unique_call 803} CheckPort_loop_L31(out_s_p_e_c_i_a_l_2, in_End);
    goto L31_last;
  ...
  anon14_Else:
    call {:si_unique_call 802} out_dsr := corral_nondet();
    out_Tmp_385 := BAND(out_dsr, in_bMask);
    goto anon15_Then;

  anon15_Then:
    assume {:partition} out_Tmp_385 != in_bValue;
    call {:si_unique_call 801} out_sdv_190 := corral_nondet();
    assume {:nonnull} in_End != 0;
    assume in_End > 0;
  ...
  anon11_Then_dummy:
    call {:si_unique_call 804} {:si_old_unique_call 1} out_Tmp_385, out_Tmp_387, out_s_p_e_c_i_a_l_2, out_sdv_190, out_dsr := CheckPort_loop_L29(out_Tmp_385, out_Tmp_387, in_Wait_3, out_s_p_e_c_i_a_l_2, out_sdv_190, in_End, in_Start, out_dsr, in_bMask, in_bValue);
    return;
...
procedure {:LoopProcedure} CheckPort_loop_L29(in_Tmp_385: int, in_Tmp_387: int, in_Wait_3: int, in_s_p_e_c_i_a_l_2: int, in_sdv_190: int, in_End: int, in_Start: int, in_dsr: int, in_bMask: int, in_bValue: int) returns (out_Tmp_385: int, out_Tmp_387: int, out_s_p_e_c_i_a_l_2: int, out_sdv_190: int, out_dsr: int);
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} false || old(t) == 1 || old(t) == 0;
  free ensures {:va_keep} alloc >= old(alloc);
  free ensures {:va_keep} false || t == 1 || t == 0;
...
implementation CheckPort_loop_L21(in_s_p_e_c_i_a_l_1: int, in_Start: int)
{
  ...
  anon13_Then_dummy:
    call {:si_unique_call 805} {:si_old_unique_call 1} CheckPort_loop_L21(in_s_p_e_c_i_a_l_1, in_Start);
    return;
}
...
implementation PpaIssueInquiry_loop_L14(in_cdb: int, in_Tmp_424: int, in_Tmp_425: int, in_Tmp_426: int, in_srb_3: int, in_status_9: int, in_Tmp_428: int, in_retryCount: int, in_Extension_37: int) returns (out_cdb: int, out_Tmp_424: int, out_Tmp_425: int, out_Tmp_426: int, out_status_9: int, out_Tmp_428: int, out_retryCount: int)
{

  entry:
    out_cdb, out_Tmp_424, out_Tmp_425, out_Tmp_426, out_status_9, out_Tmp_428, out_retryCount := in_cdb, in_Tmp_424, in_Tmp_425, in_Tmp_426, in_status_9, in_Tmp_428, in_retryCount;
    goto L14, exit;
  ...
  L14:
    call {:si_unique_call 806} sdv_RtlZeroMemory(0, 64);
    ...
    assume {:nonnull} in_Extension_37 != 0;
    assume in_Extension_37 > 0;
    call {:si_unique_call 807} IoStartTimer(0);
    call {:si_unique_call 808} out_status_9 := PpaStartExecution(in_Extension_37);
    assume {:nonnull} in_Extension_37 != 0;
    assume in_Extension_37 > 0;
    call {:si_unique_call 809} IoStopTimer(0);
    goto anon19_Else;
  ...
  anon23_Else:
    assume {:partition} out_Tmp_425 != 1;
    assume {:nonnull} in_srb_3 != 0;
    assume in_srb_3 > 0;
    havoc out_Tmp_426;
    goto anon24_Then, anon24_Else;
  ...
  anon24_Else:
    assume {:partition} out_Tmp_426 == 18;
    out_status_9 := 0;
    goto L60;
  ...
  anon21_Then_dummy:
    call {:si_unique_call 810} {:si_old_unique_call 1} out_cdb, out_Tmp_424, out_Tmp_425, out_Tmp_426, out_status_9, out_Tmp_428, out_retryCount := PpaIssueInquiry_loop_L14(out_cdb, out_Tmp_424, out_Tmp_425, out_Tmp_426, in_srb_3, out_status_9, out_Tmp_428, out_retryCount, in_Extension_37);
    return;
  ...
  anon25_Else:
    assume {:partition} out_Tmp_424 == 10;
    goto L68;
  ...
  anon26_Else:
    assume {:partition} out_Tmp_428 != 8;
...
procedure {:LoopProcedure} PpaIssueInquiry_loop_L14(in_cdb: int, in_Tmp_424: int, in_Tmp_425: int, in_Tmp_426: int, in_srb_3: int, in_status_9: int, in_Tmp_428: int, in_retryCount: int, in_Extension_37: int) returns (out_cdb: int, out_Tmp_424: int, out_Tmp_425: int, out_Tmp_426: int, out_status_9: int, out_Tmp_428: int, out_retryCount: int);
  modifies alloc;
...
implementation PpaIssueRequestSense_loop_L18(in_Tmp_436: int, in_Tmp_437: int, in_Tmp_438: int, in_Tmp_439: int, in_Tmp_440: int, in_Tmp_442: int, in_pIrpStack_4: int, in_Tmp_443: int, in_Tmp_445: int, in_Tmp_446: int, in_srb_4: int, in_status_11: int, in_Tmp_447: int, in_Tmp_448: int, in_retryCount_1: int, in_Tmp_449: int, in_Tmp_450: int, in_Extension_40: int) returns (out_Tmp_436: int, out_Tmp_437: int, out_Tmp_438: int, out_Tmp_439: int, out_Tmp_440: int, out_Tmp_442: int, out_Tmp_443: int, out_Tmp_445: int, out_Tmp_446: int, out_status_11: int, out_Tmp_447: int, out_Tmp_448: int, out_retryCount_1: int, out_Tmp_449: int, out_Tmp_450: int)
{

  entry:
    out_Tmp_436, out_Tmp_437, out_Tmp_438, out_Tmp_439, out_Tmp_440, out_Tmp_442, out_Tmp_443, out_Tmp_445, out_Tmp_446, out_status_11, out_Tmp_447, out_Tmp_448, out_retryCount_1, out_Tmp_449, out_Tmp_450 := in_Tmp_436, in_Tmp_437, in_Tmp_438, in_Tmp_439, in_Tmp_440, in_Tmp_442, in_Tmp_443, in_Tmp_445, in_Tmp_446, in_status_11, in_Tmp_447, in_Tmp_448, in_retryCount_1, in_Tmp_449, in_Tmp_450;
    goto L18, exit;
  ...
  L18:
    call {:si_unique_call 811} sdv_RtlZeroMemory(0, 64);
    ...
    assume {:nonnull} in_Extension_40 != 0;
    assume in_Extension_40 > 0;
    call {:si_unique_call 812} IoStartTimer(0);
    call {:si_unique_call 813} out_status_11 := PpaStartExecution(in_Extension_40);
    assume {:nonnull} in_Extension_40 != 0;
    assume in_Extension_40 > 0;
    call {:si_unique_call 814} IoStopTimer(0);
    goto anon17_Else;
  ...
  anon21_Else:
    assume {:partition} out_Tmp_449 != 1;
    assume {:nonnull} in_srb_4 != 0;
    assume in_srb_4 > 0;
    havoc out_Tmp_439;
    goto anon22_Then, anon22_Else;
  ...
  anon22_Else:
    assume {:partition} out_Tmp_439 == 18;
    out_status_11 := 0;
    goto L62;
  ...
  anon19_Then_dummy:
    call {:si_unique_call 815} {:si_old_unique_call 1} out_Tmp_436, out_Tmp_437, out_Tmp_438, out_Tmp_439, out_Tmp_440, out_Tmp_442, out_Tmp_443, out_Tmp_445, out_Tmp_446, out_status_11, out_Tmp_447, out_Tmp_448, out_retryCount_1, out_Tmp_449, out_Tmp_450 := PpaIssueRequestSense_loop_L18(out_Tmp_436, out_Tmp_437, out_Tmp_438, out_Tmp_439, out_Tmp_440, out_Tmp_442, in_pIrpStack_4, out_Tmp_443, out_Tmp_445, out_Tmp_446, in_srb_4, out_status_11, out_Tmp_447, out_Tmp_448, out_retryCount_1, out_Tmp_449, out_Tmp_450, in_Extension_40);
    return;
  ...
  anon23_Else:
    assume {:partition} out_Tmp_446 != 10;
    assume {:nonnull} in_srb_4 != 0;
    assume in_srb_4 > 0;
    havoc out_Tmp_440;
    goto anon24_Then, anon24_Else;
  ...
  anon24_Else:
    assume {:partition} out_Tmp_440 != 8;
...
procedure {:LoopProcedure} PpaIssueRequestSense_loop_L18(in_Tmp_436: int, in_Tmp_437: int, in_Tmp_438: int, in_Tmp_439: int, in_Tmp_440: int, in_Tmp_442: int, in_pIrpStack_4: int, in_Tmp_443: int, in_Tmp_445: int, in_Tmp_446: int, in_srb_4: int, in_status_11: int, in_Tmp_447: int, in_Tmp_448: int, in_retryCount_1: int, in_Tmp_449: int, in_Tmp_450: int, in_Extension_40: int) returns (out_Tmp_436: int, out_Tmp_437: int, out_Tmp_438: int, out_Tmp_439: int, out_Tmp_440: int, out_Tmp_442: int, out_Tmp_443: int, out_Tmp_445: int, out_Tmp_446: int, out_status_11: int, out_Tmp_447: int, out_Tmp_448: int, out_retryCount_1: int, out_Tmp_449: int, out_Tmp_450: int);
  modifies alloc;
...
implementation PpaStartDevice_loop_L26(in_Status_28: int, in_Extension_49: int) returns (out_Status_28: int)
{

  entry:
    out_Status_28 := in_Status_28;
    goto L26, exit;
  ...
  anon26_Else:
    call {:si_unique_call 816} out_Status_28 := PpaIssueInquiry(in_Extension_49);
    goto anon27_Else;
  ...
  anon27_Else_dummy:
    call {:si_unique_call 817} {:si_old_unique_call 1} out_Status_28 := PpaStartDevice_loop_L26(out_Status_28, in_Extension_49);
    return;
}



procedure {:LoopProcedure} PpaStartDevice_loop_L26(in_Status_28: int, in_Extension_49: int) returns (out_Status_28: int);
  modifies alloc;
  free ensures {:va_keep} out_Status_28 == 0 || out_Status_28 == -1073741823 || out_Status_28 == -1073741670 || out_Status_28 == in_Status_28;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} false || old(t) == 1 || old(t) == 0;
  free ensures {:va_keep} alloc >= old(alloc);
  free ensures {:va_keep} false || t == 1 || t == 0;
...
implementation PpaStartDevice_loop_L20(in_Status_28: int, in_Extension_49: int, in_sdv_265: int) returns (out_Status_28: int, out_sdv_265: int)
{

  entry:
    out_Status_28, out_sdv_265 := in_Status_28, in_sdv_265;
    goto L20, exit;
  ...
  L20:
    call {:si_unique_call 818} PpaPortLock(in_Extension_49, 1, 0);
    goto anon32_Else;
  ...
  L26:
    call {:si_unique_call 821} out_Status_28 := PpaStartDevice_loop_L26(out_Status_28, in_Extension_49);
    goto L26_last;
  ...
  anon26_Else:
    call {:si_unique_call 822} out_Status_28 := PpaIssueInquiry(in_Extension_49);
    goto anon27_Then, anon27_Else;
  ...
  L27:
    call {:si_unique_call 820} PpaPortUnlock#1(in_Extension_49, 1, 0);
    goto anon33_Else;
  ...
  anon28_Else:
    assume {:partition} out_Status_28 != 0;
    call {:si_unique_call 819} out_sdv_265 := PpaTrySlowerMode(in_Extension_49);
    goto anon29_Then;
  ...
  anon29_Then_dummy:
    call {:si_unique_call 823} {:si_old_unique_call 1} out_Status_28, out_sdv_265 := PpaStartDevice_loop_L20(out_Status_28, in_Extension_49, out_sdv_265);
    return;
...
procedure {:LoopProcedure} PpaStartDevice_loop_L20(in_Status_28: int, in_Extension_49: int, in_sdv_265: int) returns (out_Status_28: int, out_sdv_265: int);
  modifies alloc, Mem_T.CompletionRoutine__IO_STACK_LOCATION, LockDepth, yogi_error;
  free ensures {:va_keep} old(LockDepth) != 0 ==> yogi_error == 0;
  free ensures {:va_keep} old(LockDepth) == 0 ==> yogi_error == 0;
  free ensures {:va_keep} yogi_error == 0;
...
procedure fakeMain() returns (Tmp_233: int, dup_assertVar: bool);
  modifies alloc, LockDepth, t, yogi_error, Mem_T.CompletionRoutine__IO_STACK_LOCATION;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} false || old(t) == 1 || old(t) == 0;
  free ensures {:va_keep} alloc >= old(alloc);
...
implementation {:entrypoint} fakeMain() returns (Tmp_233: int, dup_assertVar: bool)
{

  start:
    call Tmp_233, dup_assertVar := main();
