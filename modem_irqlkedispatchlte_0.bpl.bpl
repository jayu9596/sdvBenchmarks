...
procedure {:origName "UniRundownShuttledWait"} UniRundownShuttledWait(actual_Extension_2: int, actual_ShuttlePointer: int, actual_ReferenceMask: int, actual_IrpToRunDown: int, actual_DeviceLockIrql: int, actual_StatusToComplete: int, actual_MaskCompleteValue: int);
  ...
  free ensures {:va_keep} sdv_irql_current == actual_DeviceLockIrql;
...
procedure {:origName "UniMakeIrpShuttledWait"} UniMakeIrpShuttledWait(actual_MaskState: int, actual_Irp_11: int, actual_OrigIrql_1: int, actual_GetNextIrpInQueue: int, actual_NewIrp: int) returns (Tmp_164: int);
  ...
  free ensures {:va_keep} sdv_irql_previous == old(sdv_irql_previous_2) || sdv_irql_previous == old(sdv_irql_previous_3) || sdv_irql_previous == actual_OrigIrql_1;
  free ensures {:va_keep} sdv_irql_previous_4 == old(sdv_irql_previous_4);
...
implementation {:origName "sdv_KeAcquireSpinLock"} {:osmodel} sdv_KeAcquireSpinLock(actual_SpinLock_1: int, actual_p: int)
{
  ...
  anon0:
    ...
    p := actual_p;
    call {:si_unique_call 244} SLIC_sdv_KeAcquireSpinLock_entry(strConst__li2bpl4);
...
implementation {:origName "MmLockPagableSectionByHandle"} {:osmodel} MmLockPagableSectionByHandle(actual_ImageSectionHandle: int)
{
  ...
  anon0:
    call {:si_unique_call 245} vslice_dummy_var_29 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "sdv_KeReleaseSpinLockFromDpcLevel"} {:osmodel} sdv_KeReleaseSpinLockFromDpcLevel(actual_SpinLock_2: int)
{
  ...
  anon0:
    call {:si_unique_call 246} vslice_dummy_var_30 := __HAVOC_malloc(4);
...
implementation {:origName "KeLeaveCriticalRegion"} {:osmodel} KeLeaveCriticalRegion()
{
  ...
  anon0:
    call {:si_unique_call 247} vslice_dummy_var_31 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "IoDetachDevice"} {:osmodel} IoDetachDevice(actual_TargetDevice: int)
{
  ...
  anon0:
    call {:si_unique_call 248} vslice_dummy_var_32 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "sdv_SetPowerIrpMinorFunction"} {:osmodel} sdv_SetPowerIrpMinorFunction(actual_pirp_3: int)
{
  ...
  anon0:
    call {:si_unique_call 250} vslice_dummy_var_34 := __HAVOC_malloc(4);
...
implementation {:origName "sdv_main"} {:osmodel} sdv_main()
{
  ...
  anon0:
    ...
    call {:si_unique_call 254} sdv_stub_driver_init();
    call {:si_unique_call 255} vslice_dummy_var_38 := sdv_RunDispatchFunction(sdv_p_devobj_fdo, sdv_irp);
    goto anon3_Then, anon3_Else;
...
implementation {:origName "KeEnterCriticalRegion"} {:osmodel} KeEnterCriticalRegion()
{
  ...
  anon0:
    call {:si_unique_call 256} vslice_dummy_var_39 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "PoCallDriver"} {:osmodel} PoCallDriver(actual_DeviceObject_7: int, actual_Irp_13: int) returns (Tmp_227: int)
{
  ...
  anon0:
    call {:si_unique_call 257} completion := __HAVOC_malloc(4);
  ...
  anon56_Then:
    ...
    call {:si_unique_call 258} vslice_dummy_var_40 := sdv_RunIoCompletionRoutines#1(sdv_p_devobj_fdo, Irp_13, vslice_dummy_var_37, completion);
    goto anon76_Then, anon76_Else;
  ...
  anon68_Else:
    ...
    call {:si_unique_call 259} vslice_dummy_var_43 := sdv_RunIoCompletionRoutines#1(sdv_p_devobj_fdo, Irp_13, vslice_dummy_var_38, completion);
    goto anon78_Then, anon78_Else;
  ...
  anon60_Else:
    ...
    call {:si_unique_call 260} vslice_dummy_var_41 := sdv_RunIoCompletionRoutines#1(sdv_p_devobj_fdo, Irp_13, vslice_dummy_var_39, completion);
    goto anon74_Then, anon74_Else;
  ...
  anon64_Else:
    ...
    call {:si_unique_call 261} vslice_dummy_var_42 := sdv_RunIoCompletionRoutines#1(sdv_p_devobj_fdo, Irp_13, vslice_dummy_var_44, completion);
    goto anon72_Then, anon72_Else;
...
implementation {:origName "WmiSystemControl"} {:osmodel} WmiSystemControl(actual_WmiLibInfo: int, actual_DeviceObject_8: int, actual_pirp_6: int, actual_IrpDisposition: int) returns (Tmp_229: int)
{
  ...
  anon12_Then:
    ...
    s_1 := 0;
    call {:si_unique_call 264} sdv_stub_WmiIrpNotCompleted(0);
    goto L24;
  ...
  anon9_Then:
    ...
    s_1 := 0;
    call {:si_unique_call 265} sdv_stub_WmiIrpProcessed(0);
    goto L24;
}
...
implementation {:origName "sdv_IoSetCompletionRoutine"} {:osmodel} sdv_IoSetCompletionRoutine(actual_pirp_7: int, actual_CompletionRoutine: int, actual_Context_5: int, actual_InvokeOnSuccess: int, actual_InvokeOnError: int, actual_InvokeOnCancel: int)
{
  ...
  anon0:
    call {:si_unique_call 266} vslice_dummy_var_44 := __HAVOC_malloc(4);
...
implementation {:origName "sdv_InitializeObjectAttributes"} {:osmodel} sdv_InitializeObjectAttributes(actual_p_1: int, actual_n: int, actual_a: int, actual_r_3: int, actual_s_2: int)
{
  ...
  anon0:
    call {:si_unique_call 271} vslice_dummy_var_47 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "PoRequestPowerIrp"} {:osmodel} PoRequestPowerIrp(actual_DeviceObject_10: int, actual_MinorFunction: int, actual_SD2: int, actual_CompletionFunction: int, actual_Context_6: int, actual_Irp_15: int) returns (Tmp_261: int)
{
  ...
  anon0:
    call {:si_unique_call 274} PowerState_2 := __HAVOC_malloc(8);
  ...
  anon9_Else:
    ...
    assume {:nonnull} sdv_power_irp != 0;
    assume sdv_power_irp > 0;
    call {:si_unique_call 275} vslice_dummy_var_50 := sdv_RunPowerCompletionRoutines(DeviceObject_10, MinorFunction, PowerState_2, Context_6, IoStatus__IRP(sdv_power_irp), CompletionFunction);
    Tmp_261 := 259;
    goto L1;
...
implementation {:origName "main"} {:osmodel} main() returns (Tmp_263: int, dup_assertVar: bool)
{
  ...
  anon0:
    dup_assertVar := true;
    assume alloc > 0;
    call {:si_unique_call 276} NMI_NOTIFY_TYPE_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume NMI_NOTIFY_TYPE_GUID__Loc == NMI_NOTIFY_TYPE_GUID;
    assume NMI_NOTIFY_TYPE_GUID != 0;
    call {:si_unique_call 277} GUID_POWERBUTTON_ACTION__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_POWERBUTTON_ACTION__Loc == GUID_POWERBUTTON_ACTION;
    assume GUID_POWERBUTTON_ACTION != 0;
    call {:si_unique_call 278} GUID_LIDOPEN_POWERSTATE__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_LIDOPEN_POWERSTATE__Loc == GUID_LIDOPEN_POWERSTATE;
    assume GUID_LIDOPEN_POWERSTATE != 0;
    call {:si_unique_call 279} GUID_PROCESSOR_PARKING_CORE_OVERRIDE__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 280} GUID_PROCESSOR_PERF_CORE_PARKING_HISTORY__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 281} GUID_PCIEXPRESS_SETTINGS_SUBGROUP__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 282} GUID_PROCESSOR_PERF_INCREASE_TIME__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 283} GUID_DISK_COALESCING_POWERDOWN_TIMEOUT__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 284} GUID_AUDIO_PLAYBACK__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_AUDIO_PLAYBACK__Loc == GUID_AUDIO_PLAYBACK;
    assume GUID_AUDIO_PLAYBACK != 0;
    call {:si_unique_call 285} IPF_SAL_RECORD_SECTION_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume IPF_SAL_RECORD_SECTION_GUID__Loc == IPF_SAL_RECORD_SECTION_GUID;
    assume IPF_SAL_RECORD_SECTION_GUID != 0;
    call {:si_unique_call 286} PROCESSOR_GENERIC_ERROR_SECTION_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 287} GUID_USERINTERFACEBUTTON_ACTION__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_USERINTERFACEBUTTON_ACTION__Loc == GUID_USERINTERFACEBUTTON_ACTION;
    assume GUID_USERINTERFACEBUTTON_ACTION != 0;
    call {:si_unique_call 288} GUID_PROCESSOR_THROTTLE_POLICY__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_PROCESSOR_THROTTLE_POLICY__Loc == GUID_PROCESSOR_THROTTLE_POLICY;
    assume GUID_PROCESSOR_THROTTLE_POLICY != 0;
    call {:si_unique_call 289} GUID_PCIEXPRESS_ASPM_POLICY__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_PCIEXPRESS_ASPM_POLICY__Loc == GUID_PCIEXPRESS_ASPM_POLICY;
    assume GUID_PCIEXPRESS_ASPM_POLICY != 0;
    call {:si_unique_call 290} GUID_BATTERY_PERCENTAGE_REMAINING__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 302} WHEA_TLBCHECK_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume WHEA_TLBCHECK_GUID__Loc == WHEA_TLBCHECK_GUID;
    assume WHEA_TLBCHECK_GUID != 0;
    call {:si_unique_call 303} GUID_MONITOR_POWER_ON__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_MONITOR_POWER_ON__Loc == GUID_MONITOR_POWER_ON;
    assume GUID_MONITOR_POWER_ON != 0;
    call {:si_unique_call 304} GUID_IDLE_RESILIENCY_PERIOD__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_IDLE_RESILIENCY_PERIOD__Loc == GUID_IDLE_RESILIENCY_PERIOD;
    assume GUID_IDLE_RESILIENCY_PERIOD != 0;
    call {:si_unique_call 305} GUID_PROCESSOR_DISTRIBUTE_UTILITY__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 306} GUID_DEVINTERFACE_MODEM__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_DEVINTERFACE_MODEM__Loc == GUID_DEVINTERFACE_MODEM;
    assume GUID_DEVINTERFACE_MODEM != 0;
    call {:si_unique_call 307} GUID_PROCESSOR_PERF_INCREASE_HISTORY__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 314} MCE_NOTIFY_TYPE_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MCE_NOTIFY_TYPE_GUID__Loc == MCE_NOTIFY_TYPE_GUID;
    assume MCE_NOTIFY_TYPE_GUID != 0;
    call {:si_unique_call 315} GUID_PROCESSOR_IDLE_DISABLE__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_PROCESSOR_IDLE_DISABLE__Loc == GUID_PROCESSOR_IDLE_DISABLE;
    assume GUID_PROCESSOR_IDLE_DISABLE != 0;
    call {:si_unique_call 316} WHEA_CACHECHECK_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume WHEA_CACHECHECK_GUID__Loc == WHEA_CACHECHECK_GUID;
    assume WHEA_CACHECHECK_GUID != 0;
    call {:si_unique_call 317} GUID_DISK_POWERDOWN_TIMEOUT__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_DISK_POWERDOWN_TIMEOUT__Loc == GUID_DISK_POWERDOWN_TIMEOUT;
    assume GUID_DISK_POWERDOWN_TIMEOUT != 0;
    call {:si_unique_call 318} GUID_PROCESSOR_CORE_PARKING_OVER_UTILIZATION_HISTORY_THRESHOLD__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 319} GUID_DISK_IDLE_TIMEOUT__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_DISK_IDLE_TIMEOUT__Loc == GUID_DISK_IDLE_TIMEOUT;
    assume GUID_DISK_IDLE_TIMEOUT != 0;
    call {:si_unique_call 320} GUID_CONSOLE_DISPLAY_STATE__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_CONSOLE_DISPLAY_STATE__Loc == GUID_CONSOLE_DISPLAY_STATE;
    assume GUID_CONSOLE_DISPLAY_STATE != 0;
    call {:si_unique_call 321} GUID_ADAPTIVE_POWER_BEHAVIOR_SUBGROUP__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 322} GUID_BATTERY_DISCHARGE_FLAGS_0__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_BATTERY_DISCHARGE_FLAGS_0__Loc == GUID_BATTERY_DISCHARGE_FLAGS_0;
    assume GUID_BATTERY_DISCHARGE_FLAGS_0 != 0;
    call {:si_unique_call 323} GUID_PROCESSOR_PARKING_HEADROOM_THRESHOLD__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 324} GUID_ACDC_POWER_SOURCE__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_ACDC_POWER_SOURCE__Loc == GUID_ACDC_POWER_SOURCE;
    assume GUID_ACDC_POWER_SOURCE != 0;
    call {:si_unique_call 325} WHEA_MSCHECK_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume WHEA_MSCHECK_GUID__Loc == WHEA_MSCHECK_GUID;
    assume WHEA_MSCHECK_GUID != 0;
    call {:si_unique_call 326} GUID_DEVICE_POWER_POLICY_VIDEO_DIM_BRIGHTNESS__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 327} GUID_PROCESSOR_IDLE_PROMOTE_THRESHOLD__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 328} FIRMWARE_ERROR_RECORD_REFERENCE_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 329} GUID_PROCESSOR_CORE_PARKING_DECREASE_TIME__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 338} GUID_DEVINTERFACE_SERENUM_BUS_ENUMERATOR__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 346} GUID_ALLOW_SYSTEM_REQUIRED__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_ALLOW_SYSTEM_REQUIRED__Loc == GUID_ALLOW_SYSTEM_REQUIRED;
    assume GUID_ALLOW_SYSTEM_REQUIRED != 0;
    call {:si_unique_call 347} GUID_VIDEO_ADAPTIVE_DISPLAY_BRIGHTNESS__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 348} GUID_PROCESSOR_IDLE_ALLOW_SCALING__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 359} GENERIC_SECTION_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume GENERIC_SECTION_GUID__Loc == GENERIC_SECTION_GUID;
    assume GENERIC_SECTION_GUID != 0;
    call {:si_unique_call 360} GUID_CRITICAL_POWER_TRANSITION__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_CRITICAL_POWER_TRANSITION__Loc == GUID_CRITICAL_POWER_TRANSITION;
    assume GUID_CRITICAL_POWER_TRANSITION != 0;
    call {:si_unique_call 361} GUID_PROCESSOR_PERF_INCREASE_THRESHOLD__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 362} GUID_BACKGROUND_TASK_NOTIFICATION__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 363} BOOT_NOTIFY_TYPE_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume BOOT_NOTIFY_TYPE_GUID__Loc == BOOT_NOTIFY_TYPE_GUID;
    assume BOOT_NOTIFY_TYPE_GUID != 0;
    call {:si_unique_call 364} GENERIC_NOTIFY_TYPE_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume GENERIC_NOTIFY_TYPE_GUID__Loc == GENERIC_NOTIFY_TYPE_GUID;
    assume GENERIC_NOTIFY_TYPE_GUID != 0;
    call {:si_unique_call 365} GUID_SLEEP_IDLE_THRESHOLD__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_SLEEP_IDLE_THRESHOLD__Loc == GUID_SLEEP_IDLE_THRESHOLD;
    assume GUID_SLEEP_IDLE_THRESHOLD != 0;
    call {:si_unique_call 366} GUID_PROCESSOR_CORE_PARKING_DECREASE_POLICY__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 367} GUID_PROCESSOR_PERF_HISTORY__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_PROCESSOR_PERF_HISTORY__Loc == GUID_PROCESSOR_PERF_HISTORY;
    assume GUID_PROCESSOR_PERF_HISTORY != 0;
    call {:si_unique_call 368} GUID_PROCESSOR_IDLE_STATE_MAXIMUM__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 369} GUID_VIDEO_ANNOYANCE_TIMEOUT__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_VIDEO_ANNOYANCE_TIMEOUT__Loc == GUID_VIDEO_ANNOYANCE_TIMEOUT;
    assume GUID_VIDEO_ANNOYANCE_TIMEOUT != 0;
    call {:si_unique_call 370} GUID_BATTERY_DISCHARGE_FLAGS_3__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_BATTERY_DISCHARGE_FLAGS_3__Loc == GUID_BATTERY_DISCHARGE_FLAGS_3;
    assume GUID_BATTERY_DISCHARGE_FLAGS_3 != 0;
    call {:si_unique_call 371} GUID_PROCESSOR_THROTTLE_MAXIMUM__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_PROCESSOR_THROTTLE_MAXIMUM__Loc == GUID_PROCESSOR_THROTTLE_MAXIMUM;
    assume GUID_PROCESSOR_THROTTLE_MAXIMUM != 0;
    call {:si_unique_call 372} GUID_PROCESSOR_CORE_PARKING_MAX_CORES__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 373} GUID_PROCESSOR_PARKING_PERF_STATE__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 374} GUID_PROCESSOR_PERF_DECREASE_POLICY__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 375} GUID_VIDEO_ADAPTIVE_PERCENT_INCREASE__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 376} GUID_VIDEO_ADAPTIVE_POWERDOWN__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_VIDEO_ADAPTIVE_POWERDOWN__Loc == GUID_VIDEO_ADAPTIVE_POWERDOWN;
    assume GUID_VIDEO_ADAPTIVE_POWERDOWN != 0;
    call {:si_unique_call 377} PCIe_NOTIFY_TYPE_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume PCIe_NOTIFY_TYPE_GUID__Loc == PCIe_NOTIFY_TYPE_GUID;
    assume PCIe_NOTIFY_TYPE_GUID != 0;
    call {:si_unique_call 378} WHEA_ERROR_PACKET_SECTION_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume WHEA_ERROR_PACKET_SECTION_GUID__Loc == WHEA_ERROR_PACKET_SECTION_GUID;
    assume WHEA_ERROR_PACKET_SECTION_GUID != 0;
    call {:si_unique_call 379} GUID_PROCESSOR_CORE_PARKING_INCREASE_THRESHOLD__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 393} GUID_EXECUTION_REQUIRED_REQUEST_TIMEOUT__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 394} GUID_PROCESSOR_CORE_PARKING_OVER_UTILIZATION_THRESHOLD__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 395} GUID_SLEEP_SUBGROUP__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_SLEEP_SUBGROUP__Loc == GUID_SLEEP_SUBGROUP;
    assume GUID_SLEEP_SUBGROUP != 0;
    call {:si_unique_call 396} GUID_BATTERY_DISCHARGE_ACTION_1__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_BATTERY_DISCHARGE_ACTION_1__Loc == GUID_BATTERY_DISCHARGE_ACTION_1;
    assume GUID_BATTERY_DISCHARGE_ACTION_1 != 0;
    call {:si_unique_call 397} GUID_PROCESSOR_PERF_INCREASE_POLICY__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 398} MEMORY_ERROR_SECTION_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MEMORY_ERROR_SECTION_GUID__Loc == MEMORY_ERROR_SECTION_GUID;
    assume MEMORY_ERROR_SECTION_GUID != 0;
    call {:si_unique_call 399} GUID_DEVINTERFACE_COMPORT__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_DEVINTERFACE_COMPORT__Loc == GUID_DEVINTERFACE_COMPORT;
    assume GUID_DEVINTERFACE_COMPORT != 0;
    call {:si_unique_call 400} GUID_VIDEO_SUBGROUP__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_VIDEO_SUBGROUP__Loc == GUID_VIDEO_SUBGROUP;
    assume GUID_VIDEO_SUBGROUP != 0;
    call {:si_unique_call 401} GUID_PROCESSOR_PERF_DECREASE_TIME__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 402} GUID_MAX_POWER_SAVINGS__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_MAX_POWER_SAVINGS__Loc == GUID_MAX_POWER_SAVINGS;
    assume GUID_MAX_POWER_SAVINGS != 0;
    call {:si_unique_call 403} GUID_TYPICAL_POWER_SAVINGS__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_TYPICAL_POWER_SAVINGS__Loc == GUID_TYPICAL_POWER_SAVINGS;
    assume GUID_TYPICAL_POWER_SAVINGS != 0;
    call {:si_unique_call 404} GUID_HIBERNATE_FASTS4_POLICY__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_HIBERNATE_FASTS4_POLICY__Loc == GUID_HIBERNATE_FASTS4_POLICY;
    assume GUID_HIBERNATE_FASTS4_POLICY != 0;
    call {:si_unique_call 405} GUID_BATTERY_SUBGROUP__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_BATTERY_SUBGROUP__Loc == GUID_BATTERY_SUBGROUP;
    assume GUID_BATTERY_SUBGROUP != 0;
    call {:si_unique_call 406} GUID_PROCESSOR_PERF_DECREASE_HISTORY__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 407} GUID_PROCESSOR_CORE_PARKING_AFFINITY_HISTORY_DECREASE_FACTOR__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 408} XPF_PROCESSOR_ERROR_SECTION_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume XPF_PROCESSOR_ERROR_SECTION_GUID__Loc == XPF_PROCESSOR_ERROR_SECTION_GUID;
    assume XPF_PROCESSOR_ERROR_SECTION_GUID != 0;
    call {:si_unique_call 409} GUID_PROCESSOR_SETTINGS_SUBGROUP__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_PROCESSOR_SETTINGS_SUBGROUP__Loc == GUID_PROCESSOR_SETTINGS_SUBGROUP;
    assume GUID_PROCESSOR_SETTINGS_SUBGROUP != 0;
    call {:si_unique_call 410} GUID_DEVICE_POWER_POLICY_VIDEO_BRIGHTNESS__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 411} GUID_IDLE_BACKGROUND_TASK__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_IDLE_BACKGROUND_TASK__Loc == GUID_IDLE_BACKGROUND_TASK;
    assume GUID_IDLE_BACKGROUND_TASK != 0;
    call {:si_unique_call 412} WHEA_BUSCHECK_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume WHEA_BUSCHECK_GUID__Loc == WHEA_BUSCHECK_GUID;
    assume WHEA_BUSCHECK_GUID != 0;
    call {:si_unique_call 413} GUID_BATTERY_DISCHARGE_FLAGS_2__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_BATTERY_DISCHARGE_FLAGS_2__Loc == GUID_BATTERY_DISCHARGE_FLAGS_2;
    assume GUID_BATTERY_DISCHARGE_FLAGS_2 != 0;
    call {:si_unique_call 414} GUID_DISK_SUBGROUP__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_DISK_SUBGROUP__Loc == GUID_DISK_SUBGROUP;
    assume GUID_DISK_SUBGROUP != 0;
    call {:si_unique_call 415} GUID_HIBERNATE_TIMEOUT__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_HIBERNATE_TIMEOUT__Loc == GUID_HIBERNATE_TIMEOUT;
    assume GUID_HIBERNATE_TIMEOUT != 0;
    call {:si_unique_call 416} CMC_NOTIFY_TYPE_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume CMC_NOTIFY_TYPE_GUID__Loc == CMC_NOTIFY_TYPE_GUID;
    assume CMC_NOTIFY_TYPE_GUID != 0;
    call {:si_unique_call 417} GUID_POWERSCHEME_PERSONALITY__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_POWERSCHEME_PERSONALITY__Loc == GUID_POWERSCHEME_PERSONALITY;
    assume GUID_POWERSCHEME_PERSONALITY != 0;
    call {:si_unique_call 418} GUID_PROCESSOR_CORE_PARKING_INCREASE_TIME__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 424} GUID_BATTERY_DISCHARGE_ACTION_3__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_BATTERY_DISCHARGE_ACTION_3__Loc == GUID_BATTERY_DISCHARGE_ACTION_3;
    assume GUID_BATTERY_DISCHARGE_ACTION_3 != 0;
    call {:si_unique_call 425} GUID_PROCESSOR_CORE_PARKING_OVER_UTILIZATION_WEIGHTING__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 426} GUID_INTSTEER_LOAD_PER_PROC_TRIGGER__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 427} GUID_PROCESSOR_PERF_DECREASE_THRESHOLD__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 428} GUID_BATTERY_DISCHARGE_LEVEL_0__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_BATTERY_DISCHARGE_LEVEL_0__Loc == GUID_BATTERY_DISCHARGE_LEVEL_0;
    assume GUID_BATTERY_DISCHARGE_LEVEL_0 != 0;
    call {:si_unique_call 429} GUID_PROCESSOR_CORE_PARKING_MIN_CORES__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 430} GUID_PROCESSOR_PARKING_CONCURRENCY_THRESHOLD__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 431} GUID_VIDEO_DIM_TIMEOUT__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_VIDEO_DIM_TIMEOUT__Loc == GUID_VIDEO_DIM_TIMEOUT;
    assume GUID_VIDEO_DIM_TIMEOUT != 0;
    call {:si_unique_call 432} GUID_PROCESSOR_CORE_PARKING_DECREASE_THRESHOLD__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 433} GUID_ACTIVE_POWERSCHEME__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_ACTIVE_POWERSCHEME__Loc == GUID_ACTIVE_POWERSCHEME;
    assume GUID_ACTIVE_POWERSCHEME != 0;
    call {:si_unique_call 434} GUID_SYSTEM_AWAYMODE__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_SYSTEM_AWAYMODE__Loc == GUID_SYSTEM_AWAYMODE;
    assume GUID_SYSTEM_AWAYMODE != 0;
    call {:si_unique_call 435} GUID_PROCESSOR_CORE_PARKING_OVER_UTILIZATION_HISTORY_DECREASE_FACTOR__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 436} GUID_PROCESSOR_PERF_TIME_CHECK__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_PROCESSOR_PERF_TIME_CHECK__Loc == GUID_PROCESSOR_PERF_TIME_CHECK;
    assume GUID_PROCESSOR_PERF_TIME_CHECK != 0;
    call {:si_unique_call 437} GUID_PROCESSOR_CORE_PARKING_AFFINITY_WEIGHTING__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 438} sdv_harnessStackLocation_next__Loc := __HAVOC_malloc_or_null(536);
    assume sdv_harnessStackLocation_next__Loc == sdv_harnessStackLocation_next;
    assume sdv_harnessStackLocation_next != 0;
    call {:si_unique_call 439} sdv_IoReadPartitionTableEx_DRIVE_LAYOUT_INFORMATION_EX__Loc := __HAVOC_malloc_or_null(76);
    assume sdv_IoReadPartitionTableEx_DRIVE_LAYOUT_INFORMATION_EX__Loc == sdv_IoReadPartitionTableEx_DRIVE_LAYOUT_INFORMATION_EX;
    assume sdv_IoReadPartitionTableEx_DRIVE_LAYOUT_INFORMATION_EX != 0;
    call {:si_unique_call 440} sdv_IoBuildAsynchronousFsdRequest_harnessIrp__Loc := __HAVOC_malloc_or_null(240);
    assume sdv_IoBuildAsynchronousFsdRequest_harnessIrp__Loc == sdv_IoBuildAsynchronousFsdRequest_harnessIrp;
    assume sdv_IoBuildAsynchronousFsdRequest_harnessIrp != 0;
    call {:si_unique_call 441} sdv_IoGetDeviceToVerify_DEVICE_OBJECT__Loc := __HAVOC_malloc_or_null(380);
    assume sdv_IoGetDeviceToVerify_DEVICE_OBJECT__Loc == sdv_IoGetDeviceToVerify_DEVICE_OBJECT;
    assume sdv_IoGetDeviceToVerify_DEVICE_OBJECT != 0;
    call {:si_unique_call 442} sdv_IoBuildDeviceIoControlRequest_harnessStackLocation_next__Loc := __HAVOC_malloc_or_null(536);
    assume sdv_IoBuildDeviceIoControlRequest_harnessStackLocation_next__Loc == sdv_IoBuildDeviceIoControlRequest_harnessStackLocation_next;
    assume sdv_IoBuildDeviceIoControlRequest_harnessStackLocation_next != 0;
    call {:si_unique_call 443} sdv_harness_IoBuildSynchronousFsdRequest_IoStatusBlock__Loc := __HAVOC_malloc_or_null(12);
    assume sdv_harness_IoBuildSynchronousFsdRequest_IoStatusBlock__Loc == sdv_harness_IoBuildSynchronousFsdRequest_IoStatusBlock;
    assume sdv_harness_IoBuildSynchronousFsdRequest_IoStatusBlock != 0;
    call {:si_unique_call 444} sdv_ControllerIrp__Loc := __HAVOC_malloc_or_null(240);
    assume sdv_ControllerIrp__Loc == sdv_ControllerIrp;
    assume sdv_ControllerIrp != 0;
    call {:si_unique_call 445} sdv_devobj_pdo__Loc := __HAVOC_malloc_or_null(380);
    assume sdv_devobj_pdo__Loc == sdv_devobj_pdo;
    assume sdv_devobj_pdo != 0;
    call {:si_unique_call 446} sdv_IoGetDmaAdapter_DMA_ADAPTER__Loc := __HAVOC_malloc_or_null(12);
    assume sdv_IoGetDmaAdapter_DMA_ADAPTER__Loc == sdv_IoGetDmaAdapter_DMA_ADAPTER;
    assume sdv_IoGetDmaAdapter_DMA_ADAPTER != 0;
    call {:si_unique_call 447} sdv_IoInitializeIrp_harnessIrp__Loc := __HAVOC_malloc_or_null(240);
    assume sdv_IoInitializeIrp_harnessIrp__Loc == sdv_IoInitializeIrp_harnessIrp;
    assume sdv_IoInitializeIrp_harnessIrp != 0;
    call {:si_unique_call 448} sdv_IoGetRelatedDeviceObject_DEVICE_OBJECT__Loc := __HAVOC_malloc_or_null(380);
    assume sdv_IoGetRelatedDeviceObject_DEVICE_OBJECT__Loc == sdv_IoGetRelatedDeviceObject_DEVICE_OBJECT;
    assume sdv_IoGetRelatedDeviceObject_DEVICE_OBJECT != 0;
    call {:si_unique_call 449} sdv_IoBuildSynchronousFsdRequest_harnessStackLocation_next__Loc := __HAVOC_malloc_or_null(536);
    assume sdv_IoBuildSynchronousFsdRequest_harnessStackLocation_next__Loc == sdv_IoBuildSynchronousFsdRequest_harnessStackLocation_next;
    assume sdv_IoBuildSynchronousFsdRequest_harnessStackLocation_next != 0;
    call {:si_unique_call 450} sdv_IoCreateSynchronizationEvent_KEVENT__Loc := __HAVOC_malloc_or_null(156);
    assume sdv_IoCreateSynchronizationEvent_KEVENT__Loc == sdv_IoCreateSynchronizationEvent_KEVENT;
    assume sdv_IoCreateSynchronizationEvent_KEVENT != 0;
    call {:si_unique_call 451} sdv_other_harnessStackLocation_next__Loc := __HAVOC_malloc_or_null(536);
    ...
    call {:si_unique_call 453} sdv_IoCreateController_CONTROLLER_OBJECT__Loc := __HAVOC_malloc_or_null(60);
    assume sdv_IoCreateController_CONTROLLER_OBJECT__Loc == sdv_IoCreateController_CONTROLLER_OBJECT;
    assume sdv_IoCreateController_CONTROLLER_OBJECT != 0;
    call {:si_unique_call 454} sdv_devobj_top__Loc := __HAVOC_malloc_or_null(380);
    assume sdv_devobj_top__Loc == sdv_devobj_top;
    assume sdv_devobj_top != 0;
    call {:si_unique_call 455} sdv_kdpc_val3__Loc := __HAVOC_malloc_or_null(44);
    assume sdv_kdpc_val3__Loc == sdv_kdpc_val3;
    assume sdv_kdpc_val3 != 0;
    call {:si_unique_call 456} sdv_IoBuildSynchronousFsdRequest_harnessIrp__Loc := __HAVOC_malloc_or_null(240);
    assume sdv_IoBuildSynchronousFsdRequest_harnessIrp__Loc == sdv_IoBuildSynchronousFsdRequest_harnessIrp;
    assume sdv_IoBuildSynchronousFsdRequest_harnessIrp != 0;
    call {:si_unique_call 457} sdv_IoGetDeviceObjectPointer_DEVICE_OBJECT__Loc := __HAVOC_malloc_or_null(380);
    assume sdv_IoGetDeviceObjectPointer_DEVICE_OBJECT__Loc == sdv_IoGetDeviceObjectPointer_DEVICE_OBJECT;
    assume sdv_IoGetDeviceObjectPointer_DEVICE_OBJECT != 0;
    call {:si_unique_call 458} sdv_MapRegisterBase_val__Loc := __HAVOC_malloc_or_null(4);
    assume sdv_MapRegisterBase_val__Loc == sdv_MapRegisterBase_val;
    assume sdv_MapRegisterBase_val != 0;
    call {:si_unique_call 459} sdv_IoGetFileObjectGenericMapping_GENERIC_MAPPING__Loc := __HAVOC_malloc_or_null(16);
    assume sdv_IoGetFileObjectGenericMapping_GENERIC_MAPPING__Loc == sdv_IoGetFileObjectGenericMapping_GENERIC_MAPPING;
    assume sdv_IoGetFileObjectGenericMapping_GENERIC_MAPPING != 0;
    call {:si_unique_call 460} sdv_IoMakeAssociatedIrp_harnessIrp__Loc := __HAVOC_malloc_or_null(240);
    assume sdv_IoMakeAssociatedIrp_harnessIrp__Loc == sdv_IoMakeAssociatedIrp_harnessIrp;
    assume sdv_IoMakeAssociatedIrp_harnessIrp != 0;
    call {:si_unique_call 461} sdv_devobj_child_pdo__Loc := __HAVOC_malloc_or_null(380);
    assume sdv_devobj_child_pdo__Loc == sdv_devobj_child_pdo;
    assume sdv_devobj_child_pdo != 0;
    call {:si_unique_call 462} sdv_harnessIrp__Loc := __HAVOC_malloc_or_null(240);
    assume sdv_harnessIrp__Loc == sdv_harnessIrp;
    assume sdv_harnessIrp != 0;
    call {:si_unique_call 463} sdv_IoBuildAsynchronousFsdRequest_harnessStackLocation_next__Loc := __HAVOC_malloc_or_null(536);
    assume sdv_IoBuildAsynchronousFsdRequest_harnessStackLocation_next__Loc == sdv_IoBuildAsynchronousFsdRequest_harnessStackLocation_next;
    assume sdv_IoBuildAsynchronousFsdRequest_harnessStackLocation_next != 0;
    call {:si_unique_call 464} sdv_harness_IoBuildDeviceIoControlRequest_IoStatusBlock__Loc := __HAVOC_malloc_or_null(12);
    assume sdv_harness_IoBuildDeviceIoControlRequest_IoStatusBlock__Loc == sdv_harness_IoBuildDeviceIoControlRequest_IoStatusBlock;
    assume sdv_harness_IoBuildDeviceIoControlRequest_IoStatusBlock != 0;
    call {:si_unique_call 465} sdv_kinterrupt_val__Loc := __HAVOC_malloc_or_null(0);
    assume sdv_kinterrupt_val__Loc == sdv_kinterrupt_val;
    assume sdv_kinterrupt_val != 0;
    call {:si_unique_call 466} sdv_fx_dev_object__Loc := __HAVOC_malloc_or_null(40);
    assume sdv_fx_dev_object__Loc == sdv_fx_dev_object;
    assume sdv_fx_dev_object != 0;
    call {:si_unique_call 467} sdv_devobj_fdo__Loc := __HAVOC_malloc_or_null(380);
    assume sdv_devobj_fdo__Loc == sdv_devobj_fdo;
    assume sdv_devobj_fdo != 0;
    call {:si_unique_call 468} sdv_StartIoIrp__Loc := __HAVOC_malloc_or_null(240);
    assume sdv_StartIoIrp__Loc == sdv_StartIoIrp;
    assume sdv_StartIoIrp != 0;
    call {:si_unique_call 469} sdv_harness_IoBuildAsynchronousFsdRequest_IoStatusBlock__Loc := __HAVOC_malloc_or_null(12);
    assume sdv_harness_IoBuildAsynchronousFsdRequest_IoStatusBlock__Loc == sdv_harness_IoBuildAsynchronousFsdRequest_IoStatusBlock;
    assume sdv_harness_IoBuildAsynchronousFsdRequest_IoStatusBlock != 0;
    call {:si_unique_call 470} sdv_PowerIrp__Loc := __HAVOC_malloc_or_null(240);
    assume sdv_PowerIrp__Loc == sdv_PowerIrp;
    assume sdv_PowerIrp != 0;
    call {:si_unique_call 471} sdv_IoBuildDeviceIoControlRequest_harnessIrp__Loc := __HAVOC_malloc_or_null(240);
    assume sdv_IoBuildDeviceIoControlRequest_harnessIrp__Loc == sdv_IoBuildDeviceIoControlRequest_harnessIrp;
    assume sdv_IoBuildDeviceIoControlRequest_harnessIrp != 0;
    call {:si_unique_call 472} sdv_other_harnessIrp__Loc := __HAVOC_malloc_or_null(240);
    assume sdv_other_harnessIrp__Loc == sdv_other_harnessIrp;
    assume sdv_other_harnessIrp != 0;
    call {:si_unique_call 473} sdv_IoCreateNotificationEvent_KEVENT__Loc := __HAVOC_malloc_or_null(156);
    assume sdv_IoCreateNotificationEvent_KEVENT__Loc == sdv_IoCreateNotificationEvent_KEVENT;
    assume sdv_IoCreateNotificationEvent_KEVENT != 0;
    call {:si_unique_call 474} sdv_other_harnessStackLocation__Loc := __HAVOC_malloc_or_null(536);
    assume sdv_other_harnessStackLocation__Loc == sdv_other_harnessStackLocation;
    assume sdv_other_harnessStackLocation != 0;
    call {:si_unique_call 475} DriverEntryRegPath__Loc := __HAVOC_malloc_or_null(12);
    assume DriverEntryRegPath__Loc == DriverEntryRegPath;
    assume DriverEntryRegPath != 0;
    call {:si_unique_call 476} GUID_TRANSLATOR_INTERFACE_STANDARD__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 477} GUID_ARBITER_INTERFACE_STANDARD__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_ARBITER_INTERFACE_STANDARD__Loc == GUID_ARBITER_INTERFACE_STANDARD;
    assume GUID_ARBITER_INTERFACE_STANDARD != 0;
    call {:si_unique_call 478} GUID_ACPI_CMOS_INTERFACE_STANDARD__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 479} GUID_BUS_TYPE_ISAPNP__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_BUS_TYPE_ISAPNP__Loc == GUID_BUS_TYPE_ISAPNP;
    assume GUID_BUS_TYPE_ISAPNP != 0;
    call {:si_unique_call 480} GUID_MF_ENUMERATION_INTERFACE__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_MF_ENUMERATION_INTERFACE__Loc == GUID_MF_ENUMERATION_INTERFACE;
    assume GUID_MF_ENUMERATION_INTERFACE != 0;
    call {:si_unique_call 481} GUID_LEGACY_DEVICE_DETECTION_STANDARD__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 482} GUID_PNP_POWER_SETTING_CHANGE__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_PNP_POWER_SETTING_CHANGE__Loc == GUID_PNP_POWER_SETTING_CHANGE;
    assume GUID_PNP_POWER_SETTING_CHANGE != 0;
    call {:si_unique_call 483} GUID_BUS_TYPE_ACPI__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_BUS_TYPE_ACPI__Loc == GUID_BUS_TYPE_ACPI;
    assume GUID_BUS_TYPE_ACPI != 0;
    call {:si_unique_call 484} GUID_PCI_EXPRESS_LINK_QUIESCENT_INTERFACE__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 485} GUID_BUS_TYPE_DOT4PRT__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_BUS_TYPE_DOT4PRT__Loc == GUID_BUS_TYPE_DOT4PRT;
    assume GUID_BUS_TYPE_DOT4PRT != 0;
    call {:si_unique_call 486} GUID_BUS_TYPE_EISA__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_BUS_TYPE_EISA__Loc == GUID_BUS_TYPE_EISA;
    assume GUID_BUS_TYPE_EISA != 0;
    call {:si_unique_call 487} GUID_ACPI_REGS_INTERFACE_STANDARD__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 488} GUID_TARGET_DEVICE_TRANSPORT_RELATIONS_CHANGED__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 489} GUID_PARTITION_UNIT_INTERFACE_STANDARD__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 490} GUID_BUS_TYPE_IRDA__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_BUS_TYPE_IRDA__Loc == GUID_BUS_TYPE_IRDA;
    assume GUID_BUS_TYPE_IRDA != 0;
    call {:si_unique_call 491} GUID_PCI_BUS_INTERFACE_STANDARD2__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_PCI_BUS_INTERFACE_STANDARD2__Loc == GUID_PCI_BUS_INTERFACE_STANDARD2;
    assume GUID_PCI_BUS_INTERFACE_STANDARD2 != 0;
    call {:si_unique_call 492} GUID_BUS_TYPE_MCA__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_BUS_TYPE_MCA__Loc == GUID_BUS_TYPE_MCA;
    assume GUID_BUS_TYPE_MCA != 0;
    call {:si_unique_call 493} GUID_PNP_LOCATION_INTERFACE__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_PNP_LOCATION_INTERFACE__Loc == GUID_PNP_LOCATION_INTERFACE;
    assume GUID_PNP_LOCATION_INTERFACE != 0;
    call {:si_unique_call 494} GUID_BUS_TYPE_INTERNAL__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_BUS_TYPE_INTERNAL__Loc == GUID_BUS_TYPE_INTERNAL;
    assume GUID_BUS_TYPE_INTERNAL != 0;
    call {:si_unique_call 495} GUID_PROCESSOR_PCC_INTERFACE_STANDARD__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 496} GUID_BUS_TYPE_PCI__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_BUS_TYPE_PCI__Loc == GUID_BUS_TYPE_PCI;
    assume GUID_BUS_TYPE_PCI != 0;
    call {:si_unique_call 497} WmiGuidInfo__Loc := __HAVOC_malloc_or_null(12);
    assume WmiGuidInfo__Loc == WmiGuidInfo;
    assume WmiGuidInfo != 0;
    call {:si_unique_call 498} GUID_TARGET_DEVICE_QUERY_REMOVE__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_TARGET_DEVICE_QUERY_REMOVE__Loc == GUID_TARGET_DEVICE_QUERY_REMOVE;
    assume GUID_TARGET_DEVICE_QUERY_REMOVE != 0;
    call {:si_unique_call 499} GUID_PCI_BUS_INTERFACE_STANDARD__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_PCI_BUS_INTERFACE_STANDARD__Loc == GUID_PCI_BUS_INTERFACE_STANDARD;
    assume GUID_PCI_BUS_INTERFACE_STANDARD != 0;
    call {:si_unique_call 500} GUID_HWPROFILE_QUERY_CHANGE__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_HWPROFILE_QUERY_CHANGE__Loc == GUID_HWPROFILE_QUERY_CHANGE;
    assume GUID_HWPROFILE_QUERY_CHANGE != 0;
    call {:si_unique_call 501} GUID_BUS_TYPE_SD__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_BUS_TYPE_SD__Loc == GUID_BUS_TYPE_SD;
    assume GUID_BUS_TYPE_SD != 0;
    call {:si_unique_call 502} GUID_PNP_POWER_NOTIFICATION__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_PNP_POWER_NOTIFICATION__Loc == GUID_PNP_POWER_NOTIFICATION;
    assume GUID_PNP_POWER_NOTIFICATION != 0;
    call {:si_unique_call 503} GUID_REENUMERATE_SELF_INTERFACE_STANDARD__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 504} GUID_BUS_TYPE_HID__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_BUS_TYPE_HID__Loc == GUID_BUS_TYPE_HID;
    assume GUID_BUS_TYPE_HID != 0;
    call {:si_unique_call 505} GUID_TARGET_DEVICE_REMOVE_COMPLETE__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 506} GUID_POWER_DEVICE_WAKE_ENABLE__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_POWER_DEVICE_WAKE_ENABLE__Loc == GUID_POWER_DEVICE_WAKE_ENABLE;
    assume GUID_POWER_DEVICE_WAKE_ENABLE != 0;
    call {:si_unique_call 507} GUID_PCMCIA_BUS_INTERFACE_STANDARD__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 508} GUID_BUS_TYPE_PCMCIA__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_BUS_TYPE_PCMCIA__Loc == GUID_BUS_TYPE_PCMCIA;
    assume GUID_BUS_TYPE_PCMCIA != 0;
    call {:si_unique_call 509} GUID_PCI_VIRTUALIZATION_INTERFACE__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 510} GUID_QUERY_CRASHDUMP_FUNCTIONS__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_QUERY_CRASHDUMP_FUNCTIONS__Loc == GUID_QUERY_CRASHDUMP_FUNCTIONS;
    assume GUID_QUERY_CRASHDUMP_FUNCTIONS != 0;
    call {:si_unique_call 511} GUID_BUS_TYPE_1394__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_BUS_TYPE_1394__Loc == GUID_BUS_TYPE_1394;
    assume GUID_BUS_TYPE_1394 != 0;
    call {:si_unique_call 512} GUID_AGP_TARGET_BUS_INTERFACE_STANDARD__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 513} GUID_TARGET_DEVICE_REMOVE_CANCELLED__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 529} GUID_BUS_TYPE_AVC__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_BUS_TYPE_AVC__Loc == GUID_BUS_TYPE_AVC;
    assume GUID_BUS_TYPE_AVC != 0;
    call {:si_unique_call 530} GUID_ACPI_PORT_RANGES_INTERFACE_STANDARD__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 531} GUID_BUS_TYPE_USB__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_BUS_TYPE_USB__Loc == GUID_BUS_TYPE_USB;
    assume GUID_BUS_TYPE_USB != 0;
    call {:si_unique_call 532} GUID_INT_ROUTE_INTERFACE_STANDARD__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 533} GUID_BUS_TYPE_USBPRINT__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_BUS_TYPE_USBPRINT__Loc == GUID_BUS_TYPE_USBPRINT;
    assume GUID_BUS_TYPE_USBPRINT != 0;
    call {:si_unique_call 534} GUID_BUS_TYPE_SW_DEVICE__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_BUS_TYPE_SW_DEVICE__Loc == GUID_BUS_TYPE_SW_DEVICE;
    assume GUID_BUS_TYPE_SW_DEVICE != 0;
    call {:si_unique_call 535} GUID_POWER_DEVICE_ENABLE__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_POWER_DEVICE_ENABLE__Loc == GUID_POWER_DEVICE_ENABLE;
    assume GUID_POWER_DEVICE_ENABLE != 0;
    call {:si_unique_call 536} GUID_PCI_EXPRESS_ROOT_PORT_INTERFACE__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 537} GUID_PNP_CUSTOM_NOTIFICATION__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_PNP_CUSTOM_NOTIFICATION__Loc == GUID_PNP_CUSTOM_NOTIFICATION;
    assume GUID_PNP_CUSTOM_NOTIFICATION != 0;
    call {:si_unique_call 538} GUID_PCC_INTERFACE_INTERNAL__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_PCC_INTERFACE_INTERNAL__Loc == GUID_PCC_INTERFACE_INTERNAL;
    assume GUID_PCC_INTERFACE_INTERNAL != 0;
    call {:si_unique_call 539} GUID_D3COLD_SUPPORT_INTERFACE__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_D3COLD_SUPPORT_INTERFACE__Loc == GUID_D3COLD_SUPPORT_INTERFACE;
    assume GUID_D3COLD_SUPPORT_INTERFACE != 0;
    call {:si_unique_call 540} GUID_ACPI_INTERFACE_STANDARD__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 548} boogieTmp := __HAVOC_malloc_or_null(240);
    assume sicrni == boogieTmp;
    call {:si_unique_call 549} boogieTmp := __HAVOC_malloc_or_null(4);
    assume PagedCodeSectionHandle == boogieTmp;
    assume {:mainInitDone} true;
    call {:si_unique_call 550} corralExtraInit();
    call {:si_unique_call 551} corralExplainErrorInit();
    call {:si_unique_call 552} _sdv_init15();
    call {:si_unique_call 553} _sdv_init1();
    call {:si_unique_call 554} _sdv_init4();
    call {:si_unique_call 555} _sdv_init5();
    call {:si_unique_call 556} _sdv_init3();
    call {:si_unique_call 557} _sdv_init6();
    call {:si_unique_call 558} _sdv_init10();
    call {:si_unique_call 559} _sdv_init11();
    call {:si_unique_call 560} _sdv_init9();
    call {:si_unique_call 561} _sdv_init12();
    call {:si_unique_call 562} _sdv_init13();
    call {:si_unique_call 563} _sdv_init7();
    call {:si_unique_call 564} _sdv_init8();
    call {:si_unique_call 565} _sdv_init2();
    goto anon9_Then, anon9_Else;
  ...
  L42:
    ...
    call {:si_unique_call 566} sdv_main();
    goto anon12_Then, anon12_Else;
...
implementation {:origName "sdv_IoSkipCurrentIrpStackLocation"} {:osmodel} sdv_IoSkipCurrentIrpStackLocation(actual_pirp_9: int)
{
  ...
  anon0:
    call {:si_unique_call 567} vslice_dummy_var_51 := __HAVOC_malloc(4);
...
implementation {:origName "sdv_RunPowerCompletionRoutines"} {:osmodel} sdv_RunPowerCompletionRoutines(actual_DeviceObject_11: int, actual_MinorFunction_1: int, actual_SD1: int, actual_Context_7: int, actual_IoStatus: int, actual_CompletionFunction_1: int) returns (Tmp_273: int)
{
  ...
  anon0:
    call {:si_unique_call 568} PowerState_1 := __HAVOC_malloc(8);
  ...
  anon3_Else:
    ...
    call {:si_unique_call 569} sdv_stub_power_completion_begin();
    call {:si_unique_call 570} SetPowerCompletion(DeviceObject_11, MinorFunction_1, PowerState_1, Context_7, IoStatus);
    sdv_irql_current := sdv_irql_previous;
    sdv_irql_previous := sdv_irql_previous_2;
    sdv_irql_previous_2 := sdv_irql_previous_3;
    sdv_irql_previous_3 := sdv_irql_previous_4;
...
implementation {:origName "RtlInitUnicodeString"} {:osmodel} RtlInitUnicodeString(actual_DestinationString: int, actual_SourceString: int)
{
  ...
  anon0:
    call {:si_unique_call 571} vslice_dummy_var_52 := __HAVOC_malloc(4);
...
implementation {:origName "MmUnlockPagableImageSection"} {:osmodel} MmUnlockPagableImageSection(actual_ImageSectionHandle_1: int)
{
  ...
  anon0:
    call {:si_unique_call 572} vslice_dummy_var_53 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "PoUnregisterSystemState"} {:osmodel} PoUnregisterSystemState(actual_StateHandle_1: int)
{
  ...
  anon0:
    call {:si_unique_call 573} vslice_dummy_var_54 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "sdv_RtlZeroMemory"} {:osmodel} sdv_RtlZeroMemory(actual_Destination_1: int, actual_Length_1: int)
{
  ...
  anon0:
    call {:si_unique_call 574} vslice_dummy_var_55 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "sdv_do_paged_code_check"} {:osmodel} sdv_do_paged_code_check()
{
  ...
  anon0:
    call {:si_unique_call 575} vslice_dummy_var_56 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "ZwCreateKey"} {:osmodel} ZwCreateKey(actual_KeyHandle_2: int, actual_DesiredAccess: int, actual_ObjectAttributes: int, actual_TitleIndex_1: int, actual_Class: int, actual_CreateOptions: int, actual_Disposition: int) returns (Tmp_287: int)
{
  ...
  anon3_Else:
    call {:si_unique_call 576} sdv_107 := __HAVOC_malloc(4);
...
implementation {:origName "sdv_IoMarkIrpPending"} {:osmodel} sdv_IoMarkIrpPending(actual_pirp_10: int)
{
  ...
  anon0:
    call {:si_unique_call 577} vslice_dummy_var_57 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "sdv_stub_WmiIrpNotCompleted"} {:osmodel} sdv_stub_WmiIrpNotCompleted(actual_pirp_11: int)
{
  ...
  anon0:
    call {:si_unique_call 578} vslice_dummy_var_58 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "sdv_RunDispatchFunction"} {:osmodel} sdv_RunDispatchFunction(actual_po: int, actual_pirp_12: int) returns (Tmp_293: int)
{
  ...
  anon0:
    ...
    assume {:nonnull} pirp_12 != 0;
    assume pirp_12 > 0;
    call {:si_unique_call 579} sdv_SetStatus(pirp_12);
    assume {:nonnull} pirp_12 != 0;
    assume pirp_12 > 0;
    assume {:nonnull} pirp_12 != 0;
    assume pirp_12 > 0;
    ...
    assume {:nonnull} ps != 0;
    assume ps > 0;
    call {:si_unique_call 580} sdv_stub_dispatch_begin();
    goto anon67_Then, anon67_Else;
  ...
  L66:
    call {:si_unique_call 581} status_4 := ModemPnP(po, pirp_12);
  ...
  L72:
    call {:si_unique_call 582} sdv_stub_dispatch_end(status_4, 0);
    assume {:nonnull} pirp_12 != 0;
    assume pirp_12 > 0;
    Tmp_293 := status_4;
    goto LM2;
  ...
  anon72_Then:
    call {:si_unique_call 583} status_4 := sdv_DoNothing();
    goto L72;

  anon73_Then:
    assume {:nonnull} ps != 0;
    assume ps > 0;
    call {:si_unique_call 584} status_4 := ModemWmi(po, pirp_12);
  ...
  anon74_Then:
    assume {:nonnull} ps != 0;
    assume ps > 0;
    call {:si_unique_call 585} sdv_SetPowerIrpMinorFunction(pirp_12);
    call {:si_unique_call 586} status_4 := ModemPower(po, pirp_12);
    goto anon96_Then, anon96_Else;
  ...
  anon75_Then:
    assume {:nonnull} ps != 0;
    assume ps > 0;
    call {:si_unique_call 587} status_4 := UniCleanup(po, pirp_12);
    goto anon95_Then, anon95_Else;
  ...
  anon79_Then:
    assume {:nonnull} ps != 0;
    assume ps > 0;
    call {:si_unique_call 591} status_4 := UniIoControl(po, pirp_12);
    goto anon94_Then, anon94_Else;
  ...
  anon84_Then:
    assume {:nonnull} ps != 0;
    assume ps > 0;
    call {:si_unique_call 596} status_4 := UniWrite(po, pirp_12);
    goto anon90_Then, anon90_Else;
  ...
  anon85_Then:
    assume {:nonnull} ps != 0;
    assume ps > 0;
    call {:si_unique_call 597} status_4 := UniRead(po, pirp_12);
    goto anon89_Then, anon89_Else;
  ...
  anon86_Then:
    assume {:nonnull} ps != 0;
    assume ps > 0;
    call {:si_unique_call 598} status_4 := UniClose(po, pirp_12);
    goto anon88_Then, anon88_Else;
  ...
  anon67_Then:
    assume {:nonnull} ps != 0;
    assume ps > 0;
    call {:si_unique_call 599} status_4 := UniOpen(po, pirp_12);
    goto anon87_Then, anon87_Else;
...
implementation {:origName "RtlFreeUnicodeString"} {:osmodel} RtlFreeUnicodeString(actual_UnicodeString: int)
{
  ...
  anon0:
    call {:si_unique_call 600} vslice_dummy_var_59 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "sdv_KeReleaseSpinLock"} {:osmodel} sdv_KeReleaseSpinLock(actual_SpinLock_3: int, actual_new_1: int)
{
  ...
  anon0:
    call {:si_unique_call 601} vslice_dummy_var_60 := __HAVOC_malloc(4);
    new_1 := actual_new_1;
...
implementation {:origName "SLIC_sdv_KeAcquireSpinLock_entry"} {:osmodel} SLIC_sdv_KeAcquireSpinLock_entry(actual_caller_11: int)
{
  ...
  anon10_Else:
    ...
    call {:si_unique_call 900} SLIC_ABORT_31_0(caller_11);
    goto anon12_Then, anon12_Else;
...
implementation {:origName "SLIC_ABORT_31_0"} SLIC_ABORT_31_0(actual_caller_28: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 901} SLIC_ERROR_ROUTINE(strConst__li2bpl31);
    return;
}
...
implementation {:origName "UniCleanup"} UniCleanup(actual_DeviceObject_28: int, actual_Irp_31: int) returns (Tmp_474: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 902} Tmp_483 := __HAVOC_malloc(48);
    call {:si_unique_call 903} Tmp_484 := __HAVOC_malloc(72);
    call {:si_unique_call 904} Tmp_485 := __HAVOC_malloc(48);
    call {:si_unique_call 905} Tmp_490 := __HAVOC_malloc(48);
    call {:si_unique_call 906} Tmp_491 := __HAVOC_malloc(48);
    assume {:nonnull} DeviceObject_28 != 0;
    assume DeviceObject_28 > 0;
    havoc extension_3;
    call {:si_unique_call 907} sdv_265 := sdv_IoGetCurrentIrpStackLocation(Irp_31);
  ...
  anon31_Then:
    call {:si_unique_call 909} Tmp_479 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_479 != 0;
    assume Tmp_479 > 0;
    Mem_T.INT4[Tmp_479] := origIrql_9;
    call {:si_unique_call 910} sdv_KeAcquireSpinLock(0, Tmp_479);
    goto anon32_Then, anon32_Else;
  ...
  anon27_Else:
    ...
    assume {:nonnull} thisMaskState_2 != 0;
    assume thisMaskState_2 > 0;
    call {:si_unique_call 911} UniRundownShuttledWait(extension_3, ShuttledWait__MASKSTATE(thisMaskState_2), 1, savedIrp_4, origIrql_9, 0, 0);
    goto L35;

  L35:
    call {:si_unique_call 912} sdv_266 := sdv_IoGetCurrentIrpStackLocation(Irp_31);
    ...
    call {:si_unique_call 913} EmptyIpcQueue(extension_3, Tmp_481);
    goto anon33_Then, anon33_Else;
  ...
  anon33_Else:
    ...
    call {:si_unique_call 914} EmptyIpcQueue(extension_3, Tmp_477);
    goto anon34_Then, anon34_Else;
  ...
  anon28_Else:
    ...
    call {:si_unique_call 915} EmptyIpcQueue(extension_3, Tmp_489);
    goto anon35_Then, anon35_Else;
  ...
  L55:
    ...
    call {:si_unique_call 916} EmptyIpcQueue(extension_3, Tmp_493);
    goto anon36_Then, anon36_Else;

  anon36_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 917} sdv_267 := sdv_IoGetCurrentIrpStackLocation(Irp_31);
  ...
  anon37_Else:
    call {:si_unique_call 918} CompletePowerWait(DeviceObject_28, -1073741536);
    goto anon38_Then, anon38_Else;
  ...
  anon38_Else:
    ...
    call {:si_unique_call 919} Tmp_474 := ForwardIrp(vslice_dummy_var_72, Irp_31);
    goto anon39_Then, anon39_Else;
  ...
  anon27_Then:
    call {:si_unique_call 921} sdv_KeReleaseSpinLock(0, origIrql_9);
    goto L35;
...
implementation {:origName "SetPowerCompletion"} SetPowerCompletion(actual_DeviceObject_29: int, actual_MinorFunction_2: int, actual_structPtr888PowerState: int, actual_Context_10: int, actual_IoStatus_1: int)
{
  ...
  anon0:
    call {:si_unique_call 922} PowerState := __HAVOC_malloc(8);
    call {:si_unique_call 923} vslice_dummy_var_120 := __HAVOC_malloc(4);
    ...
    assume {:nonnull} PowerBlock != 0;
    assume PowerBlock > 0;
    call {:si_unique_call 924} vslice_dummy_var_121 := KeSetEvent(Event__MODEM_POWER_BLOCK(PowerBlock), 0, 0);
    return;
}
...
implementation {:origName "UniOpenStarter"} UniOpenStarter(actual_Extension_4: int, actual_irp_1: int) returns (Tmp_496: int)
{
  ...
  anon0:
    call {:si_unique_call 925} defaultInactivity := __HAVOC_malloc(4);
    call {:si_unique_call 926} localKeyValue := __HAVOC_malloc(16);
    call {:si_unique_call 927} localDefault := __HAVOC_malloc(20);
    call {:si_unique_call 928} TspString := __HAVOC_malloc(12);
    call {:si_unique_call 929} valueEntryName_1 := __HAVOC_malloc(12);
    call {:si_unique_call 930} DefaultPowerDelay := __HAVOC_malloc(4);
    call {:si_unique_call 931} localProp_1 := __HAVOC_malloc(32);
    Extension_4 := actual_Extension_4;
    irp_1 := actual_irp_1;
    call {:si_unique_call 932} Tmp_497 := __HAVOC_malloc(72);
    call {:si_unique_call 933} paramTable := __HAVOC_malloc(168);
    call {:si_unique_call 934} Tmp_498 := __HAVOC_malloc(52);
    call {:si_unique_call 935} Tmp_500 := __HAVOC_malloc(72);
    call {:si_unique_call 936} Tmp_502 := __HAVOC_malloc(20);
    call {:si_unique_call 937} Tmp_503 := __HAVOC_malloc(72);
    call {:si_unique_call 938} Tmp_505 := __HAVOC_malloc(72);
    call {:si_unique_call 939} Tmp_506 := __HAVOC_malloc(72);
    call {:si_unique_call 940} Tmp_509 := __HAVOC_malloc(32);
    call {:si_unique_call 941} Tmp_511 := __HAVOC_malloc(72);
    call {:si_unique_call 942} Tmp_512 := __HAVOC_malloc(72);
    call {:si_unique_call 943} Tmp_514 := __HAVOC_malloc(72);
    call {:si_unique_call 944} Tmp_515 := __HAVOC_malloc(72);
    call {:si_unique_call 945} Tmp_517 := __HAVOC_malloc(48);
    call {:si_unique_call 946} Tmp_518 := __HAVOC_malloc(24);
    call {:si_unique_call 947} Tmp_519 := __HAVOC_malloc(48);
    call {:si_unique_call 948} Tmp_520 := __HAVOC_malloc(32);
    call {:si_unique_call 949} vslice_dummy_var_124 := __HAVOC_malloc(48);
    call {:si_unique_call 950} Tmp_525 := __HAVOC_malloc(48);
    call {:si_unique_call 951} Tmp_526 := __HAVOC_malloc(72);
    call {:si_unique_call 952} Tmp_528 := __HAVOC_malloc(72);
    call {:si_unique_call 953} Tmp_534 := __HAVOC_malloc(72);
    call {:si_unique_call 954} Tmp_535 := __HAVOC_malloc(24);
    status_11 := 0;
    accessMask_1 := 1;
    ...
    call {:si_unique_call 955} irpSp_17 := sdv_IoGetCurrentIrpStackLocation(irp_1);
    assume {:nonnull} irp_1 != 0;
    assume irp_1 > 0;
    assume {:nonnull} irp_1 != 0;
    assume irp_1 > 0;
  ...
  anon82_Else:
    Tmp_502 := strConst__li2bpl35;
    call {:si_unique_call 956} RtlInitUnicodeString(TspString, Tmp_502);
    assume {:nonnull} irpSp_17 != 0;
    assume irpSp_17 > 0;
    call {:si_unique_call 957} Match_1 := corral_nondet();
    goto anon60_Then, anon60_Else;
  ...
  anon62_Then:
    call {:si_unique_call 958} junkStatus := IoOpenDeviceRegistryKey(0, 2, accessMask_1, 0);
    goto anon64_Then, anon64_Else;

  anon64_Else:
    assume {:partition} junkStatus >= 0;
    call {:si_unique_call 959} sdv_RtlZeroMemory(0, 168);
    assume {:nonnull} paramTable != 0;
    assume paramTable > 0;
    assume {:nonnull} paramTable != 0;
    assume paramTable > 0;
    ...
    assume {:nonnull} paramTable != 0;
    assume paramTable > 0;
    call {:si_unique_call 960} sdv_283 := sdv_RtlQueryRegistryValues(-1073741824, 0, 0, 0, 0);
    goto anon65_Then, anon65_Else;

  anon65_Else:
    assume {:partition} sdv_283 >= 0;
    call {:si_unique_call 961} sdv_RtlZeroMemory(0, 80);
    call {:si_unique_call 962} sdv_RtlZeroMemory(0, 48);
    Tmp_498 := strConst__li2bpl0;
    call {:si_unique_call 963} RtlInitUnicodeString(valueEntryName_1, Tmp_498);
    assume {:nonnull} localKeyValue != 0;
    assume localKeyValue > 0;
    call {:si_unique_call 964} Tmp_507 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_507 != 0;
    assume Tmp_507 > 0;
    Mem_T.INT4[Tmp_507] := neededLength;
    call {:si_unique_call 965} junkStatus := ZwQueryValueKey(0, 0, 2, 0, 16, Tmp_507);
    assume {:nonnull} Tmp_507 != 0;
    assume Tmp_507 > 0;
  ...
  L123:
    ...
    call {:si_unique_call 966} RtlInitUnicodeString(valueEntryName_1, Tmp_535);
    assume {:nonnull} localKeyValue != 0;
    assume localKeyValue > 0;
    call {:si_unique_call 967} Tmp_507 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_507 != 0;
    assume Tmp_507 > 0;
    Mem_T.INT4[Tmp_507] := neededLength;
    call {:si_unique_call 968} junkStatus := ZwQueryValueKey(0, 0, 2, 0, 16, Tmp_507);
    assume {:nonnull} Tmp_507 != 0;
    assume Tmp_507 > 0;
    neededLength := Mem_T.INT4[Tmp_507];
    goto anon68_Then, anon68_Else;
  ...
  L135:
    ...
    call {:si_unique_call 969} RtlInitUnicodeString(valueEntryName_1, Tmp_520);
    assume {:nonnull} localKeyValue != 0;
    assume localKeyValue > 0;
    call {:si_unique_call 970} Tmp_507 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_507 != 0;
    assume Tmp_507 > 0;
    Mem_T.INT4[Tmp_507] := neededLength;
    call {:si_unique_call 971} junkStatus := ZwQueryValueKey(0, 0, 2, 0, 16, Tmp_507);
    assume {:nonnull} Tmp_507 != 0;
    assume Tmp_507 > 0;
    neededLength := Mem_T.INT4[Tmp_507];
    goto anon70_Then, anon70_Else;
  ...
  L147:
    call {:si_unique_call 972} vslice_dummy_var_122 := ZwClose(0);
    assume {:nonnull} Extension_4 != 0;
    assume Extension_4 > 0;
    assume {:nonnull} localProp_1 != 0;
    assume localProp_1 > 0;
    ...
    assume {:nonnull} Extension_4 != 0;
    assume Extension_4 > 0;
    call {:si_unique_call 973} vslice_dummy_var_125 := StartDevicePower(Extension_4);
    assume {:nonnull} Extension_4 != 0;
    assume Extension_4 > 0;
    havoc vslice_dummy_var_73;
    call {:si_unique_call 974} status_11 := WaitForLowerDriverToCompleteIrp(vslice_dummy_var_73, irp_1, 1);
    goto anon83_Then, anon83_Else;
  ...
  L183:
    ...
    assume Tmp_527 > 0;
    call {:si_unique_call 975} vslice_dummy_var_126 := SetDtr(Extension_4, 1);
    goto anon85_Then, anon85_Else;
  ...
  anon85_Else:
    ...
    call {:si_unique_call 976} vslice_dummy_var_123 := EnableDisableSerialWaitWake(Extension_4, vslice_dummy_var_74);
    goto anon86_Then, anon86_Else;
  ...
  anon86_Else:
    ...
    assume {:nonnull} Extension_4 != 0;
    assume Extension_4 > 0;
    call {:si_unique_call 977} ModemSleep(Mem_T.INT4[ConfigDelay__DEVICE_EXTENSION(Extension_4)]);
    assume {:nonnull} Extension_4 != 0;
    assume Extension_4 > 0;
    assume {:nonnull} Extension_4 != 0;
    assume Extension_4 > 0;
    ...
    assume {:nonnull} Extension_4 != 0;
    assume Extension_4 > 0;
    call {:si_unique_call 978} boogieTmp := IoGetCurrentProcess();
    assume {:nonnull} Extension_4 != 0;
    assume Extension_4 > 0;
    havoc Tmp_524;
    ...
    call {:si_unique_call 979} WaitIrp_1 := IoAllocateIrp(vslice_dummy_var_75, 0);
    goto anon73_Then, anon73_Else;
  ...
  anon73_Else:
    ...
    assume {:nonnull} WaitIrp_1 != 0;
    assume WaitIrp_1 > 0;
    call {:si_unique_call 980} waitSp := sdv_IoGetNextIrpStackLocation(WaitIrp_1);
    assume {:nonnull} WaitIrp_1 != 0;
    assume WaitIrp_1 > 0;
    assume {:nonnull} Extension_4 != 0;
    assume Extension_4 > 0;
    ...
    assume Tmp_534 > 0;
    call {:si_unique_call 981} MmLockPagableSectionByHandle(0);
    status_11 := 0;
    goto L49;
  ...
  anon73_Then:
    ...
    call {:si_unique_call 982} vslice_dummy_var_127 := UniCloseStarter(Extension_4, irp_1);
    goto anon87_Then, anon87_Else;
  ...
  anon65_Then:
    assume {:partition} 0 > sdv_283;
    status_11 := -1073741811;
    assume {:nonnull} irp_1 != 0;
    assume irp_1 > 0;
    call {:si_unique_call 983} vslice_dummy_var_128 := ZwClose(0);
    goto L49;
  ...
  anon60_Then:
    assume {:partition} Match_1 == 0;
    Tmp_509 := strConst__li2bpl36;
    call {:si_unique_call 984} RtlInitUnicodeString(TspString, Tmp_509);
    assume {:nonnull} irpSp_17 != 0;
    assume irpSp_17 > 0;
  ...
  anon74_Then:
    ...
    call {:si_unique_call 986} RtlInitUnicodeString(TspString, Tmp_518);
    assume {:nonnull} irpSp_17 != 0;
    assume irpSp_17 > 0;
  ...
  anon78_Else:
    ...
    assume Tmp_517 > 0;
    call {:si_unique_call 988} sdv_276 := sdv_IsListEmpty(0);
    goto anon79_Then, anon79_Else;
...
implementation {:origName "_sdv_init6"} _sdv_init6()
{
  ...
  anon0:
    call {:si_unique_call 989} vslice_dummy_var_129 := __HAVOC_malloc(4);
    havoc Mem_T.INT4;
    havoc Mem_T.INT4;
    havoc Mem_T.INT4;
    havoc Mem_T.INT4;
...
implementation {:origName "UniClose"} UniClose(actual_DeviceObject_30: int, actual_Irp_32: int) returns (Tmp_539: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 990} Tmp_540 := __HAVOC_malloc(4);
    ...
    call {:si_unique_call 991} vslice_dummy_var_131 := sdv_InterlockedIncrement(Tmp_540);
    assume {:nonnull} Tmp_540 != 0;
    assume Tmp_540 > 0;
    assume {:nonnull} deviceExtension_5 != 0;
    assume deviceExtension_5 > 0;
  ...
  anon5_Else:
    call {:si_unique_call 992} RemoveReferenceAndCompleteRequest(DeviceObject_30, Irp_32, -1073741823);
    Tmp_539 := -1073741823;
    goto L1;
  ...
  anon5_Then:
    call {:si_unique_call 993} KeEnterCriticalRegion();
    call {:si_unique_call 994} vslice_dummy_var_130 := ExAcquireResourceExclusiveLite(0, 1);
    call {:si_unique_call 995} status_12 := UniCloseStarter(deviceExtension_5, Irp_32);
    goto anon6_Then, anon6_Else;

  anon6_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 996} ExReleaseResourceLite(0);
    call {:si_unique_call 997} KeLeaveCriticalRegion();
    call {:si_unique_call 998} RemoveReferenceAndCompleteRequest(DeviceObject_30, Irp_32, status_12);
    Tmp_539 := status_12;
    goto L1;
...
implementation {:origName "ModemSleep"} ModemSleep(actual_MilliSeconds: int)
{
  ...
  anon0:
    call {:si_unique_call 999} vslice_dummy_var_132 := __HAVOC_malloc(4);
    MilliSeconds := actual_MilliSeconds;
    goto anon3_Then, anon3_Else;

  anon3_Else:
    assume {:partition} MilliSeconds > 0;
    call {:si_unique_call 1000} vslice_dummy_var_133 := KeDelayExecutionThread(0, 0, 0);
    goto L1;
...
implementation {:origName "EnableDisableSerialWaitWake"} EnableDisableSerialWaitWake(actual_deviceExtension_6: int, actual_Enable_1: int) returns (Tmp_543: int)
{
  ...
  anon0:
    call {:si_unique_call 1001} Event_4 := __HAVOC_malloc(156);
    call {:si_unique_call 1002} IoStatus_2 := __HAVOC_malloc(12);
    deviceExtension_6 := actual_deviceExtension_6;
    Enable_1 := actual_Enable_1;
    status_13 := 0;
    call {:si_unique_call 1003} KeInitializeEvent(Event_4, 0, 0);
    goto anon9_Then, anon9_Else;
  ...
  L14:
    call {:si_unique_call 1004} TempIrp := IoBuildDeviceIoControlRequest(Tmp_545, 0, 0, 0, 0, 0, 1, 0, IoStatus_2);
    goto anon10_Then, anon10_Else;
  ...
  anon10_Else:
    ...
    call {:si_unique_call 1005} status_13 := sdv_IoCallDriver#1(vslice_dummy_var_77, TempIrp);
    goto anon12_Then, anon12_Else;
  ...
  anon11_Else:
    ...
    call {:si_unique_call 1006} vslice_dummy_var_134 := KeWaitForSingleObject(0, 0, 0, 0, 0);
...
implementation {:origName "UniCloseStarter"} UniCloseStarter(actual_Extension_5: int, actual_irp_2: int) returns (Tmp_546: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 1007} sdv_297 := sdv_IoGetCurrentIrpStackLocation(irp_2);
  ...
  anon12_Else:
    assume {:nonnull} Extension_5 != 0;
    assume Extension_5 > 0;
    call {:si_unique_call 1008} sdv_298 := sdv_IoGetCurrentIrpStackLocation(irp_2);
  ...
  anon11_Else:
    assume {:nonnull} Extension_5 != 0;
    assume Extension_5 > 0;
    call {:si_unique_call 1009} sdv_299 := _InlineInterlockedExchangePointer(xOurWaitIrp__DEVICE_EXTENSION(Extension_5), 0);
    WaitIrp_2 := sdv_299;
    goto anon13_Then, anon13_Else;
  ...
  L26:
    ...
    call {:si_unique_call 1011} status_14 := WaitForLowerDriverToCompleteIrp(vslice_dummy_var_78, irp_2, 1);
    goto anon14_Then, anon14_Else;
  ...
  anon15_Else:
    call {:si_unique_call 1012} PoUnregisterSystemState(0);
    assume {:nonnull} Extension_5 != 0;
    assume Extension_5 > 0;
    goto L36;

  L36:
    call {:si_unique_call 1013} MmUnlockPagableImageSection(0);
    goto L18;
...
implementation {:origName "SetDtr"} SetDtr(actual_deviceExtension_7: int, actual_Enable_2: int) returns (Tmp_550: int)
{
  ...
  anon0:
    call {:si_unique_call 1014} Event_5 := __HAVOC_malloc(156);
    call {:si_unique_call 1015} IoStatus_3 := __HAVOC_malloc(12);
    deviceExtension_7 := actual_deviceExtension_7;
    status_15 := 0;
    call {:si_unique_call 1016} KeInitializeEvent(Event_5, 0, 0);
    call {:si_unique_call 1017} TempIrp_1 := IoBuildDeviceIoControlRequest(1769508, 0, 0, 0, 0, 0, 0, 0, IoStatus_3);
    goto anon7_Then, anon7_Else;
  ...
  anon7_Else:
    ...
    call {:si_unique_call 1018} status_15 := sdv_IoCallDriver#1(vslice_dummy_var_79, TempIrp_1);
    goto anon9_Then, anon9_Else;
  ...
  anon8_Else:
    ...
    call {:si_unique_call 1019} vslice_dummy_var_135 := KeWaitForSingleObject(0, 0, 0, 0, 0);
...
implementation {:origName "StartDevicePower"} StartDevicePower(actual_DeviceExtension_5: int) returns (Tmp_552: int)
{
  ...
  anon0:
    call {:si_unique_call 1020} PowerBlock_1 := __HAVOC_malloc(160);
    call {:si_unique_call 1021} PowerState_3 := __HAVOC_malloc(8);
  ...
  anon10_Else:
    ...
    call {:si_unique_call 1022} KeInitializeEvent(Event__MODEM_POWER_BLOCK(PowerBlock_1), 0, 0);
    assume {:nonnull} PowerState_3 != 0;
    assume PowerState_3 > 0;
    assume {:nonnull} DeviceExtension_5 != 0;
    assume DeviceExtension_5 > 0;
    havoc vslice_dummy_var_80;
    call {:si_unique_call 1023} Status_13 := PoRequestPowerIrp(vslice_dummy_var_80, 2, PowerState_3, li2bplFunctionConstant1306, PowerBlock_1, 0);
    goto anon11_Then, anon11_Else;

  anon11_Else:
    assume {:partition} Status_13 == 259;
    call {:si_unique_call 1024} vslice_dummy_var_136 := KeWaitForSingleObject(0, 0, 0, 0, 0);
    assume {:nonnull} PowerBlock_1 != 0;
    assume PowerBlock_1 > 0;
    havoc Status_13;
    goto L19;
  ...
  anon12_Else:
    ...
    assume {:nonnull} DeviceExtension_5 != 0;
    assume DeviceExtension_5 > 0;
    call {:si_unique_call 1025} ModemSleep(Mem_T.INT4[PowerDelay__DEVICE_EXTENSION(DeviceExtension_5)]);
    goto L24;
...
implementation {:origName "UniOpen"} UniOpen(actual_DeviceObject_31: int, actual_Irp_33: int) returns (Tmp_554: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 1026} Tmp_555 := __HAVOC_malloc(4);
    ...
    call {:si_unique_call 1027} vslice_dummy_var_138 := sdv_InterlockedIncrement(Tmp_555);
    assume {:nonnull} Tmp_555 != 0;
    assume Tmp_555 > 0;
    assume {:nonnull} deviceExtension_8 != 0;
    assume deviceExtension_8 > 0;
    call {:si_unique_call 1028} status_16 := CheckStateAndAddReference(DeviceObject_31, Irp_33);
    call {:si_unique_call 1029} Tmp_555 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_555 != 0;
    assume Tmp_555 > 0;
    assume {:nonnull} deviceExtension_8 != 0;
    assume deviceExtension_8 > 0;
    ...
    call {:si_unique_call 1030} vslice_dummy_var_139 := sdv_InterlockedDecrement(Tmp_555);
    assume {:nonnull} Tmp_555 != 0;
    assume Tmp_555 > 0;
    assume {:nonnull} deviceExtension_8 != 0;
    assume deviceExtension_8 > 0;
  ...
  anon7_Then:
    assume {:partition} status_16 == 0;
    call {:si_unique_call 1031} KeEnterCriticalRegion();
    call {:si_unique_call 1032} vslice_dummy_var_137 := ExAcquireResourceExclusiveLite(0, 1);
    assume {:nonnull} deviceExtension_8 != 0;
    assume deviceExtension_8 > 0;
    goto anon8_Then, anon8_Else;

  anon8_Else:
    call {:si_unique_call 1033} status_16 := UniOpenStarter(deviceExtension_8, Irp_33);
    goto anon9_Then, anon9_Else;
  ...
  L30:
    call {:si_unique_call 1034} ExReleaseResourceLite(0);
    call {:si_unique_call 1035} KeLeaveCriticalRegion();
    call {:si_unique_call 1036} RemoveReferenceAndCompleteRequest(DeviceObject_31, Irp_33, status_16);
    call {:si_unique_call 1037} RemoveReference(DeviceObject_31);
    Tmp_554 := status_16;
    goto L1;
...
procedure {:origName "sdv_InsertTailList"} sdv_InsertTailList(actual_sdv_320: int, actual_sdv_321: int) returns (Tmp_562: int);
  modifies alloc, Mem_T.INT4;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);
...
implementation {:origName "sdv_InsertTailList"} sdv_InsertTailList(actual_sdv_320: int, actual_sdv_321: int) returns (Tmp_562: int)
{
  var {:scalar} sdv_322: int;

  anon0:
    call {:si_unique_call 1038} sdv_322 := __HAVOC_malloc(4);
    call {:si_unique_call 1039} Tmp_562 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_562 != 0;
    assume Tmp_562 > 0;
    assume {:nonnull} sdv_322 != 0;
    assume sdv_322 > 0;
    Mem_T.INT4[Tmp_562] := Mem_T.INT4[sdv_322];
    return;
}
...
implementation {:origName "CheckStateAndAddReferenceWMI"} CheckStateAndAddReferenceWMI(actual_DeviceObject_32: int, actual_Irp_34: int) returns (Tmp_564: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 1040} Tmp_565 := __HAVOC_malloc(4);
    assume {:nonnull} DeviceExtension_6 != 0;
    assume DeviceExtension_6 > 0;
    ...
    call {:si_unique_call 1041} vslice_dummy_var_140 := sdv_InterlockedIncrement(Tmp_565);
    assume {:nonnull} DeviceExtension_6 != 0;
    assume DeviceExtension_6 > 0;
    assume {:nonnull} Tmp_565 != 0;
    assume Tmp_565 > 0;
  ...
  anon3_Else:
    call {:si_unique_call 1042} RemoveReferenceAndCompleteRequest(DeviceObject_32, Irp_34, -1073741823);
    Tmp_564 := -1073741823;
    goto L1;
  ...
  anon3_Then:
    call {:si_unique_call 1043} Tmp_565 := __HAVOC_malloc(4);
    assume {:nonnull} DeviceExtension_6 != 0;
    assume DeviceExtension_6 > 0;
    assume {:nonnull} Tmp_565 != 0;
    assume Tmp_565 > 0;
    ...
    call {:si_unique_call 1044} vslice_dummy_var_141 := sdv_InterlockedIncrement(Tmp_565);
    assume {:nonnull} DeviceExtension_6 != 0;
    assume DeviceExtension_6 > 0;
    assume {:nonnull} Tmp_565 != 0;
    assume Tmp_565 > 0;
...
implementation {:origName "CheckStateAndAddReferencePower"} CheckStateAndAddReferencePower(actual_DeviceObject_33: int, actual_Irp_35: int) returns (Tmp_566: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 1045} Tmp_567 := __HAVOC_malloc(4);
    assume {:nonnull} DeviceExtension_7 != 0;
    assume DeviceExtension_7 > 0;
    ...
    call {:si_unique_call 1046} vslice_dummy_var_142 := sdv_InterlockedIncrement(Tmp_567);
    assume {:nonnull} DeviceExtension_7 != 0;
    assume DeviceExtension_7 > 0;
    assume {:nonnull} Tmp_567 != 0;
    assume Tmp_567 > 0;
  ...
  anon3_Else:
    call {:si_unique_call 1047} PoStartNextPowerIrp(0);
    call {:si_unique_call 1048} RemoveReferenceAndCompleteRequest(DeviceObject_33, Irp_35, -1073741823);
    Tmp_566 := -1073741823;
    goto L1;
  ...
  anon3_Then:
    call {:si_unique_call 1049} Tmp_567 := __HAVOC_malloc(4);
    assume {:nonnull} DeviceExtension_7 != 0;
    assume DeviceExtension_7 > 0;
    assume {:nonnull} Tmp_567 != 0;
    assume Tmp_567 > 0;
    ...
    call {:si_unique_call 1050} vslice_dummy_var_143 := sdv_InterlockedIncrement(Tmp_567);
    assume {:nonnull} DeviceExtension_7 != 0;
    assume DeviceExtension_7 > 0;
    assume {:nonnull} Tmp_567 != 0;
    assume Tmp_567 > 0;
...
implementation {:origName "CheckStateAndAddReference"} CheckStateAndAddReference(actual_DeviceObject_34: int, actual_Irp_36: int) returns (Tmp_568: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 1051} vslice_dummy_var_144 := __HAVOC_malloc(184);
    call {:si_unique_call 1052} vslice_dummy_var_145 := __HAVOC_malloc(232);
    assume {:nonnull} DeviceObject_34 != 0;
    assume DeviceObject_34 > 0;
    havoc DeviceExtension_8;
    call {:si_unique_call 1053} irpSp_18 := sdv_IoGetCurrentIrpStackLocation(Irp_36);
    assume {:nonnull} DeviceExtension_8 != 0;
    assume DeviceExtension_8 > 0;
    goto anon11_Then, anon11_Else;
  ...
  anon14_Else:
    call {:si_unique_call 1054} Tmp_570 := __HAVOC_malloc(4);
    assume {:nonnull} DeviceExtension_8 != 0;
    assume DeviceExtension_8 > 0;
    ...
    call {:si_unique_call 1055} vslice_dummy_var_146 := sdv_InterlockedIncrement(Tmp_570);
    assume {:nonnull} DeviceExtension_8 != 0;
    assume DeviceExtension_8 > 0;
    assume {:nonnull} Tmp_570 != 0;
    assume Tmp_570 > 0;
  ...
  anon15_Else:
    call {:si_unique_call 1056} RemoveReferenceAndCompleteRequest(DeviceObject_34, Irp_36, -1073741823);
    Tmp_568 := -1073741823;
    goto L1;
  ...
  anon15_Then:
    call {:si_unique_call 1057} Tmp_570 := __HAVOC_malloc(4);
    assume {:nonnull} DeviceExtension_8 != 0;
    assume DeviceExtension_8 > 0;
    assume {:nonnull} Tmp_570 != 0;
    assume Tmp_570 > 0;
    ...
    call {:si_unique_call 1058} vslice_dummy_var_147 := sdv_InterlockedIncrement(Tmp_570);
    assume {:nonnull} DeviceExtension_8 != 0;
    assume DeviceExtension_8 > 0;
    assume {:nonnull} Tmp_570 != 0;
    assume Tmp_570 > 0;
  ...
  anon13_Then:
    call {:si_unique_call 1060} vslice_dummy_var_148 := corral_nondet();
    goto L17;
  ...
  anon12_Else:
    call {:si_unique_call 1061} vslice_dummy_var_149 := corral_nondet();
    goto L17;
...
implementation {:origName "RemoveReference"} RemoveReference(actual_DeviceObject_35: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 1064} NewReferenceCount_1 := sdv_InterlockedDecrement(Tmp_572);
    assume {:nonnull} DeviceExtension_9 != 0;
    assume DeviceExtension_9 > 0;
    assume {:nonnull} Tmp_572 != 0;
    assume Tmp_572 > 0;
  ...
  anon3_Else:
    ...
    assume {:nonnull} DeviceExtension_9 != 0;
    assume DeviceExtension_9 > 0;
    call {:si_unique_call 1065} vslice_dummy_var_151 := KeSetEvent(RemoveEvent__DEVICE_EXTENSION(DeviceExtension_9), 0, 0);
    goto L1;
...
implementation {:origName "_sdv_init3"} _sdv_init3()
{
  ...
  anon0:
    call {:si_unique_call 1066} vslice_dummy_var_152 := __HAVOC_malloc(4);
    havoc Mem_T.INT4;
    havoc Mem_T.INT4;
    havoc Mem_T.INT4;
    havoc Mem_T.INT4;
...
implementation {:origName "RemoveReferenceAndCompleteRequest"} RemoveReferenceAndCompleteRequest(actual_DeviceObject_36: int, actual_Irp_37: int, actual_StatusToReturn: int)
{
  ...
  anon0:
    call {:si_unique_call 1067} vslice_dummy_var_153 := __HAVOC_malloc(4);
    ...
    call {:si_unique_call 1068} Tmp_576 := __HAVOC_malloc(4);
    ...
    call {:si_unique_call 1069} NewReferenceCount_2 := sdv_InterlockedDecrement(Tmp_576);
    assume {:nonnull} DeviceExtension_10 != 0;
    assume DeviceExtension_10 > 0;
    assume {:nonnull} Tmp_576 != 0;
    assume Tmp_576 > 0;
  ...
  L15:
    ...
    assume Irp_37 > 0;
    call {:si_unique_call 1070} sdv_IoCompleteRequest(0, 2);
    return;
  ...
  anon3_Then:
    ...
    assume {:nonnull} DeviceExtension_10 != 0;
    assume DeviceExtension_10 > 0;
    call {:si_unique_call 1071} vslice_dummy_var_154 := KeSetEvent(RemoveEvent__DEVICE_EXTENSION(DeviceExtension_10), 0, 0);
    goto L15;
}
...
implementation {:origName "UniWrite"} UniWrite(actual_DeviceObject_37: int, actual_Irp_38: int) returns (Tmp_578: int)
{
  ...
  anon0:
    ...
    havoc deviceExtension_9;
    call {:si_unique_call 1072} irpSp_19 := sdv_IoGetCurrentIrpStackLocation(Irp_38);
    call {:si_unique_call 1073} status_17 := CheckStateAndAddReference(DeviceObject_37, Irp_38);
    goto anon11_Then, anon11_Else;
  ...
  anon11_Then:
    assume {:partition} status_17 == 0;
    call {:si_unique_call 1074} sdv_338 := CanIrpGoThrough(deviceExtension_9, irpSp_19);
    goto anon12_Then, anon12_Else;
  ...
  anon13_Else:
    assume {:nonnull} deviceExtension_9 != 0;
    assume deviceExtension_9 > 0;
    call {:si_unique_call 1075} status_17 := QueueIrp(WriteIrpControl__DEVICE_EXTENSION(deviceExtension_9), Irp_38);
    goto anon14_Then, anon14_Else;
  ...
  L32:
    call {:si_unique_call 1076} RemoveReference(DeviceObject_37);
    Tmp_578 := status_17;
    goto L1;
  ...
  anon13_Then:
    call {:si_unique_call 1077} sdv_IoSkipCurrentIrpStackLocation(Irp_38);
    assume {:nonnull} deviceExtension_9 != 0;
    assume deviceExtension_9 > 0;
    havoc vslice_dummy_var_91;
    call {:si_unique_call 1078} status_17 := sdv_IoCallDriver#1(vslice_dummy_var_91, Irp_38);
    goto anon15_Then, anon15_Else;

  anon15_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 1079} RemoveReference(DeviceObject_37);
    goto L32;
  ...
  anon12_Then:
    assume {:partition} sdv_338 == 0;
    call {:si_unique_call 1080} RemoveReferenceAndCompleteRequest(DeviceObject_37, Irp_38, -1073741769);
...
implementation {:origName "StartNextReadWriteIrp"} StartNextReadWriteIrp(actual_Control: int)
{
  ...
  anon0:
    call {:si_unique_call 1081} vslice_dummy_var_155 := __HAVOC_malloc(4);
    Control := actual_Control;
    call {:si_unique_call 1082} Tmp_581 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_581 != 0;
    assume Tmp_581 > 0;
    Mem_T.INT4[Tmp_581] := origIrql_10;
    call {:si_unique_call 1083} sdv_KeAcquireSpinLock(0, Tmp_581);
  ...
  L13:
    call {:si_unique_call 1084} sdv_KeReleaseSpinLock(0, origIrql_10);
    goto LM2;
  ...
  L17:
    call {:si_unique_call 1085} Irp_39, sdv_341, origIrql_10, sdv_344, sdv_346, Tmp_581, ListElement_1, CancelIrql_7, vslice_dummy_var_156 := StartNextReadWriteIrp_loop_L17(Irp_39, sdv_341, origIrql_10, sdv_344, sdv_346, Tmp_581, ListElement_1, CancelIrql_7, Control, vslice_dummy_var_156);
    goto L17_last;
  ...
  L18:
    call {:si_unique_call 1086} Irp_39, sdv_341, sdv_346, Tmp_581, ListElement_1, CancelIrql_7 := StartNextReadWriteIrp_loop_L18(Irp_39, sdv_341, sdv_346, Tmp_581, ListElement_1, CancelIrql_7, Control);
    goto L18_last;

  L18_last:
    call {:si_unique_call 1102} sdv_341 := sdv_IsListEmpty(0);
    goto anon21_Then, anon21_Else;
  ...
  anon21_Else:
    ...
    assume {:nonnull} Control != 0;
    assume Control > 0;
    call {:si_unique_call 1087} ListElement_1 := RemoveHeadList(ListHead__READ_WRITE_CONTROL(Control));
    call {:si_unique_call 1088} sdv_346 := sdv_containing_record(ListElement_1, 88);
    Irp_39 := sdv_346;
    call {:si_unique_call 1089} Tmp_581 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_581 != 0;
    assume Tmp_581 > 0;
    Mem_T.INT4[Tmp_581] := CancelIrql_7;
    call {:si_unique_call 1090} IoAcquireCancelSpinLock(Tmp_581);
    assume {:nonnull} Tmp_581 != 0;
    assume Tmp_581 > 0;
  ...
  anon25_Else:
    ...
    assume Irp_39 > 0;
    Irp_39 := 0;
    call {:si_unique_call 1091} IoReleaseCancelSpinLock(CancelIrql_7);
  ...
  anon25_Then:
    call {:si_unique_call 1092} vslice_dummy_var_156 := sdv_IoSetCancelRoutine(Irp_39, 0);
  ...
  anon23_Else:
    call {:si_unique_call 1094} sdv_KeReleaseSpinLock(0, origIrql_10);
    assume {:nonnull} Control != 0;
    assume Control > 0;
    havoc vslice_dummy_var_92;
    call {:si_unique_call 1095} RemoveReferenceAndCompleteRequest(vslice_dummy_var_92, Irp_39, -1073741536);
    call {:si_unique_call 1096} Tmp_581 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_581 != 0;
    assume Tmp_581 > 0;
    Mem_T.INT4[Tmp_581] := origIrql_10;
    call {:si_unique_call 1097} sdv_KeAcquireSpinLock(0, Tmp_581);
    goto anon29_Then, anon29_Else;
  ...
  anon22_Then:
    call {:si_unique_call 1098} sdv_344 := sdv_IsListEmpty(0);
  ...
  anon23_Then:
    call {:si_unique_call 1099} sdv_KeReleaseSpinLock(0, origIrql_10);
    assume {:nonnull} Control != 0;
    assume Control > 0;
    call {:si_unique_call 1100} Tmp_581 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_581 != 0;
    assume Tmp_581 > 0;
    Mem_T.INT4[Tmp_581] := origIrql_10;
    call {:si_unique_call 1101} sdv_KeAcquireSpinLock(0, Tmp_581);
    goto anon30_Then, anon30_Else;
...
implementation {:origName "HandleDleIrp"} HandleDleIrp(actual_deviceExtension_10: int)
{
  ...
  anon0:
    call {:si_unique_call 1103} vslice_dummy_var_157 := __HAVOC_malloc(4);
    deviceExtension_10 := actual_deviceExtension_10;
    DleIrp_1 := 0;
    call {:si_unique_call 1104} Tmp_582 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_582 != 0;
    assume Tmp_582 > 0;
    Mem_T.INT4[Tmp_582] := origIrql_11;
    call {:si_unique_call 1105} sdv_KeAcquireSpinLock(0, Tmp_582);
    goto anon18_Then, anon18_Else;
  ...
  anon14_Else:
    ...
    call {:si_unique_call 1106} sdv_347 := HasIrpBeenCanceled(vslice_dummy_var_93);
    goto anon15_Then, anon15_Else;
  ...
  anon15_Else:
    ...
    assume {:nonnull} deviceExtension_10 != 0;
    assume deviceExtension_10 > 0;
    call {:si_unique_call 1107} irpSp_20 := sdv_IoGetCurrentIrpStackLocation(DleIrp_1);
    assume {:nonnull} deviceExtension_10 != 0;
    assume deviceExtension_10 > 0;
  ...
  L29:
    ...
    call {:si_unique_call 1108} sdv_RtlCopyMemory(0, 0, BytesToTransfer_1);
    assume {:nonnull} deviceExtension_10 != 0;
    assume deviceExtension_10 > 0;
    assume {:nonnull} deviceExtension_10 != 0;
    assume deviceExtension_10 > 0;
    ...
    call {:si_unique_call 1109} sdv_RtlMoveMemory(0, 0, vslice_dummy_var_94);
    assume {:nonnull} DleIrp_1 != 0;
    assume DleIrp_1 > 0;
    goto L10;

  L10:
    call {:si_unique_call 1110} sdv_KeReleaseSpinLock(0, origIrql_11);
    goto anon17_Then, anon17_Else;
  ...
  anon17_Else:
    ...
    call {:si_unique_call 1111} RemoveReferenceAndCompleteRequest(vslice_dummy_var_95, DleIrp_1, 0);
    goto L1;
...
implementation {:origName "_sdv_init5"} _sdv_init5()
{
  ...
  anon0:
    call {:si_unique_call 1112} vslice_dummy_var_158 := __HAVOC_malloc(4);
    havoc Mem_T.INT4;
    havoc Mem_T.INT4;
    havoc Mem_T.INT4;
    havoc Mem_T.INT4;
...
implementation {:origName "UniRead"} UniRead(actual_DeviceObject_38: int, actual_Irp_40: int) returns (Tmp_588: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 1113} irpSp_21 := sdv_IoGetCurrentIrpStackLocation(Irp_40);
    call {:si_unique_call 1114} status_18 := CheckStateAndAddReference(DeviceObject_38, Irp_40);
    goto anon11_Then, anon11_Else;
  ...
  anon11_Then:
    assume {:partition} status_18 == 0;
    call {:si_unique_call 1115} sdv_351 := CanIrpGoThrough(deviceExtension_11, irpSp_21);
    goto anon12_Then, anon12_Else;
  ...
  anon13_Else:
    assume {:nonnull} deviceExtension_11 != 0;
    assume deviceExtension_11 > 0;
    call {:si_unique_call 1116} status_18 := QueueIrp(ReadIrpControl__DEVICE_EXTENSION(deviceExtension_11), Irp_40);
    goto anon14_Then, anon14_Else;
  ...
  L32:
    call {:si_unique_call 1117} RemoveReference(DeviceObject_38);
    Tmp_588 := status_18;
    goto L1;
  ...
  anon13_Then:
    call {:si_unique_call 1118} sdv_IoSkipCurrentIrpStackLocation(Irp_40);
    assume {:nonnull} deviceExtension_11 != 0;
    assume deviceExtension_11 > 0;
    havoc vslice_dummy_var_96;
    call {:si_unique_call 1119} status_18 := sdv_IoCallDriver#1(vslice_dummy_var_96, Irp_40);
    goto anon15_Then, anon15_Else;

  anon15_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 1120} RemoveReference(DeviceObject_38);
    goto L32;
  ...
  anon12_Then:
    assume {:partition} sdv_351 == 0;
    call {:si_unique_call 1121} RemoveReferenceAndCompleteRequest(DeviceObject_38, Irp_40, -1073741769);
...
implementation {:origName "MarkQueueToEmpty"} MarkQueueToEmpty(actual_Control_1: int)
{
  ...
  anon0:
    call {:si_unique_call 1122} vslice_dummy_var_159 := __HAVOC_malloc(4);
    Control_1 := actual_Control_1;
    call {:si_unique_call 1123} Tmp_591 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_591 != 0;
    assume Tmp_591 > 0;
    Mem_T.INT4[Tmp_591] := origIrql_12;
    call {:si_unique_call 1124} sdv_KeAcquireSpinLock(0, Tmp_591);
    goto anon9_Then, anon9_Else;
  ...
  L12:
    call {:si_unique_call 1125} sdv_KeReleaseSpinLock(0, origIrql_12);
    goto LM2;
  ...
  anon7_Then:
    call {:si_unique_call 1126} sdv_354 := sdv_IsListEmpty(0);
    goto anon8_Then, anon8_Else;
...
implementation {:origName "QueueIrp"} QueueIrp(actual_Control_2: int, actual_Irp_41: int) returns (Tmp_592: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 1127} Tmp_593 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_593 != 0;
    assume Tmp_593 > 0;
    Mem_T.INT4[Tmp_593] := origIrql_13;
    call {:si_unique_call 1128} sdv_KeAcquireSpinLock(0, Tmp_593);
    goto anon9_Then, anon9_Else;
  ...
  L12:
    call {:si_unique_call 1129} sdv_IoMarkIrpPending(0);
    ...
    assume {:nonnull} Irp_41 != 0;
    assume Irp_41 > 0;
    call {:si_unique_call 1130} vslice_dummy_var_160 := sdv_InsertTailList(ListHead__READ_WRITE_CONTROL(Control_2), ListEntry_unnamed_tag_6(Overlay_unnamed_tag_5(Tail__IRP(Irp_41))));
    call {:si_unique_call 1131} Tmp_593 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_593 != 0;
    assume Tmp_593 > 0;
    Mem_T.INT4[Tmp_593] := CancelIrql_8;
    call {:si_unique_call 1132} IoAcquireCancelSpinLock(Tmp_593);
    assume {:nonnull} Tmp_593 != 0;
    assume Tmp_593 > 0;
    CancelIrql_8 := Mem_T.INT4[Tmp_593];
    assume {:nonnull} Irp_41 != 0;
    assume Irp_41 > 0;
    call {:si_unique_call 1133} vslice_dummy_var_161 := sdv_IoSetCancelRoutine(Irp_41, li2bplFunctionConstant1126);
    call {:si_unique_call 1134} IoReleaseCancelSpinLock(CancelIrql_8);
    call {:si_unique_call 1135} sdv_KeReleaseSpinLock(0, origIrql_13);
    Tmp_592 := 259;
    goto L1;
  ...
  anon7_Then:
    call {:si_unique_call 1136} sdv_355 := sdv_IsListEmpty(0);
    goto anon8_Then, anon8_Else;
...
implementation {:origName "CleanUpQueuedIrps"} CleanUpQueuedIrps(actual_Control_5: int, actual_Status_14: int)
{
  ...
  anon0:
    call {:si_unique_call 1138} vslice_dummy_var_162 := __HAVOC_malloc(4);
    Control_5 := actual_Control_5;
    Status_14 := actual_Status_14;
    call {:si_unique_call 1139} Tmp_606 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_606 != 0;
    assume Tmp_606 > 0;
    Mem_T.INT4[Tmp_606] := origIrql_15;
    call {:si_unique_call 1140} sdv_KeAcquireSpinLock(0, Tmp_606);
    goto anon14_Then, anon14_Else;
  ...
  L9:
    call {:si_unique_call 1141} Irp_44, sdv_364, origIrql_15, sdv_366, ListElement_2, CancelIrql_9, Tmp_606, vslice_dummy_var_163 := CleanUpQueuedIrps_loop_L9(Irp_44, sdv_364, origIrql_15, sdv_366, ListElement_2, CancelIrql_9, Tmp_606, Control_5, Status_14, vslice_dummy_var_163);
    goto L9_last;

  L9_last:
    call {:si_unique_call 1154} sdv_364 := sdv_IsListEmpty(0);
    goto anon11_Then, anon11_Else;
  ...
  anon11_Else:
    ...
    assume Control_5 > 0;
    call {:si_unique_call 1142} ListElement_2 := RemoveTailList(ListHead__READ_WRITE_CONTROL(Control_5));
    call {:si_unique_call 1143} sdv_366 := sdv_containing_record(ListElement_2, 88);
    Irp_44 := sdv_366;
    call {:si_unique_call 1144} Tmp_606 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_606 != 0;
    assume Tmp_606 > 0;
    Mem_T.INT4[Tmp_606] := CancelIrql_9;
    call {:si_unique_call 1145} IoAcquireCancelSpinLock(Tmp_606);
    assume {:nonnull} Tmp_606 != 0;
    assume Tmp_606 > 0;
  ...
  anon12_Else:
    ...
    assume Irp_44 > 0;
    Irp_44 := 0;
    call {:si_unique_call 1146} IoReleaseCancelSpinLock(CancelIrql_9);
    goto L38;
  ...
  anon13_Else:
    ...
    call {:si_unique_call 1147} sdv_KeReleaseSpinLock(0, origIrql_15);
    assume {:nonnull} Irp_44 != 0;
    assume Irp_44 > 0;
    assume {:nonnull} Control_5 != 0;
    assume Control_5 > 0;
    havoc vslice_dummy_var_97;
    call {:si_unique_call 1148} RemoveReferenceAndCompleteRequest(vslice_dummy_var_97, Irp_44, Status_14);
    call {:si_unique_call 1149} Tmp_606 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_606 != 0;
    assume Tmp_606 > 0;
    Mem_T.INT4[Tmp_606] := origIrql_15;
    call {:si_unique_call 1150} sdv_KeAcquireSpinLock(0, Tmp_606);
    goto anon15_Then, anon15_Else;
  ...
  anon12_Then:
    call {:si_unique_call 1151} vslice_dummy_var_163 := sdv_IoSetCancelRoutine(Irp_44, 0);
    call {:si_unique_call 1152} IoReleaseCancelSpinLock(CancelIrql_9);
    goto L38;

  anon11_Then:
    assume {:partition} sdv_364 != 0;
    call {:si_unique_call 1153} sdv_KeReleaseSpinLock(0, origIrql_15);
    goto LM2;
...
implementation {:origName "UniPostProcessShuttledWaits"} UniPostProcessShuttledWaits(actual_Extension_6: int, actual_MaskStates: int, actual_MaskValue_1: int)
{
  ...
  anon0:
    call {:si_unique_call 1155} vslice_dummy_var_164 := __HAVOC_malloc(4);
  ...
  L7:
    call {:si_unique_call 1156} i_3, origIrql_16, irpToComplete, Tmp_613, Tmp_614 := UniPostProcessShuttledWaits_loop_L7(i_3, origIrql_16, irpToComplete, Tmp_613, Tmp_614, Extension_6, MaskStates, MaskValue_1);
    goto L7_last;
  ...
  anon7_Else:
    ...
    assume {:nonnull} MaskStates != 0;
    assume MaskStates > 0;
    call {:si_unique_call 1157} Tmp_614 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_614 != 0;
    assume Tmp_614 > 0;
    Mem_T.INT4[Tmp_614] := origIrql_16;
    call {:si_unique_call 1158} sdv_KeAcquireSpinLock(0, Tmp_614);
    goto anon8_Then, anon8_Else;
  ...
  anon8_Else:
    ...
    assume {:nonnull} MaskStates != 0;
    assume MaskStates > 0;
    call {:si_unique_call 1159} UniRundownShuttledWait(Extension_6, ShuttledWait__MASKSTATE(MaskStates), 1, irpToComplete, origIrql_16, 0, Tmp_613);
    goto L9;
...
implementation {:origName "UniStartOrQueue"} UniStartOrQueue(actual_Extension_7: int, actual_QueueLock: int, actual_Irp_48: int, actual_QueueToExamine: int, actual_CurrentOpIrp: int, actual_Starter: int) returns (Tmp_622: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 1160} Tmp_623 := __HAVOC_malloc(72);
    call {:si_unique_call 1161} Tmp_630 := __HAVOC_malloc(72);
    call {:si_unique_call 1162} vslice_dummy_var_166 := __HAVOC_malloc(72);
    call {:si_unique_call 1163} irpSp_26 := sdv_IoGetCurrentIrpStackLocation(Irp_48);
    call {:si_unique_call 1164} Tmp_627 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_627 != 0;
    assume Tmp_627 > 0;
    Mem_T.INT4[Tmp_627] := oldIrql_1;
    call {:si_unique_call 1165} sdv_KeAcquireSpinLock(0, Tmp_627);
    goto anon21_Then, anon21_Else;
  ...
  L13:
    call {:si_unique_call 1166} sdv_384 := sdv_IsListEmpty(0);
    goto anon18_Then, anon18_Else;
  ...
  anon19_Else:
    assume {:nonnull} CurrentOpIrp != 0;
    assume CurrentOpIrp > 0;
    call {:si_unique_call 1167} sdv_KeReleaseSpinLock(0, oldIrql_1);
    call {:si_unique_call 1168} sdv_IoMarkIrpPending(0);
    goto anon20_Then, anon20_Else;

  anon20_Else:
    assume {:IndirectCall} true;
    assume Starter == li2bplFunctionConstant932;
    call {:si_unique_call 1169} vslice_dummy_var_168 := UniMaskStarter(Extension_7);
    goto anon24_Then, anon24_Else;
  ...
  anon20_Then:
    ...
    call {:si_unique_call 1170} vslice_dummy_var_167 := UniPassThroughStarter#1(Extension_7);
    goto anon23_Then, anon23_Else;
  ...
  L21:
    call {:si_unique_call 1171} sdv_IoMarkIrpPending(0);
    assume {:nonnull} Irp_48 != 0;
    assume Irp_48 > 0;
    call {:si_unique_call 1172} vslice_dummy_var_165 := sdv_InsertTailList(QueueToExamine, ListEntry_unnamed_tag_6(Overlay_unnamed_tag_5(Tail__IRP(Irp_48))));
    call {:si_unique_call 1173} sdv_KeReleaseSpinLock(0, oldIrql_1);
    Tmp_622 := 259;
    goto L1;
...
implementation {:origName "UniGetNextIrp"} UniGetNextIrp(actual_DeviceObject_44: int, actual_QueueLock_1: int, actual_CurrentOpIrp_1: int, actual_QueueToProcess: int, actual_NextIrp: int, actual_CompleteCurrent: int)
{
  ...
  anon0:
    call {:si_unique_call 1174} vslice_dummy_var_169 := __HAVOC_malloc(4);
    ...
    call {:si_unique_call 1175} Tmp_632 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_632 != 0;
    assume Tmp_632 > 0;
    Mem_T.INT4[Tmp_632] := oldIrql_2;
    call {:si_unique_call 1176} sdv_KeAcquireSpinLock(0, Tmp_632);
    goto anon12_Then, anon12_Else;
  ...
  anon12_Else:
    ...
    havoc oldIrp;
    call {:si_unique_call 1177} sdv_386 := sdv_IsListEmpty(0);
    goto anon9_Then, anon9_Else;

  anon9_Else:
    assume {:partition} sdv_386 == 0;
    call {:si_unique_call 1178} headOfList := RemoveHeadList(QueueToProcess);
    call {:si_unique_call 1179} sdv_388 := sdv_containing_record(headOfList, 88);
    assume {:nonnull} CurrentOpIrp_1 != 0;
    assume CurrentOpIrp_1 > 0;
    goto L15;
  ...
  L15:
    ...
    assume NextIrp > 0;
    call {:si_unique_call 1180} sdv_KeReleaseSpinLock(0, oldIrql_2);
    goto anon10_Then, anon10_Else;
  ...
  anon11_Else:
    ...
    call {:si_unique_call 1181} RemoveReferenceAndCompleteRequest(DeviceObject_44, oldIrp, vslice_dummy_var_98);
    goto L1;
...
implementation {:origName "UniSniffOwnerSettings"} UniSniffOwnerSettings(actual_DeviceObject_45: int, actual_Irp_49: int) returns (Tmp_634: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 1182} irpSp_27 := sdv_IoGetCurrentIrpStackLocation(Irp_49);
  ...
  anon28_Else:
    call {:si_unique_call 1183} RemoveReferenceAndCompleteRequest(DeviceObject_45, Irp_49, -1073741789);
    Tmp_634 := -1073741789;
    goto L1;
  ...
  anon28_Then:
    ...
    call {:si_unique_call 1184} Tmp_634 := UniStartOrQueue(deviceExtension_14, DeviceLock__DEVICE_EXTENSION(deviceExtension_14), Irp_49, PassThroughQueue__DEVICE_EXTENSION(deviceExtension_14), CurrentPassThrough__DEVICE_EXTENSION(deviceExtension_14), li2bplFunctionConstant937);
    goto anon33_Then, anon33_Else;
  ...
  anon29_Then:
    ...
    assume {:nonnull} Irp_49 != 0;
    assume Irp_49 > 0;
    call {:si_unique_call 1186} RemoveReferenceAndCompleteRequest(DeviceObject_45, Irp_49, 0);
    Tmp_634 := 0;
    goto L1;

  anon27_Then:
    assume {:partition} controlCode != 2818052;
    call {:si_unique_call 1187} RemoveReferenceAndCompleteRequest(DeviceObject_45, Irp_49, -1073741811);
    Tmp_634 := -1073741811;
    goto L1;
  ...
  L44:
    assume {:nonnull} deviceExtension_14 != 0;
    assume deviceExtension_14 > 0;
    call {:si_unique_call 1188} Tmp_634 := UniStartOrQueue(deviceExtension_14, DeviceLock__DEVICE_EXTENSION(deviceExtension_14), Irp_49, MaskOps__DEVICE_EXTENSION(deviceExtension_14), CurrentMaskOp__DEVICE_EXTENSION(deviceExtension_14), li2bplFunctionConstant932);
    goto anon34_Then, anon34_Else;
  ...
  anon31_Else:
    call {:si_unique_call 1189} Tmp_634 := UniValidateNewCommConfig(deviceExtension_14, Irp_49, 1);
    goto anon35_Then, anon35_Else;
  ...
  anon31_Then:
    call {:si_unique_call 1190} sdv_IoSkipCurrentIrpStackLocation(Irp_49);
    assume {:nonnull} deviceExtension_14 != 0;
    assume deviceExtension_14 > 0;
    havoc vslice_dummy_var_100;
    call {:si_unique_call 1191} status_19 := sdv_IoCallDriver#1(vslice_dummy_var_100, Irp_49);
    goto anon36_Then, anon36_Else;

  anon36_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 1192} RemoveReference(DeviceObject_45);
    Tmp_634 := status_19;
    goto L1;
...
implementation {:origName "UniNoCheckPassThrough"} UniNoCheckPassThrough(actual_DeviceObject_46: int, actual_Irp_50: int) returns (Tmp_637: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 1193} sdv_IoSkipCurrentIrpStackLocation(Irp_50);
    assume {:nonnull} deviceExtension_15 != 0;
    assume deviceExtension_15 > 0;
    havoc vslice_dummy_var_101;
    call {:si_unique_call 1194} status_20 := sdv_IoCallDriver#1(vslice_dummy_var_101, Irp_50);
    goto anon3_Then, anon3_Else;

  anon3_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 1195} RemoveReference(DeviceObject_46);
    Tmp_637 := status_20;
    goto LM2;
...
implementation {:origName "UniPreProcessShuttledWaits"} UniPreProcessShuttledWaits(actual_ExtensionMaskStates: int, actual_MaskStates_1: int, actual_MaskValue_2: int)
{
  ...
  anon0:
    call {:si_unique_call 1196} vslice_dummy_var_170 := __HAVOC_malloc(4);
    ExtensionMaskStates := actual_ExtensionMaskStates;
    MaskStates_1 := actual_MaskStates_1;
    MaskValue_2 := actual_MaskValue_2;
    i_4 := 2;
    call {:si_unique_call 1197} sdv_RtlZeroMemory(0, 72);
    goto L8;

  L8:
    call {:si_unique_call 1198} i_4 := UniPreProcessShuttledWaits_loop_L8(i_4, ExtensionMaskStates, MaskStates_1, MaskValue_2);
    goto L8_last;
...
implementation {:origName "UniValidateNewCommConfig"} UniValidateNewCommConfig(actual_Extension_8: int, actual_Irp_52: int, actual_Owner: int) returns (Tmp_646: int)
{
  ...
  anon0:
    ...
    Owner := actual_Owner;
    call {:si_unique_call 1199} Tmp_648 := __HAVOC_malloc(4);
    call {:si_unique_call 1200} irpSp_29 := sdv_IoGetCurrentIrpStackLocation(Irp_52);
  ...
  anon25_Else:
    ...
    call {:si_unique_call 1201} RemoveReferenceAndCompleteRequest(vslice_dummy_var_102, Irp_52, -1073741789);
    Tmp_646 := -1073741789;
    goto L1;
  ...
  anon25_Then:
    call {:si_unique_call 1202} Tmp_647 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_647 != 0;
    assume Tmp_647 > 0;
    Mem_T.INT4[Tmp_647] := origIrql_19;
    call {:si_unique_call 1203} sdv_KeAcquireSpinLock(0, Tmp_647);
    goto anon26_Then, anon26_Else;
  ...
  L34:
    call {:si_unique_call 1204} sdv_KeReleaseSpinLock(0, origIrql_19);
    assume {:nonnull} Irp_52 != 0;
    assume Irp_52 > 0;
    assume {:nonnull} Extension_8 != 0;
    assume Extension_8 > 0;
    havoc vslice_dummy_var_103;
    call {:si_unique_call 1205} RemoveReferenceAndCompleteRequest(vslice_dummy_var_103, Irp_52, 0);
    Tmp_646 := 0;
    goto L1;
...
implementation {:origName "UniCheckPassThrough"} UniCheckPassThrough(actual_DeviceObject_51: int, actual_Irp_56: int) returns (Tmp_673: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 1206} irpSp_33 := sdv_IoGetCurrentIrpStackLocation(Irp_56);
  ...
  L15:
    assume {:nonnull} deviceExtension_16 != 0;
    assume deviceExtension_16 > 0;
    call {:si_unique_call 1207} Tmp_673 := UniStartOrQueue(deviceExtension_16, DeviceLock__DEVICE_EXTENSION(deviceExtension_16), Irp_56, MaskOps__DEVICE_EXTENSION(deviceExtension_16), CurrentMaskOp__DEVICE_EXTENSION(deviceExtension_16), li2bplFunctionConstant932);
    goto anon19_Then, anon19_Else;
  ...
  anon18_Else:
    call {:si_unique_call 1208} Tmp_673 := UniValidateNewCommConfig(deviceExtension_16, Irp_56, 0);
    goto anon20_Then, anon20_Else;
  ...
  anon18_Then:
    call {:si_unique_call 1209} sdv_IoSkipCurrentIrpStackLocation(Irp_56);
    assume {:nonnull} deviceExtension_16 != 0;
    assume deviceExtension_16 > 0;
    havoc vslice_dummy_var_104;
    call {:si_unique_call 1210} status_21 := sdv_IoCallDriver#1(vslice_dummy_var_104, Irp_56);
    goto anon21_Then, anon21_Else;

  anon21_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 1211} RemoveReference(DeviceObject_51);
    Tmp_673 := status_21;
    goto L1;
  ...
  anon15_Then:
    ...
    assume Irp_56 > 0;
    call {:si_unique_call 1212} RemoveReferenceAndCompleteRequest(DeviceObject_51, Irp_56, -1073741769);
    Tmp_673 := -1073741769;
    goto L1;
}
...
implementation {:origName "_sdv_init4"} _sdv_init4()
{
  ...
  anon0:
    call {:si_unique_call 1213} vslice_dummy_var_171 := __HAVOC_malloc(4);
    havoc Mem_T.INT4;
    havoc Mem_T.INT4;
    havoc Mem_T.INT4;
    havoc Mem_T.INT4;
...
implementation {:origName "_sdv_init1"} _sdv_init1()
{
  ...
  anon0:
    call {:si_unique_call 1214} vslice_dummy_var_172 := __HAVOC_malloc(4);
    havoc Mem_T.INT4;
    havoc Mem_T.INT4;
    havoc Mem_T.INT4;
    havoc Mem_T.INT4;
...
implementation {:origName "InsertHeadList"} InsertHeadList(actual_ListHead_1: int, actual_Entry: int)
{
  ...
  anon0:
    call {:si_unique_call 1215} vslice_dummy_var_173 := __HAVOC_malloc(4);
  ...
  anon3_Else:
    ...
    call {:si_unique_call 1216} FatalListEntryError(ListHead_1, NextEntry, vslice_dummy_var_105);
    goto L8;
...
implementation {:origName "RemoveHeadList"} RemoveHeadList(actual_ListHead_2: int) returns (Tmp_701: int)
{
  ...
  L9:
    call {:si_unique_call 1217} FatalListEntryError(ListHead_2, Entry_1, NextEntry_1);
    goto L12;
...
implementation {:origName "SetPassdownToComplete"} SetPassdownToComplete(actual_MaskState_1: int)
{
  ...
  anon0:
    call {:si_unique_call 1218} vslice_dummy_var_174 := __HAVOC_malloc(4);
...
implementation {:origName "MakeIrpCurrentPassedDown"} MakeIrpCurrentPassedDown(actual_MaskState_2: int, actual_Irp_58: int)
{
  ...
  anon0:
    call {:si_unique_call 1219} vslice_dummy_var_175 := __HAVOC_malloc(4);
    MaskState_2 := actual_MaskState_2;
    Irp_58 := actual_Irp_58;
    call {:si_unique_call 1220} s_p_e_c_i_a_l_42 := sdv_IoGetCurrentIrpStackLocation(Irp_58);
...
implementation {:origName "RemoveTailList"} RemoveTailList(actual_ListHead_3: int) returns (Tmp_707: int)
{
  ...
  L9:
    call {:si_unique_call 1221} FatalListEntryError(PrevEntry, Entry_2, ListHead_3);
    goto L12;
...
implementation {:origName "FatalListEntryError"} FatalListEntryError(actual_p1: int, actual_p2: int, actual_p3: int)
{
  ...
  anon0:
    call {:si_unique_call 1222} vslice_dummy_var_176 := __HAVOC_malloc(4);
    call {:si_unique_call 1223} RtlFailFast(3);
    return;
}
...
implementation {:origName "ModemWmi"} ModemWmi(actual_DeviceObject_53: int, actual_Irp_59: int) returns (Tmp_711: int)
{
  ...
  anon0:
    call {:si_unique_call 1224} DeviceCaps := __HAVOC_malloc(124);
    call {:si_unique_call 1225} IrpDisposition_1 := __HAVOC_malloc(4);
    ...
    call {:si_unique_call 1226} irpSp_34 := sdv_IoGetCurrentIrpStackLocation(Irp_59);
  ...
  L15:
    call {:si_unique_call 1227} Tmp_711 := ModemPdoWmi(DeviceObject_53, Irp_59);
    goto L1;
  ...
  anon34_Else:
    call {:si_unique_call 1228} status_22 := CheckStateAndAddReferenceWMI(DeviceObject_53, Irp_59);
    goto anon35_Then, anon35_Else;
  ...
  anon36_Else:
    ...
    call {:si_unique_call 1229} vslice_dummy_var_177 := QueryDeviceCaps(vslice_dummy_var_106, DeviceCaps);
    goto anon48_Then, anon48_Else;
  ...
  anon44_Else:
    ...
    call {:si_unique_call 1230} status_22 := WmiSystemControl(0, 0, Irp_59, IrpDisposition_1);
  ...
  L57:
    call {:si_unique_call 1231} RemoveReference(DeviceObject_53);
    Tmp_711 := status_22;
    goto L1;
  ...
  anon41_Then:
    ...
    call {:si_unique_call 1232} status_22 := ForwardIrp(vslice_dummy_var_107, Irp_59);
    goto anon46_Then, anon46_Else;
  ...
  anon42_Then:
    ...
    call {:si_unique_call 1234} status_22 := ForwardIrp(vslice_dummy_var_108, Irp_59);
    goto anon45_Then, anon45_Else;
  ...
  anon43_Then:
    ...
    call {:si_unique_call 1236} RemoveReferenceAndCompleteRequest(DeviceObject_53, Irp_59, vslice_dummy_var_109);
    goto L57;
  ...
  anon39_Else:
    call {:si_unique_call 1238} RemoveReference(DeviceObject_53);
    assume {:nonnull} Irp_59 != 0;
    assume Irp_59 > 0;
    havoc status_22;
    assume {:nonnull} Irp_59 != 0;
    ...
    call {:si_unique_call 1239} RemoveReferenceAndCompleteRequest(DeviceObject_53, Irp_59, vslice_dummy_var_110);
    Tmp_711 := status_22;
    goto L1;
  ...
  anon39_Then:
    ...
    call {:si_unique_call 1240} status_22 := ForwardIrp(vslice_dummy_var_111, Irp_59);
    goto anon47_Then, anon47_Else;

  anon47_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 1241} RemoveReference(DeviceObject_53);
...
implementation {:origName "UNI_SHOULD_PASSDOWN_COMPLETE"} UNI_SHOULD_PASSDOWN_COMPLETE(actual_Irp_60: int) returns (Tmp_714: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 1243} s_p_e_c_i_a_l_44 := sdv_IoGetCurrentIrpStackLocation(Irp_60);
...
implementation {:origName "RtlFailFast"} RtlFailFast(actual_Code: int)
{
  ...
  anon0:
    call {:si_unique_call 1244} vslice_dummy_var_178 := __HAVOC_malloc(4);
    return;
}
...
const {:string "ConfigDelay"} unique strConst__li2bpl41: int;

const {:string "Default"} unique strConst__li2bpl38: int;

const {:string "DuplexSupport"} unique strConst__li2bpl11: int;

const {:string "Enumerated"} unique strConst__li2bpl8: int;

const {:string "InactivityScale"} unique strConst__li2bpl39: int;

const {:string "KeCancelTimer should only be called at IRQL <= DISPATCH_LEVEL."} unique strConst__li2bpl27: int;

const {:string "KeClearEvent should only be called at IRQL <= DISPATCH_LEVEL."} unique strConst__li2bpl21: int;

const {:string "KeInitializeDeviceQueue should only be called at IRQL <= DISPATCH_LEVEL."} unique strConst__li2bpl30: int;

const {:string "KeInitializeSemaphore should only be called at IRQL <= DISPATCH_LEVEL."} unique strConst__li2bpl22: int;

const {:string "KeInitializeTimer should only be called at IRQL <= DISPATCH_LEVEL."} unique strConst__li2bpl26: int;

const {:string "KeInitializeTimerEx should only be called at IRQL <= DISPATCH_LEVEL."} unique strConst__li2bpl17: int;

const {:string "KePulseEvent should only be called at IRQL <= DISPATCH_LEVEL."} unique strConst__li2bpl24: int;

const {:string "KeRaiseIrqlToDpcLevel should only be called at IRQL <= DISPATCH_LEVEL."} unique strConst__li2bpl34: int;

const {:string "KeReadStateEvent should only be called at IRQL <= DISPATCH_LEVEL."} unique strConst__li2bpl23: int;

const {:string "KeReadStateTimer should only be called at IRQL <= DISPATCH_LEVEL."} unique strConst__li2bpl25: int;

const {:string "KeReleaseMutex should only be called at IRQL <= DISPATCH_LEVEL."} unique strConst__li2bpl20: int;

const {:string "KeRemoveEntryDeviceQueue should only be called at IRQL <= DISPATCH_LEVEL."} unique strConst__li2bpl33: int;

const {:string "KeResetEvent should only be called at IRQL <= DISPATCH_LEVEL."} unique strConst__li2bpl32: int;

const {:string "KeSaveFloatingPointState should only be called at IRQL <= DISPATCH_LEVEL."} unique strConst__li2bpl18: int;

const {:string "KeSetTimer should only be called at IRQL <= DISPATCH_LEVEL."} unique strConst__li2bpl29: int;

const {:string "KeSetTimerEx should only be called at IRQL <= DISPATCH_LEVEL."} unique strConst__li2bpl28: int;

const {:string "KfAcquireSpinLock should only be called at IRQL <= DISPATCH_LEVEL."} unique strConst__li2bpl19: int;
...
const {:string "PowerDelay"} unique strConst__li2bpl40: int;

const {:string "Properties"} unique strConst__li2bpl37: int;
...
const {:string "\\Client"} unique strConst__li2bpl36: int;

const {:string "\\DosDevices\\"} unique strConst__li2bpl5: int;

const {:string "\\Tsp"} unique strConst__li2bpl35: int;

const {:string "\\Wave"} unique strConst__li2bpl16: int;

const {:string "callee"} unique strConst__li2bpl4: int;

const {:string "sdv_KeAcquireSpinLock should only be called at IRQL <= DISPATCH_LEVEL."} unique strConst__li2bpl31: int;
...
implementation {:origName "WaveStopDpcHandler"} WaveStopDpcHandler#0(actual_Dpc: int, actual_Context_1: int, actual_SysArg1: int, actual_SysArg2: int)
{
  ...
  anon0:
    call {:si_unique_call 1245} vslice_dummy_var_179 := __HAVOC_malloc(4);
    SysArg1 := actual_SysArg1;
    SysArg2 := actual_SysArg2;
    call {:si_unique_call 1246} Tmp_102 := __HAVOC_malloc(160);
    DeviceExtension_3 := SysArg2;
    Irp_7 := SysArg1;
    call {:si_unique_call 1247} nextSp_1 := sdv_IoGetNextIrpStackLocation(Irp_7);
  ...
  L44:
    call {:si_unique_call 1248} HandleDleIrp(DeviceExtension_3);
    goto anon30_Then, anon30_Else;
  ...
  anon31_Else:
    call {:si_unique_call 1249} sdv_KeAcquireSpinLockAtDpcLevel(0);
    assume {:nonnull} DeviceExtension_3 != 0;
    assume DeviceExtension_3 > 0;
    goto anon25_Then, anon25_Else;
  ...
  anon27_Else:
    ...
    call {:si_unique_call 1250} sdv_KeReleaseSpinLockFromDpcLevel(0);
    assume {:nonnull} Irp_7 != 0;
    assume Irp_7 > 0;
    assume {:nonnull} DeviceExtension_3 != 0;
    assume DeviceExtension_3 > 0;
    havoc vslice_dummy_var_112;
    call {:si_unique_call 1251} RemoveReferenceAndCompleteRequest(vslice_dummy_var_112, Irp_7, 0);
    goto L44;
  ...
  L33:
    ...
    assume {:nonnull} nextSp_1 != 0;
    assume nextSp_1 > 0;
    call {:si_unique_call 1253} sdv_IoSetCompletionRoutine(Irp_7, li2bplFunctionConstant1652, DeviceExtension_3, 1, 1, 1);
    assume {:nonnull} DeviceExtension_3 != 0;
    assume DeviceExtension_3 > 0;
    assume false;
    return;
  ...
  anon31_Then:
    ...
    call {:si_unique_call 1254} RemoveReferenceAndCompleteRequest(vslice_dummy_var_113, Irp_7, -1073741823);
    goto L44;
  ...
  anon23_Then:
    ...
    call {:si_unique_call 1256} RemoveReferenceAndCompleteRequest(vslice_dummy_var_114, Irp_7, vslice_dummy_var_115);
    goto L44;
}
...
implementation {:origName "WaveStopDpcHandler"} WaveStopDpcHandler#1(actual_Dpc: int, actual_Context_1: int, actual_SysArg1: int, actual_SysArg2: int)
{
  ...
  anon0:
    call {:si_unique_call 1257} vslice_dummy_var_180 := __HAVOC_malloc(4);
    SysArg1 := actual_SysArg1;
    SysArg2 := actual_SysArg2;
    call {:si_unique_call 1258} Tmp_102 := __HAVOC_malloc(160);
    DeviceExtension_3 := SysArg2;
    Irp_7 := SysArg1;
    call {:si_unique_call 1259} nextSp_1 := sdv_IoGetNextIrpStackLocation(Irp_7);
    assume {:nonnull} Irp_7 != 0;
    assume Irp_7 > 0;
    goto anon23_Then, anon23_Else;
  ...
  L44:
    call {:si_unique_call 1260} HandleDleIrp(DeviceExtension_3);
    goto anon30_Then, anon30_Else;
  ...
  anon31_Else:
    call {:si_unique_call 1261} sdv_KeAcquireSpinLockAtDpcLevel(0);
    assume {:nonnull} DeviceExtension_3 != 0;
    assume DeviceExtension_3 > 0;
    goto anon25_Then, anon25_Else;
  ...
  anon27_Else:
    assume {:partition} Mem_T.INT4[Buffer] == 3;
    call {:si_unique_call 1262} sdv_KeReleaseSpinLockFromDpcLevel(0);
    assume {:nonnull} Irp_7 != 0;
    assume Irp_7 > 0;
    assume {:nonnull} DeviceExtension_3 != 0;
    assume DeviceExtension_3 > 0;
    havoc vslice_dummy_var_116;
    call {:si_unique_call 1263} RemoveReferenceAndCompleteRequest(vslice_dummy_var_116, Irp_7, 0);
    goto L44;
  ...
  L33:
    ...
    assume {:nonnull} nextSp_1 != 0;
    assume nextSp_1 > 0;
    call {:si_unique_call 1265} sdv_IoSetCompletionRoutine(Irp_7, li2bplFunctionConstant1652, DeviceExtension_3, 1, 1, 1);
    assume {:nonnull} DeviceExtension_3 != 0;
    assume DeviceExtension_3 > 0;
    havoc vslice_dummy_var_117;
    call {:si_unique_call 1266} vslice_dummy_var_181 := sdv_IoCallDriver#0(vslice_dummy_var_117, Irp_7);
    goto anon33_Then, anon33_Else;
  ...
  anon31_Then:
    ...
    call {:si_unique_call 1267} RemoveReferenceAndCompleteRequest(vslice_dummy_var_118, Irp_7, -1073741823);
    goto L44;
  ...
  anon24_Then:
    ...
    assume {:nonnull} nextSp_1 != 0;
    assume nextSp_1 > 0;
    call {:si_unique_call 1268} sdv_IoSetCompletionRoutine(Irp_7, li2bplFunctionConstant1652, DeviceExtension_3, 1, 1, 1);
    assume {:nonnull} DeviceExtension_3 != 0;
    assume DeviceExtension_3 > 0;
    havoc vslice_dummy_var_119;
    call {:si_unique_call 1269} vslice_dummy_var_182 := sdv_IoCallDriver#0(vslice_dummy_var_119, Irp_7);
    goto anon29_Then, anon29_Else;
  ...
  anon23_Then:
    ...
    call {:si_unique_call 1270} RemoveReferenceAndCompleteRequest(vslice_dummy_var_120, Irp_7, vslice_dummy_var_121);
    goto L44;
}
...
implementation {:origName "sdv_IoCallDriver"} {:osmodel} sdv_IoCallDriver#0(actual_DeviceObject_14: int, actual_Irp_18: int) returns (Tmp_334: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 1271} Tmp_334 := IofCallDriver#0(0, Irp_18);
    goto anon3_Then, anon3_Else;
...
implementation {:origName "sdv_IoCallDriver"} {:osmodel} sdv_IoCallDriver#1(actual_DeviceObject_14: int, actual_Irp_18: int) returns (Tmp_334: int)
{
  ...
  anon0:
    Irp_18 := actual_Irp_18;
    call {:si_unique_call 1272} Tmp_334 := IofCallDriver#1(0, Irp_18);
    goto anon3_Then, anon3_Else;
...
implementation {:origName "IofCallDriver"} {:osmodel} IofCallDriver#0(actual_DeviceObject_12: int, actual_Irp_16: int) returns (Tmp_324: int)
{
  ...
  anon0:
    call {:si_unique_call 1273} completion_1 := __HAVOC_malloc(4);
  ...
  anon55_Then:
    ...
    call {:si_unique_call 1274} vslice_dummy_var_183 := sdv_RunIoCompletionRoutines#0(sdv_p_devobj_fdo, Irp_16, vslice_dummy_var_122, completion_1);
    goto anon76_Then, anon76_Else;
  ...
  anon67_Else:
    ...
    call {:si_unique_call 1275} vslice_dummy_var_186 := sdv_RunIoCompletionRoutines#0(sdv_p_devobj_fdo, Irp_16, vslice_dummy_var_123, completion_1);
    goto anon78_Then, anon78_Else;
  ...
  anon59_Else:
    ...
    call {:si_unique_call 1276} vslice_dummy_var_184 := sdv_RunIoCompletionRoutines#0(sdv_p_devobj_fdo, Irp_16, vslice_dummy_var_124, completion_1);
    goto anon74_Then, anon74_Else;
  ...
  anon63_Else:
    ...
    call {:si_unique_call 1277} vslice_dummy_var_185 := sdv_RunIoCompletionRoutines#0(sdv_p_devobj_fdo, Irp_16, vslice_dummy_var_125, completion_1);
    goto anon72_Then, anon72_Else;
...
implementation {:origName "IofCallDriver"} {:osmodel} IofCallDriver#1(actual_DeviceObject_12: int, actual_Irp_16: int) returns (Tmp_324: int)
{
  ...
  anon0:
    call {:si_unique_call 1278} completion_1 := __HAVOC_malloc(4);
    Irp_16 := actual_Irp_16;
    assume {:nonnull} completion_1 != 0;
    assume completion_1 > 0;
    Mem_T.INT4[completion_1] := 0;
  ...
  anon55_Then:
    ...
    call {:si_unique_call 1279} vslice_dummy_var_187 := sdv_RunIoCompletionRoutines#1(sdv_p_devobj_fdo, Irp_16, vslice_dummy_var_126, completion_1);
    goto anon76_Then, anon76_Else;
  ...
  anon67_Else:
    ...
    call {:si_unique_call 1280} vslice_dummy_var_190 := sdv_RunIoCompletionRoutines#1(sdv_p_devobj_fdo, Irp_16, vslice_dummy_var_127, completion_1);
    goto anon78_Then, anon78_Else;
  ...
  anon59_Else:
    ...
    call {:si_unique_call 1281} vslice_dummy_var_188 := sdv_RunIoCompletionRoutines#1(sdv_p_devobj_fdo, Irp_16, vslice_dummy_var_128, completion_1);
    goto anon74_Then, anon74_Else;
  ...
  anon63_Else:
    ...
    call {:si_unique_call 1282} vslice_dummy_var_189 := sdv_RunIoCompletionRoutines#1(sdv_p_devobj_fdo, Irp_16, vslice_dummy_var_129, completion_1);
    goto anon72_Then, anon72_Else;
...
implementation {:origName "sdv_RunIoCompletionRoutines"} {:osmodel} sdv_RunIoCompletionRoutines#0(actual_DeviceObject_13: int, actual_Irp_17: int, actual_Context_8: int, actual_Completion: int) returns (Tmp_330: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 1283} irpsp := sdv_IoGetNextIrpStackLocation(Irp_17);
    Status := 0;
    assume {:nonnull} irpsp != 0;
    assume irpsp > 0;
    goto anon58_Then, anon58_Else;
  ...
  anon58_Else:
    ...
    sdv_irql_previous := sdv_irql_current;
    sdv_irql_current := 2;
    call {:si_unique_call 1284} Status := IoCompletionSetEvent(DeviceObject_13, Irp_17, Context_8);
    sdv_irql_current := sdv_irql_previous;
    sdv_irql_previous := sdv_irql_previous_2;
    sdv_irql_previous_2 := sdv_irql_previous_3;
    sdv_irql_previous_3 := sdv_irql_previous_4;
  ...
  anon47_Else:
    ...
    sdv_irql_previous := sdv_irql_current;
    sdv_irql_current := 2;
    call {:si_unique_call 1285} Status := PowerIrpCompletion(DeviceObject_13, Irp_17, Context_8);
    goto anon59_Then, anon59_Else;
  ...
  anon48_Else:
    ...
    sdv_irql_previous := sdv_irql_current;
    sdv_irql_current := 2;
    call {:si_unique_call 1286} Status := UniGeneralMaskComplete(DeviceObject_13, Irp_17, Context_8);
    goto anon60_Then, anon60_Else;
  ...
  anon49_Else:
    ...
    sdv_irql_previous := sdv_irql_current;
    sdv_irql_current := 2;
    call {:si_unique_call 1287} Status := UniGeneralWaitComplete#0(DeviceObject_13, Irp_17, Context_8);
    goto anon61_Then, anon61_Else;
  ...
  anon50_Else:
    ...
    sdv_irql_previous := sdv_irql_current;
    sdv_irql_current := 2;
    call {:si_unique_call 1288} Status := UniReadComplete#0(DeviceObject_13, Irp_17, Context_8);
    goto anon62_Then, anon62_Else;
  ...
  anon51_Else:
    ...
    sdv_irql_previous := sdv_irql_current;
    sdv_irql_current := 2;
    call {:si_unique_call 1289} Status := UniSetupNoPassPart2#0(DeviceObject_13, Irp_17, Context_8);
    goto anon63_Then, anon63_Else;
  ...
  anon52_Else:
    ...
    sdv_irql_previous := sdv_irql_current;
    sdv_irql_current := 2;
    call {:si_unique_call 1290} Status := UniSetupNoPassPart3#0(DeviceObject_13, Irp_17, Context_8);
    goto anon64_Then, anon64_Else;
  ...
  anon53_Else:
    ...
    sdv_irql_previous := sdv_irql_current;
    sdv_irql_current := 2;
    call {:si_unique_call 1291} Status := UniSetupSniffPart1#0(DeviceObject_13, Irp_17, Context_8);
    goto anon65_Then, anon65_Else;
  ...
  anon54_Else:
    ...
    sdv_irql_previous := sdv_irql_current;
    sdv_irql_current := 2;
    call {:si_unique_call 1292} Status := UniSetupSniffPart2#0(DeviceObject_13, Irp_17, Context_8);
    goto anon66_Then, anon66_Else;
  ...
  anon55_Else:
    ...
    sdv_irql_previous := sdv_irql_current;
    sdv_irql_current := 2;
    call {:si_unique_call 1293} Status := UniSniffWaitComplete#0(DeviceObject_13, Irp_17, Context_8);
    goto anon67_Then, anon67_Else;
  ...
  anon56_Else:
    ...
    sdv_irql_previous := sdv_irql_current;
    sdv_irql_current := 2;
    call {:si_unique_call 1294} Status := UniStopReceiveComplete#0(DeviceObject_13, Irp_17, Context_8);
    goto anon68_Then, anon68_Else;
  ...
  anon57_Else:
    ...
    sdv_irql_previous := sdv_irql_current;
    sdv_irql_current := 2;
    call {:si_unique_call 1295} Status := UniWriteComplete#0(DeviceObject_13, Irp_17, Context_8);
    goto anon69_Then, anon69_Else;
...
implementation {:origName "sdv_RunIoCompletionRoutines"} {:osmodel} sdv_RunIoCompletionRoutines#1(actual_DeviceObject_13: int, actual_Irp_17: int, actual_Context_8: int, actual_Completion: int) returns (Tmp_330: int)
{
  ...
  anon0:
    ...
    Context_8 := actual_Context_8;
    Completion := actual_Completion;
    call {:si_unique_call 1296} irpsp := sdv_IoGetNextIrpStackLocation(Irp_17);
    Status := 0;
    assume {:nonnull} irpsp != 0;
    assume irpsp > 0;
    goto anon58_Then, anon58_Else;
  ...
  anon58_Else:
    ...
    sdv_irql_previous := sdv_irql_current;
    sdv_irql_current := 2;
    call {:si_unique_call 1297} Status := IoCompletionSetEvent(DeviceObject_13, Irp_17, Context_8);
    sdv_irql_current := sdv_irql_previous;
    sdv_irql_previous := sdv_irql_previous_2;
    sdv_irql_previous_2 := sdv_irql_previous_3;
    sdv_irql_previous_3 := sdv_irql_previous_4;
  ...
  anon47_Else:
    ...
    sdv_irql_previous := sdv_irql_current;
    sdv_irql_current := 2;
    call {:si_unique_call 1298} Status := PowerIrpCompletion(DeviceObject_13, Irp_17, Context_8);
    goto anon59_Then, anon59_Else;
  ...
  anon48_Else:
    ...
    sdv_irql_previous := sdv_irql_current;
    sdv_irql_current := 2;
    call {:si_unique_call 1299} Status := UniGeneralMaskComplete(DeviceObject_13, Irp_17, Context_8);
    goto anon60_Then, anon60_Else;
  ...
  anon49_Else:
    ...
    sdv_irql_previous := sdv_irql_current;
    sdv_irql_current := 2;
    call {:si_unique_call 1300} Status := UniGeneralWaitComplete#1(DeviceObject_13, Irp_17, Context_8);
    goto anon61_Then, anon61_Else;
  ...
  anon50_Else:
    ...
    sdv_irql_previous := sdv_irql_current;
    sdv_irql_current := 2;
    call {:si_unique_call 1301} Status := UniReadComplete#1(DeviceObject_13, Irp_17, Context_8);
    goto anon62_Then, anon62_Else;
  ...
  anon51_Else:
    ...
    sdv_irql_previous := sdv_irql_current;
    sdv_irql_current := 2;
    call {:si_unique_call 1302} Status := UniSetupNoPassPart2#1(DeviceObject_13, Irp_17, Context_8);
    goto anon63_Then, anon63_Else;
  ...
  anon52_Else:
    ...
    sdv_irql_previous := sdv_irql_current;
    sdv_irql_current := 2;
    call {:si_unique_call 1303} Status := UniSetupNoPassPart3#1(DeviceObject_13, Irp_17, Context_8);
    goto anon64_Then, anon64_Else;
  ...
  anon53_Else:
    ...
    sdv_irql_previous := sdv_irql_current;
    sdv_irql_current := 2;
    call {:si_unique_call 1304} Status := UniSetupSniffPart1#1(DeviceObject_13, Irp_17, Context_8);
    goto anon65_Then, anon65_Else;
  ...
  anon54_Else:
    ...
    sdv_irql_previous := sdv_irql_current;
    sdv_irql_current := 2;
    call {:si_unique_call 1305} Status := UniSetupSniffPart2#1(DeviceObject_13, Irp_17, Context_8);
    goto anon66_Then, anon66_Else;
  ...
  anon55_Else:
    ...
    sdv_irql_previous := sdv_irql_current;
    sdv_irql_current := 2;
    call {:si_unique_call 1306} Status := UniSniffWaitComplete#1(DeviceObject_13, Irp_17, Context_8);
    goto anon67_Then, anon67_Else;
  ...
  anon56_Else:
    ...
    sdv_irql_previous := sdv_irql_current;
    sdv_irql_current := 2;
    call {:si_unique_call 1307} Status := UniStopReceiveComplete#1(DeviceObject_13, Irp_17, Context_8);
    goto anon68_Then, anon68_Else;
  ...
  anon57_Else:
    ...
    sdv_irql_previous := sdv_irql_current;
    sdv_irql_current := 2;
    call {:si_unique_call 1308} Status := UniWriteComplete#1(DeviceObject_13, Irp_17, Context_8);
    goto anon69_Then, anon69_Else;
...
implementation {:origName "UniGeneralWaitComplete"} UniGeneralWaitComplete#0(actual_DeviceObject_4: int, actual_Irp_9: int, actual_Context_3: int) returns (Tmp_113: int)
{
  ...
  anon0:
    call {:si_unique_call 1309} junk := __HAVOC_malloc(4);
    ...
    assume otherState > 0;
    call {:si_unique_call 1310} Tmp_121 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_121 != 0;
    assume Tmp_121 > 0;
    Mem_T.INT4[Tmp_121] := origIrql_5;
    call {:si_unique_call 1311} sdv_KeAcquireSpinLock(0, Tmp_121);
    goto anon47_Then, anon47_Else;
  ...
  anon47_Else:
    ...
    call {:si_unique_call 1312} sdv_57 := UNI_SHOULD_PASSDOWN_COMPLETE(Irp_9);
    goto anon37_Then, anon37_Else;
  ...
  anon37_Else:
    ...
    assume {:nonnull} otherState != 0;
    assume otherState > 0;
    call {:si_unique_call 1313} sdv_KeReleaseSpinLock(0, origIrql_5);
    assume {:nonnull} Irp_9 != 0;
    assume Irp_9 > 0;
    assume {:nonnull} Irp_9 != 0;
    assume Irp_9 > 0;
    ...
    call {:si_unique_call 1314} RemoveReference(DeviceObject_4);
    Tmp_113 := 0;
    goto L1;
  ...
  L31:
    ...
    assume {:nonnull} Irp_9 != 0;
    assume Irp_9 > 0;
    call {:si_unique_call 1315} vslice_dummy_var_191 := UniMakeIrpShuttledWait(thisState, Irp_9, origIrql_5, 0, junk);
    goto anon49_Then, anon49_Else;
  ...
  anon45_Else:
    ...
    call {:si_unique_call 1316} UniRundownShuttledWait(vslice_dummy_var_130, ShuttledWait__MASKSTATE(otherState), 1, savedIrp, origIrql_5, 0, Tmp_119);
    assume {:nonnull} thisState != 0;
    assume thisState > 0;
    call {:si_unique_call 1317} Tmp_121 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_121 != 0;
    assume Tmp_121 > 0;
    Mem_T.INT4[Tmp_121] := origIrql_5;
    call {:si_unique_call 1318} sdv_KeAcquireSpinLock(0, Tmp_121);
    goto anon50_Then, anon50_Else;
  ...
  L61:
    call {:si_unique_call 1320} RemoveReference(DeviceObject_4);
    Tmp_113 := 0;
    goto L1;
  ...
  anon46_Then:
    call {:si_unique_call 1322} MakeIrpCurrentPassedDown(thisState, Irp_9);
    assume {:nonnull} thisState != 0;
    assume thisState > 0;
    call {:si_unique_call 1323} sdv_KeReleaseSpinLock(0, origIrql_5);
    call {:si_unique_call 1324} sdv_IoCopyCurrentIrpStackLocationToNext(Irp_9);
    call {:si_unique_call 1325} sdv_IoSetCompletionRoutine(Irp_9, li2bplFunctionConstant1478, thisState, 1, 1, 1);
    assume {:nonnull} thisState != 0;
    assume thisState > 0;
    havoc Tmp_117;
...
implementation {:origName "UniGeneralWaitComplete"} UniGeneralWaitComplete#1(actual_DeviceObject_4: int, actual_Irp_9: int, actual_Context_3: int) returns (Tmp_113: int)
{
  ...
  anon0:
    ...
    assume {:nonnull} otherState != 0;
    assume otherState > 0;
    call {:si_unique_call 1331} Tmp_121 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_121 != 0;
    assume Tmp_121 > 0;
    Mem_T.INT4[Tmp_121] := origIrql_5;
    call {:si_unique_call 1332} sdv_KeAcquireSpinLock(0, Tmp_121);
    goto anon47_Then, anon47_Else;
  ...
  anon47_Else:
    ...
    assume Tmp_121 > 0;
    origIrql_5 := Mem_T.INT4[Tmp_121];
    call {:si_unique_call 1333} sdv_57 := UNI_SHOULD_PASSDOWN_COMPLETE(Irp_9);
    goto anon37_Then, anon37_Else;
  ...
  L31:
    ...
    assume {:nonnull} Irp_9 != 0;
    assume Irp_9 > 0;
    call {:si_unique_call 1336} vslice_dummy_var_192 := UniMakeIrpShuttledWait(thisState, Irp_9, origIrql_5, 0, junk);
    goto anon49_Then, anon49_Else;
  ...
  anon45_Else:
    ...
    call {:si_unique_call 1337} UniRundownShuttledWait(vslice_dummy_var_131, ShuttledWait__MASKSTATE(otherState), 1, savedIrp, origIrql_5, 0, Tmp_119);
    assume {:nonnull} thisState != 0;
    assume thisState > 0;
    call {:si_unique_call 1338} Tmp_121 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_121 != 0;
    assume Tmp_121 > 0;
    Mem_T.INT4[Tmp_121] := origIrql_5;
    call {:si_unique_call 1339} sdv_KeAcquireSpinLock(0, Tmp_121);
    goto anon50_Then, anon50_Else;
  ...
  anon46_Then:
    call {:si_unique_call 1343} MakeIrpCurrentPassedDown(thisState, Irp_9);
    assume {:nonnull} thisState != 0;
    assume thisState > 0;
    call {:si_unique_call 1344} sdv_KeReleaseSpinLock(0, origIrql_5);
    call {:si_unique_call 1345} sdv_IoCopyCurrentIrpStackLocationToNext(Irp_9);
    call {:si_unique_call 1346} sdv_IoSetCompletionRoutine(Irp_9, li2bplFunctionConstant1478, thisState, 1, 1, 1);
    assume {:nonnull} thisState != 0;
    assume thisState > 0;
    havoc Tmp_117;
    assume {:nonnull} Tmp_117 != 0;
    ...
    call {:si_unique_call 1347} vslice_dummy_var_193 := sdv_IoCallDriver#0(vslice_dummy_var_132, Irp_9);
    goto anon53_Then, anon53_Else;
  ...
  anon41_Else:
    call {:si_unique_call 1348} UniChangeShuttledToPassDown#1(otherState, origIrql_5);
    goto anon54_Then, anon54_Else;

  anon54_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 1349} RemoveReference(DeviceObject_4);
    Tmp_113 := 0;
    goto L1;
  ...
  anon41_Then:
    assume {:nonnull} otherState != 0;
    assume otherState > 0;
    call {:si_unique_call 1350} sdv_KeReleaseSpinLock(0, origIrql_5);
...
implementation {:origName "UniChangeShuttledToPassDown"} UniChangeShuttledToPassDown#0(actual_ChangingState: int, actual_OrigIrql: int)
{
  ...
  anon0:
    call {:si_unique_call 1352} vslice_dummy_var_194 := __HAVOC_malloc(4);
  ...
  anon17_Else:
    call {:si_unique_call 1353} Tmp_133 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_133 != 0;
    assume Tmp_133 > 0;
    Mem_T.INT4[Tmp_133] := cancelIrql_1;
    call {:si_unique_call 1354} IoAcquireCancelSpinLock(Tmp_133);
    assume {:nonnull} Tmp_133 != 0;
    assume Tmp_133 > 0;
  ...
  anon18_Else:
    ...
    assume ChangingState > 0;
    havoc savedIrp_1;
    call {:si_unique_call 1355} IoReleaseCancelSpinLock(cancelIrql_1);
    assume {:nonnull} ChangingState != 0;
    assume ChangingState > 0;
    assume {:nonnull} ChangingState != 0;
    assume ChangingState > 0;
  ...
  L79:
    ...
    call {:si_unique_call 1356} UniRundownShuttledWait(vslice_dummy_var_133, ShuttledWait__MASKSTATE(ChangingState), 1, savedIrp_1, OrigIrql, -1073741536, 0);
    goto L1;
  ...
  anon18_Then:
    ...
    call {:si_unique_call 1357} sdv_60 := sdv_IoGetCurrentIrpStackLocation(vslice_dummy_var_134);
    ...
    call {:si_unique_call 1358} IoReleaseCancelSpinLock(cancelIrql_1);
    assume {:nonnull} ChangingState != 0;
    assume ChangingState > 0;
    havoc Tmp_126;
  ...
  anon19_Else:
    ...
    call {:si_unique_call 1359} irpSp_5 := sdv_IoGetCurrentIrpStackLocation(vslice_dummy_var_135);
    assume {:nonnull} ChangingState != 0;
    assume ChangingState > 0;
    havoc vslice_dummy_var_136;
    call {:si_unique_call 1360} nextSp_2 := sdv_IoGetNextIrpStackLocation(vslice_dummy_var_136);
    s_p_e_c_i_a_l_10 := 1;
    assume {:nonnull} ChangingState != 0;
    assume ChangingState > 0;
    havoc vslice_dummy_var_137;
    call {:si_unique_call 1361} sdv_65 := sdv_IoGetCurrentIrpStackLocation(vslice_dummy_var_137);
    ...
    call {:si_unique_call 1362} sdv_61 := sdv_IoGetCurrentIrpStackLocation(vslice_dummy_var_138);
    ...
    call {:si_unique_call 1363} MakeIrpCurrentPassedDown(ChangingState, vslice_dummy_var_139);
    assume {:nonnull} ChangingState != 0;
    assume ChangingState > 0;
    ...
    call {:si_unique_call 1364} sdv_IoSetCompletionRoutine(vslice_dummy_var_140, li2bplFunctionConstant1478, ChangingState, 1, 1, 1);
    assume {:nonnull} ChangingState != 0;
    assume ChangingState > 0;
    havoc Tmp_129;
    ...
    assume {:nonnull} ChangingState != 0;
    assume ChangingState > 0;
    call {:si_unique_call 1365} sdv_KeReleaseSpinLock(0, OrigIrql);
    assume {:nonnull} ChangingState != 0;
    assume ChangingState > 0;
    havoc Tmp_127;
    assume {:nonnull} ChangingState != 0;
  ...
  anon19_Then:
    ...
    call {:si_unique_call 1366} vslice_dummy_var_195 := UniMakeIrpShuttledWait(ChangingState, vslice_dummy_var_141, OrigIrql, 0, 0);
    goto anon21_Then, anon21_Else;
...
procedure {:origName "UniChangeShuttledToPassDown"} UniChangeShuttledToPassDown#0(actual_ChangingState: int, actual_OrigIrql: int);
  ...
  free ensures {:va_keep} sdv_irql_previous_5 == old(sdv_irql_previous_4) || sdv_irql_previous_5 == old(sdv_irql_previous_5);
  free ensures {:va_keep} sdv_irql_previous_2 == old(sdv_irql_previous_3) || sdv_irql_previous_2 == old(sdv_irql_previous_4) || sdv_irql_previous_2 == old(sdv_irql_previous_2);
  free ensures {:va_keep} sdv_irql_previous == old(sdv_irql_previous_2) || sdv_irql_previous == old(sdv_irql_previous_3) || sdv_irql_previous == actual_OrigIrql;
...
implementation {:origName "UniChangeShuttledToPassDown"} UniChangeShuttledToPassDown#1(actual_ChangingState: int, actual_OrigIrql: int)
{
  ...
  anon0:
    call {:si_unique_call 1368} vslice_dummy_var_196 := __HAVOC_malloc(4);
    ChangingState := actual_ChangingState;
    OrigIrql := actual_OrigIrql;
    assume {:nonnull} ChangingState != 0;
    assume ChangingState > 0;
  ...
  anon17_Else:
    call {:si_unique_call 1369} Tmp_133 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_133 != 0;
    assume Tmp_133 > 0;
    Mem_T.INT4[Tmp_133] := cancelIrql_1;
    call {:si_unique_call 1370} IoAcquireCancelSpinLock(Tmp_133);
    assume {:nonnull} Tmp_133 != 0;
    assume Tmp_133 > 0;
    cancelIrql_1 := Mem_T.INT4[Tmp_133];
    assume {:nonnull} ChangingState != 0;
  ...
  anon22_Else:
    ...
    call {:si_unique_call 1372} UniChangeShuttledToPassDown#0(vslice_dummy_var_142, OrigIrql);
    goto anon23_Then, anon23_Else;
  ...
  anon23_Else:
    ...
    assume {:nonnull} ChangingState != 0;
    assume ChangingState > 0;
    call {:si_unique_call 1373} Tmp_133 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_133 != 0;
    assume Tmp_133 > 0;
    Mem_T.INT4[Tmp_133] := recallIrql;
    call {:si_unique_call 1374} sdv_KeAcquireSpinLock(0, Tmp_133);
    goto anon24_Then, anon24_Else;
  ...
  L79:
    ...
    call {:si_unique_call 1375} UniRundownShuttledWait(vslice_dummy_var_143, ShuttledWait__MASKSTATE(ChangingState), 1, savedIrp_1, OrigIrql, -1073741536, 0);
    goto L1;
  ...
  anon18_Then:
    ...
    call {:si_unique_call 1376} sdv_60 := sdv_IoGetCurrentIrpStackLocation(vslice_dummy_var_144);
    assume {:nonnull} sdv_60 != 0;
    assume sdv_60 > 0;
    s_p_e_c_i_a_l_7 := Argument4_unnamed_tag_42(Others_unnamed_tag_8(Parameters__IO_STACK_LOCATION(sdv_60)));
    assume {:nonnull} s_p_e_c_i_a_l_7 != 0;
    assume s_p_e_c_i_a_l_7 > 0;
    Mem_T.INT4[s_p_e_c_i_a_l_7] := BAND(Mem_T.INT4[s_p_e_c_i_a_l_7], BNOT(s_p_e_c_i_a_l_8));
    call {:si_unique_call 1377} IoReleaseCancelSpinLock(cancelIrql_1);
    assume {:nonnull} ChangingState != 0;
    assume ChangingState > 0;
    havoc Tmp_126;
    assume {:nonnull} Tmp_126 != 0;
  ...
  anon19_Else:
    ...
    call {:si_unique_call 1378} irpSp_5 := sdv_IoGetCurrentIrpStackLocation(vslice_dummy_var_145);
    assume {:nonnull} ChangingState != 0;
    assume ChangingState > 0;
    havoc vslice_dummy_var_146;
    call {:si_unique_call 1379} nextSp_2 := sdv_IoGetNextIrpStackLocation(vslice_dummy_var_146);
    s_p_e_c_i_a_l_10 := 1;
    assume {:nonnull} ChangingState != 0;
    assume ChangingState > 0;
    havoc vslice_dummy_var_147;
    call {:si_unique_call 1380} sdv_65 := sdv_IoGetCurrentIrpStackLocation(vslice_dummy_var_147);
    assume {:nonnull} sdv_65 != 0;
    assume sdv_65 > 0;
    s_p_e_c_i_a_l_9 := Argument4_unnamed_tag_42(Others_unnamed_tag_8(Parameters__IO_STACK_LOCATION(sdv_65)));
    assume {:nonnull} s_p_e_c_i_a_l_9 != 0;
    ...
    call {:si_unique_call 1381} sdv_61 := sdv_IoGetCurrentIrpStackLocation(vslice_dummy_var_148);
    assume {:nonnull} sdv_61 != 0;
    assume sdv_61 > 0;
    s_p_e_c_i_a_l_11 := Argument3_unnamed_tag_42(Others_unnamed_tag_8(Parameters__IO_STACK_LOCATION(sdv_61)));
    Tmp_135 := s_p_e_c_i_a_l_11;
    ...
    call {:si_unique_call 1382} MakeIrpCurrentPassedDown(ChangingState, vslice_dummy_var_149);
    assume {:nonnull} ChangingState != 0;
    assume ChangingState > 0;
    assume {:nonnull} irpSp_5 != 0;
    assume irpSp_5 > 0;
    ...
    call {:si_unique_call 1383} sdv_IoSetCompletionRoutine(vslice_dummy_var_150, li2bplFunctionConstant1478, ChangingState, 1, 1, 1);
    assume {:nonnull} ChangingState != 0;
    assume ChangingState > 0;
    havoc Tmp_129;
    assume {:nonnull} Tmp_129 != 0;
    ...
    assume {:nonnull} ChangingState != 0;
    assume ChangingState > 0;
    call {:si_unique_call 1384} sdv_KeReleaseSpinLock(0, OrigIrql);
    assume {:nonnull} ChangingState != 0;
    assume ChangingState > 0;
    havoc Tmp_127;
    assume {:nonnull} ChangingState != 0;
    ...
    call {:si_unique_call 1385} vslice_dummy_var_198 := sdv_IoCallDriver#0(vslice_dummy_var_151, vslice_dummy_var_152);
    goto anon20_Then, anon20_Else;
  ...
  anon19_Then:
    ...
    call {:si_unique_call 1386} vslice_dummy_var_197 := UniMakeIrpShuttledWait(ChangingState, vslice_dummy_var_153, OrigIrql, 0, 0);
    goto anon21_Then, anon21_Else;
...
implementation {:origName "UniReadComplete"} UniReadComplete#0(actual_DeviceObject_39: int, actual_Irp_42: int, actual_Context_11: int) returns (Tmp_594: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 1388} Tmp_598 := __HAVOC_malloc(160);
    Control_3 := Context_11;
    assume {:nonnull} DeviceObject_39 != 0;
    assume DeviceObject_39 > 0;
    havoc deviceExtension_12;
    call {:si_unique_call 1389} irpSp_22 := sdv_IoGetCurrentIrpStackLocation(Irp_42);
    call {:si_unique_call 1390} nextSp_4 := sdv_IoGetNextIrpStackLocation(Irp_42);
  ...
  L33:
    call {:si_unique_call 1391} Tmp_595, Tmp_598, Tmp_600, origIrql_14, Length_4, Tmp_601, Tmp_602 := UniReadComplete#0_loop_L33(Tmp_595, Tmp_598, Buffer_1, Tmp_600, origIrql_14, Length_4, Tmp_601, Tmp_602, deviceExtension_12, Irp_42);
    goto L33_last;
  ...
  anon42_Else:
    ...
    call {:si_unique_call 1392} Tmp_600 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_600 != 0;
    assume Tmp_600 > 0;
    Mem_T.INT4[Tmp_600] := origIrql_14;
    call {:si_unique_call 1393} sdv_KeAcquireSpinLock(0, Tmp_600);
    goto anon48_Then, anon48_Else;
  ...
  L45:
    call {:si_unique_call 1394} sdv_KeReleaseSpinLock(0, origIrql_14);
    Tmp_601 := Length_4 - 1;
    call {:si_unique_call 1395} sdv_RtlCopyMemory(0, 0, Tmp_601);
    Length_4 := Length_4 - 1;
    assume {:nonnull} Irp_42 != 0;
    assume Irp_42 > 0;
    goto L57;
  ...
  anon41_Else:
    ...
    assume deviceExtension_12 > 0;
    Tmp_602 := Length_4 - 1;
    call {:si_unique_call 1396} sdv_RtlCopyMemory(0, 0, Tmp_602);
    Length_4 := Length_4 - 1;
    assume {:nonnull} Irp_42 != 0;
    assume Irp_42 > 0;
  ...
  anon39_Then:
    assume {:partition} Length_4 == 0;
    call {:si_unique_call 1397} HandleDleIrp(deviceExtension_12);
    goto anon49_Then, anon49_Else;
  ...
  L73:
    call {:si_unique_call 1398} sdv_IoCopyCurrentIrpStackLocationToNext(Irp_42);
    assume {:nonnull} Irp_42 != 0;
    assume Irp_42 > 0;
    assume {:nonnull} Control_3 != 0;
    assume Control_3 > 0;
    ...
    assume nextSp_4 > 0;
    call {:si_unique_call 1399} sdv_IoSetCompletionRoutine(Irp_42, li2bplFunctionConstant1120, Control_3, 1, 1, 1);
    assume {:nonnull} Control_3 != 0;
    assume Control_3 > 0;
    assume false;
    return;
  ...
  L23:
    ...
    assume {:nonnull} Irp_42 != 0;
    assume Irp_42 > 0;
    call {:si_unique_call 1400} StartNextReadWriteIrp(Control_3);
    goto anon47_Then, anon47_Else;

  anon47_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 1401} RemoveReference(DeviceObject_39);
    Tmp_594 := 0;
    goto L1;
...
implementation {:origName "UniReadComplete"} UniReadComplete#1(actual_DeviceObject_39: int, actual_Irp_42: int, actual_Context_11: int) returns (Tmp_594: int)
{
  ...
  anon0:
    ...
    Irp_42 := actual_Irp_42;
    Context_11 := actual_Context_11;
    call {:si_unique_call 1402} Tmp_598 := __HAVOC_malloc(160);
    Control_3 := Context_11;
    assume {:nonnull} DeviceObject_39 != 0;
    assume DeviceObject_39 > 0;
    havoc deviceExtension_12;
    call {:si_unique_call 1403} irpSp_22 := sdv_IoGetCurrentIrpStackLocation(Irp_42);
    call {:si_unique_call 1404} nextSp_4 := sdv_IoGetNextIrpStackLocation(Irp_42);
    assume {:nonnull} Irp_42 != 0;
    assume Irp_42 > 0;
    goto anon35_Then, anon35_Else;
  ...
  L33:
    call {:si_unique_call 1405} Tmp_595, Tmp_598, Tmp_600, origIrql_14, Length_4, Tmp_601, Tmp_602 := UniReadComplete#1_loop_L33(Tmp_595, Tmp_598, Buffer_1, Tmp_600, origIrql_14, Length_4, Tmp_601, Tmp_602, deviceExtension_12, Irp_42);
    goto L33_last;
  ...
  anon42_Else:
    assume {:partition} Mem_T.INT4[Buffer_1] != 16;
    call {:si_unique_call 1406} Tmp_600 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_600 != 0;
    assume Tmp_600 > 0;
    Mem_T.INT4[Tmp_600] := origIrql_14;
    call {:si_unique_call 1407} sdv_KeAcquireSpinLock(0, Tmp_600);
    goto anon48_Then, anon48_Else;
  ...
  L45:
    call {:si_unique_call 1408} sdv_KeReleaseSpinLock(0, origIrql_14);
    Tmp_601 := Length_4 - 1;
    call {:si_unique_call 1409} sdv_RtlCopyMemory(0, 0, Tmp_601);
    Length_4 := Length_4 - 1;
    assume {:nonnull} Irp_42 != 0;
    assume Irp_42 > 0;
    goto L57;
  ...
  anon41_Else:
    ...
    assume deviceExtension_12 > 0;
    Tmp_602 := Length_4 - 1;
    call {:si_unique_call 1410} sdv_RtlCopyMemory(0, 0, Tmp_602);
    Length_4 := Length_4 - 1;
    assume {:nonnull} Irp_42 != 0;
    assume Irp_42 > 0;
    goto anon41_Else_dummy;
  ...
  anon39_Then:
    assume {:partition} Length_4 == 0;
    call {:si_unique_call 1411} HandleDleIrp(deviceExtension_12);
    goto anon49_Then, anon49_Else;
  ...
  L73:
    call {:si_unique_call 1412} sdv_IoCopyCurrentIrpStackLocationToNext(Irp_42);
    assume {:nonnull} Irp_42 != 0;
    assume Irp_42 > 0;
    assume {:nonnull} Control_3 != 0;
    assume Control_3 > 0;
    ...
    assume {:nonnull} nextSp_4 != 0;
    assume nextSp_4 > 0;
    call {:si_unique_call 1413} sdv_IoSetCompletionRoutine(Irp_42, li2bplFunctionConstant1120, Control_3, 1, 1, 1);
    assume {:nonnull} Control_3 != 0;
    assume Control_3 > 0;
    havoc vslice_dummy_var_154;
    call {:si_unique_call 1414} vslice_dummy_var_199 := sdv_IoCallDriver#0(vslice_dummy_var_154, Irp_42);
    goto anon51_Then, anon51_Else;
  ...
  L23:
    ...
    assume {:nonnull} Irp_42 != 0;
    assume Irp_42 > 0;
    call {:si_unique_call 1415} StartNextReadWriteIrp(Control_3);
    goto anon47_Then, anon47_Else;

  anon47_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 1416} RemoveReference(DeviceObject_39);
    Tmp_594 := 0;
    goto L1;
...
implementation {:origName "UniSetupNoPassPart2"} UniSetupNoPassPart2#0(actual_DeviceObject_49: int, actual_Irp_54: int, actual_Context_18: int) returns (Tmp_652: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 1417} nextSp_10 := sdv_IoGetNextIrpStackLocation(Irp_54);
    ...
    call {:si_unique_call 1418} sdv_IoSetCompletionRoutine(Irp_54, li2bplFunctionConstant940, Context_18, 1, 1, 1);
    Tmp_653 := Context_18;
...
implementation {:origName "UniSetupNoPassPart2"} UniSetupNoPassPart2#1(actual_DeviceObject_49: int, actual_Irp_54: int, actual_Context_18: int) returns (Tmp_652: int)
{
  ...
  anon0:
    ...
    assume Tmp_653 > 0;
    havoc Tmp_654;
    call {:si_unique_call 1421} vslice_dummy_var_200 := sdv_IoCallDriver#0(Tmp_654, Irp_54);
    goto anon3_Then, anon3_Else;
...
implementation {:origName "UniSetupNoPassPart3"} UniSetupNoPassPart3#0(actual_DeviceObject_50: int, actual_Irp_55: int, actual_Context_19: int) returns (Tmp_659: int)
{
  ...
  anon0:
    call {:si_unique_call 1422} newIrp_3 := __HAVOC_malloc(4);
    Irp_55 := actual_Irp_55;
    Context_19 := actual_Context_19;
    call {:si_unique_call 1423} Tmp_661 := __HAVOC_malloc(72);
    call {:si_unique_call 1424} Tmp_662 := __HAVOC_malloc(72);
    call {:si_unique_call 1425} Tmp_665 := __HAVOC_malloc(72);
    call {:si_unique_call 1426} Tmp_666 := __HAVOC_malloc(72);
    call {:si_unique_call 1427} Tmp_667 := __HAVOC_malloc(72);
    call {:si_unique_call 1428} Tmp_668 := __HAVOC_malloc(72);
    call {:si_unique_call 1429} vslice_dummy_var_201 := sdv_IoGetCurrentIrpStackLocation(Irp_55);
    extension_9 := Context_19;
    call {:si_unique_call 1430} sdv_415 := sdv_IoGetCurrentIrpStackLocation(Irp_55);
    assume {:nonnull} sdv_415 != 0;
    assume sdv_415 > 0;
    goto anon25_Then, anon25_Else;
  ...
  anon25_Else:
    ...
    call {:si_unique_call 1431} Tmp_664 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_664 != 0;
    assume Tmp_664 > 0;
    Mem_T.INT4[Tmp_664] := origIrql_20;
    call {:si_unique_call 1432} sdv_KeAcquireSpinLock(0, Tmp_664);
    goto anon30_Then, anon30_Else;
  ...
  L45:
    call {:si_unique_call 1433} sdv_KeReleaseSpinLock(0, origIrql_20);
    goto L48;
  ...
  anon33_Else:
    ...
    havoc Tmp_668;
    Tmp_660 := Tmp_668;
    call {:si_unique_call 1434} UniChangeShuttledToPassDown#0(Tmp_660, origIrql_20);
    goto anon34_Then, anon34_Else;
  ...
  anon35_Else:
    ...
    call {:si_unique_call 1435} UniChangeShuttledToPassDown#0(Tmp_663, origIrql_20);
    goto anon36_Then, anon36_Else;
  ...
  anon35_Then:
    call {:si_unique_call 1436} sdv_KeReleaseSpinLock(0, origIrql_20);
    goto L48;
  ...
  anon27_Then:
    call {:si_unique_call 1437} sdv_KeReleaseSpinLock(0, origIrql_20);
    goto L48;
  ...
  anon25_Then:
    ...
    call {:si_unique_call 1438} s_p_e_c_i_a_l_36 := sdv_IoGetCurrentIrpStackLocation(s_p_e_c_i_a_l_37);
    ...
    call {:si_unique_call 1439} UniGetNextIrp(vslice_dummy_var_155, DeviceLock__DEVICE_EXTENSION(extension_9), CurrentPassThrough__DEVICE_EXTENSION(extension_9), PassThroughQueue__DEVICE_EXTENSION(extension_9), newIrp_3, 1);
    goto anon28_Then, anon28_Else;
  ...
  anon26_Else:
    call {:si_unique_call 1440} vslice_dummy_var_202 := UniPassThroughStarter#0(extension_9);
    goto anon29_Then, anon29_Else;
...
implementation {:origName "UniSetupNoPassPart3"} UniSetupNoPassPart3#1(actual_DeviceObject_50: int, actual_Irp_55: int, actual_Context_19: int) returns (Tmp_659: int)
{
  ...
  anon0:
    call {:si_unique_call 1441} newIrp_3 := __HAVOC_malloc(4);
    Irp_55 := actual_Irp_55;
    Context_19 := actual_Context_19;
    call {:si_unique_call 1442} Tmp_661 := __HAVOC_malloc(72);
    call {:si_unique_call 1443} Tmp_662 := __HAVOC_malloc(72);
    call {:si_unique_call 1444} Tmp_665 := __HAVOC_malloc(72);
    call {:si_unique_call 1445} Tmp_666 := __HAVOC_malloc(72);
    call {:si_unique_call 1446} Tmp_667 := __HAVOC_malloc(72);
    call {:si_unique_call 1447} Tmp_668 := __HAVOC_malloc(72);
    call {:si_unique_call 1448} vslice_dummy_var_203 := sdv_IoGetCurrentIrpStackLocation(Irp_55);
    extension_9 := Context_19;
    call {:si_unique_call 1449} sdv_415 := sdv_IoGetCurrentIrpStackLocation(Irp_55);
    assume {:nonnull} sdv_415 != 0;
    assume sdv_415 > 0;
    goto anon25_Then, anon25_Else;
  ...
  anon25_Else:
    assume {:nonnull} extension_9 != 0;
    assume extension_9 > 0;
    call {:si_unique_call 1450} Tmp_664 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_664 != 0;
    assume Tmp_664 > 0;
    Mem_T.INT4[Tmp_664] := origIrql_20;
    call {:si_unique_call 1451} sdv_KeAcquireSpinLock(0, Tmp_664);
    goto anon30_Then, anon30_Else;
  ...
  L45:
    call {:si_unique_call 1452} sdv_KeReleaseSpinLock(0, origIrql_20);
    goto L48;
  ...
  anon33_Else:
    ...
    havoc Tmp_668;
    Tmp_660 := Tmp_668;
    call {:si_unique_call 1453} UniChangeShuttledToPassDown#1(Tmp_660, origIrql_20);
    goto anon34_Then, anon34_Else;
  ...
  anon35_Else:
    ...
    havoc Tmp_665;
    Tmp_663 := Tmp_665 + 1 * 36;
    call {:si_unique_call 1454} UniChangeShuttledToPassDown#1(Tmp_663, origIrql_20);
    goto anon36_Then, anon36_Else;
  ...
  anon27_Then:
    call {:si_unique_call 1456} sdv_KeReleaseSpinLock(0, origIrql_20);
    goto L48;
  ...
  anon25_Then:
    s_p_e_c_i_a_l_37 := Irp_55;
    s_p_e_c_i_a_l_38 := 2818056;
    call {:si_unique_call 1457} s_p_e_c_i_a_l_36 := sdv_IoGetCurrentIrpStackLocation(s_p_e_c_i_a_l_37);
    assume {:nonnull} s_p_e_c_i_a_l_36 != 0;
    assume s_p_e_c_i_a_l_36 > 0;
    assume {:nonnull} s_p_e_c_i_a_l_37 != 0;
    assume s_p_e_c_i_a_l_37 > 0;
    ...
    call {:si_unique_call 1458} UniGetNextIrp(vslice_dummy_var_156, DeviceLock__DEVICE_EXTENSION(extension_9), CurrentPassThrough__DEVICE_EXTENSION(extension_9), PassThroughQueue__DEVICE_EXTENSION(extension_9), newIrp_3, 1);
    goto anon28_Then, anon28_Else;
  ...
  anon26_Else:
    call {:si_unique_call 1459} vslice_dummy_var_204 := UniPassThroughStarter#1(extension_9);
    goto anon29_Then, anon29_Else;
...
implementation {:origName "UniPassThroughStarter"} UniPassThroughStarter#0(actual_Extension_10: int) returns (Tmp_669: int)
{
  ...
  anon0:
    call {:si_unique_call 1460} newIrp_4 := __HAVOC_malloc(4);
    Extension_10 := actual_Extension_10;
    goto L6;

  L6:
    call {:si_unique_call 1461} Tmp_671, Tmp_672, irp_4, passThroughType := UniPassThroughStarter#0_loop_L6(newIrp_4, Tmp_671, Tmp_672, irp_4, passThroughType, Extension_10);
    goto L6_last;
  ...
  anon29_Else:
    ...
    call {:si_unique_call 1462} vslice_dummy_var_205 := UniSetupPass#0(vslice_dummy_var_157, irp_4, Extension_10);
    goto anon33_Then, anon33_Else;
  ...
  L23:
    ...
    call {:si_unique_call 1463} UniGetNextIrp(vslice_dummy_var_158, DeviceLock__DEVICE_EXTENSION(Extension_10), CurrentPassThrough__DEVICE_EXTENSION(Extension_10), PassThroughQueue__DEVICE_EXTENSION(Extension_10), newIrp_4, 1);
    goto anon34_Then, anon34_Else;
  ...
  anon31_Else:
    ...
    call {:si_unique_call 1464} vslice_dummy_var_206 := UniSetupSniffPart0#0(vslice_dummy_var_159, irp_4, Extension_10);
    goto anon35_Then, anon35_Else;
  ...
  anon26_Else:
    ...
    call {:si_unique_call 1465} vslice_dummy_var_207 := UniSetupNoPassPart1#0(vslice_dummy_var_160, irp_4, Extension_10);
    goto anon36_Then, anon36_Else;
...
implementation {:origName "UniPassThroughStarter"} UniPassThroughStarter#1(actual_Extension_10: int) returns (Tmp_669: int)
{
  ...
  anon0:
    call {:si_unique_call 1466} newIrp_4 := __HAVOC_malloc(4);
    Extension_10 := actual_Extension_10;
    goto L6;

  L6:
    call {:si_unique_call 1467} Tmp_671, Tmp_672, irp_4, passThroughType := UniPassThroughStarter#1_loop_L6(newIrp_4, Tmp_671, Tmp_672, irp_4, passThroughType, Extension_10);
    goto L6_last;
  ...
  anon29_Else:
    ...
    call {:si_unique_call 1468} vslice_dummy_var_208 := UniSetupPass#1(vslice_dummy_var_161, irp_4, Extension_10);
    goto anon33_Then, anon33_Else;
  ...
  L23:
    ...
    call {:si_unique_call 1469} UniGetNextIrp(vslice_dummy_var_162, DeviceLock__DEVICE_EXTENSION(Extension_10), CurrentPassThrough__DEVICE_EXTENSION(Extension_10), PassThroughQueue__DEVICE_EXTENSION(Extension_10), newIrp_4, 1);
    goto anon34_Then, anon34_Else;
  ...
  anon31_Else:
    ...
    call {:si_unique_call 1470} vslice_dummy_var_209 := UniSetupSniffPart0#1(vslice_dummy_var_163, irp_4, Extension_10);
    goto anon35_Then, anon35_Else;
  ...
  anon26_Else:
    ...
    call {:si_unique_call 1471} vslice_dummy_var_210 := UniSetupNoPassPart1#1(vslice_dummy_var_164, irp_4, Extension_10);
    goto anon36_Then, anon36_Else;
...
implementation {:origName "UniSetupPass"} UniSetupPass#0(actual_DeviceObject_42: int, actual_Irp_46: int, actual_Context_14: int) returns (Tmp_615: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 1472} Tmp_617 := __HAVOC_malloc(72);
    call {:si_unique_call 1473} Tmp_619 := __HAVOC_malloc(72);
    call {:si_unique_call 1474} irpSp_25 := sdv_IoGetCurrentIrpStackLocation(Irp_46);
    call {:si_unique_call 1475} nextSp_7 := sdv_IoGetNextIrpStackLocation(Irp_46);
    extension_5 := Context_14;
    call {:si_unique_call 1476} Tmp_618 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_618 != 0;
    assume Tmp_618 > 0;
    Mem_T.INT4[Tmp_618] := origIrql_17;
    call {:si_unique_call 1477} sdv_KeAcquireSpinLock(0, Tmp_618);
    goto anon10_Then, anon10_Else;
  ...
  anon9_Else:
    ...
    call {:si_unique_call 1478} s_p_e_c_i_a_l_22 := sdv_IoGetCurrentIrpStackLocation(s_p_e_c_i_a_l_24);
    ...
    call {:si_unique_call 1479} sdv_IoSetCompletionRoutine(Irp_46, li2bplFunctionConstant940, extension_5, 1, 1, 1);
    call {:si_unique_call 1480} sdv_KeReleaseSpinLock(0, origIrql_17);
    assume {:nonnull} extension_5 != 0;
    assume extension_5 > 0;
    assume false;
    return;
  ...
  anon9_Then:
    assume {:nonnull} extension_5 != 0;
    assume extension_5 > 0;
    call {:si_unique_call 1481} sdv_KeReleaseSpinLock(0, origIrql_17);
    assume {:nonnull} Irp_46 != 0;
    assume Irp_46 > 0;
    assume {:nonnull} Irp_46 != 0;
    assume Irp_46 > 0;
    s_p_e_c_i_a_l_23 := Irp_46;
    call {:si_unique_call 1482} s_p_e_c_i_a_l_21 := sdv_IoGetCurrentIrpStackLocation(s_p_e_c_i_a_l_23);
...
implementation {:origName "UniSetupPass"} UniSetupPass#1(actual_DeviceObject_42: int, actual_Irp_46: int, actual_Context_14: int) returns (Tmp_615: int)
{
  ...
  anon0:
    Irp_46 := actual_Irp_46;
    Context_14 := actual_Context_14;
    call {:si_unique_call 1483} Tmp_617 := __HAVOC_malloc(72);
    call {:si_unique_call 1484} Tmp_619 := __HAVOC_malloc(72);
    call {:si_unique_call 1485} irpSp_25 := sdv_IoGetCurrentIrpStackLocation(Irp_46);
    call {:si_unique_call 1486} nextSp_7 := sdv_IoGetNextIrpStackLocation(Irp_46);
    extension_5 := Context_14;
    call {:si_unique_call 1487} Tmp_618 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_618 != 0;
    assume Tmp_618 > 0;
    Mem_T.INT4[Tmp_618] := origIrql_17;
    call {:si_unique_call 1488} sdv_KeAcquireSpinLock(0, Tmp_618);
    goto anon10_Then, anon10_Else;
  ...
  anon9_Else:
    ...
    assume extension_5 > 0;
    s_p_e_c_i_a_l_24 := Irp_46;
    call {:si_unique_call 1489} s_p_e_c_i_a_l_22 := sdv_IoGetCurrentIrpStackLocation(s_p_e_c_i_a_l_24);
    assume {:nonnull} s_p_e_c_i_a_l_22 != 0;
    assume s_p_e_c_i_a_l_22 > 0;
    assume {:nonnull} s_p_e_c_i_a_l_24 != 0;
    assume s_p_e_c_i_a_l_24 > 0;
    ...
    call {:si_unique_call 1490} sdv_IoSetCompletionRoutine(Irp_46, li2bplFunctionConstant940, extension_5, 1, 1, 1);
    call {:si_unique_call 1491} sdv_KeReleaseSpinLock(0, origIrql_17);
    assume {:nonnull} extension_5 != 0;
    assume extension_5 > 0;
    havoc vslice_dummy_var_167;
    call {:si_unique_call 1492} vslice_dummy_var_211 := sdv_IoCallDriver#0(vslice_dummy_var_167, Irp_46);
    goto anon11_Then, anon11_Else;
  ...
  anon9_Then:
    ...
    assume Irp_46 > 0;
    s_p_e_c_i_a_l_23 := Irp_46;
    call {:si_unique_call 1494} s_p_e_c_i_a_l_21 := sdv_IoGetCurrentIrpStackLocation(s_p_e_c_i_a_l_23);
    assume {:nonnull} s_p_e_c_i_a_l_21 != 0;
    assume s_p_e_c_i_a_l_21 > 0;
    assume {:nonnull} s_p_e_c_i_a_l_23 != 0;
    assume s_p_e_c_i_a_l_23 > 0;
    ...
    call {:si_unique_call 1495} vslice_dummy_var_212 := UniSetupNoPassPart3#0(vslice_dummy_var_168, Irp_46, extension_5);
    goto anon12_Then, anon12_Else;
...
implementation {:origName "UniSetupSniffPart0"} UniSetupSniffPart0#0(actual_DeviceObject_48: int, actual_Irp_53: int, actual_Context_17: int) returns (Tmp_649: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 1496} irpSp_30 := sdv_IoGetCurrentIrpStackLocation(Irp_53);
    call {:si_unique_call 1497} nextSp_9 := sdv_IoGetNextIrpStackLocation(Irp_53);
    extension_8 := Context_17;
    assume {:nonnull} extension_8 != 0;
    assume extension_8 > 0;
    s_p_e_c_i_a_l_33 := Irp_53;
    call {:si_unique_call 1498} s_p_e_c_i_a_l_32 := sdv_IoGetCurrentIrpStackLocation(s_p_e_c_i_a_l_33);
    ...
    call {:si_unique_call 1499} sdv_IoSetCompletionRoutine(Irp_53, li2bplFunctionConstant943, extension_8, 1, 1, 1);
    assume {:nonnull} extension_8 != 0;
    assume extension_8 > 0;
    assume false;
    return;
...
implementation {:origName "UniSetupSniffPart0"} UniSetupSniffPart0#1(actual_DeviceObject_48: int, actual_Irp_53: int, actual_Context_17: int) returns (Tmp_649: int)
{
  ...
  anon0:
    Irp_53 := actual_Irp_53;
    Context_17 := actual_Context_17;
    call {:si_unique_call 1500} irpSp_30 := sdv_IoGetCurrentIrpStackLocation(Irp_53);
    call {:si_unique_call 1501} nextSp_9 := sdv_IoGetNextIrpStackLocation(Irp_53);
    extension_8 := Context_17;
    assume {:nonnull} extension_8 != 0;
    assume extension_8 > 0;
    s_p_e_c_i_a_l_33 := Irp_53;
    call {:si_unique_call 1502} s_p_e_c_i_a_l_32 := sdv_IoGetCurrentIrpStackLocation(s_p_e_c_i_a_l_33);
    assume {:nonnull} s_p_e_c_i_a_l_32 != 0;
    assume s_p_e_c_i_a_l_32 > 0;
    assume {:nonnull} s_p_e_c_i_a_l_33 != 0;
    assume s_p_e_c_i_a_l_33 > 0;
    ...
    assume Tmp_650 > 0;
    Mem_T.INT4[Tmp_650] := 0;
    call {:si_unique_call 1503} sdv_IoSetCompletionRoutine(Irp_53, li2bplFunctionConstant943, extension_8, 1, 1, 1);
    assume {:nonnull} extension_8 != 0;
    assume extension_8 > 0;
    havoc vslice_dummy_var_169;
    call {:si_unique_call 1504} vslice_dummy_var_213 := sdv_IoCallDriver#0(vslice_dummy_var_169, Irp_53);
    goto anon3_Then, anon3_Else;
...
implementation {:origName "UniSetupNoPassPart1"} UniSetupNoPassPart1#0(actual_DeviceObject_47: int, actual_Irp_51: int, actual_Context_16: int) returns (Tmp_639: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 1505} Tmp_641 := __HAVOC_malloc(72);
    call {:si_unique_call 1506} Tmp_642 := __HAVOC_malloc(72);
    call {:si_unique_call 1507} irpSp_28 := sdv_IoGetCurrentIrpStackLocation(Irp_51);
    call {:si_unique_call 1508} nextSp_8 := sdv_IoGetNextIrpStackLocation(Irp_51);
    extension_7 := Context_16;
    call {:si_unique_call 1509} Tmp_640 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_640 != 0;
    assume Tmp_640 > 0;
    Mem_T.INT4[Tmp_640] := origIrql_18;
    call {:si_unique_call 1510} sdv_KeAcquireSpinLock(0, Tmp_640);
    goto anon10_Then, anon10_Else;
  ...
  anon9_Else:
    ...
    call {:si_unique_call 1511} s_p_e_c_i_a_l_29 := sdv_IoGetCurrentIrpStackLocation(s_p_e_c_i_a_l_31);
    ...
    call {:si_unique_call 1512} sdv_IoSetCompletionRoutine(Irp_51, li2bplFunctionConstant939, extension_7, 1, 1, 1);
    call {:si_unique_call 1513} sdv_KeReleaseSpinLock(0, origIrql_18);
    assume {:nonnull} extension_7 != 0;
    assume extension_7 > 0;
    assume false;
    return;
  ...
  anon9_Then:
    assume {:nonnull} extension_7 != 0;
    assume extension_7 > 0;
    call {:si_unique_call 1514} sdv_KeReleaseSpinLock(0, origIrql_18);
    s_p_e_c_i_a_l_30 := Irp_51;
    call {:si_unique_call 1515} s_p_e_c_i_a_l_28 := sdv_IoGetCurrentIrpStackLocation(s_p_e_c_i_a_l_30);
    ...
    call {:si_unique_call 1516} vslice_dummy_var_214 := UniSetupNoPassPart2#0(vslice_dummy_var_171, Irp_51, extension_7);
    goto anon12_Then, anon12_Else;
...
implementation {:origName "UniSetupNoPassPart1"} UniSetupNoPassPart1#1(actual_DeviceObject_47: int, actual_Irp_51: int, actual_Context_16: int) returns (Tmp_639: int)
{
  ...
  anon0:
    Irp_51 := actual_Irp_51;
    Context_16 := actual_Context_16;
    call {:si_unique_call 1517} Tmp_641 := __HAVOC_malloc(72);
    call {:si_unique_call 1518} Tmp_642 := __HAVOC_malloc(72);
    call {:si_unique_call 1519} irpSp_28 := sdv_IoGetCurrentIrpStackLocation(Irp_51);
    call {:si_unique_call 1520} nextSp_8 := sdv_IoGetNextIrpStackLocation(Irp_51);
    extension_7 := Context_16;
    call {:si_unique_call 1521} Tmp_640 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_640 != 0;
    assume Tmp_640 > 0;
    Mem_T.INT4[Tmp_640] := origIrql_18;
    call {:si_unique_call 1522} sdv_KeAcquireSpinLock(0, Tmp_640);
    goto anon10_Then, anon10_Else;
  ...
  anon9_Else:
    ...
    assume extension_7 > 0;
    s_p_e_c_i_a_l_31 := Irp_51;
    call {:si_unique_call 1523} s_p_e_c_i_a_l_29 := sdv_IoGetCurrentIrpStackLocation(s_p_e_c_i_a_l_31);
    assume {:nonnull} s_p_e_c_i_a_l_29 != 0;
    assume s_p_e_c_i_a_l_29 > 0;
    assume {:nonnull} s_p_e_c_i_a_l_31 != 0;
    assume s_p_e_c_i_a_l_31 > 0;
    ...
    call {:si_unique_call 1524} sdv_IoSetCompletionRoutine(Irp_51, li2bplFunctionConstant939, extension_7, 1, 1, 1);
    call {:si_unique_call 1525} sdv_KeReleaseSpinLock(0, origIrql_18);
    assume {:nonnull} extension_7 != 0;
    assume extension_7 > 0;
    havoc vslice_dummy_var_173;
    call {:si_unique_call 1526} vslice_dummy_var_215 := sdv_IoCallDriver#0(vslice_dummy_var_173, Irp_51);
    goto anon11_Then, anon11_Else;
  ...
  anon9_Then:
    ...
    call {:si_unique_call 1529} vslice_dummy_var_216 := UniSetupNoPassPart2#1(vslice_dummy_var_174, Irp_51, extension_7);
    goto anon12_Then, anon12_Else;
...
implementation {:origName "UniSetupSniffPart1"} UniSetupSniffPart1#0(actual_DeviceObject_41: int, actual_Irp_45: int, actual_Context_13: int) returns (Tmp_607: int)
{
  ...
  anon0:
    call {:si_unique_call 1530} newIrp_1 := __HAVOC_malloc(4);
    Irp_45 := actual_Irp_45;
    Context_13 := actual_Context_13;
    call {:si_unique_call 1531} Tmp_608 := __HAVOC_malloc(72);
    call {:si_unique_call 1532} Tmp_611 := __HAVOC_malloc(72);
    call {:si_unique_call 1533} irpSp_24 := sdv_IoGetCurrentIrpStackLocation(Irp_45);
    call {:si_unique_call 1534} nextSp_6 := sdv_IoGetNextIrpStackLocation(Irp_45);
    extension_4 := Context_13;
    assume {:nonnull} Irp_45 != 0;
    assume Irp_45 > 0;
    havoc vslice_dummy_var_175;
    call {:si_unique_call 1535} sdv_371 := sdv_NT_ERROR(vslice_dummy_var_175);
    goto anon11_Then, anon11_Else;
  ...
  anon11_Else:
    ...
    call {:si_unique_call 1536} s_p_e_c_i_a_l_18 := sdv_IoGetCurrentIrpStackLocation(s_p_e_c_i_a_l_19);
    ...
    call {:si_unique_call 1537} UniGetNextIrp(vslice_dummy_var_176, DeviceLock__DEVICE_EXTENSION(extension_4), CurrentPassThrough__DEVICE_EXTENSION(extension_4), PassThroughQueue__DEVICE_EXTENSION(extension_4), newIrp_1, 1);
    goto anon13_Then, anon13_Else;
  ...
  anon12_Else:
    call {:si_unique_call 1538} vslice_dummy_var_217 := UniPassThroughStarter#0(extension_4);
    goto anon14_Then, anon14_Else;
  ...
  anon11_Then:
    ...
    call {:si_unique_call 1539} sdv_IoSetCompletionRoutine(Irp_45, li2bplFunctionConstant944, extension_4, 1, 1, 1);
    assume {:nonnull} extension_4 != 0;
    assume extension_4 > 0;
    assume false;
    return;
...
implementation {:origName "UniSetupSniffPart1"} UniSetupSniffPart1#1(actual_DeviceObject_41: int, actual_Irp_45: int, actual_Context_13: int) returns (Tmp_607: int)
{
  ...
  anon0:
    call {:si_unique_call 1540} newIrp_1 := __HAVOC_malloc(4);
    Irp_45 := actual_Irp_45;
    Context_13 := actual_Context_13;
    call {:si_unique_call 1541} Tmp_608 := __HAVOC_malloc(72);
    call {:si_unique_call 1542} Tmp_611 := __HAVOC_malloc(72);
    call {:si_unique_call 1543} irpSp_24 := sdv_IoGetCurrentIrpStackLocation(Irp_45);
    call {:si_unique_call 1544} nextSp_6 := sdv_IoGetNextIrpStackLocation(Irp_45);
    extension_4 := Context_13;
    assume {:nonnull} Irp_45 != 0;
    assume Irp_45 > 0;
    havoc vslice_dummy_var_178;
    call {:si_unique_call 1545} sdv_371 := sdv_NT_ERROR(vslice_dummy_var_178);
    goto anon11_Then, anon11_Else;
  ...
  anon11_Else:
    ...
    s_p_e_c_i_a_l_19 := Irp_45;
    s_p_e_c_i_a_l_20 := 2818056;
    call {:si_unique_call 1546} s_p_e_c_i_a_l_18 := sdv_IoGetCurrentIrpStackLocation(s_p_e_c_i_a_l_19);
    assume {:nonnull} s_p_e_c_i_a_l_18 != 0;
    assume s_p_e_c_i_a_l_18 > 0;
    assume {:nonnull} s_p_e_c_i_a_l_19 != 0;
    assume s_p_e_c_i_a_l_19 > 0;
    ...
    call {:si_unique_call 1547} UniGetNextIrp(vslice_dummy_var_179, DeviceLock__DEVICE_EXTENSION(extension_4), CurrentPassThrough__DEVICE_EXTENSION(extension_4), PassThroughQueue__DEVICE_EXTENSION(extension_4), newIrp_1, 1);
    goto anon13_Then, anon13_Else;
  ...
  anon12_Else:
    call {:si_unique_call 1548} vslice_dummy_var_218 := UniPassThroughStarter#1(extension_4);
    goto anon14_Then, anon14_Else;
  ...
  anon11_Then:
    ...
    call {:si_unique_call 1549} sdv_IoSetCompletionRoutine(Irp_45, li2bplFunctionConstant944, extension_4, 1, 1, 1);
    assume {:nonnull} extension_4 != 0;
    assume extension_4 > 0;
    havoc vslice_dummy_var_181;
    call {:si_unique_call 1550} vslice_dummy_var_219 := sdv_IoCallDriver#0(vslice_dummy_var_181, Irp_45);
    goto anon15_Then, anon15_Else;
...
implementation {:origName "UniSetupSniffPart2"} UniSetupSniffPart2#0(actual_DeviceObject_43: int, actual_Irp_47: int, actual_Context_15: int) returns (Tmp_620: int)
{
  ...
  anon0:
    call {:si_unique_call 1551} newIrp_2 := __HAVOC_malloc(4);
    ...
    call {:si_unique_call 1552} sdv_380 := sdv_NT_ERROR(vslice_dummy_var_182);
    goto anon11_Then, anon11_Else;
  ...
  L15:
    ...
    call {:si_unique_call 1553} s_p_e_c_i_a_l_25 := sdv_IoGetCurrentIrpStackLocation(s_p_e_c_i_a_l_26);
    ...
    call {:si_unique_call 1554} UniGetNextIrp(vslice_dummy_var_183, DeviceLock__DEVICE_EXTENSION(extension_6), CurrentPassThrough__DEVICE_EXTENSION(extension_6), PassThroughQueue__DEVICE_EXTENSION(extension_6), newIrp_2, 1);
    goto anon13_Then, anon13_Else;
  ...
  anon12_Else:
    call {:si_unique_call 1555} vslice_dummy_var_220 := UniPassThroughStarter#0(extension_6);
    goto anon14_Then, anon14_Else;
  ...
  anon11_Then:
    assume {:partition} sdv_380 == 0;
    call {:si_unique_call 1556} UniSendOurWaitDown#0(extension_6);
    goto anon15_Then, anon15_Else;
...
implementation {:origName "UniSetupSniffPart2"} UniSetupSniffPart2#1(actual_DeviceObject_43: int, actual_Irp_47: int, actual_Context_15: int) returns (Tmp_620: int)
{
  ...
  anon0:
    call {:si_unique_call 1557} newIrp_2 := __HAVOC_malloc(4);
    Irp_47 := actual_Irp_47;
    Context_15 := actual_Context_15;
    extension_6 := Context_15;
    assume {:nonnull} Irp_47 != 0;
    ...
    call {:si_unique_call 1558} sdv_380 := sdv_NT_ERROR(vslice_dummy_var_184);
    goto anon11_Then, anon11_Else;
  ...
  L15:
    s_p_e_c_i_a_l_26 := Irp_47;
    s_p_e_c_i_a_l_27 := 2818056;
    call {:si_unique_call 1559} s_p_e_c_i_a_l_25 := sdv_IoGetCurrentIrpStackLocation(s_p_e_c_i_a_l_26);
    assume {:nonnull} s_p_e_c_i_a_l_25 != 0;
    assume s_p_e_c_i_a_l_25 > 0;
    assume {:nonnull} s_p_e_c_i_a_l_26 != 0;
    assume s_p_e_c_i_a_l_26 > 0;
    ...
    call {:si_unique_call 1560} UniGetNextIrp(vslice_dummy_var_185, DeviceLock__DEVICE_EXTENSION(extension_6), CurrentPassThrough__DEVICE_EXTENSION(extension_6), PassThroughQueue__DEVICE_EXTENSION(extension_6), newIrp_2, 1);
    goto anon13_Then, anon13_Else;
  ...
  anon12_Else:
    call {:si_unique_call 1561} vslice_dummy_var_221 := UniPassThroughStarter#1(extension_6);
    goto anon14_Then, anon14_Else;
  ...
  anon11_Then:
    assume {:partition} sdv_380 == 0;
    call {:si_unique_call 1562} UniSendOurWaitDown#1(extension_6);
    goto anon15_Then, anon15_Else;
...
implementation {:origName "UniSendOurWaitDown"} UniSendOurWaitDown#0(actual_Extension_9: int)
{
  ...
  anon0:
    call {:si_unique_call 1563} vslice_dummy_var_222 := __HAVOC_malloc(4);
    Extension_9 := actual_Extension_9;
    assume {:nonnull} Extension_9 != 0;
    assume Extension_9 > 0;
    call {:si_unique_call 1564} sdv_408 := _InlineInterlockedExchangePointer(xOurWaitIrp__DEVICE_EXTENSION(Extension_9), 0);
    irp_3 := sdv_408;
    call {:si_unique_call 1565} vslice_dummy_var_223 := sdv_IoGetCurrentIrpStackLocation(irp_3);
    call {:si_unique_call 1566} nextSp_11 := sdv_IoGetNextIrpStackLocation(irp_3);
    assume {:nonnull} irp_3 != 0;
    assume irp_3 > 0;
    s_p_e_c_i_a_l_35 := irp_3;
    call {:si_unique_call 1567} s_p_e_c_i_a_l_34 := sdv_IoGetCurrentIrpStackLocation(s_p_e_c_i_a_l_35);
    ...
    assume {:nonnull} irp_3 != 0;
    assume irp_3 > 0;
    call {:si_unique_call 1568} sdv_IoSetCompletionRoutine(irp_3, li2bplFunctionConstant945, Extension_9, 1, 1, 1);
    call {:si_unique_call 1569} Tmp_657 := __HAVOC_malloc(4);
    assume {:nonnull} Extension_9 != 0;
    assume Extension_9 > 0;
    ...
    call {:si_unique_call 1570} vslice_dummy_var_224 := sdv_InterlockedIncrement(Tmp_657);
    assume {:nonnull} Extension_9 != 0;
    assume Extension_9 > 0;
    assume {:nonnull} Tmp_657 != 0;
    assume Tmp_657 > 0;
...
implementation {:origName "UniSendOurWaitDown"} UniSendOurWaitDown#1(actual_Extension_9: int)
{
  ...
  anon0:
    call {:si_unique_call 1571} vslice_dummy_var_225 := __HAVOC_malloc(4);
    Extension_9 := actual_Extension_9;
    assume {:nonnull} Extension_9 != 0;
    assume Extension_9 > 0;
    call {:si_unique_call 1572} sdv_408 := _InlineInterlockedExchangePointer(xOurWaitIrp__DEVICE_EXTENSION(Extension_9), 0);
    irp_3 := sdv_408;
    call {:si_unique_call 1573} vslice_dummy_var_227 := sdv_IoGetCurrentIrpStackLocation(irp_3);
    call {:si_unique_call 1574} nextSp_11 := sdv_IoGetNextIrpStackLocation(irp_3);
    assume {:nonnull} irp_3 != 0;
    assume irp_3 > 0;
    s_p_e_c_i_a_l_35 := irp_3;
    call {:si_unique_call 1575} s_p_e_c_i_a_l_34 := sdv_IoGetCurrentIrpStackLocation(s_p_e_c_i_a_l_35);
    assume {:nonnull} s_p_e_c_i_a_l_34 != 0;
    assume s_p_e_c_i_a_l_34 > 0;
    assume {:nonnull} s_p_e_c_i_a_l_35 != 0;
    assume s_p_e_c_i_a_l_35 > 0;
    ...
    assume {:nonnull} irp_3 != 0;
    assume irp_3 > 0;
    call {:si_unique_call 1576} sdv_IoSetCompletionRoutine(irp_3, li2bplFunctionConstant945, Extension_9, 1, 1, 1);
    call {:si_unique_call 1577} Tmp_657 := __HAVOC_malloc(4);
    assume {:nonnull} Extension_9 != 0;
    assume Extension_9 > 0;
    assume {:nonnull} Tmp_657 != 0;
    assume Tmp_657 > 0;
    ...
    call {:si_unique_call 1578} vslice_dummy_var_228 := sdv_InterlockedIncrement(Tmp_657);
    assume {:nonnull} Extension_9 != 0;
    assume Extension_9 > 0;
    assume {:nonnull} Tmp_657 != 0;
    assume Tmp_657 > 0;
    ...
    call {:si_unique_call 1579} vslice_dummy_var_226 := sdv_IoCallDriver#0(vslice_dummy_var_188, irp_3);
    goto anon3_Then, anon3_Else;
...
implementation {:origName "UniSniffWaitComplete"} UniSniffWaitComplete#0(actual_DeviceObject_52: int, actual_Irp_57: int, actual_Context_20: int) returns (Tmp_677: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 1580} Tmp_678 := __HAVOC_malloc(72);
    call {:si_unique_call 1581} Tmp_681 := __HAVOC_malloc(72);
    call {:si_unique_call 1582} Tmp_683 := __HAVOC_malloc(72);
    call {:si_unique_call 1583} maskStates := __HAVOC_malloc(72);
    call {:si_unique_call 1584} Tmp_685 := __HAVOC_malloc(72);
    call {:si_unique_call 1585} Tmp_686 := __HAVOC_malloc(72);
    call {:si_unique_call 1586} Tmp_689 := __HAVOC_malloc(72);
    call {:si_unique_call 1587} Tmp_691 := __HAVOC_malloc(72);
    extension_10 := Context_20;
    assume {:nonnull} extension_10 != 0;
    assume extension_10 > 0;
    call {:si_unique_call 1588} Tmp_688 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_688 != 0;
    assume Tmp_688 > 0;
    Mem_T.INT4[Tmp_688] := origIrql_21;
    call {:si_unique_call 1589} sdv_KeAcquireSpinLock(0, Tmp_688);
    goto anon38_Then, anon38_Else;
  ...
  anon35_Else:
    ...
    havoc Tmp_691;
    Tmp_680 := Tmp_691;
    call {:si_unique_call 1590} UniPreProcessShuttledWaits(Tmp_680, Tmp_690, maskValue_4);
    call {:si_unique_call 1591} sdv_KeReleaseSpinLock(0, origIrql_21);
    goto anon37_Then, anon37_Else;
  ...
  anon37_Else:
    ...
    assume {:nonnull} extension_10 != 0;
    assume extension_10 > 0;
    call {:si_unique_call 1592} sdv_425 := _InlineInterlockedExchangePointer(xOurWaitIrp__DEVICE_EXTENSION(extension_10), 0);
    Irp_57 := sdv_425;
    assume {:nonnull} Irp_57 != 0;
    assume Irp_57 > 0;
    call {:si_unique_call 1593} vslice_dummy_var_229 := UniSetupNoPassPart1#0(DeviceObject_52, Irp_57, Context_20);
    goto anon39_Then, anon39_Else;
  ...
  L39:
    Tmp_684 := maskStates;
    call {:si_unique_call 1594} UniPostProcessShuttledWaits(extension_10, Tmp_684, maskValue_4);
    goto anon40_Then, anon40_Else;
  ...
  L43:
    ...
    call {:si_unique_call 1595} RemoveReference(vslice_dummy_var_189);
    Tmp_677 := -1073741802;
    goto LM2;
  ...
  anon37_Then:
    assume {:partition} BAND(maskValue_4, 48) == 0;
    call {:si_unique_call 1596} UniSendOurWaitDown#0(extension_10);
    goto anon41_Then, anon41_Else;
  ...
  anon36_Else:
    call {:si_unique_call 1597} sdv_KeReleaseSpinLock(0, origIrql_21);
  ...
  anon45_Else:
    ...
    havoc Tmp_683;
    Tmp_679 := Tmp_683;
    call {:si_unique_call 1600} UniChangeShuttledToPassDown#0(Tmp_679, origIrql_21);
    goto anon46_Then, anon46_Else;
  ...
  anon47_Else:
    ...
    call {:si_unique_call 1601} UniChangeShuttledToPassDown#0(Tmp_682, origIrql_21);
    goto anon48_Then, anon48_Else;
  ...
  anon47_Then:
    call {:si_unique_call 1602} sdv_KeReleaseSpinLock(0, origIrql_21);
    goto L43;
...
procedure {:origName "UniSniffWaitComplete"} UniSniffWaitComplete#0(actual_DeviceObject_52: int, actual_Irp_57: int, actual_Context_20: int) returns (Tmp_677: int);
  ...
  free ensures {:va_keep} sdv_irql_previous_5 == old(sdv_irql_previous_4) || sdv_irql_previous_5 == old(sdv_irql_previous_5) || sdv_irql_previous_5 == old(sdv_irql_previous_3) || sdv_irql_previous_5 == old(sdv_irql_previous_2);
  free ensures {:va_keep} sdv_irql_previous_4 == old(sdv_irql_previous_3) || sdv_irql_previous_4 == old(sdv_irql_previous_4) || sdv_irql_previous_4 == old(sdv_irql_previous_5) || sdv_irql_previous_4 == old(sdv_irql_previous_2);
  free ensures {:va_keep} sdv_irql_previous_3 == old(sdv_irql_previous_2) || sdv_irql_previous_3 == old(sdv_irql_previous_3) || sdv_irql_previous_3 == old(sdv_irql_previous_4) || sdv_irql_previous_3 == old(sdv_irql_previous) || sdv_irql_previous_3 == old(sdv_irql_previous_5);
  free ensures {:va_keep} yogi_error == 1 || yogi_error == old(yogi_error);
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);
...
implementation {:origName "UniSniffWaitComplete"} UniSniffWaitComplete#1(actual_DeviceObject_52: int, actual_Irp_57: int, actual_Context_20: int) returns (Tmp_677: int)
{
  ...
  anon0:
    ...
    Irp_57 := actual_Irp_57;
    Context_20 := actual_Context_20;
    call {:si_unique_call 1603} Tmp_678 := __HAVOC_malloc(72);
    call {:si_unique_call 1604} Tmp_681 := __HAVOC_malloc(72);
    call {:si_unique_call 1605} Tmp_683 := __HAVOC_malloc(72);
    call {:si_unique_call 1606} maskStates := __HAVOC_malloc(72);
    call {:si_unique_call 1607} Tmp_685 := __HAVOC_malloc(72);
    call {:si_unique_call 1608} Tmp_686 := __HAVOC_malloc(72);
    call {:si_unique_call 1609} Tmp_689 := __HAVOC_malloc(72);
    call {:si_unique_call 1610} Tmp_691 := __HAVOC_malloc(72);
    extension_10 := Context_20;
    assume {:nonnull} extension_10 != 0;
    assume extension_10 > 0;
    call {:si_unique_call 1611} Tmp_688 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_688 != 0;
    assume Tmp_688 > 0;
    Mem_T.INT4[Tmp_688] := origIrql_21;
    call {:si_unique_call 1612} sdv_KeAcquireSpinLock(0, Tmp_688);
    goto anon38_Then, anon38_Else;
  ...
  anon35_Else:
    ...
    havoc Tmp_691;
    Tmp_680 := Tmp_691;
    call {:si_unique_call 1613} UniPreProcessShuttledWaits(Tmp_680, Tmp_690, maskValue_4);
    call {:si_unique_call 1614} sdv_KeReleaseSpinLock(0, origIrql_21);
    goto anon37_Then, anon37_Else;
  ...
  anon37_Else:
    ...
    assume {:nonnull} extension_10 != 0;
    assume extension_10 > 0;
    call {:si_unique_call 1615} sdv_425 := _InlineInterlockedExchangePointer(xOurWaitIrp__DEVICE_EXTENSION(extension_10), 0);
    Irp_57 := sdv_425;
    assume {:nonnull} Irp_57 != 0;
    assume Irp_57 > 0;
    call {:si_unique_call 1616} vslice_dummy_var_230 := UniSetupNoPassPart1#1(DeviceObject_52, Irp_57, Context_20);
    goto anon39_Then, anon39_Else;
  ...
  L39:
    Tmp_684 := maskStates;
    call {:si_unique_call 1617} UniPostProcessShuttledWaits(extension_10, Tmp_684, maskValue_4);
    goto anon40_Then, anon40_Else;
  ...
  L43:
    ...
    call {:si_unique_call 1618} RemoveReference(vslice_dummy_var_190);
    Tmp_677 := -1073741802;
    goto LM2;
  ...
  anon37_Then:
    assume {:partition} BAND(maskValue_4, 48) == 0;
    call {:si_unique_call 1619} UniSendOurWaitDown#1(extension_10);
    goto anon41_Then, anon41_Else;
  ...
  anon36_Else:
    call {:si_unique_call 1620} sdv_KeReleaseSpinLock(0, origIrql_21);
  ...
  anon45_Else:
    ...
    havoc Tmp_683;
    Tmp_679 := Tmp_683;
    call {:si_unique_call 1623} UniChangeShuttledToPassDown#1(Tmp_679, origIrql_21);
    goto anon46_Then, anon46_Else;
  ...
  anon47_Else:
    ...
    havoc Tmp_689;
    Tmp_682 := Tmp_689 + 1 * 36;
    call {:si_unique_call 1624} UniChangeShuttledToPassDown#1(Tmp_682, origIrql_21);
    goto anon48_Then, anon48_Else;
  ...
  anon47_Then:
    call {:si_unique_call 1625} sdv_KeReleaseSpinLock(0, origIrql_21);
    goto L43;
...
implementation {:origName "UniStopReceiveComplete"} UniStopReceiveComplete#0(actual_DeviceObject: int, actual_Irp_4: int, actual_Context: int) returns (Tmp_35: int)
{
  ...
  anon0:
    ...
    assume {:nonnull} DeviceExtension_2 != 0;
    assume DeviceExtension_2 > 0;
    call {:si_unique_call 1626} vslice_dummy_var_231 := KeInsertQueueDpc#0(WaveStopDpc__DEVICE_EXTENSION(DeviceExtension_2), Irp_4, DeviceExtension_2);
    goto anon3_Then, anon3_Else;
...
procedure {:origName "UniStopReceiveComplete"} UniStopReceiveComplete#0(actual_DeviceObject: int, actual_Irp_4: int, actual_Context: int) returns (Tmp_35: int);
  modifies alloc, sdv_irql_previous_5, sdv_irql_previous_4, sdv_irql_previous_3, sdv_irql_previous_2, sdv_irql_previous, sdv_irql_current, Mem_T.INT4, yogi_error;
  free ensures {:va_keep} yogi_error == 0;
  free ensures {:va_keep} sdv_irql_previous_5 == old(sdv_irql_previous_5) || sdv_irql_previous_5 == old(sdv_irql_previous_2) || sdv_irql_previous_5 == old(sdv_irql_previous_3) || sdv_irql_previous_5 == old(sdv_irql_previous_4);
  free ensures {:va_keep} sdv_irql_previous_2 == old(sdv_irql_previous_2) || sdv_irql_previous_2 == old(sdv_irql_previous) || sdv_irql_previous_2 == old(sdv_irql_current) || sdv_irql_previous_2 == old(sdv_irql_previous_3);
  free ensures {:va_keep} sdv_irql_previous == 2 || sdv_irql_previous == old(sdv_irql_previous) || sdv_irql_previous == old(sdv_irql_current) || sdv_irql_previous == old(sdv_irql_previous_2);
  ...
  free ensures {:va_keep} sdv_irql_previous_3 == old(sdv_irql_previous_3) || sdv_irql_previous_3 == old(sdv_irql_previous_2) || sdv_irql_previous_3 == old(sdv_irql_previous) || sdv_irql_previous_3 == old(sdv_irql_previous_4);
  free ensures {:va_keep} yogi_error == 1 || yogi_error == old(yogi_error);
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);
...
implementation {:origName "UniStopReceiveComplete"} UniStopReceiveComplete#1(actual_DeviceObject: int, actual_Irp_4: int, actual_Context: int) returns (Tmp_35: int)
{
  ...
  anon0:
    ...
    assume {:nonnull} DeviceExtension_2 != 0;
    assume DeviceExtension_2 > 0;
    call {:si_unique_call 1627} vslice_dummy_var_232 := KeInsertQueueDpc#1(WaveStopDpc__DEVICE_EXTENSION(DeviceExtension_2), Irp_4, DeviceExtension_2);
    goto anon3_Then, anon3_Else;
...
implementation {:origName "KeInsertQueueDpc"} {:osmodel} KeInsertQueueDpc#0(actual_Dpc_1: int, actual_SystemArgument1: int, actual_SystemArgument2: int) returns (Tmp_349: int)
{
  ...
  anon5_Then:
    ...
    call {:si_unique_call 1628} sdv_RunKeDpcRoutines#0(vslice_dummy_var_191, sdv_pDpcContext, 0, 0);
    goto anon6_Then, anon6_Else;
...
implementation {:origName "KeInsertQueueDpc"} {:osmodel} KeInsertQueueDpc#1(actual_Dpc_1: int, actual_SystemArgument1: int, actual_SystemArgument2: int) returns (Tmp_349: int)
{
  ...
  anon5_Then:
    ...
    call {:si_unique_call 1629} sdv_RunKeDpcRoutines#1(vslice_dummy_var_192, sdv_pDpcContext, 0, 0);
    goto anon6_Then, anon6_Else;
...
implementation {:origName "sdv_RunKeDpcRoutines"} {:osmodel} sdv_RunKeDpcRoutines#0(actual_kdpc: int, actual_pDpcContext: int, actual_pv2: int, actual_pv3: int)
{
  ...
  anon0:
    call {:si_unique_call 1630} vslice_dummy_var_233 := __HAVOC_malloc(4);
    kdpc := actual_kdpc;
  ...
  anon8_Else:
    ...
    sdv_irql_previous := sdv_irql_current;
    sdv_irql_current := 2;
    call {:si_unique_call 1631} WaveStopDpcHandler#0(kdpc, pDpcContext, sdv_pv2, sdv_pv3);
    goto anon9_Then, anon9_Else;
...
procedure {:origName "sdv_RunKeDpcRoutines"} {:osmodel} sdv_RunKeDpcRoutines#0(actual_kdpc: int, actual_pDpcContext: int, actual_pv2: int, actual_pv3: int);
  ...
  free ensures {:va_keep} sdv_irql_previous == 2 || sdv_irql_previous == old(sdv_irql_current) || sdv_irql_previous == old(sdv_irql_previous) || sdv_irql_previous == old(sdv_irql_previous_2);
...
implementation {:origName "sdv_RunKeDpcRoutines"} {:osmodel} sdv_RunKeDpcRoutines#1(actual_kdpc: int, actual_pDpcContext: int, actual_pv2: int, actual_pv3: int)
{
  ...
  anon0:
    call {:si_unique_call 1632} vslice_dummy_var_234 := __HAVOC_malloc(4);
    kdpc := actual_kdpc;
    pDpcContext := actual_pDpcContext;
    assume {:nonnull} kdpc != 0;
    assume kdpc > 0;
  ...
  anon8_Else:
    ...
    sdv_irql_previous := sdv_irql_current;
    sdv_irql_current := 2;
    call {:si_unique_call 1633} WaveStopDpcHandler#1(kdpc, pDpcContext, sdv_pv2, sdv_pv3);
    goto anon9_Then, anon9_Else;
...
implementation {:origName "UniWriteComplete"} UniWriteComplete#0(actual_DeviceObject_40: int, actual_Irp_43: int, actual_Context_12: int) returns (Tmp_603: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 1634} irpSp_23 := sdv_IoGetCurrentIrpStackLocation(Irp_43);
    call {:si_unique_call 1635} nextSp_5 := sdv_IoGetNextIrpStackLocation(Irp_43);
  ...
  L32:
    call {:si_unique_call 1636} UniWriteComplete#0_loop_L32(Buffer_2, BufferEnd);
    goto L32_last;
  ...
  anon27_Else:
    call {:si_unique_call 1637} sdv_IoSetCompletionRoutine(Irp_43, li2bplFunctionConstant1122, Control_4, 1, 1, 1);
    assume {:nonnull} Control_4 != 0;
    assume Control_4 > 0;
    assume false;
    return;
  ...
  L46:
    ...
    assume {:nonnull} Irp_43 != 0;
    assume Irp_43 > 0;
    call {:si_unique_call 1638} StartNextReadWriteIrp(Control_4);
    goto anon29_Then, anon29_Else;

  anon29_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 1639} RemoveReference(DeviceObject_40);
    Tmp_603 := 0;
    goto L1;
...
implementation {:origName "UniWriteComplete"} UniWriteComplete#1(actual_DeviceObject_40: int, actual_Irp_43: int, actual_Context_12: int) returns (Tmp_603: int)
{
  ...
  anon0:
    ...
    assume DeviceObject_40 > 0;
    havoc deviceExtension_13;
    call {:si_unique_call 1640} irpSp_23 := sdv_IoGetCurrentIrpStackLocation(Irp_43);
    call {:si_unique_call 1641} nextSp_5 := sdv_IoGetNextIrpStackLocation(Irp_43);
    assume {:nonnull} irpSp_23 != 0;
    assume irpSp_23 > 0;
    goto anon21_Then, anon21_Else;
  ...
  L32:
    call {:si_unique_call 1642} UniWriteComplete#1_loop_L32(Buffer_2, BufferEnd);
    goto L32_last;
  ...
  anon27_Else:
    call {:si_unique_call 1643} sdv_IoSetCompletionRoutine(Irp_43, li2bplFunctionConstant1122, Control_4, 1, 1, 1);
    assume {:nonnull} Control_4 != 0;
    assume Control_4 > 0;
    havoc vslice_dummy_var_193;
    call {:si_unique_call 1644} vslice_dummy_var_235 := sdv_IoCallDriver#0(vslice_dummy_var_193, Irp_43);
    goto anon30_Then, anon30_Else;
  ...
  L46:
    ...
    assume {:nonnull} Irp_43 != 0;
    assume Irp_43 > 0;
    call {:si_unique_call 1645} StartNextReadWriteIrp(Control_4);
    goto anon29_Then, anon29_Else;

  anon29_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 1646} RemoveReference(DeviceObject_40);
    Tmp_603 := 0;
    goto L1;
...
implementation {:origName "HandleIpc"} HandleIpc#0(actual_DeviceExtension: int)
{
  ...
  anon0:
    call {:si_unique_call 1647} vslice_dummy_var_236 := __HAVOC_malloc(4);
    DeviceExtension := actual_DeviceExtension;
    call {:si_unique_call 1648} Tmp_16 := __HAVOC_malloc(48);
    call {:si_unique_call 1649} Tmp_17 := __HAVOC_malloc(48);
    call {:si_unique_call 1650} Tmp_22 := __HAVOC_malloc(48);
    call {:si_unique_call 1651} Tmp_25 := __HAVOC_malloc(48);
    call {:si_unique_call 1652} Tmp_27 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_27 != 0;
    assume Tmp_27 > 0;
    Mem_T.INT4[Tmp_27] := origIrql_2;
    call {:si_unique_call 1653} sdv_KeAcquireSpinLock(0, Tmp_27);
    goto anon24_Then, anon24_Else;
  ...
  anon19_Else:
    ...
    call {:si_unique_call 1655} Tmp_27 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_27 != 0;
    assume Tmp_27 > 0;
    Mem_T.INT4[Tmp_27] := CancelIrql_2;
    call {:si_unique_call 1656} IoAcquireCancelSpinLock(Tmp_27);
    assume {:nonnull} Tmp_27 != 0;
    assume Tmp_27 > 0;
    ...
    call {:si_unique_call 1657} GetIrp := GetUsableIrp(Tmp_23);
    goto anon20_Then, anon20_Else;
  ...
  anon20_Else:
    ...
    call {:si_unique_call 1658} PutIrp := GetUsableIrp(Tmp_18);
    goto anon21_Then, anon21_Else;

  anon21_Else:
    assume {:partition} PutIrp != 0;
    call {:si_unique_call 1659} vslice_dummy_var_237 := sdv_IoSetCancelRoutine(GetIrp, 0);
    call {:si_unique_call 1660} vslice_dummy_var_238 := sdv_IoSetCancelRoutine(PutIrp, 0);
    call {:si_unique_call 1661} IoReleaseCancelSpinLock(CancelIrql_2);
    call {:si_unique_call 1662} sdv_KeReleaseSpinLock(0, origIrql_2);
    call {:si_unique_call 1663} sdv_10 := sdv_IoGetCurrentIrpStackLocation(PutIrp);
    call {:si_unique_call 1664} sdv_5 := sdv_IoGetCurrentIrpStackLocation(GetIrp);
  ...
  anon22_Else:
    call {:si_unique_call 1665} sdv_7 := sdv_IoGetCurrentIrpStackLocation(PutIrp);
  ...
  L64:
    BytesToCopy := Tmp_29;
    call {:si_unique_call 1666} sdv_RtlCopyMemory(0, 0, BytesToCopy);
    assume {:nonnull} GetIrp != 0;
    assume GetIrp > 0;
    assume {:nonnull} DeviceExtension != 0;
    assume DeviceExtension > 0;
    havoc vslice_dummy_var_194;
    call {:si_unique_call 1667} RemoveReferenceAndCompleteRequest(vslice_dummy_var_194, GetIrp, 0);
    call {:si_unique_call 1668} sdv_6 := sdv_IoGetCurrentIrpStackLocation(PutIrp);
    assume {:nonnull} sdv_6 != 0;
    assume sdv_6 > 0;
    goto anon23_Then, anon23_Else;

  anon23_Else:
    call {:si_unique_call 1669} Tmp_27 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_27 != 0;
    assume Tmp_27 > 0;
    Mem_T.INT4[Tmp_27] := origIrql_2;
    call {:si_unique_call 1670} sdv_KeAcquireSpinLock(0, Tmp_27);
    goto anon25_Then, anon25_Else;
  ...
  anon25_Else:
    ...
    assume {:nonnull} PutIrp != 0;
    assume PutIrp > 0;
    call {:si_unique_call 1671} vslice_dummy_var_240 := sdv_InsertTailList(Tmp_30, ListEntry_unnamed_tag_6(Overlay_unnamed_tag_5(Tail__IRP(PutIrp))));
    call {:si_unique_call 1672} Tmp_27 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_27 != 0;
    assume Tmp_27 > 0;
    Mem_T.INT4[Tmp_27] := CancelIrql_2;
    call {:si_unique_call 1673} IoAcquireCancelSpinLock(Tmp_27);
    assume {:nonnull} Tmp_27 != 0;
    assume Tmp_27 > 0;
    CancelIrql_2 := Mem_T.INT4[Tmp_27];
    call {:si_unique_call 1674} vslice_dummy_var_239 := sdv_IoSetCancelRoutine(PutIrp, li2bplFunctionConstant587);
    call {:si_unique_call 1675} IoReleaseCancelSpinLock(CancelIrql_2);
    call {:si_unique_call 1676} sdv_KeReleaseSpinLock(0, origIrql_2);
    assume false;
    return;
  ...
  anon23_Then:
    ...
    call {:si_unique_call 1677} RemoveReferenceAndCompleteRequest(vslice_dummy_var_195, PutIrp, 0);
    goto L100;
  ...
  anon22_Then:
    call {:si_unique_call 1680} sdv_12 := sdv_IoGetCurrentIrpStackLocation(GetIrp);
  ...
  anon21_Then:
    ...
    assume {:nonnull} GetIrp != 0;
    assume GetIrp > 0;
    call {:si_unique_call 1681} InsertHeadList(Tmp_19, ListEntry_unnamed_tag_6(Overlay_unnamed_tag_5(Tail__IRP(GetIrp))));
    call {:si_unique_call 1682} IoReleaseCancelSpinLock(CancelIrql_2);
    goto L103;

  anon20_Then:
    assume {:partition} GetIrp == 0;
    call {:si_unique_call 1683} IoReleaseCancelSpinLock(CancelIrql_2);
    goto L103;

  anon19_Then:
    assume {:partition} Source >= 2;
    call {:si_unique_call 1684} sdv_KeReleaseSpinLock(0, origIrql_2);
    goto LM2;
...
implementation {:origName "HandleIpc"} HandleIpc#1(actual_DeviceExtension: int)
{
  ...
  anon0:
    call {:si_unique_call 1685} vslice_dummy_var_241 := __HAVOC_malloc(4);
    DeviceExtension := actual_DeviceExtension;
    call {:si_unique_call 1686} Tmp_16 := __HAVOC_malloc(48);
    call {:si_unique_call 1687} Tmp_17 := __HAVOC_malloc(48);
    call {:si_unique_call 1688} Tmp_22 := __HAVOC_malloc(48);
    call {:si_unique_call 1689} Tmp_25 := __HAVOC_malloc(48);
    call {:si_unique_call 1690} Tmp_27 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_27 != 0;
    assume Tmp_27 > 0;
    Mem_T.INT4[Tmp_27] := origIrql_2;
    call {:si_unique_call 1691} sdv_KeAcquireSpinLock(0, Tmp_27);
    goto anon24_Then, anon24_Else;
  ...
  anon19_Else:
    assume {:partition} 2 > Source;
    call {:si_unique_call 1693} Tmp_27 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_27 != 0;
    assume Tmp_27 > 0;
    Mem_T.INT4[Tmp_27] := CancelIrql_2;
    call {:si_unique_call 1694} IoAcquireCancelSpinLock(Tmp_27);
    assume {:nonnull} Tmp_27 != 0;
    assume Tmp_27 > 0;
    CancelIrql_2 := Mem_T.INT4[Tmp_27];
    Tmp_24 := Sink;
    ...
    assume Tmp_22 > 0;
    Tmp_23 := GetList__IPC_CONTROL(Tmp_22 + Tmp_24 * 24);
    call {:si_unique_call 1695} GetIrp := GetUsableIrp(Tmp_23);
    goto anon20_Then, anon20_Else;
  ...
  anon20_Else:
    ...
    assume Tmp_16 > 0;
    Tmp_18 := PutList__IPC_CONTROL(Tmp_16 + Tmp_26 * 24);
    call {:si_unique_call 1696} PutIrp := GetUsableIrp(Tmp_18);
    goto anon21_Then, anon21_Else;

  anon21_Else:
    assume {:partition} PutIrp != 0;
    call {:si_unique_call 1697} vslice_dummy_var_242 := sdv_IoSetCancelRoutine(GetIrp, 0);
    call {:si_unique_call 1698} vslice_dummy_var_243 := sdv_IoSetCancelRoutine(PutIrp, 0);
    call {:si_unique_call 1699} IoReleaseCancelSpinLock(CancelIrql_2);
    call {:si_unique_call 1700} sdv_KeReleaseSpinLock(0, origIrql_2);
    call {:si_unique_call 1701} sdv_10 := sdv_IoGetCurrentIrpStackLocation(PutIrp);
    call {:si_unique_call 1702} sdv_5 := sdv_IoGetCurrentIrpStackLocation(GetIrp);
    assume {:nonnull} sdv_10 != 0;
    assume sdv_10 > 0;
    assume {:nonnull} sdv_5 != 0;
    assume sdv_5 > 0;
  ...
  anon22_Else:
    call {:si_unique_call 1703} sdv_7 := sdv_IoGetCurrentIrpStackLocation(PutIrp);
    assume {:nonnull} sdv_7 != 0;
    assume sdv_7 > 0;
    havoc Tmp_29;
    goto L64;
  ...
  L64:
    BytesToCopy := Tmp_29;
    call {:si_unique_call 1704} sdv_RtlCopyMemory(0, 0, BytesToCopy);
    assume {:nonnull} GetIrp != 0;
    assume GetIrp > 0;
    assume {:nonnull} DeviceExtension != 0;
    assume DeviceExtension > 0;
    havoc vslice_dummy_var_196;
    call {:si_unique_call 1705} RemoveReferenceAndCompleteRequest(vslice_dummy_var_196, GetIrp, 0);
    call {:si_unique_call 1706} sdv_6 := sdv_IoGetCurrentIrpStackLocation(PutIrp);
    assume {:nonnull} sdv_6 != 0;
    assume sdv_6 > 0;
    goto anon23_Then, anon23_Else;

  anon23_Else:
    call {:si_unique_call 1707} Tmp_27 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_27 != 0;
    assume Tmp_27 > 0;
    Mem_T.INT4[Tmp_27] := origIrql_2;
    call {:si_unique_call 1708} sdv_KeAcquireSpinLock(0, Tmp_27);
    goto anon25_Then, anon25_Else;
  ...
  anon25_Else:
    ...
    assume {:nonnull} PutIrp != 0;
    assume PutIrp > 0;
    call {:si_unique_call 1709} vslice_dummy_var_245 := sdv_InsertTailList(Tmp_30, ListEntry_unnamed_tag_6(Overlay_unnamed_tag_5(Tail__IRP(PutIrp))));
    call {:si_unique_call 1710} Tmp_27 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_27 != 0;
    assume Tmp_27 > 0;
    Mem_T.INT4[Tmp_27] := CancelIrql_2;
    call {:si_unique_call 1711} IoAcquireCancelSpinLock(Tmp_27);
    assume {:nonnull} Tmp_27 != 0;
    assume Tmp_27 > 0;
    CancelIrql_2 := Mem_T.INT4[Tmp_27];
    call {:si_unique_call 1712} vslice_dummy_var_244 := sdv_IoSetCancelRoutine(PutIrp, li2bplFunctionConstant587);
    call {:si_unique_call 1713} IoReleaseCancelSpinLock(CancelIrql_2);
    call {:si_unique_call 1714} sdv_KeReleaseSpinLock(0, origIrql_2);
    call {:si_unique_call 1715} HandleIpc#0(DeviceExtension);
    goto anon26_Then, anon26_Else;
  ...
  anon23_Then:
    ...
    call {:si_unique_call 1718} RemoveReferenceAndCompleteRequest(vslice_dummy_var_197, PutIrp, 0);
    goto L100;

  anon22_Then:
    call {:si_unique_call 1719} sdv_12 := sdv_IoGetCurrentIrpStackLocation(GetIrp);
    assume {:nonnull} sdv_12 != 0;
    assume sdv_12 > 0;
    havoc Tmp_29;
    goto L64;
  ...
  anon21_Then:
    ...
    assume {:nonnull} GetIrp != 0;
    assume GetIrp > 0;
    call {:si_unique_call 1720} InsertHeadList(Tmp_19, ListEntry_unnamed_tag_6(Overlay_unnamed_tag_5(Tail__IRP(GetIrp))));
    call {:si_unique_call 1721} IoReleaseCancelSpinLock(CancelIrql_2);
    goto L103;

  anon20_Then:
    assume {:partition} GetIrp == 0;
    call {:si_unique_call 1722} IoReleaseCancelSpinLock(CancelIrql_2);
    goto L103;

  anon19_Then:
    assume {:partition} Source >= 2;
    call {:si_unique_call 1723} sdv_KeReleaseSpinLock(0, origIrql_2);
    goto LM2;
...
implementation GetUsableIrp_loop_L5(in_Irp_2: int, in_sdv_14: int, in_sdv_16: int, in_ListElement: int, in_List: int) returns (out_Irp_2: int, out_sdv_14: int, out_sdv_16: int, out_ListElement: int)
{
  ...
  L5:
    call {:si_unique_call 1724} out_sdv_14 := sdv_IsListEmpty(0);
    goto anon5_Then;

  anon5_Then:
    assume {:partition} out_sdv_14 == 0;
    call {:si_unique_call 1725} out_ListElement := RemoveTailList(in_List);
    call {:si_unique_call 1726} out_sdv_16 := sdv_containing_record(out_ListElement, 88);
  ...
  anon6_Else_dummy:
    call {:si_unique_call 1727} {:si_old_unique_call 1} out_Irp_2, out_sdv_14, out_sdv_16, out_ListElement := GetUsableIrp_loop_L5(out_Irp_2, out_sdv_14, out_sdv_16, out_ListElement, in_List);
    return;
}
...
implementation EmptyIpcQueue_loop_L16(in_Irp_3: int, in_Tmp_33: int, in_origIrql_3: int, in_CancelIrql_3: int, in_DeviceExtension_1: int, in_List_1: int, in_vslice_dummy_var_8: int) returns (out_Irp_3: int, out_Tmp_33: int, out_origIrql_3: int, out_CancelIrql_3: int, out_vslice_dummy_var_8: int)
{
  ...
  anon7_Else:
    ...
    call {:si_unique_call 1731} out_vslice_dummy_var_8 := sdv_IoSetCancelRoutine(out_Irp_3, 0);
    call {:si_unique_call 1732} IoReleaseCancelSpinLock(out_CancelIrql_3);
    call {:si_unique_call 1733} sdv_KeReleaseSpinLock(0, out_origIrql_3);
    assume {:nonnull} out_Irp_3 != 0;
    assume out_Irp_3 > 0;
    assume {:nonnull} in_DeviceExtension_1 != 0;
    assume in_DeviceExtension_1 > 0;
    havoc vslice_dummy_var_198;
    call {:si_unique_call 1734} RemoveReferenceAndCompleteRequest(vslice_dummy_var_198, out_Irp_3, -1073741536);
    call {:si_unique_call 1735} out_Tmp_33 := __HAVOC_malloc(4);
    assume {:nonnull} out_Tmp_33 != 0;
    assume out_Tmp_33 > 0;
    Mem_T.INT4[out_Tmp_33] := out_origIrql_3;
    call {:si_unique_call 1736} sdv_KeAcquireSpinLock(0, out_Tmp_33);
    goto anon9_Else;
  ...
  anon9_Else:
    ...
    call {:si_unique_call 1728} out_Tmp_33 := __HAVOC_malloc(4);
    assume {:nonnull} out_Tmp_33 != 0;
    assume out_Tmp_33 > 0;
    Mem_T.INT4[out_Tmp_33] := out_CancelIrql_3;
    call {:si_unique_call 1729} IoAcquireCancelSpinLock(out_Tmp_33);
    assume {:nonnull} out_Tmp_33 != 0;
    assume out_Tmp_33 > 0;
    out_CancelIrql_3 := Mem_T.INT4[out_Tmp_33];
    call {:si_unique_call 1730} out_Irp_3 := GetUsableIrp(in_List_1);
    goto anon9_Else_dummy;

  anon9_Else_dummy:
    call {:si_unique_call 1737} {:si_old_unique_call 1} out_Irp_3, out_Tmp_33, out_origIrql_3, out_CancelIrql_3, out_vslice_dummy_var_8 := EmptyIpcQueue_loop_L16(out_Irp_3, out_Tmp_33, out_origIrql_3, out_CancelIrql_3, in_DeviceExtension_1, in_List_1, out_vslice_dummy_var_8);
    return;
}
...
implementation UniMaskStarter_loop_L6(in_Tmp_138: int, in_otherMaskState: int, in_Tmp_139: int, in_maskValue_2: int, in_Tmp_140: int, in_Tmp_141: int, in_irpSp_6: int, in_thisMaskState: int, in_Tmp_142: int, in_Tmp_143: int, in_Tmp_144: int, in_Tmp_145: int, in_Tmp_146: int, in_Tmp_147: int, in_newIrp: int, in_Tmp_148: int, in_ownerHandle: int, in_Tmp_149: int, in_Tmp_150: int, in_origIrql_6: int, in_Tmp_151: int, in_Tmp_152: int, in_maskValue_3: int, in_Tmp_153: int, in_origMask: int, in_Tmp_154: int, in_savedIrp_2: int, in_Tmp_155: int, in_Tmp_156: int, in_Tmp_157: int, in_Tmp_158: int, in_Extension_3: int, in_vslice_dummy_var_18: int, in_vslice_dummy_var_19: int, in_vslice_dummy_var_20: int) returns (out_Tmp_138: int, out_otherMaskState: int, out_Tmp_139: int, out_maskValue_2: int, out_Tmp_140: int, out_Tmp_141: int, out_irpSp_6: int, out_thisMaskState: int, out_Tmp_142: int, out_Tmp_143: int, out_Tmp_144: int, out_Tmp_145: int, out_Tmp_146: int, out_Tmp_147: int, out_Tmp_148: int, out_ownerHandle: int, out_Tmp_149: int, out_Tmp_150: int, out_origIrql_6: int, out_Tmp_151: int, out_Tmp_152: int, out_maskValue_3: int, out_Tmp_153: int, out_origMask: int, out_Tmp_154: int, out_savedIrp_2: int, out_Tmp_155: int, out_Tmp_156: int, out_Tmp_157: int, out_Tmp_158: int, out_vslice_dummy_var_18: int, out_vslice_dummy_var_19: int, out_vslice_dummy_var_20: int)
{
  ...
  L6:
    ...
    call {:si_unique_call 1738} out_irpSp_6 := sdv_IoGetCurrentIrpStackLocation(vslice_dummy_var_199);
    assume {:nonnull} in_Extension_3 != 0;
    assume in_Extension_3 > 0;
    havoc out_Tmp_143;
  ...
  anon66_Else:
    ...
    call {:si_unique_call 1766} UniGetNextIrp(vslice_dummy_var_220, DeviceLock__DEVICE_EXTENSION(in_Extension_3), CurrentMaskOp__DEVICE_EXTENSION(in_Extension_3), MaskOps__DEVICE_EXTENSION(in_Extension_3), in_newIrp, 1);
    goto anon83_Else;
  ...
  anon66_Then:
    ...
    call {:si_unique_call 1761} sdv_IoCopyCurrentIrpStackLocationToNext(vslice_dummy_var_217);
    assume {:nonnull} in_Extension_3 != 0;
    assume in_Extension_3 > 0;
    havoc vslice_dummy_var_218;
    call {:si_unique_call 1762} sdv_IoSetCompletionRoutine(vslice_dummy_var_218, li2bplFunctionConstant1477, out_thisMaskState, 1, 1, 1);
    assume {:nonnull} in_Extension_3 != 0;
    assume in_Extension_3 > 0;
    havoc vslice_dummy_var_219;
    call {:si_unique_call 1763} UNI_SAVE_OLD_SETMASK(vslice_dummy_var_219);
    call {:si_unique_call 1764} out_Tmp_156 := __HAVOC_malloc(4);
    assume {:nonnull} out_Tmp_156 != 0;
    assume out_Tmp_156 > 0;
    Mem_T.INT4[out_Tmp_156] := out_origIrql_6;
    call {:si_unique_call 1765} sdv_KeAcquireSpinLock(0, out_Tmp_156);
    goto anon84_Else;
  ...
  anon85_Else:
    ...
    assume {:nonnull} out_thisMaskState != 0;
    assume out_thisMaskState > 0;
    call {:si_unique_call 1758} UniRundownShuttledWait(in_Extension_3, ShuttledWait__MASKSTATE(out_thisMaskState), 1, out_savedIrp_2, out_origIrql_6, 0, 0);
    goto L58;
  ...
  L58:
    ...
    call {:si_unique_call 1757} out_vslice_dummy_var_18 := sdv_IoCallDriver#1(vslice_dummy_var_214, vslice_dummy_var_215);
    goto anon86_Else;
  ...
  anon86_Else:
    ...
    call {:si_unique_call 1756} UniGetNextIrp(vslice_dummy_var_213, DeviceLock__DEVICE_EXTENSION(in_Extension_3), CurrentMaskOp__DEVICE_EXTENSION(in_Extension_3), MaskOps__DEVICE_EXTENSION(in_Extension_3), in_newIrp, 0);
    goto anon87_Else;
  ...
  anon69_Else:
    call {:si_unique_call 1760} SetPassdownToComplete(out_thisMaskState);
    goto L65;

  L65:
    call {:si_unique_call 1759} sdv_KeReleaseSpinLock(0, out_origIrql_6);
    goto L58;
  ...
  anon65_Else:
    ...
    call {:si_unique_call 1755} UniGetNextIrp(vslice_dummy_var_212, DeviceLock__DEVICE_EXTENSION(in_Extension_3), CurrentMaskOp__DEVICE_EXTENSION(in_Extension_3), MaskOps__DEVICE_EXTENSION(in_Extension_3), in_newIrp, 1);
    goto anon88_Else;
  ...
  L81:
    ...
    call {:si_unique_call 1754} UniGetNextIrp(vslice_dummy_var_211, DeviceLock__DEVICE_EXTENSION(in_Extension_3), CurrentMaskOp__DEVICE_EXTENSION(in_Extension_3), MaskOps__DEVICE_EXTENSION(in_Extension_3), in_newIrp, 1);
    goto anon96_Else;
  ...
  L88:
    call {:si_unique_call 1745} out_Tmp_156 := __HAVOC_malloc(4);
    assume {:nonnull} out_Tmp_156 != 0;
    assume out_Tmp_156 > 0;
    Mem_T.INT4[out_Tmp_156] := out_origIrql_6;
    call {:si_unique_call 1746} sdv_KeAcquireSpinLock(0, out_Tmp_156);
    goto anon89_Else;
  ...
  L93:
    call {:si_unique_call 1752} sdv_KeReleaseSpinLock(0, out_origIrql_6);
    assume {:nonnull} in_Extension_3 != 0;
    assume in_Extension_3 > 0;
    havoc out_Tmp_140;
    ...
    call {:si_unique_call 1753} UniGetNextIrp(vslice_dummy_var_210, DeviceLock__DEVICE_EXTENSION(in_Extension_3), CurrentMaskOp__DEVICE_EXTENSION(in_Extension_3), MaskOps__DEVICE_EXTENSION(in_Extension_3), in_newIrp, 1);
    goto anon90_Else;
  ...
  anon77_Else:
    ...
    Mem_T.INT4[out_maskValue_3] := vslice_dummy_var_208;
    assume {:nonnull} out_thisMaskState != 0;
    assume out_thisMaskState > 0;
    call {:si_unique_call 1750} sdv_KeReleaseSpinLock(0, out_origIrql_6);
    assume {:nonnull} in_Extension_3 != 0;
    assume in_Extension_3 > 0;
    havoc vslice_dummy_var_209;
    call {:si_unique_call 1751} UniGetNextIrp(vslice_dummy_var_209, DeviceLock__DEVICE_EXTENSION(in_Extension_3), CurrentMaskOp__DEVICE_EXTENSION(in_Extension_3), MaskOps__DEVICE_EXTENSION(in_Extension_3), in_newIrp, 1);
    goto anon91_Else;
  ...
  anon78_Else:
    ...
    call {:si_unique_call 1748} sdv_KeReleaseSpinLock(0, out_origIrql_6);
    assume {:nonnull} in_Extension_3 != 0;
    assume in_Extension_3 > 0;
    havoc vslice_dummy_var_207;
    call {:si_unique_call 1749} UniGetNextIrp(vslice_dummy_var_207, DeviceLock__DEVICE_EXTENSION(in_Extension_3), CurrentMaskOp__DEVICE_EXTENSION(in_Extension_3), MaskOps__DEVICE_EXTENSION(in_Extension_3), in_newIrp, 1);
    goto anon92_Else;
  ...
  L131:
    ...
    call {:si_unique_call 1747} out_vslice_dummy_var_19 := UniMakeIrpShuttledWait(out_thisMaskState, vslice_dummy_var_206, out_origIrql_6, 1, in_newIrp);
    goto anon93_Else;
  ...
  anon80_Else:
    ...
    call {:si_unique_call 1740} MakeIrpCurrentPassedDown(out_thisMaskState, vslice_dummy_var_201);
    call {:si_unique_call 1741} sdv_KeReleaseSpinLock(0, out_origIrql_6);
    assume {:nonnull} in_Extension_3 != 0;
    assume in_Extension_3 > 0;
    havoc vslice_dummy_var_202;
    call {:si_unique_call 1742} sdv_IoCopyCurrentIrpStackLocationToNext(vslice_dummy_var_202);
    assume {:nonnull} in_Extension_3 != 0;
    assume in_Extension_3 > 0;
    havoc vslice_dummy_var_203;
    call {:si_unique_call 1743} sdv_IoSetCompletionRoutine(vslice_dummy_var_203, li2bplFunctionConstant1478, out_thisMaskState, 1, 1, 1);
    assume {:nonnull} in_Extension_3 != 0;
    assume in_Extension_3 > 0;
    havoc vslice_dummy_var_204;
    havoc vslice_dummy_var_205;
    call {:si_unique_call 1744} out_vslice_dummy_var_20 := sdv_IoCallDriver#1(vslice_dummy_var_204, vslice_dummy_var_205);
    goto anon94_Else;
  ...
  anon94_Else:
    ...
    call {:si_unique_call 1739} UniGetNextIrp(vslice_dummy_var_200, DeviceLock__DEVICE_EXTENSION(in_Extension_3), CurrentMaskOp__DEVICE_EXTENSION(in_Extension_3), MaskOps__DEVICE_EXTENSION(in_Extension_3), in_newIrp, 0);
    goto anon95_Else;
...
implementation ModemPnP_loop_L113(in_j: int, in_Descriptor: int, in_Tmp_403: int, in_ResourceList: int, in_Tmp_411: int) returns (out_j: int, out_Descriptor: int, out_Tmp_403: int, out_Tmp_411: int)
{
  ...
  L118_dummy:
    call {:si_unique_call 1768} {:si_old_unique_call 1} out_j, out_Descriptor, out_Tmp_403, out_Tmp_411 := ModemPnP_loop_L113(out_j, out_Descriptor, out_Tmp_403, in_ResourceList, out_Tmp_411);
    return;
...
implementation ModemPnP_loop_L111(in_i: int, in_j: int, in_Descriptor: int, in_Tmp_403: int, in_ResourceRequirementsList: int, in_ResourceList: int, in_Tmp_411: int) returns (out_i: int, out_j: int, out_Descriptor: int, out_Tmp_403: int, out_Tmp_411: int)
{
  ...
  L113:
    call {:si_unique_call 1769} out_j, out_Descriptor, out_Tmp_403, out_Tmp_411 := ModemPnP_loop_L113(out_j, out_Descriptor, out_Tmp_403, in_ResourceList, out_Tmp_411);
    goto L113_last;
  ...
  anon118_Then_dummy:
    call {:si_unique_call 1770} {:si_old_unique_call 1} out_i, out_j, out_Descriptor, out_Tmp_403, out_Tmp_411 := ModemPnP_loop_L111(out_i, out_j, out_Descriptor, out_Tmp_403, in_ResourceRequirementsList, in_ResourceList, out_Tmp_411);
    return;
}
...
implementation {:SIextraRecBound 6} ModemPnP_loop_L138(in_i_1: int, in_irpSp_11: int, in_Tmp_394: int, in_Tmp_395: int, in_Tmp_396: int, in_Tmp_407: int, in_Tmp_408: int, in_deviceExtension: int) returns (out_i_1: int, out_Tmp_394: int, out_Tmp_395: int, out_Tmp_396: int, out_Tmp_407: int, out_Tmp_408: int)
{
  ...
  anon122_Else_dummy:
    call {:si_unique_call 1771} {:si_old_unique_call 1} out_i_1, out_Tmp_394, out_Tmp_395, out_Tmp_396, out_Tmp_407, out_Tmp_408 := ModemPnP_loop_L138(out_i_1, in_irpSp_11, out_Tmp_394, out_Tmp_395, out_Tmp_396, out_Tmp_407, out_Tmp_408, in_deviceExtension);
    return;
}
...
implementation {:SIextraRecBound 8} ModemPnP_loop_L134(in_i_1: int, in_Tmp_402: int, in_Tmp_404: int, in_deviceExtension: int) returns (out_i_1: int, out_Tmp_402: int, out_Tmp_404: int)
{
  ...
  anon121_Else_dummy:
    call {:si_unique_call 1772} {:si_old_unique_call 1} out_i_1, out_Tmp_402, out_Tmp_404 := ModemPnP_loop_L134(out_i_1, out_Tmp_402, out_Tmp_404, in_deviceExtension);
    return;
}
...
implementation CleanUpOnRemove_loop_L72(in_i_2: int, in_Tmp_422: int, in_Tmp_424: int, in_Tmp_425: int, in_Tmp_426: int, in_OwnerClient_3: int, in_Tmp_429: int, in_Tmp_430: int, in_deviceExtension_2: int) returns (out_i_2: int, out_Tmp_422: int, out_Tmp_424: int, out_Tmp_425: int, out_Tmp_426: int, out_OwnerClient_3: int, out_Tmp_429: int, out_Tmp_430: int)
{
  ...
  anon35_Else:
    ...
    call {:si_unique_call 1774} EmptyIpcQueue(in_deviceExtension_2, out_Tmp_422);
    goto anon42_Else;
  ...
  anon42_Else:
    ...
    call {:si_unique_call 1773} EmptyIpcQueue(in_deviceExtension_2, out_Tmp_425);
    goto anon43_Else;
  ...
  anon43_Else_dummy:
    call {:si_unique_call 1775} {:si_old_unique_call 1} out_i_2, out_Tmp_422, out_Tmp_424, out_Tmp_425, out_Tmp_426, out_OwnerClient_3, out_Tmp_429, out_Tmp_430 := CleanUpOnRemove_loop_L72(out_i_2, out_Tmp_422, out_Tmp_424, out_Tmp_425, out_Tmp_426, out_OwnerClient_3, out_Tmp_429, out_Tmp_430, in_deviceExtension_2);
    return;
}
...
implementation CleanUpOnRemove_loop_L25(in_i_2: int, in_Tmp_420: int, in_Tmp_421: int, in_thisMaskState_1: int, in_Tmp_427: int, in_origIrql_7: int, in_savedIrp_3: int, in_deviceExtension_2: int) returns (out_i_2: int, out_Tmp_420: int, out_Tmp_421: int, out_thisMaskState_1: int, out_Tmp_427: int, out_origIrql_7: int, out_savedIrp_3: int)
{
  ...
  anon32_Else:
    ...
    call {:si_unique_call 1779} out_Tmp_421 := __HAVOC_malloc(4);
    assume {:nonnull} out_Tmp_421 != 0;
    assume out_Tmp_421 > 0;
    Mem_T.INT4[out_Tmp_421] := out_origIrql_7;
    call {:si_unique_call 1780} sdv_KeAcquireSpinLock(0, out_Tmp_421);
    goto anon39_Else;
  ...
  anon33_Else:
    call {:si_unique_call 1778} SetPassdownToComplete(out_thisMaskState_1);
    goto L32;
  ...
  anon34_Else:
    ...
    assume {:nonnull} out_thisMaskState_1 != 0;
    assume out_thisMaskState_1 > 0;
    call {:si_unique_call 1776} UniRundownShuttledWait(in_deviceExtension_2, ShuttledWait__MASKSTATE(out_thisMaskState_1), 1, out_savedIrp_3, out_origIrql_7, 0, 0);
    goto L45;
  ...
  L45_dummy:
    call {:si_unique_call 1781} {:si_old_unique_call 1} out_i_2, out_Tmp_420, out_Tmp_421, out_thisMaskState_1, out_Tmp_427, out_origIrql_7, out_savedIrp_3 := CleanUpOnRemove_loop_L25(out_i_2, out_Tmp_420, out_Tmp_421, out_thisMaskState_1, out_Tmp_427, out_origIrql_7, out_savedIrp_3, in_deviceExtension_2);
    return;

  anon34_Then:
    call {:si_unique_call 1777} sdv_KeReleaseSpinLock(0, out_origIrql_7);
    goto L45;
...
implementation StartNextReadWriteIrp_loop_L18(in_Irp_39: int, in_sdv_341: int, in_sdv_346: int, in_Tmp_581: int, in_ListElement_1: int, in_CancelIrql_7: int, in_Control: int) returns (out_Irp_39: int, out_sdv_341: int, out_sdv_346: int, out_Tmp_581: int, out_ListElement_1: int, out_CancelIrql_7: int)
{

  entry:
    out_Irp_39, out_sdv_341, out_sdv_346, out_Tmp_581, out_ListElement_1, out_CancelIrql_7 := in_Irp_39, in_sdv_341, in_sdv_346, in_Tmp_581, in_ListElement_1, in_CancelIrql_7;
    goto L18, exit;
  ...
  L18:
    call {:si_unique_call 1782} out_sdv_341 := sdv_IsListEmpty(0);
    goto anon21_Else;

  anon21_Else:
    assume {:partition} out_sdv_341 == 0;
    assume {:nonnull} in_Control != 0;
    assume in_Control > 0;
    call {:si_unique_call 1784} out_ListElement_1 := RemoveHeadList(ListHead__READ_WRITE_CONTROL(in_Control));
    call {:si_unique_call 1785} out_sdv_346 := sdv_containing_record(out_ListElement_1, 88);
    out_Irp_39 := out_sdv_346;
    call {:si_unique_call 1786} out_Tmp_581 := __HAVOC_malloc(4);
    assume {:nonnull} out_Tmp_581 != 0;
    assume out_Tmp_581 > 0;
    Mem_T.INT4[out_Tmp_581] := out_CancelIrql_7;
    call {:si_unique_call 1787} IoAcquireCancelSpinLock(out_Tmp_581);
    assume {:nonnull} out_Tmp_581 != 0;
    assume out_Tmp_581 > 0;
  ...
  anon25_Else:
    ...
    assume out_Irp_39 > 0;
    out_Irp_39 := 0;
    call {:si_unique_call 1783} IoReleaseCancelSpinLock(out_CancelIrql_7);
    goto anon25_Else_dummy;

  anon25_Else_dummy:
    call {:si_unique_call 1788} {:si_old_unique_call 1} out_Irp_39, out_sdv_341, out_sdv_346, out_Tmp_581, out_ListElement_1, out_CancelIrql_7 := StartNextReadWriteIrp_loop_L18(out_Irp_39, out_sdv_341, out_sdv_346, out_Tmp_581, out_ListElement_1, out_CancelIrql_7, in_Control);
    return;
}



procedure {:LoopProcedure} StartNextReadWriteIrp_loop_L18(in_Irp_39: int, in_sdv_341: int, in_sdv_346: int, in_Tmp_581: int, in_ListElement_1: int, in_CancelIrql_7: int, in_Control: int) returns (out_Irp_39: int, out_sdv_341: int, out_sdv_346: int, out_Tmp_581: int, out_ListElement_1: int, out_CancelIrql_7: int);
  ...
  free ensures {:va_keep} out_sdv_341 == 1 || out_sdv_341 == 0 || out_sdv_341 == in_sdv_341;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);



implementation StartNextReadWriteIrp_loop_L17(in_Irp_39: int, in_sdv_341: int, in_origIrql_10: int, in_sdv_344: int, in_sdv_346: int, in_Tmp_581: int, in_ListElement_1: int, in_CancelIrql_7: int, in_Control: int, in_vslice_dummy_var_156: int) returns (out_Irp_39: int, out_sdv_341: int, out_origIrql_10: int, out_sdv_344: int, out_sdv_346: int, out_Tmp_581: int, out_ListElement_1: int, out_CancelIrql_7: int, out_vslice_dummy_var_156: int)
{
  var vslice_dummy_var_221: int;

  entry:
    out_Irp_39, out_sdv_341, out_origIrql_10, out_sdv_344, out_sdv_346, out_Tmp_581, out_ListElement_1, out_CancelIrql_7, out_vslice_dummy_var_156 := in_Irp_39, in_sdv_341, in_origIrql_10, in_sdv_344, in_sdv_346, in_Tmp_581, in_ListElement_1, in_CancelIrql_7, in_vslice_dummy_var_156;
    goto L17, exit;
  ...
  L18:
    call {:si_unique_call 1792} out_Irp_39, out_sdv_341, out_sdv_346, out_Tmp_581, out_ListElement_1, out_CancelIrql_7 := StartNextReadWriteIrp_loop_L18(out_Irp_39, out_sdv_341, out_sdv_346, out_Tmp_581, out_ListElement_1, out_CancelIrql_7, in_Control);
    goto L18_last;

  L18_last:
    call {:si_unique_call 1793} out_sdv_341 := sdv_IsListEmpty(0);
    goto anon21_Then, anon21_Else;
  ...
  anon21_Else:
    ...
    assume {:nonnull} in_Control != 0;
    assume in_Control > 0;
    call {:si_unique_call 1795} out_ListElement_1 := RemoveHeadList(ListHead__READ_WRITE_CONTROL(in_Control));
    call {:si_unique_call 1796} out_sdv_346 := sdv_containing_record(out_ListElement_1, 88);
    out_Irp_39 := out_sdv_346;
    call {:si_unique_call 1797} out_Tmp_581 := __HAVOC_malloc(4);
    assume {:nonnull} out_Tmp_581 != 0;
    assume out_Tmp_581 > 0;
    Mem_T.INT4[out_Tmp_581] := out_CancelIrql_7;
    call {:si_unique_call 1798} IoAcquireCancelSpinLock(out_Tmp_581);
    assume {:nonnull} out_Tmp_581 != 0;
    assume out_Tmp_581 > 0;
    out_CancelIrql_7 := Mem_T.INT4[out_Tmp_581];
    assume {:nonnull} out_Irp_39 != 0;
  ...
  anon25_Else:
    ...
    assume out_Irp_39 > 0;
    out_Irp_39 := 0;
    call {:si_unique_call 1794} IoReleaseCancelSpinLock(out_CancelIrql_7);
    assume false;
    return;

  anon25_Then:
    call {:si_unique_call 1790} out_vslice_dummy_var_156 := sdv_IoSetCancelRoutine(out_Irp_39, 0);
    call {:si_unique_call 1791} IoReleaseCancelSpinLock(out_CancelIrql_7);
    goto L23;
  ...
  anon23_Else:
    call {:si_unique_call 1802} sdv_KeReleaseSpinLock(0, out_origIrql_10);
    assume {:nonnull} in_Control != 0;
    assume in_Control > 0;
    havoc vslice_dummy_var_221;
    call {:si_unique_call 1803} RemoveReferenceAndCompleteRequest(vslice_dummy_var_221, out_Irp_39, -1073741536);
    call {:si_unique_call 1804} out_Tmp_581 := __HAVOC_malloc(4);
    assume {:nonnull} out_Tmp_581 != 0;
    assume out_Tmp_581 > 0;
    Mem_T.INT4[out_Tmp_581] := out_origIrql_10;
    call {:si_unique_call 1805} sdv_KeAcquireSpinLock(0, out_Tmp_581);
    goto anon29_Else;
  ...
  anon22_Then:
    call {:si_unique_call 1789} out_sdv_344 := sdv_IsListEmpty(0);
    goto anon24_Then;
  ...
  anon24_Then_dummy:
    call {:si_unique_call 1806} {:si_old_unique_call 1} out_Irp_39, out_sdv_341, out_origIrql_10, out_sdv_344, out_sdv_346, out_Tmp_581, out_ListElement_1, out_CancelIrql_7, out_vslice_dummy_var_156 := StartNextReadWriteIrp_loop_L17(out_Irp_39, out_sdv_341, out_origIrql_10, out_sdv_344, out_sdv_346, out_Tmp_581, out_ListElement_1, out_CancelIrql_7, in_Control, out_vslice_dummy_var_156);
    return;

  anon23_Then:
    call {:si_unique_call 1799} sdv_KeReleaseSpinLock(0, out_origIrql_10);
    assume {:nonnull} in_Control != 0;
    assume in_Control > 0;
    call {:si_unique_call 1800} out_Tmp_581 := __HAVOC_malloc(4);
    assume {:nonnull} out_Tmp_581 != 0;
    assume out_Tmp_581 > 0;
    Mem_T.INT4[out_Tmp_581] := out_origIrql_10;
    call {:si_unique_call 1801} sdv_KeAcquireSpinLock(0, out_Tmp_581);
    goto anon30_Else;
...
procedure {:LoopProcedure} StartNextReadWriteIrp_loop_L17(in_Irp_39: int, in_sdv_341: int, in_origIrql_10: int, in_sdv_344: int, in_sdv_346: int, in_Tmp_581: int, in_ListElement_1: int, in_CancelIrql_7: int, in_Control: int, in_vslice_dummy_var_156: int) returns (out_Irp_39: int, out_sdv_341: int, out_origIrql_10: int, out_sdv_344: int, out_sdv_346: int, out_Tmp_581: int, out_ListElement_1: int, out_CancelIrql_7: int, out_vslice_dummy_var_156: int);
...
implementation CleanUpQueuedIrps_loop_L9(in_Irp_44: int, in_sdv_364: int, in_origIrql_15: int, in_sdv_366: int, in_ListElement_2: int, in_CancelIrql_9: int, in_Tmp_606: int, in_Control_5: int, in_Status_14: int, in_vslice_dummy_var_163: int) returns (out_Irp_44: int, out_sdv_364: int, out_origIrql_15: int, out_sdv_366: int, out_ListElement_2: int, out_CancelIrql_9: int, out_Tmp_606: int, out_vslice_dummy_var_163: int)
{
  var vslice_dummy_var_222: int;

  entry:
    out_Irp_44, out_sdv_364, out_origIrql_15, out_sdv_366, out_ListElement_2, out_CancelIrql_9, out_Tmp_606, out_vslice_dummy_var_163 := in_Irp_44, in_sdv_364, in_origIrql_15, in_sdv_366, in_ListElement_2, in_CancelIrql_9, in_Tmp_606, in_vslice_dummy_var_163;
    goto L9, exit;
  ...
  L9:
    call {:si_unique_call 1807} out_sdv_364 := sdv_IsListEmpty(0);
    goto anon11_Else;
  ...
  anon11_Else:
    ...
    call {:si_unique_call 1815} out_ListElement_2 := RemoveTailList(ListHead__READ_WRITE_CONTROL(in_Control_5));
    call {:si_unique_call 1816} out_sdv_366 := sdv_containing_record(out_ListElement_2, 88);
    out_Irp_44 := out_sdv_366;
    call {:si_unique_call 1817} out_Tmp_606 := __HAVOC_malloc(4);
    assume {:nonnull} out_Tmp_606 != 0;
    assume out_Tmp_606 > 0;
    Mem_T.INT4[out_Tmp_606] := out_CancelIrql_9;
    call {:si_unique_call 1818} IoAcquireCancelSpinLock(out_Tmp_606);
    assume {:nonnull} out_Tmp_606 != 0;
    assume out_Tmp_606 > 0;
  ...
  anon12_Else:
    ...
    assume out_Irp_44 > 0;
    out_Irp_44 := 0;
    call {:si_unique_call 1812} IoReleaseCancelSpinLock(out_CancelIrql_9);
    goto L38;
  ...
  anon13_Else:
    ...
    call {:si_unique_call 1808} sdv_KeReleaseSpinLock(0, out_origIrql_15);
    assume {:nonnull} out_Irp_44 != 0;
    assume out_Irp_44 > 0;
    assume {:nonnull} in_Control_5 != 0;
    assume in_Control_5 > 0;
    havoc vslice_dummy_var_222;
    call {:si_unique_call 1809} RemoveReferenceAndCompleteRequest(vslice_dummy_var_222, out_Irp_44, in_Status_14);
    call {:si_unique_call 1810} out_Tmp_606 := __HAVOC_malloc(4);
    assume {:nonnull} out_Tmp_606 != 0;
    assume out_Tmp_606 > 0;
    Mem_T.INT4[out_Tmp_606] := out_origIrql_15;
    call {:si_unique_call 1811} sdv_KeAcquireSpinLock(0, out_Tmp_606);
    goto anon15_Else;
  ...
  L_BAF_0:
    call {:si_unique_call 1819} {:si_old_unique_call 1} out_Irp_44, out_sdv_364, out_origIrql_15, out_sdv_366, out_ListElement_2, out_CancelIrql_9, out_Tmp_606, out_vslice_dummy_var_163 := CleanUpQueuedIrps_loop_L9(out_Irp_44, out_sdv_364, out_origIrql_15, out_sdv_366, out_ListElement_2, out_CancelIrql_9, out_Tmp_606, in_Control_5, in_Status_14, out_vslice_dummy_var_163);
    return;
  ...
  anon12_Then:
    call {:si_unique_call 1813} out_vslice_dummy_var_163 := sdv_IoSetCancelRoutine(out_Irp_44, 0);
...
procedure {:LoopProcedure} CleanUpQueuedIrps_loop_L9(in_Irp_44: int, in_sdv_364: int, in_origIrql_15: int, in_sdv_366: int, in_ListElement_2: int, in_CancelIrql_9: int, in_Tmp_606: int, in_Control_5: int, in_Status_14: int, in_vslice_dummy_var_163: int) returns (out_Irp_44: int, out_sdv_364: int, out_origIrql_15: int, out_sdv_366: int, out_ListElement_2: int, out_CancelIrql_9: int, out_Tmp_606: int, out_vslice_dummy_var_163: int);
  modifies alloc, sdv_irql_current, sdv_irql_previous, sdv_irql_previous_2, sdv_irql_previous_3, sdv_irql_previous_4, Mem_T.INT4, sdv_irql_previous_5, yogi_error;
  free ensures {:va_keep} yogi_error == 0;
  free ensures {:va_keep} old(sdv_irql_current) <= 2 && old(sdv_irql_previous) <= 2 && old(sdv_irql_previous_2) <= 2 && old(sdv_irql_previous_3) <= 2 ==> sdv_irql_current <= 2 && sdv_irql_previous <= 2 && sdv_irql_previous_2 <= 2 && sdv_irql_previous_3 <= 2 && sdv_irql_current >= 0 && sdv_irql_previous >= 0 && sdv_irql_previous_2 >= 0 && sdv_irql_previous_3 >= 0;
  free ensures {:va_keep} sdv_irql_previous_5 == old(sdv_irql_previous_5) || sdv_irql_previous_5 == old(sdv_irql_previous_4);
  ...
  free ensures {:va_keep} yogi_error == 1 || yogi_error == old(yogi_error);
  free ensures {:va_keep} out_sdv_364 == 1 || out_sdv_364 == 0 || out_sdv_364 == in_sdv_364;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);
...
implementation UniPostProcessShuttledWaits_loop_L7(in_i_3: int, in_origIrql_16: int, in_irpToComplete: int, in_Tmp_613: int, in_Tmp_614: int, in_Extension_6: int, in_MaskStates: int, in_MaskValue_1: int) returns (out_i_3: int, out_origIrql_16: int, out_irpToComplete: int, out_Tmp_613: int, out_Tmp_614: int)
{
  ...
  anon7_Else:
    ...
    assume {:nonnull} in_MaskStates != 0;
    assume in_MaskStates > 0;
    call {:si_unique_call 1821} out_Tmp_614 := __HAVOC_malloc(4);
    assume {:nonnull} out_Tmp_614 != 0;
    assume out_Tmp_614 > 0;
    Mem_T.INT4[out_Tmp_614] := out_origIrql_16;
    call {:si_unique_call 1822} sdv_KeAcquireSpinLock(0, out_Tmp_614);
    goto anon8_Else;
  ...
  anon8_Else:
    ...
    assume {:nonnull} in_MaskStates != 0;
    assume in_MaskStates > 0;
    call {:si_unique_call 1820} UniRundownShuttledWait(in_Extension_6, ShuttledWait__MASKSTATE(in_MaskStates), 1, out_irpToComplete, out_origIrql_16, 0, out_Tmp_613);
    goto L9;
  ...
  anon9_Else_dummy:
    call {:si_unique_call 1823} {:si_old_unique_call 1} out_i_3, out_origIrql_16, out_irpToComplete, out_Tmp_613, out_Tmp_614 := UniPostProcessShuttledWaits_loop_L7(out_i_3, out_origIrql_16, out_irpToComplete, out_Tmp_613, out_Tmp_614, in_Extension_6, in_MaskStates, in_MaskValue_1);
    return;
...
implementation {:SIextraRecBound 2} UniPreProcessShuttledWaits_loop_L8(in_i_4: int, in_ExtensionMaskStates: int, in_MaskStates_1: int, in_MaskValue_2: int) returns (out_i_4: int)
{
  ...
  anon9_Else_dummy:
    call {:si_unique_call 1824} {:si_old_unique_call 1} out_i_4 := UniPreProcessShuttledWaits_loop_L8(out_i_4, in_ExtensionMaskStates, in_MaskStates_1, in_MaskValue_2);
    return;
...
implementation UniReadComplete#0_loop_L33(in_Tmp_595: int, in_Tmp_598: int, in_Buffer_1: int, in_Tmp_600: int, in_origIrql_14: int, in_Length_4: int, in_Tmp_601: int, in_Tmp_602: int, in_deviceExtension_12: int, in_Irp_42: int) returns (out_Tmp_595: int, out_Tmp_598: int, out_Tmp_600: int, out_origIrql_14: int, out_Length_4: int, out_Tmp_601: int, out_Tmp_602: int)
{
  ...
  anon42_Else:
    ...
    call {:si_unique_call 1827} out_Tmp_600 := __HAVOC_malloc(4);
    assume {:nonnull} out_Tmp_600 != 0;
    assume out_Tmp_600 > 0;
    Mem_T.INT4[out_Tmp_600] := out_origIrql_14;
    call {:si_unique_call 1828} sdv_KeAcquireSpinLock(0, out_Tmp_600);
    goto anon48_Else;
  ...
  L45:
    call {:si_unique_call 1825} sdv_KeReleaseSpinLock(0, out_origIrql_14);
    out_Tmp_601 := out_Length_4 - 1;
    call {:si_unique_call 1826} sdv_RtlCopyMemory(0, 0, out_Tmp_601);
  ...
  L_BAF_1:
    call {:si_unique_call 1830} {:si_old_unique_call 1} out_Tmp_595, out_Tmp_598, out_Tmp_600, out_origIrql_14, out_Length_4, out_Tmp_601, out_Tmp_602 := UniReadComplete#0_loop_L33(out_Tmp_595, out_Tmp_598, in_Buffer_1, out_Tmp_600, out_origIrql_14, out_Length_4, out_Tmp_601, out_Tmp_602, in_deviceExtension_12, in_Irp_42);
    return;
  ...
  anon41_Else:
    ...
    call {:si_unique_call 1829} sdv_RtlCopyMemory(0, 0, out_Tmp_602);
    out_Length_4 := out_Length_4 - 1;
    assume {:nonnull} in_Irp_42 != 0;
    assume in_Irp_42 > 0;
    goto anon41_Else_dummy;
...
implementation UniReadComplete#1_loop_L33(in_Tmp_595: int, in_Tmp_598: int, in_Buffer_1: int, in_Tmp_600: int, in_origIrql_14: int, in_Length_4: int, in_Tmp_601: int, in_Tmp_602: int, in_deviceExtension_12: int, in_Irp_42: int) returns (out_Tmp_595: int, out_Tmp_598: int, out_Tmp_600: int, out_origIrql_14: int, out_Length_4: int, out_Tmp_601: int, out_Tmp_602: int)
{
  ...
  anon42_Else:
    assume {:partition} Mem_T.INT4[in_Buffer_1] != 16;
    call {:si_unique_call 1833} out_Tmp_600 := __HAVOC_malloc(4);
    assume {:nonnull} out_Tmp_600 != 0;
    assume out_Tmp_600 > 0;
    Mem_T.INT4[out_Tmp_600] := out_origIrql_14;
    call {:si_unique_call 1834} sdv_KeAcquireSpinLock(0, out_Tmp_600);
    goto anon48_Else;
  ...
  L45:
    call {:si_unique_call 1831} sdv_KeReleaseSpinLock(0, out_origIrql_14);
    out_Tmp_601 := out_Length_4 - 1;
    call {:si_unique_call 1832} sdv_RtlCopyMemory(0, 0, out_Tmp_601);
    out_Length_4 := out_Length_4 - 1;
    assume {:nonnull} in_Irp_42 != 0;
    assume in_Irp_42 > 0;
    goto L57;
  ...
  L_BAF_2:
    call {:si_unique_call 1836} {:si_old_unique_call 1} out_Tmp_595, out_Tmp_598, out_Tmp_600, out_origIrql_14, out_Length_4, out_Tmp_601, out_Tmp_602 := UniReadComplete#1_loop_L33(out_Tmp_595, out_Tmp_598, in_Buffer_1, out_Tmp_600, out_origIrql_14, out_Length_4, out_Tmp_601, out_Tmp_602, in_deviceExtension_12, in_Irp_42);
    return;
  ...
  anon41_Else:
    ...
    assume in_deviceExtension_12 > 0;
    out_Tmp_602 := out_Length_4 - 1;
    call {:si_unique_call 1835} sdv_RtlCopyMemory(0, 0, out_Tmp_602);
    out_Length_4 := out_Length_4 - 1;
    assume {:nonnull} in_Irp_42 != 0;
    assume in_Irp_42 > 0;
    goto anon41_Else_dummy;
...
implementation UniPassThroughStarter#0_loop_L6(in_newIrp_4: int, in_Tmp_671: int, in_Tmp_672: int, in_irp_4: int, in_passThroughType: int, in_Extension_10: int) returns (out_Tmp_671: int, out_Tmp_672: int, out_irp_4: int, out_passThroughType: int)
{
  ...
  L23:
    ...
    call {:si_unique_call 1837} UniGetNextIrp(vslice_dummy_var_223, DeviceLock__DEVICE_EXTENSION(in_Extension_10), CurrentPassThrough__DEVICE_EXTENSION(in_Extension_10), PassThroughQueue__DEVICE_EXTENSION(in_Extension_10), in_newIrp_4, 1);
    goto anon34_Else;
  ...
  anon30_Then_dummy:
    call {:si_unique_call 1838} {:si_old_unique_call 1} out_Tmp_671, out_Tmp_672, out_irp_4, out_passThroughType := UniPassThroughStarter#0_loop_L6(in_newIrp_4, out_Tmp_671, out_Tmp_672, out_irp_4, out_passThroughType, in_Extension_10);
    return;
...
implementation UniPassThroughStarter#1_loop_L6(in_newIrp_4: int, in_Tmp_671: int, in_Tmp_672: int, in_irp_4: int, in_passThroughType: int, in_Extension_10: int) returns (out_Tmp_671: int, out_Tmp_672: int, out_irp_4: int, out_passThroughType: int)
{
  ...
  L23:
    ...
    call {:si_unique_call 1839} UniGetNextIrp(vslice_dummy_var_224, DeviceLock__DEVICE_EXTENSION(in_Extension_10), CurrentPassThrough__DEVICE_EXTENSION(in_Extension_10), PassThroughQueue__DEVICE_EXTENSION(in_Extension_10), in_newIrp_4, 1);
    goto anon34_Else;
  ...
  anon30_Then_dummy:
    call {:si_unique_call 1840} {:si_old_unique_call 1} out_Tmp_671, out_Tmp_672, out_irp_4, out_passThroughType := UniPassThroughStarter#1_loop_L6(in_newIrp_4, out_Tmp_671, out_Tmp_672, out_irp_4, out_passThroughType, in_Extension_10);
    return;
...
implementation UniWriteComplete#0_loop_L32(in_Buffer_2: int, in_BufferEnd: int)
{
  ...
  anon28_Then_dummy:
    call {:si_unique_call 1841} {:si_old_unique_call 1} UniWriteComplete#0_loop_L32(in_Buffer_2, in_BufferEnd);
    return;
}
...
implementation UniWriteComplete#1_loop_L32(in_Buffer_2: int, in_BufferEnd: int)
{
  ...
  anon28_Then_dummy:
    call {:si_unique_call 1842} {:si_old_unique_call 1} UniWriteComplete#1_loop_L32(in_Buffer_2, in_BufferEnd);
    return;
}
...
implementation HandleIpc#0_loop_L12(in_Tmp_16: int, in_PutIrp: int, in_Tmp_18: int, in_Tmp_19: int, in_Tmp_20: int, in_Sink: int, in_Tmp_22: int, in_sdv_5: int, in_GetIrp: int, in_Tmp_23: int, in_Tmp_24: int, in_Tmp_25: int, in_sdv_6: int, in_Tmp_26: int, in_Tmp_27: int, in_origIrql_2: int, in_sdv_7: int, in_sdv_10: int, in_BytesToCopy: int, in_sdv_12: int, in_CancelIrql_2: int, in_Tmp_29: int, in_Source: int, in_DeviceExtension: int, in_vslice_dummy_var_237: int, in_vslice_dummy_var_238: int) returns (out_Tmp_16: int, out_PutIrp: int, out_Tmp_18: int, out_Tmp_19: int, out_Tmp_20: int, out_Sink: int, out_Tmp_22: int, out_sdv_5: int, out_GetIrp: int, out_Tmp_23: int, out_Tmp_24: int, out_Tmp_25: int, out_sdv_6: int, out_Tmp_26: int, out_Tmp_27: int, out_origIrql_2: int, out_sdv_7: int, out_sdv_10: int, out_BytesToCopy: int, out_sdv_12: int, out_CancelIrql_2: int, out_Tmp_29: int, out_Source: int, out_vslice_dummy_var_237: int, out_vslice_dummy_var_238: int)
{
  ...
  anon19_Else:
    ...
    call {:si_unique_call 1846} out_Tmp_27 := __HAVOC_malloc(4);
    assume {:nonnull} out_Tmp_27 != 0;
    assume out_Tmp_27 > 0;
    Mem_T.INT4[out_Tmp_27] := out_CancelIrql_2;
    call {:si_unique_call 1847} IoAcquireCancelSpinLock(out_Tmp_27);
    assume {:nonnull} out_Tmp_27 != 0;
    assume out_Tmp_27 > 0;
    ...
    call {:si_unique_call 1848} out_GetIrp := GetUsableIrp(out_Tmp_23);
    goto anon20_Then, anon20_Else;
  ...
  anon20_Else:
    ...
    call {:si_unique_call 1849} out_PutIrp := GetUsableIrp(out_Tmp_18);
    goto anon21_Then, anon21_Else;

  anon21_Else:
    assume {:partition} out_PutIrp != 0;
    call {:si_unique_call 1858} out_vslice_dummy_var_237 := sdv_IoSetCancelRoutine(out_GetIrp, 0);
    call {:si_unique_call 1859} out_vslice_dummy_var_238 := sdv_IoSetCancelRoutine(out_PutIrp, 0);
    call {:si_unique_call 1860} IoReleaseCancelSpinLock(out_CancelIrql_2);
    call {:si_unique_call 1861} sdv_KeReleaseSpinLock(0, out_origIrql_2);
    call {:si_unique_call 1862} out_sdv_10 := sdv_IoGetCurrentIrpStackLocation(out_PutIrp);
    call {:si_unique_call 1863} out_sdv_5 := sdv_IoGetCurrentIrpStackLocation(out_GetIrp);
  ...
  anon22_Else:
    call {:si_unique_call 1856} out_sdv_7 := sdv_IoGetCurrentIrpStackLocation(out_PutIrp);
  ...
  L64:
    ...
    call {:si_unique_call 1853} sdv_RtlCopyMemory(0, 0, out_BytesToCopy);
    assume {:nonnull} out_GetIrp != 0;
    assume out_GetIrp > 0;
    assume {:nonnull} in_DeviceExtension != 0;
    assume in_DeviceExtension > 0;
    havoc vslice_dummy_var_226;
    call {:si_unique_call 1854} RemoveReferenceAndCompleteRequest(vslice_dummy_var_226, out_GetIrp, 0);
    call {:si_unique_call 1855} out_sdv_6 := sdv_IoGetCurrentIrpStackLocation(out_PutIrp);
  ...
  anon23_Then:
    ...
    call {:si_unique_call 1852} RemoveReferenceAndCompleteRequest(vslice_dummy_var_225, out_PutIrp, 0);
    goto L100;
  ...
  L100:
    ...
    call {:si_unique_call 1851} sdv_KeAcquireSpinLock(0, out_Tmp_27);
    goto anon27_Else;
  ...
  L103_dummy:
    call {:si_unique_call 1864} {:si_old_unique_call 1} out_Tmp_16, out_PutIrp, out_Tmp_18, out_Tmp_19, out_Tmp_20, out_Sink, out_Tmp_22, out_sdv_5, out_GetIrp, out_Tmp_23, out_Tmp_24, out_Tmp_25, out_sdv_6, out_Tmp_26, out_Tmp_27, out_origIrql_2, out_sdv_7, out_sdv_10, out_BytesToCopy, out_sdv_12, out_CancelIrql_2, out_Tmp_29, out_Source, out_vslice_dummy_var_237, out_vslice_dummy_var_238 := HandleIpc#0_loop_L12(out_Tmp_16, out_PutIrp, out_Tmp_18, out_Tmp_19, out_Tmp_20, out_Sink, out_Tmp_22, out_sdv_5, out_GetIrp, out_Tmp_23, out_Tmp_24, out_Tmp_25, out_sdv_6, out_Tmp_26, out_Tmp_27, out_origIrql_2, out_sdv_7, out_sdv_10, out_BytesToCopy, out_sdv_12, out_CancelIrql_2, out_Tmp_29, out_Source, in_DeviceExtension, out_vslice_dummy_var_237, out_vslice_dummy_var_238);
    return;

  anon22_Then:
    call {:si_unique_call 1857} out_sdv_12 := sdv_IoGetCurrentIrpStackLocation(out_GetIrp);
  ...
  anon21_Then:
    ...
    assume {:nonnull} out_GetIrp != 0;
    assume out_GetIrp > 0;
    call {:si_unique_call 1843} InsertHeadList(out_Tmp_19, ListEntry_unnamed_tag_6(Overlay_unnamed_tag_5(Tail__IRP(out_GetIrp))));
    call {:si_unique_call 1844} IoReleaseCancelSpinLock(out_CancelIrql_2);
    goto L103;

  anon20_Then:
    assume {:partition} out_GetIrp == 0;
    call {:si_unique_call 1845} IoReleaseCancelSpinLock(out_CancelIrql_2);
    goto L103;
}
...
implementation HandleIpc#1_loop_L12(in_Tmp_16: int, in_Tmp_17: int, in_PutIrp: int, in_Tmp_18: int, in_Tmp_19: int, in_Tmp_20: int, in_Sink: int, in_Tmp_22: int, in_sdv_5: int, in_GetIrp: int, in_Tmp_23: int, in_Tmp_24: int, in_Tmp_25: int, in_sdv_6: int, in_Tmp_26: int, in_Tmp_27: int, in_origIrql_2: int, in_sdv_7: int, in_Tmp_28: int, in_sdv_10: int, in_BytesToCopy: int, in_sdv_12: int, in_CancelIrql_2: int, in_Tmp_29: int, in_Tmp_30: int, in_Source: int, in_DeviceExtension: int, in_vslice_dummy_var_242: int, in_vslice_dummy_var_243: int, in_vslice_dummy_var_244: int, in_vslice_dummy_var_245: int) returns (out_Tmp_16: int, out_Tmp_17: int, out_PutIrp: int, out_Tmp_18: int, out_Tmp_19: int, out_Tmp_20: int, out_Sink: int, out_Tmp_22: int, out_sdv_5: int, out_GetIrp: int, out_Tmp_23: int, out_Tmp_24: int, out_Tmp_25: int, out_sdv_6: int, out_Tmp_26: int, out_Tmp_27: int, out_origIrql_2: int, out_sdv_7: int, out_Tmp_28: int, out_sdv_10: int, out_BytesToCopy: int, out_sdv_12: int, out_CancelIrql_2: int, out_Tmp_29: int, out_Tmp_30: int, out_Source: int, out_vslice_dummy_var_242: int, out_vslice_dummy_var_243: int, out_vslice_dummy_var_244: int, out_vslice_dummy_var_245: int)
{
  ...
  anon19_Else:
    assume {:partition} 2 > out_Source;
    call {:si_unique_call 1868} out_Tmp_27 := __HAVOC_malloc(4);
    assume {:nonnull} out_Tmp_27 != 0;
    assume out_Tmp_27 > 0;
    Mem_T.INT4[out_Tmp_27] := out_CancelIrql_2;
    call {:si_unique_call 1869} IoAcquireCancelSpinLock(out_Tmp_27);
    assume {:nonnull} out_Tmp_27 != 0;
    assume out_Tmp_27 > 0;
    out_CancelIrql_2 := Mem_T.INT4[out_Tmp_27];
    out_Tmp_24 := out_Sink;
    ...
    assume out_Tmp_22 > 0;
    out_Tmp_23 := GetList__IPC_CONTROL(out_Tmp_22 + out_Tmp_24 * 24);
    call {:si_unique_call 1870} out_GetIrp := GetUsableIrp(out_Tmp_23);
    goto anon20_Then, anon20_Else;
  ...
  anon20_Else:
    ...
    assume out_Tmp_16 > 0;
    out_Tmp_18 := PutList__IPC_CONTROL(out_Tmp_16 + out_Tmp_26 * 24);
    call {:si_unique_call 1871} out_PutIrp := GetUsableIrp(out_Tmp_18);
    goto anon21_Then, anon21_Else;

  anon21_Else:
    assume {:partition} out_PutIrp != 0;
    call {:si_unique_call 1880} out_vslice_dummy_var_242 := sdv_IoSetCancelRoutine(out_GetIrp, 0);
    call {:si_unique_call 1881} out_vslice_dummy_var_243 := sdv_IoSetCancelRoutine(out_PutIrp, 0);
    call {:si_unique_call 1882} IoReleaseCancelSpinLock(out_CancelIrql_2);
    call {:si_unique_call 1883} sdv_KeReleaseSpinLock(0, out_origIrql_2);
    call {:si_unique_call 1884} out_sdv_10 := sdv_IoGetCurrentIrpStackLocation(out_PutIrp);
    call {:si_unique_call 1885} out_sdv_5 := sdv_IoGetCurrentIrpStackLocation(out_GetIrp);
    assume {:nonnull} out_sdv_10 != 0;
    assume out_sdv_10 > 0;
    assume {:nonnull} out_sdv_5 != 0;
    assume out_sdv_5 > 0;
  ...
  anon22_Else:
    call {:si_unique_call 1878} out_sdv_7 := sdv_IoGetCurrentIrpStackLocation(out_PutIrp);
    assume {:nonnull} out_sdv_7 != 0;
    assume out_sdv_7 > 0;
    havoc out_Tmp_29;
    goto L64;
  ...
  L64:
    out_BytesToCopy := out_Tmp_29;
    call {:si_unique_call 1875} sdv_RtlCopyMemory(0, 0, out_BytesToCopy);
    assume {:nonnull} out_GetIrp != 0;
    assume out_GetIrp > 0;
    assume {:nonnull} in_DeviceExtension != 0;
    assume in_DeviceExtension > 0;
    havoc vslice_dummy_var_228;
    call {:si_unique_call 1876} RemoveReferenceAndCompleteRequest(vslice_dummy_var_228, out_GetIrp, 0);
    call {:si_unique_call 1877} out_sdv_6 := sdv_IoGetCurrentIrpStackLocation(out_PutIrp);
    assume {:nonnull} out_sdv_6 != 0;
    assume out_sdv_6 > 0;
    goto anon23_Then, anon23_Else;
  ...
  anon25_Else:
    ...
    assume {:nonnull} out_PutIrp != 0;
    assume out_PutIrp > 0;
    call {:si_unique_call 1886} out_vslice_dummy_var_245 := sdv_InsertTailList(out_Tmp_30, ListEntry_unnamed_tag_6(Overlay_unnamed_tag_5(Tail__IRP(out_PutIrp))));
    call {:si_unique_call 1887} out_Tmp_27 := __HAVOC_malloc(4);
    assume {:nonnull} out_Tmp_27 != 0;
    assume out_Tmp_27 > 0;
    Mem_T.INT4[out_Tmp_27] := out_CancelIrql_2;
    call {:si_unique_call 1888} IoAcquireCancelSpinLock(out_Tmp_27);
    assume {:nonnull} out_Tmp_27 != 0;
    assume out_Tmp_27 > 0;
    out_CancelIrql_2 := Mem_T.INT4[out_Tmp_27];
    call {:si_unique_call 1889} out_vslice_dummy_var_244 := sdv_IoSetCancelRoutine(out_PutIrp, li2bplFunctionConstant587);
    call {:si_unique_call 1890} IoReleaseCancelSpinLock(out_CancelIrql_2);
    call {:si_unique_call 1891} sdv_KeReleaseSpinLock(0, out_origIrql_2);
    call {:si_unique_call 1892} HandleIpc#0(in_DeviceExtension);
    goto anon26_Else;
  ...
  L100:
    ...
    assume out_Tmp_27 > 0;
    Mem_T.INT4[out_Tmp_27] := out_origIrql_2;
    call {:si_unique_call 1873} sdv_KeAcquireSpinLock(0, out_Tmp_27);
    goto anon27_Else;
  ...
  anon23_Then:
    ...
    call {:si_unique_call 1874} RemoveReferenceAndCompleteRequest(vslice_dummy_var_227, out_PutIrp, 0);
    goto L100;

  anon22_Then:
    call {:si_unique_call 1879} out_sdv_12 := sdv_IoGetCurrentIrpStackLocation(out_GetIrp);
    assume {:nonnull} out_sdv_12 != 0;
    assume out_sdv_12 > 0;
    havoc out_Tmp_29;
    goto L64;
  ...
  anon21_Then:
    ...
    assume {:nonnull} out_GetIrp != 0;
    assume out_GetIrp > 0;
    call {:si_unique_call 1865} InsertHeadList(out_Tmp_19, ListEntry_unnamed_tag_6(Overlay_unnamed_tag_5(Tail__IRP(out_GetIrp))));
    call {:si_unique_call 1866} IoReleaseCancelSpinLock(out_CancelIrql_2);
    goto L103;

  anon20_Then:
    assume {:partition} out_GetIrp == 0;
    call {:si_unique_call 1867} IoReleaseCancelSpinLock(out_CancelIrql_2);
    goto L103;
}
