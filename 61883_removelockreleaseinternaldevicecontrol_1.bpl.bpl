...
implementation {:origName "Av_IoControl"} Av_IoControl(actual_DeviceObject_1: int, actual_Irp_1: int) returns (Tmp_5: int)
{
  ...
  anon227_Then:
    ...
    call {:si_unique_call 58} ntStatus := sdv_IoCallDriver#1(vslice_dummy_var_785, Irp_1);
...
implementation {:origName "sdv_stub_dispatch_end"} {:osmodel} sdv_stub_dispatch_end(actual_s: int, actual_pirp_3: int)
{
  ...
  anon0:
    call {:si_unique_call 83} vslice_dummy_var_10 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "sdv_SetStatus"} {:osmodel} sdv_SetStatus(actual_pirp_4: int)
{
  ...
  anon0:
    call {:si_unique_call 84} vslice_dummy_var_11 := __HAVOC_malloc(4);
...
implementation {:origName "sdv_main"} {:osmodel} sdv_main()
{
  ...
  anon0:
    call {:si_unique_call 85} vslice_dummy_var_12 := __HAVOC_malloc(4);
    call {:si_unique_call 86} sdv_stub_driver_init();
    call {:si_unique_call 87} vslice_dummy_var_13 := sdv_RunDispatchInternalDeviceControl(sdv_p_devobj_fdo, sdv_irp);
    goto anon3_Then, anon3_Else;
...
implementation {:origName "PoSetPowerState"} {:osmodel} PoSetPowerState(actual_DeviceObject_3: int, actual_Type: int, actual_structPtr888State: int) returns (structPtr888Tmp: int)
{
  ...
  anon0:
    call {:si_unique_call 88} State := __HAVOC_malloc(8);
    call {:si_unique_call 89} r_1 := __HAVOC_malloc(8);
    call {:si_unique_call 90} Tmp := __HAVOC_malloc(8);
...
procedure {:origName "KeCancelTimer"} {:osmodel} KeCancelTimer(actual_Timer_1: int) returns (Tmp_57: int);
...
implementation {:origName "KeCancelTimer"} {:osmodel} KeCancelTimer(actual_Timer_1: int) returns (Tmp_57: int)
{
...
implementation {:origName "sdv_IoSetCompletionRoutine"} {:osmodel} sdv_IoSetCompletionRoutine(actual_pirp_5: int, actual_CompletionRoutine: int, actual_Context: int, actual_InvokeOnSuccess: int, actual_InvokeOnError: int, actual_InvokeOnCancel: int)
{
  ...
  anon0:
    call {:si_unique_call 91} vslice_dummy_var_14 := __HAVOC_malloc(4);
    ...
    call {:si_unique_call 92} irpSp := sdv_IoGetNextIrpStackLocation(pirp_5);
...
implementation {:origName "ExAcquireFastMutex"} {:osmodel} ExAcquireFastMutex(actual_FastMutex: int)
{
  ...
  anon0:
    call {:si_unique_call 93} vslice_dummy_var_15 := __HAVOC_malloc(4);
    return;
}



procedure {:origName "sdv_RemoveEntryList"} {:osmodel} sdv_RemoveEntryList(actual_Entry: int) returns (Tmp_63: int);
...
implementation {:origName "sdv_RemoveEntryList"} {:osmodel} sdv_RemoveEntryList(actual_Entry: int) returns (Tmp_63: int)
{
...
procedure {:origName "KeSetEvent"} {:osmodel} KeSetEvent(actual_Event_2: int, actual_Increment: int, actual_Wait: int) returns (Tmp_67: int);
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);



implementation {:origName "KeSetEvent"} {:osmodel} KeSetEvent(actual_Event_2: int, actual_Increment: int, actual_Wait: int) returns (Tmp_67: int)
{
...
procedure {:origName "sdv_RunDispatchInternalDeviceControl"} {:osmodel} sdv_RunDispatchInternalDeviceControl(actual_po: int, actual_pirp_6: int) returns (Tmp_71: int);
  modifies alloc, sdv_compFset, sdv_invoke_on_success, sdv_invoke_on_error, sdv_invoke_on_cancel, yogi_error, LockDepth;
  free ensures {:va_keep} old(LockDepth) != 0 ==> yogi_error == 1;
  free ensures {:va_keep} old(LockDepth) == 0 ==> yogi_error == 1;
  free ensures {:va_keep} LockDepth <= old(LockDepth);
...
implementation {:origName "sdv_RunDispatchInternalDeviceControl"} {:osmodel} sdv_RunDispatchInternalDeviceControl(actual_po: int, actual_pirp_6: int) returns (Tmp_71: int)
{
  var {:pointer} ps: int;
  ...
  anon0:
    ...
    assume {:nonnull} pirp_6 != 0;
    assume pirp_6 > 0;
    call {:si_unique_call 94} sdv_SetStatus(pirp_6);
    assume {:nonnull} pirp_6 != 0;
    assume pirp_6 > 0;
    assume {:nonnull} pirp_6 != 0;
    assume pirp_6 > 0;
    ...
    assume {:nonnull} ps != 0;
    assume ps > 0;
    call {:si_unique_call 95} sdv_stub_dispatch_begin();
    assume {:nonnull} ps != 0;
    assume ps > 0;
    call {:si_unique_call 96} status := Av_IoControl(po, pirp_6);
    goto anon3_Then, anon3_Else;

  anon3_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 97} sdv_stub_dispatch_end(status, 0);
    assume {:nonnull} pirp_6 != 0;
    assume pirp_6 > 0;
    Tmp_71 := status;
    goto LM2;
...
implementation {:origName "main"} {:osmodel} main() returns (Tmp_75: int, dup_assertVar: bool)
{
  ...
  anon0:
    ...
    call {:si_unique_call 266} vslice_dummy_var_786 := __HAVOC_malloc(96);
    call {:si_unique_call 267} vslice_dummy_var_787 := __HAVOC_malloc(96);
...
implementation {:origName "Av_FDO_PowerComplete"} Av_FDO_PowerComplete(actual_DeviceObject_8: int, actual_Irp_8: int, actual_BusExtensionIn: int) returns (Tmp_151: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 351} structPtr888sdv := PoSetPowerState(0, 1, vslice_dummy_var_788);
...
implementation {:origName "Av1394_Talk"} Av1394_Talk(actual_CipData: int) returns (Tmp_153: int)
{
  ...
  anon5_Else:
    ...
    call {:si_unique_call 353} Status_3 := Av_SubmitIrpSynch(vslice_dummy_var_789, 0, Irb_1);
    goto anon6_Then, anon6_Else;
  ...
  anon6_Else:
    ...
    call {:si_unique_call 354} ExFreeToNPagedLookasideList(vslice_dummy_var_790, Irb_1);
    goto L27;
...
implementation {:origName "Av1394_AttachBuffer"} Av1394_AttachBuffer(actual_CipData_1: int, actual_DescriptorData: int) returns (Tmp_159: int)
{
  ...
  L20:
    ...
    call {:si_unique_call 359} Status_4 := Av_SubmitIrpSynch(vslice_dummy_var_791, 0, Irb_2);
    goto anon9_Then, anon9_Else;
  ...
  anon9_Else:
    ...
    call {:si_unique_call 360} ExFreeToNPagedLookasideList(vslice_dummy_var_792, Irb_2);
    goto L28;
...
implementation {:origName "Av1394_AllocateResources"} Av1394_AllocateResources(actual_CipData_6: int) returns (Tmp_182: int)
{
  ...
  L22:
    ...
    call {:si_unique_call 374} Status_8 := Av_SubmitIrpSynch(vslice_dummy_var_793, 0, Irb_3);
    goto anon12_Then, anon12_Else;
  ...
  L30:
    ...
    call {:si_unique_call 375} ExFreeToNPagedLookasideList(vslice_dummy_var_794, Irb_3);
    goto L34;
...
implementation {:origName "Av1394_Stop"} Av1394_Stop(actual_CipData_9: int) returns (Tmp_192: int)
{
  ...
  anon5_Else:
    ...
    call {:si_unique_call 397} Status_10 := Av_SubmitIrpSynch(vslice_dummy_var_795, 0, Irb_4);
    goto anon6_Then, anon6_Else;
  ...
  anon6_Else:
    ...
    call {:si_unique_call 398} ExFreeToNPagedLookasideList(vslice_dummy_var_796, Irb_4);
    goto L25;
...
implementation {:origName "Av1394_Listen"} Av1394_Listen(actual_CipData_14: int) returns (Tmp_202: int)
{
  ...
  anon5_Else:
    ...
    call {:si_unique_call 419} Status_15 := Av_SubmitIrpSynch(vslice_dummy_var_797, 0, Irb_5);
    goto anon6_Then, anon6_Else;
  ...
  anon6_Else:
    ...
    call {:si_unique_call 420} ExFreeToNPagedLookasideList(vslice_dummy_var_798, Irb_5);
    goto L27;
...
implementation {:origName "AvCip_FreeResources"} AvCip_FreeResources(actual_CipData_18: int) returns (Tmp_211: int)
{
  ...
  anon43_Else:
    ...
    call {:si_unique_call 442} ExFreeToNPagedLookasideList(vslice_dummy_var_799, vslice_dummy_var_800);
    goto L72;
  ...
  anon45_Else:
    ...
    call {:si_unique_call 444} ExFreeToNPagedLookasideList(vslice_dummy_var_801, vslice_dummy_var_802);
    goto L80;
...
implementation {:origName "Av1394_DetachBuffer"} Av1394_DetachBuffer(actual_CipData_19: int, actual_DescriptorData_6: int) returns (Tmp_219: int)
{
  ...
  L20:
    ...
    call {:si_unique_call 458} Status_19 := Av_SubmitIrpSynch(vslice_dummy_var_803, 0, Irb_6);
    goto anon9_Then, anon9_Else;
  ...
  anon9_Else:
    ...
    call {:si_unique_call 459} ExFreeToNPagedLookasideList(vslice_dummy_var_804, Irb_6);
    goto L28;
...
implementation {:origName "Av1394_FreeResources"} Av1394_FreeResources(actual_CipData_20: int) returns (Tmp_224: int)
{
  ...
  anon8_Else:
    ...
    call {:si_unique_call 462} Status_20 := Av_SubmitIrpSynch(vslice_dummy_var_805, 0, Irb_7);
    goto anon9_Then, anon9_Else;
  ...
  L21:
    ...
    call {:si_unique_call 463} ExFreeToNPagedLookasideList(vslice_dummy_var_806, Irb_7);
    goto L25;
...
implementation {:origName "AvCip_AllocateResources"} AvCip_AllocateResources(actual_CipData_22: int) returns (Tmp_228: int)
{
  ...
  anon71_Else:
    ...
    call {:si_unique_call 491} ExFreeToNPagedLookasideList(vslice_dummy_var_807, vslice_dummy_var_808);
    goto L119;
  ...
  anon73_Else:
    ...
    call {:si_unique_call 493} ExFreeToNPagedLookasideList(vslice_dummy_var_809, vslice_dummy_var_810);
    goto L127;
...
implementation {:origName "AvFcp_GetFcpResponse"} AvFcp_GetFcpResponse(actual_PdoExtension_1: int, actual_Irp_17: int, actual_Request_6: int) returns (Tmp_309: int)
{
  ...
  anon17_Then:
    ...
    call {:si_unique_call 574} sdv_RtlCopyMemory(0, 0, vslice_dummy_var_811);
    assume {:nonnull} Length_4 != 0;
    assume Length_4 > 0;
    assume {:nonnull} pResponse != 0;
    assume pResponse > 0;
...
implementation {:origName "AvFcp_GetFcpRequest"} AvFcp_GetFcpRequest(actual_PdoExtension_2: int, actual_Irp_18: int, actual_Request_7: int) returns (Tmp_311: int)
{
  ...
  anon15_Then:
    ...
    call {:si_unique_call 588} sdv_RtlCopyMemory(0, 0, vslice_dummy_var_812);
    assume {:nonnull} FcpRequest != 0;
    assume FcpRequest > 0;
    assume {:nonnull} pRequest != 0;
    assume pRequest > 0;
...
implementation {:origName "AvFcp_SendFcpRequest"} AvFcp_SendFcpRequest(actual_BusExtension_7: int, actual_RequestIrp: int, actual_Request_8: int) returns (Tmp_315: int)
{
  ...
  L68:
    ...
    call {:si_unique_call 634} vslice_dummy_var_67 := sdv_IoCallDriver#1(vslice_dummy_var_813, Irp_19);
    goto anon33_Then, anon33_Else;
...
implementation {:origName "AvFcp_SendFcpResponse"} AvFcp_SendFcpResponse(actual_BusExtension_8: int, actual_RequestIrp_1: int, actual_Request_9: int) returns (Tmp_318: int)
{
  ...
  anon21_Else:
    ...
    call {:si_unique_call 642} boogieTmp := IoAllocateMdl(0, vslice_dummy_var_814, 0, 0, 0);
    assume {:nonnull} CRStruct_1 != 0;
    assume CRStruct_1 > 0;
    havoc Mdl_2;
    goto anon28_Then, anon28_Else;
  ...
  L61:
    ...
    call {:si_unique_call 646} vslice_dummy_var_68 := sdv_IoCallDriver#1(vslice_dummy_var_815, Irp_20);
    goto anon30_Then, anon30_Else;
...
implementation {:origName "AvFcp_SendFcpCR"} AvFcp_SendFcpCR(actual_DeviceObject_12: int, actual_Irp_22: int, actual_CRStructIn: int) returns (Tmp_324: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 661} ExFreeToNPagedLookasideList(IrbPool__BUS_DEVICE_EXTENSION(BusExtension_10), vslice_dummy_var_816);
...
implementation {:origName "AvCmp_P2PCR_oPlug"} AvCmp_P2PCR_oPlug(actual_BusExtension_13: int, actual_CmpData_1: int, actual_Connect_6: int, actual_bReconnect: int, actual_Generation: int) returns (Tmp_340: int)
{
  ...
  anon92_Else:
    ...
    call {:si_unique_call 697} vslice_dummy_var_75 := Av1394_FreeBandwidth(BusExtension_13, Connect_6, vslice_dummy_var_817, BandwidthUnits);
    goto anon115_Then, anon115_Else;
  ...
  anon89_Else:
    ...
    call {:si_unique_call 698} ntStatus_9 := Av1394_ReadPCR(BusExtension_13, Generation, vslice_dummy_var_818, vslice_dummy_var_819, Pcr1);
    goto anon116_Then, anon116_Else;
  ...
  anon118_Else:
    ...
    call {:si_unique_call 700} ntStatus_9 := AvCmp_SetPlugPCR(BusExtension_13, vslice_dummy_var_820, vslice_dummy_var_821, Pcr1, Pcr2, PcrOrg, 1, Generation);
    goto anon119_Then, anon119_Else;
  ...
  anon118_Then:
    ...
    call {:si_unique_call 706} ntStatus_9 := AvCmp_SetPlugPCR(BusExtension_13, vslice_dummy_var_822, vslice_dummy_var_823, Pcr1, Pcr2, PcrOrg, 0, 0);
    goto anon122_Then, anon122_Else;
  ...
  anon108_Else:
    ...
    call {:si_unique_call 710} BandwidthUnits := AvCmp_CalculateBWUnits(Connect_6, vslice_dummy_var_824, vslice_dummy_var_825);
    assume {:nonnull} Connect_6 != 0;
    assume Connect_6 > 0;
    havoc vslice_dummy_var_826;
    call {:si_unique_call 711} ntStatus_9 := Av1394_AllocateBandwidth(BusExtension_13, Connect_6, vslice_dummy_var_826, BandwidthUnits);
    goto anon128_Then, anon128_Else;
  ...
  anon89_Then:
    ...
    call {:si_unique_call 712} ntStatus_9 := AvCmp_GetPlugPCR(BusExtension_13, vslice_dummy_var_827, vslice_dummy_var_828, Pcr1);
    goto anon131_Then, anon131_Else;
...
implementation {:origName "AvCmp_InitCipModule"} AvCmp_InitCipModule(actual_BusExtension_14: int, actual_Connect_7: int, actual_TalkFormat: int) returns (Tmp_359: int)
{
  ...
  L18:
    ...
    call {:si_unique_call 714} Status_30 := AvCip_Create(CipData__AV_CONNECT(Connect_7), vslice_dummy_var_829, vslice_dummy_var_830, IrbPool__BUS_DEVICE_EXTENSION(BusExtension_14), Connect_7, 0, NodeID__BUS_DEVICE_EXTENSION(BusExtension_14));
    goto anon41_Then, anon41_Else;
  ...
  anon41_Else:
    ...
    call {:si_unique_call 715} Status_30 := AvCip_SetTalkFormat(vslice_dummy_var_831, TalkFormat, NodeID__BUS_DEVICE_EXTENSION(BusExtension_14));
    goto anon42_Then, anon42_Else;
  ...
  L30:
    ...
    call {:si_unique_call 716} Status_30 := AvCip_SetCipIsochParameters(vslice_dummy_var_832, vslice_dummy_var_833, vslice_dummy_var_834, vslice_dummy_var_835, vslice_dummy_var_836);
    goto anon43_Then, anon43_Else;
  ...
  anon43_Else:
    ...
    call {:si_unique_call 717} vslice_dummy_var_76 := AvCip_SetCipPacketSize(vslice_dummy_var_837, vslice_dummy_var_838);
    assume {:nonnull} Connect_7 != 0;
    assume Connect_7 > 0;
    havoc vslice_dummy_var_839;
    havoc vslice_dummy_var_840;
    call {:si_unique_call 718} vslice_dummy_var_77 := AvCip_SetSpeed(vslice_dummy_var_839, vslice_dummy_var_840);
    assume {:nonnull} Connect_7 != 0;
    assume Connect_7 > 0;
    havoc vslice_dummy_var_841;
    havoc vslice_dummy_var_842;
    call {:si_unique_call 719} vslice_dummy_var_78 := AvCip_SetChannel(vslice_dummy_var_841, vslice_dummy_var_842);
    goto anon51_Then, anon51_Else;
  ...
  L49:
    ...
    call {:si_unique_call 720} Status_30 := AvCip_Create(CipData__AV_CONNECT(Connect_7), vslice_dummy_var_843, vslice_dummy_var_844, IrbPool__BUS_DEVICE_EXTENSION(BusExtension_14), Connect_7, 1, NodeID__BUS_DEVICE_EXTENSION(BusExtension_14));
    goto anon48_Then, anon48_Else;
...
implementation {:origName "AvCmp_CreateCMPAddressRange"} AvCmp_CreateCMPAddressRange(actual_BusExtension_15: int, actual_CmpData_2: int, actual_PlugType: int) returns (Tmp_361: int)
{
  ...
  L38:
    ...
    call {:si_unique_call 723} ntStatus_10 := Av_SubmitIrpSynch(vslice_dummy_var_845, Irp_25, Irb_10);
    goto anon35_Then, anon35_Else;
...
implementation {:origName "AvCmp_SetPlugPCR"} AvCmp_SetPlugPCR(actual_BusExtension_16: int, actual_Type_3: int, actual_Index: int, actual_PcrRef: int, actual_PcrSet: int, actual_PcrOrg_1: int, actual_bGeneration: int, actual_Generation_1: int) returns (Tmp_364: int)
{
  ...
  anon11_Else:
    ...
    call {:si_unique_call 726} ntStatus_11 := Av1394_LockedSwap(BusExtension_16, vslice_dummy_var_846, vslice_dummy_var_847, pUlong3, Tmp_367, bGeneration, Generation_1);
    goto anon14_Then, anon14_Else;
  ...
  anon13_Then:
    ...
    call {:si_unique_call 727} ntStatus_11 := Av1394_LockedSwap(BusExtension_16, vslice_dummy_var_848, vslice_dummy_var_849, pUlong3, Tmp_366, bGeneration, Generation_1);
    goto anon15_Then, anon15_Else;
...
implementation {:origName "AvCmp_SetUnitCapabilities"} AvCmp_SetUnitCapabilities(actual_BusExtension_19: int, actual_Irp_28: int, actual_Request_15: int) returns (Tmp_383: int)
{
  ...
  anon23_Else:
    ...
    call {:si_unique_call 746} vslice_dummy_var_79 := AvCmp_DestroyCmpData(BusExtension_19, vslice_dummy_var_850);
    goto anon27_Then, anon27_Else;
...
implementation {:origName "AvCmp_Connect"} AvCmp_Connect(actual_BusExtension_20: int, actual_Irp_29: int, actual_Request_16: int) returns (Tmp_385: int)
{
  ...
  L19:
    ...
    call {:si_unique_call 747} ntStatus_15 := AvCmp_P2PConnect(BusExtension_20, vslice_dummy_var_851, iPlug_2, oPlug_2, Format__CMP_CONNECT_VER3(Connect_8), vslice_dummy_var_852, phConnect);
    goto anon9_Then, anon9_Else;
...
implementation {:origName "AvCmp_GetPlugState"} AvCmp_GetPlugState(actual_BusExtension_21: int, actual_Irp_30: int, actual_Request_17: int) returns (Tmp_391: int)
{
  ...
  anon19_Else:
    ...
    call {:si_unique_call 752} ntStatus_16 := AvCmp_GetPlugPCR(BusExtension_21, vslice_dummy_var_853, vslice_dummy_var_854, Pcr_2);
    goto anon24_Then, anon24_Else;
...
implementation {:origName "AvCmp_P2PConnect"} AvCmp_P2PConnect(actual_BusExtension_22: int, actual_ConnectType: int, actual_iPlug_3: int, actual_oPlug_3: int, actual_Format_3: int, actual_DDIVersion_2: int, actual_pConnect: int) returns (Tmp_398: int)
{
  ...
  L60_last:
    ...
    call {:si_unique_call 770} ntStatus_17 := AvCmp_P2PCR_oPlug(vslice_dummy_var_855, CmpData_6, Connect_9, 0, 0);
    goto anon92_Then, anon92_Else;
  ...
  L92_last:
    ...
    call {:si_unique_call 771} ntStatus_17 := AvCmp_P2PCR_iPlug(vslice_dummy_var_856, CmpData_6, Connect_9, 0, 0);
    goto anon95_Then, anon95_Else;
...
implementation {:origName "AvCmp_FreeCMPAddressRange"} AvCmp_FreeCMPAddressRange(actual_BusExtension_25: int, actual_CmpData_8: int, actual_PlugType_1: int) returns (Tmp_429: int)
{
  ...
  L28:
    ...
    call {:si_unique_call 780} ntStatus_19 := Av_SubmitIrpSynch(vslice_dummy_var_857, Irp_32, Irb_11);
    goto anon21_Then, anon21_Else;
...
implementation {:origName "AvCmp_P2PDisconnect"} AvCmp_P2PDisconnect(actual_BusExtension_27: int, actual_Connect_12: int) returns (Tmp_436: int)
{
  ...
  anon171_Else:
    ...
    call {:si_unique_call 800} vslice_dummy_var_84 := AvCip_Destroy(vslice_dummy_var_858);
  ...
  anon136_Else:
    ...
    call {:si_unique_call 801} ntStatus_21 := AvCmp_GetPlugPCR(vslice_dummy_var_859, vslice_dummy_var_860, vslice_dummy_var_861, Pcr1_1);
  ...
  anon184_Else:
    ...
    call {:si_unique_call 804} ntStatus_21 := AvCmp_SetPlugPCR(vslice_dummy_var_862, vslice_dummy_var_863, vslice_dummy_var_864, Pcr1_1, Pcr2_1, PcrOrg_2, 0, 0);
  ...
  anon148_Else:
    ...
    call {:si_unique_call 811} BandwidthUnits_4 := AvCmp_CalculateBWUnits(Connect_12, vslice_dummy_var_865, vslice_dummy_var_866);
    assume {:nonnull} Connect_12 != 0;
    assume Connect_12 > 0;
    havoc vslice_dummy_var_867;
    call {:si_unique_call 812} ntStatus_21 := Av1394_FreeBandwidth(BusExtension_27, Connect_12, vslice_dummy_var_867, BandwidthUnits_4);
  ...
  L147:
    ...
    call {:si_unique_call 813} ntStatus_21 := AvCmp_GetPlugPCR(vslice_dummy_var_868, vslice_dummy_var_869, vslice_dummy_var_870, Pcr1_1);
  ...
  L160:
    ...
    call {:si_unique_call 814} ntStatus_21 := AvCmp_SetPlugPCR(vslice_dummy_var_871, vslice_dummy_var_872, vslice_dummy_var_873, Pcr1_1, Pcr2_1, PcrOrg_2, 0, 0);
  ...
  anon165_Else:
    ...
    call {:si_unique_call 822} BandwidthUnits_2 := AvCmp_CalculateBWUnits(Connect_12, vslice_dummy_var_874, vslice_dummy_var_875);
    assume {:nonnull} Connect_12 != 0;
    assume Connect_12 > 0;
    havoc vslice_dummy_var_876;
    call {:si_unique_call 823} ntStatus_21 := Av1394_FreeBandwidth(BusExtension_27, Connect_12, vslice_dummy_var_876, BandwidthUnits_2);
  ...
  anon169_Else:
    ...
    call {:si_unique_call 826} ntStatus_21 := Av1394_FreeBandwidth(BusExtension_27, Connect_12, vslice_dummy_var_877, BandwidthUnits_3);
...
implementation {:origName "AvCmp_P2PCR_iPlug"} AvCmp_P2PCR_iPlug(actual_BusExtension_30: int, actual_CmpData_12: int, actual_Connect_13: int, actual_bReconnect_1: int, actual_Generation_2: int) returns (Tmp_473: int)
{
  ...
  anon108_Else:
    ...
    call {:si_unique_call 873} vslice_dummy_var_89 := Av1394_FreeBandwidth(BusExtension_30, Connect_13, vslice_dummy_var_878, BandwidthUnits_5);
    goto anon137_Then, anon137_Else;
  ...
  anon109_Else:
    ...
    call {:si_unique_call 874} ntStatus_24 := Av1394_ReadPCR(BusExtension_30, Generation_2, vslice_dummy_var_879, vslice_dummy_var_880, Pcr1_2);
    goto anon138_Then, anon138_Else;
  ...
  anon140_Else:
    ...
    call {:si_unique_call 875} ntStatus_24 := AvCmp_SetPlugPCR(BusExtension_30, vslice_dummy_var_881, vslice_dummy_var_882, Pcr1_2, Pcr2_2, PcrOrg_3, 1, Generation_2);
    goto anon141_Then, anon141_Else;
  ...
  anon140_Then:
    ...
    call {:si_unique_call 882} ntStatus_24 := AvCmp_SetPlugPCR(BusExtension_30, vslice_dummy_var_883, vslice_dummy_var_884, Pcr1_2, Pcr2_2, PcrOrg_3, 0, 0);
    goto anon144_Then, anon144_Else;
  ...
  anon113_Else:
    ...
    call {:si_unique_call 884} ntStatus_24 := Av1394_AllocateChannel(BusExtension_30, Connect_13, vslice_dummy_var_885);
    goto anon148_Then, anon148_Else;
  ...
  anon124_Else:
    ...
    call {:si_unique_call 886} ntStatus_24 := Av1394_AllocateBandwidth(BusExtension_30, Connect_13, vslice_dummy_var_886, BandwidthUnits_5);
    goto anon149_Then, anon149_Else;
  ...
  L173:
    ...
    call {:si_unique_call 891} ntStatus_24 := Av1394_AllocateBandwidth(BusExtension_30, Connect_13, vslice_dummy_var_887, BandwidthUnits_5);
    goto anon153_Then, anon153_Else;
  ...
  anon109_Then:
    ...
    call {:si_unique_call 893} ntStatus_24 := AvCmp_GetPlugPCR(BusExtension_30, vslice_dummy_var_888, vslice_dummy_var_889, Pcr1_2);
    goto anon156_Then, anon156_Else;
...
implementation {:origName "Av1394_RemoveConfigRomEntry"} Av1394_RemoveConfigRomEntry(actual_CromData: int) returns (Tmp_512: int)
{
  ...
  anon26_Else:
    ...
    call {:si_unique_call 914} ntStatus_26 := Av_SubmitIrpSynch(vslice_dummy_var_890, Irp_35, Irb_12);
    goto anon27_Then, anon27_Else;
...
implementation {:origName "Av1394_FreeBandwidth"} Av1394_FreeBandwidth(actual_BusExtension_33: int, actual_Connect_14: int, actual_Speed_1: int, actual_BandwidthUnits_6: int) returns (Tmp_517: int)
{
  ...
  anon18_Else:
    ...
    call {:si_unique_call 924} ntStatus_27 := Av_SubmitIrpSynch(vslice_dummy_var_891, Irp_36, Irb_13);
    goto anon21_Then, anon21_Else;
...
implementation {:origName "Av1394_FreeChannel"} Av1394_FreeChannel(actual_BusExtension_34: int, actual_Connect_15: int) returns (Tmp_520: int)
{
  ...
  anon18_Else:
    ...
    call {:si_unique_call 929} ntStatus_28 := Av_SubmitIrpSynch(vslice_dummy_var_892, Irp_37, Irb_14);
    goto anon21_Then, anon21_Else;
...
implementation {:origName "Av1394_AllocateChannel"} Av1394_AllocateChannel(actual_BusExtension_35: int, actual_Connect_16: int, actual_Channel_1: int) returns (Tmp_523: int)
{
  ...
  anon20_Else:
    ...
    call {:si_unique_call 934} ntStatus_29 := Av_SubmitIrpSynch(vslice_dummy_var_893, Irp_38, Irb_15);
    goto anon24_Then, anon24_Else;
...
implementation {:origName "Av1394_AllocateBandwidth"} Av1394_AllocateBandwidth(actual_BusExtension_36: int, actual_Connect_17: int, actual_Speed_2: int, actual_BandwidthUnits_7: int) returns (Tmp_528: int)
{
  ...
  anon20_Else:
    ...
    call {:si_unique_call 940} ntStatus_30 := Av_SubmitIrpSynch(vslice_dummy_var_894, Irp_39, Irb_16);
    goto anon24_Then, anon24_Else;
...
implementation {:origName "Av1394_BusReset"} Av1394_BusReset(actual_BusExtension_38: int, actual_UnusedIrp: int, actual_Request_22: int) returns (Tmp_534: int)
{
  ...
  L40:
    ...
    call {:si_unique_call 965} ntStatus_32 := Av_SubmitIrpSynch(vslice_dummy_var_895, Irp_41, Irb_17);
    goto anon24_Then, anon24_Else;
...
implementation {:origName "Av1394_ReadPCR"} Av1394_ReadPCR(actual_BusExtension_39: int, actual_GenerationCount: int, actual_Type_6: int, actual_Index_2: int, actual_Pcr_8: int) returns (Tmp_541: int)
{
  ...
  L57:
    ...
    call {:si_unique_call 972} ntStatus_34 := Av_SubmitIrpSynch(vslice_dummy_var_896, Irp_43, Irb_18);
    goto anon38_Then, anon38_Else;
...
implementation {:origName "Av1394_AddConfigRomEntry"} Av1394_AddConfigRomEntry(actual_CromData_3: int) returns (Tmp_545: int)
{
  ...
  anon25_Then:
    ...
    call {:si_unique_call 984} ntStatus_35 := Av_SubmitIrpSynch(vslice_dummy_var_897, Irp_44, Irb_19);
    goto anon33_Then, anon33_Else;
...
implementation {:origName "Av1394_QuadletRead"} Av1394_QuadletRead(actual_BusExtension_41: int, actual_pData_1: int, actual_Address_1: int) returns (Tmp_550: int)
{
  ...
  anon27_Else:
    ...
    call {:si_unique_call 991} ntStatus_36 := Av_SubmitIrpSynch(vslice_dummy_var_898, Irp_45, Irb_20);
    goto anon34_Then, anon34_Else;
...
implementation {:origName "Av1394_GetGenerationCount"} Av1394_GetGenerationCount(actual_BusExtension_42: int) returns (Tmp_554: int)
{
  ...
  anon20_Else:
    ...
    call {:si_unique_call 1002} ntStatus_37 := Av_SubmitIrpSynch(vslice_dummy_var_899, Irp_46, Irb_21);
    goto anon24_Then, anon24_Else;
...
implementation {:origName "Av1394_LockedSwap"} Av1394_LockedSwap(actual_BusExtension_43: int, actual_Argument: int, actual_Data: int, actual_pOldValue: int, actual_Address_2: int, actual_bGeneration_1: int, actual_Generation_3: int) returns (Tmp_557: int)
{
  ...
  L45:
    ...
    call {:si_unique_call 1006} ntStatus_38 := Av_SubmitIrpSynch(vslice_dummy_var_900, Irp_47, Irb_22);
    goto anon34_Then, anon34_Else;
...
implementation {:origName "AvCip_ProcessAttachBuffer"} AvCip_ProcessAttachBuffer#0(actual_CipData_23: int, actual_DescriptorData_8: int) returns (Tmp_267: int)
{
  ...
  anon17_Then:
    ...
    call {:si_unique_call 1064} IoReuseIrp(vslice_dummy_var_901, 0);
  ...
  L27:
    ...
    call {:si_unique_call 1066} NextIrpStack_1 := sdv_IoGetNextIrpStackLocation(vslice_dummy_var_902);
  ...
  L36:
    ...
    call {:si_unique_call 1068} sdv_IoSetCompletionRoutine(vslice_dummy_var_903, li2bplFunctionConstant253, DescriptorData_8, 1, 1, 1);
    assume {:nonnull} CipData_23 != 0;
    assume CipData_23 > 0;
    assume {:nonnull} DescriptorData_8 != 0;
    assume DescriptorData_8 > 0;
...
implementation {:origName "AvCip_ProcessAttachBuffer"} AvCip_ProcessAttachBuffer#1(actual_CipData_23: int, actual_DescriptorData_8: int) returns (Tmp_267: int)
{
  ...
  anon17_Then:
    ...
    call {:si_unique_call 1073} IoReuseIrp(vslice_dummy_var_904, 0);
  ...
  L27:
    ...
    call {:si_unique_call 1075} NextIrpStack_1 := sdv_IoGetNextIrpStackLocation(vslice_dummy_var_905);
    assume {:nonnull} NextIrpStack_1 != 0;
    assume NextIrpStack_1 > 0;
    assume {:nonnull} NextIrpStack_1 != 0;
    assume NextIrpStack_1 > 0;
  ...
  L36:
    ...
    call {:si_unique_call 1077} sdv_IoSetCompletionRoutine(vslice_dummy_var_906, li2bplFunctionConstant253, DescriptorData_8, 1, 1, 1);
    assume {:nonnull} CipData_23 != 0;
    assume CipData_23 > 0;
    assume {:nonnull} DescriptorData_8 != 0;
    assume DescriptorData_8 > 0;
    ...
    call {:si_unique_call 1078} Status_23 := sdv_IoCallDriver#0(vslice_dummy_var_907, vslice_dummy_var_908);
    goto anon23_Then, anon23_Else;
...
implementation {:origName "IofCallDriver"} {:osmodel} IofCallDriver#0(actual_DeviceObject_4: int, actual_Irp_5: int) returns (Tmp_117: int)
{
  ...
  anon55_Then:
    ...
    call {:si_unique_call 1085} vslice_dummy_var_122 := sdv_RunIoCompletionRoutines#0(sdv_p_devobj_fdo, Irp_5, vslice_dummy_var_909, completion);
    goto anon76_Then, anon76_Else;
  ...
  anon67_Else:
    ...
    call {:si_unique_call 1086} vslice_dummy_var_125 := sdv_RunIoCompletionRoutines#0(sdv_p_devobj_fdo, Irp_5, vslice_dummy_var_910, completion);
    goto anon78_Then, anon78_Else;
  ...
  anon59_Else:
    ...
    call {:si_unique_call 1087} vslice_dummy_var_123 := sdv_RunIoCompletionRoutines#0(sdv_p_devobj_fdo, Irp_5, vslice_dummy_var_911, completion);
    goto anon74_Then, anon74_Else;
  ...
  anon63_Else:
    ...
    call {:si_unique_call 1088} vslice_dummy_var_124 := sdv_RunIoCompletionRoutines#0(sdv_p_devobj_fdo, Irp_5, vslice_dummy_var_912, completion);
    goto anon72_Then, anon72_Else;
...
implementation {:origName "IofCallDriver"} {:osmodel} IofCallDriver#1(actual_DeviceObject_4: int, actual_Irp_5: int) returns (Tmp_117: int)
{
  ...
  anon55_Then:
    ...
    call {:si_unique_call 1090} vslice_dummy_var_126 := sdv_RunIoCompletionRoutines#1(sdv_p_devobj_fdo, Irp_5, vslice_dummy_var_913, completion);
    goto anon76_Then, anon76_Else;
  ...
  anon67_Else:
    ...
    call {:si_unique_call 1091} vslice_dummy_var_129 := sdv_RunIoCompletionRoutines#1(sdv_p_devobj_fdo, Irp_5, vslice_dummy_var_914, completion);
    goto anon78_Then, anon78_Else;
  ...
  anon59_Else:
    ...
    call {:si_unique_call 1092} vslice_dummy_var_127 := sdv_RunIoCompletionRoutines#1(sdv_p_devobj_fdo, Irp_5, vslice_dummy_var_915, completion);
    goto anon74_Then, anon74_Else;
  ...
  anon63_Else:
    ...
    call {:si_unique_call 1093} vslice_dummy_var_128 := sdv_RunIoCompletionRoutines#1(sdv_p_devobj_fdo, Irp_5, vslice_dummy_var_916, completion);
    goto anon72_Then, anon72_Else;
...
implementation AvCip_FreeResources_loop_L11(in_Tmp_212: int, in_Tmp_213: int, in_sdv_123: int, in_Status_18: int, in_sdv_124: int, in_DescriptorData_5: int, in_sdv_127: int, in_sdv_130: int, in_Tmp_216: int, in_PriorState: int, in_Tmp_217: int, in_Tmp_218: int, in_Irql_5: int, in_CipData_18: int, in_vslice_dummy_var_45: int, in_vslice_dummy_var_46: int, in_vslice_dummy_var_47: int) returns (out_Tmp_212: int, out_Tmp_213: int, out_sdv_123: int, out_Status_18: int, out_sdv_124: int, out_DescriptorData_5: int, out_sdv_127: int, out_sdv_130: int, out_Tmp_216: int, out_PriorState: int, out_Tmp_217: int, out_Tmp_218: int, out_Irql_5: int, out_vslice_dummy_var_45: int, out_vslice_dummy_var_46: int, out_vslice_dummy_var_47: int)
{
  ...
  anon43_Else:
    ...
    call {:si_unique_call 1161} ExFreeToNPagedLookasideList(vslice_dummy_var_919, vslice_dummy_var_920);
    goto L72;
  ...
  anon45_Else:
    ...
    call {:si_unique_call 1159} ExFreeToNPagedLookasideList(vslice_dummy_var_917, vslice_dummy_var_918);
    goto L80;
...
implementation AvCmp_P2PConnect_loop_L60(in_Retries: int, in_CmpData_6: int, in_Connect_9: int, in_ntStatus_17: int, in_Tmp_406: int, in_oPlug_3: int) returns (out_Retries: int, out_ntStatus_17: int, out_Tmp_406: int)
{
  ...
  L60:
    ...
    call {:si_unique_call 1227} out_ntStatus_17 := AvCmp_P2PCR_oPlug(vslice_dummy_var_921, in_CmpData_6, in_Connect_9, 0, 0);
    goto anon92_Else;
...
implementation AvCmp_P2PConnect_loop_L92(in_CmpData_6: int, in_Tmp_402: int, in_Connect_9: int, in_Retries_1: int, in_ntStatus_17: int, in_iPlug_3: int) returns (out_Tmp_402: int, out_Retries_1: int, out_ntStatus_17: int)
{
  ...
  L92:
    ...
    call {:si_unique_call 1229} out_ntStatus_17 := AvCmp_P2PCR_iPlug(vslice_dummy_var_922, in_CmpData_6, in_Connect_9, 0, 0);
    goto anon95_Else;
...
implementation Av1394_ReadPCR_loop_L22(in_Retries_2: int, in_Irp_43: int, in_Irb_18: int, in_Mdl_3: int, in_StackSize_12: int, in_sdv_346: int, in_ntStatus_34: int, in_Tmp_543: int, in_BusExtension_39: int, in_GenerationCount: int, in_Type_6: int, in_Index_2: int) returns (out_Retries_2: int, out_Irp_43: int, out_Irb_18: int, out_Mdl_3: int, out_sdv_346: int, out_ntStatus_34: int, out_Tmp_543: int)
{
  ...
  L57:
    ...
    call {:si_unique_call 1236} out_ntStatus_34 := Av_SubmitIrpSynch(vslice_dummy_var_923, out_Irp_43, out_Irb_18);
    goto anon38_Else;
...
implementation Av1394_QuadletRead_loop_L17(in_Retries_3: int, in_Irp_45: int, in_Mdl_4: int, in_Irb_20: int, in_Tmp_551: int, in_StackSize_14: int, in_sdv_357: int, in_ntStatus_36: int, in_BusExtension_41: int, in_Address_1: int, in_vslice_dummy_var_103: int) returns (out_Retries_3: int, out_Irp_45: int, out_Mdl_4: int, out_Irb_20: int, out_Tmp_551: int, out_sdv_357: int, out_ntStatus_36: int, out_vslice_dummy_var_103: int)
{
  ...
  anon27_Else:
    ...
    call {:si_unique_call 1244} out_ntStatus_36 := Av_SubmitIrpSynch(vslice_dummy_var_924, out_Irp_45, out_Irb_20);
    goto anon34_Else;
...
implementation Av1394_LockedSwap_loop_L16(in_Retries_4: int, in_Irp_47: int, in_Irb_22: int, in_Tmp_560: int, in_StackSize_16: int, in_Tmp_561: int, in_sdv_365: int, in_ntStatus_38: int, in_Tmp_562: int, in_BusExtension_43: int, in_Argument: int, in_Data: int, in_pOldValue: int, in_Address_2: int, in_bGeneration_1: int, in_Generation_3: int, in_vslice_dummy_var_104: int) returns (out_Retries_4: int, out_Irp_47: int, out_Irb_22: int, out_Tmp_560: int, out_Tmp_561: int, out_sdv_365: int, out_ntStatus_38: int, out_Tmp_562: int, out_vslice_dummy_var_104: int)
{
  ...
  L45:
    ...
    call {:si_unique_call 1252} out_ntStatus_38 := Av_SubmitIrpSynch(vslice_dummy_var_925, out_Irp_47, out_Irb_22);
    goto anon34_Else;
