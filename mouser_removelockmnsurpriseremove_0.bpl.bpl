...
procedure {:origName "CSerPowerUp"} CSerPowerUp(actual_DeviceExtension: int) returns (Tmp_2: int);
  modifies alloc, Mem_T.Status__IO_STATUS_BLOCK, yogi_error, LockDepth, Mem_T.CompletionRoutine__IO_STACK_LOCATION;
...
implementation {:origName "CSerPowerUp"} CSerPowerUp(actual_DeviceExtension: int) returns (Tmp_2: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 6} status := SerialMousepIoSyncIoctl(0, 1769508, vslice_dummy_var_301, event, iosb);
  ...
  anon12_Else:
    ...
    call {:si_unique_call 7} status := SerialMousepIoSyncIoctl(0, 1769520, vslice_dummy_var_302, event, iosb);
  ...
  anon13_Else:
    ...
    call {:si_unique_call 8} status := SerialMousepIoSyncIoctlEx(0, 1769576, vslice_dummy_var_303, event, iosb, 0, 0, bits, 4);
...
procedure {:origName "CSerDetect"} CSerDetect(actual_DeviceExtension_3: int, actual_HardwareButtons: int) returns (Tmp_17: int);
  modifies alloc, Mem_T.Status__IO_STATUS_BLOCK, Mem_T.CompletionRoutine__IO_STACK_LOCATION, yogi_error, LockDepth;
  free ensures {:va_keep} old(t) == 0 ==> yogi_error == 0;
  free ensures {:va_keep} yogi_error == 1 || yogi_error == old(yogi_error);
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} false || old(t) == 1 || old(t) == 0;
...
procedure {:origName "SerialMouseSendWaitMaskIrp"} SerialMouseSendWaitMaskIrp(actual_DeviceExtension_5: int) returns (Tmp_31: int);
  modifies alloc, LockDepth, Mem_T.Status__IO_STATUS_BLOCK, Mem_T.CompletionRoutine__IO_STACK_LOCATION, yogi_error;
  free ensures {:va_keep} old(t) == 0 ==> yogi_error == 0;
  free ensures {:va_keep} yogi_error == 1 || yogi_error == old(yogi_error);
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} false || old(t) == 1 || old(t) == 0;
...
implementation {:origName "SerialMouseSendWaitMaskIrp"} SerialMouseSendWaitMaskIrp(actual_DeviceExtension_5: int) returns (Tmp_31: int)
{
  ...
  anon5_Else:
    ...
    call {:si_unique_call 50} Tmp_31 := sdv_IoCallDriver#1(vslice_dummy_var_304, irp);
    goto anon6_Then, anon6_Else;
...
implementation {:origName "SerialMouseSerialMaskEventComplete"} SerialMouseSerialMaskEventComplete(actual_DeviceObject: int, actual_Irp: int, actual_Context: int) returns (Tmp_35: int)
{
  ...
  L14:
    ...
    call {:si_unique_call 53} vslice_dummy_var_23 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(deviceExtension), vslice_dummy_var_305);
...
procedure {:origName "SerialMouseStartDetection"} SerialMouseStartDetection(actual_DeviceExtension_6: int);
  modifies alloc, Mem_T.Status__IO_STATUS_BLOCK, LockDepth, Mem_T.CompletionRoutine__IO_STACK_LOCATION, yogi_error;
  free ensures {:va_keep} old(t) == 0 ==> yogi_error == 0;
  free ensures {:va_keep} yogi_error == 1 || yogi_error == old(yogi_error);
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} false || old(t) == 1 || old(t) == 0;
...
implementation {:origName "SerialMouseStartDetection"} SerialMouseStartDetection(actual_DeviceExtension_6: int)
{
  ...
  L29:
    ...
    call {:si_unique_call 66} status_4 := SerialMousepIoSyncIoctlEx(0, 1769540, vslice_dummy_var_306, event_1, iosb_1, waitMask, 4, 0, 0);
  ...
  anon35_Then:
    ...
    call {:si_unique_call 69} boogieTmp := IoAllocateIrp(vslice_dummy_var_307, 0);
    assume {:nonnull} DeviceExtension_6 != 0;
    assume DeviceExtension_6 > 0;
  ...
  anon28_Then:
    ...
    call {:si_unique_call 70} status_4 := SerialMousepIoSyncIoctlEx(0, 1769576, vslice_dummy_var_308, event_1, iosb_1, 0, 0, bits_1, 4);
...
implementation {:origName "SerialMouseSetBaudRate"} SerialMouseSetBaudRate(actual_DeviceExtension_9: int, actual_BaudRate_1: int) returns (Tmp_48: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 91} status_6 := SerialMousepIoSyncIoctlEx(0, 1769476, vslice_dummy_var_309, event_2, iosb_2, sbr, 4, 0, 0);
    goto anon3_Then, anon3_Else;
...
implementation {:origName "SerialMouseFlushReadBuffer"} SerialMouseFlushReadBuffer(actual_DeviceExtension_12: int) returns (Tmp_56: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 104} status_9 := SerialMousepIoSyncIoctlEx(0, 1769548, vslice_dummy_var_310, event_3, iosb_5, bits_2, 4, 0, 0);
    goto anon3_Then, anon3_Else;
...
implementation {:origName "SerialMouseSetFifo"} SerialMouseSetFifo(actual_DeviceExtension_13: int, actual_Value_2: int) returns (Tmp_58: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 110} status_10 := SerialMousepIoSyncIoctlEx(0, 1769628, vslice_dummy_var_311, event_4, iosb_6, fifo, 4, 0, 0);
    goto anon3_Then, anon3_Else;
...
implementation {:origName "SerialMouseSetLineCtrl"} SerialMouseSetLineCtrl(actual_DeviceExtension_14: int, actual_SerialLineControl: int) returns (Tmp_60: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 115} status_11 := SerialMousepIoSyncIoctlEx(0, 1769484, vslice_dummy_var_312, event_5, iosb_7, SerialLineControl, 3, 0, 0);
    goto anon3_Then, anon3_Else;
...
procedure {:origName "sdv_RunSurpriseRemoveDevice"} {:osmodel} sdv_RunSurpriseRemoveDevice(actual_po: int, actual_pirp: int) returns (Tmp_66: int);
  modifies t, Mem_T.CompletionRoutine__IO_STACK_LOCATION, alloc, Mem_T.Status__IO_STATUS_BLOCK, LockDepth, Mem_T.ReadIrp__DEVICE_EXTENSION, yogi_error;
  free ensures {:va_keep} old(t) == 1 ==> t != 0;
  free ensures {:va_keep} old(t) == 0 ==> t != 0;
  free ensures {:va_keep} yogi_error == 1 || yogi_error == old(yogi_error);
  free ensures {:va_keep} t == 1;
...
procedure {:nohoudini} {:origName "sdv_main"} {:osmodel} sdv_main();
  modifies alloc, t, Mem_T.CompletionRoutine__IO_STACK_LOCATION, Mem_T.ReadIrp__DEVICE_EXTENSION, Mem_T.Status__IO_STATUS_BLOCK, LockDepth, yogi_error;
  free ensures {:va_keep} yogi_error == 1 || yogi_error == old(yogi_error);
  free ensures {:va_keep} t == 1;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} false || old(t) == 1 || old(t) == 0;
...
procedure {:nohoudini} {:origName "main"} {:osmodel} {:entrypoint} main() returns (Tmp_122: int, dup_assertVar: bool);
  modifies alloc, t, LockDepth, yogi_error, Mem_T.CompletionRoutine__IO_STACK_LOCATION, Mem_T.ReadIrp__DEVICE_EXTENSION, Mem_T.Status__IO_STATUS_BLOCK;
...
implementation {:origName "main"} {:osmodel} main() returns (Tmp_122: int, dup_assertVar: bool)
{
  ...
  anon0:
    ...
    call {:si_unique_call 202} vslice_dummy_var_313 := __HAVOC_malloc(32);
    call {:si_unique_call 203} vslice_dummy_var_314 := __HAVOC_malloc(72);
    call {:si_unique_call 204} vslice_dummy_var_315 := __HAVOC_malloc(16);
    call {:si_unique_call 205} vslice_dummy_var_316 := __HAVOC_malloc(120);
    call {:si_unique_call 206} vslice_dummy_var_317 := __HAVOC_malloc(12);
    call {:si_unique_call 207} vslice_dummy_var_318 := __HAVOC_malloc(48);
    call {:si_unique_call 208} vslice_dummy_var_319 := __HAVOC_malloc(12);
...
procedure {:origName "sdv_RunRemoveDevice"} {:osmodel} sdv_RunRemoveDevice(actual_po_1: int, actual_pirp_8: int) returns (Tmp_132: int);
  modifies Mem_T.CompletionRoutine__IO_STACK_LOCATION, alloc, Mem_T.Status__IO_STATUS_BLOCK, LockDepth, Mem_T.ReadIrp__DEVICE_EXTENSION, yogi_error;
  free ensures {:va_keep} old(t) == 0 ==> yogi_error == 0;
  free ensures {:va_keep} yogi_error == 1 || yogi_error == old(yogi_error);
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} false || old(t) == 1 || old(t) == 0;
...
implementation {:origName "IoReuseIrp"} {:osmodel} IoReuseIrp(actual_Irp_2: int, actual_Status: int)
{
  ...
  anon0:
    ...
    assume Irp_2 > 0;
    Mem_T.Status__IO_STATUS_BLOCK[Status__IO_STATUS_BLOCK(IoStatus__IRP(Irp_2))] := Status;
    return;
}
...
procedure {:origName "SerialMouseReadSerialPortComplete"} SerialMouseReadSerialPortComplete(actual_DeviceObject_11: int, actual_Irp_6: int, actual_EventIn: int) returns (Tmp_208: int);
...
implementation {:origName "SerialMouseReadSerialPortComplete"} SerialMouseReadSerialPortComplete(actual_DeviceObject_11: int, actual_Irp_6: int, actual_EventIn: int) returns (Tmp_208: int)
{
...
implementation {:origName "SerialMouseRestorePort"} SerialMouseRestorePort(actual_DeviceExtension_16: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 255} status_18 := SerialMousepIoSyncIoctlEx(1, 1769488, vslice_dummy_var_320, event_6, iosb_8, SerialBasicSettings__DEVICE_EXTENSION(DeviceExtension_16), 44, 0, 0);
    goto anon10_Then, anon10_Else;
  ...
  anon9_Else:
    ...
    call {:si_unique_call 256} vslice_dummy_var_65 := SerialMousepIoSyncIoctlEx(0, 1769500, vslice_dummy_var_321, event_6, iosb_8, Timeouts__SERIAL_BASIC_SETTINGS(SerialBasicSettings__DEVICE_EXTENSION(DeviceExtension_16)), 20, 0, 0);
    goto anon11_Then, anon11_Else;
  ...
  anon11_Else:
    ...
    call {:si_unique_call 257} vslice_dummy_var_66 := SerialMousepIoSyncIoctlEx(0, 1769572, vslice_dummy_var_322, event_6, iosb_8, HandFlow__SERIAL_BASIC_SETTINGS(SerialBasicSettings__DEVICE_EXTENSION(DeviceExtension_16)), 16, 0, 0);
    goto anon12_Then, anon12_Else;
...
implementation {:origName "SerialMouseWriteSerialPort"} SerialMouseWriteSerialPort(actual_DeviceExtension_17: int, actual_WriteBuffer: int, actual_NumBytes: int, actual_IoStatusBlock_2: int) returns (Tmp_212: int)
{
  ...
  anon7_Else:
    ...
    call {:si_unique_call 262} status_19 := sdv_IoCallDriver#1(vslice_dummy_var_323, irp_2);
    goto anon9_Then, anon9_Else;
  ...
  anon8_Else:
    ...
    call {:si_unique_call 263} status_19 := KeWaitForSingleObject(0, 0, 0, 0, 0);
    goto L24;
...
implementation {:origName "SerialMouseReadSerialPort"} SerialMouseReadSerialPort(actual_DeviceExtension_18: int, actual_ReadBuffer: int, actual_Buflen: int, actual_ActualBytesRead: int) returns (Tmp_216: int)
{
  ...
  L21:
    call {:si_unique_call 268} status_20, stack_1 := SerialMouseReadSerialPort_loop_L21(irp_3, status_20, event_8, stack_1, DeviceExtension_18, ReadBuffer, Buflen, ActualBytesRead);
    goto L21_last;
  ...
  anon16_Else:
    ...
    call {:si_unique_call 273} status_20 := sdv_IoCallDriver#1(vslice_dummy_var_324, irp_3);
    goto anon21_Then, anon21_Else;
  ...
  anon19_Else:
    ...
    assume {:nonnull} irp_3 != 0;
    assume irp_3 > 0;
    status_20 := Mem_T.Status__IO_STATUS_BLOCK[Status__IO_STATUS_BLOCK(IoStatus__IRP(irp_3))];
    goto L45;
...
implementation {:origName "SerialMouseWait"} SerialMouseWait(actual_DeviceExtension_20: int, actual_Timeout_1: int) returns (Tmp_228: int)
{
  ...
  anon0:
    ...
    assume time > 0;
    call {:si_unique_call 282} vslice_dummy_var_68 := KeSetTimer(0, time, 0);
...
implementation {:origName "SerialMouseInitializePort"} SerialMouseInitializePort(actual_DeviceExtension_21: int) returns (Tmp_230: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 289} status_23 := SerialMousepIoSyncIoctlEx(1, 1769484, vslice_dummy_var_325, event_9, iosb_9, 0, 0, SerialBasicSettings__DEVICE_EXTENSION(DeviceExtension_21), 44);
    goto anon14_Then, anon14_Else;
  ...
  anon13_Then:
    ...
    call {:si_unique_call 290} vslice_dummy_var_69 := SerialMousepIoSyncIoctlEx(0, 1769504, vslice_dummy_var_326, event_9, iosb_9, 0, 0, Timeouts__SERIAL_BASIC_SETTINGS(SerialBasicSettings__DEVICE_EXTENSION(DeviceExtension_21)), 20);
    goto anon15_Then, anon15_Else;
  ...
  anon15_Else:
    ...
    call {:si_unique_call 292} vslice_dummy_var_70 := SerialMousepIoSyncIoctlEx(0, 1769500, vslice_dummy_var_327, event_9, iosb_9, serialTimeouts, 20, 0, 0);
    goto anon16_Then, anon16_Else;
  ...
  anon16_Else:
    ...
    call {:si_unique_call 293} vslice_dummy_var_71 := SerialMousepIoSyncIoctlEx(0, 1769568, vslice_dummy_var_328, event_9, iosb_9, 0, 0, HandFlow__SERIAL_BASIC_SETTINGS(SerialBasicSettings__DEVICE_EXTENSION(DeviceExtension_21)), 16);
    goto anon17_Then, anon17_Else;
  ...
  anon17_Else:
    ...
    call {:si_unique_call 294} status_23 := SerialMousepIoSyncIoctlEx(0, 1769572, vslice_dummy_var_329, event_9, iosb_9, serialHandFlow, 16, 0, 0);
    goto anon18_Then, anon18_Else;
...
implementation {:origName "SerialMouseSetReadTimeouts"} SerialMouseSetReadTimeouts(actual_DeviceExtension_22: int, actual_Timeout_2: int) returns (Tmp_232: int)
{
  ...
  L14:
    ...
    call {:si_unique_call 300} status_24 := SerialMousepIoSyncIoctlEx(0, 1769500, vslice_dummy_var_330, event_10, iosb_10, serialTimeouts_1, 20, 0, 0);
    goto anon6_Then, anon6_Else;
...
implementation {:origName "MSerSetProtocol"} MSerSetProtocol(actual_DeviceExtension_23: int, actual_NewProtocol_1: int) returns (Tmp_234: int)
{
  ...
  L7:
    ...
    havoc Tmp_236;
    call {:si_unique_call 302} vslice_dummy_var_72 := SerialMouseSetLineCtrl(DeviceExtension_23, Tmp_236);
    goto anon6_Then, anon6_Else;
...
implementation {:origName "_sdv_init3"} _sdv_init3()
{
  ...
  anon0:
    call {:si_unique_call 303} vslice_dummy_var_73 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "MSerPowerDown"} MSerPowerDown(actual_DeviceExtension_24: int) returns (Tmp_241: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 308} status_25 := SerialMousepIoSyncIoctl(0, 1769508, vslice_dummy_var_331, event_11, iosb_11);
    goto anon14_Then, anon14_Else;
  ...
  anon11_Else:
    ...
    call {:si_unique_call 309} status_25 := SerialMousepIoSyncIoctl(0, 1769524, vslice_dummy_var_332, event_11, iosb_11);
    goto anon15_Then, anon15_Else;
...
implementation {:origName "MSerDetect"} MSerDetect(actual_DeviceExtension_25: int) returns (Tmp_243: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 313} vslice_dummy_var_74 := SerialMouseInitializePort(DeviceExtension_25);
    goto anon55_Then, anon55_Else;

  anon55_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 314} vslice_dummy_var_75 := MSerPowerDown(DeviceExtension_25);
    goto anon56_Then, anon56_Else;

  anon56_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 315} vslice_dummy_var_76 := SerialMouseSetBaudRate(DeviceExtension_25, 1200);
    goto anon57_Then, anon57_Else;

  anon57_Else:
    assume {:partition} yogi_error != 1;
    havoc Tmp_245;
    call {:si_unique_call 316} vslice_dummy_var_82 := SerialMouseSetLineCtrl(DeviceExtension_25, Tmp_245);
    goto anon58_Then, anon58_Else;

  anon58_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 317} vslice_dummy_var_77 := SerialMouseFlushReadBuffer(DeviceExtension_25);
    goto anon59_Then, anon59_Else;

  anon59_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 318} vslice_dummy_var_78 := MSerPowerUp(DeviceExtension_25);
    goto anon60_Then, anon60_Else;

  anon60_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 319} vslice_dummy_var_79 := SerialMouseSetReadTimeouts(DeviceExtension_25, 200);
    goto anon61_Then, anon61_Else;
  ...
  anon47_Else:
    ...
    count_3 := count_3 + 1;
    call {:si_unique_call 321} vslice_dummy_var_83 := SerialMouseSetReadTimeouts(DeviceExtension_25, 100);
    goto anon63_Then, anon63_Else;
  ...
  L52:
    call {:si_unique_call 322} Tmp_244, count_3, Tmp_253, sdv_139 := MSerDetect_loop_L52(Tmp_244, count_3, receiveBuffer, Tmp_253, sdv_139, DeviceExtension_25);
    goto L52_last;
  ...
  L61:
    call {:si_unique_call 324} i_1 := MSerDetect_loop_L61(i_1, count_3);
    goto L61_last;
  ...
  L64:
    call {:si_unique_call 325} i_1, Tmp_246, Tmp_247 := MSerDetect_loop_L64(i_1, count_3, Tmp_246, Tmp_247, receiveBuffer);
    goto L64_last;
  ...
  anon54_Else:
    ...
    call {:si_unique_call 326} vslice_dummy_var_80 := SerialMouseWait(DeviceExtension_25, -5000000);
    goto L79;
  ...
  anon53_Else:
    ...
    call {:si_unique_call 327} vslice_dummy_var_81 := SerialMouseSetReadTimeouts(DeviceExtension_25, 0);
    goto anon67_Then, anon67_Else;
...
implementation {:origName "MSerPowerUp"} MSerPowerUp(actual_DeviceExtension_26: int) returns (Tmp_254: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 332} status_27 := SerialMousepIoSyncIoctl(0, 1769512, vslice_dummy_var_333, event_12, iosb_12);
    goto anon27_Then, anon27_Else;
  ...
  anon21_Else:
    ...
    call {:si_unique_call 333} status_27 := SerialMousepIoSyncIoctl(0, 1769524, vslice_dummy_var_334, event_12, iosb_12);
    goto anon28_Then, anon28_Else;
  ...
  anon23_Else:
    ...
    call {:si_unique_call 335} status_27 := SerialMousepIoSyncIoctl(0, 1769508, vslice_dummy_var_335, event_12, iosb_12);
    goto anon29_Then, anon29_Else;
  ...
  anon25_Else:
    ...
    call {:si_unique_call 337} status_27 := SerialMousepIoSyncIoctl(0, 1769520, vslice_dummy_var_336, event_12, iosb_12);
    goto anon30_Then, anon30_Else;
...
implementation {:origName "SerialMouseInitializeHardware"} SerialMouseInitializeHardware(actual_DeviceExtension_27: int) returns (Tmp_256: int)
{
  ...
  anon41_Else:
    ...
    call {:si_unique_call 344} vslice_dummy_var_84 := SerialMouseSetFifo(DeviceExtension_27, 0);
    goto anon42_Then, anon42_Else;

  anon42_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 345} vslice_dummy_var_85 := SerialMouseFlushReadBuffer(DeviceExtension_27);
...
implementation {:origName "_sdv_init5"} _sdv_init5()
{
  ...
  anon0:
    call {:si_unique_call 351} vslice_dummy_var_86 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "SerialMouseServiceParameters"} SerialMouseServiceParameters(actual_DeviceExtension_28: int, actual_Handle_1: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 358} vslice_dummy_var_87 := __HAVOC_malloc(4);
    ...
    call {:si_unique_call 361} vslice_dummy_var_90 := __HAVOC_malloc(44);
    parameters := 0;
    status_29 := 0;
    ...
    Tmp_297 := 28 * queriesPlusOne;
    call {:si_unique_call 364} sdv_156 := ExAllocatePoolWithTag(1, Tmp_297, -228232371);
    parameters := sdv_156;
    goto anon24_Then, anon24_Else;

  anon24_Else:
    assume {:partition} parameters != 0;
    Tmp_286 := 28 * queriesPlusOne;
    call {:si_unique_call 365} sdv_RtlZeroMemory(0, Tmp_286);
  ...
  anon19_Then:
    ...
    assume parametersPath > 0;
    havoc Tmp_296;
    call {:si_unique_call 370} sdv_161 := ExAllocatePoolWithTag(1, Tmp_296, -228232371);
    assume {:nonnull} parametersPath != 0;
    assume parametersPath > 0;
    assume {:nonnull} parametersPath != 0;
    assume parametersPath > 0;
  ...
  anon26_Else:
    ...
    assume parametersPath > 0;
    havoc Tmp_288;
    call {:si_unique_call 371} sdv_RtlZeroMemory(0, Tmp_288);
    call {:si_unique_call 372} vslice_dummy_var_88 := corral_nondet();
    call {:si_unique_call 373} vslice_dummy_var_89 := corral_nondet();
    i_2 := 0;
    Tmp_280 := i_2;
    assume {:nonnull} parameters != 0;
    assume parameters > 0;
...
procedure {:origName "DriverEntry"} DriverEntry(actual_DriverObject_3: int, actual_RegistryPath: int) returns (Tmp_298: int);
  modifies alloc;
...
implementation {:origName "DriverEntry"} DriverEntry(actual_DriverObject_3: int, actual_RegistryPath: int) returns (Tmp_298: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 375} Tmp_299 := __HAVOC_malloc(112);
    call {:si_unique_call 376} Tmp_300 := __HAVOC_malloc(112);
    call {:si_unique_call 377} Tmp_301 := __HAVOC_malloc(112);
    call {:si_unique_call 378} Tmp_303 := __HAVOC_malloc(112);
    call {:si_unique_call 379} Tmp_304 := __HAVOC_malloc(112);
    call {:si_unique_call 380} Tmp_309 := __HAVOC_malloc(112);
    call {:si_unique_call 381} Tmp_310 := __HAVOC_malloc(112);
    call {:si_unique_call 382} vslice_dummy_var_91 := IoAllocateDriverObjectExtension(0, 0, 8, 0);
    goto anon5_Then, anon5_Else;
  ...
  anon5_Else:
    ...
    assume regPath_1 > 0;
    havoc Tmp_305;
    call {:si_unique_call 383} sdv_165 := ExAllocatePoolWithTag(512, Tmp_305, -228232371);
    assume {:nonnull} regPath_1 != 0;
    assume regPath_1 > 0;
    assume {:nonnull} regPath_1 != 0;
    assume regPath_1 > 0;
  ...
  anon6_Else:
    ...
    assume regPath_1 > 0;
    havoc Tmp_306;
    call {:si_unique_call 384} sdv_RtlZeroMemory(0, Tmp_306);
    assume {:nonnull} RegistryPath != 0;
    assume RegistryPath > 0;
    havoc Tmp_302;
    call {:si_unique_call 385} sdv_RtlMoveMemory(0, 0, Tmp_302);
    goto L10;
...
procedure {:origName "SerialMouseSpinUpRead"} SerialMouseSpinUpRead(actual_DeviceExtension_29: int) returns (Tmp_311: int);
  modifies alloc, LockDepth, Mem_T.Status__IO_STATUS_BLOCK, Mem_T.CompletionRoutine__IO_STACK_LOCATION, yogi_error;
  free ensures {:va_keep} old(t) == 0 ==> yogi_error == 0;
  free ensures {:va_keep} yogi_error == 1 || yogi_error == old(yogi_error);
  free ensures {:va_keep} old(yogi_error) == 0;
...
implementation {:origName "SerialMouseSpinUpRead"} SerialMouseSpinUpRead(actual_DeviceExtension_29: int) returns (Tmp_311: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 387} vslice_dummy_var_92 := sdv_IoAcquireRemoveLock(0, 0);
...
implementation {:origName "SerialMouseClosePort"} SerialMouseClosePort(actual_DeviceExtension_30: int, actual_Irp_8: int)
{
  ...
  anon0:
    call {:si_unique_call 389} vslice_dummy_var_93 := __HAVOC_malloc(4);
  ...
  anon7_Else:
    ...
    call {:si_unique_call 394} vslice_dummy_var_94 := SerialMouseSendIrpSynchronously(vslice_dummy_var_337, Irp_8, 0);
    goto anon8_Then, anon8_Else;
  ...
  anon8_Else:
    ...
    call {:si_unique_call 397} vslice_dummy_var_95 := SerialMouseSendIrpSynchronously(vslice_dummy_var_338, Irp_8, 0);
    goto anon9_Then, anon9_Else;
...
procedure {:origName "SerialMouseInitializeDevice"} SerialMouseInitializeDevice(actual_DeviceExtension_31: int) returns (Tmp_315: int);
  modifies alloc, Mem_T.Status__IO_STATUS_BLOCK, Mem_T.CompletionRoutine__IO_STACK_LOCATION, LockDepth, yogi_error;
  free ensures {:va_keep} old(t) == 0 ==> yogi_error == 0;
  free ensures {:va_keep} yogi_error == 1 || yogi_error == old(yogi_error);
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} false || old(t) == 1 || old(t) == 0;
...
implementation {:origName "SerialMouseInitializeDevice"} SerialMouseInitializeDevice(actual_DeviceExtension_31: int) returns (Tmp_315: int)
{
  var {:scalar} i_3: int;
  ...
  anon0:
    ...
    call {:si_unique_call 401} Tmp_320 := __HAVOC_malloc(4);
  ...
  L16:
    call {:si_unique_call 403} i_3, Tmp_316 := SerialMouseInitializeDevice_loop_L16(i_3, Tmp_316, dumpData);
    goto L16_last;
  ...
  anon19_Then:
    ...
    call {:si_unique_call 406} vslice_dummy_var_96 := SerialMousepIoSyncIoctlEx(0, 1769540, vslice_dummy_var_339, event_13, iosb_13, waitMask_1, 4, 0, 0);
    goto anon24_Then, anon24_Else;
  ...
  anon22_Else:
    ...
    assume {:nonnull} DeviceExtension_31 != 0;
    assume DeviceExtension_31 > 0;
    Tmp_321 := 48 + dumpCount * 4;
    call {:si_unique_call 408} sdv_174 := IoAllocateErrorLogEntry(0, Tmp_321);
  ...
  L59:
    call {:si_unique_call 409} i_3, Tmp_317, Tmp_319, Tmp_320 := SerialMouseInitializeDevice_loop_L59(i_3, Tmp_317, Tmp_319, errorLogEntry, Tmp_320, dumpData, dumpCount);
    goto L59_last;
...
implementation {:origName "_sdv_init4"} _sdv_init4()
{
  ...
  anon0:
    call {:si_unique_call 412} vslice_dummy_var_97 := __HAVOC_malloc(4);
    return;
}



procedure {:origName "SerialMouseAddDevice"} SerialMouseAddDevice(actual_Driver: int, actual_PDO: int) returns (Tmp_324: int);
  modifies alloc, Mem_T.CompletionRoutine__IO_STACK_LOCATION, Mem_T.ReadIrp__DEVICE_EXTENSION;
  free ensures {:va_keep} Tmp_324 == -1073741667 || Tmp_324 == -1073741824 || Tmp_324 == -1073741771 || Tmp_324 == -1073741670 || Tmp_324 == -1073741823 || Tmp_324 == 0;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} false || old(t) == 1 || old(t) == 0;
  free ensures {:va_keep} alloc >= old(alloc);
  free ensures {:va_keep} false || t == 1 || t == 0;
...
implementation {:origName "SerialMouseAddDevice"} SerialMouseAddDevice(actual_Driver: int, actual_PDO: int) returns (Tmp_324: int)
{
  ...
  anon10_Then:
    ...
    assume {:nonnull} deviceExtension_1 != 0;
    assume deviceExtension_1 > 0;
    call {:si_unique_call 421} Tmp_325 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_325 != 0;
    assume Tmp_325 > 0;
    assume {:nonnull} deviceExtension_1 != 0;
    assume deviceExtension_1 > 0;
    call {:si_unique_call 422} sdv_KeInitializeSpinLock(Tmp_325);
    assume {:nonnull} Tmp_325 != 0;
    assume Tmp_325 > 0;
    assume {:nonnull} deviceExtension_1 != 0;
    assume deviceExtension_1 > 0;
    ...
    call {:si_unique_call 425} boogieTmp := IoAllocateIrp(vslice_dummy_var_340, 0);
  ...
  anon11_Else:
    ...
    assume {:nonnull} deviceExtension_1 != 0;
    assume deviceExtension_1 > 0;
    call {:si_unique_call 426} vslice_dummy_var_98 := IoWMIRegistrationControl(0, 1);
...
procedure {:origName "SerialMouseSendIrpSynchronously"} SerialMouseSendIrpSynchronously(actual_DeviceObject_15: int, actual_Irp_9: int, actual_CopyToNext: int) returns (Tmp_326: int);
  modifies alloc, Mem_T.CompletionRoutine__IO_STACK_LOCATION, yogi_error, Mem_T.Status__IO_STATUS_BLOCK, LockDepth;
  free ensures {:va_keep} old(t) == 0 ==> yogi_error == 0;
  free ensures {:va_keep} yogi_error == 1 || yogi_error == old(yogi_error);
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} false || old(t) == 1 || old(t) == 0;
...
implementation {:origName "SerialMouseSendIrpSynchronously"} SerialMouseSendIrpSynchronously(actual_DeviceObject_15: int, actual_Irp_9: int, actual_CopyToNext: int) returns (Tmp_326: int)
{
  ...
  anon8_Else:
    ...
    call {:si_unique_call 436} vslice_dummy_var_99 := KeWaitForSingleObject(0, 0, 0, 0, 0);
    assume {:nonnull} Irp_9 != 0;
    assume Irp_9 > 0;
    status_34 := Mem_T.Status__IO_STATUS_BLOCK[Status__IO_STATUS_BLOCK(IoStatus__IRP(Irp_9))];
    goto L23;
...
implementation {:origName "_sdv_init1"} _sdv_init1()
{
  ...
  anon0:
    call {:si_unique_call 437} vslice_dummy_var_100 := __HAVOC_malloc(4);
    return;
}



procedure {:origName "SerialMouseCompletionRoutine"} SerialMouseCompletionRoutine(actual_DeviceObject_16: int, actual_Irp_10: int, actual_EventIn_1: int) returns (Tmp_330: int);
  free ensures {:va_keep} Tmp_330 == -1073741802;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} false || old(t) == 1 || old(t) == 0;
  free ensures {:va_keep} alloc >= old(alloc);
  free ensures {:va_keep} false || t == 1 || t == 0;
...
implementation {:origName "SerialMouseCompletionRoutine"} SerialMouseCompletionRoutine(actual_DeviceObject_16: int, actual_Irp_10: int, actual_EventIn_1: int) returns (Tmp_330: int)
{
  ...
  anon0:
    ...
    Event_8 := EventIn_1;
    call {:si_unique_call 438} vslice_dummy_var_101 := KeSetEvent(Event_8, 0, 0);
    Tmp_330 := -1073741802;
    return;
}
...
implementation {:origName "SerialMouseRemoveDevice"} SerialMouseRemoveDevice(actual_DeviceExtension_32: int, actual_Irp_11: int)
{
  ...
  anon0:
    call {:si_unique_call 439} vslice_dummy_var_102 := __HAVOC_malloc(4);
  ...
  anon13_Then:
    assume {:nonnull} DeviceExtension_32 != 0;
    assume DeviceExtension_32 > 0;
    call {:si_unique_call 442} vslice_dummy_var_104 := IoWMIRegistrationControl(0, 2);
    assume {:nonnull} DeviceExtension_32 != 0;
    assume DeviceExtension_32 > 0;
    goto anon16_Then, anon16_Else;
  ...
  anon17_Else:
    call {:si_unique_call 443} vslice_dummy_var_103 := IoCancelIrp(0);
...
implementation {:origName "SerialMouseStopDevice"} SerialMouseStopDevice(actual_DeviceExtension_33: int)
{
  ...
  anon0:
    call {:si_unique_call 445} vslice_dummy_var_105 := __HAVOC_malloc(4);
    DeviceExtension_33 := actual_DeviceExtension_33;
    call {:si_unique_call 446} Tmp_335 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_335 != 0;
    assume Tmp_335 > 0;
    call {:si_unique_call 447} sdv_KeAcquireSpinLock(0, Tmp_335);
    assume {:nonnull} Tmp_335 != 0;
    assume Tmp_335 > 0;
    havoc irql_1;
  ...
  anon6_Else:
    ...
    call {:si_unique_call 451} vslice_dummy_var_106 := KeWaitForSingleObject(0, 0, 0, 0, 0);
    goto L1;
...
procedure {:origName "SerialMousePnP"} SerialMousePnP(actual_DeviceObject_17: int, actual_Irp_12: int) returns (Tmp_336: int);
  modifies alloc, LockDepth, Mem_T.Status__IO_STATUS_BLOCK, Mem_T.CompletionRoutine__IO_STACK_LOCATION, Mem_T.ReadIrp__DEVICE_EXTENSION, yogi_error;
  free ensures {:va_keep} old(t) == 0 ==> yogi_error == 0;
  free ensures {:va_keep} yogi_error == 1 || yogi_error == old(yogi_error);
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} false || old(t) == 1 || old(t) == 0;
...
implementation {:origName "SerialMousePnP"} SerialMousePnP(actual_DeviceObject_17: int, actual_Irp_12: int) returns (Tmp_336: int)
{
  var {:scalar} i_4: int;
  ...
  anon0:
    ...
    call {:si_unique_call 452} Tmp_338 := __HAVOC_malloc(28);
    call {:si_unique_call 453} Tmp_340 := __HAVOC_malloc(28);
    skipIt := 0;
  ...
  anon101_Else:
    ...
    call {:si_unique_call 459} status_35 := sdv_IoCallDriver#1(vslice_dummy_var_341, Irp_12);
  ...
  L46:
    assume {:nonnull} deviceExtension_2 != 0;
    assume deviceExtension_2 > 0;
    call {:si_unique_call 460} vslice_dummy_var_107 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(deviceExtension_2), Irp_12);
  ...
  anon117_Then:
    ...
    call {:si_unique_call 461} status_35 := SerialMouseSendIrpSynchronously(vslice_dummy_var_342, Irp_12, 1);
  ...
  L62:
    assume {:nonnull} Irp_12 != 0;
    assume Irp_12 > 0;
    Mem_T.Status__IO_STATUS_BLOCK[Status__IO_STATUS_BLOCK(IoStatus__IRP(Irp_12))] := status_35;
  ...
  anon125_Then:
    ...
    call {:si_unique_call 463} status_35 := SerialMouseSendIrpSynchronously(vslice_dummy_var_343, Irp_12, 1);
  ...
  L89:
    call {:si_unique_call 464} i_4, Tmp_338, Tmp_339 := SerialMousePnP_loop_L89(i_4, devCaps, Tmp_338, Tmp_339);
    goto L89_last;
  ...
  anon141_Else:
    ...
    call {:si_unique_call 469} status_35 := sdv_IoCallDriver#1(vslice_dummy_var_344, Irp_12);
  ...
  anon100_Then:
    ...
    call {:si_unique_call 475} status_35 := SerialMouseSendIrpSynchronously(vslice_dummy_var_345, Irp_12, 1);
  ...
  anon110_Else:
    assume {:partition} Mem_T.Status__IO_STATUS_BLOCK[Status__IO_STATUS_BLOCK(IoStatus__IRP(Irp_12))] >= 0;
    call {:si_unique_call 476} Tmp_337 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_337 != 0;
    assume Tmp_337 > 0;
    assume {:nonnull} deviceExtension_2 != 0;
    assume deviceExtension_2 > 0;
    call {:si_unique_call 477} sdv_192 := sdv_InterlockedIncrement(Tmp_337);
    assume {:nonnull} Tmp_337 != 0;
    assume Tmp_337 > 0;
    assume {:nonnull} deviceExtension_2 != 0;
    assume deviceExtension_2 > 0;
  ...
  anon111_Else:
    ...
    assume {:nonnull} Irp_12 != 0;
    assume Irp_12 > 0;
    prevStatus := Mem_T.Status__IO_STATUS_BLOCK[Status__IO_STATUS_BLOCK(IoStatus__IRP(Irp_12))];
    assume {:nonnull} Irp_12 != 0;
    assume Irp_12 > 0;
    ...
    call {:si_unique_call 480} status_35 := SerialMouseSendIrpSynchronously(vslice_dummy_var_346, Irp_12, 0);
  ...
  anon113_Else:
    ...
    assume {:nonnull} Irp_12 != 0;
    assume Irp_12 > 0;
    Mem_T.Status__IO_STATUS_BLOCK[Status__IO_STATUS_BLOCK(IoStatus__IRP(Irp_12))] := prevStatus;
    assume {:nonnull} Irp_12 != 0;
    assume Irp_12 > 0;
    goto L135;
  ...
  anon114_Else:
    ...
    call {:si_unique_call 483} vslice_dummy_var_108 := ZwClose(0);
    goto L161;
  ...
  anon136_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 486} Tmp_337 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_337 != 0;
    assume Tmp_337 > 0;
    assume {:nonnull} deviceExtension_2 != 0;
    assume deviceExtension_2 > 0;
    call {:si_unique_call 487} sdv_198 := sdv_InterlockedDecrement(Tmp_337);
    assume {:nonnull} Tmp_337 != 0;
    assume Tmp_337 > 0;
    assume {:nonnull} deviceExtension_2 != 0;
    assume deviceExtension_2 > 0;
...
implementation {:origName "SerialMouseHandleStartStopStart"} SerialMouseHandleStartStopStart(actual_DeviceExtension_34: int)
{
  ...
  anon0:
    call {:si_unique_call 492} vslice_dummy_var_109 := __HAVOC_malloc(4);
    DeviceExtension_34 := actual_DeviceExtension_34;
    call {:si_unique_call 493} Tmp_341 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_341 != 0;
    assume Tmp_341 > 0;
    call {:si_unique_call 494} sdv_KeAcquireSpinLock(0, Tmp_341);
    assume {:nonnull} Tmp_341 != 0;
    assume Tmp_341 > 0;
    havoc irql_2;
...
implementation {:origName "SerialMouseReadComplete"} SerialMouseReadComplete#0(actual_DeviceObject_14: int, actual_Irp_7: int, actual_DeviceExtensionIn: int) returns (Tmp_222: int)
{
  ...
  anon0:
    ...
    assume Irp_7 > 0;
    status_22 := Mem_T.Status__IO_STATUS_BLOCK[Status__IO_STATUS_BLOCK(IoStatus__IRP(Irp_7))];
    goto anon50_Then, anon50_Else;
  ...
  anon48_Then:
    ...
    assume {:nonnull} DeviceExtension_19 != 0;
    assume DeviceExtension_19 > 0;
    call {:si_unique_call 512} vslice_dummy_var_111 := KeSetEvent(StopEvent__DEVICE_EXTENSION(DeviceExtension_19), 0, 0);
    goto L21;

  L21:
    assume {:nonnull} DeviceExtension_19 != 0;
    assume DeviceExtension_19 > 0;
    call {:si_unique_call 513} vslice_dummy_var_110 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(DeviceExtension_19), Mem_T.ReadIrp__DEVICE_EXTENSION[ReadIrp__DEVICE_EXTENSION(DeviceExtension_19)]);
    goto anon52_Then, anon52_Else;
...
procedure {:origName "SerialMouseReadComplete"} SerialMouseReadComplete#0(actual_DeviceObject_14: int, actual_Irp_7: int, actual_DeviceExtensionIn: int) returns (Tmp_222: int);
  modifies alloc, LockDepth, yogi_error;
  free ensures {:va_keep} old(LockDepth) != 0 ==> yogi_error == 0;
  free ensures {:va_keep} old(t) == 0 ==> yogi_error == 0;
  free ensures {:va_keep} LockDepth <= old(LockDepth);
...
implementation {:origName "SerialMouseReadComplete"} SerialMouseReadComplete#1(actual_DeviceObject_14: int, actual_Irp_7: int, actual_DeviceExtensionIn: int) returns (Tmp_222: int)
{
  var {:pointer} Tmp_223: int;
  var {:scalar} sdv_112: int;
  var {:scalar} startRead: int;
  ...
  anon37_Else:
    assume {:partition} startRead != 0;
    call {:si_unique_call 519} vslice_dummy_var_114 := SerialMouseStartRead#0(DeviceExtension_19);
    goto anon53_Then, anon53_Else;
  ...
  anon48_Then:
    ...
    assume {:nonnull} DeviceExtension_19 != 0;
    assume DeviceExtension_19 > 0;
    call {:si_unique_call 520} vslice_dummy_var_113 := KeSetEvent(StopEvent__DEVICE_EXTENSION(DeviceExtension_19), 0, 0);
    goto L21;

  L21:
    assume {:nonnull} DeviceExtension_19 != 0;
    assume DeviceExtension_19 > 0;
    call {:si_unique_call 521} vslice_dummy_var_112 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(DeviceExtension_19), Mem_T.ReadIrp__DEVICE_EXTENSION[ReadIrp__DEVICE_EXTENSION(DeviceExtension_19)]);
    goto anon52_Then, anon52_Else;
...
procedure {:origName "SerialMouseReadComplete"} SerialMouseReadComplete#1(actual_DeviceObject_14: int, actual_Irp_7: int, actual_DeviceExtensionIn: int) returns (Tmp_222: int);
  modifies alloc, LockDepth, Mem_T.Status__IO_STATUS_BLOCK, Mem_T.CompletionRoutine__IO_STACK_LOCATION, yogi_error;
  free ensures {:va_keep} old(t) == 0 ==> yogi_error == 0;
  free ensures {:va_keep} yogi_error == 1 || yogi_error == old(yogi_error);
  free ensures {:va_keep} old(yogi_error) == 0;
...
implementation {:origName "SerialMouseStartRead"} SerialMouseStartRead#0(actual_DeviceExtension_15: int) returns (Tmp_206: int)
{
  ...
  L13:
    call {:si_unique_call 522} Tmp_207, status_17, irql, stack := SerialMouseStartRead#0_loop_L13(sdv_93, Tmp_207, irp_1, status_17, irql, stack, DeviceExtension_15);
    goto L13_last;
  ...
  L15:
    assume {:nonnull} DeviceExtension_15 != 0;
    assume DeviceExtension_15 > 0;
    call {:si_unique_call 523} vslice_dummy_var_115 := KeSetEvent(StopEvent__DEVICE_EXTENSION(DeviceExtension_15), 0, 0);
    assume {:nonnull} DeviceExtension_15 != 0;
    assume DeviceExtension_15 > 0;
    call {:si_unique_call 524} vslice_dummy_var_116 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(DeviceExtension_15), Mem_T.ReadIrp__DEVICE_EXTENSION[ReadIrp__DEVICE_EXTENSION(DeviceExtension_15)]);
    goto anon22_Then, anon22_Else;
  ...
  anon20_Else:
    ...
    assume {:nonnull} DeviceExtension_15 != 0;
    assume DeviceExtension_15 > 0;
    call {:si_unique_call 528} vslice_dummy_var_117 := KeSetEvent(StopEvent__DEVICE_EXTENSION(DeviceExtension_15), 0, 0);
    assume {:nonnull} DeviceExtension_15 != 0;
    assume DeviceExtension_15 > 0;
    call {:si_unique_call 529} vslice_dummy_var_118 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(DeviceExtension_15), Mem_T.ReadIrp__DEVICE_EXTENSION[ReadIrp__DEVICE_EXTENSION(DeviceExtension_15)]);
    goto anon23_Then, anon23_Else;
  ...
  anon20_Then:
    ...
    call {:si_unique_call 534} status_17 := sdv_IoCallDriver#0(vslice_dummy_var_347, irp_1);
    goto anon24_Then, anon24_Else;
...
implementation {:origName "SerialMouseStartRead"} SerialMouseStartRead#1(actual_DeviceExtension_15: int) returns (Tmp_206: int)
{
  ...
  L13:
    call {:si_unique_call 535} Tmp_207, status_17, irql, stack := SerialMouseStartRead#1_loop_L13(sdv_93, Tmp_207, irp_1, status_17, irql, stack, DeviceExtension_15);
    goto L13_last;
  ...
  L15:
    assume {:nonnull} DeviceExtension_15 != 0;
    assume DeviceExtension_15 > 0;
    call {:si_unique_call 536} vslice_dummy_var_119 := KeSetEvent(StopEvent__DEVICE_EXTENSION(DeviceExtension_15), 0, 0);
    assume {:nonnull} DeviceExtension_15 != 0;
    assume DeviceExtension_15 > 0;
    call {:si_unique_call 537} vslice_dummy_var_120 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(DeviceExtension_15), Mem_T.ReadIrp__DEVICE_EXTENSION[ReadIrp__DEVICE_EXTENSION(DeviceExtension_15)]);
    goto anon22_Then, anon22_Else;
  ...
  anon20_Else:
    ...
    assume {:nonnull} DeviceExtension_15 != 0;
    assume DeviceExtension_15 > 0;
    call {:si_unique_call 541} vslice_dummy_var_121 := KeSetEvent(StopEvent__DEVICE_EXTENSION(DeviceExtension_15), 0, 0);
    assume {:nonnull} DeviceExtension_15 != 0;
    assume DeviceExtension_15 > 0;
    call {:si_unique_call 542} vslice_dummy_var_122 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(DeviceExtension_15), Mem_T.ReadIrp__DEVICE_EXTENSION[ReadIrp__DEVICE_EXTENSION(DeviceExtension_15)]);
    goto anon23_Then, anon23_Else;
  ...
  anon20_Then:
    ...
    call {:si_unique_call 547} status_17 := sdv_IoCallDriver#1(vslice_dummy_var_348, irp_1);
    goto anon24_Then, anon24_Else;
...
procedure {:origName "sdv_IoCallDriver"} {:osmodel} sdv_IoCallDriver#0(actual_DeviceObject_6: int, actual_Irp_5: int) returns (Tmp_175: int);
  modifies yogi_error, alloc, Mem_T.Status__IO_STATUS_BLOCK, LockDepth;
  free ensures {:va_keep} old(t) == 0 ==> yogi_error == 0;
  free ensures {:va_keep} yogi_error == 1 || yogi_error == old(yogi_error);
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} false || old(t) == 1 || old(t) == 0;
...
procedure {:origName "sdv_IoCallDriver"} {:osmodel} sdv_IoCallDriver#1(actual_DeviceObject_6: int, actual_Irp_5: int) returns (Tmp_175: int);
  modifies yogi_error, alloc, Mem_T.Status__IO_STATUS_BLOCK, LockDepth, Mem_T.CompletionRoutine__IO_STACK_LOCATION;
  free ensures {:va_keep} old(t) == 0 ==> yogi_error == 0;
  free ensures {:va_keep} yogi_error == 1 || yogi_error == old(yogi_error);
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} false || old(t) == 1 || old(t) == 0;
...
implementation {:origName "IofCallDriver"} {:osmodel} IofCallDriver#0(actual_DeviceObject_4: int, actual_Irp_3: int) returns (Tmp_167: int)
{
  ...
  anon55_Then:
    ...
    call {:si_unique_call 553} vslice_dummy_var_123 := sdv_RunIoCompletionRoutines#0(sdv_p_devobj_fdo, Irp_3, vslice_dummy_var_349, completion);
  ...
  anon67_Else:
    ...
    call {:si_unique_call 554} vslice_dummy_var_126 := sdv_RunIoCompletionRoutines#0(sdv_p_devobj_fdo, Irp_3, vslice_dummy_var_350, completion);
  ...
  anon59_Else:
    ...
    call {:si_unique_call 555} vslice_dummy_var_124 := sdv_RunIoCompletionRoutines#0(sdv_p_devobj_fdo, Irp_3, vslice_dummy_var_351, completion);
  ...
  anon63_Else:
    ...
    call {:si_unique_call 556} vslice_dummy_var_125 := sdv_RunIoCompletionRoutines#0(sdv_p_devobj_fdo, Irp_3, vslice_dummy_var_352, completion);
...
implementation {:origName "IofCallDriver"} {:osmodel} IofCallDriver#1(actual_DeviceObject_4: int, actual_Irp_3: int) returns (Tmp_167: int)
{
  ...
  anon55_Then:
    ...
    call {:si_unique_call 558} vslice_dummy_var_127 := sdv_RunIoCompletionRoutines#1(sdv_p_devobj_fdo, Irp_3, vslice_dummy_var_353, completion);
    goto anon76_Then, anon76_Else;
  ...
  anon67_Else:
    ...
    call {:si_unique_call 559} vslice_dummy_var_130 := sdv_RunIoCompletionRoutines#1(sdv_p_devobj_fdo, Irp_3, vslice_dummy_var_354, completion);
    goto anon78_Then, anon78_Else;
  ...
  anon59_Else:
    ...
    call {:si_unique_call 560} vslice_dummy_var_128 := sdv_RunIoCompletionRoutines#1(sdv_p_devobj_fdo, Irp_3, vslice_dummy_var_355, completion);
    goto anon74_Then, anon74_Else;
  ...
  anon63_Else:
    ...
    call {:si_unique_call 561} vslice_dummy_var_129 := sdv_RunIoCompletionRoutines#1(sdv_p_devobj_fdo, Irp_3, vslice_dummy_var_356, completion);
    goto anon72_Then, anon72_Else;
...
implementation CSerDetect_loop_L19(in_Tmp_18: int, in_count_1: int, in_Tmp_20: int, in_sdv_12: int, in_status_1: int, in_DeviceExtension_3: int, in_vslice_dummy_var_7: int, in_vslice_dummy_var_8: int, in_vslice_dummy_var_9: int, in_vslice_dummy_var_10: int, in_vslice_dummy_var_16: int) returns (out_Tmp_18: int, out_count_1: int, out_Tmp_20: int, out_sdv_12: int, out_vslice_dummy_var_7: int, out_vslice_dummy_var_8: int, out_vslice_dummy_var_9: int, out_vslice_dummy_var_10: int, out_vslice_dummy_var_16: int)
{
...
procedure {:LoopProcedure} CSerDetect_loop_L19(in_Tmp_18: int, in_count_1: int, in_Tmp_20: int, in_sdv_12: int, in_status_1: int, in_DeviceExtension_3: int, in_vslice_dummy_var_7: int, in_vslice_dummy_var_8: int, in_vslice_dummy_var_9: int, in_vslice_dummy_var_10: int, in_vslice_dummy_var_16: int) returns (out_Tmp_18: int, out_count_1: int, out_Tmp_20: int, out_sdv_12: int, out_vslice_dummy_var_7: int, out_vslice_dummy_var_8: int, out_vslice_dummy_var_9: int, out_vslice_dummy_var_10: int, out_vslice_dummy_var_16: int);
  modifies alloc, Mem_T.Status__IO_STATUS_BLOCK, Mem_T.CompletionRoutine__IO_STACK_LOCATION, yogi_error, LockDepth;
  free ensures {:va_keep} old(LockDepth) != 0 ==> yogi_error == 0;
  free ensures {:va_keep} old(LockDepth) == 0 ==> yogi_error == 0;
  free ensures {:va_keep} yogi_error == 0;
...
implementation SerialMouseReadSerialPort_loop_L21(in_irp_3: int, in_status_20: int, in_event_8: int, in_stack_1: int, in_DeviceExtension_18: int, in_ReadBuffer: int, in_Buflen: int, in_ActualBytesRead: int) returns (out_status_20: int, out_stack_1: int)
{
  ...
  anon16_Else:
    ...
    call {:si_unique_call 575} out_status_20 := sdv_IoCallDriver#1(vslice_dummy_var_357, in_irp_3);
    goto anon21_Else;
  ...
  anon19_Else:
    ...
    assume {:nonnull} in_irp_3 != 0;
    assume in_irp_3 > 0;
    out_status_20 := Mem_T.Status__IO_STATUS_BLOCK[Status__IO_STATUS_BLOCK(IoStatus__IRP(in_irp_3))];
    goto L45;
  ...
  anon20_Else_dummy:
    call {:si_unique_call 577} {:si_old_unique_call 1} out_status_20, out_stack_1 := SerialMouseReadSerialPort_loop_L21(in_irp_3, out_status_20, in_event_8, out_stack_1, in_DeviceExtension_18, in_ReadBuffer, in_Buflen, in_ActualBytesRead);
    return;
...
procedure {:LoopProcedure} SerialMouseReadSerialPort_loop_L21(in_irp_3: int, in_status_20: int, in_event_8: int, in_stack_1: int, in_DeviceExtension_18: int, in_ReadBuffer: int, in_Buflen: int, in_ActualBytesRead: int) returns (out_status_20: int, out_stack_1: int);
  modifies alloc, Mem_T.Status__IO_STATUS_BLOCK, Mem_T.CompletionRoutine__IO_STACK_LOCATION, yogi_error, LockDepth;
  free ensures {:va_keep} old(LockDepth) != 0 ==> yogi_error == 0;
  free ensures {:va_keep} old(LockDepth) == 0 ==> yogi_error == 0;
  free ensures {:va_keep} yogi_error == 0;
...
implementation MSerDetect_loop_L52(in_Tmp_244: int, in_count_3: int, in_receiveBuffer: int, in_Tmp_253: int, in_sdv_139: int, in_DeviceExtension_25: int) returns (out_Tmp_244: int, out_count_3: int, out_Tmp_253: int, out_sdv_139: int)
{
  ...
  anon49_Else_dummy:
    call {:si_unique_call 579} {:si_old_unique_call 1} out_Tmp_244, out_count_3, out_Tmp_253, out_sdv_139 := MSerDetect_loop_L52(out_Tmp_244, out_count_3, in_receiveBuffer, out_Tmp_253, out_sdv_139, in_DeviceExtension_25);
    return;
}



procedure {:LoopProcedure} MSerDetect_loop_L52(in_Tmp_244: int, in_count_3: int, in_receiveBuffer: int, in_Tmp_253: int, in_sdv_139: int, in_DeviceExtension_25: int) returns (out_Tmp_244: int, out_count_3: int, out_Tmp_253: int, out_sdv_139: int);
  modifies alloc, Mem_T.Status__IO_STATUS_BLOCK, Mem_T.CompletionRoutine__IO_STACK_LOCATION, yogi_error, LockDepth;
  free ensures {:va_keep} old(LockDepth) != 0 ==> yogi_error == 0;
  free ensures {:va_keep} old(LockDepth) == 0 ==> yogi_error == 0;
  free ensures {:va_keep} yogi_error == 0;
...
implementation MSerDetect_loop_L64(in_i_1: int, in_count_3: int, in_Tmp_246: int, in_Tmp_247: int, in_receiveBuffer: int) returns (out_i_1: int, out_Tmp_246: int, out_Tmp_247: int)
{
...
procedure {:LoopProcedure} MSerDetect_loop_L64(in_i_1: int, in_count_3: int, in_Tmp_246: int, in_Tmp_247: int, in_receiveBuffer: int) returns (out_i_1: int, out_Tmp_246: int, out_Tmp_247: int);
...
implementation SerialMouseInitializeDevice_loop_L59(in_i_3: int, in_Tmp_317: int, in_Tmp_319: int, in_errorLogEntry: int, in_Tmp_320: int, in_dumpData: int, in_dumpCount: int) returns (out_i_3: int, out_Tmp_317: int, out_Tmp_319: int, out_Tmp_320: int)
{

  entry:
    out_i_3, out_Tmp_317, out_Tmp_319, out_Tmp_320 := in_i_3, in_Tmp_317, in_Tmp_319, in_Tmp_320;
    goto L59, exit;
  ...
  anon23_Else_dummy:
    call {:si_unique_call 580} {:si_old_unique_call 1} out_i_3, out_Tmp_317, out_Tmp_319, out_Tmp_320 := SerialMouseInitializeDevice_loop_L59(out_i_3, out_Tmp_317, out_Tmp_319, in_errorLogEntry, out_Tmp_320, in_dumpData, in_dumpCount);
    return;
}



procedure {:LoopProcedure} SerialMouseInitializeDevice_loop_L59(in_i_3: int, in_Tmp_317: int, in_Tmp_319: int, in_errorLogEntry: int, in_Tmp_320: int, in_dumpData: int, in_dumpCount: int) returns (out_i_3: int, out_Tmp_317: int, out_Tmp_319: int, out_Tmp_320: int);
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} false || old(t) == 1 || old(t) == 0;
  free ensures {:va_keep} alloc >= old(alloc);
  free ensures {:va_keep} false || t == 1 || t == 0;
...
implementation {:SIextraRecBound 4} SerialMouseInitializeDevice_loop_L16(in_i_3: int, in_Tmp_316: int, in_dumpData: int) returns (out_i_3: int, out_Tmp_316: int)
{

  entry:
    out_i_3, out_Tmp_316 := in_i_3, in_Tmp_316;
    goto L16, exit;
  ...
  anon19_Else_dummy:
    call {:si_unique_call 581} {:si_old_unique_call 1} out_i_3, out_Tmp_316 := SerialMouseInitializeDevice_loop_L16(out_i_3, out_Tmp_316, in_dumpData);
    return;
}



procedure {:LoopProcedure} SerialMouseInitializeDevice_loop_L16(in_i_3: int, in_Tmp_316: int, in_dumpData: int) returns (out_i_3: int, out_Tmp_316: int);
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} false || old(t) == 1 || old(t) == 0;
  free ensures {:va_keep} alloc >= old(alloc);
  free ensures {:va_keep} false || t == 1 || t == 0;
...
implementation {:SIextraRecBound 5} SerialMousePnP_loop_L89(in_i_4: int, in_devCaps: int, in_Tmp_338: int, in_Tmp_339: int) returns (out_i_4: int, out_Tmp_338: int, out_Tmp_339: int)
{

  entry:
    out_i_4, out_Tmp_338, out_Tmp_339 := in_i_4, in_Tmp_338, in_Tmp_339;
    goto L89, exit;
  ...
  anon108_Else_dummy:
    call {:si_unique_call 582} {:si_old_unique_call 1} out_i_4, out_Tmp_338, out_Tmp_339 := SerialMousePnP_loop_L89(out_i_4, in_devCaps, out_Tmp_338, out_Tmp_339);
    return;
}



procedure {:LoopProcedure} SerialMousePnP_loop_L89(in_i_4: int, in_devCaps: int, in_Tmp_338: int, in_Tmp_339: int) returns (out_i_4: int, out_Tmp_338: int, out_Tmp_339: int);
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} false || old(t) == 1 || old(t) == 0;
  free ensures {:va_keep} alloc >= old(alloc);
  free ensures {:va_keep} false || t == 1 || t == 0;
...
implementation SerialMouseStartRead#0_loop_L13(in_sdv_93: int, in_Tmp_207: int, in_irp_1: int, in_status_17: int, in_irql: int, in_stack: int, in_DeviceExtension_15: int) returns (out_Tmp_207: int, out_status_17: int, out_irql: int, out_stack: int)
{
  ...
  anon20_Then:
    ...
    call {:si_unique_call 587} out_status_17 := sdv_IoCallDriver#0(vslice_dummy_var_358, in_irp_1);
    goto anon24_Else;
  ...
  anon21_Else_dummy:
    call {:si_unique_call 590} {:si_old_unique_call 1} out_Tmp_207, out_status_17, out_irql, out_stack := SerialMouseStartRead#0_loop_L13(in_sdv_93, out_Tmp_207, in_irp_1, out_status_17, out_irql, out_stack, in_DeviceExtension_15);
    return;
}



procedure {:LoopProcedure} SerialMouseStartRead#0_loop_L13(in_sdv_93: int, in_Tmp_207: int, in_irp_1: int, in_status_17: int, in_irql: int, in_stack: int, in_DeviceExtension_15: int) returns (out_Tmp_207: int, out_status_17: int, out_irql: int, out_stack: int);
  modifies alloc, Mem_T.Status__IO_STATUS_BLOCK, Mem_T.CompletionRoutine__IO_STACK_LOCATION, yogi_error, LockDepth;
  free ensures {:va_keep} old(LockDepth) != 0 ==> yogi_error == 0;
  free ensures {:va_keep} old(LockDepth) == 0 ==> yogi_error == 0;
  free ensures {:va_keep} yogi_error == 0;
...
implementation SerialMouseStartRead#1_loop_L13(in_sdv_93: int, in_Tmp_207: int, in_irp_1: int, in_status_17: int, in_irql: int, in_stack: int, in_DeviceExtension_15: int) returns (out_Tmp_207: int, out_status_17: int, out_irql: int, out_stack: int)
{
  ...
  anon20_Then:
    ...
    call {:si_unique_call 595} out_status_17 := sdv_IoCallDriver#1(vslice_dummy_var_359, in_irp_1);
    goto anon24_Else;
  ...
  anon21_Else_dummy:
    call {:si_unique_call 598} {:si_old_unique_call 1} out_Tmp_207, out_status_17, out_irql, out_stack := SerialMouseStartRead#1_loop_L13(in_sdv_93, out_Tmp_207, in_irp_1, out_status_17, out_irql, out_stack, in_DeviceExtension_15);
    return;
}



procedure {:LoopProcedure} SerialMouseStartRead#1_loop_L13(in_sdv_93: int, in_Tmp_207: int, in_irp_1: int, in_status_17: int, in_irql: int, in_stack: int, in_DeviceExtension_15: int) returns (out_Tmp_207: int, out_status_17: int, out_irql: int, out_stack: int);
  modifies alloc, Mem_T.Status__IO_STATUS_BLOCK, Mem_T.CompletionRoutine__IO_STACK_LOCATION, yogi_error, LockDepth;
  free ensures {:va_keep} old(LockDepth) != 0 ==> yogi_error == 0;
  free ensures {:va_keep} old(LockDepth) == 0 ==> yogi_error == 0;
  free ensures {:va_keep} yogi_error == 0;
