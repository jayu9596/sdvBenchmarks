...
procedure {:origName "_sdv_init2"} _sdv_init2();
  ...
  free ensures {:va_keep} false || old(in_pnp) == 0 || old(in_pnp) == 1;
  free ensures {:va_keep} false || old(passed_on) == 1 || old(passed_on) == 0;
  free ensures {:va_keep} false || old(ref) == 0 || old(ref) == 1;
  free ensures {:va_keep} alloc >= old(alloc);
  free ensures {:va_keep} false || in_pnp == 0 || in_pnp == 1;
  free ensures {:va_keep} false || passed_on == 1 || passed_on == 0;
  free ensures {:va_keep} false || ref == 0 || ref == 1;
...
procedure {:origName "SLIC_ABORT_9_0"} SLIC_ABORT_9_0(actual_caller: int, actual_sdv: int, actual_sdv_1: int);
  modifies yogi_error;
  free ensures {:va_keep} old(in_pnp) == 0 ==> yogi_error == 1;
  free ensures {:va_keep} old(in_pnp) == 1 ==> yogi_error == 1;
  free ensures {:va_keep} old(passed_on) == 1 ==> yogi_error == 1;
  free ensures {:va_keep} old(passed_on) == 0 ==> yogi_error == 1;
  free ensures {:va_keep} old(ref) == 0 ==> yogi_error == 1;
  free ensures {:va_keep} old(ref) == 1 ==> yogi_error == 1;
...
procedure {:origName "SLIC_PoCallDriver_entry"} {:osmodel} SLIC_PoCallDriver_entry(actual_caller_2: int);
  modifies passed_on;
  free ensures {:va_keep} old(passed_on) == 1 ==> passed_on != 0;
  free ensures {:va_keep} old(passed_on) == 0 ==> passed_on != 0;
  free ensures {:va_keep} passed_on == 1;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} false || old(in_pnp) == 0 || old(in_pnp) == 1;
  free ensures {:va_keep} false || old(passed_on) == 1 || old(passed_on) == 0;
  free ensures {:va_keep} false || old(ref) == 0 || old(ref) == 1;
...
procedure {:origName "_sdv_init7"} {:osmodel} _sdv_init7();
  ...
  free ensures {:va_keep} old(in_pnp) == 0 ==> in_pnp != 1;
  free ensures {:va_keep} old(in_pnp) == 1 ==> in_pnp != 1;
  free ensures {:va_keep} old(passed_on) == 1 ==> passed_on != 1;
  free ensures {:va_keep} old(passed_on) == 0 ==> passed_on != 1;
  free ensures {:va_keep} old(ref) == 0 ==> ref != 1;
  free ensures {:va_keep} old(ref) == 1 ==> ref != 1;
  free ensures {:va_keep} old(SLAM_guard_S_0) == old(SLAM_guard_S_0_init) ==> yogi_error == old(yogi_error);
  free ensures {:va_keep} yogi_error == 0;
  free ensures {:va_keep} ref == 0;
  free ensures {:va_keep} yogi_error == 0;
  free ensures {:va_keep} passed_on == 0;
  free ensures {:va_keep} in_pnp == 0;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} false || old(in_pnp) == 0 || old(in_pnp) == 1;
  free ensures {:va_keep} false || old(passed_on) == 1 || old(passed_on) == 0;
  free ensures {:va_keep} false || old(ref) == 0 || old(ref) == 1;
...
procedure {:origName "SLIC_sdv_RunDispatchFunction_exit"} {:osmodel} SLIC_sdv_RunDispatchFunction_exit(actual_caller_6: int, actual_sdv_2: int, actual_sdv_3: int);
  modifies yogi_error;
  free ensures {:va_keep} old(in_pnp) == 0 ==> yogi_error == 0;
  free ensures {:va_keep} old(passed_on) == 1 ==> yogi_error == 0;
  free ensures {:va_keep} old(ref) == 1 ==> yogi_error == 0;
...
procedure {:origName "SLIC_VolSnapPnp_entry"} {:osmodel} SLIC_VolSnapPnp_entry(actual_caller_7: int);
  modifies in_pnp;
  free ensures {:va_keep} old(in_pnp) == 0 ==> in_pnp != 0;
  free ensures {:va_keep} old(in_pnp) == 1 ==> in_pnp != 0;
  free ensures {:va_keep} in_pnp == 1;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} false || old(in_pnp) == 0 || old(in_pnp) == 1;
  free ensures {:va_keep} false || old(passed_on) == 1 || old(passed_on) == 0;
  free ensures {:va_keep} false || old(ref) == 0 || old(ref) == 1;
...
procedure {:origName "SLIC_ObReferenceObjectByHandle_entry"} {:osmodel} SLIC_ObReferenceObjectByHandle_entry(actual_caller_8: int);
  modifies ref;
  free ensures {:va_keep} old(ref) == 0 ==> ref != 0;
  free ensures {:va_keep} old(ref) == 1 ==> ref != 0;
  free ensures {:va_keep} ref == 1;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} false || old(in_pnp) == 0 || old(in_pnp) == 1;
  free ensures {:va_keep} false || old(passed_on) == 1 || old(passed_on) == 0;
  free ensures {:va_keep} false || old(ref) == 0 || old(ref) == 1;
...
procedure {:origName "sdv_RunAddDevice"} {:osmodel} sdv_RunAddDevice(actual_p1: int, actual_p2: int) returns (Tmp_68: int);
  ...
  free ensures {:va_keep} Tmp_68 == 0 || Tmp_68 == -1073741810 || Tmp_68 == -1073741824 || Tmp_68 == -1073741771 || Tmp_68 == -1073741670 || Tmp_68 == -1073741823;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} false || old(in_pnp) == 0 || old(in_pnp) == 1;
  free ensures {:va_keep} false || old(passed_on) == 1 || old(passed_on) == 0;
  free ensures {:va_keep} false || old(ref) == 0 || old(ref) == 1;
...
procedure {:origName "IoGetDeviceProperty"} {:osmodel} IoGetDeviceProperty(actual_DeviceObject: int, actual_DeviceProperty: int, actual_BufferLength: int, actual_PropertyBuffer: int, actual_ResultLength: int) returns (Tmp_70: int);
  free ensures {:va_keep} Tmp_70 == -1073741584 || Tmp_70 == -1073741808 || Tmp_70 == -1073741823 || Tmp_70 == 0 || Tmp_70 == -1073741789;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} false || old(in_pnp) == 0 || old(in_pnp) == 1;
  free ensures {:va_keep} false || old(passed_on) == 1 || old(passed_on) == 0;
  free ensures {:va_keep} false || old(ref) == 0 || old(ref) == 1;
...
procedure {:origName "IoCreateDevice"} {:osmodel} IoCreateDevice(actual_DriverObject: int, actual_DeviceExtensionSize: int, actual_DeviceName: int, actual_DeviceType: int, actual_DeviceCharacteristics: int, actual_Exclusive: int, actual_DeviceObject_1: int) returns (Tmp_78: int);
  free ensures {:va_keep} Tmp_78 == -1073741824 || Tmp_78 == -1073741771 || Tmp_78 == -1073741670 || Tmp_78 == -1073741823 || Tmp_78 == 0;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} false || old(in_pnp) == 0 || old(in_pnp) == 1;
  free ensures {:va_keep} false || old(passed_on) == 1 || old(passed_on) == 0;
  free ensures {:va_keep} false || old(ref) == 0 || old(ref) == 1;
...
procedure {:origName "EtwRegister"} {:osmodel} EtwRegister(actual_ProviderId: int, actual_EnableCallback: int, actual_CallbackContext: int, actual_RegHandle: int) returns (Tmp_88: int);
  free ensures {:va_keep} Tmp_88 == 0 || Tmp_88 == -1073741823 || Tmp_88 == -1073741811;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} false || old(in_pnp) == 0 || old(in_pnp) == 1;
  free ensures {:va_keep} false || old(passed_on) == 1 || old(passed_on) == 0;
  free ensures {:va_keep} false || old(ref) == 0 || old(ref) == 1;
...
procedure {:nohoudini} {:origName "sdv_main"} {:osmodel} sdv_main();
  modifies alloc, SLAM_guard_S_0, passed_on, ref, Mem_T.MinorFunction__IO_STACK_LOCATION, in_pnp, Mem_T.Type_unnamed_tag_26, sdv_start_info, sdv_end_info, yogi_error, Mem_T.CurrentStackLocation_unnamed_tag_6, Mem_T.Information__IO_STATUS_BLOCK;
  free ensures {:va_keep} ref == 1 || ref == 0 || ref == old(ref);
  free ensures {:va_keep} yogi_error == 1 || yogi_error == old(yogi_error);
  free ensures {:va_keep} passed_on == 1 || passed_on == 0 || passed_on == old(passed_on);
  free ensures {:va_keep} in_pnp == 1 || in_pnp == old(in_pnp);
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} false || old(in_pnp) == 0 || old(in_pnp) == 1;
  free ensures {:va_keep} false || old(passed_on) == 1 || old(passed_on) == 0;
  free ensures {:va_keep} false || old(ref) == 0 || old(ref) == 1;
...
procedure {:origName "ZwOpenEvent"} {:osmodel} ZwOpenEvent(actual_EventHandle: int, actual_DesiredAccess: int, actual_ObjectAttributes: int) returns (Tmp_94: int);
  modifies alloc;
  free ensures {:va_keep} Tmp_94 == 0 || Tmp_94 == -1073741823;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} false || old(in_pnp) == 0 || old(in_pnp) == 1;
  free ensures {:va_keep} false || old(passed_on) == 1 || old(passed_on) == 0;
  free ensures {:va_keep} false || old(ref) == 0 || old(ref) == 1;
...
procedure {:origName "IoDeleteSymbolicLink"} {:osmodel} IoDeleteSymbolicLink(actual_SymbolicLinkName: int) returns (Tmp_96: int);
  free ensures {:va_keep} Tmp_96 == 0 || Tmp_96 == -1073741823;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} false || old(in_pnp) == 0 || old(in_pnp) == 1;
  free ensures {:va_keep} false || old(passed_on) == 1 || old(passed_on) == 0;
  free ensures {:va_keep} false || old(ref) == 0 || old(ref) == 1;
...
procedure {:origName "PoCallDriver"} {:osmodel} PoCallDriver(actual_DeviceObject_2: int, actual_Irp: int) returns (Tmp_100: int);
  free ensures {:va_keep} Tmp_100 == 259;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} false || old(in_pnp) == 0 || old(in_pnp) == 1;
  free ensures {:va_keep} false || old(passed_on) == 1 || old(passed_on) == 0;
  free ensures {:va_keep} false || old(ref) == 0 || old(ref) == 1;
...
procedure {:origName "ZwUnmapViewOfSection"} {:osmodel} ZwUnmapViewOfSection(actual_ProcessHandle: int, actual_BaseAddress: int) returns (Tmp_106: int);
  free ensures {:va_keep} Tmp_106 == -1073741823 || Tmp_106 == -1073741811 || Tmp_106 == 0;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} false || old(in_pnp) == 0 || old(in_pnp) == 1;
  free ensures {:va_keep} false || old(passed_on) == 1 || old(passed_on) == 0;
  free ensures {:va_keep} false || old(ref) == 0 || old(ref) == 1;
...
procedure {:origName "ExUuidCreate"} {:osmodel} ExUuidCreate(actual_Uuid: int) returns (Tmp_120: int);
  free ensures {:va_keep} Tmp_120 == 0 || Tmp_120 == -1073741267;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} false || old(in_pnp) == 0 || old(in_pnp) == 1;
  free ensures {:va_keep} false || old(passed_on) == 1 || old(passed_on) == 0;
  free ensures {:va_keep} false || old(ref) == 0 || old(ref) == 1;
...
procedure {:origName "IoAllocateDriverObjectExtension"} {:osmodel} IoAllocateDriverObjectExtension(actual_DriverObject_1: int, actual_ClientIdentificationAddress: int, actual_DriverObjectExtensionSize: int, actual_DriverObjectExtension: int) returns (Tmp_126: int);
  free ensures {:va_keep} Tmp_126 == -1073741670 || Tmp_126 == -1073741771 || Tmp_126 == 0;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} false || old(in_pnp) == 0 || old(in_pnp) == 1;
  free ensures {:va_keep} false || old(passed_on) == 1 || old(passed_on) == 0;
  free ensures {:va_keep} false || old(ref) == 0 || old(ref) == 1;
...
procedure {:nohoudini} {:origName "main"} {:osmodel} {:entrypoint} main() returns (Tmp_136: int, dup_assertVar: bool);
  modifies alloc, SLAM_guard_S_0, in_pnp, passed_on, ref, yogi_error, Mem_T.CurrentStackLocation_unnamed_tag_6, Mem_T.MinorFunction__IO_STACK_LOCATION, Mem_T.Type_unnamed_tag_26, sdv_start_info, sdv_end_info, Mem_T.Information__IO_STATUS_BLOCK;
  free ensures {:va_keep} ref == 1 || ref == 0;
  free ensures {:va_keep} yogi_error == 1 || yogi_error == 0;
  free ensures {:va_keep} passed_on == 1 || passed_on == 0;
  free ensures {:va_keep} in_pnp == 1 || in_pnp == 0;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} false || old(in_pnp) == 0 || old(in_pnp) == 1;
  free ensures {:va_keep} false || old(passed_on) == 1 || old(passed_on) == 0;
  free ensures {:va_keep} false || old(ref) == 0 || old(ref) == 1;
...
implementation {:origName "main"} {:osmodel} main() returns (Tmp_136: int, dup_assertVar: bool)
{
  ...
  anon0:
    ...
    call {:si_unique_call 373} vslice_dummy_var_853 := __HAVOC_malloc(140);
...
procedure {:origName "sdv_RunStartDevice"} {:osmodel} sdv_RunStartDevice(actual_po: int, actual_pirp_4: int) returns (Tmp_156: int);
  modifies Mem_T.MinorFunction__IO_STACK_LOCATION, alloc, in_pnp, Mem_T.CurrentStackLocation_unnamed_tag_6, ref, Mem_T.Type_unnamed_tag_26, Mem_T.Information__IO_STATUS_BLOCK;
  free ensures {:va_keep} old(in_pnp) == 1 ==> in_pnp != 0;
  free ensures {:va_keep} old(ref) == 1 ==> ref != 0;
  free ensures {:va_keep} old(SLAM_guard_S_0) == old(SLAM_guard_S_0_init) ==> in_pnp == old(in_pnp);
  free ensures {:va_keep} ref == 1 || ref == old(ref);
  free ensures {:va_keep} in_pnp == 1 || in_pnp == old(in_pnp);
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} false || old(in_pnp) == 0 || old(in_pnp) == 1;
  free ensures {:va_keep} false || old(passed_on) == 1 || old(passed_on) == 0;
...
procedure {:origName "sdv_RunDispatchFunction"} {:osmodel} sdv_RunDispatchFunction(actual_po_1: int, actual_pirp_5: int) returns (Tmp_162: int);
  modifies sdv_start_info, sdv_end_info, alloc, Mem_T.MinorFunction__IO_STACK_LOCATION, in_pnp, Mem_T.CurrentStackLocation_unnamed_tag_6, ref, Mem_T.Type_unnamed_tag_26, Mem_T.Information__IO_STATUS_BLOCK, passed_on;
  free ensures {:va_keep} old(in_pnp) == 1 ==> in_pnp != 0;
  free ensures {:va_keep} old(passed_on) == 1 ==> passed_on != 0;
  free ensures {:va_keep} old(ref) == 1 ==> ref != 0;
  free ensures {:va_keep} old(SLAM_guard_S_0) == old(SLAM_guard_S_0_init) ==> in_pnp == old(in_pnp);
  free ensures {:va_keep} old(SLAM_guard_S_0) == old(SLAM_guard_S_0_init) ==> passed_on == old(passed_on);
  free ensures {:va_keep} ref == 1 || ref == old(ref);
  free ensures {:va_keep} passed_on == 1 || passed_on == old(passed_on);
  free ensures {:va_keep} in_pnp == 1 || in_pnp == old(in_pnp);
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} false || old(in_pnp) == 0 || old(in_pnp) == 1;
  free ensures {:va_keep} false || old(passed_on) == 1 || old(passed_on) == 0;
...
procedure {:origName "IoRegisterDeviceInterface"} {:osmodel} IoRegisterDeviceInterface(actual_PhysicalDeviceObject: int, actual_InterfaceClassGuid: int, actual_ReferenceString: int, actual_SymbolicLinkName_1: int) returns (Tmp_166: int);
  free ensures {:va_keep} Tmp_166 == -1073741823 || Tmp_166 == -1073741808 || Tmp_166 == 0;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} false || old(in_pnp) == 0 || old(in_pnp) == 1;
  free ensures {:va_keep} false || old(passed_on) == 1 || old(passed_on) == 0;
  free ensures {:va_keep} false || old(ref) == 0 || old(ref) == 1;
...
procedure {:origName "IofCallDriver"} {:osmodel} IofCallDriver(actual_DeviceObject_5: int, actual_Irp_2: int) returns (Tmp_184: int);
  free ensures {:va_keep} Tmp_184 == 259;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} false || old(in_pnp) == 0 || old(in_pnp) == 1;
  free ensures {:va_keep} false || old(passed_on) == 1 || old(passed_on) == 0;
  free ensures {:va_keep} false || old(ref) == 0 || old(ref) == 1;
...
procedure {:origName "ZwOpenKey"} {:osmodel} ZwOpenKey(actual_KeyHandle: int, actual_DesiredAccess_2: int, actual_ObjectAttributes_1: int) returns (Tmp_186: int);
  modifies alloc;
  free ensures {:va_keep} Tmp_186 == 0 || Tmp_186 == -1073741727;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} false || old(in_pnp) == 0 || old(in_pnp) == 1;
  free ensures {:va_keep} false || old(passed_on) == 1 || old(passed_on) == 0;
  free ensures {:va_keep} false || old(ref) == 0 || old(ref) == 1;
...
procedure {:origName "IoForwardIrpSynchronously"} {:osmodel} IoForwardIrpSynchronously(actual_DeviceObject_8: int, actual_Irp_3: int) returns (Tmp_202: int);
  free ensures {:va_keep} Tmp_202 == 1 || Tmp_202 == 0;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} false || old(in_pnp) == 0 || old(in_pnp) == 1;
  free ensures {:va_keep} false || old(passed_on) == 1 || old(passed_on) == 0;
  free ensures {:va_keep} false || old(ref) == 0 || old(ref) == 1;
...
procedure {:origName "sdv_hash_1038281869"} sdv_hash_1038281869(actual_Filter: int, actual_NeedLock: int, actual_IsFinalRemove: int, actual_DontDeleteDevnode: int) returns (Tmp_228: int);
  modifies alloc, ref, Mem_T.Type_unnamed_tag_26, Mem_T.CurrentStackLocation_unnamed_tag_6, Mem_T.Information__IO_STATUS_BLOCK;
  free ensures {:va_keep} old(ref) == 1 ==> ref != 0;
  free ensures {:va_keep} ref == 1 || ref == old(ref);
  free ensures {:va_keep} Tmp_228 == 0 || Tmp_228 == -1073741811;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} false || old(in_pnp) == 0 || old(in_pnp) == 1;
  free ensures {:va_keep} false || old(passed_on) == 1 || old(passed_on) == 0;
  free ensures {:va_keep} false || old(ref) == 0 || old(ref) == 1;
...
implementation {:origName "sdv_hash_1038281869"} sdv_hash_1038281869(actual_Filter: int, actual_NeedLock: int, actual_IsFinalRemove: int, actual_DontDeleteDevnode: int) returns (Tmp_228: int)
{
  ...
  anon11_Else:
    ...
    call {:si_unique_call 427} sdv_hash_613687309(vslice_dummy_var_854);
    goto L6;
  ...
  anon13_Else:
    ...
    call {:si_unique_call 432} sdv_hash_986004649(vslice_dummy_var_855);
    goto L27;
...
procedure {:origName "sdv_hash_890975460"} sdv_hash_890975460(actual_Context_3: int);
  modifies alloc, Mem_T.CurrentStackLocation_unnamed_tag_6, Mem_T.Information__IO_STATUS_BLOCK;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} false || old(in_pnp) == 0 || old(in_pnp) == 1;
  free ensures {:va_keep} false || old(passed_on) == 1 || old(passed_on) == 0;
  free ensures {:va_keep} false || old(ref) == 0 || old(ref) == 1;
...
implementation {:origName "sdv_hash_890975460"} sdv_hash_890975460(actual_Context_3: int)
{
  ...
  anon123_Then:
    ...
    call {:si_unique_call 454} vslice_dummy_var_72 := VolSnapDefaultDispatch(vslice_dummy_var_856, irp);
    goto L95;
  ...
  anon122_Then:
    ...
    call {:si_unique_call 455} vslice_dummy_var_71 := VolSnapDefaultDispatch(vslice_dummy_var_857, irp);
    goto L95;
  ...
  anon121_Then:
    ...
    call {:si_unique_call 456} vslice_dummy_var_70 := VolSnapDefaultDispatch(vslice_dummy_var_858, irp);
    goto L95;
  ...
  anon118_Then:
    ...
    call {:si_unique_call 457} vslice_dummy_var_69 := VolSnapDefaultDispatch(vslice_dummy_var_859, irp);
    goto L95;
  ...
  anon117_Then:
    ...
    call {:si_unique_call 458} vslice_dummy_var_68 := VolSnapDefaultDispatch(vslice_dummy_var_860, irp);
    goto L95;
  ...
  anon116_Then:
    ...
    call {:si_unique_call 459} vslice_dummy_var_67 := VolSnapDefaultDispatch(vslice_dummy_var_861, irp);
    goto L95;
  ...
  anon115_Then:
    ...
    call {:si_unique_call 460} vslice_dummy_var_66 := VolSnapDefaultDispatch(vslice_dummy_var_862, irp);
    goto L95;
  ...
  anon114_Then:
    ...
    call {:si_unique_call 461} vslice_dummy_var_65 := VolSnapDefaultDispatch(vslice_dummy_var_863, irp);
    goto L95;
  ...
  anon113_Then:
    ...
    call {:si_unique_call 462} vslice_dummy_var_64 := VolSnapDefaultDispatch(vslice_dummy_var_864, irp);
    goto L95;
  ...
  anon112_Then:
    ...
    call {:si_unique_call 463} vslice_dummy_var_63 := VolSnapDefaultDispatch(vslice_dummy_var_865, irp);
    goto L95;
  ...
  anon111_Then:
    ...
    call {:si_unique_call 464} vslice_dummy_var_62 := VolSnapDefaultDispatch(vslice_dummy_var_866, irp);
    goto L95;
  ...
  anon110_Then:
    ...
    call {:si_unique_call 465} vslice_dummy_var_61 := VolSnapDefaultDispatch(vslice_dummy_var_867, irp);
    goto L95;
  ...
  anon108_Then:
    ...
    call {:si_unique_call 466} vslice_dummy_var_60 := VolSnapDefaultDispatch(vslice_dummy_var_868, irp);
    goto L95;
  ...
  anon107_Then:
    ...
    call {:si_unique_call 467} vslice_dummy_var_59 := VolSnapDefaultDispatch(vslice_dummy_var_869, irp);
    goto L95;
  ...
  anon106_Then:
    ...
    call {:si_unique_call 468} vslice_dummy_var_58 := VolSnapDefaultDispatch(vslice_dummy_var_870, irp);
    goto L95;
  ...
  anon104_Then:
    ...
    call {:si_unique_call 469} vslice_dummy_var_57 := VolSnapDefaultDispatch(vslice_dummy_var_871, irp);
    goto L95;
  ...
  anon103_Then:
    ...
    call {:si_unique_call 470} vslice_dummy_var_56 := VolSnapDefaultDispatch(vslice_dummy_var_872, irp);
    goto L95;
  ...
  anon102_Then:
    ...
    call {:si_unique_call 471} vslice_dummy_var_55 := VolSnapDefaultDispatch(vslice_dummy_var_873, irp);
    goto L95;
  ...
  anon100_Then:
    ...
    call {:si_unique_call 472} vslice_dummy_var_54 := VolSnapDefaultDispatch(vslice_dummy_var_874, irp);
    goto L95;
  ...
  anon99_Then:
    ...
    call {:si_unique_call 473} vslice_dummy_var_53 := VolSnapDefaultDispatch(vslice_dummy_var_875, irp);
    goto L95;
  ...
  anon98_Then:
    ...
    call {:si_unique_call 474} vslice_dummy_var_52 := VolSnapDefaultDispatch(vslice_dummy_var_876, irp);
    goto L95;
  ...
  anon97_Then:
    ...
    call {:si_unique_call 475} vslice_dummy_var_51 := VolSnapDefaultDispatch(vslice_dummy_var_877, irp);
    goto L95;
...
procedure {:origName "VolSnapPower"} VolSnapPower(actual_DeviceObject_9: int, actual_Irp_5: int) returns (Tmp_255: int);
  modifies alloc, passed_on, Mem_T.CurrentStackLocation_unnamed_tag_6;
  free ensures {:va_keep} old(passed_on) == 1 ==> passed_on != 0;
  free ensures {:va_keep} old(SLAM_guard_S_0) == old(SLAM_guard_S_0_init) ==> passed_on == old(passed_on);
  free ensures {:va_keep} passed_on == 1 || passed_on == old(passed_on);
  free ensures {:va_keep} old(yogi_error) == 0;
...
procedure {:origName "sdv_hash_570003108"} sdv_hash_570003108(actual_Extension: int, actual_DiffAreaFilter: int, actual_SpecificIoStatus: int, actual_FinalStatus: int, actual_UniqueErrorValue: int, actual_PerformSynchronously: int);
  modifies alloc, Mem_T.Type_unnamed_tag_26, ref, Mem_T.CurrentStackLocation_unnamed_tag_6, Mem_T.Information__IO_STATUS_BLOCK;
  free ensures {:va_keep} old(ref) == 1 ==> ref != 0;
  free ensures {:va_keep} ref == 1 || ref == old(ref);
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} false || old(in_pnp) == 0 || old(in_pnp) == 1;
...
procedure {:origName "DriverEntry"} DriverEntry(actual_DriverObject_5: int, actual_RegistryPath: int) returns (Tmp_269: int);
  ...
  free ensures {:va_keep} old(ref) == 0 ==> ref != 1;
  free ensures {:va_keep} old(ref) == 1 ==> ref != 0;
  free ensures {:va_keep} old(SLAM_guard_S_0) == old(SLAM_guard_S_0_init) ==> ref == old(ref);
  free ensures {:va_keep} ref == 1 || ref == old(ref);
  free ensures {:va_keep} Tmp_269 == -1073741811 || Tmp_269 == -1073741824 || Tmp_269 == -1073741771 || Tmp_269 == -1073741670 || Tmp_269 == -1073741823 || Tmp_269 == 0;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} false || old(in_pnp) == 0 || old(in_pnp) == 1;
  free ensures {:va_keep} false || old(passed_on) == 1 || old(passed_on) == 0;
  free ensures {:va_keep} false || old(ref) == 0 || old(ref) == 1;
...
implementation {:origName "DriverEntry"} DriverEntry(actual_DriverObject_5: int, actual_RegistryPath: int) returns (Tmp_269: int)
{
  ...
  anon62_Else:
    ...
    call {:si_unique_call 566} sdv_hash_364468681(rootExtension, vslice_dummy_var_878);
    goto L171;
  ...
  anon63_Else:
    ...
    call {:si_unique_call 567} ExFreeToNPagedLookasideList(ContextLookasideList__DO_EXTENSION(rootExtension), vslice_dummy_var_879);
    goto L175;
  ...
  anon68_Else:
    ...
    call {:si_unique_call 581} status_7 := _ObReferenceObjectByHandle(vslice_dummy_var_880, 0, 0, 0, event, 0);
...
procedure {:origName "sdv_hash_84974865"} sdv_hash_84974865(actual_Filter_2: int) returns (Tmp_297: int);
  modifies alloc;
  free ensures {:va_keep} Tmp_297 == -1073741810 || Tmp_297 == 0;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} false || old(in_pnp) == 0 || old(in_pnp) == 1;
  free ensures {:va_keep} false || old(passed_on) == 1 || old(passed_on) == 0;
  free ensures {:va_keep} false || old(ref) == 0 || old(ref) == 1;
...
implementation {:origName "sdv_hash_493014447"} sdv_hash_493014447(actual_RootExtension_1: int, actual_Context_4: int)
{
  ...
  anon152_Then:
    ...
    call {:si_unique_call 603} vslice_dummy_var_112 := VolSnapDefaultDispatch(vslice_dummy_var_881, irp_1);
    goto L1;
  ...
  anon151_Then:
    ...
    call {:si_unique_call 604} vslice_dummy_var_111 := VolSnapDefaultDispatch(vslice_dummy_var_882, irp_1);
    goto L1;
  ...
  anon150_Then:
    ...
    call {:si_unique_call 605} vslice_dummy_var_110 := VolSnapDefaultDispatch(vslice_dummy_var_883, irp_1);
    goto L1;
  ...
  anon147_Then:
    ...
    call {:si_unique_call 606} vslice_dummy_var_109 := VolSnapDefaultDispatch(vslice_dummy_var_884, irp_1);
    goto L1;
  ...
  anon146_Then:
    ...
    call {:si_unique_call 607} vslice_dummy_var_108 := VolSnapDefaultDispatch(vslice_dummy_var_885, irp_1);
    goto L1;
  ...
  anon145_Then:
    ...
    call {:si_unique_call 608} vslice_dummy_var_107 := VolSnapDefaultDispatch(vslice_dummy_var_886, irp_1);
    goto L1;
  ...
  anon144_Then:
    ...
    call {:si_unique_call 609} vslice_dummy_var_106 := VolSnapDefaultDispatch(vslice_dummy_var_887, irp_1);
    goto L1;
  ...
  anon143_Then:
    ...
    call {:si_unique_call 610} vslice_dummy_var_105 := VolSnapDefaultDispatch(vslice_dummy_var_888, irp_1);
    goto L1;
  ...
  anon142_Then:
    ...
    call {:si_unique_call 611} vslice_dummy_var_104 := VolSnapDefaultDispatch(vslice_dummy_var_889, irp_1);
    goto L1;
  ...
  anon141_Then:
    ...
    call {:si_unique_call 612} vslice_dummy_var_103 := VolSnapDefaultDispatch(vslice_dummy_var_890, irp_1);
    goto L1;
  ...
  anon140_Then:
    ...
    call {:si_unique_call 613} vslice_dummy_var_102 := VolSnapDefaultDispatch(vslice_dummy_var_891, irp_1);
    goto L1;
  ...
  anon139_Then:
    ...
    call {:si_unique_call 614} vslice_dummy_var_101 := VolSnapDefaultDispatch(vslice_dummy_var_892, irp_1);
    goto L1;
  ...
  anon137_Then:
    ...
    call {:si_unique_call 615} vslice_dummy_var_100 := VolSnapDefaultDispatch(vslice_dummy_var_893, irp_1);
    goto L1;
  ...
  anon136_Then:
    ...
    call {:si_unique_call 616} vslice_dummy_var_99 := VolSnapDefaultDispatch(vslice_dummy_var_894, irp_1);
    goto L1;
  ...
  anon135_Then:
    ...
    call {:si_unique_call 617} vslice_dummy_var_98 := VolSnapDefaultDispatch(vslice_dummy_var_895, irp_1);
    goto L1;
  ...
  anon133_Then:
    ...
    call {:si_unique_call 618} vslice_dummy_var_97 := VolSnapDefaultDispatch(vslice_dummy_var_896, irp_1);
    goto L1;
  ...
  anon132_Then:
    ...
    call {:si_unique_call 619} vslice_dummy_var_96 := VolSnapDefaultDispatch(vslice_dummy_var_897, irp_1);
    goto L1;
  ...
  anon131_Then:
    ...
    call {:si_unique_call 620} vslice_dummy_var_95 := VolSnapDefaultDispatch(vslice_dummy_var_898, irp_1);
    goto L1;
  ...
  anon129_Then:
    ...
    call {:si_unique_call 621} vslice_dummy_var_94 := VolSnapDefaultDispatch(vslice_dummy_var_899, irp_1);
    goto L1;
  ...
  anon128_Then:
    ...
    call {:si_unique_call 622} vslice_dummy_var_93 := VolSnapDefaultDispatch(vslice_dummy_var_900, irp_1);
    goto L1;
  ...
  anon127_Then:
    ...
    call {:si_unique_call 623} vslice_dummy_var_92 := VolSnapDefaultDispatch(vslice_dummy_var_901, irp_1);
    goto L1;
  ...
  anon126_Then:
    ...
    call {:si_unique_call 624} vslice_dummy_var_91 := VolSnapDefaultDispatch(vslice_dummy_var_902, irp_1);
    goto L1;
  ...
  anon180_Then:
    ...
    call {:si_unique_call 633} vslice_dummy_var_135 := VolSnapDefaultDispatch(vslice_dummy_var_903, irp_1);
    goto L1;
  ...
  anon179_Then:
    ...
    call {:si_unique_call 634} vslice_dummy_var_134 := VolSnapDefaultDispatch(vslice_dummy_var_904, irp_1);
    goto L1;
  ...
  anon178_Then:
    ...
    call {:si_unique_call 635} vslice_dummy_var_133 := VolSnapDefaultDispatch(vslice_dummy_var_905, irp_1);
    goto L1;
  ...
  anon175_Then:
    ...
    call {:si_unique_call 636} vslice_dummy_var_132 := VolSnapDefaultDispatch(vslice_dummy_var_906, irp_1);
    goto L1;
  ...
  anon174_Then:
    ...
    call {:si_unique_call 637} vslice_dummy_var_131 := VolSnapDefaultDispatch(vslice_dummy_var_907, irp_1);
    goto L1;
  ...
  anon173_Then:
    ...
    call {:si_unique_call 638} vslice_dummy_var_130 := VolSnapDefaultDispatch(vslice_dummy_var_908, irp_1);
    goto L1;
  ...
  anon172_Then:
    ...
    call {:si_unique_call 639} vslice_dummy_var_129 := VolSnapDefaultDispatch(vslice_dummy_var_909, irp_1);
    goto L1;
  ...
  anon171_Then:
    ...
    call {:si_unique_call 640} vslice_dummy_var_128 := VolSnapDefaultDispatch(vslice_dummy_var_910, irp_1);
    goto L1;
  ...
  anon170_Then:
    ...
    call {:si_unique_call 641} vslice_dummy_var_127 := VolSnapDefaultDispatch(vslice_dummy_var_911, irp_1);
    goto L1;
  ...
  anon169_Then:
    ...
    call {:si_unique_call 642} vslice_dummy_var_126 := VolSnapDefaultDispatch(vslice_dummy_var_912, irp_1);
    goto L1;
  ...
  anon168_Then:
    ...
    call {:si_unique_call 643} vslice_dummy_var_125 := VolSnapDefaultDispatch(vslice_dummy_var_913, irp_1);
    goto L1;
  ...
  anon167_Then:
    ...
    call {:si_unique_call 644} vslice_dummy_var_124 := VolSnapDefaultDispatch(vslice_dummy_var_914, irp_1);
    goto L1;
  ...
  anon165_Then:
    ...
    call {:si_unique_call 645} vslice_dummy_var_123 := VolSnapDefaultDispatch(vslice_dummy_var_915, irp_1);
    goto L1;
  ...
  anon164_Then:
    ...
    call {:si_unique_call 646} vslice_dummy_var_122 := VolSnapDefaultDispatch(vslice_dummy_var_916, irp_1);
    goto L1;
  ...
  anon163_Then:
    ...
    call {:si_unique_call 647} vslice_dummy_var_121 := VolSnapDefaultDispatch(vslice_dummy_var_917, irp_1);
    goto L1;
  ...
  anon161_Then:
    ...
    call {:si_unique_call 648} vslice_dummy_var_120 := VolSnapDefaultDispatch(vslice_dummy_var_918, irp_1);
    goto L1;
  ...
  anon160_Then:
    ...
    call {:si_unique_call 649} vslice_dummy_var_119 := VolSnapDefaultDispatch(vslice_dummy_var_919, irp_1);
    goto L1;
  ...
  anon159_Then:
    ...
    call {:si_unique_call 650} vslice_dummy_var_118 := VolSnapDefaultDispatch(vslice_dummy_var_920, irp_1);
    goto L1;
  ...
  anon157_Then:
    ...
    call {:si_unique_call 651} vslice_dummy_var_117 := VolSnapDefaultDispatch(vslice_dummy_var_921, irp_1);
    goto L1;
  ...
  anon156_Then:
    ...
    call {:si_unique_call 652} vslice_dummy_var_116 := VolSnapDefaultDispatch(vslice_dummy_var_922, irp_1);
    goto L1;
  ...
  anon155_Then:
    ...
    call {:si_unique_call 653} vslice_dummy_var_115 := VolSnapDefaultDispatch(vslice_dummy_var_923, irp_1);
    goto L1;
  ...
  anon154_Then:
    ...
    call {:si_unique_call 654} vslice_dummy_var_114 := VolSnapDefaultDispatch(vslice_dummy_var_924, irp_1);
    goto L1;
...
procedure {:origName "VspIsSetup"} VspIsSetup() returns (Tmp_311: int);
  modifies alloc;
  free ensures {:va_keep} Tmp_311 == 1 || Tmp_311 == 0;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} false || old(in_pnp) == 0 || old(in_pnp) == 1;
  free ensures {:va_keep} false || old(passed_on) == 1 || old(passed_on) == 0;
  free ensures {:va_keep} false || old(ref) == 0 || old(ref) == 1;
...
implementation {:origName "sdv_hash_805325738"} sdv_hash_805325738(actual_Extension_1: int, actual_WorkItem_1: int, actual_AlwaysPost: int)
{
  ...
  anon17_Else:
    ...
    call {:si_unique_call 678} sdv_hash_21074203(vslice_dummy_var_925, WorkItem_1, sdv_187);
    goto L1;
...
implementation {:origName "VspCancelRoutine"} VspCancelRoutine(actual_DeviceObject_10: int, actual_Irp_8: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 683} IoReleaseCancelSpinLock(vslice_dummy_var_926);
    assume {:nonnull} Irp_8 != 0;
    assume Irp_8 > 0;
    assume {:nonnull} Irp_8 != 0;
    assume Irp_8 > 0;
...
procedure {:origName "sdv_hash_69582830"} sdv_hash_69582830(actual_Extension_2: int) returns (Tmp_333: int);
  ...
  free ensures {:va_keep} old(ref) == 1 ==> ref != 0;
  free ensures {:va_keep} ref == 1 || ref == old(ref);
  free ensures {:va_keep} Tmp_333 == -1073741811 || Tmp_333 == 0 || Tmp_333 == -1073741823 || Tmp_333 == -1073741670;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} false || old(in_pnp) == 0 || old(in_pnp) == 1;
  free ensures {:va_keep} false || old(passed_on) == 1 || old(passed_on) == 0;
  free ensures {:va_keep} false || old(ref) == 0 || old(ref) == 1;
...
implementation {:origName "sdv_hash_69582830"} sdv_hash_69582830(actual_Extension_2: int) returns (Tmp_333: int)
{
  ...
  L23:
    ...
    call {:si_unique_call 694} sdv_hash_613687309(vslice_dummy_var_927);
    assume {:nonnull} Extension_2 != 0;
    assume Extension_2 > 0;
    goto anon33_Then, anon33_Else;
  ...
  anon34_Else:
    ...
    call {:si_unique_call 697} sdv_hash_986004649(vslice_dummy_var_928);
    Tmp_333 := 0;
    goto L1;
  ...
  anon45_Else:
    ...
    call {:si_unique_call 699} sdv_hash_986004649(vslice_dummy_var_929);
    Tmp_333 := 0;
    goto L1;
  ...
  anon38_Else:
    ...
    call {:si_unique_call 701} VspFreeBitMap(vslice_dummy_var_930);
  ...
  L67:
    ...
    call {:si_unique_call 704} sdv_hash_986004649(vslice_dummy_var_931);
    Tmp_333 := 0;
    goto L1;
  ...
  anon40_Else:
    ...
    call {:si_unique_call 707} sdv_hash_986004649(vslice_dummy_var_932);
    assume {:nonnull} filter_4 != 0;
    assume filter_4 > 0;
  ...
  anon40_Then:
    ...
    call {:si_unique_call 711} sdv_hash_986004649(vslice_dummy_var_933);
    assume {:nonnull} filter_4 != 0;
    assume filter_4 > 0;
    havoc vslice_dummy_var_934;
    call {:si_unique_call 712} context_2 := sdv_hash_859757058(vslice_dummy_var_934);
    goto anon41_Then, anon41_Else;
  ...
  anon41_Else:
    ...
    call {:si_unique_call 715} sdv_hash_21074203(vslice_dummy_var_935, WorkItem__VSP_CONTEXT(context_2), sdv_205);
    Tmp_333 := 0;
    goto L1;
  ...
  anon39_Then:
    ...
    call {:si_unique_call 719} sdv_hash_986004649(vslice_dummy_var_936);
    Tmp_333 := 0;
    goto L1;
...
procedure {:origName "_ObReferenceObjectByHandle"} _ObReferenceObjectByHandle(actual_Handle_2: int, actual_DesiredAccess_3: int, actual_ObjectType_1: int, actual_AccessMode_1: int, actual_pObject: int, actual_pHandleInformation: int) returns (Tmp_340: int);
  ...
  free ensures {:va_keep} old(ref) == 1 ==> ref != 0;
  free ensures {:va_keep} ref == 1;
  free ensures {:va_keep} Tmp_340 == 0 || Tmp_340 == -1073741823;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} false || old(in_pnp) == 0 || old(in_pnp) == 1;
  free ensures {:va_keep} false || old(passed_on) == 1 || old(passed_on) == 0;
  free ensures {:va_keep} false || old(ref) == 0 || old(ref) == 1;
...
implementation {:origName "sdv_hash_601969222"} sdv_hash_601969222(actual_TimerDpc: int, actual_Context_5: int, actual_SystemArgument1: int, actual_SystemArgument2: int)
{
  ...
  anon9_Else:
    ...
    call {:si_unique_call 773} sdv_hash_493014447(vslice_dummy_var_937, context_3);
...
implementation {:origName "sdv_hash_1005542269"} sdv_hash_1005542269(actual_Filter_9: int, actual_TargetObject_1: int, actual_MajorFunction_1: int, actual_Offset_1: int, actual_Key_1: int, actual_FileObject_1: int, actual_IoReason: int) returns (Tmp_403: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 784} status_12 := VspSynchronousIo(vslice_dummy_var_938, TargetObject_1, MajorFunction_1, Offset_1, 16384, Key_1, FileObject_1, 0, Filter_9, IoReason);
...
implementation {:origName "sdv_hash_853253100"} sdv_hash_853253100(actual_Extension_5: int)
{
  ...
  anon37_Else:
    ...
    call {:si_unique_call 856} sdv_hash_21074203(vslice_dummy_var_939, workItem, sdv_265);
    goto L1;
  ...
  anon40_Else:
    ...
    call {:si_unique_call 861} sdv_hash_21074203(vslice_dummy_var_940, workItem, sdv_260);
    goto L1;
...
implementation {:origName "sdv_hash_301435450"} sdv_hash_301435450(actual_Extension_6: int) returns (Tmp_470: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 865} status_14 := sdv_hash_84974865(vslice_dummy_var_941);
    goto anon11_Then, anon11_Else;
  ...
  anon11_Else:
    ...
    call {:si_unique_call 866} status_14 := sdv_hash_1005562481(vslice_dummy_var_942, SnapshotGuid_VOLUME_EXTENSION(Extension_6), 0, 0);
    assume {:nonnull} Extension_6 != 0;
    assume Extension_6 > 0;
    havoc vslice_dummy_var_943;
    call {:si_unique_call 867} sdv_hash_946681144(vslice_dummy_var_943);
    goto anon12_Then, anon12_Else;
  ...
  anon13_Else:
    ...
    call {:si_unique_call 868} status_14 := sdv_hash_84974865(vslice_dummy_var_944);
    goto anon14_Then, anon14_Else;
  ...
  anon14_Else:
    ...
    call {:si_unique_call 869} status_14 := sdv_hash_1005562481(vslice_dummy_var_945, SnapshotGuid_VOLUME_EXTENSION(Extension_6), 0, 0);
    assume {:nonnull} diffAreaFile != 0;
    assume diffAreaFile > 0;
    havoc vslice_dummy_var_946;
    call {:si_unique_call 870} sdv_hash_946681144(vslice_dummy_var_946);
    goto anon15_Then, anon15_Else;
...
implementation {:origName "sdv_hash_24220996"} sdv_hash_24220996(actual_Filter_12: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 872} context_5 := sdv_hash_859757058(vslice_dummy_var_947);
    goto anon7_Then, anon7_Else;
...
procedure {:origName "sdv_hash_1005562481"} sdv_hash_1005562481(actual_Filter_13: int, actual_SnapshotGuid: int, actual_NonPagedResourceHeld: int, actual_ControlFileHandle: int) returns (Tmp_479: int);
  modifies Mem_T.Type_unnamed_tag_26, ref, alloc, Mem_T.CurrentStackLocation_unnamed_tag_6, Mem_T.Information__IO_STATUS_BLOCK;
  free ensures {:va_keep} old(ref) == 1 ==> ref != 0;
  free ensures {:va_keep} ref == 1 || ref == old(ref);
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} false || old(in_pnp) == 0 || old(in_pnp) == 1;
...
implementation {:origName "sdv_hash_1005562481"} sdv_hash_1005562481(actual_Filter_13: int, actual_SnapshotGuid: int, actual_NonPagedResourceHeld: int, actual_ControlFileHandle: int) returns (Tmp_479: int)
{
  ...
  L28_last:
    ...
    call {:si_unique_call 904} status_15 := sdv_hash_984605889(Filter_13, vslice_dummy_var_951, byteOffset, -699198463, sdv_281);
    goto anon59_Then, anon59_Else;
  ...
  anon62_Else:
    ...
    call {:si_unique_call 889} status_15 := sdv_hash_916928578(Filter_13, vslice_dummy_var_948, byteOffset, -699198462, sdv_283);
    goto anon68_Then, anon68_Else;
  ...
  anon71_Then:
    ...
    call {:si_unique_call 897} context_6 := sdv_hash_859757058(vslice_dummy_var_949);
  ...
  anon79_Else:
    ...
    call {:si_unique_call 899} sdv_hash_493014447(vslice_dummy_var_950, context_6);
    goto L90;
...
procedure {:origName "sdv_hash_185580169"} sdv_hash_185580169(actual_Filter_14: int, actual_SnapshotProtectModeFailureReason: int, actual_FailureStatus: int, actual_UniqueId: int) returns (Tmp_484: int);
  ...
  free ensures {:va_keep} old(ref) == 1 ==> ref != 0;
  free ensures {:va_keep} ref == 1 || ref == old(ref);
  free ensures {:va_keep} Tmp_484 == 1 || Tmp_484 == 0;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} false || old(in_pnp) == 0 || old(in_pnp) == 1;
  free ensures {:va_keep} false || old(passed_on) == 1 || old(passed_on) == 0;
  free ensures {:va_keep} false || old(ref) == 0 || old(ref) == 1;
...
implementation {:origName "sdv_hash_588722555"} sdv_hash_588722555(actual_DriverObject_7: int, actual_IrpQueue: int)
{
  ...
  anon87_Then:
    ...
    call {:si_unique_call 925} vslice_dummy_var_226 := VolSnapDefaultDispatch(vslice_dummy_var_952, irp_4);
  ...
  anon86_Then:
    ...
    call {:si_unique_call 926} vslice_dummy_var_225 := VolSnapDefaultDispatch(vslice_dummy_var_953, irp_4);
  ...
  anon85_Then:
    ...
    call {:si_unique_call 927} vslice_dummy_var_224 := VolSnapDefaultDispatch(vslice_dummy_var_954, irp_4);
  ...
  anon82_Then:
    ...
    call {:si_unique_call 928} vslice_dummy_var_223 := VolSnapDefaultDispatch(vslice_dummy_var_955, irp_4);
  ...
  anon81_Then:
    ...
    call {:si_unique_call 929} vslice_dummy_var_222 := VolSnapDefaultDispatch(vslice_dummy_var_956, irp_4);
  ...
  anon80_Then:
    ...
    call {:si_unique_call 930} vslice_dummy_var_221 := VolSnapDefaultDispatch(vslice_dummy_var_957, irp_4);
  ...
  anon79_Then:
    ...
    call {:si_unique_call 931} vslice_dummy_var_220 := VolSnapDefaultDispatch(vslice_dummy_var_958, irp_4);
  ...
  anon78_Then:
    ...
    call {:si_unique_call 932} vslice_dummy_var_219 := VolSnapDefaultDispatch(vslice_dummy_var_959, irp_4);
  ...
  anon77_Then:
    ...
    call {:si_unique_call 933} vslice_dummy_var_218 := VolSnapDefaultDispatch(vslice_dummy_var_960, irp_4);
  ...
  anon76_Then:
    ...
    call {:si_unique_call 934} vslice_dummy_var_217 := VolSnapDefaultDispatch(vslice_dummy_var_961, irp_4);
  ...
  anon75_Then:
    ...
    call {:si_unique_call 935} vslice_dummy_var_216 := VolSnapDefaultDispatch(vslice_dummy_var_962, irp_4);
    goto anon75_Then_dummy;
  ...
  anon74_Then:
    ...
    call {:si_unique_call 936} vslice_dummy_var_215 := VolSnapDefaultDispatch(vslice_dummy_var_963, irp_4);
  ...
  anon72_Then:
    ...
    call {:si_unique_call 937} vslice_dummy_var_214 := VolSnapDefaultDispatch(vslice_dummy_var_964, irp_4);
  ...
  anon71_Then:
    ...
    call {:si_unique_call 938} vslice_dummy_var_213 := VolSnapDefaultDispatch(vslice_dummy_var_965, irp_4);
  ...
  anon70_Then:
    ...
    call {:si_unique_call 939} vslice_dummy_var_212 := VolSnapDefaultDispatch(vslice_dummy_var_966, irp_4);
  ...
  anon68_Then:
    ...
    call {:si_unique_call 940} vslice_dummy_var_211 := VolSnapDefaultDispatch(vslice_dummy_var_967, irp_4);
  ...
  anon67_Then:
    ...
    call {:si_unique_call 941} vslice_dummy_var_210 := VolSnapDefaultDispatch(vslice_dummy_var_968, irp_4);
    goto anon67_Then_dummy;
  ...
  anon66_Then:
    ...
    call {:si_unique_call 942} vslice_dummy_var_209 := VolSnapDefaultDispatch(vslice_dummy_var_969, irp_4);
  ...
  anon64_Then:
    ...
    call {:si_unique_call 943} vslice_dummy_var_208 := VolSnapDefaultDispatch(vslice_dummy_var_970, irp_4);
  ...
  anon63_Then:
    ...
    call {:si_unique_call 944} vslice_dummy_var_207 := VolSnapDefaultDispatch(vslice_dummy_var_971, irp_4);
  ...
  anon62_Then:
    ...
    call {:si_unique_call 945} vslice_dummy_var_206 := VolSnapDefaultDispatch(vslice_dummy_var_972, irp_4);
  ...
  anon61_Then:
    ...
    call {:si_unique_call 946} vslice_dummy_var_205 := VolSnapDefaultDispatch(vslice_dummy_var_973, irp_4);
...
implementation {:origName "sdv_hash_242852003"} sdv_hash_242852003(actual_Filter_15: int)
{
  ...
  anon9_Else:
    ...
    call {:si_unique_call 960} sdv_hash_588722555(vslice_dummy_var_974, q_2);
    goto L1;
...
implementation {:origName "sdv_hash_692646834"} sdv_hash_692646834(actual_Extension_7: int)
{
  ...
  anon26_Then:
    ...
    call {:si_unique_call 973} sdv_hash_21074203(vslice_dummy_var_975, workItem_1, sdv_318);
    goto L1;
...
procedure {:origName "sdv_hash_881177106"} sdv_hash_881177106(actual_Extension_8: int, actual_Irp_12: int) returns (Tmp_512: int);
  modifies alloc, Mem_T.Information__IO_STATUS_BLOCK;
  free ensures {:va_keep} Tmp_512 == -1073741637 || Tmp_512 == 0 || Tmp_512 == -1073741670;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} false || old(in_pnp) == 0 || old(in_pnp) == 1;
  free ensures {:va_keep} false || old(passed_on) == 1 || old(passed_on) == 0;
  free ensures {:va_keep} false || old(ref) == 0 || old(ref) == 1;
...
implementation {:origName "VspSynchronousIo"} VspSynchronousIo(actual_Irp_13: int, actual_TargetObject_2: int, actual_MajorFunction_3: int, actual_Offset_3: int, actual_Length_3: int, actual_Key_2: int, actual_FileObject_2: int, actual_Thread: int, actual_Filter_16: int, actual_IoReason_2: int) returns (Tmp_520: int)
{
  ...
  anon26_Else:
    ...
    call {:si_unique_call 998} sdv_hash_403736888(Filter_16, IoReason_2, MajorFunction_3, Offset_3, Tmp_521, vslice_dummy_var_976, Irp_13);
    goto L68;
  ...
  anon26_Then:
    ...
    call {:si_unique_call 999} sdv_hash_403736888(Filter_16, IoReason_2, 0, 0, Tmp_524, vslice_dummy_var_977, Irp_13);
    goto L68;
...
implementation {:origName "sdv_hash_307580759"} sdv_hash_307580759(actual_Filter_17: int, actual_ControlBlockOffset: int, actual_MaximumDiffAreaSpace: int, actual_ResetSnapshotProtectionMode: int) returns (Tmp_529: int)
{
  ...
  L53:
    ...
    call {:si_unique_call 1017} sdv_hash_403736888(Filter_17, 1, 3, 0, 8192, vslice_dummy_var_978, 0);
    goto anon37_Then, anon37_Else;
  ...
  L121:
    ...
    call {:si_unique_call 1024} sdv_hash_403736888(Filter_17, 2, 4, 0, 8192, vslice_dummy_var_979, 0);
...
procedure {:origName "sdv_hash_672018212"} sdv_hash_672018212(actual_Extension_9: int, actual_QueueType_1: int) returns (Tmp_534: int);
  free ensures {:va_keep} Tmp_534 == 8 || Tmp_534 == 6 || Tmp_534 == 7 || Tmp_534 == 5 || Tmp_534 == actual_QueueType_1;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} false || old(in_pnp) == 0 || old(in_pnp) == 1;
  free ensures {:va_keep} false || old(passed_on) == 1 || old(passed_on) == 0;
  free ensures {:va_keep} false || old(ref) == 0 || old(ref) == 1;
...
procedure {:origName "sdv_hash_210112601"} sdv_hash_210112601(actual_Filter_18: int, actual_ListOfDiffAreaFilesToClose: int, actual_LisfOfDeviceObjectsToDelete: int, actual_KeepOnDisk: int, actual_DontWakePnp: int, actual_DeleteNewest: int) returns (Tmp_539: int);
  ...
  free ensures {:va_keep} old(ref) == 1 ==> ref != 0;
  free ensures {:va_keep} ref == 1 || ref == old(ref);
  free ensures {:va_keep} Tmp_539 == -1073741811 || Tmp_539 == 0;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} false || old(in_pnp) == 0 || old(in_pnp) == 1;
  free ensures {:va_keep} false || old(passed_on) == 1 || old(passed_on) == 0;
  free ensures {:va_keep} false || old(ref) == 0 || old(ref) == 1;
...
implementation {:origName "sdv_hash_210112601"} sdv_hash_210112601(actual_Filter_18: int, actual_ListOfDiffAreaFilesToClose: int, actual_LisfOfDeviceObjectsToDelete: int, actual_KeepOnDisk: int, actual_DontWakePnp: int, actual_DeleteNewest: int) returns (Tmp_539: int)
{
  ...
  anon11_Then:
    ...
    call {:si_unique_call 1058} sdv_hash_826125959(vslice_dummy_var_980);
...
procedure {:origName "IsEqualGUID"} IsEqualGUID(actual_rguid1: int, actual_rguid2: int) returns (Tmp_545: int);
  free ensures {:va_keep} Tmp_545 == 0 || Tmp_545 == 1;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} false || old(in_pnp) == 0 || old(in_pnp) == 1;
  free ensures {:va_keep} false || old(passed_on) == 1 || old(passed_on) == 0;
  free ensures {:va_keep} false || old(ref) == 0 || old(ref) == 1;
...
implementation {:origName "sdv_hash_259372028"} sdv_hash_259372028(actual_Extension_10: int, actual_NeedLock_1: int, actual_IsFinalRemove_1: int, actual_DontDeleteDevnode_1: int)
{
  ...
  anon36_Else:
    ...
    call {:si_unique_call 1081} VspFreeBitMap(vslice_dummy_var_981);
  ...
  anon37_Else:
    ...
    call {:si_unique_call 1083} VspFreeBitMap(vslice_dummy_var_982);
  ...
  L92:
    ...
    call {:si_unique_call 1089} VspFreeIrp(vslice_dummy_var_983, 1);
    assume {:nonnull} Extension_10 != 0;
    assume Extension_10 > 0;
    assume {:nonnull} Extension_10 != 0;
    assume Extension_10 > 0;
  ...
  L117:
    ...
    call {:si_unique_call 1092} sdv_hash_826125959(vslice_dummy_var_984);
    assume {:nonnull} Extension_10 != 0;
    assume Extension_10 > 0;
    goto anon42_Then, anon42_Else;
...
procedure {:origName "sdv_hash_1053884949"} sdv_hash_1053884949(actual_Filter_20: int, actual_BootSector: int) returns (Tmp_563: int);
  modifies alloc, Mem_T.Type_unnamed_tag_26;
  free ensures {:va_keep} Tmp_563 == 0 || Tmp_563 == 1;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} false || old(in_pnp) == 0 || old(in_pnp) == 1;
  free ensures {:va_keep} false || old(passed_on) == 1 || old(passed_on) == 0;
  free ensures {:va_keep} false || old(ref) == 0 || old(ref) == 1;
...
procedure {:origName "sdv_hash_208558080"} sdv_hash_208558080(actual_Filter_23: int, actual_NeedLock_2: int) returns (Tmp_570: int);
  modifies alloc;
  free ensures {:va_keep} Tmp_570 == -1073741823 || Tmp_570 == 0;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} false || old(in_pnp) == 0 || old(in_pnp) == 1;
  free ensures {:va_keep} false || old(passed_on) == 1 || old(passed_on) == 0;
  free ensures {:va_keep} false || old(ref) == 0 || old(ref) == 1;
...
implementation {:origName "sdv_hash_208558080"} sdv_hash_208558080(actual_Filter_23: int, actual_NeedLock_2: int) returns (Tmp_570: int)
{
  ...
  anon13_Else:
    ...
    call {:si_unique_call 1109} sdv_hash_613687309(vslice_dummy_var_985);
    goto L10;
  ...
  anon16_Else:
    ...
    call {:si_unique_call 1111} sdv_hash_986004649(vslice_dummy_var_986);
    goto L22;
  ...
  anon15_Else:
    ...
    call {:si_unique_call 1112} sdv_hash_986004649(vslice_dummy_var_987);
    goto L26;
...
procedure {:origName "sdv_hash_280759867"} sdv_hash_280759867(actual_Extension_11: int);
  modifies alloc, Mem_T.Type_unnamed_tag_26, Mem_T.CurrentStackLocation_unnamed_tag_6, Mem_T.Information__IO_STATUS_BLOCK;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} false || old(in_pnp) == 0 || old(in_pnp) == 1;
  free ensures {:va_keep} false || old(passed_on) == 1 || old(passed_on) == 0;
  free ensures {:va_keep} false || old(ref) == 0 || old(ref) == 1;
...
implementation {:origName "sdv_hash_280759867"} sdv_hash_280759867(actual_Extension_11: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 1114} sdv_hash_890975460(vslice_dummy_var_988);
...
implementation {:origName "sdv_hash_1047753544"} sdv_hash_1047753544(actual_Extension_12: int, actual_WorkItem_3: int)
{
  ...
  anon16_Else:
    ...
    call {:si_unique_call 1128} sdv_hash_21074203(vslice_dummy_var_989, WorkItem_3, sdv_389);
    goto L1;
...
implementation {:origName "sdv_hash_997443178"} sdv_hash_997443178(actual_TimerDpc_1: int, actual_Context_7: int, actual_SystemArgument1_1: int, actual_SystemArgument2_1: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 1134} sdv_hash_493014447(vslice_dummy_var_990, context_9);
    assume {:nonnull} filter_12 != 0;
    assume filter_12 > 0;
    goto anon13_Then, anon13_Else;
...
implementation {:origName "sdv_hash_364468681"} sdv_hash_364468681(actual_RootExtension_8: int, actual_TempTableEntry: int)
{
  ...
  anon11_Then:
    ...
    call {:si_unique_call 1152} sdv_hash_805325738(vslice_dummy_var_991, workItem_2, 1);
    goto L1;
  ...
  anon9_Then:
    ...
    call {:si_unique_call 1158} sdv_hash_805325738(vslice_dummy_var_992, workItem_2, 1);
    goto L1;
}
...
implementation {:origName "sdv_hash_194037626"} sdv_hash_194037626(actual_Filter_26: int, actual_ControlItem: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 1200} lookupEntry_2 := sdv_hash_414123790(vslice_dummy_var_993, SnapshotGuid__VSP_CONTROL_ITEM_SNAPSHOT(ControlItem), Filter_26);
    goto anon15_Then, anon15_Else;
...
implementation {:origName "sdv_hash_90601371"} sdv_hash_90601371(actual_Context_8: int)
{
  ...
  L47:
    ...
    call {:si_unique_call 1215} sdv_hash_493014447(vslice_dummy_var_994, context_12);
    goto anon62_Then, anon62_Else;
...
procedure {:origName "VolSnapPnp"} VolSnapPnp(actual_DeviceObject_12: int, actual_Irp_17: int) returns (Tmp_641: int);
  modifies alloc, Mem_T.CurrentStackLocation_unnamed_tag_6, ref, Mem_T.Type_unnamed_tag_26, Mem_T.Information__IO_STATUS_BLOCK;
  free ensures {:va_keep} old(ref) == 1 ==> ref != 0;
  free ensures {:va_keep} ref == 1 || ref == old(ref);
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} false || old(in_pnp) == 0 || old(in_pnp) == 1;
...
implementation {:origName "VolSnapPnp"} VolSnapPnp(actual_DeviceObject_12: int, actual_Irp_17: int) returns (Tmp_641: int)
{
  ...
  anon124_Then:
    ...
    call {:si_unique_call 1241} sdv_hash_613687309(vslice_dummy_var_995);
    assume {:nonnull} filter_14 != 0;
    assume filter_14 > 0;
    goto anon107_Then, anon107_Else;
  ...
  L44:
    ...
    call {:si_unique_call 1242} sdv_hash_986004649(vslice_dummy_var_996);
  ...
  anon150_Then:
    ...
    call {:si_unique_call 1252} sdv_hash_613687309(vslice_dummy_var_997);
    call {:si_unique_call 1253} sdv_hash_375749048(filter_14);
    assume {:nonnull} filter_14 != 0;
    assume filter_14 > 0;
    havoc vslice_dummy_var_998;
    call {:si_unique_call 1254} sdv_hash_986004649(vslice_dummy_var_998);
  ...
  anon108_Else:
    ...
    call {:si_unique_call 1268} sdv_hash_613687309(vslice_dummy_var_999);
    assume {:nonnull} irpSp_8 != 0;
    assume irpSp_8 > 0;
    goto anon111_Then, anon111_Else;
  ...
  L112:
    ...
    call {:si_unique_call 1270} sdv_hash_986004649(vslice_dummy_var_1000);
    goto L84;
  ...
  L223:
    ...
    call {:si_unique_call 1273} sdv_hash_613687309(vslice_dummy_var_1001);
    assume {:nonnull} extension_7 != 0;
    assume extension_7 > 0;
    goto anon114_Then, anon114_Else;
  ...
  L227:
    ...
    call {:si_unique_call 1276} sdv_hash_986004649(vslice_dummy_var_1002);
    assume {:nonnull} irpSp_8 != 0;
    assume irpSp_8 > 0;
    goto anon115_Then, anon115_Else;
  ...
  anon118_Else:
    ...
    call {:si_unique_call 1277} sdv_hash_613687309(vslice_dummy_var_1003);
    assume {:nonnull} extension_7 != 0;
    assume extension_7 > 0;
    ...
    call {:si_unique_call 1279} sdv_hash_986004649(vslice_dummy_var_1004);
    assume {:nonnull} extension_7 != 0;
    assume extension_7 > 0;
    havoc vslice_dummy_var_1005;
    call {:si_unique_call 1280} sdv_hash_826125959(vslice_dummy_var_1005);
...
procedure {:origName "VolSnapAddDevice"} VolSnapAddDevice(actual_DriverObject_8: int, actual_PhysicalDeviceObject_1: int) returns (Tmp_650: int);
  modifies alloc, Mem_T.Type_unnamed_tag_26;
  free ensures {:va_keep} Tmp_650 == 0 || Tmp_650 == -1073741810 || Tmp_650 == -1073741824 || Tmp_650 == -1073741771 || Tmp_650 == -1073741670 || Tmp_650 == -1073741823;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} false || old(in_pnp) == 0 || old(in_pnp) == 1;
  free ensures {:va_keep} false || old(passed_on) == 1 || old(passed_on) == 0;
  free ensures {:va_keep} false || old(ref) == 0 || old(ref) == 1;
...
implementation {:origName "VolSnapAddDevice"} VolSnapAddDevice(actual_DriverObject_8: int, actual_PhysicalDeviceObject_1: int) returns (Tmp_650: int)
{
  ...
  L165:
    ...
    call {:si_unique_call 1328} sdv_hash_613687309(vslice_dummy_var_1006);
    assume {:nonnull} filter_15 != 0;
    assume filter_15 > 0;
    havoc Tmp_658;
    assume {:nonnull} filter_15 != 0;
  ...
  L184:
    ...
    call {:si_unique_call 1330} sdv_hash_986004649(vslice_dummy_var_1007);
    assume {:nonnull} deviceObject_1 != 0;
    assume deviceObject_1 > 0;
    Tmp_650 := 0;
    goto L1;
...
implementation {:origName "sdv_hash_172139115"} sdv_hash_172139115(actual_Extension_13: int, actual_ListOfDiffAreaFilesToClose_2: int, actual_KeepOnDisk_2: int)
{
  ...
  anon75_Else:
    ...
    call {:si_unique_call 1358} VspFreeIrp(vslice_dummy_var_1008, 1);
    assume {:nonnull} diffAreaFile_3 != 0;
    assume diffAreaFile_3 > 0;
    goto L140;
  ...
  anon76_Else:
    ...
    call {:si_unique_call 1359} VspFreeIrp(vslice_dummy_var_1009, 1);
    assume {:nonnull} diffAreaFile_3 != 0;
    assume diffAreaFile_3 > 0;
    goto L145;
  ...
  anon80_Else:
    ...
    call {:si_unique_call 1360} lookupEntry_3 := sdv_hash_414123790(vslice_dummy_var_1010, SnapshotGuid_VOLUME_EXTENSION(Extension_13), filter_16);
    goto anon81_Then, anon81_Else;
  ...
  anon83_Else:
    ...
    call {:si_unique_call 1363} VspFreeBitMap(vslice_dummy_var_1011);
  ...
  anon84_Else:
    ...
    call {:si_unique_call 1365} VspFreeBitMap(vslice_dummy_var_1012);
  ...
  anon85_Else:
    ...
    call {:si_unique_call 1367} VspFreeBitMap(vslice_dummy_var_1013);
  ...
  anon87_Else:
    ...
    call {:si_unique_call 1373} VspFreeIrp(vslice_dummy_var_1014, 1);
    assume {:nonnull} Extension_13 != 0;
    assume Extension_13 > 0;
    goto L224;
  ...
  L224:
    ...
    call {:si_unique_call 1374} vslice_dummy_var_324 := sdv_hash_899948027(vslice_dummy_var_1015);
    assume {:nonnull} Extension_13 != 0;
    assume Extension_13 > 0;
    goto anon88_Then, anon88_Else;
...
implementation {:origName "sdv_hash_141061226"} sdv_hash_141061226(actual_Extension_14: int)
{
  ...
  anon16_Else:
    ...
    call {:si_unique_call 1404} VspFreeIrp(vslice_dummy_var_1016, 1);
    assume {:nonnull} diffAreaFile_5 != 0;
    assume diffAreaFile_5 > 0;
    goto L51;
  ...
  anon17_Else:
    ...
    call {:si_unique_call 1405} VspFreeIrp(vslice_dummy_var_1017, 1);
    assume {:nonnull} diffAreaFile_5 != 0;
    assume diffAreaFile_5 > 0;
    goto L56;
...
implementation {:origName "sdv_hash_17066757"} sdv_hash_17066757#0(actual_Filter_27: int, actual_IsOffline: int, actual_IsFinalRemove_2: int, actual_NeedLock_3: int, actual_IsClusterUnexpectedOffline: int)
{
  ...
  anon100_Else:
    ...
    call {:si_unique_call 1427} VspCancelRoutine(vslice_dummy_var_1018, irp_6);
    goto L79;
  ...
  anon76_Else:
    ...
    call {:si_unique_call 1434} sdv_hash_986004649(vslice_dummy_var_1019);
    goto L112;
  ...
  anon77_Else:
    ...
    call {:si_unique_call 1439} sdv_hash_613687309(vslice_dummy_var_1020);
    goto L128;
  ...
  anon86_Else:
    ...
    call {:si_unique_call 1446} sdv_hash_986004649(vslice_dummy_var_1021);
    goto L180;
  ...
  anon85_Else:
    ...
    call {:si_unique_call 1456} VspFreeIrp(vslice_dummy_var_1022, 1);
    assume {:nonnull} Filter_27 != 0;
    assume Filter_27 > 0;
  ...
  anon93_Else:
    ...
    call {:si_unique_call 1467} sdv_hash_570003108(vslice_dummy_var_1023, vslice_dummy_var_1024, -1073348548, 0, 0, 1);
    goto L283;
  ...
  anon93_Then:
    ...
    call {:si_unique_call 1468} sdv_hash_570003108(vslice_dummy_var_1025, vslice_dummy_var_1026, -1073348592, 0, 3, 1);
    goto L283;
  ...
  anon75_Then:
    ...
    call {:si_unique_call 1472} sdv_hash_613687309(vslice_dummy_var_1027);
    goto L89;
...
procedure {:origName "sdv_hash_17066757"} sdv_hash_17066757#0(actual_Filter_27: int, actual_IsOffline: int, actual_IsFinalRemove_2: int, actual_NeedLock_3: int, actual_IsClusterUnexpectedOffline: int);
  modifies alloc, Mem_T.Information__IO_STATUS_BLOCK, ref, Mem_T.Type_unnamed_tag_26, Mem_T.CurrentStackLocation_unnamed_tag_6;
  free ensures {:va_keep} old(ref) == 1 ==> ref != 0;
  free ensures {:va_keep} ref == 1 || ref == old(ref);
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} false || old(in_pnp) == 0 || old(in_pnp) == 1;
...
implementation {:origName "sdv_hash_17066757"} sdv_hash_17066757#1(actual_Filter_27: int, actual_IsOffline: int, actual_IsFinalRemove_2: int, actual_NeedLock_3: int, actual_IsClusterUnexpectedOffline: int)
{
  ...
  anon100_Else:
    ...
    call {:si_unique_call 1497} VspCancelRoutine(vslice_dummy_var_1028, irp_6);
    goto L79;
  ...
  anon76_Else:
    ...
    call {:si_unique_call 1504} sdv_hash_986004649(vslice_dummy_var_1029);
    goto L112;
  ...
  anon77_Else:
    ...
    call {:si_unique_call 1509} sdv_hash_613687309(vslice_dummy_var_1030);
    goto L128;
  ...
  anon86_Else:
    ...
    call {:si_unique_call 1516} sdv_hash_986004649(vslice_dummy_var_1031);
    goto L180;
  ...
  anon85_Else:
    ...
    call {:si_unique_call 1526} VspFreeIrp(vslice_dummy_var_1032, 1);
    assume {:nonnull} Filter_27 != 0;
    assume Filter_27 > 0;
  ...
  anon93_Else:
    ...
    call {:si_unique_call 1538} sdv_hash_570003108(vslice_dummy_var_1033, vslice_dummy_var_1034, -1073348548, 0, 0, 1);
    goto L283;
  ...
  anon93_Then:
    ...
    call {:si_unique_call 1539} sdv_hash_570003108(vslice_dummy_var_1035, vslice_dummy_var_1036, -1073348592, 0, 3, 1);
    goto L283;
  ...
  anon75_Then:
    ...
    call {:si_unique_call 1543} sdv_hash_613687309(vslice_dummy_var_1037);
    goto L89;
...
implementation sdv_hash_890975460_loop_L75(in_majorFunction: int, in_Tmp_244: int, in_irpSp: int, in_irp: int, in_l: int, in_Tmp_248: int, in_driver: int, in_tmp: int, in_vslice_dummy_var_50: int, in_vslice_dummy_var_51: int, in_vslice_dummy_var_52: int, in_vslice_dummy_var_53: int, in_vslice_dummy_var_54: int, in_vslice_dummy_var_55: int, in_vslice_dummy_var_56: int, in_vslice_dummy_var_57: int, in_vslice_dummy_var_58: int, in_vslice_dummy_var_59: int, in_vslice_dummy_var_60: int, in_vslice_dummy_var_61: int, in_vslice_dummy_var_62: int, in_vslice_dummy_var_63: int, in_vslice_dummy_var_64: int, in_vslice_dummy_var_65: int, in_vslice_dummy_var_66: int, in_vslice_dummy_var_67: int, in_vslice_dummy_var_68: int, in_vslice_dummy_var_69: int, in_vslice_dummy_var_70: int, in_vslice_dummy_var_71: int, in_vslice_dummy_var_72: int) returns (out_majorFunction: int, out_Tmp_244: int, out_irpSp: int, out_irp: int, out_l: int, out_Tmp_248: int, out_tmp: int, out_vslice_dummy_var_50: int, out_vslice_dummy_var_51: int, out_vslice_dummy_var_52: int, out_vslice_dummy_var_53: int, out_vslice_dummy_var_54: int, out_vslice_dummy_var_55: int, out_vslice_dummy_var_56: int, out_vslice_dummy_var_57: int, out_vslice_dummy_var_58: int, out_vslice_dummy_var_59: int, out_vslice_dummy_var_60: int, out_vslice_dummy_var_61: int, out_vslice_dummy_var_62: int, out_vslice_dummy_var_63: int, out_vslice_dummy_var_64: int, out_vslice_dummy_var_65: int, out_vslice_dummy_var_66: int, out_vslice_dummy_var_67: int, out_vslice_dummy_var_68: int, out_vslice_dummy_var_69: int, out_vslice_dummy_var_70: int, out_vslice_dummy_var_71: int, out_vslice_dummy_var_72: int)
{
  ...
  anon123_Then:
    ...
    call {:si_unique_call 1553} out_vslice_dummy_var_72 := VolSnapDefaultDispatch(vslice_dummy_var_1038, out_irp);
    goto L95;
  ...
  anon122_Then:
    ...
    call {:si_unique_call 1554} out_vslice_dummy_var_71 := VolSnapDefaultDispatch(vslice_dummy_var_1039, out_irp);
    goto L95;
  ...
  anon121_Then:
    ...
    call {:si_unique_call 1555} out_vslice_dummy_var_70 := VolSnapDefaultDispatch(vslice_dummy_var_1040, out_irp);
    goto L95;
  ...
  anon118_Then:
    ...
    call {:si_unique_call 1556} out_vslice_dummy_var_69 := VolSnapDefaultDispatch(vslice_dummy_var_1041, out_irp);
    goto L95;
  ...
  anon117_Then:
    ...
    call {:si_unique_call 1557} out_vslice_dummy_var_68 := VolSnapDefaultDispatch(vslice_dummy_var_1042, out_irp);
    goto L95;
  ...
  anon116_Then:
    ...
    call {:si_unique_call 1558} out_vslice_dummy_var_67 := VolSnapDefaultDispatch(vslice_dummy_var_1043, out_irp);
    goto L95;
  ...
  anon115_Then:
    ...
    call {:si_unique_call 1559} out_vslice_dummy_var_66 := VolSnapDefaultDispatch(vslice_dummy_var_1044, out_irp);
    goto L95;
  ...
  anon114_Then:
    ...
    call {:si_unique_call 1560} out_vslice_dummy_var_65 := VolSnapDefaultDispatch(vslice_dummy_var_1045, out_irp);
    goto L95;
  ...
  anon113_Then:
    ...
    call {:si_unique_call 1561} out_vslice_dummy_var_64 := VolSnapDefaultDispatch(vslice_dummy_var_1046, out_irp);
    goto L95;
  ...
  anon112_Then:
    ...
    call {:si_unique_call 1562} out_vslice_dummy_var_63 := VolSnapDefaultDispatch(vslice_dummy_var_1047, out_irp);
    goto L95;
  ...
  anon111_Then:
    ...
    call {:si_unique_call 1563} out_vslice_dummy_var_62 := VolSnapDefaultDispatch(vslice_dummy_var_1048, out_irp);
    goto L95;
  ...
  anon110_Then:
    ...
    call {:si_unique_call 1564} out_vslice_dummy_var_61 := VolSnapDefaultDispatch(vslice_dummy_var_1049, out_irp);
    goto L95;
  ...
  anon108_Then:
    ...
    call {:si_unique_call 1565} out_vslice_dummy_var_60 := VolSnapDefaultDispatch(vslice_dummy_var_1050, out_irp);
    goto L95;
  ...
  anon107_Then:
    ...
    call {:si_unique_call 1566} out_vslice_dummy_var_59 := VolSnapDefaultDispatch(vslice_dummy_var_1051, out_irp);
    goto L95;
  ...
  anon106_Then:
    ...
    call {:si_unique_call 1567} out_vslice_dummy_var_58 := VolSnapDefaultDispatch(vslice_dummy_var_1052, out_irp);
    goto L95;
  ...
  anon104_Then:
    ...
    call {:si_unique_call 1568} out_vslice_dummy_var_57 := VolSnapDefaultDispatch(vslice_dummy_var_1053, out_irp);
    goto L95;
  ...
  anon103_Then:
    ...
    call {:si_unique_call 1569} out_vslice_dummy_var_56 := VolSnapDefaultDispatch(vslice_dummy_var_1054, out_irp);
    goto L95;
  ...
  anon102_Then:
    ...
    call {:si_unique_call 1570} out_vslice_dummy_var_55 := VolSnapDefaultDispatch(vslice_dummy_var_1055, out_irp);
    goto L95;
  ...
  anon100_Then:
    ...
    call {:si_unique_call 1571} out_vslice_dummy_var_54 := VolSnapDefaultDispatch(vslice_dummy_var_1056, out_irp);
    goto L95;
  ...
  anon99_Then:
    ...
    call {:si_unique_call 1572} out_vslice_dummy_var_53 := VolSnapDefaultDispatch(vslice_dummy_var_1057, out_irp);
    goto L95;
  ...
  anon98_Then:
    ...
    call {:si_unique_call 1573} out_vslice_dummy_var_52 := VolSnapDefaultDispatch(vslice_dummy_var_1058, out_irp);
    goto L95;
  ...
  anon97_Then:
    ...
    call {:si_unique_call 1574} out_vslice_dummy_var_51 := VolSnapDefaultDispatch(vslice_dummy_var_1059, out_irp);
    goto L95;
...
procedure {:LoopProcedure} DriverEntry_loop_L263(in_s_p_e_c_i_a_l_1: int, in_Tmp_282: int, in_rootExtension: int) returns (out_Tmp_282: int);
  free ensures {:va_keep} out_Tmp_282 == in_Tmp_282 || out_Tmp_282 == LastCheckTickCount__DO_EXTENSION(in_rootExtension);
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} false || old(in_pnp) == 0 || old(in_pnp) == 1;
  free ensures {:va_keep} false || old(passed_on) == 1 || old(passed_on) == 0;
  free ensures {:va_keep} false || old(ref) == 0 || old(ref) == 1;
...
procedure {:LoopProcedure} DriverEntry_loop_L27(in_i_1: int, in_Tmp_273: int, in_Tmp_296: int, in_DriverObject_5: int) returns (out_i_1: int, out_Tmp_273: int, out_Tmp_296: int);
  free ensures {:va_keep} out_Tmp_296 == 0 || out_Tmp_296 == 1 || out_Tmp_296 == 2 || out_Tmp_296 == in_i_1 || out_Tmp_296 == in_Tmp_296;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} false || old(in_pnp) == 0 || old(in_pnp) == 1;
  free ensures {:va_keep} false || old(passed_on) == 1 || old(passed_on) == 0;
  free ensures {:va_keep} false || old(ref) == 0 || old(ref) == 1;
...
procedure {:LoopProcedure} sdv_hash_1035268778_loop_L77(in_i_2: int, in_deviceRelations: int, in_Tmp_376: int, in_Tmp_379: int, in_vslice_dummy_var_162: int) returns (out_i_2: int, out_Tmp_376: int, out_Tmp_379: int, out_vslice_dummy_var_162: int);
  free ensures {:va_keep} out_Tmp_376 == in_i_2 || out_Tmp_376 == in_Tmp_376;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} false || old(in_pnp) == 0 || old(in_pnp) == 1;
  free ensures {:va_keep} false || old(passed_on) == 1 || old(passed_on) == 0;
  free ensures {:va_keep} false || old(ref) == 0 || old(ref) == 1;
...
procedure {:LoopProcedure} sdv_hash_403736888_loop_L48(in_i_3: int, in_Tmp_442: int, in_Tmp_454: int, in_Tmp_455: int, in_Tmp_463: int, in_Filter_10: int) returns (out_i_3: int, out_Tmp_442: int, out_Tmp_454: int, out_Tmp_455: int, out_Tmp_463: int);
  free ensures {:va_keep} out_Tmp_442 == in_i_3 || out_Tmp_442 == in_Tmp_442;
  free ensures {:va_keep} out_Tmp_463 == in_i_3 || out_Tmp_463 == in_Tmp_463;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} false || old(in_pnp) == 0 || old(in_pnp) == 1;
  free ensures {:va_keep} false || old(passed_on) == 1 || old(passed_on) == 0;
  free ensures {:va_keep} false || old(ref) == 0 || old(ref) == 1;
...
procedure {:LoopProcedure} sdv_hash_1005562481_loop_L39(in_controlItem: int, in_controlBlock: int, in_needWrite: int, in_sdv_288: int, in_itemsLeft: int, in_offset: int, in_Filter_13: int, in_SnapshotGuid: int) returns (out_controlItem: int, out_needWrite: int, out_sdv_288: int, out_itemsLeft: int, out_offset: int);
  modifies alloc;
  free ensures {:va_keep} out_controlItem == in_controlItem || out_controlItem == in_controlBlock;
  free ensures {:va_keep} out_needWrite == 1 || out_needWrite == in_needWrite;
  free ensures {:va_keep} out_sdv_288 == 0 || out_sdv_288 == 1 || out_sdv_288 == in_sdv_288;
  free ensures {:va_keep} out_itemsLeft == 1 || out_itemsLeft == in_itemsLeft;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} false || old(in_pnp) == 0 || old(in_pnp) == 1;
  free ensures {:va_keep} false || old(passed_on) == 1 || old(passed_on) == 0;
  free ensures {:va_keep} false || old(ref) == 0 || old(ref) == 1;
...
implementation sdv_hash_1005562481_loop_L28(in_controlItem: int, in_sdv_281: int, in_controlBlock: int, in_needWrite: int, in_sdv_283: int, in_byteOffset: int, in_sdv_288: int, in_status_15: int, in_itemsLeft: int, in_offset: int, in_Filter_13: int, in_SnapshotGuid: int) returns (out_controlItem: int, out_sdv_281: int, out_needWrite: int, out_sdv_283: int, out_byteOffset: int, out_sdv_288: int, out_status_15: int, out_itemsLeft: int, out_offset: int)
{
  ...
  L28:
    ...
    call {:si_unique_call 1615} out_status_15 := sdv_hash_984605889(in_Filter_13, vslice_dummy_var_1060, out_byteOffset, -699198463, out_sdv_281);
    goto anon59_Else;
  ...
  anon62_Else:
    ...
    call {:si_unique_call 1621} out_status_15 := sdv_hash_916928578(in_Filter_13, vslice_dummy_var_1061, out_byteOffset, -699198462, out_sdv_283);
    goto anon68_Then;
...
procedure {:LoopProcedure} sdv_hash_1005562481_loop_L28(in_controlItem: int, in_sdv_281: int, in_controlBlock: int, in_needWrite: int, in_sdv_283: int, in_byteOffset: int, in_sdv_288: int, in_status_15: int, in_itemsLeft: int, in_offset: int, in_Filter_13: int, in_SnapshotGuid: int) returns (out_controlItem: int, out_sdv_281: int, out_needWrite: int, out_sdv_283: int, out_byteOffset: int, out_sdv_288: int, out_status_15: int, out_itemsLeft: int, out_offset: int);
  modifies alloc, Mem_T.Type_unnamed_tag_26;
  free ensures {:va_keep} out_controlItem == in_controlItem || out_controlItem == in_controlBlock;
  free ensures {:va_keep} out_needWrite == 1 || out_needWrite == 0 || out_needWrite == in_needWrite;
  free ensures {:va_keep} out_sdv_288 == 0 || out_sdv_288 == 1 || out_sdv_288 == in_sdv_288;
  free ensures {:va_keep} out_itemsLeft == 1 || out_itemsLeft == in_itemsLeft;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} false || old(in_pnp) == 0 || old(in_pnp) == 1;
...
procedure {:LoopProcedure} sdv_hash_899948027_loop_L17(in_i_4: int, in_Tmp_488: int, in_Tmp_490: int, in_RootExtension_6: int, in_vslice_dummy_var_203: int) returns (out_i_4: int, out_Tmp_488: int, out_Tmp_490: int, out_vslice_dummy_var_203: int);
  free ensures {:va_keep} out_Tmp_490 == in_i_4 || out_Tmp_490 == in_Tmp_490;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} false || old(in_pnp) == 0 || old(in_pnp) == 1;
  free ensures {:va_keep} false || old(passed_on) == 1 || old(passed_on) == 0;
  free ensures {:va_keep} false || old(ref) == 0 || old(ref) == 1;
...
implementation sdv_hash_588722555_loop_L6(in_irpSp_3: int, in_Tmp_495: int, in_sdv_305: int, in_irp_4: int, in_l_5: int, in_Tmp_498: int, in_DriverObject_7: int, in_IrpQueue: int, in_vslice_dummy_var_205: int, in_vslice_dummy_var_206: int, in_vslice_dummy_var_207: int, in_vslice_dummy_var_208: int, in_vslice_dummy_var_209: int, in_vslice_dummy_var_210: int, in_vslice_dummy_var_211: int, in_vslice_dummy_var_212: int, in_vslice_dummy_var_213: int, in_vslice_dummy_var_214: int, in_vslice_dummy_var_215: int, in_vslice_dummy_var_216: int, in_vslice_dummy_var_217: int, in_vslice_dummy_var_218: int, in_vslice_dummy_var_219: int, in_vslice_dummy_var_220: int, in_vslice_dummy_var_221: int, in_vslice_dummy_var_222: int, in_vslice_dummy_var_223: int, in_vslice_dummy_var_224: int, in_vslice_dummy_var_225: int, in_vslice_dummy_var_226: int) returns (out_irpSp_3: int, out_Tmp_495: int, out_sdv_305: int, out_irp_4: int, out_l_5: int, out_Tmp_498: int, out_vslice_dummy_var_205: int, out_vslice_dummy_var_206: int, out_vslice_dummy_var_207: int, out_vslice_dummy_var_208: int, out_vslice_dummy_var_209: int, out_vslice_dummy_var_210: int, out_vslice_dummy_var_211: int, out_vslice_dummy_var_212: int, out_vslice_dummy_var_213: int, out_vslice_dummy_var_214: int, out_vslice_dummy_var_215: int, out_vslice_dummy_var_216: int, out_vslice_dummy_var_217: int, out_vslice_dummy_var_218: int, out_vslice_dummy_var_219: int, out_vslice_dummy_var_220: int, out_vslice_dummy_var_221: int, out_vslice_dummy_var_222: int, out_vslice_dummy_var_223: int, out_vslice_dummy_var_224: int, out_vslice_dummy_var_225: int, out_vslice_dummy_var_226: int)
{
  ...
  anon87_Then:
    ...
    call {:si_unique_call 1625} out_vslice_dummy_var_226 := VolSnapDefaultDispatch(vslice_dummy_var_1062, out_irp_4);
    goto anon87_Then_dummy;
  ...
  anon86_Then:
    ...
    call {:si_unique_call 1628} out_vslice_dummy_var_225 := VolSnapDefaultDispatch(vslice_dummy_var_1063, out_irp_4);
    goto anon86_Then_dummy;
  ...
  anon85_Then:
    ...
    call {:si_unique_call 1629} out_vslice_dummy_var_224 := VolSnapDefaultDispatch(vslice_dummy_var_1064, out_irp_4);
    goto anon85_Then_dummy;
  ...
  anon82_Then:
    ...
    call {:si_unique_call 1630} out_vslice_dummy_var_223 := VolSnapDefaultDispatch(vslice_dummy_var_1065, out_irp_4);
    goto anon82_Then_dummy;
  ...
  anon81_Then:
    ...
    call {:si_unique_call 1631} out_vslice_dummy_var_222 := VolSnapDefaultDispatch(vslice_dummy_var_1066, out_irp_4);
    goto anon81_Then_dummy;
  ...
  anon80_Then:
    ...
    call {:si_unique_call 1632} out_vslice_dummy_var_221 := VolSnapDefaultDispatch(vslice_dummy_var_1067, out_irp_4);
    goto anon80_Then_dummy;
  ...
  anon79_Then:
    ...
    call {:si_unique_call 1633} out_vslice_dummy_var_220 := VolSnapDefaultDispatch(vslice_dummy_var_1068, out_irp_4);
    goto anon79_Then_dummy;
  ...
  anon78_Then:
    ...
    call {:si_unique_call 1634} out_vslice_dummy_var_219 := VolSnapDefaultDispatch(vslice_dummy_var_1069, out_irp_4);
    goto anon78_Then_dummy;
  ...
  anon77_Then:
    ...
    call {:si_unique_call 1635} out_vslice_dummy_var_218 := VolSnapDefaultDispatch(vslice_dummy_var_1070, out_irp_4);
    goto anon77_Then_dummy;
  ...
  anon76_Then:
    ...
    call {:si_unique_call 1636} out_vslice_dummy_var_217 := VolSnapDefaultDispatch(vslice_dummy_var_1071, out_irp_4);
    goto anon76_Then_dummy;
  ...
  anon75_Then:
    ...
    call {:si_unique_call 1637} out_vslice_dummy_var_216 := VolSnapDefaultDispatch(vslice_dummy_var_1072, out_irp_4);
    goto anon75_Then_dummy;
  ...
  anon74_Then:
    ...
    call {:si_unique_call 1638} out_vslice_dummy_var_215 := VolSnapDefaultDispatch(vslice_dummy_var_1073, out_irp_4);
    goto anon74_Then_dummy;
  ...
  anon72_Then:
    ...
    call {:si_unique_call 1639} out_vslice_dummy_var_214 := VolSnapDefaultDispatch(vslice_dummy_var_1074, out_irp_4);
    goto anon72_Then_dummy;
  ...
  anon71_Then:
    ...
    call {:si_unique_call 1640} out_vslice_dummy_var_213 := VolSnapDefaultDispatch(vslice_dummy_var_1075, out_irp_4);
    goto anon71_Then_dummy;
  ...
  anon70_Then:
    ...
    call {:si_unique_call 1641} out_vslice_dummy_var_212 := VolSnapDefaultDispatch(vslice_dummy_var_1076, out_irp_4);
    goto anon70_Then_dummy;
  ...
  anon68_Then:
    ...
    call {:si_unique_call 1642} out_vslice_dummy_var_211 := VolSnapDefaultDispatch(vslice_dummy_var_1077, out_irp_4);
    goto anon68_Then_dummy;
  ...
  anon67_Then:
    ...
    call {:si_unique_call 1643} out_vslice_dummy_var_210 := VolSnapDefaultDispatch(vslice_dummy_var_1078, out_irp_4);
    goto anon67_Then_dummy;
  ...
  anon66_Then:
    ...
    call {:si_unique_call 1644} out_vslice_dummy_var_209 := VolSnapDefaultDispatch(vslice_dummy_var_1079, out_irp_4);
    goto anon66_Then_dummy;
  ...
  anon64_Then:
    ...
    call {:si_unique_call 1645} out_vslice_dummy_var_208 := VolSnapDefaultDispatch(vslice_dummy_var_1080, out_irp_4);
    goto anon64_Then_dummy;
  ...
  anon63_Then:
    ...
    call {:si_unique_call 1646} out_vslice_dummy_var_207 := VolSnapDefaultDispatch(vslice_dummy_var_1081, out_irp_4);
    goto anon63_Then_dummy;
  ...
  anon62_Then:
    ...
    call {:si_unique_call 1647} out_vslice_dummy_var_206 := VolSnapDefaultDispatch(vslice_dummy_var_1082, out_irp_4);
    goto anon62_Then_dummy;
  ...
  anon61_Then:
    ...
    call {:si_unique_call 1648} out_vslice_dummy_var_205 := VolSnapDefaultDispatch(vslice_dummy_var_1083, out_irp_4);
    goto anon61_Then_dummy;
...
procedure {:LoopProcedure} VspSynchronousIo_loop_L15(in_nextSp: int, in_tick_1: int, in_s_p_e_c_i_a_l_3: int, in_Tmp_522: int, in_restartCount: int, in_event_3: int, in_Irp_13: int, in_TargetObject_2: int, in_MajorFunction_3: int, in_Offset_3: int, in_Length_3: int, in_Key_2: int, in_FileObject_2: int, in_Thread: int, in_boogieTmp: int, in_vslice_dummy_var_234: int, in_vslice_dummy_var_235: int) returns (out_nextSp: int, out_s_p_e_c_i_a_l_3: int, out_Tmp_522: int, out_restartCount: int, out_boogieTmp: int, out_vslice_dummy_var_234: int, out_vslice_dummy_var_235: int);
  modifies alloc, Mem_T.Type_unnamed_tag_26;
  free ensures {:va_keep} out_vslice_dummy_var_234 == 259 || out_vslice_dummy_var_234 == in_vslice_dummy_var_234;
  free ensures {:va_keep} out_vslice_dummy_var_235 == 258 || out_vslice_dummy_var_235 == 0 || out_vslice_dummy_var_235 == in_vslice_dummy_var_235;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} false || old(in_pnp) == 0 || old(in_pnp) == 1;
  free ensures {:va_keep} false || old(passed_on) == 1 || old(passed_on) == 0;
  free ensures {:va_keep} false || old(ref) == 0 || old(ref) == 1;
...
procedure {:LoopProcedure} sdv_hash_414123790_loop_L38(in_lookupEntry: int, in_l_7: int, in_sdv_348: int, in_SnapshotGuid_1: int) returns (out_lookupEntry: int, out_l_7: int, out_sdv_348: int);
  free ensures {:va_keep} out_lookupEntry == in_l_7 || out_lookupEntry == in_lookupEntry;
  free ensures {:va_keep} out_sdv_348 == 0 || out_sdv_348 == 1 || out_sdv_348 == in_sdv_348;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} false || old(in_pnp) == 0 || old(in_pnp) == 1;
  free ensures {:va_keep} false || old(passed_on) == 1 || old(passed_on) == 0;
  free ensures {:va_keep} false || old(ref) == 0 || old(ref) == 1;
...
procedure {:LoopProcedure} sdv_hash_414123790_loop_L25(in_lookupEntry: int, in_sdv_346: int, in_l_7: int, in_SnapshotGuid_1: int) returns (out_lookupEntry: int, out_sdv_346: int, out_l_7: int);
  free ensures {:va_keep} out_sdv_346 == 0 || out_sdv_346 == 1 || out_sdv_346 == in_sdv_346;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} false || old(in_pnp) == 0 || old(in_pnp) == 1;
  free ensures {:va_keep} false || old(passed_on) == 1 || old(passed_on) == 0;
  free ensures {:va_keep} false || old(ref) == 0 || old(ref) == 1;
...
procedure {:LoopProcedure} sdv_hash_208558080_loop_L14(in_diffAreaFile_1: int, in_l_9: int, in_Tmp_572: int, in_extension_4: int, in_Filter_23: int) returns (out_diffAreaFile_1: int, out_l_9: int, out_Tmp_572: int, out_extension_4: int);
  free ensures {:va_keep} out_diffAreaFile_1 == in_l_9 || out_diffAreaFile_1 == in_diffAreaFile_1;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} false || old(in_pnp) == 0 || old(in_pnp) == 1;
  free ensures {:va_keep} false || old(passed_on) == 1 || old(passed_on) == 0;
  free ensures {:va_keep} false || old(ref) == 0 || old(ref) == 1;
...
procedure {:LoopProcedure} sdv_hash_811354472_loop_L18(in_lookupEntry_1: int, in_sdv_417: int, in_Tmp_596: int, in_l_12: int, in_Filter_24: int, in_vslice_dummy_var_273: int, in_vslice_dummy_var_276: int) returns (out_lookupEntry_1: int, out_sdv_417: int, out_Tmp_596: int, out_l_12: int, out_vslice_dummy_var_273: int, out_vslice_dummy_var_276: int);
  free ensures {:va_keep} out_Tmp_596 == in_Tmp_596 || out_Tmp_596 == DEVICE_EXTENSION_FILTER_EXTENSION(in_Filter_24);
  free ensures {:va_keep} out_vslice_dummy_var_273 == 0 || out_vslice_dummy_var_273 == in_vslice_dummy_var_273;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} false || old(in_pnp) == 0 || old(in_pnp) == 1;
  free ensures {:va_keep} false || old(passed_on) == 1 || old(passed_on) == 0;
  free ensures {:va_keep} false || old(ref) == 0 || old(ref) == 1;
...
procedure {:LoopProcedure} sdv_hash_811354472_loop_L11(in_Tmp_591: int, in_lookupEntry_1: int, in_sdv_414: int, in_l_12: int, in_Filter_24: int, in_vslice_dummy_var_277: int) returns (out_Tmp_591: int, out_lookupEntry_1: int, out_sdv_414: int, out_l_12: int, out_vslice_dummy_var_277: int);
  free ensures {:va_keep} out_Tmp_591 == in_Tmp_591 || out_Tmp_591 == DEVICE_EXTENSION_FILTER_EXTENSION(in_Filter_24);
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} false || old(in_pnp) == 0 || old(in_pnp) == 1;
  free ensures {:va_keep} false || old(passed_on) == 1 || old(passed_on) == 0;
  free ensures {:va_keep} false || old(ref) == 0 || old(ref) == 1;
...
procedure {:LoopProcedure} sdv_hash_742206354_loop_L11(in_sdv_428: int, in_dispInfo: int, in_l_13: int, in_ListOfDiffAreaFilesToClose_1: int, in_KeepOnDisk_1: int, in_vslice_dummy_var_287: int, in_vslice_dummy_var_289: int) returns (out_sdv_428: int, out_l_13: int, out_vslice_dummy_var_287: int, out_vslice_dummy_var_289: int);
  modifies alloc;
  free ensures {:va_keep} out_vslice_dummy_var_287 == 0 || out_vslice_dummy_var_287 == in_vslice_dummy_var_287;
...
procedure {:LoopProcedure} sdv_hash_172139115_loop_L82(in_l_14: int, in_q_4: int, in_oldHeapEntry: int, in_sdv_506: int, in_vslice_dummy_var_325: int) returns (out_l_14: int, out_oldHeapEntry: int, out_sdv_506: int, out_vslice_dummy_var_325: int);
  modifies alloc;
  free ensures {:va_keep} out_vslice_dummy_var_325 == -1073741823 || out_vslice_dummy_var_325 == -1073741811 || out_vslice_dummy_var_325 == 0 || out_vslice_dummy_var_325 == in_vslice_dummy_var_325;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} false || old(in_pnp) == 0 || old(in_pnp) == 1;
  free ensures {:va_keep} false || old(passed_on) == 1 || old(passed_on) == 0;
  free ensures {:va_keep} false || old(ref) == 0 || old(ref) == 1;
...
procedure {:LoopProcedure} sdv_hash_172139115_loop_L34(in_sdv_498: int, in_l_14: int, in_oldHeapEntry: int, in_Extension_13: int, in_vslice_dummy_var_326: int) returns (out_sdv_498: int, out_l_14: int, out_oldHeapEntry: int, out_vslice_dummy_var_326: int);
  modifies alloc;
  free ensures {:va_keep} out_vslice_dummy_var_326 == -1073741823 || out_vslice_dummy_var_326 == -1073741811 || out_vslice_dummy_var_326 == 0 || out_vslice_dummy_var_326 == in_vslice_dummy_var_326;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} false || old(in_pnp) == 0 || old(in_pnp) == 1;
  free ensures {:va_keep} false || old(passed_on) == 1 || old(passed_on) == 0;
  free ensures {:va_keep} false || old(ref) == 0 || old(ref) == 1;
...
procedure {:LoopProcedure} sdv_hash_17066757#0_loop_L254(in_sdv_510: int, in_listOfDiffAreaFilesToCloseKeep: int, in_f: int, in_diffAreaFile_4: int, in_listOfDiffAreaFilesToClose: int, in_b: int, in_last: int, in_listOfDeviceObjectsToDelete: int, in_protectMode: int, in_extension_8: int, in_vslice_dummy_var_339: int, in_vslice_dummy_var_340: int) returns (out_sdv_510: int, out_b: int, out_last: int, out_extension_8: int, out_vslice_dummy_var_339: int, out_vslice_dummy_var_340: int);
  ...
  free ensures {:va_keep} old(ref) == 1 ==> ref != 0;
  free ensures {:va_keep} ref == 1 || ref == old(ref);
  free ensures {:va_keep} out_b == 1 || out_b == in_b;
  free ensures {:va_keep} out_last == 1 || out_last == 0 || out_last == in_last;
  free ensures {:va_keep} out_vslice_dummy_var_339 == -1073741811 || out_vslice_dummy_var_339 == 0 || out_vslice_dummy_var_339 == in_vslice_dummy_var_339;
  free ensures {:va_keep} out_vslice_dummy_var_340 == -1073741811 || out_vslice_dummy_var_340 == 0 || out_vslice_dummy_var_340 == in_vslice_dummy_var_340;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} false || old(in_pnp) == 0 || old(in_pnp) == 1;
  free ensures {:va_keep} false || old(passed_on) == 1 || old(passed_on) == 0;
  free ensures {:va_keep} false || old(ref) == 0 || old(ref) == 1;
...
implementation sdv_hash_17066757#0_loop_L148(in_sdv_510: int, in_sdv_513: int, in_listOfDiffAreaFilesToCloseKeep: int, in_f: int, in_diffAreaFile_4: int, in_listOfDiffAreaFilesToClose: int, in_b: int, in_Tmp_671: int, in_last: int, in_l_15: int, in_listOfDeviceObjectsToDelete: int, in_status_23: int, in_protectMode: int, in_extension_8: int, in_Filter_27: int, in_IsOffline: int, in_IsClusterUnexpectedOffline: int, in_vslice_dummy_var_337: int, in_vslice_dummy_var_338: int, in_vslice_dummy_var_339: int, in_vslice_dummy_var_340: int) returns (out_sdv_510: int, out_sdv_513: int, out_f: int, out_diffAreaFile_4: int, out_b: int, out_Tmp_671: int, out_last: int, out_l_15: int, out_status_23: int, out_protectMode: int, out_extension_8: int, out_vslice_dummy_var_337: int, out_vslice_dummy_var_338: int, out_vslice_dummy_var_339: int, out_vslice_dummy_var_340: int)
{
  ...
  anon93_Else:
    ...
    call {:si_unique_call 1736} sdv_hash_570003108(vslice_dummy_var_1084, vslice_dummy_var_1085, -1073348548, 0, 0, 1);
    goto L283;
  ...
  anon93_Then:
    ...
    call {:si_unique_call 1737} sdv_hash_570003108(vslice_dummy_var_1086, vslice_dummy_var_1087, -1073348592, 0, 3, 1);
    goto L283;
...
procedure {:LoopProcedure} sdv_hash_17066757#0_loop_L148(in_sdv_510: int, in_sdv_513: int, in_listOfDiffAreaFilesToCloseKeep: int, in_f: int, in_diffAreaFile_4: int, in_listOfDiffAreaFilesToClose: int, in_b: int, in_Tmp_671: int, in_last: int, in_l_15: int, in_listOfDeviceObjectsToDelete: int, in_status_23: int, in_protectMode: int, in_extension_8: int, in_Filter_27: int, in_IsOffline: int, in_IsClusterUnexpectedOffline: int, in_vslice_dummy_var_337: int, in_vslice_dummy_var_338: int, in_vslice_dummy_var_339: int, in_vslice_dummy_var_340: int) returns (out_sdv_510: int, out_sdv_513: int, out_f: int, out_diffAreaFile_4: int, out_b: int, out_Tmp_671: int, out_last: int, out_l_15: int, out_status_23: int, out_protectMode: int, out_extension_8: int, out_vslice_dummy_var_337: int, out_vslice_dummy_var_338: int, out_vslice_dummy_var_339: int, out_vslice_dummy_var_340: int);
  ...
  free ensures {:va_keep} old(ref) == 1 ==> ref != 0;
  free ensures {:va_keep} ref == 1 || ref == old(ref);
  free ensures {:va_keep} out_b == 1 || out_b == 0 || out_b == in_b;
  free ensures {:va_keep} out_last == 1 || out_last == 0 || out_last == in_last;
  free ensures {:va_keep} out_protectMode == 1 || out_protectMode == 0 || out_protectMode == in_protectMode;
  free ensures {:va_keep} out_vslice_dummy_var_337 == 0 || out_vslice_dummy_var_337 == -1073741811 || out_vslice_dummy_var_337 == in_vslice_dummy_var_337;
  free ensures {:va_keep} out_vslice_dummy_var_338 == 0 || out_vslice_dummy_var_338 == -1073741811 || out_vslice_dummy_var_338 == in_vslice_dummy_var_338;
  free ensures {:va_keep} out_vslice_dummy_var_339 == -1073741811 || out_vslice_dummy_var_339 == 0 || out_vslice_dummy_var_339 == in_vslice_dummy_var_339;
  free ensures {:va_keep} out_vslice_dummy_var_340 == -1073741811 || out_vslice_dummy_var_340 == 0 || out_vslice_dummy_var_340 == in_vslice_dummy_var_340;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} false || old(in_pnp) == 0 || old(in_pnp) == 1;
...
procedure {:LoopProcedure} sdv_hash_17066757#0_loop_L132(in_listOfDiffAreaFilesToCloseKeep: int, in_b: int, in_listOfDeviceObjectsToDelete: int, in_sdv_539: int, in_Filter_27: int, in_vslice_dummy_var_333: int) returns (out_b: int, out_sdv_539: int, out_vslice_dummy_var_333: int);
  ...
  free ensures {:va_keep} ref == 1 || ref == old(ref);
  free ensures {:va_keep} out_b == 1 || out_b == in_b;
  free ensures {:va_keep} out_vslice_dummy_var_333 == -1073741811 || out_vslice_dummy_var_333 == 0 || out_vslice_dummy_var_333 == in_vslice_dummy_var_333;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} false || old(in_pnp) == 0 || old(in_pnp) == 1;
  free ensures {:va_keep} false || old(passed_on) == 1 || old(passed_on) == 0;
  free ensures {:va_keep} false || old(ref) == 0 || old(ref) == 1;
...
procedure {:LoopProcedure} sdv_hash_17066757#1_loop_L254(in_sdv_510: int, in_listOfDiffAreaFilesToCloseKeep: int, in_f: int, in_diffAreaFile_4: int, in_listOfDiffAreaFilesToClose: int, in_b: int, in_last: int, in_listOfDeviceObjectsToDelete: int, in_protectMode: int, in_extension_8: int, in_vslice_dummy_var_353: int, in_vslice_dummy_var_354: int) returns (out_sdv_510: int, out_b: int, out_last: int, out_extension_8: int, out_vslice_dummy_var_353: int, out_vslice_dummy_var_354: int);
  ...
  free ensures {:va_keep} out_b == 1 || out_b == in_b;
  free ensures {:va_keep} out_last == 1 || out_last == 0 || out_last == in_last;
  free ensures {:va_keep} out_vslice_dummy_var_353 == -1073741811 || out_vslice_dummy_var_353 == 0 || out_vslice_dummy_var_353 == in_vslice_dummy_var_353;
  free ensures {:va_keep} out_vslice_dummy_var_354 == -1073741811 || out_vslice_dummy_var_354 == 0 || out_vslice_dummy_var_354 == in_vslice_dummy_var_354;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} false || old(in_pnp) == 0 || old(in_pnp) == 1;
  free ensures {:va_keep} false || old(passed_on) == 1 || old(passed_on) == 0;
  free ensures {:va_keep} false || old(ref) == 0 || old(ref) == 1;
...
implementation sdv_hash_17066757#1_loop_L148(in_sdv_510: int, in_sdv_513: int, in_listOfDiffAreaFilesToCloseKeep: int, in_f: int, in_diffAreaFile_4: int, in_listOfDiffAreaFilesToClose: int, in_b: int, in_Tmp_671: int, in_last: int, in_l_15: int, in_listOfDeviceObjectsToDelete: int, in_status_23: int, in_protectMode: int, in_extension_8: int, in_Filter_27: int, in_IsOffline: int, in_IsClusterUnexpectedOffline: int, in_vslice_dummy_var_351: int, in_vslice_dummy_var_352: int, in_vslice_dummy_var_353: int, in_vslice_dummy_var_354: int) returns (out_sdv_510: int, out_sdv_513: int, out_f: int, out_diffAreaFile_4: int, out_b: int, out_Tmp_671: int, out_last: int, out_l_15: int, out_status_23: int, out_protectMode: int, out_extension_8: int, out_vslice_dummy_var_351: int, out_vslice_dummy_var_352: int, out_vslice_dummy_var_353: int, out_vslice_dummy_var_354: int)
{
  ...
  anon93_Else:
    ...
    call {:si_unique_call 1765} sdv_hash_570003108(vslice_dummy_var_1088, vslice_dummy_var_1089, -1073348548, 0, 0, 1);
    goto L283;
  ...
  anon93_Then:
    ...
    call {:si_unique_call 1766} sdv_hash_570003108(vslice_dummy_var_1090, vslice_dummy_var_1091, -1073348592, 0, 3, 1);
    goto L283;
...
procedure {:LoopProcedure} sdv_hash_17066757#1_loop_L148(in_sdv_510: int, in_sdv_513: int, in_listOfDiffAreaFilesToCloseKeep: int, in_f: int, in_diffAreaFile_4: int, in_listOfDiffAreaFilesToClose: int, in_b: int, in_Tmp_671: int, in_last: int, in_l_15: int, in_listOfDeviceObjectsToDelete: int, in_status_23: int, in_protectMode: int, in_extension_8: int, in_Filter_27: int, in_IsOffline: int, in_IsClusterUnexpectedOffline: int, in_vslice_dummy_var_351: int, in_vslice_dummy_var_352: int, in_vslice_dummy_var_353: int, in_vslice_dummy_var_354: int) returns (out_sdv_510: int, out_sdv_513: int, out_f: int, out_diffAreaFile_4: int, out_b: int, out_Tmp_671: int, out_last: int, out_l_15: int, out_status_23: int, out_protectMode: int, out_extension_8: int, out_vslice_dummy_var_351: int, out_vslice_dummy_var_352: int, out_vslice_dummy_var_353: int, out_vslice_dummy_var_354: int);
  ...
  free ensures {:va_keep} out_last == 1 || out_last == 0 || out_last == in_last;
  free ensures {:va_keep} out_protectMode == 1 || out_protectMode == 0 || out_protectMode == in_protectMode;
  free ensures {:va_keep} out_vslice_dummy_var_351 == 0 || out_vslice_dummy_var_351 == -1073741811 || out_vslice_dummy_var_351 == in_vslice_dummy_var_351;
  free ensures {:va_keep} out_vslice_dummy_var_352 == 0 || out_vslice_dummy_var_352 == -1073741811 || out_vslice_dummy_var_352 == in_vslice_dummy_var_352;
  free ensures {:va_keep} out_vslice_dummy_var_353 == -1073741811 || out_vslice_dummy_var_353 == 0 || out_vslice_dummy_var_353 == in_vslice_dummy_var_353;
  free ensures {:va_keep} out_vslice_dummy_var_354 == -1073741811 || out_vslice_dummy_var_354 == 0 || out_vslice_dummy_var_354 == in_vslice_dummy_var_354;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} false || old(in_pnp) == 0 || old(in_pnp) == 1;
...
procedure {:LoopProcedure} sdv_hash_17066757#1_loop_L132(in_listOfDiffAreaFilesToCloseKeep: int, in_b: int, in_listOfDeviceObjectsToDelete: int, in_sdv_539: int, in_Filter_27: int, in_vslice_dummy_var_347: int) returns (out_b: int, out_sdv_539: int, out_vslice_dummy_var_347: int);
  ...
  free ensures {:va_keep} ref == 1 || ref == old(ref);
  free ensures {:va_keep} out_b == 1 || out_b == in_b;
  free ensures {:va_keep} out_vslice_dummy_var_347 == -1073741811 || out_vslice_dummy_var_347 == 0 || out_vslice_dummy_var_347 == in_vslice_dummy_var_347;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} false || old(in_pnp) == 0 || old(in_pnp) == 1;
  free ensures {:va_keep} false || old(passed_on) == 1 || old(passed_on) == 0;
  free ensures {:va_keep} false || old(ref) == 0 || old(ref) == 1;
