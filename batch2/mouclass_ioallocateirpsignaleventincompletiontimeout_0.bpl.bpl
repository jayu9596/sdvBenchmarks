...
procedure {:nohoudini} {:origName "sdv_main"} {:osmodel} sdv_main();
  modifies alloc, sdv_compFset, sdv_invoke_on_success, sdv_invoke_on_error, sdv_invoke_on_cancel, signal_location, SLAM_guard_O_0, SignalState, yogi_error;
...
procedure {:origName "sdv_IoSetCompletionRoutine"} {:osmodel} sdv_IoSetCompletionRoutine(actual_pirp_7: int, actual_CompletionRoutine: int, actual_Context_2: int, actual_InvokeOnSuccess: int, actual_InvokeOnError: int, actual_InvokeOnCancel: int);
  modifies alloc, sdv_compFset, sdv_invoke_on_success, sdv_invoke_on_error, sdv_invoke_on_cancel, signal_location;
...
procedure {:nohoudini} {:origName "main"} {:osmodel} {:entrypoint} main() returns (Tmp_77: int, dup_assertVar: bool);
  modifies alloc, sdv_invoke_on_success, sdv_invoke_on_error, sdv_invoke_on_cancel, sdv_compFset, SLAM_guard_O_0, SignalState, signal_location, yogi_error;
...
implementation {:origName "main"} {:osmodel} main() returns (Tmp_77: int, dup_assertVar: bool)
{
  ...
  anon0:
    ...
    call {:si_unique_call 527} vslice_dummy_var_448 := __HAVOC_malloc(44);
    call {:si_unique_call 528} vslice_dummy_var_449 := __HAVOC_malloc(24);
...
procedure {:origName "SLIC_sdv_IoCallDriver_entry"} {:osmodel} SLIC_sdv_IoCallDriver_entry(actual_caller: int, actual_sdv_85: int);
...
implementation {:origName "SLIC_sdv_IoCallDriver_entry"} {:osmodel} SLIC_sdv_IoCallDriver_entry(actual_caller: int, actual_sdv_85: int)
{
  ...
  anon3_Else:
    assume {:partition} sdv_85 != sdv_other_irp;
    signal_location := 0;
    goto L2;
...
implementation {:origName "SLIC_sdv_IoSetCompletionRoutine_entry"} {:osmodel} SLIC_sdv_IoSetCompletionRoutine_entry(actual_caller_1: int, actual_sdv_86: int)
{
  ...
  anon6_Else:
    assume {:partition} sdv_86 != sdv_other_irp;
    goto L4;
...
implementation {:origName "SLIC_KeWaitForSingleObject_entry"} {:osmodel} SLIC_KeWaitForSingleObject_entry(actual_caller_4: int, actual_KeWaitForSingleObject_1: int)
{
  ...
  L6:
    call {:si_unique_call 580} SLIC_EXIT_ROUTINE(strConst__li2bpl0);
    goto L2;
  ...
  anon8_Then:
    assume {:partition} KeWaitForSingleObject_1 == 0;
    call {:si_unique_call 581} SLIC_ABORT_7_0(caller_4, KeWaitForSingleObject_1);
    goto anon9_Then, anon9_Else;
...
implementation {:origName "SLIC_ABORT_7_0"} SLIC_ABORT_7_0(actual_caller_5: int, actual_KeWaitForSingleObject_2: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 582} SLIC_ERROR_ROUTINE(strConst__li2bpl1);
    return;
}
...
implementation {:origName "SLIC_KeInitializeEvent_entry"} {:osmodel} SLIC_KeInitializeEvent_entry(actual_caller_7: int, actual_KeInitializeEvent_1: int)
{
  ...
  anon3_Then:
    assume {:partition} KeInitializeEvent_1 != 0;
    call {:si_unique_call 583} SLIC_EXIT_ROUTINE(strConst__li2bpl0);
    goto L2;
}
...
procedure {:origName "MouseClassDeviceControl"} MouseClassDeviceControl(actual_DeviceObject_14: int, actual_Irp_7: int) returns (Tmp_168: int);
  modifies alloc, signal_location, SLAM_guard_O_0, SignalState, sdv_compFset, sdv_invoke_on_success, sdv_invoke_on_error, sdv_invoke_on_cancel, yogi_error;
  free ensures {:va_keep} old(SignalState) == 0 ==> SignalState != 2;
  free ensures {:va_keep} yogi_error == 1 || yogi_error == old(yogi_error);
  free ensures {:va_keep} SignalState == 0 || SignalState == old(SignalState);
  free ensures {:va_keep} signal_location == 0 || signal_location == 1 || signal_location == old(signal_location);
...
implementation {:origName "MouseClassDeviceControl"} MouseClassDeviceControl(actual_DeviceObject_14: int, actual_Irp_7: int) returns (Tmp_168: int)
{
  ...
  anon0:
    ...
    havoc Tmp_181;
    havoc Tmp_173;
    call {:si_unique_call 585} WPP_RECORDER_SF_(Tmp_173, 0, 3, 19, Tmp_181);
    assume {:nonnull} DeviceObject_14 != 0;
    assume DeviceObject_14 > 0;
    havoc deviceExtension;
    call {:si_unique_call 586} stack := sdv_IoGetCurrentIrpStackLocation(Irp_7);
    call {:si_unique_call 587} status_4 := sdv_IoAcquireRemoveLock(0, 0);
    goto anon75_Then, anon75_Else;
  ...
  anon85_Else:
    call {:si_unique_call 588} sdv_IoSkipCurrentIrpStackLocation(Irp_7);
    assume {:nonnull} deviceExtension != 0;
    assume deviceExtension > 0;
    havoc vslice_dummy_var_450;
    call {:si_unique_call 589} status_4 := sdv_IoCallDriver#1(vslice_dummy_var_450, Irp_7);
  ...
  L49:
    assume {:nonnull} deviceExtension != 0;
    assume deviceExtension > 0;
    call {:si_unique_call 590} vslice_dummy_var_35 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(deviceExtension), Irp_7);
    havoc Tmp_183;
    havoc Tmp_180;
    call {:si_unique_call 591} WPP_RECORDER_SF_(Tmp_180, 0, 3, 20, Tmp_183);
    Tmp_168 := status_4;
    goto L1;
  ...
  anon80_Else:
    call {:si_unique_call 595} ExAcquireFastMutex(0);
    goto anon81_Then, anon81_Else;

  anon81_Else:
    call {:si_unique_call 596} ExReleaseFastMutex(0);
    status_4 := -1073741811;
    assume {:nonnull} Irp_7 != 0;
    assume Irp_7 > 0;
    assume {:nonnull} Irp_7 != 0;
  ...
  L91:
    call {:si_unique_call 598} unitId, Tmp_170, Tmp_176, Tmp_177, Tmp_182 := MouseClassDeviceControl_loop_L91(unitId, Tmp_170, Tmp_176, Tmp_177, Tmp_182);
    goto L91_last;
  ...
  anon83_Else:
    call {:si_unique_call 599} ExReleaseFastMutex(0);
    status_4 := -1073741811;
    assume {:nonnull} Irp_7 != 0;
    assume Irp_7 > 0;
    assume {:nonnull} Irp_7 != 0;
  ...
  L111:
    call {:si_unique_call 602} sdv_IoCopyCurrentIrpStackLocationToNext(Irp_7);
    call {:si_unique_call 603} sdv_89 := sdv_IoGetNextIrpStackLocation(Irp_7);
    assume {:nonnull} sdv_89 != 0;
    assume sdv_89 > 0;
    assume {:nonnull} port != 0;
    assume port > 0;
    havoc vslice_dummy_var_451;
    call {:si_unique_call 604} status_4 := sdv_IoCallDriver#1(vslice_dummy_var_451, Irp_7);
...
implementation {:origName "MouseClassRemoveDevice"} MouseClassRemoveDevice(actual_Data_1: int, actual_SurpriseRemove: int)
{
  ...
  anon0:
    call {:si_unique_call 606} vslice_dummy_var_36 := __HAVOC_malloc(4);
  ...
  L11:
    assume {:nonnull} Data_1 != 0;
    assume Data_1 > 0;
    call {:si_unique_call 607} sdv_92 := _InlineInterlockedExchangePointer(WaitWakeIrp__DEVICE_EXTENSION(Data_1), 0);
    waitWakeIrp := sdv_92;
    goto anon30_Then, anon30_Else;

  anon30_Else:
    assume {:partition} waitWakeIrp != 0;
    call {:si_unique_call 608} vslice_dummy_var_38 := IoCancelIrp(0);
    goto L16;

  L16:
    call {:si_unique_call 609} vslice_dummy_var_37 := IoWMIRegistrationControl(0, 2);
    assume {:nonnull} Data_1 != 0;
    assume Data_1 > 0;
    goto anon24_Then, anon24_Else;

  anon24_Else:
    call {:si_unique_call 610} ExAcquireFastMutex(0);
  ...
  anon27_Else:
    ...
    assume {:nonnull} Data_1 != 0;
    assume Data_1 > 0;
    call {:si_unique_call 612} notifyHandle := _InlineInterlockedExchangePointer(TargetNotifyHandle__DEVICE_EXTENSION(Data_1), 0);
    goto anon28_Then, anon28_Else;

  anon28_Else:
    assume {:partition} notifyHandle != 0;
    call {:si_unique_call 613} vslice_dummy_var_39 := IoUnregisterPlugPlayNotification(0);
    goto L23;
  ...
  anon25_Else:
    ...
    call {:si_unique_call 614} MouseClassCleanupQueue(vslice_dummy_var_452, Data_1, 0);
    goto L1;
  ...
  anon29_Else:
    call {:si_unique_call 617} vslice_dummy_var_40 := IoSetDeviceInterfaceState(0, 0);
    goto L23;
...
implementation {:origName "MouseClassCleanupQueue"} MouseClassCleanupQueue(actual_DeviceObject_15: int, actual_DeviceExtension: int, actual_FileObject_1: int)
{
  ...
  anon0:
    call {:si_unique_call 618} listHead := __HAVOC_malloc(8);
    call {:si_unique_call 619} vslice_dummy_var_41 := __HAVOC_malloc(4);
    DeviceExtension := actual_DeviceExtension;
    FileObject_1 := actual_FileObject_1;
    call {:si_unique_call 620} InitializeListHead(listHead);
    call {:si_unique_call 621} Tmp_188 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_188 != 0;
    assume Tmp_188 > 0;
    call {:si_unique_call 622} sdv_KeAcquireSpinLock(0, Tmp_188);
    assume {:nonnull} Tmp_188 != 0;
    assume Tmp_188 > 0;
    havoc irql_1;
    assume {:nonnull} DeviceExtension != 0;
  ...
  L16:
    call {:si_unique_call 623} nextEntry, sdv_98, oldCancelRoutine, irp, entry, stack_1, vslice_dummy_var_42, vslice_dummy_var_44 := MouseClassCleanupQueue_loop_L16(listHead, nextEntry, sdv_98, oldCancelRoutine, irp, entry, stack_1, FileObject_1, vslice_dummy_var_42, vslice_dummy_var_44);
    goto L16_last;
  ...
  anon11_Else:
    ...
    assume entry > 0;
    havoc nextEntry;
    call {:si_unique_call 624} sdv_98 := sdv_containing_record(entry, 88);
    irp := sdv_98;
    call {:si_unique_call 625} stack_1 := sdv_IoGetCurrentIrpStackLocation(irp);
    goto anon12_Then, anon12_Else;
  ...
  L31:
    call {:si_unique_call 626} vslice_dummy_var_42 := sdv_RemoveEntryList(0);
    call {:si_unique_call 627} oldCancelRoutine := sdv_IoSetCancelRoutine(irp, 0);
    goto anon14_Then, anon14_Else;
  ...
  anon14_Else:
    ...
    assume {:nonnull} irp != 0;
    assume irp > 0;
    call {:si_unique_call 628} vslice_dummy_var_44 := sdv_InsertTailList(listHead, ListEntry_unnamed_tag_6(Overlay_unnamed_tag_5(Tail__IRP(irp))));
    goto L35;
  ...
  anon11_Then:
    call {:si_unique_call 630} sdv_KeReleaseSpinLock(0, irql_1);
    goto L49;

  L49:
    call {:si_unique_call 631} sdv_103, irp, sdv_104, entry, vslice_dummy_var_43 := MouseClassCleanupQueue_loop_L49(listHead, sdv_103, irp, sdv_104, entry, DeviceExtension, vslice_dummy_var_43);
    goto L49_last;

  L49_last:
    call {:si_unique_call 636} sdv_103 := sdv_IsListEmpty(0);
    goto anon15_Then, anon15_Else;

  anon15_Else:
    assume {:partition} sdv_103 == 0;
    call {:si_unique_call 632} entry := RemoveHeadList(listHead);
    call {:si_unique_call 633} sdv_104 := sdv_containing_record(entry, 88);
    irp := sdv_104;
    call {:si_unique_call 634} sdv_IoCompleteRequest(0, 0);
    assume {:nonnull} DeviceExtension != 0;
    assume DeviceExtension > 0;
    call {:si_unique_call 635} vslice_dummy_var_43 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(DeviceExtension), irp);
...
implementation {:origName "MouseClassLogError"} MouseClassLogError(actual_Object_2: int, actual_ErrorCode: int, actual_UniqueErrorValue: int, actual_FinalStatus: int, actual_DumpCount: int, actual_DumpData: int, actual_MajorFunction: int)
{
  ...
  anon0:
    call {:si_unique_call 637} vslice_dummy_var_45 := __HAVOC_malloc(4);
    ...
    call {:si_unique_call 638} Tmp_194 := __HAVOC_malloc(4);
    Tmp_193 := 48 + DumpCount * 4;
    call {:si_unique_call 639} sdv_105 := IoAllocateErrorLogEntry(0, Tmp_193);
    errorLogEntry := sdv_105;
    goto anon6_Then, anon6_Else;
  ...
  L20:
    call {:si_unique_call 640} i, Tmp_190, Tmp_194, Tmp_195 := MouseClassLogError_loop_L20(i, errorLogEntry, Tmp_190, Tmp_194, Tmp_195, DumpCount, DumpData);
    goto L20_last;
...
implementation {:origName "_sdv_init1"} _sdv_init1()
{
  ...
  anon0:
    call {:si_unique_call 642} vslice_dummy_var_46 := __HAVOC_malloc(4);
    call {:si_unique_call 643} Tmp_197 := __HAVOC_malloc(4);
...
implementation {:origName "MouseClassClose"} MouseClassClose(actual_DeviceObject_16: int, actual_Irp_8: int) returns (Tmp_199: int)
{
  ...
  anon0:
    ...
    havoc Tmp_206;
    havoc Tmp_200;
    call {:si_unique_call 644} WPP_RECORDER_SF_(Tmp_200, 0, 3, 28, Tmp_206);
    assume {:nonnull} DeviceObject_16 != 0;
    assume DeviceObject_16 > 0;
    havoc deviceExtension_1;
    call {:si_unique_call 645} irpSp_1 := sdv_IoGetCurrentIrpStackLocation(Irp_8);
    assume {:nonnull} deviceExtension_1 != 0;
    assume deviceExtension_1 > 0;
    goto anon33_Then, anon33_Else;

  anon33_Else:
    call {:si_unique_call 646} Tmp_202 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_202 != 0;
    assume Tmp_202 > 0;
    call {:si_unique_call 647} sdv_KeAcquireSpinLock(0, Tmp_202);
    assume {:nonnull} Tmp_202 != 0;
    assume Tmp_202 > 0;
    havoc oldIrql;
  ...
  L29:
    call {:si_unique_call 649} ExAcquireFastMutex(0);
  ...
  L45:
    call {:si_unique_call 650} i_1, someEnableDisableSucceeded, notifyHandle_1, port_2, Tmp_204, Tmp_205, enabled_1, Tmp_208, status_5, Tmp_211, Tmp_212, vslice_dummy_var_47 := MouseClassClose_loop_L45(i_1, someEnableDisableSucceeded, irpSp_1, notifyHandle_1, port_2, Tmp_204, Tmp_205, enabled_1, Tmp_208, status_5, Tmp_211, Tmp_212, DeviceObject_16, Irp_8, vslice_dummy_var_47);
    goto L45_last;
  ...
  anon37_Else:
    ...
    assume Tmp_205 > 0;
    call {:si_unique_call 652} notifyHandle_1 := _InlineInterlockedExchangePointer(TargetNotifyHandle__DEVICE_EXTENSION(Tmp_205), 0);
    goto anon39_Then, anon39_Else;

  anon39_Else:
    assume {:partition} notifyHandle_1 != 0;
    call {:si_unique_call 653} vslice_dummy_var_47 := IoUnregisterPlugPlayNotification(0);
    goto L65;
  ...
  L65:
    ...
    call {:si_unique_call 654} status_5 := MouEnableDisablePort#1(0, Irp_8, vslice_dummy_var_453, File__PORT(port_2));
  ...
  anon38_Else:
    ...
    call {:si_unique_call 655} WPP_RECORDER_SF_q(Tmp_208, 0, 1, 29, Tmp_212, vslice_dummy_var_454);
    assume {:nonnull} irpSp_1 != 0;
    assume irpSp_1 > 0;
    havoc vslice_dummy_var_455;
    call {:si_unique_call 656} MouseClassLogError(DeviceObject_16, -1073414134, 20120, status_5, 0, 0, vslice_dummy_var_455);
    goto L85;

  L85:
    call {:si_unique_call 657} ExAcquireFastMutex(0);
    goto L53;
  ...
  L89:
    ...
    havoc Tmp_209;
    havoc Tmp_213;
    call {:si_unique_call 660} WPP_RECORDER_SF_(Tmp_213, 0, 3, 31, Tmp_209);
    Tmp_199 := status_5;
    goto L1;
  ...
  anon35_Else:
    call {:si_unique_call 661} ExReleaseFastMutex(0);
    assume {:nonnull} deviceExtension_1 != 0;
    assume deviceExtension_1 > 0;
  ...
  anon41_Else:
    assume {:nonnull} irpSp_1 != 0;
    assume irpSp_1 > 0;
    call {:si_unique_call 662} status_5 := MouEnableDisablePort#1(0, Irp_8, deviceExtension_1, FileObject__IO_STACK_LOCATION(irpSp_1));
  ...
  anon42_Else:
    ...
    call {:si_unique_call 663} WPP_RECORDER_SF_q(Tmp_207, 0, 1, 30, Tmp_203, vslice_dummy_var_456);
    assume {:nonnull} irpSp_1 != 0;
    assume irpSp_1 > 0;
    havoc vslice_dummy_var_457;
    call {:si_unique_call 664} MouseClassLogError(DeviceObject_16, -1073414134, 20120, status_5, 0, 0, vslice_dummy_var_457);
    goto L88;
  ...
  anon41_Then:
    call {:si_unique_call 665} sdv_IoSkipCurrentIrpStackLocation(Irp_8);
    assume {:nonnull} deviceExtension_1 != 0;
    assume deviceExtension_1 > 0;
    havoc vslice_dummy_var_458;
    call {:si_unique_call 666} status_5 := sdv_IoCallDriver#1(vslice_dummy_var_458, Irp_8);
  ...
  anon35_Then:
    call {:si_unique_call 667} ExReleaseFastMutex(0);
    goto L88;
...
implementation {:origName "MouseQueryDeviceKey"} MouseQueryDeviceKey(actual_Handle_1: int, actual_ValueNameString: int, actual_Data_3: int, actual_DataLength: int) returns (Tmp_224: int)
{
  ...
  anon0:
    call {:si_unique_call 669} valueName := __HAVOC_malloc(12);
    call {:si_unique_call 670} length := __HAVOC_malloc(4);
    ValueNameString := actual_ValueNameString;
    DataLength := actual_DataLength;
    call {:si_unique_call 671} sdv_do_paged_code_check();
    call {:si_unique_call 672} RtlInitUnicodeString(valueName, ValueNameString);
    assume {:nonnull} valueName != 0;
    assume valueName > 0;
    havoc Tmp_227;
    call {:si_unique_call 673} status_9 := RtlULongAdd(24, Tmp_227, length);
    goto anon11_Then, anon11_Else;
  ...
  anon11_Else:
    ...
    call {:si_unique_call 674} status_9 := RtlULongAdd(vslice_dummy_var_459, DataLength, length);
    goto anon12_Then, anon12_Else;
  ...
  anon12_Else:
    ...
    call {:si_unique_call 675} sdv_121 := ExAllocatePoolWithTag(1, vslice_dummy_var_460, -1016105651);
    fullInfo := sdv_121;
    goto anon15_Then, anon15_Else;

  anon15_Else:
    assume {:partition} fullInfo != 0;
    call {:si_unique_call 676} Tmp_225 := __HAVOC_malloc(4);
    ...
    call {:si_unique_call 677} status_9 := ZwQueryValueKey(0, 0, 1, 0, vslice_dummy_var_461, Tmp_225);
    assume {:nonnull} Tmp_225 != 0;
    assume Tmp_225 > 0;
    assume {:nonnull} length != 0;
    assume length > 0;
  ...
  anon14_Else:
    ...
    call {:si_unique_call 678} sdv_RtlCopyMemory(0, 0, vslice_dummy_var_462);
    goto L37;
...
implementation {:origName "WPP_RECORDER_SF_q"} WPP_RECORDER_SF_q(actual_AutoLogContext: int, actual_level: int, actual_flags: int, actual_id: int, actual_traceGuid: int, actual_s_p_e_c_i_a_l_1: int)
{
  ...
  anon0:
    call {:si_unique_call 680} vslice_dummy_var_48 := __HAVOC_malloc(4);
    level := actual_level;
    flags := actual_flags;
    traceGuid := actual_traceGuid;
    call {:si_unique_call 681} vslice_dummy_var_50 := __HAVOC_malloc(4);
    ...
    call {:si_unique_call 682} Tmp_234 := corral_nondet();
    goto anon5_Then, anon5_Else;

  anon5_Else:
    call {:si_unique_call 683} Tmp_228 := corral_nondet();
    goto anon6_Then, anon6_Else;

  anon6_Else:
    call {:si_unique_call 684} Tmp_230 := corral_nondet();
    assume pfnWppTraceMessage == 0;
    goto L6;

  L6:
    call {:si_unique_call 685} vslice_dummy_var_49 := corral_nondet();
    return;
...
implementation {:origName "WPP_RECORDER_SF_Dq"} WPP_RECORDER_SF_Dq(actual_AutoLogContext_1: int, actual_level_1: int, actual_flags_1: int, actual_id_1: int, actual_traceGuid_1: int, actual_s_p_e_c_i_a_l_2: int, actual_s_p_e_c_i_a_l_3: int)
{
  ...
  anon0:
    call {:si_unique_call 686} vslice_dummy_var_51 := __HAVOC_malloc(4);
    level_1 := actual_level_1;
    flags_1 := actual_flags_1;
    traceGuid_1 := actual_traceGuid_1;
    call {:si_unique_call 687} vslice_dummy_var_53 := __HAVOC_malloc(4);
    ...
    call {:si_unique_call 688} Tmp_239 := corral_nondet();
    goto anon5_Then, anon5_Else;

  anon5_Else:
    call {:si_unique_call 689} Tmp_243 := corral_nondet();
    goto anon6_Then, anon6_Else;

  anon6_Else:
    call {:si_unique_call 690} Tmp_241 := corral_nondet();
    assume pfnWppTraceMessage == 0;
    goto L6;

  L6:
    call {:si_unique_call 691} vslice_dummy_var_52 := corral_nondet();
    return;
...
implementation {:origName "MouSyncComplete"} MouSyncComplete(actual_DeviceObject_19: int, actual_Irp_10: int, actual_Context_9: int) returns (Tmp_254: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 692} vslice_dummy_var_54 := KeSetEvent(Context_9, 0, 0);
    Tmp_254 := -1073741802;
    return;
}
...
implementation {:origName "MouseClassPassThrough"} MouseClassPassThrough(actual_DeviceObject_20: int, actual_Irp_11: int) returns (Tmp_256: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 693} sdv_do_paged_code_check();
    call {:si_unique_call 694} sdv_IoSkipCurrentIrpStackLocation(Irp_11);
    ...
    assume Tmp_259 > 0;
    havoc Tmp_257;
    call {:si_unique_call 695} Tmp_256 := sdv_IoCallDriver#1(Tmp_257, Irp_11);
    goto anon3_Then, anon3_Else;
...
implementation {:origName "RtlFailFast"} RtlFailFast(actual_Code: int)
{
  ...
  anon0:
    call {:si_unique_call 696} vslice_dummy_var_55 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "WPP_RECORDER_SF_LL"} WPP_RECORDER_SF_LL(actual_AutoLogContext_2: int, actual_level_2: int, actual_flags_2: int, actual_id_2: int, actual_traceGuid_2: int, actual_s_p_e_c_i_a_l_4: int, actual_s_p_e_c_i_a_l_5: int)
{
  ...
  anon0:
    call {:si_unique_call 697} vslice_dummy_var_56 := __HAVOC_malloc(4);
    level_2 := actual_level_2;
    flags_2 := actual_flags_2;
    traceGuid_2 := actual_traceGuid_2;
    call {:si_unique_call 698} vslice_dummy_var_58 := __HAVOC_malloc(4);
    ...
    call {:si_unique_call 699} Tmp_273 := corral_nondet();
    goto anon5_Then, anon5_Else;

  anon5_Else:
    call {:si_unique_call 700} Tmp_274 := corral_nondet();
    goto anon6_Then, anon6_Else;

  anon6_Else:
    call {:si_unique_call 701} Tmp_268 := corral_nondet();
    assume pfnWppTraceMessage == 0;
    goto L6;

  L6:
    call {:si_unique_call 702} vslice_dummy_var_57 := corral_nondet();
    return;
...
implementation {:origName "MouseClassCleanup"} MouseClassCleanup(actual_DeviceObject_24: int, actual_Irp_13: int) returns (Tmp_283: int)
{
  ...
  anon0:
    ...
    havoc Tmp_289;
    havoc Tmp_287;
    call {:si_unique_call 703} WPP_RECORDER_SF_(Tmp_287, 0, 3, 17, Tmp_289);
    assume {:nonnull} DeviceObject_24 != 0;
    assume DeviceObject_24 > 0;
    havoc deviceExtension_2;
    call {:si_unique_call 704} irpSp_2 := sdv_IoGetCurrentIrpStackLocation(Irp_13);
  ...
  anon3_Else:
    ...
    call {:si_unique_call 705} MouseClassCleanupQueue(DeviceObject_24, deviceExtension_2, vslice_dummy_var_463);
    goto L20;
  ...
  L20:
    ...
    havoc Tmp_285;
    havoc Tmp_284;
    call {:si_unique_call 707} WPP_RECORDER_SF_(Tmp_284, 0, 3, 18, Tmp_285);
    Tmp_283 := 0;
    return;
...
implementation {:origName "MouseClassSystemControl"} MouseClassSystemControl(actual_DeviceObject_25: int, actual_Irp_14: int) returns (Tmp_290: int)
{
  ...
  anon0:
    call {:si_unique_call 708} disposition := __HAVOC_malloc(4);
    ...
    call {:si_unique_call 710} status_12 := sdv_IoAcquireRemoveLock(0, 0);
    goto anon15_Then, anon15_Else;

  anon15_Else:
    assume {:partition} status_12 >= 0;
    call {:si_unique_call 711} status_12 := WmiSystemControl(0, 0, Irp_14, disposition);
  ...
  L28:
    call {:si_unique_call 712} status_12 := MouseClassPassThrough(DeviceObject_25, Irp_14);
  ...
  L33:
    ...
    call {:si_unique_call 713} vslice_dummy_var_59 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(deviceExtension_3), Irp_14);
    Tmp_290 := status_12;
    goto L1;
  ...
  anon17_Then:
    call {:si_unique_call 714} status_12 := MouseClassPassThrough(DeviceObject_25, Irp_14);
    goto anon21_Then, anon21_Else;
...
implementation {:origName "MouInitializeDataQueue"} MouInitializeDataQueue(actual_Context_13: int)
{
  ...
  anon0:
    call {:si_unique_call 717} vslice_dummy_var_60 := __HAVOC_malloc(4);
    Context_13 := actual_Context_13;
    havoc Tmp_292;
    havoc Tmp_296;
    call {:si_unique_call 718} WPP_RECORDER_SF_(Tmp_296, 0, 4, 84, Tmp_292);
    deviceExtension_4 := Context_13;
    call {:si_unique_call 719} Tmp_293 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_293 != 0;
    assume Tmp_293 > 0;
    call {:si_unique_call 720} sdv_KeAcquireSpinLock(0, Tmp_293);
    assume {:nonnull} Tmp_293 != 0;
    assume Tmp_293 > 0;
    havoc oldIrql_1;
    ...
    assume {:nonnull} deviceExtension_4 != 0;
    assume deviceExtension_4 > 0;
    call {:si_unique_call 721} sdv_KeReleaseSpinLock(0, oldIrql_1);
    havoc Tmp_297;
    havoc Tmp_294;
    call {:si_unique_call 722} WPP_RECORDER_SF_(Tmp_294, 0, 4, 85, Tmp_297);
    return;
}
...
implementation {:origName "WPP_RECORDER_SF_qq"} WPP_RECORDER_SF_qq(actual_AutoLogContext_3: int, actual_level_3: int, actual_flags_3: int, actual_id_3: int, actual_traceGuid_3: int, actual_s_p_e_c_i_a_l_6: int, actual_s_p_e_c_i_a_l_7: int)
{
  ...
  anon0:
    call {:si_unique_call 723} vslice_dummy_var_61 := __HAVOC_malloc(4);
    ...
    call {:si_unique_call 725} Tmp_303 := corral_nondet();
    goto anon5_Then, anon5_Else;

  anon5_Else:
    call {:si_unique_call 726} Tmp_306 := corral_nondet();
    goto anon6_Then, anon6_Else;

  anon6_Else:
    call {:si_unique_call 727} Tmp_300 := corral_nondet();
    assume pfnWppTraceMessage == 0;
    goto L6;

  L6:
    call {:si_unique_call 728} vslice_dummy_var_62 := corral_nondet();
    return;
...
implementation {:origName "MouseClassCheckWaitWakeEnabled"} MouseClassCheckWaitWakeEnabled(actual_Data_4: int) returns (Tmp_319: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 729} Tmp_320 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_320 != 0;
    assume Tmp_320 > 0;
    call {:si_unique_call 730} sdv_KeAcquireSpinLock(0, Tmp_320);
    assume {:nonnull} Tmp_320 != 0;
    assume Tmp_320 > 0;
    havoc irql_3;
    ...
    assume Data_4 > 0;
    havoc enabled_2;
    call {:si_unique_call 731} sdv_KeReleaseSpinLock(0, irql_3);
    Tmp_319 := enabled_2;
    return;
}
...
implementation {:origName "MouseClassGetWaitWakeEnableState"} MouseClassGetWaitWakeEnableState(actual_Data_5: int)
{
  ...
  anon0:
    call {:si_unique_call 732} sysPowerCaps := __HAVOC_malloc(124);
    call {:si_unique_call 733} osVerInfo := __HAVOC_malloc(44);
    call {:si_unique_call 734} vslice_dummy_var_64 := __HAVOC_malloc(4);
    call {:si_unique_call 735} tmp_1 := __HAVOC_malloc(4);
    Data_5 := actual_Data_5;
    call {:si_unique_call 736} Tmp_324 := __HAVOC_malloc(64);
    call {:si_unique_call 737} sdv_do_paged_code_check();
    hKey := 0;
    wwEnableFound := 0;
    call {:si_unique_call 738} status_15 := IoOpenDeviceRegistryKey(0, 1, 2031616, 0);
    goto anon23_Then, anon23_Else;

  anon23_Else:
    assume {:partition} status_15 >= 0;
    Tmp_324 := strConst__li2bpl2;
    call {:si_unique_call 739} status_15 := MouseQueryDeviceKey(hKey, Tmp_324, tmp_1, 4);
    goto anon25_Then, anon25_Else;
  ...
  L23:
    call {:si_unique_call 740} vslice_dummy_var_65 := ZwClose(0);
    hKey := 0;
    goto L17;
  ...
  anon26_Else:
    mask := 0;
    call {:si_unique_call 741} sdv_RtlZeroMemory(0, 284);
    assume {:nonnull} osVerInfo != 0;
    assume osVerInfo > 0;
    assume {:nonnull} osVerInfo != 0;
    assume osVerInfo > 0;
    call {:si_unique_call 742} mask := VerSetConditionMask(mask, 128, 1);
    call {:si_unique_call 743} sdv_170 := RtlVerifyVersionInfo(0, 128, mask);
    goto anon27_Then, anon27_Else;

  anon27_Else:
    assume {:partition} sdv_170 >= 0;
    call {:si_unique_call 744} sdv_RtlZeroMemory(0, 76);
    call {:si_unique_call 745} status_15 := ZwPowerInformation(4, 0, 0, 0, 76);
    goto anon28_Then, anon28_Else;
...
implementation {:origName "InitializeListHead"} InitializeListHead(actual_ListHead_2: int)
{
  ...
  anon0:
    call {:si_unique_call 746} vslice_dummy_var_66 := __HAVOC_malloc(4);
...
implementation {:origName "WPP_RECORDER_SF_qd"} WPP_RECORDER_SF_qd(actual_AutoLogContext_4: int, actual_level_4: int, actual_flags_4: int, actual_id_4: int, actual_traceGuid_4: int, actual_s_p_e_c_i_a_l_8: int, actual_s_p_e_c_i_a_l_9: int)
{
  ...
  anon0:
    call {:si_unique_call 747} vslice_dummy_var_67 := __HAVOC_malloc(4);
    level_4 := actual_level_4;
    flags_4 := actual_flags_4;
    traceGuid_4 := actual_traceGuid_4;
    call {:si_unique_call 748} vslice_dummy_var_69 := __HAVOC_malloc(4);
    ...
    call {:si_unique_call 749} Tmp_329 := corral_nondet();
    goto anon5_Then, anon5_Else;

  anon5_Else:
    call {:si_unique_call 750} Tmp_333 := corral_nondet();
    goto anon6_Then, anon6_Else;

  anon6_Else:
    call {:si_unique_call 751} Tmp_335 := corral_nondet();
    assume pfnWppTraceMessage == 0;
    goto L6;

  L6:
    call {:si_unique_call 752} vslice_dummy_var_68 := corral_nondet();
    return;
...
implementation {:origName "MouseClassReadCopyData"} MouseClassReadCopyData(actual_DeviceExtension_1: int, actual_Irp_18: int) returns (Tmp_340: int)
{
  ...
  anon0:
    ...
    assume {:nonnull} DeviceExtension_1 != 0;
    assume DeviceExtension_1 > 0;
    call {:si_unique_call 753} irpSp_3 := sdv_IoGetCurrentIrpStackLocation(Irp_18);
    assume {:nonnull} DeviceExtension_1 != 0;
    assume DeviceExtension_1 > 0;
    havoc bytesInQueue;
    ...
    havoc Tmp_342;
    havoc Tmp_349;
    call {:si_unique_call 754} WPP_RECORDER_SF_LL(Tmp_349, 0, 4, 32, Tmp_342, bytesInQueue, bytesToMove);
    goto anon9_Then, anon9_Else;
  ...
  L32:
    ...
    havoc Tmp_353;
    havoc Tmp_358;
    call {:si_unique_call 755} WPP_RECORDER_SF_L(Tmp_358, 0, 4, 33, Tmp_353, bytesInQueue);
    assume {:nonnull} Irp_18 != 0;
    assume Irp_18 > 0;
    havoc destination;
    havoc Tmp_359;
    havoc Tmp_361;
    call {:si_unique_call 756} WPP_RECORDER_SF_L(Tmp_361, 0, 4, 34, Tmp_359, moveSize);
    assume {:nonnull} DeviceExtension_1 != 0;
    assume DeviceExtension_1 > 0;
    havoc Tmp_348;
    havoc Tmp_365;
    havoc Tmp_344;
    call {:si_unique_call 757} WPP_RECORDER_SF_qq(Tmp_344, 0, 4, 35, Tmp_365, Tmp_348, destination);
    assume {:nonnull} DeviceExtension_1 != 0;
    assume DeviceExtension_1 > 0;
  ...
  anon11_Else:
    ...
    havoc Tmp_343;
    havoc Tmp_347;
    call {:si_unique_call 759} WPP_RECORDER_SF_L(Tmp_347, 0, 4, 36, Tmp_343, moveSize);
    assume {:nonnull} DeviceExtension_1 != 0;
    assume DeviceExtension_1 > 0;
    havoc Tmp_351;
    havoc Tmp_360;
    havoc Tmp_352;
    call {:si_unique_call 760} WPP_RECORDER_SF_qq(Tmp_352, 0, 4, 37, Tmp_360, Tmp_351, destination);
    assume {:nonnull} DeviceExtension_1 != 0;
    assume DeviceExtension_1 > 0;
  ...
  anon12_Else:
    havoc Tmp_345;
    havoc Tmp_346;
    call {:si_unique_call 762} WPP_RECORDER_SF_(Tmp_346, 0, 2, 38, Tmp_345);
    assume {:nonnull} DeviceExtension_1 != 0;
    assume DeviceExtension_1 > 0;
    goto L106;
  ...
  L106:
    ...
    call {:si_unique_call 763} WPP_RECORDER_SF_qq(Tmp_356, 0, 4, 39, Tmp_350, vslice_dummy_var_464, vslice_dummy_var_465);
    havoc Tmp_341;
    havoc Tmp_364;
    assume {:nonnull} DeviceExtension_1 != 0;
    assume DeviceExtension_1 > 0;
    havoc vslice_dummy_var_466;
    call {:si_unique_call 764} WPP_RECORDER_SF_l(Tmp_364, 0, 4, 40, Tmp_341, vslice_dummy_var_466);
    assume {:nonnull} Irp_18 != 0;
    assume Irp_18 > 0;
    assume {:nonnull} irpSp_3 != 0;
    assume irpSp_3 > 0;
...
implementation {:origName "MouseClassHandleRead"} MouseClassHandleRead(actual_DeviceExtension_2: int, actual_Irp_19: int) returns (Tmp_366: int)
{
  ...
  anon0:
    ...
    status_17 := 259;
    completeIrp := 0;
    call {:si_unique_call 765} Tmp_371 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_371 != 0;
    assume Tmp_371 > 0;
    call {:si_unique_call 766} sdv_KeAcquireSpinLock(0, Tmp_371);
    assume {:nonnull} Tmp_371 != 0;
    assume Tmp_371 > 0;
    havoc irql_4;
  ...
  anon11_Else:
    call {:si_unique_call 767} status_17 := MouseClassReadCopyData(DeviceExtension_2, Irp_19);
  ...
  L22:
    call {:si_unique_call 768} sdv_KeReleaseSpinLock(0, irql_4);
    goto anon12_Then, anon12_Else;
  ...
  anon12_Else:
    ...
    assume {:nonnull} DeviceExtension_2 != 0;
    assume DeviceExtension_2 > 0;
    call {:si_unique_call 769} vslice_dummy_var_71 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(DeviceExtension_2), Irp_19);
    call {:si_unique_call 770} sdv_IoCompleteRequest(0, 0);
    goto L26;
  ...
  anon11_Then:
    ...
    assume {:nonnull} Irp_19 != 0;
    assume Irp_19 > 0;
    call {:si_unique_call 771} vslice_dummy_var_70 := sdv_InsertTailList(ReadQueue__DEVICE_EXTENSION(DeviceExtension_2), ListEntry_unnamed_tag_6(Overlay_unnamed_tag_5(Tail__IRP(Irp_19))));
    call {:si_unique_call 772} oldCancelRoutine_1 := sdv_IoSetCancelRoutine(Irp_19, li2bplFunctionConstant979);
    assume {:nonnull} Irp_19 != 0;
    assume Irp_19 > 0;
    goto anon13_Then, anon13_Else;

  anon13_Else:
    call {:si_unique_call 773} oldCancelRoutine_1 := sdv_IoSetCancelRoutine(Irp_19, 0);
    goto anon15_Then, anon15_Else;
  ...
  anon15_Else:
    ...
    havoc Tmp_369;
    havoc Tmp_370;
    call {:si_unique_call 774} WPP_RECORDER_SF_(Tmp_370, 0, 1, 42, Tmp_369);
    goto L38;
  ...
  anon15_Then:
    assume {:partition} oldCancelRoutine_1 != 0;
    call {:si_unique_call 776} vslice_dummy_var_72 := sdv_RemoveEntryList(0);
    assume {:nonnull} Irp_19 != 0;
    assume Irp_19 > 0;
    assume {:nonnull} Irp_19 != 0;
    assume Irp_19 > 0;
    ...
    havoc Tmp_367;
    havoc Tmp_368;
    call {:si_unique_call 777} WPP_RECORDER_SF_(Tmp_368, 0, 1, 41, Tmp_367);
    goto L38;
...
implementation {:origName "WPP_RECORDER_SF_"} WPP_RECORDER_SF_(actual_AutoLogContext_5: int, actual_level_5: int, actual_flags_5: int, actual_id_5: int, actual_traceGuid_5: int)
{
  ...
  anon0:
    call {:si_unique_call 778} vslice_dummy_var_73 := __HAVOC_malloc(4);
    level_5 := actual_level_5;
    flags_5 := actual_flags_5;
    traceGuid_5 := actual_traceGuid_5;
    call {:si_unique_call 779} vslice_dummy_var_75 := __HAVOC_malloc(4);
    ...
    call {:si_unique_call 780} Tmp_376 := corral_nondet();
    goto anon5_Then, anon5_Else;

  anon5_Else:
    call {:si_unique_call 781} Tmp_384 := corral_nondet();
    goto anon6_Then, anon6_Else;

  anon6_Else:
    call {:si_unique_call 782} Tmp_374 := corral_nondet();
    assume pfnWppTraceMessage == 0;
    goto L6;

  L6:
    call {:si_unique_call 783} vslice_dummy_var_74 := corral_nondet();
    return;
...
implementation {:origName "MouseClassPower"} MouseClassPower(actual_DeviceObject_28: int, actual_Irp_20: int) returns (Tmp_387: int)
{
  ...
  anon0:
    call {:si_unique_call 784} powerState_3 := __HAVOC_malloc(8);
    call {:si_unique_call 785} sdv := __HAVOC_malloc(8);
    DeviceObject_28 := actual_DeviceObject_28;
    Irp_20 := actual_Irp_20;
    call {:si_unique_call 786} Tmp_394 := __HAVOC_malloc(20);
    hookit := 0;
    pendit := 0;
    releaseRemoveLock := 1;
    ...
    havoc data_4;
    call {:si_unique_call 788} stack_4 := sdv_IoGetCurrentIrpStackLocation(Irp_20);
  ...
  anon97_Else:
    call {:si_unique_call 789} PoStartNextPowerIrp(0);
    assume {:nonnull} Irp_20 != 0;
    assume Irp_20 > 0;
    call {:si_unique_call 790} sdv_IoCompleteRequest(0, 0);
    Tmp_387 := -1073741637;
    goto L1;
  ...
  anon69_Else:
    call {:si_unique_call 791} status_19 := sdv_IoAcquireRemoveLock(0, 0);
    goto anon70_Then, anon70_Else;
  ...
  anon76_Else:
    ...
    call {:si_unique_call 792} status_19 := sdv_IoAcquireRemoveLock(0, 0);
    call {:si_unique_call 793} sdv_IoCopyCurrentIrpStackLocationToNext(Irp_20);
    call {:si_unique_call 794} sdv_IoSetCompletionRoutine(Irp_20, li2bplFunctionConstant1012, 0, 1, 1, 1);
    call {:si_unique_call 795} sdv_IoMarkIrpPending(0);
    call {:si_unique_call 796} vslice_dummy_var_76 := PoCallDriver#1(0, Irp_20);
    goto anon98_Then, anon98_Else;
  ...
  anon78_Else:
    ...
    assume {:nonnull} data_4 != 0;
    assume data_4 > 0;
    call {:si_unique_call 797} vslice_dummy_var_77 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(data_4), Irp_20);
    goto L85;
  ...
  anon77_Then:
    assume {:partition} pendit == 0;
    call {:si_unique_call 798} PoStartNextPowerIrp(0);
    call {:si_unique_call 799} sdv_IoSkipCurrentIrpStackLocation(Irp_20);
    call {:si_unique_call 800} status_19 := PoCallDriver#1(0, Irp_20);
    goto anon99_Then, anon99_Else;
  ...
  anon73_Else:
    assume {:nonnull} data_4 != 0;
    assume data_4 > 0;
    call {:si_unique_call 803} sdv_193 := _InlineInterlockedCompareExchangePointer(WaitWakeIrp__DEVICE_EXTENSION(data_4), 0, 0);
    goto anon74_Then, anon74_Else;
  ...
  L111:
    ...
    call {:si_unique_call 804} WPP_RECORDER_SF_sd(Tmp_390, 0, 3, 92, Tmp_388, Tmp_389, vslice_dummy_var_467);
    goto anon79_Then, anon79_Else;
  ...
  anon102_Else:
    call {:si_unique_call 805} structPtr888sdv := PoSetPowerState(0, powerType_1, powerState_3);
  ...
  anon81_Else:
    call {:si_unique_call 806} status_19 := sdv_IoAcquireRemoveLock(0, 0);
    goto anon84_Then, anon84_Else;
  ...
  anon84_Else:
    ...
    assume {:nonnull} data_4 != 0;
    assume data_4 > 0;
    call {:si_unique_call 807} sdv_189 := _InlineInterlockedCompareExchangePointer(WaitWakeIrp__DEVICE_EXTENSION(data_4), 0, 0);
    goto anon85_Then, anon85_Else;
  ...
  L142:
    call {:si_unique_call 808} sdv_IoMarkIrpPending(0);
    assume {:nonnull} data_4 != 0;
    assume data_4 > 0;
    havoc vslice_dummy_var_468;
    call {:si_unique_call 809} status_19 := PoRequestPowerIrp#1(vslice_dummy_var_468, 2, powerState_3, li2bplFunctionConstant1013, Irp_20, 0);
    goto anon100_Then, anon100_Else;
  ...
  anon87_Then:
    ...
    assume {:nonnull} data_4 != 0;
    assume data_4 > 0;
    call {:si_unique_call 810} vslice_dummy_var_78 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(data_4), Irp_20);
    ...
    assume {:nonnull} data_4 != 0;
    assume data_4 > 0;
    call {:si_unique_call 813} vslice_dummy_var_79 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(data_4), Irp_20);
    Tmp_387 := 259;
    goto L1;
  ...
  anon90_Else:
    assume {:nonnull} data_4 != 0;
    assume data_4 > 0;
    call {:si_unique_call 814} sdv_192 := _InlineInterlockedCompareExchangePointer(WaitWakeIrp__DEVICE_EXTENSION(data_4), 0, 0);
    goto anon91_Then, anon91_Else;

  anon91_Else:
    assume {:partition} sdv_192 == 0;
    call {:si_unique_call 815} sdv_185 := MouseClassCheckWaitWakeEnabled(data_4);
    goto anon92_Then, anon92_Else;

  anon92_Else:
    assume {:partition} sdv_185 != 0;
    call {:si_unique_call 816} vslice_dummy_var_80 := MouseClassCreateWaitWakeIrp#1(data_4);
    goto anon101_Then, anon101_Else;
  ...
  anon71_Then:
    havoc Tmp_393;
    havoc Tmp_392;
    call {:si_unique_call 817} WPP_RECORDER_SF_q(Tmp_392, 0, 3, 93, Tmp_393, Irp_20);
    releaseRemoveLock := 0;
    assume {:nonnull} data_4 != 0;
    assume data_4 > 0;
    call {:si_unique_call 818} sdv_196 := _InlineInterlockedCompareExchangePointer(WaitWakeIrp__DEVICE_EXTENSION(data_4), Irp_20, 0);
    goto anon93_Then, anon93_Else;
  ...
  anon93_Else:
    ...
    assume {:nonnull} data_4 != 0;
    assume data_4 > 0;
    call {:si_unique_call 819} vslice_dummy_var_82 := _InlineInterlockedExchangePointer(ExtraWaitWakeIrp__DEVICE_EXTENSION(data_4), Irp_20);
    assume {:nonnull} data_4 != 0;
    assume data_4 > 0;
    call {:si_unique_call 820} vslice_dummy_var_83 := _InlineInterlockedExchangePointer(ExtraWWIrpTag__DEVICE_EXTENSION(data_4), Irp_20);
  ...
  anon93_Then:
    ...
    assume {:nonnull} data_4 != 0;
    assume data_4 > 0;
    call {:si_unique_call 821} vslice_dummy_var_81 := _InlineInterlockedExchangePointer(WWIrpTag__DEVICE_EXTENSION(data_4), Irp_20);
    status_19 := 0;
    goto L63;
...
implementation {:origName "FatalListEntryError"} FatalListEntryError(actual_p1: int, actual_p2: int, actual_p3: int)
{
  ...
  anon0:
    call {:si_unique_call 826} vslice_dummy_var_84 := __HAVOC_malloc(4);
    call {:si_unique_call 827} RtlFailFast(3);
    return;
}
...
implementation {:origName "RtlConvertLongToLuid"} RtlConvertLongToLuid(actual_Long: int) returns (structPtr888Tmp: int)
{
  ...
  anon0:
    call {:si_unique_call 828} Tmp := __HAVOC_malloc(8);
    call {:si_unique_call 829} TempLi := __HAVOC_malloc(20);
    call {:si_unique_call 830} TempLuid := __HAVOC_malloc(8);
    Long := actual_Long;
...
implementation {:origName "WPP_RECORDER_SF_l"} WPP_RECORDER_SF_l(actual_AutoLogContext_6: int, actual_level_6: int, actual_flags_6: int, actual_id_6: int, actual_traceGuid_6: int, actual_s_p_e_c_i_a_l_10: int)
{
  ...
  anon0:
    call {:si_unique_call 831} vslice_dummy_var_85 := __HAVOC_malloc(4);
    ...
    call {:si_unique_call 833} Tmp_409 := corral_nondet();
    goto anon5_Then, anon5_Else;

  anon5_Else:
    call {:si_unique_call 834} Tmp_405 := corral_nondet();
    goto anon6_Then, anon6_Else;

  anon6_Else:
    call {:si_unique_call 835} Tmp_404 := corral_nondet();
    assume pfnWppTraceMessage == 0;
    goto L6;

  L6:
    call {:si_unique_call 836} vslice_dummy_var_86 := corral_nondet();
    return;
...
implementation {:origName "WPP_RECORDER_SF_sd"} WPP_RECORDER_SF_sd(actual_AutoLogContext_7: int, actual_level_7: int, actual_flags_7: int, actual_id_7: int, actual_traceGuid_7: int, actual_s_p_e_c_i_a_l_11: int, actual_s_p_e_c_i_a_l_12: int)
{
  ...
  anon0:
    call {:si_unique_call 837} vslice_dummy_var_88 := __HAVOC_malloc(4);
    level_7 := actual_level_7;
    flags_7 := actual_flags_7;
    traceGuid_7 := actual_traceGuid_7;
    s_p_e_c_i_a_l_11 := actual_s_p_e_c_i_a_l_11;
    call {:si_unique_call 838} vslice_dummy_var_90 := __HAVOC_malloc(4);
    ...
    call {:si_unique_call 839} Tmp_413 := corral_nondet();
    goto anon17_Then, anon17_Else;

  anon17_Else:
    call {:si_unique_call 840} Tmp_415 := corral_nondet();
    goto anon18_Then, anon18_Else;
  ...
  L17:
    call {:si_unique_call 841} Tmp_425 := corral_nondet();
    assume pfnWppTraceMessage == 0;
    goto L6;
  ...
  L30:
    call {:si_unique_call 842} vslice_dummy_var_89 := corral_nondet();
    return;
...
implementation {:origName "MouseClassRead"} MouseClassRead(actual_Device: int, actual_Irp_22: int) returns (Tmp_431: int)
{
  ...
  anon0:
    ...
    havoc Tmp_432;
    havoc Tmp_434;
    call {:si_unique_call 843} WPP_RECORDER_SF_(Tmp_434, 0, 3, 43, Tmp_432);
    call {:si_unique_call 844} irpSp_4 := sdv_IoGetCurrentIrpStackLocation(Irp_22);
  ...
  anon17_Else:
    ...
    call {:si_unique_call 845} Tmp_431 := MouseClassHandleRead(deviceExtension_5, Irp_22);
    goto L1;
  ...
  anon17_Then:
    ...
    havoc Tmp_435;
    havoc Tmp_437;
    call {:si_unique_call 847} WPP_RECORDER_SF_(Tmp_437, 0, 3, 44, Tmp_435);
    Tmp_431 := status_21;
    goto L1;
  ...
  anon18_Else:
    ...
    assume Device > 0;
    havoc deviceExtension_5;
    call {:si_unique_call 848} status_21 := sdv_IoAcquireRemoveLock(0, 0);
    goto anon15_Then, anon15_Else;
...
implementation {:origName "WPP_RECORDER_SF_L"} WPP_RECORDER_SF_L(actual_AutoLogContext_8: int, actual_level_8: int, actual_flags_8: int, actual_id_8: int, actual_traceGuid_8: int, actual_s_p_e_c_i_a_l_13: int)
{
  ...
  anon0:
    call {:si_unique_call 849} vslice_dummy_var_91 := __HAVOC_malloc(4);
    level_8 := actual_level_8;
    flags_8 := actual_flags_8;
    traceGuid_8 := actual_traceGuid_8;
    call {:si_unique_call 850} vslice_dummy_var_93 := __HAVOC_malloc(4);
    ...
    call {:si_unique_call 851} Tmp_439 := corral_nondet();
    goto anon5_Then, anon5_Else;

  anon5_Else:
    call {:si_unique_call 852} Tmp_443 := corral_nondet();
    goto anon6_Then, anon6_Else;

  anon6_Else:
    call {:si_unique_call 853} Tmp_445 := corral_nondet();
    assume pfnWppTraceMessage == 0;
    goto L6;

  L6:
    call {:si_unique_call 854} vslice_dummy_var_92 := corral_nondet();
    return;
...
implementation {:origName "MousePnP"} MousePnP(actual_DeviceObject_31: int, actual_Irp_23: int) returns (Tmp_449: int)
{
  ...
  anon0:
    call {:si_unique_call 855} worker := __HAVOC_malloc(8);
    ...
    havoc data_6;
    call {:si_unique_call 856} stack_6 := sdv_IoGetCurrentIrpStackLocation(Irp_23);
    assume {:nonnull} data_6 != 0;
    assume data_6 > 0;
    goto anon81_Then, anon81_Else;

  anon81_Else:
    call {:si_unique_call 857} status_22 := sdv_IoAcquireRemoveLock(0, 0);
    goto anon82_Then, anon82_Else;
  ...
  anon93_Else:
    call {:si_unique_call 858} MouseClassRemoveDevice(data_6, 1);
    call {:si_unique_call 859} sdv_IoSkipCurrentIrpStackLocation(Irp_23);
    assume {:nonnull} data_6 != 0;
    assume data_6 > 0;
    havoc vslice_dummy_var_469;
    call {:si_unique_call 860} status_22 := sdv_IoCallDriver#1(vslice_dummy_var_469, Irp_23);
  ...
  L48:
    assume {:nonnull} data_6 != 0;
    assume data_6 > 0;
    call {:si_unique_call 861} vslice_dummy_var_94 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(data_6), Irp_23);
    Tmp_449 := status_22;
    goto L1;
  ...
  L27:
    call {:si_unique_call 862} sdv_IoCopyCurrentIrpStackLocationToNext(Irp_23);
    assume {:nonnull} data_6 != 0;
    assume data_6 > 0;
    havoc vslice_dummy_var_470;
    call {:si_unique_call 863} status_22 := sdv_IoCallDriver#1(vslice_dummy_var_470, Irp_23);
  ...
  anon84_Else:
    call {:si_unique_call 864} ExAcquireFastMutex(0);
    goto anon85_Then, anon85_Else;
  ...
  anon87_Else:
    ...
    assume {:nonnull} data_6 != 0;
    assume data_6 > 0;
    call {:si_unique_call 866} notifyHandle_2 := _InlineInterlockedExchangePointer(TargetNotifyHandle__DEVICE_EXTENSION(data_6), 0);
    goto anon88_Then, anon88_Else;

  anon88_Else:
    assume {:partition} notifyHandle_2 != 0;
    call {:si_unique_call 867} vslice_dummy_var_95 := IoUnregisterPlugPlayNotification(0);
    goto L77;

  L77:
    call {:si_unique_call 868} status_22 := MouEnableDisablePort#1(0, 0, data_6, file_1);
  ...
  L52:
    assume {:nonnull} data_6 != 0;
    assume data_6 > 0;
    call {:si_unique_call 869} sdv_IoSkipCurrentIrpStackLocation(Irp_23);
    assume {:nonnull} data_6 != 0;
    assume data_6 > 0;
    havoc vslice_dummy_var_471;
    call {:si_unique_call 870} status_22 := sdv_IoCallDriver#1(vslice_dummy_var_471, Irp_23);
  ...
  anon109_Then:
    call {:si_unique_call 873} MouseClassRemoveDevice(data_6, 0);
    call {:si_unique_call 874} sdv_IoReleaseRemoveLockAndWait(0, 0);
    call {:si_unique_call 875} sdv_IoCopyCurrentIrpStackLocationToNext(Irp_23);
    assume {:nonnull} data_6 != 0;
    assume data_6 > 0;
    havoc vslice_dummy_var_472;
    call {:si_unique_call 876} status_22 := sdv_IoCallDriver#1(vslice_dummy_var_472, Irp_23);
    goto anon116_Then, anon116_Else;

  anon116_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 877} ExAcquireFastMutex(0);
    goto anon89_Then, anon89_Else;
  ...
  L114:
    call {:si_unique_call 878} ExReleaseFastMutex(0);
    goto L117;

  L117:
    call {:si_unique_call 879} IoDetachDevice(0);
    call {:si_unique_call 880} RtlFreeUnicodeString(0);
    call {:si_unique_call 881} sdv_ExFreePool(0);
    call {:si_unique_call 882} IoDeleteDevice(0);
    Tmp_449 := status_22;
    goto L1;
  ...
  anon83_Then:
    call {:si_unique_call 885} sdv_228 := ExAllocatePoolWithTag(512, 8, -1016105651);
    item_3 := sdv_228;
    goto anon111_Then, anon111_Else;

  anon111_Else:
    assume {:partition} item_3 != 0;
    call {:si_unique_call 886} sdv_RtlZeroMemory(0, 8);
    assume {:nonnull} item_3 != 0;
    assume item_3 > 0;
    call {:si_unique_call 887} boogieTmp := IoAllocateWorkItem(0);
    assume {:nonnull} item_3 != 0;
    assume item_3 > 0;
    goto anon91_Then, anon91_Else;
  ...
  anon91_Else:
    assume {:nonnull} item_3 != 0;
    assume item_3 > 0;
    call {:si_unique_call 888} vslice_dummy_var_98 := sdv_IoAcquireRemoveLock(0, 0);
    call {:si_unique_call 889} sdv_IoCopyCurrentIrpStackLocationToNext(Irp_23);
    call {:si_unique_call 890} sdv_IoSetCompletionRoutine(Irp_23, li2bplFunctionConstant1002, item_3, 1, 1, 1);
    status_22 := 259;
    call {:si_unique_call 891} sdv_IoMarkIrpPending(0);
    assume {:nonnull} data_6 != 0;
    assume data_6 > 0;
    havoc vslice_dummy_var_473;
    call {:si_unique_call 892} vslice_dummy_var_96 := sdv_IoCallDriver#1(vslice_dummy_var_473, Irp_23);
  ...
  anon92_Else:
    ...
    call {:si_unique_call 893} vslice_dummy_var_97 := MouseSendIrpSynchronously#1(vslice_dummy_var_474, Irp_23, 1);
  ...
  anon113_Else:
    ...
    assume {:nonnull} worker != 0;
    assume worker > 0;
    call {:si_unique_call 894} status_22 := MouseStart#1(DeviceObject_31, worker);
  ...
  anon114_Else:
    ...
    assume {:nonnull} Irp_23 != 0;
    assume Irp_23 > 0;
    call {:si_unique_call 895} sdv_IoCompleteRequest(0, 0);
    goto L48;
...
implementation {:origName "MouseClassFlush"} MouseClassFlush(actual_DeviceObject_32: int, actual_Irp_24: int) returns (Tmp_455: int)
{
  ...
  anon0:
    ...
    havoc Tmp_459;
    havoc Tmp_458;
    call {:si_unique_call 898} WPP_RECORDER_SF_(Tmp_458, 0, 3, 21, Tmp_459);
    assume {:nonnull} DeviceObject_32 != 0;
    assume DeviceObject_32 > 0;
    havoc deviceExtension_6;
    call {:si_unique_call 899} irpSp_5 := sdv_IoGetCurrentIrpStackLocation(Irp_24);
  ...
  anon8_Else:
    ...
    call {:si_unique_call 900} MouInitializeDataQueue(deviceExtension_6);
    goto L25;
  ...
  L25:
    ...
    havoc Tmp_460;
    havoc Tmp_461;
    call {:si_unique_call 902} WPP_RECORDER_SF_(Tmp_461, 0, 3, 22, Tmp_460);
    Tmp_455 := status_23;
    return;
...
implementation {:origName "MouseClassCreate"} MouseClassCreate(actual_DeviceObject_34: int, actual_Irp_26: int) returns (Tmp_468: int)
{
  ...
  anon0:
    call {:si_unique_call 903} vslice_dummy_var_99 := __HAVOC_malloc(8);
    call {:si_unique_call 904} priv := __HAVOC_malloc(8);
    ...
    havoc Tmp_482;
    havoc Tmp_476;
    call {:si_unique_call 905} WPP_RECORDER_SF_(Tmp_476, 0, 3, 23, Tmp_482);
    assume {:nonnull} DeviceObject_34 != 0;
    assume DeviceObject_34 > 0;
    havoc deviceExtension_7;
    call {:si_unique_call 906} irpSp_6 := sdv_IoGetCurrentIrpStackLocation(Irp_26);
  ...
  L35:
    ...
    assume {:nonnull} Irp_26 != 0;
    assume Irp_26 > 0;
    call {:si_unique_call 907} sdv_IoCompleteRequest(0, 0);
    havoc Tmp_480;
    havoc Tmp_472;
    call {:si_unique_call 908} WPP_RECORDER_SF_(Tmp_472, 0, 3, 27, Tmp_480);
    Tmp_468 := status_24;
    goto L1;
  ...
  L29:
    call {:si_unique_call 909} status_24 := sdv_IoAcquireRemoveLock(0, 0);
    goto anon42_Then, anon42_Else;
  ...
  anon45_Else:
    havoc Tmp_481;
    havoc Tmp_473;
    call {:si_unique_call 910} WPP_RECORDER_SF_(Tmp_473, 0, 2, 24, Tmp_481);
    status_24 := -1073741823;
    assume {:nonnull} deviceExtension_7 != 0;
    assume deviceExtension_7 > 0;
    call {:si_unique_call 911} vslice_dummy_var_102 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(deviceExtension_7), Irp_26);
    goto L35;
  ...
  anon44_Else:
    call {:si_unique_call 912} structPtr888priv := RtlConvertLongToLuid(7);
    ...
    call {:si_unique_call 913} sdv_247 := SeSinglePrivilegeCheck(priv, vslice_dummy_var_475);
    goto anon46_Then, anon46_Else;

  anon46_Else:
    assume {:partition} sdv_247 != 0;
    call {:si_unique_call 914} Tmp_479 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_479 != 0;
    assume Tmp_479 > 0;
    call {:si_unique_call 915} sdv_KeAcquireSpinLock(0, Tmp_479);
    assume {:nonnull} Tmp_479 != 0;
    assume Tmp_479 > 0;
    havoc oldIrql_2;
    assume {:nonnull} irpSp_6 != 0;
    ...
    assume {:nonnull} deviceExtension_7 != 0;
    assume deviceExtension_7 > 0;
    call {:si_unique_call 916} sdv_KeReleaseSpinLock(0, oldIrql_2);
    goto L70;
  ...
  L93:
    call {:si_unique_call 918} i_2, someEnableDisableSucceeded_1, Tmp_469, Tmp_470, port_5, enabled_5, status_24, Tmp_478 := MouseClassCreate_loop_L93(i_2, someEnableDisableSucceeded_1, Tmp_469, irpSp_6, Tmp_470, port_5, enabled_5, status_24, deviceExtension_7, Tmp_478, DeviceObject_34, Irp_26);
    goto L93_last;
  ...
  anon51_Else:
    ...
    call {:si_unique_call 920} WPP_RECORDER_SF_q(Tmp_470, 0, 1, 25, Tmp_469, vslice_dummy_var_476);
    assume {:nonnull} irpSp_6 != 0;
    assume irpSp_6 > 0;
    havoc vslice_dummy_var_477;
    call {:si_unique_call 921} MouseClassLogError(DeviceObject_34, -1073414135, 20120, status_24, 0, 0, vslice_dummy_var_477);
    assume {:nonnull} port_5 != 0;
    assume port_5 > 0;
    goto L125;

  L125:
    call {:si_unique_call 922} ExAcquireFastMutex(0);
    goto L101;
  ...
  anon50_Then:
    ...
    call {:si_unique_call 923} status_24 := MouEnableDisablePort#1(1, Irp_26, vslice_dummy_var_478, File__PORT(port_5));
    goto anon58_Then, anon58_Else;
  ...
  L130:
    assume {:nonnull} deviceExtension_7 != 0;
    assume deviceExtension_7 > 0;
    call {:si_unique_call 925} vslice_dummy_var_100 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(deviceExtension_7), Irp_26);
    goto L35;
  ...
  anon48_Else:
    call {:si_unique_call 926} ExReleaseFastMutex(0);
    assume {:nonnull} deviceExtension_7 != 0;
    assume deviceExtension_7 > 0;
  ...
  anon53_Else:
    assume {:nonnull} irpSp_6 != 0;
    assume irpSp_6 > 0;
    call {:si_unique_call 927} status_24 := MouEnableDisablePort#1(1, Irp_26, deviceExtension_7, FileObject__IO_STACK_LOCATION(irpSp_6));
    goto anon59_Then, anon59_Else;
  ...
  anon54_Else:
    ...
    call {:si_unique_call 928} WPP_RECORDER_SF_Dq(Tmp_474, 0, 1, 26, Tmp_477, status_24, vslice_dummy_var_479);
    goto L129;
  ...
  anon53_Then:
    call {:si_unique_call 929} sdv_IoSkipCurrentIrpStackLocation(Irp_26);
    assume {:nonnull} deviceExtension_7 != 0;
    assume deviceExtension_7 > 0;
    havoc vslice_dummy_var_480;
    call {:si_unique_call 930} status_24 := sdv_IoCallDriver#1(vslice_dummy_var_480, Irp_26);
    goto anon60_Then, anon60_Else;
  ...
  anon60_Else:
    ...
    assume {:nonnull} deviceExtension_7 != 0;
    assume deviceExtension_7 > 0;
    call {:si_unique_call 931} vslice_dummy_var_101 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(deviceExtension_7), Irp_26);
    Tmp_468 := status_24;
    goto L1;
  ...
  anon48_Then:
    call {:si_unique_call 932} ExReleaseFastMutex(0);
    goto L129;
...
const {:string "WaitWakeEnabled"} unique strConst__li2bpl2: int;
...
implementation {:origName "MouseClassWWPowerUpComplete"} MouseClassWWPowerUpComplete#0(actual_DeviceObject_17: int, actual_MinorFunction_2: int, actual_SD1_1: int, actual_Context_7: int, actual_IoStatus_1: int)
{
  ...
  anon0:
    call {:si_unique_call 933} PowerState_1 := __HAVOC_malloc(8);
    call {:si_unique_call 934} vslice_dummy_var_103 := __HAVOC_malloc(4);
    SD1_1 := actual_SD1_1;
  ...
  anon13_Else:
    call {:si_unique_call 935} sdv_112 := ExAllocatePoolWithTag(512, 16, -1016105651);
    itemData := sdv_112;
    goto anon14_Then, anon14_Else;
  ...
  L45:
    havoc Tmp_219;
    havoc Tmp_221;
    call {:si_unique_call 936} WPP_RECORDER_SF_(Tmp_221, 0, 2, 89, Tmp_219);
    assume {:nonnull} data != 0;
    assume data > 0;
    havoc vslice_dummy_var_481;
    call {:si_unique_call 937} MouseClassLogError(vslice_dummy_var_481, 327694, 1, -1073741670, 0, 0, 0);
    goto L1;
  ...
  anon14_Then:
    ...
    assume itemData > 0;
    call {:si_unique_call 938} boogieTmp := IoAllocateWorkItem(0);
    assume {:nonnull} itemData != 0;
    assume itemData > 0;
    goto anon11_Then, anon11_Else;
  ...
  anon11_Else:
    ...
    assume {:nonnull} itemData != 0;
    assume itemData > 0;
    call {:si_unique_call 939} status_7 := sdv_IoAcquireRemoveLock(0, 0);
    goto anon12_Then, anon12_Else;
  ...
  anon12_Else:
    ...
    call {:si_unique_call 940} IoQueueWorkItem#0(vslice_dummy_var_482, li2bplFunctionConstant1006, 1, itemData);
    goto anon15_Then, anon15_Else;
  ...
  anon12_Then:
    ...
    call {:si_unique_call 941} IoFreeWorkItem(0);
...
procedure {:origName "MouseClassWWPowerUpComplete"} MouseClassWWPowerUpComplete#0(actual_DeviceObject_17: int, actual_MinorFunction_2: int, actual_SD1_1: int, actual_Context_7: int, actual_IoStatus_1: int);
  modifies alloc, SLAM_guard_O_0, SignalState, sdv_compFset, sdv_invoke_on_success, sdv_invoke_on_error, sdv_invoke_on_cancel, signal_location, yogi_error;
  free ensures {:va_keep} old(SignalState) == 2 ==> SignalState != 0;
  free ensures {:va_keep} old(SignalState) == 0 ==> SignalState != 2;
  free ensures {:va_keep} old(signal_location) == 0 ==> signal_location != 1;
...
implementation {:origName "MouseClassWWPowerUpComplete"} MouseClassWWPowerUpComplete#1(actual_DeviceObject_17: int, actual_MinorFunction_2: int, actual_SD1_1: int, actual_Context_7: int, actual_IoStatus_1: int)
{
  ...
  anon0:
    call {:si_unique_call 944} PowerState_1 := __HAVOC_malloc(8);
    call {:si_unique_call 945} vslice_dummy_var_104 := __HAVOC_malloc(4);
    SD1_1 := actual_SD1_1;
    Context_7 := actual_Context_7;
    assume {:nonnull} PowerState_1 != 0;
    assume PowerState_1 > 0;
  ...
  anon13_Else:
    call {:si_unique_call 946} sdv_112 := ExAllocatePoolWithTag(512, 16, -1016105651);
    itemData := sdv_112;
    goto anon14_Then, anon14_Else;
  ...
  L45:
    havoc Tmp_219;
    havoc Tmp_221;
    call {:si_unique_call 947} WPP_RECORDER_SF_(Tmp_221, 0, 2, 89, Tmp_219);
    assume {:nonnull} data != 0;
    assume data > 0;
    havoc vslice_dummy_var_483;
    call {:si_unique_call 948} MouseClassLogError(vslice_dummy_var_483, 327694, 1, -1073741670, 0, 0, 0);
    goto L1;
  ...
  anon14_Then:
    ...
    assume {:nonnull} itemData != 0;
    assume itemData > 0;
    call {:si_unique_call 949} boogieTmp := IoAllocateWorkItem(0);
    assume {:nonnull} itemData != 0;
    assume itemData > 0;
    goto anon11_Then, anon11_Else;
  ...
  anon11_Else:
    ...
    assume {:nonnull} itemData != 0;
    assume itemData > 0;
    call {:si_unique_call 950} status_7 := sdv_IoAcquireRemoveLock(0, 0);
    goto anon12_Then, anon12_Else;
  ...
  anon12_Else:
    ...
    call {:si_unique_call 951} IoQueueWorkItem#1(vslice_dummy_var_484, li2bplFunctionConstant1006, 1, itemData);
    goto anon15_Then, anon15_Else;
  ...
  anon12_Then:
    assume {:partition} 0 > status_7;
    call {:si_unique_call 952} IoFreeWorkItem(0);
...
implementation {:origName "IoQueueWorkItem"} {:osmodel} IoQueueWorkItem#0(actual_IoWorkItem_1: int, actual_WorkerRoutine: int, actual_QueueType: int, actual_Context: int)
{
  ...
  anon0:
    call {:si_unique_call 955} vslice_dummy_var_105 := __HAVOC_malloc(4);
    WorkerRoutine := actual_WorkerRoutine;
    QueueType := actual_QueueType;
    Context := actual_Context;
    call {:si_unique_call 956} sdv_RunIoQueueWorkItems#0(0, WorkerRoutine, QueueType, Context);
    goto anon3_Then, anon3_Else;
...
implementation {:origName "IoQueueWorkItem"} {:osmodel} IoQueueWorkItem#1(actual_IoWorkItem_1: int, actual_WorkerRoutine: int, actual_QueueType: int, actual_Context: int)
{
  ...
  anon0:
    call {:si_unique_call 957} vslice_dummy_var_106 := __HAVOC_malloc(4);
    WorkerRoutine := actual_WorkerRoutine;
    QueueType := actual_QueueType;
    Context := actual_Context;
    call {:si_unique_call 958} sdv_RunIoQueueWorkItems#1(0, WorkerRoutine, QueueType, Context);
    goto anon3_Then, anon3_Else;
...
implementation {:origName "sdv_RunIoQueueWorkItems"} {:osmodel} sdv_RunIoQueueWorkItems#0(actual_IoWorkItem_2: int, actual_WorkerRoutine_1: int, actual_QueueType_1: int, actual_Context_1: int)
{
  ...
  anon0:
    call {:si_unique_call 959} vslice_dummy_var_107 := __HAVOC_malloc(4);
  ...
  anon13_Else:
    ...
    call {:si_unique_call 960} MouseClassCreateWaitWakeIrpWorker#0(sdv_p_devobj_fdo, Context_1);
    goto anon16_Then, anon16_Else;
  ...
  anon14_Else:
    ...
    call {:si_unique_call 961} MouseStartWorker#0(sdv_p_devobj_fdo, Context_1);
    goto anon17_Then, anon17_Else;
  ...
  anon15_Else:
    ...
    call {:si_unique_call 962} MouseToggleWaitWakeWorker#0(sdv_p_devobj_fdo, Context_1);
    goto anon18_Then, anon18_Else;
...
implementation {:origName "sdv_RunIoQueueWorkItems"} {:osmodel} sdv_RunIoQueueWorkItems#1(actual_IoWorkItem_2: int, actual_WorkerRoutine_1: int, actual_QueueType_1: int, actual_Context_1: int)
{
  ...
  anon0:
    call {:si_unique_call 963} vslice_dummy_var_108 := __HAVOC_malloc(4);
    WorkerRoutine_1 := actual_WorkerRoutine_1;
    Context_1 := actual_Context_1;
    goto anon13_Then, anon13_Else;
  ...
  anon13_Else:
    assume {:partition} WorkerRoutine_1 == li2bplFunctionConstant1006;
    call {:si_unique_call 964} MouseClassCreateWaitWakeIrpWorker#1(sdv_p_devobj_fdo, Context_1);
    goto anon16_Then, anon16_Else;
  ...
  anon14_Else:
    assume {:partition} WorkerRoutine_1 == li2bplFunctionConstant1001;
    call {:si_unique_call 965} MouseStartWorker#1(sdv_p_devobj_fdo, Context_1);
    goto anon17_Then, anon17_Else;
  ...
  anon15_Else:
    assume {:partition} WorkerRoutine_1 == li2bplFunctionConstant1010;
    call {:si_unique_call 966} MouseToggleWaitWakeWorker#1(sdv_p_devobj_fdo, Context_1);
    goto anon18_Then, anon18_Else;
...
implementation {:origName "MouseClassCreateWaitWakeIrpWorker"} MouseClassCreateWaitWakeIrpWorker#0(actual_DeviceObject_30: int, actual_Context_15: int)
{
  ...
  anon0:
    call {:si_unique_call 967} vslice_dummy_var_109 := __HAVOC_malloc(4);
...
implementation {:origName "MouseClassCreateWaitWakeIrpWorker"} MouseClassCreateWaitWakeIrpWorker#1(actual_DeviceObject_30: int, actual_Context_15: int)
{
  ...
  anon0:
    call {:si_unique_call 969} vslice_dummy_var_111 := __HAVOC_malloc(4);
    Context_15 := actual_Context_15;
    ...
    call {:si_unique_call 971} vslice_dummy_var_112 := MouseClassCreateWaitWakeIrp#0(vslice_dummy_var_485);
    goto anon3_Then, anon3_Else;
  ...
  anon3_Else:
    ...
    assume Tmp_428 > 0;
    call {:si_unique_call 972} vslice_dummy_var_113 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(Tmp_428), ItemData_1);
    call {:si_unique_call 973} IoFreeWorkItem(0);
...
implementation {:origName "MouseClassCreateWaitWakeIrp"} MouseClassCreateWaitWakeIrp#0(actual_Data_6: int) returns (Tmp_372: int)
{
  ...
  anon0:
    call {:si_unique_call 975} powerState_2 := __HAVOC_malloc(8);
    Data_6 := actual_Data_6;
    success := 1;
    call {:si_unique_call 976} sdv_do_paged_code_check();
    assume {:nonnull} Data_6 != 0;
    assume Data_6 > 0;
    ...
    call {:si_unique_call 977} status_18 := PoRequestPowerIrp#0(vslice_dummy_var_486, 0, powerState_2, li2bplFunctionConstant1007, Data_6, 0);
    goto anon6_Then, anon6_Else;
...
implementation {:origName "MouseClassCreateWaitWakeIrp"} MouseClassCreateWaitWakeIrp#1(actual_Data_6: int) returns (Tmp_372: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 980} status_18 := PoRequestPowerIrp#1(vslice_dummy_var_487, 0, powerState_2, li2bplFunctionConstant1007, Data_6, 0);
    goto anon6_Then, anon6_Else;
...
implementation {:origName "PoRequestPowerIrp"} {:osmodel} PoRequestPowerIrp#0(actual_DeviceObject_6: int, actual_MinorFunction: int, actual_SD3: int, actual_CompletionFunction: int, actual_Context_3: int, actual_Irp_2: int) returns (Tmp_73: int)
{
  ...
  anon0:
    call {:si_unique_call 981} PowerState_3 := __HAVOC_malloc(8);
  ...
  anon11_Else:
    ...
    assume {:nonnull} sdv_power_irp != 0;
    assume sdv_power_irp > 0;
    call {:si_unique_call 982} vslice_dummy_var_114 := sdv_RunPowerCompletionRoutines#0(DeviceObject_6, MinorFunction, PowerState_3, Context_3, IoStatus__IRP(sdv_power_irp), CompletionFunction);
    goto anon15_Then, anon15_Else;
...
implementation {:origName "PoRequestPowerIrp"} {:osmodel} PoRequestPowerIrp#1(actual_DeviceObject_6: int, actual_MinorFunction: int, actual_SD3: int, actual_CompletionFunction: int, actual_Context_3: int, actual_Irp_2: int) returns (Tmp_73: int)
{
  ...
  anon0:
    call {:si_unique_call 983} PowerState_3 := __HAVOC_malloc(8);
    DeviceObject_6 := actual_DeviceObject_6;
    MinorFunction := actual_MinorFunction;
    SD3 := actual_SD3;
    CompletionFunction := actual_CompletionFunction;
  ...
  anon11_Else:
    ...
    assume {:nonnull} sdv_power_irp != 0;
    assume sdv_power_irp > 0;
    call {:si_unique_call 984} vslice_dummy_var_115 := sdv_RunPowerCompletionRoutines#1(DeviceObject_6, MinorFunction, PowerState_3, Context_3, IoStatus__IRP(sdv_power_irp), CompletionFunction);
    goto anon15_Then, anon15_Else;
...
implementation {:origName "sdv_RunPowerCompletionRoutines"} {:osmodel} sdv_RunPowerCompletionRoutines#0(actual_DeviceObject_7: int, actual_MinorFunction_1: int, actual_SD2: int, actual_Context_4: int, actual_IoStatus: int, actual_CompletionFunction_1: int) returns (Tmp_89: int)
{
  ...
  anon0:
    call {:si_unique_call 985} PowerState_2 := __HAVOC_malloc(8);
  ...
  anon15_Else:
    ...
    call {:si_unique_call 986} sdv_stub_power_completion_begin();
    call {:si_unique_call 987} MouseClassPoRequestComplete#0(DeviceObject_7, MinorFunction_1, PowerState_2, Context_4, IoStatus);
    goto anon16_Then, anon16_Else;
  ...
  anon13_Else:
    ...
    call {:si_unique_call 988} sdv_stub_power_completion_begin();
    call {:si_unique_call 989} MouseClassWWPowerUpComplete#0(DeviceObject_7, MinorFunction_1, PowerState_2, Context_4, IoStatus);
    goto anon17_Then, anon17_Else;
  ...
  anon14_Else:
    ...
    call {:si_unique_call 990} sdv_stub_power_completion_begin();
    call {:si_unique_call 991} MouseClassWaitWakeComplete#0(DeviceObject_7, MinorFunction_1, PowerState_2, Context_4, IoStatus);
    goto anon18_Then, anon18_Else;
...
implementation {:origName "sdv_RunPowerCompletionRoutines"} {:osmodel} sdv_RunPowerCompletionRoutines#1(actual_DeviceObject_7: int, actual_MinorFunction_1: int, actual_SD2: int, actual_Context_4: int, actual_IoStatus: int, actual_CompletionFunction_1: int) returns (Tmp_89: int)
{
  ...
  anon0:
    call {:si_unique_call 992} PowerState_2 := __HAVOC_malloc(8);
    DeviceObject_7 := actual_DeviceObject_7;
    MinorFunction_1 := actual_MinorFunction_1;
    SD2 := actual_SD2;
    Context_4 := actual_Context_4;
  ...
  anon15_Else:
    ...
    call {:si_unique_call 994} MouseClassPoRequestComplete#1(DeviceObject_7, MinorFunction_1, PowerState_2, Context_4, IoStatus);
    goto anon16_Then, anon16_Else;
  ...
  anon13_Else:
    assume {:partition} CompletionFunction_1 == li2bplFunctionConstant1005;
    call {:si_unique_call 995} sdv_stub_power_completion_begin();
    call {:si_unique_call 996} MouseClassWWPowerUpComplete#1(DeviceObject_7, MinorFunction_1, PowerState_2, Context_4, IoStatus);
    goto anon17_Then, anon17_Else;
  ...
  anon14_Else:
    assume {:partition} CompletionFunction_1 == li2bplFunctionConstant1007;
    call {:si_unique_call 997} sdv_stub_power_completion_begin();
    call {:si_unique_call 998} MouseClassWaitWakeComplete#1(DeviceObject_7, MinorFunction_1, PowerState_2, Context_4, IoStatus);
    goto anon18_Then, anon18_Else;
...
implementation {:origName "MouseClassPoRequestComplete"} MouseClassPoRequestComplete#0(actual_DeviceObject_22: int, actual_MinorFunction_3: int, actual_structPtr888D: int, actual_Context_11: int, actual_IoStatus_2: int)
{
  ...
  anon0:
    call {:si_unique_call 999} D := __HAVOC_malloc(8);
    call {:si_unique_call 1000} powerState_1 := __HAVOC_malloc(8);
    call {:si_unique_call 1001} vslice_dummy_var_116 := __HAVOC_malloc(4);
    call {:si_unique_call 1002} sdv_1 := __HAVOC_malloc(8);
  ...
  anon27_Else:
    ...
    call {:si_unique_call 1003} sdv_140 := sdv_IoGetCurrentIrpStackLocation(S);
    assume {:nonnull} powerState_1 != 0;
    assume powerState_1 > 0;
    ...
    assume {:nonnull} sdv_140 != 0;
    assume sdv_140 > 0;
    call {:si_unique_call 1004} SD1_2 := PoSetPowerState(0, 0, powerState_1);
    ...
    call {:si_unique_call 1006} sdv_IoSkipCurrentIrpStackLocation(S);
    call {:si_unique_call 1007} vslice_dummy_var_117 := PoCallDriver#0(0, S);
    goto anon28_Then, anon28_Else;
  ...
  anon28_Else:
    ...
    assume {:nonnull} data_3 != 0;
    assume data_3 > 0;
    call {:si_unique_call 1008} vslice_dummy_var_118 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(data_3), S);
    goto L1;
  ...
  anon22_Else:
    assume {:nonnull} data_3 != 0;
    assume data_3 > 0;
    call {:si_unique_call 1009} sdv_145 := _InlineInterlockedCompareExchangePointer(WaitWakeIrp__DEVICE_EXTENSION(data_3), 0, 0);
    goto anon23_Then, anon23_Else;

  anon23_Else:
    assume {:partition} sdv_145 == 0;
    call {:si_unique_call 1010} sdv_144 := MouseClassCheckWaitWakeEnabled(data_3);
    goto anon24_Then, anon24_Else;

  anon24_Else:
    assume {:partition} sdv_144 != 0;
    call {:si_unique_call 1011} sdv_141 := ExAllocatePoolWithTag(512, 16, -1016105651);
    itemData_2 := sdv_141;
    goto anon29_Then, anon29_Else;
  ...
  L79:
    havoc Tmp_277;
    havoc Tmp_279;
    call {:si_unique_call 1012} WPP_RECORDER_SF_(Tmp_279, 0, 2, 94, Tmp_277);
    assume {:nonnull} data_3 != 0;
    assume data_3 > 0;
    havoc vslice_dummy_var_488;
    call {:si_unique_call 1013} MouseClassLogError(vslice_dummy_var_488, 327694, 2, -1073741670, 0, 0, 0);
    goto L1;
  ...
  anon29_Then:
    ...
    assume itemData_2 > 0;
    call {:si_unique_call 1014} boogieTmp := IoAllocateWorkItem(0);
    assume {:nonnull} itemData_2 != 0;
    assume itemData_2 > 0;
    goto anon25_Then, anon25_Else;
  ...
  anon25_Else:
    ...
    assume {:nonnull} itemData_2 != 0;
    assume itemData_2 > 0;
    call {:si_unique_call 1015} status_11 := sdv_IoAcquireRemoveLock(0, 0);
    goto anon26_Then, anon26_Else;
  ...
  anon26_Else:
    ...
    call {:si_unique_call 1016} IoQueueWorkItem#0(vslice_dummy_var_489, li2bplFunctionConstant1006, 1, itemData_2);
    goto anon30_Then, anon30_Else;
  ...
  anon26_Then:
    ...
    call {:si_unique_call 1017} IoFreeWorkItem(0);
...
implementation {:origName "MouseClassPoRequestComplete"} MouseClassPoRequestComplete#1(actual_DeviceObject_22: int, actual_MinorFunction_3: int, actual_structPtr888D: int, actual_Context_11: int, actual_IoStatus_2: int)
{
  ...
  anon0:
    call {:si_unique_call 1020} D := __HAVOC_malloc(8);
    call {:si_unique_call 1021} powerState_1 := __HAVOC_malloc(8);
    call {:si_unique_call 1022} vslice_dummy_var_119 := __HAVOC_malloc(4);
    call {:si_unique_call 1023} sdv_1 := __HAVOC_malloc(8);
    DeviceObject_22 := actual_DeviceObject_22;
    structPtr888D := actual_structPtr888D;
    Context_11 := actual_Context_11;
    assume {:nonnull} D != 0;
  ...
  anon27_Else:
    assume {:partition} S != 0;
    call {:si_unique_call 1024} sdv_140 := sdv_IoGetCurrentIrpStackLocation(S);
    assume {:nonnull} powerState_1 != 0;
    assume powerState_1 > 0;
    assume {:nonnull} sdv_140 != 0;
    assume sdv_140 > 0;
    ...
    assume {:nonnull} sdv_140 != 0;
    assume sdv_140 > 0;
    call {:si_unique_call 1025} SD1_2 := PoSetPowerState(0, 0, powerState_1);
    assume {:nonnull} SD1_2 != 0;
    assume SD1_2 > 0;
    assume {:nonnull} sdv_1 != 0;
    assume sdv_1 > 0;
    ...
    call {:si_unique_call 1027} sdv_IoSkipCurrentIrpStackLocation(S);
    call {:si_unique_call 1028} vslice_dummy_var_120 := PoCallDriver#1(0, S);
    goto anon28_Then, anon28_Else;
  ...
  anon28_Else:
    ...
    assume {:nonnull} data_3 != 0;
    assume data_3 > 0;
    call {:si_unique_call 1029} vslice_dummy_var_121 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(data_3), S);
    goto L1;
  ...
  anon22_Else:
    assume {:nonnull} data_3 != 0;
    assume data_3 > 0;
    call {:si_unique_call 1030} sdv_145 := _InlineInterlockedCompareExchangePointer(WaitWakeIrp__DEVICE_EXTENSION(data_3), 0, 0);
    goto anon23_Then, anon23_Else;

  anon23_Else:
    assume {:partition} sdv_145 == 0;
    call {:si_unique_call 1031} sdv_144 := MouseClassCheckWaitWakeEnabled(data_3);
    goto anon24_Then, anon24_Else;

  anon24_Else:
    assume {:partition} sdv_144 != 0;
    call {:si_unique_call 1032} sdv_141 := ExAllocatePoolWithTag(512, 16, -1016105651);
    itemData_2 := sdv_141;
    goto anon29_Then, anon29_Else;
  ...
  L79:
    havoc Tmp_277;
    havoc Tmp_279;
    call {:si_unique_call 1033} WPP_RECORDER_SF_(Tmp_279, 0, 2, 94, Tmp_277);
    assume {:nonnull} data_3 != 0;
    assume data_3 > 0;
    havoc vslice_dummy_var_490;
    call {:si_unique_call 1034} MouseClassLogError(vslice_dummy_var_490, 327694, 2, -1073741670, 0, 0, 0);
    goto L1;
  ...
  anon29_Then:
    ...
    assume {:nonnull} itemData_2 != 0;
    assume itemData_2 > 0;
    call {:si_unique_call 1035} boogieTmp := IoAllocateWorkItem(0);
    assume {:nonnull} itemData_2 != 0;
    assume itemData_2 > 0;
    goto anon25_Then, anon25_Else;
  ...
  anon25_Else:
    ...
    assume {:nonnull} itemData_2 != 0;
    assume itemData_2 > 0;
    call {:si_unique_call 1036} status_11 := sdv_IoAcquireRemoveLock(0, 0);
    goto anon26_Then, anon26_Else;
  ...
  anon26_Else:
    ...
    call {:si_unique_call 1037} IoQueueWorkItem#1(vslice_dummy_var_491, li2bplFunctionConstant1006, 1, itemData_2);
    goto anon30_Then, anon30_Else;
  ...
  anon26_Then:
    assume {:partition} 0 > status_11;
    call {:si_unique_call 1038} IoFreeWorkItem(0);
    call {:si_unique_call 1039} sdv_ExFreePool(0);
    goto L79;

  anon25_Then:
    call {:si_unique_call 1040} sdv_ExFreePool(0);
    goto L79;
...
implementation {:origName "PoCallDriver"} {:osmodel} PoCallDriver#0(actual_DeviceObject_1: int, actual_Irp: int) returns (Tmp_40: int)
{
  ...
  anon0:
    call {:si_unique_call 1041} completion := __HAVOC_malloc(4);
    Irp := actual_Irp;
    call {:si_unique_call 1042} SLIC_PoCallDriver_entry(0, Irp);
  ...
  anon56_Then:
    ...
    call {:si_unique_call 1043} vslice_dummy_var_122 := sdv_RunIoCompletionRoutines#0(sdv_p_devobj_fdo, Irp, vslice_dummy_var_492, completion);
    goto anon76_Then, anon76_Else;
  ...
  anon68_Else:
    ...
    call {:si_unique_call 1044} vslice_dummy_var_125 := sdv_RunIoCompletionRoutines#0(sdv_p_devobj_fdo, Irp, vslice_dummy_var_493, completion);
    goto anon78_Then, anon78_Else;
  ...
  anon60_Else:
    ...
    call {:si_unique_call 1045} vslice_dummy_var_123 := sdv_RunIoCompletionRoutines#0(sdv_p_devobj_fdo, Irp, vslice_dummy_var_494, completion);
    goto anon74_Then, anon74_Else;
  ...
  anon64_Else:
    ...
    call {:si_unique_call 1046} vslice_dummy_var_124 := sdv_RunIoCompletionRoutines#0(sdv_p_devobj_fdo, Irp, vslice_dummy_var_495, completion);
    goto anon72_Then, anon72_Else;
...
implementation {:origName "PoCallDriver"} {:osmodel} PoCallDriver#1(actual_DeviceObject_1: int, actual_Irp: int) returns (Tmp_40: int)
{
  ...
  anon0:
    call {:si_unique_call 1047} completion := __HAVOC_malloc(4);
    Irp := actual_Irp;
    call {:si_unique_call 1048} SLIC_PoCallDriver_entry(0, Irp);
    assume {:nonnull} completion != 0;
    assume completion > 0;
    status := 259;
    goto anon53_Then, anon53_Else;
  ...
  anon56_Then:
    ...
    call {:si_unique_call 1049} vslice_dummy_var_126 := sdv_RunIoCompletionRoutines#1(sdv_p_devobj_fdo, Irp, vslice_dummy_var_496, completion);
    goto anon76_Then, anon76_Else;
  ...
  anon68_Else:
    ...
    call {:si_unique_call 1050} vslice_dummy_var_129 := sdv_RunIoCompletionRoutines#1(sdv_p_devobj_fdo, Irp, vslice_dummy_var_497, completion);
    goto anon78_Then, anon78_Else;
  ...
  anon60_Else:
    ...
    call {:si_unique_call 1051} vslice_dummy_var_127 := sdv_RunIoCompletionRoutines#1(sdv_p_devobj_fdo, Irp, vslice_dummy_var_498, completion);
    goto anon74_Then, anon74_Else;
  ...
  anon64_Else:
    ...
    call {:si_unique_call 1052} vslice_dummy_var_128 := sdv_RunIoCompletionRoutines#1(sdv_p_devobj_fdo, Irp, vslice_dummy_var_499, completion);
    goto anon72_Then, anon72_Else;
...
implementation {:origName "sdv_RunIoCompletionRoutines"} {:osmodel} sdv_RunIoCompletionRoutines#0(actual_DeviceObject_9: int, actual_Irp_5: int, actual_Context_6: int, actual_Completion: int) returns (Tmp_135: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 1053} irpsp := sdv_IoGetNextIrpStackLocation(Irp_5);
    Status := 0;
    assume {:nonnull} irpsp != 0;
    assume irpsp > 0;
    goto anon13_Then, anon13_Else;
  ...
  anon13_Else:
    call {:si_unique_call 1054} Status := MouSyncComplete(DeviceObject_9, Irp_5, Context_6);
    assume {:nonnull} Completion != 0;
    assume Completion > 0;
    goto L11;
  ...
  anon11_Else:
    call {:si_unique_call 1055} Status := MouseClassPowerComplete#0(DeviceObject_9, Irp_5, Context_6);
    goto anon14_Then, anon14_Else;
  ...
  anon12_Else:
    call {:si_unique_call 1056} Status := MousePnpStartCompletion#0(DeviceObject_9, Irp_5, Context_6);
    goto anon15_Then, anon15_Else;
...
implementation {:origName "sdv_RunIoCompletionRoutines"} {:osmodel} sdv_RunIoCompletionRoutines#1(actual_DeviceObject_9: int, actual_Irp_5: int, actual_Context_6: int, actual_Completion: int) returns (Tmp_135: int)
{
  ...
  anon0:
    ...
    Context_6 := actual_Context_6;
    Completion := actual_Completion;
    call {:si_unique_call 1057} irpsp := sdv_IoGetNextIrpStackLocation(Irp_5);
    Status := 0;
    assume {:nonnull} irpsp != 0;
    assume irpsp > 0;
    goto anon13_Then, anon13_Else;
  ...
  anon13_Else:
    call {:si_unique_call 1058} Status := MouSyncComplete(DeviceObject_9, Irp_5, Context_6);
    assume {:nonnull} Completion != 0;
    assume Completion > 0;
    goto L11;
  ...
  anon11_Else:
    call {:si_unique_call 1059} Status := MouseClassPowerComplete#1(DeviceObject_9, Irp_5, Context_6);
    goto anon14_Then, anon14_Else;
  ...
  anon12_Else:
    call {:si_unique_call 1060} Status := MousePnpStartCompletion#1(DeviceObject_9, Irp_5, Context_6);
    goto anon15_Then, anon15_Else;
...
implementation {:origName "MouseClassPowerComplete"} MouseClassPowerComplete#0(actual_DeviceObject_18: int, actual_Irp_9: int, actual_Context_8: int) returns (Tmp_250: int)
{
  ...
  anon0:
    call {:si_unique_call 1061} powerState := __HAVOC_malloc(8);
    call {:si_unique_call 1062} sdv_2 := __HAVOC_malloc(8);
    call {:si_unique_call 1063} sdv_3 := __HAVOC_malloc(8);
    DeviceObject_18 := actual_DeviceObject_18;
    Irp_9 := actual_Irp_9;
    assume {:nonnull} DeviceObject_18 != 0;
    assume DeviceObject_18 > 0;
    havoc data_1;
    call {:si_unique_call 1064} stack_2 := sdv_IoGetCurrentIrpStackLocation(Irp_9);
  ...
  L36:
    call {:si_unique_call 1065} PoStartNextPowerIrp(0);
    assume {:nonnull} data_1 != 0;
    assume data_1 > 0;
    call {:si_unique_call 1066} vslice_dummy_var_130 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(data_1), Irp_9);
    Tmp_250 := 0;
    goto LM2;
  ...
  anon13_Then:
    ...
    assume {:nonnull} powerState != 0;
    assume powerState > 0;
    call {:si_unique_call 1067} SD3_1 := PoSetPowerState(0, powerType, powerState);
  ...
  anon11_Then:
    assume {:partition} powerType == 0;
    call {:si_unique_call 1068} SD2_1 := PoSetPowerState(0, powerType, powerState);
...
implementation {:origName "MouseClassPowerComplete"} MouseClassPowerComplete#1(actual_DeviceObject_18: int, actual_Irp_9: int, actual_Context_8: int) returns (Tmp_250: int)
{
  ...
  anon0:
    call {:si_unique_call 1069} powerState := __HAVOC_malloc(8);
    call {:si_unique_call 1070} sdv_2 := __HAVOC_malloc(8);
    call {:si_unique_call 1071} sdv_3 := __HAVOC_malloc(8);
    DeviceObject_18 := actual_DeviceObject_18;
    Irp_9 := actual_Irp_9;
    assume {:nonnull} DeviceObject_18 != 0;
    assume DeviceObject_18 > 0;
    havoc data_1;
    call {:si_unique_call 1072} stack_2 := sdv_IoGetCurrentIrpStackLocation(Irp_9);
    assume {:nonnull} stack_2 != 0;
    assume stack_2 > 0;
    havoc powerType;
    assume {:nonnull} powerState != 0;
  ...
  L36:
    ...
    assume {:nonnull} data_1 != 0;
    assume data_1 > 0;
    call {:si_unique_call 1074} vslice_dummy_var_131 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(data_1), Irp_9);
    Tmp_250 := 0;
    goto LM2;
  ...
  anon13_Then:
    ...
    assume {:nonnull} powerState != 0;
    assume powerState > 0;
    call {:si_unique_call 1075} SD3_1 := PoSetPowerState(0, powerType, powerState);
    assume {:nonnull} SD3_1 != 0;
    assume SD3_1 > 0;
    assume {:nonnull} sdv_3 != 0;
    assume sdv_3 > 0;
  ...
  anon11_Then:
    assume {:partition} powerType == 0;
    call {:si_unique_call 1076} SD2_1 := PoSetPowerState(0, powerType, powerState);
    assume {:nonnull} SD2_1 != 0;
    assume SD2_1 > 0;
    assume {:nonnull} sdv_2 != 0;
    assume sdv_2 > 0;
    ...
    call {:si_unique_call 1077} status_10 := PoRequestPowerIrp#0(vslice_dummy_var_500, 2, powerState, li2bplFunctionConstant1013, 0, 0);
    goto anon15_Then, anon15_Else;
...
implementation {:origName "MousePnpStartCompletion"} MousePnpStartCompletion#0(actual_DeviceObject_23: int, actual_Irp_12: int, actual_Context_12: int) returns (Tmp_281: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 1078} IoQueueWorkItem#0(vslice_dummy_var_501, li2bplFunctionConstant1001, 1, item);
    goto anon3_Then, anon3_Else;
...
implementation {:origName "MousePnpStartCompletion"} MousePnpStartCompletion#1(actual_DeviceObject_23: int, actual_Irp_12: int, actual_Context_12: int) returns (Tmp_281: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 1079} IoQueueWorkItem#1(vslice_dummy_var_502, li2bplFunctionConstant1001, 1, item);
    goto anon3_Then, anon3_Else;
...
implementation {:origName "MouseClassWaitWakeComplete"} MouseClassWaitWakeComplete#0(actual_DeviceObject_33: int, actual_MinorFunction_4: int, actual_structPtr888PowerState: int, actual_Context_16: int, actual_IoStatus_3: int)
{
  ...
  anon0:
    call {:si_unique_call 1080} PowerState := __HAVOC_malloc(8);
    call {:si_unique_call 1081} powerState_4 := __HAVOC_malloc(8);
    call {:si_unique_call 1082} vslice_dummy_var_132 := __HAVOC_malloc(4);
    ...
    assume data_7 > 0;
    call {:si_unique_call 1083} sdv_236 := _InlineInterlockedExchangePointer(ExtraWaitWakeIrp__DEVICE_EXTENSION(data_7), 0);
    goto anon21_Then, anon21_Else;
  ...
  L14:
    assume {:nonnull} data_7 != 0;
    assume data_7 > 0;
    call {:si_unique_call 1084} sdv_239 := _InlineInterlockedExchangePointer(ExtraWWIrpTag__DEVICE_EXTENSION(data_7), 0);
    Irp_25 := sdv_239;
    goto anon28_Then, anon28_Else;
  ...
  L27:
    ...
    call {:si_unique_call 1085} WPP_RECORDER_SF_qd(Tmp_464, 0, 3, 90, Tmp_466, Irp_25, vslice_dummy_var_503);
    assume {:nonnull} IoStatus_3 != 0;
    assume IoStatus_3 > 0;
    goto anon22_Then, anon22_Else;
  ...
  anon23_Else:
    havoc Tmp_465;
    havoc Tmp_467;
    call {:si_unique_call 1086} WPP_RECORDER_SF_(Tmp_467, 0, 2, 91, Tmp_465);
  ...
  anon23_Then:
    call {:si_unique_call 1087} vslice_dummy_var_134 := MouseToggleWaitWake#0(data_7, 0);
    goto anon30_Then, anon30_Else;
  ...
  L49:
    assume {:nonnull} data_7 != 0;
    assume data_7 > 0;
    call {:si_unique_call 1088} vslice_dummy_var_135 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(data_7), Irp_25);
    goto LM2;
  ...
  anon28_Then:
    ...
    assume {:nonnull} data_7 != 0;
    assume data_7 > 0;
    call {:si_unique_call 1089} sdv_241 := _InlineInterlockedExchangePointer(WWIrpTag__DEVICE_EXTENSION(data_7), 0);
    Irp_25 := sdv_241;
    goto L27;
  ...
  anon21_Then:
    ...
    assume {:nonnull} data_7 != 0;
    assume data_7 > 0;
    call {:si_unique_call 1090} vslice_dummy_var_133 := _InlineInterlockedExchangePointer(WaitWakeIrp__DEVICE_EXTENSION(data_7), 0);
    goto L14;
}
...
implementation {:origName "MouseClassWaitWakeComplete"} MouseClassWaitWakeComplete#1(actual_DeviceObject_33: int, actual_MinorFunction_4: int, actual_structPtr888PowerState: int, actual_Context_16: int, actual_IoStatus_3: int)
{
  ...
  anon0:
    call {:si_unique_call 1091} PowerState := __HAVOC_malloc(8);
    call {:si_unique_call 1092} powerState_4 := __HAVOC_malloc(8);
    call {:si_unique_call 1093} vslice_dummy_var_136 := __HAVOC_malloc(4);
    structPtr888PowerState := actual_structPtr888PowerState;
    Context_16 := actual_Context_16;
    IoStatus_3 := actual_IoStatus_3;
    assume {:nonnull} PowerState != 0;
    ...
    assume {:nonnull} data_7 != 0;
    assume data_7 > 0;
    call {:si_unique_call 1094} sdv_236 := _InlineInterlockedExchangePointer(ExtraWaitWakeIrp__DEVICE_EXTENSION(data_7), 0);
    goto anon21_Then, anon21_Else;
  ...
  L14:
    assume {:nonnull} data_7 != 0;
    assume data_7 > 0;
    call {:si_unique_call 1095} sdv_239 := _InlineInterlockedExchangePointer(ExtraWWIrpTag__DEVICE_EXTENSION(data_7), 0);
    Irp_25 := sdv_239;
    goto anon28_Then, anon28_Else;
  ...
  L27:
    ...
    call {:si_unique_call 1096} WPP_RECORDER_SF_qd(Tmp_464, 0, 3, 90, Tmp_466, Irp_25, vslice_dummy_var_504);
    assume {:nonnull} IoStatus_3 != 0;
    assume IoStatus_3 > 0;
    goto anon22_Then, anon22_Else;
  ...
  anon23_Else:
    havoc Tmp_465;
    havoc Tmp_467;
    call {:si_unique_call 1097} WPP_RECORDER_SF_(Tmp_467, 0, 2, 91, Tmp_465);
    assume {:nonnull} powerState_4 != 0;
    assume powerState_4 > 0;
    assume {:nonnull} data_7 != 0;
    assume data_7 > 0;
    havoc vslice_dummy_var_505;
    call {:si_unique_call 1098} vslice_dummy_var_140 := PoRequestPowerIrp#0(vslice_dummy_var_505, 2, powerState_4, li2bplFunctionConstant1005, Context_16, 0);
    goto anon29_Then, anon29_Else;
  ...
  L49:
    assume {:nonnull} data_7 != 0;
    assume data_7 > 0;
    call {:si_unique_call 1099} vslice_dummy_var_139 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(data_7), Irp_25);
    goto LM2;
  ...
  anon23_Then:
    call {:si_unique_call 1100} vslice_dummy_var_138 := MouseToggleWaitWake#1(data_7, 0);
    goto anon30_Then, anon30_Else;
  ...
  anon28_Then:
    ...
    assume {:nonnull} data_7 != 0;
    assume data_7 > 0;
    call {:si_unique_call 1101} sdv_241 := _InlineInterlockedExchangePointer(WWIrpTag__DEVICE_EXTENSION(data_7), 0);
    Irp_25 := sdv_241;
    goto L27;
  ...
  anon21_Then:
    ...
    assume {:nonnull} data_7 != 0;
    assume data_7 > 0;
    call {:si_unique_call 1102} vslice_dummy_var_137 := _InlineInterlockedExchangePointer(WaitWakeIrp__DEVICE_EXTENSION(data_7), 0);
    goto L14;
}
...
implementation {:origName "MouseToggleWaitWake"} MouseToggleWaitWake#0(actual_Data_2: int, actual_WaitWakeState: int) returns (Tmp_222: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 1103} status_8 := sdv_IoAcquireRemoveLock(0, 0);
    goto anon13_Then, anon13_Else;

  anon13_Else:
    assume {:partition} status_8 >= 0;
    call {:si_unique_call 1104} sdv_116 := ExAllocatePoolWithTag(512, 16, -1016105651);
    itemData_1 := sdv_116;
    goto anon16_Then, anon16_Else;
  ...
  anon16_Else:
    ...
    assume {:nonnull} itemData_1 != 0;
    assume itemData_1 > 0;
    call {:si_unique_call 1105} boogieTmp := IoAllocateWorkItem(0);
    assume {:nonnull} itemData_1 != 0;
    assume itemData_1 > 0;
    goto anon14_Then, anon14_Else;
  ...
  anon14_Else:
    ...
    assume {:nonnull} itemData_1 != 0;
    assume itemData_1 > 0;
    call {:si_unique_call 1106} sdv_118 := sdv_KeGetCurrentIrql();
    goto anon15_Then, anon15_Else;
  ...
  anon15_Else:
    ...
    call {:si_unique_call 1107} IoQueueWorkItem#0(vslice_dummy_var_506, li2bplFunctionConstant1010, 1, itemData_1);
    goto anon17_Then, anon17_Else;
  ...
  anon15_Then:
    ...
    call {:si_unique_call 1108} MouseToggleWaitWakeWorker#0(vslice_dummy_var_507, itemData_1);
    goto anon18_Then, anon18_Else;
  ...
  anon14_Then:
    assume {:nonnull} Data_2 != 0;
    assume Data_2 > 0;
    call {:si_unique_call 1109} vslice_dummy_var_142 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(Data_2), li2bplFunctionConstant1010);
  ...
  anon16_Then:
    ...
    assume {:nonnull} Data_2 != 0;
    assume Data_2 > 0;
    call {:si_unique_call 1111} vslice_dummy_var_141 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(Data_2), li2bplFunctionConstant1010);
    goto L39;
...
implementation {:origName "MouseToggleWaitWake"} MouseToggleWaitWake#1(actual_Data_2: int, actual_WaitWakeState: int) returns (Tmp_222: int)
{
  ...
  anon0:
    Data_2 := actual_Data_2;
    WaitWakeState := actual_WaitWakeState;
    call {:si_unique_call 1112} status_8 := sdv_IoAcquireRemoveLock(0, 0);
    goto anon13_Then, anon13_Else;

  anon13_Else:
    assume {:partition} status_8 >= 0;
    call {:si_unique_call 1113} sdv_116 := ExAllocatePoolWithTag(512, 16, -1016105651);
    itemData_1 := sdv_116;
    goto anon16_Then, anon16_Else;
  ...
  anon16_Else:
    ...
    assume {:nonnull} itemData_1 != 0;
    assume itemData_1 > 0;
    call {:si_unique_call 1114} boogieTmp := IoAllocateWorkItem(0);
    assume {:nonnull} itemData_1 != 0;
    assume itemData_1 > 0;
    goto anon14_Then, anon14_Else;
  ...
  anon14_Else:
    ...
    assume {:nonnull} itemData_1 != 0;
    assume itemData_1 > 0;
    call {:si_unique_call 1115} sdv_118 := sdv_KeGetCurrentIrql();
    goto anon15_Then, anon15_Else;
  ...
  anon15_Else:
    ...
    call {:si_unique_call 1116} IoQueueWorkItem#1(vslice_dummy_var_508, li2bplFunctionConstant1010, 1, itemData_1);
    goto anon17_Then, anon17_Else;
  ...
  anon15_Then:
    ...
    call {:si_unique_call 1117} MouseToggleWaitWakeWorker#1(vslice_dummy_var_509, itemData_1);
    goto anon18_Then, anon18_Else;
  ...
  anon14_Then:
    assume {:nonnull} Data_2 != 0;
    assume Data_2 > 0;
    call {:si_unique_call 1118} vslice_dummy_var_144 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(Data_2), li2bplFunctionConstant1010);
  ...
  anon16_Then:
    ...
    assume {:nonnull} Data_2 != 0;
    assume Data_2 > 0;
    call {:si_unique_call 1120} vslice_dummy_var_143 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(Data_2), li2bplFunctionConstant1010);
    goto L39;
...
implementation {:origName "MouseToggleWaitWakeWorker"} MouseToggleWaitWakeWorker#0(actual_DeviceObject_21: int, actual_Context_10: int)
{
  ...
  anon0:
    call {:si_unique_call 1121} strEnable := __HAVOC_malloc(12);
    call {:si_unique_call 1122} vslice_dummy_var_145 := __HAVOC_malloc(4);
    Context_10 := actual_Context_10;
    call {:si_unique_call 1123} Tmp_262 := __HAVOC_malloc(64);
    waitWakeIrp_1 := 0;
    toggled := 0;
    ItemData := Context_10;
    assume {:nonnull} ItemData != 0;
  ...
  L15:
    ...
    assume ItemData > 0;
    havoc data_2;
    call {:si_unique_call 1124} Tmp_264 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_264 != 0;
    assume Tmp_264 > 0;
    call {:si_unique_call 1125} sdv_KeAcquireSpinLock(0, Tmp_264);
    assume {:nonnull} Tmp_264 != 0;
    assume Tmp_264 > 0;
    havoc irql_2;
    assume {:nonnull} data_2 != 0;
  ...
  anon26_Else:
    assume {:nonnull} data_2 != 0;
    assume data_2 > 0;
    call {:si_unique_call 1126} sdv_132 := _InlineInterlockedExchangePointer(WaitWakeIrp__DEVICE_EXTENSION(data_2), 0);
    waitWakeIrp_1 := sdv_132;
    goto L26;
  ...
  L21:
    call {:si_unique_call 1127} sdv_KeReleaseSpinLock(0, irql_2);
    goto anon20_Then, anon20_Else;

  anon20_Else:
    assume {:partition} toggled != 0;
    call {:si_unique_call 1128} sdv_134 := IoOpenDeviceRegistryKey(0, 1, 2031616, 0);
    goto anon22_Then, anon22_Else;

  anon22_Else:
    assume {:partition} sdv_134 >= 0;
    Tmp_262 := strConst__li2bpl2;
    call {:si_unique_call 1129} RtlInitUnicodeString(strEnable, Tmp_262);
    call {:si_unique_call 1130} vslice_dummy_var_146 := ZwSetValueKey(0, 0, 0, 4, 0, 4);
    call {:si_unique_call 1131} vslice_dummy_var_147 := ZwClose(0);
    goto L32;
  ...
  anon23_Else:
    ...
    call {:si_unique_call 1132} vslice_dummy_var_149 := IoCancelIrp(0);
    goto L55;

  L55:
    assume {:nonnull} data_2 != 0;
    assume data_2 > 0;
    call {:si_unique_call 1133} vslice_dummy_var_148 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(data_2), li2bplFunctionConstant1010);
    call {:si_unique_call 1134} IoFreeWorkItem(0);
...
implementation {:origName "MouseToggleWaitWakeWorker"} MouseToggleWaitWakeWorker#1(actual_DeviceObject_21: int, actual_Context_10: int)
{
  ...
  anon0:
    call {:si_unique_call 1136} strEnable := __HAVOC_malloc(12);
    call {:si_unique_call 1137} vslice_dummy_var_150 := __HAVOC_malloc(4);
    Context_10 := actual_Context_10;
    call {:si_unique_call 1138} Tmp_262 := __HAVOC_malloc(64);
    waitWakeIrp_1 := 0;
    toggled := 0;
    ItemData := Context_10;
    assume {:nonnull} ItemData != 0;
  ...
  L15:
    ...
    assume ItemData > 0;
    havoc data_2;
    call {:si_unique_call 1139} Tmp_264 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_264 != 0;
    assume Tmp_264 > 0;
    call {:si_unique_call 1140} sdv_KeAcquireSpinLock(0, Tmp_264);
    assume {:nonnull} Tmp_264 != 0;
    assume Tmp_264 > 0;
    havoc irql_2;
    assume {:nonnull} data_2 != 0;
  ...
  anon26_Else:
    assume {:nonnull} data_2 != 0;
    assume data_2 > 0;
    call {:si_unique_call 1141} sdv_132 := _InlineInterlockedExchangePointer(WaitWakeIrp__DEVICE_EXTENSION(data_2), 0);
    waitWakeIrp_1 := sdv_132;
    goto L26;
  ...
  L21:
    call {:si_unique_call 1142} sdv_KeReleaseSpinLock(0, irql_2);
    goto anon20_Then, anon20_Else;

  anon20_Else:
    assume {:partition} toggled != 0;
    call {:si_unique_call 1143} sdv_134 := IoOpenDeviceRegistryKey(0, 1, 2031616, 0);
    goto anon22_Then, anon22_Else;

  anon22_Else:
    assume {:partition} sdv_134 >= 0;
    Tmp_262 := strConst__li2bpl2;
    call {:si_unique_call 1144} RtlInitUnicodeString(strEnable, Tmp_262);
    call {:si_unique_call 1145} vslice_dummy_var_151 := ZwSetValueKey(0, 0, 0, 4, 0, 4);
    call {:si_unique_call 1146} vslice_dummy_var_152 := ZwClose(0);
    goto L32;
  ...
  anon24_Else:
    assume {:partition} wwState != 0;
    call {:si_unique_call 1147} vslice_dummy_var_153 := MouseClassCreateWaitWakeIrp#0(data_2);
    goto anon27_Then, anon27_Else;
  ...
  anon23_Else:
    assume {:partition} waitWakeIrp_1 != 0;
    call {:si_unique_call 1148} vslice_dummy_var_155 := IoCancelIrp(0);
    goto L55;

  L55:
    assume {:nonnull} data_2 != 0;
    assume data_2 > 0;
    call {:si_unique_call 1149} vslice_dummy_var_154 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(data_2), li2bplFunctionConstant1010);
    call {:si_unique_call 1150} IoFreeWorkItem(0);
...
implementation {:origName "MouseStartWorker"} MouseStartWorker#0(actual_DeviceObject_26: int, actual_Context_14: int)
{
  ...
  anon0:
    call {:si_unique_call 1152} vslice_dummy_var_156 := __HAVOC_malloc(4);
    ...
    havoc devExt;
    call {:si_unique_call 1153} status_14 := MouseStart#0(DeviceObject_26, item_1);
    goto anon3_Then, anon3_Else;
  ...
  anon3_Else:
    ...
    assume devExt > 0;
    call {:si_unique_call 1157} vslice_dummy_var_157 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(devExt), li2bplFunctionConstant1001);
    goto LM2;
...
implementation {:origName "MouseStartWorker"} MouseStartWorker#1(actual_DeviceObject_26: int, actual_Context_14: int)
{
  ...
  anon0:
    ...
    assume DeviceObject_26 > 0;
    havoc devExt;
    call {:si_unique_call 1159} status_14 := MouseStart#1(DeviceObject_26, item_1);
    goto anon3_Then, anon3_Else;
  ...
  anon3_Else:
    ...
    assume {:nonnull} devExt != 0;
    assume devExt > 0;
    call {:si_unique_call 1163} vslice_dummy_var_159 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(devExt), li2bplFunctionConstant1001);
    goto LM2;
...
implementation {:origName "MouseStart"} MouseStart#0(actual_DeviceObject_29: int, actual_item_2: int) returns (Tmp_398: int)
{
  ...
  anon44_Else:
    ...
    assume {:nonnull} devCaps != 0;
    assume devCaps > 0;
    call {:si_unique_call 1166} stack_5 := sdv_IoGetNextIrpStackLocation(Irp_21);
    ...
    call {:si_unique_call 1167} status_20 := MouseSendIrpSynchronously#0(vslice_dummy_var_510, Irp_21, 0);
    goto anon45_Then, anon45_Else;
  ...
  L57:
    ...
    assume {:nonnull} data_5 != 0;
    assume data_5 > 0;
    call {:si_unique_call 1170} vslice_dummy_var_160 := IoWMIRegistrationControl(0, 1);
  ...
  anon40_Else:
    assume {:nonnull} data_5 != 0;
    assume data_5 > 0;
    call {:si_unique_call 1173} sdv_205 := _InlineInterlockedCompareExchangePointer(WaitWakeIrp__DEVICE_EXTENSION(data_5), 0, 0);
    goto anon41_Then, anon41_Else;

  anon41_Else:
    assume {:partition} sdv_205 == 0;
    call {:si_unique_call 1174} sdv_201 := MouseClassCheckWaitWakeEnabled(data_5);
    goto anon42_Then, anon42_Else;
  ...
  anon38_Then:
    assume {:partition} enabled_3 == 0;
    call {:si_unique_call 1175} status_20 := MouEnableDisablePort#0(1, 0, data_5, file);
    goto anon48_Then, anon48_Else;
  ...
  anon37_Then:
    call {:si_unique_call 1176} ExReleaseFastMutex(0);
    goto L89;

  anon36_Then:
    call {:si_unique_call 1177} ExReleaseFastMutex(0);
    call {:si_unique_call 1178} status_20 := IoSetDeviceInterfaceState(0, 1);
    goto L89;
...
implementation {:origName "MouseStart"} MouseStart#1(actual_DeviceObject_29: int, actual_item_2: int) returns (Tmp_398: int)
{
  ...
  anon0:
    call {:si_unique_call 1179} devCaps := __HAVOC_malloc(124);
    DeviceObject_29 := actual_DeviceObject_29;
    item_2 := actual_item_2;
    assume {:nonnull} item_2 != 0;
    assume item_2 > 0;
  ...
  anon44_Else:
    ...
    assume {:nonnull} Irp_21 != 0;
    assume Irp_21 > 0;
    call {:si_unique_call 1180} sdv_RtlZeroMemory(0, 64);
    assume {:nonnull} devCaps != 0;
    assume devCaps > 0;
    assume {:nonnull} devCaps != 0;
    assume devCaps > 0;
    ...
    assume {:nonnull} devCaps != 0;
    assume devCaps > 0;
    call {:si_unique_call 1181} stack_5 := sdv_IoGetNextIrpStackLocation(Irp_21);
    assume {:nonnull} stack_5 != 0;
    assume stack_5 > 0;
    assume {:nonnull} stack_5 != 0;
    assume stack_5 > 0;
    ...
    call {:si_unique_call 1182} status_20 := MouseSendIrpSynchronously#1(vslice_dummy_var_511, Irp_21, 0);
    goto anon45_Then, anon45_Else;
  ...
  anon34_Else:
    ...
    assume {:nonnull} devCaps != 0;
    assume devCaps > 0;
    call {:si_unique_call 1183} sdv_RtlCopyMemory(0, 0, 20);
    goto L40;
  ...
  anon35_Else:
    assume {:nonnull} data_5 != 0;
    assume data_5 > 0;
    call {:si_unique_call 1184} MouseClassGetWaitWakeEnableState(data_5);
    goto L57;
  ...
  L57:
    ...
    assume {:nonnull} data_5 != 0;
    assume data_5 > 0;
    call {:si_unique_call 1185} vslice_dummy_var_162 := IoWMIRegistrationControl(0, 1);
    call {:si_unique_call 1186} ExAcquireFastMutex(0);
    goto anon36_Then, anon36_Else;
  ...
  anon37_Else:
    ...
    assume {:nonnull} port_3 != 0;
    assume port_3 > 0;
    call {:si_unique_call 1187} ExReleaseFastMutex(0);
    goto anon38_Then, anon38_Else;
  ...
  anon40_Else:
    assume {:nonnull} data_5 != 0;
    assume data_5 > 0;
    call {:si_unique_call 1188} sdv_205 := _InlineInterlockedCompareExchangePointer(WaitWakeIrp__DEVICE_EXTENSION(data_5), 0, 0);
    goto anon41_Then, anon41_Else;

  anon41_Else:
    assume {:partition} sdv_205 == 0;
    call {:si_unique_call 1189} sdv_201 := MouseClassCheckWaitWakeEnabled(data_5);
    goto anon42_Then, anon42_Else;

  anon42_Else:
    assume {:partition} sdv_201 != 0;
    call {:si_unique_call 1190} vslice_dummy_var_161 := MouseClassCreateWaitWakeIrp#0(data_5);
    goto anon47_Then, anon47_Else;
  ...
  anon38_Then:
    assume {:partition} enabled_3 == 0;
    call {:si_unique_call 1191} status_20 := MouEnableDisablePort#1(1, 0, data_5, file);
    goto anon48_Then, anon48_Else;
  ...
  anon36_Then:
    ...
    call {:si_unique_call 1194} status_20 := IoSetDeviceInterfaceState(0, 1);
    goto L89;
...
implementation {:origName "MouEnableDisablePort"} MouEnableDisablePort#0(actual_EnableFlag: int, actual_Irp_15: int, actual_Port: int, actual_File: int) returns (Tmp_309: int)
{
  ...
  anon0:
    call {:si_unique_call 1195} name := __HAVOC_malloc(12);
    call {:si_unique_call 1196} device := __HAVOC_malloc(4);
    ...
    havoc Tmp_315;
    havoc Tmp_312;
    call {:si_unique_call 1198} WPP_RECORDER_SF_(Tmp_312, 0, 3, 82, Tmp_315);
    assume {:nonnull} Port != 0;
    assume Port > 0;
    goto anon23_Then, anon23_Else;
  ...
  anon25_Else:
    call {:si_unique_call 1199} sdv_IoCopyCurrentIrpStackLocationToNext(Irp_15);
    call {:si_unique_call 1200} stack_3 := sdv_IoGetNextIrpStackLocation(Irp_15);
    goto anon26_Then, anon26_Else;
  ...
  L40:
    ...
    call {:si_unique_call 1201} status_13 := MouseSendIrpSynchronously#0(vslice_dummy_var_512, Irp_15, 0);
    goto anon30_Then, anon30_Else;
  ...
  L49:
    havoc Tmp_310;
    havoc Tmp_316;
    call {:si_unique_call 1202} WPP_RECORDER_SF_(Tmp_316, 0, 3, 83, Tmp_310);
    Tmp_309 := status_13;
    goto L1;
  ...
  anon28_Else:
    assume {:partition} EnableFlag != 0;
    bufferLength := 0;
    call {:si_unique_call 1203} Tmp_313 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_313 != 0;
    assume Tmp_313 > 0;
    call {:si_unique_call 1204} status_13 := IoGetDeviceProperty(0, 4107, bufferLength, 0, Tmp_313);
    assume {:nonnull} Tmp_313 != 0;
    assume Tmp_313 > 0;
    havoc bufferLength;
    call {:si_unique_call 1205} sdv_160 := ExAllocatePoolWithTag(1, bufferLength, -1016105651);
    buffer := sdv_160;
    goto anon31_Then, anon31_Else;

  anon31_Else:
    assume {:partition} buffer != 0;
    call {:si_unique_call 1206} Tmp_313 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_313 != 0;
    assume Tmp_313 > 0;
    call {:si_unique_call 1207} vslice_dummy_var_164 := IoGetDeviceProperty(0, 4107, bufferLength, 0, Tmp_313);
    assume {:nonnull} Tmp_313 != 0;
    assume Tmp_313 > 0;
    havoc bufferLength;
    assume {:nonnull} name != 0;
    ...
    assume {:nonnull} name != 0;
    assume name > 0;
    call {:si_unique_call 1208} status_13 := IoGetDeviceObjectPointer(0, 2032127, 0, device);
  ...
  anon29_Else:
    ...
    assume {:nonnull} Port != 0;
    assume Port > 0;
    call {:si_unique_call 1210} status_13 := IoRegisterPlugPlayNotification(3, 0, 0, 0, li2bplFunctionConstant992, 0, 0);
    goto L49;
  ...
  anon28_Then:
    assume {:partition} EnableFlag == 0;
    call {:si_unique_call 1211} vslice_dummy_var_163 := sdv_ObDereferenceObject(0);
  ...
  anon24_Then:
    assume {:nonnull} Port != 0;
    assume Port > 0;
    call {:si_unique_call 1212} sdv_IoCopyCurrentIrpStackLocationToNext(Irp_15);
    call {:si_unique_call 1213} stack_3 := sdv_IoGetNextIrpStackLocation(Irp_15);
    assume {:nonnull} stack_3 != 0;
    assume stack_3 > 0;
    assume {:nonnull} stack_3 != 0;
    assume stack_3 > 0;
  ...
  L102:
    ...
    call {:si_unique_call 1214} status_13 := MouseSendIrpSynchronously#0(vslice_dummy_var_513, Irp_15, 0);
    goto anon33_Then, anon33_Else;
...
implementation {:origName "MouEnableDisablePort"} MouEnableDisablePort#1(actual_EnableFlag: int, actual_Irp_15: int, actual_Port: int, actual_File: int) returns (Tmp_309: int)
{
  ...
  anon0:
    call {:si_unique_call 1215} name := __HAVOC_malloc(12);
    call {:si_unique_call 1216} device := __HAVOC_malloc(4);
    EnableFlag := actual_EnableFlag;
    Irp_15 := actual_Irp_15;
    Port := actual_Port;
    File := actual_File;
    ...
    havoc Tmp_315;
    havoc Tmp_312;
    call {:si_unique_call 1218} WPP_RECORDER_SF_(Tmp_312, 0, 3, 82, Tmp_315);
    assume {:nonnull} Port != 0;
    assume Port > 0;
    goto anon23_Then, anon23_Else;
  ...
  anon25_Else:
    call {:si_unique_call 1219} sdv_IoCopyCurrentIrpStackLocationToNext(Irp_15);
    call {:si_unique_call 1220} stack_3 := sdv_IoGetNextIrpStackLocation(Irp_15);
    goto anon26_Then, anon26_Else;
  ...
  L40:
    ...
    call {:si_unique_call 1221} status_13 := MouseSendIrpSynchronously#1(vslice_dummy_var_514, Irp_15, 0);
    goto anon30_Then, anon30_Else;
  ...
  L49:
    havoc Tmp_310;
    havoc Tmp_316;
    call {:si_unique_call 1222} WPP_RECORDER_SF_(Tmp_316, 0, 3, 83, Tmp_310);
    Tmp_309 := status_13;
    goto L1;
  ...
  anon28_Else:
    assume {:partition} EnableFlag != 0;
    bufferLength := 0;
    call {:si_unique_call 1223} Tmp_313 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_313 != 0;
    assume Tmp_313 > 0;
    call {:si_unique_call 1224} status_13 := IoGetDeviceProperty(0, 4107, bufferLength, 0, Tmp_313);
    assume {:nonnull} Tmp_313 != 0;
    assume Tmp_313 > 0;
    havoc bufferLength;
    call {:si_unique_call 1225} sdv_160 := ExAllocatePoolWithTag(1, bufferLength, -1016105651);
    buffer := sdv_160;
    goto anon31_Then, anon31_Else;

  anon31_Else:
    assume {:partition} buffer != 0;
    call {:si_unique_call 1226} Tmp_313 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_313 != 0;
    assume Tmp_313 > 0;
    call {:si_unique_call 1227} vslice_dummy_var_166 := IoGetDeviceProperty(0, 4107, bufferLength, 0, Tmp_313);
    assume {:nonnull} Tmp_313 != 0;
    assume Tmp_313 > 0;
    havoc bufferLength;
    assume {:nonnull} name != 0;
    ...
    assume {:nonnull} name != 0;
    assume name > 0;
    call {:si_unique_call 1228} status_13 := IoGetDeviceObjectPointer(0, 2032127, 0, device);
  ...
  anon29_Else:
    ...
    assume {:nonnull} Port != 0;
    assume Port > 0;
    call {:si_unique_call 1230} status_13 := IoRegisterPlugPlayNotification(3, 0, 0, 0, li2bplFunctionConstant992, 0, 0);
    goto L49;
  ...
  anon28_Then:
    assume {:partition} EnableFlag == 0;
    call {:si_unique_call 1231} vslice_dummy_var_165 := sdv_ObDereferenceObject(0);
    assume {:nonnull} File != 0;
    assume File > 0;
    goto L49;
  ...
  anon24_Then:
    assume {:nonnull} Port != 0;
    assume Port > 0;
    call {:si_unique_call 1232} sdv_IoCopyCurrentIrpStackLocationToNext(Irp_15);
    call {:si_unique_call 1233} stack_3 := sdv_IoGetNextIrpStackLocation(Irp_15);
    assume {:nonnull} stack_3 != 0;
    assume stack_3 > 0;
    assume {:nonnull} stack_3 != 0;
    assume stack_3 > 0;
  ...
  L102:
    ...
    call {:si_unique_call 1234} status_13 := MouseSendIrpSynchronously#1(vslice_dummy_var_515, Irp_15, 0);
    goto anon33_Then, anon33_Else;
...
implementation {:origName "MouseSendIrpSynchronously"} MouseSendIrpSynchronously#0(actual_DeviceObject_27: int, actual_Irp_17: int, actual_CopyToNext: int) returns (Tmp_338: int)
{
  ...
  anon0:
    call {:si_unique_call 1235} event := __HAVOC_malloc(156);
    ...
    call {:si_unique_call 1237} SLIC_KeInitializeEvent_entry(0, 0);
    call {:si_unique_call 1238} KeInitializeEvent(event, 1, 0);
    goto anon9_Then, anon9_Else;

  anon9_Else:
    assume {:partition} CopyToNext != 0;
    call {:si_unique_call 1239} sdv_IoCopyCurrentIrpStackLocationToNext(Irp_17);
    goto L12;

  L12:
    call {:si_unique_call 1240} sdv_IoSetCompletionRoutine(Irp_17, li2bplFunctionConstant981, event, 1, 1, 1);
    call {:si_unique_call 1241} vslice_dummy_var_167 := sdv_IoCallDriver#0(DeviceObject_27, Irp_17);
    goto anon11_Then, anon11_Else;
  ...
  anon10_Else:
    ...
    assume SLAM_guard_O_0 != SLAM_guard_O_0_init;
    call {:si_unique_call 1242} SLIC_KeWaitForSingleObject_entry(strConst__li2bpl3, 0);
    goto anon12_Then, anon12_Else;
  ...
  L29:
    call {:si_unique_call 1243} vslice_dummy_var_168 := KeWaitForSingleObject(0, 0, 0, 0, 0);
...
implementation {:origName "MouseSendIrpSynchronously"} MouseSendIrpSynchronously#1(actual_DeviceObject_27: int, actual_Irp_17: int, actual_CopyToNext: int) returns (Tmp_338: int)
{
  ...
  anon0:
    call {:si_unique_call 1244} event := __HAVOC_malloc(156);
    DeviceObject_27 := actual_DeviceObject_27;
    Irp_17 := actual_Irp_17;
    CopyToNext := actual_CopyToNext;
    ...
    SLAM_guard_O_0 := event;
    assume SLAM_guard_O_0 != SLAM_guard_O_0_init;
    call {:si_unique_call 1246} SLIC_KeInitializeEvent_entry(0, 0);
    call {:si_unique_call 1247} KeInitializeEvent(event, 1, 0);
    goto anon9_Then, anon9_Else;

  anon9_Else:
    assume {:partition} CopyToNext != 0;
    call {:si_unique_call 1248} sdv_IoCopyCurrentIrpStackLocationToNext(Irp_17);
    goto L12;

  L12:
    call {:si_unique_call 1249} sdv_IoSetCompletionRoutine(Irp_17, li2bplFunctionConstant981, event, 1, 1, 1);
    call {:si_unique_call 1250} vslice_dummy_var_169 := sdv_IoCallDriver#1(DeviceObject_27, Irp_17);
    goto anon11_Then, anon11_Else;
  ...
  anon10_Else:
    assume event == SLAM_guard_O_0;
    assume SLAM_guard_O_0 != SLAM_guard_O_0_init;
    call {:si_unique_call 1251} SLIC_KeWaitForSingleObject_entry(strConst__li2bpl3, 0);
    goto anon12_Then, anon12_Else;
  ...
  L29:
    call {:si_unique_call 1252} vslice_dummy_var_170 := KeWaitForSingleObject(0, 0, 0, 0, 0);
    assume {:nonnull} Irp_17 != 0;
    assume Irp_17 > 0;
    havoc status_16;
    Tmp_338 := status_16;
...
implementation {:origName "sdv_IoCallDriver"} {:osmodel} sdv_IoCallDriver#0(actual_DeviceObject_10: int, actual_Irp_6: int) returns (Tmp_139: int)
{
  ...
  anon0:
    Irp_6 := actual_Irp_6;
    call {:si_unique_call 1253} SLIC_sdv_IoCallDriver_entry(0, Irp_6);
    call {:si_unique_call 1254} Tmp_139 := IofCallDriver#0(0, Irp_6);
    goto anon3_Then, anon3_Else;
...
procedure {:origName "sdv_IoCallDriver"} {:osmodel} sdv_IoCallDriver#0(actual_DeviceObject_10: int, actual_Irp_6: int) returns (Tmp_139: int);
  modifies signal_location, alloc;
  free ensures {:va_keep} old(signal_location) == 0 ==> signal_location != 1;
  free ensures {:va_keep} signal_location == 0 || signal_location == old(signal_location);
...
implementation {:origName "sdv_IoCallDriver"} {:osmodel} sdv_IoCallDriver#1(actual_DeviceObject_10: int, actual_Irp_6: int) returns (Tmp_139: int)
{
  ...
  anon0:
    Irp_6 := actual_Irp_6;
    call {:si_unique_call 1255} SLIC_sdv_IoCallDriver_entry(0, Irp_6);
    call {:si_unique_call 1256} Tmp_139 := IofCallDriver#1(0, Irp_6);
    goto anon3_Then, anon3_Else;
...
procedure {:origName "sdv_IoCallDriver"} {:osmodel} sdv_IoCallDriver#1(actual_DeviceObject_10: int, actual_Irp_6: int) returns (Tmp_139: int);
  modifies signal_location, alloc, SLAM_guard_O_0, SignalState, sdv_compFset, sdv_invoke_on_success, sdv_invoke_on_error, sdv_invoke_on_cancel, yogi_error;
  free ensures {:va_keep} old(SignalState) == 0 ==> SignalState != 2;
  free ensures {:va_keep} yogi_error == 1 || yogi_error == old(yogi_error);
  free ensures {:va_keep} SignalState == 0 || SignalState == old(SignalState);
  free ensures {:va_keep} signal_location == 0 || signal_location == 1 || signal_location == old(signal_location);
...
implementation {:origName "IofCallDriver"} {:osmodel} IofCallDriver#0(actual_DeviceObject_8: int, actual_Irp_4: int) returns (Tmp_133: int)
{
  ...
  anon0:
    call {:si_unique_call 1257} completion_1 := __HAVOC_malloc(4);
    Irp_4 := actual_Irp_4;
...
implementation {:origName "IofCallDriver"} {:osmodel} IofCallDriver#1(actual_DeviceObject_8: int, actual_Irp_4: int) returns (Tmp_133: int)
{
  ...
  anon55_Then:
    ...
    call {:si_unique_call 1259} vslice_dummy_var_171 := sdv_RunIoCompletionRoutines#0(sdv_p_devobj_fdo, Irp_4, vslice_dummy_var_516, completion_1);
    goto anon76_Then, anon76_Else;
  ...
  anon67_Else:
    ...
    call {:si_unique_call 1260} vslice_dummy_var_174 := sdv_RunIoCompletionRoutines#0(sdv_p_devobj_fdo, Irp_4, vslice_dummy_var_517, completion_1);
    goto anon78_Then, anon78_Else;
  ...
  anon59_Else:
    ...
    call {:si_unique_call 1261} vslice_dummy_var_172 := sdv_RunIoCompletionRoutines#0(sdv_p_devobj_fdo, Irp_4, vslice_dummy_var_518, completion_1);
    goto anon74_Then, anon74_Else;
  ...
  anon63_Else:
    ...
    call {:si_unique_call 1262} vslice_dummy_var_173 := sdv_RunIoCompletionRoutines#0(sdv_p_devobj_fdo, Irp_4, vslice_dummy_var_519, completion_1);
    goto anon72_Then, anon72_Else;
...
implementation MouseClassCleanupQueue_loop_L49(in_listHead: int, in_sdv_103: int, in_irp: int, in_sdv_104: int, in_entry: int, in_DeviceExtension: int, in_vslice_dummy_var_43: int) returns (out_sdv_103: int, out_irp: int, out_sdv_104: int, out_entry: int, out_vslice_dummy_var_43: int)
{

  entry:
    out_sdv_103, out_irp, out_sdv_104, out_entry, out_vslice_dummy_var_43 := in_sdv_103, in_irp, in_sdv_104, in_entry, in_vslice_dummy_var_43;
    goto L49, exit;
  ...
  L49:
    call {:si_unique_call 1263} out_sdv_103 := sdv_IsListEmpty(0);
    goto anon15_Else;

  anon15_Else:
    assume {:partition} out_sdv_103 == 0;
    call {:si_unique_call 1264} out_entry := RemoveHeadList(in_listHead);
    call {:si_unique_call 1265} out_sdv_104 := sdv_containing_record(out_entry, 88);
    out_irp := out_sdv_104;
    call {:si_unique_call 1266} sdv_IoCompleteRequest(0, 0);
    assume {:nonnull} in_DeviceExtension != 0;
    assume in_DeviceExtension > 0;
    call {:si_unique_call 1267} out_vslice_dummy_var_43 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(in_DeviceExtension), out_irp);
    goto anon15_Else_dummy;

  anon15_Else_dummy:
    call {:si_unique_call 1268} {:si_old_unique_call 1} out_sdv_103, out_irp, out_sdv_104, out_entry, out_vslice_dummy_var_43 := MouseClassCleanupQueue_loop_L49(in_listHead, out_sdv_103, out_irp, out_sdv_104, out_entry, in_DeviceExtension, out_vslice_dummy_var_43);
    return;
}



procedure {:LoopProcedure} MouseClassCleanupQueue_loop_L49(in_listHead: int, in_sdv_103: int, in_irp: int, in_sdv_104: int, in_entry: int, in_DeviceExtension: int, in_vslice_dummy_var_43: int) returns (out_sdv_103: int, out_irp: int, out_sdv_104: int, out_entry: int, out_vslice_dummy_var_43: int);
  modifies alloc;
...
implementation MouseClassCleanupQueue_loop_L16(in_listHead: int, in_nextEntry: int, in_sdv_98: int, in_oldCancelRoutine: int, in_irp: int, in_entry: int, in_stack_1: int, in_FileObject_1: int, in_vslice_dummy_var_42: int, in_vslice_dummy_var_44: int) returns (out_nextEntry: int, out_sdv_98: int, out_oldCancelRoutine: int, out_irp: int, out_entry: int, out_stack_1: int, out_vslice_dummy_var_42: int, out_vslice_dummy_var_44: int)
{

  entry:
    out_nextEntry, out_sdv_98, out_oldCancelRoutine, out_irp, out_entry, out_stack_1, out_vslice_dummy_var_42, out_vslice_dummy_var_44 := in_nextEntry, in_sdv_98, in_oldCancelRoutine, in_irp, in_entry, in_stack_1, in_vslice_dummy_var_42, in_vslice_dummy_var_44;
    goto L16, exit;
  ...
  anon11_Else:
    ...
    assume out_entry > 0;
    havoc out_nextEntry;
    call {:si_unique_call 1273} out_sdv_98 := sdv_containing_record(out_entry, 88);
    out_irp := out_sdv_98;
    call {:si_unique_call 1274} out_stack_1 := sdv_IoGetCurrentIrpStackLocation(out_irp);
    goto anon12_Then, anon12_Else;
  ...
  L35_dummy:
    call {:si_unique_call 1275} {:si_old_unique_call 1} out_nextEntry, out_sdv_98, out_oldCancelRoutine, out_irp, out_entry, out_stack_1, out_vslice_dummy_var_42, out_vslice_dummy_var_44 := MouseClassCleanupQueue_loop_L16(in_listHead, out_nextEntry, out_sdv_98, out_oldCancelRoutine, out_irp, out_entry, out_stack_1, in_FileObject_1, out_vslice_dummy_var_42, out_vslice_dummy_var_44);
    return;
  ...
  L31:
    call {:si_unique_call 1271} out_vslice_dummy_var_42 := sdv_RemoveEntryList(0);
    call {:si_unique_call 1272} out_oldCancelRoutine := sdv_IoSetCancelRoutine(out_irp, 0);
    goto anon14_Then, anon14_Else;
  ...
  anon14_Else:
    ...
    assume {:nonnull} out_irp != 0;
    assume out_irp > 0;
    call {:si_unique_call 1269} out_vslice_dummy_var_44 := sdv_InsertTailList(in_listHead, ListEntry_unnamed_tag_6(Overlay_unnamed_tag_5(Tail__IRP(out_irp))));
    goto L35;
  ...
  anon14_Then:
    ...
    assume {:nonnull} out_irp != 0;
    assume out_irp > 0;
    call {:si_unique_call 1270} InitializeListHead(ListEntry_unnamed_tag_6(Overlay_unnamed_tag_5(Tail__IRP(out_irp))));
    goto L35;
...
procedure {:LoopProcedure} MouseClassCleanupQueue_loop_L16(in_listHead: int, in_nextEntry: int, in_sdv_98: int, in_oldCancelRoutine: int, in_irp: int, in_entry: int, in_stack_1: int, in_FileObject_1: int, in_vslice_dummy_var_42: int, in_vslice_dummy_var_44: int) returns (out_nextEntry: int, out_sdv_98: int, out_oldCancelRoutine: int, out_irp: int, out_entry: int, out_stack_1: int, out_vslice_dummy_var_42: int, out_vslice_dummy_var_44: int);
  modifies alloc;
...
implementation MouseClassLogError_loop_L20(in_i: int, in_errorLogEntry: int, in_Tmp_190: int, in_Tmp_194: int, in_Tmp_195: int, in_DumpCount: int, in_DumpData: int) returns (out_i: int, out_Tmp_190: int, out_Tmp_194: int, out_Tmp_195: int)
{
  ...
  anon5_Else_dummy:
    call {:si_unique_call 1276} {:si_old_unique_call 1} out_i, out_Tmp_190, out_Tmp_194, out_Tmp_195 := MouseClassLogError_loop_L20(out_i, in_errorLogEntry, out_Tmp_190, out_Tmp_194, out_Tmp_195, in_DumpCount, in_DumpData);
    return;
}
...
implementation MouseClassClose_loop_L45(in_i_1: int, in_someEnableDisableSucceeded: int, in_irpSp_1: int, in_notifyHandle_1: int, in_port_2: int, in_Tmp_204: int, in_Tmp_205: int, in_enabled_1: int, in_Tmp_208: int, in_status_5: int, in_Tmp_211: int, in_Tmp_212: int, in_DeviceObject_16: int, in_Irp_8: int, in_vslice_dummy_var_47: int) returns (out_i_1: int, out_someEnableDisableSucceeded: int, out_notifyHandle_1: int, out_port_2: int, out_Tmp_204: int, out_Tmp_205: int, out_enabled_1: int, out_Tmp_208: int, out_status_5: int, out_Tmp_211: int, out_Tmp_212: int, out_vslice_dummy_var_47: int)
{
  ...
  anon47_Then:
    ...
    assume {:nonnull} out_port_2 != 0;
    assume out_port_2 > 0;
    call {:si_unique_call 1280} ExReleaseFastMutex(0);
    goto anon37_Then, anon37_Else;
  ...
  anon37_Else:
    ...
    call {:si_unique_call 1283} out_notifyHandle_1 := _InlineInterlockedExchangePointer(TargetNotifyHandle__DEVICE_EXTENSION(out_Tmp_205), 0);
    goto anon39_Then, anon39_Else;

  anon39_Else:
    assume {:partition} out_notifyHandle_1 != 0;
    call {:si_unique_call 1282} out_vslice_dummy_var_47 := IoUnregisterPlugPlayNotification(0);
    goto L65;
  ...
  L65:
    ...
    call {:si_unique_call 1281} out_status_5 := MouEnableDisablePort#1(0, in_Irp_8, vslice_dummy_var_522, File__PORT(out_port_2));
    goto anon48_Else;
  ...
  anon38_Else:
    ...
    call {:si_unique_call 1278} WPP_RECORDER_SF_q(out_Tmp_208, 0, 1, 29, out_Tmp_212, vslice_dummy_var_520);
    assume {:nonnull} in_irpSp_1 != 0;
    assume in_irpSp_1 > 0;
    havoc vslice_dummy_var_521;
    call {:si_unique_call 1279} MouseClassLogError(in_DeviceObject_16, -1073414134, 20120, out_status_5, 0, 0, vslice_dummy_var_521);
    goto L85;

  L85:
    call {:si_unique_call 1277} ExAcquireFastMutex(0);
    goto L53;
...
implementation MouseClassCreate_loop_L93(in_i_2: int, in_someEnableDisableSucceeded_1: int, in_Tmp_469: int, in_irpSp_6: int, in_Tmp_470: int, in_port_5: int, in_enabled_5: int, in_status_24: int, in_deviceExtension_7: int, in_Tmp_478: int, in_DeviceObject_34: int, in_Irp_26: int) returns (out_i_2: int, out_someEnableDisableSucceeded_1: int, out_Tmp_469: int, out_Tmp_470: int, out_port_5: int, out_enabled_5: int, out_status_24: int, out_Tmp_478: int)
{
  ...
  anon57_Then:
    ...
    assume {:nonnull} out_port_5 != 0;
    assume out_port_5 > 0;
    call {:si_unique_call 1289} ExReleaseFastMutex(0);
    goto anon50_Then, anon50_Else;
  ...
  anon51_Else:
    ...
    call {:si_unique_call 1286} WPP_RECORDER_SF_q(out_Tmp_470, 0, 1, 25, out_Tmp_469, vslice_dummy_var_523);
    assume {:nonnull} in_irpSp_6 != 0;
    assume in_irpSp_6 > 0;
    havoc vslice_dummy_var_524;
    call {:si_unique_call 1287} MouseClassLogError(in_DeviceObject_34, -1073414135, 20120, out_status_24, 0, 0, vslice_dummy_var_524);
    assume {:nonnull} out_port_5 != 0;
    assume out_port_5 > 0;
    goto L125;

  L125:
    call {:si_unique_call 1285} ExAcquireFastMutex(0);
    goto L101;
  ...
  anon50_Then:
    ...
    call {:si_unique_call 1288} out_status_24 := MouEnableDisablePort#1(1, in_Irp_26, vslice_dummy_var_525, File__PORT(out_port_5));
    goto anon58_Else;
