...
procedure {:origName "DispatchControl"} DispatchControl(actual_fdo: int, actual_Irp_3: int) returns (Tmp_97: int);
  modifies alloc, LockDepth, yogi_error, sdv_compFset, sdv_invoke_on_cancel;
...
implementation {:origName "DispatchControl"} DispatchControl(actual_fdo: int, actual_Irp_3: int) returns (Tmp_97: int)
{
  ...
  L1:
    call {:si_unique_call 38} SLIC_DispatchControl_exit(strConst__li2bpl3, Irp_3);
  ...
  anon21_Then:
    ...
    call {:si_unique_call 39} sdv_IoSkipCurrentIrpStackLocation(Irp_3);
  ...
  anon23_Else:
    ...
    call {:si_unique_call 40} status_3 := sdv_IoCallDriver(vslice_dummy_var_206, Irp_3);
  ...
  anon26_Else:
    ...
    assume {:nonnull} pdx_2 != 0;
    assume pdx_2 > 0;
    call {:si_unique_call 41} vslice_dummy_var_7 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(pdx_2), Irp_3);
  ...
  L24:
    ...
    call {:si_unique_call 42} status_3 := CompleteRequest(Irp_3, vslice_dummy_var_207, 0);
    assume {:nonnull} pdx_2 != 0;
    assume pdx_2 > 0;
    call {:si_unique_call 43} vslice_dummy_var_8 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(pdx_2), Irp_3);
  ...
  anon25_Then:
    assume {:partition} pdx_2 == 0;
    call {:si_unique_call 44} Tmp_97 := CompleteRequest2(Irp_3, -1073741810);
    goto L1;
}
...
implementation {:origName "_sdv_init9"} _sdv_init9()
{
  ...
  anon0:
    call {:si_unique_call 45} Tmp_102 := __HAVOC_malloc(4);
...
implementation {:origName "_sdv_init11"} _sdv_init11()
{
  ...
  anon0:
    call {:si_unique_call 47} Tmp_106 := __HAVOC_malloc(4);
...
implementation {:origName "_sdv_init10"} _sdv_init10()
{
  ...
  anon0:
    call {:si_unique_call 49} Tmp_108 := __HAVOC_malloc(4);
    call {:si_unique_call 50} vslice_dummy_var_11 := __HAVOC_malloc(4);
...
implementation {:origName "sdv_IoReleaseRemoveLock"} sdv_IoReleaseRemoveLock(actual_sdv_15: int, actual_sdv_16: int) returns (Tmp_111: int)
{
  ...
  anon0:
    call {:si_unique_call 51} sdv_17 := __HAVOC_malloc(4);
    call {:si_unique_call 52} Tmp_111 := __HAVOC_malloc(4);
    call {:si_unique_call 53} SLIC_sdv_IoReleaseRemoveLock_entry(strConst__li2bpl3);
...
implementation {:origName "_sdv_init6"} _sdv_init6()
{
  ...
  anon0:
    call {:si_unique_call 54} Tmp_113 := __HAVOC_malloc(4);
...
implementation {:origName "sdv_IoCopyCurrentIrpStackLocationToNext"} {:osmodel} sdv_IoCopyCurrentIrpStackLocationToNext(actual_pirp: int)
{
  ...
  anon0:
    call {:si_unique_call 56} vslice_dummy_var_13 := __HAVOC_malloc(4);
    pirp := actual_pirp;
...
implementation {:origName "sdv_RunDispatchDeviceControl"} {:osmodel} sdv_RunDispatchDeviceControl(actual_po: int, actual_pirp_2: int) returns (Tmp_120: int)
{
  ...
  anon0:
    ...
    assume {:nonnull} pirp_2 != 0;
    assume pirp_2 > 0;
    call {:si_unique_call 57} sdv_SetStatus(pirp_2);
    assume {:nonnull} pirp_2 != 0;
    assume pirp_2 > 0;
    assume {:nonnull} pirp_2 != 0;
    assume pirp_2 > 0;
    ...
    assume {:nonnull} ps != 0;
    assume ps > 0;
    call {:si_unique_call 58} sdv_stub_dispatch_begin();
    assume {:nonnull} ps != 0;
    assume ps > 0;
  ...
  anon3_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 60} sdv_stub_dispatch_end(status_4, 0);
    assume {:nonnull} pirp_2 != 0;
    assume pirp_2 > 0;
    Tmp_120 := status_4;
    goto LM2;
...
implementation {:origName "sdv_stub_dispatch_end"} {:osmodel} sdv_stub_dispatch_end(actual_s: int, actual_pirp_3: int)
{
  ...
  anon0:
    call {:si_unique_call 61} vslice_dummy_var_14 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "sdv_SetStatus"} {:osmodel} sdv_SetStatus(actual_pirp_4: int)
{
  ...
  anon0:
    call {:si_unique_call 62} vslice_dummy_var_15 := __HAVOC_malloc(4);
...
implementation {:origName "sdv_main"} {:osmodel} sdv_main()
{
  ...
  anon0:
    ...
    call {:si_unique_call 64} sdv_stub_driver_init();
    call {:si_unique_call 65} vslice_dummy_var_17 := sdv_RunDispatchDeviceControl(sdv_p_devobj_fdo, sdv_irp);
    goto anon3_Then, anon3_Else;
...
procedure {:origName "sdv_IoSetCompletionRoutine"} {:osmodel} sdv_IoSetCompletionRoutine(actual_pirp_5: int, actual_CompletionRoutine: int, actual_Context_3: int, actual_InvokeOnSuccess: int, actual_InvokeOnError: int, actual_InvokeOnCancel: int);
  modifies alloc, sdv_compFset, sdv_invoke_on_cancel;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);
...
implementation {:origName "sdv_IoSetCompletionRoutine"} {:osmodel} sdv_IoSetCompletionRoutine(actual_pirp_5: int, actual_CompletionRoutine: int, actual_Context_3: int, actual_InvokeOnSuccess: int, actual_InvokeOnError: int, actual_InvokeOnCancel: int)
{
  ...
  anon0:
    call {:si_unique_call 66} vslice_dummy_var_18 := __HAVOC_malloc(4);
    ...
    call {:si_unique_call 67} irpSp := sdv_IoGetNextIrpStackLocation(pirp_5);
...
implementation {:origName "PoStartNextPowerIrp"} {:osmodel} PoStartNextPowerIrp(actual_Irp_5: int)
{
  ...
  anon0:
    call {:si_unique_call 68} vslice_dummy_var_19 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "sdv_stub_power_completion_begin"} {:osmodel} sdv_stub_power_completion_begin()
{
  ...
  anon0:
    call {:si_unique_call 69} vslice_dummy_var_20 := __HAVOC_malloc(4);
    goto anon3_Then, anon3_Else;
...
procedure {:nohoudini} {:origName "main"} {:osmodel} {:entrypoint} main() returns (Tmp_144: int, dup_assertVar: bool);
  modifies alloc, LockDepth, yogi_error, sdv_invoke_on_cancel, sdv_compFset;
...
implementation {:origName "main"} {:osmodel} main() returns (Tmp_144: int, dup_assertVar: bool)
{
  ...
  anon0:
    ...
    call {:si_unique_call 71} EventTraceConfigGuid__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 73} WPP_TRACE_CONTROL_NULL_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume WPP_TRACE_CONTROL_NULL_GUID__Loc == WPP_TRACE_CONTROL_NULL_GUID;
    assume WPP_TRACE_CONTROL_NULL_GUID != 0;
    call {:si_unique_call 74} GUID_DEVICE__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_DEVICE__Loc == GUID_DEVICE;
    assume GUID_DEVICE != 0;
    call {:si_unique_call 75} DefaultTraceSecurityGuid__Loc := __HAVOC_malloc_or_null(16);
    assume DefaultTraceSecurityGuid__Loc == DefaultTraceSecurityGuid;
    assume DefaultTraceSecurityGuid != 0;
    call {:si_unique_call 76} SystemTraceControlGuid__Loc := __HAVOC_malloc_or_null(16);
    assume SystemTraceControlGuid__Loc == SystemTraceControlGuid;
    assume SystemTraceControlGuid != 0;
    call {:si_unique_call 77} WPP_ThisDir_CTLGUID_IPMIDRIVER__Loc := __HAVOC_malloc_or_null(16);
    assume WPP_ThisDir_CTLGUID_IPMIDRIVER__Loc == WPP_ThisDir_CTLGUID_IPMIDRIVER;
    assume WPP_ThisDir_CTLGUID_IPMIDRIVER != 0;
    call {:si_unique_call 78} EventTraceGuid__Loc := __HAVOC_malloc_or_null(16);
    assume EventTraceGuid__Loc == EventTraceGuid;
    assume EventTraceGuid != 0;
    call {:si_unique_call 79} KeTickCount__Loc := __HAVOC_malloc_or_null(12);
    assume KeTickCount__Loc == KeTickCount;
    assume KeTickCount != 0;
    call {:si_unique_call 80} cKCSEngine__Loc := __HAVOC_malloc_or_null(12);
    assume cKCSEngine__Loc == cKCSEngine;
    assume cKCSEngine != 0;
    call {:si_unique_call 81} EngineState__Loc := __HAVOC_malloc_or_null(1088);
    assume EngineState__Loc == EngineState;
    assume EngineState != 0;
    call {:si_unique_call 82} CONFIG_KEY__Loc := __HAVOC_malloc_or_null(12);
    assume CONFIG_KEY__Loc == CONFIG_KEY;
    assume CONFIG_KEY != 0;
    call {:si_unique_call 83} sdv_harnessStackLocation_next__Loc := __HAVOC_malloc_or_null(536);
    assume sdv_harnessStackLocation_next__Loc == sdv_harnessStackLocation_next;
    assume sdv_harnessStackLocation_next != 0;
    call {:si_unique_call 84} sdv_IoReadPartitionTableEx_DRIVE_LAYOUT_INFORMATION_EX__Loc := __HAVOC_malloc_or_null(76);
    assume sdv_IoReadPartitionTableEx_DRIVE_LAYOUT_INFORMATION_EX__Loc == sdv_IoReadPartitionTableEx_DRIVE_LAYOUT_INFORMATION_EX;
    assume sdv_IoReadPartitionTableEx_DRIVE_LAYOUT_INFORMATION_EX != 0;
    call {:si_unique_call 85} sdv_IoBuildAsynchronousFsdRequest_harnessIrp__Loc := __HAVOC_malloc_or_null(240);
    assume sdv_IoBuildAsynchronousFsdRequest_harnessIrp__Loc == sdv_IoBuildAsynchronousFsdRequest_harnessIrp;
    assume sdv_IoBuildAsynchronousFsdRequest_harnessIrp != 0;
    call {:si_unique_call 86} sdv_IoGetDeviceToVerify_DEVICE_OBJECT__Loc := __HAVOC_malloc_or_null(380);
    assume sdv_IoGetDeviceToVerify_DEVICE_OBJECT__Loc == sdv_IoGetDeviceToVerify_DEVICE_OBJECT;
    assume sdv_IoGetDeviceToVerify_DEVICE_OBJECT != 0;
    call {:si_unique_call 87} sdv_IoBuildDeviceIoControlRequest_harnessStackLocation_next__Loc := __HAVOC_malloc_or_null(536);
    assume sdv_IoBuildDeviceIoControlRequest_harnessStackLocation_next__Loc == sdv_IoBuildDeviceIoControlRequest_harnessStackLocation_next;
    assume sdv_IoBuildDeviceIoControlRequest_harnessStackLocation_next != 0;
    call {:si_unique_call 88} sdv_harness_IoBuildSynchronousFsdRequest_IoStatusBlock__Loc := __HAVOC_malloc_or_null(12);
    assume sdv_harness_IoBuildSynchronousFsdRequest_IoStatusBlock__Loc == sdv_harness_IoBuildSynchronousFsdRequest_IoStatusBlock;
    assume sdv_harness_IoBuildSynchronousFsdRequest_IoStatusBlock != 0;
    call {:si_unique_call 89} sdv_ControllerIrp__Loc := __HAVOC_malloc_or_null(240);
    assume sdv_ControllerIrp__Loc == sdv_ControllerIrp;
    assume sdv_ControllerIrp != 0;
    call {:si_unique_call 90} sdv_devobj_pdo__Loc := __HAVOC_malloc_or_null(380);
    assume sdv_devobj_pdo__Loc == sdv_devobj_pdo;
    assume sdv_devobj_pdo != 0;
    call {:si_unique_call 91} sdv_IoGetDmaAdapter_DMA_ADAPTER__Loc := __HAVOC_malloc_or_null(12);
    assume sdv_IoGetDmaAdapter_DMA_ADAPTER__Loc == sdv_IoGetDmaAdapter_DMA_ADAPTER;
    assume sdv_IoGetDmaAdapter_DMA_ADAPTER != 0;
    call {:si_unique_call 92} sdv_IoInitializeIrp_harnessIrp__Loc := __HAVOC_malloc_or_null(240);
    assume sdv_IoInitializeIrp_harnessIrp__Loc == sdv_IoInitializeIrp_harnessIrp;
    assume sdv_IoInitializeIrp_harnessIrp != 0;
    call {:si_unique_call 93} sdv_IoGetRelatedDeviceObject_DEVICE_OBJECT__Loc := __HAVOC_malloc_or_null(380);
    assume sdv_IoGetRelatedDeviceObject_DEVICE_OBJECT__Loc == sdv_IoGetRelatedDeviceObject_DEVICE_OBJECT;
    assume sdv_IoGetRelatedDeviceObject_DEVICE_OBJECT != 0;
    call {:si_unique_call 94} sdv_IoBuildSynchronousFsdRequest_harnessStackLocation_next__Loc := __HAVOC_malloc_or_null(536);
    assume sdv_IoBuildSynchronousFsdRequest_harnessStackLocation_next__Loc == sdv_IoBuildSynchronousFsdRequest_harnessStackLocation_next;
    assume sdv_IoBuildSynchronousFsdRequest_harnessStackLocation_next != 0;
    call {:si_unique_call 95} sdv_IoCreateSynchronizationEvent_KEVENT__Loc := __HAVOC_malloc_or_null(156);
    ...
    call {:si_unique_call 97} sdv_other_harnessStackLocation_next__Loc := __HAVOC_malloc_or_null(536);
    assume sdv_other_harnessStackLocation_next__Loc == sdv_other_harnessStackLocation_next;
    assume sdv_other_harnessStackLocation_next != 0;
    call {:si_unique_call 98} sdv_IoCreateController_CONTROLLER_OBJECT__Loc := __HAVOC_malloc_or_null(60);
    assume sdv_IoCreateController_CONTROLLER_OBJECT__Loc == sdv_IoCreateController_CONTROLLER_OBJECT;
    assume sdv_IoCreateController_CONTROLLER_OBJECT != 0;
    call {:si_unique_call 99} sdv_devobj_top__Loc := __HAVOC_malloc_or_null(380);
    assume sdv_devobj_top__Loc == sdv_devobj_top;
    assume sdv_devobj_top != 0;
    call {:si_unique_call 100} sdv_kdpc_val3__Loc := __HAVOC_malloc_or_null(44);
    assume sdv_kdpc_val3__Loc == sdv_kdpc_val3;
    assume sdv_kdpc_val3 != 0;
    call {:si_unique_call 101} sdv_IoBuildSynchronousFsdRequest_harnessIrp__Loc := __HAVOC_malloc_or_null(240);
    assume sdv_IoBuildSynchronousFsdRequest_harnessIrp__Loc == sdv_IoBuildSynchronousFsdRequest_harnessIrp;
    assume sdv_IoBuildSynchronousFsdRequest_harnessIrp != 0;
    call {:si_unique_call 102} sdv_IoGetDeviceObjectPointer_DEVICE_OBJECT__Loc := __HAVOC_malloc_or_null(380);
    ...
    call {:si_unique_call 105} sdv_IoMakeAssociatedIrp_harnessIrp__Loc := __HAVOC_malloc_or_null(240);
    assume sdv_IoMakeAssociatedIrp_harnessIrp__Loc == sdv_IoMakeAssociatedIrp_harnessIrp;
    assume sdv_IoMakeAssociatedIrp_harnessIrp != 0;
    call {:si_unique_call 106} sdv_devobj_child_pdo__Loc := __HAVOC_malloc_or_null(380);
    assume sdv_devobj_child_pdo__Loc == sdv_devobj_child_pdo;
    assume sdv_devobj_child_pdo != 0;
    call {:si_unique_call 107} sdv_harnessIrp__Loc := __HAVOC_malloc_or_null(240);
    assume sdv_harnessIrp__Loc == sdv_harnessIrp;
    assume sdv_harnessIrp != 0;
    call {:si_unique_call 108} sdv_IoBuildAsynchronousFsdRequest_harnessStackLocation_next__Loc := __HAVOC_malloc_or_null(536);
    ...
    call {:si_unique_call 111} sdv_fx_dev_object__Loc := __HAVOC_malloc_or_null(40);
    assume sdv_fx_dev_object__Loc == sdv_fx_dev_object;
    assume sdv_fx_dev_object != 0;
    call {:si_unique_call 112} sdv_devobj_fdo__Loc := __HAVOC_malloc_or_null(380);
    assume sdv_devobj_fdo__Loc == sdv_devobj_fdo;
    assume sdv_devobj_fdo != 0;
    call {:si_unique_call 113} sdv_StartIoIrp__Loc := __HAVOC_malloc_or_null(240);
    assume sdv_StartIoIrp__Loc == sdv_StartIoIrp;
    assume sdv_StartIoIrp != 0;
    call {:si_unique_call 114} sdv_harness_IoBuildAsynchronousFsdRequest_IoStatusBlock__Loc := __HAVOC_malloc_or_null(12);
    assume sdv_harness_IoBuildAsynchronousFsdRequest_IoStatusBlock__Loc == sdv_harness_IoBuildAsynchronousFsdRequest_IoStatusBlock;
    assume sdv_harness_IoBuildAsynchronousFsdRequest_IoStatusBlock != 0;
    call {:si_unique_call 115} sdv_PowerIrp__Loc := __HAVOC_malloc_or_null(240);
    assume sdv_PowerIrp__Loc == sdv_PowerIrp;
    assume sdv_PowerIrp != 0;
    call {:si_unique_call 116} sdv_IoBuildDeviceIoControlRequest_harnessIrp__Loc := __HAVOC_malloc_or_null(240);
    assume sdv_IoBuildDeviceIoControlRequest_harnessIrp__Loc == sdv_IoBuildDeviceIoControlRequest_harnessIrp;
    assume sdv_IoBuildDeviceIoControlRequest_harnessIrp != 0;
    call {:si_unique_call 117} sdv_other_harnessIrp__Loc := __HAVOC_malloc_or_null(240);
    assume sdv_other_harnessIrp__Loc == sdv_other_harnessIrp;
    assume sdv_other_harnessIrp != 0;
    call {:si_unique_call 118} sdv_IoCreateNotificationEvent_KEVENT__Loc := __HAVOC_malloc_or_null(156);
    assume sdv_IoCreateNotificationEvent_KEVENT__Loc == sdv_IoCreateNotificationEvent_KEVENT;
    assume sdv_IoCreateNotificationEvent_KEVENT != 0;
    call {:si_unique_call 119} sdv_other_harnessStackLocation__Loc := __HAVOC_malloc_or_null(536);
    assume sdv_other_harnessStackLocation__Loc == sdv_other_harnessStackLocation;
    assume sdv_other_harnessStackLocation != 0;
    call {:si_unique_call 120} GUID_DEVCLASS_VOLUME__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_DEVCLASS_VOLUME__Loc == GUID_DEVCLASS_VOLUME;
    assume GUID_DEVCLASS_VOLUME != 0;
    call {:si_unique_call 121} GUID_DEVCLASS_BATTERY__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_DEVCLASS_BATTERY__Loc == GUID_DEVCLASS_BATTERY;
    assume GUID_DEVCLASS_BATTERY != 0;
    call {:si_unique_call 122} GUID_DEVCLASS_WPD__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_DEVCLASS_WPD__Loc == GUID_DEVCLASS_WPD;
    assume GUID_DEVCLASS_WPD != 0;
    call {:si_unique_call 123} GUID_DEVCLASS_PCMCIA__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_DEVCLASS_PCMCIA__Loc == GUID_DEVCLASS_PCMCIA;
    assume GUID_DEVCLASS_PCMCIA != 0;
    call {:si_unique_call 124} GUID_DEVCLASS_FSFILTER_ANTIVIRUS__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_DEVCLASS_FSFILTER_ANTIVIRUS__Loc == GUID_DEVCLASS_FSFILTER_ANTIVIRUS;
    assume GUID_DEVCLASS_FSFILTER_ANTIVIRUS != 0;
    call {:si_unique_call 125} GUID_DEVCLASS_PROCESSOR__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_DEVCLASS_PROCESSOR__Loc == GUID_DEVCLASS_PROCESSOR;
    assume GUID_DEVCLASS_PROCESSOR != 0;
    call {:si_unique_call 126} GUID_DEVCLASS_GPS__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_DEVCLASS_GPS__Loc == GUID_DEVCLASS_GPS;
    assume GUID_DEVCLASS_GPS != 0;
    call {:si_unique_call 127} GUID_DEVCLASS_HDC__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_DEVCLASS_HDC__Loc == GUID_DEVCLASS_HDC;
    assume GUID_DEVCLASS_HDC != 0;
    call {:si_unique_call 128} GUID_DEVCLASS_ENUM1394__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_DEVCLASS_ENUM1394__Loc == GUID_DEVCLASS_ENUM1394;
    assume GUID_DEVCLASS_ENUM1394 != 0;
    call {:si_unique_call 129} GUID_DEVCLASS_MONITOR__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_DEVCLASS_MONITOR__Loc == GUID_DEVCLASS_MONITOR;
    assume GUID_DEVCLASS_MONITOR != 0;
    call {:si_unique_call 130} GUID_DEVCLASS_MULTIFUNCTION__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_DEVCLASS_MULTIFUNCTION__Loc == GUID_DEVCLASS_MULTIFUNCTION;
    assume GUID_DEVCLASS_MULTIFUNCTION != 0;
    call {:si_unique_call 131} GUID_DEVCLASS_BLUETOOTH__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_DEVCLASS_BLUETOOTH__Loc == GUID_DEVCLASS_BLUETOOTH;
    assume GUID_DEVCLASS_BLUETOOTH != 0;
    call {:si_unique_call 132} GUID_DEVCLASS_FSFILTER_HSM__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_DEVCLASS_FSFILTER_HSM__Loc == GUID_DEVCLASS_FSFILTER_HSM;
    assume GUID_DEVCLASS_FSFILTER_HSM != 0;
    call {:si_unique_call 133} GUID_DEVCLASS_MEMORY__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_DEVCLASS_MEMORY__Loc == GUID_DEVCLASS_MEMORY;
    assume GUID_DEVCLASS_MEMORY != 0;
    call {:si_unique_call 134} GUID_DEVCLASS_MTD__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_DEVCLASS_MTD__Loc == GUID_DEVCLASS_MTD;
    assume GUID_DEVCLASS_MTD != 0;
    call {:si_unique_call 135} GUID_DEVCLASS_CDROM__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_DEVCLASS_CDROM__Loc == GUID_DEVCLASS_CDROM;
    assume GUID_DEVCLASS_CDROM != 0;
    call {:si_unique_call 136} GUID_DEVCLASS_KEYBOARD__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_DEVCLASS_KEYBOARD__Loc == GUID_DEVCLASS_KEYBOARD;
    assume GUID_DEVCLASS_KEYBOARD != 0;
    call {:si_unique_call 137} GUID_DEVCLASS_NETSERVICE__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_DEVCLASS_NETSERVICE__Loc == GUID_DEVCLASS_NETSERVICE;
    assume GUID_DEVCLASS_NETSERVICE != 0;
    call {:si_unique_call 138} GUID_DEVCLASS_1394DEBUG__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_DEVCLASS_1394DEBUG__Loc == GUID_DEVCLASS_1394DEBUG;
    assume GUID_DEVCLASS_1394DEBUG != 0;
    call {:si_unique_call 139} GUID_DEVCLASS_EHSTORAGESILO__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_DEVCLASS_EHSTORAGESILO__Loc == GUID_DEVCLASS_EHSTORAGESILO;
    assume GUID_DEVCLASS_EHSTORAGESILO != 0;
    call {:si_unique_call 140} GUID_DEVCLASS_FSFILTER_UNDELETE__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_DEVCLASS_FSFILTER_UNDELETE__Loc == GUID_DEVCLASS_FSFILTER_UNDELETE;
    assume GUID_DEVCLASS_FSFILTER_UNDELETE != 0;
    call {:si_unique_call 141} GUID_DEVCLASS_FSFILTER_VIRTUALIZATION__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 142} GUID_DEVCLASS_FLOPPYDISK__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_DEVCLASS_FLOPPYDISK__Loc == GUID_DEVCLASS_FLOPPYDISK;
    assume GUID_DEVCLASS_FLOPPYDISK != 0;
    call {:si_unique_call 143} GUID_DEVCLASS_FSFILTER_COPYPROTECTION__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 144} GUID_DEVCLASS_IMAGE__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_DEVCLASS_IMAGE__Loc == GUID_DEVCLASS_IMAGE;
    assume GUID_DEVCLASS_IMAGE != 0;
    call {:si_unique_call 145} GUID_DEVCLASS_PORTS__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_DEVCLASS_PORTS__Loc == GUID_DEVCLASS_PORTS;
    assume GUID_DEVCLASS_PORTS != 0;
    call {:si_unique_call 146} GUID_DEVCLASS_SBP2__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_DEVCLASS_SBP2__Loc == GUID_DEVCLASS_SBP2;
    assume GUID_DEVCLASS_SBP2 != 0;
    call {:si_unique_call 147} GUID_DEVCLASS_SIDESHOW__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_DEVCLASS_SIDESHOW__Loc == GUID_DEVCLASS_SIDESHOW;
    assume GUID_DEVCLASS_SIDESHOW != 0;
    call {:si_unique_call 148} GUID_DEVCLASS_FSFILTER_PHYSICALQUOTAMANAGEMENT__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 149} GUID_DEVCLASS_USB__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_DEVCLASS_USB__Loc == GUID_DEVCLASS_USB;
    assume GUID_DEVCLASS_USB != 0;
    call {:si_unique_call 150} GUID_DEVCLASS_1394__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_DEVCLASS_1394__Loc == GUID_DEVCLASS_1394;
    assume GUID_DEVCLASS_1394 != 0;
    call {:si_unique_call 151} GUID_DEVCLASS_NETTRANS__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_DEVCLASS_NETTRANS__Loc == GUID_DEVCLASS_NETTRANS;
    assume GUID_DEVCLASS_NETTRANS != 0;
    call {:si_unique_call 152} GUID_DEVCLASS_SECURITYACCELERATOR__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 153} GUID_DEVCLASS_FSFILTER_SECURITYENHANCER__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 154} GUID_DEVCLASS_FSFILTER_CFSMETADATASERVER__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 155} GUID_DEVCLASS_NODRIVER__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_DEVCLASS_NODRIVER__Loc == GUID_DEVCLASS_NODRIVER;
    assume GUID_DEVCLASS_NODRIVER != 0;
    call {:si_unique_call 156} GUID_DEVCLASS_EXTENSION__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_DEVCLASS_EXTENSION__Loc == GUID_DEVCLASS_EXTENSION;
    assume GUID_DEVCLASS_EXTENSION != 0;
    call {:si_unique_call 157} GUID_DEVCLASS_DISKDRIVE__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_DEVCLASS_DISKDRIVE__Loc == GUID_DEVCLASS_DISKDRIVE;
    assume GUID_DEVCLASS_DISKDRIVE != 0;
    call {:si_unique_call 158} GUID_DEVCLASS_FIRMWARE__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_DEVCLASS_FIRMWARE__Loc == GUID_DEVCLASS_FIRMWARE;
    assume GUID_DEVCLASS_FIRMWARE != 0;
    call {:si_unique_call 159} GUID_DEVCLASS_APMSUPPORT__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_DEVCLASS_APMSUPPORT__Loc == GUID_DEVCLASS_APMSUPPORT;
    assume GUID_DEVCLASS_APMSUPPORT != 0;
    call {:si_unique_call 160} GUID_DEVCLASS_FSFILTER_COMPRESSION__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 161} GUID_DEVCLASS_FSFILTER_ENCRYPTION__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 162} GUID_DEVCLASS_DOT4PRINT__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_DEVCLASS_DOT4PRINT__Loc == GUID_DEVCLASS_DOT4PRINT;
    assume GUID_DEVCLASS_DOT4PRINT != 0;
    call {:si_unique_call 163} GUID_DEVCLASS_INFRARED__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_DEVCLASS_INFRARED__Loc == GUID_DEVCLASS_INFRARED;
    assume GUID_DEVCLASS_INFRARED != 0;
    call {:si_unique_call 164} GUID_DEVCLASS_MOUSE__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_DEVCLASS_MOUSE__Loc == GUID_DEVCLASS_MOUSE;
    assume GUID_DEVCLASS_MOUSE != 0;
    call {:si_unique_call 165} GUID_DEVCLASS_ADAPTER__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_DEVCLASS_ADAPTER__Loc == GUID_DEVCLASS_ADAPTER;
    assume GUID_DEVCLASS_ADAPTER != 0;
    call {:si_unique_call 166} GUID_DEVCLASS_INFINIBAND__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_DEVCLASS_INFINIBAND__Loc == GUID_DEVCLASS_INFINIBAND;
    assume GUID_DEVCLASS_INFINIBAND != 0;
    call {:si_unique_call 167} GUID_DEVCLASS_PNPPRINTERS__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_DEVCLASS_PNPPRINTERS__Loc == GUID_DEVCLASS_PNPPRINTERS;
    assume GUID_DEVCLASS_PNPPRINTERS != 0;
    call {:si_unique_call 168} GUID_DEVCLASS_NETCLIENT__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_DEVCLASS_NETCLIENT__Loc == GUID_DEVCLASS_NETCLIENT;
    assume GUID_DEVCLASS_NETCLIENT != 0;
    call {:si_unique_call 169} GUID_DEVCLASS_FSFILTER_INFRASTRUCTURE__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 170} GUID_DEVCLASS_DOT4__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_DEVCLASS_DOT4__Loc == GUID_DEVCLASS_DOT4;
    assume GUID_DEVCLASS_DOT4 != 0;
    call {:si_unique_call 171} GUID_DEVCLASS_FSFILTER_ACTIVITYMONITOR__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 187} servkey__Loc := __HAVOC_malloc_or_null(12);
    assume servkey__Loc == servkey;
    assume servkey != 0;
    call {:si_unique_call 188} GUID_DEVCLASS_FSFILTER_CONTENTSCREENER__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 189} GUID_DEVCLASS_NET__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_DEVCLASS_NET__Loc == GUID_DEVCLASS_NET;
    assume GUID_DEVCLASS_NET != 0;
    call {:si_unique_call 190} GUID_DEVCLASS_FSFILTER_SYSTEMRECOVERY__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 191} GUID_DEVCLASS_SCSIADAPTER__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_DEVCLASS_SCSIADAPTER__Loc == GUID_DEVCLASS_SCSIADAPTER;
    assume GUID_DEVCLASS_SCSIADAPTER != 0;
    call {:si_unique_call 192} GUID_DEVCLASS_FSFILTER_CONTINUOUSBACKUP__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 193} GUID_DEVCLASS_PRINTERUPGRADE__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_DEVCLASS_PRINTERUPGRADE__Loc == GUID_DEVCLASS_PRINTERUPGRADE;
    assume GUID_DEVCLASS_PRINTERUPGRADE != 0;
    call {:si_unique_call 194} GUID_DEVCLASS_VOLUMESNAPSHOT__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_DEVCLASS_VOLUMESNAPSHOT__Loc == GUID_DEVCLASS_VOLUMESNAPSHOT;
    assume GUID_DEVCLASS_VOLUMESNAPSHOT != 0;
    call {:si_unique_call 195} GUID_DEVCLASS_DECODER__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_DEVCLASS_DECODER__Loc == GUID_DEVCLASS_DECODER;
    assume GUID_DEVCLASS_DECODER != 0;
    call {:si_unique_call 196} GUID_DEVCLASS_LEGACYDRIVER__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_DEVCLASS_LEGACYDRIVER__Loc == GUID_DEVCLASS_LEGACYDRIVER;
    assume GUID_DEVCLASS_LEGACYDRIVER != 0;
    call {:si_unique_call 197} GUID_DEVCLASS_FSFILTER_QUOTAMANAGEMENT__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 198} GUID_DEVCLASS_AVC__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_DEVCLASS_AVC__Loc == GUID_DEVCLASS_AVC;
    assume GUID_DEVCLASS_AVC != 0;
    call {:si_unique_call 199} GUID_DEVCLASS_FSFILTER_TOP__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_DEVCLASS_FSFILTER_TOP__Loc == GUID_DEVCLASS_FSFILTER_TOP;
    assume GUID_DEVCLASS_FSFILTER_TOP != 0;
    call {:si_unique_call 200} GUID_DEVCLASS_UNKNOWN__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_DEVCLASS_UNKNOWN__Loc == GUID_DEVCLASS_UNKNOWN;
    assume GUID_DEVCLASS_UNKNOWN != 0;
    call {:si_unique_call 201} GUID_DEVCLASS_FSFILTER_REPLICATION__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 217} MSMCAEvent_PCIComponentError_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 218} MSNdis_FddiLongCurrentAddress_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 219} MSNdis_QueryReceiveFilterHardwareCapabilities_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 228} MSNdis_80211_DesiredDataRates_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 229} MSMCAInfo_Entry_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSMCAInfo_Entry_GUID__Loc == MSMCAInfo_Entry_GUID;
    assume MSMCAInfo_Entry_GUID != 0;
    call {:si_unique_call 230} MSNdis_GroupAffinity_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_GroupAffinity_GUID__Loc == MSNdis_GroupAffinity_GUID;
    assume MSNdis_GroupAffinity_GUID != 0;
    call {:si_unique_call 231} MSNdis_StatusDot11RoamingCompletion_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 232} MSNdis_EthernetCurrentAddress_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 233} MSNdis_TcpOffloadHardwareConfig_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 234} MSNdis_80211_ConfigurationFH_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 235} KernelPerfStateChange_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume KernelPerfStateChange_GUID__Loc == KernelPerfStateChange_GUID;
    assume KernelPerfStateChange_GUID != 0;
    call {:si_unique_call 236} MSNdis_PMCapabilities_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_PMCapabilities_GUID__Loc == MSNdis_PMCapabilities_GUID;
    assume MSNdis_PMCapabilities_GUID != 0;
    call {:si_unique_call 237} MSRedbook_PerformanceGuid__Loc := __HAVOC_malloc_or_null(16);
    assume MSRedbook_PerformanceGuid__Loc == MSRedbook_PerformanceGuid;
    assume MSRedbook_PerformanceGuid != 0;
    call {:si_unique_call 238} MSNdis_StatusDot11RoamingStart_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 239} MSMouse_ClassInformation_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSMouse_ClassInformation_GUID__Loc == MSMouse_ClassInformation_GUID;
    assume MSMouse_ClassInformation_GUID != 0;
    call {:si_unique_call 240} MSNdis_80211_NetworkTypesSupported_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 241} MSNdis_80211_NetworkInfrastructure_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 242} MSNdis_NotifyVcArrival_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_NotifyVcArrival_GUID__Loc == MSNdis_NotifyVcArrival_GUID;
    assume MSNdis_NotifyVcArrival_GUID != 0;
    call {:si_unique_call 243} MSNdis_FddiShortMulticastList_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 244} MSNdis_AtmMaxAal5PacketSize_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_AtmMaxAal5PacketSize_GUID__Loc == MSNdis_AtmMaxAal5PacketSize_GUID;
    assume MSNdis_AtmMaxAal5PacketSize_GUID != 0;
    call {:si_unique_call 245} MSNdis_80211_ReceivedSignalStrengthEventTrigger_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 246} MSNdis_StatusDevicePowerOn_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_StatusDevicePowerOn_GUID__Loc == MSNdis_StatusDevicePowerOn_GUID;
    assume MSNdis_StatusDevicePowerOn_GUID != 0;
    call {:si_unique_call 247} MSKeyboard_ExtendedID_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSKeyboard_ExtendedID_GUID__Loc == MSKeyboard_ExtendedID_GUID;
    assume MSKeyboard_ExtendedID_GUID != 0;
    call {:si_unique_call 248} WHEAErrorSourceMethods_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume WHEAErrorSourceMethods_GUID__Loc == WHEAErrorSourceMethods_GUID;
    assume WHEAErrorSourceMethods_GUID != 0;
    call {:si_unique_call 249} MSNdis_AtmMaxAal34PacketSize_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 250} MSNdis_TokenRingCurrentGroup_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 257} MSMCAEvent_PCIBusError_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSMCAEvent_PCIBusError_GUID__Loc == MSMCAEvent_PCIBusError_GUID;
    assume MSMCAEvent_PCIBusError_GUID != 0;
    call {:si_unique_call 258} MSNdis_StatusMediaConnect_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_StatusMediaConnect_GUID__Loc == MSNdis_StatusMediaConnect_GUID;
    assume MSNdis_StatusMediaConnect_GUID != 0;
    call {:si_unique_call 259} MSNdis_MediaInUse_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_MediaInUse_GUID__Loc == MSNdis_MediaInUse_GUID;
    assume MSNdis_MediaInUse_GUID != 0;
    call {:si_unique_call 260} MSStorageDriver_ScsiInfoExceptions_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 261} WmiMonitorID_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume WmiMonitorID_GUID__Loc == WmiMonitorID_GUID;
    assume WmiMonitorID_GUID != 0;
    call {:si_unique_call 262} MSNdis_ReceiveFilterInfoArray_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 263} MSMCAInfo_RawCorrectedPlatformEvent_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 264} MSNdis_CurrentLookahead_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_CurrentLookahead_GUID__Loc == MSNdis_CurrentLookahead_GUID;
    assume MSNdis_CurrentLookahead_GUID != 0;
    call {:si_unique_call 265} MSStorageDriver_ATAPISmartData_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 266} MSNdis_AtmMaxActiveVciBits_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_AtmMaxActiveVciBits_GUID__Loc == MSNdis_AtmMaxActiveVciBits_GUID;
    assume MSNdis_AtmMaxActiveVciBits_GUID != 0;
    call {:si_unique_call 267} MSNdis_80211_NetworkTypeInUse_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 268} ProcessorPerformance_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume ProcessorPerformance_GUID__Loc == ProcessorPerformance_GUID;
    assume ProcessorPerformance_GUID != 0;
    call {:si_unique_call 269} MSNdis_QueryPhysicalMediumTypeEx_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 270} MSNdis_80211_Configuration_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_80211_Configuration_GUID__Loc == MSNdis_80211_Configuration_GUID;
    assume MSNdis_80211_Configuration_GUID != 0;
    call {:si_unique_call 271} MSMCAEvent_BusError_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSMCAEvent_BusError_GUID__Loc == MSMCAEvent_BusError_GUID;
    assume MSMCAEvent_BusError_GUID != 0;
    call {:si_unique_call 272} MSNdis_MaximumTotalSize_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_MaximumTotalSize_GUID__Loc == MSNdis_MaximumTotalSize_GUID;
    assume MSNdis_MaximumTotalSize_GUID != 0;
    call {:si_unique_call 273} MSNdis_StatusPacketFilterChange_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 274} WmiMonitorBasicDisplayParams_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 275} MSNdis_ReceiveBufferSpace_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_ReceiveBufferSpace_GUID__Loc == MSNdis_ReceiveBufferSpace_GUID;
    assume MSNdis_ReceiveBufferSpace_GUID != 0;
    call {:si_unique_call 276} MSPower_DeviceWakeEnable_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSPower_DeviceWakeEnable_GUID__Loc == MSPower_DeviceWakeEnable_GUID;
    assume MSPower_DeviceWakeEnable_GUID != 0;
    call {:si_unique_call 277} MSNdis_CoVendorId_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_CoVendorId_GUID__Loc == MSNdis_CoVendorId_GUID;
    assume MSNdis_CoVendorId_GUID != 0;
    call {:si_unique_call 278} MSNdis_AtmHardwareCurrentAddress_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 279} MSNdis_WmiTcpIpChecksumOffload_IPv4TransmitReceive_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 280} MSNdis_NdisEnumerateVc_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_NdisEnumerateVc_GUID__Loc == MSNdis_NdisEnumerateVc_GUID;
    assume MSNdis_NdisEnumerateVc_GUID != 0;
    call {:si_unique_call 281} MSNdis_CoMacOptions_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_CoMacOptions_GUID__Loc == MSNdis_CoMacOptions_GUID;
    assume MSNdis_CoMacOptions_GUID != 0;
    call {:si_unique_call 282} MSNdis_FddiShortCurrentAddress_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 296} MSSmBios_Sysid1394List_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSSmBios_Sysid1394List_GUID__Loc == MSSmBios_Sysid1394List_GUID;
    assume MSSmBios_Sysid1394List_GUID != 0;
    call {:si_unique_call 297} MSNdis_TransmitsError_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_TransmitsError_GUID__Loc == MSNdis_TransmitsError_GUID;
    assume MSNdis_TransmitsError_GUID != 0;
    call {:si_unique_call 298} MSNdis_CoMinimumLinkSpeed_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_CoMinimumLinkSpeed_GUID__Loc == MSNdis_CoMinimumLinkSpeed_GUID;
    assume MSNdis_CoMinimumLinkSpeed_GUID != 0;
    call {:si_unique_call 299} MSNdis_QueryReceiveFilterParameters_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 300} MSNdis_QueryNicSwitchCurrentCapabilities_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 301} MSNdis_StatusDot11Disassociation_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 302} MSNdis_NetworkDirectVersion_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_NetworkDirectVersion_GUID__Loc == MSNdis_NetworkDirectVersion_GUID;
    assume MSNdis_NetworkDirectVersion_GUID != 0;
    call {:si_unique_call 303} MSNdis_80211_Disassociate_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_80211_Disassociate_GUID__Loc == MSNdis_80211_Disassociate_GUID;
    assume MSNdis_80211_Disassociate_GUID != 0;
    call {:si_unique_call 304} MSStorageDriver_FailurePredictStatus_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 305} MSNdis_LinkSpeed_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_LinkSpeed_GUID__Loc == MSNdis_LinkSpeed_GUID;
    assume MSNdis_LinkSpeed_GUID != 0;
    call {:si_unique_call 306} MSNdis_WmiReceiveScaleCapabilities_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 307} MSNdis_80211_AddWEP_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_80211_AddWEP_GUID__Loc == MSNdis_80211_AddWEP_GUID;
    assume MSNdis_80211_AddWEP_GUID != 0;
    call {:si_unique_call 308} MSNdis_StatusDevicePowerOnEx_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 309} MSNdis_TokenRingCurrentRingStatus_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 310} IdleStateBucketEx_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume IdleStateBucketEx_GUID__Loc == IdleStateBucketEx_GUID;
    assume IdleStateBucketEx_GUID != 0;
    call {:si_unique_call 311} MSNdis_StatusProtocolBind_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_StatusProtocolBind_GUID__Loc == MSNdis_StatusProtocolBind_GUID;
    assume MSNdis_StatusProtocolBind_GUID != 0;
    call {:si_unique_call 312} MSNdis_TokenRingCurrentFunctional_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 313} MSNdis_FddiFramesLost_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_FddiFramesLost_GUID__Loc == MSNdis_FddiFramesLost_GUID;
    assume MSNdis_FddiFramesLost_GUID != 0;
    call {:si_unique_call 314} MSNdis_InterruptModerationParameters_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 315} KernelIdleStates_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume KernelIdleStates_GUID__Loc == KernelIdleStates_GUID;
    assume KernelIdleStates_GUID != 0;
    call {:si_unique_call 316} MSNdis_PMCapabilitiesParam_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_PMCapabilitiesParam_GUID__Loc == MSNdis_PMCapabilitiesParam_GUID;
    assume MSNdis_PMCapabilitiesParam_GUID != 0;
    call {:si_unique_call 317} MSVerifierIrpLogInformation_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSVerifierIrpLogInformation_GUID__Loc == MSVerifierIrpLogInformation_GUID;
    assume MSVerifierIrpLogInformation_GUID != 0;
    call {:si_unique_call 318} MSNdis_WmiTcpLargeSendOffloadV1_IPv4_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 319} MSNdis_HardwareStatus_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_HardwareStatus_GUID__Loc == MSNdis_HardwareStatus_GUID;
    assume MSNdis_HardwareStatus_GUID != 0;
    call {:si_unique_call 320} MSNdis_WmiTcpLargeSendOffloadV2_IPv4_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 321} MSNdis_PMAdminConfigParam_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_PMAdminConfigParam_GUID__Loc == MSNdis_PMAdminConfigParam_GUID;
    assume MSNdis_PMAdminConfigParam_GUID != 0;
    call {:si_unique_call 322} MSNdis_EthernetReceiveErrorAlignment_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 323} MSNdis_80211_TransmitPowerLevel_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 324} WmiMonitorBrightnessEvent_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume WmiMonitorBrightnessEvent_GUID__Loc == WmiMonitorBrightnessEvent_GUID;
    assume WmiMonitorBrightnessEvent_GUID != 0;
    call {:si_unique_call 325} MSNdis_80211_BaseServiceSetIdentifier_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 333} MSNdis_LinkState_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_LinkState_GUID__Loc == MSNdis_LinkState_GUID;
    assume MSNdis_LinkState_GUID != 0;
    call {:si_unique_call 334} MSNdis_80211_FragmentationThreshold_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 335} WHEAPolicyManagementMethods_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume WHEAPolicyManagementMethods_GUID__Loc == WHEAPolicyManagementMethods_GUID;
    assume WHEAPolicyManagementMethods_GUID != 0;
    call {:si_unique_call 336} MSNdis_NetworkAddress_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_NetworkAddress_GUID__Loc == MSNdis_NetworkAddress_GUID;
    assume MSNdis_NetworkAddress_GUID != 0;
    call {:si_unique_call 337} WmiMonitorDigitalVideoInputParams_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 338} MSNdis_PortStateData_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_PortStateData_GUID__Loc == MSNdis_PortStateData_GUID;
    assume MSNdis_PortStateData_GUID != 0;
    call {:si_unique_call 339} MSNdis_WmiIPSecOffloadV1_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_WmiIPSecOffloadV1_GUID__Loc == MSNdis_WmiIPSecOffloadV1_GUID;
    assume MSNdis_WmiIPSecOffloadV1_GUID != 0;
    call {:si_unique_call 340} MSNdis_80211_TransmitAntennaSelected_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 341} MSTapeDriveParam_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSTapeDriveParam_GUID__Loc == MSTapeDriveParam_GUID;
    assume MSTapeDriveParam_GUID != 0;
    call {:si_unique_call 342} MSSmBios_SysidUUID_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSSmBios_SysidUUID_GUID__Loc == MSSmBios_SysidUUID_GUID;
    assume MSSmBios_SysidUUID_GUID != 0;
    call {:si_unique_call 343} MSNdis_AtmSupportedServiceCategory_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 344} WmiMonitorColorCharacteristics_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 345} MSNdis_DriverVersion_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_DriverVersion_GUID__Loc == MSNdis_DriverVersion_GUID;
    assume MSNdis_DriverVersion_GUID != 0;
    call {:si_unique_call 346} MSNdis_AtmSupportedVcRates_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_AtmSupportedVcRates_GUID__Loc == MSNdis_AtmSupportedVcRates_GUID;
    assume MSNdis_AtmSupportedVcRates_GUID != 0;
    call {:si_unique_call 347} MSNdis_StatusMediaSpecificIndicationEx_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 348} MSNdis_StatusDot11AssociationCompletion_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 349} MSNdis_MediaSupported_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_MediaSupported_GUID__Loc == MSNdis_MediaSupported_GUID;
    assume MSNdis_MediaSupported_GUID != 0;
    call {:si_unique_call 350} MSNdis_QueryReceiveFilterCurrentCapabilities_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 351} KernelThermalConstraintChange_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 359} IdleAccountingEx_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume IdleAccountingEx_GUID__Loc == IdleAccountingEx_GUID;
    assume IdleAccountingEx_GUID != 0;
    call {:si_unique_call 360} MSWmi_GuidRegistrationInfo_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSWmi_GuidRegistrationInfo_GUID__Loc == MSWmi_GuidRegistrationInfo_GUID;
    assume MSWmi_GuidRegistrationInfo_GUID != 0;
    call {:si_unique_call 361} MSMCAInfo_RawCMCEvent_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSMCAInfo_RawCMCEvent_GUID__Loc == MSMCAInfo_RawCMCEvent_GUID;
    assume MSMCAInfo_RawCMCEvent_GUID != 0;
    call {:si_unique_call 362} MSNdis_80211_WEPStatus_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_80211_WEPStatus_GUID__Loc == MSNdis_80211_WEPStatus_GUID;
    assume MSNdis_80211_WEPStatus_GUID != 0;
    call {:si_unique_call 363} MSNdis_StatusExternalConnectivityChange_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 373} MSNdis_TokenRingCurrentAddress_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 374} MSNdis_WmiTcpIpChecksumOffload_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 375} MSNdis_StatusPortState_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_StatusPortState_GUID__Loc == MSNdis_StatusPortState_GUID;
    assume MSNdis_StatusPortState_GUID != 0;
    call {:si_unique_call 376} MSNdis_StatusDot11MPDUMaxLengthChange_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 377} MSNdis_CoMediaInUse_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_CoMediaInUse_GUID__Loc == MSNdis_CoMediaInUse_GUID;
    assume MSNdis_CoMediaInUse_GUID != 0;
    call {:si_unique_call 378} MSNdis_ReceiveQueueParameters_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 379} KernelPerfState_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume KernelPerfState_GUID__Loc == KernelPerfState_GUID;
    assume KernelPerfState_GUID != 0;
    call {:si_unique_call 380} MSSmBios_Sysid1394_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSSmBios_Sysid1394_GUID__Loc == MSSmBios_Sysid1394_GUID;
    assume MSSmBios_Sysid1394_GUID != 0;
    call {:si_unique_call 381} MSNdis_ReceiveQueueInfo_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_ReceiveQueueInfo_GUID__Loc == MSNdis_ReceiveQueueInfo_GUID;
    assume MSNdis_ReceiveQueueInfo_GUID != 0;
    call {:si_unique_call 382} MSNdis_WmiIPSecOffloadV1_Supported_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 383} MSNdis_PMAdminConfigState_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_PMAdminConfigState_GUID__Loc == MSNdis_PMAdminConfigState_GUID;
    assume MSNdis_PMAdminConfigState_GUID != 0;
    call {:si_unique_call 384} MSStorageDriver_FailurePredictFunction_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 385} MSNdis_NotifyAdapterRemoval_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_NotifyAdapterRemoval_GUID__Loc == MSNdis_NotifyAdapterRemoval_GUID;
    assume MSNdis_NotifyAdapterRemoval_GUID != 0;
    call {:si_unique_call 386} MSNdis_FddiShortMaximumListSize_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 387} MSNdis_WmiTcpConnectionOffload_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 388} MSNdis_StatisticsInfo_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_StatisticsInfo_GUID__Loc == MSNdis_StatisticsInfo_GUID;
    assume MSNdis_StatisticsInfo_GUID != 0;
    call {:si_unique_call 389} MSNdis_SetPortParameters_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_SetPortParameters_GUID__Loc == MSNdis_SetPortParameters_GUID;
    assume MSNdis_SetPortParameters_GUID != 0;
    call {:si_unique_call 390} MSNdis_QueryNicSwitchHardwareCapabilities_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 391} WmiMonitorBrightnessMethods_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume WmiMonitorBrightnessMethods_GUID__Loc == WmiMonitorBrightnessMethods_GUID;
    assume WmiMonitorBrightnessMethods_GUID != 0;
    call {:si_unique_call 392} MSNdis_EthernetPermanentAddress_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 393} MSNdis_FddiLongPermanentAddress_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 394} MSNdis_DeviceWakeOnMagicPacketOnly_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 395} MSNdis_PortAuthParameters_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_PortAuthParameters_GUID__Loc == MSNdis_PortAuthParameters_GUID;
    assume MSNdis_PortAuthParameters_GUID != 0;
    call {:si_unique_call 396} MSNdis_WmiTcpLargeSendOffloadV2_IPv6_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 397} MSNdis_CoReceivePdusNoBuffer_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 398} MSNdis_StatusDot11ConnectionStart_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 399} MSNdis_NetworkShortAddress_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_NetworkShortAddress_GUID__Loc == MSNdis_NetworkShortAddress_GUID;
    assume MSNdis_NetworkShortAddress_GUID != 0;
    call {:si_unique_call 400} MSNdis_ObjectHeader_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_ObjectHeader_GUID__Loc == MSNdis_ObjectHeader_GUID;
    assume MSNdis_ObjectHeader_GUID != 0;
    call {:si_unique_call 401} MSNdis_80211_DataRates_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_80211_DataRates_GUID__Loc == MSNdis_80211_DataRates_GUID;
    assume MSNdis_80211_DataRates_GUID != 0;
    call {:si_unique_call 402} MSNdis_StatusOperationalStatus_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 409} MSNdis_EnumeratePorts_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_EnumeratePorts_GUID__Loc == MSNdis_EnumeratePorts_GUID;
    assume MSNdis_EnumeratePorts_GUID != 0;
    call {:si_unique_call 410} MSNdis_AtmReceiveCellsOk_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_AtmReceiveCellsOk_GUID__Loc == MSNdis_AtmReceiveCellsOk_GUID;
    assume MSNdis_AtmReceiveCellsOk_GUID != 0;
    call {:si_unique_call 411} MSNdis_TokenRingCurrentRingState_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 412} MSNdis_WmiMethodHeader_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_WmiMethodHeader_GUID__Loc == MSNdis_WmiMethodHeader_GUID;
    assume MSNdis_WmiMethodHeader_GUID != 0;
    call {:si_unique_call 413} MSNdis_TcpConnectionOffloadCurrentConfig_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 414} MSNdis_TcpConnectionOffloadHardwareConfig_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 415} MSMCAEvent_MemoryHierarchyError_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 416} MSNdis_CoHardwareStatus_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_CoHardwareStatus_GUID__Loc == MSNdis_CoHardwareStatus_GUID;
    assume MSNdis_CoHardwareStatus_GUID != 0;
    call {:si_unique_call 417} MSNdis_PMAdminConfig_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_PMAdminConfig_GUID__Loc == MSNdis_PMAdminConfig_GUID;
    assume MSNdis_PMAdminConfig_GUID != 0;
    call {:si_unique_call 418} MSNdis_PortChar_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_PortChar_GUID__Loc == MSNdis_PortChar_GUID;
    assume MSNdis_PortChar_GUID != 0;
    call {:si_unique_call 419} MSNdis_ReceiveQueueInfoArray_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 420} MSNdis_TokenRingLineErrors_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_TokenRingLineErrors_GUID__Loc == MSNdis_TokenRingLineErrors_GUID;
    assume MSNdis_TokenRingLineErrors_GUID != 0;
    call {:si_unique_call 421} MSNdis_80211_RemoveWEP_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_80211_RemoveWEP_GUID__Loc == MSNdis_80211_RemoveWEP_GUID;
    assume MSNdis_80211_RemoveWEP_GUID != 0;
    call {:si_unique_call 422} MSNdis_QueryInterruptModeration_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 423} MSNdis_NotifyFilterArrival_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_NotifyFilterArrival_GUID__Loc == MSNdis_NotifyFilterArrival_GUID;
    assume MSNdis_NotifyFilterArrival_GUID != 0;
    call {:si_unique_call 424} MSNdis_QueryStatisticsInfo_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_QueryStatisticsInfo_GUID__Loc == MSNdis_QueryStatisticsInfo_GUID;
    assume MSNdis_QueryStatisticsInfo_GUID != 0;
    call {:si_unique_call 425} MSNdis_StatusDot11ConnectionCompletion_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 426} MSMCAEvent_SMBIOSError_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSMCAEvent_SMBIOSError_GUID__Loc == MSMCAEvent_SMBIOSError_GUID;
    assume MSMCAEvent_SMBIOSError_GUID != 0;
    call {:si_unique_call 427} MSKeyboard_ClassInformation_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSKeyboard_ClassInformation_GUID__Loc == MSKeyboard_ClassInformation_GUID;
    assume MSKeyboard_ClassInformation_GUID != 0;
    call {:si_unique_call 428} IdleStateAccounting_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume IdleStateAccounting_GUID__Loc == IdleStateAccounting_GUID;
    assume IdleStateAccounting_GUID != 0;
    call {:si_unique_call 429} MSNdis_NetworkDirectAdapterInfo_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 430} MSNdis_EthernetMoreTransmitCollisions_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 431} MSNdis_StatusDot11TkipmicFailure_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 432} MSNdis_EnumerateAdapter_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_EnumerateAdapter_GUID__Loc == MSNdis_EnumerateAdapter_GUID;
    assume MSNdis_EnumerateAdapter_GUID != 0;
    call {:si_unique_call 433} MSNdis_AtmMaxAal0PacketSize_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_AtmMaxAal0PacketSize_GUID__Loc == MSNdis_AtmMaxAal0PacketSize_GUID;
    assume MSNdis_AtmMaxAal0PacketSize_GUID != 0;
    call {:si_unique_call 434} MSNdis_EthernetOneTransmitCollision_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 435} MSDiskDriver_PerformanceData_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 436} MSNdis_EnumerateReceiveQueues_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 437} MSNdis_StatusDot11LinkQuality_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 438} MSNdis_NotifyAdapterArrival_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_NotifyAdapterArrival_GUID__Loc == MSNdis_NotifyAdapterArrival_GUID;
    assume MSNdis_NotifyAdapterArrival_GUID != 0;
    call {:si_unique_call 439} MSMCAInfo_RawMCAData_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSMCAInfo_RawMCAData_GUID__Loc == MSMCAInfo_RawMCAData_GUID;
    assume MSMCAInfo_RawMCAData_GUID != 0;
    call {:si_unique_call 440} MSMouse_PortInformation_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSMouse_PortInformation_GUID__Loc == MSMouse_PortInformation_GUID;
    assume MSMouse_PortInformation_GUID != 0;
    call {:si_unique_call 441} MSMCAEvent_PlatformSpecificError_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 442} MSMCAEvent_SwitchToCMCPolling_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 443} MSNdis_CoMediaConnectStatus_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_CoMediaConnectStatus_GUID__Loc == MSNdis_CoMediaConnectStatus_GUID;
    assume MSNdis_CoMediaConnectStatus_GUID != 0;
    call {:si_unique_call 444} MSNdis_StatusLinkState_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_StatusLinkState_GUID__Loc == MSNdis_StatusLinkState_GUID;
    assume MSNdis_StatusLinkState_GUID != 0;
    call {:si_unique_call 445} MSAcpi_ThermalZoneTemperature_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 446} MSStorageDriver_FailurePredictData_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 447} MSDeviceUI_FirmwareRevision_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSDeviceUI_FirmwareRevision_GUID__Loc == MSDeviceUI_FirmwareRevision_GUID;
    assume MSDeviceUI_FirmwareRevision_GUID != 0;
    call {:si_unique_call 448} KernelPerfStateDomainChange_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume KernelPerfStateDomainChange_GUID__Loc == KernelPerfStateDomainChange_GUID;
    assume KernelPerfStateDomainChange_GUID != 0;
    call {:si_unique_call 449} MSNdis_ReceiveFilterFieldParameters_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 450} MSNdis_80211_AuthenticationMode_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 451} MSVerifierIrpLogEntry_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSVerifierIrpLogEntry_GUID__Loc == MSVerifierIrpLogEntry_GUID;
    assume MSVerifierIrpLogEntry_GUID != 0;
    call {:si_unique_call 452} WmiMonitorListedFrequencyRanges_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 453} MSNdis_CoVendorDescription_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_CoVendorDescription_GUID__Loc == MSNdis_CoVendorDescription_GUID;
    assume MSNdis_CoVendorDescription_GUID != 0;
    call {:si_unique_call 454} MSNdis_NetworkDirectState_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_NetworkDirectState_GUID__Loc == MSNdis_NetworkDirectState_GUID;
    assume MSNdis_NetworkDirectState_GUID != 0;
    call {:si_unique_call 455} MSNdis_QueryReceiveQueueParameters_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 456} MSMCAInfo_RawMCAEvent_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSMCAInfo_RawMCAEvent_GUID__Loc == MSMCAInfo_RawMCAEvent_GUID;
    assume MSMCAInfo_RawMCAEvent_GUID != 0;
    call {:si_unique_call 457} WmiMonitorRawEEdidV1Block_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume WmiMonitorRawEEdidV1Block_GUID__Loc == WmiMonitorRawEEdidV1Block_GUID;
    assume WmiMonitorRawEEdidV1Block_GUID != 0;
    call {:si_unique_call 458} MSNdis_StatusHDSplitCurrentConfig_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 459} MSMCAEvent_InvalidError_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSMCAEvent_InvalidError_GUID__Loc == MSMCAEvent_InvalidError_GUID;
    assume MSMCAEvent_InvalidError_GUID != 0;
    call {:si_unique_call 460} MSNdis_HDSplitCurrentConfig_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_HDSplitCurrentConfig_GUID__Loc == MSNdis_HDSplitCurrentConfig_GUID;
    assume MSNdis_HDSplitCurrentConfig_GUID != 0;
    call {:si_unique_call 461} KernelIdleState_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume KernelIdleState_GUID__Loc == KernelIdleState_GUID;
    assume KernelIdleState_GUID != 0;
    call {:si_unique_call 462} MSWmi_Guid_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSWmi_Guid_GUID__Loc == MSWmi_Guid_GUID;
    assume MSWmi_Guid_GUID != 0;
    call {:si_unique_call 463} MSMCAEvent_MemoryPageRemoved_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 464} MSTapeProblemIoError_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSTapeProblemIoError_GUID__Loc == MSTapeProblemIoError_GUID;
    assume MSTapeProblemIoError_GUID != 0;
    call {:si_unique_call 465} MSNdis_ReceiveFilterCapabilities_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 466} MSNdis_FddiShortPermanentAddress_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 471} MSTapeDriveProblemEvent_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSTapeDriveProblemEvent_GUID__Loc == MSTapeDriveProblemEvent_GUID;
    assume MSTapeDriveProblemEvent_GUID != 0;
    call {:si_unique_call 472} MSTapeProblemDeviceError_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSTapeProblemDeviceError_GUID__Loc == MSTapeProblemDeviceError_GUID;
    assume MSTapeProblemDeviceError_GUID != 0;
    call {:si_unique_call 473} WmiMonitorListedSupportedSourceModes_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 474} MSNdis_FddiFrameErrors_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_FddiFrameErrors_GUID__Loc == MSNdis_FddiFrameErrors_GUID;
    assume MSNdis_FddiFrameErrors_GUID != 0;
    call {:si_unique_call 475} MSNdis_WmiTcpLargeSendOffloadV2_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 476} MSNdis_NetworkDirectAdapterCapabilities_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 477} WmiMonitorColorXYZinCIE_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume WmiMonitorColorXYZinCIE_GUID__Loc == WmiMonitorColorXYZinCIE_GUID;
    assume WmiMonitorColorXYZinCIE_GUID != 0;
    call {:si_unique_call 478} Microsoft_IPMI_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume Microsoft_IPMI_GUID__Loc == Microsoft_IPMI_GUID;
    assume Microsoft_IPMI_GUID != 0;
    call {:si_unique_call 479} MSNdis_TransmitBufferSpace_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_TransmitBufferSpace_GUID__Loc == MSNdis_TransmitBufferSpace_GUID;
    assume MSNdis_TransmitBufferSpace_GUID != 0;
    call {:si_unique_call 480} MSNdis_CoVendorDriverVersion_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 481} MSNdis_FddiDownstreamNodeLong_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 482} MSNdis_FddiLemRejects_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_FddiLemRejects_GUID__Loc == MSNdis_FddiLemRejects_GUID;
    assume MSNdis_FddiLemRejects_GUID != 0;
    call {:si_unique_call 483} MSNdis_80211_NumberOfAntennas_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 484} IdleStateAccountingEx_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume IdleStateAccountingEx_GUID__Loc == IdleStateAccountingEx_GUID;
    assume IdleStateAccountingEx_GUID != 0;
    call {:si_unique_call 485} MSNdis_80211_WLanBssId_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_80211_WLanBssId_GUID__Loc == MSNdis_80211_WLanBssId_GUID;
    assume MSNdis_80211_WLanBssId_GUID != 0;
    call {:si_unique_call 486} MSNdis_FddiRingManagmentState_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 487} MSSmBios_SysidUUIDList_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSSmBios_SysidUUIDList_GUID__Loc == MSSmBios_SysidUUIDList_GUID;
    assume MSSmBios_SysidUUIDList_GUID != 0;
    call {:si_unique_call 488} MSNdis_ReceiveScaleCapabilities_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 489} MSNdis_QueryReceiveFilterGlobalParameters_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 490} libinfo__Loc := __HAVOC_malloc_or_null(32);
    assume libinfo__Loc == libinfo;
    assume libinfo != 0;
    call {:si_unique_call 491} MSNdis_PMCapabilityState_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_PMCapabilityState_GUID__Loc == MSNdis_PMCapabilityState_GUID;
    assume MSNdis_PMCapabilityState_GUID != 0;
    call {:si_unique_call 492} MSNdis_StatusLinkSpeedChange_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 493} MSNdis_StatusResetEnd_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_StatusResetEnd_GUID__Loc == MSNdis_StatusResetEnd_GUID;
    assume MSNdis_StatusResetEnd_GUID != 0;
    call {:si_unique_call 494} MSNdis_AtmMaxActiveVpiBits_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_AtmMaxActiveVpiBits_GUID__Loc == MSNdis_AtmMaxActiveVpiBits_GUID;
    assume MSNdis_AtmMaxActiveVpiBits_GUID != 0;
    call {:si_unique_call 495} MSNdis_EnumerateReceiveFilters_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 496} MSNdis_StatusMediaDisconnect_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 497} MSParallel_AllocFreeCounts_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSParallel_AllocFreeCounts_GUID__Loc == MSParallel_AllocFreeCounts_GUID;
    assume MSParallel_AllocFreeCounts_GUID != 0;
    call {:si_unique_call 498} WmiMonitorConnectionParams_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume WmiMonitorConnectionParams_GUID__Loc == WmiMonitorConnectionParams_GUID;
    assume WmiMonitorConnectionParams_GUID != 0;
    call {:si_unique_call 499} MSNdis_EthernetMulticastList_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 500} MSNdis_ReceiveFilterGlobalParameters_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 501} MSNdis_80211_NetworkType_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_80211_NetworkType_GUID__Loc == MSNdis_80211_NetworkType_GUID;
    assume MSNdis_80211_NetworkType_GUID != 0;
    call {:si_unique_call 502} MSSerial_HardwareConfiguration_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 509} MSTapeSymbolicName_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSTapeSymbolicName_GUID__Loc == MSTapeSymbolicName_GUID;
    assume MSTapeSymbolicName_GUID != 0;
    call {:si_unique_call 510} MSNdis_ReceiveNoBuffer_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_ReceiveNoBuffer_GUID__Loc == MSNdis_ReceiveNoBuffer_GUID;
    assume MSNdis_ReceiveNoBuffer_GUID != 0;
    call {:si_unique_call 511} MSNdis_WmiEnumAdapter_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_WmiEnumAdapter_GUID__Loc == MSNdis_WmiEnumAdapter_GUID;
    assume MSNdis_WmiEnumAdapter_GUID != 0;
    call {:si_unique_call 512} MSWmi_PnPInstanceNames_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSWmi_PnPInstanceNames_GUID__Loc == MSWmi_PnPInstanceNames_GUID;
    assume MSWmi_PnPInstanceNames_GUID != 0;
    call {:si_unique_call 513} MSNdis_NetworkDirectCapabilities_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 514} MSNdis_StatusResetStart_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_StatusResetStart_GUID__Loc == MSNdis_StatusResetStart_GUID;
    assume MSNdis_StatusResetStart_GUID != 0;
    call {:si_unique_call 515} MSNdis_MaximumFrameSize_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_MaximumFrameSize_GUID__Loc == MSNdis_MaximumFrameSize_GUID;
    assume MSNdis_MaximumFrameSize_GUID != 0;
    call {:si_unique_call 516} MSNdis_WmiSetHeader_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_WmiSetHeader_GUID__Loc == MSNdis_WmiSetHeader_GUID;
    assume MSNdis_WmiSetHeader_GUID != 0;
    call {:si_unique_call 517} MSNdis_80211_ConfigurationInfo_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 518} MSNdis_80211_ServiceSetIdentifier_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 519} MSSerial_PerformanceInformation_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 520} WmiMonitorSupportedDisplayFeatures_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 521} MSNdis_EthernetMaximumMulticastListSize_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 522} MSNdis_SetHDSplitParameters_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_SetHDSplitParameters_GUID__Loc == MSNdis_SetHDSplitParameters_GUID;
    assume MSNdis_SetHDSplitParameters_GUID != 0;
    call {:si_unique_call 523} MSNdis_WmiIPSecOffloadV1_IPv4AH_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 524} MSNdis_TcpOffloadCurrentConfig_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 536} MSSmBios_SMBiosEventlog_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSSmBios_SMBiosEventlog_GUID__Loc == MSSmBios_SMBiosEventlog_GUID;
    assume MSSmBios_SMBiosEventlog_GUID != 0;
    call {:si_unique_call 537} MSNdis_PhysicalMediumType_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_PhysicalMediumType_GUID__Loc == MSNdis_PhysicalMediumType_GUID;
    assume MSNdis_PhysicalMediumType_GUID != 0;
    call {:si_unique_call 538} MSNdis_80211_PowerMode_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_80211_PowerMode_GUID__Loc == MSNdis_80211_PowerMode_GUID;
    assume MSNdis_80211_PowerMode_GUID != 0;
    call {:si_unique_call 539} MSNdis_StatusDot11AssociationStart_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 540} MSNdis_QueryPciDeviceCustomProperty_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 541} MSNdis_80211_ReceivedSignalStrength_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 542} MSSerial_CommProperties_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSSerial_CommProperties_GUID__Loc == MSSerial_CommProperties_GUID;
    assume MSSerial_CommProperties_GUID != 0;
    call {:si_unique_call 543} MSNdis_ReceiveError_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_ReceiveError_GUID__Loc == MSNdis_ReceiveError_GUID;
    assume MSNdis_ReceiveError_GUID != 0;
    call {:si_unique_call 544} MSNdis_80211_InfrastructureMode_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 545} MSNdis_80211_ReceiveAntennaSelected_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 546} MSNdis_StatusTaskOffloadChange_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 547} MSNdis_StatusDot11PhyStateChange_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 548} MSStorageDriver_FailurePredictThresholds_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 549} FrequencyRangeDescriptor_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume FrequencyRangeDescriptor_GUID__Loc == FrequencyRangeDescriptor_GUID;
    assume FrequencyRangeDescriptor_GUID != 0;
    call {:si_unique_call 550} MSNdis_ReceiveBlockSize_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_ReceiveBlockSize_GUID__Loc == MSNdis_ReceiveBlockSize_GUID;
    assume MSNdis_ReceiveBlockSize_GUID != 0;
    call {:si_unique_call 551} MSNdis_TransmitsOk_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_TransmitsOk_GUID__Loc == MSNdis_TransmitsOk_GUID;
    assume MSNdis_TransmitsOk_GUID != 0;
    call {:si_unique_call 552} MSNdis_TokenRingPermanentAddress_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 553} MSNdis_SetInterruptModeration_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 554} MSSmBios_RawSMBiosTables_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSSmBios_RawSMBiosTables_GUID__Loc == MSSmBios_RawSMBiosTables_GUID;
    assume MSSmBios_RawSMBiosTables_GUID != 0;
    call {:si_unique_call 555} MSNdis_WmiTcpLargeSendOffloadV1_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 556} MSNdis_SetTcpOffloadParameters_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 557} MSNdis_CoTransmitPduErrors_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_CoTransmitPduErrors_GUID__Loc == MSNdis_CoTransmitPduErrors_GUID;
    assume MSNdis_CoTransmitPduErrors_GUID != 0;
    call {:si_unique_call 558} MSNdis_PciDeviceProperty_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_PciDeviceProperty_GUID__Loc == MSNdis_PciDeviceProperty_GUID;
    assume MSNdis_PciDeviceProperty_GUID != 0;
    call {:si_unique_call 559} MSNdis_WmiOffload_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_WmiOffload_GUID__Loc == MSNdis_WmiOffload_GUID;
    assume MSNdis_WmiOffload_GUID != 0;
    call {:si_unique_call 560} MSMCAEvent_MemoryError_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSMCAEvent_MemoryError_GUID__Loc == MSMCAEvent_MemoryError_GUID;
    assume MSMCAEvent_MemoryError_GUID != 0;
    call {:si_unique_call 561} MSNdis_WmiIPSecOffloadV1_IPv4ESP_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 562} MSNdis_WmiHDSplitCurrentConfig_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 563} MSStorageDriver_FailurePredictEvent_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 564} WmiMonitorAnalogVideoInputParams_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 565} MSMCAEvent_SwitchToCPEPolling_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 566} MSNdis_CoDriverVersion_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_CoDriverVersion_GUID__Loc == MSNdis_CoDriverVersion_GUID;
    assume MSNdis_CoDriverVersion_GUID != 0;
    call {:si_unique_call 567} MSNdis_FddiLongMulticastList_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 574} boogieTmp := __HAVOC_malloc_or_null(16);
    call {:si_unique_call 575} boogieTmp := __HAVOC_malloc_or_null(16);
    call {:si_unique_call 576} boogieTmp := __HAVOC_malloc_or_null(16);
    call {:si_unique_call 577} boogieTmp := __HAVOC_malloc_or_null(16);
    call {:si_unique_call 578} boogieTmp := __HAVOC_malloc_or_null(4);
    call {:si_unique_call 579} boogieTmp := __HAVOC_malloc_or_null(4);
    ...
    call {:si_unique_call 583} boogieTmp := __HAVOC_malloc_or_null(16);
    call {:si_unique_call 584} boogieTmp := __HAVOC_malloc_or_null(16);
    call {:si_unique_call 585} boogieTmp := __HAVOC_malloc_or_null(16);
    call {:si_unique_call 586} boogieTmp := __HAVOC_malloc_or_null(12);
    call {:si_unique_call 587} boogieTmp := __HAVOC_malloc_or_null(16);
    call {:si_unique_call 588} boogieTmp := __HAVOC_malloc_or_null(4);
    assume sdv_harnessDeviceExtension_two == boogieTmp;
    call {:si_unique_call 589} boogieTmp := __HAVOC_malloc_or_null(4);
    ...
    call {:si_unique_call 593} boogieTmp := __HAVOC_malloc_or_null(240);
    assume sicrni == boogieTmp;
    call {:si_unique_call 594} boogieTmp := __HAVOC_malloc_or_null(4);
    assume KiBugCheckData == boogieTmp;
    call {:si_unique_call 595} boogieTmp := __HAVOC_malloc_or_null(48);
    call {:si_unique_call 596} boogieTmp := __HAVOC_malloc_or_null(16);
    call {:si_unique_call 597} boogieTmp := __HAVOC_malloc_or_null(12);
    call {:si_unique_call 598} boogieTmp := __HAVOC_malloc_or_null(16);
    call {:si_unique_call 599} boogieTmp := __HAVOC_malloc_or_null(16);
    call {:si_unique_call 600} vslice_dummy_var_208 := __HAVOC_malloc(216);
    call {:si_unique_call 601} vslice_dummy_var_209 := __HAVOC_malloc(44);
    call {:si_unique_call 602} vslice_dummy_var_210 := __HAVOC_malloc(44);
    call {:si_unique_call 603} vslice_dummy_var_211 := __HAVOC_malloc(44);
    call {:si_unique_call 604} vslice_dummy_var_212 := __HAVOC_malloc(44);
    call {:si_unique_call 605} vslice_dummy_var_213 := __HAVOC_malloc(96);
    call {:si_unique_call 606} vslice_dummy_var_214 := __HAVOC_malloc(96);
    call {:si_unique_call 607} vslice_dummy_var_215 := __HAVOC_malloc(116);
    call {:si_unique_call 608} vslice_dummy_var_48 := __HAVOC_malloc(4096);
    call {:si_unique_call 609} vslice_dummy_var_216 := __HAVOC_malloc(24);
    call {:si_unique_call 610} vslice_dummy_var_217 := __HAVOC_malloc(44);
    call {:si_unique_call 611} vslice_dummy_var_218 := __HAVOC_malloc(44);
    call {:si_unique_call 612} vslice_dummy_var_219 := __HAVOC_malloc(44);
    call {:si_unique_call 613} vslice_dummy_var_220 := __HAVOC_malloc(48);
    call {:si_unique_call 614} vslice_dummy_var_221 := __HAVOC_malloc(44);
    call {:si_unique_call 615} vslice_dummy_var_49 := __HAVOC_malloc(236);
    call {:si_unique_call 616} vslice_dummy_var_222 := __HAVOC_malloc(44);
    call {:si_unique_call 617} vslice_dummy_var_223 := __HAVOC_malloc(208);
    call {:si_unique_call 618} vslice_dummy_var_50 := __HAVOC_malloc(4096);
    call {:si_unique_call 619} vslice_dummy_var_224 := __HAVOC_malloc(224);
    call {:si_unique_call 620} vslice_dummy_var_51 := __HAVOC_malloc(12);
    call {:si_unique_call 621} vslice_dummy_var_225 := __HAVOC_malloc(44);
    call {:si_unique_call 622} vslice_dummy_var_226 := __HAVOC_malloc(44);
    assume {:mainInitDone} true;
    call {:si_unique_call 623} corralExtraInit();
    call {:si_unique_call 624} corralExplainErrorInit();
    call {:si_unique_call 625} _sdv_init16();
    call {:si_unique_call 626} _sdv_init1();
    call {:si_unique_call 627} _sdv_init5();
    call {:si_unique_call 628} _sdv_init4();
    call {:si_unique_call 629} _sdv_init3();
    call {:si_unique_call 630} _sdv_init14();
    call {:si_unique_call 631} _sdv_init6();
    call {:si_unique_call 632} _sdv_init10();
    call {:si_unique_call 633} _sdv_init11();
    call {:si_unique_call 634} _sdv_init9();
    call {:si_unique_call 635} _sdv_init12();
    call {:si_unique_call 636} _sdv_init13();
    call {:si_unique_call 637} _sdv_init7();
    call {:si_unique_call 638} _sdv_init8();
    call {:si_unique_call 639} _sdv_init2();
  ...
  L43:
    ...
    call {:si_unique_call 640} sdv_main();
    goto anon12_Then, anon12_Else;
...
implementation {:origName "sdv_IoSkipCurrentIrpStackLocation"} {:osmodel} sdv_IoSkipCurrentIrpStackLocation(actual_pirp_7: int)
{
  ...
  anon0:
    call {:si_unique_call 641} vslice_dummy_var_21 := __HAVOC_malloc(4);
...
implementation {:origName "_sdv_init14"} {:osmodel} _sdv_init14()
{
  ...
  anon0:
    call {:si_unique_call 642} vslice_dummy_var_22 := __HAVOC_malloc(4);
...
implementation {:origName "sdv_IoMarkIrpPending"} {:osmodel} sdv_IoMarkIrpPending(actual_pirp_8: int)
{
  ...
  anon0:
    call {:si_unique_call 643} vslice_dummy_var_23 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "sdv_IoCompleteRequest"} {:osmodel} sdv_IoCompleteRequest(actual_pirp_9: int, actual_PriorityBoost: int)
{
  ...
  anon0:
    call {:si_unique_call 644} vslice_dummy_var_24 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "ExFreePoolWithTag"} {:osmodel} ExFreePoolWithTag(actual_P: int, actual_Tag: int)
{
  ...
  anon0:
    call {:si_unique_call 645} vslice_dummy_var_25 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "sdv_IoAcquireRemoveLock"} {:osmodel} sdv_IoAcquireRemoveLock(actual_RemoveLock: int, actual_Tag_1: int) returns (Tmp_162: int)
{
  ...
  L1:
    call {:si_unique_call 646} SLIC_sdv_IoAcquireRemoveLock_exit(0, Tmp_162);
    return;
...
procedure {:origName "IofCallDriver"} {:osmodel} IofCallDriver(actual_DeviceObject_3: int, actual_Irp_7: int) returns (Tmp_164: int);
  modifies alloc, sdv_compFset, sdv_invoke_on_cancel, LockDepth, yogi_error;
  free ensures {:va_keep} yogi_error == 1 || yogi_error == old(yogi_error);
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);
...
implementation {:origName "IofCallDriver"} {:osmodel} IofCallDriver(actual_DeviceObject_3: int, actual_Irp_7: int) returns (Tmp_164: int)
{
  ...
  anon0:
    call {:si_unique_call 647} completion_1 := __HAVOC_malloc(4);
    Irp_7 := actual_Irp_7;
  ...
  anon55_Then:
    ...
    call {:si_unique_call 648} vslice_dummy_var_26 := sdv_RunIoCompletionRoutines#1(sdv_p_devobj_fdo, Irp_7, vslice_dummy_var_227, completion_1);
  ...
  anon67_Else:
    ...
    call {:si_unique_call 649} vslice_dummy_var_29 := sdv_RunIoCompletionRoutines#1(sdv_p_devobj_fdo, Irp_7, vslice_dummy_var_228, completion_1);
  ...
  anon59_Else:
    ...
    call {:si_unique_call 650} vslice_dummy_var_27 := sdv_RunIoCompletionRoutines#1(sdv_p_devobj_fdo, Irp_7, vslice_dummy_var_229, completion_1);
  ...
  anon63_Else:
    ...
    call {:si_unique_call 651} vslice_dummy_var_28 := sdv_RunIoCompletionRoutines#1(sdv_p_devobj_fdo, Irp_7, vslice_dummy_var_230, completion_1);
...
implementation {:origName "sdv_IoCallDriver"} {:osmodel} sdv_IoCallDriver(actual_DeviceObject_5: int, actual_Irp_9: int) returns (Tmp_168: int)
{
  ...
  anon0:
    Irp_9 := actual_Irp_9;
    call {:si_unique_call 652} Tmp_168 := IofCallDriver(0, Irp_9);
    goto anon3_Then, anon3_Else;
...
implementation {:origName "sdv_stub_driver_init"} {:osmodel} sdv_stub_driver_init()
{
  ...
  anon0:
    call {:si_unique_call 653} vslice_dummy_var_30 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "sdv_stub_dispatch_begin"} {:osmodel} sdv_stub_dispatch_begin()
{
  ...
  anon0:
    call {:si_unique_call 654} vslice_dummy_var_31 := __HAVOC_malloc(4);
    return;
}



procedure {:origName "SLIC_sdv_IoAcquireRemoveLock_exit"} {:osmodel} SLIC_sdv_IoAcquireRemoveLock_exit(actual_caller_5: int, actual_sdv_42: int);
  modifies LockDepth;
  free ensures {:va_keep} LockDepth >= old(LockDepth);
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);
...
implementation {:origName "SLIC_sdv_IoAcquireRemoveLock_exit"} {:osmodel} SLIC_sdv_IoAcquireRemoveLock_exit(actual_caller_5: int, actual_sdv_42: int)
{
  ...
  anon9_Then:
    assume {:partition} sdv_42 != 0;
    call {:si_unique_call 655} SLIC_EXIT_ROUTINE(strConst__li2bpl4);
    goto L2;
...
procedure {:origName "SLIC_sdv_RunIoCompletionRoutines_exit"} {:osmodel} SLIC_sdv_RunIoCompletionRoutines_exit(actual_caller_14: int, actual_sdv_43: int);
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);



implementation {:origName "SLIC_sdv_RunIoCompletionRoutines_exit"} {:osmodel} SLIC_sdv_RunIoCompletionRoutines_exit(actual_caller_14: int, actual_sdv_43: int)
{
  ...
  anon3_Else:
    call {:si_unique_call 656} SLIC_EXIT_ROUTINE(strConst__li2bpl4);
    goto L2;
...
implementation {:origName "SLIC_ABORT_17_0"} SLIC_ABORT_17_0(actual_caller_15: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 657} SLIC_ERROR_ROUTINE(strConst__li2bpl7);
    return;
}



procedure {:origName "SLIC_ABORT_27_0"} SLIC_ABORT_27_0(actual_caller_19: int, actual_DispatchControl_1: int);
  modifies yogi_error;
  free ensures {:va_keep} old(LockDepth) != 0 ==> yogi_error == 1;
  free ensures {:va_keep} old(LockDepth) == 0 ==> yogi_error == 1;
  free ensures {:va_keep} yogi_error == 1;
...
implementation {:origName "SLIC_ABORT_27_0"} SLIC_ABORT_27_0(actual_caller_19: int, actual_DispatchControl_1: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 658} SLIC_ERROR_ROUTINE(strConst__li2bpl5);
    return;
}
...
implementation {:origName "SLIC_sdv_IoReleaseRemoveLock_entry"} {:osmodel} SLIC_sdv_IoReleaseRemoveLock_entry(actual_caller_23: int)
{
  ...
  anon5_Then:
    assume {:partition} LockDepth == 0;
    call {:si_unique_call 659} SLIC_ABORT_17_0(caller_23);
    goto anon6_Then, anon6_Else;
...
procedure {:origName "SLIC_DispatchControl_exit"} {:osmodel} SLIC_DispatchControl_exit(actual_caller_24: int, actual_DispatchControl_2: int);
  modifies yogi_error;
  free ensures {:va_keep} old(LockDepth) != 0 ==> yogi_error == 1;
  free ensures {:va_keep} old(LockDepth) == 0 ==> yogi_error == 0;
  free ensures {:va_keep} old(LockDepth) == 0 ==> yogi_error == 1;
...
implementation {:origName "SLIC_DispatchControl_exit"} {:osmodel} SLIC_DispatchControl_exit(actual_caller_24: int, actual_DispatchControl_2: int)
{
  ...
  L6:
    call {:si_unique_call 660} SLIC_EXIT_ROUTINE(strConst__li2bpl4);
    goto L2;
  ...
  anon7_Then:
    call {:si_unique_call 661} SLIC_ABORT_27_0(caller_24, DispatchControl_2);
    goto anon9_Then, anon9_Else;
...
procedure {:origName "CompleteRequest2"} CompleteRequest2(actual_Irp_10: int, actual_status_8: int) returns (Tmp_181: int);
  modifies alloc;
  free ensures {:va_keep} Tmp_181 == actual_status_8;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);



implementation {:origName "CompleteRequest2"} CompleteRequest2(actual_Irp_10: int, actual_status_8: int) returns (Tmp_181: int)
{
...
procedure {:origName "CompleteRequest"} CompleteRequest(actual_Irp_11: int, actual_status_9: int, actual_info: int) returns (Tmp_183: int);
  modifies alloc;
  free ensures {:va_keep} Tmp_183 == actual_status_9;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);



implementation {:origName "CompleteRequest"} CompleteRequest(actual_Irp_11: int, actual_status_9: int, actual_info: int) returns (Tmp_183: int)
{
...
procedure {:origName "OnRequestComplete"} OnRequestComplete(actual_fdo_1: int, actual_Irp_12: int, actual_pev: int) returns (Tmp_185: int);
  free ensures {:va_keep} Tmp_185 == -1073741802;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);



implementation {:origName "OnRequestComplete"} OnRequestComplete(actual_fdo_1: int, actual_Irp_12: int, actual_pev: int) returns (Tmp_185: int)
{
  var {:pointer} pev: int;
  ...
  anon0:
    pev := actual_pev;
    call {:si_unique_call 664} vslice_dummy_var_32 := KeSetEvent(pev, 0, 0);
    Tmp_185 := -1073741802;
    return;
}
...
implementation {:origName "_sdv_init3"} _sdv_init3()
{
  ...
  anon0:
    call {:si_unique_call 665} vslice_dummy_var_33 := __HAVOC_malloc(4);
    call {:si_unique_call 666} Tmp_189 := __HAVOC_malloc(4);
...
implementation {:origName "_sdv_init4"} _sdv_init4()
{
  ...
  anon0:
    call {:si_unique_call 667} vslice_dummy_var_34 := __HAVOC_malloc(4);
    call {:si_unique_call 668} Tmp_192 := __HAVOC_malloc(4);
...
implementation {:origName "_sdv_init5"} _sdv_init5()
{
  ...
  anon0:
    call {:si_unique_call 669} vslice_dummy_var_35 := __HAVOC_malloc(4);
    call {:si_unique_call 670} Tmp_195 := __HAVOC_malloc(4);
...
implementation {:origName "_sdv_init1"} _sdv_init1()
{
  ...
  anon0:
    call {:si_unique_call 671} vslice_dummy_var_36 := __HAVOC_malloc(4);
    return;
}
...
const {:string "D:P(A;;GA;;;BA)(A;;GA;;;NS)(A;;GA;;;LS)(A;;GA;;;SY)"} unique strConst__li2bpl8: int;

const {:string "Dispatch returned with an invalid RemoveLock state"} unique strConst__li2bpl5: int;
...
const {:string "The driver is calling sdv_IoReleaseRemoveLock without first acquiring the Removelock."} unique strConst__li2bpl7: int;
...
const {:string "\\registry\\machine\\System\\CurrentControlSet\\Control\\IPMI"} unique strConst__li2bpl9: int;
...
implementation {:origName "HandlePowerEvent"} HandlePowerEvent#0(actual_ctx: int, actual_event: int) returns (Tmp_21: int)
{
  ...
  anon0:
    call {:si_unique_call 672} powstate := __HAVOC_malloc(8);
    ctx := actual_ctx;
    event := actual_event;
    call {:si_unique_call 673} Tmp_24 := __HAVOC_malloc(4);
    call {:si_unique_call 674} Tmp_28 := __HAVOC_malloc(4);
    call {:si_unique_call 675} Tmp_30 := __HAVOC_malloc(4);
    call {:si_unique_call 676} Tmp_32 := __HAVOC_malloc(4);
    call {:si_unique_call 677} Tmp_39 := __HAVOC_malloc(12);
    call {:si_unique_call 678} Tmp_42 := __HAVOC_malloc(4);
    call {:si_unique_call 679} Tmp_43 := __HAVOC_malloc(4);
    loopBreak := 0;
    Irp := 0;
    stack := 0;
    pdx := 0;
  ...
  anon124_Else:
    havoc Tmp_26;
    havoc Tmp_25;
    call {:si_unique_call 680} WPP_SF_(Tmp_25, 18, Tmp_26);
    goto L22;
  ...
  anon135_Else:
    havoc Tmp_36;
    havoc Tmp_41;
    call {:si_unique_call 681} WPP_SF_D(Tmp_41, 19, Tmp_36, -1073741811);
    goto L202;
  ...
  anon125_Then:
    assume {:partition} Irp != 0;
    call {:si_unique_call 682} stack := sdv_IoGetCurrentIrpStackLocation(Irp);
  ...
  anon134_Else:
    havoc Tmp_27;
    havoc Tmp_31;
    call {:si_unique_call 683} WPP_SF_D(Tmp_31, 20, Tmp_27, -1073741811);
    goto L194;
  ...
  anon133_Else:
    havoc Tmp_40;
    havoc Tmp_34;
    call {:si_unique_call 684} WPP_SF_D(Tmp_34, 21, Tmp_40, -1073741811);
    goto L186;
  ...
  L47:
    call {:si_unique_call 685} Tmp_22, Tmp_23, postatus, Tmp_30, status, loopBreak, sysstate, Tmp_44, state_1, boogieTmp, vslice_dummy_var_37 := HandlePowerEvent#0_loop_L47(Tmp_22, Tmp_23, Irp, postatus, pdx, Tmp_30, status, loopBreak, sysstate, stack, Tmp_44, state_1, powstate, ctx, boogieTmp, vslice_dummy_var_37);
    goto L47_last;
  ...
  anon127_Else:
    havoc Tmp_37;
    havoc Tmp_35;
    call {:si_unique_call 686} WPP_SF_D(Tmp_35, 23, Tmp_37, status);
    goto L53;
  ...
  L99:
    ...
    assume {:nonnull} ctx != 0;
    assume ctx > 0;
    call {:si_unique_call 687} boogieTmp := GetLowestDevicePowerState(pdx, sysstate);
    assume {:nonnull} ctx != 0;
    assume ctx > 0;
    assume {:nonnull} stack != 0;
    assume stack > 0;
    ...
    call {:si_unique_call 688} postatus := PoRequestPowerIrp#0(vslice_dummy_var_231, vslice_dummy_var_232, powstate, li2bplFunctionConstant5, ctx, 0);
  ...
  anon132_Else:
    havoc Tmp_22;
    havoc Tmp_44;
    call {:si_unique_call 689} WPP_SF_D(Tmp_44, 22, Tmp_22, postatus);
    goto L118;
  ...
  anon119_Then:
    assume {:partition} state_1 == 4;
    call {:si_unique_call 690} PoStartNextPowerIrp(0);
    assume {:nonnull} ctx != 0;
    assume ctx > 0;
  ...
  L282:
    ...
    assume {:nonnull} pdx != 0;
    assume pdx > 0;
    call {:si_unique_call 692} vslice_dummy_var_37 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(pdx), Irp);
    goto anon129_Then, anon129_Else;

  anon129_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 693} ExFreePoolWithTag(0, -917680055);
    status := -1073741802;
    loopBreak := 1;
  ...
  anon121_Then:
    assume {:partition} state_1 == 2;
    call {:si_unique_call 694} PoStartNextPowerIrp(0);
    assume {:nonnull} Irp != 0;
    assume Irp > 0;
  ...
  anon122_Then:
    assume {:partition} state_1 == 1;
    call {:si_unique_call 696} status := sdv_IoAcquireRemoveLock(0, 0);
  ...
  L158:
    call {:si_unique_call 697} sdv_IoMarkIrpPending(0);
    call {:si_unique_call 698} sdv_IoCopyCurrentIrpStackLocationToNext(Irp);
    assume {:nonnull} stack != 0;
    assume stack > 0;
    goto anon108_Then, anon108_Else;

  anon108_Else:
    call {:si_unique_call 699} sdv_IoSetCompletionRoutine(Irp, li2bplFunctionConstant3, ctx, 1, 1, 1);
    goto L171;

  L171:
    call {:si_unique_call 700} PoStartNextPowerIrp(0);
    call {:si_unique_call 701} status := PoCallDriver#0(0, Irp);
  ...
  anon108_Then:
    call {:si_unique_call 702} sdv_IoSetCompletionRoutine(Irp, li2bplFunctionConstant4, ctx, 1, 1, 1);
    goto L171;
...
implementation {:origName "HandlePowerEvent"} HandlePowerEvent#1(actual_ctx: int, actual_event: int) returns (Tmp_21: int)
{
  ...
  anon0:
    call {:si_unique_call 703} powstate := __HAVOC_malloc(8);
    ctx := actual_ctx;
    event := actual_event;
    call {:si_unique_call 704} Tmp_24 := __HAVOC_malloc(4);
    call {:si_unique_call 705} Tmp_28 := __HAVOC_malloc(4);
    call {:si_unique_call 706} Tmp_30 := __HAVOC_malloc(4);
    call {:si_unique_call 707} Tmp_32 := __HAVOC_malloc(4);
    call {:si_unique_call 708} Tmp_39 := __HAVOC_malloc(12);
    call {:si_unique_call 709} Tmp_42 := __HAVOC_malloc(4);
    call {:si_unique_call 710} Tmp_43 := __HAVOC_malloc(4);
    loopBreak := 0;
    Irp := 0;
    stack := 0;
    pdx := 0;
  ...
  anon124_Else:
    havoc Tmp_26;
    havoc Tmp_25;
    call {:si_unique_call 711} WPP_SF_(Tmp_25, 18, Tmp_26);
    goto L22;
  ...
  anon135_Else:
    havoc Tmp_36;
    havoc Tmp_41;
    call {:si_unique_call 712} WPP_SF_D(Tmp_41, 19, Tmp_36, -1073741811);
    goto L202;
  ...
  anon125_Then:
    assume {:partition} Irp != 0;
    call {:si_unique_call 713} stack := sdv_IoGetCurrentIrpStackLocation(Irp);
    goto anon91_Then, anon91_Else;
  ...
  anon134_Else:
    havoc Tmp_27;
    havoc Tmp_31;
    call {:si_unique_call 714} WPP_SF_D(Tmp_31, 20, Tmp_27, -1073741811);
    goto L194;
  ...
  anon133_Else:
    havoc Tmp_40;
    havoc Tmp_34;
    call {:si_unique_call 715} WPP_SF_D(Tmp_34, 21, Tmp_40, -1073741811);
    goto L186;
  ...
  L47:
    call {:si_unique_call 716} Tmp_22, Tmp_23, postatus, Tmp_30, status, loopBreak, sysstate, Tmp_44, state_1, boogieTmp, vslice_dummy_var_38 := HandlePowerEvent#1_loop_L47(Tmp_22, Tmp_23, Irp, postatus, pdx, Tmp_30, status, loopBreak, sysstate, stack, Tmp_44, state_1, powstate, ctx, boogieTmp, vslice_dummy_var_38);
    goto L47_last;
  ...
  anon127_Else:
    havoc Tmp_37;
    havoc Tmp_35;
    call {:si_unique_call 717} WPP_SF_D(Tmp_35, 23, Tmp_37, status);
    goto L53;
  ...
  L99:
    ...
    assume {:nonnull} ctx != 0;
    assume ctx > 0;
    call {:si_unique_call 718} boogieTmp := GetLowestDevicePowerState(pdx, sysstate);
    assume {:nonnull} ctx != 0;
    assume ctx > 0;
    assume {:nonnull} stack != 0;
    assume stack > 0;
    ...
    call {:si_unique_call 719} postatus := PoRequestPowerIrp#1(vslice_dummy_var_233, vslice_dummy_var_234, powstate, li2bplFunctionConstant5, ctx, 0);
    goto anon131_Then, anon131_Else;
  ...
  anon132_Else:
    havoc Tmp_22;
    havoc Tmp_44;
    call {:si_unique_call 720} WPP_SF_D(Tmp_44, 22, Tmp_22, postatus);
    goto L118;
  ...
  anon119_Then:
    assume {:partition} state_1 == 4;
    call {:si_unique_call 721} PoStartNextPowerIrp(0);
    assume {:nonnull} ctx != 0;
    assume ctx > 0;
    goto anon103_Then, anon103_Else;
  ...
  L282:
    ...
    assume {:nonnull} pdx != 0;
    assume pdx > 0;
    call {:si_unique_call 723} vslice_dummy_var_38 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(pdx), Irp);
    goto anon129_Then, anon129_Else;

  anon129_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 724} ExFreePoolWithTag(0, -917680055);
    status := -1073741802;
    loopBreak := 1;
    goto anon129_Else_dummy;
  ...
  anon121_Then:
    assume {:partition} state_1 == 2;
    call {:si_unique_call 725} PoStartNextPowerIrp(0);
    assume {:nonnull} Irp != 0;
    assume Irp > 0;
  ...
  anon122_Then:
    assume {:partition} state_1 == 1;
    call {:si_unique_call 727} status := sdv_IoAcquireRemoveLock(0, 0);
    goto anon104_Then, anon104_Else;
  ...
  L158:
    call {:si_unique_call 728} sdv_IoMarkIrpPending(0);
    call {:si_unique_call 729} sdv_IoCopyCurrentIrpStackLocationToNext(Irp);
    assume {:nonnull} stack != 0;
    assume stack > 0;
    goto anon108_Then, anon108_Else;

  anon108_Else:
    call {:si_unique_call 730} sdv_IoSetCompletionRoutine(Irp, li2bplFunctionConstant3, ctx, 1, 1, 1);
    goto L171;

  L171:
    call {:si_unique_call 731} PoStartNextPowerIrp(0);
    call {:si_unique_call 732} status := PoCallDriver#1(0, Irp);
    goto anon128_Then, anon128_Else;
  ...
  anon108_Then:
    call {:si_unique_call 733} sdv_IoSetCompletionRoutine(Irp, li2bplFunctionConstant4, ctx, 1, 1, 1);
    goto L171;
...
implementation {:origName "PoCallDriver"} {:osmodel} PoCallDriver#0(actual_DeviceObject: int, actual_Irp_4: int) returns (Tmp_128: int)
{
  ...
  anon0:
    call {:si_unique_call 734} completion := __HAVOC_malloc(4);
    Irp_4 := actual_Irp_4;
...
implementation {:origName "PoCallDriver"} {:osmodel} PoCallDriver#1(actual_DeviceObject: int, actual_Irp_4: int) returns (Tmp_128: int)
{
  ...
  anon0:
    call {:si_unique_call 735} completion := __HAVOC_malloc(4);
    Irp_4 := actual_Irp_4;
    assume {:nonnull} completion != 0;
    assume completion > 0;
    status_5 := 259;
  ...
  anon56_Then:
    ...
    call {:si_unique_call 736} vslice_dummy_var_39 := sdv_RunIoCompletionRoutines#0(sdv_p_devobj_fdo, Irp_4, vslice_dummy_var_235, completion);
    goto anon76_Then, anon76_Else;
  ...
  anon68_Else:
    ...
    call {:si_unique_call 737} vslice_dummy_var_42 := sdv_RunIoCompletionRoutines#0(sdv_p_devobj_fdo, Irp_4, vslice_dummy_var_236, completion);
    goto anon78_Then, anon78_Else;
  ...
  anon60_Else:
    ...
    call {:si_unique_call 738} vslice_dummy_var_40 := sdv_RunIoCompletionRoutines#0(sdv_p_devobj_fdo, Irp_4, vslice_dummy_var_237, completion);
    goto anon74_Then, anon74_Else;
  ...
  anon64_Else:
    ...
    call {:si_unique_call 739} vslice_dummy_var_41 := sdv_RunIoCompletionRoutines#0(sdv_p_devobj_fdo, Irp_4, vslice_dummy_var_238, completion);
    goto anon72_Then, anon72_Else;
...
implementation {:origName "sdv_RunIoCompletionRoutines"} {:osmodel} sdv_RunIoCompletionRoutines#0(actual_DeviceObject_4: int, actual_Irp_8: int, actual_Context_6: int, actual_Completion: int) returns (Tmp_166: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 740} irpsp := sdv_IoGetNextIrpStackLocation(Irp_8);
    Status := 0;
    assume {:nonnull} irpsp != 0;
    assume irpsp > 0;
    goto anon13_Then, anon13_Else;
  ...
  anon13_Else:
    call {:si_unique_call 741} Status := MainDeviceCompletionRoutine#0(DeviceObject_4, Irp_8, Context_6);
    goto anon14_Then, anon14_Else;
  ...
  anon11_Else:
    call {:si_unique_call 742} Status := MainSystemCompletionRoutine#0(DeviceObject_4, Irp_8, Context_6);
    goto anon15_Then, anon15_Else;
  ...
  anon12_Else:
    call {:si_unique_call 743} Status := OnRequestComplete(DeviceObject_4, Irp_8, Context_6);
    assume {:nonnull} Completion != 0;
    assume Completion > 0;
    goto L45;
  ...
  L45:
    Tmp_166 := Status;
    call {:si_unique_call 744} SLIC_sdv_RunIoCompletionRoutines_exit(0, Completion);
    goto LM2;
...
implementation {:origName "sdv_RunIoCompletionRoutines"} {:osmodel} sdv_RunIoCompletionRoutines#1(actual_DeviceObject_4: int, actual_Irp_8: int, actual_Context_6: int, actual_Completion: int) returns (Tmp_166: int)
{
  ...
  anon0:
    ...
    Context_6 := actual_Context_6;
    Completion := actual_Completion;
    call {:si_unique_call 745} irpsp := sdv_IoGetNextIrpStackLocation(Irp_8);
    Status := 0;
    assume {:nonnull} irpsp != 0;
    assume irpsp > 0;
    goto anon13_Then, anon13_Else;
  ...
  anon13_Else:
    call {:si_unique_call 746} Status := MainDeviceCompletionRoutine#1(DeviceObject_4, Irp_8, Context_6);
    goto anon14_Then, anon14_Else;
  ...
  anon11_Else:
    call {:si_unique_call 747} Status := MainSystemCompletionRoutine#1(DeviceObject_4, Irp_8, Context_6);
    goto anon15_Then, anon15_Else;
  ...
  anon12_Else:
    call {:si_unique_call 748} Status := OnRequestComplete(DeviceObject_4, Irp_8, Context_6);
    assume {:nonnull} Completion != 0;
    assume Completion > 0;
    goto L45;
  ...
  L45:
    Tmp_166 := Status;
    call {:si_unique_call 749} SLIC_sdv_RunIoCompletionRoutines_exit(0, Completion);
    goto LM2;
...
implementation {:origName "MainDeviceCompletionRoutine"} MainDeviceCompletionRoutine#0(actual_junk_2: int, actual_Irp_2: int, actual_Context_2: int) returns (Tmp_72: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 750} Tmp_76 := __HAVOC_malloc(4);
    call {:si_unique_call 751} Tmp_77 := __HAVOC_malloc(4);
    status_2 := 0;
    ctx_3 := Context_2;
    goto anon14_Then, anon14_Else;
  ...
  anon15_Else:
    havoc Tmp_78;
    havoc Tmp_73;
    call {:si_unique_call 752} WPP_SF_(Tmp_73, 26, Tmp_78);
    goto L11;
  ...
  L19:
    call {:si_unique_call 754} status_2 := HandlePowerEvent#0(ctx_3, 1);
  ...
  anon18_Else:
    havoc Tmp_75;
    havoc Tmp_79;
    call {:si_unique_call 755} WPP_SF_D(Tmp_79, 27, Tmp_75, status_2);
    goto L30;
...
implementation {:origName "MainDeviceCompletionRoutine"} MainDeviceCompletionRoutine#1(actual_junk_2: int, actual_Irp_2: int, actual_Context_2: int) returns (Tmp_72: int)
{
  ...
  anon0:
    Irp_2 := actual_Irp_2;
    Context_2 := actual_Context_2;
    call {:si_unique_call 756} Tmp_76 := __HAVOC_malloc(4);
    call {:si_unique_call 757} Tmp_77 := __HAVOC_malloc(4);
    status_2 := 0;
    ctx_3 := Context_2;
    goto anon14_Then, anon14_Else;
  ...
  anon15_Else:
    havoc Tmp_78;
    havoc Tmp_73;
    call {:si_unique_call 758} WPP_SF_(Tmp_73, 26, Tmp_78);
    goto L11;
  ...
  L19:
    call {:si_unique_call 760} status_2 := HandlePowerEvent#1(ctx_3, 1);
    goto anon17_Then, anon17_Else;
  ...
  anon18_Else:
    havoc Tmp_75;
    havoc Tmp_79;
    call {:si_unique_call 761} WPP_SF_D(Tmp_79, 27, Tmp_75, status_2);
    goto L30;
...
implementation {:origName "MainSystemCompletionRoutine"} MainSystemCompletionRoutine#0(actual_junk: int, actual_Irp_1: int, actual_Context: int) returns (Tmp_45: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 762} Tmp_47 := __HAVOC_malloc(4);
    call {:si_unique_call 763} Tmp_51 := __HAVOC_malloc(4);
    status_1 := 0;
    ctx_1 := Context;
    goto anon15_Then, anon15_Else;
  ...
  anon16_Else:
    havoc Tmp_46;
    havoc Tmp_49;
    call {:si_unique_call 764} WPP_SF_(Tmp_49, 24, Tmp_46);
    goto L11;
  ...
  anon13_Else:
    call {:si_unique_call 765} sdv_IoMarkIrpPending(0);
    goto L18;
  ...
  L18:
    ...
    assume ctx_1 > 0;
    call {:si_unique_call 766} status_1 := HandlePowerEvent#0(ctx_1, 1);
    goto anon17_Then, anon17_Else;
  ...
  anon18_Else:
    havoc Tmp_50;
    havoc Tmp_48;
    call {:si_unique_call 767} WPP_SF_D(Tmp_48, 25, Tmp_50, status_1);
    goto L30;
...
implementation {:origName "MainSystemCompletionRoutine"} MainSystemCompletionRoutine#1(actual_junk: int, actual_Irp_1: int, actual_Context: int) returns (Tmp_45: int)
{
  ...
  anon0:
    Irp_1 := actual_Irp_1;
    Context := actual_Context;
    call {:si_unique_call 768} Tmp_47 := __HAVOC_malloc(4);
    call {:si_unique_call 769} Tmp_51 := __HAVOC_malloc(4);
    status_1 := 0;
    ctx_1 := Context;
    goto anon15_Then, anon15_Else;
  ...
  anon16_Else:
    havoc Tmp_46;
    havoc Tmp_49;
    call {:si_unique_call 770} WPP_SF_(Tmp_49, 24, Tmp_46);
    goto L11;
  ...
  anon13_Else:
    call {:si_unique_call 771} sdv_IoMarkIrpPending(0);
    goto L18;
  ...
  L18:
    ...
    assume {:nonnull} ctx_1 != 0;
    assume ctx_1 > 0;
    call {:si_unique_call 772} status_1 := HandlePowerEvent#1(ctx_1, 1);
    goto anon17_Then, anon17_Else;
  ...
  anon18_Else:
    havoc Tmp_50;
    havoc Tmp_48;
    call {:si_unique_call 773} WPP_SF_D(Tmp_48, 25, Tmp_50, status_1);
    goto L30;
...
implementation {:origName "PoRequestPowerIrp"} {:osmodel} PoRequestPowerIrp#0(actual_DeviceObject_1: int, actual_MinorFunction: int, actual_SD1: int, actual_CompletionFunction: int, actual_Context_4: int, actual_Irp_6: int) returns (Tmp_142: int)
{
  ...
  anon0:
    call {:si_unique_call 774} PowerState_1 := __HAVOC_malloc(8);
  ...
  anon11_Else:
    ...
    assume {:nonnull} sdv_power_irp != 0;
    assume sdv_power_irp > 0;
    call {:si_unique_call 775} vslice_dummy_var_43 := sdv_RunPowerCompletionRoutines#0(DeviceObject_1, MinorFunction, PowerState_1, Context_4, IoStatus__IRP(sdv_power_irp), CompletionFunction);
    goto anon15_Then, anon15_Else;
...
implementation {:origName "PoRequestPowerIrp"} {:osmodel} PoRequestPowerIrp#1(actual_DeviceObject_1: int, actual_MinorFunction: int, actual_SD1: int, actual_CompletionFunction: int, actual_Context_4: int, actual_Irp_6: int) returns (Tmp_142: int)
{
  ...
  anon0:
    call {:si_unique_call 776} PowerState_1 := __HAVOC_malloc(8);
    DeviceObject_1 := actual_DeviceObject_1;
    MinorFunction := actual_MinorFunction;
    SD1 := actual_SD1;
    CompletionFunction := actual_CompletionFunction;
  ...
  anon11_Else:
    ...
    assume {:nonnull} sdv_power_irp != 0;
    assume sdv_power_irp > 0;
    call {:si_unique_call 777} vslice_dummy_var_44 := sdv_RunPowerCompletionRoutines#1(DeviceObject_1, MinorFunction, PowerState_1, Context_4, IoStatus__IRP(sdv_power_irp), CompletionFunction);
    goto anon15_Then, anon15_Else;
...
implementation {:origName "sdv_RunPowerCompletionRoutines"} {:osmodel} sdv_RunPowerCompletionRoutines#0(actual_DeviceObject_2: int, actual_MinorFunction_1: int, actual_structPtr888PowerState: int, actual_Context_5: int, actual_IoStatus: int, actual_CompletionFunction_1: int) returns (Tmp_150: int)
{
  ...
  anon0:
    call {:si_unique_call 778} PowerState := __HAVOC_malloc(8);
  ...
  anon5_Else:
    ...
    call {:si_unique_call 779} sdv_stub_power_completion_begin();
    call {:si_unique_call 780} PowerCompletionRoutine#0(DeviceObject_2, MinorFunction_1, PowerState, Context_5, IoStatus);
    goto anon6_Then, anon6_Else;
...
implementation {:origName "sdv_RunPowerCompletionRoutines"} {:osmodel} sdv_RunPowerCompletionRoutines#1(actual_DeviceObject_2: int, actual_MinorFunction_1: int, actual_structPtr888PowerState: int, actual_Context_5: int, actual_IoStatus: int, actual_CompletionFunction_1: int) returns (Tmp_150: int)
{
  ...
  anon0:
    call {:si_unique_call 781} PowerState := __HAVOC_malloc(8);
    DeviceObject_2 := actual_DeviceObject_2;
    MinorFunction_1 := actual_MinorFunction_1;
    structPtr888PowerState := actual_structPtr888PowerState;
    Context_5 := actual_Context_5;
  ...
  anon5_Else:
    assume {:partition} CompletionFunction_1 == li2bplFunctionConstant5;
    call {:si_unique_call 782} sdv_stub_power_completion_begin();
    call {:si_unique_call 783} PowerCompletionRoutine#1(DeviceObject_2, MinorFunction_1, PowerState, Context_5, IoStatus);
    goto anon6_Then, anon6_Else;
...
implementation {:origName "PowerCompletionRoutine"} PowerCompletionRoutine#0(actual_junk_1: int, actual_fcn: int, actual_structPtr888state: int, actual_Context_1: int, actual_pstatus: int)
{
  ...
  anon0:
    call {:si_unique_call 784} state := __HAVOC_malloc(8);
    call {:si_unique_call 785} vslice_dummy_var_45 := __HAVOC_malloc(4);
    ...
    assume {:nonnull} structPtr888state != 0;
    assume structPtr888state > 0;
    call {:si_unique_call 786} Tmp_54 := __HAVOC_malloc(4);
    call {:si_unique_call 787} Tmp_60 := __HAVOC_malloc(4);
    ctx_2 := Context_1;
    goto anon12_Then, anon12_Else;
  ...
  anon13_Else:
    havoc Tmp_57;
    havoc Tmp_56;
    call {:si_unique_call 788} WPP_SF_(Tmp_56, 28, Tmp_57);
    goto L9;
...
implementation {:origName "PowerCompletionRoutine"} PowerCompletionRoutine#1(actual_junk_1: int, actual_fcn: int, actual_structPtr888state: int, actual_Context_1: int, actual_pstatus: int)
{
  ...
  anon0:
    call {:si_unique_call 789} state := __HAVOC_malloc(8);
    call {:si_unique_call 790} vslice_dummy_var_46 := __HAVOC_malloc(4);
    structPtr888state := actual_structPtr888state;
    Context_1 := actual_Context_1;
    pstatus := actual_pstatus;
    assume {:nonnull} state != 0;
    ...
    assume {:nonnull} structPtr888state != 0;
    assume structPtr888state > 0;
    call {:si_unique_call 791} Tmp_54 := __HAVOC_malloc(4);
    call {:si_unique_call 792} Tmp_60 := __HAVOC_malloc(4);
    ctx_2 := Context_1;
    goto anon12_Then, anon12_Else;
  ...
  anon13_Else:
    havoc Tmp_57;
    havoc Tmp_56;
    call {:si_unique_call 793} WPP_SF_(Tmp_56, 28, Tmp_57);
    goto L9;
  ...
  L9:
    ...
    assume {:nonnull} pstatus != 0;
    assume pstatus > 0;
    call {:si_unique_call 794} vslice_dummy_var_47 := HandlePowerEvent#0(ctx_2, 2);
    goto anon14_Then, anon14_Else;
  ...
  anon15_Else:
    havoc Tmp_55;
    havoc Tmp_58;
    call {:si_unique_call 795} WPP_SF_(Tmp_58, 29, Tmp_55);
    goto L1;
...
implementation HandlePowerEvent#0_loop_L47(in_Tmp_22: int, in_Tmp_23: int, in_Irp: int, in_postatus: int, in_pdx: int, in_Tmp_30: int, in_status: int, in_loopBreak: int, in_sysstate: int, in_stack: int, in_Tmp_44: int, in_state_1: int, in_powstate: int, in_ctx: int, in_boogieTmp: int, in_vslice_dummy_var_37: int) returns (out_Tmp_22: int, out_Tmp_23: int, out_postatus: int, out_Tmp_30: int, out_status: int, out_loopBreak: int, out_sysstate: int, out_Tmp_44: int, out_state_1: int, out_boogieTmp: int, out_vslice_dummy_var_37: int)
{
  ...
  anon98_Else_dummy:
    call {:si_unique_call 796} {:si_old_unique_call 1} out_Tmp_22, out_Tmp_23, out_postatus, out_Tmp_30, out_status, out_loopBreak, out_sysstate, out_Tmp_44, out_state_1, out_boogieTmp, out_vslice_dummy_var_37 := HandlePowerEvent#0_loop_L47(out_Tmp_22, out_Tmp_23, in_Irp, out_postatus, in_pdx, out_Tmp_30, out_status, out_loopBreak, out_sysstate, in_stack, out_Tmp_44, out_state_1, in_powstate, in_ctx, out_boogieTmp, out_vslice_dummy_var_37);
    return;
  ...
  L74_dummy:
    call {:si_unique_call 797} {:si_old_unique_call 2} out_Tmp_22, out_Tmp_23, out_postatus, out_Tmp_30, out_status, out_loopBreak, out_sysstate, out_Tmp_44, out_state_1, out_boogieTmp, out_vslice_dummy_var_37 := HandlePowerEvent#0_loop_L47(out_Tmp_22, out_Tmp_23, in_Irp, out_postatus, in_pdx, out_Tmp_30, out_status, out_loopBreak, out_sysstate, in_stack, out_Tmp_44, out_state_1, in_powstate, in_ctx, out_boogieTmp, out_vslice_dummy_var_37);
    return;
  ...
  anon99_Else_dummy:
    call {:si_unique_call 799} {:si_old_unique_call 4} out_Tmp_22, out_Tmp_23, out_postatus, out_Tmp_30, out_status, out_loopBreak, out_sysstate, out_Tmp_44, out_state_1, out_boogieTmp, out_vslice_dummy_var_37 := HandlePowerEvent#0_loop_L47(out_Tmp_22, out_Tmp_23, in_Irp, out_postatus, in_pdx, out_Tmp_30, out_status, out_loopBreak, out_sysstate, in_stack, out_Tmp_44, out_state_1, in_powstate, in_ctx, out_boogieTmp, out_vslice_dummy_var_37);
    return;
  ...
  L80_dummy:
    call {:si_unique_call 800} {:si_old_unique_call 5} out_Tmp_22, out_Tmp_23, out_postatus, out_Tmp_30, out_status, out_loopBreak, out_sysstate, out_Tmp_44, out_state_1, out_boogieTmp, out_vslice_dummy_var_37 := HandlePowerEvent#0_loop_L47(out_Tmp_22, out_Tmp_23, in_Irp, out_postatus, in_pdx, out_Tmp_30, out_status, out_loopBreak, out_sysstate, in_stack, out_Tmp_44, out_state_1, in_powstate, in_ctx, out_boogieTmp, out_vslice_dummy_var_37);
    return;
  ...
  anon100_Else_dummy:
    call {:si_unique_call 801} {:si_old_unique_call 6} out_Tmp_22, out_Tmp_23, out_postatus, out_Tmp_30, out_status, out_loopBreak, out_sysstate, out_Tmp_44, out_state_1, out_boogieTmp, out_vslice_dummy_var_37 := HandlePowerEvent#0_loop_L47(out_Tmp_22, out_Tmp_23, in_Irp, out_postatus, in_pdx, out_Tmp_30, out_status, out_loopBreak, out_sysstate, in_stack, out_Tmp_44, out_state_1, in_powstate, in_ctx, out_boogieTmp, out_vslice_dummy_var_37);
    return;
  ...
  L99:
    ...
    assume {:nonnull} in_ctx != 0;
    assume in_ctx > 0;
    call {:si_unique_call 804} out_boogieTmp := GetLowestDevicePowerState(in_pdx, out_sysstate);
    assume {:nonnull} in_ctx != 0;
    assume in_ctx > 0;
    assume {:nonnull} in_stack != 0;
    assume in_stack > 0;
    ...
    call {:si_unique_call 805} out_postatus := PoRequestPowerIrp#0(vslice_dummy_var_239, vslice_dummy_var_240, in_powstate, li2bplFunctionConstant5, in_ctx, 0);
    goto anon131_Else;
  ...
  anon132_Else:
    havoc out_Tmp_22;
    havoc out_Tmp_44;
    call {:si_unique_call 803} WPP_SF_D(out_Tmp_44, 22, out_Tmp_22, out_postatus);
    goto L118;
  ...
  L118_dummy:
    call {:si_unique_call 806} {:si_old_unique_call 8} out_Tmp_22, out_Tmp_23, out_postatus, out_Tmp_30, out_status, out_loopBreak, out_sysstate, out_Tmp_44, out_state_1, out_boogieTmp, out_vslice_dummy_var_37 := HandlePowerEvent#0_loop_L47(out_Tmp_22, out_Tmp_23, in_Irp, out_postatus, in_pdx, out_Tmp_30, out_status, out_loopBreak, out_sysstate, in_stack, out_Tmp_44, out_state_1, in_powstate, in_ctx, out_boogieTmp, out_vslice_dummy_var_37);
    return;
  ...
  L282:
    ...
    assume {:nonnull} in_pdx != 0;
    assume in_pdx > 0;
    call {:si_unique_call 810} out_vslice_dummy_var_37 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(in_pdx), in_Irp);
    goto anon129_Else;

  anon129_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 808} ExFreePoolWithTag(0, -917680055);
    out_status := -1073741802;
    out_loopBreak := 1;
    goto anon129_Else_dummy;

  anon129_Else_dummy:
    call {:si_unique_call 812} {:si_old_unique_call 10} out_Tmp_22, out_Tmp_23, out_postatus, out_Tmp_30, out_status, out_loopBreak, out_sysstate, out_Tmp_44, out_state_1, out_boogieTmp, out_vslice_dummy_var_37 := HandlePowerEvent#0_loop_L47(out_Tmp_22, out_Tmp_23, in_Irp, out_postatus, in_pdx, out_Tmp_30, out_status, out_loopBreak, out_sysstate, in_stack, out_Tmp_44, out_state_1, in_powstate, in_ctx, out_boogieTmp, out_vslice_dummy_var_37);
    return;
  ...
  anon121_Then:
    assume {:partition} out_state_1 == 2;
    call {:si_unique_call 813} PoStartNextPowerIrp(0);
    assume {:nonnull} in_Irp != 0;
    assume in_Irp > 0;
  ...
  anon121_Then_dummy:
    call {:si_unique_call 815} {:si_old_unique_call 11} out_Tmp_22, out_Tmp_23, out_postatus, out_Tmp_30, out_status, out_loopBreak, out_sysstate, out_Tmp_44, out_state_1, out_boogieTmp, out_vslice_dummy_var_37 := HandlePowerEvent#0_loop_L47(out_Tmp_22, out_Tmp_23, in_Irp, out_postatus, in_pdx, out_Tmp_30, out_status, out_loopBreak, out_sysstate, in_stack, out_Tmp_44, out_state_1, in_powstate, in_ctx, out_boogieTmp, out_vslice_dummy_var_37);
    return;

  anon122_Then:
    assume {:partition} out_state_1 == 1;
    call {:si_unique_call 816} out_status := sdv_IoAcquireRemoveLock(0, 0);
    goto anon104_Then, anon104_Else;
  ...
  anon104_Else_dummy:
    call {:si_unique_call 817} {:si_old_unique_call 12} out_Tmp_22, out_Tmp_23, out_postatus, out_Tmp_30, out_status, out_loopBreak, out_sysstate, out_Tmp_44, out_state_1, out_boogieTmp, out_vslice_dummy_var_37 := HandlePowerEvent#0_loop_L47(out_Tmp_22, out_Tmp_23, in_Irp, out_postatus, in_pdx, out_Tmp_30, out_status, out_loopBreak, out_sysstate, in_stack, out_Tmp_44, out_state_1, in_powstate, in_ctx, out_boogieTmp, out_vslice_dummy_var_37);
    return;
  ...
  L158:
    ...
    call {:si_unique_call 823} sdv_IoCopyCurrentIrpStackLocationToNext(in_Irp);
    assume {:nonnull} in_stack != 0;
    assume in_stack > 0;
    goto anon108_Then, anon108_Else;

  anon108_Else:
    call {:si_unique_call 820} sdv_IoSetCompletionRoutine(in_Irp, li2bplFunctionConstant3, in_ctx, 1, 1, 1);
    goto L171;

  L171:
    call {:si_unique_call 818} PoStartNextPowerIrp(0);
    call {:si_unique_call 819} out_status := PoCallDriver#0(0, in_Irp);
    goto anon128_Else;
  ...
  anon128_Else_dummy:
    call {:si_unique_call 824} {:si_old_unique_call 13} out_Tmp_22, out_Tmp_23, out_postatus, out_Tmp_30, out_status, out_loopBreak, out_sysstate, out_Tmp_44, out_state_1, out_boogieTmp, out_vslice_dummy_var_37 := HandlePowerEvent#0_loop_L47(out_Tmp_22, out_Tmp_23, in_Irp, out_postatus, in_pdx, out_Tmp_30, out_status, out_loopBreak, out_sysstate, in_stack, out_Tmp_44, out_state_1, in_powstate, in_ctx, out_boogieTmp, out_vslice_dummy_var_37);
    return;

  anon108_Then:
    call {:si_unique_call 821} sdv_IoSetCompletionRoutine(in_Irp, li2bplFunctionConstant4, in_ctx, 1, 1, 1);
    goto L171;
...
implementation HandlePowerEvent#1_loop_L47(in_Tmp_22: int, in_Tmp_23: int, in_Irp: int, in_postatus: int, in_pdx: int, in_Tmp_30: int, in_status: int, in_loopBreak: int, in_sysstate: int, in_stack: int, in_Tmp_44: int, in_state_1: int, in_powstate: int, in_ctx: int, in_boogieTmp: int, in_vslice_dummy_var_38: int) returns (out_Tmp_22: int, out_Tmp_23: int, out_postatus: int, out_Tmp_30: int, out_status: int, out_loopBreak: int, out_sysstate: int, out_Tmp_44: int, out_state_1: int, out_boogieTmp: int, out_vslice_dummy_var_38: int)
{
  ...
  anon98_Else_dummy:
    call {:si_unique_call 825} {:si_old_unique_call 1} out_Tmp_22, out_Tmp_23, out_postatus, out_Tmp_30, out_status, out_loopBreak, out_sysstate, out_Tmp_44, out_state_1, out_boogieTmp, out_vslice_dummy_var_38 := HandlePowerEvent#1_loop_L47(out_Tmp_22, out_Tmp_23, in_Irp, out_postatus, in_pdx, out_Tmp_30, out_status, out_loopBreak, out_sysstate, in_stack, out_Tmp_44, out_state_1, in_powstate, in_ctx, out_boogieTmp, out_vslice_dummy_var_38);
    return;
  ...
  L74_dummy:
    call {:si_unique_call 826} {:si_old_unique_call 2} out_Tmp_22, out_Tmp_23, out_postatus, out_Tmp_30, out_status, out_loopBreak, out_sysstate, out_Tmp_44, out_state_1, out_boogieTmp, out_vslice_dummy_var_38 := HandlePowerEvent#1_loop_L47(out_Tmp_22, out_Tmp_23, in_Irp, out_postatus, in_pdx, out_Tmp_30, out_status, out_loopBreak, out_sysstate, in_stack, out_Tmp_44, out_state_1, in_powstate, in_ctx, out_boogieTmp, out_vslice_dummy_var_38);
    return;
  ...
  anon99_Else_dummy:
    call {:si_unique_call 828} {:si_old_unique_call 4} out_Tmp_22, out_Tmp_23, out_postatus, out_Tmp_30, out_status, out_loopBreak, out_sysstate, out_Tmp_44, out_state_1, out_boogieTmp, out_vslice_dummy_var_38 := HandlePowerEvent#1_loop_L47(out_Tmp_22, out_Tmp_23, in_Irp, out_postatus, in_pdx, out_Tmp_30, out_status, out_loopBreak, out_sysstate, in_stack, out_Tmp_44, out_state_1, in_powstate, in_ctx, out_boogieTmp, out_vslice_dummy_var_38);
    return;
  ...
  L80_dummy:
    call {:si_unique_call 829} {:si_old_unique_call 5} out_Tmp_22, out_Tmp_23, out_postatus, out_Tmp_30, out_status, out_loopBreak, out_sysstate, out_Tmp_44, out_state_1, out_boogieTmp, out_vslice_dummy_var_38 := HandlePowerEvent#1_loop_L47(out_Tmp_22, out_Tmp_23, in_Irp, out_postatus, in_pdx, out_Tmp_30, out_status, out_loopBreak, out_sysstate, in_stack, out_Tmp_44, out_state_1, in_powstate, in_ctx, out_boogieTmp, out_vslice_dummy_var_38);
    return;
  ...
  anon100_Else_dummy:
    call {:si_unique_call 830} {:si_old_unique_call 6} out_Tmp_22, out_Tmp_23, out_postatus, out_Tmp_30, out_status, out_loopBreak, out_sysstate, out_Tmp_44, out_state_1, out_boogieTmp, out_vslice_dummy_var_38 := HandlePowerEvent#1_loop_L47(out_Tmp_22, out_Tmp_23, in_Irp, out_postatus, in_pdx, out_Tmp_30, out_status, out_loopBreak, out_sysstate, in_stack, out_Tmp_44, out_state_1, in_powstate, in_ctx, out_boogieTmp, out_vslice_dummy_var_38);
    return;
  ...
  anon100_Then_dummy:
    call {:si_unique_call 831} {:si_old_unique_call 7} out_Tmp_22, out_Tmp_23, out_postatus, out_Tmp_30, out_status, out_loopBreak, out_sysstate, out_Tmp_44, out_state_1, out_boogieTmp, out_vslice_dummy_var_38 := HandlePowerEvent#1_loop_L47(out_Tmp_22, out_Tmp_23, in_Irp, out_postatus, in_pdx, out_Tmp_30, out_status, out_loopBreak, out_sysstate, in_stack, out_Tmp_44, out_state_1, in_powstate, in_ctx, out_boogieTmp, out_vslice_dummy_var_38);
    return;
  ...
  L99:
    ...
    assume {:nonnull} in_ctx != 0;
    assume in_ctx > 0;
    call {:si_unique_call 833} out_boogieTmp := GetLowestDevicePowerState(in_pdx, out_sysstate);
    assume {:nonnull} in_ctx != 0;
    assume in_ctx > 0;
    assume {:nonnull} in_stack != 0;
    assume in_stack > 0;
    ...
    call {:si_unique_call 834} out_postatus := PoRequestPowerIrp#1(vslice_dummy_var_241, vslice_dummy_var_242, in_powstate, li2bplFunctionConstant5, in_ctx, 0);
    goto anon131_Else;
  ...
  anon132_Else:
    havoc out_Tmp_22;
    havoc out_Tmp_44;
    call {:si_unique_call 832} WPP_SF_D(out_Tmp_44, 22, out_Tmp_22, out_postatus);
    goto L118;
  ...
  L118_dummy:
    call {:si_unique_call 835} {:si_old_unique_call 8} out_Tmp_22, out_Tmp_23, out_postatus, out_Tmp_30, out_status, out_loopBreak, out_sysstate, out_Tmp_44, out_state_1, out_boogieTmp, out_vslice_dummy_var_38 := HandlePowerEvent#1_loop_L47(out_Tmp_22, out_Tmp_23, in_Irp, out_postatus, in_pdx, out_Tmp_30, out_status, out_loopBreak, out_sysstate, in_stack, out_Tmp_44, out_state_1, in_powstate, in_ctx, out_boogieTmp, out_vslice_dummy_var_38);
    return;
  ...
  anon101_Then_dummy:
    call {:si_unique_call 836} {:si_old_unique_call 9} out_Tmp_22, out_Tmp_23, out_postatus, out_Tmp_30, out_status, out_loopBreak, out_sysstate, out_Tmp_44, out_state_1, out_boogieTmp, out_vslice_dummy_var_38 := HandlePowerEvent#1_loop_L47(out_Tmp_22, out_Tmp_23, in_Irp, out_postatus, in_pdx, out_Tmp_30, out_status, out_loopBreak, out_sysstate, in_stack, out_Tmp_44, out_state_1, in_powstate, in_ctx, out_boogieTmp, out_vslice_dummy_var_38);
    return;
  ...
  L282:
    ...
    assume {:nonnull} in_pdx != 0;
    assume in_pdx > 0;
    call {:si_unique_call 839} out_vslice_dummy_var_38 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(in_pdx), in_Irp);
    goto anon129_Else;

  anon129_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 837} ExFreePoolWithTag(0, -917680055);
    out_status := -1073741802;
    out_loopBreak := 1;
    goto anon129_Else_dummy;
  ...
  anon121_Then:
    assume {:partition} out_state_1 == 2;
    call {:si_unique_call 842} PoStartNextPowerIrp(0);
    assume {:nonnull} in_Irp != 0;
    assume in_Irp > 0;
  ...
  anon121_Then_dummy:
    call {:si_unique_call 844} {:si_old_unique_call 11} out_Tmp_22, out_Tmp_23, out_postatus, out_Tmp_30, out_status, out_loopBreak, out_sysstate, out_Tmp_44, out_state_1, out_boogieTmp, out_vslice_dummy_var_38 := HandlePowerEvent#1_loop_L47(out_Tmp_22, out_Tmp_23, in_Irp, out_postatus, in_pdx, out_Tmp_30, out_status, out_loopBreak, out_sysstate, in_stack, out_Tmp_44, out_state_1, in_powstate, in_ctx, out_boogieTmp, out_vslice_dummy_var_38);
    return;

  anon122_Then:
    assume {:partition} out_state_1 == 1;
    call {:si_unique_call 845} out_status := sdv_IoAcquireRemoveLock(0, 0);
    goto anon104_Then, anon104_Else;
  ...
  anon104_Else_dummy:
    call {:si_unique_call 846} {:si_old_unique_call 12} out_Tmp_22, out_Tmp_23, out_postatus, out_Tmp_30, out_status, out_loopBreak, out_sysstate, out_Tmp_44, out_state_1, out_boogieTmp, out_vslice_dummy_var_38 := HandlePowerEvent#1_loop_L47(out_Tmp_22, out_Tmp_23, in_Irp, out_postatus, in_pdx, out_Tmp_30, out_status, out_loopBreak, out_sysstate, in_stack, out_Tmp_44, out_state_1, in_powstate, in_ctx, out_boogieTmp, out_vslice_dummy_var_38);
    return;
  ...
  L158:
    ...
    call {:si_unique_call 852} sdv_IoCopyCurrentIrpStackLocationToNext(in_Irp);
    assume {:nonnull} in_stack != 0;
    assume in_stack > 0;
    goto anon108_Then, anon108_Else;

  anon108_Else:
    call {:si_unique_call 849} sdv_IoSetCompletionRoutine(in_Irp, li2bplFunctionConstant3, in_ctx, 1, 1, 1);
    goto L171;

  L171:
    call {:si_unique_call 847} PoStartNextPowerIrp(0);
    call {:si_unique_call 848} out_status := PoCallDriver#1(0, in_Irp);
    goto anon128_Else;
  ...
  anon128_Else_dummy:
    call {:si_unique_call 853} {:si_old_unique_call 13} out_Tmp_22, out_Tmp_23, out_postatus, out_Tmp_30, out_status, out_loopBreak, out_sysstate, out_Tmp_44, out_state_1, out_boogieTmp, out_vslice_dummy_var_38 := HandlePowerEvent#1_loop_L47(out_Tmp_22, out_Tmp_23, in_Irp, out_postatus, in_pdx, out_Tmp_30, out_status, out_loopBreak, out_sysstate, in_stack, out_Tmp_44, out_state_1, in_powstate, in_ctx, out_boogieTmp, out_vslice_dummy_var_38);
    return;

  anon108_Then:
    call {:si_unique_call 850} sdv_IoSetCompletionRoutine(in_Irp, li2bplFunctionConstant4, in_ctx, 1, 1, 1);
    goto L171;
