...
procedure {:origName "sdv_RunSurpriseRemoveDevice"} {:osmodel} sdv_RunSurpriseRemoveDevice(actual_po: int, actual_pirp: int) returns (Tmp_3: int);
  modifies alloc, Mem_T.Status__IO_STATUS_BLOCK, Mem_T.Item__DEVICE_START_WORKER, Mem_T.Irp__DEVICE_START_WORKER, sdv_compFset, sdv_invoke_on_success, sdv_invoke_on_error, sdv_invoke_on_cancel, Mem_T.Buffer__UNICODE_STRING, Mem_T.Length_unnamed_tag_18, Mem_T.MaximumLength__UNICODE_STRING, Mem_T.P_DEVICE_OBJECT;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);
...
procedure {:origName "sdv_containing_record"} {:osmodel} sdv_containing_record(actual_Address: int, actual_FieldOffset: int) returns (Tmp_7: int);
  free ensures {:va_keep} Tmp_7 == actual_Address;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);



implementation {:origName "sdv_containing_record"} {:osmodel} sdv_containing_record(actual_Address: int, actual_FieldOffset: int) returns (Tmp_7: int)
{
...
procedure {:origName "IoUnregisterPlugPlayNotification"} {:osmodel} IoUnregisterPlugPlayNotification(actual_NotificationEntry: int) returns (Tmp_9: int);
  free ensures {:va_keep} Tmp_9 == 0 || Tmp_9 == -1073741823;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);



implementation {:origName "IoUnregisterPlugPlayNotification"} {:osmodel} IoUnregisterPlugPlayNotification(actual_NotificationEntry: int) returns (Tmp_9: int)
{
...
procedure {:origName "sdv_RunAddDevice"} {:osmodel} sdv_RunAddDevice(actual_p1: int, actual_p2: int) returns (Tmp_15: int);
...
implementation {:origName "sdv_RunAddDevice"} {:osmodel} sdv_RunAddDevice(actual_p1: int, actual_p2: int) returns (Tmp_15: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 7} status_1 := KeyboardAddDevice(p1, p2);
...
procedure {:origName "IoGetDeviceProperty"} {:osmodel} IoGetDeviceProperty(actual_DeviceObject: int, actual_DeviceProperty: int, actual_BufferLength: int, actual_PropertyBuffer: int, actual_ResultLength: int) returns (Tmp_17: int);
  free ensures {:va_keep} Tmp_17 == -1073741584 || Tmp_17 == -1073741808 || Tmp_17 == -1073741823 || Tmp_17 == 0 || Tmp_17 == -1073741789;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);



implementation {:origName "IoGetDeviceProperty"} {:osmodel} IoGetDeviceProperty(actual_DeviceObject: int, actual_DeviceProperty: int, actual_BufferLength: int, actual_PropertyBuffer: int, actual_ResultLength: int) returns (Tmp_17: int)
{
  var {:scalar} L: int;
...
procedure {:origName "sdv_IoGetNextIrpStackLocation"} {:osmodel} sdv_IoGetNextIrpStackLocation(actual_pirp_2: int) returns (Tmp_19: int);
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);



implementation {:origName "sdv_IoGetNextIrpStackLocation"} {:osmodel} sdv_IoGetNextIrpStackLocation(actual_pirp_2: int) returns (Tmp_19: int)
{
...
procedure {:origName "IoCreateDevice"} {:osmodel} IoCreateDevice(actual_DriverObject: int, actual_DeviceExtensionSize: int, actual_DeviceName: int, actual_DeviceType: int, actual_DeviceCharacteristics: int, actual_Exclusive: int, actual_DeviceObject_1: int) returns (Tmp_23: int);
  modifies Mem_T.P_DEVICE_OBJECT;
  free ensures {:va_keep} Tmp_23 == -1073741824 || Tmp_23 == -1073741771 || Tmp_23 == -1073741670 || Tmp_23 == -1073741823 || Tmp_23 == 0;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);



implementation {:origName "IoCreateDevice"} {:osmodel} IoCreateDevice(actual_DriverObject: int, actual_DeviceExtensionSize: int, actual_DeviceName: int, actual_DeviceType: int, actual_DeviceCharacteristics: int, actual_Exclusive: int, actual_DeviceObject_1: int) returns (Tmp_23: int)
{
...
procedure {:origName "sdv_IoSetCancelRoutine"} {:osmodel} sdv_IoSetCancelRoutine(actual_pirp_3: int, actual_CancelRoutine: int) returns (Tmp_29: int);
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);



implementation {:origName "sdv_IoSetCancelRoutine"} {:osmodel} sdv_IoSetCancelRoutine(actual_pirp_3: int, actual_CancelRoutine: int) returns (Tmp_29: int)
{
  var {:scalar} r: int;
...
procedure {:origName "sdv_RtlQueryRegistryValues"} {:osmodel} sdv_RtlQueryRegistryValues(actual_RelativeTo: int, actual_Path: int, actual_QueryTable: int, actual_Context_1: int, actual_Environment: int) returns (Tmp_35: int);
...
implementation {:origName "sdv_RtlQueryRegistryValues"} {:osmodel} sdv_RtlQueryRegistryValues(actual_RelativeTo: int, actual_Path: int, actual_QueryTable: int, actual_Context_1: int, actual_Environment: int) returns (Tmp_35: int)
{
...
implementation {:origName "sdv_main"} {:osmodel} sdv_main()
{
  ...
  L78:
    ...
    call {:si_unique_call 20} status_2 := sdv_RunSurpriseRemoveDevice(sdv_p_devobj_fdo, sdv_irp);
    call {:si_unique_call 21} status_2 := sdv_RunRemoveDevice(sdv_p_devobj_fdo, sdv_irp);
    goto anon9_Then, anon9_Else;
...
procedure {:origName "IoAllocateErrorLogEntry"} {:osmodel} IoAllocateErrorLogEntry(actual_IoObject: int, actual_EntrySize: int) returns (Tmp_43: int);
  modifies alloc;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);
...
implementation {:origName "IoAllocateErrorLogEntry"} {:osmodel} IoAllocateErrorLogEntry(actual_IoObject: int, actual_EntrySize: int) returns (Tmp_43: int)
{
  ...
  anon3_Else:
    call {:si_unique_call 22} sdv_16 := __HAVOC_malloc(1);
    Tmp_43 := sdv_16;
    goto L1;
...
implementation {:origName "PoSetPowerState"} {:osmodel} PoSetPowerState(actual_DeviceObject_2: int, actual_Type: int, actual_structPtr888State: int) returns (structPtr888Tmp: int)
{
  ...
  anon0:
    call {:si_unique_call 23} State := __HAVOC_malloc(8);
    call {:si_unique_call 24} r_1 := __HAVOC_malloc(8);
    call {:si_unique_call 25} Tmp := __HAVOC_malloc(8);
...
implementation {:origName "IoWriteErrorLogEntry"} {:osmodel} IoWriteErrorLogEntry(actual_ElEntry: int)
{
  ...
  anon0:
    call {:si_unique_call 26} vslice_dummy_var_11 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "sdv_IoSetCompletionRoutine"} {:osmodel} sdv_IoSetCompletionRoutine(actual_pirp_6: int, actual_CompletionRoutine: int, actual_Context_2: int, actual_InvokeOnSuccess: int, actual_InvokeOnError: int, actual_InvokeOnCancel: int)
{
  ...
  anon0:
    call {:si_unique_call 27} vslice_dummy_var_12 := __HAVOC_malloc(4);
    ...
    call {:si_unique_call 28} irpSp := sdv_IoGetNextIrpStackLocation(pirp_6);
...
procedure {:origName "IoGetDeviceObjectPointer"} {:osmodel} IoGetDeviceObjectPointer(actual_ObjectName: int, actual_DesiredAccess: int, actual_FileObject: int, actual_DeviceObject_3: int) returns (Tmp_50: int);
  modifies Mem_T.P_DEVICE_OBJECT;
  free ensures {:va_keep} Tmp_50 == -1073741670 || Tmp_50 == -1073741773 || Tmp_50 == -1073741727 || Tmp_50 == -1073741811 || Tmp_50 == -1073741788 || Tmp_50 == 0;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);



implementation {:origName "IoGetDeviceObjectPointer"} {:osmodel} IoGetDeviceObjectPointer(actual_ObjectName: int, actual_DesiredAccess: int, actual_FileObject: int, actual_DeviceObject_3: int) returns (Tmp_50: int)
{
...
procedure {:origName "sdv_RemoveEntryList"} {:osmodel} sdv_RemoveEntryList(actual_Entry: int) returns (Tmp_56: int);
...
implementation {:origName "sdv_RemoveEntryList"} {:osmodel} sdv_RemoveEntryList(actual_Entry: int) returns (Tmp_56: int)
{
...
procedure {:origName "KeSetEvent"} {:osmodel} KeSetEvent(actual_Event: int, actual_Increment: int, actual_Wait: int) returns (Tmp_64: int);
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);



implementation {:origName "KeSetEvent"} {:osmodel} KeSetEvent(actual_Event: int, actual_Increment: int, actual_Wait: int) returns (Tmp_64: int)
{
...
procedure {:origName "PoRequestPowerIrp"} {:osmodel} PoRequestPowerIrp(actual_DeviceObject_5: int, actual_MinorFunction: int, actual_structPtr888PowerState: int, actual_CompletionFunction: int, actual_Context_3: int, actual_Irp_1: int) returns (Tmp_74: int);
  modifies alloc, Mem_T.Status__IO_STATUS_BLOCK;
  free ensures {:va_keep} Tmp_74 == -1073741584 || Tmp_74 == 259 || Tmp_74 == -1073741670;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);



implementation {:origName "PoRequestPowerIrp"} {:osmodel} PoRequestPowerIrp(actual_DeviceObject_5: int, actual_MinorFunction: int, actual_structPtr888PowerState: int, actual_CompletionFunction: int, actual_Context_3: int, actual_Irp_1: int) returns (Tmp_74: int)
{
  ...
  anon0:
    call {:si_unique_call 35} PowerState := __HAVOC_malloc(8);
...
procedure {:origName "RtlVerifyVersionInfo"} {:osmodel} RtlVerifyVersionInfo(actual_VersionInfo: int, actual_TypeMask: int, actual_ConditionMask: int) returns (Tmp_76: int);
  free ensures {:va_keep} Tmp_76 == -1073741811 || Tmp_76 == -1073741735 || Tmp_76 == 0;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);



implementation {:origName "RtlVerifyVersionInfo"} {:osmodel} RtlVerifyVersionInfo(actual_VersionInfo: int, actual_TypeMask: int, actual_ConditionMask: int) returns (Tmp_76: int)
{
...
implementation {:origName "main"} {:osmodel} main() returns (Tmp_78: int, dup_assertVar: bool)
{
  ...
  anon0:
    dup_assertVar := true;
    assume alloc > 0;
    call {:si_unique_call 36} sdv_harnessStackLocation_next__Loc := __HAVOC_malloc_or_null(536);
    assume sdv_harnessStackLocation_next__Loc == sdv_harnessStackLocation_next;
    assume sdv_harnessStackLocation_next != 0;
    call {:si_unique_call 37} sdv_IoReadPartitionTableEx_DRIVE_LAYOUT_INFORMATION_EX__Loc := __HAVOC_malloc_or_null(76);
    assume sdv_IoReadPartitionTableEx_DRIVE_LAYOUT_INFORMATION_EX__Loc == sdv_IoReadPartitionTableEx_DRIVE_LAYOUT_INFORMATION_EX;
    assume sdv_IoReadPartitionTableEx_DRIVE_LAYOUT_INFORMATION_EX != 0;
    call {:si_unique_call 38} WHEA_ERROR_PACKET_SECTION_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume WHEA_ERROR_PACKET_SECTION_GUID__Loc == WHEA_ERROR_PACKET_SECTION_GUID;
    assume WHEA_ERROR_PACKET_SECTION_GUID != 0;
    call {:si_unique_call 39} sdv_IoBuildAsynchronousFsdRequest_harnessIrp__Loc := __HAVOC_malloc_or_null(240);
    assume sdv_IoBuildAsynchronousFsdRequest_harnessIrp__Loc == sdv_IoBuildAsynchronousFsdRequest_harnessIrp;
    assume sdv_IoBuildAsynchronousFsdRequest_harnessIrp != 0;
    call {:si_unique_call 40} sdv_IoGetDeviceToVerify_DEVICE_OBJECT__Loc := __HAVOC_malloc_or_null(380);
    assume sdv_IoGetDeviceToVerify_DEVICE_OBJECT__Loc == sdv_IoGetDeviceToVerify_DEVICE_OBJECT;
    assume sdv_IoGetDeviceToVerify_DEVICE_OBJECT != 0;
    call {:si_unique_call 41} sdv_IoBuildDeviceIoControlRequest_harnessStackLocation_next__Loc := __HAVOC_malloc_or_null(536);
    assume sdv_IoBuildDeviceIoControlRequest_harnessStackLocation_next__Loc == sdv_IoBuildDeviceIoControlRequest_harnessStackLocation_next;
    assume sdv_IoBuildDeviceIoControlRequest_harnessStackLocation_next != 0;
    call {:si_unique_call 42} sdv_harness_IoBuildSynchronousFsdRequest_IoStatusBlock__Loc := __HAVOC_malloc_or_null(12);
    assume sdv_harness_IoBuildSynchronousFsdRequest_IoStatusBlock__Loc == sdv_harness_IoBuildSynchronousFsdRequest_IoStatusBlock;
    assume sdv_harness_IoBuildSynchronousFsdRequest_IoStatusBlock != 0;
    call {:si_unique_call 43} sdv_ControllerIrp__Loc := __HAVOC_malloc_or_null(240);
    assume sdv_ControllerIrp__Loc == sdv_ControllerIrp;
    assume sdv_ControllerIrp != 0;
    call {:si_unique_call 44} sdv_devobj_pdo__Loc := __HAVOC_malloc_or_null(380);
    assume sdv_devobj_pdo__Loc == sdv_devobj_pdo;
    assume sdv_devobj_pdo != 0;
    call {:si_unique_call 45} sdv_IoGetDmaAdapter_DMA_ADAPTER__Loc := __HAVOC_malloc_or_null(12);
    assume sdv_IoGetDmaAdapter_DMA_ADAPTER__Loc == sdv_IoGetDmaAdapter_DMA_ADAPTER;
    assume sdv_IoGetDmaAdapter_DMA_ADAPTER != 0;
    call {:si_unique_call 46} sdv_IoInitializeIrp_harnessIrp__Loc := __HAVOC_malloc_or_null(240);
    assume sdv_IoInitializeIrp_harnessIrp__Loc == sdv_IoInitializeIrp_harnessIrp;
    assume sdv_IoInitializeIrp_harnessIrp != 0;
    call {:si_unique_call 47} sdv_IoGetRelatedDeviceObject_DEVICE_OBJECT__Loc := __HAVOC_malloc_or_null(380);
    assume sdv_IoGetRelatedDeviceObject_DEVICE_OBJECT__Loc == sdv_IoGetRelatedDeviceObject_DEVICE_OBJECT;
    assume sdv_IoGetRelatedDeviceObject_DEVICE_OBJECT != 0;
    call {:si_unique_call 48} sdv_IoBuildSynchronousFsdRequest_harnessStackLocation_next__Loc := __HAVOC_malloc_or_null(536);
    assume sdv_IoBuildSynchronousFsdRequest_harnessStackLocation_next__Loc == sdv_IoBuildSynchronousFsdRequest_harnessStackLocation_next;
    assume sdv_IoBuildSynchronousFsdRequest_harnessStackLocation_next != 0;
    call {:si_unique_call 49} sdv_IoCreateSynchronizationEvent_KEVENT__Loc := __HAVOC_malloc_or_null(156);
    ...
    call {:si_unique_call 51} sdv_harnessStackLocation__Loc := __HAVOC_malloc_or_null(536);
    assume sdv_harnessStackLocation__Loc == sdv_harnessStackLocation;
    assume sdv_harnessStackLocation != 0;
    call {:si_unique_call 52} sdv_IoCreateController_CONTROLLER_OBJECT__Loc := __HAVOC_malloc_or_null(60);
    assume sdv_IoCreateController_CONTROLLER_OBJECT__Loc == sdv_IoCreateController_CONTROLLER_OBJECT;
    assume sdv_IoCreateController_CONTROLLER_OBJECT != 0;
    call {:si_unique_call 53} sdv_devobj_top__Loc := __HAVOC_malloc_or_null(380);
    assume sdv_devobj_top__Loc == sdv_devobj_top;
    assume sdv_devobj_top != 0;
    call {:si_unique_call 54} sdv_kdpc_val3__Loc := __HAVOC_malloc_or_null(44);
    assume sdv_kdpc_val3__Loc == sdv_kdpc_val3;
    assume sdv_kdpc_val3 != 0;
    call {:si_unique_call 55} sdv_IoBuildSynchronousFsdRequest_harnessIrp__Loc := __HAVOC_malloc_or_null(240);
    assume sdv_IoBuildSynchronousFsdRequest_harnessIrp__Loc == sdv_IoBuildSynchronousFsdRequest_harnessIrp;
    assume sdv_IoBuildSynchronousFsdRequest_harnessIrp != 0;
    call {:si_unique_call 56} sdv_IoGetDeviceObjectPointer_DEVICE_OBJECT__Loc := __HAVOC_malloc_or_null(380);
    assume sdv_IoGetDeviceObjectPointer_DEVICE_OBJECT__Loc == sdv_IoGetDeviceObjectPointer_DEVICE_OBJECT;
    assume sdv_IoGetDeviceObjectPointer_DEVICE_OBJECT != 0;
    call {:si_unique_call 57} sdv_driver_object__Loc := __HAVOC_malloc_or_null(68);
    assume sdv_driver_object__Loc == sdv_driver_object;
    assume sdv_driver_object != 0;
    call {:si_unique_call 58} sdv_MapRegisterBase_val__Loc := __HAVOC_malloc_or_null(4);
    assume sdv_MapRegisterBase_val__Loc == sdv_MapRegisterBase_val;
    assume sdv_MapRegisterBase_val != 0;
    call {:si_unique_call 59} sdv_IoGetFileObjectGenericMapping_GENERIC_MAPPING__Loc := __HAVOC_malloc_or_null(16);
    assume sdv_IoGetFileObjectGenericMapping_GENERIC_MAPPING__Loc == sdv_IoGetFileObjectGenericMapping_GENERIC_MAPPING;
    assume sdv_IoGetFileObjectGenericMapping_GENERIC_MAPPING != 0;
    call {:si_unique_call 60} sdv_IoMakeAssociatedIrp_harnessIrp__Loc := __HAVOC_malloc_or_null(240);
    assume sdv_IoMakeAssociatedIrp_harnessIrp__Loc == sdv_IoMakeAssociatedIrp_harnessIrp;
    assume sdv_IoMakeAssociatedIrp_harnessIrp != 0;
    call {:si_unique_call 61} sdv_devobj_child_pdo__Loc := __HAVOC_malloc_or_null(380);
    assume sdv_devobj_child_pdo__Loc == sdv_devobj_child_pdo;
    assume sdv_devobj_child_pdo != 0;
    call {:si_unique_call 62} sdv_harnessIrp__Loc := __HAVOC_malloc_or_null(240);
    assume sdv_harnessIrp__Loc == sdv_harnessIrp;
    assume sdv_harnessIrp != 0;
    call {:si_unique_call 63} sdv_IoBuildAsynchronousFsdRequest_harnessStackLocation_next__Loc := __HAVOC_malloc_or_null(536);
    assume sdv_IoBuildAsynchronousFsdRequest_harnessStackLocation_next__Loc == sdv_IoBuildAsynchronousFsdRequest_harnessStackLocation_next;
    assume sdv_IoBuildAsynchronousFsdRequest_harnessStackLocation_next != 0;
    call {:si_unique_call 64} sdv_harness_IoBuildDeviceIoControlRequest_IoStatusBlock__Loc := __HAVOC_malloc_or_null(12);
    assume sdv_harness_IoBuildDeviceIoControlRequest_IoStatusBlock__Loc == sdv_harness_IoBuildDeviceIoControlRequest_IoStatusBlock;
    assume sdv_harness_IoBuildDeviceIoControlRequest_IoStatusBlock != 0;
    call {:si_unique_call 65} sdv_kinterrupt_val__Loc := __HAVOC_malloc_or_null(0);
    assume sdv_kinterrupt_val__Loc == sdv_kinterrupt_val;
    assume sdv_kinterrupt_val != 0;
    call {:si_unique_call 66} sdv_fx_dev_object__Loc := __HAVOC_malloc_or_null(40);
    assume sdv_fx_dev_object__Loc == sdv_fx_dev_object;
    assume sdv_fx_dev_object != 0;
    call {:si_unique_call 67} sdv_devobj_fdo__Loc := __HAVOC_malloc_or_null(380);
    assume sdv_devobj_fdo__Loc == sdv_devobj_fdo;
    assume sdv_devobj_fdo != 0;
    call {:si_unique_call 68} sdv_StartIoIrp__Loc := __HAVOC_malloc_or_null(240);
    assume sdv_StartIoIrp__Loc == sdv_StartIoIrp;
    assume sdv_StartIoIrp != 0;
    call {:si_unique_call 69} sdv_harness_IoBuildAsynchronousFsdRequest_IoStatusBlock__Loc := __HAVOC_malloc_or_null(12);
    assume sdv_harness_IoBuildAsynchronousFsdRequest_IoStatusBlock__Loc == sdv_harness_IoBuildAsynchronousFsdRequest_IoStatusBlock;
    assume sdv_harness_IoBuildAsynchronousFsdRequest_IoStatusBlock != 0;
    call {:si_unique_call 70} sdv_PowerIrp__Loc := __HAVOC_malloc_or_null(240);
    assume sdv_PowerIrp__Loc == sdv_PowerIrp;
    assume sdv_PowerIrp != 0;
    call {:si_unique_call 71} sdv_IoBuildDeviceIoControlRequest_harnessIrp__Loc := __HAVOC_malloc_or_null(240);
    assume sdv_IoBuildDeviceIoControlRequest_harnessIrp__Loc == sdv_IoBuildDeviceIoControlRequest_harnessIrp;
    assume sdv_IoBuildDeviceIoControlRequest_harnessIrp != 0;
    call {:si_unique_call 72} sdv_other_harnessIrp__Loc := __HAVOC_malloc_or_null(240);
    assume sdv_other_harnessIrp__Loc == sdv_other_harnessIrp;
    assume sdv_other_harnessIrp != 0;
    call {:si_unique_call 73} sdv_IoCreateNotificationEvent_KEVENT__Loc := __HAVOC_malloc_or_null(156);
    assume sdv_IoCreateNotificationEvent_KEVENT__Loc == sdv_IoCreateNotificationEvent_KEVENT;
    assume sdv_IoCreateNotificationEvent_KEVENT != 0;
    call {:si_unique_call 74} sdv_other_harnessStackLocation__Loc := __HAVOC_malloc_or_null(536);
    assume sdv_other_harnessStackLocation__Loc == sdv_other_harnessStackLocation;
    assume sdv_other_harnessStackLocation != 0;
    call {:si_unique_call 75} MSWmi_PnPDeviceId_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSWmi_PnPDeviceId_GUID__Loc == MSWmi_PnPDeviceId_GUID;
    assume MSWmi_PnPDeviceId_GUID != 0;
    call {:si_unique_call 76} MSNdis_80211_BSSIList_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_80211_BSSIList_GUID__Loc == MSNdis_80211_BSSIList_GUID;
    assume MSNdis_80211_BSSIList_GUID != 0;
    call {:si_unique_call 77} WPP_GLOBAL_Control__Loc := __HAVOC_malloc_or_null(4);
    assume WPP_GLOBAL_Control__Loc == WPP_GLOBAL_Control;
    assume WPP_GLOBAL_Control != 0;
    call {:si_unique_call 78} MSNdis_TokenRingLostFrames_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_TokenRingLostFrames_GUID__Loc == MSNdis_TokenRingLostFrames_GUID;
    assume MSNdis_TokenRingLostFrames_GUID != 0;
    call {:si_unique_call 79} MSRedbook_DriverInformationGuid__Loc := __HAVOC_malloc_or_null(16);
    assume MSRedbook_DriverInformationGuid__Loc == MSRedbook_DriverInformationGuid;
    assume MSRedbook_DriverInformationGuid != 0;
    call {:si_unique_call 80} MSNdis_FddiUpstreamNodeLong_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_FddiUpstreamNodeLong_GUID__Loc == MSNdis_FddiUpstreamNodeLong_GUID;
    assume MSNdis_FddiUpstreamNodeLong_GUID != 0;
    call {:si_unique_call 81} MSNdis_PortArray_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_PortArray_GUID__Loc == MSNdis_PortArray_GUID;
    assume MSNdis_PortArray_GUID != 0;
    call {:si_unique_call 82} MSNdis_QueryPortState_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_QueryPortState_GUID__Loc == MSNdis_QueryPortState_GUID;
    assume MSNdis_QueryPortState_GUID != 0;
    call {:si_unique_call 83} GUID_TRANSLATOR_INTERFACE_STANDARD__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 84} GUID_ARBITER_INTERFACE_STANDARD__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_ARBITER_INTERFACE_STANDARD__Loc == GUID_ARBITER_INTERFACE_STANDARD;
    assume GUID_ARBITER_INTERFACE_STANDARD != 0;
    call {:si_unique_call 85} MSNdis_VendorID_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_VendorID_GUID__Loc == MSNdis_VendorID_GUID;
    assume MSNdis_VendorID_GUID != 0;
    call {:si_unique_call 86} MSNdis_StatusDot11PmkidCandidateList_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 87} MSMCAEvent_PCIComponentError_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 88} MSNdis_FddiLongCurrentAddress_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 89} MSNdis_QueryReceiveFilterHardwareCapabilities_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 98} MSNdis_80211_DesiredDataRates_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 99} MSMCAInfo_Entry_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSMCAInfo_Entry_GUID__Loc == MSMCAInfo_Entry_GUID;
    assume MSMCAInfo_Entry_GUID != 0;
    call {:si_unique_call 100} MSNdis_GroupAffinity_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_GroupAffinity_GUID__Loc == MSNdis_GroupAffinity_GUID;
    assume MSNdis_GroupAffinity_GUID != 0;
    call {:si_unique_call 101} MSNdis_StatusDot11RoamingCompletion_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 102} MSNdis_EthernetCurrentAddress_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 103} MSNdis_TcpOffloadHardwareConfig_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 104} MSNdis_80211_ConfigurationFH_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 105} GUID_MF_ENUMERATION_INTERFACE__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_MF_ENUMERATION_INTERFACE__Loc == GUID_MF_ENUMERATION_INTERFACE;
    assume GUID_MF_ENUMERATION_INTERFACE != 0;
    call {:si_unique_call 106} GUID_LEGACY_DEVICE_DETECTION_STANDARD__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 107} KernelPerfStateChange_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume KernelPerfStateChange_GUID__Loc == KernelPerfStateChange_GUID;
    assume KernelPerfStateChange_GUID != 0;
    call {:si_unique_call 108} MSNdis_PMCapabilities_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_PMCapabilities_GUID__Loc == MSNdis_PMCapabilities_GUID;
    assume MSNdis_PMCapabilities_GUID != 0;
    call {:si_unique_call 109} MSRedbook_PerformanceGuid__Loc := __HAVOC_malloc_or_null(16);
    assume MSRedbook_PerformanceGuid__Loc == MSRedbook_PerformanceGuid;
    assume MSRedbook_PerformanceGuid != 0;
    call {:si_unique_call 110} MSNdis_StatusDot11RoamingStart_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 111} GUID_DEVICE_MEMORY__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_DEVICE_MEMORY__Loc == GUID_DEVICE_MEMORY;
    assume GUID_DEVICE_MEMORY != 0;
    call {:si_unique_call 112} MSMouse_ClassInformation_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSMouse_ClassInformation_GUID__Loc == MSMouse_ClassInformation_GUID;
    assume MSMouse_ClassInformation_GUID != 0;
    call {:si_unique_call 113} GUID_DEVICE_FAN__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_DEVICE_FAN__Loc == GUID_DEVICE_FAN;
    assume GUID_DEVICE_FAN != 0;
    call {:si_unique_call 114} MSNdis_80211_NetworkTypesSupported_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 115} MSNdis_80211_NetworkInfrastructure_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 116} GUID_PNP_POWER_SETTING_CHANGE__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_PNP_POWER_SETTING_CHANGE__Loc == GUID_PNP_POWER_SETTING_CHANGE;
    assume GUID_PNP_POWER_SETTING_CHANGE != 0;
    call {:si_unique_call 117} MSNdis_NotifyVcArrival_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_NotifyVcArrival_GUID__Loc == MSNdis_NotifyVcArrival_GUID;
    assume MSNdis_NotifyVcArrival_GUID != 0;
    call {:si_unique_call 118} MSNdis_FddiShortMulticastList_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 119} PROCESSOR_NUMBER_PKEY__Loc := __HAVOC_malloc_or_null(20);
    assume PROCESSOR_NUMBER_PKEY__Loc == PROCESSOR_NUMBER_PKEY;
    assume PROCESSOR_NUMBER_PKEY != 0;
    call {:si_unique_call 120} MSNdis_AtmMaxAal5PacketSize_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_AtmMaxAal5PacketSize_GUID__Loc == MSNdis_AtmMaxAal5PacketSize_GUID;
    assume MSNdis_AtmMaxAal5PacketSize_GUID != 0;
    call {:si_unique_call 121} MSNdis_80211_ReceivedSignalStrengthEventTrigger_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 122} MSNdis_StatusDevicePowerOn_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_StatusDevicePowerOn_GUID__Loc == MSNdis_StatusDevicePowerOn_GUID;
    assume MSNdis_StatusDevicePowerOn_GUID != 0;
    call {:si_unique_call 123} MSKeyboard_ExtendedID_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSKeyboard_ExtendedID_GUID__Loc == MSKeyboard_ExtendedID_GUID;
    assume MSKeyboard_ExtendedID_GUID != 0;
    call {:si_unique_call 124} WHEAErrorSourceMethods_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume WHEAErrorSourceMethods_GUID__Loc == WHEAErrorSourceMethods_GUID;
    assume WHEAErrorSourceMethods_GUID != 0;
    call {:si_unique_call 125} MSNdis_AtmMaxAal34PacketSize_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 126} GUID_ACPI_REGS_INTERFACE_STANDARD__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 127} MSNdis_TokenRingCurrentGroup_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 128} MSNdis_FddiLConnectionState_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_FddiLConnectionState_GUID__Loc == MSNdis_FddiLConnectionState_GUID;
    assume MSNdis_FddiLConnectionState_GUID != 0;
    call {:si_unique_call 129} GUID_PARTITION_UNIT_INTERFACE_STANDARD__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 136} MSMCAEvent_PCIBusError_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSMCAEvent_PCIBusError_GUID__Loc == MSMCAEvent_PCIBusError_GUID;
    assume MSMCAEvent_PCIBusError_GUID != 0;
    call {:si_unique_call 137} MSNdis_StatusMediaConnect_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_StatusMediaConnect_GUID__Loc == MSNdis_StatusMediaConnect_GUID;
    assume MSNdis_StatusMediaConnect_GUID != 0;
    call {:si_unique_call 138} MSNdis_MediaInUse_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_MediaInUse_GUID__Loc == MSNdis_MediaInUse_GUID;
    assume MSNdis_MediaInUse_GUID != 0;
    call {:si_unique_call 139} MSStorageDriver_ScsiInfoExceptions_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 140} WmiMonitorID_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume WmiMonitorID_GUID__Loc == WmiMonitorID_GUID;
    assume WmiMonitorID_GUID != 0;
    call {:si_unique_call 141} MSNdis_ReceiveFilterInfoArray_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 142} MSMCAInfo_RawCorrectedPlatformEvent_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 143} MSNdis_CurrentLookahead_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_CurrentLookahead_GUID__Loc == MSNdis_CurrentLookahead_GUID;
    assume MSNdis_CurrentLookahead_GUID != 0;
    call {:si_unique_call 144} MSStorageDriver_ATAPISmartData_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 145} GUID_DEVICE_PROCESSOR__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_DEVICE_PROCESSOR__Loc == GUID_DEVICE_PROCESSOR;
    assume GUID_DEVICE_PROCESSOR != 0;
    call {:si_unique_call 146} MSNdis_AtmMaxActiveVciBits_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_AtmMaxActiveVciBits_GUID__Loc == MSNdis_AtmMaxActiveVciBits_GUID;
    assume MSNdis_AtmMaxActiveVciBits_GUID != 0;
    call {:si_unique_call 147} MSNdis_80211_NetworkTypeInUse_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 148} ProcessorPerformance_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume ProcessorPerformance_GUID__Loc == ProcessorPerformance_GUID;
    assume ProcessorPerformance_GUID != 0;
    call {:si_unique_call 149} MSNdis_QueryPhysicalMediumTypeEx_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 150} MSNdis_80211_Configuration_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_80211_Configuration_GUID__Loc == MSNdis_80211_Configuration_GUID;
    assume MSNdis_80211_Configuration_GUID != 0;
    call {:si_unique_call 151} MSMCAEvent_BusError_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSMCAEvent_BusError_GUID__Loc == MSMCAEvent_BusError_GUID;
    assume MSMCAEvent_BusError_GUID != 0;
    call {:si_unique_call 152} MSNdis_MaximumTotalSize_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_MaximumTotalSize_GUID__Loc == MSNdis_MaximumTotalSize_GUID;
    assume MSNdis_MaximumTotalSize_GUID != 0;
    call {:si_unique_call 153} MSNdis_StatusPacketFilterChange_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 154} WmiMonitorBasicDisplayParams_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 155} MSNdis_ReceiveBufferSpace_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_ReceiveBufferSpace_GUID__Loc == MSNdis_ReceiveBufferSpace_GUID;
    assume MSNdis_ReceiveBufferSpace_GUID != 0;
    call {:si_unique_call 156} MSPower_DeviceWakeEnable_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSPower_DeviceWakeEnable_GUID__Loc == MSPower_DeviceWakeEnable_GUID;
    assume MSPower_DeviceWakeEnable_GUID != 0;
    call {:si_unique_call 157} MSNdis_CoVendorId_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_CoVendorId_GUID__Loc == MSNdis_CoVendorId_GUID;
    assume MSNdis_CoVendorId_GUID != 0;
    call {:si_unique_call 158} MSNdis_AtmHardwareCurrentAddress_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 159} MSNdis_WmiTcpIpChecksumOffload_IPv4TransmitReceive_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 180} MSParallel_DeviceBytesTransferred_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 181} MSSmBios_Sysid1394List_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSSmBios_Sysid1394List_GUID__Loc == MSSmBios_Sysid1394List_GUID;
    assume MSSmBios_Sysid1394List_GUID != 0;
    call {:si_unique_call 182} MSNdis_TransmitsError_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_TransmitsError_GUID__Loc == MSNdis_TransmitsError_GUID;
    assume MSNdis_TransmitsError_GUID != 0;
    call {:si_unique_call 183} MSNdis_CoMinimumLinkSpeed_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_CoMinimumLinkSpeed_GUID__Loc == MSNdis_CoMinimumLinkSpeed_GUID;
    assume MSNdis_CoMinimumLinkSpeed_GUID != 0;
    call {:si_unique_call 184} MSNdis_QueryReceiveFilterParameters_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 185} MSNdis_QueryNicSwitchCurrentCapabilities_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 186} MSNdis_StatusDot11Disassociation_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 187} MSNdis_NetworkDirectVersion_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_NetworkDirectVersion_GUID__Loc == MSNdis_NetworkDirectVersion_GUID;
    assume MSNdis_NetworkDirectVersion_GUID != 0;
    call {:si_unique_call 188} GUID_PCI_VIRTUALIZATION_INTERFACE__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 189} MSNdis_80211_Disassociate_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_80211_Disassociate_GUID__Loc == MSNdis_80211_Disassociate_GUID;
    assume MSNdis_80211_Disassociate_GUID != 0;
    call {:si_unique_call 190} MSStorageDriver_FailurePredictStatus_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 191} GUID_QUERY_CRASHDUMP_FUNCTIONS__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_QUERY_CRASHDUMP_FUNCTIONS__Loc == GUID_QUERY_CRASHDUMP_FUNCTIONS;
    assume GUID_QUERY_CRASHDUMP_FUNCTIONS != 0;
    call {:si_unique_call 192} MSNdis_LinkSpeed_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_LinkSpeed_GUID__Loc == MSNdis_LinkSpeed_GUID;
    assume MSNdis_LinkSpeed_GUID != 0;
    call {:si_unique_call 193} GUID_AGP_TARGET_BUS_INTERFACE_STANDARD__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 194} MSNdis_WmiReceiveScaleCapabilities_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 195} MSNdis_80211_AddWEP_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_80211_AddWEP_GUID__Loc == MSNdis_80211_AddWEP_GUID;
    assume MSNdis_80211_AddWEP_GUID != 0;
    call {:si_unique_call 196} MSNdis_StatusDevicePowerOnEx_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 197} MSNdis_TokenRingCurrentRingStatus_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 198} IdleStateBucketEx_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume IdleStateBucketEx_GUID__Loc == IdleStateBucketEx_GUID;
    assume IdleStateBucketEx_GUID != 0;
    call {:si_unique_call 199} WPP_TRACE_CONTROL_NULL_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 229} EventTraceConfigGuid__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 319} DefaultTraceSecurityGuid__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 338} MSNdis_ReceiveQueueInfoArray_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 339} MSNdis_TokenRingLineErrors_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_TokenRingLineErrors_GUID__Loc == MSNdis_TokenRingLineErrors_GUID;
    assume MSNdis_TokenRingLineErrors_GUID != 0;
    call {:si_unique_call 340} MSNdis_80211_RemoveWEP_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_80211_RemoveWEP_GUID__Loc == MSNdis_80211_RemoveWEP_GUID;
    assume MSNdis_80211_RemoveWEP_GUID != 0;
    call {:si_unique_call 341} MSNdis_QueryInterruptModeration_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 342} GUID_DEVICE_MESSAGE_INDICATOR__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_DEVICE_MESSAGE_INDICATOR__Loc == GUID_DEVICE_MESSAGE_INDICATOR;
    assume GUID_DEVICE_MESSAGE_INDICATOR != 0;
    call {:si_unique_call 343} GUID_TARGET_DEVICE_TRANSPORT_RELATIONS_CHANGED__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 344} MSNdis_NotifyFilterArrival_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_NotifyFilterArrival_GUID__Loc == MSNdis_NotifyFilterArrival_GUID;
    assume MSNdis_NotifyFilterArrival_GUID != 0;
    call {:si_unique_call 345} MSNdis_QueryStatisticsInfo_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_QueryStatisticsInfo_GUID__Loc == MSNdis_QueryStatisticsInfo_GUID;
    assume MSNdis_QueryStatisticsInfo_GUID != 0;
    call {:si_unique_call 346} MSNdis_StatusDot11ConnectionCompletion_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 347} MSMCAEvent_SMBIOSError_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSMCAEvent_SMBIOSError_GUID__Loc == MSMCAEvent_SMBIOSError_GUID;
    assume MSMCAEvent_SMBIOSError_GUID != 0;
    call {:si_unique_call 348} MSKeyboard_ClassInformation_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSKeyboard_ClassInformation_GUID__Loc == MSKeyboard_ClassInformation_GUID;
    assume MSKeyboard_ClassInformation_GUID != 0;
    call {:si_unique_call 349} IdleStateAccounting_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume IdleStateAccounting_GUID__Loc == IdleStateAccounting_GUID;
    assume IdleStateAccounting_GUID != 0;
    call {:si_unique_call 350} GUID_BUS_TYPE_IRDA__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_BUS_TYPE_IRDA__Loc == GUID_BUS_TYPE_IRDA;
    assume GUID_BUS_TYPE_IRDA != 0;
    call {:si_unique_call 351} MSNdis_NetworkDirectAdapterInfo_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 352} MSNdis_EthernetMoreTransmitCollisions_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 353} MSNdis_StatusDot11TkipmicFailure_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 354} MSNdis_EnumerateAdapter_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_EnumerateAdapter_GUID__Loc == MSNdis_EnumerateAdapter_GUID;
    assume MSNdis_EnumerateAdapter_GUID != 0;
    call {:si_unique_call 355} MSNdis_AtmMaxAal0PacketSize_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_AtmMaxAal0PacketSize_GUID__Loc == MSNdis_AtmMaxAal0PacketSize_GUID;
    assume MSNdis_AtmMaxAal0PacketSize_GUID != 0;
    call {:si_unique_call 356} MSNdis_EthernetOneTransmitCollision_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 357} MSDiskDriver_PerformanceData_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 358} MSNdis_EnumerateReceiveQueues_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 359} MSNdis_StatusDot11LinkQuality_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 368} MSMCAEvent_SwitchToCMCPolling_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 369} MSNdis_CoMediaConnectStatus_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_CoMediaConnectStatus_GUID__Loc == MSNdis_CoMediaConnectStatus_GUID;
    assume MSNdis_CoMediaConnectStatus_GUID != 0;
    call {:si_unique_call 370} MSNdis_StatusLinkState_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_StatusLinkState_GUID__Loc == MSNdis_StatusLinkState_GUID;
    assume MSNdis_StatusLinkState_GUID != 0;
    call {:si_unique_call 371} MSAcpi_ThermalZoneTemperature_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 372} MSStorageDriver_FailurePredictData_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 373} MSDeviceUI_FirmwareRevision_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSDeviceUI_FirmwareRevision_GUID__Loc == MSDeviceUI_FirmwareRevision_GUID;
    assume MSDeviceUI_FirmwareRevision_GUID != 0;
    call {:si_unique_call 374} KernelPerfStateDomainChange_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume KernelPerfStateDomainChange_GUID__Loc == KernelPerfStateDomainChange_GUID;
    assume KernelPerfStateDomainChange_GUID != 0;
    call {:si_unique_call 375} MSNdis_ReceiveFilterFieldParameters_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 376} MSNdis_80211_AuthenticationMode_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 377} MSVerifierIrpLogEntry_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSVerifierIrpLogEntry_GUID__Loc == MSVerifierIrpLogEntry_GUID;
    assume MSVerifierIrpLogEntry_GUID != 0;
    call {:si_unique_call 378} WmiMonitorListedFrequencyRanges_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 379} MSNdis_CoVendorDescription_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_CoVendorDescription_GUID__Loc == MSNdis_CoVendorDescription_GUID;
    assume MSNdis_CoVendorDescription_GUID != 0;
    call {:si_unique_call 380} MSNdis_NetworkDirectState_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_NetworkDirectState_GUID__Loc == MSNdis_NetworkDirectState_GUID;
    assume MSNdis_NetworkDirectState_GUID != 0;
    call {:si_unique_call 381} MSNdis_QueryReceiveQueueParameters_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 382} GUID_PROCESSOR_PCC_INTERFACE_STANDARD__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 383} MSMCAInfo_RawMCAEvent_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSMCAInfo_RawMCAEvent_GUID__Loc == MSMCAInfo_RawMCAEvent_GUID;
    assume MSMCAInfo_RawMCAEvent_GUID != 0;
    call {:si_unique_call 384} WmiMonitorRawEEdidV1Block_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume WmiMonitorRawEEdidV1Block_GUID__Loc == WmiMonitorRawEEdidV1Block_GUID;
    assume WmiMonitorRawEEdidV1Block_GUID != 0;
    call {:si_unique_call 385} MSNdis_StatusHDSplitCurrentConfig_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 386} MSMCAEvent_InvalidError_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSMCAEvent_InvalidError_GUID__Loc == MSMCAEvent_InvalidError_GUID;
    assume MSMCAEvent_InvalidError_GUID != 0;
    call {:si_unique_call 387} MSNdis_HDSplitCurrentConfig_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_HDSplitCurrentConfig_GUID__Loc == MSNdis_HDSplitCurrentConfig_GUID;
    assume MSNdis_HDSplitCurrentConfig_GUID != 0;
    call {:si_unique_call 388} KernelIdleState_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume KernelIdleState_GUID__Loc == KernelIdleState_GUID;
    assume KernelIdleState_GUID != 0;
    call {:si_unique_call 389} MSWmi_Guid_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSWmi_Guid_GUID__Loc == MSWmi_Guid_GUID;
    assume MSWmi_Guid_GUID != 0;
    call {:si_unique_call 390} MSMCAEvent_MemoryPageRemoved_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 391} MSTapeProblemIoError_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSTapeProblemIoError_GUID__Loc == MSTapeProblemIoError_GUID;
    assume MSTapeProblemIoError_GUID != 0;
    call {:si_unique_call 392} MSNdis_ReceiveFilterCapabilities_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 393} MSNdis_FddiShortPermanentAddress_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 401} MSTapeDriveProblemEvent_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSTapeDriveProblemEvent_GUID__Loc == MSTapeDriveProblemEvent_GUID;
    assume MSTapeDriveProblemEvent_GUID != 0;
    call {:si_unique_call 402} MSTapeProblemDeviceError_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSTapeProblemDeviceError_GUID__Loc == MSTapeProblemDeviceError_GUID;
    assume MSTapeProblemDeviceError_GUID != 0;
    call {:si_unique_call 403} WmiMonitorListedSupportedSourceModes_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 404} MSNdis_FddiFrameErrors_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_FddiFrameErrors_GUID__Loc == MSNdis_FddiFrameErrors_GUID;
    assume MSNdis_FddiFrameErrors_GUID != 0;
    call {:si_unique_call 405} MSNdis_WmiTcpLargeSendOffloadV2_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 406} GUID_BUS_TYPE_HID__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_BUS_TYPE_HID__Loc == GUID_BUS_TYPE_HID;
    assume GUID_BUS_TYPE_HID != 0;
    call {:si_unique_call 407} MSNdis_NetworkDirectAdapterCapabilities_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 408} GUID_TARGET_DEVICE_REMOVE_COMPLETE__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 409} WmiMonitorColorXYZinCIE_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume WmiMonitorColorXYZinCIE_GUID__Loc == WmiMonitorColorXYZinCIE_GUID;
    assume WmiMonitorColorXYZinCIE_GUID != 0;
    call {:si_unique_call 410} GUID_POWER_DEVICE_WAKE_ENABLE__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_POWER_DEVICE_WAKE_ENABLE__Loc == GUID_POWER_DEVICE_WAKE_ENABLE;
    assume GUID_POWER_DEVICE_WAKE_ENABLE != 0;
    call {:si_unique_call 411} MSNdis_TransmitBufferSpace_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_TransmitBufferSpace_GUID__Loc == MSNdis_TransmitBufferSpace_GUID;
    assume MSNdis_TransmitBufferSpace_GUID != 0;
    call {:si_unique_call 412} MSNdis_CoVendorDriverVersion_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 413} MSNdis_FddiDownstreamNodeLong_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 414} GUID_PCMCIA_BUS_INTERFACE_STANDARD__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 415} GUID_BUS_TYPE_PCMCIA__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_BUS_TYPE_PCMCIA__Loc == GUID_BUS_TYPE_PCMCIA;
    assume GUID_BUS_TYPE_PCMCIA != 0;
    call {:si_unique_call 416} MSNdis_FddiLemRejects_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_FddiLemRejects_GUID__Loc == MSNdis_FddiLemRejects_GUID;
    assume MSNdis_FddiLemRejects_GUID != 0;
    call {:si_unique_call 417} MSNdis_80211_NumberOfAntennas_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 418} IdleStateAccountingEx_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume IdleStateAccountingEx_GUID__Loc == IdleStateAccountingEx_GUID;
    assume IdleStateAccountingEx_GUID != 0;
    call {:si_unique_call 419} MSNdis_80211_WLanBssId_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_80211_WLanBssId_GUID__Loc == MSNdis_80211_WLanBssId_GUID;
    assume MSNdis_80211_WLanBssId_GUID != 0;
    call {:si_unique_call 420} MSNdis_FddiRingManagmentState_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 421} GUID_BUS_TYPE_1394__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_BUS_TYPE_1394__Loc == GUID_BUS_TYPE_1394;
    assume GUID_BUS_TYPE_1394 != 0;
    call {:si_unique_call 422} MSSmBios_SysidUUIDList_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSSmBios_SysidUUIDList_GUID__Loc == MSSmBios_SysidUUIDList_GUID;
    assume MSSmBios_SysidUUIDList_GUID != 0;
    call {:si_unique_call 423} MSNdis_ReceiveScaleCapabilities_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 424} MSNdis_QueryReceiveFilterGlobalParameters_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 425} MSNdis_PMCapabilityState_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_PMCapabilityState_GUID__Loc == MSNdis_PMCapabilityState_GUID;
    assume MSNdis_PMCapabilityState_GUID != 0;
    call {:si_unique_call 426} GUID_TARGET_DEVICE_REMOVE_CANCELLED__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 427} MSNdis_StatusLinkSpeedChange_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 428} MSNdis_StatusResetEnd_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_StatusResetEnd_GUID__Loc == MSNdis_StatusResetEnd_GUID;
    assume MSNdis_StatusResetEnd_GUID != 0;
    call {:si_unique_call 429} MSNdis_AtmMaxActiveVpiBits_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_AtmMaxActiveVpiBits_GUID__Loc == MSNdis_AtmMaxActiveVpiBits_GUID;
    assume MSNdis_AtmMaxActiveVpiBits_GUID != 0;
    call {:si_unique_call 430} MSNdis_EnumerateReceiveFilters_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 431} MSNdis_StatusMediaDisconnect_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 432} MSParallel_AllocFreeCounts_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSParallel_AllocFreeCounts_GUID__Loc == MSParallel_AllocFreeCounts_GUID;
    assume MSParallel_AllocFreeCounts_GUID != 0;
    call {:si_unique_call 433} WmiMonitorConnectionParams_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume WmiMonitorConnectionParams_GUID__Loc == WmiMonitorConnectionParams_GUID;
    assume WmiMonitorConnectionParams_GUID != 0;
    call {:si_unique_call 434} MSNdis_EthernetMulticastList_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 435} MSNdis_ReceiveFilterGlobalParameters_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 436} MSNdis_80211_NetworkType_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_80211_NetworkType_GUID__Loc == MSNdis_80211_NetworkType_GUID;
    assume MSNdis_80211_NetworkType_GUID != 0;
    call {:si_unique_call 437} MSSerial_HardwareConfiguration_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 444} MSTapeSymbolicName_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSTapeSymbolicName_GUID__Loc == MSTapeSymbolicName_GUID;
    assume MSTapeSymbolicName_GUID != 0;
    call {:si_unique_call 445} MSNdis_ReceiveNoBuffer_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_ReceiveNoBuffer_GUID__Loc == MSNdis_ReceiveNoBuffer_GUID;
    assume MSNdis_ReceiveNoBuffer_GUID != 0;
    call {:si_unique_call 446} MSNdis_WmiEnumAdapter_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_WmiEnumAdapter_GUID__Loc == MSNdis_WmiEnumAdapter_GUID;
    assume MSNdis_WmiEnumAdapter_GUID != 0;
    call {:si_unique_call 447} MSWmi_PnPInstanceNames_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSWmi_PnPInstanceNames_GUID__Loc == MSWmi_PnPInstanceNames_GUID;
    assume MSWmi_PnPInstanceNames_GUID != 0;
    call {:si_unique_call 448} MSNdis_NetworkDirectCapabilities_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 449} MSNdis_StatusResetStart_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_StatusResetStart_GUID__Loc == MSNdis_StatusResetStart_GUID;
    assume MSNdis_StatusResetStart_GUID != 0;
    call {:si_unique_call 450} GUID_DEVINTERFACE_MOUSE__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_DEVINTERFACE_MOUSE__Loc == GUID_DEVINTERFACE_MOUSE;
    assume GUID_DEVINTERFACE_MOUSE != 0;
    call {:si_unique_call 451} MSNdis_MaximumFrameSize_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_MaximumFrameSize_GUID__Loc == MSNdis_MaximumFrameSize_GUID;
    assume MSNdis_MaximumFrameSize_GUID != 0;
    call {:si_unique_call 452} MSNdis_WmiSetHeader_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_WmiSetHeader_GUID__Loc == MSNdis_WmiSetHeader_GUID;
    assume MSNdis_WmiSetHeader_GUID != 0;
    call {:si_unique_call 453} MSNdis_80211_ConfigurationInfo_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 454} MSNdis_80211_ServiceSetIdentifier_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 455} MSSerial_PerformanceInformation_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 456} WmiMonitorSupportedDisplayFeatures_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 457} GUID_WUDF_DEVICE_HOST_PROBLEM__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_WUDF_DEVICE_HOST_PROBLEM__Loc == GUID_WUDF_DEVICE_HOST_PROBLEM;
    assume GUID_WUDF_DEVICE_HOST_PROBLEM != 0;
    call {:si_unique_call 458} MSNdis_EthernetMaximumMulticastListSize_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 459} MSNdis_SetHDSplitParameters_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_SetHDSplitParameters_GUID__Loc == MSNdis_SetHDSplitParameters_GUID;
    assume MSNdis_SetHDSplitParameters_GUID != 0;
    call {:si_unique_call 460} GUID_BUS_TYPE_SERENUM__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_BUS_TYPE_SERENUM__Loc == GUID_BUS_TYPE_SERENUM;
    assume GUID_BUS_TYPE_SERENUM != 0;
    call {:si_unique_call 461} MSNdis_WmiIPSecOffloadV1_IPv4AH_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 462} MSNdis_TcpOffloadCurrentConfig_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 478} GUID_DEVICE_ACPI_TIME__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_DEVICE_ACPI_TIME__Loc == GUID_DEVICE_ACPI_TIME;
    assume GUID_DEVICE_ACPI_TIME != 0;
    call {:si_unique_call 479} WPP_ThisDir_CTLGUID_KbdClassTraceGuid__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 480} MSSmBios_SMBiosEventlog_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSSmBios_SMBiosEventlog_GUID__Loc == MSSmBios_SMBiosEventlog_GUID;
    assume MSSmBios_SMBiosEventlog_GUID != 0;
    call {:si_unique_call 481} MSNdis_PhysicalMediumType_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_PhysicalMediumType_GUID__Loc == MSNdis_PhysicalMediumType_GUID;
    assume MSNdis_PhysicalMediumType_GUID != 0;
    call {:si_unique_call 482} MSNdis_80211_PowerMode_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_80211_PowerMode_GUID__Loc == MSNdis_80211_PowerMode_GUID;
    assume MSNdis_80211_PowerMode_GUID != 0;
    call {:si_unique_call 483} MSNdis_StatusDot11AssociationStart_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 484} MSNdis_QueryPciDeviceCustomProperty_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 485} MSNdis_80211_ReceivedSignalStrength_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 486} MSSerial_CommProperties_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSSerial_CommProperties_GUID__Loc == MSSerial_CommProperties_GUID;
    assume MSSerial_CommProperties_GUID != 0;
    call {:si_unique_call 487} MSNdis_ReceiveError_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_ReceiveError_GUID__Loc == MSNdis_ReceiveError_GUID;
    assume MSNdis_ReceiveError_GUID != 0;
    call {:si_unique_call 488} MSNdis_80211_InfrastructureMode_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 489} MSNdis_80211_ReceiveAntennaSelected_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 490} MSNdis_StatusTaskOffloadChange_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 491} MSNdis_StatusDot11PhyStateChange_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 492} MSStorageDriver_FailurePredictThresholds_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 493} GUID_BUS_TYPE_USB__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_BUS_TYPE_USB__Loc == GUID_BUS_TYPE_USB;
    assume GUID_BUS_TYPE_USB != 0;
    call {:si_unique_call 494} FrequencyRangeDescriptor_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume FrequencyRangeDescriptor_GUID__Loc == FrequencyRangeDescriptor_GUID;
    assume FrequencyRangeDescriptor_GUID != 0;
    call {:si_unique_call 495} KeyboardClassGuid__Loc := __HAVOC_malloc_or_null(16);
    assume KeyboardClassGuid__Loc == KeyboardClassGuid;
    assume KeyboardClassGuid != 0;
    call {:si_unique_call 496} Globals__Loc := __HAVOC_malloc_or_null(652);
    assume Globals__Loc == Globals;
    assume Globals != 0;
    call {:si_unique_call 497} GUID_INT_ROUTE_INTERFACE_STANDARD__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 498} MSNdis_ReceiveBlockSize_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_ReceiveBlockSize_GUID__Loc == MSNdis_ReceiveBlockSize_GUID;
    assume MSNdis_ReceiveBlockSize_GUID != 0;
    call {:si_unique_call 499} MSNdis_TransmitsOk_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_TransmitsOk_GUID__Loc == MSNdis_TransmitsOk_GUID;
    assume MSNdis_TransmitsOk_GUID != 0;
    call {:si_unique_call 500} MSNdis_TokenRingPermanentAddress_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 501} MSNdis_SetInterruptModeration_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 502} MSSmBios_RawSMBiosTables_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSSmBios_RawSMBiosTables_GUID__Loc == MSSmBios_RawSMBiosTables_GUID;
    assume MSSmBios_RawSMBiosTables_GUID != 0;
    call {:si_unique_call 503} MSNdis_WmiTcpLargeSendOffloadV1_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 504} MSNdis_SetTcpOffloadParameters_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 511} MSNdis_WmiHDSplitCurrentConfig_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 512} MSStorageDriver_FailurePredictEvent_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 513} WmiMonitorAnalogVideoInputParams_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 514} GUID_PCC_INTERFACE_INTERNAL__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_PCC_INTERFACE_INTERNAL__Loc == GUID_PCC_INTERFACE_INTERNAL;
    assume GUID_PCC_INTERFACE_INTERNAL != 0;
    call {:si_unique_call 515} MSMCAEvent_SwitchToCPEPolling_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 516} GUID_D3COLD_SUPPORT_INTERFACE__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_D3COLD_SUPPORT_INTERFACE__Loc == GUID_D3COLD_SUPPORT_INTERFACE;
    assume GUID_D3COLD_SUPPORT_INTERFACE != 0;
    call {:si_unique_call 517} MSNdis_CoDriverVersion_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_CoDriverVersion_GUID__Loc == MSNdis_CoDriverVersion_GUID;
    assume MSNdis_CoDriverVersion_GUID != 0;
    call {:si_unique_call 518} MSNdis_FddiLongMulticastList_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 529} boogieTmp := __HAVOC_malloc_or_null(240);
    assume sicrni == boogieTmp;
    call {:si_unique_call 530} boogieTmp := __HAVOC_malloc_or_null(60);
    call {:si_unique_call 531} boogieTmp := __HAVOC_malloc_or_null(16);
    call {:si_unique_call 532} boogieTmp := __HAVOC_malloc_or_null(12);
    call {:si_unique_call 533} vslice_dummy_var_116 := __HAVOC_malloc(280);
    call {:si_unique_call 534} vslice_dummy_var_1699 := __HAVOC_malloc(44);
    call {:si_unique_call 535} vslice_dummy_var_1700 := __HAVOC_malloc(24);
    assume {:mainInitDone} true;
    call {:si_unique_call 536} corralExtraInit();
    call {:si_unique_call 537} corralExplainErrorInit();
    call {:si_unique_call 538} _sdv_init4();
    call {:si_unique_call 539} _sdv_init1();
    call {:si_unique_call 540} _sdv_init2();
    goto anon9_Then, anon9_Else;
  ...
  L31:
    ...
    call {:si_unique_call 541} sdv_main();
    goto anon12_Then, anon12_Else;
...
procedure {:origName "VerSetConditionMask"} {:osmodel} VerSetConditionMask(actual_ConditionMask_1: int, actual_TypeMask_1: int, actual_Condition: int) returns (Tmp_86: int);
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);



implementation {:origName "VerSetConditionMask"} {:osmodel} VerSetConditionMask(actual_ConditionMask_1: int, actual_TypeMask_1: int, actual_Condition: int) returns (Tmp_86: int)
{
  var {:scalar} r_3: int;
...
procedure {:origName "IoCancelIrp"} {:osmodel} IoCancelIrp(actual_Irp_2: int) returns (Tmp_88: int);
  free ensures {:va_keep} Tmp_88 == 0 || Tmp_88 == 1;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);



implementation {:origName "IoCancelIrp"} {:osmodel} IoCancelIrp(actual_Irp_2: int) returns (Tmp_88: int)
{
...
procedure {:origName "sdv_RunRemoveDevice"} {:osmodel} sdv_RunRemoveDevice(actual_po_1: int, actual_pirp_9: int) returns (Tmp_90: int);
  modifies alloc, Mem_T.Status__IO_STATUS_BLOCK, Mem_T.Item__DEVICE_START_WORKER, Mem_T.Irp__DEVICE_START_WORKER, sdv_compFset, sdv_invoke_on_success, sdv_invoke_on_error, sdv_invoke_on_cancel, Mem_T.Buffer__UNICODE_STRING, Mem_T.Length_unnamed_tag_18, Mem_T.MaximumLength__UNICODE_STRING, Mem_T.P_DEVICE_OBJECT, yogi_error;
  free ensures {:va_keep} yogi_error == 1;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);
...
implementation {:origName "sdv_RunRemoveDevice"} {:osmodel} sdv_RunRemoveDevice(actual_po_1: int, actual_pirp_9: int) returns (Tmp_90: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 545} sdv_SetStatus(pirp_9);
    call {:si_unique_call 546} status_4 := KeyboardPnP(po_1, pirp_9);
    call {:si_unique_call 547} sdv_stub_dispatch_end(status_4, 0);
    Tmp_90 := status_4;
    call {:si_unique_call 548} SLIC_sdv_RunRemoveDevice_exit(strConst__li2bpl0, pirp_9, Tmp_90);
    goto anon3_Then, anon3_Else;
...
implementation {:origName "sdv_stub_add_end"} {:osmodel} sdv_stub_add_end()
{
  ...
  anon0:
    call {:si_unique_call 549} vslice_dummy_var_21 := __HAVOC_malloc(4);
    sdv_inside_init_entrypoint := 0;
    return;
}
...
implementation {:origName "RtlInitUnicodeString"} {:osmodel} RtlInitUnicodeString(actual_DestinationString: int, actual_SourceString: int)
{
  ...
  anon0:
    call {:si_unique_call 550} vslice_dummy_var_22 := __HAVOC_malloc(4);
...
procedure {:origName "IoAttachDeviceToDeviceStack"} {:osmodel} IoAttachDeviceToDeviceStack(actual_SourceDevice: int, actual_TargetDevice_1: int) returns (Tmp_96: int);
  free ensures {:va_keep} Tmp_96 == 0 || Tmp_96 == actual_TargetDevice_1;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);



implementation {:origName "IoAttachDeviceToDeviceStack"} {:osmodel} IoAttachDeviceToDeviceStack(actual_SourceDevice: int, actual_TargetDevice_1: int) returns (Tmp_96: int)
{
...
procedure {:origName "ZwPowerInformation"} {:osmodel} ZwPowerInformation(actual_InformationLevel: int, actual_InputBuffer: int, actual_InputBufferLength: int, actual_OutputBuffer: int, actual_OutputBufferLength: int) returns (Tmp_98: int);
...
implementation {:origName "ZwPowerInformation"} {:osmodel} ZwPowerInformation(actual_InformationLevel: int, actual_InputBuffer: int, actual_InputBufferLength: int, actual_OutputBuffer: int, actual_OutputBufferLength: int) returns (Tmp_98: int)
{
...
implementation {:origName "sdv_RtlZeroMemory"} {:osmodel} sdv_RtlZeroMemory(actual_Destination_1: int, actual_Length_1: int)
{
  ...
  anon0:
    call {:si_unique_call 551} vslice_dummy_var_23 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "sdv_do_paged_code_check"} {:osmodel} sdv_do_paged_code_check()
{
  ...
  anon0:
    call {:si_unique_call 552} vslice_dummy_var_24 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "sdv_IoMarkIrpPending"} {:osmodel} sdv_IoMarkIrpPending(actual_pirp_10: int)
{
  ...
  anon0:
    call {:si_unique_call 553} vslice_dummy_var_25 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "RtlFreeUnicodeString"} {:osmodel} RtlFreeUnicodeString(actual_UnicodeString: int)
{
  ...
  anon0:
    call {:si_unique_call 554} vslice_dummy_var_26 := __HAVOC_malloc(4);
    return;
}



procedure {:origName "IoRegisterDeviceInterface"} {:osmodel} IoRegisterDeviceInterface(actual_PhysicalDeviceObject: int, actual_InterfaceClassGuid: int, actual_ReferenceString: int, actual_SymbolicLinkName: int) returns (Tmp_108: int);
  free ensures {:va_keep} Tmp_108 == -1073741823 || Tmp_108 == -1073741808 || Tmp_108 == 0;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);



implementation {:origName "IoRegisterDeviceInterface"} {:osmodel} IoRegisterDeviceInterface(actual_PhysicalDeviceObject: int, actual_InterfaceClassGuid: int, actual_ReferenceString: int, actual_SymbolicLinkName: int) returns (Tmp_108: int)
{
...
procedure {:origName "IoRegisterPlugPlayNotification"} {:osmodel} IoRegisterPlugPlayNotification(actual_EventCategory: int, actual_EventCategoryFlags: int, actual_EventCategoryData: int, actual_DriverObject_2: int, actual_CallbackRoutine: int, actual_Context_5: int, actual_NotificationEntry_1: int) returns (Tmp_111: int);
...
implementation {:origName "sdv_KeReleaseSpinLock"} {:osmodel} sdv_KeReleaseSpinLock(actual_SpinLock_1: int, actual_new: int)
{
  ...
  anon0:
    call {:si_unique_call 555} vslice_dummy_var_27 := __HAVOC_malloc(4);
    new := actual_new;
    return;
}
...
implementation {:origName "sdv_IoCompleteRequest"} {:osmodel} sdv_IoCompleteRequest(actual_pirp_11: int, actual_PriorityBoost: int)
{
  ...
  anon0:
    call {:si_unique_call 556} vslice_dummy_var_28 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "sdv_RtlCopyMemory"} {:osmodel} sdv_RtlCopyMemory(actual_Destination_2: int, actual_Source_1: int, actual_Length_2: int)
{
  ...
  anon0:
    call {:si_unique_call 557} vslice_dummy_var_29 := __HAVOC_malloc(4);
    return;
}



procedure {:origName "ZwQueryValueKey"} {:osmodel} ZwQueryValueKey(actual_KeyHandle: int, actual_ValueName: int, actual_KeyValueInformationClass: int, actual_KeyValueInformation: int, actual_Length_3: int, actual_ResultLength_1: int) returns (Tmp_119: int);
  free ensures {:va_keep} Tmp_119 == -1073741811 || Tmp_119 == -1073741823 || Tmp_119 == 0 || Tmp_119 == 5 || Tmp_119 == -1073741789;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);



implementation {:origName "ZwQueryValueKey"} {:osmodel} ZwQueryValueKey(actual_KeyHandle: int, actual_ValueName: int, actual_KeyValueInformationClass: int, actual_KeyValueInformation: int, actual_Length_3: int, actual_ResultLength_1: int) returns (Tmp_119: int)
{
  var {:scalar} L_1: int;
...
implementation {:origName "sdv_ExFreePool"} {:osmodel} sdv_ExFreePool(actual_P: int)
{
  ...
  anon0:
    call {:si_unique_call 558} vslice_dummy_var_30 := __HAVOC_malloc(4);
    return;
}



procedure {:origName "sdv_IoAcquireRemoveLock"} {:osmodel} sdv_IoAcquireRemoveLock(actual_RemoveLock_1: int, actual_Tag_1: int) returns (Tmp_125: int);
  free ensures {:va_keep} Tmp_125 == -1073741823 || Tmp_125 == -1073741738 || Tmp_125 == 0;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);



implementation {:origName "sdv_IoAcquireRemoveLock"} {:osmodel} sdv_IoAcquireRemoveLock(actual_RemoveLock_1: int, actual_Tag_1: int) returns (Tmp_125: int)
{
  ...
  L1:
    call {:si_unique_call 559} SLIC_sdv_IoAcquireRemoveLock_exit(0, Tmp_125);
    return;
...
procedure {:origName "sdv_IsListEmpty"} {:osmodel} sdv_IsListEmpty(actual_ListHead: int) returns (Tmp_129: int);
  free ensures {:va_keep} Tmp_129 == 1 || Tmp_129 == 0;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);



implementation {:origName "sdv_IsListEmpty"} {:osmodel} sdv_IsListEmpty(actual_ListHead: int) returns (Tmp_129: int)
{
...
procedure {:origName "IoAllocateIrp"} {:osmodel} IoAllocateIrp(actual_StackSize: int, actual_ChargeQuota: int) returns (Tmp_131: int);
...
implementation {:origName "IoAllocateIrp"} {:osmodel} IoAllocateIrp(actual_StackSize: int, actual_ChargeQuota: int) returns (Tmp_131: int)
{
  ...
  anon3_Else:
    assume {:nonnull} sdv_other_irp != 0;
    assume sdv_other_irp > 0;
    call {:si_unique_call 561} irpSp_1 := sdv_IoGetNextIrpStackLocation(sdv_other_irp);
    assume {:nonnull} irpSp_1 != 0;
    assume irpSp_1 > 0;
    sdv_compFset := 0;
    Tmp_131 := sdv_other_irp;
    goto L1;
...
procedure {:origName "ZwOpenKey"} {:osmodel} ZwOpenKey(actual_KeyHandle_1: int, actual_DesiredAccess_1: int, actual_ObjectAttributes: int) returns (Tmp_135: int);
  modifies alloc;
  free ensures {:va_keep} Tmp_135 == 0 || Tmp_135 == -1073741727;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);



implementation {:origName "ZwOpenKey"} {:osmodel} ZwOpenKey(actual_KeyHandle_1: int, actual_DesiredAccess_1: int, actual_ObjectAttributes: int) returns (Tmp_135: int)
{
  ...
  anon3_Else:
    call {:si_unique_call 562} sdv_40 := __HAVOC_malloc(4);
...
implementation {:origName "KeInitializeEvent"} {:osmodel} KeInitializeEvent(actual_Event_1: int, actual_Type_1: int, actual_State_1: int)
{
  ...
  anon0:
    call {:si_unique_call 563} vslice_dummy_var_32 := __HAVOC_malloc(4);
...
implementation {:origName "IoBuildDeviceIoControlRequest"} {:osmodel} IoBuildDeviceIoControlRequest(actual_IoControlCode: int, actual_DeviceObject_9: int, actual_InputBuffer_1: int, actual_InputBufferLength_1: int, actual_OutputBuffer_1: int, actual_OutputBufferLength_1: int, actual_InternalDeviceIoControl: int, actual_Event_2: int, actual_IoStatusBlock: int) returns (Tmp_143: int)
{
  ...
  L14:
    ...
    Tmp_143 := sdv_IoBuildDeviceIoControlRequest_irp;
    goto L1;
...
implementation {:origName "IoFreeIrp"} {:osmodel} IoFreeIrp(actual_pirp_12: int)
{
  ...
  anon0:
    call {:si_unique_call 564} vslice_dummy_var_33 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "sdv_KeInitializeSpinLock"} {:osmodel} sdv_KeInitializeSpinLock(actual_SpinLock_2: int)
{
  ...
  anon0:
    call {:si_unique_call 565} vslice_dummy_var_34 := __HAVOC_malloc(4);
...
procedure {:origName "ExAllocatePoolWithTag"} {:osmodel} ExAllocatePoolWithTag(actual_PoolType: int, actual_NumberOfBytes: int, actual_Tag_2: int) returns (Tmp_151: int);
  modifies alloc;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);
...
implementation {:origName "ExAllocatePoolWithTag"} {:osmodel} ExAllocatePoolWithTag(actual_PoolType: int, actual_NumberOfBytes: int, actual_Tag_2: int) returns (Tmp_151: int)
{
  ...
  anon3_Else:
    call {:si_unique_call 566} sdv_50 := __HAVOC_malloc(NumberOfBytes);
    Tmp_151 := sdv_50;
    goto L1;
...
procedure {:origName "RtlWriteRegistryValue"} {:osmodel} RtlWriteRegistryValue(actual_RelativeTo_1: int, actual_Path_1: int, actual_ValueName_1: int, actual_ValueType: int, actual_ValueData: int, actual_ValueLength: int) returns (Tmp_153: int);
...
implementation {:origName "RtlWriteRegistryValue"} {:osmodel} RtlWriteRegistryValue(actual_RelativeTo_1: int, actual_Path_1: int, actual_ValueName_1: int, actual_ValueType: int, actual_ValueData: int, actual_ValueLength: int) returns (Tmp_153: int)
{
...
procedure {:origName "IoAllocateWorkItem"} {:osmodel} IoAllocateWorkItem(actual_DeviceObject_10: int) returns (Tmp_155: int);
  modifies alloc;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);
...
implementation {:origName "IoAllocateWorkItem"} {:osmodel} IoAllocateWorkItem(actual_DeviceObject_10: int) returns (Tmp_155: int)
{
  ...
  anon0:
    call {:si_unique_call 567} sdv_53 := __HAVOC_malloc(1);
    ioWorkItem := sdv_53;
    goto anon6_Then, anon6_Else;
...
procedure {:origName "IoWMIRegistrationControl"} {:osmodel} IoWMIRegistrationControl(actual_DeviceObject_12: int, actual_Action: int) returns (Tmp_170: int);
  free ensures {:va_keep} Tmp_170 == -1073741823 || Tmp_170 == -1073741811 || Tmp_170 == 0;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);



implementation {:origName "IoWMIRegistrationControl"} {:osmodel} IoWMIRegistrationControl(actual_DeviceObject_12: int, actual_Action: int) returns (Tmp_170: int)
{
...
procedure {:origName "sdv_IoReleaseRemoveLock"} sdv_IoReleaseRemoveLock(actual_sdv_61: int, actual_sdv_62: int) returns (Tmp_174: int);
  modifies alloc;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);
...
implementation {:origName "sdv_IoReleaseRemoveLock"} sdv_IoReleaseRemoveLock(actual_sdv_61: int, actual_sdv_62: int) returns (Tmp_174: int)
{
  var {:scalar} sdv_63: int;

  anon0:
    call {:si_unique_call 570} Tmp_174 := __HAVOC_malloc(4);
    call {:si_unique_call 571} sdv_63 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_174 != 0;
    assume Tmp_174 > 0;
    assume {:nonnull} sdv_63 != 0;
    assume sdv_63 > 0;
    return;
}
...
procedure {:origName "sdv_InsertTailList"} sdv_InsertTailList(actual_sdv_69: int, actual_sdv_70: int) returns (Tmp_178: int);
  modifies alloc;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);
...
implementation {:origName "sdv_InsertTailList"} sdv_InsertTailList(actual_sdv_69: int, actual_sdv_70: int) returns (Tmp_178: int)
{
  var {:scalar} sdv_71: int;

  anon0:
    call {:si_unique_call 572} sdv_71 := __HAVOC_malloc(4);
    call {:si_unique_call 573} Tmp_178 := __HAVOC_malloc(4);
...
procedure {:origName "SLIC_sdv_IoAcquireRemoveLock_exit"} {:osmodel} SLIC_sdv_IoAcquireRemoveLock_exit(actual_caller: int, actual_sdv_81: int);
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);



implementation {:origName "SLIC_sdv_IoAcquireRemoveLock_exit"} {:osmodel} SLIC_sdv_IoAcquireRemoveLock_exit(actual_caller: int, actual_sdv_81: int)
{
  ...
  anon3_Else:
    ...
    call {:si_unique_call 574} SLIC_EXIT_ROUTINE(strConst__li2bpl1);
    goto L2;
...
procedure {:origName "SLIC_sdv_RunRemoveDevice_exit"} {:osmodel} SLIC_sdv_RunRemoveDevice_exit(actual_caller_1: int, actual_sdv_82: int, actual_sdv_83: int);
  modifies yogi_error;
  free ensures {:va_keep} yogi_error == 1;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);
...
implementation {:origName "SLIC_sdv_RunRemoveDevice_exit"} {:osmodel} SLIC_sdv_RunRemoveDevice_exit(actual_caller_1: int, actual_sdv_82: int, actual_sdv_83: int)
{
  ...
  anon8_Else:
    assume {:partition} sdv_83 == -1073741637;
  ...
  anon7_Then:
    call {:si_unique_call 576} SLIC_ABORT_2_0(caller_1, sdv_82, sdv_83);
    goto anon9_Then, anon9_Else;
...
procedure {:origName "SLIC_ABORT_2_0"} SLIC_ABORT_2_0(actual_caller_2: int, actual_sdv_84: int, actual_sdv_85: int);
  modifies yogi_error;
  free ensures {:va_keep} yogi_error == 1;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);
...
implementation {:origName "SLIC_ABORT_2_0"} SLIC_ABORT_2_0(actual_caller_2: int, actual_sdv_84: int, actual_sdv_85: int)
{
...
implementation {:origName "WPP_RECORDER_SF_S"} WPP_RECORDER_SF_S(actual_AutoLogContext: int, actual_level: int, actual_flags: int, actual_id: int, actual_traceGuid: int, actual_s_p_e_c_i_a_l_1: int)
{
  ...
  anon0:
    call {:si_unique_call 578} vslice_dummy_var_37 := __HAVOC_malloc(4);
    level := actual_level;
    flags := actual_flags;
    ...
    call {:si_unique_call 580} Tmp_192 := corral_nondet();
    goto anon29_Then, anon29_Else;

  anon29_Else:
    call {:si_unique_call 581} Tmp_199 := corral_nondet();
  ...
  L23:
    call {:si_unique_call 582} Tmp_203 := corral_nondet();
  ...
  L42:
    call {:si_unique_call 583} vslice_dummy_var_38 := corral_nondet();
    return;
...
implementation {:origName "KbdConfiguration"} KbdConfiguration()
{
  ...
  anon0:
    call {:si_unique_call 584} defaultConnectMultiplePorts := __HAVOC_malloc(4);
    call {:si_unique_call 585} defaultDataQueueSize := __HAVOC_malloc(4);
    call {:si_unique_call 586} vslice_dummy_var_40 := __HAVOC_malloc(4);
    call {:si_unique_call 587} defaultUnicodeName := __HAVOC_malloc(12);
    call {:si_unique_call 588} defaultSendOutputToAllPorts := __HAVOC_malloc(4);
    call {:si_unique_call 589} defaultMaximumPortsServiced := __HAVOC_malloc(4);
    call {:si_unique_call 590} parametersPath := __HAVOC_malloc(12);
    call {:si_unique_call 591} vslice_dummy_var_42 := __HAVOC_malloc(48);
    call {:si_unique_call 592} Tmp_226 := __HAVOC_malloc(56);
    parameters := 0;
    ...
    path := 0;
    queriesPlusOne := 6;
    call {:si_unique_call 593} sdv_do_paged_code_check();
    call {:si_unique_call 594} RtlInitUnicodeString(parametersPath, 0);
    call {:si_unique_call 595} RtlInitUnicodeString(defaultUnicodeName, 0);
    path := Mem_T.Buffer__UNICODE_STRING[Buffer__UNICODE_STRING(RegistryPath__GLOBALS(Globals))];
    Tmp_229 := 28 * queriesPlusOne;
    call {:si_unique_call 596} sdv_90 := ExAllocatePoolWithTag(1, Tmp_229, -1016831413);
    parameters := sdv_90;
  ...
  anon32_Else:
    ...
    havoc Tmp_224;
    havoc Tmp_207;
    call {:si_unique_call 597} WPP_RECORDER_SF_S(Tmp_207, 0, 2, 64, Tmp_224, path);
    status_6 := -1073741823;
    goto L54;
  ...
  anon23_Else:
    ...
    call {:si_unique_call 598} sdv_RtlZeroMemory(0, Tmp_220);
    call {:si_unique_call 599} vslice_dummy_var_41 := corral_nondet();
  ...
  L131:
    havoc Tmp_228;
    havoc Tmp_216;
    call {:si_unique_call 601} WPP_RECORDER_SF_S(Tmp_216, 0, 2, 68, Tmp_228, Mem_T.Buffer__UNICODE_STRING[Buffer__UNICODE_STRING(BaseClassName__GLOBALS(Globals))]);
    goto anon27_Then, anon27_Else;
  ...
  anon27_Else:
    ...
    call {:si_unique_call 602} WPP_RECORDER_SF_D(Tmp_223, 0, 2, 69, Tmp_222, vslice_dummy_var_1701);
    assume {:nonnull} defaultDataQueueSize != 0;
    assume defaultDataQueueSize > 0;
    goto L139;
  ...
  L149:
    ...
    call {:si_unique_call 603} WPP_RECORDER_SF_D(Tmp_209, 0, 2, 70, Tmp_208, vslice_dummy_var_1702);
    havoc Tmp_230;
    havoc Tmp_217;
    havoc vslice_dummy_var_1703;
    call {:si_unique_call 604} WPP_RECORDER_SF_d(Tmp_217, 0, 2, 71, Tmp_230, vslice_dummy_var_1703);
    goto anon29_Then, anon29_Else;
  ...
  L240:
    ...
    call {:si_unique_call 605} WPP_RECORDER_SF_d(Tmp_225, 0, 2, 72, Tmp_206, vslice_dummy_var_1704);
    assume {:nonnull} parametersPath != 0;
    assume parametersPath > 0;
    goto anon30_Then, anon30_Else;
  ...
  anon25_Then:
    ...
    assume {:nonnull} parametersPath != 0;
    assume parametersPath > 0;
    call {:si_unique_call 608} WPP_RECORDER_SF_S(Tmp_205, 0, 2, 66, Tmp_211, Mem_T.Buffer__UNICODE_STRING[Buffer__UNICODE_STRING(parametersPath)]);
    Tmp_226 := strConst__li2bpl6;
    call {:si_unique_call 609} RtlInitUnicodeString(defaultUnicodeName, Tmp_226);
    ...
    assume {:nonnull} parameters != 0;
    assume parameters > 0;
    call {:si_unique_call 610} status_6 := sdv_RtlQueryRegistryValues(0, 0, 0, 0, 0);
    goto anon26_Then, anon26_Else;
  ...
  anon26_Else:
    ...
    havoc Tmp_215;
    havoc Tmp_219;
    call {:si_unique_call 611} WPP_RECORDER_SF_D(Tmp_219, 0, 2, 67, Tmp_215, status_6);
    goto L55;
  ...
  anon32_Then:
    ...
    call {:si_unique_call 612} sdv_RtlZeroMemory(0, Tmp_212);
    assume {:nonnull} parametersPath != 0;
    assume parametersPath > 0;
    ...
    call {:si_unique_call 613} sdv_91 := ExAllocatePoolWithTag(1, Tmp_218, -1016831413);
    assume {:nonnull} parametersPath != 0;
    assume parametersPath > 0;
    Mem_T.Buffer__UNICODE_STRING[Buffer__UNICODE_STRING(parametersPath)] := sdv_91;
    assume {:nonnull} parametersPath != 0;
    assume parametersPath > 0;
  ...
  anon33_Else:
    ...
    havoc Tmp_221;
    havoc Tmp_214;
    call {:si_unique_call 614} WPP_RECORDER_SF_S(Tmp_214, 0, 2, 65, Tmp_221, path);
    status_6 := -1073741823;
    goto L54;
...
implementation {:origName "_sdv_init1"} _sdv_init1()
{
  ...
  anon0:
    call {:si_unique_call 615} vslice_dummy_var_44 := __HAVOC_malloc(4);
    call {:si_unique_call 616} Tmp_233 := __HAVOC_malloc(4);
...
procedure {:origName "RemoveHeadList"} RemoveHeadList(actual_ListHead_1: int) returns (Tmp_238: int);
  modifies alloc;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);
...
implementation {:origName "RemoveHeadList"} RemoveHeadList(actual_ListHead_1: int) returns (Tmp_238: int)
{
  ...
  L9:
    call {:si_unique_call 617} FatalListEntryError(ListHead_1, Entry_1, NextEntry);
    goto L12;
...
procedure {:origName "RtlUnicodeStringValidateDestWorker_sdv_static_function_1"} RtlUnicodeStringValidateDestWorker_sdv_static_function_1(actual_DestinationString_1: int, actual_ppszDest: int, actual_pcchDest: int, actual_pcchDestLength: int, actual_cchMax_1: int, actual_dwFlags_1: int) returns (Tmp_252: int);
  modifies Mem_T.PINT4;
  free ensures {:va_keep} Tmp_252 == 0 || Tmp_252 == -1073741811;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);



implementation {:origName "RtlUnicodeStringValidateDestWorker_sdv_static_function_1"} RtlUnicodeStringValidateDestWorker_sdv_static_function_1(actual_DestinationString_1: int, actual_ppszDest: int, actual_pcchDest: int, actual_pcchDestLength: int, actual_cchMax_1: int, actual_dwFlags_1: int) returns (Tmp_252: int)
{
  ...
  L7:
    call {:si_unique_call 618} status_10 := RtlUnicodeStringValidateWorker_sdv_static_function_1(DestinationString_1, cchMax_1, dwFlags_1);
    goto anon9_Then, anon9_Else;
...
procedure {:origName "KeyboardClassSetLedsComplete"} KeyboardClassSetLedsComplete(actual_DeviceObject_14: int, actual_Irp_8: int, actual_Context_8: int) returns (Tmp_257: int);
  modifies alloc;
  free ensures {:va_keep} Tmp_257 == -1073741802;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);



implementation {:origName "KeyboardClassSetLedsComplete"} KeyboardClassSetLedsComplete(actual_DeviceObject_14: int, actual_Irp_8: int, actual_Context_8: int) returns (Tmp_257: int)
{
  ...
  anon0:
    ...
    assume data_1 > 0;
    call {:si_unique_call 619} vslice_dummy_var_45 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(data_1), Irp_8);
...
procedure {:origName "DriverEntry"} DriverEntry(actual_DriverObject_3: int, actual_RegistryPath: int) returns (Tmp_259: int);
  ...
  free ensures {:va_keep} Tmp_259 == 0 || Tmp_259 == -1073741823 || Tmp_259 == 5 || Tmp_259 == -1073741811 || Tmp_259 == -1073741824 || Tmp_259 == -1073741771 || Tmp_259 == -1073741670;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);



implementation {:origName "DriverEntry"} DriverEntry(actual_DriverObject_3: int, actual_RegistryPath: int) returns (Tmp_259: int)
{
  var {:scalar} i: int;
  ...
  anon0:
    ...
    call {:si_unique_call 627} Tmp_263 := __HAVOC_malloc(112);
    call {:si_unique_call 628} Tmp_264 := __HAVOC_malloc(112);
    call {:si_unique_call 629} Tmp_266 := __HAVOC_malloc(112);
    call {:si_unique_call 630} Tmp_267 := __HAVOC_malloc(112);
    call {:si_unique_call 631} Tmp_269 := __HAVOC_malloc(112);
    call {:si_unique_call 632} vslice_dummy_var_49 := __HAVOC_malloc(36);
    call {:si_unique_call 633} vslice_dummy_var_50 := __HAVOC_malloc(8);
    call {:si_unique_call 634} dumpData := __HAVOC_malloc(16);
    call {:si_unique_call 635} Tmp_280 := __HAVOC_malloc(112);
    call {:si_unique_call 636} Tmp_283 := __HAVOC_malloc(112);
    call {:si_unique_call 637} Tmp_284 := __HAVOC_malloc(112);
    call {:si_unique_call 638} vslice_dummy_var_51 := __HAVOC_malloc(20);
    call {:si_unique_call 639} Tmp_287 := __HAVOC_malloc(112);
    call {:si_unique_call 640} Tmp_292 := __HAVOC_malloc(112);
    status_12 := 0;
    deviceExtension := 0;
    ...
    havoc Tmp_294;
    havoc Tmp_272;
    call {:si_unique_call 641} WPP_RECORDER_SF_(Tmp_272, 0, 2, 10, Tmp_294);
    ...
    Mem_T.Buffer__UNICODE_STRING[Buffer__UNICODE_STRING(BaseClassName__GLOBALS(Globals))] := vslice_dummy_var_1705;
    ...
    Tmp_275 := Mem_T.MaximumLength__UNICODE_STRING[MaximumLength__UNICODE_STRING(RegistryPath__GLOBALS(Globals))];
    call {:si_unique_call 646} sdv_106 := ExAllocatePoolWithTag(512, Tmp_275, -1016831413);
    Mem_T.Buffer__UNICODE_STRING[Buffer__UNICODE_STRING(RegistryPath__GLOBALS(Globals))] := sdv_106;
  ...
  anon71_Else:
    ...
    havoc Tmp_279;
    havoc Tmp_296;
    call {:si_unique_call 647} WPP_RECORDER_SF_(Tmp_296, 0, 2, 11, Tmp_279);
    assume {:nonnull} RegistryPath != 0;
    assume RegistryPath > 0;
  ...
  L112:
    havoc Tmp_288;
    havoc Tmp_281;
    call {:si_unique_call 652} WPP_RECORDER_SF_(Tmp_281, 0, 2, 14, Tmp_288);
    Tmp_259 := status_12;
    return;
  ...
  anon71_Then:
    ...
    assume {:nonnull} RegistryPath != 0;
    assume RegistryPath > 0;
    Tmp_289 := Mem_T.Length_unnamed_tag_18[Length_unnamed_tag_18(RegistryPath)];
    call {:si_unique_call 657} sdv_RtlMoveMemory(0, 0, Tmp_289);
    assume {:nonnull} RegistryPath != 0;
    assume RegistryPath > 0;
    Tmp_293 := INTDIV(Mem_T.Length_unnamed_tag_18[Length_unnamed_tag_18(RegistryPath)], 2);
  ...
  L71:
    ...
    call {:si_unique_call 659} vslice_dummy_var_52 := corral_nondet();
    assume {:nonnull} basePortName != 0;
    assume basePortName > 0;
  ...
  anon50_Then:
    ...
    assume {:nonnull} basePortName != 0;
    assume basePortName > 0;
    Tmp_265 := INTDIV(Mem_T.Length_unnamed_tag_18[Length_unnamed_tag_18(basePortName)], 2) + 1;
    ...
    assume {:nonnull} basePortName != 0;
    assume basePortName > 0;
    call {:si_unique_call 660} vslice_dummy_var_53 := KbdDeterminePortsServiced(basePortName, numPorts);
    havoc Tmp_285;
    havoc Tmp_268;
    assume {:nonnull} numPorts != 0;
    assume numPorts > 0;
    havoc vslice_dummy_var_1706;
    call {:si_unique_call 661} WPP_RECORDER_SF_d(Tmp_268, 0, 2, 12, Tmp_285, vslice_dummy_var_1706);
    ...
    assume {:nonnull} fullPortName != 0;
    assume fullPortName > 0;
    Tmp_277 := Mem_T.MaximumLength__UNICODE_STRING[MaximumLength__UNICODE_STRING(fullPortName)];
    call {:si_unique_call 663} sdv_114 := ExAllocatePoolWithTag(1, Tmp_277, -1016831413);
    assume {:nonnull} fullPortName != 0;
    assume fullPortName > 0;
    Mem_T.Buffer__UNICODE_STRING[Buffer__UNICODE_STRING(fullPortName)] := sdv_114;
    assume {:nonnull} fullPortName != 0;
    assume fullPortName > 0;
  ...
  anon72_Else:
    ...
    havoc Tmp_271;
    havoc Tmp_282;
    call {:si_unique_call 664} WPP_RECORDER_SF_(Tmp_282, 0, 2, 13, Tmp_271);
    status_12 := -1073741823;
    assume {:nonnull} dumpData != 0;
    assume dumpData > 0;
    assume {:nonnull} fullPortName != 0;
    assume fullPortName > 0;
    call {:si_unique_call 665} KeyboardClassLogError(DriverObject_3, -1073414143, 10006, status_12, 1, dumpData, 0);
    goto L82;
  ...
  anon72_Then:
    ...
    assume {:nonnull} fullPortName != 0;
    assume fullPortName > 0;
    Tmp_260 := Mem_T.MaximumLength__UNICODE_STRING[MaximumLength__UNICODE_STRING(fullPortName)];
    call {:si_unique_call 666} sdv_RtlZeroMemory(0, Tmp_260);
    call {:si_unique_call 667} vslice_dummy_var_54 := corral_nondet();
    call {:si_unique_call 668} vslice_dummy_var_46 := corral_nondet();
    call {:si_unique_call 669} vslice_dummy_var_55 := corral_nondet();
    i := 0;
    goto L178;

  L178:
    call {:si_unique_call 670} i, Tmp_261, Tmp_262, file_1, Tmp_273, Tmp_276, Tmp_278, status_12, deviceExtension, Tmp_295, vslice_dummy_var_47, vslice_dummy_var_48 := DriverEntry_loop_L178(i, classDeviceObject, Tmp_261, fullPortName, Tmp_262, file_1, fullClassName, Tmp_273, Tmp_276, Tmp_278, numPorts, status_12, deviceExtension, Tmp_295, DriverObject_3, vslice_dummy_var_47, vslice_dummy_var_48);
    goto L178_last;
  ...
  anon59_Else:
    ...
    assume {:nonnull} fullPortName != 0;
    assume fullPortName > 0;
    call {:si_unique_call 671} status_12 := KbdCreateClassObject(DriverObject_3, InitExtension__GLOBALS(Globals), classDeviceObject, fullClassName, 1);
  ...
  anon60_Else:
    ...
    assume {:nonnull} deviceExtension != 0;
    assume deviceExtension > 0;
    call {:si_unique_call 672} status_12 := IoGetDeviceObjectPointer(0, 128, 0, TopPort__DEVICE_EXTENSION(deviceExtension));
  ...
  anon61_Else:
    ...
    assume {:nonnull} deviceExtension != 0;
    assume deviceExtension > 0;
    Tmp_276 := Mem_T.P_DEVICE_OBJECT[TopPort__DEVICE_EXTENSION(deviceExtension)];
    assume {:nonnull} Mem_T.P_DEVICE_OBJECT[classDeviceObject] != 0;
    assume Mem_T.P_DEVICE_OBJECT[classDeviceObject] > 0;
    ...
    assume {:nonnull} fullClassName != 0;
    assume fullClassName > 0;
    call {:si_unique_call 673} status_12 := KeyboardAddDeviceEx(deviceExtension, Mem_T.PINT4[fullClassName], file_1);
    assume {:nonnull} fullClassName != 0;
    assume fullClassName > 0;
  ...
  anon64_Else:
    ...
    assume {:nonnull} deviceExtension != 0;
    assume deviceExtension > 0;
    call {:si_unique_call 675} vslice_dummy_var_47 := sdv_InsertTailList(LegacyDeviceList__GLOBALS(Globals), Link__DEVICE_EXTENSION(deviceExtension));
    goto L215;
  ...
  anon67_Else:
    ...
    call {:si_unique_call 678} vslice_dummy_var_48 := sdv_ObDereferenceObject(0);
    goto L228;
  ...
  anon68_Else:
    ...
    Mem_T.InputData__DEVICE_EXTENSION[InputData__DEVICE_EXTENSION(deviceExtension)] := vslice_dummy_var_1707;
    goto L232;
  ...
  anon62_Else:
    ...
    Mem_T.InputData__DEVICE_EXTENSION[InputData__DEVICE_EXTENSION(deviceExtension)] := vslice_dummy_var_1708;
    goto L245;
  ...
  anon60_Then:
    assume {:partition} 0 > status_12;
    call {:si_unique_call 683} KeyboardClassLogError(li2bplFunctionConstant962, -1073414143, 10008, status_12, 0, 0, 0);
    goto L215;
  ...
  anon49_Then:
    call {:si_unique_call 685} status_12 := KbdCreateClassObject(DriverObject_3, InitExtension__GLOBALS(Globals), classDeviceObject, fullClassName, 1);
  ...
  anon70_Else:
    ...
    assume {:nonnull} fullClassName != 0;
    assume fullClassName > 0;
    call {:si_unique_call 686} vslice_dummy_var_56 := KeyboardAddDeviceEx(deviceExtension, Mem_T.PINT4[fullClassName], 0);
...
procedure {:origName "_InlineInterlockedExchangePointer"} _InlineInterlockedExchangePointer(actual_Destination_3: int, actual_Value: int) returns (Tmp_297: int);
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);



implementation {:origName "_InlineInterlockedExchangePointer"} _InlineInterlockedExchangePointer(actual_Destination_3: int, actual_Value: int) returns (Tmp_297: int)
{
...
implementation {:origName "KeyboardClassCleanupQueue"} KeyboardClassCleanupQueue(actual_DeviceObject_15: int, actual_DeviceExtension: int, actual_FileObject_1: int)
{
  ...
  anon0:
    call {:si_unique_call 688} listHead := __HAVOC_malloc(8);
    call {:si_unique_call 689} vslice_dummy_var_57 := __HAVOC_malloc(4);
    DeviceExtension := actual_DeviceExtension;
    FileObject_1 := actual_FileObject_1;
    call {:si_unique_call 690} InitializeListHead(listHead);
    call {:si_unique_call 691} Tmp_299 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_299 != 0;
    assume Tmp_299 > 0;
    call {:si_unique_call 692} sdv_KeAcquireSpinLock(0, Tmp_299);
    assume {:nonnull} Tmp_299 != 0;
    assume Tmp_299 > 0;
    havoc irql;
    assume {:nonnull} DeviceExtension != 0;
  ...
  L16:
    call {:si_unique_call 693} nextEntry, sdv_118, oldCancelRoutine, irp, entry_1, stack_1, vslice_dummy_var_58, vslice_dummy_var_60 := KeyboardClassCleanupQueue_loop_L16(listHead, nextEntry, sdv_118, oldCancelRoutine, irp, entry_1, stack_1, FileObject_1, vslice_dummy_var_58, vslice_dummy_var_60);
    goto L16_last;
  ...
  anon11_Else:
    ...
    assume entry_1 > 0;
    havoc nextEntry;
    call {:si_unique_call 694} sdv_118 := sdv_containing_record(entry_1, 88);
    irp := sdv_118;
    call {:si_unique_call 695} stack_1 := sdv_IoGetCurrentIrpStackLocation(irp);
    goto anon12_Then, anon12_Else;
  ...
  L31:
    call {:si_unique_call 696} vslice_dummy_var_58 := sdv_RemoveEntryList(0);
    call {:si_unique_call 697} oldCancelRoutine := sdv_IoSetCancelRoutine(irp, 0);
    goto anon14_Then, anon14_Else;
  ...
  anon14_Else:
    ...
    assume {:nonnull} irp != 0;
    assume irp > 0;
    call {:si_unique_call 698} vslice_dummy_var_60 := sdv_InsertTailList(listHead, ListEntry_unnamed_tag_6(Overlay_unnamed_tag_5(Tail__IRP(irp))));
    goto L35;
  ...
  anon14_Then:
    ...
    assume {:nonnull} irp != 0;
    assume irp > 0;
    call {:si_unique_call 699} InitializeListHead(ListEntry_unnamed_tag_6(Overlay_unnamed_tag_5(Tail__IRP(irp))));
    goto L35;
  ...
  anon11_Then:
    call {:si_unique_call 700} sdv_KeReleaseSpinLock(0, irql);
    goto L49;

  L49:
    call {:si_unique_call 701} sdv_123, irp, sdv_124, entry_1, vslice_dummy_var_59 := KeyboardClassCleanupQueue_loop_L49(listHead, sdv_123, irp, sdv_124, entry_1, DeviceExtension, vslice_dummy_var_59);
    goto L49_last;

  L49_last:
    call {:si_unique_call 706} sdv_123 := sdv_IsListEmpty(0);
    goto anon15_Then, anon15_Else;

  anon15_Else:
    assume {:partition} sdv_123 == 0;
    call {:si_unique_call 702} entry_1 := RemoveHeadList(listHead);
    call {:si_unique_call 703} sdv_124 := sdv_containing_record(entry_1, 88);
    irp := sdv_124;
    call {:si_unique_call 704} sdv_IoCompleteRequest(0, 0);
    assume {:nonnull} DeviceExtension != 0;
    assume DeviceExtension > 0;
    call {:si_unique_call 705} vslice_dummy_var_59 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(DeviceExtension), irp);
...
procedure {:origName "KeyboardAddDeviceEx"} KeyboardAddDeviceEx(actual_ClassData: int, actual_FullClassName: int, actual_File: int) returns (Tmp_301: int);
...
implementation {:origName "KeyboardAddDeviceEx"} KeyboardAddDeviceEx(actual_ClassData: int, actual_FullClassName: int, actual_File: int) returns (Tmp_301: int)
{
  var {:scalar} i_1: int;
  ...
  anon0:
    ...
    File := actual_File;
    call {:si_unique_call 707} Tmp_309 := __HAVOC_malloc(4);
    call {:si_unique_call 708} dumpData_1 := __HAVOC_malloc(16);
    errorCode := 0;
    status_13 := 0;
    uniqueErrorValue := 0;
    dumpCount := 0;
    call {:si_unique_call 709} sdv_do_paged_code_check();
    call {:si_unique_call 710} Tmp_313 := __HAVOC_malloc(4);
    assume {:nonnull} ClassData != 0;
    assume ClassData > 0;
    assume {:nonnull} Tmp_313 != 0;
    assume Tmp_313 > 0;
    call {:si_unique_call 711} sdv_KeInitializeSpinLock(Tmp_313);
    assume {:nonnull} ClassData != 0;
    assume ClassData > 0;
    assume {:nonnull} Tmp_313 != 0;
    assume Tmp_313 > 0;
  ...
  anon35_Else:
    call {:si_unique_call 712} status_13 := KbdSendConnectRequest(ClassData, li2bplFunctionConstant978);
    call {:si_unique_call 713} ExAcquireFastMutex(0);
    i_1 := 0;
    goto L37;

  L37:
    call {:si_unique_call 714} i_1, Tmp_307 := KeyboardAddDeviceEx_loop_L37(i_1, Tmp_307);
    goto L37_last;
  ...
  anon37_Else:
    havoc Tmp_306;
    call {:si_unique_call 715} sdv_126 := ExAllocatePoolWithTag(512, Tmp_306, -1016831413);
    classDataList := sdv_126;
    goto anon46_Then, anon46_Else;

  anon46_Else:
    assume {:partition} classDataList != 0;
    havoc Tmp_321;
    call {:si_unique_call 716} sdv_RtlZeroMemory(0, Tmp_321);
    goto anon38_Then, anon38_Else;

  anon38_Else:
    havoc Tmp_317;
    call {:si_unique_call 717} sdv_RtlCopyMemory(0, 0, Tmp_317);
  ...
  anon41_Else:
    ...
    Tmp_320 := Mem_T.Length_unnamed_tag_18[Length_unnamed_tag_18(RegistryPath__GLOBALS(Globals))] + 2;
    call {:si_unique_call 720} status_13 := RtlWriteRegistryValue(4, 0, 0, 1, 0, Tmp_320);
  ...
  anon42_Else:
    ...
    havoc Tmp_310;
    havoc Tmp_322;
    call {:si_unique_call 721} WPP_RECORDER_SF_S(Tmp_322, 0, 2, 15, Tmp_310, FullClassName);
    call {:si_unique_call 722} KeyboardClassLogError(ClassData, 327685, 10014, status_13, 0, 0, 0);
    goto L102;
  ...
  anon42_Then:
    ...
    havoc Tmp_314;
    havoc Tmp_319;
    call {:si_unique_call 723} WPP_RECORDER_SF_S(Tmp_319, 0, 2, 16, Tmp_314, FullClassName);
    goto L102;
  ...
  anon46_Then:
    ...
    call {:si_unique_call 724} ExReleaseFastMutex(0);
    goto anon39_Then, anon39_Else;

  anon39_Else:
    assume {:partition} errorCode != 0;
    Tmp_311 := 48 + dumpCount * 4;
    call {:si_unique_call 725} sdv_127 := IoAllocateErrorLogEntry(0, Tmp_311);
    errorLogEntry := sdv_127;
  ...
  L86:
    call {:si_unique_call 726} i_1, Tmp_304, Tmp_309, Tmp_324 := KeyboardAddDeviceEx_loop_L86(i_1, Tmp_304, errorLogEntry, Tmp_309, dumpData_1, dumpCount, Tmp_324);
    goto L86_last;
  ...
  anon40_Then:
    ...
    call {:si_unique_call 727} IoWriteErrorLogEntry(0);
    goto L70;
  ...
  anon43_Else:
    assume {:partition} ClassData == trueClassData;
    call {:si_unique_call 728} status_13 := KbdSendConnectRequest(ClassData, li2bplFunctionConstant978);
    goto L101;
...
procedure {:origName "KeyboardPnpStartCompletion"} KeyboardPnpStartCompletion(actual_DeviceObject_16: int, actual_Irp_9: int, actual_Context_9: int) returns (Tmp_325: int);
  modifies alloc;
  free ensures {:va_keep} Tmp_325 == -1073741802;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);



implementation {:origName "KeyboardPnpStartCompletion"} KeyboardPnpStartCompletion(actual_DeviceObject_16: int, actual_Irp_9: int, actual_Context_9: int) returns (Tmp_325: int)
{
  var {:pointer} Context_9: int;

  anon0:
    Context_9 := actual_Context_9;
    call {:si_unique_call 729} IoQueueWorkItem(0, li2bplFunctionConstant1002, 1, 0);
    Tmp_325 := -1073741802;
    return;
}
...
implementation {:origName "KeyboardClassRemoveDevice"} KeyboardClassRemoveDevice(actual_Data: int)
{
  ...
  anon0:
    call {:si_unique_call 730} vslice_dummy_var_61 := __HAVOC_malloc(4);
    Data := actual_Data;
    assume {:nonnull} Data != 0;
    assume Data > 0;
    call {:si_unique_call 731} sdv_130 := _InlineInterlockedExchangePointer(WaitWakeIrp__DEVICE_EXTENSION(Data), 0);
    waitWakeIrp := sdv_130;
    goto anon24_Then, anon24_Else;

  anon24_Else:
    assume {:partition} waitWakeIrp != 0;
    call {:si_unique_call 732} vslice_dummy_var_63 := IoCancelIrp(0);
    goto L12;

  L12:
    call {:si_unique_call 733} vslice_dummy_var_62 := IoWMIRegistrationControl(0, 2);
    assume {:nonnull} Data != 0;
    assume Data > 0;
    goto anon17_Then, anon17_Else;

  anon17_Else:
    call {:si_unique_call 734} ExAcquireFastMutex(0);
    goto anon19_Then, anon19_Else;
  ...
  anon20_Else:
    ...
    assume {:nonnull} port_1 != 0;
    assume port_1 > 0;
    call {:si_unique_call 735} ExReleaseFastMutex(0);
    assume {:nonnull} Data != 0;
    assume Data > 0;
    call {:si_unique_call 736} notifyHandle := _InlineInterlockedExchangePointer(TargetNotifyHandle__DEVICE_EXTENSION(Data), 0);
    goto anon21_Then, anon21_Else;

  anon21_Else:
    assume {:partition} notifyHandle != 0;
    call {:si_unique_call 737} vslice_dummy_var_64 := IoUnregisterPlugPlayNotification(0);
    goto L19;
  ...
  anon18_Else:
    ...
    call {:si_unique_call 738} KeyboardClassCleanupQueue(vslice_dummy_var_1709, Data, 0);
    goto L1;
  ...
  anon20_Then:
    call {:si_unique_call 739} ExReleaseFastMutex(0);
    goto L19;
  ...
  anon23_Else:
    ...
    call {:si_unique_call 741} vslice_dummy_var_65 := IoSetDeviceInterfaceState(0, 0);
    goto L19;
...
implementation {:origName "RtlFailFast"} RtlFailFast(actual_Code: int)
{
  ...
  anon0:
    call {:si_unique_call 742} vslice_dummy_var_66 := __HAVOC_malloc(4);
    return;
}



procedure {:origName "KbdSyncComplete"} KbdSyncComplete(actual_DeviceObject_17: int, actual_Irp_10: int, actual_Context_10: int) returns (Tmp_332: int);
...
implementation {:origName "KbdSyncComplete"} KbdSyncComplete(actual_DeviceObject_17: int, actual_Irp_10: int, actual_Context_10: int) returns (Tmp_332: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 743} vslice_dummy_var_67 := KeSetEvent(Context_10, 0, 0);
    Tmp_332 := -1073741802;
    return;
}
...
procedure {:origName "KeyboardQueryDeviceKey"} KeyboardQueryDeviceKey(actual_Handle_1: int, actual_ValueNameString: int, actual_Data_1: int, actual_DataLength: int) returns (Tmp_334: int);
  modifies alloc, Mem_T.Buffer__UNICODE_STRING, Mem_T.Length_unnamed_tag_18, Mem_T.MaximumLength__UNICODE_STRING;
  free ensures {:va_keep} Tmp_334 == -1073741811 || Tmp_334 == -1073741823 || Tmp_334 == 0 || Tmp_334 == 5 || Tmp_334 == -1073741789 || Tmp_334 == -1073741801 || Tmp_334 == -1073741675;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);



implementation {:origName "KeyboardQueryDeviceKey"} KeyboardQueryDeviceKey(actual_Handle_1: int, actual_ValueNameString: int, actual_Data_1: int, actual_DataLength: int) returns (Tmp_334: int)
{
  ...
  anon0:
    call {:si_unique_call 744} valueName := __HAVOC_malloc(12);
    call {:si_unique_call 745} length := __HAVOC_malloc(4);
    ValueNameString := actual_ValueNameString;
    DataLength := actual_DataLength;
    call {:si_unique_call 746} sdv_do_paged_code_check();
    call {:si_unique_call 747} RtlInitUnicodeString(valueName, ValueNameString);
    assume {:nonnull} valueName != 0;
    assume valueName > 0;
    Tmp_337 := Mem_T.MaximumLength__UNICODE_STRING[MaximumLength__UNICODE_STRING(valueName)];
    call {:si_unique_call 748} status_14 := RtlULongAdd(24, Tmp_337, length);
    goto anon11_Then, anon11_Else;
  ...
  anon11_Else:
    ...
    call {:si_unique_call 749} status_14 := RtlULongAdd(vslice_dummy_var_1710, DataLength, length);
    goto anon12_Then, anon12_Else;
  ...
  anon12_Else:
    ...
    call {:si_unique_call 750} sdv_139 := ExAllocatePoolWithTag(1, vslice_dummy_var_1711, -1016831413);
    fullInfo := sdv_139;
    goto anon15_Then, anon15_Else;

  anon15_Else:
    assume {:partition} fullInfo != 0;
    call {:si_unique_call 751} Tmp_335 := __HAVOC_malloc(4);
    ...
    call {:si_unique_call 752} status_14 := ZwQueryValueKey(0, 0, 1, 0, vslice_dummy_var_1712, Tmp_335);
    assume {:nonnull} Tmp_335 != 0;
    assume Tmp_335 > 0;
    assume {:nonnull} length != 0;
    assume length > 0;
  ...
  anon14_Else:
    ...
    call {:si_unique_call 753} sdv_RtlCopyMemory(0, 0, vslice_dummy_var_1713);
    goto L37;
...
procedure {:origName "RtlUnicodeStringPrintf"} RtlUnicodeStringPrintf(actual_DestinationString_2: int, actual_pszFormat: int) returns (Tmp_338: int);
  modifies alloc, Mem_T.PINT4, Mem_T.Length_unnamed_tag_18;
  free ensures {:va_keep} Tmp_338 == 0 || Tmp_338 == 5 || Tmp_338 == -1073741811;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);



implementation {:origName "RtlUnicodeStringPrintf"} RtlUnicodeStringPrintf(actual_DestinationString_2: int, actual_pszFormat: int) returns (Tmp_338: int)
{
  ...
  anon0:
    call {:si_unique_call 755} cchNewDestLength := __HAVOC_malloc(4);
    call {:si_unique_call 756} cchDest := __HAVOC_malloc(4);
    call {:si_unique_call 757} pszDest := __HAVOC_malloc(4);
    DestinationString_2 := actual_DestinationString_2;
    call {:si_unique_call 758} pszFormat := __HAVOC_malloc(4);
    Mem_T.PINT4[pszFormat] := actual_pszFormat;
    call {:si_unique_call 759} status_15 := RtlUnicodeStringValidateDestWorker_sdv_static_function_1(DestinationString_2, pszDest, cchDest, 0, 32767, 0);
    goto anon3_Then, anon3_Else;
  ...
  anon3_Else:
    ...
    call {:si_unique_call 760} status_15 := RtlWideCharArrayVPrintfWorker_sdv_static_function_1(Mem_T.PINT4[pszDest], vslice_dummy_var_1714, cchNewDestLength, Mem_T.PINT4[pszFormat], argList);
    argList := 0;
    ...
    Mem_T.Length_unnamed_tag_18[Length_unnamed_tag_18(DestinationString_2)] := vslice_dummy_var_1715;
    goto L11;
...
procedure {:origName "KeyboardSendIrpSynchronously"} KeyboardSendIrpSynchronously(actual_DeviceObject_18: int, actual_Irp_11: int, actual_CopyToNext: int) returns (Tmp_340: int);
...
implementation {:origName "KeyboardSendIrpSynchronously"} KeyboardSendIrpSynchronously(actual_DeviceObject_18: int, actual_Irp_11: int, actual_CopyToNext: int) returns (Tmp_340: int)
{
  ...
  anon0:
    call {:si_unique_call 761} event := __HAVOC_malloc(156);
    DeviceObject_18 := actual_DeviceObject_18;
    Irp_11 := actual_Irp_11;
    CopyToNext := actual_CopyToNext;
    call {:si_unique_call 762} sdv_do_paged_code_check();
    call {:si_unique_call 763} KeInitializeEvent(event, 1, 0);
    goto anon3_Then, anon3_Else;

  anon3_Else:
    assume {:partition} CopyToNext != 0;
    call {:si_unique_call 764} sdv_IoCopyCurrentIrpStackLocationToNext(Irp_11);
    goto L12;

  L12:
    call {:si_unique_call 765} sdv_IoSetCompletionRoutine(Irp_11, li2bplFunctionConstant982, event, 1, 1, 1);
    call {:si_unique_call 766} vslice_dummy_var_68 := sdv_IoCallDriver#1(DeviceObject_18, Irp_11);
    call {:si_unique_call 767} vslice_dummy_var_69 := KeWaitForSingleObject(0, 0, 0, 0, 0);
    assume {:nonnull} Irp_11 != 0;
    assume Irp_11 > 0;
    status_16 := Mem_T.Status__IO_STATUS_BLOCK[Status__IO_STATUS_BLOCK(IoStatus__IRP(Irp_11))];
    Tmp_340 := status_16;
    return;
...
implementation {:origName "KeyboardClassLogError"} KeyboardClassLogError(actual_Object_2: int, actual_ErrorCode: int, actual_UniqueErrorValue: int, actual_FinalStatus: int, actual_DumpCount: int, actual_DumpData: int, actual_MajorFunction: int)
{
  ...
  anon0:
    call {:si_unique_call 768} vslice_dummy_var_70 := __HAVOC_malloc(4);
    ...
    call {:si_unique_call 769} Tmp_344 := __HAVOC_malloc(4);
    Tmp_346 := 48 + DumpCount * 4;
    call {:si_unique_call 770} sdv_145 := IoAllocateErrorLogEntry(0, Tmp_346);
  ...
  L20:
    call {:si_unique_call 771} i_2, Tmp_342, Tmp_344, Tmp_345 := KeyboardClassLogError_loop_L20(i_2, Tmp_342, Tmp_344, Tmp_345, errorLogEntry_1, DumpCount, DumpData);
    goto L20_last;
  ...
  anon5_Then:
    ...
    call {:si_unique_call 772} IoWriteErrorLogEntry(0);
    goto L1;
...
procedure {:origName "KbdCreateClassObject"} KbdCreateClassObject(actual_DriverObject_4: int, actual_TmpDeviceExtension: int, actual_ClassDeviceObject: int, actual_FullDeviceName: int, actual_Legacy: int) returns (Tmp_348: int);
  ...
  free ensures {:va_keep} Tmp_348 == -1073741823 || Tmp_348 == 0 || Tmp_348 == 5 || Tmp_348 == -1073741811 || Tmp_348 == -1073741824 || Tmp_348 == -1073741771 || Tmp_348 == -1073741670;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);



implementation {:origName "KbdCreateClassObject"} KbdCreateClassObject(actual_DriverObject_4: int, actual_TmpDeviceExtension: int, actual_ClassDeviceObject: int, actual_FullDeviceName: int, actual_Legacy: int) returns (Tmp_348: int)
{
  ...
  anon0:
    call {:si_unique_call 773} fullClassName_1 := __HAVOC_malloc(12);
    ...
    call {:si_unique_call 774} name := __HAVOC_malloc(20);
    call {:si_unique_call 775} dumpData_2 := __HAVOC_malloc(16);
    call {:si_unique_call 776} Tmp_373 := __HAVOC_malloc(80);
    call {:si_unique_call 777} Tmp_374 := __HAVOC_malloc(56);
    ...
    assume name > 0;
    call {:si_unique_call 778} sdv_do_paged_code_check();
    havoc Tmp_359;
    havoc Tmp_369;
    call {:si_unique_call 779} WPP_RECORDER_SF_(Tmp_369, 0, 2, 73, Tmp_359);
  ...
  anon53_Else:
    ...
    call {:si_unique_call 782} status_17 := IoCreateDevice(0, 232, 0, 11, 0, 0, ClassDeviceObject);
  ...
  L125:
    ...
    assume {:nonnull} fullClassName_1 != 0;
    assume fullClassName_1 > 0;
    call {:si_unique_call 783} WPP_RECORDER_SF_S(Tmp_365, 0, 2, 77, Tmp_356, Mem_T.Buffer__UNICODE_STRING[Buffer__UNICODE_STRING(fullClassName_1)]);
  ...
  L108:
    havoc Tmp_350;
    havoc Tmp_355;
    call {:si_unique_call 784} WPP_RECORDER_SF_(Tmp_355, 0, 2, 79, Tmp_350);
    Tmp_348 := status_17;
    return;

  anon41_Then:
    assume {:partition} status_17 != 0;
    call {:si_unique_call 785} RtlFreeUnicodeString(0);
    assume {:nonnull} FullDeviceName != 0;
    assume FullDeviceName > 0;
    Mem_T.PINT4[FullDeviceName] := 0;
    goto anon55_Then, anon55_Else;
  ...
  anon43_Else:
    ...
    assume {:nonnull} ClassDeviceObject != 0;
    assume ClassDeviceObject > 0;
    Tmp_367 := Mem_T.P_DEVICE_OBJECT[ClassDeviceObject];
    goto L93;

  L93:
    call {:si_unique_call 786} KeyboardClassLogError(Tmp_367, errorCode_1, uniqueErrorValue_1, status_17, dumpCount_1, dumpData_2, 0);
    goto L89;
  ...
  anon44_Then:
    assume {:partition} Mem_T.P_DEVICE_OBJECT[ClassDeviceObject] != 0;
    call {:si_unique_call 788} IoDeleteDevice(0);
    assume {:nonnull} ClassDeviceObject != 0;
    assume ClassDeviceObject > 0;
    Mem_T.P_DEVICE_OBJECT[ClassDeviceObject] := 0;
    goto L108;
  ...
  anon40_Then:
    ...
    assume {:nonnull} ClassDeviceObject != 0;
    assume ClassDeviceObject > 0;
    Tmp_360 := Mem_T.P_DEVICE_OBJECT[ClassDeviceObject];
    assume {:nonnull} ClassDeviceObject != 0;
    assume ClassDeviceObject > 0;
    Tmp_370 := Mem_T.P_DEVICE_OBJECT[ClassDeviceObject];
    ...
    assume {:nonnull} ClassDeviceObject != 0;
    assume ClassDeviceObject > 0;
    Tmp_354 := Mem_T.P_DEVICE_OBJECT[ClassDeviceObject];
    assume {:nonnull} Tmp_354 != 0;
    assume Tmp_354 > 0;
    deviceExtension_1 := Mem_T.DeviceExtension__DEVICE_OBJECT[DeviceExtension__DEVICE_OBJECT(Tmp_354)];
    ...
    assume {:nonnull} deviceExtension_1 != 0;
    assume deviceExtension_1 > 0;
    call {:si_unique_call 789} sdv_IoInitializeRemoveLock(0, -1016831413, 0, 0);
    call {:si_unique_call 790} Tmp_376 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_376 != 0;
    assume Tmp_376 > 0;
    assume {:nonnull} deviceExtension_1 != 0;
    assume deviceExtension_1 > 0;
    call {:si_unique_call 791} sdv_KeInitializeSpinLock(Tmp_376);
    assume {:nonnull} Tmp_376 != 0;
    assume Tmp_376 > 0;
    assume {:nonnull} deviceExtension_1 != 0;
    assume deviceExtension_1 > 0;
    assume {:nonnull} deviceExtension_1 != 0;
    assume deviceExtension_1 > 0;
    call {:si_unique_call 792} InitializeListHead(ReadQueue__DEVICE_EXTENSION(deviceExtension_1));
    assume {:nonnull} deviceExtension_1 != 0;
    assume deviceExtension_1 > 0;
    assume {:nonnull} deviceExtension_1 != 0;
    assume deviceExtension_1 > 0;
    havoc vslice_dummy_var_1716;
    call {:si_unique_call 793} sdv_148 := ExAllocatePoolWithTag(512, vslice_dummy_var_1716, -1016831413);
    assume {:nonnull} deviceExtension_1 != 0;
    assume deviceExtension_1 > 0;
    Mem_T.InputData__DEVICE_EXTENSION[InputData__DEVICE_EXTENSION(deviceExtension_1)] := sdv_148;
    assume {:nonnull} deviceExtension_1 != 0;
    assume deviceExtension_1 > 0;
    goto anon54_Then, anon54_Else;
  ...
  anon54_Else:
    ...
    assume {:nonnull} FullDeviceName != 0;
    assume FullDeviceName > 0;
    call {:si_unique_call 794} WPP_RECORDER_SF_S(Tmp_357, 0, 2, 78, Tmp_362, Mem_T.PINT4[FullDeviceName]);
  ...
  anon54_Then:
    assume {:partition} Mem_T.InputData__DEVICE_EXTENSION[InputData__DEVICE_EXTENSION(deviceExtension_1)] != 0;
    call {:si_unique_call 795} KbdInitializeDataQueue(deviceExtension_1);
    goto L80;
  ...
  L143:
    ...
    call {:si_unique_call 797} sdv_149 := ExAllocatePoolWithTag(1, Tmp_375, -1016831413);
    assume {:nonnull} fullClassName_1 != 0;
    assume fullClassName_1 > 0;
    Mem_T.Buffer__UNICODE_STRING[Buffer__UNICODE_STRING(fullClassName_1)] := sdv_149;
    assume {:nonnull} fullClassName_1 != 0;
    assume fullClassName_1 > 0;
    goto anon57_Then, anon57_Else;
  ...
  anon57_Else:
    ...
    havoc Tmp_368;
    havoc Tmp_363;
    call {:si_unique_call 798} WPP_RECORDER_SF_(Tmp_363, 0, 2, 74, Tmp_368);
    status_17 := -1073741823;
    errorCode_1 := -1073414143;
    uniqueErrorValue_1 := 10006;
    assume {:nonnull} dumpData_2 != 0;
  ...
  anon57_Then:
    ...
    assume {:nonnull} fullClassName_1 != 0;
    assume fullClassName_1 > 0;
    Tmp_353 := Mem_T.MaximumLength__UNICODE_STRING[MaximumLength__UNICODE_STRING(fullClassName_1)];
    call {:si_unique_call 799} sdv_RtlZeroMemory(0, Tmp_353);
    goto L158;

  L158:
    call {:si_unique_call 800} Tmp_349, Tmp_352, Tmp_358, Tmp_361, Tmp_364, status_17, Tmp_371, Tmp_373, Tmp_374 := KbdCreateClassObject_loop_L158(Tmp_349, Tmp_352, fullClassName_1, Tmp_358, Tmp_361, Tmp_364, status_17, Tmp_371, Tmp_373, Tmp_374, ClassDeviceObject, Legacy);
    goto L158_last;
  ...
  anon49_Else:
    ...
    havoc Tmp_352;
    Tmp_371 := Tmp_352;
    Tmp_373 := strConst__li2bpl15;
    call {:si_unique_call 801} status_17 := RtlUnicodeStringPrintf(fullClassName_1, Tmp_373);
    goto L166;
  ...
  anon50_Else:
    ...
    assume {:nonnull} fullClassName_1 != 0;
    assume fullClassName_1 > 0;
    call {:si_unique_call 802} WPP_RECORDER_SF_S(Tmp_351, 0, 2, 75, Tmp_366, Mem_T.Buffer__UNICODE_STRING[Buffer__UNICODE_STRING(fullClassName_1)]);
    errorCode_1 := -1073414131;
    uniqueErrorValue_1 := 10006;
    assume {:nonnull} dumpData_2 != 0;
    assume dumpData_2 > 0;
  ...
  anon50_Then:
    ...
    assume {:nonnull} fullClassName_1 != 0;
    assume fullClassName_1 > 0;
    call {:si_unique_call 803} WPP_RECORDER_SF_S(Tmp_364, 0, 2, 76, Tmp_349, Mem_T.Buffer__UNICODE_STRING[Buffer__UNICODE_STRING(fullClassName_1)]);
    call {:si_unique_call 804} status_17 := IoCreateDevice(0, 232, 0, 11, 0, 0, ClassDeviceObject);
    goto anon51_Then, anon51_Else;
  ...
  anon52_Then:
    ...
    assume {:nonnull} fullClassName_1 != 0;
    assume fullClassName_1 > 0;
    Tmp_372 := INTDIV(Mem_T.Length_unnamed_tag_18[Length_unnamed_tag_18(fullClassName_1)], 2) + 1;
  ...
  L159:
    havoc Tmp_361;
    Tmp_358 := Tmp_361;
    Tmp_374 := strConst__li2bpl16;
    call {:si_unique_call 805} status_17 := RtlUnicodeStringPrintf(fullClassName_1, Tmp_374);
    goto L166;
...
procedure {:origName "KeyboardAddDevice"} KeyboardAddDevice(actual_DriverObject_5: int, actual_PhysicalDeviceObject_1: int) returns (Tmp_377: int);
...
implementation {:origName "KeyboardAddDevice"} KeyboardAddDevice(actual_DriverObject_5: int, actual_PhysicalDeviceObject_1: int) returns (Tmp_377: int)
{
  ...
  anon0:
    call {:si_unique_call 806} fullClassName_2 := __HAVOC_malloc(4);
    call {:si_unique_call 807} hParameters := __HAVOC_malloc(4);
    call {:si_unique_call 808} vslice_dummy_var_71 := __HAVOC_malloc(24);
    call {:si_unique_call 809} hService := __HAVOC_malloc(4);
    call {:si_unique_call 810} sdv := __HAVOC_malloc(8);
    call {:si_unique_call 811} fdo := __HAVOC_malloc(4);
    call {:si_unique_call 812} parameters_1 := __HAVOC_malloc(12);
    call {:si_unique_call 813} tmp := __HAVOC_malloc(4);
    call {:si_unique_call 814} state := __HAVOC_malloc(8);
    DriverObject_5 := actual_DriverObject_5;
    PhysicalDeviceObject_1 := actual_PhysicalDeviceObject_1;
    call {:si_unique_call 815} Tmp_380 := __HAVOC_malloc(44);
    call {:si_unique_call 816} Tmp_381 := __HAVOC_malloc(52);
    ...
    call {:si_unique_call 818} status_18 := KbdCreateClassObject(DriverObject_5, InitExtension__GLOBALS(Globals), fdo, fullClassName_2, 0);
    goto anon19_Then, anon19_Else;
  ...
  anon19_Else:
    ...
    assume port_2 > 0;
    call {:si_unique_call 819} boogieTmp := IoAttachDeviceToDeviceStack(0, PhysicalDeviceObject_1);
  ...
  anon20_Else:
    ...
    call {:si_unique_call 820} sdv_157 := IoAllocateErrorLogEntry(0, 48);
    errorLogEntry_2 := sdv_157;
    goto anon27_Then, anon27_Else;
  ...
  anon27_Else:
    ...
    assume {:nonnull} errorLogEntry_2 != 0;
    assume errorLogEntry_2 > 0;
    call {:si_unique_call 821} IoWriteErrorLogEntry(0);
    goto L106;

  L106:
    call {:si_unique_call 822} IoDeleteDevice(0);
    Tmp_377 := -1073741667;
    goto L1;
  ...
  anon20_Then:
    ...
    assume {:nonnull} state != 0;
    assume state > 0;
    call {:si_unique_call 823} structPtr888sdv := PoSetPowerState(0, 1, state);
    ...
    assume {:nonnull} port_2 != 0;
    assume port_2 > 0;
    call {:si_unique_call 824} sdv_InitializeObjectAttributes(0, 0, 576, 0, 0);
    call {:si_unique_call 825} status_18 := ZwOpenKey(hService, 983103, 0);
    goto anon21_Then, anon21_Else;

  anon21_Else:
    assume {:partition} status_18 >= 0;
    Tmp_380 := strConst__li2bpl17;
    call {:si_unique_call 826} RtlInitUnicodeString(parameters_1, Tmp_380);
    call {:si_unique_call 827} sdv_InitializeObjectAttributes(0, 0, 576, 0, 0);
    call {:si_unique_call 828} status_18 := ZwOpenKey(hParameters, 983103, 0);
    goto anon22_Then, anon22_Else;

  anon22_Else:
    assume {:partition} status_18 >= 0;
    Tmp_381 := strConst__li2bpl18;
    assume {:nonnull} hParameters != 0;
    assume hParameters > 0;
    havoc vslice_dummy_var_1717;
    call {:si_unique_call 829} status_18 := KeyboardQueryDeviceKey(vslice_dummy_var_1717, Tmp_381, tmp, 4);
    goto anon23_Then, anon23_Else;
  ...
  L71:
    call {:si_unique_call 830} vslice_dummy_var_73 := ZwClose(0);
    goto L63;

  L63:
    call {:si_unique_call 831} vslice_dummy_var_72 := ZwClose(0);
    goto L50;
  ...
  L50:
    ...
    assume {:nonnull} port_2 != 0;
    assume port_2 > 0;
    call {:si_unique_call 832} status_18 := IoRegisterDeviceInterface(0, 0, 0, SymbolicLinkName__DEVICE_EXTENSION(port_2));
    goto anon25_Then, anon25_Else;
  ...
  anon25_Else:
    ...
    assume {:nonnull} fullClassName_2 != 0;
    assume fullClassName_2 > 0;
    call {:si_unique_call 833} status_18 := KeyboardAddDeviceEx(port_2, Mem_T.PINT4[fullClassName_2], 0);
    goto L92;
  ...
  anon26_Else:
    ...
    call {:si_unique_call 834} sdv_ExFreePool(0);
    goto L93;
  ...
  anon25_Then:
    ...
    call {:si_unique_call 835} IoDetachDevice(0);
    assume {:nonnull} port_2 != 0;
    assume port_2 > 0;
    Mem_T.P_DEVICE_OBJECT[TopPort__DEVICE_EXTENSION(port_2)] := 0;
    call {:si_unique_call 836} IoDeleteDevice(0);
    goto L92;
...
implementation {:origName "KeyboardClassGetWaitWakeEnableState"} KeyboardClassGetWaitWakeEnableState(actual_Data_2: int)
{
  ...
  anon0:
    call {:si_unique_call 837} sysPowerCaps := __HAVOC_malloc(124);
    call {:si_unique_call 838} osVerInfo := __HAVOC_malloc(44);
    call {:si_unique_call 839} vslice_dummy_var_74 := __HAVOC_malloc(4);
    call {:si_unique_call 840} tmp_1 := __HAVOC_malloc(4);
    Data_2 := actual_Data_2;
    call {:si_unique_call 841} Tmp_386 := __HAVOC_malloc(64);
    call {:si_unique_call 842} sdv_do_paged_code_check();
    hKey := 0;
    wwEnableFound := 0;
    call {:si_unique_call 843} status_19 := IoOpenDeviceRegistryKey(0, 1, 2031616, 0);
    goto anon23_Then, anon23_Else;

  anon23_Else:
    assume {:partition} status_19 >= 0;
    Tmp_386 := strConst__li2bpl19;
    call {:si_unique_call 844} status_19 := KeyboardQueryDeviceKey(hKey, Tmp_386, tmp_1, 4);
    goto anon25_Then, anon25_Else;
  ...
  L23:
    call {:si_unique_call 845} vslice_dummy_var_75 := ZwClose(0);
    hKey := 0;
    goto L17;
  ...
  anon26_Else:
    mask := 0;
    call {:si_unique_call 846} sdv_RtlZeroMemory(0, 284);
    assume {:nonnull} osVerInfo != 0;
    assume osVerInfo > 0;
    assume {:nonnull} osVerInfo != 0;
    assume osVerInfo > 0;
    call {:si_unique_call 847} mask := VerSetConditionMask(mask, 128, 1);
    call {:si_unique_call 848} sdv_167 := RtlVerifyVersionInfo(0, 128, mask);
    goto anon27_Then, anon27_Else;

  anon27_Else:
    assume {:partition} sdv_167 >= 0;
    call {:si_unique_call 849} sdv_RtlZeroMemory(0, 76);
    call {:si_unique_call 850} status_19 := ZwPowerInformation(4, 0, 0, 0, 76);
    goto anon28_Then, anon28_Else;
...
implementation {:origName "InitializeListHead"} InitializeListHead(actual_ListHead_2: int)
{
  ...
  anon0:
    call {:si_unique_call 851} vslice_dummy_var_76 := __HAVOC_malloc(4);
...
implementation {:origName "WPP_RECORDER_SF_"} WPP_RECORDER_SF_(actual_AutoLogContext_1: int, actual_level_1: int, actual_flags_1: int, actual_id_1: int, actual_traceGuid_1: int)
{
  ...
  anon0:
    call {:si_unique_call 852} vslice_dummy_var_77 := __HAVOC_malloc(4);
    ...
    Tmp_393 := BAND(BOR(BOR(BOR(BOR(BOR(BOR(BOR(BOR(BOR(BOR(BOR(BOR(BOR(BOR(BOR(1, 2), 4), 8), 16), 32), 64), 128), 256), 512), 1024), 2048), 4096), 8192), 16384), 32768), flags_1 - 1);
    call {:si_unique_call 854} Tmp_391 := corral_nondet();
    goto anon5_Then, anon5_Else;

  anon5_Else:
    call {:si_unique_call 855} Tmp_399 := corral_nondet();
    goto anon6_Then, anon6_Else;

  anon6_Else:
    call {:si_unique_call 856} Tmp_389 := corral_nondet();
    assume pfnWppTraceMessage == 0;
    goto L6;

  L6:
    call {:si_unique_call 857} vslice_dummy_var_78 := corral_nondet();
    return;
...
procedure {:origName "RtlWideCharArrayVPrintfWorker_sdv_static_function_1"} RtlWideCharArrayVPrintfWorker_sdv_static_function_1(actual_pszDest_1: int, actual_cchDest_1: int, actual_pcchNewDestLength: int, actual_pszFormat_1: int, actual_argList_1: int) returns (Tmp_400: int);
  free ensures {:va_keep} Tmp_400 == 0 || Tmp_400 == 5;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);



implementation {:origName "RtlWideCharArrayVPrintfWorker_sdv_static_function_1"} RtlWideCharArrayVPrintfWorker_sdv_static_function_1(actual_pszDest_1: int, actual_cchDest_1: int, actual_pcchNewDestLength: int, actual_pszFormat_1: int, actual_argList_1: int) returns (Tmp_400: int)
{
  var {:scalar} iRet: int;
  ...
  anon0:
    ...
    status_20 := 0;
    call {:si_unique_call 858} iRet := corral_nondet();
    goto anon5_Then, anon5_Else;
...
procedure {:origName "_InlineInterlockedCompareExchangePointer"} _InlineInterlockedCompareExchangePointer(actual_Destination_4: int, actual_ExChange: int, actual_Comperand: int) returns (Tmp_402: int);
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);



implementation {:origName "_InlineInterlockedCompareExchangePointer"} _InlineInterlockedCompareExchangePointer(actual_Destination_4: int, actual_ExChange: int, actual_Comperand: int) returns (Tmp_402: int)
{
...
implementation {:origName "WPP_RECORDER_SF_d"} WPP_RECORDER_SF_d(actual_AutoLogContext_2: int, actual_level_2: int, actual_flags_2: int, actual_id_2: int, actual_traceGuid_2: int, actual_s_p_e_c_i_a_l_2: int)
{
  ...
  anon0:
    call {:si_unique_call 859} vslice_dummy_var_80 := __HAVOC_malloc(4);
    level_2 := actual_level_2;
    flags_2 := actual_flags_2;
    traceGuid_2 := actual_traceGuid_2;
    call {:si_unique_call 860} vslice_dummy_var_82 := __HAVOC_malloc(4);
    Tmp_409 := BAND(BOR(BOR(BOR(BOR(BOR(BOR(BOR(BOR(BOR(BOR(BOR(BOR(BOR(BOR(BOR(1, 2), 4), 8), 16), 32), 64), 128), 256), 512), 1024), 2048), 4096), 8192), 16384), 32768), flags_2 - 1);
    call {:si_unique_call 861} Tmp_411 := corral_nondet();
    goto anon5_Then, anon5_Else;

  anon5_Else:
    call {:si_unique_call 862} Tmp_413 := corral_nondet();
    goto anon6_Then, anon6_Else;

  anon6_Else:
    call {:si_unique_call 863} Tmp_408 := corral_nondet();
    assume pfnWppTraceMessage == 0;
    goto L6;

  L6:
    call {:si_unique_call 864} vslice_dummy_var_81 := corral_nondet();
    return;
...
implementation {:origName "FatalListEntryError"} FatalListEntryError(actual_p1_1: int, actual_p2_1: int, actual_p3: int)
{
  ...
  anon0:
    call {:si_unique_call 865} vslice_dummy_var_83 := __HAVOC_malloc(4);
    call {:si_unique_call 866} RtlFailFast(3);
    return;
}



procedure {:origName "KbdDeterminePortsServiced"} KbdDeterminePortsServiced(actual_BasePortName: int, actual_NumberPortsServiced: int) returns (Tmp_417: int);
  modifies alloc;
  free ensures {:va_keep} Tmp_417 == -1073741823 || Tmp_417 == 0;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);



implementation {:origName "KbdDeterminePortsServiced"} KbdDeterminePortsServiced(actual_BasePortName: int, actual_NumberPortsServiced: int) returns (Tmp_417: int)
{
  ...
  anon11_Then:
    ...
    assume {:nonnull} BasePortName != 0;
    assume BasePortName > 0;
    Tmp_421 := INTDIV(Mem_T.Length_unnamed_tag_18[Length_unnamed_tag_18(BasePortName)], 2) + 1;
    assume {:nonnull} BasePortName != 0;
    assume BasePortName > 0;
    Tmp_418 := Mem_T.Buffer__UNICODE_STRING[Buffer__UNICODE_STRING(BasePortName)];
    assume {:nonnull} Tmp_418 != 0;
    assume Tmp_418 > 0;
    Tmp_420 := 28 * queriesPlusOne_1;
    call {:si_unique_call 869} sdv_174 := ExAllocatePoolWithTag(1, Tmp_420, -1016831413);
    registryTable := sdv_174;
    goto anon12_Then, anon12_Else;
  ...
  anon12_Else:
    ...
    havoc Tmp_425;
    havoc Tmp_424;
    call {:si_unique_call 870} WPP_RECORDER_SF_(Tmp_424, 0, 2, 80, Tmp_425);
    status_21 := -1073741823;
    goto L16;

  anon12_Then:
    assume {:partition} registryTable != 0;
    Tmp_419 := 28 * queriesPlusOne_1;
    call {:si_unique_call 871} sdv_RtlZeroMemory(0, Tmp_419);
    assume {:nonnull} registryTable != 0;
    assume registryTable > 0;
    assume {:nonnull} registryTable != 0;
    assume registryTable > 0;
    call {:si_unique_call 872} status_21 := sdv_RtlQueryRegistryValues(4, 0, 0, 0, 0);
    goto anon10_Then, anon10_Else;
  ...
  anon10_Else:
    ...
    havoc Tmp_423;
    havoc Tmp_422;
    call {:si_unique_call 873} WPP_RECORDER_SF_D(Tmp_422, 0, 2, 81, Tmp_423, status_21);
    goto L16;
...
procedure {:origName "KeyboardStart"} KeyboardStart(actual_DeviceObject_19: int, actual_item_1: int) returns (Tmp_427: int);
...
implementation {:origName "KeyboardStart"} KeyboardStart(actual_DeviceObject_19: int, actual_item_1: int) returns (Tmp_427: int)
{
  ...
  anon0:
    call {:si_unique_call 874} devCaps := __HAVOC_malloc(124);
    ...
    assume Irp_12 > 0;
    status_22 := Mem_T.Status__IO_STATUS_BLOCK[Status__IO_STATUS_BLOCK(IoStatus__IRP(Irp_12))];
    assume {:nonnull} Irp_12 != 0;
    assume Irp_12 > 0;
    goto anon38_Then, anon38_Else;
  ...
  anon38_Else:
    ...
    assume {:nonnull} Irp_12 != 0;
    assume Irp_12 > 0;
    call {:si_unique_call 875} sdv_RtlZeroMemory(0, 64);
    ...
    assume {:nonnull} devCaps != 0;
    assume devCaps > 0;
    call {:si_unique_call 876} stack_2 := sdv_IoGetNextIrpStackLocation(Irp_12);
    ...
    assume {:nonnull} data_2 != 0;
    assume data_2 > 0;
    call {:si_unique_call 877} status_22 := KeyboardSendIrpSynchronously(Mem_T.P_DEVICE_OBJECT[TopPort__DEVICE_EXTENSION(data_2)], Irp_12, 0);
    goto anon27_Then, anon27_Else;
  ...
  anon28_Else:
    ...
    assume {:nonnull} devCaps != 0;
    assume devCaps > 0;
    call {:si_unique_call 878} sdv_RtlCopyMemory(0, 0, 20);
    goto L40;
  ...
  anon29_Else:
    assume {:nonnull} data_2 != 0;
    assume data_2 > 0;
    call {:si_unique_call 879} KeyboardClassGetWaitWakeEnableState(data_2);
    goto L57;
  ...
  L57:
    ...
    assume {:nonnull} data_2 != 0;
    assume data_2 > 0;
    call {:si_unique_call 880} vslice_dummy_var_85 := IoWMIRegistrationControl(0, 1);
    call {:si_unique_call 881} ExAcquireFastMutex(0);
    goto anon30_Then, anon30_Else;
  ...
  anon34_Else:
    assume {:nonnull} data_2 != 0;
    assume data_2 > 0;
    call {:si_unique_call 883} sdv_182 := _InlineInterlockedCompareExchangePointer(WaitWakeIrp__DEVICE_EXTENSION(data_2), 0, 0);
    goto anon35_Then, anon35_Else;

  anon35_Else:
    assume {:partition} sdv_182 == 0;
    call {:si_unique_call 884} sdv_177 := KeyboardClassCheckWaitWakeEnabled(data_2);
    goto anon36_Then, anon36_Else;

  anon36_Else:
    assume {:partition} sdv_177 != 0;
    call {:si_unique_call 885} vslice_dummy_var_84 := KeyboardClassCreateWaitWakeIrp(data_2);
    goto L17;
  ...
  anon32_Then:
    assume {:partition} enabled_1 == 0;
    call {:si_unique_call 886} status_22 := KbdEnableDisablePort(1, Irp_12, data_2, file_2);
    goto anon37_Then, anon37_Else;

  anon37_Else:
    assume {:partition} status_22 >= 0;
    call {:si_unique_call 887} stack_2 := sdv_IoGetNextIrpStackLocation(Irp_12);
    assume {:nonnull} stack_2 != 0;
    assume stack_2 > 0;
    assume {:nonnull} stack_2 != 0;
    assume stack_2 > 0;
    ...
    assume {:nonnull} data_2 != 0;
    assume data_2 > 0;
    call {:si_unique_call 888} vslice_dummy_var_86 := KeyboardSendIrpSynchronously(Mem_T.P_DEVICE_OBJECT[TopPort__DEVICE_EXTENSION(data_2)], Irp_12, 0);
    status_22 := 0;
    assume {:nonnull} Irp_12 != 0;
    assume Irp_12 > 0;
    Mem_T.Status__IO_STATUS_BLOCK[Status__IO_STATUS_BLOCK(IoStatus__IRP(Irp_12))] := startStatus;
  ...
  anon30_Then:
    ...
    call {:si_unique_call 891} status_22 := IoSetDeviceInterfaceState(0, 1);
    goto L89;
...
procedure {:origName "KeyboardClassCreateWaitWakeIrp"} KeyboardClassCreateWaitWakeIrp(actual_Data_3: int) returns (Tmp_430: int);
  modifies alloc, Mem_T.Status__IO_STATUS_BLOCK;
  free ensures {:va_keep} Tmp_430 == 0 || Tmp_430 == 1;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);



implementation {:origName "KeyboardClassCreateWaitWakeIrp"} KeyboardClassCreateWaitWakeIrp(actual_Data_3: int) returns (Tmp_430: int)
{
  ...
  anon0:
    call {:si_unique_call 892} powerState_1 := __HAVOC_malloc(8);
    ...
    call {:si_unique_call 894} status_23 := PoRequestPowerIrp(0, 0, powerState_1, li2bplFunctionConstant1008, 0, 0);
    goto anon3_Then, anon3_Else;
...
procedure {:origName "KeyboardPnP"} KeyboardPnP(actual_DeviceObject_20: int, actual_Irp_13: int) returns (Tmp_432: int);
  modifies alloc, Mem_T.Status__IO_STATUS_BLOCK, Mem_T.Item__DEVICE_START_WORKER, Mem_T.Irp__DEVICE_START_WORKER, sdv_compFset, sdv_invoke_on_success, sdv_invoke_on_error, sdv_invoke_on_cancel, Mem_T.Buffer__UNICODE_STRING, Mem_T.Length_unnamed_tag_18, Mem_T.MaximumLength__UNICODE_STRING, Mem_T.P_DEVICE_OBJECT;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);
...
implementation {:origName "KeyboardPnP"} KeyboardPnP(actual_DeviceObject_20: int, actual_Irp_13: int) returns (Tmp_432: int)
{
  ...
  anon0:
    call {:si_unique_call 895} worker := __HAVOC_malloc(8);
    ...
    call {:si_unique_call 896} stack_3 := sdv_IoGetCurrentIrpStackLocation(Irp_13);
    assume {:nonnull} data_3 != 0;
    assume data_3 > 0;
    goto anon69_Then, anon69_Else;
  ...
  anon69_Else:
    ...
    call {:si_unique_call 897} status_24 := sdv_IoAcquireRemoveLock(0, 0);
    goto anon70_Then, anon70_Else;
  ...
  anon102_Else:
    ...
    call {:si_unique_call 898} vslice_dummy_var_87 := IoSetDeviceInterfaceState(0, 0);
    goto L40;

  L40:
    call {:si_unique_call 899} sdv_IoSkipCurrentIrpStackLocation(Irp_13);
    assume {:nonnull} data_3 != 0;
    assume data_3 > 0;
    call {:si_unique_call 900} status_24 := sdv_IoCallDriver#1(Mem_T.P_DEVICE_OBJECT[TopPort__DEVICE_EXTENSION(data_3)], Irp_13);
    goto L51;

  L51:
    assume {:nonnull} data_3 != 0;
    assume data_3 > 0;
    call {:si_unique_call 901} vslice_dummy_var_88 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(data_3), Irp_13);
    Tmp_432 := status_24;
    goto L1;
  ...
  L27:
    call {:si_unique_call 902} sdv_IoCopyCurrentIrpStackLocationToNext(Irp_13);
    assume {:nonnull} data_3 != 0;
    assume data_3 > 0;
    call {:si_unique_call 903} status_24 := sdv_IoCallDriver#1(Mem_T.P_DEVICE_OBJECT[TopPort__DEVICE_EXTENSION(data_3)], Irp_13);
    goto L51;
  ...
  anon72_Else:
    call {:si_unique_call 904} ExAcquireFastMutex(0);
  ...
  anon76_Else:
    ...
    assume {:nonnull} data_3 != 0;
    assume data_3 > 0;
    call {:si_unique_call 906} notifyHandle_1 := _InlineInterlockedExchangePointer(TargetNotifyHandle__DEVICE_EXTENSION(data_3), 0);
    goto anon77_Then, anon77_Else;

  anon77_Else:
    assume {:partition} notifyHandle_1 != 0;
    call {:si_unique_call 907} vslice_dummy_var_89 := IoUnregisterPlugPlayNotification(0);
    goto L82;

  L82:
    call {:si_unique_call 908} status_24 := KbdEnableDisablePort(0, Irp_13, data_3, file_3);
    goto L57;

  L57:
    assume {:nonnull} data_3 != 0;
    assume data_3 > 0;
    call {:si_unique_call 909} sdv_IoSkipCurrentIrpStackLocation(Irp_13);
    assume {:nonnull} data_3 != 0;
    assume data_3 > 0;
    call {:si_unique_call 910} status_24 := sdv_IoCallDriver#1(Mem_T.P_DEVICE_OBJECT[TopPort__DEVICE_EXTENSION(data_3)], Irp_13);
    goto L51;
  ...
  anon98_Then:
    call {:si_unique_call 913} KeyboardClassRemoveDevice(data_3);
    call {:si_unique_call 914} sdv_IoReleaseRemoveLockAndWait(0, 0);
    call {:si_unique_call 915} sdv_IoCopyCurrentIrpStackLocationToNext(Irp_13);
    assume {:nonnull} data_3 != 0;
    assume data_3 > 0;
    call {:si_unique_call 916} status_24 := sdv_IoCallDriver#1(Mem_T.P_DEVICE_OBJECT[TopPort__DEVICE_EXTENSION(data_3)], Irp_13);
  ...
  L119:
    call {:si_unique_call 918} ExReleaseFastMutex(0);
    goto L122;

  L122:
    call {:si_unique_call 919} IoDetachDevice(0);
    call {:si_unique_call 920} RtlFreeUnicodeString(0);
    call {:si_unique_call 921} sdv_ExFreePool(0);
    call {:si_unique_call 922} IoDeleteDevice(0);
    Tmp_432 := status_24;
    goto L1;
  ...
  anon78_Then:
    call {:si_unique_call 924} ExReleaseFastMutex(0);
    goto L122;
  ...
  anon71_Then:
    call {:si_unique_call 925} sdv_195 := ExAllocatePoolWithTag(512, 8, -1016831413);
    item_2 := sdv_195;
    goto anon100_Then, anon100_Else;

  anon100_Else:
    assume {:partition} item_2 != 0;
    call {:si_unique_call 926} sdv_RtlZeroMemory(0, 8);
    assume {:nonnull} item_2 != 0;
    assume item_2 > 0;
    call {:si_unique_call 927} boogieTmp := IoAllocateWorkItem(0);
  ...
  anon80_Else:
    ...
    call {:si_unique_call 928} vslice_dummy_var_92 := sdv_IoAcquireRemoveLock(0, 0);
    call {:si_unique_call 929} sdv_IoCopyCurrentIrpStackLocationToNext(Irp_13);
    call {:si_unique_call 930} sdv_IoSetCompletionRoutine(Irp_13, li2bplFunctionConstant1003, item_2, 1, 1, 1);
    status_24 := 259;
    call {:si_unique_call 931} sdv_IoMarkIrpPending(0);
    assume {:nonnull} data_3 != 0;
    assume data_3 > 0;
    call {:si_unique_call 932} vslice_dummy_var_90 := sdv_IoCallDriver#1(Mem_T.P_DEVICE_OBJECT[TopPort__DEVICE_EXTENSION(data_3)], Irp_13);
    goto L169;
  ...
  anon81_Else:
    ...
    assume {:nonnull} data_3 != 0;
    assume data_3 > 0;
    call {:si_unique_call 933} vslice_dummy_var_91 := KeyboardSendIrpSynchronously(Mem_T.P_DEVICE_OBJECT[TopPort__DEVICE_EXTENSION(data_3)], Irp_13, 1);
    ...
    call {:si_unique_call 934} status_24 := KeyboardStart(DeviceObject_20, worker);
    assume {:nonnull} Irp_13 != 0;
    assume Irp_13 > 0;
    Mem_T.Status__IO_STATUS_BLOCK[Status__IO_STATUS_BLOCK(IoStatus__IRP(Irp_13))] := status_24;
    assume {:nonnull} Irp_13 != 0;
    assume Irp_13 > 0;
  ...
  anon70_Then:
    ...
    assume Irp_13 > 0;
    Mem_T.Status__IO_STATUS_BLOCK[Status__IO_STATUS_BLOCK(IoStatus__IRP(Irp_13))] := status_24;
    call {:si_unique_call 936} sdv_IoCompleteRequest(0, 0);
    Tmp_432 := status_24;
    goto L1;
...
procedure {:origName "KbdSendConnectRequest"} KbdSendConnectRequest(actual_ClassData_1: int, actual_ServiceCallback: int) returns (Tmp_438: int);
  modifies alloc, Mem_T.Status__IO_STATUS_BLOCK, sdv_compFset, sdv_invoke_on_success, sdv_invoke_on_error, sdv_invoke_on_cancel;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);
...
implementation {:origName "KbdSendConnectRequest"} KbdSendConnectRequest(actual_ClassData_1: int, actual_ServiceCallback: int) returns (Tmp_438: int)
{
  ...
  anon0:
    call {:si_unique_call 938} connectData := __HAVOC_malloc(8);
    call {:si_unique_call 939} ioStatus := __HAVOC_malloc(12);
    call {:si_unique_call 940} event_1 := __HAVOC_malloc(156);
    ClassData_1 := actual_ClassData_1;
    ServiceCallback := actual_ServiceCallback;
    call {:si_unique_call 941} sdv_do_paged_code_check();
    havoc Tmp_443;
    havoc Tmp_442;
    call {:si_unique_call 942} WPP_RECORDER_SF_(Tmp_442, 0, 3, 86, Tmp_443);
    call {:si_unique_call 943} KeInitializeEvent(event_1, 0, 0);
    ...
    assume {:nonnull} connectData != 0;
    assume connectData > 0;
    call {:si_unique_call 944} irp_1 := IoBuildDeviceIoControlRequest(721411, 0, 0, 8, 0, 0, 1, 0, ioStatus);
    goto anon5_Then, anon5_Else;
  ...
  anon5_Else:
    ...
    assume {:nonnull} ClassData_1 != 0;
    assume ClassData_1 > 0;
    call {:si_unique_call 945} status_25 := sdv_IoCallDriver#1(Mem_T.P_DEVICE_OBJECT[TopPort__DEVICE_EXTENSION(ClassData_1)], irp_1);
    goto anon6_Then, anon6_Else;

  anon6_Else:
    assume {:partition} status_25 == 259;
    call {:si_unique_call 946} vslice_dummy_var_93 := KeWaitForSingleObject(0, 0, 0, 0, 0);
    goto L45;

  L45:
    havoc Tmp_440;
    havoc Tmp_439;
    call {:si_unique_call 947} WPP_RECORDER_SF_(Tmp_439, 0, 3, 87, Tmp_440);
    assume {:nonnull} ioStatus != 0;
    assume ioStatus > 0;
    Tmp_438 := Mem_T.Status__IO_STATUS_BLOCK[Status__IO_STATUS_BLOCK(ioStatus)];
    return;
  ...
  anon6_Then:
    ...
    assume {:nonnull} ioStatus != 0;
    assume ioStatus > 0;
    Mem_T.Status__IO_STATUS_BLOCK[Status__IO_STATUS_BLOCK(ioStatus)] := status_25;
    goto L45;
...
implementation {:origName "WPP_RECORDER_SF_D"} WPP_RECORDER_SF_D(actual_AutoLogContext_3: int, actual_level_3: int, actual_flags_3: int, actual_id_3: int, actual_traceGuid_3: int, actual_s_p_e_c_i_a_l_3: int)
{
  ...
  anon0:
    call {:si_unique_call 948} vslice_dummy_var_94 := __HAVOC_malloc(4);
    level_3 := actual_level_3;
    flags_3 := actual_flags_3;
    traceGuid_3 := actual_traceGuid_3;
    call {:si_unique_call 949} vslice_dummy_var_96 := __HAVOC_malloc(4);
    Tmp_448 := BAND(BOR(BOR(BOR(BOR(BOR(BOR(BOR(BOR(BOR(BOR(BOR(BOR(BOR(BOR(BOR(1, 2), 4), 8), 16), 32), 64), 128), 256), 512), 1024), 2048), 4096), 8192), 16384), 32768), flags_3 - 1);
    call {:si_unique_call 950} Tmp_444 := corral_nondet();
    goto anon5_Then, anon5_Else;

  anon5_Else:
    call {:si_unique_call 951} Tmp_449 := corral_nondet();
    goto anon6_Then, anon6_Else;

  anon6_Else:
    call {:si_unique_call 952} Tmp_450 := corral_nondet();
    assume pfnWppTraceMessage == 0;
    goto L6;

  L6:
    call {:si_unique_call 953} vslice_dummy_var_95 := corral_nondet();
    return;
...
procedure {:origName "KeyboardClassCheckWaitWakeEnabled"} KeyboardClassCheckWaitWakeEnabled(actual_Data_4: int) returns (Tmp_455: int);
  modifies alloc;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);
...
implementation {:origName "KeyboardClassCheckWaitWakeEnabled"} KeyboardClassCheckWaitWakeEnabled(actual_Data_4: int) returns (Tmp_455: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 954} Tmp_456 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_456 != 0;
    assume Tmp_456 > 0;
    call {:si_unique_call 955} sdv_KeAcquireSpinLock(0, Tmp_456);
    assume {:nonnull} Tmp_456 != 0;
    assume Tmp_456 > 0;
    havoc irql_1;
    ...
    assume Data_4 > 0;
    havoc enabled_3;
    call {:si_unique_call 956} sdv_KeReleaseSpinLock(0, irql_1);
    Tmp_455 := enabled_3;
    return;
}
...
implementation {:origName "KbdInitializeDataQueue"} KbdInitializeDataQueue(actual_Context_11: int)
{
  ...
  anon0:
    ...
    havoc Tmp_457;
    havoc Tmp_461;
    call {:si_unique_call 958} WPP_RECORDER_SF_(Tmp_461, 0, 4, 84, Tmp_457);
    deviceExtension_2 := Context_11;
    call {:si_unique_call 959} Tmp_460 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_460 != 0;
    assume Tmp_460 > 0;
    call {:si_unique_call 960} sdv_KeAcquireSpinLock(0, Tmp_460);
    assume {:nonnull} Tmp_460 != 0;
    assume Tmp_460 > 0;
    havoc oldIrql;
    ...
    assume {:nonnull} deviceExtension_2 != 0;
    assume deviceExtension_2 > 0;
    call {:si_unique_call 961} sdv_KeReleaseSpinLock(0, oldIrql);
    havoc Tmp_462;
    havoc Tmp_459;
    call {:si_unique_call 962} WPP_RECORDER_SF_(Tmp_459, 0, 4, 85, Tmp_462);
    return;
}



procedure {:origName "KbdEnableDisablePort"} KbdEnableDisablePort(actual_EnableFlag: int, actual_Irp_14: int, actual_Port: int, actual_File_1: int) returns (Tmp_463: int);
...
implementation {:origName "KbdEnableDisablePort"} KbdEnableDisablePort(actual_EnableFlag: int, actual_Irp_14: int, actual_Port: int, actual_File_1: int) returns (Tmp_463: int)
{
  ...
  anon0:
    call {:si_unique_call 963} name_1 := __HAVOC_malloc(12);
    call {:si_unique_call 964} device := __HAVOC_malloc(4);
    ...
    havoc Tmp_464;
    havoc Tmp_468;
    call {:si_unique_call 966} WPP_RECORDER_SF_(Tmp_468, 0, 3, 82, Tmp_464);
  ...
  anon23_Else:
    ...
    call {:si_unique_call 967} sdv_IoCopyCurrentIrpStackLocationToNext(Irp_14);
    call {:si_unique_call 968} stack_4 := sdv_IoGetNextIrpStackLocation(Irp_14);
    goto anon24_Then, anon24_Else;
  ...
  L40:
    assume {:nonnull} Port != 0;
    assume Port > 0;
    call {:si_unique_call 969} status_26 := KeyboardSendIrpSynchronously(Mem_T.P_DEVICE_OBJECT[TopPort__DEVICE_EXTENSION(Port)], Irp_14, 0);
    goto L49;

  L49:
    havoc Tmp_469;
    havoc Tmp_466;
    call {:si_unique_call 970} WPP_RECORDER_SF_(Tmp_466, 0, 3, 83, Tmp_469);
    Tmp_463 := status_26;
    goto L1;
  ...
  anon26_Else:
    assume {:partition} EnableFlag != 0;
    bufferLength := 0;
    call {:si_unique_call 971} Tmp_467 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_467 != 0;
    assume Tmp_467 > 0;
    call {:si_unique_call 972} status_26 := IoGetDeviceProperty(0, 4107, bufferLength, 0, Tmp_467);
    assume {:nonnull} Tmp_467 != 0;
    assume Tmp_467 > 0;
    havoc bufferLength;
    call {:si_unique_call 973} sdv_217 := ExAllocatePoolWithTag(1, bufferLength, -1016831413);
    buffer := sdv_217;
    goto anon29_Then, anon29_Else;

  anon29_Else:
    assume {:partition} buffer != 0;
    call {:si_unique_call 974} Tmp_467 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_467 != 0;
    assume Tmp_467 > 0;
    call {:si_unique_call 975} vslice_dummy_var_99 := IoGetDeviceProperty(0, 4107, bufferLength, 0, Tmp_467);
    assume {:nonnull} Tmp_467 != 0;
    assume Tmp_467 > 0;
    havoc bufferLength;
    assume {:nonnull} name_1 != 0;
    ...
    call {:si_unique_call 976} status_26 := IoGetDeviceObjectPointer(0, 2032127, 0, device);
  ...
  anon28_Else:
    ...
    call {:si_unique_call 978} sdv_IoCopyCurrentIrpStackLocationToNext(Irp_14);
    call {:si_unique_call 979} stack_4 := sdv_IoGetNextIrpStackLocation(Irp_14);
    assume {:nonnull} stack_4 != 0;
    assume stack_4 > 0;
    assume {:nonnull} stack_4 != 0;
    assume stack_4 > 0;
    ...
    assume {:nonnull} Port != 0;
    assume Port > 0;
    call {:si_unique_call 980} vslice_dummy_var_100 := KeyboardSendIrpSynchronously(Mem_T.P_DEVICE_OBJECT[TopPort__DEVICE_EXTENSION(Port)], Irp_14, 0);
    assume {:nonnull} Irp_14 != 0;
    assume Irp_14 > 0;
    goto L87;
  ...
  L87:
    assume {:nonnull} Port != 0;
    assume Port > 0;
    call {:si_unique_call 981} status_26 := IoRegisterPlugPlayNotification(3, 0, 0, 0, li2bplFunctionConstant993, 0, 0);
    goto L49;
  ...
  anon26_Then:
    assume {:partition} EnableFlag == 0;
    call {:si_unique_call 982} vslice_dummy_var_98 := sdv_ObDereferenceObject(0);
    assume {:nonnull} File_1 != 0;
    assume File_1 > 0;
    goto L49;
  ...
  anon22_Then:
    ...
    assume {:nonnull} Port != 0;
    assume Port > 0;
    call {:si_unique_call 983} sdv_IoCopyCurrentIrpStackLocationToNext(Irp_14);
    call {:si_unique_call 984} stack_4 := sdv_IoGetNextIrpStackLocation(Irp_14);
    assume {:nonnull} stack_4 != 0;
    assume stack_4 > 0;
    assume {:nonnull} stack_4 != 0;
    assume stack_4 > 0;
  ...
  L122:
    ...
    assume {:nonnull} Port != 0;
    assume Port > 0;
    call {:si_unique_call 985} status_26 := KeyboardSendIrpSynchronously(Mem_T.P_DEVICE_OBJECT[TopPort__DEVICE_EXTENSION(Port)], Irp_14, 0);
    goto L49;
...
implementation {:origName "KeyboardCallAllPorts"} KeyboardCallAllPorts#0(actual_Device: int, actual_Irp_6: int, actual_CallAllIn: int) returns (Tmp_240: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 986} Tmp_246 := __HAVOC_malloc(4);
    call {:si_unique_call 987} Tmp_247 := __HAVOC_malloc(4);
    call {:si_unique_call 988} Tmp_248 := __HAVOC_malloc(4);
    call {:si_unique_call 989} Tmp_251 := __HAVOC_malloc(4);
    CallAll := CallAllIn;
  ...
  L59:
    call {:si_unique_call 990} nextSp := sdv_IoGetNextIrpStackLocation(Irp_6);
    call {:si_unique_call 991} sdv_IoCopyCurrentIrpStackLocationToNext(Irp_6);
    assume {:nonnull} nextSp != 0;
    assume nextSp > 0;
    goto L18;

  L18:
    call {:si_unique_call 992} Tmp_241, Tmp_242, Tmp_244, Tmp_246, Tmp_249, Tmp_251 := KeyboardCallAllPorts#0_loop_L18(Tmp_241, CallAll, Tmp_242, Tmp_244, Tmp_246, Tmp_249, Tmp_251);
    goto L18_last;
  ...
  anon16_Else:
    ...
    assume {:nonnull} CallAll != 0;
    assume CallAll > 0;
    call {:si_unique_call 993} sdv_IoSetCompletionRoutine(Irp_6, li2bplFunctionConstant981, CallAll, 1, 1, 1);
    assume {:nonnull} port != 0;
    assume port > 0;
    assume false;
    assume {:nonnull} port != 0;
    assume port > 0;
    call {:si_unique_call 994} vslice_dummy_var_101 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(port), Irp_6);
    return;
  ...
  anon17_Else:
    call {:si_unique_call 995} sdv_IoMarkIrpPending(0);
    goto L40;

  L40:
    havoc vslice_dummy_var_1718;
    call {:si_unique_call 996} vslice_dummy_var_102 := sdv_IoReleaseRemoveLock(vslice_dummy_var_1718, Irp_6);
...
procedure {:origName "KeyboardCallAllPorts"} KeyboardCallAllPorts#0(actual_Device: int, actual_Irp_6: int, actual_CallAllIn: int) returns (Tmp_240: int);
  modifies alloc, sdv_compFset, sdv_invoke_on_success, sdv_invoke_on_error, sdv_invoke_on_cancel;
...
implementation {:origName "KeyboardCallAllPorts"} KeyboardCallAllPorts#1(actual_Device: int, actual_Irp_6: int, actual_CallAllIn: int) returns (Tmp_240: int)
{
  var {:pointer} nextSp: int;
  var {:pointer} Tmp_241: int;
  var {:pointer} CallAll: int;
  ...
  anon0:
    Irp_6 := actual_Irp_6;
    CallAllIn := actual_CallAllIn;
    call {:si_unique_call 998} Tmp_246 := __HAVOC_malloc(4);
    call {:si_unique_call 999} Tmp_247 := __HAVOC_malloc(4);
    call {:si_unique_call 1000} Tmp_248 := __HAVOC_malloc(4);
    call {:si_unique_call 1001} Tmp_251 := __HAVOC_malloc(4);
    CallAll := CallAllIn;
    assume {:nonnull} CallAll != 0;
    assume CallAll > 0;
    goto anon19_Then, anon19_Else;
  ...
  L59:
    call {:si_unique_call 1002} nextSp := sdv_IoGetNextIrpStackLocation(Irp_6);
    call {:si_unique_call 1003} sdv_IoCopyCurrentIrpStackLocationToNext(Irp_6);
    assume {:nonnull} nextSp != 0;
    assume nextSp > 0;
    goto L18;

  L18:
    call {:si_unique_call 1004} Tmp_241, Tmp_242, Tmp_244, Tmp_246, Tmp_249, Tmp_251 := KeyboardCallAllPorts#1_loop_L18(Tmp_241, CallAll, Tmp_242, Tmp_244, Tmp_246, Tmp_249, Tmp_251);
    goto L18_last;
  ...
  anon16_Else:
    ...
    assume {:nonnull} CallAll != 0;
    assume CallAll > 0;
    call {:si_unique_call 1005} sdv_IoSetCompletionRoutine(Irp_6, li2bplFunctionConstant981, CallAll, 1, 1, 1);
    assume {:nonnull} port != 0;
    assume port > 0;
    call {:si_unique_call 1006} status_9 := sdv_IoCallDriver#0(Mem_T.P_DEVICE_OBJECT[TopPort__DEVICE_EXTENSION(port)], Irp_6);
    assume {:nonnull} port != 0;
    assume port > 0;
    call {:si_unique_call 1007} vslice_dummy_var_103 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(port), Irp_6);
    goto anon18_Then, anon18_Else;
  ...
  L40:
    ...
    call {:si_unique_call 1009} vslice_dummy_var_104 := sdv_IoReleaseRemoveLock(vslice_dummy_var_1719, Irp_6);
...
procedure {:origName "KeyboardCallAllPorts"} KeyboardCallAllPorts#1(actual_Device: int, actual_Irp_6: int, actual_CallAllIn: int) returns (Tmp_240: int);
  modifies alloc, sdv_compFset, sdv_invoke_on_success, sdv_invoke_on_error, sdv_invoke_on_cancel, Mem_T.Status__IO_STATUS_BLOCK;
  free ensures {:va_keep} Tmp_240 == 259 || Tmp_240 == -1073741802 || Tmp_240 == 0;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);



implementation {:origName "sdv_IoCallDriver"} {:osmodel} sdv_IoCallDriver#0(actual_DeviceObject_8: int, actual_Irp_5: int) returns (Tmp_141: int)
{
  var {:pointer} Irp_5: int;

  anon0:
    Irp_5 := actual_Irp_5;
    call {:si_unique_call 1011} Tmp_141 := IofCallDriver#0(0, Irp_5);
    return;
}



procedure {:origName "sdv_IoCallDriver"} {:osmodel} sdv_IoCallDriver#0(actual_DeviceObject_8: int, actual_Irp_5: int) returns (Tmp_141: int);
  modifies alloc, Mem_T.Status__IO_STATUS_BLOCK, sdv_compFset, sdv_invoke_on_success, sdv_invoke_on_error, sdv_invoke_on_cancel;
  free ensures {:va_keep} Tmp_141 == 259;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);



implementation {:origName "sdv_IoCallDriver"} {:osmodel} sdv_IoCallDriver#1(actual_DeviceObject_8: int, actual_Irp_5: int) returns (Tmp_141: int)
{
  var {:pointer} Irp_5: int;

  anon0:
    Irp_5 := actual_Irp_5;
    call {:si_unique_call 1012} Tmp_141 := IofCallDriver#1(0, Irp_5);
    return;
}



procedure {:origName "sdv_IoCallDriver"} {:osmodel} sdv_IoCallDriver#1(actual_DeviceObject_8: int, actual_Irp_5: int) returns (Tmp_141: int);
  modifies alloc, Mem_T.Status__IO_STATUS_BLOCK, sdv_compFset, sdv_invoke_on_success, sdv_invoke_on_error, sdv_invoke_on_cancel;
  free ensures {:va_keep} Tmp_141 == 259;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);
...
implementation {:origName "IofCallDriver"} {:osmodel} IofCallDriver#0(actual_DeviceObject_6: int, actual_Irp_3: int) returns (Tmp_133: int)
{
  ...
  anon0:
    call {:si_unique_call 1013} completion := __HAVOC_malloc(4);
    Irp_3 := actual_Irp_3;
  ...
  anon47_Then:
    ...
    call {:si_unique_call 1014} vslice_dummy_var_105 := sdv_RunIoCompletionRoutines#0(sdv_p_devobj_fdo, Irp_3, vslice_dummy_var_1720, completion);
    goto L29;
  ...
  anon59_Else:
    ...
    call {:si_unique_call 1015} vslice_dummy_var_108 := sdv_RunIoCompletionRoutines#0(sdv_p_devobj_fdo, Irp_3, vslice_dummy_var_1721, completion);
    goto L29;
  ...
  anon51_Else:
    ...
    call {:si_unique_call 1016} vslice_dummy_var_106 := sdv_RunIoCompletionRoutines#0(sdv_p_devobj_fdo, Irp_3, vslice_dummy_var_1722, completion);
    goto L29;
  ...
  anon55_Else:
    ...
    call {:si_unique_call 1017} vslice_dummy_var_107 := sdv_RunIoCompletionRoutines#0(sdv_p_devobj_fdo, Irp_3, vslice_dummy_var_1723, completion);
    goto L29;
...
procedure {:origName "IofCallDriver"} {:osmodel} IofCallDriver#0(actual_DeviceObject_6: int, actual_Irp_3: int) returns (Tmp_133: int);
  modifies alloc, Mem_T.Status__IO_STATUS_BLOCK, sdv_compFset, sdv_invoke_on_success, sdv_invoke_on_error, sdv_invoke_on_cancel;
...
implementation {:origName "IofCallDriver"} {:osmodel} IofCallDriver#1(actual_DeviceObject_6: int, actual_Irp_3: int) returns (Tmp_133: int)
{
  var {:dopa} {:scalar} completion: int;
  var {:scalar} status_5: int;
  var {:pointer} Irp_3: int;
  ...
  anon47_Then:
    ...
    call {:si_unique_call 1019} vslice_dummy_var_109 := sdv_RunIoCompletionRoutines#1(sdv_p_devobj_fdo, Irp_3, vslice_dummy_var_1724, completion);
    goto L29;
  ...
  anon59_Else:
    ...
    call {:si_unique_call 1020} vslice_dummy_var_112 := sdv_RunIoCompletionRoutines#1(sdv_p_devobj_fdo, Irp_3, vslice_dummy_var_1725, completion);
    goto L29;
  ...
  anon51_Else:
    ...
    call {:si_unique_call 1021} vslice_dummy_var_110 := sdv_RunIoCompletionRoutines#1(sdv_p_devobj_fdo, Irp_3, vslice_dummy_var_1726, completion);
    goto L29;
  ...
  anon55_Else:
    ...
    call {:si_unique_call 1022} vslice_dummy_var_111 := sdv_RunIoCompletionRoutines#1(sdv_p_devobj_fdo, Irp_3, vslice_dummy_var_1727, completion);
    goto L29;
...
procedure {:origName "IofCallDriver"} {:osmodel} IofCallDriver#1(actual_DeviceObject_6: int, actual_Irp_3: int) returns (Tmp_133: int);
  modifies alloc, Mem_T.Status__IO_STATUS_BLOCK, sdv_compFset, sdv_invoke_on_success, sdv_invoke_on_error, sdv_invoke_on_cancel;
  free ensures {:va_keep} Tmp_133 == 259;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);
...
implementation {:origName "sdv_RunIoCompletionRoutines"} {:osmodel} sdv_RunIoCompletionRoutines#0(actual_DeviceObject_7: int, actual_Irp_4: int, actual_Context_6: int, actual_Completion: int) returns (Tmp_137: int)
{
  var {:scalar} Status: int;
  var {:pointer} irpsp: int;
  ...
  anon0:
    ...
    call {:si_unique_call 1023} irpsp := sdv_IoGetNextIrpStackLocation(Irp_4);
    Status := 0;
    assume {:nonnull} irpsp != 0;
    assume irpsp > 0;
    goto anon15_Then, anon15_Else;
  ...
  anon15_Else:
    call {:si_unique_call 1024} Status := KbdSyncComplete(DeviceObject_7, Irp_4, Context_6);
    assume {:nonnull} Completion != 0;
    assume Completion > 0;
    goto L11;
  ...
  anon11_Else:
    call {:si_unique_call 1025} Status := KeyboardCallAllPorts#0(DeviceObject_7, Irp_4, Context_6);
    assume {:nonnull} Completion != 0;
    assume Completion > 0;
    goto L28;
  ...
  anon12_Else:
    call {:si_unique_call 1026} Status := KeyboardClassPowerComplete#0(DeviceObject_7, Irp_4, Context_6);
    assume {:nonnull} Completion != 0;
    assume Completion > 0;
    goto L45;
  ...
  anon13_Else:
    call {:si_unique_call 1027} Status := KeyboardClassSetLedsComplete(DeviceObject_7, Irp_4, Context_6);
    assume {:nonnull} Completion != 0;
    assume Completion > 0;
    goto L62;
  ...
  anon14_Else:
    call {:si_unique_call 1028} Status := KeyboardPnpStartCompletion(DeviceObject_7, Irp_4, Context_6);
    assume {:nonnull} Completion != 0;
    assume Completion > 0;
    goto L79;
...
procedure {:origName "sdv_RunIoCompletionRoutines"} {:osmodel} sdv_RunIoCompletionRoutines#0(actual_DeviceObject_7: int, actual_Irp_4: int, actual_Context_6: int, actual_Completion: int) returns (Tmp_137: int);
  modifies alloc, sdv_compFset, sdv_invoke_on_success, sdv_invoke_on_error, sdv_invoke_on_cancel, Mem_T.Status__IO_STATUS_BLOCK;
  free ensures {:va_keep} Tmp_137 == -1073741802 || Tmp_137 == 0;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);



implementation {:origName "sdv_RunIoCompletionRoutines"} {:osmodel} sdv_RunIoCompletionRoutines#1(actual_DeviceObject_7: int, actual_Irp_4: int, actual_Context_6: int, actual_Completion: int) returns (Tmp_137: int)
{
  var {:scalar} Status: int;
  var {:pointer} irpsp: int;
  var {:pointer} DeviceObject_7: int;
  ...
  anon0:
    ...
    Context_6 := actual_Context_6;
    Completion := actual_Completion;
    call {:si_unique_call 1029} irpsp := sdv_IoGetNextIrpStackLocation(Irp_4);
    Status := 0;
    assume {:nonnull} irpsp != 0;
    assume irpsp > 0;
    goto anon15_Then, anon15_Else;
  ...
  anon15_Else:
    call {:si_unique_call 1030} Status := KbdSyncComplete(DeviceObject_7, Irp_4, Context_6);
    assume {:nonnull} Completion != 0;
    assume Completion > 0;
    goto L11;
  ...
  anon11_Else:
    call {:si_unique_call 1031} Status := KeyboardCallAllPorts#1(DeviceObject_7, Irp_4, Context_6);
    assume {:nonnull} Completion != 0;
    assume Completion > 0;
    goto L28;
  ...
  anon12_Else:
    call {:si_unique_call 1032} Status := KeyboardClassPowerComplete#1(DeviceObject_7, Irp_4, Context_6);
    assume {:nonnull} Completion != 0;
    assume Completion > 0;
    goto L45;
  ...
  anon13_Else:
    call {:si_unique_call 1033} Status := KeyboardClassSetLedsComplete(DeviceObject_7, Irp_4, Context_6);
    assume {:nonnull} Completion != 0;
    assume Completion > 0;
    goto L62;
  ...
  anon14_Else:
    call {:si_unique_call 1034} Status := KeyboardPnpStartCompletion(DeviceObject_7, Irp_4, Context_6);
    assume {:nonnull} Completion != 0;
    assume Completion > 0;
    goto L79;
...
procedure {:origName "sdv_RunIoCompletionRoutines"} {:osmodel} sdv_RunIoCompletionRoutines#1(actual_DeviceObject_7: int, actual_Irp_4: int, actual_Context_6: int, actual_Completion: int) returns (Tmp_137: int);
  modifies alloc, sdv_compFset, sdv_invoke_on_success, sdv_invoke_on_error, sdv_invoke_on_cancel, Mem_T.Status__IO_STATUS_BLOCK;
  free ensures {:va_keep} Tmp_137 == -1073741802 || Tmp_137 == 0 || Tmp_137 == 259;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);



implementation {:origName "KeyboardClassPowerComplete"} KeyboardClassPowerComplete#0(actual_DeviceObject_13: int, actual_Irp_7: int, actual_Context_7: int) returns (Tmp_254: int)
{
  var {:pointer} SD2: int;
  var {:pointer} SD1: int;
  ...
  anon0:
    call {:si_unique_call 1035} powerState := __HAVOC_malloc(8);
    call {:si_unique_call 1036} sdv_1 := __HAVOC_malloc(8);
    ...
    call {:si_unique_call 1038} stack := sdv_IoGetCurrentIrpStackLocation(Irp_7);
  ...
  L74:
    call {:si_unique_call 1039} PoStartNextPowerIrp(0);
    assume {:nonnull} data != 0;
    assume data > 0;
    call {:si_unique_call 1040} vslice_dummy_var_113 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(data), Irp_7);
    Tmp_254 := 0;
    return;
  ...
  anon20_Then:
    assume {:partition} powerType == 1;
    call {:si_unique_call 1041} SD2 := PoSetPowerState(0, powerType, powerState);
    ...
    call {:si_unique_call 1042} irpLeds := IoAllocateIrp(vslice_dummy_var_1728, 0);
    goto anon16_Then, anon16_Else;
  ...
  anon16_Then:
    assume {:partition} irpLeds != 0;
    call {:si_unique_call 1043} status_11 := sdv_IoAcquireRemoveLock(0, 0);
    goto anon17_Then, anon17_Else;
  ...
  L48:
    call {:si_unique_call 1044} next := sdv_IoGetNextIrpStackLocation(irpLeds);
    ...
    assume {:nonnull} next != 0;
    assume next > 0;
    call {:si_unique_call 1045} sdv_IoSetCompletionRoutine(irpLeds, li2bplFunctionConstant1015, data, 1, 1, 1);
  ...
  anon15_Then:
    assume {:partition} powerType == 0;
    call {:si_unique_call 1047} SD1 := PoSetPowerState(0, powerType, powerState);
    ...
    assume {:nonnull} powerState != 0;
    assume powerState > 0;
    call {:si_unique_call 1048} status_11 := PoRequestPowerIrp(0, 2, powerState, li2bplFunctionConstant1014, 0, 0);
    goto anon19_Then, anon19_Else;
...
procedure {:origName "KeyboardClassPowerComplete"} KeyboardClassPowerComplete#0(actual_DeviceObject_13: int, actual_Irp_7: int, actual_Context_7: int) returns (Tmp_254: int);
  modifies alloc, sdv_compFset, sdv_invoke_on_success, sdv_invoke_on_error, sdv_invoke_on_cancel, Mem_T.Status__IO_STATUS_BLOCK;
...
implementation {:origName "KeyboardClassPowerComplete"} KeyboardClassPowerComplete#1(actual_DeviceObject_13: int, actual_Irp_7: int, actual_Context_7: int) returns (Tmp_254: int)
{
  var {:pointer} SD2: int;
  var {:pointer} SD1: int;
  var {:scalar} Tmp_255: int;
  ...
  anon0:
    call {:si_unique_call 1049} powerState := __HAVOC_malloc(8);
    call {:si_unique_call 1050} sdv_1 := __HAVOC_malloc(8);
    call {:si_unique_call 1051} sdv_2 := __HAVOC_malloc(8);
    DeviceObject_13 := actual_DeviceObject_13;
    Irp_7 := actual_Irp_7;
    assume {:nonnull} DeviceObject_13 != 0;
    assume DeviceObject_13 > 0;
    data := Mem_T.DeviceExtension__DEVICE_OBJECT[DeviceExtension__DEVICE_OBJECT(DeviceObject_13)];
    call {:si_unique_call 1052} stack := sdv_IoGetCurrentIrpStackLocation(Irp_7);
    assume {:nonnull} stack != 0;
    assume stack > 0;
    havoc powerType;
    assume {:nonnull} powerState != 0;
  ...
  L74:
    call {:si_unique_call 1053} PoStartNextPowerIrp(0);
    assume {:nonnull} data != 0;
    assume data > 0;
    call {:si_unique_call 1054} vslice_dummy_var_114 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(data), Irp_7);
    Tmp_254 := 0;
    return;
  ...
  anon20_Then:
    assume {:partition} powerType == 1;
    call {:si_unique_call 1055} SD2 := PoSetPowerState(0, powerType, powerState);
    assume {:nonnull} SD2 != 0;
    assume SD2 > 0;
    assume {:nonnull} sdv_2 != 0;
    assume sdv_2 > 0;
    ...
    call {:si_unique_call 1056} irpLeds := IoAllocateIrp(vslice_dummy_var_1729, 0);
    goto anon16_Then, anon16_Else;
  ...
  anon16_Then:
    assume {:partition} irpLeds != 0;
    call {:si_unique_call 1057} status_11 := sdv_IoAcquireRemoveLock(0, 0);
    goto anon17_Then, anon17_Else;
  ...
  L48:
    ...
    assume {:nonnull} next != 0;
    assume next > 0;
    call {:si_unique_call 1059} sdv_IoSetCompletionRoutine(irpLeds, li2bplFunctionConstant1015, data, 1, 1, 1);
    assume {:nonnull} irpLeds != 0;
    assume irpLeds > 0;
    assume {:nonnull} data != 0;
    assume data > 0;
    call {:si_unique_call 1060} vslice_dummy_var_115 := sdv_IoCallDriver#0(Mem_T.P_DEVICE_OBJECT[TopPort__DEVICE_EXTENSION(data)], irpLeds);
    goto L74;
  ...
  anon17_Then:
    assume {:partition} 0 > status_11;
    call {:si_unique_call 1061} IoFreeIrp(0);
    goto L74;

  anon15_Then:
    assume {:partition} powerType == 0;
    call {:si_unique_call 1062} SD1 := PoSetPowerState(0, powerType, powerState);
    assume {:nonnull} SD1 != 0;
    assume SD1 > 0;
    assume {:nonnull} sdv_1 != 0;
    assume sdv_1 > 0;
    ...
    assume {:nonnull} powerState != 0;
    assume powerState > 0;
    call {:si_unique_call 1063} status_11 := PoRequestPowerIrp(0, 2, powerState, li2bplFunctionConstant1014, 0, 0);
    goto anon19_Then, anon19_Else;
...
procedure {:origName "KeyboardClassPowerComplete"} KeyboardClassPowerComplete#1(actual_DeviceObject_13: int, actual_Irp_7: int, actual_Context_7: int) returns (Tmp_254: int);
  modifies alloc, sdv_compFset, sdv_invoke_on_success, sdv_invoke_on_error, sdv_invoke_on_cancel, Mem_T.Status__IO_STATUS_BLOCK;
  free ensures {:va_keep} Tmp_254 == 0;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);
...
implementation DriverEntry_loop_L258(in_entry: int) returns (out_entry: int)
{
  ...
  anon69_Else_dummy:
    call {:si_unique_call 1064} {:si_old_unique_call 1} out_entry := DriverEntry_loop_L258(out_entry);
    return;
}
...
implementation DriverEntry_loop_L178(in_i: int, in_classDeviceObject: int, in_Tmp_261: int, in_fullPortName: int, in_Tmp_262: int, in_file_1: int, in_fullClassName: int, in_Tmp_273: int, in_Tmp_276: int, in_Tmp_278: int, in_numPorts: int, in_status_12: int, in_deviceExtension: int, in_Tmp_295: int, in_DriverObject_3: int, in_vslice_dummy_var_47: int, in_vslice_dummy_var_48: int) returns (out_i: int, out_Tmp_261: int, out_Tmp_262: int, out_file_1: int, out_Tmp_273: int, out_Tmp_276: int, out_Tmp_278: int, out_status_12: int, out_deviceExtension: int, out_Tmp_295: int, out_vslice_dummy_var_47: int, out_vslice_dummy_var_48: int)
{
  var vslice_dummy_var_1730: int;
  var vslice_dummy_var_1731: int;

  entry:
    out_i, out_Tmp_261, out_Tmp_262, out_file_1, out_Tmp_273, out_Tmp_276, out_Tmp_278, out_status_12, out_deviceExtension, out_Tmp_295, out_vslice_dummy_var_47, out_vslice_dummy_var_48 := in_i, in_Tmp_261, in_Tmp_262, in_file_1, in_Tmp_273, in_Tmp_276, in_Tmp_278, in_status_12, in_deviceExtension, in_Tmp_295, in_vslice_dummy_var_47, in_vslice_dummy_var_48;
    goto L178, exit;
  ...
  anon59_Else:
    ...
    assume {:nonnull} in_fullPortName != 0;
    assume in_fullPortName > 0;
    call {:si_unique_call 1069} out_status_12 := KbdCreateClassObject(in_DriverObject_3, InitExtension__GLOBALS(Globals), in_classDeviceObject, in_fullClassName, 1);
    goto anon60_Then, anon60_Else;
  ...
  anon60_Else:
    ...
    assume {:nonnull} out_deviceExtension != 0;
    assume out_deviceExtension > 0;
    call {:si_unique_call 1071} out_status_12 := IoGetDeviceObjectPointer(0, 128, 0, TopPort__DEVICE_EXTENSION(out_deviceExtension));
    goto anon61_Then, anon61_Else;
  ...
  anon61_Else:
    ...
    assume {:nonnull} out_deviceExtension != 0;
    assume out_deviceExtension > 0;
    out_Tmp_276 := Mem_T.P_DEVICE_OBJECT[TopPort__DEVICE_EXTENSION(out_deviceExtension)];
    assume {:nonnull} Mem_T.P_DEVICE_OBJECT[in_classDeviceObject] != 0;
    assume Mem_T.P_DEVICE_OBJECT[in_classDeviceObject] > 0;
    ...
    call {:si_unique_call 1077} out_status_12 := KeyboardAddDeviceEx(out_deviceExtension, Mem_T.PINT4[in_fullClassName], out_file_1);
    assume {:nonnull} in_fullClassName != 0;
    assume in_fullClassName > 0;
    goto anon63_Then, anon63_Else;
  ...
  anon64_Else:
    ...
    assume {:nonnull} out_deviceExtension != 0;
    assume out_deviceExtension > 0;
    call {:si_unique_call 1065} out_vslice_dummy_var_47 := sdv_InsertTailList(LegacyDeviceList__GLOBALS(Globals), Link__DEVICE_EXTENSION(out_deviceExtension));
    goto L215;
  ...
  L215_dummy:
    call {:si_unique_call 1078} {:si_old_unique_call 1} out_i, out_Tmp_261, out_Tmp_262, out_file_1, out_Tmp_273, out_Tmp_276, out_Tmp_278, out_status_12, out_deviceExtension, out_Tmp_295, out_vslice_dummy_var_47, out_vslice_dummy_var_48 := DriverEntry_loop_L178(out_i, in_classDeviceObject, out_Tmp_261, in_fullPortName, out_Tmp_262, out_file_1, in_fullClassName, out_Tmp_273, out_Tmp_276, out_Tmp_278, in_numPorts, out_status_12, out_deviceExtension, out_Tmp_295, in_DriverObject_3, out_vslice_dummy_var_47, out_vslice_dummy_var_48);
    return;
  ...
  anon65_Else:
    call {:si_unique_call 1074} ExAcquireFastMutex(0);
    assume {:nonnull} out_deviceExtension != 0;
    assume out_deviceExtension > 0;
    havoc out_Tmp_278;
    havoc out_file_1;
  ...
  anon67_Else:
    ...
    call {:si_unique_call 1073} out_vslice_dummy_var_48 := sdv_ObDereferenceObject(0);
    goto L228;
  ...
  anon68_Else:
    ...
    Mem_T.InputData__DEVICE_EXTENSION[InputData__DEVICE_EXTENSION(out_deviceExtension)] := vslice_dummy_var_1731;
    goto L232;

  L232:
    call {:si_unique_call 1066} IoDeleteDevice(0);
  ...
  anon62_Else:
    ...
    Mem_T.InputData__DEVICE_EXTENSION[InputData__DEVICE_EXTENSION(out_deviceExtension)] := vslice_dummy_var_1730;
    goto L245;

  L245:
    call {:si_unique_call 1067} IoDeleteDevice(0);
    out_deviceExtension := 0;
    goto L215;
  ...
  anon60_Then:
    assume {:partition} 0 > out_status_12;
    call {:si_unique_call 1068} KeyboardClassLogError(li2bplFunctionConstant962, -1073414143, 10008, out_status_12, 0, 0, 0);
    goto L215;
}



procedure {:LoopProcedure} DriverEntry_loop_L178(in_i: int, in_classDeviceObject: int, in_Tmp_261: int, in_fullPortName: int, in_Tmp_262: int, in_file_1: int, in_fullClassName: int, in_Tmp_273: int, in_Tmp_276: int, in_Tmp_278: int, in_numPorts: int, in_status_12: int, in_deviceExtension: int, in_Tmp_295: int, in_DriverObject_3: int, in_vslice_dummy_var_47: int, in_vslice_dummy_var_48: int) returns (out_i: int, out_Tmp_261: int, out_Tmp_262: int, out_file_1: int, out_Tmp_273: int, out_Tmp_276: int, out_Tmp_278: int, out_status_12: int, out_deviceExtension: int, out_Tmp_295: int, out_vslice_dummy_var_47: int, out_vslice_dummy_var_48: int);
...
implementation KeyboardClassCleanupQueue_loop_L49(in_listHead: int, in_sdv_123: int, in_irp: int, in_sdv_124: int, in_entry_1: int, in_DeviceExtension: int, in_vslice_dummy_var_59: int) returns (out_sdv_123: int, out_irp: int, out_sdv_124: int, out_entry_1: int, out_vslice_dummy_var_59: int)
{

  entry:
    out_sdv_123, out_irp, out_sdv_124, out_entry_1, out_vslice_dummy_var_59 := in_sdv_123, in_irp, in_sdv_124, in_entry_1, in_vslice_dummy_var_59;
    goto L49, exit;
  ...
  L49:
    call {:si_unique_call 1079} out_sdv_123 := sdv_IsListEmpty(0);
    goto anon15_Else;

  anon15_Else:
    assume {:partition} out_sdv_123 == 0;
    call {:si_unique_call 1080} out_entry_1 := RemoveHeadList(in_listHead);
    call {:si_unique_call 1081} out_sdv_124 := sdv_containing_record(out_entry_1, 88);
    out_irp := out_sdv_124;
    call {:si_unique_call 1082} sdv_IoCompleteRequest(0, 0);
    assume {:nonnull} in_DeviceExtension != 0;
    assume in_DeviceExtension > 0;
    call {:si_unique_call 1083} out_vslice_dummy_var_59 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(in_DeviceExtension), out_irp);
    goto anon15_Else_dummy;

  anon15_Else_dummy:
    call {:si_unique_call 1084} {:si_old_unique_call 1} out_sdv_123, out_irp, out_sdv_124, out_entry_1, out_vslice_dummy_var_59 := KeyboardClassCleanupQueue_loop_L49(in_listHead, out_sdv_123, out_irp, out_sdv_124, out_entry_1, in_DeviceExtension, out_vslice_dummy_var_59);
    return;
}



procedure {:LoopProcedure} KeyboardClassCleanupQueue_loop_L49(in_listHead: int, in_sdv_123: int, in_irp: int, in_sdv_124: int, in_entry_1: int, in_DeviceExtension: int, in_vslice_dummy_var_59: int) returns (out_sdv_123: int, out_irp: int, out_sdv_124: int, out_entry_1: int, out_vslice_dummy_var_59: int);
  modifies alloc;
...
implementation KeyboardClassCleanupQueue_loop_L16(in_listHead: int, in_nextEntry: int, in_sdv_118: int, in_oldCancelRoutine: int, in_irp: int, in_entry_1: int, in_stack_1: int, in_FileObject_1: int, in_vslice_dummy_var_58: int, in_vslice_dummy_var_60: int) returns (out_nextEntry: int, out_sdv_118: int, out_oldCancelRoutine: int, out_irp: int, out_entry_1: int, out_stack_1: int, out_vslice_dummy_var_58: int, out_vslice_dummy_var_60: int)
{

  entry:
    out_nextEntry, out_sdv_118, out_oldCancelRoutine, out_irp, out_entry_1, out_stack_1, out_vslice_dummy_var_58, out_vslice_dummy_var_60 := in_nextEntry, in_sdv_118, in_oldCancelRoutine, in_irp, in_entry_1, in_stack_1, in_vslice_dummy_var_58, in_vslice_dummy_var_60;
    goto L16, exit;
  ...
  anon11_Else:
    ...
    havoc out_nextEntry;
    call {:si_unique_call 1089} out_sdv_118 := sdv_containing_record(out_entry_1, 88);
    out_irp := out_sdv_118;
    call {:si_unique_call 1090} out_stack_1 := sdv_IoGetCurrentIrpStackLocation(out_irp);
    goto anon12_Then, anon12_Else;
  ...
  L35_dummy:
    call {:si_unique_call 1091} {:si_old_unique_call 1} out_nextEntry, out_sdv_118, out_oldCancelRoutine, out_irp, out_entry_1, out_stack_1, out_vslice_dummy_var_58, out_vslice_dummy_var_60 := KeyboardClassCleanupQueue_loop_L16(in_listHead, out_nextEntry, out_sdv_118, out_oldCancelRoutine, out_irp, out_entry_1, out_stack_1, in_FileObject_1, out_vslice_dummy_var_58, out_vslice_dummy_var_60);
    return;
  ...
  L31:
    call {:si_unique_call 1087} out_vslice_dummy_var_58 := sdv_RemoveEntryList(0);
    call {:si_unique_call 1088} out_oldCancelRoutine := sdv_IoSetCancelRoutine(out_irp, 0);
    goto anon14_Then, anon14_Else;
  ...
  anon14_Else:
    ...
    assume {:nonnull} out_irp != 0;
    assume out_irp > 0;
    call {:si_unique_call 1085} out_vslice_dummy_var_60 := sdv_InsertTailList(in_listHead, ListEntry_unnamed_tag_6(Overlay_unnamed_tag_5(Tail__IRP(out_irp))));
    goto L35;
  ...
  anon14_Then:
    ...
    assume {:nonnull} out_irp != 0;
    assume out_irp > 0;
    call {:si_unique_call 1086} InitializeListHead(ListEntry_unnamed_tag_6(Overlay_unnamed_tag_5(Tail__IRP(out_irp))));
    goto L35;
...
procedure {:LoopProcedure} KeyboardClassCleanupQueue_loop_L16(in_listHead: int, in_nextEntry: int, in_sdv_118: int, in_oldCancelRoutine: int, in_irp: int, in_entry_1: int, in_stack_1: int, in_FileObject_1: int, in_vslice_dummy_var_58: int, in_vslice_dummy_var_60: int) returns (out_nextEntry: int, out_sdv_118: int, out_oldCancelRoutine: int, out_irp: int, out_entry_1: int, out_stack_1: int, out_vslice_dummy_var_58: int, out_vslice_dummy_var_60: int);
...
implementation KeyboardAddDeviceEx_loop_L86(in_i_1: int, in_Tmp_304: int, in_errorLogEntry: int, in_Tmp_309: int, in_dumpData_1: int, in_dumpCount: int, in_Tmp_324: int) returns (out_i_1: int, out_Tmp_304: int, out_Tmp_309: int, out_Tmp_324: int)
{

  entry:
    out_i_1, out_Tmp_304, out_Tmp_309, out_Tmp_324 := in_i_1, in_Tmp_304, in_Tmp_309, in_Tmp_324;
    goto L86, exit;
  ...
  anon40_Else_dummy:
    call {:si_unique_call 1092} {:si_old_unique_call 1} out_i_1, out_Tmp_304, out_Tmp_309, out_Tmp_324 := KeyboardAddDeviceEx_loop_L86(out_i_1, out_Tmp_304, in_errorLogEntry, out_Tmp_309, in_dumpData_1, in_dumpCount, out_Tmp_324);
    return;
}



procedure {:LoopProcedure} KeyboardAddDeviceEx_loop_L86(in_i_1: int, in_Tmp_304: int, in_errorLogEntry: int, in_Tmp_309: int, in_dumpData_1: int, in_dumpCount: int, in_Tmp_324: int) returns (out_i_1: int, out_Tmp_304: int, out_Tmp_309: int, out_Tmp_324: int);
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);



implementation KeyboardAddDeviceEx_loop_L37(in_i_1: int, in_Tmp_307: int) returns (out_i_1: int, out_Tmp_307: int)
{

  entry:
    out_i_1, out_Tmp_307 := in_i_1, in_Tmp_307;
    goto L37, exit;
...
procedure {:LoopProcedure} KeyboardAddDeviceEx_loop_L37(in_i_1: int, in_Tmp_307: int) returns (out_i_1: int, out_Tmp_307: int);
  free ensures {:va_keep} out_Tmp_307 == in_i_1 || out_Tmp_307 == in_Tmp_307;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);



implementation KeyboardClassLogError_loop_L20(in_i_2: int, in_Tmp_342: int, in_Tmp_344: int, in_Tmp_345: int, in_errorLogEntry_1: int, in_DumpCount: int, in_DumpData: int) returns (out_i_2: int, out_Tmp_342: int, out_Tmp_344: int, out_Tmp_345: int)
{

  entry:
    out_i_2, out_Tmp_342, out_Tmp_344, out_Tmp_345 := in_i_2, in_Tmp_342, in_Tmp_344, in_Tmp_345;
    goto L20, exit;
  ...
  anon5_Else_dummy:
    call {:si_unique_call 1093} {:si_old_unique_call 1} out_i_2, out_Tmp_342, out_Tmp_344, out_Tmp_345 := KeyboardClassLogError_loop_L20(out_i_2, out_Tmp_342, out_Tmp_344, out_Tmp_345, in_errorLogEntry_1, in_DumpCount, in_DumpData);
    return;
}



procedure {:LoopProcedure} KeyboardClassLogError_loop_L20(in_i_2: int, in_Tmp_342: int, in_Tmp_344: int, in_Tmp_345: int, in_errorLogEntry_1: int, in_DumpCount: int, in_DumpData: int) returns (out_i_2: int, out_Tmp_342: int, out_Tmp_344: int, out_Tmp_345: int);
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);



implementation KbdCreateClassObject_loop_L158(in_Tmp_349: int, in_Tmp_352: int, in_fullClassName_1: int, in_Tmp_358: int, in_Tmp_361: int, in_Tmp_364: int, in_status_17: int, in_Tmp_371: int, in_Tmp_373: int, in_Tmp_374: int, in_ClassDeviceObject: int, in_Legacy: int) returns (out_Tmp_349: int, out_Tmp_352: int, out_Tmp_358: int, out_Tmp_361: int, out_Tmp_364: int, out_status_17: int, out_Tmp_371: int, out_Tmp_373: int, out_Tmp_374: int)
{

  entry:
    out_Tmp_349, out_Tmp_352, out_Tmp_358, out_Tmp_361, out_Tmp_364, out_status_17, out_Tmp_371, out_Tmp_373, out_Tmp_374 := in_Tmp_349, in_Tmp_352, in_Tmp_358, in_Tmp_361, in_Tmp_364, in_status_17, in_Tmp_371, in_Tmp_373, in_Tmp_374;
    goto L158, exit;
  ...
  anon49_Else:
    ...
    havoc out_Tmp_352;
    out_Tmp_371 := out_Tmp_352;
    out_Tmp_373 := strConst__li2bpl15;
    call {:si_unique_call 1096} out_status_17 := RtlUnicodeStringPrintf(in_fullClassName_1, out_Tmp_373);
    goto L166;
  ...
  anon50_Then:
    ...
    call {:si_unique_call 1094} WPP_RECORDER_SF_S(out_Tmp_364, 0, 2, 76, out_Tmp_349, Mem_T.Buffer__UNICODE_STRING[Buffer__UNICODE_STRING(in_fullClassName_1)]);
    call {:si_unique_call 1095} out_status_17 := IoCreateDevice(0, 232, 0, 11, 0, 0, in_ClassDeviceObject);
    goto anon51_Then;
  ...
  anon51_Then_dummy:
    call {:si_unique_call 1098} {:si_old_unique_call 1} out_Tmp_349, out_Tmp_352, out_Tmp_358, out_Tmp_361, out_Tmp_364, out_status_17, out_Tmp_371, out_Tmp_373, out_Tmp_374 := KbdCreateClassObject_loop_L158(out_Tmp_349, out_Tmp_352, in_fullClassName_1, out_Tmp_358, out_Tmp_361, out_Tmp_364, out_status_17, out_Tmp_371, out_Tmp_373, out_Tmp_374, in_ClassDeviceObject, in_Legacy);
    return;
  ...
  L159:
    havoc out_Tmp_361;
    out_Tmp_358 := out_Tmp_361;
    out_Tmp_374 := strConst__li2bpl16;
    call {:si_unique_call 1097} out_status_17 := RtlUnicodeStringPrintf(in_fullClassName_1, out_Tmp_374);
    goto L166;
...
procedure {:LoopProcedure} KbdCreateClassObject_loop_L158(in_Tmp_349: int, in_Tmp_352: int, in_fullClassName_1: int, in_Tmp_358: int, in_Tmp_361: int, in_Tmp_364: int, in_status_17: int, in_Tmp_371: int, in_Tmp_373: int, in_Tmp_374: int, in_ClassDeviceObject: int, in_Legacy: int) returns (out_Tmp_349: int, out_Tmp_352: int, out_Tmp_358: int, out_Tmp_361: int, out_Tmp_364: int, out_status_17: int, out_Tmp_371: int, out_Tmp_373: int, out_Tmp_374: int);
...
implementation KeyboardCallAllPorts#0_loop_L18(in_Tmp_241: int, in_CallAll: int, in_Tmp_242: int, in_Tmp_244: int, in_Tmp_246: int, in_Tmp_249: int, in_Tmp_251: int) returns (out_Tmp_241: int, out_Tmp_242: int, out_Tmp_244: int, out_Tmp_246: int, out_Tmp_249: int, out_Tmp_251: int)
{

  entry:
    out_Tmp_241, out_Tmp_242, out_Tmp_244, out_Tmp_246, out_Tmp_249, out_Tmp_251 := in_Tmp_241, in_Tmp_242, in_Tmp_244, in_Tmp_246, in_Tmp_249, in_Tmp_251;
    goto L18, exit;
  ...
  anon15_Else:
    ...
    assume in_CallAll > 0;
    havoc out_Tmp_246;
    out_Tmp_244 := out_Tmp_246 + out_Tmp_242 * 24;
  ...
  anon20_Else:
    ...
    assume in_CallAll > 0;
    havoc out_Tmp_251;
    out_Tmp_241 := out_Tmp_251 + out_Tmp_249 * 24;
  ...
  L21_dummy:
    call {:si_unique_call 1099} {:si_old_unique_call 1} out_Tmp_241, out_Tmp_242, out_Tmp_244, out_Tmp_246, out_Tmp_249, out_Tmp_251 := KeyboardCallAllPorts#0_loop_L18(out_Tmp_241, in_CallAll, out_Tmp_242, out_Tmp_244, out_Tmp_246, out_Tmp_249, out_Tmp_251);
    return;
...
procedure {:LoopProcedure} KeyboardCallAllPorts#0_loop_L18(in_Tmp_241: int, in_CallAll: int, in_Tmp_242: int, in_Tmp_244: int, in_Tmp_246: int, in_Tmp_249: int, in_Tmp_251: int) returns (out_Tmp_241: int, out_Tmp_242: int, out_Tmp_244: int, out_Tmp_246: int, out_Tmp_249: int, out_Tmp_251: int);
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);



implementation KeyboardCallAllPorts#1_loop_L18(in_Tmp_241: int, in_CallAll: int, in_Tmp_242: int, in_Tmp_244: int, in_Tmp_246: int, in_Tmp_249: int, in_Tmp_251: int) returns (out_Tmp_241: int, out_Tmp_242: int, out_Tmp_244: int, out_Tmp_246: int, out_Tmp_249: int, out_Tmp_251: int)
{
  ...
  L21_dummy:
    call {:si_unique_call 1100} {:si_old_unique_call 1} out_Tmp_241, out_Tmp_242, out_Tmp_244, out_Tmp_246, out_Tmp_249, out_Tmp_251 := KeyboardCallAllPorts#1_loop_L18(out_Tmp_241, in_CallAll, out_Tmp_242, out_Tmp_244, out_Tmp_246, out_Tmp_249, out_Tmp_251);
    return;
...
procedure {:LoopProcedure} KeyboardCallAllPorts#1_loop_L18(in_Tmp_241: int, in_CallAll: int, in_Tmp_242: int, in_Tmp_244: int, in_Tmp_246: int, in_Tmp_249: int, in_Tmp_251: int) returns (out_Tmp_241: int, out_Tmp_242: int, out_Tmp_244: int, out_Tmp_246: int, out_Tmp_249: int, out_Tmp_251: int);
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);
