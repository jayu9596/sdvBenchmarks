...
implementation {:origName "VPI1DataIn"} VPI1DataIn(actual_Extension_3: int) returns (Tmp_47: int)
{
  ...
  anon46_Else:
    ...
    call {:si_unique_call 66} sdv_19 := VPI1GetPhase(Extension_3, vslice_dummy_var_459);
  ...
  anon59_Else:
    ...
    call {:si_unique_call 67} vslice_dummy_var_8 := VPI1GetPhase(Extension_3, vslice_dummy_var_460);
  ...
  anon65_Else:
    ...
    call {:si_unique_call 73} Status_3 := VPI1ParallelRead(Extension_3, vslice_dummy_var_461, ChunkSize, BytesRead);
    assume {:nonnull} Extension_3 != 0;
    assume Extension_3 > 0;
...
implementation {:origName "VPI1DataOut"} VPI1DataOut(actual_Extension_7: int) returns (Tmp_73: int)
{
  ...
  anon28_Else:
    ...
    call {:si_unique_call 93} sdv_38 := VPI1GetPhase(Extension_7, vslice_dummy_var_462);
    goto anon29_Then, anon29_Else;
  ...
  L34:
    ...
    call {:si_unique_call 94} Status_5 := VPI1ParallelWrite(Extension_7, vslice_dummy_var_463, ChunkSize_1, BytesWritten);
    assume {:nonnull} Extension_7 != 0;
    assume Extension_7 > 0;
    goto anon34_Then, anon34_Else;
...
implementation {:origName "VPI1Command"} VPI1Command(actual_Extension_9: int) returns (Tmp_84: int)
{
  ...
  anon27_Else:
    ...
    call {:si_unique_call 102} sdv_43 := VPI1GetPhase(Extension_9, vslice_dummy_var_464);
    goto anon19_Then, anon19_Else;
...
implementation {:origName "VPI1ParallelWrite"} VPI1ParallelWrite(actual_Extension_13: int, actual_Buffer: int, actual_NumBytesToWrite: int, actual_BytesTransfered: int) returns (Tmp_128: int)
{
  ...
  L12:
    ...
    call {:si_unique_call 121} Status_9 := VPI1DataByteWrite(vslice_dummy_var_465, Buffer, NumBytesToWrite, BytesTransfered);
    goto L16;
...
implementation {:origName "VPI1ParallelRead"} VPI1ParallelRead(actual_Extension_16: int, actual_Buffer_1: int, actual_NumBytesToRead: int, actual_BytesTransfered_1: int) returns (Tmp_151: int)
{
  ...
  anon8_Else:
    ...
    call {:si_unique_call 126} Status_12 := VPI1DataNibbleRead(vslice_dummy_var_466, Buffer_1, NumBytesToRead, BytesTransfered_1);
    goto L16;
  ...
  anon9_Else:
    ...
    call {:si_unique_call 127} Status_12 := VPI1DataByteRead(vslice_dummy_var_467, Buffer_1, NumBytesToRead, BytesTransfered_1);
    goto L16;
...
procedure {:origName "sdv_RunSurpriseRemoveDevice"} {:osmodel} sdv_RunSurpriseRemoveDevice(actual_po: int, actual_pirp: int) returns (Tmp_176: int);
  modifies alloc, Mem_T.Status__IO_STATUS_BLOCK, Mem_T.DeviceFlags__DEVICE_EXTENSION, sdv_IoBuildSynchronousFsdRequest_IoStatusBlock, sdv_IoBuildDeviceIoControlRequest_IoStatusBlock;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);
...
implementation {:origName "sdv_IoCopyCurrentIrpStackLocationToNext"} {:osmodel} sdv_IoCopyCurrentIrpStackLocationToNext(actual_pirp_1: int)
{
  ...
  anon0:
    call {:si_unique_call 137} vslice_dummy_var_24 := __HAVOC_malloc(4);
...
implementation {:origName "IoStartNextPacket"} {:osmodel} IoStartNextPacket(actual_DeviceObject: int, actual_Cancelable: int)
{
  ...
  anon0:
    call {:si_unique_call 138} vslice_dummy_var_25 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "sdv_IoInitializeRemoveLock"} {:osmodel} sdv_IoInitializeRemoveLock(actual_Lock: int, actual_AllocateTag: int, actual_MaxLockedMinutes: int, actual_HighWatermark: int)
{
  ...
  anon0:
    call {:si_unique_call 139} vslice_dummy_var_26 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "sdv_KeAcquireSpinLock"} {:osmodel} sdv_KeAcquireSpinLock(actual_SpinLock: int, actual_p: int)
{
  ...
  anon0:
    call {:si_unique_call 140} vslice_dummy_var_27 := __HAVOC_malloc(4);
    p := actual_p;
    assume {:nonnull} p != 0;
    assume p > 0;
    return;
...
implementation {:origName "sdv_RunAddDevice"} {:osmodel} sdv_RunAddDevice(actual_p1: int, actual_p2: int) returns (Tmp_188: int)
{
  ...
  anon0:
    ...
    p2 := actual_p2;
    status_1 := 0;
    call {:si_unique_call 141} sdv_stub_add_begin();
    call {:si_unique_call 142} status_1 := PpaAddDevice(p1, p2);
    call {:si_unique_call 143} sdv_stub_add_end();
    Tmp_188 := status_1;
    return;
}
...
procedure {:nohoudini} {:origName "sdv_main"} {:osmodel} sdv_main();
  modifies alloc, Mem_T.Status__IO_STATUS_BLOCK, Mem_T.DeviceFlags__DEVICE_EXTENSION, sdv_IoBuildSynchronousFsdRequest_IoStatusBlock, sdv_IoBuildDeviceIoControlRequest_IoStatusBlock, yogi_error;
...
implementation {:origName "sdv_main"} {:osmodel} sdv_main()
{
  ...
  anon0:
    call {:si_unique_call 150} u := __HAVOC_malloc(12);
    call {:si_unique_call 151} vslice_dummy_var_34 := __HAVOC_malloc(4);
    assume {:nonnull} sdv_p_devobj_fdo != 0;
    assume sdv_p_devobj_fdo > 0;
    assume {:nonnull} sdv_p_devobj_child_pdo != 0;
    assume sdv_p_devobj_child_pdo > 0;
    call {:si_unique_call 152} status_2 := DriverEntry(sdv_driver_object, u);
    goto anon8_Then, anon8_Else;
  ...
  L68:
    assume Tmp_208 != 0;
    call {:si_unique_call 153} status_2 := sdv_RunAddDevice(sdv_driver_object, sdv_p_devobj_pdo);
    goto anon7_Then, anon7_Else;
  ...
  L78:
    assume Tmp_209 != 0;
    call {:si_unique_call 154} sdv_stub_driver_init();
    call {:si_unique_call 155} status_2 := sdv_RunSurpriseRemoveDevice(sdv_p_devobj_fdo, sdv_irp);
    call {:si_unique_call 156} status_2 := sdv_RunRemoveDevice(sdv_p_devobj_fdo, sdv_irp);
    goto anon9_Then, anon9_Else;
...
implementation {:origName "sdv_MmGetMdlVirtualAddress"} {:osmodel} sdv_MmGetMdlVirtualAddress(actual_Mdl: int) returns (Tmp_212: int)
{
  ...
  anon0:
    call {:si_unique_call 157} sdv_86 := __HAVOC_malloc(1);
    x_1 := sdv_86;
    Tmp_212 := x_1;
    return;
}
...
implementation {:origName "sdv_IoSetCompletionRoutine"} {:osmodel} sdv_IoSetCompletionRoutine(actual_pirp_5: int, actual_CompletionRoutine: int, actual_Context_1: int, actual_InvokeOnSuccess: int, actual_InvokeOnError: int, actual_InvokeOnCancel: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 159} irpSp := sdv_IoGetNextIrpStackLocation(pirp_5);
...
procedure {:origName "_sdv_init9"} {:osmodel} _sdv_init9();
  modifies alloc, sdv_IoBuildDeviceIoControlRequest_IoStatusBlock, sdv_IoBuildSynchronousFsdRequest_IoStatusBlock;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);
...
procedure {:nohoudini} {:origName "main"} {:osmodel} {:entrypoint} main() returns (Tmp_234: int, dup_assertVar: bool);
  modifies alloc, sdv_IoBuildDeviceIoControlRequest_IoStatusBlock, sdv_IoBuildSynchronousFsdRequest_IoStatusBlock, Mem_T.DeviceExtension__DEVICE_OBJECT, yogi_error, Mem_T.Status__IO_STATUS_BLOCK, Mem_T.DeviceFlags__DEVICE_EXTENSION;
  free ensures {:va_keep} yogi_error == 1;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);
...
implementation {:origName "main"} {:osmodel} main() returns (Tmp_234: int, dup_assertVar: bool)
{
  ...
  anon0:
    dup_assertVar := true;
    assume alloc > 0;
    call {:si_unique_call 163} WHEA_ERROR_PACKET_SECTION_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume WHEA_ERROR_PACKET_SECTION_GUID__Loc == WHEA_ERROR_PACKET_SECTION_GUID;
    assume WHEA_ERROR_PACKET_SECTION_GUID != 0;
    call {:si_unique_call 164} PpaBreakOn__Loc := __HAVOC_malloc_or_null(4);
    assume PpaBreakOn__Loc == PpaBreakOn;
    assume PpaBreakOn != 0;
    call {:si_unique_call 165} PpaDebugLevel__Loc := __HAVOC_malloc_or_null(4);
    assume PpaDebugLevel__Loc == PpaDebugLevel;
    assume PpaDebugLevel != 0;
    call {:si_unique_call 166} sdv_harnessStackLocation_next__Loc := __HAVOC_malloc_or_null(496);
    assume sdv_harnessStackLocation_next__Loc == sdv_harnessStackLocation_next;
    assume sdv_harnessStackLocation_next != 0;
    call {:si_unique_call 167} sdv_IoReadPartitionTableEx_DRIVE_LAYOUT_INFORMATION_EX__Loc := __HAVOC_malloc_or_null(76);
    assume sdv_IoReadPartitionTableEx_DRIVE_LAYOUT_INFORMATION_EX__Loc == sdv_IoReadPartitionTableEx_DRIVE_LAYOUT_INFORMATION_EX;
    assume sdv_IoReadPartitionTableEx_DRIVE_LAYOUT_INFORMATION_EX != 0;
    call {:si_unique_call 168} sdv_IoBuildAsynchronousFsdRequest_harnessIrp__Loc := __HAVOC_malloc_or_null(248);
    assume sdv_IoBuildAsynchronousFsdRequest_harnessIrp__Loc == sdv_IoBuildAsynchronousFsdRequest_harnessIrp;
    assume sdv_IoBuildAsynchronousFsdRequest_harnessIrp != 0;
    call {:si_unique_call 169} sdv_IoGetDeviceToVerify_DEVICE_OBJECT__Loc := __HAVOC_malloc_or_null(320);
    assume sdv_IoGetDeviceToVerify_DEVICE_OBJECT__Loc == sdv_IoGetDeviceToVerify_DEVICE_OBJECT;
    assume sdv_IoGetDeviceToVerify_DEVICE_OBJECT != 0;
    call {:si_unique_call 170} sdv_IoBuildDeviceIoControlRequest_harnessStackLocation_next__Loc := __HAVOC_malloc_or_null(496);
    assume sdv_IoBuildDeviceIoControlRequest_harnessStackLocation_next__Loc == sdv_IoBuildDeviceIoControlRequest_harnessStackLocation_next;
    assume sdv_IoBuildDeviceIoControlRequest_harnessStackLocation_next != 0;
    call {:si_unique_call 171} sdv_harness_IoBuildSynchronousFsdRequest_IoStatusBlock__Loc := __HAVOC_malloc_or_null(12);
    assume sdv_harness_IoBuildSynchronousFsdRequest_IoStatusBlock__Loc == sdv_harness_IoBuildSynchronousFsdRequest_IoStatusBlock;
    assume sdv_harness_IoBuildSynchronousFsdRequest_IoStatusBlock != 0;
    call {:si_unique_call 172} sdv_ControllerIrp__Loc := __HAVOC_malloc_or_null(248);
    assume sdv_ControllerIrp__Loc == sdv_ControllerIrp;
    assume sdv_ControllerIrp != 0;
    call {:si_unique_call 173} sdv_devobj_pdo__Loc := __HAVOC_malloc_or_null(320);
    assume sdv_devobj_pdo__Loc == sdv_devobj_pdo;
    assume sdv_devobj_pdo != 0;
    call {:si_unique_call 174} sdv_IoGetDmaAdapter_DMA_ADAPTER__Loc := __HAVOC_malloc_or_null(12);
    assume sdv_IoGetDmaAdapter_DMA_ADAPTER__Loc == sdv_IoGetDmaAdapter_DMA_ADAPTER;
    assume sdv_IoGetDmaAdapter_DMA_ADAPTER != 0;
    call {:si_unique_call 175} sdv_IoInitializeIrp_harnessIrp__Loc := __HAVOC_malloc_or_null(248);
    assume sdv_IoInitializeIrp_harnessIrp__Loc == sdv_IoInitializeIrp_harnessIrp;
    assume sdv_IoInitializeIrp_harnessIrp != 0;
    call {:si_unique_call 176} sdv_IoGetRelatedDeviceObject_DEVICE_OBJECT__Loc := __HAVOC_malloc_or_null(320);
    assume sdv_IoGetRelatedDeviceObject_DEVICE_OBJECT__Loc == sdv_IoGetRelatedDeviceObject_DEVICE_OBJECT;
    assume sdv_IoGetRelatedDeviceObject_DEVICE_OBJECT != 0;
    call {:si_unique_call 177} sdv_IoBuildSynchronousFsdRequest_harnessStackLocation_next__Loc := __HAVOC_malloc_or_null(496);
    assume sdv_IoBuildSynchronousFsdRequest_harnessStackLocation_next__Loc == sdv_IoBuildSynchronousFsdRequest_harnessStackLocation_next;
    assume sdv_IoBuildSynchronousFsdRequest_harnessStackLocation_next != 0;
    call {:si_unique_call 178} sdv_IoCreateSynchronizationEvent_KEVENT__Loc := __HAVOC_malloc_or_null(124);
    assume sdv_IoCreateSynchronizationEvent_KEVENT__Loc == sdv_IoCreateSynchronizationEvent_KEVENT;
    assume sdv_IoCreateSynchronizationEvent_KEVENT != 0;
    call {:si_unique_call 179} sdv_other_harnessStackLocation_next__Loc := __HAVOC_malloc_or_null(496);
    assume sdv_other_harnessStackLocation_next__Loc == sdv_other_harnessStackLocation_next;
    assume sdv_other_harnessStackLocation_next != 0;
    call {:si_unique_call 180} sdv_harnessStackLocation__Loc := __HAVOC_malloc_or_null(496);
    assume sdv_harnessStackLocation__Loc == sdv_harnessStackLocation;
    assume sdv_harnessStackLocation != 0;
    call {:si_unique_call 181} sdv_IoCreateController_CONTROLLER_OBJECT__Loc := __HAVOC_malloc_or_null(60);
    assume sdv_IoCreateController_CONTROLLER_OBJECT__Loc == sdv_IoCreateController_CONTROLLER_OBJECT;
    assume sdv_IoCreateController_CONTROLLER_OBJECT != 0;
    call {:si_unique_call 182} sdv_devobj_top__Loc := __HAVOC_malloc_or_null(320);
    assume sdv_devobj_top__Loc == sdv_devobj_top;
    assume sdv_devobj_top != 0;
    call {:si_unique_call 183} sdv_kdpc_val3__Loc := __HAVOC_malloc_or_null(40);
    assume sdv_kdpc_val3__Loc == sdv_kdpc_val3;
    assume sdv_kdpc_val3 != 0;
    call {:si_unique_call 184} sdv_IoBuildSynchronousFsdRequest_harnessIrp__Loc := __HAVOC_malloc_or_null(248);
    assume sdv_IoBuildSynchronousFsdRequest_harnessIrp__Loc == sdv_IoBuildSynchronousFsdRequest_harnessIrp;
    assume sdv_IoBuildSynchronousFsdRequest_harnessIrp != 0;
    call {:si_unique_call 185} sdv_IoGetDeviceObjectPointer_DEVICE_OBJECT__Loc := __HAVOC_malloc_or_null(320);
    assume sdv_IoGetDeviceObjectPointer_DEVICE_OBJECT__Loc == sdv_IoGetDeviceObjectPointer_DEVICE_OBJECT;
    assume sdv_IoGetDeviceObjectPointer_DEVICE_OBJECT != 0;
    call {:si_unique_call 186} sdv_driver_object__Loc := __HAVOC_malloc_or_null(68);
    assume sdv_driver_object__Loc == sdv_driver_object;
    assume sdv_driver_object != 0;
    call {:si_unique_call 187} sdv_MapRegisterBase_val__Loc := __HAVOC_malloc_or_null(4);
    assume sdv_MapRegisterBase_val__Loc == sdv_MapRegisterBase_val;
    assume sdv_MapRegisterBase_val != 0;
    call {:si_unique_call 188} sdv_IoGetFileObjectGenericMapping_GENERIC_MAPPING__Loc := __HAVOC_malloc_or_null(16);
    assume sdv_IoGetFileObjectGenericMapping_GENERIC_MAPPING__Loc == sdv_IoGetFileObjectGenericMapping_GENERIC_MAPPING;
    assume sdv_IoGetFileObjectGenericMapping_GENERIC_MAPPING != 0;
    call {:si_unique_call 189} sdv_IoMakeAssociatedIrp_harnessIrp__Loc := __HAVOC_malloc_or_null(248);
    assume sdv_IoMakeAssociatedIrp_harnessIrp__Loc == sdv_IoMakeAssociatedIrp_harnessIrp;
    assume sdv_IoMakeAssociatedIrp_harnessIrp != 0;
    call {:si_unique_call 190} sdv_devobj_child_pdo__Loc := __HAVOC_malloc_or_null(320);
    assume sdv_devobj_child_pdo__Loc == sdv_devobj_child_pdo;
    assume sdv_devobj_child_pdo != 0;
    call {:si_unique_call 191} sdv_harnessIrp__Loc := __HAVOC_malloc_or_null(248);
    assume sdv_harnessIrp__Loc == sdv_harnessIrp;
    assume sdv_harnessIrp != 0;
    call {:si_unique_call 192} sdv_IoBuildAsynchronousFsdRequest_harnessStackLocation_next__Loc := __HAVOC_malloc_or_null(496);
    assume sdv_IoBuildAsynchronousFsdRequest_harnessStackLocation_next__Loc == sdv_IoBuildAsynchronousFsdRequest_harnessStackLocation_next;
    assume sdv_IoBuildAsynchronousFsdRequest_harnessStackLocation_next != 0;
    call {:si_unique_call 193} sdv_harness_IoBuildDeviceIoControlRequest_IoStatusBlock__Loc := __HAVOC_malloc_or_null(12);
    assume sdv_harness_IoBuildDeviceIoControlRequest_IoStatusBlock__Loc == sdv_harness_IoBuildDeviceIoControlRequest_IoStatusBlock;
    assume sdv_harness_IoBuildDeviceIoControlRequest_IoStatusBlock != 0;
    call {:si_unique_call 194} sdv_kinterrupt_val__Loc := __HAVOC_malloc_or_null(0);
    assume sdv_kinterrupt_val__Loc == sdv_kinterrupt_val;
    assume sdv_kinterrupt_val != 0;
    call {:si_unique_call 195} sdv_devobj_fdo__Loc := __HAVOC_malloc_or_null(320);
    assume sdv_devobj_fdo__Loc == sdv_devobj_fdo;
    assume sdv_devobj_fdo != 0;
    call {:si_unique_call 196} sdv_StartIoIrp__Loc := __HAVOC_malloc_or_null(248);
    assume sdv_StartIoIrp__Loc == sdv_StartIoIrp;
    assume sdv_StartIoIrp != 0;
    call {:si_unique_call 197} sdv_harness_IoBuildAsynchronousFsdRequest_IoStatusBlock__Loc := __HAVOC_malloc_or_null(12);
    assume sdv_harness_IoBuildAsynchronousFsdRequest_IoStatusBlock__Loc == sdv_harness_IoBuildAsynchronousFsdRequest_IoStatusBlock;
    assume sdv_harness_IoBuildAsynchronousFsdRequest_IoStatusBlock != 0;
    call {:si_unique_call 198} sdv_PowerIrp__Loc := __HAVOC_malloc_or_null(248);
    assume sdv_PowerIrp__Loc == sdv_PowerIrp;
    assume sdv_PowerIrp != 0;
    call {:si_unique_call 199} sdv_IoBuildDeviceIoControlRequest_harnessIrp__Loc := __HAVOC_malloc_or_null(248);
    assume sdv_IoBuildDeviceIoControlRequest_harnessIrp__Loc == sdv_IoBuildDeviceIoControlRequest_harnessIrp;
    assume sdv_IoBuildDeviceIoControlRequest_harnessIrp != 0;
    call {:si_unique_call 200} sdv_other_harnessIrp__Loc := __HAVOC_malloc_or_null(248);
    assume sdv_other_harnessIrp__Loc == sdv_other_harnessIrp;
    assume sdv_other_harnessIrp != 0;
    call {:si_unique_call 201} sdv_IoCreateNotificationEvent_KEVENT__Loc := __HAVOC_malloc_or_null(124);
    assume sdv_IoCreateNotificationEvent_KEVENT__Loc == sdv_IoCreateNotificationEvent_KEVENT;
    assume sdv_IoCreateNotificationEvent_KEVENT != 0;
    call {:si_unique_call 202} sdv_other_harnessStackLocation__Loc := __HAVOC_malloc_or_null(496);
    assume sdv_other_harnessStackLocation__Loc == sdv_other_harnessStackLocation;
    assume sdv_other_harnessStackLocation != 0;
    call {:si_unique_call 203} KeTickCount__Loc := __HAVOC_malloc_or_null(12);
    ...
    call {:si_unique_call 217} boogieTmp := __HAVOC_malloc_or_null(248);
    ...
    call {:si_unique_call 228} vslice_dummy_var_113 := __HAVOC_malloc(4);
    call {:si_unique_call 229} vslice_dummy_var_468 := __HAVOC_malloc(28);
    call {:si_unique_call 230} vslice_dummy_var_114 := __HAVOC_malloc(4);
    call {:si_unique_call 231} vslice_dummy_var_115 := __HAVOC_malloc(4);
    call {:si_unique_call 232} vslice_dummy_var_116 := __HAVOC_malloc(4);
    call {:si_unique_call 233} vslice_dummy_var_117 := __HAVOC_malloc(4);
    call {:si_unique_call 234} vslice_dummy_var_469 := __HAVOC_malloc(12);
    call {:si_unique_call 235} vslice_dummy_var_118 := __HAVOC_malloc(4);
    call {:si_unique_call 236} vslice_dummy_var_470 := __HAVOC_malloc(28);
    call {:si_unique_call 237} vslice_dummy_var_119 := __HAVOC_malloc(4);
    call {:si_unique_call 238} vslice_dummy_var_120 := __HAVOC_malloc(4);
    call {:si_unique_call 239} vslice_dummy_var_121 := __HAVOC_malloc(4);
    call {:si_unique_call 240} vslice_dummy_var_122 := __HAVOC_malloc(4);
    call {:si_unique_call 241} vslice_dummy_var_471 := __HAVOC_malloc(12);
    call {:si_unique_call 242} vslice_dummy_var_123 := __HAVOC_malloc(4);
    call {:si_unique_call 243} vslice_dummy_var_472 := __HAVOC_malloc(28);
    call {:si_unique_call 244} vslice_dummy_var_124 := __HAVOC_malloc(4);
    call {:si_unique_call 245} vslice_dummy_var_125 := __HAVOC_malloc(4);
    call {:si_unique_call 246} vslice_dummy_var_126 := __HAVOC_malloc(4);
    call {:si_unique_call 247} vslice_dummy_var_127 := __HAVOC_malloc(4);
    call {:si_unique_call 248} vslice_dummy_var_473 := __HAVOC_malloc(12);
    call {:si_unique_call 249} vslice_dummy_var_128 := __HAVOC_malloc(4);
    call {:si_unique_call 250} vslice_dummy_var_129 := __HAVOC_malloc(4);
    call {:si_unique_call 251} vslice_dummy_var_130 := __HAVOC_malloc(4);
    call {:si_unique_call 252} vslice_dummy_var_131 := __HAVOC_malloc(4);
    call {:si_unique_call 253} vslice_dummy_var_132 := __HAVOC_malloc(4);
    call {:si_unique_call 254} vslice_dummy_var_133 := __HAVOC_malloc(4);
    call {:si_unique_call 255} vslice_dummy_var_474 := __HAVOC_malloc(28);
    call {:si_unique_call 256} vslice_dummy_var_134 := __HAVOC_malloc(4);
    call {:si_unique_call 257} vslice_dummy_var_135 := __HAVOC_malloc(4);
    call {:si_unique_call 258} vslice_dummy_var_136 := __HAVOC_malloc(4);
    call {:si_unique_call 259} vslice_dummy_var_137 := __HAVOC_malloc(4);
    call {:si_unique_call 260} vslice_dummy_var_475 := __HAVOC_malloc(12);
    call {:si_unique_call 261} vslice_dummy_var_138 := __HAVOC_malloc(4);
    call {:si_unique_call 262} vslice_dummy_var_476 := __HAVOC_malloc(28);
    call {:si_unique_call 263} vslice_dummy_var_139 := __HAVOC_malloc(4);
    call {:si_unique_call 264} vslice_dummy_var_140 := __HAVOC_malloc(4);
    call {:si_unique_call 265} vslice_dummy_var_141 := __HAVOC_malloc(4);
    call {:si_unique_call 266} vslice_dummy_var_142 := __HAVOC_malloc(4);
    call {:si_unique_call 267} vslice_dummy_var_477 := __HAVOC_malloc(12);
    call {:si_unique_call 268} vslice_dummy_var_143 := __HAVOC_malloc(4);
    call {:si_unique_call 269} vslice_dummy_var_478 := __HAVOC_malloc(28);
    call {:si_unique_call 270} vslice_dummy_var_144 := __HAVOC_malloc(4);
    call {:si_unique_call 271} vslice_dummy_var_145 := __HAVOC_malloc(4);
    call {:si_unique_call 272} vslice_dummy_var_146 := __HAVOC_malloc(4);
    call {:si_unique_call 273} vslice_dummy_var_147 := __HAVOC_malloc(4);
    call {:si_unique_call 274} vslice_dummy_var_479 := __HAVOC_malloc(12);
    call {:si_unique_call 275} vslice_dummy_var_148 := __HAVOC_malloc(4);
    call {:si_unique_call 276} vslice_dummy_var_480 := __HAVOC_malloc(28);
    call {:si_unique_call 277} vslice_dummy_var_149 := __HAVOC_malloc(4);
    call {:si_unique_call 278} vslice_dummy_var_150 := __HAVOC_malloc(4);
    call {:si_unique_call 279} vslice_dummy_var_151 := __HAVOC_malloc(4);
    call {:si_unique_call 280} vslice_dummy_var_152 := __HAVOC_malloc(4);
    call {:si_unique_call 281} vslice_dummy_var_481 := __HAVOC_malloc(12);
    call {:si_unique_call 282} vslice_dummy_var_153 := __HAVOC_malloc(4);
    call {:si_unique_call 283} vslice_dummy_var_482 := __HAVOC_malloc(28);
    call {:si_unique_call 284} vslice_dummy_var_154 := __HAVOC_malloc(4);
    call {:si_unique_call 285} vslice_dummy_var_155 := __HAVOC_malloc(4);
    call {:si_unique_call 286} vslice_dummy_var_156 := __HAVOC_malloc(4);
    call {:si_unique_call 287} vslice_dummy_var_157 := __HAVOC_malloc(4);
    call {:si_unique_call 288} vslice_dummy_var_483 := __HAVOC_malloc(12);
    assume {:mainInitDone} true;
    call {:si_unique_call 289} corralExtraInit();
    call {:si_unique_call 290} corralExplainErrorInit();
    call {:si_unique_call 291} _sdv_init11();
    call {:si_unique_call 292} _sdv_init1();
    call {:si_unique_call 293} _sdv_init4();
    call {:si_unique_call 294} _sdv_init5();
    call {:si_unique_call 295} _sdv_init3();
    call {:si_unique_call 296} _sdv_init6();
    call {:si_unique_call 297} _sdv_init9();
    call {:si_unique_call 298} _sdv_init7();
    call {:si_unique_call 299} _sdv_init8();
    call {:si_unique_call 300} _sdv_init2();
    goto anon9_Then, anon9_Else;
  ...
  L38:
    ...
    call {:si_unique_call 301} sdv_main();
    goto anon12_Then, anon12_Else;
...
implementation {:origName "sdv_IoSkipCurrentIrpStackLocation"} {:osmodel} sdv_IoSkipCurrentIrpStackLocation(actual_pirp_7: int)
{
  ...
  anon0:
    call {:si_unique_call 302} vslice_dummy_var_39 := __HAVOC_malloc(4);
...
implementation {:origName "sdv_RunRemoveDevice"} {:osmodel} sdv_RunRemoveDevice(actual_po_1: int, actual_pirp_8: int) returns (Tmp_244: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 304} sdv_SetStatus(pirp_8);
    call {:si_unique_call 305} status_3 := PpaPnpDeviceControl(po_1, pirp_8);
    call {:si_unique_call 306} sdv_stub_dispatch_end(status_3, 0);
    Tmp_244 := status_3;
    call {:si_unique_call 307} SLIC_sdv_RunRemoveDevice_exit(strConst__li2bpl12, pirp_8, Tmp_244);
    goto anon3_Then, anon3_Else;
...
procedure {:origName "SLIC_sdv_RunRemoveDevice_exit"} {:osmodel} SLIC_sdv_RunRemoveDevice_exit(actual_caller_1: int, actual_sdv_113: int, actual_sdv_114: int);
  modifies yogi_error;
  free ensures {:va_keep} yogi_error == 1;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);
...
implementation {:origName "SLIC_sdv_RunRemoveDevice_exit"} {:osmodel} SLIC_sdv_RunRemoveDevice_exit(actual_caller_1: int, actual_sdv_113: int, actual_sdv_114: int)
{
...
implementation {:origName "PpaPortLock"} PpaPortLock(actual_Extension_20: int, actual_Wait_1: int, actual_pDeviceObject: int)
{
  ...
  anon15_Else:
    ...
    call {:si_unique_call 341} sdv_IoSetCompletionRoutine(vslice_dummy_var_484, li2bplFunctionConstant134, Event_4, 1, 1, 1);
    goto L26;
  ...
  L26:
    ...
    call {:si_unique_call 342} status_5 := sdv_IoCallDriver#1(vslice_dummy_var_485, vslice_dummy_var_486);
    goto anon16_Then, anon16_Else;
  ...
  anon15_Then:
    ...
    call {:si_unique_call 345} sdv_IoSetCompletionRoutine(vslice_dummy_var_487, li2bplFunctionConstant199, pDeviceObject, 1, 1, 1);
    goto L26;
...
implementation {:origName "PpaGetDeviceInfo"} PpaGetDeviceInfo(actual_Extension_29: int) returns (Tmp_370: int)
{
  ...
  anon7_Else:
    assume {:partition} BAND(Mem_T.DeviceFlags__DEVICE_EXTENSION[DeviceFlags__DEVICE_EXTENSION(Extension_29)], 16) != 0;
    Tmp_370 := 0;
    goto L1;
  ...
  anon8_Else:
    ...
    call {:si_unique_call 378} Status_18 := sdv_IoCallDriver#1(vslice_dummy_var_488, Irp_5);
    goto anon9_Then, anon9_Else;
...
implementation {:origName "PpaCloseToParclass"} PpaCloseToParclass(actual_Extension_30: int) returns (Tmp_372: int)
{
  ...
  anon5_Else:
    ...
    call {:si_unique_call 385} Status_19 := sdv_IoCallDriver#1(vslice_dummy_var_489, Irp_6);
    goto anon6_Then, anon6_Else;
...
implementation {:origName "PpaCreateToParclass"} PpaCreateToParclass(actual_Extension_33: int) returns (Tmp_386: int)
{
  ...
  anon5_Else:
    ...
    call {:si_unique_call 408} Status_21 := sdv_IoCallDriver#1(vslice_dummy_var_490, Irp_7);
    goto anon6_Then, anon6_Else;
...
implementation {:origName "PpaPortUnlockCompletionRoutine"} PpaPortUnlockCompletionRoutine(actual_pDeviceObject_2: int, actual_Irp_9: int, actual_ContextIn: int) returns (Tmp_403: int)
{
  ...
  anon0:
    ...
    assume Context_4 > 0;
    Extension_36 := Mem_T.DeviceExtension__DEVICE_OBJECT[DeviceExtension__DEVICE_OBJECT(Context_4)];
...
procedure {:origName "PpaPnpDeviceControl"} PpaPnpDeviceControl(actual_pDeviceObject_4: int, actual_pIrp_2: int) returns (Tmp_431: int);
  modifies alloc, Mem_T.DeviceFlags__DEVICE_EXTENSION, Mem_T.Status__IO_STATUS_BLOCK, sdv_IoBuildSynchronousFsdRequest_IoStatusBlock, sdv_IoBuildDeviceIoControlRequest_IoStatusBlock;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);
...
implementation {:origName "PpaPnpDeviceControl"} PpaPnpDeviceControl(actual_pDeviceObject_4: int, actual_pIrp_2: int) returns (Tmp_431: int)
{
  ...
  anon0:
    ...
    Extension_40 := Mem_T.DeviceExtension__DEVICE_OBJECT[DeviceExtension__DEVICE_OBJECT(pDeviceObject_4)];
    gotRemoveLock := 0;
  ...
  anon89_Else:
    ...
    Mem_T.DeviceFlags__DEVICE_EXTENSION[DeviceFlags__DEVICE_EXTENSION(Extension_40)] := BOR(Mem_T.DeviceFlags__DEVICE_EXTENSION[DeviceFlags__DEVICE_EXTENSION(Extension_40)], BOR(16, 32));
    ...
    call {:si_unique_call 460} Status_25 := sdv_IoCallDriver#1(vslice_dummy_var_491, pIrp_2);
    goto L66;
  ...
  L21:
    ...
    call {:si_unique_call 462} Status_25 := sdv_IoCallDriver#1(vslice_dummy_var_492, pIrp_2);
    goto L66;
  ...
  anon93_Then:
    ...
    call {:si_unique_call 464} Status_25 := sdv_IoCallDriver#1(vslice_dummy_var_493, pIrp_2);
    goto L66;
  ...
  anon95_Then:
    ...
    call {:si_unique_call 467} Status_25 := sdv_IoCallDriver#1(vslice_dummy_var_494, pIrp_2);
  ...
  anon108_Else:
    ...
    assume {:nonnull} Extension_40 != 0;
    assume Extension_40 > 0;
    Mem_T.DeviceFlags__DEVICE_EXTENSION[DeviceFlags__DEVICE_EXTENSION(Extension_40)] := BAND(Mem_T.DeviceFlags__DEVICE_EXTENSION[DeviceFlags__DEVICE_EXTENSION(Extension_40)], BNOT(BOR(2, 4)));
  ...
  anon96_Then:
    ...
    call {:si_unique_call 475} Status_25 := sdv_IoCallDriver#1(vslice_dummy_var_495, pIrp_2);
  ...
  anon107_Else:
    ...
    assume {:nonnull} Extension_40 != 0;
    assume Extension_40 > 0;
    Mem_T.DeviceFlags__DEVICE_EXTENSION[DeviceFlags__DEVICE_EXTENSION(Extension_40)] := BOR(Mem_T.DeviceFlags__DEVICE_EXTENSION[DeviceFlags__DEVICE_EXTENSION(Extension_40)], BOR(2, 4));
  ...
  anon97_Then:
    ...
    call {:si_unique_call 483} Status_25 := sdv_IoCallDriver#1(vslice_dummy_var_496, pIrp_2);
  ...
  anon106_Else:
    ...
    assume {:nonnull} Extension_40 != 0;
    assume Extension_40 > 0;
    Mem_T.DeviceFlags__DEVICE_EXTENSION[DeviceFlags__DEVICE_EXTENSION(Extension_40)] := BOR(Mem_T.DeviceFlags__DEVICE_EXTENSION[DeviceFlags__DEVICE_EXTENSION(Extension_40)], 2);
  ...
  anon98_Then:
    ...
    call {:si_unique_call 490} Status_25 := sdv_IoCallDriver#1(vslice_dummy_var_497, pIrp_2);
  ...
  anon77_Else:
    ...
    assume {:nonnull} Extension_40 != 0;
    assume Extension_40 > 0;
    Mem_T.DeviceFlags__DEVICE_EXTENSION[DeviceFlags__DEVICE_EXTENSION(Extension_40)] := BAND(Mem_T.DeviceFlags__DEVICE_EXTENSION[DeviceFlags__DEVICE_EXTENSION(Extension_40)], BNOT(16));
  ...
  anon81_Else:
    assume {:partition} BAND(Mem_T.DeviceFlags__DEVICE_EXTENSION[DeviceFlags__DEVICE_EXTENSION(Extension_40)], 8) != 0;
  ...
  anon82_Else:
    ...
    assume {:nonnull} Extension_40 != 0;
    assume Extension_40 > 0;
    Mem_T.DeviceFlags__DEVICE_EXTENSION[DeviceFlags__DEVICE_EXTENSION(Extension_40)] := BAND(Mem_T.DeviceFlags__DEVICE_EXTENSION[DeviceFlags__DEVICE_EXTENSION(Extension_40)], BNOT(8));
    ...
    call {:si_unique_call 506} Status_25 := sdv_IoCallDriver#1(vslice_dummy_var_498, pIrp_2);
  ...
  anon103_Then:
    ...
    assume {:nonnull} Extension_40 != 0;
    assume Extension_40 > 0;
    Mem_T.DeviceFlags__DEVICE_EXTENSION[DeviceFlags__DEVICE_EXTENSION(Extension_40)] := BOR(Mem_T.DeviceFlags__DEVICE_EXTENSION[DeviceFlags__DEVICE_EXTENSION(Extension_40)], 16);
  ...
  anon86_Else:
    ...
    call {:si_unique_call 523} Status_25 := sdv_IoCallDriver#1(vslice_dummy_var_499, pIrp_2);
  ...
  anon73_Then:
    ...
    call {:si_unique_call 531} Status_25 := sdv_IoCallDriver#1(vslice_dummy_var_500, pIrp_2);
...
procedure {:origName "PpaStartDevice"} PpaStartDevice(actual_pDeviceObject_5: int) returns (Tmp_452: int);
  modifies Mem_T.DeviceFlags__DEVICE_EXTENSION, alloc, Mem_T.Status__IO_STATUS_BLOCK, sdv_IoBuildDeviceIoControlRequest_IoStatusBlock, sdv_IoBuildSynchronousFsdRequest_IoStatusBlock;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);
...
implementation {:origName "PpaStartDevice"} PpaStartDevice(actual_pDeviceObject_5: int) returns (Tmp_452: int)
{
  ...
  anon0:
    ...
    Extension_41 := Mem_T.DeviceExtension__DEVICE_OBJECT[DeviceExtension__DEVICE_OBJECT(pDeviceObject_5)];
    assume {:nonnull} Extension_41 != 0;
    assume Extension_41 > 0;
    Mem_T.DeviceFlags__DEVICE_EXTENSION[DeviceFlags__DEVICE_EXTENSION(Extension_41)] := BOR(Mem_T.DeviceFlags__DEVICE_EXTENSION[DeviceFlags__DEVICE_EXTENSION(Extension_41)], BOR(1, 2));
  ...
  anon20_Then:
    ...
    assume {:nonnull} Extension_41 != 0;
    assume Extension_41 > 0;
    Mem_T.DeviceFlags__DEVICE_EXTENSION[DeviceFlags__DEVICE_EXTENSION(Extension_41)] := BAND(Mem_T.DeviceFlags__DEVICE_EXTENSION[DeviceFlags__DEVICE_EXTENSION(Extension_41)], BNOT(BOR(1, 2)));
    goto L43;
...
implementation {:origName "PpaInitializeUnlockIrp"} PpaInitializeUnlockIrp(actual_Extension_42: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 555} IoReuseIrp(vslice_dummy_var_501, 0);
    assume {:nonnull} Extension_42 != 0;
    assume Extension_42 > 0;
    havoc vslice_dummy_var_502;
    call {:si_unique_call 556} pNextIrpStack := sdv_IoGetNextIrpStackLocation(vslice_dummy_var_502);
    assume {:nonnull} Extension_42 != 0;
    assume Extension_42 > 0;
...
procedure {:origName "PpaInitializeExtension"} PpaInitializeExtension(actual_Extension_43: int) returns (Tmp_456: int);
  modifies alloc, Mem_T.Status__IO_STATUS_BLOCK, sdv_IoBuildSynchronousFsdRequest_IoStatusBlock, Mem_T.DeviceFlags__DEVICE_EXTENSION;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);
...
implementation {:origName "PpaInitializeExtension"} PpaInitializeExtension(actual_Extension_43: int) returns (Tmp_456: int)
{
  ...
  anon36_Else:
    assume {:partition} BAND(Mem_T.DeviceFlags__DEVICE_EXTENSION[DeviceFlags__DEVICE_EXTENSION(Extension_43)], 16) != 0;
    Tmp_456 := 0;
    goto L1;
  ...
  anon27_Else:
    ...
    assume {:nonnull} Extension_43 != 0;
    assume Extension_43 > 0;
    Mem_T.DeviceFlags__DEVICE_EXTENSION[DeviceFlags__DEVICE_EXTENSION(Extension_43)] := BOR(Mem_T.DeviceFlags__DEVICE_EXTENSION[DeviceFlags__DEVICE_EXTENSION(Extension_43)], 8);
  ...
  anon28_Else:
    assume {:partition} BAND(Mem_T.DeviceFlags__DEVICE_EXTENSION[DeviceFlags__DEVICE_EXTENSION(Extension_43)], 1) != 0;
    assume {:nonnull} Extension_43 != 0;
    assume Extension_43 > 0;
  ...
  anon29_Else:
    ...
    call {:si_unique_call 564} boogieTmp := IoAllocateIrp(vslice_dummy_var_503, 0);
    assume {:nonnull} Extension_43 != 0;
    assume Extension_43 > 0;
    goto anon30_Then, anon30_Else;
  ...
  anon30_Else:
    ...
    call {:si_unique_call 565} boogieTmp := IoAllocateIrp(vslice_dummy_var_504, 0);
    assume {:nonnull} Extension_43 != 0;
    assume Extension_43 > 0;
    goto anon31_Then, anon31_Else;
...
implementation {:origName "PpaCleanExtension"} PpaCleanExtension(actual_pDeviceObject_7: int, actual_DeviceRemoved: int)
{
  ...
  anon0:
    ...
    Extension_44 := Mem_T.DeviceExtension__DEVICE_OBJECT[DeviceExtension__DEVICE_OBJECT(pDeviceObject_7)];
  ...
  anon22_Else:
    assume {:partition} BAND(Mem_T.DeviceFlags__DEVICE_EXTENSION[DeviceFlags__DEVICE_EXTENSION(Extension_44)], 8) != 0;
  ...
  anon24_Else:
    ...
    assume {:nonnull} Extension_44 != 0;
    assume Extension_44 > 0;
    Mem_T.DeviceFlags__DEVICE_EXTENSION[DeviceFlags__DEVICE_EXTENSION(Extension_44)] := BAND(Mem_T.DeviceFlags__DEVICE_EXTENSION[DeviceFlags__DEVICE_EXTENSION(Extension_44)], BNOT(8));
...
implementation {:origName "PpaInitializeLockIrp"} PpaInitializeLockIrp(actual_Extension_45: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 594} IoReuseIrp(vslice_dummy_var_505, 0);
    assume {:nonnull} Extension_45 != 0;
    assume Extension_45 > 0;
    havoc vslice_dummy_var_506;
    call {:si_unique_call 595} pNextIrpStack_1 := sdv_IoGetNextIrpStackLocation(vslice_dummy_var_506);
    assume {:nonnull} Extension_45 != 0;
    assume Extension_45 > 0;
...
implementation {:origName "PpaCreateDevObject"} PpaCreateDevObject(actual_pDriverObject_2: int, actual_pPhysicalDeviceObject_1: int) returns (Tmp_466: int)
{
  ...
  L24:
    assume {:nonnull} Extension_46 != 0;
    assume Extension_46 > 0;
    Mem_T.DeviceFlags__DEVICE_EXTENSION[DeviceFlags__DEVICE_EXTENSION(Extension_46)] := 2;
...
const {:string "Remove Device Irp is not supported."} unique strConst__li2bpl14: int;
...
implementation {:origName "PpaPortLockCompletionRoutine"} PpaPortLockCompletionRoutine#0(actual_pDeviceObject_3: int, actual_Irp_10: int, actual_ContextIn_1: int) returns (Tmp_406: int)
{
  ...
  anon0:
    ...
    assume Context_5 > 0;
    Extension_37 := Mem_T.DeviceExtension__DEVICE_OBJECT[DeviceExtension__DEVICE_OBJECT(Context_5)];
  ...
  L10:
    ...
    call {:si_unique_call 608} PpaCompleteRequest(Extension_37, vslice_dummy_var_507, status_9);
...
implementation {:origName "PpaPortLockCompletionRoutine"} PpaPortLockCompletionRoutine#1(actual_pDeviceObject_3: int, actual_Irp_10: int, actual_ContextIn_1: int) returns (Tmp_406: int)
{
  ...
  L10:
    ...
    call {:si_unique_call 617} PpaCompleteRequest(Extension_37, vslice_dummy_var_508, status_9);
...
implementation {:origName "PpaPortUnlock"} PpaPortUnlock#0(actual_Extension_21: int, actual_Wait_2: int, actual_pDeviceObject_1: int)
{
  ...
  anon12_Else:
    ...
    call {:si_unique_call 630} sdv_IoSetCompletionRoutine(vslice_dummy_var_509, li2bplFunctionConstant134, Event_5, 1, 1, 1);
    goto L20;
  ...
  L20:
    ...
    call {:si_unique_call 631} status_6 := sdv_IoCallDriver#0(vslice_dummy_var_510, vslice_dummy_var_511);
    goto anon13_Then, anon13_Else;
  ...
  anon12_Then:
    ...
    call {:si_unique_call 633} sdv_IoSetCompletionRoutine(vslice_dummy_var_512, li2bplFunctionConstant200, pDeviceObject_1, 1, 1, 1);
    goto L20;
...
implementation {:origName "PpaPortUnlock"} PpaPortUnlock#1(actual_Extension_21: int, actual_Wait_2: int, actual_pDeviceObject_1: int)
{
  ...
  anon12_Else:
    ...
    call {:si_unique_call 638} sdv_IoSetCompletionRoutine(vslice_dummy_var_513, li2bplFunctionConstant134, Event_5, 1, 1, 1);
    goto L20;
  ...
  L20:
    ...
    call {:si_unique_call 639} status_6 := sdv_IoCallDriver#1(vslice_dummy_var_514, vslice_dummy_var_515);
    goto anon13_Then, anon13_Else;
  ...
  anon12_Then:
    ...
    call {:si_unique_call 641} sdv_IoSetCompletionRoutine(vslice_dummy_var_516, li2bplFunctionConstant200, pDeviceObject_1, 1, 1, 1);
    goto L20;
...
implementation {:origName "IofCallDriver"} {:osmodel} IofCallDriver#0(actual_DeviceObject_6: int, actual_Irp_2: int) returns (Tmp_279: int)
{
  ...
  anon47_Then:
    ...
    call {:si_unique_call 645} vslice_dummy_var_105 := sdv_RunIoCompletionRoutines#0(sdv_p_devobj_fdo, Irp_2, vslice_dummy_var_517, completion);
    goto L29;
  ...
  anon59_Else:
    ...
    call {:si_unique_call 646} vslice_dummy_var_108 := sdv_RunIoCompletionRoutines#0(sdv_p_devobj_fdo, Irp_2, vslice_dummy_var_518, completion);
    goto L29;
  ...
  anon51_Else:
    ...
    call {:si_unique_call 647} vslice_dummy_var_106 := sdv_RunIoCompletionRoutines#0(sdv_p_devobj_fdo, Irp_2, vslice_dummy_var_519, completion);
    goto L29;
  ...
  anon55_Else:
    ...
    call {:si_unique_call 648} vslice_dummy_var_107 := sdv_RunIoCompletionRoutines#0(sdv_p_devobj_fdo, Irp_2, vslice_dummy_var_520, completion);
    goto L29;
...
implementation {:origName "IofCallDriver"} {:osmodel} IofCallDriver#1(actual_DeviceObject_6: int, actual_Irp_2: int) returns (Tmp_279: int)
{
  ...
  anon47_Then:
    ...
    call {:si_unique_call 650} vslice_dummy_var_109 := sdv_RunIoCompletionRoutines#1(sdv_p_devobj_fdo, Irp_2, vslice_dummy_var_521, completion);
    goto L29;
  ...
  anon59_Else:
    ...
    call {:si_unique_call 651} vslice_dummy_var_112 := sdv_RunIoCompletionRoutines#1(sdv_p_devobj_fdo, Irp_2, vslice_dummy_var_522, completion);
    goto L29;
  ...
  anon51_Else:
    ...
    call {:si_unique_call 652} vslice_dummy_var_110 := sdv_RunIoCompletionRoutines#1(sdv_p_devobj_fdo, Irp_2, vslice_dummy_var_523, completion);
    goto L29;
  ...
  anon55_Else:
    ...
    call {:si_unique_call 653} vslice_dummy_var_111 := sdv_RunIoCompletionRoutines#1(sdv_p_devobj_fdo, Irp_2, vslice_dummy_var_524, completion);
    goto L29;
...
implementation VPI1DataIn_loop_L16(in_ChunkSize: int, in_sdv_19: int, in_Status_3: int, in_sdv_22: int, in_BytesRead: int, in_Extension_3: int) returns (out_ChunkSize: int, out_sdv_19: int, out_Status_3: int, out_sdv_22: int)
{
  ...
  anon46_Else:
    ...
    call {:si_unique_call 679} out_sdv_19 := VPI1GetPhase(in_Extension_3, vslice_dummy_var_526);
    goto anon48_Else;
  ...
  anon65_Else:
    ...
    call {:si_unique_call 678} out_Status_3 := VPI1ParallelRead(in_Extension_3, vslice_dummy_var_525, out_ChunkSize, in_BytesRead);
    assume {:nonnull} in_Extension_3 != 0;
    assume in_Extension_3 > 0;
    goto anon55_Then, anon55_Else;
...
implementation VPI1DataOut_loop_L13(in_ChunkSize_1: int, in_sdv_38: int, in_Status_5: int, in_BytesWritten: int, in_Extension_7: int) returns (out_ChunkSize_1: int, out_sdv_38: int, out_Status_5: int)
{
  ...
  anon28_Else:
    ...
    call {:si_unique_call 687} out_sdv_38 := VPI1GetPhase(in_Extension_7, vslice_dummy_var_528);
    goto anon29_Else;
  ...
  L34:
    ...
    call {:si_unique_call 686} out_Status_5 := VPI1ParallelWrite(in_Extension_7, vslice_dummy_var_527, out_ChunkSize_1, in_BytesWritten);
    assume {:nonnull} in_Extension_7 != 0;
    assume in_Extension_7 > 0;
    goto anon34_Then, anon34_Else;
...
implementation VPI1Command_loop_L10(in_i_3: int, in_Tmp_85: int, in_Tmp_87: int, in_Tmp_88: int, in_success_3: int, in_sdv_43: int, in_Status_7: int, in_BytesWritten_1: int, in_Tmp_89: int, in_Tmp_90: int, in_Extension_9: int) returns (out_i_3: int, out_Tmp_85: int, out_Tmp_87: int, out_Tmp_88: int, out_success_3: int, out_sdv_43: int, out_Status_7: int, out_Tmp_89: int, out_Tmp_90: int)
{
  ...
  anon27_Else:
    ...
    call {:si_unique_call 690} out_sdv_43 := VPI1GetPhase(in_Extension_9, vslice_dummy_var_529);
    goto anon19_Else;
