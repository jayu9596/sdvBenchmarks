...
implementation {:origName "Serenum_FDO_Power"} Serenum_FDO_Power(actual_Data: int, actual_Irp_2: int) returns (Tmp_7: int)
{
  ...
  anon28_Else:
    ...
    call {:si_unique_call 24} sdv_IoSetCompletionRoutine(Irp_2, li2bplFunctionConstant317, 0, 1, 1, 1);
...
implementation {:origName "Serenum_Power"} Serenum_Power(actual_DeviceObject_1: int, actual_Irp_3: int) returns (Tmp_9: int)
{
  ...
  anon5_Else:
    ...
    call {:si_unique_call 34} status_2 := Serenum_FDO_Power(vslice_dummy_var_65, Irp_3);
  ...
  anon5_Then:
    ...
    call {:si_unique_call 35} status_2 := Serenum_PDO_Power(vslice_dummy_var_66, Irp_3);
    goto L20;
}
...
implementation {:origName "sdv_main"} {:osmodel} sdv_main()
{
  ...
  anon0:
    ...
    call {:si_unique_call 48} vslice_dummy_var_12 := sdv_RunDispatchFunction(sdv_p_devobj_fdo, sdv_irp);
    goto anon3_Then, anon3_Else;
...
implementation {:origName "PoCallDriver"} {:osmodel} PoCallDriver(actual_DeviceObject_3: int, actual_Irp_4: int) returns (Tmp_39: int)
{
  ...
  anon0:
    call {:si_unique_call 49} completion := __HAVOC_malloc(4);
    Irp_4 := actual_Irp_4;
  ...
  L29:
    Tmp_39 := status_3;
    call {:si_unique_call 50} SLIC_PoCallDriver_exit(0, Irp_4);
    goto LM2;
  ...
  anon64_Then:
    ...
    call {:si_unique_call 51} sdv_22 := sdv_RunIoCompletionRoutines(sdv_p_devobj_fdo, Irp_4, vslice_dummy_var_67, completion);
    goto anon81_Then, anon81_Else;

  anon81_Else:
    assume Irp_4 == SLAM_guard_S_0;
    assume SLAM_guard_S_0 != SLAM_guard_S_0_init;
    call {:si_unique_call 52} SLIC_sdv_RunIoCompletionRoutines_exit(strConst__li2bpl0, completion, sdv_22);
  ...
  anon76_Else:
    ...
    call {:si_unique_call 53} sdv_25 := sdv_RunIoCompletionRoutines(sdv_p_devobj_fdo, Irp_4, vslice_dummy_var_68, completion);
    goto anon82_Then, anon82_Else;

  anon82_Else:
    assume Irp_4 == SLAM_guard_S_0;
    assume SLAM_guard_S_0 != SLAM_guard_S_0_init;
    call {:si_unique_call 54} SLIC_sdv_RunIoCompletionRoutines_exit(strConst__li2bpl0, completion, sdv_25);
  ...
  anon68_Else:
    ...
    call {:si_unique_call 55} sdv_23 := sdv_RunIoCompletionRoutines(sdv_p_devobj_fdo, Irp_4, vslice_dummy_var_69, completion);
    goto anon80_Then, anon80_Else;

  anon80_Else:
    assume Irp_4 == SLAM_guard_S_0;
    assume SLAM_guard_S_0 != SLAM_guard_S_0_init;
    call {:si_unique_call 56} SLIC_sdv_RunIoCompletionRoutines_exit(strConst__li2bpl0, completion, sdv_23);
  ...
  anon72_Else:
    ...
    call {:si_unique_call 57} sdv_24 := sdv_RunIoCompletionRoutines(sdv_p_devobj_fdo, Irp_4, vslice_dummy_var_70, completion);
    goto anon79_Then, anon79_Else;

  anon79_Else:
    assume Irp_4 == SLAM_guard_S_0;
    assume SLAM_guard_S_0 != SLAM_guard_S_0_init;
    call {:si_unique_call 58} SLIC_sdv_RunIoCompletionRoutines_exit(strConst__li2bpl0, completion, sdv_24);
...
implementation {:origName "main"} {:osmodel} main() returns (Tmp_64: int, dup_assertVar: bool)
{
  ...
  anon0:
    ...
    call {:si_unique_call 147} sdv_other_harnessStackLocation_next__Loc := __HAVOC_malloc_or_null(536);
    assume sdv_other_harnessStackLocation_next__Loc == sdv_other_harnessStackLocation_next;
    assume sdv_other_harnessStackLocation_next != 0;
    call {:si_unique_call 148} sdv_harnessStackLocation__Loc := __HAVOC_malloc_or_null(536);
...
implementation {:origName "sdv_RunDispatchFunction"} {:osmodel} sdv_RunDispatchFunction(actual_po: int, actual_pirp_9: int) returns (Tmp_84: int)
{
  ...
  anon104_Else:
    ...
    assume SLAM_guard_S_0 != SLAM_guard_S_0_init;
    call {:si_unique_call 199} SLIC_Serenum_PnP_exit(strConst__li2bpl0, status_4);
  ...
  L72:
    call {:si_unique_call 200} sdv_stub_dispatch_end(status_4, 0);
    assume {:nonnull} pirp_9 != 0;
    assume pirp_9 > 0;
    Tmp_84 := status_4;
    goto LM2;
  ...
  anon85_Then:
    assume {:nonnull} ps != 0;
    assume ps > 0;
    call {:si_unique_call 202} status_4 := sdv_DoNothing();
    goto L72;

  anon86_Then:
    assume {:nonnull} ps != 0;
    assume ps > 0;
    call {:si_unique_call 203} sdv_SetPowerIrpMinorFunction(pirp_9);
    call {:si_unique_call 204} status_4 := Serenum_Power(po, pirp_9);
  ...
  anon103_Else:
    assume pirp_9 == SLAM_guard_S_0;
    assume SLAM_guard_S_0 != SLAM_guard_S_0_init;
    call {:si_unique_call 205} SLIC_Serenum_Power_exit(strConst__li2bpl0, status_4);
  ...
  anon90_Then:
    assume {:nonnull} ps != 0;
    assume ps > 0;
    call {:si_unique_call 209} status_4 := Serenum_InternIoCtl(po, pirp_9);
  ...
  anon102_Else:
    assume pirp_9 == SLAM_guard_S_0;
    assume SLAM_guard_S_0 != SLAM_guard_S_0_init;
    call {:si_unique_call 210} SLIC_Serenum_InternIoCtl_exit(strConst__li2bpl0, status_4);
  ...
  anon91_Then:
    assume {:nonnull} ps != 0;
    assume ps > 0;
    call {:si_unique_call 211} status_4 := Serenum_IoCtl(po, pirp_9);
  ...
  anon101_Else:
    assume pirp_9 == SLAM_guard_S_0;
    assume SLAM_guard_S_0 != SLAM_guard_S_0_init;
    call {:si_unique_call 212} SLIC_Serenum_IoCtl_exit(strConst__li2bpl0, status_4);
  ...
  anon94_Then:
    assume {:nonnull} ps != 0;
    assume ps > 0;
    call {:si_unique_call 215} status_4 := sdv_DoNothing();
    goto L72;

  anon95_Then:
    assume {:nonnull} ps != 0;
    assume ps > 0;
    call {:si_unique_call 216} status_4 := sdv_DoNothing();
    goto L72;
  ...
  anon98_Then:
    assume {:nonnull} ps != 0;
    assume ps > 0;
    call {:si_unique_call 219} status_4 := Serenum_CreateClose(po, pirp_9);
  ...
  anon100_Else:
    assume pirp_9 == SLAM_guard_S_0;
    assume SLAM_guard_S_0 != SLAM_guard_S_0_init;
    call {:si_unique_call 220} SLIC_Serenum_CreateClose_exit(strConst__li2bpl0, status_4);
  ...
  anon79_Then:
    assume {:nonnull} ps != 0;
    assume ps > 0;
    call {:si_unique_call 221} status_4 := Serenum_CreateClose(po, pirp_9);
  ...
  anon99_Else:
    assume pirp_9 == SLAM_guard_S_0;
    assume SLAM_guard_S_0 != SLAM_guard_S_0_init;
    call {:si_unique_call 222} SLIC_Serenum_CreateClose_exit(strConst__li2bpl0, status_4);
...
implementation {:origName "RtlFreeUnicodeString"} {:osmodel} RtlFreeUnicodeString(actual_UnicodeString: int)
{
  ...
  anon0:
    call {:si_unique_call 223} vslice_dummy_var_23 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "sdv_KeReleaseSpinLock"} {:osmodel} sdv_KeReleaseSpinLock(actual_SpinLock_1: int, actual_new: int)
{
  ...
  anon0:
    call {:si_unique_call 224} vslice_dummy_var_24 := __HAVOC_malloc(4);
    new := actual_new;
    return;
}
...
implementation {:origName "sdv_IoCompleteRequest"} {:osmodel} sdv_IoCompleteRequest(actual_pirp_10: int, actual_PriorityBoost: int)
{
  ...
  anon0:
    call {:si_unique_call 225} vslice_dummy_var_25 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "sdv_RtlCopyMemory"} {:osmodel} sdv_RtlCopyMemory(actual_Destination_1: int, actual_Source: int, actual_Length_2: int)
{
  ...
  anon0:
    call {:si_unique_call 226} vslice_dummy_var_26 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "sdv_ExFreePool"} {:osmodel} sdv_ExFreePool(actual_P: int)
{
  ...
  anon0:
    call {:si_unique_call 227} vslice_dummy_var_27 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "IoAllocateIrp"} {:osmodel} IoAllocateIrp(actual_StackSize: int, actual_ChargeQuota: int) returns (Tmp_109: int)
{
  ...
  anon3_Else:
    assume {:nonnull} sdv_other_irp != 0;
    assume sdv_other_irp > 0;
    call {:si_unique_call 228} irpSp_1 := sdv_IoGetNextIrpStackLocation(sdv_other_irp);
...
implementation {:origName "IofCallDriver"} {:osmodel} IofCallDriver(actual_DeviceObject_7: int, actual_Irp_7: int) returns (Tmp_111: int)
{
  ...
  anon0:
    call {:si_unique_call 229} completion_1 := __HAVOC_malloc(4);
    Irp_7 := actual_Irp_7;
  ...
  anon63_Then:
    ...
    call {:si_unique_call 230} sdv_57 := sdv_RunIoCompletionRoutines(sdv_p_devobj_fdo, Irp_7, vslice_dummy_var_71, completion_1);
    goto anon80_Then, anon80_Else;

  anon80_Else:
    assume Irp_7 == SLAM_guard_S_0;
    assume SLAM_guard_S_0 != SLAM_guard_S_0_init;
    call {:si_unique_call 231} SLIC_sdv_RunIoCompletionRoutines_exit(strConst__li2bpl0, completion_1, sdv_57);
    goto anon88_Then, anon88_Else;
  ...
  anon75_Else:
    ...
    call {:si_unique_call 232} sdv_60 := sdv_RunIoCompletionRoutines(sdv_p_devobj_fdo, Irp_7, vslice_dummy_var_72, completion_1);
    goto anon81_Then, anon81_Else;

  anon81_Else:
    assume Irp_7 == SLAM_guard_S_0;
    assume SLAM_guard_S_0 != SLAM_guard_S_0_init;
    call {:si_unique_call 233} SLIC_sdv_RunIoCompletionRoutines_exit(strConst__li2bpl0, completion_1, sdv_60);
    goto anon90_Then, anon90_Else;
  ...
  anon67_Else:
    ...
    call {:si_unique_call 234} sdv_58 := sdv_RunIoCompletionRoutines(sdv_p_devobj_fdo, Irp_7, vslice_dummy_var_73, completion_1);
    goto anon79_Then, anon79_Else;

  anon79_Else:
    assume Irp_7 == SLAM_guard_S_0;
    assume SLAM_guard_S_0 != SLAM_guard_S_0_init;
    call {:si_unique_call 235} SLIC_sdv_RunIoCompletionRoutines_exit(strConst__li2bpl0, completion_1, sdv_58);
    goto anon86_Then, anon86_Else;
  ...
  anon71_Else:
    ...
    call {:si_unique_call 236} sdv_59 := sdv_RunIoCompletionRoutines(sdv_p_devobj_fdo, Irp_7, vslice_dummy_var_74, completion_1);
    goto anon78_Then, anon78_Else;

  anon78_Else:
    assume Irp_7 == SLAM_guard_S_0;
    assume SLAM_guard_S_0 != SLAM_guard_S_0_init;
    call {:si_unique_call 237} SLIC_sdv_RunIoCompletionRoutines_exit(strConst__li2bpl0, completion_1, sdv_59);
    goto anon84_Then, anon84_Else;
...
implementation {:origName "sdv_RunIoCompletionRoutines"} {:osmodel} sdv_RunIoCompletionRoutines(actual_DeviceObject_8: int, actual_Irp_8: int, actual_Context_3: int, actual_Completion: int) returns (Tmp_115: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 238} irpsp := sdv_IoGetNextIrpStackLocation(Irp_8);
    Status := 0;
    assume {:nonnull} irpsp != 0;
    assume irpsp > 0;
    goto anon9_Then, anon9_Else;
  ...
  anon9_Else:
    ...
    call {:si_unique_call 239} Status := SerenumSyncCompletion(DeviceObject_8, Irp_8, Context_3);
    assume {:nonnull} Completion != 0;
    assume Completion > 0;
    goto L11;
  ...
  anon7_Else:
    ...
    call {:si_unique_call 240} Status := Serenum_EnumComplete(DeviceObject_8, Irp_8, Context_3);
    assume {:nonnull} Completion != 0;
    assume Completion > 0;
    goto L28;
  ...
  anon8_Else:
    ...
    call {:si_unique_call 241} Status := Serenum_FDOPowerComplete(DeviceObject_8, Irp_8, Context_3);
    assume {:nonnull} Completion != 0;
    assume Completion > 0;
    goto L45;
...
implementation {:origName "KeInitializeEvent"} {:osmodel} KeInitializeEvent(actual_Event_2: int, actual_Type_2: int, actual_State_1: int)
{
  ...
  anon0:
    call {:si_unique_call 242} vslice_dummy_var_28 := __HAVOC_malloc(4);
...
implementation {:origName "KeInitializeTimer"} {:osmodel} KeInitializeTimer(actual_Timer_1: int)
{
  ...
  anon0:
    call {:si_unique_call 243} vslice_dummy_var_29 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "sdv_IoCallDriver"} {:osmodel} sdv_IoCallDriver(actual_DeviceObject_9: int, actual_Irp_9: int) returns (Tmp_121: int)
{
  ...
  anon0:
    Irp_9 := actual_Irp_9;
    call {:si_unique_call 244} Tmp_121 := IofCallDriver(0, Irp_9);
    goto anon3_Then, anon3_Else;

  anon3_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 245} SLIC_sdv_IoCallDriver_exit(0, Irp_9);
    goto LM2;
...
implementation {:origName "ExAllocatePoolWithTag"} {:osmodel} ExAllocatePoolWithTag(actual_PoolType: int, actual_NumberOfBytes: int, actual_Tag: int) returns (Tmp_134: int)
{
  ...
  anon3_Else:
    call {:si_unique_call 248} sdv_70 := __HAVOC_malloc(NumberOfBytes);
    Tmp_134 := sdv_70;
    goto L1;
...
implementation {:origName "IoAllocateWorkItem"} {:osmodel} IoAllocateWorkItem(actual_DeviceObject_12: int) returns (Tmp_136: int)
{
  ...
  anon0:
    call {:si_unique_call 249} sdv_72 := __HAVOC_malloc(1);
    ioWorkItem := sdv_72;
    goto anon6_Then, anon6_Else;
...
implementation {:origName "KeClearEvent"} {:osmodel} KeClearEvent(actual_Event_4: int)
{
  ...
  anon0:
    call {:si_unique_call 252} vslice_dummy_var_34 := __HAVOC_malloc(4);
...
implementation {:origName "_sdv_init7"} _sdv_init7()
{
  ...
  anon0:
    call {:si_unique_call 253} vslice_dummy_var_35 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "SLIC_Serenum_IoCtl_exit"} {:osmodel} SLIC_Serenum_IoCtl_exit(actual_caller: int, actual_Serenum: int)
{
  ...
  L6:
    call {:si_unique_call 254} SLIC_EXIT_ROUTINE(strConst__li2bpl1);
    goto L2;
  ...
  anon8_Then:
    assume {:partition} Serenum != 259;
    call {:si_unique_call 255} SLIC_ABORT_7_0(caller, Serenum);
    goto anon9_Then, anon9_Else;
...
procedure {:origName "SLIC_sdv_IoCompleteRequest_entry"} {:osmodel} SLIC_sdv_IoCompleteRequest_entry(actual_caller_3: int, actual_sdv_88: int);
  modifies completed;
...
implementation {:origName "SLIC_sdv_IoCompleteRequest_entry"} {:osmodel} SLIC_sdv_IoCompleteRequest_entry(actual_caller_3: int, actual_sdv_88: int)
{
  ...
  anon3_Else:
    call {:si_unique_call 257} SLIC_EXIT_ROUTINE(strConst__li2bpl1);
    goto L2;
...
implementation {:origName "SLIC_ABORT_3_0"} SLIC_ABORT_3_0(actual_caller_4: int, actual_Serenum_2: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 258} SLIC_ERROR_ROUTINE(strConst__li2bpl2);
    return;
}
...
implementation {:origName "SLIC_Serenum_CreateClose_exit"} {:osmodel} SLIC_Serenum_CreateClose_exit(actual_caller_5: int, actual_Serenum_3: int)
{
  ...
  anon8_Then:
    assume {:partition} Serenum_3 != 259;
    call {:si_unique_call 260} SLIC_ABORT_9_0(caller_5, Serenum_3);
    goto anon9_Then, anon9_Else;
...
implementation {:origName "SLIC_PoCallDriver_exit"} {:osmodel} SLIC_PoCallDriver_exit(actual_caller_6: int, actual_PoCallDriver_1: int)
{
  ...
  anon3_Else:
    call {:si_unique_call 261} SLIC_EXIT_ROUTINE(strConst__li2bpl1);
    goto L2;
...
procedure {:origName "SLIC_sdv_RunIoCompletionRoutines_exit"} {:osmodel} SLIC_sdv_RunIoCompletionRoutines_exit(actual_caller_8: int, actual_sdv_89: int, actual_sdv_90: int);
  modifies yogi_error;
  free ensures {:va_keep} old(completed) == 0 ==> yogi_error == 0;
  free ensures {:va_keep} yogi_error == 1 || yogi_error == old(yogi_error);
  free ensures {:va_keep} old(yogi_error) == 0;
...
implementation {:origName "SLIC_sdv_RunIoCompletionRoutines_exit"} {:osmodel} SLIC_sdv_RunIoCompletionRoutines_exit(actual_caller_8: int, actual_sdv_89: int, actual_sdv_90: int)
{
  ...
  anon16_Else:
    assume {:partition} sdv_90 != -1073741802;
    goto anon15_Then, anon15_Else;
  ...
  L10:
    call {:si_unique_call 262} SLIC_ABORT_16_0(caller_8, sdv_89, sdv_90);
    goto anon21_Then, anon21_Else;
  ...
  anon16_Then:
    assume {:partition} sdv_90 == -1073741802;
    call {:si_unique_call 263} SLIC_EXIT_ROUTINE(strConst__li2bpl1);
    goto L2;
...
implementation {:origName "SLIC_Serenum_PnP_exit"} {:osmodel} SLIC_Serenum_PnP_exit(actual_caller_9: int, actual_Serenum_4: int)
{
  ...
  L6:
    call {:si_unique_call 265} SLIC_EXIT_ROUTINE(strConst__li2bpl1);
    goto L2;
  ...
  anon8_Then:
    assume {:partition} Serenum_4 != 259;
    call {:si_unique_call 266} SLIC_ABORT_1_0(caller_9, Serenum_4);
    goto anon9_Then, anon9_Else;
...
procedure {:origName "SLIC_sdv_IoCallDriver_exit"} {:osmodel} SLIC_sdv_IoCallDriver_exit(actual_caller_10: int, actual_sdv_91: int);
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} false || old(completed) == 0 || old(completed) == 1;
  free ensures {:va_keep} false || old(pended) == 0 || old(pended) == 1;
  free ensures {:va_keep} alloc >= old(alloc);
...
implementation {:origName "SLIC_sdv_IoCallDriver_exit"} {:osmodel} SLIC_sdv_IoCallDriver_exit(actual_caller_10: int, actual_sdv_91: int)
{
  ...
  anon3_Else:
    call {:si_unique_call 267} SLIC_EXIT_ROUTINE(strConst__li2bpl1);
    goto L2;
...
procedure {:origName "SLIC_ABORT_16_0"} SLIC_ABORT_16_0(actual_caller_11: int, actual_sdv_92: int, actual_sdv_93: int);
  modifies yogi_error;
  free ensures {:va_keep} old(completed) == 0 ==> yogi_error == 1;
  free ensures {:va_keep} old(completed) == 1 ==> yogi_error == 1;
  free ensures {:va_keep} old(pended) == 0 ==> yogi_error == 1;
...
implementation {:origName "SLIC_ABORT_16_0"} SLIC_ABORT_16_0(actual_caller_11: int, actual_sdv_92: int, actual_sdv_93: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 268} SLIC_ERROR_ROUTINE(strConst__li2bpl3);
    return;
}
...
implementation {:origName "SLIC_ABORT_7_0"} SLIC_ABORT_7_0(actual_caller_12: int, actual_Serenum_5: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 269} SLIC_ERROR_ROUTINE(strConst__li2bpl2);
    return;
}
...
implementation {:origName "SLIC_ABORT_1_0"} SLIC_ABORT_1_0(actual_caller_13: int, actual_Serenum_6: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 270} SLIC_ERROR_ROUTINE(strConst__li2bpl2);
    return;
}
...
implementation {:origName "SLIC_Serenum_InternIoCtl_exit"} {:osmodel} SLIC_Serenum_InternIoCtl_exit(actual_caller_15: int, actual_Serenum_7: int)
{
  ...
  L6:
    call {:si_unique_call 271} SLIC_EXIT_ROUTINE(strConst__li2bpl1);
    goto L2;
  ...
  anon8_Then:
    assume {:partition} Serenum_7 != 259;
    call {:si_unique_call 272} SLIC_ABORT_5_0(caller_15, Serenum_7);
    goto anon9_Then, anon9_Else;
...
implementation {:origName "SLIC_Serenum_Power_exit"} {:osmodel} SLIC_Serenum_Power_exit(actual_caller_16: int, actual_Serenum_8: int)
{
  ...
  L6:
    call {:si_unique_call 273} SLIC_EXIT_ROUTINE(strConst__li2bpl1);
    goto L2;
  ...
  anon8_Then:
    assume {:partition} Serenum_8 != 259;
    call {:si_unique_call 274} SLIC_ABORT_3_0(caller_16, Serenum_8);
    goto anon9_Then, anon9_Else;
...
implementation {:origName "SerenumCheckEnumerations"} SerenumCheckEnumerations(actual_PFdoData: int) returns (Tmp_165: int)
{
  ...
  anon0:
    call {:si_unique_call 276} sameDevice := __HAVOC_malloc(4);
  ...
  anon24_Else:
    call {:si_unique_call 277} Tmp_166 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_166 != 0;
    assume Tmp_166 > 0;
    call {:si_unique_call 278} sdv_KeAcquireSpinLock(0, Tmp_166);
    assume {:nonnull} Tmp_166 != 0;
    assume Tmp_166 > 0;
    havoc oldIrql;
    assume {:nonnull} PFdoData != 0;
  ...
  anon26_Else:
    ...
    assume Tmp_167 > 0;
    havoc Tmp_169;
    call {:si_unique_call 280} pIrp := IoAllocateIrp(Tmp_169, 0);
    goto anon21_Then, anon21_Else;

  anon21_Else:
    assume {:partition} pIrp != 0;
    call {:si_unique_call 281} sdv_IoSetNextIrpStackLocation(0);
    call {:si_unique_call 282} status_6 := Serenum_ReenumerateDevices(pIrp, PFdoData, sameDevice);
    goto anon27_Then, anon27_Else;
  ...
  anon22_Else:
    assume {:partition} pIrp != 0;
    call {:si_unique_call 283} IoFreeIrp(0);
    goto L41;

  L41:
    call {:si_unique_call 284} Tmp_166 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_166 != 0;
    assume Tmp_166 > 0;
    call {:si_unique_call 285} sdv_KeAcquireSpinLock(0, Tmp_166);
    assume {:nonnull} Tmp_166 != 0;
    assume Tmp_166 > 0;
    havoc oldIrql;
    goto anon23_Then, anon23_Else;
  ...
  anon20_Else:
    ...
    assume {:nonnull} PFdoData != 0;
    assume PFdoData > 0;
    call {:si_unique_call 287} sdv_KeReleaseSpinLock(0, oldIrql);
    status_6 := 0;
    goto L12;

  anon20_Then:
    call {:si_unique_call 288} sdv_KeReleaseSpinLock(0, oldIrql);
    status_6 := 0;
    goto L12;
  ...
  anon19_Then:
    assume {:nonnull} PFdoData != 0;
    assume PFdoData > 0;
    call {:si_unique_call 289} sdv_KeReleaseSpinLock(0, oldIrql);
    call {:si_unique_call 290} status_6 := SerenumStartProtocolThread(PFdoData);
    goto L12;
...
implementation {:origName "Serenum_FDO_PnP"} Serenum_FDO_PnP(actual_DeviceObject_14: int, actual_Irp_10: int, actual_IrpStack: int, actual_DeviceData: int) returns (Tmp_170: int)
{
  ...
  anon0:
    call {:si_unique_call 291} DebugLevelDefault := __HAVOC_malloc(4);
    call {:si_unique_call 292} event := __HAVOC_malloc(156);
    Irp_10 := actual_Irp_10;
    IrpStack := actual_IrpStack;
    DeviceData := actual_DeviceData;
    call {:si_unique_call 293} vslice_dummy_var_39 := __HAVOC_malloc(32);
    call {:si_unique_call 294} Tmp_176 := __HAVOC_malloc(4);
    QueryTable_1 := 0;
    assume {:nonnull} DebugLevelDefault != 0;
    assume DebugLevelDefault > 0;
    call {:si_unique_call 295} sdv_do_paged_code_check();
    call {:si_unique_call 296} status_7 := Serenum_IncIoCount(DeviceData);
    goto anon83_Then, anon83_Else;

  anon83_Else:
    assume {:partition} status_7 >= 0;
    call {:si_unique_call 297} vslice_dummy_var_36 := sdv_IoGetCurrentIrpStackLocation(Irp_10);
  ...
  anon99_Else:
    call {:si_unique_call 298} KeInitializeEvent(event, 0, 0);
    call {:si_unique_call 299} sdv_IoCopyCurrentIrpStackLocationToNext(Irp_10);
    call {:si_unique_call 300} sdv_IoSetCompletionRoutine(Irp_10, li2bplFunctionConstant482, event, 1, 1, 1);
    assume {:nonnull} DeviceData != 0;
    assume DeviceData > 0;
    havoc vslice_dummy_var_75;
    call {:si_unique_call 301} status_7 := sdv_IoCallDriver(vslice_dummy_var_75, Irp_10);
  ...
  anon88_Else:
    ...
    call {:si_unique_call 302} status_7 := KeWaitForSingleObject(0, 0, 0, 0, 0);
  ...
  anon106_Else:
    ...
    assume SLAM_guard_S_0 != SLAM_guard_S_0_init;
    call {:si_unique_call 303} SLIC_sdv_IoCompleteRequest_entry(0, Irp_10);
    goto L317;

  L317:
    call {:si_unique_call 304} sdv_IoCompleteRequest(0, 0);
    call {:si_unique_call 305} Serenum_DecIoCount(DeviceData);
    Tmp_170 := status_7;
    goto L1;
  ...
  anon89_Then:
    ...
    call {:si_unique_call 306} irpSp_2 := sdv_IoGetCurrentIrpStackLocation(Irp_10);
  ...
  L31:
    ...
    call {:si_unique_call 308} status_7 := sdv_IoCallDriver(vslice_dummy_var_76, Irp_10);
    goto anon115_Then, anon115_Else;
  ...
  anon87_Else:
    call {:si_unique_call 310} status_7 := SerenumCheckEnumerations(DeviceData);
    goto anon116_Then, anon116_Else;
  ...
  L91:
    ...
    assume DeviceData > 0;
    havoc length;
    call {:si_unique_call 311} sdv_116 := ExAllocatePoolWithTag(512, length, -311532205);
    relations := sdv_116;
    goto anon117_Then, anon117_Else;
  ...
  anon91_Else:
    ...
    assume Tmp_179 > 0;
    call {:si_unique_call 312} sdv_RtlCopyMemory(0, 0, Tmp_177);
    goto L100;
  ...
  anon118_Else:
    ...
    assume Tmp_176 > 0;
    call {:si_unique_call 313} vslice_dummy_var_41 := sdv_ObReferenceObject(0);
    goto L107;
  ...
  L113:
    ...
    call {:si_unique_call 316} status_7 := sdv_IoCallDriver(vslice_dummy_var_77, Irp_10);
  ...
  anon121_Else:
    assume Irp_10 == SLAM_guard_S_0;
    assume SLAM_guard_S_0 != SLAM_guard_S_0_init;
    call {:si_unique_call 318} SLIC_sdv_IoCompleteRequest_entry(0, Irp_10);
    goto L323;
  ...
  anon101_Then:
    ...
    call {:si_unique_call 322} status_7 := sdv_IoCallDriver(vslice_dummy_var_78, Irp_10);
    goto anon114_Then, anon114_Else;

  anon114_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 323} Serenum_DecIoCount(DeviceData);
    Tmp_170 := status_7;
    goto L1;
  ...
  anon112_Else:
    ...
    call {:si_unique_call 325} status_7 := sdv_IoCallDriver(vslice_dummy_var_79, Irp_10);
    goto anon113_Then, anon113_Else;
  ...
  anon93_Else:
    assume Irp_10 == SLAM_guard_S_0;
    assume SLAM_guard_S_0 != SLAM_guard_S_0_init;
    call {:si_unique_call 327} SLIC_sdv_IoCompleteRequest_entry(0, Irp_10);
    goto L320;
  ...
  anon103_Then:
    call {:si_unique_call 329} SerenumWaitForEnumThreadTerminate(DeviceData);
    assume {:nonnull} DeviceData != 0;
    assume DeviceData > 0;
    assume {:nonnull} Irp_10 != 0;
    assume Irp_10 > 0;
    call {:si_unique_call 330} sdv_IoSkipCurrentIrpStackLocation(Irp_10);
    assume {:nonnull} DeviceData != 0;
    assume DeviceData > 0;
    havoc vslice_dummy_var_80;
    call {:si_unique_call 331} status_7 := sdv_IoCallDriver(vslice_dummy_var_80, Irp_10);
    goto anon111_Then, anon111_Else;

  anon111_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 332} Serenum_DecIoCount(DeviceData);
    Tmp_170 := status_7;
    goto L1;
  ...
  anon104_Then:
    call {:si_unique_call 333} SerenumWaitForEnumThreadTerminate(DeviceData);
    assume {:nonnull} DeviceData != 0;
    assume DeviceData > 0;
    call {:si_unique_call 334} vslice_dummy_var_40 := IoSetDeviceInterfaceState(0, 0);
    assume {:nonnull} Irp_10 != 0;
    assume Irp_10 > 0;
    ...
    call {:si_unique_call 336} status_7 := sdv_IoCallDriver(vslice_dummy_var_81, Irp_10);
    goto anon110_Then, anon110_Else;

  anon110_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 337} Tmp_175 := __HAVOC_malloc(4);
    assume {:nonnull} DeviceData != 0;
    assume DeviceData > 0;
    assume {:nonnull} Tmp_175 != 0;
    assume Tmp_175 > 0;
    call {:si_unique_call 338} sdv_115 := sdv_InterlockedDecrement(Tmp_175);
    assume {:nonnull} DeviceData != 0;
    assume DeviceData > 0;
    assume {:nonnull} Tmp_175 != 0;
    assume Tmp_175 > 0;
    i := sdv_115;
    call {:si_unique_call 339} Tmp_175 := __HAVOC_malloc(4);
    assume {:nonnull} DeviceData != 0;
    assume DeviceData > 0;
    assume {:nonnull} Tmp_175 != 0;
    assume Tmp_175 > 0;
    call {:si_unique_call 340} sdv_117 := sdv_InterlockedDecrement(Tmp_175);
    assume {:nonnull} DeviceData != 0;
    assume DeviceData > 0;
    assume {:nonnull} Tmp_175 != 0;
    assume Tmp_175 > 0;
  ...
  anon94_Else:
    ...
    call {:si_unique_call 341} vslice_dummy_var_37 := KeWaitForSingleObject(0, 0, 0, 0, 0);
    goto L198;

  L198:
    call {:si_unique_call 342} IoDetachDevice(0);
    assume {:nonnull} DeviceData != 0;
    assume DeviceData > 0;
    call {:si_unique_call 343} sdv_ExFreePool(0);
    assume {:nonnull} DeviceData != 0;
    assume DeviceData > 0;
    goto anon95_Then, anon95_Else;
  ...
  anon95_Else:
    ...
    call {:si_unique_call 344} vslice_dummy_var_38 := Serenum_PnPRemove(vslice_dummy_var_82, vslice_dummy_var_83);
    assume {:nonnull} DeviceData != 0;
    assume DeviceData > 0;
    assume {:nonnull} DeviceData != 0;
    assume DeviceData > 0;
  ...
  L208:
    call {:si_unique_call 345} IoDeleteDevice(0);
    Tmp_170 := status_7;
    goto L1;
  ...
  anon105_Then:
    call {:si_unique_call 346} SerenumWaitForEnumThreadTerminate(DeviceData);
    assume {:nonnull} Irp_10 != 0;
    assume Irp_10 > 0;
    call {:si_unique_call 347} sdv_IoSkipCurrentIrpStackLocation(Irp_10);
    assume {:nonnull} DeviceData != 0;
    assume DeviceData > 0;
    havoc vslice_dummy_var_84;
    call {:si_unique_call 348} status_7 := sdv_IoCallDriver(vslice_dummy_var_84, Irp_10);
    goto anon109_Then, anon109_Else;

  anon109_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 349} Serenum_DecIoCount(DeviceData);
    Tmp_170 := status_7;
    goto L1;
  ...
  anon85_Then:
    call {:si_unique_call 350} KeInitializeEvent(event, 0, 0);
    call {:si_unique_call 351} sdv_IoCopyCurrentIrpStackLocationToNext(Irp_10);
    call {:si_unique_call 352} sdv_IoSetCompletionRoutine(Irp_10, li2bplFunctionConstant482, event, 1, 1, 1);
    assume {:nonnull} DeviceData != 0;
    assume DeviceData > 0;
    havoc vslice_dummy_var_85;
    call {:si_unique_call 353} status_7 := sdv_IoCallDriver(vslice_dummy_var_85, Irp_10);
    goto anon107_Then, anon107_Else;
  ...
  anon96_Else:
    assume {:partition} 259 == status_7;
    call {:si_unique_call 354} status_7 := KeWaitForSingleObject(0, 0, 0, 0, 0);
    assume {:nonnull} Irp_10 != 0;
    assume Irp_10 > 0;
    havoc status_7;
    goto L246;
  ...
  anon97_Else:
    assume {:partition} status_7 >= 0;
    call {:si_unique_call 355} sdv_118 := ExAllocatePoolWithTag(1, 56, -311532205);
    QueryTable_1 := sdv_118;
    goto anon108_Then, anon108_Else;

  anon108_Else:
    assume {:partition} QueryTable_1 != 0;
    call {:si_unique_call 356} sdv_RtlZeroMemory(0, 56);
    ...
    assume {:nonnull} QueryTable_1 != 0;
    assume QueryTable_1 > 0;
    call {:si_unique_call 357} sdv_101 := sdv_RtlQueryRegistryValues(1, 0, 0, 0, 0);
    goto anon98_Then, anon98_Else;
  ...
  L274:
    call {:si_unique_call 358} sdv_ExFreePool(0);
    goto L277;
  ...
  anon123_Else:
    assume Irp_10 == SLAM_guard_S_0;
    assume SLAM_guard_S_0 != SLAM_guard_S_0_init;
    call {:si_unique_call 359} SLIC_sdv_IoCompleteRequest_entry(0, Irp_10);
    goto L326;
...
implementation {:origName "SerenumMarkPdoRemoved"} SerenumMarkPdoRemoved(actual_PFdoData_1: int)
{
  ...
  anon0:
    call {:si_unique_call 361} vslice_dummy_var_42 := __HAVOC_malloc(4);
    PFdoData_1 := actual_PFdoData_1;
    call {:si_unique_call 362} Tmp_184 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_184 != 0;
    assume Tmp_184 > 0;
    call {:si_unique_call 363} sdv_KeAcquireSpinLock(0, Tmp_184);
    assume {:nonnull} Tmp_184 != 0;
    assume Tmp_184 > 0;
    havoc oldIrql_1;
    assume {:nonnull} PFdoData_1 != 0;
    assume PFdoData_1 > 0;
    call {:si_unique_call 364} sdv_KeReleaseSpinLock(0, oldIrql_1);
    return;
}
...
implementation {:origName "_sdv_init6"} _sdv_init6()
{
  ...
  anon0:
    call {:si_unique_call 365} vslice_dummy_var_43 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "Serenum_PnPRemove"} Serenum_PnPRemove(actual_Device: int, actual_PdoData_1: int) returns (Tmp_187: int)
{
  ...
  anon6_Else:
    assume {:nonnull} PdoData_1 != 0;
    assume PdoData_1 > 0;
    call {:si_unique_call 366} RtlFreeUnicodeString(0);
    call {:si_unique_call 367} RtlFreeUnicodeString(0);
    call {:si_unique_call 368} RtlFreeUnicodeString(0);
    call {:si_unique_call 369} IoDeleteDevice(0);
    Tmp_187 := 0;
    goto L1;
...
implementation {:origName "Serenum_PnP"} Serenum_PnP(actual_DeviceObject_15: int, actual_Irp_11: int) returns (Tmp_189: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 371} irpStack_1 := sdv_IoGetCurrentIrpStackLocation(Irp_11);
  ...
  anon11_Else:
    ...
    assume SLAM_guard_S_0 != SLAM_guard_S_0_init;
    call {:si_unique_call 372} SLIC_sdv_IoCompleteRequest_entry(0, Irp_11);
    goto L34;

  L34:
    call {:si_unique_call 373} sdv_IoCompleteRequest(0, 0);
    goto L23;
  ...
  anon9_Else:
    call {:si_unique_call 374} status_8 := Serenum_FDO_PnP(DeviceObject_15, Irp_11, irpStack_1, commonData_1);
    goto anon12_Then, anon12_Else;
  ...
  anon9_Then:
    call {:si_unique_call 375} status_8 := Serenum_PDO_PnP(DeviceObject_15, Irp_11, irpStack_1, commonData_1);
    goto L23;
}
...
implementation {:origName "Serenum_PDO_PnP"} Serenum_PDO_PnP(actual_DeviceObject_16: int, actual_Irp_12: int, actual_IrpStack_1: int, actual_DeviceData_1: int) returns (Tmp_191: int)
{
  ...
  anon0:
    call {:si_unique_call 376} keyname := __HAVOC_malloc(12);
    DeviceObject_16 := actual_DeviceObject_16;
    Irp_12 := actual_Irp_12;
    IrpStack_1 := actual_IrpStack_1;
    DeviceData_1 := actual_DeviceData_1;
    call {:si_unique_call 377} vslice_dummy_var_45 := __HAVOC_malloc(20);
    call {:si_unique_call 378} vslice_dummy_var_46 := __HAVOC_malloc(56);
    call {:si_unique_call 379} vslice_dummy_var_47 := __HAVOC_malloc(28);
    call {:si_unique_call 380} Tmp_209 := __HAVOC_malloc(4);
    returnBuffer := 0;
  ...
  anon125_Else:
    ...
    assume SLAM_guard_S_0 != SLAM_guard_S_0_init;
    call {:si_unique_call 382} SLIC_sdv_IoCompleteRequest_entry(0, Irp_12);
    goto L268;
  ...
  anon100_Then:
    call {:si_unique_call 384} sdv_126 := ExAllocatePoolWithTag(1, 24, -311532205);
    pBusInfo := sdv_126;
  ...
  anon117_Else:
    status_9 := 0;
    length_1 := 10;
    call {:si_unique_call 385} sdv_130 := ExAllocatePoolWithTag(1, length_1, -311532205);
  ...
  anon129_Else:
    ...
    havoc length_1;
    Tmp_210 := length_1 + 2;
    call {:si_unique_call 387} sdv_132 := ExAllocatePoolWithTag(1, Tmp_210, -311532205);
  ...
  anon130_Else:
    assume {:partition} returnBuffer != 0;
    Tmp_201 := length_1 + 2;
    call {:si_unique_call 388} sdv_RtlZeroMemory(0, Tmp_201);
    call {:si_unique_call 389} sdv_RtlCopyMemory(0, 0, length_1);
    goto L80;
  ...
  anon93_Else:
    ...
    assume DeviceData_1 > 0;
    havoc Tmp_200;
    call {:si_unique_call 390} sdv_134 := ExAllocatePoolWithTag(1, Tmp_200, -311532205);
  ...
  anon127_Else:
    ...
    assume DeviceData_1 > 0;
    havoc Tmp_205;
    call {:si_unique_call 391} sdv_RtlCopyMemory(0, 0, Tmp_205);
    assume {:nonnull} Irp_12 != 0;
    assume Irp_12 > 0;
    goto L48;
  ...
  anon94_Else:
    call {:si_unique_call 392} sdv_133 := ExAllocatePoolWithTag(1, 8, -311532205);
    pDevRel := sdv_133;
  ...
  anon126_Else:
    ...
    assume Tmp_209 > 0;
    call {:si_unique_call 393} vslice_dummy_var_50 := sdv_ObReferenceObject(0);
    status_9 := 0;
    assume {:nonnull} Irp_12 != 0;
    assume Irp_12 > 0;
    goto L48;
  ...
  anon115_Then:
    ...
    call {:si_unique_call 394} SerenumMarkPdoRemoved(vslice_dummy_var_86);
    assume {:nonnull} DeviceData_1 != 0;
    assume DeviceData_1 > 0;
    goto anon95_Then, anon95_Else;
  ...
  anon95_Then:
    call {:si_unique_call 395} status_9 := Serenum_PnPRemove(DeviceObject_16, DeviceData_1);
    goto L48;
  ...
  L160:
    call {:si_unique_call 396} status_9 := IoOpenDeviceRegistryKey(0, 1, 131072, 0);
    goto anon97_Then, anon97_Else;
  ...
  anon98_Else:
    call {:si_unique_call 397} RtlInitUnicodeString(keyname, 0);
    assume {:nonnull} keyname != 0;
    assume keyname > 0;
    assume {:nonnull} keyname != 0;
    assume keyname > 0;
    havoc Tmp_196;
    call {:si_unique_call 398} sdv_128 := ExAllocatePoolWithTag(1, Tmp_196, -311532205);
    assume {:nonnull} keyname != 0;
    assume keyname > 0;
    assume {:nonnull} keyname != 0;
    assume keyname > 0;
  ...
  anon123_Else:
    call {:si_unique_call 399} vslice_dummy_var_48 := corral_nondet();
    assume {:nonnull} DeviceData_1 != 0;
    assume DeviceData_1 > 0;
    havoc Tmp_197;
    assume {:nonnull} DeviceData_1 != 0;
    assume DeviceData_1 > 0;
    call {:si_unique_call 400} status_9 := ZwSetValueKey(0, 0, 0, 1, 0, Tmp_197);
  ...
  anon99_Else:
    call {:si_unique_call 402} RtlInitUnicodeString(keyname, 0);
    assume {:nonnull} keyname != 0;
    assume keyname > 0;
    assume {:nonnull} keyname != 0;
    assume keyname > 0;
    havoc Tmp_199;
    call {:si_unique_call 403} sdv_125 := ExAllocatePoolWithTag(1, Tmp_199, -311532205);
    assume {:nonnull} keyname != 0;
    assume keyname > 0;
    assume {:nonnull} keyname != 0;
    assume keyname > 0;
  ...
  anon124_Else:
    call {:si_unique_call 404} vslice_dummy_var_49 := corral_nondet();
    assume {:nonnull} DeviceData_1 != 0;
    assume DeviceData_1 > 0;
    havoc Tmp_193;
    assume {:nonnull} DeviceData_1 != 0;
    assume DeviceData_1 > 0;
    call {:si_unique_call 405} status_9 := ZwSetValueKey(0, 0, 0, 1, 0, Tmp_193);
    call {:si_unique_call 406} sdv_ExFreePool(0);
    goto L189;

  L189:
    call {:si_unique_call 407} vslice_dummy_var_44 := ZwClose(0);
    goto L213;
...
implementation {:origName "Serenum_StrLen"} Serenum_StrLen(actual_string: int) returns (Tmp_212: int)
{
  ...
  L7:
    call {:si_unique_call 408} i_1, Tmp_213 := Serenum_StrLen_loop_L7(i_1, Tmp_213, string);
    goto L7_last;
...
implementation {:origName "Serenum_GetDevDesc"} Serenum_GetDevDesc(actual_input: int, actual_output: int, actual_start: int)
{
  ...
  anon0:
    call {:si_unique_call 409} vslice_dummy_var_51 := __HAVOC_malloc(4);
    input := actual_input;
  ...
  L13:
    call {:si_unique_call 410} Tmp_219, c_1, Tmp_224, tail := Serenum_GetDevDesc_loop_L13(Tmp_219, c_1, Tmp_224, tail, input, output);
    goto L13_last;
...
implementation {:origName "Serenum_GetDevName"} Serenum_GetDevName(actual_input_1: int, actual_output_1: int, actual_start_1: int)
{
  ...
  anon0:
    call {:si_unique_call 411} vslice_dummy_var_52 := __HAVOC_malloc(4);
  ...
  anon14_Else:
    ...
    assume input_1 > 0;
    havoc c_2;
    call {:si_unique_call 412} sdv_139 := Serenum_HToI(c_2);
    goto anon15_Then, anon15_Else;
  ...
  L17:
    ...
    assume input_1 > 0;
    havoc c_2;
    call {:si_unique_call 413} sdv_140 := Serenum_HToI(c_2);
    goto anon16_Then, anon16_Else;
  ...
  L23:
    ...
    assume input_1 > 0;
    havoc c_2;
    call {:si_unique_call 414} sdv_141 := Serenum_HToI(c_2);
    goto anon17_Then, anon17_Else;
  ...
  L29:
    ...
    assume input_1 > 0;
    havoc c_2;
    call {:si_unique_call 415} sdv_142 := Serenum_HToI(c_2);
    goto anon18_Then, anon18_Else;
...
implementation {:origName "Serenum_GetDevPnPRev"} Serenum_GetDevPnPRev(actual_FdoData: int, actual_input_2: int, actual_output_2: int, actual_start_2: int) returns (Tmp_241: int)
{
  ...
  L21:
    call {:si_unique_call 416} Tmp_255, c_3, Tmp_261, tail_2 := Serenum_GetDevPnPRev_loop_L21(Tmp_255, c_3, Tmp_261, tail_2, input_2);
    goto L21_last;
  ...
  L34:
    call {:si_unique_call 417} i_2, sum, Tmp_257, c_3, Tmp_264 := Serenum_GetDevPnPRev_loop_L34(i_2, sum, Tmp_257, c_3, delta, Tmp_264, input_2);
    goto L34_last;
  ...
  L35:
    ...
    lsd := lsd + delta;
    Tmp_250 := msd;
    call {:si_unique_call 418} msd := Serenum_HToI(Tmp_250);
  ...
  anon48_Then:
    ...
    Tmp_256 := lsd;
    call {:si_unique_call 419} lsd := Serenum_HToI(Tmp_256);
  ...
  anon49_Then:
    ...
    call {:si_unique_call 420} vslice_dummy_var_53 := corral_nondet();
  ...
  anon56_Else:
    ...
    assume {:nonnull} input_2 != 0;
    assume input_2 > 0;
    call {:si_unique_call 421} i_2 := corral_nondet();
    Tmp_253 := tail_2;
    tail_2 := tail_2 + 1;
    Tmp_246 := Tmp_253;
    assume {:nonnull} input_2 != 0;
    assume input_2 > 0;
    havoc i_2;
    call {:si_unique_call 422} Serenum_FixptToAscii(i_2, output_2);
    i_2 := tail_2;
    goto L76;

  L76:
    call {:si_unique_call 423} i_2, Tmp_244, Tmp_251, c_3, Tmp_258, delta, Tmp_267 := Serenum_GetDevPnPRev_loop_L76(i_2, Tmp_244, Tmp_251, c_3, Tmp_258, delta, Tmp_267, input_2);
    goto L76_last;
...
implementation {:origName "Serenum_SzCopy"} Serenum_SzCopy(actual_source: int, actual_dest: int) returns (Tmp_268: int)
{
  ...
  L5:
    call {:si_unique_call 424} i_3, Tmp_270, Tmp_271 := Serenum_SzCopy_loop_L5(i_3, Tmp_270, Tmp_271, source, dest);
    goto L5_last;
...
implementation {:origName "Serenum_GetDevCompId"} Serenum_GetDevCompId(actual_input_3: int, actual_output_3: int, actual_start_3: int)
{
  ...
  anon0:
    call {:si_unique_call 425} vslice_dummy_var_54 := __HAVOC_malloc(4);
  ...
  L13:
    call {:si_unique_call 426} Tmp_277, c_4, Tmp_278, tail_3 := Serenum_GetDevCompId_loop_L13(Tmp_277, c_4, Tmp_278, tail_3, input_3, output_3);
    goto L13_last;
...
implementation {:origName "Serenum_GetDevClass"} Serenum_GetDevClass(actual_input_4: int, actual_output_4: int, actual_start_4: int)
{
  ...
  anon0:
    call {:si_unique_call 427} vslice_dummy_var_55 := __HAVOC_malloc(4);
  ...
  L13:
    call {:si_unique_call 428} Tmp_281, Tmp_283, c_5, tail_4 := Serenum_GetDevClass_loop_L13(Tmp_281, Tmp_283, c_5, tail_4, input_4, output_4);
    goto L13_last;
...
implementation {:origName "_sdv_init3"} _sdv_init3()
{
  ...
  anon0:
    call {:si_unique_call 429} vslice_dummy_var_56 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "Serenum_InitMultiString"} Serenum_InitMultiString(actual_FdoData_1: int, actual_MultiString: int) returns (Tmp_290: int)
{
  ...
  anon0:
    call {:si_unique_call 430} ansiString := __HAVOC_malloc(12);
    call {:si_unique_call 431} unicodeString := __HAVOC_malloc(12);
    call {:si_unique_call 432} MultiString := __HAVOC_malloc(4);
    multiLength := 0;
  ...
  L17:
    call {:si_unique_call 434} Tmp_292, Tmp_293, multiLength, rawString := Serenum_InitMultiString_loop_L17(Tmp_292, Tmp_293, ansiString, multiLength, rawString, ap);
    goto L17_last;
  ...
  anon17_Else:
    ...
    call {:si_unique_call 435} RtlInitAnsiString(0, 0);
    assume {:nonnull} NlsMbCodePageTag != 0;
    assume NlsMbCodePageTag > 0;
    goto anon18_Then, anon18_Else;

  anon18_Else:
    call {:si_unique_call 436} Tmp_293 := corral_nondet();
    goto L28;
  ...
  anon21_Else:
    ...
    call {:si_unique_call 437} sdv_146 := ExAllocatePoolWithTag(1, multiLength, -311532205);
    assume {:nonnull} MultiString != 0;
    assume MultiString > 0;
    assume {:nonnull} MultiString != 0;
    assume MultiString > 0;
  ...
  L47:
    call {:si_unique_call 438} i_4, Tmp_294, Tmp_295, Tmp_296, Tmp_297, rawString, vslice_dummy_var_57 := Serenum_InitMultiString_loop_L47(i_4, Tmp_294, Tmp_295, unicodeString, Tmp_296, Tmp_297, rawString, ap, vslice_dummy_var_57);
    goto L47_last;
  ...
  anon19_Else:
    assume {:partition} rawString != 0;
    call {:si_unique_call 439} RtlInitAnsiString(0, 0);
    call {:si_unique_call 440} vslice_dummy_var_57 := RtlAnsiStringToUnicodeString(0, 0, 0);
    i_4 := 0;
    goto L57;

  L57:
    call {:si_unique_call 441} i_4, Tmp_294, Tmp_295, Tmp_297 := Serenum_InitMultiString_loop_L57(i_4, Tmp_294, Tmp_295, unicodeString, Tmp_297);
    goto L57_last;
  ...
  anon21_Then:
    ...
    call {:si_unique_call 442} RtlInitUnicodeString(vslice_dummy_var_87, 0);
    Tmp_290 := 0;
    goto L1;
}
...
implementation {:origName "Serenum_ParseData"} Serenum_ParseData(actual_FdoData_2: int, actual_ReadBuffer: int, actual_BufferLen: int, actual_hardwareIDs: int, actual_compIDs: int, actual_deviceIDs: int, actual_PDeviceDesc: int, actual_serialNo: int, actual_pnpRev: int) returns (Tmp_300: int)
{
  ...
  anon0:
    call {:si_unique_call 443} start_5 := __HAVOC_malloc(4);
    call {:si_unique_call 444} pMouseID := __HAVOC_malloc(4);
    ...
    call {:si_unique_call 445} Tmp_301 := __HAVOC_malloc(52);
    call {:si_unique_call 446} vslice_dummy_var_64 := __HAVOC_malloc(24);
    call {:si_unique_call 447} Tmp_303 := __HAVOC_malloc(52);
    call {:si_unique_call 448} Tmp_304 := __HAVOC_malloc(36);
    pOtherId := 0;
    pPnpRev := 0;
    pDevNodeName := 0;
    pSerNo := 0;
    ...
    assume pMouseID > 0;
    call {:si_unique_call 449} sdv_152 := ExAllocatePoolWithTag(1, 1793, -311532205);
    pStrBuffer := sdv_152;
    goto anon51_Then, anon51_Else;
  ...
  anon51_Else:
    ...
    assume pDesc > 0;
    Tmp_304 := strConst__li2bpl11;
    assume {:nonnull} start_5 != 0;
    assume start_5 > 0;
    call {:si_unique_call 450} boogieTmp := Serenum_SzCopy(Tmp_304, pDevNodeName);
    pDevName := pDevNodeName;
    assume {:nonnull} start_5 != 0;
    assume start_5 > 0;
    call {:si_unique_call 451} RtlInitUnicodeString(hardwareIDs, 0);
    call {:si_unique_call 452} RtlInitUnicodeString(compIDs, 0);
    call {:si_unique_call 453} RtlInitUnicodeString(deviceIDs, 0);
    call {:si_unique_call 454} RtlInitUnicodeString(pnpRev, 0);
    call {:si_unique_call 455} RtlInitUnicodeString(serialNo, 0);
    assume {:nonnull} start_5 != 0;
    assume start_5 > 0;
    call {:si_unique_call 456} boogieTmp := Serenum_GetDevOtherID(ReadBuffer, pOtherId);
    assume {:nonnull} start_5 != 0;
    assume start_5 > 0;
    goto anon35_Then, anon35_Else;
  ...
  anon36_Else:
    assume {:partition} pStrBuffer != 0;
    call {:si_unique_call 457} vslice_dummy_var_58 := Serenum_InitMultiString(FdoData_2, hardwareIDs);
    call {:si_unique_call 458} sdv_163 := Serenum_StrLen(pCompId);
  ...
  anon39_Else:
    ...
    Tmp_301 := strConst__li2bpl9;
    call {:si_unique_call 459} vslice_dummy_var_65 := Serenum_InitMultiString(FdoData_2, compIDs);
    goto L108;

  L108:
    call {:si_unique_call 460} vslice_dummy_var_60 := Serenum_InitMultiString(FdoData_2, deviceIDs);
    call {:si_unique_call 461} vslice_dummy_var_61 := Serenum_InitMultiString(FdoData_2, PDeviceDesc);
    call {:si_unique_call 462} sdv_169 := Serenum_StrLen(pSerNo);
    goto anon40_Then, anon40_Else;

  anon40_Else:
    assume {:partition} sdv_169 != 0;
    call {:si_unique_call 463} vslice_dummy_var_62 := Serenum_InitMultiString(FdoData_2, serialNo);
    goto L118;

  L118:
    call {:si_unique_call 464} sdv_159 := Serenum_StrLen(pPnpRev);
    goto anon41_Then, anon41_Else;

  anon41_Else:
    assume {:partition} sdv_159 != 0;
    call {:si_unique_call 465} vslice_dummy_var_63 := Serenum_InitMultiString(FdoData_2, pnpRev);
    goto L125;
  ...
  anon39_Then:
    assume {:partition} isMouse == 0;
    call {:si_unique_call 467} vslice_dummy_var_59 := Serenum_InitMultiString(FdoData_2, compIDs);
    goto L108;
  ...
  anon38_Else:
    assume {:partition} isMouse != 0;
    Tmp_303 := strConst__li2bpl9;
    call {:si_unique_call 468} vslice_dummy_var_66 := Serenum_InitMultiString(FdoData_2, compIDs);
    goto L108;
  ...
  anon35_Then:
    call {:si_unique_call 469} SerenumScanOtherIdForMouse(ReadBuffer, BufferLen, pMouseID);
    assume {:nonnull} pMouseID != 0;
    assume pMouseID > 0;
    goto anon42_Then, anon42_Else;
  ...
  L135:
    call {:si_unique_call 470} status_11 := Serenum_GetDevPnPRev(FdoData_2, ReadBuffer, pPnpRev, start_5);
    goto anon45_Then, anon45_Else;

  anon45_Else:
    assume {:partition} status_11 >= 0;
    call {:si_unique_call 471} Serenum_GetDevName(ReadBuffer, pDevName, start_5);
    call {:si_unique_call 472} Serenum_GetDevSerialNo(ReadBuffer, pSerNo, start_5);
    call {:si_unique_call 473} sdv_167 := Serenum_StrLen(pSerNo);
    goto anon46_Then, anon46_Else;

  anon46_Else:
    assume {:partition} sdv_167 != 0;
    call {:si_unique_call 474} sdv_148 := Serenum_StrLen(pSerNo);
    goto anon47_Then, anon47_Else;
  ...
  L154:
    call {:si_unique_call 475} Serenum_GetDevClass(ReadBuffer, pClass, start_5);
    call {:si_unique_call 476} sdv_153 := Serenum_StrLen(pClass);
    goto anon48_Then, anon48_Else;
  ...
  anon48_Then:
    ...
    call {:si_unique_call 477} vslice_dummy_var_67 := corral_nondet();
    assume {:nonnull} pCompIdStar != 0;
    assume pCompIdStar > 0;
    call {:si_unique_call 478} Serenum_GetDevCompId(ReadBuffer, pCompId, start_5);
    call {:si_unique_call 479} sdv_151 := Serenum_StrLen(pCompId);
    goto anon49_Then, anon49_Else;
  ...
  anon49_Then:
    ...
    call {:si_unique_call 480} Serenum_GetDevDesc(ReadBuffer, pDesc, start_5);
    call {:si_unique_call 481} sdv_168 := Serenum_StrLen(pDesc);
    goto anon50_Then, anon50_Else;
...
implementation {:origName "Serenum_GetDevOtherID"} Serenum_GetDevOtherID(actual_input_5: int, actual_output_5: int) returns (Tmp_306: int)
{
  ...
  L7:
    call {:si_unique_call 482} Tmp_310, c_6, Tmp_311, tail_5 := Serenum_GetDevOtherID_loop_L7(Tmp_310, c_6, Tmp_311, tail_5, input_5, output_5);
    goto L7_last;
...
implementation {:origName "Serenum_FixptToAscii"} Serenum_FixptToAscii(actual_n_1: int, actual_output_6: int)
{
  ...
  anon0:
    call {:si_unique_call 483} vslice_dummy_var_68 := __HAVOC_malloc(4);
    n_1 := actual_n_1;
...
implementation {:origName "Serenum_GetDevSerialNo"} Serenum_GetDevSerialNo(actual_input_6: int, actual_output_7: int, actual_start_6: int)
{
  ...
  anon0:
    call {:si_unique_call 484} vslice_dummy_var_69 := __HAVOC_malloc(4);
  ...
  L15:
    call {:si_unique_call 485} cnt, Tmp_316, Tmp_318, sdv_170, c_7, tail_6 := Serenum_GetDevSerialNo_loop_L15(cnt, Tmp_316, Tmp_318, sdv_170, c_7, tail_6, input_6, output_7);
    goto L15_last;
  ...
  anon22_Else:
    ...
    cnt := cnt + 1;
    call {:si_unique_call 486} sdv_170 := Serenum_HToI(c_7);
    goto anon23_Then, anon23_Else;
...
implementation {:origName "SerenumScanOtherIdForMouse"} SerenumScanOtherIdForMouse(actual_PBuffer: int, actual_BufLen: int, actual_PpMouseId: int)
{
  ...
  anon0:
    call {:si_unique_call 487} vslice_dummy_var_70 := __HAVOC_malloc(4);
  ...
  L7:
    call {:si_unique_call 489} Tmp_324, Tmp_326, Tmp_327, Tmp_328, Tmp_329, BufLen := SerenumScanOtherIdForMouse_loop_L7(Tmp_324, Tmp_326, Tmp_327, Tmp_328, Tmp_329, BufLen, PpMouseId);
    goto L7_last;
...
implementation {:origName "SerenumValidateID"} SerenumValidateID(actual_PId: int) returns (Tmp_331: int)
{
  ...
  L10:
    call {:si_unique_call 491} SerenumValidateID_loop_L10(cp);
    goto L10_last;
...
implementation {:origName "SerenumWaitForEnumThreadTerminate"} SerenumWaitForEnumThreadTerminate(actual_PFdoData_2: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 493} Tmp_333 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_333 != 0;
    assume Tmp_333 > 0;
    call {:si_unique_call 494} sdv_KeAcquireSpinLock(0, Tmp_333);
    assume {:nonnull} Tmp_333 != 0;
    assume Tmp_333 > 0;
    havoc oldIrql_2;
  ...
  L13:
    call {:si_unique_call 495} sdv_KeReleaseSpinLock(0, oldIrql_2);
    goto anon6_Then, anon6_Else;

  anon6_Else:
    assume {:partition} pThreadObj != 0;
    call {:si_unique_call 496} vslice_dummy_var_72 := KeWaitForSingleObject(0, 0, 0, 0, 0);
    call {:si_unique_call 497} vslice_dummy_var_73 := sdv_ObDereferenceObject(0);
    goto L1;
...
implementation {:origName "Serenum_IoSyncReq"} Serenum_IoSyncReq(actual_PDevObj: int, actual_PIrp: int, actual_PEvent: int) returns (Tmp_335: int)
{
  ...
  anon0:
    ...
    PIrp := actual_PIrp;
    call {:si_unique_call 498} status_12 := sdv_IoCallDriver(PDevObj, PIrp);
    goto anon6_Then, anon6_Else;
  ...
  anon5_Else:
    ...
    call {:si_unique_call 499} status_12 := KeWaitForSingleObject(0, 0, 0, 0, 0);
    goto L9;
...
implementation {:origName "Serenum_GetRegistryKeyValue"} Serenum_GetRegistryKeyValue(actual_Handle_2: int, actual_KeyNameString: int, actual_KeyNameStringLength: int, actual_Data_2: int, actual_DataLength: int, actual_ActualLength: int) returns (Tmp_337: int)
{
  ...
  anon0:
    call {:si_unique_call 500} keyName := __HAVOC_malloc(12);
    ...
    ntStatus := -1073741670;
    call {:si_unique_call 501} RtlInitUnicodeString(keyName, KeyNameString);
    length_2 := 24 + KeyNameStringLength + DataLength;
    call {:si_unique_call 502} sdv_175 := ExAllocatePoolWithTag(1, length_2, -311532205);
    fullInfo := sdv_175;
    goto anon24_Then, anon24_Else;
  ...
  anon17_Else:
    ...
    call {:si_unique_call 503} Tmp_339 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_339 != 0;
    assume Tmp_339 > 0;
    call {:si_unique_call 504} ntStatus := ZwQueryValueKey(0, 0, 1, 0, length_2, Tmp_339);
    assume {:nonnull} Tmp_339 != 0;
    assume Tmp_339 > 0;
    havoc length_2;
    goto anon19_Then, anon19_Else;
  ...
  anon20_Else:
    ...
    call {:si_unique_call 505} sdv_RtlCopyMemory(0, 0, vslice_dummy_var_88);
    goto anon21_Then, anon21_Else;
  ...
  anon18_Then:
    ...
    call {:si_unique_call 507} sdv_177 := sdv_NT_ERROR(ntStatus);
    goto anon22_Then, anon22_Else;
...
implementation {:origName "Serenum_EnumComplete"} Serenum_EnumComplete(actual_DeviceObject_17: int, actual_Irp_13: int, actual_Context_4: int) returns (Tmp_340: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 508} vslice_dummy_var_74 := KeSetEvent(Context_4, 0, 0);
    Tmp_340 := -1073741802;
    return;
}
...
implementation {:origName "_sdv_init5"} _sdv_init5()
{
  ...
  anon0:
    call {:si_unique_call 509} vslice_dummy_var_75 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "SerenumCheckForLegacyDevice"} SerenumCheckForLegacyDevice(actual_PFdoData_3: int, actual_PIdBuf: int, actual_BufferLen_1: int, actual_PHardwareIDs: int, actual_PCompIDs: int, actual_PDeviceIDs: int) returns (Tmp_344: int)
{
  ...
  anon0:
    call {:si_unique_call 510} mouseId := __HAVOC_malloc(4);
    ...
    call {:si_unique_call 511} Tmp_345 := __HAVOC_malloc(36);
    call {:si_unique_call 512} Tmp_346 := __HAVOC_malloc(36);
    call {:si_unique_call 513} Tmp_347 := __HAVOC_malloc(36);
    call {:si_unique_call 514} Tmp_348 := __HAVOC_malloc(52);
    call {:si_unique_call 515} Tmp_349 := __HAVOC_malloc(56);
    call {:si_unique_call 516} Tmp_351 := __HAVOC_malloc(56);
    call {:si_unique_call 517} Tmp_352 := __HAVOC_malloc(36);
    call {:si_unique_call 518} Tmp_353 := __HAVOC_malloc(72);
    call {:si_unique_call 519} Tmp_354 := __HAVOC_malloc(52);
    call {:si_unique_call 520} Tmp_355 := __HAVOC_malloc(52);
    assume {:nonnull} mouseId != 0;
    assume mouseId > 0;
    rval := 0;
    call {:si_unique_call 521} sdv_do_paged_code_check();
    call {:si_unique_call 522} SerenumScanOtherIdForMouse(PIdBuf, BufferLen_1, mouseId);
    assume {:nonnull} mouseId != 0;
    assume mouseId > 0;
    goto anon11_Then, anon11_Else;
  ...
  anon15_Else:
    Tmp_345 := strConst__li2bpl13;
    call {:si_unique_call 523} vslice_dummy_var_76 := Serenum_InitMultiString(PFdoData_3, PHardwareIDs);
    Tmp_348 := strConst__li2bpl9;
    call {:si_unique_call 524} vslice_dummy_var_77 := Serenum_InitMultiString(PFdoData_3, PCompIDs);
    Tmp_351 := strConst__li2bpl14;
    call {:si_unique_call 525} vslice_dummy_var_78 := Serenum_InitMultiString(PFdoData_3, PDeviceIDs);
    rval := 1;
    goto L15;
  ...
  L19:
    ...
    call {:si_unique_call 526} vslice_dummy_var_79 := Serenum_InitMultiString(PFdoData_3, PHardwareIDs);
    Tmp_354 := strConst__li2bpl9;
    call {:si_unique_call 527} vslice_dummy_var_80 := Serenum_InitMultiString(PFdoData_3, PCompIDs);
    Tmp_349 := strConst__li2bpl14;
    call {:si_unique_call 528} vslice_dummy_var_81 := Serenum_InitMultiString(PFdoData_3, PDeviceIDs);
    rval := 1;
    goto L15;
  ...
  anon13_Else:
    Tmp_346 := strConst__li2bpl15;
    call {:si_unique_call 529} vslice_dummy_var_82 := Serenum_InitMultiString(PFdoData_3, PHardwareIDs);
    Tmp_347 := strConst__li2bpl16;
    Tmp_355 := strConst__li2bpl9;
    call {:si_unique_call 530} vslice_dummy_var_83 := Serenum_InitMultiString(PFdoData_3, PCompIDs);
    Tmp_353 := strConst__li2bpl17;
    call {:si_unique_call 531} vslice_dummy_var_84 := Serenum_InitMultiString(PFdoData_3, PDeviceIDs);
    rval := 1;
    goto L15;
...
implementation {:origName "Serenum_IoSyncReqWithIrp"} Serenum_IoSyncReqWithIrp(actual_PIrp_1: int, actual_MajorFunction_1: int, actual_PEvent_1: int, actual_PDevObj_1: int) returns (Tmp_356: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 532} stack_4 := sdv_IoGetNextIrpStackLocation(PIrp_1);
    assume {:nonnull} stack_4 != 0;
    assume stack_4 > 0;
    call {:si_unique_call 533} KeClearEvent(PEvent_1);
    call {:si_unique_call 534} sdv_IoSetCompletionRoutine(PIrp_1, li2bplFunctionConstant563, PEvent_1, 1, 1, 1);
    call {:si_unique_call 535} status_13 := Serenum_IoSyncReq(PDevObj_1, PIrp_1, PEvent_1);
    goto anon6_Then, anon6_Else;
...
implementation {:origName "Serenum_ReenumerateDevices"} Serenum_ReenumerateDevices(actual_Irp_14: int, actual_PFdoData_4: int, actual_PSameDevice: int) returns (Tmp_358: int)
{
  ...
  anon0:
    call {:si_unique_call 536} hardwareIDs_1 := __HAVOC_malloc(12);
    call {:si_unique_call 537} pdoUniName := __HAVOC_malloc(12);
    call {:si_unique_call 538} basicSettings := __HAVOC_malloc(44);
    call {:si_unique_call 539} DSRMissing := __HAVOC_malloc(4);
    call {:si_unique_call 540} timeouts := __HAVOC_malloc(20);
    call {:si_unique_call 541} nActual := __HAVOC_malloc(4);
    call {:si_unique_call 542} serNo := __HAVOC_malloc(12);
    call {:si_unique_call 543} deviceIDs_1 := __HAVOC_malloc(12);
    call {:si_unique_call 544} vslice_dummy_var_85 := __HAVOC_malloc(192);
    call {:si_unique_call 545} pdo := __HAVOC_malloc(4);
    call {:si_unique_call 546} compIDs_1 := __HAVOC_malloc(12);
    call {:si_unique_call 547} pnpRev_1 := __HAVOC_malloc(12);
    call {:si_unique_call 548} devDesc := __HAVOC_malloc(12);
    call {:si_unique_call 549} pReadBuf := __HAVOC_malloc(4);
    call {:si_unique_call 550} event_1 := __HAVOC_malloc(156);
    call {:si_unique_call 551} newTimeouts := __HAVOC_malloc(20);
    Irp_14 := actual_Irp_14;
    PFdoData_4 := actual_PFdoData_4;
    PSameDevice := actual_PSameDevice;
    call {:si_unique_call 552} pdoName := __HAVOC_malloc(36);
    ...
    call {:si_unique_call 554} status_14 := KeWaitForSingleObject(0, 0, 0, 0, 0);
    goto anon119_Then, anon119_Else;

  anon119_Else:
    assume {:partition} status_14 >= 0;
    call {:si_unique_call 555} RtlInitUnicodeString(pdoUniName, pdoName);
    assume {:nonnull} PFdoData_4 != 0;
    assume PFdoData_4 > 0;
    assume {:nonnull} PFdoData_4 != 0;
    assume PFdoData_4 > 0;
    ...
    assume pdoName > 0;
    call {:si_unique_call 556} KeInitializeEvent(event_1, 0, 0);
    call {:si_unique_call 557} KeInitializeTimer(0);
    call {:si_unique_call 558} RtlInitUnicodeString(hardwareIDs_1, 0);
    call {:si_unique_call 559} RtlInitUnicodeString(compIDs_1, 0);
    call {:si_unique_call 560} RtlInitUnicodeString(deviceIDs_1, 0);
    call {:si_unique_call 561} RtlInitUnicodeString(devDesc, 0);
    call {:si_unique_call 562} RtlInitUnicodeString(serNo, 0);
    call {:si_unique_call 563} RtlInitUnicodeString(pnpRev_1, 0);
    assume {:nonnull} PFdoData_4 != 0;
    assume PFdoData_4 > 0;
    goto anon120_Then, anon120_Else;
  ...
  anon121_Else:
    ...
    call {:si_unique_call 564} Serenum_PDO_EnumMarkMissing(PFdoData_4, vslice_dummy_var_96);
    assume {:nonnull} pdo != 0;
    assume pdo > 0;
    goto L80;

  L80:
    call {:si_unique_call 565} status_14 := Serenum_IoSyncReqWithIrp(Irp_14, 0, event_1, pDevStack);
  ...
  anon122_Else:
    assume {:partition} status_14 >= 0;
    call {:si_unique_call 566} status_14 := Serenum_IoSyncIoctlEx(1769484, 1, pDevStack, event_1, 0, 0, basicSettings, 44);
  ...
  L102:
    call {:si_unique_call 567} curTry, status_14 := Serenum_ReenumerateDevices_loop_L102(curTry, DSRMissing, nActual, pReadBuf, status_14, PFdoData_4);
    goto L102_last;
  ...
  L105:
    call {:si_unique_call 569} status_14 := SerenumDoEnumProtocol(PFdoData_4, pReadBuf, nActual, DSRMissing);
  ...
  anon125_Else:
    ...
    call {:si_unique_call 570} vslice_dummy_var_88 := Serenum_IoSyncIoctlEx(1769488, 1, pDevStack, event_1, basicSettings, 44, 0, 0);
  ...
  L122:
    call {:si_unique_call 571} vslice_dummy_var_89 := Serenum_IoSyncReqWithIrp(Irp_14, 18, event_1, pDevStack);
    goto anon173_Then, anon173_Else;

  anon173_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 572} vslice_dummy_var_90 := Serenum_IoSyncReqWithIrp(Irp_14, 2, event_1, pDevStack);
  ...
  anon131_Else:
    ...
    call {:si_unique_call 573} legacyDeviceFound := SerenumCheckForLegacyDevice(PFdoData_4, vslice_dummy_var_97, Tmp_359, hardwareIDs_1, compIDs_1, deviceIDs_1);
    goto L135;
  ...
  L143:
    call {:si_unique_call 575} sdv_192 := SerenumValidateID(hardwareIDs_1);
    goto anon134_Then, anon134_Else;

  anon134_Else:
    assume {:partition} sdv_192 != 0;
    call {:si_unique_call 576} sdv_207 := SerenumValidateID(compIDs_1);
    goto anon136_Then, anon136_Else;

  anon136_Else:
    assume {:partition} sdv_207 != 0;
    call {:si_unique_call 577} sdv_208 := SerenumValidateID(deviceIDs_1);
  ...
  anon138_Else:
    ...
    assume pdo > 0;
    havoc pdoData;
    call {:si_unique_call 578} sdv_210 := corral_nondet();
    goto anon140_Then, anon140_Else;

  anon140_Else:
    assume {:partition} sdv_210 != 0;
    call {:si_unique_call 579} sdv_191 := corral_nondet();
  ...
  L178:
    call {:si_unique_call 580} vslice_dummy_var_92 := KeReleaseSemaphore(0, 0, 1, 0);
  ...
  anon139_Then:
    assume {:nonnull} PFdoData_4 != 0;
    assume PFdoData_4 > 0;
    call {:si_unique_call 581} status_14 := IoCreateDevice(0, 76, 0, 34, 128, 0, pdo);
  ...
  anon142_Else:
    ...
    call {:si_unique_call 582} Serenum_InitPDO(vslice_dummy_var_98, PFdoData_4);
    goto L178;

  anon142_Then:
    assume {:partition} 0 > status_14;
    call {:si_unique_call 583} vslice_dummy_var_93 := KeReleaseSemaphore(0, 0, 1, 0);
    Tmp_358 := status_14;
    goto L1;
  ...
  L166:
    call {:si_unique_call 584} Serenum_PDO_EnumMarkMissing(PFdoData_4, pdoData);
    assume {:nonnull} pdo != 0;
    assume pdo > 0;
    goto L160;
  ...
  anon135_Else:
    ...
    call {:si_unique_call 585} Serenum_PDO_EnumMarkMissing(PFdoData_4, vslice_dummy_var_99);
    assume {:nonnull} pdo != 0;
    assume pdo > 0;
    goto L199;
  ...
  L211:
    call {:si_unique_call 589} RtlInitUnicodeString(compIDs_1, 0);
    assume {:nonnull} deviceIDs_1 != 0;
    assume deviceIDs_1 > 0;
  ...
  L218:
    call {:si_unique_call 591} RtlInitUnicodeString(deviceIDs_1, 0);
    assume {:nonnull} devDesc != 0;
    assume devDesc > 0;
  ...
  L225:
    call {:si_unique_call 593} RtlInitUnicodeString(devDesc, 0);
    assume {:nonnull} serNo != 0;
    assume serNo > 0;
  ...
  L232:
    call {:si_unique_call 595} RtlInitUnicodeString(serNo, 0);
    assume {:nonnull} pnpRev_1 != 0;
    assume pnpRev_1 > 0;
  ...
  L239:
    call {:si_unique_call 597} RtlInitUnicodeString(pnpRev_1, 0);
    goto L178;
  ...
  anon132_Then:
    ...
    call {:si_unique_call 598} status_14 := Serenum_ParseData(PFdoData_4, vslice_dummy_var_100, Tmp_360, hardwareIDs_1, compIDs_1, deviceIDs_1, devDesc, serNo, pnpRev_1);
    assume {:nonnull} DSRMissing != 0;
    assume DSRMissing > 0;
  ...
  anon152_Else:
    ...
    call {:si_unique_call 599} Serenum_PDO_EnumMarkMissing(PFdoData_4, vslice_dummy_var_101);
    assume {:nonnull} pdo != 0;
    assume pdo > 0;
    goto L254;
  ...
  L259:
    call {:si_unique_call 601} RtlInitUnicodeString(hardwareIDs_1, 0);
    assume {:nonnull} compIDs_1 != 0;
    assume compIDs_1 > 0;
  ...
  L266:
    call {:si_unique_call 603} RtlInitUnicodeString(compIDs_1, 0);
    assume {:nonnull} deviceIDs_1 != 0;
    assume deviceIDs_1 > 0;
  ...
  L273:
    call {:si_unique_call 605} RtlInitUnicodeString(deviceIDs_1, 0);
    assume {:nonnull} devDesc != 0;
    assume devDesc > 0;
  ...
  L280:
    call {:si_unique_call 607} RtlInitUnicodeString(devDesc, 0);
    assume {:nonnull} serNo != 0;
    assume serNo > 0;
  ...
  L287:
    call {:si_unique_call 609} RtlInitUnicodeString(serNo, 0);
    assume {:nonnull} pnpRev_1 != 0;
    assume pnpRev_1 > 0;
  ...
  L294:
    call {:si_unique_call 611} RtlInitUnicodeString(pnpRev_1, 0);
  ...
  L306:
    call {:si_unique_call 614} RtlInitUnicodeString(hardwareIDs_1, 0);
    assume {:nonnull} compIDs_1 != 0;
    assume compIDs_1 > 0;
  ...
  L313:
    call {:si_unique_call 616} RtlInitUnicodeString(compIDs_1, 0);
    assume {:nonnull} deviceIDs_1 != 0;
    assume deviceIDs_1 > 0;
  ...
  L320:
    call {:si_unique_call 618} RtlInitUnicodeString(deviceIDs_1, 0);
    assume {:nonnull} devDesc != 0;
    assume devDesc > 0;
  ...
  L327:
    call {:si_unique_call 620} RtlInitUnicodeString(devDesc, 0);
    assume {:nonnull} serNo != 0;
    assume serNo > 0;
  ...
  L334:
    call {:si_unique_call 622} RtlInitUnicodeString(serNo, 0);
    assume {:nonnull} pnpRev_1 != 0;
    assume pnpRev_1 > 0;
  ...
  L341:
    call {:si_unique_call 624} RtlInitUnicodeString(pnpRev_1, 0);
    assume {:nonnull} nActual != 0;
    assume nActual > 0;
    havoc Tmp_363;
    assume {:nonnull} pReadBuf != 0;
    ...
    call {:si_unique_call 625} sdv_211 := SerenumCheckForLegacyDevice(PFdoData_4, vslice_dummy_var_102, Tmp_363, hardwareIDs_1, compIDs_1, deviceIDs_1);
  ...
  anon166_Else:
    ...
    call {:si_unique_call 627} Serenum_PDO_EnumMarkMissing(PFdoData_4, vslice_dummy_var_103);
    assume {:nonnull} pdo != 0;
    assume pdo > 0;
    goto L178;
  ...
  anon128_Then:
    assume {:partition} 0 > status_14;
    call {:si_unique_call 628} vslice_dummy_var_91 := KeReleaseSemaphore(0, 0, 1, 0);
    assume {:nonnull} pReadBuf != 0;
    assume pReadBuf > 0;
  ...
  anon125_Then:
    assume {:partition} basicSettingsDone == 0;
    call {:si_unique_call 630} vslice_dummy_var_87 := Serenum_IoSyncIoctlEx(1769500, 0, pDevStack, event_1, timeouts, 20, 0, 0);
  ...
  anon123_Then:
    assume {:partition} 0 > status_14;
    call {:si_unique_call 631} status_14 := Serenum_IoSyncIoctlEx(1769504, 0, pDevStack, event_1, 0, 0, timeouts, 20);
  ...
  anon168_Else:
    ...
    call {:si_unique_call 633} vslice_dummy_var_95 := Serenum_IoSyncIoctlEx(1769500, 0, pDevStack, event_1, newTimeouts, 20, 0, 0);
  ...
  anon168_Then:
    assume {:partition} 0 > status_14;
    call {:si_unique_call 634} vslice_dummy_var_94 := KeReleaseSemaphore(0, 0, 1, 0);
    Tmp_358 := status_14;
    goto L1;
  ...
  anon122_Then:
    assume {:partition} 0 > status_14;
    call {:si_unique_call 635} vslice_dummy_var_86 := KeReleaseSemaphore(0, 0, 1, 0);
    Tmp_358 := status_14;
    goto L1;
...
implementation {:origName "Serenum_IoSyncIoctlEx"} Serenum_IoSyncIoctlEx(actual_Ioctl: int, actual_Internal: int, actual_PDevObj_2: int, actual_PEvent_2: int, actual_PInBuffer: int, actual_InBufferLen: int, actual_POutBuffer: int, actual_OutBufferLen: int) returns (Tmp_364: int)
{
  ...
  anon0:
    call {:si_unique_call 636} IoStatusBlock_2 := __HAVOC_malloc(12);
    Ioctl := actual_Ioctl;
    ...
    call {:si_unique_call 637} KeClearEvent(PEvent_2);
    call {:si_unique_call 638} pIrp_1 := IoBuildDeviceIoControlRequest(Ioctl, 0, 0, InBufferLen, 0, OutBufferLen, Internal, 0, IoStatusBlock_2);
    goto anon7_Then, anon7_Else;

  anon7_Else:
    assume {:partition} pIrp_1 != 0;
    call {:si_unique_call 639} status_15 := Serenum_IoSyncReq(PDevObj_2, pIrp_1, PEvent_2);
    goto anon9_Then, anon9_Else;
...
implementation {:origName "SerenumDoEnumProtocol"} SerenumDoEnumProtocol(actual_PFdoData_5: int, actual_PpBuf: int, actual_PNBytes: int, actual_PDSRMissing: int) returns (Tmp_366: int)
{
  ...
  anon0:
    call {:si_unique_call 640} DefaultWait := __HAVOC_malloc(20);
    call {:si_unique_call 641} ioStatusBlock := __HAVOC_malloc(12);
    call {:si_unique_call 642} nRead := __HAVOC_malloc(4);
    call {:si_unique_call 643} timer_1 := __HAVOC_malloc(192);
    call {:si_unique_call 644} lineControl := __HAVOC_malloc(12);
    call {:si_unique_call 645} baudRate := __HAVOC_malloc(4);
    call {:si_unique_call 646} bitMask := __HAVOC_malloc(4);
    call {:si_unique_call 647} event_2 := __HAVOC_malloc(156);
    ...
    call {:si_unique_call 649} KeInitializeEvent(event_2, 0, 0);
    call {:si_unique_call 650} KeInitializeTimer(0);
    ...
    call {:si_unique_call 651} sdv_218 := ExAllocatePoolWithTag(512, 257, -311532205);
    pReadBuf_1 := sdv_218;
    goto anon90_Then, anon90_Else;
  ...
  anon69_Then:
    assume {:partition} 0 <= status_16;
    call {:si_unique_call 654} status_16 := Serenum_IoSyncIoctlEx(1769524, 0, pDevStack_1, event_2, 0, 0, 0, 0);
    goto anon92_Then, anon92_Else;
  ...
  anon71_Then:
    assume {:partition} 0 <= status_16;
    call {:si_unique_call 656} status_16 := Serenum_IoSyncIoctlEx(1769576, 0, pDevStack_1, event_2, 0, 0, bitMask, 4);
    goto anon93_Then, anon93_Else;
  ...
  L64:
    ...
    assume baudRate > 0;
    call {:si_unique_call 657} status_16 := Serenum_IoSyncIoctlEx(1769476, 0, pDevStack_1, event_2, baudRate, 4, 0, 0);
    goto anon94_Then, anon94_Else;
  ...
  anon74_Then:
    ...
    assume {:nonnull} lineControl != 0;
    assume lineControl > 0;
    call {:si_unique_call 658} status_16 := Serenum_IoSyncIoctlEx(1769484, 0, pDevStack_1, event_2, lineControl, 3, 0, 0);
    goto anon95_Then, anon95_Else;
  ...
  L81:
    call {:si_unique_call 659} i_5, status_16 := SerenumDoEnumProtocol_loop_L81(i_5, pDevStack_1, DefaultWait, ioStatusBlock, nRead, timer_1, pReadBuf_1, status_16, bitMask, event_2, PFdoData_5);
    goto L81_last;
  ...
  anon76_Else:
    ...
    assume {:nonnull} bitMask != 0;
    assume bitMask > 0;
    call {:si_unique_call 660} status_16 := Serenum_IoSyncIoctlEx(1769548, 0, pDevStack_1, event_2, bitMask, 4, 0, 0);
    goto anon96_Then, anon96_Else;
  ...
  anon78_Else:
    assume {:partition} status_16 >= 0;
    call {:si_unique_call 661} status_16 := Serenum_IoSyncIoctlEx(1769512, 0, pDevStack_1, event_2, 0, 0, 0, 0);
    goto anon97_Then, anon97_Else;
  ...
  anon79_Else:
    assume {:partition} status_16 >= 0;
    call {:si_unique_call 662} status_16 := Serenum_IoSyncIoctlEx(1769524, 0, pDevStack_1, event_2, 0, 0, 0, 0);
    goto anon98_Then, anon98_Else;
  ...
  anon80_Else:
    assume {:partition} status_16 >= 0;
    call {:si_unique_call 663} status_16 := Serenum_Wait(timer_1, DefaultWait);
    goto anon81_Then, anon81_Else;

  anon81_Else:
    assume {:partition} status_16 >= 0;
    call {:si_unique_call 664} status_16 := Serenum_IoSyncIoctlEx(1769508, 0, pDevStack_1, event_2, 0, 0, 0, 0);
    goto anon99_Then, anon99_Else;
  ...
  L118:
    call {:si_unique_call 665} status_16 := Serenum_IoSyncIoctlEx(1769520, 0, pDevStack_1, event_2, 0, 0, 0, 0);
    goto anon100_Then, anon100_Else;
  ...
  anon84_Else:
    ...
    assume {:nonnull} nRead != 0;
    assume nRead > 0;
    call {:si_unique_call 666} status_16 := Serenum_ReadSerialPort(pReadBuf_1, 256, 240, nRead, ioStatusBlock, PFdoData_5);
    goto anon101_Then, anon101_Else;
  ...
  anon83_Then:
    assume {:partition} i_5 == 0;
    call {:si_unique_call 667} status_16 := Serenum_Wait(timer_1, DefaultWait);
    goto anon87_Then, anon87_Else;
...
implementation {:origName "Serenum_PDO_EnumMarkMissing"} Serenum_PDO_EnumMarkMissing(actual_FdoData_3: int, actual_PdoData_2: int)
{
  ...
  anon0:
    call {:si_unique_call 668} vslice_dummy_var_96 := __HAVOC_malloc(4);
    FdoData_3 := actual_FdoData_3;
    PdoData_2 := actual_PdoData_2;
    call {:si_unique_call 669} Tmp_368 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_368 != 0;
    assume Tmp_368 > 0;
    call {:si_unique_call 670} sdv_KeAcquireSpinLock(0, Tmp_368);
    assume {:nonnull} Tmp_368 != 0;
    assume Tmp_368 > 0;
    havoc oldIrql_3;
    ...
    assume {:nonnull} FdoData_3 != 0;
    assume FdoData_3 > 0;
    call {:si_unique_call 671} sdv_KeReleaseSpinLock(0, oldIrql_3);
    return;
}
...
implementation {:origName "Serenum_ReadSerialPort"} Serenum_ReadSerialPort(actual_PReadBuffer: int, actual_Buflen: int, actual_Timeout_1: int, actual_nActual_1: int, actual_PIoStatusBlock: int, actual_FdoData_4: int) returns (Tmp_370: int)
{
  ...
  anon0:
    call {:si_unique_call 672} startingOffset := __HAVOC_malloc(20);
    call {:si_unique_call 673} timeouts_1 := __HAVOC_malloc(20);
    call {:si_unique_call 674} event_3 := __HAVOC_malloc(156);
    ...
    assume {:nonnull} timeouts_1 != 0;
    assume timeouts_1 > 0;
    call {:si_unique_call 675} KeInitializeEvent(event_3, 0, 0);
    assume {:nonnull} FdoData_4 != 0;
    assume FdoData_4 > 0;
    havoc vslice_dummy_var_104;
    call {:si_unique_call 676} status_17 := Serenum_IoSyncIoctlEx(1769500, 0, vslice_dummy_var_104, event_3, timeouts_1, 20, 0, 0);
    goto anon26_Then, anon26_Else;
  ...
  L25:
    call {:si_unique_call 677} pIrp_2, status_17 := Serenum_ReadSerialPort_loop_L25(pIrp_2, status_17, event_3, PReadBuffer, Buflen, nActual_1, PIoStatusBlock, FdoData_4);
    goto L25_last;
  ...
  anon20_Else:
    call {:si_unique_call 678} KeClearEvent(event_3);
    call {:si_unique_call 679} pIrp_2 := IoBuildSynchronousFsdRequest(3, 0, 0, 1, 0, 0, PIoStatusBlock);
    goto anon21_Then, anon21_Else;
  ...
  anon21_Else:
    ...
    call {:si_unique_call 680} status_17 := sdv_IoCallDriver(vslice_dummy_var_105, pIrp_2);
    goto anon27_Then, anon27_Else;
  ...
  anon22_Else:
    ...
    call {:si_unique_call 681} status_17 := KeWaitForSingleObject(0, 0, 0, 0, 0);
    goto anon24_Then, anon24_Else;
...
implementation {:origName "Serenum_Wait"} Serenum_Wait(actual_Timer_2: int, actual_structPtr888DueTime: int) returns (Tmp_372: int)
{
  ...
  anon0:
    call {:si_unique_call 682} DueTime := __HAVOC_malloc(20);
    ...
    assume {:nonnull} structPtr888DueTime != 0;
    assume structPtr888DueTime > 0;
    call {:si_unique_call 683} vslice_dummy_var_97 := KeSetTimer(0, DueTime, 0);
    call {:si_unique_call 684} Tmp_372 := KeWaitForSingleObject(0, 0, 0, 0, 0);
    return;
}
...
implementation {:origName "SerenumStartProtocolThread"} SerenumStartProtocolThread(actual_PFdoData_6: int) returns (Tmp_374: int)
{
  ...
  anon0:
    call {:si_unique_call 685} vslice_dummy_var_98 := __HAVOC_malloc(24);
    PFdoData_6 := actual_PFdoData_6;
    call {:si_unique_call 686} sdv_InitializeObjectAttributes(0, 0, 512, 0, 0);
    call {:si_unique_call 687} pWorkItem := IoAllocateWorkItem(0);
    goto anon7_Then, anon7_Else;
  ...
  anon7_Else:
    ...
    assume PFdoData_6 > 0;
    call {:si_unique_call 688} status_18 := PsCreateSystemThread(0, 2097151, 0, 0, 0, li2bplFunctionConstant571, 0);
    goto anon8_Then, anon8_Else;

  anon8_Else:
    assume {:partition} status_18 >= 0;
    call {:si_unique_call 689} status_18 := ObReferenceObjectByHandle(0, 2097151, 0, 0, 0, 0);
    call {:si_unique_call 690} Tmp_375 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_375 != 0;
    assume Tmp_375 > 0;
    call {:si_unique_call 691} sdv_KeAcquireSpinLock(0, Tmp_375);
    assume {:nonnull} Tmp_375 != 0;
    assume Tmp_375 > 0;
    havoc oldIrql_4;
    goto anon9_Then, anon9_Else;
  ...
  anon9_Else:
    ...
    assume {:nonnull} PFdoData_6 != 0;
    assume PFdoData_6 > 0;
    call {:si_unique_call 692} sdv_KeReleaseSpinLock(0, oldIrql_4);
    goto L39;

  L39:
    call {:si_unique_call 693} vslice_dummy_var_99 := ZwClose(0);
    goto L42;
  ...
  anon9_Then:
    ...
    assume {:nonnull} PFdoData_6 != 0;
    assume PFdoData_6 > 0;
    call {:si_unique_call 694} sdv_KeReleaseSpinLock(0, oldIrql_4);
    goto L39;
  ...
  anon8_Then:
    ...
    assume {:nonnull} PFdoData_6 != 0;
    assume PFdoData_6 > 0;
    call {:si_unique_call 695} IoFreeWorkItem(0);
    goto L42;
...
implementation {:origName "Serenum_CreateClose"} Serenum_CreateClose(actual_DeviceObject_18: int, actual_Irp_15: int) returns (Tmp_376: int)
{
  ...
  anon0:
    call {:si_unique_call 696} completionEvent := __HAVOC_malloc(156);
    DeviceObject_18 := actual_DeviceObject_18;
    Irp_15 := actual_Irp_15;
    call {:si_unique_call 697} irpStack_2 := sdv_IoGetCurrentIrpStackLocation(Irp_15);
  ...
  anon17_Else:
    call {:si_unique_call 698} sdv_IoCopyCurrentIrpStackLocationToNext(Irp_15);
    call {:si_unique_call 699} KeInitializeEvent(completionEvent, 1, 0);
    call {:si_unique_call 700} sdv_IoSetCompletionRoutine(Irp_15, li2bplFunctionConstant482, completionEvent, 1, 1, 1);
    call {:si_unique_call 701} status_19 := sdv_IoCallDriver(pNextDevice, Irp_15);
    goto anon20_Then, anon20_Else;
  ...
  anon16_Else:
    ...
    call {:si_unique_call 702} vslice_dummy_var_100 := KeWaitForSingleObject(0, 0, 0, 0, 0);
    goto L35;
  ...
  anon21_Else:
    ...
    assume SLAM_guard_S_0 != SLAM_guard_S_0_init;
    call {:si_unique_call 703} SLIC_sdv_IoCompleteRequest_entry(0, Irp_15);
    goto L51;
  ...
  anon15_Then:
    call {:si_unique_call 705} status_19 := Serenum_DispatchPassThrough(DeviceObject_18, Irp_15);
    goto anon19_Then, anon19_Else;
...
implementation {:origName "Serenum_IncIoCount"} Serenum_IncIoCount(actual_Data_3: int) returns (Tmp_385: int)
{
  ...
  anon0:
    ...
    assume Tmp_386 > 0;
    call {:si_unique_call 707} vslice_dummy_var_102 := sdv_InterlockedIncrement(Tmp_386);
    assume {:nonnull} Data_3 != 0;
    assume Data_3 > 0;
    assume {:nonnull} Tmp_386 != 0;
    assume Tmp_386 > 0;
  ...
  anon5_Else:
    call {:si_unique_call 708} Tmp_386 := __HAVOC_malloc(4);
    assume {:nonnull} Data_3 != 0;
    assume Data_3 > 0;
    assume {:nonnull} Tmp_386 != 0;
    assume Tmp_386 > 0;
    call {:si_unique_call 709} sdv_246 := sdv_InterlockedDecrement(Tmp_386);
    assume {:nonnull} Data_3 != 0;
    assume Data_3 > 0;
    assume {:nonnull} Tmp_386 != 0;
    assume Tmp_386 > 0;
  ...
  anon6_Then:
    ...
    assume {:nonnull} Data_3 != 0;
    assume Data_3 > 0;
    call {:si_unique_call 710} vslice_dummy_var_101 := KeSetEvent(RemoveEvent__FDO_DEVICE_DATA(Data_3), 0, 0);
    goto L15;
...
implementation {:origName "SerenumSyncCompletion"} SerenumSyncCompletion(actual_DeviceObject_19: int, actual_Irp_16: int, actual_SerenumSyncEventIn: int) returns (Tmp_387: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 711} vslice_dummy_var_103 := KeSetEvent(SerenumSyncEvent, 0, 0);
    Tmp_387 := -1073741802;
    return;
}
...
implementation {:origName "Serenum_InitPDO"} Serenum_InitPDO(actual_Pdo: int, actual_FdoData_5: int)
{
  ...
  anon0:
    call {:si_unique_call 712} vslice_dummy_var_104 := __HAVOC_malloc(4);
    Pdo := actual_Pdo;
  ...
  L11:
    ...
    assume {:nonnull} pdoData_1 != 0;
    assume pdoData_1 > 0;
    call {:si_unique_call 713} Tmp_389 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_389 != 0;
    assume Tmp_389 > 0;
    call {:si_unique_call 714} sdv_KeAcquireSpinLock(0, Tmp_389);
    assume {:nonnull} Tmp_389 != 0;
    assume Tmp_389 > 0;
    havoc oldIrql_5;
    assume {:nonnull} FdoData_5 != 0;
    ...
    assume {:nonnull} FdoData_5 != 0;
    assume FdoData_5 > 0;
    call {:si_unique_call 715} sdv_KeReleaseSpinLock(0, oldIrql_5);
    assume {:nonnull} Pdo != 0;
    assume Pdo > 0;
    assume {:nonnull} Pdo != 0;
    assume Pdo > 0;
...
implementation {:origName "Serenum_InternIoCtl"} Serenum_InternIoCtl(actual_DeviceObject_20: int, actual_Irp_17: int) returns (Tmp_393: int)
{
  ...
  anon0:
    ...
    status_20 := 0;
    call {:si_unique_call 716} irpStack_3 := sdv_IoGetCurrentIrpStackLocation(Irp_17);
  ...
  anon14_Else:
    call {:si_unique_call 717} Tmp_393 := Serenum_DispatchPassThrough(DeviceObject_20, Irp_17);
    goto anon15_Then, anon15_Else;
  ...
  anon16_Else:
    ...
    assume SLAM_guard_S_0 != SLAM_guard_S_0_init;
    call {:si_unique_call 718} SLIC_sdv_IoCompleteRequest_entry(0, Irp_17);
    goto L47;
  ...
  anon17_Else:
    ...
    call {:si_unique_call 720} Serenum_PDO_EnumMarkMissing(vslice_dummy_var_106, vslice_dummy_var_107);
    assume {:nonnull} pdoData_2 != 0;
    assume pdoData_2 > 0;
    havoc Tmp_400;
    ...
    assume Tmp_397 > 0;
    call {:si_unique_call 721} IoInvalidateDeviceRelations(0, 0);
    status_20 := 0;
    assume {:nonnull} Irp_17 != 0;
    assume Irp_17 > 0;
    goto L24;
  ...
  anon17_Then:
    call {:si_unique_call 722} Tmp_393 := Serenum_DispatchPassThrough(DeviceObject_20, Irp_17);
    goto anon18_Then, anon18_Else;
...
implementation {:origName "Serenum_DecIoCount"} Serenum_DecIoCount(actual_Data_4: int)
{
  ...
  anon0:
    call {:si_unique_call 723} vslice_dummy_var_105 := __HAVOC_malloc(4);
    Data_4 := actual_Data_4;
    call {:si_unique_call 724} Tmp_401 := __HAVOC_malloc(4);
    assume {:nonnull} Data_4 != 0;
    assume Data_4 > 0;
    assume {:nonnull} Tmp_401 != 0;
    assume Tmp_401 > 0;
    call {:si_unique_call 725} sdv_252 := sdv_InterlockedDecrement(Tmp_401);
    assume {:nonnull} Data_4 != 0;
    assume Data_4 > 0;
    assume {:nonnull} Tmp_401 != 0;
    assume Tmp_401 > 0;
  ...
  anon3_Else:
    ...
    assume {:nonnull} Data_4 != 0;
    assume Data_4 > 0;
    call {:si_unique_call 726} vslice_dummy_var_106 := KeSetEvent(RemoveEvent__FDO_DEVICE_DATA(Data_4), 0, 0);
    goto L1;
...
implementation {:origName "Serenum_DispatchPassThrough"} Serenum_DispatchPassThrough(actual_DeviceObject_21: int, actual_Irp_18: int) returns (Tmp_403: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 727} IrpStack_2 := sdv_IoGetCurrentIrpStackLocation(Irp_18);
    waitForEnum := 0;
  ...
  L19:
    call {:si_unique_call 728} sdv_IoSkipCurrentIrpStackLocation(Irp_18);
    assume {:nonnull} pFdoData != 0;
    assume pFdoData > 0;
    havoc vslice_dummy_var_108;
    call {:si_unique_call 729} rval_1 := sdv_IoCallDriver(vslice_dummy_var_108, Irp_18);
    goto anon17_Then, anon17_Else;
  ...
  anon14_Else:
    ...
    call {:si_unique_call 730} vslice_dummy_var_107 := KeReleaseSemaphore(0, 0, 1, 0);
    goto L27;
  ...
  anon13_Then:
    waitForEnum := 1;
    call {:si_unique_call 731} rval_1 := KeWaitForSingleObject(0, 0, 0, 0, 0);
    goto anon15_Then, anon15_Else;
  ...
  anon18_Else:
    ...
    assume SLAM_guard_S_0 != SLAM_guard_S_0_init;
    call {:si_unique_call 732} SLIC_sdv_IoCompleteRequest_entry(0, Irp_18);
    goto L45;
...
implementation {:origName "Serenum_IoCtl"} Serenum_IoCtl(actual_DeviceObject_22: int, actual_Irp_19: int) returns (Tmp_408: int)
{
  ...
  anon0:
    call {:si_unique_call 734} actualLength := __HAVOC_malloc(4);
    DeviceObject_22 := actual_DeviceObject_22;
    Irp_19 := actual_Irp_19;
    call {:si_unique_call 735} Tmp_411 := __HAVOC_malloc(36);
    call {:si_unique_call 736} Tmp_413 := __HAVOC_malloc(44);
    status_21 := 0;
    call {:si_unique_call 737} irpStack_4 := sdv_IoGetCurrentIrpStackLocation(Irp_19);
  ...
  anon26_Else:
    call {:si_unique_call 738} status_21 := Serenum_IncIoCount(fdoData_1);
    goto anon21_Then, anon21_Else;
  ...
  anon22_Else:
    call {:si_unique_call 739} status_21 := IoOpenDeviceRegistryKey(0, 1, 131072, 0);
    goto anon23_Then, anon23_Else;

  anon23_Else:
    assume {:partition} status_21 >= 0;
    Tmp_411 := strConst__li2bpl19;
    assume {:nonnull} Irp_19 != 0;
    assume Irp_19 > 0;
    assume {:nonnull} irpStack_4 != 0;
    assume irpStack_4 > 0;
    ...
    call {:si_unique_call 740} status_21 := Serenum_GetRegistryKeyValue(keyHandle, Tmp_411, 18, vslice_dummy_var_109, vslice_dummy_var_110, actualLength);
    goto anon24_Then, anon24_Else;
  ...
  L48:
    ...
    call {:si_unique_call 741} status_21 := Serenum_GetRegistryKeyValue(keyHandle, Tmp_413, 22, vslice_dummy_var_111, vslice_dummy_var_112, actualLength);
    goto L52;
  ...
  L52:
    ...
    assume {:nonnull} actualLength != 0;
    assume actualLength > 0;
    call {:si_unique_call 742} vslice_dummy_var_108 := ZwClose(0);
    goto L57;

  L57:
    call {:si_unique_call 743} Serenum_DecIoCount(fdoData_1);
    assume {:nonnull} Irp_19 != 0;
    assume Irp_19 > 0;
    goto anon27_Then, anon27_Else;
  ...
  anon27_Else:
    ...
    assume SLAM_guard_S_0 != SLAM_guard_S_0_init;
    call {:si_unique_call 744} SLIC_sdv_IoCompleteRequest_entry(0, Irp_19);
    goto L84;
  ...
  anon22_Then:
    call {:si_unique_call 746} Serenum_DecIoCount(fdoData_1);
    call {:si_unique_call 747} Tmp_408 := Serenum_DispatchPassThrough(DeviceObject_22, Irp_19);
    goto anon28_Then, anon28_Else;
  ...
  anon29_Else:
    assume Irp_19 == SLAM_guard_S_0;
    assume SLAM_guard_S_0 != SLAM_guard_S_0_init;
    call {:si_unique_call 748} SLIC_sdv_IoCompleteRequest_entry(0, Irp_19);
    goto L87;
  ...
  anon26_Then:
    call {:si_unique_call 750} sdv_IoSkipCurrentIrpStackLocation(Irp_19);
    assume {:nonnull} DeviceObject_22 != 0;
    assume DeviceObject_22 > 0;
    havoc Tmp_409;
    ...
    assume Tmp_409 > 0;
    havoc Tmp_412;
    call {:si_unique_call 751} Tmp_408 := sdv_IoCallDriver(Tmp_412, Irp_19);
    goto anon30_Then, anon30_Else;
...
implementation {:origName "_sdv_init4"} _sdv_init4()
{
  ...
  anon0:
    call {:si_unique_call 752} vslice_dummy_var_109 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "_sdv_init1"} _sdv_init1()
{
  ...
  anon0:
    call {:si_unique_call 753} vslice_dummy_var_110 := __HAVOC_malloc(4);
    return;
}
...
implementation Serenum_GetDevDesc_loop_L13(in_Tmp_219: int, in_c_1: int, in_Tmp_224: int, in_tail: int, in_input: int, in_output: int) returns (out_Tmp_219: int, out_c_1: int, out_Tmp_224: int, out_tail: int)
{
  ...
  anon17_Else_dummy:
    call {:si_unique_call 754} {:si_old_unique_call 1} out_Tmp_219, out_c_1, out_Tmp_224, out_tail := Serenum_GetDevDesc_loop_L13(out_Tmp_219, out_c_1, out_Tmp_224, out_tail, in_input, in_output);
    return;
}
...
implementation Serenum_GetDevPnPRev_loop_L34(in_i_2: int, in_sum: int, in_Tmp_257: int, in_c_3: int, in_delta: int, in_Tmp_264: int, in_input_2: int) returns (out_i_2: int, out_sum: int, out_Tmp_257: int, out_c_3: int, out_Tmp_264: int)
{
  ...
  anon47_Else_dummy:
    call {:si_unique_call 755} {:si_old_unique_call 1} out_i_2, out_sum, out_Tmp_257, out_c_3, out_Tmp_264 := Serenum_GetDevPnPRev_loop_L34(out_i_2, out_sum, out_Tmp_257, out_c_3, in_delta, out_Tmp_264, in_input_2);
    return;
}
...
implementation Serenum_GetDevPnPRev_loop_L76(in_i_2: int, in_Tmp_244: int, in_Tmp_251: int, in_c_3: int, in_Tmp_258: int, in_delta: int, in_Tmp_267: int, in_input_2: int) returns (out_i_2: int, out_Tmp_244: int, out_Tmp_251: int, out_c_3: int, out_Tmp_258: int, out_delta: int, out_Tmp_267: int)
{
  ...
  L_BAF_0:
    call {:si_unique_call 756} {:si_old_unique_call 1} out_i_2, out_Tmp_244, out_Tmp_251, out_c_3, out_Tmp_258, out_delta, out_Tmp_267 := Serenum_GetDevPnPRev_loop_L76(out_i_2, out_Tmp_244, out_Tmp_251, out_c_3, out_Tmp_258, out_delta, out_Tmp_267, in_input_2);
    return;
...
implementation Serenum_GetDevPnPRev_loop_L21(in_Tmp_255: int, in_c_3: int, in_Tmp_261: int, in_tail_2: int, in_input_2: int) returns (out_Tmp_255: int, out_c_3: int, out_Tmp_261: int, out_tail_2: int)
{
  ...
  anon44_Else_dummy:
    call {:si_unique_call 757} {:si_old_unique_call 1} out_Tmp_255, out_c_3, out_Tmp_261, out_tail_2 := Serenum_GetDevPnPRev_loop_L21(out_Tmp_255, out_c_3, out_Tmp_261, out_tail_2, in_input_2);
    return;
}
...
implementation Serenum_SzCopy_loop_L5(in_i_3: int, in_Tmp_270: int, in_Tmp_271: int, in_source: int, in_dest: int) returns (out_i_3: int, out_Tmp_270: int, out_Tmp_271: int)
{
  ...
  anon3_Else_dummy:
    call {:si_unique_call 758} {:si_old_unique_call 1} out_i_3, out_Tmp_270, out_Tmp_271 := Serenum_SzCopy_loop_L5(out_i_3, out_Tmp_270, out_Tmp_271, in_source, in_dest);
    return;
}
...
implementation Serenum_GetDevCompId_loop_L13(in_Tmp_277: int, in_c_4: int, in_Tmp_278: int, in_tail_3: int, in_input_3: int, in_output_3: int) returns (out_Tmp_277: int, out_c_4: int, out_Tmp_278: int, out_tail_3: int)
{
  ...
  L21_dummy:
    call {:si_unique_call 759} {:si_old_unique_call 1} out_Tmp_277, out_c_4, out_Tmp_278, out_tail_3 := Serenum_GetDevCompId_loop_L13(out_Tmp_277, out_c_4, out_Tmp_278, out_tail_3, in_input_3, in_output_3);
    return;
...
implementation Serenum_GetDevClass_loop_L13(in_Tmp_281: int, in_Tmp_283: int, in_c_5: int, in_tail_4: int, in_input_4: int, in_output_4: int) returns (out_Tmp_281: int, out_Tmp_283: int, out_c_5: int, out_tail_4: int)
{
  ...
  anon17_Else_dummy:
    call {:si_unique_call 760} {:si_old_unique_call 1} out_Tmp_281, out_Tmp_283, out_c_5, out_tail_4 := Serenum_GetDevClass_loop_L13(out_Tmp_281, out_Tmp_283, out_c_5, out_tail_4, in_input_4, in_output_4);
    return;
}
...
implementation Serenum_InitMultiString_loop_L57(in_i_4: int, in_Tmp_294: int, in_Tmp_295: int, in_unicodeString: int, in_Tmp_297: int) returns (out_i_4: int, out_Tmp_294: int, out_Tmp_295: int, out_Tmp_297: int)
{
  ...
  L62_dummy:
    call {:si_unique_call 761} {:si_old_unique_call 1} out_i_4, out_Tmp_294, out_Tmp_295, out_Tmp_297 := Serenum_InitMultiString_loop_L57(out_i_4, out_Tmp_294, out_Tmp_295, in_unicodeString, out_Tmp_297);
    return;
...
implementation Serenum_InitMultiString_loop_L47(in_i_4: int, in_Tmp_294: int, in_Tmp_295: int, in_unicodeString: int, in_Tmp_296: int, in_Tmp_297: int, in_rawString: int, in_ap: int, in_vslice_dummy_var_57: int) returns (out_i_4: int, out_Tmp_294: int, out_Tmp_295: int, out_Tmp_296: int, out_Tmp_297: int, out_rawString: int, out_vslice_dummy_var_57: int)
{
  ...
  anon19_Else:
    ...
    call {:si_unique_call 763} RtlInitAnsiString(0, 0);
    call {:si_unique_call 764} out_vslice_dummy_var_57 := RtlAnsiStringToUnicodeString(0, 0, 0);
    out_i_4 := 0;
    goto L57;

  L57:
    call {:si_unique_call 762} out_i_4, out_Tmp_294, out_Tmp_295, out_Tmp_297 := Serenum_InitMultiString_loop_L57(out_i_4, out_Tmp_294, out_Tmp_295, in_unicodeString, out_Tmp_297);
    goto L57_last;
  ...
  anon20_Then_dummy:
    call {:si_unique_call 765} {:si_old_unique_call 1} out_i_4, out_Tmp_294, out_Tmp_295, out_Tmp_296, out_Tmp_297, out_rawString, out_vslice_dummy_var_57 := Serenum_InitMultiString_loop_L47(out_i_4, out_Tmp_294, out_Tmp_295, in_unicodeString, out_Tmp_296, out_Tmp_297, out_rawString, in_ap, out_vslice_dummy_var_57);
    return;
}
...
implementation Serenum_InitMultiString_loop_L17(in_Tmp_292: int, in_Tmp_293: int, in_ansiString: int, in_multiLength: int, in_rawString: int, in_ap: int) returns (out_Tmp_292: int, out_Tmp_293: int, out_multiLength: int, out_rawString: int)
{
  ...
  anon17_Else:
    assume {:partition} out_rawString != 0;
    call {:si_unique_call 767} RtlInitAnsiString(0, 0);
    assume {:nonnull} NlsMbCodePageTag != 0;
    assume NlsMbCodePageTag > 0;
    goto anon18_Then, anon18_Else;

  anon18_Else:
    call {:si_unique_call 766} out_Tmp_293 := corral_nondet();
    goto L28;
...
implementation Serenum_GetDevOtherID_loop_L7(in_Tmp_310: int, in_c_6: int, in_Tmp_311: int, in_tail_5: int, in_input_5: int, in_output_5: int) returns (out_Tmp_310: int, out_c_6: int, out_Tmp_311: int, out_tail_5: int)
{
  ...
  anon9_Else_dummy:
    call {:si_unique_call 768} {:si_old_unique_call 1} out_Tmp_310, out_c_6, out_Tmp_311, out_tail_5 := Serenum_GetDevOtherID_loop_L7(out_Tmp_310, out_c_6, out_Tmp_311, out_tail_5, in_input_5, in_output_5);
    return;
}
...
implementation {:SIextraRecBound 8} Serenum_GetDevSerialNo_loop_L15(in_cnt: int, in_Tmp_316: int, in_Tmp_318: int, in_sdv_170: int, in_c_7: int, in_tail_6: int, in_input_6: int, in_output_7: int) returns (out_cnt: int, out_Tmp_316: int, out_Tmp_318: int, out_sdv_170: int, out_c_7: int, out_tail_6: int)
{
  ...
  anon22_Else:
    ...
    out_cnt := out_cnt + 1;
    call {:si_unique_call 769} out_sdv_170 := Serenum_HToI(out_c_7);
    goto anon23_Else;
  ...
  anon23_Else_dummy:
    call {:si_unique_call 770} {:si_old_unique_call 1} out_cnt, out_Tmp_316, out_Tmp_318, out_sdv_170, out_c_7, out_tail_6 := Serenum_GetDevSerialNo_loop_L15(out_cnt, out_Tmp_316, out_Tmp_318, out_sdv_170, out_c_7, out_tail_6, in_input_6, in_output_7);
    return;
}
...
implementation SerenumValidateID_loop_L10(in_cp: int)
{
  ...
  L_BAF_1:
    call {:si_unique_call 771} {:si_old_unique_call 1} SerenumValidateID_loop_L10(in_cp);
    return;
...
implementation Serenum_ReenumerateDevices_loop_L102(in_curTry: int, in_DSRMissing: int, in_nActual: int, in_pReadBuf: int, in_status_14: int, in_PFdoData_4: int) returns (out_curTry: int, out_status_14: int)
{
  ...
  L105:
    call {:si_unique_call 772} out_status_14 := SerenumDoEnumProtocol(in_PFdoData_4, in_pReadBuf, in_nActual, in_DSRMissing);
    goto anon171_Else;
  ...
  anon127_Else_dummy:
    call {:si_unique_call 774} {:si_old_unique_call 1} out_curTry, out_status_14 := Serenum_ReenumerateDevices_loop_L102(out_curTry, in_DSRMissing, in_nActual, in_pReadBuf, out_status_14, in_PFdoData_4);
    return;
...
implementation SerenumDoEnumProtocol_loop_L81(in_i_5: int, in_pDevStack_1: int, in_DefaultWait: int, in_ioStatusBlock: int, in_nRead: int, in_timer_1: int, in_pReadBuf_1: int, in_status_16: int, in_bitMask: int, in_event_2: int, in_PFdoData_5: int) returns (out_i_5: int, out_status_16: int)
{
  ...
  anon76_Else:
    ...
    assume in_bitMask > 0;
    call {:si_unique_call 782} out_status_16 := Serenum_IoSyncIoctlEx(1769548, 0, in_pDevStack_1, in_event_2, in_bitMask, 4, 0, 0);
    goto anon96_Else;
  ...
  anon78_Else:
    ...
    call {:si_unique_call 781} out_status_16 := Serenum_IoSyncIoctlEx(1769512, 0, in_pDevStack_1, in_event_2, 0, 0, 0, 0);
    goto anon97_Else;
  ...
  anon79_Else:
    assume {:partition} out_status_16 >= 0;
    call {:si_unique_call 780} out_status_16 := Serenum_IoSyncIoctlEx(1769524, 0, in_pDevStack_1, in_event_2, 0, 0, 0, 0);
    goto anon98_Else;
  ...
  anon80_Else:
    assume {:partition} out_status_16 >= 0;
    call {:si_unique_call 779} out_status_16 := Serenum_Wait(in_timer_1, in_DefaultWait);
    goto anon81_Else;

  anon81_Else:
    assume {:partition} out_status_16 >= 0;
    call {:si_unique_call 778} out_status_16 := Serenum_IoSyncIoctlEx(1769508, 0, in_pDevStack_1, in_event_2, 0, 0, 0, 0);
    goto anon99_Else;
  ...
  L118:
    call {:si_unique_call 776} out_status_16 := Serenum_IoSyncIoctlEx(1769520, 0, in_pDevStack_1, in_event_2, 0, 0, 0, 0);
    goto anon100_Else;
  ...
  anon84_Else:
    ...
    assume in_nRead > 0;
    call {:si_unique_call 775} out_status_16 := Serenum_ReadSerialPort(in_pReadBuf_1, 256, 240, in_nRead, in_ioStatusBlock, in_PFdoData_5);
    goto anon101_Else;
  ...
  L137_dummy:
    call {:si_unique_call 783} {:si_old_unique_call 1} out_i_5, out_status_16 := SerenumDoEnumProtocol_loop_L81(out_i_5, in_pDevStack_1, in_DefaultWait, in_ioStatusBlock, in_nRead, in_timer_1, in_pReadBuf_1, out_status_16, in_bitMask, in_event_2, in_PFdoData_5);
    return;
  ...
  anon83_Then:
    assume {:partition} out_i_5 == 0;
    call {:si_unique_call 777} out_status_16 := Serenum_Wait(in_timer_1, in_DefaultWait);
    goto anon87_Else;
...
implementation Serenum_ReadSerialPort_loop_L25(in_pIrp_2: int, in_status_17: int, in_event_3: int, in_PReadBuffer: int, in_Buflen: int, in_nActual_1: int, in_PIoStatusBlock: int, in_FdoData_4: int) returns (out_pIrp_2: int, out_status_17: int)
{
  ...
  anon20_Else:
    call {:si_unique_call 785} KeClearEvent(in_event_3);
    call {:si_unique_call 786} out_pIrp_2 := IoBuildSynchronousFsdRequest(3, 0, 0, 1, 0, 0, in_PIoStatusBlock);
    goto anon21_Else;
  ...
  anon21_Else:
    ...
    call {:si_unique_call 784} out_status_17 := sdv_IoCallDriver(vslice_dummy_var_113, out_pIrp_2);
    goto anon27_Else;
  ...
  anon22_Else:
    ...
    call {:si_unique_call 787} out_status_17 := KeWaitForSingleObject(0, 0, 0, 0, 0);
    goto anon24_Then, anon24_Else;
  ...
  anon25_Else_dummy:
    call {:si_unique_call 788} {:si_old_unique_call 1} out_pIrp_2, out_status_17 := Serenum_ReadSerialPort_loop_L25(out_pIrp_2, out_status_17, in_event_3, in_PReadBuffer, in_Buflen, in_nActual_1, in_PIoStatusBlock, in_FdoData_4);
    return;
