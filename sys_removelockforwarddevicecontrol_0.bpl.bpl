...
procedure {:origName "DispatchControl"} DispatchControl(actual_fdo: int, actual_Irp_3: int) returns (Tmp_97: int);
  modifies alloc, LockDepth, sdv_compFset, sdv_invoke_on_error, sdv_invoke_on_cancel, yogi_error;
...
implementation {:origName "DispatchControl"} DispatchControl(actual_fdo: int, actual_Irp_3: int) returns (Tmp_97: int)
{
  ...
  anon21_Else:
    ...
    call {:si_unique_call 39} status_3 := sdv_IoCallDriver(vslice_dummy_var_306, Irp_3);
  ...
  L24:
    ...
    call {:si_unique_call 41} status_3 := CompleteRequest(Irp_3, vslice_dummy_var_307, 0);
    assume {:nonnull} pdx_2 != 0;
    assume pdx_2 > 0;
...
procedure {:origName "sdv_RunDispatchDeviceControl"} {:osmodel} sdv_RunDispatchDeviceControl(actual_po: int, actual_pirp_2: int) returns (Tmp_120: int);
  modifies SLAM_guard_O_0, alloc, t, LockDepth, yogi_error, sdv_compFset, sdv_invoke_on_error, sdv_invoke_on_cancel;
...
procedure {:nohoudini} {:origName "sdv_main"} {:osmodel} sdv_main();
  modifies alloc, SLAM_guard_O_0, t, LockDepth, yogi_error, sdv_compFset, sdv_invoke_on_error, sdv_invoke_on_cancel;
  free ensures {:va_keep} yogi_error == 1 || yogi_error == old(yogi_error);
  free ensures {:va_keep} t == 1;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} false || old(t) == 0 || old(t) == 1;
...
procedure {:origName "sdv_IoSetCompletionRoutine"} {:osmodel} sdv_IoSetCompletionRoutine(actual_pirp_5: int, actual_CompletionRoutine: int, actual_Context_3: int, actual_InvokeOnSuccess: int, actual_InvokeOnError: int, actual_InvokeOnCancel: int);
  modifies alloc, sdv_compFset, sdv_invoke_on_error, sdv_invoke_on_cancel;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} false || old(t) == 0 || old(t) == 1;
  free ensures {:va_keep} alloc >= old(alloc);
  free ensures {:va_keep} false || t == 0 || t == 1;
...
procedure {:nohoudini} {:origName "main"} {:osmodel} {:entrypoint} main() returns (Tmp_144: int, dup_assertVar: bool);
  modifies alloc, SLAM_guard_O_0, t, LockDepth, yogi_error, sdv_invoke_on_error, sdv_invoke_on_cancel, sdv_compFset;
...
implementation {:origName "main"} {:osmodel} main() returns (Tmp_144: int, dup_assertVar: bool)
{
  ...
  anon0:
    ...
    call {:si_unique_call 602} vslice_dummy_var_308 := __HAVOC_malloc(216);
    call {:si_unique_call 603} vslice_dummy_var_309 := __HAVOC_malloc(44);
    call {:si_unique_call 604} vslice_dummy_var_310 := __HAVOC_malloc(44);
    call {:si_unique_call 605} vslice_dummy_var_311 := __HAVOC_malloc(44);
    call {:si_unique_call 606} vslice_dummy_var_312 := __HAVOC_malloc(44);
    call {:si_unique_call 607} vslice_dummy_var_313 := __HAVOC_malloc(96);
    call {:si_unique_call 608} vslice_dummy_var_314 := __HAVOC_malloc(96);
    call {:si_unique_call 609} vslice_dummy_var_315 := __HAVOC_malloc(116);
    call {:si_unique_call 610} vslice_dummy_var_48 := __HAVOC_malloc(4096);
    call {:si_unique_call 611} vslice_dummy_var_316 := __HAVOC_malloc(24);
    call {:si_unique_call 612} vslice_dummy_var_317 := __HAVOC_malloc(44);
    call {:si_unique_call 613} vslice_dummy_var_318 := __HAVOC_malloc(44);
    call {:si_unique_call 614} vslice_dummy_var_319 := __HAVOC_malloc(44);
    call {:si_unique_call 615} vslice_dummy_var_320 := __HAVOC_malloc(48);
    call {:si_unique_call 616} vslice_dummy_var_321 := __HAVOC_malloc(44);
    call {:si_unique_call 617} vslice_dummy_var_49 := __HAVOC_malloc(236);
    call {:si_unique_call 618} vslice_dummy_var_322 := __HAVOC_malloc(44);
    call {:si_unique_call 619} vslice_dummy_var_323 := __HAVOC_malloc(208);
    call {:si_unique_call 620} vslice_dummy_var_50 := __HAVOC_malloc(4096);
    call {:si_unique_call 621} vslice_dummy_var_324 := __HAVOC_malloc(224);
    call {:si_unique_call 622} vslice_dummy_var_51 := __HAVOC_malloc(12);
    call {:si_unique_call 623} vslice_dummy_var_325 := __HAVOC_malloc(44);
    call {:si_unique_call 624} vslice_dummy_var_326 := __HAVOC_malloc(44);
...
procedure {:origName "_sdv_init14"} {:osmodel} _sdv_init14();
  modifies alloc, sdv_invoke_on_error, sdv_invoke_on_cancel, sdv_compFset;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} false || old(t) == 0 || old(t) == 1;
  free ensures {:va_keep} alloc >= old(alloc);
  free ensures {:va_keep} false || t == 0 || t == 1;
...
procedure {:origName "IofCallDriver"} {:osmodel} IofCallDriver(actual_DeviceObject_3: int, actual_Irp_7: int) returns (Tmp_164: int);
  modifies alloc, sdv_compFset, sdv_invoke_on_error, sdv_invoke_on_cancel, LockDepth, yogi_error;
  free ensures {:va_keep} old(t) == 0 ==> yogi_error == 0;
  free ensures {:va_keep} yogi_error == 1 || yogi_error == old(yogi_error);
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} false || old(t) == 0 || old(t) == 1;
...
implementation {:origName "IofCallDriver"} {:osmodel} IofCallDriver(actual_DeviceObject_3: int, actual_Irp_7: int) returns (Tmp_164: int)
{
  ...
  anon0:
    call {:si_unique_call 649} completion_1 := __HAVOC_malloc(4);
    Irp_7 := actual_Irp_7;
  ...
  anon55_Then:
    ...
    call {:si_unique_call 650} vslice_dummy_var_26 := sdv_RunIoCompletionRoutines#1(sdv_p_devobj_fdo, Irp_7, vslice_dummy_var_327, completion_1);
  ...
  anon67_Else:
    ...
    call {:si_unique_call 651} vslice_dummy_var_29 := sdv_RunIoCompletionRoutines#1(sdv_p_devobj_fdo, Irp_7, vslice_dummy_var_328, completion_1);
  ...
  anon59_Else:
    ...
    call {:si_unique_call 652} vslice_dummy_var_27 := sdv_RunIoCompletionRoutines#1(sdv_p_devobj_fdo, Irp_7, vslice_dummy_var_329, completion_1);
  ...
  anon63_Else:
    ...
    call {:si_unique_call 653} vslice_dummy_var_28 := sdv_RunIoCompletionRoutines#1(sdv_p_devobj_fdo, Irp_7, vslice_dummy_var_330, completion_1);
...
procedure {:origName "sdv_IoCallDriver"} {:osmodel} sdv_IoCallDriver(actual_DeviceObject_5: int, actual_Irp_9: int) returns (Tmp_168: int);
  modifies alloc, sdv_compFset, sdv_invoke_on_error, sdv_invoke_on_cancel, yogi_error, LockDepth;
  free ensures {:va_keep} old(t) == 0 ==> yogi_error == 0;
  free ensures {:va_keep} yogi_error == 1 || yogi_error == old(yogi_error);
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} false || old(t) == 0 || old(t) == 1;
...
procedure {:origName "_sdv_init16"} {:osmodel} _sdv_init16();
  modifies SLAM_guard_O_0, t, LockDepth, yogi_error;
...
procedure {:origName "SLIC_ABORT_15_0"} SLIC_ABORT_15_0(actual_caller_9: int);
  modifies yogi_error;
  free ensures {:va_keep} old(LockDepth) != 0 ==> yogi_error == 1;
  free ensures {:va_keep} old(LockDepth) == 0 ==> yogi_error == 1;
  free ensures {:va_keep} old(t) == 0 ==> yogi_error == 1;
...
implementation {:origName "SLIC_ABORT_15_0"} SLIC_ABORT_15_0(actual_caller_9: int)
{
...
procedure {:origName "SLIC_ABORT_17_0"} SLIC_ABORT_17_0(actual_caller_10: int);
  modifies yogi_error;
  free ensures {:va_keep} old(LockDepth) != 0 ==> yogi_error == 1;
  free ensures {:va_keep} old(LockDepth) == 0 ==> yogi_error == 1;
  free ensures {:va_keep} old(t) == 0 ==> yogi_error == 1;
...
implementation {:origName "SLIC_ABORT_17_0"} SLIC_ABORT_17_0(actual_caller_10: int)
{
  var {:pointer} caller_10: int;

  anon0:
    caller_10 := actual_caller_10;
    call {:si_unique_call 663} SLIC_ERROR_ROUTINE(strConst__li2bpl6);
    return;
}



procedure {:origName "SLIC_ABORT_22_0"} SLIC_ABORT_22_0(actual_caller_12: int, actual_DispatchControl_1: int);
  modifies yogi_error;
  free ensures {:va_keep} old(LockDepth) != 0 ==> yogi_error == 1;
  free ensures {:va_keep} old(LockDepth) == 0 ==> yogi_error == 1;
  free ensures {:va_keep} old(t) == 0 ==> yogi_error == 1;
...
implementation {:origName "SLIC_ABORT_22_0"} SLIC_ABORT_22_0(actual_caller_12: int, actual_DispatchControl_1: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 664} SLIC_ERROR_ROUTINE(strConst__li2bpl8);
    return;
}



procedure {:origName "SLIC_sdv_IoReleaseRemoveLock_entry"} {:osmodel} SLIC_sdv_IoReleaseRemoveLock_entry(actual_caller_17: int);
...
implementation {:origName "SLIC_sdv_IoReleaseRemoveLock_entry"} {:osmodel} SLIC_sdv_IoReleaseRemoveLock_entry(actual_caller_17: int)
{
  ...
  anon8_Then:
    assume {:partition} t == 1;
    call {:si_unique_call 665} SLIC_ABORT_15_0(caller_17);
    goto anon9_Then, anon9_Else;
...
procedure {:origName "SLIC_DispatchControl_exit"} {:osmodel} SLIC_DispatchControl_exit(actual_caller_18: int, actual_DispatchControl_2: int);
  modifies yogi_error;
  free ensures {:va_keep} old(LockDepth) != 0 ==> yogi_error == 1;
  free ensures {:va_keep} old(LockDepth) == 0 ==> yogi_error == 0;
  free ensures {:va_keep} old(LockDepth) == 0 ==> yogi_error == 1;
...
implementation {:origName "SLIC_DispatchControl_exit"} {:osmodel} SLIC_DispatchControl_exit(actual_caller_18: int, actual_DispatchControl_2: int)
{
  ...
  anon7_Then:
    call {:si_unique_call 667} SLIC_ABORT_22_0(caller_18, DispatchControl_2);
    goto anon9_Then, anon9_Else;
...
procedure {:origName "SLIC_DispatchControl_entry"} {:osmodel} SLIC_DispatchControl_entry(actual_caller_20: int, actual_DispatchControl_3: int);
  modifies t;
  free ensures {:va_keep} old(t) == 0 ==> t != 0;
  free ensures {:va_keep} old(t) == 1 ==> t != 0;
  free ensures {:va_keep} t == 1;
...
implementation {:origName "SLIC_DispatchControl_entry"} {:osmodel} SLIC_DispatchControl_entry(actual_caller_20: int, actual_DispatchControl_3: int)
{
...
implementation {:origName "_sdv_init3"} _sdv_init3()
{
  ...
  anon0:
    call {:si_unique_call 672} vslice_dummy_var_33 := __HAVOC_malloc(4);
    call {:si_unique_call 673} Tmp_184 := __HAVOC_malloc(4);
...
implementation {:origName "_sdv_init4"} _sdv_init4()
{
  ...
  anon0:
    call {:si_unique_call 674} vslice_dummy_var_34 := __HAVOC_malloc(4);
    call {:si_unique_call 675} Tmp_187 := __HAVOC_malloc(4);
...
implementation {:origName "_sdv_init5"} _sdv_init5()
{
  ...
  anon0:
    call {:si_unique_call 676} vslice_dummy_var_35 := __HAVOC_malloc(4);
    call {:si_unique_call 677} Tmp_190 := __HAVOC_malloc(4);
...
implementation {:origName "_sdv_init1"} _sdv_init1()
{
  ...
  anon0:
    call {:si_unique_call 678} vslice_dummy_var_36 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "HandlePowerEvent"} HandlePowerEvent#0(actual_ctx: int, actual_event: int) returns (Tmp_21: int)
{
  ...
  anon0:
    call {:si_unique_call 679} powstate := __HAVOC_malloc(8);
    ctx := actual_ctx;
    event := actual_event;
    call {:si_unique_call 680} Tmp_24 := __HAVOC_malloc(4);
    call {:si_unique_call 681} Tmp_28 := __HAVOC_malloc(4);
    call {:si_unique_call 682} Tmp_30 := __HAVOC_malloc(4);
    call {:si_unique_call 683} Tmp_32 := __HAVOC_malloc(4);
    call {:si_unique_call 684} Tmp_39 := __HAVOC_malloc(12);
    call {:si_unique_call 685} Tmp_42 := __HAVOC_malloc(4);
    call {:si_unique_call 686} Tmp_43 := __HAVOC_malloc(4);
    loopBreak := 0;
    Irp := 0;
    stack := 0;
    pdx := 0;
  ...
  anon124_Else:
    havoc Tmp_26;
    havoc Tmp_25;
    call {:si_unique_call 687} WPP_SF_(Tmp_25, 18, Tmp_26);
    goto L22;
  ...
  anon135_Else:
    havoc Tmp_36;
    havoc Tmp_41;
    call {:si_unique_call 688} WPP_SF_D(Tmp_41, 19, Tmp_36, -1073741811);
    goto L202;
  ...
  anon125_Then:
    assume {:partition} Irp != 0;
    call {:si_unique_call 689} stack := sdv_IoGetCurrentIrpStackLocation(Irp);
  ...
  anon134_Else:
    havoc Tmp_27;
    havoc Tmp_31;
    call {:si_unique_call 690} WPP_SF_D(Tmp_31, 20, Tmp_27, -1073741811);
    goto L194;
  ...
  anon133_Else:
    havoc Tmp_40;
    havoc Tmp_34;
    call {:si_unique_call 691} WPP_SF_D(Tmp_34, 21, Tmp_40, -1073741811);
    goto L186;
  ...
  L47:
    call {:si_unique_call 692} Tmp_22, Tmp_23, postatus, Tmp_30, status, loopBreak, sysstate, Tmp_44, state_1, boogieTmp, vslice_dummy_var_37 := HandlePowerEvent#0_loop_L47(Tmp_22, Tmp_23, Irp, postatus, pdx, Tmp_30, status, loopBreak, sysstate, stack, Tmp_44, state_1, powstate, ctx, boogieTmp, vslice_dummy_var_37);
    goto L47_last;
  ...
  anon127_Else:
    havoc Tmp_37;
    havoc Tmp_35;
    call {:si_unique_call 693} WPP_SF_D(Tmp_35, 23, Tmp_37, status);
    goto L53;
  ...
  L99:
    ...
    assume {:nonnull} ctx != 0;
    assume ctx > 0;
    call {:si_unique_call 694} boogieTmp := GetLowestDevicePowerState(pdx, sysstate);
    assume {:nonnull} ctx != 0;
    assume ctx > 0;
    assume {:nonnull} stack != 0;
    assume stack > 0;
    ...
    call {:si_unique_call 695} postatus := PoRequestPowerIrp#0(vslice_dummy_var_331, vslice_dummy_var_332, powstate, li2bplFunctionConstant5, ctx, 0);
  ...
  anon132_Else:
    havoc Tmp_22;
    havoc Tmp_44;
    call {:si_unique_call 696} WPP_SF_D(Tmp_44, 22, Tmp_22, postatus);
    goto L118;
  ...
  anon119_Then:
    assume {:partition} state_1 == 4;
    call {:si_unique_call 697} PoStartNextPowerIrp(0);
    assume {:nonnull} ctx != 0;
    assume ctx > 0;
  ...
  L282:
    ...
    assume {:nonnull} ctx != 0;
    assume ctx > 0;
    call {:si_unique_call 698} sdv_IoCompleteRequest(0, 0);
    assume {:nonnull} pdx != 0;
    assume pdx > 0;
    call {:si_unique_call 699} vslice_dummy_var_37 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(pdx), Irp);
    goto anon129_Then, anon129_Else;

  anon129_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 700} ExFreePoolWithTag(0, -917680055);
    status := -1073741802;
    loopBreak := 1;
  ...
  anon121_Then:
    assume {:partition} state_1 == 2;
    call {:si_unique_call 701} PoStartNextPowerIrp(0);
    assume {:nonnull} Irp != 0;
    assume Irp > 0;
  ...
  anon122_Then:
    assume {:partition} state_1 == 1;
    call {:si_unique_call 703} status := sdv_IoAcquireRemoveLock(0, 0);
  ...
  L158:
    call {:si_unique_call 704} sdv_IoMarkIrpPending(0);
    call {:si_unique_call 705} sdv_IoCopyCurrentIrpStackLocationToNext(Irp);
    assume {:nonnull} stack != 0;
    assume stack > 0;
    goto anon108_Then, anon108_Else;

  anon108_Else:
    call {:si_unique_call 706} sdv_IoSetCompletionRoutine(Irp, li2bplFunctionConstant3, ctx, 1, 1, 1);
    goto L171;

  L171:
    call {:si_unique_call 707} PoStartNextPowerIrp(0);
    call {:si_unique_call 708} status := PoCallDriver#0(0, Irp);
  ...
  anon108_Then:
    call {:si_unique_call 709} sdv_IoSetCompletionRoutine(Irp, li2bplFunctionConstant4, ctx, 1, 1, 1);
    goto L171;
...
implementation {:origName "HandlePowerEvent"} HandlePowerEvent#1(actual_ctx: int, actual_event: int) returns (Tmp_21: int)
{
  ...
  anon0:
    call {:si_unique_call 710} powstate := __HAVOC_malloc(8);
    ctx := actual_ctx;
    event := actual_event;
    call {:si_unique_call 711} Tmp_24 := __HAVOC_malloc(4);
    call {:si_unique_call 712} Tmp_28 := __HAVOC_malloc(4);
    call {:si_unique_call 713} Tmp_30 := __HAVOC_malloc(4);
    call {:si_unique_call 714} Tmp_32 := __HAVOC_malloc(4);
    call {:si_unique_call 715} Tmp_39 := __HAVOC_malloc(12);
    call {:si_unique_call 716} Tmp_42 := __HAVOC_malloc(4);
    call {:si_unique_call 717} Tmp_43 := __HAVOC_malloc(4);
    loopBreak := 0;
    Irp := 0;
    stack := 0;
    pdx := 0;
  ...
  anon124_Else:
    havoc Tmp_26;
    havoc Tmp_25;
    call {:si_unique_call 718} WPP_SF_(Tmp_25, 18, Tmp_26);
    goto L22;
  ...
  anon135_Else:
    havoc Tmp_36;
    havoc Tmp_41;
    call {:si_unique_call 719} WPP_SF_D(Tmp_41, 19, Tmp_36, -1073741811);
    goto L202;
  ...
  anon125_Then:
    assume {:partition} Irp != 0;
    call {:si_unique_call 720} stack := sdv_IoGetCurrentIrpStackLocation(Irp);
    goto anon91_Then, anon91_Else;
  ...
  anon134_Else:
    havoc Tmp_27;
    havoc Tmp_31;
    call {:si_unique_call 721} WPP_SF_D(Tmp_31, 20, Tmp_27, -1073741811);
    goto L194;
  ...
  anon133_Else:
    havoc Tmp_40;
    havoc Tmp_34;
    call {:si_unique_call 722} WPP_SF_D(Tmp_34, 21, Tmp_40, -1073741811);
    goto L186;
  ...
  L47:
    call {:si_unique_call 723} Tmp_22, Tmp_23, postatus, Tmp_30, status, loopBreak, sysstate, Tmp_44, state_1, boogieTmp, vslice_dummy_var_38 := HandlePowerEvent#1_loop_L47(Tmp_22, Tmp_23, Irp, postatus, pdx, Tmp_30, status, loopBreak, sysstate, stack, Tmp_44, state_1, powstate, ctx, boogieTmp, vslice_dummy_var_38);
    goto L47_last;
  ...
  anon127_Else:
    havoc Tmp_37;
    havoc Tmp_35;
    call {:si_unique_call 724} WPP_SF_D(Tmp_35, 23, Tmp_37, status);
    goto L53;
  ...
  L99:
    ...
    assume {:nonnull} ctx != 0;
    assume ctx > 0;
    call {:si_unique_call 725} boogieTmp := GetLowestDevicePowerState(pdx, sysstate);
    assume {:nonnull} ctx != 0;
    assume ctx > 0;
    assume {:nonnull} stack != 0;
    assume stack > 0;
    ...
    call {:si_unique_call 726} postatus := PoRequestPowerIrp#1(vslice_dummy_var_333, vslice_dummy_var_334, powstate, li2bplFunctionConstant5, ctx, 0);
    goto anon131_Then, anon131_Else;
  ...
  anon132_Else:
    havoc Tmp_22;
    havoc Tmp_44;
    call {:si_unique_call 727} WPP_SF_D(Tmp_44, 22, Tmp_22, postatus);
    goto L118;
  ...
  anon119_Then:
    assume {:partition} state_1 == 4;
    call {:si_unique_call 728} PoStartNextPowerIrp(0);
    assume {:nonnull} ctx != 0;
    assume ctx > 0;
    goto anon103_Then, anon103_Else;
  ...
  L282:
    ...
    assume {:nonnull} pdx != 0;
    assume pdx > 0;
    call {:si_unique_call 730} vslice_dummy_var_38 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(pdx), Irp);
    goto anon129_Then, anon129_Else;

  anon129_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 731} ExFreePoolWithTag(0, -917680055);
    status := -1073741802;
    loopBreak := 1;
    goto anon129_Else_dummy;
  ...
  anon122_Then:
    assume {:partition} state_1 == 1;
    call {:si_unique_call 734} status := sdv_IoAcquireRemoveLock(0, 0);
    goto anon104_Then, anon104_Else;
  ...
  L158:
    call {:si_unique_call 735} sdv_IoMarkIrpPending(0);
    call {:si_unique_call 736} sdv_IoCopyCurrentIrpStackLocationToNext(Irp);
    assume {:nonnull} stack != 0;
    assume stack > 0;
    goto anon108_Then, anon108_Else;

  anon108_Else:
    call {:si_unique_call 737} sdv_IoSetCompletionRoutine(Irp, li2bplFunctionConstant3, ctx, 1, 1, 1);
    goto L171;

  L171:
    call {:si_unique_call 738} PoStartNextPowerIrp(0);
    call {:si_unique_call 739} status := PoCallDriver#1(0, Irp);
    goto anon128_Then, anon128_Else;
  ...
  anon108_Then:
    call {:si_unique_call 740} sdv_IoSetCompletionRoutine(Irp, li2bplFunctionConstant4, ctx, 1, 1, 1);
    goto L171;
...
implementation {:origName "PoCallDriver"} {:osmodel} PoCallDriver#0(actual_DeviceObject: int, actual_Irp_4: int) returns (Tmp_128: int)
{
  ...
  anon0:
    call {:si_unique_call 741} completion := __HAVOC_malloc(4);
    Irp_4 := actual_Irp_4;
    call {:si_unique_call 742} SLIC_PoCallDriver_entry(strConst__li2bpl3);
    goto anon73_Then, anon73_Else;
...
implementation {:origName "PoCallDriver"} {:osmodel} PoCallDriver#1(actual_DeviceObject: int, actual_Irp_4: int) returns (Tmp_128: int)
{
  ...
  anon0:
    call {:si_unique_call 743} completion := __HAVOC_malloc(4);
    Irp_4 := actual_Irp_4;
    call {:si_unique_call 744} SLIC_PoCallDriver_entry(strConst__li2bpl3);
    goto anon73_Then, anon73_Else;
  ...
  anon58_Then:
    ...
    call {:si_unique_call 745} vslice_dummy_var_39 := sdv_RunIoCompletionRoutines#0(sdv_p_devobj_fdo, Irp_4, vslice_dummy_var_335, completion);
  ...
  anon70_Else:
    ...
    call {:si_unique_call 746} vslice_dummy_var_42 := sdv_RunIoCompletionRoutines#0(sdv_p_devobj_fdo, Irp_4, vslice_dummy_var_336, completion);
  ...
  anon62_Else:
    ...
    call {:si_unique_call 747} vslice_dummy_var_40 := sdv_RunIoCompletionRoutines#0(sdv_p_devobj_fdo, Irp_4, vslice_dummy_var_337, completion);
    goto anon77_Then, anon77_Else;
  ...
  anon66_Else:
    ...
    call {:si_unique_call 748} vslice_dummy_var_41 := sdv_RunIoCompletionRoutines#0(sdv_p_devobj_fdo, Irp_4, vslice_dummy_var_338, completion);
    goto anon75_Then, anon75_Else;
...
procedure {:origName "PoCallDriver"} {:osmodel} PoCallDriver#1(actual_DeviceObject: int, actual_Irp_4: int) returns (Tmp_128: int);
  modifies alloc, yogi_error, sdv_compFset, sdv_invoke_on_error, sdv_invoke_on_cancel, LockDepth;
  free ensures {:va_keep} old(t) == 0 ==> yogi_error == 0;
  free ensures {:va_keep} yogi_error == 1 || yogi_error == old(yogi_error);
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} false || old(t) == 0 || old(t) == 1;
...
implementation {:origName "sdv_RunIoCompletionRoutines"} {:osmodel} sdv_RunIoCompletionRoutines#0(actual_DeviceObject_4: int, actual_Irp_8: int, actual_Context_6: int, actual_Completion: int) returns (Tmp_166: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 749} irpsp := sdv_IoGetNextIrpStackLocation(Irp_8);
    Status := 0;
    assume {:nonnull} irpsp != 0;
    assume irpsp > 0;
    goto anon13_Then, anon13_Else;
  ...
  anon13_Else:
    call {:si_unique_call 750} Status := MainDeviceCompletionRoutine#0(DeviceObject_4, Irp_8, Context_6);
    goto anon14_Then, anon14_Else;
  ...
  anon11_Else:
    call {:si_unique_call 751} Status := MainSystemCompletionRoutine#0(DeviceObject_4, Irp_8, Context_6);
    goto anon15_Then, anon15_Else;
  ...
  anon12_Else:
    call {:si_unique_call 752} Status := OnRequestComplete(DeviceObject_4, Irp_8, Context_6);
    assume {:nonnull} Completion != 0;
    assume Completion > 0;
    goto L45;
...
implementation {:origName "sdv_RunIoCompletionRoutines"} {:osmodel} sdv_RunIoCompletionRoutines#1(actual_DeviceObject_4: int, actual_Irp_8: int, actual_Context_6: int, actual_Completion: int) returns (Tmp_166: int)
{
  ...
  anon0:
    ...
    Context_6 := actual_Context_6;
    Completion := actual_Completion;
    call {:si_unique_call 753} irpsp := sdv_IoGetNextIrpStackLocation(Irp_8);
    Status := 0;
    assume {:nonnull} irpsp != 0;
    assume irpsp > 0;
    goto anon13_Then, anon13_Else;
  ...
  anon13_Else:
    call {:si_unique_call 754} Status := MainDeviceCompletionRoutine#1(DeviceObject_4, Irp_8, Context_6);
    goto anon14_Then, anon14_Else;
  ...
  anon11_Else:
    call {:si_unique_call 755} Status := MainSystemCompletionRoutine#1(DeviceObject_4, Irp_8, Context_6);
    goto anon15_Then, anon15_Else;
  ...
  anon12_Else:
    call {:si_unique_call 756} Status := OnRequestComplete(DeviceObject_4, Irp_8, Context_6);
    assume {:nonnull} Completion != 0;
    assume Completion > 0;
    goto L45;
...
implementation {:origName "MainDeviceCompletionRoutine"} MainDeviceCompletionRoutine#0(actual_junk_2: int, actual_Irp_2: int, actual_Context_2: int) returns (Tmp_72: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 757} Tmp_76 := __HAVOC_malloc(4);
    call {:si_unique_call 758} Tmp_77 := __HAVOC_malloc(4);
    status_2 := 0;
    ctx_3 := Context_2;
    goto anon14_Then, anon14_Else;
  ...
  anon15_Else:
    havoc Tmp_78;
    havoc Tmp_73;
    call {:si_unique_call 759} WPP_SF_(Tmp_73, 26, Tmp_78);
    goto L11;
  ...
  anon16_Else:
    call {:si_unique_call 760} sdv_IoMarkIrpPending(0);
    goto L19;

  L19:
    call {:si_unique_call 761} status_2 := HandlePowerEvent#0(ctx_3, 1);
  ...
  anon18_Else:
    havoc Tmp_75;
    havoc Tmp_79;
    call {:si_unique_call 762} WPP_SF_D(Tmp_79, 27, Tmp_75, status_2);
    goto L30;
...
implementation {:origName "MainDeviceCompletionRoutine"} MainDeviceCompletionRoutine#1(actual_junk_2: int, actual_Irp_2: int, actual_Context_2: int) returns (Tmp_72: int)
{
  ...
  anon0:
    Irp_2 := actual_Irp_2;
    Context_2 := actual_Context_2;
    call {:si_unique_call 763} Tmp_76 := __HAVOC_malloc(4);
    call {:si_unique_call 764} Tmp_77 := __HAVOC_malloc(4);
    status_2 := 0;
    ctx_3 := Context_2;
    goto anon14_Then, anon14_Else;
  ...
  anon15_Else:
    havoc Tmp_78;
    havoc Tmp_73;
    call {:si_unique_call 765} WPP_SF_(Tmp_73, 26, Tmp_78);
    goto L11;
  ...
  anon16_Else:
    call {:si_unique_call 766} sdv_IoMarkIrpPending(0);
    goto L19;

  L19:
    call {:si_unique_call 767} status_2 := HandlePowerEvent#1(ctx_3, 1);
    goto anon17_Then, anon17_Else;
  ...
  anon18_Else:
    havoc Tmp_75;
    havoc Tmp_79;
    call {:si_unique_call 768} WPP_SF_D(Tmp_79, 27, Tmp_75, status_2);
    goto L30;
...
implementation {:origName "MainSystemCompletionRoutine"} MainSystemCompletionRoutine#0(actual_junk: int, actual_Irp_1: int, actual_Context: int) returns (Tmp_45: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 769} Tmp_47 := __HAVOC_malloc(4);
    call {:si_unique_call 770} Tmp_51 := __HAVOC_malloc(4);
    status_1 := 0;
    ctx_1 := Context;
    goto anon15_Then, anon15_Else;
  ...
  anon16_Else:
    havoc Tmp_46;
    havoc Tmp_49;
    call {:si_unique_call 771} WPP_SF_(Tmp_49, 24, Tmp_46);
    goto L11;
  ...
  anon13_Else:
    call {:si_unique_call 772} sdv_IoMarkIrpPending(0);
    goto L18;
  ...
  L18:
    ...
    assume ctx_1 > 0;
    call {:si_unique_call 773} status_1 := HandlePowerEvent#0(ctx_1, 1);
    goto anon17_Then, anon17_Else;
  ...
  anon18_Else:
    havoc Tmp_50;
    havoc Tmp_48;
    call {:si_unique_call 774} WPP_SF_D(Tmp_48, 25, Tmp_50, status_1);
    goto L30;
...
implementation {:origName "MainSystemCompletionRoutine"} MainSystemCompletionRoutine#1(actual_junk: int, actual_Irp_1: int, actual_Context: int) returns (Tmp_45: int)
{
  ...
  anon0:
    Irp_1 := actual_Irp_1;
    Context := actual_Context;
    call {:si_unique_call 775} Tmp_47 := __HAVOC_malloc(4);
    call {:si_unique_call 776} Tmp_51 := __HAVOC_malloc(4);
    status_1 := 0;
    ctx_1 := Context;
    goto anon15_Then, anon15_Else;
  ...
  anon16_Else:
    havoc Tmp_46;
    havoc Tmp_49;
    call {:si_unique_call 777} WPP_SF_(Tmp_49, 24, Tmp_46);
    goto L11;
  ...
  L18:
    ...
    assume {:nonnull} ctx_1 != 0;
    assume ctx_1 > 0;
    call {:si_unique_call 779} status_1 := HandlePowerEvent#1(ctx_1, 1);
    goto anon17_Then, anon17_Else;
  ...
  anon18_Else:
    havoc Tmp_50;
    havoc Tmp_48;
    call {:si_unique_call 780} WPP_SF_D(Tmp_48, 25, Tmp_50, status_1);
    goto L30;
...
implementation {:origName "PoRequestPowerIrp"} {:osmodel} PoRequestPowerIrp#0(actual_DeviceObject_1: int, actual_MinorFunction: int, actual_SD1: int, actual_CompletionFunction: int, actual_Context_4: int, actual_Irp_6: int) returns (Tmp_142: int)
{
  ...
  anon0:
    call {:si_unique_call 781} PowerState_1 := __HAVOC_malloc(8);
  ...
  anon11_Else:
    ...
    assume {:nonnull} sdv_power_irp != 0;
    assume sdv_power_irp > 0;
    call {:si_unique_call 782} vslice_dummy_var_43 := sdv_RunPowerCompletionRoutines#0(DeviceObject_1, MinorFunction, PowerState_1, Context_4, IoStatus__IRP(sdv_power_irp), CompletionFunction);
    goto anon15_Then, anon15_Else;
...
implementation {:origName "PoRequestPowerIrp"} {:osmodel} PoRequestPowerIrp#1(actual_DeviceObject_1: int, actual_MinorFunction: int, actual_SD1: int, actual_CompletionFunction: int, actual_Context_4: int, actual_Irp_6: int) returns (Tmp_142: int)
{
  ...
  anon0:
    call {:si_unique_call 783} PowerState_1 := __HAVOC_malloc(8);
    DeviceObject_1 := actual_DeviceObject_1;
    MinorFunction := actual_MinorFunction;
    SD1 := actual_SD1;
    CompletionFunction := actual_CompletionFunction;
  ...
  anon11_Else:
    ...
    assume {:nonnull} sdv_power_irp != 0;
    assume sdv_power_irp > 0;
    call {:si_unique_call 784} vslice_dummy_var_44 := sdv_RunPowerCompletionRoutines#1(DeviceObject_1, MinorFunction, PowerState_1, Context_4, IoStatus__IRP(sdv_power_irp), CompletionFunction);
    goto anon15_Then, anon15_Else;
...
implementation {:origName "sdv_RunPowerCompletionRoutines"} {:osmodel} sdv_RunPowerCompletionRoutines#0(actual_DeviceObject_2: int, actual_MinorFunction_1: int, actual_structPtr888PowerState: int, actual_Context_5: int, actual_IoStatus: int, actual_CompletionFunction_1: int) returns (Tmp_150: int)
{
  ...
  anon0:
    call {:si_unique_call 785} PowerState := __HAVOC_malloc(8);
  ...
  anon5_Else:
    ...
    call {:si_unique_call 786} sdv_stub_power_completion_begin();
    call {:si_unique_call 787} PowerCompletionRoutine#0(DeviceObject_2, MinorFunction_1, PowerState, Context_5, IoStatus);
    goto anon6_Then, anon6_Else;
...
implementation {:origName "sdv_RunPowerCompletionRoutines"} {:osmodel} sdv_RunPowerCompletionRoutines#1(actual_DeviceObject_2: int, actual_MinorFunction_1: int, actual_structPtr888PowerState: int, actual_Context_5: int, actual_IoStatus: int, actual_CompletionFunction_1: int) returns (Tmp_150: int)
{
  ...
  anon0:
    call {:si_unique_call 788} PowerState := __HAVOC_malloc(8);
    DeviceObject_2 := actual_DeviceObject_2;
    MinorFunction_1 := actual_MinorFunction_1;
    structPtr888PowerState := actual_structPtr888PowerState;
    Context_5 := actual_Context_5;
  ...
  anon5_Else:
    assume {:partition} CompletionFunction_1 == li2bplFunctionConstant5;
    call {:si_unique_call 789} sdv_stub_power_completion_begin();
    call {:si_unique_call 790} PowerCompletionRoutine#1(DeviceObject_2, MinorFunction_1, PowerState, Context_5, IoStatus);
    goto anon6_Then, anon6_Else;
...
implementation {:origName "PowerCompletionRoutine"} PowerCompletionRoutine#0(actual_junk_1: int, actual_fcn: int, actual_structPtr888state: int, actual_Context_1: int, actual_pstatus: int)
{
  ...
  anon0:
    call {:si_unique_call 791} state := __HAVOC_malloc(8);
    call {:si_unique_call 792} vslice_dummy_var_45 := __HAVOC_malloc(4);
    ...
    assume {:nonnull} structPtr888state != 0;
    assume structPtr888state > 0;
    call {:si_unique_call 793} Tmp_54 := __HAVOC_malloc(4);
    call {:si_unique_call 794} Tmp_60 := __HAVOC_malloc(4);
    ctx_2 := Context_1;
    goto anon12_Then, anon12_Else;
  ...
  anon13_Else:
    havoc Tmp_57;
    havoc Tmp_56;
    call {:si_unique_call 795} WPP_SF_(Tmp_56, 28, Tmp_57);
    goto L9;
...
implementation {:origName "PowerCompletionRoutine"} PowerCompletionRoutine#1(actual_junk_1: int, actual_fcn: int, actual_structPtr888state: int, actual_Context_1: int, actual_pstatus: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 797} vslice_dummy_var_46 := __HAVOC_malloc(4);
    structPtr888state := actual_structPtr888state;
    Context_1 := actual_Context_1;
    pstatus := actual_pstatus;
    assume {:nonnull} state != 0;
  ...
  L9:
    ...
    assume {:nonnull} pstatus != 0;
    assume pstatus > 0;
    call {:si_unique_call 801} vslice_dummy_var_47 := HandlePowerEvent#0(ctx_2, 2);
    goto anon14_Then, anon14_Else;
  ...
  anon15_Else:
    havoc Tmp_55;
    havoc Tmp_58;
    call {:si_unique_call 802} WPP_SF_(Tmp_58, 29, Tmp_55);
    goto L1;
...
implementation HandlePowerEvent#0_loop_L47(in_Tmp_22: int, in_Tmp_23: int, in_Irp: int, in_postatus: int, in_pdx: int, in_Tmp_30: int, in_status: int, in_loopBreak: int, in_sysstate: int, in_stack: int, in_Tmp_44: int, in_state_1: int, in_powstate: int, in_ctx: int, in_boogieTmp: int, in_vslice_dummy_var_37: int) returns (out_Tmp_22: int, out_Tmp_23: int, out_postatus: int, out_Tmp_30: int, out_status: int, out_loopBreak: int, out_sysstate: int, out_Tmp_44: int, out_state_1: int, out_boogieTmp: int, out_vslice_dummy_var_37: int)
{
  ...
  anon98_Else_dummy:
    call {:si_unique_call 803} {:si_old_unique_call 1} out_Tmp_22, out_Tmp_23, out_postatus, out_Tmp_30, out_status, out_loopBreak, out_sysstate, out_Tmp_44, out_state_1, out_boogieTmp, out_vslice_dummy_var_37 := HandlePowerEvent#0_loop_L47(out_Tmp_22, out_Tmp_23, in_Irp, out_postatus, in_pdx, out_Tmp_30, out_status, out_loopBreak, out_sysstate, in_stack, out_Tmp_44, out_state_1, in_powstate, in_ctx, out_boogieTmp, out_vslice_dummy_var_37);
    return;
  ...
  L74_dummy:
    call {:si_unique_call 804} {:si_old_unique_call 2} out_Tmp_22, out_Tmp_23, out_postatus, out_Tmp_30, out_status, out_loopBreak, out_sysstate, out_Tmp_44, out_state_1, out_boogieTmp, out_vslice_dummy_var_37 := HandlePowerEvent#0_loop_L47(out_Tmp_22, out_Tmp_23, in_Irp, out_postatus, in_pdx, out_Tmp_30, out_status, out_loopBreak, out_sysstate, in_stack, out_Tmp_44, out_state_1, in_powstate, in_ctx, out_boogieTmp, out_vslice_dummy_var_37);
    return;
  ...
  anon99_Else_dummy:
    call {:si_unique_call 806} {:si_old_unique_call 4} out_Tmp_22, out_Tmp_23, out_postatus, out_Tmp_30, out_status, out_loopBreak, out_sysstate, out_Tmp_44, out_state_1, out_boogieTmp, out_vslice_dummy_var_37 := HandlePowerEvent#0_loop_L47(out_Tmp_22, out_Tmp_23, in_Irp, out_postatus, in_pdx, out_Tmp_30, out_status, out_loopBreak, out_sysstate, in_stack, out_Tmp_44, out_state_1, in_powstate, in_ctx, out_boogieTmp, out_vslice_dummy_var_37);
    return;
  ...
  L80_dummy:
    call {:si_unique_call 807} {:si_old_unique_call 5} out_Tmp_22, out_Tmp_23, out_postatus, out_Tmp_30, out_status, out_loopBreak, out_sysstate, out_Tmp_44, out_state_1, out_boogieTmp, out_vslice_dummy_var_37 := HandlePowerEvent#0_loop_L47(out_Tmp_22, out_Tmp_23, in_Irp, out_postatus, in_pdx, out_Tmp_30, out_status, out_loopBreak, out_sysstate, in_stack, out_Tmp_44, out_state_1, in_powstate, in_ctx, out_boogieTmp, out_vslice_dummy_var_37);
    return;
  ...
  anon100_Else_dummy:
    call {:si_unique_call 808} {:si_old_unique_call 6} out_Tmp_22, out_Tmp_23, out_postatus, out_Tmp_30, out_status, out_loopBreak, out_sysstate, out_Tmp_44, out_state_1, out_boogieTmp, out_vslice_dummy_var_37 := HandlePowerEvent#0_loop_L47(out_Tmp_22, out_Tmp_23, in_Irp, out_postatus, in_pdx, out_Tmp_30, out_status, out_loopBreak, out_sysstate, in_stack, out_Tmp_44, out_state_1, in_powstate, in_ctx, out_boogieTmp, out_vslice_dummy_var_37);
    return;
  ...
  anon100_Then_dummy:
    call {:si_unique_call 809} {:si_old_unique_call 7} out_Tmp_22, out_Tmp_23, out_postatus, out_Tmp_30, out_status, out_loopBreak, out_sysstate, out_Tmp_44, out_state_1, out_boogieTmp, out_vslice_dummy_var_37 := HandlePowerEvent#0_loop_L47(out_Tmp_22, out_Tmp_23, in_Irp, out_postatus, in_pdx, out_Tmp_30, out_status, out_loopBreak, out_sysstate, in_stack, out_Tmp_44, out_state_1, in_powstate, in_ctx, out_boogieTmp, out_vslice_dummy_var_37);
    return;
  ...
  L99:
    ...
    assume {:nonnull} in_ctx != 0;
    assume in_ctx > 0;
    call {:si_unique_call 811} out_boogieTmp := GetLowestDevicePowerState(in_pdx, out_sysstate);
    assume {:nonnull} in_ctx != 0;
    assume in_ctx > 0;
    assume {:nonnull} in_stack != 0;
    assume in_stack > 0;
    ...
    call {:si_unique_call 812} out_postatus := PoRequestPowerIrp#0(vslice_dummy_var_339, vslice_dummy_var_340, in_powstate, li2bplFunctionConstant5, in_ctx, 0);
    goto anon131_Else;
  ...
  anon132_Else:
    havoc out_Tmp_22;
    havoc out_Tmp_44;
    call {:si_unique_call 810} WPP_SF_D(out_Tmp_44, 22, out_Tmp_22, out_postatus);
    goto L118;
  ...
  L118_dummy:
    call {:si_unique_call 813} {:si_old_unique_call 8} out_Tmp_22, out_Tmp_23, out_postatus, out_Tmp_30, out_status, out_loopBreak, out_sysstate, out_Tmp_44, out_state_1, out_boogieTmp, out_vslice_dummy_var_37 := HandlePowerEvent#0_loop_L47(out_Tmp_22, out_Tmp_23, in_Irp, out_postatus, in_pdx, out_Tmp_30, out_status, out_loopBreak, out_sysstate, in_stack, out_Tmp_44, out_state_1, in_powstate, in_ctx, out_boogieTmp, out_vslice_dummy_var_37);
    return;
  ...
  L282:
    ...
    assume {:nonnull} in_pdx != 0;
    assume in_pdx > 0;
    call {:si_unique_call 817} out_vslice_dummy_var_37 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(in_pdx), in_Irp);
    goto anon129_Else;

  anon129_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 815} ExFreePoolWithTag(0, -917680055);
    out_status := -1073741802;
    out_loopBreak := 1;
    goto anon129_Else_dummy;
  ...
  anon121_Then_dummy:
    call {:si_unique_call 822} {:si_old_unique_call 11} out_Tmp_22, out_Tmp_23, out_postatus, out_Tmp_30, out_status, out_loopBreak, out_sysstate, out_Tmp_44, out_state_1, out_boogieTmp, out_vslice_dummy_var_37 := HandlePowerEvent#0_loop_L47(out_Tmp_22, out_Tmp_23, in_Irp, out_postatus, in_pdx, out_Tmp_30, out_status, out_loopBreak, out_sysstate, in_stack, out_Tmp_44, out_state_1, in_powstate, in_ctx, out_boogieTmp, out_vslice_dummy_var_37);
    return;

  anon122_Then:
    assume {:partition} out_state_1 == 1;
    call {:si_unique_call 823} out_status := sdv_IoAcquireRemoveLock(0, 0);
    goto anon104_Then, anon104_Else;
  ...
  anon104_Else_dummy:
    call {:si_unique_call 824} {:si_old_unique_call 12} out_Tmp_22, out_Tmp_23, out_postatus, out_Tmp_30, out_status, out_loopBreak, out_sysstate, out_Tmp_44, out_state_1, out_boogieTmp, out_vslice_dummy_var_37 := HandlePowerEvent#0_loop_L47(out_Tmp_22, out_Tmp_23, in_Irp, out_postatus, in_pdx, out_Tmp_30, out_status, out_loopBreak, out_sysstate, in_stack, out_Tmp_44, out_state_1, in_powstate, in_ctx, out_boogieTmp, out_vslice_dummy_var_37);
    return;
  ...
  L158:
    call {:si_unique_call 829} sdv_IoMarkIrpPending(0);
    call {:si_unique_call 830} sdv_IoCopyCurrentIrpStackLocationToNext(in_Irp);
    assume {:nonnull} in_stack != 0;
    assume in_stack > 0;
    goto anon108_Then, anon108_Else;

  anon108_Else:
    call {:si_unique_call 827} sdv_IoSetCompletionRoutine(in_Irp, li2bplFunctionConstant3, in_ctx, 1, 1, 1);
    goto L171;

  L171:
    call {:si_unique_call 825} PoStartNextPowerIrp(0);
    call {:si_unique_call 826} out_status := PoCallDriver#0(0, in_Irp);
    goto anon128_Else;
  ...
  anon128_Else_dummy:
    call {:si_unique_call 831} {:si_old_unique_call 13} out_Tmp_22, out_Tmp_23, out_postatus, out_Tmp_30, out_status, out_loopBreak, out_sysstate, out_Tmp_44, out_state_1, out_boogieTmp, out_vslice_dummy_var_37 := HandlePowerEvent#0_loop_L47(out_Tmp_22, out_Tmp_23, in_Irp, out_postatus, in_pdx, out_Tmp_30, out_status, out_loopBreak, out_sysstate, in_stack, out_Tmp_44, out_state_1, in_powstate, in_ctx, out_boogieTmp, out_vslice_dummy_var_37);
    return;

  anon108_Then:
    call {:si_unique_call 828} sdv_IoSetCompletionRoutine(in_Irp, li2bplFunctionConstant4, in_ctx, 1, 1, 1);
    goto L171;
...
implementation HandlePowerEvent#1_loop_L47(in_Tmp_22: int, in_Tmp_23: int, in_Irp: int, in_postatus: int, in_pdx: int, in_Tmp_30: int, in_status: int, in_loopBreak: int, in_sysstate: int, in_stack: int, in_Tmp_44: int, in_state_1: int, in_powstate: int, in_ctx: int, in_boogieTmp: int, in_vslice_dummy_var_38: int) returns (out_Tmp_22: int, out_Tmp_23: int, out_postatus: int, out_Tmp_30: int, out_status: int, out_loopBreak: int, out_sysstate: int, out_Tmp_44: int, out_state_1: int, out_boogieTmp: int, out_vslice_dummy_var_38: int)
{
  ...
  anon98_Else_dummy:
    call {:si_unique_call 832} {:si_old_unique_call 1} out_Tmp_22, out_Tmp_23, out_postatus, out_Tmp_30, out_status, out_loopBreak, out_sysstate, out_Tmp_44, out_state_1, out_boogieTmp, out_vslice_dummy_var_38 := HandlePowerEvent#1_loop_L47(out_Tmp_22, out_Tmp_23, in_Irp, out_postatus, in_pdx, out_Tmp_30, out_status, out_loopBreak, out_sysstate, in_stack, out_Tmp_44, out_state_1, in_powstate, in_ctx, out_boogieTmp, out_vslice_dummy_var_38);
    return;
  ...
  L74_dummy:
    call {:si_unique_call 833} {:si_old_unique_call 2} out_Tmp_22, out_Tmp_23, out_postatus, out_Tmp_30, out_status, out_loopBreak, out_sysstate, out_Tmp_44, out_state_1, out_boogieTmp, out_vslice_dummy_var_38 := HandlePowerEvent#1_loop_L47(out_Tmp_22, out_Tmp_23, in_Irp, out_postatus, in_pdx, out_Tmp_30, out_status, out_loopBreak, out_sysstate, in_stack, out_Tmp_44, out_state_1, in_powstate, in_ctx, out_boogieTmp, out_vslice_dummy_var_38);
    return;
  ...
  anon99_Else_dummy:
    call {:si_unique_call 835} {:si_old_unique_call 4} out_Tmp_22, out_Tmp_23, out_postatus, out_Tmp_30, out_status, out_loopBreak, out_sysstate, out_Tmp_44, out_state_1, out_boogieTmp, out_vslice_dummy_var_38 := HandlePowerEvent#1_loop_L47(out_Tmp_22, out_Tmp_23, in_Irp, out_postatus, in_pdx, out_Tmp_30, out_status, out_loopBreak, out_sysstate, in_stack, out_Tmp_44, out_state_1, in_powstate, in_ctx, out_boogieTmp, out_vslice_dummy_var_38);
    return;
  ...
  L80_dummy:
    call {:si_unique_call 836} {:si_old_unique_call 5} out_Tmp_22, out_Tmp_23, out_postatus, out_Tmp_30, out_status, out_loopBreak, out_sysstate, out_Tmp_44, out_state_1, out_boogieTmp, out_vslice_dummy_var_38 := HandlePowerEvent#1_loop_L47(out_Tmp_22, out_Tmp_23, in_Irp, out_postatus, in_pdx, out_Tmp_30, out_status, out_loopBreak, out_sysstate, in_stack, out_Tmp_44, out_state_1, in_powstate, in_ctx, out_boogieTmp, out_vslice_dummy_var_38);
    return;
  ...
  anon100_Else_dummy:
    call {:si_unique_call 837} {:si_old_unique_call 6} out_Tmp_22, out_Tmp_23, out_postatus, out_Tmp_30, out_status, out_loopBreak, out_sysstate, out_Tmp_44, out_state_1, out_boogieTmp, out_vslice_dummy_var_38 := HandlePowerEvent#1_loop_L47(out_Tmp_22, out_Tmp_23, in_Irp, out_postatus, in_pdx, out_Tmp_30, out_status, out_loopBreak, out_sysstate, in_stack, out_Tmp_44, out_state_1, in_powstate, in_ctx, out_boogieTmp, out_vslice_dummy_var_38);
    return;
  ...
  anon100_Then_dummy:
    call {:si_unique_call 838} {:si_old_unique_call 7} out_Tmp_22, out_Tmp_23, out_postatus, out_Tmp_30, out_status, out_loopBreak, out_sysstate, out_Tmp_44, out_state_1, out_boogieTmp, out_vslice_dummy_var_38 := HandlePowerEvent#1_loop_L47(out_Tmp_22, out_Tmp_23, in_Irp, out_postatus, in_pdx, out_Tmp_30, out_status, out_loopBreak, out_sysstate, in_stack, out_Tmp_44, out_state_1, in_powstate, in_ctx, out_boogieTmp, out_vslice_dummy_var_38);
    return;
  ...
  L99:
    ...
    assume {:nonnull} in_ctx != 0;
    assume in_ctx > 0;
    call {:si_unique_call 840} out_boogieTmp := GetLowestDevicePowerState(in_pdx, out_sysstate);
    assume {:nonnull} in_ctx != 0;
    assume in_ctx > 0;
    assume {:nonnull} in_stack != 0;
    assume in_stack > 0;
    ...
    call {:si_unique_call 841} out_postatus := PoRequestPowerIrp#1(vslice_dummy_var_341, vslice_dummy_var_342, in_powstate, li2bplFunctionConstant5, in_ctx, 0);
    goto anon131_Else;
  ...
  anon132_Else:
    havoc out_Tmp_22;
    havoc out_Tmp_44;
    call {:si_unique_call 839} WPP_SF_D(out_Tmp_44, 22, out_Tmp_22, out_postatus);
    goto L118;
  ...
  L118_dummy:
    call {:si_unique_call 842} {:si_old_unique_call 8} out_Tmp_22, out_Tmp_23, out_postatus, out_Tmp_30, out_status, out_loopBreak, out_sysstate, out_Tmp_44, out_state_1, out_boogieTmp, out_vslice_dummy_var_38 := HandlePowerEvent#1_loop_L47(out_Tmp_22, out_Tmp_23, in_Irp, out_postatus, in_pdx, out_Tmp_30, out_status, out_loopBreak, out_sysstate, in_stack, out_Tmp_44, out_state_1, in_powstate, in_ctx, out_boogieTmp, out_vslice_dummy_var_38);
    return;
  ...
  anon101_Then_dummy:
    call {:si_unique_call 843} {:si_old_unique_call 9} out_Tmp_22, out_Tmp_23, out_postatus, out_Tmp_30, out_status, out_loopBreak, out_sysstate, out_Tmp_44, out_state_1, out_boogieTmp, out_vslice_dummy_var_38 := HandlePowerEvent#1_loop_L47(out_Tmp_22, out_Tmp_23, in_Irp, out_postatus, in_pdx, out_Tmp_30, out_status, out_loopBreak, out_sysstate, in_stack, out_Tmp_44, out_state_1, in_powstate, in_ctx, out_boogieTmp, out_vslice_dummy_var_38);
    return;
  ...
  L282:
    ...
    assume {:nonnull} in_pdx != 0;
    assume in_pdx > 0;
    call {:si_unique_call 846} out_vslice_dummy_var_38 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(in_pdx), in_Irp);
    goto anon129_Else;

  anon129_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 844} ExFreePoolWithTag(0, -917680055);
    out_status := -1073741802;
    out_loopBreak := 1;
    goto anon129_Else_dummy;

  anon129_Else_dummy:
    call {:si_unique_call 848} {:si_old_unique_call 10} out_Tmp_22, out_Tmp_23, out_postatus, out_Tmp_30, out_status, out_loopBreak, out_sysstate, out_Tmp_44, out_state_1, out_boogieTmp, out_vslice_dummy_var_38 := HandlePowerEvent#1_loop_L47(out_Tmp_22, out_Tmp_23, in_Irp, out_postatus, in_pdx, out_Tmp_30, out_status, out_loopBreak, out_sysstate, in_stack, out_Tmp_44, out_state_1, in_powstate, in_ctx, out_boogieTmp, out_vslice_dummy_var_38);
    return;
  ...
  anon121_Then:
    assume {:partition} out_state_1 == 2;
    call {:si_unique_call 849} PoStartNextPowerIrp(0);
    assume {:nonnull} in_Irp != 0;
    assume in_Irp > 0;
  ...
  anon121_Then_dummy:
    call {:si_unique_call 851} {:si_old_unique_call 11} out_Tmp_22, out_Tmp_23, out_postatus, out_Tmp_30, out_status, out_loopBreak, out_sysstate, out_Tmp_44, out_state_1, out_boogieTmp, out_vslice_dummy_var_38 := HandlePowerEvent#1_loop_L47(out_Tmp_22, out_Tmp_23, in_Irp, out_postatus, in_pdx, out_Tmp_30, out_status, out_loopBreak, out_sysstate, in_stack, out_Tmp_44, out_state_1, in_powstate, in_ctx, out_boogieTmp, out_vslice_dummy_var_38);
    return;

  anon122_Then:
    assume {:partition} out_state_1 == 1;
    call {:si_unique_call 852} out_status := sdv_IoAcquireRemoveLock(0, 0);
    goto anon104_Then, anon104_Else;
  ...
  anon104_Else_dummy:
    call {:si_unique_call 853} {:si_old_unique_call 12} out_Tmp_22, out_Tmp_23, out_postatus, out_Tmp_30, out_status, out_loopBreak, out_sysstate, out_Tmp_44, out_state_1, out_boogieTmp, out_vslice_dummy_var_38 := HandlePowerEvent#1_loop_L47(out_Tmp_22, out_Tmp_23, in_Irp, out_postatus, in_pdx, out_Tmp_30, out_status, out_loopBreak, out_sysstate, in_stack, out_Tmp_44, out_state_1, in_powstate, in_ctx, out_boogieTmp, out_vslice_dummy_var_38);
    return;
  ...
  L158:
    call {:si_unique_call 858} sdv_IoMarkIrpPending(0);
    call {:si_unique_call 859} sdv_IoCopyCurrentIrpStackLocationToNext(in_Irp);
    assume {:nonnull} in_stack != 0;
    assume in_stack > 0;
    goto anon108_Then, anon108_Else;

  anon108_Else:
    call {:si_unique_call 856} sdv_IoSetCompletionRoutine(in_Irp, li2bplFunctionConstant3, in_ctx, 1, 1, 1);
    goto L171;

  L171:
    call {:si_unique_call 854} PoStartNextPowerIrp(0);
    call {:si_unique_call 855} out_status := PoCallDriver#1(0, in_Irp);
    goto anon128_Else;
  ...
  anon128_Else_dummy:
    call {:si_unique_call 860} {:si_old_unique_call 13} out_Tmp_22, out_Tmp_23, out_postatus, out_Tmp_30, out_status, out_loopBreak, out_sysstate, out_Tmp_44, out_state_1, out_boogieTmp, out_vslice_dummy_var_38 := HandlePowerEvent#1_loop_L47(out_Tmp_22, out_Tmp_23, in_Irp, out_postatus, in_pdx, out_Tmp_30, out_status, out_loopBreak, out_sysstate, in_stack, out_Tmp_44, out_state_1, in_powstate, in_ctx, out_boogieTmp, out_vslice_dummy_var_38);
    return;

  anon108_Then:
    call {:si_unique_call 857} sdv_IoSetCompletionRoutine(in_Irp, li2bplFunctionConstant4, in_ctx, 1, 1, 1);
    goto L171;
