...
procedure {:origName "USBPRINT_SoftReset"} USBPRINT_SoftReset(actual_DeviceObject: int) returns (Tmp_2: int);
  modifies alloc, Mem_T.CompletionRoutine__IO_STACK_LOCATION, sdv_compFset, sdv_invoke_on_success, sdv_invoke_on_error, sdv_invoke_on_cancel, s, yogi_error;
...
implementation {:origName "HPUsbIOCTLVendorSetCommand"} HPUsbIOCTLVendorSetCommand(actual_DeviceObject_1: int, actual_Irp: int) returns (Tmp_5: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 7} ntStatus_1 := HPUsbVendorSetCommand(DeviceObject_1, vslice_dummy_var_383, vslice_dummy_var_384);
...
procedure {:origName "USBPRINT_GetPortStatus"} USBPRINT_GetPortStatus(actual_DeviceObject_2: int, actual_PortStatus: int) returns (Tmp_7: int);
  modifies alloc, s, Mem_T.CompletionRoutine__IO_STACK_LOCATION, sdv_compFset, sdv_invoke_on_success, sdv_invoke_on_error, sdv_invoke_on_cancel, yogi_error;
  free ensures {:va_keep} old(s) == 2 ==> s != 0;
  free ensures {:va_keep} old(s) == 1 ==> s != 0;
  free ensures {:va_keep} old(SLAM_guard_S_0) == old(SLAM_guard_S_0_init) ==> s == old(s);
  free ensures {:va_keep} old(SLAM_guard_S_0) == old(SLAM_guard_S_0_init) ==> yogi_error == old(yogi_error);
...
implementation {:origName "USBPRINT_GetPortStatus"} USBPRINT_GetPortStatus(actual_DeviceObject_2: int, actual_PortStatus: int) returns (Tmp_7: int)
{
  ...
  anon0:
    ...
    assume PortStatus > 0;
    call {:si_unique_call 10} KeInitializeEvent(event, 0, 0);
    call {:si_unique_call 11} irp := IoBuildDeviceIoControlRequest(2228243, 0, 0, 0, 0, 0, 1, 0, ioStatus);
    goto anon7_Then, anon7_Else;

  anon7_Else:
    assume {:partition} irp != 0;
    call {:si_unique_call 12} nextStack := sdv_IoGetNextIrpStackLocation(irp);
    assume {:nonnull} nextStack != 0;
    assume nextStack > 0;
    assume {:nonnull} deviceExtension_1 != 0;
    assume deviceExtension_1 > 0;
    havoc vslice_dummy_var_385;
    call {:si_unique_call 13} ntStatus_2 := sdv_IoCallDriver#1(vslice_dummy_var_385, irp);
  ...
  anon8_Else:
    ...
    call {:si_unique_call 14} vslice_dummy_var_1 := KeWaitForSingleObject(0, 5, 0, 0, 0);
    goto L38;
...
implementation {:origName "USBPRINT_ResetParentPort"} USBPRINT_ResetParentPort(actual_DeviceObject_3: int) returns (Tmp_9: int)
{
  ...
  anon0:
    call {:si_unique_call 15} ioStatus_1 := __HAVOC_malloc(12);
    call {:si_unique_call 16} event_1 := __HAVOC_malloc(156);
    DeviceObject_3 := actual_DeviceObject_3;
    assume {:nonnull} DeviceObject_3 != 0;
    assume DeviceObject_3 > 0;
    havoc deviceExtension_2;
    call {:si_unique_call 17} KeInitializeEvent(event_1, 0, 0);
    call {:si_unique_call 18} irp_1 := IoBuildDeviceIoControlRequest(2228231, 0, 0, 0, 0, 0, 1, 0, ioStatus_1);
    goto anon7_Then, anon7_Else;

  anon7_Else:
    assume {:partition} irp_1 != 0;
    call {:si_unique_call 19} vslice_dummy_var_2 := sdv_IoGetNextIrpStackLocation(irp_1);
    assume {:nonnull} deviceExtension_2 != 0;
    assume deviceExtension_2 > 0;
    havoc vslice_dummy_var_386;
    call {:si_unique_call 20} ntStatus_3 := sdv_IoCallDriver#1(vslice_dummy_var_386, irp_1);
    goto anon9_Then, anon9_Else;
  ...
  anon8_Else:
    ...
    call {:si_unique_call 21} vslice_dummy_var_3 := KeWaitForSingleObject(0, 5, 0, 0, 0);
    goto L35;
...
implementation {:origName "USBPRINT_Get1284Id"} USBPRINT_Get1284Id(actual_DeviceObject_4: int, actual_pIoBuffer: int, actual_iLen: int) returns (Tmp_11: int)
{
  ...
  anon0:
    call {:si_unique_call 22} timeOut_1 := __HAVOC_malloc(20);
    ...
    call {:si_unique_call 23} sdv_12 := ExAllocatePoolWithTag(512, 80, -800959659);
    urb_1 := sdv_12;
  ...
  anon16_Else:
    ...
    assume timeOut_1 > 0;
    call {:si_unique_call 25} ntStatus_4 := USBPRINT_CallUSBD#1(DeviceObject_4, urb_1, timeOut_1);
  ...
  anon14_Else:
    ...
    assume Tmp_16 > 0;
    havoc iReturn;
    call {:si_unique_call 26} iReturn := corral_nondet();
    Tmp_14 := pIoBuffer;
...
implementation {:origName "USBPRINT_GetLptStatus"} USBPRINT_GetLptStatus(actual_DeviceObject_5: int) returns (Tmp_17: int)
{
  ...
  anon0:
    call {:si_unique_call 28} timeOut_2 := __HAVOC_malloc(20);
    DeviceObject_5 := actual_DeviceObject_5;
    call {:si_unique_call 29} RETURN := __HAVOC_malloc(4);
    ...
    call {:si_unique_call 30} sdv_14 := ExAllocatePoolWithTag(512, 80, -800959659);
    urb_2 := sdv_14;
    goto anon8_Then, anon8_Else;
  ...
  anon8_Else:
    ...
    assume {:nonnull} urb_2 != 0;
    assume urb_2 > 0;
    call {:si_unique_call 31} ntStatus_5 := USBPRINT_CallUSBD#1(DeviceObject_5, urb_2, timeOut_2);
    goto anon9_Then, anon9_Else;
...
implementation {:origName "HPUsbVendorGetCommand"} HPUsbVendorGetCommand(actual_DeviceObject_6: int, actual_buffer: int, actual_length: int, actual_pBytesRead: int) returns (Tmp_22: int)
{
  ...
  anon12_Else:
    ...
    size := 80;
    call {:si_unique_call 33} sdv_16 := ExAllocatePoolWithTag(512, size, -800959659);
    urb_3 := sdv_16;
    goto anon14_Then, anon14_Else;
  ...
  anon14_Else:
    ...
    assume buffer > 0;
    havoc bRequest;
    call {:si_unique_call 34} wValue := corral_nondet();
    call {:si_unique_call 35} wIndex := corral_nondet();
    ...
    assume {:nonnull} urb_3 != 0;
    assume urb_3 > 0;
    call {:si_unique_call 36} ntStatus_6 := USBPRINT_CallUSBD#1(DeviceObject_6, urb_3, 0);
    goto anon15_Then, anon15_Else;
...
procedure {:origName "USBPRINT_ProcessIOCTL"} USBPRINT_ProcessIOCTL(actual_DeviceObject_7: int, actual_Irp_1: int) returns (Tmp_24: int);
  modifies alloc, Mem_T.CompletionRoutine__IO_STACK_LOCATION, sdv_compFset, sdv_invoke_on_success, sdv_invoke_on_error, sdv_invoke_on_cancel, yogi_error, s;
  free ensures {:va_keep} old(s) == 2 ==> s != 0;
  free ensures {:va_keep} old(s) == 1 ==> s != 0;
  free ensures {:va_keep} old(SLAM_guard_S_0) == old(SLAM_guard_S_0_init) ==> s == old(s);
  free ensures {:va_keep} s == 1 || s == 2 || s == old(s);
...
implementation {:origName "USBPRINT_ProcessIOCTL"} USBPRINT_ProcessIOCTL(actual_DeviceObject_7: int, actual_Irp_1: int) returns (Tmp_24: int)
{
  ...
  anon0:
    call {:si_unique_call 38} portStatus := __HAVOC_malloc(4);
    call {:si_unique_call 39} bufferSize := __HAVOC_malloc(4);
    DeviceObject_7 := actual_DeviceObject_7;
    Irp_1 := actual_Irp_1;
    ntStatus_7 := -1073741808;
    call {:si_unique_call 40} USBPRINT_IncrementIoCount(DeviceObject_7);
  ...
  anon84_Else:
    ...
    call {:si_unique_call 41} SLIC_sdv_IoCompleteRequest_entry(strConst__li2bpl1);
  ...
  L168:
    call {:si_unique_call 42} sdv_IoCompleteRequest(0, 0);
    call {:si_unique_call 43} vslice_dummy_var_4 := USBPRINT_DecrementIoCount(DeviceObject_7);
    Tmp_24 := ntStatus_7;
    goto L1;

  L1:
    call {:si_unique_call 44} SLIC_USBPRINT_ProcessIOCTL_exit(strConst__li2bpl0, Tmp_24);
  ...
  anon90_Else:
    assume Irp_1 == SLAM_guard_S_0;
    assume SLAM_guard_S_0 != SLAM_guard_S_0_init;
    call {:si_unique_call 47} SLIC_sdv_IoCompleteRequest_entry(strConst__li2bpl1);
  ...
  L171:
    ...
    call {:si_unique_call 49} vslice_dummy_var_5 := USBPRINT_DecrementIoCount(DeviceObject_7);
    Tmp_24 := ntStatus_7;
    goto L1;
  ...
  anon78_Then:
    assume {:partition} ioControlCode == 2228284;
    call {:si_unique_call 50} ntStatus_7 := HPUsbIOCTLVendorGetCommand(DeviceObject_7, Irp_1);
  ...
  anon79_Then:
    assume {:partition} ioControlCode == 2228280;
    call {:si_unique_call 51} ntStatus_7 := HPUsbIOCTLVendorSetCommand(DeviceObject_7, Irp_1);
  ...
  anon96_Then:
    ...
    call {:si_unique_call 52} iReturn_1 := USBPRINT_Get1284Id(DeviceObject_7, ioBuffer, outputBufferLength);
  ...
  anon94_Then:
    assume {:partition} outputBufferLength >= 1;
    call {:si_unique_call 53} iReturn_2 := USBPRINT_GetLptStatus(DeviceObject_7);
  ...
  anon82_Then:
    assume {:partition} ioControlCode == 2228260;
    call {:si_unique_call 54} ntStatus_7 := USBPRINT_GetPortStatus(DeviceObject_7, portStatus);
  ...
  anon74_Else:
    call {:si_unique_call 55} vslice_dummy_var_6 := USBPRINT_ResetParentPort(DeviceObject_7);
  ...
  anon87_Then:
    ...
    assume bufferSize > 0;
    call {:si_unique_call 56} ntStatus_7 := RtlULongAdd(outputBufferLength, 3, bufferSize);
  ...
  L117:
    ...
    call {:si_unique_call 57} sdv_18 := ExAllocatePoolWithTag(512, vslice_dummy_var_387, -800959659);
    pTempBuffer := sdv_18;
  ...
  anon88_Else:
    ...
    assume bufferSize > 0;
    havoc Tmp_25;
    call {:si_unique_call 58} iReturn_3 := USBPRINT_Get1284Id(DeviceObject_7, pTempBuffer, Tmp_25);
  ...
  anon76_Else:
    ...
    Tmp_27 := iReturn_3 - 1;
    call {:si_unique_call 59} sdv_RtlCopyMemory(0, 0, Tmp_27);
    ntStatus_7 := 0;
    goto L138;

  L138:
    call {:si_unique_call 60} sdv_ExFreePool(0);
    goto L54;
  ...
  anon101_Else:
    assume Irp_1 == SLAM_guard_S_0;
    assume SLAM_guard_S_0 != SLAM_guard_S_0_init;
    call {:si_unique_call 61} SLIC_sdv_IoCompleteRequest_entry(strConst__li2bpl1);
  ...
  L174:
    ...
    call {:si_unique_call 63} vslice_dummy_var_7 := USBPRINT_DecrementIoCount(DeviceObject_7);
    Tmp_24 := ntStatus_7;
    goto L1;
...
implementation {:origName "HPUsbIOCTLVendorGetCommand"} HPUsbIOCTLVendorGetCommand(actual_DeviceObject_8: int, actual_Irp_2: int) returns (Tmp_29: int)
{
  ...
  anon0:
    call {:si_unique_call 64} bytesRead := __HAVOC_malloc(4);
    DeviceObject_8 := actual_DeviceObject_8;
    Irp_2 := actual_Irp_2;
    assume {:nonnull} bytesRead != 0;
    assume bytesRead > 0;
    call {:si_unique_call 65} currentIrpStack_1 := sdv_IoGetCurrentIrpStackLocation(Irp_2);
    ...
    call {:si_unique_call 66} ntStatus_8 := HPUsbVendorGetCommand(DeviceObject_8, vslice_dummy_var_388, vslice_dummy_var_389, bytesRead);
    goto anon3_Then, anon3_Else;
...
implementation {:origName "USBPRINT_GetSerialNumber"} USBPRINT_GetSerialNumber(actual_DeviceObject_9: int, actual_pIoBuffer_1: int, actual_iLen_1: int) returns (Tmp_31: int)
{
  ...
  anon0:
    call {:si_unique_call 67} timeOut_3 := __HAVOC_malloc(20);
    ...
    call {:si_unique_call 68} sdv_34 := ExAllocatePoolWithTag(512, 80, -800959659);
    urb_4 := sdv_34;
    goto anon11_Then, anon11_Else;
  ...
  anon11_Else:
    ...
    assume timeOut_3 > 0;
    call {:si_unique_call 69} ntStatus_9 := USBPRINT_CallUSBD#1(DeviceObject_9, urb_4, timeOut_3);
    goto anon12_Then, anon12_Else;
...
implementation {:origName "HPUsbVendorSetCommand"} HPUsbVendorSetCommand(actual_DeviceObject_10: int, actual_buffer_1: int, actual_length_1: int) returns (Tmp_34: int)
{
  ...
  anon10_Else:
    ...
    size_1 := 80;
    call {:si_unique_call 71} sdv_36 := ExAllocatePoolWithTag(512, size_1, -800959659);
    urb_5 := sdv_36;
    goto anon11_Then, anon11_Else;
  ...
  anon11_Else:
    ...
    assume buffer_1 > 0;
    havoc bRequest_1;
    call {:si_unique_call 72} wValue_1 := corral_nondet();
    call {:si_unique_call 73} wIndex_1 := corral_nondet();
    ...
    assume {:nonnull} urb_5 != 0;
    assume urb_5 > 0;
    call {:si_unique_call 74} ntStatus_10 := USBPRINT_CallUSBD#1(DeviceObject_10, urb_5, 0);
    goto anon12_Then, anon12_Else;
...
procedure {:origName "SLIC_ABORT_25_0"} SLIC_ABORT_25_0(actual_caller_2: int, actual_USBPRINT: int);
  modifies yogi_error;
...
implementation {:origName "SLIC_ABORT_25_0"} SLIC_ABORT_25_0(actual_caller_2: int, actual_USBPRINT: int)
{
  var {:pointer} caller_2: int;
  var {:scalar} USBPRINT: int;

  anon0:
    caller_2 := actual_caller_2;
    USBPRINT := actual_USBPRINT;
    call {:si_unique_call 76} SLIC_ERROR_ROUTINE(strConst__li2bpl2);
    return;
}



procedure {:origName "SLIC_USBPRINT_Close_exit"} {:osmodel} SLIC_USBPRINT_Close_exit(actual_caller_3: int, actual_USBPRINT_1: int);
  modifies yogi_error;
...
implementation {:origName "SLIC_USBPRINT_Close_exit"} {:osmodel} SLIC_USBPRINT_Close_exit(actual_caller_3: int, actual_USBPRINT_1: int)
{
  var {:pointer} caller_3: int;
  var {:scalar} USBPRINT_1: int;

  anon0:
    caller_3 := actual_caller_3;
    USBPRINT_1 := actual_USBPRINT_1;
    goto anon7_Then, anon7_Else;
  ...
  anon8_Else:
    assume {:partition} USBPRINT_1 != 259;
    call {:si_unique_call 77} SLIC_ABORT_25_0(caller_3, USBPRINT_1);
    goto anon9_Then, anon9_Else;
...
procedure {:origName "SLIC_USBPRINT_Write_exit"} {:osmodel} SLIC_USBPRINT_Write_exit(actual_caller_4: int, actual_USBPRINT_2: int);
  modifies yogi_error;
  free ensures {:va_keep} old(s) == 0 ==> yogi_error == 0;
  free ensures {:va_keep} old(s) == 1 ==> yogi_error == 0;
  free ensures {:va_keep} yogi_error == 1 || yogi_error == old(yogi_error);
...
implementation {:origName "SLIC_USBPRINT_Write_exit"} {:osmodel} SLIC_USBPRINT_Write_exit(actual_caller_4: int, actual_USBPRINT_2: int)
{
  var {:pointer} caller_4: int;
  var {:scalar} USBPRINT_2: int;

  anon0:
    caller_4 := actual_caller_4;
    USBPRINT_2 := actual_USBPRINT_2;
    goto anon7_Then, anon7_Else;
  ...
  anon8_Else:
    assume {:partition} USBPRINT_2 != 259;
    call {:si_unique_call 78} SLIC_ABORT_15_0(caller_4, USBPRINT_2);
    goto anon9_Then, anon9_Else;
...
procedure {:origName "SLIC_USBPRINT_Read_exit"} {:osmodel} SLIC_USBPRINT_Read_exit(actual_caller_7: int, actual_USBPRINT_3: int);
  modifies yogi_error;
  free ensures {:va_keep} old(s) == 0 ==> yogi_error == 0;
  free ensures {:va_keep} old(s) == 1 ==> yogi_error == 0;
  free ensures {:va_keep} yogi_error == 1 || yogi_error == old(yogi_error);
...
implementation {:origName "SLIC_USBPRINT_Read_exit"} {:osmodel} SLIC_USBPRINT_Read_exit(actual_caller_7: int, actual_USBPRINT_3: int)
{
  var {:pointer} caller_7: int;
  var {:scalar} USBPRINT_3: int;

  anon0:
    caller_7 := actual_caller_7;
    USBPRINT_3 := actual_USBPRINT_3;
    goto anon7_Then, anon7_Else;
  ...
  anon8_Else:
    assume {:partition} USBPRINT_3 != 259;
    call {:si_unique_call 79} SLIC_ABORT_19_0(caller_7, USBPRINT_3);
    goto anon9_Then, anon9_Else;
...
procedure {:origName "SLIC_sdv_IoSetCompletionRoutine_exit"} {:osmodel} SLIC_sdv_IoSetCompletionRoutine_exit(actual_caller_8: int);
...
implementation {:origName "SLIC_sdv_IoSetCompletionRoutine_exit"} {:osmodel} SLIC_sdv_IoSetCompletionRoutine_exit(actual_caller_8: int)
{
...
procedure {:origName "SLIC_ABORT_19_0"} SLIC_ABORT_19_0(actual_caller_11: int, actual_USBPRINT_4: int);
  modifies yogi_error;
  free ensures {:va_keep} old(forward_state) == 1 ==> yogi_error == 1;
  free ensures {:va_keep} old(forward_state) == 0 ==> yogi_error == 1;
  free ensures {:va_keep} old(s) == 0 ==> yogi_error == 1;
...
implementation {:origName "SLIC_ABORT_19_0"} SLIC_ABORT_19_0(actual_caller_11: int, actual_USBPRINT_4: int)
{
  var {:pointer} caller_11: int;
  var {:scalar} USBPRINT_4: int;

  anon0:
    caller_11 := actual_caller_11;
    USBPRINT_4 := actual_USBPRINT_4;
    call {:si_unique_call 80} SLIC_ERROR_ROUTINE(strConst__li2bpl2);
    return;
}



procedure {:origName "SLIC_sdv_IoCompleteRequest_entry"} {:osmodel} SLIC_sdv_IoCompleteRequest_entry(actual_caller_12: int);
  modifies yogi_error;
  free ensures {:va_keep} old(forward_state) == 1 ==> yogi_error == 1;
  free ensures {:va_keep} old(forward_state) == 0 ==> yogi_error == 1;
  free ensures {:va_keep} old(s) == 0 ==> yogi_error == 0;
...
implementation {:origName "SLIC_sdv_IoCompleteRequest_entry"} {:osmodel} SLIC_sdv_IoCompleteRequest_entry(actual_caller_12: int)
{
  ...
  anon5_Else:
    ...
    call {:si_unique_call 81} SLIC_EXIT_ROUTINE(strConst__li2bpl3);
    goto L2;
  ...
  anon5_Then:
    assume {:partition} s == 1;
    call {:si_unique_call 82} SLIC_ABORT_6_0(caller_12);
    goto anon6_Then, anon6_Else;
...
procedure {:origName "SLIC_USBPRINT_Dispatch_exit"} {:osmodel} SLIC_USBPRINT_Dispatch_exit(actual_caller_13: int, actual_USBPRINT_5: int);
  modifies yogi_error;
  free ensures {:va_keep} old(s) == 0 ==> yogi_error == 0;
  free ensures {:va_keep} old(s) == 1 ==> yogi_error == 0;
  free ensures {:va_keep} yogi_error == 1 || yogi_error == old(yogi_error);
...
implementation {:origName "SLIC_USBPRINT_Dispatch_exit"} {:osmodel} SLIC_USBPRINT_Dispatch_exit(actual_caller_13: int, actual_USBPRINT_5: int)
{
  var {:pointer} caller_13: int;
  var {:scalar} USBPRINT_5: int;

  anon0:
    caller_13 := actual_caller_13;
    USBPRINT_5 := actual_USBPRINT_5;
    goto anon7_Then, anon7_Else;
  ...
  anon8_Else:
    assume {:partition} USBPRINT_5 != 259;
    call {:si_unique_call 83} SLIC_ABORT_13_0(caller_13, USBPRINT_5);
    goto anon9_Then, anon9_Else;
...
procedure {:origName "SLIC_USBPRINT_Create_exit"} {:osmodel} SLIC_USBPRINT_Create_exit(actual_caller_14: int, actual_USBPRINT_6: int);
  modifies yogi_error;
  free ensures {:va_keep} old(s) == 0 ==> yogi_error == 0;
  free ensures {:va_keep} old(s) == 1 ==> yogi_error == 0;
  free ensures {:va_keep} yogi_error == 1 || yogi_error == old(yogi_error);
...
implementation {:origName "SLIC_USBPRINT_Create_exit"} {:osmodel} SLIC_USBPRINT_Create_exit(actual_caller_14: int, actual_USBPRINT_6: int)
{
  var {:pointer} caller_14: int;
  var {:scalar} USBPRINT_6: int;

  anon0:
    caller_14 := actual_caller_14;
    USBPRINT_6 := actual_USBPRINT_6;
    goto anon7_Then, anon7_Else;
  ...
  anon8_Else:
    assume {:partition} USBPRINT_6 != 259;
    call {:si_unique_call 84} SLIC_ABORT_23_0(caller_14, USBPRINT_6);
    goto anon9_Then, anon9_Else;
...
procedure {:origName "SLIC_USBPRINT_ProcessIOCTL_exit"} {:osmodel} SLIC_USBPRINT_ProcessIOCTL_exit(actual_caller_15: int, actual_USBPRINT_7: int);
  modifies yogi_error;
  free ensures {:va_keep} old(s) == 0 ==> yogi_error == 0;
  free ensures {:va_keep} old(s) == 1 ==> yogi_error == 0;
  free ensures {:va_keep} yogi_error == 1 || yogi_error == old(yogi_error);
...
implementation {:origName "SLIC_USBPRINT_ProcessIOCTL_exit"} {:osmodel} SLIC_USBPRINT_ProcessIOCTL_exit(actual_caller_15: int, actual_USBPRINT_7: int)
{
  var {:pointer} caller_15: int;
  var {:scalar} USBPRINT_7: int;

  anon0:
    caller_15 := actual_caller_15;
    USBPRINT_7 := actual_USBPRINT_7;
    goto anon7_Then, anon7_Else;
  ...
  anon8_Else:
    assume {:partition} USBPRINT_7 != 259;
    call {:si_unique_call 85} SLIC_ABORT_21_0(caller_15, USBPRINT_7);
    goto anon9_Then, anon9_Else;
...
procedure {:origName "SLIC_ABORT_15_0"} SLIC_ABORT_15_0(actual_caller_16: int, actual_USBPRINT_8: int);
  modifies yogi_error;
  free ensures {:va_keep} old(forward_state) == 1 ==> yogi_error == 1;
  free ensures {:va_keep} old(forward_state) == 0 ==> yogi_error == 1;
  free ensures {:va_keep} old(s) == 0 ==> yogi_error == 1;
...
implementation {:origName "SLIC_ABORT_15_0"} SLIC_ABORT_15_0(actual_caller_16: int, actual_USBPRINT_8: int)
{
  var {:pointer} caller_16: int;
  var {:scalar} USBPRINT_8: int;

  anon0:
    caller_16 := actual_caller_16;
    USBPRINT_8 := actual_USBPRINT_8;
    call {:si_unique_call 86} SLIC_ERROR_ROUTINE(strConst__li2bpl2);
    return;
}



procedure {:origName "SLIC_sdv_RunIoCompletionRoutines_exit"} {:osmodel} SLIC_sdv_RunIoCompletionRoutines_exit(actual_caller_17: int, actual_sdv_41: int, actual_sdv_42: int);
  modifies s;
...
implementation {:origName "SLIC_sdv_RunIoCompletionRoutines_exit"} {:osmodel} SLIC_sdv_RunIoCompletionRoutines_exit(actual_caller_17: int, actual_sdv_41: int, actual_sdv_42: int)
{
  ...
  anon7_Else:
    assume {:partition} sdv_42 != -1073741802;
    s := 1;
    goto L2;
  ...
  anon9_Then:
    call {:si_unique_call 87} SLIC_EXIT_ROUTINE(strConst__li2bpl3);
    goto L2;
...
procedure {:origName "SLIC_ABORT_11_0"} SLIC_ABORT_11_0(actual_caller_18: int, actual_USBPRINT_9: int);
  modifies yogi_error;
  free ensures {:va_keep} old(forward_state) == 1 ==> yogi_error == 1;
  free ensures {:va_keep} old(forward_state) == 0 ==> yogi_error == 1;
  free ensures {:va_keep} old(s) == 0 ==> yogi_error == 1;
...
implementation {:origName "SLIC_ABORT_11_0"} SLIC_ABORT_11_0(actual_caller_18: int, actual_USBPRINT_9: int)
{
  var {:pointer} caller_18: int;
  var {:scalar} USBPRINT_9: int;

  anon0:
    caller_18 := actual_caller_18;
    USBPRINT_9 := actual_USBPRINT_9;
    call {:si_unique_call 88} SLIC_ERROR_ROUTINE(strConst__li2bpl2);
    return;
}



procedure {:origName "SLIC_ABORT_17_0"} SLIC_ABORT_17_0(actual_caller_19: int, actual_USBPRINT_10: int);
  modifies yogi_error;
  free ensures {:va_keep} old(forward_state) == 1 ==> yogi_error == 1;
  free ensures {:va_keep} old(forward_state) == 0 ==> yogi_error == 1;
  free ensures {:va_keep} old(s) == 0 ==> yogi_error == 1;
...
implementation {:origName "SLIC_ABORT_17_0"} SLIC_ABORT_17_0(actual_caller_19: int, actual_USBPRINT_10: int)
{
  var {:pointer} caller_19: int;
  var {:scalar} USBPRINT_10: int;

  anon0:
    caller_19 := actual_caller_19;
    USBPRINT_10 := actual_USBPRINT_10;
...
procedure {:origName "SLIC_USBPRINT_ProcessPowerIrp_exit"} {:osmodel} SLIC_USBPRINT_ProcessPowerIrp_exit(actual_caller_20: int, actual_USBPRINT_11: int);
  modifies yogi_error;
  free ensures {:va_keep} old(s) == 0 ==> yogi_error == 0;
  free ensures {:va_keep} old(s) == 1 ==> yogi_error == 0;
  free ensures {:va_keep} yogi_error == 1 || yogi_error == old(yogi_error);
...
implementation {:origName "SLIC_USBPRINT_ProcessPowerIrp_exit"} {:osmodel} SLIC_USBPRINT_ProcessPowerIrp_exit(actual_caller_20: int, actual_USBPRINT_11: int)
{
  var {:pointer} caller_20: int;
  var {:scalar} USBPRINT_11: int;

  anon0:
    caller_20 := actual_caller_20;
    USBPRINT_11 := actual_USBPRINT_11;
    goto anon7_Then, anon7_Else;
  ...
  anon8_Else:
    assume {:partition} USBPRINT_11 != 259;
    call {:si_unique_call 90} SLIC_ABORT_11_0(caller_20, USBPRINT_11);
    goto anon9_Then, anon9_Else;
...
implementation {:origName "SLIC_ABORT_6_0"} SLIC_ABORT_6_0(actual_caller_23: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 91} SLIC_ERROR_ROUTINE(strConst__li2bpl4);
    return;
}
...
procedure {:origName "SLIC_ABORT_23_0"} SLIC_ABORT_23_0(actual_caller_25: int, actual_USBPRINT_12: int);
  modifies yogi_error;
  free ensures {:va_keep} old(forward_state) == 1 ==> yogi_error == 1;
  free ensures {:va_keep} old(forward_state) == 0 ==> yogi_error == 1;
  free ensures {:va_keep} old(s) == 0 ==> yogi_error == 1;
...
implementation {:origName "SLIC_ABORT_23_0"} SLIC_ABORT_23_0(actual_caller_25: int, actual_USBPRINT_12: int)
{
  var {:pointer} caller_25: int;
  var {:scalar} USBPRINT_12: int;

  anon0:
    caller_25 := actual_caller_25;
    USBPRINT_12 := actual_USBPRINT_12;
    call {:si_unique_call 92} SLIC_ERROR_ROUTINE(strConst__li2bpl2);
    return;
}



procedure {:origName "SLIC_USBPRINT_SystemControl_exit"} {:osmodel} SLIC_USBPRINT_SystemControl_exit(actual_caller_26: int, actual_USBPRINT_13: int);
  modifies yogi_error;
  free ensures {:va_keep} old(s) == 0 ==> yogi_error == 0;
  free ensures {:va_keep} old(s) == 1 ==> yogi_error == 0;
  free ensures {:va_keep} yogi_error == 1 || yogi_error == old(yogi_error);
...
implementation {:origName "SLIC_USBPRINT_SystemControl_exit"} {:osmodel} SLIC_USBPRINT_SystemControl_exit(actual_caller_26: int, actual_USBPRINT_13: int)
{
  var {:pointer} caller_26: int;
  var {:scalar} USBPRINT_13: int;

  anon0:
    caller_26 := actual_caller_26;
    USBPRINT_13 := actual_USBPRINT_13;
    goto anon7_Then, anon7_Else;
  ...
  anon8_Else:
    assume {:partition} USBPRINT_13 != 259;
    call {:si_unique_call 93} SLIC_ABORT_17_0(caller_26, USBPRINT_13);
    goto anon9_Then, anon9_Else;
...
procedure {:origName "SLIC_ABORT_21_0"} SLIC_ABORT_21_0(actual_caller_27: int, actual_USBPRINT_14: int);
  modifies yogi_error;
  free ensures {:va_keep} old(forward_state) == 1 ==> yogi_error == 1;
  free ensures {:va_keep} old(forward_state) == 0 ==> yogi_error == 1;
  free ensures {:va_keep} old(s) == 0 ==> yogi_error == 1;
...
implementation {:origName "SLIC_ABORT_21_0"} SLIC_ABORT_21_0(actual_caller_27: int, actual_USBPRINT_14: int)
{
  var {:pointer} caller_27: int;
  var {:scalar} USBPRINT_14: int;

  anon0:
    caller_27 := actual_caller_27;
    USBPRINT_14 := actual_USBPRINT_14;
    call {:si_unique_call 94} SLIC_ERROR_ROUTINE(strConst__li2bpl2);
    return;
}



procedure {:origName "SLIC_ABORT_13_0"} SLIC_ABORT_13_0(actual_caller_28: int, actual_USBPRINT_15: int);
  modifies yogi_error;
  free ensures {:va_keep} old(forward_state) == 1 ==> yogi_error == 1;
  free ensures {:va_keep} old(forward_state) == 0 ==> yogi_error == 1;
  free ensures {:va_keep} old(s) == 0 ==> yogi_error == 1;
...
implementation {:origName "SLIC_ABORT_13_0"} SLIC_ABORT_13_0(actual_caller_28: int, actual_USBPRINT_15: int)
{
  var {:pointer} caller_28: int;
  var {:scalar} USBPRINT_15: int;

  anon0:
    caller_28 := actual_caller_28;
    USBPRINT_15 := actual_USBPRINT_15;
    call {:si_unique_call 95} SLIC_ERROR_ROUTINE(strConst__li2bpl2);
    return;
}
...
implementation {:origName "USBPRINT_Close"} USBPRINT_Close(actual_DeviceObject_11: int, actual_Irp_3: int) returns (Tmp_49: int)
{
  ...
  anon0:
    ...
    Irp_3 := actual_Irp_3;
    call {:si_unique_call 96} USBPRINT_IncrementIoCount(DeviceObject_11);
    assume {:nonnull} DeviceObject_11 != 0;
    assume DeviceObject_11 > 0;
    havoc deviceExtension_9;
    call {:si_unique_call 97} irpStack_1 := sdv_IoGetCurrentIrpStackLocation(Irp_3);
  ...
  anon13_Else:
    ...
    assume SLAM_guard_S_0 != SLAM_guard_S_0_init;
    call {:si_unique_call 98} SLIC_sdv_IoCompleteRequest_entry(strConst__li2bpl1);
    goto anon14_Then, anon14_Else;
  ...
  L39:
    ...
    call {:si_unique_call 100} vslice_dummy_var_8 := USBPRINT_DecrementIoCount(DeviceObject_11);
    assume {:nonnull} deviceExtension_9 != 0;
    assume deviceExtension_9 > 0;
    goto anon11_Then, anon11_Else;
  ...
  L34:
    Tmp_49 := ntStatus_11;
    call {:si_unique_call 101} SLIC_USBPRINT_Close_exit(strConst__li2bpl0, Tmp_49);
    goto anon15_Then, anon15_Else;
  ...
  anon11_Then:
    call {:si_unique_call 102} vslice_dummy_var_9 := USBPRINT_FdoSubmitIdleRequestIrp(deviceExtension_9);
    goto L34;
...
implementation {:origName "USBPRINT_BuildAsyncRequest"} USBPRINT_BuildAsyncRequest(actual_DeviceObject_12: int, actual_Irp_4: int, actual_PipeHandle: int, actual_Read: int) returns (Tmp_51: int)
{
  ...
  anon7_Else:
    call {:si_unique_call 103} length_2 := sdv_MmGetMdlByteCount(0);
    siz := 72;
    call {:si_unique_call 104} sdv_76 := ExAllocatePoolWithTag(512, siz, -800959659);
    urb_6 := sdv_76;
    goto anon8_Then, anon8_Else;

  anon8_Else:
    assume {:partition} urb_6 != 0;
    call {:si_unique_call 105} sdv_RtlZeroMemory(0, siz);
...
procedure {:origName "USBPRINT_Write"} USBPRINT_Write(actual_DeviceObject_13: int, actual_Irp_5: int) returns (Tmp_54: int);
  modifies forward_state, alloc, Mem_T.CompletionRoutine__IO_STACK_LOCATION, sdv_compFset, sdv_invoke_on_success, sdv_invoke_on_error, sdv_invoke_on_cancel, yogi_error, s;
  free ensures {:va_keep} old(forward_state) == 1 ==> forward_state != 0;
  free ensures {:va_keep} old(s) == 2 ==> s != 0;
  free ensures {:va_keep} old(s) == 1 ==> s != 0;
...
implementation {:origName "USBPRINT_Write"} USBPRINT_Write(actual_DeviceObject_13: int, actual_Irp_5: int) returns (Tmp_54: int)
{
  ...
  anon0:
    ...
    urb_7 := 0;
    context := 0;
    call {:si_unique_call 106} USBPRINT_IncrementIoCount(DeviceObject_13);
  ...
  anon46_Else:
    ...
    assume {:nonnull} Irp_5 != 0;
    assume Irp_5 > 0;
    call {:si_unique_call 107} vslice_dummy_var_13 := USBPRINT_DecrementIoCount(DeviceObject_13);
    goto anon38_Then, anon38_Else;

  anon38_Else:
    assume Irp_5 == SLAM_guard_S_0;
    assume SLAM_guard_S_0 != SLAM_guard_S_0_init;
    call {:si_unique_call 108} SLIC_sdv_IoCompleteRequest_entry(strConst__li2bpl1);
  ...
  L1:
    call {:si_unique_call 110} SLIC_USBPRINT_Write_exit(strConst__li2bpl0, Tmp_54);
  ...
  anon37_Else:
    call {:si_unique_call 111} vslice_dummy_var_10 := sdv_IoGetCurrentIrpStackLocation(Irp_5);
    assume {:nonnull} deviceExtension_10 != 0;
    assume deviceExtension_10 > 0;
    havoc pipeHandle_1;
  ...
  L40:
    call {:si_unique_call 112} urb_7 := USBPRINT_BuildAsyncRequest(DeviceObject_13, Irp_5, pipeHandle_1, 0);
    goto anon40_Then, anon40_Else;

  anon40_Else:
    assume {:partition} urb_7 != 0;
    call {:si_unique_call 113} sdv_83 := ExAllocatePoolWithTag(512, 12, -800959659);
    context := sdv_83;
  ...
  anon42_Else:
    ...
    assume {:nonnull} context != 0;
    assume context > 0;
    call {:si_unique_call 115} nextStack_2 := sdv_IoGetNextIrpStackLocation(Irp_5);
    ...
    assume {:nonnull} nextStack_2 != 0;
    assume nextStack_2 > 0;
    call {:si_unique_call 116} sdv_IoSetCompletionRoutine(Irp_5, li2bplFunctionConstant623, context, 1, 1, 1);
    goto anon45_Then, anon45_Else;

  anon45_Else:
    assume Irp_5 == SLAM_guard_S_0;
    assume SLAM_guard_S_0 != SLAM_guard_S_0_init;
    call {:si_unique_call 117} SLIC_sdv_IoSetCompletionRoutine_exit(0);
    goto L70;

  L70:
    call {:si_unique_call 118} sdv_IoMarkIrpPending(0);
    assume {:nonnull} deviceExtension_10 != 0;
    assume deviceExtension_10 > 0;
    havoc vslice_dummy_var_390;
    call {:si_unique_call 119} vslice_dummy_var_11 := sdv_IoCallDriver#1(vslice_dummy_var_390, Irp_5);
  ...
  L80:
    call {:si_unique_call 120} vslice_dummy_var_12 := USBPRINT_DecrementIoCount(DeviceObject_13);
    assume {:nonnull} Irp_5 != 0;
    assume Irp_5 > 0;
    assume {:nonnull} Irp_5 != 0;
    assume Irp_5 > 0;
  ...
  anon52_Else:
    assume Irp_5 == SLAM_guard_S_0;
    assume SLAM_guard_S_0 != SLAM_guard_S_0_init;
    call {:si_unique_call 121} SLIC_sdv_IoCompleteRequest_entry(strConst__li2bpl1);
  ...
  L115:
    call {:si_unique_call 122} sdv_IoCompleteRequest(0, 0);
    goto L78;
  ...
  anon37_Then:
    ...
    assume {:nonnull} Irp_5 != 0;
    assume Irp_5 > 0;
    call {:si_unique_call 123} vslice_dummy_var_14 := USBPRINT_DecrementIoCount(DeviceObject_13);
    goto anon43_Then, anon43_Else;

  anon43_Else:
    assume Irp_5 == SLAM_guard_S_0;
    assume SLAM_guard_S_0 != SLAM_guard_S_0_init;
    call {:si_unique_call 124} SLIC_sdv_IoCompleteRequest_entry(strConst__li2bpl1);
...
implementation {:origName "USBPRINT_Read"} USBPRINT_Read(actual_DeviceObject_14: int, actual_Irp_6: int) returns (Tmp_56: int)
{
  ...
  anon0:
    ...
    urb_8 := 0;
    context_1 := 0;
    call {:si_unique_call 126} USBPRINT_IncrementIoCount(DeviceObject_14);
  ...
  anon45_Else:
    ...
    assume SLAM_guard_S_0 != SLAM_guard_S_0_init;
    call {:si_unique_call 127} SLIC_sdv_IoCompleteRequest_entry(strConst__li2bpl1);
    goto anon46_Then, anon46_Else;
  ...
  L109:
    ...
    call {:si_unique_call 129} vslice_dummy_var_15 := USBPRINT_DecrementIoCount(DeviceObject_14);
    Tmp_56 := ntStatus_13;
    goto L1;

  L1:
    call {:si_unique_call 130} SLIC_USBPRINT_Read_exit(strConst__li2bpl0, Tmp_56);
    goto anon47_Then, anon47_Else;
  ...
  anon37_Else:
    call {:si_unique_call 131} vslice_dummy_var_16 := sdv_IoGetCurrentIrpStackLocation(Irp_6);
    assume {:nonnull} deviceExtension_11 != 0;
    assume deviceExtension_11 > 0;
    havoc pipeHandle_2;
    goto anon48_Then, anon48_Else;
  ...
  L40:
    call {:si_unique_call 132} urb_8 := USBPRINT_BuildAsyncRequest(DeviceObject_14, Irp_6, pipeHandle_2, 1);
    goto anon39_Then, anon39_Else;

  anon39_Else:
    assume {:partition} urb_8 != 0;
    call {:si_unique_call 133} sdv_91 := ExAllocatePoolWithTag(512, 12, -800959659);
    context_1 := sdv_91;
    goto anon49_Then, anon49_Else;
  ...
  anon41_Else:
    ...
    assume {:nonnull} context_1 != 0;
    assume context_1 > 0;
    call {:si_unique_call 135} nextStack_3 := sdv_IoGetNextIrpStackLocation(Irp_6);
    ...
    assume {:nonnull} nextStack_3 != 0;
    assume nextStack_3 > 0;
    call {:si_unique_call 136} sdv_IoSetCompletionRoutine(Irp_6, li2bplFunctionConstant623, context_1, 1, 1, 1);
    goto anon43_Then, anon43_Else;

  anon43_Else:
    assume Irp_6 == SLAM_guard_S_0;
    assume SLAM_guard_S_0 != SLAM_guard_S_0_init;
    call {:si_unique_call 137} SLIC_sdv_IoSetCompletionRoutine_exit(0);
    goto L70;

  L70:
    call {:si_unique_call 138} sdv_IoMarkIrpPending(0);
    assume {:nonnull} deviceExtension_11 != 0;
    assume deviceExtension_11 > 0;
    havoc vslice_dummy_var_391;
    call {:si_unique_call 139} vslice_dummy_var_17 := sdv_IoCallDriver#1(vslice_dummy_var_391, Irp_6);
    goto anon50_Then, anon50_Else;
  ...
  L80:
    call {:si_unique_call 140} vslice_dummy_var_18 := USBPRINT_DecrementIoCount(DeviceObject_14);
    assume {:nonnull} Irp_6 != 0;
    assume Irp_6 > 0;
    assume {:nonnull} Irp_6 != 0;
    assume Irp_6 > 0;
  ...
  anon51_Else:
    assume Irp_6 == SLAM_guard_S_0;
    assume SLAM_guard_S_0 != SLAM_guard_S_0_init;
    call {:si_unique_call 141} SLIC_sdv_IoCompleteRequest_entry(strConst__li2bpl1);
    goto anon52_Then, anon52_Else;
  ...
  anon53_Else:
    assume Irp_6 == SLAM_guard_S_0;
    assume SLAM_guard_S_0 != SLAM_guard_S_0_init;
    call {:si_unique_call 143} SLIC_sdv_IoCompleteRequest_entry(strConst__li2bpl1);
    goto anon54_Then, anon54_Else;
  ...
  L118:
    call {:si_unique_call 144} sdv_IoCompleteRequest(0, 0);
    call {:si_unique_call 145} vslice_dummy_var_19 := USBPRINT_DecrementIoCount(DeviceObject_14);
    Tmp_56 := ntStatus_13;
    goto L1;
...
procedure {:origName "USBPRINT_Create"} USBPRINT_Create(actual_DeviceObject_15: int, actual_Irp_7: int) returns (Tmp_58: int);
  modifies alloc, yogi_error, s, Mem_T.CompletionRoutine__IO_STACK_LOCATION, sdv_compFset, sdv_invoke_on_success, sdv_invoke_on_error, sdv_invoke_on_cancel;
  free ensures {:va_keep} old(s) == 0 ==> s != 2;
  free ensures {:va_keep} old(s) == 0 ==> s != 1;
  free ensures {:va_keep} old(s) == 2 ==> s != 0;
  free ensures {:va_keep} old(s) == 2 ==> s != 1;
...
implementation {:origName "USBPRINT_Create"} USBPRINT_Create(actual_DeviceObject_15: int, actual_Irp_7: int) returns (Tmp_58: int)
{
  ...
  anon0:
    ...
    Irp_7 := actual_Irp_7;
    ntStatus_14 := 0;
    call {:si_unique_call 146} USBPRINT_IncrementIoCount(DeviceObject_15);
  ...
  anon23_Else:
    ...
    assume SLAM_guard_S_0 != SLAM_guard_S_0_init;
    call {:si_unique_call 147} SLIC_sdv_IoCompleteRequest_entry(strConst__li2bpl1);
  ...
  L56:
    ...
    call {:si_unique_call 149} vslice_dummy_var_20 := USBPRINT_DecrementIoCount(DeviceObject_15);
    Tmp_58 := ntStatus_14;
    goto L1;

  L1:
    call {:si_unique_call 150} SLIC_USBPRINT_Create_exit(strConst__li2bpl0, Tmp_58);
  ...
  anon21_Else:
    call {:si_unique_call 151} USBPRINT_FdoRequestWake(deviceExtension_12);
    goto anon26_Then, anon26_Else;

  anon26_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 152} irpStack_4 := sdv_IoGetCurrentIrpStackLocation(Irp_7);
  ...
  anon27_Else:
    assume Irp_7 == SLAM_guard_S_0;
    assume SLAM_guard_S_0 != SLAM_guard_S_0_init;
    call {:si_unique_call 153} SLIC_sdv_IoCompleteRequest_entry(strConst__li2bpl1);
  ...
  L59:
    ...
    call {:si_unique_call 155} vslice_dummy_var_21 := USBPRINT_DecrementIoCount(DeviceObject_15);
    Tmp_58 := ntStatus_14;
    goto L1;
  ...
  anon29_Else:
    assume Irp_7 == SLAM_guard_S_0;
    assume SLAM_guard_S_0 != SLAM_guard_S_0_init;
    call {:si_unique_call 156} SLIC_sdv_IoCompleteRequest_entry(strConst__li2bpl1);
  ...
  L62:
    call {:si_unique_call 157} sdv_IoCompleteRequest(0, 0);
    call {:si_unique_call 158} vslice_dummy_var_22 := USBPRINT_DecrementIoCount(DeviceObject_15);
    Tmp_58 := ntStatus_14;
    goto L1;
...
implementation {:origName "_sdv_init3"} _sdv_init3()
{
  ...
  anon0:
    call {:si_unique_call 159} vslice_dummy_var_23 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "IoFreeWorkItem"} {:osmodel} IoFreeWorkItem(actual_IoWorkItem: int)
{
  ...
  anon0:
    call {:si_unique_call 160} vslice_dummy_var_24 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "sdv_IoCopyCurrentIrpStackLocationToNext"} {:osmodel} sdv_IoCopyCurrentIrpStackLocationToNext(actual_pirp: int)
{
  ...
  anon0:
    call {:si_unique_call 161} vslice_dummy_var_25 := __HAVOC_malloc(4);
    pirp := actual_pirp;
    goto anon5_Then, anon5_Else;
...
implementation {:origName "sdv_KeAcquireSpinLock"} {:osmodel} sdv_KeAcquireSpinLock(actual_SpinLock: int, actual_p: int)
{
  ...
  anon0:
    call {:si_unique_call 162} vslice_dummy_var_26 := __HAVOC_malloc(4);
    p := actual_p;
    assume {:nonnull} p != 0;
    assume p > 0;
    return;
...
implementation {:origName "sdv_MmGetMdlByteCount"} {:osmodel} sdv_MmGetMdlByteCount(actual_Mdl: int) returns (Tmp_70: int)
{
  ...
  anon0:
    call {:si_unique_call 163} sdv_101 := __HAVOC_malloc(1);
    x := sdv_101;
    Tmp_70 := x;
    return;
}
...
implementation {:origName "IoDetachDevice"} {:osmodel} IoDetachDevice(actual_TargetDevice: int)
{
  ...
  anon0:
    call {:si_unique_call 164} vslice_dummy_var_27 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "sdv_SetPowerIrpMinorFunction"} {:osmodel} sdv_SetPowerIrpMinorFunction(actual_pirp_2: int)
{
  ...
  anon0:
    call {:si_unique_call 165} vslice_dummy_var_28 := __HAVOC_malloc(4);
...
implementation {:origName "sdv_stub_dispatch_end"} {:osmodel} sdv_stub_dispatch_end(actual_s_1: int, actual_pirp_3: int)
{
  ...
  anon0:
    call {:si_unique_call 166} vslice_dummy_var_29 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "RtlInitAnsiString"} {:osmodel} RtlInitAnsiString(actual_DestinationString: int, actual_SourceString: int)
{
  ...
  anon0:
    call {:si_unique_call 167} vslice_dummy_var_30 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "sdv_SetStatus"} {:osmodel} sdv_SetStatus(actual_pirp_4: int)
{
  ...
  anon0:
    call {:si_unique_call 168} vslice_dummy_var_31 := __HAVOC_malloc(4);
...
procedure {:nohoudini} {:origName "sdv_main"} {:osmodel} sdv_main();
  modifies alloc, SLAM_guard_S_0, Mem_T.CompletionRoutine__IO_STACK_LOCATION, forward_state, sdv_compFset, sdv_invoke_on_success, sdv_invoke_on_error, sdv_invoke_on_cancel, yogi_error, s;
  free ensures {:va_keep} s == 1 || s == 2 || s == old(s);
  free ensures {:va_keep} yogi_error == 1 || yogi_error == old(yogi_error);
  free ensures {:va_keep} forward_state == 1 || forward_state == old(forward_state);
  free ensures {:va_keep} old(yogi_error) == 0;
...
implementation {:origName "sdv_main"} {:osmodel} sdv_main()
{
  ...
  anon0:
    call {:si_unique_call 169} vslice_dummy_var_32 := __HAVOC_malloc(4);
    SLAM_guard_S_0 := sdv_irp;
    assume SLAM_guard_S_0 != 0;
    assume SLAM_guard_S_0 != SLAM_guard_S_0_init;
    call {:si_unique_call 170} sdv_stub_driver_init();
    call {:si_unique_call 171} vslice_dummy_var_33 := sdv_RunDispatchFunction(sdv_p_devobj_fdo, sdv_irp);
    goto anon3_Then, anon3_Else;
...
implementation {:origName "PoCallDriver"} {:osmodel} PoCallDriver(actual_DeviceObject_18: int, actual_Irp_9: int) returns (Tmp_92: int)
{
  ...
  anon0:
    call {:si_unique_call 172} completion := __HAVOC_malloc(4);
    Irp_9 := actual_Irp_9;
  ...
  anon64_Then:
    ...
    call {:si_unique_call 173} sdv_108 := sdv_RunIoCompletionRoutines#1(sdv_p_devobj_fdo, Irp_9, vslice_dummy_var_392, completion);
    goto anon88_Then, anon88_Else;
  ...
  anon81_Else:
    ...
    assume SLAM_guard_S_0 != SLAM_guard_S_0_init;
    call {:si_unique_call 174} SLIC_sdv_RunIoCompletionRoutines_exit(0, completion, sdv_108);
    goto L29;
  ...
  anon76_Else:
    ...
    call {:si_unique_call 175} sdv_111 := sdv_RunIoCompletionRoutines#1(sdv_p_devobj_fdo, Irp_9, vslice_dummy_var_393, completion);
    goto anon90_Then, anon90_Else;
  ...
  anon82_Else:
    assume Irp_9 == SLAM_guard_S_0;
    assume SLAM_guard_S_0 != SLAM_guard_S_0_init;
    call {:si_unique_call 176} SLIC_sdv_RunIoCompletionRoutines_exit(0, completion, sdv_111);
    goto L29;
  ...
  anon68_Else:
    ...
    call {:si_unique_call 177} sdv_109 := sdv_RunIoCompletionRoutines#1(sdv_p_devobj_fdo, Irp_9, vslice_dummy_var_394, completion);
    goto anon86_Then, anon86_Else;
  ...
  anon80_Else:
    assume Irp_9 == SLAM_guard_S_0;
    assume SLAM_guard_S_0 != SLAM_guard_S_0_init;
    call {:si_unique_call 178} SLIC_sdv_RunIoCompletionRoutines_exit(0, completion, sdv_109);
    goto L29;
  ...
  anon72_Else:
    ...
    call {:si_unique_call 179} sdv_110 := sdv_RunIoCompletionRoutines#1(sdv_p_devobj_fdo, Irp_9, vslice_dummy_var_395, completion);
    goto anon84_Then, anon84_Else;
  ...
  anon79_Else:
    assume Irp_9 == SLAM_guard_S_0;
    assume SLAM_guard_S_0 != SLAM_guard_S_0_init;
    call {:si_unique_call 180} SLIC_sdv_RunIoCompletionRoutines_exit(0, completion, sdv_110);
    goto L29;
...
implementation {:origName "sdv_IoSetCompletionRoutine"} {:osmodel} sdv_IoSetCompletionRoutine(actual_pirp_5: int, actual_CompletionRoutine: int, actual_Context_4: int, actual_InvokeOnSuccess: int, actual_InvokeOnError: int, actual_InvokeOnCancel: int)
{
  ...
  anon0:
    call {:si_unique_call 181} vslice_dummy_var_34 := __HAVOC_malloc(4);
    ...
    call {:si_unique_call 182} irpSp := sdv_IoGetNextIrpStackLocation(pirp_5);
...
implementation {:origName "PoStartNextPowerIrp"} {:osmodel} PoStartNextPowerIrp(actual_Irp_10: int)
{
  ...
  anon0:
    call {:si_unique_call 183} vslice_dummy_var_35 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "IoDeleteDevice"} {:osmodel} IoDeleteDevice(actual_DeviceObject_19: int)
{
  ...
  anon0:
    call {:si_unique_call 184} vslice_dummy_var_36 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "PoRequestPowerIrp"} {:osmodel} PoRequestPowerIrp(actual_DeviceObject_20: int, actual_MinorFunction: int, actual_SD2: int, actual_CompletionFunction: int, actual_Context_5: int, actual_Irp_11: int) returns (Tmp_110: int)
{
  ...
  anon0:
    call {:si_unique_call 186} PowerState_2 := __HAVOC_malloc(8);
  ...
  anon11_Else:
    ...
    assume {:nonnull} sdv_power_irp != 0;
    assume sdv_power_irp > 0;
    call {:si_unique_call 187} vslice_dummy_var_38 := sdv_RunPowerCompletionRoutines(DeviceObject_20, MinorFunction, PowerState_2, Context_5, IoStatus__IRP(sdv_power_irp), CompletionFunction);
    goto anon15_Then, anon15_Else;
...
procedure {:nohoudini} {:origName "main"} {:osmodel} {:entrypoint} main() returns (Tmp_112: int, dup_assertVar: bool);
  modifies alloc, SLAM_guard_S_0, forward_state, s, yogi_error, sdv_invoke_on_success, sdv_invoke_on_error, sdv_invoke_on_cancel, sdv_compFset, Mem_T.CompletionRoutine__IO_STACK_LOCATION;
...
implementation {:origName "main"} {:osmodel} main() returns (Tmp_112: int, dup_assertVar: bool)
{
  ...
  anon0:
    dup_assertVar := true;
    assume alloc > 0;
    call {:si_unique_call 188} SLAM_guard_S_0_init__Loc := __HAVOC_malloc_or_null(240);
    assume SLAM_guard_S_0_init__Loc == SLAM_guard_S_0_init;
    assume SLAM_guard_S_0_init != 0;
    call {:si_unique_call 189} sdv_harnessStackLocation_next__Loc := __HAVOC_malloc_or_null(536);
    ...
    call {:si_unique_call 191} WHEA_ERROR_PACKET_SECTION_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume WHEA_ERROR_PACKET_SECTION_GUID__Loc == WHEA_ERROR_PACKET_SECTION_GUID;
    assume WHEA_ERROR_PACKET_SECTION_GUID != 0;
    call {:si_unique_call 192} sdv_IoBuildAsynchronousFsdRequest_harnessIrp__Loc := __HAVOC_malloc_or_null(240);
    assume sdv_IoBuildAsynchronousFsdRequest_harnessIrp__Loc == sdv_IoBuildAsynchronousFsdRequest_harnessIrp;
    assume sdv_IoBuildAsynchronousFsdRequest_harnessIrp != 0;
    call {:si_unique_call 193} sdv_IoGetDeviceToVerify_DEVICE_OBJECT__Loc := __HAVOC_malloc_or_null(380);
    assume sdv_IoGetDeviceToVerify_DEVICE_OBJECT__Loc == sdv_IoGetDeviceToVerify_DEVICE_OBJECT;
    assume sdv_IoGetDeviceToVerify_DEVICE_OBJECT != 0;
    call {:si_unique_call 194} sdv_IoBuildDeviceIoControlRequest_harnessStackLocation_next__Loc := __HAVOC_malloc_or_null(536);
    assume sdv_IoBuildDeviceIoControlRequest_harnessStackLocation_next__Loc == sdv_IoBuildDeviceIoControlRequest_harnessStackLocation_next;
    assume sdv_IoBuildDeviceIoControlRequest_harnessStackLocation_next != 0;
    call {:si_unique_call 195} sdv_harness_IoBuildSynchronousFsdRequest_IoStatusBlock__Loc := __HAVOC_malloc_or_null(12);
    assume sdv_harness_IoBuildSynchronousFsdRequest_IoStatusBlock__Loc == sdv_harness_IoBuildSynchronousFsdRequest_IoStatusBlock;
    assume sdv_harness_IoBuildSynchronousFsdRequest_IoStatusBlock != 0;
    call {:si_unique_call 196} sdv_ControllerIrp__Loc := __HAVOC_malloc_or_null(240);
    assume sdv_ControllerIrp__Loc == sdv_ControllerIrp;
    assume sdv_ControllerIrp != 0;
    call {:si_unique_call 197} sdv_devobj_pdo__Loc := __HAVOC_malloc_or_null(380);
    assume sdv_devobj_pdo__Loc == sdv_devobj_pdo;
    assume sdv_devobj_pdo != 0;
    call {:si_unique_call 198} sdv_IoGetDmaAdapter_DMA_ADAPTER__Loc := __HAVOC_malloc_or_null(12);
    assume sdv_IoGetDmaAdapter_DMA_ADAPTER__Loc == sdv_IoGetDmaAdapter_DMA_ADAPTER;
    assume sdv_IoGetDmaAdapter_DMA_ADAPTER != 0;
    call {:si_unique_call 199} sdv_IoInitializeIrp_harnessIrp__Loc := __HAVOC_malloc_or_null(240);
    assume sdv_IoInitializeIrp_harnessIrp__Loc == sdv_IoInitializeIrp_harnessIrp;
    assume sdv_IoInitializeIrp_harnessIrp != 0;
    call {:si_unique_call 200} sdv_IoGetRelatedDeviceObject_DEVICE_OBJECT__Loc := __HAVOC_malloc_or_null(380);
    assume sdv_IoGetRelatedDeviceObject_DEVICE_OBJECT__Loc == sdv_IoGetRelatedDeviceObject_DEVICE_OBJECT;
    assume sdv_IoGetRelatedDeviceObject_DEVICE_OBJECT != 0;
    call {:si_unique_call 201} sdv_IoBuildSynchronousFsdRequest_harnessStackLocation_next__Loc := __HAVOC_malloc_or_null(536);
    assume sdv_IoBuildSynchronousFsdRequest_harnessStackLocation_next__Loc == sdv_IoBuildSynchronousFsdRequest_harnessStackLocation_next;
    assume sdv_IoBuildSynchronousFsdRequest_harnessStackLocation_next != 0;
    call {:si_unique_call 202} sdv_IoCreateSynchronizationEvent_KEVENT__Loc := __HAVOC_malloc_or_null(156);
    assume sdv_IoCreateSynchronizationEvent_KEVENT__Loc == sdv_IoCreateSynchronizationEvent_KEVENT;
    assume sdv_IoCreateSynchronizationEvent_KEVENT != 0;
    call {:si_unique_call 203} sdv_harnessStackLocation__Loc := __HAVOC_malloc_or_null(536);
    assume sdv_harnessStackLocation__Loc == sdv_harnessStackLocation;
    assume sdv_harnessStackLocation != 0;
    call {:si_unique_call 204} sdv_other_harnessStackLocation_next__Loc := __HAVOC_malloc_or_null(536);
    assume sdv_other_harnessStackLocation_next__Loc == sdv_other_harnessStackLocation_next;
    assume sdv_other_harnessStackLocation_next != 0;
    call {:si_unique_call 205} sdv_IoCreateController_CONTROLLER_OBJECT__Loc := __HAVOC_malloc_or_null(60);
    assume sdv_IoCreateController_CONTROLLER_OBJECT__Loc == sdv_IoCreateController_CONTROLLER_OBJECT;
    assume sdv_IoCreateController_CONTROLLER_OBJECT != 0;
    call {:si_unique_call 206} sdv_devobj_top__Loc := __HAVOC_malloc_or_null(380);
    assume sdv_devobj_top__Loc == sdv_devobj_top;
    assume sdv_devobj_top != 0;
    call {:si_unique_call 207} sdv_kdpc_val3__Loc := __HAVOC_malloc_or_null(44);
    assume sdv_kdpc_val3__Loc == sdv_kdpc_val3;
    assume sdv_kdpc_val3 != 0;
    call {:si_unique_call 208} sdv_IoBuildSynchronousFsdRequest_harnessIrp__Loc := __HAVOC_malloc_or_null(240);
    assume sdv_IoBuildSynchronousFsdRequest_harnessIrp__Loc == sdv_IoBuildSynchronousFsdRequest_harnessIrp;
    assume sdv_IoBuildSynchronousFsdRequest_harnessIrp != 0;
    call {:si_unique_call 209} sdv_IoGetDeviceObjectPointer_DEVICE_OBJECT__Loc := __HAVOC_malloc_or_null(380);
    assume sdv_IoGetDeviceObjectPointer_DEVICE_OBJECT__Loc == sdv_IoGetDeviceObjectPointer_DEVICE_OBJECT;
    assume sdv_IoGetDeviceObjectPointer_DEVICE_OBJECT != 0;
    call {:si_unique_call 210} sdv_MapRegisterBase_val__Loc := __HAVOC_malloc_or_null(4);
    assume sdv_MapRegisterBase_val__Loc == sdv_MapRegisterBase_val;
    assume sdv_MapRegisterBase_val != 0;
    call {:si_unique_call 211} sdv_IoGetFileObjectGenericMapping_GENERIC_MAPPING__Loc := __HAVOC_malloc_or_null(16);
    assume sdv_IoGetFileObjectGenericMapping_GENERIC_MAPPING__Loc == sdv_IoGetFileObjectGenericMapping_GENERIC_MAPPING;
    assume sdv_IoGetFileObjectGenericMapping_GENERIC_MAPPING != 0;
    call {:si_unique_call 212} sdv_IoMakeAssociatedIrp_harnessIrp__Loc := __HAVOC_malloc_or_null(240);
    assume sdv_IoMakeAssociatedIrp_harnessIrp__Loc == sdv_IoMakeAssociatedIrp_harnessIrp;
    assume sdv_IoMakeAssociatedIrp_harnessIrp != 0;
    call {:si_unique_call 213} sdv_devobj_child_pdo__Loc := __HAVOC_malloc_or_null(380);
    assume sdv_devobj_child_pdo__Loc == sdv_devobj_child_pdo;
    assume sdv_devobj_child_pdo != 0;
    call {:si_unique_call 214} sdv_harnessIrp__Loc := __HAVOC_malloc_or_null(240);
    assume sdv_harnessIrp__Loc == sdv_harnessIrp;
    assume sdv_harnessIrp != 0;
    call {:si_unique_call 215} sdv_IoBuildAsynchronousFsdRequest_harnessStackLocation_next__Loc := __HAVOC_malloc_or_null(536);
    assume sdv_IoBuildAsynchronousFsdRequest_harnessStackLocation_next__Loc == sdv_IoBuildAsynchronousFsdRequest_harnessStackLocation_next;
    assume sdv_IoBuildAsynchronousFsdRequest_harnessStackLocation_next != 0;
    call {:si_unique_call 216} sdv_harness_IoBuildDeviceIoControlRequest_IoStatusBlock__Loc := __HAVOC_malloc_or_null(12);
    assume sdv_harness_IoBuildDeviceIoControlRequest_IoStatusBlock__Loc == sdv_harness_IoBuildDeviceIoControlRequest_IoStatusBlock;
    assume sdv_harness_IoBuildDeviceIoControlRequest_IoStatusBlock != 0;
    call {:si_unique_call 217} sdv_kinterrupt_val__Loc := __HAVOC_malloc_or_null(0);
    assume sdv_kinterrupt_val__Loc == sdv_kinterrupt_val;
    assume sdv_kinterrupt_val != 0;
    call {:si_unique_call 218} sdv_fx_dev_object__Loc := __HAVOC_malloc_or_null(40);
    assume sdv_fx_dev_object__Loc == sdv_fx_dev_object;
    assume sdv_fx_dev_object != 0;
    call {:si_unique_call 219} sdv_devobj_fdo__Loc := __HAVOC_malloc_or_null(380);
    assume sdv_devobj_fdo__Loc == sdv_devobj_fdo;
    assume sdv_devobj_fdo != 0;
    call {:si_unique_call 220} sdv_StartIoIrp__Loc := __HAVOC_malloc_or_null(240);
    assume sdv_StartIoIrp__Loc == sdv_StartIoIrp;
    assume sdv_StartIoIrp != 0;
    call {:si_unique_call 221} sdv_harness_IoBuildAsynchronousFsdRequest_IoStatusBlock__Loc := __HAVOC_malloc_or_null(12);
    assume sdv_harness_IoBuildAsynchronousFsdRequest_IoStatusBlock__Loc == sdv_harness_IoBuildAsynchronousFsdRequest_IoStatusBlock;
    assume sdv_harness_IoBuildAsynchronousFsdRequest_IoStatusBlock != 0;
    call {:si_unique_call 222} sdv_PowerIrp__Loc := __HAVOC_malloc_or_null(240);
    assume sdv_PowerIrp__Loc == sdv_PowerIrp;
    assume sdv_PowerIrp != 0;
    call {:si_unique_call 223} sdv_IoBuildDeviceIoControlRequest_harnessIrp__Loc := __HAVOC_malloc_or_null(240);
    assume sdv_IoBuildDeviceIoControlRequest_harnessIrp__Loc == sdv_IoBuildDeviceIoControlRequest_harnessIrp;
    assume sdv_IoBuildDeviceIoControlRequest_harnessIrp != 0;
    call {:si_unique_call 224} sdv_other_harnessIrp__Loc := __HAVOC_malloc_or_null(240);
    assume sdv_other_harnessIrp__Loc == sdv_other_harnessIrp;
    assume sdv_other_harnessIrp != 0;
    call {:si_unique_call 225} sdv_IoCreateNotificationEvent_KEVENT__Loc := __HAVOC_malloc_or_null(156);
    assume sdv_IoCreateNotificationEvent_KEVENT__Loc == sdv_IoCreateNotificationEvent_KEVENT;
    assume sdv_IoCreateNotificationEvent_KEVENT != 0;
    call {:si_unique_call 226} sdv_other_harnessStackLocation__Loc := __HAVOC_malloc_or_null(536);
    assume sdv_other_harnessStackLocation__Loc == sdv_other_harnessStackLocation;
    assume sdv_other_harnessStackLocation != 0;
    call {:si_unique_call 227} GUID_PCMCIA_BUS_INTERFACE_STANDARD__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 228} GUID_BUS_TYPE_PCMCIA__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_BUS_TYPE_PCMCIA__Loc == GUID_BUS_TYPE_PCMCIA;
    assume GUID_BUS_TYPE_PCMCIA != 0;
    call {:si_unique_call 229} GUID_TRANSLATOR_INTERFACE_STANDARD__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 230} GUID_PCI_VIRTUALIZATION_INTERFACE__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 231} GUID_ARBITER_INTERFACE_STANDARD__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_ARBITER_INTERFACE_STANDARD__Loc == GUID_ARBITER_INTERFACE_STANDARD;
    assume GUID_ARBITER_INTERFACE_STANDARD != 0;
    call {:si_unique_call 232} GUID_QUERY_CRASHDUMP_FUNCTIONS__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_QUERY_CRASHDUMP_FUNCTIONS__Loc == GUID_QUERY_CRASHDUMP_FUNCTIONS;
    assume GUID_QUERY_CRASHDUMP_FUNCTIONS != 0;
    call {:si_unique_call 233} GUID_ACPI_CMOS_INTERFACE_STANDARD__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 234} GUID_BUS_TYPE_1394__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_BUS_TYPE_1394__Loc == GUID_BUS_TYPE_1394;
    assume GUID_BUS_TYPE_1394 != 0;
    call {:si_unique_call 235} GUID_AGP_TARGET_BUS_INTERFACE_STANDARD__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 236} GUID_USB_CAPABILITY_DEVICE_CONNECTION_HIGH_SPEED_COMPATIBLE__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 237} GUID_TARGET_DEVICE_REMOVE_CANCELLED__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 238} GUID_BUS_TYPE_ISAPNP__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_BUS_TYPE_ISAPNP__Loc == GUID_BUS_TYPE_ISAPNP;
    assume GUID_BUS_TYPE_ISAPNP != 0;
    call {:si_unique_call 239} GUID_MF_ENUMERATION_INTERFACE__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_MF_ENUMERATION_INTERFACE__Loc == GUID_MF_ENUMERATION_INTERFACE;
    assume GUID_MF_ENUMERATION_INTERFACE != 0;
    call {:si_unique_call 240} GUID_LEGACY_DEVICE_DETECTION_STANDARD__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 241} GUID_USB_CAPABILITY_STATIC_STREAMS__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 242} GUID_USB_CAPABILITY_FUNCTION_SUSPEND__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 243} GUID_PCC_INTERFACE_STANDARD__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_PCC_INTERFACE_STANDARD__Loc == GUID_PCC_INTERFACE_STANDARD;
    assume GUID_PCC_INTERFACE_STANDARD != 0;
    call {:si_unique_call 244} GUID_DEVINTERFACE_USB_HUB__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_DEVINTERFACE_USB_HUB__Loc == GUID_DEVINTERFACE_USB_HUB;
    assume GUID_DEVINTERFACE_USB_HUB != 0;
    call {:si_unique_call 245} GUID_BUS_INTERFACE_STANDARD__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_BUS_INTERFACE_STANDARD__Loc == GUID_BUS_INTERFACE_STANDARD;
    assume GUID_BUS_INTERFACE_STANDARD != 0;
    call {:si_unique_call 246} GUID_DEVINTERFACE_USB_DEVICE__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_DEVINTERFACE_USB_DEVICE__Loc == GUID_DEVINTERFACE_USB_DEVICE;
    assume GUID_DEVINTERFACE_USB_DEVICE != 0;
    call {:si_unique_call 247} GUID_USB_CAPABILITY_SELECTIVE_SUSPEND__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 248} GUID_PNP_POWER_SETTING_CHANGE__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_PNP_POWER_SETTING_CHANGE__Loc == GUID_PNP_POWER_SETTING_CHANGE;
    assume GUID_PNP_POWER_SETTING_CHANGE != 0;
    call {:si_unique_call 249} GUID_BUS_TYPE_ACPI__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_BUS_TYPE_ACPI__Loc == GUID_BUS_TYPE_ACPI;
    assume GUID_BUS_TYPE_ACPI != 0;
    call {:si_unique_call 250} GUID_PCI_EXPRESS_LINK_QUIESCENT_INTERFACE__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 251} GUID_BUS_TYPE_DOT4PRT__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_BUS_TYPE_DOT4PRT__Loc == GUID_BUS_TYPE_DOT4PRT;
    assume GUID_BUS_TYPE_DOT4PRT != 0;
    call {:si_unique_call 252} GUID_BUS_TYPE_EISA__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_BUS_TYPE_EISA__Loc == GUID_BUS_TYPE_EISA;
    assume GUID_BUS_TYPE_EISA != 0;
    call {:si_unique_call 253} GUID_ACPI_REGS_INTERFACE_STANDARD__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 254} GUID_TARGET_DEVICE_TRANSPORT_RELATIONS_CHANGED__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 255} GUID_ACPI_INTERFACE_STANDARD2__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_ACPI_INTERFACE_STANDARD2__Loc == GUID_ACPI_INTERFACE_STANDARD2;
    assume GUID_ACPI_INTERFACE_STANDARD2 != 0;
    call {:si_unique_call 256} GUID_PARTITION_UNIT_INTERFACE_STANDARD__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 263} GUID_PCI_DEVICE_PRESENT_INTERFACE__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 264} GUID_BUS_TYPE_MCA__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_BUS_TYPE_MCA__Loc == GUID_BUS_TYPE_MCA;
    assume GUID_BUS_TYPE_MCA != 0;
    call {:si_unique_call 265} GUID_USB_TRANSFER_TRACING__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_USB_TRANSFER_TRACING__Loc == GUID_USB_TRANSFER_TRACING;
    assume GUID_USB_TRANSFER_TRACING != 0;
    call {:si_unique_call 266} GUID_POWER_DEVICE_TIMEOUTS__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_POWER_DEVICE_TIMEOUTS__Loc == GUID_POWER_DEVICE_TIMEOUTS;
    assume GUID_POWER_DEVICE_TIMEOUTS != 0;
    call {:si_unique_call 267} USB_BUS_INTERFACE_USBC_CONFIGURATION_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 281} GUID_BUS_TYPE_USB__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_BUS_TYPE_USB__Loc == GUID_BUS_TYPE_USB;
    assume GUID_BUS_TYPE_USB != 0;
    call {:si_unique_call 282} GUID_INT_ROUTE_INTERFACE_STANDARD__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 283} GUID_PROCESSOR_PCC_INTERFACE_STANDARD__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 284} GUID_BUS_TYPE_USBPRINT__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_BUS_TYPE_USBPRINT__Loc == GUID_BUS_TYPE_USBPRINT;
    assume GUID_BUS_TYPE_USBPRINT != 0;
    call {:si_unique_call 285} GUID_BUS_TYPE_PCI__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_BUS_TYPE_PCI__Loc == GUID_BUS_TYPE_PCI;
    assume GUID_BUS_TYPE_PCI != 0;
    call {:si_unique_call 286} GUID_USB_MSOS20_PLATFORM_CAPABILITY_ID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 287} GUID_TARGET_DEVICE_QUERY_REMOVE__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_TARGET_DEVICE_QUERY_REMOVE__Loc == GUID_TARGET_DEVICE_QUERY_REMOVE;
    assume GUID_TARGET_DEVICE_QUERY_REMOVE != 0;
    call {:si_unique_call 288} GUID_PCI_BUS_INTERFACE_STANDARD__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_PCI_BUS_INTERFACE_STANDARD__Loc == GUID_PCI_BUS_INTERFACE_STANDARD;
    assume GUID_PCI_BUS_INTERFACE_STANDARD != 0;
    call {:si_unique_call 289} GUID_USB_WMI_SURPRISE_REMOVAL_NOTIFICATION__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 290} GUID_USB_CAPABILITY_DEVICE_CONNECTION_SUPER_SPEED_COMPATIBLE__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 291} GUID_HWPROFILE_QUERY_CHANGE__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_HWPROFILE_QUERY_CHANGE__Loc == GUID_HWPROFILE_QUERY_CHANGE;
    assume GUID_HWPROFILE_QUERY_CHANGE != 0;
    call {:si_unique_call 292} GUID_BUS_TYPE_SW_DEVICE__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_BUS_TYPE_SW_DEVICE__Loc == GUID_BUS_TYPE_SW_DEVICE;
    assume GUID_BUS_TYPE_SW_DEVICE != 0;
    call {:si_unique_call 293} GUID_POWER_DEVICE_ENABLE__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_POWER_DEVICE_ENABLE__Loc == GUID_POWER_DEVICE_ENABLE;
    assume GUID_POWER_DEVICE_ENABLE != 0;
    call {:si_unique_call 294} GUID_USB_WMI_STD_DATA__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_USB_WMI_STD_DATA__Loc == GUID_USB_WMI_STD_DATA;
    assume GUID_USB_WMI_STD_DATA != 0;
    call {:si_unique_call 295} GUID_PCI_EXPRESS_ROOT_PORT_INTERFACE__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 305} GUID_USB_WMI_STD_NOTIFICATION__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_USB_WMI_STD_NOTIFICATION__Loc == GUID_USB_WMI_STD_NOTIFICATION;
    assume GUID_USB_WMI_STD_NOTIFICATION != 0;
    call {:si_unique_call 306} USB_BUS_INTERFACE_USBDI_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume USB_BUS_INTERFACE_USBDI_GUID__Loc == USB_BUS_INTERFACE_USBDI_GUID;
    assume USB_BUS_INTERFACE_USBDI_GUID != 0;
    call {:si_unique_call 307} GUID_BUS_TYPE_HID__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_BUS_TYPE_HID__Loc == GUID_BUS_TYPE_HID;
    assume GUID_BUS_TYPE_HID != 0;
    call {:si_unique_call 308} GUID_TARGET_DEVICE_REMOVE_COMPLETE__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 309} GUID_ACPI_INTERFACE_STANDARD__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_ACPI_INTERFACE_STANDARD__Loc == GUID_ACPI_INTERFACE_STANDARD;
    assume GUID_ACPI_INTERFACE_STANDARD != 0;
    call {:si_unique_call 310} GUID_POWER_DEVICE_WAKE_ENABLE__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_POWER_DEVICE_WAKE_ENABLE__Loc == GUID_POWER_DEVICE_WAKE_ENABLE;
    assume GUID_POWER_DEVICE_WAKE_ENABLE != 0;
    call {:si_unique_call 311} boogieTmp := __HAVOC_malloc_or_null(4);
    assume sdv_harnessDeviceExtension_two == boogieTmp;
    call {:si_unique_call 312} boogieTmp := __HAVOC_malloc_or_null(4);
    call {:si_unique_call 313} boogieTmp := __HAVOC_malloc_or_null(4);
    assume sdv_pDpcContext == boogieTmp;
    call {:si_unique_call 314} boogieTmp := __HAVOC_malloc_or_null(4);
    assume sdv_harnessDeviceExtension == boogieTmp;
    call {:si_unique_call 315} boogieTmp := __HAVOC_malloc_or_null(4);
    assume igdoe == boogieTmp;
    call {:si_unique_call 316} boogieTmp := __HAVOC_malloc_or_null(240);
    assume sicrni == boogieTmp;
    call {:si_unique_call 317} boogieTmp := __HAVOC_malloc_or_null(68);
    assume USBPRINT_DriverObject == boogieTmp;
    call {:si_unique_call 318} boogieTmp := __HAVOC_malloc_or_null(12);
    assume pGPortList == boogieTmp;
    assume {:mainInitDone} true;
    call {:si_unique_call 319} corralExtraInit();
    call {:si_unique_call 320} corralExplainErrorInit();
    call {:si_unique_call 321} _sdv_init7();
    call {:si_unique_call 322} _sdv_init1();
    call {:si_unique_call 323} _sdv_init4();
    call {:si_unique_call 324} _sdv_init5();
    call {:si_unique_call 325} _sdv_init3();
    call {:si_unique_call 326} _sdv_init2();
    goto anon9_Then, anon9_Else;
  ...
  L34:
    ...
    call {:si_unique_call 327} sdv_main();
    goto anon12_Then, anon12_Else;
...
implementation {:origName "sdv_IoSkipCurrentIrpStackLocation"} {:osmodel} sdv_IoSkipCurrentIrpStackLocation(actual_pirp_7: int)
{
  ...
  anon0:
    call {:si_unique_call 328} vslice_dummy_var_39 := __HAVOC_malloc(4);
...
implementation {:origName "sdv_RunPowerCompletionRoutines"} {:osmodel} sdv_RunPowerCompletionRoutines(actual_DeviceObject_21: int, actual_MinorFunction_1: int, actual_SD1: int, actual_Context_6: int, actual_IoStatus: int, actual_CompletionFunction_1: int) returns (Tmp_124: int)
{
  ...
  anon0:
    call {:si_unique_call 329} PowerState_1 := __HAVOC_malloc(8);
  ...
  anon5_Else:
    ...
    call {:si_unique_call 330} sdv_stub_power_completion_begin();
    call {:si_unique_call 331} USBPRINT_PoRequestCompletion(DeviceObject_21, MinorFunction_1, PowerState_1, Context_6, IoStatus);
    goto anon6_Then, anon6_Else;
...
implementation {:origName "RtlInitUnicodeString"} {:osmodel} RtlInitUnicodeString(actual_DestinationString_1: int, actual_SourceString_1: int)
{
  ...
  anon0:
    call {:si_unique_call 332} vslice_dummy_var_40 := __HAVOC_malloc(4);
...
implementation {:origName "sdv_RtlZeroMemory"} {:osmodel} sdv_RtlZeroMemory(actual_Destination: int, actual_Length_1: int)
{
  ...
  anon0:
    call {:si_unique_call 333} vslice_dummy_var_41 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "sdv_do_paged_code_check"} {:osmodel} sdv_do_paged_code_check()
{
  ...
  anon0:
    call {:si_unique_call 334} vslice_dummy_var_42 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "sdv_IoMarkIrpPending"} {:osmodel} sdv_IoMarkIrpPending(actual_pirp_8: int)
{
  ...
  anon0:
    call {:si_unique_call 335} vslice_dummy_var_43 := __HAVOC_malloc(4);
    return;
}
...
procedure {:origName "sdv_RunDispatchFunction"} {:osmodel} sdv_RunDispatchFunction(actual_po: int, actual_pirp_9: int) returns (Tmp_136: int);
  modifies alloc, Mem_T.CompletionRoutine__IO_STACK_LOCATION, forward_state, sdv_compFset, sdv_invoke_on_success, sdv_invoke_on_error, sdv_invoke_on_cancel, yogi_error, s;
  free ensures {:va_keep} old(forward_state) == 1 ==> forward_state != 0;
  free ensures {:va_keep} old(s) == 2 ==> s != 0;
  free ensures {:va_keep} old(s) == 1 ==> s != 0;
  free ensures {:va_keep} old(SLAM_guard_S_0) == old(SLAM_guard_S_0_init) ==> forward_state == old(forward_state);
...
implementation {:origName "sdv_RunDispatchFunction"} {:osmodel} sdv_RunDispatchFunction(actual_po: int, actual_pirp_9: int) returns (Tmp_136: int)
{
  ...
  anon0:
    ...
    assume {:nonnull} pirp_9 != 0;
    assume pirp_9 > 0;
    call {:si_unique_call 336} sdv_SetStatus(pirp_9);
    assume {:nonnull} pirp_9 != 0;
    assume pirp_9 > 0;
    assume {:nonnull} pirp_9 != 0;
    assume pirp_9 > 0;
    ...
    call {:si_unique_call 337} sdv_stub_dispatch_begin();
  ...
  L66:
    call {:si_unique_call 338} status_5 := USBPRINT_Dispatch(po, pirp_9);
    goto anon87_Then, anon87_Else;
  ...
  L72:
    call {:si_unique_call 339} sdv_stub_dispatch_end(status_5, 0);
    assume {:nonnull} pirp_9 != 0;
    assume pirp_9 > 0;
    Tmp_136 := status_5;
    goto LM2;
  ...
  anon64_Then:
    call {:si_unique_call 340} status_5 := sdv_DoNothing();
    goto L72;

  anon65_Then:
    assume {:nonnull} ps != 0;
    assume ps > 0;
    call {:si_unique_call 341} status_5 := USBPRINT_SystemControl(po, pirp_9);
    goto anon85_Then, anon85_Else;
  ...
  anon66_Then:
    assume {:nonnull} ps != 0;
    assume ps > 0;
    call {:si_unique_call 342} sdv_SetPowerIrpMinorFunction(pirp_9);
    call {:si_unique_call 343} status_5 := USBPRINT_ProcessPowerIrp(po, pirp_9);
    goto anon84_Then, anon84_Else;
  ...
  anon67_Then:
    assume {:nonnull} ps != 0;
    assume ps > 0;
    call {:si_unique_call 344} status_5 := sdv_DoNothing();
    goto L72;

  anon68_Then:
    call {:si_unique_call 345} status_5 := sdv_DoNothing();
    goto L72;

  anon69_Then:
    assume {:nonnull} ps != 0;
    assume ps > 0;
    call {:si_unique_call 346} status_5 := sdv_DoNothing();
    goto L72;

  anon70_Then:
    assume {:nonnull} ps != 0;
    assume ps > 0;
    call {:si_unique_call 347} status_5 := sdv_DoNothing();
    goto L72;

  anon71_Then:
    assume {:nonnull} ps != 0;
    assume ps > 0;
    call {:si_unique_call 348} status_5 := USBPRINT_ProcessIOCTL(po, pirp_9);
    goto anon83_Then, anon83_Else;
  ...
  anon72_Then:
    call {:si_unique_call 349} status_5 := sdv_DoNothing();
    goto L72;

  anon73_Then:
    assume {:nonnull} ps != 0;
    assume ps > 0;
    call {:si_unique_call 350} status_5 := sdv_DoNothing();
    goto L72;

  anon74_Then:
    assume {:nonnull} ps != 0;
    assume ps > 0;
    call {:si_unique_call 351} status_5 := sdv_DoNothing();
    goto L72;

  anon75_Then:
    assume {:nonnull} ps != 0;
    assume ps > 0;
    call {:si_unique_call 352} status_5 := sdv_DoNothing();
    goto L72;

  anon76_Then:
    assume {:nonnull} ps != 0;
    assume ps > 0;
    call {:si_unique_call 353} status_5 := USBPRINT_Write(po, pirp_9);
    goto anon82_Then, anon82_Else;
  ...
  anon77_Then:
    assume {:nonnull} ps != 0;
    assume ps > 0;
    call {:si_unique_call 354} status_5 := USBPRINT_Read(po, pirp_9);
    goto anon81_Then, anon81_Else;
  ...
  anon78_Then:
    assume {:nonnull} ps != 0;
    assume ps > 0;
    call {:si_unique_call 355} status_5 := USBPRINT_Close(po, pirp_9);
    goto anon80_Then, anon80_Else;
  ...
  anon59_Then:
    assume {:nonnull} ps != 0;
    assume ps > 0;
    call {:si_unique_call 356} status_5 := USBPRINT_Create(po, pirp_9);
    goto anon79_Then, anon79_Else;
...
implementation {:origName "RtlFreeUnicodeString"} {:osmodel} RtlFreeUnicodeString(actual_UnicodeString: int)
{
  ...
  anon0:
    call {:si_unique_call 357} vslice_dummy_var_44 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "sdv_KeReleaseSpinLock"} {:osmodel} sdv_KeReleaseSpinLock(actual_SpinLock_1: int, actual_new: int)
{
  ...
  anon0:
    call {:si_unique_call 358} vslice_dummy_var_45 := __HAVOC_malloc(4);
    new := actual_new;
    return;
}
...
implementation {:origName "sdv_ExFreePool"} {:osmodel} sdv_ExFreePool(actual_P: int)
{
  ...
  anon0:
    call {:si_unique_call 361} vslice_dummy_var_48 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "_sdv_init5"} {:osmodel} _sdv_init5()
{
  ...
  anon0:
    call {:si_unique_call 362} vslice_dummy_var_49 := __HAVOC_malloc(4);
...
implementation {:origName "IoAllocateIrp"} {:osmodel} IoAllocateIrp(actual_StackSize: int, actual_ChargeQuota: int) returns (Tmp_158: int)
{
  ...
  anon3_Else:
    assume {:nonnull} sdv_other_irp != 0;
    assume sdv_other_irp > 0;
    call {:si_unique_call 363} irpSp_1 := sdv_IoGetNextIrpStackLocation(sdv_other_irp);
...
implementation {:origName "KeInitializeEvent"} {:osmodel} KeInitializeEvent(actual_Event_1: int, actual_Type_1: int, actual_State: int)
{
  ...
  anon0:
    call {:si_unique_call 364} vslice_dummy_var_50 := __HAVOC_malloc(4);
...
implementation {:origName "IoFreeIrp"} {:osmodel} IoFreeIrp(actual_pirp_11: int)
{
  ...
  anon0:
    call {:si_unique_call 365} vslice_dummy_var_51 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "ExAllocatePoolWithTag"} {:osmodel} ExAllocatePoolWithTag(actual_PoolType: int, actual_NumberOfBytes: int, actual_Tag: int) returns (Tmp_176: int)
{
  ...
  anon3_Else:
    call {:si_unique_call 366} sdv_155 := __HAVOC_malloc(NumberOfBytes);
    Tmp_176 := sdv_155;
    goto L1;
...
implementation {:origName "IoAllocateWorkItem"} {:osmodel} IoAllocateWorkItem(actual_DeviceObject_26: int) returns (Tmp_178: int)
{
  ...
  anon0:
    call {:si_unique_call 367} sdv_157 := __HAVOC_malloc(1);
    ioWorkItem := sdv_157;
    goto anon6_Then, anon6_Else;
...
implementation {:origName "sdv_stub_driver_init"} {:osmodel} sdv_stub_driver_init()
{
  ...
  anon0:
    call {:si_unique_call 368} vslice_dummy_var_52 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "sdv_stub_dispatch_begin"} {:osmodel} sdv_stub_dispatch_begin()
{
  ...
  anon0:
    call {:si_unique_call 369} vslice_dummy_var_53 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "KeClearEvent"} {:osmodel} KeClearEvent(actual_Event_3: int)
{
  ...
  anon0:
    call {:si_unique_call 370} vslice_dummy_var_54 := __HAVOC_malloc(4);
...
implementation {:origName "GetDelimitedString"} GetDelimitedString(actual_input: int, actual_c: int) returns (Tmp_195: int)
{
  ...
  L8:
    call {:si_unique_call 371} Tmp_200 := GetDelimitedString_loop_L8(Tmp_200, input);
    goto L8_last;
  ...
  L11:
    call {:si_unique_call 372} Tmp_198, Tmp_199 := GetDelimitedString_loop_L11(Tmp_198, Tmp_199, input, c);
    goto L11_last;
...
implementation {:origName "StringSubst"} StringSubst(actual_lpS: int, actual_chTargetChar: int, actual_chReplacementChar: int, actual_cbS: int)
{
  ...
  anon0:
    call {:si_unique_call 373} vslice_dummy_var_55 := __HAVOC_malloc(4);
    lpS := actual_lpS;
  ...
  L5:
    call {:si_unique_call 374} Tmp_203, iCnt := StringSubst_loop_L5(Tmp_203, iCnt, lpS, chTargetChar, chReplacementChar, cbS);
    goto L5_last;
...
implementation {:origName "GetCheckSum"} GetCheckSum(actual_Block: int, actual_Len: int, actual_CheckSum: int)
{
  ...
  anon0:
    call {:si_unique_call 375} vslice_dummy_var_56 := __HAVOC_malloc(4);
    Len := actual_Len;
    CheckSum := actual_CheckSum;
    call {:si_unique_call 376} crc16a := __HAVOC_malloc(64);
    call {:si_unique_call 377} crc16b := __HAVOC_malloc(64);
    crc := 0;
  ...
  L12:
    call {:si_unique_call 378} i, crc, Tmp_206, tmp, vslice_dummy_var_57 := GetCheckSum_loop_L12(i, crc, Tmp_206, tmp, Len, vslice_dummy_var_57);
    goto L12_last;
  ...
  anon3_Else:
    ...
    call {:si_unique_call 379} tmp := corral_nondet();
    Tmp_206 := BAND(tmp, BOR(BOR(BOR(1, 2), 4), 8));
    call {:si_unique_call 380} vslice_dummy_var_57 := corral_nondet();
    call {:si_unique_call 381} crc := corral_nondet();
    i := i + 1;
...
implementation {:origName "StringChr"} StringChr(actual_string: int, actual_c_1: int) returns (Tmp_210: int)
{
  ...
  L7:
    call {:si_unique_call 382} i_1 := StringChr_loop_L7(i_1, string, c_1);
    goto L7_last;
...
implementation {:origName "ParPnpFindDeviceIdKeys"} ParPnpFindDeviceIdKeys(actual_lppMFG: int, actual_lppMDL: int, actual_lppCLS: int, actual_lppDES: int, actual_lppAID: int, actual_lppCID: int, actual_lpDeviceID: int)
{
  ...
  anon0:
    call {:si_unique_call 383} vslice_dummy_var_58 := __HAVOC_malloc(4);
    ...
    call {:si_unique_call 384} vslice_dummy_var_59 := __HAVOC_malloc(16);
    call {:si_unique_call 385} vslice_dummy_var_60 := __HAVOC_malloc(16);
    call {:si_unique_call 386} vslice_dummy_var_61 := __HAVOC_malloc(24);
    call {:si_unique_call 387} vslice_dummy_var_62 := __HAVOC_malloc(48);
    call {:si_unique_call 388} vslice_dummy_var_63 := __HAVOC_malloc(48);
    call {:si_unique_call 389} vslice_dummy_var_64 := __HAVOC_malloc(52);
    call {:si_unique_call 390} vslice_dummy_var_65 := __HAVOC_malloc(16);
    call {:si_unique_call 391} vslice_dummy_var_66 := __HAVOC_malloc(16);
    call {:si_unique_call 392} vslice_dummy_var_67 := __HAVOC_malloc(24);
    call {:si_unique_call 393} vslice_dummy_var_68 := __HAVOC_malloc(16);
    call {:si_unique_call 394} vslice_dummy_var_69 := __HAVOC_malloc(52);
    call {:si_unique_call 395} vslice_dummy_var_70 := __HAVOC_malloc(16);
    lpKey := lpDeviceID;
    goto L7;

  L7:
    call {:si_unique_call 396} Tmp_214, sdv_160, sdv_161, sdv_163, Tmp_217, sdv_164, Tmp_218, Tmp_219, Tmp_220, lpKey, sdv_167, Tmp_223, Tmp_225, sdv_170, sdv_173, sdv_174, Tmp_226, Tmp_227, Tmp_228, sdv_176, sdv_177, Tmp_232, lpValue, sdv_180, Tmp_236, sdv_182, wKeyLength := ParPnpFindDeviceIdKeys_loop_L7(Tmp_214, sdv_160, sdv_161, sdv_163, Tmp_217, sdv_164, Tmp_218, Tmp_219, Tmp_220, lpKey, sdv_167, Tmp_223, Tmp_225, sdv_170, sdv_173, sdv_174, Tmp_226, Tmp_227, Tmp_228, sdv_176, sdv_177, Tmp_232, lpValue, sdv_180, Tmp_236, sdv_182, wKeyLength, lppMFG, lppMDL, lppCLS, lppDES, lppAID, lppCID);
    goto L7_last;
  ...
  L8:
    call {:si_unique_call 397} ParPnpFindDeviceIdKeys_loop_L8(lpKey);
    goto L8_last;
  ...
  anon62_Then:
    call {:si_unique_call 398} lpValue := StringChr(lpKey, 58);
    goto anon63_Then, anon63_Else;
  ...
  anon87_Else:
    Tmp_226 := wKeyLength;
    call {:si_unique_call 399} sdv_174 := RtlCompareMemory(0, 0, Tmp_226);
    goto anon64_Then, anon64_Else;
  ...
  L31:
    ...
    assume lppMFG > 0;
    call {:si_unique_call 400} lpKey := StringChr(lpValue, 59);
    goto anon65_Then, anon65_Else;
  ...
  anon64_Then:
    ...
    Tmp_214 := wKeyLength;
    call {:si_unique_call 401} sdv_176 := RtlCompareMemory(0, 0, Tmp_214);
    goto anon66_Then, anon66_Else;

  anon66_Else:
    assume {:partition} sdv_176 != 3;
    Tmp_236 := wKeyLength;
    call {:si_unique_call 402} sdv_167 := RtlCompareMemory(0, 0, Tmp_236);
    goto anon67_Then, anon67_Else;
  ...
  L50:
    ...
    assume lppMDL > 0;
    call {:si_unique_call 403} lpKey := StringChr(lpValue, 59);
    goto anon68_Then, anon68_Else;
  ...
  anon67_Then:
    assume {:partition} sdv_167 != 5;
    Tmp_225 := wKeyLength;
    call {:si_unique_call 404} sdv_170 := RtlCompareMemory(0, 0, Tmp_225);
    goto anon69_Then, anon69_Else;

  anon69_Else:
    assume {:partition} sdv_170 != 3;
    call {:si_unique_call 405} lpKey := StringChr(lpValue, 59);
    goto anon70_Then, anon70_Else;
  ...
  anon87_Then:
    call {:si_unique_call 406} lpKey := StringChr(lpValue, 59);
    goto anon86_Then, anon86_Else;
  ...
  anon88_Then:
    Tmp_223 := wKeyLength;
    call {:si_unique_call 407} sdv_182 := RtlCompareMemory(0, 0, Tmp_223);
    goto anon71_Then, anon71_Else;
  ...
  L74:
    ...
    assume lppDES > 0;
    call {:si_unique_call 408} lpKey := StringChr(lpValue, 59);
    goto anon72_Then, anon72_Else;
  ...
  anon71_Then:
    assume {:partition} sdv_182 == 0;
    Tmp_219 := wKeyLength;
    call {:si_unique_call 409} sdv_161 := RtlCompareMemory(0, 0, Tmp_219);
    goto anon73_Then, anon73_Else;

  anon73_Else:
    assume {:partition} sdv_161 == 0;
    call {:si_unique_call 410} lpKey := StringChr(lpValue, 59);
    goto anon74_Then, anon74_Else;
  ...
  anon89_Then:
    Tmp_228 := wKeyLength;
    call {:si_unique_call 411} sdv_177 := RtlCompareMemory(0, 0, Tmp_228);
    goto anon75_Then, anon75_Else;
  ...
  L99:
    ...
    assume lppCLS > 0;
    call {:si_unique_call 412} lpKey := StringChr(lpValue, 59);
    goto anon76_Then, anon76_Else;
  ...
  anon75_Then:
    assume {:partition} sdv_177 != 5;
    Tmp_218 := wKeyLength;
    call {:si_unique_call 413} sdv_180 := RtlCompareMemory(0, 0, Tmp_218);
    goto anon77_Then, anon77_Else;

  anon77_Else:
    assume {:partition} sdv_180 != 3;
    Tmp_227 := wKeyLength;
    call {:si_unique_call 414} sdv_160 := RtlCompareMemory(0, 0, Tmp_227);
    goto anon78_Then, anon78_Else;
  ...
  L118:
    ...
    assume lppCID > 0;
    call {:si_unique_call 415} lpKey := StringChr(lpValue, 59);
    goto anon79_Then, anon79_Else;
  ...
  anon78_Then:
    ...
    Tmp_220 := wKeyLength;
    call {:si_unique_call 416} sdv_173 := RtlCompareMemory(0, 0, Tmp_220);
    goto anon80_Then, anon80_Else;

  anon80_Else:
    assume {:partition} sdv_173 != 3;
    call {:si_unique_call 417} lpKey := StringChr(lpValue, 59);
    goto anon81_Then, anon81_Else;
  ...
  anon90_Then:
    Tmp_232 := wKeyLength;
    call {:si_unique_call 418} sdv_163 := RtlCompareMemory(0, 0, Tmp_232);
    goto anon82_Then, anon82_Else;
  ...
  L142:
    ...
    assume lppAID > 0;
    call {:si_unique_call 419} lpKey := StringChr(lpValue, 59);
    goto anon83_Then, anon83_Else;
  ...
  anon82_Then:
    assume {:partition} sdv_163 == 0;
    Tmp_217 := wKeyLength;
    call {:si_unique_call 420} sdv_164 := RtlCompareMemory(0, 0, Tmp_217);
    goto anon84_Then, anon84_Else;

  anon84_Else:
    assume {:partition} sdv_164 == 0;
    call {:si_unique_call 421} lpKey := StringChr(lpValue, 59);
    goto anon85_Then, anon85_Else;
...
implementation {:origName "FixupDeviceId"} FixupDeviceId(actual_DeviceId: int)
{
  ...
  anon0:
    call {:si_unique_call 422} vslice_dummy_var_71 := __HAVOC_malloc(4);
    DeviceId := actual_DeviceId;
    p_3 := DeviceId;
    goto L5;

  L5:
    call {:si_unique_call 423} FixupDeviceId_loop_L5(p_3);
    goto L5_last;
...
implementation {:origName "_sdv_init4"} _sdv_init4()
{
  ...
  anon0:
    call {:si_unique_call 424} vslice_dummy_var_72 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "ParPnpGetId"} ParPnpGetId(actual_DeviceIdString: int, actual_Type_2: int, actual_resultString: int, actual_resultLen: int) returns (Tmp_242: int)
{
  ...
  anon0:
    call {:si_unique_call 425} CLS := __HAVOC_malloc(4);
    call {:si_unique_call 426} checkSum := __HAVOC_malloc(4);
    call {:si_unique_call 427} CID := __HAVOC_malloc(4);
    call {:si_unique_call 428} DES := __HAVOC_malloc(4);
    call {:si_unique_call 429} MDL := __HAVOC_malloc(4);
    call {:si_unique_call 430} MFG := __HAVOC_malloc(4);
    call {:si_unique_call 431} AID := __HAVOC_malloc(4);
    DeviceIdString := actual_DeviceIdString;
    Type_2 := actual_Type_2;
    resultString := actual_resultString;
    resultLen := actual_resultLen;
    call {:si_unique_call 432} Tmp_244 := __HAVOC_malloc(8);
    call {:si_unique_call 433} Tmp_245 := __HAVOC_malloc(24);
    call {:si_unique_call 434} Tmp_246 := __HAVOC_malloc(16);
    call {:si_unique_call 435} Tmp_248 := __HAVOC_malloc(44);
    call {:si_unique_call 436} Tmp_249 := __HAVOC_malloc(24);
    call {:si_unique_call 437} vslice_dummy_var_73 := __HAVOC_malloc(60);
    assume {:nonnull} checkSum != 0;
    assume checkSum > 0;
    ...
    assume DES > 0;
    status_7 := 0;
    call {:si_unique_call 438} sdv_RtlZeroMemory(0, resultLen);
    call {:si_unique_call 439} sdv_184 := corral_nondet();
    goto anon27_Then, anon27_Else;
  ...
  anon38_Else:
    ...
    call {:si_unique_call 440} ParPnpFindDeviceIdKeys(MFG, MDL, CLS, DES, AID, CID, DeviceIdString);
    assume {:nonnull} CID != 0;
    assume CID > 0;
    goto anon29_Then, anon29_Else;

  anon29_Else:
    Tmp_246 := strConst__li2bpl20;
    call {:si_unique_call 441} status_7 := RtlStringCbPrintfA(resultString, resultLen, Tmp_246);
    goto anon30_Then, anon30_Else;
  ...
  anon32_Else:
    assume {:partition} Type_2 != 2;
    Tmp_243 := sdv_185;
    call {:si_unique_call 442} StringSubst(resultString, 32, 95, Tmp_243);
    goto L52;
  ...
  anon38_Then:
    assume {:partition} Type_2 != 2;
    Tmp_244 := strConst__li2bpl19;
    call {:si_unique_call 443} status_7 := RtlStringCbPrintfA(resultString, resultLen, Tmp_244);
    goto anon37_Then, anon37_Else;
  ...
  anon39_Then:
    assume {:partition} Type_2 == 1;
    Tmp_247 := sdv_190;
    call {:si_unique_call 444} GetCheckSum(DeviceIdString, Tmp_247, checkSum);
    Tmp_248 := strConst__li2bpl21;
    call {:si_unique_call 445} status_7 := RtlStringCbPrintfA(resultString, resultLen, Tmp_248);
  ...
  anon28_Then:
    assume {:partition} Type_2 == 0;
    call {:si_unique_call 446} ParPnpFindDeviceIdKeys(MFG, MDL, CLS, DES, AID, CID, DeviceIdString);
    assume {:nonnull} MFG != 0;
    assume MFG > 0;
  ...
  anon35_Else:
    Tmp_249 := strConst__li2bpl22;
    call {:si_unique_call 447} status_7 := RtlStringCbPrintfA(resultString, resultLen, Tmp_249);
  ...
  anon27_Then:
    assume {:partition} sdv_184 == 0;
    Tmp_245 := strConst__li2bpl18;
    call {:si_unique_call 448} status_7 := RtlStringCbPrintfA(resultString, resultLen, Tmp_245);
    goto L52;
}
...
implementation {:origName "USBPRINT_PoRequestCompletion"} USBPRINT_PoRequestCompletion(actual_DeviceObject_28: int, actual_MinorFunction_2: int, actual_structPtr888PowerState: int, actual_Context_8: int, actual_IoStatus_1: int)
{
  ...
  anon0:
    call {:si_unique_call 449} PowerState := __HAVOC_malloc(8);
    call {:si_unique_call 450} vslice_dummy_var_74 := __HAVOC_malloc(4);
    ...
    call {:si_unique_call 452} sdv_IoCopyCurrentIrpStackLocationToNext(irp_2);
    call {:si_unique_call 453} vslice_dummy_var_75 := PoCallDriver(0, irp_2);
    goto anon3_Then, anon3_Else;

  anon3_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 454} vslice_dummy_var_76 := USBPRINT_DecrementIoCount(deviceObject_2);
    goto LM2;
...
implementation {:origName "USBPRINT_DecrementIoCount"} USBPRINT_DecrementIoCount(actual_DeviceObject_29: int) returns (Tmp_254: int)
{
  ...
  anon6_Then:
    call {:si_unique_call 455} Tmp_255 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_255 != 0;
    assume Tmp_255 > 0;
    assume {:nonnull} deviceExtension_15 != 0;
    assume deviceExtension_15 > 0;
    call {:si_unique_call 456} ioCount := sdv_InterlockedDecrement(Tmp_255);
    assume {:nonnull} Tmp_255 != 0;
    assume Tmp_255 > 0;
    assume {:nonnull} deviceExtension_15 != 0;
    assume deviceExtension_15 > 0;
  ...
  anon5_Else:
    ...
    assume {:nonnull} deviceExtension_15 != 0;
    assume deviceExtension_15 > 0;
    call {:si_unique_call 457} vslice_dummy_var_77 := KeSetEvent(RemoveEvent__DEVICE_EXTENSION(deviceExtension_15), 1, 0);
    goto L11;
...
implementation {:origName "USBPRINT_StopDevice"} USBPRINT_StopDevice(actual_DeviceObject_30: int) returns (Tmp_256: int)
{
  ...
  anon0:
    call {:si_unique_call 458} timeOut_4 := __HAVOC_malloc(20);
    DeviceObject_30 := actual_DeviceObject_30;
    ntStatus_16 := 0;
    assume {:nonnull} timeOut_4 != 0;
    assume timeOut_4 > 0;
    siz_1 := 60;
    call {:si_unique_call 459} sdv_196 := ExAllocatePoolWithTag(512, siz_1, -800959659);
    urb_10 := sdv_196;
    goto anon5_Then, anon5_Else;
  ...
  anon5_Else:
    ...
    assume {:nonnull} urb_10 != 0;
    assume urb_10 > 0;
    call {:si_unique_call 460} vslice_dummy_var_78 := USBPRINT_CallUSBD#1(DeviceObject_30, urb_10, timeOut_4);
    goto anon6_Then, anon6_Else;
...
implementation {:origName "USBPRINT_StartDevice"} USBPRINT_StartDevice(actual_DeviceObject_31: int) returns (Tmp_258: int)
{
  ...
  anon0:
    call {:si_unique_call 462} timeOut_5 := __HAVOC_malloc(20);
    call {:si_unique_call 463} NewDevice := __HAVOC_malloc(4);
    ...
    call {:si_unique_call 464} ntStatus_17 := USBPRINT_ConfigureDevice(DeviceObject_31);
    goto anon52_Then, anon52_Else;
  ...
  anon39_Else:
    ...
    call {:si_unique_call 465} sdv_202 := ExAllocatePoolWithTag(512, 80, -800959659);
    urb_11 := sdv_202;
    goto L31;
  ...
  anon40_Else:
    ...
    siz_2 := 18;
    call {:si_unique_call 466} sdv_204 := ExAllocatePoolWithTag(512, siz_2, -800959659);
  ...
  anon53_Else:
    ...
    assume timeOut_5 > 0;
    call {:si_unique_call 467} ntStatus_17 := USBPRINT_CallUSBD#1(DeviceObject_31, urb_11, timeOut_5);
    goto anon54_Then, anon54_Else;
  ...
  anon41_Else:
    ...
    havoc dwVidPid;
    call {:si_unique_call 468} dwVidPid := corral_nondet();
    assume {:nonnull} deviceDescriptor != 0;
    assume deviceDescriptor > 0;
    havoc dwVidPid;
    goto L59;
  ...
  anon46_Else:
    ...
    assume deviceExtension_16 > 0;
    siz_2 := 259;
    call {:si_unique_call 470} sdv_205 := ExAllocatePoolWithTag(512, siz_2, -800959659);
    stringDescriptor_1 := sdv_205;
    goto anon55_Then, anon55_Else;

  anon55_Else:
    assume {:partition} stringDescriptor_1 != 0;
    call {:si_unique_call 471} iReturn_5 := USBPRINT_GetSerialNumber(DeviceObject_31, stringDescriptor_1, siz_2);
  ...
  anon48_Else:
    ...
    call {:si_unique_call 472} sdv_RtlZeroMemory(0, 64);
    assume {:nonnull} stringDescriptor_1 != 0;
    assume stringDescriptor_1 > 0;
    havoc Tmp_259;
    call {:si_unique_call 473} sdv_RtlCopyMemory(0, 0, Tmp_259);
    assume {:nonnull} deviceExtension_16 != 0;
    assume deviceExtension_16 > 0;
    goto L81;
  ...
  anon47_Else:
    assume {:partition} ntStatus_17 >= 0;
    call {:si_unique_call 475} vslice_dummy_var_79 := USBPRINT_GetDeviceID(DeviceObject_31);
    goto anon57_Then, anon57_Else;

  anon57_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 476} WritePortDescription(deviceExtension_16);
    call {:si_unique_call 477} ntStatus_17 := IoSetDeviceInterfaceState(0, 1);
    goto L92;
  ...
  anon49_Else:
    assume {:partition} ntStatus_17 >= 0;
    call {:si_unique_call 478} ntStatus_17 := USBPRINT_BuildPipeList(DeviceObject_31);
    assume {:nonnull} deviceExtension_16 != 0;
    assume deviceExtension_16 > 0;
    goto anon50_Then, anon50_Else;

  anon50_Else:
    call {:si_unique_call 479} vslice_dummy_var_80 := USBPRINT_FdoSubmitIdleRequestIrp(deviceExtension_16);
    goto L103;
  ...
  anon45_Else:
    assume {:partition} ntStatus_17 >= 0;
    call {:si_unique_call 480} ntStatus_17 := IoCreateDevice(0, 12, 0, 22, 128, 1, NewDevice);
    goto L112;
...
implementation {:origName "RtlStringVPrintfWorkerW_sdv_static_function_1"} RtlStringVPrintfWorkerW_sdv_static_function_1(actual_pszDest: int, actual_cchDest: int, actual_pcchNewDestLength: int, actual_pszFormat: int, actual_argList: int) returns (Tmp_261: int)
{
  ...
  anon0:
    ...
    cchNewDestLength := 0;
    cchMax := cchDest - 1;
    call {:si_unique_call 482} iRet := corral_nondet();
    goto anon9_Then, anon9_Else;
...
implementation {:origName "USBPRINT_SystemControl"} USBPRINT_SystemControl(actual_DeviceObject_32: int, actual_Irp_16: int) returns (Tmp_265: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 484} USBPRINT_IncrementIoCount(DeviceObject_32);
    assume {:nonnull} deviceExtension_17 != 0;
    assume deviceExtension_17 > 0;
    goto anon11_Then, anon11_Else;
  ...
  anon12_Else:
    ...
    assume SLAM_guard_S_0 != SLAM_guard_S_0_init;
    call {:si_unique_call 485} SLIC_sdv_IoCompleteRequest_entry(strConst__li2bpl1);
    goto anon13_Then, anon13_Else;
  ...
  L22:
    call {:si_unique_call 487} vslice_dummy_var_81 := USBPRINT_DecrementIoCount(DeviceObject_32);
    Tmp_265 := ntStatus_18;
    call {:si_unique_call 488} SLIC_USBPRINT_SystemControl_exit(strConst__li2bpl0, Tmp_265);
    goto anon14_Then, anon14_Else;
  ...
  anon11_Then:
    call {:si_unique_call 489} sdv_IoSkipCurrentIrpStackLocation(Irp_16);
    call {:si_unique_call 490} ntStatus_18 := sdv_IoCallDriver#1(stackDeviceObject, Irp_16);
    goto anon15_Then, anon15_Else;
...
implementation {:origName "QueryDeviceRelations"} QueryDeviceRelations(actual_DeviceObject_33: int, actual_Irp_17: int, actual_RelationType: int, actual_pbComplete: int) returns (Tmp_267: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 491} Tmp_268 := __HAVOC_malloc(4);
    call {:si_unique_call 492} Tmp_269 := __HAVOC_malloc(4);
  ...
  anon26_Else:
    ...
    assume {:nonnull} pbComplete != 0;
    assume pbComplete > 0;
    call {:si_unique_call 493} sdv_212 := ExAllocatePoolWithTag(512, 8, -800959659);
    pRelations := sdv_212;
    goto anon28_Then, anon28_Else;
  ...
  anon28_Else:
    ...
    assume Tmp_269 > 0;
    call {:si_unique_call 494} vslice_dummy_var_82 := sdv_ObReferenceObject(0);
    assume {:nonnull} Irp_17 != 0;
    assume Irp_17 > 0;
    ntStatus_19 := 0;
    assume {:nonnull} Irp_17 != 0;
  ...
  anon29_Else:
    ...
    assume SLAM_guard_S_0 != SLAM_guard_S_0_init;
    call {:si_unique_call 495} SLIC_sdv_IoCompleteRequest_entry(strConst__li2bpl1);
    goto anon30_Then, anon30_Else;
  ...
  anon31_Else:
    assume Irp_17 == SLAM_guard_S_0;
    assume SLAM_guard_S_0 != SLAM_guard_S_0_init;
    call {:si_unique_call 497} SLIC_sdv_IoCompleteRequest_entry(strConst__li2bpl1);
    goto anon32_Then, anon32_Else;
  ...
  anon25_Else:
    ...
    assume {:nonnull} pbComplete != 0;
    assume pbComplete > 0;
    call {:si_unique_call 499} sdv_214 := ExAllocatePoolWithTag(512, 8, -800959659);
    pRelations := sdv_214;
    goto anon33_Then, anon33_Else;
  ...
  anon33_Else:
    ...
    assume {:nonnull} pRelations != 0;
    assume pRelations > 0;
    call {:si_unique_call 500} vslice_dummy_var_83 := sdv_ObReferenceObject(0);
    assume {:nonnull} Irp_17 != 0;
    assume Irp_17 > 0;
    assume {:nonnull} Irp_17 != 0;
    assume Irp_17 > 0;
    call {:si_unique_call 501} sdv_IoCopyCurrentIrpStackLocationToNext(Irp_17);
    assume {:nonnull} pExtension != 0;
    assume pExtension > 0;
    havoc vslice_dummy_var_396;
    call {:si_unique_call 502} ntStatus_19 := sdv_IoCallDriver#1(vslice_dummy_var_396, Irp_17);
    goto anon34_Then, anon34_Else;
  ...
  anon35_Else:
    assume Irp_17 == SLAM_guard_S_0;
    assume SLAM_guard_S_0 != SLAM_guard_S_0_init;
    call {:si_unique_call 503} SLIC_sdv_IoCompleteRequest_entry(strConst__li2bpl1);
    goto anon36_Then, anon36_Else;
...
implementation {:origName "WritePortDescription"} WritePortDescription(actual_deviceExtension_18: int)
{
  ...
  anon0:
    call {:si_unique_call 505} Description := __HAVOC_malloc(12);
    call {:si_unique_call 506} ValueName_1 := __HAVOC_malloc(12);
    call {:si_unique_call 507} InterfaceNumberValueName := __HAVOC_malloc(12);
    call {:si_unique_call 508} SerialNumberValueName := __HAVOC_malloc(12);
    call {:si_unique_call 509} BaseName := __HAVOC_malloc(12);
    call {:si_unique_call 510} vslice_dummy_var_84 := __HAVOC_malloc(12);
    call {:si_unique_call 511} BaseValueName := __HAVOC_malloc(12);
    call {:si_unique_call 512} vslice_dummy_var_85 := __HAVOC_malloc(4);
    call {:si_unique_call 513} SerialNumberString := __HAVOC_malloc(12);
    deviceExtension_18 := actual_deviceExtension_18;
    call {:si_unique_call 514} Tmp_273 := __HAVOC_malloc(40);
    call {:si_unique_call 515} Tmp_275 := __HAVOC_malloc(16);
    call {:si_unique_call 516} Tmp_276 := __HAVOC_malloc(68);
    call {:si_unique_call 517} Tmp_277 := __HAVOC_malloc(68);
    call {:si_unique_call 518} Tmp_279 := __HAVOC_malloc(56);
    ...
    assume {:nonnull} Description != 0;
    assume Description > 0;
    Tmp_276 := strConst__li2bpl26;
    call {:si_unique_call 519} RtlInitUnicodeString(ValueName_1, Tmp_276);
    call {:si_unique_call 520} RtlInitAnsiString(0, 0);
    assume {:nonnull} Description != 0;
    assume Description > 0;
    call {:si_unique_call 521} vslice_dummy_var_87 := RtlAnsiStringToUnicodeString(0, 0, 1);
    assume {:nonnull} Description != 0;
    assume Description > 0;
    havoc Tmp_274;
    call {:si_unique_call 522} vslice_dummy_var_88 := ZwSetValueKey(0, 0, 0, 1, 0, Tmp_274);
    call {:si_unique_call 523} RtlFreeUnicodeString(0);
    Tmp_275 := strConst__li2bpl23;
    call {:si_unique_call 524} RtlInitUnicodeString(BaseName, Tmp_275);
    Tmp_273 := strConst__li2bpl24;
    call {:si_unique_call 525} RtlInitUnicodeString(BaseValueName, Tmp_273);
    assume {:nonnull} BaseName != 0;
    assume BaseName > 0;
    havoc Tmp_278;
    call {:si_unique_call 526} vslice_dummy_var_89 := ZwSetValueKey(0, 0, 0, 1, 0, Tmp_278);
  ...
  anon5_Else:
    ...
    call {:si_unique_call 527} RtlInitUnicodeString(SerialNumberString, vslice_dummy_var_397);
    Tmp_279 := strConst__li2bpl25;
    call {:si_unique_call 528} RtlInitUnicodeString(SerialNumberValueName, Tmp_279);
    assume {:nonnull} SerialNumberString != 0;
    assume SerialNumberString > 0;
    havoc Tmp_271;
    call {:si_unique_call 529} vslice_dummy_var_90 := ZwSetValueKey(0, 0, 0, 1, 0, Tmp_271);
    goto L43;
  ...
  anon6_Else:
    ...
    assume Tmp_272 > 0;
    Tmp_277 := strConst__li2bpl27;
    call {:si_unique_call 530} RtlInitUnicodeString(InterfaceNumberValueName, Tmp_277);
    call {:si_unique_call 531} vslice_dummy_var_86 := ZwSetValueKey(0, 0, 0, 4, 0, 4);
    goto L1;
...
implementation {:origName "_sdv_init1"} _sdv_init1()
{
  ...
  anon0:
    call {:si_unique_call 532} vslice_dummy_var_91 := __HAVOC_malloc(4);
...
implementation {:origName "USBPRINT_GetDeviceID"} USBPRINT_GetDeviceID(actual_ParentDeviceObject: int) returns (Tmp_286: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 533} Tmp_288 := __HAVOC_malloc(60);
    call {:si_unique_call 534} Tmp_291 := __HAVOC_malloc(60);
    call {:si_unique_call 535} Tmp_292 := __HAVOC_malloc(60);
    assume {:nonnull} ParentDeviceObject != 0;
    assume ParentDeviceObject > 0;
    havoc pParentExtension;
    call {:si_unique_call 536} sdv_222 := ExAllocatePoolWithTag(512, 1024, -800959659);
    p1284Id := sdv_222;
    goto anon13_Then, anon13_Else;

  anon13_Else:
    assume {:partition} p1284Id != 0;
    call {:si_unique_call 537} sdv_RtlZeroMemory(0, 1024);
    call {:si_unique_call 538} iReturnSize := USBPRINT_Get1284Id(ParentDeviceObject, p1284Id, 1009);
    goto anon14_Then, anon14_Else;
  ...
  anon11_Else:
    ...
    Tmp_288 := strConst__li2bpl17;
    assume {:nonnull} pParentExtension != 0;
    assume pParentExtension > 0;
    havoc vslice_dummy_var_398;
    call {:si_unique_call 539} vslice_dummy_var_92 := RtlStringCbPrintfA(vslice_dummy_var_398, 1024, Tmp_288);
    goto L27;
  ...
  anon11_Then:
    ...
    call {:si_unique_call 541} sdv_226 := ExAllocatePoolWithTag(512, Tmp_287, -800959659);
    assume {:nonnull} pParentExtension != 0;
    assume pParentExtension > 0;
    assume {:nonnull} pParentExtension != 0;
    assume pParentExtension > 0;
  ...
  anon15_Else:
    ...
    call {:si_unique_call 542} sdv_RtlCopyMemory(0, 0, Tmp_294);
    goto L35;
  ...
  L35:
    ...
    call {:si_unique_call 543} ntStatus_20 := ParPnpGetId(Tmp_293, 0, vslice_dummy_var_399, 1024);
    goto anon12_Then, anon12_Else;

  anon12_Else:
    assume {:partition} ntStatus_20 < 0;
    Tmp_291 := strConst__li2bpl17;
    assume {:nonnull} pParentExtension != 0;
    assume pParentExtension > 0;
    havoc vslice_dummy_var_400;
    call {:si_unique_call 544} vslice_dummy_var_93 := RtlStringCbPrintfA(vslice_dummy_var_400, 1024, Tmp_291);
    assume {:nonnull} pParentExtension != 0;
    assume pParentExtension > 0;
    goto L27;
  ...
  anon13_Then:
    ...
    assume {:nonnull} pParentExtension != 0;
    assume pParentExtension > 0;
    Tmp_292 := strConst__li2bpl17;
    assume {:nonnull} pParentExtension != 0;
    assume pParentExtension > 0;
    havoc vslice_dummy_var_401;
    call {:si_unique_call 545} vslice_dummy_var_94 := RtlStringCbPrintfA(vslice_dummy_var_401, 1024, Tmp_292);
    goto L1;
}
...
implementation {:origName "USBPRINT_RemoveDevice"} USBPRINT_RemoveDevice(actual_DeviceObject_34: int) returns (Tmp_295: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 546} vslice_dummy_var_95 := ZwClose(0);
  ...
  L14:
    call {:si_unique_call 547} RtlFreeUnicodeString(0);
    assume {:nonnull} deviceExtension_19 != 0;
    assume deviceExtension_19 > 0;
    goto anon10_Then, anon10_Else;
  ...
  anon12_Else:
    call {:si_unique_call 550} sdv_ExFreePool(0);
    goto L27;
  ...
  anon9_Then:
    call {:si_unique_call 551} ntStatus_21 := IoSetDeviceInterfaceState(0, 0);
    goto L14;
}
...
procedure {:origName "USBPRINT_ProcessPowerIrp"} USBPRINT_ProcessPowerIrp(actual_DeviceObject_35: int, actual_Irp_18: int) returns (Tmp_297: int);
  modifies alloc, yogi_error, Mem_T.CompletionRoutine__IO_STACK_LOCATION, sdv_compFset, sdv_invoke_on_success, sdv_invoke_on_error, sdv_invoke_on_cancel, forward_state, s;
  free ensures {:va_keep} old(forward_state) == 1 ==> forward_state != 0;
  free ensures {:va_keep} old(s) == 2 ==> s != 0;
  free ensures {:va_keep} old(s) == 1 ==> s != 0;
  free ensures {:va_keep} old(SLAM_guard_S_0) == old(SLAM_guard_S_0_init) ==> forward_state == old(forward_state);
...
implementation {:origName "USBPRINT_ProcessPowerIrp"} USBPRINT_ProcessPowerIrp(actual_DeviceObject_35: int, actual_Irp_18: int) returns (Tmp_297: int)
{
  ...
  anon9_Else:
    call {:si_unique_call 552} ntStatus_22 := USBPRINT_ProcessChildPowerIrp(DeviceObject_35, Irp_18);
    goto anon10_Then, anon10_Else;
  ...
  L16:
    Tmp_297 := ntStatus_22;
    call {:si_unique_call 553} SLIC_USBPRINT_ProcessPowerIrp_exit(strConst__li2bpl0, Tmp_297);
    goto anon11_Then, anon11_Else;
  ...
  anon9_Then:
    call {:si_unique_call 554} ntStatus_22 := USBPRINT_ProcessFdoPowerIrp(DeviceObject_35, Irp_18);
    goto anon12_Then, anon12_Else;
...
implementation {:origName "USBPRINT_PowerIrp_Complete"} USBPRINT_PowerIrp_Complete(actual_NullDeviceObject: int, actual_Irp_19: int, actual_Context_9: int) returns (Tmp_304: int)
{
  ...
  anon3_Else:
    call {:si_unique_call 555} sdv_IoMarkIrpPending(0);
    goto L11;

  L11:
    call {:si_unique_call 556} vslice_dummy_var_96 := sdv_IoGetCurrentIrpStackLocation(Irp_19);
    ...
    assume {:nonnull} Irp_19 != 0;
    assume Irp_19 > 0;
    call {:si_unique_call 557} vslice_dummy_var_97 := USBPRINT_DecrementIoCount(deviceObject_3);
    Tmp_304 := ntStatus_25;
    return;
...
implementation {:origName "RtlStringCopyWorkerA_sdv_static_function_1"} RtlStringCopyWorkerA_sdv_static_function_1(actual_pszDest_3: int, actual_cchDest_3: int, actual_pcchNewDestLength_1: int, actual_pszSrc: int, actual_cchToCopy: int) returns (Tmp_308: int)
{
  ...
  L7:
    call {:si_unique_call 558} cchNewDestLength_1, cchDest_3, cchToCopy := RtlStringCopyWorkerA_sdv_static_function_1_loop_L7(cchNewDestLength_1, pszDest_3, cchDest_3, pszSrc, cchToCopy);
    goto L7_last;
...
implementation {:origName "RtlStringCbPrintfA"} RtlStringCbPrintfA(actual_pszDest_4: int, actual_cbDest: int, actual_pszFormat_1: int) returns (Tmp_310: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 559} pszFormat_1 := __HAVOC_malloc(4);
    cchDest_4 := INTDIV(cbDest, 1);
    call {:si_unique_call 560} status_14 := RtlStringValidateDestA_sdv_static_function_1(pszDest_4, cchDest_4, -1);
    goto anon5_Then, anon5_Else;
  ...
  anon5_Else:
    ...
    call {:si_unique_call 561} status_14 := RtlStringVPrintfWorkerA_sdv_static_function_1(pszDest_4, cchDest_4, 0, vslice_dummy_var_402, argList_1);
    argList_1 := 0;
    goto L19;
...
implementation {:origName "RtlStringLengthWorkerA_sdv_static_function_1"} RtlStringLengthWorkerA_sdv_static_function_1(actual_psz: int, actual_cchMax_3: int, actual_pcchLength: int) returns (Tmp_312: int)
{
  ...
  L7:
    call {:si_unique_call 562} cchMax_3 := RtlStringLengthWorkerA_sdv_static_function_1_loop_L7(psz, cchMax_3);
    goto L7_last;
...
implementation {:origName "USBPRINT_ProcessChildPowerIrp"} USBPRINT_ProcessChildPowerIrp(actual_DeviceObject_38: int, actual_Irp_20: int) returns (Tmp_314: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 563} irpStack_6 := sdv_IoGetCurrentIrpStackLocation(Irp_20);
  ...
  anon11_Else:
    ...
    assume SLAM_guard_S_0 != SLAM_guard_S_0_init;
    call {:si_unique_call 565} SLIC_sdv_IoCompleteRequest_entry(strConst__li2bpl1);
    goto anon12_Then, anon12_Else;
...
implementation {:origName "USBPRINT_DeferIrpCompletion"} USBPRINT_DeferIrpCompletion(actual_DeviceObject_39: int, actual_Irp_21: int, actual_Context_10: int) returns (Tmp_316: int)
{
  ...
  anon0:
    ...
    event_3 := Context_10;
    call {:si_unique_call 567} vslice_dummy_var_98 := KeSetEvent(event_3, 1, 0);
    Tmp_316 := -1073741802;
    return;
}
...
procedure {:origName "USBPRINT_ProcessFdoPowerIrp"} USBPRINT_ProcessFdoPowerIrp(actual_DeviceObject_40: int, actual_Irp_22: int) returns (Tmp_318: int);
  modifies alloc, Mem_T.CompletionRoutine__IO_STACK_LOCATION, sdv_compFset, sdv_invoke_on_success, sdv_invoke_on_error, sdv_invoke_on_cancel, forward_state, s, yogi_error;
  free ensures {:va_keep} old(forward_state) == 1 ==> forward_state != 0;
  free ensures {:va_keep} old(s) == 2 ==> s != 0;
  free ensures {:va_keep} old(s) == 1 ==> s != 0;
  free ensures {:va_keep} old(SLAM_guard_S_0) == old(SLAM_guard_S_0_init) ==> forward_state == old(forward_state);
...
implementation {:origName "USBPRINT_ProcessFdoPowerIrp"} USBPRINT_ProcessFdoPowerIrp(actual_DeviceObject_40: int, actual_Irp_22: int) returns (Tmp_318: int)
{
  ...
  anon0:
    call {:si_unique_call 568} hookIt_1 := __HAVOC_malloc(4);
    call {:si_unique_call 569} powerState := __HAVOC_malloc(8);
    DeviceObject_40 := actual_DeviceObject_40;
    Irp_22 := actual_Irp_22;
    call {:si_unique_call 570} Tmp_321 := __HAVOC_malloc(28);
    ntStatus_28 := 0;
    ...
    call {:si_unique_call 571} irpStack_7 := sdv_IoGetCurrentIrpStackLocation(Irp_22);
    call {:si_unique_call 572} USBPRINT_IncrementIoCount(DeviceObject_40);
  ...
  anon26_Then:
    call {:si_unique_call 573} vslice_dummy_var_100 := USBPRINT_DecrementIoCount(DeviceObject_40);
    goto L70;
  ...
  anon27_Then:
    ...
    call {:si_unique_call 574} vslice_dummy_var_99 := USBPRINT_SetDevicePowerState(DeviceObject_40, vslice_dummy_var_403, hookIt_1);
    call {:si_unique_call 575} PoStartNextPowerIrp(0);
    call {:si_unique_call 576} sdv_IoCopyCurrentIrpStackLocationToNext(Irp_22);
    assume {:nonnull} hookIt_1 != 0;
    assume hookIt_1 > 0;
    goto anon25_Then, anon25_Else;

  anon25_Else:
    call {:si_unique_call 577} sdv_IoSetCompletionRoutine(Irp_22, li2bplFunctionConstant388, DeviceObject_40, 1, 1, 1);
    goto anon28_Then, anon28_Else;

  anon28_Else:
    assume Irp_22 == SLAM_guard_S_0;
    assume SLAM_guard_S_0 != SLAM_guard_S_0_init;
    call {:si_unique_call 578} SLIC_sdv_IoSetCompletionRoutine_exit(0);
    goto L35;

  L35:
    call {:si_unique_call 579} ntStatus_28 := PoCallDriver(0, Irp_22);
    goto anon32_Then, anon32_Else;
  ...
  anon29_Else:
    assume {:nonnull} deviceExtension_24 != 0;
    assume deviceExtension_24 > 0;
    call {:si_unique_call 580} sdv_IoMarkIrpPending(0);
    assume {:nonnull} deviceExtension_24 != 0;
    assume deviceExtension_24 > 0;
    havoc vslice_dummy_var_404;
    call {:si_unique_call 581} ntStatus_28 := PoRequestPowerIrp(vslice_dummy_var_404, 2, powerState, li2bplFunctionConstant387, DeviceObject_40, 0);
    goto anon30_Then, anon30_Else;
  ...
  anon29_Then:
    call {:si_unique_call 582} PoStartNextPowerIrp(0);
    call {:si_unique_call 583} sdv_IoCopyCurrentIrpStackLocationToNext(Irp_22);
    call {:si_unique_call 584} ntStatus_28 := PoCallDriver(0, Irp_22);
    goto anon31_Then, anon31_Else;
  ...
  anon23_Then:
    call {:si_unique_call 585} PoStartNextPowerIrp(0);
    call {:si_unique_call 586} sdv_IoCopyCurrentIrpStackLocationToNext(Irp_22);
    call {:si_unique_call 587} ntStatus_28 := PoCallDriver(0, Irp_22);
    goto anon33_Then, anon33_Else;
...
implementation {:origName "USBPRINT_ConfigureDevice"} USBPRINT_ConfigureDevice(actual_DeviceObject_41: int) returns (Tmp_322: int)
{
  ...
  anon0:
    call {:si_unique_call 588} timeOut_6 := __HAVOC_malloc(20);
    DeviceObject_41 := actual_DeviceObject_41;
    configurationDescriptor_3 := 0;
    tries := 0;
    assume {:nonnull} timeOut_6 != 0;
    assume timeOut_6 > 0;
    call {:si_unique_call 589} sdv_252 := ExAllocatePoolWithTag(512, 80, -800959659);
    urb_12 := sdv_252;
    goto anon29_Then, anon29_Else;
  ...
  L19:
    call {:si_unique_call 590} siz_3, tries, sdv_253, ntStatus_29, Tmp_324, configurationDescriptor_3 := USBPRINT_ConfigureDevice_loop_L19(timeOut_6, siz_3, tries, sdv_253, ntStatus_29, urb_12, Tmp_324, configurationDescriptor_3, DeviceObject_41);
    goto L19_last;

  L19_last:
    call {:si_unique_call 597} sdv_253 := ExAllocatePoolWithTag(512, siz_3, -800959659);
  ...
  anon30_Else:
    ...
    assume {:nonnull} urb_12 != 0;
    assume urb_12 > 0;
    call {:si_unique_call 591} ntStatus_29 := USBPRINT_CallUSBD#1(DeviceObject_41, urb_12, timeOut_6);
    goto anon31_Then, anon31_Else;
  ...
  anon28_Else:
    assume {:partition} ntStatus_29 >= 0;
    call {:si_unique_call 594} ntStatus_29 := USBPRINT_SelectInterface(DeviceObject_41, configurationDescriptor_3);
    goto anon32_Then, anon32_Else;
  ...
  L60:
    call {:si_unique_call 595} sdv_ExFreePool(0);
    goto L58;
...
procedure {:origName "USBPRINT_Dispatch"} USBPRINT_Dispatch(actual_DeviceObject_42: int, actual_Irp_23: int) returns (Tmp_325: int);
  modifies alloc, Mem_T.CompletionRoutine__IO_STACK_LOCATION, sdv_compFset, sdv_invoke_on_success, sdv_invoke_on_error, sdv_invoke_on_cancel, forward_state, yogi_error, s;
  free ensures {:va_keep} old(forward_state) == 1 ==> forward_state != 0;
  free ensures {:va_keep} old(s) == 2 ==> s != 0;
  free ensures {:va_keep} old(s) == 1 ==> s != 0;
  free ensures {:va_keep} old(SLAM_guard_S_0) == old(SLAM_guard_S_0_init) ==> forward_state == old(forward_state);
...
implementation {:origName "USBPRINT_Dispatch"} USBPRINT_Dispatch(actual_DeviceObject_42: int, actual_Irp_23: int) returns (Tmp_325: int)
{
  ...
  anon0:
    call {:si_unique_call 598} event_4 := __HAVOC_malloc(156);
    call {:si_unique_call 599} UnicodeDeviceText := __HAVOC_malloc(12);
    call {:si_unique_call 600} bHandled := __HAVOC_malloc(4);
    call {:si_unique_call 601} vslice_dummy_var_101 := __HAVOC_malloc(12);
    call {:si_unique_call 602} event_5 := __HAVOC_malloc(156);
    DeviceObject_42 := actual_DeviceObject_42;
    Irp_23 := actual_Irp_23;
    ntStatus_30 := 0;
    assume {:nonnull} bHandled != 0;
    assume bHandled > 0;
    call {:si_unique_call 603} irpStack_8 := sdv_IoGetCurrentIrpStackLocation(Irp_23);
    ...
    call {:si_unique_call 604} USBPRINT_IncrementIoCount(DeviceObject_42);
  ...
  anon158_Else:
    call {:si_unique_call 605} ntStatus_30 := SetPortName(deviceExtension_25, irpStack_8, Irp_23, DeviceObject_42);
    assume {:nonnull} bHandled != 0;
    assume bHandled > 0;
    call {:si_unique_call 606} vslice_dummy_var_120 := USBPRINT_DecrementIoCount(DeviceObject_42);
  ...
  anon218_Else:
    ...
    assume SLAM_guard_S_0 != SLAM_guard_S_0_init;
    call {:si_unique_call 607} SLIC_sdv_IoCompleteRequest_entry(strConst__li2bpl1);
  ...
  L302:
    Tmp_325 := ntStatus_30;
    call {:si_unique_call 609} SLIC_USBPRINT_Dispatch_exit(strConst__li2bpl0, Tmp_325);
  ...
  anon186_Else:
    assume Irp_23 == SLAM_guard_S_0;
    assume SLAM_guard_S_0 != SLAM_guard_S_0_init;
    call {:si_unique_call 610} SLIC_sdv_IoCompleteRequest_entry(strConst__li2bpl1);
  ...
  L310:
    call {:si_unique_call 612} vslice_dummy_var_112 := USBPRINT_DecrementIoCount(DeviceObject_42);
    goto L302;
  ...
  anon167_Then:
    call {:si_unique_call 613} sdv_IoSkipCurrentIrpStackLocation(Irp_23);
    call {:si_unique_call 614} ntStatus_30 := sdv_IoCallDriver#1(stackDeviceObject_1, Irp_23);
  ...
  anon214_Else:
    assume Irp_23 == SLAM_guard_S_0;
    assume SLAM_guard_S_0 != SLAM_guard_S_0_init;
    call {:si_unique_call 615} SLIC_sdv_IoCompleteRequest_entry(strConst__li2bpl1);
  ...
  L53:
    assume {:nonnull} bHandled != 0;
    assume bHandled > 0;
    call {:si_unique_call 617} vslice_dummy_var_118 := USBPRINT_DecrementIoCount(DeviceObject_42);
    goto L20;
  ...
  anon157_Then:
    assume {:nonnull} deviceExtension_25 != 0;
    assume deviceExtension_25 > 0;
    call {:si_unique_call 618} vslice_dummy_var_119 := IoSetDeviceInterfaceState(0, 0);
    call {:si_unique_call 619} ntStatus_30 := USBPRINT_StopDevice(DeviceObject_42);
  ...
  anon216_Else:
    ...
    assume {:nonnull} deviceExtension_25 != 0;
    assume deviceExtension_25 > 0;
    call {:si_unique_call 620} sdv_IoSkipCurrentIrpStackLocation(Irp_23);
    call {:si_unique_call 621} ntStatus_30 := sdv_IoCallDriver#1(stackDeviceObject_1, Irp_23);
  ...
  anon156_Else:
    call {:si_unique_call 622} sdv_272 := ExAllocatePoolWithTag(1, 24, -800959659);
    pBusInfo := sdv_272;
  ...
  L87:
    assume {:nonnull} bHandled != 0;
    assume bHandled > 0;
    call {:si_unique_call 623} vslice_dummy_var_117 := USBPRINT_DecrementIoCount(DeviceObject_42);
    assume {:nonnull} Irp_23 != 0;
    assume Irp_23 > 0;
  ...
  anon212_Else:
    assume Irp_23 == SLAM_guard_S_0;
    assume SLAM_guard_S_0 != SLAM_guard_S_0_init;
    call {:si_unique_call 624} SLIC_sdv_IoCompleteRequest_entry(strConst__li2bpl1);
  ...
  anon155_Else:
    call {:si_unique_call 626} ntStatus_30 := ProduceQueriedID(deviceExtension_25, irpStack_8, Irp_23, DeviceObject_42);
    assume {:nonnull} bHandled != 0;
    assume bHandled > 0;
    call {:si_unique_call 627} vslice_dummy_var_116 := USBPRINT_DecrementIoCount(DeviceObject_42);
    assume {:nonnull} Irp_23 != 0;
    assume Irp_23 > 0;
  ...
  anon209_Else:
    assume Irp_23 == SLAM_guard_S_0;
    assume SLAM_guard_S_0 != SLAM_guard_S_0_init;
    call {:si_unique_call 628} SLIC_sdv_IoCompleteRequest_entry(strConst__li2bpl1);
  ...
  anon206_Else:
    call {:si_unique_call 630} RtlInitAnsiString(0, 0);
    call {:si_unique_call 631} ntStatus_30 := RtlAnsiStringToUnicodeString(0, 0, 1);
  ...
  L127:
    assume {:nonnull} bHandled != 0;
    assume bHandled > 0;
    call {:si_unique_call 632} vslice_dummy_var_115 := USBPRINT_DecrementIoCount(DeviceObject_42);
    assume {:nonnull} Irp_23 != 0;
    assume Irp_23 > 0;
  ...
  anon207_Else:
    assume Irp_23 == SLAM_guard_S_0;
    assume SLAM_guard_S_0 != SLAM_guard_S_0_init;
    call {:si_unique_call 633} SLIC_sdv_IoCompleteRequest_entry(strConst__li2bpl1);
  ...
  anon153_Else:
    call {:si_unique_call 635} KeInitializeEvent(event_5, 0, 0);
    call {:si_unique_call 636} sdv_IoCopyCurrentIrpStackLocationToNext(Irp_23);
    call {:si_unique_call 637} sdv_IoSetCompletionRoutine(Irp_23, li2bplFunctionConstant390, event_5, 1, 1, 1);
    goto anon182_Then, anon182_Else;

  anon182_Else:
    assume Irp_23 == SLAM_guard_S_0;
    assume SLAM_guard_S_0 != SLAM_guard_S_0_init;
    call {:si_unique_call 638} SLIC_sdv_IoSetCompletionRoutine_exit(0);
    goto L159;

  L159:
    call {:si_unique_call 639} ntStatus_30 := sdv_IoCallDriver#1(stackDeviceObject_1, Irp_23);
  ...
  anon161_Else:
    ...
    call {:si_unique_call 640} vslice_dummy_var_102 := KeWaitForSingleObject(0, 5, 0, 0, 0);
    assume {:nonnull} Irp_23 != 0;
    assume Irp_23 > 0;
    havoc ntStatus_30;
    goto L164;
  ...
  anon160_Else:
    assume Irp_23 == SLAM_guard_S_0;
    assume SLAM_guard_S_0 != SLAM_guard_S_0_init;
    call {:si_unique_call 641} SLIC_sdv_IoCompleteRequest_entry(strConst__li2bpl1);
  ...
  L370:
    ...
    assume {:nonnull} bHandled != 0;
    assume bHandled > 0;
    call {:si_unique_call 643} vslice_dummy_var_114 := USBPRINT_DecrementIoCount(DeviceObject_42);
    goto L20;
  ...
  anon174_Then:
    ...
    call {:si_unique_call 644} ntStatus_30 := QueryDeviceRelations(DeviceObject_42, Irp_23, vslice_dummy_var_405, bHandled);
  ...
  anon163_Else:
    call {:si_unique_call 645} vslice_dummy_var_103 := USBPRINT_DecrementIoCount(DeviceObject_42);
    goto L20;
  ...
  anon191_Else:
    assume Irp_23 == SLAM_guard_S_0;
    assume SLAM_guard_S_0 != SLAM_guard_S_0_init;
    call {:si_unique_call 646} SLIC_sdv_IoCompleteRequest_entry(strConst__li2bpl1);
  ...
  L254:
    call {:si_unique_call 648} vslice_dummy_var_109 := USBPRINT_DecrementIoCount(DeviceObject_42);
    assume {:nonnull} bHandled != 0;
    assume bHandled > 0;
    goto L20;
  ...
  anon150_Then:
    assume {:nonnull} Irp_23 != 0;
    assume Irp_23 > 0;
    call {:si_unique_call 649} sdv_IoSkipCurrentIrpStackLocation(Irp_23);
    call {:si_unique_call 650} ntStatus_30 := sdv_IoCallDriver#1(stackDeviceObject_1, Irp_23);
  ...
  anon199_Else:
    assume Irp_23 == SLAM_guard_S_0;
    assume SLAM_guard_S_0 != SLAM_guard_S_0_init;
    call {:si_unique_call 651} SLIC_sdv_IoCompleteRequest_entry(strConst__li2bpl1);
  ...
  L185:
    assume {:nonnull} bHandled != 0;
    assume bHandled > 0;
    call {:si_unique_call 653} vslice_dummy_var_113 := USBPRINT_DecrementIoCount(DeviceObject_42);
    goto L20;
  ...
  anon152_Then:
    call {:si_unique_call 654} ntStatus_30 := USBPRINT_StopDevice(DeviceObject_42);
  ...
  anon201_Else:
    ...
    assume {:nonnull} Irp_23 != 0;
    assume Irp_23 > 0;
    call {:si_unique_call 655} sdv_IoSkipCurrentIrpStackLocation(Irp_23);
    call {:si_unique_call 656} ntStatus_30 := sdv_IoCallDriver#1(stackDeviceObject_1, Irp_23);
  ...
  anon151_Else:
    call {:si_unique_call 657} vslice_dummy_var_105 := USBPRINT_DecrementIoCount(DeviceObject_42);
    assume {:nonnull} Irp_23 != 0;
    assume Irp_23 > 0;
    ntStatus_30 := 0;
  ...
  anon194_Else:
    assume Irp_23 == SLAM_guard_S_0;
    assume SLAM_guard_S_0 != SLAM_guard_S_0_init;
    call {:si_unique_call 658} SLIC_sdv_IoCompleteRequest_entry(strConst__li2bpl1);
  ...
  anon151_Then:
    call {:si_unique_call 660} vslice_dummy_var_104 := USBPRINT_DecrementIoCount(DeviceObject_42);
    call {:si_unique_call 661} ntStatus_30 := USBPRINT_StopDevice(DeviceObject_42);
  ...
  anon197_Else:
    assume {:nonnull} deviceExtension_25 != 0;
    assume deviceExtension_25 > 0;
    call {:si_unique_call 662} IoDeleteDevice(0);
    goto L219;
  ...
  anon164_Else:
    assume {:partition} ntStatus_30 >= 0;
    call {:si_unique_call 663} sdv_IoCopyCurrentIrpStackLocationToNext(Irp_23);
    call {:si_unique_call 664} ntStatus_30 := sdv_IoCallDriver#1(stackDeviceObject_1, Irp_23);
    goto anon198_Then, anon198_Else;

  anon198_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 665} vslice_dummy_var_106 := USBPRINT_DecrementIoCount(DeviceObject_42);
    call {:si_unique_call 666} vslice_dummy_var_107 := KeWaitForSingleObject(0, 5, 0, 0, 0);
    call {:si_unique_call 667} vslice_dummy_var_108 := USBPRINT_RemoveDevice(DeviceObject_42);
    call {:si_unique_call 668} IoDetachDevice(0);
  ...
  anon149_Else:
    call {:si_unique_call 670} KeInitializeEvent(event_4, 0, 0);
    call {:si_unique_call 671} sdv_IoCopyCurrentIrpStackLocationToNext(Irp_23);
    call {:si_unique_call 672} sdv_IoSetCompletionRoutine(Irp_23, li2bplFunctionConstant390, event_4, 1, 1, 1);
    goto anon181_Then, anon181_Else;

  anon181_Else:
    assume Irp_23 == SLAM_guard_S_0;
    assume SLAM_guard_S_0 != SLAM_guard_S_0_init;
    call {:si_unique_call 673} SLIC_sdv_IoSetCompletionRoutine_exit(0);
    goto L286;

  L286:
    call {:si_unique_call 674} ntStatus_30 := sdv_IoCallDriver#1(stackDeviceObject_1, Irp_23);
  ...
  anon165_Else:
    assume {:partition} ntStatus_30 == 259;
    call {:si_unique_call 675} vslice_dummy_var_111 := KeWaitForSingleObject(0, 5, 0, 0, 0);
    assume {:nonnull} Irp_23 != 0;
    assume Irp_23 > 0;
    havoc ntStatus_30;
    goto L291;
  ...
  anon166_Else:
    assume {:partition} ntStatus_30 >= 0;
    call {:si_unique_call 676} ntStatus_30 := USBPRINT_StartDevice(DeviceObject_42);
  ...
  anon183_Else:
    assume Irp_23 == SLAM_guard_S_0;
    assume SLAM_guard_S_0 != SLAM_guard_S_0_init;
    call {:si_unique_call 677} SLIC_sdv_IoCompleteRequest_entry(strConst__li2bpl1);
  ...
  L352:
    call {:si_unique_call 678} sdv_IoCompleteRequest(0, 0);
    call {:si_unique_call 679} vslice_dummy_var_110 := USBPRINT_DecrementIoCount(DeviceObject_42);
    goto L20;
...
implementation {:origName "RtlStringCbPrintfW"} RtlStringCbPrintfW(actual_pszDest_5: int, actual_cbDest_1: int, actual_pszFormat_2: int) returns (Tmp_332: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 680} pszFormat_2 := __HAVOC_malloc(4);
    cchDest_5 := INTDIV(cbDest_1, 2);
    call {:si_unique_call 681} status_16 := RtlStringValidateDestW_sdv_static_function_1(pszDest_5, cchDest_5, -1);
    goto anon5_Then, anon5_Else;
  ...
  anon5_Else:
    ...
    call {:si_unique_call 682} status_16 := RtlStringVPrintfWorkerW_sdv_static_function_1(pszDest_5, cchDest_5, 0, vslice_dummy_var_406, argList_2);
    argList_2 := 0;
    goto L19;
...
implementation {:origName "RtlStringVPrintfWorkerA_sdv_static_function_1"} RtlStringVPrintfWorkerA_sdv_static_function_1(actual_pszDest_6: int, actual_cchDest_6: int, actual_pcchNewDestLength_2: int, actual_pszFormat_3: int, actual_argList_3: int) returns (Tmp_334: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 683} iRet_1 := corral_nondet();
    goto anon9_Then, anon9_Else;
...
implementation {:origName "USBPRINT_SelectInterface"} USBPRINT_SelectInterface(actual_DeviceObject_43: int, actual_ConfigurationDescriptor: int) returns (Tmp_336: int)
{
  ...
  anon0:
    call {:si_unique_call 684} timeOut_7 := __HAVOC_malloc(20);
    DeviceObject_43 := actual_DeviceObject_43;
    call {:si_unique_call 685} Tmp_341 := __HAVOC_malloc(28);
    call {:si_unique_call 686} InterfaceList := __HAVOC_malloc(16);
  ...
  anon29_Else:
    ...
    assume InterfaceList > 0;
    havoc Interface;
    call {:si_unique_call 687} ntStatus_31 := USBPRINT_CallUSBD#1(DeviceObject_43, urb_13, timeOut_7);
    goto anon35_Then, anon35_Else;
  ...
  anon28_Else:
    ...
    assume Interface > 0;
    havoc Tmp_339;
    call {:si_unique_call 688} sdv_298 := ExAllocatePoolWithTag(512, Tmp_339, -800959659);
    assume {:nonnull} deviceExtension_26 != 0;
    assume deviceExtension_26 > 0;
    assume {:nonnull} deviceExtension_26 != 0;
    assume deviceExtension_26 > 0;
  ...
  anon36_Else:
    ...
    assume Interface > 0;
    havoc Tmp_338;
    call {:si_unique_call 689} sdv_RtlCopyMemory(0, 0, Tmp_338);
    j := 0;
    goto L55;

  L55:
    call {:si_unique_call 690} j, Tmp_337, Tmp_341, Tmp_342 := USBPRINT_SelectInterface_loop_L55(Interface, j, Tmp_337, Tmp_341, Tmp_342, deviceExtension_26);
    goto L55_last;
  ...
  anon34_Then:
    call {:si_unique_call 692} urb_13 := __HAVOC_malloc(1);
    goto L33;
  ...
  anon26_Then:
    call {:si_unique_call 693} interfaceDescriptor := __HAVOC_malloc(1);
    goto L64;

  anon33_Then:
    call {:si_unique_call 694} interfaceDescriptor := __HAVOC_malloc(1);
    goto L20;
}
...
implementation {:origName "RtlStringValidateDestAndLengthA_sdv_static_function_1"} RtlStringValidateDestAndLengthA_sdv_static_function_1(actual_pszDest_7: int, actual_cchDest_7: int, actual_pcchDestLength: int, actual_cchMax_5: int) returns (Tmp_343: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 695} status_18 := RtlStringValidateDestA_sdv_static_function_1(pszDest_7, cchDest_7, cchMax_5);
    goto anon3_Then, anon3_Else;

  anon3_Else:
    assume {:partition} status_18 >= 0;
    call {:si_unique_call 696} status_18 := RtlStringLengthWorkerA_sdv_static_function_1(pszDest_7, cchDest_7, pcchDestLength);
    goto L14;
...
implementation {:origName "USBPRINT_FdoRequestWake"} USBPRINT_FdoRequestWake(actual_DevExt_1: int)
{
  ...
  anon0:
    call {:si_unique_call 697} powerState_1 := __HAVOC_malloc(8);
    call {:si_unique_call 698} vslice_dummy_var_121 := __HAVOC_malloc(4);
    DevExt_1 := actual_DevExt_1;
    bExit := 0;
    call {:si_unique_call 699} Tmp_345 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_345 != 0;
    assume Tmp_345 > 0;
    call {:si_unique_call 700} sdv_KeAcquireSpinLock(0, Tmp_345);
    assume {:nonnull} Tmp_345 != 0;
    assume Tmp_345 > 0;
    havoc OldIrql;
  ...
  L15:
    call {:si_unique_call 701} sdv_KeReleaseSpinLock(0, OldIrql);
    goto anon14_Then, anon14_Else;
  ...
  anon14_Else:
    ...
    call {:si_unique_call 702} vslice_dummy_var_122 := PoRequestPowerIrp(vslice_dummy_var_407, 2, powerState_1, 0, 0, 0);
    goto anon15_Then, anon15_Else;
...
implementation {:origName "ProduceQueriedID"} ProduceQueriedID(actual_deviceExtension_27: int, actual_irpStack_9: int, actual_Irp_24: int, actual_DeviceObject_44: int) returns (Tmp_347: int)
{
  ...
  anon0:
    call {:si_unique_call 703} vslice_dummy_var_123 := __HAVOC_malloc(12);
    call {:si_unique_call 704} UnicodeDeviceId := __HAVOC_malloc(12);
    call {:si_unique_call 705} pString_1 := __HAVOC_malloc(4);
    deviceExtension_27 := actual_deviceExtension_27;
    irpStack_9 := actual_irpStack_9;
    Irp_24 := actual_Irp_24;
    call {:si_unique_call 706} Tmp_351 := __HAVOC_malloc(4096);
    call {:si_unique_call 707} Tmp_352 := __HAVOC_malloc(4096);
    call {:si_unique_call 708} Tmp_353 := __HAVOC_malloc(48);
    call {:si_unique_call 709} Tmp_355 := __HAVOC_malloc(52);
    call {:si_unique_call 710} Tmp_357 := __HAVOC_malloc(32);
    call {:si_unique_call 711} Tmp_359 := __HAVOC_malloc(48);
    call {:si_unique_call 712} Tmp_360 := __HAVOC_malloc(88);
    ntStatus_32 := 0;
    ...
    call {:si_unique_call 713} sdv_308 := ExAllocatePoolWithTag(512, 1024, -800959659);
    pRawString := sdv_308;
    call {:si_unique_call 714} sdv_314 := ExAllocatePoolWithTag(512, 1024, -800959659);
    pTempString := sdv_314;
    goto anon71_Then, anon71_Else;
  ...
  anon49_Else:
    ...
    call {:si_unique_call 715} sdv_RtlZeroMemory(0, 1024);
    call {:si_unique_call 716} sdv_RtlZeroMemory(0, 1024);
  ...
  anon68_Else:
    Tmp_357 := strConst__li2bpl28;
    call {:si_unique_call 717} vslice_dummy_var_129 := RtlStringCbPrintfA(pRawString, 1024, Tmp_357);
    call {:si_unique_call 718} RtlInitAnsiString(0, 0);
    call {:si_unique_call 719} sdv_318 := RtlAnsiStringToUnicodeString(0, 0, 1);
    goto anon51_Then, anon51_Else;
  ...
  anon54_Else:
    ...
    call {:si_unique_call 722} ntStatus_32 := ParPnpGetId(vslice_dummy_var_408, vslice_dummy_var_409, pRawString, 1024);
    goto anon55_Then, anon55_Else;
  ...
  L86:
    call {:si_unique_call 723} Tmp_348, Tmp_349, iTotalLen, Tmp_354, Tmp_355, pDelimitedString, Tmp_358, Tmp_360, vslice_dummy_var_127, vslice_dummy_var_128 := ProduceQueriedID_loop_L86(Tmp_348, Tmp_349, sdv_304, pTempString, iTotalLen, Tmp_354, Tmp_355, sdv_312, pDelimitedString, sdv_320, Tmp_358, pString_1, sdv_325, Tmp_360, vslice_dummy_var_127, vslice_dummy_var_128);
    goto L86_last;
  ...
  anon60_Else:
    ...
    call {:si_unique_call 724} RtlInitAnsiString(0, 0);
    call {:si_unique_call 725} sdv_321 := RtlAnsiStringToUnicodeString(0, 0, 1);
    goto anon61_Then, anon61_Else;
  ...
  L138:
    call {:si_unique_call 726} ProduceQueriedID_loop_L138(pWString);
    goto L138_last;
  ...
  anon56_Then:
    ...
    pDelimitedString := 0;
    call {:si_unique_call 727} pDelimitedString := GetDelimitedString(pString_1, 44);
    goto anon57_Then, anon57_Else;
  ...
  anon59_Then:
    ...
    call {:si_unique_call 728} FixupDeviceId(pDelimitedString);
    Tmp_354 := 1024 - iTotalLen;
    Tmp_348 := pTempString;
    Tmp_360 := strConst__li2bpl30;
    call {:si_unique_call 729} vslice_dummy_var_127 := RtlStringCbPrintfA(Tmp_348, Tmp_354, Tmp_360);
    iTotalLen := sdv_304;
    Tmp_349 := 1024 - iTotalLen;
    Tmp_358 := pTempString;
    Tmp_355 := strConst__li2bpl31;
    call {:si_unique_call 730} vslice_dummy_var_128 := RtlStringCbPrintfA(Tmp_358, Tmp_349, Tmp_355);
    iTotalLen := sdv_320;
  ...
  anon70_Then:
    ...
    call {:si_unique_call 731} ntStatus_32 := ParPnpGetId(vslice_dummy_var_410, vslice_dummy_var_411, pRawString, 1024);
    goto anon64_Then, anon64_Else;
  ...
  anon65_Then:
    ...
    Tmp_359 := strConst__li2bpl29;
    call {:si_unique_call 732} vslice_dummy_var_125 := RtlStringCbPrintfA(pTempString, 1024, Tmp_359);
    assume {:nonnull} pTempString != 0;
    assume pTempString > 0;
    assume {:nonnull} pTempString != 0;
    assume pTempString > 0;
    call {:si_unique_call 733} vslice_dummy_var_126 := RtlStringCbCatA(pTempString, 1024, pRawString);
    iTotalLen := sdv_311;
    assume {:nonnull} pTempString != 0;
    assume pTempString > 0;
    assume {:nonnull} pTempString != 0;
    assume pTempString > 0;
    call {:si_unique_call 734} FixupDeviceId(pTempString);
    call {:si_unique_call 735} RtlInitAnsiString(0, 0);
    call {:si_unique_call 736} sdv_306 := RtlAnsiStringToUnicodeString(0, 0, 1);
    goto anon66_Then, anon66_Else;
  ...
  anon50_Then:
    ...
    assume pParentExtension_2 > 0;
    havoc Tmp_352;
    Tmp_353 := strConst__li2bpl29;
    call {:si_unique_call 737} vslice_dummy_var_124 := RtlStringCbPrintfA(pRawString, 1024, Tmp_353);
    call {:si_unique_call 738} FixupDeviceId(pRawString);
    call {:si_unique_call 739} RtlInitAnsiString(0, 0);
    call {:si_unique_call 740} sdv_307 := RtlAnsiStringToUnicodeString(0, 0, 1);
    goto anon67_Then, anon67_Else;
...
implementation {:origName "SetPortName"} SetPortName(actual_deviceExtension_28: int, actual_irpStack_10: int, actual_Irp_25: int, actual_DeviceObject_45: int) returns (Tmp_361: int)
{
  ...
  anon0:
    call {:si_unique_call 741} uncPortValueName := __HAVOC_malloc(12);
    deviceExtension_28 := actual_deviceExtension_28;
    call {:si_unique_call 742} Tmp_362 := __HAVOC_malloc(32);
    call {:si_unique_call 743} tempString := __HAVOC_malloc(128);
    call {:si_unique_call 744} Tmp_365 := __HAVOC_malloc(36);
    pChildExtension_2 := deviceExtension_28;
    call {:si_unique_call 745} ntStatus_33 := IoOpenDeviceRegistryKey(0, 1, 983103, 0);
    goto anon5_Then, anon5_Else;

  anon5_Else:
    assume {:partition} ntStatus_33 >= 0;
    call {:si_unique_call 746} sdv_RtlZeroMemory(0, 64);
    Tmp_362 := strConst__li2bpl28;
    call {:si_unique_call 747} ntStatus_33 := RtlStringCbPrintfW(tempString, 64, Tmp_362);
    goto anon6_Then, anon6_Else;

  anon6_Else:
    assume {:partition} ntStatus_33 >= 0;
    Tmp_365 := strConst__li2bpl32;
    call {:si_unique_call 748} RtlInitUnicodeString(uncPortValueName, Tmp_365);
    Tmp_363 := (sdv_328 + 1) * 2;
    call {:si_unique_call 749} ntStatus_33 := ZwSetValueKey(0, 0, 0, 1, 0, Tmp_363);
    goto L24;

  L24:
    call {:si_unique_call 750} vslice_dummy_var_130 := ZwClose(0);
    goto L15;
...
implementation {:origName "USBPRINT_IncrementIoCount"} USBPRINT_IncrementIoCount(actual_DeviceObject_46: int)
{
  ...
  anon0:
    call {:si_unique_call 751} vslice_dummy_var_131 := __HAVOC_malloc(4);
  ...
  anon3_Else:
    call {:si_unique_call 752} Tmp_366 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_366 != 0;
    assume Tmp_366 > 0;
    assume {:nonnull} deviceExtension_29 != 0;
    assume deviceExtension_29 > 0;
    call {:si_unique_call 753} vslice_dummy_var_132 := sdv_InterlockedIncrement(Tmp_366);
    assume {:nonnull} Tmp_366 != 0;
    assume Tmp_366 > 0;
    assume {:nonnull} deviceExtension_29 != 0;
    assume deviceExtension_29 > 0;
    assume {:nonnull} deviceExtension_29 != 0;
    assume deviceExtension_29 > 0;
    call {:si_unique_call 754} KeClearEvent(RemoveEvent__DEVICE_EXTENSION(deviceExtension_29));
    goto L1;
...
implementation {:origName "USBPRINT_BuildPipeList"} USBPRINT_BuildPipeList(actual_DeviceObject_47: int) returns (Tmp_368: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 755} Tmp_370 := __HAVOC_malloc(28);
    call {:si_unique_call 756} Tmp_372 := __HAVOC_malloc(28);
    call {:si_unique_call 757} Tmp_374 := __HAVOC_malloc(28);
    call {:si_unique_call 758} vslice_dummy_var_133 := __HAVOC_malloc(32);
    bFoundWritePipe := 0;
    bFoundReadPipe := 0;
    bNeedReadPipe := 0;
  ...
  L21:
    call {:si_unique_call 759} i_2, Tmp_369, Tmp_370, Tmp_371, bFoundReadPipe, Tmp_372, bFoundWritePipe, Tmp_373, Tmp_374 := USBPRINT_BuildPipeList_loop_L21(i_2, Tmp_369, Tmp_370, Tmp_371, bNeedReadPipe, bFoundReadPipe, InterfaceDescriptor, Tmp_372, bFoundWritePipe, Tmp_373, Tmp_374, deviceExtension_30);
    goto L21_last;
...
implementation {:origName "RtlStringCbCatA"} RtlStringCbCatA(actual_pszDest_8: int, actual_cbDest_2: int, actual_pszSrc_1: int) returns (Tmp_378: int)
{
  ...
  anon0:
    call {:si_unique_call 760} cchDestLength := __HAVOC_malloc(4);
    pszDest_8 := actual_pszDest_8;
    cbDest_2 := actual_cbDest_2;
    pszSrc_1 := actual_pszSrc_1;
    cchDest_8 := INTDIV(cbDest_2, 1);
    call {:si_unique_call 761} status_19 := RtlStringValidateDestAndLengthA_sdv_static_function_1(pszDest_8, cchDest_8, cchDestLength, -1);
    goto anon3_Then, anon3_Else;
  ...
  anon3_Else:
    ...
    havoc Tmp_379;
    Tmp_380 := pszDest_8;
    call {:si_unique_call 762} status_19 := RtlStringCopyWorkerA_sdv_static_function_1(Tmp_380, Tmp_379, 0, pszSrc_1, -2);
    goto L12;
...
implementation corralExtraInit()
{
  ...
  anon0:
    ...
    assume (forall x: int :: { Mem_T.CompletionRoutine__IO_STACK_LOCATION[x] } Mem_T.CompletionRoutine__IO_STACK_LOCATION[x] <= 0 || Mem_T.CompletionRoutine__IO_STACK_LOCATION[x] > 740);
    return;
}
...
const {:string ""} unique strConst__li2bpl19: int;

const {:string "%.20s"} unique strConst__li2bpl18: int;

const {:string "%.20s%04X"} unique strConst__li2bpl21: int;

const {:string "%s"} unique strConst__li2bpl20: int;

const {:string "%s%s"} unique strConst__li2bpl22: int;

const {:string "1284_CID_%s "} unique strConst__li2bpl31: int;

const {:string "AID"} unique strConst__li2bpl6: int;

const {:string "AUTOMATICID"} unique strConst__li2bpl5: int;

const {:string "Base Name"} unique strConst__li2bpl24: int;

const {:string "CID"} unique strConst__li2bpl10: int;

const {:string "CLASS"} unique strConst__li2bpl7: int;

const {:string "CLS"} unique strConst__li2bpl8: int;

const {:string "COMPATIBLEID"} unique strConst__li2bpl9: int;

const {:string "DES"} unique strConst__li2bpl12: int;

const {:string "DESCRIPTION"} unique strConst__li2bpl11: int;

const {:string "Interface Number"} unique strConst__li2bpl27: int;

const {:string "MANUFACTURER"} unique strConst__li2bpl13: int;

const {:string "MDL"} unique strConst__li2bpl16: int;

const {:string "MFG"} unique strConst__li2bpl14: int;

const {:string "MODEL"} unique strConst__li2bpl15: int;

const {:string "Port Description"} unique strConst__li2bpl26: int;

const {:string "PortName"} unique strConst__li2bpl32: int;

const {:string "Serial Number"} unique strConst__li2bpl25: int;
...
const {:string "USB"} unique strConst__li2bpl23: int;

const {:string "USB%03u"} unique strConst__li2bpl28: int;

const {:string "USBPRINT\\%s"} unique strConst__li2bpl29: int;

const {:string "USBPRINT\\1284_CID_%s "} unique strConst__li2bpl30: int;

const {:string "UnknownPrinter"} unique strConst__li2bpl17: int;

const {:string "\\PIPE00"} unique strConst__li2bpl33: int;
...
implementation {:origName "USBPRINT_ResetWorkItem"} USBPRINT_ResetWorkItem#0(actual_deviceObject: int, actual_Context: int)
{
  ...
  anon0:
    call {:si_unique_call 763} vslice_dummy_var_134 := __HAVOC_malloc(4);
    ...
    call {:si_unique_call 764} vslice_dummy_var_136 := USBPRINT_ResetPipe#0(vslice_dummy_var_412, vslice_dummy_var_413, 0);
    goto anon8_Then, anon8_Else;
  ...
  L29:
    ...
    call {:si_unique_call 767} IoFreeWorkItem(0);
    assume {:nonnull} pResetWorkItemObj != 0;
    assume pResetWorkItemObj > 0;
    havoc devObj;
    call {:si_unique_call 768} sdv_ExFreePool(0);
    call {:si_unique_call 769} vslice_dummy_var_135 := USBPRINT_DecrementIoCount(devObj);
    goto LM2;
...
implementation {:origName "USBPRINT_ResetWorkItem"} USBPRINT_ResetWorkItem#1(actual_deviceObject: int, actual_Context: int)
{
  ...
  anon0:
    call {:si_unique_call 770} vslice_dummy_var_137 := __HAVOC_malloc(4);
    Context := actual_Context;
    pResetWorkItemObj := Context;
    assume {:nonnull} pResetWorkItemObj != 0;
    assume pResetWorkItemObj > 0;
    ...
    call {:si_unique_call 771} vslice_dummy_var_139 := USBPRINT_ResetPipe#1(vslice_dummy_var_414, vslice_dummy_var_415, 0);
    goto anon8_Then, anon8_Else;
  ...
  anon7_Else:
    assume SLAM_guard_S_0 != SLAM_guard_S_0_init;
    call {:si_unique_call 772} SLIC_sdv_IoCompleteRequest_entry(strConst__li2bpl1);
    goto anon9_Then, anon9_Else;
  ...
  L29:
    ...
    call {:si_unique_call 774} IoFreeWorkItem(0);
    assume {:nonnull} pResetWorkItemObj != 0;
    assume pResetWorkItemObj > 0;
    havoc devObj;
    call {:si_unique_call 775} sdv_ExFreePool(0);
    call {:si_unique_call 776} vslice_dummy_var_138 := USBPRINT_DecrementIoCount(devObj);
    goto LM2;
...
implementation {:origName "USBPRINT_ResetPipe"} USBPRINT_ResetPipe#0(actual_DeviceObject_48: int, actual_Pipe: int, actual_IsoClearStall: int) returns (Tmp_376: int)
{
  ...
  anon0:
    call {:si_unique_call 777} timeOut_8 := __HAVOC_malloc(20);
    DeviceObject_48 := actual_DeviceObject_48;
    Pipe := actual_Pipe;
    IsoClearStall := actual_IsoClearStall;
    assume {:nonnull} timeOut_8 != 0;
    assume timeOut_8 > 0;
    call {:si_unique_call 778} sdv_332 := ExAllocatePoolWithTag(512, 24, -800959659);
    urb_14 := sdv_332;
    goto anon18_Then, anon18_Else;
  ...
  anon17_Else:
    call {:si_unique_call 779} sdv_334 := ExAllocatePoolWithTag(512, 80, -800959659);
    urb_14 := sdv_334;
...
implementation {:origName "USBPRINT_ResetPipe"} USBPRINT_ResetPipe#1(actual_DeviceObject_48: int, actual_Pipe: int, actual_IsoClearStall: int) returns (Tmp_376: int)
{
  ...
  anon0:
    call {:si_unique_call 780} timeOut_8 := __HAVOC_malloc(20);
    DeviceObject_48 := actual_DeviceObject_48;
    Pipe := actual_Pipe;
    IsoClearStall := actual_IsoClearStall;
    assume {:nonnull} timeOut_8 != 0;
    assume timeOut_8 > 0;
    call {:si_unique_call 781} sdv_332 := ExAllocatePoolWithTag(512, 24, -800959659);
    urb_14 := sdv_332;
    goto anon18_Then, anon18_Else;
  ...
  anon18_Else:
    ...
    assume {:nonnull} urb_14 != 0;
    assume urb_14 > 0;
    call {:si_unique_call 782} ntStatus_34 := USBPRINT_CallUSBD#0(DeviceObject_48, urb_14, timeOut_8);
  ...
  anon17_Else:
    call {:si_unique_call 784} sdv_334 := ExAllocatePoolWithTag(512, 80, -800959659);
    urb_14 := sdv_334;
    goto anon20_Then, anon20_Else;
  ...
  anon20_Else:
    ...
    assume {:nonnull} urb_14 != 0;
    assume urb_14 > 0;
    call {:si_unique_call 785} ntStatus_34 := USBPRINT_CallUSBD#0(DeviceObject_48, urb_14, timeOut_8);
    goto anon21_Then, anon21_Else;
...
implementation {:origName "USBPRINT_CallUSBD"} USBPRINT_CallUSBD#0(actual_DeviceObject_36: int, actual_Urb: int, actual_pTimeout: int) returns (Tmp_299: int)
{
  ...
  anon0:
    call {:si_unique_call 787} event_2 := __HAVOC_malloc(156);
    ...
    call {:si_unique_call 788} KeInitializeEvent(event_2, 0, 0);
    ...
    call {:si_unique_call 789} irp_3 := IoAllocateIrp(vslice_dummy_var_416, 0);
    goto anon9_Then, anon9_Else;

  anon9_Else:
    assume {:partition} irp_3 != 0;
    call {:si_unique_call 790} nextStack_4 := sdv_IoGetNextIrpStackLocation(irp_3);
    ...
    assume {:nonnull} nextStack_4 != 0;
    assume nextStack_4 > 0;
    call {:si_unique_call 791} sdv_IoSetCompletionRoutine(irp_3, li2bplFunctionConstant390, event_2, 1, 1, 1);
    assume {:nonnull} deviceExtension_21 != 0;
    assume deviceExtension_21 > 0;
    havoc vslice_dummy_var_417;
    call {:si_unique_call 792} ntStatus_23 := sdv_IoCallDriver#0(vslice_dummy_var_417, irp_3);
    goto anon12_Then, anon12_Else;
  ...
  anon10_Else:
    ...
    call {:si_unique_call 793} status_12 := KeWaitForSingleObject(0, 5, 0, 0, pTimeout);
    goto anon11_Then, anon11_Else;

  anon11_Else:
    assume {:partition} status_12 == 258;
    call {:si_unique_call 794} vslice_dummy_var_140 := IoCancelIrp(0);
    call {:si_unique_call 795} vslice_dummy_var_141 := KeWaitForSingleObject(0, 5, 0, 0, 0);
    goto L43;
  ...
  L35:
    call {:si_unique_call 796} IoFreeIrp(0);
    Tmp_299 := ntStatus_23;
    goto L1;
...
implementation {:origName "USBPRINT_CallUSBD"} USBPRINT_CallUSBD#1(actual_DeviceObject_36: int, actual_Urb: int, actual_pTimeout: int) returns (Tmp_299: int)
{
  ...
  anon0:
    call {:si_unique_call 797} event_2 := __HAVOC_malloc(156);
    DeviceObject_36 := actual_DeviceObject_36;
    Urb := actual_Urb;
    pTimeout := actual_pTimeout;
    status_12 := 0;
    ...
    assume DeviceObject_36 > 0;
    havoc deviceExtension_21;
    call {:si_unique_call 798} KeInitializeEvent(event_2, 0, 0);
    assume {:nonnull} deviceExtension_21 != 0;
    assume deviceExtension_21 > 0;
    havoc Tmp_300;
    assume {:nonnull} Tmp_300 != 0;
    ...
    call {:si_unique_call 799} irp_3 := IoAllocateIrp(vslice_dummy_var_418, 0);
    goto anon9_Then, anon9_Else;

  anon9_Else:
    assume {:partition} irp_3 != 0;
    call {:si_unique_call 800} nextStack_4 := sdv_IoGetNextIrpStackLocation(irp_3);
    assume {:nonnull} nextStack_4 != 0;
    assume nextStack_4 > 0;
    assume {:nonnull} nextStack_4 != 0;
    assume nextStack_4 > 0;
    assume {:nonnull} nextStack_4 != 0;
    assume nextStack_4 > 0;
    call {:si_unique_call 801} sdv_IoSetCompletionRoutine(irp_3, li2bplFunctionConstant390, event_2, 1, 1, 1);
    assume {:nonnull} deviceExtension_21 != 0;
    assume deviceExtension_21 > 0;
    havoc vslice_dummy_var_419;
    call {:si_unique_call 802} ntStatus_23 := sdv_IoCallDriver#1(vslice_dummy_var_419, irp_3);
    goto anon12_Then, anon12_Else;
  ...
  anon10_Else:
    assume {:partition} ntStatus_23 == 259;
    call {:si_unique_call 803} status_12 := KeWaitForSingleObject(0, 5, 0, 0, pTimeout);
    goto anon11_Then, anon11_Else;

  anon11_Else:
    assume {:partition} status_12 == 258;
    call {:si_unique_call 804} vslice_dummy_var_142 := IoCancelIrp(0);
    call {:si_unique_call 805} vslice_dummy_var_143 := KeWaitForSingleObject(0, 5, 0, 0, 0);
    goto L43;
  ...
  L35:
    call {:si_unique_call 806} IoFreeIrp(0);
    Tmp_299 := ntStatus_23;
    goto L1;
...
implementation {:origName "sdv_IoCallDriver"} {:osmodel} sdv_IoCallDriver#0(actual_DeviceObject_24: int, actual_Irp_15: int) returns (Tmp_168: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 807} Tmp_168 := IofCallDriver#0(0, Irp_15);
    goto anon3_Then, anon3_Else;
...
implementation {:origName "sdv_IoCallDriver"} {:osmodel} sdv_IoCallDriver#1(actual_DeviceObject_24: int, actual_Irp_15: int) returns (Tmp_168: int)
{
  ...
  anon0:
    Irp_15 := actual_Irp_15;
    call {:si_unique_call 808} Tmp_168 := IofCallDriver#1(0, Irp_15);
    goto anon3_Then, anon3_Else;
...
implementation {:origName "IofCallDriver"} {:osmodel} IofCallDriver#0(actual_DeviceObject_22: int, actual_Irp_13: int) returns (Tmp_160: int)
{
  ...
  anon0:
    call {:si_unique_call 809} completion_1 := __HAVOC_malloc(4);
  ...
  anon63_Then:
    ...
    call {:si_unique_call 810} sdv_143 := sdv_RunIoCompletionRoutines#0(sdv_p_devobj_fdo, Irp_13, vslice_dummy_var_420, completion_1);
    goto anon88_Then, anon88_Else;
  ...
  anon80_Else:
    ...
    assume SLAM_guard_S_0 != SLAM_guard_S_0_init;
    call {:si_unique_call 811} SLIC_sdv_RunIoCompletionRoutines_exit(0, completion_1, sdv_143);
    goto L29;
  ...
  anon75_Else:
    ...
    call {:si_unique_call 812} sdv_145 := sdv_RunIoCompletionRoutines#0(sdv_p_devobj_fdo, Irp_13, vslice_dummy_var_421, completion_1);
    goto anon90_Then, anon90_Else;
  ...
  anon81_Else:
    assume Irp_13 == SLAM_guard_S_0;
    assume SLAM_guard_S_0 != SLAM_guard_S_0_init;
    call {:si_unique_call 813} SLIC_sdv_RunIoCompletionRoutines_exit(0, completion_1, sdv_145);
    goto L29;
  ...
  anon67_Else:
    ...
    call {:si_unique_call 814} sdv_144 := sdv_RunIoCompletionRoutines#0(sdv_p_devobj_fdo, Irp_13, vslice_dummy_var_422, completion_1);
    goto anon86_Then, anon86_Else;
  ...
  anon79_Else:
    assume Irp_13 == SLAM_guard_S_0;
    assume SLAM_guard_S_0 != SLAM_guard_S_0_init;
    call {:si_unique_call 815} SLIC_sdv_RunIoCompletionRoutines_exit(0, completion_1, sdv_144);
    goto L29;
  ...
  anon71_Else:
    ...
    call {:si_unique_call 816} sdv_146 := sdv_RunIoCompletionRoutines#0(sdv_p_devobj_fdo, Irp_13, vslice_dummy_var_423, completion_1);
    goto anon84_Then, anon84_Else;
  ...
  anon78_Else:
    assume Irp_13 == SLAM_guard_S_0;
    assume SLAM_guard_S_0 != SLAM_guard_S_0_init;
    call {:si_unique_call 817} SLIC_sdv_RunIoCompletionRoutines_exit(0, completion_1, sdv_146);
    goto L29;
...
implementation {:origName "IofCallDriver"} {:osmodel} IofCallDriver#1(actual_DeviceObject_22: int, actual_Irp_13: int) returns (Tmp_160: int)
{
  ...
  anon0:
    call {:si_unique_call 818} completion_1 := __HAVOC_malloc(4);
    Irp_13 := actual_Irp_13;
    assume {:nonnull} completion_1 != 0;
    assume completion_1 > 0;
    status_6 := 259;
  ...
  anon63_Then:
    ...
    call {:si_unique_call 819} sdv_143 := sdv_RunIoCompletionRoutines#1(sdv_p_devobj_fdo, Irp_13, vslice_dummy_var_424, completion_1);
    goto anon88_Then, anon88_Else;
  ...
  anon80_Else:
    assume Irp_13 == SLAM_guard_S_0;
    assume SLAM_guard_S_0 != SLAM_guard_S_0_init;
    call {:si_unique_call 820} SLIC_sdv_RunIoCompletionRoutines_exit(0, completion_1, sdv_143);
    goto L29;
  ...
  anon75_Else:
    ...
    call {:si_unique_call 821} sdv_145 := sdv_RunIoCompletionRoutines#1(sdv_p_devobj_fdo, Irp_13, vslice_dummy_var_425, completion_1);
    goto anon90_Then, anon90_Else;
  ...
  anon81_Else:
    assume Irp_13 == SLAM_guard_S_0;
    assume SLAM_guard_S_0 != SLAM_guard_S_0_init;
    call {:si_unique_call 822} SLIC_sdv_RunIoCompletionRoutines_exit(0, completion_1, sdv_145);
    goto L29;
  ...
  anon67_Else:
    ...
    call {:si_unique_call 823} sdv_144 := sdv_RunIoCompletionRoutines#1(sdv_p_devobj_fdo, Irp_13, vslice_dummy_var_426, completion_1);
    goto anon86_Then, anon86_Else;
  ...
  anon79_Else:
    assume Irp_13 == SLAM_guard_S_0;
    assume SLAM_guard_S_0 != SLAM_guard_S_0_init;
    call {:si_unique_call 824} SLIC_sdv_RunIoCompletionRoutines_exit(0, completion_1, sdv_144);
    goto L29;
  ...
  anon71_Else:
    ...
    call {:si_unique_call 825} sdv_146 := sdv_RunIoCompletionRoutines#1(sdv_p_devobj_fdo, Irp_13, vslice_dummy_var_427, completion_1);
    goto anon84_Then, anon84_Else;
  ...
  anon78_Else:
    assume Irp_13 == SLAM_guard_S_0;
    assume SLAM_guard_S_0 != SLAM_guard_S_0_init;
    call {:si_unique_call 826} SLIC_sdv_RunIoCompletionRoutines_exit(0, completion_1, sdv_146);
    goto L29;
...
implementation {:origName "sdv_RunIoCompletionRoutines"} {:osmodel} sdv_RunIoCompletionRoutines#0(actual_DeviceObject_23: int, actual_Irp_14: int, actual_Context_7: int, actual_Completion: int) returns (Tmp_164: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 827} irpsp := sdv_IoGetNextIrpStackLocation(Irp_14);
    Status := 0;
    assume {:nonnull} irpsp != 0;
    assume irpsp > 0;
    goto anon11_Then, anon11_Else;
  ...
  anon11_Else:
    assume {:partition} Mem_T.CompletionRoutine__IO_STACK_LOCATION[CompletionRoutine__IO_STACK_LOCATION(irpsp)] == li2bplFunctionConstant623;
    call {:si_unique_call 828} Status := USBPRINT_AsyncReadWrite_Complete#0(DeviceObject_23, Irp_14, Context_7);
    goto anon12_Then, anon12_Else;
  ...
  anon9_Else:
    assume {:partition} Mem_T.CompletionRoutine__IO_STACK_LOCATION[CompletionRoutine__IO_STACK_LOCATION(irpsp)] == li2bplFunctionConstant390;
    call {:si_unique_call 829} Status := USBPRINT_DeferIrpCompletion(DeviceObject_23, Irp_14, Context_7);
    assume {:nonnull} Completion != 0;
    assume Completion > 0;
    goto L28;
  ...
  anon10_Else:
    assume {:partition} Mem_T.CompletionRoutine__IO_STACK_LOCATION[CompletionRoutine__IO_STACK_LOCATION(irpsp)] == li2bplFunctionConstant388;
    call {:si_unique_call 830} Status := USBPRINT_PowerIrp_Complete(DeviceObject_23, Irp_14, Context_7);
    assume {:nonnull} Completion != 0;
    assume Completion > 0;
    goto L45;
...
implementation {:origName "sdv_RunIoCompletionRoutines"} {:osmodel} sdv_RunIoCompletionRoutines#1(actual_DeviceObject_23: int, actual_Irp_14: int, actual_Context_7: int, actual_Completion: int) returns (Tmp_164: int)
{
  ...
  anon0:
    ...
    Context_7 := actual_Context_7;
    Completion := actual_Completion;
    call {:si_unique_call 831} irpsp := sdv_IoGetNextIrpStackLocation(Irp_14);
    Status := 0;
    assume {:nonnull} irpsp != 0;
    assume irpsp > 0;
    goto anon11_Then, anon11_Else;
  ...
  anon11_Else:
    assume {:partition} Mem_T.CompletionRoutine__IO_STACK_LOCATION[CompletionRoutine__IO_STACK_LOCATION(irpsp)] == li2bplFunctionConstant623;
    call {:si_unique_call 832} Status := USBPRINT_AsyncReadWrite_Complete#1(DeviceObject_23, Irp_14, Context_7);
    goto anon12_Then, anon12_Else;
  ...
  anon9_Else:
    assume {:partition} Mem_T.CompletionRoutine__IO_STACK_LOCATION[CompletionRoutine__IO_STACK_LOCATION(irpsp)] == li2bplFunctionConstant390;
    call {:si_unique_call 833} Status := USBPRINT_DeferIrpCompletion(DeviceObject_23, Irp_14, Context_7);
    assume {:nonnull} Completion != 0;
    assume Completion > 0;
    goto L28;
  ...
  anon10_Else:
    assume {:partition} Mem_T.CompletionRoutine__IO_STACK_LOCATION[CompletionRoutine__IO_STACK_LOCATION(irpsp)] == li2bplFunctionConstant388;
    call {:si_unique_call 834} Status := USBPRINT_PowerIrp_Complete(DeviceObject_23, Irp_14, Context_7);
    assume {:nonnull} Completion != 0;
    assume Completion > 0;
    goto L45;
...
implementation {:origName "USBPRINT_AsyncReadWrite_Complete"} USBPRINT_AsyncReadWrite_Complete#0(actual_DeviceObject_16: int, actual_Irp_8: int, actual_Context_1: int) returns (Tmp_60: int)
{
  ...
  L19:
    call {:si_unique_call 835} vslice_dummy_var_144 := USBPRINT_DecrementIoCount(deviceObject_1);
  ...
  anon27_Else:
    ...
    call {:si_unique_call 838} sdv_99 := ExAllocatePoolWithTag(512, 16, -800959659);
  ...
  anon28_Else:
    ...
    call {:si_unique_call 839} boogieTmp := IoAllocateWorkItem(0);
    assume {:nonnull} pResetWorkItemObj_1 != 0;
    assume pResetWorkItemObj_1 > 0;
    goto anon25_Then, anon25_Else;
  ...
  L56:
    call {:si_unique_call 841} USBPRINT_IncrementIoCount(deviceObject_1);
    assume {:nonnull} pResetWorkItemObj_1 != 0;
    assume pResetWorkItemObj_1 > 0;
    havoc vslice_dummy_var_428;
    call {:si_unique_call 842} IoQueueWorkItem#0(vslice_dummy_var_428, li2bplFunctionConstant624, 1, pResetWorkItemObj_1);
    goto anon30_Then, anon30_Else;
...
implementation {:origName "USBPRINT_AsyncReadWrite_Complete"} USBPRINT_AsyncReadWrite_Complete#1(actual_DeviceObject_16: int, actual_Irp_8: int, actual_Context_1: int) returns (Tmp_60: int)
{
  ...
  L19:
    call {:si_unique_call 843} vslice_dummy_var_145 := USBPRINT_DecrementIoCount(deviceObject_1);
  ...
  anon27_Else:
    assume {:partition} ResetPending == 0;
    call {:si_unique_call 846} sdv_99 := ExAllocatePoolWithTag(512, 16, -800959659);
    pResetWorkItemObj_1 := sdv_99;
    goto anon28_Then, anon28_Else;
  ...
  anon28_Else:
    ...
    assume {:nonnull} pResetWorkItemObj_1 != 0;
    assume pResetWorkItemObj_1 > 0;
    call {:si_unique_call 847} boogieTmp := IoAllocateWorkItem(0);
    assume {:nonnull} pResetWorkItemObj_1 != 0;
    assume pResetWorkItemObj_1 > 0;
    goto anon25_Then, anon25_Else;
  ...
  L56:
    call {:si_unique_call 849} USBPRINT_IncrementIoCount(deviceObject_1);
    assume {:nonnull} pResetWorkItemObj_1 != 0;
    assume pResetWorkItemObj_1 > 0;
    havoc vslice_dummy_var_429;
    call {:si_unique_call 850} IoQueueWorkItem#1(vslice_dummy_var_429, li2bplFunctionConstant624, 1, pResetWorkItemObj_1);
    goto anon30_Then, anon30_Else;
...
implementation {:origName "IoQueueWorkItem"} {:osmodel} IoQueueWorkItem#0(actual_IoWorkItem_1: int, actual_WorkerRoutine: int, actual_QueueType: int, actual_Context_2: int)
{
  ...
  anon0:
    call {:si_unique_call 851} vslice_dummy_var_146 := __HAVOC_malloc(4);
    WorkerRoutine := actual_WorkerRoutine;
    QueueType := actual_QueueType;
    Context_2 := actual_Context_2;
    call {:si_unique_call 852} sdv_RunIoQueueWorkItems#0(0, WorkerRoutine, QueueType, Context_2);
    goto anon3_Then, anon3_Else;
...
implementation {:origName "IoQueueWorkItem"} {:osmodel} IoQueueWorkItem#1(actual_IoWorkItem_1: int, actual_WorkerRoutine: int, actual_QueueType: int, actual_Context_2: int)
{
  ...
  anon0:
    call {:si_unique_call 853} vslice_dummy_var_147 := __HAVOC_malloc(4);
    WorkerRoutine := actual_WorkerRoutine;
    QueueType := actual_QueueType;
    Context_2 := actual_Context_2;
    call {:si_unique_call 854} sdv_RunIoQueueWorkItems#1(0, WorkerRoutine, QueueType, Context_2);
    goto anon3_Then, anon3_Else;
...
implementation {:origName "sdv_RunIoQueueWorkItems"} {:osmodel} sdv_RunIoQueueWorkItems#0(actual_IoWorkItem_2: int, actual_WorkerRoutine_1: int, actual_QueueType_1: int, actual_Context_3: int)
{
  ...
  anon0:
    call {:si_unique_call 855} vslice_dummy_var_148 := __HAVOC_malloc(4);
  ...
  anon5_Else:
    ...
    call {:si_unique_call 856} USBPRINT_ResetWorkItem#0(sdv_p_devobj_fdo, Context_3);
    goto anon6_Then, anon6_Else;
...
implementation {:origName "sdv_RunIoQueueWorkItems"} {:osmodel} sdv_RunIoQueueWorkItems#1(actual_IoWorkItem_2: int, actual_WorkerRoutine_1: int, actual_QueueType_1: int, actual_Context_3: int)
{
  ...
  anon0:
    call {:si_unique_call 857} vslice_dummy_var_149 := __HAVOC_malloc(4);
    WorkerRoutine_1 := actual_WorkerRoutine_1;
    Context_3 := actual_Context_3;
    goto anon5_Then, anon5_Else;
  ...
  anon5_Else:
    assume {:partition} WorkerRoutine_1 == li2bplFunctionConstant624;
    call {:si_unique_call 858} USBPRINT_ResetWorkItem#1(sdv_p_devobj_fdo, Context_3);
    goto anon6_Then, anon6_Else;
...
implementation GetDelimitedString_loop_L11(in_Tmp_198: int, in_Tmp_199: int, in_input: int, in_c: int) returns (out_Tmp_198: int, out_Tmp_199: int)
{
  ...
  anon15_Then_dummy:
    call {:si_unique_call 859} {:si_old_unique_call 1} out_Tmp_198, out_Tmp_199 := GetDelimitedString_loop_L11(out_Tmp_198, out_Tmp_199, in_input, in_c);
    return;
}
...
implementation GetDelimitedString_loop_L8(in_Tmp_200: int, in_input: int) returns (out_Tmp_200: int)
{
  ...
  anon13_Else_dummy:
    call {:si_unique_call 860} {:si_old_unique_call 1} out_Tmp_200 := GetDelimitedString_loop_L8(out_Tmp_200, in_input);
    return;
}
...
implementation GetCheckSum_loop_L12(in_i: int, in_crc: int, in_Tmp_206: int, in_tmp: int, in_Len: int, in_vslice_dummy_var_57: int) returns (out_i: int, out_crc: int, out_Tmp_206: int, out_tmp: int, out_vslice_dummy_var_57: int)
{

  entry:
    out_i, out_crc, out_Tmp_206, out_tmp, out_vslice_dummy_var_57 := in_i, in_crc, in_Tmp_206, in_tmp, in_vslice_dummy_var_57;
    goto L12, exit;
  ...
  anon3_Else:
    ...
    call {:si_unique_call 861} out_tmp := corral_nondet();
    out_Tmp_206 := BAND(out_tmp, BOR(BOR(BOR(1, 2), 4), 8));
    call {:si_unique_call 862} out_vslice_dummy_var_57 := corral_nondet();
    call {:si_unique_call 863} out_crc := corral_nondet();
    out_i := out_i + 1;
    goto anon3_Else_dummy;
...
procedure {:LoopProcedure} GetCheckSum_loop_L12(in_i: int, in_crc: int, in_Tmp_206: int, in_tmp: int, in_Len: int, in_vslice_dummy_var_57: int) returns (out_i: int, out_crc: int, out_Tmp_206: int, out_tmp: int, out_vslice_dummy_var_57: int);
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} false || old(forward_state) == 1 || old(forward_state) == 0;
  free ensures {:va_keep} false || old(s) == 0 || old(s) == 2 || old(s) == 1;
  free ensures {:va_keep} alloc >= old(alloc);
...
implementation ParPnpFindDeviceIdKeys_loop_L8(in_lpKey: int)
{
  ...
  anon62_Else_dummy:
    call {:si_unique_call 864} {:si_old_unique_call 1} ParPnpFindDeviceIdKeys_loop_L8(in_lpKey);
    return;
}
...
implementation ParPnpFindDeviceIdKeys_loop_L7(in_Tmp_214: int, in_sdv_160: int, in_sdv_161: int, in_sdv_163: int, in_Tmp_217: int, in_sdv_164: int, in_Tmp_218: int, in_Tmp_219: int, in_Tmp_220: int, in_lpKey: int, in_sdv_167: int, in_Tmp_223: int, in_Tmp_225: int, in_sdv_170: int, in_sdv_173: int, in_sdv_174: int, in_Tmp_226: int, in_Tmp_227: int, in_Tmp_228: int, in_sdv_176: int, in_sdv_177: int, in_Tmp_232: int, in_lpValue: int, in_sdv_180: int, in_Tmp_236: int, in_sdv_182: int, in_wKeyLength: int, in_lppMFG: int, in_lppMDL: int, in_lppCLS: int, in_lppDES: int, in_lppAID: int, in_lppCID: int) returns (out_Tmp_214: int, out_sdv_160: int, out_sdv_161: int, out_sdv_163: int, out_Tmp_217: int, out_sdv_164: int, out_Tmp_218: int, out_Tmp_219: int, out_Tmp_220: int, out_lpKey: int, out_sdv_167: int, out_Tmp_223: int, out_Tmp_225: int, out_sdv_170: int, out_sdv_173: int, out_sdv_174: int, out_Tmp_226: int, out_Tmp_227: int, out_Tmp_228: int, out_sdv_176: int, out_sdv_177: int, out_Tmp_232: int, out_lpValue: int, out_sdv_180: int, out_Tmp_236: int, out_sdv_182: int, out_wKeyLength: int)
{
  ...
  L8:
    call {:si_unique_call 869} ParPnpFindDeviceIdKeys_loop_L8(out_lpKey);
    goto L8_last;
  ...
  anon62_Then:
    call {:si_unique_call 868} out_lpValue := StringChr(out_lpKey, 58);
    goto anon63_Else;
  ...
  anon87_Else:
    ...
    call {:si_unique_call 867} out_sdv_174 := RtlCompareMemory(0, 0, out_Tmp_226);
    goto anon64_Then, anon64_Else;
  ...
  L31:
    ...
    assume in_lppMFG > 0;
    call {:si_unique_call 865} out_lpKey := StringChr(out_lpValue, 59);
    goto anon65_Then, anon65_Else;
  ...
  anon64_Then:
    ...
    call {:si_unique_call 866} out_sdv_176 := RtlCompareMemory(0, 0, out_Tmp_214);
    goto anon66_Then, anon66_Else;

  anon66_Else:
    assume {:partition} out_sdv_176 != 3;
    out_Tmp_236 := out_wKeyLength;
    call {:si_unique_call 872} out_sdv_167 := RtlCompareMemory(0, 0, out_Tmp_236);
    goto anon67_Then, anon67_Else;
  ...
  L50:
    ...
    assume in_lppMDL > 0;
    call {:si_unique_call 870} out_lpKey := StringChr(out_lpValue, 59);
    goto anon68_Then, anon68_Else;
  ...
  anon67_Then:
    ...
    call {:si_unique_call 871} out_sdv_170 := RtlCompareMemory(0, 0, out_Tmp_225);
    goto anon69_Then, anon69_Else;

  anon69_Else:
    assume {:partition} out_sdv_170 != 3;
    call {:si_unique_call 873} out_lpKey := StringChr(out_lpValue, 59);
    goto anon70_Then, anon70_Else;
  ...
  anon87_Then:
    call {:si_unique_call 874} out_lpKey := StringChr(out_lpValue, 59);
    goto anon86_Then, anon86_Else;
  ...
  anon88_Then:
    ...
    call {:si_unique_call 877} out_sdv_182 := RtlCompareMemory(0, 0, out_Tmp_223);
    goto anon71_Then, anon71_Else;
  ...
  L74:
    ...
    assume in_lppDES > 0;
    call {:si_unique_call 875} out_lpKey := StringChr(out_lpValue, 59);
    goto anon72_Then, anon72_Else;
  ...
  anon71_Then:
    ...
    call {:si_unique_call 876} out_sdv_161 := RtlCompareMemory(0, 0, out_Tmp_219);
    goto anon73_Then, anon73_Else;

  anon73_Else:
    assume {:partition} out_sdv_161 == 0;
    call {:si_unique_call 878} out_lpKey := StringChr(out_lpValue, 59);
    goto anon74_Then, anon74_Else;
  ...
  anon89_Then:
    ...
    call {:si_unique_call 881} out_sdv_177 := RtlCompareMemory(0, 0, out_Tmp_228);
    goto anon75_Then, anon75_Else;
  ...
  L99:
    ...
    assume in_lppCLS > 0;
    call {:si_unique_call 879} out_lpKey := StringChr(out_lpValue, 59);
    goto anon76_Then, anon76_Else;
  ...
  anon75_Then:
    ...
    call {:si_unique_call 880} out_sdv_180 := RtlCompareMemory(0, 0, out_Tmp_218);
    goto anon77_Then, anon77_Else;

  anon77_Else:
    assume {:partition} out_sdv_180 != 3;
    out_Tmp_227 := out_wKeyLength;
    call {:si_unique_call 884} out_sdv_160 := RtlCompareMemory(0, 0, out_Tmp_227);
    goto anon78_Then, anon78_Else;
  ...
  L118:
    ...
    assume in_lppCID > 0;
    call {:si_unique_call 882} out_lpKey := StringChr(out_lpValue, 59);
    goto anon79_Then, anon79_Else;
  ...
  anon78_Then:
    ...
    call {:si_unique_call 883} out_sdv_173 := RtlCompareMemory(0, 0, out_Tmp_220);
    goto anon80_Then, anon80_Else;

  anon80_Else:
    assume {:partition} out_sdv_173 != 3;
    call {:si_unique_call 885} out_lpKey := StringChr(out_lpValue, 59);
    goto anon81_Then, anon81_Else;
  ...
  anon90_Then:
    ...
    call {:si_unique_call 888} out_sdv_163 := RtlCompareMemory(0, 0, out_Tmp_232);
    goto anon82_Then, anon82_Else;
  ...
  L142:
    ...
    assume in_lppAID > 0;
    call {:si_unique_call 886} out_lpKey := StringChr(out_lpValue, 59);
    goto anon83_Then, anon83_Else;
  ...
  anon82_Then:
    ...
    call {:si_unique_call 887} out_sdv_164 := RtlCompareMemory(0, 0, out_Tmp_217);
    goto anon84_Then, anon84_Else;

  anon84_Else:
    assume {:partition} out_sdv_164 == 0;
    call {:si_unique_call 889} out_lpKey := StringChr(out_lpValue, 59);
    goto anon85_Then, anon85_Else;
...
implementation FixupDeviceId_loop_L5(in_p_3: int)
{
  ...
  L9_dummy:
    call {:si_unique_call 891} {:si_old_unique_call 1} FixupDeviceId_loop_L5(in_p_3);
    return;
...
implementation RtlStringCopyWorkerA_sdv_static_function_1_loop_L7(in_cchNewDestLength_1: int, in_pszDest_3: int, in_cchDest_3: int, in_pszSrc: int, in_cchToCopy: int) returns (out_cchNewDestLength_1: int, out_cchDest_3: int, out_cchToCopy: int)
{
  ...
  anon14_Else_dummy:
    call {:si_unique_call 892} {:si_old_unique_call 1} out_cchNewDestLength_1, out_cchDest_3, out_cchToCopy := RtlStringCopyWorkerA_sdv_static_function_1_loop_L7(out_cchNewDestLength_1, in_pszDest_3, out_cchDest_3, in_pszSrc, out_cchToCopy);
    return;
}
...
implementation USBPRINT_ConfigureDevice_loop_L19(in_timeOut_6: int, in_siz_3: int, in_tries: int, in_sdv_253: int, in_ntStatus_29: int, in_urb_12: int, in_Tmp_324: int, in_configurationDescriptor_3: int, in_DeviceObject_41: int) returns (out_siz_3: int, out_tries: int, out_sdv_253: int, out_ntStatus_29: int, out_Tmp_324: int, out_configurationDescriptor_3: int)
{
  ...
  L19:
    call {:si_unique_call 893} out_sdv_253 := ExAllocatePoolWithTag(512, out_siz_3, -800959659);
  ...
  anon30_Else:
    ...
    assume {:nonnull} in_urb_12 != 0;
    assume in_urb_12 > 0;
    call {:si_unique_call 895} out_ntStatus_29 := USBPRINT_CallUSBD#1(in_DeviceObject_41, in_urb_12, in_timeOut_6);
    goto anon31_Else;
  ...
  anon33_Else_dummy:
    call {:si_unique_call 896} {:si_old_unique_call 1} out_siz_3, out_tries, out_sdv_253, out_ntStatus_29, out_Tmp_324, out_configurationDescriptor_3 := USBPRINT_ConfigureDevice_loop_L19(in_timeOut_6, out_siz_3, out_tries, out_sdv_253, out_ntStatus_29, in_urb_12, out_Tmp_324, out_configurationDescriptor_3, in_DeviceObject_41);
    return;
}
...
implementation ProduceQueriedID_loop_L138(in_pWString: int)
{
  ...
  L141_dummy:
    call {:si_unique_call 897} {:si_old_unique_call 1} ProduceQueriedID_loop_L138(in_pWString);
    return;
...
implementation ProduceQueriedID_loop_L86(in_Tmp_348: int, in_Tmp_349: int, in_sdv_304: int, in_pTempString: int, in_iTotalLen: int, in_Tmp_354: int, in_Tmp_355: int, in_sdv_312: int, in_pDelimitedString: int, in_sdv_320: int, in_Tmp_358: int, in_pString_1: int, in_sdv_325: int, in_Tmp_360: int, in_vslice_dummy_var_127: int, in_vslice_dummy_var_128: int) returns (out_Tmp_348: int, out_Tmp_349: int, out_iTotalLen: int, out_Tmp_354: int, out_Tmp_355: int, out_pDelimitedString: int, out_Tmp_358: int, out_Tmp_360: int, out_vslice_dummy_var_127: int, out_vslice_dummy_var_128: int)
{

  entry:
    out_Tmp_348, out_Tmp_349, out_iTotalLen, out_Tmp_354, out_Tmp_355, out_pDelimitedString, out_Tmp_358, out_Tmp_360, out_vslice_dummy_var_127, out_vslice_dummy_var_128 := in_Tmp_348, in_Tmp_349, in_iTotalLen, in_Tmp_354, in_Tmp_355, in_pDelimitedString, in_Tmp_358, in_Tmp_360, in_vslice_dummy_var_127, in_vslice_dummy_var_128;
    goto L86, exit;
  ...
  anon56_Then:
    ...
    call {:si_unique_call 901} out_pDelimitedString := GetDelimitedString(in_pString_1, 44);
    goto anon57_Then;
  ...
  anon59_Then:
    ...
    call {:si_unique_call 898} FixupDeviceId(out_pDelimitedString);
    out_Tmp_354 := 1024 - out_iTotalLen;
    out_Tmp_348 := in_pTempString;
    out_Tmp_360 := strConst__li2bpl30;
    call {:si_unique_call 899} out_vslice_dummy_var_127 := RtlStringCbPrintfA(out_Tmp_348, out_Tmp_354, out_Tmp_360);
    out_iTotalLen := in_sdv_304;
    out_Tmp_349 := 1024 - out_iTotalLen;
    out_Tmp_358 := in_pTempString;
    out_Tmp_355 := strConst__li2bpl31;
    call {:si_unique_call 900} out_vslice_dummy_var_128 := RtlStringCbPrintfA(out_Tmp_358, out_Tmp_349, out_Tmp_355);
    out_iTotalLen := in_sdv_320;
    goto anon59_Then_dummy;

  anon59_Then_dummy:
    call {:si_unique_call 902} {:si_old_unique_call 1} out_Tmp_348, out_Tmp_349, out_iTotalLen, out_Tmp_354, out_Tmp_355, out_pDelimitedString, out_Tmp_358, out_Tmp_360, out_vslice_dummy_var_127, out_vslice_dummy_var_128 := ProduceQueriedID_loop_L86(out_Tmp_348, out_Tmp_349, in_sdv_304, in_pTempString, out_iTotalLen, out_Tmp_354, out_Tmp_355, in_sdv_312, out_pDelimitedString, in_sdv_320, out_Tmp_358, in_pString_1, in_sdv_325, out_Tmp_360, out_vslice_dummy_var_127, out_vslice_dummy_var_128);
    return;
}



procedure {:LoopProcedure} ProduceQueriedID_loop_L86(in_Tmp_348: int, in_Tmp_349: int, in_sdv_304: int, in_pTempString: int, in_iTotalLen: int, in_Tmp_354: int, in_Tmp_355: int, in_sdv_312: int, in_pDelimitedString: int, in_sdv_320: int, in_Tmp_358: int, in_pString_1: int, in_sdv_325: int, in_Tmp_360: int, in_vslice_dummy_var_127: int, in_vslice_dummy_var_128: int) returns (out_Tmp_348: int, out_Tmp_349: int, out_iTotalLen: int, out_Tmp_354: int, out_Tmp_355: int, out_pDelimitedString: int, out_Tmp_358: int, out_Tmp_360: int, out_vslice_dummy_var_127: int, out_vslice_dummy_var_128: int);
  modifies alloc;
  ...
  free ensures {:va_keep} out_vslice_dummy_var_127 == 0 || out_vslice_dummy_var_127 == 5 || out_vslice_dummy_var_127 == -1073741811 || out_vslice_dummy_var_127 == in_vslice_dummy_var_127;
  free ensures {:va_keep} out_vslice_dummy_var_128 == 0 || out_vslice_dummy_var_128 == 5 || out_vslice_dummy_var_128 == -1073741811 || out_vslice_dummy_var_128 == in_vslice_dummy_var_128;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} false || old(forward_state) == 1 || old(forward_state) == 0;
  free ensures {:va_keep} false || old(s) == 0 || old(s) == 2 || old(s) == 1;
  free ensures {:va_keep} alloc >= old(alloc);
