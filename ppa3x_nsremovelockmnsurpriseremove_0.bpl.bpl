...
implementation {:origName "VPI0DataIn"} VPI0DataIn(actual_Extension_2: int) returns (Tmp_25: int)
{
  ...
  L27:
    ...
    call {:si_unique_call 55} Status_3 := VPI0ParallelRead(Extension_2, vslice_dummy_var_1002, ChunkSize, BytesRead);
    assume {:nonnull} Extension_2 != 0;
    assume Extension_2 > 0;
    goto anon29_Then, anon29_Else;
...
implementation {:origName "VPI0DataOut"} VPI0DataOut(actual_Extension_6: int) returns (Tmp_49: int)
{
  ...
  L27:
    ...
    call {:si_unique_call 66} Status_4 := VPI0ParallelWrite(Extension_6, vslice_dummy_var_1003, ChunkSize_1, BytesWritten);
    assume {:nonnull} Extension_6 != 0;
    assume Extension_6 > 0;
    goto anon29_Then, anon29_Else;
...
implementation {:origName "VPI0RestoreDrive"} VPI0RestoreDrive(actual_Extension_7: int) returns (Tmp_55: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 68} VPI0Deselect(vslice_dummy_var_1004);
    call {:si_unique_call 69} vslice_dummy_var_11 := VPI0TerminateMode(Extension_7);
    assume {:nonnull} Extension_7 != 0;
    assume Extension_7 > 0;
    havoc vslice_dummy_var_1005;
    call {:si_unique_call 70} VPI0TrySelect(vslice_dummy_var_1005, 143);
    Tmp_55 := 1;
    return;
}
...
implementation {:origName "VPI0NegotiateMode"} VPI0NegotiateMode(actual_Extension_14: int) returns (Tmp_99: int)
{
  ...
  anon13_Else:
    ...
    call {:si_unique_call 99} VPI0Deselect(vslice_dummy_var_1006);
    assume {:nonnull} Extension_14 != 0;
    assume Extension_14 > 0;
    havoc vslice_dummy_var_1007;
    call {:si_unique_call 100} VPI0TrySelect(vslice_dummy_var_1007, 207);
    assume {:nonnull} Extension_14 != 0;
    assume Extension_14 > 0;
    havoc vslice_dummy_var_1008;
    call {:si_unique_call 101} sdv_45 := VPI0CheckDevice(vslice_dummy_var_1008);
    goto anon14_Then, anon14_Else;
...
implementation {:origName "VPI0ParallelWrite"} VPI0ParallelWrite(actual_Extension_15: int, actual_Buffer_2: int, actual_NumBytesToWrite: int, actual_BytesTransfered: int) returns (Tmp_107: int)
{
  ...
  L12:
    ...
    call {:si_unique_call 104} Status_11 := VPI0DataByteWrite(vslice_dummy_var_1009, Buffer_2, NumBytesToWrite, BytesTransfered);
    goto L16;
...
implementation {:origName "VPI0ParallelRead"} VPI0ParallelRead(actual_Extension_16: int, actual_Buffer_4: int, actual_NumBytesToRead: int, actual_BytesTransfered_1: int) returns (Tmp_140: int)
{
  ...
  anon8_Else:
    ...
    call {:si_unique_call 118} Status_12 := VPI0DataNibbleRead(vslice_dummy_var_1010, Buffer_4, NumBytesToRead, BytesTransfered_1);
    goto L16;
  ...
  anon9_Else:
    ...
    call {:si_unique_call 119} Status_12 := VPI0DataByteRead(vslice_dummy_var_1011, Buffer_4, NumBytesToRead, BytesTransfered_1);
    goto L16;
...
implementation {:origName "sdv_RunSurpriseRemoveDevice"} {:osmodel} sdv_RunSurpriseRemoveDevice(actual_po: int, actual_pirp: int) returns (Tmp_143: int)
{
  ...
  anon0:
    ...
    Tmp_143 := status;
    call {:si_unique_call 122} SLIC_sdv_RunSurpriseRemoveDevice_exit(strConst__li2bpl11, pirp, Tmp_143);
    goto anon3_Then, anon3_Else;
...
implementation {:origName "sdv_IoCopyCurrentIrpStackLocationToNext"} {:osmodel} sdv_IoCopyCurrentIrpStackLocationToNext(actual_pirp_1: int)
{
  ...
  anon0:
    call {:si_unique_call 123} vslice_dummy_var_21 := __HAVOC_malloc(4);
...
implementation {:origName "IoStartNextPacket"} {:osmodel} IoStartNextPacket(actual_DeviceObject: int, actual_Cancelable: int)
{
  ...
  anon0:
    call {:si_unique_call 124} vslice_dummy_var_22 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "sdv_IoInitializeRemoveLock"} {:osmodel} sdv_IoInitializeRemoveLock(actual_Lock: int, actual_AllocateTag: int, actual_MaxLockedMinutes: int, actual_HighWatermark: int)
{
  ...
  anon0:
    call {:si_unique_call 125} vslice_dummy_var_23 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "sdv_KeAcquireSpinLock"} {:osmodel} sdv_KeAcquireSpinLock(actual_SpinLock: int, actual_p: int)
{
  ...
  anon0:
    call {:si_unique_call 126} vslice_dummy_var_24 := __HAVOC_malloc(4);
    p := actual_p;
    assume {:nonnull} p != 0;
    assume p > 0;
    return;
...
implementation {:origName "sdv_RunAddDevice"} {:osmodel} sdv_RunAddDevice(actual_p1: int, actual_p2: int) returns (Tmp_155: int)
{
  ...
  anon0:
    ...
    p2 := actual_p2;
    status_1 := 0;
    call {:si_unique_call 127} sdv_stub_add_begin();
    call {:si_unique_call 128} status_1 := PpaAddDevice(p1, p2);
    call {:si_unique_call 129} sdv_stub_add_end();
    Tmp_155 := status_1;
    return;
}
...
implementation {:origName "KeInitializeDpc"} {:osmodel} KeInitializeDpc(actual_Dpc: int, actual_DeferredRoutine: int, actual_DeferredContext: int)
{
  ...
  anon0:
    call {:si_unique_call 130} vslice_dummy_var_25 := __HAVOC_malloc(4);
    Dpc := actual_Dpc;
...
implementation {:origName "sdv_IoReleaseRemoveLockAndWait"} {:osmodel} sdv_IoReleaseRemoveLockAndWait(actual_RemoveLock: int, actual_Tag: int)
{
  ...
  anon0:
    call {:si_unique_call 131} vslice_dummy_var_26 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "IoDetachDevice"} {:osmodel} IoDetachDevice(actual_TargetDevice: int)
{
  ...
  anon0:
    call {:si_unique_call 132} vslice_dummy_var_27 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "sdv_RtlMoveMemory"} {:osmodel} sdv_RtlMoveMemory(actual_Destination: int, actual_Source: int, actual_Length: int)
{
  ...
  anon0:
    call {:si_unique_call 133} vslice_dummy_var_28 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "sdv_stub_dispatch_end"} {:osmodel} sdv_stub_dispatch_end(actual_s: int, actual_pirp_3: int)
{
  ...
  anon0:
    call {:si_unique_call 134} vslice_dummy_var_29 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "sdv_SetStatus"} {:osmodel} sdv_SetStatus(actual_pirp_4: int)
{
  ...
  anon0:
    call {:si_unique_call 135} vslice_dummy_var_30 := __HAVOC_malloc(4);
...
implementation {:origName "sdv_main"} {:osmodel} sdv_main()
{
  ...
  anon0:
    ...
    assume {:nonnull} sdv_p_devobj_child_pdo != 0;
    assume sdv_p_devobj_child_pdo > 0;
    call {:si_unique_call 138} status_2 := DriverEntry(sdv_driver_object, u);
    goto anon8_Then, anon8_Else;
  ...
  L68:
    assume Tmp_177 != 0;
    call {:si_unique_call 139} status_2 := sdv_RunAddDevice(sdv_driver_object, sdv_p_devobj_pdo);
    goto anon7_Then, anon7_Else;
  ...
  L78:
    ...
    call {:si_unique_call 141} status_2 := sdv_RunSurpriseRemoveDevice(sdv_p_devobj_fdo, sdv_irp);
    goto anon9_Then, anon9_Else;

  anon9_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 142} status_2 := sdv_RunRemoveDevice(sdv_p_devobj_fdo, sdv_irp);
    goto LM2;
...
implementation {:origName "sdv_MmGetMdlVirtualAddress"} {:osmodel} sdv_MmGetMdlVirtualAddress(actual_Mdl: int) returns (Tmp_181: int)
{
  ...
  anon0:
    call {:si_unique_call 143} sdv_66 := __HAVOC_malloc(1);
    x_2 := sdv_66;
    Tmp_181 := x_2;
    return;
}
...
implementation {:origName "sdv_IoSetCompletionRoutine"} {:osmodel} sdv_IoSetCompletionRoutine(actual_pirp_5: int, actual_CompletionRoutine: int, actual_Context_1: int, actual_InvokeOnSuccess: int, actual_InvokeOnError: int, actual_InvokeOnCancel: int)
{
  ...
  anon0:
    call {:si_unique_call 144} vslice_dummy_var_32 := __HAVOC_malloc(4);
    ...
    call {:si_unique_call 145} irpSp := sdv_IoGetNextIrpStackLocation(pirp_5);
...
implementation {:origName "_sdv_init9"} {:osmodel} _sdv_init9()
{
  ...
  anon0:
    call {:si_unique_call 146} vslice_dummy_var_33 := __HAVOC_malloc(4);
...
implementation {:origName "main"} {:osmodel} main() returns (Tmp_203: int, dup_assertVar: bool)
{
  ...
  anon0:
    dup_assertVar := true;
    assume alloc > 0;
    call {:si_unique_call 149} WHEA_ERROR_PACKET_SECTION_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume WHEA_ERROR_PACKET_SECTION_GUID__Loc == WHEA_ERROR_PACKET_SECTION_GUID;
    assume WHEA_ERROR_PACKET_SECTION_GUID != 0;
    call {:si_unique_call 150} PpaBreakOn__Loc := __HAVOC_malloc_or_null(4);
    assume PpaBreakOn__Loc == PpaBreakOn;
    assume PpaBreakOn != 0;
    call {:si_unique_call 151} PpaDebugLevel__Loc := __HAVOC_malloc_or_null(4);
    assume PpaDebugLevel__Loc == PpaDebugLevel;
    assume PpaDebugLevel != 0;
    call {:si_unique_call 152} sdv_harnessStackLocation_next__Loc := __HAVOC_malloc_or_null(496);
    ...
    call {:si_unique_call 154} sdv_IoBuildAsynchronousFsdRequest_harnessIrp__Loc := __HAVOC_malloc_or_null(248);
    assume sdv_IoBuildAsynchronousFsdRequest_harnessIrp__Loc == sdv_IoBuildAsynchronousFsdRequest_harnessIrp;
    assume sdv_IoBuildAsynchronousFsdRequest_harnessIrp != 0;
    call {:si_unique_call 155} sdv_IoGetDeviceToVerify_DEVICE_OBJECT__Loc := __HAVOC_malloc_or_null(320);
    assume sdv_IoGetDeviceToVerify_DEVICE_OBJECT__Loc == sdv_IoGetDeviceToVerify_DEVICE_OBJECT;
    assume sdv_IoGetDeviceToVerify_DEVICE_OBJECT != 0;
    call {:si_unique_call 156} sdv_IoBuildDeviceIoControlRequest_harnessStackLocation_next__Loc := __HAVOC_malloc_or_null(496);
    ...
    call {:si_unique_call 158} sdv_ControllerIrp__Loc := __HAVOC_malloc_or_null(248);
    assume sdv_ControllerIrp__Loc == sdv_ControllerIrp;
    assume sdv_ControllerIrp != 0;
    call {:si_unique_call 159} sdv_devobj_pdo__Loc := __HAVOC_malloc_or_null(320);
    ...
    call {:si_unique_call 161} sdv_IoInitializeIrp_harnessIrp__Loc := __HAVOC_malloc_or_null(248);
    assume sdv_IoInitializeIrp_harnessIrp__Loc == sdv_IoInitializeIrp_harnessIrp;
    assume sdv_IoInitializeIrp_harnessIrp != 0;
    call {:si_unique_call 162} sdv_IoGetRelatedDeviceObject_DEVICE_OBJECT__Loc := __HAVOC_malloc_or_null(320);
    assume sdv_IoGetRelatedDeviceObject_DEVICE_OBJECT__Loc == sdv_IoGetRelatedDeviceObject_DEVICE_OBJECT;
    assume sdv_IoGetRelatedDeviceObject_DEVICE_OBJECT != 0;
    call {:si_unique_call 163} sdv_IoBuildSynchronousFsdRequest_harnessStackLocation_next__Loc := __HAVOC_malloc_or_null(496);
    assume sdv_IoBuildSynchronousFsdRequest_harnessStackLocation_next__Loc == sdv_IoBuildSynchronousFsdRequest_harnessStackLocation_next;
    assume sdv_IoBuildSynchronousFsdRequest_harnessStackLocation_next != 0;
    call {:si_unique_call 164} sdv_IoCreateSynchronizationEvent_KEVENT__Loc := __HAVOC_malloc_or_null(124);
    ...
    call {:si_unique_call 166} sdv_other_harnessStackLocation_next__Loc := __HAVOC_malloc_or_null(496);
    ...
    call {:si_unique_call 168} sdv_devobj_top__Loc := __HAVOC_malloc_or_null(320);
    assume sdv_devobj_top__Loc == sdv_devobj_top;
    assume sdv_devobj_top != 0;
    call {:si_unique_call 169} sdv_kdpc_val3__Loc := __HAVOC_malloc_or_null(40);
    assume sdv_kdpc_val3__Loc == sdv_kdpc_val3;
    assume sdv_kdpc_val3 != 0;
    call {:si_unique_call 170} sdv_IoBuildSynchronousFsdRequest_harnessIrp__Loc := __HAVOC_malloc_or_null(248);
    assume sdv_IoBuildSynchronousFsdRequest_harnessIrp__Loc == sdv_IoBuildSynchronousFsdRequest_harnessIrp;
    assume sdv_IoBuildSynchronousFsdRequest_harnessIrp != 0;
    call {:si_unique_call 171} sdv_IoGetDeviceObjectPointer_DEVICE_OBJECT__Loc := __HAVOC_malloc_or_null(320);
    ...
    call {:si_unique_call 175} sdv_IoMakeAssociatedIrp_harnessIrp__Loc := __HAVOC_malloc_or_null(248);
    assume sdv_IoMakeAssociatedIrp_harnessIrp__Loc == sdv_IoMakeAssociatedIrp_harnessIrp;
    assume sdv_IoMakeAssociatedIrp_harnessIrp != 0;
    call {:si_unique_call 176} sdv_devobj_child_pdo__Loc := __HAVOC_malloc_or_null(320);
    assume sdv_devobj_child_pdo__Loc == sdv_devobj_child_pdo;
    assume sdv_devobj_child_pdo != 0;
    call {:si_unique_call 177} sdv_harnessIrp__Loc := __HAVOC_malloc_or_null(248);
    assume sdv_harnessIrp__Loc == sdv_harnessIrp;
    assume sdv_harnessIrp != 0;
    call {:si_unique_call 178} sdv_IoBuildAsynchronousFsdRequest_harnessStackLocation_next__Loc := __HAVOC_malloc_or_null(496);
    ...
    call {:si_unique_call 181} sdv_devobj_fdo__Loc := __HAVOC_malloc_or_null(320);
    assume sdv_devobj_fdo__Loc == sdv_devobj_fdo;
    assume sdv_devobj_fdo != 0;
    call {:si_unique_call 182} sdv_StartIoIrp__Loc := __HAVOC_malloc_or_null(248);
    ...
    call {:si_unique_call 184} sdv_PowerIrp__Loc := __HAVOC_malloc_or_null(248);
    assume sdv_PowerIrp__Loc == sdv_PowerIrp;
    assume sdv_PowerIrp != 0;
    call {:si_unique_call 185} sdv_IoBuildDeviceIoControlRequest_harnessIrp__Loc := __HAVOC_malloc_or_null(248);
    assume sdv_IoBuildDeviceIoControlRequest_harnessIrp__Loc == sdv_IoBuildDeviceIoControlRequest_harnessIrp;
    assume sdv_IoBuildDeviceIoControlRequest_harnessIrp != 0;
    call {:si_unique_call 186} sdv_other_harnessIrp__Loc := __HAVOC_malloc_or_null(248);
    assume sdv_other_harnessIrp__Loc == sdv_other_harnessIrp;
    assume sdv_other_harnessIrp != 0;
    call {:si_unique_call 187} sdv_IoCreateNotificationEvent_KEVENT__Loc := __HAVOC_malloc_or_null(124);
    assume sdv_IoCreateNotificationEvent_KEVENT__Loc == sdv_IoCreateNotificationEvent_KEVENT;
    assume sdv_IoCreateNotificationEvent_KEVENT != 0;
    call {:si_unique_call 188} sdv_other_harnessStackLocation__Loc := __HAVOC_malloc_or_null(496);
    assume sdv_other_harnessStackLocation__Loc == sdv_other_harnessStackLocation;
    assume sdv_other_harnessStackLocation != 0;
    call {:si_unique_call 189} KeTickCount__Loc := __HAVOC_malloc_or_null(12);
    ...
    call {:si_unique_call 212} vslice_dummy_var_110 := __HAVOC_malloc(4);
    call {:si_unique_call 213} vslice_dummy_var_1012 := __HAVOC_malloc(28);
    call {:si_unique_call 214} vslice_dummy_var_111 := __HAVOC_malloc(4);
    call {:si_unique_call 215} vslice_dummy_var_112 := __HAVOC_malloc(4);
    call {:si_unique_call 216} vslice_dummy_var_113 := __HAVOC_malloc(4);
    call {:si_unique_call 217} vslice_dummy_var_114 := __HAVOC_malloc(4);
    call {:si_unique_call 218} vslice_dummy_var_1013 := __HAVOC_malloc(12);
    call {:si_unique_call 219} vslice_dummy_var_115 := __HAVOC_malloc(4);
    call {:si_unique_call 220} vslice_dummy_var_1014 := __HAVOC_malloc(28);
    call {:si_unique_call 221} vslice_dummy_var_116 := __HAVOC_malloc(4);
    call {:si_unique_call 222} vslice_dummy_var_117 := __HAVOC_malloc(4);
    call {:si_unique_call 223} vslice_dummy_var_118 := __HAVOC_malloc(4);
    call {:si_unique_call 224} vslice_dummy_var_119 := __HAVOC_malloc(4);
    call {:si_unique_call 225} vslice_dummy_var_1015 := __HAVOC_malloc(12);
    call {:si_unique_call 226} vslice_dummy_var_120 := __HAVOC_malloc(4);
    call {:si_unique_call 227} vslice_dummy_var_1016 := __HAVOC_malloc(28);
    call {:si_unique_call 228} vslice_dummy_var_121 := __HAVOC_malloc(4);
    call {:si_unique_call 229} vslice_dummy_var_122 := __HAVOC_malloc(4);
    call {:si_unique_call 230} vslice_dummy_var_123 := __HAVOC_malloc(4);
    call {:si_unique_call 231} vslice_dummy_var_124 := __HAVOC_malloc(4);
    call {:si_unique_call 232} vslice_dummy_var_1017 := __HAVOC_malloc(12);
    call {:si_unique_call 233} vslice_dummy_var_125 := __HAVOC_malloc(4);
    call {:si_unique_call 234} vslice_dummy_var_126 := __HAVOC_malloc(4);
    call {:si_unique_call 235} vslice_dummy_var_127 := __HAVOC_malloc(4);
    call {:si_unique_call 236} vslice_dummy_var_128 := __HAVOC_malloc(4);
    call {:si_unique_call 237} vslice_dummy_var_129 := __HAVOC_malloc(4);
    call {:si_unique_call 238} vslice_dummy_var_130 := __HAVOC_malloc(4);
    call {:si_unique_call 239} vslice_dummy_var_1018 := __HAVOC_malloc(28);
    call {:si_unique_call 240} vslice_dummy_var_131 := __HAVOC_malloc(4);
    call {:si_unique_call 241} vslice_dummy_var_132 := __HAVOC_malloc(4);
    call {:si_unique_call 242} vslice_dummy_var_133 := __HAVOC_malloc(4);
    call {:si_unique_call 243} vslice_dummy_var_134 := __HAVOC_malloc(4);
    call {:si_unique_call 244} vslice_dummy_var_1019 := __HAVOC_malloc(12);
    call {:si_unique_call 245} vslice_dummy_var_135 := __HAVOC_malloc(4);
    call {:si_unique_call 246} vslice_dummy_var_1020 := __HAVOC_malloc(28);
    call {:si_unique_call 247} vslice_dummy_var_136 := __HAVOC_malloc(4);
    call {:si_unique_call 248} vslice_dummy_var_137 := __HAVOC_malloc(4);
    ...
    call {:si_unique_call 251} vslice_dummy_var_1021 := __HAVOC_malloc(12);
    call {:si_unique_call 252} vslice_dummy_var_140 := __HAVOC_malloc(4);
    call {:si_unique_call 253} vslice_dummy_var_1022 := __HAVOC_malloc(28);
    call {:si_unique_call 254} vslice_dummy_var_141 := __HAVOC_malloc(4);
    call {:si_unique_call 255} vslice_dummy_var_142 := __HAVOC_malloc(4);
    call {:si_unique_call 256} vslice_dummy_var_143 := __HAVOC_malloc(4);
    call {:si_unique_call 257} vslice_dummy_var_144 := __HAVOC_malloc(4);
    call {:si_unique_call 258} vslice_dummy_var_1023 := __HAVOC_malloc(12);
    call {:si_unique_call 259} vslice_dummy_var_145 := __HAVOC_malloc(4);
    call {:si_unique_call 260} vslice_dummy_var_1024 := __HAVOC_malloc(28);
    call {:si_unique_call 261} vslice_dummy_var_146 := __HAVOC_malloc(4);
    call {:si_unique_call 262} vslice_dummy_var_147 := __HAVOC_malloc(4);
    call {:si_unique_call 263} vslice_dummy_var_148 := __HAVOC_malloc(4);
    call {:si_unique_call 264} vslice_dummy_var_149 := __HAVOC_malloc(4);
    call {:si_unique_call 265} vslice_dummy_var_1025 := __HAVOC_malloc(12);
    call {:si_unique_call 266} vslice_dummy_var_150 := __HAVOC_malloc(4);
    call {:si_unique_call 267} vslice_dummy_var_1026 := __HAVOC_malloc(28);
    call {:si_unique_call 268} vslice_dummy_var_151 := __HAVOC_malloc(4);
    call {:si_unique_call 269} vslice_dummy_var_152 := __HAVOC_malloc(4);
    call {:si_unique_call 270} vslice_dummy_var_153 := __HAVOC_malloc(4);
    call {:si_unique_call 271} vslice_dummy_var_154 := __HAVOC_malloc(4);
    call {:si_unique_call 272} vslice_dummy_var_1027 := __HAVOC_malloc(12);
...
implementation {:origName "sdv_IoSkipCurrentIrpStackLocation"} {:osmodel} sdv_IoSkipCurrentIrpStackLocation(actual_pirp_7: int)
{
  ...
  anon0:
    call {:si_unique_call 286} vslice_dummy_var_36 := __HAVOC_malloc(4);
...
implementation {:origName "sdv_RunRemoveDevice"} {:osmodel} sdv_RunRemoveDevice(actual_po_1: int, actual_pirp_8: int) returns (Tmp_213: int)
{
  ...
  anon0:
    ...
    assume {:nonnull} ps_1 != 0;
    assume ps_1 > 0;
    call {:si_unique_call 287} sdv_stub_dispatch_begin();
    call {:si_unique_call 288} sdv_SetStatus(pirp_8);
    call {:si_unique_call 289} status_3 := PpaPnpDeviceControl(po_1, pirp_8);
    call {:si_unique_call 290} sdv_stub_dispatch_end(status_3, 0);
    Tmp_213 := status_3;
    return;
}
...
procedure {:origName "SLIC_sdv_RunSurpriseRemoveDevice_exit"} {:osmodel} SLIC_sdv_RunSurpriseRemoveDevice_exit(actual_caller_1: int, actual_sdv_93: int, actual_sdv_94: int);
  modifies yogi_error;
  free ensures {:va_keep} yogi_error == 1;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);
...
implementation {:origName "SLIC_sdv_RunSurpriseRemoveDevice_exit"} {:osmodel} SLIC_sdv_RunSurpriseRemoveDevice_exit(actual_caller_1: int, actual_sdv_93: int, actual_sdv_94: int)
{
...
implementation {:origName "PpaPortLock"} PpaPortLock(actual_Extension_18: int, actual_Wait_1: int, actual_pDeviceObject: int)
{
  ...
  anon15_Else:
    ...
    call {:si_unique_call 324} sdv_IoSetCompletionRoutine(vslice_dummy_var_1028, li2bplFunctionConstant134, Event_4, 1, 1, 1);
    goto L26;
  ...
  L26:
    ...
    call {:si_unique_call 325} status_5 := sdv_IoCallDriver#1(vslice_dummy_var_1029, vslice_dummy_var_1030);
    goto anon16_Then, anon16_Else;
  ...
  anon15_Then:
    ...
    call {:si_unique_call 328} sdv_IoSetCompletionRoutine(vslice_dummy_var_1031, li2bplFunctionConstant199, pDeviceObject, 1, 1, 1);
    goto L26;
...
implementation {:origName "PpaGetDeviceInfo"} PpaGetDeviceInfo(actual_Extension_27: int) returns (Tmp_337: int)
{
  ...
  anon8_Else:
    ...
    call {:si_unique_call 361} Status_16 := sdv_IoCallDriver#1(vslice_dummy_var_1032, Irp_5);
    goto anon9_Then, anon9_Else;
...
implementation {:origName "PpaCloseToParclass"} PpaCloseToParclass(actual_Extension_28: int) returns (Tmp_339: int)
{
  ...
  anon5_Else:
    ...
    call {:si_unique_call 368} Status_17 := sdv_IoCallDriver#1(vslice_dummy_var_1033, Irp_6);
    goto anon6_Then, anon6_Else;
...
implementation {:origName "PpaCreateToParclass"} PpaCreateToParclass(actual_Extension_30: int) returns (Tmp_345: int)
{
  ...
  anon5_Else:
    ...
    call {:si_unique_call 376} Status_19 := sdv_IoCallDriver#1(vslice_dummy_var_1034, Irp_7);
    goto anon6_Then, anon6_Else;
...
implementation {:origName "PpaPnpDeviceControl"} PpaPnpDeviceControl(actual_pDeviceObject_4: int, actual_pIrp_2: int) returns (Tmp_390: int)
{
  ...
  anon89_Else:
    ...
    call {:si_unique_call 428} Status_23 := sdv_IoCallDriver#1(vslice_dummy_var_1035, pIrp_2);
    goto L66;
  ...
  L21:
    ...
    call {:si_unique_call 430} Status_23 := sdv_IoCallDriver#1(vslice_dummy_var_1036, pIrp_2);
    goto L66;
  ...
  anon93_Then:
    ...
    call {:si_unique_call 432} Status_23 := sdv_IoCallDriver#1(vslice_dummy_var_1037, pIrp_2);
    goto L66;
  ...
  anon95_Then:
    ...
    call {:si_unique_call 435} Status_23 := sdv_IoCallDriver#1(vslice_dummy_var_1038, pIrp_2);
  ...
  anon96_Then:
    ...
    call {:si_unique_call 443} Status_23 := sdv_IoCallDriver#1(vslice_dummy_var_1039, pIrp_2);
  ...
  anon97_Then:
    ...
    call {:si_unique_call 451} Status_23 := sdv_IoCallDriver#1(vslice_dummy_var_1040, pIrp_2);
  ...
  anon98_Then:
    ...
    call {:si_unique_call 458} Status_23 := sdv_IoCallDriver#1(vslice_dummy_var_1041, pIrp_2);
  ...
  anon82_Else:
    ...
    call {:si_unique_call 474} Status_23 := sdv_IoCallDriver#1(vslice_dummy_var_1042, pIrp_2);
  ...
  anon86_Else:
    ...
    call {:si_unique_call 491} Status_23 := sdv_IoCallDriver#1(vslice_dummy_var_1043, pIrp_2);
  ...
  anon73_Then:
    ...
    call {:si_unique_call 499} Status_23 := sdv_IoCallDriver#1(vslice_dummy_var_1044, pIrp_2);
...
implementation {:origName "PpaInitializeUnlockIrp"} PpaInitializeUnlockIrp(actual_Extension_39: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 523} IoReuseIrp(vslice_dummy_var_1045, 0);
    assume {:nonnull} Extension_39 != 0;
    assume Extension_39 > 0;
    havoc vslice_dummy_var_1046;
    call {:si_unique_call 524} pNextIrpStack := sdv_IoGetNextIrpStackLocation(vslice_dummy_var_1046);
    assume {:nonnull} Extension_39 != 0;
    assume Extension_39 > 0;
...
implementation {:origName "PpaInitializeExtension"} PpaInitializeExtension(actual_Extension_40: int) returns (Tmp_415: int)
{
  ...
  anon29_Else:
    ...
    call {:si_unique_call 532} boogieTmp := IoAllocateIrp(vslice_dummy_var_1047, 0);
    assume {:nonnull} Extension_40 != 0;
    assume Extension_40 > 0;
    goto anon30_Then, anon30_Else;
  ...
  anon30_Else:
    ...
    call {:si_unique_call 533} boogieTmp := IoAllocateIrp(vslice_dummy_var_1048, 0);
    assume {:nonnull} Extension_40 != 0;
    assume Extension_40 > 0;
    goto anon31_Then, anon31_Else;
...
implementation {:origName "PpaInitializeLockIrp"} PpaInitializeLockIrp(actual_Extension_42: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 562} IoReuseIrp(vslice_dummy_var_1049, 0);
    assume {:nonnull} Extension_42 != 0;
    assume Extension_42 > 0;
    havoc vslice_dummy_var_1050;
    call {:si_unique_call 563} pNextIrpStack_1 := sdv_IoGetNextIrpStackLocation(vslice_dummy_var_1050);
    assume {:nonnull} Extension_42 != 0;
    assume Extension_42 > 0;
...
const {:string "Suprise Remove Device Irp is not supported."} unique strConst__li2bpl13: int;
...
implementation {:origName "PpaPortLockCompletionRoutine"} PpaPortLockCompletionRoutine#0(actual_pDeviceObject_3: int, actual_Irp_10: int, actual_ContextIn_1: int) returns (Tmp_365: int)
{
  ...
  L10:
    ...
    call {:si_unique_call 576} PpaCompleteRequest(Extension_34, vslice_dummy_var_1051, status_9);
...
implementation {:origName "PpaPortLockCompletionRoutine"} PpaPortLockCompletionRoutine#1(actual_pDeviceObject_3: int, actual_Irp_10: int, actual_ContextIn_1: int) returns (Tmp_365: int)
{
  ...
  L10:
    ...
    call {:si_unique_call 585} PpaCompleteRequest(Extension_34, vslice_dummy_var_1052, status_9);
...
implementation {:origName "PpaPortUnlock"} PpaPortUnlock#0(actual_Extension_19: int, actual_Wait_2: int, actual_pDeviceObject_1: int)
{
  ...
  anon12_Else:
    ...
    call {:si_unique_call 598} sdv_IoSetCompletionRoutine(vslice_dummy_var_1053, li2bplFunctionConstant134, Event_5, 1, 1, 1);
    goto L20;
  ...
  L20:
    ...
    call {:si_unique_call 599} status_6 := sdv_IoCallDriver#0(vslice_dummy_var_1054, vslice_dummy_var_1055);
    goto anon13_Then, anon13_Else;
  ...
  anon12_Then:
    ...
    call {:si_unique_call 601} sdv_IoSetCompletionRoutine(vslice_dummy_var_1056, li2bplFunctionConstant200, pDeviceObject_1, 1, 1, 1);
    goto L20;
...
implementation {:origName "PpaPortUnlock"} PpaPortUnlock#1(actual_Extension_19: int, actual_Wait_2: int, actual_pDeviceObject_1: int)
{
  ...
  anon12_Else:
    ...
    call {:si_unique_call 606} sdv_IoSetCompletionRoutine(vslice_dummy_var_1057, li2bplFunctionConstant134, Event_5, 1, 1, 1);
    goto L20;
  ...
  L20:
    ...
    call {:si_unique_call 607} status_6 := sdv_IoCallDriver#1(vslice_dummy_var_1058, vslice_dummy_var_1059);
    goto anon13_Then, anon13_Else;
  ...
  anon12_Then:
    ...
    call {:si_unique_call 609} sdv_IoSetCompletionRoutine(vslice_dummy_var_1060, li2bplFunctionConstant200, pDeviceObject_1, 1, 1, 1);
    goto L20;
...
implementation {:origName "IofCallDriver"} {:osmodel} IofCallDriver#0(actual_DeviceObject_6: int, actual_Irp_2: int) returns (Tmp_248: int)
{
  ...
  anon47_Then:
    ...
    call {:si_unique_call 613} vslice_dummy_var_102 := sdv_RunIoCompletionRoutines#0(sdv_p_devobj_fdo, Irp_2, vslice_dummy_var_1061, completion);
    goto L29;
  ...
  anon59_Else:
    ...
    call {:si_unique_call 614} vslice_dummy_var_105 := sdv_RunIoCompletionRoutines#0(sdv_p_devobj_fdo, Irp_2, vslice_dummy_var_1062, completion);
    goto L29;
  ...
  anon51_Else:
    ...
    call {:si_unique_call 615} vslice_dummy_var_103 := sdv_RunIoCompletionRoutines#0(sdv_p_devobj_fdo, Irp_2, vslice_dummy_var_1063, completion);
    goto L29;
  ...
  anon55_Else:
    ...
    call {:si_unique_call 616} vslice_dummy_var_104 := sdv_RunIoCompletionRoutines#0(sdv_p_devobj_fdo, Irp_2, vslice_dummy_var_1064, completion);
    goto L29;
...
implementation {:origName "IofCallDriver"} {:osmodel} IofCallDriver#1(actual_DeviceObject_6: int, actual_Irp_2: int) returns (Tmp_248: int)
{
  ...
  anon47_Then:
    ...
    call {:si_unique_call 618} vslice_dummy_var_106 := sdv_RunIoCompletionRoutines#1(sdv_p_devobj_fdo, Irp_2, vslice_dummy_var_1065, completion);
    goto L29;
  ...
  anon59_Else:
    ...
    call {:si_unique_call 619} vslice_dummy_var_109 := sdv_RunIoCompletionRoutines#1(sdv_p_devobj_fdo, Irp_2, vslice_dummy_var_1066, completion);
    goto L29;
  ...
  anon51_Else:
    ...
    call {:si_unique_call 620} vslice_dummy_var_107 := sdv_RunIoCompletionRoutines#1(sdv_p_devobj_fdo, Irp_2, vslice_dummy_var_1067, completion);
    goto L29;
  ...
  anon55_Else:
    ...
    call {:si_unique_call 621} vslice_dummy_var_108 := sdv_RunIoCompletionRoutines#1(sdv_p_devobj_fdo, Irp_2, vslice_dummy_var_1068, completion);
    goto L29;
...
implementation VPI0DataIn_loop_L14(in_ChunkSize: int, in_sdv_15: int, in_Status_3: int, in_BytesRead: int, in_Extension_2: int) returns (out_ChunkSize: int, out_sdv_15: int, out_Status_3: int)
{
  ...
  L27:
    ...
    call {:si_unique_call 639} out_Status_3 := VPI0ParallelRead(in_Extension_2, vslice_dummy_var_1069, out_ChunkSize, in_BytesRead);
    assume {:nonnull} in_Extension_2 != 0;
    assume in_Extension_2 > 0;
    goto anon29_Else;
...
implementation VPI0DataOut_loop_L14(in_ChunkSize_1: int, in_sdv_22: int, in_Status_4: int, in_BytesWritten: int, in_Extension_6: int) returns (out_ChunkSize_1: int, out_sdv_22: int, out_Status_4: int)
{
  ...
  L27:
    ...
    call {:si_unique_call 643} out_Status_4 := VPI0ParallelWrite(in_Extension_6, vslice_dummy_var_1070, out_ChunkSize_1, in_BytesWritten);
    assume {:nonnull} in_Extension_6 != 0;
    assume in_Extension_6 > 0;
    goto anon29_Else;
