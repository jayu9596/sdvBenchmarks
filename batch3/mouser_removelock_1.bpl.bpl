...
implementation {:origName "SerialMouseSystemControl"} SerialMouseSystemControl(actual_DeviceObject: int, actual_Irp: int) returns (Tmp_30: int)
{
  ...
  L22:
    ...
    call {:si_unique_call 5} status_2 := sdv_IoCallDriver#1(vslice_dummy_var_152, Irp);
  ...
  anon14_Then:
    ...
    call {:si_unique_call 7} status_2 := sdv_IoCallDriver#1(vslice_dummy_var_153, Irp);
...
procedure {:origName "sdv_RtlQueryRegistryValues"} {:osmodel} sdv_RtlQueryRegistryValues(actual_RelativeTo: int, actual_Path: int, actual_QueryTable: int, actual_Context_4: int, actual_Environment: int) returns (Tmp_101: int);
...
implementation {:origName "sdv_RtlQueryRegistryValues"} {:osmodel} sdv_RtlQueryRegistryValues(actual_RelativeTo: int, actual_Path: int, actual_QueryTable: int, actual_Context_4: int, actual_Environment: int) returns (Tmp_101: int)
{
...
implementation {:origName "PoCallDriver"} {:osmodel} PoCallDriver(actual_DeviceObject_4: int, actual_Irp_2: int) returns (Tmp_112: int)
{
  ...
  anon56_Then:
    ...
    call {:si_unique_call 47} vslice_dummy_var_17 := sdv_RunIoCompletionRoutines#1(sdv_p_devobj_fdo, Irp_2, vslice_dummy_var_154, completion);
  ...
  anon68_Else:
    ...
    call {:si_unique_call 48} vslice_dummy_var_20 := sdv_RunIoCompletionRoutines#1(sdv_p_devobj_fdo, Irp_2, vslice_dummy_var_155, completion);
  ...
  anon60_Else:
    ...
    call {:si_unique_call 49} vslice_dummy_var_18 := sdv_RunIoCompletionRoutines#1(sdv_p_devobj_fdo, Irp_2, vslice_dummy_var_156, completion);
  ...
  anon64_Else:
    ...
    call {:si_unique_call 50} vslice_dummy_var_19 := sdv_RunIoCompletionRoutines#1(sdv_p_devobj_fdo, Irp_2, vslice_dummy_var_157, completion);
...
implementation {:origName "main"} {:osmodel} main() returns (Tmp_137: int, dup_assertVar: bool)
{
  ...
  anon0:
    ...
    call {:si_unique_call 117} vslice_dummy_var_158 := __HAVOC_malloc(32);
    call {:si_unique_call 118} vslice_dummy_var_159 := __HAVOC_malloc(72);
    call {:si_unique_call 119} vslice_dummy_var_160 := __HAVOC_malloc(16);
    call {:si_unique_call 120} vslice_dummy_var_161 := __HAVOC_malloc(120);
    call {:si_unique_call 121} vslice_dummy_var_162 := __HAVOC_malloc(12);
    call {:si_unique_call 122} vslice_dummy_var_163 := __HAVOC_malloc(48);
    call {:si_unique_call 123} vslice_dummy_var_164 := __HAVOC_malloc(12);
...
procedure {:origName "SerialMouseReadSerialPortComplete"} SerialMouseReadSerialPortComplete(actual_DeviceObject_16: int, actual_Irp_9: int, actual_Context_7: int) returns (Tmp_233: int);
...
implementation {:origName "SerialMouseReadSerialPortComplete"} SerialMouseReadSerialPortComplete(actual_DeviceObject_16: int, actual_Irp_9: int, actual_Context_7: int) returns (Tmp_233: int)
{
...
implementation {:origName "SerialMouseServiceParameters"} SerialMouseServiceParameters(actual_DeviceExtension_28: int, actual_Handle_1: int)
{
  ...
  anon0:
    ...
    Tmp_323 := 28 * queriesPlusOne;
    call {:si_unique_call 205} sdv_186 := ExAllocatePoolWithTag(1, Tmp_323, -228232371);
    parameters := sdv_186;
    goto anon27_Then, anon27_Else;

  anon27_Else:
    assume {:partition} parameters != 0;
    Tmp_312 := 28 * queriesPlusOne;
    call {:si_unique_call 206} sdv_RtlZeroMemory(0, Tmp_312);
  ...
  anon21_Then:
    ...
    assume parametersPath > 0;
    havoc Tmp_322;
    call {:si_unique_call 211} sdv_191 := ExAllocatePoolWithTag(1, Tmp_322, -228232371);
    assume {:nonnull} parametersPath != 0;
    assume parametersPath > 0;
    assume {:nonnull} parametersPath != 0;
    assume parametersPath > 0;
  ...
  anon29_Else:
    ...
    assume parametersPath > 0;
    havoc Tmp_315;
    call {:si_unique_call 212} sdv_RtlZeroMemory(0, Tmp_315);
...
procedure {:origName "SerialMouseCreate"} SerialMouseCreate(actual_DeviceObject_20: int, actual_Irp_13: int) returns (Tmp_337: int);
  modifies alloc, LockDepth, Mem_T.CompletionRoutine__IO_STACK_LOCATION, yogi_error;
  free ensures {:va_keep} old(t) == 0 ==> yogi_error == 0;
  free ensures {:va_keep} yogi_error == 1 || yogi_error == old(yogi_error);
  free ensures {:va_keep} old(yogi_error) == 0;
...
implementation {:origName "SerialMouseCreate"} SerialMouseCreate(actual_DeviceObject_20: int, actual_Irp_13: int) returns (Tmp_337: int)
{
  ...
  anon20_Else:
    call {:si_unique_call 220} Tmp_338 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_338 != 0;
    assume Tmp_338 > 0;
    assume {:nonnull} deviceExtension_3 != 0;
    assume deviceExtension_3 > 0;
    call {:si_unique_call 221} sdv_209 := sdv_InterlockedIncrement(Tmp_338);
    assume {:nonnull} Tmp_338 != 0;
    assume Tmp_338 > 0;
    assume {:nonnull} deviceExtension_3 != 0;
    assume deviceExtension_3 > 0;
  ...
  anon21_Else:
    ...
    call {:si_unique_call 222} status_35 := SerialMouseSendIrpSynchronously#1(vslice_dummy_var_165, Irp_13, 1);
    goto anon25_Then, anon25_Else;
  ...
  L44:
    call {:si_unique_call 225} Tmp_338 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_338 != 0;
    assume Tmp_338 > 0;
    assume {:nonnull} deviceExtension_3 != 0;
    assume deviceExtension_3 > 0;
    call {:si_unique_call 226} vslice_dummy_var_59 := sdv_InterlockedDecrement(Tmp_338);
    assume {:nonnull} Tmp_338 != 0;
    assume Tmp_338 > 0;
    assume {:nonnull} deviceExtension_3 != 0;
    assume deviceExtension_3 > 0;
...
procedure {:origName "SerialMouseInternalDeviceControl"} SerialMouseInternalDeviceControl(actual_DeviceObject_21: int, actual_Irp_14: int) returns (Tmp_340: int);
...
implementation {:origName "SerialMouseInternalDeviceControl"} SerialMouseInternalDeviceControl(actual_DeviceObject_21: int, actual_Irp_14: int) returns (Tmp_340: int)
{
...
procedure {:origName "SerialMouseFlush"} SerialMouseFlush(actual_DeviceObject_22: int, actual_Irp_15: int) returns (Tmp_346: int);
...
implementation {:origName "SerialMouseFlush"} SerialMouseFlush(actual_DeviceObject_22: int, actual_Irp_15: int) returns (Tmp_346: int)
{
  ...
  anon7_Else:
    ...
    call {:si_unique_call 235} status_37 := sdv_IoCallDriver#1(vslice_dummy_var_166, Irp_15);
    goto anon8_Then, anon8_Else;
...
procedure {:origName "SerialMouseClose"} SerialMouseClose(actual_DeviceObject_23: int, actual_Irp_16: int) returns (Tmp_348: int);
...
implementation {:origName "SerialMouseClose"} SerialMouseClose(actual_DeviceObject_23: int, actual_Irp_16: int) returns (Tmp_348: int)
{
  ...
  anon13_Then:
    ...
    call {:si_unique_call 240} Tmp_349 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_349 != 0;
    assume Tmp_349 > 0;
    assume {:nonnull} deviceExtension_6 != 0;
    assume deviceExtension_6 > 0;
    call {:si_unique_call 241} sdv_217 := sdv_InterlockedDecrement(Tmp_349);
    assume {:nonnull} Tmp_349 != 0;
    assume Tmp_349 > 0;
    assume {:nonnull} deviceExtension_6 != 0;
    assume deviceExtension_6 > 0;
  ...
  anon17_Else:
    ...
    call {:si_unique_call 248} Tmp_348 := sdv_IoCallDriver#1(vslice_dummy_var_167, Irp_16);
    goto anon18_Then, anon18_Else;
...
procedure {:origName "SerialMouseAddDevice"} SerialMouseAddDevice(actual_Driver: int, actual_PDO: int) returns (Tmp_350: int);
  modifies alloc, Mem_T.CompletionRoutine__IO_STACK_LOCATION;
  free ensures {:va_keep} Tmp_350 == -1073741667 || Tmp_350 == -1073741824 || Tmp_350 == -1073741771 || Tmp_350 == -1073741670 || Tmp_350 == -1073741823 || Tmp_350 == 0;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} false || old(t) == 1 || old(t) == 0;
  free ensures {:va_keep} alloc >= old(alloc);
  free ensures {:va_keep} false || t == 1 || t == 0;
...
implementation {:origName "SerialMouseAddDevice"} SerialMouseAddDevice(actual_Driver: int, actual_PDO: int) returns (Tmp_350: int)
{
  ...
  anon10_Then:
    ...
    assume {:nonnull} deviceExtension_7 != 0;
    assume deviceExtension_7 > 0;
    call {:si_unique_call 257} Tmp_351 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_351 != 0;
    assume Tmp_351 > 0;
    assume {:nonnull} deviceExtension_7 != 0;
    assume deviceExtension_7 > 0;
    call {:si_unique_call 258} sdv_KeInitializeSpinLock(Tmp_351);
    assume {:nonnull} Tmp_351 != 0;
    assume Tmp_351 > 0;
    assume {:nonnull} deviceExtension_7 != 0;
    assume deviceExtension_7 > 0;
    ...
    call {:si_unique_call 261} boogieTmp := IoAllocateIrp(vslice_dummy_var_168, 0);
    assume {:nonnull} deviceExtension_7 != 0;
    assume deviceExtension_7 > 0;
    goto anon11_Then, anon11_Else;
...
procedure {:origName "SerialMouseCompletionRoutine"} SerialMouseCompletionRoutine(actual_DeviceObject_25: int, actual_Irp_18: int, actual_Context_9: int) returns (Tmp_356: int);
  free ensures {:va_keep} Tmp_356 == -1073741802;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} false || old(t) == 1 || old(t) == 0;
  free ensures {:va_keep} alloc >= old(alloc);
  free ensures {:va_keep} false || t == 1 || t == 0;
...
implementation {:origName "SerialMouseCompletionRoutine"} SerialMouseCompletionRoutine(actual_DeviceObject_25: int, actual_Irp_18: int, actual_Context_9: int) returns (Tmp_356: int)
{
...
implementation {:origName "SerialMouseStopDevice"} SerialMouseStopDevice(actual_DeviceExtension_34: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 275} Tmp_364 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_364 != 0;
    assume Tmp_364 > 0;
    call {:si_unique_call 276} sdv_KeAcquireSpinLock(0, Tmp_364);
    assume {:nonnull} Tmp_364 != 0;
    assume Tmp_364 > 0;
    havoc irql_1;
...
procedure {:origName "SerialMousePnP"} SerialMousePnP(actual_DeviceObject_27: int, actual_Irp_20: int) returns (Tmp_365: int);
  modifies alloc, t, LockDepth, yogi_error, Mem_T.CompletionRoutine__IO_STACK_LOCATION;
  free ensures {:va_keep} old(LockDepth) != 0 ==> yogi_error == 1;
  free ensures {:va_keep} old(LockDepth) == 0 ==> yogi_error == 1;
  free ensures {:va_keep} old(t) == 1 ==> t != 0;
  free ensures {:va_keep} old(t) == 0 ==> t != 0;
...
implementation {:origName "SerialMousePnP"} SerialMousePnP(actual_DeviceObject_27: int, actual_Irp_20: int) returns (Tmp_365: int)
{
  var {:scalar} i_4: int;
  ...
  anon0:
    ...
    call {:si_unique_call 281} Tmp_367 := __HAVOC_malloc(28);
    call {:si_unique_call 282} Tmp_369 := __HAVOC_malloc(28);
  ...
  anon105_Else:
    ...
    call {:si_unique_call 289} status_42 := sdv_IoCallDriver#1(vslice_dummy_var_169, Irp_20);
  ...
  anon121_Then:
    ...
    call {:si_unique_call 292} status_42 := SerialMouseSendIrpSynchronously#1(vslice_dummy_var_170, Irp_20, 1);
  ...
  anon129_Then:
    ...
    call {:si_unique_call 294} status_42 := SerialMouseSendIrpSynchronously#1(vslice_dummy_var_171, Irp_20, 1);
  ...
  L88:
    call {:si_unique_call 295} i_4, Tmp_367, Tmp_368 := SerialMousePnP_loop_L88(i_4, devCaps, Tmp_367, Tmp_368);
    goto L88_last;
  ...
  anon146_Else:
    ...
    call {:si_unique_call 300} status_42 := sdv_IoCallDriver#1(vslice_dummy_var_172, Irp_20);
  ...
  anon104_Then:
    ...
    call {:si_unique_call 306} status_42 := SerialMouseSendIrpSynchronously#1(vslice_dummy_var_173, Irp_20, 1);
  ...
  anon114_Else:
    call {:si_unique_call 307} Tmp_366 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_366 != 0;
    assume Tmp_366 > 0;
    assume {:nonnull} deviceExtension_9 != 0;
    assume deviceExtension_9 > 0;
    call {:si_unique_call 308} sdv_240 := sdv_InterlockedIncrement(Tmp_366);
    assume {:nonnull} Tmp_366 != 0;
    assume Tmp_366 > 0;
    assume {:nonnull} deviceExtension_9 != 0;
    assume deviceExtension_9 > 0;
  ...
  anon115_Else:
    ...
    call {:si_unique_call 311} status_42 := SerialMouseSendIrpSynchronously#1(vslice_dummy_var_174, Irp_20, 0);
  ...
  anon140_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 317} Tmp_366 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_366 != 0;
    assume Tmp_366 > 0;
    assume {:nonnull} deviceExtension_9 != 0;
    assume deviceExtension_9 > 0;
    call {:si_unique_call 318} sdv_246 := sdv_InterlockedDecrement(Tmp_366);
    assume {:nonnull} Tmp_366 != 0;
    assume Tmp_366 > 0;
    assume {:nonnull} deviceExtension_9 != 0;
    assume deviceExtension_9 > 0;
...
procedure {:origName "SerialMousePower"} SerialMousePower(actual_DeviceObject_28: int, actual_Irp_21: int) returns (Tmp_370: int);
  modifies alloc, LockDepth, Mem_T.CompletionRoutine__IO_STACK_LOCATION, yogi_error;
  free ensures {:va_keep} old(t) == 0 ==> yogi_error == 0;
  free ensures {:va_keep} yogi_error == 1 || yogi_error == old(yogi_error);
  free ensures {:va_keep} old(yogi_error) == 0;
...
implementation {:origName "SerialMousePower"} SerialMousePower(actual_DeviceObject_28: int, actual_Irp_21: int) returns (Tmp_370: int)
{
  var {:pointer} SD1: int;
  ...
  anon78_Else:
    ...
    call {:si_unique_call 335} status_43 := SerialMousepIoSyncIoctl#1(0, 1769524, vslice_dummy_var_175, event_17, iosb_16);
    goto anon79_Then, anon79_Else;
  ...
  L62:
    ...
    call {:si_unique_call 337} SD1 := PoSetPowerState(0, vslice_dummy_var_176, vslice_dummy_var_177);
  ...
  anon80_Else:
    ...
    call {:si_unique_call 341} Tmp_370 := PoCallDriver(0, Irp_21);
    goto anon81_Then, anon81_Else;
...
implementation {:origName "SerialMouseHandleStartStopStart"} SerialMouseHandleStartStopStart(actual_DeviceExtension_35: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 365} Tmp_372 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_372 != 0;
    assume Tmp_372 > 0;
    call {:si_unique_call 366} sdv_KeAcquireSpinLock(0, Tmp_372);
    assume {:nonnull} Tmp_372 != 0;
    assume Tmp_372 > 0;
    havoc irql_2;
  ...
  anon3_Else:
    ...
    call {:si_unique_call 367} IoReuseIrp(vslice_dummy_var_178, 0);
    goto L8;
...
implementation {:origName "CSerPowerUp"} CSerPowerUp#0(actual_DeviceExtension: int) returns (Tmp_3: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 377} status := SerialMousepIoSyncIoctl#0(0, 1769508, vslice_dummy_var_179, event, iosb);
    goto anon12_Then, anon12_Else;
  ...
  anon12_Else:
    ...
    call {:si_unique_call 378} status := SerialMousepIoSyncIoctl#0(0, 1769520, vslice_dummy_var_180, event, iosb);
    goto anon13_Then, anon13_Else;
  ...
  anon13_Else:
    ...
    call {:si_unique_call 379} status := SerialMousepIoSyncIoctlEx#0(0, 1769576, vslice_dummy_var_181, event, iosb, 0, 0, bits, 4);
    goto anon14_Then, anon14_Else;
...
implementation {:origName "CSerPowerUp"} CSerPowerUp#1(actual_DeviceExtension: int) returns (Tmp_3: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 386} status := SerialMousepIoSyncIoctl#1(0, 1769508, vslice_dummy_var_182, event, iosb);
    goto anon12_Then, anon12_Else;
  ...
  anon12_Else:
    ...
    call {:si_unique_call 387} status := SerialMousepIoSyncIoctl#1(0, 1769520, vslice_dummy_var_183, event, iosb);
    goto anon13_Then, anon13_Else;
  ...
  anon13_Else:
    ...
    call {:si_unique_call 388} status := SerialMousepIoSyncIoctlEx#1(0, 1769576, vslice_dummy_var_184, event, iosb, 0, 0, bits, 4);
    goto anon14_Then, anon14_Else;
...
implementation {:origName "IofCallDriver"} {:osmodel} IofCallDriver#0(actual_DeviceObject_9: int, actual_Irp_6: int) returns (Tmp_190: int)
{
  ...
  anon55_Then:
    ...
    call {:si_unique_call 405} vslice_dummy_var_89 := sdv_RunIoCompletionRoutines#0(sdv_p_devobj_fdo, Irp_6, vslice_dummy_var_185, completion_1);
    goto anon76_Then, anon76_Else;
  ...
  anon67_Else:
    ...
    call {:si_unique_call 406} vslice_dummy_var_92 := sdv_RunIoCompletionRoutines#0(sdv_p_devobj_fdo, Irp_6, vslice_dummy_var_186, completion_1);
    goto anon78_Then, anon78_Else;
  ...
  anon59_Else:
    ...
    call {:si_unique_call 407} vslice_dummy_var_90 := sdv_RunIoCompletionRoutines#0(sdv_p_devobj_fdo, Irp_6, vslice_dummy_var_187, completion_1);
    goto anon74_Then, anon74_Else;
  ...
  anon63_Else:
    ...
    call {:si_unique_call 408} vslice_dummy_var_91 := sdv_RunIoCompletionRoutines#0(sdv_p_devobj_fdo, Irp_6, vslice_dummy_var_188, completion_1);
    goto anon72_Then, anon72_Else;
...
implementation {:origName "IofCallDriver"} {:osmodel} IofCallDriver#1(actual_DeviceObject_9: int, actual_Irp_6: int) returns (Tmp_190: int)
{
  ...
  anon55_Then:
    ...
    call {:si_unique_call 410} vslice_dummy_var_93 := sdv_RunIoCompletionRoutines#1(sdv_p_devobj_fdo, Irp_6, vslice_dummy_var_189, completion_1);
    goto anon76_Then, anon76_Else;
  ...
  anon67_Else:
    ...
    call {:si_unique_call 411} vslice_dummy_var_96 := sdv_RunIoCompletionRoutines#1(sdv_p_devobj_fdo, Irp_6, vslice_dummy_var_190, completion_1);
    goto anon78_Then, anon78_Else;
  ...
  anon59_Else:
    ...
    call {:si_unique_call 412} vslice_dummy_var_94 := sdv_RunIoCompletionRoutines#1(sdv_p_devobj_fdo, Irp_6, vslice_dummy_var_191, completion_1);
    goto anon74_Then, anon74_Else;
  ...
  anon63_Else:
    ...
    call {:si_unique_call 413} vslice_dummy_var_95 := sdv_RunIoCompletionRoutines#1(sdv_p_devobj_fdo, Irp_6, vslice_dummy_var_192, completion_1);
    goto anon72_Then, anon72_Else;
...
implementation {:origName "sdv_RunIoCompletionRoutines"} {:osmodel} sdv_RunIoCompletionRoutines#0(actual_DeviceObject_10: int, actual_Irp_7: int, actual_Context_6: int, actual_Completion: int) returns (Tmp_192: int)
{
  ...
  anon16_Else:
    ...
    call {:si_unique_call 415} Status_1 := SerialMouseCompletionRoutine(DeviceObject_10, Irp_7, Context_6);
    assume {:nonnull} Completion != 0;
    assume Completion > 0;
    goto L11;
  ...
  anon13_Else:
    ...
    call {:si_unique_call 416} Status_1 := SerialMouseReadComplete#0(DeviceObject_10, Irp_7, Context_6);
    goto anon17_Then, anon17_Else;
  ...
  anon14_Else:
    ...
    call {:si_unique_call 417} Status_1 := SerialMouseReadSerialPortComplete(DeviceObject_10, Irp_7, Context_6);
    assume {:nonnull} Completion != 0;
    assume Completion > 0;
    goto L45;
  ...
  anon15_Else:
    ...
    call {:si_unique_call 418} Status_1 := SerialMouseSerialMaskEventComplete#0(DeviceObject_10, Irp_7, Context_6);
    goto anon18_Then, anon18_Else;
...
procedure {:origName "sdv_RunIoCompletionRoutines"} {:osmodel} sdv_RunIoCompletionRoutines#0(actual_DeviceObject_10: int, actual_Irp_7: int, actual_Context_6: int, actual_Completion: int) returns (Tmp_192: int);
  modifies alloc, LockDepth, Mem_T.CompletionRoutine__IO_STACK_LOCATION, yogi_error;
  free ensures {:va_keep} old(t) == 0 ==> yogi_error == 0;
  free ensures {:va_keep} yogi_error == 1 || yogi_error == old(yogi_error);
  free ensures {:va_keep} old(yogi_error) == 0;
...
implementation {:origName "sdv_RunIoCompletionRoutines"} {:osmodel} sdv_RunIoCompletionRoutines#1(actual_DeviceObject_10: int, actual_Irp_7: int, actual_Context_6: int, actual_Completion: int) returns (Tmp_192: int)
{
  var {:scalar} Status_1: int;
  var {:pointer} irpsp: int;
  var {:pointer} DeviceObject_10: int;
  ...
  anon16_Else:
    assume {:partition} Mem_T.CompletionRoutine__IO_STACK_LOCATION[CompletionRoutine__IO_STACK_LOCATION(irpsp)] == li2bplFunctionConstant188;
    call {:si_unique_call 420} Status_1 := SerialMouseCompletionRoutine(DeviceObject_10, Irp_7, Context_6);
    assume {:nonnull} Completion != 0;
    assume Completion > 0;
    goto L11;
  ...
  anon13_Else:
    assume {:partition} Mem_T.CompletionRoutine__IO_STACK_LOCATION[CompletionRoutine__IO_STACK_LOCATION(irpsp)] == li2bplFunctionConstant251;
    call {:si_unique_call 421} Status_1 := SerialMouseReadComplete#1(DeviceObject_10, Irp_7, Context_6);
    goto anon17_Then, anon17_Else;
  ...
  anon14_Else:
    assume {:partition} Mem_T.CompletionRoutine__IO_STACK_LOCATION[CompletionRoutine__IO_STACK_LOCATION(irpsp)] == li2bplFunctionConstant256;
    call {:si_unique_call 422} Status_1 := SerialMouseReadSerialPortComplete(DeviceObject_10, Irp_7, Context_6);
    assume {:nonnull} Completion != 0;
    assume Completion > 0;
    goto L45;
  ...
  anon15_Else:
    assume {:partition} Mem_T.CompletionRoutine__IO_STACK_LOCATION[CompletionRoutine__IO_STACK_LOCATION(irpsp)] == li2bplFunctionConstant268;
    call {:si_unique_call 423} Status_1 := SerialMouseSerialMaskEventComplete#1(DeviceObject_10, Irp_7, Context_6);
    goto anon18_Then, anon18_Else;
...
procedure {:origName "sdv_RunIoCompletionRoutines"} {:osmodel} sdv_RunIoCompletionRoutines#1(actual_DeviceObject_10: int, actual_Irp_7: int, actual_Context_6: int, actual_Completion: int) returns (Tmp_192: int);
  modifies alloc, LockDepth, Mem_T.CompletionRoutine__IO_STACK_LOCATION, yogi_error;
  free ensures {:va_keep} old(t) == 0 ==> yogi_error == 0;
  free ensures {:va_keep} yogi_error == 1 || yogi_error == old(yogi_error);
  free ensures {:va_keep} old(yogi_error) == 0;
...
implementation {:origName "SerialMouseReadComplete"} SerialMouseReadComplete#0(actual_DeviceObject_19: int, actual_Irp_10: int, actual_Context_8: int) returns (Tmp_247: int)
{
  ...
  L21:
    ...
    call {:si_unique_call 431} vslice_dummy_var_97 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(DeviceExtension_19), vslice_dummy_var_193);
...
procedure {:origName "SerialMouseReadComplete"} SerialMouseReadComplete#0(actual_DeviceObject_19: int, actual_Irp_10: int, actual_Context_8: int) returns (Tmp_247: int);
  modifies alloc, LockDepth, Mem_T.CompletionRoutine__IO_STACK_LOCATION, yogi_error;
  free ensures {:va_keep} old(LockDepth) != 0 ==> yogi_error == 0;
  free ensures {:va_keep} old(t) == 0 ==> yogi_error == 0;
  free ensures {:va_keep} LockDepth <= old(LockDepth);
...
implementation {:origName "SerialMouseReadComplete"} SerialMouseReadComplete#1(actual_DeviceObject_19: int, actual_Irp_10: int, actual_Context_8: int) returns (Tmp_247: int)
{
  var {:pointer} Tmp_248: int;
  var {:scalar} sdv_142: int;
  var {:scalar} startRead: int;
  ...
  L21:
    ...
    call {:si_unique_call 439} vslice_dummy_var_100 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(DeviceExtension_19), vslice_dummy_var_194);
    goto anon52_Then, anon52_Else;
...
procedure {:origName "SerialMouseReadComplete"} SerialMouseReadComplete#1(actual_DeviceObject_19: int, actual_Irp_10: int, actual_Context_8: int) returns (Tmp_247: int);
  modifies alloc, LockDepth, Mem_T.CompletionRoutine__IO_STACK_LOCATION, yogi_error;
  free ensures {:va_keep} old(t) == 0 ==> yogi_error == 0;
  free ensures {:va_keep} yogi_error == 1 || yogi_error == old(yogi_error);
  free ensures {:va_keep} old(yogi_error) == 0;
...
implementation {:origName "SerialMouseStartRead"} SerialMouseStartRead#0(actual_DeviceExtension_15: int) returns (Tmp_231: int)
{
  ...
  L13:
    ...
    call {:si_unique_call 441} vslice_dummy_var_104 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(DeviceExtension_15), vslice_dummy_var_195);
    goto anon22_Then, anon22_Else;
  ...
  anon20_Else:
    ...
    call {:si_unique_call 446} vslice_dummy_var_106 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(DeviceExtension_15), vslice_dummy_var_196);
    goto anon23_Then, anon23_Else;
...
implementation {:origName "SerialMouseStartRead"} SerialMouseStartRead#1(actual_DeviceExtension_15: int) returns (Tmp_231: int)
{
  ...
  L11:
    call {:si_unique_call 451} Tmp_232, status_19, irql, stack := SerialMouseStartRead#1_loop_L11(sdv_123, Tmp_232, irp_2, status_19, irql, stack, DeviceExtension_15);
    goto L11_last;
  ...
  L13:
    ...
    call {:si_unique_call 453} vslice_dummy_var_108 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(DeviceExtension_15), vslice_dummy_var_197);
    goto anon22_Then, anon22_Else;
  ...
  anon20_Else:
    ...
    call {:si_unique_call 458} vslice_dummy_var_110 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(DeviceExtension_15), vslice_dummy_var_198);
    goto anon23_Then, anon23_Else;
  ...
  anon20_Then:
    ...
    call {:si_unique_call 463} status_19 := sdv_IoCallDriver#0(vslice_dummy_var_199, irp_2);
    goto anon24_Then, anon24_Else;
...
implementation {:origName "SerialMouseSerialMaskEventComplete"} SerialMouseSerialMaskEventComplete#0(actual_DeviceObject_1: int, actual_Irp_1: int, actual_Context: int) returns (Tmp_38: int)
{
  ...
  L12:
    ...
    call {:si_unique_call 465} vslice_dummy_var_111 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(deviceExtension_1), vslice_dummy_var_200);
    goto anon20_Then, anon20_Else;
...
implementation {:origName "SerialMouseSerialMaskEventComplete"} SerialMouseSerialMaskEventComplete#1(actual_DeviceObject_1: int, actual_Irp_1: int, actual_Context: int) returns (Tmp_38: int)
{
  ...
  L12:
    ...
    call {:si_unique_call 470} vslice_dummy_var_112 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(deviceExtension_1), vslice_dummy_var_201);
    goto anon20_Then, anon20_Else;
...
implementation {:origName "IoQueueWorkItem"} {:osmodel} IoQueueWorkItem#0(actual_IoWorkItem_1: int, actual_WorkerRoutine: int, actual_QueueType: int, actual_Context_2: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 475} sdv_RunIoQueueWorkItems#0(0, WorkerRoutine, QueueType, Context_2);
    goto anon3_Then, anon3_Else;
...
implementation {:origName "IoQueueWorkItem"} {:osmodel} IoQueueWorkItem#1(actual_IoWorkItem_1: int, actual_WorkerRoutine: int, actual_QueueType: int, actual_Context_2: int)
{
  ...
  anon0:
    ...
    QueueType := actual_QueueType;
    Context_2 := actual_Context_2;
    call {:si_unique_call 477} sdv_RunIoQueueWorkItems#1(0, WorkerRoutine, QueueType, Context_2);
    goto anon3_Then, anon3_Else;
...
implementation {:origName "sdv_RunIoQueueWorkItems"} {:osmodel} sdv_RunIoQueueWorkItems#0(actual_IoWorkItem_2: int, actual_WorkerRoutine_1: int, actual_QueueType_1: int, actual_Context_3: int)
{
  ...
  anon9_Else:
    ...
    call {:si_unique_call 479} SerialMouseSerialMaskEventWorker#0(sdv_p_devobj_fdo, Context_3);
    goto anon11_Then, anon11_Else;
  ...
  anon10_Else:
    ...
    call {:si_unique_call 480} StartDeviceWorker#0(sdv_p_devobj_fdo, Context_3);
    goto anon12_Then, anon12_Else;
...
implementation {:origName "sdv_RunIoQueueWorkItems"} {:osmodel} sdv_RunIoQueueWorkItems#1(actual_IoWorkItem_2: int, actual_WorkerRoutine_1: int, actual_QueueType_1: int, actual_Context_3: int)
{
  ...
  anon9_Else:
    assume {:partition} WorkerRoutine_1 == li2bplFunctionConstant271;
    call {:si_unique_call 482} SerialMouseSerialMaskEventWorker#1(sdv_p_devobj_fdo, Context_3);
    goto anon11_Then, anon11_Else;
  ...
  anon10_Else:
    assume {:partition} WorkerRoutine_1 == li2bplFunctionConstant193;
    call {:si_unique_call 483} StartDeviceWorker#1(sdv_p_devobj_fdo, Context_3);
    goto anon12_Then, anon12_Else;
...
implementation {:origName "SerialMouseSerialMaskEventWorker"} SerialMouseSerialMaskEventWorker#0(actual_DeviceObject_2: int, actual_Context_1: int)
{
  ...
  anon23_Else:
    ...
    call {:si_unique_call 490} vslice_dummy_var_121 := SerialMousepIoSyncIoctlEx#0(0, 1769576, vslice_dummy_var_202, event_1, iosb_1, 0, 0, bits_1, 4);
    goto anon25_Then, anon25_Else;
  ...
  anon21_Then:
    ...
    call {:si_unique_call 494} vslice_dummy_var_119 := SerialMousepIoSyncIoctl#0(1, 3604999, vslice_dummy_var_203, event_1, iosb_1);
    goto anon27_Then, anon27_Else;
...
implementation {:origName "SerialMouseSerialMaskEventWorker"} SerialMouseSerialMaskEventWorker#1(actual_DeviceObject_2: int, actual_Context_1: int)
{
  ...
  anon23_Else:
    ...
    call {:si_unique_call 501} vslice_dummy_var_126 := SerialMousepIoSyncIoctlEx#1(0, 1769576, vslice_dummy_var_204, event_1, iosb_1, 0, 0, bits_1, 4);
    goto anon25_Then, anon25_Else;
  ...
  anon21_Then:
    ...
    call {:si_unique_call 505} vslice_dummy_var_124 := SerialMousepIoSyncIoctl#1(1, 3604999, vslice_dummy_var_205, event_1, iosb_1);
    goto anon27_Then, anon27_Else;
...
implementation {:origName "SerialMouseSendWaitMaskIrp"} SerialMouseSendWaitMaskIrp#1(actual_DeviceExtension_5: int) returns (Tmp_34: int)
{
  ...
  anon5_Else:
    ...
    call {:si_unique_call 516} Tmp_34 := sdv_IoCallDriver#0(vslice_dummy_var_206, irp);
    goto anon6_Then, anon6_Else;
...
implementation {:origName "StartDeviceWorker"} StartDeviceWorker#0(actual_DeviceObject_26: int, actual_Context_10: int)
{
  ...
  anon18_Else:
    ...
    call {:si_unique_call 520} irp_6 := IoAllocateIrp(vslice_dummy_var_207, 0);
    goto anon19_Then, anon19_Else;
  ...
  anon20_Else:
    ...
    call {:si_unique_call 523} vslice_dummy_var_128 := SerialMousepIoSyncIoctl#0(1, 3604999, vslice_dummy_var_208, event_16, iosb_15);
    goto anon24_Then, anon24_Else;
...
implementation {:origName "StartDeviceWorker"} StartDeviceWorker#1(actual_DeviceObject_26: int, actual_Context_10: int)
{
  ...
  anon18_Else:
    ...
    call {:si_unique_call 531} irp_6 := IoAllocateIrp(vslice_dummy_var_209, 0);
    goto anon19_Then, anon19_Else;
  ...
  anon20_Else:
    ...
    call {:si_unique_call 534} vslice_dummy_var_131 := SerialMousepIoSyncIoctl#1(1, 3604999, vslice_dummy_var_210, event_16, iosb_15);
    goto anon24_Then, anon24_Else;
...
implementation {:origName "SerialMouseStartDevice"} SerialMouseStartDevice#0(actual_DeviceExtension_30: int, actual_Irp_11: int, actual_CloseOnFailure: int) returns (Tmp_326: int)
{
  ...
  anon18_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 543} Tmp_327 := __HAVOC_malloc(4);
    assume {:nonnull} DeviceExtension_30 != 0;
    assume DeviceExtension_30 > 0;
    assume {:nonnull} Tmp_327 != 0;
    assume Tmp_327 > 0;
    call {:si_unique_call 544} vslice_dummy_var_133 := sdv_InterlockedDecrement(Tmp_327);
    assume {:nonnull} DeviceExtension_30 != 0;
    assume DeviceExtension_30 > 0;
    assume {:nonnull} Tmp_327 != 0;
    assume Tmp_327 > 0;
...
procedure {:origName "SerialMouseStartDevice"} SerialMouseStartDevice#0(actual_DeviceExtension_30: int, actual_Irp_11: int, actual_CloseOnFailure: int) returns (Tmp_326: int);
  modifies alloc, LockDepth, Mem_T.CompletionRoutine__IO_STACK_LOCATION, yogi_error;
  free ensures {:va_keep} old(t) == 0 ==> yogi_error == 0;
  free ensures {:va_keep} old(LockDepth) > 0 ==> yogi_error == 0;
  free ensures {:va_keep} yogi_error == 1 || yogi_error == old(yogi_error);
...
implementation {:origName "SerialMouseStartDevice"} SerialMouseStartDevice#1(actual_DeviceExtension_30: int, actual_Irp_11: int, actual_CloseOnFailure: int) returns (Tmp_326: int)
{
  var {:pointer} Tmp_327: int;
  var {:scalar} status_33: int;
  var {:pointer} DeviceExtension_30: int;
  ...
  anon18_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 549} Tmp_327 := __HAVOC_malloc(4);
    assume {:nonnull} DeviceExtension_30 != 0;
    assume DeviceExtension_30 > 0;
    assume {:nonnull} Tmp_327 != 0;
    assume Tmp_327 > 0;
    call {:si_unique_call 550} vslice_dummy_var_134 := sdv_InterlockedDecrement(Tmp_327);
    assume {:nonnull} DeviceExtension_30 != 0;
    assume DeviceExtension_30 > 0;
    assume {:nonnull} Tmp_327 != 0;
    assume Tmp_327 > 0;
...
procedure {:origName "SerialMouseStartDevice"} SerialMouseStartDevice#1(actual_DeviceExtension_30: int, actual_Irp_11: int, actual_CloseOnFailure: int) returns (Tmp_326: int);
  modifies alloc, LockDepth, Mem_T.CompletionRoutine__IO_STACK_LOCATION, yogi_error;
  free ensures {:va_keep} old(t) == 0 ==> yogi_error == 0;
  free ensures {:va_keep} yogi_error == 1 || yogi_error == old(yogi_error);
  free ensures {:va_keep} old(yogi_error) == 0;
...
implementation {:origName "SerialMouseInitializeDevice"} SerialMouseInitializeDevice#0(actual_DeviceExtension_32: int) returns (Tmp_330: int)
{
  var {:scalar} i_3: int;
  ...
  anon0:
    ...
    call {:si_unique_call 554} Tmp_335 := __HAVOC_malloc(4);
  ...
  L14:
    call {:si_unique_call 556} i_3, Tmp_331 := SerialMouseInitializeDevice#0_loop_L14(i_3, Tmp_331, dumpData);
    goto L14_last;
  ...
  anon19_Then:
    ...
    call {:si_unique_call 559} vslice_dummy_var_135 := SerialMousepIoSyncIoctlEx#0(0, 1769540, vslice_dummy_var_211, event_14, iosb_14, waitMask_1, 4, 0, 0);
    goto anon24_Then, anon24_Else;
  ...
  anon22_Else:
    ...
    assume {:nonnull} DeviceExtension_32 != 0;
    assume DeviceExtension_32 > 0;
    Tmp_336 := 48 + dumpCount * 4;
    call {:si_unique_call 561} sdv_205 := IoAllocateErrorLogEntry(0, Tmp_336);
  ...
  L57:
    call {:si_unique_call 562} i_3, Tmp_332, Tmp_334, Tmp_335 := SerialMouseInitializeDevice#0_loop_L57(i_3, Tmp_332, Tmp_334, errorLogEntry, Tmp_335, dumpData, dumpCount);
    goto L57_last;
...
procedure {:origName "SerialMouseInitializeDevice"} SerialMouseInitializeDevice#0(actual_DeviceExtension_32: int) returns (Tmp_330: int);
  modifies alloc, LockDepth, Mem_T.CompletionRoutine__IO_STACK_LOCATION;
  free ensures {:va_keep} old(LockDepth) == LockDepth;
  free ensures {:va_keep} old(LockDepth) == LockDepth;
  free ensures {:va_keep} old(LockDepth) >= 0 ==> LockDepth == old(LockDepth);
...
implementation {:origName "SerialMouseInitializeDevice"} SerialMouseInitializeDevice#1(actual_DeviceExtension_32: int) returns (Tmp_330: int)
{
  var {:scalar} i_3: int;
  var {:scalar} Tmp_331: int;
  var {:scalar} Tmp_332: int;
  ...
  anon0:
    ...
    DeviceExtension_32 := actual_DeviceExtension_32;
    call {:si_unique_call 568} Tmp_335 := __HAVOC_malloc(4);
  ...
  L14:
    call {:si_unique_call 570} i_3, Tmp_331 := SerialMouseInitializeDevice#1_loop_L14(i_3, Tmp_331, dumpData);
    goto L14_last;
  ...
  anon19_Then:
    ...
    call {:si_unique_call 573} vslice_dummy_var_136 := SerialMousepIoSyncIoctlEx#1(0, 1769540, vslice_dummy_var_212, event_14, iosb_14, waitMask_1, 4, 0, 0);
    goto anon24_Then, anon24_Else;
  ...
  anon22_Else:
    ...
    assume DeviceExtension_32 > 0;
    Tmp_336 := 48 + dumpCount * 4;
    call {:si_unique_call 575} sdv_205 := IoAllocateErrorLogEntry(0, Tmp_336);
    errorLogEntry := sdv_205;
    goto anon27_Then, anon27_Else;
  ...
  L57:
    call {:si_unique_call 576} i_3, Tmp_332, Tmp_334, Tmp_335 := SerialMouseInitializeDevice#1_loop_L57(i_3, Tmp_332, Tmp_334, errorLogEntry, Tmp_335, dumpData, dumpCount);
    goto L57_last;
...
procedure {:origName "SerialMouseInitializeDevice"} SerialMouseInitializeDevice#1(actual_DeviceExtension_32: int) returns (Tmp_330: int);
  modifies alloc, LockDepth, Mem_T.CompletionRoutine__IO_STACK_LOCATION, yogi_error;
  free ensures {:va_keep} old(t) == 0 ==> yogi_error == 0;
  free ensures {:va_keep} yogi_error == 1 || yogi_error == old(yogi_error);
  free ensures {:va_keep} old(yogi_error) == 0;
...
implementation {:origName "MSerDetect"} MSerDetect#0(actual_DeviceExtension_25: int) returns (Tmp_268: int)
{
  ...
  L53:
    call {:si_unique_call 614} Tmp_269, count_3, Tmp_278, sdv_169 := MSerDetect#0_loop_L53(Tmp_269, count_3, receiveBuffer, Tmp_278, sdv_169, DeviceExtension_25);
    goto L53_last;
  ...
  L62:
    call {:si_unique_call 616} i_1 := MSerDetect#0_loop_L62(i_1, count_3);
    goto L62_last;
  ...
  L65:
    call {:si_unique_call 617} i_1, Tmp_271, Tmp_272 := MSerDetect#0_loop_L65(i_1, count_3, Tmp_271, Tmp_272, receiveBuffer);
    goto L65_last;
...
implementation {:origName "MSerDetect"} MSerDetect#1(actual_DeviceExtension_25: int) returns (Tmp_268: int)
{
  ...
  L53:
    call {:si_unique_call 631} Tmp_269, count_3, Tmp_278, sdv_169 := MSerDetect#1_loop_L53(Tmp_269, count_3, receiveBuffer, Tmp_278, sdv_169, DeviceExtension_25);
    goto L53_last;
  ...
  L62:
    call {:si_unique_call 633} i_1 := MSerDetect#1_loop_L62(i_1, count_3);
    goto L62_last;
  ...
  L65:
    call {:si_unique_call 634} i_1, Tmp_271, Tmp_272 := MSerDetect#1_loop_L65(i_1, count_3, Tmp_271, Tmp_272, receiveBuffer);
    goto L65_last;
...
implementation {:origName "SerialMouseInitializePort"} SerialMouseInitializePort#0(actual_DeviceExtension_21: int) returns (Tmp_255: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 642} status_25 := SerialMousepIoSyncIoctlEx#0(1, 1769484, vslice_dummy_var_213, event_10, iosb_10, 0, 0, SerialBasicSettings__DEVICE_EXTENSION(DeviceExtension_21), 44);
    goto anon14_Then, anon14_Else;
  ...
  anon13_Then:
    ...
    call {:si_unique_call 643} vslice_dummy_var_161 := SerialMousepIoSyncIoctlEx#0(0, 1769504, vslice_dummy_var_214, event_10, iosb_10, 0, 0, Timeouts__SERIAL_BASIC_SETTINGS(SerialBasicSettings__DEVICE_EXTENSION(DeviceExtension_21)), 20);
    goto anon15_Then, anon15_Else;
  ...
  anon15_Else:
    ...
    call {:si_unique_call 645} vslice_dummy_var_162 := SerialMousepIoSyncIoctlEx#0(0, 1769500, vslice_dummy_var_215, event_10, iosb_10, serialTimeouts, 20, 0, 0);
    goto anon16_Then, anon16_Else;
  ...
  anon16_Else:
    ...
    call {:si_unique_call 646} vslice_dummy_var_163 := SerialMousepIoSyncIoctlEx#0(0, 1769568, vslice_dummy_var_216, event_10, iosb_10, 0, 0, HandFlow__SERIAL_BASIC_SETTINGS(SerialBasicSettings__DEVICE_EXTENSION(DeviceExtension_21)), 16);
    goto anon17_Then, anon17_Else;
  ...
  anon17_Else:
    ...
    call {:si_unique_call 647} status_25 := SerialMousepIoSyncIoctlEx#0(0, 1769572, vslice_dummy_var_217, event_10, iosb_10, serialHandFlow, 16, 0, 0);
    goto anon18_Then, anon18_Else;
...
implementation {:origName "SerialMouseInitializePort"} SerialMouseInitializePort#1(actual_DeviceExtension_21: int) returns (Tmp_255: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 653} status_25 := SerialMousepIoSyncIoctlEx#1(1, 1769484, vslice_dummy_var_218, event_10, iosb_10, 0, 0, SerialBasicSettings__DEVICE_EXTENSION(DeviceExtension_21), 44);
    goto anon14_Then, anon14_Else;
  ...
  anon13_Then:
    ...
    call {:si_unique_call 654} vslice_dummy_var_164 := SerialMousepIoSyncIoctlEx#1(0, 1769504, vslice_dummy_var_219, event_10, iosb_10, 0, 0, Timeouts__SERIAL_BASIC_SETTINGS(SerialBasicSettings__DEVICE_EXTENSION(DeviceExtension_21)), 20);
    goto anon15_Then, anon15_Else;
  ...
  anon15_Else:
    ...
    call {:si_unique_call 656} vslice_dummy_var_165 := SerialMousepIoSyncIoctlEx#1(0, 1769500, vslice_dummy_var_220, event_10, iosb_10, serialTimeouts, 20, 0, 0);
    goto anon16_Then, anon16_Else;
  ...
  anon16_Else:
    ...
    call {:si_unique_call 657} vslice_dummy_var_166 := SerialMousepIoSyncIoctlEx#1(0, 1769568, vslice_dummy_var_221, event_10, iosb_10, 0, 0, HandFlow__SERIAL_BASIC_SETTINGS(SerialBasicSettings__DEVICE_EXTENSION(DeviceExtension_21)), 16);
    goto anon17_Then, anon17_Else;
  ...
  anon17_Else:
    ...
    call {:si_unique_call 658} status_25 := SerialMousepIoSyncIoctlEx#1(0, 1769572, vslice_dummy_var_222, event_10, iosb_10, serialHandFlow, 16, 0, 0);
    goto anon18_Then, anon18_Else;
...
implementation {:origName "MSerPowerDown"} MSerPowerDown#0(actual_DeviceExtension_24: int) returns (Tmp_266: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 663} status_27 := SerialMousepIoSyncIoctl#0(0, 1769508, vslice_dummy_var_223, event_12, iosb_12);
    goto anon14_Then, anon14_Else;
  ...
  anon11_Else:
    ...
    call {:si_unique_call 664} status_27 := SerialMousepIoSyncIoctl#0(0, 1769524, vslice_dummy_var_224, event_12, iosb_12);
    goto anon15_Then, anon15_Else;
...
implementation {:origName "MSerPowerDown"} MSerPowerDown#1(actual_DeviceExtension_24: int) returns (Tmp_266: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 670} status_27 := SerialMousepIoSyncIoctl#1(0, 1769508, vslice_dummy_var_225, event_12, iosb_12);
    goto anon14_Then, anon14_Else;
  ...
  anon11_Else:
    ...
    call {:si_unique_call 671} status_27 := SerialMousepIoSyncIoctl#1(0, 1769524, vslice_dummy_var_226, event_12, iosb_12);
    goto anon15_Then, anon15_Else;
...
implementation {:origName "SerialMouseSetBaudRate"} SerialMouseSetBaudRate#0(actual_DeviceExtension_9: int, actual_BaudRate_1: int) returns (Tmp_53: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 678} status_8 := SerialMousepIoSyncIoctlEx#0(0, 1769476, vslice_dummy_var_227, event_3, iosb_3, sbr, 4, 0, 0);
    goto anon3_Then, anon3_Else;
...
implementation {:origName "SerialMouseSetBaudRate"} SerialMouseSetBaudRate#1(actual_DeviceExtension_9: int, actual_BaudRate_1: int) returns (Tmp_53: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 684} status_8 := SerialMousepIoSyncIoctlEx#1(0, 1769476, vslice_dummy_var_228, event_3, iosb_3, sbr, 4, 0, 0);
    goto anon3_Then, anon3_Else;
...
implementation {:origName "SerialMouseFlushReadBuffer"} SerialMouseFlushReadBuffer#0(actual_DeviceExtension_12: int) returns (Tmp_61: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 689} status_11 := SerialMousepIoSyncIoctlEx#0(0, 1769548, vslice_dummy_var_229, event_4, iosb_6, bits_3, 4, 0, 0);
    goto anon3_Then, anon3_Else;
...
implementation {:origName "SerialMouseFlushReadBuffer"} SerialMouseFlushReadBuffer#1(actual_DeviceExtension_12: int) returns (Tmp_61: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 694} status_11 := SerialMousepIoSyncIoctlEx#1(0, 1769548, vslice_dummy_var_230, event_4, iosb_6, bits_3, 4, 0, 0);
    goto anon3_Then, anon3_Else;
...
implementation {:origName "MSerPowerUp"} MSerPowerUp#0(actual_DeviceExtension_26: int) returns (Tmp_279: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 699} status_29 := SerialMousepIoSyncIoctl#0(0, 1769512, vslice_dummy_var_231, event_13, iosb_13);
    goto anon27_Then, anon27_Else;
  ...
  anon21_Else:
    ...
    call {:si_unique_call 700} status_29 := SerialMousepIoSyncIoctl#0(0, 1769524, vslice_dummy_var_232, event_13, iosb_13);
    goto anon28_Then, anon28_Else;
  ...
  anon23_Else:
    ...
    call {:si_unique_call 702} status_29 := SerialMousepIoSyncIoctl#0(0, 1769508, vslice_dummy_var_233, event_13, iosb_13);
    goto anon29_Then, anon29_Else;
  ...
  anon25_Else:
    ...
    call {:si_unique_call 704} status_29 := SerialMousepIoSyncIoctl#0(0, 1769520, vslice_dummy_var_234, event_13, iosb_13);
    goto anon30_Then, anon30_Else;
...
implementation {:origName "MSerPowerUp"} MSerPowerUp#1(actual_DeviceExtension_26: int) returns (Tmp_279: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 710} status_29 := SerialMousepIoSyncIoctl#1(0, 1769512, vslice_dummy_var_235, event_13, iosb_13);
    goto anon27_Then, anon27_Else;
  ...
  anon21_Else:
    ...
    call {:si_unique_call 711} status_29 := SerialMousepIoSyncIoctl#1(0, 1769524, vslice_dummy_var_236, event_13, iosb_13);
    goto anon28_Then, anon28_Else;
  ...
  anon23_Else:
    ...
    call {:si_unique_call 713} status_29 := SerialMousepIoSyncIoctl#1(0, 1769508, vslice_dummy_var_237, event_13, iosb_13);
    goto anon29_Then, anon29_Else;
  ...
  anon25_Else:
    ...
    call {:si_unique_call 715} status_29 := SerialMousepIoSyncIoctl#1(0, 1769520, vslice_dummy_var_238, event_13, iosb_13);
    goto anon30_Then, anon30_Else;
...
implementation {:origName "SerialMouseSetReadTimeouts"} SerialMouseSetReadTimeouts#0(actual_DeviceExtension_22: int, actual_Timeout_2: int) returns (Tmp_257: int)
{
  ...
  L14:
    ...
    call {:si_unique_call 722} status_26 := SerialMousepIoSyncIoctlEx#0(0, 1769500, vslice_dummy_var_239, event_11, iosb_11, serialTimeouts_1, 20, 0, 0);
    goto anon6_Then, anon6_Else;
...
implementation {:origName "SerialMouseSetReadTimeouts"} SerialMouseSetReadTimeouts#1(actual_DeviceExtension_22: int, actual_Timeout_2: int) returns (Tmp_257: int)
{
  ...
  L14:
    ...
    call {:si_unique_call 728} status_26 := SerialMousepIoSyncIoctlEx#1(0, 1769500, vslice_dummy_var_240, event_11, iosb_11, serialTimeouts_1, 20, 0, 0);
    goto anon6_Then, anon6_Else;
...
implementation {:origName "SerialMouseSetLineCtrl"} SerialMouseSetLineCtrl#0(actual_DeviceExtension_14: int, actual_SerialLineControl: int) returns (Tmp_65: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 733} status_13 := SerialMousepIoSyncIoctlEx#0(0, 1769484, vslice_dummy_var_241, event_6, iosb_8, SerialLineControl, 3, 0, 0);
    goto anon3_Then, anon3_Else;
...
implementation {:origName "SerialMouseSetLineCtrl"} SerialMouseSetLineCtrl#1(actual_DeviceExtension_14: int, actual_SerialLineControl: int) returns (Tmp_65: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 738} status_13 := SerialMousepIoSyncIoctlEx#1(0, 1769484, vslice_dummy_var_242, event_6, iosb_8, SerialLineControl, 3, 0, 0);
    goto anon3_Then, anon3_Else;
...
implementation {:origName "SerialMouseReadSerialPort"} SerialMouseReadSerialPort#1(actual_DeviceExtension_18: int, actual_ReadBuffer: int, actual_Buflen: int, actual_ActualBytesRead: int) returns (Tmp_241: int)
{
  ...
  L15:
    call {:si_unique_call 753} status_22, stack_1 := SerialMouseReadSerialPort#1_loop_L15(irp_4, status_22, event_9, stack_1, DeviceExtension_18, ReadBuffer, Buflen, ActualBytesRead);
    goto L15_last;
  ...
  anon16_Else:
    ...
    call {:si_unique_call 758} status_22 := sdv_IoCallDriver#0(vslice_dummy_var_243, irp_4);
    goto anon21_Then, anon21_Else;
...
implementation {:origName "CSerDetect"} CSerDetect#0(actual_DeviceExtension_3: int, actual_HardwareButtons: int) returns (Tmp_18: int)
{
  ...
  L20:
    call {:si_unique_call 765} Tmp_19, count_1, Tmp_21, sdv_14, vslice_dummy_var_168, vslice_dummy_var_169, vslice_dummy_var_170, vslice_dummy_var_171, vslice_dummy_var_177 := CSerDetect#0_loop_L20(Tmp_19, count_1, Tmp_21, sdv_14, status_1, DeviceExtension_3, vslice_dummy_var_168, vslice_dummy_var_169, vslice_dummy_var_170, vslice_dummy_var_171, vslice_dummy_var_177);
    goto L20_last;
...
implementation {:origName "CSerDetect"} CSerDetect#1(actual_DeviceExtension_3: int, actual_HardwareButtons: int) returns (Tmp_18: int)
{
  ...
  L20:
    call {:si_unique_call 785} Tmp_19, count_1, Tmp_21, sdv_14, vslice_dummy_var_179, vslice_dummy_var_180, vslice_dummy_var_181, vslice_dummy_var_182, vslice_dummy_var_188 := CSerDetect#1_loop_L20(Tmp_19, count_1, Tmp_21, sdv_14, status_1, DeviceExtension_3, vslice_dummy_var_179, vslice_dummy_var_180, vslice_dummy_var_181, vslice_dummy_var_182, vslice_dummy_var_188);
    goto L20_last;
...
implementation {:origName "SerialMouseWriteSerialPort"} SerialMouseWriteSerialPort#1(actual_DeviceExtension_17: int, actual_WriteBuffer: int, actual_NumBytes: int, actual_IoStatusBlock_2: int) returns (Tmp_237: int)
{
  ...
  anon7_Else:
    ...
    call {:si_unique_call 824} status_21 := sdv_IoCallDriver#0(vslice_dummy_var_244, irp_3);
    goto anon9_Then, anon9_Else;
  ...
  anon8_Else:
    ...
    call {:si_unique_call 825} vslice_dummy_var_194 := KeWaitForSingleObject(0, 0, 0, 0, 0);
    goto L22;
...
implementation {:origName "CSerSetProtocol"} CSerSetProtocol#0(actual_DeviceExtension_2: int, actual_NewProtocol: int) returns (Tmp_11: int)
{
  ...
  anon0:
    ...
    Tmp_16 := NewProtocol;
    havoc Tmp_12;
    call {:si_unique_call 827} vslice_dummy_var_195 := SerialMouseWriteChar#0(DeviceExtension_2, Tmp_12);
    goto anon5_Then, anon5_Else;
  ...
  anon5_Else:
    ...
    Tmp_15 := NewProtocol;
    havoc Tmp_14;
    call {:si_unique_call 828} vslice_dummy_var_196 := SerialMouseSetLineCtrl#0(DeviceExtension_2, Tmp_14);
    goto anon6_Then, anon6_Else;
...
implementation {:origName "CSerSetProtocol"} CSerSetProtocol#1(actual_DeviceExtension_2: int, actual_NewProtocol: int) returns (Tmp_11: int)
{
  ...
  anon0:
    ...
    Tmp_16 := NewProtocol;
    havoc Tmp_12;
    call {:si_unique_call 830} vslice_dummy_var_197 := SerialMouseWriteChar#1(DeviceExtension_2, Tmp_12);
    goto anon5_Then, anon5_Else;
  ...
  anon5_Else:
    ...
    Tmp_15 := NewProtocol;
    havoc Tmp_14;
    call {:si_unique_call 831} vslice_dummy_var_198 := SerialMouseSetLineCtrl#1(DeviceExtension_2, Tmp_14);
    goto anon6_Then, anon6_Else;
...
implementation {:origName "CSerSetBaudRate"} CSerSetBaudRate#0(actual_DeviceExtension_4: int, actual_BaudRate: int)
{
  ...
  anon0:
    call {:si_unique_call 832} vslice_dummy_var_199 := __HAVOC_malloc(4);
  ...
  anon13_Else:
    Tmp_24 := count_2;
    havoc Tmp_29;
    call {:si_unique_call 836} vslice_dummy_var_201 := SerialMouseWriteString#0(DeviceExtension_4, Tmp_29);
    goto anon14_Then, anon14_Else;
  ...
  anon14_Else:
    ...
    Tmp_23 := count_2;
    havoc Tmp_28;
    call {:si_unique_call 837} vslice_dummy_var_202 := SerialMouseSetBaudRate#0(DeviceExtension_4, Tmp_28);
    goto anon15_Then, anon15_Else;

  anon15_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 838} vslice_dummy_var_200 := SerialMouseWait(DeviceExtension_4, -20000);
    goto L1;
...
implementation {:origName "CSerSetBaudRate"} CSerSetBaudRate#1(actual_DeviceExtension_4: int, actual_BaudRate: int)
{
  ...
  anon0:
    call {:si_unique_call 839} vslice_dummy_var_203 := __HAVOC_malloc(4);
    DeviceExtension_4 := actual_DeviceExtension_4;
    BaudRate := actual_BaudRate;
  ...
  anon13_Else:
    Tmp_24 := count_2;
    havoc Tmp_29;
    call {:si_unique_call 843} vslice_dummy_var_205 := SerialMouseWriteString#1(DeviceExtension_4, Tmp_29);
    goto anon14_Then, anon14_Else;
  ...
  anon14_Else:
    ...
    Tmp_23 := count_2;
    havoc Tmp_28;
    call {:si_unique_call 844} vslice_dummy_var_206 := SerialMouseSetBaudRate#1(DeviceExtension_4, Tmp_28);
    goto anon15_Then, anon15_Else;

  anon15_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 845} vslice_dummy_var_204 := SerialMouseWait(DeviceExtension_4, -20000);
    goto L1;
...
implementation {:origName "MSerSetProtocol"} MSerSetProtocol#0(actual_DeviceExtension_23: int, actual_NewProtocol_1: int) returns (Tmp_259: int)
{
  ...
  L7:
    ...
    havoc Tmp_261;
    call {:si_unique_call 853} vslice_dummy_var_207 := SerialMouseSetLineCtrl#0(DeviceExtension_23, Tmp_261);
    goto anon6_Then, anon6_Else;
...
implementation {:origName "MSerSetProtocol"} MSerSetProtocol#1(actual_DeviceExtension_23: int, actual_NewProtocol_1: int) returns (Tmp_259: int)
{
  ...
  L7:
    Tmp_263 := NewProtocol_1;
    havoc Tmp_261;
    call {:si_unique_call 855} vslice_dummy_var_208 := SerialMouseSetLineCtrl#1(DeviceExtension_23, Tmp_261);
    goto anon6_Then, anon6_Else;
...
implementation {:origName "SerialMouseSetFifo"} SerialMouseSetFifo#0(actual_DeviceExtension_13: int, actual_Value_2: int) returns (Tmp_63: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 861} status_12 := SerialMousepIoSyncIoctlEx#0(0, 1769628, vslice_dummy_var_245, event_5, iosb_7, fifo, 4, 0, 0);
    goto anon3_Then, anon3_Else;
...
implementation {:origName "SerialMouseSetFifo"} SerialMouseSetFifo#1(actual_DeviceExtension_13: int, actual_Value_2: int) returns (Tmp_63: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 867} status_12 := SerialMousepIoSyncIoctlEx#1(0, 1769628, vslice_dummy_var_246, event_5, iosb_7, fifo, 4, 0, 0);
    goto anon3_Then, anon3_Else;
...
implementation {:origName "SerialMouseStartDetection"} SerialMouseStartDetection#0(actual_DeviceExtension_6: int)
{
  ...
  anon0:
    call {:si_unique_call 868} vslice_dummy_var_209 := __HAVOC_malloc(4);
  ...
  L29:
    ...
    call {:si_unique_call 877} status_6 := SerialMousepIoSyncIoctlEx#0(0, 1769540, vslice_dummy_var_247, event_2, iosb_2, waitMask, 4, 0, 0);
    goto anon34_Then, anon34_Else;
  ...
  anon30_Then:
    ...
    call {:si_unique_call 879} vslice_dummy_var_210 := IoCancelIrp(0);
    assume {:nonnull} DeviceExtension_6 != 0;
    assume DeviceExtension_6 > 0;
    goto L1;
  ...
  anon35_Then:
    ...
    call {:si_unique_call 880} boogieTmp := IoAllocateIrp(vslice_dummy_var_248, 0);
    assume {:nonnull} DeviceExtension_6 != 0;
    assume DeviceExtension_6 > 0;
  ...
  anon28_Then:
    ...
    call {:si_unique_call 881} status_6 := SerialMousepIoSyncIoctlEx#0(0, 1769576, vslice_dummy_var_249, event_2, iosb_2, 0, 0, bits_2, 4);
    goto anon37_Then, anon37_Else;
...
implementation {:origName "SerialMouseStartDetection"} SerialMouseStartDetection#1(actual_DeviceExtension_6: int)
{
  ...
  anon0:
    call {:si_unique_call 883} vslice_dummy_var_211 := __HAVOC_malloc(4);
  ...
  L29:
    ...
    call {:si_unique_call 892} status_6 := SerialMousepIoSyncIoctlEx#1(0, 1769540, vslice_dummy_var_250, event_2, iosb_2, waitMask, 4, 0, 0);
    goto anon34_Then, anon34_Else;
  ...
  anon30_Then:
    assume {:partition} 0 > status_6;
    call {:si_unique_call 894} vslice_dummy_var_212 := IoCancelIrp(0);
    assume {:nonnull} DeviceExtension_6 != 0;
    assume DeviceExtension_6 > 0;
    goto L1;
  ...
  anon35_Then:
    ...
    call {:si_unique_call 895} boogieTmp := IoAllocateIrp(vslice_dummy_var_251, 0);
    assume {:nonnull} DeviceExtension_6 != 0;
    assume DeviceExtension_6 > 0;
    goto anon31_Then, anon31_Else;
  ...
  anon28_Then:
    ...
    call {:si_unique_call 896} status_6 := SerialMousepIoSyncIoctlEx#1(0, 1769576, vslice_dummy_var_252, event_2, iosb_2, 0, 0, bits_2, 4);
    goto anon37_Then, anon37_Else;
...
implementation {:origName "SerialMouseSpinUpRead"} SerialMouseSpinUpRead#0(actual_DeviceExtension_29: int) returns (Tmp_324: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 899} vslice_dummy_var_213 := sdv_IoAcquireRemoveLock(0, 0);
...
procedure {:origName "SerialMouseSpinUpRead"} SerialMouseSpinUpRead#0(actual_DeviceExtension_29: int) returns (Tmp_324: int);
  modifies alloc, LockDepth, Mem_T.CompletionRoutine__IO_STACK_LOCATION, yogi_error;
  free ensures {:va_keep} old(t) == 0 ==> yogi_error == 0;
  free ensures {:va_keep} old(LockDepth) > 0 ==> yogi_error == 0;
  free ensures {:va_keep} yogi_error == 1 || yogi_error == old(yogi_error);
...
implementation {:origName "SerialMouseSpinUpRead"} SerialMouseSpinUpRead#1(actual_DeviceExtension_29: int) returns (Tmp_324: int)
{
  var {:scalar} status_32: int;
  var {:pointer} DeviceExtension_29: int;
  var vslice_dummy_var_214: int;
  ...
  anon0:
    ...
    call {:si_unique_call 902} vslice_dummy_var_214 := sdv_IoAcquireRemoveLock(0, 0);
    assume {:nonnull} DeviceExtension_29 != 0;
    assume DeviceExtension_29 > 0;
...
procedure {:origName "SerialMouseSpinUpRead"} SerialMouseSpinUpRead#1(actual_DeviceExtension_29: int) returns (Tmp_324: int);
  modifies alloc, LockDepth, Mem_T.CompletionRoutine__IO_STACK_LOCATION, yogi_error;
  free ensures {:va_keep} old(t) == 0 ==> yogi_error == 0;
  free ensures {:va_keep} yogi_error == 1 || yogi_error == old(yogi_error);
  free ensures {:va_keep} old(yogi_error) == 0;
...
implementation {:origName "SerialMouseClosePort"} SerialMouseClosePort#0(actual_DeviceExtension_31: int, actual_Irp_12: int)
{
  ...
  anon0:
    call {:si_unique_call 904} vslice_dummy_var_215 := __HAVOC_malloc(4);
  ...
  anon7_Else:
    ...
    call {:si_unique_call 909} vslice_dummy_var_216 := SerialMouseSendIrpSynchronously#0(vslice_dummy_var_253, Irp_12, 0);
    goto anon8_Then, anon8_Else;
  ...
  anon8_Else:
    ...
    call {:si_unique_call 912} vslice_dummy_var_217 := SerialMouseSendIrpSynchronously#0(vslice_dummy_var_254, Irp_12, 0);
    goto anon9_Then, anon9_Else;
...
implementation {:origName "SerialMouseClosePort"} SerialMouseClosePort#1(actual_DeviceExtension_31: int, actual_Irp_12: int)
{
  ...
  anon0:
    call {:si_unique_call 913} vslice_dummy_var_218 := __HAVOC_malloc(4);
    DeviceExtension_31 := actual_DeviceExtension_31;
    Irp_12 := actual_Irp_12;
  ...
  anon7_Else:
    ...
    call {:si_unique_call 918} vslice_dummy_var_219 := SerialMouseSendIrpSynchronously#1(vslice_dummy_var_255, Irp_12, 0);
    goto anon8_Then, anon8_Else;
  ...
  anon8_Else:
    ...
    call {:si_unique_call 921} vslice_dummy_var_220 := SerialMouseSendIrpSynchronously#1(vslice_dummy_var_256, Irp_12, 0);
    goto anon9_Then, anon9_Else;
...
implementation {:origName "SerialMouseRestorePort"} SerialMouseRestorePort#0(actual_DeviceExtension_16: int)
{
  ...
  anon0:
    call {:si_unique_call 922} vslice_dummy_var_221 := __HAVOC_malloc(4);
    ...
    call {:si_unique_call 926} status_20 := SerialMousepIoSyncIoctlEx#0(1, 1769488, vslice_dummy_var_257, event_7, iosb_9, SerialBasicSettings__DEVICE_EXTENSION(DeviceExtension_16), 44, 0, 0);
    goto anon10_Then, anon10_Else;
  ...
  anon9_Else:
    ...
    call {:si_unique_call 927} vslice_dummy_var_222 := SerialMousepIoSyncIoctlEx#0(0, 1769500, vslice_dummy_var_258, event_7, iosb_9, Timeouts__SERIAL_BASIC_SETTINGS(SerialBasicSettings__DEVICE_EXTENSION(DeviceExtension_16)), 20, 0, 0);
    goto anon11_Then, anon11_Else;
  ...
  anon11_Else:
    ...
    call {:si_unique_call 928} vslice_dummy_var_223 := SerialMousepIoSyncIoctlEx#0(0, 1769572, vslice_dummy_var_259, event_7, iosb_9, HandFlow__SERIAL_BASIC_SETTINGS(SerialBasicSettings__DEVICE_EXTENSION(DeviceExtension_16)), 16, 0, 0);
    goto anon12_Then, anon12_Else;
...
implementation {:origName "SerialMouseRestorePort"} SerialMouseRestorePort#1(actual_DeviceExtension_16: int)
{
  ...
  anon0:
    call {:si_unique_call 929} vslice_dummy_var_224 := __HAVOC_malloc(4);
    ...
    call {:si_unique_call 933} status_20 := SerialMousepIoSyncIoctlEx#1(1, 1769488, vslice_dummy_var_260, event_7, iosb_9, SerialBasicSettings__DEVICE_EXTENSION(DeviceExtension_16), 44, 0, 0);
    goto anon10_Then, anon10_Else;
  ...
  anon9_Else:
    ...
    call {:si_unique_call 934} vslice_dummy_var_225 := SerialMousepIoSyncIoctlEx#1(0, 1769500, vslice_dummy_var_261, event_7, iosb_9, Timeouts__SERIAL_BASIC_SETTINGS(SerialBasicSettings__DEVICE_EXTENSION(DeviceExtension_16)), 20, 0, 0);
    goto anon11_Then, anon11_Else;
  ...
  anon11_Else:
    ...
    call {:si_unique_call 935} vslice_dummy_var_226 := SerialMousepIoSyncIoctlEx#1(0, 1769572, vslice_dummy_var_262, event_7, iosb_9, HandFlow__SERIAL_BASIC_SETTINGS(SerialBasicSettings__DEVICE_EXTENSION(DeviceExtension_16)), 16, 0, 0);
    goto anon12_Then, anon12_Else;
...
implementation {:origName "SerialMouseSendIrpSynchronously"} SerialMouseSendIrpSynchronously#0(actual_DeviceObject_24: int, actual_Irp_17: int, actual_CopyToNext: int) returns (Tmp_352: int)
{
...
procedure {:origName "SerialMouseSendIrpSynchronously"} SerialMouseSendIrpSynchronously#0(actual_DeviceObject_24: int, actual_Irp_17: int, actual_CopyToNext: int) returns (Tmp_352: int);
  modifies alloc, Mem_T.CompletionRoutine__IO_STACK_LOCATION;
  free ensures {:va_keep} false;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} false || old(t) == 1 || old(t) == 0;
...
implementation {:origName "SerialMouseSendIrpSynchronously"} SerialMouseSendIrpSynchronously#1(actual_DeviceObject_24: int, actual_Irp_17: int, actual_CopyToNext: int) returns (Tmp_352: int)
{
  var {:scalar} status_40: int;
  var {:scalar} event_15: int;
  var {:pointer} DeviceObject_24: int;
  ...
  anon8_Else:
    ...
    call {:si_unique_call 947} vslice_dummy_var_228 := KeWaitForSingleObject(0, 0, 0, 0, 0);
...
procedure {:origName "SerialMouseSendIrpSynchronously"} SerialMouseSendIrpSynchronously#1(actual_DeviceObject_24: int, actual_Irp_17: int, actual_CopyToNext: int) returns (Tmp_352: int);
  modifies alloc, Mem_T.CompletionRoutine__IO_STACK_LOCATION, LockDepth, yogi_error;
  free ensures {:va_keep} old(t) == 0 ==> yogi_error == 0;
  free ensures {:va_keep} yogi_error == 1 || yogi_error == old(yogi_error);
  free ensures {:va_keep} old(yogi_error) == 0;
...
implementation {:SIextraRecBound 5} SerialMousePnP_loop_L88(in_i_4: int, in_devCaps: int, in_Tmp_367: int, in_Tmp_368: int) returns (out_i_4: int, out_Tmp_367: int, out_Tmp_368: int)
{

  entry:
    out_i_4, out_Tmp_367, out_Tmp_368 := in_i_4, in_Tmp_367, in_Tmp_368;
    goto L88, exit;
  ...
  anon112_Else_dummy:
    call {:si_unique_call 948} {:si_old_unique_call 1} out_i_4, out_Tmp_367, out_Tmp_368 := SerialMousePnP_loop_L88(out_i_4, in_devCaps, out_Tmp_367, out_Tmp_368);
    return;
}



procedure {:LoopProcedure} SerialMousePnP_loop_L88(in_i_4: int, in_devCaps: int, in_Tmp_367: int, in_Tmp_368: int) returns (out_i_4: int, out_Tmp_367: int, out_Tmp_368: int);
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} false || old(t) == 1 || old(t) == 0;
  free ensures {:va_keep} alloc >= old(alloc);
  free ensures {:va_keep} false || t == 1 || t == 0;
...
implementation SerialMouseStartRead#1_loop_L11(in_sdv_123: int, in_Tmp_232: int, in_irp_2: int, in_status_19: int, in_irql: int, in_stack: int, in_DeviceExtension_15: int) returns (out_Tmp_232: int, out_status_19: int, out_irql: int, out_stack: int)
{
  ...
  anon20_Then:
    ...
    call {:si_unique_call 953} out_status_19 := sdv_IoCallDriver#0(vslice_dummy_var_263, in_irp_2);
    goto anon24_Else;
  ...
  anon21_Else_dummy:
    call {:si_unique_call 956} {:si_old_unique_call 1} out_Tmp_232, out_status_19, out_irql, out_stack := SerialMouseStartRead#1_loop_L11(in_sdv_123, out_Tmp_232, in_irp_2, out_status_19, out_irql, out_stack, in_DeviceExtension_15);
    return;
}



procedure {:LoopProcedure} SerialMouseStartRead#1_loop_L11(in_sdv_123: int, in_Tmp_232: int, in_irp_2: int, in_status_19: int, in_irql: int, in_stack: int, in_DeviceExtension_15: int) returns (out_Tmp_232: int, out_status_19: int, out_irql: int, out_stack: int);
  modifies alloc, Mem_T.CompletionRoutine__IO_STACK_LOCATION, LockDepth, yogi_error;
  free ensures {:va_keep} old(LockDepth) != 0 ==> yogi_error == 0;
  free ensures {:va_keep} old(LockDepth) == 0 ==> yogi_error == 0;
  free ensures {:va_keep} yogi_error == 0;
...
implementation SerialMouseInitializeDevice#0_loop_L57(in_i_3: int, in_Tmp_332: int, in_Tmp_334: int, in_errorLogEntry: int, in_Tmp_335: int, in_dumpData: int, in_dumpCount: int) returns (out_i_3: int, out_Tmp_332: int, out_Tmp_334: int, out_Tmp_335: int)
{

  entry:
    out_i_3, out_Tmp_332, out_Tmp_334, out_Tmp_335 := in_i_3, in_Tmp_332, in_Tmp_334, in_Tmp_335;
    goto L57, exit;
  ...
  anon23_Else_dummy:
    call {:si_unique_call 957} {:si_old_unique_call 1} out_i_3, out_Tmp_332, out_Tmp_334, out_Tmp_335 := SerialMouseInitializeDevice#0_loop_L57(out_i_3, out_Tmp_332, out_Tmp_334, in_errorLogEntry, out_Tmp_335, in_dumpData, in_dumpCount);
    return;
}



procedure {:LoopProcedure} SerialMouseInitializeDevice#0_loop_L57(in_i_3: int, in_Tmp_332: int, in_Tmp_334: int, in_errorLogEntry: int, in_Tmp_335: int, in_dumpData: int, in_dumpCount: int) returns (out_i_3: int, out_Tmp_332: int, out_Tmp_334: int, out_Tmp_335: int);
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} false || old(t) == 1 || old(t) == 0;
  free ensures {:va_keep} alloc >= old(alloc);
  free ensures {:va_keep} false || t == 1 || t == 0;
...
implementation {:SIextraRecBound 4} SerialMouseInitializeDevice#0_loop_L14(in_i_3: int, in_Tmp_331: int, in_dumpData: int) returns (out_i_3: int, out_Tmp_331: int)
{

  entry:
    out_i_3, out_Tmp_331 := in_i_3, in_Tmp_331;
    goto L14, exit;
  ...
  anon19_Else_dummy:
    call {:si_unique_call 958} {:si_old_unique_call 1} out_i_3, out_Tmp_331 := SerialMouseInitializeDevice#0_loop_L14(out_i_3, out_Tmp_331, in_dumpData);
    return;
}



procedure {:LoopProcedure} SerialMouseInitializeDevice#0_loop_L14(in_i_3: int, in_Tmp_331: int, in_dumpData: int) returns (out_i_3: int, out_Tmp_331: int);
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} false || old(t) == 1 || old(t) == 0;
  free ensures {:va_keep} alloc >= old(alloc);
  free ensures {:va_keep} false || t == 1 || t == 0;
...
implementation SerialMouseInitializeDevice#1_loop_L57(in_i_3: int, in_Tmp_332: int, in_Tmp_334: int, in_errorLogEntry: int, in_Tmp_335: int, in_dumpData: int, in_dumpCount: int) returns (out_i_3: int, out_Tmp_332: int, out_Tmp_334: int, out_Tmp_335: int)
{
  ...
  anon23_Else_dummy:
    call {:si_unique_call 959} {:si_old_unique_call 1} out_i_3, out_Tmp_332, out_Tmp_334, out_Tmp_335 := SerialMouseInitializeDevice#1_loop_L57(out_i_3, out_Tmp_332, out_Tmp_334, in_errorLogEntry, out_Tmp_335, in_dumpData, in_dumpCount);
    return;
}



procedure {:LoopProcedure} SerialMouseInitializeDevice#1_loop_L57(in_i_3: int, in_Tmp_332: int, in_Tmp_334: int, in_errorLogEntry: int, in_Tmp_335: int, in_dumpData: int, in_dumpCount: int) returns (out_i_3: int, out_Tmp_332: int, out_Tmp_334: int, out_Tmp_335: int);
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} false || old(t) == 1 || old(t) == 0;
  free ensures {:va_keep} alloc >= old(alloc);
  free ensures {:va_keep} false || t == 1 || t == 0;
...
implementation {:SIextraRecBound 4} SerialMouseInitializeDevice#1_loop_L14(in_i_3: int, in_Tmp_331: int, in_dumpData: int) returns (out_i_3: int, out_Tmp_331: int)
{
  ...
  anon19_Else_dummy:
    call {:si_unique_call 960} {:si_old_unique_call 1} out_i_3, out_Tmp_331 := SerialMouseInitializeDevice#1_loop_L14(out_i_3, out_Tmp_331, in_dumpData);
    return;
}



procedure {:LoopProcedure} SerialMouseInitializeDevice#1_loop_L14(in_i_3: int, in_Tmp_331: int, in_dumpData: int) returns (out_i_3: int, out_Tmp_331: int);
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} false || old(t) == 1 || old(t) == 0;
  free ensures {:va_keep} alloc >= old(alloc);
  free ensures {:va_keep} false || t == 1 || t == 0;
...
implementation MSerDetect#0_loop_L53(in_Tmp_269: int, in_count_3: int, in_receiveBuffer: int, in_Tmp_278: int, in_sdv_169: int, in_DeviceExtension_25: int) returns (out_Tmp_269: int, out_count_3: int, out_Tmp_278: int, out_sdv_169: int)
{
...
procedure {:LoopProcedure} MSerDetect#0_loop_L53(in_Tmp_269: int, in_count_3: int, in_receiveBuffer: int, in_Tmp_278: int, in_sdv_169: int, in_DeviceExtension_25: int) returns (out_Tmp_269: int, out_count_3: int, out_Tmp_278: int, out_sdv_169: int);
  modifies alloc, Mem_T.CompletionRoutine__IO_STACK_LOCATION;
...
implementation MSerDetect#0_loop_L65(in_i_1: int, in_count_3: int, in_Tmp_271: int, in_Tmp_272: int, in_receiveBuffer: int) returns (out_i_1: int, out_Tmp_271: int, out_Tmp_272: int)
{
...
procedure {:LoopProcedure} MSerDetect#0_loop_L65(in_i_1: int, in_count_3: int, in_Tmp_271: int, in_Tmp_272: int, in_receiveBuffer: int) returns (out_i_1: int, out_Tmp_271: int, out_Tmp_272: int);
...
implementation MSerDetect#1_loop_L53(in_Tmp_269: int, in_count_3: int, in_receiveBuffer: int, in_Tmp_278: int, in_sdv_169: int, in_DeviceExtension_25: int) returns (out_Tmp_269: int, out_count_3: int, out_Tmp_278: int, out_sdv_169: int)
{
  ...
  anon49_Else_dummy:
    call {:si_unique_call 963} {:si_old_unique_call 1} out_Tmp_269, out_count_3, out_Tmp_278, out_sdv_169 := MSerDetect#1_loop_L53(out_Tmp_269, out_count_3, in_receiveBuffer, out_Tmp_278, out_sdv_169, in_DeviceExtension_25);
    return;
}



procedure {:LoopProcedure} MSerDetect#1_loop_L53(in_Tmp_269: int, in_count_3: int, in_receiveBuffer: int, in_Tmp_278: int, in_sdv_169: int, in_DeviceExtension_25: int) returns (out_Tmp_269: int, out_count_3: int, out_Tmp_278: int, out_sdv_169: int);
  modifies alloc, Mem_T.CompletionRoutine__IO_STACK_LOCATION, LockDepth, yogi_error;
  free ensures {:va_keep} old(LockDepth) != 0 ==> yogi_error == 0;
  free ensures {:va_keep} old(LockDepth) == 0 ==> yogi_error == 0;
  free ensures {:va_keep} yogi_error == 0;
...
implementation MSerDetect#1_loop_L65(in_i_1: int, in_count_3: int, in_Tmp_271: int, in_Tmp_272: int, in_receiveBuffer: int) returns (out_i_1: int, out_Tmp_271: int, out_Tmp_272: int)
{
...
procedure {:LoopProcedure} MSerDetect#1_loop_L65(in_i_1: int, in_count_3: int, in_Tmp_271: int, in_Tmp_272: int, in_receiveBuffer: int) returns (out_i_1: int, out_Tmp_271: int, out_Tmp_272: int);
  free ensures {:va_keep} out_Tmp_271 == in_i_1 || out_Tmp_271 == in_Tmp_271;
  free ensures {:va_keep} out_Tmp_272 == in_i_1 || out_Tmp_272 == in_Tmp_272;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} false || old(t) == 1 || old(t) == 0;
...
implementation SerialMouseReadSerialPort#1_loop_L15(in_irp_4: int, in_status_22: int, in_event_9: int, in_stack_1: int, in_DeviceExtension_18: int, in_ReadBuffer: int, in_Buflen: int, in_ActualBytesRead: int) returns (out_status_22: int, out_stack_1: int)
{
  ...
  anon16_Else:
    ...
    call {:si_unique_call 968} out_status_22 := sdv_IoCallDriver#0(vslice_dummy_var_264, in_irp_4);
    goto anon21_Else;
  ...
  anon20_Else_dummy:
    call {:si_unique_call 970} {:si_old_unique_call 1} out_status_22, out_stack_1 := SerialMouseReadSerialPort#1_loop_L15(in_irp_4, out_status_22, in_event_9, out_stack_1, in_DeviceExtension_18, in_ReadBuffer, in_Buflen, in_ActualBytesRead);
    return;
...
implementation CSerDetect#0_loop_L20(in_Tmp_19: int, in_count_1: int, in_Tmp_21: int, in_sdv_14: int, in_status_1: int, in_DeviceExtension_3: int, in_vslice_dummy_var_168: int, in_vslice_dummy_var_169: int, in_vslice_dummy_var_170: int, in_vslice_dummy_var_171: int, in_vslice_dummy_var_177: int) returns (out_Tmp_19: int, out_count_1: int, out_Tmp_21: int, out_sdv_14: int, out_vslice_dummy_var_168: int, out_vslice_dummy_var_169: int, out_vslice_dummy_var_170: int, out_vslice_dummy_var_171: int, out_vslice_dummy_var_177: int)
{
...
procedure {:LoopProcedure} CSerDetect#0_loop_L20(in_Tmp_19: int, in_count_1: int, in_Tmp_21: int, in_sdv_14: int, in_status_1: int, in_DeviceExtension_3: int, in_vslice_dummy_var_168: int, in_vslice_dummy_var_169: int, in_vslice_dummy_var_170: int, in_vslice_dummy_var_171: int, in_vslice_dummy_var_177: int) returns (out_Tmp_19: int, out_count_1: int, out_Tmp_21: int, out_sdv_14: int, out_vslice_dummy_var_168: int, out_vslice_dummy_var_169: int, out_vslice_dummy_var_170: int, out_vslice_dummy_var_171: int, out_vslice_dummy_var_177: int);
  modifies alloc, Mem_T.CompletionRoutine__IO_STACK_LOCATION;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} false || old(t) == 1 || old(t) == 0;
  free ensures {:va_keep} alloc >= old(alloc);
...
implementation CSerDetect#1_loop_L20(in_Tmp_19: int, in_count_1: int, in_Tmp_21: int, in_sdv_14: int, in_status_1: int, in_DeviceExtension_3: int, in_vslice_dummy_var_179: int, in_vslice_dummy_var_180: int, in_vslice_dummy_var_181: int, in_vslice_dummy_var_182: int, in_vslice_dummy_var_188: int) returns (out_Tmp_19: int, out_count_1: int, out_Tmp_21: int, out_sdv_14: int, out_vslice_dummy_var_179: int, out_vslice_dummy_var_180: int, out_vslice_dummy_var_181: int, out_vslice_dummy_var_182: int, out_vslice_dummy_var_188: int)
{
...
procedure {:LoopProcedure} CSerDetect#1_loop_L20(in_Tmp_19: int, in_count_1: int, in_Tmp_21: int, in_sdv_14: int, in_status_1: int, in_DeviceExtension_3: int, in_vslice_dummy_var_179: int, in_vslice_dummy_var_180: int, in_vslice_dummy_var_181: int, in_vslice_dummy_var_182: int, in_vslice_dummy_var_188: int) returns (out_Tmp_19: int, out_count_1: int, out_Tmp_21: int, out_sdv_14: int, out_vslice_dummy_var_179: int, out_vslice_dummy_var_180: int, out_vslice_dummy_var_181: int, out_vslice_dummy_var_182: int, out_vslice_dummy_var_188: int);
  modifies alloc, Mem_T.CompletionRoutine__IO_STACK_LOCATION, LockDepth, yogi_error;
  free ensures {:va_keep} old(LockDepth) != 0 ==> yogi_error == 0;
  free ensures {:va_keep} old(LockDepth) == 0 ==> yogi_error == 0;
  free ensures {:va_keep} yogi_error == 0;
