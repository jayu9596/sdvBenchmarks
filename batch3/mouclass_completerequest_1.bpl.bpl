...
implementation {:origName "main"} {:osmodel} main() returns (Tmp_77: int, dup_assertVar: bool)
{
  ...
  anon0:
    ...
    call {:si_unique_call 527} vslice_dummy_var_110 := __HAVOC_malloc(44);
    call {:si_unique_call 528} vslice_dummy_var_111 := __HAVOC_malloc(24);
    call {:si_unique_call 529} vslice_dummy_var_163 := __HAVOC_malloc(280);
...
procedure {:origName "SLIC_MouseClassClose_exit"} {:osmodel} SLIC_MouseClassClose_exit(actual_caller_1: int, actual_MouseClassClose_1: int);
  modifies yogi_error;
...
implementation {:origName "SLIC_MouseClassClose_exit"} {:osmodel} SLIC_MouseClassClose_exit(actual_caller_1: int, actual_MouseClassClose_1: int)
{
  var {:pointer} caller_1: int;
  var {:scalar} MouseClassClose_1: int;

  anon0:
    caller_1 := actual_caller_1;
    MouseClassClose_1 := actual_MouseClassClose_1;
    goto anon7_Then, anon7_Else;
  ...
  anon8_Else:
    assume {:partition} MouseClassClose_1 != 259;
    call {:si_unique_call 580} SLIC_ABORT_27_0(caller_1, MouseClassClose_1);
    goto anon9_Then, anon9_Else;
...
procedure {:origName "SLIC_ABORT_25_0"} SLIC_ABORT_25_0(actual_caller_3: int, actual_MouseClassCreate_1: int);
  modifies yogi_error;
...
implementation {:origName "SLIC_ABORT_25_0"} SLIC_ABORT_25_0(actual_caller_3: int, actual_MouseClassCreate_1: int)
{
  var {:pointer} caller_3: int;
  var {:scalar} MouseClassCreate_1: int;

  anon0:
    caller_3 := actual_caller_3;
    MouseClassCreate_1 := actual_MouseClassCreate_1;
    call {:si_unique_call 581} SLIC_ERROR_ROUTINE(strConst__li2bpl1);
    return;
}
...
procedure {:origName "SLIC_MouseClassRead_exit"} {:osmodel} SLIC_MouseClassRead_exit(actual_caller_7: int, actual_MouseClassRead_1: int);
  modifies yogi_error;
  free ensures {:va_keep} old(s) == 1 ==> yogi_error == 0;
  free ensures {:va_keep} old(s) == 0 ==> yogi_error == 0;
  free ensures {:va_keep} yogi_error == 1 || yogi_error == old(yogi_error);
...
implementation {:origName "SLIC_MouseClassRead_exit"} {:osmodel} SLIC_MouseClassRead_exit(actual_caller_7: int, actual_MouseClassRead_1: int)
{
  var {:pointer} caller_7: int;
  var {:scalar} MouseClassRead_1: int;

  anon0:
    caller_7 := actual_caller_7;
    MouseClassRead_1 := actual_MouseClassRead_1;
    goto anon7_Then, anon7_Else;
  ...
  anon8_Else:
    assume {:partition} MouseClassRead_1 != 259;
    call {:si_unique_call 582} SLIC_ABORT_17_0(caller_7, MouseClassRead_1);
    goto anon9_Then, anon9_Else;
...
procedure {:origName "SLIC_ABORT_19_0"} SLIC_ABORT_19_0(actual_caller_10: int, actual_MouseClassPassThrough_1: int);
  modifies yogi_error;
  free ensures {:va_keep} old(forward_state) == 1 ==> yogi_error == 1;
  free ensures {:va_keep} old(forward_state) == 0 ==> yogi_error == 1;
  free ensures {:va_keep} old(s) == 2 ==> yogi_error == 1;
...
implementation {:origName "SLIC_ABORT_19_0"} SLIC_ABORT_19_0(actual_caller_10: int, actual_MouseClassPassThrough_1: int)
{
  var {:pointer} caller_10: int;
  var {:scalar} MouseClassPassThrough_1: int;

  anon0:
    caller_10 := actual_caller_10;
    MouseClassPassThrough_1 := actual_MouseClassPassThrough_1;
    call {:si_unique_call 584} SLIC_ERROR_ROUTINE(strConst__li2bpl1);
    return;
}
...
implementation {:origName "SLIC_sdv_IoCompleteRequest_entry"} {:osmodel} SLIC_sdv_IoCompleteRequest_entry(actual_caller_11: int)
{
  ...
  anon5_Then:
    assume {:partition} s == 1;
    call {:si_unique_call 586} SLIC_ABORT_6_0(caller_11);
    goto anon6_Then, anon6_Else;
...
procedure {:origName "SLIC_MouseClassPassThrough_exit"} {:osmodel} SLIC_MouseClassPassThrough_exit(actual_caller_12: int, actual_MouseClassPassThrough_2: int);
  modifies yogi_error;
  free ensures {:va_keep} old(s) == 1 ==> yogi_error == 0;
  free ensures {:va_keep} old(s) == 0 ==> yogi_error == 0;
  free ensures {:va_keep} yogi_error == 1 || yogi_error == old(yogi_error);
...
implementation {:origName "SLIC_MouseClassPassThrough_exit"} {:osmodel} SLIC_MouseClassPassThrough_exit(actual_caller_12: int, actual_MouseClassPassThrough_2: int)
{
  var {:pointer} caller_12: int;
  var {:scalar} MouseClassPassThrough_2: int;

  anon0:
    caller_12 := actual_caller_12;
    MouseClassPassThrough_2 := actual_MouseClassPassThrough_2;
    goto anon7_Then, anon7_Else;
  ...
  anon8_Else:
    assume {:partition} MouseClassPassThrough_2 != 259;
    call {:si_unique_call 587} SLIC_ABORT_19_0(caller_12, MouseClassPassThrough_2);
    goto anon9_Then, anon9_Else;
...
procedure {:origName "SLIC_ABORT_15_0"} SLIC_ABORT_15_0(actual_caller_13: int, actual_MouseClassSystemControl_1: int);
  modifies yogi_error;
  free ensures {:va_keep} old(forward_state) == 1 ==> yogi_error == 1;
  free ensures {:va_keep} old(forward_state) == 0 ==> yogi_error == 1;
  free ensures {:va_keep} old(s) == 2 ==> yogi_error == 1;
...
implementation {:origName "SLIC_ABORT_15_0"} SLIC_ABORT_15_0(actual_caller_13: int, actual_MouseClassSystemControl_1: int)
{
  var {:pointer} caller_13: int;
  var {:scalar} MouseClassSystemControl_1: int;

  anon0:
    caller_13 := actual_caller_13;
    MouseClassSystemControl_1 := actual_MouseClassSystemControl_1;
    call {:si_unique_call 588} SLIC_ERROR_ROUTINE(strConst__li2bpl1);
    return;
}



procedure {:origName "SLIC_sdv_RunIoCompletionRoutines_exit"} {:osmodel} SLIC_sdv_RunIoCompletionRoutines_exit(actual_caller_14: int, actual_sdv_88: int, actual_sdv_89: int);
  modifies s;
  free ensures {:va_keep} old(s) == 2 ==> s != 0;
  free ensures {:va_keep} old(s) == 1 ==> s != 0;
...
implementation {:origName "SLIC_sdv_RunIoCompletionRoutines_exit"} {:osmodel} SLIC_sdv_RunIoCompletionRoutines_exit(actual_caller_14: int, actual_sdv_88: int, actual_sdv_89: int)
{
  ...
  anon7_Else:
    assume {:partition} sdv_89 != -1073741802;
    s := 1;
    goto L2;
  ...
  anon9_Then:
    call {:si_unique_call 589} SLIC_EXIT_ROUTINE(strConst__li2bpl2);
    goto L2;
...
procedure {:origName "SLIC_MouseClassDeviceControl_exit"} {:osmodel} SLIC_MouseClassDeviceControl_exit(actual_caller_15: int, actual_MouseClassDeviceControl_1: int);
  modifies yogi_error;
  free ensures {:va_keep} old(s) == 1 ==> yogi_error == 0;
  free ensures {:va_keep} old(s) == 0 ==> yogi_error == 0;
  free ensures {:va_keep} yogi_error == 1 || yogi_error == old(yogi_error);
...
implementation {:origName "SLIC_MouseClassDeviceControl_exit"} {:osmodel} SLIC_MouseClassDeviceControl_exit(actual_caller_15: int, actual_MouseClassDeviceControl_1: int)
{
  var {:pointer} caller_15: int;
  var {:scalar} MouseClassDeviceControl_1: int;

  anon0:
    caller_15 := actual_caller_15;
    MouseClassDeviceControl_1 := actual_MouseClassDeviceControl_1;
    goto anon7_Then, anon7_Else;
  ...
  anon8_Else:
    assume {:partition} MouseClassDeviceControl_1 != 259;
    call {:si_unique_call 590} SLIC_ABORT_23_0(caller_15, MouseClassDeviceControl_1);
    goto anon9_Then, anon9_Else;
...
procedure {:origName "SLIC_ABORT_11_0"} SLIC_ABORT_11_0(actual_caller_16: int, actual_MouseClassPower_1: int);
  modifies yogi_error;
  free ensures {:va_keep} old(forward_state) == 1 ==> yogi_error == 1;
  free ensures {:va_keep} old(forward_state) == 0 ==> yogi_error == 1;
  free ensures {:va_keep} old(s) == 2 ==> yogi_error == 1;
...
implementation {:origName "SLIC_ABORT_11_0"} SLIC_ABORT_11_0(actual_caller_16: int, actual_MouseClassPower_1: int)
{
  var {:pointer} caller_16: int;
  var {:scalar} MouseClassPower_1: int;

  anon0:
    caller_16 := actual_caller_16;
    MouseClassPower_1 := actual_MouseClassPower_1;
...
procedure {:origName "SLIC_ABORT_17_0"} SLIC_ABORT_17_0(actual_caller_18: int, actual_MouseClassRead_2: int);
  modifies yogi_error;
  free ensures {:va_keep} old(forward_state) == 1 ==> yogi_error == 1;
  free ensures {:va_keep} old(forward_state) == 0 ==> yogi_error == 1;
  free ensures {:va_keep} old(s) == 2 ==> yogi_error == 1;
...
implementation {:origName "SLIC_ABORT_17_0"} SLIC_ABORT_17_0(actual_caller_18: int, actual_MouseClassRead_2: int)
{
  var {:pointer} caller_18: int;
  var {:scalar} MouseClassRead_2: int;

  anon0:
    caller_18 := actual_caller_18;
    MouseClassRead_2 := actual_MouseClassRead_2;
    call {:si_unique_call 592} SLIC_ERROR_ROUTINE(strConst__li2bpl1);
    return;
}



procedure {:origName "SLIC_MouseClassSystemControl_exit"} {:osmodel} SLIC_MouseClassSystemControl_exit(actual_caller_19: int, actual_MouseClassSystemControl_2: int);
  modifies yogi_error;
  free ensures {:va_keep} old(s) == 1 ==> yogi_error == 0;
  free ensures {:va_keep} old(s) == 0 ==> yogi_error == 0;
  free ensures {:va_keep} yogi_error == 1 || yogi_error == old(yogi_error);
...
implementation {:origName "SLIC_MouseClassSystemControl_exit"} {:osmodel} SLIC_MouseClassSystemControl_exit(actual_caller_19: int, actual_MouseClassSystemControl_2: int)
{
  var {:pointer} caller_19: int;
  var {:scalar} MouseClassSystemControl_2: int;

  anon0:
    caller_19 := actual_caller_19;
    MouseClassSystemControl_2 := actual_MouseClassSystemControl_2;
    goto anon7_Then, anon7_Else;
  ...
  anon8_Else:
    assume {:partition} MouseClassSystemControl_2 != 259;
    call {:si_unique_call 593} SLIC_ABORT_15_0(caller_19, MouseClassSystemControl_2);
    goto anon9_Then, anon9_Else;
...
procedure {:origName "SLIC_MouseClassFlush_exit"} {:osmodel} SLIC_MouseClassFlush_exit(actual_caller_20: int, actual_MouseClassFlush_1: int);
  modifies yogi_error;
  free ensures {:va_keep} old(s) == 1 ==> yogi_error == 0;
  free ensures {:va_keep} old(s) == 0 ==> yogi_error == 0;
  free ensures {:va_keep} yogi_error == 1 || yogi_error == old(yogi_error);
...
implementation {:origName "SLIC_MouseClassFlush_exit"} {:osmodel} SLIC_MouseClassFlush_exit(actual_caller_20: int, actual_MouseClassFlush_1: int)
{
  var {:pointer} caller_20: int;
  var {:scalar} MouseClassFlush_1: int;

  anon0:
    caller_20 := actual_caller_20;
    MouseClassFlush_1 := actual_MouseClassFlush_1;
    goto anon7_Then, anon7_Else;
  ...
  anon8_Else:
    assume {:partition} MouseClassFlush_1 != 259;
    call {:si_unique_call 594} SLIC_ABORT_21_0(caller_20, MouseClassFlush_1);
    goto anon9_Then, anon9_Else;
...
procedure {:origName "SLIC_MousePnP_exit"} {:osmodel} SLIC_MousePnP_exit(actual_caller_21: int, actual_MousePnP_1: int);
  modifies yogi_error;
  free ensures {:va_keep} old(s) == 1 ==> yogi_error == 0;
  free ensures {:va_keep} old(s) == 0 ==> yogi_error == 0;
  free ensures {:va_keep} yogi_error == 1 || yogi_error == old(yogi_error);
...
implementation {:origName "SLIC_MousePnP_exit"} {:osmodel} SLIC_MousePnP_exit(actual_caller_21: int, actual_MousePnP_1: int)
{
  var {:pointer} caller_21: int;
  var {:scalar} MousePnP_1: int;

  anon0:
    caller_21 := actual_caller_21;
    MousePnP_1 := actual_MousePnP_1;
    goto anon7_Then, anon7_Else;
  ...
  anon8_Else:
    assume {:partition} MousePnP_1 != 259;
    call {:si_unique_call 595} SLIC_ABORT_13_0(caller_21, MousePnP_1);
    goto anon9_Then, anon9_Else;
...
procedure {:origName "SLIC_ABORT_29_0"} SLIC_ABORT_29_0(actual_caller_22: int, actual_MouseClassCleanup_1: int);
  modifies yogi_error;
  free ensures {:va_keep} old(forward_state) == 1 ==> yogi_error == 1;
  free ensures {:va_keep} old(forward_state) == 0 ==> yogi_error == 1;
  free ensures {:va_keep} old(s) == 2 ==> yogi_error == 1;
...
implementation {:origName "SLIC_ABORT_29_0"} SLIC_ABORT_29_0(actual_caller_22: int, actual_MouseClassCleanup_1: int)
{
  var {:pointer} caller_22: int;
  var {:scalar} MouseClassCleanup_1: int;

  anon0:
    caller_22 := actual_caller_22;
    MouseClassCleanup_1 := actual_MouseClassCleanup_1;
...
implementation {:origName "SLIC_RemoveHeadList_entry"} SLIC_RemoveHeadList_entry(actual_caller_23: int)
{
  ...
  anon0:
    call {:si_unique_call 597} SLIC_EXIT_ROUTINE(strConst__li2bpl2);
    return;
}
...
implementation {:origName "SLIC_ABORT_6_0"} SLIC_ABORT_6_0(actual_caller_24: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 598} SLIC_ERROR_ROUTINE(strConst__li2bpl3);
    return;
}



procedure {:origName "SLIC_ABORT_27_0"} SLIC_ABORT_27_0(actual_caller_25: int, actual_MouseClassClose_2: int);
  modifies yogi_error;
  free ensures {:va_keep} old(forward_state) == 1 ==> yogi_error == 1;
  free ensures {:va_keep} old(forward_state) == 0 ==> yogi_error == 1;
  free ensures {:va_keep} old(s) == 2 ==> yogi_error == 1;
...
implementation {:origName "SLIC_ABORT_27_0"} SLIC_ABORT_27_0(actual_caller_25: int, actual_MouseClassClose_2: int)
{
  var {:pointer} caller_25: int;
  var {:scalar} MouseClassClose_2: int;

  anon0:
    caller_25 := actual_caller_25;
    MouseClassClose_2 := actual_MouseClassClose_2;
    call {:si_unique_call 599} SLIC_ERROR_ROUTINE(strConst__li2bpl1);
    return;
}
...
procedure {:origName "SLIC_MouseClassPower_exit"} {:osmodel} SLIC_MouseClassPower_exit(actual_caller_27: int, actual_MouseClassPower_2: int);
  modifies yogi_error;
  free ensures {:va_keep} old(s) == 1 ==> yogi_error == 0;
  free ensures {:va_keep} old(s) == 0 ==> yogi_error == 0;
  free ensures {:va_keep} yogi_error == 1 || yogi_error == old(yogi_error);
...
implementation {:origName "SLIC_MouseClassPower_exit"} {:osmodel} SLIC_MouseClassPower_exit(actual_caller_27: int, actual_MouseClassPower_2: int)
{
  var {:pointer} caller_27: int;
  var {:scalar} MouseClassPower_2: int;

  anon0:
    caller_27 := actual_caller_27;
    MouseClassPower_2 := actual_MouseClassPower_2;
    goto anon7_Then, anon7_Else;
  ...
  anon8_Else:
    assume {:partition} MouseClassPower_2 != 259;
    call {:si_unique_call 600} SLIC_ABORT_11_0(caller_27, MouseClassPower_2);
    goto anon9_Then, anon9_Else;
...
procedure {:origName "SLIC_ABORT_23_0"} SLIC_ABORT_23_0(actual_caller_28: int, actual_MouseClassDeviceControl_2: int);
  modifies yogi_error;
  free ensures {:va_keep} old(forward_state) == 1 ==> yogi_error == 1;
  free ensures {:va_keep} old(forward_state) == 0 ==> yogi_error == 1;
  free ensures {:va_keep} old(s) == 2 ==> yogi_error == 1;
...
implementation {:origName "SLIC_ABORT_23_0"} SLIC_ABORT_23_0(actual_caller_28: int, actual_MouseClassDeviceControl_2: int)
{
  var {:pointer} caller_28: int;
  var {:scalar} MouseClassDeviceControl_2: int;

  anon0:
    caller_28 := actual_caller_28;
    MouseClassDeviceControl_2 := actual_MouseClassDeviceControl_2;
...
procedure {:origName "SLIC_MouseClassCleanup_exit"} {:osmodel} SLIC_MouseClassCleanup_exit(actual_caller_29: int, actual_MouseClassCleanup_2: int);
  modifies yogi_error;
  free ensures {:va_keep} old(s) == 1 ==> yogi_error == 0;
  free ensures {:va_keep} old(s) == 0 ==> yogi_error == 0;
  free ensures {:va_keep} yogi_error == 1 || yogi_error == old(yogi_error);
...
implementation {:origName "SLIC_MouseClassCleanup_exit"} {:osmodel} SLIC_MouseClassCleanup_exit(actual_caller_29: int, actual_MouseClassCleanup_2: int)
{
  var {:pointer} caller_29: int;
  var {:scalar} MouseClassCleanup_2: int;

  anon0:
    caller_29 := actual_caller_29;
    MouseClassCleanup_2 := actual_MouseClassCleanup_2;
    goto anon7_Then, anon7_Else;
  ...
  anon8_Else:
    assume {:partition} MouseClassCleanup_2 != 259;
    call {:si_unique_call 602} SLIC_ABORT_29_0(caller_29, MouseClassCleanup_2);
    goto anon9_Then, anon9_Else;
...
procedure {:origName "SLIC_MouseClassCreate_exit"} {:osmodel} SLIC_MouseClassCreate_exit(actual_caller_30: int, actual_MouseClassCreate_2: int);
  modifies yogi_error;
  free ensures {:va_keep} old(s) == 1 ==> yogi_error == 0;
  free ensures {:va_keep} old(s) == 0 ==> yogi_error == 0;
  free ensures {:va_keep} yogi_error == 1 || yogi_error == old(yogi_error);
...
implementation {:origName "SLIC_MouseClassCreate_exit"} {:osmodel} SLIC_MouseClassCreate_exit(actual_caller_30: int, actual_MouseClassCreate_2: int)
{
  var {:pointer} caller_30: int;
  var {:scalar} MouseClassCreate_2: int;

  anon0:
    caller_30 := actual_caller_30;
    MouseClassCreate_2 := actual_MouseClassCreate_2;
    goto anon7_Then, anon7_Else;
  ...
  anon8_Else:
    assume {:partition} MouseClassCreate_2 != 259;
    call {:si_unique_call 603} SLIC_ABORT_25_0(caller_30, MouseClassCreate_2);
    goto anon9_Then, anon9_Else;
...
procedure {:origName "SLIC_ABORT_21_0"} SLIC_ABORT_21_0(actual_caller_31: int, actual_MouseClassFlush_2: int);
  modifies yogi_error;
  free ensures {:va_keep} old(forward_state) == 1 ==> yogi_error == 1;
  free ensures {:va_keep} old(forward_state) == 0 ==> yogi_error == 1;
  free ensures {:va_keep} old(s) == 2 ==> yogi_error == 1;
...
implementation {:origName "SLIC_ABORT_21_0"} SLIC_ABORT_21_0(actual_caller_31: int, actual_MouseClassFlush_2: int)
{
  var {:pointer} caller_31: int;
  var {:scalar} MouseClassFlush_2: int;

  anon0:
    caller_31 := actual_caller_31;
    MouseClassFlush_2 := actual_MouseClassFlush_2;
...
procedure {:origName "SLIC_ABORT_13_0"} SLIC_ABORT_13_0(actual_caller_32: int, actual_MousePnP_2: int);
  modifies yogi_error;
  free ensures {:va_keep} old(forward_state) == 1 ==> yogi_error == 1;
  free ensures {:va_keep} old(forward_state) == 0 ==> yogi_error == 1;
  free ensures {:va_keep} old(s) == 2 ==> yogi_error == 1;
...
implementation {:origName "SLIC_ABORT_13_0"} SLIC_ABORT_13_0(actual_caller_32: int, actual_MousePnP_2: int)
{
  var {:pointer} caller_32: int;
  var {:scalar} MousePnP_2: int;

  anon0:
    caller_32 := actual_caller_32;
    MousePnP_2 := actual_MousePnP_2;
    call {:si_unique_call 605} SLIC_ERROR_ROUTINE(strConst__li2bpl1);
    return;
}
...
implementation {:origName "MouseClassDeviceControl"} MouseClassDeviceControl(actual_DeviceObject_14: int, actual_Irp_7: int) returns (Tmp_168: int)
{
  ...
  anon0:
    ...
    havoc Tmp_181;
    havoc Tmp_173;
    call {:si_unique_call 607} WPP_RECORDER_SF_(Tmp_173, 0, 3, 19, Tmp_181);
    assume {:nonnull} DeviceObject_14 != 0;
    assume DeviceObject_14 > 0;
    havoc deviceExtension;
    call {:si_unique_call 608} stack := sdv_IoGetCurrentIrpStackLocation(Irp_7);
    call {:si_unique_call 609} status_4 := sdv_IoAcquireRemoveLock(0, 0);
  ...
  anon111_Else:
    call {:si_unique_call 610} sdv_IoSkipCurrentIrpStackLocation(Irp_7);
    assume {:nonnull} deviceExtension != 0;
    assume deviceExtension > 0;
    havoc vslice_dummy_var_112;
    call {:si_unique_call 611} status_4 := sdv_IoCallDriver#1(vslice_dummy_var_112, Irp_7);
  ...
  L49:
    assume {:nonnull} deviceExtension != 0;
    assume deviceExtension > 0;
    call {:si_unique_call 612} vslice_dummy_var_35 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(deviceExtension), Irp_7);
    havoc Tmp_183;
    havoc Tmp_180;
    call {:si_unique_call 613} WPP_RECORDER_SF_(Tmp_180, 0, 3, 20, Tmp_183);
    Tmp_168 := status_4;
    goto L1;

  L1:
    call {:si_unique_call 614} SLIC_MouseClassDeviceControl_exit(strConst__li2bpl0, Tmp_168);
  ...
  anon134_Else:
    ...
    assume SLAM_guard_S_0 != SLAM_guard_S_0_init;
    call {:si_unique_call 615} SLIC_sdv_IoCompleteRequest_entry(strConst__li2bpl4);
  ...
  anon136_Else:
    assume Irp_7 == SLAM_guard_S_0;
    assume SLAM_guard_S_0 != SLAM_guard_S_0_init;
    call {:si_unique_call 617} SLIC_sdv_IoCompleteRequest_entry(strConst__li2bpl4);
  ...
  anon138_Else:
    assume Irp_7 == SLAM_guard_S_0;
    assume SLAM_guard_S_0 != SLAM_guard_S_0_init;
    call {:si_unique_call 619} SLIC_sdv_IoCompleteRequest_entry(strConst__li2bpl4);
  ...
  L91:
    call {:si_unique_call 625} unitId, Tmp_170, Tmp_176, Tmp_177, Tmp_182 := MouseClassDeviceControl_loop_L91(unitId, Tmp_170, Tmp_176, Tmp_177, Tmp_182);
    goto L91_last;
  ...
  anon146_Else:
    assume Irp_7 == SLAM_guard_S_0;
    assume SLAM_guard_S_0 != SLAM_guard_S_0_init;
    call {:si_unique_call 627} SLIC_sdv_IoCompleteRequest_entry(strConst__li2bpl4);
  ...
  anon109_Then:
    ...
    assume {:nonnull} stack != 0;
    assume stack > 0;
    call {:si_unique_call 629} ExReleaseFastMutex(0);
    goto L111;

  L111:
    call {:si_unique_call 630} sdv_IoCopyCurrentIrpStackLocationToNext(Irp_7);
    call {:si_unique_call 631} sdv_93 := sdv_IoGetNextIrpStackLocation(Irp_7);
    assume {:nonnull} sdv_93 != 0;
    assume sdv_93 > 0;
    assume {:nonnull} port != 0;
    assume port > 0;
    havoc vslice_dummy_var_113;
    call {:si_unique_call 632} status_4 := sdv_IoCallDriver#1(vslice_dummy_var_113, Irp_7);
  ...
  anon149_Else:
    assume Irp_7 == SLAM_guard_S_0;
    assume SLAM_guard_S_0 != SLAM_guard_S_0_init;
    call {:si_unique_call 633} SLIC_sdv_IoCompleteRequest_entry(strConst__li2bpl4);
...
implementation {:origName "MouseClassRemoveDevice"} MouseClassRemoveDevice(actual_Data_1: int, actual_SurpriseRemove: int)
{
  ...
  anon0:
    call {:si_unique_call 635} vslice_dummy_var_36 := __HAVOC_malloc(4);
  ...
  L11:
    assume {:nonnull} Data_1 != 0;
    assume Data_1 > 0;
    call {:si_unique_call 636} sdv_96 := _InlineInterlockedExchangePointer(WaitWakeIrp__DEVICE_EXTENSION(Data_1), 0);
    waitWakeIrp := sdv_96;
    goto anon30_Then, anon30_Else;

  anon30_Else:
    assume {:partition} waitWakeIrp != 0;
    call {:si_unique_call 637} vslice_dummy_var_38 := IoCancelIrp(0);
    goto L16;

  L16:
    call {:si_unique_call 638} vslice_dummy_var_37 := IoWMIRegistrationControl(0, 2);
    assume {:nonnull} Data_1 != 0;
    assume Data_1 > 0;
    goto anon24_Then, anon24_Else;

  anon24_Else:
    call {:si_unique_call 639} ExAcquireFastMutex(0);
  ...
  anon27_Else:
    ...
    assume {:nonnull} Data_1 != 0;
    assume Data_1 > 0;
    call {:si_unique_call 641} notifyHandle := _InlineInterlockedExchangePointer(TargetNotifyHandle__DEVICE_EXTENSION(Data_1), 0);
    goto anon28_Then, anon28_Else;

  anon28_Else:
    assume {:partition} notifyHandle != 0;
    call {:si_unique_call 642} vslice_dummy_var_39 := IoUnregisterPlugPlayNotification(0);
    goto L23;
  ...
  anon25_Else:
    ...
    call {:si_unique_call 643} MouseClassCleanupQueue(vslice_dummy_var_114, Data_1, 0);
    goto L1;
  ...
  anon26_Then:
    call {:si_unique_call 645} ExReleaseFastMutex(0);
    assume {:nonnull} Data_1 != 0;
    assume Data_1 > 0;
    goto anon29_Then, anon29_Else;

  anon29_Else:
    call {:si_unique_call 646} vslice_dummy_var_40 := IoSetDeviceInterfaceState(0, 0);
    goto L23;
...
implementation {:origName "MouseClassCleanupQueue"} MouseClassCleanupQueue(actual_DeviceObject_15: int, actual_DeviceExtension: int, actual_FileObject_1: int)
{
  ...
  anon0:
    call {:si_unique_call 647} listHead := __HAVOC_malloc(8);
    call {:si_unique_call 648} vslice_dummy_var_41 := __HAVOC_malloc(4);
    DeviceExtension := actual_DeviceExtension;
    FileObject_1 := actual_FileObject_1;
    call {:si_unique_call 649} InitializeListHead(listHead);
    call {:si_unique_call 650} Tmp_188 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_188 != 0;
    assume Tmp_188 > 0;
    call {:si_unique_call 651} sdv_KeAcquireSpinLock(0, Tmp_188);
    assume {:nonnull} Tmp_188 != 0;
    assume Tmp_188 > 0;
    havoc irql_1;
    assume {:nonnull} DeviceExtension != 0;
  ...
  L16:
    call {:si_unique_call 652} nextEntry, sdv_102, oldCancelRoutine, irp, entry, stack_1, vslice_dummy_var_42, vslice_dummy_var_44 := MouseClassCleanupQueue_loop_L16(listHead, nextEntry, sdv_102, oldCancelRoutine, irp, entry, stack_1, FileObject_1, vslice_dummy_var_42, vslice_dummy_var_44);
    goto L16_last;
  ...
  anon11_Else:
    ...
    assume entry > 0;
    havoc nextEntry;
    call {:si_unique_call 653} sdv_102 := sdv_containing_record(entry, 88);
    irp := sdv_102;
    call {:si_unique_call 654} stack_1 := sdv_IoGetCurrentIrpStackLocation(irp);
    goto anon12_Then, anon12_Else;
  ...
  L31:
    call {:si_unique_call 655} vslice_dummy_var_42 := sdv_RemoveEntryList(0);
    call {:si_unique_call 656} oldCancelRoutine := sdv_IoSetCancelRoutine(irp, 0);
    goto anon14_Then, anon14_Else;
  ...
  anon14_Else:
    ...
    assume {:nonnull} irp != 0;
    assume irp > 0;
    call {:si_unique_call 657} vslice_dummy_var_44 := sdv_InsertTailList(listHead, ListEntry_unnamed_tag_6(Overlay_unnamed_tag_5(Tail__IRP(irp))));
    goto L35;
  ...
  anon14_Then:
    ...
    assume {:nonnull} irp != 0;
    assume irp > 0;
    call {:si_unique_call 658} InitializeListHead(ListEntry_unnamed_tag_6(Overlay_unnamed_tag_5(Tail__IRP(irp))));
    goto L35;
  ...
  anon11_Then:
    call {:si_unique_call 659} sdv_KeReleaseSpinLock(0, irql_1);
    goto L49;

  L49:
    call {:si_unique_call 660} sdv_107, irp, sdv_108, entry, vslice_dummy_var_43 := MouseClassCleanupQueue_loop_L49(listHead, sdv_107, irp, sdv_108, entry, DeviceExtension, vslice_dummy_var_43);
    goto L49_last;

  L49_last:
    call {:si_unique_call 665} sdv_107 := sdv_IsListEmpty(0);
    goto anon15_Then, anon15_Else;

  anon15_Else:
    assume {:partition} sdv_107 == 0;
    call {:si_unique_call 661} entry := RemoveHeadList(listHead);
    call {:si_unique_call 662} sdv_108 := sdv_containing_record(entry, 88);
    irp := sdv_108;
    call {:si_unique_call 663} sdv_IoCompleteRequest(0, 0);
    assume {:nonnull} DeviceExtension != 0;
    assume DeviceExtension > 0;
    call {:si_unique_call 664} vslice_dummy_var_43 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(DeviceExtension), irp);
...
implementation {:origName "MouseClassLogError"} MouseClassLogError(actual_Object_2: int, actual_ErrorCode: int, actual_UniqueErrorValue: int, actual_FinalStatus: int, actual_DumpCount: int, actual_DumpData: int, actual_MajorFunction: int)
{
  ...
  anon0:
    call {:si_unique_call 666} vslice_dummy_var_45 := __HAVOC_malloc(4);
    ...
    call {:si_unique_call 667} Tmp_194 := __HAVOC_malloc(4);
    Tmp_193 := 48 + DumpCount * 4;
    call {:si_unique_call 668} sdv_109 := IoAllocateErrorLogEntry(0, Tmp_193);
  ...
  L20:
    call {:si_unique_call 669} i, Tmp_190, Tmp_194, Tmp_195 := MouseClassLogError_loop_L20(i, errorLogEntry, Tmp_190, Tmp_194, Tmp_195, DumpCount, DumpData);
    goto L20_last;
...
implementation {:origName "_sdv_init1"} _sdv_init1()
{
  ...
  anon0:
    call {:si_unique_call 671} vslice_dummy_var_46 := __HAVOC_malloc(4);
    call {:si_unique_call 672} Tmp_197 := __HAVOC_malloc(4);
...
implementation {:origName "MouseClassClose"} MouseClassClose(actual_DeviceObject_16: int, actual_Irp_8: int) returns (Tmp_199: int)
{
  ...
  anon0:
    ...
    havoc Tmp_206;
    havoc Tmp_200;
    call {:si_unique_call 673} WPP_RECORDER_SF_(Tmp_200, 0, 3, 28, Tmp_206);
    assume {:nonnull} DeviceObject_16 != 0;
    assume DeviceObject_16 > 0;
    havoc deviceExtension_1;
    call {:si_unique_call 674} irpSp_1 := sdv_IoGetCurrentIrpStackLocation(Irp_8);
    assume {:nonnull} deviceExtension_1 != 0;
    assume deviceExtension_1 > 0;
    goto anon39_Then, anon39_Else;

  anon39_Else:
    call {:si_unique_call 675} Tmp_202 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_202 != 0;
    assume Tmp_202 > 0;
    call {:si_unique_call 676} sdv_KeAcquireSpinLock(0, Tmp_202);
    assume {:nonnull} Tmp_202 != 0;
    assume Tmp_202 > 0;
    havoc oldIrql;
  ...
  L36:
    call {:si_unique_call 677} sdv_KeReleaseSpinLock(0, oldIrql);
    goto L29;

  L29:
    call {:si_unique_call 678} ExAcquireFastMutex(0);
  ...
  L45:
    call {:si_unique_call 679} i_1, someEnableDisableSucceeded, notifyHandle_1, port_2, Tmp_204, Tmp_205, enabled_1, Tmp_208, status_5, Tmp_211, Tmp_212, vslice_dummy_var_47 := MouseClassClose_loop_L45(i_1, someEnableDisableSucceeded, irpSp_1, notifyHandle_1, port_2, Tmp_204, Tmp_205, enabled_1, Tmp_208, status_5, Tmp_211, Tmp_212, DeviceObject_16, Irp_8, vslice_dummy_var_47);
    goto L45_last;
  ...
  anon43_Else:
    ...
    assume Tmp_205 > 0;
    call {:si_unique_call 681} notifyHandle_1 := _InlineInterlockedExchangePointer(TargetNotifyHandle__DEVICE_EXTENSION(Tmp_205), 0);
    goto anon45_Then, anon45_Else;

  anon45_Else:
    assume {:partition} notifyHandle_1 != 0;
    call {:si_unique_call 682} vslice_dummy_var_47 := IoUnregisterPlugPlayNotification(0);
    goto L65;
  ...
  L65:
    ...
    call {:si_unique_call 683} status_5 := MouEnableDisablePort#1(0, Irp_8, vslice_dummy_var_115, File__PORT(port_2));
  ...
  anon44_Else:
    ...
    call {:si_unique_call 684} WPP_RECORDER_SF_q(Tmp_208, 0, 1, 29, Tmp_212, vslice_dummy_var_116);
    assume {:nonnull} irpSp_1 != 0;
    assume irpSp_1 > 0;
    havoc vslice_dummy_var_117;
    call {:si_unique_call 685} MouseClassLogError(DeviceObject_16, -1073414134, 20120, status_5, 0, 0, vslice_dummy_var_117);
    goto L85;

  L85:
    call {:si_unique_call 686} ExAcquireFastMutex(0);
    goto L53;
  ...
  anon52_Else:
    ...
    assume SLAM_guard_S_0 != SLAM_guard_S_0_init;
    call {:si_unique_call 688} SLIC_sdv_IoCompleteRequest_entry(strConst__li2bpl4);
  ...
  L150:
    ...
    havoc Tmp_209;
    havoc Tmp_213;
    call {:si_unique_call 690} WPP_RECORDER_SF_(Tmp_213, 0, 3, 31, Tmp_209);
    Tmp_199 := status_5;
    goto L1;

  L1:
    call {:si_unique_call 691} SLIC_MouseClassClose_exit(strConst__li2bpl0, Tmp_199);
  ...
  anon47_Else:
    assume {:nonnull} irpSp_1 != 0;
    assume irpSp_1 > 0;
    call {:si_unique_call 693} status_5 := MouEnableDisablePort#1(0, Irp_8, deviceExtension_1, FileObject__IO_STACK_LOCATION(irpSp_1));
  ...
  anon48_Else:
    ...
    call {:si_unique_call 694} WPP_RECORDER_SF_q(Tmp_207, 0, 1, 30, Tmp_203, vslice_dummy_var_118);
    assume {:nonnull} irpSp_1 != 0;
    assume irpSp_1 > 0;
    havoc vslice_dummy_var_119;
    call {:si_unique_call 695} MouseClassLogError(DeviceObject_16, -1073414134, 20120, status_5, 0, 0, vslice_dummy_var_119);
    goto L88;
  ...
  anon47_Then:
    call {:si_unique_call 696} sdv_IoSkipCurrentIrpStackLocation(Irp_8);
    assume {:nonnull} deviceExtension_1 != 0;
    assume deviceExtension_1 > 0;
    havoc vslice_dummy_var_120;
    call {:si_unique_call 697} status_5 := sdv_IoCallDriver#1(vslice_dummy_var_120, Irp_8);
...
implementation {:origName "RemoveHeadList"} RemoveHeadList(actual_ListHead_1: int) returns (Tmp_216: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 699} SLIC_RemoveHeadList_entry(strConst__li2bpl0);
  ...
  L9:
    call {:si_unique_call 700} FatalListEntryError(ListHead_1, Entry_1, NextEntry);
    goto L12;
...
implementation {:origName "MouseQueryDeviceKey"} MouseQueryDeviceKey(actual_Handle_1: int, actual_ValueNameString: int, actual_Data_3: int, actual_DataLength: int) returns (Tmp_224: int)
{
  ...
  anon0:
    call {:si_unique_call 701} valueName := __HAVOC_malloc(12);
    call {:si_unique_call 702} length := __HAVOC_malloc(4);
    ValueNameString := actual_ValueNameString;
    DataLength := actual_DataLength;
    call {:si_unique_call 703} sdv_do_paged_code_check();
    call {:si_unique_call 704} RtlInitUnicodeString(valueName, ValueNameString);
    assume {:nonnull} valueName != 0;
    assume valueName > 0;
    havoc Tmp_227;
    call {:si_unique_call 705} status_9 := RtlULongAdd(24, Tmp_227, length);
    goto anon11_Then, anon11_Else;
  ...
  anon11_Else:
    ...
    call {:si_unique_call 706} status_9 := RtlULongAdd(vslice_dummy_var_121, DataLength, length);
    goto anon12_Then, anon12_Else;
  ...
  anon12_Else:
    ...
    call {:si_unique_call 707} sdv_125 := ExAllocatePoolWithTag(1, vslice_dummy_var_122, -1016105651);
    fullInfo := sdv_125;
    goto anon15_Then, anon15_Else;

  anon15_Else:
    assume {:partition} fullInfo != 0;
    call {:si_unique_call 708} Tmp_225 := __HAVOC_malloc(4);
    ...
    call {:si_unique_call 709} status_9 := ZwQueryValueKey(0, 0, 1, 0, vslice_dummy_var_123, Tmp_225);
    assume {:nonnull} Tmp_225 != 0;
    assume Tmp_225 > 0;
    assume {:nonnull} length != 0;
    assume length > 0;
  ...
  anon14_Else:
    ...
    call {:si_unique_call 710} sdv_RtlCopyMemory(0, 0, vslice_dummy_var_124);
    goto L37;
...
implementation {:origName "WPP_RECORDER_SF_q"} WPP_RECORDER_SF_q(actual_AutoLogContext: int, actual_level: int, actual_flags: int, actual_id: int, actual_traceGuid: int, actual_s_p_e_c_i_a_l_1: int)
{
  ...
  anon0:
    call {:si_unique_call 712} vslice_dummy_var_48 := __HAVOC_malloc(4);
    level := actual_level;
    flags := actual_flags;
    traceGuid := actual_traceGuid;
    call {:si_unique_call 713} vslice_dummy_var_50 := __HAVOC_malloc(4);
    ...
    call {:si_unique_call 714} Tmp_234 := corral_nondet();
    goto anon5_Then, anon5_Else;

  anon5_Else:
    call {:si_unique_call 715} Tmp_228 := corral_nondet();
    goto anon6_Then, anon6_Else;

  anon6_Else:
    call {:si_unique_call 716} Tmp_230 := corral_nondet();
    assume pfnWppTraceMessage == 0;
    goto L6;

  L6:
    call {:si_unique_call 717} vslice_dummy_var_49 := corral_nondet();
    return;
...
implementation {:origName "WPP_RECORDER_SF_Dq"} WPP_RECORDER_SF_Dq(actual_AutoLogContext_1: int, actual_level_1: int, actual_flags_1: int, actual_id_1: int, actual_traceGuid_1: int, actual_s_p_e_c_i_a_l_2: int, actual_s_p_e_c_i_a_l_3: int)
{
  ...
  anon0:
    call {:si_unique_call 718} vslice_dummy_var_51 := __HAVOC_malloc(4);
    level_1 := actual_level_1;
    flags_1 := actual_flags_1;
    traceGuid_1 := actual_traceGuid_1;
    call {:si_unique_call 719} vslice_dummy_var_53 := __HAVOC_malloc(4);
    ...
    call {:si_unique_call 720} Tmp_239 := corral_nondet();
    goto anon5_Then, anon5_Else;

  anon5_Else:
    call {:si_unique_call 721} Tmp_243 := corral_nondet();
    goto anon6_Then, anon6_Else;

  anon6_Else:
    call {:si_unique_call 722} Tmp_241 := corral_nondet();
    assume pfnWppTraceMessage == 0;
    goto L6;

  L6:
    call {:si_unique_call 723} vslice_dummy_var_52 := corral_nondet();
    return;
...
implementation {:origName "MouSyncComplete"} MouSyncComplete(actual_DeviceObject_19: int, actual_Irp_10: int, actual_Context_9: int) returns (Tmp_254: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 724} vslice_dummy_var_54 := KeSetEvent(Context_9, 0, 0);
    Tmp_254 := -1073741802;
    return;
}
...
implementation {:origName "MouseClassPassThrough"} MouseClassPassThrough(actual_DeviceObject_20: int, actual_Irp_11: int) returns (Tmp_256: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 726} sdv_IoSkipCurrentIrpStackLocation(Irp_11);
    ...
    assume Tmp_259 > 0;
    havoc Tmp_257;
    call {:si_unique_call 727} Tmp_256 := sdv_IoCallDriver#1(Tmp_257, Irp_11);
    goto anon5_Then, anon5_Else;

  anon5_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 728} SLIC_MouseClassPassThrough_exit(strConst__li2bpl0, Tmp_256);
    goto anon6_Then, anon6_Else;
...
implementation {:origName "RtlFailFast"} RtlFailFast(actual_Code: int)
{
  ...
  anon0:
    call {:si_unique_call 729} vslice_dummy_var_55 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "WPP_RECORDER_SF_LL"} WPP_RECORDER_SF_LL(actual_AutoLogContext_2: int, actual_level_2: int, actual_flags_2: int, actual_id_2: int, actual_traceGuid_2: int, actual_s_p_e_c_i_a_l_4: int, actual_s_p_e_c_i_a_l_5: int)
{
  ...
  anon0:
    call {:si_unique_call 730} vslice_dummy_var_56 := __HAVOC_malloc(4);
    level_2 := actual_level_2;
    flags_2 := actual_flags_2;
    traceGuid_2 := actual_traceGuid_2;
    call {:si_unique_call 731} vslice_dummy_var_58 := __HAVOC_malloc(4);
    ...
    call {:si_unique_call 732} Tmp_273 := corral_nondet();
    goto anon5_Then, anon5_Else;

  anon5_Else:
    call {:si_unique_call 733} Tmp_274 := corral_nondet();
    goto anon6_Then, anon6_Else;

  anon6_Else:
    call {:si_unique_call 734} Tmp_268 := corral_nondet();
    assume pfnWppTraceMessage == 0;
    goto L6;

  L6:
    call {:si_unique_call 735} vslice_dummy_var_57 := corral_nondet();
    return;
...
implementation {:origName "MouseClassCleanup"} MouseClassCleanup(actual_DeviceObject_24: int, actual_Irp_13: int) returns (Tmp_283: int)
{
  ...
  anon0:
    ...
    havoc Tmp_289;
    havoc Tmp_287;
    call {:si_unique_call 736} WPP_RECORDER_SF_(Tmp_287, 0, 3, 17, Tmp_289);
    assume {:nonnull} DeviceObject_24 != 0;
    assume DeviceObject_24 > 0;
    havoc deviceExtension_2;
    call {:si_unique_call 737} irpSp_2 := sdv_IoGetCurrentIrpStackLocation(Irp_13);
  ...
  anon9_Else:
    ...
    call {:si_unique_call 738} MouseClassCleanupQueue(DeviceObject_24, deviceExtension_2, vslice_dummy_var_125);
    goto L20;
  ...
  anon10_Else:
    ...
    assume SLAM_guard_S_0 != SLAM_guard_S_0_init;
    call {:si_unique_call 739} SLIC_sdv_IoCompleteRequest_entry(strConst__li2bpl4);
    goto anon11_Then, anon11_Else;
  ...
  L41:
    ...
    havoc Tmp_285;
    havoc Tmp_284;
    call {:si_unique_call 741} WPP_RECORDER_SF_(Tmp_284, 0, 3, 18, Tmp_285);
    Tmp_283 := 0;
    call {:si_unique_call 742} SLIC_MouseClassCleanup_exit(strConst__li2bpl0, Tmp_283);
    goto anon12_Then, anon12_Else;
...
implementation {:origName "MouseClassSystemControl"} MouseClassSystemControl(actual_DeviceObject_25: int, actual_Irp_14: int) returns (Tmp_290: int)
{
  ...
  anon0:
    call {:si_unique_call 743} disposition := __HAVOC_malloc(4);
    ...
    call {:si_unique_call 745} status_12 := sdv_IoAcquireRemoveLock(0, 0);
    goto anon25_Then, anon25_Else;

  anon25_Else:
    assume {:partition} status_12 >= 0;
    call {:si_unique_call 746} status_12 := WmiSystemControl(0, 0, Irp_14, disposition);
  ...
  L28:
    call {:si_unique_call 747} status_12 := MouseClassPassThrough(DeviceObject_25, Irp_14);
  ...
  L33:
    ...
    call {:si_unique_call 748} vslice_dummy_var_59 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(deviceExtension_3), Irp_14);
    Tmp_290 := status_12;
    goto L1;

  L1:
    call {:si_unique_call 749} SLIC_MouseClassSystemControl_exit(strConst__li2bpl0, Tmp_290);
  ...
  anon28_Then:
    call {:si_unique_call 750} status_12 := MouseClassPassThrough(DeviceObject_25, Irp_14);
  ...
  anon27_Else:
    ...
    assume SLAM_guard_S_0 != SLAM_guard_S_0_init;
    call {:si_unique_call 751} SLIC_sdv_IoCompleteRequest_entry(strConst__li2bpl4);
  ...
  L54:
    call {:si_unique_call 752} sdv_IoCompleteRequest(0, 0);
    goto L33;
  ...
  anon35_Else:
    assume Irp_14 == SLAM_guard_S_0;
    assume SLAM_guard_S_0 != SLAM_guard_S_0_init;
    call {:si_unique_call 753} SLIC_sdv_IoCompleteRequest_entry(strConst__li2bpl4);
  ...
  L57:
    call {:si_unique_call 754} sdv_IoCompleteRequest(0, 0);
    Tmp_290 := status_12;
    goto L1;
...
implementation {:origName "MouInitializeDataQueue"} MouInitializeDataQueue(actual_Context_13: int)
{
  ...
  anon0:
    call {:si_unique_call 755} vslice_dummy_var_60 := __HAVOC_malloc(4);
    Context_13 := actual_Context_13;
    havoc Tmp_292;
    havoc Tmp_296;
    call {:si_unique_call 756} WPP_RECORDER_SF_(Tmp_296, 0, 4, 84, Tmp_292);
    deviceExtension_4 := Context_13;
    call {:si_unique_call 757} Tmp_293 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_293 != 0;
    assume Tmp_293 > 0;
    call {:si_unique_call 758} sdv_KeAcquireSpinLock(0, Tmp_293);
    assume {:nonnull} Tmp_293 != 0;
    assume Tmp_293 > 0;
    havoc oldIrql_1;
    ...
    assume {:nonnull} deviceExtension_4 != 0;
    assume deviceExtension_4 > 0;
    call {:si_unique_call 759} sdv_KeReleaseSpinLock(0, oldIrql_1);
    havoc Tmp_297;
    havoc Tmp_294;
    call {:si_unique_call 760} WPP_RECORDER_SF_(Tmp_294, 0, 4, 85, Tmp_297);
    return;
}
...
implementation {:origName "WPP_RECORDER_SF_qq"} WPP_RECORDER_SF_qq(actual_AutoLogContext_3: int, actual_level_3: int, actual_flags_3: int, actual_id_3: int, actual_traceGuid_3: int, actual_s_p_e_c_i_a_l_6: int, actual_s_p_e_c_i_a_l_7: int)
{
  ...
  anon0:
    call {:si_unique_call 761} vslice_dummy_var_61 := __HAVOC_malloc(4);
    level_3 := actual_level_3;
    flags_3 := actual_flags_3;
    traceGuid_3 := actual_traceGuid_3;
    call {:si_unique_call 762} vslice_dummy_var_63 := __HAVOC_malloc(4);
    ...
    call {:si_unique_call 763} Tmp_303 := corral_nondet();
    goto anon5_Then, anon5_Else;

  anon5_Else:
    call {:si_unique_call 764} Tmp_306 := corral_nondet();
    goto anon6_Then, anon6_Else;

  anon6_Else:
    call {:si_unique_call 765} Tmp_300 := corral_nondet();
    assume pfnWppTraceMessage == 0;
    goto L6;

  L6:
    call {:si_unique_call 766} vslice_dummy_var_62 := corral_nondet();
    return;
...
implementation {:origName "MouseClassCheckWaitWakeEnabled"} MouseClassCheckWaitWakeEnabled(actual_Data_4: int) returns (Tmp_319: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 767} Tmp_320 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_320 != 0;
    assume Tmp_320 > 0;
    call {:si_unique_call 768} sdv_KeAcquireSpinLock(0, Tmp_320);
    assume {:nonnull} Tmp_320 != 0;
    assume Tmp_320 > 0;
    havoc irql_3;
    ...
    assume Data_4 > 0;
    havoc enabled_2;
    call {:si_unique_call 769} sdv_KeReleaseSpinLock(0, irql_3);
    Tmp_319 := enabled_2;
    return;
}
...
implementation {:origName "MouseClassGetWaitWakeEnableState"} MouseClassGetWaitWakeEnableState(actual_Data_5: int)
{
  ...
  anon0:
    call {:si_unique_call 770} sysPowerCaps := __HAVOC_malloc(124);
    call {:si_unique_call 771} osVerInfo := __HAVOC_malloc(44);
    call {:si_unique_call 772} vslice_dummy_var_64 := __HAVOC_malloc(4);
    call {:si_unique_call 773} tmp_1 := __HAVOC_malloc(4);
    Data_5 := actual_Data_5;
    call {:si_unique_call 774} Tmp_324 := __HAVOC_malloc(64);
    call {:si_unique_call 775} sdv_do_paged_code_check();
    hKey := 0;
    wwEnableFound := 0;
    call {:si_unique_call 776} status_15 := IoOpenDeviceRegistryKey(0, 1, 2031616, 0);
    goto anon23_Then, anon23_Else;

  anon23_Else:
    assume {:partition} status_15 >= 0;
    Tmp_324 := strConst__li2bpl5;
    call {:si_unique_call 777} status_15 := MouseQueryDeviceKey(hKey, Tmp_324, tmp_1, 4);
    goto anon25_Then, anon25_Else;
  ...
  L23:
    call {:si_unique_call 778} vslice_dummy_var_65 := ZwClose(0);
    hKey := 0;
    goto L17;
  ...
  anon26_Else:
    mask := 0;
    call {:si_unique_call 779} sdv_RtlZeroMemory(0, 284);
    assume {:nonnull} osVerInfo != 0;
    assume osVerInfo > 0;
    assume {:nonnull} osVerInfo != 0;
    assume osVerInfo > 0;
    call {:si_unique_call 780} mask := VerSetConditionMask(mask, 128, 1);
    call {:si_unique_call 781} sdv_174 := RtlVerifyVersionInfo(0, 128, mask);
    goto anon27_Then, anon27_Else;

  anon27_Else:
    assume {:partition} sdv_174 >= 0;
    call {:si_unique_call 782} sdv_RtlZeroMemory(0, 76);
    call {:si_unique_call 783} status_15 := ZwPowerInformation(4, 0, 0, 0, 76);
    goto anon28_Then, anon28_Else;
...
implementation {:origName "InitializeListHead"} InitializeListHead(actual_ListHead_2: int)
{
  ...
  anon0:
    call {:si_unique_call 784} vslice_dummy_var_66 := __HAVOC_malloc(4);
...
implementation {:origName "WPP_RECORDER_SF_qd"} WPP_RECORDER_SF_qd(actual_AutoLogContext_4: int, actual_level_4: int, actual_flags_4: int, actual_id_4: int, actual_traceGuid_4: int, actual_s_p_e_c_i_a_l_8: int, actual_s_p_e_c_i_a_l_9: int)
{
  ...
  anon0:
    call {:si_unique_call 785} vslice_dummy_var_67 := __HAVOC_malloc(4);
    level_4 := actual_level_4;
    flags_4 := actual_flags_4;
    traceGuid_4 := actual_traceGuid_4;
    call {:si_unique_call 786} vslice_dummy_var_69 := __HAVOC_malloc(4);
    ...
    call {:si_unique_call 787} Tmp_329 := corral_nondet();
    goto anon5_Then, anon5_Else;

  anon5_Else:
    call {:si_unique_call 788} Tmp_333 := corral_nondet();
    goto anon6_Then, anon6_Else;

  anon6_Else:
    call {:si_unique_call 789} Tmp_335 := corral_nondet();
    assume pfnWppTraceMessage == 0;
    goto L6;

  L6:
    call {:si_unique_call 790} vslice_dummy_var_68 := corral_nondet();
    return;
...
implementation {:origName "MouseClassReadCopyData"} MouseClassReadCopyData(actual_DeviceExtension_1: int, actual_Irp_18: int) returns (Tmp_340: int)
{
  ...
  anon0:
    ...
    assume {:nonnull} DeviceExtension_1 != 0;
    assume DeviceExtension_1 > 0;
    call {:si_unique_call 791} irpSp_3 := sdv_IoGetCurrentIrpStackLocation(Irp_18);
    assume {:nonnull} DeviceExtension_1 != 0;
    assume DeviceExtension_1 > 0;
    havoc bytesInQueue;
    ...
    havoc Tmp_342;
    havoc Tmp_349;
    call {:si_unique_call 792} WPP_RECORDER_SF_LL(Tmp_349, 0, 4, 32, Tmp_342, bytesInQueue, bytesToMove);
    goto anon9_Then, anon9_Else;
  ...
  L32:
    ...
    havoc Tmp_353;
    havoc Tmp_358;
    call {:si_unique_call 793} WPP_RECORDER_SF_L(Tmp_358, 0, 4, 33, Tmp_353, bytesInQueue);
    assume {:nonnull} Irp_18 != 0;
    assume Irp_18 > 0;
    havoc destination;
    havoc Tmp_359;
    havoc Tmp_361;
    call {:si_unique_call 794} WPP_RECORDER_SF_L(Tmp_361, 0, 4, 34, Tmp_359, moveSize);
    assume {:nonnull} DeviceExtension_1 != 0;
    assume DeviceExtension_1 > 0;
    havoc Tmp_348;
    havoc Tmp_365;
    havoc Tmp_344;
    call {:si_unique_call 795} WPP_RECORDER_SF_qq(Tmp_344, 0, 4, 35, Tmp_365, Tmp_348, destination);
    assume {:nonnull} DeviceExtension_1 != 0;
    assume DeviceExtension_1 > 0;
    call {:si_unique_call 796} sdv_RtlMoveMemory(0, 0, moveSize);
    goto anon11_Then, anon11_Else;
  ...
  anon11_Else:
    ...
    havoc Tmp_343;
    havoc Tmp_347;
    call {:si_unique_call 797} WPP_RECORDER_SF_L(Tmp_347, 0, 4, 36, Tmp_343, moveSize);
    assume {:nonnull} DeviceExtension_1 != 0;
    assume DeviceExtension_1 > 0;
    havoc Tmp_351;
    havoc Tmp_360;
    havoc Tmp_352;
    call {:si_unique_call 798} WPP_RECORDER_SF_qq(Tmp_352, 0, 4, 37, Tmp_360, Tmp_351, destination);
    assume {:nonnull} DeviceExtension_1 != 0;
    assume DeviceExtension_1 > 0;
    call {:si_unique_call 799} sdv_RtlMoveMemory(0, 0, moveSize);
    assume {:nonnull} DeviceExtension_1 != 0;
    assume DeviceExtension_1 > 0;
    goto L94;
  ...
  anon12_Else:
    havoc Tmp_345;
    havoc Tmp_346;
    call {:si_unique_call 800} WPP_RECORDER_SF_(Tmp_346, 0, 2, 38, Tmp_345);
    assume {:nonnull} DeviceExtension_1 != 0;
    assume DeviceExtension_1 > 0;
    goto L106;
  ...
  L106:
    ...
    call {:si_unique_call 801} WPP_RECORDER_SF_qq(Tmp_356, 0, 4, 39, Tmp_350, vslice_dummy_var_126, vslice_dummy_var_127);
    havoc Tmp_341;
    havoc Tmp_364;
    assume {:nonnull} DeviceExtension_1 != 0;
    assume DeviceExtension_1 > 0;
    havoc vslice_dummy_var_128;
    call {:si_unique_call 802} WPP_RECORDER_SF_l(Tmp_364, 0, 4, 40, Tmp_341, vslice_dummy_var_128);
    assume {:nonnull} Irp_18 != 0;
    assume Irp_18 > 0;
    assume {:nonnull} irpSp_3 != 0;
    assume irpSp_3 > 0;
...
implementation {:origName "MouseClassHandleRead"} MouseClassHandleRead(actual_DeviceExtension_2: int, actual_Irp_19: int) returns (Tmp_366: int)
{
  ...
  anon0:
    ...
    status_17 := 259;
    completeIrp := 0;
    call {:si_unique_call 803} Tmp_371 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_371 != 0;
    assume Tmp_371 > 0;
    call {:si_unique_call 804} sdv_KeAcquireSpinLock(0, Tmp_371);
    assume {:nonnull} Tmp_371 != 0;
    assume Tmp_371 > 0;
    havoc irql_4;
  ...
  anon15_Else:
    call {:si_unique_call 805} status_17 := MouseClassReadCopyData(DeviceExtension_2, Irp_19);
  ...
  L22:
    call {:si_unique_call 806} sdv_KeReleaseSpinLock(0, irql_4);
  ...
  anon16_Else:
    ...
    assume {:nonnull} DeviceExtension_2 != 0;
    assume DeviceExtension_2 > 0;
    call {:si_unique_call 807} vslice_dummy_var_71 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(DeviceExtension_2), Irp_19);
    goto anon17_Then, anon17_Else;

  anon17_Else:
    assume Irp_19 == SLAM_guard_S_0;
    assume SLAM_guard_S_0 != SLAM_guard_S_0_init;
    call {:si_unique_call 808} SLIC_sdv_IoCompleteRequest_entry(strConst__li2bpl4);
    goto anon21_Then, anon21_Else;
  ...
  anon15_Then:
    ...
    assume {:nonnull} Irp_19 != 0;
    assume Irp_19 > 0;
    call {:si_unique_call 810} vslice_dummy_var_70 := sdv_InsertTailList(ReadQueue__DEVICE_EXTENSION(DeviceExtension_2), ListEntry_unnamed_tag_6(Overlay_unnamed_tag_5(Tail__IRP(Irp_19))));
    call {:si_unique_call 811} oldCancelRoutine_1 := sdv_IoSetCancelRoutine(Irp_19, li2bplFunctionConstant979);
    assume {:nonnull} Irp_19 != 0;
    assume Irp_19 > 0;
    goto anon18_Then, anon18_Else;

  anon18_Else:
    call {:si_unique_call 812} oldCancelRoutine_1 := sdv_IoSetCancelRoutine(Irp_19, 0);
  ...
  anon20_Else:
    ...
    havoc Tmp_369;
    havoc Tmp_370;
    call {:si_unique_call 813} WPP_RECORDER_SF_(Tmp_370, 0, 1, 42, Tmp_369);
    goto L38;
  ...
  anon20_Then:
    assume {:partition} oldCancelRoutine_1 != 0;
    call {:si_unique_call 815} vslice_dummy_var_72 := sdv_RemoveEntryList(0);
    assume {:nonnull} Irp_19 != 0;
    assume Irp_19 > 0;
    assume {:nonnull} Irp_19 != 0;
    assume Irp_19 > 0;
    ...
    havoc Tmp_367;
    havoc Tmp_368;
    call {:si_unique_call 816} WPP_RECORDER_SF_(Tmp_368, 0, 1, 41, Tmp_367);
    goto L38;
...
implementation {:origName "WPP_RECORDER_SF_"} WPP_RECORDER_SF_(actual_AutoLogContext_5: int, actual_level_5: int, actual_flags_5: int, actual_id_5: int, actual_traceGuid_5: int)
{
  ...
  anon0:
    call {:si_unique_call 817} vslice_dummy_var_73 := __HAVOC_malloc(4);
    level_5 := actual_level_5;
    flags_5 := actual_flags_5;
    traceGuid_5 := actual_traceGuid_5;
    call {:si_unique_call 818} vslice_dummy_var_75 := __HAVOC_malloc(4);
    ...
    call {:si_unique_call 819} Tmp_376 := corral_nondet();
    goto anon5_Then, anon5_Else;

  anon5_Else:
    call {:si_unique_call 820} Tmp_384 := corral_nondet();
    goto anon6_Then, anon6_Else;

  anon6_Else:
    call {:si_unique_call 821} Tmp_374 := corral_nondet();
    assume pfnWppTraceMessage == 0;
    goto L6;

  L6:
    call {:si_unique_call 822} vslice_dummy_var_74 := corral_nondet();
    return;
...
implementation {:origName "MouseClassPower"} MouseClassPower(actual_DeviceObject_28: int, actual_Irp_20: int) returns (Tmp_387: int)
{
  ...
  anon0:
    call {:si_unique_call 823} powerState_3 := __HAVOC_malloc(8);
    call {:si_unique_call 824} sdv := __HAVOC_malloc(8);
    DeviceObject_28 := actual_DeviceObject_28;
    Irp_20 := actual_Irp_20;
    call {:si_unique_call 825} Tmp_394 := __HAVOC_malloc(20);
    hookit := 0;
    pendit := 0;
    releaseRemoveLock := 1;
    ...
    havoc data_4;
    call {:si_unique_call 827} stack_4 := sdv_IoGetCurrentIrpStackLocation(Irp_20);
  ...
  anon123_Else:
    call {:si_unique_call 828} PoStartNextPowerIrp(0);
  ...
  anon124_Else:
    ...
    assume SLAM_guard_S_0 != SLAM_guard_S_0_init;
    call {:si_unique_call 829} SLIC_sdv_IoCompleteRequest_entry(strConst__li2bpl4);
    goto anon125_Then, anon125_Else;
  ...
  L1:
    call {:si_unique_call 831} SLIC_MouseClassPower_exit(strConst__li2bpl0, Tmp_387);
    goto anon126_Then, anon126_Else;
  ...
  anon93_Else:
    call {:si_unique_call 832} status_19 := sdv_IoAcquireRemoveLock(0, 0);
  ...
  anon100_Else:
    ...
    call {:si_unique_call 833} status_19 := sdv_IoAcquireRemoveLock(0, 0);
    call {:si_unique_call 834} sdv_IoCopyCurrentIrpStackLocationToNext(Irp_20);
    call {:si_unique_call 835} sdv_IoSetCompletionRoutine(Irp_20, li2bplFunctionConstant1012, 0, 1, 1, 1);
    goto anon122_Then, anon122_Else;

  anon122_Else:
    assume Irp_20 == SLAM_guard_S_0;
    assume SLAM_guard_S_0 != SLAM_guard_S_0_init;
    call {:si_unique_call 836} SLIC_sdv_IoSetCompletionRoutine_exit(0);
    goto L77;

  L77:
    call {:si_unique_call 837} sdv_IoMarkIrpPending(0);
    call {:si_unique_call 838} vslice_dummy_var_76 := PoCallDriver#1(0, Irp_20);
    goto anon127_Then, anon127_Else;
  ...
  anon102_Else:
    ...
    assume {:nonnull} data_4 != 0;
    assume data_4 > 0;
    call {:si_unique_call 839} vslice_dummy_var_77 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(data_4), Irp_20);
    goto L85;
  ...
  anon101_Then:
    ...
    call {:si_unique_call 841} sdv_IoSkipCurrentIrpStackLocation(Irp_20);
    call {:si_unique_call 842} status_19 := PoCallDriver#1(0, Irp_20);
    goto anon128_Then, anon128_Else;
  ...
  anon103_Else:
    assume Irp_20 == SLAM_guard_S_0;
    assume SLAM_guard_S_0 != SLAM_guard_S_0_init;
    call {:si_unique_call 844} SLIC_sdv_IoCompleteRequest_entry(strConst__li2bpl4);
    goto anon129_Then, anon129_Else;
  ...
  anon97_Else:
    assume {:nonnull} data_4 != 0;
    assume data_4 > 0;
    call {:si_unique_call 846} sdv_197 := _InlineInterlockedCompareExchangePointer(WaitWakeIrp__DEVICE_EXTENSION(data_4), 0, 0);
  ...
  L111:
    ...
    call {:si_unique_call 847} WPP_RECORDER_SF_sd(Tmp_390, 0, 3, 92, Tmp_388, Tmp_389, vslice_dummy_var_129);
    goto anon104_Then, anon104_Else;
  ...
  anon134_Else:
    call {:si_unique_call 848} structPtr888sdv := PoSetPowerState(0, powerType_1, powerState_3);
  ...
  anon106_Else:
    call {:si_unique_call 849} status_19 := sdv_IoAcquireRemoveLock(0, 0);
    goto anon109_Then, anon109_Else;
  ...
  anon109_Else:
    ...
    assume {:nonnull} data_4 != 0;
    assume data_4 > 0;
    call {:si_unique_call 850} sdv_193 := _InlineInterlockedCompareExchangePointer(WaitWakeIrp__DEVICE_EXTENSION(data_4), 0, 0);
    goto anon110_Then, anon110_Else;
  ...
  L142:
    ...
    call {:si_unique_call 852} status_19 := PoRequestPowerIrp#1(vslice_dummy_var_130, 2, powerState_3, li2bplFunctionConstant1013, Irp_20, 0);
    goto anon130_Then, anon130_Else;
  ...
  anon112_Then:
    ...
    assume {:nonnull} data_4 != 0;
    assume data_4 > 0;
    call {:si_unique_call 853} vslice_dummy_var_78 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(data_4), Irp_20);
  ...
  anon131_Else:
    assume Irp_20 == SLAM_guard_S_0;
    assume SLAM_guard_S_0 != SLAM_guard_S_0_init;
    call {:si_unique_call 855} SLIC_sdv_IoCompleteRequest_entry(strConst__li2bpl4);
    goto anon132_Then, anon132_Else;
  ...
  L249:
    ...
    assume {:nonnull} data_4 != 0;
    assume data_4 > 0;
    call {:si_unique_call 857} vslice_dummy_var_79 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(data_4), Irp_20);
    Tmp_387 := 259;
    goto L1;
  ...
  anon115_Else:
    assume {:nonnull} data_4 != 0;
    assume data_4 > 0;
    call {:si_unique_call 858} sdv_196 := _InlineInterlockedCompareExchangePointer(WaitWakeIrp__DEVICE_EXTENSION(data_4), 0, 0);
    goto anon116_Then, anon116_Else;

  anon116_Else:
    assume {:partition} sdv_196 == 0;
    call {:si_unique_call 859} sdv_189 := MouseClassCheckWaitWakeEnabled(data_4);
    goto anon117_Then, anon117_Else;

  anon117_Else:
    assume {:partition} sdv_189 != 0;
    call {:si_unique_call 860} vslice_dummy_var_80 := MouseClassCreateWaitWakeIrp#1(data_4);
    goto anon133_Then, anon133_Else;
  ...
  anon105_Then:
    assume {:partition} powerType_1 == 0;
    Tmp_389 := strConst__li2bpl6;
    goto L111;

  anon95_Then:
    havoc Tmp_393;
    havoc Tmp_392;
    call {:si_unique_call 861} WPP_RECORDER_SF_q(Tmp_392, 0, 3, 93, Tmp_393, Irp_20);
    releaseRemoveLock := 0;
    assume {:nonnull} data_4 != 0;
    assume data_4 > 0;
    call {:si_unique_call 862} sdv_200 := _InlineInterlockedCompareExchangePointer(WaitWakeIrp__DEVICE_EXTENSION(data_4), Irp_20, 0);
    goto anon118_Then, anon118_Else;
  ...
  anon118_Else:
    ...
    assume {:nonnull} data_4 != 0;
    assume data_4 > 0;
    call {:si_unique_call 863} vslice_dummy_var_82 := _InlineInterlockedExchangePointer(ExtraWaitWakeIrp__DEVICE_EXTENSION(data_4), Irp_20);
    assume {:nonnull} data_4 != 0;
    assume data_4 > 0;
    call {:si_unique_call 864} vslice_dummy_var_83 := _InlineInterlockedExchangePointer(ExtraWWIrpTag__DEVICE_EXTENSION(data_4), Irp_20);
  ...
  anon118_Then:
    ...
    assume {:nonnull} data_4 != 0;
    assume data_4 > 0;
    call {:si_unique_call 865} vslice_dummy_var_81 := _InlineInterlockedExchangePointer(WWIrpTag__DEVICE_EXTENSION(data_4), Irp_20);
    status_19 := 0;
    goto L63;

  anon94_Then:
    assume {:partition} 0 > status_19;
    call {:si_unique_call 866} PoStartNextPowerIrp(0);
    assume {:nonnull} Irp_20 != 0;
    assume Irp_20 > 0;
    goto anon135_Then, anon135_Else;
  ...
  anon135_Else:
    assume Irp_20 == SLAM_guard_S_0;
    assume SLAM_guard_S_0 != SLAM_guard_S_0_init;
    call {:si_unique_call 867} SLIC_sdv_IoCompleteRequest_entry(strConst__li2bpl4);
    goto anon136_Then, anon136_Else;
  ...
  anon93_Then:
    call {:si_unique_call 869} PoStartNextPowerIrp(0);
    assume {:nonnull} Irp_20 != 0;
    assume Irp_20 > 0;
    goto anon137_Then, anon137_Else;
  ...
  anon137_Else:
    assume Irp_20 == SLAM_guard_S_0;
    assume SLAM_guard_S_0 != SLAM_guard_S_0_init;
    call {:si_unique_call 870} SLIC_sdv_IoCompleteRequest_entry(strConst__li2bpl4);
    goto anon138_Then, anon138_Else;
...
implementation {:origName "RtlConvertLongToLuid"} RtlConvertLongToLuid(actual_Long: int) returns (structPtr888Tmp: int)
{
  ...
  anon0:
    call {:si_unique_call 874} Tmp := __HAVOC_malloc(8);
    call {:si_unique_call 875} TempLi := __HAVOC_malloc(20);
    call {:si_unique_call 876} TempLuid := __HAVOC_malloc(8);
    Long := actual_Long;
...
implementation {:origName "WPP_RECORDER_SF_l"} WPP_RECORDER_SF_l(actual_AutoLogContext_6: int, actual_level_6: int, actual_flags_6: int, actual_id_6: int, actual_traceGuid_6: int, actual_s_p_e_c_i_a_l_10: int)
{
  ...
  anon0:
    call {:si_unique_call 877} vslice_dummy_var_85 := __HAVOC_malloc(4);
    level_6 := actual_level_6;
    flags_6 := actual_flags_6;
    traceGuid_6 := actual_traceGuid_6;
    call {:si_unique_call 878} vslice_dummy_var_87 := __HAVOC_malloc(4);
    ...
    call {:si_unique_call 879} Tmp_409 := corral_nondet();
    goto anon5_Then, anon5_Else;

  anon5_Else:
    call {:si_unique_call 880} Tmp_405 := corral_nondet();
    goto anon6_Then, anon6_Else;

  anon6_Else:
    call {:si_unique_call 881} Tmp_404 := corral_nondet();
    assume pfnWppTraceMessage == 0;
    goto L6;

  L6:
    call {:si_unique_call 882} vslice_dummy_var_86 := corral_nondet();
    return;
...
implementation {:origName "WPP_RECORDER_SF_sd"} WPP_RECORDER_SF_sd(actual_AutoLogContext_7: int, actual_level_7: int, actual_flags_7: int, actual_id_7: int, actual_traceGuid_7: int, actual_s_p_e_c_i_a_l_11: int, actual_s_p_e_c_i_a_l_12: int)
{
  ...
  anon0:
    call {:si_unique_call 883} vslice_dummy_var_88 := __HAVOC_malloc(4);
    level_7 := actual_level_7;
    flags_7 := actual_flags_7;
    traceGuid_7 := actual_traceGuid_7;
    s_p_e_c_i_a_l_11 := actual_s_p_e_c_i_a_l_11;
    call {:si_unique_call 884} vslice_dummy_var_90 := __HAVOC_malloc(4);
    ...
    call {:si_unique_call 885} Tmp_413 := corral_nondet();
    goto anon17_Then, anon17_Else;

  anon17_Else:
    call {:si_unique_call 886} Tmp_415 := corral_nondet();
    goto anon18_Then, anon18_Else;
  ...
  L17:
    call {:si_unique_call 887} Tmp_425 := corral_nondet();
    assume pfnWppTraceMessage == 0;
    goto L6;
  ...
  L30:
    call {:si_unique_call 888} vslice_dummy_var_89 := corral_nondet();
    return;
...
implementation {:origName "MouseClassRead"} MouseClassRead(actual_Device: int, actual_Irp_22: int) returns (Tmp_431: int)
{
  ...
  anon0:
    ...
    havoc Tmp_432;
    havoc Tmp_434;
    call {:si_unique_call 889} WPP_RECORDER_SF_(Tmp_434, 0, 3, 43, Tmp_432);
    call {:si_unique_call 890} irpSp_4 := sdv_IoGetCurrentIrpStackLocation(Irp_22);
  ...
  anon26_Else:
    ...
    call {:si_unique_call 891} Tmp_431 := MouseClassHandleRead(deviceExtension_5, Irp_22);
    goto anon27_Then, anon27_Else;
  ...
  L1:
    call {:si_unique_call 892} SLIC_MouseClassRead_exit(strConst__li2bpl0, Tmp_431);
    goto anon28_Then, anon28_Else;
  ...
  anon23_Else:
    ...
    assume SLAM_guard_S_0 != SLAM_guard_S_0_init;
    call {:si_unique_call 893} SLIC_sdv_IoCompleteRequest_entry(strConst__li2bpl4);
    goto anon29_Then, anon29_Else;
  ...
  L58:
    ...
    havoc Tmp_435;
    havoc Tmp_437;
    call {:si_unique_call 895} WPP_RECORDER_SF_(Tmp_437, 0, 3, 44, Tmp_435);
    Tmp_431 := status_21;
    goto L1;
  ...
  anon30_Else:
    ...
    assume Device > 0;
    havoc deviceExtension_5;
    call {:si_unique_call 896} status_21 := sdv_IoAcquireRemoveLock(0, 0);
    goto anon24_Then, anon24_Else;
...
implementation {:origName "WPP_RECORDER_SF_L"} WPP_RECORDER_SF_L(actual_AutoLogContext_8: int, actual_level_8: int, actual_flags_8: int, actual_id_8: int, actual_traceGuid_8: int, actual_s_p_e_c_i_a_l_13: int)
{
  ...
  anon0:
    call {:si_unique_call 897} vslice_dummy_var_91 := __HAVOC_malloc(4);
    level_8 := actual_level_8;
    flags_8 := actual_flags_8;
    traceGuid_8 := actual_traceGuid_8;
    call {:si_unique_call 898} vslice_dummy_var_93 := __HAVOC_malloc(4);
    ...
    call {:si_unique_call 899} Tmp_439 := corral_nondet();
    goto anon5_Then, anon5_Else;

  anon5_Else:
    call {:si_unique_call 900} Tmp_443 := corral_nondet();
    goto anon6_Then, anon6_Else;

  anon6_Else:
    call {:si_unique_call 901} Tmp_445 := corral_nondet();
    assume pfnWppTraceMessage == 0;
    goto L6;

  L6:
    call {:si_unique_call 902} vslice_dummy_var_92 := corral_nondet();
    return;
...
implementation {:origName "MousePnP"} MousePnP(actual_DeviceObject_31: int, actual_Irp_23: int) returns (Tmp_449: int)
{
  ...
  anon0:
    call {:si_unique_call 903} worker := __HAVOC_malloc(8);
    ...
    havoc data_6;
    call {:si_unique_call 904} stack_6 := sdv_IoGetCurrentIrpStackLocation(Irp_23);
    assume {:nonnull} data_6 != 0;
    assume data_6 > 0;
    goto anon97_Then, anon97_Else;

  anon97_Else:
    call {:si_unique_call 905} status_22 := sdv_IoAcquireRemoveLock(0, 0);
    goto anon98_Then, anon98_Else;
  ...
  anon109_Else:
    call {:si_unique_call 906} MouseClassRemoveDevice(data_6, 1);
    call {:si_unique_call 907} sdv_IoSkipCurrentIrpStackLocation(Irp_23);
    assume {:nonnull} data_6 != 0;
    assume data_6 > 0;
    havoc vslice_dummy_var_131;
    call {:si_unique_call 908} status_22 := sdv_IoCallDriver#1(vslice_dummy_var_131, Irp_23);
    goto anon140_Then, anon140_Else;
  ...
  L48:
    assume {:nonnull} data_6 != 0;
    assume data_6 > 0;
    call {:si_unique_call 909} vslice_dummy_var_94 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(data_6), Irp_23);
    Tmp_449 := status_22;
    goto L1;

  L1:
    call {:si_unique_call 910} SLIC_MousePnP_exit(strConst__li2bpl0, Tmp_449);
    goto anon134_Then, anon134_Else;
  ...
  L27:
    call {:si_unique_call 911} sdv_IoCopyCurrentIrpStackLocationToNext(Irp_23);
    assume {:nonnull} data_6 != 0;
    assume data_6 > 0;
    havoc vslice_dummy_var_132;
    call {:si_unique_call 912} status_22 := sdv_IoCallDriver#1(vslice_dummy_var_132, Irp_23);
    goto anon135_Then, anon135_Else;
  ...
  anon103_Else:
    ...
    assume {:nonnull} data_6 != 0;
    assume data_6 > 0;
    call {:si_unique_call 915} notifyHandle_2 := _InlineInterlockedExchangePointer(TargetNotifyHandle__DEVICE_EXTENSION(data_6), 0);
    goto anon104_Then, anon104_Else;

  anon104_Else:
    assume {:partition} notifyHandle_2 != 0;
    call {:si_unique_call 916} vslice_dummy_var_95 := IoUnregisterPlugPlayNotification(0);
    goto L77;

  L77:
    call {:si_unique_call 917} status_22 := MouEnableDisablePort#1(0, 0, data_6, file_1);
    goto anon138_Then, anon138_Else;
  ...
  L52:
    assume {:nonnull} data_6 != 0;
    assume data_6 > 0;
    call {:si_unique_call 918} sdv_IoSkipCurrentIrpStackLocation(Irp_23);
    assume {:nonnull} data_6 != 0;
    assume data_6 > 0;
    havoc vslice_dummy_var_133;
    call {:si_unique_call 919} status_22 := sdv_IoCallDriver#1(vslice_dummy_var_133, Irp_23);
    goto anon139_Then, anon139_Else;
  ...
  anon125_Then:
    call {:si_unique_call 922} MouseClassRemoveDevice(data_6, 0);
    call {:si_unique_call 923} sdv_IoReleaseRemoveLockAndWait(0, 0);
    call {:si_unique_call 924} sdv_IoCopyCurrentIrpStackLocationToNext(Irp_23);
    assume {:nonnull} data_6 != 0;
    assume data_6 > 0;
    havoc vslice_dummy_var_134;
    call {:si_unique_call 925} status_22 := sdv_IoCallDriver#1(vslice_dummy_var_134, Irp_23);
    goto anon136_Then, anon136_Else;

  anon136_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 926} ExAcquireFastMutex(0);
    goto anon105_Then, anon105_Else;
  ...
  L117:
    call {:si_unique_call 928} IoDetachDevice(0);
  ...
  anon105_Then:
    call {:si_unique_call 933} ExReleaseFastMutex(0);
    goto L117;
  ...
  anon99_Then:
    call {:si_unique_call 934} sdv_232 := ExAllocatePoolWithTag(512, 8, -1016105651);
    item_3 := sdv_232;
    goto anon128_Then, anon128_Else;

  anon128_Else:
    assume {:partition} item_3 != 0;
    call {:si_unique_call 935} sdv_RtlZeroMemory(0, 8);
    assume {:nonnull} item_3 != 0;
    assume item_3 > 0;
    call {:si_unique_call 936} boogieTmp := IoAllocateWorkItem(0);
    assume {:nonnull} item_3 != 0;
    assume item_3 > 0;
    goto anon107_Then, anon107_Else;
  ...
  anon107_Else:
    assume {:nonnull} item_3 != 0;
    assume item_3 > 0;
    call {:si_unique_call 937} vslice_dummy_var_98 := sdv_IoAcquireRemoveLock(0, 0);
    call {:si_unique_call 938} sdv_IoCopyCurrentIrpStackLocationToNext(Irp_23);
    call {:si_unique_call 939} sdv_IoSetCompletionRoutine(Irp_23, li2bplFunctionConstant1002, item_3, 1, 1, 1);
    goto anon127_Then, anon127_Else;

  anon127_Else:
    assume Irp_23 == SLAM_guard_S_0;
    assume SLAM_guard_S_0 != SLAM_guard_S_0_init;
    call {:si_unique_call 940} SLIC_sdv_IoSetCompletionRoutine_exit(0);
    goto L157;

  L157:
    status_22 := 259;
    call {:si_unique_call 941} sdv_IoMarkIrpPending(0);
    assume {:nonnull} data_6 != 0;
    assume data_6 > 0;
    havoc vslice_dummy_var_135;
    call {:si_unique_call 942} vslice_dummy_var_96 := sdv_IoCallDriver#1(vslice_dummy_var_135, Irp_23);
    goto anon129_Then, anon129_Else;
  ...
  anon108_Else:
    ...
    call {:si_unique_call 943} vslice_dummy_var_97 := MouseSendIrpSynchronously#1(vslice_dummy_var_136, Irp_23, 1);
    goto anon130_Then, anon130_Else;
  ...
  anon130_Else:
    ...
    assume {:nonnull} worker != 0;
    assume worker > 0;
    call {:si_unique_call 944} status_22 := MouseStart#1(DeviceObject_31, worker);
    goto anon131_Then, anon131_Else;
  ...
  anon132_Else:
    assume Irp_23 == SLAM_guard_S_0;
    assume SLAM_guard_S_0 != SLAM_guard_S_0_init;
    call {:si_unique_call 945} SLIC_sdv_IoCompleteRequest_entry(strConst__li2bpl4);
    goto anon133_Then, anon133_Else;
  ...
  L241:
    call {:si_unique_call 946} sdv_IoCompleteRequest(0, 0);
    goto L48;
  ...
  anon141_Else:
    assume Irp_23 == SLAM_guard_S_0;
    assume SLAM_guard_S_0 != SLAM_guard_S_0_init;
    call {:si_unique_call 947} SLIC_sdv_IoCompleteRequest_entry(strConst__li2bpl4);
    goto anon142_Then, anon142_Else;
  ...
  anon143_Else:
    assume Irp_23 == SLAM_guard_S_0;
    assume SLAM_guard_S_0 != SLAM_guard_S_0_init;
    call {:si_unique_call 949} SLIC_sdv_IoCompleteRequest_entry(strConst__li2bpl4);
    goto anon144_Then, anon144_Else;
...
implementation {:origName "MouseClassFlush"} MouseClassFlush(actual_DeviceObject_32: int, actual_Irp_24: int) returns (Tmp_455: int)
{
  ...
  anon0:
    ...
    havoc Tmp_459;
    havoc Tmp_458;
    call {:si_unique_call 951} WPP_RECORDER_SF_(Tmp_458, 0, 3, 21, Tmp_459);
    assume {:nonnull} DeviceObject_32 != 0;
    assume DeviceObject_32 > 0;
    havoc deviceExtension_6;
    call {:si_unique_call 952} irpSp_5 := sdv_IoGetCurrentIrpStackLocation(Irp_24);
  ...
  anon14_Else:
    ...
    call {:si_unique_call 953} MouInitializeDataQueue(deviceExtension_6);
    goto L25;
  ...
  anon15_Else:
    ...
    assume SLAM_guard_S_0 != SLAM_guard_S_0_init;
    call {:si_unique_call 954} SLIC_sdv_IoCompleteRequest_entry(strConst__li2bpl4);
    goto anon16_Then, anon16_Else;
  ...
  L48:
    ...
    havoc Tmp_460;
    havoc Tmp_461;
    call {:si_unique_call 956} WPP_RECORDER_SF_(Tmp_461, 0, 3, 22, Tmp_460);
    Tmp_455 := status_23;
    call {:si_unique_call 957} SLIC_MouseClassFlush_exit(strConst__li2bpl0, Tmp_455);
    goto anon17_Then, anon17_Else;
...
implementation {:origName "MouseClassCreate"} MouseClassCreate(actual_DeviceObject_34: int, actual_Irp_26: int) returns (Tmp_468: int)
{
  ...
  anon0:
    call {:si_unique_call 958} vslice_dummy_var_99 := __HAVOC_malloc(8);
    call {:si_unique_call 959} priv := __HAVOC_malloc(8);
    ...
    havoc Tmp_482;
    havoc Tmp_476;
    call {:si_unique_call 960} WPP_RECORDER_SF_(Tmp_476, 0, 3, 23, Tmp_482);
    assume {:nonnull} DeviceObject_34 != 0;
    assume DeviceObject_34 > 0;
    havoc deviceExtension_7;
    call {:si_unique_call 961} irpSp_6 := sdv_IoGetCurrentIrpStackLocation(Irp_26);
  ...
  anon62_Else:
    ...
    assume SLAM_guard_S_0 != SLAM_guard_S_0_init;
    call {:si_unique_call 962} SLIC_sdv_IoCompleteRequest_entry(strConst__li2bpl4);
    goto anon63_Then, anon63_Else;
  ...
  L183:
    call {:si_unique_call 963} sdv_IoCompleteRequest(0, 0);
    havoc Tmp_480;
    havoc Tmp_472;
    call {:si_unique_call 964} WPP_RECORDER_SF_(Tmp_472, 0, 3, 27, Tmp_480);
    Tmp_468 := status_24;
    goto L1;

  L1:
    call {:si_unique_call 965} SLIC_MouseClassCreate_exit(strConst__li2bpl0, Tmp_468);
    goto anon64_Then, anon64_Else;
  ...
  L29:
    call {:si_unique_call 966} status_24 := sdv_IoAcquireRemoveLock(0, 0);
    goto anon48_Then, anon48_Else;
  ...
  anon51_Else:
    havoc Tmp_481;
    havoc Tmp_473;
    call {:si_unique_call 967} WPP_RECORDER_SF_(Tmp_473, 0, 2, 24, Tmp_481);
    status_24 := -1073741823;
    assume {:nonnull} deviceExtension_7 != 0;
    assume deviceExtension_7 > 0;
    call {:si_unique_call 968} vslice_dummy_var_102 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(deviceExtension_7), Irp_26);
    goto L35;
  ...
  anon50_Else:
    call {:si_unique_call 969} structPtr888priv := RtlConvertLongToLuid(7);
    ...
    call {:si_unique_call 970} sdv_251 := SeSinglePrivilegeCheck(priv, vslice_dummy_var_137);
    goto anon52_Then, anon52_Else;

  anon52_Else:
    assume {:partition} sdv_251 != 0;
    call {:si_unique_call 971} Tmp_479 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_479 != 0;
    assume Tmp_479 > 0;
    call {:si_unique_call 972} sdv_KeAcquireSpinLock(0, Tmp_479);
    assume {:nonnull} Tmp_479 != 0;
    assume Tmp_479 > 0;
    havoc oldIrql_2;
    assume {:nonnull} irpSp_6 != 0;
    ...
    assume {:nonnull} deviceExtension_7 != 0;
    assume deviceExtension_7 > 0;
    call {:si_unique_call 973} sdv_KeReleaseSpinLock(0, oldIrql_2);
    goto L70;

  L70:
    call {:si_unique_call 974} ExAcquireFastMutex(0);
    goto anon53_Then, anon53_Else;
  ...
  L93:
    call {:si_unique_call 975} i_2, someEnableDisableSucceeded_1, Tmp_469, Tmp_470, port_5, enabled_5, status_24, Tmp_478 := MouseClassCreate_loop_L93(i_2, someEnableDisableSucceeded_1, Tmp_469, irpSp_6, Tmp_470, port_5, enabled_5, status_24, deviceExtension_7, Tmp_478, DeviceObject_34, Irp_26);
    goto L93_last;
  ...
  anon57_Else:
    ...
    call {:si_unique_call 977} WPP_RECORDER_SF_q(Tmp_470, 0, 1, 25, Tmp_469, vslice_dummy_var_138);
    assume {:nonnull} irpSp_6 != 0;
    assume irpSp_6 > 0;
    havoc vslice_dummy_var_139;
    call {:si_unique_call 978} MouseClassLogError(DeviceObject_34, -1073414135, 20120, status_24, 0, 0, vslice_dummy_var_139);
    assume {:nonnull} port_5 != 0;
    assume port_5 > 0;
    goto L125;
  ...
  anon56_Then:
    ...
    call {:si_unique_call 980} status_24 := MouEnableDisablePort#1(1, Irp_26, vslice_dummy_var_140, File__PORT(port_5));
    goto anon67_Then, anon67_Else;
  ...
  anon55_Then:
    call {:si_unique_call 981} ExReleaseFastMutex(0);
    goto L129;
  ...
  L130:
    assume {:nonnull} deviceExtension_7 != 0;
    assume deviceExtension_7 > 0;
    call {:si_unique_call 982} vslice_dummy_var_100 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(deviceExtension_7), Irp_26);
    goto L35;
  ...
  anon59_Else:
    assume {:nonnull} irpSp_6 != 0;
    assume irpSp_6 > 0;
    call {:si_unique_call 984} status_24 := MouEnableDisablePort#1(1, Irp_26, deviceExtension_7, FileObject__IO_STACK_LOCATION(irpSp_6));
    goto anon68_Then, anon68_Else;
  ...
  anon60_Else:
    ...
    call {:si_unique_call 985} WPP_RECORDER_SF_Dq(Tmp_474, 0, 1, 26, Tmp_477, status_24, vslice_dummy_var_141);
    goto L129;
  ...
  anon59_Then:
    call {:si_unique_call 986} sdv_IoSkipCurrentIrpStackLocation(Irp_26);
    assume {:nonnull} deviceExtension_7 != 0;
    assume deviceExtension_7 > 0;
    havoc vslice_dummy_var_142;
    call {:si_unique_call 987} status_24 := sdv_IoCallDriver#1(vslice_dummy_var_142, Irp_26);
    goto anon69_Then, anon69_Else;
  ...
  anon69_Else:
    ...
    assume {:nonnull} deviceExtension_7 != 0;
    assume deviceExtension_7 > 0;
    call {:si_unique_call 988} vslice_dummy_var_101 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(deviceExtension_7), Irp_26);
    Tmp_468 := status_24;
    goto L1;
...
implementation {:origName "MouseClassWWPowerUpComplete"} MouseClassWWPowerUpComplete#0(actual_DeviceObject_17: int, actual_MinorFunction_2: int, actual_SD1_1: int, actual_Context_7: int, actual_IoStatus_1: int)
{
  ...
  anon0:
    call {:si_unique_call 990} PowerState_1 := __HAVOC_malloc(8);
    call {:si_unique_call 991} vslice_dummy_var_103 := __HAVOC_malloc(4);
    SD1_1 := actual_SD1_1;
  ...
  anon13_Else:
    call {:si_unique_call 992} sdv_116 := ExAllocatePoolWithTag(512, 16, -1016105651);
    itemData := sdv_116;
    goto anon14_Then, anon14_Else;
  ...
  L45:
    havoc Tmp_219;
    havoc Tmp_221;
    call {:si_unique_call 993} WPP_RECORDER_SF_(Tmp_221, 0, 2, 89, Tmp_219);
    assume {:nonnull} data != 0;
    assume data > 0;
    havoc vslice_dummy_var_143;
    call {:si_unique_call 994} MouseClassLogError(vslice_dummy_var_143, 327694, 1, -1073741670, 0, 0, 0);
    goto L1;
  ...
  anon14_Then:
    ...
    assume itemData > 0;
    call {:si_unique_call 995} boogieTmp := IoAllocateWorkItem(0);
    assume {:nonnull} itemData != 0;
    assume itemData > 0;
    goto anon11_Then, anon11_Else;
  ...
  anon11_Else:
    ...
    assume {:nonnull} itemData != 0;
    assume itemData > 0;
    call {:si_unique_call 996} status_7 := sdv_IoAcquireRemoveLock(0, 0);
    goto anon12_Then, anon12_Else;
  ...
  anon12_Else:
    ...
    call {:si_unique_call 997} IoQueueWorkItem#0(vslice_dummy_var_144, li2bplFunctionConstant1006, 1, itemData);
    goto anon15_Then, anon15_Else;
  ...
  anon12_Then:
    ...
    call {:si_unique_call 998} IoFreeWorkItem(0);
...
procedure {:origName "MouseClassWWPowerUpComplete"} MouseClassWWPowerUpComplete#0(actual_DeviceObject_17: int, actual_MinorFunction_2: int, actual_SD1_1: int, actual_Context_7: int, actual_IoStatus_1: int);
  modifies alloc, Mem_T.CompletionRoutine__IO_STACK_LOCATION, forward_state, yogi_error;
  free ensures {:va_keep} old(forward_state) == 1 ==> forward_state != 0;
  free ensures {:va_keep} old(forward_state) == 0 ==> forward_state != 1;
  free ensures {:va_keep} old(SLAM_guard_S_0) == old(SLAM_guard_S_0_init) ==> forward_state == old(forward_state);
  free ensures {:va_keep} old(SLAM_guard_S_0) == old(SLAM_guard_S_0_init) ==> yogi_error == old(yogi_error);
...
implementation {:origName "MouseClassWWPowerUpComplete"} MouseClassWWPowerUpComplete#1(actual_DeviceObject_17: int, actual_MinorFunction_2: int, actual_SD1_1: int, actual_Context_7: int, actual_IoStatus_1: int)
{
  ...
  anon0:
    call {:si_unique_call 1001} PowerState_1 := __HAVOC_malloc(8);
    call {:si_unique_call 1002} vslice_dummy_var_104 := __HAVOC_malloc(4);
    SD1_1 := actual_SD1_1;
    Context_7 := actual_Context_7;
    assume {:nonnull} PowerState_1 != 0;
    assume PowerState_1 > 0;
  ...
  anon13_Else:
    call {:si_unique_call 1003} sdv_116 := ExAllocatePoolWithTag(512, 16, -1016105651);
    itemData := sdv_116;
    goto anon14_Then, anon14_Else;
  ...
  L45:
    havoc Tmp_219;
    havoc Tmp_221;
    call {:si_unique_call 1004} WPP_RECORDER_SF_(Tmp_221, 0, 2, 89, Tmp_219);
    assume {:nonnull} data != 0;
    assume data > 0;
    havoc vslice_dummy_var_145;
    call {:si_unique_call 1005} MouseClassLogError(vslice_dummy_var_145, 327694, 1, -1073741670, 0, 0, 0);
    goto L1;
  ...
  anon14_Then:
    ...
    assume {:nonnull} itemData != 0;
    assume itemData > 0;
    call {:si_unique_call 1006} boogieTmp := IoAllocateWorkItem(0);
    assume {:nonnull} itemData != 0;
    assume itemData > 0;
    goto anon11_Then, anon11_Else;
  ...
  anon11_Else:
    ...
    assume {:nonnull} itemData != 0;
    assume itemData > 0;
    call {:si_unique_call 1007} status_7 := sdv_IoAcquireRemoveLock(0, 0);
    goto anon12_Then, anon12_Else;
  ...
  anon12_Else:
    ...
    call {:si_unique_call 1008} IoQueueWorkItem#1(vslice_dummy_var_146, li2bplFunctionConstant1006, 1, itemData);
    goto anon15_Then, anon15_Else;
  ...
  anon12_Then:
    assume {:partition} 0 > status_7;
    call {:si_unique_call 1009} IoFreeWorkItem(0);
...
implementation {:origName "IoQueueWorkItem"} {:osmodel} IoQueueWorkItem#0(actual_IoWorkItem_1: int, actual_WorkerRoutine: int, actual_QueueType: int, actual_Context: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 1013} sdv_RunIoQueueWorkItems#0(0, WorkerRoutine, QueueType, Context);
    goto anon3_Then, anon3_Else;
...
implementation {:origName "IoQueueWorkItem"} {:osmodel} IoQueueWorkItem#1(actual_IoWorkItem_1: int, actual_WorkerRoutine: int, actual_QueueType: int, actual_Context: int)
{
  ...
  anon0:
    call {:si_unique_call 1014} vslice_dummy_var_106 := __HAVOC_malloc(4);
    WorkerRoutine := actual_WorkerRoutine;
    QueueType := actual_QueueType;
    Context := actual_Context;
    call {:si_unique_call 1015} sdv_RunIoQueueWorkItems#1(0, WorkerRoutine, QueueType, Context);
    goto anon3_Then, anon3_Else;
...
implementation {:origName "sdv_RunIoQueueWorkItems"} {:osmodel} sdv_RunIoQueueWorkItems#0(actual_IoWorkItem_2: int, actual_WorkerRoutine_1: int, actual_QueueType_1: int, actual_Context_1: int)
{
  ...
  anon0:
    call {:si_unique_call 1016} vslice_dummy_var_107 := __HAVOC_malloc(4);
  ...
  anon13_Else:
    ...
    call {:si_unique_call 1017} MouseClassCreateWaitWakeIrpWorker#0(sdv_p_devobj_fdo, Context_1);
    goto anon16_Then, anon16_Else;
  ...
  anon14_Else:
    ...
    call {:si_unique_call 1018} MouseStartWorker#0(sdv_p_devobj_fdo, Context_1);
    goto anon17_Then, anon17_Else;
  ...
  anon15_Else:
    ...
    call {:si_unique_call 1019} MouseToggleWaitWakeWorker#0(sdv_p_devobj_fdo, Context_1);
    goto anon18_Then, anon18_Else;
...
implementation {:origName "sdv_RunIoQueueWorkItems"} {:osmodel} sdv_RunIoQueueWorkItems#1(actual_IoWorkItem_2: int, actual_WorkerRoutine_1: int, actual_QueueType_1: int, actual_Context_1: int)
{
  ...
  anon0:
    call {:si_unique_call 1020} vslice_dummy_var_108 := __HAVOC_malloc(4);
    WorkerRoutine_1 := actual_WorkerRoutine_1;
    Context_1 := actual_Context_1;
    goto anon13_Then, anon13_Else;
  ...
  anon13_Else:
    assume {:partition} WorkerRoutine_1 == li2bplFunctionConstant1006;
    call {:si_unique_call 1021} MouseClassCreateWaitWakeIrpWorker#1(sdv_p_devobj_fdo, Context_1);
    goto anon16_Then, anon16_Else;
  ...
  anon14_Else:
    assume {:partition} WorkerRoutine_1 == li2bplFunctionConstant1001;
    call {:si_unique_call 1022} MouseStartWorker#1(sdv_p_devobj_fdo, Context_1);
    goto anon17_Then, anon17_Else;
  ...
  anon15_Else:
    assume {:partition} WorkerRoutine_1 == li2bplFunctionConstant1010;
    call {:si_unique_call 1023} MouseToggleWaitWakeWorker#1(sdv_p_devobj_fdo, Context_1);
    goto anon18_Then, anon18_Else;
...
implementation {:origName "MouseClassCreateWaitWakeIrpWorker"} MouseClassCreateWaitWakeIrpWorker#0(actual_DeviceObject_30: int, actual_Context_15: int)
{
  ...
  anon0:
    call {:si_unique_call 1024} vslice_dummy_var_109 := __HAVOC_malloc(4);
...
implementation {:origName "MouseClassCreateWaitWakeIrpWorker"} MouseClassCreateWaitWakeIrpWorker#1(actual_DeviceObject_30: int, actual_Context_15: int)
{
  ...
  anon0:
    call {:si_unique_call 1026} vslice_dummy_var_111 := __HAVOC_malloc(4);
    Context_15 := actual_Context_15;
    call {:si_unique_call 1027} sdv_do_paged_code_check();
    ItemData_1 := Context_15;
    assume {:nonnull} ItemData_1 != 0;
    assume ItemData_1 > 0;
    havoc vslice_dummy_var_147;
    call {:si_unique_call 1028} vslice_dummy_var_112 := MouseClassCreateWaitWakeIrp#0(vslice_dummy_var_147);
    goto anon3_Then, anon3_Else;
  ...
  anon3_Else:
    ...
    assume Tmp_428 > 0;
    call {:si_unique_call 1029} vslice_dummy_var_113 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(Tmp_428), ItemData_1);
    call {:si_unique_call 1030} IoFreeWorkItem(0);
...
implementation {:origName "MouseClassCreateWaitWakeIrp"} MouseClassCreateWaitWakeIrp#0(actual_Data_6: int) returns (Tmp_372: int)
{
  ...
  anon0:
    call {:si_unique_call 1032} powerState_2 := __HAVOC_malloc(8);
    Data_6 := actual_Data_6;
    success := 1;
    call {:si_unique_call 1033} sdv_do_paged_code_check();
    assume {:nonnull} Data_6 != 0;
    assume Data_6 > 0;
    ...
    call {:si_unique_call 1034} status_18 := PoRequestPowerIrp#0(vslice_dummy_var_148, 0, powerState_2, li2bplFunctionConstant1007, Data_6, 0);
    goto anon6_Then, anon6_Else;
...
implementation {:origName "MouseClassCreateWaitWakeIrp"} MouseClassCreateWaitWakeIrp#1(actual_Data_6: int) returns (Tmp_372: int)
{
  ...
  anon0:
    call {:si_unique_call 1035} powerState_2 := __HAVOC_malloc(8);
    Data_6 := actual_Data_6;
    success := 1;
    ...
    call {:si_unique_call 1037} status_18 := PoRequestPowerIrp#1(vslice_dummy_var_149, 0, powerState_2, li2bplFunctionConstant1007, Data_6, 0);
    goto anon6_Then, anon6_Else;
...
implementation {:origName "PoRequestPowerIrp"} {:osmodel} PoRequestPowerIrp#0(actual_DeviceObject_6: int, actual_MinorFunction: int, actual_SD3: int, actual_CompletionFunction: int, actual_Context_3: int, actual_Irp_2: int) returns (Tmp_73: int)
{
  ...
  anon0:
    call {:si_unique_call 1038} PowerState_3 := __HAVOC_malloc(8);
  ...
  anon11_Else:
    ...
    assume {:nonnull} sdv_power_irp != 0;
    assume sdv_power_irp > 0;
    call {:si_unique_call 1039} vslice_dummy_var_114 := sdv_RunPowerCompletionRoutines#0(DeviceObject_6, MinorFunction, PowerState_3, Context_3, IoStatus__IRP(sdv_power_irp), CompletionFunction);
    goto anon15_Then, anon15_Else;
...
implementation {:origName "PoRequestPowerIrp"} {:osmodel} PoRequestPowerIrp#1(actual_DeviceObject_6: int, actual_MinorFunction: int, actual_SD3: int, actual_CompletionFunction: int, actual_Context_3: int, actual_Irp_2: int) returns (Tmp_73: int)
{
  ...
  anon0:
    call {:si_unique_call 1040} PowerState_3 := __HAVOC_malloc(8);
    DeviceObject_6 := actual_DeviceObject_6;
    MinorFunction := actual_MinorFunction;
    SD3 := actual_SD3;
    CompletionFunction := actual_CompletionFunction;
  ...
  anon11_Else:
    ...
    assume {:nonnull} sdv_power_irp != 0;
    assume sdv_power_irp > 0;
    call {:si_unique_call 1041} vslice_dummy_var_115 := sdv_RunPowerCompletionRoutines#1(DeviceObject_6, MinorFunction, PowerState_3, Context_3, IoStatus__IRP(sdv_power_irp), CompletionFunction);
    goto anon15_Then, anon15_Else;
...
implementation {:origName "sdv_RunPowerCompletionRoutines"} {:osmodel} sdv_RunPowerCompletionRoutines#0(actual_DeviceObject_7: int, actual_MinorFunction_1: int, actual_SD2: int, actual_Context_4: int, actual_IoStatus: int, actual_CompletionFunction_1: int) returns (Tmp_89: int)
{
  ...
  anon0:
    call {:si_unique_call 1042} PowerState_2 := __HAVOC_malloc(8);
  ...
  anon15_Else:
    ...
    call {:si_unique_call 1043} sdv_stub_power_completion_begin();
    call {:si_unique_call 1044} MouseClassPoRequestComplete#0(DeviceObject_7, MinorFunction_1, PowerState_2, Context_4, IoStatus);
    goto anon16_Then, anon16_Else;
  ...
  anon13_Else:
    ...
    call {:si_unique_call 1045} sdv_stub_power_completion_begin();
    call {:si_unique_call 1046} MouseClassWWPowerUpComplete#0(DeviceObject_7, MinorFunction_1, PowerState_2, Context_4, IoStatus);
    goto anon17_Then, anon17_Else;
  ...
  anon14_Else:
    ...
    call {:si_unique_call 1048} MouseClassWaitWakeComplete#0(DeviceObject_7, MinorFunction_1, PowerState_2, Context_4, IoStatus);
    goto anon18_Then, anon18_Else;
...
implementation {:origName "sdv_RunPowerCompletionRoutines"} {:osmodel} sdv_RunPowerCompletionRoutines#1(actual_DeviceObject_7: int, actual_MinorFunction_1: int, actual_SD2: int, actual_Context_4: int, actual_IoStatus: int, actual_CompletionFunction_1: int) returns (Tmp_89: int)
{
  ...
  anon15_Else:
    ...
    call {:si_unique_call 1051} MouseClassPoRequestComplete#1(DeviceObject_7, MinorFunction_1, PowerState_2, Context_4, IoStatus);
    goto anon16_Then, anon16_Else;
  ...
  anon13_Else:
    ...
    call {:si_unique_call 1053} MouseClassWWPowerUpComplete#1(DeviceObject_7, MinorFunction_1, PowerState_2, Context_4, IoStatus);
    goto anon17_Then, anon17_Else;
  ...
  anon14_Else:
    ...
    call {:si_unique_call 1055} MouseClassWaitWakeComplete#1(DeviceObject_7, MinorFunction_1, PowerState_2, Context_4, IoStatus);
    goto anon18_Then, anon18_Else;
...
implementation {:origName "MouseClassPoRequestComplete"} MouseClassPoRequestComplete#0(actual_DeviceObject_22: int, actual_MinorFunction_3: int, actual_structPtr888D: int, actual_Context_11: int, actual_IoStatus_2: int)
{
  ...
  anon0:
    call {:si_unique_call 1056} D := __HAVOC_malloc(8);
    call {:si_unique_call 1057} powerState_1 := __HAVOC_malloc(8);
    call {:si_unique_call 1058} vslice_dummy_var_116 := __HAVOC_malloc(4);
    call {:si_unique_call 1059} sdv_1 := __HAVOC_malloc(8);
  ...
  anon27_Else:
    ...
    call {:si_unique_call 1060} sdv_144 := sdv_IoGetCurrentIrpStackLocation(S);
    assume {:nonnull} powerState_1 != 0;
    assume powerState_1 > 0;
    ...
    assume {:nonnull} sdv_144 != 0;
    assume sdv_144 > 0;
    call {:si_unique_call 1061} SD1_2 := PoSetPowerState(0, 0, powerState_1);
    ...
    assume {:nonnull} powerState_1 != 0;
    assume powerState_1 > 0;
    call {:si_unique_call 1062} PoStartNextPowerIrp(0);
    call {:si_unique_call 1063} sdv_IoSkipCurrentIrpStackLocation(S);
    call {:si_unique_call 1064} vslice_dummy_var_117 := PoCallDriver#0(0, S);
    goto anon28_Then, anon28_Else;
  ...
  anon28_Else:
    ...
    assume {:nonnull} data_3 != 0;
    assume data_3 > 0;
    call {:si_unique_call 1065} vslice_dummy_var_118 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(data_3), S);
    goto L1;
  ...
  anon22_Else:
    assume {:nonnull} data_3 != 0;
    assume data_3 > 0;
    call {:si_unique_call 1066} sdv_149 := _InlineInterlockedCompareExchangePointer(WaitWakeIrp__DEVICE_EXTENSION(data_3), 0, 0);
    goto anon23_Then, anon23_Else;

  anon23_Else:
    assume {:partition} sdv_149 == 0;
    call {:si_unique_call 1067} sdv_148 := MouseClassCheckWaitWakeEnabled(data_3);
    goto anon24_Then, anon24_Else;

  anon24_Else:
    assume {:partition} sdv_148 != 0;
    call {:si_unique_call 1068} sdv_145 := ExAllocatePoolWithTag(512, 16, -1016105651);
    itemData_2 := sdv_145;
    goto anon29_Then, anon29_Else;
  ...
  L79:
    havoc Tmp_277;
    havoc Tmp_279;
    call {:si_unique_call 1069} WPP_RECORDER_SF_(Tmp_279, 0, 2, 94, Tmp_277);
    assume {:nonnull} data_3 != 0;
    assume data_3 > 0;
    havoc vslice_dummy_var_150;
    call {:si_unique_call 1070} MouseClassLogError(vslice_dummy_var_150, 327694, 2, -1073741670, 0, 0, 0);
    goto L1;
  ...
  anon29_Then:
    ...
    assume itemData_2 > 0;
    call {:si_unique_call 1071} boogieTmp := IoAllocateWorkItem(0);
    assume {:nonnull} itemData_2 != 0;
    assume itemData_2 > 0;
    goto anon25_Then, anon25_Else;
  ...
  anon25_Else:
    ...
    assume {:nonnull} itemData_2 != 0;
    assume itemData_2 > 0;
    call {:si_unique_call 1072} status_11 := sdv_IoAcquireRemoveLock(0, 0);
    goto anon26_Then, anon26_Else;
  ...
  anon26_Else:
    ...
    call {:si_unique_call 1073} IoQueueWorkItem#0(vslice_dummy_var_151, li2bplFunctionConstant1006, 1, itemData_2);
    goto anon30_Then, anon30_Else;
  ...
  anon26_Then:
    ...
    call {:si_unique_call 1074} IoFreeWorkItem(0);
...
implementation {:origName "MouseClassPoRequestComplete"} MouseClassPoRequestComplete#1(actual_DeviceObject_22: int, actual_MinorFunction_3: int, actual_structPtr888D: int, actual_Context_11: int, actual_IoStatus_2: int)
{
  ...
  anon0:
    call {:si_unique_call 1077} D := __HAVOC_malloc(8);
    call {:si_unique_call 1078} powerState_1 := __HAVOC_malloc(8);
    call {:si_unique_call 1079} vslice_dummy_var_119 := __HAVOC_malloc(4);
    call {:si_unique_call 1080} sdv_1 := __HAVOC_malloc(8);
    DeviceObject_22 := actual_DeviceObject_22;
    structPtr888D := actual_structPtr888D;
    Context_11 := actual_Context_11;
    assume {:nonnull} D != 0;
  ...
  anon27_Else:
    assume {:partition} S != 0;
    call {:si_unique_call 1081} sdv_144 := sdv_IoGetCurrentIrpStackLocation(S);
    assume {:nonnull} powerState_1 != 0;
    assume powerState_1 > 0;
    assume {:nonnull} sdv_144 != 0;
    assume sdv_144 > 0;
    ...
    assume {:nonnull} sdv_144 != 0;
    assume sdv_144 > 0;
    call {:si_unique_call 1082} SD1_2 := PoSetPowerState(0, 0, powerState_1);
    assume {:nonnull} SD1_2 != 0;
    assume SD1_2 > 0;
    assume {:nonnull} sdv_1 != 0;
    assume sdv_1 > 0;
    ...
    assume {:nonnull} powerState_1 != 0;
    assume powerState_1 > 0;
    call {:si_unique_call 1083} PoStartNextPowerIrp(0);
    call {:si_unique_call 1084} sdv_IoSkipCurrentIrpStackLocation(S);
    call {:si_unique_call 1085} vslice_dummy_var_120 := PoCallDriver#1(0, S);
    goto anon28_Then, anon28_Else;
  ...
  anon28_Else:
    ...
    assume {:nonnull} data_3 != 0;
    assume data_3 > 0;
    call {:si_unique_call 1086} vslice_dummy_var_121 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(data_3), S);
    goto L1;
  ...
  anon22_Else:
    assume {:nonnull} data_3 != 0;
    assume data_3 > 0;
    call {:si_unique_call 1087} sdv_149 := _InlineInterlockedCompareExchangePointer(WaitWakeIrp__DEVICE_EXTENSION(data_3), 0, 0);
    goto anon23_Then, anon23_Else;

  anon23_Else:
    assume {:partition} sdv_149 == 0;
    call {:si_unique_call 1088} sdv_148 := MouseClassCheckWaitWakeEnabled(data_3);
    goto anon24_Then, anon24_Else;

  anon24_Else:
    assume {:partition} sdv_148 != 0;
    call {:si_unique_call 1089} sdv_145 := ExAllocatePoolWithTag(512, 16, -1016105651);
    itemData_2 := sdv_145;
    goto anon29_Then, anon29_Else;
  ...
  L79:
    havoc Tmp_277;
    havoc Tmp_279;
    call {:si_unique_call 1090} WPP_RECORDER_SF_(Tmp_279, 0, 2, 94, Tmp_277);
    assume {:nonnull} data_3 != 0;
    assume data_3 > 0;
    havoc vslice_dummy_var_152;
    call {:si_unique_call 1091} MouseClassLogError(vslice_dummy_var_152, 327694, 2, -1073741670, 0, 0, 0);
    goto L1;
  ...
  anon29_Then:
    ...
    assume {:nonnull} itemData_2 != 0;
    assume itemData_2 > 0;
    call {:si_unique_call 1092} boogieTmp := IoAllocateWorkItem(0);
    assume {:nonnull} itemData_2 != 0;
    assume itemData_2 > 0;
    goto anon25_Then, anon25_Else;
  ...
  anon25_Else:
    ...
    assume {:nonnull} itemData_2 != 0;
    assume itemData_2 > 0;
    call {:si_unique_call 1093} status_11 := sdv_IoAcquireRemoveLock(0, 0);
    goto anon26_Then, anon26_Else;
  ...
  anon26_Else:
    ...
    call {:si_unique_call 1094} IoQueueWorkItem#1(vslice_dummy_var_153, li2bplFunctionConstant1006, 1, itemData_2);
    goto anon30_Then, anon30_Else;
  ...
  anon26_Then:
    assume {:partition} 0 > status_11;
    call {:si_unique_call 1095} IoFreeWorkItem(0);
...
implementation {:origName "PoCallDriver"} {:osmodel} PoCallDriver#0(actual_DeviceObject_1: int, actual_Irp: int) returns (Tmp_40: int)
{
  ...
  anon0:
    call {:si_unique_call 1098} completion := __HAVOC_malloc(4);
    Irp := actual_Irp;
  ...
  anon64_Then:
    ...
    call {:si_unique_call 1099} sdv_14 := sdv_RunIoCompletionRoutines#0(sdv_p_devobj_fdo, Irp, vslice_dummy_var_154, completion);
    goto anon88_Then, anon88_Else;
  ...
  anon81_Else:
    ...
    assume SLAM_guard_S_0 != SLAM_guard_S_0_init;
    call {:si_unique_call 1100} SLIC_sdv_RunIoCompletionRoutines_exit(0, completion, sdv_14);
    goto L29;
  ...
  anon76_Else:
    ...
    call {:si_unique_call 1101} sdv_17 := sdv_RunIoCompletionRoutines#0(sdv_p_devobj_fdo, Irp, vslice_dummy_var_155, completion);
    goto anon90_Then, anon90_Else;
  ...
  anon82_Else:
    assume Irp == SLAM_guard_S_0;
    assume SLAM_guard_S_0 != SLAM_guard_S_0_init;
    call {:si_unique_call 1102} SLIC_sdv_RunIoCompletionRoutines_exit(0, completion, sdv_17);
    goto L29;
  ...
  anon68_Else:
    ...
    call {:si_unique_call 1103} sdv_15 := sdv_RunIoCompletionRoutines#0(sdv_p_devobj_fdo, Irp, vslice_dummy_var_156, completion);
    goto anon86_Then, anon86_Else;
  ...
  anon80_Else:
    assume Irp == SLAM_guard_S_0;
    assume SLAM_guard_S_0 != SLAM_guard_S_0_init;
    call {:si_unique_call 1104} SLIC_sdv_RunIoCompletionRoutines_exit(0, completion, sdv_15);
    goto L29;
  ...
  anon72_Else:
    ...
    call {:si_unique_call 1105} sdv_16 := sdv_RunIoCompletionRoutines#0(sdv_p_devobj_fdo, Irp, vslice_dummy_var_157, completion);
    goto anon84_Then, anon84_Else;
  ...
  anon79_Else:
    assume Irp == SLAM_guard_S_0;
    assume SLAM_guard_S_0 != SLAM_guard_S_0_init;
    call {:si_unique_call 1106} SLIC_sdv_RunIoCompletionRoutines_exit(0, completion, sdv_16);
    goto L29;
...
implementation {:origName "PoCallDriver"} {:osmodel} PoCallDriver#1(actual_DeviceObject_1: int, actual_Irp: int) returns (Tmp_40: int)
{
  ...
  anon64_Then:
    ...
    call {:si_unique_call 1108} sdv_14 := sdv_RunIoCompletionRoutines#1(sdv_p_devobj_fdo, Irp, vslice_dummy_var_158, completion);
    goto anon88_Then, anon88_Else;
  ...
  anon81_Else:
    assume Irp == SLAM_guard_S_0;
    assume SLAM_guard_S_0 != SLAM_guard_S_0_init;
    call {:si_unique_call 1109} SLIC_sdv_RunIoCompletionRoutines_exit(0, completion, sdv_14);
    goto L29;
  ...
  anon76_Else:
    ...
    call {:si_unique_call 1110} sdv_17 := sdv_RunIoCompletionRoutines#1(sdv_p_devobj_fdo, Irp, vslice_dummy_var_159, completion);
    goto anon90_Then, anon90_Else;
  ...
  anon82_Else:
    assume Irp == SLAM_guard_S_0;
    assume SLAM_guard_S_0 != SLAM_guard_S_0_init;
    call {:si_unique_call 1111} SLIC_sdv_RunIoCompletionRoutines_exit(0, completion, sdv_17);
    goto L29;
  ...
  anon68_Else:
    ...
    call {:si_unique_call 1112} sdv_15 := sdv_RunIoCompletionRoutines#1(sdv_p_devobj_fdo, Irp, vslice_dummy_var_160, completion);
    goto anon86_Then, anon86_Else;
  ...
  anon80_Else:
    assume Irp == SLAM_guard_S_0;
    assume SLAM_guard_S_0 != SLAM_guard_S_0_init;
    call {:si_unique_call 1113} SLIC_sdv_RunIoCompletionRoutines_exit(0, completion, sdv_15);
    goto L29;
  ...
  anon72_Else:
    ...
    call {:si_unique_call 1114} sdv_16 := sdv_RunIoCompletionRoutines#1(sdv_p_devobj_fdo, Irp, vslice_dummy_var_161, completion);
    goto anon84_Then, anon84_Else;
  ...
  anon79_Else:
    assume Irp == SLAM_guard_S_0;
    assume SLAM_guard_S_0 != SLAM_guard_S_0_init;
    call {:si_unique_call 1115} SLIC_sdv_RunIoCompletionRoutines_exit(0, completion, sdv_16);
    goto L29;
...
implementation {:origName "sdv_RunIoCompletionRoutines"} {:osmodel} sdv_RunIoCompletionRoutines#0(actual_DeviceObject_9: int, actual_Irp_5: int, actual_Context_6: int, actual_Completion: int) returns (Tmp_135: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 1116} irpsp := sdv_IoGetNextIrpStackLocation(Irp_5);
    Status := 0;
    assume {:nonnull} irpsp != 0;
    assume irpsp > 0;
    goto anon13_Then, anon13_Else;
  ...
  anon13_Else:
    ...
    call {:si_unique_call 1117} Status := MouSyncComplete(DeviceObject_9, Irp_5, Context_6);
    assume {:nonnull} Completion != 0;
    assume Completion > 0;
    goto L11;
  ...
  anon11_Else:
    ...
    call {:si_unique_call 1118} Status := MouseClassPowerComplete#0(DeviceObject_9, Irp_5, Context_6);
    goto anon14_Then, anon14_Else;
  ...
  anon12_Else:
    ...
    call {:si_unique_call 1119} Status := MousePnpStartCompletion#0(DeviceObject_9, Irp_5, Context_6);
    goto anon15_Then, anon15_Else;
...
implementation {:origName "sdv_RunIoCompletionRoutines"} {:osmodel} sdv_RunIoCompletionRoutines#1(actual_DeviceObject_9: int, actual_Irp_5: int, actual_Context_6: int, actual_Completion: int) returns (Tmp_135: int)
{
  ...
  anon13_Else:
    assume {:partition} Mem_T.CompletionRoutine__IO_STACK_LOCATION[CompletionRoutine__IO_STACK_LOCATION(irpsp)] == li2bplFunctionConstant981;
    call {:si_unique_call 1121} Status := MouSyncComplete(DeviceObject_9, Irp_5, Context_6);
    assume {:nonnull} Completion != 0;
    assume Completion > 0;
    goto L11;
  ...
  anon11_Else:
    assume {:partition} Mem_T.CompletionRoutine__IO_STACK_LOCATION[CompletionRoutine__IO_STACK_LOCATION(irpsp)] == li2bplFunctionConstant1012;
    call {:si_unique_call 1122} Status := MouseClassPowerComplete#1(DeviceObject_9, Irp_5, Context_6);
    goto anon14_Then, anon14_Else;
  ...
  anon12_Else:
    assume {:partition} Mem_T.CompletionRoutine__IO_STACK_LOCATION[CompletionRoutine__IO_STACK_LOCATION(irpsp)] == li2bplFunctionConstant1002;
    call {:si_unique_call 1123} Status := MousePnpStartCompletion#1(DeviceObject_9, Irp_5, Context_6);
    goto anon15_Then, anon15_Else;
...
implementation {:origName "MouseClassPowerComplete"} MouseClassPowerComplete#0(actual_DeviceObject_18: int, actual_Irp_9: int, actual_Context_8: int) returns (Tmp_250: int)
{
  ...
  anon0:
    ...
    havoc data_1;
    call {:si_unique_call 1127} stack_2 := sdv_IoGetCurrentIrpStackLocation(Irp_9);
  ...
  L36:
    ...
    assume {:nonnull} data_1 != 0;
    assume data_1 > 0;
    call {:si_unique_call 1129} vslice_dummy_var_122 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(data_1), Irp_9);
    Tmp_250 := 0;
    goto LM2;
  ...
  anon11_Then:
    assume {:partition} powerType == 0;
    call {:si_unique_call 1131} SD2_1 := PoSetPowerState(0, powerType, powerState);
...
implementation {:origName "MouseClassPowerComplete"} MouseClassPowerComplete#1(actual_DeviceObject_18: int, actual_Irp_9: int, actual_Context_8: int) returns (Tmp_250: int)
{
  ...
  anon0:
    call {:si_unique_call 1132} powerState := __HAVOC_malloc(8);
    call {:si_unique_call 1133} sdv_2 := __HAVOC_malloc(8);
    call {:si_unique_call 1134} sdv_3 := __HAVOC_malloc(8);
    DeviceObject_18 := actual_DeviceObject_18;
    Irp_9 := actual_Irp_9;
    assume {:nonnull} DeviceObject_18 != 0;
    assume DeviceObject_18 > 0;
    havoc data_1;
    call {:si_unique_call 1135} stack_2 := sdv_IoGetCurrentIrpStackLocation(Irp_9);
    assume {:nonnull} stack_2 != 0;
    assume stack_2 > 0;
    havoc powerType;
    assume {:nonnull} powerState != 0;
  ...
  L36:
    call {:si_unique_call 1136} PoStartNextPowerIrp(0);
    assume {:nonnull} data_1 != 0;
    assume data_1 > 0;
    call {:si_unique_call 1137} vslice_dummy_var_123 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(data_1), Irp_9);
    Tmp_250 := 0;
    goto LM2;
  ...
  anon11_Then:
    ...
    call {:si_unique_call 1140} status_10 := PoRequestPowerIrp#0(vslice_dummy_var_162, 2, powerState, li2bplFunctionConstant1013, 0, 0);
    goto anon15_Then, anon15_Else;
...
implementation {:origName "MousePnpStartCompletion"} MousePnpStartCompletion#0(actual_DeviceObject_23: int, actual_Irp_12: int, actual_Context_12: int) returns (Tmp_281: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 1141} IoQueueWorkItem#0(vslice_dummy_var_163, li2bplFunctionConstant1001, 1, item);
    goto anon3_Then, anon3_Else;
...
implementation {:origName "MousePnpStartCompletion"} MousePnpStartCompletion#1(actual_DeviceObject_23: int, actual_Irp_12: int, actual_Context_12: int) returns (Tmp_281: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 1142} IoQueueWorkItem#1(vslice_dummy_var_164, li2bplFunctionConstant1001, 1, item);
    goto anon3_Then, anon3_Else;
...
implementation {:origName "MouseClassWaitWakeComplete"} MouseClassWaitWakeComplete#0(actual_DeviceObject_33: int, actual_MinorFunction_4: int, actual_structPtr888PowerState: int, actual_Context_16: int, actual_IoStatus_3: int)
{
  ...
  anon0:
    call {:si_unique_call 1143} PowerState := __HAVOC_malloc(8);
    call {:si_unique_call 1144} powerState_4 := __HAVOC_malloc(8);
    call {:si_unique_call 1145} vslice_dummy_var_124 := __HAVOC_malloc(4);
    ...
    assume data_7 > 0;
    call {:si_unique_call 1146} sdv_240 := _InlineInterlockedExchangePointer(ExtraWaitWakeIrp__DEVICE_EXTENSION(data_7), 0);
    goto anon21_Then, anon21_Else;
  ...
  L14:
    assume {:nonnull} data_7 != 0;
    assume data_7 > 0;
    call {:si_unique_call 1147} sdv_243 := _InlineInterlockedExchangePointer(ExtraWWIrpTag__DEVICE_EXTENSION(data_7), 0);
    Irp_25 := sdv_243;
    goto anon28_Then, anon28_Else;
  ...
  L27:
    ...
    call {:si_unique_call 1148} WPP_RECORDER_SF_qd(Tmp_464, 0, 3, 90, Tmp_466, Irp_25, vslice_dummy_var_165);
    assume {:nonnull} IoStatus_3 != 0;
    assume IoStatus_3 > 0;
    goto anon22_Then, anon22_Else;
  ...
  anon23_Else:
    havoc Tmp_465;
    havoc Tmp_467;
    call {:si_unique_call 1149} WPP_RECORDER_SF_(Tmp_467, 0, 2, 91, Tmp_465);
  ...
  anon23_Then:
    call {:si_unique_call 1150} vslice_dummy_var_126 := MouseToggleWaitWake#0(data_7, 0);
    goto anon30_Then, anon30_Else;
  ...
  L49:
    assume {:nonnull} data_7 != 0;
    assume data_7 > 0;
    call {:si_unique_call 1151} vslice_dummy_var_127 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(data_7), Irp_25);
    goto LM2;
  ...
  anon28_Then:
    ...
    assume {:nonnull} data_7 != 0;
    assume data_7 > 0;
    call {:si_unique_call 1152} sdv_245 := _InlineInterlockedExchangePointer(WWIrpTag__DEVICE_EXTENSION(data_7), 0);
    Irp_25 := sdv_245;
    goto L27;
  ...
  anon21_Then:
    ...
    assume {:nonnull} data_7 != 0;
    assume data_7 > 0;
    call {:si_unique_call 1153} vslice_dummy_var_125 := _InlineInterlockedExchangePointer(WaitWakeIrp__DEVICE_EXTENSION(data_7), 0);
    goto L14;
}
...
implementation {:origName "MouseClassWaitWakeComplete"} MouseClassWaitWakeComplete#1(actual_DeviceObject_33: int, actual_MinorFunction_4: int, actual_structPtr888PowerState: int, actual_Context_16: int, actual_IoStatus_3: int)
{
  ...
  anon0:
    call {:si_unique_call 1154} PowerState := __HAVOC_malloc(8);
    call {:si_unique_call 1155} powerState_4 := __HAVOC_malloc(8);
    call {:si_unique_call 1156} vslice_dummy_var_128 := __HAVOC_malloc(4);
    structPtr888PowerState := actual_structPtr888PowerState;
    Context_16 := actual_Context_16;
    IoStatus_3 := actual_IoStatus_3;
    assume {:nonnull} PowerState != 0;
    ...
    assume {:nonnull} data_7 != 0;
    assume data_7 > 0;
    call {:si_unique_call 1157} sdv_240 := _InlineInterlockedExchangePointer(ExtraWaitWakeIrp__DEVICE_EXTENSION(data_7), 0);
    goto anon21_Then, anon21_Else;
  ...
  L14:
    assume {:nonnull} data_7 != 0;
    assume data_7 > 0;
    call {:si_unique_call 1158} sdv_243 := _InlineInterlockedExchangePointer(ExtraWWIrpTag__DEVICE_EXTENSION(data_7), 0);
    Irp_25 := sdv_243;
    goto anon28_Then, anon28_Else;
  ...
  L27:
    ...
    call {:si_unique_call 1159} WPP_RECORDER_SF_qd(Tmp_464, 0, 3, 90, Tmp_466, Irp_25, vslice_dummy_var_166);
    assume {:nonnull} IoStatus_3 != 0;
    assume IoStatus_3 > 0;
    goto anon22_Then, anon22_Else;
  ...
  anon23_Else:
    havoc Tmp_465;
    havoc Tmp_467;
    call {:si_unique_call 1160} WPP_RECORDER_SF_(Tmp_467, 0, 2, 91, Tmp_465);
    assume {:nonnull} powerState_4 != 0;
    assume powerState_4 > 0;
    assume {:nonnull} data_7 != 0;
    assume data_7 > 0;
    havoc vslice_dummy_var_167;
    call {:si_unique_call 1161} vslice_dummy_var_132 := PoRequestPowerIrp#0(vslice_dummy_var_167, 2, powerState_4, li2bplFunctionConstant1005, Context_16, 0);
    goto anon29_Then, anon29_Else;
  ...
  L49:
    assume {:nonnull} data_7 != 0;
    assume data_7 > 0;
    call {:si_unique_call 1162} vslice_dummy_var_131 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(data_7), Irp_25);
    goto LM2;
  ...
  anon23_Then:
    call {:si_unique_call 1163} vslice_dummy_var_130 := MouseToggleWaitWake#1(data_7, 0);
    goto anon30_Then, anon30_Else;
  ...
  anon28_Then:
    ...
    assume {:nonnull} data_7 != 0;
    assume data_7 > 0;
    call {:si_unique_call 1164} sdv_245 := _InlineInterlockedExchangePointer(WWIrpTag__DEVICE_EXTENSION(data_7), 0);
    Irp_25 := sdv_245;
    goto L27;
  ...
  anon21_Then:
    ...
    assume {:nonnull} data_7 != 0;
    assume data_7 > 0;
    call {:si_unique_call 1165} vslice_dummy_var_129 := _InlineInterlockedExchangePointer(WaitWakeIrp__DEVICE_EXTENSION(data_7), 0);
    goto L14;
}
...
implementation {:origName "MouseToggleWaitWake"} MouseToggleWaitWake#0(actual_Data_2: int, actual_WaitWakeState: int) returns (Tmp_222: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 1166} status_8 := sdv_IoAcquireRemoveLock(0, 0);
    goto anon13_Then, anon13_Else;

  anon13_Else:
    assume {:partition} status_8 >= 0;
    call {:si_unique_call 1167} sdv_120 := ExAllocatePoolWithTag(512, 16, -1016105651);
    itemData_1 := sdv_120;
    goto anon16_Then, anon16_Else;
  ...
  anon16_Else:
    ...
    assume {:nonnull} itemData_1 != 0;
    assume itemData_1 > 0;
    call {:si_unique_call 1168} boogieTmp := IoAllocateWorkItem(0);
    assume {:nonnull} itemData_1 != 0;
    assume itemData_1 > 0;
    goto anon14_Then, anon14_Else;
  ...
  anon14_Else:
    ...
    assume {:nonnull} itemData_1 != 0;
    assume itemData_1 > 0;
    call {:si_unique_call 1169} sdv_122 := sdv_KeGetCurrentIrql();
    goto anon15_Then, anon15_Else;
  ...
  anon15_Else:
    ...
    call {:si_unique_call 1170} IoQueueWorkItem#0(vslice_dummy_var_168, li2bplFunctionConstant1010, 1, itemData_1);
    goto anon17_Then, anon17_Else;
  ...
  anon15_Then:
    ...
    call {:si_unique_call 1171} MouseToggleWaitWakeWorker#0(vslice_dummy_var_169, itemData_1);
    goto anon18_Then, anon18_Else;
  ...
  anon14_Then:
    assume {:nonnull} Data_2 != 0;
    assume Data_2 > 0;
    call {:si_unique_call 1172} vslice_dummy_var_134 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(Data_2), li2bplFunctionConstant1010);
  ...
  anon16_Then:
    ...
    assume {:nonnull} Data_2 != 0;
    assume Data_2 > 0;
    call {:si_unique_call 1174} vslice_dummy_var_133 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(Data_2), li2bplFunctionConstant1010);
    goto L39;
...
implementation {:origName "MouseToggleWaitWake"} MouseToggleWaitWake#1(actual_Data_2: int, actual_WaitWakeState: int) returns (Tmp_222: int)
{
  ...
  anon0:
    Data_2 := actual_Data_2;
    WaitWakeState := actual_WaitWakeState;
    call {:si_unique_call 1175} status_8 := sdv_IoAcquireRemoveLock(0, 0);
    goto anon13_Then, anon13_Else;

  anon13_Else:
    assume {:partition} status_8 >= 0;
    call {:si_unique_call 1176} sdv_120 := ExAllocatePoolWithTag(512, 16, -1016105651);
    itemData_1 := sdv_120;
    goto anon16_Then, anon16_Else;
  ...
  anon16_Else:
    ...
    assume {:nonnull} itemData_1 != 0;
    assume itemData_1 > 0;
    call {:si_unique_call 1177} boogieTmp := IoAllocateWorkItem(0);
    assume {:nonnull} itemData_1 != 0;
    assume itemData_1 > 0;
    goto anon14_Then, anon14_Else;
  ...
  anon14_Else:
    ...
    assume {:nonnull} itemData_1 != 0;
    assume itemData_1 > 0;
    call {:si_unique_call 1178} sdv_122 := sdv_KeGetCurrentIrql();
    goto anon15_Then, anon15_Else;
  ...
  anon15_Else:
    ...
    call {:si_unique_call 1179} IoQueueWorkItem#1(vslice_dummy_var_170, li2bplFunctionConstant1010, 1, itemData_1);
    goto anon17_Then, anon17_Else;
  ...
  anon15_Then:
    ...
    call {:si_unique_call 1180} MouseToggleWaitWakeWorker#1(vslice_dummy_var_171, itemData_1);
    goto anon18_Then, anon18_Else;
  ...
  anon14_Then:
    assume {:nonnull} Data_2 != 0;
    assume Data_2 > 0;
    call {:si_unique_call 1181} vslice_dummy_var_136 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(Data_2), li2bplFunctionConstant1010);
    call {:si_unique_call 1182} sdv_ExFreePool(0);
    status_8 := -1073741670;
    Tmp_222 := status_8;
    goto L1;
  ...
  anon16_Then:
    ...
    assume {:nonnull} Data_2 != 0;
    assume Data_2 > 0;
    call {:si_unique_call 1183} vslice_dummy_var_135 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(Data_2), li2bplFunctionConstant1010);
    goto L39;
...
implementation {:origName "MouseToggleWaitWakeWorker"} MouseToggleWaitWakeWorker#0(actual_DeviceObject_21: int, actual_Context_10: int)
{
  ...
  anon0:
    call {:si_unique_call 1184} strEnable := __HAVOC_malloc(12);
    call {:si_unique_call 1185} vslice_dummy_var_137 := __HAVOC_malloc(4);
    Context_10 := actual_Context_10;
    call {:si_unique_call 1186} Tmp_262 := __HAVOC_malloc(64);
    waitWakeIrp_1 := 0;
    toggled := 0;
    ItemData := Context_10;
    assume {:nonnull} ItemData != 0;
  ...
  L15:
    ...
    assume ItemData > 0;
    havoc data_2;
    call {:si_unique_call 1187} Tmp_264 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_264 != 0;
    assume Tmp_264 > 0;
    call {:si_unique_call 1188} sdv_KeAcquireSpinLock(0, Tmp_264);
    assume {:nonnull} Tmp_264 != 0;
    assume Tmp_264 > 0;
    havoc irql_2;
    assume {:nonnull} data_2 != 0;
  ...
  anon26_Else:
    assume {:nonnull} data_2 != 0;
    assume data_2 > 0;
    call {:si_unique_call 1189} sdv_136 := _InlineInterlockedExchangePointer(WaitWakeIrp__DEVICE_EXTENSION(data_2), 0);
  ...
  L21:
    call {:si_unique_call 1190} sdv_KeReleaseSpinLock(0, irql_2);
    goto anon20_Then, anon20_Else;

  anon20_Else:
    assume {:partition} toggled != 0;
    call {:si_unique_call 1191} sdv_138 := IoOpenDeviceRegistryKey(0, 1, 2031616, 0);
    goto anon22_Then, anon22_Else;

  anon22_Else:
    assume {:partition} sdv_138 >= 0;
    Tmp_262 := strConst__li2bpl5;
    call {:si_unique_call 1192} RtlInitUnicodeString(strEnable, Tmp_262);
    call {:si_unique_call 1193} vslice_dummy_var_138 := ZwSetValueKey(0, 0, 0, 4, 0, 4);
    call {:si_unique_call 1194} vslice_dummy_var_139 := ZwClose(0);
    goto L32;
  ...
  anon23_Else:
    ...
    call {:si_unique_call 1195} vslice_dummy_var_141 := IoCancelIrp(0);
    goto L55;

  L55:
    assume {:nonnull} data_2 != 0;
    assume data_2 > 0;
    call {:si_unique_call 1196} vslice_dummy_var_140 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(data_2), li2bplFunctionConstant1010);
    call {:si_unique_call 1197} IoFreeWorkItem(0);
...
implementation {:origName "MouseToggleWaitWakeWorker"} MouseToggleWaitWakeWorker#1(actual_DeviceObject_21: int, actual_Context_10: int)
{
  ...
  anon0:
    call {:si_unique_call 1199} strEnable := __HAVOC_malloc(12);
    call {:si_unique_call 1200} vslice_dummy_var_142 := __HAVOC_malloc(4);
    Context_10 := actual_Context_10;
    call {:si_unique_call 1201} Tmp_262 := __HAVOC_malloc(64);
    waitWakeIrp_1 := 0;
    toggled := 0;
    ItemData := Context_10;
    assume {:nonnull} ItemData != 0;
  ...
  L15:
    ...
    assume ItemData > 0;
    havoc data_2;
    call {:si_unique_call 1202} Tmp_264 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_264 != 0;
    assume Tmp_264 > 0;
    call {:si_unique_call 1203} sdv_KeAcquireSpinLock(0, Tmp_264);
    assume {:nonnull} Tmp_264 != 0;
    assume Tmp_264 > 0;
    havoc irql_2;
    assume {:nonnull} data_2 != 0;
  ...
  anon26_Else:
    assume {:nonnull} data_2 != 0;
    assume data_2 > 0;
    call {:si_unique_call 1204} sdv_136 := _InlineInterlockedExchangePointer(WaitWakeIrp__DEVICE_EXTENSION(data_2), 0);
    waitWakeIrp_1 := sdv_136;
    goto L26;
  ...
  L21:
    call {:si_unique_call 1205} sdv_KeReleaseSpinLock(0, irql_2);
    goto anon20_Then, anon20_Else;

  anon20_Else:
    assume {:partition} toggled != 0;
    call {:si_unique_call 1206} sdv_138 := IoOpenDeviceRegistryKey(0, 1, 2031616, 0);
    goto anon22_Then, anon22_Else;

  anon22_Else:
    assume {:partition} sdv_138 >= 0;
    Tmp_262 := strConst__li2bpl5;
    call {:si_unique_call 1207} RtlInitUnicodeString(strEnable, Tmp_262);
    call {:si_unique_call 1208} vslice_dummy_var_143 := ZwSetValueKey(0, 0, 0, 4, 0, 4);
    call {:si_unique_call 1209} vslice_dummy_var_144 := ZwClose(0);
    goto L32;
  ...
  anon24_Else:
    assume {:partition} wwState != 0;
    call {:si_unique_call 1210} vslice_dummy_var_145 := MouseClassCreateWaitWakeIrp#0(data_2);
    goto anon27_Then, anon27_Else;
  ...
  anon23_Else:
    assume {:partition} waitWakeIrp_1 != 0;
    call {:si_unique_call 1211} vslice_dummy_var_147 := IoCancelIrp(0);
    goto L55;

  L55:
    assume {:nonnull} data_2 != 0;
    assume data_2 > 0;
    call {:si_unique_call 1212} vslice_dummy_var_146 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(data_2), li2bplFunctionConstant1010);
    call {:si_unique_call 1213} IoFreeWorkItem(0);
...
implementation {:origName "MouseStartWorker"} MouseStartWorker#0(actual_DeviceObject_26: int, actual_Context_14: int)
{
  ...
  anon0:
    call {:si_unique_call 1215} vslice_dummy_var_148 := __HAVOC_malloc(4);
    ...
    havoc devExt;
    call {:si_unique_call 1216} status_14 := MouseStart#0(DeviceObject_26, item_1);
    goto anon7_Then, anon7_Else;
  ...
  anon8_Else:
    ...
    assume SLAM_guard_S_0 != SLAM_guard_S_0_init;
    call {:si_unique_call 1217} SLIC_sdv_IoCompleteRequest_entry(strConst__li2bpl4);
    goto anon9_Then, anon9_Else;
  ...
  L29:
    ...
    call {:si_unique_call 1219} IoFreeWorkItem(0);
    call {:si_unique_call 1220} sdv_ExFreePool(0);
    assume {:nonnull} devExt != 0;
    assume devExt > 0;
    call {:si_unique_call 1221} vslice_dummy_var_149 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(devExt), li2bplFunctionConstant1001);
    goto LM2;
...
implementation {:origName "MouseStartWorker"} MouseStartWorker#1(actual_DeviceObject_26: int, actual_Context_14: int)
{
  ...
  anon0:
    call {:si_unique_call 1222} vslice_dummy_var_150 := __HAVOC_malloc(4);
    DeviceObject_26 := actual_DeviceObject_26;
    Context_14 := actual_Context_14;
    item_1 := Context_14;
    assume {:nonnull} item_1 != 0;
    ...
    assume DeviceObject_26 > 0;
    havoc devExt;
    call {:si_unique_call 1223} status_14 := MouseStart#1(DeviceObject_26, item_1);
    goto anon7_Then, anon7_Else;
  ...
  anon8_Else:
    assume Irp_16 == SLAM_guard_S_0;
    assume SLAM_guard_S_0 != SLAM_guard_S_0_init;
    call {:si_unique_call 1224} SLIC_sdv_IoCompleteRequest_entry(strConst__li2bpl4);
    goto anon9_Then, anon9_Else;
  ...
  L29:
    ...
    call {:si_unique_call 1226} IoFreeWorkItem(0);
    call {:si_unique_call 1227} sdv_ExFreePool(0);
    assume {:nonnull} devExt != 0;
    assume devExt > 0;
    call {:si_unique_call 1228} vslice_dummy_var_151 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(devExt), li2bplFunctionConstant1001);
    goto LM2;
...
implementation {:origName "MouseStart"} MouseStart#0(actual_DeviceObject_29: int, actual_item_2: int) returns (Tmp_398: int)
{
  ...
  anon0:
    call {:si_unique_call 1229} devCaps := __HAVOC_malloc(124);
  ...
  anon44_Else:
    ...
    assume {:nonnull} Irp_21 != 0;
    assume Irp_21 > 0;
    call {:si_unique_call 1230} sdv_RtlZeroMemory(0, 64);
    ...
    assume {:nonnull} devCaps != 0;
    assume devCaps > 0;
    call {:si_unique_call 1231} stack_5 := sdv_IoGetNextIrpStackLocation(Irp_21);
    ...
    call {:si_unique_call 1232} status_20 := MouseSendIrpSynchronously#0(vslice_dummy_var_172, Irp_21, 0);
    goto anon45_Then, anon45_Else;
  ...
  anon34_Else:
    ...
    assume {:nonnull} devCaps != 0;
    assume devCaps > 0;
    call {:si_unique_call 1233} sdv_RtlCopyMemory(0, 0, 20);
    goto L40;
  ...
  anon35_Else:
    assume {:nonnull} data_5 != 0;
    assume data_5 > 0;
    call {:si_unique_call 1234} MouseClassGetWaitWakeEnableState(data_5);
    goto L57;
  ...
  L57:
    ...
    assume {:nonnull} data_5 != 0;
    assume data_5 > 0;
    call {:si_unique_call 1235} vslice_dummy_var_152 := IoWMIRegistrationControl(0, 1);
    call {:si_unique_call 1236} ExAcquireFastMutex(0);
    goto anon36_Then, anon36_Else;
  ...
  anon37_Else:
    ...
    assume {:nonnull} port_3 != 0;
    assume port_3 > 0;
    call {:si_unique_call 1237} ExReleaseFastMutex(0);
  ...
  anon40_Else:
    assume {:nonnull} data_5 != 0;
    assume data_5 > 0;
    call {:si_unique_call 1238} sdv_209 := _InlineInterlockedCompareExchangePointer(WaitWakeIrp__DEVICE_EXTENSION(data_5), 0, 0);
    goto anon41_Then, anon41_Else;

  anon41_Else:
    assume {:partition} sdv_209 == 0;
    call {:si_unique_call 1239} sdv_205 := MouseClassCheckWaitWakeEnabled(data_5);
    goto anon42_Then, anon42_Else;
  ...
  anon38_Then:
    assume {:partition} enabled_3 == 0;
    call {:si_unique_call 1240} status_20 := MouEnableDisablePort#0(1, 0, data_5, file);
    goto anon48_Then, anon48_Else;
  ...
  anon37_Then:
    call {:si_unique_call 1241} ExReleaseFastMutex(0);
    goto L89;

  anon36_Then:
    call {:si_unique_call 1242} ExReleaseFastMutex(0);
    call {:si_unique_call 1243} status_20 := IoSetDeviceInterfaceState(0, 1);
    goto L89;
...
implementation {:origName "MouseStart"} MouseStart#1(actual_DeviceObject_29: int, actual_item_2: int) returns (Tmp_398: int)
{
  ...
  anon0:
    call {:si_unique_call 1244} devCaps := __HAVOC_malloc(124);
    DeviceObject_29 := actual_DeviceObject_29;
    item_2 := actual_item_2;
    assume {:nonnull} item_2 != 0;
    assume item_2 > 0;
  ...
  anon44_Else:
    ...
    assume {:nonnull} Irp_21 != 0;
    assume Irp_21 > 0;
    call {:si_unique_call 1245} sdv_RtlZeroMemory(0, 64);
    assume {:nonnull} devCaps != 0;
    assume devCaps > 0;
    assume {:nonnull} devCaps != 0;
    assume devCaps > 0;
    ...
    assume {:nonnull} devCaps != 0;
    assume devCaps > 0;
    call {:si_unique_call 1246} stack_5 := sdv_IoGetNextIrpStackLocation(Irp_21);
    assume {:nonnull} stack_5 != 0;
    assume stack_5 > 0;
    assume {:nonnull} stack_5 != 0;
    assume stack_5 > 0;
    ...
    call {:si_unique_call 1247} status_20 := MouseSendIrpSynchronously#1(vslice_dummy_var_173, Irp_21, 0);
    goto anon45_Then, anon45_Else;
  ...
  anon35_Else:
    assume {:nonnull} data_5 != 0;
    assume data_5 > 0;
    call {:si_unique_call 1249} MouseClassGetWaitWakeEnableState(data_5);
    goto L57;
  ...
  L57:
    ...
    assume {:nonnull} data_5 != 0;
    assume data_5 > 0;
    call {:si_unique_call 1250} vslice_dummy_var_154 := IoWMIRegistrationControl(0, 1);
    call {:si_unique_call 1251} ExAcquireFastMutex(0);
    goto anon36_Then, anon36_Else;
  ...
  anon37_Else:
    ...
    assume {:nonnull} port_3 != 0;
    assume port_3 > 0;
    call {:si_unique_call 1252} ExReleaseFastMutex(0);
    goto anon38_Then, anon38_Else;
  ...
  anon40_Else:
    assume {:nonnull} data_5 != 0;
    assume data_5 > 0;
    call {:si_unique_call 1253} sdv_209 := _InlineInterlockedCompareExchangePointer(WaitWakeIrp__DEVICE_EXTENSION(data_5), 0, 0);
    goto anon41_Then, anon41_Else;

  anon41_Else:
    assume {:partition} sdv_209 == 0;
    call {:si_unique_call 1254} sdv_205 := MouseClassCheckWaitWakeEnabled(data_5);
    goto anon42_Then, anon42_Else;

  anon42_Else:
    assume {:partition} sdv_205 != 0;
    call {:si_unique_call 1255} vslice_dummy_var_153 := MouseClassCreateWaitWakeIrp#0(data_5);
    goto anon47_Then, anon47_Else;
  ...
  anon38_Then:
    assume {:partition} enabled_3 == 0;
    call {:si_unique_call 1256} status_20 := MouEnableDisablePort#1(1, 0, data_5, file);
    goto anon48_Then, anon48_Else;
  ...
  anon36_Then:
    call {:si_unique_call 1258} ExReleaseFastMutex(0);
    call {:si_unique_call 1259} status_20 := IoSetDeviceInterfaceState(0, 1);
    goto L89;
...
implementation {:origName "MouEnableDisablePort"} MouEnableDisablePort#0(actual_EnableFlag: int, actual_Irp_15: int, actual_Port: int, actual_File: int) returns (Tmp_309: int)
{
  ...
  anon0:
    call {:si_unique_call 1260} name := __HAVOC_malloc(12);
    call {:si_unique_call 1261} device := __HAVOC_malloc(4);
    ...
    buffer := 0;
    bufferLength := 0;
    call {:si_unique_call 1262} sdv_do_paged_code_check();
    havoc Tmp_315;
    havoc Tmp_312;
    call {:si_unique_call 1263} WPP_RECORDER_SF_(Tmp_312, 0, 3, 82, Tmp_315);
    assume {:nonnull} Port != 0;
    assume Port > 0;
    goto anon23_Then, anon23_Else;
  ...
  anon25_Else:
    call {:si_unique_call 1264} sdv_IoCopyCurrentIrpStackLocationToNext(Irp_15);
    call {:si_unique_call 1265} stack_3 := sdv_IoGetNextIrpStackLocation(Irp_15);
    goto anon26_Then, anon26_Else;
  ...
  L40:
    ...
    call {:si_unique_call 1266} status_13 := MouseSendIrpSynchronously#0(vslice_dummy_var_174, Irp_15, 0);
    goto anon30_Then, anon30_Else;
  ...
  L49:
    havoc Tmp_310;
    havoc Tmp_316;
    call {:si_unique_call 1267} WPP_RECORDER_SF_(Tmp_316, 0, 3, 83, Tmp_310);
    Tmp_309 := status_13;
    goto L1;
  ...
  anon28_Else:
    assume {:partition} EnableFlag != 0;
    bufferLength := 0;
    call {:si_unique_call 1268} Tmp_313 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_313 != 0;
    assume Tmp_313 > 0;
    call {:si_unique_call 1269} status_13 := IoGetDeviceProperty(0, 4107, bufferLength, 0, Tmp_313);
    assume {:nonnull} Tmp_313 != 0;
    assume Tmp_313 > 0;
    havoc bufferLength;
    call {:si_unique_call 1270} sdv_164 := ExAllocatePoolWithTag(1, bufferLength, -1016105651);
    buffer := sdv_164;
    goto anon31_Then, anon31_Else;

  anon31_Else:
    assume {:partition} buffer != 0;
    call {:si_unique_call 1271} Tmp_313 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_313 != 0;
    assume Tmp_313 > 0;
    call {:si_unique_call 1272} vslice_dummy_var_156 := IoGetDeviceProperty(0, 4107, bufferLength, 0, Tmp_313);
    assume {:nonnull} Tmp_313 != 0;
    assume Tmp_313 > 0;
    havoc bufferLength;
    assume {:nonnull} name != 0;
    ...
    assume {:nonnull} name != 0;
    assume name > 0;
    call {:si_unique_call 1273} status_13 := IoGetDeviceObjectPointer(0, 2032127, 0, device);
  ...
  anon29_Else:
    ...
    assume {:nonnull} Port != 0;
    assume Port > 0;
    call {:si_unique_call 1275} status_13 := IoRegisterPlugPlayNotification(3, 0, 0, 0, li2bplFunctionConstant992, 0, 0);
    goto L49;
  ...
  anon28_Then:
    assume {:partition} EnableFlag == 0;
    call {:si_unique_call 1276} vslice_dummy_var_155 := sdv_ObDereferenceObject(0);
  ...
  anon24_Then:
    assume {:nonnull} Port != 0;
    assume Port > 0;
    call {:si_unique_call 1277} sdv_IoCopyCurrentIrpStackLocationToNext(Irp_15);
    call {:si_unique_call 1278} stack_3 := sdv_IoGetNextIrpStackLocation(Irp_15);
    assume {:nonnull} stack_3 != 0;
    assume stack_3 > 0;
    assume {:nonnull} stack_3 != 0;
    assume stack_3 > 0;
  ...
  L102:
    ...
    call {:si_unique_call 1279} status_13 := MouseSendIrpSynchronously#0(vslice_dummy_var_175, Irp_15, 0);
    goto anon33_Then, anon33_Else;
...
implementation {:origName "MouEnableDisablePort"} MouEnableDisablePort#1(actual_EnableFlag: int, actual_Irp_15: int, actual_Port: int, actual_File: int) returns (Tmp_309: int)
{
  ...
  anon0:
    call {:si_unique_call 1280} name := __HAVOC_malloc(12);
    call {:si_unique_call 1281} device := __HAVOC_malloc(4);
    EnableFlag := actual_EnableFlag;
    Irp_15 := actual_Irp_15;
    Port := actual_Port;
    File := actual_File;
    ...
    havoc Tmp_315;
    havoc Tmp_312;
    call {:si_unique_call 1283} WPP_RECORDER_SF_(Tmp_312, 0, 3, 82, Tmp_315);
    assume {:nonnull} Port != 0;
    assume Port > 0;
    goto anon23_Then, anon23_Else;
  ...
  anon25_Else:
    call {:si_unique_call 1284} sdv_IoCopyCurrentIrpStackLocationToNext(Irp_15);
    call {:si_unique_call 1285} stack_3 := sdv_IoGetNextIrpStackLocation(Irp_15);
    goto anon26_Then, anon26_Else;
  ...
  L40:
    ...
    call {:si_unique_call 1286} status_13 := MouseSendIrpSynchronously#1(vslice_dummy_var_176, Irp_15, 0);
    goto anon30_Then, anon30_Else;
  ...
  L49:
    havoc Tmp_310;
    havoc Tmp_316;
    call {:si_unique_call 1287} WPP_RECORDER_SF_(Tmp_316, 0, 3, 83, Tmp_310);
    Tmp_309 := status_13;
    goto L1;
  ...
  anon28_Else:
    assume {:partition} EnableFlag != 0;
    bufferLength := 0;
    call {:si_unique_call 1288} Tmp_313 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_313 != 0;
    assume Tmp_313 > 0;
    call {:si_unique_call 1289} status_13 := IoGetDeviceProperty(0, 4107, bufferLength, 0, Tmp_313);
    assume {:nonnull} Tmp_313 != 0;
    assume Tmp_313 > 0;
    havoc bufferLength;
    call {:si_unique_call 1290} sdv_164 := ExAllocatePoolWithTag(1, bufferLength, -1016105651);
    buffer := sdv_164;
    goto anon31_Then, anon31_Else;

  anon31_Else:
    assume {:partition} buffer != 0;
    call {:si_unique_call 1291} Tmp_313 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_313 != 0;
    assume Tmp_313 > 0;
    call {:si_unique_call 1292} vslice_dummy_var_158 := IoGetDeviceProperty(0, 4107, bufferLength, 0, Tmp_313);
    assume {:nonnull} Tmp_313 != 0;
    assume Tmp_313 > 0;
    havoc bufferLength;
    assume {:nonnull} name != 0;
    ...
    assume {:nonnull} name != 0;
    assume name > 0;
    call {:si_unique_call 1293} status_13 := IoGetDeviceObjectPointer(0, 2032127, 0, device);
  ...
  anon29_Else:
    ...
    assume {:nonnull} Port != 0;
    assume Port > 0;
    call {:si_unique_call 1295} status_13 := IoRegisterPlugPlayNotification(3, 0, 0, 0, li2bplFunctionConstant992, 0, 0);
    goto L49;
  ...
  anon28_Then:
    assume {:partition} EnableFlag == 0;
    call {:si_unique_call 1296} vslice_dummy_var_157 := sdv_ObDereferenceObject(0);
    assume {:nonnull} File != 0;
    assume File > 0;
    goto L49;
  ...
  anon24_Then:
    assume {:nonnull} Port != 0;
    assume Port > 0;
    call {:si_unique_call 1297} sdv_IoCopyCurrentIrpStackLocationToNext(Irp_15);
    call {:si_unique_call 1298} stack_3 := sdv_IoGetNextIrpStackLocation(Irp_15);
    assume {:nonnull} stack_3 != 0;
    assume stack_3 > 0;
    assume {:nonnull} stack_3 != 0;
    assume stack_3 > 0;
  ...
  L102:
    ...
    call {:si_unique_call 1299} status_13 := MouseSendIrpSynchronously#1(vslice_dummy_var_177, Irp_15, 0);
    goto anon33_Then, anon33_Else;
...
implementation {:origName "MouseSendIrpSynchronously"} MouseSendIrpSynchronously#0(actual_DeviceObject_27: int, actual_Irp_17: int, actual_CopyToNext: int) returns (Tmp_338: int)
{
  ...
  anon0:
    call {:si_unique_call 1300} event := __HAVOC_malloc(156);
    DeviceObject_27 := actual_DeviceObject_27;
    Irp_17 := actual_Irp_17;
    CopyToNext := actual_CopyToNext;
    call {:si_unique_call 1301} sdv_do_paged_code_check();
    call {:si_unique_call 1302} KeInitializeEvent(event, 1, 0);
    goto anon7_Then, anon7_Else;

  anon7_Else:
    assume {:partition} CopyToNext != 0;
    call {:si_unique_call 1303} sdv_IoCopyCurrentIrpStackLocationToNext(Irp_17);
    goto L12;

  L12:
    call {:si_unique_call 1304} sdv_IoSetCompletionRoutine(Irp_17, li2bplFunctionConstant981, event, 1, 1, 1);
    goto anon8_Then, anon8_Else;

  anon8_Else:
    assume Irp_17 == SLAM_guard_S_0;
    assume SLAM_guard_S_0 != SLAM_guard_S_0_init;
    call {:si_unique_call 1305} SLIC_sdv_IoSetCompletionRoutine_exit(0);
    goto L18;

  L18:
    call {:si_unique_call 1306} vslice_dummy_var_159 := sdv_IoCallDriver#0(DeviceObject_27, Irp_17);
    goto anon9_Then, anon9_Else;

  anon9_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 1307} vslice_dummy_var_160 := KeWaitForSingleObject(0, 0, 0, 0, 0);
...
implementation {:origName "MouseSendIrpSynchronously"} MouseSendIrpSynchronously#1(actual_DeviceObject_27: int, actual_Irp_17: int, actual_CopyToNext: int) returns (Tmp_338: int)
{
  ...
  anon0:
    call {:si_unique_call 1308} event := __HAVOC_malloc(156);
    DeviceObject_27 := actual_DeviceObject_27;
    Irp_17 := actual_Irp_17;
    CopyToNext := actual_CopyToNext;
    call {:si_unique_call 1309} sdv_do_paged_code_check();
    call {:si_unique_call 1310} KeInitializeEvent(event, 1, 0);
    goto anon7_Then, anon7_Else;

  anon7_Else:
    assume {:partition} CopyToNext != 0;
    call {:si_unique_call 1311} sdv_IoCopyCurrentIrpStackLocationToNext(Irp_17);
    goto L12;

  L12:
    call {:si_unique_call 1312} sdv_IoSetCompletionRoutine(Irp_17, li2bplFunctionConstant981, event, 1, 1, 1);
    goto anon8_Then, anon8_Else;

  anon8_Else:
    assume Irp_17 == SLAM_guard_S_0;
    assume SLAM_guard_S_0 != SLAM_guard_S_0_init;
    call {:si_unique_call 1313} SLIC_sdv_IoSetCompletionRoutine_exit(0);
    goto L18;

  L18:
    call {:si_unique_call 1314} vslice_dummy_var_161 := sdv_IoCallDriver#1(DeviceObject_27, Irp_17);
    goto anon9_Then, anon9_Else;

  anon9_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 1315} vslice_dummy_var_162 := KeWaitForSingleObject(0, 0, 0, 0, 0);
    assume {:nonnull} Irp_17 != 0;
    assume Irp_17 > 0;
    havoc status_16;
    Tmp_338 := status_16;
...
implementation {:origName "sdv_IoCallDriver"} {:osmodel} sdv_IoCallDriver#0(actual_DeviceObject_10: int, actual_Irp_6: int) returns (Tmp_139: int)
{
  ...
  anon0:
    Irp_6 := actual_Irp_6;
    call {:si_unique_call 1316} Tmp_139 := IofCallDriver#0(0, Irp_6);
    goto anon3_Then, anon3_Else;
...
implementation {:origName "sdv_IoCallDriver"} {:osmodel} sdv_IoCallDriver#1(actual_DeviceObject_10: int, actual_Irp_6: int) returns (Tmp_139: int)
{
  ...
  anon0:
    Irp_6 := actual_Irp_6;
    call {:si_unique_call 1317} Tmp_139 := IofCallDriver#1(0, Irp_6);
    goto anon3_Then, anon3_Else;
...
implementation {:origName "IofCallDriver"} {:osmodel} IofCallDriver#0(actual_DeviceObject_8: int, actual_Irp_4: int) returns (Tmp_133: int)
{
  ...
  anon0:
    call {:si_unique_call 1318} completion_1 := __HAVOC_malloc(4);
    Irp_4 := actual_Irp_4;
...
implementation {:origName "IofCallDriver"} {:osmodel} IofCallDriver#1(actual_DeviceObject_8: int, actual_Irp_4: int) returns (Tmp_133: int)
{
  ...
  anon0:
    call {:si_unique_call 1319} completion_1 := __HAVOC_malloc(4);
    Irp_4 := actual_Irp_4;
    assume {:nonnull} completion_1 != 0;
    assume completion_1 > 0;
    status_3 := 259;
  ...
  anon63_Then:
    ...
    call {:si_unique_call 1320} sdv_56 := sdv_RunIoCompletionRoutines#0(sdv_p_devobj_fdo, Irp_4, vslice_dummy_var_178, completion_1);
    goto anon88_Then, anon88_Else;
  ...
  anon80_Else:
    ...
    assume SLAM_guard_S_0 != SLAM_guard_S_0_init;
    call {:si_unique_call 1321} SLIC_sdv_RunIoCompletionRoutines_exit(0, completion_1, sdv_56);
    goto L29;
  ...
  anon75_Else:
    ...
    call {:si_unique_call 1322} sdv_59 := sdv_RunIoCompletionRoutines#0(sdv_p_devobj_fdo, Irp_4, vslice_dummy_var_179, completion_1);
    goto anon90_Then, anon90_Else;
  ...
  anon81_Else:
    assume Irp_4 == SLAM_guard_S_0;
    assume SLAM_guard_S_0 != SLAM_guard_S_0_init;
    call {:si_unique_call 1323} SLIC_sdv_RunIoCompletionRoutines_exit(0, completion_1, sdv_59);
    goto L29;
  ...
  anon67_Else:
    ...
    call {:si_unique_call 1324} sdv_57 := sdv_RunIoCompletionRoutines#0(sdv_p_devobj_fdo, Irp_4, vslice_dummy_var_180, completion_1);
    goto anon86_Then, anon86_Else;
  ...
  anon79_Else:
    assume Irp_4 == SLAM_guard_S_0;
    assume SLAM_guard_S_0 != SLAM_guard_S_0_init;
    call {:si_unique_call 1325} SLIC_sdv_RunIoCompletionRoutines_exit(0, completion_1, sdv_57);
    goto L29;
  ...
  anon71_Else:
    ...
    call {:si_unique_call 1326} sdv_58 := sdv_RunIoCompletionRoutines#0(sdv_p_devobj_fdo, Irp_4, vslice_dummy_var_181, completion_1);
    goto anon84_Then, anon84_Else;
  ...
  anon78_Else:
    assume Irp_4 == SLAM_guard_S_0;
    assume SLAM_guard_S_0 != SLAM_guard_S_0_init;
    call {:si_unique_call 1327} SLIC_sdv_RunIoCompletionRoutines_exit(0, completion_1, sdv_58);
    goto L29;
...
implementation MouseClassCleanupQueue_loop_L49(in_listHead: int, in_sdv_107: int, in_irp: int, in_sdv_108: int, in_entry: int, in_DeviceExtension: int, in_vslice_dummy_var_43: int) returns (out_sdv_107: int, out_irp: int, out_sdv_108: int, out_entry: int, out_vslice_dummy_var_43: int)
{
  ...
  L49:
    call {:si_unique_call 1328} out_sdv_107 := sdv_IsListEmpty(0);
    goto anon15_Else;

  anon15_Else:
    assume {:partition} out_sdv_107 == 0;
    call {:si_unique_call 1329} out_entry := RemoveHeadList(in_listHead);
    call {:si_unique_call 1330} out_sdv_108 := sdv_containing_record(out_entry, 88);
    out_irp := out_sdv_108;
    call {:si_unique_call 1331} sdv_IoCompleteRequest(0, 0);
    assume {:nonnull} in_DeviceExtension != 0;
    assume in_DeviceExtension > 0;
    call {:si_unique_call 1332} out_vslice_dummy_var_43 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(in_DeviceExtension), out_irp);
    goto anon15_Else_dummy;

  anon15_Else_dummy:
    call {:si_unique_call 1333} {:si_old_unique_call 1} out_sdv_107, out_irp, out_sdv_108, out_entry, out_vslice_dummy_var_43 := MouseClassCleanupQueue_loop_L49(in_listHead, out_sdv_107, out_irp, out_sdv_108, out_entry, in_DeviceExtension, out_vslice_dummy_var_43);
    return;
}
...
procedure {:LoopProcedure} MouseClassCleanupQueue_loop_L49(in_listHead: int, in_sdv_107: int, in_irp: int, in_sdv_108: int, in_entry: int, in_DeviceExtension: int, in_vslice_dummy_var_43: int) returns (out_sdv_107: int, out_irp: int, out_sdv_108: int, out_entry: int, out_vslice_dummy_var_43: int);
  modifies alloc;
  free ensures {:va_keep} alloc == old(alloc);
  free ensures {:va_keep} out_sdv_107 == in_sdv_107;
  free ensures {:va_keep} out_irp == in_irp;
  free ensures {:va_keep} out_sdv_108 == in_sdv_108;
  free ensures {:va_keep} out_entry == in_entry;
  free ensures {:va_keep} out_vslice_dummy_var_43 == in_vslice_dummy_var_43;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} false || old(forward_state) == 1 || old(forward_state) == 0;
  free ensures {:va_keep} false || old(s) == 2 || old(s) == 1 || old(s) == 0;
  free ensures {:va_keep} alloc >= old(alloc);
...
implementation MouseClassCleanupQueue_loop_L16(in_listHead: int, in_nextEntry: int, in_sdv_102: int, in_oldCancelRoutine: int, in_irp: int, in_entry: int, in_stack_1: int, in_FileObject_1: int, in_vslice_dummy_var_42: int, in_vslice_dummy_var_44: int) returns (out_nextEntry: int, out_sdv_102: int, out_oldCancelRoutine: int, out_irp: int, out_entry: int, out_stack_1: int, out_vslice_dummy_var_42: int, out_vslice_dummy_var_44: int)
{
  ...
  anon11_Else:
    ...
    assume out_entry > 0;
    havoc out_nextEntry;
    call {:si_unique_call 1338} out_sdv_102 := sdv_containing_record(out_entry, 88);
    out_irp := out_sdv_102;
    call {:si_unique_call 1339} out_stack_1 := sdv_IoGetCurrentIrpStackLocation(out_irp);
    goto anon12_Then, anon12_Else;
  ...
  L31:
    call {:si_unique_call 1336} out_vslice_dummy_var_42 := sdv_RemoveEntryList(0);
    call {:si_unique_call 1337} out_oldCancelRoutine := sdv_IoSetCancelRoutine(out_irp, 0);
    goto anon14_Then, anon14_Else;
  ...
  anon14_Else:
    ...
    assume {:nonnull} out_irp != 0;
    assume out_irp > 0;
    call {:si_unique_call 1334} out_vslice_dummy_var_44 := sdv_InsertTailList(in_listHead, ListEntry_unnamed_tag_6(Overlay_unnamed_tag_5(Tail__IRP(out_irp))));
    goto L35;
  ...
  anon14_Then:
    ...
    assume {:nonnull} out_irp != 0;
    assume out_irp > 0;
    call {:si_unique_call 1335} InitializeListHead(ListEntry_unnamed_tag_6(Overlay_unnamed_tag_5(Tail__IRP(out_irp))));
    goto L35;
...
procedure {:LoopProcedure} MouseClassCleanupQueue_loop_L16(in_listHead: int, in_nextEntry: int, in_sdv_102: int, in_oldCancelRoutine: int, in_irp: int, in_entry: int, in_stack_1: int, in_FileObject_1: int, in_vslice_dummy_var_42: int, in_vslice_dummy_var_44: int) returns (out_nextEntry: int, out_sdv_102: int, out_oldCancelRoutine: int, out_irp: int, out_entry: int, out_stack_1: int, out_vslice_dummy_var_42: int, out_vslice_dummy_var_44: int);
  ...
  free ensures {:va_keep} out_sdv_102 == in_sdv_102;
  free ensures {:va_keep} out_oldCancelRoutine == in_oldCancelRoutine;
  free ensures {:va_keep} out_irp == in_irp;
  free ensures {:va_keep} out_entry == in_entry;
  free ensures {:va_keep} out_stack_1 == in_stack_1;
  free ensures {:va_keep} out_vslice_dummy_var_42 == in_vslice_dummy_var_42;
...
implementation MouseClassLogError_loop_L20(in_i: int, in_errorLogEntry: int, in_Tmp_190: int, in_Tmp_194: int, in_Tmp_195: int, in_DumpCount: int, in_DumpData: int) returns (out_i: int, out_Tmp_190: int, out_Tmp_194: int, out_Tmp_195: int)
{
  ...
  anon5_Else_dummy:
    call {:si_unique_call 1341} {:si_old_unique_call 1} out_i, out_Tmp_190, out_Tmp_194, out_Tmp_195 := MouseClassLogError_loop_L20(out_i, in_errorLogEntry, out_Tmp_190, out_Tmp_194, out_Tmp_195, in_DumpCount, in_DumpData);
    return;
}
...
implementation MouseClassClose_loop_L45(in_i_1: int, in_someEnableDisableSucceeded: int, in_irpSp_1: int, in_notifyHandle_1: int, in_port_2: int, in_Tmp_204: int, in_Tmp_205: int, in_enabled_1: int, in_Tmp_208: int, in_status_5: int, in_Tmp_211: int, in_Tmp_212: int, in_DeviceObject_16: int, in_Irp_8: int, in_vslice_dummy_var_47: int) returns (out_i_1: int, out_someEnableDisableSucceeded: int, out_notifyHandle_1: int, out_port_2: int, out_Tmp_204: int, out_Tmp_205: int, out_enabled_1: int, out_Tmp_208: int, out_status_5: int, out_Tmp_211: int, out_Tmp_212: int, out_vslice_dummy_var_47: int)
{
  ...
  anon43_Else:
    ...
    call {:si_unique_call 1348} out_notifyHandle_1 := _InlineInterlockedExchangePointer(TargetNotifyHandle__DEVICE_EXTENSION(out_Tmp_205), 0);
    goto anon45_Then, anon45_Else;

  anon45_Else:
    assume {:partition} out_notifyHandle_1 != 0;
    call {:si_unique_call 1347} out_vslice_dummy_var_47 := IoUnregisterPlugPlayNotification(0);
    goto L65;
  ...
  L65:
    ...
    call {:si_unique_call 1346} out_status_5 := MouEnableDisablePort#1(0, in_Irp_8, vslice_dummy_var_184, File__PORT(out_port_2));
    goto anon57_Else;
  ...
  anon44_Else:
    ...
    call {:si_unique_call 1343} WPP_RECORDER_SF_q(out_Tmp_208, 0, 1, 29, out_Tmp_212, vslice_dummy_var_182);
    assume {:nonnull} in_irpSp_1 != 0;
    assume in_irpSp_1 > 0;
    havoc vslice_dummy_var_183;
    call {:si_unique_call 1344} MouseClassLogError(in_DeviceObject_16, -1073414134, 20120, out_status_5, 0, 0, vslice_dummy_var_183);
    goto L85;

  L85:
    call {:si_unique_call 1342} ExAcquireFastMutex(0);
    goto L53;
...
implementation MouseClassCreate_loop_L93(in_i_2: int, in_someEnableDisableSucceeded_1: int, in_Tmp_469: int, in_irpSp_6: int, in_Tmp_470: int, in_port_5: int, in_enabled_5: int, in_status_24: int, in_deviceExtension_7: int, in_Tmp_478: int, in_DeviceObject_34: int, in_Irp_26: int) returns (out_i_2: int, out_someEnableDisableSucceeded_1: int, out_Tmp_469: int, out_Tmp_470: int, out_port_5: int, out_enabled_5: int, out_status_24: int, out_Tmp_478: int)
{
  ...
  anon66_Then:
    ...
    assume {:nonnull} out_port_5 != 0;
    assume out_port_5 > 0;
    call {:si_unique_call 1354} ExReleaseFastMutex(0);
    goto anon56_Then, anon56_Else;
  ...
  anon57_Else:
    ...
    call {:si_unique_call 1351} WPP_RECORDER_SF_q(out_Tmp_470, 0, 1, 25, out_Tmp_469, vslice_dummy_var_185);
    assume {:nonnull} in_irpSp_6 != 0;
    assume in_irpSp_6 > 0;
    havoc vslice_dummy_var_186;
    call {:si_unique_call 1352} MouseClassLogError(in_DeviceObject_34, -1073414135, 20120, out_status_24, 0, 0, vslice_dummy_var_186);
    assume {:nonnull} out_port_5 != 0;
    assume out_port_5 > 0;
    goto L125;

  L125:
    call {:si_unique_call 1350} ExAcquireFastMutex(0);
    goto L101;
  ...
  anon56_Then:
    ...
    call {:si_unique_call 1353} out_status_24 := MouEnableDisablePort#1(1, in_Irp_26, vslice_dummy_var_187, File__PORT(out_port_5));
    goto anon67_Else;
