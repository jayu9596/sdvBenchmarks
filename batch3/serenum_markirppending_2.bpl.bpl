...
procedure {:origName "_sdv_init2"} _sdv_init2();
  ...
  free ensures {:va_keep} false || old(completed) == 1 || old(completed) == 0;
  free ensures {:va_keep} false || old(pended) == 1 || old(pended) == 0;
  free ensures {:va_keep} alloc >= old(alloc);
  free ensures {:va_keep} false || completed == 1 || completed == 0;
  free ensures {:va_keep} false || pended == 1 || pended == 0;
...
implementation {:origName "Serenum_GetRegistryKeyValue"} Serenum_GetRegistryKeyValue(actual_Handle: int, actual_KeyNameString: int, actual_KeyNameStringLength: int, actual_Data: int, actual_DataLength: int, actual_ActualLength: int) returns (Tmp_16: int)
{
  ...
  anon20_Else:
    ...
    call {:si_unique_call 19} sdv_RtlCopyMemory(0, 0, vslice_dummy_var_96);
...
implementation {:origName "Serenum_ReenumerateDevices"} Serenum_ReenumerateDevices(actual_Irp_1: int, actual_PFdoData_2: int, actual_PSameDevice: int) returns (Tmp_35: int)
{
  ...
  anon121_Else:
    ...
    call {:si_unique_call 77} Serenum_PDO_EnumMarkMissing(PFdoData_2, vslice_dummy_var_97);
    assume {:nonnull} pdo != 0;
    assume pdo > 0;
    goto L80;
  ...
  anon131_Else:
    ...
    call {:si_unique_call 86} legacyDeviceFound := SerenumCheckForLegacyDevice(PFdoData_2, vslice_dummy_var_98, Tmp_37, hardwareIDs, compIDs, deviceIDs);
    goto L135;
  ...
  anon142_Else:
    ...
    call {:si_unique_call 95} Serenum_InitPDO(vslice_dummy_var_99, PFdoData_2);
    goto L178;
  ...
  anon135_Else:
    ...
    call {:si_unique_call 98} Serenum_PDO_EnumMarkMissing(PFdoData_2, vslice_dummy_var_100);
    assume {:nonnull} pdo != 0;
    assume pdo > 0;
    goto L199;
  ...
  anon132_Then:
    ...
    call {:si_unique_call 111} status_2 := Serenum_ParseData(PFdoData_2, vslice_dummy_var_101, Tmp_38, hardwareIDs, compIDs, deviceIDs, devDesc, serNo, pnpRev);
    assume {:nonnull} DSRMissing != 0;
    assume DSRMissing > 0;
  ...
  anon152_Else:
    ...
    call {:si_unique_call 112} Serenum_PDO_EnumMarkMissing(PFdoData_2, vslice_dummy_var_102);
    assume {:nonnull} pdo != 0;
    assume pdo > 0;
    goto L254;
  ...
  L341:
    ...
    call {:si_unique_call 138} sdv_44 := SerenumCheckForLegacyDevice(PFdoData_2, vslice_dummy_var_103, Tmp_39, hardwareIDs, compIDs, deviceIDs);
  ...
  anon166_Else:
    ...
    call {:si_unique_call 140} Serenum_PDO_EnumMarkMissing(PFdoData_2, vslice_dummy_var_104);
    assume {:nonnull} pdo != 0;
    assume pdo > 0;
    goto L178;
...
implementation {:origName "Serenum_ReadSerialPort"} Serenum_ReadSerialPort(actual_PReadBuffer: int, actual_Buflen: int, actual_Timeout: int, actual_nActual_1: int, actual_PIoStatusBlock: int, actual_FdoData_1: int) returns (Tmp_47: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 189} status_5 := Serenum_IoSyncIoctlEx(1769500, 0, vslice_dummy_var_105, event_2, timeouts_1, 20, 0, 0);
  ...
  anon21_Else:
    ...
    call {:si_unique_call 193} status_5 := sdv_IoCallDriver(vslice_dummy_var_106, pIrp_1);
...
implementation {:origName "PoCallDriver"} {:osmodel} PoCallDriver(actual_DeviceObject_2: int, actual_Irp_2: int) returns (Tmp_87: int)
{
  ...
  L29:
    Tmp_87 := status_7;
    call {:si_unique_call 222} SLIC_PoCallDriver_exit(0, Irp_2);
    goto LM2;
  ...
  anon64_Then:
    ...
    call {:si_unique_call 223} sdv_94 := sdv_RunIoCompletionRoutines(sdv_p_devobj_fdo, Irp_2, vslice_dummy_var_107, completion);
    goto anon81_Then, anon81_Else;

  anon81_Else:
    assume Irp_2 == SLAM_guard_S_0;
    assume SLAM_guard_S_0 != SLAM_guard_S_0_init;
    call {:si_unique_call 224} SLIC_sdv_RunIoCompletionRoutines_exit(strConst__li2bpl9, completion, sdv_94);
    goto anon88_Then, anon88_Else;
  ...
  anon76_Else:
    ...
    call {:si_unique_call 225} sdv_97 := sdv_RunIoCompletionRoutines(sdv_p_devobj_fdo, Irp_2, vslice_dummy_var_108, completion);
    goto anon82_Then, anon82_Else;

  anon82_Else:
    assume Irp_2 == SLAM_guard_S_0;
    assume SLAM_guard_S_0 != SLAM_guard_S_0_init;
    call {:si_unique_call 226} SLIC_sdv_RunIoCompletionRoutines_exit(strConst__li2bpl9, completion, sdv_97);
    goto anon90_Then, anon90_Else;
  ...
  anon68_Else:
    ...
    call {:si_unique_call 227} sdv_95 := sdv_RunIoCompletionRoutines(sdv_p_devobj_fdo, Irp_2, vslice_dummy_var_109, completion);
    goto anon80_Then, anon80_Else;

  anon80_Else:
    assume Irp_2 == SLAM_guard_S_0;
    assume SLAM_guard_S_0 != SLAM_guard_S_0_init;
    call {:si_unique_call 228} SLIC_sdv_RunIoCompletionRoutines_exit(strConst__li2bpl9, completion, sdv_95);
    goto anon86_Then, anon86_Else;
  ...
  anon72_Else:
    ...
    call {:si_unique_call 229} sdv_96 := sdv_RunIoCompletionRoutines(sdv_p_devobj_fdo, Irp_2, vslice_dummy_var_110, completion);
    goto anon79_Then, anon79_Else;

  anon79_Else:
    assume Irp_2 == SLAM_guard_S_0;
    assume SLAM_guard_S_0 != SLAM_guard_S_0_init;
    call {:si_unique_call 230} SLIC_sdv_RunIoCompletionRoutines_exit(strConst__li2bpl9, completion, sdv_96);
    goto anon84_Then, anon84_Else;
...
implementation {:origName "PoSetPowerState"} {:osmodel} PoSetPowerState(actual_DeviceObject_3: int, actual_Type: int, actual_structPtr888State: int) returns (structPtr888Tmp: int)
{
  ...
  anon0:
    call {:si_unique_call 231} State := __HAVOC_malloc(8);
    call {:si_unique_call 232} r_1 := __HAVOC_malloc(8);
    call {:si_unique_call 233} Tmp := __HAVOC_malloc(8);
...
implementation {:origName "sdv_IoSetCompletionRoutine"} {:osmodel} sdv_IoSetCompletionRoutine(actual_pirp_5: int, actual_CompletionRoutine: int, actual_Context_2: int, actual_InvokeOnSuccess: int, actual_InvokeOnError: int, actual_InvokeOnCancel: int)
{
  ...
  anon0:
    call {:si_unique_call 234} vslice_dummy_var_40 := __HAVOC_malloc(4);
    ...
    call {:si_unique_call 235} irpSp := sdv_IoGetNextIrpStackLocation(pirp_5);
...
implementation {:origName "PoStartNextPowerIrp"} {:osmodel} PoStartNextPowerIrp(actual_Irp_3: int)
{
  ...
  anon0:
    call {:si_unique_call 236} vslice_dummy_var_41 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "IoDeleteDevice"} {:osmodel} IoDeleteDevice(actual_DeviceObject_4: int)
{
  ...
  anon0:
    call {:si_unique_call 237} vslice_dummy_var_42 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "sdv_InitializeObjectAttributes"} {:osmodel} sdv_InitializeObjectAttributes(actual_p_1: int, actual_n: int, actual_a: int, actual_r_2: int, actual_s_1: int)
{
  ...
  anon0:
    call {:si_unique_call 238} vslice_dummy_var_43 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "sdv_IoSetNextIrpStackLocation"} {:osmodel} sdv_IoSetNextIrpStackLocation(actual_Irp_4: int)
{
  ...
  anon0:
    call {:si_unique_call 239} vslice_dummy_var_44 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "main"} {:osmodel} main() returns (Tmp_112: int, dup_assertVar: bool)
{
  ...
  anon0:
    ...
    call {:si_unique_call 241} GUID_PCMCIA_BUS_INTERFACE_STANDARD__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 242} GUID_BUS_TYPE_PCMCIA__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_BUS_TYPE_PCMCIA__Loc == GUID_BUS_TYPE_PCMCIA;
    assume GUID_BUS_TYPE_PCMCIA != 0;
    call {:si_unique_call 243} GUID_TRANSLATOR_INTERFACE_STANDARD__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 250} GUID_BUS_TYPE_LPTENUM__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_BUS_TYPE_LPTENUM__Loc == GUID_BUS_TYPE_LPTENUM;
    assume GUID_BUS_TYPE_LPTENUM != 0;
    call {:si_unique_call 251} WHEA_ERROR_PACKET_SECTION_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume WHEA_ERROR_PACKET_SECTION_GUID__Loc == WHEA_ERROR_PACKET_SECTION_GUID;
    assume WHEA_ERROR_PACKET_SECTION_GUID != 0;
    call {:si_unique_call 252} GUID_HWPROFILE_CHANGE_COMPLETE__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_HWPROFILE_CHANGE_COMPLETE__Loc == GUID_HWPROFILE_CHANGE_COMPLETE;
    assume GUID_HWPROFILE_CHANGE_COMPLETE != 0;
    call {:si_unique_call 253} GUID_DEVICE_INTERFACE_ARRIVAL__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_DEVICE_INTERFACE_ARRIVAL__Loc == GUID_DEVICE_INTERFACE_ARRIVAL;
    assume GUID_DEVICE_INTERFACE_ARRIVAL != 0;
    call {:si_unique_call 254} GUID_BUS_TYPE_1394__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_BUS_TYPE_1394__Loc == GUID_BUS_TYPE_1394;
    assume GUID_BUS_TYPE_1394 != 0;
    call {:si_unique_call 255} GUID_AGP_TARGET_BUS_INTERFACE_STANDARD__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 256} GUID_BUS_TYPE_AVC__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_BUS_TYPE_AVC__Loc == GUID_BUS_TYPE_AVC;
    assume GUID_BUS_TYPE_AVC != 0;
    call {:si_unique_call 257} GUID_TARGET_DEVICE_REMOVE_CANCELLED__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 258} GUID_BUS_TYPE_ISAPNP__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_BUS_TYPE_ISAPNP__Loc == GUID_BUS_TYPE_ISAPNP;
    assume GUID_BUS_TYPE_ISAPNP != 0;
    call {:si_unique_call 259} GUID_MF_ENUMERATION_INTERFACE__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_MF_ENUMERATION_INTERFACE__Loc == GUID_MF_ENUMERATION_INTERFACE;
    assume GUID_MF_ENUMERATION_INTERFACE != 0;
    call {:si_unique_call 260} GUID_ACPI_PORT_RANGES_INTERFACE_STANDARD__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 261} GUID_DEVINTERFACE_SERENUM_BUS_ENUMERATOR__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 262} GUID_LEGACY_DEVICE_DETECTION_STANDARD__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 263} GUID_BUS_TYPE_USB__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_BUS_TYPE_USB__Loc == GUID_BUS_TYPE_USB;
    assume GUID_BUS_TYPE_USB != 0;
    call {:si_unique_call 264} GUID_INT_ROUTE_INTERFACE_STANDARD__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 265} GUID_BUS_INTERFACE_STANDARD__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_BUS_INTERFACE_STANDARD__Loc == GUID_BUS_INTERFACE_STANDARD;
    assume GUID_BUS_INTERFACE_STANDARD != 0;
    call {:si_unique_call 266} GUID_PROCESSOR_PCC_INTERFACE_STANDARD__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 267} GUID_BUS_TYPE_USBPRINT__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_BUS_TYPE_USBPRINT__Loc == GUID_BUS_TYPE_USBPRINT;
    assume GUID_BUS_TYPE_USBPRINT != 0;
    call {:si_unique_call 268} GUID_PNP_POWER_SETTING_CHANGE__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_PNP_POWER_SETTING_CHANGE__Loc == GUID_PNP_POWER_SETTING_CHANGE;
    assume GUID_PNP_POWER_SETTING_CHANGE != 0;
    call {:si_unique_call 269} GUID_BUS_TYPE_PCI__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_BUS_TYPE_PCI__Loc == GUID_BUS_TYPE_PCI;
    assume GUID_BUS_TYPE_PCI != 0;
    call {:si_unique_call 270} GUID_TARGET_DEVICE_QUERY_REMOVE__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_TARGET_DEVICE_QUERY_REMOVE__Loc == GUID_TARGET_DEVICE_QUERY_REMOVE;
    assume GUID_TARGET_DEVICE_QUERY_REMOVE != 0;
    call {:si_unique_call 271} GUID_PCI_EXPRESS_LINK_QUIESCENT_INTERFACE__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 272} GUID_PCI_BUS_INTERFACE_STANDARD__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_PCI_BUS_INTERFACE_STANDARD__Loc == GUID_PCI_BUS_INTERFACE_STANDARD;
    assume GUID_PCI_BUS_INTERFACE_STANDARD != 0;
    call {:si_unique_call 273} GUID_BUS_TYPE_DOT4PRT__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_BUS_TYPE_DOT4PRT__Loc == GUID_BUS_TYPE_DOT4PRT;
    assume GUID_BUS_TYPE_DOT4PRT != 0;
    call {:si_unique_call 274} GUID_HWPROFILE_QUERY_CHANGE__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_HWPROFILE_QUERY_CHANGE__Loc == GUID_HWPROFILE_QUERY_CHANGE;
    assume GUID_HWPROFILE_QUERY_CHANGE != 0;
    call {:si_unique_call 275} GUID_BUS_TYPE_EISA__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_BUS_TYPE_EISA__Loc == GUID_BUS_TYPE_EISA;
    assume GUID_BUS_TYPE_EISA != 0;
    call {:si_unique_call 276} GUID_POWER_DEVICE_ENABLE__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_POWER_DEVICE_ENABLE__Loc == GUID_POWER_DEVICE_ENABLE;
    assume GUID_POWER_DEVICE_ENABLE != 0;
    call {:si_unique_call 277} GUID_PCI_EXPRESS_ROOT_PORT_INTERFACE__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 278} GUID_PNP_CUSTOM_NOTIFICATION__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_PNP_CUSTOM_NOTIFICATION__Loc == GUID_PNP_CUSTOM_NOTIFICATION;
    assume GUID_PNP_CUSTOM_NOTIFICATION != 0;
    call {:si_unique_call 279} GUID_ACPI_REGS_INTERFACE_STANDARD__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 280} GUID_BUS_TYPE_SD__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_BUS_TYPE_SD__Loc == GUID_BUS_TYPE_SD;
    assume GUID_BUS_TYPE_SD != 0;
    call {:si_unique_call 281} GUID_PNP_POWER_NOTIFICATION__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_PNP_POWER_NOTIFICATION__Loc == GUID_PNP_POWER_NOTIFICATION;
    assume GUID_PNP_POWER_NOTIFICATION != 0;
    call {:si_unique_call 282} GUID_TARGET_DEVICE_TRANSPORT_RELATIONS_CHANGED__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 283} GUID_ACPI_INTERFACE_STANDARD2__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_ACPI_INTERFACE_STANDARD2__Loc == GUID_ACPI_INTERFACE_STANDARD2;
    assume GUID_ACPI_INTERFACE_STANDARD2 != 0;
    call {:si_unique_call 284} GUID_DEVINTERFACE_COMPORT__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_DEVINTERFACE_COMPORT__Loc == GUID_DEVINTERFACE_COMPORT;
    assume GUID_DEVINTERFACE_COMPORT != 0;
    call {:si_unique_call 285} GUID_PARTITION_UNIT_INTERFACE_STANDARD__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 286} GUID_BUS_TYPE_IRDA__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_BUS_TYPE_IRDA__Loc == GUID_BUS_TYPE_IRDA;
    assume GUID_BUS_TYPE_IRDA != 0;
    call {:si_unique_call 287} GUID_REENUMERATE_SELF_INTERFACE_STANDARD__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 288} GUID_BUS_TYPE_HID__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_BUS_TYPE_HID__Loc == GUID_BUS_TYPE_HID;
    assume GUID_BUS_TYPE_HID != 0;
    call {:si_unique_call 289} GUID_WUDF_DEVICE_HOST_PROBLEM__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_WUDF_DEVICE_HOST_PROBLEM__Loc == GUID_WUDF_DEVICE_HOST_PROBLEM;
    assume GUID_WUDF_DEVICE_HOST_PROBLEM != 0;
    call {:si_unique_call 290} GUID_DEVICE_INTERFACE_REMOVAL__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_DEVICE_INTERFACE_REMOVAL__Loc == GUID_DEVICE_INTERFACE_REMOVAL;
    assume GUID_DEVICE_INTERFACE_REMOVAL != 0;
    call {:si_unique_call 291} GUID_TARGET_DEVICE_REMOVE_COMPLETE__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 292} GUID_BUS_TYPE_SERENUM__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 294} GUID_PCI_DEVICE_PRESENT_INTERFACE__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 295} GUID_BUS_TYPE_MCA__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_BUS_TYPE_MCA__Loc == GUID_BUS_TYPE_MCA;
    assume GUID_BUS_TYPE_MCA != 0;
    call {:si_unique_call 296} GUID_POWER_DEVICE_WAKE_ENABLE__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_POWER_DEVICE_WAKE_ENABLE__Loc == GUID_POWER_DEVICE_WAKE_ENABLE;
    assume GUID_POWER_DEVICE_WAKE_ENABLE != 0;
    call {:si_unique_call 297} sdv_harnessStackLocation_next__Loc := __HAVOC_malloc_or_null(496);
    assume sdv_harnessStackLocation_next__Loc == sdv_harnessStackLocation_next;
    assume sdv_harnessStackLocation_next != 0;
    call {:si_unique_call 298} sdv_IoReadPartitionTableEx_DRIVE_LAYOUT_INFORMATION_EX__Loc := __HAVOC_malloc_or_null(76);
    assume sdv_IoReadPartitionTableEx_DRIVE_LAYOUT_INFORMATION_EX__Loc == sdv_IoReadPartitionTableEx_DRIVE_LAYOUT_INFORMATION_EX;
    assume sdv_IoReadPartitionTableEx_DRIVE_LAYOUT_INFORMATION_EX != 0;
    call {:si_unique_call 299} sdv_IoBuildAsynchronousFsdRequest_harnessIrp__Loc := __HAVOC_malloc_or_null(248);
    assume sdv_IoBuildAsynchronousFsdRequest_harnessIrp__Loc == sdv_IoBuildAsynchronousFsdRequest_harnessIrp;
    assume sdv_IoBuildAsynchronousFsdRequest_harnessIrp != 0;
    call {:si_unique_call 300} sdv_IoGetDeviceToVerify_DEVICE_OBJECT__Loc := __HAVOC_malloc_or_null(320);
    assume sdv_IoGetDeviceToVerify_DEVICE_OBJECT__Loc == sdv_IoGetDeviceToVerify_DEVICE_OBJECT;
    assume sdv_IoGetDeviceToVerify_DEVICE_OBJECT != 0;
    call {:si_unique_call 301} sdv_IoBuildDeviceIoControlRequest_harnessStackLocation_next__Loc := __HAVOC_malloc_or_null(496);
    ...
    call {:si_unique_call 303} sdv_ControllerIrp__Loc := __HAVOC_malloc_or_null(248);
    assume sdv_ControllerIrp__Loc == sdv_ControllerIrp;
    assume sdv_ControllerIrp != 0;
    call {:si_unique_call 304} sdv_devobj_pdo__Loc := __HAVOC_malloc_or_null(320);
    ...
    call {:si_unique_call 306} sdv_IoInitializeIrp_harnessIrp__Loc := __HAVOC_malloc_or_null(248);
    assume sdv_IoInitializeIrp_harnessIrp__Loc == sdv_IoInitializeIrp_harnessIrp;
    assume sdv_IoInitializeIrp_harnessIrp != 0;
    call {:si_unique_call 307} sdv_IoGetRelatedDeviceObject_DEVICE_OBJECT__Loc := __HAVOC_malloc_or_null(320);
    assume sdv_IoGetRelatedDeviceObject_DEVICE_OBJECT__Loc == sdv_IoGetRelatedDeviceObject_DEVICE_OBJECT;
    assume sdv_IoGetRelatedDeviceObject_DEVICE_OBJECT != 0;
    call {:si_unique_call 308} sdv_IoBuildSynchronousFsdRequest_harnessStackLocation_next__Loc := __HAVOC_malloc_or_null(496);
    assume sdv_IoBuildSynchronousFsdRequest_harnessStackLocation_next__Loc == sdv_IoBuildSynchronousFsdRequest_harnessStackLocation_next;
    assume sdv_IoBuildSynchronousFsdRequest_harnessStackLocation_next != 0;
    call {:si_unique_call 309} sdv_IoCreateSynchronizationEvent_KEVENT__Loc := __HAVOC_malloc_or_null(124);
    assume sdv_IoCreateSynchronizationEvent_KEVENT__Loc == sdv_IoCreateSynchronizationEvent_KEVENT;
    assume sdv_IoCreateSynchronizationEvent_KEVENT != 0;
    call {:si_unique_call 310} sdv_harnessStackLocation__Loc := __HAVOC_malloc_or_null(496);
    assume sdv_harnessStackLocation__Loc == sdv_harnessStackLocation;
    assume sdv_harnessStackLocation != 0;
    call {:si_unique_call 311} sdv_other_harnessStackLocation_next__Loc := __HAVOC_malloc_or_null(496);
    ...
    call {:si_unique_call 313} sdv_devobj_top__Loc := __HAVOC_malloc_or_null(320);
    assume sdv_devobj_top__Loc == sdv_devobj_top;
    assume sdv_devobj_top != 0;
    call {:si_unique_call 314} sdv_kdpc_val3__Loc := __HAVOC_malloc_or_null(40);
    assume sdv_kdpc_val3__Loc == sdv_kdpc_val3;
    assume sdv_kdpc_val3 != 0;
    call {:si_unique_call 315} sdv_IoBuildSynchronousFsdRequest_harnessIrp__Loc := __HAVOC_malloc_or_null(248);
    assume sdv_IoBuildSynchronousFsdRequest_harnessIrp__Loc == sdv_IoBuildSynchronousFsdRequest_harnessIrp;
    assume sdv_IoBuildSynchronousFsdRequest_harnessIrp != 0;
    call {:si_unique_call 316} sdv_IoGetDeviceObjectPointer_DEVICE_OBJECT__Loc := __HAVOC_malloc_or_null(320);
    ...
    call {:si_unique_call 319} sdv_IoMakeAssociatedIrp_harnessIrp__Loc := __HAVOC_malloc_or_null(248);
    assume sdv_IoMakeAssociatedIrp_harnessIrp__Loc == sdv_IoMakeAssociatedIrp_harnessIrp;
    assume sdv_IoMakeAssociatedIrp_harnessIrp != 0;
    call {:si_unique_call 320} sdv_devobj_child_pdo__Loc := __HAVOC_malloc_or_null(320);
    assume sdv_devobj_child_pdo__Loc == sdv_devobj_child_pdo;
    assume sdv_devobj_child_pdo != 0;
    call {:si_unique_call 321} sdv_harnessIrp__Loc := __HAVOC_malloc_or_null(248);
    assume sdv_harnessIrp__Loc == sdv_harnessIrp;
    assume sdv_harnessIrp != 0;
    call {:si_unique_call 322} sdv_IoBuildAsynchronousFsdRequest_harnessStackLocation_next__Loc := __HAVOC_malloc_or_null(496);
    ...
    call {:si_unique_call 325} sdv_devobj_fdo__Loc := __HAVOC_malloc_or_null(320);
    assume sdv_devobj_fdo__Loc == sdv_devobj_fdo;
    assume sdv_devobj_fdo != 0;
    call {:si_unique_call 326} sdv_StartIoIrp__Loc := __HAVOC_malloc_or_null(248);
    assume sdv_StartIoIrp__Loc == sdv_StartIoIrp;
    assume sdv_StartIoIrp != 0;
    call {:si_unique_call 327} sdv_harness_IoBuildAsynchronousFsdRequest_IoStatusBlock__Loc := __HAVOC_malloc_or_null(12);
    assume sdv_harness_IoBuildAsynchronousFsdRequest_IoStatusBlock__Loc == sdv_harness_IoBuildAsynchronousFsdRequest_IoStatusBlock;
    assume sdv_harness_IoBuildAsynchronousFsdRequest_IoStatusBlock != 0;
    call {:si_unique_call 328} sdv_PowerIrp__Loc := __HAVOC_malloc_or_null(248);
    assume sdv_PowerIrp__Loc == sdv_PowerIrp;
    assume sdv_PowerIrp != 0;
    call {:si_unique_call 329} sdv_IoBuildDeviceIoControlRequest_harnessIrp__Loc := __HAVOC_malloc_or_null(248);
    assume sdv_IoBuildDeviceIoControlRequest_harnessIrp__Loc == sdv_IoBuildDeviceIoControlRequest_harnessIrp;
    assume sdv_IoBuildDeviceIoControlRequest_harnessIrp != 0;
    call {:si_unique_call 330} sdv_other_harnessIrp__Loc := __HAVOC_malloc_or_null(248);
    assume sdv_other_harnessIrp__Loc == sdv_other_harnessIrp;
    assume sdv_other_harnessIrp != 0;
    call {:si_unique_call 331} sdv_IoCreateNotificationEvent_KEVENT__Loc := __HAVOC_malloc_or_null(124);
    assume sdv_IoCreateNotificationEvent_KEVENT__Loc == sdv_IoCreateNotificationEvent_KEVENT;
    assume sdv_IoCreateNotificationEvent_KEVENT != 0;
    call {:si_unique_call 332} sdv_other_harnessStackLocation__Loc := __HAVOC_malloc_or_null(496);
    assume sdv_other_harnessStackLocation__Loc == sdv_other_harnessStackLocation;
    assume sdv_other_harnessStackLocation != 0;
    call {:si_unique_call 333} SLAM_guard_S_0_init__Loc := __HAVOC_malloc_or_null(248);
    ...
    call {:si_unique_call 339} boogieTmp := __HAVOC_malloc_or_null(248);
    assume sicrni == boogieTmp;
    call {:si_unique_call 340} boogieTmp := __HAVOC_malloc_or_null(4);
    assume NlsMbCodePageTag == boogieTmp;
    call {:si_unique_call 341} vslice_dummy_var_109 := __HAVOC_malloc(4);
    call {:si_unique_call 342} vslice_dummy_var_110 := __HAVOC_malloc(4);
    call {:si_unique_call 343} vslice_dummy_var_111 := __HAVOC_malloc(4);
    call {:si_unique_call 344} vslice_dummy_var_112 := __HAVOC_malloc(4);
    call {:si_unique_call 345} vslice_dummy_var_113 := __HAVOC_malloc(4);
    call {:si_unique_call 346} vslice_dummy_var_114 := __HAVOC_malloc(4);
    call {:si_unique_call 347} vslice_dummy_var_115 := __HAVOC_malloc(4);
    call {:si_unique_call 348} vslice_dummy_var_116 := __HAVOC_malloc(4);
    call {:si_unique_call 349} vslice_dummy_var_117 := __HAVOC_malloc(4);
    call {:si_unique_call 350} vslice_dummy_var_118 := __HAVOC_malloc(4);
    call {:si_unique_call 351} vslice_dummy_var_119 := __HAVOC_malloc(4);
    call {:si_unique_call 352} vslice_dummy_var_120 := __HAVOC_malloc(4);
    call {:si_unique_call 353} vslice_dummy_var_121 := __HAVOC_malloc(4);
    call {:si_unique_call 354} vslice_dummy_var_122 := __HAVOC_malloc(4);
    call {:si_unique_call 355} vslice_dummy_var_123 := __HAVOC_malloc(4);
    call {:si_unique_call 356} vslice_dummy_var_124 := __HAVOC_malloc(4);
    call {:si_unique_call 357} vslice_dummy_var_125 := __HAVOC_malloc(4);
    call {:si_unique_call 358} vslice_dummy_var_126 := __HAVOC_malloc(4);
    call {:si_unique_call 359} vslice_dummy_var_127 := __HAVOC_malloc(4);
    call {:si_unique_call 360} vslice_dummy_var_128 := __HAVOC_malloc(4);
    call {:si_unique_call 361} vslice_dummy_var_129 := __HAVOC_malloc(4);
    call {:si_unique_call 362} vslice_dummy_var_130 := __HAVOC_malloc(4);
    call {:si_unique_call 363} vslice_dummy_var_131 := __HAVOC_malloc(4);
    call {:si_unique_call 364} vslice_dummy_var_132 := __HAVOC_malloc(4);
    call {:si_unique_call 365} vslice_dummy_var_133 := __HAVOC_malloc(4);
    call {:si_unique_call 366} vslice_dummy_var_134 := __HAVOC_malloc(4);
    call {:si_unique_call 367} vslice_dummy_var_135 := __HAVOC_malloc(4);
    call {:si_unique_call 368} vslice_dummy_var_136 := __HAVOC_malloc(4);
    call {:si_unique_call 369} vslice_dummy_var_137 := __HAVOC_malloc(4);
    call {:si_unique_call 370} vslice_dummy_var_138 := __HAVOC_malloc(4);
    call {:si_unique_call 371} vslice_dummy_var_139 := __HAVOC_malloc(4);
    call {:si_unique_call 372} vslice_dummy_var_140 := __HAVOC_malloc(4);
    call {:si_unique_call 373} vslice_dummy_var_141 := __HAVOC_malloc(4);
    call {:si_unique_call 374} vslice_dummy_var_142 := __HAVOC_malloc(4);
    call {:si_unique_call 375} vslice_dummy_var_143 := __HAVOC_malloc(4);
    assume {:mainInitDone} true;
    call {:si_unique_call 376} corralExtraInit();
    call {:si_unique_call 377} corralExplainErrorInit();
    call {:si_unique_call 378} _sdv_init9();
    call {:si_unique_call 379} _sdv_init1();
    call {:si_unique_call 380} _sdv_init4();
    call {:si_unique_call 381} _sdv_init5();
    call {:si_unique_call 382} _sdv_init3();
    call {:si_unique_call 383} _sdv_init6();
    call {:si_unique_call 384} _sdv_init7();
    call {:si_unique_call 385} _sdv_init2();
    goto anon9_Then, anon9_Else;
  ...
  L36:
    ...
    call {:si_unique_call 386} sdv_main();
    goto anon12_Then, anon12_Else;
...
implementation {:origName "sdv_IoSkipCurrentIrpStackLocation"} {:osmodel} sdv_IoSkipCurrentIrpStackLocation(actual_pirp_7: int)
{
  ...
  anon0:
    call {:si_unique_call 387} vslice_dummy_var_45 := __HAVOC_malloc(4);
...
implementation {:origName "RtlInitUnicodeString"} {:osmodel} RtlInitUnicodeString(actual_DestinationString_1: int, actual_SourceString_1: int)
{
  ...
  anon0:
    call {:si_unique_call 388} vslice_dummy_var_46 := __HAVOC_malloc(4);
...
implementation {:origName "sdv_RunDispatchFunction"} {:osmodel} sdv_RunDispatchFunction(actual_po: int, actual_pirp_9: int) returns (Tmp_134: int)
{
  ...
  anon0:
    ...
    assume {:nonnull} pirp_9 != 0;
    assume pirp_9 > 0;
    call {:si_unique_call 393} sdv_SetStatus(pirp_9);
    assume {:nonnull} pirp_9 != 0;
    assume pirp_9 > 0;
    assume {:nonnull} pirp_9 != 0;
    assume pirp_9 > 0;
    ...
    call {:si_unique_call 394} sdv_stub_dispatch_begin();
    goto anon73_Then, anon73_Else;
  ...
  L66:
    call {:si_unique_call 395} status_8 := Serenum_PnP(po, pirp_9);
  ...
  anon97_Else:
    ...
    assume SLAM_guard_S_0 != SLAM_guard_S_0_init;
    call {:si_unique_call 396} SLIC_Serenum_PnP_exit(strConst__li2bpl9, status_8);
  ...
  L72:
    call {:si_unique_call 397} sdv_stub_dispatch_end(status_8, 0);
    assume {:nonnull} pirp_9 != 0;
    assume pirp_9 > 0;
    Tmp_134 := status_8;
    goto LM2;
  ...
  anon78_Then:
    call {:si_unique_call 398} status_8 := sdv_DoNothing();
    goto L72;

  anon79_Then:
    assume {:nonnull} ps != 0;
    assume ps > 0;
    call {:si_unique_call 399} status_8 := sdv_DoNothing();
    goto L72;

  anon80_Then:
    assume {:nonnull} ps != 0;
    assume ps > 0;
    call {:si_unique_call 400} sdv_SetPowerIrpMinorFunction(pirp_9);
    call {:si_unique_call 401} status_8 := Serenum_Power(po, pirp_9);
  ...
  anon96_Else:
    assume pirp_9 == SLAM_guard_S_0;
    assume SLAM_guard_S_0 != SLAM_guard_S_0_init;
    call {:si_unique_call 402} SLIC_Serenum_Power_exit(strConst__li2bpl9, status_8);
  ...
  anon82_Then:
    call {:si_unique_call 404} status_8 := sdv_DoNothing();
    goto L72;
  ...
  anon85_Then:
    assume {:nonnull} ps != 0;
    assume ps > 0;
    call {:si_unique_call 407} status_8 := Serenum_IoCtl(po, pirp_9);
    goto anon102_Then, anon102_Else;
  ...
  anon95_Else:
    assume pirp_9 == SLAM_guard_S_0;
    assume SLAM_guard_S_0 != SLAM_guard_S_0_init;
    call {:si_unique_call 408} SLIC_Serenum_IoCtl_exit(strConst__li2bpl9, status_8);
  ...
  anon88_Then:
    assume {:nonnull} ps != 0;
    assume ps > 0;
    call {:si_unique_call 411} status_8 := sdv_DoNothing();
    goto L72;

  anon89_Then:
    assume {:nonnull} ps != 0;
    assume ps > 0;
    call {:si_unique_call 412} status_8 := sdv_DoNothing();
    goto L72;

  anon90_Then:
    assume {:nonnull} ps != 0;
    assume ps > 0;
    call {:si_unique_call 413} status_8 := sdv_DoNothing();
    goto L72;

  anon91_Then:
    assume {:nonnull} ps != 0;
    assume ps > 0;
    call {:si_unique_call 414} status_8 := sdv_DoNothing();
    goto L72;

  anon92_Then:
    assume {:nonnull} ps != 0;
    assume ps > 0;
    call {:si_unique_call 415} status_8 := Serenum_CreateClose(po, pirp_9);
    goto anon100_Then, anon100_Else;
  ...
  anon94_Else:
    assume pirp_9 == SLAM_guard_S_0;
    assume SLAM_guard_S_0 != SLAM_guard_S_0_init;
    call {:si_unique_call 416} SLIC_Serenum_CreateClose_exit(strConst__li2bpl9, status_8);
    goto anon101_Then, anon101_Else;
  ...
  anon73_Then:
    assume {:nonnull} ps != 0;
    assume ps > 0;
    call {:si_unique_call 417} status_8 := Serenum_CreateClose(po, pirp_9);
    goto anon98_Then, anon98_Else;
  ...
  anon93_Else:
    assume pirp_9 == SLAM_guard_S_0;
    assume SLAM_guard_S_0 != SLAM_guard_S_0_init;
    call {:si_unique_call 418} SLIC_Serenum_CreateClose_exit(strConst__li2bpl9, status_8);
    goto anon99_Then, anon99_Else;
...
implementation {:origName "RtlFreeUnicodeString"} {:osmodel} RtlFreeUnicodeString(actual_UnicodeString: int)
{
  ...
  anon0:
    call {:si_unique_call 419} vslice_dummy_var_51 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "sdv_KeReleaseSpinLock"} {:osmodel} sdv_KeReleaseSpinLock(actual_SpinLock_1: int, actual_new: int)
{
  ...
  anon0:
    call {:si_unique_call 420} vslice_dummy_var_52 := __HAVOC_malloc(4);
    new := actual_new;
    return;
}
...
implementation {:origName "sdv_IoCompleteRequest"} {:osmodel} sdv_IoCompleteRequest(actual_pirp_10: int, actual_PriorityBoost: int)
{
  ...
  anon0:
    call {:si_unique_call 421} vslice_dummy_var_53 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "sdv_RtlCopyMemory"} {:osmodel} sdv_RtlCopyMemory(actual_Destination_1: int, actual_Source: int, actual_Length_2: int)
{
  ...
  anon0:
    call {:si_unique_call 422} vslice_dummy_var_54 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "sdv_ExFreePool"} {:osmodel} sdv_ExFreePool(actual_P: int)
{
  ...
  anon0:
    call {:si_unique_call 423} vslice_dummy_var_55 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "IoAllocateIrp"} {:osmodel} IoAllocateIrp(actual_StackSize: int, actual_ChargeQuota: int) returns (Tmp_159: int)
{
  ...
  anon3_Else:
    assume {:nonnull} sdv_other_irp != 0;
    assume sdv_other_irp > 0;
    call {:si_unique_call 424} irpSp_1 := sdv_IoGetNextIrpStackLocation(sdv_other_irp);
...
implementation {:origName "IofCallDriver"} {:osmodel} IofCallDriver(actual_DeviceObject_6: int, actual_Irp_5: int) returns (Tmp_161: int)
{
  ...
  anon0:
    call {:si_unique_call 425} completion_1 := __HAVOC_malloc(4);
    Irp_5 := actual_Irp_5;
  ...
  anon63_Then:
    ...
    call {:si_unique_call 426} sdv_129 := sdv_RunIoCompletionRoutines(sdv_p_devobj_fdo, Irp_5, vslice_dummy_var_111, completion_1);
    goto anon80_Then, anon80_Else;

  anon80_Else:
    assume Irp_5 == SLAM_guard_S_0;
    assume SLAM_guard_S_0 != SLAM_guard_S_0_init;
    call {:si_unique_call 427} SLIC_sdv_RunIoCompletionRoutines_exit(strConst__li2bpl9, completion_1, sdv_129);
    goto anon88_Then, anon88_Else;
  ...
  anon75_Else:
    ...
    call {:si_unique_call 428} sdv_131 := sdv_RunIoCompletionRoutines(sdv_p_devobj_fdo, Irp_5, vslice_dummy_var_112, completion_1);
    goto anon81_Then, anon81_Else;

  anon81_Else:
    assume Irp_5 == SLAM_guard_S_0;
    assume SLAM_guard_S_0 != SLAM_guard_S_0_init;
    call {:si_unique_call 429} SLIC_sdv_RunIoCompletionRoutines_exit(strConst__li2bpl9, completion_1, sdv_131);
    goto anon90_Then, anon90_Else;
  ...
  anon67_Else:
    ...
    call {:si_unique_call 430} sdv_130 := sdv_RunIoCompletionRoutines(sdv_p_devobj_fdo, Irp_5, vslice_dummy_var_113, completion_1);
    goto anon79_Then, anon79_Else;

  anon79_Else:
    assume Irp_5 == SLAM_guard_S_0;
    assume SLAM_guard_S_0 != SLAM_guard_S_0_init;
    call {:si_unique_call 431} SLIC_sdv_RunIoCompletionRoutines_exit(strConst__li2bpl9, completion_1, sdv_130);
    goto anon86_Then, anon86_Else;
  ...
  anon71_Else:
    ...
    call {:si_unique_call 432} sdv_132 := sdv_RunIoCompletionRoutines(sdv_p_devobj_fdo, Irp_5, vslice_dummy_var_114, completion_1);
    goto anon78_Then, anon78_Else;

  anon78_Else:
    assume Irp_5 == SLAM_guard_S_0;
    assume SLAM_guard_S_0 != SLAM_guard_S_0_init;
    call {:si_unique_call 433} SLIC_sdv_RunIoCompletionRoutines_exit(strConst__li2bpl9, completion_1, sdv_132);
    goto anon84_Then, anon84_Else;
...
implementation {:origName "sdv_RunIoCompletionRoutines"} {:osmodel} sdv_RunIoCompletionRoutines(actual_DeviceObject_7: int, actual_Irp_6: int, actual_Context_3: int, actual_Completion: int) returns (Tmp_165: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 434} irpsp := sdv_IoGetNextIrpStackLocation(Irp_6);
    Status := 0;
    assume {:nonnull} irpsp != 0;
    assume irpsp > 0;
    goto anon9_Then, anon9_Else;
  ...
  anon9_Else:
    ...
    call {:si_unique_call 435} Status := SerenumSyncCompletion(DeviceObject_7, Irp_6, Context_3);
    assume {:nonnull} Completion != 0;
    assume Completion > 0;
    goto L11;
  ...
  anon7_Else:
    ...
    call {:si_unique_call 436} Status := Serenum_EnumComplete(DeviceObject_7, Irp_6, Context_3);
    assume {:nonnull} Completion != 0;
    assume Completion > 0;
    goto L28;
  ...
  anon8_Else:
    ...
    call {:si_unique_call 437} Status := Serenum_FDOPowerComplete(DeviceObject_7, Irp_6, Context_3);
    assume {:nonnull} Completion != 0;
    assume Completion > 0;
    goto L45;
...
implementation {:origName "KeInitializeEvent"} {:osmodel} KeInitializeEvent(actual_Event_2: int, actual_Type_2: int, actual_State_1: int)
{
  ...
  anon0:
    call {:si_unique_call 438} vslice_dummy_var_56 := __HAVOC_malloc(4);
...
implementation {:origName "KeInitializeTimer"} {:osmodel} KeInitializeTimer(actual_Timer_2: int)
{
  ...
  anon0:
    call {:si_unique_call 439} vslice_dummy_var_57 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "sdv_IoCallDriver"} {:osmodel} sdv_IoCallDriver(actual_DeviceObject_8: int, actual_Irp_7: int) returns (Tmp_171: int)
{
  ...
  anon0:
    Irp_7 := actual_Irp_7;
    call {:si_unique_call 440} Tmp_171 := IofCallDriver(0, Irp_7);
    goto anon3_Then, anon3_Else;

  anon3_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 441} SLIC_sdv_IoCallDriver_exit(0, Irp_7);
    goto LM2;
...
implementation {:origName "IoFreeIrp"} {:osmodel} IoFreeIrp(actual_pirp_11: int)
{
  ...
  anon0:
    call {:si_unique_call 442} vslice_dummy_var_58 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "ExAllocatePoolWithTag"} {:osmodel} ExAllocatePoolWithTag(actual_PoolType: int, actual_NumberOfBytes: int, actual_Tag: int) returns (Tmp_182: int)
{
  ...
  anon3_Else:
    call {:si_unique_call 443} sdv_142 := __HAVOC_malloc(NumberOfBytes);
    Tmp_182 := sdv_142;
    goto L1;
...
implementation {:origName "IoAllocateWorkItem"} {:osmodel} IoAllocateWorkItem(actual_DeviceObject_10: int) returns (Tmp_184: int)
{
  ...
  anon0:
    call {:si_unique_call 444} sdv_144 := __HAVOC_malloc(1);
    ioWorkItem := sdv_144;
    goto anon6_Then, anon6_Else;
...
implementation {:origName "sdv_stub_driver_init"} {:osmodel} sdv_stub_driver_init()
{
  ...
  anon0:
    call {:si_unique_call 445} vslice_dummy_var_59 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "sdv_stub_dispatch_begin"} {:osmodel} sdv_stub_dispatch_begin()
{
  ...
  anon0:
    call {:si_unique_call 446} vslice_dummy_var_60 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "KeClearEvent"} {:osmodel} KeClearEvent(actual_Event_4: int)
{
  ...
  anon0:
    call {:si_unique_call 447} vslice_dummy_var_61 := __HAVOC_malloc(4);
...
implementation {:origName "SLIC_Serenum_IoCtl_exit"} {:osmodel} SLIC_Serenum_IoCtl_exit(actual_caller: int, actual_Serenum: int)
{
  ...
  L6:
    call {:si_unique_call 448} SLIC_EXIT_ROUTINE(strConst__li2bpl10);
    goto L2;
  ...
  anon8_Then:
    assume {:partition} Serenum != 259;
    call {:si_unique_call 449} SLIC_ABORT_5_0(caller, Serenum);
    goto anon9_Then, anon9_Else;
...
procedure {:origName "SLIC_ABORT_14_0"} SLIC_ABORT_14_0(actual_caller_2: int, actual_sdv_148: int, actual_sdv_149: int);
  modifies yogi_error;
  free ensures {:va_keep} old(completed) == 1 ==> yogi_error == 1;
  free ensures {:va_keep} old(completed) == 0 ==> yogi_error == 1;
  free ensures {:va_keep} old(pended) == 1 ==> yogi_error == 1;
...
implementation {:origName "SLIC_ABORT_14_0"} SLIC_ABORT_14_0(actual_caller_2: int, actual_sdv_148: int, actual_sdv_149: int)
{
  ...
  anon0:
    ...
    sdv_148 := actual_sdv_148;
    sdv_149 := actual_sdv_149;
...
procedure {:origName "SLIC_sdv_IoCompleteRequest_entry"} {:osmodel} SLIC_sdv_IoCompleteRequest_entry(actual_caller_3: int, actual_sdv_150: int);
  modifies completed;
  free ensures {:va_keep} old(completed) == 1 ==> completed != 0;
...
implementation {:origName "SLIC_sdv_IoCompleteRequest_entry"} {:osmodel} SLIC_sdv_IoCompleteRequest_entry(actual_caller_3: int, actual_sdv_150: int)
{
  var {:pointer} sdv_150: int;

  anon0:
    sdv_150 := actual_sdv_150;
    assume {:nonnull} sdv_150 != 0;
    assume sdv_150 > 0;
    goto anon3_Then, anon3_Else;

  anon3_Else:
    call {:si_unique_call 451} SLIC_EXIT_ROUTINE(strConst__li2bpl10);
    goto L2;
...
procedure {:origName "SLIC_ABORT_3_0"} SLIC_ABORT_3_0(actual_caller_4: int, actual_Serenum_1: int);
  modifies yogi_error;
  free ensures {:va_keep} old(completed) == 1 ==> yogi_error == 1;
  free ensures {:va_keep} old(completed) == 0 ==> yogi_error == 1;
  free ensures {:va_keep} old(pended) == 1 ==> yogi_error == 1;
...
implementation {:origName "SLIC_ABORT_3_0"} SLIC_ABORT_3_0(actual_caller_4: int, actual_Serenum_1: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 452} SLIC_ERROR_ROUTINE(strConst__li2bpl12);
    return;
}



procedure {:origName "SLIC_Serenum_CreateClose_exit"} {:osmodel} SLIC_Serenum_CreateClose_exit(actual_caller_5: int, actual_Serenum_2: int);
  modifies yogi_error;
  free ensures {:va_keep} old(completed) == 1 ==> yogi_error == 1;
  free ensures {:va_keep} old(completed) == 0 ==> yogi_error == 1;
  free ensures {:va_keep} old(pended) == 1 ==> yogi_error == 1;
...
implementation {:origName "SLIC_Serenum_CreateClose_exit"} {:osmodel} SLIC_Serenum_CreateClose_exit(actual_caller_5: int, actual_Serenum_2: int)
{
  ...
  L6:
    call {:si_unique_call 453} SLIC_EXIT_ROUTINE(strConst__li2bpl10);
    goto L2;
  ...
  anon8_Then:
    assume {:partition} Serenum_2 != 259;
    call {:si_unique_call 454} SLIC_ABORT_7_0(caller_5, Serenum_2);
    goto anon9_Then, anon9_Else;
...
implementation {:origName "SLIC_PoCallDriver_exit"} {:osmodel} SLIC_PoCallDriver_exit(actual_caller_6: int, actual_PoCallDriver_1: int)
{
  ...
  anon3_Else:
    call {:si_unique_call 455} SLIC_EXIT_ROUTINE(strConst__li2bpl10);
    goto L2;
...
procedure {:origName "SLIC_sdv_RunIoCompletionRoutines_exit"} {:osmodel} SLIC_sdv_RunIoCompletionRoutines_exit(actual_caller_8: int, actual_sdv_151: int, actual_sdv_152: int);
  modifies yogi_error;
  free ensures {:va_keep} old(completed) == 0 ==> yogi_error == 0;
  free ensures {:va_keep} yogi_error == 1 || yogi_error == old(yogi_error);
  free ensures {:va_keep} old(yogi_error) == 0;
...
implementation {:origName "SLIC_sdv_RunIoCompletionRoutines_exit"} {:osmodel} SLIC_sdv_RunIoCompletionRoutines_exit(actual_caller_8: int, actual_sdv_151: int, actual_sdv_152: int)
{
  ...
  anon0:
    ...
    sdv_151 := actual_sdv_151;
    sdv_152 := actual_sdv_152;
    assume {:nonnull} sdv_151 != 0;
    assume sdv_151 > 0;
    goto anon17_Then, anon17_Else;
  ...
  anon16_Else:
    assume {:partition} sdv_152 != -1073741802;
    goto anon15_Then, anon15_Else;
  ...
  L10:
    call {:si_unique_call 456} SLIC_ABORT_14_0(caller_8, sdv_151, sdv_152);
    goto anon21_Then, anon21_Else;
  ...
  anon16_Then:
    assume {:partition} sdv_152 == -1073741802;
    call {:si_unique_call 457} SLIC_EXIT_ROUTINE(strConst__li2bpl10);
    goto L2;

  anon17_Then:
    call {:si_unique_call 458} SLIC_EXIT_ROUTINE(strConst__li2bpl10);
    goto L2;
}



procedure {:origName "SLIC_Serenum_PnP_exit"} {:osmodel} SLIC_Serenum_PnP_exit(actual_caller_9: int, actual_Serenum_3: int);
  modifies yogi_error;
  free ensures {:va_keep} old(completed) == 1 ==> yogi_error == 1;
  free ensures {:va_keep} old(completed) == 0 ==> yogi_error == 1;
  free ensures {:va_keep} old(pended) == 1 ==> yogi_error == 1;
...
implementation {:origName "SLIC_Serenum_PnP_exit"} {:osmodel} SLIC_Serenum_PnP_exit(actual_caller_9: int, actual_Serenum_3: int)
{
  ...
  L6:
    call {:si_unique_call 459} SLIC_EXIT_ROUTINE(strConst__li2bpl10);
    goto L2;
  ...
  anon8_Then:
    assume {:partition} Serenum_3 != 259;
    call {:si_unique_call 460} SLIC_ABORT_1_0(caller_9, Serenum_3);
    goto anon9_Then, anon9_Else;
...
procedure {:origName "SLIC_sdv_IoCallDriver_exit"} {:osmodel} SLIC_sdv_IoCallDriver_exit(actual_caller_10: int, actual_sdv_153: int);
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} false || old(completed) == 1 || old(completed) == 0;
  free ensures {:va_keep} false || old(pended) == 1 || old(pended) == 0;
  free ensures {:va_keep} alloc >= old(alloc);
...
implementation {:origName "SLIC_sdv_IoCallDriver_exit"} {:osmodel} SLIC_sdv_IoCallDriver_exit(actual_caller_10: int, actual_sdv_153: int)
{
  var {:pointer} sdv_153: int;

  anon0:
    sdv_153 := actual_sdv_153;
    assume {:nonnull} sdv_153 != 0;
    assume sdv_153 > 0;
    goto anon3_Then, anon3_Else;

  anon3_Else:
    call {:si_unique_call 461} SLIC_EXIT_ROUTINE(strConst__li2bpl10);
    goto L2;
...
procedure {:origName "SLIC_ABORT_7_0"} SLIC_ABORT_7_0(actual_caller_11: int, actual_Serenum_4: int);
  modifies yogi_error;
  free ensures {:va_keep} old(completed) == 1 ==> yogi_error == 1;
  free ensures {:va_keep} old(completed) == 0 ==> yogi_error == 1;
  free ensures {:va_keep} old(pended) == 1 ==> yogi_error == 1;
...
implementation {:origName "SLIC_ABORT_7_0"} SLIC_ABORT_7_0(actual_caller_11: int, actual_Serenum_4: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 462} SLIC_ERROR_ROUTINE(strConst__li2bpl12);
    return;
}



procedure {:origName "SLIC_ABORT_1_0"} SLIC_ABORT_1_0(actual_caller_12: int, actual_Serenum_5: int);
  modifies yogi_error;
  free ensures {:va_keep} old(completed) == 1 ==> yogi_error == 1;
  free ensures {:va_keep} old(completed) == 0 ==> yogi_error == 1;
  free ensures {:va_keep} old(pended) == 1 ==> yogi_error == 1;
...
implementation {:origName "SLIC_ABORT_1_0"} SLIC_ABORT_1_0(actual_caller_12: int, actual_Serenum_5: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 463} SLIC_ERROR_ROUTINE(strConst__li2bpl12);
    return;
}
...
procedure {:origName "SLIC_Serenum_Power_exit"} {:osmodel} SLIC_Serenum_Power_exit(actual_caller_14: int, actual_Serenum_6: int);
  modifies yogi_error;
  free ensures {:va_keep} old(completed) == 1 ==> yogi_error == 1;
  free ensures {:va_keep} old(completed) == 0 ==> yogi_error == 1;
  free ensures {:va_keep} old(pended) == 1 ==> yogi_error == 1;
...
implementation {:origName "SLIC_Serenum_Power_exit"} {:osmodel} SLIC_Serenum_Power_exit(actual_caller_14: int, actual_Serenum_6: int)
{
  ...
  L6:
    call {:si_unique_call 464} SLIC_EXIT_ROUTINE(strConst__li2bpl10);
    goto L2;
  ...
  anon8_Then:
    assume {:partition} Serenum_6 != 259;
    call {:si_unique_call 465} SLIC_ABORT_3_0(caller_14, Serenum_6);
    goto anon9_Then, anon9_Else;
...
procedure {:origName "SLIC_ABORT_5_0"} SLIC_ABORT_5_0(actual_caller_15: int, actual_Serenum_7: int);
  modifies yogi_error;
  free ensures {:va_keep} old(completed) == 1 ==> yogi_error == 1;
  free ensures {:va_keep} old(completed) == 0 ==> yogi_error == 1;
  free ensures {:va_keep} old(pended) == 1 ==> yogi_error == 1;
...
implementation {:origName "SLIC_ABORT_5_0"} SLIC_ABORT_5_0(actual_caller_15: int, actual_Serenum_7: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 466} SLIC_ERROR_ROUTINE(strConst__li2bpl12);
    return;
}
...
implementation {:origName "_sdv_init6"} _sdv_init6()
{
  ...
  anon0:
    call {:si_unique_call 467} vslice_dummy_var_62 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "Serenum_CreateClose"} Serenum_CreateClose(actual_DeviceObject_12: int, actual_Irp_8: int) returns (Tmp_205: int)
{
  ...
  anon0:
    call {:si_unique_call 468} completionEvent := __HAVOC_malloc(124);
    DeviceObject_12 := actual_DeviceObject_12;
    Irp_8 := actual_Irp_8;
    call {:si_unique_call 469} irpStack := sdv_IoGetCurrentIrpStackLocation(Irp_8);
  ...
  anon17_Else:
    call {:si_unique_call 470} sdv_IoCopyCurrentIrpStackLocationToNext(Irp_8);
    call {:si_unique_call 471} KeInitializeEvent(completionEvent, 1, 0);
    call {:si_unique_call 472} sdv_IoSetCompletionRoutine(Irp_8, li2bplFunctionConstant171, completionEvent, 1, 1, 1);
    call {:si_unique_call 473} status_10 := sdv_IoCallDriver(pNextDevice, Irp_8);
    goto anon20_Then, anon20_Else;
  ...
  anon16_Else:
    ...
    call {:si_unique_call 474} vslice_dummy_var_63 := KeWaitForSingleObject(0, 0, 0, 0, 0);
    goto L35;
  ...
  anon21_Else:
    ...
    assume SLAM_guard_S_0 != SLAM_guard_S_0_init;
    call {:si_unique_call 475} SLIC_sdv_IoCompleteRequest_entry(0, Irp_8);
    goto L51;
  ...
  anon15_Then:
    call {:si_unique_call 477} status_10 := Serenum_DispatchPassThrough(DeviceObject_12, Irp_8);
    goto anon19_Then, anon19_Else;
...
implementation {:origName "Serenum_IncIoCount"} Serenum_IncIoCount(actual_Data_2: int) returns (Tmp_214: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 478} Tmp_215 := __HAVOC_malloc(4);
    assume {:nonnull} Data_2 != 0;
    assume Data_2 > 0;
    assume {:nonnull} Tmp_215 != 0;
    assume Tmp_215 > 0;
    call {:si_unique_call 479} vslice_dummy_var_65 := sdv_InterlockedIncrement(Tmp_215);
    assume {:nonnull} Data_2 != 0;
    assume Data_2 > 0;
    assume {:nonnull} Tmp_215 != 0;
    assume Tmp_215 > 0;
  ...
  anon5_Else:
    call {:si_unique_call 480} Tmp_215 := __HAVOC_malloc(4);
    assume {:nonnull} Data_2 != 0;
    assume Data_2 > 0;
    assume {:nonnull} Tmp_215 != 0;
    assume Tmp_215 > 0;
    call {:si_unique_call 481} sdv_159 := sdv_InterlockedDecrement(Tmp_215);
    assume {:nonnull} Data_2 != 0;
    assume Data_2 > 0;
    assume {:nonnull} Tmp_215 != 0;
    assume Tmp_215 > 0;
  ...
  anon6_Then:
    ...
    assume {:nonnull} Data_2 != 0;
    assume Data_2 > 0;
    call {:si_unique_call 482} vslice_dummy_var_64 := KeSetEvent(RemoveEvent__FDO_DEVICE_DATA(Data_2), 0, 0);
    goto L15;
...
implementation {:origName "SerenumSyncCompletion"} SerenumSyncCompletion(actual_DeviceObject_13: int, actual_Irp_9: int, actual_SerenumSyncEventIn: int) returns (Tmp_216: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 483} vslice_dummy_var_66 := KeSetEvent(SerenumSyncEvent, 0, 0);
    Tmp_216 := -1073741802;
    return;
}
...
implementation {:origName "Serenum_InitPDO"} Serenum_InitPDO(actual_Pdo: int, actual_FdoData_2: int)
{
  ...
  anon0:
    call {:si_unique_call 484} vslice_dummy_var_67 := __HAVOC_malloc(4);
    Pdo := actual_Pdo;
  ...
  L11:
    ...
    assume {:nonnull} pdoData_1 != 0;
    assume pdoData_1 > 0;
    call {:si_unique_call 485} Tmp_218 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_218 != 0;
    assume Tmp_218 > 0;
    call {:si_unique_call 486} sdv_KeAcquireSpinLock(0, Tmp_218);
    assume {:nonnull} Tmp_218 != 0;
    assume Tmp_218 > 0;
    havoc oldIrql_3;
    assume {:nonnull} FdoData_2 != 0;
    ...
    assume {:nonnull} FdoData_2 != 0;
    assume FdoData_2 > 0;
    call {:si_unique_call 487} sdv_KeReleaseSpinLock(0, oldIrql_3);
    assume {:nonnull} Pdo != 0;
    assume Pdo > 0;
    assume {:nonnull} Pdo != 0;
    assume Pdo > 0;
...
implementation {:origName "Serenum_DecIoCount"} Serenum_DecIoCount(actual_Data_3: int)
{
  ...
  anon0:
    call {:si_unique_call 488} vslice_dummy_var_68 := __HAVOC_malloc(4);
    ...
    assume Tmp_222 > 0;
    call {:si_unique_call 490} sdv_162 := sdv_InterlockedDecrement(Tmp_222);
    assume {:nonnull} Data_3 != 0;
    assume Data_3 > 0;
    assume {:nonnull} Tmp_222 != 0;
    assume Tmp_222 > 0;
  ...
  anon3_Else:
    ...
    assume {:nonnull} Data_3 != 0;
    assume Data_3 > 0;
    call {:si_unique_call 491} vslice_dummy_var_69 := KeSetEvent(RemoveEvent__FDO_DEVICE_DATA(Data_3), 0, 0);
    goto L1;
...
implementation {:origName "Serenum_DispatchPassThrough"} Serenum_DispatchPassThrough(actual_DeviceObject_14: int, actual_Irp_10: int) returns (Tmp_224: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 492} IrpStack := sdv_IoGetCurrentIrpStackLocation(Irp_10);
    waitForEnum := 0;
  ...
  L19:
    call {:si_unique_call 493} sdv_IoSkipCurrentIrpStackLocation(Irp_10);
    assume {:nonnull} pFdoData != 0;
    assume pFdoData > 0;
    havoc vslice_dummy_var_115;
    call {:si_unique_call 494} rval_1 := sdv_IoCallDriver(vslice_dummy_var_115, Irp_10);
    goto anon17_Then, anon17_Else;
  ...
  anon14_Else:
    ...
    call {:si_unique_call 495} vslice_dummy_var_70 := KeReleaseSemaphore(0, 0, 1, 0);
    goto L27;
  ...
  anon13_Then:
    waitForEnum := 1;
    call {:si_unique_call 496} rval_1 := KeWaitForSingleObject(0, 0, 0, 0, 0);
    goto anon15_Then, anon15_Else;
  ...
  anon18_Else:
    ...
    assume SLAM_guard_S_0 != SLAM_guard_S_0_init;
    call {:si_unique_call 497} SLIC_sdv_IoCompleteRequest_entry(0, Irp_10);
    goto L45;
...
implementation {:origName "Serenum_IoCtl"} Serenum_IoCtl(actual_DeviceObject_15: int, actual_Irp_11: int) returns (Tmp_229: int)
{
  ...
  anon0:
    call {:si_unique_call 499} actualLength := __HAVOC_malloc(4);
    DeviceObject_15 := actual_DeviceObject_15;
    Irp_11 := actual_Irp_11;
    call {:si_unique_call 500} Tmp_232 := __HAVOC_malloc(44);
    call {:si_unique_call 501} Tmp_234 := __HAVOC_malloc(36);
    status_11 := 0;
    call {:si_unique_call 502} irpStack_1 := sdv_IoGetCurrentIrpStackLocation(Irp_11);
  ...
  anon26_Else:
    call {:si_unique_call 503} status_11 := Serenum_IncIoCount(fdoData_1);
    goto anon21_Then, anon21_Else;
  ...
  anon22_Else:
    call {:si_unique_call 504} status_11 := IoOpenDeviceRegistryKey(0, 1, 131072, 0);
    goto anon23_Then, anon23_Else;

  anon23_Else:
    assume {:partition} status_11 >= 0;
    Tmp_234 := strConst__li2bpl13;
    assume {:nonnull} Irp_11 != 0;
    assume Irp_11 > 0;
    assume {:nonnull} irpStack_1 != 0;
    assume irpStack_1 > 0;
    ...
    call {:si_unique_call 505} status_11 := Serenum_GetRegistryKeyValue(keyHandle, Tmp_234, 18, vslice_dummy_var_116, vslice_dummy_var_117, actualLength);
    goto anon24_Then, anon24_Else;
  ...
  L48:
    ...
    call {:si_unique_call 506} status_11 := Serenum_GetRegistryKeyValue(keyHandle, Tmp_232, 22, vslice_dummy_var_118, vslice_dummy_var_119, actualLength);
    goto L52;
  ...
  L52:
    ...
    assume {:nonnull} actualLength != 0;
    assume actualLength > 0;
    call {:si_unique_call 507} vslice_dummy_var_71 := ZwClose(0);
    goto L57;

  L57:
    call {:si_unique_call 508} Serenum_DecIoCount(fdoData_1);
    assume {:nonnull} Irp_11 != 0;
    assume Irp_11 > 0;
    goto anon27_Then, anon27_Else;
  ...
  anon27_Else:
    ...
    assume SLAM_guard_S_0 != SLAM_guard_S_0_init;
    call {:si_unique_call 509} SLIC_sdv_IoCompleteRequest_entry(0, Irp_11);
    goto L84;
  ...
  anon22_Then:
    call {:si_unique_call 511} Serenum_DecIoCount(fdoData_1);
    call {:si_unique_call 512} Tmp_229 := Serenum_DispatchPassThrough(DeviceObject_15, Irp_11);
  ...
  anon29_Else:
    assume Irp_11 == SLAM_guard_S_0;
    assume SLAM_guard_S_0 != SLAM_guard_S_0_init;
    call {:si_unique_call 513} SLIC_sdv_IoCompleteRequest_entry(0, Irp_11);
    goto L87;
  ...
  anon26_Then:
    call {:si_unique_call 515} sdv_IoSkipCurrentIrpStackLocation(Irp_11);
    assume {:nonnull} DeviceObject_15 != 0;
    assume DeviceObject_15 > 0;
    havoc Tmp_230;
    ...
    assume Tmp_230 > 0;
    havoc Tmp_233;
    call {:si_unique_call 516} Tmp_229 := sdv_IoCallDriver(Tmp_233, Irp_11);
...
implementation {:origName "_sdv_init3"} _sdv_init3()
{
  ...
  anon0:
    call {:si_unique_call 517} vslice_dummy_var_72 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "Serenum_FDOPowerComplete"} Serenum_FDOPowerComplete(actual_DeviceObject_16: int, actual_Irp_12: int, actual_Context_4: int) returns (Tmp_237: int)
{
  ...
  anon0:
    call {:si_unique_call 518} powerState := __HAVOC_malloc(8);
    call {:si_unique_call 519} sdv_3 := __HAVOC_malloc(8);
  ...
  anon10_Else:
    ...
    assume SLAM_guard_S_0 != SLAM_guard_S_0_init;
    call {:si_unique_call 520} SLIC_sdv_IoMarkIrpPending_entry(0);
    goto L42;

  L42:
    call {:si_unique_call 521} sdv_IoMarkIrpPending(0);
    goto L8;
  ...
  L8:
    ...
    havoc data;
    call {:si_unique_call 522} stack_1 := sdv_IoGetCurrentIrpStackLocation(Irp_12);
  ...
  L22:
    call {:si_unique_call 523} PoStartNextPowerIrp(0);
    call {:si_unique_call 524} Serenum_DecIoCount(data);
    Tmp_237 := 0;
    return;
  ...
  anon11_Else:
    ...
    assume {:nonnull} powerState != 0;
    assume powerState > 0;
    call {:si_unique_call 525} SD3 := PoSetPowerState(0, powerType, powerState);
...
implementation {:origName "Serenum_PDO_Power"} Serenum_PDO_Power(actual_PdoData_1: int, actual_Irp_13: int) returns (Tmp_239: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 527} sdv_1 := __HAVOC_malloc(8);
    call {:si_unique_call 528} sdv_2 := __HAVOC_malloc(8);
    PdoData_1 := actual_PdoData_1;
    Irp_13 := actual_Irp_13;
    status_12 := 0;
    call {:si_unique_call 529} stack_2 := sdv_IoGetCurrentIrpStackLocation(Irp_13);
  ...
  anon20_Else:
    ...
    assume SLAM_guard_S_0 != SLAM_guard_S_0_init;
    call {:si_unique_call 531} SLIC_sdv_IoCompleteRequest_entry(0, Irp_13);
    goto L55;
  ...
  anon21_Else:
    call {:si_unique_call 533} SD1_1 := PoSetPowerState(0, powerType_1, powerState_1);
  ...
  anon22_Else:
    call {:si_unique_call 534} SD2 := PoSetPowerState(0, powerType_1, powerState_1);
...
implementation {:origName "_sdv_init5"} _sdv_init5()
{
  ...
  anon0:
    call {:si_unique_call 535} vslice_dummy_var_73 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "Serenum_FDO_Power"} Serenum_FDO_Power(actual_Data_4: int, actual_Irp_14: int) returns (Tmp_243: int)
{
  ...
  anon0:
    call {:si_unique_call 536} powerState_2 := __HAVOC_malloc(8);
    call {:si_unique_call 537} sdv := __HAVOC_malloc(8);
    Data_4 := actual_Data_4;
    Irp_14 := actual_Irp_14;
    hookit := 0;
    call {:si_unique_call 538} stack_3 := sdv_IoGetCurrentIrpStackLocation(Irp_14);
    ...
    assume {:nonnull} stack_3 != 0;
    assume stack_3 > 0;
    call {:si_unique_call 539} status_13 := Serenum_IncIoCount(Data_4);
    goto anon25_Then, anon25_Else;
  ...
  L27:
    call {:si_unique_call 540} sdv_IoCopyCurrentIrpStackLocationToNext(Irp_14);
    goto anon28_Then, anon28_Else;

  anon28_Else:
    assume {:partition} hookit != 0;
    call {:si_unique_call 541} status_13 := Serenum_IncIoCount(Data_4);
    call {:si_unique_call 542} sdv_IoSetCompletionRoutine(Irp_14, li2bplFunctionConstant479, 0, 1, 1, 1);
    call {:si_unique_call 543} status_13 := PoCallDriver(0, Irp_14);
  ...
  L45:
    call {:si_unique_call 544} Serenum_DecIoCount(Data_4);
    Tmp_243 := status_13;
    goto L1;
  ...
  anon28_Then:
    assume {:partition} hookit == 0;
    call {:si_unique_call 545} PoStartNextPowerIrp(0);
    call {:si_unique_call 546} status_13 := PoCallDriver(0, Irp_14);
  ...
  anon36_Else:
    call {:si_unique_call 547} structPtr888sdv := PoSetPowerState(0, powerType_2, powerState_2);
  ...
  anon25_Then:
    ...
    assume {:nonnull} Irp_14 != 0;
    assume Irp_14 > 0;
    call {:si_unique_call 548} PoStartNextPowerIrp(0);
    goto anon31_Then, anon31_Else;

  anon31_Else:
    assume Irp_14 == SLAM_guard_S_0;
    assume SLAM_guard_S_0 != SLAM_guard_S_0_init;
    call {:si_unique_call 549} SLIC_sdv_IoCompleteRequest_entry(0, Irp_14);
    goto L86;
...
implementation {:origName "Serenum_Power"} Serenum_Power(actual_DeviceObject_17: int, actual_Irp_15: int) returns (Tmp_245: int)
{
  ...
  anon0:
    ...
    status_14 := 0;
    call {:si_unique_call 551} vslice_dummy_var_74 := sdv_IoGetCurrentIrpStackLocation(Irp_15);
  ...
  anon5_Else:
    ...
    call {:si_unique_call 552} status_14 := Serenum_FDO_Power(vslice_dummy_var_120, Irp_15);
    goto anon6_Then, anon6_Else;
  ...
  anon5_Then:
    ...
    call {:si_unique_call 553} status_14 := Serenum_PDO_Power(vslice_dummy_var_121, Irp_15);
    goto L20;
}
...
implementation {:origName "Serenum_StrLen"} Serenum_StrLen(actual_string: int) returns (Tmp_247: int)
{
  ...
  L7:
    call {:si_unique_call 554} i_1, Tmp_248 := Serenum_StrLen_loop_L7(i_1, Tmp_248, string);
    goto L7_last;
...
implementation {:origName "Serenum_GetDevDesc"} Serenum_GetDevDesc(actual_input: int, actual_output: int, actual_start: int)
{
  ...
  anon0:
    call {:si_unique_call 555} vslice_dummy_var_75 := __HAVOC_malloc(4);
    input := actual_input;
  ...
  L13:
    call {:si_unique_call 556} c_1, Tmp_257, Tmp_258, tail := Serenum_GetDevDesc_loop_L13(c_1, Tmp_257, Tmp_258, tail, input, output);
    goto L13_last;
...
implementation {:origName "Serenum_GetDevName"} Serenum_GetDevName(actual_input_1: int, actual_output_1: int, actual_start_1: int)
{
  ...
  anon0:
    call {:si_unique_call 557} vslice_dummy_var_76 := __HAVOC_malloc(4);
  ...
  anon14_Else:
    ...
    assume input_1 > 0;
    havoc c_2;
    call {:si_unique_call 558} sdv_186 := Serenum_HToI(c_2);
    goto anon15_Then, anon15_Else;
  ...
  L17:
    ...
    assume input_1 > 0;
    havoc c_2;
    call {:si_unique_call 559} sdv_187 := Serenum_HToI(c_2);
    goto anon16_Then, anon16_Else;
  ...
  L23:
    ...
    assume input_1 > 0;
    havoc c_2;
    call {:si_unique_call 560} sdv_188 := Serenum_HToI(c_2);
    goto anon17_Then, anon17_Else;
  ...
  L29:
    ...
    assume input_1 > 0;
    havoc c_2;
    call {:si_unique_call 561} sdv_189 := Serenum_HToI(c_2);
    goto anon18_Then, anon18_Else;
...
implementation {:origName "Serenum_GetDevPnPRev"} Serenum_GetDevPnPRev(actual_FdoData_3: int, actual_input_2: int, actual_output_2: int, actual_start_2: int) returns (Tmp_276: int)
{
  ...
  L21:
    call {:si_unique_call 562} Tmp_278, Tmp_286, c_3, tail_2 := Serenum_GetDevPnPRev_loop_L21(Tmp_278, Tmp_286, c_3, tail_2, input_2);
    goto L21_last;
  ...
  L34:
    call {:si_unique_call 563} i_2, sum, Tmp_291, c_3, Tmp_294 := Serenum_GetDevPnPRev_loop_L34(i_2, sum, Tmp_291, c_3, Tmp_294, delta, input_2);
    goto L34_last;
  ...
  L35:
    ...
    lsd := lsd + delta;
    Tmp_293 := msd;
    call {:si_unique_call 564} msd := Serenum_HToI(Tmp_293);
  ...
  anon48_Then:
    ...
    Tmp_298 := lsd;
    call {:si_unique_call 565} lsd := Serenum_HToI(Tmp_298);
  ...
  anon49_Then:
    ...
    call {:si_unique_call 566} vslice_dummy_var_77 := corral_nondet();
  ...
  anon56_Else:
    ...
    assume {:nonnull} input_2 != 0;
    assume input_2 > 0;
    call {:si_unique_call 567} i_2 := corral_nondet();
    Tmp_285 := tail_2;
    tail_2 := tail_2 + 1;
    Tmp_288 := Tmp_285;
    assume {:nonnull} input_2 != 0;
    assume input_2 > 0;
    havoc i_2;
    call {:si_unique_call 568} Serenum_FixptToAscii(i_2, output_2);
    i_2 := tail_2;
    goto L76;

  L76:
    call {:si_unique_call 569} i_2, Tmp_281, Tmp_289, c_3, Tmp_296, delta, Tmp_302 := Serenum_GetDevPnPRev_loop_L76(i_2, Tmp_281, Tmp_289, c_3, Tmp_296, delta, Tmp_302, input_2);
    goto L76_last;
...
implementation {:origName "Serenum_SzCopy"} Serenum_SzCopy(actual_source: int, actual_dest: int) returns (Tmp_303: int)
{
  ...
  L5:
    call {:si_unique_call 570} i_3, Tmp_305, Tmp_306 := Serenum_SzCopy_loop_L5(i_3, Tmp_305, Tmp_306, source, dest);
    goto L5_last;
...
implementation {:origName "Serenum_GetDevCompId"} Serenum_GetDevCompId(actual_input_3: int, actual_output_3: int, actual_start_3: int)
{
  ...
  anon0:
    call {:si_unique_call 571} vslice_dummy_var_78 := __HAVOC_malloc(4);
  ...
  L13:
    call {:si_unique_call 572} Tmp_307, c_4, Tmp_313, tail_3 := Serenum_GetDevCompId_loop_L13(Tmp_307, c_4, Tmp_313, tail_3, input_3, output_3);
    goto L13_last;
...
implementation {:origName "Serenum_GetDevClass"} Serenum_GetDevClass(actual_input_4: int, actual_output_4: int, actual_start_4: int)
{
  ...
  anon0:
    call {:si_unique_call 573} vslice_dummy_var_79 := __HAVOC_malloc(4);
  ...
  L13:
    call {:si_unique_call 574} Tmp_317, c_5, Tmp_319, tail_4 := Serenum_GetDevClass_loop_L13(Tmp_317, c_5, Tmp_319, tail_4, input_4, output_4);
    goto L13_last;
...
implementation {:origName "Serenum_InitMultiString"} Serenum_InitMultiString(actual_FdoData_4: int, actual_MultiString: int) returns (Tmp_323: int)
{
  ...
  anon0:
    call {:si_unique_call 575} ansiString := __HAVOC_malloc(12);
    call {:si_unique_call 576} unicodeString := __HAVOC_malloc(12);
    call {:si_unique_call 577} MultiString := __HAVOC_malloc(4);
    multiLength := 0;
  ...
  L17:
    call {:si_unique_call 579} multiLength, rawString, Tmp_329, Tmp_332 := Serenum_InitMultiString_loop_L17(ansiString, multiLength, rawString, Tmp_329, Tmp_332, ap);
    goto L17_last;
  ...
  anon17_Else:
    ...
    call {:si_unique_call 580} RtlInitAnsiString(0, 0);
    assume {:nonnull} NlsMbCodePageTag != 0;
    assume NlsMbCodePageTag > 0;
    goto anon18_Then, anon18_Else;

  anon18_Else:
    call {:si_unique_call 581} Tmp_332 := corral_nondet();
    goto L28;
  ...
  anon21_Else:
    ...
    call {:si_unique_call 582} sdv_193 := ExAllocatePoolWithTag(1, multiLength, -311532205);
    assume {:nonnull} MultiString != 0;
    assume MultiString > 0;
    assume {:nonnull} MultiString != 0;
    assume MultiString > 0;
  ...
  L47:
    call {:si_unique_call 583} i_4, Tmp_324, Tmp_326, rawString, Tmp_330, Tmp_331, vslice_dummy_var_80 := Serenum_InitMultiString_loop_L47(i_4, Tmp_324, Tmp_326, unicodeString, rawString, Tmp_330, Tmp_331, ap, vslice_dummy_var_80);
    goto L47_last;
  ...
  anon19_Else:
    assume {:partition} rawString != 0;
    call {:si_unique_call 584} RtlInitAnsiString(0, 0);
    call {:si_unique_call 585} vslice_dummy_var_80 := RtlAnsiStringToUnicodeString(0, 0, 0);
    i_4 := 0;
    goto L57;

  L57:
    call {:si_unique_call 586} i_4, Tmp_324, Tmp_326, Tmp_331 := Serenum_InitMultiString_loop_L57(i_4, Tmp_324, Tmp_326, unicodeString, Tmp_331);
    goto L57_last;
  ...
  anon21_Then:
    ...
    call {:si_unique_call 587} RtlInitUnicodeString(vslice_dummy_var_122, 0);
    Tmp_323 := 0;
    goto L1;
}
...
implementation {:origName "_sdv_init4"} _sdv_init4()
{
  ...
  anon0:
    call {:si_unique_call 588} vslice_dummy_var_81 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "Serenum_ParseData"} Serenum_ParseData(actual_FdoData_5: int, actual_ReadBuffer: int, actual_BufferLen_1: int, actual_hardwareIDs_1: int, actual_compIDs_1: int, actual_deviceIDs_1: int, actual_PDeviceDesc: int, actual_serialNo: int, actual_pnpRev_1: int) returns (Tmp_335: int)
{
  ...
  anon0:
    call {:si_unique_call 589} start_5 := __HAVOC_malloc(4);
    call {:si_unique_call 590} pMouseID := __HAVOC_malloc(4);
    ...
    call {:si_unique_call 591} Tmp_336 := __HAVOC_malloc(52);
    call {:si_unique_call 592} Tmp_337 := __HAVOC_malloc(36);
    call {:si_unique_call 593} Tmp_338 := __HAVOC_malloc(52);
    call {:si_unique_call 594} vslice_dummy_var_88 := __HAVOC_malloc(24);
    pStrBuffer := 0;
    isMouse := 0;
    assume {:nonnull} pMouseID != 0;
    assume pMouseID > 0;
    call {:si_unique_call 595} sdv_199 := ExAllocatePoolWithTag(1, 1793, -311532205);
    pStrBuffer := sdv_199;
    goto anon51_Then, anon51_Else;
  ...
  anon51_Else:
    ...
    assume pDesc > 0;
    Tmp_337 := strConst__li2bpl16;
    assume {:nonnull} start_5 != 0;
    assume start_5 > 0;
    call {:si_unique_call 596} boogieTmp := Serenum_SzCopy(Tmp_337, pDevNodeName);
    pDevName := pDevNodeName;
    assume {:nonnull} start_5 != 0;
    assume start_5 > 0;
    call {:si_unique_call 597} RtlInitUnicodeString(hardwareIDs_1, 0);
    call {:si_unique_call 598} RtlInitUnicodeString(compIDs_1, 0);
    call {:si_unique_call 599} RtlInitUnicodeString(deviceIDs_1, 0);
    call {:si_unique_call 600} RtlInitUnicodeString(pnpRev_1, 0);
    call {:si_unique_call 601} RtlInitUnicodeString(serialNo, 0);
    assume {:nonnull} start_5 != 0;
    assume start_5 > 0;
    call {:si_unique_call 602} boogieTmp := Serenum_GetDevOtherID(ReadBuffer, pOtherId);
    assume {:nonnull} start_5 != 0;
    assume start_5 > 0;
    goto anon35_Then, anon35_Else;
  ...
  anon36_Else:
    assume {:partition} pStrBuffer != 0;
    call {:si_unique_call 603} vslice_dummy_var_82 := Serenum_InitMultiString(FdoData_5, hardwareIDs_1);
    call {:si_unique_call 604} sdv_210 := Serenum_StrLen(pCompId);
  ...
  anon39_Else:
    ...
    call {:si_unique_call 605} vslice_dummy_var_89 := Serenum_InitMultiString(FdoData_5, compIDs_1);
    goto L99;

  L99:
    call {:si_unique_call 606} vslice_dummy_var_84 := Serenum_InitMultiString(FdoData_5, deviceIDs_1);
    call {:si_unique_call 607} vslice_dummy_var_85 := Serenum_InitMultiString(FdoData_5, PDeviceDesc);
    call {:si_unique_call 608} sdv_216 := Serenum_StrLen(pSerNo);
    goto anon40_Then, anon40_Else;

  anon40_Else:
    assume {:partition} sdv_216 != 0;
    call {:si_unique_call 609} vslice_dummy_var_86 := Serenum_InitMultiString(FdoData_5, serialNo);
    goto L109;

  L109:
    call {:si_unique_call 610} sdv_206 := Serenum_StrLen(pPnpRev);
    goto anon41_Then, anon41_Else;

  anon41_Else:
    assume {:partition} sdv_206 != 0;
    call {:si_unique_call 611} vslice_dummy_var_87 := Serenum_InitMultiString(FdoData_5, pnpRev_1);
    goto L116;
  ...
  anon39_Then:
    assume {:partition} isMouse == 0;
    call {:si_unique_call 613} vslice_dummy_var_83 := Serenum_InitMultiString(FdoData_5, compIDs_1);
    goto L99;
  ...
  anon38_Else:
    ...
    call {:si_unique_call 614} vslice_dummy_var_90 := Serenum_InitMultiString(FdoData_5, compIDs_1);
    goto L99;
  ...
  anon35_Then:
    call {:si_unique_call 615} SerenumScanOtherIdForMouse(ReadBuffer, BufferLen_1, pMouseID);
    assume {:nonnull} pMouseID != 0;
    assume pMouseID > 0;
    goto anon42_Then, anon42_Else;
  ...
  L126:
    call {:si_unique_call 616} status_16 := Serenum_GetDevPnPRev(FdoData_5, ReadBuffer, pPnpRev, start_5);
    goto anon45_Then, anon45_Else;

  anon45_Else:
    assume {:partition} status_16 >= 0;
    call {:si_unique_call 617} Serenum_GetDevName(ReadBuffer, pDevName, start_5);
    call {:si_unique_call 618} Serenum_GetDevSerialNo(ReadBuffer, pSerNo, start_5);
    call {:si_unique_call 619} sdv_214 := Serenum_StrLen(pSerNo);
    goto anon46_Then, anon46_Else;

  anon46_Else:
    assume {:partition} sdv_214 != 0;
    call {:si_unique_call 620} sdv_195 := Serenum_StrLen(pSerNo);
    goto anon47_Then, anon47_Else;
  ...
  L145:
    call {:si_unique_call 621} Serenum_GetDevClass(ReadBuffer, pClass, start_5);
    call {:si_unique_call 622} sdv_200 := Serenum_StrLen(pClass);
    goto anon48_Then, anon48_Else;
  ...
  anon48_Then:
    ...
    call {:si_unique_call 623} vslice_dummy_var_91 := corral_nondet();
    assume {:nonnull} pCompIdStar != 0;
    assume pCompIdStar > 0;
    call {:si_unique_call 624} Serenum_GetDevCompId(ReadBuffer, pCompId, start_5);
    call {:si_unique_call 625} sdv_198 := Serenum_StrLen(pCompId);
    goto anon49_Then, anon49_Else;
  ...
  anon49_Then:
    ...
    call {:si_unique_call 626} Serenum_GetDevDesc(ReadBuffer, pDesc, start_5);
    call {:si_unique_call 627} sdv_215 := Serenum_StrLen(pDesc);
    goto anon50_Then, anon50_Else;
...
implementation {:origName "Serenum_GetDevOtherID"} Serenum_GetDevOtherID(actual_input_5: int, actual_output_5: int) returns (Tmp_341: int)
{
  ...
  L7:
    call {:si_unique_call 628} Tmp_342, c_6, Tmp_346, tail_5 := Serenum_GetDevOtherID_loop_L7(Tmp_342, c_6, Tmp_346, tail_5, input_5, output_5);
    goto L7_last;
...
implementation {:origName "Serenum_FixptToAscii"} Serenum_FixptToAscii(actual_n_1: int, actual_output_6: int)
{
  ...
  anon0:
    call {:si_unique_call 629} vslice_dummy_var_92 := __HAVOC_malloc(4);
    n_1 := actual_n_1;
...
implementation {:origName "Serenum_GetDevSerialNo"} Serenum_GetDevSerialNo(actual_input_6: int, actual_output_7: int, actual_start_6: int)
{
  ...
  L15:
    call {:si_unique_call 631} cnt, sdv_217, Tmp_354, c_7, Tmp_356, tail_6 := Serenum_GetDevSerialNo_loop_L15(cnt, sdv_217, Tmp_354, c_7, Tmp_356, tail_6, input_6, output_7);
    goto L15_last;
  ...
  anon22_Else:
    ...
    cnt := cnt + 1;
    call {:si_unique_call 632} sdv_217 := Serenum_HToI(c_7);
    goto anon23_Then, anon23_Else;
...
implementation {:origName "SerenumCheckEnumerations"} SerenumCheckEnumerations(actual_PFdoData_5: int) returns (Tmp_359: int)
{
  ...
  anon0:
    call {:si_unique_call 633} sameDevice_1 := __HAVOC_malloc(4);
  ...
  anon24_Else:
    call {:si_unique_call 634} Tmp_361 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_361 != 0;
    assume Tmp_361 > 0;
    call {:si_unique_call 635} sdv_KeAcquireSpinLock(0, Tmp_361);
    assume {:nonnull} Tmp_361 != 0;
    assume Tmp_361 > 0;
    havoc oldIrql_4;
    assume {:nonnull} PFdoData_5 != 0;
  ...
  anon26_Else:
    ...
    assume Tmp_362 > 0;
    havoc Tmp_363;
    call {:si_unique_call 637} pIrp_2 := IoAllocateIrp(Tmp_363, 0);
    goto anon21_Then, anon21_Else;

  anon21_Else:
    assume {:partition} pIrp_2 != 0;
    call {:si_unique_call 638} sdv_IoSetNextIrpStackLocation(0);
    call {:si_unique_call 639} status_17 := Serenum_ReenumerateDevices(pIrp_2, PFdoData_5, sameDevice_1);
    goto anon27_Then, anon27_Else;
  ...
  L41:
    call {:si_unique_call 641} Tmp_361 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_361 != 0;
    assume Tmp_361 > 0;
    call {:si_unique_call 642} sdv_KeAcquireSpinLock(0, Tmp_361);
    assume {:nonnull} Tmp_361 != 0;
    assume Tmp_361 > 0;
    havoc oldIrql_4;
    goto anon23_Then, anon23_Else;
  ...
  L49:
    call {:si_unique_call 643} sdv_KeReleaseSpinLock(0, oldIrql_4);
    goto L12;
  ...
  anon20_Else:
    ...
    assume {:nonnull} PFdoData_5 != 0;
    assume PFdoData_5 > 0;
    call {:si_unique_call 644} sdv_KeReleaseSpinLock(0, oldIrql_4);
    status_17 := 0;
    goto L12;

  anon20_Then:
    call {:si_unique_call 645} sdv_KeReleaseSpinLock(0, oldIrql_4);
    status_17 := 0;
    goto L12;
  ...
  anon19_Then:
    assume {:nonnull} PFdoData_5 != 0;
    assume PFdoData_5 > 0;
    call {:si_unique_call 646} sdv_KeReleaseSpinLock(0, oldIrql_4);
    call {:si_unique_call 647} status_17 := SerenumStartProtocolThread(PFdoData_5);
    goto L12;
...
implementation {:origName "Serenum_FDO_PnP"} Serenum_FDO_PnP(actual_DeviceObject_18: int, actual_Irp_16: int, actual_IrpStack_1: int, actual_DeviceData: int) returns (Tmp_364: int)
{
  ...
  anon0:
    call {:si_unique_call 648} DebugLevelDefault := __HAVOC_malloc(4);
    call {:si_unique_call 649} event_3 := __HAVOC_malloc(124);
    Irp_16 := actual_Irp_16;
    IrpStack_1 := actual_IrpStack_1;
    DeviceData := actual_DeviceData;
    call {:si_unique_call 650} vslice_dummy_var_97 := __HAVOC_malloc(32);
    call {:si_unique_call 651} Tmp_372 := __HAVOC_malloc(4);
    QueryTable_1 := 0;
    assume {:nonnull} DebugLevelDefault != 0;
    assume DebugLevelDefault > 0;
    call {:si_unique_call 652} sdv_do_paged_code_check();
    call {:si_unique_call 653} status_18 := Serenum_IncIoCount(DeviceData);
    goto anon83_Then, anon83_Else;

  anon83_Else:
    assume {:partition} status_18 >= 0;
    call {:si_unique_call 654} vslice_dummy_var_94 := sdv_IoGetCurrentIrpStackLocation(Irp_16);
    assume {:nonnull} IrpStack_1 != 0;
    assume IrpStack_1 > 0;
    goto anon84_Then, anon84_Else;
  ...
  anon99_Else:
    call {:si_unique_call 655} KeInitializeEvent(event_3, 0, 0);
    call {:si_unique_call 656} sdv_IoCopyCurrentIrpStackLocationToNext(Irp_16);
    call {:si_unique_call 657} sdv_IoSetCompletionRoutine(Irp_16, li2bplFunctionConstant171, event_3, 1, 1, 1);
    assume {:nonnull} DeviceData != 0;
    assume DeviceData > 0;
    havoc vslice_dummy_var_123;
    call {:si_unique_call 658} status_18 := sdv_IoCallDriver(vslice_dummy_var_123, Irp_16);
    goto anon122_Then, anon122_Else;
  ...
  anon88_Else:
    ...
    call {:si_unique_call 659} status_18 := KeWaitForSingleObject(0, 0, 0, 0, 0);
  ...
  anon106_Else:
    ...
    assume SLAM_guard_S_0 != SLAM_guard_S_0_init;
    call {:si_unique_call 660} SLIC_sdv_IoCompleteRequest_entry(0, Irp_16);
    goto L317;

  L317:
    call {:si_unique_call 661} sdv_IoCompleteRequest(0, 0);
    call {:si_unique_call 662} Serenum_DecIoCount(DeviceData);
    Tmp_364 := status_18;
    goto L1;
  ...
  anon89_Then:
    ...
    call {:si_unique_call 663} irpSp_2 := sdv_IoGetCurrentIrpStackLocation(Irp_16);
  ...
  L31:
    call {:si_unique_call 664} sdv_IoSkipCurrentIrpStackLocation(Irp_16);
    assume {:nonnull} DeviceData != 0;
    assume DeviceData > 0;
    havoc vslice_dummy_var_124;
    call {:si_unique_call 665} status_18 := sdv_IoCallDriver(vslice_dummy_var_124, Irp_16);
    goto anon115_Then, anon115_Else;

  anon115_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 666} Serenum_DecIoCount(DeviceData);
    Tmp_364 := status_18;
    goto L1;
  ...
  anon87_Else:
    call {:si_unique_call 667} status_18 := SerenumCheckEnumerations(DeviceData);
  ...
  L91:
    ...
    assume DeviceData > 0;
    havoc length_1;
    call {:si_unique_call 668} sdv_240 := ExAllocatePoolWithTag(0, length_1, -311532205);
    relations := sdv_240;
  ...
  anon91_Else:
    ...
    assume Tmp_365 > 0;
    call {:si_unique_call 669} sdv_RtlCopyMemory(0, 0, Tmp_371);
    goto L100;
  ...
  anon118_Else:
    ...
    assume Tmp_372 > 0;
    call {:si_unique_call 670} vslice_dummy_var_99 := sdv_ObReferenceObject(0);
    goto L107;
  ...
  L113:
    ...
    call {:si_unique_call 673} status_18 := sdv_IoCallDriver(vslice_dummy_var_125, Irp_16);
    goto anon120_Then, anon120_Else;
  ...
  anon121_Else:
    assume Irp_16 == SLAM_guard_S_0;
    assume SLAM_guard_S_0 != SLAM_guard_S_0_init;
    call {:si_unique_call 675} SLIC_sdv_IoCompleteRequest_entry(0, Irp_16);
    goto L323;

  L323:
    call {:si_unique_call 676} sdv_IoCompleteRequest(0, 0);
    call {:si_unique_call 677} Serenum_DecIoCount(DeviceData);
    Tmp_364 := -1073741670;
    goto L1;
  ...
  anon101_Then:
    ...
    call {:si_unique_call 679} status_18 := sdv_IoCallDriver(vslice_dummy_var_126, Irp_16);
  ...
  anon112_Else:
    assume {:partition} status_18 >= 0;
    call {:si_unique_call 681} sdv_IoSkipCurrentIrpStackLocation(Irp_16);
    assume {:nonnull} DeviceData != 0;
    assume DeviceData > 0;
    havoc vslice_dummy_var_127;
    call {:si_unique_call 682} status_18 := sdv_IoCallDriver(vslice_dummy_var_127, Irp_16);
  ...
  L160:
    call {:si_unique_call 683} Serenum_DecIoCount(DeviceData);
    Tmp_364 := status_18;
    goto L1;
  ...
  anon93_Else:
    assume Irp_16 == SLAM_guard_S_0;
    assume SLAM_guard_S_0 != SLAM_guard_S_0_init;
    call {:si_unique_call 684} SLIC_sdv_IoCompleteRequest_entry(0, Irp_16);
    goto L320;
  ...
  anon103_Then:
    call {:si_unique_call 686} SerenumWaitForEnumThreadTerminate(DeviceData);
    assume {:nonnull} DeviceData != 0;
    assume DeviceData > 0;
    assume {:nonnull} Irp_16 != 0;
    assume Irp_16 > 0;
    call {:si_unique_call 687} sdv_IoSkipCurrentIrpStackLocation(Irp_16);
    assume {:nonnull} DeviceData != 0;
    assume DeviceData > 0;
    havoc vslice_dummy_var_128;
    call {:si_unique_call 688} status_18 := sdv_IoCallDriver(vslice_dummy_var_128, Irp_16);
    goto anon111_Then, anon111_Else;

  anon111_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 689} Serenum_DecIoCount(DeviceData);
    Tmp_364 := status_18;
    goto L1;
  ...
  anon104_Then:
    call {:si_unique_call 690} SerenumWaitForEnumThreadTerminate(DeviceData);
    assume {:nonnull} DeviceData != 0;
    assume DeviceData > 0;
    call {:si_unique_call 691} vslice_dummy_var_98 := IoSetDeviceInterfaceState(0, 0);
    assume {:nonnull} Irp_16 != 0;
    assume Irp_16 > 0;
    call {:si_unique_call 692} sdv_IoSkipCurrentIrpStackLocation(Irp_16);
    assume {:nonnull} DeviceData != 0;
    assume DeviceData > 0;
    havoc vslice_dummy_var_129;
    call {:si_unique_call 693} status_18 := sdv_IoCallDriver(vslice_dummy_var_129, Irp_16);
    goto anon110_Then, anon110_Else;

  anon110_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 694} Tmp_376 := __HAVOC_malloc(4);
    assume {:nonnull} DeviceData != 0;
    assume DeviceData > 0;
    assume {:nonnull} Tmp_376 != 0;
    assume Tmp_376 > 0;
    call {:si_unique_call 695} sdv_239 := sdv_InterlockedDecrement(Tmp_376);
    assume {:nonnull} DeviceData != 0;
    assume DeviceData > 0;
    assume {:nonnull} Tmp_376 != 0;
    assume Tmp_376 > 0;
    i_5 := sdv_239;
    call {:si_unique_call 696} Tmp_376 := __HAVOC_malloc(4);
    assume {:nonnull} DeviceData != 0;
    assume DeviceData > 0;
    assume {:nonnull} Tmp_376 != 0;
    assume Tmp_376 > 0;
    call {:si_unique_call 697} sdv_241 := sdv_InterlockedDecrement(Tmp_376);
    assume {:nonnull} DeviceData != 0;
    assume DeviceData > 0;
    assume {:nonnull} Tmp_376 != 0;
    assume Tmp_376 > 0;
  ...
  anon94_Else:
    ...
    call {:si_unique_call 698} vslice_dummy_var_95 := KeWaitForSingleObject(0, 0, 0, 0, 0);
    goto L198;

  L198:
    call {:si_unique_call 699} IoDetachDevice(0);
    assume {:nonnull} DeviceData != 0;
    assume DeviceData > 0;
  ...
  anon95_Else:
    ...
    call {:si_unique_call 701} vslice_dummy_var_96 := Serenum_PnPRemove(vslice_dummy_var_130, vslice_dummy_var_131);
    assume {:nonnull} DeviceData != 0;
    assume DeviceData > 0;
    assume {:nonnull} DeviceData != 0;
    assume DeviceData > 0;
  ...
  L208:
    call {:si_unique_call 702} IoDeleteDevice(0);
    Tmp_364 := status_18;
    goto L1;
  ...
  anon105_Then:
    call {:si_unique_call 703} SerenumWaitForEnumThreadTerminate(DeviceData);
    assume {:nonnull} Irp_16 != 0;
    assume Irp_16 > 0;
    call {:si_unique_call 704} sdv_IoSkipCurrentIrpStackLocation(Irp_16);
    assume {:nonnull} DeviceData != 0;
    assume DeviceData > 0;
    havoc vslice_dummy_var_132;
    call {:si_unique_call 705} status_18 := sdv_IoCallDriver(vslice_dummy_var_132, Irp_16);
    goto anon109_Then, anon109_Else;

  anon109_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 706} Serenum_DecIoCount(DeviceData);
    Tmp_364 := status_18;
    goto L1;
  ...
  anon85_Then:
    call {:si_unique_call 707} KeInitializeEvent(event_3, 0, 0);
    call {:si_unique_call 708} sdv_IoCopyCurrentIrpStackLocationToNext(Irp_16);
    call {:si_unique_call 709} sdv_IoSetCompletionRoutine(Irp_16, li2bplFunctionConstant171, event_3, 1, 1, 1);
    assume {:nonnull} DeviceData != 0;
    assume DeviceData > 0;
    havoc vslice_dummy_var_133;
    call {:si_unique_call 710} status_18 := sdv_IoCallDriver(vslice_dummy_var_133, Irp_16);
    goto anon107_Then, anon107_Else;
  ...
  anon96_Else:
    assume {:partition} 259 == status_18;
    call {:si_unique_call 711} status_18 := KeWaitForSingleObject(0, 0, 0, 0, 0);
    assume {:nonnull} Irp_16 != 0;
    assume Irp_16 > 0;
    havoc status_18;
    goto L246;
  ...
  anon97_Else:
    assume {:partition} status_18 >= 0;
    call {:si_unique_call 712} sdv_242 := ExAllocatePoolWithTag(1, 56, -311532205);
    QueryTable_1 := sdv_242;
    goto anon108_Then, anon108_Else;

  anon108_Else:
    assume {:partition} QueryTable_1 != 0;
    call {:si_unique_call 713} sdv_RtlZeroMemory(0, 56);
    ...
    assume {:nonnull} QueryTable_1 != 0;
    assume QueryTable_1 > 0;
    call {:si_unique_call 714} sdv_225 := sdv_RtlQueryRegistryValues(1, 0, 0, 0, 0);
    goto anon98_Then, anon98_Else;
  ...
  anon123_Else:
    assume Irp_16 == SLAM_guard_S_0;
    assume SLAM_guard_S_0 != SLAM_guard_S_0_init;
    call {:si_unique_call 716} SLIC_sdv_IoCompleteRequest_entry(0, Irp_16);
    goto L326;
...
implementation {:origName "_sdv_init1"} _sdv_init1()
{
  ...
  anon0:
    call {:si_unique_call 718} vslice_dummy_var_100 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "Serenum_PnP"} Serenum_PnP(actual_DeviceObject_19: int, actual_Irp_17: int) returns (Tmp_379: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 720} irpStack_3 := sdv_IoGetCurrentIrpStackLocation(Irp_17);
  ...
  anon11_Else:
    ...
    assume SLAM_guard_S_0 != SLAM_guard_S_0_init;
    call {:si_unique_call 721} SLIC_sdv_IoCompleteRequest_entry(0, Irp_17);
    goto L34;
  ...
  anon9_Else:
    call {:si_unique_call 723} status_19 := Serenum_FDO_PnP(DeviceObject_19, Irp_17, irpStack_3, commonData_2);
    goto anon12_Then, anon12_Else;
  ...
  anon9_Then:
    call {:si_unique_call 724} status_19 := Serenum_PDO_PnP(DeviceObject_19, Irp_17, irpStack_3, commonData_2);
    goto L23;
}
...
implementation {:origName "Serenum_PDO_PnP"} Serenum_PDO_PnP(actual_DeviceObject_20: int, actual_Irp_18: int, actual_IrpStack_2: int, actual_DeviceData_1: int) returns (Tmp_381: int)
{
  ...
  anon0:
    call {:si_unique_call 725} keyname := __HAVOC_malloc(12);
    DeviceObject_20 := actual_DeviceObject_20;
    Irp_18 := actual_Irp_18;
    IrpStack_2 := actual_IrpStack_2;
    DeviceData_1 := actual_DeviceData_1;
    call {:si_unique_call 726} vslice_dummy_var_102 := __HAVOC_malloc(56);
    call {:si_unique_call 727} vslice_dummy_var_103 := __HAVOC_malloc(28);
    call {:si_unique_call 728} vslice_dummy_var_104 := __HAVOC_malloc(20);
    call {:si_unique_call 729} Tmp_401 := __HAVOC_malloc(4);
    returnBuffer := 0;
  ...
  anon125_Else:
    ...
    assume SLAM_guard_S_0 != SLAM_guard_S_0_init;
    call {:si_unique_call 731} SLIC_sdv_IoCompleteRequest_entry(0, Irp_18);
    goto L267;
  ...
  anon100_Then:
    call {:si_unique_call 733} sdv_250 := ExAllocatePoolWithTag(1, 24, -311532205);
    pBusInfo := sdv_250;
    goto anon132_Then, anon132_Else;
  ...
  anon117_Else:
    status_20 := 0;
    length_2 := 10;
    call {:si_unique_call 734} sdv_254 := ExAllocatePoolWithTag(1, length_2, -311532205);
    returnBuffer := sdv_254;
    goto anon131_Then, anon131_Else;

  anon131_Else:
    assume {:partition} returnBuffer != 0;
    call {:si_unique_call 735} sdv_RtlCopyMemory(0, 0, length_2);
    goto L67;
  ...
  anon129_Else:
    ...
    havoc length_2;
    Tmp_390 := length_2 + 2;
    call {:si_unique_call 736} sdv_256 := ExAllocatePoolWithTag(1, Tmp_390, -311532205);
  ...
  anon130_Else:
    assume {:partition} returnBuffer != 0;
    Tmp_397 := length_2 + 2;
    call {:si_unique_call 737} sdv_RtlZeroMemory(0, Tmp_397);
    call {:si_unique_call 738} sdv_RtlCopyMemory(0, 0, length_2);
    goto L79;
  ...
  anon93_Else:
    ...
    assume DeviceData_1 > 0;
    havoc Tmp_391;
    call {:si_unique_call 739} sdv_257 := ExAllocatePoolWithTag(1, Tmp_391, -311532205);
  ...
  anon127_Else:
    ...
    assume DeviceData_1 > 0;
    havoc Tmp_396;
    call {:si_unique_call 740} sdv_RtlCopyMemory(0, 0, Tmp_396);
    assume {:nonnull} Irp_18 != 0;
    assume Irp_18 > 0;
    goto L48;
  ...
  anon94_Else:
    call {:si_unique_call 741} sdv_258 := ExAllocatePoolWithTag(1, 8, -311532205);
    pDevRel := sdv_258;
    goto anon126_Then, anon126_Else;
  ...
  anon126_Else:
    ...
    assume Tmp_401 > 0;
    call {:si_unique_call 742} vslice_dummy_var_107 := sdv_ObReferenceObject(0);
    status_20 := 0;
    assume {:nonnull} Irp_18 != 0;
    assume Irp_18 > 0;
    goto L48;
  ...
  anon115_Then:
    ...
    call {:si_unique_call 743} SerenumMarkPdoRemoved(vslice_dummy_var_134);
    assume {:nonnull} DeviceData_1 != 0;
    assume DeviceData_1 > 0;
    goto anon95_Then, anon95_Else;
  ...
  anon95_Then:
    call {:si_unique_call 744} status_20 := Serenum_PnPRemove(DeviceObject_20, DeviceData_1);
    goto L48;
  ...
  L159:
    call {:si_unique_call 745} status_20 := IoOpenDeviceRegistryKey(0, 1, 131072, 0);
    goto anon97_Then, anon97_Else;
  ...
  anon98_Else:
    call {:si_unique_call 746} RtlInitUnicodeString(keyname, 0);
    assume {:nonnull} keyname != 0;
    assume keyname > 0;
    assume {:nonnull} keyname != 0;
    assume keyname > 0;
    havoc Tmp_395;
    call {:si_unique_call 747} sdv_252 := ExAllocatePoolWithTag(1, Tmp_395, -311532205);
    assume {:nonnull} keyname != 0;
    assume keyname > 0;
    assume {:nonnull} keyname != 0;
    assume keyname > 0;
  ...
  anon123_Else:
    call {:si_unique_call 748} vslice_dummy_var_105 := corral_nondet();
    assume {:nonnull} DeviceData_1 != 0;
    assume DeviceData_1 > 0;
    havoc Tmp_386;
    assume {:nonnull} DeviceData_1 != 0;
    assume DeviceData_1 > 0;
    call {:si_unique_call 749} status_20 := ZwSetValueKey(0, 0, 0, 1, 0, Tmp_386);
  ...
  anon99_Else:
    call {:si_unique_call 751} RtlInitUnicodeString(keyname, 0);
    assume {:nonnull} keyname != 0;
    assume keyname > 0;
    assume {:nonnull} keyname != 0;
    assume keyname > 0;
    havoc Tmp_389;
    call {:si_unique_call 752} sdv_249 := ExAllocatePoolWithTag(1, Tmp_389, -311532205);
    assume {:nonnull} keyname != 0;
    assume keyname > 0;
    assume {:nonnull} keyname != 0;
    assume keyname > 0;
  ...
  anon124_Else:
    call {:si_unique_call 753} vslice_dummy_var_106 := corral_nondet();
    assume {:nonnull} DeviceData_1 != 0;
    assume DeviceData_1 > 0;
    havoc Tmp_399;
    assume {:nonnull} DeviceData_1 != 0;
    assume DeviceData_1 > 0;
    call {:si_unique_call 754} status_20 := ZwSetValueKey(0, 0, 0, 1, 0, Tmp_399);
    call {:si_unique_call 755} sdv_ExFreePool(0);
    goto L188;

  L188:
    call {:si_unique_call 756} vslice_dummy_var_101 := ZwClose(0);
    goto L212;
...
implementation {:origName "SerenumMarkPdoRemoved"} SerenumMarkPdoRemoved(actual_PFdoData_6: int)
{
  ...
  anon0:
    call {:si_unique_call 757} vslice_dummy_var_108 := __HAVOC_malloc(4);
    PFdoData_6 := actual_PFdoData_6;
    call {:si_unique_call 758} Tmp_403 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_403 != 0;
    assume Tmp_403 > 0;
    call {:si_unique_call 759} sdv_KeAcquireSpinLock(0, Tmp_403);
    assume {:nonnull} Tmp_403 != 0;
    assume Tmp_403 > 0;
    havoc oldIrql_5;
    assume {:nonnull} PFdoData_6 != 0;
    assume PFdoData_6 > 0;
    call {:si_unique_call 760} sdv_KeReleaseSpinLock(0, oldIrql_5);
    return;
}
...
implementation {:origName "Serenum_PnPRemove"} Serenum_PnPRemove(actual_Device: int, actual_PdoData_2: int) returns (Tmp_404: int)
{
  ...
  anon6_Else:
    assume {:nonnull} PdoData_2 != 0;
    assume PdoData_2 > 0;
    call {:si_unique_call 761} RtlFreeUnicodeString(0);
    call {:si_unique_call 762} RtlFreeUnicodeString(0);
    call {:si_unique_call 763} RtlFreeUnicodeString(0);
...
const {:string "0000"} unique strConst__li2bpl19: int;

const {:string "DebugLevel"} unique strConst__li2bpl17: int;

const {:string "Identifier"} unique strConst__li2bpl14: int;

const {:string "MOUSE"} unique strConst__li2bpl15: int;

const {:string "PnPRev"} unique strConst__li2bpl20: int;

const {:string "PortName"} unique strConst__li2bpl13: int;

const {:string "SERENUM\\"} unique strConst__li2bpl16: int;

const {:string "SERIAL_MOUSE"} unique strConst__li2bpl3: int;

const {:string "Serenum"} unique strConst__li2bpl18: int;

const {:string "Serenum\\BallPoint"} unique strConst__li2bpl7: int;

const {:string "Serenum\\Mouse"} unique strConst__li2bpl4: int;

const {:string "Serial Number"} unique strConst__li2bpl21: int;

const {:string "The completion routine has completed an IRP and returned STATUS_CONTINUE_COMPLETION. This can cause a double completion if the lower driver returns STATUS_PENDING."} unique strConst__li2bpl11: int;

const {:string "The dispatch routine has marked the incoming IRP with IoMarkIrpPending, but it is not returning STATUS_PENDING."} unique strConst__li2bpl12: int;
...
implementation SerenumValidateID_loop_L10(in_cp: int)
{
  ...
  L_BAF_0:
    call {:si_unique_call 765} {:si_old_unique_call 1} SerenumValidateID_loop_L10(in_cp);
    return;
...
implementation Serenum_ReenumerateDevices_loop_L102(in_curTry: int, in_DSRMissing: int, in_nActual: int, in_pReadBuf: int, in_status_2: int, in_PFdoData_2: int) returns (out_curTry: int, out_status_2: int)
{
  ...
  L105:
    call {:si_unique_call 766} out_status_2 := SerenumDoEnumProtocol(in_PFdoData_2, in_pReadBuf, in_nActual, in_DSRMissing);
    goto anon171_Else;
  ...
  anon127_Else_dummy:
    call {:si_unique_call 768} {:si_old_unique_call 1} out_curTry, out_status_2 := Serenum_ReenumerateDevices_loop_L102(out_curTry, in_DSRMissing, in_nActual, in_pReadBuf, out_status_2, in_PFdoData_2);
    return;
...
implementation SerenumDoEnumProtocol_loop_L81(in_i: int, in_pDevStack_1: int, in_DefaultWait: int, in_ioStatusBlock: int, in_nRead: int, in_timer_1: int, in_pReadBuf_1: int, in_bitMask: int, in_status_4: int, in_event_1: int, in_PFdoData_3: int) returns (out_i: int, out_status_4: int)
{
  ...
  anon76_Else:
    ...
    assume in_bitMask > 0;
    call {:si_unique_call 776} out_status_4 := Serenum_IoSyncIoctlEx(1769548, 0, in_pDevStack_1, in_event_1, in_bitMask, 4, 0, 0);
    goto anon96_Else;
  ...
  anon78_Else:
    ...
    call {:si_unique_call 775} out_status_4 := Serenum_IoSyncIoctlEx(1769512, 0, in_pDevStack_1, in_event_1, 0, 0, 0, 0);
    goto anon97_Else;
  ...
  anon79_Else:
    assume {:partition} out_status_4 >= 0;
    call {:si_unique_call 774} out_status_4 := Serenum_IoSyncIoctlEx(1769524, 0, in_pDevStack_1, in_event_1, 0, 0, 0, 0);
    goto anon98_Else;
  ...
  anon80_Else:
    assume {:partition} out_status_4 >= 0;
    call {:si_unique_call 773} out_status_4 := Serenum_Wait(in_timer_1, in_DefaultWait);
    goto anon81_Else;

  anon81_Else:
    assume {:partition} out_status_4 >= 0;
    call {:si_unique_call 772} out_status_4 := Serenum_IoSyncIoctlEx(1769508, 0, in_pDevStack_1, in_event_1, 0, 0, 0, 0);
    goto anon99_Else;
  ...
  L118:
    call {:si_unique_call 770} out_status_4 := Serenum_IoSyncIoctlEx(1769520, 0, in_pDevStack_1, in_event_1, 0, 0, 0, 0);
    goto anon100_Else;
  ...
  anon84_Else:
    ...
    assume in_nRead > 0;
    call {:si_unique_call 769} out_status_4 := Serenum_ReadSerialPort(in_pReadBuf_1, 256, 240, in_nRead, in_ioStatusBlock, in_PFdoData_3);
    goto anon101_Else;
  ...
  L137_dummy:
    call {:si_unique_call 777} {:si_old_unique_call 1} out_i, out_status_4 := SerenumDoEnumProtocol_loop_L81(out_i, in_pDevStack_1, in_DefaultWait, in_ioStatusBlock, in_nRead, in_timer_1, in_pReadBuf_1, in_bitMask, out_status_4, in_event_1, in_PFdoData_3);
    return;
  ...
  anon83_Then:
    assume {:partition} out_i == 0;
    call {:si_unique_call 771} out_status_4 := Serenum_Wait(in_timer_1, in_DefaultWait);
    goto anon87_Else;
...
implementation Serenum_ReadSerialPort_loop_L25(in_pIrp_1: int, in_status_5: int, in_event_2: int, in_PReadBuffer: int, in_Buflen: int, in_nActual_1: int, in_PIoStatusBlock: int, in_FdoData_1: int) returns (out_pIrp_1: int, out_status_5: int)
{
  ...
  anon20_Else:
    call {:si_unique_call 779} KeClearEvent(in_event_2);
    call {:si_unique_call 780} out_pIrp_1 := IoBuildSynchronousFsdRequest(3, 0, 0, 1, 0, 0, in_PIoStatusBlock);
    goto anon21_Else;
  ...
  anon21_Else:
    ...
    call {:si_unique_call 778} out_status_5 := sdv_IoCallDriver(vslice_dummy_var_135, out_pIrp_1);
    goto anon27_Else;
  ...
  anon22_Else:
    ...
    call {:si_unique_call 781} out_status_5 := KeWaitForSingleObject(0, 0, 0, 0, 0);
    goto anon24_Then, anon24_Else;
  ...
  anon25_Else_dummy:
    call {:si_unique_call 782} {:si_old_unique_call 1} out_pIrp_1, out_status_5 := Serenum_ReadSerialPort_loop_L25(out_pIrp_1, out_status_5, in_event_2, in_PReadBuffer, in_Buflen, in_nActual_1, in_PIoStatusBlock, in_FdoData_1);
    return;
...
implementation Serenum_GetDevDesc_loop_L13(in_c_1: int, in_Tmp_257: int, in_Tmp_258: int, in_tail: int, in_input: int, in_output: int) returns (out_c_1: int, out_Tmp_257: int, out_Tmp_258: int, out_tail: int)
{
  ...
  anon17_Else_dummy:
    call {:si_unique_call 783} {:si_old_unique_call 1} out_c_1, out_Tmp_257, out_Tmp_258, out_tail := Serenum_GetDevDesc_loop_L13(out_c_1, out_Tmp_257, out_Tmp_258, out_tail, in_input, in_output);
    return;
}
...
implementation Serenum_GetDevPnPRev_loop_L34(in_i_2: int, in_sum: int, in_Tmp_291: int, in_c_3: int, in_Tmp_294: int, in_delta: int, in_input_2: int) returns (out_i_2: int, out_sum: int, out_Tmp_291: int, out_c_3: int, out_Tmp_294: int)
{
  ...
  anon47_Else_dummy:
    call {:si_unique_call 784} {:si_old_unique_call 1} out_i_2, out_sum, out_Tmp_291, out_c_3, out_Tmp_294 := Serenum_GetDevPnPRev_loop_L34(out_i_2, out_sum, out_Tmp_291, out_c_3, out_Tmp_294, in_delta, in_input_2);
    return;
}
...
implementation Serenum_GetDevPnPRev_loop_L76(in_i_2: int, in_Tmp_281: int, in_Tmp_289: int, in_c_3: int, in_Tmp_296: int, in_delta: int, in_Tmp_302: int, in_input_2: int) returns (out_i_2: int, out_Tmp_281: int, out_Tmp_289: int, out_c_3: int, out_Tmp_296: int, out_delta: int, out_Tmp_302: int)
{
  ...
  L_BAF_1:
    call {:si_unique_call 785} {:si_old_unique_call 1} out_i_2, out_Tmp_281, out_Tmp_289, out_c_3, out_Tmp_296, out_delta, out_Tmp_302 := Serenum_GetDevPnPRev_loop_L76(out_i_2, out_Tmp_281, out_Tmp_289, out_c_3, out_Tmp_296, out_delta, out_Tmp_302, in_input_2);
    return;
...
implementation Serenum_GetDevPnPRev_loop_L21(in_Tmp_278: int, in_Tmp_286: int, in_c_3: int, in_tail_2: int, in_input_2: int) returns (out_Tmp_278: int, out_Tmp_286: int, out_c_3: int, out_tail_2: int)
{
  ...
  anon44_Else_dummy:
    call {:si_unique_call 786} {:si_old_unique_call 1} out_Tmp_278, out_Tmp_286, out_c_3, out_tail_2 := Serenum_GetDevPnPRev_loop_L21(out_Tmp_278, out_Tmp_286, out_c_3, out_tail_2, in_input_2);
    return;
}
...
implementation Serenum_SzCopy_loop_L5(in_i_3: int, in_Tmp_305: int, in_Tmp_306: int, in_source: int, in_dest: int) returns (out_i_3: int, out_Tmp_305: int, out_Tmp_306: int)
{
  ...
  anon3_Else_dummy:
    call {:si_unique_call 787} {:si_old_unique_call 1} out_i_3, out_Tmp_305, out_Tmp_306 := Serenum_SzCopy_loop_L5(out_i_3, out_Tmp_305, out_Tmp_306, in_source, in_dest);
    return;
}
...
implementation Serenum_GetDevCompId_loop_L13(in_Tmp_307: int, in_c_4: int, in_Tmp_313: int, in_tail_3: int, in_input_3: int, in_output_3: int) returns (out_Tmp_307: int, out_c_4: int, out_Tmp_313: int, out_tail_3: int)
{
  ...
  L21_dummy:
    call {:si_unique_call 788} {:si_old_unique_call 1} out_Tmp_307, out_c_4, out_Tmp_313, out_tail_3 := Serenum_GetDevCompId_loop_L13(out_Tmp_307, out_c_4, out_Tmp_313, out_tail_3, in_input_3, in_output_3);
    return;
...
implementation Serenum_GetDevClass_loop_L13(in_Tmp_317: int, in_c_5: int, in_Tmp_319: int, in_tail_4: int, in_input_4: int, in_output_4: int) returns (out_Tmp_317: int, out_c_5: int, out_Tmp_319: int, out_tail_4: int)
{
  ...
  anon17_Else_dummy:
    call {:si_unique_call 789} {:si_old_unique_call 1} out_Tmp_317, out_c_5, out_Tmp_319, out_tail_4 := Serenum_GetDevClass_loop_L13(out_Tmp_317, out_c_5, out_Tmp_319, out_tail_4, in_input_4, in_output_4);
    return;
}
...
implementation Serenum_InitMultiString_loop_L57(in_i_4: int, in_Tmp_324: int, in_Tmp_326: int, in_unicodeString: int, in_Tmp_331: int) returns (out_i_4: int, out_Tmp_324: int, out_Tmp_326: int, out_Tmp_331: int)
{
  ...
  L62_dummy:
    call {:si_unique_call 790} {:si_old_unique_call 1} out_i_4, out_Tmp_324, out_Tmp_326, out_Tmp_331 := Serenum_InitMultiString_loop_L57(out_i_4, out_Tmp_324, out_Tmp_326, in_unicodeString, out_Tmp_331);
    return;
...
implementation Serenum_InitMultiString_loop_L47(in_i_4: int, in_Tmp_324: int, in_Tmp_326: int, in_unicodeString: int, in_rawString: int, in_Tmp_330: int, in_Tmp_331: int, in_ap: int, in_vslice_dummy_var_80: int) returns (out_i_4: int, out_Tmp_324: int, out_Tmp_326: int, out_rawString: int, out_Tmp_330: int, out_Tmp_331: int, out_vslice_dummy_var_80: int)
{
  ...
  anon19_Else:
    ...
    call {:si_unique_call 792} RtlInitAnsiString(0, 0);
    call {:si_unique_call 793} out_vslice_dummy_var_80 := RtlAnsiStringToUnicodeString(0, 0, 0);
    out_i_4 := 0;
    goto L57;

  L57:
    call {:si_unique_call 791} out_i_4, out_Tmp_324, out_Tmp_326, out_Tmp_331 := Serenum_InitMultiString_loop_L57(out_i_4, out_Tmp_324, out_Tmp_326, in_unicodeString, out_Tmp_331);
    goto L57_last;
  ...
  anon20_Then_dummy:
    call {:si_unique_call 794} {:si_old_unique_call 1} out_i_4, out_Tmp_324, out_Tmp_326, out_rawString, out_Tmp_330, out_Tmp_331, out_vslice_dummy_var_80 := Serenum_InitMultiString_loop_L47(out_i_4, out_Tmp_324, out_Tmp_326, in_unicodeString, out_rawString, out_Tmp_330, out_Tmp_331, in_ap, out_vslice_dummy_var_80);
    return;
}
...
implementation Serenum_InitMultiString_loop_L17(in_ansiString: int, in_multiLength: int, in_rawString: int, in_Tmp_329: int, in_Tmp_332: int, in_ap: int) returns (out_multiLength: int, out_rawString: int, out_Tmp_329: int, out_Tmp_332: int)
{
  ...
  anon17_Else:
    assume {:partition} out_rawString != 0;
    call {:si_unique_call 796} RtlInitAnsiString(0, 0);
    assume {:nonnull} NlsMbCodePageTag != 0;
    assume NlsMbCodePageTag > 0;
    goto anon18_Then, anon18_Else;

  anon18_Else:
    call {:si_unique_call 795} out_Tmp_332 := corral_nondet();
    goto L28;
...
implementation Serenum_GetDevOtherID_loop_L7(in_Tmp_342: int, in_c_6: int, in_Tmp_346: int, in_tail_5: int, in_input_5: int, in_output_5: int) returns (out_Tmp_342: int, out_c_6: int, out_Tmp_346: int, out_tail_5: int)
{
  ...
  anon9_Else_dummy:
    call {:si_unique_call 797} {:si_old_unique_call 1} out_Tmp_342, out_c_6, out_Tmp_346, out_tail_5 := Serenum_GetDevOtherID_loop_L7(out_Tmp_342, out_c_6, out_Tmp_346, out_tail_5, in_input_5, in_output_5);
    return;
}
...
implementation {:SIextraRecBound 8} Serenum_GetDevSerialNo_loop_L15(in_cnt: int, in_sdv_217: int, in_Tmp_354: int, in_c_7: int, in_Tmp_356: int, in_tail_6: int, in_input_6: int, in_output_7: int) returns (out_cnt: int, out_sdv_217: int, out_Tmp_354: int, out_c_7: int, out_Tmp_356: int, out_tail_6: int)
{
  ...
  anon22_Else:
    ...
    out_cnt := out_cnt + 1;
    call {:si_unique_call 798} out_sdv_217 := Serenum_HToI(out_c_7);
    goto anon23_Else;
  ...
  anon23_Else_dummy:
    call {:si_unique_call 799} {:si_old_unique_call 1} out_cnt, out_sdv_217, out_Tmp_354, out_c_7, out_Tmp_356, out_tail_6 := Serenum_GetDevSerialNo_loop_L15(out_cnt, out_sdv_217, out_Tmp_354, out_c_7, out_Tmp_356, out_tail_6, in_input_6, in_output_7);
    return;
}
