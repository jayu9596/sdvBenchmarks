...
implementation {:origName "IoQueueWorkItem"} {:osmodel} IoQueueWorkItem(actual_IoWorkItem_1: int, actual_WorkerRoutine: int, actual_QueueType: int, actual_Context: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 6} sdv_RunIoQueueWorkItems(0, WorkerRoutine, QueueType, 0);
    return;
}
...
implementation {:origName "sdv_SetStatus"} {:osmodel} sdv_SetStatus(actual_pirp_5: int)
{
  ...
  anon0:
    call {:si_unique_call 12} vslice_dummy_var_10 := __HAVOC_malloc(4);
...
implementation {:origName "sdv_main"} {:osmodel} sdv_main()
{
  ...
  anon0:
    call {:si_unique_call 13} vslice_dummy_var_11 := __HAVOC_malloc(4);
    call {:si_unique_call 14} sdv_stub_driver_init();
    call {:si_unique_call 15} vslice_dummy_var_12 := sdv_RunDispatchFunction(sdv_p_devobj_fdo, sdv_irp);
    goto anon3_Then, anon3_Else;
...
implementation {:origName "IoAllocateErrorLogEntry"} {:osmodel} IoAllocateErrorLogEntry(actual_IoObject: int, actual_EntrySize: int) returns (Tmp_38: int)
{
  ...
  anon3_Else:
    call {:si_unique_call 16} sdv_12 := __HAVOC_malloc(1);
    Tmp_38 := sdv_12;
    goto L1;
...
implementation {:origName "WmiSystemControl"} {:osmodel} WmiSystemControl(actual_WmiLibInfo: int, actual_DeviceObject_2: int, actual_pirp_6: int, actual_IrpDisposition: int) returns (Tmp_42: int)
{
  ...
  anon11_Else:
    ...
    s_1 := 0;
    call {:si_unique_call 17} sdv_stub_WmiIrpForward(0);
    goto L24;
  ...
  anon12_Then:
    ...
    assume IrpDisposition > 0;
    s_1 := 0;
    call {:si_unique_call 19} sdv_stub_WmiIrpNotCompleted(0);
    goto L24;
  ...
  anon9_Then:
    ...
    assume IrpDisposition > 0;
    s_1 := 0;
    call {:si_unique_call 20} sdv_stub_WmiIrpProcessed(0);
    goto L24;
}
...
implementation {:origName "PoSetPowerState"} {:osmodel} PoSetPowerState(actual_DeviceObject_3: int, actual_Type: int, actual_structPtr888State: int) returns (SD1: int)
{
  ...
  anon0:
    call {:si_unique_call 21} State := __HAVOC_malloc(8);
    call {:si_unique_call 22} r_2 := __HAVOC_malloc(8);
    call {:si_unique_call 23} Tmp_1 := __HAVOC_malloc(8);
...
implementation {:origName "IoWriteErrorLogEntry"} {:osmodel} IoWriteErrorLogEntry(actual_ElEntry: int)
{
  ...
  anon0:
    call {:si_unique_call 24} vslice_dummy_var_13 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "sdv_IoSetCompletionRoutine"} {:osmodel} sdv_IoSetCompletionRoutine(actual_pirp_7: int, actual_CompletionRoutine: int, actual_Context_2: int, actual_InvokeOnSuccess: int, actual_InvokeOnError: int, actual_InvokeOnCancel: int)
{
  ...
  anon0:
    call {:si_unique_call 25} vslice_dummy_var_14 := __HAVOC_malloc(4);
    ...
    call {:si_unique_call 26} SLIC_sdv_IoSetCompletionRoutine_entry(0, pirp_7);
...
implementation {:origName "KeSetEvent"} {:osmodel} KeSetEvent(actual_Event: int, actual_Increment: int, actual_Wait: int) returns (Tmp_61: int)
{
  ...
  anon0:
    Event := actual_Event;
    call {:si_unique_call 31} SLIC_KeSetEvent_entry(0);
...
implementation {:origName "sdv_stub_power_completion_begin"} {:osmodel} sdv_stub_power_completion_begin()
{
  ...
  anon0:
    call {:si_unique_call 32} vslice_dummy_var_18 := __HAVOC_malloc(4);
    goto anon3_Then, anon3_Else;
...
implementation {:origName "_sdv_init2"} {:osmodel} _sdv_init2()
{
  ...
  anon0:
    call {:si_unique_call 33} vslice_dummy_var_19 := __HAVOC_malloc(4);
...
implementation {:origName "main"} {:osmodel} main() returns (Tmp_75: int, dup_assertVar: bool)
{
  ...
  anon0:
    ...
    call {:si_unique_call 55} sdv_MapRegisterBase_val__Loc := __HAVOC_malloc_or_null(4);
    assume sdv_MapRegisterBase_val__Loc == sdv_MapRegisterBase_val;
    assume sdv_MapRegisterBase_val != 0;
    call {:si_unique_call 56} sdv_IoGetFileObjectGenericMapping_GENERIC_MAPPING__Loc := __HAVOC_malloc_or_null(16);
    assume sdv_IoGetFileObjectGenericMapping_GENERIC_MAPPING__Loc == sdv_IoGetFileObjectGenericMapping_GENERIC_MAPPING;
    assume sdv_IoGetFileObjectGenericMapping_GENERIC_MAPPING != 0;
    call {:si_unique_call 57} sdv_IoMakeAssociatedIrp_harnessIrp__Loc := __HAVOC_malloc_or_null(240);
    assume sdv_IoMakeAssociatedIrp_harnessIrp__Loc == sdv_IoMakeAssociatedIrp_harnessIrp;
    assume sdv_IoMakeAssociatedIrp_harnessIrp != 0;
    call {:si_unique_call 58} sdv_devobj_child_pdo__Loc := __HAVOC_malloc_or_null(380);
    assume sdv_devobj_child_pdo__Loc == sdv_devobj_child_pdo;
    assume sdv_devobj_child_pdo != 0;
    call {:si_unique_call 59} sdv_harnessIrp__Loc := __HAVOC_malloc_or_null(240);
    assume sdv_harnessIrp__Loc == sdv_harnessIrp;
    assume sdv_harnessIrp != 0;
    call {:si_unique_call 60} sdv_IoBuildAsynchronousFsdRequest_harnessStackLocation_next__Loc := __HAVOC_malloc_or_null(536);
    assume sdv_IoBuildAsynchronousFsdRequest_harnessStackLocation_next__Loc == sdv_IoBuildAsynchronousFsdRequest_harnessStackLocation_next;
    assume sdv_IoBuildAsynchronousFsdRequest_harnessStackLocation_next != 0;
    call {:si_unique_call 61} sdv_harness_IoBuildDeviceIoControlRequest_IoStatusBlock__Loc := __HAVOC_malloc_or_null(12);
    assume sdv_harness_IoBuildDeviceIoControlRequest_IoStatusBlock__Loc == sdv_harness_IoBuildDeviceIoControlRequest_IoStatusBlock;
    assume sdv_harness_IoBuildDeviceIoControlRequest_IoStatusBlock != 0;
    call {:si_unique_call 62} sdv_kinterrupt_val__Loc := __HAVOC_malloc_or_null(0);
    assume sdv_kinterrupt_val__Loc == sdv_kinterrupt_val;
    assume sdv_kinterrupt_val != 0;
    call {:si_unique_call 63} sdv_fx_dev_object__Loc := __HAVOC_malloc_or_null(40);
    assume sdv_fx_dev_object__Loc == sdv_fx_dev_object;
    assume sdv_fx_dev_object != 0;
    call {:si_unique_call 64} sdv_devobj_fdo__Loc := __HAVOC_malloc_or_null(380);
    assume sdv_devobj_fdo__Loc == sdv_devobj_fdo;
    assume sdv_devobj_fdo != 0;
    call {:si_unique_call 65} sdv_StartIoIrp__Loc := __HAVOC_malloc_or_null(240);
    assume sdv_StartIoIrp__Loc == sdv_StartIoIrp;
    assume sdv_StartIoIrp != 0;
    call {:si_unique_call 66} sdv_harness_IoBuildAsynchronousFsdRequest_IoStatusBlock__Loc := __HAVOC_malloc_or_null(12);
    assume sdv_harness_IoBuildAsynchronousFsdRequest_IoStatusBlock__Loc == sdv_harness_IoBuildAsynchronousFsdRequest_IoStatusBlock;
    assume sdv_harness_IoBuildAsynchronousFsdRequest_IoStatusBlock != 0;
    call {:si_unique_call 67} sdv_PowerIrp__Loc := __HAVOC_malloc_or_null(240);
    assume sdv_PowerIrp__Loc == sdv_PowerIrp;
    assume sdv_PowerIrp != 0;
    call {:si_unique_call 68} sdv_IoBuildDeviceIoControlRequest_harnessIrp__Loc := __HAVOC_malloc_or_null(240);
    assume sdv_IoBuildDeviceIoControlRequest_harnessIrp__Loc == sdv_IoBuildDeviceIoControlRequest_harnessIrp;
    assume sdv_IoBuildDeviceIoControlRequest_harnessIrp != 0;
    call {:si_unique_call 69} sdv_other_harnessIrp__Loc := __HAVOC_malloc_or_null(240);
    assume sdv_other_harnessIrp__Loc == sdv_other_harnessIrp;
    assume sdv_other_harnessIrp != 0;
    call {:si_unique_call 70} sdv_IoCreateNotificationEvent_KEVENT__Loc := __HAVOC_malloc_or_null(156);
    assume sdv_IoCreateNotificationEvent_KEVENT__Loc == sdv_IoCreateNotificationEvent_KEVENT;
    assume sdv_IoCreateNotificationEvent_KEVENT != 0;
    call {:si_unique_call 71} sdv_other_harnessStackLocation__Loc := __HAVOC_malloc_or_null(536);
    assume sdv_other_harnessStackLocation__Loc == sdv_other_harnessStackLocation;
    assume sdv_other_harnessStackLocation != 0;
    call {:si_unique_call 72} SLAM_guard_O_0_init__Loc := __HAVOC_malloc_or_null(156);
    ...
    call {:si_unique_call 81} GUID_ARBITER_INTERFACE_STANDARD__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_ARBITER_INTERFACE_STANDARD__Loc == GUID_ARBITER_INTERFACE_STANDARD;
    assume GUID_ARBITER_INTERFACE_STANDARD != 0;
    call {:si_unique_call 82} MSNdis_VendorID_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_VendorID_GUID__Loc == MSNdis_VendorID_GUID;
    assume MSNdis_VendorID_GUID != 0;
    call {:si_unique_call 83} MSNdis_StatusDot11PmkidCandidateList_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 84} MSMCAEvent_PCIComponentError_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 85} MSNdis_FddiLongCurrentAddress_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 86} MSNdis_QueryReceiveFilterHardwareCapabilities_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 95} MSNdis_80211_DesiredDataRates_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 96} MSMCAInfo_Entry_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSMCAInfo_Entry_GUID__Loc == MSMCAInfo_Entry_GUID;
    assume MSMCAInfo_Entry_GUID != 0;
    call {:si_unique_call 97} MSNdis_GroupAffinity_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_GroupAffinity_GUID__Loc == MSNdis_GroupAffinity_GUID;
    assume MSNdis_GroupAffinity_GUID != 0;
    call {:si_unique_call 98} MSNdis_StatusDot11RoamingCompletion_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 99} MSNdis_EthernetCurrentAddress_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 100} MSNdis_TcpOffloadHardwareConfig_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 101} MSNdis_80211_ConfigurationFH_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 102} GUID_MF_ENUMERATION_INTERFACE__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_MF_ENUMERATION_INTERFACE__Loc == GUID_MF_ENUMERATION_INTERFACE;
    assume GUID_MF_ENUMERATION_INTERFACE != 0;
    call {:si_unique_call 103} GUID_LEGACY_DEVICE_DETECTION_STANDARD__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 104} KernelPerfStateChange_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume KernelPerfStateChange_GUID__Loc == KernelPerfStateChange_GUID;
    assume KernelPerfStateChange_GUID != 0;
    call {:si_unique_call 105} MSNdis_PMCapabilities_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_PMCapabilities_GUID__Loc == MSNdis_PMCapabilities_GUID;
    assume MSNdis_PMCapabilities_GUID != 0;
    call {:si_unique_call 106} MSRedbook_PerformanceGuid__Loc := __HAVOC_malloc_or_null(16);
    assume MSRedbook_PerformanceGuid__Loc == MSRedbook_PerformanceGuid;
    assume MSRedbook_PerformanceGuid != 0;
    call {:si_unique_call 107} MSNdis_StatusDot11RoamingStart_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 108} GUID_DEVICE_MEMORY__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_DEVICE_MEMORY__Loc == GUID_DEVICE_MEMORY;
    assume GUID_DEVICE_MEMORY != 0;
    call {:si_unique_call 109} MSMouse_ClassInformation_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSMouse_ClassInformation_GUID__Loc == MSMouse_ClassInformation_GUID;
    assume MSMouse_ClassInformation_GUID != 0;
    call {:si_unique_call 110} GUID_DEVICE_FAN__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_DEVICE_FAN__Loc == GUID_DEVICE_FAN;
    assume GUID_DEVICE_FAN != 0;
    call {:si_unique_call 111} MSNdis_80211_NetworkTypesSupported_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 112} MSNdis_80211_NetworkInfrastructure_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 113} GUID_PNP_POWER_SETTING_CHANGE__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_PNP_POWER_SETTING_CHANGE__Loc == GUID_PNP_POWER_SETTING_CHANGE;
    assume GUID_PNP_POWER_SETTING_CHANGE != 0;
    call {:si_unique_call 114} MSNdis_NotifyVcArrival_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_NotifyVcArrival_GUID__Loc == MSNdis_NotifyVcArrival_GUID;
    assume MSNdis_NotifyVcArrival_GUID != 0;
    call {:si_unique_call 115} MSNdis_FddiShortMulticastList_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 116} PROCESSOR_NUMBER_PKEY__Loc := __HAVOC_malloc_or_null(20);
    assume PROCESSOR_NUMBER_PKEY__Loc == PROCESSOR_NUMBER_PKEY;
    assume PROCESSOR_NUMBER_PKEY != 0;
    call {:si_unique_call 117} MSNdis_AtmMaxAal5PacketSize_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_AtmMaxAal5PacketSize_GUID__Loc == MSNdis_AtmMaxAal5PacketSize_GUID;
    assume MSNdis_AtmMaxAal5PacketSize_GUID != 0;
    call {:si_unique_call 118} MSNdis_80211_ReceivedSignalStrengthEventTrigger_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 119} MSNdis_StatusDevicePowerOn_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_StatusDevicePowerOn_GUID__Loc == MSNdis_StatusDevicePowerOn_GUID;
    assume MSNdis_StatusDevicePowerOn_GUID != 0;
    call {:si_unique_call 120} MSKeyboard_ExtendedID_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSKeyboard_ExtendedID_GUID__Loc == MSKeyboard_ExtendedID_GUID;
    assume MSKeyboard_ExtendedID_GUID != 0;
    call {:si_unique_call 121} WHEAErrorSourceMethods_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume WHEAErrorSourceMethods_GUID__Loc == WHEAErrorSourceMethods_GUID;
    assume WHEAErrorSourceMethods_GUID != 0;
    call {:si_unique_call 122} MSNdis_AtmMaxAal34PacketSize_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 123} GUID_ACPI_REGS_INTERFACE_STANDARD__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 124} MSNdis_TokenRingCurrentGroup_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 125} MSNdis_FddiLConnectionState_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_FddiLConnectionState_GUID__Loc == MSNdis_FddiLConnectionState_GUID;
    assume MSNdis_FddiLConnectionState_GUID != 0;
    call {:si_unique_call 126} GUID_PARTITION_UNIT_INTERFACE_STANDARD__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 133} MSMCAEvent_PCIBusError_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSMCAEvent_PCIBusError_GUID__Loc == MSMCAEvent_PCIBusError_GUID;
    assume MSMCAEvent_PCIBusError_GUID != 0;
    call {:si_unique_call 134} MSNdis_StatusMediaConnect_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_StatusMediaConnect_GUID__Loc == MSNdis_StatusMediaConnect_GUID;
    assume MSNdis_StatusMediaConnect_GUID != 0;
    call {:si_unique_call 135} MSNdis_MediaInUse_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_MediaInUse_GUID__Loc == MSNdis_MediaInUse_GUID;
    assume MSNdis_MediaInUse_GUID != 0;
    call {:si_unique_call 136} MSStorageDriver_ScsiInfoExceptions_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 137} WmiMonitorID_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume WmiMonitorID_GUID__Loc == WmiMonitorID_GUID;
    assume WmiMonitorID_GUID != 0;
    call {:si_unique_call 138} MSNdis_ReceiveFilterInfoArray_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 139} MSMCAInfo_RawCorrectedPlatformEvent_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 140} MSNdis_CurrentLookahead_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_CurrentLookahead_GUID__Loc == MSNdis_CurrentLookahead_GUID;
    assume MSNdis_CurrentLookahead_GUID != 0;
    call {:si_unique_call 141} MSStorageDriver_ATAPISmartData_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 142} GUID_DEVICE_PROCESSOR__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_DEVICE_PROCESSOR__Loc == GUID_DEVICE_PROCESSOR;
    assume GUID_DEVICE_PROCESSOR != 0;
    call {:si_unique_call 143} MSNdis_AtmMaxActiveVciBits_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_AtmMaxActiveVciBits_GUID__Loc == MSNdis_AtmMaxActiveVciBits_GUID;
    assume MSNdis_AtmMaxActiveVciBits_GUID != 0;
    call {:si_unique_call 144} MSNdis_80211_NetworkTypeInUse_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 145} ProcessorPerformance_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume ProcessorPerformance_GUID__Loc == ProcessorPerformance_GUID;
    assume ProcessorPerformance_GUID != 0;
    call {:si_unique_call 146} MSNdis_QueryPhysicalMediumTypeEx_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 147} MSNdis_80211_Configuration_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_80211_Configuration_GUID__Loc == MSNdis_80211_Configuration_GUID;
    assume MSNdis_80211_Configuration_GUID != 0;
    call {:si_unique_call 148} MSMCAEvent_BusError_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSMCAEvent_BusError_GUID__Loc == MSMCAEvent_BusError_GUID;
    assume MSMCAEvent_BusError_GUID != 0;
    call {:si_unique_call 149} MSNdis_MaximumTotalSize_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_MaximumTotalSize_GUID__Loc == MSNdis_MaximumTotalSize_GUID;
    assume MSNdis_MaximumTotalSize_GUID != 0;
    call {:si_unique_call 150} MSNdis_StatusPacketFilterChange_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 151} WmiMonitorBasicDisplayParams_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 152} MSNdis_ReceiveBufferSpace_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_ReceiveBufferSpace_GUID__Loc == MSNdis_ReceiveBufferSpace_GUID;
    assume MSNdis_ReceiveBufferSpace_GUID != 0;
    call {:si_unique_call 153} MSPower_DeviceWakeEnable_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSPower_DeviceWakeEnable_GUID__Loc == MSPower_DeviceWakeEnable_GUID;
    assume MSPower_DeviceWakeEnable_GUID != 0;
    call {:si_unique_call 154} MSNdis_CoVendorId_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_CoVendorId_GUID__Loc == MSNdis_CoVendorId_GUID;
    assume MSNdis_CoVendorId_GUID != 0;
    call {:si_unique_call 155} MSNdis_AtmHardwareCurrentAddress_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 156} MSNdis_WmiTcpIpChecksumOffload_IPv4TransmitReceive_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 177} MSParallel_DeviceBytesTransferred_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 178} MSSmBios_Sysid1394List_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSSmBios_Sysid1394List_GUID__Loc == MSSmBios_Sysid1394List_GUID;
    assume MSSmBios_Sysid1394List_GUID != 0;
    call {:si_unique_call 179} MSNdis_TransmitsError_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_TransmitsError_GUID__Loc == MSNdis_TransmitsError_GUID;
    assume MSNdis_TransmitsError_GUID != 0;
    call {:si_unique_call 180} MSNdis_CoMinimumLinkSpeed_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_CoMinimumLinkSpeed_GUID__Loc == MSNdis_CoMinimumLinkSpeed_GUID;
    assume MSNdis_CoMinimumLinkSpeed_GUID != 0;
    call {:si_unique_call 181} MSNdis_QueryReceiveFilterParameters_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 182} MSNdis_QueryNicSwitchCurrentCapabilities_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 183} MSNdis_StatusDot11Disassociation_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 184} MSNdis_NetworkDirectVersion_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_NetworkDirectVersion_GUID__Loc == MSNdis_NetworkDirectVersion_GUID;
    assume MSNdis_NetworkDirectVersion_GUID != 0;
    call {:si_unique_call 185} GUID_PCI_VIRTUALIZATION_INTERFACE__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 186} MSNdis_80211_Disassociate_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_80211_Disassociate_GUID__Loc == MSNdis_80211_Disassociate_GUID;
    assume MSNdis_80211_Disassociate_GUID != 0;
    call {:si_unique_call 187} MSStorageDriver_FailurePredictStatus_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 188} GUID_QUERY_CRASHDUMP_FUNCTIONS__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_QUERY_CRASHDUMP_FUNCTIONS__Loc == GUID_QUERY_CRASHDUMP_FUNCTIONS;
    assume GUID_QUERY_CRASHDUMP_FUNCTIONS != 0;
    call {:si_unique_call 189} MSNdis_LinkSpeed_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_LinkSpeed_GUID__Loc == MSNdis_LinkSpeed_GUID;
    assume MSNdis_LinkSpeed_GUID != 0;
    call {:si_unique_call 190} GUID_AGP_TARGET_BUS_INTERFACE_STANDARD__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 191} MSNdis_WmiReceiveScaleCapabilities_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 192} MSNdis_80211_AddWEP_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_80211_AddWEP_GUID__Loc == MSNdis_80211_AddWEP_GUID;
    assume MSNdis_80211_AddWEP_GUID != 0;
    call {:si_unique_call 193} MSNdis_StatusDevicePowerOnEx_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 194} MSNdis_TokenRingCurrentRingStatus_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 195} IdleStateBucketEx_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 389} MSMCAEvent_SystemEventError_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSMCAEvent_SystemEventError_GUID__Loc == MSMCAEvent_SystemEventError_GUID;
    assume MSMCAEvent_SystemEventError_GUID != 0;
    call {:si_unique_call 390} MSNdis_VendorDriverVersion_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_VendorDriverVersion_GUID__Loc == MSNdis_VendorDriverVersion_GUID;
    assume MSNdis_VendorDriverVersion_GUID != 0;
    call {:si_unique_call 391} GUID_PNP_POWER_NOTIFICATION__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_PNP_POWER_NOTIFICATION__Loc == GUID_PNP_POWER_NOTIFICATION;
    assume GUID_PNP_POWER_NOTIFICATION != 0;
    call {:si_unique_call 392} MSNdis_TokenRingLastOpenStatus_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 393} MSTapeDriveProblemEvent_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSTapeDriveProblemEvent_GUID__Loc == MSTapeDriveProblemEvent_GUID;
    assume MSTapeDriveProblemEvent_GUID != 0;
    call {:si_unique_call 394} MSTapeProblemDeviceError_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSTapeProblemDeviceError_GUID__Loc == MSTapeProblemDeviceError_GUID;
    assume MSTapeProblemDeviceError_GUID != 0;
    call {:si_unique_call 395} WmiMonitorListedSupportedSourceModes_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 396} MSNdis_FddiFrameErrors_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_FddiFrameErrors_GUID__Loc == MSNdis_FddiFrameErrors_GUID;
    assume MSNdis_FddiFrameErrors_GUID != 0;
    call {:si_unique_call 397} MSNdis_WmiTcpLargeSendOffloadV2_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 398} GUID_BUS_TYPE_HID__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_BUS_TYPE_HID__Loc == GUID_BUS_TYPE_HID;
    assume GUID_BUS_TYPE_HID != 0;
    call {:si_unique_call 399} MSNdis_NetworkDirectAdapterCapabilities_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 400} GUID_TARGET_DEVICE_REMOVE_COMPLETE__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 401} WmiMonitorColorXYZinCIE_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume WmiMonitorColorXYZinCIE_GUID__Loc == WmiMonitorColorXYZinCIE_GUID;
    assume WmiMonitorColorXYZinCIE_GUID != 0;
    call {:si_unique_call 402} GUID_POWER_DEVICE_WAKE_ENABLE__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_POWER_DEVICE_WAKE_ENABLE__Loc == GUID_POWER_DEVICE_WAKE_ENABLE;
    assume GUID_POWER_DEVICE_WAKE_ENABLE != 0;
    call {:si_unique_call 403} MSNdis_TransmitBufferSpace_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_TransmitBufferSpace_GUID__Loc == MSNdis_TransmitBufferSpace_GUID;
    assume MSNdis_TransmitBufferSpace_GUID != 0;
    call {:si_unique_call 404} MSNdis_CoVendorDriverVersion_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 405} MSNdis_FddiDownstreamNodeLong_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 406} GUID_PCMCIA_BUS_INTERFACE_STANDARD__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 407} GUID_BUS_TYPE_PCMCIA__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_BUS_TYPE_PCMCIA__Loc == GUID_BUS_TYPE_PCMCIA;
    assume GUID_BUS_TYPE_PCMCIA != 0;
    call {:si_unique_call 408} MSNdis_FddiLemRejects_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_FddiLemRejects_GUID__Loc == MSNdis_FddiLemRejects_GUID;
    assume MSNdis_FddiLemRejects_GUID != 0;
    call {:si_unique_call 409} MSNdis_80211_NumberOfAntennas_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 410} IdleStateAccountingEx_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume IdleStateAccountingEx_GUID__Loc == IdleStateAccountingEx_GUID;
    assume IdleStateAccountingEx_GUID != 0;
    call {:si_unique_call 411} MSNdis_80211_WLanBssId_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_80211_WLanBssId_GUID__Loc == MSNdis_80211_WLanBssId_GUID;
    assume MSNdis_80211_WLanBssId_GUID != 0;
    call {:si_unique_call 412} MSNdis_FddiRingManagmentState_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 413} GUID_BUS_TYPE_1394__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_BUS_TYPE_1394__Loc == GUID_BUS_TYPE_1394;
    assume GUID_BUS_TYPE_1394 != 0;
    call {:si_unique_call 414} MSSmBios_SysidUUIDList_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSSmBios_SysidUUIDList_GUID__Loc == MSSmBios_SysidUUIDList_GUID;
    assume MSSmBios_SysidUUIDList_GUID != 0;
    call {:si_unique_call 415} MSNdis_ReceiveScaleCapabilities_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 416} MSNdis_QueryReceiveFilterGlobalParameters_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 417} MSNdis_PMCapabilityState_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_PMCapabilityState_GUID__Loc == MSNdis_PMCapabilityState_GUID;
    assume MSNdis_PMCapabilityState_GUID != 0;
    call {:si_unique_call 418} GUID_TARGET_DEVICE_REMOVE_CANCELLED__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 419} MSNdis_StatusLinkSpeedChange_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 420} MSNdis_StatusResetEnd_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_StatusResetEnd_GUID__Loc == MSNdis_StatusResetEnd_GUID;
    assume MSNdis_StatusResetEnd_GUID != 0;
    call {:si_unique_call 421} MSNdis_AtmMaxActiveVpiBits_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_AtmMaxActiveVpiBits_GUID__Loc == MSNdis_AtmMaxActiveVpiBits_GUID;
    assume MSNdis_AtmMaxActiveVpiBits_GUID != 0;
    call {:si_unique_call 422} MSNdis_EnumerateReceiveFilters_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 423} MSNdis_StatusMediaDisconnect_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 424} MSParallel_AllocFreeCounts_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSParallel_AllocFreeCounts_GUID__Loc == MSParallel_AllocFreeCounts_GUID;
    assume MSParallel_AllocFreeCounts_GUID != 0;
    call {:si_unique_call 425} WmiMonitorConnectionParams_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume WmiMonitorConnectionParams_GUID__Loc == WmiMonitorConnectionParams_GUID;
    assume WmiMonitorConnectionParams_GUID != 0;
    call {:si_unique_call 426} MSNdis_EthernetMulticastList_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 427} MSNdis_ReceiveFilterGlobalParameters_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 428} MSNdis_80211_NetworkType_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_80211_NetworkType_GUID__Loc == MSNdis_80211_NetworkType_GUID;
    assume MSNdis_80211_NetworkType_GUID != 0;
    call {:si_unique_call 429} MSSerial_HardwareConfiguration_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 436} MSTapeSymbolicName_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSTapeSymbolicName_GUID__Loc == MSTapeSymbolicName_GUID;
    assume MSTapeSymbolicName_GUID != 0;
    call {:si_unique_call 437} MSNdis_ReceiveNoBuffer_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_ReceiveNoBuffer_GUID__Loc == MSNdis_ReceiveNoBuffer_GUID;
    assume MSNdis_ReceiveNoBuffer_GUID != 0;
    call {:si_unique_call 438} MSNdis_WmiEnumAdapter_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_WmiEnumAdapter_GUID__Loc == MSNdis_WmiEnumAdapter_GUID;
    assume MSNdis_WmiEnumAdapter_GUID != 0;
    call {:si_unique_call 439} MSWmi_PnPInstanceNames_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSWmi_PnPInstanceNames_GUID__Loc == MSWmi_PnPInstanceNames_GUID;
    assume MSWmi_PnPInstanceNames_GUID != 0;
    call {:si_unique_call 440} MSNdis_NetworkDirectCapabilities_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 441} MSNdis_StatusResetStart_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_StatusResetStart_GUID__Loc == MSNdis_StatusResetStart_GUID;
    assume MSNdis_StatusResetStart_GUID != 0;
    call {:si_unique_call 442} GUID_DEVINTERFACE_MOUSE__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_DEVINTERFACE_MOUSE__Loc == GUID_DEVINTERFACE_MOUSE;
    assume GUID_DEVINTERFACE_MOUSE != 0;
    call {:si_unique_call 443} MSNdis_MaximumFrameSize_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_MaximumFrameSize_GUID__Loc == MSNdis_MaximumFrameSize_GUID;
    assume MSNdis_MaximumFrameSize_GUID != 0;
    call {:si_unique_call 444} MSNdis_WmiSetHeader_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_WmiSetHeader_GUID__Loc == MSNdis_WmiSetHeader_GUID;
    assume MSNdis_WmiSetHeader_GUID != 0;
    call {:si_unique_call 445} MSNdis_80211_ConfigurationInfo_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 446} MSNdis_80211_ServiceSetIdentifier_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 447} MSSerial_PerformanceInformation_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 448} WmiMonitorSupportedDisplayFeatures_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 449} GUID_WUDF_DEVICE_HOST_PROBLEM__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_WUDF_DEVICE_HOST_PROBLEM__Loc == GUID_WUDF_DEVICE_HOST_PROBLEM;
    assume GUID_WUDF_DEVICE_HOST_PROBLEM != 0;
    call {:si_unique_call 450} MSNdis_EthernetMaximumMulticastListSize_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 451} MSNdis_SetHDSplitParameters_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_SetHDSplitParameters_GUID__Loc == MSNdis_SetHDSplitParameters_GUID;
    assume MSNdis_SetHDSplitParameters_GUID != 0;
    call {:si_unique_call 452} GUID_BUS_TYPE_SERENUM__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_BUS_TYPE_SERENUM__Loc == GUID_BUS_TYPE_SERENUM;
    assume GUID_BUS_TYPE_SERENUM != 0;
    call {:si_unique_call 453} MSNdis_WmiIPSecOffloadV1_IPv4AH_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 454} MSNdis_TcpOffloadCurrentConfig_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 470} GUID_DEVICE_ACPI_TIME__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 487} Globals__Loc := __HAVOC_malloc_or_null(648);
    ...
    call {:si_unique_call 521} boogieTmp := __HAVOC_malloc_or_null(12);
    call {:si_unique_call 522} vslice_dummy_var_0 := __HAVOC_malloc(24);
    assume {:mainInitDone} true;
    call {:si_unique_call 523} corralExtraInit();
    call {:si_unique_call 524} corralExplainErrorInit();
    call {:si_unique_call 525} _sdv_init4();
    call {:si_unique_call 526} _sdv_init1();
    call {:si_unique_call 527} _sdv_init2();
    goto anon9_Then, anon9_Else;
  ...
  L31:
    ...
    call {:si_unique_call 528} sdv_main();
    goto anon12_Then, anon12_Else;
...
implementation {:origName "sdv_IoSkipCurrentIrpStackLocation"} {:osmodel} sdv_IoSkipCurrentIrpStackLocation(actual_pirp_9: int)
{
  ...
  anon0:
    call {:si_unique_call 529} vslice_dummy_var_20 := __HAVOC_malloc(4);
...
implementation {:origName "RtlInitUnicodeString"} {:osmodel} RtlInitUnicodeString(actual_DestinationString: int, actual_SourceString: int)
{
  ...
  anon0:
    call {:si_unique_call 530} vslice_dummy_var_21 := __HAVOC_malloc(4);
...
implementation {:origName "sdv_RtlZeroMemory"} {:osmodel} sdv_RtlZeroMemory(actual_Destination_1: int, actual_Length_1: int)
{
  ...
  anon0:
    call {:si_unique_call 531} vslice_dummy_var_22 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "sdv_do_paged_code_check"} {:osmodel} sdv_do_paged_code_check()
{
  ...
  anon0:
    call {:si_unique_call 532} vslice_dummy_var_23 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "sdv_IoMarkIrpPending"} {:osmodel} sdv_IoMarkIrpPending(actual_pirp_10: int)
{
  ...
  anon0:
    call {:si_unique_call 533} vslice_dummy_var_24 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "sdv_stub_WmiIrpNotCompleted"} {:osmodel} sdv_stub_WmiIrpNotCompleted(actual_pirp_11: int)
{
  ...
  anon0:
    call {:si_unique_call 534} vslice_dummy_var_25 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "sdv_RunDispatchFunction"} {:osmodel} sdv_RunDispatchFunction(actual_po: int, actual_pirp_12: int) returns (Tmp_97: int)
{
  ...
  anon0:
    ...
    assume {:nonnull} pirp_12 != 0;
    assume pirp_12 > 0;
    call {:si_unique_call 535} sdv_SetStatus(pirp_12);
    assume {:nonnull} pirp_12 != 0;
    assume pirp_12 > 0;
    assume {:nonnull} pirp_12 != 0;
    assume pirp_12 > 0;
  ...
  L66:
    call {:si_unique_call 537} status_2 := KeyboardPnP(po, pirp_12);
  ...
  L72:
    call {:si_unique_call 538} sdv_stub_dispatch_end(status_2, 0);
    assume {:nonnull} pirp_12 != 0;
    assume pirp_12 > 0;
    Tmp_97 := status_2;
    goto LM2;
  ...
  anon62_Then:
    call {:si_unique_call 539} status_2 := sdv_DoNothing();
    goto L72;

  anon63_Then:
    assume {:nonnull} ps != 0;
    assume ps > 0;
    call {:si_unique_call 540} status_2 := KeyboardClassSystemControl(po, pirp_12);
  ...
  anon64_Then:
    assume {:nonnull} ps != 0;
    assume ps > 0;
    call {:si_unique_call 541} sdv_SetPowerIrpMinorFunction(pirp_12);
    call {:si_unique_call 542} status_2 := KeyboardClassPower(po, pirp_12);
  ...
  anon65_Then:
    assume {:nonnull} ps != 0;
    assume ps > 0;
    call {:si_unique_call 543} status_2 := KeyboardClassCleanup(po, pirp_12);
    goto L72;
  ...
  anon68_Then:
    assume {:nonnull} ps != 0;
    assume ps > 0;
    call {:si_unique_call 546} status_2 := KeyboardClassPassThrough(po, pirp_12);
  ...
  anon69_Then:
    assume {:nonnull} ps != 0;
    assume ps > 0;
    call {:si_unique_call 547} status_2 := KeyboardClassDeviceControl(po, pirp_12);
  ...
  anon70_Then:
    call {:si_unique_call 548} status_2 := sdv_DoNothing();
    goto L72;

  anon71_Then:
    assume {:nonnull} ps != 0;
    assume ps > 0;
    call {:si_unique_call 549} status_2 := KeyboardClassFlush(po, pirp_12);
    goto L72;
  ...
  anon75_Then:
    assume {:nonnull} ps != 0;
    assume ps > 0;
    call {:si_unique_call 553} status_2 := KeyboardClassRead(po, pirp_12);
    goto L72;

  anon76_Then:
    assume {:nonnull} ps != 0;
    assume ps > 0;
    call {:si_unique_call 554} status_2 := KeyboardClassClose(po, pirp_12);
  ...
  anon57_Then:
    assume {:nonnull} ps != 0;
    assume ps > 0;
    call {:si_unique_call 555} status_2 := KeyboardClassCreate(po, pirp_12);
...
implementation {:origName "RtlFreeUnicodeString"} {:osmodel} RtlFreeUnicodeString(actual_UnicodeString: int)
{
  ...
  anon0:
    call {:si_unique_call 556} vslice_dummy_var_26 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "sdv_KeReleaseSpinLock"} {:osmodel} sdv_KeReleaseSpinLock(actual_SpinLock_1: int, actual_new: int)
{
  ...
  anon0:
    call {:si_unique_call 557} vslice_dummy_var_27 := __HAVOC_malloc(4);
    new := actual_new;
    return;
}
...
implementation {:origName "sdv_IoCompleteRequest"} {:osmodel} sdv_IoCompleteRequest(actual_pirp_13: int, actual_PriorityBoost: int)
{
  ...
  anon0:
    call {:si_unique_call 558} vslice_dummy_var_28 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "sdv_RtlCopyMemory"} {:osmodel} sdv_RtlCopyMemory(actual_Destination_2: int, actual_Source_1: int, actual_Length_2: int)
{
  ...
  anon0:
    call {:si_unique_call 559} vslice_dummy_var_29 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "sdv_stub_WmiIrpForward"} {:osmodel} sdv_stub_WmiIrpForward(actual_pirp_14: int)
{
  ...
  anon0:
    call {:si_unique_call 560} vslice_dummy_var_30 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "sdv_ExFreePool"} {:osmodel} sdv_ExFreePool(actual_P: int)
{
  ...
  anon0:
    call {:si_unique_call 561} vslice_dummy_var_31 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "sdv_stub_WmiIrpProcessed"} {:osmodel} sdv_stub_WmiIrpProcessed(actual_pirp_15: int)
{
  ...
  anon0:
    call {:si_unique_call 562} vslice_dummy_var_32 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "IoAllocateIrp"} {:osmodel} IoAllocateIrp(actual_StackSize: int, actual_ChargeQuota: int) returns (Tmp_127: int)
{
  ...
  L1:
    call {:si_unique_call 565} SLIC_IoAllocateIrp_exit(0, Tmp_127);
    return;
...
implementation {:origName "ExAllocatePoolWithTag"} {:osmodel} ExAllocatePoolWithTag(actual_PoolType: int, actual_NumberOfBytes: int, actual_Tag_2: int) returns (Tmp_139: int)
{
  ...
  anon3_Else:
    call {:si_unique_call 568} sdv_66 := __HAVOC_malloc(NumberOfBytes);
    Tmp_139 := sdv_66;
    goto L1;
...
implementation {:origName "IoAllocateWorkItem"} {:osmodel} IoAllocateWorkItem(actual_DeviceObject_11: int) returns (Tmp_141: int)
{
  ...
  anon0:
    call {:si_unique_call 569} sdv_68 := __HAVOC_malloc(1);
    ioWorkItem := sdv_68;
    goto anon6_Then, anon6_Else;
...
implementation {:origName "sdv_stub_driver_init"} {:osmodel} sdv_stub_driver_init()
{
  ...
  anon0:
    call {:si_unique_call 570} vslice_dummy_var_36 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "sdv_IoReleaseRemoveLock"} sdv_IoReleaseRemoveLock(actual_sdv_73: int, actual_sdv_74: int) returns (Tmp_160: int)
{
  ...
  anon0:
    call {:si_unique_call 572} Tmp_160 := __HAVOC_malloc(4);
    call {:si_unique_call 573} sdv_75 := __HAVOC_malloc(4);
...
implementation {:origName "sdv_InsertTailList"} sdv_InsertTailList(actual_sdv_78: int, actual_sdv_79: int) returns (Tmp_164: int)
{
  ...
  anon0:
    call {:si_unique_call 574} Tmp_164 := __HAVOC_malloc(4);
    call {:si_unique_call 575} sdv_80 := __HAVOC_malloc(4);
...
procedure {:origName "SLIC_sdv_RunIoCompletionRoutines_entry"} {:osmodel} SLIC_sdv_RunIoCompletionRoutines_entry(actual_caller: int, actual_sdv_81: int);
...
implementation {:origName "SLIC_sdv_RunIoCompletionRoutines_entry"} {:osmodel} SLIC_sdv_RunIoCompletionRoutines_entry(actual_caller: int, actual_sdv_81: int)
{
  var {:pointer} sdv_81: int;

  anon0:
    sdv_81 := actual_sdv_81;
    assume {:nonnull} sdv_81 != 0;
    assume sdv_81 > 0;
    goto anon5_Then, anon5_Else;
  ...
  anon6_Else:
    assume {:partition} sdv_81 == sdv_other_irp;
    completion_state := 1;
    goto L2;
...
procedure {:origName "SLIC_sdv_IoSetCompletionRoutine_entry"} {:osmodel} SLIC_sdv_IoSetCompletionRoutine_entry(actual_caller_1: int, actual_sdv_82: int);
...
implementation {:origName "SLIC_sdv_IoSetCompletionRoutine_entry"} {:osmodel} SLIC_sdv_IoSetCompletionRoutine_entry(actual_caller_1: int, actual_sdv_82: int)
{
  ...
  anon6_Else:
    assume {:partition} sdv_82 != sdv_other_irp;
    goto L4;
...
procedure {:origName "SLIC_sdv_RunIoCompletionRoutines_exit"} {:osmodel} SLIC_sdv_RunIoCompletionRoutines_exit(actual_caller_3: int, actual_sdv_83: int, actual_sdv_84: int);
  modifies yogi_error;
...
implementation {:origName "SLIC_sdv_RunIoCompletionRoutines_exit"} {:osmodel} SLIC_sdv_RunIoCompletionRoutines_exit(actual_caller_3: int, actual_sdv_83: int, actual_sdv_84: int)
{
  ...
  anon13_Else:
    assume {:partition} sdv_83 != sdv_other_irp;
    goto L9;
  ...
  anon13_Then:
    assume {:partition} sdv_83 == sdv_other_irp;
    call {:si_unique_call 577} SLIC_ABORT_8_0(caller_3, sdv_83, sdv_84);
    goto anon15_Then, anon15_Else;
...
procedure {:origName "SLIC_ABORT_8_0"} SLIC_ABORT_8_0(actual_caller_5: int, actual_sdv_85: int, actual_sdv_86: int);
  modifies yogi_error;
  free ensures {:va_keep} old(SignalState) == 2 ==> yogi_error == 1;
  free ensures {:va_keep} old(SignalState) == 0 ==> yogi_error == 1;
  free ensures {:va_keep} old(completion_state) == 1 ==> yogi_error == 1;
...
implementation {:origName "SLIC_ABORT_8_0"} SLIC_ABORT_8_0(actual_caller_5: int, actual_sdv_85: int, actual_sdv_86: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 579} SLIC_ERROR_ROUTINE(strConst__li2bpl2);
    return;
}
...
implementation {:origName "SLIC_KeSetEvent_entry"} {:osmodel} SLIC_KeSetEvent_entry(actual_caller_7: int)
{
  ...
  anon3_Else:
    assume {:partition} completion_state == 1;
    call {:si_unique_call 581} SLIC_EXIT_ROUTINE(strConst__li2bpl1);
    goto L2;
...
implementation {:origName "KeyboardClassClose"} KeyboardClassClose(actual_DeviceObject_14: int, actual_Irp_7: int) returns (Tmp_166: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 583} irpSp_2 := sdv_IoGetCurrentIrpStackLocation(Irp_7);
    assume {:nonnull} deviceExtension != 0;
    assume deviceExtension > 0;
    goto anon33_Then, anon33_Else;

  anon33_Else:
    call {:si_unique_call 584} Tmp_170 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_170 != 0;
    assume Tmp_170 > 0;
    call {:si_unique_call 585} sdv_KeAcquireSpinLock(0, Tmp_170);
    assume {:nonnull} Tmp_170 != 0;
    assume Tmp_170 > 0;
    havoc oldIrql;
  ...
  L30:
    call {:si_unique_call 586} sdv_KeReleaseSpinLock(0, oldIrql);
    goto L23;

  L23:
    call {:si_unique_call 587} ExAcquireFastMutex(0);
  ...
  L39:
    call {:si_unique_call 588} i, someEnableDisableSucceeded, Tmp_167, notifyHandle, port, Tmp_168, enabled, status_4, vslice_dummy_var_38 := KeyboardClassClose_loop_L39(i, someEnableDisableSucceeded, Tmp_167, notifyHandle, port, Tmp_168, enabled, status_4, DeviceObject_14, Irp_7, vslice_dummy_var_38);
    goto L39_last;
  ...
  anon47_Then:
    ...
    assume {:nonnull} port != 0;
    assume port > 0;
    call {:si_unique_call 589} ExReleaseFastMutex(0);
  ...
  anon37_Else:
    ...
    assume Tmp_168 > 0;
    call {:si_unique_call 590} notifyHandle := _InlineInterlockedExchangePointer(TargetNotifyHandle__DEVICE_EXTENSION(Tmp_168), 0);
    goto anon39_Then, anon39_Else;

  anon39_Else:
    assume {:partition} notifyHandle != 0;
    call {:si_unique_call 591} vslice_dummy_var_38 := IoUnregisterPlugPlayNotification(0);
    goto L59;
  ...
  L59:
    ...
    call {:si_unique_call 592} status_4 := KbdEnableDisablePort(0, Irp_7, vslice_dummy_var_1, File__PORT(port));
  ...
  anon38_Then:
    ...
    call {:si_unique_call 594} KeyboardClassLogError(DeviceObject_14, -1073414134, 10120, status_4, 0, 0, 0);
    goto L70;
  ...
  anon41_Else:
    assume {:nonnull} irpSp_2 != 0;
    assume irpSp_2 > 0;
    call {:si_unique_call 598} status_4 := KbdEnableDisablePort(0, Irp_7, deviceExtension, FileObject__IO_STACK_LOCATION(irpSp_2));
  ...
  anon42_Then:
    ...
    call {:si_unique_call 599} KeyboardClassLogError(DeviceObject_14, -1073414134, 10120, status_4, 0, 0, vslice_dummy_var_2);
    goto L73;
  ...
  anon41_Then:
    call {:si_unique_call 600} sdv_IoSkipCurrentIrpStackLocation(Irp_7);
    assume {:nonnull} deviceExtension != 0;
    assume deviceExtension > 0;
    havoc vslice_dummy_var_3;
    call {:si_unique_call 601} status_4 := sdv_IoCallDriver#1(vslice_dummy_var_3, Irp_7);
...
implementation {:origName "_sdv_init1"} _sdv_init1()
{
  ...
  anon0:
    call {:si_unique_call 603} vslice_dummy_var_39 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "KeyboardClassDequeueReadByFileObject"} KeyboardClassDequeueReadByFileObject(actual_DeviceExtension: int, actual_FileObject_1: int) returns (Tmp_174: int)
{
  ...
  L14:
    call {:si_unique_call 604} oldCancelRoutine, sdv_94, irp, entry, stack, vslice_dummy_var_40 := KeyboardClassDequeueReadByFileObject_loop_L14(oldCancelRoutine, sdv_94, irp, entry, stack, FileObject_1, vslice_dummy_var_40);
    goto L14_last;
  ...
  anon9_Else:
    call {:si_unique_call 605} sdv_94 := sdv_containing_record(entry, 88);
    irp := sdv_94;
    call {:si_unique_call 606} stack := sdv_IoGetCurrentIrpStackLocation(irp);
    assume {:nonnull} stack != 0;
    assume stack > 0;
    goto anon10_Then, anon10_Else;

  anon10_Else:
    call {:si_unique_call 607} vslice_dummy_var_40 := sdv_RemoveEntryList(0);
    call {:si_unique_call 608} oldCancelRoutine := sdv_IoSetCancelRoutine(irp, 0);
    goto anon11_Then, anon11_Else;
  ...
  anon11_Then:
    ...
    assume irp > 0;
    call {:si_unique_call 609} InitializeListHead(ListEntry_unnamed_tag_6(Overlay_unnamed_tag_5(Tail__IRP(irp))));
    goto L25;
  ...
  anon12_Then:
    assume {:partition} FileObject_1 == 0;
    call {:si_unique_call 610} Tmp_174 := KeyboardClassDequeueRead(DeviceExtension);
    goto L1;
}
...
implementation {:origName "RemoveHeadList"} RemoveHeadList(actual_ListHead_1: int) returns (Tmp_176: int)
{
  ...
  L9:
    call {:si_unique_call 611} FatalListEntryError(ListHead_1, Entry_1, NextEntry);
    goto L12;
...
implementation {:origName "KeyboardClassHandleRead"} KeyboardClassHandleRead(actual_DeviceExtension_1: int, actual_Irp_8: int) returns (Tmp_178: int)
{
  ...
  anon0:
    ...
    status_5 := 259;
    completeIrp := 0;
    call {:si_unique_call 612} Tmp_179 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_179 != 0;
    assume Tmp_179 > 0;
    call {:si_unique_call 613} sdv_KeAcquireSpinLock(0, Tmp_179);
    assume {:nonnull} Tmp_179 != 0;
    assume Tmp_179 > 0;
    havoc irql_1;
  ...
  anon11_Else:
    call {:si_unique_call 614} status_5 := KeyboardClassReadCopyData(DeviceExtension_1, Irp_8);
  ...
  L22:
    call {:si_unique_call 615} sdv_KeReleaseSpinLock(0, irql_1);
    goto anon12_Then, anon12_Else;
  ...
  anon12_Else:
    ...
    assume {:nonnull} DeviceExtension_1 != 0;
    assume DeviceExtension_1 > 0;
    call {:si_unique_call 616} vslice_dummy_var_42 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(DeviceExtension_1), Irp_8);
  ...
  anon11_Then:
    ...
    assume {:nonnull} Irp_8 != 0;
    assume Irp_8 > 0;
    call {:si_unique_call 618} vslice_dummy_var_41 := sdv_InsertTailList(ReadQueue__DEVICE_EXTENSION(DeviceExtension_1), ListEntry_unnamed_tag_6(Overlay_unnamed_tag_5(Tail__IRP(Irp_8))));
    call {:si_unique_call 619} sdv_IoMarkIrpPending(0);
    call {:si_unique_call 620} oldCancelRoutine_1 := sdv_IoSetCancelRoutine(Irp_8, li2bplFunctionConstant641);
    assume {:nonnull} Irp_8 != 0;
    assume Irp_8 > 0;
    goto anon13_Then, anon13_Else;

  anon13_Else:
    call {:si_unique_call 621} oldCancelRoutine_1 := sdv_IoSetCancelRoutine(Irp_8, 0);
    goto anon15_Then, anon15_Else;

  anon15_Else:
    assume {:partition} oldCancelRoutine_1 != 0;
    call {:si_unique_call 622} vslice_dummy_var_43 := sdv_RemoveEntryList(0);
    assume {:nonnull} Irp_8 != 0;
    assume Irp_8 > 0;
    assume {:nonnull} Irp_8 != 0;
    assume Irp_8 > 0;
...
implementation {:origName "KeyboardClassCreate"} KeyboardClassCreate(actual_DeviceObject_15: int, actual_Irp_9: int) returns (Tmp_180: int)
{
  ...
  anon0:
    call {:si_unique_call 623} vslice_dummy_var_44 := __HAVOC_malloc(8);
    ...
    call {:si_unique_call 625} irpSp_3 := sdv_IoGetCurrentIrpStackLocation(Irp_9);
  ...
  L21:
    call {:si_unique_call 627} status_6 := sdv_IoAcquireRemoveLock(0, 0);
    goto anon42_Then, anon42_Else;
  ...
  anon45_Else:
    ...
    assume {:nonnull} deviceExtension_1 != 0;
    assume deviceExtension_1 > 0;
    call {:si_unique_call 628} vslice_dummy_var_47 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(deviceExtension_1), Irp_9);
    goto L27;
  ...
  anon44_Else:
    call {:si_unique_call 629} structPtr888priv := RtlConvertLongToLuid(7);
    ...
    call {:si_unique_call 630} sdv_106 := SeSinglePrivilegeCheck(priv, vslice_dummy_var_4);
    goto anon46_Then, anon46_Else;

  anon46_Else:
    assume {:partition} sdv_106 != 0;
    call {:si_unique_call 631} Tmp_184 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_184 != 0;
    assume Tmp_184 > 0;
    call {:si_unique_call 632} sdv_KeAcquireSpinLock(0, Tmp_184);
    assume {:nonnull} Tmp_184 != 0;
    assume Tmp_184 > 0;
    havoc oldIrql_1;
    assume {:nonnull} irpSp_3 != 0;
    ...
    assume {:nonnull} deviceExtension_1 != 0;
    assume deviceExtension_1 > 0;
    call {:si_unique_call 633} sdv_KeReleaseSpinLock(0, oldIrql_1);
    goto L44;

  L44:
    call {:si_unique_call 634} ExAcquireFastMutex(0);
    goto anon47_Then, anon47_Else;
  ...
  L67:
    call {:si_unique_call 635} i_1, someEnableDisableSucceeded_1, port_1, Tmp_181, enabled_1, status_6 := KeyboardClassCreate_loop_L67(i_1, someEnableDisableSucceeded_1, irpSp_3, port_1, Tmp_181, enabled_1, status_6, DeviceObject_15, Irp_9);
    goto L67_last;
  ...
  anon51_Then:
    ...
    call {:si_unique_call 638} KeyboardClassLogError(DeviceObject_15, -1073414135, 10120, status_6, 0, 0, vslice_dummy_var_5);
    assume {:nonnull} port_1 != 0;
    assume port_1 > 0;
    goto L89;
  ...
  anon50_Then:
    ...
    call {:si_unique_call 639} status_6 := KbdEnableDisablePort(1, Irp_9, vslice_dummy_var_6, File__PORT(port_1));
    goto anon58_Then, anon58_Else;
  ...
  anon49_Then:
    call {:si_unique_call 640} ExReleaseFastMutex(0);
    goto L94;
  ...
  L95:
    assume {:nonnull} deviceExtension_1 != 0;
    assume deviceExtension_1 > 0;
    call {:si_unique_call 641} vslice_dummy_var_45 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(deviceExtension_1), Irp_9);
    goto L27;
  ...
  anon53_Else:
    assume {:nonnull} irpSp_3 != 0;
    assume irpSp_3 > 0;
    call {:si_unique_call 643} status_6 := KbdEnableDisablePort(1, Irp_9, deviceExtension_1, FileObject__IO_STACK_LOCATION(irpSp_3));
    goto anon59_Then, anon59_Else;
  ...
  anon53_Then:
    call {:si_unique_call 644} sdv_IoSkipCurrentIrpStackLocation(Irp_9);
    assume {:nonnull} deviceExtension_1 != 0;
    assume deviceExtension_1 > 0;
    havoc vslice_dummy_var_7;
    call {:si_unique_call 645} status_6 := sdv_IoCallDriver#1(vslice_dummy_var_7, Irp_9);
    goto anon60_Then, anon60_Else;
  ...
  anon60_Else:
    ...
    assume {:nonnull} deviceExtension_1 != 0;
    assume deviceExtension_1 > 0;
    call {:si_unique_call 646} vslice_dummy_var_46 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(deviceExtension_1), Irp_9);
    Tmp_180 := status_6;
    goto L1;
...
procedure {:origName "KeyboardClassSetLedsComplete"} KeyboardClassSetLedsComplete(actual_DeviceObject_17: int, actual_Irp_12: int, actual_Context_8: int) returns (Tmp_200: int);
  modifies alloc;
  free ensures {:va_keep} Tmp_200 == -1073741802 || Tmp_200 == -1073741823;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} false || old(SignalState) == 2 || old(SignalState) == 0;
  free ensures {:va_keep} false || old(completion_state) == 1 || old(completion_state) == 0;
  free ensures {:va_keep} false || old(signal_location) == 1 || old(signal_location) == 0;
...
implementation {:origName "KeyboardClassSetLedsComplete"} KeyboardClassSetLedsComplete(actual_DeviceObject_17: int, actual_Irp_12: int, actual_Context_8: int) returns (Tmp_200: int)
{
  ...
  anon3_Else:
    ...
    assume data_1 > 0;
    call {:si_unique_call 648} vslice_dummy_var_48 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(data_1), Irp_12);
    call {:si_unique_call 649} IoFreeIrp(0);
    Tmp_200 := -1073741802;
    goto L1;
...
implementation {:origName "KeyboardClassCleanupQueue"} KeyboardClassCleanupQueue(actual_DeviceObject_18: int, actual_DeviceExtension_2: int, actual_FileObject_2: int)
{
  ...
  anon0:
    call {:si_unique_call 650} listHead := __HAVOC_malloc(8);
    call {:si_unique_call 651} vslice_dummy_var_49 := __HAVOC_malloc(4);
    DeviceExtension_2 := actual_DeviceExtension_2;
    FileObject_2 := actual_FileObject_2;
    call {:si_unique_call 652} InitializeListHead(listHead);
    call {:si_unique_call 653} Tmp_204 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_204 != 0;
    assume Tmp_204 > 0;
    call {:si_unique_call 654} sdv_KeAcquireSpinLock(0, Tmp_204);
    assume {:nonnull} Tmp_204 != 0;
    assume Tmp_204 > 0;
    havoc irql_2;
    goto L13;
  ...
  L13:
    call {:si_unique_call 655} irp_1, vslice_dummy_var_51 := KeyboardClassCleanupQueue_loop_L13(listHead, irp_1, DeviceExtension_2, FileObject_2, vslice_dummy_var_51);
    goto L13_last;

  L13_last:
    call {:si_unique_call 664} irp_1 := KeyboardClassDequeueReadByFileObject(DeviceExtension_2, FileObject_2);
    goto anon7_Then, anon7_Else;
  ...
  anon7_Else:
    ...
    assume {:nonnull} irp_1 != 0;
    assume irp_1 > 0;
    call {:si_unique_call 656} vslice_dummy_var_51 := sdv_InsertTailList(listHead, ListEntry_unnamed_tag_6(Overlay_unnamed_tag_5(Tail__IRP(irp_1))));
    goto L18;
  ...
  anon8_Else:
    assume {:partition} irp_1 == 0;
    call {:si_unique_call 657} sdv_KeReleaseSpinLock(0, irql_2);
    goto L27;

  L27:
    call {:si_unique_call 658} sdv_120, sdv_122, irp_1, entry_1, vslice_dummy_var_50 := KeyboardClassCleanupQueue_loop_L27(listHead, sdv_120, sdv_122, irp_1, entry_1, DeviceExtension_2, vslice_dummy_var_50);
    goto L27_last;

  L27_last:
    call {:si_unique_call 663} sdv_120 := sdv_IsListEmpty(0);
    goto anon9_Then, anon9_Else;

  anon9_Else:
    assume {:partition} sdv_120 == 0;
    call {:si_unique_call 659} entry_1 := RemoveHeadList(listHead);
    call {:si_unique_call 660} sdv_122 := sdv_containing_record(entry_1, 88);
    irp_1 := sdv_122;
    call {:si_unique_call 661} sdv_IoCompleteRequest(0, 0);
    assume {:nonnull} DeviceExtension_2 != 0;
    assume DeviceExtension_2 > 0;
    call {:si_unique_call 662} vslice_dummy_var_50 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(DeviceExtension_2), irp_1);
...
implementation {:origName "KeyboardClassFlush"} KeyboardClassFlush(actual_DeviceObject_19: int, actual_Irp_13: int) returns (Tmp_206: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 665} irpSp_4 := sdv_IoGetCurrentIrpStackLocation(Irp_13);
    assume {:nonnull} deviceExtension_2 != 0;
    assume deviceExtension_2 > 0;
    goto anon7_Then, anon7_Else;
  ...
  anon8_Else:
    ...
    call {:si_unique_call 666} KbdInitializeDataQueue(deviceExtension_2);
    goto L16;
...
implementation {:origName "KeyboardClassRemoveDevice"} KeyboardClassRemoveDevice(actual_Data_1: int)
{
  ...
  anon0:
    ...
    assume {:nonnull} Data_1 != 0;
    assume Data_1 > 0;
    call {:si_unique_call 669} sdv_124 := _InlineInterlockedExchangePointer(WaitWakeIrp__DEVICE_EXTENSION(Data_1), 0);
    waitWakeIrp := sdv_124;
    goto anon24_Then, anon24_Else;

  anon24_Else:
    assume {:partition} waitWakeIrp != 0;
    call {:si_unique_call 670} vslice_dummy_var_54 := IoCancelIrp(0);
    goto L13;

  L13:
    call {:si_unique_call 671} vslice_dummy_var_53 := IoWMIRegistrationControl(0, 2);
    assume {:nonnull} Data_1 != 0;
    assume Data_1 > 0;
  ...
  anon20_Else:
    ...
    assume {:nonnull} Data_1 != 0;
    assume Data_1 > 0;
    call {:si_unique_call 674} notifyHandle_1 := _InlineInterlockedExchangePointer(TargetNotifyHandle__DEVICE_EXTENSION(Data_1), 0);
    goto anon21_Then, anon21_Else;

  anon21_Else:
    assume {:partition} notifyHandle_1 != 0;
    call {:si_unique_call 675} vslice_dummy_var_55 := IoUnregisterPlugPlayNotification(0);
    goto L20;
  ...
  anon18_Else:
    ...
    call {:si_unique_call 676} KeyboardClassCleanupQueue(vslice_dummy_var_8, Data_1, 0);
    goto L1;
  ...
  anon23_Else:
    call {:si_unique_call 679} vslice_dummy_var_56 := IoSetDeviceInterfaceState(0, 0);
    goto L20;
...
implementation {:origName "RtlFailFast"} RtlFailFast(actual_Code: int)
{
  ...
  anon0:
    call {:si_unique_call 680} vslice_dummy_var_57 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "KbdSyncComplete"} KbdSyncComplete(actual_DeviceObject_20: int, actual_Irp_14: int, actual_Context_9: int) returns (Tmp_214: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 681} vslice_dummy_var_58 := KeSetEvent(Context_9, 0, 0);
    Tmp_214 := -1073741802;
    return;
}
...
implementation {:origName "KeyboardQueryDeviceKey"} KeyboardQueryDeviceKey(actual_Handle_1: int, actual_ValueNameString: int, actual_Data_2: int, actual_DataLength: int) returns (Tmp_216: int)
{
  ...
  anon0:
    call {:si_unique_call 682} valueName := __HAVOC_malloc(12);
    ValueNameString := actual_ValueNameString;
    DataLength := actual_DataLength;
    call {:si_unique_call 683} sdv_do_paged_code_check();
    call {:si_unique_call 684} RtlInitUnicodeString(valueName, ValueNameString);
    assume {:nonnull} valueName != 0;
    assume valueName > 0;
    havoc length;
    call {:si_unique_call 685} sdv_131 := ExAllocatePoolWithTag(1, length, -1016831413);
    fullInfo := sdv_131;
    goto anon6_Then, anon6_Else;

  anon6_Else:
    assume {:partition} fullInfo != 0;
    call {:si_unique_call 686} Tmp_218 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_218 != 0;
    assume Tmp_218 > 0;
    call {:si_unique_call 687} status_10 := ZwQueryValueKey(0, 0, 1, 0, length, Tmp_218);
    assume {:nonnull} Tmp_218 != 0;
    assume Tmp_218 > 0;
    havoc length;
    goto anon5_Then, anon5_Else;
  ...
  anon5_Else:
    ...
    call {:si_unique_call 688} sdv_RtlCopyMemory(0, 0, vslice_dummy_var_9);
    goto L25;
...
implementation {:origName "KeyboardSendIrpSynchronously"} KeyboardSendIrpSynchronously(actual_DeviceObject_22: int, actual_Irp_15: int, actual_CopyToNext: int) returns (Tmp_221: int)
{
  ...
  anon0:
    call {:si_unique_call 690} event := __HAVOC_malloc(156);
    ...
    call {:si_unique_call 692} SLIC_KeInitializeEvent_entry(0, 0);
    call {:si_unique_call 693} KeInitializeEvent(event, 1, 0);
    goto anon5_Then, anon5_Else;

  anon5_Else:
    assume {:partition} CopyToNext != 0;
    call {:si_unique_call 694} sdv_IoCopyCurrentIrpStackLocationToNext(Irp_15);
    goto L12;

  L12:
    call {:si_unique_call 695} sdv_IoSetCompletionRoutine(Irp_15, li2bplFunctionConstant644, event, 1, 1, 1);
    call {:si_unique_call 696} vslice_dummy_var_59 := sdv_IoCallDriver#1(DeviceObject_22, Irp_15);
    goto anon6_Then, anon6_Else;

  anon6_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 697} vslice_dummy_var_60 := KeWaitForSingleObject(0, 0, 0, 0, 0);
...
implementation {:origName "KeyboardClassLogError"} KeyboardClassLogError(actual_Object_2: int, actual_ErrorCode: int, actual_UniqueErrorValue: int, actual_FinalStatus: int, actual_DumpCount: int, actual_DumpData: int, actual_MajorFunction: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 699} Tmp_225 := __HAVOC_malloc(4);
    Tmp_224 := 48 + DumpCount * 4;
    call {:si_unique_call 700} sdv_139 := IoAllocateErrorLogEntry(0, Tmp_224);
    errorLogEntry := sdv_139;
    goto anon6_Then, anon6_Else;
  ...
  L20:
    call {:si_unique_call 701} i_2, Tmp_223, Tmp_225, Tmp_226 := KeyboardClassLogError_loop_L20(i_2, Tmp_223, errorLogEntry, Tmp_225, Tmp_226, DumpCount, DumpData);
    goto L20_last;
  ...
  anon5_Then:
    ...
    call {:si_unique_call 702} IoWriteErrorLogEntry(0);
    goto L1;
...
implementation {:origName "KeyboardClassRead"} KeyboardClassRead(actual_Device_1: int, actual_Irp_16: int) returns (Tmp_229: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 703} irpSp_5 := sdv_IoGetCurrentIrpStackLocation(Irp_16);
  ...
  anon17_Else:
    ...
    call {:si_unique_call 704} Tmp_229 := KeyboardClassHandleRead(deviceExtension_3, Irp_16);
    goto L1;
  ...
  anon18_Else:
    call {:si_unique_call 706} status_13 := sdv_IoAcquireRemoveLock(0, 0);
    goto anon15_Then, anon15_Else;
...
implementation {:origName "KeyboardClassPassThrough"} KeyboardClassPassThrough(actual_DeviceObject_23: int, actual_Irp_17: int) returns (Tmp_232: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 707} sdv_IoSkipCurrentIrpStackLocation(Irp_17);
    ...
    assume Tmp_235 > 0;
    havoc Tmp_233;
    call {:si_unique_call 708} Tmp_232 := sdv_IoCallDriver#1(Tmp_233, Irp_17);
    goto anon3_Then, anon3_Else;
...
implementation {:origName "KeyboardClassReadCopyData"} KeyboardClassReadCopyData(actual_DeviceExtension_3: int, actual_Irp_18: int) returns (Tmp_236: int)
{
  ...
  anon0:
    ...
    assume {:nonnull} DeviceExtension_3 != 0;
    assume DeviceExtension_3 > 0;
    call {:si_unique_call 709} irpSp_6 := sdv_IoGetCurrentIrpStackLocation(Irp_18);
    assume {:nonnull} DeviceExtension_3 != 0;
    assume DeviceExtension_3 > 0;
    havoc bytesInQueue;
  ...
  L23:
    ...
    assume {:nonnull} DeviceExtension_3 != 0;
    assume DeviceExtension_3 > 0;
    call {:si_unique_call 710} sdv_RtlMoveMemory(0, 0, moveSize);
    goto anon11_Then, anon11_Else;
  ...
  anon11_Else:
    ...
    assume {:nonnull} DeviceExtension_3 != 0;
    assume DeviceExtension_3 > 0;
    call {:si_unique_call 711} sdv_RtlMoveMemory(0, 0, moveSize);
    assume {:nonnull} DeviceExtension_3 != 0;
    assume DeviceExtension_3 > 0;
    goto L38;
...
implementation {:origName "KeyboardClassGetWaitWakeEnableState"} KeyboardClassGetWaitWakeEnableState(actual_Data_3: int)
{
  ...
  anon0:
    call {:si_unique_call 712} vslice_dummy_var_62 := __HAVOC_malloc(4);
    call {:si_unique_call 713} tmp := __HAVOC_malloc(4);
    Data_3 := actual_Data_3;
    call {:si_unique_call 714} Tmp_242 := __HAVOC_malloc(64);
    hKey := 0;
    call {:si_unique_call 715} status_14 := IoOpenDeviceRegistryKey(0, 1, 2031616, 0);
    goto anon7_Then, anon7_Else;

  anon7_Else:
    assume {:partition} status_14 >= 0;
    Tmp_242 := strConst__li2bpl3;
    call {:si_unique_call 716} status_14 := KeyboardQueryDeviceKey(hKey, Tmp_242, tmp, 4);
    goto anon8_Then, anon8_Else;
  ...
  L19:
    call {:si_unique_call 717} vslice_dummy_var_63 := ZwClose(0);
    hKey := 0;
    goto L1;
...
implementation {:origName "KeyboardClassPower"} KeyboardClassPower(actual_DeviceObject_24: int, actual_Irp_19: int) returns (Tmp_246: int)
{
  ...
  anon0:
    call {:si_unique_call 718} powerState_2 := __HAVOC_malloc(8);
    call {:si_unique_call 719} sdv_1 := __HAVOC_malloc(8);
    DeviceObject_24 := actual_DeviceObject_24;
    Irp_19 := actual_Irp_19;
    call {:si_unique_call 720} Tmp_247 := __HAVOC_malloc(20);
    hookit := 0;
    pendit := 0;
    ...
    havoc data_3;
    call {:si_unique_call 722} stack_2 := sdv_IoGetCurrentIrpStackLocation(Irp_19);
  ...
  anon65_Else:
    call {:si_unique_call 725} status_15 := sdv_IoAcquireRemoveLock(0, 0);
    goto anon66_Then, anon66_Else;
  ...
  anon73_Else:
    ...
    call {:si_unique_call 726} status_15 := sdv_IoAcquireRemoveLock(0, 0);
    call {:si_unique_call 727} sdv_IoCopyCurrentIrpStackLocationToNext(Irp_19);
    call {:si_unique_call 728} sdv_IoSetCompletionRoutine(Irp_19, li2bplFunctionConstant673, 0, 1, 1, 1);
    call {:si_unique_call 729} sdv_IoMarkIrpPending(0);
    call {:si_unique_call 730} vslice_dummy_var_64 := PoCallDriver#1(0, Irp_19);
  ...
  L80:
    assume {:nonnull} data_3 != 0;
    assume data_3 > 0;
    call {:si_unique_call 731} vslice_dummy_var_65 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(data_3), Irp_19);
    Tmp_246 := status_15;
    goto L1;
  ...
  anon74_Then:
    assume {:partition} pendit == 0;
    call {:si_unique_call 732} PoStartNextPowerIrp(0);
    call {:si_unique_call 733} sdv_IoSkipCurrentIrpStackLocation(Irp_19);
    call {:si_unique_call 734} status_15 := PoCallDriver#1(0, Irp_19);
  ...
  anon70_Else:
    assume {:nonnull} data_3 != 0;
    assume data_3 > 0;
    call {:si_unique_call 737} sdv_156 := _InlineInterlockedCompareExchangePointer(WaitWakeIrp__DEVICE_EXTENSION(data_3), 0, 0);
    goto anon71_Then, anon71_Else;
  ...
  anon96_Else:
    call {:si_unique_call 738} SD1_2 := PoSetPowerState(0, powerType_1, powerState_2);
  ...
  anon75_Else:
    call {:si_unique_call 739} status_15 := sdv_IoAcquireRemoveLock(0, 0);
    goto anon78_Then, anon78_Else;
  ...
  anon78_Else:
    ...
    assume {:nonnull} data_3 != 0;
    assume data_3 > 0;
    call {:si_unique_call 740} sdv_161 := _InlineInterlockedCompareExchangePointer(WaitWakeIrp__DEVICE_EXTENSION(data_3), 0, 0);
    goto anon79_Then, anon79_Else;
  ...
  L127:
    call {:si_unique_call 741} sdv_IoMarkIrpPending(0);
    assume {:nonnull} data_3 != 0;
    assume data_3 > 0;
    havoc vslice_dummy_var_10;
    call {:si_unique_call 742} status_15 := PoRequestPowerIrp#1(vslice_dummy_var_10, 2, powerState_2, li2bplFunctionConstant674, Irp_19, 0);
  ...
  anon81_Then:
    ...
    assume {:nonnull} data_3 != 0;
    assume data_3 > 0;
    call {:si_unique_call 743} vslice_dummy_var_66 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(data_3), Irp_19);
    call {:si_unique_call 744} PoStartNextPowerIrp(0);
    assume {:nonnull} Irp_19 != 0;
    assume Irp_19 > 0;
    call {:si_unique_call 745} sdv_IoCompleteRequest(0, 0);
    assume {:nonnull} data_3 != 0;
    assume data_3 > 0;
    call {:si_unique_call 746} vslice_dummy_var_67 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(data_3), Irp_19);
    Tmp_246 := 259;
    goto L1;
  ...
  anon84_Else:
    assume {:nonnull} data_3 != 0;
    assume data_3 > 0;
    call {:si_unique_call 747} sdv_148 := _InlineInterlockedCompareExchangePointer(WaitWakeIrp__DEVICE_EXTENSION(data_3), 0, 0);
    goto anon85_Then, anon85_Else;

  anon85_Else:
    assume {:partition} sdv_148 == 0;
    call {:si_unique_call 748} sdv_149 := KeyboardClassCheckWaitWakeEnabled(data_3);
    goto anon86_Then, anon86_Else;

  anon86_Else:
    assume {:partition} sdv_149 != 0;
    call {:si_unique_call 749} vslice_dummy_var_68 := KeyboardClassCreateWaitWakeIrp#1(data_3);
  ...
  anon67_Then:
    assume {:nonnull} data_3 != 0;
    assume data_3 > 0;
    call {:si_unique_call 750} sdv_155 := _InlineInterlockedCompareExchangePointer(WaitWakeIrp__DEVICE_EXTENSION(data_3), Irp_19, 0);
  ...
  anon87_Else:
    ...
    assume {:nonnull} data_3 != 0;
    assume data_3 > 0;
    call {:si_unique_call 751} vslice_dummy_var_69 := _InlineInterlockedExchangePointer(ExtraWaitWakeIrp__DEVICE_EXTENSION(data_3), Irp_19);
  ...
  anon66_Then:
    assume {:partition} 0 > status_15;
    call {:si_unique_call 752} PoStartNextPowerIrp(0);
    assume {:nonnull} Irp_19 != 0;
    assume Irp_19 > 0;
  ...
  anon65_Then:
    call {:si_unique_call 754} PoStartNextPowerIrp(0);
    assume {:nonnull} Irp_19 != 0;
    assume Irp_19 > 0;
    call {:si_unique_call 755} sdv_IoCompleteRequest(0, 0);
    Tmp_246 := -1073741637;
    goto L1;
}
...
implementation {:origName "KeyboardClassDequeueRead"} KeyboardClassDequeueRead(actual_DeviceExtension_4: int) returns (Tmp_254: int)
{
  ...
  L6:
    call {:si_unique_call 757} sdv_166, listEntry, oldCancelRoutine_2, sdv_168, nextIrp := KeyboardClassDequeueRead_loop_L6(sdv_166, listEntry, oldCancelRoutine_2, sdv_168, nextIrp, DeviceExtension_4);
    goto L6_last;
  ...
  anon7_Then:
    assume {:partition} nextIrp == 0;
    call {:si_unique_call 758} sdv_166 := sdv_IsListEmpty(0);
    goto anon8_Then, anon8_Else;
  ...
  anon8_Else:
    ...
    call {:si_unique_call 759} listEntry := RemoveHeadList(ReadQueue__DEVICE_EXTENSION(DeviceExtension_4));
    call {:si_unique_call 760} sdv_168 := sdv_containing_record(listEntry, 88);
    nextIrp := sdv_168;
    call {:si_unique_call 761} oldCancelRoutine_2 := sdv_IoSetCancelRoutine(nextIrp, 0);
    goto anon9_Then, anon9_Else;
  ...
  anon9_Else:
    ...
    assume nextIrp > 0;
    call {:si_unique_call 762} InitializeListHead(ListEntry_unnamed_tag_6(Overlay_unnamed_tag_5(Tail__IRP(nextIrp))));
    nextIrp := 0;
    goto anon9_Else_dummy;
...
implementation {:origName "FatalListEntryError"} FatalListEntryError(actual_p1: int, actual_p2: int, actual_p3: int)
{
  ...
  anon0:
    call {:si_unique_call 763} vslice_dummy_var_71 := __HAVOC_malloc(4);
    call {:si_unique_call 764} RtlFailFast(3);
    return;
}
...
implementation {:origName "KeyboardClassSystemControl"} KeyboardClassSystemControl(actual_DeviceObject_26: int, actual_Irp_20: int) returns (Tmp_263: int)
{
  ...
  anon0:
    call {:si_unique_call 765} disposition := __HAVOC_malloc(4);
    ...
    call {:si_unique_call 766} status_18 := sdv_IoAcquireRemoveLock(0, 0);
    goto anon15_Then, anon15_Else;

  anon15_Else:
    assume {:partition} status_18 >= 0;
    call {:si_unique_call 767} status_18 := WmiSystemControl(0, 0, Irp_20, disposition);
  ...
  L25:
    call {:si_unique_call 768} status_18 := KeyboardClassPassThrough(DeviceObject_26, Irp_20);
    goto anon20_Then, anon20_Else;
  ...
  L30:
    assume {:nonnull} deviceExtension_4 != 0;
    assume deviceExtension_4 > 0;
    call {:si_unique_call 769} vslice_dummy_var_72 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(deviceExtension_4), Irp_20);
    Tmp_263 := status_18;
    goto L1;
  ...
  anon17_Then:
    call {:si_unique_call 770} status_18 := KeyboardClassPassThrough(DeviceObject_26, Irp_20);
    goto anon21_Then, anon21_Else;
...
implementation {:origName "RtlConvertLongToLuid"} RtlConvertLongToLuid(actual_Long: int) returns (structPtr888Tmp: int)
{
  ...
  anon0:
    call {:si_unique_call 773} Tmp := __HAVOC_malloc(8);
    call {:si_unique_call 774} TempLi := __HAVOC_malloc(20);
    call {:si_unique_call 775} TempLuid := __HAVOC_malloc(8);
    Long := actual_Long;
...
implementation {:origName "KeyboardPnP"} KeyboardPnP(actual_DeviceObject_27: int, actual_Irp_21: int) returns (Tmp_268: int)
{
  ...
  anon0:
    call {:si_unique_call 776} devCaps := __HAVOC_malloc(124);
    DeviceObject_27 := actual_DeviceObject_27;
    Irp_21 := actual_Irp_21;
    assume {:nonnull} DeviceObject_27 != 0;
    assume DeviceObject_27 > 0;
    havoc data_5;
    call {:si_unique_call 777} stack_3 := sdv_IoGetCurrentIrpStackLocation(Irp_21);
    assume {:nonnull} data_5 != 0;
    assume data_5 > 0;
    goto anon109_Then, anon109_Else;

  anon109_Else:
    call {:si_unique_call 778} status_20 := sdv_IoAcquireRemoveLock(0, 0);
  ...
  anon161_Else:
    call {:si_unique_call 779} vslice_dummy_var_73 := IoSetDeviceInterfaceState(0, 0);
    goto L45;

  L45:
    call {:si_unique_call 780} sdv_IoSkipCurrentIrpStackLocation(Irp_21);
    assume {:nonnull} data_5 != 0;
    assume data_5 > 0;
    havoc vslice_dummy_var_11;
    call {:si_unique_call 781} status_20 := sdv_IoCallDriver#1(vslice_dummy_var_11, Irp_21);
  ...
  L56:
    assume {:nonnull} data_5 != 0;
    assume data_5 > 0;
    call {:si_unique_call 782} vslice_dummy_var_74 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(data_5), Irp_21);
    Tmp_268 := status_20;
    goto L1;
  ...
  L32:
    call {:si_unique_call 783} sdv_IoCopyCurrentIrpStackLocationToNext(Irp_21);
    assume {:nonnull} data_5 != 0;
    assume data_5 > 0;
    havoc vslice_dummy_var_12;
    call {:si_unique_call 784} status_20 := sdv_IoCallDriver#1(vslice_dummy_var_12, Irp_21);
  ...
  anon115_Else:
    ...
    assume {:nonnull} data_5 != 0;
    assume data_5 > 0;
    call {:si_unique_call 787} notifyHandle_2 := _InlineInterlockedExchangePointer(TargetNotifyHandle__DEVICE_EXTENSION(data_5), 0);
    goto anon116_Then, anon116_Else;

  anon116_Else:
    assume {:partition} notifyHandle_2 != 0;
    call {:si_unique_call 788} vslice_dummy_var_75 := IoUnregisterPlugPlayNotification(0);
    goto L87;

  L87:
    call {:si_unique_call 789} status_20 := KbdEnableDisablePort(0, Irp_21, data_5, file_2);
  ...
  L62:
    assume {:nonnull} data_5 != 0;
    assume data_5 > 0;
    call {:si_unique_call 790} sdv_IoSkipCurrentIrpStackLocation(Irp_21);
    assume {:nonnull} data_5 != 0;
    assume data_5 > 0;
    havoc vslice_dummy_var_13;
    call {:si_unique_call 791} status_20 := sdv_IoCallDriver#1(vslice_dummy_var_13, Irp_21);
  ...
  anon148_Then:
    call {:si_unique_call 794} KeyboardClassRemoveDevice(data_5);
    call {:si_unique_call 795} sdv_IoCopyCurrentIrpStackLocationToNext(Irp_21);
    assume {:nonnull} data_5 != 0;
    assume data_5 > 0;
    havoc vslice_dummy_var_14;
    call {:si_unique_call 796} status_20 := sdv_IoCallDriver#1(vslice_dummy_var_14, Irp_21);
    goto anon158_Then, anon158_Else;

  anon158_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 797} ExAcquireFastMutex(0);
  ...
  L121:
    call {:si_unique_call 798} ExReleaseFastMutex(0);
    goto L124;

  L124:
    call {:si_unique_call 799} sdv_IoReleaseRemoveLockAndWait(0, 0);
    call {:si_unique_call 800} IoDetachDevice(0);
    call {:si_unique_call 801} RtlFreeUnicodeString(0);
    call {:si_unique_call 802} sdv_ExFreePool(0);
    call {:si_unique_call 803} IoDeleteDevice(0);
    Tmp_268 := status_20;
    goto L1;
  ...
  anon117_Then:
    call {:si_unique_call 805} ExReleaseFastMutex(0);
    goto L124;
  ...
  anon150_Then:
    ...
    call {:si_unique_call 806} status_20 := KeyboardSendIrpSynchronously(vslice_dummy_var_15, Irp_21, 1);
  ...
  anon120_Else:
    ...
    assume {:nonnull} Irp_21 != 0;
    assume Irp_21 > 0;
    call {:si_unique_call 807} sdv_RtlZeroMemory(0, 64);
    ...
    assume {:nonnull} devCaps != 0;
    assume devCaps > 0;
    call {:si_unique_call 808} stack_3 := sdv_IoGetNextIrpStackLocation(Irp_21);
    assume {:nonnull} stack_3 != 0;
    assume stack_3 > 0;
    assume {:nonnull} stack_3 != 0;
    assume stack_3 > 0;
    ...
    call {:si_unique_call 809} status_20 := KeyboardSendIrpSynchronously(vslice_dummy_var_16, Irp_21, 0);
  ...
  anon122_Else:
    ...
    assume {:nonnull} devCaps != 0;
    assume devCaps > 0;
    call {:si_unique_call 810} sdv_RtlCopyMemory(0, 0, 20);
    goto L170;
  ...
  anon123_Else:
    assume {:nonnull} data_5 != 0;
    assume data_5 > 0;
    call {:si_unique_call 811} KeyboardClassGetWaitWakeEnableState(data_5);
    goto L187;
  ...
  L187:
    ...
    assume {:nonnull} data_5 != 0;
    assume data_5 > 0;
    call {:si_unique_call 812} vslice_dummy_var_77 := IoWMIRegistrationControl(0, 1);
  ...
  anon128_Else:
    assume {:nonnull} data_5 != 0;
    assume data_5 > 0;
    call {:si_unique_call 815} sdv_201 := _InlineInterlockedCompareExchangePointer(WaitWakeIrp__DEVICE_EXTENSION(data_5), 0, 0);
    goto anon129_Then, anon129_Else;

  anon129_Else:
    assume {:partition} sdv_201 == 0;
    call {:si_unique_call 816} sdv_203 := KeyboardClassCheckWaitWakeEnabled(data_5);
    goto anon130_Then, anon130_Else;

  anon130_Else:
    assume {:partition} sdv_203 != 0;
    call {:si_unique_call 817} vslice_dummy_var_76 := KeyboardClassCreateWaitWakeIrp#1(data_5);
  ...
  anon126_Then:
    assume {:partition} enabled_3 == 0;
    call {:si_unique_call 819} status_20 := KbdEnableDisablePort(1, Irp_21, data_5, file_2);
  ...
  anon131_Else:
    assume {:partition} status_20 >= 0;
    call {:si_unique_call 820} stack_3 := sdv_IoGetNextIrpStackLocation(Irp_21);
    assume {:nonnull} stack_3 != 0;
    assume stack_3 > 0;
    assume {:nonnull} stack_3 != 0;
    assume stack_3 > 0;
    ...
    call {:si_unique_call 821} status_20 := KeyboardSendIrpSynchronously(vslice_dummy_var_17, Irp_21, 0);
  ...
  anon124_Then:
    call {:si_unique_call 823} ExReleaseFastMutex(0);
    call {:si_unique_call 824} status_20 := IoSetDeviceInterfaceState(0, 1);
    goto L219;
...
implementation {:origName "KeyboardClassDeviceControl"} KeyboardClassDeviceControl(actual_DeviceObject_28: int, actual_Irp_22: int) returns (Tmp_276: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 827} Tmp_283 := __HAVOC_malloc(4);
    call {:si_unique_call 828} Tmp_297 := __HAVOC_malloc(4);
    call {:si_unique_call 829} Tmp_298 := __HAVOC_malloc(4);
    call {:si_unique_call 830} Tmp_300 := __HAVOC_malloc(4);
    loopit := 0;
    status_21 := 0;
    ...
    call {:si_unique_call 832} stack_4 := sdv_IoGetCurrentIrpStackLocation(Irp_22);
    call {:si_unique_call 833} status_21 := sdv_IoAcquireRemoveLock(0, 0);
  ...
  anon110_Else:
    call {:si_unique_call 834} sdv_IoSkipCurrentIrpStackLocation(Irp_22);
    assume {:nonnull} deviceExtension_5 != 0;
    assume deviceExtension_5 > 0;
    havoc vslice_dummy_var_18;
    call {:si_unique_call 835} status_21 := sdv_IoCallDriver#1(vslice_dummy_var_18, Irp_22);
    goto anon156_Then, anon156_Else;
  ...
  L46:
    assume {:nonnull} deviceExtension_5 != 0;
    assume deviceExtension_5 > 0;
    call {:si_unique_call 836} vslice_dummy_var_78 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(deviceExtension_5), Irp_22);
    Tmp_276 := status_21;
    goto L1;
  ...
  L98:
    call {:si_unique_call 843} Tmp_281, unitId, Tmp_296, Tmp_301, Tmp_302 := KeyboardClassDeviceControl_loop_L98(Tmp_281, unitId, Tmp_296, Tmp_301, Tmp_302);
    goto L98_last;
  ...
  L117:
    call {:si_unique_call 847} sdv_IoCopyCurrentIrpStackLocationToNext(Irp_22);
    call {:si_unique_call 848} sdv_212 := sdv_IoGetNextIrpStackLocation(Irp_22);
  ...
  anon150_Else:
    ...
    call {:si_unique_call 849} status_21 := sdv_IoAcquireRemoveLock(0, 0);
    call {:si_unique_call 850} ExAcquireFastMutex(0);
    havoc Tmp_288;
    call {:si_unique_call 851} sdv_213 := ExAllocatePoolWithTag(512, Tmp_288, -1016831413);
    callAll := sdv_213;
    goto anon151_Then, anon151_Else;
  ...
  L145:
    call {:si_unique_call 852} i_3, Tmp_277, Tmp_279, Tmp_280, Tmp_283, Tmp_284, Tmp_286, Tmp_294, Tmp_295, Tmp_297, status_21, Tmp_298, Tmp_299, Tmp_300 := KeyboardClassDeviceControl_loop_L145(i_3, Tmp_277, Tmp_279, Tmp_280, Tmp_283, Tmp_284, Tmp_286, Tmp_294, Tmp_295, Tmp_297, status_21, Tmp_298, callAll, Tmp_299, Tmp_300);
    goto L145_last;
  ...
  anon153_Else:
    ...
    assume Tmp_295 > 0;
    call {:si_unique_call 853} status_21 := sdv_IoAcquireRemoveLock(0, 0);
    goto L151;
  ...
  anon118_Then:
    call {:si_unique_call 854} status_21 := KeyboardCallAllPorts#1(DeviceObject_28, Irp_22, callAll);
    goto anon154_Then, anon154_Else;
  ...
  anon151_Then:
    ...
    assume {:nonnull} Irp_22 != 0;
    assume Irp_22 > 0;
    call {:si_unique_call 856} sdv_IoCompleteRequest(0, 0);
    goto L159;
  ...
  anon150_Then:
    ...
    call {:si_unique_call 857} status_21 := sdv_IoCallDriver#1(vslice_dummy_var_19, Irp_22);
    goto anon155_Then, anon155_Else;
  ...
  anon108_Else:
    ...
    assume {:nonnull} Irp_22 != 0;
    assume Irp_22 > 0;
    call {:si_unique_call 858} sdv_IoCompleteRequest(0, 0);
    goto L46;
...
implementation {:origName "KeyboardClassWWPowerUpComplete"} KeyboardClassWWPowerUpComplete(actual_DeviceObject_29: int, actual_MinorFunction_4: int, actual_structPtr888PowerState: int, actual_Context_11: int, actual_IoStatus_3: int)
{
  ...
  anon0:
    call {:si_unique_call 860} PowerState := __HAVOC_malloc(8);
    call {:si_unique_call 861} vslice_dummy_var_79 := __HAVOC_malloc(4);
    ...
    assume {:nonnull} structPtr888PowerState != 0;
    assume structPtr888PowerState > 0;
    call {:si_unique_call 862} vslice_dummy_var_80 := __HAVOC_malloc(204);
    data_6 := Context_11;
  ...
  anon11_Else:
    call {:si_unique_call 863} sdv_214 := ExAllocatePoolWithTag(512, 16, -1016831413);
    itemData_2 := sdv_214;
    goto anon12_Then, anon12_Else;
  ...
  anon9_Else:
    ...
    assume {:nonnull} itemData_2 != 0;
    assume itemData_2 > 0;
    call {:si_unique_call 865} status_22 := sdv_IoAcquireRemoveLock(0, 0);
    goto anon10_Then, anon10_Else;
  ...
  anon10_Else:
    ...
    call {:si_unique_call 866} IoQueueWorkItem(vslice_dummy_var_20, li2bplFunctionConstant667, 1, itemData_2);
    goto L1;
  ...
  L14:
    call {:si_unique_call 870} vslice_dummy_var_81 := corral_nondet();
    assume {:nonnull} data_6 != 0;
    assume data_6 > 0;
    havoc vslice_dummy_var_21;
    call {:si_unique_call 871} KeyboardClassLogError(vslice_dummy_var_21, 327694, 2, -1073741670, 0, 0, 0);
    goto L1;
...
implementation {:origName "KeyboardClassCheckWaitWakeEnabled"} KeyboardClassCheckWaitWakeEnabled(actual_Data_6: int) returns (Tmp_311: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 872} Tmp_312 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_312 != 0;
    assume Tmp_312 > 0;
    call {:si_unique_call 873} sdv_KeAcquireSpinLock(0, Tmp_312);
    assume {:nonnull} Tmp_312 != 0;
    assume Tmp_312 > 0;
    havoc irql_4;
    assume {:nonnull} Data_6 != 0;
    assume Data_6 > 0;
    havoc enabled_4;
    call {:si_unique_call 874} sdv_KeReleaseSpinLock(0, irql_4);
    Tmp_311 := enabled_4;
    return;
}
...
implementation {:origName "KeyboardClassCleanup"} KeyboardClassCleanup(actual_DeviceObject_31: int, actual_Irp_23: int) returns (Tmp_313: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 875} irpSp_7 := sdv_IoGetCurrentIrpStackLocation(Irp_23);
  ...
  anon3_Else:
    ...
    call {:si_unique_call 876} KeyboardClassCleanupQueue(DeviceObject_31, deviceExtension_6, vslice_dummy_var_22);
    goto L11;
...
implementation {:origName "KbdInitializeDataQueue"} KbdInitializeDataQueue(actual_Context_12: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 879} Tmp_316 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_316 != 0;
    assume Tmp_316 > 0;
    call {:si_unique_call 880} sdv_KeAcquireSpinLock(0, Tmp_316);
    assume {:nonnull} Tmp_316 != 0;
    assume Tmp_316 > 0;
    havoc oldIrql_2;
    ...
    assume {:nonnull} deviceExtension_7 != 0;
    assume deviceExtension_7 > 0;
    call {:si_unique_call 881} sdv_KeReleaseSpinLock(0, oldIrql_2);
    return;
}
...
implementation {:origName "KbdEnableDisablePort"} KbdEnableDisablePort(actual_EnableFlag: int, actual_Irp_24: int, actual_Port: int, actual_File: int) returns (Tmp_318: int)
{
  ...
  anon0:
    call {:si_unique_call 882} name := __HAVOC_malloc(12);
    call {:si_unique_call 883} device := __HAVOC_malloc(4);
  ...
  anon29_Else:
    call {:si_unique_call 885} sdv_IoCopyCurrentIrpStackLocationToNext(Irp_24);
    call {:si_unique_call 886} stack_5 := sdv_IoGetNextIrpStackLocation(Irp_24);
  ...
  L32:
    ...
    call {:si_unique_call 887} status_23 := KeyboardSendIrpSynchronously(vslice_dummy_var_23, Irp_24, 0);
    goto anon35_Then, anon35_Else;
  ...
  anon32_Else:
    assume {:partition} EnableFlag != 0;
    bufferLength := 0;
    call {:si_unique_call 888} Tmp_320 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_320 != 0;
    assume Tmp_320 > 0;
    call {:si_unique_call 889} status_23 := IoGetDeviceProperty(0, 4107, bufferLength, 0, Tmp_320);
    assume {:nonnull} Tmp_320 != 0;
    assume Tmp_320 > 0;
    havoc bufferLength;
    call {:si_unique_call 890} sdv_234 := ExAllocatePoolWithTag(1, bufferLength, -1016831413);
    buffer := sdv_234;
    goto anon36_Then, anon36_Else;

  anon36_Else:
    assume {:partition} buffer != 0;
    call {:si_unique_call 891} Tmp_320 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_320 != 0;
    assume Tmp_320 > 0;
    call {:si_unique_call 892} status_23 := IoGetDeviceProperty(0, 4107, bufferLength, 0, Tmp_320);
    assume {:nonnull} Tmp_320 != 0;
    assume Tmp_320 > 0;
    havoc bufferLength;
    assume {:nonnull} name != 0;
    ...
    assume {:nonnull} name != 0;
    assume name > 0;
    call {:si_unique_call 893} status_23 := IoGetDeviceObjectPointer(0, 2032127, 0, device);
  ...
  anon34_Else:
    ...
    call {:si_unique_call 895} sdv_IoCopyCurrentIrpStackLocationToNext(Irp_24);
    call {:si_unique_call 896} stack_5 := sdv_IoGetNextIrpStackLocation(Irp_24);
    assume {:nonnull} stack_5 != 0;
    assume stack_5 > 0;
    assume {:nonnull} stack_5 != 0;
    assume stack_5 > 0;
    ...
    call {:si_unique_call 897} status_23 := KeyboardSendIrpSynchronously(vslice_dummy_var_24, Irp_24, 0);
    goto anon37_Then, anon37_Else;
  ...
  L71:
    assume {:nonnull} Port != 0;
    assume Port > 0;
    call {:si_unique_call 898} status_23 := IoRegisterPlugPlayNotification(3, 0, 0, 0, li2bplFunctionConstant656, 0, 0);
    goto L36;
  ...
  anon32_Then:
    assume {:partition} EnableFlag == 0;
    call {:si_unique_call 899} vslice_dummy_var_83 := sdv_ObDereferenceObject(0);
    assume {:nonnull} File != 0;
    assume File > 0;
    goto L36;
  ...
  anon28_Then:
    assume {:nonnull} Port != 0;
    assume Port > 0;
    call {:si_unique_call 900} sdv_IoCopyCurrentIrpStackLocationToNext(Irp_24);
    call {:si_unique_call 901} stack_5 := sdv_IoGetNextIrpStackLocation(Irp_24);
    assume {:nonnull} stack_5 != 0;
    assume stack_5 > 0;
    assume {:nonnull} stack_5 != 0;
    assume stack_5 > 0;
  ...
  L107:
    ...
    call {:si_unique_call 902} status_23 := KeyboardSendIrpSynchronously(vslice_dummy_var_25, Irp_24, 0);
    goto anon39_Then, anon39_Else;
...
implementation {:origName "KeyboardClassPoRequestComplete"} KeyboardClassPoRequestComplete#0(actual_DeviceObject_25: int, actual_MinorFunction_3: int, actual_structPtr888D: int, actual_S: int, actual_IoStatus_2: int)
{
  ...
  anon0:
    call {:si_unique_call 903} D := __HAVOC_malloc(8);
    call {:si_unique_call 904} vslice_dummy_var_84 := __HAVOC_malloc(4);
    call {:si_unique_call 905} powerState_3 := __HAVOC_malloc(8);
    call {:si_unique_call 906} sdv := __HAVOC_malloc(8);
    ...
    assume {:nonnull} structPtr888D != 0;
    assume structPtr888D > 0;
    call {:si_unique_call 907} vslice_dummy_var_86 := __HAVOC_malloc(204);
  ...
  anon25_Else:
    ...
    call {:si_unique_call 908} sdv_170 := sdv_IoGetCurrentIrpStackLocation(S);
    assume {:nonnull} powerState_3 != 0;
    assume powerState_3 > 0;
    assume {:nonnull} sdv_170 != 0;
    assume sdv_170 > 0;
    assume {:nonnull} powerState_3 != 0;
    assume powerState_3 > 0;
    assume {:nonnull} sdv_170 != 0;
    assume sdv_170 > 0;
    call {:si_unique_call 909} structPtr888sdv := PoSetPowerState(0, 0, powerState_3);
    ...
    call {:si_unique_call 911} sdv_IoSkipCurrentIrpStackLocation(S);
    assume false;
    return;
  ...
  anon20_Else:
    assume {:nonnull} data_4 != 0;
    assume data_4 > 0;
    call {:si_unique_call 912} sdv_176 := _InlineInterlockedCompareExchangePointer(WaitWakeIrp__DEVICE_EXTENSION(data_4), 0, 0);
    goto anon21_Then, anon21_Else;

  anon21_Else:
    assume {:partition} sdv_176 == 0;
    call {:si_unique_call 913} sdv_175 := KeyboardClassCheckWaitWakeEnabled(data_4);
    goto anon22_Then, anon22_Else;

  anon22_Else:
    assume {:partition} sdv_175 != 0;
    call {:si_unique_call 914} sdv_171 := ExAllocatePoolWithTag(512, 16, -1016831413);
    itemData_1 := sdv_171;
    goto anon27_Then, anon27_Else;
  ...
  anon27_Else:
    ...
    assume itemData_1 > 0;
    call {:si_unique_call 915} boogieTmp := IoAllocateWorkItem(0);
    assume {:nonnull} itemData_1 != 0;
    assume itemData_1 > 0;
    goto anon23_Then, anon23_Else;
  ...
  anon23_Else:
    ...
    assume {:nonnull} itemData_1 != 0;
    assume itemData_1 > 0;
    call {:si_unique_call 916} status_17 := sdv_IoAcquireRemoveLock(0, 0);
    goto anon24_Then, anon24_Else;
  ...
  anon24_Else:
    ...
    call {:si_unique_call 917} IoQueueWorkItem(vslice_dummy_var_26, li2bplFunctionConstant667, 1, itemData_1);
    goto L1;
  ...
  anon24_Then:
    ...
    call {:si_unique_call 918} IoFreeWorkItem(0);
    call {:si_unique_call 919} sdv_ExFreePool(0);
    goto L43;

  L43:
    call {:si_unique_call 920} vslice_dummy_var_87 := corral_nondet();
    assume {:nonnull} data_4 != 0;
    assume data_4 > 0;
    havoc vslice_dummy_var_27;
    call {:si_unique_call 921} KeyboardClassLogError(vslice_dummy_var_27, 327694, 1, -1073741670, 0, 0, 0);
    goto L1;
...
implementation {:origName "KeyboardClassPoRequestComplete"} KeyboardClassPoRequestComplete#1(actual_DeviceObject_25: int, actual_MinorFunction_3: int, actual_structPtr888D: int, actual_S: int, actual_IoStatus_2: int)
{
  ...
  anon0:
    call {:si_unique_call 923} D := __HAVOC_malloc(8);
    call {:si_unique_call 924} vslice_dummy_var_88 := __HAVOC_malloc(4);
    call {:si_unique_call 925} powerState_3 := __HAVOC_malloc(8);
    call {:si_unique_call 926} sdv := __HAVOC_malloc(8);
    DeviceObject_25 := actual_DeviceObject_25;
    structPtr888D := actual_structPtr888D;
    S := actual_S;
    assume {:nonnull} D != 0;
    ...
    assume {:nonnull} structPtr888D != 0;
    assume structPtr888D > 0;
    call {:si_unique_call 927} vslice_dummy_var_91 := __HAVOC_malloc(204);
    assume {:nonnull} DeviceObject_25 != 0;
    assume DeviceObject_25 > 0;
    havoc data_4;
    goto anon25_Then, anon25_Else;
  ...
  anon25_Else:
    assume {:partition} S != 0;
    call {:si_unique_call 928} sdv_170 := sdv_IoGetCurrentIrpStackLocation(S);
    assume {:nonnull} powerState_3 != 0;
    assume powerState_3 > 0;
    assume {:nonnull} sdv_170 != 0;
    assume sdv_170 > 0;
    ...
    assume {:nonnull} sdv_170 != 0;
    assume sdv_170 > 0;
    call {:si_unique_call 929} structPtr888sdv := PoSetPowerState(0, 0, powerState_3);
    assume {:nonnull} sdv != 0;
    assume sdv > 0;
    assume {:nonnull} structPtr888sdv != 0;
    assume structPtr888sdv > 0;
    ...
    assume {:nonnull} powerState_3 != 0;
    assume powerState_3 > 0;
    call {:si_unique_call 930} PoStartNextPowerIrp(0);
    call {:si_unique_call 931} sdv_IoSkipCurrentIrpStackLocation(S);
    call {:si_unique_call 932} vslice_dummy_var_89 := PoCallDriver#0(0, S);
  ...
  anon26_Else:
    ...
    assume {:nonnull} data_4 != 0;
    assume data_4 > 0;
    call {:si_unique_call 933} vslice_dummy_var_90 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(data_4), S);
    goto L1;
  ...
  anon20_Else:
    assume {:nonnull} data_4 != 0;
    assume data_4 > 0;
    call {:si_unique_call 934} sdv_176 := _InlineInterlockedCompareExchangePointer(WaitWakeIrp__DEVICE_EXTENSION(data_4), 0, 0);
    goto anon21_Then, anon21_Else;

  anon21_Else:
    assume {:partition} sdv_176 == 0;
    call {:si_unique_call 935} sdv_175 := KeyboardClassCheckWaitWakeEnabled(data_4);
    goto anon22_Then, anon22_Else;

  anon22_Else:
    assume {:partition} sdv_175 != 0;
    call {:si_unique_call 936} sdv_171 := ExAllocatePoolWithTag(512, 16, -1016831413);
    itemData_1 := sdv_171;
    goto anon27_Then, anon27_Else;
  ...
  anon27_Else:
    ...
    assume {:nonnull} itemData_1 != 0;
    assume itemData_1 > 0;
    call {:si_unique_call 937} boogieTmp := IoAllocateWorkItem(0);
    assume {:nonnull} itemData_1 != 0;
    assume itemData_1 > 0;
    goto anon23_Then, anon23_Else;
  ...
  anon23_Else:
    ...
    assume {:nonnull} itemData_1 != 0;
    assume itemData_1 > 0;
    call {:si_unique_call 938} status_17 := sdv_IoAcquireRemoveLock(0, 0);
    goto anon24_Then, anon24_Else;
  ...
  anon24_Else:
    ...
    call {:si_unique_call 939} IoQueueWorkItem(vslice_dummy_var_28, li2bplFunctionConstant667, 1, itemData_1);
    goto L1;

  anon24_Then:
    assume {:partition} 0 > status_17;
    call {:si_unique_call 940} IoFreeWorkItem(0);
    call {:si_unique_call 941} sdv_ExFreePool(0);
    goto L43;

  L43:
    call {:si_unique_call 942} vslice_dummy_var_92 := corral_nondet();
    assume {:nonnull} data_4 != 0;
    assume data_4 > 0;
    havoc vslice_dummy_var_29;
    call {:si_unique_call 943} KeyboardClassLogError(vslice_dummy_var_29, 327694, 1, -1073741670, 0, 0, 0);
    goto L1;
...
implementation {:origName "PoCallDriver"} {:osmodel} PoCallDriver#0(actual_DeviceObject_1: int, actual_Irp: int) returns (Tmp_40: int)
{
  ...
  anon0:
    call {:si_unique_call 945} completion := __HAVOC_malloc(4);
    Irp := actual_Irp;
  ...
  anon56_Then:
    ...
    call {:si_unique_call 946} vslice_dummy_var_93 := sdv_RunIoCompletionRoutines#0(sdv_p_devobj_fdo, Irp, vslice_dummy_var_30, completion);
    goto anon76_Then, anon76_Else;
  ...
  anon68_Else:
    ...
    call {:si_unique_call 947} vslice_dummy_var_96 := sdv_RunIoCompletionRoutines#0(sdv_p_devobj_fdo, Irp, vslice_dummy_var_31, completion);
    goto anon78_Then, anon78_Else;
  ...
  anon60_Else:
    ...
    call {:si_unique_call 948} vslice_dummy_var_94 := sdv_RunIoCompletionRoutines#0(sdv_p_devobj_fdo, Irp, vslice_dummy_var_32, completion);
    goto anon74_Then, anon74_Else;
  ...
  anon64_Else:
    ...
    call {:si_unique_call 949} vslice_dummy_var_95 := sdv_RunIoCompletionRoutines#0(sdv_p_devobj_fdo, Irp, vslice_dummy_var_33, completion);
    goto anon72_Then, anon72_Else;
...
implementation {:origName "PoCallDriver"} {:osmodel} PoCallDriver#1(actual_DeviceObject_1: int, actual_Irp: int) returns (Tmp_40: int)
{
  ...
  anon0:
    call {:si_unique_call 950} completion := __HAVOC_malloc(4);
    Irp := actual_Irp;
    assume {:nonnull} completion != 0;
    assume completion > 0;
    status := 259;
  ...
  anon56_Then:
    ...
    call {:si_unique_call 951} vslice_dummy_var_97 := sdv_RunIoCompletionRoutines#1(sdv_p_devobj_fdo, Irp, vslice_dummy_var_34, completion);
    goto anon76_Then, anon76_Else;
  ...
  anon68_Else:
    ...
    call {:si_unique_call 952} vslice_dummy_var_100 := sdv_RunIoCompletionRoutines#1(sdv_p_devobj_fdo, Irp, vslice_dummy_var_35, completion);
    goto anon78_Then, anon78_Else;
  ...
  anon60_Else:
    ...
    call {:si_unique_call 953} vslice_dummy_var_98 := sdv_RunIoCompletionRoutines#1(sdv_p_devobj_fdo, Irp, vslice_dummy_var_36, completion);
    goto anon74_Then, anon74_Else;
  ...
  anon64_Else:
    ...
    call {:si_unique_call 954} vslice_dummy_var_99 := sdv_RunIoCompletionRoutines#1(sdv_p_devobj_fdo, Irp, vslice_dummy_var_37, completion);
    goto anon72_Then, anon72_Else;
...
implementation {:origName "sdv_RunIoCompletionRoutines"} {:osmodel} sdv_RunIoCompletionRoutines#0(actual_DeviceObject_9: int, actual_Irp_5: int, actual_Context_6: int, actual_Completion: int) returns (Tmp_131: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 955} SLIC_sdv_RunIoCompletionRoutines_entry(0, Irp_5);
    call {:si_unique_call 956} irpsp := sdv_IoGetNextIrpStackLocation(Irp_5);
    Status := 0;
    assume {:nonnull} irpsp != 0;
    assume irpsp > 0;
    goto anon18_Then, anon18_Else;
  ...
  anon18_Else:
    call {:si_unique_call 957} Status := KbdSyncComplete(DeviceObject_9, Irp_5, Context_6);
    assume {:nonnull} Completion != 0;
    assume Completion > 0;
    goto L11;
  ...
  anon15_Else:
    call {:si_unique_call 958} Status := KeyboardCallAllPorts#0(DeviceObject_9, Irp_5, Context_6);
    goto anon19_Then, anon19_Else;
  ...
  anon16_Else:
    call {:si_unique_call 959} Status := KeyboardClassPowerComplete#0(DeviceObject_9, Irp_5, Context_6);
    goto anon20_Then, anon20_Else;
  ...
  anon17_Else:
    call {:si_unique_call 960} Status := KeyboardClassSetLedsComplete(DeviceObject_9, Irp_5, Context_6);
    assume {:nonnull} Completion != 0;
    assume Completion > 0;
    goto L62;
  ...
  L62:
    Tmp_131 := Status;
    call {:si_unique_call 961} SLIC_sdv_RunIoCompletionRoutines_exit(strConst__li2bpl0, Irp_5, Completion);
    goto anon21_Then, anon21_Else;
...
implementation {:origName "sdv_RunIoCompletionRoutines"} {:osmodel} sdv_RunIoCompletionRoutines#1(actual_DeviceObject_9: int, actual_Irp_5: int, actual_Context_6: int, actual_Completion: int) returns (Tmp_131: int)
{
  ...
  anon0:
    ...
    Context_6 := actual_Context_6;
    Completion := actual_Completion;
    call {:si_unique_call 962} SLIC_sdv_RunIoCompletionRoutines_entry(0, Irp_5);
    call {:si_unique_call 963} irpsp := sdv_IoGetNextIrpStackLocation(Irp_5);
    Status := 0;
    assume {:nonnull} irpsp != 0;
    assume irpsp > 0;
    goto anon18_Then, anon18_Else;
  ...
  anon18_Else:
    call {:si_unique_call 964} Status := KbdSyncComplete(DeviceObject_9, Irp_5, Context_6);
    assume {:nonnull} Completion != 0;
    assume Completion > 0;
    goto L11;
  ...
  anon15_Else:
    call {:si_unique_call 965} Status := KeyboardCallAllPorts#1(DeviceObject_9, Irp_5, Context_6);
    goto anon19_Then, anon19_Else;
  ...
  anon16_Else:
    call {:si_unique_call 966} Status := KeyboardClassPowerComplete#1(DeviceObject_9, Irp_5, Context_6);
    goto anon20_Then, anon20_Else;
  ...
  anon17_Else:
    call {:si_unique_call 967} Status := KeyboardClassSetLedsComplete(DeviceObject_9, Irp_5, Context_6);
    assume {:nonnull} Completion != 0;
    assume Completion > 0;
    goto L62;
  ...
  L62:
    Tmp_131 := Status;
    call {:si_unique_call 968} SLIC_sdv_RunIoCompletionRoutines_exit(strConst__li2bpl0, Irp_5, Completion);
    goto anon21_Then, anon21_Else;
...
implementation {:origName "KeyboardCallAllPorts"} KeyboardCallAllPorts#0(actual_Device: int, actual_Irp_10: int, actual_CallAll: int) returns (Tmp_185: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 969} Tmp_187 := __HAVOC_malloc(4);
    call {:si_unique_call 970} Tmp_189 := __HAVOC_malloc(4);
    call {:si_unique_call 971} Tmp_190 := __HAVOC_malloc(4);
    call {:si_unique_call 972} Tmp_193 := __HAVOC_malloc(4);
    assume {:nonnull} CallAll != 0;
    assume CallAll > 0;
    goto anon17_Then, anon17_Else;
  ...
  L56:
    call {:si_unique_call 973} nextSp := sdv_IoGetNextIrpStackLocation(Irp_10);
    call {:si_unique_call 974} sdv_IoCopyCurrentIrpStackLocationToNext(Irp_10);
    assume {:nonnull} nextSp != 0;
    assume nextSp > 0;
    goto L16;

  L16:
    call {:si_unique_call 975} Tmp_190, Tmp_192, Tmp_193, Tmp_194, Tmp_195, Tmp_196 := KeyboardCallAllPorts#0_loop_L16(Tmp_190, Tmp_192, Tmp_193, Tmp_194, Tmp_195, Tmp_196, CallAll);
    goto L16_last;
  ...
  anon19_Else:
    ...
    assume {:nonnull} CallAll != 0;
    assume CallAll > 0;
    call {:si_unique_call 976} sdv_IoSetCompletionRoutine(Irp_10, li2bplFunctionConstant643, CallAll, 1, 1, 1);
    assume {:nonnull} port_2 != 0;
    assume port_2 > 0;
    havoc vslice_dummy_var_38;
    call {:si_unique_call 977} status_7 := sdv_IoCallDriver#0(vslice_dummy_var_38, Irp_10);
    goto anon24_Then, anon24_Else;
  ...
  anon24_Else:
    ...
    assume {:nonnull} port_2 != 0;
    assume port_2 > 0;
    call {:si_unique_call 978} vslice_dummy_var_101 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(port_2), Irp_10);
    goto anon21_Then, anon21_Else;
  ...
  L38:
    ...
    call {:si_unique_call 980} vslice_dummy_var_102 := sdv_IoReleaseRemoveLock(vslice_dummy_var_39, Irp_10);
...
implementation {:origName "KeyboardCallAllPorts"} KeyboardCallAllPorts#1(actual_Device: int, actual_Irp_10: int, actual_CallAll: int) returns (Tmp_185: int)
{
  ...
  anon0:
    Irp_10 := actual_Irp_10;
    CallAll := actual_CallAll;
    call {:si_unique_call 982} Tmp_187 := __HAVOC_malloc(4);
    call {:si_unique_call 983} Tmp_189 := __HAVOC_malloc(4);
    call {:si_unique_call 984} Tmp_190 := __HAVOC_malloc(4);
    call {:si_unique_call 985} Tmp_193 := __HAVOC_malloc(4);
    assume {:nonnull} CallAll != 0;
    assume CallAll > 0;
    goto anon17_Then, anon17_Else;
  ...
  L56:
    call {:si_unique_call 986} nextSp := sdv_IoGetNextIrpStackLocation(Irp_10);
    call {:si_unique_call 987} sdv_IoCopyCurrentIrpStackLocationToNext(Irp_10);
    assume {:nonnull} nextSp != 0;
    assume nextSp > 0;
    goto L16;

  L16:
    call {:si_unique_call 988} Tmp_190, Tmp_192, Tmp_193, Tmp_194, Tmp_195, Tmp_196 := KeyboardCallAllPorts#1_loop_L16(Tmp_190, Tmp_192, Tmp_193, Tmp_194, Tmp_195, Tmp_196, CallAll);
    goto L16_last;
  ...
  anon19_Else:
    ...
    assume {:nonnull} CallAll != 0;
    assume CallAll > 0;
    call {:si_unique_call 989} sdv_IoSetCompletionRoutine(Irp_10, li2bplFunctionConstant643, CallAll, 1, 1, 1);
    assume {:nonnull} port_2 != 0;
    assume port_2 > 0;
    havoc vslice_dummy_var_40;
    call {:si_unique_call 990} status_7 := sdv_IoCallDriver#1(vslice_dummy_var_40, Irp_10);
    goto anon24_Then, anon24_Else;
  ...
  anon24_Else:
    ...
    assume {:nonnull} port_2 != 0;
    assume port_2 > 0;
    call {:si_unique_call 991} vslice_dummy_var_103 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(port_2), Irp_10);
    goto anon21_Then, anon21_Else;
  ...
  L38:
    ...
    call {:si_unique_call 993} vslice_dummy_var_104 := sdv_IoReleaseRemoveLock(vslice_dummy_var_41, Irp_10);
...
implementation {:origName "sdv_IoCallDriver"} {:osmodel} sdv_IoCallDriver#0(actual_DeviceObject_10: int, actual_Irp_6: int) returns (Tmp_135: int)
{
  ...
  anon0:
    Irp_6 := actual_Irp_6;
    call {:si_unique_call 995} Tmp_135 := IofCallDriver#0(0, Irp_6);
    goto anon3_Then, anon3_Else;
...
implementation {:origName "sdv_IoCallDriver"} {:osmodel} sdv_IoCallDriver#1(actual_DeviceObject_10: int, actual_Irp_6: int) returns (Tmp_135: int)
{
  ...
  anon0:
    Irp_6 := actual_Irp_6;
    call {:si_unique_call 996} Tmp_135 := IofCallDriver#1(0, Irp_6);
    goto anon3_Then, anon3_Else;
...
implementation {:origName "IofCallDriver"} {:osmodel} IofCallDriver#0(actual_DeviceObject_8: int, actual_Irp_4: int) returns (Tmp_129: int)
{
  ...
  anon0:
    call {:si_unique_call 997} completion_1 := __HAVOC_malloc(4);
    Irp_4 := actual_Irp_4;
...
implementation {:origName "IofCallDriver"} {:osmodel} IofCallDriver#1(actual_DeviceObject_8: int, actual_Irp_4: int) returns (Tmp_129: int)
{
  ...
  anon0:
    call {:si_unique_call 998} completion_1 := __HAVOC_malloc(4);
    Irp_4 := actual_Irp_4;
    assume {:nonnull} completion_1 != 0;
    assume completion_1 > 0;
    status_3 := 259;
  ...
  anon55_Then:
    ...
    call {:si_unique_call 999} vslice_dummy_var_105 := sdv_RunIoCompletionRoutines#0(sdv_p_devobj_fdo, Irp_4, vslice_dummy_var_42, completion_1);
    goto anon76_Then, anon76_Else;
  ...
  anon67_Else:
    ...
    call {:si_unique_call 1000} vslice_dummy_var_108 := sdv_RunIoCompletionRoutines#0(sdv_p_devobj_fdo, Irp_4, vslice_dummy_var_43, completion_1);
    goto anon78_Then, anon78_Else;
  ...
  anon59_Else:
    ...
    call {:si_unique_call 1001} vslice_dummy_var_106 := sdv_RunIoCompletionRoutines#0(sdv_p_devobj_fdo, Irp_4, vslice_dummy_var_44, completion_1);
    goto anon74_Then, anon74_Else;
  ...
  anon63_Else:
    ...
    call {:si_unique_call 1002} vslice_dummy_var_107 := sdv_RunIoCompletionRoutines#0(sdv_p_devobj_fdo, Irp_4, vslice_dummy_var_45, completion_1);
    goto anon72_Then, anon72_Else;
...
implementation {:origName "KeyboardClassPowerComplete"} KeyboardClassPowerComplete#0(actual_DeviceObject_16: int, actual_Irp_11: int, actual_Context_7: int) returns (Tmp_197: int)
{
  ...
  anon0:
    call {:si_unique_call 1003} powerState := __HAVOC_malloc(8);
    call {:si_unique_call 1004} sdv_2 := __HAVOC_malloc(8);
    call {:si_unique_call 1005} sdv_3 := __HAVOC_malloc(8);
    DeviceObject_16 := actual_DeviceObject_16;
    Irp_11 := actual_Irp_11;
    assume {:nonnull} DeviceObject_16 != 0;
    assume DeviceObject_16 > 0;
    havoc data;
    call {:si_unique_call 1006} stack_1 := sdv_IoGetCurrentIrpStackLocation(Irp_11);
    call {:si_unique_call 1007} next := sdv_IoGetNextIrpStackLocation(Irp_11);
  ...
  L79:
    ...
    assume data > 0;
    call {:si_unique_call 1009} vslice_dummy_var_109 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(data), Irp_11);
    Tmp_197 := 0;
    goto LM2;
  ...
  anon24_Then:
    assume {:partition} powerType == 1;
    call {:si_unique_call 1010} SD3_1 := PoSetPowerState(0, powerType, powerState);
    ...
    call {:si_unique_call 1011} irpLeds := IoAllocateIrp(vslice_dummy_var_46, 0);
    goto anon20_Then, anon20_Else;
  ...
  anon20_Then:
    assume {:partition} irpLeds != 0;
    call {:si_unique_call 1012} status_8 := sdv_IoAcquireRemoveLock(0, 0);
    goto anon21_Then, anon21_Else;
  ...
  L53:
    call {:si_unique_call 1013} next := sdv_IoGetNextIrpStackLocation(irpLeds);
    ...
    assume {:nonnull} next != 0;
    assume next > 0;
    call {:si_unique_call 1014} sdv_IoSetCompletionRoutine(irpLeds, li2bplFunctionConstant675, data, 1, 1, 1);
    assume {:nonnull} irpLeds != 0;
    assume irpLeds > 0;
    assume {:nonnull} data != 0;
    assume data > 0;
    havoc vslice_dummy_var_47;
    call {:si_unique_call 1015} vslice_dummy_var_110 := sdv_IoCallDriver#0(vslice_dummy_var_47, irpLeds);
    goto anon27_Then, anon27_Else;
  ...
  anon19_Then:
    assume {:partition} powerType == 0;
    call {:si_unique_call 1017} SD2_1 := PoSetPowerState(0, powerType, powerState);
    ...
    call {:si_unique_call 1018} status_8 := PoRequestPowerIrp#0(vslice_dummy_var_48, 2, powerState, li2bplFunctionConstant674, 0, 0);
    goto anon26_Then, anon26_Else;
...
implementation {:origName "KeyboardClassPowerComplete"} KeyboardClassPowerComplete#1(actual_DeviceObject_16: int, actual_Irp_11: int, actual_Context_7: int) returns (Tmp_197: int)
{
  ...
  anon0:
    call {:si_unique_call 1019} powerState := __HAVOC_malloc(8);
    call {:si_unique_call 1020} sdv_2 := __HAVOC_malloc(8);
    call {:si_unique_call 1021} sdv_3 := __HAVOC_malloc(8);
    DeviceObject_16 := actual_DeviceObject_16;
    Irp_11 := actual_Irp_11;
    assume {:nonnull} DeviceObject_16 != 0;
    assume DeviceObject_16 > 0;
    havoc data;
    call {:si_unique_call 1022} stack_1 := sdv_IoGetCurrentIrpStackLocation(Irp_11);
    call {:si_unique_call 1023} next := sdv_IoGetNextIrpStackLocation(Irp_11);
    assume {:nonnull} stack_1 != 0;
    assume stack_1 > 0;
    havoc powerType;
    assume {:nonnull} powerState != 0;
  ...
  L79:
    ...
    assume {:nonnull} data != 0;
    assume data > 0;
    call {:si_unique_call 1025} vslice_dummy_var_111 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(data), Irp_11);
    Tmp_197 := 0;
    goto LM2;
  ...
  anon24_Then:
    assume {:partition} powerType == 1;
    call {:si_unique_call 1026} SD3_1 := PoSetPowerState(0, powerType, powerState);
    assume {:nonnull} SD3_1 != 0;
    assume SD3_1 > 0;
    assume {:nonnull} sdv_3 != 0;
    assume sdv_3 > 0;
    ...
    call {:si_unique_call 1027} irpLeds := IoAllocateIrp(vslice_dummy_var_49, 0);
    goto anon20_Then, anon20_Else;
  ...
  anon20_Then:
    assume {:partition} irpLeds != 0;
    call {:si_unique_call 1028} status_8 := sdv_IoAcquireRemoveLock(0, 0);
    goto anon21_Then, anon21_Else;
  ...
  L53:
    call {:si_unique_call 1029} next := sdv_IoGetNextIrpStackLocation(irpLeds);
    assume {:nonnull} next != 0;
    assume next > 0;
    assume {:nonnull} next != 0;
    assume next > 0;
    ...
    assume {:nonnull} next != 0;
    assume next > 0;
    call {:si_unique_call 1030} sdv_IoSetCompletionRoutine(irpLeds, li2bplFunctionConstant675, data, 1, 1, 1);
    assume {:nonnull} irpLeds != 0;
    assume irpLeds > 0;
    assume {:nonnull} data != 0;
    assume data > 0;
    havoc vslice_dummy_var_50;
    call {:si_unique_call 1031} vslice_dummy_var_112 := sdv_IoCallDriver#1(vslice_dummy_var_50, irpLeds);
    goto anon27_Then, anon27_Else;
  ...
  anon19_Then:
    assume {:partition} powerType == 0;
    call {:si_unique_call 1033} SD2_1 := PoSetPowerState(0, powerType, powerState);
    assume {:nonnull} SD2_1 != 0;
    assume SD2_1 > 0;
    assume {:nonnull} sdv_2 != 0;
    assume sdv_2 > 0;
    ...
    call {:si_unique_call 1034} status_8 := PoRequestPowerIrp#1(vslice_dummy_var_51, 2, powerState, li2bplFunctionConstant674, 0, 0);
    goto anon26_Then, anon26_Else;
...
implementation {:origName "PoRequestPowerIrp"} {:osmodel} PoRequestPowerIrp#0(actual_DeviceObject_6: int, actual_MinorFunction: int, actual_SD3: int, actual_CompletionFunction: int, actual_Context_3: int, actual_Irp_2: int) returns (Tmp_73: int)
{
  ...
  anon0:
    call {:si_unique_call 1035} PowerState_3 := __HAVOC_malloc(8);
  ...
  anon11_Else:
    ...
    assume {:nonnull} sdv_power_irp != 0;
    assume sdv_power_irp > 0;
    call {:si_unique_call 1036} vslice_dummy_var_113 := sdv_RunPowerCompletionRoutines#0(DeviceObject_6, MinorFunction, PowerState_3, Context_3, IoStatus__IRP(sdv_power_irp), CompletionFunction);
    goto anon15_Then, anon15_Else;
...
implementation {:origName "PoRequestPowerIrp"} {:osmodel} PoRequestPowerIrp#1(actual_DeviceObject_6: int, actual_MinorFunction: int, actual_SD3: int, actual_CompletionFunction: int, actual_Context_3: int, actual_Irp_2: int) returns (Tmp_73: int)
{
  ...
  anon11_Else:
    ...
    assume {:nonnull} sdv_power_irp != 0;
    assume sdv_power_irp > 0;
    call {:si_unique_call 1038} vslice_dummy_var_114 := sdv_RunPowerCompletionRoutines#1(DeviceObject_6, MinorFunction, PowerState_3, Context_3, IoStatus__IRP(sdv_power_irp), CompletionFunction);
    goto anon15_Then, anon15_Else;
...
implementation {:origName "sdv_RunPowerCompletionRoutines"} {:osmodel} sdv_RunPowerCompletionRoutines#0(actual_DeviceObject_7: int, actual_MinorFunction_1: int, actual_SD2: int, actual_Context_4: int, actual_IoStatus: int, actual_CompletionFunction_1: int) returns (Tmp_85: int)
{
  ...
  anon0:
    call {:si_unique_call 1039} PowerState_2 := __HAVOC_malloc(8);
  ...
  anon13_Else:
    ...
    call {:si_unique_call 1040} sdv_stub_power_completion_begin();
    call {:si_unique_call 1041} KeyboardClassPoRequestComplete#0(DeviceObject_7, MinorFunction_1, PowerState_2, Context_4, IoStatus);
    goto anon14_Then, anon14_Else;
  ...
  anon11_Else:
    ...
    call {:si_unique_call 1043} KeyboardClassWWPowerUpComplete(DeviceObject_7, MinorFunction_1, PowerState_2, Context_4, IoStatus);
    CompletionFunction_2 := 1;
    goto L19;
  ...
  anon12_Else:
    ...
    call {:si_unique_call 1045} KeyboardClassWaitWakeComplete#0(DeviceObject_7, MinorFunction_1, PowerState_2, Context_4, IoStatus);
    goto anon15_Then, anon15_Else;
...
implementation {:origName "sdv_RunPowerCompletionRoutines"} {:osmodel} sdv_RunPowerCompletionRoutines#1(actual_DeviceObject_7: int, actual_MinorFunction_1: int, actual_SD2: int, actual_Context_4: int, actual_IoStatus: int, actual_CompletionFunction_1: int) returns (Tmp_85: int)
{
  ...
  anon0:
    call {:si_unique_call 1046} PowerState_2 := __HAVOC_malloc(8);
    DeviceObject_7 := actual_DeviceObject_7;
    MinorFunction_1 := actual_MinorFunction_1;
    SD2 := actual_SD2;
    Context_4 := actual_Context_4;
  ...
  anon13_Else:
    assume {:partition} CompletionFunction_1 == li2bplFunctionConstant674;
    call {:si_unique_call 1047} sdv_stub_power_completion_begin();
    call {:si_unique_call 1048} KeyboardClassPoRequestComplete#1(DeviceObject_7, MinorFunction_1, PowerState_2, Context_4, IoStatus);
    goto anon14_Then, anon14_Else;
  ...
  anon11_Else:
    ...
    call {:si_unique_call 1050} KeyboardClassWWPowerUpComplete(DeviceObject_7, MinorFunction_1, PowerState_2, Context_4, IoStatus);
    CompletionFunction_2 := 1;
    goto L19;
  ...
  anon12_Else:
    ...
    call {:si_unique_call 1052} KeyboardClassWaitWakeComplete#1(DeviceObject_7, MinorFunction_1, PowerState_2, Context_4, IoStatus);
    goto anon15_Then, anon15_Else;
...
implementation {:origName "KeyboardClassWaitWakeComplete"} KeyboardClassWaitWakeComplete#0(actual_DeviceObject_21: int, actual_MinorFunction_2: int, actual_SD1_1: int, actual_Context_10: int, actual_IoStatus_1: int)
{
  ...
  anon0:
    call {:si_unique_call 1053} PowerState_1 := __HAVOC_malloc(8);
    ...
    assume data_2 > 0;
    call {:si_unique_call 1056} sdv_133 := _InlineInterlockedExchangePointer(ExtraWaitWakeIrp__DEVICE_EXTENSION(data_2), 0);
    goto anon19_Then, anon19_Else;
  ...
  anon21_Then:
    call {:si_unique_call 1057} vslice_dummy_var_117 := KeyboardToggleWaitWake#0(data_2, 0);
    goto anon27_Then, anon27_Else;
  ...
  anon19_Then:
    ...
    assume {:nonnull} data_2 != 0;
    assume data_2 > 0;
    call {:si_unique_call 1058} vslice_dummy_var_116 := _InlineInterlockedExchangePointer(WaitWakeIrp__DEVICE_EXTENSION(data_2), 0);
    goto L15;
}
...
implementation {:origName "KeyboardClassWaitWakeComplete"} KeyboardClassWaitWakeComplete#1(actual_DeviceObject_21: int, actual_MinorFunction_2: int, actual_SD1_1: int, actual_Context_10: int, actual_IoStatus_1: int)
{
  ...
  anon0:
    call {:si_unique_call 1059} PowerState_1 := __HAVOC_malloc(8);
    call {:si_unique_call 1060} vslice_dummy_var_118 := __HAVOC_malloc(4);
    ...
    assume {:nonnull} data_2 != 0;
    assume data_2 > 0;
    call {:si_unique_call 1062} sdv_133 := _InlineInterlockedExchangePointer(ExtraWaitWakeIrp__DEVICE_EXTENSION(data_2), 0);
    goto anon19_Then, anon19_Else;
  ...
  anon21_Else:
    ...
    call {:si_unique_call 1063} vslice_dummy_var_121 := PoRequestPowerIrp#0(vslice_dummy_var_52, 2, powerState_1, li2bplFunctionConstant666, Context_10, 0);
    goto anon26_Then, anon26_Else;
  ...
  anon21_Then:
    call {:si_unique_call 1064} vslice_dummy_var_120 := KeyboardToggleWaitWake#1(data_2, 0);
    goto anon27_Then, anon27_Else;
  ...
  anon19_Then:
    ...
    assume {:nonnull} data_2 != 0;
    assume data_2 > 0;
    call {:si_unique_call 1065} vslice_dummy_var_119 := _InlineInterlockedExchangePointer(WaitWakeIrp__DEVICE_EXTENSION(data_2), 0);
    goto L15;
}
...
implementation {:origName "KeyboardToggleWaitWake"} KeyboardToggleWaitWake#0(actual_Data_4: int, actual_WaitWakeState: int) returns (Tmp_252: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 1066} status_16 := sdv_IoAcquireRemoveLock(0, 0);
    goto anon11_Then, anon11_Else;

  anon11_Else:
    assume {:partition} status_16 >= 0;
    call {:si_unique_call 1067} sdv_163 := ExAllocatePoolWithTag(512, 16, -1016831413);
    itemData := sdv_163;
    goto anon14_Then, anon14_Else;
  ...
  anon14_Else:
    ...
    assume itemData > 0;
    call {:si_unique_call 1068} boogieTmp := IoAllocateWorkItem(0);
    assume {:nonnull} itemData != 0;
    assume itemData > 0;
    goto anon12_Then, anon12_Else;
  ...
  anon12_Else:
    ...
    assume {:nonnull} itemData != 0;
    assume itemData > 0;
    call {:si_unique_call 1069} sdv_165 := sdv_KeGetCurrentIrql();
    goto anon13_Then, anon13_Else;
  ...
  anon13_Else:
    ...
    call {:si_unique_call 1070} IoQueueWorkItem(vslice_dummy_var_53, li2bplFunctionConstant671, 1, itemData);
    goto L39;
  ...
  anon13_Then:
    ...
    call {:si_unique_call 1071} KeyboardToggleWaitWakeWorker#0(vslice_dummy_var_54, itemData);
    goto anon15_Then, anon15_Else;
  ...
  anon12_Then:
    assume {:nonnull} Data_4 != 0;
    assume Data_4 > 0;
    call {:si_unique_call 1072} vslice_dummy_var_123 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(Data_4), li2bplFunctionConstant671);
    goto L39;
  ...
  anon14_Then:
    ...
    assume {:nonnull} Data_4 != 0;
    assume Data_4 > 0;
    call {:si_unique_call 1073} vslice_dummy_var_122 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(Data_4), li2bplFunctionConstant671);
    goto L39;
...
implementation {:origName "KeyboardToggleWaitWake"} KeyboardToggleWaitWake#1(actual_Data_4: int, actual_WaitWakeState: int) returns (Tmp_252: int)
{
  ...
  anon0:
    Data_4 := actual_Data_4;
    WaitWakeState := actual_WaitWakeState;
    call {:si_unique_call 1074} status_16 := sdv_IoAcquireRemoveLock(0, 0);
    goto anon11_Then, anon11_Else;

  anon11_Else:
    assume {:partition} status_16 >= 0;
    call {:si_unique_call 1075} sdv_163 := ExAllocatePoolWithTag(512, 16, -1016831413);
    itemData := sdv_163;
    goto anon14_Then, anon14_Else;
  ...
  anon14_Else:
    ...
    assume {:nonnull} itemData != 0;
    assume itemData > 0;
    call {:si_unique_call 1076} boogieTmp := IoAllocateWorkItem(0);
    assume {:nonnull} itemData != 0;
    assume itemData > 0;
    goto anon12_Then, anon12_Else;
  ...
  anon12_Else:
    ...
    assume {:nonnull} itemData != 0;
    assume itemData > 0;
    call {:si_unique_call 1077} sdv_165 := sdv_KeGetCurrentIrql();
    goto anon13_Then, anon13_Else;
  ...
  anon13_Else:
    ...
    call {:si_unique_call 1078} IoQueueWorkItem(vslice_dummy_var_55, li2bplFunctionConstant671, 1, itemData);
    goto L39;
  ...
  anon13_Then:
    ...
    call {:si_unique_call 1079} KeyboardToggleWaitWakeWorker#1(vslice_dummy_var_56, itemData);
    goto anon15_Then, anon15_Else;
  ...
  anon12_Then:
    assume {:nonnull} Data_4 != 0;
    assume Data_4 > 0;
    call {:si_unique_call 1080} vslice_dummy_var_125 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(Data_4), li2bplFunctionConstant671);
    goto L39;
  ...
  anon14_Then:
    ...
    assume {:nonnull} Data_4 != 0;
    assume Data_4 > 0;
    call {:si_unique_call 1081} vslice_dummy_var_124 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(Data_4), li2bplFunctionConstant671);
    goto L39;
...
implementation {:origName "KeyboardToggleWaitWakeWorker"} KeyboardToggleWaitWakeWorker#0(actual_DeviceObject_30: int, actual_ItemData: int)
{
  ...
  anon0:
    call {:si_unique_call 1082} strEnable := __HAVOC_malloc(12);
    call {:si_unique_call 1083} vslice_dummy_var_126 := __HAVOC_malloc(4);
    ItemData := actual_ItemData;
    call {:si_unique_call 1084} Tmp_308 := __HAVOC_malloc(64);
    waitWakeIrp_1 := 0;
    assume {:nonnull} ItemData != 0;
    assume ItemData > 0;
    goto anon25_Then, anon25_Else;
  ...
  L11:
    ...
    assume ItemData > 0;
    havoc data_7;
    call {:si_unique_call 1085} Tmp_310 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_310 != 0;
    assume Tmp_310 > 0;
    call {:si_unique_call 1086} sdv_KeAcquireSpinLock(0, Tmp_310);
    assume {:nonnull} Tmp_310 != 0;
    assume Tmp_310 > 0;
    havoc irql_3;
  ...
  anon26_Else:
    assume {:nonnull} data_7 != 0;
    assume data_7 > 0;
    call {:si_unique_call 1087} sdv_218 := _InlineInterlockedExchangePointer(WaitWakeIrp__DEVICE_EXTENSION(data_7), 0);
    waitWakeIrp_1 := sdv_218;
    goto L24;
  ...
  L19:
    call {:si_unique_call 1088} sdv_KeReleaseSpinLock(0, irql_3);
    goto anon20_Then, anon20_Else;

  anon20_Else:
    assume {:partition} toggled != 0;
    call {:si_unique_call 1089} sdv_220 := IoOpenDeviceRegistryKey(0, 1, 2031616, 0);
    goto anon22_Then, anon22_Else;

  anon22_Else:
    assume {:partition} sdv_220 >= 0;
    Tmp_308 := strConst__li2bpl3;
    call {:si_unique_call 1090} RtlInitUnicodeString(strEnable, Tmp_308);
    call {:si_unique_call 1091} vslice_dummy_var_127 := ZwSetValueKey(0, 0, 0, 4, 0, 4);
    call {:si_unique_call 1092} vslice_dummy_var_128 := ZwClose(0);
    goto L30;
  ...
  anon24_Else:
    ...
    call {:si_unique_call 1093} vslice_dummy_var_129 := KeyboardClassCreateWaitWakeIrp#0(data_7);
    goto anon27_Then, anon27_Else;
  ...
  anon23_Else:
    ...
    call {:si_unique_call 1094} vslice_dummy_var_131 := IoCancelIrp(0);
    goto L53;

  L53:
    assume {:nonnull} data_7 != 0;
    assume data_7 > 0;
    call {:si_unique_call 1095} vslice_dummy_var_130 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(data_7), li2bplFunctionConstant671);
    call {:si_unique_call 1096} IoFreeWorkItem(0);
...
implementation {:origName "KeyboardToggleWaitWakeWorker"} KeyboardToggleWaitWakeWorker#1(actual_DeviceObject_30: int, actual_ItemData: int)
{
  ...
  anon0:
    call {:si_unique_call 1098} strEnable := __HAVOC_malloc(12);
    call {:si_unique_call 1099} vslice_dummy_var_132 := __HAVOC_malloc(4);
    ItemData := actual_ItemData;
    call {:si_unique_call 1100} Tmp_308 := __HAVOC_malloc(64);
    waitWakeIrp_1 := 0;
    assume {:nonnull} ItemData != 0;
    assume ItemData > 0;
    goto anon25_Then, anon25_Else;
  ...
  L11:
    ...
    assume ItemData > 0;
    havoc data_7;
    call {:si_unique_call 1101} Tmp_310 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_310 != 0;
    assume Tmp_310 > 0;
    call {:si_unique_call 1102} sdv_KeAcquireSpinLock(0, Tmp_310);
    assume {:nonnull} Tmp_310 != 0;
    assume Tmp_310 > 0;
    havoc irql_3;
    assume {:nonnull} data_7 != 0;
  ...
  anon26_Else:
    assume {:nonnull} data_7 != 0;
    assume data_7 > 0;
    call {:si_unique_call 1103} sdv_218 := _InlineInterlockedExchangePointer(WaitWakeIrp__DEVICE_EXTENSION(data_7), 0);
    waitWakeIrp_1 := sdv_218;
    goto L24;
  ...
  L19:
    call {:si_unique_call 1104} sdv_KeReleaseSpinLock(0, irql_3);
    goto anon20_Then, anon20_Else;

  anon20_Else:
    assume {:partition} toggled != 0;
    call {:si_unique_call 1105} sdv_220 := IoOpenDeviceRegistryKey(0, 1, 2031616, 0);
    goto anon22_Then, anon22_Else;

  anon22_Else:
    assume {:partition} sdv_220 >= 0;
    Tmp_308 := strConst__li2bpl3;
    call {:si_unique_call 1106} RtlInitUnicodeString(strEnable, Tmp_308);
    call {:si_unique_call 1107} vslice_dummy_var_133 := ZwSetValueKey(0, 0, 0, 4, 0, 4);
    call {:si_unique_call 1108} vslice_dummy_var_134 := ZwClose(0);
    goto L30;
  ...
  anon24_Else:
    assume {:partition} wwState != 0;
    call {:si_unique_call 1109} vslice_dummy_var_135 := KeyboardClassCreateWaitWakeIrp#1(data_7);
    goto anon27_Then, anon27_Else;
  ...
  anon23_Else:
    assume {:partition} waitWakeIrp_1 != 0;
    call {:si_unique_call 1110} vslice_dummy_var_137 := IoCancelIrp(0);
    goto L53;

  L53:
    assume {:nonnull} data_7 != 0;
    assume data_7 > 0;
    call {:si_unique_call 1111} vslice_dummy_var_136 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(data_7), li2bplFunctionConstant671);
    call {:si_unique_call 1112} IoFreeWorkItem(0);
...
implementation {:origName "KeyboardClassCreateWaitWakeIrp"} KeyboardClassCreateWaitWakeIrp#0(actual_Data_5: int) returns (Tmp_266: int)
{
  ...
  anon0:
    call {:si_unique_call 1114} powerState_4 := __HAVOC_malloc(8);
    Data_5 := actual_Data_5;
    success := 1;
    call {:si_unique_call 1115} sdv_do_paged_code_check();
    assume {:nonnull} Data_5 != 0;
    assume Data_5 > 0;
...
implementation {:origName "KeyboardClassCreateWaitWakeIrp"} KeyboardClassCreateWaitWakeIrp#1(actual_Data_5: int) returns (Tmp_266: int)
{
  ...
  anon0:
    call {:si_unique_call 1116} powerState_4 := __HAVOC_malloc(8);
    Data_5 := actual_Data_5;
    success := 1;
    ...
    call {:si_unique_call 1118} status_19 := PoRequestPowerIrp#0(vslice_dummy_var_57, 0, powerState_4, li2bplFunctionConstant668, Data_5, 0);
    goto anon6_Then, anon6_Else;
...
implementation KeyboardClassClose_loop_L39(in_i: int, in_someEnableDisableSucceeded: int, in_Tmp_167: int, in_notifyHandle: int, in_port: int, in_Tmp_168: int, in_enabled: int, in_status_4: int, in_DeviceObject_14: int, in_Irp_7: int, in_vslice_dummy_var_38: int) returns (out_i: int, out_someEnableDisableSucceeded: int, out_Tmp_167: int, out_notifyHandle: int, out_port: int, out_Tmp_168: int, out_enabled: int, out_status_4: int, out_vslice_dummy_var_38: int)
{
  ...
  anon47_Then:
    ...
    assume {:nonnull} out_port != 0;
    assume out_port > 0;
    call {:si_unique_call 1121} ExReleaseFastMutex(0);
    goto anon37_Then, anon37_Else;
  ...
  anon37_Else:
    ...
    call {:si_unique_call 1124} out_notifyHandle := _InlineInterlockedExchangePointer(TargetNotifyHandle__DEVICE_EXTENSION(out_Tmp_168), 0);
    goto anon39_Then, anon39_Else;

  anon39_Else:
    assume {:partition} out_notifyHandle != 0;
    call {:si_unique_call 1123} out_vslice_dummy_var_38 := IoUnregisterPlugPlayNotification(0);
    goto L59;
  ...
  L59:
    ...
    call {:si_unique_call 1122} out_status_4 := KbdEnableDisablePort(0, in_Irp_7, vslice_dummy_var_58, File__PORT(out_port));
    goto anon48_Else;
  ...
  L70:
    call {:si_unique_call 1119} ExAcquireFastMutex(0);
    goto L47;

  anon38_Then:
    assume {:partition} 0 > out_status_4;
    call {:si_unique_call 1120} KeyboardClassLogError(in_DeviceObject_14, -1073414134, 10120, out_status_4, 0, 0, 0);
    goto L70;
...
implementation KeyboardClassDequeueReadByFileObject_loop_L14(in_oldCancelRoutine: int, in_sdv_94: int, in_irp: int, in_entry: int, in_stack: int, in_FileObject_1: int, in_vslice_dummy_var_40: int) returns (out_oldCancelRoutine: int, out_sdv_94: int, out_irp: int, out_entry: int, out_stack: int, out_vslice_dummy_var_40: int)
{

  entry:
    out_oldCancelRoutine, out_sdv_94, out_irp, out_entry, out_stack, out_vslice_dummy_var_40 := in_oldCancelRoutine, in_sdv_94, in_irp, in_entry, in_stack, in_vslice_dummy_var_40;
    goto L14, exit;
  ...
  anon9_Else:
    call {:si_unique_call 1127} out_sdv_94 := sdv_containing_record(out_entry, 88);
    out_irp := out_sdv_94;
    call {:si_unique_call 1128} out_stack := sdv_IoGetCurrentIrpStackLocation(out_irp);
    assume {:nonnull} out_stack != 0;
    assume out_stack > 0;
    goto anon10_Then, anon10_Else;

  anon10_Else:
    call {:si_unique_call 1129} out_vslice_dummy_var_40 := sdv_RemoveEntryList(0);
    call {:si_unique_call 1130} out_oldCancelRoutine := sdv_IoSetCancelRoutine(out_irp, 0);
    goto anon11_Then;
  ...
  anon11_Then:
    ...
    assume out_irp > 0;
    call {:si_unique_call 1126} InitializeListHead(ListEntry_unnamed_tag_6(Overlay_unnamed_tag_5(Tail__IRP(out_irp))));
    goto L25;
  ...
  L25_dummy:
    call {:si_unique_call 1131} {:si_old_unique_call 1} out_oldCancelRoutine, out_sdv_94, out_irp, out_entry, out_stack, out_vslice_dummy_var_40 := KeyboardClassDequeueReadByFileObject_loop_L14(out_oldCancelRoutine, out_sdv_94, out_irp, out_entry, out_stack, in_FileObject_1, out_vslice_dummy_var_40);
    return;
...
procedure {:LoopProcedure} KeyboardClassDequeueReadByFileObject_loop_L14(in_oldCancelRoutine: int, in_sdv_94: int, in_irp: int, in_entry: int, in_stack: int, in_FileObject_1: int, in_vslice_dummy_var_40: int) returns (out_oldCancelRoutine: int, out_sdv_94: int, out_irp: int, out_entry: int, out_stack: int, out_vslice_dummy_var_40: int);
  modifies alloc;
  free ensures {:va_keep} out_vslice_dummy_var_40 == 1 || out_vslice_dummy_var_40 == 0 || out_vslice_dummy_var_40 == in_vslice_dummy_var_40;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} false || old(SignalState) == 2 || old(SignalState) == 0;
  free ensures {:va_keep} false || old(completion_state) == 1 || old(completion_state) == 0;
  free ensures {:va_keep} false || old(signal_location) == 1 || old(signal_location) == 0;
...
implementation KeyboardClassCreate_loop_L67(in_i_1: int, in_someEnableDisableSucceeded_1: int, in_irpSp_3: int, in_port_1: int, in_Tmp_181: int, in_enabled_1: int, in_status_6: int, in_DeviceObject_15: int, in_Irp_9: int) returns (out_i_1: int, out_someEnableDisableSucceeded_1: int, out_port_1: int, out_Tmp_181: int, out_enabled_1: int, out_status_6: int)
{
  ...
  L75_dummy:
    call {:si_unique_call 1136} {:si_old_unique_call 1} out_i_1, out_someEnableDisableSucceeded_1, out_port_1, out_Tmp_181, out_enabled_1, out_status_6 := KeyboardClassCreate_loop_L67(out_i_1, out_someEnableDisableSucceeded_1, in_irpSp_3, out_port_1, out_Tmp_181, out_enabled_1, out_status_6, in_DeviceObject_15, in_Irp_9);
    return;
  ...
  anon57_Then:
    ...
    assume {:nonnull} out_port_1 != 0;
    assume out_port_1 > 0;
    call {:si_unique_call 1135} ExReleaseFastMutex(0);
    goto anon50_Then, anon50_Else;
  ...
  L89:
    call {:si_unique_call 1132} ExAcquireFastMutex(0);
    goto L75;
  ...
  anon51_Then:
    ...
    call {:si_unique_call 1133} KeyboardClassLogError(in_DeviceObject_15, -1073414135, 10120, out_status_6, 0, 0, vslice_dummy_var_59);
    assume {:nonnull} out_port_1 != 0;
    assume out_port_1 > 0;
    goto L89;
  ...
  anon50_Then:
    ...
    call {:si_unique_call 1134} out_status_6 := KbdEnableDisablePort(1, in_Irp_9, vslice_dummy_var_60, File__PORT(out_port_1));
    goto anon58_Else;
...
implementation KeyboardClassCleanupQueue_loop_L27(in_listHead: int, in_sdv_120: int, in_sdv_122: int, in_irp_1: int, in_entry_1: int, in_DeviceExtension_2: int, in_vslice_dummy_var_50: int) returns (out_sdv_120: int, out_sdv_122: int, out_irp_1: int, out_entry_1: int, out_vslice_dummy_var_50: int)
{

  entry:
    out_sdv_120, out_sdv_122, out_irp_1, out_entry_1, out_vslice_dummy_var_50 := in_sdv_120, in_sdv_122, in_irp_1, in_entry_1, in_vslice_dummy_var_50;
    goto L27, exit;
  ...
  L27:
    call {:si_unique_call 1137} out_sdv_120 := sdv_IsListEmpty(0);
    goto anon9_Else;

  anon9_Else:
    assume {:partition} out_sdv_120 == 0;
    call {:si_unique_call 1138} out_entry_1 := RemoveHeadList(in_listHead);
    call {:si_unique_call 1139} out_sdv_122 := sdv_containing_record(out_entry_1, 88);
    out_irp_1 := out_sdv_122;
    call {:si_unique_call 1140} sdv_IoCompleteRequest(0, 0);
    assume {:nonnull} in_DeviceExtension_2 != 0;
    assume in_DeviceExtension_2 > 0;
    call {:si_unique_call 1141} out_vslice_dummy_var_50 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(in_DeviceExtension_2), out_irp_1);
    goto anon9_Else_dummy;

  anon9_Else_dummy:
    call {:si_unique_call 1142} {:si_old_unique_call 1} out_sdv_120, out_sdv_122, out_irp_1, out_entry_1, out_vslice_dummy_var_50 := KeyboardClassCleanupQueue_loop_L27(in_listHead, out_sdv_120, out_sdv_122, out_irp_1, out_entry_1, in_DeviceExtension_2, out_vslice_dummy_var_50);
    return;
}



procedure {:LoopProcedure} KeyboardClassCleanupQueue_loop_L27(in_listHead: int, in_sdv_120: int, in_sdv_122: int, in_irp_1: int, in_entry_1: int, in_DeviceExtension_2: int, in_vslice_dummy_var_50: int) returns (out_sdv_120: int, out_sdv_122: int, out_irp_1: int, out_entry_1: int, out_vslice_dummy_var_50: int);
  modifies alloc;
  free ensures {:va_keep} out_sdv_120 == 1 || out_sdv_120 == 0 || out_sdv_120 == in_sdv_120;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} false || old(SignalState) == 2 || old(SignalState) == 0;
  free ensures {:va_keep} false || old(completion_state) == 1 || old(completion_state) == 0;
  free ensures {:va_keep} false || old(signal_location) == 1 || old(signal_location) == 0;
...
implementation KeyboardClassCleanupQueue_loop_L13(in_listHead: int, in_irp_1: int, in_DeviceExtension_2: int, in_FileObject_2: int, in_vslice_dummy_var_51: int) returns (out_irp_1: int, out_vslice_dummy_var_51: int)
{
  ...
  L13:
    call {:si_unique_call 1143} out_irp_1 := KeyboardClassDequeueReadByFileObject(in_DeviceExtension_2, in_FileObject_2);
    goto anon7_Then, anon7_Else;
  ...
  anon7_Else:
    ...
    assume {:nonnull} out_irp_1 != 0;
    assume out_irp_1 > 0;
    call {:si_unique_call 1144} out_vslice_dummy_var_51 := sdv_InsertTailList(in_listHead, ListEntry_unnamed_tag_6(Overlay_unnamed_tag_5(Tail__IRP(out_irp_1))));
    goto L18;
  ...
  anon8_Then_dummy:
    call {:si_unique_call 1145} {:si_old_unique_call 1} out_irp_1, out_vslice_dummy_var_51 := KeyboardClassCleanupQueue_loop_L13(in_listHead, out_irp_1, in_DeviceExtension_2, in_FileObject_2, out_vslice_dummy_var_51);
    return;
...
implementation KeyboardClassLogError_loop_L20(in_i_2: int, in_Tmp_223: int, in_errorLogEntry: int, in_Tmp_225: int, in_Tmp_226: int, in_DumpCount: int, in_DumpData: int) returns (out_i_2: int, out_Tmp_223: int, out_Tmp_225: int, out_Tmp_226: int)
{
  ...
  anon5_Else_dummy:
    call {:si_unique_call 1146} {:si_old_unique_call 1} out_i_2, out_Tmp_223, out_Tmp_225, out_Tmp_226 := KeyboardClassLogError_loop_L20(out_i_2, out_Tmp_223, in_errorLogEntry, out_Tmp_225, out_Tmp_226, in_DumpCount, in_DumpData);
    return;
}
...
implementation KeyboardClassDequeueRead_loop_L6(in_sdv_166: int, in_listEntry: int, in_oldCancelRoutine_2: int, in_sdv_168: int, in_nextIrp: int, in_DeviceExtension_4: int) returns (out_sdv_166: int, out_listEntry: int, out_oldCancelRoutine_2: int, out_sdv_168: int, out_nextIrp: int)
{

  entry:
    out_sdv_166, out_listEntry, out_oldCancelRoutine_2, out_sdv_168, out_nextIrp := in_sdv_166, in_listEntry, in_oldCancelRoutine_2, in_sdv_168, in_nextIrp;
    goto L6, exit;
  ...
  anon7_Then:
    ...
    call {:si_unique_call 1151} out_sdv_166 := sdv_IsListEmpty(0);
    goto anon8_Else;
  ...
  anon8_Else:
    ...
    call {:si_unique_call 1148} out_listEntry := RemoveHeadList(ReadQueue__DEVICE_EXTENSION(in_DeviceExtension_4));
    call {:si_unique_call 1149} out_sdv_168 := sdv_containing_record(out_listEntry, 88);
    out_nextIrp := out_sdv_168;
    call {:si_unique_call 1150} out_oldCancelRoutine_2 := sdv_IoSetCancelRoutine(out_nextIrp, 0);
    goto anon9_Then, anon9_Else;
  ...
  anon9_Else:
    ...
    call {:si_unique_call 1147} InitializeListHead(ListEntry_unnamed_tag_6(Overlay_unnamed_tag_5(Tail__IRP(out_nextIrp))));
    out_nextIrp := 0;
    goto anon9_Else_dummy;
  ...
  L_BAF_0:
    call {:si_unique_call 1152} {:si_old_unique_call 1} out_sdv_166, out_listEntry, out_oldCancelRoutine_2, out_sdv_168, out_nextIrp := KeyboardClassDequeueRead_loop_L6(out_sdv_166, out_listEntry, out_oldCancelRoutine_2, out_sdv_168, out_nextIrp, in_DeviceExtension_4);
    return;
...
procedure {:LoopProcedure} KeyboardClassDequeueRead_loop_L6(in_sdv_166: int, in_listEntry: int, in_oldCancelRoutine_2: int, in_sdv_168: int, in_nextIrp: int, in_DeviceExtension_4: int) returns (out_sdv_166: int, out_listEntry: int, out_oldCancelRoutine_2: int, out_sdv_168: int, out_nextIrp: int);
  modifies alloc;
...
implementation KeyboardClassDeviceControl_loop_L145(in_i_3: int, in_Tmp_277: int, in_Tmp_279: int, in_Tmp_280: int, in_Tmp_283: int, in_Tmp_284: int, in_Tmp_286: int, in_Tmp_294: int, in_Tmp_295: int, in_Tmp_297: int, in_status_21: int, in_Tmp_298: int, in_callAll: int, in_Tmp_299: int, in_Tmp_300: int) returns (out_i_3: int, out_Tmp_277: int, out_Tmp_279: int, out_Tmp_280: int, out_Tmp_283: int, out_Tmp_284: int, out_Tmp_286: int, out_Tmp_294: int, out_Tmp_295: int, out_Tmp_297: int, out_status_21: int, out_Tmp_298: int, out_Tmp_299: int, out_Tmp_300: int)
{
  ...
  anon153_Else:
    ...
    call {:si_unique_call 1153} out_status_21 := sdv_IoAcquireRemoveLock(0, 0);
    goto L151;
...
implementation KeyboardCallAllPorts#0_loop_L16(in_Tmp_190: int, in_Tmp_192: int, in_Tmp_193: int, in_Tmp_194: int, in_Tmp_195: int, in_Tmp_196: int, in_CallAll: int) returns (out_Tmp_190: int, out_Tmp_192: int, out_Tmp_193: int, out_Tmp_194: int, out_Tmp_195: int, out_Tmp_196: int)
{
  ...
  L19_dummy:
    call {:si_unique_call 1155} {:si_old_unique_call 1} out_Tmp_190, out_Tmp_192, out_Tmp_193, out_Tmp_194, out_Tmp_195, out_Tmp_196 := KeyboardCallAllPorts#0_loop_L16(out_Tmp_190, out_Tmp_192, out_Tmp_193, out_Tmp_194, out_Tmp_195, out_Tmp_196, in_CallAll);
    return;
...
implementation KeyboardCallAllPorts#1_loop_L16(in_Tmp_190: int, in_Tmp_192: int, in_Tmp_193: int, in_Tmp_194: int, in_Tmp_195: int, in_Tmp_196: int, in_CallAll: int) returns (out_Tmp_190: int, out_Tmp_192: int, out_Tmp_193: int, out_Tmp_194: int, out_Tmp_195: int, out_Tmp_196: int)
{
  ...
  L19_dummy:
    call {:si_unique_call 1156} {:si_old_unique_call 1} out_Tmp_190, out_Tmp_192, out_Tmp_193, out_Tmp_194, out_Tmp_195, out_Tmp_196 := KeyboardCallAllPorts#1_loop_L16(out_Tmp_190, out_Tmp_192, out_Tmp_193, out_Tmp_194, out_Tmp_195, out_Tmp_196, in_CallAll);
    return;
