...
procedure {:origName "SLIC_sdv_RunSurpriseRemoveDevice_exit"} {:osmodel} SLIC_sdv_RunSurpriseRemoveDevice_exit(actual_caller_1: int, actual_sdv_10: int, actual_sdv_11: int);
  modifies yogi_error;
...
implementation {:origName "SLIC_sdv_RunSurpriseRemoveDevice_exit"} {:osmodel} SLIC_sdv_RunSurpriseRemoveDevice_exit(actual_caller_1: int, actual_sdv_10: int, actual_sdv_11: int)
{
...
implementation {:origName "PmDetermineDeviceNameAndNumber"} PmDetermineDeviceNameAndNumber(actual_DeviceObject_1: int, actual_WmiRegistrationFlags_1: int) returns (Tmp_16: int)
{
  ...
  anon9_Else:
    ...
    call {:si_unique_call 32} status_1 := sdv_IoCallDriver(vslice_dummy_var_1233, irp);
...
implementation {:origName "sdv_RunSurpriseRemoveDevice"} {:osmodel} sdv_RunSurpriseRemoveDevice(actual_po: int, actual_pirp: int) returns (Tmp_44: int)
{
  ...
  anon0:
    ...
    Tmp_44 := status_2;
    call {:si_unique_call 40} SLIC_sdv_RunSurpriseRemoveDevice_exit(strConst__li2bpl4, pirp, Tmp_44);
    goto anon3_Then, anon3_Else;
...
implementation {:origName "sdv_IoInitializeRemoveLock"} {:osmodel} sdv_IoInitializeRemoveLock(actual_Lock: int, actual_AllocateTag: int, actual_MaxLockedMinutes: int, actual_HighWatermark: int)
{
  ...
  anon0:
    call {:si_unique_call 42} vslice_dummy_var_8 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "sdv_RunAddDevice"} {:osmodel} sdv_RunAddDevice(actual_p1: int, actual_p2: int) returns (Tmp_52: int)
{
  ...
  anon0:
    ...
    p2 := actual_p2;
    status_3 := 0;
    call {:si_unique_call 43} sdv_stub_add_begin();
    call {:si_unique_call 44} status_3 := PmAddDevice(p1, p2);
    call {:si_unique_call 45} sdv_stub_add_end();
    Tmp_52 := status_3;
    return;
}
...
implementation {:origName "sdv_IoAdjustPagingPathCount"} {:osmodel} sdv_IoAdjustPagingPathCount(actual_Count: int, actual_Increment: int)
{
  ...
  anon0:
    call {:si_unique_call 48} vslice_dummy_var_11 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "sdv_stub_dispatch_end"} {:osmodel} sdv_stub_dispatch_end(actual_s: int, actual_pirp_4: int)
{
  ...
  anon0:
    call {:si_unique_call 49} vslice_dummy_var_12 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "sdv_main"} {:osmodel} sdv_main()
{
  ...
  anon0:
    call {:si_unique_call 51} vslice_dummy_var_14 := __HAVOC_malloc(4);
    call {:si_unique_call 52} u := __HAVOC_malloc(12);
    assume {:nonnull} sdv_p_devobj_fdo != 0;
    assume sdv_p_devobj_fdo > 0;
    assume {:nonnull} sdv_p_devobj_child_pdo != 0;
    assume sdv_p_devobj_child_pdo > 0;
    call {:si_unique_call 53} status_4 := DriverEntry(sdv_driver_object, u);
    goto anon8_Then, anon8_Else;
  ...
  L68:
    assume Tmp_79 != 0;
    call {:si_unique_call 54} status_4 := sdv_RunAddDevice(sdv_driver_object, sdv_p_devobj_pdo);
    goto anon7_Then, anon7_Else;
  ...
  L78:
    assume Tmp_77 != 0;
    call {:si_unique_call 55} sdv_stub_driver_init();
    call {:si_unique_call 56} status_4 := sdv_RunSurpriseRemoveDevice(sdv_p_devobj_fdo, sdv_irp);
    goto anon9_Then, anon9_Else;

  anon9_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 57} status_4 := sdv_RunRemoveDevice(sdv_p_devobj_fdo, sdv_irp);
    goto LM2;
...
implementation {:origName "IoAllocateErrorLogEntry"} {:osmodel} IoAllocateErrorLogEntry(actual_IoObject: int, actual_EntrySize: int) returns (Tmp_80: int)
{
  ...
  anon3_Else:
    call {:si_unique_call 58} sdv_72 := __HAVOC_malloc(1);
    Tmp_80 := sdv_72;
    goto L1;
...
implementation {:origName "IoWriteErrorLogEntry"} {:osmodel} IoWriteErrorLogEntry(actual_ElEntry: int)
{
  ...
  anon0:
    call {:si_unique_call 59} vslice_dummy_var_15 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "sdv_IoSetCompletionRoutine"} {:osmodel} sdv_IoSetCompletionRoutine(actual_pirp_6: int, actual_CompletionRoutine: int, actual_Context_1: int, actual_InvokeOnSuccess: int, actual_InvokeOnError: int, actual_InvokeOnCancel: int)
{
  ...
  anon0:
    call {:si_unique_call 60} vslice_dummy_var_16 := __HAVOC_malloc(4);
...
implementation {:origName "IoDeleteDevice"} {:osmodel} IoDeleteDevice(actual_DeviceObject_5: int)
{
  ...
  anon0:
    call {:si_unique_call 63} vslice_dummy_var_18 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "_sdv_init4"} {:osmodel} _sdv_init4()
{
  ...
  anon0:
    call {:si_unique_call 64} vslice_dummy_var_19 := __HAVOC_malloc(4);
...
implementation {:origName "IoReleaseCancelSpinLock"} {:osmodel} IoReleaseCancelSpinLock(actual_new: int)
{
  ...
  anon0:
    call {:si_unique_call 65} vslice_dummy_var_20 := __HAVOC_malloc(4);
    new := actual_new;
    return;
}
...
implementation {:origName "main"} {:osmodel} main() returns (Tmp_114: int, dup_assertVar: bool)
{
  ...
  anon0:
    ...
    call {:si_unique_call 67} THERMAL_ZONE_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume THERMAL_ZONE_GUID__Loc == THERMAL_ZONE_GUID;
    assume THERMAL_ZONE_GUID != 0;
    call {:si_unique_call 68} DbgPrintGuid__Loc := __HAVOC_malloc_or_null(16);
    assume DbgPrintGuid__Loc == DbgPrintGuid;
    assume DbgPrintGuid != 0;
    call {:si_unique_call 69} GenericMessageGuid__Loc := __HAVOC_malloc_or_null(16);
    assume GenericMessageGuid__Loc == GenericMessageGuid;
    assume GenericMessageGuid != 0;
    call {:si_unique_call 70} MS_SYSTEM_INFORMATION_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MS_SYSTEM_INFORMATION_GUID__Loc == MS_SYSTEM_INFORMATION_GUID;
    assume MS_SYSTEM_INFORMATION_GUID != 0;
    call {:si_unique_call 71} DiskPerfGuid__Loc := __HAVOC_malloc_or_null(16);
    assume DiskPerfGuid__Loc == DiskPerfGuid;
    assume DiskPerfGuid != 0;
    call {:si_unique_call 72} PageFaultGuid__Loc := __HAVOC_malloc_or_null(16);
    assume PageFaultGuid__Loc == PageFaultGuid;
    assume PageFaultGuid != 0;
    call {:si_unique_call 73} ApplicationVerifierGuid__Loc := __HAVOC_malloc_or_null(16);
    assume ApplicationVerifierGuid__Loc == ApplicationVerifierGuid;
    assume ApplicationVerifierGuid != 0;
    call {:si_unique_call 74} TraceErrorGuid__Loc := __HAVOC_malloc_or_null(16);
    assume TraceErrorGuid__Loc == TraceErrorGuid;
    assume TraceErrorGuid != 0;
    call {:si_unique_call 75} GlobalLoggerGuid__Loc := __HAVOC_malloc_or_null(16);
    assume GlobalLoggerGuid__Loc == GlobalLoggerGuid;
    assume GlobalLoggerGuid != 0;
    call {:si_unique_call 76} EventLogGuid__Loc := __HAVOC_malloc_or_null(16);
    assume EventLogGuid__Loc == EventLogGuid;
    assume EventLogGuid != 0;
    call {:si_unique_call 77} TcpIpGuid__Loc := __HAVOC_malloc_or_null(16);
    assume TcpIpGuid__Loc == TcpIpGuid;
    assume TcpIpGuid != 0;
    call {:si_unique_call 78} FileIoGuid__Loc := __HAVOC_malloc_or_null(16);
    assume FileIoGuid__Loc == FileIoGuid;
    assume FileIoGuid != 0;
    call {:si_unique_call 79} UdpIpGuid__Loc := __HAVOC_malloc_or_null(16);
    assume UdpIpGuid__Loc == UdpIpGuid;
    assume UdpIpGuid != 0;
    call {:si_unique_call 80} WmiEventLoggerGuid__Loc := __HAVOC_malloc_or_null(16);
    assume WmiEventLoggerGuid__Loc == WmiEventLoggerGuid;
    assume WmiEventLoggerGuid != 0;
    call {:si_unique_call 81} ThreadGuid__Loc := __HAVOC_malloc_or_null(16);
    assume ThreadGuid__Loc == ThreadGuid;
    assume ThreadGuid != 0;
    call {:si_unique_call 82} ImageLoadGuid__Loc := __HAVOC_malloc_or_null(16);
    assume ImageLoadGuid__Loc == ImageLoadGuid;
    assume ImageLoadGuid != 0;
    call {:si_unique_call 83} ProcessGuid__Loc := __HAVOC_malloc_or_null(16);
    assume ProcessGuid__Loc == ProcessGuid;
    assume ProcessGuid != 0;
    call {:si_unique_call 84} DiskIoGuid__Loc := __HAVOC_malloc_or_null(16);
    assume DiskIoGuid__Loc == DiskIoGuid;
    assume DiskIoGuid != 0;
    call {:si_unique_call 85} DriverVerifierGuid__Loc := __HAVOC_malloc_or_null(16);
    assume DriverVerifierGuid__Loc == DriverVerifierGuid;
    assume DriverVerifierGuid != 0;
    call {:si_unique_call 86} RegistryGuid__Loc := __HAVOC_malloc_or_null(16);
    assume RegistryGuid__Loc == RegistryGuid;
    assume RegistryGuid != 0;
    call {:si_unique_call 87} sdv_harnessStackLocation_next__Loc := __HAVOC_malloc_or_null(496);
    assume sdv_harnessStackLocation_next__Loc == sdv_harnessStackLocation_next;
    assume sdv_harnessStackLocation_next != 0;
    call {:si_unique_call 88} sdv_IoReadPartitionTableEx_DRIVE_LAYOUT_INFORMATION_EX__Loc := __HAVOC_malloc_or_null(76);
    assume sdv_IoReadPartitionTableEx_DRIVE_LAYOUT_INFORMATION_EX__Loc == sdv_IoReadPartitionTableEx_DRIVE_LAYOUT_INFORMATION_EX;
    assume sdv_IoReadPartitionTableEx_DRIVE_LAYOUT_INFORMATION_EX != 0;
    call {:si_unique_call 89} sdv_IoBuildAsynchronousFsdRequest_harnessIrp__Loc := __HAVOC_malloc_or_null(248);
    assume sdv_IoBuildAsynchronousFsdRequest_harnessIrp__Loc == sdv_IoBuildAsynchronousFsdRequest_harnessIrp;
    assume sdv_IoBuildAsynchronousFsdRequest_harnessIrp != 0;
    call {:si_unique_call 90} sdv_IoGetDeviceToVerify_DEVICE_OBJECT__Loc := __HAVOC_malloc_or_null(320);
    assume sdv_IoGetDeviceToVerify_DEVICE_OBJECT__Loc == sdv_IoGetDeviceToVerify_DEVICE_OBJECT;
    assume sdv_IoGetDeviceToVerify_DEVICE_OBJECT != 0;
    call {:si_unique_call 91} sdv_IoBuildDeviceIoControlRequest_harnessStackLocation_next__Loc := __HAVOC_malloc_or_null(496);
    assume sdv_IoBuildDeviceIoControlRequest_harnessStackLocation_next__Loc == sdv_IoBuildDeviceIoControlRequest_harnessStackLocation_next;
    assume sdv_IoBuildDeviceIoControlRequest_harnessStackLocation_next != 0;
    call {:si_unique_call 92} sdv_harness_IoBuildSynchronousFsdRequest_IoStatusBlock__Loc := __HAVOC_malloc_or_null(12);
    assume sdv_harness_IoBuildSynchronousFsdRequest_IoStatusBlock__Loc == sdv_harness_IoBuildSynchronousFsdRequest_IoStatusBlock;
    assume sdv_harness_IoBuildSynchronousFsdRequest_IoStatusBlock != 0;
    call {:si_unique_call 93} sdv_ControllerIrp__Loc := __HAVOC_malloc_or_null(248);
    assume sdv_ControllerIrp__Loc == sdv_ControllerIrp;
    assume sdv_ControllerIrp != 0;
    call {:si_unique_call 94} sdv_devobj_pdo__Loc := __HAVOC_malloc_or_null(320);
    assume sdv_devobj_pdo__Loc == sdv_devobj_pdo;
    assume sdv_devobj_pdo != 0;
    call {:si_unique_call 95} sdv_IoGetDmaAdapter_DMA_ADAPTER__Loc := __HAVOC_malloc_or_null(12);
    assume sdv_IoGetDmaAdapter_DMA_ADAPTER__Loc == sdv_IoGetDmaAdapter_DMA_ADAPTER;
    assume sdv_IoGetDmaAdapter_DMA_ADAPTER != 0;
    call {:si_unique_call 96} sdv_IoInitializeIrp_harnessIrp__Loc := __HAVOC_malloc_or_null(248);
    assume sdv_IoInitializeIrp_harnessIrp__Loc == sdv_IoInitializeIrp_harnessIrp;
    assume sdv_IoInitializeIrp_harnessIrp != 0;
    call {:si_unique_call 97} sdv_IoGetRelatedDeviceObject_DEVICE_OBJECT__Loc := __HAVOC_malloc_or_null(320);
    assume sdv_IoGetRelatedDeviceObject_DEVICE_OBJECT__Loc == sdv_IoGetRelatedDeviceObject_DEVICE_OBJECT;
    assume sdv_IoGetRelatedDeviceObject_DEVICE_OBJECT != 0;
    call {:si_unique_call 98} sdv_IoBuildSynchronousFsdRequest_harnessStackLocation_next__Loc := __HAVOC_malloc_or_null(496);
    assume sdv_IoBuildSynchronousFsdRequest_harnessStackLocation_next__Loc == sdv_IoBuildSynchronousFsdRequest_harnessStackLocation_next;
    assume sdv_IoBuildSynchronousFsdRequest_harnessStackLocation_next != 0;
    call {:si_unique_call 99} sdv_IoCreateSynchronizationEvent_KEVENT__Loc := __HAVOC_malloc_or_null(124);
    ...
    call {:si_unique_call 101} sdv_other_harnessStackLocation_next__Loc := __HAVOC_malloc_or_null(496);
    assume sdv_other_harnessStackLocation_next__Loc == sdv_other_harnessStackLocation_next;
    assume sdv_other_harnessStackLocation_next != 0;
    call {:si_unique_call 102} sdv_IoCreateController_CONTROLLER_OBJECT__Loc := __HAVOC_malloc_or_null(60);
    assume sdv_IoCreateController_CONTROLLER_OBJECT__Loc == sdv_IoCreateController_CONTROLLER_OBJECT;
    assume sdv_IoCreateController_CONTROLLER_OBJECT != 0;
    call {:si_unique_call 103} sdv_devobj_top__Loc := __HAVOC_malloc_or_null(320);
    assume sdv_devobj_top__Loc == sdv_devobj_top;
    assume sdv_devobj_top != 0;
    call {:si_unique_call 104} sdv_kdpc_val3__Loc := __HAVOC_malloc_or_null(40);
    assume sdv_kdpc_val3__Loc == sdv_kdpc_val3;
    assume sdv_kdpc_val3 != 0;
    call {:si_unique_call 105} sdv_IoBuildSynchronousFsdRequest_harnessIrp__Loc := __HAVOC_malloc_or_null(248);
    assume sdv_IoBuildSynchronousFsdRequest_harnessIrp__Loc == sdv_IoBuildSynchronousFsdRequest_harnessIrp;
    assume sdv_IoBuildSynchronousFsdRequest_harnessIrp != 0;
    call {:si_unique_call 106} sdv_IoGetDeviceObjectPointer_DEVICE_OBJECT__Loc := __HAVOC_malloc_or_null(320);
    assume sdv_IoGetDeviceObjectPointer_DEVICE_OBJECT__Loc == sdv_IoGetDeviceObjectPointer_DEVICE_OBJECT;
    assume sdv_IoGetDeviceObjectPointer_DEVICE_OBJECT != 0;
    call {:si_unique_call 107} sdv_driver_object__Loc := __HAVOC_malloc_or_null(68);
    assume sdv_driver_object__Loc == sdv_driver_object;
    assume sdv_driver_object != 0;
    call {:si_unique_call 108} sdv_MapRegisterBase_val__Loc := __HAVOC_malloc_or_null(4);
    assume sdv_MapRegisterBase_val__Loc == sdv_MapRegisterBase_val;
    assume sdv_MapRegisterBase_val != 0;
    call {:si_unique_call 109} sdv_IoGetFileObjectGenericMapping_GENERIC_MAPPING__Loc := __HAVOC_malloc_or_null(16);
    assume sdv_IoGetFileObjectGenericMapping_GENERIC_MAPPING__Loc == sdv_IoGetFileObjectGenericMapping_GENERIC_MAPPING;
    assume sdv_IoGetFileObjectGenericMapping_GENERIC_MAPPING != 0;
    call {:si_unique_call 110} sdv_IoMakeAssociatedIrp_harnessIrp__Loc := __HAVOC_malloc_or_null(248);
    assume sdv_IoMakeAssociatedIrp_harnessIrp__Loc == sdv_IoMakeAssociatedIrp_harnessIrp;
    assume sdv_IoMakeAssociatedIrp_harnessIrp != 0;
    call {:si_unique_call 111} sdv_devobj_child_pdo__Loc := __HAVOC_malloc_or_null(320);
    assume sdv_devobj_child_pdo__Loc == sdv_devobj_child_pdo;
    assume sdv_devobj_child_pdo != 0;
    call {:si_unique_call 112} sdv_harnessIrp__Loc := __HAVOC_malloc_or_null(248);
    assume sdv_harnessIrp__Loc == sdv_harnessIrp;
    assume sdv_harnessIrp != 0;
    call {:si_unique_call 113} sdv_IoBuildAsynchronousFsdRequest_harnessStackLocation_next__Loc := __HAVOC_malloc_or_null(496);
    assume sdv_IoBuildAsynchronousFsdRequest_harnessStackLocation_next__Loc == sdv_IoBuildAsynchronousFsdRequest_harnessStackLocation_next;
    assume sdv_IoBuildAsynchronousFsdRequest_harnessStackLocation_next != 0;
    call {:si_unique_call 114} sdv_harness_IoBuildDeviceIoControlRequest_IoStatusBlock__Loc := __HAVOC_malloc_or_null(12);
    assume sdv_harness_IoBuildDeviceIoControlRequest_IoStatusBlock__Loc == sdv_harness_IoBuildDeviceIoControlRequest_IoStatusBlock;
    assume sdv_harness_IoBuildDeviceIoControlRequest_IoStatusBlock != 0;
    call {:si_unique_call 115} sdv_kinterrupt_val__Loc := __HAVOC_malloc_or_null(0);
    assume sdv_kinterrupt_val__Loc == sdv_kinterrupt_val;
    assume sdv_kinterrupt_val != 0;
    call {:si_unique_call 116} sdv_devobj_fdo__Loc := __HAVOC_malloc_or_null(320);
    assume sdv_devobj_fdo__Loc == sdv_devobj_fdo;
    assume sdv_devobj_fdo != 0;
    call {:si_unique_call 117} sdv_StartIoIrp__Loc := __HAVOC_malloc_or_null(248);
    assume sdv_StartIoIrp__Loc == sdv_StartIoIrp;
    assume sdv_StartIoIrp != 0;
    call {:si_unique_call 118} sdv_harness_IoBuildAsynchronousFsdRequest_IoStatusBlock__Loc := __HAVOC_malloc_or_null(12);
    assume sdv_harness_IoBuildAsynchronousFsdRequest_IoStatusBlock__Loc == sdv_harness_IoBuildAsynchronousFsdRequest_IoStatusBlock;
    assume sdv_harness_IoBuildAsynchronousFsdRequest_IoStatusBlock != 0;
    call {:si_unique_call 119} sdv_PowerIrp__Loc := __HAVOC_malloc_or_null(248);
    assume sdv_PowerIrp__Loc == sdv_PowerIrp;
    assume sdv_PowerIrp != 0;
    call {:si_unique_call 120} sdv_IoBuildDeviceIoControlRequest_harnessIrp__Loc := __HAVOC_malloc_or_null(248);
    assume sdv_IoBuildDeviceIoControlRequest_harnessIrp__Loc == sdv_IoBuildDeviceIoControlRequest_harnessIrp;
    assume sdv_IoBuildDeviceIoControlRequest_harnessIrp != 0;
    call {:si_unique_call 121} sdv_other_harnessIrp__Loc := __HAVOC_malloc_or_null(248);
    assume sdv_other_harnessIrp__Loc == sdv_other_harnessIrp;
    assume sdv_other_harnessIrp != 0;
    call {:si_unique_call 122} sdv_IoCreateNotificationEvent_KEVENT__Loc := __HAVOC_malloc_or_null(124);
    assume sdv_IoCreateNotificationEvent_KEVENT__Loc == sdv_IoCreateNotificationEvent_KEVENT;
    assume sdv_IoCreateNotificationEvent_KEVENT != 0;
    call {:si_unique_call 123} sdv_other_harnessStackLocation__Loc := __HAVOC_malloc_or_null(496);
    assume sdv_other_harnessStackLocation__Loc == sdv_other_harnessStackLocation;
    assume sdv_other_harnessStackLocation != 0;
    call {:si_unique_call 124} PARTITION_SYSTEM_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume PARTITION_SYSTEM_GUID__Loc == PARTITION_SYSTEM_GUID;
    assume PARTITION_SYSTEM_GUID != 0;
    call {:si_unique_call 125} GUID_IO_VOLUME_DISMOUNT_FAILED__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_IO_VOLUME_DISMOUNT_FAILED__Loc == GUID_IO_VOLUME_DISMOUNT_FAILED;
    assume GUID_IO_VOLUME_DISMOUNT_FAILED != 0;
    call {:si_unique_call 126} PARTITION_LDM_DATA_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume PARTITION_LDM_DATA_GUID__Loc == PARTITION_LDM_DATA_GUID;
    assume PARTITION_LDM_DATA_GUID != 0;
    call {:si_unique_call 127} GUID_PCMCIA_BUS_INTERFACE_STANDARD__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 128} GUID_BUS_TYPE_PCMCIA__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_BUS_TYPE_PCMCIA__Loc == GUID_BUS_TYPE_PCMCIA;
    assume GUID_BUS_TYPE_PCMCIA != 0;
    call {:si_unique_call 129} PARTITION_BASIC_DATA_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 131} PARTITION_MSFT_RECOVERY_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 133} GUID_DEVINTERFACE_STORAGEPORT__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 135} PARTITION_ENTRY_UNUSED_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume PARTITION_ENTRY_UNUSED_GUID__Loc == PARTITION_ENTRY_UNUSED_GUID;
    assume PARTITION_ENTRY_UNUSED_GUID != 0;
    call {:si_unique_call 136} GUID_BUS_TYPE_1394__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_BUS_TYPE_1394__Loc == GUID_BUS_TYPE_1394;
    assume GUID_BUS_TYPE_1394 != 0;
    call {:si_unique_call 137} GUID_AGP_TARGET_BUS_INTERFACE_STANDARD__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 138} GUID_IO_DEVICE_EXTERNAL_REQUEST__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_IO_DEVICE_EXTERNAL_REQUEST__Loc == GUID_IO_DEVICE_EXTERNAL_REQUEST;
    assume GUID_IO_DEVICE_EXTERNAL_REQUEST != 0;
    call {:si_unique_call 139} GUID_DEVINTERFACE_WRITEONCEDISK__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_DEVINTERFACE_WRITEONCEDISK__Loc == GUID_DEVINTERFACE_WRITEONCEDISK;
    assume GUID_DEVINTERFACE_WRITEONCEDISK != 0;
    call {:si_unique_call 140} GUID_IO_VOLUME_FORCE_CLOSED__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_IO_VOLUME_FORCE_CLOSED__Loc == GUID_IO_VOLUME_FORCE_CLOSED;
    assume GUID_IO_VOLUME_FORCE_CLOSED != 0;
    call {:si_unique_call 141} GUID_TARGET_DEVICE_REMOVE_CANCELLED__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 156} GUID_IO_VOLUME_MOUNT__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_IO_VOLUME_MOUNT__Loc == GUID_IO_VOLUME_MOUNT;
    assume GUID_IO_VOLUME_MOUNT != 0;
    call {:si_unique_call 157} GUID_DEVINTERFACE_CDROM__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_DEVINTERFACE_CDROM__Loc == GUID_DEVINTERFACE_CDROM;
    assume GUID_DEVINTERFACE_CDROM != 0;
    call {:si_unique_call 158} GUID_BUS_TYPE_DOT4PRT__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_BUS_TYPE_DOT4PRT__Loc == GUID_BUS_TYPE_DOT4PRT;
    assume GUID_BUS_TYPE_DOT4PRT != 0;
    call {:si_unique_call 159} GUID_DEVINTERFACE_DISK__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_DEVINTERFACE_DISK__Loc == GUID_DEVINTERFACE_DISK;
    assume GUID_DEVINTERFACE_DISK != 0;
    call {:si_unique_call 160} SystemTraceControlGuid__Loc := __HAVOC_malloc_or_null(16);
    assume SystemTraceControlGuid__Loc == SystemTraceControlGuid;
    assume SystemTraceControlGuid != 0;
    call {:si_unique_call 161} GUID_BUS_TYPE_EISA__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 163} GUID_ACPI_REGS_INTERFACE_STANDARD__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 164} GUID_TARGET_DEVICE_TRANSPORT_RELATIONS_CHANGED__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 166} GUID_IO_VOLUME_BACKGROUND_FORMAT__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_IO_VOLUME_BACKGROUND_FORMAT__Loc == GUID_IO_VOLUME_BACKGROUND_FORMAT;
    assume GUID_IO_VOLUME_BACKGROUND_FORMAT != 0;
    call {:si_unique_call 167} GUID_PARTITION_UNIT_INTERFACE_STANDARD__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 168} GUID_IO_DISK_LAYOUT_CHANGE__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 170} GUID_BUS_TYPE_IRDA__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_BUS_TYPE_IRDA__Loc == GUID_BUS_TYPE_IRDA;
    assume GUID_BUS_TYPE_IRDA != 0;
    call {:si_unique_call 171} GUID_IO_CDROM_EXCLUSIVE_LOCK__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_IO_CDROM_EXCLUSIVE_LOCK__Loc == GUID_IO_CDROM_EXCLUSIVE_LOCK;
    assume GUID_IO_CDROM_EXCLUSIVE_LOCK != 0;
    call {:si_unique_call 172} GUID_IO_VOLUME_WORM_NEAR_FULL__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_IO_VOLUME_WORM_NEAR_FULL__Loc == GUID_IO_VOLUME_WORM_NEAR_FULL;
    assume GUID_IO_VOLUME_WORM_NEAR_FULL != 0;
    call {:si_unique_call 173} GUID_WUDF_DEVICE_HOST_PROBLEM__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 175} GUID_IO_VOLUME_UNIQUE_ID_CHANGE__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_IO_VOLUME_UNIQUE_ID_CHANGE__Loc == GUID_IO_VOLUME_UNIQUE_ID_CHANGE;
    assume GUID_IO_VOLUME_UNIQUE_ID_CHANGE != 0;
    call {:si_unique_call 176} GUID_IO_VOLUME_FVE_STATUS_CHANGE__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_IO_VOLUME_FVE_STATUS_CHANGE__Loc == GUID_IO_VOLUME_FVE_STATUS_CHANGE;
    assume GUID_IO_VOLUME_FVE_STATUS_CHANGE != 0;
    call {:si_unique_call 177} GUID_BUS_TYPE_SERENUM__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_BUS_TYPE_SERENUM__Loc == GUID_BUS_TYPE_SERENUM;
    assume GUID_BUS_TYPE_SERENUM != 0;
    call {:si_unique_call 178} GUID_PCI_DEVICE_PRESENT_INTERFACE__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 203} GUID_BUS_TYPE_USB__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_BUS_TYPE_USB__Loc == GUID_BUS_TYPE_USB;
    assume GUID_BUS_TYPE_USB != 0;
    call {:si_unique_call 204} GUID_IO_CDROM_EXCLUSIVE_UNLOCK__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_IO_CDROM_EXCLUSIVE_UNLOCK__Loc == GUID_IO_CDROM_EXCLUSIVE_UNLOCK;
    assume GUID_IO_CDROM_EXCLUSIVE_UNLOCK != 0;
    call {:si_unique_call 205} GUID_IO_DRIVE_REQUIRES_CLEANING__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_IO_DRIVE_REQUIRES_CLEANING__Loc == GUID_IO_DRIVE_REQUIRES_CLEANING;
    assume GUID_IO_DRIVE_REQUIRES_CLEANING != 0;
    call {:si_unique_call 206} GUID_INT_ROUTE_INTERFACE_STANDARD__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 207} PARTITION_MSFT_RESERVED_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume PARTITION_MSFT_RESERVED_GUID__Loc == PARTITION_MSFT_RESERVED_GUID;
    assume PARTITION_MSFT_RESERVED_GUID != 0;
    call {:si_unique_call 208} GUID_PROCESSOR_PCC_INTERFACE_STANDARD__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 230} GUID_BUS_TYPE_HID__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_BUS_TYPE_HID__Loc == GUID_BUS_TYPE_HID;
    assume GUID_BUS_TYPE_HID != 0;
    call {:si_unique_call 231} GUID_TARGET_DEVICE_REMOVE_COMPLETE__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 232} guidNull__Loc := __HAVOC_malloc_or_null(16);
    assume guidNull__Loc == guidNull;
    assume guidNull != 0;
    call {:si_unique_call 233} GUID_ACPI_INTERFACE_STANDARD__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_ACPI_INTERFACE_STANDARD__Loc == GUID_ACPI_INTERFACE_STANDARD;
    assume GUID_ACPI_INTERFACE_STANDARD != 0;
    call {:si_unique_call 234} GUID_POWER_DEVICE_WAKE_ENABLE__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_POWER_DEVICE_WAKE_ENABLE__Loc == GUID_POWER_DEVICE_WAKE_ENABLE;
    assume GUID_POWER_DEVICE_WAKE_ENABLE != 0;
    call {:si_unique_call 235} boogieTmp := __HAVOC_malloc_or_null(12);
    ...
    call {:si_unique_call 241} boogieTmp := __HAVOC_malloc_or_null(248);
    assume sicrni == boogieTmp;
    call {:si_unique_call 242} vslice_dummy_var_166 := __HAVOC_malloc(4);
    call {:si_unique_call 243} vslice_dummy_var_167 := __HAVOC_malloc(4);
    call {:si_unique_call 244} vslice_dummy_var_168 := __HAVOC_malloc(4);
    call {:si_unique_call 245} vslice_dummy_var_169 := __HAVOC_malloc(4);
    call {:si_unique_call 246} vslice_dummy_var_170 := __HAVOC_malloc(4);
    call {:si_unique_call 247} vslice_dummy_var_171 := __HAVOC_malloc(4);
    call {:si_unique_call 248} vslice_dummy_var_172 := __HAVOC_malloc(4);
    call {:si_unique_call 249} vslice_dummy_var_1234 := __HAVOC_malloc(12);
    call {:si_unique_call 250} vslice_dummy_var_173 := __HAVOC_malloc(4);
    call {:si_unique_call 251} vslice_dummy_var_174 := __HAVOC_malloc(4);
    call {:si_unique_call 252} vslice_dummy_var_175 := __HAVOC_malloc(4);
    call {:si_unique_call 253} vslice_dummy_var_176 := __HAVOC_malloc(4);
    call {:si_unique_call 254} vslice_dummy_var_177 := __HAVOC_malloc(4);
    call {:si_unique_call 255} vslice_dummy_var_178 := __HAVOC_malloc(4);
    call {:si_unique_call 256} vslice_dummy_var_179 := __HAVOC_malloc(4);
    call {:si_unique_call 257} vslice_dummy_var_180 := __HAVOC_malloc(4);
    call {:si_unique_call 258} vslice_dummy_var_1235 := __HAVOC_malloc(4);
    call {:si_unique_call 259} vslice_dummy_var_181 := __HAVOC_malloc(4);
    call {:si_unique_call 260} vslice_dummy_var_182 := __HAVOC_malloc(4);
    call {:si_unique_call 261} vslice_dummy_var_183 := __HAVOC_malloc(4);
    call {:si_unique_call 262} vslice_dummy_var_184 := __HAVOC_malloc(4);
    call {:si_unique_call 263} vslice_dummy_var_185 := __HAVOC_malloc(4);
    ...
    call {:si_unique_call 269} _sdv_init3();
    call {:si_unique_call 270} _sdv_init2();
    goto anon9_Then, anon9_Else;
  ...
  L33:
    ...
    call {:si_unique_call 271} sdv_main();
    goto anon12_Then, anon12_Else;
...
implementation {:origName "sdv_IoSkipCurrentIrpStackLocation"} {:osmodel} sdv_IoSkipCurrentIrpStackLocation(actual_pirp_8: int)
{
  ...
  anon0:
    call {:si_unique_call 272} vslice_dummy_var_21 := __HAVOC_malloc(4);
...
implementation {:origName "sdv_RunRemoveDevice"} {:osmodel} sdv_RunRemoveDevice(actual_po_1: int, actual_pirp_9: int) returns (Tmp_120: int)
{
  ...
  anon0:
    ...
    Mem_T.CompletionRoutine__IO_STACK_LOCATION[CompletionRoutine__IO_STACK_LOCATION(sdv_other_harnessStackLocation_next)] := 0;
    Mem_T.CompletionRoutine__IO_STACK_LOCATION[CompletionRoutine__IO_STACK_LOCATION(sdv_harnessStackLocation)] := 0;
    call {:si_unique_call 273} sdv_stub_dispatch_begin();
    call {:si_unique_call 274} sdv_SetStatus(pirp_9);
    call {:si_unique_call 275} status_5 := PmPnp(po_1, pirp_9);
    call {:si_unique_call 276} sdv_stub_dispatch_end(status_5, 0);
    Tmp_120 := status_5;
    return;
}
...
implementation {:origName "IofCallDriver"} {:osmodel} IofCallDriver(actual_DeviceObject_8: int, actual_Irp: int) returns (Tmp_159: int)
{
  ...
  anon47_Then:
    ...
    call {:si_unique_call 289} vslice_dummy_var_31 := sdv_RunIoCompletionRoutines(sdv_p_devobj_fdo, Irp, vslice_dummy_var_1236, completion);
    goto L29;
  ...
  anon59_Else:
    ...
    call {:si_unique_call 290} vslice_dummy_var_34 := sdv_RunIoCompletionRoutines(sdv_p_devobj_fdo, Irp, vslice_dummy_var_1237, completion);
    goto L29;
  ...
  anon51_Else:
    ...
    call {:si_unique_call 291} vslice_dummy_var_32 := sdv_RunIoCompletionRoutines(sdv_p_devobj_fdo, Irp, vslice_dummy_var_1238, completion);
    goto L29;
  ...
  anon55_Else:
    ...
    call {:si_unique_call 292} vslice_dummy_var_33 := sdv_RunIoCompletionRoutines(sdv_p_devobj_fdo, Irp, vslice_dummy_var_1239, completion);
    goto L29;
...
implementation {:origName "PmRemovePartition"} PmRemovePartition(actual_Partition: int) returns (Tmp_193: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 307} irp_1 := IoAllocateIrp(vslice_dummy_var_1240, 0);
    goto anon3_Then, anon3_Else;
  ...
  anon3_Else:
    ...
    call {:si_unique_call 311} vslice_dummy_var_43 := sdv_IoCallDriver(vslice_dummy_var_1241, irp_1);
...
implementation {:origName "PmSigCheckUpdateEpoch"} PmSigCheckUpdateEpoch(actual_DeviceExtension: int, actual_CompletionList_1: int)
{
  ...
  anon10_Else:
    ...
    call {:si_unique_call 333} status_8 := PmSigCheckFillInNotificationIrp(vslice_dummy_var_1242, irp_3);
    assume {:nonnull} irp_3 != 0;
    assume irp_3 > 0;
...
implementation {:origName "PmTakePartition"} PmTakePartition(actual_VolumeManagerEntry: int, actual_Partition_1: int, actual_WholeDiskPdo: int)
{
  ...
  anon10_Else:
    ...
    call {:si_unique_call 340} status_9 := sdv_IoCallDriver(vslice_dummy_var_1243, irp_4);
    goto anon11_Then, anon11_Else;
...
implementation {:origName "PmGivePartition"} PmGivePartition(actual_VolumeManagerEntry_1: int, actual_Partition_2: int, actual_WholeDiskPdo_1: int) returns (Tmp_215: int)
{
  ...
  anon16_Else:
    ...
    call {:si_unique_call 358} status_11 := sdv_IoCallDriver(vslice_dummy_var_1244, irp_5);
    goto anon18_Then, anon18_Else;
...
implementation {:origName "PmBuildDependantVolumeRelations"} PmBuildDependantVolumeRelations(actual_Extension: int, actual_Relations: int) returns (Tmp_220: int)
{
  ...
  anon45_Then:
    ...
    call {:si_unique_call 392} status_13 := PmQueryDependantVolumeList(vslice_dummy_var_1245, vslice_dummy_var_1246, vslice_dummy_var_1247, dependantVolumes);
...
implementation {:origName "PmWriteGptAttributesOnMbr"} PmWriteGptAttributesOnMbr(actual_Extension_1: int, actual_AttribInfo: int) returns (Tmp_253: int)
{
  ...
  anon13_Else:
    ...
    call {:si_unique_call 416} status_14 := sdv_IoCallDriver(vslice_dummy_var_1248, irp_7);
    goto anon14_Then, anon14_Else;
  ...
  L32:
    ...
    call {:si_unique_call 419} irp_7 := IoBuildSynchronousFsdRequest(4, 0, 0, vslice_dummy_var_1249, 0, 0, ioStatus_4);
    goto anon16_Then, anon16_Else;
  ...
  anon16_Else:
    ...
    call {:si_unique_call 420} status_14 := sdv_IoCallDriver(vslice_dummy_var_1250, irp_7);
    goto anon17_Then, anon17_Else;
...
implementation {:origName "PmStartPartition"} PmStartPartition(actual_Partition_4: int) returns (Tmp_257: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 423} irp_8 := IoAllocateIrp(vslice_dummy_var_1251, 0);
    goto anon3_Then, anon3_Else;
...
implementation {:origName "PmNotifyPartitions"} PmNotifyPartitions(actual_Extension_2: int, actual_Irp_3: int) returns (Tmp_259: int)
{
  ...
  anon7_Else:
    ...
    call {:si_unique_call 439} status_16 := sdv_IoCallDriver(vslice_dummy_var_1252, Irp_3);
    goto anon8_Then, anon8_Else;
...
implementation {:origName "PmReadGptAttributesOnMbr"} PmReadGptAttributesOnMbr(actual_Extension_3: int, actual_AttribInfo_1: int) returns (Tmp_263: int)
{
  ...
  anon25_Else:
    ...
    call {:si_unique_call 448} status_17 := sdv_IoCallDriver(vslice_dummy_var_1253, irp_9);
  ...
  anon27_Else:
    ...
    call {:si_unique_call 450} sdv_164 := ExAllocatePoolWithTag(0, vslice_dummy_var_1254, -380476589);
    attribInfo := sdv_164;
    goto anon34_Then, anon34_Else;
  ...
  L40:
    ...
    call {:si_unique_call 452} irp_9 := IoBuildSynchronousFsdRequest(3, 0, 0, vslice_dummy_var_1255, 0, 0, ioStatus_5);
  ...
  anon28_Else:
    ...
    call {:si_unique_call 453} status_17 := sdv_IoCallDriver(vslice_dummy_var_1256, irp_9);
...
implementation {:origName "PmLogError"} PmLogError(actual_Extension_4: int, actual_WinningExtension: int, actual_SpecificIoStatus: int)
{
  ...
  anon19_Else:
    ...
    call {:si_unique_call 480} status_19 := sdv_IoCallDriver(vslice_dummy_var_1257, irp_10);
    goto anon20_Then, anon20_Else;
  ...
  anon22_Else:
    ...
    call {:si_unique_call 484} status_19 := sdv_IoCallDriver(vslice_dummy_var_1258, irp_10);
    goto anon23_Then, anon23_Else;
...
implementation {:origName "PmQueryDeviceId"} PmQueryDeviceId(actual_Extension_5: int, actual_DeviceId_1: int) returns (Tmp_299: int)
{
  ...
  anon15_Else:
    ...
    call {:si_unique_call 535} status_21 := sdv_IoCallDriver(vslice_dummy_var_1259, irp_11);
    goto anon16_Then, anon16_Else;
  ...
  anon17_Else:
    ...
    call {:si_unique_call 537} sdv_197 := ExAllocatePoolWithTag(0, vslice_dummy_var_1260, -380476589);
    deviceId := sdv_197;
    goto anon21_Then, anon21_Else;
  ...
  anon21_Else:
    ...
    call {:si_unique_call 539} irp_11 := IoBuildDeviceIoControlRequest(2954240, 0, 0, 12, 0, vslice_dummy_var_1261, 0, 0, ioStatus_7);
    goto anon18_Then, anon18_Else;
  ...
  anon18_Else:
    ...
    call {:si_unique_call 540} status_21 := sdv_IoCallDriver(vslice_dummy_var_1262, irp_11);
    goto anon19_Then, anon19_Else;
...
implementation {:origName "PmCheckAndUpdateSignature"} PmCheckAndUpdateSignature(actual_DeviceExtension_1: int, actual_IssueSigCheckNotifications: int, actual_ForceSignatureCheck: int) returns (Tmp_301: int)
{
  ...
  L11:
    ...
    call {:si_unique_call 545} status_22 := PmReadPartitionTableEx(vslice_dummy_var_1263, newLayout);
    goto anon28_Then, anon28_Else;
  ...
  L19:
    ...
    call {:si_unique_call 546} sdv_200 := LockDriverWithTimeout(vslice_dummy_var_1264);
    goto anon32_Then, anon32_Else;
  ...
  L27:
    ...
    call {:si_unique_call 548} PmAddSignatures(DeviceExtension_1, vslice_dummy_var_1265);
...
implementation {:origName "PmAddSignatures"} PmAddSignatures(actual_Extension_6: int, actual_Layout: int)
{
  ...
  anon142_Else:
    ...
    call {:si_unique_call 571} sdv_218 := PmIsRedundantPath(Extension_6, vslice_dummy_var_1266, 0, Guid__GUID_TABLE_ENTRY(guidEntry));
  ...
  anon143_Else:
    ...
    call {:si_unique_call 572} PmLogError(Extension_6, vslice_dummy_var_1267, 262203);
    assume {:nonnull} Extension_6 != 0;
    assume Extension_6 > 0;
    goto L1;
  ...
  anon143_Then:
    ...
    call {:si_unique_call 573} PmLogError(Extension_6, vslice_dummy_var_1268, 262202);
    goto L57;
  ...
  anon144_Else:
    ...
    call {:si_unique_call 575} status_23 := PmWritePartitionTableEx(vslice_dummy_var_1269, Layout);
  ...
  L145:
    ...
    call {:si_unique_call 580} status_23 := PmWritePartitionTableEx(vslice_dummy_var_1270, Layout);
  ...
  anon162_Else:
    ...
    call {:si_unique_call 592} sdv_234 := PmIsRedundantPath(Extension_6, vslice_dummy_var_1271, vslice_dummy_var_1272, 0);
  ...
  anon163_Else:
    ...
    call {:si_unique_call 593} PmLogError(Extension_6, vslice_dummy_var_1273, 262203);
    assume {:nonnull} Extension_6 != 0;
    assume Extension_6 > 0;
    goto L1;
  ...
  anon163_Then:
    ...
    call {:si_unique_call 594} PmLogError(Extension_6, vslice_dummy_var_1274, 262202);
    goto L187;
  ...
  anon198_Else:
    ...
    call {:si_unique_call 595} status_23 := PmWritePartitionTableEx(vslice_dummy_var_1275, Layout);
  ...
  anon168_Else:
    ...
    call {:si_unique_call 596} status_23 := PmWriteGptAttributesOnMbr(Extension_6, vslice_dummy_var_1276);
  ...
  anon177_Else:
    ...
    call {:si_unique_call 607} sdv_230 := PmLookupId(vslice_dummy_var_1277, vslice_dummy_var_1278, vslice_dummy_var_1279);
  ...
  anon201_Then:
    ...
    call {:si_unique_call 610} vslice_dummy_var_105 := PmWriteGptAttributesOnMbr(Extension_6, vslice_dummy_var_1280);
    goto L276;
...
implementation {:origName "PmRemoveDevice"} PmRemoveDevice(actual_Extension_7: int, actual_Irp_7: int) returns (Tmp_328: int)
{
  ...
  anon16_Else:
    ...
    call {:si_unique_call 632} PmTakePartition(vslice_dummy_var_1281, vslice_dummy_var_1282, 0);
  ...
  anon18_Else:
    ...
    call {:si_unique_call 635} PmTakeWholeDisk(volmgrEntry, vslice_dummy_var_1283);
    assume {:nonnull} l_3 != 0;
    assume l_3 > 0;
    havoc l_3;
...
implementation {:origName "PmPnp"} PmPnp(actual_DeviceObject_15: int, actual_Irp_8: int) returns (Tmp_334: int)
{
  ...
  L27:
    ...
    call {:si_unique_call 648} status_25 := sdv_IoCallDriver(vslice_dummy_var_1284, Irp_8);
    goto anon62_Then, anon62_Else;
  ...
  anon63_Else:
    ...
    call {:si_unique_call 650} sdv_IoAdjustPagingPathCount(0, vslice_dummy_var_1285);
    assume {:nonnull} irpSp_5 != 0;
    assume irpSp_5 > 0;
    goto anon65_Then, anon65_Else;
  ...
  anon73_Then:
    ...
    call {:si_unique_call 671} Tmp_334 := sdv_IoCallDriver(vslice_dummy_var_1286, Irp_8);
    goto L1;
  ...
  anon81_Then:
    ...
    call {:si_unique_call 675} Tmp_334 := sdv_IoCallDriver(vslice_dummy_var_1287, Irp_8);
    goto L1;
  ...
  anon72_Else:
    ...
    call {:si_unique_call 679} Tmp_334 := sdv_IoCallDriver(vslice_dummy_var_1288, Irp_8);
    goto L1;
  ...
  anon69_Then:
    ...
    call {:si_unique_call 683} vslice_dummy_var_120 := sdv_IoCallDriver(vslice_dummy_var_1289, Irp_8);
  ...
  anon86_Else:
    ...
    call {:si_unique_call 689} vslice_dummy_var_124 := PmRegisterDevice(DeviceObject_15, vslice_dummy_var_1290);
    goto L128;
...
implementation {:origName "PmTakeWholeDisk"} PmTakeWholeDisk(actual_VolumeManagerEntry_2: int, actual_WholeDiskPdo_3: int)
{
  ...
  anon17_Else:
    ...
    call {:si_unique_call 696} status_26 := sdv_IoCallDriver(vslice_dummy_var_1291, irp_12);
    goto anon19_Then, anon19_Else;
...
implementation {:origName "PmQueryDeviceRelations"} PmQueryDeviceRelations(actual_Extension_8: int, actual_Irp_9: int) returns (Tmp_349: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 721} vslice_dummy_var_139 := sdv_IoCallDriver(vslice_dummy_var_1292, Irp_9);
  ...
  anon34_Then:
    ...
    call {:si_unique_call 728} PmTakePartition(vslice_dummy_var_1293, vslice_dummy_var_1294, vslice_dummy_var_1295);
  ...
  anon45_Else:
    ...
    call {:si_unique_call 743} status_28 := PmGivePartition(volmgrEntry_1, vslice_dummy_var_1296, vslice_dummy_var_1297);
    goto anon40_Then, anon40_Else;
...
implementation {:origName "PmIsRedundantPath"} PmIsRedundantPath(actual_Extension_9: int, actual_WinningExtension_1: int, actual_Signature: int, actual_Guid: int) returns (Tmp_377: int)
{
  ...
  anon59_Else:
    ...
    call {:si_unique_call 753} status_29 := sdv_IoCallDriver(vslice_dummy_var_1298, irp_13);
    goto anon60_Then, anon60_Else;
  ...
  anon62_Else:
    ...
    call {:si_unique_call 757} status_29 := sdv_IoCallDriver(vslice_dummy_var_1299, irp_13);
    goto anon63_Then, anon63_Else;
  ...
  anon67_Else:
    ...
    call {:si_unique_call 762} status_29 := sdv_IoCallDriver(vslice_dummy_var_1300, irp_13);
    goto anon68_Then, anon68_Else;
  ...
  anon70_Else:
    ...
    call {:si_unique_call 766} status_29 := sdv_IoCallDriver(vslice_dummy_var_1301, irp_13);
    goto anon71_Then, anon71_Else;
  ...
  anon74_Else:
    ...
    call {:si_unique_call 772} status_29 := sdv_IoCallDriver(vslice_dummy_var_1302, irp_13);
    goto anon75_Then, anon75_Else;
  ...
  anon77_Else:
    ...
    call {:si_unique_call 776} status_29 := sdv_IoCallDriver(vslice_dummy_var_1303, irp_13);
    goto anon78_Then, anon78_Else;
  ...
  anon82_Else:
    ...
    call {:si_unique_call 782} status_29 := sdv_IoCallDriver(vslice_dummy_var_1304, irp_13);
    goto anon83_Then, anon83_Else;
...
implementation {:origName "PmQueryRemovalRelations"} PmQueryRemovalRelations(actual_Extension_10: int, actual_Irp_10: int) returns (Tmp_401: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 836} vslice_dummy_var_162 := sdv_IoCallDriver(vslice_dummy_var_1305, Irp_10);
...
implementation PmSigCheckUpdateEpoch_loop_L19(in_Tmp_198: int, in_Tmp_200: int, in_sdv_112: int, in_oldIrql: int, in_sdv_113: int, in_irp_3: int, in_listElement_1: int, in_status_8: int, in_DeviceExtension: int, in_CompletionList_1: int, in_vslice_dummy_var_47: int, in_vslice_dummy_var_48: int) returns (out_Tmp_198: int, out_Tmp_200: int, out_sdv_112: int, out_oldIrql: int, out_sdv_113: int, out_irp_3: int, out_listElement_1: int, out_status_8: int, out_vslice_dummy_var_47: int, out_vslice_dummy_var_48: int)
{
  ...
  anon10_Else:
    ...
    call {:si_unique_call 855} out_status_8 := PmSigCheckFillInNotificationIrp(vslice_dummy_var_1306, out_irp_3);
    assume {:nonnull} out_irp_3 != 0;
    assume out_irp_3 > 0;
...
implementation PmBuildDependantVolumeRelations_loop_L47(in_i_1: int, in_Tmp_225: int, in_dependantVolumeCount: int, in_Tmp_228: int, in_relationsList: int, in_Tmp_237: int, in_sdv_138: int, in_l: int, in_partition: int, in_dependantVolumes: int, in_status_13: int) returns (out_i_1: int, out_Tmp_225: int, out_dependantVolumeCount: int, out_Tmp_228: int, out_Tmp_237: int, out_sdv_138: int, out_l: int, out_partition: int, out_status_13: int)
{
  ...
  anon45_Then:
    ...
    call {:si_unique_call 878} out_status_13 := PmQueryDependantVolumeList(vslice_dummy_var_1307, vslice_dummy_var_1308, vslice_dummy_var_1309, in_dependantVolumes);
    goto anon36_Else;
...
implementation PmNotifyPartitions_loop_L23(in_sdv_156: int, in_l_1: int, in_partition_1: int, in_status_16: int, in_event_8: int, in_Irp_3: int, in_vslice_dummy_var_75: int) returns (out_sdv_156: int, out_l_1: int, out_partition_1: int, out_status_16: int, out_vslice_dummy_var_75: int)
{
  ...
  anon7_Else:
    ...
    call {:si_unique_call 886} out_status_16 := sdv_IoCallDriver(vslice_dummy_var_1310, in_Irp_3);
    goto anon8_Then, anon8_Else;
...
implementation PmAddSignatures_loop_L114(in_i_3: int, in_Tmp_305: int, in_Tmp_306: int, in_Tmp_307: int, in_Tmp_309: int, in_g: int, in_Tmp_314: int, in_Tmp_315: int, in_guidEntry: int, in_sdv_216: int, in_Tmp_319: int, in_Tmp_320: int, in_Tmp_321: int, in_sigEntry: int, in_sdv_226: int, in_driverExtension_1: int, in_sdv_229: int, in_Tmp_324: int, in_sdv_232: int, in_status_23: int, in_p_4: int, in_uuid: int, in_hasBootPartitionType: int, in_Extension_6: int, in_Layout: int, in_vslice_dummy_var_97: int, in_vslice_dummy_var_103: int) returns (out_i_3: int, out_Tmp_305: int, out_Tmp_306: int, out_Tmp_307: int, out_Tmp_309: int, out_g: int, out_Tmp_314: int, out_Tmp_315: int, out_sdv_216: int, out_Tmp_319: int, out_Tmp_320: int, out_Tmp_321: int, out_sdv_226: int, out_Tmp_324: int, out_status_23: int, out_p_4: int, out_hasBootPartitionType: int, out_vslice_dummy_var_97: int, out_vslice_dummy_var_103: int)
{
  ...
  L145:
    ...
    call {:si_unique_call 903} out_status_23 := PmWritePartitionTableEx(vslice_dummy_var_1311, in_Layout);
    goto anon154_Else;
...
implementation PmRemoveDevice_loop_L60(in_volmgrEntry: int, in_sdv_244: int, in_l_3: int, in_Extension_7: int) returns (out_volmgrEntry: int, out_sdv_244: int, out_l_3: int)
{
  ...
  anon18_Else:
    ...
    call {:si_unique_call 923} PmTakeWholeDisk(out_volmgrEntry, vslice_dummy_var_1312);
...
implementation PmRemoveDevice_loop_L50(in_sdv_241: int, in_l_3: int, in_partition_2: int) returns (out_sdv_241: int, out_l_3: int, out_partition_2: int)
{
  ...
  anon16_Else:
    ...
    call {:si_unique_call 926} PmTakePartition(vslice_dummy_var_1313, vslice_dummy_var_1314, 0);
    assume {:nonnull} out_l_3 != 0;
    assume out_l_3 > 0;
    havoc out_l_3;
    goto anon16_Else_dummy;
...
implementation PmQueryDeviceRelations_loop_L117(in_volmgrEntry_1: int, in_l_4: int, in_sdv_298: int, in_partition_3: int, in_status_28: int, in_Extension_8: int) returns (out_volmgrEntry_1: int, out_l_4: int, out_sdv_298: int, out_status_28: int)
{
  ...
  anon45_Else:
    ...
    call {:si_unique_call 930} out_status_28 := PmGivePartition(out_volmgrEntry_1, vslice_dummy_var_1315, vslice_dummy_var_1316);
    goto anon40_Then;
...
implementation PmQueryDeviceRelations_loop_L69(in_i_4: int, in_deviceRelations: int, in_Tmp_350: int, in_Tmp_351: int, in_Tmp_352: int, in_Tmp_353: int, in_volmgrEntry_1: int, in_Tmp_357: int, in_Tmp_358: int, in_Tmp_360: int, in_Tmp_361: int, in_Tmp_362: int, in_Tmp_363: int, in_Tmp_364: int, in_Tmp_366: int, in_sdv_297: int, in_Tmp_367: int, in_l_4: int, in_Tmp_368: int, in_sdv_298: int, in_Tmp_369: int, in_partition_3: int, in_Tmp_370: int, in_status_28: int, in_Tmp_371: int, in_sdv_301: int, in_Tmp_374: int, in_Tmp_375: int, in_Tmp_376: int, in_Extension_8: int, in_vslice_dummy_var_146: int, in_vslice_dummy_var_147: int) returns (out_i_4: int, out_Tmp_350: int, out_Tmp_351: int, out_Tmp_352: int, out_Tmp_353: int, out_volmgrEntry_1: int, out_Tmp_357: int, out_Tmp_358: int, out_Tmp_360: int, out_Tmp_361: int, out_Tmp_362: int, out_Tmp_363: int, out_Tmp_364: int, out_Tmp_366: int, out_sdv_297: int, out_Tmp_367: int, out_l_4: int, out_Tmp_368: int, out_sdv_298: int, out_Tmp_369: int, out_partition_3: int, out_Tmp_370: int, out_status_28: int, out_Tmp_371: int, out_sdv_301: int, out_Tmp_374: int, out_Tmp_375: int, out_Tmp_376: int, out_vslice_dummy_var_146: int, out_vslice_dummy_var_147: int)
{
  ...
  anon45_Else:
    ...
    call {:si_unique_call 943} out_status_28 := PmGivePartition(out_volmgrEntry_1, vslice_dummy_var_1317, vslice_dummy_var_1318);
    goto anon40_Then, anon40_Else;
...
implementation PmQueryDeviceRelations_loop_L38(in_i_4: int, in_deviceRelations: int, in_b: int, in_sdv_296: int, in_Tmp_365: int, in_l_4: int, in_partition_3: int, in_Tmp_372: int, in_vslice_dummy_var_141: int, in_vslice_dummy_var_144: int, in_vslice_dummy_var_145: int) returns (out_i_4: int, out_b: int, out_sdv_296: int, out_Tmp_365: int, out_l_4: int, out_partition_3: int, out_Tmp_372: int, out_vslice_dummy_var_141: int, out_vslice_dummy_var_144: int, out_vslice_dummy_var_145: int)
{
  ...
  anon34_Then:
    ...
    call {:si_unique_call 945} PmTakePartition(vslice_dummy_var_1319, vslice_dummy_var_1320, vslice_dummy_var_1321);
