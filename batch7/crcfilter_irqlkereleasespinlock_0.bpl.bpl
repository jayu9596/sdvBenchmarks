...
procedure {:origName "SLIC_sdv_KeReleaseSpinLock_entry"} {:osmodel} SLIC_sdv_KeReleaseSpinLock_entry(actual_caller: int, actual_sdv_10: int);
  modifies yogi_error;
  free ensures {:va_keep} yogi_error == 1 || yogi_error == old(yogi_error);
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);
...
implementation {:origName "SLIC_sdv_KeReleaseSpinLock_entry"} {:osmodel} SLIC_sdv_KeReleaseSpinLock_entry(actual_caller: int, actual_sdv_10: int)
{
  ...
  anon9_Else:
    assume {:partition} sdv_10 != sdv_irql_previous;
    call {:si_unique_call 26} SLIC_ABORT_1_1(caller, sdv_10);
    goto anon12_Then, anon12_Else;
  ...
  anon10_Then:
    assume {:partition} sdv_irql_current != 2;
    call {:si_unique_call 27} SLIC_ABORT_1_0(caller, sdv_10);
    goto anon11_Then, anon11_Else;
...
procedure {:origName "SLIC_ABORT_1_0"} SLIC_ABORT_1_0(actual_caller_1: int, actual_sdv_11: int);
  modifies yogi_error;
...
implementation {:origName "SLIC_ABORT_1_0"} SLIC_ABORT_1_0(actual_caller_1: int, actual_sdv_11: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 28} SLIC_ERROR_ROUTINE(strConst__li2bpl0);
    return;
}
...
procedure {:origName "SLIC_ABORT_1_1"} SLIC_ABORT_1_1(actual_caller_2: int, actual_sdv_12: int);
  modifies yogi_error;
  free ensures {:va_keep} yogi_error == 1;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);
...
implementation {:origName "SLIC_ABORT_1_1"} SLIC_ABORT_1_1(actual_caller_2: int, actual_sdv_12: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 29} SLIC_ERROR_ROUTINE(strConst__li2bpl1);
    return;
}



procedure {:origName "sdv_InsertTailList"} sdv_InsertTailList(actual_sdv_15: int, actual_sdv_16: int) returns (Tmp_61: int);
  modifies alloc, Mem_T.INT4;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);
...
implementation {:origName "sdv_InsertTailList"} sdv_InsertTailList(actual_sdv_15: int, actual_sdv_16: int) returns (Tmp_61: int)
{
  var {:scalar} sdv_17: int;

  anon0:
    call {:si_unique_call 30} Tmp_61 := __HAVOC_malloc(4);
    call {:si_unique_call 31} sdv_17 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_61 != 0;
    assume Tmp_61 > 0;
    assume {:nonnull} sdv_17 != 0;
    assume sdv_17 > 0;
    Mem_T.INT4[Tmp_61] := Mem_T.INT4[sdv_17];
    return;
}
...
implementation {:origName "CallDriverSyncCompletion"} CallDriverSyncCompletion(actual_DevObjOrNULL: int, actual_Irp_1: int, actual_Context_1: int) returns (Tmp_63: int)
{
  ...
  anon0:
    ...
    event := Context_1;
    call {:si_unique_call 32} vslice_dummy_var_5 := KeSetEvent(event, 0, 0);
    Tmp_63 := -1073741802;
    return;
}
...
implementation {:origName "CallDriverSync"} CallDriverSync(actual_TargetDevObj: int, actual_Irp_2: int) returns (Tmp_65: int)
{
  ...
  anon0:
    call {:si_unique_call 33} event_1 := __HAVOC_malloc(156);
    TargetDevObj := actual_TargetDevObj;
    Irp_2 := actual_Irp_2;
    call {:si_unique_call 34} sdv_do_paged_code_check();
    call {:si_unique_call 35} KeInitializeEvent(event_1, 0, 0);
    call {:si_unique_call 36} sdv_IoSetCompletionRoutine(Irp_2, li2bplFunctionConstant254, event_1, 1, 1, 1);
    call {:si_unique_call 37} status_2 := sdv_IoCallDriver(TargetDevObj, Irp_2);
    goto anon3_Then, anon3_Else;

  anon3_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 38} vslice_dummy_var_6 := KeWaitForSingleObject(0, 0, 0, 0, 0);
...
implementation {:origName "AcquirePassiveLevelLock"} AcquirePassiveLevelLock(actual_DeviceExtension_4: int)
{
  ...
  anon0:
    call {:si_unique_call 39} vslice_dummy_var_7 := __HAVOC_malloc(4);
    DeviceExtension_4 := actual_DeviceExtension_4;
    call {:si_unique_call 40} sdv_do_paged_code_check();
    call {:si_unique_call 41} vslice_dummy_var_8 := KeWaitForSingleObject(0, 0, 0, 0, 0);
    call {:si_unique_call 42} sdv_22 := sdv_KeGetCurrentThread();
...
implementation {:origName "DataVerFilter_ForwardIrpSyn"} DataVerFilter_ForwardIrpSyn(actual_DeviceObject: int, actual_Irp_3: int) returns (Tmp_69: int)
{
  ...
  anon0:
    call {:si_unique_call 43} event_2 := __HAVOC_malloc(156);
    DeviceObject := actual_DeviceObject;
    Irp_3 := actual_Irp_3;
    call {:si_unique_call 44} sdv_do_paged_code_check();
    call {:si_unique_call 45} KeInitializeEvent(event_2, 0, 0);
    call {:si_unique_call 46} Tmp_69 := DataVerFilter_ForwardIrp(DeviceObject, Irp_3, li2bplFunctionConstant248, event_2, event_2);
    goto anon3_Then, anon3_Else;
...
implementation {:origName "DataVerFilter_ForwardIrpAsyn"} DataVerFilter_ForwardIrpAsyn(actual_DeviceObject_1: int, actual_Irp_4: int, actual_CompletionRoutine: int, actual_pContext: int) returns (Tmp_71: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 47} Tmp_71 := DataVerFilter_ForwardIrp(DeviceObject_1, Irp_4, CompletionRoutine, pContext, 0);
    goto anon3_Then, anon3_Else;
...
implementation {:origName "FreePool"} FreePool(actual_DeviceExtension_5: int, actual_Buf: int, actual_PoolType: int)
{
  ...
  anon0:
    call {:si_unique_call 48} vslice_dummy_var_9 := __HAVOC_malloc(4);
  ...
  anon6_Else:
    ...
    call {:si_unique_call 49} Tmp_74 := __HAVOC_malloc(4);
    ...
    call {:si_unique_call 50} vslice_dummy_var_11 := sdv_InterlockedDecrement(Tmp_74);
    assume {:nonnull} DeviceExtension_5 != 0;
    assume DeviceExtension_5 > 0;
    assume {:nonnull} Tmp_74 != 0;
    assume Tmp_74 > 0;
    call {:si_unique_call 51} sdv_ExFreePool(0);
    goto L1;
  ...
  anon5_Then:
    assume {:partition} PoolType == 1;
    call {:si_unique_call 52} Tmp_74 := __HAVOC_malloc(4);
    assume {:nonnull} DeviceExtension_5 != 0;
    assume DeviceExtension_5 > 0;
    assume {:nonnull} Tmp_74 != 0;
    assume Tmp_74 > 0;
    ...
    call {:si_unique_call 53} vslice_dummy_var_10 := sdv_InterlockedDecrement(Tmp_74);
    assume {:nonnull} DeviceExtension_5 != 0;
    assume DeviceExtension_5 > 0;
    assume {:nonnull} Tmp_74 != 0;
    assume Tmp_74 > 0;
...
implementation {:origName "ReleasePassiveLevelLock"} ReleasePassiveLevelLock(actual_DeviceExtension_6: int)
{
  ...
  anon0:
    ...
    assume {:nonnull} DeviceExtension_6 != 0;
    assume DeviceExtension_6 > 0;
    call {:si_unique_call 57} vslice_dummy_var_13 := KeSetEvent(SyncEvent__DEVICE_EXTENSION(DeviceExtension_6), 0, 0);
    return;
}
...
implementation {:origName "DataVerFilter_ForwardIrp"} DataVerFilter_ForwardIrp(actual_DeviceObject_2: int, actual_Irp_5: int, actual_CompletionRoutine_1: int, actual_pContext_1: int, actual_pEvent: int) returns (Tmp_79: int)
{
  ...
  anon11_Else:
    ...
    call {:si_unique_call 59} sdv_IoCopyCurrentIrpStackLocationToNext(Irp_5);
    call {:si_unique_call 60} sdv_IoSetCompletionRoutine(Irp_5, CompletionRoutine_1, pContext_1, 1, 1, 1);
    goto L17;
  ...
  L17:
    ...
    call {:si_unique_call 61} status_5 := sdv_IoCallDriver(vslice_dummy_var_3, Irp_5);
    goto anon12_Then, anon12_Else;
  ...
  anon10_Else:
    ...
    call {:si_unique_call 62} vslice_dummy_var_15 := KeWaitForSingleObject(0, 0, 0, 0, 0);
  ...
  anon11_Then:
    assume {:partition} CompletionRoutine_1 == 0;
    call {:si_unique_call 63} sdv_IoSkipCurrentIrpStackLocation(Irp_5);
    goto L17;
}
...
implementation {:origName "AllocPool"} AllocPool(actual_DeviceExtension_7: int, actual_PoolType_1: int, actual_NumBytes: int, actual_SyncEventHeld: int) returns (Tmp_81: int)
{
  ...
  anon18_Else:
    ...
    call {:si_unique_call 64} newBuf := ExAllocatePoolWithTag(512, NumBytes, -767207868);
    goto anon14_Then, anon14_Else;

  anon14_Else:
    assume {:partition} newBuf != 0;
    call {:si_unique_call 65} sdv_RtlZeroMemory(0, NumBytes);
    call {:si_unique_call 66} Tmp_82 := __HAVOC_malloc(4);
    ...
    call {:si_unique_call 67} vslice_dummy_var_17 := sdv_InterlockedIncrement(Tmp_82);
    assume {:nonnull} DeviceExtension_7 != 0;
    assume DeviceExtension_7 > 0;
    assume {:nonnull} Tmp_82 != 0;
    assume Tmp_82 > 0;
  ...
  anon13_Then:
    assume {:partition} PoolType_1 == 1;
    call {:si_unique_call 68} newBuf := ExAllocatePoolWithTag(1, NumBytes, -767207868);
    goto anon16_Then, anon16_Else;

  anon16_Else:
    assume {:partition} newBuf != 0;
    call {:si_unique_call 69} sdv_RtlZeroMemory(0, NumBytes);
    ...
    call {:si_unique_call 71} vslice_dummy_var_16 := sdv_InterlockedIncrement(Tmp_82);
    assume {:nonnull} DeviceExtension_7 != 0;
    assume DeviceExtension_7 > 0;
    assume {:nonnull} Tmp_82 != 0;
    assume Tmp_82 > 0;
...
implementation {:origName "GetDeviceDescriptor"} GetDeviceDescriptor(actual_DeviceExtension_8: int, actual_PropertyId: int, actual_DescHeader: int) returns (Tmp_83: int)
{
  ...
  anon0:
    call {:si_unique_call 72} propQuery := __HAVOC_malloc(12);
    ...
    call {:si_unique_call 74} irp := IoAllocateIrp(vslice_dummy_var_6, 0);
    goto anon17_Then, anon17_Else;
  ...
  anon17_Else:
    ...
    assume {:nonnull} propQuery != 0;
    assume propQuery > 0;
    call {:si_unique_call 75} nextIrpSp := sdv_IoGetNextIrpStackLocation(irp);
    ...
    call {:si_unique_call 76} status_6 := CallDriverSync(vslice_dummy_var_7, irp);
  ...
  anon18_Else:
    ...
    assume Tmp_88 > 0;
    havoc Tmp_90;
    call {:si_unique_call 77} sdv_38 := AllocPool(DeviceExtension_8, 512, Tmp_90, 0);
    descHeader := sdv_38;
    goto anon23_Then, anon23_Else;

  anon23_Else:
    assume {:partition} descHeader != 0;
    call {:si_unique_call 78} IoReuseIrp(irp, -1073741637);
    assume {:nonnull} nextIrpSp != 0;
    assume nextIrpSp > 0;
    assume {:nonnull} nextIrpSp != 0;
    assume nextIrpSp > 0;
    ...
    call {:si_unique_call 79} status_6 := CallDriverSync(vslice_dummy_var_8, irp);
  ...
  anon20_Then:
    ...
    call {:si_unique_call 81} FreePool(DeviceExtension_8, descHeader, 512);
    goto L37;
...
implementation {:origName "DataVerFilter_IrpSignalCompletion"} DataVerFilter_IrpSignalCompletion(actual_DeviceObject_3: int, actual_Irp_6: int, actual_pContext_2: int) returns (Tmp_92: int)
{
  ...
  anon0:
    ...
    pEvent_1 := pContext_2;
    call {:si_unique_call 82} vslice_dummy_var_18 := KeSetEvent(pEvent_1, 0, 0);
    Tmp_92 := -1073741802;
    return;
}
...
implementation {:origName "KeBugCheckEx"} {:osmodel} KeBugCheckEx(actual_BugCheckCode: int, actual_BugCheckParameter1: int, actual_BugCheckParameter2: int, actual_BugCheckParameter3: int, actual_BugCheckParameter4: int)
{
  ...
  anon0:
    call {:si_unique_call 83} vslice_dummy_var_19 := __HAVOC_malloc(4);
    call {:si_unique_call 84} SdvExit#1();
    return;
}
...
implementation {:origName "IoFreeWorkItem"} {:osmodel} IoFreeWorkItem(actual_IoWorkItem: int)
{
  ...
  anon0:
    call {:si_unique_call 85} vslice_dummy_var_20 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "sdv_IoCopyCurrentIrpStackLocationToNext"} {:osmodel} sdv_IoCopyCurrentIrpStackLocationToNext(actual_pirp: int)
{
  ...
  anon0:
    call {:si_unique_call 86} vslice_dummy_var_21 := __HAVOC_malloc(4);
    pirp := actual_pirp;
    goto anon5_Then, anon5_Else;
...
implementation {:origName "sdv_KeAcquireSpinLock"} {:osmodel} sdv_KeAcquireSpinLock(actual_SpinLock: int, actual_p: int)
{
  ...
  anon0:
    call {:si_unique_call 87} vslice_dummy_var_22 := __HAVOC_malloc(4);
    p := actual_p;
...
implementation {:origName "IoDetachDevice"} {:osmodel} IoDetachDevice(actual_TargetDevice: int)
{
  ...
  anon0:
    call {:si_unique_call 88} vslice_dummy_var_23 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "sdv_SetPowerIrpMinorFunction"} {:osmodel} sdv_SetPowerIrpMinorFunction(actual_pirp_2: int)
{
  ...
  anon0:
    call {:si_unique_call 89} vslice_dummy_var_24 := __HAVOC_malloc(4);
...
implementation {:origName "sdv_stub_dispatch_end"} {:osmodel} sdv_stub_dispatch_end(actual_s: int, actual_pirp_3: int)
{
  ...
  anon0:
    call {:si_unique_call 90} vslice_dummy_var_25 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "sdv_SetStatus"} {:osmodel} sdv_SetStatus(actual_pirp_4: int)
{
  ...
  anon0:
    call {:si_unique_call 91} vslice_dummy_var_26 := __HAVOC_malloc(4);
...
implementation {:origName "sdv_main"} {:osmodel} sdv_main()
{
  ...
  anon0:
    call {:si_unique_call 92} vslice_dummy_var_27 := __HAVOC_malloc(4);
    call {:si_unique_call 93} sdv_stub_driver_init();
    call {:si_unique_call 94} vslice_dummy_var_28 := sdv_RunDispatchFunction(sdv_p_devobj_fdo, sdv_irp);
    goto anon3_Then, anon3_Else;
...
implementation {:origName "sdv_MmGetSystemAddressForMdlSafe"} {:osmodel} sdv_MmGetSystemAddressForMdlSafe(actual_MDL: int, actual_PRIORITY: int) returns (Tmp_122: int)
{
  ...
  anon3_Else:
    call {:si_unique_call 95} sdv_45 := __HAVOC_malloc(1);
    p_1 := sdv_45;
    Tmp_122 := p_1;
    goto L1;
...
implementation {:origName "sdv_MmGetMdlVirtualAddress"} {:osmodel} sdv_MmGetMdlVirtualAddress(actual_Mdl: int) returns (Tmp_124: int)
{
  ...
  anon0:
    call {:si_unique_call 96} sdv_46 := __HAVOC_malloc(1);
    x_1 := sdv_46;
    Tmp_124 := x_1;
    return;
}
...
implementation {:origName "PoCallDriver"} {:osmodel} PoCallDriver(actual_DeviceObject_4: int, actual_Irp_7: int) returns (Tmp_126: int)
{
  ...
  anon0:
    call {:si_unique_call 97} completion := __HAVOC_malloc(4);
    Irp_7 := actual_Irp_7;
  ...
  anon56_Then:
    ...
    call {:si_unique_call 98} vslice_dummy_var_29 := sdv_RunIoCompletionRoutines(sdv_p_devobj_fdo, Irp_7, vslice_dummy_var_9, completion);
  ...
  anon68_Else:
    ...
    call {:si_unique_call 99} vslice_dummy_var_32 := sdv_RunIoCompletionRoutines(sdv_p_devobj_fdo, Irp_7, vslice_dummy_var_10, completion);
  ...
  anon60_Else:
    ...
    call {:si_unique_call 100} vslice_dummy_var_30 := sdv_RunIoCompletionRoutines(sdv_p_devobj_fdo, Irp_7, vslice_dummy_var_11, completion);
  ...
  anon64_Else:
    ...
    call {:si_unique_call 101} vslice_dummy_var_31 := sdv_RunIoCompletionRoutines(sdv_p_devobj_fdo, Irp_7, vslice_dummy_var_12, completion);
...
implementation {:origName "sdv_IoSetCompletionRoutine"} {:osmodel} sdv_IoSetCompletionRoutine(actual_pirp_5: int, actual_CompletionRoutine_2: int, actual_Context_4: int, actual_InvokeOnSuccess: int, actual_InvokeOnError: int, actual_InvokeOnCancel: int)
{
  ...
  anon0:
    call {:si_unique_call 102} vslice_dummy_var_33 := __HAVOC_malloc(4);
    ...
    call {:si_unique_call 103} irpSp_1 := sdv_IoGetNextIrpStackLocation(pirp_5);
...
implementation {:origName "PoStartNextPowerIrp"} {:osmodel} PoStartNextPowerIrp(actual_Irp_8: int)
{
  ...
  anon0:
    call {:si_unique_call 104} vslice_dummy_var_34 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "IoDeleteDevice"} {:osmodel} IoDeleteDevice(actual_DeviceObject_5: int)
{
  ...
  anon0:
    call {:si_unique_call 105} vslice_dummy_var_35 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "MmProbeAndLockPages"} {:osmodel} MmProbeAndLockPages(actual_MemoryDescriptorList: int, actual_AccessMode: int, actual_Operation: int)
{
  ...
  anon0:
    call {:si_unique_call 106} vslice_dummy_var_36 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "main"} {:osmodel} main() returns (Tmp_146: int, dup_assertVar: bool)
{
  ...
  anon0:
    ...
    call {:si_unique_call 108} AllContextsList__Loc := __HAVOC_malloc_or_null(8);
    assume AllContextsList__Loc == AllContextsList;
    assume AllContextsList != 0;
    call {:si_unique_call 109} sdv_harnessStackLocation_next__Loc := __HAVOC_malloc_or_null(536);
    assume sdv_harnessStackLocation_next__Loc == sdv_harnessStackLocation_next;
    assume sdv_harnessStackLocation_next != 0;
    call {:si_unique_call 110} sdv_IoReadPartitionTableEx_DRIVE_LAYOUT_INFORMATION_EX__Loc := __HAVOC_malloc_or_null(76);
    assume sdv_IoReadPartitionTableEx_DRIVE_LAYOUT_INFORMATION_EX__Loc == sdv_IoReadPartitionTableEx_DRIVE_LAYOUT_INFORMATION_EX;
    assume sdv_IoReadPartitionTableEx_DRIVE_LAYOUT_INFORMATION_EX != 0;
    call {:si_unique_call 111} sdv_IoBuildAsynchronousFsdRequest_harnessIrp__Loc := __HAVOC_malloc_or_null(240);
    assume sdv_IoBuildAsynchronousFsdRequest_harnessIrp__Loc == sdv_IoBuildAsynchronousFsdRequest_harnessIrp;
    assume sdv_IoBuildAsynchronousFsdRequest_harnessIrp != 0;
    call {:si_unique_call 112} sdv_IoGetDeviceToVerify_DEVICE_OBJECT__Loc := __HAVOC_malloc_or_null(380);
    assume sdv_IoGetDeviceToVerify_DEVICE_OBJECT__Loc == sdv_IoGetDeviceToVerify_DEVICE_OBJECT;
    assume sdv_IoGetDeviceToVerify_DEVICE_OBJECT != 0;
    call {:si_unique_call 113} sdv_IoBuildDeviceIoControlRequest_harnessStackLocation_next__Loc := __HAVOC_malloc_or_null(536);
    assume sdv_IoBuildDeviceIoControlRequest_harnessStackLocation_next__Loc == sdv_IoBuildDeviceIoControlRequest_harnessStackLocation_next;
    assume sdv_IoBuildDeviceIoControlRequest_harnessStackLocation_next != 0;
    call {:si_unique_call 114} sdv_harness_IoBuildSynchronousFsdRequest_IoStatusBlock__Loc := __HAVOC_malloc_or_null(12);
    assume sdv_harness_IoBuildSynchronousFsdRequest_IoStatusBlock__Loc == sdv_harness_IoBuildSynchronousFsdRequest_IoStatusBlock;
    assume sdv_harness_IoBuildSynchronousFsdRequest_IoStatusBlock != 0;
    call {:si_unique_call 115} sdv_ControllerIrp__Loc := __HAVOC_malloc_or_null(240);
    assume sdv_ControllerIrp__Loc == sdv_ControllerIrp;
    assume sdv_ControllerIrp != 0;
    call {:si_unique_call 116} sdv_devobj_pdo__Loc := __HAVOC_malloc_or_null(380);
    assume sdv_devobj_pdo__Loc == sdv_devobj_pdo;
    assume sdv_devobj_pdo != 0;
    call {:si_unique_call 117} sdv_IoGetDmaAdapter_DMA_ADAPTER__Loc := __HAVOC_malloc_or_null(12);
    assume sdv_IoGetDmaAdapter_DMA_ADAPTER__Loc == sdv_IoGetDmaAdapter_DMA_ADAPTER;
    assume sdv_IoGetDmaAdapter_DMA_ADAPTER != 0;
    call {:si_unique_call 118} sdv_IoInitializeIrp_harnessIrp__Loc := __HAVOC_malloc_or_null(240);
    assume sdv_IoInitializeIrp_harnessIrp__Loc == sdv_IoInitializeIrp_harnessIrp;
    assume sdv_IoInitializeIrp_harnessIrp != 0;
    call {:si_unique_call 119} sdv_IoGetRelatedDeviceObject_DEVICE_OBJECT__Loc := __HAVOC_malloc_or_null(380);
    assume sdv_IoGetRelatedDeviceObject_DEVICE_OBJECT__Loc == sdv_IoGetRelatedDeviceObject_DEVICE_OBJECT;
    assume sdv_IoGetRelatedDeviceObject_DEVICE_OBJECT != 0;
    call {:si_unique_call 120} sdv_IoBuildSynchronousFsdRequest_harnessStackLocation_next__Loc := __HAVOC_malloc_or_null(536);
    assume sdv_IoBuildSynchronousFsdRequest_harnessStackLocation_next__Loc == sdv_IoBuildSynchronousFsdRequest_harnessStackLocation_next;
    assume sdv_IoBuildSynchronousFsdRequest_harnessStackLocation_next != 0;
    call {:si_unique_call 121} sdv_IoCreateSynchronizationEvent_KEVENT__Loc := __HAVOC_malloc_or_null(156);
    ...
    call {:si_unique_call 123} sdv_other_harnessStackLocation_next__Loc := __HAVOC_malloc_or_null(536);
    assume sdv_other_harnessStackLocation_next__Loc == sdv_other_harnessStackLocation_next;
    assume sdv_other_harnessStackLocation_next != 0;
    call {:si_unique_call 124} sdv_IoCreateController_CONTROLLER_OBJECT__Loc := __HAVOC_malloc_or_null(60);
    assume sdv_IoCreateController_CONTROLLER_OBJECT__Loc == sdv_IoCreateController_CONTROLLER_OBJECT;
    assume sdv_IoCreateController_CONTROLLER_OBJECT != 0;
    call {:si_unique_call 125} sdv_devobj_top__Loc := __HAVOC_malloc_or_null(380);
    assume sdv_devobj_top__Loc == sdv_devobj_top;
    assume sdv_devobj_top != 0;
    call {:si_unique_call 126} sdv_kdpc_val3__Loc := __HAVOC_malloc_or_null(44);
    assume sdv_kdpc_val3__Loc == sdv_kdpc_val3;
    assume sdv_kdpc_val3 != 0;
    call {:si_unique_call 127} sdv_IoBuildSynchronousFsdRequest_harnessIrp__Loc := __HAVOC_malloc_or_null(240);
    assume sdv_IoBuildSynchronousFsdRequest_harnessIrp__Loc == sdv_IoBuildSynchronousFsdRequest_harnessIrp;
    assume sdv_IoBuildSynchronousFsdRequest_harnessIrp != 0;
    call {:si_unique_call 128} sdv_IoGetDeviceObjectPointer_DEVICE_OBJECT__Loc := __HAVOC_malloc_or_null(380);
    assume sdv_IoGetDeviceObjectPointer_DEVICE_OBJECT__Loc == sdv_IoGetDeviceObjectPointer_DEVICE_OBJECT;
    assume sdv_IoGetDeviceObjectPointer_DEVICE_OBJECT != 0;
    call {:si_unique_call 129} sdv_MapRegisterBase_val__Loc := __HAVOC_malloc_or_null(4);
    assume sdv_MapRegisterBase_val__Loc == sdv_MapRegisterBase_val;
    assume sdv_MapRegisterBase_val != 0;
    call {:si_unique_call 130} sdv_IoGetFileObjectGenericMapping_GENERIC_MAPPING__Loc := __HAVOC_malloc_or_null(16);
    assume sdv_IoGetFileObjectGenericMapping_GENERIC_MAPPING__Loc == sdv_IoGetFileObjectGenericMapping_GENERIC_MAPPING;
    assume sdv_IoGetFileObjectGenericMapping_GENERIC_MAPPING != 0;
    call {:si_unique_call 131} sdv_IoMakeAssociatedIrp_harnessIrp__Loc := __HAVOC_malloc_or_null(240);
    assume sdv_IoMakeAssociatedIrp_harnessIrp__Loc == sdv_IoMakeAssociatedIrp_harnessIrp;
    assume sdv_IoMakeAssociatedIrp_harnessIrp != 0;
    call {:si_unique_call 132} sdv_devobj_child_pdo__Loc := __HAVOC_malloc_or_null(380);
    assume sdv_devobj_child_pdo__Loc == sdv_devobj_child_pdo;
    assume sdv_devobj_child_pdo != 0;
    call {:si_unique_call 133} sdv_harnessIrp__Loc := __HAVOC_malloc_or_null(240);
    assume sdv_harnessIrp__Loc == sdv_harnessIrp;
    assume sdv_harnessIrp != 0;
    call {:si_unique_call 134} sdv_IoBuildAsynchronousFsdRequest_harnessStackLocation_next__Loc := __HAVOC_malloc_or_null(536);
    assume sdv_IoBuildAsynchronousFsdRequest_harnessStackLocation_next__Loc == sdv_IoBuildAsynchronousFsdRequest_harnessStackLocation_next;
    assume sdv_IoBuildAsynchronousFsdRequest_harnessStackLocation_next != 0;
    call {:si_unique_call 135} sdv_harness_IoBuildDeviceIoControlRequest_IoStatusBlock__Loc := __HAVOC_malloc_or_null(12);
    assume sdv_harness_IoBuildDeviceIoControlRequest_IoStatusBlock__Loc == sdv_harness_IoBuildDeviceIoControlRequest_IoStatusBlock;
    assume sdv_harness_IoBuildDeviceIoControlRequest_IoStatusBlock != 0;
    call {:si_unique_call 136} sdv_kinterrupt_val__Loc := __HAVOC_malloc_or_null(0);
    assume sdv_kinterrupt_val__Loc == sdv_kinterrupt_val;
    assume sdv_kinterrupt_val != 0;
    call {:si_unique_call 137} sdv_fx_dev_object__Loc := __HAVOC_malloc_or_null(40);
    assume sdv_fx_dev_object__Loc == sdv_fx_dev_object;
    assume sdv_fx_dev_object != 0;
    call {:si_unique_call 138} sdv_devobj_fdo__Loc := __HAVOC_malloc_or_null(380);
    assume sdv_devobj_fdo__Loc == sdv_devobj_fdo;
    assume sdv_devobj_fdo != 0;
    call {:si_unique_call 139} sdv_StartIoIrp__Loc := __HAVOC_malloc_or_null(240);
    assume sdv_StartIoIrp__Loc == sdv_StartIoIrp;
    assume sdv_StartIoIrp != 0;
    call {:si_unique_call 140} sdv_harness_IoBuildAsynchronousFsdRequest_IoStatusBlock__Loc := __HAVOC_malloc_or_null(12);
    assume sdv_harness_IoBuildAsynchronousFsdRequest_IoStatusBlock__Loc == sdv_harness_IoBuildAsynchronousFsdRequest_IoStatusBlock;
    assume sdv_harness_IoBuildAsynchronousFsdRequest_IoStatusBlock != 0;
    call {:si_unique_call 141} sdv_PowerIrp__Loc := __HAVOC_malloc_or_null(240);
    assume sdv_PowerIrp__Loc == sdv_PowerIrp;
    assume sdv_PowerIrp != 0;
    call {:si_unique_call 142} sdv_IoBuildDeviceIoControlRequest_harnessIrp__Loc := __HAVOC_malloc_or_null(240);
    assume sdv_IoBuildDeviceIoControlRequest_harnessIrp__Loc == sdv_IoBuildDeviceIoControlRequest_harnessIrp;
    assume sdv_IoBuildDeviceIoControlRequest_harnessIrp != 0;
    call {:si_unique_call 143} sdv_other_harnessIrp__Loc := __HAVOC_malloc_or_null(240);
    assume sdv_other_harnessIrp__Loc == sdv_other_harnessIrp;
    assume sdv_other_harnessIrp != 0;
    call {:si_unique_call 144} sdv_IoCreateNotificationEvent_KEVENT__Loc := __HAVOC_malloc_or_null(156);
    assume sdv_IoCreateNotificationEvent_KEVENT__Loc == sdv_IoCreateNotificationEvent_KEVENT;
    assume sdv_IoCreateNotificationEvent_KEVENT != 0;
    call {:si_unique_call 145} sdv_other_harnessStackLocation__Loc := __HAVOC_malloc_or_null(536);
    assume sdv_other_harnessStackLocation__Loc == sdv_other_harnessStackLocation;
    assume sdv_other_harnessStackLocation != 0;
    call {:si_unique_call 146} KeTickCount__Loc := __HAVOC_malloc_or_null(12);
    ...
    call {:si_unique_call 152} boogieTmp := __HAVOC_malloc_or_null(4);
    assume igdoe == boogieTmp;
    call {:si_unique_call 153} boogieTmp := __HAVOC_malloc_or_null(240);
    assume sicrni == boogieTmp;
    call {:si_unique_call 154} boogieTmp := __HAVOC_malloc_or_null(4);
    assume InitSafeBootMode == boogieTmp;
    call {:si_unique_call 155} vslice_dummy_var_13 := __HAVOC_malloc(1024);
    assume {:mainInitDone} true;
    call {:si_unique_call 156} corralExtraInit();
    call {:si_unique_call 157} corralExplainErrorInit();
    call {:si_unique_call 158} _sdv_init7();
    call {:si_unique_call 159} _sdv_init1();
    call {:si_unique_call 160} _sdv_init4();
    call {:si_unique_call 161} _sdv_init5();
    call {:si_unique_call 162} _sdv_init3();
    call {:si_unique_call 163} _sdv_init2();
    goto anon9_Then, anon9_Else;
  ...
  L34:
    ...
    call {:si_unique_call 164} sdv_main();
    goto anon12_Then, anon12_Else;
...
implementation {:origName "sdv_IoSkipCurrentIrpStackLocation"} {:osmodel} sdv_IoSkipCurrentIrpStackLocation(actual_pirp_7: int)
{
  ...
  anon0:
    call {:si_unique_call 165} vslice_dummy_var_37 := __HAVOC_malloc(4);
...
implementation {:origName "sdv_KeGetCurrentThread"} {:osmodel} sdv_KeGetCurrentThread() returns (Tmp_154: int)
{
  ...
  anon0:
    call {:si_unique_call 166} sdv_55 := __HAVOC_malloc(4);
    Tmp_154 := sdv_55;
    return;
}
...
implementation {:origName "IoAllocateMdl"} {:osmodel} IoAllocateMdl(actual_VirtualAddress: int, actual_Length_1: int, actual_SecondaryBuffer: int, actual_ChargeQuota: int, actual_Irp_9: int) returns (Tmp_156: int)
{
  ...
  anon3_Else:
    call {:si_unique_call 167} sdv_57 := __HAVOC_malloc(1);
    Tmp_156 := sdv_57;
    goto L1;
...
implementation {:origName "IoFreeMdl"} {:osmodel} IoFreeMdl(actual_Mdl_1: int)
{
  ...
  anon0:
    call {:si_unique_call 169} vslice_dummy_var_39 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "sdv_do_paged_code_check"} {:osmodel} sdv_do_paged_code_check()
{
  ...
  anon0:
    call {:si_unique_call 170} vslice_dummy_var_40 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "sdv_IoMarkIrpPending"} {:osmodel} sdv_IoMarkIrpPending(actual_pirp_8: int)
{
  ...
  anon0:
    call {:si_unique_call 171} vslice_dummy_var_41 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "sdv_RunDispatchFunction"} {:osmodel} sdv_RunDispatchFunction(actual_po: int, actual_pirp_9: int) returns (Tmp_166: int)
{
  ...
  anon0:
    ...
    assume {:nonnull} pirp_9 != 0;
    assume pirp_9 > 0;
    call {:si_unique_call 172} sdv_SetStatus(pirp_9);
    assume {:nonnull} pirp_9 != 0;
    assume pirp_9 > 0;
    assume {:nonnull} pirp_9 != 0;
    assume pirp_9 > 0;
    ...
    assume {:nonnull} ps != 0;
    assume ps > 0;
    call {:si_unique_call 173} sdv_stub_dispatch_begin();
    goto anon73_Then, anon73_Else;
  ...
  L66:
    call {:si_unique_call 174} status_8 := DataVerFilter_DispatchPnp(po, pirp_9);
  ...
  L72:
    call {:si_unique_call 175} sdv_stub_dispatch_end(status_8, 0);
    assume {:nonnull} pirp_9 != 0;
    assume pirp_9 > 0;
    Tmp_166 := status_8;
    goto LM2;
  ...
  anon78_Then:
    call {:si_unique_call 176} status_8 := sdv_DoNothing();
    goto L72;

  anon79_Then:
    assume {:nonnull} ps != 0;
    assume ps > 0;
    call {:si_unique_call 177} status_8 := DataVerFilter_DispatchAny(po, pirp_9);
  ...
  anon80_Then:
    assume {:nonnull} ps != 0;
    assume ps > 0;
    call {:si_unique_call 178} sdv_SetPowerIrpMinorFunction(pirp_9);
    call {:si_unique_call 179} status_8 := DataVerFilter_DispatchPower(po, pirp_9);
  ...
  anon81_Then:
    assume {:nonnull} ps != 0;
    assume ps > 0;
    call {:si_unique_call 180} status_8 := DataVerFilter_DispatchAny(po, pirp_9);
  ...
  anon82_Then:
    call {:si_unique_call 181} status_8 := sdv_DoNothing();
    goto L72;

  anon83_Then:
    assume {:nonnull} ps != 0;
    assume ps > 0;
    call {:si_unique_call 182} status_8 := DataVerFilter_DispatchAny(po, pirp_9);
  ...
  anon84_Then:
    assume {:nonnull} ps != 0;
    assume ps > 0;
    call {:si_unique_call 183} status_8 := CrcScsi(po, pirp_9);
  ...
  anon85_Then:
    assume {:nonnull} ps != 0;
    assume ps > 0;
    call {:si_unique_call 184} status_8 := DataVerFilter_DeviceControl(po, pirp_9);
  ...
  anon73_Then:
    assume {:nonnull} ps != 0;
    assume ps > 0;
    call {:si_unique_call 192} status_8 := DataVerFilter_DispatchAny(po, pirp_9);
...
procedure {:origName "sdv_KeReleaseSpinLock"} {:osmodel} sdv_KeReleaseSpinLock(actual_SpinLock_1: int, actual_new: int);
  ...
  free ensures {:va_keep} sdv_irql_current == actual_new || sdv_irql_current == old(sdv_irql_current);
...
implementation {:origName "sdv_KeReleaseSpinLock"} {:osmodel} sdv_KeReleaseSpinLock(actual_SpinLock_1: int, actual_new: int)
{
  ...
  anon0:
    call {:si_unique_call 193} vslice_dummy_var_42 := __HAVOC_malloc(4);
    new := actual_new;
    call {:si_unique_call 194} SLIC_sdv_KeReleaseSpinLock_entry(strConst__li2bpl2, new);
    goto anon3_Then, anon3_Else;
...
implementation {:origName "IoReuseIrp"} {:osmodel} IoReuseIrp(actual_Irp_10: int, actual_Status: int)
{
  ...
  anon0:
    call {:si_unique_call 195} vslice_dummy_var_43 := __HAVOC_malloc(4);
...
implementation {:origName "sdv_IoCompleteRequest"} {:osmodel} sdv_IoCompleteRequest(actual_pirp_10: int, actual_PriorityBoost: int)
{
  ...
  anon0:
    call {:si_unique_call 196} vslice_dummy_var_44 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "sdv_RtlCopyMemory"} {:osmodel} sdv_RtlCopyMemory(actual_Destination_1: int, actual_Source: int, actual_Length_3: int)
{
  ...
  anon0:
    call {:si_unique_call 197} vslice_dummy_var_45 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "sdv_ExFreePool"} {:osmodel} sdv_ExFreePool(actual_P: int)
{
  ...
  anon0:
    call {:si_unique_call 198} vslice_dummy_var_46 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "_sdv_init5"} {:osmodel} _sdv_init5()
{
  ...
  anon0:
    call {:si_unique_call 199} vslice_dummy_var_47 := __HAVOC_malloc(4);
...
implementation {:origName "IoAllocateIrp"} {:osmodel} IoAllocateIrp(actual_StackSize: int, actual_ChargeQuota_1: int) returns (Tmp_188: int)
{
  ...
  anon3_Else:
    assume {:nonnull} sdv_other_irp != 0;
    assume sdv_other_irp > 0;
    call {:si_unique_call 200} irpSp_2 := sdv_IoGetNextIrpStackLocation(sdv_other_irp);
...
implementation {:origName "IofCallDriver"} {:osmodel} IofCallDriver(actual_DeviceObject_6: int, actual_Irp_11: int) returns (Tmp_190: int)
{
  ...
  anon0:
    call {:si_unique_call 201} completion_1 := __HAVOC_malloc(4);
  ...
  anon55_Then:
    ...
    call {:si_unique_call 202} vslice_dummy_var_48 := sdv_RunIoCompletionRoutines(sdv_p_devobj_fdo, Irp_11, vslice_dummy_var_14, completion_1);
    goto anon76_Then, anon76_Else;
  ...
  anon67_Else:
    ...
    call {:si_unique_call 203} vslice_dummy_var_51 := sdv_RunIoCompletionRoutines(sdv_p_devobj_fdo, Irp_11, vslice_dummy_var_15, completion_1);
    goto anon78_Then, anon78_Else;
  ...
  anon59_Else:
    ...
    call {:si_unique_call 204} vslice_dummy_var_49 := sdv_RunIoCompletionRoutines(sdv_p_devobj_fdo, Irp_11, vslice_dummy_var_16, completion_1);
    goto anon74_Then, anon74_Else;
  ...
  anon63_Else:
    ...
    call {:si_unique_call 205} vslice_dummy_var_50 := sdv_RunIoCompletionRoutines(sdv_p_devobj_fdo, Irp_11, vslice_dummy_var_17, completion_1);
    goto anon72_Then, anon72_Else;
...
implementation {:origName "sdv_RunIoCompletionRoutines"} {:osmodel} sdv_RunIoCompletionRoutines(actual_DeviceObject_7: int, actual_Irp_12: int, actual_Context_5: int, actual_Completion: int) returns (Tmp_192: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 206} irpsp := sdv_IoGetNextIrpStackLocation(Irp_12);
    Status_1 := 0;
  ...
  anon21_Else:
    ...
    sdv_irql_previous := sdv_irql_current;
    sdv_irql_current := 2;
    call {:si_unique_call 207} Status_1 := CallDriverSyncCompletion(DeviceObject_7, Irp_12, Context_5);
  ...
  anon17_Else:
    ...
    sdv_irql_previous := sdv_irql_current;
    sdv_irql_current := 2;
    call {:si_unique_call 208} Status_1 := CrcScsiReadCapacityCompletion(DeviceObject_7, Irp_12, Context_5);
    goto anon22_Then, anon22_Else;
  ...
  anon18_Else:
    ...
    sdv_irql_previous := sdv_irql_current;
    sdv_irql_current := 2;
    call {:si_unique_call 209} Status_1 := CrcScsiReadCompletion(DeviceObject_7, Irp_12, Context_5);
    goto anon23_Then, anon23_Else;
  ...
  anon19_Else:
    ...
    sdv_irql_previous := sdv_irql_current;
    sdv_irql_current := 2;
    call {:si_unique_call 210} Status_1 := CrcScsiWriteCompletion(DeviceObject_7, Irp_12, Context_5);
    goto anon24_Then, anon24_Else;
  ...
  anon20_Else:
    ...
    sdv_irql_previous := sdv_irql_current;
    sdv_irql_current := 2;
    call {:si_unique_call 211} Status_1 := DataVerFilter_IrpSignalCompletion(DeviceObject_7, Irp_12, Context_5);
    sdv_irql_current := sdv_irql_previous;
    sdv_irql_previous := sdv_irql_previous_2;
    sdv_irql_previous_2 := sdv_irql_previous_3;
    sdv_irql_previous_3 := sdv_irql_previous_4;
...
implementation {:origName "KeInitializeEvent"} {:osmodel} KeInitializeEvent(actual_Event_1: int, actual_Type: int, actual_State: int)
{
  ...
  anon0:
    call {:si_unique_call 212} vslice_dummy_var_52 := __HAVOC_malloc(4);
...
implementation {:origName "sdv_IoCallDriver"} {:osmodel} sdv_IoCallDriver(actual_DeviceObject_8: int, actual_Irp_13: int) returns (Tmp_196: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 213} Tmp_196 := IofCallDriver(0, Irp_13);
    goto anon3_Then, anon3_Else;
...
implementation {:origName "IoFreeIrp"} {:osmodel} IoFreeIrp(actual_pirp_11: int)
{
  ...
  anon0:
    call {:si_unique_call 214} vslice_dummy_var_53 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "MmUnlockPages"} {:osmodel} MmUnlockPages(actual_MemoryDescriptorList_1: int)
{
  ...
  anon0:
    call {:si_unique_call 215} vslice_dummy_var_54 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "ExAllocatePoolWithTag"} {:osmodel} ExAllocatePoolWithTag(actual_PoolType_2: int, actual_NumberOfBytes: int, actual_Tag: int) returns (Tmp_202: int)
{
  ...
  anon3_Else:
    call {:si_unique_call 216} sdv_93 := __HAVOC_malloc(NumberOfBytes);
    Tmp_202 := sdv_93;
    goto L1;
...
implementation {:origName "sdv_stub_driver_init"} {:osmodel} sdv_stub_driver_init()
{
  ...
  anon0:
    call {:si_unique_call 217} vslice_dummy_var_55 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "LockCheckSumArrays"} LockCheckSumArrays(actual_DeviceExtension_9: int, actual_RegionIndex: int) returns (Tmp_210: int)
{
  ...
  anon0:
    ...
    lockSucceeded := 0;
    call {:si_unique_call 219} MmProbeAndLockPages(0, 0, 1);
    call {:si_unique_call 220} MmProbeAndLockPages(0, 0, 1);
    lockSucceeded := 1;
    goto anon12_Then, anon12_Else;
  ...
  anon12_Else:
    ...
    unlockSome := 0;
    call {:si_unique_call 221} Tmp_212 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_212 != 0;
    assume Tmp_212 > 0;
    Mem_T.INT4[Tmp_212] := oldIrql_3;
    call {:si_unique_call 222} sdv_KeAcquireSpinLock(0, Tmp_212);
    assume {:nonnull} Tmp_212 != 0;
    assume Tmp_212 > 0;
    oldIrql_3 := Mem_T.INT4[Tmp_212];
    assume {:nonnull} pCRCMdlItem_1 != 0;
    assume pCRCMdlItem_1 > 0;
    call {:si_unique_call 223} UpdateRegionAccessTimeStamp(DeviceExtension_9, RegionIndex);
    assume {:nonnull} DeviceExtension_9 != 0;
    assume DeviceExtension_9 > 0;
    assume {:nonnull} DeviceExtension_9 != 0;
    assume DeviceExtension_9 > 0;
  ...
  L32:
    call {:si_unique_call 224} sdv_KeReleaseSpinLock(0, oldIrql_3);
    goto anon14_Then, anon14_Else;
  ...
  anon11_Else:
    ...
    call {:si_unique_call 225} UnlockLRUChecksumArray(DeviceExtension_9);
    goto anon15_Then, anon15_Else;
...
implementation {:origName "FreeAllPages"} FreeAllPages(actual_DeviceExtension_10: int)
{
  ...
  anon0:
    call {:si_unique_call 226} vslice_dummy_var_57 := __HAVOC_malloc(4);
  ...
  L14:
    call {:si_unique_call 227} pCRCMdlItem_2, i_3, Tmp_215, bufToFree, Tmp_216, bufCopyToFree, oldIrql_4, Tmp_217, vslice_dummy_var_58 := FreeAllPages_loop_L14(pCRCMdlItem_2, i_3, Tmp_215, bufToFree, Tmp_216, EndIndex, bufCopyToFree, oldIrql_4, Tmp_217, DeviceExtension_10, vslice_dummy_var_58);
    goto L14_last;
  ...
  anon16_Else:
    ...
    bufToFree := 0;
    bufCopyToFree := 0;
    call {:si_unique_call 228} Tmp_215 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_215 != 0;
    assume Tmp_215 > 0;
    Mem_T.INT4[Tmp_215] := oldIrql_4;
    call {:si_unique_call 229} sdv_KeAcquireSpinLock(0, Tmp_215);
    assume {:nonnull} Tmp_215 != 0;
    assume Tmp_215 > 0;
  ...
  anon20_Else:
    call {:si_unique_call 230} MmUnlockPages(0);
    call {:si_unique_call 231} MmUnlockPages(0);
    assume {:nonnull} pCRCMdlItem_2 != 0;
    assume pCRCMdlItem_2 > 0;
    call {:si_unique_call 232} vslice_dummy_var_58 := sdv_RemoveEntryList(0);
    assume {:nonnull} pCRCMdlItem_2 != 0;
    assume pCRCMdlItem_2 > 0;
    call {:si_unique_call 233} InitializeListHead(LockedLRUListEntry__CRC_MDL_ITEM(pCRCMdlItem_2));
    assume {:nonnull} DeviceExtension_10 != 0;
    assume DeviceExtension_10 > 0;
    goto L34;

  L34:
    call {:si_unique_call 234} IoFreeMdl(0);
    assume {:nonnull} pCRCMdlItem_2 != 0;
    assume pCRCMdlItem_2 > 0;
    call {:si_unique_call 235} IoFreeMdl(0);
    assume {:nonnull} pCRCMdlItem_2 != 0;
    assume pCRCMdlItem_2 > 0;
    assume {:nonnull} pCRCMdlItem_2 != 0;
    assume pCRCMdlItem_2 > 0;
  ...
  anon18_Else:
    ...
    call {:si_unique_call 237} FreePool(DeviceExtension_10, bufToFree, 1);
    goto L58;
  ...
  anon19_Else:
    ...
    call {:si_unique_call 238} FreePool(DeviceExtension_10, bufCopyToFree, 1);
    goto L62;
...
implementation {:origName "UnlockLRUChecksumArray"} UnlockLRUChecksumArray(actual_DeviceExtension_11: int)
{
  ...
  anon0:
    call {:si_unique_call 239} vslice_dummy_var_59 := __HAVOC_malloc(4);
    DeviceExtension_11 := actual_DeviceExtension_11;
    call {:si_unique_call 240} Tmp_218 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_218 != 0;
    assume Tmp_218 > 0;
    Mem_T.INT4[Tmp_218] := oldIrql_5;
    call {:si_unique_call 241} sdv_KeAcquireSpinLock(0, Tmp_218);
    assume {:nonnull} Tmp_218 != 0;
    assume Tmp_218 > 0;
  ...
  anon7_Else:
    call {:si_unique_call 242} sdv_95 := sdv_IsListEmpty(0);
    goto anon8_Then, anon8_Else;
  ...
  anon8_Else:
    ...
    assume {:nonnull} DeviceExtension_11 != 0;
    assume DeviceExtension_11 > 0;
    call {:si_unique_call 243} listEntry_2 := RemoveHeadList(LockedLRUList__CRC_MDL_ARRAY(CRCMdlLists__DEVICE_EXTENSION(DeviceExtension_11)));
    call {:si_unique_call 244} sdv_97 := sdv_containing_record(listEntry_2, 16);
    lruMdlItem := sdv_97;
    assume {:nonnull} lruMdlItem != 0;
    assume lruMdlItem > 0;
    call {:si_unique_call 245} InitializeListHead(LockedLRUListEntry__CRC_MDL_ITEM(lruMdlItem));
    assume {:nonnull} lruMdlItem != 0;
    assume lruMdlItem > 0;
    call {:si_unique_call 246} MmUnlockPages(0);
    call {:si_unique_call 247} MmUnlockPages(0);
    assume {:nonnull} DeviceExtension_11 != 0;
    assume DeviceExtension_11 > 0;
    goto L8;

  L8:
    call {:si_unique_call 248} sdv_KeReleaseSpinLock(0, oldIrql_5);
    goto anon9_Then, anon9_Else;
...
implementation {:origName "UpdateRegionAccessTimeStamp"} UpdateRegionAccessTimeStamp(actual_DeviceExtension_12: int, actual_RegionIndex_1: int)
{
  ...
  anon0:
    call {:si_unique_call 249} vslice_dummy_var_60 := __HAVOC_malloc(4);
    ...
    call {:si_unique_call 250} vslice_dummy_var_62 := sdv_RemoveEntryList(0);
    assume {:nonnull} DeviceExtension_12 != 0;
    assume DeviceExtension_12 > 0;
    assume {:nonnull} pCRCMdlItem_3 != 0;
    assume pCRCMdlItem_3 > 0;
    call {:si_unique_call 251} vslice_dummy_var_61 := sdv_InsertTailList(LockedLRUList__CRC_MDL_ARRAY(CRCMdlLists__DEVICE_EXTENSION(DeviceExtension_12)), LockedLRUListEntry__CRC_MDL_ITEM(pCRCMdlItem_3));
    return;
}
...
implementation {:origName "AllocAndMapPages"} AllocAndMapPages(actual_DeviceExtension_13: int, actual_LogicalBlockAddr: int, actual_NumSectors: int) returns (Tmp_224: int)
{
  ...
  L13:
    call {:si_unique_call 252} i_4, pCRCMdlItem_4, checkSumsMdl, buffersAssigned, checkSumsCopyMdl, Tmp_225, Tmp_226, sdv_99, sdv_100, checkSumsArrayLen, oldIrql_6, Tmp_227, checkSums, checkSumsCopy := AllocAndMapPages_loop_L13(i_4, pCRCMdlItem_4, checkSumsMdl, buffersAssigned, checkSumsCopyMdl, Tmp_225, Tmp_226, sdv_99, sdv_100, EndIndex_1, checkSumsArrayLen, oldIrql_6, Tmp_227, checkSums, checkSumsCopy, DeviceExtension_13);
    goto L13_last;
  ...
  anon51_Else:
    buffersAssigned := 0;
    call {:si_unique_call 253} checkSums := AllocPool(DeviceExtension_13, 1, checkSumsArrayLen, 1);
    goto anon40_Then, anon40_Else;

  anon40_Else:
    assume {:partition} checkSums != 0;
    call {:si_unique_call 254} checkSumsCopy := AllocPool(DeviceExtension_13, 1, checkSumsArrayLen, 1);
    goto anon41_Then, anon41_Else;

  anon41_Else:
    assume {:partition} checkSumsCopy != 0;
    call {:si_unique_call 255} checkSumsMdl := IoAllocateMdl(0, checkSumsArrayLen, 0, 0, 0);
    goto anon42_Then, anon42_Else;

  anon42_Else:
    assume {:partition} checkSumsMdl != 0;
    call {:si_unique_call 256} checkSumsCopyMdl := IoAllocateMdl(0, checkSumsArrayLen, 0, 0, 0);
    goto anon43_Then, anon43_Else;

  anon43_Else:
    assume {:partition} checkSumsCopyMdl != 0;
    call {:si_unique_call 257} Tmp_227 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_227 != 0;
    assume Tmp_227 > 0;
    Mem_T.INT4[Tmp_227] := oldIrql_6;
    call {:si_unique_call 258} sdv_KeAcquireSpinLock(0, Tmp_227);
    assume {:nonnull} Tmp_227 != 0;
    assume Tmp_227 > 0;
  ...
  L64:
    call {:si_unique_call 259} sdv_KeReleaseSpinLock(0, oldIrql_6);
    goto anon53_Then, anon53_Else;
  ...
  anon45_Else:
    ...
    call {:si_unique_call 260} sdv_100 := LockCheckSumArrays(DeviceExtension_13, i_4);
    goto anon54_Then, anon54_Else;
  ...
  anon49_Else:
    assume {:partition} buffersAssigned == 0;
    call {:si_unique_call 261} FreePool(DeviceExtension_13, checkSums, 1);
    goto L24;
  ...
  anon48_Then:
    assume {:partition} buffersAssigned == 0;
    call {:si_unique_call 262} FreePool(DeviceExtension_13, checkSumsCopy, 1);
    goto L84;

  anon47_Then:
    assume {:partition} buffersAssigned == 0;
    call {:si_unique_call 263} IoFreeMdl(0);
    goto L80;
  ...
  anon38_Then:
    call {:si_unique_call 265} sdv_99 := LockCheckSumArrays(DeviceExtension_13, i_4);
...
implementation {:origName "FatalListEntryError"} FatalListEntryError(actual_p1: int, actual_p2: int, actual_p3: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 268} RtlFailFast(3);
    return;
}
...
implementation {:origName "DataVerFilter_DeviceControl"} DataVerFilter_DeviceControl(actual_DeviceObject_9: int, actual_Irp_14: int) returns (Tmp_232: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 269} vslice_dummy_var_65 := sdv_IoGetCurrentIrpStackLocation(Irp_14);
    status_11 := 0;
    assume {:nonnull} DeviceObject_9 != 0;
    assume DeviceObject_9 > 0;
    call {:si_unique_call 270} status_11 := DataVerFilter_ForwardIrpAsyn(DeviceObject_9, Irp_14, 0, 0);
    goto anon3_Then, anon3_Else;
...
implementation {:origName "DataVerFilter_StartDevice"} DataVerFilter_StartDevice(actual_DeviceObject_10: int, actual_Irp_15: int) returns (Tmp_234: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 272} status_12 := DataVerFilter_ForwardIrpSyn(DeviceObject_10, Irp_15);
    goto anon14_Then, anon14_Else;
  ...
  anon11_Then:
    assume {:nonnull} deviceExtension_5 != 0;
    assume deviceExtension_5 > 0;
    call {:si_unique_call 274} status_12 := GetDeviceDescriptor(deviceExtension_5, 0, StorageDeviceDesc__DEVICE_EXTENSION(deviceExtension_5));
    goto anon15_Then, anon15_Else;
  ...
  anon12_Else:
    assume {:partition} status_12 >= 0;
    call {:si_unique_call 275} Tmp_241 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_241 != 0;
    assume Tmp_241 > 0;
    havoc vslice_dummy_var_18;
    Mem_T.INT4[Tmp_241] := vslice_dummy_var_18;
    call {:si_unique_call 276} sdv_109 := sdv_InterlockedIncrement(Tmp_241);
    assume {:nonnull} Tmp_241 != 0;
    assume Tmp_241 > 0;
    assume {:nonnull} deviceExtension_5 != 0;
    assume deviceExtension_5 > 0;
...
implementation {:origName "DataVerFilter_RemoveDevice"} DataVerFilter_RemoveDevice(actual_DeviceObject_11: int, actual_Irp_16: int) returns (Tmp_243: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 277} sdv_do_paged_code_check();
    assume {:nonnull} deviceExtension_6 != 0;
    assume deviceExtension_6 > 0;
    call {:si_unique_call 278} status_13 := DataVerFilter_ForwardIrpAsyn(DeviceObject_11, Irp_16, 0, 0);
    goto anon11_Then, anon11_Else;

  anon11_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 279} IoDetachDevice(0);
    call {:si_unique_call 280} FreeAllPages(deviceExtension_6);
    goto anon12_Then, anon12_Else;
  ...
  anon9_Else:
    ...
    call {:si_unique_call 281} FreePool(deviceExtension_6, vslice_dummy_var_19, 512);
    goto L21;
  ...
  anon10_Else:
    ...
    call {:si_unique_call 282} FreePool(deviceExtension_6, vslice_dummy_var_20, 512);
    goto L25;

  L25:
    call {:si_unique_call 283} IoFreeWorkItem(0);
    call {:si_unique_call 284} IoFreeWorkItem(0);
    call {:si_unique_call 285} vslice_dummy_var_66 := sdv_RemoveEntryList(0);
    assume {:nonnull} deviceExtension_6 != 0;
    assume deviceExtension_6 > 0;
    call {:si_unique_call 286} InitializeListHead(AllContextsListEntry__DEVICE_EXTENSION(deviceExtension_6));
...
implementation {:origName "CrcScsiReadCapacityCompletion"} CrcScsiReadCapacityCompletion(actual_DeviceObject_12: int, actual_Irp_17: int, actual_pContext_3: int) returns (Tmp_245: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 288} Tmp_246 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_246 != 0;
    assume Tmp_246 > 0;
    Mem_T.INT4[Tmp_246] := oldIrql_7;
    call {:si_unique_call 289} sdv_KeAcquireSpinLock(0, Tmp_246);
    assume {:nonnull} Tmp_246 != 0;
    assume Tmp_246 > 0;
  ...
  L17:
    call {:si_unique_call 290} sdv_KeReleaseSpinLock(0, oldIrql_7);
    goto anon20_Then, anon20_Else;
  ...
  anon18_Else:
    ...
    call {:si_unique_call 291} IoQueueWorkItem#1(vslice_dummy_var_21, li2bplFunctionConstant219, 1, deviceExtension_7);
    goto anon21_Then, anon21_Else;
  ...
  anon19_Else:
    call {:si_unique_call 292} sdv_IoMarkIrpPending(0);
    goto L27;
...
implementation {:origName "CompleteXfer"} CompleteXfer(actual_DeviceExtension_14: int, actual_Irp_18: int)
{
  ...
  anon0:
    call {:si_unique_call 293} vslice_dummy_var_67 := __HAVOC_malloc(4);
    call {:si_unique_call 294} tmp := __HAVOC_malloc(4);
    DeviceExtension_14 := actual_DeviceExtension_14;
    Irp_18 := actual_Irp_18;
    call {:si_unique_call 295} Tmp_249 := __HAVOC_malloc(16);
    call {:si_unique_call 296} Tmp_250 := __HAVOC_malloc(16);
    assume {:nonnull} DeviceExtension_14 != 0;
    assume DeviceExtension_14 > 0;
    goto anon29_Then, anon29_Else;

  anon29_Else:
    call {:si_unique_call 297} irpStack_2 := sdv_IoGetCurrentIrpStackLocation(Irp_18);
  ...
  anon35_Else:
    ...
    call {:si_unique_call 298} sdv_113 := sdv_MmGetSystemAddressForMdlSafe(0, 16);
    pDataBuf := sdv_113;
    goto anon41_Then, anon41_Else;

  anon41_Else:
    assume {:partition} pDataBuf != 0;
    call {:si_unique_call 299} vslice_dummy_var_69 := sdv_MmGetMdlVirtualAddress(0);
    call {:si_unique_call 300} vslice_dummy_var_71 := VerifyCheckSum(DeviceExtension_14, Irp_18, ulLogicalBlockAddr_4, ulLength_1, pDataBuf, 0);
    goto anon42_Then, anon42_Else;
  ...
  L87:
    call {:si_unique_call 301} sdv_RtlCopyMemory(0, 0, ulLength_1);
    call {:si_unique_call 302} IoFreeMdl(0);
    assume {:nonnull} pSRB_1 != 0;
    assume pSRB_1 > 0;
    havoc vslice_dummy_var_22;
    call {:si_unique_call 303} FreePool(DeviceExtension_14, vslice_dummy_var_22, 512);
    assume {:nonnull} Irp_18 != 0;
    assume Irp_18 > 0;
    assume {:nonnull} PCrcContext != 0;
    assume PCrcContext > 0;
  ...
  L43:
    call {:si_unique_call 304} FreePool(DeviceExtension_14, PCrcContext, 512);
    goto L1;
  ...
  anon35_Then:
    ...
    call {:si_unique_call 305} LogCRCReadFailure(vslice_dummy_var_23, ulLogicalBlockAddr_4, ulBlocks_2, srbStat);
    goto L87;
  ...
  anon33_Else:
    assume {:partition} srbStat == 1;
    call {:si_unique_call 306} sdv_115 := sdv_MmGetSystemAddressForMdlSafe(0, 16);
    pDataBuf := sdv_115;
  ...
  anon34_Else:
    assume {:partition} pDataBuf != 0;
    call {:si_unique_call 307} vslice_dummy_var_68 := sdv_MmGetMdlVirtualAddress(0);
    call {:si_unique_call 308} vslice_dummy_var_70 := VerifyCheckSum(DeviceExtension_14, Irp_18, ulLogicalBlockAddr_4, ulLength_1, pDataBuf, 1);
    goto anon37_Then, anon37_Else;
  ...
  anon36_Then:
    assume {:partition} pDataBuf == 0;
    call {:si_unique_call 310} sdv_116 := sdv_MmGetSystemAddressForMdlSafe(0, 32);
    pDataBuf := sdv_116;
    goto L59;

  anon33_Then:
    assume {:partition} srbStat != 1;
    call {:si_unique_call 311} InvalidateChecksums(DeviceExtension_14, ulLogicalBlockAddr_4, ulLength_1);
    goto anon39_Then, anon39_Else;
  ...
  anon39_Else:
    ...
    call {:si_unique_call 312} LogCRCWriteFailure(vslice_dummy_var_24, ulLogicalBlockAddr_4, 0, srbStat);
    assume {:nonnull} DeviceExtension_14 != 0;
    assume DeviceExtension_14 > 0;
    goto L43;
...
implementation {:origName "DataVerFilter_DispatchAny"} DataVerFilter_DispatchAny(actual_DeviceObject_13: int, actual_Irp_19: int) returns (Tmp_251: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 313} vslice_dummy_var_72 := sdv_IoGetCurrentIrpStackLocation(Irp_19);
    status_15 := 0;
    assume {:nonnull} DeviceObject_13 != 0;
    assume DeviceObject_13 > 0;
    call {:si_unique_call 314} status_15 := DataVerFilter_ForwardIrpAsyn(DeviceObject_13, Irp_19, 0, 0);
    goto anon3_Then, anon3_Else;
...
implementation {:origName "_sdv_init1"} _sdv_init1()
{
  ...
  anon0:
    call {:si_unique_call 315} vslice_dummy_var_73 := __HAVOC_malloc(4);
...
implementation {:origName "CrcScsiWriteCompletion"} CrcScsiWriteCompletion(actual_DeviceObject_14: int, actual_Irp_20: int, actual_pContext_4: int) returns (Tmp_255: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 316} Tmp_256 := __HAVOC_malloc(16);
    call {:si_unique_call 317} Tmp_258 := __HAVOC_malloc(16);
    ...
    assume Tmp_256 > 0;
    call {:si_unique_call 318} CompleteXfer(deviceExtension_9, Irp_20);
    goto anon6_Then, anon6_Else;
  ...
  anon5_Else:
    call {:si_unique_call 319} sdv_IoMarkIrpPending(0);
    goto L13;
...
implementation {:origName "CrcScsiRead"} CrcScsiRead(actual_DeviceObject_15: int, actual_Irp_21: int) returns (Tmp_259: int)
{
  ...
  anon0:
    call {:si_unique_call 320} ulLogicalBlockAddr_5 := __HAVOC_malloc(4);
    ...
    call {:si_unique_call 321} irpStack_4 := sdv_IoGetCurrentIrpStackLocation(Irp_21);
  ...
  anon24_Else:
    ...
    call {:si_unique_call 322} sdv_127 := AllocPool(deviceExtension_10, 512, 20, 0);
    PCrcContext_2 := sdv_127;
  ...
  anon27_Else:
    ...
    call {:si_unique_call 323} sdv_129 := AllocPool(deviceExtension_10, 512, ulLength_2, 0);
    TempDataBuff := sdv_129;
    goto anon28_Then, anon28_Else;

  anon28_Else:
    assume {:partition} TempDataBuff != 0;
    call {:si_unique_call 324} TempMdl := IoAllocateMdl(0, ulLength_2, 0, 0, 0);
  ...
  anon25_Else:
    ...
    assume {:nonnull} PCrcContext_2 != 0;
    assume PCrcContext_2 > 0;
    call {:si_unique_call 325} sdv_130 := sdv_MmGetSystemAddressForMdlSafe(0, 16);
    sysAddr := sdv_130;
    goto anon29_Then, anon29_Else;
  ...
  anon29_Else:
    ...
    assume {:nonnull} pSRB_2 != 0;
    assume pSRB_2 > 0;
    call {:si_unique_call 326} vslice_dummy_var_74 := sdv_MmGetMdlVirtualAddress(0);
    assume {:nonnull} PCrcContext_2 != 0;
    assume PCrcContext_2 > 0;
    assume {:nonnull} Irp_21 != 0;
    assume Irp_21 > 0;
  ...
  L84:
    call {:si_unique_call 327} Tmp_259 := DataVerFilter_ForwardIrpAsyn(DeviceObject_15, Irp_21, li2bplFunctionConstant213, PCrcContext_2);
    goto anon30_Then, anon30_Else;
  ...
  anon29_Then:
    ...
    assume {:nonnull} PCrcContext_2 != 0;
    assume PCrcContext_2 > 0;
    call {:si_unique_call 328} FreePool(deviceExtension_10, TempDataBuff, 512);
    call {:si_unique_call 329} IoFreeMdl(0);
    call {:si_unique_call 330} Tmp_259 := DataVerFilter_ForwardIrpAsyn(DeviceObject_15, Irp_21, li2bplFunctionConstant213, PCrcContext_2);
    goto anon31_Then, anon31_Else;
  ...
  anon25_Then:
    ...
    assume {:nonnull} PCrcContext_2 != 0;
    assume PCrcContext_2 > 0;
    call {:si_unique_call 331} FreePool(deviceExtension_10, TempDataBuff, 512);
    goto L84;
  ...
  anon27_Then:
    assume {:partition} PCrcContext_2 == 0;
    call {:si_unique_call 332} Tmp_259 := DataVerFilter_ForwardIrpAsyn(DeviceObject_15, Irp_21, 0, 0);
    goto anon32_Then, anon32_Else;
  ...
  L39:
    call {:si_unique_call 333} Tmp_259 := DataVerFilter_ForwardIrpAsyn(DeviceObject_15, Irp_21, 0, 0);
    goto anon33_Then, anon33_Else;
...
implementation {:origName "__AssumeBoundInt"} __AssumeBoundInt(actual_i_5: int)
{
  ...
  anon0:
    call {:si_unique_call 334} vslice_dummy_var_75 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "InitiateCRCTable"} InitiateCRCTable(actual_DeviceExtension_15: int) returns (Tmp_263: int)
{
  ...
  anon7_Then:
    ...
    call {:si_unique_call 336} __AssumeBoundInt(vslice_dummy_var_25);
    assume {:nonnull} DeviceExtension_15 != 0;
    assume DeviceExtension_15 > 0;
    assume {:nonnull} DeviceExtension_15 != 0;
    assume DeviceExtension_15 > 0;
    havoc Tmp_265;
    call {:si_unique_call 337} sdv_132 := AllocPool(DeviceExtension_15, 512, Tmp_265, 1);
    assume {:nonnull} DeviceExtension_15 != 0;
    assume DeviceExtension_15 > 0;
    assume {:nonnull} DeviceExtension_15 != 0;
    assume DeviceExtension_15 > 0;
  ...
  anon9_Else:
    assume {:nonnull} DeviceExtension_15 != 0;
    assume DeviceExtension_15 > 0;
    call {:si_unique_call 338} InitializeListHead(LockedLRUList__CRC_MDL_ARRAY(CRCMdlLists__DEVICE_EXTENSION(DeviceExtension_15)));
    i_6 := 0;
    goto L26;

  L26:
    call {:si_unique_call 339} i_6, Tmp_264, Tmp_266, Tmp_267 := InitiateCRCTable_loop_L26(i_6, Tmp_264, Tmp_266, Tmp_267, DeviceExtension_15);
    goto L26_last;
  ...
  anon8_Else:
    ...
    call {:si_unique_call 340} InitializeListHead(Tmp_266);
    i_6 := i_6 + 1;
...
implementation {:origName "ReadCapacityWorkItemCallback"} ReadCapacityWorkItemCallback(actual_DevObj_1: int, actual_Context_6: int)
{
  ...
  anon0:
    call {:si_unique_call 341} vslice_dummy_var_76 := __HAVOC_malloc(4);
    call {:si_unique_call 342} ulSectorSize := __HAVOC_malloc(4);
    call {:si_unique_call 343} ulNumSectors := __HAVOC_malloc(4);
    Context_6 := actual_Context_6;
    deviceExtension_11 := Context_6;
    call {:si_unique_call 344} Tmp_272 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_272 != 0;
    assume Tmp_272 > 0;
    Mem_T.INT4[Tmp_272] := oldIrql_8;
    call {:si_unique_call 345} sdv_KeAcquireSpinLock(0, Tmp_272);
    assume {:nonnull} Tmp_272 != 0;
    assume Tmp_272 > 0;
    ...
    assume {:nonnull} deviceExtension_11 != 0;
    assume deviceExtension_11 > 0;
    call {:si_unique_call 346} sdv_KeReleaseSpinLock(0, oldIrql_8);
    goto anon37_Then, anon37_Else;

  anon37_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 347} irpStack_5 := sdv_IoGetCurrentIrpStackLocation(readCapacityIrp);
  ...
  anon30_Else:
    ...
    call {:si_unique_call 348} AcquirePassiveLevelLock(deviceExtension_11);
    call {:si_unique_call 349} Tmp_272 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_272 != 0;
    assume Tmp_272 > 0;
    Mem_T.INT4[Tmp_272] := oldIrql_8;
    call {:si_unique_call 350} sdv_KeAcquireSpinLock(0, Tmp_272);
    assume {:nonnull} Tmp_272 != 0;
    assume Tmp_272 > 0;
    oldIrql_8 := Mem_T.INT4[Tmp_272];
    assume {:nonnull} deviceExtension_11 != 0;
    ...
    assume {:nonnull} deviceExtension_11 != 0;
    assume deviceExtension_11 > 0;
    call {:si_unique_call 351} sdv_KeReleaseSpinLock(0, oldIrql_8);
    goto anon39_Then, anon39_Else;
  ...
  anon31_Else:
    ...
    call {:si_unique_call 352} FreeAllPages(deviceExtension_11);
    goto anon40_Then, anon40_Else;
  ...
  anon40_Else:
    ...
    call {:si_unique_call 353} FreePool(deviceExtension_11, vslice_dummy_var_26, 512);
    assume {:nonnull} deviceExtension_11 != 0;
    assume deviceExtension_11 > 0;
    goto L64;
  ...
  L73:
    call {:si_unique_call 354} ReadCapacityWorkItemCallback_loop_L73(ulSectorSize);
    goto L73_last;
  ...
  anon34_Else:
    call {:si_unique_call 355} status_17 := InitiateCRCTable(deviceExtension_11);
    goto anon35_Then, anon35_Else;
  ...
  L95:
    call {:si_unique_call 356} Tmp_274 := ReadCapacityWorkItemCallback_loop_L95(s_p_e_c_i_a_l_1, deviceExtension_11, Tmp_274);
    goto L95_last;
  ...
  L78:
    call {:si_unique_call 357} ReleasePassiveLevelLock(deviceExtension_11);
    goto L48;
...
implementation {:origName "InitializeListHead"} InitializeListHead(actual_ListHead_1: int)
{
  ...
  anon0:
    call {:si_unique_call 360} vslice_dummy_var_77 := __HAVOC_malloc(4);
...
implementation {:origName "DoCriticalRecovery"} DoCriticalRecovery(actual_DeviceExtension_16: int)
{
  ...
  anon0:
    call {:si_unique_call 361} vslice_dummy_var_78 := __HAVOC_malloc(4);
  ...
  L12:
    call {:si_unique_call 362} sdv_135, listEntry_3, defCheckEntry_3, oldIrql_9, sdv_137, Tmp_280 := DoCriticalRecovery_loop_L12(sdv_135, listEntry_3, defCheckEntry_3, oldIrql_9, sdv_137, Tmp_280, DeviceExtension_16);
    goto L12_last;

  L12_last:
    call {:si_unique_call 370} Tmp_280 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_280 != 0;
    assume Tmp_280 > 0;
    Mem_T.INT4[Tmp_280] := oldIrql_9;
    call {:si_unique_call 371} sdv_KeAcquireSpinLock(0, Tmp_280);
    assume {:nonnull} Tmp_280 != 0;
    assume Tmp_280 > 0;
    oldIrql_9 := Mem_T.INT4[Tmp_280];
    call {:si_unique_call 372} sdv_135 := sdv_IsListEmpty(0);
    goto anon14_Then, anon14_Else;
  ...
  anon14_Else:
    ...
    assume {:nonnull} DeviceExtension_16 != 0;
    assume DeviceExtension_16 > 0;
    call {:si_unique_call 363} listEntry_3 := RemoveHeadList(DeferredCheckSumList__DEVICE_EXTENSION(DeviceExtension_16));
    call {:si_unique_call 364} InitializeListHead(listEntry_3);
    call {:si_unique_call 365} sdv_137 := sdv_containing_record(listEntry_3, 0);
    defCheckEntry_3 := sdv_137;
    goto L21;

  L21:
    call {:si_unique_call 366} sdv_KeReleaseSpinLock(0, oldIrql_9);
    goto anon17_Then, anon17_Else;
  ...
  anon15_Else:
    ...
    call {:si_unique_call 367} FreeDeferredCheckSumEntry(DeviceExtension_16, defCheckEntry_3);
  ...
  L43:
    call {:si_unique_call 368} Tmp_279 := DoCriticalRecovery_loop_L43(s_p_e_c_i_a_l_2, Tmp_279, DeviceExtension_16);
    goto L43_last;
  ...
  anon13_Then:
    call {:si_unique_call 369} FreeAllPages(DeviceExtension_16);
    goto anon16_Then, anon16_Else;
...
implementation {:origName "DataVerFilter_DispatchPower"} DataVerFilter_DispatchPower(actual_DeviceObject_16: int, actual_Irp_22: int) returns (Tmp_281: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 373} irpSp_3 := sdv_IoGetCurrentIrpStackLocation(Irp_22);
  ...
  anon16_Else:
    call {:si_unique_call 374} Tmp_282 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_282 != 0;
    assume Tmp_282 > 0;
    Mem_T.INT4[Tmp_282] := oldIrql_10;
    call {:si_unique_call 375} sdv_KeAcquireSpinLock(0, Tmp_282);
    assume {:nonnull} Tmp_282 != 0;
    assume Tmp_282 > 0;
  ...
  L24:
    assume {:nonnull} deviceExtension_12 != 0;
    assume deviceExtension_12 > 0;
    call {:si_unique_call 376} sdv_KeReleaseSpinLock(0, oldIrql_10);
    goto anon19_Then, anon19_Else;
  ...
  L12:
    ...
    call {:si_unique_call 378} sdv_IoSkipCurrentIrpStackLocation(Irp_22);
    call {:si_unique_call 379} status_18 := PoCallDriver(0, Irp_22);
    goto anon20_Then, anon20_Else;
  ...
  anon18_Then:
    ...
    call {:si_unique_call 380} IoQueueWorkItem#1(vslice_dummy_var_27, li2bplFunctionConstant212, 0, deviceExtension_12);
    goto anon21_Then, anon21_Else;
...
implementation {:origName "RemoveHeadList"} RemoveHeadList(actual_ListHead_2: int) returns (Tmp_283: int)
{
  ...
  L9:
    call {:si_unique_call 381} FatalListEntryError(ListHead_2, Entry_1, NextEntry);
    goto L12;
...
implementation {:origName "DataVerFilter_DispatchPnp"} DataVerFilter_DispatchPnp(actual_DeviceObject_17: int, actual_Irp_23: int) returns (Tmp_285: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 382} irpStack_6 := sdv_IoGetCurrentIrpStackLocation(Irp_23);
  ...
  L24:
    assume {:nonnull} deviceExtension_13 != 0;
    assume deviceExtension_13 > 0;
    call {:si_unique_call 384} status_19 := DataVerFilter_ForwardIrpAsyn(DeviceObject_17, Irp_23, 0, 0);
    goto anon23_Then, anon23_Else;
  ...
  anon18_Then:
    call {:si_unique_call 385} status_19 := DataVerFilter_ForwardIrpAsyn(DeviceObject_17, Irp_23, 0, 0);
    goto anon24_Then, anon24_Else;
  ...
  anon20_Then:
    call {:si_unique_call 386} status_19 := DataVerFilter_RemoveDevice(DeviceObject_17, Irp_23);
    goto anon22_Then, anon22_Else;
  ...
  anon17_Then:
    call {:si_unique_call 387} status_19 := DataVerFilter_StartDevice(DeviceObject_17, Irp_23);
    goto anon21_Then, anon21_Else;
...
implementation {:origName "RtlFailFast"} RtlFailFast(actual_Code: int)
{
  ...
  anon0:
    call {:si_unique_call 388} vslice_dummy_var_79 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "CrcScsiReadCompletion"} CrcScsiReadCompletion(actual_DeviceObject_18: int, actual_Irp_24: int, actual_pContext_5: int) returns (Tmp_289: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 389} Tmp_290 := __HAVOC_malloc(16);
    call {:si_unique_call 390} Tmp_292 := __HAVOC_malloc(16);
    ...
    assume Tmp_290 > 0;
    call {:si_unique_call 391} CompleteXfer(deviceExtension_14, Irp_24);
    goto anon6_Then, anon6_Else;
  ...
  anon5_Else:
    call {:si_unique_call 392} sdv_IoMarkIrpPending(0);
    goto L13;
...
implementation {:origName "CrcScsiWrite"} CrcScsiWrite(actual_DeviceObject_19: int, actual_Irp_25: int) returns (Tmp_293: int)
{
  ...
  anon0:
    call {:si_unique_call 393} ulLogicalBlockAddr_6 := __HAVOC_malloc(4);
    ...
    call {:si_unique_call 394} irpStack_7 := sdv_IoGetCurrentIrpStackLocation(Irp_25);
  ...
  anon18_Else:
    call {:si_unique_call 395} sdv_147 := AllocPool(deviceExtension_15, 512, 20, 0);
    pCrcContext := sdv_147;
    goto anon20_Then, anon20_Else;
  ...
  anon20_Else:
    ...
    call {:si_unique_call 396} status_20 := DataVerFilter_ForwardIrpAsyn(DeviceObject_19, Irp_25, li2bplFunctionConstant216, pCrcContext);
    goto anon21_Then, anon21_Else;
  ...
  anon20_Then:
    ...
    assume {:nonnull} ulLogicalBlockAddr_6 != 0;
    assume ulLogicalBlockAddr_6 > 0;
    call {:si_unique_call 397} InvalidateChecksums(deviceExtension_15, Mem_T.INT4[ulLogicalBlockAddr_6], ulLength_3);
    goto anon22_Then, anon22_Else;

  anon22_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 398} status_20 := DataVerFilter_ForwardIrpAsyn(DeviceObject_19, Irp_25, 0, 0);
    goto anon23_Then, anon23_Else;
  ...
  L37:
    call {:si_unique_call 399} status_20 := DataVerFilter_ForwardIrpAsyn(DeviceObject_19, Irp_25, 0, 0);
    goto anon24_Then, anon24_Else;
...
implementation {:origName "CrcScsi"} CrcScsi(actual_DeviceObject_20: int, actual_Irp_26: int) returns (Tmp_295: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 400} irpStack_8 := sdv_IoGetCurrentIrpStackLocation(Irp_26);
  ...
  L22:
    call {:si_unique_call 401} status_21 := DataVerFilter_ForwardIrpAsyn(DeviceObject_20, Irp_26, 0, 0);
    goto anon27_Then, anon27_Else;
  ...
  anon25_Else:
    call {:si_unique_call 402} sdv_IoMarkIrpPending(0);
    call {:si_unique_call 403} vslice_dummy_var_80 := DataVerFilter_ForwardIrpAsyn(DeviceObject_20, Irp_26, li2bplFunctionConstant218, deviceExtension_16);
    goto anon28_Then, anon28_Else;
  ...
  anon23_Else:
    call {:si_unique_call 404} status_21 := CrcScsiWrite(DeviceObject_20, Irp_26);
    goto anon29_Then, anon29_Else;
  ...
  anon21_Else:
    call {:si_unique_call 405} status_21 := CrcScsiRead(DeviceObject_20, Irp_26);
    goto anon30_Then, anon30_Else;
...
const {:string "sdv_KeReleaseSpinLock must restore old IRQL value."} unique strConst__li2bpl1: int;

const {:string "sdv_KeReleaseSpinLock should only be called at IRQL = DISPATCH_LEVEL."} unique strConst__li2bpl0: int;
...
implementation {:origName "SdvExit"} {:osmodel} SdvExit#0()
{
  ...
  anon0:
    call {:si_unique_call 406} vslice_dummy_var_81 := __HAVOC_malloc(4);
    assume false;
    assume false;
    return;
}
...
implementation {:origName "SdvExit"} {:osmodel} SdvExit#1()
{
  ...
  anon0:
    call {:si_unique_call 407} vslice_dummy_var_82 := __HAVOC_malloc(4);
    assume false;
    call {:si_unique_call 408} SdvExit#0();
    return;
}
...
implementation {:origName "VerifyOrStoreSectorCheckSum"} VerifyOrStoreSectorCheckSum#0(actual_DeviceExtension_1: int, actual_SectorNum: int, actual_CheckSum: int, actual_IsWrite: int, actual_PagingOk: int, actual_OriginalIrpOrCopy: int, actual_IsSynchronousCheck: int)
{
  ...
  anon0:
    call {:si_unique_call 409} vslice_dummy_var_83 := __HAVOC_malloc(4);
    DeviceExtension_1 := actual_DeviceExtension_1;
  ...
  anon85_Else:
    assume {:partition} PagingOk != 0;
    call {:si_unique_call 410} Tmp_15 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_15 != 0;
    assume Tmp_15 > 0;
    Mem_T.INT4[Tmp_15] := oldIrql;
    call {:si_unique_call 411} sdv_KeAcquireSpinLock(0, Tmp_15);
    assume {:nonnull} Tmp_15 != 0;
    assume Tmp_15 > 0;
  ...
  anon100_Else:
    ...
    call {:si_unique_call 412} KeBugCheckEx(196, 162, OriginalIrpOrCopy, vslice_dummy_var_28, SectorNum);
    goto L50;

  L50:
    assume {:nonnull} DeviceExtension_1 != 0;
    assume DeviceExtension_1 > 0;
    call {:si_unique_call 413} UpdateRegionAccessTimeStamp(DeviceExtension_1, regionIndex);
    goto anon86_Then, anon86_Else;

  anon86_Else:
    assume {:partition} PagingOk != 0;
    call {:si_unique_call 414} sdv_KeReleaseSpinLock(0, oldIrql);
    goto anon101_Then, anon101_Else;
  ...
  anon82_Else:
    assume {:partition} PagingOk == 0;
    call {:si_unique_call 415} sdv_KeReleaseSpinLock(0, oldIrql);
    goto anon102_Then, anon102_Else;
  ...
  anon94_Else:
    ...
    call {:si_unique_call 416} FreeDeferredCheckSumEntry(DeviceExtension_1, defCheckEntry);
    goto L1;
  ...
  L68:
    ...
    call {:si_unique_call 417} KeBugCheckEx(196, Tmp_23, OriginalIrpOrCopy, vslice_dummy_var_29, SectorNum);
    goto L50;
  ...
  L79:
    call {:si_unique_call 418} sdv_RtlCopyMemory(0, 0, Tmp_30);
    goto anon91_Then, anon91_Else;

  anon91_Else:
    assume {:partition} IsSynchronousCheck != 0;
    call {:si_unique_call 419} irpSp := sdv_IoGetCurrentIrpStackLocation(OriginalIrpOrCopy);
    assume {:nonnull} irpSp != 0;
    assume irpSp > 0;
    havoc Tmp_26;
  ...
  L94:
    mdlCopyBytes := Tmp_6;
    call {:si_unique_call 420} sdv_RtlCopyMemory(0, 0, mdlCopyBytes);
    goto L73;
  ...
  L73:
    ...
    assume {:nonnull} defCheckEntry != 0;
    assume defCheckEntry > 0;
    call {:si_unique_call 421} vslice_dummy_var_84 := sdv_InsertTailList(DeferredCheckSumList__DEVICE_EXTENSION(DeviceExtension_1), ListEntry__DEFERRED_CHECKSUM_ENTRY(defCheckEntry));
    assume {:nonnull} DeviceExtension_1 != 0;
    assume DeviceExtension_1 > 0;
    goto anon92_Then, anon92_Else;
  ...
  anon92_Then:
    ...
    call {:si_unique_call 422} IoQueueWorkItem#0(vslice_dummy_var_30, li2bplFunctionConstant212, 2, DeviceExtension_1);
    goto anon108_Then, anon108_Else;
  ...
  anon109_Else:
    ...
    call {:si_unique_call 423} IoQueueWorkItem#0(vslice_dummy_var_31, li2bplFunctionConstant212, 2, DeviceExtension_1);
  ...
  L135:
    call {:si_unique_call 424} thisDefEntry, listEntry, sdv_3 := VerifyOrStoreSectorCheckSum#0_loop_L135(thisDefEntry, listEntry, sdv_3, SectorNum);
    goto L135_last;
  ...
  anon98_Else:
    call {:si_unique_call 425} sdv_3 := sdv_containing_record(listEntry, 0);
    thisDefEntry := sdv_3;
  ...
  anon79_Then:
    assume {:partition} PagingOk != 0;
    call {:si_unique_call 426} allocStatus := AllocAndMapPages(DeviceExtension_1, SectorNum, 1);
  ...
  anon99_Then:
    assume {:partition} PagingOk == 0;
    call {:si_unique_call 427} defCheckEntry := NewDeferredCheckSumEntry(DeviceExtension_1, SectorNum, CheckSum, IsWrite);
    call {:si_unique_call 428} Tmp_15 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_15 != 0;
    assume Tmp_15 > 0;
    Mem_T.INT4[Tmp_15] := oldIrql;
    call {:si_unique_call 429} sdv_KeAcquireSpinLock(0, Tmp_15);
    assume {:nonnull} Tmp_15 != 0;
    assume Tmp_15 > 0;
    oldIrql := Mem_T.INT4[Tmp_15];
    goto L19;
...
implementation {:origName "VerifyOrStoreSectorCheckSum"} VerifyOrStoreSectorCheckSum#1(actual_DeviceExtension_1: int, actual_SectorNum: int, actual_CheckSum: int, actual_IsWrite: int, actual_PagingOk: int, actual_OriginalIrpOrCopy: int, actual_IsSynchronousCheck: int)
{
  ...
  anon0:
    call {:si_unique_call 430} vslice_dummy_var_85 := __HAVOC_malloc(4);
    DeviceExtension_1 := actual_DeviceExtension_1;
    SectorNum := actual_SectorNum;
    CheckSum := actual_CheckSum;
    IsWrite := actual_IsWrite;
  ...
  anon85_Else:
    assume {:partition} PagingOk != 0;
    call {:si_unique_call 431} Tmp_15 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_15 != 0;
    assume Tmp_15 > 0;
    Mem_T.INT4[Tmp_15] := oldIrql;
    call {:si_unique_call 432} sdv_KeAcquireSpinLock(0, Tmp_15);
    assume {:nonnull} Tmp_15 != 0;
    assume Tmp_15 > 0;
    oldIrql := Mem_T.INT4[Tmp_15];
    goto L38;
  ...
  anon100_Else:
    ...
    call {:si_unique_call 433} KeBugCheckEx(196, 162, OriginalIrpOrCopy, vslice_dummy_var_32, SectorNum);
    goto L50;

  L50:
    assume {:nonnull} DeviceExtension_1 != 0;
    assume DeviceExtension_1 > 0;
    call {:si_unique_call 434} UpdateRegionAccessTimeStamp(DeviceExtension_1, regionIndex);
    goto anon86_Then, anon86_Else;

  anon86_Else:
    assume {:partition} PagingOk != 0;
    call {:si_unique_call 435} sdv_KeReleaseSpinLock(0, oldIrql);
    goto anon101_Then, anon101_Else;
  ...
  anon82_Else:
    assume {:partition} PagingOk == 0;
    call {:si_unique_call 436} sdv_KeReleaseSpinLock(0, oldIrql);
    goto anon102_Then, anon102_Else;
  ...
  anon94_Else:
    assume {:partition} defCheckEntry != 0;
    call {:si_unique_call 437} FreeDeferredCheckSumEntry(DeviceExtension_1, defCheckEntry);
    goto L1;
  ...
  L68:
    ...
    call {:si_unique_call 438} KeBugCheckEx(196, Tmp_23, OriginalIrpOrCopy, vslice_dummy_var_33, SectorNum);
    goto L50;
  ...
  L79:
    call {:si_unique_call 439} sdv_RtlCopyMemory(0, 0, Tmp_30);
    goto anon91_Then, anon91_Else;

  anon91_Else:
    assume {:partition} IsSynchronousCheck != 0;
    call {:si_unique_call 440} irpSp := sdv_IoGetCurrentIrpStackLocation(OriginalIrpOrCopy);
    assume {:nonnull} irpSp != 0;
    assume irpSp > 0;
    havoc Tmp_26;
    assume {:nonnull} Tmp_26 != 0;
  ...
  L94:
    mdlCopyBytes := Tmp_6;
    call {:si_unique_call 441} sdv_RtlCopyMemory(0, 0, mdlCopyBytes);
    goto L73;
  ...
  L73:
    ...
    assume {:nonnull} defCheckEntry != 0;
    assume defCheckEntry > 0;
    call {:si_unique_call 442} vslice_dummy_var_86 := sdv_InsertTailList(DeferredCheckSumList__DEVICE_EXTENSION(DeviceExtension_1), ListEntry__DEFERRED_CHECKSUM_ENTRY(defCheckEntry));
    assume {:nonnull} DeviceExtension_1 != 0;
    assume DeviceExtension_1 > 0;
    goto anon92_Then, anon92_Else;
  ...
  anon92_Then:
    ...
    call {:si_unique_call 443} IoQueueWorkItem#1(vslice_dummy_var_34, li2bplFunctionConstant212, 2, DeviceExtension_1);
    goto anon108_Then, anon108_Else;
  ...
  anon109_Else:
    ...
    call {:si_unique_call 444} IoQueueWorkItem#1(vslice_dummy_var_35, li2bplFunctionConstant212, 2, DeviceExtension_1);
    goto anon110_Then, anon110_Else;
  ...
  L135:
    call {:si_unique_call 445} thisDefEntry, listEntry, sdv_3 := VerifyOrStoreSectorCheckSum#1_loop_L135(thisDefEntry, listEntry, sdv_3, SectorNum);
    goto L135_last;
  ...
  anon98_Else:
    call {:si_unique_call 446} sdv_3 := sdv_containing_record(listEntry, 0);
    thisDefEntry := sdv_3;
    assume {:nonnull} thisDefEntry != 0;
    assume thisDefEntry > 0;
    goto anon114_Then, anon114_Else;
  ...
  anon79_Then:
    assume {:partition} PagingOk != 0;
    call {:si_unique_call 447} allocStatus := AllocAndMapPages(DeviceExtension_1, SectorNum, 1);
    goto anon111_Then, anon111_Else;
  ...
  anon99_Then:
    assume {:partition} PagingOk == 0;
    call {:si_unique_call 448} defCheckEntry := NewDeferredCheckSumEntry(DeviceExtension_1, SectorNum, CheckSum, IsWrite);
    call {:si_unique_call 449} Tmp_15 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_15 != 0;
    assume Tmp_15 > 0;
    Mem_T.INT4[Tmp_15] := oldIrql;
    call {:si_unique_call 450} sdv_KeAcquireSpinLock(0, Tmp_15);
    assume {:nonnull} Tmp_15 != 0;
    assume Tmp_15 > 0;
    oldIrql := Mem_T.INT4[Tmp_15];
    goto L19;
...
implementation {:origName "IoQueueWorkItem"} {:osmodel} IoQueueWorkItem#0(actual_IoWorkItem_1: int, actual_WorkerRoutine: int, actual_QueueType: int, actual_Context_2: int)
{
  ...
  anon0:
    call {:si_unique_call 451} vslice_dummy_var_87 := __HAVOC_malloc(4);
    WorkerRoutine := actual_WorkerRoutine;
    QueueType := actual_QueueType;
    Context_2 := actual_Context_2;
    call {:si_unique_call 452} sdv_RunIoQueueWorkItems#0(0, WorkerRoutine, QueueType, Context_2);
    goto anon3_Then, anon3_Else;
...
implementation {:origName "IoQueueWorkItem"} {:osmodel} IoQueueWorkItem#1(actual_IoWorkItem_1: int, actual_WorkerRoutine: int, actual_QueueType: int, actual_Context_2: int)
{
  ...
  anon0:
    call {:si_unique_call 453} vslice_dummy_var_88 := __HAVOC_malloc(4);
    WorkerRoutine := actual_WorkerRoutine;
    QueueType := actual_QueueType;
    Context_2 := actual_Context_2;
    call {:si_unique_call 454} sdv_RunIoQueueWorkItems#1(0, WorkerRoutine, QueueType, Context_2);
    goto anon3_Then, anon3_Else;
...
implementation {:origName "sdv_RunIoQueueWorkItems"} {:osmodel} sdv_RunIoQueueWorkItems#0(actual_IoWorkItem_2: int, actual_WorkerRoutine_1: int, actual_QueueType_1: int, actual_Context_3: int)
{
  ...
  anon0:
    call {:si_unique_call 455} vslice_dummy_var_89 := __HAVOC_malloc(4);
  ...
  anon9_Else:
    ...
    sdv_irql_previous := sdv_irql_current;
    sdv_irql_current := 0;
    call {:si_unique_call 456} CheckSumWorkItemCallback#0(sdv_p_devobj_fdo, Context_3);
    goto anon11_Then, anon11_Else;
  ...
  anon10_Else:
    ...
    sdv_irql_previous := sdv_irql_current;
    sdv_irql_current := 0;
    call {:si_unique_call 457} ReadCapacityWorkItemCallback(sdv_p_devobj_fdo, Context_3);
    goto anon12_Then, anon12_Else;
...
implementation {:origName "sdv_RunIoQueueWorkItems"} {:osmodel} sdv_RunIoQueueWorkItems#1(actual_IoWorkItem_2: int, actual_WorkerRoutine_1: int, actual_QueueType_1: int, actual_Context_3: int)
{
  ...
  anon0:
    call {:si_unique_call 458} vslice_dummy_var_90 := __HAVOC_malloc(4);
    WorkerRoutine_1 := actual_WorkerRoutine_1;
    Context_3 := actual_Context_3;
    goto anon9_Then, anon9_Else;
  ...
  anon9_Else:
    ...
    sdv_irql_previous := sdv_irql_current;
    sdv_irql_current := 0;
    call {:si_unique_call 459} CheckSumWorkItemCallback#1(sdv_p_devobj_fdo, Context_3);
    goto anon11_Then, anon11_Else;
  ...
  anon10_Else:
    ...
    sdv_irql_previous := sdv_irql_current;
    sdv_irql_current := 0;
    call {:si_unique_call 460} ReadCapacityWorkItemCallback(sdv_p_devobj_fdo, Context_3);
    goto anon12_Then, anon12_Else;
...
implementation {:origName "CheckSumWorkItemCallback"} CheckSumWorkItemCallback#0(actual_DevObj: int, actual_Context: int)
{
  ...
  anon0:
    call {:si_unique_call 461} vslice_dummy_var_91 := __HAVOC_malloc(4);
    Context := actual_Context;
    DeviceExtension_2 := Context;
    goto L9;

  L9:
    call {:si_unique_call 462} Tmp_42 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_42 != 0;
    assume Tmp_42 > 0;
    Mem_T.INT4[Tmp_42] := oldIrql_1;
    call {:si_unique_call 463} sdv_KeAcquireSpinLock(0, Tmp_42);
    assume {:nonnull} Tmp_42 != 0;
    assume Tmp_42 > 0;
    oldIrql_1 := Mem_T.INT4[Tmp_42];
    call {:si_unique_call 464} sdv_4 := sdv_IsListEmpty(0);
    goto anon16_Then, anon16_Else;
  ...
  anon16_Else:
    ...
    call {:si_unique_call 465} listEntry_1 := RemoveHeadList(DeferredCheckSumList__DEVICE_EXTENSION(DeviceExtension_2));
    call {:si_unique_call 466} InitializeListHead(listEntry_1);
    call {:si_unique_call 467} sdv_6 := sdv_containing_record(listEntry_1, 0);
  ...
  L19:
    call {:si_unique_call 468} sdv_KeReleaseSpinLock(0, oldIrql_1);
    goto anon18_Then, anon18_Else;
  ...
  anon17_Else:
    ...
    call {:si_unique_call 469} AcquirePassiveLevelLock(DeviceExtension_2);
  ...
  anon15_Else:
    call {:si_unique_call 470} AcquirePassiveLevelLock(DeviceExtension_2);
    call {:si_unique_call 471} DoCriticalRecovery(DeviceExtension_2);
    goto anon21_Then, anon21_Else;

  anon21_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 472} ReleasePassiveLevelLock(DeviceExtension_2);
    goto L1;
...
implementation {:origName "CheckSumWorkItemCallback"} CheckSumWorkItemCallback#1(actual_DevObj: int, actual_Context: int)
{
  ...
  anon0:
    call {:si_unique_call 473} vslice_dummy_var_92 := __HAVOC_malloc(4);
    Context := actual_Context;
    DeviceExtension_2 := Context;
    goto L9;

  L9:
    call {:si_unique_call 474} Tmp_42, listEntry_1, sdv_4, defCheckEntry_1, oldIrql_1, sdv_6, Tmp_44 := CheckSumWorkItemCallback#1_loop_L9(Tmp_42, listEntry_1, sdv_4, defCheckEntry_1, DeviceExtension_2, oldIrql_1, sdv_6, Tmp_44);
    goto L9_last;

  L9_last:
    call {:si_unique_call 489} Tmp_42 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_42 != 0;
    assume Tmp_42 > 0;
    Mem_T.INT4[Tmp_42] := oldIrql_1;
    call {:si_unique_call 490} sdv_KeAcquireSpinLock(0, Tmp_42);
    assume {:nonnull} Tmp_42 != 0;
    assume Tmp_42 > 0;
    oldIrql_1 := Mem_T.INT4[Tmp_42];
    call {:si_unique_call 491} sdv_4 := sdv_IsListEmpty(0);
    goto anon16_Then, anon16_Else;
  ...
  anon16_Else:
    ...
    assume {:nonnull} DeviceExtension_2 != 0;
    assume DeviceExtension_2 > 0;
    call {:si_unique_call 475} listEntry_1 := RemoveHeadList(DeferredCheckSumList__DEVICE_EXTENSION(DeviceExtension_2));
    call {:si_unique_call 476} InitializeListHead(listEntry_1);
    call {:si_unique_call 477} sdv_6 := sdv_containing_record(listEntry_1, 0);
    defCheckEntry_1 := sdv_6;
    assume {:nonnull} DeviceExtension_2 != 0;
    assume DeviceExtension_2 > 0;
    goto L19;
  ...
  L19:
    call {:si_unique_call 478} sdv_KeReleaseSpinLock(0, oldIrql_1);
    goto anon18_Then, anon18_Else;
  ...
  anon17_Else:
    assume {:partition} defCheckEntry_1 != 0;
    call {:si_unique_call 479} AcquirePassiveLevelLock(DeviceExtension_2);
    assume {:nonnull} defCheckEntry_1 != 0;
    assume defCheckEntry_1 > 0;
    havoc Tmp_44;
    assume {:nonnull} defCheckEntry_1 != 0;
    ...
    call {:si_unique_call 480} VerifyOrStoreSectorCheckSum#0(DeviceExtension_2, vslice_dummy_var_36, vslice_dummy_var_37, vslice_dummy_var_38, 1, Tmp_44, 0);
    goto anon19_Then, anon19_Else;
  ...
  anon19_Else:
    ...
    assume {:nonnull} DeviceExtension_2 != 0;
    assume DeviceExtension_2 > 0;
    call {:si_unique_call 481} ReleasePassiveLevelLock(DeviceExtension_2);
    call {:si_unique_call 482} FreeDeferredCheckSumEntry(DeviceExtension_2, defCheckEntry_1);
    call {:si_unique_call 483} Tmp_42 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_42 != 0;
    assume Tmp_42 > 0;
    Mem_T.INT4[Tmp_42] := oldIrql_1;
    call {:si_unique_call 484} sdv_KeAcquireSpinLock(0, Tmp_42);
    assume {:nonnull} Tmp_42 != 0;
    assume Tmp_42 > 0;
    oldIrql_1 := Mem_T.INT4[Tmp_42];
    assume {:nonnull} DeviceExtension_2 != 0;
    assume DeviceExtension_2 > 0;
    call {:si_unique_call 485} sdv_KeReleaseSpinLock(0, oldIrql_1);
    goto anon20_Then, anon20_Else;
  ...
  anon15_Else:
    call {:si_unique_call 486} AcquirePassiveLevelLock(DeviceExtension_2);
    call {:si_unique_call 487} DoCriticalRecovery(DeviceExtension_2);
    goto anon21_Then, anon21_Else;

  anon21_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 488} ReleasePassiveLevelLock(DeviceExtension_2);
    goto L1;
...
implementation ComputeCheckSum16_loop_L8(in_i: int, in_Crc: int, in_Tmp_35: int, in_Length: int) returns (out_i: int, out_Crc: int, out_Tmp_35: int)
{
  ...
  anon5_Else:
    ...
    call {:si_unique_call 492} out_Tmp_35 := corral_nondet();
    call {:si_unique_call 493} out_Crc := corral_nondet();
    out_i := out_i + 1;
    goto anon5_Else_dummy;
...
implementation InvalidateChecksums_loop_L12(in_i_1: int, in_endSector: int, in_deviceExtension: int) returns (out_i_1: int)
{
  ...
  anon8_Else:
    ...
    call {:si_unique_call 494} VerifyOrStoreSectorCheckSum#1(in_deviceExtension, out_i_1, 0, 1, 0, 0, 1);
    goto anon9_Else;
  ...
  anon9_Else_dummy:
    call {:si_unique_call 495} {:si_old_unique_call 1} out_i_1 := InvalidateChecksums_loop_L12(out_i_1, in_endSector, in_deviceExtension);
    return;
}
...
implementation VerifyCheckSum_loop_L29(in_i_2: int, in_Tmp_50: int, in_ulCRCDataPtr: int, in_checkSum: int, in_Tmp_51: int, in_Tmp_52: int, in_oldIrql_2: int, in_EndSector: int, in_Tmp_54: int, in_Tmp_55: int, in_Tmp_56: int, in_Tmp_57: int, in_Tmp_58: int, in_deviceExtension_1: int, in_Irp: int, in_pData: int, in_bWrite: int) returns (out_i_2: int, out_Tmp_50: int, out_ulCRCDataPtr: int, out_checkSum: int, out_Tmp_51: int, out_Tmp_52: int, out_oldIrql_2: int, out_Tmp_54: int, out_Tmp_55: int, out_Tmp_56: int, out_Tmp_57: int, out_Tmp_58: int)
{
  ...
  anon9_Else:
    ...
    call {:si_unique_call 497} out_checkSum := ComputeCheckSum16(0, out_Tmp_54, vslice_dummy_var_39);
    call {:si_unique_call 498} out_Tmp_51 := __HAVOC_malloc(4);
    assume {:nonnull} out_Tmp_51 != 0;
    assume out_Tmp_51 > 0;
    Mem_T.INT4[out_Tmp_51] := out_oldIrql_2;
    call {:si_unique_call 499} sdv_KeAcquireSpinLock(0, out_Tmp_51);
    assume {:nonnull} out_Tmp_51 != 0;
    assume out_Tmp_51 > 0;
    ...
    assume {:nonnull} in_deviceExtension_1 != 0;
    assume in_deviceExtension_1 > 0;
    call {:si_unique_call 500} sdv_KeReleaseSpinLock(0, out_oldIrql_2);
    goto anon11_Else;

  anon11_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 496} VerifyOrStoreSectorCheckSum#1(in_deviceExtension_1, out_i_2, out_checkSum, in_bWrite, 0, in_Irp, 1);
    goto anon12_Else;
...
implementation FreeAllPages_loop_L14(in_pCRCMdlItem_2: int, in_i_3: int, in_Tmp_215: int, in_bufToFree: int, in_Tmp_216: int, in_EndIndex: int, in_bufCopyToFree: int, in_oldIrql_4: int, in_Tmp_217: int, in_DeviceExtension_10: int, in_vslice_dummy_var_58: int) returns (out_pCRCMdlItem_2: int, out_i_3: int, out_Tmp_215: int, out_bufToFree: int, out_Tmp_216: int, out_bufCopyToFree: int, out_oldIrql_4: int, out_Tmp_217: int, out_vslice_dummy_var_58: int)
{
  ...
  anon16_Else:
    ...
    out_bufToFree := 0;
    out_bufCopyToFree := 0;
    call {:si_unique_call 507} out_Tmp_215 := __HAVOC_malloc(4);
    assume {:nonnull} out_Tmp_215 != 0;
    assume out_Tmp_215 > 0;
    Mem_T.INT4[out_Tmp_215] := out_oldIrql_4;
    call {:si_unique_call 508} sdv_KeAcquireSpinLock(0, out_Tmp_215);
    assume {:nonnull} out_Tmp_215 != 0;
    assume out_Tmp_215 > 0;
  ...
  anon20_Else:
    call {:si_unique_call 509} MmUnlockPages(0);
    call {:si_unique_call 510} MmUnlockPages(0);
    assume {:nonnull} out_pCRCMdlItem_2 != 0;
    assume out_pCRCMdlItem_2 > 0;
    call {:si_unique_call 511} out_vslice_dummy_var_58 := sdv_RemoveEntryList(0);
    assume {:nonnull} out_pCRCMdlItem_2 != 0;
    assume out_pCRCMdlItem_2 > 0;
    call {:si_unique_call 512} InitializeListHead(LockedLRUListEntry__CRC_MDL_ITEM(out_pCRCMdlItem_2));
    assume {:nonnull} in_DeviceExtension_10 != 0;
    assume in_DeviceExtension_10 > 0;
    goto L34;

  L34:
    call {:si_unique_call 505} IoFreeMdl(0);
    assume {:nonnull} out_pCRCMdlItem_2 != 0;
    assume out_pCRCMdlItem_2 > 0;
    call {:si_unique_call 506} IoFreeMdl(0);
    assume {:nonnull} out_pCRCMdlItem_2 != 0;
    assume out_pCRCMdlItem_2 > 0;
    assume {:nonnull} out_pCRCMdlItem_2 != 0;
    assume out_pCRCMdlItem_2 > 0;
  ...
  L26:
    call {:si_unique_call 504} sdv_KeReleaseSpinLock(0, out_oldIrql_4);
    goto anon21_Else;
  ...
  anon18_Else:
    ...
    call {:si_unique_call 503} FreePool(in_DeviceExtension_10, out_bufToFree, 1);
    goto L58;
  ...
  anon19_Else:
    ...
    call {:si_unique_call 502} FreePool(in_DeviceExtension_10, out_bufCopyToFree, 1);
    goto L62;
  ...
  L62_dummy:
    call {:si_unique_call 513} {:si_old_unique_call 1} out_pCRCMdlItem_2, out_i_3, out_Tmp_215, out_bufToFree, out_Tmp_216, out_bufCopyToFree, out_oldIrql_4, out_Tmp_217, out_vslice_dummy_var_58 := FreeAllPages_loop_L14(out_pCRCMdlItem_2, out_i_3, out_Tmp_215, out_bufToFree, out_Tmp_216, in_EndIndex, out_bufCopyToFree, out_oldIrql_4, out_Tmp_217, in_DeviceExtension_10, out_vslice_dummy_var_58);
    return;
...
implementation AllocAndMapPages_loop_L13(in_i_4: int, in_pCRCMdlItem_4: int, in_checkSumsMdl: int, in_buffersAssigned: int, in_checkSumsCopyMdl: int, in_Tmp_225: int, in_Tmp_226: int, in_sdv_99: int, in_sdv_100: int, in_EndIndex_1: int, in_checkSumsArrayLen: int, in_oldIrql_6: int, in_Tmp_227: int, in_checkSums: int, in_checkSumsCopy: int, in_DeviceExtension_13: int) returns (out_i_4: int, out_pCRCMdlItem_4: int, out_checkSumsMdl: int, out_buffersAssigned: int, out_checkSumsCopyMdl: int, out_Tmp_225: int, out_Tmp_226: int, out_sdv_99: int, out_sdv_100: int, out_checkSumsArrayLen: int, out_oldIrql_6: int, out_Tmp_227: int, out_checkSums: int, out_checkSumsCopy: int)
{

  entry:
    out_i_4, out_pCRCMdlItem_4, out_checkSumsMdl, out_buffersAssigned, out_checkSumsCopyMdl, out_Tmp_225, out_Tmp_226, out_sdv_99, out_sdv_100, out_checkSumsArrayLen, out_oldIrql_6, out_Tmp_227, out_checkSums, out_checkSumsCopy := in_i_4, in_pCRCMdlItem_4, in_checkSumsMdl, in_buffersAssigned, in_checkSumsCopyMdl, in_Tmp_225, in_Tmp_226, in_sdv_99, in_sdv_100, in_checkSumsArrayLen, in_oldIrql_6, in_Tmp_227, in_checkSums, in_checkSumsCopy;
    goto L13, exit;
  ...
  anon51_Else:
    ...
    call {:si_unique_call 525} out_checkSums := AllocPool(in_DeviceExtension_13, 1, out_checkSumsArrayLen, 1);
    goto anon40_Else;

  anon40_Else:
    assume {:partition} out_checkSums != 0;
    call {:si_unique_call 524} out_checkSumsCopy := AllocPool(in_DeviceExtension_13, 1, out_checkSumsArrayLen, 1);
    goto anon41_Else;

  anon41_Else:
    assume {:partition} out_checkSumsCopy != 0;
    call {:si_unique_call 523} out_checkSumsMdl := IoAllocateMdl(0, out_checkSumsArrayLen, 0, 0, 0);
    goto anon42_Else;

  anon42_Else:
    assume {:partition} out_checkSumsMdl != 0;
    call {:si_unique_call 522} out_checkSumsCopyMdl := IoAllocateMdl(0, out_checkSumsArrayLen, 0, 0, 0);
    goto anon43_Else;

  anon43_Else:
    assume {:partition} out_checkSumsCopyMdl != 0;
    call {:si_unique_call 520} out_Tmp_227 := __HAVOC_malloc(4);
    assume {:nonnull} out_Tmp_227 != 0;
    assume out_Tmp_227 > 0;
    Mem_T.INT4[out_Tmp_227] := out_oldIrql_6;
    call {:si_unique_call 521} sdv_KeAcquireSpinLock(0, out_Tmp_227);
    assume {:nonnull} out_Tmp_227 != 0;
    assume out_Tmp_227 > 0;
  ...
  L64:
    call {:si_unique_call 519} sdv_KeReleaseSpinLock(0, out_oldIrql_6);
    goto anon53_Else;
  ...
  anon45_Else:
    ...
    call {:si_unique_call 526} out_sdv_100 := LockCheckSumArrays(in_DeviceExtension_13, out_i_4);
    goto anon54_Else;
  ...
  anon49_Else:
    assume {:partition} out_buffersAssigned == 0;
    call {:si_unique_call 514} FreePool(in_DeviceExtension_13, out_checkSums, 1);
    goto L24;
  ...
  L24_dummy:
    call {:si_unique_call 527} {:si_old_unique_call 1} out_i_4, out_pCRCMdlItem_4, out_checkSumsMdl, out_buffersAssigned, out_checkSumsCopyMdl, out_Tmp_225, out_Tmp_226, out_sdv_99, out_sdv_100, out_checkSumsArrayLen, out_oldIrql_6, out_Tmp_227, out_checkSums, out_checkSumsCopy := AllocAndMapPages_loop_L13(out_i_4, out_pCRCMdlItem_4, out_checkSumsMdl, out_buffersAssigned, out_checkSumsCopyMdl, out_Tmp_225, out_Tmp_226, out_sdv_99, out_sdv_100, in_EndIndex_1, out_checkSumsArrayLen, out_oldIrql_6, out_Tmp_227, out_checkSums, out_checkSumsCopy, in_DeviceExtension_13);
    return;
  ...
  anon48_Then:
    assume {:partition} out_buffersAssigned == 0;
    call {:si_unique_call 516} FreePool(in_DeviceExtension_13, out_checkSumsCopy, 1);
    goto L84;

  anon47_Then:
    assume {:partition} out_buffersAssigned == 0;
    call {:si_unique_call 517} IoFreeMdl(0);
    goto L80;

  anon45_Then:
    assume {:partition} out_buffersAssigned == 0;
    call {:si_unique_call 518} IoFreeMdl(0);
    goto L76;
  ...
  anon38_Then:
    call {:si_unique_call 515} out_sdv_99 := LockCheckSumArrays(in_DeviceExtension_13, out_i_4);
    goto anon52_Else;
...
implementation InitiateCRCTable_loop_L26(in_i_6: int, in_Tmp_264: int, in_Tmp_266: int, in_Tmp_267: int, in_DeviceExtension_15: int) returns (out_i_6: int, out_Tmp_264: int, out_Tmp_266: int, out_Tmp_267: int)
{
  ...
  anon8_Else:
    ...
    call {:si_unique_call 528} InitializeListHead(out_Tmp_266);
    out_i_6 := out_i_6 + 1;
    goto anon8_Else_dummy;

  anon8_Else_dummy:
    call {:si_unique_call 529} {:si_old_unique_call 1} out_i_6, out_Tmp_264, out_Tmp_266, out_Tmp_267 := InitiateCRCTable_loop_L26(out_i_6, out_Tmp_264, out_Tmp_266, out_Tmp_267, in_DeviceExtension_15);
    return;
}
...
implementation ReadCapacityWorkItemCallback_loop_L73(in_ulSectorSize: int)
{
  ...
  anon33_Else_dummy:
    call {:si_unique_call 530} {:si_old_unique_call 1} ReadCapacityWorkItemCallback_loop_L73(in_ulSectorSize);
    return;
}
...
implementation ReadCapacityWorkItemCallback_loop_L95(in_s_p_e_c_i_a_l_1: int, in_deviceExtension_11: int, in_Tmp_274: int) returns (out_Tmp_274: int)
{
  ...
  anon42_Else_dummy:
    call {:si_unique_call 531} {:si_old_unique_call 1} out_Tmp_274 := ReadCapacityWorkItemCallback_loop_L95(in_s_p_e_c_i_a_l_1, in_deviceExtension_11, out_Tmp_274);
    return;
}
...
implementation DoCriticalRecovery_loop_L43(in_s_p_e_c_i_a_l_2: int, in_Tmp_279: int, in_DeviceExtension_16: int) returns (out_Tmp_279: int)
{
  ...
  anon18_Then_dummy:
    call {:si_unique_call 532} {:si_old_unique_call 1} out_Tmp_279 := DoCriticalRecovery_loop_L43(in_s_p_e_c_i_a_l_2, out_Tmp_279, in_DeviceExtension_16);
    return;
}
...
implementation DoCriticalRecovery_loop_L12(in_sdv_135: int, in_listEntry_3: int, in_defCheckEntry_3: int, in_oldIrql_9: int, in_sdv_137: int, in_Tmp_280: int, in_DeviceExtension_16: int) returns (out_sdv_135: int, out_listEntry_3: int, out_defCheckEntry_3: int, out_oldIrql_9: int, out_sdv_137: int, out_Tmp_280: int)
{

  entry:
    out_sdv_135, out_listEntry_3, out_defCheckEntry_3, out_oldIrql_9, out_sdv_137, out_Tmp_280 := in_sdv_135, in_listEntry_3, in_defCheckEntry_3, in_oldIrql_9, in_sdv_137, in_Tmp_280;
    goto L12, exit;
  ...
  L12:
    call {:si_unique_call 533} out_Tmp_280 := __HAVOC_malloc(4);
    assume {:nonnull} out_Tmp_280 != 0;
    assume out_Tmp_280 > 0;
    Mem_T.INT4[out_Tmp_280] := out_oldIrql_9;
    call {:si_unique_call 534} sdv_KeAcquireSpinLock(0, out_Tmp_280);
    assume {:nonnull} out_Tmp_280 != 0;
    assume out_Tmp_280 > 0;
    out_oldIrql_9 := Mem_T.INT4[out_Tmp_280];
    call {:si_unique_call 535} out_sdv_135 := sdv_IsListEmpty(0);
    goto anon14_Then, anon14_Else;
  ...
  anon14_Else:
    ...
    assume {:nonnull} in_DeviceExtension_16 != 0;
    assume in_DeviceExtension_16 > 0;
    call {:si_unique_call 538} out_listEntry_3 := RemoveHeadList(DeferredCheckSumList__DEVICE_EXTENSION(in_DeviceExtension_16));
    call {:si_unique_call 539} InitializeListHead(out_listEntry_3);
    call {:si_unique_call 540} out_sdv_137 := sdv_containing_record(out_listEntry_3, 0);
    out_defCheckEntry_3 := out_sdv_137;
    goto L21;

  L21:
    call {:si_unique_call 537} sdv_KeReleaseSpinLock(0, out_oldIrql_9);
    goto anon17_Else;
  ...
  anon15_Else:
    ...
    call {:si_unique_call 536} FreeDeferredCheckSumEntry(in_DeviceExtension_16, out_defCheckEntry_3);
    goto anon15_Else_dummy;

  anon15_Else_dummy:
    call {:si_unique_call 541} {:si_old_unique_call 1} out_sdv_135, out_listEntry_3, out_defCheckEntry_3, out_oldIrql_9, out_sdv_137, out_Tmp_280 := DoCriticalRecovery_loop_L12(out_sdv_135, out_listEntry_3, out_defCheckEntry_3, out_oldIrql_9, out_sdv_137, out_Tmp_280, in_DeviceExtension_16);
    return;
...
procedure {:LoopProcedure} DoCriticalRecovery_loop_L12(in_sdv_135: int, in_listEntry_3: int, in_defCheckEntry_3: int, in_oldIrql_9: int, in_sdv_137: int, in_Tmp_280: int, in_DeviceExtension_16: int) returns (out_sdv_135: int, out_listEntry_3: int, out_defCheckEntry_3: int, out_oldIrql_9: int, out_sdv_137: int, out_Tmp_280: int);
  modifies alloc, Mem_T.INT4, sdv_irql_previous_5, sdv_irql_previous_4, sdv_irql_previous_3, sdv_irql_previous_2, sdv_irql_previous, sdv_irql_current, yogi_error;
  free ensures {:va_keep} yogi_error == 0;
  free ensures {:va_keep} old(sdv_irql_current) == sdv_irql_current;
  free ensures {:va_keep} old(sdv_irql_previous) == sdv_irql_previous;
  free ensures {:va_keep} yogi_error == 1 || yogi_error == old(yogi_error);
  free ensures {:va_keep} out_sdv_135 == 1 || out_sdv_135 == 0 || out_sdv_135 == in_sdv_135;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);
...
implementation VerifyOrStoreSectorCheckSum#0_loop_L135(in_thisDefEntry: int, in_listEntry: int, in_sdv_3: int, in_SectorNum: int) returns (out_thisDefEntry: int, out_listEntry: int, out_sdv_3: int)
{
  ...
  anon98_Else:
    call {:si_unique_call 542} out_sdv_3 := sdv_containing_record(out_listEntry, 0);
...
implementation VerifyOrStoreSectorCheckSum#1_loop_L135(in_thisDefEntry: int, in_listEntry: int, in_sdv_3: int, in_SectorNum: int) returns (out_thisDefEntry: int, out_listEntry: int, out_sdv_3: int)
{
  ...
  anon98_Else:
    call {:si_unique_call 543} out_sdv_3 := sdv_containing_record(out_listEntry, 0);
    out_thisDefEntry := out_sdv_3;
    assume {:nonnull} out_thisDefEntry != 0;
    assume out_thisDefEntry > 0;
    goto anon114_Then;
...
implementation CheckSumWorkItemCallback#1_loop_L9(in_Tmp_42: int, in_listEntry_1: int, in_sdv_4: int, in_defCheckEntry_1: int, in_DeviceExtension_2: int, in_oldIrql_1: int, in_sdv_6: int, in_Tmp_44: int) returns (out_Tmp_42: int, out_listEntry_1: int, out_sdv_4: int, out_defCheckEntry_1: int, out_oldIrql_1: int, out_sdv_6: int, out_Tmp_44: int)
{
  ...
  L9:
    call {:si_unique_call 544} out_Tmp_42 := __HAVOC_malloc(4);
    assume {:nonnull} out_Tmp_42 != 0;
    assume out_Tmp_42 > 0;
    Mem_T.INT4[out_Tmp_42] := out_oldIrql_1;
    call {:si_unique_call 545} sdv_KeAcquireSpinLock(0, out_Tmp_42);
    assume {:nonnull} out_Tmp_42 != 0;
    assume out_Tmp_42 > 0;
    out_oldIrql_1 := Mem_T.INT4[out_Tmp_42];
    call {:si_unique_call 546} out_sdv_4 := sdv_IsListEmpty(0);
    goto anon16_Then, anon16_Else;
  ...
  anon16_Else:
    ...
    call {:si_unique_call 555} out_listEntry_1 := RemoveHeadList(DeferredCheckSumList__DEVICE_EXTENSION(in_DeviceExtension_2));
    call {:si_unique_call 556} InitializeListHead(out_listEntry_1);
    call {:si_unique_call 557} out_sdv_6 := sdv_containing_record(out_listEntry_1, 0);
  ...
  L19:
    call {:si_unique_call 554} sdv_KeReleaseSpinLock(0, out_oldIrql_1);
    goto anon18_Else;
  ...
  anon17_Else:
    ...
    call {:si_unique_call 552} AcquirePassiveLevelLock(in_DeviceExtension_2);
    ...
    call {:si_unique_call 553} VerifyOrStoreSectorCheckSum#0(in_DeviceExtension_2, vslice_dummy_var_40, vslice_dummy_var_41, vslice_dummy_var_42, 1, out_Tmp_44, 0);
    goto anon19_Else;
  ...
  anon19_Else:
    ...
    assume {:nonnull} in_DeviceExtension_2 != 0;
    assume in_DeviceExtension_2 > 0;
    call {:si_unique_call 547} ReleasePassiveLevelLock(in_DeviceExtension_2);
    call {:si_unique_call 548} FreeDeferredCheckSumEntry(in_DeviceExtension_2, out_defCheckEntry_1);
    call {:si_unique_call 549} out_Tmp_42 := __HAVOC_malloc(4);
    assume {:nonnull} out_Tmp_42 != 0;
    assume out_Tmp_42 > 0;
    Mem_T.INT4[out_Tmp_42] := out_oldIrql_1;
    call {:si_unique_call 550} sdv_KeAcquireSpinLock(0, out_Tmp_42);
    assume {:nonnull} out_Tmp_42 != 0;
    assume out_Tmp_42 > 0;
    out_oldIrql_1 := Mem_T.INT4[out_Tmp_42];
    assume {:nonnull} in_DeviceExtension_2 != 0;
  ...
  anon20_Else_dummy:
    call {:si_unique_call 558} {:si_old_unique_call 1} out_Tmp_42, out_listEntry_1, out_sdv_4, out_defCheckEntry_1, out_oldIrql_1, out_sdv_6, out_Tmp_44 := CheckSumWorkItemCallback#1_loop_L9(out_Tmp_42, out_listEntry_1, out_sdv_4, out_defCheckEntry_1, in_DeviceExtension_2, out_oldIrql_1, out_sdv_6, out_Tmp_44);
    return;
