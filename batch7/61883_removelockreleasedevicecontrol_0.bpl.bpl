...
procedure {:origName "Av_IoControl"} Av_IoControl(actual_DeviceObject_1: int, actual_Irp_1: int) returns (Tmp_5: int);
  modifies alloc, sdv_compFset, sdv_invoke_on_success, sdv_invoke_on_error, sdv_invoke_on_cancel, yogi_error, LockDepth;
...
implementation {:origName "Av_IoControl"} Av_IoControl(actual_DeviceObject_1: int, actual_Irp_1: int) returns (Tmp_5: int)
{
  ...
  anon224_Then:
    ...
    call {:si_unique_call 57} ntStatus := sdv_IoCallDriver#1(vslice_dummy_var_678, Irp_1);
...
procedure {:origName "sdv_RunDispatchDeviceControl"} {:osmodel} sdv_RunDispatchDeviceControl(actual_po: int, actual_pirp_3: int) returns (Tmp_44: int);
  modifies alloc, sdv_compFset, sdv_invoke_on_success, sdv_invoke_on_error, sdv_invoke_on_cancel, yogi_error, LockDepth;
  free ensures {:va_keep} old(LockDepth) != 0 ==> yogi_error == 1;
  free ensures {:va_keep} old(LockDepth) == 0 ==> yogi_error == 1;
  free ensures {:va_keep} LockDepth <= old(LockDepth);
...
implementation {:origName "sdv_RunDispatchDeviceControl"} {:osmodel} sdv_RunDispatchDeviceControl(actual_po: int, actual_pirp_3: int) returns (Tmp_44: int)
{
  var {:pointer} ps: int;
  ...
  anon0:
    ...
    assume {:nonnull} pirp_3 != 0;
    assume pirp_3 > 0;
    call {:si_unique_call 82} sdv_SetStatus(pirp_3);
    assume {:nonnull} pirp_3 != 0;
    assume pirp_3 > 0;
    assume {:nonnull} pirp_3 != 0;
    assume pirp_3 > 0;
    ...
    assume {:nonnull} ps != 0;
    assume ps > 0;
    call {:si_unique_call 83} sdv_stub_dispatch_begin();
    assume {:nonnull} ps != 0;
    assume ps > 0;
    call {:si_unique_call 84} status := Av_IoControl(po, pirp_3);
    goto anon3_Then, anon3_Else;

  anon3_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 85} sdv_stub_dispatch_end(status, 0);
    assume {:nonnull} pirp_3 != 0;
    assume pirp_3 > 0;
    Tmp_44 := status;
    goto LM2;
...
implementation {:origName "sdv_stub_dispatch_end"} {:osmodel} sdv_stub_dispatch_end(actual_s: int, actual_pirp_4: int)
{
  ...
  anon0:
    call {:si_unique_call 86} vslice_dummy_var_10 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "sdv_SetStatus"} {:osmodel} sdv_SetStatus(actual_pirp_5: int)
{
  ...
  anon0:
    call {:si_unique_call 87} vslice_dummy_var_11 := __HAVOC_malloc(4);
...
implementation {:origName "sdv_main"} {:osmodel} sdv_main()
{
  ...
  anon0:
    call {:si_unique_call 88} vslice_dummy_var_12 := __HAVOC_malloc(4);
    call {:si_unique_call 89} sdv_stub_driver_init();
    call {:si_unique_call 90} vslice_dummy_var_13 := sdv_RunDispatchDeviceControl(sdv_p_devobj_fdo, sdv_irp);
    goto anon3_Then, anon3_Else;
...
implementation {:origName "PoSetPowerState"} {:osmodel} PoSetPowerState(actual_DeviceObject_3: int, actual_Type: int, actual_structPtr888State: int) returns (structPtr888Tmp: int)
{
  ...
  anon0:
    call {:si_unique_call 91} State := __HAVOC_malloc(8);
    call {:si_unique_call 92} r_1 := __HAVOC_malloc(8);
    call {:si_unique_call 93} Tmp := __HAVOC_malloc(8);
...
procedure {:origName "KeCancelTimer"} {:osmodel} KeCancelTimer(actual_Timer_1: int) returns (Tmp_53: int);
...
implementation {:origName "KeCancelTimer"} {:osmodel} KeCancelTimer(actual_Timer_1: int) returns (Tmp_53: int)
{
...
implementation {:origName "sdv_IoSetCompletionRoutine"} {:osmodel} sdv_IoSetCompletionRoutine(actual_pirp_6: int, actual_CompletionRoutine: int, actual_Context: int, actual_InvokeOnSuccess: int, actual_InvokeOnError: int, actual_InvokeOnCancel: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 95} irpSp := sdv_IoGetNextIrpStackLocation(pirp_6);
...
implementation {:origName "ExAcquireFastMutex"} {:osmodel} ExAcquireFastMutex(actual_FastMutex: int)
{
  ...
  anon0:
    call {:si_unique_call 96} vslice_dummy_var_15 := __HAVOC_malloc(4);
    return;
}
...
procedure {:origName "KeSetEvent"} {:osmodel} KeSetEvent(actual_Event_2: int, actual_Increment: int, actual_Wait: int) returns (Tmp_63: int);
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);



implementation {:origName "KeSetEvent"} {:osmodel} KeSetEvent(actual_Event_2: int, actual_Increment: int, actual_Wait: int) returns (Tmp_63: int)
{
...
procedure {:nohoudini} {:origName "main"} {:osmodel} {:entrypoint} main() returns (Tmp_69: int, dup_assertVar: bool);
  modifies alloc, LockDepth, yogi_error, sdv_invoke_on_success, sdv_invoke_on_error, sdv_invoke_on_cancel, sdv_compFset;
...
implementation {:origName "main"} {:osmodel} main() returns (Tmp_69: int, dup_assertVar: bool)
{
  ...
  anon0:
    ...
    call {:si_unique_call 113} sdv_other_harnessStackLocation_next__Loc := __HAVOC_malloc_or_null(536);
    assume sdv_other_harnessStackLocation_next__Loc == sdv_other_harnessStackLocation_next;
    assume sdv_other_harnessStackLocation_next != 0;
    call {:si_unique_call 114} sdv_harnessStackLocation__Loc := __HAVOC_malloc_or_null(536);
    ...
    call {:si_unique_call 280} vslice_dummy_var_679 := __HAVOC_malloc(96);
    call {:si_unique_call 281} vslice_dummy_var_680 := __HAVOC_malloc(96);
...
implementation {:origName "Av_FDO_PowerComplete"} Av_FDO_PowerComplete(actual_DeviceObject_8: int, actual_Irp_8: int, actual_Context_2: int) returns (Tmp_145: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 335} structPtr888sdv := PoSetPowerState(0, 1, vslice_dummy_var_681);
...
implementation {:origName "Av1394_Talk"} Av1394_Talk(actual_CipData: int) returns (Tmp_147: int)
{
  ...
  anon5_Else:
    ...
    call {:si_unique_call 337} Status_3 := Av_SubmitIrpSynch(vslice_dummy_var_682, 0, Irb_1);
    goto anon6_Then, anon6_Else;
  ...
  anon6_Else:
    ...
    call {:si_unique_call 338} ExFreeToNPagedLookasideList(vslice_dummy_var_683, Irb_1);
    goto L27;
...
implementation {:origName "Av1394_AttachBuffer"} Av1394_AttachBuffer(actual_CipData_1: int, actual_DescriptorData: int) returns (Tmp_153: int)
{
  ...
  L20:
    ...
    call {:si_unique_call 343} Status_4 := Av_SubmitIrpSynch(vslice_dummy_var_684, 0, Irb_2);
    goto anon9_Then, anon9_Else;
  ...
  anon9_Else:
    ...
    call {:si_unique_call 344} ExFreeToNPagedLookasideList(vslice_dummy_var_685, Irb_2);
    goto L28;
...
implementation {:origName "Av1394_AllocateResources"} Av1394_AllocateResources(actual_CipData_6: int) returns (Tmp_184: int)
{
  ...
  L22:
    ...
    call {:si_unique_call 357} Status_8 := Av_SubmitIrpSynch(vslice_dummy_var_686, 0, Irb_3);
    goto anon12_Then, anon12_Else;
  ...
  L30:
    ...
    call {:si_unique_call 358} ExFreeToNPagedLookasideList(vslice_dummy_var_687, Irb_3);
    goto L34;
...
implementation {:origName "Av1394_Stop"} Av1394_Stop(actual_CipData_9: int) returns (Tmp_194: int)
{
  ...
  anon5_Else:
    ...
    call {:si_unique_call 380} Status_10 := Av_SubmitIrpSynch(vslice_dummy_var_688, 0, Irb_4);
    goto anon6_Then, anon6_Else;
  ...
  anon6_Else:
    ...
    call {:si_unique_call 381} ExFreeToNPagedLookasideList(vslice_dummy_var_689, Irb_4);
    goto L25;
...
implementation {:origName "Av1394_Listen"} Av1394_Listen(actual_CipData_14: int) returns (Tmp_204: int)
{
  ...
  anon5_Else:
    ...
    call {:si_unique_call 402} Status_15 := Av_SubmitIrpSynch(vslice_dummy_var_690, 0, Irb_5);
    goto anon6_Then, anon6_Else;
  ...
  anon6_Else:
    ...
    call {:si_unique_call 403} ExFreeToNPagedLookasideList(vslice_dummy_var_691, Irb_5);
    goto L27;
...
procedure {:origName "AvCip_FreeResources"} AvCip_FreeResources(actual_CipData_18: int) returns (Tmp_213: int);
  modifies alloc, LockDepth, sdv_compFset, sdv_invoke_on_success, sdv_invoke_on_error, sdv_invoke_on_cancel, yogi_error;
  free ensures {:va_keep} LockDepth <= old(LockDepth);
  free ensures {:va_keep} yogi_error == 1 || yogi_error == old(yogi_error);
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);
...
implementation {:origName "AvCip_FreeResources"} AvCip_FreeResources(actual_CipData_18: int) returns (Tmp_213: int)
{
  ...
  anon43_Else:
    ...
    call {:si_unique_call 424} ExFreeToNPagedLookasideList(vslice_dummy_var_692, vslice_dummy_var_693);
    goto L72;
  ...
  anon45_Else:
    ...
    call {:si_unique_call 426} ExFreeToNPagedLookasideList(vslice_dummy_var_694, vslice_dummy_var_695);
    goto L80;
...
implementation {:origName "Av1394_DetachBuffer"} Av1394_DetachBuffer(actual_CipData_19: int, actual_DescriptorData_6: int) returns (Tmp_221: int)
{
  ...
  L20:
    ...
    call {:si_unique_call 440} Status_19 := Av_SubmitIrpSynch(vslice_dummy_var_696, 0, Irb_6);
    goto anon9_Then, anon9_Else;
  ...
  anon9_Else:
    ...
    call {:si_unique_call 441} ExFreeToNPagedLookasideList(vslice_dummy_var_697, Irb_6);
    goto L28;
...
implementation {:origName "Av1394_FreeResources"} Av1394_FreeResources(actual_CipData_20: int) returns (Tmp_226: int)
{
  ...
  anon8_Else:
    ...
    call {:si_unique_call 444} Status_20 := Av_SubmitIrpSynch(vslice_dummy_var_698, 0, Irb_7);
    goto anon9_Then, anon9_Else;
  ...
  L21:
    ...
    call {:si_unique_call 445} ExFreeToNPagedLookasideList(vslice_dummy_var_699, Irb_7);
    goto L25;
...
implementation {:origName "AvCip_AllocateResources"} AvCip_AllocateResources(actual_CipData_22: int) returns (Tmp_230: int)
{
  ...
  anon71_Else:
    ...
    call {:si_unique_call 473} ExFreeToNPagedLookasideList(vslice_dummy_var_700, vslice_dummy_var_701);
    goto L122;
  ...
  anon73_Else:
    ...
    call {:si_unique_call 475} ExFreeToNPagedLookasideList(vslice_dummy_var_702, vslice_dummy_var_703);
    goto L130;
  ...
  L65:
    ...
    call {:si_unique_call 489} __AssumeBoundInt(vslice_dummy_var_704);
    assume {:nonnull} CipData_22 != 0;
    assume CipData_22 > 0;
    havoc Tmp_260;
...
implementation {:origName "AvCip_ProcessTalkPacket_2"} AvCip_ProcessTalkPacket_2(actual_CipData_26: int, actual_DescriptorData_9: int) returns (Tmp_282: int)
{
  ...
  L103:
    ...
    call {:si_unique_call 522} sdv_155 := RtlUShortAdd(vslice_dummy_var_705, vslice_dummy_var_706, BytesInFrame__CIP_DATA(CipData_26));
...
implementation {:origName "AvFcp_GetFcpResponse"} AvFcp_GetFcpResponse(actual_PdoExtension_1: int, actual_Irp_17: int, actual_Request_6: int) returns (Tmp_312: int)
{
  ...
  anon17_Then:
    ...
    call {:si_unique_call 558} sdv_RtlCopyMemory(0, 0, vslice_dummy_var_707);
    assume {:nonnull} Length_4 != 0;
    assume Length_4 > 0;
    assume {:nonnull} pResponse != 0;
    assume pResponse > 0;
...
implementation {:origName "AvFcp_GetFcpRequest"} AvFcp_GetFcpRequest(actual_PdoExtension_2: int, actual_Irp_18: int, actual_Request_7: int) returns (Tmp_314: int)
{
  ...
  anon15_Then:
    ...
    call {:si_unique_call 572} sdv_RtlCopyMemory(0, 0, vslice_dummy_var_708);
    assume {:nonnull} FcpRequest != 0;
    assume FcpRequest > 0;
    assume {:nonnull} pRequest != 0;
    assume pRequest > 0;
...
implementation {:origName "AvFcp_SendFcpRequest"} AvFcp_SendFcpRequest(actual_BusExtension_7: int, actual_RequestIrp: int, actual_Request_8: int) returns (Tmp_318: int)
{
  ...
  L70:
    ...
    call {:si_unique_call 618} vslice_dummy_var_66 := sdv_IoCallDriver#1(vslice_dummy_var_709, Irp_19);
    goto anon33_Then, anon33_Else;
...
implementation {:origName "AvFcp_SendFcpResponse"} AvFcp_SendFcpResponse(actual_BusExtension_8: int, actual_RequestIrp_1: int, actual_Request_9: int) returns (Tmp_321: int)
{
  ...
  anon21_Else:
    ...
    call {:si_unique_call 626} boogieTmp := IoAllocateMdl(0, vslice_dummy_var_710, 0, 0, 0);
    assume {:nonnull} CRStruct_1 != 0;
    assume CRStruct_1 > 0;
    havoc Mdl_2;
    goto anon28_Then, anon28_Else;
  ...
  L61:
    ...
    call {:si_unique_call 630} vslice_dummy_var_67 := sdv_IoCallDriver#1(vslice_dummy_var_711, Irp_20);
    goto anon30_Then, anon30_Else;
...
implementation {:origName "AvFcp_SendFcpCR"} AvFcp_SendFcpCR(actual_DeviceObject_12: int, actual_Irp_22: int, actual_Context_3: int) returns (Tmp_327: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 645} ExFreeToNPagedLookasideList(IrbPool__BUS_DEVICE_EXTENSION(BusExtension_10), vslice_dummy_var_712);
...
implementation {:origName "AvCmp_P2PCR_oPlug"} AvCmp_P2PCR_oPlug(actual_BusExtension_13: int, actual_CmpData_1: int, actual_Connect_6: int, actual_bReconnect: int, actual_Generation: int) returns (Tmp_343: int)
{
  ...
  anon92_Else:
    ...
    call {:si_unique_call 681} vslice_dummy_var_74 := Av1394_FreeBandwidth(BusExtension_13, Connect_6, vslice_dummy_var_713, BandwidthUnits);
    goto anon115_Then, anon115_Else;
  ...
  anon89_Else:
    ...
    call {:si_unique_call 682} ntStatus_9 := Av1394_ReadPCR(BusExtension_13, Generation, vslice_dummy_var_714, vslice_dummy_var_715, Pcr1);
    goto anon116_Then, anon116_Else;
  ...
  anon118_Else:
    ...
    call {:si_unique_call 684} ntStatus_9 := AvCmp_SetPlugPCR(BusExtension_13, vslice_dummy_var_716, vslice_dummy_var_717, Pcr1, Pcr2, PcrOrg, 1, Generation);
    goto anon119_Then, anon119_Else;
  ...
  anon118_Then:
    ...
    call {:si_unique_call 690} ntStatus_9 := AvCmp_SetPlugPCR(BusExtension_13, vslice_dummy_var_718, vslice_dummy_var_719, Pcr1, Pcr2, PcrOrg, 0, 0);
    goto anon122_Then, anon122_Else;
  ...
  anon108_Else:
    ...
    call {:si_unique_call 694} BandwidthUnits := AvCmp_CalculateBWUnits(Connect_6, vslice_dummy_var_720, vslice_dummy_var_721);
    assume {:nonnull} Connect_6 != 0;
    assume Connect_6 > 0;
    havoc vslice_dummy_var_722;
    call {:si_unique_call 695} ntStatus_9 := Av1394_AllocateBandwidth(BusExtension_13, Connect_6, vslice_dummy_var_722, BandwidthUnits);
    goto anon128_Then, anon128_Else;
  ...
  anon89_Then:
    ...
    call {:si_unique_call 696} ntStatus_9 := AvCmp_GetPlugPCR(BusExtension_13, vslice_dummy_var_723, vslice_dummy_var_724, Pcr1);
    goto anon131_Then, anon131_Else;
...
implementation {:origName "AvCmp_InitCipModule"} AvCmp_InitCipModule(actual_BusExtension_14: int, actual_Connect_7: int, actual_TalkFormat: int) returns (Tmp_362: int)
{
  ...
  L18:
    ...
    call {:si_unique_call 698} Status_30 := AvCip_Create(CipData__AV_CONNECT(Connect_7), vslice_dummy_var_725, vslice_dummy_var_726, IrbPool__BUS_DEVICE_EXTENSION(BusExtension_14), Connect_7, 0, NodeID__BUS_DEVICE_EXTENSION(BusExtension_14));
    goto anon41_Then, anon41_Else;
  ...
  anon41_Else:
    ...
    call {:si_unique_call 699} Status_30 := AvCip_SetTalkFormat(vslice_dummy_var_727, TalkFormat, NodeID__BUS_DEVICE_EXTENSION(BusExtension_14));
    goto anon42_Then, anon42_Else;
  ...
  L30:
    ...
    call {:si_unique_call 700} Status_30 := AvCip_SetCipIsochParameters(vslice_dummy_var_728, vslice_dummy_var_729, vslice_dummy_var_730, vslice_dummy_var_731, vslice_dummy_var_732);
    goto anon43_Then, anon43_Else;
  ...
  anon43_Else:
    ...
    call {:si_unique_call 701} vslice_dummy_var_75 := AvCip_SetCipPacketSize(vslice_dummy_var_733, vslice_dummy_var_734);
    assume {:nonnull} Connect_7 != 0;
    assume Connect_7 > 0;
    havoc vslice_dummy_var_735;
    havoc vslice_dummy_var_736;
    call {:si_unique_call 702} vslice_dummy_var_76 := AvCip_SetSpeed(vslice_dummy_var_735, vslice_dummy_var_736);
    assume {:nonnull} Connect_7 != 0;
    assume Connect_7 > 0;
    havoc vslice_dummy_var_737;
    havoc vslice_dummy_var_738;
    call {:si_unique_call 703} vslice_dummy_var_77 := AvCip_SetChannel(vslice_dummy_var_737, vslice_dummy_var_738);
    goto anon51_Then, anon51_Else;
  ...
  L49:
    ...
    call {:si_unique_call 704} Status_30 := AvCip_Create(CipData__AV_CONNECT(Connect_7), vslice_dummy_var_739, vslice_dummy_var_740, IrbPool__BUS_DEVICE_EXTENSION(BusExtension_14), Connect_7, 1, NodeID__BUS_DEVICE_EXTENSION(BusExtension_14));
    goto anon48_Then, anon48_Else;
...
procedure {:origName "AvCmp_CreateCMPAddressRange"} AvCmp_CreateCMPAddressRange(actual_BusExtension_15: int, actual_CmpData_2: int, actual_PlugType: int) returns (Tmp_364: int);
  modifies sdv_compFset, alloc, sdv_invoke_on_success, sdv_invoke_on_error, sdv_invoke_on_cancel, LockDepth, yogi_error;
  free ensures {:va_keep} LockDepth <= old(LockDepth);
  free ensures {:va_keep} yogi_error == 1 || yogi_error == old(yogi_error);
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);
...
implementation {:origName "AvCmp_CreateCMPAddressRange"} AvCmp_CreateCMPAddressRange(actual_BusExtension_15: int, actual_CmpData_2: int, actual_PlugType: int) returns (Tmp_364: int)
{
  ...
  L38:
    ...
    call {:si_unique_call 707} ntStatus_10 := Av_SubmitIrpSynch(vslice_dummy_var_741, Irp_25, Irb_10);
    goto anon35_Then, anon35_Else;
...
implementation {:origName "AvCmp_SetPlugPCR"} AvCmp_SetPlugPCR(actual_BusExtension_16: int, actual_Type_3: int, actual_Index: int, actual_PcrRef: int, actual_PcrSet: int, actual_PcrOrg_1: int, actual_bGeneration: int, actual_Generation_1: int) returns (Tmp_367: int)
{
  ...
  anon11_Else:
    ...
    call {:si_unique_call 710} ntStatus_11 := Av1394_LockedSwap(BusExtension_16, vslice_dummy_var_742, vslice_dummy_var_743, pUlong3, Tmp_369, bGeneration, Generation_1);
    goto anon14_Then, anon14_Else;
  ...
  anon13_Then:
    ...
    call {:si_unique_call 711} ntStatus_11 := Av1394_LockedSwap(BusExtension_16, vslice_dummy_var_744, vslice_dummy_var_745, pUlong3, Tmp_370, bGeneration, Generation_1);
    goto anon15_Then, anon15_Else;
...
implementation {:origName "AvCmp_SetUnitCapabilities"} AvCmp_SetUnitCapabilities(actual_BusExtension_19: int, actual_Irp_28: int, actual_Request_15: int) returns (Tmp_386: int)
{
  ...
  anon23_Else:
    ...
    call {:si_unique_call 730} vslice_dummy_var_78 := AvCmp_DestroyCmpData(BusExtension_19, vslice_dummy_var_746);
    goto anon27_Then, anon27_Else;
...
implementation {:origName "AvCmp_Connect"} AvCmp_Connect(actual_BusExtension_20: int, actual_Irp_29: int, actual_Request_16: int) returns (Tmp_388: int)
{
  ...
  L19:
    ...
    call {:si_unique_call 731} ntStatus_15 := AvCmp_P2PConnect(BusExtension_20, vslice_dummy_var_747, iPlug_2, oPlug_2, Format__CMP_CONNECT_VER3(Connect_8), vslice_dummy_var_748, phConnect);
    goto anon9_Then, anon9_Else;
...
implementation {:origName "AvCmp_GetPlugState"} AvCmp_GetPlugState(actual_BusExtension_21: int, actual_Irp_30: int, actual_Request_17: int) returns (Tmp_394: int)
{
  ...
  anon19_Else:
    ...
    call {:si_unique_call 736} ntStatus_16 := AvCmp_GetPlugPCR(BusExtension_21, vslice_dummy_var_749, vslice_dummy_var_750, Pcr_2);
    goto anon24_Then, anon24_Else;
...
implementation {:origName "AvCmp_P2PConnect"} AvCmp_P2PConnect(actual_BusExtension_22: int, actual_ConnectType: int, actual_iPlug_3: int, actual_oPlug_3: int, actual_Format_3: int, actual_DDIVersion_2: int, actual_pConnect: int) returns (Tmp_401: int)
{
  ...
  L60_last:
    ...
    call {:si_unique_call 754} ntStatus_17 := AvCmp_P2PCR_oPlug(vslice_dummy_var_751, CmpData_6, Connect_9, 0, 0);
    goto anon92_Then, anon92_Else;
  ...
  L92_last:
    ...
    call {:si_unique_call 755} ntStatus_17 := AvCmp_P2PCR_iPlug(vslice_dummy_var_752, CmpData_6, Connect_9, 0, 0);
    goto anon95_Then, anon95_Else;
...
implementation {:origName "AvCmp_FreeCMPAddressRange"} AvCmp_FreeCMPAddressRange(actual_BusExtension_25: int, actual_CmpData_8: int, actual_PlugType_1: int) returns (Tmp_432: int)
{
  ...
  L28:
    ...
    call {:si_unique_call 764} ntStatus_19 := Av_SubmitIrpSynch(vslice_dummy_var_753, Irp_32, Irb_11);
    goto anon21_Then, anon21_Else;
...
implementation {:origName "AvCmp_P2PDisconnect"} AvCmp_P2PDisconnect(actual_BusExtension_27: int, actual_Connect_12: int) returns (Tmp_439: int)
{
  ...
  anon171_Else:
    ...
    call {:si_unique_call 784} vslice_dummy_var_83 := AvCip_Destroy(vslice_dummy_var_754);
  ...
  anon136_Else:
    ...
    call {:si_unique_call 785} ntStatus_21 := AvCmp_GetPlugPCR(vslice_dummy_var_755, vslice_dummy_var_756, vslice_dummy_var_757, Pcr1_1);
  ...
  anon184_Else:
    ...
    call {:si_unique_call 788} ntStatus_21 := AvCmp_SetPlugPCR(vslice_dummy_var_758, vslice_dummy_var_759, vslice_dummy_var_760, Pcr1_1, Pcr2_1, PcrOrg_2, 0, 0);
  ...
  anon148_Else:
    ...
    call {:si_unique_call 795} BandwidthUnits_4 := AvCmp_CalculateBWUnits(Connect_12, vslice_dummy_var_761, vslice_dummy_var_762);
    assume {:nonnull} Connect_12 != 0;
    assume Connect_12 > 0;
    havoc vslice_dummy_var_763;
    call {:si_unique_call 796} ntStatus_21 := Av1394_FreeBandwidth(BusExtension_27, Connect_12, vslice_dummy_var_763, BandwidthUnits_4);
  ...
  L147:
    ...
    call {:si_unique_call 797} ntStatus_21 := AvCmp_GetPlugPCR(vslice_dummy_var_764, vslice_dummy_var_765, vslice_dummy_var_766, Pcr1_1);
  ...
  L160:
    ...
    call {:si_unique_call 798} ntStatus_21 := AvCmp_SetPlugPCR(vslice_dummy_var_767, vslice_dummy_var_768, vslice_dummy_var_769, Pcr1_1, Pcr2_1, PcrOrg_2, 0, 0);
  ...
  anon165_Else:
    ...
    call {:si_unique_call 806} BandwidthUnits_2 := AvCmp_CalculateBWUnits(Connect_12, vslice_dummy_var_770, vslice_dummy_var_771);
    assume {:nonnull} Connect_12 != 0;
    assume Connect_12 > 0;
    havoc vslice_dummy_var_772;
    call {:si_unique_call 807} ntStatus_21 := Av1394_FreeBandwidth(BusExtension_27, Connect_12, vslice_dummy_var_772, BandwidthUnits_2);
  ...
  anon169_Else:
    ...
    call {:si_unique_call 810} ntStatus_21 := Av1394_FreeBandwidth(BusExtension_27, Connect_12, vslice_dummy_var_773, BandwidthUnits_3);
...
implementation {:origName "AvCmp_P2PCR_iPlug"} AvCmp_P2PCR_iPlug(actual_BusExtension_30: int, actual_CmpData_12: int, actual_Connect_13: int, actual_bReconnect_1: int, actual_Generation_2: int) returns (Tmp_476: int)
{
  ...
  anon108_Else:
    ...
    call {:si_unique_call 857} vslice_dummy_var_88 := Av1394_FreeBandwidth(BusExtension_30, Connect_13, vslice_dummy_var_774, BandwidthUnits_5);
    goto anon137_Then, anon137_Else;
  ...
  anon109_Else:
    ...
    call {:si_unique_call 858} ntStatus_24 := Av1394_ReadPCR(BusExtension_30, Generation_2, vslice_dummy_var_775, vslice_dummy_var_776, Pcr1_2);
    goto anon138_Then, anon138_Else;
  ...
  anon140_Else:
    ...
    call {:si_unique_call 859} ntStatus_24 := AvCmp_SetPlugPCR(BusExtension_30, vslice_dummy_var_777, vslice_dummy_var_778, Pcr1_2, Pcr2_2, PcrOrg_3, 1, Generation_2);
    goto anon141_Then, anon141_Else;
  ...
  anon140_Then:
    ...
    call {:si_unique_call 866} ntStatus_24 := AvCmp_SetPlugPCR(BusExtension_30, vslice_dummy_var_779, vslice_dummy_var_780, Pcr1_2, Pcr2_2, PcrOrg_3, 0, 0);
    goto anon144_Then, anon144_Else;
  ...
  anon113_Else:
    ...
    call {:si_unique_call 868} ntStatus_24 := Av1394_AllocateChannel(BusExtension_30, Connect_13, vslice_dummy_var_781);
    goto anon148_Then, anon148_Else;
  ...
  anon124_Else:
    ...
    call {:si_unique_call 870} ntStatus_24 := Av1394_AllocateBandwidth(BusExtension_30, Connect_13, vslice_dummy_var_782, BandwidthUnits_5);
    goto anon149_Then, anon149_Else;
  ...
  L173:
    ...
    call {:si_unique_call 875} ntStatus_24 := Av1394_AllocateBandwidth(BusExtension_30, Connect_13, vslice_dummy_var_783, BandwidthUnits_5);
    goto anon153_Then, anon153_Else;
  ...
  anon109_Then:
    ...
    call {:si_unique_call 877} ntStatus_24 := AvCmp_GetPlugPCR(BusExtension_30, vslice_dummy_var_784, vslice_dummy_var_785, Pcr1_2);
    goto anon156_Then, anon156_Else;
...
implementation {:origName "Av1394_BusReset"} Av1394_BusReset(actual_BusExtension_33: int, actual_UnusedIrp: int, actual_Request_22: int) returns (Tmp_515: int)
{
  ...
  L40:
    ...
    call {:si_unique_call 917} ntStatus_27 := Av_SubmitIrpSynch(vslice_dummy_var_786, Irp_36, Irb_12);
    goto anon24_Then, anon24_Else;
...
implementation {:origName "Av1394_AddConfigRomEntry"} Av1394_AddConfigRomEntry(actual_CromData_2: int) returns (Tmp_520: int)
{
  ...
  anon25_Then:
    ...
    call {:si_unique_call 925} ntStatus_28 := Av_SubmitIrpSynch(vslice_dummy_var_787, Irp_37, Irb_13);
    goto anon33_Then, anon33_Else;
...
implementation {:origName "InsertHeadList"} InsertHeadList(actual_ListHead_2: int, actual_Entry_1: int)
{
  ...
  anon3_Else:
    ...
    call {:si_unique_call 932} FatalListEntryError(ListHead_2, NextEntry, vslice_dummy_var_788);
    goto L8;
...
implementation {:origName "Av1394_RemoveConfigRomEntry"} Av1394_RemoveConfigRomEntry(actual_CromData_3: int) returns (Tmp_529: int)
{
  ...
  anon26_Else:
    ...
    call {:si_unique_call 937} ntStatus_29 := Av_SubmitIrpSynch(vslice_dummy_var_789, Irp_38, Irb_14);
    goto anon27_Then, anon27_Else;
...
implementation {:origName "Av1394_FreeBandwidth"} Av1394_FreeBandwidth(actual_BusExtension_36: int, actual_Connect_14: int, actual_Speed_1: int, actual_BandwidthUnits_6: int) returns (Tmp_538: int)
{
  ...
  anon18_Else:
    ...
    call {:si_unique_call 951} ntStatus_30 := Av_SubmitIrpSynch(vslice_dummy_var_790, Irp_39, Irb_15);
    goto anon21_Then, anon21_Else;
...
implementation {:origName "Av1394_FreeChannel"} Av1394_FreeChannel(actual_BusExtension_37: int, actual_Connect_15: int) returns (Tmp_541: int)
{
  ...
  anon18_Else:
    ...
    call {:si_unique_call 956} ntStatus_31 := Av_SubmitIrpSynch(vslice_dummy_var_791, Irp_40, Irb_16);
    goto anon21_Then, anon21_Else;
...
implementation {:origName "Av1394_ReadPCR"} Av1394_ReadPCR(actual_BusExtension_38: int, actual_GenerationCount: int, actual_Type_6: int, actual_Index_2: int, actual_Pcr_8: int) returns (Tmp_544: int)
{
  ...
  L57:
    ...
    call {:si_unique_call 959} ntStatus_32 := Av_SubmitIrpSynch(vslice_dummy_var_792, Irp_41, Irb_17);
    goto anon38_Then, anon38_Else;
...
implementation {:origName "Av1394_LockedSwap"} Av1394_LockedSwap(actual_BusExtension_39: int, actual_Argument: int, actual_Data: int, actual_pOldValue: int, actual_Address_1: int, actual_bGeneration_1: int, actual_Generation_3: int) returns (Tmp_548: int)
{
  ...
  L45:
    ...
    call {:si_unique_call 968} ntStatus_33 := Av_SubmitIrpSynch(vslice_dummy_var_793, Irp_42, Irb_18);
    goto anon34_Then, anon34_Else;
...
implementation {:origName "Av1394_AllocateChannel"} Av1394_AllocateChannel(actual_BusExtension_40: int, actual_Connect_16: int, actual_Channel_1: int) returns (Tmp_557: int)
{
  ...
  anon20_Else:
    ...
    call {:si_unique_call 980} ntStatus_34 := Av_SubmitIrpSynch(vslice_dummy_var_794, Irp_43, Irb_19);
    goto anon24_Then, anon24_Else;
...
implementation {:origName "Av1394_AllocateBandwidth"} Av1394_AllocateBandwidth(actual_BusExtension_41: int, actual_Connect_17: int, actual_Speed_2: int, actual_BandwidthUnits_7: int) returns (Tmp_562: int)
{
  ...
  anon20_Else:
    ...
    call {:si_unique_call 986} ntStatus_35 := Av_SubmitIrpSynch(vslice_dummy_var_795, Irp_44, Irb_20);
    goto anon24_Then, anon24_Else;
...
implementation {:origName "Av1394_QuadletRead"} Av1394_QuadletRead(actual_BusExtension_42: int, actual_pData_1: int, actual_Address_2: int) returns (Tmp_569: int)
{
  ...
  anon27_Else:
    ...
    call {:si_unique_call 992} ntStatus_37 := Av_SubmitIrpSynch(vslice_dummy_var_796, Irp_46, Irb_21);
    goto anon34_Then, anon34_Else;
...
implementation {:origName "Av1394_GetGenerationCount"} Av1394_GetGenerationCount(actual_BusExtension_43: int) returns (Tmp_573: int)
{
  ...
  anon20_Else:
    ...
    call {:si_unique_call 1003} ntStatus_38 := Av_SubmitIrpSynch(vslice_dummy_var_797, Irp_47, Irb_22);
    goto anon24_Then, anon24_Else;
...
implementation {:origName "AvCip_ProcessAttachBuffer"} AvCip_ProcessAttachBuffer#0(actual_CipData_23: int, actual_DescriptorData_8: int) returns (Tmp_269: int)
{
  ...
  anon19_Then:
    ...
    call {:si_unique_call 1059} IoReuseIrp(vslice_dummy_var_798, 0);
  ...
  L27:
    ...
    call {:si_unique_call 1061} NextIrpStack_1 := sdv_IoGetNextIrpStackLocation(vslice_dummy_var_799);
  ...
  L36:
    ...
    call {:si_unique_call 1063} sdv_IoSetCompletionRoutine(vslice_dummy_var_800, li2bplFunctionConstant445, DescriptorData_8, 1, 1, 1);
    assume {:nonnull} CipData_23 != 0;
    assume CipData_23 > 0;
    assume {:nonnull} DescriptorData_8 != 0;
    assume DescriptorData_8 > 0;
...
implementation {:origName "AvCip_ProcessAttachBuffer"} AvCip_ProcessAttachBuffer#1(actual_CipData_23: int, actual_DescriptorData_8: int) returns (Tmp_269: int)
{
  ...
  anon19_Then:
    ...
    call {:si_unique_call 1067} IoReuseIrp(vslice_dummy_var_801, 0);
  ...
  L27:
    ...
    call {:si_unique_call 1069} NextIrpStack_1 := sdv_IoGetNextIrpStackLocation(vslice_dummy_var_802);
    assume {:nonnull} NextIrpStack_1 != 0;
    assume NextIrpStack_1 > 0;
    assume {:nonnull} NextIrpStack_1 != 0;
    assume NextIrpStack_1 > 0;
  ...
  L36:
    ...
    call {:si_unique_call 1071} sdv_IoSetCompletionRoutine(vslice_dummy_var_803, li2bplFunctionConstant445, DescriptorData_8, 1, 1, 1);
    assume {:nonnull} CipData_23 != 0;
    assume CipData_23 > 0;
    assume {:nonnull} DescriptorData_8 != 0;
    assume DescriptorData_8 > 0;
    ...
    call {:si_unique_call 1072} Status_23 := sdv_IoCallDriver#0(vslice_dummy_var_804, vslice_dummy_var_805);
    goto anon23_Then, anon23_Else;
...
implementation {:origName "IofCallDriver"} {:osmodel} IofCallDriver#0(actual_DeviceObject_4: int, actual_Irp_5: int) returns (Tmp_111: int)
{
  ...
  anon55_Then:
    ...
    call {:si_unique_call 1078} vslice_dummy_var_120 := sdv_RunIoCompletionRoutines#0(sdv_p_devobj_fdo, Irp_5, vslice_dummy_var_806, completion);
    goto anon76_Then, anon76_Else;
  ...
  anon67_Else:
    ...
    call {:si_unique_call 1079} vslice_dummy_var_123 := sdv_RunIoCompletionRoutines#0(sdv_p_devobj_fdo, Irp_5, vslice_dummy_var_807, completion);
    goto anon78_Then, anon78_Else;
  ...
  anon59_Else:
    ...
    call {:si_unique_call 1080} vslice_dummy_var_121 := sdv_RunIoCompletionRoutines#0(sdv_p_devobj_fdo, Irp_5, vslice_dummy_var_808, completion);
    goto anon74_Then, anon74_Else;
  ...
  anon63_Else:
    ...
    call {:si_unique_call 1081} vslice_dummy_var_122 := sdv_RunIoCompletionRoutines#0(sdv_p_devobj_fdo, Irp_5, vslice_dummy_var_809, completion);
    goto anon72_Then, anon72_Else;
...
implementation {:origName "IofCallDriver"} {:osmodel} IofCallDriver#1(actual_DeviceObject_4: int, actual_Irp_5: int) returns (Tmp_111: int)
{
  ...
  anon55_Then:
    ...
    call {:si_unique_call 1083} vslice_dummy_var_124 := sdv_RunIoCompletionRoutines#1(sdv_p_devobj_fdo, Irp_5, vslice_dummy_var_810, completion);
    goto anon76_Then, anon76_Else;
  ...
  anon67_Else:
    ...
    call {:si_unique_call 1084} vslice_dummy_var_127 := sdv_RunIoCompletionRoutines#1(sdv_p_devobj_fdo, Irp_5, vslice_dummy_var_811, completion);
    goto anon78_Then, anon78_Else;
  ...
  anon59_Else:
    ...
    call {:si_unique_call 1085} vslice_dummy_var_125 := sdv_RunIoCompletionRoutines#1(sdv_p_devobj_fdo, Irp_5, vslice_dummy_var_812, completion);
    goto anon74_Then, anon74_Else;
  ...
  anon63_Else:
    ...
    call {:si_unique_call 1086} vslice_dummy_var_126 := sdv_RunIoCompletionRoutines#1(sdv_p_devobj_fdo, Irp_5, vslice_dummy_var_813, completion);
    goto anon72_Then, anon72_Else;
...
implementation AvCip_FreeResources_loop_L11(in_Tmp_214: int, in_Tmp_216: int, in_sdv_113: int, in_Status_18: int, in_Tmp_217: int, in_sdv_114: int, in_DescriptorData_5: int, in_sdv_117: int, in_sdv_120: int, in_Tmp_218: int, in_PriorState: int, in_Irql_5: int, in_Tmp_219: int, in_CipData_18: int, in_vslice_dummy_var_44: int, in_vslice_dummy_var_45: int, in_vslice_dummy_var_46: int) returns (out_Tmp_214: int, out_Tmp_216: int, out_sdv_113: int, out_Status_18: int, out_Tmp_217: int, out_DescriptorData_5: int, out_sdv_117: int, out_sdv_120: int, out_Tmp_218: int, out_PriorState: int, out_Irql_5: int, out_Tmp_219: int, out_vslice_dummy_var_44: int, out_vslice_dummy_var_45: int, out_vslice_dummy_var_46: int)
{
  ...
  anon43_Else:
    ...
    call {:si_unique_call 1153} ExFreeToNPagedLookasideList(vslice_dummy_var_816, vslice_dummy_var_817);
    goto L72;
  ...
  anon45_Else:
    ...
    call {:si_unique_call 1151} ExFreeToNPagedLookasideList(vslice_dummy_var_814, vslice_dummy_var_815);
    goto L80;
...
implementation AvCip_AllocateResources_loop_L23(in_Tmp_231: int, in_Tmp_232: int, in_Tmp_233: int, in_sdv_126: int, in_iPacket: int, in_Tmp_235: int, in_Tmp_236: int, in_Tmp_237: int, in_NumDescriptors: int, in_Status_22: int, in_sdv_128: int, in_Tmp_238: int, in_DescriptorData_7: int, in_sdv_130: int, in_Tmp_240: int, in_sdv_131: int, in_sdv_132: int, in_Tmp_243: int, in_Tmp_244: int, in_NumPackets: int, in_Tmp_245: int, in_iAttach: int, in_Tmp_246: int, in_Tmp_247: int, in_Tmp_248: int, in_sdv_134: int, in_Tmp_249: int, in_Tmp_251: int, in_Tmp_252: int, in_Tmp_253: int, in_Tmp_254: int, in_Tmp_255: int, in_Tmp_256: int, in_Tmp_257: int, in_Tmp_258: int, in_Irql_6: int, in_sdv_136: int, in_Tmp_259: int, in_Tmp_260: int, in_Tmp_261: int, in_Tmp_262: int, in_Tmp_263: int, in_Tmp_264: int, in_Tmp_266: int, in_Tmp_267: int, in_Tmp_268: int, in_CipData_22: int, in_boogieTmp: int, in_vslice_dummy_var_48: int) returns (out_Tmp_231: int, out_Tmp_232: int, out_Tmp_233: int, out_sdv_126: int, out_iPacket: int, out_Tmp_235: int, out_Tmp_236: int, out_Tmp_237: int, out_Status_22: int, out_sdv_128: int, out_Tmp_238: int, out_DescriptorData_7: int, out_sdv_130: int, out_Tmp_240: int, out_sdv_131: int, out_sdv_132: int, out_Tmp_243: int, out_Tmp_244: int, out_Tmp_245: int, out_iAttach: int, out_Tmp_246: int, out_Tmp_247: int, out_Tmp_248: int, out_sdv_134: int, out_Tmp_249: int, out_Tmp_251: int, out_Tmp_252: int, out_Tmp_253: int, out_Tmp_254: int, out_Tmp_255: int, out_Tmp_256: int, out_Tmp_257: int, out_Tmp_258: int, out_Irql_6: int, out_sdv_136: int, out_Tmp_259: int, out_Tmp_260: int, out_Tmp_261: int, out_Tmp_262: int, out_Tmp_263: int, out_Tmp_264: int, out_Tmp_266: int, out_Tmp_267: int, out_Tmp_268: int, out_boogieTmp: int, out_vslice_dummy_var_48: int)
{
  ...
  L65:
    ...
    call {:si_unique_call 1176} __AssumeBoundInt(vslice_dummy_var_818);
    assume {:nonnull} in_CipData_22 != 0;
    assume in_CipData_22 > 0;
    havoc out_Tmp_260;
...
implementation AvCip_ProcessTalkPacket_2_loop_L69(in_Frame_3: int, in_BlockTime: int, in_Tmp_284: int, in_UniTime_1: int, in_sdv_153: int, in_sdv_155: int, in_sdv_157: int, in_Cip: int, in_bDone: int, in_sdv_159: int, in_sdv_163: int, in_SpTime: int, in_FrameContext_6: int, in_SpHeader: int, in_sdv_165: int, in_pThisFrame: int, in_CipData_26: int, in_DescriptorData_9: int, in_boogieTmp: int, in_vslice_dummy_var_52: int, in_vslice_dummy_var_54: int, in_vslice_dummy_var_55: int) returns (out_Frame_3: int, out_BlockTime: int, out_Tmp_284: int, out_sdv_155: int, out_bDone: int, out_sdv_159: int, out_FrameContext_6: int, out_SpHeader: int, out_sdv_165: int, out_pThisFrame: int, out_boogieTmp: int, out_vslice_dummy_var_52: int, out_vslice_dummy_var_54: int, out_vslice_dummy_var_55: int)
{
  ...
  L103:
    ...
    call {:si_unique_call 1183} out_sdv_155 := RtlUShortAdd(vslice_dummy_var_819, vslice_dummy_var_820, BytesInFrame__CIP_DATA(in_CipData_26));
    goto anon119_Else;
...
implementation AvCip_ProcessTalkPacket_2_loop_L58(in_i_1: int, in_Frame_3: int, in_BlockTime: int, in_Tmp_284: int, in_MaxFrameSize: int, in_UniTime_1: int, in_sdv_153: int, in_sdv_155: int, in_sdv_157: int, in_Cip: int, in_bDone: int, in_sdv_159: int, in_Tmp_292: int, in_sdv_163: int, in_SpTime: int, in_FrameContext_6: int, in_currLength: int, in_SpHeader: int, in_sdv_165: int, in_pThisFrame: int, in_CipData_26: int, in_DescriptorData_9: int, in_boogieTmp: int, in_vslice_dummy_var_51: int, in_vslice_dummy_var_52: int, in_vslice_dummy_var_54: int, in_vslice_dummy_var_55: int) returns (out_i_1: int, out_Frame_3: int, out_BlockTime: int, out_Tmp_284: int, out_MaxFrameSize: int, out_sdv_155: int, out_bDone: int, out_sdv_159: int, out_Tmp_292: int, out_FrameContext_6: int, out_currLength: int, out_SpHeader: int, out_sdv_165: int, out_pThisFrame: int, out_boogieTmp: int, out_vslice_dummy_var_51: int, out_vslice_dummy_var_52: int, out_vslice_dummy_var_54: int, out_vslice_dummy_var_55: int)
{
  ...
  L103:
    ...
    call {:si_unique_call 1195} out_sdv_155 := RtlUShortAdd(vslice_dummy_var_821, vslice_dummy_var_822, BytesInFrame__CIP_DATA(in_CipData_26));
    goto anon119_Else;
...
implementation AvCmp_P2PConnect_loop_L60(in_Retries: int, in_Tmp_404: int, in_CmpData_6: int, in_Connect_9: int, in_ntStatus_17: int, in_oPlug_3: int) returns (out_Retries: int, out_Tmp_404: int, out_ntStatus_17: int)
{
  ...
  L60:
    ...
    call {:si_unique_call 1222} out_ntStatus_17 := AvCmp_P2PCR_oPlug(vslice_dummy_var_823, in_CmpData_6, in_Connect_9, 0, 0);
    goto anon92_Else;
...
implementation AvCmp_P2PConnect_loop_L92(in_CmpData_6: int, in_Connect_9: int, in_Retries_1: int, in_ntStatus_17: int, in_Tmp_410: int, in_iPlug_3: int) returns (out_Retries_1: int, out_ntStatus_17: int, out_Tmp_410: int)
{
  ...
  L92:
    ...
    call {:si_unique_call 1224} out_ntStatus_17 := AvCmp_P2PCR_iPlug(vslice_dummy_var_824, in_CmpData_6, in_Connect_9, 0, 0);
    goto anon95_Else;
...
implementation Av1394_ReadPCR_loop_L22(in_Retries_2: int, in_Irp_41: int, in_Irb_17: int, in_Mdl_3: int, in_Tmp_545: int, in_StackSize_11: int, in_sdv_336: int, in_ntStatus_32: int, in_BusExtension_38: int, in_GenerationCount: int, in_Type_6: int, in_Index_2: int) returns (out_Retries_2: int, out_Irp_41: int, out_Irb_17: int, out_Mdl_3: int, out_Tmp_545: int, out_sdv_336: int, out_ntStatus_32: int)
{
  ...
  L57:
    ...
    call {:si_unique_call 1231} out_ntStatus_32 := Av_SubmitIrpSynch(vslice_dummy_var_825, out_Irp_41, out_Irb_17);
    goto anon38_Else;
...
implementation Av1394_LockedSwap_loop_L16(in_Retries_3: int, in_Irp_42: int, in_Tmp_549: int, in_Irb_18: int, in_Tmp_550: int, in_StackSize_12: int, in_sdv_341: int, in_ntStatus_33: int, in_Tmp_552: int, in_BusExtension_39: int, in_Argument: int, in_Data: int, in_pOldValue: int, in_Address_1: int, in_bGeneration_1: int, in_Generation_3: int, in_vslice_dummy_var_103: int) returns (out_Retries_3: int, out_Irp_42: int, out_Tmp_549: int, out_Irb_18: int, out_Tmp_550: int, out_sdv_341: int, out_ntStatus_33: int, out_Tmp_552: int, out_vslice_dummy_var_103: int)
{
  ...
  L45:
    ...
    call {:si_unique_call 1238} out_ntStatus_33 := Av_SubmitIrpSynch(vslice_dummy_var_826, out_Irp_42, out_Irb_18);
    goto anon34_Else;
...
implementation Av1394_QuadletRead_loop_L17(in_Retries_4: int, in_Irp_46: int, in_Mdl_4: int, in_Irb_21: int, in_Tmp_570: int, in_StackSize_15: int, in_sdv_352: int, in_ntStatus_37: int, in_BusExtension_42: int, in_Address_2: int, in_vslice_dummy_var_107: int) returns (out_Retries_4: int, out_Irp_46: int, out_Mdl_4: int, out_Irb_21: int, out_Tmp_570: int, out_sdv_352: int, out_ntStatus_37: int, out_vslice_dummy_var_107: int)
{
  ...
  anon27_Else:
    ...
    call {:si_unique_call 1246} out_ntStatus_37 := Av_SubmitIrpSynch(vslice_dummy_var_827, out_Irp_46, out_Irb_21);
    goto anon34_Else;
