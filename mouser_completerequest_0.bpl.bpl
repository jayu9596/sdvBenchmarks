...
implementation {:origName "PoCallDriver"} {:osmodel} PoCallDriver(actual_DeviceObject_3: int, actual_Irp_2: int) returns (Tmp_101: int)
{
  ...
  anon68_Else:
    ...
    call {:si_unique_call 53} sdv_75 := sdv_RunIoCompletionRoutines#1(sdv_p_devobj_fdo, Irp_2, vslice_dummy_var_139, completion);
    goto anon74_Then, anon74_Else;

  anon74_Else:
    assume Irp_2 == SLAM_guard_S_0;
    assume SLAM_guard_S_0 != SLAM_guard_S_0_init;
    call {:si_unique_call 54} SLIC_sdv_RunIoCompletionRoutines_exit(0, completion, sdv_75);
    goto L29;
  ...
  anon64_Else:
    ...
    call {:si_unique_call 57} sdv_74 := sdv_RunIoCompletionRoutines#1(sdv_p_devobj_fdo, Irp_2, vslice_dummy_var_141, completion);
    goto anon71_Then, anon71_Else;

  anon71_Else:
    assume Irp_2 == SLAM_guard_S_0;
    assume SLAM_guard_S_0 != SLAM_guard_S_0_init;
    call {:si_unique_call 58} SLIC_sdv_RunIoCompletionRoutines_exit(0, completion, sdv_74);
    goto L29;
...
implementation {:origName "main"} {:osmodel} main() returns (Tmp_124: int, dup_assertVar: bool)
{
  ...
  anon0:
    ...
    call {:si_unique_call 88} sdv_other_harnessStackLocation_next__Loc := __HAVOC_malloc_or_null(536);
    assume sdv_other_harnessStackLocation_next__Loc == sdv_other_harnessStackLocation_next;
    assume sdv_other_harnessStackLocation_next != 0;
    call {:si_unique_call 89} sdv_harnessStackLocation__Loc := __HAVOC_malloc_or_null(536);
    ...
    call {:si_unique_call 128} vslice_dummy_var_207 := __HAVOC_malloc(12);
    call {:si_unique_call 129} vslice_dummy_var_146 := __HAVOC_malloc(48);
    call {:si_unique_call 130} vslice_dummy_var_208 := __HAVOC_malloc(12);
...
implementation {:origName "SerialMouseServiceParameters"} SerialMouseServiceParameters(actual_DeviceExtension_28: int, actual_Handle_1: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 207} sdv_187 := ExAllocatePoolWithTag(1, Tmp_301, -228232371);
    parameters := sdv_187;
  ...
  anon24_Else:
    ...
    call {:si_unique_call 208} sdv_RtlZeroMemory(0, Tmp_290);
  ...
  anon19_Then:
    ...
    assume parametersPath > 0;
    havoc Tmp_300;
    call {:si_unique_call 213} sdv_192 := ExAllocatePoolWithTag(1, Tmp_300, -228232371);
    assume {:nonnull} parametersPath != 0;
    assume parametersPath > 0;
    assume {:nonnull} parametersPath != 0;
    assume parametersPath > 0;
  ...
  anon26_Else:
    ...
    assume parametersPath > 0;
    havoc Tmp_292;
    call {:si_unique_call 214} sdv_RtlZeroMemory(0, Tmp_292);
...
implementation {:origName "SerialMouseCreate"} SerialMouseCreate(actual_DeviceObject_19: int, actual_Irp_13: int) returns (Tmp_315: int)
{
  ...
  L64:
    ...
    Tmp_315 := status_33;
    call {:si_unique_call 222} SLIC_SerialMouseCreate_exit(strConst__li2bpl1, Tmp_315);
    goto anon27_Then, anon27_Else;
  ...
  anon20_Else:
    call {:si_unique_call 224} Tmp_316 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_316 != 0;
    assume Tmp_316 > 0;
    assume {:nonnull} deviceExtension_3 != 0;
    assume deviceExtension_3 > 0;
    call {:si_unique_call 225} sdv_210 := sdv_InterlockedIncrement(Tmp_316);
    assume {:nonnull} Tmp_316 != 0;
    assume Tmp_316 > 0;
    assume {:nonnull} deviceExtension_3 != 0;
    assume deviceExtension_3 > 0;
  ...
  L44:
    call {:si_unique_call 229} Tmp_316 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_316 != 0;
    assume Tmp_316 > 0;
    assume {:nonnull} deviceExtension_3 != 0;
    assume deviceExtension_3 > 0;
    call {:si_unique_call 230} vslice_dummy_var_50 := sdv_InterlockedDecrement(Tmp_316);
    assume {:nonnull} Tmp_316 != 0;
    assume Tmp_316 > 0;
    assume {:nonnull} deviceExtension_3 != 0;
    assume deviceExtension_3 > 0;
...
implementation {:origName "SerialMouseInternalDeviceControl"} SerialMouseInternalDeviceControl(actual_DeviceObject_20: int, actual_Irp_14: int) returns (Tmp_318: int)
{
  ...
  L1:
    call {:si_unique_call 236} SLIC_SerialMouseInternalDeviceControl_exit(strConst__li2bpl1, Tmp_318);
...
implementation {:origName "SerialMouseFlush"} SerialMouseFlush(actual_DeviceObject_21: int, actual_Irp_15: int) returns (Tmp_324: int)
{
  ...
  L1:
    call {:si_unique_call 244} SLIC_SerialMouseFlush_exit(strConst__li2bpl1, Tmp_324);
    goto anon6_Then, anon6_Else;
...
implementation {:origName "SerialMouseClose"} SerialMouseClose(actual_DeviceObject_22: int, actual_Irp_16: int) returns (Tmp_326: int)
{
  ...
  L1:
    call {:si_unique_call 249} SLIC_SerialMouseClose_exit(strConst__li2bpl1, Tmp_326);
    goto anon15_Then, anon15_Else;
  ...
  anon11_Then:
    ...
    call {:si_unique_call 250} Tmp_327 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_327 != 0;
    assume Tmp_327 > 0;
    assume {:nonnull} deviceExtension_6 != 0;
    assume deviceExtension_6 > 0;
    call {:si_unique_call 251} sdv_218 := sdv_InterlockedDecrement(Tmp_327);
    assume {:nonnull} Tmp_327 != 0;
    assume Tmp_327 > 0;
    assume {:nonnull} deviceExtension_6 != 0;
    assume deviceExtension_6 > 0;
  ...
  anon12_Then:
    ...
    call {:si_unique_call 258} Tmp_326 := sdv_IoCallDriver#1(vslice_dummy_var_149, Irp_16);
    goto L1;
}
...
implementation {:origName "SerialMouseStopDevice"} SerialMouseStopDevice(actual_DeviceExtension_34: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 268} Tmp_340 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_340 != 0;
    assume Tmp_340 > 0;
    call {:si_unique_call 269} sdv_KeAcquireSpinLock(0, Tmp_340);
    assume {:nonnull} Tmp_340 != 0;
    assume Tmp_340 > 0;
    havoc irql_1;
...
implementation {:origName "SerialMousePnP"} SerialMousePnP(actual_DeviceObject_26: int, actual_Irp_20: int) returns (Tmp_341: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 274} Tmp_343 := __HAVOC_malloc(28);
    call {:si_unique_call 275} Tmp_345 := __HAVOC_malloc(28);
    skipIt := 0;
  ...
  L1:
    call {:si_unique_call 283} SLIC_SerialMousePnP_exit(strConst__li2bpl1, Tmp_341);
  ...
  L89:
    call {:si_unique_call 288} i_4, Tmp_343, Tmp_344 := SerialMousePnP_loop_L89(i_4, devCaps, Tmp_343, Tmp_344);
    goto L89_last;
  ...
  anon105_Else:
    call {:si_unique_call 301} Tmp_342 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_342 != 0;
    assume Tmp_342 > 0;
    assume {:nonnull} deviceExtension_8 != 0;
    assume deviceExtension_8 > 0;
    call {:si_unique_call 302} sdv_236 := sdv_InterlockedIncrement(Tmp_342);
    assume {:nonnull} Tmp_342 != 0;
    assume Tmp_342 > 0;
    assume {:nonnull} deviceExtension_8 != 0;
    assume deviceExtension_8 > 0;
  ...
  L161:
    ...
    call {:si_unique_call 311} Tmp_342 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_342 != 0;
    assume Tmp_342 > 0;
    assume {:nonnull} deviceExtension_8 != 0;
    assume deviceExtension_8 > 0;
    call {:si_unique_call 312} sdv_242 := sdv_InterlockedDecrement(Tmp_342);
    assume {:nonnull} Tmp_342 != 0;
    assume Tmp_342 > 0;
    assume {:nonnull} deviceExtension_8 != 0;
    assume deviceExtension_8 > 0;
...
implementation {:origName "SerialMousePower"} SerialMousePower(actual_DeviceObject_27: int, actual_Irp_21: int) returns (Tmp_346: int)
{
  ...
  L62:
    ...
    call {:si_unique_call 337} Tmp_346 := PoCallDriver(0, Irp_21);
    goto L1;

  L1:
    call {:si_unique_call 338} SLIC_SerialMousePower_exit(strConst__li2bpl1, Tmp_346);
    goto anon64_Then, anon64_Else;
...
implementation {:origName "SerialMouseHandleStartStopStart"} SerialMouseHandleStartStopStart(actual_DeviceExtension_35: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 365} Tmp_348 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_348 != 0;
    assume Tmp_348 > 0;
    call {:si_unique_call 366} sdv_KeAcquireSpinLock(0, Tmp_348);
    assume {:nonnull} Tmp_348 != 0;
    assume Tmp_348 > 0;
    havoc irql_2;
...
implementation {:origName "sdv_RunIoCompletionRoutines"} {:osmodel} sdv_RunIoCompletionRoutines#0(actual_DeviceObject_9: int, actual_Irp_7: int, actual_Context_5: int, actual_Completion: int) returns (Tmp_175: int)
{
  ...
  anon12_Else:
    ...
    call {:si_unique_call 420} Status_1 := SerialMouseCompletionRoutine(DeviceObject_9, Irp_7, Context_5);
    assume {:nonnull} Completion != 0;
    assume Completion > 0;
    goto L11;
  ...
  anon9_Else:
    ...
    call {:si_unique_call 421} Status_1 := SerialMouseReadComplete#0(DeviceObject_9, Irp_7, Context_5);
    assume {:nonnull} Completion != 0;
    assume Completion > 0;
    goto L28;
  ...
  anon10_Else:
    ...
    call {:si_unique_call 422} Status_1 := SerialMouseReadSerialPortComplete(DeviceObject_9, Irp_7, Context_5);
    assume {:nonnull} Completion != 0;
    assume Completion > 0;
    goto L45;
  ...
  anon11_Else:
    ...
    call {:si_unique_call 423} Status_1 := SerialMouseSerialMaskEventComplete#0(DeviceObject_9, Irp_7, Context_5);
    assume {:nonnull} Completion != 0;
    assume Completion > 0;
    goto L62;
...
implementation {:origName "sdv_RunIoCompletionRoutines"} {:osmodel} sdv_RunIoCompletionRoutines#1(actual_DeviceObject_9: int, actual_Irp_7: int, actual_Context_5: int, actual_Completion: int) returns (Tmp_175: int)
{
  ...
  anon12_Else:
    assume {:partition} Mem_T.CompletionRoutine__IO_STACK_LOCATION[CompletionRoutine__IO_STACK_LOCATION(irpsp)] == li2bplFunctionConstant188;
    call {:si_unique_call 425} Status_1 := SerialMouseCompletionRoutine(DeviceObject_9, Irp_7, Context_5);
    assume {:nonnull} Completion != 0;
    assume Completion > 0;
    goto L11;
  ...
  anon9_Else:
    assume {:partition} Mem_T.CompletionRoutine__IO_STACK_LOCATION[CompletionRoutine__IO_STACK_LOCATION(irpsp)] == li2bplFunctionConstant251;
    call {:si_unique_call 426} Status_1 := SerialMouseReadComplete#1(DeviceObject_9, Irp_7, Context_5);
    assume {:nonnull} Completion != 0;
    assume Completion > 0;
    goto L28;
  ...
  anon10_Else:
    assume {:partition} Mem_T.CompletionRoutine__IO_STACK_LOCATION[CompletionRoutine__IO_STACK_LOCATION(irpsp)] == li2bplFunctionConstant256;
    call {:si_unique_call 427} Status_1 := SerialMouseReadSerialPortComplete(DeviceObject_9, Irp_7, Context_5);
    assume {:nonnull} Completion != 0;
    assume Completion > 0;
    goto L45;
  ...
  anon11_Else:
    assume {:partition} Mem_T.CompletionRoutine__IO_STACK_LOCATION[CompletionRoutine__IO_STACK_LOCATION(irpsp)] == li2bplFunctionConstant268;
    call {:si_unique_call 428} Status_1 := SerialMouseSerialMaskEventComplete#1(DeviceObject_9, Irp_7, Context_5);
    assume {:nonnull} Completion != 0;
    assume Completion > 0;
    goto L62;
...
implementation {:origName "SerialMouseStartRead"} SerialMouseStartRead#1(actual_DeviceExtension_15: int) returns (Tmp_210: int)
{
  ...
  L13:
    call {:si_unique_call 456} Tmp_211, status_17, irql, stack := SerialMouseStartRead#1_loop_L13(sdv_124, Tmp_211, irp_2, status_17, irql, stack, DeviceExtension_15);
    goto L13_last;
...
implementation {:origName "IoQueueWorkItem"} {:osmodel} IoQueueWorkItem#0(actual_IoWorkItem_1: int, actual_WorkerRoutine: int, actual_QueueType: int, actual_Context_1: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 480} sdv_RunIoQueueWorkItems#0(0, WorkerRoutine, QueueType, Context_1);
    return;
}
...
implementation {:origName "IoQueueWorkItem"} {:osmodel} IoQueueWorkItem#1(actual_IoWorkItem_1: int, actual_WorkerRoutine: int, actual_QueueType: int, actual_Context_1: int)
{
  ...
  anon0:
    ...
    QueueType := actual_QueueType;
    Context_1 := actual_Context_1;
    call {:si_unique_call 482} sdv_RunIoQueueWorkItems#1(0, WorkerRoutine, QueueType, Context_1);
    return;
}
...
implementation {:origName "sdv_RunIoQueueWorkItems"} {:osmodel} sdv_RunIoQueueWorkItems#0(actual_IoWorkItem_2: int, actual_WorkerRoutine_1: int, actual_QueueType_1: int, actual_Context_2: int)
{
  ...
  anon5_Else:
    ...
    call {:si_unique_call 484} SerialMouseSerialMaskEventWorker#0(sdv_p_devobj_fdo, Context_2);
    goto L4;
  ...
  anon6_Else:
    ...
    call {:si_unique_call 485} StartDeviceWorker#0(sdv_p_devobj_fdo, Context_2);
    goto L1;
...
implementation {:origName "sdv_RunIoQueueWorkItems"} {:osmodel} sdv_RunIoQueueWorkItems#1(actual_IoWorkItem_2: int, actual_WorkerRoutine_1: int, actual_QueueType_1: int, actual_Context_2: int)
{
  ...
  anon5_Else:
    assume {:partition} WorkerRoutine_1 == li2bplFunctionConstant271;
    call {:si_unique_call 487} SerialMouseSerialMaskEventWorker#1(sdv_p_devobj_fdo, Context_2);
    goto L4;
  ...
  anon6_Else:
    assume {:partition} WorkerRoutine_1 == li2bplFunctionConstant193;
    call {:si_unique_call 488} StartDeviceWorker#1(sdv_p_devobj_fdo, Context_2);
    goto L1;
...
implementation {:origName "SerialMouseStartDevice"} SerialMouseStartDevice#0(actual_DeviceExtension_30: int, actual_Irp_11: int, actual_CloseOnFailure: int) returns (Tmp_304: int)
{
  ...
  anon9_Else:
    ...
    call {:si_unique_call 548} Tmp_305 := __HAVOC_malloc(4);
    assume {:nonnull} DeviceExtension_30 != 0;
    assume DeviceExtension_30 > 0;
    assume {:nonnull} Tmp_305 != 0;
    assume Tmp_305 > 0;
    call {:si_unique_call 549} vslice_dummy_var_113 := sdv_InterlockedDecrement(Tmp_305);
    assume {:nonnull} DeviceExtension_30 != 0;
    assume DeviceExtension_30 > 0;
    assume {:nonnull} Tmp_305 != 0;
    assume Tmp_305 > 0;
...
implementation {:origName "SerialMouseStartDevice"} SerialMouseStartDevice#1(actual_DeviceExtension_30: int, actual_Irp_11: int, actual_CloseOnFailure: int) returns (Tmp_304: int)
{
  ...
  anon9_Else:
    ...
    call {:si_unique_call 554} Tmp_305 := __HAVOC_malloc(4);
    assume {:nonnull} DeviceExtension_30 != 0;
    assume DeviceExtension_30 > 0;
    assume {:nonnull} Tmp_305 != 0;
    assume Tmp_305 > 0;
    call {:si_unique_call 555} vslice_dummy_var_114 := sdv_InterlockedDecrement(Tmp_305);
    assume {:nonnull} DeviceExtension_30 != 0;
    assume DeviceExtension_30 > 0;
    assume {:nonnull} Tmp_305 != 0;
    assume Tmp_305 > 0;
...
implementation {:origName "SerialMouseInitializeDevice"} SerialMouseInitializeDevice#0(actual_DeviceExtension_32: int) returns (Tmp_308: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 559} Tmp_313 := __HAVOC_malloc(4);
  ...
  L16:
    call {:si_unique_call 561} i_3, Tmp_309 := SerialMouseInitializeDevice#0_loop_L16(i_3, Tmp_309, dumpData);
    goto L16_last;
  ...
  anon16_Else:
    ...
    call {:si_unique_call 566} sdv_206 := IoAllocateErrorLogEntry(0, Tmp_314);
  ...
  L59:
    call {:si_unique_call 567} i_3, Tmp_310, Tmp_312, Tmp_313 := SerialMouseInitializeDevice#0_loop_L59(i_3, Tmp_310, Tmp_312, errorLogEntry, Tmp_313, dumpData, dumpCount);
    goto L59_last;
...
implementation {:origName "SerialMouseInitializeDevice"} SerialMouseInitializeDevice#1(actual_DeviceExtension_32: int) returns (Tmp_308: int)
{
  ...
  anon0:
    ...
    DeviceExtension_32 := actual_DeviceExtension_32;
    call {:si_unique_call 573} Tmp_313 := __HAVOC_malloc(4);
  ...
  L16:
    call {:si_unique_call 575} i_3, Tmp_309 := SerialMouseInitializeDevice#1_loop_L16(i_3, Tmp_309, dumpData);
    goto L16_last;
  ...
  anon16_Else:
    ...
    assume DeviceExtension_32 > 0;
    Tmp_314 := 48 + dumpCount * 4;
    call {:si_unique_call 580} sdv_206 := IoAllocateErrorLogEntry(0, Tmp_314);
    errorLogEntry := sdv_206;
    goto anon18_Then, anon18_Else;
  ...
  L59:
    call {:si_unique_call 581} i_3, Tmp_310, Tmp_312, Tmp_313 := SerialMouseInitializeDevice#1_loop_L59(i_3, Tmp_310, Tmp_312, errorLogEntry, Tmp_313, dumpData, dumpCount);
    goto L59_last;
...
implementation {:origName "MSerDetect"} MSerDetect#0(actual_DeviceExtension_25: int) returns (Tmp_247: int)
{
  ...
  L52:
    call {:si_unique_call 619} Tmp_248, count_3, Tmp_257, sdv_170 := MSerDetect#0_loop_L52(Tmp_248, count_3, receiveBuffer, Tmp_257, sdv_170, DeviceExtension_25);
    goto L52_last;
  ...
  L61:
    call {:si_unique_call 621} i_1 := MSerDetect#0_loop_L61(i_1, count_3);
    goto L61_last;
  ...
  L64:
    call {:si_unique_call 622} i_1, Tmp_250, Tmp_251 := MSerDetect#0_loop_L64(i_1, count_3, Tmp_250, Tmp_251, receiveBuffer);
    goto L64_last;
...
implementation {:origName "MSerDetect"} MSerDetect#1(actual_DeviceExtension_25: int) returns (Tmp_247: int)
{
  ...
  L52:
    call {:si_unique_call 636} Tmp_248, count_3, Tmp_257, sdv_170 := MSerDetect#1_loop_L52(Tmp_248, count_3, receiveBuffer, Tmp_257, sdv_170, DeviceExtension_25);
    goto L52_last;
  ...
  L61:
    call {:si_unique_call 638} i_1 := MSerDetect#1_loop_L61(i_1, count_3);
    goto L61_last;
  ...
  L64:
    call {:si_unique_call 639} i_1, Tmp_250, Tmp_251 := MSerDetect#1_loop_L64(i_1, count_3, Tmp_250, Tmp_251, receiveBuffer);
    goto L64_last;
...
implementation {:origName "SerialMouseReadSerialPort"} SerialMouseReadSerialPort#1(actual_DeviceExtension_18: int, actual_ReadBuffer: int, actual_Buflen: int, actual_ActualBytesRead: int) returns (Tmp_220: int)
{
  ...
  L21:
    call {:si_unique_call 758} status_20, stack_1 := SerialMouseReadSerialPort#1_loop_L21(irp_4, status_20, event_9, stack_1, DeviceExtension_18, ReadBuffer, Buflen, ActualBytesRead);
    goto L21_last;
...
implementation {:origName "CSerDetect"} CSerDetect#0(actual_DeviceExtension_3: int, actual_HardwareButtons: int) returns (Tmp_18: int)
{
  ...
  L19:
    call {:si_unique_call 770} Tmp_19, count_1, Tmp_21, sdv_14, vslice_dummy_var_148, vslice_dummy_var_149, vslice_dummy_var_150, vslice_dummy_var_151, vslice_dummy_var_157 := CSerDetect#0_loop_L19(Tmp_19, count_1, Tmp_21, sdv_14, status_1, DeviceExtension_3, vslice_dummy_var_148, vslice_dummy_var_149, vslice_dummy_var_150, vslice_dummy_var_151, vslice_dummy_var_157);
    goto L19_last;
...
implementation {:origName "CSerDetect"} CSerDetect#1(actual_DeviceExtension_3: int, actual_HardwareButtons: int) returns (Tmp_18: int)
{
  ...
  L19:
    call {:si_unique_call 790} Tmp_19, count_1, Tmp_21, sdv_14, vslice_dummy_var_159, vslice_dummy_var_160, vslice_dummy_var_161, vslice_dummy_var_162, vslice_dummy_var_168 := CSerDetect#1_loop_L19(Tmp_19, count_1, Tmp_21, sdv_14, status_1, DeviceExtension_3, vslice_dummy_var_159, vslice_dummy_var_160, vslice_dummy_var_161, vslice_dummy_var_162, vslice_dummy_var_168);
    goto L19_last;
...
implementation {:origName "SerialMouseWriteSerialPort"} SerialMouseWriteSerialPort#1(actual_DeviceExtension_17: int, actual_WriteBuffer: int, actual_NumBytes: int, actual_IoStatusBlock_2: int) returns (Tmp_216: int)
{
  ...
  anon6_Else:
    ...
    call {:si_unique_call 830} status_19 := KeWaitForSingleObject(0, 0, 0, 0, 0);
    goto L24;
...
implementation {:origName "CSerSetProtocol"} CSerSetProtocol#0(actual_DeviceExtension_2: int, actual_NewProtocol: int) returns (Tmp_11: int)
{
  ...
  anon0:
    ...
    Tmp_16 := NewProtocol;
    havoc Tmp_12;
    call {:si_unique_call 832} vslice_dummy_var_173 := SerialMouseWriteChar#0(DeviceExtension_2, Tmp_12);
    Tmp_15 := NewProtocol;
    havoc Tmp_14;
    call {:si_unique_call 833} vslice_dummy_var_174 := SerialMouseSetLineCtrl#0(DeviceExtension_2, Tmp_14);
    Tmp_13 := NewProtocol;
    havoc Tmp_11;
    return;
}
...
implementation {:origName "CSerSetProtocol"} CSerSetProtocol#1(actual_DeviceExtension_2: int, actual_NewProtocol: int) returns (Tmp_11: int)
{
  ...
  anon0:
    ...
    Tmp_16 := NewProtocol;
    havoc Tmp_12;
    call {:si_unique_call 835} vslice_dummy_var_175 := SerialMouseWriteChar#1(DeviceExtension_2, Tmp_12);
    Tmp_15 := NewProtocol;
    havoc Tmp_14;
    call {:si_unique_call 836} vslice_dummy_var_176 := SerialMouseSetLineCtrl#1(DeviceExtension_2, Tmp_14);
    Tmp_13 := NewProtocol;
    havoc Tmp_11;
    return;
}
...
implementation {:origName "CSerSetBaudRate"} CSerSetBaudRate#0(actual_DeviceExtension_4: int, actual_BaudRate: int)
{
  ...
  anon0:
    call {:si_unique_call 837} vslice_dummy_var_177 := __HAVOC_malloc(4);
  ...
  anon6_Else:
    Tmp_24 := count_2;
    havoc Tmp_29;
    call {:si_unique_call 841} vslice_dummy_var_179 := SerialMouseWriteString#0(DeviceExtension_4, Tmp_29);
    Tmp_23 := count_2;
    havoc Tmp_28;
    call {:si_unique_call 842} vslice_dummy_var_180 := SerialMouseSetBaudRate#0(DeviceExtension_4, Tmp_28);
    call {:si_unique_call 843} vslice_dummy_var_178 := SerialMouseWait(DeviceExtension_4, -20000);
    goto L1;
...
implementation {:origName "CSerSetBaudRate"} CSerSetBaudRate#1(actual_DeviceExtension_4: int, actual_BaudRate: int)
{
  ...
  anon0:
    call {:si_unique_call 844} vslice_dummy_var_181 := __HAVOC_malloc(4);
    DeviceExtension_4 := actual_DeviceExtension_4;
    BaudRate := actual_BaudRate;
  ...
  anon6_Else:
    Tmp_24 := count_2;
    havoc Tmp_29;
    call {:si_unique_call 848} vslice_dummy_var_183 := SerialMouseWriteString#1(DeviceExtension_4, Tmp_29);
    Tmp_23 := count_2;
    havoc Tmp_28;
    call {:si_unique_call 849} vslice_dummy_var_184 := SerialMouseSetBaudRate#1(DeviceExtension_4, Tmp_28);
    call {:si_unique_call 850} vslice_dummy_var_182 := SerialMouseWait(DeviceExtension_4, -20000);
    goto L1;
...
implementation {:origName "MSerSetProtocol"} MSerSetProtocol#0(actual_DeviceExtension_23: int, actual_NewProtocol_1: int) returns (Tmp_238: int)
{
  ...
  L7:
    ...
    havoc Tmp_240;
    call {:si_unique_call 858} vslice_dummy_var_185 := SerialMouseSetLineCtrl#0(DeviceExtension_23, Tmp_240);
...
implementation {:origName "MSerSetProtocol"} MSerSetProtocol#1(actual_DeviceExtension_23: int, actual_NewProtocol_1: int) returns (Tmp_238: int)
{
  ...
  L7:
    Tmp_242 := NewProtocol_1;
    havoc Tmp_240;
    call {:si_unique_call 860} vslice_dummy_var_186 := SerialMouseSetLineCtrl#1(DeviceExtension_23, Tmp_240);
    Tmp_239 := NewProtocol_1;
    havoc Tmp_238;
    return;
...
implementation {:origName "SerialMouseStartDetection"} SerialMouseStartDetection#0(actual_DeviceExtension_6: int)
{
  ...
  anon0:
    call {:si_unique_call 873} vslice_dummy_var_187 := __HAVOC_malloc(4);
  ...
  anon24_Then:
    ...
    call {:si_unique_call 884} vslice_dummy_var_188 := IoCancelIrp(0);
    assume {:nonnull} DeviceExtension_6 != 0;
    assume DeviceExtension_6 > 0;
    goto L1;
...
implementation {:origName "SerialMouseStartDetection"} SerialMouseStartDetection#1(actual_DeviceExtension_6: int)
{
  ...
  anon0:
    call {:si_unique_call 888} vslice_dummy_var_189 := __HAVOC_malloc(4);
  ...
  anon24_Then:
    assume {:partition} 0 > status_6;
    call {:si_unique_call 899} vslice_dummy_var_190 := IoCancelIrp(0);
    assume {:nonnull} DeviceExtension_6 != 0;
    assume DeviceExtension_6 > 0;
    goto L1;
...
implementation {:origName "SerialMouseSpinUpRead"} SerialMouseSpinUpRead#0(actual_DeviceExtension_29: int) returns (Tmp_302: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 904} vslice_dummy_var_191 := sdv_IoAcquireRemoveLock(0, 0);
...
implementation {:origName "SerialMouseSpinUpRead"} SerialMouseSpinUpRead#1(actual_DeviceExtension_29: int) returns (Tmp_302: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 907} vslice_dummy_var_192 := sdv_IoAcquireRemoveLock(0, 0);
    assume {:nonnull} DeviceExtension_29 != 0;
    assume DeviceExtension_29 > 0;
...
implementation {:origName "SerialMouseClosePort"} SerialMouseClosePort#0(actual_DeviceExtension_31: int, actual_Irp_12: int)
{
  ...
  anon0:
    call {:si_unique_call 909} vslice_dummy_var_193 := __HAVOC_malloc(4);
    ...
    call {:si_unique_call 914} vslice_dummy_var_194 := SerialMouseSendIrpSynchronously#0(vslice_dummy_var_234, Irp_12, 0);
    ...
    call {:si_unique_call 917} vslice_dummy_var_195 := SerialMouseSendIrpSynchronously#0(vslice_dummy_var_235, Irp_12, 0);
    return;
}
...
implementation {:origName "SerialMouseClosePort"} SerialMouseClosePort#1(actual_DeviceExtension_31: int, actual_Irp_12: int)
{
  ...
  anon0:
    call {:si_unique_call 918} vslice_dummy_var_196 := __HAVOC_malloc(4);
    DeviceExtension_31 := actual_DeviceExtension_31;
    Irp_12 := actual_Irp_12;
    ...
    call {:si_unique_call 923} vslice_dummy_var_197 := SerialMouseSendIrpSynchronously#1(vslice_dummy_var_236, Irp_12, 0);
    ...
    call {:si_unique_call 926} vslice_dummy_var_198 := SerialMouseSendIrpSynchronously#1(vslice_dummy_var_237, Irp_12, 0);
    return;
}
...
implementation {:origName "SerialMouseRestorePort"} SerialMouseRestorePort#0(actual_DeviceExtension_16: int)
{
  ...
  anon0:
    call {:si_unique_call 927} vslice_dummy_var_199 := __HAVOC_malloc(4);
  ...
  anon3_Else:
    ...
    call {:si_unique_call 932} vslice_dummy_var_200 := SerialMousepIoSyncIoctlEx#0(0, 1769500, vslice_dummy_var_239, event_7, iosb_9, Timeouts__SERIAL_BASIC_SETTINGS(SerialBasicSettings__DEVICE_EXTENSION(DeviceExtension_16)), 20, 0, 0);
    assume {:nonnull} DeviceExtension_16 != 0;
    assume DeviceExtension_16 > 0;
    havoc vslice_dummy_var_240;
    call {:si_unique_call 933} vslice_dummy_var_201 := SerialMousepIoSyncIoctlEx#0(0, 1769572, vslice_dummy_var_240, event_7, iosb_9, HandFlow__SERIAL_BASIC_SETTINGS(SerialBasicSettings__DEVICE_EXTENSION(DeviceExtension_16)), 16, 0, 0);
    goto L1;
...
implementation {:origName "SerialMouseRestorePort"} SerialMouseRestorePort#1(actual_DeviceExtension_16: int)
{
  ...
  anon0:
    call {:si_unique_call 934} vslice_dummy_var_202 := __HAVOC_malloc(4);
  ...
  anon3_Else:
    ...
    call {:si_unique_call 939} vslice_dummy_var_203 := SerialMousepIoSyncIoctlEx#1(0, 1769500, vslice_dummy_var_242, event_7, iosb_9, Timeouts__SERIAL_BASIC_SETTINGS(SerialBasicSettings__DEVICE_EXTENSION(DeviceExtension_16)), 20, 0, 0);
    assume {:nonnull} DeviceExtension_16 != 0;
    assume DeviceExtension_16 > 0;
    havoc vslice_dummy_var_243;
    call {:si_unique_call 940} vslice_dummy_var_204 := SerialMousepIoSyncIoctlEx#1(0, 1769572, vslice_dummy_var_243, event_7, iosb_9, HandFlow__SERIAL_BASIC_SETTINGS(SerialBasicSettings__DEVICE_EXTENSION(DeviceExtension_16)), 16, 0, 0);
    goto L1;
...
implementation {:origName "SerialMouseSendIrpSynchronously"} SerialMouseSendIrpSynchronously#1(actual_DeviceObject_23: int, actual_Irp_17: int, actual_CopyToNext: int) returns (Tmp_328: int)
{
  ...
  anon8_Else:
    ...
    call {:si_unique_call 954} vslice_dummy_var_206 := KeWaitForSingleObject(0, 0, 0, 0, 0);
...
implementation {:SIextraRecBound 5} SerialMousePnP_loop_L89(in_i_4: int, in_devCaps: int, in_Tmp_343: int, in_Tmp_344: int) returns (out_i_4: int, out_Tmp_343: int, out_Tmp_344: int)
{
  ...
  anon103_Else_dummy:
    call {:si_unique_call 955} {:si_old_unique_call 1} out_i_4, out_Tmp_343, out_Tmp_344 := SerialMousePnP_loop_L89(out_i_4, in_devCaps, out_Tmp_343, out_Tmp_344);
    return;
}
...
implementation SerialMouseStartRead#1_loop_L13(in_sdv_124: int, in_Tmp_211: int, in_irp_2: int, in_status_17: int, in_irql: int, in_stack: int, in_DeviceExtension_15: int) returns (out_Tmp_211: int, out_status_17: int, out_irql: int, out_stack: int)
{
  ...
  anon15_Else_dummy:
    call {:si_unique_call 963} {:si_old_unique_call 1} out_Tmp_211, out_status_17, out_irql, out_stack := SerialMouseStartRead#1_loop_L13(in_sdv_124, out_Tmp_211, in_irp_2, out_status_17, out_irql, out_stack, in_DeviceExtension_15);
    return;
}
...
implementation SerialMouseInitializeDevice#0_loop_L59(in_i_3: int, in_Tmp_310: int, in_Tmp_312: int, in_errorLogEntry: int, in_Tmp_313: int, in_dumpData: int, in_dumpCount: int) returns (out_i_3: int, out_Tmp_310: int, out_Tmp_312: int, out_Tmp_313: int)
{
  ...
  anon17_Else_dummy:
    call {:si_unique_call 964} {:si_old_unique_call 1} out_i_3, out_Tmp_310, out_Tmp_312, out_Tmp_313 := SerialMouseInitializeDevice#0_loop_L59(out_i_3, out_Tmp_310, out_Tmp_312, in_errorLogEntry, out_Tmp_313, in_dumpData, in_dumpCount);
    return;
}
...
implementation {:SIextraRecBound 4} SerialMouseInitializeDevice#0_loop_L16(in_i_3: int, in_Tmp_309: int, in_dumpData: int) returns (out_i_3: int, out_Tmp_309: int)
{
  ...
  anon13_Else_dummy:
    call {:si_unique_call 965} {:si_old_unique_call 1} out_i_3, out_Tmp_309 := SerialMouseInitializeDevice#0_loop_L16(out_i_3, out_Tmp_309, in_dumpData);
    return;
}
...
implementation SerialMouseInitializeDevice#1_loop_L59(in_i_3: int, in_Tmp_310: int, in_Tmp_312: int, in_errorLogEntry: int, in_Tmp_313: int, in_dumpData: int, in_dumpCount: int) returns (out_i_3: int, out_Tmp_310: int, out_Tmp_312: int, out_Tmp_313: int)
{
  ...
  anon17_Else_dummy:
    call {:si_unique_call 966} {:si_old_unique_call 1} out_i_3, out_Tmp_310, out_Tmp_312, out_Tmp_313 := SerialMouseInitializeDevice#1_loop_L59(out_i_3, out_Tmp_310, out_Tmp_312, in_errorLogEntry, out_Tmp_313, in_dumpData, in_dumpCount);
    return;
}
...
implementation {:SIextraRecBound 4} SerialMouseInitializeDevice#1_loop_L16(in_i_3: int, in_Tmp_309: int, in_dumpData: int) returns (out_i_3: int, out_Tmp_309: int)
{
  ...
  anon13_Else_dummy:
    call {:si_unique_call 967} {:si_old_unique_call 1} out_i_3, out_Tmp_309 := SerialMouseInitializeDevice#1_loop_L16(out_i_3, out_Tmp_309, in_dumpData);
    return;
}
...
implementation MSerDetect#1_loop_L52(in_Tmp_248: int, in_count_3: int, in_receiveBuffer: int, in_Tmp_257: int, in_sdv_170: int, in_DeviceExtension_25: int) returns (out_Tmp_248: int, out_count_3: int, out_Tmp_257: int, out_sdv_170: int)
{
  ...
  anon27_Else_dummy:
    call {:si_unique_call 970} {:si_old_unique_call 1} out_Tmp_248, out_count_3, out_Tmp_257, out_sdv_170 := MSerDetect#1_loop_L52(out_Tmp_248, out_count_3, in_receiveBuffer, out_Tmp_257, out_sdv_170, in_DeviceExtension_25);
    return;
}
...
implementation SerialMouseReadSerialPort#1_loop_L21(in_irp_4: int, in_status_20: int, in_event_9: int, in_stack_1: int, in_DeviceExtension_18: int, in_ReadBuffer: int, in_Buflen: int, in_ActualBytesRead: int) returns (out_status_20: int, out_stack_1: int)
{
  ...
  anon18_Else_dummy:
    call {:si_unique_call 977} {:si_old_unique_call 1} out_status_20, out_stack_1 := SerialMouseReadSerialPort#1_loop_L21(in_irp_4, out_status_20, in_event_9, out_stack_1, in_DeviceExtension_18, in_ReadBuffer, in_Buflen, in_ActualBytesRead);
    return;
...
implementation CSerDetect#0_loop_L19(in_Tmp_19: int, in_count_1: int, in_Tmp_21: int, in_sdv_14: int, in_status_1: int, in_DeviceExtension_3: int, in_vslice_dummy_var_148: int, in_vslice_dummy_var_149: int, in_vslice_dummy_var_150: int, in_vslice_dummy_var_151: int, in_vslice_dummy_var_157: int) returns (out_Tmp_19: int, out_count_1: int, out_Tmp_21: int, out_sdv_14: int, out_vslice_dummy_var_148: int, out_vslice_dummy_var_149: int, out_vslice_dummy_var_150: int, out_vslice_dummy_var_151: int, out_vslice_dummy_var_157: int)
{
...
procedure {:LoopProcedure} CSerDetect#0_loop_L19(in_Tmp_19: int, in_count_1: int, in_Tmp_21: int, in_sdv_14: int, in_status_1: int, in_DeviceExtension_3: int, in_vslice_dummy_var_148: int, in_vslice_dummy_var_149: int, in_vslice_dummy_var_150: int, in_vslice_dummy_var_151: int, in_vslice_dummy_var_157: int) returns (out_Tmp_19: int, out_count_1: int, out_Tmp_21: int, out_sdv_14: int, out_vslice_dummy_var_148: int, out_vslice_dummy_var_149: int, out_vslice_dummy_var_150: int, out_vslice_dummy_var_151: int, out_vslice_dummy_var_157: int);
  modifies alloc, Mem_T.CompletionRoutine__IO_STACK_LOCATION;
...
procedure {:LoopProcedure} CSerDetect#1_loop_L19(in_Tmp_19: int, in_count_1: int, in_Tmp_21: int, in_sdv_14: int, in_status_1: int, in_DeviceExtension_3: int, in_vslice_dummy_var_159: int, in_vslice_dummy_var_160: int, in_vslice_dummy_var_161: int, in_vslice_dummy_var_162: int, in_vslice_dummy_var_168: int) returns (out_Tmp_19: int, out_count_1: int, out_Tmp_21: int, out_sdv_14: int, out_vslice_dummy_var_159: int, out_vslice_dummy_var_160: int, out_vslice_dummy_var_161: int, out_vslice_dummy_var_162: int, out_vslice_dummy_var_168: int);
  modifies alloc, Mem_T.CompletionRoutine__IO_STACK_LOCATION, s, forward_state;
  free ensures {:va_keep} old(forward_state) == 1 ==> forward_state != 0;
  free ensures {:va_keep} old(forward_state) == 0 ==> forward_state != 1;
  free ensures {:va_keep} old(s) == 2 ==> s != 0;
