...
implementation {:origName "main"} {:osmodel} main() returns (Tmp_124: int, dup_assertVar: bool)
{
  ...
  anon0:
    ...
    call {:si_unique_call 83} sdv_other_harnessStackLocation_next__Loc := __HAVOC_malloc_or_null(536);
    assume sdv_other_harnessStackLocation_next__Loc == sdv_other_harnessStackLocation_next;
    assume sdv_other_harnessStackLocation_next != 0;
    call {:si_unique_call 84} sdv_harnessStackLocation__Loc := __HAVOC_malloc_or_null(536);
    ...
    call {:si_unique_call 123} vslice_dummy_var_219 := __HAVOC_malloc(12);
    call {:si_unique_call 124} vslice_dummy_var_10 := __HAVOC_malloc(48);
    call {:si_unique_call 125} vslice_dummy_var_220 := __HAVOC_malloc(12);
...
implementation {:origName "SerialMouseServiceParameters"} SerialMouseServiceParameters(actual_DeviceExtension_28: int, actual_Handle_1: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 202} sdv_183 := ExAllocatePoolWithTag(1, Tmp_301, -228232371);
    parameters := sdv_183;
  ...
  anon24_Else:
    ...
    call {:si_unique_call 203} sdv_RtlZeroMemory(0, Tmp_290);
  ...
  anon19_Then:
    ...
    assume parametersPath > 0;
    havoc Tmp_300;
    call {:si_unique_call 208} sdv_188 := ExAllocatePoolWithTag(1, Tmp_300, -228232371);
    assume {:nonnull} parametersPath != 0;
    assume parametersPath > 0;
    assume {:nonnull} parametersPath != 0;
    assume parametersPath > 0;
  ...
  anon26_Else:
    ...
    assume parametersPath > 0;
    havoc Tmp_292;
    call {:si_unique_call 209} sdv_RtlZeroMemory(0, Tmp_292);
...
implementation {:origName "SerialMouseCreate"} SerialMouseCreate(actual_DeviceObject_19: int, actual_Irp_13: int) returns (Tmp_315: int)
{
  ...
  anon16_Else:
    call {:si_unique_call 218} Tmp_316 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_316 != 0;
    assume Tmp_316 > 0;
    assume {:nonnull} deviceExtension_3 != 0;
    assume deviceExtension_3 > 0;
    call {:si_unique_call 219} sdv_206 := sdv_InterlockedIncrement(Tmp_316);
    assume {:nonnull} Tmp_316 != 0;
    assume Tmp_316 > 0;
    assume {:nonnull} deviceExtension_3 != 0;
    assume deviceExtension_3 > 0;
  ...
  L44:
    call {:si_unique_call 223} Tmp_316 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_316 != 0;
    assume Tmp_316 > 0;
    assume {:nonnull} deviceExtension_3 != 0;
    assume deviceExtension_3 > 0;
    call {:si_unique_call 224} vslice_dummy_var_54 := sdv_InterlockedDecrement(Tmp_316);
    assume {:nonnull} Tmp_316 != 0;
    assume Tmp_316 > 0;
    assume {:nonnull} deviceExtension_3 != 0;
    assume deviceExtension_3 > 0;
...
procedure {:origName "SerialMouseFlush"} SerialMouseFlush(actual_DeviceObject_21: int, actual_Irp_15: int) returns (Tmp_324: int);
  ...
  free ensures {:va_keep} yogi_error == 1 || yogi_error == old(yogi_error);
  free ensures {:va_keep} irp_state == 1 || irp_state == old(irp_state);
  free ensures {:va_keep} Tmp_324 == 259 || Tmp_324 == -1073741823 || Tmp_324 == -1073741738 || Tmp_324 == 0;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} false || old(event_state) == 2 || old(event_state) == 0 || old(event_state) == 1;
  free ensures {:va_keep} false || old(irp_state) == 1 || old(irp_state) == 0;
  free ensures {:va_keep} alloc >= old(alloc);
...
procedure {:origName "SerialMouseClose"} SerialMouseClose(actual_DeviceObject_22: int, actual_Irp_16: int) returns (Tmp_326: int);
  ...
  free ensures {:va_keep} yogi_error == 1 || yogi_error == old(yogi_error);
  free ensures {:va_keep} irp_state == 1 || irp_state == old(irp_state);
  free ensures {:va_keep} Tmp_326 == -1073741823 || Tmp_326 == -1073741738 || Tmp_326 == 0 || Tmp_326 == 259;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} false || old(event_state) == 2 || old(event_state) == 0 || old(event_state) == 1;
  free ensures {:va_keep} false || old(irp_state) == 1 || old(irp_state) == 0;
  free ensures {:va_keep} alloc >= old(alloc);
...
implementation {:origName "SerialMouseClose"} SerialMouseClose(actual_DeviceObject_22: int, actual_Irp_16: int) returns (Tmp_326: int)
{
  ...
  anon7_Then:
    ...
    call {:si_unique_call 241} Tmp_327 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_327 != 0;
    assume Tmp_327 > 0;
    assume {:nonnull} deviceExtension_6 != 0;
    assume deviceExtension_6 > 0;
    call {:si_unique_call 242} sdv_214 := sdv_InterlockedDecrement(Tmp_327);
    assume {:nonnull} Tmp_327 != 0;
    assume Tmp_327 > 0;
    assume {:nonnull} deviceExtension_6 != 0;
    assume deviceExtension_6 > 0;
  ...
  anon8_Then:
    ...
    call {:si_unique_call 249} Tmp_326 := sdv_IoCallDriver#1(vslice_dummy_var_13, Irp_16);
    goto L1;
}
...
implementation {:origName "SerialMouseStopDevice"} SerialMouseStopDevice(actual_DeviceExtension_34: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 259} Tmp_340 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_340 != 0;
    assume Tmp_340 > 0;
    call {:si_unique_call 260} sdv_KeAcquireSpinLock(0, Tmp_340);
    assume {:nonnull} Tmp_340 != 0;
    assume Tmp_340 > 0;
    havoc irql_1;
...
implementation {:origName "SerialMousePnP"} SerialMousePnP(actual_DeviceObject_26: int, actual_Irp_20: int) returns (Tmp_341: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 265} Tmp_343 := __HAVOC_malloc(28);
    call {:si_unique_call 266} Tmp_345 := __HAVOC_malloc(28);
    skipIt := 0;
  ...
  L89:
    call {:si_unique_call 278} i_4, Tmp_343, Tmp_344 := SerialMousePnP_loop_L89(i_4, devCaps, Tmp_343, Tmp_344);
    goto L89_last;
  ...
  anon88_Else:
    call {:si_unique_call 290} Tmp_342 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_342 != 0;
    assume Tmp_342 > 0;
    assume {:nonnull} deviceExtension_8 != 0;
    assume deviceExtension_8 > 0;
    call {:si_unique_call 291} sdv_232 := sdv_InterlockedIncrement(Tmp_342);
    assume {:nonnull} Tmp_342 != 0;
    assume Tmp_342 > 0;
    assume {:nonnull} deviceExtension_8 != 0;
    assume deviceExtension_8 > 0;
  ...
  L161:
    ...
    call {:si_unique_call 300} Tmp_342 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_342 != 0;
    assume Tmp_342 > 0;
    assume {:nonnull} deviceExtension_8 != 0;
    assume deviceExtension_8 > 0;
    call {:si_unique_call 301} sdv_238 := sdv_InterlockedDecrement(Tmp_342);
    assume {:nonnull} Tmp_342 != 0;
    assume Tmp_342 > 0;
    assume {:nonnull} deviceExtension_8 != 0;
    assume deviceExtension_8 > 0;
...
implementation {:origName "SerialMousePower"} SerialMousePower(actual_DeviceObject_27: int, actual_Irp_21: int) returns (Tmp_346: int)
{
  ...
  L62:
    ...
    call {:si_unique_call 324} Tmp_346 := PoCallDriver(0, Irp_21);
    goto L1;
...
implementation {:origName "SerialMouseHandleStartStopStart"} SerialMouseHandleStartStopStart(actual_DeviceExtension_35: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 349} Tmp_348 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_348 != 0;
    assume Tmp_348 > 0;
    call {:si_unique_call 350} sdv_KeAcquireSpinLock(0, Tmp_348);
    assume {:nonnull} Tmp_348 != 0;
    assume Tmp_348 > 0;
    havoc irql_2;
...
implementation {:origName "sdv_RunIoCompletionRoutines"} {:osmodel} sdv_RunIoCompletionRoutines#0(actual_DeviceObject_9: int, actual_Irp_7: int, actual_Context_5: int, actual_Completion: int) returns (Tmp_175: int)
{
  ...
  anon12_Else:
    call {:si_unique_call 403} Status_1 := SerialMouseCompletionRoutine(DeviceObject_9, Irp_7, Context_5);
    assume {:nonnull} Completion != 0;
    assume Completion > 0;
    goto L11;
  ...
  anon9_Else:
    call {:si_unique_call 404} Status_1 := SerialMouseReadComplete#0(DeviceObject_9, Irp_7, Context_5);
    assume {:nonnull} Completion != 0;
    assume Completion > 0;
    goto L28;
  ...
  anon10_Else:
    call {:si_unique_call 405} Status_1 := SerialMouseReadSerialPortComplete(DeviceObject_9, Irp_7, Context_5);
    assume {:nonnull} Completion != 0;
    assume Completion > 0;
    goto L45;
  ...
  anon11_Else:
    call {:si_unique_call 406} Status_1 := SerialMouseSerialMaskEventComplete#0(DeviceObject_9, Irp_7, Context_5);
    assume {:nonnull} Completion != 0;
    assume Completion > 0;
    goto L62;
...
procedure {:origName "sdv_RunIoCompletionRoutines"} {:osmodel} sdv_RunIoCompletionRoutines#0(actual_DeviceObject_9: int, actual_Irp_7: int, actual_Context_5: int, actual_Completion: int) returns (Tmp_175: int);
  ...
  free ensures {:va_keep} old(SLAM_guard_O_0) == old(SLAM_guard_O_0_init) ==> event_state == old(event_state);
  free ensures {:va_keep} event_state == 2 || event_state == 1 || event_state == old(event_state);
  free ensures {:va_keep} Tmp_175 == -1073741802 || Tmp_175 == -1073741823 || Tmp_175 == 0;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} false || old(event_state) == 2 || old(event_state) == 0 || old(event_state) == 1;
  free ensures {:va_keep} false || old(irp_state) == 1 || old(irp_state) == 0;
  free ensures {:va_keep} alloc >= old(alloc);
...
implementation {:origName "sdv_RunIoCompletionRoutines"} {:osmodel} sdv_RunIoCompletionRoutines#1(actual_DeviceObject_9: int, actual_Irp_7: int, actual_Context_5: int, actual_Completion: int) returns (Tmp_175: int)
{
  ...
  anon12_Else:
    call {:si_unique_call 408} Status_1 := SerialMouseCompletionRoutine(DeviceObject_9, Irp_7, Context_5);
    assume {:nonnull} Completion != 0;
    assume Completion > 0;
    goto L11;
  ...
  anon9_Else:
    call {:si_unique_call 409} Status_1 := SerialMouseReadComplete#1(DeviceObject_9, Irp_7, Context_5);
    assume {:nonnull} Completion != 0;
    assume Completion > 0;
    goto L28;
  ...
  anon10_Else:
    call {:si_unique_call 410} Status_1 := SerialMouseReadSerialPortComplete(DeviceObject_9, Irp_7, Context_5);
    assume {:nonnull} Completion != 0;
    assume Completion > 0;
    goto L45;
  ...
  anon11_Else:
    call {:si_unique_call 411} Status_1 := SerialMouseSerialMaskEventComplete#1(DeviceObject_9, Irp_7, Context_5);
    assume {:nonnull} Completion != 0;
    assume Completion > 0;
    goto L62;
...
implementation {:origName "SerialMouseStartRead"} SerialMouseStartRead#1(actual_DeviceExtension_15: int) returns (Tmp_210: int)
{
  ...
  L13:
    call {:si_unique_call 439} Tmp_211, status_17, irql, stack := SerialMouseStartRead#1_loop_L13(sdv_120, Tmp_211, irp_2, status_17, irql, stack, DeviceExtension_15);
    goto L13_last;
...
implementation {:origName "IoQueueWorkItem"} {:osmodel} IoQueueWorkItem#0(actual_IoWorkItem_1: int, actual_WorkerRoutine: int, actual_QueueType: int, actual_Context_1: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 463} sdv_RunIoQueueWorkItems#0(0, WorkerRoutine, QueueType, Context_1);
    return;
}
...
implementation {:origName "IoQueueWorkItem"} {:osmodel} IoQueueWorkItem#1(actual_IoWorkItem_1: int, actual_WorkerRoutine: int, actual_QueueType: int, actual_Context_1: int)
{
  ...
  anon0:
    ...
    QueueType := actual_QueueType;
    Context_1 := actual_Context_1;
    call {:si_unique_call 465} sdv_RunIoQueueWorkItems#1(0, WorkerRoutine, QueueType, Context_1);
    return;
}
...
implementation {:origName "sdv_RunIoQueueWorkItems"} {:osmodel} sdv_RunIoQueueWorkItems#0(actual_IoWorkItem_2: int, actual_WorkerRoutine_1: int, actual_QueueType_1: int, actual_Context_2: int)
{
  ...
  anon5_Else:
    ...
    call {:si_unique_call 467} SerialMouseSerialMaskEventWorker#0(sdv_p_devobj_fdo, Context_2);
    goto L4;
  ...
  anon6_Else:
    ...
    call {:si_unique_call 468} StartDeviceWorker#0(sdv_p_devobj_fdo, Context_2);
    goto L1;
...
implementation {:origName "sdv_RunIoQueueWorkItems"} {:osmodel} sdv_RunIoQueueWorkItems#1(actual_IoWorkItem_2: int, actual_WorkerRoutine_1: int, actual_QueueType_1: int, actual_Context_2: int)
{
  ...
  anon5_Else:
    assume {:partition} WorkerRoutine_1 == li2bplFunctionConstant271;
    call {:si_unique_call 470} SerialMouseSerialMaskEventWorker#1(sdv_p_devobj_fdo, Context_2);
    goto L4;
  ...
  anon6_Else:
    assume {:partition} WorkerRoutine_1 == li2bplFunctionConstant193;
    call {:si_unique_call 471} StartDeviceWorker#1(sdv_p_devobj_fdo, Context_2);
    goto L1;
...
implementation {:origName "SerialMouseStartDevice"} SerialMouseStartDevice#0(actual_DeviceExtension_30: int, actual_Irp_11: int, actual_CloseOnFailure: int) returns (Tmp_304: int)
{
  ...
  anon9_Else:
    ...
    call {:si_unique_call 531} Tmp_305 := __HAVOC_malloc(4);
    assume {:nonnull} DeviceExtension_30 != 0;
    assume DeviceExtension_30 > 0;
    assume {:nonnull} Tmp_305 != 0;
    assume Tmp_305 > 0;
    call {:si_unique_call 532} vslice_dummy_var_125 := sdv_InterlockedDecrement(Tmp_305);
    assume {:nonnull} DeviceExtension_30 != 0;
    assume DeviceExtension_30 > 0;
    assume {:nonnull} Tmp_305 != 0;
    assume Tmp_305 > 0;
...
procedure {:origName "SerialMouseStartDevice"} SerialMouseStartDevice#0(actual_DeviceExtension_30: int, actual_Irp_11: int, actual_CloseOnFailure: int) returns (Tmp_304: int);
  ...
  free ensures {:va_keep} old(SLAM_guard_O_0) == old(SLAM_guard_O_0_init) ==> event_state == old(event_state);
  free ensures {:va_keep} event_state == 2 || event_state == 1 || event_state == old(event_state);
  free ensures {:va_keep} Tmp_304 == 0 || Tmp_304 == -1073741823;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} false || old(event_state) == 2 || old(event_state) == 0 || old(event_state) == 1;
  free ensures {:va_keep} false || old(irp_state) == 1 || old(irp_state) == 0;
  free ensures {:va_keep} alloc >= old(alloc);
...
implementation {:origName "SerialMouseStartDevice"} SerialMouseStartDevice#1(actual_DeviceExtension_30: int, actual_Irp_11: int, actual_CloseOnFailure: int) returns (Tmp_304: int)
{
  ...
  anon9_Else:
    ...
    call {:si_unique_call 537} Tmp_305 := __HAVOC_malloc(4);
    assume {:nonnull} DeviceExtension_30 != 0;
    assume DeviceExtension_30 > 0;
    assume {:nonnull} Tmp_305 != 0;
    assume Tmp_305 > 0;
    call {:si_unique_call 538} vslice_dummy_var_126 := sdv_InterlockedDecrement(Tmp_305);
    assume {:nonnull} DeviceExtension_30 != 0;
    assume DeviceExtension_30 > 0;
    assume {:nonnull} Tmp_305 != 0;
    assume Tmp_305 > 0;
...
procedure {:origName "SerialMouseStartDevice"} SerialMouseStartDevice#1(actual_DeviceExtension_30: int, actual_Irp_11: int, actual_CloseOnFailure: int) returns (Tmp_304: int);
  ...
  free ensures {:va_keep} event_state == 2 || event_state == 1 || event_state == old(event_state);
  free ensures {:va_keep} irp_state == 1 || irp_state == old(irp_state);
  free ensures {:va_keep} Tmp_304 == 0 || Tmp_304 == 259 || Tmp_304 == -1073741823;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} false || old(event_state) == 2 || old(event_state) == 0 || old(event_state) == 1;
  free ensures {:va_keep} false || old(irp_state) == 1 || old(irp_state) == 0;
  free ensures {:va_keep} alloc >= old(alloc);
...
implementation {:origName "SerialMouseInitializeDevice"} SerialMouseInitializeDevice#0(actual_DeviceExtension_32: int) returns (Tmp_308: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 542} Tmp_313 := __HAVOC_malloc(4);
  ...
  L16:
    call {:si_unique_call 544} i_3, Tmp_309 := SerialMouseInitializeDevice#0_loop_L16(i_3, Tmp_309, dumpData);
    goto L16_last;
  ...
  anon16_Else:
    ...
    call {:si_unique_call 549} sdv_202 := IoAllocateErrorLogEntry(0, Tmp_314);
  ...
  L59:
    call {:si_unique_call 550} i_3, Tmp_310, Tmp_312, Tmp_313 := SerialMouseInitializeDevice#0_loop_L59(i_3, Tmp_310, Tmp_312, errorLogEntry, Tmp_313, dumpData, dumpCount);
    goto L59_last;
...
procedure {:origName "SerialMouseInitializeDevice"} SerialMouseInitializeDevice#0(actual_DeviceExtension_32: int) returns (Tmp_308: int);
  ...
  free ensures {:va_keep} old(SLAM_guard_O_0) == old(SLAM_guard_O_0_init) ==> event_state == old(event_state);
  free ensures {:va_keep} event_state == 2 || event_state == 1 || event_state == old(event_state);
  free ensures {:va_keep} Tmp_308 == 0 || Tmp_308 == -1073741823;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} false || old(event_state) == 2 || old(event_state) == 0 || old(event_state) == 1;
  free ensures {:va_keep} false || old(irp_state) == 1 || old(irp_state) == 0;
  free ensures {:va_keep} alloc >= old(alloc);
...
implementation {:origName "SerialMouseInitializeDevice"} SerialMouseInitializeDevice#1(actual_DeviceExtension_32: int) returns (Tmp_308: int)
{
  ...
  anon0:
    ...
    DeviceExtension_32 := actual_DeviceExtension_32;
    call {:si_unique_call 556} Tmp_313 := __HAVOC_malloc(4);
  ...
  L16:
    call {:si_unique_call 558} i_3, Tmp_309 := SerialMouseInitializeDevice#1_loop_L16(i_3, Tmp_309, dumpData);
    goto L16_last;
  ...
  anon16_Else:
    ...
    assume DeviceExtension_32 > 0;
    Tmp_314 := 48 + dumpCount * 4;
    call {:si_unique_call 563} sdv_202 := IoAllocateErrorLogEntry(0, Tmp_314);
    errorLogEntry := sdv_202;
    goto anon18_Then, anon18_Else;
  ...
  L59:
    call {:si_unique_call 564} i_3, Tmp_310, Tmp_312, Tmp_313 := SerialMouseInitializeDevice#1_loop_L59(i_3, Tmp_310, Tmp_312, errorLogEntry, Tmp_313, dumpData, dumpCount);
    goto L59_last;
...
implementation {:origName "MSerDetect"} MSerDetect#0(actual_DeviceExtension_25: int) returns (Tmp_247: int)
{
  ...
  L52:
    call {:si_unique_call 602} Tmp_248, count_3, Tmp_257, sdv_166 := MSerDetect#0_loop_L52(Tmp_248, count_3, receiveBuffer, Tmp_257, sdv_166, DeviceExtension_25);
    goto L52_last;
  ...
  L61:
    call {:si_unique_call 604} i_1 := MSerDetect#0_loop_L61(i_1, count_3);
    goto L61_last;
  ...
  L64:
    call {:si_unique_call 605} i_1, Tmp_250, Tmp_251 := MSerDetect#0_loop_L64(i_1, count_3, Tmp_250, Tmp_251, receiveBuffer);
    goto L64_last;
...
implementation {:origName "MSerDetect"} MSerDetect#1(actual_DeviceExtension_25: int) returns (Tmp_247: int)
{
  ...
  L52:
    call {:si_unique_call 619} Tmp_248, count_3, Tmp_257, sdv_166 := MSerDetect#1_loop_L52(Tmp_248, count_3, receiveBuffer, Tmp_257, sdv_166, DeviceExtension_25);
    goto L52_last;
  ...
  L61:
    call {:si_unique_call 621} i_1 := MSerDetect#1_loop_L61(i_1, count_3);
    goto L61_last;
  ...
  L64:
    call {:si_unique_call 622} i_1, Tmp_250, Tmp_251 := MSerDetect#1_loop_L64(i_1, count_3, Tmp_250, Tmp_251, receiveBuffer);
    goto L64_last;
...
implementation {:origName "SerialMouseReadSerialPort"} SerialMouseReadSerialPort#1(actual_DeviceExtension_18: int, actual_ReadBuffer: int, actual_Buflen: int, actual_ActualBytesRead: int) returns (Tmp_220: int)
{
  ...
  L21:
    call {:si_unique_call 741} status_20, stack_1 := SerialMouseReadSerialPort#1_loop_L21(irp_4, status_20, event_9, stack_1, DeviceExtension_18, ReadBuffer, Buflen, ActualBytesRead);
    goto L21_last;
...
implementation {:origName "CSerDetect"} CSerDetect#0(actual_DeviceExtension_3: int, actual_HardwareButtons: int) returns (Tmp_18: int)
{
  ...
  L19:
    call {:si_unique_call 753} Tmp_19, count_1, Tmp_21, sdv_14, vslice_dummy_var_160, vslice_dummy_var_161, vslice_dummy_var_162, vslice_dummy_var_163, vslice_dummy_var_169 := CSerDetect#0_loop_L19(Tmp_19, count_1, Tmp_21, sdv_14, status_1, DeviceExtension_3, vslice_dummy_var_160, vslice_dummy_var_161, vslice_dummy_var_162, vslice_dummy_var_163, vslice_dummy_var_169);
    goto L19_last;
...
implementation {:origName "SerialMouseWriteSerialPort"} SerialMouseWriteSerialPort#1(actual_DeviceExtension_17: int, actual_WriteBuffer: int, actual_NumBytes: int, actual_IoStatusBlock_2: int) returns (Tmp_216: int)
{
  ...
  anon6_Else:
    ...
    call {:si_unique_call 813} status_19 := KeWaitForSingleObject(0, 0, 0, 0, 0);
    goto L24;
...
implementation {:origName "CSerSetProtocol"} CSerSetProtocol#0(actual_DeviceExtension_2: int, actual_NewProtocol: int) returns (Tmp_11: int)
{
  ...
  anon0:
    ...
    Tmp_16 := NewProtocol;
    havoc Tmp_12;
    call {:si_unique_call 815} vslice_dummy_var_185 := SerialMouseWriteChar#0(DeviceExtension_2, Tmp_12);
    Tmp_15 := NewProtocol;
    havoc Tmp_14;
    call {:si_unique_call 816} vslice_dummy_var_186 := SerialMouseSetLineCtrl#0(DeviceExtension_2, Tmp_14);
    Tmp_13 := NewProtocol;
    havoc Tmp_11;
    return;
}
...
implementation {:origName "CSerSetProtocol"} CSerSetProtocol#1(actual_DeviceExtension_2: int, actual_NewProtocol: int) returns (Tmp_11: int)
{
  ...
  anon0:
    ...
    Tmp_16 := NewProtocol;
    havoc Tmp_12;
    call {:si_unique_call 818} vslice_dummy_var_187 := SerialMouseWriteChar#1(DeviceExtension_2, Tmp_12);
    Tmp_15 := NewProtocol;
    havoc Tmp_14;
    call {:si_unique_call 819} vslice_dummy_var_188 := SerialMouseSetLineCtrl#1(DeviceExtension_2, Tmp_14);
    Tmp_13 := NewProtocol;
    havoc Tmp_11;
    return;
}
...
implementation {:origName "CSerSetBaudRate"} CSerSetBaudRate#0(actual_DeviceExtension_4: int, actual_BaudRate: int)
{
  ...
  anon0:
    call {:si_unique_call 820} vslice_dummy_var_189 := __HAVOC_malloc(4);
  ...
  anon6_Else:
    Tmp_24 := count_2;
    havoc Tmp_29;
    call {:si_unique_call 824} vslice_dummy_var_191 := SerialMouseWriteString#0(DeviceExtension_4, Tmp_29);
    Tmp_23 := count_2;
    havoc Tmp_28;
    call {:si_unique_call 825} vslice_dummy_var_192 := SerialMouseSetBaudRate#0(DeviceExtension_4, Tmp_28);
    call {:si_unique_call 826} vslice_dummy_var_190 := SerialMouseWait(DeviceExtension_4, -20000);
    goto L1;
...
implementation {:origName "CSerSetBaudRate"} CSerSetBaudRate#1(actual_DeviceExtension_4: int, actual_BaudRate: int)
{
  ...
  anon0:
    call {:si_unique_call 827} vslice_dummy_var_193 := __HAVOC_malloc(4);
    DeviceExtension_4 := actual_DeviceExtension_4;
    BaudRate := actual_BaudRate;
  ...
  anon6_Else:
    Tmp_24 := count_2;
    havoc Tmp_29;
    call {:si_unique_call 831} vslice_dummy_var_195 := SerialMouseWriteString#1(DeviceExtension_4, Tmp_29);
    Tmp_23 := count_2;
    havoc Tmp_28;
    call {:si_unique_call 832} vslice_dummy_var_196 := SerialMouseSetBaudRate#1(DeviceExtension_4, Tmp_28);
    call {:si_unique_call 833} vslice_dummy_var_194 := SerialMouseWait(DeviceExtension_4, -20000);
    goto L1;
...
implementation {:origName "MSerSetProtocol"} MSerSetProtocol#0(actual_DeviceExtension_23: int, actual_NewProtocol_1: int) returns (Tmp_238: int)
{
  ...
  L7:
    ...
    havoc Tmp_240;
    call {:si_unique_call 841} vslice_dummy_var_197 := SerialMouseSetLineCtrl#0(DeviceExtension_23, Tmp_240);
...
implementation {:origName "MSerSetProtocol"} MSerSetProtocol#1(actual_DeviceExtension_23: int, actual_NewProtocol_1: int) returns (Tmp_238: int)
{
  ...
  L7:
    Tmp_242 := NewProtocol_1;
    havoc Tmp_240;
    call {:si_unique_call 843} vslice_dummy_var_198 := SerialMouseSetLineCtrl#1(DeviceExtension_23, Tmp_240);
    Tmp_239 := NewProtocol_1;
    havoc Tmp_238;
    return;
...
implementation {:origName "SerialMouseStartDetection"} SerialMouseStartDetection#0(actual_DeviceExtension_6: int)
{
  ...
  anon0:
    call {:si_unique_call 856} vslice_dummy_var_199 := __HAVOC_malloc(4);
  ...
  anon24_Then:
    ...
    call {:si_unique_call 867} vslice_dummy_var_200 := IoCancelIrp(0);
    assume {:nonnull} DeviceExtension_6 != 0;
    assume DeviceExtension_6 > 0;
    goto L1;
...
implementation {:origName "SerialMouseStartDetection"} SerialMouseStartDetection#1(actual_DeviceExtension_6: int)
{
  ...
  anon0:
    call {:si_unique_call 871} vslice_dummy_var_201 := __HAVOC_malloc(4);
  ...
  anon24_Then:
    assume {:partition} 0 > status_6;
    call {:si_unique_call 882} vslice_dummy_var_202 := IoCancelIrp(0);
    assume {:nonnull} DeviceExtension_6 != 0;
    assume DeviceExtension_6 > 0;
    goto L1;
...
implementation {:origName "SerialMouseSpinUpRead"} SerialMouseSpinUpRead#0(actual_DeviceExtension_29: int) returns (Tmp_302: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 887} vslice_dummy_var_203 := sdv_IoAcquireRemoveLock(0, 0);
...
procedure {:origName "SerialMouseSpinUpRead"} SerialMouseSpinUpRead#0(actual_DeviceExtension_29: int) returns (Tmp_302: int);
  modifies alloc;
  free ensures {:va_keep} Tmp_302 == 0 || Tmp_302 == -1073741823;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} false || old(event_state) == 2 || old(event_state) == 0 || old(event_state) == 1;
  free ensures {:va_keep} false || old(irp_state) == 1 || old(irp_state) == 0;
  free ensures {:va_keep} alloc >= old(alloc);
...
implementation {:origName "SerialMouseSpinUpRead"} SerialMouseSpinUpRead#1(actual_DeviceExtension_29: int) returns (Tmp_302: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 890} vslice_dummy_var_204 := sdv_IoAcquireRemoveLock(0, 0);
    assume {:nonnull} DeviceExtension_29 != 0;
    assume DeviceExtension_29 > 0;
...
procedure {:origName "SerialMouseSpinUpRead"} SerialMouseSpinUpRead#1(actual_DeviceExtension_29: int) returns (Tmp_302: int);
  ...
  free ensures {:va_keep} event_state == 2 || event_state == 1 || event_state == old(event_state);
  free ensures {:va_keep} irp_state == 1 || irp_state == old(irp_state);
  free ensures {:va_keep} Tmp_302 == 0 || Tmp_302 == 259 || Tmp_302 == -1073741823;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} false || old(event_state) == 2 || old(event_state) == 0 || old(event_state) == 1;
  free ensures {:va_keep} false || old(irp_state) == 1 || old(irp_state) == 0;
  free ensures {:va_keep} alloc >= old(alloc);
...
implementation {:origName "SerialMouseClosePort"} SerialMouseClosePort#0(actual_DeviceExtension_31: int, actual_Irp_12: int)
{
  ...
  anon0:
    call {:si_unique_call 892} vslice_dummy_var_205 := __HAVOC_malloc(4);
    ...
    call {:si_unique_call 897} vslice_dummy_var_206 := SerialMouseSendIrpSynchronously#0(vslice_dummy_var_98, Irp_12, 0);
    ...
    call {:si_unique_call 900} vslice_dummy_var_207 := SerialMouseSendIrpSynchronously#0(vslice_dummy_var_99, Irp_12, 0);
    return;
}
...
implementation {:origName "SerialMouseClosePort"} SerialMouseClosePort#1(actual_DeviceExtension_31: int, actual_Irp_12: int)
{
  ...
  anon0:
    call {:si_unique_call 901} vslice_dummy_var_208 := __HAVOC_malloc(4);
    DeviceExtension_31 := actual_DeviceExtension_31;
    Irp_12 := actual_Irp_12;
    ...
    call {:si_unique_call 906} vslice_dummy_var_209 := SerialMouseSendIrpSynchronously#1(vslice_dummy_var_100, Irp_12, 0);
    ...
    call {:si_unique_call 909} vslice_dummy_var_210 := SerialMouseSendIrpSynchronously#1(vslice_dummy_var_101, Irp_12, 0);
    return;
}
...
implementation {:origName "SerialMouseRestorePort"} SerialMouseRestorePort#0(actual_DeviceExtension_16: int)
{
  ...
  anon0:
    call {:si_unique_call 910} vslice_dummy_var_211 := __HAVOC_malloc(4);
  ...
  anon3_Else:
    ...
    call {:si_unique_call 915} vslice_dummy_var_212 := SerialMousepIoSyncIoctlEx#0(0, 1769500, vslice_dummy_var_103, event_7, iosb_9, Timeouts__SERIAL_BASIC_SETTINGS(SerialBasicSettings__DEVICE_EXTENSION(DeviceExtension_16)), 20, 0, 0);
    assume {:nonnull} DeviceExtension_16 != 0;
    assume DeviceExtension_16 > 0;
    havoc vslice_dummy_var_104;
    call {:si_unique_call 916} vslice_dummy_var_213 := SerialMousepIoSyncIoctlEx#0(0, 1769572, vslice_dummy_var_104, event_7, iosb_9, HandFlow__SERIAL_BASIC_SETTINGS(SerialBasicSettings__DEVICE_EXTENSION(DeviceExtension_16)), 16, 0, 0);
    goto L1;
...
implementation {:origName "SerialMouseRestorePort"} SerialMouseRestorePort#1(actual_DeviceExtension_16: int)
{
  ...
  anon0:
    call {:si_unique_call 917} vslice_dummy_var_214 := __HAVOC_malloc(4);
  ...
  anon3_Else:
    ...
    call {:si_unique_call 922} vslice_dummy_var_215 := SerialMousepIoSyncIoctlEx#1(0, 1769500, vslice_dummy_var_106, event_7, iosb_9, Timeouts__SERIAL_BASIC_SETTINGS(SerialBasicSettings__DEVICE_EXTENSION(DeviceExtension_16)), 20, 0, 0);
    assume {:nonnull} DeviceExtension_16 != 0;
    assume DeviceExtension_16 > 0;
    havoc vslice_dummy_var_107;
    call {:si_unique_call 923} vslice_dummy_var_216 := SerialMousepIoSyncIoctlEx#1(0, 1769572, vslice_dummy_var_107, event_7, iosb_9, HandFlow__SERIAL_BASIC_SETTINGS(SerialBasicSettings__DEVICE_EXTENSION(DeviceExtension_16)), 16, 0, 0);
    goto L1;
...
implementation {:origName "SerialMouseSendIrpSynchronously"} SerialMouseSendIrpSynchronously#1(actual_DeviceObject_23: int, actual_Irp_17: int, actual_CopyToNext: int) returns (Tmp_328: int)
{
  ...
  anon6_Else:
    ...
    call {:si_unique_call 935} vslice_dummy_var_218 := KeWaitForSingleObject(0, 0, 0, 0, 0);
...
implementation {:SIextraRecBound 5} SerialMousePnP_loop_L89(in_i_4: int, in_devCaps: int, in_Tmp_343: int, in_Tmp_344: int) returns (out_i_4: int, out_Tmp_343: int, out_Tmp_344: int)
{
  ...
  anon86_Else_dummy:
    call {:si_unique_call 936} {:si_old_unique_call 1} out_i_4, out_Tmp_343, out_Tmp_344 := SerialMousePnP_loop_L89(out_i_4, in_devCaps, out_Tmp_343, out_Tmp_344);
    return;
}
...
implementation SerialMouseStartRead#1_loop_L13(in_sdv_120: int, in_Tmp_211: int, in_irp_2: int, in_status_17: int, in_irql: int, in_stack: int, in_DeviceExtension_15: int) returns (out_Tmp_211: int, out_status_17: int, out_irql: int, out_stack: int)
{
  ...
  anon15_Else_dummy:
    call {:si_unique_call 944} {:si_old_unique_call 1} out_Tmp_211, out_status_17, out_irql, out_stack := SerialMouseStartRead#1_loop_L13(in_sdv_120, out_Tmp_211, in_irp_2, out_status_17, out_irql, out_stack, in_DeviceExtension_15);
    return;
}
...
implementation SerialMouseInitializeDevice#0_loop_L59(in_i_3: int, in_Tmp_310: int, in_Tmp_312: int, in_errorLogEntry: int, in_Tmp_313: int, in_dumpData: int, in_dumpCount: int) returns (out_i_3: int, out_Tmp_310: int, out_Tmp_312: int, out_Tmp_313: int)
{
  ...
  anon17_Else_dummy:
    call {:si_unique_call 945} {:si_old_unique_call 1} out_i_3, out_Tmp_310, out_Tmp_312, out_Tmp_313 := SerialMouseInitializeDevice#0_loop_L59(out_i_3, out_Tmp_310, out_Tmp_312, in_errorLogEntry, out_Tmp_313, in_dumpData, in_dumpCount);
    return;
}
...
implementation {:SIextraRecBound 4} SerialMouseInitializeDevice#0_loop_L16(in_i_3: int, in_Tmp_309: int, in_dumpData: int) returns (out_i_3: int, out_Tmp_309: int)
{
  ...
  anon13_Else_dummy:
    call {:si_unique_call 946} {:si_old_unique_call 1} out_i_3, out_Tmp_309 := SerialMouseInitializeDevice#0_loop_L16(out_i_3, out_Tmp_309, in_dumpData);
    return;
}
...
implementation SerialMouseInitializeDevice#1_loop_L59(in_i_3: int, in_Tmp_310: int, in_Tmp_312: int, in_errorLogEntry: int, in_Tmp_313: int, in_dumpData: int, in_dumpCount: int) returns (out_i_3: int, out_Tmp_310: int, out_Tmp_312: int, out_Tmp_313: int)
{
  ...
  anon17_Else_dummy:
    call {:si_unique_call 947} {:si_old_unique_call 1} out_i_3, out_Tmp_310, out_Tmp_312, out_Tmp_313 := SerialMouseInitializeDevice#1_loop_L59(out_i_3, out_Tmp_310, out_Tmp_312, in_errorLogEntry, out_Tmp_313, in_dumpData, in_dumpCount);
    return;
}
...
implementation {:SIextraRecBound 4} SerialMouseInitializeDevice#1_loop_L16(in_i_3: int, in_Tmp_309: int, in_dumpData: int) returns (out_i_3: int, out_Tmp_309: int)
{
  ...
  anon13_Else_dummy:
    call {:si_unique_call 948} {:si_old_unique_call 1} out_i_3, out_Tmp_309 := SerialMouseInitializeDevice#1_loop_L16(out_i_3, out_Tmp_309, in_dumpData);
    return;
}
...
implementation MSerDetect#1_loop_L52(in_Tmp_248: int, in_count_3: int, in_receiveBuffer: int, in_Tmp_257: int, in_sdv_166: int, in_DeviceExtension_25: int) returns (out_Tmp_248: int, out_count_3: int, out_Tmp_257: int, out_sdv_166: int)
{
  ...
  anon27_Else_dummy:
    call {:si_unique_call 951} {:si_old_unique_call 1} out_Tmp_248, out_count_3, out_Tmp_257, out_sdv_166 := MSerDetect#1_loop_L52(out_Tmp_248, out_count_3, in_receiveBuffer, out_Tmp_257, out_sdv_166, in_DeviceExtension_25);
    return;
}
...
implementation SerialMouseReadSerialPort#1_loop_L21(in_irp_4: int, in_status_20: int, in_event_9: int, in_stack_1: int, in_DeviceExtension_18: int, in_ReadBuffer: int, in_Buflen: int, in_ActualBytesRead: int) returns (out_status_20: int, out_stack_1: int)
{
  ...
  anon18_Else_dummy:
    call {:si_unique_call 958} {:si_old_unique_call 1} out_status_20, out_stack_1 := SerialMouseReadSerialPort#1_loop_L21(in_irp_4, out_status_20, in_event_9, out_stack_1, in_DeviceExtension_18, in_ReadBuffer, in_Buflen, in_ActualBytesRead);
    return;
