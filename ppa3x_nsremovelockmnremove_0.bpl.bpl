...
var {:scalar} Mem_T.Locked__DEVICE_EXTENSION: [int]int;
...
implementation {:origName "VPI0DataIn"} VPI0DataIn(actual_Extension_2: int) returns (Tmp_25: int)
{
  ...
  L27:
    ...
    call {:si_unique_call 55} Status_3 := VPI0ParallelRead(Extension_2, vslice_dummy_var_1366, ChunkSize, BytesRead);
    assume {:nonnull} Extension_2 != 0;
    assume Extension_2 > 0;
    goto anon29_Then, anon29_Else;
...
implementation {:origName "VPI0DataOut"} VPI0DataOut(actual_Extension_6: int) returns (Tmp_49: int)
{
  ...
  L27:
    ...
    call {:si_unique_call 66} Status_4 := VPI0ParallelWrite(Extension_6, vslice_dummy_var_1367, ChunkSize_1, BytesWritten);
    assume {:nonnull} Extension_6 != 0;
    assume Extension_6 > 0;
    goto anon29_Then, anon29_Else;
...
implementation {:origName "VPI0RestoreDrive"} VPI0RestoreDrive(actual_Extension_7: int) returns (Tmp_55: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 68} VPI0Deselect(vslice_dummy_var_1368);
    call {:si_unique_call 69} vslice_dummy_var_11 := VPI0TerminateMode(Extension_7);
    assume {:nonnull} Extension_7 != 0;
    assume Extension_7 > 0;
    havoc vslice_dummy_var_1369;
    call {:si_unique_call 70} VPI0TrySelect(vslice_dummy_var_1369, 143);
    Tmp_55 := 1;
    return;
}
...
implementation {:origName "VPI0NegotiateMode"} VPI0NegotiateMode(actual_Extension_14: int) returns (Tmp_99: int)
{
  ...
  anon13_Else:
    ...
    call {:si_unique_call 99} VPI0Deselect(vslice_dummy_var_1370);
    assume {:nonnull} Extension_14 != 0;
    assume Extension_14 > 0;
    havoc vslice_dummy_var_1371;
    call {:si_unique_call 100} VPI0TrySelect(vslice_dummy_var_1371, 207);
    assume {:nonnull} Extension_14 != 0;
    assume Extension_14 > 0;
    havoc vslice_dummy_var_1372;
    call {:si_unique_call 101} sdv_45 := VPI0CheckDevice(vslice_dummy_var_1372);
    goto anon14_Then, anon14_Else;
...
implementation {:origName "VPI0ParallelWrite"} VPI0ParallelWrite(actual_Extension_15: int, actual_Buffer_2: int, actual_NumBytesToWrite: int, actual_BytesTransfered: int) returns (Tmp_107: int)
{
  ...
  L12:
    ...
    call {:si_unique_call 104} Status_11 := VPI0DataByteWrite(vslice_dummy_var_1373, Buffer_2, NumBytesToWrite, BytesTransfered);
    goto L16;
...
implementation {:origName "VPI0ParallelRead"} VPI0ParallelRead(actual_Extension_16: int, actual_Buffer_4: int, actual_NumBytesToRead: int, actual_BytesTransfered_1: int) returns (Tmp_140: int)
{
  ...
  anon8_Else:
    ...
    call {:si_unique_call 118} Status_12 := VPI0DataNibbleRead(vslice_dummy_var_1374, Buffer_4, NumBytesToRead, BytesTransfered_1);
    goto L16;
  ...
  anon9_Else:
    ...
    call {:si_unique_call 119} Status_12 := VPI0DataByteRead(vslice_dummy_var_1375, Buffer_4, NumBytesToRead, BytesTransfered_1);
    goto L16;
...
procedure {:origName "sdv_RunSurpriseRemoveDevice"} {:osmodel} sdv_RunSurpriseRemoveDevice(actual_po: int, actual_pirp: int) returns (Tmp_143: int);
  modifies alloc, Mem_T.Status__IO_STATUS_BLOCK, Mem_T.DeviceFlags__DEVICE_EXTENSION, sdv_compFset, sdv_invoke_on_success, sdv_invoke_on_error, sdv_invoke_on_cancel, sdv_IoBuildSynchronousFsdRequest_IoStatusBlock, sdv_IoBuildDeviceIoControlRequest_IoStatusBlock, Mem_T.Locked__DEVICE_EXTENSION;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);



implementation {:origName "sdv_RunSurpriseRemoveDevice"} {:osmodel} sdv_RunSurpriseRemoveDevice(actual_po: int, actual_pirp: int) returns (Tmp_143: int)
{
  var {:pointer} ps: int;
  var {:scalar} status: int;
  var {:pointer} po: int;
  ...
  anon0:
    ...
    call {:si_unique_call 121} status := PpaPnpDeviceControl(po, pirp);
    Tmp_143 := status;
    return;
}
...
procedure {:origName "KeRaiseIrqlToDpcLevel"} {:osmodel} KeRaiseIrqlToDpcLevel() returns (Tmp_145: int);
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);



implementation {:origName "KeRaiseIrqlToDpcLevel"} {:osmodel} KeRaiseIrqlToDpcLevel() returns (Tmp_145: int)
{
...
implementation {:origName "sdv_IoCopyCurrentIrpStackLocationToNext"} {:osmodel} sdv_IoCopyCurrentIrpStackLocationToNext(actual_pirp_1: int)
{
  ...
  anon0:
    call {:si_unique_call 122} vslice_dummy_var_21 := __HAVOC_malloc(4);
...
implementation {:origName "IoStartNextPacket"} {:osmodel} IoStartNextPacket(actual_DeviceObject: int, actual_Cancelable: int)
{
  ...
  anon0:
    call {:si_unique_call 123} vslice_dummy_var_22 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "sdv_IoInitializeRemoveLock"} {:osmodel} sdv_IoInitializeRemoveLock(actual_Lock: int, actual_AllocateTag: int, actual_MaxLockedMinutes: int, actual_HighWatermark: int)
{
  ...
  anon0:
    call {:si_unique_call 124} vslice_dummy_var_23 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "sdv_KeAcquireSpinLock"} {:osmodel} sdv_KeAcquireSpinLock(actual_SpinLock: int, actual_p: int)
{
  ...
  anon0:
    call {:si_unique_call 125} vslice_dummy_var_24 := __HAVOC_malloc(4);
    p := actual_p;
    assume {:nonnull} p != 0;
    assume p > 0;
    return;
...
procedure {:origName "sdv_RunAddDevice"} {:osmodel} sdv_RunAddDevice(actual_p1: int, actual_p2: int) returns (Tmp_155: int);
  modifies alloc, Mem_T.DeviceFlags__DEVICE_EXTENSION;
  free ensures {:va_keep} Tmp_155 == -1073741637 || Tmp_155 == 0 || Tmp_155 == -1073741823 || Tmp_155 == -1073741824 || Tmp_155 == -1073741771 || Tmp_155 == -1073741670;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);



implementation {:origName "sdv_RunAddDevice"} {:osmodel} sdv_RunAddDevice(actual_p1: int, actual_p2: int) returns (Tmp_155: int)
{
  var {:scalar} status_1: int;
  var {:pointer} p1: int;
  var {:pointer} p2: int;
  ...
  anon0:
    ...
    call {:si_unique_call 127} status_1 := PpaAddDevice(p1, p2);
...
procedure {:origName "sdv_IoGetNextIrpStackLocation"} {:osmodel} sdv_IoGetNextIrpStackLocation(actual_pirp_2: int) returns (Tmp_157: int);
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);



implementation {:origName "sdv_IoGetNextIrpStackLocation"} {:osmodel} sdv_IoGetNextIrpStackLocation(actual_pirp_2: int) returns (Tmp_157: int)
{
  ...
  anon5_Else:
    ...
    Tmp_157 := sdv_harnessStackLocation_next;
    goto L1;
  ...
  anon6_Else:
    ...
    Tmp_157 := sdv_other_harnessStackLocation_next;
    goto L1;

  anon6_Then:
    assume {:partition} pirp_2 != sdv_other_harnessIrp;
    Tmp_157 := sdv_harnessStackLocation;
    goto L1;
}
...
implementation {:origName "KeInitializeDpc"} {:osmodel} KeInitializeDpc(actual_Dpc: int, actual_DeferredRoutine: int, actual_DeferredContext: int)
{
  ...
  anon0:
    call {:si_unique_call 129} vslice_dummy_var_25 := __HAVOC_malloc(4);
    Dpc := actual_Dpc;
...
implementation {:origName "sdv_IoReleaseRemoveLockAndWait"} {:osmodel} sdv_IoReleaseRemoveLockAndWait(actual_RemoveLock: int, actual_Tag: int)
{
  ...
  anon0:
    call {:si_unique_call 130} vslice_dummy_var_26 := __HAVOC_malloc(4);
    return;
}



procedure {:origName "IoCreateDevice"} {:osmodel} IoCreateDevice(actual_DriverObject: int, actual_DeviceExtensionSize: int, actual_DeviceName: int, actual_DeviceType: int, actual_DeviceCharacteristics: int, actual_Exclusive: int, actual_DeviceObject_1: int) returns (Tmp_163: int);
  free ensures {:va_keep} Tmp_163 == -1073741824 || Tmp_163 == -1073741771 || Tmp_163 == -1073741670 || Tmp_163 == -1073741823 || Tmp_163 == 0;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);



implementation {:origName "IoCreateDevice"} {:osmodel} IoCreateDevice(actual_DriverObject: int, actual_DeviceExtensionSize: int, actual_DeviceName: int, actual_DeviceType: int, actual_DeviceCharacteristics: int, actual_Exclusive: int, actual_DeviceObject_1: int) returns (Tmp_163: int)
{
...
implementation {:origName "IoDetachDevice"} {:osmodel} IoDetachDevice(actual_TargetDevice: int)
{
  ...
  anon0:
    call {:si_unique_call 131} vslice_dummy_var_27 := __HAVOC_malloc(4);
    return;
}
...
procedure {:origName "sdv_RtlQueryRegistryValues"} {:osmodel} sdv_RtlQueryRegistryValues(actual_RelativeTo: int, actual_Path: int, actual_QueryTable: int, actual_Context: int, actual_Environment: int) returns (Tmp_171: int);
...
implementation {:origName "sdv_RtlQueryRegistryValues"} {:osmodel} sdv_RtlQueryRegistryValues(actual_RelativeTo: int, actual_Path: int, actual_QueryTable: int, actual_Context: int, actual_Environment: int) returns (Tmp_171: int)
{
...
procedure {:origName "KeDelayExecutionThread"} {:osmodel} KeDelayExecutionThread(actual_WaitMode: int, actual_Alertable: int, actual_Interval: int) returns (Tmp_175: int);
...
implementation {:origName "KeDelayExecutionThread"} {:osmodel} KeDelayExecutionThread(actual_WaitMode: int, actual_Alertable: int, actual_Interval: int) returns (Tmp_175: int)
{
...
procedure {:nohoudini} {:origName "sdv_main"} {:osmodel} sdv_main();
  modifies alloc, Mem_T.Status__IO_STATUS_BLOCK, Mem_T.DeviceFlags__DEVICE_EXTENSION, sdv_compFset, sdv_invoke_on_success, sdv_invoke_on_error, sdv_invoke_on_cancel, sdv_IoBuildSynchronousFsdRequest_IoStatusBlock, sdv_IoBuildDeviceIoControlRequest_IoStatusBlock, Mem_T.Locked__DEVICE_EXTENSION, yogi_error;
...
implementation {:origName "sdv_main"} {:osmodel} sdv_main()
{
  ...
  anon0:
    ...
    call {:si_unique_call 136} vslice_dummy_var_31 := __HAVOC_malloc(4);
    assume {:nonnull} sdv_p_devobj_fdo != 0;
    assume sdv_p_devobj_fdo > 0;
    assume {:nonnull} sdv_p_devobj_child_pdo != 0;
    assume sdv_p_devobj_child_pdo > 0;
    call {:si_unique_call 137} status_2 := DriverEntry(sdv_driver_object, u);
    goto anon8_Then, anon8_Else;
  ...
  L68:
    assume Tmp_177 != 0;
    call {:si_unique_call 138} status_2 := sdv_RunAddDevice(sdv_driver_object, sdv_p_devobj_pdo);
    goto anon7_Then, anon7_Else;
  ...
  L78:
    ...
    call {:si_unique_call 140} status_2 := sdv_RunSurpriseRemoveDevice(sdv_p_devobj_fdo, sdv_irp);
    call {:si_unique_call 141} status_2 := sdv_RunRemoveDevice(sdv_p_devobj_fdo, sdv_irp);
    goto anon9_Then, anon9_Else;
...
procedure {:origName "sdv_MmGetMdlVirtualAddress"} {:osmodel} sdv_MmGetMdlVirtualAddress(actual_Mdl: int) returns (Tmp_181: int);
  modifies alloc;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);
...
implementation {:origName "sdv_MmGetMdlVirtualAddress"} {:osmodel} sdv_MmGetMdlVirtualAddress(actual_Mdl: int) returns (Tmp_181: int)
{
  var {:pointer} x_2: int;
  var {:pointer} sdv_66: int;

  anon0:
    call {:si_unique_call 142} sdv_66 := __HAVOC_malloc(1);
    x_2 := sdv_66;
    Tmp_181 := x_2;
    return;
}
...
procedure {:origName "KeCancelTimer"} {:osmodel} KeCancelTimer(actual_Timer: int) returns (Tmp_183: int);
  free ensures {:va_keep} Tmp_183 == 1 || Tmp_183 == 0;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);



implementation {:origName "KeCancelTimer"} {:osmodel} KeCancelTimer(actual_Timer: int) returns (Tmp_183: int)
{
...
implementation {:origName "sdv_IoSetCompletionRoutine"} {:osmodel} sdv_IoSetCompletionRoutine(actual_pirp_5: int, actual_CompletionRoutine: int, actual_Context_1: int, actual_InvokeOnSuccess: int, actual_InvokeOnError: int, actual_InvokeOnCancel: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 144} irpSp := sdv_IoGetNextIrpStackLocation(pirp_5);
...
procedure {:origName "KeWaitForSingleObject"} {:osmodel} KeWaitForSingleObject(actual_Object: int, actual_WaitReason: int, actual_WaitMode_1: int, actual_Alertable_1: int, actual_Timeout: int) returns (Tmp_191: int);
  free ensures {:va_keep} Tmp_191 == 258 || Tmp_191 == 0;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);



implementation {:origName "KeWaitForSingleObject"} {:osmodel} KeWaitForSingleObject(actual_Object: int, actual_WaitReason: int, actual_WaitMode_1: int, actual_Alertable_1: int, actual_Timeout: int) returns (Tmp_191: int)
{
...
implementation {:origName "IoDeleteDevice"} {:osmodel} IoDeleteDevice(actual_DeviceObject_2: int)
{
  ...
  anon0:
    call {:si_unique_call 147} vslice_dummy_var_35 := __HAVOC_malloc(4);
    return;
}



procedure {:origName "KeSetEvent"} {:osmodel} KeSetEvent(actual_Event: int, actual_Increment: int, actual_Wait: int) returns (Tmp_195: int);
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);



implementation {:origName "KeSetEvent"} {:osmodel} KeSetEvent(actual_Event: int, actual_Increment: int, actual_Wait: int) returns (Tmp_195: int)
{
...
procedure {:origName "sdv_IoGetCurrentIrpStackLocation"} {:osmodel} sdv_IoGetCurrentIrpStackLocation(actual_pirp_6: int) returns (Tmp_199: int);
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);



implementation {:origName "sdv_IoGetCurrentIrpStackLocation"} {:osmodel} sdv_IoGetCurrentIrpStackLocation(actual_pirp_6: int) returns (Tmp_199: int)
{
...
procedure {:nohoudini} {:origName "main"} {:osmodel} {:entrypoint} main() returns (Tmp_203: int, dup_assertVar: bool);
  modifies alloc, sdv_IoBuildDeviceIoControlRequest_IoStatusBlock, sdv_IoBuildSynchronousFsdRequest_IoStatusBlock, sdv_invoke_on_success, sdv_invoke_on_error, sdv_invoke_on_cancel, sdv_compFset, Mem_T.DeviceExtension__DEVICE_OBJECT, yogi_error, Mem_T.Status__IO_STATUS_BLOCK, Mem_T.DeviceFlags__DEVICE_EXTENSION, Mem_T.Locked__DEVICE_EXTENSION;
  free ensures {:va_keep} yogi_error == 1;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);
...
implementation {:origName "main"} {:osmodel} main() returns (Tmp_203: int, dup_assertVar: bool)
{
  ...
  anon0:
    dup_assertVar := true;
    assume alloc > 0;
    call {:si_unique_call 148} WHEA_ERROR_PACKET_SECTION_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume WHEA_ERROR_PACKET_SECTION_GUID__Loc == WHEA_ERROR_PACKET_SECTION_GUID;
    assume WHEA_ERROR_PACKET_SECTION_GUID != 0;
    call {:si_unique_call 149} PpaBreakOn__Loc := __HAVOC_malloc_or_null(4);
    assume PpaBreakOn__Loc == PpaBreakOn;
    assume PpaBreakOn != 0;
    call {:si_unique_call 150} PpaDebugLevel__Loc := __HAVOC_malloc_or_null(4);
    ...
    call {:si_unique_call 164} sdv_harnessStackLocation__Loc := __HAVOC_malloc_or_null(496);
    assume sdv_harnessStackLocation__Loc == sdv_harnessStackLocation;
    assume sdv_harnessStackLocation != 0;
    call {:si_unique_call 165} sdv_other_harnessStackLocation_next__Loc := __HAVOC_malloc_or_null(496);
    ...
    call {:si_unique_call 174} sdv_IoMakeAssociatedIrp_harnessIrp__Loc := __HAVOC_malloc_or_null(248);
    assume sdv_IoMakeAssociatedIrp_harnessIrp__Loc == sdv_IoMakeAssociatedIrp_harnessIrp;
    assume sdv_IoMakeAssociatedIrp_harnessIrp != 0;
    call {:si_unique_call 175} sdv_devobj_child_pdo__Loc := __HAVOC_malloc_or_null(320);
    assume sdv_devobj_child_pdo__Loc == sdv_devobj_child_pdo;
    assume sdv_devobj_child_pdo != 0;
    call {:si_unique_call 176} sdv_harnessIrp__Loc := __HAVOC_malloc_or_null(248);
    assume sdv_harnessIrp__Loc == sdv_harnessIrp;
    assume sdv_harnessIrp != 0;
    call {:si_unique_call 177} sdv_IoBuildAsynchronousFsdRequest_harnessStackLocation_next__Loc := __HAVOC_malloc_or_null(496);
    ...
    call {:si_unique_call 180} sdv_devobj_fdo__Loc := __HAVOC_malloc_or_null(320);
    assume sdv_devobj_fdo__Loc == sdv_devobj_fdo;
    assume sdv_devobj_fdo != 0;
    call {:si_unique_call 181} sdv_StartIoIrp__Loc := __HAVOC_malloc_or_null(248);
    assume sdv_StartIoIrp__Loc == sdv_StartIoIrp;
    assume sdv_StartIoIrp != 0;
    call {:si_unique_call 182} sdv_harness_IoBuildAsynchronousFsdRequest_IoStatusBlock__Loc := __HAVOC_malloc_or_null(12);
    assume sdv_harness_IoBuildAsynchronousFsdRequest_IoStatusBlock__Loc == sdv_harness_IoBuildAsynchronousFsdRequest_IoStatusBlock;
    assume sdv_harness_IoBuildAsynchronousFsdRequest_IoStatusBlock != 0;
    call {:si_unique_call 183} sdv_PowerIrp__Loc := __HAVOC_malloc_or_null(248);
    assume sdv_PowerIrp__Loc == sdv_PowerIrp;
    assume sdv_PowerIrp != 0;
    call {:si_unique_call 184} sdv_IoBuildDeviceIoControlRequest_harnessIrp__Loc := __HAVOC_malloc_or_null(248);
    assume sdv_IoBuildDeviceIoControlRequest_harnessIrp__Loc == sdv_IoBuildDeviceIoControlRequest_harnessIrp;
    assume sdv_IoBuildDeviceIoControlRequest_harnessIrp != 0;
    call {:si_unique_call 185} sdv_other_harnessIrp__Loc := __HAVOC_malloc_or_null(248);
    assume sdv_other_harnessIrp__Loc == sdv_other_harnessIrp;
    assume sdv_other_harnessIrp != 0;
    call {:si_unique_call 186} sdv_IoCreateNotificationEvent_KEVENT__Loc := __HAVOC_malloc_or_null(124);
    assume sdv_IoCreateNotificationEvent_KEVENT__Loc == sdv_IoCreateNotificationEvent_KEVENT;
    assume sdv_IoCreateNotificationEvent_KEVENT != 0;
    call {:si_unique_call 187} sdv_other_harnessStackLocation__Loc := __HAVOC_malloc_or_null(496);
    assume sdv_other_harnessStackLocation__Loc == sdv_other_harnessStackLocation;
    assume sdv_other_harnessStackLocation != 0;
    call {:si_unique_call 188} KeTickCount__Loc := __HAVOC_malloc_or_null(12);
    ...
    call {:si_unique_call 200} boogieTmp := __HAVOC_malloc_or_null(248);
    ...
    call {:si_unique_call 211} vslice_dummy_var_110 := __HAVOC_malloc(4);
    call {:si_unique_call 212} vslice_dummy_var_1376 := __HAVOC_malloc(28);
    call {:si_unique_call 213} vslice_dummy_var_111 := __HAVOC_malloc(4);
    call {:si_unique_call 214} vslice_dummy_var_112 := __HAVOC_malloc(4);
    call {:si_unique_call 215} vslice_dummy_var_113 := __HAVOC_malloc(4);
    call {:si_unique_call 216} vslice_dummy_var_114 := __HAVOC_malloc(4);
    call {:si_unique_call 217} vslice_dummy_var_1377 := __HAVOC_malloc(12);
    call {:si_unique_call 218} vslice_dummy_var_115 := __HAVOC_malloc(4);
    call {:si_unique_call 219} vslice_dummy_var_1378 := __HAVOC_malloc(28);
    call {:si_unique_call 220} vslice_dummy_var_116 := __HAVOC_malloc(4);
    call {:si_unique_call 221} vslice_dummy_var_117 := __HAVOC_malloc(4);
    call {:si_unique_call 222} vslice_dummy_var_118 := __HAVOC_malloc(4);
    call {:si_unique_call 223} vslice_dummy_var_119 := __HAVOC_malloc(4);
    call {:si_unique_call 224} vslice_dummy_var_1379 := __HAVOC_malloc(12);
    call {:si_unique_call 225} vslice_dummy_var_120 := __HAVOC_malloc(4);
    call {:si_unique_call 226} vslice_dummy_var_1380 := __HAVOC_malloc(28);
    call {:si_unique_call 227} vslice_dummy_var_121 := __HAVOC_malloc(4);
    call {:si_unique_call 228} vslice_dummy_var_122 := __HAVOC_malloc(4);
    call {:si_unique_call 229} vslice_dummy_var_123 := __HAVOC_malloc(4);
    call {:si_unique_call 230} vslice_dummy_var_124 := __HAVOC_malloc(4);
    call {:si_unique_call 231} vslice_dummy_var_1381 := __HAVOC_malloc(12);
    call {:si_unique_call 232} vslice_dummy_var_125 := __HAVOC_malloc(4);
    call {:si_unique_call 233} vslice_dummy_var_126 := __HAVOC_malloc(4);
    call {:si_unique_call 234} vslice_dummy_var_127 := __HAVOC_malloc(4);
    call {:si_unique_call 235} vslice_dummy_var_128 := __HAVOC_malloc(4);
    call {:si_unique_call 236} vslice_dummy_var_129 := __HAVOC_malloc(4);
    call {:si_unique_call 237} vslice_dummy_var_130 := __HAVOC_malloc(4);
    call {:si_unique_call 238} vslice_dummy_var_1382 := __HAVOC_malloc(28);
    call {:si_unique_call 239} vslice_dummy_var_131 := __HAVOC_malloc(4);
    call {:si_unique_call 240} vslice_dummy_var_132 := __HAVOC_malloc(4);
    call {:si_unique_call 241} vslice_dummy_var_133 := __HAVOC_malloc(4);
    call {:si_unique_call 242} vslice_dummy_var_134 := __HAVOC_malloc(4);
    call {:si_unique_call 243} vslice_dummy_var_1383 := __HAVOC_malloc(12);
    call {:si_unique_call 244} vslice_dummy_var_135 := __HAVOC_malloc(4);
    call {:si_unique_call 245} vslice_dummy_var_1384 := __HAVOC_malloc(28);
    call {:si_unique_call 246} vslice_dummy_var_136 := __HAVOC_malloc(4);
    call {:si_unique_call 247} vslice_dummy_var_137 := __HAVOC_malloc(4);
    call {:si_unique_call 248} vslice_dummy_var_138 := __HAVOC_malloc(4);
    call {:si_unique_call 249} vslice_dummy_var_139 := __HAVOC_malloc(4);
    call {:si_unique_call 250} vslice_dummy_var_1385 := __HAVOC_malloc(12);
    call {:si_unique_call 251} vslice_dummy_var_140 := __HAVOC_malloc(4);
    call {:si_unique_call 252} vslice_dummy_var_1386 := __HAVOC_malloc(28);
    call {:si_unique_call 253} vslice_dummy_var_141 := __HAVOC_malloc(4);
    call {:si_unique_call 254} vslice_dummy_var_142 := __HAVOC_malloc(4);
    call {:si_unique_call 255} vslice_dummy_var_143 := __HAVOC_malloc(4);
    call {:si_unique_call 256} vslice_dummy_var_144 := __HAVOC_malloc(4);
    call {:si_unique_call 257} vslice_dummy_var_1387 := __HAVOC_malloc(12);
    call {:si_unique_call 258} vslice_dummy_var_145 := __HAVOC_malloc(4);
    call {:si_unique_call 259} vslice_dummy_var_1388 := __HAVOC_malloc(28);
    call {:si_unique_call 260} vslice_dummy_var_146 := __HAVOC_malloc(4);
    call {:si_unique_call 261} vslice_dummy_var_147 := __HAVOC_malloc(4);
    call {:si_unique_call 262} vslice_dummy_var_148 := __HAVOC_malloc(4);
    call {:si_unique_call 263} vslice_dummy_var_149 := __HAVOC_malloc(4);
    call {:si_unique_call 264} vslice_dummy_var_1389 := __HAVOC_malloc(12);
    call {:si_unique_call 265} vslice_dummy_var_150 := __HAVOC_malloc(4);
    call {:si_unique_call 266} vslice_dummy_var_1390 := __HAVOC_malloc(28);
    call {:si_unique_call 267} vslice_dummy_var_151 := __HAVOC_malloc(4);
    call {:si_unique_call 268} vslice_dummy_var_152 := __HAVOC_malloc(4);
    call {:si_unique_call 269} vslice_dummy_var_153 := __HAVOC_malloc(4);
    call {:si_unique_call 270} vslice_dummy_var_154 := __HAVOC_malloc(4);
    call {:si_unique_call 271} vslice_dummy_var_1391 := __HAVOC_malloc(12);
    assume {:mainInitDone} true;
    call {:si_unique_call 272} corralExtraInit();
    call {:si_unique_call 273} corralExplainErrorInit();
    call {:si_unique_call 274} _sdv_init11();
    call {:si_unique_call 275} _sdv_init1();
    call {:si_unique_call 276} _sdv_init4();
    call {:si_unique_call 277} _sdv_init5();
    call {:si_unique_call 278} _sdv_init3();
    call {:si_unique_call 279} _sdv_init6();
    call {:si_unique_call 280} _sdv_init9();
    call {:si_unique_call 281} _sdv_init7();
    call {:si_unique_call 282} _sdv_init8();
    call {:si_unique_call 283} _sdv_init2();
    goto anon9_Then, anon9_Else;
  ...
  L38:
    ...
    call {:si_unique_call 284} sdv_main();
    goto anon12_Then, anon12_Else;
...
implementation {:origName "sdv_IoSkipCurrentIrpStackLocation"} {:osmodel} sdv_IoSkipCurrentIrpStackLocation(actual_pirp_7: int)
{
  ...
  anon0:
    call {:si_unique_call 285} vslice_dummy_var_36 := __HAVOC_malloc(4);
...
procedure {:origName "IoCancelIrp"} {:osmodel} IoCancelIrp(actual_Irp: int) returns (Tmp_209: int);
...
implementation {:origName "IoCancelIrp"} {:osmodel} IoCancelIrp(actual_Irp: int) returns (Tmp_209: int)
{
...
procedure {:origName "IoInitializeTimer"} {:osmodel} IoInitializeTimer(actual_DeviceObject_3: int, actual_TimerRoutine: int, actual_Context_2: int) returns (Tmp_211: int);
  free ensures {:va_keep} Tmp_211 == 0 || Tmp_211 == -1073741823;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);



implementation {:origName "IoInitializeTimer"} {:osmodel} IoInitializeTimer(actual_DeviceObject_3: int, actual_TimerRoutine: int, actual_Context_2: int) returns (Tmp_211: int)
{
...
procedure {:origName "sdv_RunRemoveDevice"} {:osmodel} sdv_RunRemoveDevice(actual_po_1: int, actual_pirp_8: int) returns (Tmp_213: int);
  modifies alloc, Mem_T.Status__IO_STATUS_BLOCK, Mem_T.DeviceFlags__DEVICE_EXTENSION, sdv_compFset, sdv_invoke_on_success, sdv_invoke_on_error, sdv_invoke_on_cancel, sdv_IoBuildSynchronousFsdRequest_IoStatusBlock, sdv_IoBuildDeviceIoControlRequest_IoStatusBlock, Mem_T.Locked__DEVICE_EXTENSION, yogi_error;
  free ensures {:va_keep} yogi_error == 1;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);
...
implementation {:origName "sdv_RunRemoveDevice"} {:osmodel} sdv_RunRemoveDevice(actual_po_1: int, actual_pirp_8: int) returns (Tmp_213: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 287} sdv_SetStatus(pirp_8);
    call {:si_unique_call 288} status_3 := PpaPnpDeviceControl(po_1, pirp_8);
    call {:si_unique_call 289} sdv_stub_dispatch_end(status_3, 0);
    Tmp_213 := status_3;
    call {:si_unique_call 290} SLIC_sdv_RunRemoveDevice_exit(strConst__li2bpl11, pirp_8, Tmp_213);
    goto anon3_Then, anon3_Else;
...
implementation {:origName "sdv_stub_add_end"} {:osmodel} sdv_stub_add_end()
{
  ...
  anon0:
    call {:si_unique_call 291} vslice_dummy_var_37 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "RtlInitUnicodeString"} {:osmodel} RtlInitUnicodeString(actual_DestinationString: int, actual_SourceString: int)
{
  ...
  anon0:
    call {:si_unique_call 292} vslice_dummy_var_38 := __HAVOC_malloc(4);
...
implementation {:origName "sdv_RtlZeroMemory"} {:osmodel} sdv_RtlZeroMemory(actual_Destination_1: int, actual_Length_1: int)
{
  ...
  anon0:
    call {:si_unique_call 293} vslice_dummy_var_39 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "sdv_KeFlushIoBuffers"} {:osmodel} sdv_KeFlushIoBuffers(actual_Mdl_1: int, actual_ReadOperation: int, actual_DmaOperation: int)
{
  ...
  anon0:
    call {:si_unique_call 294} vslice_dummy_var_40 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "sdv_KeLowerIrql"} {:osmodel} sdv_KeLowerIrql(actual_NewIrql: int)
{
  ...
  anon0:
    call {:si_unique_call 295} vslice_dummy_var_41 := __HAVOC_malloc(4);
...
implementation {:origName "RtlFreeUnicodeString"} {:osmodel} RtlFreeUnicodeString(actual_UnicodeString: int)
{
  ...
  anon0:
    call {:si_unique_call 296} vslice_dummy_var_42 := __HAVOC_malloc(4);
    return;
}



procedure {:origName "IoBuildSynchronousFsdRequest"} {:osmodel} IoBuildSynchronousFsdRequest(actual_MajorFunction: int, actual_DeviceObject_4: int, actual_Buffer_5: int, actual_Length_2: int, actual_StartingOffset: int, actual_Event_1: int, actual_IoStatusBlock: int) returns (Tmp_229: int);
...
implementation {:origName "IoBuildSynchronousFsdRequest"} {:osmodel} IoBuildSynchronousFsdRequest(actual_MajorFunction: int, actual_DeviceObject_4: int, actual_Buffer_5: int, actual_Length_2: int, actual_StartingOffset: int, actual_Event_1: int, actual_IoStatusBlock: int) returns (Tmp_229: int)
{
  ...
  anon3_Else:
    ...
    assume {:nonnull} sdv_IoBuildSynchronousFsdRequest_irp != 0;
    assume sdv_IoBuildSynchronousFsdRequest_irp > 0;
    Tmp_229 := sdv_IoBuildSynchronousFsdRequest_irp;
    goto L1;
...
implementation {:origName "sdv_KeReleaseSpinLock"} {:osmodel} sdv_KeReleaseSpinLock(actual_SpinLock_1: int, actual_new: int)
{
  ...
  anon0:
    call {:si_unique_call 297} vslice_dummy_var_43 := __HAVOC_malloc(4);
    new := actual_new;
    return;
}
...
implementation {:origName "IoReuseIrp"} {:osmodel} IoReuseIrp(actual_Irp_1: int, actual_Status_13: int)
{
  ...
  anon0:
    call {:si_unique_call 298} vslice_dummy_var_44 := __HAVOC_malloc(4);
    Irp_1 := actual_Irp_1;
...
implementation {:origName "sdv_IoCompleteRequest"} {:osmodel} sdv_IoCompleteRequest(actual_pirp_9: int, actual_PriorityBoost: int)
{
  ...
  anon0:
    call {:si_unique_call 299} vslice_dummy_var_45 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "IoStopTimer"} {:osmodel} IoStopTimer(actual_DeviceObject_5: int)
{
  ...
  anon0:
    call {:si_unique_call 300} vslice_dummy_var_46 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "sdv_ExFreePool"} {:osmodel} sdv_ExFreePool(actual_P: int)
{
  ...
  anon0:
    call {:si_unique_call 301} vslice_dummy_var_47 := __HAVOC_malloc(4);
    return;
}



procedure {:origName "sdv_IoAcquireRemoveLock"} {:osmodel} sdv_IoAcquireRemoveLock(actual_RemoveLock_1: int, actual_Tag_1: int) returns (Tmp_244: int);
  free ensures {:va_keep} Tmp_244 == -1073741823 || Tmp_244 == -1073741738 || Tmp_244 == 0;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);



implementation {:origName "sdv_IoAcquireRemoveLock"} {:osmodel} sdv_IoAcquireRemoveLock(actual_RemoveLock_1: int, actual_Tag_1: int) returns (Tmp_244: int)
{
  ...
  L1:
    call {:si_unique_call 302} SLIC_sdv_IoAcquireRemoveLock_exit(0, Tmp_244);
    return;
...
procedure {:origName "IoAllocateIrp"} {:osmodel} IoAllocateIrp(actual_StackSize: int, actual_ChargeQuota: int) returns (Tmp_246: int);
...
implementation {:origName "IoAllocateIrp"} {:osmodel} IoAllocateIrp(actual_StackSize: int, actual_ChargeQuota: int) returns (Tmp_246: int)
{
...
implementation {:origName "KeInitializeEvent"} {:osmodel} KeInitializeEvent(actual_Event_2: int, actual_Type: int, actual_State: int)
{
  ...
  anon0:
    call {:si_unique_call 304} vslice_dummy_var_48 := __HAVOC_malloc(4);
...
implementation {:origName "KeInitializeTimer"} {:osmodel} KeInitializeTimer(actual_Timer_1: int)
{
  ...
  anon0:
    call {:si_unique_call 305} vslice_dummy_var_49 := __HAVOC_malloc(4);
    return;
}



procedure {:origName "IoBuildDeviceIoControlRequest"} {:osmodel} IoBuildDeviceIoControlRequest(actual_IoControlCode: int, actual_DeviceObject_9: int, actual_InputBuffer: int, actual_InputBufferLength: int, actual_OutputBuffer: int, actual_OutputBufferLength: int, actual_InternalDeviceIoControl: int, actual_Event_3: int, actual_IoStatusBlock_1: int) returns (Tmp_258: int);
...
implementation {:origName "IoBuildDeviceIoControlRequest"} {:osmodel} IoBuildDeviceIoControlRequest(actual_IoControlCode: int, actual_DeviceObject_9: int, actual_InputBuffer: int, actual_InputBufferLength: int, actual_OutputBuffer: int, actual_OutputBufferLength: int, actual_InternalDeviceIoControl: int, actual_Event_3: int, actual_IoStatusBlock_1: int) returns (Tmp_258: int)
{
  ...
  L14:
    ...
    Tmp_258 := sdv_IoBuildDeviceIoControlRequest_irp;
    goto L1;
...
implementation {:origName "IoFreeIrp"} {:osmodel} IoFreeIrp(actual_pirp_10: int)
{
  ...
  anon0:
    call {:si_unique_call 306} vslice_dummy_var_50 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "sdv_KeInitializeSpinLock"} {:osmodel} sdv_KeInitializeSpinLock(actual_SpinLock_2: int)
{
  ...
  anon0:
    call {:si_unique_call 307} vslice_dummy_var_51 := __HAVOC_malloc(4);
...
procedure {:origName "ExAllocatePoolWithTag"} {:osmodel} ExAllocatePoolWithTag(actual_PoolType: int, actual_NumberOfBytes: int, actual_Tag_2: int) returns (Tmp_266: int);
  modifies alloc;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);
...
implementation {:origName "ExAllocatePoolWithTag"} {:osmodel} ExAllocatePoolWithTag(actual_PoolType: int, actual_NumberOfBytes: int, actual_Tag_2: int) returns (Tmp_266: int)
{
  ...
  anon3_Else:
    call {:si_unique_call 308} sdv_89 := __HAVOC_malloc(NumberOfBytes);
    Tmp_266 := sdv_89;
    goto L1;
...
procedure {:origName "RtlWriteRegistryValue"} {:osmodel} RtlWriteRegistryValue(actual_RelativeTo_1: int, actual_Path_1: int, actual_ValueName: int, actual_ValueType: int, actual_ValueData: int, actual_ValueLength: int) returns (Tmp_268: int);
  free ensures {:va_keep} Tmp_268 == 0 || Tmp_268 == -1073741823;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);



implementation {:origName "RtlWriteRegistryValue"} {:osmodel} RtlWriteRegistryValue(actual_RelativeTo_1: int, actual_Path_1: int, actual_ValueName: int, actual_ValueType: int, actual_ValueData: int, actual_ValueLength: int) returns (Tmp_268: int)
{
...
procedure {:origName "IoOpenDeviceRegistryKey"} {:osmodel} IoOpenDeviceRegistryKey(actual_DeviceObject_10: int, actual_DevInstKeyType: int, actual_DesiredAccess: int, actual_DevInstRegKey: int) returns (Tmp_274: int);
  free ensures {:va_keep} Tmp_274 == -1073741811 || Tmp_274 == -1073741808 || Tmp_274 == -1073741823 || Tmp_274 == 0;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);



implementation {:origName "IoOpenDeviceRegistryKey"} {:osmodel} IoOpenDeviceRegistryKey(actual_DeviceObject_10: int, actual_DevInstKeyType: int, actual_DesiredAccess: int, actual_DevInstRegKey: int) returns (Tmp_274: int)
{
...
procedure {:origName "ZwClose"} {:osmodel} ZwClose(actual_Handle: int) returns (Tmp_278: int);
...
implementation {:origName "ZwClose"} {:osmodel} ZwClose(actual_Handle: int) returns (Tmp_278: int)
{
...
procedure {:origName "SLIC_sdv_IoAcquireRemoveLock_exit"} {:osmodel} SLIC_sdv_IoAcquireRemoveLock_exit(actual_caller: int, actual_sdv_92: int);
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);



implementation {:origName "SLIC_sdv_IoAcquireRemoveLock_exit"} {:osmodel} SLIC_sdv_IoAcquireRemoveLock_exit(actual_caller: int, actual_sdv_92: int)
{
  ...
  anon3_Else:
    ...
    call {:si_unique_call 312} SLIC_EXIT_ROUTINE(strConst__li2bpl12);
    goto L2;
...
procedure {:origName "SLIC_sdv_RunRemoveDevice_exit"} {:osmodel} SLIC_sdv_RunRemoveDevice_exit(actual_caller_1: int, actual_sdv_93: int, actual_sdv_94: int);
  modifies yogi_error;
  free ensures {:va_keep} yogi_error == 1;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);
...
implementation {:origName "SLIC_sdv_RunRemoveDevice_exit"} {:osmodel} SLIC_sdv_RunRemoveDevice_exit(actual_caller_1: int, actual_sdv_93: int, actual_sdv_94: int)
{
  ...
  anon8_Else:
    assume {:partition} sdv_94 == -1073741637;
  ...
  L6:
    call {:si_unique_call 313} SLIC_EXIT_ROUTINE(strConst__li2bpl12);
    goto L2;
  ...
  anon7_Then:
    call {:si_unique_call 314} SLIC_ABORT_2_0(caller_1, sdv_93, sdv_94);
    goto anon9_Then, anon9_Else;
...
procedure {:origName "SLIC_ABORT_2_0"} SLIC_ABORT_2_0(actual_caller_2: int, actual_sdv_95: int, actual_sdv_96: int);
  modifies yogi_error;
  free ensures {:va_keep} yogi_error == 1;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);
...
implementation {:origName "SLIC_ABORT_2_0"} SLIC_ABORT_2_0(actual_caller_2: int, actual_sdv_95: int, actual_sdv_96: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 315} SLIC_ERROR_ROUTINE(strConst__li2bpl13);
    return;
}
...
procedure {:origName "sdv_IoReleaseRemoveLock"} sdv_IoReleaseRemoveLock(actual_sdv_101: int, actual_sdv_102: int) returns (Tmp_283: int);
  modifies alloc;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);
...
implementation {:origName "sdv_IoReleaseRemoveLock"} sdv_IoReleaseRemoveLock(actual_sdv_101: int, actual_sdv_102: int) returns (Tmp_283: int)
{
  var {:scalar} sdv_103: int;

  anon0:
    call {:si_unique_call 316} Tmp_283 := __HAVOC_malloc(4);
    call {:si_unique_call 317} sdv_103 := __HAVOC_malloc(4);
...
procedure {:origName "PpaCommand"} PpaCommand(actual_Extension_17: int) returns (Tmp_293: int);
  modifies alloc;
  free ensures {:va_keep} Tmp_293 == 0 || Tmp_293 == 1;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);



implementation {:origName "PpaCommand"} PpaCommand(actual_Extension_17: int) returns (Tmp_293: int)
{
  ...
  anon3_Then:
    call {:si_unique_call 318} success_6 := VPI0Command(Extension_17);
    Tmp_293 := success_6;
    goto L1;
}
...
procedure {:origName "PpaPortLock"} PpaPortLock(actual_Extension_18: int, actual_Wait_1: int, actual_pDeviceObject: int);
  modifies alloc, sdv_compFset, sdv_invoke_on_success, sdv_invoke_on_error, sdv_invoke_on_cancel, Mem_T.Locked__DEVICE_EXTENSION, Mem_T.Status__IO_STATUS_BLOCK;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);
...
implementation {:origName "PpaPortLock"} PpaPortLock(actual_Extension_18: int, actual_Wait_1: int, actual_pDeviceObject: int)
{
  ...
  anon0:
    call {:si_unique_call 319} Event_4 := __HAVOC_malloc(124);
    call {:si_unique_call 320} vslice_dummy_var_55 := __HAVOC_malloc(4);
  ...
  anon13_Else:
    assume {:partition} Mem_T.Locked__DEVICE_EXTENSION[Locked__DEVICE_EXTENSION(Extension_18)] == 0;
    call {:si_unique_call 321} status_5 := sdv_IoAcquireRemoveLock(0, 0);
    goto anon14_Then, anon14_Else;

  anon14_Else:
    assume {:partition} status_5 >= 0;
    call {:si_unique_call 322} PpaInitializeLockIrp(Extension_18);
    goto anon15_Then, anon15_Else;

  anon15_Else:
    assume {:partition} Wait_1 != 0;
    call {:si_unique_call 323} KeInitializeEvent(Event_4, 0, 0);
    assume {:nonnull} Extension_18 != 0;
    assume Extension_18 > 0;
    havoc vslice_dummy_var_1392;
    call {:si_unique_call 324} sdv_IoSetCompletionRoutine(vslice_dummy_var_1392, li2bplFunctionConstant134, Event_4, 1, 1, 1);
    goto L26;
  ...
  L26:
    ...
    call {:si_unique_call 325} status_5 := sdv_IoCallDriver#1(vslice_dummy_var_1393, vslice_dummy_var_1394);
    goto anon16_Then, anon16_Else;
  ...
  anon17_Else:
    ...
    call {:si_unique_call 326} vslice_dummy_var_56 := KeWaitForSingleObject(0, 0, 0, 0, 0);
    goto L33;
  ...
  anon18_Else:
    ...
    assume {:nonnull} Extension_18 != 0;
    assume Extension_18 > 0;
    Mem_T.Locked__DEVICE_EXTENSION[Locked__DEVICE_EXTENSION(Extension_18)] := 1;
    goto L37;

  L37:
    assume {:nonnull} Extension_18 != 0;
    assume Extension_18 > 0;
    call {:si_unique_call 327} vslice_dummy_var_57 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(Extension_18), Extension_18);
    goto L1;
  ...
  anon15_Then:
    ...
    call {:si_unique_call 328} sdv_IoSetCompletionRoutine(vslice_dummy_var_1395, li2bplFunctionConstant199, pDeviceObject, 1, 1, 1);
    goto L26;
...
procedure {:origName "PpaStatus"} PpaStatus(actual_Extension_20: int) returns (Tmp_301: int);
  modifies alloc;
  free ensures {:va_keep} Tmp_301 == 0 || Tmp_301 == 1;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);



implementation {:origName "PpaStatus"} PpaStatus(actual_Extension_20: int) returns (Tmp_301: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 329} Tmp_303 := __HAVOC_malloc(64);
    goto anon21_Then, anon21_Else;
  ...
  anon21_Then:
    call {:si_unique_call 330} endingStatus_1 := VPI0Status(Extension_20);
...
implementation {:origName "_sdv_init6"} _sdv_init6()
{
  ...
  anon0:
    call {:si_unique_call 331} vslice_dummy_var_58 := __HAVOC_malloc(4);
    return;
}



procedure {:origName "PpaStartExecution"} PpaStartExecution(actual_Extension_21: int) returns (Tmp_310: int);
  modifies alloc;
...
implementation {:origName "PpaStartExecution"} PpaStartExecution(actual_Extension_21: int) returns (Tmp_310: int)
{
  ...
  anon11_Else:
    assume {:partition} Mem_T.Locked__DEVICE_EXTENSION[Locked__DEVICE_EXTENSION(Extension_21)] != 0;
    assume {:nonnull} Extension_21 != 0;
    assume Extension_21 > 0;
    havoc Tmp_313;
    assume {:nonnull} Extension_21 != 0;
  ...
  anon12_Else:
    call {:si_unique_call 332} vslice_dummy_var_60 := PpaResetBus(Extension_21);
    goto L13;
  ...
  anon15_Then:
    call {:si_unique_call 333} vslice_dummy_var_59 := PpaContinueExecution(Extension_21);
    goto L13;
...
procedure {:origName "PpaContinueExecution"} PpaContinueExecution(actual_Extension_22: int) returns (Tmp_315: int);
  modifies alloc;
  free ensures {:va_keep} Tmp_315 == 0 || Tmp_315 == -1073741823;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);



implementation {:origName "PpaContinueExecution"} PpaContinueExecution(actual_Extension_22: int) returns (Tmp_315: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 334} Tmp_319 := __HAVOC_malloc(64);
    call {:si_unique_call 335} Tmp_320 := __HAVOC_malloc(64);
    success_7 := 0;
    assume {:nonnull} Extension_22 != 0;
    assume Extension_22 > 0;
    call {:si_unique_call 336} success_7 := VPI0SetupDrive(Extension_22);
    goto anon5_Then, anon5_Else;
  ...
  L13:
    call {:si_unique_call 337} PpaPhaseMan(Extension_22);
    call {:si_unique_call 338} vslice_dummy_var_61 := VPI0RestoreDrive(Extension_22);
    assume {:nonnull} Extension_22 != 0;
    assume Extension_22 > 0;
    Tmp_315 := 0;
    goto L1;
...
implementation {:origName "PpaPhaseMan"} PpaPhaseMan(actual_Extension_23: int)
{
  ...
  anon0:
    call {:si_unique_call 339} vslice_dummy_var_62 := __HAVOC_malloc(4);
  ...
  L8:
    call {:si_unique_call 340} i_6, Tmp_321, sdv_129, sdv_133, sdv_134, sdv_135, sdv_136, sdv_137, Tmp_329, CurrPhase, busBusy, vslice_dummy_var_68 := PpaPhaseMan_loop_L8(i_6, Tmp_321, sdv_129, sdv_133, sdv_134, sdv_135, sdv_136, sdv_137, Tmp_329, CurrPhase, busBusy, Extension_23, vslice_dummy_var_68);
    goto L8_last;
  ...
  anon32_Else:
    call {:si_unique_call 341} sdv_129 := VPI0GetPhase(Extension_23);
    goto anon33_Then, anon33_Else;
  ...
  anon42_Else:
    call {:si_unique_call 342} sdv_137 := PpaStatus(Extension_23);
    goto anon35_Then, anon35_Else;

  anon35_Else:
    assume {:partition} sdv_137 != 0;
    busBusy := 0;
  ...
  anon35_Then:
    assume {:partition} sdv_137 == 0;
    call {:si_unique_call 343} vslice_dummy_var_63 := PpaResetBus(Extension_23);
    assume {:nonnull} Extension_23 != 0;
    assume Extension_23 > 0;
    havoc Tmp_325;
  ...
  anon42_Then:
    busBusy := 0;
    call {:si_unique_call 344} vslice_dummy_var_68 := PpaResetBus(Extension_23);
    assume {:nonnull} Extension_23 != 0;
    assume Extension_23 > 0;
    havoc Tmp_329;
  ...
  anon43_Then:
    call {:si_unique_call 345} sdv_136 := PpaCommand(Extension_23);
    goto anon36_Then, anon36_Else;

  anon36_Else:
    assume {:partition} sdv_136 == 0;
    call {:si_unique_call 346} vslice_dummy_var_64 := PpaResetBus(Extension_23);
    assume {:nonnull} Extension_23 != 0;
    assume Extension_23 > 0;
    havoc Tmp_327;
  ...
  anon44_Then:
    call {:si_unique_call 347} sdv_135 := PpaDataIn(Extension_23);
    goto anon37_Then, anon37_Else;

  anon37_Else:
    assume {:partition} sdv_135 == 0;
    call {:si_unique_call 348} vslice_dummy_var_65 := PpaResetBus(Extension_23);
    assume {:nonnull} Extension_23 != 0;
    assume Extension_23 > 0;
    havoc Tmp_330;
  ...
  anon34_Then:
    call {:si_unique_call 349} sdv_133 := PpaDataOut(Extension_23);
    goto anon38_Then, anon38_Else;

  anon38_Else:
    assume {:partition} sdv_133 == 0;
    call {:si_unique_call 350} vslice_dummy_var_66 := PpaResetBus(Extension_23);
    assume {:nonnull} Extension_23 != 0;
    assume Extension_23 > 0;
    havoc Tmp_324;
  ...
  L65:
    call {:si_unique_call 351} i_6, sdv_134 := PpaPhaseMan_loop_L65(i_6, sdv_134, CurrPhase, Extension_23);
    goto L65_last;
  ...
  anon45_Else:
    ...
    call {:si_unique_call 352} sdv_134 := VPI0GetPhase(Extension_23);
  ...
  anon39_Else:
    ...
    call {:si_unique_call 353} vslice_dummy_var_67 := PpaResetBus(Extension_23);
    assume {:nonnull} Extension_23 != 0;
    assume Extension_23 > 0;
    havoc Tmp_328;
...
procedure {:origName "PpaDataIn"} PpaDataIn(actual_Extension_24: int) returns (Tmp_331: int);
  modifies alloc;
...
implementation {:origName "PpaDataIn"} PpaDataIn(actual_Extension_24: int) returns (Tmp_331: int)
{
  ...
  anon6_Else:
    call {:si_unique_call 354} success_8 := VPI0DataIn(Extension_24);
    Tmp_331 := success_8;
    goto L1;
...
procedure {:origName "PpaResetBus"} PpaResetBus(actual_Extension_25: int) returns (Tmp_333: int);
...
implementation {:origName "PpaResetBus"} PpaResetBus(actual_Extension_25: int) returns (Tmp_333: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 355} sdv_141 := VPI0ResetBus(Extension_25);
    goto anon3_Then, anon3_Else;
...
procedure {:origName "PpaDataOut"} PpaDataOut(actual_Extension_26: int) returns (Tmp_335: int);
  modifies alloc;
  free ensures {:va_keep} Tmp_335 == 0 || Tmp_335 == 1;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);



implementation {:origName "PpaDataOut"} PpaDataOut(actual_Extension_26: int) returns (Tmp_335: int)
{
  ...
  anon6_Else:
    call {:si_unique_call 356} success_9 := VPI0DataOut(Extension_26);
    Tmp_335 := success_9;
    goto L1;
...
procedure {:origName "PpaGetDeviceInfo"} PpaGetDeviceInfo(actual_Extension_27: int) returns (Tmp_337: int);
  modifies alloc, Mem_T.Status__IO_STATUS_BLOCK, sdv_IoBuildDeviceIoControlRequest_IoStatusBlock, Mem_T.Locked__DEVICE_EXTENSION, sdv_compFset, sdv_invoke_on_success, sdv_invoke_on_error, sdv_invoke_on_cancel;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);



implementation {:origName "PpaGetDeviceInfo"} PpaGetDeviceInfo(actual_Extension_27: int) returns (Tmp_337: int)
{
  ...
  anon0:
    call {:si_unique_call 357} kEvent := __HAVOC_malloc(124);
    call {:si_unique_call 358} ioStatus := __HAVOC_malloc(12);
  ...
  anon7_Else:
    assume {:partition} BAND(Mem_T.DeviceFlags__DEVICE_EXTENSION[DeviceFlags__DEVICE_EXTENSION(Extension_27)], 16) != 0;
    Tmp_337 := 0;
    goto L1;
  ...
  anon7_Then:
    assume {:partition} BAND(Mem_T.DeviceFlags__DEVICE_EXTENSION[DeviceFlags__DEVICE_EXTENSION(Extension_27)], 16) == 0;
    call {:si_unique_call 359} KeInitializeEvent(kEvent, 0, 0);
    call {:si_unique_call 360} Irp_5 := IoBuildDeviceIoControlRequest(1441912, 0, 0, 0, 0, 64, 1, 0, ioStatus);
    goto anon8_Then, anon8_Else;
  ...
  anon8_Else:
    ...
    call {:si_unique_call 361} Status_16 := sdv_IoCallDriver#1(vslice_dummy_var_1396, Irp_5);
    goto anon9_Then, anon9_Else;

  anon9_Else:
    assume {:partition} Status_16 == 259;
    call {:si_unique_call 362} vslice_dummy_var_69 := KeWaitForSingleObject(0, 0, 0, 0, 0);
...
procedure {:origName "PpaCloseToParclass"} PpaCloseToParclass(actual_Extension_28: int) returns (Tmp_339: int);
  modifies alloc, Mem_T.Status__IO_STATUS_BLOCK, sdv_IoBuildSynchronousFsdRequest_IoStatusBlock, Mem_T.Locked__DEVICE_EXTENSION, sdv_compFset, sdv_invoke_on_success, sdv_invoke_on_error, sdv_invoke_on_cancel;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);



implementation {:origName "PpaCloseToParclass"} PpaCloseToParclass(actual_Extension_28: int) returns (Tmp_339: int)
{
  ...
  anon0:
    call {:si_unique_call 363} kEvent_1 := __HAVOC_malloc(124);
    call {:si_unique_call 364} ioStatus_1 := __HAVOC_malloc(12);
    Extension_28 := actual_Extension_28;
    call {:si_unique_call 365} KeInitializeEvent(kEvent_1, 0, 0);
    call {:si_unique_call 366} Irp_6 := IoBuildSynchronousFsdRequest(27, 0, 0, 0, 0, 0, ioStatus_1);
    goto anon5_Then, anon5_Else;

  anon5_Else:
    assume {:partition} Irp_6 != 0;
    call {:si_unique_call 367} pIrpStack := sdv_IoGetNextIrpStackLocation(Irp_6);
    assume {:nonnull} pIrpStack != 0;
    assume pIrpStack > 0;
    assume {:nonnull} Extension_28 != 0;
    assume Extension_28 > 0;
    havoc vslice_dummy_var_1397;
    call {:si_unique_call 368} Status_17 := sdv_IoCallDriver#1(vslice_dummy_var_1397, Irp_6);
    goto anon6_Then, anon6_Else;

  anon6_Else:
    assume {:partition} Status_17 == 259;
    call {:si_unique_call 369} vslice_dummy_var_70 := KeWaitForSingleObject(0, 0, 0, 0, 0);
...
implementation {:origName "_sdv_init3"} _sdv_init3()
{
  ...
  anon0:
    call {:si_unique_call 370} vslice_dummy_var_71 := __HAVOC_malloc(4);
    return;
}



procedure {:origName "PpaGetTransferMode"} PpaGetTransferMode(actual_Extension_29: int) returns (Tmp_343: int);
  free ensures {:va_keep} Tmp_343 == 0;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);



implementation {:origName "PpaGetTransferMode"} PpaGetTransferMode(actual_Extension_29: int) returns (Tmp_343: int)
{
...
procedure {:origName "PpaCreateToParclass"} PpaCreateToParclass(actual_Extension_30: int) returns (Tmp_345: int);
  modifies alloc, Mem_T.Status__IO_STATUS_BLOCK, sdv_IoBuildSynchronousFsdRequest_IoStatusBlock, Mem_T.Locked__DEVICE_EXTENSION, sdv_compFset, sdv_invoke_on_success, sdv_invoke_on_error, sdv_invoke_on_cancel;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);
...
implementation {:origName "PpaCreateToParclass"} PpaCreateToParclass(actual_Extension_30: int) returns (Tmp_345: int)
{
  ...
  anon0:
    call {:si_unique_call 371} kEvent_2 := __HAVOC_malloc(124);
    call {:si_unique_call 372} ioStatus_2 := __HAVOC_malloc(12);
    Extension_30 := actual_Extension_30;
    call {:si_unique_call 373} KeInitializeEvent(kEvent_2, 0, 0);
    call {:si_unique_call 374} Irp_7 := IoBuildSynchronousFsdRequest(27, 0, 0, 0, 0, 0, ioStatus_2);
    goto anon5_Then, anon5_Else;

  anon5_Else:
    assume {:partition} Irp_7 != 0;
    call {:si_unique_call 375} pIrpStack_1 := sdv_IoGetNextIrpStackLocation(Irp_7);
    ...
    call {:si_unique_call 376} Status_19 := sdv_IoCallDriver#1(vslice_dummy_var_1398, Irp_7);
    goto anon6_Then, anon6_Else;

  anon6_Else:
    assume {:partition} Status_19 == 259;
    call {:si_unique_call 377} vslice_dummy_var_72 := KeWaitForSingleObject(0, 0, 0, 0, 0);
...
procedure {:origName "PpaRequestCompletionRoutine"} PpaRequestCompletionRoutine(actual_DeviceObject_12: int, actual_Irp_8: int, actual_EventIn: int) returns (Tmp_347: int);
  free ensures {:va_keep} Tmp_347 == -1073741802;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);



implementation {:origName "PpaRequestCompletionRoutine"} PpaRequestCompletionRoutine(actual_DeviceObject_12: int, actual_Irp_8: int, actual_EventIn: int) returns (Tmp_347: int)
{
  ...
  anon0:
    ...
    Event_6 := EventIn;
    call {:si_unique_call 378} vslice_dummy_var_73 := KeSetEvent(Event_6, 1, 0);
    Tmp_347 := -1073741802;
    return;
}
...
implementation {:origName "PpaCompleteRequest"} PpaCompleteRequest(actual_Extension_31: int, actual_pIrp: int, actual_Status_20: int)
{
  ...
  anon0:
    call {:si_unique_call 379} vslice_dummy_var_74 := __HAVOC_malloc(4);
    Extension_31 := actual_Extension_31;
    pIrp := actual_pIrp;
    Status_20 := actual_Status_20;
    call {:si_unique_call 380} pIrpStack_2 := sdv_IoGetCurrentIrpStackLocation(pIrp);
  ...
  anon21_Else:
    call {:si_unique_call 381} sdv_157 := sdv_MmGetMdlVirtualAddress(0);
    assume {:nonnull} srb != 0;
    assume srb > 0;
    assume {:nonnull} srb != 0;
    assume srb > 0;
  ...
  anon28_Else:
    call {:si_unique_call 382} sdv_KeFlushIoBuffers(0, 1, 0);
    goto L11;
  ...
  anon25_Else:
    call {:si_unique_call 383} sdv_159 := PpaIssueRequestSense(Extension_31, pIrp);
    goto anon26_Then, anon26_Else;
  ...
  anon26_Else:
    ...
    assume {:nonnull} pIrp != 0;
    assume pIrp > 0;
    call {:si_unique_call 384} boogieTmp := PpaInterpretSenseInfo(srb);
  ...
  anon26_Then:
    ...
    assume {:nonnull} pIrp != 0;
    assume pIrp > 0;
    call {:si_unique_call 385} boogieTmp := PpaTranslateScsiStatus(srb);
    Mem_T.Status__IO_STATUS_BLOCK[Status__IO_STATUS_BLOCK(IoStatus__IRP(pIrp))] := boogieTmp;
    goto L1;
  ...
  L28:
    assume {:nonnull} pIrp != 0;
    assume pIrp > 0;
    call {:si_unique_call 386} boogieTmp := PpaTranslateScsiStatus(srb);
    Mem_T.Status__IO_STATUS_BLOCK[Status__IO_STATUS_BLOCK(IoStatus__IRP(pIrp))] := boogieTmp;
    goto L1;
...
procedure {:origName "PpaInterpretSenseInfo"} PpaInterpretSenseInfo(actual_Srb: int) returns (Tmp_352: int);
  free ensures {:va_keep} Tmp_352 == -1073741435 || Tmp_352 == -1073741823 || Tmp_352 == -1073741790 || Tmp_352 == 32 || Tmp_352 == -1073741808 || Tmp_352 == 17 || Tmp_352 == -1073741805;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);



implementation {:origName "PpaInterpretSenseInfo"} PpaInterpretSenseInfo(actual_Srb: int) returns (Tmp_352: int)
{
...
implementation {:origName "_sdv_init5"} _sdv_init5()
{
  ...
  anon0:
    call {:si_unique_call 387} vslice_dummy_var_75 := __HAVOC_malloc(4);
    return;
}



procedure {:origName "PpaIssueInquiry"} PpaIssueInquiry(actual_Extension_32: int) returns (Tmp_356: int);
  modifies alloc;
  free ensures {:va_keep} Tmp_356 == 0 || Tmp_356 == -1073741823 || Tmp_356 == -1073741670;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);



implementation {:origName "PpaIssueInquiry"} PpaIssueInquiry(actual_Extension_32: int) returns (Tmp_356: int)
{
  var {:pointer} cdb: int;
  ...
  anon0:
    ...
    retryCount := 0;
    call {:si_unique_call 388} sdv_161 := ExAllocatePoolWithTag(4, 64, 863134032);
    srb_1 := sdv_161;
    goto anon22_Then, anon22_Else;
  ...
  L14:
    call {:si_unique_call 389} cdb, Tmp_357, Tmp_358, Tmp_359, status_8, Tmp_361, retryCount := PpaIssueInquiry_loop_L14(cdb, Tmp_357, Tmp_358, Tmp_359, srb_1, status_8, Tmp_361, retryCount, Extension_32);
    goto L14_last;

  L14_last:
    call {:si_unique_call 391} sdv_RtlZeroMemory(0, 64);
    ...
    assume {:nonnull} Extension_32 != 0;
    assume Extension_32 > 0;
    call {:si_unique_call 392} IoStartTimer(0);
    call {:si_unique_call 393} status_8 := PpaStartExecution(Extension_32);
    assume {:nonnull} Extension_32 != 0;
    assume Extension_32 > 0;
    call {:si_unique_call 394} IoStopTimer(0);
    goto anon19_Then, anon19_Else;
...
procedure {:origName "PpaPortUnlockCompletionRoutine"} PpaPortUnlockCompletionRoutine(actual_pDeviceObject_2: int, actual_Irp_9: int, actual_ContextIn: int) returns (Tmp_362: int);
  modifies Mem_T.Locked__DEVICE_EXTENSION, alloc;
  free ensures {:va_keep} Tmp_362 == -1073741802;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);



implementation {:origName "PpaPortUnlockCompletionRoutine"} PpaPortUnlockCompletionRoutine(actual_pDeviceObject_2: int, actual_Irp_9: int, actual_ContextIn: int) returns (Tmp_362: int)
{
  ...
  anon0:
    ...
    assume Context_4 > 0;
    Extension_33 := Mem_T.DeviceExtension__DEVICE_OBJECT[DeviceExtension__DEVICE_OBJECT(Context_4)];
  ...
  anon6_Else:
    assume {:partition} Mem_T.Status__IO_STATUS_BLOCK[Status__IO_STATUS_BLOCK(IoStatus__IRP(Tmp_363))] >= 0;
    assume {:nonnull} Extension_33 != 0;
    assume Extension_33 > 0;
    Mem_T.Locked__DEVICE_EXTENSION[Locked__DEVICE_EXTENSION(Extension_33)] := 0;
    goto L9;

  L9:
    call {:si_unique_call 395} sdv_163 := sdv_KeGetCurrentIrql();
    goto anon5_Then, anon5_Else;

  anon5_Else:
    assume {:partition} 2 > sdv_163;
    call {:si_unique_call 396} oldIrql := KeRaiseIrqlToDpcLevel();
    call {:si_unique_call 397} IoStartNextPacket(0, 0);
    call {:si_unique_call 398} sdv_KeLowerIrql(oldIrql);
    goto L27;
  ...
  anon5_Then:
    ...
    call {:si_unique_call 399} IoStartNextPacket(0, 0);
    goto L27;

  anon6_Then:
    assume {:partition} 0 > Mem_T.Status__IO_STATUS_BLOCK[Status__IO_STATUS_BLOCK(IoStatus__IRP(Tmp_363))];
    goto L9;
}



procedure {:origName "PpaIssueRequestSense"} PpaIssueRequestSense(actual_Extension_35: int, actual_pIrp_1: int) returns (Tmp_368: int);
  modifies alloc;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);
...
implementation {:origName "PpaIssueRequestSense"} PpaIssueRequestSense(actual_Extension_35: int, actual_pIrp_1: int) returns (Tmp_368: int)
{
  ...
  anon0:
    ...
    pIrp_1 := actual_pIrp_1;
    call {:si_unique_call 400} Tmp_369 := __HAVOC_malloc(64);
    call {:si_unique_call 401} Tmp_376 := __HAVOC_malloc(64);
    call {:si_unique_call 402} Tmp_378 := __HAVOC_malloc(64);
    call {:si_unique_call 403} Tmp_380 := __HAVOC_malloc(64);
    call {:si_unique_call 404} Tmp_381 := __HAVOC_malloc(64);
    call {:si_unique_call 405} Tmp_383 := __HAVOC_malloc(64);
    call {:si_unique_call 406} pIrpStack_3 := sdv_IoGetCurrentIrpStackLocation(pIrp_1);
    retryCount_1 := 0;
    call {:si_unique_call 407} sdv_169 := ExAllocatePoolWithTag(0, 68, 863134032);
    srb_2 := sdv_169;
    goto anon20_Then, anon20_Else;
  ...
  L18:
    call {:si_unique_call 408} Tmp_369, Tmp_370, Tmp_371, Tmp_372, Tmp_373, Tmp_375, Tmp_376, Tmp_378, Tmp_379, status_10, Tmp_380, Tmp_381, retryCount_1, Tmp_382, Tmp_383 := PpaIssueRequestSense_loop_L18(Tmp_369, Tmp_370, Tmp_371, Tmp_372, Tmp_373, Tmp_375, pIrpStack_3, Tmp_376, Tmp_378, Tmp_379, srb_2, status_10, Tmp_380, Tmp_381, retryCount_1, Tmp_382, Tmp_383, Extension_35);
    goto L18_last;
  ...
  L18_last:
    ...
    assume {:nonnull} Extension_35 != 0;
    assume Extension_35 > 0;
    call {:si_unique_call 411} IoStartTimer(0);
    call {:si_unique_call 412} status_10 := PpaStartExecution(Extension_35);
    assume {:nonnull} Extension_35 != 0;
    assume Extension_35 > 0;
    call {:si_unique_call 413} IoStopTimer(0);
    goto anon17_Then, anon17_Else;
...
procedure {:origName "PpaTranslateScsiStatus"} PpaTranslateScsiStatus(actual_Srb_1: int) returns (Tmp_384: int);
  free ensures {:va_keep} Tmp_384 == -1073741435;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);



implementation {:origName "PpaTranslateScsiStatus"} PpaTranslateScsiStatus(actual_Srb_1: int) returns (Tmp_384: int)
{
...
implementation {:origName "_sdv_init4"} _sdv_init4()
{
  ...
  anon0:
    call {:si_unique_call 414} vslice_dummy_var_76 := __HAVOC_malloc(4);
    return;
}



procedure {:origName "PpaTrySlowerMode"} PpaTrySlowerMode(actual_Extension_36: int) returns (Tmp_388: int);
  modifies alloc;
...
implementation {:origName "PpaTrySlowerMode"} PpaTrySlowerMode(actual_Extension_36: int) returns (Tmp_388: int)
{
  ...
  anon14_Else:
    ...
    assume {:nonnull} Extension_36 != 0;
    assume Extension_36 > 0;
    call {:si_unique_call 415} vslice_dummy_var_77 := PpaWriteRegistryModeValue(Extension_36);
    goto L14;
  ...
  anon15_Else:
    ...
    assume {:nonnull} Extension_36 != 0;
    assume Extension_36 > 0;
    call {:si_unique_call 416} vslice_dummy_var_78 := PpaWriteRegistryModeValue(Extension_36);
    goto L14;
  ...
  anon15_Then:
    ...
    assume {:nonnull} Extension_36 != 0;
    assume Extension_36 > 0;
    call {:si_unique_call 417} vslice_dummy_var_79 := PpaWriteRegistryModeValue(Extension_36);
    goto L14;
  ...
  anon17_Else:
    ...
    assume {:nonnull} Extension_36 != 0;
    assume Extension_36 > 0;
    call {:si_unique_call 418} vslice_dummy_var_80 := PpaWriteRegistryModeValue(Extension_36);
    goto L34;
  ...
  anon17_Then:
    ...
    assume {:nonnull} Extension_36 != 0;
    assume Extension_36 > 0;
    call {:si_unique_call 419} vslice_dummy_var_81 := PpaWriteRegistryModeValue(Extension_36);
    goto L34;
  ...
  anon16_Else:
    ...
    assume {:nonnull} Extension_36 != 0;
    assume Extension_36 > 0;
    call {:si_unique_call 420} vslice_dummy_var_82 := PpaWriteRegistryModeValue(Extension_36);
    trySlowerMode := 1;
    goto L15;
...
procedure {:origName "PpaPnpDeviceControl"} PpaPnpDeviceControl(actual_pDeviceObject_4: int, actual_pIrp_2: int) returns (Tmp_390: int);
  modifies alloc, Mem_T.DeviceFlags__DEVICE_EXTENSION, Mem_T.Status__IO_STATUS_BLOCK, sdv_compFset, sdv_invoke_on_success, sdv_invoke_on_error, sdv_invoke_on_cancel, sdv_IoBuildSynchronousFsdRequest_IoStatusBlock, sdv_IoBuildDeviceIoControlRequest_IoStatusBlock, Mem_T.Locked__DEVICE_EXTENSION;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);



implementation {:origName "PpaPnpDeviceControl"} PpaPnpDeviceControl(actual_pDeviceObject_4: int, actual_pIrp_2: int) returns (Tmp_390: int)
{
  ...
  anon0:
    call {:si_unique_call 421} Event_7 := __HAVOC_malloc(124);
    pDeviceObject_4 := actual_pDeviceObject_4;
    pIrp_2 := actual_pIrp_2;
    assume {:nonnull} pDeviceObject_4 != 0;
    assume pDeviceObject_4 > 0;
    Extension_37 := Mem_T.DeviceExtension__DEVICE_OBJECT[DeviceExtension__DEVICE_OBJECT(pDeviceObject_4)];
    gotRemoveLock := 0;
    call {:si_unique_call 422} pIrpStack_4 := sdv_IoGetCurrentIrpStackLocation(pIrp_2);
    call {:si_unique_call 423} KeInitializeEvent(Event_7, 1, 0);
  ...
  anon89_Else:
    call {:si_unique_call 424} Tmp_391 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_391 != 0;
    assume Tmp_391 > 0;
    call {:si_unique_call 425} sdv_KeAcquireSpinLock(0, Tmp_391);
    assume {:nonnull} Tmp_391 != 0;
    assume Tmp_391 > 0;
    havoc cIrql;
    assume {:nonnull} Extension_37 != 0;
    assume Extension_37 > 0;
    Mem_T.DeviceFlags__DEVICE_EXTENSION[DeviceFlags__DEVICE_EXTENSION(Extension_37)] := BOR(Mem_T.DeviceFlags__DEVICE_EXTENSION[DeviceFlags__DEVICE_EXTENSION(Extension_37)], BOR(16, 32));
    call {:si_unique_call 426} sdv_KeReleaseSpinLock(0, cIrql);
    Status_23 := 0;
    ...
    assume {:nonnull} pIrp_2 != 0;
    assume pIrp_2 > 0;
    call {:si_unique_call 427} sdv_IoSkipCurrentIrpStackLocation(pIrp_2);
    assume {:nonnull} Extension_37 != 0;
    assume Extension_37 > 0;
    havoc vslice_dummy_var_1399;
    call {:si_unique_call 428} Status_23 := sdv_IoCallDriver#1(vslice_dummy_var_1399, pIrp_2);
    goto L66;
  ...
  L21:
    call {:si_unique_call 429} sdv_IoSkipCurrentIrpStackLocation(pIrp_2);
    assume {:nonnull} Extension_37 != 0;
    assume Extension_37 > 0;
    havoc vslice_dummy_var_1400;
    call {:si_unique_call 430} Status_23 := sdv_IoCallDriver#1(vslice_dummy_var_1400, pIrp_2);
    goto L66;
  ...
  anon93_Then:
    ...
    assume Tmp_392 > 0;
    call {:si_unique_call 431} sdv_IoCopyCurrentIrpStackLocationToNext(pIrp_2);
    assume {:nonnull} Extension_37 != 0;
    assume Extension_37 > 0;
    havoc vslice_dummy_var_1401;
    call {:si_unique_call 432} Status_23 := sdv_IoCallDriver#1(vslice_dummy_var_1401, pIrp_2);
    goto L66;
  ...
  anon95_Then:
    call {:si_unique_call 433} sdv_IoCopyCurrentIrpStackLocationToNext(pIrp_2);
    call {:si_unique_call 434} sdv_IoSetCompletionRoutine(pIrp_2, li2bplFunctionConstant134, Event_7, 1, 1, 1);
    assume {:nonnull} Extension_37 != 0;
    assume Extension_37 > 0;
    havoc vslice_dummy_var_1402;
    call {:si_unique_call 435} Status_23 := sdv_IoCallDriver#1(vslice_dummy_var_1402, pIrp_2);
    goto anon74_Then, anon74_Else;

  anon74_Else:
    assume {:partition} Status_23 == 259;
    call {:si_unique_call 436} vslice_dummy_var_83 := KeWaitForSingleObject(0, 0, 0, 0, 0);
    goto L89;
  ...
  anon108_Else:
    ...
    call {:si_unique_call 437} Tmp_391 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_391 != 0;
    assume Tmp_391 > 0;
    call {:si_unique_call 438} sdv_KeAcquireSpinLock(0, Tmp_391);
    assume {:nonnull} Tmp_391 != 0;
    assume Tmp_391 > 0;
    havoc cIrql;
    assume {:nonnull} Extension_37 != 0;
    assume Extension_37 > 0;
    Mem_T.DeviceFlags__DEVICE_EXTENSION[DeviceFlags__DEVICE_EXTENSION(Extension_37)] := BAND(Mem_T.DeviceFlags__DEVICE_EXTENSION[DeviceFlags__DEVICE_EXTENSION(Extension_37)], BNOT(BOR(2, 4)));
    call {:si_unique_call 439} sdv_KeReleaseSpinLock(0, cIrql);
    goto L94;

  L94:
    call {:si_unique_call 440} sdv_IoCompleteRequest(0, 0);
    goto L66;
  ...
  anon96_Then:
    call {:si_unique_call 441} sdv_IoCopyCurrentIrpStackLocationToNext(pIrp_2);
    call {:si_unique_call 442} sdv_IoSetCompletionRoutine(pIrp_2, li2bplFunctionConstant134, Event_7, 1, 1, 1);
    assume {:nonnull} Extension_37 != 0;
    assume Extension_37 > 0;
    havoc vslice_dummy_var_1403;
    call {:si_unique_call 443} Status_23 := sdv_IoCallDriver#1(vslice_dummy_var_1403, pIrp_2);
    goto anon75_Then, anon75_Else;

  anon75_Else:
    assume {:partition} Status_23 == 259;
    call {:si_unique_call 444} vslice_dummy_var_84 := KeWaitForSingleObject(0, 0, 0, 0, 0);
    goto L113;
  ...
  anon107_Else:
    assume {:partition} Status_23 >= 0;
    call {:si_unique_call 445} Tmp_391 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_391 != 0;
    assume Tmp_391 > 0;
    call {:si_unique_call 446} sdv_KeAcquireSpinLock(0, Tmp_391);
    assume {:nonnull} Tmp_391 != 0;
    assume Tmp_391 > 0;
    havoc cIrql;
    assume {:nonnull} Extension_37 != 0;
    assume Extension_37 > 0;
    Mem_T.DeviceFlags__DEVICE_EXTENSION[DeviceFlags__DEVICE_EXTENSION(Extension_37)] := BOR(Mem_T.DeviceFlags__DEVICE_EXTENSION[DeviceFlags__DEVICE_EXTENSION(Extension_37)], BOR(2, 4));
  ...
  anon97_Then:
    call {:si_unique_call 449} sdv_IoCopyCurrentIrpStackLocationToNext(pIrp_2);
    call {:si_unique_call 450} sdv_IoSetCompletionRoutine(pIrp_2, li2bplFunctionConstant134, Event_7, 1, 1, 1);
    assume {:nonnull} Extension_37 != 0;
    assume Extension_37 > 0;
    havoc vslice_dummy_var_1404;
    call {:si_unique_call 451} Status_23 := sdv_IoCallDriver#1(vslice_dummy_var_1404, pIrp_2);
    goto anon76_Then, anon76_Else;

  anon76_Else:
    assume {:partition} Status_23 == 259;
    call {:si_unique_call 452} vslice_dummy_var_85 := KeWaitForSingleObject(0, 0, 0, 0, 0);
    goto L137;
  ...
  anon106_Else:
    assume {:partition} Status_23 >= 0;
    call {:si_unique_call 453} Tmp_391 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_391 != 0;
    assume Tmp_391 > 0;
    call {:si_unique_call 454} sdv_KeAcquireSpinLock(0, Tmp_391);
    assume {:nonnull} Tmp_391 != 0;
    assume Tmp_391 > 0;
    havoc cIrql;
    assume {:nonnull} Extension_37 != 0;
    assume Extension_37 > 0;
    Mem_T.DeviceFlags__DEVICE_EXTENSION[DeviceFlags__DEVICE_EXTENSION(Extension_37)] := BOR(Mem_T.DeviceFlags__DEVICE_EXTENSION[DeviceFlags__DEVICE_EXTENSION(Extension_37)], 2);
    call {:si_unique_call 455} sdv_KeReleaseSpinLock(0, cIrql);
    assume {:nonnull} pIrp_2 != 0;
    assume pIrp_2 > 0;
  ...
  anon98_Then:
    call {:si_unique_call 457} sdv_IoCopyCurrentIrpStackLocationToNext(pIrp_2);
    assume {:nonnull} Extension_37 != 0;
    assume Extension_37 > 0;
    havoc vslice_dummy_var_1405;
    call {:si_unique_call 458} Status_23 := sdv_IoCallDriver#1(vslice_dummy_var_1405, pIrp_2);
    goto anon77_Then, anon77_Else;

  anon77_Else:
    assume {:partition} Status_23 >= 0;
    call {:si_unique_call 459} Tmp_391 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_391 != 0;
    assume Tmp_391 > 0;
    call {:si_unique_call 460} sdv_KeAcquireSpinLock(0, Tmp_391);
    assume {:nonnull} Tmp_391 != 0;
    assume Tmp_391 > 0;
    havoc cIrql;
    assume {:nonnull} Extension_37 != 0;
    assume Extension_37 > 0;
    Mem_T.DeviceFlags__DEVICE_EXTENSION[DeviceFlags__DEVICE_EXTENSION(Extension_37)] := BAND(Mem_T.DeviceFlags__DEVICE_EXTENSION[DeviceFlags__DEVICE_EXTENSION(Extension_37)], BNOT(16));
    call {:si_unique_call 461} sdv_KeReleaseSpinLock(0, cIrql);
    assume {:nonnull} Extension_37 != 0;
    assume Extension_37 > 0;
    goto anon105_Then, anon105_Else;

  anon105_Else:
    call {:si_unique_call 462} Status_23 := PpaCreateToParclass(Extension_37);
    goto L171;
  ...
  anon78_Else:
    assume {:partition} Status_23 >= 0;
    call {:si_unique_call 463} Tmp_391 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_391 != 0;
    assume Tmp_391 > 0;
    call {:si_unique_call 464} sdv_KeAcquireSpinLock(0, Tmp_391);
    assume {:nonnull} Tmp_391 != 0;
    assume Tmp_391 > 0;
    havoc cIrql;
    assume {:nonnull} Extension_37 != 0;
    assume Extension_37 > 0;
    Mem_T.DeviceFlags__DEVICE_EXTENSION[DeviceFlags__DEVICE_EXTENSION(Extension_37)] := BOR(Mem_T.DeviceFlags__DEVICE_EXTENSION[DeviceFlags__DEVICE_EXTENSION(Extension_37)], 8);
  ...
  anon99_Then:
    call {:si_unique_call 466} Status_23 := sdv_IoAcquireRemoveLock(0, 0);
  ...
  anon80_Else:
    call {:si_unique_call 467} vslice_dummy_var_86 := IoCancelIrp(0);
    goto L187;
  ...
  anon103_Else:
    assume {:partition} BAND(Mem_T.DeviceFlags__DEVICE_EXTENSION[DeviceFlags__DEVICE_EXTENSION(Extension_37)], 16) != 0;
    goto L195;
  ...
  anon81_Else:
    assume {:partition} BAND(Mem_T.DeviceFlags__DEVICE_EXTENSION[DeviceFlags__DEVICE_EXTENSION(Extension_37)], 8) != 0;
    call {:si_unique_call 468} Status_23 := PpaCloseToParclass(Extension_37);
    goto L196;
  ...
  anon82_Else:
    assume {:partition} Status_23 >= 0;
    call {:si_unique_call 469} Tmp_391 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_391 != 0;
    assume Tmp_391 > 0;
    call {:si_unique_call 470} sdv_KeAcquireSpinLock(0, Tmp_391);
    assume {:nonnull} Tmp_391 != 0;
    assume Tmp_391 > 0;
    havoc cIrql;
    assume {:nonnull} Extension_37 != 0;
    assume Extension_37 > 0;
    Mem_T.DeviceFlags__DEVICE_EXTENSION[DeviceFlags__DEVICE_EXTENSION(Extension_37)] := BAND(Mem_T.DeviceFlags__DEVICE_EXTENSION[DeviceFlags__DEVICE_EXTENSION(Extension_37)], BNOT(8));
    call {:si_unique_call 471} sdv_KeReleaseSpinLock(0, cIrql);
    call {:si_unique_call 472} sdv_IoCopyCurrentIrpStackLocationToNext(pIrp_2);
    call {:si_unique_call 473} sdv_IoSetCompletionRoutine(pIrp_2, li2bplFunctionConstant134, Event_7, 1, 1, 1);
    assume {:nonnull} Extension_37 != 0;
    assume Extension_37 > 0;
    havoc vslice_dummy_var_1406;
    call {:si_unique_call 474} Status_23 := sdv_IoCallDriver#1(vslice_dummy_var_1406, pIrp_2);
    goto anon84_Then, anon84_Else;

  anon84_Else:
    assume {:partition} Status_23 == 259;
    call {:si_unique_call 475} vslice_dummy_var_87 := KeWaitForSingleObject(0, 0, 0, 0, 0);
    goto L220;
  ...
  anon85_Else:
    ...
    call {:si_unique_call 476} sdv_IoReleaseRemoveLockAndWait(0, 0);
    goto L224;
  ...
  anon104_Else:
    assume {:partition} Status_23 >= 0;
    call {:si_unique_call 477} vslice_dummy_var_88 := KeCancelTimer(0);
    call {:si_unique_call 478} PpaCleanExtension(pDeviceObject_4, 1);
    call {:si_unique_call 479} IoDetachDevice(0);
    call {:si_unique_call 480} IoDeleteDevice(0);
    assume {:nonnull} pIrp_2 != 0;
    assume pIrp_2 > 0;
    goto L229;
  ...
  anon83_Else:
    assume {:partition} gotRemoveLock != 0;
    call {:si_unique_call 482} sdv_IoReleaseRemoveLockAndWait(0, 0);
    goto L246;
  ...
  anon103_Then:
    assume {:partition} BAND(Mem_T.DeviceFlags__DEVICE_EXTENSION[DeviceFlags__DEVICE_EXTENSION(Extension_37)], 16) == 0;
    call {:si_unique_call 483} Tmp_391 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_391 != 0;
    assume Tmp_391 > 0;
    call {:si_unique_call 484} sdv_KeAcquireSpinLock(0, Tmp_391);
    assume {:nonnull} Tmp_391 != 0;
    assume Tmp_391 > 0;
    havoc cIrql;
    assume {:nonnull} Extension_37 != 0;
    assume Extension_37 > 0;
    Mem_T.DeviceFlags__DEVICE_EXTENSION[DeviceFlags__DEVICE_EXTENSION(Extension_37)] := BOR(Mem_T.DeviceFlags__DEVICE_EXTENSION[DeviceFlags__DEVICE_EXTENSION(Extension_37)], 16);
    call {:si_unique_call 485} sdv_KeReleaseSpinLock(0, cIrql);
    goto L195;
  ...
  anon102_Else:
    assume {:partition} BAND(Mem_T.DeviceFlags__DEVICE_EXTENSION[DeviceFlags__DEVICE_EXTENSION(Extension_37)], 8) != 0;
    call {:si_unique_call 486} Status_23 := PpaCloseToParclass(Extension_37);
    goto L256;
  ...
  anon86_Else:
    assume {:partition} Status_23 >= 0;
    call {:si_unique_call 487} Tmp_391 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_391 != 0;
    assume Tmp_391 > 0;
    call {:si_unique_call 488} sdv_KeAcquireSpinLock(0, Tmp_391);
    assume {:nonnull} Tmp_391 != 0;
    assume Tmp_391 > 0;
    havoc cIrql;
    assume {:nonnull} Extension_37 != 0;
    ...
    call {:si_unique_call 491} Status_23 := sdv_IoCallDriver#1(vslice_dummy_var_1407, pIrp_2);
    goto anon87_Then, anon87_Else;

  anon87_Else:
    assume {:partition} Status_23 >= 0;
    call {:si_unique_call 492} Tmp_391 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_391 != 0;
    assume Tmp_391 > 0;
    call {:si_unique_call 493} sdv_KeAcquireSpinLock(0, Tmp_391);
    assume {:nonnull} Tmp_391 != 0;
    assume Tmp_391 > 0;
    havoc cIrql;
    assume {:nonnull} Extension_37 != 0;
    assume Extension_37 > 0;
    Mem_T.DeviceFlags__DEVICE_EXTENSION[DeviceFlags__DEVICE_EXTENSION(Extension_37)] := BOR(Mem_T.DeviceFlags__DEVICE_EXTENSION[DeviceFlags__DEVICE_EXTENSION(Extension_37)], 16);
    call {:si_unique_call 494} sdv_KeReleaseSpinLock(0, cIrql);
    goto L66;

  anon87_Then:
    assume {:partition} 0 > Status_23;
    call {:si_unique_call 495} Status_23 := PpaCreateToParclass(Extension_37);
    goto L66;
  ...
  anon73_Then:
    ...
    call {:si_unique_call 499} Status_23 := sdv_IoCallDriver#1(vslice_dummy_var_1408, pIrp_2);
    goto anon88_Then, anon88_Else;

  anon88_Else:
    assume {:partition} Status_23 == 259;
    call {:si_unique_call 500} vslice_dummy_var_89 := KeWaitForSingleObject(0, 0, 0, 0, 0);
    goto L300;
  ...
  anon101_Else:
    assume {:partition} Status_23 >= 0;
    call {:si_unique_call 501} Status_23 := PpaStartDevice(pDeviceObject_4);
    assume {:nonnull} pIrp_2 != 0;
    assume pIrp_2 > 0;
    Mem_T.Status__IO_STATUS_BLOCK[Status__IO_STATUS_BLOCK(IoStatus__IRP(pIrp_2))] := Status_23;
    assume {:nonnull} pIrp_2 != 0;
...
procedure {:origName "DriverEntry"} DriverEntry(actual_pDriverObject: int, actual_RegistryPath_1: int) returns (Tmp_396: int);
  modifies alloc;
...
implementation {:origName "DriverEntry"} DriverEntry(actual_pDriverObject: int, actual_RegistryPath_1: int) returns (Tmp_396: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 503} Tmp_397 := __HAVOC_malloc(112);
    call {:si_unique_call 504} Tmp_399 := __HAVOC_malloc(112);
    call {:si_unique_call 505} Tmp_400 := __HAVOC_malloc(112);
    call {:si_unique_call 506} Tmp_401 := __HAVOC_malloc(112);
    call {:si_unique_call 507} Tmp_402 := __HAVOC_malloc(112);
    call {:si_unique_call 508} Tmp_403 := __HAVOC_malloc(112);
    call {:si_unique_call 509} Tmp_404 := __HAVOC_malloc(112);
    call {:si_unique_call 510} Tmp_405 := __HAVOC_malloc(112);
    call {:si_unique_call 511} PpaRegInitDriverSettings(RegistryPath_1);
...
procedure {:origName "PpaAddDevice"} PpaAddDevice(actual_pDriverObject_1: int, actual_pPhysicalDeviceObject: int) returns (Tmp_407: int);
  modifies alloc, Mem_T.DeviceFlags__DEVICE_EXTENSION;
  free ensures {:va_keep} Tmp_407 == -1073741637 || Tmp_407 == 0 || Tmp_407 == -1073741823 || Tmp_407 == -1073741824 || Tmp_407 == -1073741771 || Tmp_407 == -1073741670;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);



implementation {:origName "PpaAddDevice"} PpaAddDevice(actual_pDriverObject_1: int, actual_pPhysicalDeviceObject: int) returns (Tmp_407: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 512} Status_24 := PpaCreateDevObject(pDriverObject_1, pPhysicalDeviceObject);
    Tmp_407 := Status_24;
    return;
}
...
implementation {:origName "_sdv_init1"} _sdv_init1()
{
  ...
  anon0:
    call {:si_unique_call 513} vslice_dummy_var_90 := __HAVOC_malloc(4);
    return;
}



procedure {:origName "PpaStartDevice"} PpaStartDevice(actual_pDeviceObject_5: int) returns (Tmp_411: int);
  modifies Mem_T.DeviceFlags__DEVICE_EXTENSION, alloc, Mem_T.Status__IO_STATUS_BLOCK, sdv_IoBuildDeviceIoControlRequest_IoStatusBlock, sdv_compFset, sdv_invoke_on_success, sdv_invoke_on_error, sdv_invoke_on_cancel, Mem_T.Locked__DEVICE_EXTENSION, sdv_IoBuildSynchronousFsdRequest_IoStatusBlock;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);



implementation {:origName "PpaStartDevice"} PpaStartDevice(actual_pDeviceObject_5: int) returns (Tmp_411: int)
{
  ...
  anon0:
    ...
    Extension_38 := Mem_T.DeviceExtension__DEVICE_OBJECT[DeviceExtension__DEVICE_OBJECT(pDeviceObject_5)];
    assume {:nonnull} Extension_38 != 0;
    assume Extension_38 > 0;
    Mem_T.DeviceFlags__DEVICE_EXTENSION[DeviceFlags__DEVICE_EXTENSION(Extension_38)] := BOR(Mem_T.DeviceFlags__DEVICE_EXTENSION[DeviceFlags__DEVICE_EXTENSION(Extension_38)], BOR(1, 2));
    call {:si_unique_call 514} Status_25 := PpaGetDeviceInfo(Extension_38);
    goto anon15_Then, anon15_Else;

  anon15_Else:
    assume {:partition} Status_25 >= 0;
    call {:si_unique_call 515} Status_25 := PpaInitializeExtension(Extension_38);
    goto anon16_Then, anon16_Else;
  ...
  L20:
    call {:si_unique_call 516} Status_25, sdv_205 := PpaStartDevice_loop_L20(Status_25, Extension_38, sdv_205);
    goto L20_last;

  L20_last:
    call {:si_unique_call 521} PpaPortLock(Extension_38, 1, 0);
    assume {:nonnull} Extension_38 != 0;
    assume Extension_38 > 0;
    goto anon17_Then, anon17_Else;

  anon17_Else:
    assume {:partition} Mem_T.Locked__DEVICE_EXTENSION[Locked__DEVICE_EXTENSION(Extension_38)] != 0;
    assume {:nonnull} Extension_38 != 0;
    assume Extension_38 > 0;
    goto L26;

  L26:
    call {:si_unique_call 517} Status_25 := PpaStartDevice_loop_L26(Status_25, Extension_38);
    goto L26_last;
  ...
  anon18_Else:
    call {:si_unique_call 518} Status_25 := PpaIssueInquiry(Extension_38);
    goto anon19_Then, anon19_Else;
  ...
  L27:
    call {:si_unique_call 519} PpaPortUnlock#1(Extension_38, 1, 0);
    goto anon20_Then, anon20_Else;

  anon20_Else:
    assume {:partition} Status_25 != 0;
    call {:si_unique_call 520} sdv_205 := PpaTrySlowerMode(Extension_38);
    goto anon21_Then, anon21_Else;
  ...
  anon20_Then:
    ...
    assume {:nonnull} Extension_38 != 0;
    assume Extension_38 > 0;
    Mem_T.DeviceFlags__DEVICE_EXTENSION[DeviceFlags__DEVICE_EXTENSION(Extension_38)] := BAND(Mem_T.DeviceFlags__DEVICE_EXTENSION[DeviceFlags__DEVICE_EXTENSION(Extension_38)], BNOT(BOR(1, 2)));
    goto L43;
...
implementation {:origName "PpaInitializeUnlockIrp"} PpaInitializeUnlockIrp(actual_Extension_39: int)
{
  ...
  anon0:
    call {:si_unique_call 522} vslice_dummy_var_91 := __HAVOC_malloc(4);
    Extension_39 := actual_Extension_39;
    assume {:nonnull} Extension_39 != 0;
    assume Extension_39 > 0;
    havoc vslice_dummy_var_1409;
    call {:si_unique_call 523} IoReuseIrp(vslice_dummy_var_1409, 0);
    assume {:nonnull} Extension_39 != 0;
    assume Extension_39 > 0;
    havoc vslice_dummy_var_1410;
    call {:si_unique_call 524} pNextIrpStack := sdv_IoGetNextIrpStackLocation(vslice_dummy_var_1410);
    assume {:nonnull} Extension_39 != 0;
    assume Extension_39 > 0;
...
procedure {:origName "PpaInitializeExtension"} PpaInitializeExtension(actual_Extension_40: int) returns (Tmp_415: int);
  modifies alloc, Mem_T.Status__IO_STATUS_BLOCK, sdv_IoBuildSynchronousFsdRequest_IoStatusBlock, Mem_T.DeviceFlags__DEVICE_EXTENSION, sdv_compFset, Mem_T.Locked__DEVICE_EXTENSION, sdv_invoke_on_success, sdv_invoke_on_error, sdv_invoke_on_cancel;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);



implementation {:origName "PpaInitializeExtension"} PpaInitializeExtension(actual_Extension_40: int) returns (Tmp_415: int)
{
  ...
  anon36_Else:
    assume {:partition} BAND(Mem_T.DeviceFlags__DEVICE_EXTENSION[DeviceFlags__DEVICE_EXTENSION(Extension_40)], 16) != 0;
    Tmp_415 := 0;
    goto L1;
  ...
  anon37_Else:
    call {:si_unique_call 525} Status_26 := PpaCreateToParclass(Extension_40);
    goto L13;
  ...
  anon27_Else:
    ...
    call {:si_unique_call 526} Tmp_419 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_419 != 0;
    assume Tmp_419 > 0;
    call {:si_unique_call 527} sdv_KeAcquireSpinLock(0, Tmp_419);
    assume {:nonnull} Tmp_419 != 0;
    assume Tmp_419 > 0;
    havoc cIrql_1;
    assume {:nonnull} Extension_40 != 0;
    assume Extension_40 > 0;
    Mem_T.DeviceFlags__DEVICE_EXTENSION[DeviceFlags__DEVICE_EXTENSION(Extension_40)] := BOR(Mem_T.DeviceFlags__DEVICE_EXTENSION[DeviceFlags__DEVICE_EXTENSION(Extension_40)], 8);
    call {:si_unique_call 528} sdv_KeReleaseSpinLock(0, cIrql_1);
    assume {:nonnull} Extension_40 != 0;
    assume Extension_40 > 0;
    goto anon28_Then, anon28_Else;

  anon28_Else:
    assume {:partition} BAND(Mem_T.DeviceFlags__DEVICE_EXTENSION[DeviceFlags__DEVICE_EXTENSION(Extension_40)], 1) != 0;
    assume {:nonnull} Extension_40 != 0;
    assume Extension_40 > 0;
    call {:si_unique_call 529} sdv_211 := ExAllocatePoolWithTag(4, 36, 863134032);
    assume {:nonnull} Extension_40 != 0;
    assume Extension_40 > 0;
    assume {:nonnull} Extension_40 != 0;
    assume Extension_40 > 0;
  ...
  anon38_Else:
    call {:si_unique_call 530} sdv_212 := ExAllocatePoolWithTag(4, 64, 863134032);
    assume {:nonnull} Extension_40 != 0;
    assume Extension_40 > 0;
    assume {:nonnull} Extension_40 != 0;
    assume Extension_40 > 0;
  ...
  anon39_Else:
    assume {:nonnull} Extension_40 != 0;
    assume Extension_40 > 0;
    call {:si_unique_call 531} boogieTmp := IoAllocateIrp(1, 0);
    assume {:nonnull} Extension_40 != 0;
    assume Extension_40 > 0;
    goto anon29_Then, anon29_Else;
  ...
  anon29_Else:
    ...
    call {:si_unique_call 532} boogieTmp := IoAllocateIrp(vslice_dummy_var_1411, 0);
    assume {:nonnull} Extension_40 != 0;
    assume Extension_40 > 0;
    goto anon30_Then, anon30_Else;
  ...
  anon30_Else:
    ...
    call {:si_unique_call 533} boogieTmp := IoAllocateIrp(vslice_dummy_var_1412, 0);
    assume {:nonnull} Extension_40 != 0;
    assume Extension_40 > 0;
    goto anon31_Then, anon31_Else;
  ...
  anon31_Else:
    ...
    assume {:nonnull} Extension_40 != 0;
    assume Extension_40 > 0;
    Mem_T.Locked__DEVICE_EXTENSION[Locked__DEVICE_EXTENSION(Extension_40)] := 0;
    assume {:nonnull} Extension_40 != 0;
    assume Extension_40 > 0;
    assume {:nonnull} Extension_40 != 0;
    assume Extension_40 > 0;
  ...
  L27:
    ...
    assume {:nonnull} Extension_40 != 0;
    assume Extension_40 > 0;
    call {:si_unique_call 534} vslice_dummy_var_93 := PpaGetRegistryParameters(Extension_40);
    call {:si_unique_call 535} Status_26 := PpaGetTransferMode(Extension_40);
    call {:si_unique_call 536} vslice_dummy_var_92 := PpaWriteRegistryModeValue(Extension_40);
    goto anon32_Then, anon32_Else;
  ...
  anon35_Else:
    call {:si_unique_call 539} IoFreeIrp(0);
    assume {:nonnull} Extension_40 != 0;
    assume Extension_40 > 0;
    goto L115;
...
procedure {:origName "PpaCleanExtension"} PpaCleanExtension(actual_pDeviceObject_7: int, actual_DeviceRemoved: int);
  modifies alloc, Mem_T.Status__IO_STATUS_BLOCK, sdv_IoBuildSynchronousFsdRequest_IoStatusBlock, Mem_T.DeviceFlags__DEVICE_EXTENSION, Mem_T.Locked__DEVICE_EXTENSION, sdv_compFset, sdv_invoke_on_success, sdv_invoke_on_error, sdv_invoke_on_cancel;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);
...
implementation {:origName "PpaCleanExtension"} PpaCleanExtension(actual_pDeviceObject_7: int, actual_DeviceRemoved: int)
{
  ...
  anon0:
    call {:si_unique_call 549} vslice_dummy_var_94 := __HAVOC_malloc(4);
    pDeviceObject_7 := actual_pDeviceObject_7;
    assume {:nonnull} pDeviceObject_7 != 0;
    assume pDeviceObject_7 > 0;
    Extension_41 := Mem_T.DeviceExtension__DEVICE_OBJECT[DeviceExtension__DEVICE_OBJECT(pDeviceObject_7)];
    call {:si_unique_call 550} IoStopTimer(0);
  ...
  anon18_Else:
    call {:si_unique_call 552} IoFreeIrp(0);
    assume {:nonnull} Extension_41 != 0;
    assume Extension_41 > 0;
    goto L16;
  ...
  anon22_Else:
    assume {:partition} BAND(Mem_T.DeviceFlags__DEVICE_EXTENSION[DeviceFlags__DEVICE_EXTENSION(Extension_41)], 8) != 0;
    call {:si_unique_call 556} Status_27 := PpaCloseToParclass(Extension_41);
    goto anon24_Then, anon24_Else;

  anon24_Else:
    assume {:partition} Status_27 >= 0;
    call {:si_unique_call 557} Tmp_420 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_420 != 0;
    assume Tmp_420 > 0;
    call {:si_unique_call 558} sdv_KeAcquireSpinLock(0, Tmp_420);
    assume {:nonnull} Tmp_420 != 0;
    assume Tmp_420 > 0;
    havoc cIrql_2;
    assume {:nonnull} Extension_41 != 0;
    assume Extension_41 > 0;
    Mem_T.DeviceFlags__DEVICE_EXTENSION[DeviceFlags__DEVICE_EXTENSION(Extension_41)] := BAND(Mem_T.DeviceFlags__DEVICE_EXTENSION[DeviceFlags__DEVICE_EXTENSION(Extension_41)], BNOT(8));
    call {:si_unique_call 559} sdv_KeReleaseSpinLock(0, cIrql_2);
    goto L36;
...
implementation {:origName "PpaInitializeLockIrp"} PpaInitializeLockIrp(actual_Extension_42: int)
{
  ...
  anon0:
    call {:si_unique_call 561} vslice_dummy_var_95 := __HAVOC_malloc(4);
    Extension_42 := actual_Extension_42;
    assume {:nonnull} Extension_42 != 0;
    assume Extension_42 > 0;
    havoc vslice_dummy_var_1413;
    call {:si_unique_call 562} IoReuseIrp(vslice_dummy_var_1413, 0);
    assume {:nonnull} Extension_42 != 0;
    assume Extension_42 > 0;
    havoc vslice_dummy_var_1414;
    call {:si_unique_call 563} pNextIrpStack_1 := sdv_IoGetNextIrpStackLocation(vslice_dummy_var_1414);
    assume {:nonnull} Extension_42 != 0;
    assume Extension_42 > 0;
...
procedure {:origName "PpaCreateDevObject"} PpaCreateDevObject(actual_pDriverObject_2: int, actual_pPhysicalDeviceObject_1: int) returns (Tmp_425: int);
  modifies alloc, Mem_T.DeviceFlags__DEVICE_EXTENSION;
  free ensures {:va_keep} Tmp_425 == -1073741637 || Tmp_425 == 0 || Tmp_425 == -1073741823 || Tmp_425 == -1073741824 || Tmp_425 == -1073741771 || Tmp_425 == -1073741670;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);



implementation {:origName "PpaCreateDevObject"} PpaCreateDevObject(actual_pDriverObject_2: int, actual_pPhysicalDeviceObject_1: int) returns (Tmp_425: int)
{
  ...
  anon0:
    call {:si_unique_call 564} pDeviceObject_8 := __HAVOC_malloc(4);
    ...
    call {:si_unique_call 565} Status_28 := IoCreateDevice(0, 288, 0, 45, 257, 0, pDeviceObject_8);
    goto anon7_Then, anon7_Else;
  ...
  anon7_Else:
    ...
    assume pDeviceObject_8 > 0;
    havoc Extension_43;
    call {:si_unique_call 566} sdv_RtlZeroMemory(0, 288);
  ...
  anon9_Else:
    ...
    assume {:nonnull} Extension_43 != 0;
    assume Extension_43 > 0;
    call {:si_unique_call 567} boogieTmp := IoAttachDeviceToDeviceStack(0, pPhysicalDeviceObject_1);
    assume {:nonnull} Extension_43 != 0;
    assume Extension_43 > 0;
    goto anon8_Then, anon8_Else;

  anon8_Else:
    call {:si_unique_call 568} IoDeleteDevice(0);
    Tmp_425 := -1073741637;
    goto L1;
  ...
  L24:
    assume {:nonnull} Extension_43 != 0;
    assume Extension_43 > 0;
    Mem_T.DeviceFlags__DEVICE_EXTENSION[DeviceFlags__DEVICE_EXTENSION(Extension_43)] := 2;
    call {:si_unique_call 569} Status_28 := IoInitializeTimer(0, li2bplFunctionConstant126, 0);
    assume {:nonnull} Extension_43 != 0;
    assume Extension_43 > 0;
    call {:si_unique_call 570} KeInitializeDpc(TimeoutDpc__DEVICE_EXTENSION(Extension_43), li2bplFunctionConstant127, 0);
    call {:si_unique_call 571} KeInitializeTimer(0);
    call {:si_unique_call 572} Tmp_426 := __HAVOC_malloc(4);
    assume {:nonnull} Extension_43 != 0;
    assume Extension_43 > 0;
    assume {:nonnull} Tmp_426 != 0;
    assume Tmp_426 > 0;
    call {:si_unique_call 573} sdv_KeInitializeSpinLock(Tmp_426);
    assume {:nonnull} Extension_43 != 0;
    assume Extension_43 > 0;
    assume {:nonnull} Tmp_426 != 0;
    assume Tmp_426 > 0;
    call {:si_unique_call 574} sdv_IoInitializeRemoveLock(0, 859918416, 0, 1024);
    assume {:nonnull} pDeviceObject_8 != 0;
    assume pDeviceObject_8 > 0;
    Tmp_425 := Status_28;
    goto L1;
...
const {:string "Remove Device Irp is not supported."} unique strConst__li2bpl13: int;
...
implementation {:origName "PpaPortLockCompletionRoutine"} PpaPortLockCompletionRoutine#0(actual_pDeviceObject_3: int, actual_Irp_10: int, actual_ContextIn_1: int) returns (Tmp_365: int)
{
  ...
  anon0:
    ...
    assume Context_5 > 0;
    Extension_34 := Mem_T.DeviceExtension__DEVICE_OBJECT[DeviceExtension__DEVICE_OBJECT(Context_5)];
  ...
  anon9_Else:
    assume {:partition} Mem_T.Status__IO_STATUS_BLOCK[Status__IO_STATUS_BLOCK(IoStatus__IRP(Tmp_367))] >= 0;
    assume {:nonnull} Extension_34 != 0;
    assume Extension_34 > 0;
    Mem_T.Locked__DEVICE_EXTENSION[Locked__DEVICE_EXTENSION(Extension_34)] := 1;
    goto L10;

  L10:
    call {:si_unique_call 575} status_9 := PpaStartExecution(Extension_34);
    assume {:nonnull} Extension_34 != 0;
    assume Extension_34 > 0;
    havoc vslice_dummy_var_1415;
    call {:si_unique_call 576} PpaCompleteRequest(Extension_34, vslice_dummy_var_1415, status_9);
    call {:si_unique_call 577} sdv_IoCompleteRequest(0, 0);
    assume {:nonnull} Extension_34 != 0;
    assume Extension_34 > 0;
    assume {:nonnull} Extension_34 != 0;
    assume Extension_34 > 0;
    call {:si_unique_call 578} vslice_dummy_var_96 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(Extension_34), Extension_34);
    goto anon7_Then, anon7_Else;

  anon7_Else:
    assume {:partition} status_9 < 0;
    call {:si_unique_call 579} sdv_166 := sdv_KeGetCurrentIrql();
    goto anon8_Then, anon8_Else;

  anon8_Else:
    assume {:partition} 2 > sdv_166;
    call {:si_unique_call 580} oldIrql_1 := KeRaiseIrqlToDpcLevel();
    call {:si_unique_call 581} IoStartNextPacket(0, 0);
    call {:si_unique_call 582} sdv_KeLowerIrql(oldIrql_1);
    goto L30;
  ...
  anon9_Then:
    assume {:partition} 0 > Mem_T.Status__IO_STATUS_BLOCK[Status__IO_STATUS_BLOCK(IoStatus__IRP(Tmp_367))];
    goto L10;
}



procedure {:origName "PpaPortLockCompletionRoutine"} PpaPortLockCompletionRoutine#0(actual_pDeviceObject_3: int, actual_Irp_10: int, actual_ContextIn_1: int) returns (Tmp_365: int);
  modifies Mem_T.Locked__DEVICE_EXTENSION, alloc, Mem_T.Status__IO_STATUS_BLOCK;
  free ensures {:va_keep} Tmp_365 == -1073741802;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);



implementation {:origName "PpaPortLockCompletionRoutine"} PpaPortLockCompletionRoutine#1(actual_pDeviceObject_3: int, actual_Irp_10: int, actual_ContextIn_1: int) returns (Tmp_365: int)
{
  var {:scalar} sdv_166: int;
  var {:pointer} Context_5: int;
  var {:scalar} oldIrql_1: int;
  ...
  L10:
    call {:si_unique_call 584} status_9 := PpaStartExecution(Extension_34);
    assume {:nonnull} Extension_34 != 0;
    assume Extension_34 > 0;
    havoc vslice_dummy_var_1416;
    call {:si_unique_call 585} PpaCompleteRequest(Extension_34, vslice_dummy_var_1416, status_9);
    call {:si_unique_call 586} sdv_IoCompleteRequest(0, 0);
    assume {:nonnull} Extension_34 != 0;
    assume Extension_34 > 0;
    assume {:nonnull} Extension_34 != 0;
    assume Extension_34 > 0;
    call {:si_unique_call 587} vslice_dummy_var_97 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(Extension_34), Extension_34);
    goto anon7_Then, anon7_Else;

  anon7_Else:
    assume {:partition} status_9 < 0;
    call {:si_unique_call 588} sdv_166 := sdv_KeGetCurrentIrql();
    goto anon8_Then, anon8_Else;

  anon8_Else:
    assume {:partition} 2 > sdv_166;
    call {:si_unique_call 589} oldIrql_1 := KeRaiseIrqlToDpcLevel();
    call {:si_unique_call 590} IoStartNextPacket(0, 0);
    call {:si_unique_call 591} sdv_KeLowerIrql(oldIrql_1);
    goto L30;
  ...
  anon8_Then:
    assume {:partition} sdv_166 >= 2;
    call {:si_unique_call 592} IoStartNextPacket(0, 0);
    goto L30;

  anon7_Then:
    assume {:partition} 0 <= status_9;
    call {:si_unique_call 593} PpaPortUnlock#0(Extension_34, 0, Context_5);
    goto L30;
...
procedure {:origName "PpaPortLockCompletionRoutine"} PpaPortLockCompletionRoutine#1(actual_pDeviceObject_3: int, actual_Irp_10: int, actual_ContextIn_1: int) returns (Tmp_365: int);
  modifies Mem_T.Locked__DEVICE_EXTENSION, alloc, Mem_T.Status__IO_STATUS_BLOCK, sdv_compFset, sdv_invoke_on_success, sdv_invoke_on_error, sdv_invoke_on_cancel;
  free ensures {:va_keep} Tmp_365 == -1073741802;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);
...
implementation {:origName "PpaPortUnlock"} PpaPortUnlock#0(actual_Extension_19: int, actual_Wait_2: int, actual_pDeviceObject_1: int)
{
  ...
  anon0:
    call {:si_unique_call 594} vslice_dummy_var_98 := __HAVOC_malloc(4);
    call {:si_unique_call 595} Event_5 := __HAVOC_malloc(124);
  ...
  anon11_Else:
    assume {:partition} Mem_T.Locked__DEVICE_EXTENSION[Locked__DEVICE_EXTENSION(Extension_19)] != 0;
    call {:si_unique_call 596} PpaInitializeUnlockIrp(Extension_19);
    goto anon12_Then, anon12_Else;

  anon12_Else:
    assume {:partition} Wait_2 != 0;
    call {:si_unique_call 597} KeInitializeEvent(Event_5, 0, 0);
    assume {:nonnull} Extension_19 != 0;
    assume Extension_19 > 0;
    havoc vslice_dummy_var_1417;
    call {:si_unique_call 598} sdv_IoSetCompletionRoutine(vslice_dummy_var_1417, li2bplFunctionConstant134, Event_5, 1, 1, 1);
    goto L20;
  ...
  L20:
    ...
    call {:si_unique_call 599} status_6 := sdv_IoCallDriver#0(vslice_dummy_var_1418, vslice_dummy_var_1419);
    goto anon13_Then, anon13_Else;
  ...
  anon14_Else:
    ...
    call {:si_unique_call 600} vslice_dummy_var_99 := KeWaitForSingleObject(0, 0, 0, 0, 0);
    goto L27;
  ...
  anon15_Else:
    assume {:partition} Mem_T.Status__IO_STATUS_BLOCK[Status__IO_STATUS_BLOCK(IoStatus__IRP(Tmp_300))] >= 0;
    assume {:nonnull} Extension_19 != 0;
    assume Extension_19 > 0;
    Mem_T.Locked__DEVICE_EXTENSION[Locked__DEVICE_EXTENSION(Extension_19)] := 0;
    goto L1;
  ...
  anon15_Then:
    assume {:partition} 0 > Mem_T.Status__IO_STATUS_BLOCK[Status__IO_STATUS_BLOCK(IoStatus__IRP(Tmp_300))];
    goto L1;
  ...
  anon12_Then:
    ...
    call {:si_unique_call 601} sdv_IoSetCompletionRoutine(vslice_dummy_var_1420, li2bplFunctionConstant200, pDeviceObject_1, 1, 1, 1);
    goto L20;
...
procedure {:origName "PpaPortUnlock"} PpaPortUnlock#0(actual_Extension_19: int, actual_Wait_2: int, actual_pDeviceObject_1: int);
  modifies alloc, Mem_T.Status__IO_STATUS_BLOCK, sdv_compFset, sdv_invoke_on_success, sdv_invoke_on_error, sdv_invoke_on_cancel, Mem_T.Locked__DEVICE_EXTENSION;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);
...
implementation {:origName "PpaPortUnlock"} PpaPortUnlock#1(actual_Extension_19: int, actual_Wait_2: int, actual_pDeviceObject_1: int)
{
  ...
  anon0:
    call {:si_unique_call 602} vslice_dummy_var_100 := __HAVOC_malloc(4);
    call {:si_unique_call 603} Event_5 := __HAVOC_malloc(124);
    Extension_19 := actual_Extension_19;
    Wait_2 := actual_Wait_2;
    pDeviceObject_1 := actual_pDeviceObject_1;
    assume {:nonnull} Extension_19 != 0;
  ...
  anon11_Else:
    assume {:partition} Mem_T.Locked__DEVICE_EXTENSION[Locked__DEVICE_EXTENSION(Extension_19)] != 0;
    call {:si_unique_call 604} PpaInitializeUnlockIrp(Extension_19);
    goto anon12_Then, anon12_Else;

  anon12_Else:
    assume {:partition} Wait_2 != 0;
    call {:si_unique_call 605} KeInitializeEvent(Event_5, 0, 0);
    assume {:nonnull} Extension_19 != 0;
    assume Extension_19 > 0;
    havoc vslice_dummy_var_1421;
    call {:si_unique_call 606} sdv_IoSetCompletionRoutine(vslice_dummy_var_1421, li2bplFunctionConstant134, Event_5, 1, 1, 1);
    goto L20;
  ...
  L20:
    ...
    call {:si_unique_call 607} status_6 := sdv_IoCallDriver#1(vslice_dummy_var_1422, vslice_dummy_var_1423);
    goto anon13_Then, anon13_Else;
  ...
  anon14_Else:
    assume {:partition} status_6 == 259;
    call {:si_unique_call 608} vslice_dummy_var_101 := KeWaitForSingleObject(0, 0, 0, 0, 0);
    goto L27;
  ...
  anon12_Then:
    ...
    call {:si_unique_call 609} sdv_IoSetCompletionRoutine(vslice_dummy_var_1424, li2bplFunctionConstant200, pDeviceObject_1, 1, 1, 1);
    goto L20;
...
implementation {:origName "sdv_IoCallDriver"} {:osmodel} sdv_IoCallDriver#0(actual_DeviceObject_8: int, actual_Irp_4: int) returns (Tmp_256: int)
{
  var {:pointer} Irp_4: int;

  anon0:
    Irp_4 := actual_Irp_4;
    call {:si_unique_call 610} Tmp_256 := IofCallDriver#0(0, Irp_4);
    return;
}



procedure {:origName "sdv_IoCallDriver"} {:osmodel} sdv_IoCallDriver#0(actual_DeviceObject_8: int, actual_Irp_4: int) returns (Tmp_256: int);
  modifies alloc, Mem_T.Status__IO_STATUS_BLOCK, Mem_T.Locked__DEVICE_EXTENSION;
  free ensures {:va_keep} Tmp_256 == 259;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);



implementation {:origName "sdv_IoCallDriver"} {:osmodel} sdv_IoCallDriver#1(actual_DeviceObject_8: int, actual_Irp_4: int) returns (Tmp_256: int)
{
  var {:pointer} Irp_4: int;

  anon0:
    Irp_4 := actual_Irp_4;
    call {:si_unique_call 611} Tmp_256 := IofCallDriver#1(0, Irp_4);
    return;
}



procedure {:origName "sdv_IoCallDriver"} {:osmodel} sdv_IoCallDriver#1(actual_DeviceObject_8: int, actual_Irp_4: int) returns (Tmp_256: int);
  modifies alloc, Mem_T.Status__IO_STATUS_BLOCK, Mem_T.Locked__DEVICE_EXTENSION, sdv_compFset, sdv_invoke_on_success, sdv_invoke_on_error, sdv_invoke_on_cancel;
  free ensures {:va_keep} Tmp_256 == 259;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);
...
implementation {:origName "IofCallDriver"} {:osmodel} IofCallDriver#0(actual_DeviceObject_6: int, actual_Irp_2: int) returns (Tmp_248: int)
{
  ...
  anon0:
    call {:si_unique_call 612} completion := __HAVOC_malloc(4);
    Irp_2 := actual_Irp_2;
  ...
  anon47_Then:
    ...
    call {:si_unique_call 613} vslice_dummy_var_102 := sdv_RunIoCompletionRoutines#0(sdv_p_devobj_fdo, Irp_2, vslice_dummy_var_1425, completion);
    goto L29;
  ...
  anon59_Else:
    ...
    call {:si_unique_call 614} vslice_dummy_var_105 := sdv_RunIoCompletionRoutines#0(sdv_p_devobj_fdo, Irp_2, vslice_dummy_var_1426, completion);
    goto L29;
  ...
  anon51_Else:
    ...
    call {:si_unique_call 615} vslice_dummy_var_103 := sdv_RunIoCompletionRoutines#0(sdv_p_devobj_fdo, Irp_2, vslice_dummy_var_1427, completion);
    goto L29;
  ...
  anon55_Else:
    ...
    call {:si_unique_call 616} vslice_dummy_var_104 := sdv_RunIoCompletionRoutines#0(sdv_p_devobj_fdo, Irp_2, vslice_dummy_var_1428, completion);
    goto L29;
...
procedure {:origName "IofCallDriver"} {:osmodel} IofCallDriver#0(actual_DeviceObject_6: int, actual_Irp_2: int) returns (Tmp_248: int);
  modifies alloc, Mem_T.Status__IO_STATUS_BLOCK, Mem_T.Locked__DEVICE_EXTENSION;
  free ensures {:va_keep} Tmp_248 == 259;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);



implementation {:origName "IofCallDriver"} {:osmodel} IofCallDriver#1(actual_DeviceObject_6: int, actual_Irp_2: int) returns (Tmp_248: int)
{
  var {:dopa} {:scalar} completion: int;
  var {:scalar} status_4: int;
  var {:pointer} Irp_2: int;
  ...
  anon0:
    call {:si_unique_call 617} completion := __HAVOC_malloc(4);
    Irp_2 := actual_Irp_2;
    assume {:nonnull} completion != 0;
    assume completion > 0;
    status_4 := 259;
  ...
  anon47_Then:
    ...
    call {:si_unique_call 618} vslice_dummy_var_106 := sdv_RunIoCompletionRoutines#1(sdv_p_devobj_fdo, Irp_2, vslice_dummy_var_1429, completion);
    goto L29;
  ...
  anon59_Else:
    ...
    call {:si_unique_call 619} vslice_dummy_var_109 := sdv_RunIoCompletionRoutines#1(sdv_p_devobj_fdo, Irp_2, vslice_dummy_var_1430, completion);
    goto L29;
  ...
  anon51_Else:
    ...
    call {:si_unique_call 620} vslice_dummy_var_107 := sdv_RunIoCompletionRoutines#1(sdv_p_devobj_fdo, Irp_2, vslice_dummy_var_1431, completion);
    goto L29;
  ...
  anon55_Else:
    ...
    call {:si_unique_call 621} vslice_dummy_var_108 := sdv_RunIoCompletionRoutines#1(sdv_p_devobj_fdo, Irp_2, vslice_dummy_var_1432, completion);
    goto L29;
...
procedure {:origName "IofCallDriver"} {:osmodel} IofCallDriver#1(actual_DeviceObject_6: int, actual_Irp_2: int) returns (Tmp_248: int);
  modifies alloc, Mem_T.Status__IO_STATUS_BLOCK, Mem_T.Locked__DEVICE_EXTENSION, sdv_compFset, sdv_invoke_on_success, sdv_invoke_on_error, sdv_invoke_on_cancel;
  free ensures {:va_keep} Tmp_248 == 259;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);
...
implementation {:origName "sdv_RunIoCompletionRoutines"} {:osmodel} sdv_RunIoCompletionRoutines#0(actual_DeviceObject_7: int, actual_Irp_3: int, actual_Context_3: int, actual_Completion: int) returns (Tmp_250: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 622} irpsp := sdv_IoGetNextIrpStackLocation(Irp_3);
    Status_14 := 0;
    assume {:nonnull} irpsp != 0;
    assume irpsp > 0;
    goto anon9_Then, anon9_Else;
  ...
  anon9_Else:
    call {:si_unique_call 623} Status_14 := PpaPortLockCompletionRoutine#0(DeviceObject_7, Irp_3, Context_3);
    assume {:nonnull} Completion != 0;
    assume Completion > 0;
    goto L11;
  ...
  anon7_Else:
    call {:si_unique_call 624} Status_14 := PpaPortUnlockCompletionRoutine(DeviceObject_7, Irp_3, Context_3);
    assume {:nonnull} Completion != 0;
    assume Completion > 0;
    goto L28;
  ...
  anon8_Else:
    call {:si_unique_call 625} Status_14 := PpaRequestCompletionRoutine(DeviceObject_7, Irp_3, Context_3);
    assume {:nonnull} Completion != 0;
    assume Completion > 0;
    goto L45;
...
procedure {:origName "sdv_RunIoCompletionRoutines"} {:osmodel} sdv_RunIoCompletionRoutines#0(actual_DeviceObject_7: int, actual_Irp_3: int, actual_Context_3: int, actual_Completion: int) returns (Tmp_250: int);
  modifies Mem_T.Locked__DEVICE_EXTENSION, alloc, Mem_T.Status__IO_STATUS_BLOCK;
  free ensures {:va_keep} Tmp_250 == -1073741802 || Tmp_250 == 0;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);



implementation {:origName "sdv_RunIoCompletionRoutines"} {:osmodel} sdv_RunIoCompletionRoutines#1(actual_DeviceObject_7: int, actual_Irp_3: int, actual_Context_3: int, actual_Completion: int) returns (Tmp_250: int)
{
  var {:scalar} Status_14: int;
  var {:pointer} irpsp: int;
  var {:pointer} DeviceObject_7: int;
  ...
  anon0:
    ...
    Context_3 := actual_Context_3;
    Completion := actual_Completion;
    call {:si_unique_call 626} irpsp := sdv_IoGetNextIrpStackLocation(Irp_3);
    Status_14 := 0;
    assume {:nonnull} irpsp != 0;
    assume irpsp > 0;
    goto anon9_Then, anon9_Else;
  ...
  anon9_Else:
    call {:si_unique_call 627} Status_14 := PpaPortLockCompletionRoutine#1(DeviceObject_7, Irp_3, Context_3);
    assume {:nonnull} Completion != 0;
    assume Completion > 0;
    goto L11;
  ...
  anon7_Else:
    call {:si_unique_call 628} Status_14 := PpaPortUnlockCompletionRoutine(DeviceObject_7, Irp_3, Context_3);
    assume {:nonnull} Completion != 0;
    assume Completion > 0;
    goto L28;
  ...
  anon8_Else:
    call {:si_unique_call 629} Status_14 := PpaRequestCompletionRoutine(DeviceObject_7, Irp_3, Context_3);
    assume {:nonnull} Completion != 0;
    assume Completion > 0;
    goto L45;
...
procedure {:origName "sdv_RunIoCompletionRoutines"} {:osmodel} sdv_RunIoCompletionRoutines#1(actual_DeviceObject_7: int, actual_Irp_3: int, actual_Context_3: int, actual_Completion: int) returns (Tmp_250: int);
  modifies Mem_T.Locked__DEVICE_EXTENSION, alloc, Mem_T.Status__IO_STATUS_BLOCK, sdv_compFset, sdv_invoke_on_success, sdv_invoke_on_error, sdv_invoke_on_cancel;
  free ensures {:va_keep} Tmp_250 == -1073741802 || Tmp_250 == 0;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);
...
implementation {:SIextraRecBound 4} PpaGetRegistryParameters_loop_L56(in_i: int, in_Tmp_3: int, in_CheckMode: int, in_sdv_1: int, in_sdv_3: int, in_Tmp_6: int, in_sdv_6: int, in_sdv_8: int, in_Tmp_8: int, in_Tmp_9: int, in_Found: int, in_Extension: int) returns (out_i: int, out_Tmp_3: int, out_sdv_1: int, out_sdv_3: int, out_Tmp_6: int, out_sdv_6: int, out_sdv_8: int, out_Tmp_8: int, out_Tmp_9: int, out_Found: int)
{
  ...
  anon36_Else:
    ...
    call {:si_unique_call 636} RtlInitUnicodeString(in_CheckMode, out_Tmp_8);
    call {:si_unique_call 637} out_sdv_6 := corral_nondet();
    goto anon32_Then, anon32_Else;
  ...
  L62_dummy:
    call {:si_unique_call 638} {:si_old_unique_call 1} out_i, out_Tmp_3, out_sdv_1, out_sdv_3, out_Tmp_6, out_sdv_6, out_sdv_8, out_Tmp_8, out_Tmp_9, out_Found := PpaGetRegistryParameters_loop_L56(out_i, out_Tmp_3, in_CheckMode, out_sdv_1, out_sdv_3, out_Tmp_6, out_sdv_6, out_sdv_8, out_Tmp_8, out_Tmp_9, out_Found, in_Extension);
    return;
  ...
  anon37_Then:
    ...
    call {:si_unique_call 634} RtlInitUnicodeString(in_CheckMode, out_Tmp_9);
    call {:si_unique_call 635} out_sdv_1 := corral_nondet();
    goto anon33_Then, anon33_Else;
  ...
  anon38_Then:
    ...
    call {:si_unique_call 632} RtlInitUnicodeString(in_CheckMode, out_Tmp_3);
    call {:si_unique_call 633} out_sdv_8 := corral_nondet();
    goto anon34_Then, anon34_Else;
  ...
  anon31_Then:
    ...
    call {:si_unique_call 630} RtlInitUnicodeString(in_CheckMode, out_Tmp_6);
    call {:si_unique_call 631} out_sdv_3 := corral_nondet();
    goto anon35_Then, anon35_Else;
...
implementation VPI0DataIn_loop_L14(in_ChunkSize: int, in_sdv_15: int, in_Status_3: int, in_BytesRead: int, in_Extension_2: int) returns (out_ChunkSize: int, out_sdv_15: int, out_Status_3: int)
{
  ...
  anon24_Else:
    call {:si_unique_call 640} out_sdv_15 := VPI0GetPhase(in_Extension_2);
    goto anon25_Else;
  ...
  L27:
    ...
    call {:si_unique_call 639} out_Status_3 := VPI0ParallelRead(in_Extension_2, vslice_dummy_var_1433, out_ChunkSize, in_BytesRead);
    assume {:nonnull} in_Extension_2 != 0;
    assume in_Extension_2 > 0;
    goto anon29_Else;
  ...
  L_BAF_0:
    call {:si_unique_call 641} {:si_old_unique_call 1} out_ChunkSize, out_sdv_15, out_Status_3 := VPI0DataIn_loop_L14(out_ChunkSize, out_sdv_15, out_Status_3, in_BytesRead, in_Extension_2);
    return;
...
implementation VPI0Selection_loop_L28(in_i_1: int, in_sdv_17: int, in_Controller: int, in_Tmp_38: int) returns (out_i_1: int, out_sdv_17: int, out_Tmp_38: int)
{
  ...
  anon5_Else:
    ...
    call {:si_unique_call 642} out_sdv_17 := corral_nondet();
...
implementation VPI0DataOut_loop_L14(in_ChunkSize_1: int, in_sdv_22: int, in_Status_4: int, in_BytesWritten: int, in_Extension_6: int) returns (out_ChunkSize_1: int, out_sdv_22: int, out_Status_4: int)
{
  ...
  anon24_Else:
    call {:si_unique_call 644} out_sdv_22 := VPI0GetPhase(in_Extension_6);
    goto anon25_Else;
  ...
  L27:
    ...
    call {:si_unique_call 643} out_Status_4 := VPI0ParallelWrite(in_Extension_6, vslice_dummy_var_1434, out_ChunkSize_1, in_BytesWritten);
    assume {:nonnull} in_Extension_6 != 0;
    assume in_Extension_6 > 0;
    goto anon29_Else;
  ...
  L_BAF_1:
    call {:si_unique_call 645} {:si_old_unique_call 1} out_ChunkSize_1, out_sdv_22, out_Status_4 := VPI0DataOut_loop_L14(out_ChunkSize_1, out_sdv_22, out_Status_4, in_BytesWritten, in_Extension_6);
    return;
...
implementation VPI0GetPhase_loop_L55(in_i_2: int, in_Tmp_65: int, in_Controller_2: int, in_sdv_33: int, in_vslice_dummy_var_14: int) returns (out_i_2: int, out_Tmp_65: int, out_sdv_33: int, out_vslice_dummy_var_14: int)
{
  ...
  anon26_Else:
    ...
    call {:si_unique_call 647} out_sdv_33 := corral_nondet();
    out_Tmp_65 := BAND(out_sdv_33, BOR(64, 128));
    goto anon27_Then;

  anon27_Then:
    assume {:partition} out_Tmp_65 != 192;
    call {:si_unique_call 646} out_vslice_dummy_var_14 := KeDelayExecutionThread(0, 0, 0);
    goto anon27_Then_dummy;
...
implementation VPI0GetPhase_loop_L41(in_i_2: int, in_Tmp_66: int, in_Controller_2: int, in_sdv_34: int) returns (out_i_2: int, out_Tmp_66: int, out_sdv_34: int)
{
  ...
  anon24_Else:
    assume {:partition} out_i_2 != 0;
    call {:si_unique_call 648} out_sdv_34 := corral_nondet();
...
implementation VPI0GetPhase_loop_L13(in_i_2: int, in_Tmp_64: int, in_sdv_29: int, in_Controller_2: int) returns (out_i_2: int, out_Tmp_64: int, out_sdv_29: int)
{
  ...
  anon22_Else:
    assume {:partition} out_i_2 != 0;
    call {:si_unique_call 649} out_sdv_29 := corral_nondet();
...
implementation VPI0Command_loop_L10(in_i_3: int, in_Tmp_71: int, in_Tmp_73: int, in_Tmp_74: int, in_success_4: int, in_sdv_35: int, in_Status_6: int, in_BytesWritten_1: int, in_Tmp_77: int, in_Tmp_78: int, in_Extension_10: int) returns (out_i_3: int, out_Tmp_71: int, out_Tmp_73: int, out_Tmp_74: int, out_success_4: int, out_sdv_35: int, out_Status_6: int, out_Tmp_77: int, out_Tmp_78: int)
{
  ...
  anon18_Else:
    call {:si_unique_call 651} out_sdv_35 := VPI0GetPhase(in_Extension_10);
    goto anon13_Else;
  ...
  L20:
    ...
    call {:si_unique_call 650} out_Status_6 := VPI0ParallelWrite(in_Extension_10, out_Tmp_73, 1, in_BytesWritten_1);
    assume {:nonnull} in_Extension_10 != 0;
    assume in_Extension_10 > 0;
    goto anon16_Then, anon16_Else;
...
implementation VPI0DataNibbleRead_loop_L14(in_sdv_38: int, in_CharBufPtr_1: int, in_ByteRead: int, in_sdv_39: int, in_xferCount_1: int, in_Controller_4: int, in_ChunkSize_3: int) returns (out_sdv_38: int, out_ByteRead: int, out_sdv_39: int, out_xferCount_1: int)
{
  ...
  L14:
    call {:si_unique_call 653} out_sdv_38 := corral_nondet();
    call {:si_unique_call 654} out_sdv_39 := corral_nondet();
    call {:si_unique_call 655} out_ByteRead := corral_nondet();
...
implementation VPI0TrySelect_loop_L5(in_i_4: int, in_Tmp_111: int, in_Tmp_113: int, in_Controller_6: int) returns (out_i_4: int, out_Tmp_111: int, out_Tmp_113: int)
{
  ...
  anon3_Else:
    ...
    out_Tmp_113 := out_i_4;
    havoc out_Tmp_111;
    call {:si_unique_call 656} VPI0ClockSelectByte(in_Controller_6, out_Tmp_111);
    out_i_4 := out_i_4 + 1;
    goto anon3_Else_dummy;
...
implementation VPI0Deselect_loop_L5(in_i_5: int, in_Tmp_136: int, in_Tmp_137: int, in_Controller_10: int) returns (out_i_5: int, out_Tmp_136: int, out_Tmp_137: int)
{
  ...
  anon3_Else:
    ...
    out_Tmp_137 := out_i_5;
    havoc out_Tmp_136;
    call {:si_unique_call 657} VPI0ClockDeselectByte(in_Controller_10, out_Tmp_136);
    out_i_5 := out_i_5 + 1;
    goto anon3_Else_dummy;
...
implementation PpaPhaseMan_loop_L65(in_i_6: int, in_sdv_134: int, in_CurrPhase: int, in_Extension_23: int) returns (out_i_6: int, out_sdv_134: int)
{

  entry:
    out_i_6, out_sdv_134 := in_i_6, in_sdv_134;
    goto L65, exit;
  ...
  anon45_Else:
    ...
    call {:si_unique_call 658} out_sdv_134 := VPI0GetPhase(in_Extension_23);
    goto anon40_Else;
  ...
  anon41_Else_dummy:
    call {:si_unique_call 659} {:si_old_unique_call 1} out_i_6, out_sdv_134 := PpaPhaseMan_loop_L65(out_i_6, out_sdv_134, in_CurrPhase, in_Extension_23);
    return;
}



procedure {:LoopProcedure} PpaPhaseMan_loop_L65(in_i_6: int, in_sdv_134: int, in_CurrPhase: int, in_Extension_23: int) returns (out_i_6: int, out_sdv_134: int);
  modifies alloc;
  free ensures {:va_keep} out_sdv_134 == 1 || out_sdv_134 == 0 || out_sdv_134 == in_sdv_134;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);



implementation PpaPhaseMan_loop_L8(in_i_6: int, in_Tmp_321: int, in_sdv_129: int, in_sdv_133: int, in_sdv_134: int, in_sdv_135: int, in_sdv_136: int, in_sdv_137: int, in_Tmp_329: int, in_CurrPhase: int, in_busBusy: int, in_Extension_23: int, in_vslice_dummy_var_68: int) returns (out_i_6: int, out_Tmp_321: int, out_sdv_129: int, out_sdv_133: int, out_sdv_134: int, out_sdv_135: int, out_sdv_136: int, out_sdv_137: int, out_Tmp_329: int, out_CurrPhase: int, out_busBusy: int, out_vslice_dummy_var_68: int)
{

  entry:
    out_i_6, out_Tmp_321, out_sdv_129, out_sdv_133, out_sdv_134, out_sdv_135, out_sdv_136, out_sdv_137, out_Tmp_329, out_CurrPhase, out_busBusy, out_vslice_dummy_var_68 := in_i_6, in_Tmp_321, in_sdv_129, in_sdv_133, in_sdv_134, in_sdv_135, in_sdv_136, in_sdv_137, in_Tmp_329, in_CurrPhase, in_busBusy, in_vslice_dummy_var_68;
    goto L8, exit;
  ...
  anon32_Else:
    call {:si_unique_call 663} out_sdv_129 := VPI0GetPhase(in_Extension_23);
    goto anon33_Else;
  ...
  anon42_Else:
    call {:si_unique_call 660} out_sdv_137 := PpaStatus(in_Extension_23);
    goto anon35_Else;

  anon35_Else:
    assume {:partition} out_sdv_137 != 0;
    out_busBusy := 0;
    goto anon35_Else_dummy;
  ...
  L_BAF_2:
    call {:si_unique_call 668} {:si_old_unique_call 1} out_i_6, out_Tmp_321, out_sdv_129, out_sdv_133, out_sdv_134, out_sdv_135, out_sdv_136, out_sdv_137, out_Tmp_329, out_CurrPhase, out_busBusy, out_vslice_dummy_var_68 := PpaPhaseMan_loop_L8(out_i_6, out_Tmp_321, out_sdv_129, out_sdv_133, out_sdv_134, out_sdv_135, out_sdv_136, out_sdv_137, out_Tmp_329, out_CurrPhase, out_busBusy, in_Extension_23, out_vslice_dummy_var_68);
    return;

  anon42_Then:
    out_busBusy := 0;
    call {:si_unique_call 664} out_vslice_dummy_var_68 := PpaResetBus(in_Extension_23);
    assume {:nonnull} in_Extension_23 != 0;
    assume in_Extension_23 > 0;
    havoc out_Tmp_329;
  ...
  anon43_Then:
    call {:si_unique_call 665} out_sdv_136 := PpaCommand(in_Extension_23);
    goto anon36_Then;

  anon36_Then:
    assume {:partition} out_sdv_136 != 0;
    goto anon36_Then_dummy;
  ...
  anon44_Then:
    call {:si_unique_call 666} out_sdv_135 := PpaDataIn(in_Extension_23);
    goto anon37_Then;
  ...
  anon34_Then:
    call {:si_unique_call 667} out_sdv_133 := PpaDataOut(in_Extension_23);
    goto anon38_Then;
  ...
  L65:
    call {:si_unique_call 661} out_i_6, out_sdv_134 := PpaPhaseMan_loop_L65(out_i_6, out_sdv_134, out_CurrPhase, in_Extension_23);
    goto L65_last;
  ...
  anon45_Else:
    assume {:partition} out_i_6 != 0;
    call {:si_unique_call 662} out_sdv_134 := VPI0GetPhase(in_Extension_23);
    goto anon40_Then, anon40_Else;
...
procedure {:LoopProcedure} PpaPhaseMan_loop_L8(in_i_6: int, in_Tmp_321: int, in_sdv_129: int, in_sdv_133: int, in_sdv_134: int, in_sdv_135: int, in_sdv_136: int, in_sdv_137: int, in_Tmp_329: int, in_CurrPhase: int, in_busBusy: int, in_Extension_23: int, in_vslice_dummy_var_68: int) returns (out_i_6: int, out_Tmp_321: int, out_sdv_129: int, out_sdv_133: int, out_sdv_134: int, out_sdv_135: int, out_sdv_136: int, out_sdv_137: int, out_Tmp_329: int, out_CurrPhase: int, out_busBusy: int, out_vslice_dummy_var_68: int);
  modifies alloc;
  ...
  free ensures {:va_keep} out_sdv_136 == 0 || out_sdv_136 == 1 || out_sdv_136 == in_sdv_136;
  free ensures {:va_keep} out_sdv_137 == 0 || out_sdv_137 == 1 || out_sdv_137 == in_sdv_137;
...
implementation PpaIssueInquiry_loop_L14(in_cdb: int, in_Tmp_357: int, in_Tmp_358: int, in_Tmp_359: int, in_srb_1: int, in_status_8: int, in_Tmp_361: int, in_retryCount: int, in_Extension_32: int) returns (out_cdb: int, out_Tmp_357: int, out_Tmp_358: int, out_Tmp_359: int, out_status_8: int, out_Tmp_361: int, out_retryCount: int)
{

  entry:
    out_cdb, out_Tmp_357, out_Tmp_358, out_Tmp_359, out_status_8, out_Tmp_361, out_retryCount := in_cdb, in_Tmp_357, in_Tmp_358, in_Tmp_359, in_status_8, in_Tmp_361, in_retryCount;
    goto L14, exit;
  ...
  L14:
    call {:si_unique_call 669} sdv_RtlZeroMemory(0, 64);
    ...
    assume {:nonnull} in_Extension_32 != 0;
    assume in_Extension_32 > 0;
    call {:si_unique_call 670} IoStartTimer(0);
    call {:si_unique_call 671} out_status_8 := PpaStartExecution(in_Extension_32);
    assume {:nonnull} in_Extension_32 != 0;
    assume in_Extension_32 > 0;
    call {:si_unique_call 672} IoStopTimer(0);
    goto anon19_Else;
  ...
  anon23_Else:
    assume {:partition} out_Tmp_358 != 1;
    assume {:nonnull} in_srb_1 != 0;
    assume in_srb_1 > 0;
    havoc out_Tmp_359;
    goto anon24_Then, anon24_Else;
  ...
  anon24_Else:
    assume {:partition} out_Tmp_359 == 18;
    out_status_8 := 0;
    goto L60;
  ...
  anon21_Then_dummy:
    call {:si_unique_call 673} {:si_old_unique_call 1} out_cdb, out_Tmp_357, out_Tmp_358, out_Tmp_359, out_status_8, out_Tmp_361, out_retryCount := PpaIssueInquiry_loop_L14(out_cdb, out_Tmp_357, out_Tmp_358, out_Tmp_359, in_srb_1, out_status_8, out_Tmp_361, out_retryCount, in_Extension_32);
    return;
  ...
  anon25_Else:
    assume {:partition} out_Tmp_357 == 10;
    goto L68;
  ...
  anon26_Else:
    assume {:partition} out_Tmp_361 != 8;
...
procedure {:LoopProcedure} PpaIssueInquiry_loop_L14(in_cdb: int, in_Tmp_357: int, in_Tmp_358: int, in_Tmp_359: int, in_srb_1: int, in_status_8: int, in_Tmp_361: int, in_retryCount: int, in_Extension_32: int) returns (out_cdb: int, out_Tmp_357: int, out_Tmp_358: int, out_Tmp_359: int, out_status_8: int, out_Tmp_361: int, out_retryCount: int);
  modifies alloc;
...
implementation PpaIssueRequestSense_loop_L18(in_Tmp_369: int, in_Tmp_370: int, in_Tmp_371: int, in_Tmp_372: int, in_Tmp_373: int, in_Tmp_375: int, in_pIrpStack_3: int, in_Tmp_376: int, in_Tmp_378: int, in_Tmp_379: int, in_srb_2: int, in_status_10: int, in_Tmp_380: int, in_Tmp_381: int, in_retryCount_1: int, in_Tmp_382: int, in_Tmp_383: int, in_Extension_35: int) returns (out_Tmp_369: int, out_Tmp_370: int, out_Tmp_371: int, out_Tmp_372: int, out_Tmp_373: int, out_Tmp_375: int, out_Tmp_376: int, out_Tmp_378: int, out_Tmp_379: int, out_status_10: int, out_Tmp_380: int, out_Tmp_381: int, out_retryCount_1: int, out_Tmp_382: int, out_Tmp_383: int)
{

  entry:
    out_Tmp_369, out_Tmp_370, out_Tmp_371, out_Tmp_372, out_Tmp_373, out_Tmp_375, out_Tmp_376, out_Tmp_378, out_Tmp_379, out_status_10, out_Tmp_380, out_Tmp_381, out_retryCount_1, out_Tmp_382, out_Tmp_383 := in_Tmp_369, in_Tmp_370, in_Tmp_371, in_Tmp_372, in_Tmp_373, in_Tmp_375, in_Tmp_376, in_Tmp_378, in_Tmp_379, in_status_10, in_Tmp_380, in_Tmp_381, in_retryCount_1, in_Tmp_382, in_Tmp_383;
    goto L18, exit;
  ...
  L18:
    call {:si_unique_call 674} sdv_RtlZeroMemory(0, 64);
    ...
    assume {:nonnull} in_Extension_35 != 0;
    assume in_Extension_35 > 0;
    call {:si_unique_call 675} IoStartTimer(0);
    call {:si_unique_call 676} out_status_10 := PpaStartExecution(in_Extension_35);
    assume {:nonnull} in_Extension_35 != 0;
    assume in_Extension_35 > 0;
    call {:si_unique_call 677} IoStopTimer(0);
    goto anon17_Else;
  ...
  anon21_Else:
    assume {:partition} out_Tmp_382 != 1;
    assume {:nonnull} in_srb_2 != 0;
    assume in_srb_2 > 0;
    havoc out_Tmp_372;
    goto anon22_Then, anon22_Else;
  ...
  anon22_Else:
    assume {:partition} out_Tmp_372 == 18;
    out_status_10 := 0;
    goto L62;
  ...
  anon19_Then_dummy:
    call {:si_unique_call 678} {:si_old_unique_call 1} out_Tmp_369, out_Tmp_370, out_Tmp_371, out_Tmp_372, out_Tmp_373, out_Tmp_375, out_Tmp_376, out_Tmp_378, out_Tmp_379, out_status_10, out_Tmp_380, out_Tmp_381, out_retryCount_1, out_Tmp_382, out_Tmp_383 := PpaIssueRequestSense_loop_L18(out_Tmp_369, out_Tmp_370, out_Tmp_371, out_Tmp_372, out_Tmp_373, out_Tmp_375, in_pIrpStack_3, out_Tmp_376, out_Tmp_378, out_Tmp_379, in_srb_2, out_status_10, out_Tmp_380, out_Tmp_381, out_retryCount_1, out_Tmp_382, out_Tmp_383, in_Extension_35);
    return;
  ...
  anon23_Else:
    assume {:partition} out_Tmp_379 != 10;
    assume {:nonnull} in_srb_2 != 0;
    assume in_srb_2 > 0;
    havoc out_Tmp_373;
    goto anon24_Then, anon24_Else;
  ...
  anon24_Else:
    assume {:partition} out_Tmp_373 != 8;
...
procedure {:LoopProcedure} PpaIssueRequestSense_loop_L18(in_Tmp_369: int, in_Tmp_370: int, in_Tmp_371: int, in_Tmp_372: int, in_Tmp_373: int, in_Tmp_375: int, in_pIrpStack_3: int, in_Tmp_376: int, in_Tmp_378: int, in_Tmp_379: int, in_srb_2: int, in_status_10: int, in_Tmp_380: int, in_Tmp_381: int, in_retryCount_1: int, in_Tmp_382: int, in_Tmp_383: int, in_Extension_35: int) returns (out_Tmp_369: int, out_Tmp_370: int, out_Tmp_371: int, out_Tmp_372: int, out_Tmp_373: int, out_Tmp_375: int, out_Tmp_376: int, out_Tmp_378: int, out_Tmp_379: int, out_status_10: int, out_Tmp_380: int, out_Tmp_381: int, out_retryCount_1: int, out_Tmp_382: int, out_Tmp_383: int);
  modifies alloc;
...
implementation PpaStartDevice_loop_L26(in_Status_25: int, in_Extension_38: int) returns (out_Status_25: int)
{
  ...
  anon18_Else:
    call {:si_unique_call 679} out_Status_25 := PpaIssueInquiry(in_Extension_38);
    goto anon19_Else;
  ...
  anon19_Else_dummy:
    call {:si_unique_call 680} {:si_old_unique_call 1} out_Status_25 := PpaStartDevice_loop_L26(out_Status_25, in_Extension_38);
    return;
}
...
implementation PpaStartDevice_loop_L20(in_Status_25: int, in_Extension_38: int, in_sdv_205: int) returns (out_Status_25: int, out_sdv_205: int)
{

  entry:
    out_Status_25, out_sdv_205 := in_Status_25, in_sdv_205;
    goto L20, exit;
  ...
  L20:
    call {:si_unique_call 681} PpaPortLock(in_Extension_38, 1, 0);
    assume {:nonnull} in_Extension_38 != 0;
    assume in_Extension_38 > 0;
    goto anon17_Else;

  anon17_Else:
    assume {:partition} Mem_T.Locked__DEVICE_EXTENSION[Locked__DEVICE_EXTENSION(in_Extension_38)] != 0;
    assume {:nonnull} in_Extension_38 != 0;
    assume in_Extension_38 > 0;
    goto L26;

  L26:
    call {:si_unique_call 684} out_Status_25 := PpaStartDevice_loop_L26(out_Status_25, in_Extension_38);
    goto L26_last;
  ...
  anon18_Else:
    call {:si_unique_call 685} out_Status_25 := PpaIssueInquiry(in_Extension_38);
    goto anon19_Then, anon19_Else;
  ...
  L27:
    call {:si_unique_call 683} PpaPortUnlock#1(in_Extension_38, 1, 0);
    goto anon20_Else;

  anon20_Else:
    assume {:partition} out_Status_25 != 0;
    call {:si_unique_call 682} out_sdv_205 := PpaTrySlowerMode(in_Extension_38);
    goto anon21_Then;
  ...
  anon21_Then_dummy:
    call {:si_unique_call 686} {:si_old_unique_call 1} out_Status_25, out_sdv_205 := PpaStartDevice_loop_L20(out_Status_25, in_Extension_38, out_sdv_205);
    return;
...
procedure {:LoopProcedure} PpaStartDevice_loop_L20(in_Status_25: int, in_Extension_38: int, in_sdv_205: int) returns (out_Status_25: int, out_sdv_205: int);
  modifies alloc, sdv_compFset, sdv_invoke_on_success, sdv_invoke_on_error, sdv_invoke_on_cancel, Mem_T.Locked__DEVICE_EXTENSION, Mem_T.Status__IO_STATUS_BLOCK;
  free ensures {:va_keep} out_Status_25 == 0 || out_Status_25 == -1073741823 || out_Status_25 == -1073741670 || out_Status_25 == in_Status_25;
