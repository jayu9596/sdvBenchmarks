...
procedure {:origName "SLIC_sdv_RunIoCompletionRoutines_entry"} {:osmodel} SLIC_sdv_RunIoCompletionRoutines_entry(actual_caller: int, actual_sdv_42: int);
...
implementation {:origName "SLIC_sdv_RunIoCompletionRoutines_entry"} {:osmodel} SLIC_sdv_RunIoCompletionRoutines_entry(actual_caller: int, actual_sdv_42: int)
{
...
procedure {:origName "SLIC_sdv_RunIoCompletionRoutines_exit"} {:osmodel} SLIC_sdv_RunIoCompletionRoutines_exit(actual_caller_3: int, actual_sdv_44: int, actual_sdv_45: int);
  modifies yogi_error;
...
implementation {:origName "SLIC_sdv_RunIoCompletionRoutines_exit"} {:osmodel} SLIC_sdv_RunIoCompletionRoutines_exit(actual_caller_3: int, actual_sdv_44: int, actual_sdv_45: int)
{
  ...
  anon13_Else:
    assume {:partition} sdv_44 != sdv_other_irp;
    goto L9;
  ...
  anon13_Then:
    assume {:partition} sdv_44 == sdv_other_irp;
    call {:si_unique_call 15} SLIC_ABORT_8_0(caller_3, sdv_44, sdv_45);
    goto anon15_Then, anon15_Else;
...
procedure {:origName "SLIC_ABORT_8_0"} SLIC_ABORT_8_0(actual_caller_5: int, actual_sdv_46: int, actual_sdv_47: int);
  modifies yogi_error;
  free ensures {:va_keep} old(SignalState) == 2 ==> yogi_error == 1;
  free ensures {:va_keep} old(SignalState) == 0 ==> yogi_error == 1;
  free ensures {:va_keep} old(completion_state) == 1 ==> yogi_error == 1;
...
implementation {:origName "SLIC_ABORT_8_0"} SLIC_ABORT_8_0(actual_caller_5: int, actual_sdv_46: int, actual_sdv_47: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 18} SLIC_ERROR_ROUTINE(strConst__li2bpl1);
    return;
}
...
implementation {:origName "SLIC_IoAllocateIrp_exit"} {:osmodel} SLIC_IoAllocateIrp_exit(actual_caller_6: int, actual_IoAllocateIrp_1: int)
{
  ...
  anon3_Else:
    ...
    call {:si_unique_call 19} SLIC_EXIT_ROUTINE(strConst__li2bpl0);
    goto L2;
...
implementation {:origName "SLIC_KeSetEvent_entry"} {:osmodel} SLIC_KeSetEvent_entry(actual_caller_7: int)
{
  ...
  anon3_Else:
    assume {:partition} completion_state == 1;
    call {:si_unique_call 20} SLIC_EXIT_ROUTINE(strConst__li2bpl0);
    goto L2;
...
implementation {:origName "_sdv_init9"} _sdv_init9()
{
  ...
  anon0:
    call {:si_unique_call 22} vslice_dummy_var_5 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "sdv_IoReleaseRemoveLock"} sdv_IoReleaseRemoveLock(actual_sdv_59: int, actual_sdv_60: int) returns (Tmp_67: int)
{
  ...
  anon0:
    call {:si_unique_call 23} Tmp_67 := __HAVOC_malloc(4);
    call {:si_unique_call 24} sdv_61 := __HAVOC_malloc(4);
...
implementation {:origName "IoFreeWorkItem"} {:osmodel} IoFreeWorkItem(actual_IoWorkItem: int)
{
  ...
  anon0:
    call {:si_unique_call 25} vslice_dummy_var_6 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "sdv_IoCopyCurrentIrpStackLocationToNext"} {:osmodel} sdv_IoCopyCurrentIrpStackLocationToNext(actual_pirp: int)
{
  ...
  anon0:
    call {:si_unique_call 26} vslice_dummy_var_7 := __HAVOC_malloc(4);
    pirp := actual_pirp;
    goto anon5_Then, anon5_Else;
...
implementation {:origName "KeSetTimer"} {:osmodel} KeSetTimer(actual_Timer: int, actual_structPtr888DueTime: int, actual_Dpc: int) returns (Tmp_75: int)
{
  ...
  anon0:
    call {:si_unique_call 28} DueTime := __HAVOC_malloc(20);
...
implementation {:origName "sdv_IoReleaseRemoveLockAndWait"} {:osmodel} sdv_IoReleaseRemoveLockAndWait(actual_RemoveLock: int, actual_Tag: int)
{
  ...
  anon0:
    call {:si_unique_call 29} vslice_dummy_var_9 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "IoDetachDevice"} {:osmodel} IoDetachDevice(actual_TargetDevice: int)
{
  ...
  anon0:
    call {:si_unique_call 30} vslice_dummy_var_10 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "sdv_SetPowerIrpMinorFunction"} {:osmodel} sdv_SetPowerIrpMinorFunction(actual_pirp_2: int)
{
  ...
  anon0:
    call {:si_unique_call 31} vslice_dummy_var_11 := __HAVOC_malloc(4);
...
implementation {:origName "sdv_stub_dispatch_end"} {:osmodel} sdv_stub_dispatch_end(actual_s: int, actual_pirp_3: int)
{
  ...
  anon0:
    call {:si_unique_call 32} vslice_dummy_var_12 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "sdv_SetStatus"} {:osmodel} sdv_SetStatus(actual_pirp_4: int)
{
  ...
  anon0:
    call {:si_unique_call 33} vslice_dummy_var_13 := __HAVOC_malloc(4);
...
procedure {:nohoudini} {:origName "sdv_main"} {:osmodel} sdv_main();
  modifies alloc, signal_location, completion_state, SLAM_guard_O_0, SignalState, yogi_error;
  free ensures {:va_keep} yogi_error == 1 || yogi_error == old(yogi_error);
  free ensures {:va_keep} completion_state == 1 || completion_state == old(completion_state);
  free ensures {:va_keep} SignalState == 0 || SignalState == old(SignalState);
  free ensures {:va_keep} signal_location == 1 || signal_location == 0 || signal_location == old(signal_location);
...
implementation {:origName "sdv_main"} {:osmodel} sdv_main()
{
  ...
  anon0:
    call {:si_unique_call 34} vslice_dummy_var_14 := __HAVOC_malloc(4);
    call {:si_unique_call 35} sdv_stub_driver_init();
    call {:si_unique_call 36} vslice_dummy_var_15 := sdv_RunDispatchFunction(sdv_p_devobj_fdo, sdv_irp);
    goto anon3_Then, anon3_Else;
...
implementation {:origName "IoAllocateErrorLogEntry"} {:osmodel} IoAllocateErrorLogEntry(actual_IoObject: int, actual_EntrySize: int) returns (Tmp_99: int)
{
  ...
  anon3_Else:
    call {:si_unique_call 37} sdv_70 := __HAVOC_malloc(1);
    Tmp_99 := sdv_70;
    goto L1;
...
implementation {:origName "PoCallDriver"} {:osmodel} PoCallDriver(actual_DeviceObject_3: int, actual_Irp_2: int) returns (Tmp_101: int)
{
  ...
  anon0:
    call {:si_unique_call 38} completion := __HAVOC_malloc(4);
    Irp_2 := actual_Irp_2;
  ...
  anon56_Then:
    ...
    call {:si_unique_call 39} vslice_dummy_var_16 := sdv_RunIoCompletionRoutines#1(sdv_p_devobj_fdo, Irp_2, vslice_dummy_var_2, completion);
  ...
  anon68_Else:
    ...
    call {:si_unique_call 40} vslice_dummy_var_19 := sdv_RunIoCompletionRoutines#1(sdv_p_devobj_fdo, Irp_2, vslice_dummy_var_3, completion);
  ...
  anon60_Else:
    ...
    call {:si_unique_call 41} vslice_dummy_var_17 := sdv_RunIoCompletionRoutines#1(sdv_p_devobj_fdo, Irp_2, vslice_dummy_var_4, completion);
  ...
  anon64_Else:
    ...
    call {:si_unique_call 42} vslice_dummy_var_18 := sdv_RunIoCompletionRoutines#1(sdv_p_devobj_fdo, Irp_2, vslice_dummy_var_5, completion);
...
implementation {:origName "WmiSystemControl"} {:osmodel} WmiSystemControl(actual_WmiLibInfo: int, actual_DeviceObject_4: int, actual_pirp_5: int, actual_IrpDisposition: int) returns (Tmp_103: int)
{
  ...
  anon11_Else:
    ...
    s_1 := 0;
    call {:si_unique_call 43} sdv_stub_WmiIrpForward(0);
    goto L24;
  ...
  anon11_Then:
    assume {:nonnull} IrpDisposition != 0;
    assume IrpDisposition > 0;
    call {:si_unique_call 44} sdv_stub_WmiIrpForward(0);
  ...
  anon12_Then:
    ...
    assume IrpDisposition > 0;
    s_1 := 0;
    call {:si_unique_call 45} sdv_stub_WmiIrpNotCompleted(0);
    goto L24;
  ...
  anon9_Then:
    ...
    assume IrpDisposition > 0;
    s_1 := 0;
    call {:si_unique_call 46} sdv_stub_WmiIrpProcessed(0);
    goto L24;
}
...
implementation {:origName "sdv_KeRaiseIrql"} {:osmodel} sdv_KeRaiseIrql(actual_new: int, actual_p_1: int)
{
  ...
  anon0:
    call {:si_unique_call 50} vslice_dummy_var_20 := __HAVOC_malloc(4);
    new := actual_new;
    p_1 := actual_p_1;
...
implementation {:origName "IoWriteErrorLogEntry"} {:osmodel} IoWriteErrorLogEntry(actual_ElEntry: int)
{
  ...
  anon0:
    call {:si_unique_call 51} vslice_dummy_var_21 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "sdv_IoSetCompletionRoutine"} {:osmodel} sdv_IoSetCompletionRoutine(actual_pirp_6: int, actual_CompletionRoutine: int, actual_Context_5: int, actual_InvokeOnSuccess: int, actual_InvokeOnError: int, actual_InvokeOnCancel: int)
{
  ...
  anon0:
    call {:si_unique_call 52} vslice_dummy_var_22 := __HAVOC_malloc(4);
    ...
    call {:si_unique_call 53} SLIC_sdv_IoSetCompletionRoutine_entry(0, pirp_6);
    call {:si_unique_call 54} irpSp := sdv_IoGetNextIrpStackLocation(pirp_6);
...
implementation {:origName "PoStartNextPowerIrp"} {:osmodel} PoStartNextPowerIrp(actual_Irp_3: int)
{
  ...
  anon0:
    call {:si_unique_call 55} vslice_dummy_var_23 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "IoDeleteDevice"} {:osmodel} IoDeleteDevice(actual_DeviceObject_6: int)
{
  ...
  anon0:
    call {:si_unique_call 56} vslice_dummy_var_24 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "KeSetEvent"} {:osmodel} KeSetEvent(actual_Event: int, actual_Increment: int, actual_Wait: int) returns (Tmp_118: int)
{
  ...
  anon0:
    Event := actual_Event;
    call {:si_unique_call 57} SLIC_KeSetEvent_entry(0);
...
implementation {:origName "main"} {:osmodel} main() returns (Tmp_124: int, dup_assertVar: bool)
{
  ...
  anon0:
    ...
    call {:si_unique_call 59} SerialMousePointerPortGuid__Loc := __HAVOC_malloc_or_null(16);
    assume SerialMousePointerPortGuid__Loc == SerialMousePointerPortGuid;
    assume SerialMousePointerPortGuid != 0;
    call {:si_unique_call 60} SLAM_guard_O_0_init__Loc := __HAVOC_malloc_or_null(156);
    assume SLAM_guard_O_0_init__Loc == SLAM_guard_O_0_init;
    assume SLAM_guard_O_0_init != 0;
    call {:si_unique_call 61} sdv_harnessStackLocation_next__Loc := __HAVOC_malloc_or_null(536);
    assume sdv_harnessStackLocation_next__Loc == sdv_harnessStackLocation_next;
    assume sdv_harnessStackLocation_next != 0;
    call {:si_unique_call 62} sdv_IoReadPartitionTableEx_DRIVE_LAYOUT_INFORMATION_EX__Loc := __HAVOC_malloc_or_null(76);
    assume sdv_IoReadPartitionTableEx_DRIVE_LAYOUT_INFORMATION_EX__Loc == sdv_IoReadPartitionTableEx_DRIVE_LAYOUT_INFORMATION_EX;
    assume sdv_IoReadPartitionTableEx_DRIVE_LAYOUT_INFORMATION_EX != 0;
    call {:si_unique_call 63} sdv_IoBuildAsynchronousFsdRequest_harnessIrp__Loc := __HAVOC_malloc_or_null(240);
    assume sdv_IoBuildAsynchronousFsdRequest_harnessIrp__Loc == sdv_IoBuildAsynchronousFsdRequest_harnessIrp;
    assume sdv_IoBuildAsynchronousFsdRequest_harnessIrp != 0;
    call {:si_unique_call 64} sdv_IoGetDeviceToVerify_DEVICE_OBJECT__Loc := __HAVOC_malloc_or_null(380);
    assume sdv_IoGetDeviceToVerify_DEVICE_OBJECT__Loc == sdv_IoGetDeviceToVerify_DEVICE_OBJECT;
    assume sdv_IoGetDeviceToVerify_DEVICE_OBJECT != 0;
    call {:si_unique_call 65} sdv_IoBuildDeviceIoControlRequest_harnessStackLocation_next__Loc := __HAVOC_malloc_or_null(536);
    assume sdv_IoBuildDeviceIoControlRequest_harnessStackLocation_next__Loc == sdv_IoBuildDeviceIoControlRequest_harnessStackLocation_next;
    assume sdv_IoBuildDeviceIoControlRequest_harnessStackLocation_next != 0;
    call {:si_unique_call 66} sdv_harness_IoBuildSynchronousFsdRequest_IoStatusBlock__Loc := __HAVOC_malloc_or_null(12);
    assume sdv_harness_IoBuildSynchronousFsdRequest_IoStatusBlock__Loc == sdv_harness_IoBuildSynchronousFsdRequest_IoStatusBlock;
    assume sdv_harness_IoBuildSynchronousFsdRequest_IoStatusBlock != 0;
    call {:si_unique_call 67} sdv_ControllerIrp__Loc := __HAVOC_malloc_or_null(240);
    assume sdv_ControllerIrp__Loc == sdv_ControllerIrp;
    assume sdv_ControllerIrp != 0;
    call {:si_unique_call 68} sdv_devobj_pdo__Loc := __HAVOC_malloc_or_null(380);
    assume sdv_devobj_pdo__Loc == sdv_devobj_pdo;
    assume sdv_devobj_pdo != 0;
    call {:si_unique_call 69} sdv_IoGetDmaAdapter_DMA_ADAPTER__Loc := __HAVOC_malloc_or_null(12);
    assume sdv_IoGetDmaAdapter_DMA_ADAPTER__Loc == sdv_IoGetDmaAdapter_DMA_ADAPTER;
    assume sdv_IoGetDmaAdapter_DMA_ADAPTER != 0;
    call {:si_unique_call 70} sdv_IoInitializeIrp_harnessIrp__Loc := __HAVOC_malloc_or_null(240);
    assume sdv_IoInitializeIrp_harnessIrp__Loc == sdv_IoInitializeIrp_harnessIrp;
    assume sdv_IoInitializeIrp_harnessIrp != 0;
    call {:si_unique_call 71} sdv_IoGetRelatedDeviceObject_DEVICE_OBJECT__Loc := __HAVOC_malloc_or_null(380);
    assume sdv_IoGetRelatedDeviceObject_DEVICE_OBJECT__Loc == sdv_IoGetRelatedDeviceObject_DEVICE_OBJECT;
    assume sdv_IoGetRelatedDeviceObject_DEVICE_OBJECT != 0;
    call {:si_unique_call 72} sdv_IoBuildSynchronousFsdRequest_harnessStackLocation_next__Loc := __HAVOC_malloc_or_null(536);
    assume sdv_IoBuildSynchronousFsdRequest_harnessStackLocation_next__Loc == sdv_IoBuildSynchronousFsdRequest_harnessStackLocation_next;
    assume sdv_IoBuildSynchronousFsdRequest_harnessStackLocation_next != 0;
    call {:si_unique_call 73} sdv_IoCreateSynchronizationEvent_KEVENT__Loc := __HAVOC_malloc_or_null(156);
    assume sdv_IoCreateSynchronizationEvent_KEVENT__Loc == sdv_IoCreateSynchronizationEvent_KEVENT;
    assume sdv_IoCreateSynchronizationEvent_KEVENT != 0;
    call {:si_unique_call 74} sdv_harnessStackLocation__Loc := __HAVOC_malloc_or_null(536);
    assume sdv_harnessStackLocation__Loc == sdv_harnessStackLocation;
    assume sdv_harnessStackLocation != 0;
    call {:si_unique_call 75} sdv_other_harnessStackLocation_next__Loc := __HAVOC_malloc_or_null(536);
    assume sdv_other_harnessStackLocation_next__Loc == sdv_other_harnessStackLocation_next;
    assume sdv_other_harnessStackLocation_next != 0;
    call {:si_unique_call 76} sdv_IoCreateController_CONTROLLER_OBJECT__Loc := __HAVOC_malloc_or_null(60);
    assume sdv_IoCreateController_CONTROLLER_OBJECT__Loc == sdv_IoCreateController_CONTROLLER_OBJECT;
    assume sdv_IoCreateController_CONTROLLER_OBJECT != 0;
    call {:si_unique_call 77} sdv_devobj_top__Loc := __HAVOC_malloc_or_null(380);
    assume sdv_devobj_top__Loc == sdv_devobj_top;
    assume sdv_devobj_top != 0;
    call {:si_unique_call 78} sdv_kdpc_val3__Loc := __HAVOC_malloc_or_null(44);
    assume sdv_kdpc_val3__Loc == sdv_kdpc_val3;
    assume sdv_kdpc_val3 != 0;
    call {:si_unique_call 79} sdv_IoBuildSynchronousFsdRequest_harnessIrp__Loc := __HAVOC_malloc_or_null(240);
    assume sdv_IoBuildSynchronousFsdRequest_harnessIrp__Loc == sdv_IoBuildSynchronousFsdRequest_harnessIrp;
    assume sdv_IoBuildSynchronousFsdRequest_harnessIrp != 0;
    call {:si_unique_call 80} sdv_IoGetDeviceObjectPointer_DEVICE_OBJECT__Loc := __HAVOC_malloc_or_null(380);
    ...
    call {:si_unique_call 98} boogieTmp := __HAVOC_malloc_or_null(8);
    call {:si_unique_call 99} boogieTmp := __HAVOC_malloc_or_null(8);
    call {:si_unique_call 100} boogieTmp := __HAVOC_malloc_or_null(4);
    call {:si_unique_call 101} boogieTmp := __HAVOC_malloc_or_null(20);
    call {:si_unique_call 102} boogieTmp := __HAVOC_malloc_or_null(12);
    ...
    call {:si_unique_call 108} boogieTmp := __HAVOC_malloc_or_null(240);
    assume sicrni == boogieTmp;
    call {:si_unique_call 109} boogieTmp := __HAVOC_malloc_or_null(20);
    call {:si_unique_call 110} vslice_dummy_var_6 := __HAVOC_malloc(32);
    call {:si_unique_call 111} vslice_dummy_var_7 := __HAVOC_malloc(72);
    call {:si_unique_call 112} vslice_dummy_var_8 := __HAVOC_malloc(16);
    call {:si_unique_call 113} vslice_dummy_var_9 := __HAVOC_malloc(120);
    call {:si_unique_call 114} vslice_dummy_var_221 := __HAVOC_malloc(12);
    call {:si_unique_call 115} vslice_dummy_var_10 := __HAVOC_malloc(48);
    call {:si_unique_call 116} vslice_dummy_var_222 := __HAVOC_malloc(12);
    assume {:mainInitDone} true;
    call {:si_unique_call 117} corralExtraInit();
    call {:si_unique_call 118} corralExplainErrorInit();
    call {:si_unique_call 119} _sdv_init12();
    call {:si_unique_call 120} _sdv_init1();
    call {:si_unique_call 121} _sdv_init4();
    call {:si_unique_call 122} _sdv_init5();
    call {:si_unique_call 123} _sdv_init3();
    call {:si_unique_call 124} _sdv_init6();
    call {:si_unique_call 125} _sdv_init10();
    call {:si_unique_call 126} _sdv_init9();
    call {:si_unique_call 127} _sdv_init7();
    call {:si_unique_call 128} _sdv_init8();
    call {:si_unique_call 129} _sdv_init2();
    goto anon9_Then, anon9_Else;
  ...
  L39:
    ...
    call {:si_unique_call 130} sdv_main();
    goto anon12_Then, anon12_Else;
...
implementation {:origName "IoInvalidateDeviceState"} {:osmodel} IoInvalidateDeviceState(actual_PhysicalDeviceObject: int)
{
  ...
  anon0:
    call {:si_unique_call 135} vslice_dummy_var_29 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "sdv_KeLowerIrql"} {:osmodel} sdv_KeLowerIrql(actual_NewIrql: int)
{
  ...
  anon0:
    call {:si_unique_call 136} vslice_dummy_var_30 := __HAVOC_malloc(4);
...
implementation {:origName "sdv_stub_WmiIrpNotCompleted"} {:osmodel} sdv_stub_WmiIrpNotCompleted(actual_pirp_9: int)
{
  ...
  anon0:
    call {:si_unique_call 137} vslice_dummy_var_31 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "sdv_RunDispatchFunction"} {:osmodel} sdv_RunDispatchFunction(actual_po: int, actual_pirp_10: int) returns (Tmp_146: int)
{
  ...
  anon0:
    ...
    assume {:nonnull} pirp_10 != 0;
    assume pirp_10 > 0;
    call {:si_unique_call 138} sdv_SetStatus(pirp_10);
    assume {:nonnull} pirp_10 != 0;
    assume pirp_10 > 0;
    assume {:nonnull} pirp_10 != 0;
    assume pirp_10 > 0;
  ...
  L66:
    call {:si_unique_call 140} status_15 := SerialMousePnP(po, pirp_10);
  ...
  L72:
    call {:si_unique_call 141} sdv_stub_dispatch_end(status_15, 0);
    assume {:nonnull} pirp_10 != 0;
    assume pirp_10 > 0;
    Tmp_146 := status_15;
    goto LM2;
  ...
  anon61_Then:
    assume {:nonnull} ps != 0;
    assume ps > 0;
    call {:si_unique_call 143} status_15 := SerialMouseSystemControl(po, pirp_10);
  ...
  anon62_Then:
    assume {:nonnull} ps != 0;
    assume ps > 0;
    call {:si_unique_call 144} sdv_SetPowerIrpMinorFunction(pirp_10);
    call {:si_unique_call 145} status_15 := SerialMousePower(po, pirp_10);
    goto anon78_Then, anon78_Else;
  ...
  anon66_Then:
    assume {:nonnull} ps != 0;
    assume ps > 0;
    call {:si_unique_call 149} status_15 := SerialMouseInternalDeviceControl(po, pirp_10);
    goto L72;
  ...
  anon69_Then:
    assume {:nonnull} ps != 0;
    assume ps > 0;
    call {:si_unique_call 152} status_15 := SerialMouseFlush(po, pirp_10);
    goto anon77_Then, anon77_Else;
  ...
  anon71_Then:
    assume {:nonnull} ps != 0;
    assume ps > 0;
    call {:si_unique_call 154} status_15 := sdv_DoNothing();
    goto L72;
  ...
  anon74_Then:
    assume {:nonnull} ps != 0;
    assume ps > 0;
    call {:si_unique_call 157} status_15 := SerialMouseClose(po, pirp_10);
    goto anon76_Then, anon76_Else;
  ...
  anon55_Then:
    assume {:nonnull} ps != 0;
    assume ps > 0;
    call {:si_unique_call 158} status_15 := SerialMouseCreate(po, pirp_10);
    goto anon75_Then, anon75_Else;
...
implementation {:origName "sdv_KeReleaseSpinLock"} {:osmodel} sdv_KeReleaseSpinLock(actual_SpinLock_1: int, actual_new_1: int)
{
  ...
  anon0:
    call {:si_unique_call 159} vslice_dummy_var_32 := __HAVOC_malloc(4);
    new_1 := actual_new_1;
    return;
}
...
implementation {:origName "IoReuseIrp"} {:osmodel} IoReuseIrp(actual_Irp_5: int, actual_Status: int)
{
  ...
  anon0:
    call {:si_unique_call 160} vslice_dummy_var_33 := __HAVOC_malloc(4);
    Irp_5 := actual_Irp_5;
...
implementation {:origName "sdv_IoCompleteRequest"} {:osmodel} sdv_IoCompleteRequest(actual_pirp_11: int, actual_PriorityBoost: int)
{
  ...
  anon0:
    call {:si_unique_call 161} vslice_dummy_var_34 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "sdv_stub_WmiIrpForward"} {:osmodel} sdv_stub_WmiIrpForward(actual_pirp_12: int)
{
  ...
  anon0:
    call {:si_unique_call 162} vslice_dummy_var_35 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "sdv_ExFreePool"} {:osmodel} sdv_ExFreePool(actual_P: int)
{
  ...
  anon0:
    call {:si_unique_call 163} vslice_dummy_var_36 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "IoAllocateIrp"} {:osmodel} IoAllocateIrp(actual_StackSize: int, actual_ChargeQuota: int) returns (Tmp_171: int)
{
  ...
  anon3_Else:
    assume {:nonnull} sdv_other_irp != 0;
    assume sdv_other_irp > 0;
    call {:si_unique_call 165} irpSp_1 := sdv_IoGetNextIrpStackLocation(sdv_other_irp);
  ...
  L1:
    call {:si_unique_call 166} SLIC_IoAllocateIrp_exit(0, Tmp_171);
    return;
...
implementation {:origName "ExAllocatePoolWithTag"} {:osmodel} ExAllocatePoolWithTag(actual_PoolType: int, actual_NumberOfBytes: int, actual_Tag_2: int) returns (Tmp_189: int)
{
  ...
  anon3_Else:
    call {:si_unique_call 170} sdv_117 := __HAVOC_malloc(NumberOfBytes);
    Tmp_189 := sdv_117;
    goto L1;
...
implementation {:origName "IoAllocateWorkItem"} {:osmodel} IoAllocateWorkItem(actual_DeviceObject_12: int) returns (Tmp_191: int)
{
  ...
  anon0:
    call {:si_unique_call 171} sdv_119 := __HAVOC_malloc(1);
    ioWorkItem := sdv_119;
    goto anon6_Then, anon6_Else;
...
implementation {:origName "sdv_stub_dispatch_begin"} {:osmodel} sdv_stub_dispatch_begin()
{
  ...
  anon0:
    call {:si_unique_call 173} vslice_dummy_var_42 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "KeClearEvent"} {:osmodel} KeClearEvent(actual_Event_4: int)
{
  ...
  anon0:
    call {:si_unique_call 174} vslice_dummy_var_43 := __HAVOC_malloc(4);
...
implementation {:origName "SerialMouseReadSerialPortComplete"} SerialMouseReadSerialPortComplete(actual_DeviceObject_15: int, actual_Irp_9: int, actual_Context_7: int) returns (Tmp_212: int)
{
  ...
  anon0:
    ...
    Event_5 := Context_7;
    call {:si_unique_call 175} vslice_dummy_var_44 := KeSetEvent(Event_5, 0, 0);
    Tmp_212 := -1073741802;
    return;
}
...
implementation {:origName "_sdv_init6"} _sdv_init6()
{
  ...
  anon0:
    call {:si_unique_call 176} vslice_dummy_var_45 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "SerialMouseWait"} SerialMouseWait(actual_DeviceExtension_20: int, actual_Timeout_1: int) returns (Tmp_232: int)
{
  ...
  anon0:
    call {:si_unique_call 177} time := __HAVOC_malloc(20);
    Timeout_1 := actual_Timeout_1;
    assume {:nonnull} time != 0;
    assume time > 0;
    call {:si_unique_call 178} vslice_dummy_var_46 := KeSetTimer(0, time, 0);
    call {:si_unique_call 179} Tmp_232 := KeWaitForSingleObject(0, 0, 0, 0, 0);
    return;
}
...
implementation {:origName "_sdv_init3"} _sdv_init3()
{
  ...
  anon0:
    call {:si_unique_call 180} vslice_dummy_var_47 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "_sdv_init5"} _sdv_init5()
{
  ...
  anon0:
    call {:si_unique_call 181} vslice_dummy_var_48 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "SerialMouseServiceParameters"} SerialMouseServiceParameters(actual_DeviceExtension_28: int, actual_Handle_1: int)
{
  ...
  anon0:
    call {:si_unique_call 182} prevNumberOfButtons := __HAVOC_malloc(4);
    call {:si_unique_call 183} sampleRate := __HAVOC_malloc(4);
    call {:si_unique_call 184} prevSampleRate := __HAVOC_malloc(4);
    call {:si_unique_call 185} defaultWaitEventMask := __HAVOC_malloc(4);
    call {:si_unique_call 186} defaultNumberOfButtons := __HAVOC_malloc(4);
    call {:si_unique_call 187} numberOfButtons := __HAVOC_malloc(4);
    call {:si_unique_call 188} vslice_dummy_var_49 := __HAVOC_malloc(4);
    call {:si_unique_call 189} defaultSampleRate := __HAVOC_malloc(4);
    call {:si_unique_call 190} parametersPath := __HAVOC_malloc(12);
    DeviceExtension_28 := actual_DeviceExtension_28;
    Handle_1 := actual_Handle_1;
    call {:si_unique_call 191} vslice_dummy_var_52 := __HAVOC_malloc(44);
    parameters := 0;
    status_29 := 0;
    ...
    call {:si_unique_call 193} RtlInitUnicodeString(parametersPath, 0);
    Tmp_302 := 28 * queriesPlusOne;
    call {:si_unique_call 194} sdv_187 := ExAllocatePoolWithTag(1, Tmp_302, -228232371);
    parameters := sdv_187;
  ...
  anon27_Else:
    ...
    call {:si_unique_call 195} sdv_RtlZeroMemory(0, Tmp_291);
    assume {:nonnull} DeviceExtension_28 != 0;
    assume DeviceExtension_28 > 0;
    call {:si_unique_call 196} sdv_190 := IoGetDriverObjectExtension(0, 0);
    regPath := sdv_190;
  ...
  anon23_Else:
    ...
    assume {:nonnull} parameters != 0;
    assume parameters > 0;
    call {:si_unique_call 197} status_29 := sdv_RtlQueryRegistryValues(-1073741824, 0, 0, 0, 0);
    goto L74;
  ...
  anon30_Else:
    call {:si_unique_call 198} sdv_ExFreePool(0);
    goto L107;
  ...
  anon21_Then:
    ...
    assume parametersPath > 0;
    havoc Tmp_301;
    call {:si_unique_call 200} sdv_192 := ExAllocatePoolWithTag(1, Tmp_301, -228232371);
    assume {:nonnull} parametersPath != 0;
    assume parametersPath > 0;
    assume {:nonnull} parametersPath != 0;
    assume parametersPath > 0;
  ...
  anon29_Else:
    ...
    assume parametersPath > 0;
    havoc Tmp_294;
    call {:si_unique_call 201} sdv_RtlZeroMemory(0, Tmp_294);
    call {:si_unique_call 202} vslice_dummy_var_50 := corral_nondet();
    call {:si_unique_call 203} vslice_dummy_var_51 := corral_nondet();
    assume {:nonnull} parametersPath != 0;
    assume parametersPath > 0;
  ...
  anon22_Then:
    ...
    assume {:nonnull} parameters != 0;
    assume parameters > 0;
    call {:si_unique_call 204} status_29 := sdv_RtlQueryRegistryValues(0, 0, 0, 0, 0);
...
implementation {:origName "SerialMouseCreate"} SerialMouseCreate(actual_DeviceObject_19: int, actual_Irp_13: int) returns (Tmp_316: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 206} irpSp_2 := sdv_IoGetCurrentIrpStackLocation(Irp_13);
  ...
  L23:
    ...
    assume {:nonnull} Irp_13 != 0;
    assume Irp_13 > 0;
    call {:si_unique_call 207} sdv_IoCompleteRequest(0, 0);
    Tmp_316 := status_33;
    goto LM2;
  ...
  anon22_Then:
    call {:si_unique_call 208} status_33 := sdv_IoAcquireRemoveLock(0, 0);
    goto anon17_Then, anon17_Else;
  ...
  anon18_Else:
    call {:si_unique_call 209} Tmp_317 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_317 != 0;
    assume Tmp_317 > 0;
    assume {:nonnull} deviceExtension_3 != 0;
    assume deviceExtension_3 > 0;
    call {:si_unique_call 210} sdv_210 := sdv_InterlockedIncrement(Tmp_317);
    assume {:nonnull} Tmp_317 != 0;
    assume Tmp_317 > 0;
    assume {:nonnull} deviceExtension_3 != 0;
    assume deviceExtension_3 > 0;
  ...
  anon19_Else:
    ...
    call {:si_unique_call 211} status_33 := SerialMouseSendIrpSynchronously#1(vslice_dummy_var_11, Irp_13, 1);
    goto anon23_Then, anon23_Else;
  ...
  anon21_Else:
    call {:si_unique_call 212} status_33 := SerialMouseStartDevice#1(deviceExtension_3, Irp_13, 1);
    goto anon24_Then, anon24_Else;
  ...
  L52:
    assume {:nonnull} deviceExtension_3 != 0;
    assume deviceExtension_3 > 0;
    call {:si_unique_call 213} vslice_dummy_var_53 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(deviceExtension_3), Irp_13);
    goto L23;
  ...
  L44:
    call {:si_unique_call 214} Tmp_317 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_317 != 0;
    assume Tmp_317 > 0;
    assume {:nonnull} deviceExtension_3 != 0;
    assume deviceExtension_3 > 0;
    call {:si_unique_call 215} vslice_dummy_var_54 := sdv_InterlockedDecrement(Tmp_317);
    assume {:nonnull} Tmp_317 != 0;
    assume Tmp_317 > 0;
    assume {:nonnull} deviceExtension_3 != 0;
    assume deviceExtension_3 > 0;
...
implementation {:origName "SerialMouseInternalDeviceControl"} SerialMouseInternalDeviceControl(actual_DeviceObject_20: int, actual_Irp_14: int) returns (Tmp_319: int)
{
  ...
  anon0:
    ...
    assume Irp_14 > 0;
    call {:si_unique_call 216} irpSp_3 := sdv_IoGetCurrentIrpStackLocation(Irp_14);
    call {:si_unique_call 217} status_34 := sdv_IoAcquireRemoveLock(0, 0);
    goto anon19_Then, anon19_Else;
  ...
  L26:
    ...
    call {:si_unique_call 219} vslice_dummy_var_55 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(deviceExtension_4), Irp_14);
    Tmp_319 := status_34;
    goto L1;
  ...
  anon19_Then:
    ...
    assume {:nonnull} Irp_14 != 0;
    assume Irp_14 > 0;
    call {:si_unique_call 220} sdv_IoCompleteRequest(0, 0);
    Tmp_319 := status_34;
    goto L1;
}
...
implementation {:origName "_sdv_init4"} _sdv_init4()
{
  ...
  anon0:
    call {:si_unique_call 221} vslice_dummy_var_56 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "SerialMouseFlush"} SerialMouseFlush(actual_DeviceObject_21: int, actual_Irp_15: int) returns (Tmp_325: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 222} status_35 := sdv_IoAcquireRemoveLock(0, 0);
    goto anon5_Then, anon5_Else;

  anon5_Else:
    assume {:partition} status_35 >= 0;
    call {:si_unique_call 223} sdv_IoSkipCurrentIrpStackLocation(Irp_15);
    assume {:nonnull} deviceExtension_5 != 0;
    assume deviceExtension_5 > 0;
    havoc vslice_dummy_var_12;
    call {:si_unique_call 224} status_35 := sdv_IoCallDriver#1(vslice_dummy_var_12, Irp_15);
    goto anon6_Then, anon6_Else;
  ...
  anon6_Else:
    ...
    assume {:nonnull} deviceExtension_5 != 0;
    assume deviceExtension_5 > 0;
    call {:si_unique_call 225} vslice_dummy_var_57 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(deviceExtension_5), Irp_15);
    Tmp_325 := status_35;
    goto L1;
...
implementation {:origName "SerialMouseClose"} SerialMouseClose(actual_DeviceObject_22: int, actual_Irp_16: int) returns (Tmp_327: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 226} sdv_do_paged_code_check();
    assume {:nonnull} DeviceObject_22 != 0;
    assume DeviceObject_22 > 0;
    havoc deviceExtension_6;
    call {:si_unique_call 227} status_36 := sdv_IoAcquireRemoveLock(0, 0);
    goto anon9_Then, anon9_Else;
  ...
  L26:
    ...
    assume {:nonnull} Irp_16 != 0;
    assume Irp_16 > 0;
    call {:si_unique_call 228} sdv_IoCompleteRequest(0, 0);
    Tmp_327 := status_36;
    goto L1;
  ...
  anon9_Then:
    ...
    call {:si_unique_call 229} Tmp_328 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_328 != 0;
    assume Tmp_328 > 0;
    assume {:nonnull} deviceExtension_6 != 0;
    assume deviceExtension_6 > 0;
    call {:si_unique_call 230} sdv_218 := sdv_InterlockedDecrement(Tmp_328);
    assume {:nonnull} Tmp_328 != 0;
    assume Tmp_328 > 0;
    assume {:nonnull} deviceExtension_6 != 0;
    assume deviceExtension_6 > 0;
  ...
  anon10_Else:
    ...
    assume {:nonnull} deviceExtension_6 != 0;
    assume deviceExtension_6 > 0;
    call {:si_unique_call 231} vslice_dummy_var_60 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(deviceExtension_6), Irp_16);
    goto L26;

  anon10_Then:
    assume {:partition} sdv_218 == 0;
    call {:si_unique_call 232} vslice_dummy_var_58 := IoCancelIrp(0);
    call {:si_unique_call 233} SerialMouseStopDetection(deviceExtension_6);
    call {:si_unique_call 234} SerialMouseRestorePort#1(deviceExtension_6);
    goto anon11_Then, anon11_Else;
  ...
  anon11_Else:
    ...
    assume {:nonnull} deviceExtension_6 != 0;
    assume deviceExtension_6 > 0;
    call {:si_unique_call 235} vslice_dummy_var_59 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(deviceExtension_6), Irp_16);
    call {:si_unique_call 236} sdv_IoSkipCurrentIrpStackLocation(Irp_16);
    assume {:nonnull} deviceExtension_6 != 0;
    assume deviceExtension_6 > 0;
    havoc vslice_dummy_var_13;
    call {:si_unique_call 237} Tmp_327 := sdv_IoCallDriver#1(vslice_dummy_var_13, Irp_16);
    goto anon12_Then, anon12_Else;
...
implementation {:origName "_sdv_init1"} _sdv_init1()
{
  ...
  anon0:
    call {:si_unique_call 238} vslice_dummy_var_61 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "SerialMouseCompletionRoutine"} SerialMouseCompletionRoutine(actual_DeviceObject_24: int, actual_Irp_18: int, actual_Context_9: int) returns (Tmp_333: int)
{
  ...
  anon0:
    ...
    Event_8 := Context_9;
    call {:si_unique_call 239} vslice_dummy_var_62 := KeSetEvent(Event_8, 0, 0);
    Tmp_333 := -1073741802;
    return;
}
...
implementation {:origName "SerialMouseRemoveDevice"} SerialMouseRemoveDevice(actual_DeviceExtension_33: int, actual_Irp_19: int)
{
  ...
  anon0:
    call {:si_unique_call 240} vslice_dummy_var_63 := __HAVOC_malloc(4);
  ...
  anon15_Else:
    assume {:nonnull} DeviceExtension_33 != 0;
    assume DeviceExtension_33 > 0;
    call {:si_unique_call 242} SerialMouseClosePort#1(DeviceExtension_33, Irp_19);
    goto anon18_Then, anon18_Else;
  ...
  anon13_Then:
    assume {:nonnull} DeviceExtension_33 != 0;
    assume DeviceExtension_33 > 0;
    call {:si_unique_call 243} vslice_dummy_var_65 := IoWMIRegistrationControl(0, 2);
    assume {:nonnull} DeviceExtension_33 != 0;
    assume DeviceExtension_33 > 0;
    goto anon16_Then, anon16_Else;
  ...
  anon17_Else:
    call {:si_unique_call 244} vslice_dummy_var_64 := IoCancelIrp(0);
    call {:si_unique_call 245} SerialMouseStopDetection(DeviceExtension_33);
    goto L8;
...
implementation {:origName "SerialMouseStopDevice"} SerialMouseStopDevice(actual_DeviceExtension_34: int)
{
  ...
  anon0:
    call {:si_unique_call 246} vslice_dummy_var_66 := __HAVOC_malloc(4);
    DeviceExtension_34 := actual_DeviceExtension_34;
    call {:si_unique_call 247} Tmp_341 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_341 != 0;
    assume Tmp_341 > 0;
    call {:si_unique_call 248} sdv_KeAcquireSpinLock(0, Tmp_341);
    assume {:nonnull} Tmp_341 != 0;
    assume Tmp_341 > 0;
    havoc irql_1;
    assume {:nonnull} DeviceExtension_34 != 0;
    assume DeviceExtension_34 > 0;
    call {:si_unique_call 249} sdv_KeReleaseSpinLock(0, irql_1);
    assume {:nonnull} DeviceExtension_34 != 0;
    assume DeviceExtension_34 > 0;
    goto anon5_Then, anon5_Else;
  ...
  anon5_Else:
    assume {:nonnull} DeviceExtension_34 != 0;
    assume DeviceExtension_34 > 0;
    call {:si_unique_call 250} SerialMouseStopDetection(DeviceExtension_34);
    call {:si_unique_call 251} sdv_229 := IoCancelIrp(0);
    goto anon6_Then, anon6_Else;

  anon6_Else:
    assume {:partition} sdv_229 == 0;
    call {:si_unique_call 252} vslice_dummy_var_67 := KeWaitForSingleObject(0, 0, 0, 0, 0);
    goto L1;
...
implementation {:origName "SerialMousePnP"} SerialMousePnP(actual_DeviceObject_26: int, actual_Irp_20: int) returns (Tmp_342: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 253} Tmp_344 := __HAVOC_malloc(28);
    call {:si_unique_call 254} Tmp_346 := __HAVOC_malloc(28);
    skipIt := 0;
    ...
    call {:si_unique_call 256} stack_2 := sdv_IoGetCurrentIrpStackLocation(Irp_20);
    call {:si_unique_call 257} status_39 := sdv_IoAcquireRemoveLock(0, 0);
  ...
  anon114_Else:
    call {:si_unique_call 258} SerialMouseRemoveDevice(deviceExtension_8, Irp_20);
  ...
  anon99_Else:
    ...
    call {:si_unique_call 259} sdv_IoSkipCurrentIrpStackLocation(Irp_20);
    assume {:nonnull} deviceExtension_8 != 0;
    assume deviceExtension_8 > 0;
    havoc vslice_dummy_var_14;
    call {:si_unique_call 260} status_39 := sdv_IoCallDriver#1(vslice_dummy_var_14, Irp_20);
  ...
  L45:
    assume {:nonnull} deviceExtension_8 != 0;
    assume deviceExtension_8 > 0;
    call {:si_unique_call 261} vslice_dummy_var_68 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(deviceExtension_8), Irp_20);
    Tmp_342 := status_39;
    goto L1;
  ...
  anon115_Then:
    ...
    call {:si_unique_call 262} status_39 := SerialMouseSendIrpSynchronously#1(vslice_dummy_var_15, Irp_20, 1);
  ...
  anon123_Then:
    ...
    call {:si_unique_call 264} status_39 := SerialMouseSendIrpSynchronously#1(vslice_dummy_var_16, Irp_20, 1);
  ...
  L88:
    call {:si_unique_call 265} i_4, Tmp_344, Tmp_345 := SerialMousePnP_loop_L88(i_4, devCaps, Tmp_344, Tmp_345);
    goto L88_last;
  ...
  anon128_Then:
    call {:si_unique_call 267} SerialMouseStopDevice(deviceExtension_8);
    skipIt := 1;
    assume {:nonnull} Irp_20 != 0;
    assume Irp_20 > 0;
    goto L44;
  ...
  anon130_Then:
    assume {:nonnull} deviceExtension_8 != 0;
    assume deviceExtension_8 > 0;
    call {:si_unique_call 268} SerialMouseRemoveDevice(deviceExtension_8, Irp_20);
  ...
  anon138_Else:
    ...
    assume {:nonnull} Irp_20 != 0;
    assume Irp_20 > 0;
    call {:si_unique_call 269} sdv_IoSkipCurrentIrpStackLocation(Irp_20);
    assume {:nonnull} deviceExtension_8 != 0;
    assume deviceExtension_8 > 0;
    havoc vslice_dummy_var_17;
    call {:si_unique_call 270} status_39 := sdv_IoCallDriver#1(vslice_dummy_var_17, Irp_20);
    goto anon139_Then, anon139_Else;

  anon139_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 271} sdv_IoReleaseRemoveLockAndWait(0, 0);
  ...
  anon140_Else:
    call {:si_unique_call 273} IoFreeIrp(0);
    assume {:nonnull} deviceExtension_8 != 0;
    assume deviceExtension_8 > 0;
    goto L114;

  L114:
    call {:si_unique_call 274} IoDetachDevice(0);
    call {:si_unique_call 275} IoDeleteDevice(0);
    Tmp_342 := status_39;
    goto L1;
  ...
  anon98_Then:
    ...
    call {:si_unique_call 276} status_39 := SerialMouseSendIrpSynchronously#1(vslice_dummy_var_18, Irp_20, 1);
  ...
  anon108_Else:
    call {:si_unique_call 277} Tmp_343 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_343 != 0;
    assume Tmp_343 > 0;
    assume {:nonnull} deviceExtension_8 != 0;
    assume deviceExtension_8 > 0;
    call {:si_unique_call 278} sdv_236 := sdv_InterlockedIncrement(Tmp_343);
    assume {:nonnull} Tmp_343 != 0;
    assume Tmp_343 > 0;
    assume {:nonnull} deviceExtension_8 != 0;
    assume deviceExtension_8 > 0;
  ...
  anon109_Else:
    ...
    call {:si_unique_call 279} nextStack := sdv_IoGetNextIrpStackLocation(Irp_20);
    call {:si_unique_call 280} sdv_RtlZeroMemory(0, 36);
    assume {:nonnull} nextStack != 0;
    assume nextStack > 0;
    assume {:nonnull} deviceExtension_8 != 0;
    assume deviceExtension_8 > 0;
    havoc vslice_dummy_var_19;
    call {:si_unique_call 281} status_39 := SerialMouseSendIrpSynchronously#1(vslice_dummy_var_19, Irp_20, 0);
  ...
  L134:
    call {:si_unique_call 282} status_39 := IoOpenDeviceRegistryKey(0, 1, 131072, 0);
    goto anon112_Then, anon112_Else;

  anon112_Else:
    assume {:partition} status_39 >= 0;
    call {:si_unique_call 283} SerialMouseServiceParameters(deviceExtension_8, keyHandle);
    call {:si_unique_call 284} vslice_dummy_var_69 := ZwClose(0);
    goto L160;

  L160:
    call {:si_unique_call 285} SerialMouseHandleStartStopStart(deviceExtension_8);
    call {:si_unique_call 286} status_39 := SerialMouseInitializeDevice#1(deviceExtension_8);
    goto anon134_Then, anon134_Else;

  anon134_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 287} Tmp_343 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_343 != 0;
    assume Tmp_343 > 0;
    assume {:nonnull} deviceExtension_8 != 0;
    assume deviceExtension_8 > 0;
    call {:si_unique_call 288} sdv_242 := sdv_InterlockedDecrement(Tmp_343);
    assume {:nonnull} Tmp_343 != 0;
    assume Tmp_343 > 0;
    assume {:nonnull} deviceExtension_8 != 0;
    assume deviceExtension_8 > 0;
  ...
  anon113_Else:
    ...
    call {:si_unique_call 289} status_39 := SerialMouseSpinUpRead#1(deviceExtension_8);
  ...
  anon113_Then:
    assume {:partition} sdv_242 == 0;
    call {:si_unique_call 291} SerialMouseClosePort#1(deviceExtension_8, Irp_20);
  ...
  anon97_Then:
    ...
    assume {:nonnull} Irp_20 != 0;
    assume Irp_20 > 0;
    call {:si_unique_call 292} sdv_IoCompleteRequest(0, 0);
    Tmp_342 := status_39;
    goto L1;
}
...
implementation {:origName "SerialMousePower"} SerialMousePower(actual_DeviceObject_27: int, actual_Irp_21: int) returns (Tmp_347: int)
{
  ...
  anon0:
    call {:si_unique_call 293} powerState := __HAVOC_malloc(8);
    call {:si_unique_call 294} li := __HAVOC_malloc(20);
    call {:si_unique_call 295} sdv_1 := __HAVOC_malloc(8);
    call {:si_unique_call 296} iosb_16 := __HAVOC_malloc(12);
    call {:si_unique_call 297} event_17 := __HAVOC_malloc(156);
    call {:si_unique_call 298} sdv := __HAVOC_malloc(8);
    ...
    assume DeviceObject_27 > 0;
    havoc deviceExtension_9;
    call {:si_unique_call 300} stack_3 := sdv_IoGetCurrentIrpStackLocation(Irp_21);
    ...
    assume {:nonnull} stack_3 != 0;
    assume stack_3 > 0;
    call {:si_unique_call 301} status_40 := sdv_IoAcquireRemoveLock(0, 0);
  ...
  anon64_Else:
    ...
    assume {:nonnull} stack_3 != 0;
    assume stack_3 > 0;
    call {:si_unique_call 302} vslice_dummy_var_76 := IoCancelIrp(0);
    call {:si_unique_call 303} SerialMouseStopDetection(deviceExtension_9);
    call {:si_unique_call 304} KeInitializeEvent(event_17, 0, 0);
    assume {:nonnull} deviceExtension_9 != 0;
    assume deviceExtension_9 > 0;
    havoc vslice_dummy_var_20;
    call {:si_unique_call 305} status_40 := SerialMousepIoSyncIoctl#1(0, 1769524, vslice_dummy_var_20, event_17, iosb_16);
    goto anon65_Then, anon65_Else;
  ...
  anon50_Else:
    ...
    assume {:nonnull} li != 0;
    assume li > 0;
    call {:si_unique_call 306} vslice_dummy_var_77 := KeDelayExecutionThread(0, 0, 0);
    goto L62;
  ...
  L62:
    ...
    call {:si_unique_call 307} SD1 := PoSetPowerState(0, vslice_dummy_var_21, vslice_dummy_var_22);
    ...
    assume {:nonnull} deviceExtension_9 != 0;
    assume deviceExtension_9 > 0;
    call {:si_unique_call 308} vslice_dummy_var_70 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(deviceExtension_9), Irp_21);
    assume {:nonnull} Irp_21 != 0;
    assume Irp_21 > 0;
    call {:si_unique_call 309} sdv_IoCopyCurrentIrpStackLocationToNext(Irp_21);
    call {:si_unique_call 310} PoStartNextPowerIrp(0);
    call {:si_unique_call 311} Tmp_347 := PoCallDriver(0, Irp_21);
    goto anon66_Then, anon66_Else;
  ...
  L32:
    call {:si_unique_call 312} PoStartNextPowerIrp(0);
    call {:si_unique_call 313} sdv_IoSkipCurrentIrpStackLocation(Irp_21);
    call {:si_unique_call 314} status_40 := PoCallDriver(0, Irp_21);
    goto anon60_Then, anon60_Else;
  ...
  anon60_Else:
    ...
    assume {:nonnull} deviceExtension_9 != 0;
    assume deviceExtension_9 > 0;
    call {:si_unique_call 315} vslice_dummy_var_74 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(deviceExtension_9), Irp_21);
    Tmp_347 := status_40;
    goto L1;
  ...
  anon49_Then:
    call {:si_unique_call 316} KeInitializeEvent(event_17, 1, 0);
    assume {:nonnull} deviceExtension_9 != 0;
    assume deviceExtension_9 > 0;
    assume {:nonnull} deviceExtension_9 != 0;
    assume deviceExtension_9 > 0;
    assume {:nonnull} stack_3 != 0;
    assume stack_3 > 0;
    call {:si_unique_call 317} sdv_IoCopyCurrentIrpStackLocationToNext(Irp_21);
    call {:si_unique_call 318} sdv_IoSetCompletionRoutine(Irp_21, li2bplFunctionConstant188, event_17, 1, 1, 1);
    call {:si_unique_call 319} status_40 := PoCallDriver(0, Irp_21);
    goto anon61_Then, anon61_Else;
  ...
  anon51_Else:
    ...
    call {:si_unique_call 320} vslice_dummy_var_71 := KeWaitForSingleObject(0, 0, 0, 0, 0);
    assume {:nonnull} Irp_21 != 0;
    assume Irp_21 > 0;
    havoc status_40;
    goto L96;
  ...
  anon53_Else:
    call {:si_unique_call 321} structPtr888sdv := PoSetPowerState(0, powerType, powerState);
    ...
    assume {:nonnull} structPtr888sdv != 0;
    assume structPtr888sdv > 0;
    call {:si_unique_call 322} sdv_253 := sdv_IoAcquireRemoveLock(0, 0);
    goto anon54_Then, anon54_Else;

  anon54_Else:
    assume {:partition} sdv_253 >= 0;
    call {:si_unique_call 323} workItem := IoAllocateWorkItem(0);
    goto anon55_Then, anon55_Else;

  anon55_Else:
    assume {:partition} workItem != 0;
    call {:si_unique_call 324} sdv_247 := ExAllocatePoolWithTag(512, 8, -228232371);
  ...
  anon62_Else:
    ...
    assume {:nonnull} workItemContext != 0;
    assume workItemContext > 0;
    call {:si_unique_call 325} IoQueueWorkItem#1(workItem, li2bplFunctionConstant193, 1, workItemContext);
    goto anon63_Then, anon63_Else;
  ...
  L101:
    ...
    assume {:nonnull} deviceExtension_9 != 0;
    assume deviceExtension_9 > 0;
    call {:si_unique_call 326} vslice_dummy_var_75 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(deviceExtension_9), Irp_21);
    call {:si_unique_call 327} PoStartNextPowerIrp(0);
    call {:si_unique_call 328} sdv_IoCompleteRequest(0, 0);
    Tmp_347 := status_40;
    goto L1;
  ...
  anon62_Then:
    assume {:partition} workItemContext == 0;
    call {:si_unique_call 329} IoFreeWorkItem(0);
    assume {:nonnull} deviceExtension_9 != 0;
    assume deviceExtension_9 > 0;
    call {:si_unique_call 330} vslice_dummy_var_73 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(deviceExtension_9), deviceExtension_9);
    goto L101;
  ...
  anon55_Then:
    ...
    assume {:nonnull} deviceExtension_9 != 0;
    assume deviceExtension_9 > 0;
    call {:si_unique_call 331} vslice_dummy_var_72 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(deviceExtension_9), deviceExtension_9);
    goto L101;
  ...
  anon45_Then:
    assume {:partition} 0 > status_40;
    call {:si_unique_call 332} PoStartNextPowerIrp(0);
    assume {:nonnull} Irp_21 != 0;
    assume Irp_21 > 0;
...
implementation {:origName "SerialMouseHandleStartStopStart"} SerialMouseHandleStartStopStart(actual_DeviceExtension_35: int)
{
  ...
  anon0:
    call {:si_unique_call 334} vslice_dummy_var_78 := __HAVOC_malloc(4);
    DeviceExtension_35 := actual_DeviceExtension_35;
    call {:si_unique_call 335} Tmp_349 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_349 != 0;
    assume Tmp_349 > 0;
    call {:si_unique_call 336} sdv_KeAcquireSpinLock(0, Tmp_349);
    assume {:nonnull} Tmp_349 != 0;
    assume Tmp_349 > 0;
    havoc irql_2;
  ...
  anon3_Else:
    ...
    call {:si_unique_call 337} IoReuseIrp(vslice_dummy_var_23, 0);
    goto L8;

  L8:
    call {:si_unique_call 338} sdv_KeReleaseSpinLock(0, irql_2);
    return;
...
const {:string "KeSetEvent needs to be called in the completion routine when Irp->PendingReturned is TRUE and processing a locally created async. irp."} unique strConst__li2bpl1: int;
...
implementation {:origName "CSerPowerUp"} CSerPowerUp#0(actual_DeviceExtension: int) returns (Tmp_3: int)
{
  ...
  anon0:
    call {:si_unique_call 339} bits := __HAVOC_malloc(4);
    call {:si_unique_call 340} iosb := __HAVOC_malloc(12);
    call {:si_unique_call 341} event := __HAVOC_malloc(156);
    ...
    call {:si_unique_call 343} SLIC_KeInitializeEvent_entry(0, 0);
    call {:si_unique_call 344} KeInitializeEvent(event, 0, 0);
    assume {:nonnull} DeviceExtension != 0;
    assume DeviceExtension > 0;
    havoc vslice_dummy_var_24;
    call {:si_unique_call 345} status := SerialMousepIoSyncIoctl#0(0, 1769508, vslice_dummy_var_24, event, iosb);
    goto anon12_Then, anon12_Else;
  ...
  anon12_Else:
    ...
    call {:si_unique_call 346} status := SerialMousepIoSyncIoctl#0(0, 1769520, vslice_dummy_var_25, event, iosb);
    goto anon13_Then, anon13_Else;
  ...
  anon13_Else:
    ...
    call {:si_unique_call 347} status := SerialMousepIoSyncIoctlEx#0(0, 1769576, vslice_dummy_var_26, event, iosb, 0, 0, bits, 4);
    goto anon14_Then, anon14_Else;
  ...
  anon15_Else:
    ...
    call {:si_unique_call 348} vslice_dummy_var_79 := SerialMouseWait(DeviceExtension, -5000000);
    goto L29;
...
implementation {:origName "CSerPowerUp"} CSerPowerUp#1(actual_DeviceExtension: int) returns (Tmp_3: int)
{
  ...
  anon0:
    call {:si_unique_call 349} bits := __HAVOC_malloc(4);
    call {:si_unique_call 350} iosb := __HAVOC_malloc(12);
    call {:si_unique_call 351} event := __HAVOC_malloc(156);
    DeviceExtension := actual_DeviceExtension;
    status := 0;
    rtsDtr := 3;
    ...
    SLAM_guard_O_0 := event;
    assume SLAM_guard_O_0 != SLAM_guard_O_0_init;
    call {:si_unique_call 353} SLIC_KeInitializeEvent_entry(0, 0);
    call {:si_unique_call 354} KeInitializeEvent(event, 0, 0);
    assume {:nonnull} DeviceExtension != 0;
    assume DeviceExtension > 0;
    havoc vslice_dummy_var_27;
    call {:si_unique_call 355} status := SerialMousepIoSyncIoctl#1(0, 1769508, vslice_dummy_var_27, event, iosb);
    goto anon12_Then, anon12_Else;
  ...
  anon12_Else:
    ...
    call {:si_unique_call 356} status := SerialMousepIoSyncIoctl#1(0, 1769520, vslice_dummy_var_28, event, iosb);
    goto anon13_Then, anon13_Else;
  ...
  anon13_Else:
    ...
    call {:si_unique_call 357} status := SerialMousepIoSyncIoctlEx#1(0, 1769576, vslice_dummy_var_29, event, iosb, 0, 0, bits, 4);
    goto anon14_Then, anon14_Else;
  ...
  anon15_Else:
    assume {:partition} Tmp_4 == rtsDtr;
    call {:si_unique_call 358} vslice_dummy_var_80 := SerialMouseWait(DeviceExtension, -5000000);
    goto L29;
...
implementation {:origName "SerialMousepIoSyncIoctl"} SerialMousepIoSyncIoctl#0(actual_Internal: int, actual_Ioctl: int, actual_DeviceObject_16: int, actual_Event_6: int, actual_Iosb: int) returns (Tmp_218: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 360} Tmp_218 := SerialMousepIoSyncIoctlEx#0(Internal, Ioctl, DeviceObject_16, Event_6, Iosb, 0, 0, 0, 0);
    goto anon3_Then, anon3_Else;
...
implementation {:origName "SerialMousepIoSyncIoctl"} SerialMousepIoSyncIoctl#1(actual_Internal: int, actual_Ioctl: int, actual_DeviceObject_16: int, actual_Event_6: int, actual_Iosb: int) returns (Tmp_218: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 362} Tmp_218 := SerialMousepIoSyncIoctlEx#1(Internal, Ioctl, DeviceObject_16, Event_6, Iosb, 0, 0, 0, 0);
    goto anon3_Then, anon3_Else;
...
implementation {:origName "SerialMousepIoSyncIoctlEx"} SerialMousepIoSyncIoctlEx#0(actual_Internal_1: int, actual_Ioctl_1: int, actual_DeviceObject_17: int, actual_Event_7: int, actual_Iosb_1: int, actual_InBuffer: int, actual_InBufferLen: int, actual_OutBuffer: int, actual_OutBufferLen: int) returns (Tmp_222: int)
{
  ...
  anon11_Else:
    ...
    assume SLAM_guard_O_0 != SLAM_guard_O_0_init;
    call {:si_unique_call 365} SLIC_IoBuildDeviceIoControlRequest_entry(strConst__li2bpl3);
    goto L32;

  L32:
    call {:si_unique_call 366} irp_5 := IoBuildDeviceIoControlRequest(Ioctl_1, 0, 0, InBufferLen, 0, OutBufferLen, Internal_1, 0, Iosb_1);
    goto anon12_Then, anon12_Else;
...
implementation {:origName "SerialMousepIoSyncIoctlEx"} SerialMousepIoSyncIoctlEx#1(actual_Internal_1: int, actual_Ioctl_1: int, actual_DeviceObject_17: int, actual_Event_7: int, actual_Iosb_1: int, actual_InBuffer: int, actual_InBufferLen: int, actual_OutBuffer: int, actual_OutBufferLen: int) returns (Tmp_222: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 368} KeClearEvent(Event_7);
    goto anon11_Then, anon11_Else;

  anon11_Else:
    assume Event_7 == SLAM_guard_O_0;
    assume SLAM_guard_O_0 != SLAM_guard_O_0_init;
    call {:si_unique_call 369} SLIC_IoBuildDeviceIoControlRequest_entry(strConst__li2bpl3);
    goto L32;
  ...
  anon12_Else:
    assume {:partition} irp_5 != 0;
    call {:si_unique_call 371} status_21 := sdv_IoCallDriver#0(DeviceObject_17, irp_5);
    goto anon15_Then, anon15_Else;
  ...
  anon13_Else:
    ...
    call {:si_unique_call 372} status_21 := KeWaitForSingleObject(0, 0, 0, 0, 0);
    goto anon14_Then, anon14_Else;
...
implementation {:origName "sdv_IoCallDriver"} {:osmodel} sdv_IoCallDriver#0(actual_DeviceObject_10: int, actual_Irp_8: int) returns (Tmp_179: int)
{
  ...
  anon0:
    Irp_8 := actual_Irp_8;
    call {:si_unique_call 373} Tmp_179 := IofCallDriver#0(0, Irp_8);
    goto anon3_Then, anon3_Else;
...
implementation {:origName "sdv_IoCallDriver"} {:osmodel} sdv_IoCallDriver#1(actual_DeviceObject_10: int, actual_Irp_8: int) returns (Tmp_179: int)
{
  ...
  anon0:
    Irp_8 := actual_Irp_8;
    call {:si_unique_call 374} Tmp_179 := IofCallDriver#1(0, Irp_8);
    goto anon3_Then, anon3_Else;
...
implementation {:origName "IofCallDriver"} {:osmodel} IofCallDriver#0(actual_DeviceObject_8: int, actual_Irp_6: int) returns (Tmp_173: int)
{
  ...
  anon0:
    call {:si_unique_call 375} completion_1 := __HAVOC_malloc(4);
    Irp_6 := actual_Irp_6;
  ...
  anon55_Then:
    ...
    call {:si_unique_call 376} vslice_dummy_var_81 := sdv_RunIoCompletionRoutines#0(sdv_p_devobj_fdo, Irp_6, vslice_dummy_var_30, completion_1);
    goto anon76_Then, anon76_Else;
  ...
  anon67_Else:
    ...
    call {:si_unique_call 377} vslice_dummy_var_84 := sdv_RunIoCompletionRoutines#0(sdv_p_devobj_fdo, Irp_6, vslice_dummy_var_31, completion_1);
    goto anon78_Then, anon78_Else;
  ...
  anon59_Else:
    ...
    call {:si_unique_call 378} vslice_dummy_var_82 := sdv_RunIoCompletionRoutines#0(sdv_p_devobj_fdo, Irp_6, vslice_dummy_var_32, completion_1);
    goto anon74_Then, anon74_Else;
  ...
  anon63_Else:
    ...
    call {:si_unique_call 379} vslice_dummy_var_83 := sdv_RunIoCompletionRoutines#0(sdv_p_devobj_fdo, Irp_6, vslice_dummy_var_33, completion_1);
    goto anon72_Then, anon72_Else;
...
implementation {:origName "IofCallDriver"} {:osmodel} IofCallDriver#1(actual_DeviceObject_8: int, actual_Irp_6: int) returns (Tmp_173: int)
{
  ...
  anon0:
    call {:si_unique_call 380} completion_1 := __HAVOC_malloc(4);
    Irp_6 := actual_Irp_6;
    assume {:nonnull} completion_1 != 0;
    assume completion_1 > 0;
    status_16 := 259;
  ...
  anon55_Then:
    ...
    call {:si_unique_call 381} vslice_dummy_var_85 := sdv_RunIoCompletionRoutines#1(sdv_p_devobj_fdo, Irp_6, vslice_dummy_var_34, completion_1);
    goto anon76_Then, anon76_Else;
  ...
  anon67_Else:
    ...
    call {:si_unique_call 382} vslice_dummy_var_88 := sdv_RunIoCompletionRoutines#1(sdv_p_devobj_fdo, Irp_6, vslice_dummy_var_35, completion_1);
    goto anon78_Then, anon78_Else;
  ...
  anon59_Else:
    ...
    call {:si_unique_call 383} vslice_dummy_var_86 := sdv_RunIoCompletionRoutines#1(sdv_p_devobj_fdo, Irp_6, vslice_dummy_var_36, completion_1);
    goto anon74_Then, anon74_Else;
  ...
  anon63_Else:
    ...
    call {:si_unique_call 384} vslice_dummy_var_87 := sdv_RunIoCompletionRoutines#1(sdv_p_devobj_fdo, Irp_6, vslice_dummy_var_37, completion_1);
    goto anon72_Then, anon72_Else;
...
implementation {:origName "sdv_RunIoCompletionRoutines"} {:osmodel} sdv_RunIoCompletionRoutines#0(actual_DeviceObject_9: int, actual_Irp_7: int, actual_Context_6: int, actual_Completion: int) returns (Tmp_175: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 385} SLIC_sdv_RunIoCompletionRoutines_entry(0, Irp_7);
  ...
  L62:
    Tmp_175 := Status_1;
    call {:si_unique_call 391} SLIC_sdv_RunIoCompletionRoutines_exit(strConst__li2bpl2, Irp_7, Completion);
    goto anon21_Then, anon21_Else;
...
implementation {:origName "sdv_RunIoCompletionRoutines"} {:osmodel} sdv_RunIoCompletionRoutines#1(actual_DeviceObject_9: int, actual_Irp_7: int, actual_Context_6: int, actual_Completion: int) returns (Tmp_175: int)
{
  ...
  anon0:
    ...
    Context_6 := actual_Context_6;
    Completion := actual_Completion;
    call {:si_unique_call 392} SLIC_sdv_RunIoCompletionRoutines_entry(0, Irp_7);
    call {:si_unique_call 393} irpsp := sdv_IoGetNextIrpStackLocation(Irp_7);
    Status_1 := 0;
    assume {:nonnull} irpsp != 0;
    assume irpsp > 0;
    goto anon18_Then, anon18_Else;
  ...
  anon18_Else:
    call {:si_unique_call 394} Status_1 := SerialMouseCompletionRoutine(DeviceObject_9, Irp_7, Context_6);
    assume {:nonnull} Completion != 0;
    assume Completion > 0;
    goto L11;
  ...
  anon15_Else:
    call {:si_unique_call 395} Status_1 := SerialMouseReadComplete#1(DeviceObject_9, Irp_7, Context_6);
    goto anon19_Then, anon19_Else;
  ...
  anon16_Else:
    call {:si_unique_call 396} Status_1 := SerialMouseReadSerialPortComplete(DeviceObject_9, Irp_7, Context_6);
    assume {:nonnull} Completion != 0;
    assume Completion > 0;
    goto L45;
  ...
  anon17_Else:
    call {:si_unique_call 397} Status_1 := SerialMouseSerialMaskEventComplete#1(DeviceObject_9, Irp_7, Context_6);
    goto anon20_Then, anon20_Else;
  ...
  L62:
    Tmp_175 := Status_1;
    call {:si_unique_call 398} SLIC_sdv_RunIoCompletionRoutines_exit(strConst__li2bpl2, Irp_7, Completion);
    goto anon21_Then, anon21_Else;
...
implementation {:origName "SerialMouseReadComplete"} SerialMouseReadComplete#0(actual_DeviceObject_18: int, actual_Irp_10: int, actual_Context_8: int) returns (Tmp_226: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 399} Tmp_230 := __HAVOC_malloc(4);
  ...
  anon38_Else:
    call {:si_unique_call 400} buttonsDelta := corral_nondet();
    goto anon51_Then, anon51_Else;
  ...
  anon39_Else:
    call {:si_unique_call 401} Tmp_227 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_227 != 0;
    assume Tmp_227 > 0;
    call {:si_unique_call 402} sdv_KeRaiseIrql(2, Tmp_227);
    assume {:nonnull} Tmp_227 != 0;
    assume Tmp_227 > 0;
    havoc oldIrql;
    assume {:nonnull} DeviceExtension_19 != 0;
    ...
    assume {:nonnull} DeviceExtension_19 != 0;
    assume DeviceExtension_19 > 0;
    call {:si_unique_call 403} sdv_KeLowerIrql(oldIrql);
    goto L53;
  ...
  anon35_Else:
    ...
    call {:si_unique_call 404} vslice_dummy_var_91 := SerialMouseStartRead#0(DeviceExtension_19);
    goto anon50_Then, anon50_Else;
  ...
  anon46_Then:
    ...
    assume {:nonnull} DeviceExtension_19 != 0;
    assume DeviceExtension_19 > 0;
    call {:si_unique_call 405} vslice_dummy_var_90 := KeSetEvent(StopEvent__DEVICE_EXTENSION(DeviceExtension_19), 0, 0);
    goto L21;
  ...
  L21:
    ...
    call {:si_unique_call 406} vslice_dummy_var_89 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(DeviceExtension_19), vslice_dummy_var_38);
    startRead := 0;
    goto L20;
...
implementation {:origName "SerialMouseReadComplete"} SerialMouseReadComplete#1(actual_DeviceObject_18: int, actual_Irp_10: int, actual_Context_8: int) returns (Tmp_226: int)
{
  ...
  anon0:
    Irp_10 := actual_Irp_10;
    Context_8 := actual_Context_8;
    call {:si_unique_call 407} Tmp_230 := __HAVOC_malloc(4);
    DeviceExtension_19 := Context_8;
    buttonsDelta := 0;
    startRead := 1;
    assume {:nonnull} Irp_10 != 0;
  ...
  anon38_Else:
    call {:si_unique_call 408} buttonsDelta := corral_nondet();
    goto anon51_Then, anon51_Else;
  ...
  anon39_Else:
    call {:si_unique_call 409} Tmp_227 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_227 != 0;
    assume Tmp_227 > 0;
    call {:si_unique_call 410} sdv_KeRaiseIrql(2, Tmp_227);
    assume {:nonnull} Tmp_227 != 0;
    assume Tmp_227 > 0;
    havoc oldIrql;
    assume {:nonnull} DeviceExtension_19 != 0;
    ...
    assume {:nonnull} DeviceExtension_19 != 0;
    assume DeviceExtension_19 > 0;
    call {:si_unique_call 411} sdv_KeLowerIrql(oldIrql);
    goto L53;
  ...
  anon35_Else:
    assume {:partition} startRead != 0;
    call {:si_unique_call 412} vslice_dummy_var_94 := SerialMouseStartRead#1(DeviceExtension_19);
    goto anon50_Then, anon50_Else;
  ...
  anon46_Then:
    ...
    assume {:nonnull} DeviceExtension_19 != 0;
    assume DeviceExtension_19 > 0;
    call {:si_unique_call 413} vslice_dummy_var_93 := KeSetEvent(StopEvent__DEVICE_EXTENSION(DeviceExtension_19), 0, 0);
    goto L21;
  ...
  L21:
    ...
    call {:si_unique_call 414} vslice_dummy_var_92 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(DeviceExtension_19), vslice_dummy_var_39);
    startRead := 0;
    goto L20;
...
implementation {:origName "SerialMouseStartRead"} SerialMouseStartRead#0(actual_DeviceExtension_15: int) returns (Tmp_210: int)
{
  ...
  L13:
    assume {:nonnull} DeviceExtension_15 != 0;
    assume DeviceExtension_15 > 0;
    call {:si_unique_call 415} vslice_dummy_var_95 := KeSetEvent(StopEvent__DEVICE_EXTENSION(DeviceExtension_15), 0, 0);
    assume {:nonnull} DeviceExtension_15 != 0;
    assume DeviceExtension_15 > 0;
    havoc vslice_dummy_var_40;
    call {:si_unique_call 416} vslice_dummy_var_96 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(DeviceExtension_15), vslice_dummy_var_40);
    Tmp_210 := -1073741823;
    goto L1;
  ...
  anon15_Else:
    ...
    assume Tmp_211 > 0;
    call {:si_unique_call 418} sdv_KeAcquireSpinLock(0, Tmp_211);
    assume {:nonnull} Tmp_211 != 0;
    assume Tmp_211 > 0;
    havoc irql;
    assume {:nonnull} DeviceExtension_15 != 0;
  ...
  anon16_Else:
    call {:si_unique_call 419} sdv_KeReleaseSpinLock(0, irql);
    assume {:nonnull} DeviceExtension_15 != 0;
    assume DeviceExtension_15 > 0;
    call {:si_unique_call 420} vslice_dummy_var_97 := KeSetEvent(StopEvent__DEVICE_EXTENSION(DeviceExtension_15), 0, 0);
    assume {:nonnull} DeviceExtension_15 != 0;
    assume DeviceExtension_15 > 0;
    havoc vslice_dummy_var_41;
    call {:si_unique_call 421} vslice_dummy_var_98 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(DeviceExtension_15), vslice_dummy_var_41);
    Tmp_210 := 0;
    goto L1;

  anon16_Then:
    call {:si_unique_call 422} IoReuseIrp(irp_2, 0);
    call {:si_unique_call 423} sdv_KeReleaseSpinLock(0, irql);
    assume {:nonnull} DeviceExtension_15 != 0;
    assume DeviceExtension_15 > 0;
    assume {:nonnull} irp_2 != 0;
    assume irp_2 > 0;
    call {:si_unique_call 424} stack := sdv_IoGetNextIrpStackLocation(irp_2);
    ...
    assume {:nonnull} stack != 0;
    assume stack > 0;
    call {:si_unique_call 425} sdv_IoSetCompletionRoutine(irp_2, li2bplFunctionConstant251, DeviceExtension_15, 1, 1, 1);
    assume {:nonnull} DeviceExtension_15 != 0;
    assume DeviceExtension_15 > 0;
    assume false;
    return;
...
implementation {:origName "SerialMouseStartRead"} SerialMouseStartRead#1(actual_DeviceExtension_15: int) returns (Tmp_210: int)
{
  ...
  L11:
    call {:si_unique_call 426} Tmp_211, status_17, irql, stack := SerialMouseStartRead#1_loop_L11(sdv_124, Tmp_211, irp_2, status_17, irql, stack, DeviceExtension_15);
    goto L11_last;
  ...
  L13:
    assume {:nonnull} DeviceExtension_15 != 0;
    assume DeviceExtension_15 > 0;
    call {:si_unique_call 427} vslice_dummy_var_99 := KeSetEvent(StopEvent__DEVICE_EXTENSION(DeviceExtension_15), 0, 0);
    assume {:nonnull} DeviceExtension_15 != 0;
    assume DeviceExtension_15 > 0;
    havoc vslice_dummy_var_42;
    call {:si_unique_call 428} vslice_dummy_var_100 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(DeviceExtension_15), vslice_dummy_var_42);
    Tmp_210 := -1073741823;
    goto L1;
  ...
  anon15_Else:
    ...
    assume {:nonnull} Tmp_211 != 0;
    assume Tmp_211 > 0;
    call {:si_unique_call 430} sdv_KeAcquireSpinLock(0, Tmp_211);
    assume {:nonnull} Tmp_211 != 0;
    assume Tmp_211 > 0;
    havoc irql;
    assume {:nonnull} DeviceExtension_15 != 0;
  ...
  anon16_Else:
    call {:si_unique_call 431} sdv_KeReleaseSpinLock(0, irql);
    assume {:nonnull} DeviceExtension_15 != 0;
    assume DeviceExtension_15 > 0;
    call {:si_unique_call 432} vslice_dummy_var_101 := KeSetEvent(StopEvent__DEVICE_EXTENSION(DeviceExtension_15), 0, 0);
    assume {:nonnull} DeviceExtension_15 != 0;
    assume DeviceExtension_15 > 0;
    havoc vslice_dummy_var_43;
    call {:si_unique_call 433} vslice_dummy_var_102 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(DeviceExtension_15), vslice_dummy_var_43);
    Tmp_210 := 0;
    goto L1;

  anon16_Then:
    call {:si_unique_call 434} IoReuseIrp(irp_2, 0);
    call {:si_unique_call 435} sdv_KeReleaseSpinLock(0, irql);
    assume {:nonnull} DeviceExtension_15 != 0;
    assume DeviceExtension_15 > 0;
    assume {:nonnull} irp_2 != 0;
    assume irp_2 > 0;
    call {:si_unique_call 436} stack := sdv_IoGetNextIrpStackLocation(irp_2);
    assume {:nonnull} stack != 0;
    assume stack > 0;
    assume {:nonnull} stack != 0;
    assume stack > 0;
    assume {:nonnull} stack != 0;
    assume stack > 0;
    call {:si_unique_call 437} sdv_IoSetCompletionRoutine(irp_2, li2bplFunctionConstant251, DeviceExtension_15, 1, 1, 1);
    assume {:nonnull} DeviceExtension_15 != 0;
    assume DeviceExtension_15 > 0;
    havoc vslice_dummy_var_44;
    call {:si_unique_call 438} status_17 := sdv_IoCallDriver#0(vslice_dummy_var_44, irp_2);
    goto anon18_Then, anon18_Else;
...
implementation {:origName "SerialMouseSerialMaskEventComplete"} SerialMouseSerialMaskEventComplete#0(actual_DeviceObject_1: int, actual_Irp_1: int, actual_Context: int) returns (Tmp_38: int)
{
  ...
  anon14_Else:
    ...
    assume {:nonnull} deviceExtension_1 != 0;
    assume deviceExtension_1 > 0;
    call {:si_unique_call 439} IoInvalidateDeviceState(0);
    goto L12;
  ...
  L12:
    ...
    call {:si_unique_call 440} vslice_dummy_var_103 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(deviceExtension_1), vslice_dummy_var_45);
    Tmp_38 := -1073741802;
    goto LM2;
  ...
  anon13_Else:
    call {:si_unique_call 441} item := IoAllocateWorkItem(0);
    goto anon15_Then, anon15_Else;

  anon15_Else:
    assume {:partition} item != 0;
    call {:si_unique_call 442} status_4 := sdv_IoAcquireRemoveLock(0, 0);
    goto anon16_Then, anon16_Else;

  anon16_Else:
    assume {:partition} status_4 >= 0;
    call {:si_unique_call 443} IoQueueWorkItem#0(item, li2bplFunctionConstant271, 1, item);
    goto anon18_Then, anon18_Else;
...
implementation {:origName "SerialMouseSerialMaskEventComplete"} SerialMouseSerialMaskEventComplete#1(actual_DeviceObject_1: int, actual_Irp_1: int, actual_Context: int) returns (Tmp_38: int)
{
  ...
  anon14_Else:
    ...
    assume {:nonnull} deviceExtension_1 != 0;
    assume deviceExtension_1 > 0;
    call {:si_unique_call 444} IoInvalidateDeviceState(0);
    goto L12;
  ...
  L12:
    ...
    call {:si_unique_call 445} vslice_dummy_var_104 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(deviceExtension_1), vslice_dummy_var_46);
    Tmp_38 := -1073741802;
    goto LM2;
  ...
  anon13_Else:
    call {:si_unique_call 446} item := IoAllocateWorkItem(0);
    goto anon15_Then, anon15_Else;

  anon15_Else:
    assume {:partition} item != 0;
    call {:si_unique_call 447} status_4 := sdv_IoAcquireRemoveLock(0, 0);
    goto anon16_Then, anon16_Else;

  anon16_Else:
    assume {:partition} status_4 >= 0;
    call {:si_unique_call 448} IoQueueWorkItem#1(item, li2bplFunctionConstant271, 1, item);
    goto anon18_Then, anon18_Else;
...
implementation {:origName "IoQueueWorkItem"} {:osmodel} IoQueueWorkItem#0(actual_IoWorkItem_1: int, actual_WorkerRoutine: int, actual_QueueType: int, actual_Context_2: int)
{
  ...
  anon0:
    call {:si_unique_call 449} vslice_dummy_var_105 := __HAVOC_malloc(4);
...
implementation {:origName "IoQueueWorkItem"} {:osmodel} IoQueueWorkItem#1(actual_IoWorkItem_1: int, actual_WorkerRoutine: int, actual_QueueType: int, actual_Context_2: int)
{
  ...
  anon0:
    call {:si_unique_call 451} vslice_dummy_var_106 := __HAVOC_malloc(4);
    WorkerRoutine := actual_WorkerRoutine;
    QueueType := actual_QueueType;
    Context_2 := actual_Context_2;
...
implementation {:origName "sdv_RunIoQueueWorkItems"} {:osmodel} sdv_RunIoQueueWorkItems#0(actual_IoWorkItem_2: int, actual_WorkerRoutine_1: int, actual_QueueType_1: int, actual_Context_3: int)
{
  ...
  anon0:
    call {:si_unique_call 453} vslice_dummy_var_107 := __HAVOC_malloc(4);
  ...
  anon9_Else:
    ...
    call {:si_unique_call 454} SerialMouseSerialMaskEventWorker#0(sdv_p_devobj_fdo, Context_3);
    goto anon11_Then, anon11_Else;
  ...
  anon10_Else:
    ...
    call {:si_unique_call 455} StartDeviceWorker#0(sdv_p_devobj_fdo, Context_3);
    goto anon12_Then, anon12_Else;
...
implementation {:origName "sdv_RunIoQueueWorkItems"} {:osmodel} sdv_RunIoQueueWorkItems#1(actual_IoWorkItem_2: int, actual_WorkerRoutine_1: int, actual_QueueType_1: int, actual_Context_3: int)
{
  ...
  anon0:
    call {:si_unique_call 456} vslice_dummy_var_108 := __HAVOC_malloc(4);
    WorkerRoutine_1 := actual_WorkerRoutine_1;
    Context_3 := actual_Context_3;
    goto anon9_Then, anon9_Else;
  ...
  anon9_Else:
    assume {:partition} WorkerRoutine_1 == li2bplFunctionConstant271;
    call {:si_unique_call 457} SerialMouseSerialMaskEventWorker#1(sdv_p_devobj_fdo, Context_3);
    goto anon11_Then, anon11_Else;
  ...
  anon10_Else:
    assume {:partition} WorkerRoutine_1 == li2bplFunctionConstant193;
    call {:si_unique_call 458} StartDeviceWorker#1(sdv_p_devobj_fdo, Context_3);
    goto anon12_Then, anon12_Else;
...
implementation {:origName "SerialMouseSerialMaskEventWorker"} SerialMouseSerialMaskEventWorker#0(actual_DeviceObject_2: int, actual_Context_1: int)
{
  ...
  anon0:
    call {:si_unique_call 459} bits_1 := __HAVOC_malloc(4);
    call {:si_unique_call 460} iosb_1 := __HAVOC_malloc(12);
    call {:si_unique_call 461} vslice_dummy_var_109 := __HAVOC_malloc(4);
    call {:si_unique_call 462} event_1 := __HAVOC_malloc(156);
    ...
    Item := Context_1;
    call {:si_unique_call 463} sdv_do_paged_code_check();
    assume {:nonnull} deviceExtension_2 != 0;
    assume deviceExtension_2 > 0;
    havoc irp_1;
    call {:si_unique_call 464} KeInitializeEvent(event_1, 0, 0);
  ...
  anon21_Else:
    ...
    call {:si_unique_call 465} vslice_dummy_var_113 := SerialMousepIoSyncIoctlEx#0(0, 1769576, vslice_dummy_var_47, event_1, iosb_1, 0, 0, bits_1, 4);
    goto anon22_Then, anon22_Else;
  ...
  anon19_Else:
    call {:si_unique_call 466} vslice_dummy_var_112 := SerialMouseSendWaitMaskIrp#0(deviceExtension_2);
    goto anon23_Then, anon23_Else;
  ...
  L20:
    assume {:nonnull} deviceExtension_2 != 0;
    assume deviceExtension_2 > 0;
    call {:si_unique_call 467} vslice_dummy_var_110 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(deviceExtension_2), Item);
    call {:si_unique_call 468} IoFreeWorkItem(0);
    goto LM2;
  ...
  anon19_Then:
    ...
    call {:si_unique_call 469} vslice_dummy_var_111 := SerialMousepIoSyncIoctl#0(1, 3604999, vslice_dummy_var_48, event_1, iosb_1);
    goto anon24_Then, anon24_Else;
...
implementation {:origName "SerialMouseSerialMaskEventWorker"} SerialMouseSerialMaskEventWorker#1(actual_DeviceObject_2: int, actual_Context_1: int)
{
  ...
  anon0:
    call {:si_unique_call 470} bits_1 := __HAVOC_malloc(4);
    call {:si_unique_call 471} iosb_1 := __HAVOC_malloc(12);
    call {:si_unique_call 472} vslice_dummy_var_114 := __HAVOC_malloc(4);
    call {:si_unique_call 473} event_1 := __HAVOC_malloc(156);
    DeviceObject_2 := actual_DeviceObject_2;
    Context_1 := actual_Context_1;
    assume {:nonnull} DeviceObject_2 != 0;
    assume DeviceObject_2 > 0;
    ...
    assume deviceExtension_2 > 0;
    havoc irp_1;
    call {:si_unique_call 475} KeInitializeEvent(event_1, 0, 0);
    assume {:nonnull} irp_1 != 0;
    assume irp_1 > 0;
    goto anon17_Then, anon17_Else;
  ...
  anon21_Else:
    ...
    call {:si_unique_call 476} vslice_dummy_var_118 := SerialMousepIoSyncIoctlEx#1(0, 1769576, vslice_dummy_var_49, event_1, iosb_1, 0, 0, bits_1, 4);
    goto anon22_Then, anon22_Else;
  ...
  anon19_Else:
    call {:si_unique_call 477} vslice_dummy_var_117 := SerialMouseSendWaitMaskIrp#1(deviceExtension_2);
    goto anon23_Then, anon23_Else;
  ...
  L20:
    assume {:nonnull} deviceExtension_2 != 0;
    assume deviceExtension_2 > 0;
    call {:si_unique_call 478} vslice_dummy_var_115 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(deviceExtension_2), Item);
    call {:si_unique_call 479} IoFreeWorkItem(0);
    goto LM2;
  ...
  anon19_Then:
    ...
    call {:si_unique_call 480} vslice_dummy_var_116 := SerialMousepIoSyncIoctl#1(1, 3604999, vslice_dummy_var_50, event_1, iosb_1);
    goto anon24_Then, anon24_Else;
...
implementation {:origName "SerialMouseSendWaitMaskIrp"} SerialMouseSendWaitMaskIrp#0(actual_DeviceExtension_5: int) returns (Tmp_34: int)
{
  ...
  anon0:
    ...
    assume {:nonnull} DeviceExtension_5 != 0;
    assume DeviceExtension_5 > 0;
    call {:si_unique_call 482} status_3 := sdv_IoAcquireRemoveLock(0, 0);
    goto anon5_Then, anon5_Else;

  anon5_Else:
    assume {:partition} status_3 >= 0;
    call {:si_unique_call 483} IoReuseIrp(irp, 0);
    call {:si_unique_call 484} next := sdv_IoGetNextIrpStackLocation(irp);
    ...
    assume irp > 0;
    call {:si_unique_call 485} sdv_IoSetCompletionRoutine(irp, li2bplFunctionConstant268, DeviceExtension_5, 1, 1, 1);
    assume {:nonnull} DeviceExtension_5 != 0;
    assume DeviceExtension_5 > 0;
    assume false;
    return;
...
implementation {:origName "SerialMouseSendWaitMaskIrp"} SerialMouseSendWaitMaskIrp#1(actual_DeviceExtension_5: int) returns (Tmp_34: int)
{
  ...
  anon0:
    ...
    assume {:nonnull} DeviceExtension_5 != 0;
    assume DeviceExtension_5 > 0;
    call {:si_unique_call 487} status_3 := sdv_IoAcquireRemoveLock(0, 0);
    goto anon5_Then, anon5_Else;

  anon5_Else:
    assume {:partition} status_3 >= 0;
    call {:si_unique_call 488} IoReuseIrp(irp, 0);
    call {:si_unique_call 489} next := sdv_IoGetNextIrpStackLocation(irp);
    assume {:nonnull} next != 0;
    assume next > 0;
    assume {:nonnull} next != 0;
    assume next > 0;
    ...
    assume {:nonnull} irp != 0;
    assume irp > 0;
    call {:si_unique_call 490} sdv_IoSetCompletionRoutine(irp, li2bplFunctionConstant268, DeviceExtension_5, 1, 1, 1);
    assume {:nonnull} DeviceExtension_5 != 0;
    assume DeviceExtension_5 > 0;
    havoc vslice_dummy_var_51;
    call {:si_unique_call 491} Tmp_34 := sdv_IoCallDriver#0(vslice_dummy_var_51, irp);
    goto anon6_Then, anon6_Else;
...
implementation {:origName "StartDeviceWorker"} StartDeviceWorker#0(actual_DeviceObject_25: int, actual_Context_10: int)
{
  ...
  anon0:
    call {:si_unique_call 492} vslice_dummy_var_119 := __HAVOC_malloc(4);
    call {:si_unique_call 493} iosb_15 := __HAVOC_malloc(12);
    call {:si_unique_call 494} event_16 := __HAVOC_malloc(156);
  ...
  anon16_Else:
    ...
    call {:si_unique_call 495} irp_6 := IoAllocateIrp(vslice_dummy_var_52, 0);
    goto anon17_Then, anon17_Else;

  anon17_Else:
    assume {:partition} irp_6 != 0;
    call {:si_unique_call 496} status_38 := SerialMouseStartDevice#0(deviceExtension_7, irp_6, 0);
    goto anon20_Then, anon20_Else;
...
implementation {:origName "StartDeviceWorker"} StartDeviceWorker#1(actual_DeviceObject_25: int, actual_Context_10: int)
{
  ...
  anon18_Else:
    assume {:partition} status_38 < 0;
    call {:si_unique_call 508} KeInitializeEvent(event_16, 1, 0);
    assume {:nonnull} deviceExtension_7 != 0;
    assume deviceExtension_7 > 0;
    havoc vslice_dummy_var_55;
    call {:si_unique_call 509} vslice_dummy_var_123 := SerialMousepIoSyncIoctl#1(1, 3604999, vslice_dummy_var_55, event_16, iosb_15);
    goto anon21_Then, anon21_Else;
  ...
  L26:
    call {:si_unique_call 510} IoFreeIrp(0);
    goto L10;

  L10:
    call {:si_unique_call 511} IoFreeWorkItem(0);
    call {:si_unique_call 512} sdv_ExFreePool(0);
    assume {:nonnull} deviceExtension_7 != 0;
    assume deviceExtension_7 > 0;
    call {:si_unique_call 513} vslice_dummy_var_124 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(deviceExtension_7), deviceExtension_7);
    goto LM2;
...
implementation {:origName "SerialMouseStartDevice"} SerialMouseStartDevice#0(actual_DeviceExtension_30: int, actual_Irp_11: int, actual_CloseOnFailure: int) returns (Tmp_305: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 515} status_31 := SerialMouseInitializeDevice#0(DeviceExtension_30);
    goto anon16_Then, anon16_Else;
  ...
  anon13_Else:
    ...
    call {:si_unique_call 516} status_31 := SerialMouseSpinUpRead#0(DeviceExtension_30);
    goto anon17_Then, anon17_Else;
  ...
  anon15_Else:
    ...
    call {:si_unique_call 517} SerialMouseClosePort#0(DeviceExtension_30, Irp_11);
    goto anon18_Then, anon18_Else;

  anon18_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 518} Tmp_306 := __HAVOC_malloc(4);
    assume {:nonnull} DeviceExtension_30 != 0;
    assume DeviceExtension_30 > 0;
    assume {:nonnull} Tmp_306 != 0;
    assume Tmp_306 > 0;
    call {:si_unique_call 519} vslice_dummy_var_125 := sdv_InterlockedDecrement(Tmp_306);
    assume {:nonnull} DeviceExtension_30 != 0;
    assume DeviceExtension_30 > 0;
    assume {:nonnull} Tmp_306 != 0;
    assume Tmp_306 > 0;
...
implementation {:origName "SerialMouseStartDevice"} SerialMouseStartDevice#1(actual_DeviceExtension_30: int, actual_Irp_11: int, actual_CloseOnFailure: int) returns (Tmp_305: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 521} status_31 := SerialMouseInitializeDevice#1(DeviceExtension_30);
    goto anon16_Then, anon16_Else;
  ...
  anon13_Else:
    assume {:partition} status_31 >= 0;
    call {:si_unique_call 522} status_31 := SerialMouseSpinUpRead#1(DeviceExtension_30);
    goto anon17_Then, anon17_Else;
  ...
  anon15_Else:
    assume {:partition} CloseOnFailure != 0;
    call {:si_unique_call 523} SerialMouseClosePort#1(DeviceExtension_30, Irp_11);
    goto anon18_Then, anon18_Else;

  anon18_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 524} Tmp_306 := __HAVOC_malloc(4);
    assume {:nonnull} DeviceExtension_30 != 0;
    assume DeviceExtension_30 > 0;
    assume {:nonnull} Tmp_306 != 0;
    assume Tmp_306 > 0;
    call {:si_unique_call 525} vslice_dummy_var_126 := sdv_InterlockedDecrement(Tmp_306);
    assume {:nonnull} DeviceExtension_30 != 0;
    assume DeviceExtension_30 > 0;
    assume {:nonnull} Tmp_306 != 0;
    assume Tmp_306 > 0;
...
implementation {:origName "SerialMouseInitializeDevice"} SerialMouseInitializeDevice#0(actual_DeviceExtension_32: int) returns (Tmp_309: int)
{
  ...
  anon0:
    call {:si_unique_call 526} iosb_14 := __HAVOC_malloc(12);
    call {:si_unique_call 527} waitMask_1 := __HAVOC_malloc(4);
    call {:si_unique_call 528} event_14 := __HAVOC_malloc(156);
    DeviceExtension_32 := actual_DeviceExtension_32;
    call {:si_unique_call 529} Tmp_314 := __HAVOC_malloc(4);
    call {:si_unique_call 530} dumpData := __HAVOC_malloc(16);
    status_32 := 0;
    dumpCount := 0;
    i_3 := 0;
    goto L14;
  ...
  L14:
    call {:si_unique_call 531} i_3, Tmp_310 := SerialMouseInitializeDevice#0_loop_L14(i_3, Tmp_310, dumpData);
    goto L14_last;
  ...
  anon19_Then:
    ...
    assume waitMask_1 > 0;
    call {:si_unique_call 533} KeInitializeEvent(event_14, 0, 0);
    assume {:nonnull} DeviceExtension_32 != 0;
    assume DeviceExtension_32 > 0;
    havoc vslice_dummy_var_56;
    call {:si_unique_call 534} vslice_dummy_var_127 := SerialMousepIoSyncIoctlEx#0(0, 1769540, vslice_dummy_var_56, event_14, iosb_14, waitMask_1, 4, 0, 0);
    goto anon24_Then, anon24_Else;

  anon24_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 535} status_32 := SerialMouseInitializeHardware#0(DeviceExtension_32);
    goto anon25_Then, anon25_Else;
  ...
  anon22_Else:
    ...
    call {:si_unique_call 536} sdv_206 := IoAllocateErrorLogEntry(0, Tmp_315);
  ...
  L57:
    call {:si_unique_call 537} i_3, Tmp_311, Tmp_313, Tmp_314 := SerialMouseInitializeDevice#0_loop_L57(i_3, Tmp_311, Tmp_313, errorLogEntry, Tmp_314, dumpData, dumpCount);
    goto L57_last;
  ...
  anon23_Then:
    ...
    call {:si_unique_call 538} IoWriteErrorLogEntry(0);
    goto L41;
  ...
  L36:
    assume {:nonnull} DeviceExtension_32 != 0;
    assume DeviceExtension_32 > 0;
    call {:si_unique_call 539} SerialMouseStartDetection#0(DeviceExtension_32);
    goto anon26_Then, anon26_Else;
...
implementation {:origName "SerialMouseInitializeDevice"} SerialMouseInitializeDevice#1(actual_DeviceExtension_32: int) returns (Tmp_309: int)
{
  ...
  anon0:
    call {:si_unique_call 540} iosb_14 := __HAVOC_malloc(12);
    call {:si_unique_call 541} waitMask_1 := __HAVOC_malloc(4);
    call {:si_unique_call 542} event_14 := __HAVOC_malloc(156);
    DeviceExtension_32 := actual_DeviceExtension_32;
    call {:si_unique_call 543} Tmp_314 := __HAVOC_malloc(4);
    call {:si_unique_call 544} dumpData := __HAVOC_malloc(16);
    status_32 := 0;
    dumpCount := 0;
    i_3 := 0;
    goto L14;
  ...
  L14:
    call {:si_unique_call 545} i_3, Tmp_310 := SerialMouseInitializeDevice#1_loop_L14(i_3, Tmp_310, dumpData);
    goto L14_last;
  ...
  anon19_Then:
    ...
    assume {:nonnull} waitMask_1 != 0;
    assume waitMask_1 > 0;
    call {:si_unique_call 547} KeInitializeEvent(event_14, 0, 0);
    assume {:nonnull} DeviceExtension_32 != 0;
    assume DeviceExtension_32 > 0;
    havoc vslice_dummy_var_57;
    call {:si_unique_call 548} vslice_dummy_var_128 := SerialMousepIoSyncIoctlEx#1(0, 1769540, vslice_dummy_var_57, event_14, iosb_14, waitMask_1, 4, 0, 0);
    goto anon24_Then, anon24_Else;

  anon24_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 549} status_32 := SerialMouseInitializeHardware#1(DeviceExtension_32);
    goto anon25_Then, anon25_Else;
  ...
  anon22_Else:
    ...
    assume DeviceExtension_32 > 0;
    Tmp_315 := 48 + dumpCount * 4;
    call {:si_unique_call 550} sdv_206 := IoAllocateErrorLogEntry(0, Tmp_315);
    errorLogEntry := sdv_206;
    goto anon27_Then, anon27_Else;
  ...
  L57:
    call {:si_unique_call 551} i_3, Tmp_311, Tmp_313, Tmp_314 := SerialMouseInitializeDevice#1_loop_L57(i_3, Tmp_311, Tmp_313, errorLogEntry, Tmp_314, dumpData, dumpCount);
    goto L57_last;
  ...
  anon23_Then:
    assume {:partition} i_3 >= dumpCount;
    call {:si_unique_call 552} IoWriteErrorLogEntry(0);
    goto L41;
  ...
  L36:
    assume {:nonnull} DeviceExtension_32 != 0;
    assume DeviceExtension_32 > 0;
    call {:si_unique_call 553} SerialMouseStartDetection#1(DeviceExtension_32);
    goto anon26_Then, anon26_Else;
...
implementation {:origName "SerialMouseInitializeHardware"} SerialMouseInitializeHardware#0(actual_DeviceExtension_27: int) returns (Tmp_260: int)
{
  ...
  anon0:
    call {:si_unique_call 554} hardwareButtons := __HAVOC_malloc(4);
    ...
    call {:si_unique_call 556} sdv_RtlZeroMemory(0, 20);
    call {:si_unique_call 557} mouseType_1 := MSerDetect#0(DeviceExtension_27);
    goto anon38_Then, anon38_Else;
  ...
  anon35_Else:
    ...
    call {:si_unique_call 558} boogieTmp := MSerSetProtocol#0(DeviceExtension_27, 2);
    goto anon46_Then, anon46_Else;
  ...
  anon41_Else:
    ...
    call {:si_unique_call 559} vslice_dummy_var_129 := SerialMouseSetFifo#0(DeviceExtension_27, 0);
    goto anon42_Then, anon42_Else;

  anon42_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 560} vslice_dummy_var_130 := SerialMouseFlushReadBuffer#0(DeviceExtension_27);
    goto anon43_Then, anon43_Else;
  ...
  anon36_Then:
    ...
    assume {:nonnull} DeviceExtension_27 != 0;
    assume DeviceExtension_27 > 0;
    call {:si_unique_call 561} boogieTmp := MSerSetProtocol#0(DeviceExtension_27, 1);
    goto anon45_Then, anon45_Else;
  ...
  anon37_Then:
    ...
    assume {:nonnull} DeviceExtension_27 != 0;
    assume DeviceExtension_27 > 0;
    call {:si_unique_call 562} boogieTmp := MSerSetProtocol#0(DeviceExtension_27, 0);
    goto anon44_Then, anon44_Else;
  ...
  anon39_Then:
    ...
    assume {:nonnull} DeviceExtension_27 != 0;
    assume DeviceExtension_27 > 0;
    call {:si_unique_call 563} boogieTmp := MSerSetProtocol#0(DeviceExtension_27, 0);
    goto anon40_Then, anon40_Else;
  ...
  anon33_Then:
    assume {:partition} mouseType_1 == 0;
    call {:si_unique_call 564} sdv_182 := CSerDetect#0(DeviceExtension_27, hardwareButtons);
    goto anon47_Then, anon47_Else;
  ...
  anon34_Else:
    ...
    assume {:nonnull} DeviceExtension_27 != 0;
    assume DeviceExtension_27 > 0;
    call {:si_unique_call 565} boogieTmp := CSerSetProtocol#0(DeviceExtension_27, 0);
    goto anon48_Then, anon48_Else;
...
implementation {:origName "SerialMouseInitializeHardware"} SerialMouseInitializeHardware#1(actual_DeviceExtension_27: int) returns (Tmp_260: int)
{
  ...
  anon0:
    call {:si_unique_call 566} hardwareButtons := __HAVOC_malloc(4);
    DeviceExtension_27 := actual_DeviceExtension_27;
    assume {:nonnull} hardwareButtons != 0;
    assume hardwareButtons > 0;
    status_28 := -1073741823;
    call {:si_unique_call 567} sdv_do_paged_code_check();
    call {:si_unique_call 568} sdv_RtlZeroMemory(0, 20);
    call {:si_unique_call 569} mouseType_1 := MSerDetect#1(DeviceExtension_27);
    goto anon38_Then, anon38_Else;
  ...
  anon35_Else:
    ...
    assume {:nonnull} DeviceExtension_27 != 0;
    assume DeviceExtension_27 > 0;
    call {:si_unique_call 570} boogieTmp := MSerSetProtocol#1(DeviceExtension_27, 2);
    goto anon46_Then, anon46_Else;
  ...
  anon41_Else:
    assume {:partition} status_28 >= 0;
    call {:si_unique_call 571} vslice_dummy_var_131 := SerialMouseSetFifo#1(DeviceExtension_27, 0);
    goto anon42_Then, anon42_Else;

  anon42_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 572} vslice_dummy_var_132 := SerialMouseFlushReadBuffer#1(DeviceExtension_27);
    goto anon43_Then, anon43_Else;
  ...
  anon36_Then:
    ...
    assume {:nonnull} DeviceExtension_27 != 0;
    assume DeviceExtension_27 > 0;
    call {:si_unique_call 573} boogieTmp := MSerSetProtocol#1(DeviceExtension_27, 1);
    goto anon45_Then, anon45_Else;
  ...
  anon37_Then:
    ...
    assume {:nonnull} DeviceExtension_27 != 0;
    assume DeviceExtension_27 > 0;
    call {:si_unique_call 574} boogieTmp := MSerSetProtocol#1(DeviceExtension_27, 0);
    goto anon44_Then, anon44_Else;
  ...
  anon39_Then:
    ...
    assume {:nonnull} DeviceExtension_27 != 0;
    assume DeviceExtension_27 > 0;
    call {:si_unique_call 575} boogieTmp := MSerSetProtocol#1(DeviceExtension_27, 0);
    goto anon40_Then, anon40_Else;
  ...
  anon33_Then:
    assume {:partition} mouseType_1 == 0;
    call {:si_unique_call 576} sdv_182 := CSerDetect#1(DeviceExtension_27, hardwareButtons);
    goto anon47_Then, anon47_Else;
  ...
  anon34_Else:
    ...
    assume {:nonnull} DeviceExtension_27 != 0;
    assume DeviceExtension_27 > 0;
    call {:si_unique_call 577} boogieTmp := CSerSetProtocol#1(DeviceExtension_27, 0);
    goto anon48_Then, anon48_Else;
...
implementation {:origName "MSerDetect"} MSerDetect#0(actual_DeviceExtension_25: int) returns (Tmp_247: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 578} receiveBuffer := __HAVOC_malloc(1024);
    count_3 := 0;
    mouseType := 0;
    call {:si_unique_call 579} sdv_do_paged_code_check();
    call {:si_unique_call 580} vslice_dummy_var_133 := SerialMouseInitializePort#0(DeviceExtension_25);
    goto anon55_Then, anon55_Else;

  anon55_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 581} vslice_dummy_var_134 := MSerPowerDown#0(DeviceExtension_25);
    goto anon56_Then, anon56_Else;

  anon56_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 582} vslice_dummy_var_135 := SerialMouseSetBaudRate#0(DeviceExtension_25, 1200);
    goto anon57_Then, anon57_Else;

  anon57_Else:
    assume {:partition} yogi_error != 1;
    havoc Tmp_249;
    call {:si_unique_call 583} vslice_dummy_var_141 := SerialMouseSetLineCtrl#0(DeviceExtension_25, Tmp_249);
    goto anon58_Then, anon58_Else;

  anon58_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 584} vslice_dummy_var_136 := SerialMouseFlushReadBuffer#0(DeviceExtension_25);
    goto anon59_Then, anon59_Else;

  anon59_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 585} vslice_dummy_var_137 := MSerPowerUp#0(DeviceExtension_25);
    goto anon60_Then, anon60_Else;

  anon60_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 586} vslice_dummy_var_138 := SerialMouseSetReadTimeouts#0(DeviceExtension_25, 200);
    goto anon61_Then, anon61_Else;
  ...
  anon61_Else:
    ...
    call {:si_unique_call 587} sdv_163 := SerialMouseReadChar#0(DeviceExtension_25, Tmp_256);
    goto anon62_Then, anon62_Else;
  ...
  anon47_Else:
    ...
    count_3 := count_3 + 1;
    call {:si_unique_call 588} vslice_dummy_var_142 := SerialMouseSetReadTimeouts#0(DeviceExtension_25, 100);
    goto anon63_Then, anon63_Else;
  ...
  L53:
    call {:si_unique_call 589} Tmp_248, count_3, Tmp_257, sdv_170 := MSerDetect#0_loop_L53(Tmp_248, count_3, receiveBuffer, Tmp_257, sdv_170, DeviceExtension_25);
    goto L53_last;
  ...
  anon48_Else:
    ...
    call {:si_unique_call 590} sdv_170 := SerialMouseReadChar#0(DeviceExtension_25, Tmp_248);
    goto anon64_Then, anon64_Else;
  ...
  L62:
    call {:si_unique_call 591} i_1 := MSerDetect#0_loop_L62(i_1, count_3);
    goto L62_last;
  ...
  L65:
    call {:si_unique_call 592} i_1, Tmp_250, Tmp_251 := MSerDetect#0_loop_L65(i_1, count_3, Tmp_250, Tmp_251, receiveBuffer);
    goto L65_last;
  ...
  anon54_Else:
    ...
    call {:si_unique_call 593} vslice_dummy_var_139 := SerialMouseWait(DeviceExtension_25, -5000000);
    goto L80;
  ...
  anon53_Else:
    ...
    call {:si_unique_call 594} vslice_dummy_var_140 := SerialMouseSetReadTimeouts#0(DeviceExtension_25, 0);
    goto anon67_Then, anon67_Else;
...
implementation {:origName "MSerDetect"} MSerDetect#1(actual_DeviceExtension_25: int) returns (Tmp_247: int)
{
  ...
  anon0:
    DeviceExtension_25 := actual_DeviceExtension_25;
    call {:si_unique_call 595} receiveBuffer := __HAVOC_malloc(1024);
    count_3 := 0;
    mouseType := 0;
    call {:si_unique_call 596} sdv_do_paged_code_check();
    call {:si_unique_call 597} vslice_dummy_var_143 := SerialMouseInitializePort#1(DeviceExtension_25);
    goto anon55_Then, anon55_Else;

  anon55_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 598} vslice_dummy_var_144 := MSerPowerDown#1(DeviceExtension_25);
    goto anon56_Then, anon56_Else;

  anon56_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 599} vslice_dummy_var_145 := SerialMouseSetBaudRate#1(DeviceExtension_25, 1200);
    goto anon57_Then, anon57_Else;

  anon57_Else:
    assume {:partition} yogi_error != 1;
    havoc Tmp_249;
    call {:si_unique_call 600} vslice_dummy_var_151 := SerialMouseSetLineCtrl#1(DeviceExtension_25, Tmp_249);
    goto anon58_Then, anon58_Else;

  anon58_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 601} vslice_dummy_var_146 := SerialMouseFlushReadBuffer#1(DeviceExtension_25);
    goto anon59_Then, anon59_Else;

  anon59_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 602} vslice_dummy_var_147 := MSerPowerUp#1(DeviceExtension_25);
    goto anon60_Then, anon60_Else;

  anon60_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 603} vslice_dummy_var_148 := SerialMouseSetReadTimeouts#1(DeviceExtension_25, 200);
    goto anon61_Then, anon61_Else;
  ...
  anon61_Else:
    ...
    Tmp_253 := count_3;
    Tmp_256 := receiveBuffer + Tmp_253 * 4;
    call {:si_unique_call 604} sdv_163 := SerialMouseReadChar#1(DeviceExtension_25, Tmp_256);
    goto anon62_Then, anon62_Else;
  ...
  anon47_Else:
    assume {:partition} sdv_163 >= 0;
    count_3 := count_3 + 1;
    call {:si_unique_call 605} vslice_dummy_var_152 := SerialMouseSetReadTimeouts#1(DeviceExtension_25, 100);
    goto anon63_Then, anon63_Else;
  ...
  L53:
    call {:si_unique_call 606} Tmp_248, count_3, Tmp_257, sdv_170 := MSerDetect#1_loop_L53(Tmp_248, count_3, receiveBuffer, Tmp_257, sdv_170, DeviceExtension_25);
    goto L53_last;
  ...
  anon48_Else:
    ...
    Tmp_257 := count_3;
    Tmp_248 := receiveBuffer + Tmp_257 * 4;
    call {:si_unique_call 607} sdv_170 := SerialMouseReadChar#1(DeviceExtension_25, Tmp_248);
    goto anon64_Then, anon64_Else;
  ...
  L62:
    call {:si_unique_call 608} i_1 := MSerDetect#1_loop_L62(i_1, count_3);
    goto L62_last;
  ...
  L65:
    call {:si_unique_call 609} i_1, Tmp_250, Tmp_251 := MSerDetect#1_loop_L65(i_1, count_3, Tmp_250, Tmp_251, receiveBuffer);
    goto L65_last;
  ...
  anon54_Else:
    assume {:partition} count_3 != 0;
    call {:si_unique_call 610} vslice_dummy_var_149 := SerialMouseWait(DeviceExtension_25, -5000000);
    goto L80;
  ...
  anon53_Else:
    assume {:partition} mouseType != 0;
    call {:si_unique_call 611} vslice_dummy_var_150 := SerialMouseSetReadTimeouts#1(DeviceExtension_25, 0);
    goto anon67_Then, anon67_Else;
...
implementation {:origName "SerialMouseInitializePort"} SerialMouseInitializePort#0(actual_DeviceExtension_21: int) returns (Tmp_234: int)
{
  ...
  anon0:
    call {:si_unique_call 612} serialHandFlow := __HAVOC_malloc(16);
    call {:si_unique_call 613} serialTimeouts := __HAVOC_malloc(20);
    call {:si_unique_call 614} iosb_10 := __HAVOC_malloc(12);
    call {:si_unique_call 615} event_10 := __HAVOC_malloc(156);
    DeviceExtension_21 := actual_DeviceExtension_21;
    call {:si_unique_call 616} KeInitializeEvent(event_10, 0, 0);
    assume {:nonnull} DeviceExtension_21 != 0;
    assume DeviceExtension_21 > 0;
    havoc vslice_dummy_var_58;
    call {:si_unique_call 617} status_23 := SerialMousepIoSyncIoctlEx#0(1, 1769484, vslice_dummy_var_58, event_10, iosb_10, 0, 0, SerialBasicSettings__DEVICE_EXTENSION(DeviceExtension_21), 44);
    goto anon14_Then, anon14_Else;
  ...
  anon13_Then:
    ...
    call {:si_unique_call 618} vslice_dummy_var_153 := SerialMousepIoSyncIoctlEx#0(0, 1769504, vslice_dummy_var_59, event_10, iosb_10, 0, 0, Timeouts__SERIAL_BASIC_SETTINGS(SerialBasicSettings__DEVICE_EXTENSION(DeviceExtension_21)), 20);
    goto anon15_Then, anon15_Else;

  anon15_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 619} sdv_RtlZeroMemory(0, 20);
    assume {:nonnull} DeviceExtension_21 != 0;
    assume DeviceExtension_21 > 0;
    havoc vslice_dummy_var_60;
    call {:si_unique_call 620} vslice_dummy_var_154 := SerialMousepIoSyncIoctlEx#0(0, 1769500, vslice_dummy_var_60, event_10, iosb_10, serialTimeouts, 20, 0, 0);
    goto anon16_Then, anon16_Else;
  ...
  anon16_Else:
    ...
    call {:si_unique_call 621} vslice_dummy_var_155 := SerialMousepIoSyncIoctlEx#0(0, 1769568, vslice_dummy_var_61, event_10, iosb_10, 0, 0, HandFlow__SERIAL_BASIC_SETTINGS(SerialBasicSettings__DEVICE_EXTENSION(DeviceExtension_21)), 16);
    goto anon17_Then, anon17_Else;
  ...
  anon17_Else:
    ...
    call {:si_unique_call 622} status_23 := SerialMousepIoSyncIoctlEx#0(0, 1769572, vslice_dummy_var_62, event_10, iosb_10, serialHandFlow, 16, 0, 0);
    goto anon18_Then, anon18_Else;
...
implementation {:origName "SerialMouseInitializePort"} SerialMouseInitializePort#1(actual_DeviceExtension_21: int) returns (Tmp_234: int)
{
  ...
  anon0:
    call {:si_unique_call 623} serialHandFlow := __HAVOC_malloc(16);
    call {:si_unique_call 624} serialTimeouts := __HAVOC_malloc(20);
    call {:si_unique_call 625} iosb_10 := __HAVOC_malloc(12);
    call {:si_unique_call 626} event_10 := __HAVOC_malloc(156);
    DeviceExtension_21 := actual_DeviceExtension_21;
    call {:si_unique_call 627} KeInitializeEvent(event_10, 0, 0);
    assume {:nonnull} DeviceExtension_21 != 0;
    assume DeviceExtension_21 > 0;
    havoc vslice_dummy_var_63;
    call {:si_unique_call 628} status_23 := SerialMousepIoSyncIoctlEx#1(1, 1769484, vslice_dummy_var_63, event_10, iosb_10, 0, 0, SerialBasicSettings__DEVICE_EXTENSION(DeviceExtension_21), 44);
    goto anon14_Then, anon14_Else;
  ...
  anon13_Then:
    ...
    call {:si_unique_call 629} vslice_dummy_var_156 := SerialMousepIoSyncIoctlEx#1(0, 1769504, vslice_dummy_var_64, event_10, iosb_10, 0, 0, Timeouts__SERIAL_BASIC_SETTINGS(SerialBasicSettings__DEVICE_EXTENSION(DeviceExtension_21)), 20);
    goto anon15_Then, anon15_Else;

  anon15_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 630} sdv_RtlZeroMemory(0, 20);
    assume {:nonnull} DeviceExtension_21 != 0;
    assume DeviceExtension_21 > 0;
    havoc vslice_dummy_var_65;
    call {:si_unique_call 631} vslice_dummy_var_157 := SerialMousepIoSyncIoctlEx#1(0, 1769500, vslice_dummy_var_65, event_10, iosb_10, serialTimeouts, 20, 0, 0);
    goto anon16_Then, anon16_Else;
  ...
  anon16_Else:
    ...
    call {:si_unique_call 632} vslice_dummy_var_158 := SerialMousepIoSyncIoctlEx#1(0, 1769568, vslice_dummy_var_66, event_10, iosb_10, 0, 0, HandFlow__SERIAL_BASIC_SETTINGS(SerialBasicSettings__DEVICE_EXTENSION(DeviceExtension_21)), 16);
    goto anon17_Then, anon17_Else;
  ...
  anon17_Else:
    ...
    call {:si_unique_call 633} status_23 := SerialMousepIoSyncIoctlEx#1(0, 1769572, vslice_dummy_var_67, event_10, iosb_10, serialHandFlow, 16, 0, 0);
    goto anon18_Then, anon18_Else;
...
implementation {:origName "MSerPowerDown"} MSerPowerDown#0(actual_DeviceExtension_24: int) returns (Tmp_245: int)
{
  ...
  anon0:
    call {:si_unique_call 634} iosb_12 := __HAVOC_malloc(12);
    call {:si_unique_call 635} event_12 := __HAVOC_malloc(156);
    DeviceExtension_24 := actual_DeviceExtension_24;
    call {:si_unique_call 636} sdv_do_paged_code_check();
    call {:si_unique_call 637} KeInitializeEvent(event_12, 0, 0);
    assume {:nonnull} DeviceExtension_24 != 0;
    assume DeviceExtension_24 > 0;
    havoc vslice_dummy_var_68;
    call {:si_unique_call 638} status_25 := SerialMousepIoSyncIoctl#0(0, 1769508, vslice_dummy_var_68, event_12, iosb_12);
    goto anon14_Then, anon14_Else;
  ...
  anon11_Else:
    ...
    call {:si_unique_call 639} status_25 := SerialMousepIoSyncIoctl#0(0, 1769524, vslice_dummy_var_69, event_12, iosb_12);
    goto anon15_Then, anon15_Else;
  ...
  anon12_Else:
    assume {:partition} status_25 >= 0;
    call {:si_unique_call 640} status_25 := SerialMouseWait(DeviceExtension_24, -2000000);
    goto anon13_Then, anon13_Else;
...
implementation {:origName "MSerPowerDown"} MSerPowerDown#1(actual_DeviceExtension_24: int) returns (Tmp_245: int)
{
  ...
  anon0:
    call {:si_unique_call 641} iosb_12 := __HAVOC_malloc(12);
    call {:si_unique_call 642} event_12 := __HAVOC_malloc(156);
    DeviceExtension_24 := actual_DeviceExtension_24;
    call {:si_unique_call 643} sdv_do_paged_code_check();
    call {:si_unique_call 644} KeInitializeEvent(event_12, 0, 0);
    assume {:nonnull} DeviceExtension_24 != 0;
    assume DeviceExtension_24 > 0;
    havoc vslice_dummy_var_70;
    call {:si_unique_call 645} status_25 := SerialMousepIoSyncIoctl#1(0, 1769508, vslice_dummy_var_70, event_12, iosb_12);
    goto anon14_Then, anon14_Else;
  ...
  anon11_Else:
    ...
    call {:si_unique_call 646} status_25 := SerialMousepIoSyncIoctl#1(0, 1769524, vslice_dummy_var_71, event_12, iosb_12);
    goto anon15_Then, anon15_Else;
  ...
  anon12_Else:
    assume {:partition} status_25 >= 0;
    call {:si_unique_call 647} status_25 := SerialMouseWait(DeviceExtension_24, -2000000);
    goto anon13_Then, anon13_Else;
...
implementation {:origName "SerialMouseSetBaudRate"} SerialMouseSetBaudRate#0(actual_DeviceExtension_9: int, actual_BaudRate_1: int) returns (Tmp_51: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 653} status_8 := SerialMousepIoSyncIoctlEx#0(0, 1769476, vslice_dummy_var_72, event_3, iosb_3, sbr, 4, 0, 0);
    goto anon3_Then, anon3_Else;
...
implementation {:origName "SerialMouseSetBaudRate"} SerialMouseSetBaudRate#1(actual_DeviceExtension_9: int, actual_BaudRate_1: int) returns (Tmp_51: int)
{
  ...
  anon0:
    call {:si_unique_call 654} sbr := __HAVOC_malloc(4);
    call {:si_unique_call 655} iosb_3 := __HAVOC_malloc(12);
    call {:si_unique_call 656} event_3 := __HAVOC_malloc(156);
    DeviceExtension_9 := actual_DeviceExtension_9;
    BaudRate_1 := actual_BaudRate_1;
    call {:si_unique_call 657} sdv_do_paged_code_check();
    call {:si_unique_call 658} KeInitializeEvent(event_3, 0, 0);
    assume {:nonnull} sbr != 0;
    assume sbr > 0;
    assume {:nonnull} DeviceExtension_9 != 0;
    assume DeviceExtension_9 > 0;
    havoc vslice_dummy_var_73;
    call {:si_unique_call 659} status_8 := SerialMousepIoSyncIoctlEx#1(0, 1769476, vslice_dummy_var_73, event_3, iosb_3, sbr, 4, 0, 0);
    goto anon3_Then, anon3_Else;
...
implementation {:origName "SerialMouseFlushReadBuffer"} SerialMouseFlushReadBuffer#0(actual_DeviceExtension_12: int) returns (Tmp_59: int)
{
  ...
  anon0:
    call {:si_unique_call 660} bits_3 := __HAVOC_malloc(4);
    call {:si_unique_call 661} iosb_6 := __HAVOC_malloc(12);
    call {:si_unique_call 662} event_4 := __HAVOC_malloc(156);
    DeviceExtension_12 := actual_DeviceExtension_12;
    assume {:nonnull} bits_3 != 0;
    assume bits_3 > 0;
    call {:si_unique_call 663} KeInitializeEvent(event_4, 0, 0);
    assume {:nonnull} DeviceExtension_12 != 0;
    assume DeviceExtension_12 > 0;
    havoc vslice_dummy_var_74;
    call {:si_unique_call 664} status_11 := SerialMousepIoSyncIoctlEx#0(0, 1769548, vslice_dummy_var_74, event_4, iosb_6, bits_3, 4, 0, 0);
    goto anon3_Then, anon3_Else;
...
implementation {:origName "SerialMouseFlushReadBuffer"} SerialMouseFlushReadBuffer#1(actual_DeviceExtension_12: int) returns (Tmp_59: int)
{
  ...
  anon0:
    call {:si_unique_call 665} bits_3 := __HAVOC_malloc(4);
    call {:si_unique_call 666} iosb_6 := __HAVOC_malloc(12);
    call {:si_unique_call 667} event_4 := __HAVOC_malloc(156);
    DeviceExtension_12 := actual_DeviceExtension_12;
    assume {:nonnull} bits_3 != 0;
    assume bits_3 > 0;
    call {:si_unique_call 668} KeInitializeEvent(event_4, 0, 0);
    assume {:nonnull} DeviceExtension_12 != 0;
    assume DeviceExtension_12 > 0;
    havoc vslice_dummy_var_75;
    call {:si_unique_call 669} status_11 := SerialMousepIoSyncIoctlEx#1(0, 1769548, vslice_dummy_var_75, event_4, iosb_6, bits_3, 4, 0, 0);
    goto anon3_Then, anon3_Else;
...
implementation {:origName "MSerPowerUp"} MSerPowerUp#0(actual_DeviceExtension_26: int) returns (Tmp_258: int)
{
  ...
  anon0:
    call {:si_unique_call 670} iosb_13 := __HAVOC_malloc(12);
    call {:si_unique_call 671} event_13 := __HAVOC_malloc(156);
    DeviceExtension_26 := actual_DeviceExtension_26;
    call {:si_unique_call 672} sdv_do_paged_code_check();
    call {:si_unique_call 673} KeInitializeEvent(event_13, 0, 0);
    assume {:nonnull} DeviceExtension_26 != 0;
    assume DeviceExtension_26 > 0;
    havoc vslice_dummy_var_76;
    call {:si_unique_call 674} status_27 := SerialMousepIoSyncIoctl#0(0, 1769512, vslice_dummy_var_76, event_13, iosb_13);
    goto anon27_Then, anon27_Else;
  ...
  anon21_Else:
    ...
    call {:si_unique_call 675} status_27 := SerialMousepIoSyncIoctl#0(0, 1769524, vslice_dummy_var_77, event_13, iosb_13);
    goto anon28_Then, anon28_Else;
  ...
  anon22_Else:
    assume {:partition} status_27 >= 0;
    call {:si_unique_call 676} status_27 := SerialMouseWait(DeviceExtension_26, -2000000);
    goto anon23_Then, anon23_Else;
  ...
  anon23_Else:
    ...
    call {:si_unique_call 677} status_27 := SerialMousepIoSyncIoctl#0(0, 1769508, vslice_dummy_var_78, event_13, iosb_13);
    goto anon29_Then, anon29_Else;
  ...
  anon24_Else:
    assume {:partition} status_27 >= 0;
    call {:si_unique_call 678} status_27 := SerialMouseWait(DeviceExtension_26, -2000000);
    goto anon25_Then, anon25_Else;
  ...
  anon25_Else:
    ...
    call {:si_unique_call 679} status_27 := SerialMousepIoSyncIoctl#0(0, 1769520, vslice_dummy_var_79, event_13, iosb_13);
    goto anon30_Then, anon30_Else;

  anon30_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 680} status_27 := SerialMouseWait(DeviceExtension_26, -1750000);
    goto anon26_Then, anon26_Else;
...
implementation {:origName "MSerPowerUp"} MSerPowerUp#1(actual_DeviceExtension_26: int) returns (Tmp_258: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 684} KeInitializeEvent(event_13, 0, 0);
    assume {:nonnull} DeviceExtension_26 != 0;
    assume DeviceExtension_26 > 0;
    havoc vslice_dummy_var_80;
    call {:si_unique_call 685} status_27 := SerialMousepIoSyncIoctl#1(0, 1769512, vslice_dummy_var_80, event_13, iosb_13);
    goto anon27_Then, anon27_Else;
  ...
  anon21_Else:
    ...
    call {:si_unique_call 686} status_27 := SerialMousepIoSyncIoctl#1(0, 1769524, vslice_dummy_var_81, event_13, iosb_13);
    goto anon28_Then, anon28_Else;
  ...
  anon22_Else:
    assume {:partition} status_27 >= 0;
    call {:si_unique_call 687} status_27 := SerialMouseWait(DeviceExtension_26, -2000000);
    goto anon23_Then, anon23_Else;
  ...
  anon23_Else:
    ...
    call {:si_unique_call 688} status_27 := SerialMousepIoSyncIoctl#1(0, 1769508, vslice_dummy_var_82, event_13, iosb_13);
    goto anon29_Then, anon29_Else;
  ...
  anon25_Else:
    ...
    call {:si_unique_call 690} status_27 := SerialMousepIoSyncIoctl#1(0, 1769520, vslice_dummy_var_83, event_13, iosb_13);
    goto anon30_Then, anon30_Else;

  anon30_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 691} status_27 := SerialMouseWait(DeviceExtension_26, -1750000);
    goto anon26_Then, anon26_Else;
...
implementation {:origName "SerialMouseSetReadTimeouts"} SerialMouseSetReadTimeouts#0(actual_DeviceExtension_22: int, actual_Timeout_2: int) returns (Tmp_236: int)
{
  ...
  L14:
    ...
    call {:si_unique_call 697} status_24 := SerialMousepIoSyncIoctlEx#0(0, 1769500, vslice_dummy_var_84, event_11, iosb_11, serialTimeouts_1, 20, 0, 0);
    goto anon6_Then, anon6_Else;
...
implementation {:origName "SerialMouseSetReadTimeouts"} SerialMouseSetReadTimeouts#1(actual_DeviceExtension_22: int, actual_Timeout_2: int) returns (Tmp_236: int)
{
  ...
  anon0:
    call {:si_unique_call 698} serialTimeouts_1 := __HAVOC_malloc(20);
    call {:si_unique_call 699} iosb_11 := __HAVOC_malloc(12);
    call {:si_unique_call 700} event_11 := __HAVOC_malloc(156);
    DeviceExtension_22 := actual_DeviceExtension_22;
    Timeout_2 := actual_Timeout_2;
    call {:si_unique_call 701} KeInitializeEvent(event_11, 0, 0);
    call {:si_unique_call 702} sdv_RtlZeroMemory(0, 20);
    goto anon5_Then, anon5_Else;
  ...
  L14:
    ...
    call {:si_unique_call 703} status_24 := SerialMousepIoSyncIoctlEx#1(0, 1769500, vslice_dummy_var_85, event_11, iosb_11, serialTimeouts_1, 20, 0, 0);
    goto anon6_Then, anon6_Else;
...
implementation {:origName "SerialMouseSetLineCtrl"} SerialMouseSetLineCtrl#0(actual_DeviceExtension_14: int, actual_SerialLineControl: int) returns (Tmp_63: int)
{
  ...
  anon0:
    call {:si_unique_call 704} iosb_8 := __HAVOC_malloc(12);
    call {:si_unique_call 705} event_6 := __HAVOC_malloc(156);
    ...
    call {:si_unique_call 707} KeInitializeEvent(event_6, 0, 0);
    assume {:nonnull} DeviceExtension_14 != 0;
    assume DeviceExtension_14 > 0;
    havoc vslice_dummy_var_86;
    call {:si_unique_call 708} status_13 := SerialMousepIoSyncIoctlEx#0(0, 1769484, vslice_dummy_var_86, event_6, iosb_8, SerialLineControl, 3, 0, 0);
    goto anon3_Then, anon3_Else;
...
implementation {:origName "SerialMouseSetLineCtrl"} SerialMouseSetLineCtrl#1(actual_DeviceExtension_14: int, actual_SerialLineControl: int) returns (Tmp_63: int)
{
  ...
  anon0:
    call {:si_unique_call 709} iosb_8 := __HAVOC_malloc(12);
    call {:si_unique_call 710} event_6 := __HAVOC_malloc(156);
    DeviceExtension_14 := actual_DeviceExtension_14;
    SerialLineControl := actual_SerialLineControl;
    call {:si_unique_call 711} sdv_do_paged_code_check();
    call {:si_unique_call 712} KeInitializeEvent(event_6, 0, 0);
    assume {:nonnull} DeviceExtension_14 != 0;
    assume DeviceExtension_14 > 0;
    havoc vslice_dummy_var_87;
    call {:si_unique_call 713} status_13 := SerialMousepIoSyncIoctlEx#1(0, 1769484, vslice_dummy_var_87, event_6, iosb_8, SerialLineControl, 3, 0, 0);
    goto anon3_Then, anon3_Else;
...
implementation {:origName "SerialMouseReadChar"} SerialMouseReadChar#0(actual_DeviceExtension_8: int, actual_Value: int) returns (Tmp_49: int)
{
  ...
  anon0:
    call {:si_unique_call 714} actual := __HAVOC_malloc(4);
    DeviceExtension_8 := actual_DeviceExtension_8;
    Value := actual_Value;
    call {:si_unique_call 715} sdv_do_paged_code_check();
    call {:si_unique_call 716} status_7 := SerialMouseReadSerialPort#0(DeviceExtension_8, Value, 1, actual);
    goto anon9_Then, anon9_Else;
...
implementation {:origName "SerialMouseReadChar"} SerialMouseReadChar#1(actual_DeviceExtension_8: int, actual_Value: int) returns (Tmp_49: int)
{
  ...
  anon0:
    call {:si_unique_call 717} actual := __HAVOC_malloc(4);
    DeviceExtension_8 := actual_DeviceExtension_8;
    Value := actual_Value;
    call {:si_unique_call 718} sdv_do_paged_code_check();
    call {:si_unique_call 719} status_7 := SerialMouseReadSerialPort#1(DeviceExtension_8, Value, 1, actual);
    goto anon9_Then, anon9_Else;
...
implementation {:origName "SerialMouseReadSerialPort"} SerialMouseReadSerialPort#0(actual_DeviceExtension_18: int, actual_ReadBuffer: int, actual_Buflen: int, actual_ActualBytesRead: int) returns (Tmp_220: int)
{
  ...
  anon16_Else:
    call {:si_unique_call 722} KeClearEvent(event_9);
    call {:si_unique_call 723} IoReuseIrp(irp_4, 0);
    assume {:nonnull} irp_4 != 0;
    assume irp_4 > 0;
    call {:si_unique_call 724} stack_1 := sdv_IoGetNextIrpStackLocation(irp_4);
    ...
    assume {:nonnull} stack_1 != 0;
    assume stack_1 > 0;
    call {:si_unique_call 725} sdv_IoSetCompletionRoutine(irp_4, li2bplFunctionConstant256, event_9, 1, 1, 1);
    assume {:nonnull} DeviceExtension_18 != 0;
    assume DeviceExtension_18 > 0;
    assume false;
    return;
...
implementation {:origName "SerialMouseReadSerialPort"} SerialMouseReadSerialPort#1(actual_DeviceExtension_18: int, actual_ReadBuffer: int, actual_Buflen: int, actual_ActualBytesRead: int) returns (Tmp_220: int)
{
  ...
  anon0:
    call {:si_unique_call 726} event_9 := __HAVOC_malloc(156);
    DeviceExtension_18 := actual_DeviceExtension_18;
    ReadBuffer := actual_ReadBuffer;
    Buflen := actual_Buflen;
    ActualBytesRead := actual_ActualBytesRead;
    status_20 := 0;
    call {:si_unique_call 727} KeInitializeEvent(event_9, 0, 0);
    goto anon15_Then, anon15_Else;
  ...
  L15:
    call {:si_unique_call 728} status_20, stack_1 := SerialMouseReadSerialPort#1_loop_L15(irp_4, status_20, event_9, stack_1, DeviceExtension_18, ReadBuffer, Buflen, ActualBytesRead);
    goto L15_last;
  ...
  anon16_Else:
    call {:si_unique_call 729} KeClearEvent(event_9);
    call {:si_unique_call 730} IoReuseIrp(irp_4, 0);
    assume {:nonnull} irp_4 != 0;
    assume irp_4 > 0;
    call {:si_unique_call 731} stack_1 := sdv_IoGetNextIrpStackLocation(irp_4);
    assume {:nonnull} stack_1 != 0;
    assume stack_1 > 0;
    assume {:nonnull} stack_1 != 0;
    assume stack_1 > 0;
    assume {:nonnull} stack_1 != 0;
    assume stack_1 > 0;
    call {:si_unique_call 732} sdv_IoSetCompletionRoutine(irp_4, li2bplFunctionConstant256, event_9, 1, 1, 1);
    assume {:nonnull} DeviceExtension_18 != 0;
    assume DeviceExtension_18 > 0;
    havoc vslice_dummy_var_88;
    call {:si_unique_call 733} status_20 := sdv_IoCallDriver#0(vslice_dummy_var_88, irp_4);
    goto anon21_Then, anon21_Else;
  ...
  anon17_Else:
    ...
    call {:si_unique_call 734} status_20 := KeWaitForSingleObject(0, 0, 0, 0, 0);
    goto anon19_Then, anon19_Else;
...
implementation {:origName "CSerDetect"} CSerDetect#0(actual_DeviceExtension_3: int, actual_HardwareButtons: int) returns (Tmp_18: int)
{
  ...
  anon0:
    call {:si_unique_call 735} numButtons := __HAVOC_malloc(4);
    call {:si_unique_call 736} status_1 := __HAVOC_malloc(4);
    ...
    call {:si_unique_call 738} vslice_dummy_var_159 := CSerPowerUp#0(DeviceExtension_3);
    goto anon53_Then, anon53_Else;

  anon53_Else:
    assume {:partition} yogi_error != 1;
    havoc Tmp_22;
    call {:si_unique_call 739} vslice_dummy_var_168 := SerialMouseSetLineCtrl#0(DeviceExtension_3, Tmp_22);
    goto anon54_Then, anon54_Else;
  ...
  L20:
    call {:si_unique_call 740} Tmp_19, count_1, Tmp_21, sdv_14, vslice_dummy_var_160, vslice_dummy_var_161, vslice_dummy_var_162, vslice_dummy_var_163, vslice_dummy_var_169 := CSerDetect#0_loop_L20(Tmp_19, count_1, Tmp_21, sdv_14, status_1, DeviceExtension_3, vslice_dummy_var_160, vslice_dummy_var_161, vslice_dummy_var_162, vslice_dummy_var_163, vslice_dummy_var_169);
    goto L20_last;
  ...
  anon47_Else:
    ...
    Tmp_19 := count_1;
    havoc Tmp_21;
    call {:si_unique_call 741} vslice_dummy_var_169 := SerialMouseSetBaudRate#0(DeviceExtension_3, Tmp_21);
    goto anon55_Then, anon55_Else;

  anon55_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 742} CSerSetReportRate#0(DeviceExtension_3, 0);
    goto anon56_Then, anon56_Else;

  anon56_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 743} vslice_dummy_var_160 := CSerSetProtocol#0(DeviceExtension_3, 0);
    goto anon57_Then, anon57_Else;

  anon57_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 744} vslice_dummy_var_161 := SerialMouseWriteChar#0(DeviceExtension_3, 115);
    goto anon58_Then, anon58_Else;

  anon58_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 745} vslice_dummy_var_162 := SerialMouseFlushReadBuffer#0(DeviceExtension_3);
    goto anon59_Then, anon59_Else;

  anon59_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 746} vslice_dummy_var_163 := SerialMouseSetReadTimeouts#0(DeviceExtension_3, 50);
    goto anon60_Then, anon60_Else;

  anon60_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 747} sdv_14 := SerialMouseReadChar#0(DeviceExtension_3, status_1);
    goto anon61_Then, anon61_Else;
  ...
  anon48_Else:
    ...
    call {:si_unique_call 748} vslice_dummy_var_164 := SerialMouseWriteChar#0(DeviceExtension_3, 107);
    goto anon62_Then, anon62_Else;

  anon62_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 749} vslice_dummy_var_165 := SerialMouseFlushReadBuffer#0(DeviceExtension_3);
    goto anon63_Then, anon63_Else;

  anon63_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 750} vslice_dummy_var_166 := SerialMouseSetReadTimeouts#0(DeviceExtension_3, 50);
    goto anon64_Then, anon64_Else;

  anon64_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 751} sdv_9 := SerialMouseReadChar#0(DeviceExtension_3, numButtons);
    goto anon65_Then, anon65_Else;
  ...
  L70:
    call {:si_unique_call 752} vslice_dummy_var_167 := SerialMouseSetReadTimeouts#0(DeviceExtension_3, 0);
    goto anon67_Then, anon67_Else;
  ...
  L49:
    call {:si_unique_call 753} CSerSetBaudRate#0(DeviceExtension_3, 1200);
    goto anon68_Then, anon68_Else;

  anon68_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 754} CSerSetReportRate#0(DeviceExtension_3, 150);
    goto anon69_Then, anon69_Else;
...
implementation {:origName "CSerDetect"} CSerDetect#1(actual_DeviceExtension_3: int, actual_HardwareButtons: int) returns (Tmp_18: int)
{
  ...
  anon0:
    call {:si_unique_call 755} numButtons := __HAVOC_malloc(4);
    call {:si_unique_call 756} status_1 := __HAVOC_malloc(4);
    DeviceExtension_3 := actual_DeviceExtension_3;
    HardwareButtons := actual_HardwareButtons;
    detected := 0;
    assume {:nonnull} status_1 != 0;
    ...
    call {:si_unique_call 758} vslice_dummy_var_170 := CSerPowerUp#1(DeviceExtension_3);
    goto anon53_Then, anon53_Else;

  anon53_Else:
    assume {:partition} yogi_error != 1;
    havoc Tmp_22;
    call {:si_unique_call 759} vslice_dummy_var_179 := SerialMouseSetLineCtrl#1(DeviceExtension_3, Tmp_22);
    goto anon54_Then, anon54_Else;
  ...
  anon47_Else:
    ...
    Tmp_19 := count_1;
    havoc Tmp_21;
    call {:si_unique_call 761} vslice_dummy_var_180 := SerialMouseSetBaudRate#1(DeviceExtension_3, Tmp_21);
    goto anon55_Then, anon55_Else;

  anon55_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 762} CSerSetReportRate#1(DeviceExtension_3, 0);
    goto anon56_Then, anon56_Else;

  anon56_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 763} vslice_dummy_var_171 := CSerSetProtocol#1(DeviceExtension_3, 0);
    goto anon57_Then, anon57_Else;

  anon57_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 764} vslice_dummy_var_172 := SerialMouseWriteChar#1(DeviceExtension_3, 115);
    goto anon58_Then, anon58_Else;

  anon58_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 765} vslice_dummy_var_173 := SerialMouseFlushReadBuffer#1(DeviceExtension_3);
    goto anon59_Then, anon59_Else;

  anon59_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 766} vslice_dummy_var_174 := SerialMouseSetReadTimeouts#1(DeviceExtension_3, 50);
    goto anon60_Then, anon60_Else;

  anon60_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 767} sdv_14 := SerialMouseReadChar#1(DeviceExtension_3, status_1);
    goto anon61_Then, anon61_Else;
  ...
  anon48_Else:
    assume {:partition} detected != 0;
    call {:si_unique_call 768} vslice_dummy_var_175 := SerialMouseWriteChar#1(DeviceExtension_3, 107);
    goto anon62_Then, anon62_Else;

  anon62_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 769} vslice_dummy_var_176 := SerialMouseFlushReadBuffer#1(DeviceExtension_3);
    goto anon63_Then, anon63_Else;

  anon63_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 770} vslice_dummy_var_177 := SerialMouseSetReadTimeouts#1(DeviceExtension_3, 50);
    goto anon64_Then, anon64_Else;

  anon64_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 771} sdv_9 := SerialMouseReadChar#1(DeviceExtension_3, numButtons);
    goto anon65_Then, anon65_Else;
  ...
  L70:
    call {:si_unique_call 772} vslice_dummy_var_178 := SerialMouseSetReadTimeouts#1(DeviceExtension_3, 0);
    goto anon67_Then, anon67_Else;
  ...
  L49:
    call {:si_unique_call 773} CSerSetBaudRate#1(DeviceExtension_3, 1200);
    goto anon68_Then, anon68_Else;

  anon68_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 774} CSerSetReportRate#1(DeviceExtension_3, 150);
    goto anon69_Then, anon69_Else;
...
implementation {:origName "CSerSetReportRate"} CSerSetReportRate#0(actual_DeviceExtension_1: int, actual_ReportRate: int)
{
  ...
  anon0:
    call {:si_unique_call 775} vslice_dummy_var_181 := __HAVOC_malloc(4);
    DeviceExtension_1 := actual_DeviceExtension_1;
    ReportRate := actual_ReportRate;
    call {:si_unique_call 776} sdv_do_paged_code_check();
    count := 8;
    goto L8;

  L8:
    call {:si_unique_call 777} count, Tmp_7 := CSerSetReportRate#0_loop_L8(count, Tmp_7, ReportRate);
    goto L8_last;
  ...
  anon8_Else:
    Tmp_9 := count;
    havoc Tmp_6;
    call {:si_unique_call 778} vslice_dummy_var_182 := SerialMouseWriteChar#0(DeviceExtension_1, Tmp_6);
    goto anon9_Then, anon9_Else;
...
implementation {:origName "CSerSetReportRate"} CSerSetReportRate#1(actual_DeviceExtension_1: int, actual_ReportRate: int)
{
  ...
  anon0:
    call {:si_unique_call 779} vslice_dummy_var_183 := __HAVOC_malloc(4);
    DeviceExtension_1 := actual_DeviceExtension_1;
    ReportRate := actual_ReportRate;
  ...
  L8:
    call {:si_unique_call 781} count, Tmp_7 := CSerSetReportRate#1_loop_L8(count, Tmp_7, ReportRate);
    goto L8_last;
  ...
  anon8_Else:
    Tmp_9 := count;
    havoc Tmp_6;
    call {:si_unique_call 782} vslice_dummy_var_184 := SerialMouseWriteChar#1(DeviceExtension_1, Tmp_6);
    goto anon9_Then, anon9_Else;
...
implementation {:origName "SerialMouseWriteChar"} SerialMouseWriteChar#0(actual_DeviceExtension_11: int, actual_Value_1: int) returns (Tmp_57: int)
{
  ...
  anon0:
    call {:si_unique_call 783} iosb_5 := __HAVOC_malloc(12);
    DeviceExtension_11 := actual_DeviceExtension_11;
    call {:si_unique_call 784} Value_1 := __HAVOC_malloc(4);
    call {:si_unique_call 785} sdv_do_paged_code_check();
    call {:si_unique_call 786} status_10 := SerialMouseWriteSerialPort#0(DeviceExtension_11, Value_1, 1, iosb_5);
    goto anon3_Then, anon3_Else;
...
implementation {:origName "SerialMouseWriteChar"} SerialMouseWriteChar#1(actual_DeviceExtension_11: int, actual_Value_1: int) returns (Tmp_57: int)
{
  ...
  anon0:
    call {:si_unique_call 787} iosb_5 := __HAVOC_malloc(12);
    DeviceExtension_11 := actual_DeviceExtension_11;
    call {:si_unique_call 788} Value_1 := __HAVOC_malloc(4);
    call {:si_unique_call 789} sdv_do_paged_code_check();
    call {:si_unique_call 790} status_10 := SerialMouseWriteSerialPort#1(DeviceExtension_11, Value_1, 1, iosb_5);
    goto anon3_Then, anon3_Else;
...
implementation {:origName "SerialMouseWriteSerialPort"} SerialMouseWriteSerialPort#0(actual_DeviceExtension_17: int, actual_WriteBuffer: int, actual_NumBytes: int, actual_IoStatusBlock_2: int) returns (Tmp_216: int)
{
  ...
  anon0:
    call {:si_unique_call 791} startingOffset := __HAVOC_malloc(20);
    call {:si_unique_call 792} event_8 := __HAVOC_malloc(156);
    ...
    call {:si_unique_call 793} KeInitializeEvent(event_8, 0, 0);
    call {:si_unique_call 794} irp_3 := IoBuildSynchronousFsdRequest(4, 0, 0, NumBytes, 0, 0, IoStatusBlock_2);
    goto anon7_Then, anon7_Else;
...
implementation {:origName "SerialMouseWriteSerialPort"} SerialMouseWriteSerialPort#1(actual_DeviceExtension_17: int, actual_WriteBuffer: int, actual_NumBytes: int, actual_IoStatusBlock_2: int) returns (Tmp_216: int)
{
  ...
  anon0:
    call {:si_unique_call 795} startingOffset := __HAVOC_malloc(20);
    call {:si_unique_call 796} event_8 := __HAVOC_malloc(156);
    DeviceExtension_17 := actual_DeviceExtension_17;
    NumBytes := actual_NumBytes;
    IoStatusBlock_2 := actual_IoStatusBlock_2;
    assume {:nonnull} startingOffset != 0;
    assume startingOffset > 0;
    call {:si_unique_call 797} KeInitializeEvent(event_8, 0, 0);
    call {:si_unique_call 798} irp_3 := IoBuildSynchronousFsdRequest(4, 0, 0, NumBytes, 0, 0, IoStatusBlock_2);
    goto anon7_Then, anon7_Else;
  ...
  anon7_Else:
    ...
    call {:si_unique_call 799} status_19 := sdv_IoCallDriver#0(vslice_dummy_var_89, irp_3);
    goto anon9_Then, anon9_Else;
  ...
  anon8_Else:
    ...
    call {:si_unique_call 800} vslice_dummy_var_186 := KeWaitForSingleObject(0, 0, 0, 0, 0);
    goto L22;
...
implementation {:origName "CSerSetProtocol"} CSerSetProtocol#0(actual_DeviceExtension_2: int, actual_NewProtocol: int) returns (Tmp_11: int)
{
  ...
  anon0:
    ...
    Tmp_16 := NewProtocol;
    havoc Tmp_12;
    call {:si_unique_call 802} vslice_dummy_var_187 := SerialMouseWriteChar#0(DeviceExtension_2, Tmp_12);
    goto anon5_Then, anon5_Else;
  ...
  anon5_Else:
    ...
    Tmp_15 := NewProtocol;
    havoc Tmp_14;
    call {:si_unique_call 803} vslice_dummy_var_188 := SerialMouseSetLineCtrl#0(DeviceExtension_2, Tmp_14);
    goto anon6_Then, anon6_Else;
...
implementation {:origName "CSerSetProtocol"} CSerSetProtocol#1(actual_DeviceExtension_2: int, actual_NewProtocol: int) returns (Tmp_11: int)
{
  ...
  anon0:
    ...
    Tmp_16 := NewProtocol;
    havoc Tmp_12;
    call {:si_unique_call 805} vslice_dummy_var_189 := SerialMouseWriteChar#1(DeviceExtension_2, Tmp_12);
    goto anon5_Then, anon5_Else;
  ...
  anon5_Else:
    ...
    Tmp_15 := NewProtocol;
    havoc Tmp_14;
    call {:si_unique_call 806} vslice_dummy_var_190 := SerialMouseSetLineCtrl#1(DeviceExtension_2, Tmp_14);
    goto anon6_Then, anon6_Else;
...
implementation {:origName "CSerSetBaudRate"} CSerSetBaudRate#0(actual_DeviceExtension_4: int, actual_BaudRate: int)
{
  ...
  anon0:
    call {:si_unique_call 807} vslice_dummy_var_191 := __HAVOC_malloc(4);
    DeviceExtension_4 := actual_DeviceExtension_4;
    BaudRate := actual_BaudRate;
    call {:si_unique_call 808} sdv_do_paged_code_check();
    call {:si_unique_call 809} CSerSetReportRate#0(DeviceExtension_4, 0);
    goto anon12_Then, anon12_Else;
  ...
  L11:
    call {:si_unique_call 810} count_2, Tmp_27 := CSerSetBaudRate#0_loop_L11(count_2, Tmp_27, BaudRate);
    goto L11_last;
  ...
  anon13_Else:
    Tmp_24 := count_2;
    havoc Tmp_29;
    call {:si_unique_call 811} vslice_dummy_var_193 := SerialMouseWriteString#0(DeviceExtension_4, Tmp_29);
    goto anon14_Then, anon14_Else;
  ...
  anon14_Else:
    ...
    Tmp_23 := count_2;
    havoc Tmp_28;
    call {:si_unique_call 812} vslice_dummy_var_194 := SerialMouseSetBaudRate#0(DeviceExtension_4, Tmp_28);
    goto anon15_Then, anon15_Else;

  anon15_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 813} vslice_dummy_var_192 := SerialMouseWait(DeviceExtension_4, -20000);
    goto L1;
...
implementation {:origName "CSerSetBaudRate"} CSerSetBaudRate#1(actual_DeviceExtension_4: int, actual_BaudRate: int)
{
  ...
  anon0:
    call {:si_unique_call 814} vslice_dummy_var_195 := __HAVOC_malloc(4);
    DeviceExtension_4 := actual_DeviceExtension_4;
    BaudRate := actual_BaudRate;
    call {:si_unique_call 815} sdv_do_paged_code_check();
    call {:si_unique_call 816} CSerSetReportRate#1(DeviceExtension_4, 0);
    goto anon12_Then, anon12_Else;
  ...
  L11:
    call {:si_unique_call 817} count_2, Tmp_27 := CSerSetBaudRate#1_loop_L11(count_2, Tmp_27, BaudRate);
    goto L11_last;
  ...
  anon13_Else:
    Tmp_24 := count_2;
    havoc Tmp_29;
    call {:si_unique_call 818} vslice_dummy_var_197 := SerialMouseWriteString#1(DeviceExtension_4, Tmp_29);
    goto anon14_Then, anon14_Else;
  ...
  anon14_Else:
    ...
    Tmp_23 := count_2;
    havoc Tmp_28;
    call {:si_unique_call 819} vslice_dummy_var_198 := SerialMouseSetBaudRate#1(DeviceExtension_4, Tmp_28);
    goto anon15_Then, anon15_Else;

  anon15_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 820} vslice_dummy_var_196 := SerialMouseWait(DeviceExtension_4, -20000);
    goto L1;
...
implementation {:origName "SerialMouseWriteString"} SerialMouseWriteString#0(actual_DeviceExtension_10: int, actual_Buffer: int) returns (Tmp_53: int)
{
  ...
  anon0:
    call {:si_unique_call 821} iosb_4 := __HAVOC_malloc(12);
    DeviceExtension_10 := actual_DeviceExtension_10;
    Buffer := actual_Buffer;
    call {:si_unique_call 822} sdv_do_paged_code_check();
    call {:si_unique_call 823} status_9 := SerialMouseWriteSerialPort#0(DeviceExtension_10, Buffer, sdv_50, iosb_4);
    goto anon3_Then, anon3_Else;
...
implementation {:origName "SerialMouseWriteString"} SerialMouseWriteString#1(actual_DeviceExtension_10: int, actual_Buffer: int) returns (Tmp_53: int)
{
  ...
  anon0:
    call {:si_unique_call 824} iosb_4 := __HAVOC_malloc(12);
    DeviceExtension_10 := actual_DeviceExtension_10;
    Buffer := actual_Buffer;
    call {:si_unique_call 825} sdv_do_paged_code_check();
    call {:si_unique_call 826} status_9 := SerialMouseWriteSerialPort#1(DeviceExtension_10, Buffer, sdv_50, iosb_4);
    goto anon3_Then, anon3_Else;
...
implementation {:origName "MSerSetProtocol"} MSerSetProtocol#0(actual_DeviceExtension_23: int, actual_NewProtocol_1: int) returns (Tmp_238: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 827} sdv_do_paged_code_check();
    goto anon5_Then, anon5_Else;
  ...
  L7:
    ...
    havoc Tmp_240;
    call {:si_unique_call 828} vslice_dummy_var_199 := SerialMouseSetLineCtrl#0(DeviceExtension_23, Tmp_240);
    goto anon6_Then, anon6_Else;
...
implementation {:origName "MSerSetProtocol"} MSerSetProtocol#1(actual_DeviceExtension_23: int, actual_NewProtocol_1: int) returns (Tmp_238: int)
{
  ...
  L7:
    Tmp_242 := NewProtocol_1;
    havoc Tmp_240;
    call {:si_unique_call 830} vslice_dummy_var_200 := SerialMouseSetLineCtrl#1(DeviceExtension_23, Tmp_240);
    goto anon6_Then, anon6_Else;
...
implementation {:origName "SerialMouseSetFifo"} SerialMouseSetFifo#0(actual_DeviceExtension_13: int, actual_Value_2: int) returns (Tmp_61: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 836} status_12 := SerialMousepIoSyncIoctlEx#0(0, 1769628, vslice_dummy_var_90, event_5, iosb_7, fifo, 4, 0, 0);
    goto anon3_Then, anon3_Else;
...
implementation {:origName "SerialMouseSetFifo"} SerialMouseSetFifo#1(actual_DeviceExtension_13: int, actual_Value_2: int) returns (Tmp_61: int)
{
  ...
  anon0:
    call {:si_unique_call 837} fifo := __HAVOC_malloc(4);
    call {:si_unique_call 838} iosb_7 := __HAVOC_malloc(12);
    call {:si_unique_call 839} event_5 := __HAVOC_malloc(156);
    DeviceExtension_13 := actual_DeviceExtension_13;
    Value_2 := actual_Value_2;
    assume {:nonnull} fifo != 0;
    assume fifo > 0;
    call {:si_unique_call 840} sdv_do_paged_code_check();
    call {:si_unique_call 841} KeInitializeEvent(event_5, 0, 0);
    assume {:nonnull} DeviceExtension_13 != 0;
    assume DeviceExtension_13 > 0;
    havoc vslice_dummy_var_91;
    call {:si_unique_call 842} status_12 := SerialMousepIoSyncIoctlEx#1(0, 1769628, vslice_dummy_var_91, event_5, iosb_7, fifo, 4, 0, 0);
    goto anon3_Then, anon3_Else;
...
implementation {:origName "SerialMouseStartDetection"} SerialMouseStartDetection#0(actual_DeviceExtension_6: int)
{
  ...
  anon0:
    call {:si_unique_call 843} vslice_dummy_var_201 := __HAVOC_malloc(4);
    call {:si_unique_call 844} bits_2 := __HAVOC_malloc(4);
    call {:si_unique_call 845} iosb_2 := __HAVOC_malloc(12);
    call {:si_unique_call 846} waitMask := __HAVOC_malloc(4);
    call {:si_unique_call 847} event_2 := __HAVOC_malloc(156);
    DeviceExtension_6 := actual_DeviceExtension_6;
    call {:si_unique_call 848} eventBits := __HAVOC_malloc(8);
    call {:si_unique_call 849} statusBits := __HAVOC_malloc(12);
  ...
  anon27_Then:
    call {:si_unique_call 851} KeInitializeEvent(event_2, 0, 0);
    assume {:nonnull} DeviceExtension_6 != 0;
    assume DeviceExtension_6 > 0;
    goto anon28_Then, anon28_Else;
  ...
  L29:
    ...
    call {:si_unique_call 852} status_6 := SerialMousepIoSyncIoctlEx#0(0, 1769540, vslice_dummy_var_92, event_2, iosb_2, waitMask, 4, 0, 0);
    goto anon34_Then, anon34_Else;
  ...
  L40:
    call {:si_unique_call 853} status_6 := SerialMouseSendWaitMaskIrp#0(DeviceExtension_6);
    goto anon36_Then, anon36_Else;
  ...
  anon30_Then:
    ...
    call {:si_unique_call 854} vslice_dummy_var_202 := IoCancelIrp(0);
    assume {:nonnull} DeviceExtension_6 != 0;
    assume DeviceExtension_6 > 0;
    goto L1;
  ...
  anon35_Then:
    ...
    call {:si_unique_call 855} boogieTmp := IoAllocateIrp(vslice_dummy_var_93, 0);
    assume {:nonnull} DeviceExtension_6 != 0;
    assume DeviceExtension_6 > 0;
  ...
  anon28_Then:
    ...
    call {:si_unique_call 856} status_6 := SerialMousepIoSyncIoctlEx#0(0, 1769576, vslice_dummy_var_94, event_2, iosb_2, 0, 0, bits_2, 4);
    goto anon37_Then, anon37_Else;
  ...
  L62:
    call {:si_unique_call 857} i, Tmp_42, Tmp_45, Tmp_46 := SerialMouseStartDetection#0_loop_L62(i, Tmp_42, bits_2, eventBits, statusBits, Tmp_45, Tmp_46, waitMask);
    goto L62_last;
...
implementation {:origName "SerialMouseStartDetection"} SerialMouseStartDetection#1(actual_DeviceExtension_6: int)
{
  ...
  anon0:
    call {:si_unique_call 858} vslice_dummy_var_203 := __HAVOC_malloc(4);
    call {:si_unique_call 859} bits_2 := __HAVOC_malloc(4);
    call {:si_unique_call 860} iosb_2 := __HAVOC_malloc(12);
    call {:si_unique_call 861} waitMask := __HAVOC_malloc(4);
    call {:si_unique_call 862} event_2 := __HAVOC_malloc(156);
    DeviceExtension_6 := actual_DeviceExtension_6;
    call {:si_unique_call 863} eventBits := __HAVOC_malloc(8);
    call {:si_unique_call 864} statusBits := __HAVOC_malloc(12);
    assume {:nonnull} bits_2 != 0;
    assume bits_2 > 0;
    assume {:nonnull} statusBits != 0;
    assume statusBits > 0;
  ...
  anon27_Then:
    call {:si_unique_call 866} KeInitializeEvent(event_2, 0, 0);
    assume {:nonnull} DeviceExtension_6 != 0;
    assume DeviceExtension_6 > 0;
    goto anon28_Then, anon28_Else;
  ...
  L29:
    ...
    call {:si_unique_call 867} status_6 := SerialMousepIoSyncIoctlEx#1(0, 1769540, vslice_dummy_var_95, event_2, iosb_2, waitMask, 4, 0, 0);
    goto anon34_Then, anon34_Else;
  ...
  L40:
    call {:si_unique_call 868} status_6 := SerialMouseSendWaitMaskIrp#1(DeviceExtension_6);
    goto anon36_Then, anon36_Else;
  ...
  anon30_Then:
    assume {:partition} 0 > status_6;
    call {:si_unique_call 869} vslice_dummy_var_204 := IoCancelIrp(0);
    assume {:nonnull} DeviceExtension_6 != 0;
    assume DeviceExtension_6 > 0;
    goto L1;
  ...
  anon35_Then:
    ...
    call {:si_unique_call 870} boogieTmp := IoAllocateIrp(vslice_dummy_var_96, 0);
    assume {:nonnull} DeviceExtension_6 != 0;
    assume DeviceExtension_6 > 0;
    goto anon31_Then, anon31_Else;
  ...
  anon28_Then:
    ...
    call {:si_unique_call 871} status_6 := SerialMousepIoSyncIoctlEx#1(0, 1769576, vslice_dummy_var_97, event_2, iosb_2, 0, 0, bits_2, 4);
    goto anon37_Then, anon37_Else;
  ...
  L62:
    call {:si_unique_call 872} i, Tmp_42, Tmp_45, Tmp_46 := SerialMouseStartDetection#1_loop_L62(i, Tmp_42, bits_2, eventBits, statusBits, Tmp_45, Tmp_46, waitMask);
    goto L62_last;
...
implementation {:origName "SerialMouseSpinUpRead"} SerialMouseSpinUpRead#0(actual_DeviceExtension_29: int) returns (Tmp_303: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 874} vslice_dummy_var_205 := sdv_IoAcquireRemoveLock(0, 0);
    assume {:nonnull} DeviceExtension_29 != 0;
    assume DeviceExtension_29 > 0;
    call {:si_unique_call 875} status_30 := SerialMouseStartRead#0(DeviceExtension_29);
    goto anon9_Then, anon9_Else;
...
implementation {:origName "SerialMouseSpinUpRead"} SerialMouseSpinUpRead#1(actual_DeviceExtension_29: int) returns (Tmp_303: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 877} vslice_dummy_var_206 := sdv_IoAcquireRemoveLock(0, 0);
    assume {:nonnull} DeviceExtension_29 != 0;
    assume DeviceExtension_29 > 0;
    call {:si_unique_call 878} status_30 := SerialMouseStartRead#1(DeviceExtension_29);
    goto anon9_Then, anon9_Else;
...
implementation {:origName "SerialMouseClosePort"} SerialMouseClosePort#0(actual_DeviceExtension_31: int, actual_Irp_12: int)
{
  ...
  anon0:
    call {:si_unique_call 879} vslice_dummy_var_207 := __HAVOC_malloc(4);
    DeviceExtension_31 := actual_DeviceExtension_31;
    Irp_12 := actual_Irp_12;
    call {:si_unique_call 880} sdv_do_paged_code_check();
    call {:si_unique_call 881} SerialMouseRestorePort#0(DeviceExtension_31);
    goto anon7_Then, anon7_Else;

  anon7_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 882} next_1 := sdv_IoGetNextIrpStackLocation(Irp_12);
    call {:si_unique_call 883} sdv_RtlZeroMemory(0, 36);
    assume {:nonnull} next_1 != 0;
    assume next_1 > 0;
    assume {:nonnull} DeviceExtension_31 != 0;
    assume DeviceExtension_31 > 0;
    havoc vslice_dummy_var_98;
    call {:si_unique_call 884} vslice_dummy_var_208 := SerialMouseSendIrpSynchronously#0(vslice_dummy_var_98, Irp_12, 0);
    goto anon8_Then, anon8_Else;
  ...
  anon8_Else:
    ...
    call {:si_unique_call 887} vslice_dummy_var_209 := SerialMouseSendIrpSynchronously#0(vslice_dummy_var_99, Irp_12, 0);
    goto anon9_Then, anon9_Else;
...
implementation {:origName "SerialMouseClosePort"} SerialMouseClosePort#1(actual_DeviceExtension_31: int, actual_Irp_12: int)
{
  ...
  anon0:
    call {:si_unique_call 888} vslice_dummy_var_210 := __HAVOC_malloc(4);
    DeviceExtension_31 := actual_DeviceExtension_31;
    Irp_12 := actual_Irp_12;
    call {:si_unique_call 889} sdv_do_paged_code_check();
    call {:si_unique_call 890} SerialMouseRestorePort#1(DeviceExtension_31);
    goto anon7_Then, anon7_Else;

  anon7_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 891} next_1 := sdv_IoGetNextIrpStackLocation(Irp_12);
    call {:si_unique_call 892} sdv_RtlZeroMemory(0, 36);
    assume {:nonnull} next_1 != 0;
    assume next_1 > 0;
    assume {:nonnull} DeviceExtension_31 != 0;
    assume DeviceExtension_31 > 0;
    havoc vslice_dummy_var_100;
    call {:si_unique_call 893} vslice_dummy_var_211 := SerialMouseSendIrpSynchronously#1(vslice_dummy_var_100, Irp_12, 0);
    goto anon8_Then, anon8_Else;

  anon8_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 894} next_1 := sdv_IoGetNextIrpStackLocation(Irp_12);
    call {:si_unique_call 895} sdv_RtlZeroMemory(0, 36);
    assume {:nonnull} next_1 != 0;
    assume next_1 > 0;
    assume {:nonnull} DeviceExtension_31 != 0;
    assume DeviceExtension_31 > 0;
    havoc vslice_dummy_var_101;
    call {:si_unique_call 896} vslice_dummy_var_212 := SerialMouseSendIrpSynchronously#1(vslice_dummy_var_101, Irp_12, 0);
    goto anon9_Then, anon9_Else;
...
implementation {:origName "SerialMouseRestorePort"} SerialMouseRestorePort#0(actual_DeviceExtension_16: int)
{
  ...
  anon0:
    call {:si_unique_call 897} vslice_dummy_var_213 := __HAVOC_malloc(4);
    call {:si_unique_call 898} iosb_9 := __HAVOC_malloc(12);
    call {:si_unique_call 899} event_7 := __HAVOC_malloc(156);
    DeviceExtension_16 := actual_DeviceExtension_16;
    call {:si_unique_call 900} KeInitializeEvent(event_7, 0, 0);
    assume {:nonnull} DeviceExtension_16 != 0;
    assume DeviceExtension_16 > 0;
    havoc vslice_dummy_var_102;
    call {:si_unique_call 901} status_18 := SerialMousepIoSyncIoctlEx#0(1, 1769488, vslice_dummy_var_102, event_7, iosb_9, SerialBasicSettings__DEVICE_EXTENSION(DeviceExtension_16), 44, 0, 0);
    goto anon10_Then, anon10_Else;
  ...
  anon9_Else:
    ...
    call {:si_unique_call 902} vslice_dummy_var_214 := SerialMousepIoSyncIoctlEx#0(0, 1769500, vslice_dummy_var_103, event_7, iosb_9, Timeouts__SERIAL_BASIC_SETTINGS(SerialBasicSettings__DEVICE_EXTENSION(DeviceExtension_16)), 20, 0, 0);
    goto anon11_Then, anon11_Else;
  ...
  anon11_Else:
    ...
    call {:si_unique_call 903} vslice_dummy_var_215 := SerialMousepIoSyncIoctlEx#0(0, 1769572, vslice_dummy_var_104, event_7, iosb_9, HandFlow__SERIAL_BASIC_SETTINGS(SerialBasicSettings__DEVICE_EXTENSION(DeviceExtension_16)), 16, 0, 0);
    goto anon12_Then, anon12_Else;
...
implementation {:origName "SerialMouseRestorePort"} SerialMouseRestorePort#1(actual_DeviceExtension_16: int)
{
  ...
  anon0:
    call {:si_unique_call 904} vslice_dummy_var_216 := __HAVOC_malloc(4);
    call {:si_unique_call 905} iosb_9 := __HAVOC_malloc(12);
    call {:si_unique_call 906} event_7 := __HAVOC_malloc(156);
    DeviceExtension_16 := actual_DeviceExtension_16;
    call {:si_unique_call 907} KeInitializeEvent(event_7, 0, 0);
    assume {:nonnull} DeviceExtension_16 != 0;
    assume DeviceExtension_16 > 0;
    havoc vslice_dummy_var_105;
    call {:si_unique_call 908} status_18 := SerialMousepIoSyncIoctlEx#1(1, 1769488, vslice_dummy_var_105, event_7, iosb_9, SerialBasicSettings__DEVICE_EXTENSION(DeviceExtension_16), 44, 0, 0);
    goto anon10_Then, anon10_Else;
  ...
  anon9_Else:
    ...
    call {:si_unique_call 909} vslice_dummy_var_217 := SerialMousepIoSyncIoctlEx#1(0, 1769500, vslice_dummy_var_106, event_7, iosb_9, Timeouts__SERIAL_BASIC_SETTINGS(SerialBasicSettings__DEVICE_EXTENSION(DeviceExtension_16)), 20, 0, 0);
    goto anon11_Then, anon11_Else;
  ...
  anon11_Else:
    ...
    call {:si_unique_call 910} vslice_dummy_var_218 := SerialMousepIoSyncIoctlEx#1(0, 1769572, vslice_dummy_var_107, event_7, iosb_9, HandFlow__SERIAL_BASIC_SETTINGS(SerialBasicSettings__DEVICE_EXTENSION(DeviceExtension_16)), 16, 0, 0);
    goto anon12_Then, anon12_Else;
...
implementation {:origName "SerialMouseSendIrpSynchronously"} SerialMouseSendIrpSynchronously#0(actual_DeviceObject_23: int, actual_Irp_17: int, actual_CopyToNext: int) returns (Tmp_329: int)
{
  ...
  anon0:
    call {:si_unique_call 911} event_15 := __HAVOC_malloc(156);
    DeviceObject_23 := actual_DeviceObject_23;
    Irp_17 := actual_Irp_17;
    CopyToNext := actual_CopyToNext;
    call {:si_unique_call 912} sdv_do_paged_code_check();
    call {:si_unique_call 913} KeInitializeEvent(event_15, 1, 0);
    goto anon7_Then, anon7_Else;

  anon7_Else:
    assume {:partition} CopyToNext != 0;
    call {:si_unique_call 914} sdv_IoCopyCurrentIrpStackLocationToNext(Irp_17);
    goto L12;

  L12:
    call {:si_unique_call 915} sdv_IoSetCompletionRoutine(Irp_17, li2bplFunctionConstant188, event_15, 1, 1, 1);
    assume false;
    return;
...
implementation {:origName "SerialMouseSendIrpSynchronously"} SerialMouseSendIrpSynchronously#1(actual_DeviceObject_23: int, actual_Irp_17: int, actual_CopyToNext: int) returns (Tmp_329: int)
{
  ...
  anon0:
    call {:si_unique_call 916} event_15 := __HAVOC_malloc(156);
    DeviceObject_23 := actual_DeviceObject_23;
    Irp_17 := actual_Irp_17;
    CopyToNext := actual_CopyToNext;
    call {:si_unique_call 917} sdv_do_paged_code_check();
    call {:si_unique_call 918} KeInitializeEvent(event_15, 1, 0);
    goto anon7_Then, anon7_Else;

  anon7_Else:
    assume {:partition} CopyToNext != 0;
    call {:si_unique_call 919} sdv_IoCopyCurrentIrpStackLocationToNext(Irp_17);
    goto L12;

  L12:
    call {:si_unique_call 920} sdv_IoSetCompletionRoutine(Irp_17, li2bplFunctionConstant188, event_15, 1, 1, 1);
    call {:si_unique_call 921} status_37 := sdv_IoCallDriver#0(DeviceObject_23, Irp_17);
    goto anon9_Then, anon9_Else;
  ...
  anon8_Else:
    ...
    call {:si_unique_call 922} vslice_dummy_var_220 := KeWaitForSingleObject(0, 0, 0, 0, 0);
...
implementation {:SIextraRecBound 5} SerialMousePnP_loop_L88(in_i_4: int, in_devCaps: int, in_Tmp_344: int, in_Tmp_345: int) returns (out_i_4: int, out_Tmp_344: int, out_Tmp_345: int)
{
  ...
  anon106_Else_dummy:
    call {:si_unique_call 923} {:si_old_unique_call 1} out_i_4, out_Tmp_344, out_Tmp_345 := SerialMousePnP_loop_L88(out_i_4, in_devCaps, out_Tmp_344, out_Tmp_345);
    return;
}
...
implementation SerialMouseStartRead#1_loop_L11(in_sdv_124: int, in_Tmp_211: int, in_irp_2: int, in_status_17: int, in_irql: int, in_stack: int, in_DeviceExtension_15: int) returns (out_Tmp_211: int, out_status_17: int, out_irql: int, out_stack: int)
{
  ...
  anon15_Else:
    call {:si_unique_call 929} out_Tmp_211 := __HAVOC_malloc(4);
    assume {:nonnull} out_Tmp_211 != 0;
    assume out_Tmp_211 > 0;
    call {:si_unique_call 930} sdv_KeAcquireSpinLock(0, out_Tmp_211);
    assume {:nonnull} out_Tmp_211 != 0;
    assume out_Tmp_211 > 0;
    havoc out_irql;
    assume {:nonnull} in_DeviceExtension_15 != 0;
  ...
  anon16_Then:
    call {:si_unique_call 924} IoReuseIrp(in_irp_2, 0);
    call {:si_unique_call 925} sdv_KeReleaseSpinLock(0, out_irql);
    assume {:nonnull} in_DeviceExtension_15 != 0;
    assume in_DeviceExtension_15 > 0;
    assume {:nonnull} in_irp_2 != 0;
    assume in_irp_2 > 0;
    call {:si_unique_call 926} out_stack := sdv_IoGetNextIrpStackLocation(in_irp_2);
    ...
    assume {:nonnull} out_stack != 0;
    assume out_stack > 0;
    call {:si_unique_call 927} sdv_IoSetCompletionRoutine(in_irp_2, li2bplFunctionConstant251, in_DeviceExtension_15, 1, 1, 1);
    assume {:nonnull} in_DeviceExtension_15 != 0;
    assume in_DeviceExtension_15 > 0;
    havoc vslice_dummy_var_108;
    call {:si_unique_call 928} out_status_17 := sdv_IoCallDriver#0(vslice_dummy_var_108, in_irp_2);
    goto anon18_Else;
  ...
  anon17_Else_dummy:
    call {:si_unique_call 931} {:si_old_unique_call 1} out_Tmp_211, out_status_17, out_irql, out_stack := SerialMouseStartRead#1_loop_L11(in_sdv_124, out_Tmp_211, in_irp_2, out_status_17, out_irql, out_stack, in_DeviceExtension_15);
    return;
}
...
implementation SerialMouseInitializeDevice#0_loop_L57(in_i_3: int, in_Tmp_311: int, in_Tmp_313: int, in_errorLogEntry: int, in_Tmp_314: int, in_dumpData: int, in_dumpCount: int) returns (out_i_3: int, out_Tmp_311: int, out_Tmp_313: int, out_Tmp_314: int)
{
  ...
  anon23_Else_dummy:
    call {:si_unique_call 932} {:si_old_unique_call 1} out_i_3, out_Tmp_311, out_Tmp_313, out_Tmp_314 := SerialMouseInitializeDevice#0_loop_L57(out_i_3, out_Tmp_311, out_Tmp_313, in_errorLogEntry, out_Tmp_314, in_dumpData, in_dumpCount);
    return;
}
...
implementation {:SIextraRecBound 4} SerialMouseInitializeDevice#0_loop_L14(in_i_3: int, in_Tmp_310: int, in_dumpData: int) returns (out_i_3: int, out_Tmp_310: int)
{
  ...
  anon19_Else_dummy:
    call {:si_unique_call 933} {:si_old_unique_call 1} out_i_3, out_Tmp_310 := SerialMouseInitializeDevice#0_loop_L14(out_i_3, out_Tmp_310, in_dumpData);
    return;
}
...
implementation SerialMouseInitializeDevice#1_loop_L57(in_i_3: int, in_Tmp_311: int, in_Tmp_313: int, in_errorLogEntry: int, in_Tmp_314: int, in_dumpData: int, in_dumpCount: int) returns (out_i_3: int, out_Tmp_311: int, out_Tmp_313: int, out_Tmp_314: int)
{
  ...
  anon23_Else_dummy:
    call {:si_unique_call 934} {:si_old_unique_call 1} out_i_3, out_Tmp_311, out_Tmp_313, out_Tmp_314 := SerialMouseInitializeDevice#1_loop_L57(out_i_3, out_Tmp_311, out_Tmp_313, in_errorLogEntry, out_Tmp_314, in_dumpData, in_dumpCount);
    return;
}
...
implementation {:SIextraRecBound 4} SerialMouseInitializeDevice#1_loop_L14(in_i_3: int, in_Tmp_310: int, in_dumpData: int) returns (out_i_3: int, out_Tmp_310: int)
{
  ...
  anon19_Else_dummy:
    call {:si_unique_call 935} {:si_old_unique_call 1} out_i_3, out_Tmp_310 := SerialMouseInitializeDevice#1_loop_L14(out_i_3, out_Tmp_310, in_dumpData);
    return;
}
...
implementation MSerDetect#0_loop_L53(in_Tmp_248: int, in_count_3: int, in_receiveBuffer: int, in_Tmp_257: int, in_sdv_170: int, in_DeviceExtension_25: int) returns (out_Tmp_248: int, out_count_3: int, out_Tmp_257: int, out_sdv_170: int)
{
  ...
  anon48_Else:
    ...
    call {:si_unique_call 936} out_sdv_170 := SerialMouseReadChar#0(in_DeviceExtension_25, out_Tmp_248);
    goto anon64_Else;
...
implementation MSerDetect#1_loop_L53(in_Tmp_248: int, in_count_3: int, in_receiveBuffer: int, in_Tmp_257: int, in_sdv_170: int, in_DeviceExtension_25: int) returns (out_Tmp_248: int, out_count_3: int, out_Tmp_257: int, out_sdv_170: int)
{
  ...
  anon48_Else:
    ...
    out_Tmp_257 := out_count_3;
    out_Tmp_248 := in_receiveBuffer + out_Tmp_257 * 4;
    call {:si_unique_call 937} out_sdv_170 := SerialMouseReadChar#1(in_DeviceExtension_25, out_Tmp_248);
    goto anon64_Else;
  ...
  anon49_Else_dummy:
    call {:si_unique_call 938} {:si_old_unique_call 1} out_Tmp_248, out_count_3, out_Tmp_257, out_sdv_170 := MSerDetect#1_loop_L53(out_Tmp_248, out_count_3, in_receiveBuffer, out_Tmp_257, out_sdv_170, in_DeviceExtension_25);
    return;
}
...
implementation SerialMouseReadSerialPort#1_loop_L15(in_irp_4: int, in_status_20: int, in_event_9: int, in_stack_1: int, in_DeviceExtension_18: int, in_ReadBuffer: int, in_Buflen: int, in_ActualBytesRead: int) returns (out_status_20: int, out_stack_1: int)
{
  ...
  anon16_Else:
    call {:si_unique_call 939} KeClearEvent(in_event_9);
    call {:si_unique_call 940} IoReuseIrp(in_irp_4, 0);
    assume {:nonnull} in_irp_4 != 0;
    assume in_irp_4 > 0;
    call {:si_unique_call 941} out_stack_1 := sdv_IoGetNextIrpStackLocation(in_irp_4);
    ...
    assume {:nonnull} out_stack_1 != 0;
    assume out_stack_1 > 0;
    call {:si_unique_call 942} sdv_IoSetCompletionRoutine(in_irp_4, li2bplFunctionConstant256, in_event_9, 1, 1, 1);
    assume {:nonnull} in_DeviceExtension_18 != 0;
    assume in_DeviceExtension_18 > 0;
    havoc vslice_dummy_var_109;
    call {:si_unique_call 943} out_status_20 := sdv_IoCallDriver#0(vslice_dummy_var_109, in_irp_4);
    goto anon21_Else;
  ...
  anon17_Else:
    ...
    call {:si_unique_call 944} out_status_20 := KeWaitForSingleObject(0, 0, 0, 0, 0);
    goto anon19_Then, anon19_Else;
  ...
  anon20_Else_dummy:
    call {:si_unique_call 945} {:si_old_unique_call 1} out_status_20, out_stack_1 := SerialMouseReadSerialPort#1_loop_L15(in_irp_4, out_status_20, in_event_9, out_stack_1, in_DeviceExtension_18, in_ReadBuffer, in_Buflen, in_ActualBytesRead);
    return;
...
implementation CSerDetect#0_loop_L20(in_Tmp_19: int, in_count_1: int, in_Tmp_21: int, in_sdv_14: int, in_status_1: int, in_DeviceExtension_3: int, in_vslice_dummy_var_160: int, in_vslice_dummy_var_161: int, in_vslice_dummy_var_162: int, in_vslice_dummy_var_163: int, in_vslice_dummy_var_169: int) returns (out_Tmp_19: int, out_count_1: int, out_Tmp_21: int, out_sdv_14: int, out_vslice_dummy_var_160: int, out_vslice_dummy_var_161: int, out_vslice_dummy_var_162: int, out_vslice_dummy_var_163: int, out_vslice_dummy_var_169: int)
{
  ...
  anon47_Else:
    ...
    havoc out_Tmp_21;
    call {:si_unique_call 952} out_vslice_dummy_var_169 := SerialMouseSetBaudRate#0(in_DeviceExtension_3, out_Tmp_21);
    goto anon55_Else;

  anon55_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 951} CSerSetReportRate#0(in_DeviceExtension_3, 0);
    goto anon56_Else;

  anon56_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 950} out_vslice_dummy_var_160 := CSerSetProtocol#0(in_DeviceExtension_3, 0);
    goto anon57_Else;

  anon57_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 949} out_vslice_dummy_var_161 := SerialMouseWriteChar#0(in_DeviceExtension_3, 115);
    goto anon58_Else;

  anon58_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 948} out_vslice_dummy_var_162 := SerialMouseFlushReadBuffer#0(in_DeviceExtension_3);
    goto anon59_Else;

  anon59_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 947} out_vslice_dummy_var_163 := SerialMouseSetReadTimeouts#0(in_DeviceExtension_3, 50);
    goto anon60_Else;

  anon60_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 946} out_sdv_14 := SerialMouseReadChar#0(in_DeviceExtension_3, in_status_1);
    goto anon61_Else;
...
implementation CSerDetect#1_loop_L20(in_Tmp_19: int, in_count_1: int, in_Tmp_21: int, in_sdv_14: int, in_status_1: int, in_DeviceExtension_3: int, in_vslice_dummy_var_171: int, in_vslice_dummy_var_172: int, in_vslice_dummy_var_173: int, in_vslice_dummy_var_174: int, in_vslice_dummy_var_180: int) returns (out_Tmp_19: int, out_count_1: int, out_Tmp_21: int, out_sdv_14: int, out_vslice_dummy_var_171: int, out_vslice_dummy_var_172: int, out_vslice_dummy_var_173: int, out_vslice_dummy_var_174: int, out_vslice_dummy_var_180: int)
{
  ...
  anon47_Else:
    ...
    out_Tmp_19 := out_count_1;
    havoc out_Tmp_21;
    call {:si_unique_call 960} out_vslice_dummy_var_180 := SerialMouseSetBaudRate#1(in_DeviceExtension_3, out_Tmp_21);
    goto anon55_Else;

  anon55_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 959} CSerSetReportRate#1(in_DeviceExtension_3, 0);
    goto anon56_Else;

  anon56_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 958} out_vslice_dummy_var_171 := CSerSetProtocol#1(in_DeviceExtension_3, 0);
    goto anon57_Else;

  anon57_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 957} out_vslice_dummy_var_172 := SerialMouseWriteChar#1(in_DeviceExtension_3, 115);
    goto anon58_Else;

  anon58_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 956} out_vslice_dummy_var_173 := SerialMouseFlushReadBuffer#1(in_DeviceExtension_3);
    goto anon59_Else;

  anon59_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 955} out_vslice_dummy_var_174 := SerialMouseSetReadTimeouts#1(in_DeviceExtension_3, 50);
    goto anon60_Else;

  anon60_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 954} out_sdv_14 := SerialMouseReadChar#1(in_DeviceExtension_3, in_status_1);
    goto anon61_Else;
...
implementation SerialMouseStartDetection#0_loop_L62(in_i: int, in_Tmp_42: int, in_bits_2: int, in_eventBits: int, in_statusBits: int, in_Tmp_45: int, in_Tmp_46: int, in_waitMask: int) returns (out_i: int, out_Tmp_42: int, out_Tmp_45: int, out_Tmp_46: int)
{
  ...
  L64_dummy:
    call {:si_unique_call 962} {:si_old_unique_call 1} out_i, out_Tmp_42, out_Tmp_45, out_Tmp_46 := SerialMouseStartDetection#0_loop_L62(out_i, out_Tmp_42, in_bits_2, in_eventBits, in_statusBits, out_Tmp_45, out_Tmp_46, in_waitMask);
    return;
...
implementation SerialMouseStartDetection#1_loop_L62(in_i: int, in_Tmp_42: int, in_bits_2: int, in_eventBits: int, in_statusBits: int, in_Tmp_45: int, in_Tmp_46: int, in_waitMask: int) returns (out_i: int, out_Tmp_42: int, out_Tmp_45: int, out_Tmp_46: int)
{
  ...
  L64_dummy:
    call {:si_unique_call 963} {:si_old_unique_call 1} out_i, out_Tmp_42, out_Tmp_45, out_Tmp_46 := SerialMouseStartDetection#1_loop_L62(out_i, out_Tmp_42, in_bits_2, in_eventBits, in_statusBits, out_Tmp_45, out_Tmp_46, in_waitMask);
    return;
