...
procedure {:origName "SerialMouseSystemControl"} SerialMouseSystemControl(actual_DeviceObject: int, actual_Irp: int) returns (Tmp_30: int);
  modifies alloc, yogi_error, completion, LockDepth, Mem_T.CompletionRoutine__IO_STACK_LOCATION;
...
implementation {:origName "SerialMouseSystemControl"} SerialMouseSystemControl(actual_DeviceObject: int, actual_Irp: int) returns (Tmp_30: int)
{
  ...
  L22:
    ...
    call {:si_unique_call 5} status_2 := sdv_IoCallDriver#1(vslice_dummy_var_296, Irp);
  ...
  anon14_Then:
    ...
    call {:si_unique_call 7} status_2 := sdv_IoCallDriver#1(vslice_dummy_var_297, Irp);
...
procedure {:origName "sdv_RtlQueryRegistryValues"} {:osmodel} sdv_RtlQueryRegistryValues(actual_RelativeTo: int, actual_Path: int, actual_QueryTable: int, actual_Context_4: int, actual_Environment: int) returns (Tmp_103: int);
...
implementation {:origName "sdv_RtlQueryRegistryValues"} {:osmodel} sdv_RtlQueryRegistryValues(actual_RelativeTo: int, actual_Path: int, actual_QueryTable: int, actual_Context_4: int, actual_Environment: int) returns (Tmp_103: int)
{
...
procedure {:nohoudini} {:origName "sdv_main"} {:osmodel} sdv_main();
  modifies alloc, Mem_T.CompletionRoutine__IO_STACK_LOCATION, Mem_T.ReadIrp__DEVICE_EXTENSION, SLAM_guard_O_0, t, LockDepth, yogi_error, completion;
  free ensures {:va_keep} yogi_error == 1 || yogi_error == old(yogi_error);
  free ensures {:va_keep} completion == 1 || completion == old(completion);
...
procedure {:origName "PoCallDriver"} {:osmodel} PoCallDriver(actual_DeviceObject_4: int, actual_Irp_2: int) returns (Tmp_115: int);
  modifies alloc, completion, yogi_error, LockDepth, Mem_T.CompletionRoutine__IO_STACK_LOCATION;
  free ensures {:va_keep} old(completion) == 1 ==> completion != 0;
  free ensures {:va_keep} old(t) == 0 ==> yogi_error == 0;
  free ensures {:va_keep} yogi_error == 1 || yogi_error == old(yogi_error);
  free ensures {:va_keep} completion == 1 || completion == old(completion);
...
implementation {:origName "PoCallDriver"} {:osmodel} PoCallDriver(actual_DeviceObject_4: int, actual_Irp_2: int) returns (Tmp_115: int)
{
  ...
  anon58_Then:
    ...
    call {:si_unique_call 52} vslice_dummy_var_18 := sdv_RunIoCompletionRoutines#1(sdv_p_devobj_fdo, Irp_2, vslice_dummy_var_298, completion_1);
  ...
  anon70_Else:
    ...
    call {:si_unique_call 53} vslice_dummy_var_21 := sdv_RunIoCompletionRoutines#1(sdv_p_devobj_fdo, Irp_2, vslice_dummy_var_299, completion_1);
  ...
  anon62_Else:
    ...
    call {:si_unique_call 54} vslice_dummy_var_19 := sdv_RunIoCompletionRoutines#1(sdv_p_devobj_fdo, Irp_2, vslice_dummy_var_300, completion_1);
  ...
  anon66_Else:
    ...
    call {:si_unique_call 55} vslice_dummy_var_20 := sdv_RunIoCompletionRoutines#1(sdv_p_devobj_fdo, Irp_2, vslice_dummy_var_301, completion_1);
...
procedure {:nohoudini} {:origName "main"} {:osmodel} {:entrypoint} main() returns (Tmp_142: int, dup_assertVar: bool);
  modifies alloc, SLAM_guard_O_0, LockDepth, completion, t, yogi_error, Mem_T.CompletionRoutine__IO_STACK_LOCATION, Mem_T.ReadIrp__DEVICE_EXTENSION;
...
implementation {:origName "main"} {:osmodel} main() returns (Tmp_142: int, dup_assertVar: bool)
{
  ...
  anon0:
    ...
    call {:si_unique_call 123} vslice_dummy_var_302 := __HAVOC_malloc(32);
    call {:si_unique_call 124} vslice_dummy_var_303 := __HAVOC_malloc(72);
    call {:si_unique_call 125} vslice_dummy_var_304 := __HAVOC_malloc(16);
    call {:si_unique_call 126} vslice_dummy_var_305 := __HAVOC_malloc(120);
    call {:si_unique_call 127} vslice_dummy_var_306 := __HAVOC_malloc(12);
    call {:si_unique_call 128} vslice_dummy_var_307 := __HAVOC_malloc(48);
    call {:si_unique_call 129} vslice_dummy_var_308 := __HAVOC_malloc(12);
...
procedure {:origName "sdv_RunDispatchFunction"} {:osmodel} sdv_RunDispatchFunction(actual_po: int, actual_pirp_11: int) returns (Tmp_170: int);
  modifies alloc, Mem_T.CompletionRoutine__IO_STACK_LOCATION, SLAM_guard_O_0, t, LockDepth, Mem_T.ReadIrp__DEVICE_EXTENSION, yogi_error, completion;
  free ensures {:va_keep} old(completion) == 1 ==> completion != 0;
  free ensures {:va_keep} old(t) == 1 ==> t != 0;
...
procedure {:origName "SerialMouseReadSerialPortComplete"} SerialMouseReadSerialPortComplete(actual_DeviceObject_16: int, actual_Irp_9: int, actual_Context_7: int) returns (Tmp_240: int);
  modifies completion;
  free ensures {:va_keep} old(completion) == 1 ==> completion != 0;
  free ensures {:va_keep} completion == 1 || completion == old(completion);
...
implementation {:origName "SerialMouseReadSerialPortComplete"} SerialMouseReadSerialPortComplete(actual_DeviceObject_16: int, actual_Irp_9: int, actual_Context_7: int) returns (Tmp_240: int)
{
...
implementation {:origName "SerialMouseServiceParameters"} SerialMouseServiceParameters(actual_DeviceExtension_28: int, actual_Handle_1: int)
{
  ...
  anon0:
    ...
    Tmp_330 := 28 * queriesPlusOne;
    call {:si_unique_call 216} sdv_189 := ExAllocatePoolWithTag(1, Tmp_330, -228232371);
    parameters := sdv_189;
    goto anon27_Then, anon27_Else;

  anon27_Else:
    assume {:partition} parameters != 0;
    Tmp_319 := 28 * queriesPlusOne;
    call {:si_unique_call 217} sdv_RtlZeroMemory(0, Tmp_319);
  ...
  anon21_Then:
    ...
    assume parametersPath > 0;
    havoc Tmp_329;
    call {:si_unique_call 222} sdv_194 := ExAllocatePoolWithTag(1, Tmp_329, -228232371);
    assume {:nonnull} parametersPath != 0;
    assume parametersPath > 0;
    assume {:nonnull} parametersPath != 0;
    assume parametersPath > 0;
  ...
  anon29_Else:
    ...
    assume parametersPath > 0;
    havoc Tmp_322;
    call {:si_unique_call 223} sdv_RtlZeroMemory(0, Tmp_322);
...
procedure {:origName "DriverEntry"} DriverEntry(actual_DriverObject_3: int, actual_RegistryPath: int) returns (Tmp_331: int);
  modifies alloc;
...
implementation {:origName "DriverEntry"} DriverEntry(actual_DriverObject_3: int, actual_RegistryPath: int) returns (Tmp_331: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 227} Tmp_332 := __HAVOC_malloc(112);
    call {:si_unique_call 228} Tmp_333 := __HAVOC_malloc(112);
    call {:si_unique_call 229} Tmp_334 := __HAVOC_malloc(112);
    call {:si_unique_call 230} Tmp_336 := __HAVOC_malloc(112);
    call {:si_unique_call 231} Tmp_337 := __HAVOC_malloc(112);
    call {:si_unique_call 232} Tmp_342 := __HAVOC_malloc(112);
    call {:si_unique_call 233} Tmp_343 := __HAVOC_malloc(112);
  ...
  anon5_Else:
    ...
    assume regPath_1 > 0;
    havoc Tmp_338;
    call {:si_unique_call 235} sdv_198 := ExAllocatePoolWithTag(512, Tmp_338, -228232371);
    assume {:nonnull} regPath_1 != 0;
    assume regPath_1 > 0;
    assume {:nonnull} regPath_1 != 0;
    assume regPath_1 > 0;
  ...
  anon6_Else:
    ...
    assume regPath_1 > 0;
    havoc Tmp_339;
    call {:si_unique_call 236} sdv_RtlZeroMemory(0, Tmp_339);
    assume {:nonnull} RegistryPath != 0;
    assume RegistryPath > 0;
    havoc Tmp_335;
    call {:si_unique_call 237} sdv_RtlMoveMemory(0, 0, Tmp_335);
    goto L10;
...
procedure {:origName "SerialMouseCreate"} SerialMouseCreate(actual_DeviceObject_20: int, actual_Irp_13: int) returns (Tmp_357: int);
  modifies alloc, LockDepth, Mem_T.CompletionRoutine__IO_STACK_LOCATION, yogi_error, completion;
  free ensures {:va_keep} old(completion) == 1 ==> completion != 0;
  free ensures {:va_keep} old(t) == 0 ==> yogi_error == 0;
  free ensures {:va_keep} yogi_error == 1 || yogi_error == old(yogi_error);
  free ensures {:va_keep} completion == 1 || completion == old(completion);
...
implementation {:origName "SerialMouseCreate"} SerialMouseCreate(actual_DeviceObject_20: int, actual_Irp_13: int) returns (Tmp_357: int)
{
  ...
  anon20_Else:
    call {:si_unique_call 242} Tmp_358 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_358 != 0;
    assume Tmp_358 > 0;
    assume {:nonnull} deviceExtension_3 != 0;
    assume deviceExtension_3 > 0;
    call {:si_unique_call 243} sdv_214 := sdv_InterlockedIncrement(Tmp_358);
    assume {:nonnull} Tmp_358 != 0;
    assume Tmp_358 > 0;
    assume {:nonnull} deviceExtension_3 != 0;
    assume deviceExtension_3 > 0;
  ...
  anon21_Else:
    ...
    call {:si_unique_call 244} status_36 := SerialMouseSendIrpSynchronously#1(vslice_dummy_var_309, Irp_13, 1);
    goto anon25_Then, anon25_Else;
  ...
  L44:
    call {:si_unique_call 247} Tmp_358 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_358 != 0;
    assume Tmp_358 > 0;
    assume {:nonnull} deviceExtension_3 != 0;
    assume deviceExtension_3 > 0;
    call {:si_unique_call 248} vslice_dummy_var_62 := sdv_InterlockedDecrement(Tmp_358);
    assume {:nonnull} Tmp_358 != 0;
    assume Tmp_358 > 0;
    assume {:nonnull} deviceExtension_3 != 0;
    assume deviceExtension_3 > 0;
...
procedure {:origName "SerialMouseInternalDeviceControl"} SerialMouseInternalDeviceControl(actual_DeviceObject_21: int, actual_Irp_14: int) returns (Tmp_360: int);
...
implementation {:origName "SerialMouseInternalDeviceControl"} SerialMouseInternalDeviceControl(actual_DeviceObject_21: int, actual_Irp_14: int) returns (Tmp_360: int)
{
...
procedure {:origName "SerialMouseFlush"} SerialMouseFlush(actual_DeviceObject_22: int, actual_Irp_15: int) returns (Tmp_366: int);
  modifies LockDepth, alloc, yogi_error, completion, Mem_T.CompletionRoutine__IO_STACK_LOCATION;
  free ensures {:va_keep} old(completion) == 1 ==> completion != 0;
  free ensures {:va_keep} old(t) == 0 ==> yogi_error == 0;
  free ensures {:va_keep} yogi_error == 1 || yogi_error == old(yogi_error);
  free ensures {:va_keep} completion == 1 || completion == old(completion);
...
implementation {:origName "SerialMouseFlush"} SerialMouseFlush(actual_DeviceObject_22: int, actual_Irp_15: int) returns (Tmp_366: int)
{
  ...
  anon7_Else:
    ...
    call {:si_unique_call 257} status_38 := sdv_IoCallDriver#1(vslice_dummy_var_310, Irp_15);
    goto anon8_Then, anon8_Else;
...
procedure {:origName "SerialMouseClose"} SerialMouseClose(actual_DeviceObject_23: int, actual_Irp_16: int) returns (Tmp_368: int);
  modifies alloc, LockDepth, yogi_error, completion, Mem_T.CompletionRoutine__IO_STACK_LOCATION;
  free ensures {:va_keep} old(completion) == 1 ==> completion != 0;
  free ensures {:va_keep} old(t) == 0 ==> yogi_error == 0;
  free ensures {:va_keep} yogi_error == 1 || yogi_error == old(yogi_error);
  free ensures {:va_keep} completion == 1 || completion == old(completion);
...
implementation {:origName "SerialMouseClose"} SerialMouseClose(actual_DeviceObject_23: int, actual_Irp_16: int) returns (Tmp_368: int)
{
  ...
  anon13_Then:
    ...
    call {:si_unique_call 262} Tmp_369 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_369 != 0;
    assume Tmp_369 > 0;
    assume {:nonnull} deviceExtension_6 != 0;
    assume deviceExtension_6 > 0;
    call {:si_unique_call 263} sdv_222 := sdv_InterlockedDecrement(Tmp_369);
    assume {:nonnull} Tmp_369 != 0;
    assume Tmp_369 > 0;
    assume {:nonnull} deviceExtension_6 != 0;
    assume deviceExtension_6 > 0;
  ...
  anon17_Else:
    ...
    call {:si_unique_call 270} Tmp_368 := sdv_IoCallDriver#1(vslice_dummy_var_311, Irp_16);
    goto anon18_Then, anon18_Else;
...
procedure {:origName "SerialMouseAddDevice"} SerialMouseAddDevice(actual_Driver: int, actual_PDO: int) returns (Tmp_370: int);
  modifies alloc, Mem_T.CompletionRoutine__IO_STACK_LOCATION, Mem_T.ReadIrp__DEVICE_EXTENSION;
  free ensures {:va_keep} Tmp_370 == -1073741667 || Tmp_370 == -1073741824 || Tmp_370 == -1073741771 || Tmp_370 == -1073741670 || Tmp_370 == -1073741823 || Tmp_370 == 0;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} false || old(completion) == 1 || old(completion) == 0;
  free ensures {:va_keep} false || old(t) == 1 || old(t) == 0;
  free ensures {:va_keep} alloc >= old(alloc);
...
implementation {:origName "SerialMouseAddDevice"} SerialMouseAddDevice(actual_Driver: int, actual_PDO: int) returns (Tmp_370: int)
{
  ...
  anon10_Then:
    ...
    assume {:nonnull} deviceExtension_7 != 0;
    assume deviceExtension_7 > 0;
    call {:si_unique_call 279} Tmp_371 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_371 != 0;
    assume Tmp_371 > 0;
    assume {:nonnull} deviceExtension_7 != 0;
    assume deviceExtension_7 > 0;
    call {:si_unique_call 280} sdv_KeInitializeSpinLock(Tmp_371);
    assume {:nonnull} Tmp_371 != 0;
    assume Tmp_371 > 0;
    assume {:nonnull} deviceExtension_7 != 0;
    assume deviceExtension_7 > 0;
    ...
    call {:si_unique_call 283} boogieTmp := IoAllocateIrp(vslice_dummy_var_312, 0);
...
procedure {:origName "SerialMouseCompletionRoutine"} SerialMouseCompletionRoutine(actual_DeviceObject_25: int, actual_Irp_18: int, actual_Context_9: int) returns (Tmp_376: int);
  modifies completion;
  free ensures {:va_keep} old(completion) == 1 ==> completion != 0;
  free ensures {:va_keep} completion == 1 || completion == old(completion);
...
implementation {:origName "SerialMouseCompletionRoutine"} SerialMouseCompletionRoutine(actual_DeviceObject_25: int, actual_Irp_18: int, actual_Context_9: int) returns (Tmp_376: int)
{
...
procedure {:origName "SerialMouseRemoveDevice"} SerialMouseRemoveDevice(actual_DeviceExtension_33: int, actual_Irp_19: int);
  modifies alloc, Mem_T.CompletionRoutine__IO_STACK_LOCATION, yogi_error, completion, LockDepth;
  free ensures {:va_keep} old(completion) == 1 ==> completion != 0;
  free ensures {:va_keep} old(t) == 0 ==> yogi_error == 0;
  free ensures {:va_keep} yogi_error == 1 || yogi_error == old(yogi_error);
  free ensures {:va_keep} completion == 1 || completion == old(completion);
...
implementation {:origName "SerialMouseStopDevice"} SerialMouseStopDevice(actual_DeviceExtension_34: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 298} Tmp_384 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_384 != 0;
    assume Tmp_384 > 0;
    call {:si_unique_call 299} sdv_KeAcquireSpinLock(0, Tmp_384);
    assume {:nonnull} Tmp_384 != 0;
    assume Tmp_384 > 0;
    havoc irql_1;
...
procedure {:origName "SerialMousePnP"} SerialMousePnP(actual_DeviceObject_27: int, actual_Irp_20: int) returns (Tmp_385: int);
  modifies alloc, LockDepth, Mem_T.ReadIrp__DEVICE_EXTENSION, yogi_error, Mem_T.CompletionRoutine__IO_STACK_LOCATION, completion;
  free ensures {:va_keep} old(completion) == 1 ==> completion != 0;
  free ensures {:va_keep} old(t) == 0 ==> yogi_error == 0;
  free ensures {:va_keep} yogi_error == 1 || yogi_error == old(yogi_error);
  free ensures {:va_keep} completion == 1 || completion == old(completion);
...
implementation {:origName "SerialMousePnP"} SerialMousePnP(actual_DeviceObject_27: int, actual_Irp_20: int) returns (Tmp_385: int)
{
  var {:scalar} i_4: int;
  ...
  anon0:
    ...
    call {:si_unique_call 304} Tmp_387 := __HAVOC_malloc(28);
    call {:si_unique_call 305} Tmp_389 := __HAVOC_malloc(28);
    skipIt := 0;
  ...
  anon101_Else:
    ...
    call {:si_unique_call 311} status_43 := sdv_IoCallDriver#1(vslice_dummy_var_313, Irp_20);
  ...
  anon117_Then:
    ...
    call {:si_unique_call 313} status_43 := SerialMouseSendIrpSynchronously#1(vslice_dummy_var_314, Irp_20, 1);
  ...
  anon125_Then:
    ...
    call {:si_unique_call 315} status_43 := SerialMouseSendIrpSynchronously#1(vslice_dummy_var_315, Irp_20, 1);
  ...
  L88:
    call {:si_unique_call 316} i_4, Tmp_387, Tmp_388 := SerialMousePnP_loop_L88(i_4, devCaps, Tmp_387, Tmp_388);
    goto L88_last;
  ...
  anon141_Else:
    ...
    call {:si_unique_call 321} status_43 := sdv_IoCallDriver#1(vslice_dummy_var_316, Irp_20);
  ...
  anon100_Then:
    ...
    call {:si_unique_call 327} status_43 := SerialMouseSendIrpSynchronously#1(vslice_dummy_var_317, Irp_20, 1);
  ...
  anon110_Else:
    call {:si_unique_call 328} Tmp_386 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_386 != 0;
    assume Tmp_386 > 0;
    assume {:nonnull} deviceExtension_9 != 0;
    assume deviceExtension_9 > 0;
    call {:si_unique_call 329} sdv_245 := sdv_InterlockedIncrement(Tmp_386);
    assume {:nonnull} Tmp_386 != 0;
    assume Tmp_386 > 0;
    assume {:nonnull} deviceExtension_9 != 0;
    assume deviceExtension_9 > 0;
  ...
  anon111_Else:
    ...
    call {:si_unique_call 332} status_43 := SerialMouseSendIrpSynchronously#1(vslice_dummy_var_318, Irp_20, 0);
  ...
  anon136_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 338} Tmp_386 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_386 != 0;
    assume Tmp_386 > 0;
    assume {:nonnull} deviceExtension_9 != 0;
    assume deviceExtension_9 > 0;
    call {:si_unique_call 339} sdv_251 := sdv_InterlockedDecrement(Tmp_386);
    assume {:nonnull} Tmp_386 != 0;
    assume Tmp_386 > 0;
    assume {:nonnull} deviceExtension_9 != 0;
    assume deviceExtension_9 > 0;
...
procedure {:origName "SerialMousePower"} SerialMousePower(actual_DeviceObject_28: int, actual_Irp_21: int) returns (Tmp_390: int);
  modifies alloc, LockDepth, Mem_T.CompletionRoutine__IO_STACK_LOCATION, yogi_error, completion;
  free ensures {:va_keep} old(completion) == 1 ==> completion != 0;
  free ensures {:va_keep} old(t) == 0 ==> yogi_error == 0;
  free ensures {:va_keep} yogi_error == 1 || yogi_error == old(yogi_error);
...
implementation {:origName "SerialMousePower"} SerialMousePower(actual_DeviceObject_28: int, actual_Irp_21: int) returns (Tmp_390: int)
{
  var {:pointer} SD1: int;
  ...
  anon78_Else:
    ...
    call {:si_unique_call 356} status_44 := SerialMousepIoSyncIoctl#1(0, 1769524, vslice_dummy_var_319, event_17, iosb_16);
    goto anon79_Then, anon79_Else;
  ...
  L62:
    ...
    call {:si_unique_call 358} SD1 := PoSetPowerState(0, vslice_dummy_var_320, vslice_dummy_var_321);
  ...
  anon80_Else:
    ...
    call {:si_unique_call 362} Tmp_390 := PoCallDriver(0, Irp_21);
    goto anon81_Then, anon81_Else;
...
implementation {:origName "SerialMouseHandleStartStopStart"} SerialMouseHandleStartStopStart(actual_DeviceExtension_35: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 386} Tmp_392 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_392 != 0;
    assume Tmp_392 > 0;
    call {:si_unique_call 387} sdv_KeAcquireSpinLock(0, Tmp_392);
    assume {:nonnull} Tmp_392 != 0;
    assume Tmp_392 > 0;
    havoc irql_2;
...
implementation {:origName "CSerPowerUp"} CSerPowerUp#0(actual_DeviceExtension: int) returns (Tmp_3: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 398} status := SerialMousepIoSyncIoctl#0(0, 1769508, vslice_dummy_var_322, event, iosb);
    goto anon12_Then, anon12_Else;
  ...
  anon12_Else:
    ...
    call {:si_unique_call 399} status := SerialMousepIoSyncIoctl#0(0, 1769520, vslice_dummy_var_323, event, iosb);
    goto anon13_Then, anon13_Else;
  ...
  anon13_Else:
    ...
    call {:si_unique_call 400} status := SerialMousepIoSyncIoctlEx#0(0, 1769576, vslice_dummy_var_324, event, iosb, 0, 0, bits, 4);
    goto anon14_Then, anon14_Else;
...
implementation {:origName "CSerPowerUp"} CSerPowerUp#1(actual_DeviceExtension: int) returns (Tmp_3: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 407} status := SerialMousepIoSyncIoctl#1(0, 1769508, vslice_dummy_var_325, event, iosb);
    goto anon12_Then, anon12_Else;
  ...
  anon12_Else:
    ...
    call {:si_unique_call 408} status := SerialMousepIoSyncIoctl#1(0, 1769520, vslice_dummy_var_326, event, iosb);
    goto anon13_Then, anon13_Else;
  ...
  anon13_Else:
    ...
    call {:si_unique_call 409} status := SerialMousepIoSyncIoctlEx#1(0, 1769576, vslice_dummy_var_327, event, iosb, 0, 0, bits, 4);
    goto anon14_Then, anon14_Else;
...
implementation {:origName "IofCallDriver"} {:osmodel} IofCallDriver#0(actual_DeviceObject_9: int, actual_Irp_6: int) returns (Tmp_197: int)
{
  ...
  anon55_Then:
    ...
    call {:si_unique_call 428} vslice_dummy_var_92 := sdv_RunIoCompletionRoutines#0(sdv_p_devobj_fdo, Irp_6, vslice_dummy_var_328, completion_2);
    goto anon76_Then, anon76_Else;
  ...
  anon67_Else:
    ...
    call {:si_unique_call 429} vslice_dummy_var_95 := sdv_RunIoCompletionRoutines#0(sdv_p_devobj_fdo, Irp_6, vslice_dummy_var_329, completion_2);
    goto anon78_Then, anon78_Else;
  ...
  anon59_Else:
    ...
    call {:si_unique_call 430} vslice_dummy_var_93 := sdv_RunIoCompletionRoutines#0(sdv_p_devobj_fdo, Irp_6, vslice_dummy_var_330, completion_2);
    goto anon74_Then, anon74_Else;
  ...
  anon63_Else:
    ...
    call {:si_unique_call 431} vslice_dummy_var_94 := sdv_RunIoCompletionRoutines#0(sdv_p_devobj_fdo, Irp_6, vslice_dummy_var_331, completion_2);
    goto anon72_Then, anon72_Else;
...
procedure {:origName "IofCallDriver"} {:osmodel} IofCallDriver#0(actual_DeviceObject_9: int, actual_Irp_6: int) returns (Tmp_197: int);
  modifies alloc, completion, LockDepth, Mem_T.CompletionRoutine__IO_STACK_LOCATION, yogi_error;
  free ensures {:va_keep} old(completion) == 1 ==> completion != 0;
  free ensures {:va_keep} old(t) == 0 ==> yogi_error == 0;
  free ensures {:va_keep} yogi_error == 1 || yogi_error == old(yogi_error);
  free ensures {:va_keep} completion == 1 || completion == old(completion);
...
implementation {:origName "IofCallDriver"} {:osmodel} IofCallDriver#1(actual_DeviceObject_9: int, actual_Irp_6: int) returns (Tmp_197: int)
{
  ...
  anon55_Then:
    ...
    call {:si_unique_call 433} vslice_dummy_var_96 := sdv_RunIoCompletionRoutines#1(sdv_p_devobj_fdo, Irp_6, vslice_dummy_var_332, completion_2);
    goto anon76_Then, anon76_Else;
  ...
  anon67_Else:
    ...
    call {:si_unique_call 434} vslice_dummy_var_99 := sdv_RunIoCompletionRoutines#1(sdv_p_devobj_fdo, Irp_6, vslice_dummy_var_333, completion_2);
    goto anon78_Then, anon78_Else;
  ...
  anon59_Else:
    ...
    call {:si_unique_call 435} vslice_dummy_var_97 := sdv_RunIoCompletionRoutines#1(sdv_p_devobj_fdo, Irp_6, vslice_dummy_var_334, completion_2);
    goto anon74_Then, anon74_Else;
  ...
  anon63_Else:
    ...
    call {:si_unique_call 436} vslice_dummy_var_98 := sdv_RunIoCompletionRoutines#1(sdv_p_devobj_fdo, Irp_6, vslice_dummy_var_335, completion_2);
    goto anon72_Then, anon72_Else;
...
implementation {:origName "sdv_RunIoCompletionRoutines"} {:osmodel} sdv_RunIoCompletionRoutines#0(actual_DeviceObject_10: int, actual_Irp_7: int, actual_Context_6: int, actual_Completion: int) returns (Tmp_199: int)
{
  ...
  anon16_Else:
    ...
    call {:si_unique_call 438} Status_1 := SerialMouseCompletionRoutine(DeviceObject_10, Irp_7, Context_6);
  ...
  anon13_Else:
    ...
    call {:si_unique_call 439} Status_1 := SerialMouseReadComplete#0(DeviceObject_10, Irp_7, Context_6);
    goto anon17_Then, anon17_Else;
  ...
  anon14_Else:
    ...
    call {:si_unique_call 440} Status_1 := SerialMouseReadSerialPortComplete(DeviceObject_10, Irp_7, Context_6);
    assume {:nonnull} Completion != 0;
    assume Completion > 0;
    goto L45;
  ...
  anon15_Else:
    ...
    call {:si_unique_call 441} Status_1 := SerialMouseSerialMaskEventComplete#0(DeviceObject_10, Irp_7, Context_6);
    goto anon18_Then, anon18_Else;
...
procedure {:origName "sdv_RunIoCompletionRoutines"} {:osmodel} sdv_RunIoCompletionRoutines#0(actual_DeviceObject_10: int, actual_Irp_7: int, actual_Context_6: int, actual_Completion: int) returns (Tmp_199: int);
  modifies completion, alloc, LockDepth, Mem_T.CompletionRoutine__IO_STACK_LOCATION, yogi_error;
  free ensures {:va_keep} old(completion) == 1 ==> completion != 0;
  free ensures {:va_keep} old(t) == 0 ==> yogi_error == 0;
  free ensures {:va_keep} yogi_error == 1 || yogi_error == old(yogi_error);
  free ensures {:va_keep} completion == 1 || completion == old(completion);
...
implementation {:origName "sdv_RunIoCompletionRoutines"} {:osmodel} sdv_RunIoCompletionRoutines#1(actual_DeviceObject_10: int, actual_Irp_7: int, actual_Context_6: int, actual_Completion: int) returns (Tmp_199: int)
{
  var {:scalar} Status_1: int;
  var {:pointer} irpsp: int;
  var {:pointer} DeviceObject_10: int;
  ...
  anon16_Else:
    assume {:partition} Mem_T.CompletionRoutine__IO_STACK_LOCATION[CompletionRoutine__IO_STACK_LOCATION(irpsp)] == li2bplFunctionConstant188;
    call {:si_unique_call 443} Status_1 := SerialMouseCompletionRoutine(DeviceObject_10, Irp_7, Context_6);
    assume {:nonnull} Completion != 0;
    assume Completion > 0;
    goto L11;
  ...
  anon13_Else:
    assume {:partition} Mem_T.CompletionRoutine__IO_STACK_LOCATION[CompletionRoutine__IO_STACK_LOCATION(irpsp)] == li2bplFunctionConstant251;
    call {:si_unique_call 444} Status_1 := SerialMouseReadComplete#1(DeviceObject_10, Irp_7, Context_6);
    goto anon17_Then, anon17_Else;
  ...
  anon14_Else:
    assume {:partition} Mem_T.CompletionRoutine__IO_STACK_LOCATION[CompletionRoutine__IO_STACK_LOCATION(irpsp)] == li2bplFunctionConstant256;
    call {:si_unique_call 445} Status_1 := SerialMouseReadSerialPortComplete(DeviceObject_10, Irp_7, Context_6);
    assume {:nonnull} Completion != 0;
    assume Completion > 0;
    goto L45;
  ...
  anon15_Else:
    assume {:partition} Mem_T.CompletionRoutine__IO_STACK_LOCATION[CompletionRoutine__IO_STACK_LOCATION(irpsp)] == li2bplFunctionConstant268;
    call {:si_unique_call 446} Status_1 := SerialMouseSerialMaskEventComplete#1(DeviceObject_10, Irp_7, Context_6);
    goto anon18_Then, anon18_Else;
...
procedure {:origName "sdv_RunIoCompletionRoutines"} {:osmodel} sdv_RunIoCompletionRoutines#1(actual_DeviceObject_10: int, actual_Irp_7: int, actual_Context_6: int, actual_Completion: int) returns (Tmp_199: int);
  modifies completion, alloc, LockDepth, Mem_T.CompletionRoutine__IO_STACK_LOCATION, yogi_error;
  free ensures {:va_keep} old(completion) == 1 ==> completion != 0;
  free ensures {:va_keep} old(t) == 0 ==> yogi_error == 0;
  free ensures {:va_keep} yogi_error == 1 || yogi_error == old(yogi_error);
...
implementation {:origName "SerialMouseReadComplete"} SerialMouseReadComplete#0(actual_DeviceObject_19: int, actual_Irp_10: int, actual_Context_8: int) returns (Tmp_254: int)
{
...
procedure {:origName "SerialMouseReadComplete"} SerialMouseReadComplete#0(actual_DeviceObject_19: int, actual_Irp_10: int, actual_Context_8: int) returns (Tmp_254: int);
  modifies alloc, completion, LockDepth, Mem_T.CompletionRoutine__IO_STACK_LOCATION, yogi_error;
  free ensures {:va_keep} old(LockDepth) != 0 ==> yogi_error == 0;
  free ensures {:va_keep} old(completion) == 1 ==> completion != 0;
  free ensures {:va_keep} old(t) == 0 ==> yogi_error == 0;
...
implementation {:origName "SerialMouseReadComplete"} SerialMouseReadComplete#1(actual_DeviceObject_19: int, actual_Irp_10: int, actual_Context_8: int) returns (Tmp_254: int)
{
  var {:pointer} Tmp_255: int;
  var {:scalar} sdv_145: int;
  var {:scalar} startRead: int;
...
procedure {:origName "SerialMouseReadComplete"} SerialMouseReadComplete#1(actual_DeviceObject_19: int, actual_Irp_10: int, actual_Context_8: int) returns (Tmp_254: int);
  modifies alloc, completion, LockDepth, Mem_T.CompletionRoutine__IO_STACK_LOCATION, yogi_error;
  free ensures {:va_keep} old(completion) == 1 ==> completion != 0;
  free ensures {:va_keep} old(t) == 0 ==> yogi_error == 0;
  free ensures {:va_keep} yogi_error == 1 || yogi_error == old(yogi_error);
...
implementation {:origName "SerialMouseStartRead"} SerialMouseStartRead#1(actual_DeviceExtension_15: int) returns (Tmp_238: int)
{
  ...
  L11:
    call {:si_unique_call 476} Tmp_239, status_19, irql, stack := SerialMouseStartRead#1_loop_L11(sdv_126, Tmp_239, irp_2, status_19, irql, stack, DeviceExtension_15);
    goto L11_last;
  ...
  anon20_Then:
    ...
    call {:si_unique_call 488} status_19 := sdv_IoCallDriver#0(vslice_dummy_var_336, irp_2);
    goto anon24_Then, anon24_Else;
...
implementation {:origName "SerialMouseSerialMaskEventComplete"} SerialMouseSerialMaskEventComplete#0(actual_DeviceObject_1: int, actual_Irp_1: int, actual_Context: int) returns (Tmp_38: int)
{
  ...
  L12:
    ...
    call {:si_unique_call 490} vslice_dummy_var_114 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(deviceExtension_1), vslice_dummy_var_337);
    goto anon20_Then, anon20_Else;
...
procedure {:origName "SerialMouseSerialMaskEventComplete"} SerialMouseSerialMaskEventComplete#0(actual_DeviceObject_1: int, actual_Irp_1: int, actual_Context: int) returns (Tmp_38: int);
  modifies alloc, LockDepth, completion, yogi_error, Mem_T.CompletionRoutine__IO_STACK_LOCATION;
  free ensures {:va_keep} old(completion) == 1 ==> completion != 0;
  free ensures {:va_keep} old(t) == 0 ==> yogi_error == 0;
  free ensures {:va_keep} old(LockDepth) > 0 ==> LockDepth == old(LockDepth) - 1;
  free ensures {:va_keep} old(LockDepth) > 0 ==> yogi_error == 0;
...
implementation {:origName "SerialMouseSerialMaskEventComplete"} SerialMouseSerialMaskEventComplete#1(actual_DeviceObject_1: int, actual_Irp_1: int, actual_Context: int) returns (Tmp_38: int)
{
  ...
  L12:
    ...
    call {:si_unique_call 496} vslice_dummy_var_115 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(deviceExtension_1), vslice_dummy_var_338);
    goto anon20_Then, anon20_Else;
...
implementation {:origName "IoQueueWorkItem"} {:osmodel} IoQueueWorkItem#0(actual_IoWorkItem_1: int, actual_WorkerRoutine: int, actual_QueueType: int, actual_Context_2: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 502} sdv_RunIoQueueWorkItems#0(0, WorkerRoutine, QueueType, Context_2);
    goto anon3_Then, anon3_Else;
...
implementation {:origName "IoQueueWorkItem"} {:osmodel} IoQueueWorkItem#1(actual_IoWorkItem_1: int, actual_WorkerRoutine: int, actual_QueueType: int, actual_Context_2: int)
{
  ...
  anon0:
    ...
    QueueType := actual_QueueType;
    Context_2 := actual_Context_2;
    call {:si_unique_call 504} sdv_RunIoQueueWorkItems#1(0, WorkerRoutine, QueueType, Context_2);
    goto anon3_Then, anon3_Else;
...
implementation {:origName "sdv_RunIoQueueWorkItems"} {:osmodel} sdv_RunIoQueueWorkItems#0(actual_IoWorkItem_2: int, actual_WorkerRoutine_1: int, actual_QueueType_1: int, actual_Context_3: int)
{
  ...
  anon9_Else:
    ...
    call {:si_unique_call 506} SerialMouseSerialMaskEventWorker#0(sdv_p_devobj_fdo, Context_3);
    goto anon11_Then, anon11_Else;
  ...
  anon10_Else:
    ...
    call {:si_unique_call 507} StartDeviceWorker#0(sdv_p_devobj_fdo, Context_3);
    goto anon12_Then, anon12_Else;
...
implementation {:origName "sdv_RunIoQueueWorkItems"} {:osmodel} sdv_RunIoQueueWorkItems#1(actual_IoWorkItem_2: int, actual_WorkerRoutine_1: int, actual_QueueType_1: int, actual_Context_3: int)
{
  ...
  anon9_Else:
    assume {:partition} WorkerRoutine_1 == li2bplFunctionConstant271;
    call {:si_unique_call 509} SerialMouseSerialMaskEventWorker#1(sdv_p_devobj_fdo, Context_3);
    goto anon11_Then, anon11_Else;
  ...
  anon10_Else:
    assume {:partition} WorkerRoutine_1 == li2bplFunctionConstant193;
    call {:si_unique_call 510} StartDeviceWorker#1(sdv_p_devobj_fdo, Context_3);
    goto anon12_Then, anon12_Else;
...
implementation {:origName "SerialMouseSerialMaskEventWorker"} SerialMouseSerialMaskEventWorker#0(actual_DeviceObject_2: int, actual_Context_1: int)
{
  ...
  anon23_Else:
    ...
    call {:si_unique_call 517} vslice_dummy_var_124 := SerialMousepIoSyncIoctlEx#0(0, 1769576, vslice_dummy_var_339, event_1, iosb_1, 0, 0, bits_1, 4);
    goto anon25_Then, anon25_Else;
  ...
  anon21_Then:
    ...
    call {:si_unique_call 521} vslice_dummy_var_122 := SerialMousepIoSyncIoctl#0(1, 3604999, vslice_dummy_var_340, event_1, iosb_1);
    goto anon27_Then, anon27_Else;
...
implementation {:origName "SerialMouseSerialMaskEventWorker"} SerialMouseSerialMaskEventWorker#1(actual_DeviceObject_2: int, actual_Context_1: int)
{
  ...
  anon23_Else:
    ...
    call {:si_unique_call 528} vslice_dummy_var_129 := SerialMousepIoSyncIoctlEx#1(0, 1769576, vslice_dummy_var_341, event_1, iosb_1, 0, 0, bits_1, 4);
    goto anon25_Then, anon25_Else;
  ...
  anon21_Then:
    ...
    call {:si_unique_call 532} vslice_dummy_var_127 := SerialMousepIoSyncIoctl#1(1, 3604999, vslice_dummy_var_342, event_1, iosb_1);
    goto anon27_Then, anon27_Else;
...
implementation {:origName "SerialMouseSendWaitMaskIrp"} SerialMouseSendWaitMaskIrp#1(actual_DeviceExtension_5: int) returns (Tmp_34: int)
{
  ...
  anon5_Else:
    ...
    call {:si_unique_call 543} Tmp_34 := sdv_IoCallDriver#0(vslice_dummy_var_343, irp);
    goto anon6_Then, anon6_Else;
...
implementation {:origName "StartDeviceWorker"} StartDeviceWorker#0(actual_DeviceObject_26: int, actual_Context_10: int)
{
  var {:pointer} WorkItemContext: int;
  ...
  anon18_Else:
    ...
    call {:si_unique_call 547} irp_6 := IoAllocateIrp(vslice_dummy_var_344, 0);
    goto anon19_Then, anon19_Else;
  ...
  anon20_Else:
    ...
    call {:si_unique_call 550} vslice_dummy_var_131 := SerialMousepIoSyncIoctl#0(1, 3604999, vslice_dummy_var_345, event_16, iosb_15);
    goto anon24_Then, anon24_Else;
...
procedure {:origName "StartDeviceWorker"} StartDeviceWorker#0(actual_DeviceObject_26: int, actual_Context_10: int);
...
implementation {:origName "StartDeviceWorker"} StartDeviceWorker#1(actual_DeviceObject_26: int, actual_Context_10: int)
{
  var {:pointer} WorkItemContext: int;
  var {:scalar} iosb_15: int;
  var {:pointer} irp_6: int;
  ...
  anon18_Else:
    ...
    call {:si_unique_call 558} irp_6 := IoAllocateIrp(vslice_dummy_var_346, 0);
    goto anon19_Then, anon19_Else;
  ...
  anon20_Else:
    ...
    call {:si_unique_call 561} vslice_dummy_var_134 := SerialMousepIoSyncIoctl#1(1, 3604999, vslice_dummy_var_347, event_16, iosb_15);
    goto anon24_Then, anon24_Else;
...
procedure {:origName "StartDeviceWorker"} StartDeviceWorker#1(actual_DeviceObject_26: int, actual_Context_10: int);
  modifies alloc, Mem_T.CompletionRoutine__IO_STACK_LOCATION, LockDepth, yogi_error, completion;
  free ensures {:va_keep} old(completion) == 1 ==> completion != 0;
  free ensures {:va_keep} old(t) == 0 ==> yogi_error == 0;
  free ensures {:va_keep} yogi_error == 1 || yogi_error == old(yogi_error);
  free ensures {:va_keep} completion == 1 || completion == old(completion);
...
implementation {:origName "SerialMouseStartDevice"} SerialMouseStartDevice#0(actual_DeviceExtension_30: int, actual_Irp_11: int, actual_CloseOnFailure: int) returns (Tmp_346: int)
{
  ...
  anon18_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 570} Tmp_347 := __HAVOC_malloc(4);
    assume {:nonnull} DeviceExtension_30 != 0;
    assume DeviceExtension_30 > 0;
    assume {:nonnull} Tmp_347 != 0;
    assume Tmp_347 > 0;
    call {:si_unique_call 571} vslice_dummy_var_136 := sdv_InterlockedDecrement(Tmp_347);
    assume {:nonnull} DeviceExtension_30 != 0;
    assume DeviceExtension_30 > 0;
    assume {:nonnull} Tmp_347 != 0;
    assume Tmp_347 > 0;
...
procedure {:origName "SerialMouseStartDevice"} SerialMouseStartDevice#0(actual_DeviceExtension_30: int, actual_Irp_11: int, actual_CloseOnFailure: int) returns (Tmp_346: int);
  modifies alloc, LockDepth, Mem_T.CompletionRoutine__IO_STACK_LOCATION, yogi_error;
  free ensures {:va_keep} old(t) == 0 ==> yogi_error == 0;
  free ensures {:va_keep} old(LockDepth) > 0 ==> yogi_error == 0;
  free ensures {:va_keep} yogi_error == 1 || yogi_error == old(yogi_error);
...
implementation {:origName "SerialMouseStartDevice"} SerialMouseStartDevice#1(actual_DeviceExtension_30: int, actual_Irp_11: int, actual_CloseOnFailure: int) returns (Tmp_346: int)
{
  var {:pointer} Tmp_347: int;
  var {:scalar} status_34: int;
  var {:pointer} DeviceExtension_30: int;
  ...
  anon18_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 576} Tmp_347 := __HAVOC_malloc(4);
    assume {:nonnull} DeviceExtension_30 != 0;
    assume DeviceExtension_30 > 0;
    assume {:nonnull} Tmp_347 != 0;
    assume Tmp_347 > 0;
    call {:si_unique_call 577} vslice_dummy_var_137 := sdv_InterlockedDecrement(Tmp_347);
    assume {:nonnull} DeviceExtension_30 != 0;
    assume DeviceExtension_30 > 0;
    assume {:nonnull} Tmp_347 != 0;
    assume Tmp_347 > 0;
...
procedure {:origName "SerialMouseStartDevice"} SerialMouseStartDevice#1(actual_DeviceExtension_30: int, actual_Irp_11: int, actual_CloseOnFailure: int) returns (Tmp_346: int);
  modifies alloc, LockDepth, Mem_T.CompletionRoutine__IO_STACK_LOCATION, yogi_error, completion;
  free ensures {:va_keep} old(completion) == 1 ==> completion != 0;
  free ensures {:va_keep} old(t) == 0 ==> yogi_error == 0;
  free ensures {:va_keep} yogi_error == 1 || yogi_error == old(yogi_error);
...
implementation {:origName "SerialMouseInitializeDevice"} SerialMouseInitializeDevice#0(actual_DeviceExtension_32: int) returns (Tmp_350: int)
{
  var {:scalar} i_3: int;
  ...
  anon0:
    ...
    call {:si_unique_call 581} Tmp_355 := __HAVOC_malloc(4);
  ...
  L14:
    call {:si_unique_call 583} i_3, Tmp_351 := SerialMouseInitializeDevice#0_loop_L14(i_3, Tmp_351, dumpData);
    goto L14_last;
  ...
  anon19_Then:
    ...
    call {:si_unique_call 586} vslice_dummy_var_138 := SerialMousepIoSyncIoctlEx#0(0, 1769540, vslice_dummy_var_348, event_14, iosb_14, waitMask_1, 4, 0, 0);
    goto anon24_Then, anon24_Else;
  ...
  anon22_Else:
    ...
    assume {:nonnull} DeviceExtension_32 != 0;
    assume DeviceExtension_32 > 0;
    Tmp_356 := 48 + dumpCount * 4;
    call {:si_unique_call 588} sdv_210 := IoAllocateErrorLogEntry(0, Tmp_356);
  ...
  L57:
    call {:si_unique_call 589} i_3, Tmp_352, Tmp_354, Tmp_355 := SerialMouseInitializeDevice#0_loop_L57(i_3, Tmp_352, Tmp_354, errorLogEntry, Tmp_355, dumpData, dumpCount);
    goto L57_last;
...
procedure {:origName "SerialMouseInitializeDevice"} SerialMouseInitializeDevice#0(actual_DeviceExtension_32: int) returns (Tmp_350: int);
  modifies alloc, LockDepth, Mem_T.CompletionRoutine__IO_STACK_LOCATION;
  free ensures {:va_keep} old(LockDepth) == LockDepth;
  free ensures {:va_keep} old(LockDepth) == LockDepth;
  free ensures {:va_keep} old(LockDepth) >= 0 ==> LockDepth == old(LockDepth);
...
implementation {:origName "SerialMouseInitializeDevice"} SerialMouseInitializeDevice#1(actual_DeviceExtension_32: int) returns (Tmp_350: int)
{
  var {:scalar} i_3: int;
  var {:scalar} Tmp_351: int;
  var {:scalar} Tmp_352: int;
  ...
  anon0:
    ...
    DeviceExtension_32 := actual_DeviceExtension_32;
    call {:si_unique_call 595} Tmp_355 := __HAVOC_malloc(4);
  ...
  L14:
    call {:si_unique_call 597} i_3, Tmp_351 := SerialMouseInitializeDevice#1_loop_L14(i_3, Tmp_351, dumpData);
    goto L14_last;
  ...
  anon19_Then:
    ...
    call {:si_unique_call 600} vslice_dummy_var_139 := SerialMousepIoSyncIoctlEx#1(0, 1769540, vslice_dummy_var_349, event_14, iosb_14, waitMask_1, 4, 0, 0);
    goto anon24_Then, anon24_Else;
  ...
  anon22_Else:
    ...
    assume DeviceExtension_32 > 0;
    Tmp_356 := 48 + dumpCount * 4;
    call {:si_unique_call 602} sdv_210 := IoAllocateErrorLogEntry(0, Tmp_356);
    errorLogEntry := sdv_210;
    goto anon27_Then, anon27_Else;
  ...
  L57:
    call {:si_unique_call 603} i_3, Tmp_352, Tmp_354, Tmp_355 := SerialMouseInitializeDevice#1_loop_L57(i_3, Tmp_352, Tmp_354, errorLogEntry, Tmp_355, dumpData, dumpCount);
    goto L57_last;
...
procedure {:origName "SerialMouseInitializeDevice"} SerialMouseInitializeDevice#1(actual_DeviceExtension_32: int) returns (Tmp_350: int);
  modifies alloc, LockDepth, Mem_T.CompletionRoutine__IO_STACK_LOCATION, yogi_error, completion;
  free ensures {:va_keep} old(completion) == 1 ==> completion != 0;
  free ensures {:va_keep} old(t) == 0 ==> yogi_error == 0;
  free ensures {:va_keep} yogi_error == 1 || yogi_error == old(yogi_error);
...
implementation {:origName "MSerDetect"} MSerDetect#0(actual_DeviceExtension_25: int) returns (Tmp_275: int)
{
  ...
  L53:
    call {:si_unique_call 641} Tmp_276, count_3, Tmp_285, sdv_172 := MSerDetect#0_loop_L53(Tmp_276, count_3, receiveBuffer, Tmp_285, sdv_172, DeviceExtension_25);
    goto L53_last;
  ...
  L62:
    call {:si_unique_call 643} i_1 := MSerDetect#0_loop_L62(i_1, count_3);
    goto L62_last;
  ...
  L65:
    call {:si_unique_call 644} i_1, Tmp_278, Tmp_279 := MSerDetect#0_loop_L65(i_1, count_3, Tmp_278, Tmp_279, receiveBuffer);
    goto L65_last;
...
implementation {:origName "MSerDetect"} MSerDetect#1(actual_DeviceExtension_25: int) returns (Tmp_275: int)
{
  ...
  L53:
    call {:si_unique_call 658} Tmp_276, count_3, Tmp_285, sdv_172 := MSerDetect#1_loop_L53(Tmp_276, count_3, receiveBuffer, Tmp_285, sdv_172, DeviceExtension_25);
    goto L53_last;
  ...
  L62:
    call {:si_unique_call 660} i_1 := MSerDetect#1_loop_L62(i_1, count_3);
    goto L62_last;
  ...
  L65:
    call {:si_unique_call 661} i_1, Tmp_278, Tmp_279 := MSerDetect#1_loop_L65(i_1, count_3, Tmp_278, Tmp_279, receiveBuffer);
    goto L65_last;
...
implementation {:origName "SerialMouseInitializePort"} SerialMouseInitializePort#0(actual_DeviceExtension_21: int) returns (Tmp_262: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 669} status_25 := SerialMousepIoSyncIoctlEx#0(1, 1769484, vslice_dummy_var_350, event_10, iosb_10, 0, 0, SerialBasicSettings__DEVICE_EXTENSION(DeviceExtension_21), 44);
    goto anon14_Then, anon14_Else;
  ...
  anon13_Then:
    ...
    call {:si_unique_call 670} vslice_dummy_var_164 := SerialMousepIoSyncIoctlEx#0(0, 1769504, vslice_dummy_var_351, event_10, iosb_10, 0, 0, Timeouts__SERIAL_BASIC_SETTINGS(SerialBasicSettings__DEVICE_EXTENSION(DeviceExtension_21)), 20);
    goto anon15_Then, anon15_Else;
  ...
  anon15_Else:
    ...
    call {:si_unique_call 672} vslice_dummy_var_165 := SerialMousepIoSyncIoctlEx#0(0, 1769500, vslice_dummy_var_352, event_10, iosb_10, serialTimeouts, 20, 0, 0);
    goto anon16_Then, anon16_Else;
  ...
  anon16_Else:
    ...
    call {:si_unique_call 673} vslice_dummy_var_166 := SerialMousepIoSyncIoctlEx#0(0, 1769568, vslice_dummy_var_353, event_10, iosb_10, 0, 0, HandFlow__SERIAL_BASIC_SETTINGS(SerialBasicSettings__DEVICE_EXTENSION(DeviceExtension_21)), 16);
    goto anon17_Then, anon17_Else;
  ...
  anon17_Else:
    ...
    call {:si_unique_call 674} status_25 := SerialMousepIoSyncIoctlEx#0(0, 1769572, vslice_dummy_var_354, event_10, iosb_10, serialHandFlow, 16, 0, 0);
    goto anon18_Then, anon18_Else;
...
implementation {:origName "SerialMouseInitializePort"} SerialMouseInitializePort#1(actual_DeviceExtension_21: int) returns (Tmp_262: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 680} status_25 := SerialMousepIoSyncIoctlEx#1(1, 1769484, vslice_dummy_var_355, event_10, iosb_10, 0, 0, SerialBasicSettings__DEVICE_EXTENSION(DeviceExtension_21), 44);
    goto anon14_Then, anon14_Else;
  ...
  anon13_Then:
    ...
    call {:si_unique_call 681} vslice_dummy_var_167 := SerialMousepIoSyncIoctlEx#1(0, 1769504, vslice_dummy_var_356, event_10, iosb_10, 0, 0, Timeouts__SERIAL_BASIC_SETTINGS(SerialBasicSettings__DEVICE_EXTENSION(DeviceExtension_21)), 20);
    goto anon15_Then, anon15_Else;
  ...
  anon15_Else:
    ...
    call {:si_unique_call 683} vslice_dummy_var_168 := SerialMousepIoSyncIoctlEx#1(0, 1769500, vslice_dummy_var_357, event_10, iosb_10, serialTimeouts, 20, 0, 0);
    goto anon16_Then, anon16_Else;
  ...
  anon16_Else:
    ...
    call {:si_unique_call 684} vslice_dummy_var_169 := SerialMousepIoSyncIoctlEx#1(0, 1769568, vslice_dummy_var_358, event_10, iosb_10, 0, 0, HandFlow__SERIAL_BASIC_SETTINGS(SerialBasicSettings__DEVICE_EXTENSION(DeviceExtension_21)), 16);
    goto anon17_Then, anon17_Else;
  ...
  anon17_Else:
    ...
    call {:si_unique_call 685} status_25 := SerialMousepIoSyncIoctlEx#1(0, 1769572, vslice_dummy_var_359, event_10, iosb_10, serialHandFlow, 16, 0, 0);
    goto anon18_Then, anon18_Else;
...
implementation {:origName "MSerPowerDown"} MSerPowerDown#0(actual_DeviceExtension_24: int) returns (Tmp_273: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 690} status_27 := SerialMousepIoSyncIoctl#0(0, 1769508, vslice_dummy_var_360, event_12, iosb_12);
    goto anon14_Then, anon14_Else;
  ...
  anon11_Else:
    ...
    call {:si_unique_call 691} status_27 := SerialMousepIoSyncIoctl#0(0, 1769524, vslice_dummy_var_361, event_12, iosb_12);
    goto anon15_Then, anon15_Else;
...
implementation {:origName "MSerPowerDown"} MSerPowerDown#1(actual_DeviceExtension_24: int) returns (Tmp_273: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 697} status_27 := SerialMousepIoSyncIoctl#1(0, 1769508, vslice_dummy_var_362, event_12, iosb_12);
    goto anon14_Then, anon14_Else;
  ...
  anon11_Else:
    ...
    call {:si_unique_call 698} status_27 := SerialMousepIoSyncIoctl#1(0, 1769524, vslice_dummy_var_363, event_12, iosb_12);
    goto anon15_Then, anon15_Else;
...
implementation {:origName "SerialMouseSetBaudRate"} SerialMouseSetBaudRate#0(actual_DeviceExtension_9: int, actual_BaudRate_1: int) returns (Tmp_53: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 705} status_8 := SerialMousepIoSyncIoctlEx#0(0, 1769476, vslice_dummy_var_364, event_3, iosb_3, sbr, 4, 0, 0);
    goto anon3_Then, anon3_Else;
...
implementation {:origName "SerialMouseSetBaudRate"} SerialMouseSetBaudRate#1(actual_DeviceExtension_9: int, actual_BaudRate_1: int) returns (Tmp_53: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 711} status_8 := SerialMousepIoSyncIoctlEx#1(0, 1769476, vslice_dummy_var_365, event_3, iosb_3, sbr, 4, 0, 0);
    goto anon3_Then, anon3_Else;
...
implementation {:origName "SerialMouseFlushReadBuffer"} SerialMouseFlushReadBuffer#0(actual_DeviceExtension_12: int) returns (Tmp_61: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 716} status_11 := SerialMousepIoSyncIoctlEx#0(0, 1769548, vslice_dummy_var_366, event_4, iosb_6, bits_3, 4, 0, 0);
    goto anon3_Then, anon3_Else;
...
implementation {:origName "SerialMouseFlushReadBuffer"} SerialMouseFlushReadBuffer#1(actual_DeviceExtension_12: int) returns (Tmp_61: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 721} status_11 := SerialMousepIoSyncIoctlEx#1(0, 1769548, vslice_dummy_var_367, event_4, iosb_6, bits_3, 4, 0, 0);
    goto anon3_Then, anon3_Else;
...
implementation {:origName "MSerPowerUp"} MSerPowerUp#0(actual_DeviceExtension_26: int) returns (Tmp_286: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 726} status_29 := SerialMousepIoSyncIoctl#0(0, 1769512, vslice_dummy_var_368, event_13, iosb_13);
    goto anon27_Then, anon27_Else;
  ...
  anon21_Else:
    ...
    call {:si_unique_call 727} status_29 := SerialMousepIoSyncIoctl#0(0, 1769524, vslice_dummy_var_369, event_13, iosb_13);
    goto anon28_Then, anon28_Else;
  ...
  anon23_Else:
    ...
    call {:si_unique_call 729} status_29 := SerialMousepIoSyncIoctl#0(0, 1769508, vslice_dummy_var_370, event_13, iosb_13);
    goto anon29_Then, anon29_Else;
  ...
  anon25_Else:
    ...
    call {:si_unique_call 731} status_29 := SerialMousepIoSyncIoctl#0(0, 1769520, vslice_dummy_var_371, event_13, iosb_13);
    goto anon30_Then, anon30_Else;
...
implementation {:origName "MSerPowerUp"} MSerPowerUp#1(actual_DeviceExtension_26: int) returns (Tmp_286: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 737} status_29 := SerialMousepIoSyncIoctl#1(0, 1769512, vslice_dummy_var_372, event_13, iosb_13);
    goto anon27_Then, anon27_Else;
  ...
  anon21_Else:
    ...
    call {:si_unique_call 738} status_29 := SerialMousepIoSyncIoctl#1(0, 1769524, vslice_dummy_var_373, event_13, iosb_13);
    goto anon28_Then, anon28_Else;
  ...
  anon23_Else:
    ...
    call {:si_unique_call 740} status_29 := SerialMousepIoSyncIoctl#1(0, 1769508, vslice_dummy_var_374, event_13, iosb_13);
    goto anon29_Then, anon29_Else;
  ...
  anon25_Else:
    ...
    call {:si_unique_call 742} status_29 := SerialMousepIoSyncIoctl#1(0, 1769520, vslice_dummy_var_375, event_13, iosb_13);
    goto anon30_Then, anon30_Else;
...
implementation {:origName "SerialMouseSetReadTimeouts"} SerialMouseSetReadTimeouts#0(actual_DeviceExtension_22: int, actual_Timeout_2: int) returns (Tmp_264: int)
{
  ...
  L14:
    ...
    call {:si_unique_call 749} status_26 := SerialMousepIoSyncIoctlEx#0(0, 1769500, vslice_dummy_var_376, event_11, iosb_11, serialTimeouts_1, 20, 0, 0);
    goto anon6_Then, anon6_Else;
...
implementation {:origName "SerialMouseSetReadTimeouts"} SerialMouseSetReadTimeouts#1(actual_DeviceExtension_22: int, actual_Timeout_2: int) returns (Tmp_264: int)
{
  ...
  L14:
    ...
    call {:si_unique_call 755} status_26 := SerialMousepIoSyncIoctlEx#1(0, 1769500, vslice_dummy_var_377, event_11, iosb_11, serialTimeouts_1, 20, 0, 0);
    goto anon6_Then, anon6_Else;
...
implementation {:origName "SerialMouseSetLineCtrl"} SerialMouseSetLineCtrl#0(actual_DeviceExtension_14: int, actual_SerialLineControl: int) returns (Tmp_65: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 760} status_13 := SerialMousepIoSyncIoctlEx#0(0, 1769484, vslice_dummy_var_378, event_6, iosb_8, SerialLineControl, 3, 0, 0);
    goto anon3_Then, anon3_Else;
...
implementation {:origName "SerialMouseSetLineCtrl"} SerialMouseSetLineCtrl#1(actual_DeviceExtension_14: int, actual_SerialLineControl: int) returns (Tmp_65: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 765} status_13 := SerialMousepIoSyncIoctlEx#1(0, 1769484, vslice_dummy_var_379, event_6, iosb_8, SerialLineControl, 3, 0, 0);
    goto anon3_Then, anon3_Else;
...
implementation {:origName "SerialMouseReadSerialPort"} SerialMouseReadSerialPort#1(actual_DeviceExtension_18: int, actual_ReadBuffer: int, actual_Buflen: int, actual_ActualBytesRead: int) returns (Tmp_248: int)
{
  ...
  L15:
    call {:si_unique_call 780} status_22, stack_1 := SerialMouseReadSerialPort#1_loop_L15(irp_4, status_22, event_9, stack_1, DeviceExtension_18, ReadBuffer, Buflen, ActualBytesRead);
    goto L15_last;
  ...
  anon16_Else:
    ...
    call {:si_unique_call 785} status_22 := sdv_IoCallDriver#0(vslice_dummy_var_380, irp_4);
    goto anon21_Then, anon21_Else;
...
implementation {:origName "CSerDetect"} CSerDetect#0(actual_DeviceExtension_3: int, actual_HardwareButtons: int) returns (Tmp_18: int)
{
  ...
  L20:
    call {:si_unique_call 792} Tmp_19, count_1, Tmp_21, sdv_14, vslice_dummy_var_171, vslice_dummy_var_172, vslice_dummy_var_173, vslice_dummy_var_174, vslice_dummy_var_180 := CSerDetect#0_loop_L20(Tmp_19, count_1, Tmp_21, sdv_14, status_1, DeviceExtension_3, vslice_dummy_var_171, vslice_dummy_var_172, vslice_dummy_var_173, vslice_dummy_var_174, vslice_dummy_var_180);
    goto L20_last;
...
implementation {:origName "CSerDetect"} CSerDetect#1(actual_DeviceExtension_3: int, actual_HardwareButtons: int) returns (Tmp_18: int)
{
  ...
  L20:
    call {:si_unique_call 812} Tmp_19, count_1, Tmp_21, sdv_14, vslice_dummy_var_182, vslice_dummy_var_183, vslice_dummy_var_184, vslice_dummy_var_185, vslice_dummy_var_191 := CSerDetect#1_loop_L20(Tmp_19, count_1, Tmp_21, sdv_14, status_1, DeviceExtension_3, vslice_dummy_var_182, vslice_dummy_var_183, vslice_dummy_var_184, vslice_dummy_var_185, vslice_dummy_var_191);
    goto L20_last;
...
implementation {:origName "SerialMouseWriteSerialPort"} SerialMouseWriteSerialPort#1(actual_DeviceExtension_17: int, actual_WriteBuffer: int, actual_NumBytes: int, actual_IoStatusBlock_2: int) returns (Tmp_244: int)
{
  ...
  anon7_Else:
    ...
    call {:si_unique_call 851} status_21 := sdv_IoCallDriver#0(vslice_dummy_var_381, irp_3);
    goto anon9_Then, anon9_Else;
  ...
  anon8_Else:
    ...
    call {:si_unique_call 852} vslice_dummy_var_197 := KeWaitForSingleObject(0, 0, 0, 0, 0);
    goto L22;
...
implementation {:origName "CSerSetProtocol"} CSerSetProtocol#0(actual_DeviceExtension_2: int, actual_NewProtocol: int) returns (Tmp_11: int)
{
  ...
  anon0:
    ...
    Tmp_16 := NewProtocol;
    havoc Tmp_12;
    call {:si_unique_call 854} vslice_dummy_var_198 := SerialMouseWriteChar#0(DeviceExtension_2, Tmp_12);
    goto anon5_Then, anon5_Else;
  ...
  anon5_Else:
    ...
    Tmp_15 := NewProtocol;
    havoc Tmp_14;
    call {:si_unique_call 855} vslice_dummy_var_199 := SerialMouseSetLineCtrl#0(DeviceExtension_2, Tmp_14);
    goto anon6_Then, anon6_Else;
...
implementation {:origName "CSerSetProtocol"} CSerSetProtocol#1(actual_DeviceExtension_2: int, actual_NewProtocol: int) returns (Tmp_11: int)
{
  ...
  anon0:
    ...
    Tmp_16 := NewProtocol;
    havoc Tmp_12;
    call {:si_unique_call 857} vslice_dummy_var_200 := SerialMouseWriteChar#1(DeviceExtension_2, Tmp_12);
    goto anon5_Then, anon5_Else;
  ...
  anon5_Else:
    ...
    Tmp_15 := NewProtocol;
    havoc Tmp_14;
    call {:si_unique_call 858} vslice_dummy_var_201 := SerialMouseSetLineCtrl#1(DeviceExtension_2, Tmp_14);
    goto anon6_Then, anon6_Else;
...
implementation {:origName "CSerSetBaudRate"} CSerSetBaudRate#0(actual_DeviceExtension_4: int, actual_BaudRate: int)
{
  ...
  anon0:
    call {:si_unique_call 859} vslice_dummy_var_202 := __HAVOC_malloc(4);
  ...
  anon13_Else:
    Tmp_24 := count_2;
    havoc Tmp_29;
    call {:si_unique_call 863} vslice_dummy_var_204 := SerialMouseWriteString#0(DeviceExtension_4, Tmp_29);
    goto anon14_Then, anon14_Else;
  ...
  anon14_Else:
    ...
    Tmp_23 := count_2;
    havoc Tmp_28;
    call {:si_unique_call 864} vslice_dummy_var_205 := SerialMouseSetBaudRate#0(DeviceExtension_4, Tmp_28);
    goto anon15_Then, anon15_Else;

  anon15_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 865} vslice_dummy_var_203 := SerialMouseWait(DeviceExtension_4, -20000);
    goto L1;
...
implementation {:origName "CSerSetBaudRate"} CSerSetBaudRate#1(actual_DeviceExtension_4: int, actual_BaudRate: int)
{
  ...
  anon0:
    call {:si_unique_call 866} vslice_dummy_var_206 := __HAVOC_malloc(4);
    DeviceExtension_4 := actual_DeviceExtension_4;
    BaudRate := actual_BaudRate;
  ...
  anon13_Else:
    Tmp_24 := count_2;
    havoc Tmp_29;
    call {:si_unique_call 870} vslice_dummy_var_208 := SerialMouseWriteString#1(DeviceExtension_4, Tmp_29);
    goto anon14_Then, anon14_Else;
  ...
  anon14_Else:
    ...
    Tmp_23 := count_2;
    havoc Tmp_28;
    call {:si_unique_call 871} vslice_dummy_var_209 := SerialMouseSetBaudRate#1(DeviceExtension_4, Tmp_28);
    goto anon15_Then, anon15_Else;

  anon15_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 872} vslice_dummy_var_207 := SerialMouseWait(DeviceExtension_4, -20000);
    goto L1;
...
implementation {:origName "MSerSetProtocol"} MSerSetProtocol#0(actual_DeviceExtension_23: int, actual_NewProtocol_1: int) returns (Tmp_266: int)
{
  ...
  L7:
    ...
    havoc Tmp_268;
    call {:si_unique_call 880} vslice_dummy_var_210 := SerialMouseSetLineCtrl#0(DeviceExtension_23, Tmp_268);
    goto anon6_Then, anon6_Else;
...
implementation {:origName "MSerSetProtocol"} MSerSetProtocol#1(actual_DeviceExtension_23: int, actual_NewProtocol_1: int) returns (Tmp_266: int)
{
  ...
  L7:
    Tmp_270 := NewProtocol_1;
    havoc Tmp_268;
    call {:si_unique_call 882} vslice_dummy_var_211 := SerialMouseSetLineCtrl#1(DeviceExtension_23, Tmp_268);
    goto anon6_Then, anon6_Else;
...
implementation {:origName "SerialMouseSetFifo"} SerialMouseSetFifo#0(actual_DeviceExtension_13: int, actual_Value_2: int) returns (Tmp_63: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 888} status_12 := SerialMousepIoSyncIoctlEx#0(0, 1769628, vslice_dummy_var_382, event_5, iosb_7, fifo, 4, 0, 0);
    goto anon3_Then, anon3_Else;
...
implementation {:origName "SerialMouseSetFifo"} SerialMouseSetFifo#1(actual_DeviceExtension_13: int, actual_Value_2: int) returns (Tmp_63: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 894} status_12 := SerialMousepIoSyncIoctlEx#1(0, 1769628, vslice_dummy_var_383, event_5, iosb_7, fifo, 4, 0, 0);
    goto anon3_Then, anon3_Else;
...
implementation {:origName "SerialMouseStartDetection"} SerialMouseStartDetection#0(actual_DeviceExtension_6: int)
{
  ...
  anon0:
    call {:si_unique_call 895} vslice_dummy_var_212 := __HAVOC_malloc(4);
  ...
  L29:
    ...
    call {:si_unique_call 904} status_6 := SerialMousepIoSyncIoctlEx#0(0, 1769540, vslice_dummy_var_384, event_2, iosb_2, waitMask, 4, 0, 0);
    goto anon34_Then, anon34_Else;
  ...
  anon30_Then:
    ...
    call {:si_unique_call 906} vslice_dummy_var_213 := IoCancelIrp(0);
    assume {:nonnull} DeviceExtension_6 != 0;
    assume DeviceExtension_6 > 0;
    goto L1;
  ...
  anon35_Then:
    ...
    call {:si_unique_call 907} boogieTmp := IoAllocateIrp(vslice_dummy_var_385, 0);
    assume {:nonnull} DeviceExtension_6 != 0;
    assume DeviceExtension_6 > 0;
  ...
  anon28_Then:
    ...
    call {:si_unique_call 908} status_6 := SerialMousepIoSyncIoctlEx#0(0, 1769576, vslice_dummy_var_386, event_2, iosb_2, 0, 0, bits_2, 4);
    goto anon37_Then, anon37_Else;
...
implementation {:origName "SerialMouseStartDetection"} SerialMouseStartDetection#1(actual_DeviceExtension_6: int)
{
  ...
  anon0:
    call {:si_unique_call 910} vslice_dummy_var_214 := __HAVOC_malloc(4);
  ...
  L29:
    ...
    call {:si_unique_call 919} status_6 := SerialMousepIoSyncIoctlEx#1(0, 1769540, vslice_dummy_var_387, event_2, iosb_2, waitMask, 4, 0, 0);
    goto anon34_Then, anon34_Else;
  ...
  anon30_Then:
    assume {:partition} 0 > status_6;
    call {:si_unique_call 921} vslice_dummy_var_215 := IoCancelIrp(0);
    assume {:nonnull} DeviceExtension_6 != 0;
    assume DeviceExtension_6 > 0;
    goto L1;
  ...
  anon35_Then:
    ...
    call {:si_unique_call 922} boogieTmp := IoAllocateIrp(vslice_dummy_var_388, 0);
    assume {:nonnull} DeviceExtension_6 != 0;
    assume DeviceExtension_6 > 0;
    goto anon31_Then, anon31_Else;
  ...
  anon28_Then:
    ...
    call {:si_unique_call 923} status_6 := SerialMousepIoSyncIoctlEx#1(0, 1769576, vslice_dummy_var_389, event_2, iosb_2, 0, 0, bits_2, 4);
    goto anon37_Then, anon37_Else;
...
implementation {:origName "SerialMouseSpinUpRead"} SerialMouseSpinUpRead#0(actual_DeviceExtension_29: int) returns (Tmp_344: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 926} vslice_dummy_var_216 := sdv_IoAcquireRemoveLock(0, 0);
...
procedure {:origName "SerialMouseSpinUpRead"} SerialMouseSpinUpRead#0(actual_DeviceExtension_29: int) returns (Tmp_344: int);
  modifies alloc, LockDepth, Mem_T.CompletionRoutine__IO_STACK_LOCATION, yogi_error;
  free ensures {:va_keep} old(t) == 0 ==> yogi_error == 0;
  free ensures {:va_keep} old(LockDepth) > 0 ==> yogi_error == 0;
  free ensures {:va_keep} yogi_error == 1 || yogi_error == old(yogi_error);
...
implementation {:origName "SerialMouseSpinUpRead"} SerialMouseSpinUpRead#1(actual_DeviceExtension_29: int) returns (Tmp_344: int)
{
  var {:scalar} status_33: int;
  var {:pointer} DeviceExtension_29: int;
  ...
  anon0:
    ...
    call {:si_unique_call 929} vslice_dummy_var_217 := sdv_IoAcquireRemoveLock(0, 0);
    assume {:nonnull} DeviceExtension_29 != 0;
    assume DeviceExtension_29 > 0;
...
procedure {:origName "SerialMouseSpinUpRead"} SerialMouseSpinUpRead#1(actual_DeviceExtension_29: int) returns (Tmp_344: int);
  modifies alloc, LockDepth, Mem_T.CompletionRoutine__IO_STACK_LOCATION, yogi_error, completion;
  free ensures {:va_keep} old(completion) == 1 ==> completion != 0;
  free ensures {:va_keep} old(t) == 0 ==> yogi_error == 0;
  free ensures {:va_keep} yogi_error == 1 || yogi_error == old(yogi_error);
...
implementation {:origName "SerialMouseClosePort"} SerialMouseClosePort#0(actual_DeviceExtension_31: int, actual_Irp_12: int)
{
  ...
  anon0:
    call {:si_unique_call 931} vslice_dummy_var_218 := __HAVOC_malloc(4);
  ...
  anon7_Else:
    ...
    call {:si_unique_call 936} vslice_dummy_var_219 := SerialMouseSendIrpSynchronously#0(vslice_dummy_var_390, Irp_12, 0);
    goto anon8_Then, anon8_Else;
  ...
  anon8_Else:
    ...
    call {:si_unique_call 939} vslice_dummy_var_220 := SerialMouseSendIrpSynchronously#0(vslice_dummy_var_391, Irp_12, 0);
    goto anon9_Then, anon9_Else;
...
implementation {:origName "SerialMouseClosePort"} SerialMouseClosePort#1(actual_DeviceExtension_31: int, actual_Irp_12: int)
{
  ...
  anon0:
    call {:si_unique_call 940} vslice_dummy_var_221 := __HAVOC_malloc(4);
    DeviceExtension_31 := actual_DeviceExtension_31;
    Irp_12 := actual_Irp_12;
  ...
  anon7_Else:
    ...
    call {:si_unique_call 945} vslice_dummy_var_222 := SerialMouseSendIrpSynchronously#1(vslice_dummy_var_392, Irp_12, 0);
    goto anon8_Then, anon8_Else;
  ...
  anon8_Else:
    ...
    call {:si_unique_call 948} vslice_dummy_var_223 := SerialMouseSendIrpSynchronously#1(vslice_dummy_var_393, Irp_12, 0);
    goto anon9_Then, anon9_Else;
...
implementation {:origName "SerialMouseRestorePort"} SerialMouseRestorePort#0(actual_DeviceExtension_16: int)
{
  ...
  anon0:
    call {:si_unique_call 949} vslice_dummy_var_224 := __HAVOC_malloc(4);
    ...
    call {:si_unique_call 953} status_20 := SerialMousepIoSyncIoctlEx#0(1, 1769488, vslice_dummy_var_394, event_7, iosb_9, SerialBasicSettings__DEVICE_EXTENSION(DeviceExtension_16), 44, 0, 0);
    goto anon10_Then, anon10_Else;
  ...
  anon9_Else:
    ...
    call {:si_unique_call 954} vslice_dummy_var_225 := SerialMousepIoSyncIoctlEx#0(0, 1769500, vslice_dummy_var_395, event_7, iosb_9, Timeouts__SERIAL_BASIC_SETTINGS(SerialBasicSettings__DEVICE_EXTENSION(DeviceExtension_16)), 20, 0, 0);
    goto anon11_Then, anon11_Else;
  ...
  anon11_Else:
    ...
    call {:si_unique_call 955} vslice_dummy_var_226 := SerialMousepIoSyncIoctlEx#0(0, 1769572, vslice_dummy_var_396, event_7, iosb_9, HandFlow__SERIAL_BASIC_SETTINGS(SerialBasicSettings__DEVICE_EXTENSION(DeviceExtension_16)), 16, 0, 0);
    goto anon12_Then, anon12_Else;
...
implementation {:origName "SerialMouseRestorePort"} SerialMouseRestorePort#1(actual_DeviceExtension_16: int)
{
  ...
  anon0:
    call {:si_unique_call 956} vslice_dummy_var_227 := __HAVOC_malloc(4);
    ...
    call {:si_unique_call 960} status_20 := SerialMousepIoSyncIoctlEx#1(1, 1769488, vslice_dummy_var_397, event_7, iosb_9, SerialBasicSettings__DEVICE_EXTENSION(DeviceExtension_16), 44, 0, 0);
    goto anon10_Then, anon10_Else;
  ...
  anon9_Else:
    ...
    call {:si_unique_call 961} vslice_dummy_var_228 := SerialMousepIoSyncIoctlEx#1(0, 1769500, vslice_dummy_var_398, event_7, iosb_9, Timeouts__SERIAL_BASIC_SETTINGS(SerialBasicSettings__DEVICE_EXTENSION(DeviceExtension_16)), 20, 0, 0);
    goto anon11_Then, anon11_Else;
  ...
  anon11_Else:
    ...
    call {:si_unique_call 962} vslice_dummy_var_229 := SerialMousepIoSyncIoctlEx#1(0, 1769572, vslice_dummy_var_399, event_7, iosb_9, HandFlow__SERIAL_BASIC_SETTINGS(SerialBasicSettings__DEVICE_EXTENSION(DeviceExtension_16)), 16, 0, 0);
    goto anon12_Then, anon12_Else;
...
implementation {:origName "SerialMouseSendIrpSynchronously"} SerialMouseSendIrpSynchronously#0(actual_DeviceObject_24: int, actual_Irp_17: int, actual_CopyToNext: int) returns (Tmp_372: int)
{
...
procedure {:origName "SerialMouseSendIrpSynchronously"} SerialMouseSendIrpSynchronously#0(actual_DeviceObject_24: int, actual_Irp_17: int, actual_CopyToNext: int) returns (Tmp_372: int);
  modifies alloc, Mem_T.CompletionRoutine__IO_STACK_LOCATION;
  free ensures {:va_keep} false;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} false || old(completion) == 1 || old(completion) == 0;
...
implementation {:origName "SerialMouseSendIrpSynchronously"} SerialMouseSendIrpSynchronously#1(actual_DeviceObject_24: int, actual_Irp_17: int, actual_CopyToNext: int) returns (Tmp_372: int)
{
  var {:scalar} status_41: int;
  var {:scalar} event_15: int;
  var {:pointer} DeviceObject_24: int;
  ...
  anon8_Else:
    ...
    call {:si_unique_call 974} vslice_dummy_var_231 := KeWaitForSingleObject(0, 0, 0, 0, 0);
...
procedure {:origName "SerialMouseSendIrpSynchronously"} SerialMouseSendIrpSynchronously#1(actual_DeviceObject_24: int, actual_Irp_17: int, actual_CopyToNext: int) returns (Tmp_372: int);
  modifies alloc, Mem_T.CompletionRoutine__IO_STACK_LOCATION, yogi_error, completion, LockDepth;
  free ensures {:va_keep} old(completion) == 1 ==> completion != 0;
  free ensures {:va_keep} old(t) == 0 ==> yogi_error == 0;
  free ensures {:va_keep} yogi_error == 1 || yogi_error == old(yogi_error);
...
implementation {:SIextraRecBound 5} SerialMousePnP_loop_L88(in_i_4: int, in_devCaps: int, in_Tmp_387: int, in_Tmp_388: int) returns (out_i_4: int, out_Tmp_387: int, out_Tmp_388: int)
{

  entry:
    out_i_4, out_Tmp_387, out_Tmp_388 := in_i_4, in_Tmp_387, in_Tmp_388;
    goto L88, exit;
  ...
  anon108_Else_dummy:
    call {:si_unique_call 975} {:si_old_unique_call 1} out_i_4, out_Tmp_387, out_Tmp_388 := SerialMousePnP_loop_L88(out_i_4, in_devCaps, out_Tmp_387, out_Tmp_388);
    return;
}



procedure {:LoopProcedure} SerialMousePnP_loop_L88(in_i_4: int, in_devCaps: int, in_Tmp_387: int, in_Tmp_388: int) returns (out_i_4: int, out_Tmp_387: int, out_Tmp_388: int);
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} false || old(completion) == 1 || old(completion) == 0;
  free ensures {:va_keep} false || old(t) == 1 || old(t) == 0;
  free ensures {:va_keep} alloc >= old(alloc);
...
implementation SerialMouseStartRead#1_loop_L11(in_sdv_126: int, in_Tmp_239: int, in_irp_2: int, in_status_19: int, in_irql: int, in_stack: int, in_DeviceExtension_15: int) returns (out_Tmp_239: int, out_status_19: int, out_irql: int, out_stack: int)
{
  ...
  anon20_Then:
    ...
    call {:si_unique_call 980} out_status_19 := sdv_IoCallDriver#0(vslice_dummy_var_400, in_irp_2);
    goto anon24_Else;
  ...
  anon21_Else_dummy:
    call {:si_unique_call 983} {:si_old_unique_call 1} out_Tmp_239, out_status_19, out_irql, out_stack := SerialMouseStartRead#1_loop_L11(in_sdv_126, out_Tmp_239, in_irp_2, out_status_19, out_irql, out_stack, in_DeviceExtension_15);
    return;
}



procedure {:LoopProcedure} SerialMouseStartRead#1_loop_L11(in_sdv_126: int, in_Tmp_239: int, in_irp_2: int, in_status_19: int, in_irql: int, in_stack: int, in_DeviceExtension_15: int) returns (out_Tmp_239: int, out_status_19: int, out_irql: int, out_stack: int);
  modifies alloc, Mem_T.CompletionRoutine__IO_STACK_LOCATION, yogi_error, completion, LockDepth;
  free ensures {:va_keep} old(LockDepth) != 0 ==> yogi_error == 0;
  free ensures {:va_keep} old(LockDepth) == 0 ==> yogi_error == 0;
  free ensures {:va_keep} old(completion) == 1 ==> completion != 0;
...
implementation SerialMouseInitializeDevice#0_loop_L57(in_i_3: int, in_Tmp_352: int, in_Tmp_354: int, in_errorLogEntry: int, in_Tmp_355: int, in_dumpData: int, in_dumpCount: int) returns (out_i_3: int, out_Tmp_352: int, out_Tmp_354: int, out_Tmp_355: int)
{

  entry:
    out_i_3, out_Tmp_352, out_Tmp_354, out_Tmp_355 := in_i_3, in_Tmp_352, in_Tmp_354, in_Tmp_355;
    goto L57, exit;
  ...
  anon23_Else_dummy:
    call {:si_unique_call 984} {:si_old_unique_call 1} out_i_3, out_Tmp_352, out_Tmp_354, out_Tmp_355 := SerialMouseInitializeDevice#0_loop_L57(out_i_3, out_Tmp_352, out_Tmp_354, in_errorLogEntry, out_Tmp_355, in_dumpData, in_dumpCount);
    return;
}



procedure {:LoopProcedure} SerialMouseInitializeDevice#0_loop_L57(in_i_3: int, in_Tmp_352: int, in_Tmp_354: int, in_errorLogEntry: int, in_Tmp_355: int, in_dumpData: int, in_dumpCount: int) returns (out_i_3: int, out_Tmp_352: int, out_Tmp_354: int, out_Tmp_355: int);
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} false || old(completion) == 1 || old(completion) == 0;
  free ensures {:va_keep} false || old(t) == 1 || old(t) == 0;
  free ensures {:va_keep} alloc >= old(alloc);
...
implementation {:SIextraRecBound 4} SerialMouseInitializeDevice#0_loop_L14(in_i_3: int, in_Tmp_351: int, in_dumpData: int) returns (out_i_3: int, out_Tmp_351: int)
{

  entry:
    out_i_3, out_Tmp_351 := in_i_3, in_Tmp_351;
    goto L14, exit;
  ...
  anon19_Else_dummy:
    call {:si_unique_call 985} {:si_old_unique_call 1} out_i_3, out_Tmp_351 := SerialMouseInitializeDevice#0_loop_L14(out_i_3, out_Tmp_351, in_dumpData);
    return;
}



procedure {:LoopProcedure} SerialMouseInitializeDevice#0_loop_L14(in_i_3: int, in_Tmp_351: int, in_dumpData: int) returns (out_i_3: int, out_Tmp_351: int);
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} false || old(completion) == 1 || old(completion) == 0;
  free ensures {:va_keep} false || old(t) == 1 || old(t) == 0;
  free ensures {:va_keep} alloc >= old(alloc);
...
implementation SerialMouseInitializeDevice#1_loop_L57(in_i_3: int, in_Tmp_352: int, in_Tmp_354: int, in_errorLogEntry: int, in_Tmp_355: int, in_dumpData: int, in_dumpCount: int) returns (out_i_3: int, out_Tmp_352: int, out_Tmp_354: int, out_Tmp_355: int)
{
  ...
  anon23_Else_dummy:
    call {:si_unique_call 986} {:si_old_unique_call 1} out_i_3, out_Tmp_352, out_Tmp_354, out_Tmp_355 := SerialMouseInitializeDevice#1_loop_L57(out_i_3, out_Tmp_352, out_Tmp_354, in_errorLogEntry, out_Tmp_355, in_dumpData, in_dumpCount);
    return;
}



procedure {:LoopProcedure} SerialMouseInitializeDevice#1_loop_L57(in_i_3: int, in_Tmp_352: int, in_Tmp_354: int, in_errorLogEntry: int, in_Tmp_355: int, in_dumpData: int, in_dumpCount: int) returns (out_i_3: int, out_Tmp_352: int, out_Tmp_354: int, out_Tmp_355: int);
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} false || old(completion) == 1 || old(completion) == 0;
  free ensures {:va_keep} false || old(t) == 1 || old(t) == 0;
  free ensures {:va_keep} alloc >= old(alloc);
...
implementation {:SIextraRecBound 4} SerialMouseInitializeDevice#1_loop_L14(in_i_3: int, in_Tmp_351: int, in_dumpData: int) returns (out_i_3: int, out_Tmp_351: int)
{
  ...
  anon19_Else_dummy:
    call {:si_unique_call 987} {:si_old_unique_call 1} out_i_3, out_Tmp_351 := SerialMouseInitializeDevice#1_loop_L14(out_i_3, out_Tmp_351, in_dumpData);
    return;
}



procedure {:LoopProcedure} SerialMouseInitializeDevice#1_loop_L14(in_i_3: int, in_Tmp_351: int, in_dumpData: int) returns (out_i_3: int, out_Tmp_351: int);
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} false || old(completion) == 1 || old(completion) == 0;
  free ensures {:va_keep} false || old(t) == 1 || old(t) == 0;
  free ensures {:va_keep} alloc >= old(alloc);
...
implementation MSerDetect#0_loop_L53(in_Tmp_276: int, in_count_3: int, in_receiveBuffer: int, in_Tmp_285: int, in_sdv_172: int, in_DeviceExtension_25: int) returns (out_Tmp_276: int, out_count_3: int, out_Tmp_285: int, out_sdv_172: int)
{
...
procedure {:LoopProcedure} MSerDetect#0_loop_L53(in_Tmp_276: int, in_count_3: int, in_receiveBuffer: int, in_Tmp_285: int, in_sdv_172: int, in_DeviceExtension_25: int) returns (out_Tmp_276: int, out_count_3: int, out_Tmp_285: int, out_sdv_172: int);
  modifies alloc, Mem_T.CompletionRoutine__IO_STACK_LOCATION;
...
implementation MSerDetect#0_loop_L65(in_i_1: int, in_count_3: int, in_Tmp_278: int, in_Tmp_279: int, in_receiveBuffer: int) returns (out_i_1: int, out_Tmp_278: int, out_Tmp_279: int)
{
...
procedure {:LoopProcedure} MSerDetect#0_loop_L65(in_i_1: int, in_count_3: int, in_Tmp_278: int, in_Tmp_279: int, in_receiveBuffer: int) returns (out_i_1: int, out_Tmp_278: int, out_Tmp_279: int);
...
implementation MSerDetect#1_loop_L53(in_Tmp_276: int, in_count_3: int, in_receiveBuffer: int, in_Tmp_285: int, in_sdv_172: int, in_DeviceExtension_25: int) returns (out_Tmp_276: int, out_count_3: int, out_Tmp_285: int, out_sdv_172: int)
{
  ...
  anon49_Else_dummy:
    call {:si_unique_call 990} {:si_old_unique_call 1} out_Tmp_276, out_count_3, out_Tmp_285, out_sdv_172 := MSerDetect#1_loop_L53(out_Tmp_276, out_count_3, in_receiveBuffer, out_Tmp_285, out_sdv_172, in_DeviceExtension_25);
    return;
}



procedure {:LoopProcedure} MSerDetect#1_loop_L53(in_Tmp_276: int, in_count_3: int, in_receiveBuffer: int, in_Tmp_285: int, in_sdv_172: int, in_DeviceExtension_25: int) returns (out_Tmp_276: int, out_count_3: int, out_Tmp_285: int, out_sdv_172: int);
  modifies alloc, Mem_T.CompletionRoutine__IO_STACK_LOCATION, yogi_error, completion, LockDepth;
  free ensures {:va_keep} old(LockDepth) != 0 ==> yogi_error == 0;
  free ensures {:va_keep} old(LockDepth) == 0 ==> yogi_error == 0;
  free ensures {:va_keep} old(completion) == 1 ==> completion != 0;
...
implementation MSerDetect#1_loop_L65(in_i_1: int, in_count_3: int, in_Tmp_278: int, in_Tmp_279: int, in_receiveBuffer: int) returns (out_i_1: int, out_Tmp_278: int, out_Tmp_279: int)
{
...
procedure {:LoopProcedure} MSerDetect#1_loop_L65(in_i_1: int, in_count_3: int, in_Tmp_278: int, in_Tmp_279: int, in_receiveBuffer: int) returns (out_i_1: int, out_Tmp_278: int, out_Tmp_279: int);
  free ensures {:va_keep} out_Tmp_278 == in_i_1 || out_Tmp_278 == in_Tmp_278;
  free ensures {:va_keep} out_Tmp_279 == in_i_1 || out_Tmp_279 == in_Tmp_279;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} false || old(completion) == 1 || old(completion) == 0;
...
implementation SerialMouseReadSerialPort#1_loop_L15(in_irp_4: int, in_status_22: int, in_event_9: int, in_stack_1: int, in_DeviceExtension_18: int, in_ReadBuffer: int, in_Buflen: int, in_ActualBytesRead: int) returns (out_status_22: int, out_stack_1: int)
{
  ...
  anon16_Else:
    ...
    call {:si_unique_call 995} out_status_22 := sdv_IoCallDriver#0(vslice_dummy_var_401, in_irp_4);
    goto anon21_Else;
  ...
  anon20_Else_dummy:
    call {:si_unique_call 997} {:si_old_unique_call 1} out_status_22, out_stack_1 := SerialMouseReadSerialPort#1_loop_L15(in_irp_4, out_status_22, in_event_9, out_stack_1, in_DeviceExtension_18, in_ReadBuffer, in_Buflen, in_ActualBytesRead);
    return;
...
procedure {:LoopProcedure} SerialMouseReadSerialPort#1_loop_L15(in_irp_4: int, in_status_22: int, in_event_9: int, in_stack_1: int, in_DeviceExtension_18: int, in_ReadBuffer: int, in_Buflen: int, in_ActualBytesRead: int) returns (out_status_22: int, out_stack_1: int);
  modifies alloc, Mem_T.CompletionRoutine__IO_STACK_LOCATION, yogi_error, completion, LockDepth;
  free ensures {:va_keep} old(LockDepth) != 0 ==> yogi_error == 0;
  free ensures {:va_keep} old(LockDepth) == 0 ==> yogi_error == 0;
  free ensures {:va_keep} old(completion) == 1 ==> completion != 0;
...
implementation CSerDetect#0_loop_L20(in_Tmp_19: int, in_count_1: int, in_Tmp_21: int, in_sdv_14: int, in_status_1: int, in_DeviceExtension_3: int, in_vslice_dummy_var_171: int, in_vslice_dummy_var_172: int, in_vslice_dummy_var_173: int, in_vslice_dummy_var_174: int, in_vslice_dummy_var_180: int) returns (out_Tmp_19: int, out_count_1: int, out_Tmp_21: int, out_sdv_14: int, out_vslice_dummy_var_171: int, out_vslice_dummy_var_172: int, out_vslice_dummy_var_173: int, out_vslice_dummy_var_174: int, out_vslice_dummy_var_180: int)
{
...
procedure {:LoopProcedure} CSerDetect#0_loop_L20(in_Tmp_19: int, in_count_1: int, in_Tmp_21: int, in_sdv_14: int, in_status_1: int, in_DeviceExtension_3: int, in_vslice_dummy_var_171: int, in_vslice_dummy_var_172: int, in_vslice_dummy_var_173: int, in_vslice_dummy_var_174: int, in_vslice_dummy_var_180: int) returns (out_Tmp_19: int, out_count_1: int, out_Tmp_21: int, out_sdv_14: int, out_vslice_dummy_var_171: int, out_vslice_dummy_var_172: int, out_vslice_dummy_var_173: int, out_vslice_dummy_var_174: int, out_vslice_dummy_var_180: int);
  modifies alloc, Mem_T.CompletionRoutine__IO_STACK_LOCATION;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} false || old(completion) == 1 || old(completion) == 0;
  free ensures {:va_keep} false || old(t) == 1 || old(t) == 0;
...
procedure {:LoopProcedure} CSerDetect#1_loop_L20(in_Tmp_19: int, in_count_1: int, in_Tmp_21: int, in_sdv_14: int, in_status_1: int, in_DeviceExtension_3: int, in_vslice_dummy_var_182: int, in_vslice_dummy_var_183: int, in_vslice_dummy_var_184: int, in_vslice_dummy_var_185: int, in_vslice_dummy_var_191: int) returns (out_Tmp_19: int, out_count_1: int, out_Tmp_21: int, out_sdv_14: int, out_vslice_dummy_var_182: int, out_vslice_dummy_var_183: int, out_vslice_dummy_var_184: int, out_vslice_dummy_var_185: int, out_vslice_dummy_var_191: int);
  modifies alloc, Mem_T.CompletionRoutine__IO_STACK_LOCATION, yogi_error, completion, LockDepth;
  free ensures {:va_keep} old(LockDepth) != 0 ==> yogi_error == 0;
  free ensures {:va_keep} old(LockDepth) == 0 ==> yogi_error == 0;
  free ensures {:va_keep} old(completion) == 1 ==> completion != 0;
