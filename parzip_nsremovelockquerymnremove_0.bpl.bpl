...
implementation {:origName "VPI1DataIn"} VPI1DataIn(actual_Extension_3: int) returns (Tmp_47: int)
{
  ...
  anon46_Else:
    ...
    call {:si_unique_call 66} sdv_19 := VPI1GetPhase(Extension_3, vslice_dummy_var_1156);
  ...
  anon59_Else:
    ...
    call {:si_unique_call 67} vslice_dummy_var_8 := VPI1GetPhase(Extension_3, vslice_dummy_var_1157);
  ...
  anon65_Else:
    ...
    call {:si_unique_call 73} Status_3 := VPI1ParallelRead(Extension_3, vslice_dummy_var_1158, ChunkSize, BytesRead);
    assume {:nonnull} Extension_3 != 0;
    assume Extension_3 > 0;
...
implementation {:origName "VPI1DataOut"} VPI1DataOut(actual_Extension_7: int) returns (Tmp_73: int)
{
  ...
  anon28_Else:
    ...
    call {:si_unique_call 93} sdv_38 := VPI1GetPhase(Extension_7, vslice_dummy_var_1159);
    goto anon29_Then, anon29_Else;
  ...
  L34:
    ...
    call {:si_unique_call 94} Status_5 := VPI1ParallelWrite(Extension_7, vslice_dummy_var_1160, ChunkSize_1, BytesWritten);
    assume {:nonnull} Extension_7 != 0;
    assume Extension_7 > 0;
    goto anon34_Then, anon34_Else;
...
implementation {:origName "VPI1Command"} VPI1Command(actual_Extension_9: int) returns (Tmp_84: int)
{
  ...
  anon27_Else:
    ...
    call {:si_unique_call 102} sdv_43 := VPI1GetPhase(Extension_9, vslice_dummy_var_1161);
    goto anon19_Then, anon19_Else;
...
implementation {:origName "VPI1ParallelWrite"} VPI1ParallelWrite(actual_Extension_13: int, actual_Buffer: int, actual_NumBytesToWrite: int, actual_BytesTransfered: int) returns (Tmp_128: int)
{
  ...
  L12:
    ...
    call {:si_unique_call 121} Status_9 := VPI1DataByteWrite(vslice_dummy_var_1162, Buffer, NumBytesToWrite, BytesTransfered);
    goto L16;
...
implementation {:origName "VPI1ParallelRead"} VPI1ParallelRead(actual_Extension_16: int, actual_Buffer_1: int, actual_NumBytesToRead: int, actual_BytesTransfered_1: int) returns (Tmp_151: int)
{
  ...
  anon8_Else:
    ...
    call {:si_unique_call 126} Status_12 := VPI1DataNibbleRead(vslice_dummy_var_1163, Buffer_1, NumBytesToRead, BytesTransfered_1);
    goto L16;
  ...
  anon9_Else:
    ...
    call {:si_unique_call 127} Status_12 := VPI1DataByteRead(vslice_dummy_var_1164, Buffer_1, NumBytesToRead, BytesTransfered_1);
    goto L16;
...
procedure {:origName "KeRaiseIrqlToDpcLevel"} {:osmodel} KeRaiseIrqlToDpcLevel() returns (Tmp_176: int);
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);



implementation {:origName "KeRaiseIrqlToDpcLevel"} {:osmodel} KeRaiseIrqlToDpcLevel() returns (Tmp_176: int)
{
...
implementation {:origName "sdv_IoCopyCurrentIrpStackLocationToNext"} {:osmodel} sdv_IoCopyCurrentIrpStackLocationToNext(actual_pirp: int)
{
  ...
  anon0:
    call {:si_unique_call 135} vslice_dummy_var_24 := __HAVOC_malloc(4);
    pirp := actual_pirp;
    goto anon5_Then, anon5_Else;
...
implementation {:origName "IoStartNextPacket"} {:osmodel} IoStartNextPacket(actual_DeviceObject: int, actual_Cancelable: int)
{
  ...
  anon0:
    call {:si_unique_call 136} vslice_dummy_var_25 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "sdv_IoInitializeRemoveLock"} {:osmodel} sdv_IoInitializeRemoveLock(actual_Lock: int, actual_AllocateTag: int, actual_MaxLockedMinutes: int, actual_HighWatermark: int)
{
  ...
  anon0:
    call {:si_unique_call 137} vslice_dummy_var_26 := __HAVOC_malloc(4);
    return;
}
...
procedure {:origName "sdv_RunAddDevice"} {:osmodel} sdv_RunAddDevice(actual_p1: int, actual_p2: int) returns (Tmp_186: int);
  modifies alloc;
  free ensures {:va_keep} Tmp_186 == -1073741637 || Tmp_186 == 0 || Tmp_186 == -1073741823 || Tmp_186 == -1073741824 || Tmp_186 == -1073741771 || Tmp_186 == -1073741670;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);



implementation {:origName "sdv_RunAddDevice"} {:osmodel} sdv_RunAddDevice(actual_p1: int, actual_p2: int) returns (Tmp_186: int)
{
  var {:scalar} status: int;
  var {:pointer} p1: int;
  var {:pointer} p2: int;
  ...
  anon0:
    ...
    p2 := actual_p2;
    status := 0;
    call {:si_unique_call 139} sdv_stub_add_begin();
    call {:si_unique_call 140} status := PpaAddDevice(p1, p2);
    call {:si_unique_call 141} sdv_stub_add_end();
    Tmp_186 := status;
    return;
}
...
procedure {:origName "sdv_IoGetNextIrpStackLocation"} {:osmodel} sdv_IoGetNextIrpStackLocation(actual_pirp_1: int) returns (Tmp_188: int);
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);



implementation {:origName "sdv_IoGetNextIrpStackLocation"} {:osmodel} sdv_IoGetNextIrpStackLocation(actual_pirp_1: int) returns (Tmp_188: int)
{
  ...
  anon5_Else:
    ...
    Tmp_188 := sdv_harnessStackLocation_next;
    goto L1;
  ...
  anon6_Else:
    ...
    Tmp_188 := sdv_other_harnessStackLocation_next;
    goto L1;

  anon6_Then:
    assume {:partition} pirp_1 != sdv_other_harnessIrp;
    Tmp_188 := sdv_harnessStackLocation;
    goto L1;
}
...
implementation {:origName "KeInitializeDpc"} {:osmodel} KeInitializeDpc(actual_Dpc: int, actual_DeferredRoutine: int, actual_DeferredContext: int)
{
  ...
  anon0:
    call {:si_unique_call 142} vslice_dummy_var_28 := __HAVOC_malloc(4);
    Dpc := actual_Dpc;
...
implementation {:origName "sdv_IoReleaseRemoveLockAndWait"} {:osmodel} sdv_IoReleaseRemoveLockAndWait(actual_RemoveLock: int, actual_Tag: int)
{
  ...
  anon0:
    call {:si_unique_call 143} vslice_dummy_var_29 := __HAVOC_malloc(4);
    return;
}



procedure {:origName "IoCreateDevice"} {:osmodel} IoCreateDevice(actual_DriverObject: int, actual_DeviceExtensionSize: int, actual_DeviceName: int, actual_DeviceType: int, actual_DeviceCharacteristics: int, actual_Exclusive: int, actual_DeviceObject_1: int) returns (Tmp_194: int);
  free ensures {:va_keep} Tmp_194 == -1073741824 || Tmp_194 == -1073741771 || Tmp_194 == -1073741670 || Tmp_194 == -1073741823 || Tmp_194 == 0;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);



implementation {:origName "IoCreateDevice"} {:osmodel} IoCreateDevice(actual_DriverObject: int, actual_DeviceExtensionSize: int, actual_DeviceName: int, actual_DeviceType: int, actual_DeviceCharacteristics: int, actual_Exclusive: int, actual_DeviceObject_1: int) returns (Tmp_194: int)
{
...
implementation {:origName "IoDetachDevice"} {:osmodel} IoDetachDevice(actual_TargetDevice: int)
{
  ...
  anon0:
    call {:si_unique_call 144} vslice_dummy_var_30 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "sdv_RtlMoveMemory"} {:osmodel} sdv_RtlMoveMemory(actual_Destination: int, actual_Source: int, actual_Length: int)
{
  ...
  anon0:
    call {:si_unique_call 145} vslice_dummy_var_31 := __HAVOC_malloc(4);
    return;
}



procedure {:origName "sdv_RtlQueryRegistryValues"} {:osmodel} sdv_RtlQueryRegistryValues(actual_RelativeTo: int, actual_Path: int, actual_QueryTable: int, actual_Context: int, actual_Environment: int) returns (Tmp_200: int);
  free ensures {:va_keep} Tmp_200 == 0 || Tmp_200 == -1073741823;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);



implementation {:origName "sdv_RtlQueryRegistryValues"} {:osmodel} sdv_RtlQueryRegistryValues(actual_RelativeTo: int, actual_Path: int, actual_QueryTable: int, actual_Context: int, actual_Environment: int) returns (Tmp_200: int)
{
...
implementation {:origName "sdv_SetStatus"} {:osmodel} sdv_SetStatus(actual_pirp_2: int)
{
  ...
  anon0:
    call {:si_unique_call 146} vslice_dummy_var_32 := __HAVOC_malloc(4);
...
procedure {:nohoudini} {:origName "sdv_main"} {:osmodel} sdv_main();
  modifies alloc, Mem_T.CompletionRoutine__IO_STACK_LOCATION, Mem_T.Status__IO_STATUS_BLOCK, sdv_compFset, sdv_invoke_on_success, sdv_invoke_on_error, sdv_invoke_on_cancel, sdv_IoBuildSynchronousFsdRequest_IoStatusBlock, sdv_IoBuildDeviceIoControlRequest_IoStatusBlock, yogi_error;
...
implementation {:origName "sdv_main"} {:osmodel} sdv_main()
{
  ...
  anon0:
    call {:si_unique_call 147} u := __HAVOC_malloc(12);
    call {:si_unique_call 148} vslice_dummy_var_33 := __HAVOC_malloc(4);
    assume {:nonnull} sdv_p_devobj_fdo != 0;
    assume sdv_p_devobj_fdo > 0;
    assume {:nonnull} sdv_p_devobj_child_pdo != 0;
    assume sdv_p_devobj_child_pdo > 0;
    call {:si_unique_call 149} status_1 := DriverEntry(sdv_driver_object, u);
    goto anon11_Then, anon11_Else;
  ...
  L69:
    assume Tmp_204 != 0;
    call {:si_unique_call 150} status_1 := sdv_RunAddDevice(sdv_driver_object, sdv_p_devobj_pdo);
    goto anon9_Then, anon9_Else;
  ...
  L79:
    assume Tmp_205 != 0;
    call {:si_unique_call 151} sdv_stub_driver_init();
    call {:si_unique_call 152} status_1 := sdv_RunQueryRemoveDevice(sdv_p_devobj_fdo, sdv_irp);
    goto anon12_Then, anon12_Else;
...
procedure {:origName "sdv_MmGetMdlVirtualAddress"} {:osmodel} sdv_MmGetMdlVirtualAddress(actual_Mdl: int) returns (Tmp_209: int);
  modifies alloc;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);
...
implementation {:origName "sdv_MmGetMdlVirtualAddress"} {:osmodel} sdv_MmGetMdlVirtualAddress(actual_Mdl: int) returns (Tmp_209: int)
{
  var {:pointer} x_1: int;
...
procedure {:origName "KeCancelTimer"} {:osmodel} KeCancelTimer(actual_Timer: int) returns (Tmp_211: int);
  free ensures {:va_keep} Tmp_211 == 1 || Tmp_211 == 0;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);



implementation {:origName "KeCancelTimer"} {:osmodel} KeCancelTimer(actual_Timer: int) returns (Tmp_211: int)
{
...
implementation {:origName "sdv_IoSetCompletionRoutine"} {:osmodel} sdv_IoSetCompletionRoutine(actual_pirp_3: int, actual_CompletionRoutine: int, actual_Context_1: int, actual_InvokeOnSuccess: int, actual_InvokeOnError: int, actual_InvokeOnCancel: int)
{
  ...
  anon0:
    call {:si_unique_call 154} vslice_dummy_var_34 := __HAVOC_malloc(4);
    ...
    call {:si_unique_call 155} irpSp := sdv_IoGetNextIrpStackLocation(pirp_3);
...
implementation {:origName "_sdv_init9"} {:osmodel} _sdv_init9()
{
  ...
  anon0:
    call {:si_unique_call 156} vslice_dummy_var_35 := __HAVOC_malloc(4);
...
implementation {:origName "sdv_stub_add_begin"} {:osmodel} sdv_stub_add_begin()
{
  ...
  anon0:
    call {:si_unique_call 157} vslice_dummy_var_36 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "IoDeleteDevice"} {:osmodel} IoDeleteDevice(actual_DeviceObject_2: int)
{
  ...
  anon0:
    call {:si_unique_call 158} vslice_dummy_var_37 := __HAVOC_malloc(4);
    return;
}
...
procedure {:origName "sdv_IoGetCurrentIrpStackLocation"} {:osmodel} sdv_IoGetCurrentIrpStackLocation(actual_pirp_4: int) returns (Tmp_227: int);
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);



implementation {:origName "sdv_IoGetCurrentIrpStackLocation"} {:osmodel} sdv_IoGetCurrentIrpStackLocation(actual_pirp_4: int) returns (Tmp_227: int)
{
...
procedure {:origName "sdv_KeGetCurrentIrql"} {:osmodel} sdv_KeGetCurrentIrql() returns (Tmp_229: int);
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);



implementation {:origName "sdv_KeGetCurrentIrql"} {:osmodel} sdv_KeGetCurrentIrql() returns (Tmp_229: int)
{
...
procedure {:nohoudini} {:origName "main"} {:osmodel} {:entrypoint} main() returns (Tmp_231: int, dup_assertVar: bool);
  modifies alloc, sdv_IoBuildDeviceIoControlRequest_IoStatusBlock, sdv_IoBuildSynchronousFsdRequest_IoStatusBlock, sdv_invoke_on_success, sdv_invoke_on_error, sdv_invoke_on_cancel, sdv_compFset, yogi_error, Mem_T.CompletionRoutine__IO_STACK_LOCATION, Mem_T.Status__IO_STATUS_BLOCK;
  free ensures {:va_keep} yogi_error == 1;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);
...
implementation {:origName "main"} {:osmodel} main() returns (Tmp_231: int, dup_assertVar: bool)
{
  ...
  anon0:
    ...
    call {:si_unique_call 160} PpaBreakOn__Loc := __HAVOC_malloc_or_null(4);
    assume PpaBreakOn__Loc == PpaBreakOn;
    assume PpaBreakOn != 0;
    call {:si_unique_call 161} PpaDebugLevel__Loc := __HAVOC_malloc_or_null(4);
    assume PpaDebugLevel__Loc == PpaDebugLevel;
    assume PpaDebugLevel != 0;
    call {:si_unique_call 162} sdv_harnessStackLocation_next__Loc := __HAVOC_malloc_or_null(496);
    assume sdv_harnessStackLocation_next__Loc == sdv_harnessStackLocation_next;
    assume sdv_harnessStackLocation_next != 0;
    call {:si_unique_call 163} sdv_IoReadPartitionTableEx_DRIVE_LAYOUT_INFORMATION_EX__Loc := __HAVOC_malloc_or_null(76);
    assume sdv_IoReadPartitionTableEx_DRIVE_LAYOUT_INFORMATION_EX__Loc == sdv_IoReadPartitionTableEx_DRIVE_LAYOUT_INFORMATION_EX;
    assume sdv_IoReadPartitionTableEx_DRIVE_LAYOUT_INFORMATION_EX != 0;
    call {:si_unique_call 164} sdv_IoBuildAsynchronousFsdRequest_harnessIrp__Loc := __HAVOC_malloc_or_null(248);
    assume sdv_IoBuildAsynchronousFsdRequest_harnessIrp__Loc == sdv_IoBuildAsynchronousFsdRequest_harnessIrp;
    assume sdv_IoBuildAsynchronousFsdRequest_harnessIrp != 0;
    call {:si_unique_call 165} sdv_IoGetDeviceToVerify_DEVICE_OBJECT__Loc := __HAVOC_malloc_or_null(320);
    assume sdv_IoGetDeviceToVerify_DEVICE_OBJECT__Loc == sdv_IoGetDeviceToVerify_DEVICE_OBJECT;
    assume sdv_IoGetDeviceToVerify_DEVICE_OBJECT != 0;
    call {:si_unique_call 166} sdv_IoBuildDeviceIoControlRequest_harnessStackLocation_next__Loc := __HAVOC_malloc_or_null(496);
    assume sdv_IoBuildDeviceIoControlRequest_harnessStackLocation_next__Loc == sdv_IoBuildDeviceIoControlRequest_harnessStackLocation_next;
    assume sdv_IoBuildDeviceIoControlRequest_harnessStackLocation_next != 0;
    call {:si_unique_call 167} sdv_harness_IoBuildSynchronousFsdRequest_IoStatusBlock__Loc := __HAVOC_malloc_or_null(12);
    assume sdv_harness_IoBuildSynchronousFsdRequest_IoStatusBlock__Loc == sdv_harness_IoBuildSynchronousFsdRequest_IoStatusBlock;
    assume sdv_harness_IoBuildSynchronousFsdRequest_IoStatusBlock != 0;
    call {:si_unique_call 168} sdv_ControllerIrp__Loc := __HAVOC_malloc_or_null(248);
    assume sdv_ControllerIrp__Loc == sdv_ControllerIrp;
    assume sdv_ControllerIrp != 0;
    call {:si_unique_call 169} sdv_devobj_pdo__Loc := __HAVOC_malloc_or_null(320);
    assume sdv_devobj_pdo__Loc == sdv_devobj_pdo;
    assume sdv_devobj_pdo != 0;
    call {:si_unique_call 170} sdv_IoGetDmaAdapter_DMA_ADAPTER__Loc := __HAVOC_malloc_or_null(12);
    assume sdv_IoGetDmaAdapter_DMA_ADAPTER__Loc == sdv_IoGetDmaAdapter_DMA_ADAPTER;
    assume sdv_IoGetDmaAdapter_DMA_ADAPTER != 0;
    call {:si_unique_call 171} sdv_IoInitializeIrp_harnessIrp__Loc := __HAVOC_malloc_or_null(248);
    assume sdv_IoInitializeIrp_harnessIrp__Loc == sdv_IoInitializeIrp_harnessIrp;
    assume sdv_IoInitializeIrp_harnessIrp != 0;
    call {:si_unique_call 172} sdv_IoGetRelatedDeviceObject_DEVICE_OBJECT__Loc := __HAVOC_malloc_or_null(320);
    assume sdv_IoGetRelatedDeviceObject_DEVICE_OBJECT__Loc == sdv_IoGetRelatedDeviceObject_DEVICE_OBJECT;
    assume sdv_IoGetRelatedDeviceObject_DEVICE_OBJECT != 0;
    call {:si_unique_call 173} sdv_IoBuildSynchronousFsdRequest_harnessStackLocation_next__Loc := __HAVOC_malloc_or_null(496);
    assume sdv_IoBuildSynchronousFsdRequest_harnessStackLocation_next__Loc == sdv_IoBuildSynchronousFsdRequest_harnessStackLocation_next;
    assume sdv_IoBuildSynchronousFsdRequest_harnessStackLocation_next != 0;
    call {:si_unique_call 174} sdv_IoCreateSynchronizationEvent_KEVENT__Loc := __HAVOC_malloc_or_null(124);
    assume sdv_IoCreateSynchronizationEvent_KEVENT__Loc == sdv_IoCreateSynchronizationEvent_KEVENT;
    assume sdv_IoCreateSynchronizationEvent_KEVENT != 0;
    call {:si_unique_call 175} sdv_other_harnessStackLocation_next__Loc := __HAVOC_malloc_or_null(496);
    assume sdv_other_harnessStackLocation_next__Loc == sdv_other_harnessStackLocation_next;
    assume sdv_other_harnessStackLocation_next != 0;
    call {:si_unique_call 176} sdv_harnessStackLocation__Loc := __HAVOC_malloc_or_null(496);
    assume sdv_harnessStackLocation__Loc == sdv_harnessStackLocation;
    assume sdv_harnessStackLocation != 0;
    call {:si_unique_call 177} sdv_IoCreateController_CONTROLLER_OBJECT__Loc := __HAVOC_malloc_or_null(60);
    assume sdv_IoCreateController_CONTROLLER_OBJECT__Loc == sdv_IoCreateController_CONTROLLER_OBJECT;
    assume sdv_IoCreateController_CONTROLLER_OBJECT != 0;
    call {:si_unique_call 178} sdv_devobj_top__Loc := __HAVOC_malloc_or_null(320);
    assume sdv_devobj_top__Loc == sdv_devobj_top;
    assume sdv_devobj_top != 0;
    call {:si_unique_call 179} sdv_kdpc_val3__Loc := __HAVOC_malloc_or_null(40);
    assume sdv_kdpc_val3__Loc == sdv_kdpc_val3;
    assume sdv_kdpc_val3 != 0;
    call {:si_unique_call 180} sdv_IoBuildSynchronousFsdRequest_harnessIrp__Loc := __HAVOC_malloc_or_null(248);
    assume sdv_IoBuildSynchronousFsdRequest_harnessIrp__Loc == sdv_IoBuildSynchronousFsdRequest_harnessIrp;
    assume sdv_IoBuildSynchronousFsdRequest_harnessIrp != 0;
    call {:si_unique_call 181} sdv_IoGetDeviceObjectPointer_DEVICE_OBJECT__Loc := __HAVOC_malloc_or_null(320);
    assume sdv_IoGetDeviceObjectPointer_DEVICE_OBJECT__Loc == sdv_IoGetDeviceObjectPointer_DEVICE_OBJECT;
    assume sdv_IoGetDeviceObjectPointer_DEVICE_OBJECT != 0;
    call {:si_unique_call 182} sdv_driver_object__Loc := __HAVOC_malloc_or_null(68);
    assume sdv_driver_object__Loc == sdv_driver_object;
    assume sdv_driver_object != 0;
    call {:si_unique_call 183} sdv_MapRegisterBase_val__Loc := __HAVOC_malloc_or_null(4);
    assume sdv_MapRegisterBase_val__Loc == sdv_MapRegisterBase_val;
    assume sdv_MapRegisterBase_val != 0;
    call {:si_unique_call 184} sdv_IoGetFileObjectGenericMapping_GENERIC_MAPPING__Loc := __HAVOC_malloc_or_null(16);
    assume sdv_IoGetFileObjectGenericMapping_GENERIC_MAPPING__Loc == sdv_IoGetFileObjectGenericMapping_GENERIC_MAPPING;
    assume sdv_IoGetFileObjectGenericMapping_GENERIC_MAPPING != 0;
    call {:si_unique_call 185} sdv_IoMakeAssociatedIrp_harnessIrp__Loc := __HAVOC_malloc_or_null(248);
    assume sdv_IoMakeAssociatedIrp_harnessIrp__Loc == sdv_IoMakeAssociatedIrp_harnessIrp;
    assume sdv_IoMakeAssociatedIrp_harnessIrp != 0;
    call {:si_unique_call 186} sdv_devobj_child_pdo__Loc := __HAVOC_malloc_or_null(320);
    assume sdv_devobj_child_pdo__Loc == sdv_devobj_child_pdo;
    assume sdv_devobj_child_pdo != 0;
    call {:si_unique_call 187} sdv_harnessIrp__Loc := __HAVOC_malloc_or_null(248);
    assume sdv_harnessIrp__Loc == sdv_harnessIrp;
    assume sdv_harnessIrp != 0;
    call {:si_unique_call 188} sdv_IoBuildAsynchronousFsdRequest_harnessStackLocation_next__Loc := __HAVOC_malloc_or_null(496);
    assume sdv_IoBuildAsynchronousFsdRequest_harnessStackLocation_next__Loc == sdv_IoBuildAsynchronousFsdRequest_harnessStackLocation_next;
    assume sdv_IoBuildAsynchronousFsdRequest_harnessStackLocation_next != 0;
    call {:si_unique_call 189} sdv_harness_IoBuildDeviceIoControlRequest_IoStatusBlock__Loc := __HAVOC_malloc_or_null(12);
    assume sdv_harness_IoBuildDeviceIoControlRequest_IoStatusBlock__Loc == sdv_harness_IoBuildDeviceIoControlRequest_IoStatusBlock;
    assume sdv_harness_IoBuildDeviceIoControlRequest_IoStatusBlock != 0;
    call {:si_unique_call 190} sdv_kinterrupt_val__Loc := __HAVOC_malloc_or_null(0);
    assume sdv_kinterrupt_val__Loc == sdv_kinterrupt_val;
    assume sdv_kinterrupt_val != 0;
    call {:si_unique_call 191} sdv_devobj_fdo__Loc := __HAVOC_malloc_or_null(320);
    assume sdv_devobj_fdo__Loc == sdv_devobj_fdo;
    assume sdv_devobj_fdo != 0;
    call {:si_unique_call 192} sdv_StartIoIrp__Loc := __HAVOC_malloc_or_null(248);
    assume sdv_StartIoIrp__Loc == sdv_StartIoIrp;
    assume sdv_StartIoIrp != 0;
    call {:si_unique_call 193} sdv_harness_IoBuildAsynchronousFsdRequest_IoStatusBlock__Loc := __HAVOC_malloc_or_null(12);
    assume sdv_harness_IoBuildAsynchronousFsdRequest_IoStatusBlock__Loc == sdv_harness_IoBuildAsynchronousFsdRequest_IoStatusBlock;
    assume sdv_harness_IoBuildAsynchronousFsdRequest_IoStatusBlock != 0;
    call {:si_unique_call 194} sdv_PowerIrp__Loc := __HAVOC_malloc_or_null(248);
    assume sdv_PowerIrp__Loc == sdv_PowerIrp;
    assume sdv_PowerIrp != 0;
    call {:si_unique_call 195} sdv_IoBuildDeviceIoControlRequest_harnessIrp__Loc := __HAVOC_malloc_or_null(248);
    assume sdv_IoBuildDeviceIoControlRequest_harnessIrp__Loc == sdv_IoBuildDeviceIoControlRequest_harnessIrp;
    assume sdv_IoBuildDeviceIoControlRequest_harnessIrp != 0;
    call {:si_unique_call 196} sdv_other_harnessIrp__Loc := __HAVOC_malloc_or_null(248);
    assume sdv_other_harnessIrp__Loc == sdv_other_harnessIrp;
    assume sdv_other_harnessIrp != 0;
    call {:si_unique_call 197} sdv_IoCreateNotificationEvent_KEVENT__Loc := __HAVOC_malloc_or_null(124);
    assume sdv_IoCreateNotificationEvent_KEVENT__Loc == sdv_IoCreateNotificationEvent_KEVENT;
    assume sdv_IoCreateNotificationEvent_KEVENT != 0;
    call {:si_unique_call 198} sdv_other_harnessStackLocation__Loc := __HAVOC_malloc_or_null(496);
    assume sdv_other_harnessStackLocation__Loc == sdv_other_harnessStackLocation;
    assume sdv_other_harnessStackLocation != 0;
    call {:si_unique_call 199} KeTickCount__Loc := __HAVOC_malloc_or_null(12);
    ...
    call {:si_unique_call 213} boogieTmp := __HAVOC_malloc_or_null(248);
    ...
    call {:si_unique_call 224} vslice_dummy_var_111 := __HAVOC_malloc(4);
    call {:si_unique_call 225} vslice_dummy_var_1165 := __HAVOC_malloc(28);
    call {:si_unique_call 226} vslice_dummy_var_112 := __HAVOC_malloc(4);
    call {:si_unique_call 227} vslice_dummy_var_113 := __HAVOC_malloc(4);
    call {:si_unique_call 228} vslice_dummy_var_114 := __HAVOC_malloc(4);
    call {:si_unique_call 229} vslice_dummy_var_115 := __HAVOC_malloc(4);
    call {:si_unique_call 230} vslice_dummy_var_1166 := __HAVOC_malloc(12);
    call {:si_unique_call 231} vslice_dummy_var_116 := __HAVOC_malloc(4);
    call {:si_unique_call 232} vslice_dummy_var_1167 := __HAVOC_malloc(28);
    call {:si_unique_call 233} vslice_dummy_var_117 := __HAVOC_malloc(4);
    call {:si_unique_call 234} vslice_dummy_var_118 := __HAVOC_malloc(4);
    call {:si_unique_call 235} vslice_dummy_var_119 := __HAVOC_malloc(4);
    call {:si_unique_call 236} vslice_dummy_var_120 := __HAVOC_malloc(4);
    call {:si_unique_call 237} vslice_dummy_var_1168 := __HAVOC_malloc(12);
    call {:si_unique_call 238} vslice_dummy_var_121 := __HAVOC_malloc(4);
    call {:si_unique_call 239} vslice_dummy_var_1169 := __HAVOC_malloc(28);
    call {:si_unique_call 240} vslice_dummy_var_122 := __HAVOC_malloc(4);
    call {:si_unique_call 241} vslice_dummy_var_123 := __HAVOC_malloc(4);
    call {:si_unique_call 242} vslice_dummy_var_124 := __HAVOC_malloc(4);
    call {:si_unique_call 243} vslice_dummy_var_125 := __HAVOC_malloc(4);
    call {:si_unique_call 244} vslice_dummy_var_1170 := __HAVOC_malloc(12);
    call {:si_unique_call 245} vslice_dummy_var_126 := __HAVOC_malloc(4);
    call {:si_unique_call 246} vslice_dummy_var_127 := __HAVOC_malloc(4);
    call {:si_unique_call 247} vslice_dummy_var_128 := __HAVOC_malloc(4);
    call {:si_unique_call 248} vslice_dummy_var_129 := __HAVOC_malloc(4);
    call {:si_unique_call 249} vslice_dummy_var_130 := __HAVOC_malloc(4);
    call {:si_unique_call 250} vslice_dummy_var_131 := __HAVOC_malloc(4);
    call {:si_unique_call 251} vslice_dummy_var_1171 := __HAVOC_malloc(28);
    call {:si_unique_call 252} vslice_dummy_var_132 := __HAVOC_malloc(4);
    call {:si_unique_call 253} vslice_dummy_var_133 := __HAVOC_malloc(4);
    call {:si_unique_call 254} vslice_dummy_var_134 := __HAVOC_malloc(4);
    call {:si_unique_call 255} vslice_dummy_var_135 := __HAVOC_malloc(4);
    call {:si_unique_call 256} vslice_dummy_var_1172 := __HAVOC_malloc(12);
    call {:si_unique_call 257} vslice_dummy_var_136 := __HAVOC_malloc(4);
    call {:si_unique_call 258} vslice_dummy_var_1173 := __HAVOC_malloc(28);
    call {:si_unique_call 259} vslice_dummy_var_137 := __HAVOC_malloc(4);
    call {:si_unique_call 260} vslice_dummy_var_138 := __HAVOC_malloc(4);
    call {:si_unique_call 261} vslice_dummy_var_139 := __HAVOC_malloc(4);
    call {:si_unique_call 262} vslice_dummy_var_140 := __HAVOC_malloc(4);
    call {:si_unique_call 263} vslice_dummy_var_1174 := __HAVOC_malloc(12);
    call {:si_unique_call 264} vslice_dummy_var_141 := __HAVOC_malloc(4);
    call {:si_unique_call 265} vslice_dummy_var_1175 := __HAVOC_malloc(28);
    call {:si_unique_call 266} vslice_dummy_var_142 := __HAVOC_malloc(4);
    call {:si_unique_call 267} vslice_dummy_var_143 := __HAVOC_malloc(4);
    call {:si_unique_call 268} vslice_dummy_var_144 := __HAVOC_malloc(4);
    call {:si_unique_call 269} vslice_dummy_var_145 := __HAVOC_malloc(4);
    call {:si_unique_call 270} vslice_dummy_var_1176 := __HAVOC_malloc(12);
    call {:si_unique_call 271} vslice_dummy_var_146 := __HAVOC_malloc(4);
    call {:si_unique_call 272} vslice_dummy_var_1177 := __HAVOC_malloc(28);
    call {:si_unique_call 273} vslice_dummy_var_147 := __HAVOC_malloc(4);
    call {:si_unique_call 274} vslice_dummy_var_148 := __HAVOC_malloc(4);
    call {:si_unique_call 275} vslice_dummy_var_149 := __HAVOC_malloc(4);
    call {:si_unique_call 276} vslice_dummy_var_150 := __HAVOC_malloc(4);
    call {:si_unique_call 277} vslice_dummy_var_1178 := __HAVOC_malloc(12);
    call {:si_unique_call 278} vslice_dummy_var_151 := __HAVOC_malloc(4);
    call {:si_unique_call 279} vslice_dummy_var_1179 := __HAVOC_malloc(28);
    call {:si_unique_call 280} vslice_dummy_var_152 := __HAVOC_malloc(4);
    call {:si_unique_call 281} vslice_dummy_var_153 := __HAVOC_malloc(4);
    call {:si_unique_call 282} vslice_dummy_var_154 := __HAVOC_malloc(4);
    call {:si_unique_call 283} vslice_dummy_var_155 := __HAVOC_malloc(4);
    call {:si_unique_call 284} vslice_dummy_var_1180 := __HAVOC_malloc(12);
    assume {:mainInitDone} true;
    call {:si_unique_call 285} corralExtraInit();
    call {:si_unique_call 286} corralExplainErrorInit();
    call {:si_unique_call 287} _sdv_init11();
    call {:si_unique_call 288} _sdv_init1();
    call {:si_unique_call 289} _sdv_init4();
    call {:si_unique_call 290} _sdv_init5();
    call {:si_unique_call 291} _sdv_init3();
    call {:si_unique_call 292} _sdv_init6();
    call {:si_unique_call 293} _sdv_init9();
    call {:si_unique_call 294} _sdv_init7();
    call {:si_unique_call 295} _sdv_init8();
    call {:si_unique_call 296} _sdv_init2();
    goto anon9_Then, anon9_Else;
  ...
  L38:
    ...
    call {:si_unique_call 297} sdv_main();
    goto anon12_Then, anon12_Else;
...
implementation {:origName "sdv_IoSkipCurrentIrpStackLocation"} {:osmodel} sdv_IoSkipCurrentIrpStackLocation(actual_pirp_5: int)
{
  ...
  anon0:
    call {:si_unique_call 298} vslice_dummy_var_38 := __HAVOC_malloc(4);
...
procedure {:origName "IoCancelIrp"} {:osmodel} IoCancelIrp(actual_Irp: int) returns (Tmp_237: int);
  free ensures {:va_keep} Tmp_237 == 0 || Tmp_237 == 1;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);



implementation {:origName "IoCancelIrp"} {:osmodel} IoCancelIrp(actual_Irp: int) returns (Tmp_237: int)
{
...
procedure {:origName "IoInitializeTimer"} {:osmodel} IoInitializeTimer(actual_DeviceObject_3: int, actual_TimerRoutine: int, actual_Context_2: int) returns (Tmp_239: int);
...
implementation {:origName "IoInitializeTimer"} {:osmodel} IoInitializeTimer(actual_DeviceObject_3: int, actual_TimerRoutine: int, actual_Context_2: int) returns (Tmp_239: int)
{
...
implementation {:origName "sdv_stub_add_end"} {:osmodel} sdv_stub_add_end()
{
  ...
  anon0:
    call {:si_unique_call 299} vslice_dummy_var_39 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "RtlInitUnicodeString"} {:osmodel} RtlInitUnicodeString(actual_DestinationString: int, actual_SourceString: int)
{
  ...
  anon0:
    call {:si_unique_call 300} vslice_dummy_var_40 := __HAVOC_malloc(4);
...
procedure {:origName "IoAttachDeviceToDeviceStack"} {:osmodel} IoAttachDeviceToDeviceStack(actual_SourceDevice: int, actual_TargetDevice_1: int) returns (Tmp_245: int);
  free ensures {:va_keep} Tmp_245 == 0 || Tmp_245 == actual_TargetDevice_1;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);



implementation {:origName "IoAttachDeviceToDeviceStack"} {:osmodel} IoAttachDeviceToDeviceStack(actual_SourceDevice: int, actual_TargetDevice_1: int) returns (Tmp_245: int)
{
...
implementation {:origName "sdv_RtlZeroMemory"} {:osmodel} sdv_RtlZeroMemory(actual_Destination_1: int, actual_Length_1: int)
{
  ...
  anon0:
    call {:si_unique_call 301} vslice_dummy_var_41 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "sdv_KeFlushIoBuffers"} {:osmodel} sdv_KeFlushIoBuffers(actual_Mdl_1: int, actual_ReadOperation: int, actual_DmaOperation: int)
{
  ...
  anon0:
    call {:si_unique_call 302} vslice_dummy_var_42 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "sdv_KeLowerIrql"} {:osmodel} sdv_KeLowerIrql(actual_NewIrql: int)
{
  ...
  anon0:
    call {:si_unique_call 303} vslice_dummy_var_43 := __HAVOC_malloc(4);
...
implementation {:origName "RtlFreeUnicodeString"} {:osmodel} RtlFreeUnicodeString(actual_UnicodeString: int)
{
  ...
  anon0:
    call {:si_unique_call 304} vslice_dummy_var_44 := __HAVOC_malloc(4);
    return;
}



procedure {:origName "IoBuildSynchronousFsdRequest"} {:osmodel} IoBuildSynchronousFsdRequest(actual_MajorFunction: int, actual_DeviceObject_4: int, actual_Buffer_5: int, actual_Length_2: int, actual_StartingOffset: int, actual_Event_1: int, actual_IoStatusBlock: int) returns (Tmp_255: int);
...
implementation {:origName "IoBuildSynchronousFsdRequest"} {:osmodel} IoBuildSynchronousFsdRequest(actual_MajorFunction: int, actual_DeviceObject_4: int, actual_Buffer_5: int, actual_Length_2: int, actual_StartingOffset: int, actual_Event_1: int, actual_IoStatusBlock: int) returns (Tmp_255: int)
{
  ...
  anon3_Else:
    ...
    assume {:nonnull} sdv_IoBuildSynchronousFsdRequest_irp != 0;
    assume sdv_IoBuildSynchronousFsdRequest_irp > 0;
    Tmp_255 := sdv_IoBuildSynchronousFsdRequest_irp;
    goto L1;
...
implementation {:origName "sdv_KeReleaseSpinLock"} {:osmodel} sdv_KeReleaseSpinLock(actual_SpinLock_1: int, actual_new: int)
{
  ...
  anon0:
    call {:si_unique_call 305} vslice_dummy_var_45 := __HAVOC_malloc(4);
    new := actual_new;
    return;
}
...
implementation {:origName "IoReuseIrp"} {:osmodel} IoReuseIrp(actual_Irp_1: int, actual_Status_15: int)
{
  ...
  anon0:
    call {:si_unique_call 306} vslice_dummy_var_46 := __HAVOC_malloc(4);
    Irp_1 := actual_Irp_1;
...
implementation {:origName "sdv_IoCompleteRequest"} {:osmodel} sdv_IoCompleteRequest(actual_pirp_6: int, actual_PriorityBoost: int)
{
  ...
  anon0:
    call {:si_unique_call 307} vslice_dummy_var_47 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "IoStopTimer"} {:osmodel} IoStopTimer(actual_DeviceObject_5: int)
{
  ...
  anon0:
    call {:si_unique_call 308} vslice_dummy_var_48 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "sdv_ExFreePool"} {:osmodel} sdv_ExFreePool(actual_P: int)
{
  ...
  anon0:
    call {:si_unique_call 309} vslice_dummy_var_49 := __HAVOC_malloc(4);
    return;
}



procedure {:origName "sdv_RunQueryRemoveDevice"} {:osmodel} sdv_RunQueryRemoveDevice(actual_po: int, actual_pirp_7: int) returns (Tmp_268: int);
  modifies Mem_T.CompletionRoutine__IO_STACK_LOCATION, alloc, Mem_T.Status__IO_STATUS_BLOCK, sdv_compFset, sdv_invoke_on_success, sdv_invoke_on_error, sdv_invoke_on_cancel, sdv_IoBuildSynchronousFsdRequest_IoStatusBlock, sdv_IoBuildDeviceIoControlRequest_IoStatusBlock, yogi_error;
  free ensures {:va_keep} yogi_error == 1;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);
...
implementation {:origName "sdv_RunQueryRemoveDevice"} {:osmodel} sdv_RunQueryRemoveDevice(actual_po: int, actual_pirp_7: int) returns (Tmp_268: int)
{
  var {:pointer} ps: int;
  var {:scalar} status_2: int;
  var {:pointer} po: int;
  ...
  anon0:
    ...
    call {:si_unique_call 310} sdv_SetStatus(pirp_7);
    call {:si_unique_call 311} status_2 := PpaPnpDeviceControl(po, pirp_7);
    Tmp_268 := status_2;
    call {:si_unique_call 312} SLIC_sdv_RunQueryRemoveDevice_exit(strConst__li2bpl12, pirp_7, Tmp_268);
    goto anon3_Then, anon3_Else;
...
procedure {:origName "sdv_IoAcquireRemoveLock"} {:osmodel} sdv_IoAcquireRemoveLock(actual_RemoveLock_1: int, actual_Tag_1: int) returns (Tmp_272: int);
  free ensures {:va_keep} Tmp_272 == -1073741823 || Tmp_272 == -1073741738 || Tmp_272 == 0;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);



implementation {:origName "sdv_IoAcquireRemoveLock"} {:osmodel} sdv_IoAcquireRemoveLock(actual_RemoveLock_1: int, actual_Tag_1: int) returns (Tmp_272: int)
{
  ...
  L1:
    call {:si_unique_call 313} SLIC_sdv_IoAcquireRemoveLock_exit(0, Tmp_272);
    return;
...
procedure {:origName "IoAllocateIrp"} {:osmodel} IoAllocateIrp(actual_StackSize: int, actual_ChargeQuota: int) returns (Tmp_274: int);
...
implementation {:origName "IoAllocateIrp"} {:osmodel} IoAllocateIrp(actual_StackSize: int, actual_ChargeQuota: int) returns (Tmp_274: int)
{
  ...
  anon3_Else:
    assume {:nonnull} sdv_other_irp != 0;
    assume sdv_other_irp > 0;
    call {:si_unique_call 314} irpSp_1 := sdv_IoGetNextIrpStackLocation(sdv_other_irp);
    assume {:nonnull} irpSp_1 != 0;
    assume irpSp_1 > 0;
    Mem_T.CompletionRoutine__IO_STACK_LOCATION[CompletionRoutine__IO_STACK_LOCATION(irpSp_1)] := 0;
    sdv_compFset := 0;
    Tmp_274 := sdv_other_irp;
    goto L1;
...
procedure {:origName "IoBuildDeviceIoControlRequest"} {:osmodel} IoBuildDeviceIoControlRequest(actual_IoControlCode: int, actual_DeviceObject_9: int, actual_InputBuffer: int, actual_InputBufferLength: int, actual_OutputBuffer: int, actual_OutputBufferLength: int, actual_InternalDeviceIoControl: int, actual_Event_3: int, actual_IoStatusBlock_1: int) returns (Tmp_286: int);
...
implementation {:origName "IoBuildDeviceIoControlRequest"} {:osmodel} IoBuildDeviceIoControlRequest(actual_IoControlCode: int, actual_DeviceObject_9: int, actual_InputBuffer: int, actual_InputBufferLength: int, actual_OutputBuffer: int, actual_OutputBufferLength: int, actual_InternalDeviceIoControl: int, actual_Event_3: int, actual_IoStatusBlock_1: int) returns (Tmp_286: int)
{
  ...
  L14:
    ...
    Tmp_286 := sdv_IoBuildDeviceIoControlRequest_irp;
    goto L1;
...
implementation {:origName "IoFreeIrp"} {:osmodel} IoFreeIrp(actual_pirp_8: int)
{
  ...
  anon0:
    call {:si_unique_call 317} vslice_dummy_var_52 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "sdv_KeInitializeSpinLock"} {:osmodel} sdv_KeInitializeSpinLock(actual_SpinLock_2: int)
{
  ...
  anon0:
    call {:si_unique_call 318} vslice_dummy_var_53 := __HAVOC_malloc(4);
...
procedure {:origName "ExAllocatePoolWithTag"} {:osmodel} ExAllocatePoolWithTag(actual_PoolType: int, actual_NumberOfBytes: int, actual_Tag_2: int) returns (Tmp_294: int);
  modifies alloc;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);
...
implementation {:origName "ExAllocatePoolWithTag"} {:osmodel} ExAllocatePoolWithTag(actual_PoolType: int, actual_NumberOfBytes: int, actual_Tag_2: int) returns (Tmp_294: int)
{
  ...
  anon3_Else:
    call {:si_unique_call 319} sdv_107 := __HAVOC_malloc(NumberOfBytes);
    Tmp_294 := sdv_107;
    goto L1;
...
procedure {:origName "RtlWriteRegistryValue"} {:osmodel} RtlWriteRegistryValue(actual_RelativeTo_1: int, actual_Path_1: int, actual_ValueName: int, actual_ValueType: int, actual_ValueData: int, actual_ValueLength: int) returns (Tmp_296: int);
  free ensures {:va_keep} Tmp_296 == 0 || Tmp_296 == -1073741823;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);



implementation {:origName "RtlWriteRegistryValue"} {:osmodel} RtlWriteRegistryValue(actual_RelativeTo_1: int, actual_Path_1: int, actual_ValueName: int, actual_ValueType: int, actual_ValueData: int, actual_ValueLength: int) returns (Tmp_296: int)
{
...
implementation {:origName "sdv_stub_driver_init"} {:osmodel} sdv_stub_driver_init()
{
  ...
  anon0:
    call {:si_unique_call 320} vslice_dummy_var_54 := __HAVOC_malloc(4);
    return;
}



procedure {:origName "IoOpenDeviceRegistryKey"} {:osmodel} IoOpenDeviceRegistryKey(actual_DeviceObject_10: int, actual_DevInstKeyType: int, actual_DesiredAccess: int, actual_DevInstRegKey: int) returns (Tmp_300: int);
  free ensures {:va_keep} Tmp_300 == -1073741811 || Tmp_300 == -1073741808 || Tmp_300 == -1073741823 || Tmp_300 == 0;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);



implementation {:origName "IoOpenDeviceRegistryKey"} {:osmodel} IoOpenDeviceRegistryKey(actual_DeviceObject_10: int, actual_DevInstKeyType: int, actual_DesiredAccess: int, actual_DevInstRegKey: int) returns (Tmp_300: int)
{
...
procedure {:origName "ZwClose"} {:osmodel} ZwClose(actual_Handle: int) returns (Tmp_304: int);
...
implementation {:origName "ZwClose"} {:osmodel} ZwClose(actual_Handle: int) returns (Tmp_304: int)
{
...
procedure {:origName "SLIC_sdv_IoAcquireRemoveLock_exit"} {:osmodel} SLIC_sdv_IoAcquireRemoveLock_exit(actual_caller: int, actual_sdv_110: int);
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);



implementation {:origName "SLIC_sdv_IoAcquireRemoveLock_exit"} {:osmodel} SLIC_sdv_IoAcquireRemoveLock_exit(actual_caller: int, actual_sdv_110: int)
{
  ...
  anon3_Else:
    ...
    call {:si_unique_call 322} SLIC_EXIT_ROUTINE(strConst__li2bpl13);
    goto L2;
...
procedure {:origName "SLIC_sdv_RunQueryRemoveDevice_exit"} {:osmodel} SLIC_sdv_RunQueryRemoveDevice_exit(actual_caller_1: int, actual_sdv_111: int, actual_sdv_112: int);
  modifies yogi_error;
  free ensures {:va_keep} yogi_error == 1;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);
...
implementation {:origName "SLIC_sdv_RunQueryRemoveDevice_exit"} {:osmodel} SLIC_sdv_RunQueryRemoveDevice_exit(actual_caller_1: int, actual_sdv_111: int, actual_sdv_112: int)
{
  ...
  anon8_Else:
    assume {:partition} sdv_112 == -1073741637;
  ...
  L6:
    call {:si_unique_call 323} SLIC_EXIT_ROUTINE(strConst__li2bpl13);
    goto L2;
  ...
  anon7_Then:
    call {:si_unique_call 324} SLIC_ABORT_2_0(caller_1, sdv_111, sdv_112);
    goto anon9_Then, anon9_Else;
...
procedure {:origName "SLIC_ABORT_2_0"} SLIC_ABORT_2_0(actual_caller_2: int, actual_sdv_113: int, actual_sdv_114: int);
  modifies yogi_error;
  free ensures {:va_keep} yogi_error == 1;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);
...
implementation {:origName "SLIC_ABORT_2_0"} SLIC_ABORT_2_0(actual_caller_2: int, actual_sdv_113: int, actual_sdv_114: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 325} SLIC_ERROR_ROUTINE(strConst__li2bpl14);
    return;
}
...
procedure {:origName "sdv_IoReleaseRemoveLock"} sdv_IoReleaseRemoveLock(actual_sdv_119: int, actual_sdv_120: int) returns (Tmp_309: int);
  modifies alloc;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);
...
implementation {:origName "sdv_IoReleaseRemoveLock"} sdv_IoReleaseRemoveLock(actual_sdv_119: int, actual_sdv_120: int) returns (Tmp_309: int)
{
  var {:scalar} sdv_121: int;

  anon0:
    call {:si_unique_call 326} Tmp_309 := __HAVOC_malloc(4);
    call {:si_unique_call 327} sdv_121 := __HAVOC_malloc(4);
...
procedure {:origName "PpaCommand"} PpaCommand(actual_Extension_19: int) returns (Tmp_321: int);
  modifies alloc;
  free ensures {:va_keep} Tmp_321 == 0 || Tmp_321 == 1;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);



implementation {:origName "PpaCommand"} PpaCommand(actual_Extension_19: int) returns (Tmp_321: int)
{
  ...
  anon3_Then:
    call {:si_unique_call 328} success_5 := VPI1Command(Extension_19);
    Tmp_321 := success_5;
    goto L1;
}
...
implementation {:origName "PpaPortLock"} PpaPortLock(actual_Extension_20: int, actual_Wait_1: int, actual_pDeviceObject: int)
{
  ...
  anon0:
    call {:si_unique_call 329} Event_4 := __HAVOC_malloc(124);
    call {:si_unique_call 330} vslice_dummy_var_56 := __HAVOC_malloc(4);
  ...
  anon13_Else:
    call {:si_unique_call 331} status_4 := sdv_IoAcquireRemoveLock(0, 0);
    goto anon14_Then, anon14_Else;

  anon14_Else:
    assume {:partition} status_4 >= 0;
    call {:si_unique_call 332} PpaInitializeLockIrp(Extension_20);
    goto anon15_Then, anon15_Else;

  anon15_Else:
    assume {:partition} Wait_1 != 0;
    call {:si_unique_call 333} KeInitializeEvent(Event_4, 0, 0);
    assume {:nonnull} Extension_20 != 0;
    assume Extension_20 > 0;
    havoc vslice_dummy_var_1181;
    call {:si_unique_call 334} sdv_IoSetCompletionRoutine(vslice_dummy_var_1181, li2bplFunctionConstant134, Event_4, 1, 1, 1);
    goto L26;
  ...
  L26:
    ...
    call {:si_unique_call 335} status_4 := sdv_IoCallDriver#1(vslice_dummy_var_1182, vslice_dummy_var_1183);
    goto anon16_Then, anon16_Else;
  ...
  anon17_Else:
    ...
    call {:si_unique_call 336} vslice_dummy_var_57 := KeWaitForSingleObject(0, 0, 0, 0, 0);
    goto L33;
  ...
  anon18_Else:
    assume {:partition} Mem_T.Status__IO_STATUS_BLOCK[Status__IO_STATUS_BLOCK(IoStatus__IRP(Tmp_323))] >= 0;
    assume {:nonnull} Extension_20 != 0;
    assume Extension_20 > 0;
    goto L37;
  ...
  L37:
    assume {:nonnull} Extension_20 != 0;
    assume Extension_20 > 0;
    call {:si_unique_call 337} vslice_dummy_var_58 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(Extension_20), Extension_20);
    goto L1;
  ...
  anon18_Then:
    assume {:partition} 0 > Mem_T.Status__IO_STATUS_BLOCK[Status__IO_STATUS_BLOCK(IoStatus__IRP(Tmp_323))];
    goto L37;
  ...
  anon15_Then:
    ...
    call {:si_unique_call 338} sdv_IoSetCompletionRoutine(vslice_dummy_var_1184, li2bplFunctionConstant199, pDeviceObject, 1, 1, 1);
    goto L26;
...
procedure {:origName "PpaStatus"} PpaStatus(actual_Extension_22: int) returns (Tmp_329: int);
  modifies alloc;
  free ensures {:va_keep} Tmp_329 == 0 || Tmp_329 == 1;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);



implementation {:origName "PpaStatus"} PpaStatus(actual_Extension_22: int) returns (Tmp_329: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 339} Tmp_331 := __HAVOC_malloc(64);
    goto anon21_Then, anon21_Else;
  ...
  anon21_Then:
    call {:si_unique_call 340} endingStatus_1 := VPI1Status(Extension_22);
...
implementation {:origName "_sdv_init6"} _sdv_init6()
{
  ...
  anon0:
    call {:si_unique_call 341} vslice_dummy_var_59 := __HAVOC_malloc(4);
    return;
}



procedure {:origName "PpaStartExecution"} PpaStartExecution(actual_Extension_23: int) returns (Tmp_338: int);
  modifies alloc;
  free ensures {:va_keep} Tmp_338 == 0 || Tmp_338 == -1073741823;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);



implementation {:origName "PpaStartExecution"} PpaStartExecution(actual_Extension_23: int) returns (Tmp_338: int)
{
  ...
  anon12_Else:
    call {:si_unique_call 342} vslice_dummy_var_61 := PpaResetBus(Extension_23);
    goto L13;
  ...
  anon15_Then:
    call {:si_unique_call 343} vslice_dummy_var_60 := PpaContinueExecution(Extension_23);
    goto L13;
...
procedure {:origName "PpaContinueExecution"} PpaContinueExecution(actual_Extension_24: int) returns (Tmp_343: int);
  modifies alloc;
...
implementation {:origName "PpaContinueExecution"} PpaContinueExecution(actual_Extension_24: int) returns (Tmp_343: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 344} Tmp_347 := __HAVOC_malloc(64);
    call {:si_unique_call 345} Tmp_348 := __HAVOC_malloc(64);
    success_6 := 0;
    assume {:nonnull} Extension_24 != 0;
    assume Extension_24 > 0;
    call {:si_unique_call 346} success_6 := VPI1SetupDrive(Extension_24);
    goto anon5_Then, anon5_Else;
  ...
  L13:
    call {:si_unique_call 347} PpaPhaseMan(Extension_24);
    call {:si_unique_call 348} vslice_dummy_var_62 := VPI1RestoreDrive(Extension_24);
    assume {:nonnull} Extension_24 != 0;
    assume Extension_24 > 0;
    Tmp_343 := 0;
    goto L1;
...
implementation {:origName "PpaPhaseMan"} PpaPhaseMan(actual_Extension_25: int)
{
  ...
  anon0:
    call {:si_unique_call 349} vslice_dummy_var_63 := __HAVOC_malloc(4);
  ...
  L8:
    call {:si_unique_call 350} i_5, Tmp_349, sdv_148, sdv_152, sdv_153, sdv_154, sdv_155, sdv_156, Tmp_357, CurrPhase, busBusy, vslice_dummy_var_69 := PpaPhaseMan_loop_L8(i_5, Tmp_349, sdv_148, sdv_152, sdv_153, sdv_154, sdv_155, sdv_156, Tmp_357, CurrPhase, busBusy, Extension_25, vslice_dummy_var_69);
    goto L8_last;
  ...
  anon32_Else:
    call {:si_unique_call 351} sdv_148 := VPI1GetPhase(Extension_25, 0);
    goto anon33_Then, anon33_Else;
  ...
  anon42_Else:
    call {:si_unique_call 352} sdv_156 := PpaStatus(Extension_25);
    goto anon35_Then, anon35_Else;
  ...
  anon35_Then:
    assume {:partition} sdv_156 == 0;
    call {:si_unique_call 353} vslice_dummy_var_64 := PpaResetBus(Extension_25);
    assume {:nonnull} Extension_25 != 0;
    assume Extension_25 > 0;
    havoc Tmp_353;
  ...
  anon42_Then:
    busBusy := 0;
    call {:si_unique_call 354} vslice_dummy_var_69 := PpaResetBus(Extension_25);
    assume {:nonnull} Extension_25 != 0;
    assume Extension_25 > 0;
    havoc Tmp_357;
  ...
  anon43_Then:
    call {:si_unique_call 355} sdv_155 := PpaCommand(Extension_25);
    goto anon36_Then, anon36_Else;

  anon36_Else:
    assume {:partition} sdv_155 == 0;
    call {:si_unique_call 356} vslice_dummy_var_65 := PpaResetBus(Extension_25);
    assume {:nonnull} Extension_25 != 0;
    assume Extension_25 > 0;
    havoc Tmp_355;
  ...
  anon44_Then:
    call {:si_unique_call 357} sdv_154 := PpaDataIn(Extension_25);
    goto anon37_Then, anon37_Else;

  anon37_Else:
    assume {:partition} sdv_154 == 0;
    call {:si_unique_call 358} vslice_dummy_var_66 := PpaResetBus(Extension_25);
    assume {:nonnull} Extension_25 != 0;
    assume Extension_25 > 0;
    havoc Tmp_358;
  ...
  anon34_Then:
    call {:si_unique_call 359} sdv_152 := PpaDataOut(Extension_25);
    goto anon38_Then, anon38_Else;

  anon38_Else:
    assume {:partition} sdv_152 == 0;
    call {:si_unique_call 360} vslice_dummy_var_67 := PpaResetBus(Extension_25);
    assume {:nonnull} Extension_25 != 0;
    assume Extension_25 > 0;
    havoc Tmp_352;
  ...
  L65:
    call {:si_unique_call 361} i_5, sdv_153 := PpaPhaseMan_loop_L65(i_5, sdv_153, CurrPhase, Extension_25);
    goto L65_last;
  ...
  anon45_Else:
    ...
    call {:si_unique_call 362} sdv_153 := VPI1GetPhase(Extension_25, 0);
    goto anon40_Then, anon40_Else;
  ...
  anon39_Else:
    ...
    call {:si_unique_call 363} vslice_dummy_var_68 := PpaResetBus(Extension_25);
    assume {:nonnull} Extension_25 != 0;
    assume Extension_25 > 0;
    havoc Tmp_356;
...
procedure {:origName "PpaDataIn"} PpaDataIn(actual_Extension_26: int) returns (Tmp_359: int);
  modifies alloc;
  free ensures {:va_keep} Tmp_359 == 0 || Tmp_359 == 1;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);



implementation {:origName "PpaDataIn"} PpaDataIn(actual_Extension_26: int) returns (Tmp_359: int)
{
  ...
  anon6_Else:
    call {:si_unique_call 364} success_7 := VPI1DataIn(Extension_26);
    Tmp_359 := success_7;
    goto L1;
...
procedure {:origName "PpaResetBus"} PpaResetBus(actual_Extension_27: int) returns (Tmp_361: int);
  free ensures {:va_keep} Tmp_361 == 0 || Tmp_361 == -1073741823;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);



implementation {:origName "PpaResetBus"} PpaResetBus(actual_Extension_27: int) returns (Tmp_361: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 365} sdv_160 := VPI1ResetBus(Extension_27);
    goto anon3_Then, anon3_Else;
...
procedure {:origName "PpaDataOut"} PpaDataOut(actual_Extension_28: int) returns (Tmp_363: int);
  modifies alloc;
  free ensures {:va_keep} Tmp_363 == 0 || Tmp_363 == 1;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);



implementation {:origName "PpaDataOut"} PpaDataOut(actual_Extension_28: int) returns (Tmp_363: int)
{
  ...
  anon6_Else:
    call {:si_unique_call 366} success_8 := VPI1DataOut(Extension_28);
    Tmp_363 := success_8;
    goto L1;
...
procedure {:origName "PpaGetDeviceInfo"} PpaGetDeviceInfo(actual_Extension_29: int) returns (Tmp_365: int);
...
implementation {:origName "PpaGetDeviceInfo"} PpaGetDeviceInfo(actual_Extension_29: int) returns (Tmp_365: int)
{
  ...
  anon0:
    call {:si_unique_call 367} kEvent := __HAVOC_malloc(124);
    call {:si_unique_call 368} ioStatus := __HAVOC_malloc(12);
  ...
  anon7_Then:
    call {:si_unique_call 369} KeInitializeEvent(kEvent, 0, 0);
    call {:si_unique_call 370} Irp_5 := IoBuildDeviceIoControlRequest(1441912, 0, 0, 0, 0, 64, 1, 0, ioStatus);
    goto anon8_Then, anon8_Else;
  ...
  anon8_Else:
    ...
    call {:si_unique_call 371} Status_18 := sdv_IoCallDriver#1(vslice_dummy_var_1185, Irp_5);
    goto anon9_Then, anon9_Else;

  anon9_Else:
    assume {:partition} Status_18 == 259;
    call {:si_unique_call 372} vslice_dummy_var_70 := KeWaitForSingleObject(0, 0, 0, 0, 0);
...
procedure {:origName "PpaCloseToParclass"} PpaCloseToParclass(actual_Extension_30: int) returns (Tmp_367: int);
  modifies alloc, Mem_T.Status__IO_STATUS_BLOCK, sdv_IoBuildSynchronousFsdRequest_IoStatusBlock, Mem_T.CompletionRoutine__IO_STACK_LOCATION, sdv_compFset, sdv_invoke_on_success, sdv_invoke_on_error, sdv_invoke_on_cancel;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);



implementation {:origName "PpaCloseToParclass"} PpaCloseToParclass(actual_Extension_30: int) returns (Tmp_367: int)
{
  ...
  anon0:
    call {:si_unique_call 373} kEvent_1 := __HAVOC_malloc(124);
    call {:si_unique_call 374} ioStatus_1 := __HAVOC_malloc(12);
    Extension_30 := actual_Extension_30;
    call {:si_unique_call 375} KeInitializeEvent(kEvent_1, 0, 0);
    call {:si_unique_call 376} Irp_6 := IoBuildSynchronousFsdRequest(27, 0, 0, 0, 0, 0, ioStatus_1);
    goto anon5_Then, anon5_Else;

  anon5_Else:
    assume {:partition} Irp_6 != 0;
    call {:si_unique_call 377} pIrpStack := sdv_IoGetNextIrpStackLocation(Irp_6);
    assume {:nonnull} pIrpStack != 0;
    assume pIrpStack > 0;
    assume {:nonnull} Extension_30 != 0;
    assume Extension_30 > 0;
    havoc vslice_dummy_var_1186;
    call {:si_unique_call 378} Status_19 := sdv_IoCallDriver#1(vslice_dummy_var_1186, Irp_6);
    goto anon6_Then, anon6_Else;

  anon6_Else:
    assume {:partition} Status_19 == 259;
    call {:si_unique_call 379} vslice_dummy_var_71 := KeWaitForSingleObject(0, 0, 0, 0, 0);
...
procedure {:origName "CheckPort"} CheckPort(actual_wPortAddr: int, actual_bMask: int, actual_bValue: int, actual_msTimeDelay: int) returns (Tmp_369: int);
  modifies alloc;
  free ensures {:va_keep} Tmp_369 == 1 || Tmp_369 == 0;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);



implementation {:origName "CheckPort"} CheckPort(actual_wPortAddr: int, actual_bMask: int, actual_bValue: int, actual_msTimeDelay: int) returns (Tmp_369: int)
{
  ...
  anon0:
    call {:si_unique_call 380} Wait_3 := __HAVOC_malloc(20);
    call {:si_unique_call 381} End := __HAVOC_malloc(20);
    call {:si_unique_call 382} Start := __HAVOC_malloc(20);
    bMask := actual_bMask;
    bValue := actual_bValue;
    msTimeDelay := actual_msTimeDelay;
    call {:si_unique_call 383} dsr := corral_nondet();
    Tmp_374 := BAND(dsr, bMask);
    goto anon12_Then, anon12_Else;

  anon12_Else:
    assume {:partition} Tmp_374 == bValue;
    Tmp_369 := 1;
    goto L1;
  ...
  anon12_Then:
    assume {:partition} Tmp_374 != bValue;
    call {:si_unique_call 384} sdv_170 := corral_nondet();
  ...
  L21:
    call {:si_unique_call 385} CheckPort_loop_L21(s_p_e_c_i_a_l_1, Start);
    goto L21_last;
  ...
  L29:
    call {:si_unique_call 386} Tmp_370, Tmp_372, s_p_e_c_i_a_l_2, sdv_172, dsr := CheckPort_loop_L29(Tmp_370, Tmp_372, Wait_3, s_p_e_c_i_a_l_2, sdv_172, End, Start, dsr, bMask, bValue);
    goto L29_last;
  ...
  L31:
    call {:si_unique_call 387} CheckPort_loop_L31(s_p_e_c_i_a_l_2, End);
    goto L31_last;
  ...
  anon14_Else:
    call {:si_unique_call 388} dsr := corral_nondet();
    Tmp_370 := BAND(dsr, bMask);
    goto anon15_Then, anon15_Else;

  anon15_Else:
    assume {:partition} Tmp_370 == bValue;
    Tmp_369 := 1;
    goto L1;

  anon15_Then:
    assume {:partition} Tmp_370 != bValue;
    call {:si_unique_call 389} sdv_172 := corral_nondet();
    assume {:nonnull} End != 0;
    assume End > 0;
    assume {:nonnull} Start != 0;
    assume Start > 0;
...
procedure {:origName "PpaHWTransferOk"} PpaHWTransferOk(actual_Extension_31: int) returns (Tmp_375: int);
  free ensures {:va_keep} Tmp_375 == 0 || Tmp_375 == 1;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);



implementation {:origName "PpaHWTransferOk"} PpaHWTransferOk(actual_Extension_31: int) returns (Tmp_375: int)
{
...
implementation {:origName "_sdv_init3"} _sdv_init3()
{
  ...
  anon0:
    call {:si_unique_call 390} vslice_dummy_var_72 := __HAVOC_malloc(4);
    return;
}



procedure {:origName "PpaGetTransferMode"} PpaGetTransferMode(actual_Extension_32: int) returns (Tmp_379: int);
  modifies alloc, Mem_T.CompletionRoutine__IO_STACK_LOCATION, sdv_compFset, sdv_invoke_on_success, sdv_invoke_on_error, sdv_invoke_on_cancel, Mem_T.Status__IO_STATUS_BLOCK;
  free ensures {:va_keep} Tmp_379 == 0 || Tmp_379 == -1073741823;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);



implementation {:origName "PpaGetTransferMode"} PpaGetTransferMode(actual_Extension_32: int) returns (Tmp_379: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 391} PpaPortLock(Extension_32, 1, 0);
  ...
  anon45_Else:
    ...
    call {:si_unique_call 392} sdv_174 := PpaHWTransferOk(Extension_32);
    goto anon33_Then, anon33_Else;
  ...
  anon37_Else:
    call {:si_unique_call 393} sdv_175 := PpaHWTransferOk(Extension_32);
    goto anon38_Then, anon38_Else;
  ...
  L39:
    call {:si_unique_call 394} PpaPortUnlock#1(Extension_32, 1, 0);
    goto L10;
  ...
  anon32_Else:
    ...
    call {:si_unique_call 395} sdv_176 := PpaHWTransferOk(Extension_32);
    goto anon43_Then, anon43_Else;
...
procedure {:origName "PpaCreateToParclass"} PpaCreateToParclass(actual_Extension_33: int) returns (Tmp_381: int);
  modifies alloc, Mem_T.Status__IO_STATUS_BLOCK, sdv_IoBuildSynchronousFsdRequest_IoStatusBlock, Mem_T.CompletionRoutine__IO_STACK_LOCATION, sdv_compFset, sdv_invoke_on_success, sdv_invoke_on_error, sdv_invoke_on_cancel;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);
...
implementation {:origName "PpaCreateToParclass"} PpaCreateToParclass(actual_Extension_33: int) returns (Tmp_381: int)
{
  ...
  anon0:
    call {:si_unique_call 396} kEvent_2 := __HAVOC_malloc(124);
    call {:si_unique_call 397} ioStatus_2 := __HAVOC_malloc(12);
    Extension_33 := actual_Extension_33;
    call {:si_unique_call 398} KeInitializeEvent(kEvent_2, 0, 0);
    call {:si_unique_call 399} Irp_7 := IoBuildSynchronousFsdRequest(27, 0, 0, 0, 0, 0, ioStatus_2);
    goto anon5_Then, anon5_Else;

  anon5_Else:
    assume {:partition} Irp_7 != 0;
    call {:si_unique_call 400} pIrpStack_1 := sdv_IoGetNextIrpStackLocation(Irp_7);
    ...
    call {:si_unique_call 401} Status_21 := sdv_IoCallDriver#1(vslice_dummy_var_1187, Irp_7);
    goto anon6_Then, anon6_Else;

  anon6_Else:
    assume {:partition} Status_21 == 259;
    call {:si_unique_call 402} vslice_dummy_var_73 := KeWaitForSingleObject(0, 0, 0, 0, 0);
...
procedure {:origName "PpaRequestCompletionRoutine"} PpaRequestCompletionRoutine(actual_DeviceObject_12: int, actual_Irp_8: int, actual_EventIn: int) returns (Tmp_383: int);
  free ensures {:va_keep} Tmp_383 == -1073741802;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);



implementation {:origName "PpaRequestCompletionRoutine"} PpaRequestCompletionRoutine(actual_DeviceObject_12: int, actual_Irp_8: int, actual_EventIn: int) returns (Tmp_383: int)
{
  ...
  anon0:
    ...
    Event_6 := EventIn;
    call {:si_unique_call 403} vslice_dummy_var_74 := KeSetEvent(Event_6, 1, 0);
    Tmp_383 := -1073741802;
    return;
}
...
implementation {:origName "PpaCompleteRequest"} PpaCompleteRequest(actual_Extension_34: int, actual_pIrp: int, actual_Status_22: int)
{
  ...
  anon0:
    call {:si_unique_call 404} vslice_dummy_var_75 := __HAVOC_malloc(4);
    Extension_34 := actual_Extension_34;
    pIrp := actual_pIrp;
    Status_22 := actual_Status_22;
    call {:si_unique_call 405} pIrpStack_2 := sdv_IoGetCurrentIrpStackLocation(pIrp);
  ...
  anon21_Else:
    call {:si_unique_call 406} sdv_184 := sdv_MmGetMdlVirtualAddress(0);
    assume {:nonnull} srb != 0;
    assume srb > 0;
    assume {:nonnull} srb != 0;
    assume srb > 0;
  ...
  anon28_Else:
    call {:si_unique_call 407} sdv_KeFlushIoBuffers(0, 1, 0);
    goto L11;
  ...
  anon25_Else:
    call {:si_unique_call 408} sdv_186 := PpaIssueRequestSense(Extension_34, pIrp);
    goto anon26_Then, anon26_Else;
  ...
  anon26_Else:
    ...
    assume {:nonnull} pIrp != 0;
    assume pIrp > 0;
    call {:si_unique_call 409} boogieTmp := PpaInterpretSenseInfo(srb);
  ...
  anon26_Then:
    ...
    assume {:nonnull} pIrp != 0;
    assume pIrp > 0;
    call {:si_unique_call 410} boogieTmp := PpaTranslateScsiStatus(srb);
    Mem_T.Status__IO_STATUS_BLOCK[Status__IO_STATUS_BLOCK(IoStatus__IRP(pIrp))] := boogieTmp;
    goto L1;
  ...
  L28:
    assume {:nonnull} pIrp != 0;
    assume pIrp > 0;
    call {:si_unique_call 411} boogieTmp := PpaTranslateScsiStatus(srb);
    Mem_T.Status__IO_STATUS_BLOCK[Status__IO_STATUS_BLOCK(IoStatus__IRP(pIrp))] := boogieTmp;
    goto L1;
...
procedure {:origName "PpaInterpretSenseInfo"} PpaInterpretSenseInfo(actual_Srb: int) returns (Tmp_388: int);
  free ensures {:va_keep} Tmp_388 == -1073741435 || Tmp_388 == -1073741823 || Tmp_388 == -1073741790 || Tmp_388 == 32 || Tmp_388 == -1073741808 || Tmp_388 == 17 || Tmp_388 == -1073741805;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);



implementation {:origName "PpaInterpretSenseInfo"} PpaInterpretSenseInfo(actual_Srb: int) returns (Tmp_388: int)
{
...
implementation {:origName "_sdv_init5"} _sdv_init5()
{
  ...
  anon0:
    call {:si_unique_call 412} vslice_dummy_var_76 := __HAVOC_malloc(4);
    return;
}



procedure {:origName "PpaIssueInquiry"} PpaIssueInquiry(actual_Extension_35: int) returns (Tmp_392: int);
  modifies alloc;
  free ensures {:va_keep} Tmp_392 == 0 || Tmp_392 == -1073741823 || Tmp_392 == -1073741670;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);



implementation {:origName "PpaIssueInquiry"} PpaIssueInquiry(actual_Extension_35: int) returns (Tmp_392: int)
{
  var {:pointer} cdb: int;
  ...
  anon0:
    ...
    retryCount := 0;
    call {:si_unique_call 413} sdv_188 := ExAllocatePoolWithTag(4, 64, -965582512);
    srb_1 := sdv_188;
    goto anon22_Then, anon22_Else;
  ...
  L14:
    call {:si_unique_call 414} cdb, Tmp_393, Tmp_394, Tmp_395, status_7, Tmp_397, retryCount := PpaIssueInquiry_loop_L14(cdb, Tmp_393, Tmp_394, Tmp_395, srb_1, status_7, Tmp_397, retryCount, Extension_35);
    goto L14_last;

  L14_last:
    call {:si_unique_call 416} sdv_RtlZeroMemory(0, 64);
    ...
    assume {:nonnull} Extension_35 != 0;
    assume Extension_35 > 0;
    call {:si_unique_call 417} IoStartTimer(0);
    call {:si_unique_call 418} status_7 := PpaStartExecution(Extension_35);
    assume {:nonnull} Extension_35 != 0;
    assume Extension_35 > 0;
    call {:si_unique_call 419} IoStopTimer(0);
    goto anon19_Then, anon19_Else;
...
procedure {:origName "PpaPortUnlockCompletionRoutine"} PpaPortUnlockCompletionRoutine(actual_pDeviceObject_2: int, actual_Irp_9: int, actual_ContextIn: int) returns (Tmp_398: int);
  modifies alloc;
...
implementation {:origName "PpaPortUnlockCompletionRoutine"} PpaPortUnlockCompletionRoutine(actual_pDeviceObject_2: int, actual_Irp_9: int, actual_ContextIn: int) returns (Tmp_398: int)
{
  ...
  anon6_Else:
    assume {:partition} Mem_T.Status__IO_STATUS_BLOCK[Status__IO_STATUS_BLOCK(IoStatus__IRP(Tmp_399))] >= 0;
    assume {:nonnull} Extension_36 != 0;
    assume Extension_36 > 0;
    goto L9;

  L9:
    call {:si_unique_call 420} sdv_190 := sdv_KeGetCurrentIrql();
    goto anon5_Then, anon5_Else;

  anon5_Else:
    assume {:partition} 2 > sdv_190;
    call {:si_unique_call 421} oldIrql := KeRaiseIrqlToDpcLevel();
    call {:si_unique_call 422} IoStartNextPacket(0, 0);
    call {:si_unique_call 423} sdv_KeLowerIrql(oldIrql);
    goto L27;
  ...
  anon5_Then:
    assume {:partition} sdv_190 >= 2;
    call {:si_unique_call 424} IoStartNextPacket(0, 0);
    goto L27;

  anon6_Then:
    assume {:partition} 0 > Mem_T.Status__IO_STATUS_BLOCK[Status__IO_STATUS_BLOCK(IoStatus__IRP(Tmp_399))];
    goto L9;
}



procedure {:origName "PpaIssueRequestSense"} PpaIssueRequestSense(actual_Extension_38: int, actual_pIrp_1: int) returns (Tmp_404: int);
  modifies alloc;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);
...
implementation {:origName "PpaIssueRequestSense"} PpaIssueRequestSense(actual_Extension_38: int, actual_pIrp_1: int) returns (Tmp_404: int)
{
  ...
  anon0:
    ...
    pIrp_1 := actual_pIrp_1;
    call {:si_unique_call 425} Tmp_405 := __HAVOC_malloc(64);
    call {:si_unique_call 426} Tmp_412 := __HAVOC_malloc(64);
    call {:si_unique_call 427} Tmp_414 := __HAVOC_malloc(64);
    call {:si_unique_call 428} Tmp_416 := __HAVOC_malloc(64);
    call {:si_unique_call 429} Tmp_417 := __HAVOC_malloc(64);
    call {:si_unique_call 430} Tmp_419 := __HAVOC_malloc(64);
    call {:si_unique_call 431} pIrpStack_3 := sdv_IoGetCurrentIrpStackLocation(pIrp_1);
    retryCount_1 := 0;
    call {:si_unique_call 432} sdv_196 := ExAllocatePoolWithTag(0, 68, -965582512);
    srb_2 := sdv_196;
    goto anon20_Then, anon20_Else;
  ...
  L18:
    call {:si_unique_call 433} Tmp_405, Tmp_406, Tmp_407, Tmp_408, Tmp_409, Tmp_411, Tmp_412, Tmp_414, Tmp_415, status_9, Tmp_416, Tmp_417, retryCount_1, Tmp_418, Tmp_419 := PpaIssueRequestSense_loop_L18(Tmp_405, Tmp_406, Tmp_407, Tmp_408, Tmp_409, Tmp_411, pIrpStack_3, Tmp_412, Tmp_414, Tmp_415, srb_2, status_9, Tmp_416, Tmp_417, retryCount_1, Tmp_418, Tmp_419, Extension_38);
    goto L18_last;

  L18_last:
    call {:si_unique_call 435} sdv_RtlZeroMemory(0, 64);
    ...
    assume {:nonnull} Extension_38 != 0;
    assume Extension_38 > 0;
    call {:si_unique_call 436} IoStartTimer(0);
    call {:si_unique_call 437} status_9 := PpaStartExecution(Extension_38);
    assume {:nonnull} Extension_38 != 0;
    assume Extension_38 > 0;
    call {:si_unique_call 438} IoStopTimer(0);
    goto anon17_Then, anon17_Else;
...
procedure {:origName "PpaTranslateScsiStatus"} PpaTranslateScsiStatus(actual_Srb_1: int) returns (Tmp_420: int);
  free ensures {:va_keep} Tmp_420 == -1073741435;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);



implementation {:origName "PpaTranslateScsiStatus"} PpaTranslateScsiStatus(actual_Srb_1: int) returns (Tmp_420: int)
{
...
implementation {:origName "_sdv_init4"} _sdv_init4()
{
  ...
  anon0:
    call {:si_unique_call 439} vslice_dummy_var_77 := __HAVOC_malloc(4);
    return;
}



procedure {:origName "PpaTrySlowerMode"} PpaTrySlowerMode(actual_Extension_39: int) returns (Tmp_424: int);
  modifies alloc;
...
implementation {:origName "PpaTrySlowerMode"} PpaTrySlowerMode(actual_Extension_39: int) returns (Tmp_424: int)
{
  ...
  anon14_Else:
    ...
    assume {:nonnull} Extension_39 != 0;
    assume Extension_39 > 0;
    call {:si_unique_call 440} vslice_dummy_var_78 := PpaWriteRegistryModeValue(Extension_39);
    goto L14;
  ...
  anon15_Else:
    ...
    assume {:nonnull} Extension_39 != 0;
    assume Extension_39 > 0;
    call {:si_unique_call 441} vslice_dummy_var_79 := PpaWriteRegistryModeValue(Extension_39);
    goto L14;
  ...
  anon15_Then:
    ...
    assume {:nonnull} Extension_39 != 0;
    assume Extension_39 > 0;
    call {:si_unique_call 442} vslice_dummy_var_80 := PpaWriteRegistryModeValue(Extension_39);
    goto L14;
  ...
  anon17_Else:
    ...
    assume {:nonnull} Extension_39 != 0;
    assume Extension_39 > 0;
    call {:si_unique_call 443} vslice_dummy_var_81 := PpaWriteRegistryModeValue(Extension_39);
    goto L34;
  ...
  anon17_Then:
    ...
    assume {:nonnull} Extension_39 != 0;
    assume Extension_39 > 0;
    call {:si_unique_call 444} vslice_dummy_var_82 := PpaWriteRegistryModeValue(Extension_39);
    goto L34;
  ...
  anon16_Else:
    ...
    assume {:nonnull} Extension_39 != 0;
    assume Extension_39 > 0;
    call {:si_unique_call 445} vslice_dummy_var_83 := PpaWriteRegistryModeValue(Extension_39);
    trySlowerMode := 1;
    goto L15;
...
procedure {:origName "PpaPnpDeviceControl"} PpaPnpDeviceControl(actual_pDeviceObject_4: int, actual_pIrp_2: int) returns (Tmp_426: int);
  modifies alloc, Mem_T.Status__IO_STATUS_BLOCK, Mem_T.CompletionRoutine__IO_STACK_LOCATION, sdv_compFset, sdv_invoke_on_success, sdv_invoke_on_error, sdv_invoke_on_cancel, sdv_IoBuildSynchronousFsdRequest_IoStatusBlock, sdv_IoBuildDeviceIoControlRequest_IoStatusBlock;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);



implementation {:origName "PpaPnpDeviceControl"} PpaPnpDeviceControl(actual_pDeviceObject_4: int, actual_pIrp_2: int) returns (Tmp_426: int)
{
  ...
  anon0:
    call {:si_unique_call 446} Event_7 := __HAVOC_malloc(124);
    ...
    havoc Extension_40;
    gotRemoveLock := 0;
    call {:si_unique_call 447} pIrpStack_4 := sdv_IoGetCurrentIrpStackLocation(pIrp_2);
    call {:si_unique_call 448} KeInitializeEvent(Event_7, 1, 0);
  ...
  anon89_Else:
    call {:si_unique_call 449} Tmp_427 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_427 != 0;
    assume Tmp_427 > 0;
    call {:si_unique_call 450} sdv_KeAcquireSpinLock(0, Tmp_427);
    assume {:nonnull} Tmp_427 != 0;
    assume Tmp_427 > 0;
    havoc cIrql;
    ...
    assume {:nonnull} pIrp_2 != 0;
    assume pIrp_2 > 0;
    call {:si_unique_call 452} sdv_IoSkipCurrentIrpStackLocation(pIrp_2);
    assume {:nonnull} Extension_40 != 0;
    assume Extension_40 > 0;
    havoc vslice_dummy_var_1188;
    call {:si_unique_call 453} Status_25 := sdv_IoCallDriver#1(vslice_dummy_var_1188, pIrp_2);
    goto L66;
  ...
  L21:
    call {:si_unique_call 454} sdv_IoSkipCurrentIrpStackLocation(pIrp_2);
    assume {:nonnull} Extension_40 != 0;
    assume Extension_40 > 0;
    havoc vslice_dummy_var_1189;
    call {:si_unique_call 455} Status_25 := sdv_IoCallDriver#1(vslice_dummy_var_1189, pIrp_2);
    goto L66;
  ...
  anon93_Then:
    ...
    assume Tmp_428 > 0;
    call {:si_unique_call 456} sdv_IoCopyCurrentIrpStackLocationToNext(pIrp_2);
    assume {:nonnull} Extension_40 != 0;
    assume Extension_40 > 0;
    havoc vslice_dummy_var_1190;
    call {:si_unique_call 457} Status_25 := sdv_IoCallDriver#1(vslice_dummy_var_1190, pIrp_2);
    goto L66;
  ...
  anon95_Then:
    call {:si_unique_call 458} sdv_IoCopyCurrentIrpStackLocationToNext(pIrp_2);
    call {:si_unique_call 459} sdv_IoSetCompletionRoutine(pIrp_2, li2bplFunctionConstant134, Event_7, 1, 1, 1);
    assume {:nonnull} Extension_40 != 0;
    assume Extension_40 > 0;
    havoc vslice_dummy_var_1191;
    call {:si_unique_call 460} Status_25 := sdv_IoCallDriver#1(vslice_dummy_var_1191, pIrp_2);
  ...
  anon108_Else:
    ...
    call {:si_unique_call 462} Tmp_427 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_427 != 0;
    assume Tmp_427 > 0;
    call {:si_unique_call 463} sdv_KeAcquireSpinLock(0, Tmp_427);
    assume {:nonnull} Tmp_427 != 0;
    assume Tmp_427 > 0;
    havoc cIrql;
    assume {:nonnull} Extension_40 != 0;
  ...
  anon96_Then:
    call {:si_unique_call 466} sdv_IoCopyCurrentIrpStackLocationToNext(pIrp_2);
    call {:si_unique_call 467} sdv_IoSetCompletionRoutine(pIrp_2, li2bplFunctionConstant134, Event_7, 1, 1, 1);
    assume {:nonnull} Extension_40 != 0;
    assume Extension_40 > 0;
    havoc vslice_dummy_var_1192;
    call {:si_unique_call 468} Status_25 := sdv_IoCallDriver#1(vslice_dummy_var_1192, pIrp_2);
    goto anon75_Then, anon75_Else;

  anon75_Else:
    assume {:partition} Status_25 == 259;
    call {:si_unique_call 469} vslice_dummy_var_85 := KeWaitForSingleObject(0, 0, 0, 0, 0);
    goto L113;
  ...
  anon107_Else:
    assume {:partition} Status_25 >= 0;
    call {:si_unique_call 470} Tmp_427 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_427 != 0;
    assume Tmp_427 > 0;
    call {:si_unique_call 471} sdv_KeAcquireSpinLock(0, Tmp_427);
    assume {:nonnull} Tmp_427 != 0;
    assume Tmp_427 > 0;
    havoc cIrql;
    assume {:nonnull} Extension_40 != 0;
    assume Extension_40 > 0;
    call {:si_unique_call 472} sdv_KeReleaseSpinLock(0, cIrql);
    goto L118;
  ...
  anon97_Then:
    call {:si_unique_call 474} sdv_IoCopyCurrentIrpStackLocationToNext(pIrp_2);
    call {:si_unique_call 475} sdv_IoSetCompletionRoutine(pIrp_2, li2bplFunctionConstant134, Event_7, 1, 1, 1);
    assume {:nonnull} Extension_40 != 0;
    assume Extension_40 > 0;
    havoc vslice_dummy_var_1193;
    call {:si_unique_call 476} Status_25 := sdv_IoCallDriver#1(vslice_dummy_var_1193, pIrp_2);
    goto anon76_Then, anon76_Else;

  anon76_Else:
    assume {:partition} Status_25 == 259;
    call {:si_unique_call 477} vslice_dummy_var_86 := KeWaitForSingleObject(0, 0, 0, 0, 0);
    goto L137;
  ...
  anon106_Else:
    assume {:partition} Status_25 >= 0;
    call {:si_unique_call 478} Tmp_427 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_427 != 0;
    assume Tmp_427 > 0;
    call {:si_unique_call 479} sdv_KeAcquireSpinLock(0, Tmp_427);
    assume {:nonnull} Tmp_427 != 0;
    assume Tmp_427 > 0;
    havoc cIrql;
    assume {:nonnull} Extension_40 != 0;
  ...
  anon98_Then:
    call {:si_unique_call 482} sdv_IoCopyCurrentIrpStackLocationToNext(pIrp_2);
    assume {:nonnull} Extension_40 != 0;
    assume Extension_40 > 0;
    havoc vslice_dummy_var_1194;
    call {:si_unique_call 483} Status_25 := sdv_IoCallDriver#1(vslice_dummy_var_1194, pIrp_2);
    goto anon77_Then, anon77_Else;

  anon77_Else:
    assume {:partition} Status_25 >= 0;
    call {:si_unique_call 484} Tmp_427 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_427 != 0;
    assume Tmp_427 > 0;
    call {:si_unique_call 485} sdv_KeAcquireSpinLock(0, Tmp_427);
    assume {:nonnull} Tmp_427 != 0;
    assume Tmp_427 > 0;
    havoc cIrql;
    assume {:nonnull} Extension_40 != 0;
    assume Extension_40 > 0;
    call {:si_unique_call 486} sdv_KeReleaseSpinLock(0, cIrql);
    assume {:nonnull} Extension_40 != 0;
    assume Extension_40 > 0;
    goto anon105_Then, anon105_Else;

  anon105_Else:
    call {:si_unique_call 487} Status_25 := PpaCreateToParclass(Extension_40);
    goto L171;
  ...
  anon78_Else:
    assume {:partition} Status_25 >= 0;
    call {:si_unique_call 488} Tmp_427 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_427 != 0;
    assume Tmp_427 > 0;
    call {:si_unique_call 489} sdv_KeAcquireSpinLock(0, Tmp_427);
    assume {:nonnull} Tmp_427 != 0;
    assume Tmp_427 > 0;
    havoc cIrql;
    assume {:nonnull} Extension_40 != 0;
    assume Extension_40 > 0;
    call {:si_unique_call 490} sdv_KeReleaseSpinLock(0, cIrql);
    goto L66;
  ...
  anon99_Then:
    call {:si_unique_call 491} Status_25 := sdv_IoAcquireRemoveLock(0, 0);
  ...
  anon80_Else:
    call {:si_unique_call 492} vslice_dummy_var_87 := IoCancelIrp(0);
    goto L187;
  ...
  anon81_Else:
    call {:si_unique_call 493} Status_25 := PpaCloseToParclass(Extension_40);
    goto L196;
  ...
  anon82_Else:
    assume {:partition} Status_25 >= 0;
    call {:si_unique_call 494} Tmp_427 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_427 != 0;
    assume Tmp_427 > 0;
    call {:si_unique_call 495} sdv_KeAcquireSpinLock(0, Tmp_427);
    assume {:nonnull} Tmp_427 != 0;
    assume Tmp_427 > 0;
    havoc cIrql;
    assume {:nonnull} Extension_40 != 0;
    assume Extension_40 > 0;
    call {:si_unique_call 496} sdv_KeReleaseSpinLock(0, cIrql);
    call {:si_unique_call 497} sdv_IoCopyCurrentIrpStackLocationToNext(pIrp_2);
    call {:si_unique_call 498} sdv_IoSetCompletionRoutine(pIrp_2, li2bplFunctionConstant134, Event_7, 1, 1, 1);
    assume {:nonnull} Extension_40 != 0;
    assume Extension_40 > 0;
    havoc vslice_dummy_var_1195;
    call {:si_unique_call 499} Status_25 := sdv_IoCallDriver#1(vslice_dummy_var_1195, pIrp_2);
    goto anon84_Then, anon84_Else;

  anon84_Else:
    assume {:partition} Status_25 == 259;
    call {:si_unique_call 500} vslice_dummy_var_88 := KeWaitForSingleObject(0, 0, 0, 0, 0);
    goto L220;
  ...
  anon85_Else:
    ...
    call {:si_unique_call 501} sdv_IoReleaseRemoveLockAndWait(0, 0);
    goto L224;
  ...
  anon104_Else:
    assume {:partition} Status_25 >= 0;
    call {:si_unique_call 502} vslice_dummy_var_89 := KeCancelTimer(0);
    call {:si_unique_call 503} PpaCleanExtension(pDeviceObject_4, 1);
    call {:si_unique_call 504} IoDetachDevice(0);
    call {:si_unique_call 505} IoDeleteDevice(0);
    assume {:nonnull} pIrp_2 != 0;
    assume pIrp_2 > 0;
    goto L229;
  ...
  anon83_Else:
    assume {:partition} gotRemoveLock != 0;
    call {:si_unique_call 507} sdv_IoReleaseRemoveLockAndWait(0, 0);
    goto L246;
  ...
  anon103_Then:
    call {:si_unique_call 508} Tmp_427 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_427 != 0;
    assume Tmp_427 > 0;
    call {:si_unique_call 509} sdv_KeAcquireSpinLock(0, Tmp_427);
    assume {:nonnull} Tmp_427 != 0;
    assume Tmp_427 > 0;
    havoc cIrql;
    assume {:nonnull} Extension_40 != 0;
    assume Extension_40 > 0;
    call {:si_unique_call 510} sdv_KeReleaseSpinLock(0, cIrql);
    goto L195;
  ...
  anon102_Else:
    call {:si_unique_call 511} Status_25 := PpaCloseToParclass(Extension_40);
    goto L256;
  ...
  anon86_Else:
    assume {:partition} Status_25 >= 0;
    call {:si_unique_call 512} Tmp_427 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_427 != 0;
    assume Tmp_427 > 0;
    call {:si_unique_call 513} sdv_KeAcquireSpinLock(0, Tmp_427);
    assume {:nonnull} Tmp_427 != 0;
    assume Tmp_427 > 0;
    havoc cIrql;
    assume {:nonnull} Extension_40 != 0;
    assume Extension_40 > 0;
    call {:si_unique_call 514} sdv_KeReleaseSpinLock(0, cIrql);
    call {:si_unique_call 515} sdv_IoCopyCurrentIrpStackLocationToNext(pIrp_2);
    assume {:nonnull} Extension_40 != 0;
    assume Extension_40 > 0;
    havoc vslice_dummy_var_1196;
    call {:si_unique_call 516} Status_25 := sdv_IoCallDriver#1(vslice_dummy_var_1196, pIrp_2);
    goto anon87_Then, anon87_Else;

  anon87_Else:
    assume {:partition} Status_25 >= 0;
    call {:si_unique_call 517} Tmp_427 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_427 != 0;
    assume Tmp_427 > 0;
    call {:si_unique_call 518} sdv_KeAcquireSpinLock(0, Tmp_427);
    assume {:nonnull} Tmp_427 != 0;
    assume Tmp_427 > 0;
    havoc cIrql;
    assume {:nonnull} Extension_40 != 0;
    assume Extension_40 > 0;
    call {:si_unique_call 519} sdv_KeReleaseSpinLock(0, cIrql);
    goto L66;

  anon87_Then:
    assume {:partition} 0 > Status_25;
    call {:si_unique_call 520} Status_25 := PpaCreateToParclass(Extension_40);
    goto L66;
  ...
  anon86_Then:
    ...
    assume pIrp_2 > 0;
    Mem_T.Status__IO_STATUS_BLOCK[Status__IO_STATUS_BLOCK(IoStatus__IRP(pIrp_2))] := Status_25;
    call {:si_unique_call 521} sdv_IoCompleteRequest(0, 0);
    goto L66;
  ...
  anon73_Then:
    ...
    call {:si_unique_call 523} sdv_IoSetCompletionRoutine(pIrp_2, li2bplFunctionConstant134, Event_7, 1, 1, 1);
    assume {:nonnull} Extension_40 != 0;
    assume Extension_40 > 0;
    havoc vslice_dummy_var_1197;
    call {:si_unique_call 524} Status_25 := sdv_IoCallDriver#1(vslice_dummy_var_1197, pIrp_2);
    goto anon88_Then, anon88_Else;

  anon88_Else:
    assume {:partition} Status_25 == 259;
    call {:si_unique_call 525} vslice_dummy_var_90 := KeWaitForSingleObject(0, 0, 0, 0, 0);
    goto L300;
  ...
  anon101_Else:
    assume {:partition} Status_25 >= 0;
    call {:si_unique_call 526} Status_25 := PpaStartDevice(pDeviceObject_4);
    assume {:nonnull} pIrp_2 != 0;
    assume pIrp_2 > 0;
    Mem_T.Status__IO_STATUS_BLOCK[Status__IO_STATUS_BLOCK(IoStatus__IRP(pIrp_2))] := Status_25;
    assume {:nonnull} pIrp_2 != 0;
  ...
  L305:
    call {:si_unique_call 527} sdv_IoCompleteRequest(0, 0);
    goto L66;
...
procedure {:origName "DriverEntry"} DriverEntry(actual_pDriverObject: int, actual_RegistryPath_1: int) returns (Tmp_432: int);
  modifies alloc;
...
implementation {:origName "DriverEntry"} DriverEntry(actual_pDriverObject: int, actual_RegistryPath_1: int) returns (Tmp_432: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 528} Tmp_433 := __HAVOC_malloc(112);
    call {:si_unique_call 529} Tmp_435 := __HAVOC_malloc(112);
    call {:si_unique_call 530} Tmp_436 := __HAVOC_malloc(112);
    call {:si_unique_call 531} Tmp_437 := __HAVOC_malloc(112);
    call {:si_unique_call 532} Tmp_438 := __HAVOC_malloc(112);
    call {:si_unique_call 533} Tmp_439 := __HAVOC_malloc(112);
    call {:si_unique_call 534} Tmp_440 := __HAVOC_malloc(112);
    call {:si_unique_call 535} Tmp_441 := __HAVOC_malloc(112);
    call {:si_unique_call 536} PpaRegInitDriverSettings(RegistryPath_1);
...
procedure {:origName "PpaAddDevice"} PpaAddDevice(actual_pDriverObject_1: int, actual_pPhysicalDeviceObject: int) returns (Tmp_443: int);
  modifies alloc;
  free ensures {:va_keep} Tmp_443 == -1073741637 || Tmp_443 == 0 || Tmp_443 == -1073741823 || Tmp_443 == -1073741824 || Tmp_443 == -1073741771 || Tmp_443 == -1073741670;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);



implementation {:origName "PpaAddDevice"} PpaAddDevice(actual_pDriverObject_1: int, actual_pPhysicalDeviceObject: int) returns (Tmp_443: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 537} Status_26 := PpaCreateDevObject(pDriverObject_1, pPhysicalDeviceObject);
    Tmp_443 := Status_26;
    return;
}
...
implementation {:origName "_sdv_init1"} _sdv_init1()
{
  ...
  anon0:
    call {:si_unique_call 538} vslice_dummy_var_91 := __HAVOC_malloc(4);
    return;
}



procedure {:origName "PpaStartDevice"} PpaStartDevice(actual_pDeviceObject_5: int) returns (Tmp_447: int);
  modifies alloc, Mem_T.Status__IO_STATUS_BLOCK, sdv_IoBuildDeviceIoControlRequest_IoStatusBlock, Mem_T.CompletionRoutine__IO_STACK_LOCATION, sdv_compFset, sdv_invoke_on_success, sdv_invoke_on_error, sdv_invoke_on_cancel, sdv_IoBuildSynchronousFsdRequest_IoStatusBlock;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);



implementation {:origName "PpaStartDevice"} PpaStartDevice(actual_pDeviceObject_5: int) returns (Tmp_447: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 539} Status_27 := PpaGetDeviceInfo(Extension_41);
    goto anon15_Then, anon15_Else;

  anon15_Else:
    assume {:partition} Status_27 >= 0;
    call {:si_unique_call 540} Status_27 := PpaInitializeExtension(Extension_41);
    goto anon16_Then, anon16_Else;
  ...
  L20:
    call {:si_unique_call 541} Status_27, sdv_232 := PpaStartDevice_loop_L20(Status_27, Extension_41, sdv_232);
    goto L20_last;

  L20_last:
    call {:si_unique_call 546} PpaPortLock(Extension_41, 1, 0);
    assume {:nonnull} Extension_41 != 0;
    assume Extension_41 > 0;
    goto anon17_Then, anon17_Else;
  ...
  L26:
    call {:si_unique_call 542} Status_27 := PpaStartDevice_loop_L26(Status_27, Extension_41);
    goto L26_last;
  ...
  anon18_Else:
    call {:si_unique_call 543} Status_27 := PpaIssueInquiry(Extension_41);
    goto anon19_Then, anon19_Else;
  ...
  L27:
    call {:si_unique_call 544} PpaPortUnlock#1(Extension_41, 1, 0);
    goto anon20_Then, anon20_Else;

  anon20_Else:
    assume {:partition} Status_27 != 0;
    call {:si_unique_call 545} sdv_232 := PpaTrySlowerMode(Extension_41);
    goto anon21_Then, anon21_Else;
...
implementation {:origName "PpaInitializeUnlockIrp"} PpaInitializeUnlockIrp(actual_Extension_42: int)
{
  ...
  anon0:
    call {:si_unique_call 547} vslice_dummy_var_92 := __HAVOC_malloc(4);
    Extension_42 := actual_Extension_42;
    assume {:nonnull} Extension_42 != 0;
    assume Extension_42 > 0;
    havoc vslice_dummy_var_1198;
    call {:si_unique_call 548} IoReuseIrp(vslice_dummy_var_1198, 0);
    assume {:nonnull} Extension_42 != 0;
    assume Extension_42 > 0;
    havoc vslice_dummy_var_1199;
    call {:si_unique_call 549} pNextIrpStack := sdv_IoGetNextIrpStackLocation(vslice_dummy_var_1199);
    assume {:nonnull} Extension_42 != 0;
    assume Extension_42 > 0;
...
procedure {:origName "PpaInitializeExtension"} PpaInitializeExtension(actual_Extension_43: int) returns (Tmp_451: int);
  modifies alloc, Mem_T.Status__IO_STATUS_BLOCK, sdv_IoBuildSynchronousFsdRequest_IoStatusBlock, Mem_T.CompletionRoutine__IO_STACK_LOCATION, sdv_compFset, sdv_invoke_on_success, sdv_invoke_on_error, sdv_invoke_on_cancel;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);
...
implementation {:origName "PpaInitializeExtension"} PpaInitializeExtension(actual_Extension_43: int) returns (Tmp_451: int)
{
  ...
  anon37_Else:
    call {:si_unique_call 550} Status_28 := PpaCreateToParclass(Extension_43);
    goto L13;
  ...
  anon27_Else:
    ...
    call {:si_unique_call 551} Tmp_455 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_455 != 0;
    assume Tmp_455 > 0;
    call {:si_unique_call 552} sdv_KeAcquireSpinLock(0, Tmp_455);
    assume {:nonnull} Tmp_455 != 0;
    assume Tmp_455 > 0;
    havoc cIrql_1;
    assume {:nonnull} Extension_43 != 0;
    assume Extension_43 > 0;
    call {:si_unique_call 553} sdv_KeReleaseSpinLock(0, cIrql_1);
    assume {:nonnull} Extension_43 != 0;
    assume Extension_43 > 0;
    goto anon28_Then, anon28_Else;
  ...
  anon28_Else:
    assume {:nonnull} Extension_43 != 0;
    assume Extension_43 > 0;
    call {:si_unique_call 554} sdv_238 := ExAllocatePoolWithTag(4, 36, -965582512);
    assume {:nonnull} Extension_43 != 0;
    assume Extension_43 > 0;
    assume {:nonnull} Extension_43 != 0;
    assume Extension_43 > 0;
  ...
  anon38_Else:
    call {:si_unique_call 555} sdv_239 := ExAllocatePoolWithTag(4, 64, -965582512);
    assume {:nonnull} Extension_43 != 0;
    assume Extension_43 > 0;
    assume {:nonnull} Extension_43 != 0;
    assume Extension_43 > 0;
  ...
  anon39_Else:
    assume {:nonnull} Extension_43 != 0;
    assume Extension_43 > 0;
    call {:si_unique_call 556} boogieTmp := IoAllocateIrp(1, 0);
    assume {:nonnull} Extension_43 != 0;
    assume Extension_43 > 0;
    goto anon29_Then, anon29_Else;
  ...
  anon29_Else:
    ...
    call {:si_unique_call 557} boogieTmp := IoAllocateIrp(vslice_dummy_var_1200, 0);
    assume {:nonnull} Extension_43 != 0;
    assume Extension_43 > 0;
    goto anon30_Then, anon30_Else;
  ...
  anon30_Else:
    ...
    call {:si_unique_call 558} boogieTmp := IoAllocateIrp(vslice_dummy_var_1201, 0);
    assume {:nonnull} Extension_43 != 0;
    assume Extension_43 > 0;
    goto anon31_Then, anon31_Else;
  ...
  L27:
    ...
    assume {:nonnull} Extension_43 != 0;
    assume Extension_43 > 0;
    call {:si_unique_call 559} vslice_dummy_var_94 := PpaGetRegistryParameters(Extension_43);
    call {:si_unique_call 560} Status_28 := PpaGetTransferMode(Extension_43);
    call {:si_unique_call 561} vslice_dummy_var_93 := PpaWriteRegistryModeValue(Extension_43);
    goto anon32_Then, anon32_Else;
  ...
  anon35_Else:
    call {:si_unique_call 564} IoFreeIrp(0);
    assume {:nonnull} Extension_43 != 0;
    assume Extension_43 > 0;
    goto L115;
  ...
  anon30_Then:
    ...
    call {:si_unique_call 570} IoFreeIrp(0);
    assume {:nonnull} Extension_43 != 0;
    assume Extension_43 > 0;
    assume {:nonnull} Extension_43 != 0;
    assume Extension_43 > 0;
...
implementation {:origName "PpaCleanExtension"} PpaCleanExtension(actual_pDeviceObject_7: int, actual_DeviceRemoved: int)
{
  ...
  anon22_Else:
    call {:si_unique_call 581} Status_29 := PpaCloseToParclass(Extension_44);
    goto anon24_Then, anon24_Else;

  anon24_Else:
    assume {:partition} Status_29 >= 0;
    call {:si_unique_call 582} Tmp_456 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_456 != 0;
    assume Tmp_456 > 0;
    call {:si_unique_call 583} sdv_KeAcquireSpinLock(0, Tmp_456);
    assume {:nonnull} Tmp_456 != 0;
    assume Tmp_456 > 0;
    havoc cIrql_2;
    assume {:nonnull} Extension_44 != 0;
    assume Extension_44 > 0;
    call {:si_unique_call 584} sdv_KeReleaseSpinLock(0, cIrql_2);
    goto L36;
...
implementation {:origName "PpaInitializeLockIrp"} PpaInitializeLockIrp(actual_Extension_45: int)
{
  ...
  anon0:
    call {:si_unique_call 586} vslice_dummy_var_96 := __HAVOC_malloc(4);
    Extension_45 := actual_Extension_45;
    assume {:nonnull} Extension_45 != 0;
    assume Extension_45 > 0;
    havoc vslice_dummy_var_1202;
    call {:si_unique_call 587} IoReuseIrp(vslice_dummy_var_1202, 0);
    assume {:nonnull} Extension_45 != 0;
    assume Extension_45 > 0;
    havoc vslice_dummy_var_1203;
    call {:si_unique_call 588} pNextIrpStack_1 := sdv_IoGetNextIrpStackLocation(vslice_dummy_var_1203);
    assume {:nonnull} Extension_45 != 0;
    assume Extension_45 > 0;
...
procedure {:origName "PpaCreateDevObject"} PpaCreateDevObject(actual_pDriverObject_2: int, actual_pPhysicalDeviceObject_1: int) returns (Tmp_461: int);
  modifies alloc;
  free ensures {:va_keep} Tmp_461 == -1073741637 || Tmp_461 == 0 || Tmp_461 == -1073741823 || Tmp_461 == -1073741824 || Tmp_461 == -1073741771 || Tmp_461 == -1073741670;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);



implementation {:origName "PpaCreateDevObject"} PpaCreateDevObject(actual_pDriverObject_2: int, actual_pPhysicalDeviceObject_1: int) returns (Tmp_461: int)
{
  ...
  anon0:
    call {:si_unique_call 589} pDeviceObject_8 := __HAVOC_malloc(4);
    ...
    call {:si_unique_call 590} Status_30 := IoCreateDevice(0, 288, 0, 45, 257, 0, pDeviceObject_8);
    goto anon7_Then, anon7_Else;
  ...
  anon7_Else:
    ...
    assume pDeviceObject_8 > 0;
    havoc Extension_46;
    call {:si_unique_call 591} sdv_RtlZeroMemory(0, 288);
  ...
  anon9_Else:
    ...
    assume {:nonnull} Extension_46 != 0;
    assume Extension_46 > 0;
    call {:si_unique_call 592} boogieTmp := IoAttachDeviceToDeviceStack(0, pPhysicalDeviceObject_1);
    assume {:nonnull} Extension_46 != 0;
    assume Extension_46 > 0;
    goto anon8_Then, anon8_Else;

  anon8_Else:
    call {:si_unique_call 593} IoDeleteDevice(0);
    Tmp_461 := -1073741637;
    goto L1;
  ...
  L24:
    assume {:nonnull} Extension_46 != 0;
    assume Extension_46 > 0;
    call {:si_unique_call 594} Status_30 := IoInitializeTimer(0, li2bplFunctionConstant126, 0);
    assume {:nonnull} Extension_46 != 0;
    assume Extension_46 > 0;
    call {:si_unique_call 595} KeInitializeDpc(TimeoutDpc__DEVICE_EXTENSION(Extension_46), li2bplFunctionConstant127, 0);
    call {:si_unique_call 596} KeInitializeTimer(0);
    call {:si_unique_call 597} Tmp_462 := __HAVOC_malloc(4);
    assume {:nonnull} Extension_46 != 0;
    assume Extension_46 > 0;
    assume {:nonnull} Tmp_462 != 0;
    assume Tmp_462 > 0;
    call {:si_unique_call 598} sdv_KeInitializeSpinLock(Tmp_462);
    assume {:nonnull} Extension_46 != 0;
    assume Extension_46 > 0;
    assume {:nonnull} Tmp_462 != 0;
    assume Tmp_462 > 0;
    call {:si_unique_call 599} sdv_IoInitializeRemoveLock(0, 541151312, 0, 1024);
    assume {:nonnull} pDeviceObject_8 != 0;
    assume pDeviceObject_8 > 0;
    Tmp_461 := Status_30;
    goto L1;
...
const {:string "Query Remove Device Irp is not supported."} unique strConst__li2bpl14: int;
...
implementation {:origName "PpaPortLockCompletionRoutine"} PpaPortLockCompletionRoutine#0(actual_pDeviceObject_3: int, actual_Irp_10: int, actual_ContextIn_1: int) returns (Tmp_401: int)
{
  ...
  anon9_Else:
    assume {:partition} Mem_T.Status__IO_STATUS_BLOCK[Status__IO_STATUS_BLOCK(IoStatus__IRP(Tmp_403))] >= 0;
    assume {:nonnull} Extension_37 != 0;
    assume Extension_37 > 0;
    goto L10;

  L10:
    call {:si_unique_call 600} status_8 := PpaStartExecution(Extension_37);
    assume {:nonnull} Extension_37 != 0;
    assume Extension_37 > 0;
    havoc vslice_dummy_var_1204;
    call {:si_unique_call 601} PpaCompleteRequest(Extension_37, vslice_dummy_var_1204, status_8);
    call {:si_unique_call 602} sdv_IoCompleteRequest(0, 0);
    assume {:nonnull} Extension_37 != 0;
    assume Extension_37 > 0;
    assume {:nonnull} Extension_37 != 0;
    assume Extension_37 > 0;
    call {:si_unique_call 603} vslice_dummy_var_97 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(Extension_37), Extension_37);
    goto anon7_Then, anon7_Else;

  anon7_Else:
    assume {:partition} status_8 < 0;
    call {:si_unique_call 604} sdv_193 := sdv_KeGetCurrentIrql();
    goto anon8_Then, anon8_Else;

  anon8_Else:
    assume {:partition} 2 > sdv_193;
    call {:si_unique_call 605} oldIrql_1 := KeRaiseIrqlToDpcLevel();
    call {:si_unique_call 606} IoStartNextPacket(0, 0);
    call {:si_unique_call 607} sdv_KeLowerIrql(oldIrql_1);
    goto L30;
  ...
  anon8_Then:
    assume {:partition} sdv_193 >= 2;
    call {:si_unique_call 608} IoStartNextPacket(0, 0);
    goto L30;
  ...
  anon9_Then:
    assume {:partition} 0 > Mem_T.Status__IO_STATUS_BLOCK[Status__IO_STATUS_BLOCK(IoStatus__IRP(Tmp_403))];
    goto L10;
}



procedure {:origName "PpaPortLockCompletionRoutine"} PpaPortLockCompletionRoutine#0(actual_pDeviceObject_3: int, actual_Irp_10: int, actual_ContextIn_1: int) returns (Tmp_401: int);
  modifies alloc, Mem_T.Status__IO_STATUS_BLOCK;
  free ensures {:va_keep} Tmp_401 == -1073741802;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);



implementation {:origName "PpaPortLockCompletionRoutine"} PpaPortLockCompletionRoutine#1(actual_pDeviceObject_3: int, actual_Irp_10: int, actual_ContextIn_1: int) returns (Tmp_401: int)
{
  var {:scalar} sdv_193: int;
  var {:pointer} Context_5: int;
  var {:scalar} oldIrql_1: int;
  ...
  L10:
    call {:si_unique_call 609} status_8 := PpaStartExecution(Extension_37);
    assume {:nonnull} Extension_37 != 0;
    assume Extension_37 > 0;
    havoc vslice_dummy_var_1205;
    call {:si_unique_call 610} PpaCompleteRequest(Extension_37, vslice_dummy_var_1205, status_8);
    call {:si_unique_call 611} sdv_IoCompleteRequest(0, 0);
    assume {:nonnull} Extension_37 != 0;
    assume Extension_37 > 0;
    assume {:nonnull} Extension_37 != 0;
    assume Extension_37 > 0;
    call {:si_unique_call 612} vslice_dummy_var_98 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(Extension_37), Extension_37);
    goto anon7_Then, anon7_Else;

  anon7_Else:
    assume {:partition} status_8 < 0;
    call {:si_unique_call 613} sdv_193 := sdv_KeGetCurrentIrql();
    goto anon8_Then, anon8_Else;

  anon8_Else:
    assume {:partition} 2 > sdv_193;
    call {:si_unique_call 614} oldIrql_1 := KeRaiseIrqlToDpcLevel();
    call {:si_unique_call 615} IoStartNextPacket(0, 0);
    call {:si_unique_call 616} sdv_KeLowerIrql(oldIrql_1);
    goto L30;
  ...
  anon8_Then:
    assume {:partition} sdv_193 >= 2;
    call {:si_unique_call 617} IoStartNextPacket(0, 0);
    goto L30;

  anon7_Then:
    assume {:partition} 0 <= status_8;
    call {:si_unique_call 618} PpaPortUnlock#0(Extension_37, 0, Context_5);
    goto L30;
...
procedure {:origName "PpaPortLockCompletionRoutine"} PpaPortLockCompletionRoutine#1(actual_pDeviceObject_3: int, actual_Irp_10: int, actual_ContextIn_1: int) returns (Tmp_401: int);
...
implementation {:origName "PpaPortUnlock"} PpaPortUnlock#0(actual_Extension_21: int, actual_Wait_2: int, actual_pDeviceObject_1: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 620} Event_5 := __HAVOC_malloc(124);
  ...
  anon11_Else:
    call {:si_unique_call 621} PpaInitializeUnlockIrp(Extension_21);
    goto anon12_Then, anon12_Else;

  anon12_Else:
    assume {:partition} Wait_2 != 0;
    call {:si_unique_call 622} KeInitializeEvent(Event_5, 0, 0);
    assume {:nonnull} Extension_21 != 0;
    assume Extension_21 > 0;
    havoc vslice_dummy_var_1206;
    call {:si_unique_call 623} sdv_IoSetCompletionRoutine(vslice_dummy_var_1206, li2bplFunctionConstant134, Event_5, 1, 1, 1);
    goto L20;
  ...
  L20:
    ...
    call {:si_unique_call 624} status_5 := sdv_IoCallDriver#0(vslice_dummy_var_1207, vslice_dummy_var_1208);
    goto anon13_Then, anon13_Else;
  ...
  anon14_Else:
    ...
    call {:si_unique_call 625} vslice_dummy_var_100 := KeWaitForSingleObject(0, 0, 0, 0, 0);
    goto L27;
  ...
  anon12_Then:
    ...
    call {:si_unique_call 626} sdv_IoSetCompletionRoutine(vslice_dummy_var_1209, li2bplFunctionConstant200, pDeviceObject_1, 1, 1, 1);
    goto L20;
...
implementation {:origName "PpaPortUnlock"} PpaPortUnlock#1(actual_Extension_21: int, actual_Wait_2: int, actual_pDeviceObject_1: int)
{
  ...
  anon0:
    call {:si_unique_call 627} vslice_dummy_var_101 := __HAVOC_malloc(4);
    call {:si_unique_call 628} Event_5 := __HAVOC_malloc(124);
    Extension_21 := actual_Extension_21;
    Wait_2 := actual_Wait_2;
    pDeviceObject_1 := actual_pDeviceObject_1;
    assume {:nonnull} Extension_21 != 0;
  ...
  anon11_Else:
    call {:si_unique_call 629} PpaInitializeUnlockIrp(Extension_21);
    goto anon12_Then, anon12_Else;

  anon12_Else:
    assume {:partition} Wait_2 != 0;
    call {:si_unique_call 630} KeInitializeEvent(Event_5, 0, 0);
    assume {:nonnull} Extension_21 != 0;
    assume Extension_21 > 0;
    havoc vslice_dummy_var_1210;
    call {:si_unique_call 631} sdv_IoSetCompletionRoutine(vslice_dummy_var_1210, li2bplFunctionConstant134, Event_5, 1, 1, 1);
    goto L20;
  ...
  L20:
    ...
    call {:si_unique_call 632} status_5 := sdv_IoCallDriver#1(vslice_dummy_var_1211, vslice_dummy_var_1212);
    goto anon13_Then, anon13_Else;
  ...
  anon14_Else:
    assume {:partition} status_5 == 259;
    call {:si_unique_call 633} vslice_dummy_var_102 := KeWaitForSingleObject(0, 0, 0, 0, 0);
    goto L27;
  ...
  anon12_Then:
    ...
    call {:si_unique_call 634} sdv_IoSetCompletionRoutine(vslice_dummy_var_1213, li2bplFunctionConstant200, pDeviceObject_1, 1, 1, 1);
    goto L20;
...
implementation {:origName "sdv_IoCallDriver"} {:osmodel} sdv_IoCallDriver#0(actual_DeviceObject_8: int, actual_Irp_4: int) returns (Tmp_284: int)
{
  var {:pointer} Irp_4: int;

  anon0:
    Irp_4 := actual_Irp_4;
    call {:si_unique_call 635} Tmp_284 := IofCallDriver#0(0, Irp_4);
    return;
}



procedure {:origName "sdv_IoCallDriver"} {:osmodel} sdv_IoCallDriver#0(actual_DeviceObject_8: int, actual_Irp_4: int) returns (Tmp_284: int);
  modifies alloc, Mem_T.Status__IO_STATUS_BLOCK;
  free ensures {:va_keep} Tmp_284 == 259;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);



implementation {:origName "sdv_IoCallDriver"} {:osmodel} sdv_IoCallDriver#1(actual_DeviceObject_8: int, actual_Irp_4: int) returns (Tmp_284: int)
{
  var {:pointer} Irp_4: int;

  anon0:
    Irp_4 := actual_Irp_4;
    call {:si_unique_call 636} Tmp_284 := IofCallDriver#1(0, Irp_4);
    return;
}



procedure {:origName "sdv_IoCallDriver"} {:osmodel} sdv_IoCallDriver#1(actual_DeviceObject_8: int, actual_Irp_4: int) returns (Tmp_284: int);
  modifies alloc, Mem_T.Status__IO_STATUS_BLOCK, Mem_T.CompletionRoutine__IO_STACK_LOCATION, sdv_compFset, sdv_invoke_on_success, sdv_invoke_on_error, sdv_invoke_on_cancel;
  free ensures {:va_keep} Tmp_284 == 259;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);
...
implementation {:origName "IofCallDriver"} {:osmodel} IofCallDriver#0(actual_DeviceObject_6: int, actual_Irp_2: int) returns (Tmp_276: int)
{
  ...
  anon47_Then:
    ...
    call {:si_unique_call 638} vslice_dummy_var_103 := sdv_RunIoCompletionRoutines#0(sdv_p_devobj_fdo, Irp_2, vslice_dummy_var_1214, completion);
    goto L29;
  ...
  anon59_Else:
    ...
    call {:si_unique_call 639} vslice_dummy_var_106 := sdv_RunIoCompletionRoutines#0(sdv_p_devobj_fdo, Irp_2, vslice_dummy_var_1215, completion);
    goto L29;
  ...
  anon51_Else:
    ...
    call {:si_unique_call 640} vslice_dummy_var_104 := sdv_RunIoCompletionRoutines#0(sdv_p_devobj_fdo, Irp_2, vslice_dummy_var_1216, completion);
    goto L29;
  ...
  anon55_Else:
    ...
    call {:si_unique_call 641} vslice_dummy_var_105 := sdv_RunIoCompletionRoutines#0(sdv_p_devobj_fdo, Irp_2, vslice_dummy_var_1217, completion);
    goto L29;
...
procedure {:origName "IofCallDriver"} {:osmodel} IofCallDriver#0(actual_DeviceObject_6: int, actual_Irp_2: int) returns (Tmp_276: int);
  modifies alloc, Mem_T.Status__IO_STATUS_BLOCK;
...
implementation {:origName "IofCallDriver"} {:osmodel} IofCallDriver#1(actual_DeviceObject_6: int, actual_Irp_2: int) returns (Tmp_276: int)
{
  var {:dopa} {:scalar} completion: int;
  var {:scalar} status_3: int;
  var {:pointer} Irp_2: int;
  ...
  anon0:
    call {:si_unique_call 642} completion := __HAVOC_malloc(4);
    Irp_2 := actual_Irp_2;
    assume {:nonnull} completion != 0;
    assume completion > 0;
    status_3 := 259;
  ...
  anon47_Then:
    ...
    call {:si_unique_call 643} vslice_dummy_var_107 := sdv_RunIoCompletionRoutines#1(sdv_p_devobj_fdo, Irp_2, vslice_dummy_var_1218, completion);
    goto L29;
  ...
  anon59_Else:
    ...
    call {:si_unique_call 644} vslice_dummy_var_110 := sdv_RunIoCompletionRoutines#1(sdv_p_devobj_fdo, Irp_2, vslice_dummy_var_1219, completion);
    goto L29;
  ...
  anon51_Else:
    ...
    call {:si_unique_call 645} vslice_dummy_var_108 := sdv_RunIoCompletionRoutines#1(sdv_p_devobj_fdo, Irp_2, vslice_dummy_var_1220, completion);
    goto L29;
  ...
  anon55_Else:
    ...
    call {:si_unique_call 646} vslice_dummy_var_109 := sdv_RunIoCompletionRoutines#1(sdv_p_devobj_fdo, Irp_2, vslice_dummy_var_1221, completion);
    goto L29;
...
procedure {:origName "IofCallDriver"} {:osmodel} IofCallDriver#1(actual_DeviceObject_6: int, actual_Irp_2: int) returns (Tmp_276: int);
  modifies alloc, Mem_T.Status__IO_STATUS_BLOCK, Mem_T.CompletionRoutine__IO_STACK_LOCATION, sdv_compFset, sdv_invoke_on_success, sdv_invoke_on_error, sdv_invoke_on_cancel;
  free ensures {:va_keep} Tmp_276 == 259;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);
...
implementation {:origName "sdv_RunIoCompletionRoutines"} {:osmodel} sdv_RunIoCompletionRoutines#0(actual_DeviceObject_7: int, actual_Irp_3: int, actual_Context_3: int, actual_Completion: int) returns (Tmp_278: int)
{
  ...
  anon9_Else:
    ...
    call {:si_unique_call 648} Status_16 := PpaPortLockCompletionRoutine#0(DeviceObject_7, Irp_3, Context_3);
    assume {:nonnull} Completion != 0;
    assume Completion > 0;
    goto L11;
  ...
  anon7_Else:
    ...
    call {:si_unique_call 649} Status_16 := PpaPortUnlockCompletionRoutine(DeviceObject_7, Irp_3, Context_3);
    assume {:nonnull} Completion != 0;
    assume Completion > 0;
    goto L28;
  ...
  anon8_Else:
    ...
    call {:si_unique_call 650} Status_16 := PpaRequestCompletionRoutine(DeviceObject_7, Irp_3, Context_3);
    assume {:nonnull} Completion != 0;
    assume Completion > 0;
    goto L45;
...
procedure {:origName "sdv_RunIoCompletionRoutines"} {:osmodel} sdv_RunIoCompletionRoutines#0(actual_DeviceObject_7: int, actual_Irp_3: int, actual_Context_3: int, actual_Completion: int) returns (Tmp_278: int);
  modifies alloc, Mem_T.Status__IO_STATUS_BLOCK;
  free ensures {:va_keep} Tmp_278 == -1073741802 || Tmp_278 == 0;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);



implementation {:origName "sdv_RunIoCompletionRoutines"} {:osmodel} sdv_RunIoCompletionRoutines#1(actual_DeviceObject_7: int, actual_Irp_3: int, actual_Context_3: int, actual_Completion: int) returns (Tmp_278: int)
{
  var {:scalar} Status_16: int;
  var {:pointer} irpsp: int;
  var {:pointer} DeviceObject_7: int;
  ...
  anon0:
    ...
    Context_3 := actual_Context_3;
    Completion := actual_Completion;
    call {:si_unique_call 651} irpsp := sdv_IoGetNextIrpStackLocation(Irp_3);
    Status_16 := 0;
    assume {:nonnull} irpsp != 0;
    assume irpsp > 0;
    goto anon9_Then, anon9_Else;
  ...
  anon9_Else:
    assume {:partition} Mem_T.CompletionRoutine__IO_STACK_LOCATION[CompletionRoutine__IO_STACK_LOCATION(irpsp)] == li2bplFunctionConstant199;
    call {:si_unique_call 652} Status_16 := PpaPortLockCompletionRoutine#1(DeviceObject_7, Irp_3, Context_3);
    assume {:nonnull} Completion != 0;
    assume Completion > 0;
    goto L11;
  ...
  anon7_Else:
    assume {:partition} Mem_T.CompletionRoutine__IO_STACK_LOCATION[CompletionRoutine__IO_STACK_LOCATION(irpsp)] == li2bplFunctionConstant200;
    call {:si_unique_call 653} Status_16 := PpaPortUnlockCompletionRoutine(DeviceObject_7, Irp_3, Context_3);
    assume {:nonnull} Completion != 0;
    assume Completion > 0;
    goto L28;
  ...
  anon8_Else:
    assume {:partition} Mem_T.CompletionRoutine__IO_STACK_LOCATION[CompletionRoutine__IO_STACK_LOCATION(irpsp)] == li2bplFunctionConstant134;
    call {:si_unique_call 654} Status_16 := PpaRequestCompletionRoutine(DeviceObject_7, Irp_3, Context_3);
    assume {:nonnull} Completion != 0;
    assume Completion > 0;
    goto L45;
...
procedure {:origName "sdv_RunIoCompletionRoutines"} {:osmodel} sdv_RunIoCompletionRoutines#1(actual_DeviceObject_7: int, actual_Irp_3: int, actual_Context_3: int, actual_Completion: int) returns (Tmp_278: int);
  modifies alloc, Mem_T.Status__IO_STATUS_BLOCK, Mem_T.CompletionRoutine__IO_STACK_LOCATION, sdv_compFset, sdv_invoke_on_success, sdv_invoke_on_error, sdv_invoke_on_cancel;
  free ensures {:va_keep} Tmp_278 == -1073741802 || Tmp_278 == 0;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);
...
implementation {:SIextraRecBound 5} PpaGetRegistryParameters_loop_L56(in_i: int, in_Tmp_4: int, in_CheckMode: int, in_sdv_1: int, in_Tmp_5: int, in_sdv_2: int, in_sdv_3: int, in_Tmp_7: int, in_sdv_7: int, in_sdv_8: int, in_Tmp_9: int, in_Tmp_10: int, in_Found: int, in_Extension: int) returns (out_i: int, out_Tmp_4: int, out_sdv_1: int, out_Tmp_5: int, out_sdv_2: int, out_sdv_3: int, out_Tmp_7: int, out_sdv_7: int, out_sdv_8: int, out_Tmp_9: int, out_Tmp_10: int, out_Found: int)
{
  ...
  anon41_Else:
    ...
    call {:si_unique_call 663} RtlInitUnicodeString(in_CheckMode, out_Tmp_5);
    call {:si_unique_call 664} out_sdv_7 := corral_nondet();
    goto anon36_Then, anon36_Else;
  ...
  anon42_Then:
    ...
    call {:si_unique_call 661} RtlInitUnicodeString(in_CheckMode, out_Tmp_9);
    call {:si_unique_call 662} out_sdv_1 := corral_nondet();
    goto anon37_Then, anon37_Else;
  ...
  anon43_Then:
    ...
    call {:si_unique_call 659} RtlInitUnicodeString(in_CheckMode, out_Tmp_10);
    call {:si_unique_call 660} out_sdv_8 := corral_nondet();
    goto anon38_Then, anon38_Else;
  ...
  anon44_Then:
    ...
    call {:si_unique_call 657} RtlInitUnicodeString(in_CheckMode, out_Tmp_4);
    call {:si_unique_call 658} out_sdv_3 := corral_nondet();
    goto anon39_Then, anon39_Else;
  ...
  anon35_Then:
    ...
    call {:si_unique_call 655} RtlInitUnicodeString(in_CheckMode, out_Tmp_7);
    call {:si_unique_call 656} out_sdv_2 := corral_nondet();
    goto anon40_Then, anon40_Else;
...
implementation VPI1Selection_loop_L71(in_i_1: int, in_Controller: int, in_sdv_18: int, in_Tmp_36: int) returns (out_i_1: int, out_sdv_18: int, out_Tmp_36: int)
{
  ...
  anon25_Else:
    ...
    call {:si_unique_call 666} out_sdv_18 := corral_nondet();
...
implementation VPI1Selection_loop_L33(in_i_1: int, in_Controller: int, in_sdv_17: int, in_Tmp_43: int) returns (out_i_1: int, out_sdv_17: int, out_Tmp_43: int)
{
  ...
  anon21_Else:
    assume {:partition} 25000 > out_i_1;
    call {:si_unique_call 667} out_sdv_17 := corral_nondet();
...
implementation VPI1DataIn_loop_L91(in_sdv_26: int, in_Extension_3: int, in_vslice_dummy_var_10: int) returns (out_sdv_26: int, out_vslice_dummy_var_10: int)
{
  ...
  L91:
    ...
    call {:si_unique_call 668} out_sdv_26 := corral_nondet();
    goto anon63_Else;
  ...
  anon63_Else:
    ...
    assume {:nonnull} in_Extension_3 != 0;
    assume in_Extension_3 > 0;
    call {:si_unique_call 669} out_vslice_dummy_var_10 := corral_nondet();
    goto anon63_Else_dummy;

  anon63_Else_dummy:
    call {:si_unique_call 670} {:si_old_unique_call 1} out_sdv_26, out_vslice_dummy_var_10 := VPI1DataIn_loop_L91(out_sdv_26, in_Extension_3, out_vslice_dummy_var_10);
    return;
}
...
implementation VPI1DataIn_loop_L16(in_ChunkSize: int, in_sdv_19: int, in_Status_3: int, in_sdv_22: int, in_BytesRead: int, in_Extension_3: int) returns (out_ChunkSize: int, out_sdv_19: int, out_Status_3: int, out_sdv_22: int)
{
  ...
  anon46_Else:
    ...
    call {:si_unique_call 672} out_sdv_19 := VPI1GetPhase(in_Extension_3, vslice_dummy_var_1223);
    goto anon48_Else;
  ...
  anon53_Else:
    assume {:nonnull} in_Extension_3 != 0;
    assume in_Extension_3 > 0;
    call {:si_unique_call 673} out_sdv_22 := corral_nondet();
    goto anon54_Then;
  ...
  anon65_Else:
    ...
    call {:si_unique_call 671} out_Status_3 := VPI1ParallelRead(in_Extension_3, vslice_dummy_var_1222, out_ChunkSize, in_BytesRead);
    assume {:nonnull} in_Extension_3 != 0;
    assume in_Extension_3 > 0;
    goto anon55_Then, anon55_Else;
  ...
  L_BAF_0:
    call {:si_unique_call 674} {:si_old_unique_call 1} out_ChunkSize, out_sdv_19, out_Status_3, out_sdv_22 := VPI1DataIn_loop_L16(out_ChunkSize, out_sdv_19, out_Status_3, out_sdv_22, in_BytesRead, in_Extension_3);
    return;
...
implementation VPI1Status_loop_L34(in_sdv_30: int, in_Extension_4: int, in_vslice_dummy_var_13: int) returns (out_sdv_30: int, out_vslice_dummy_var_13: int)
{
  ...
  L34:
    ...
    call {:si_unique_call 675} out_sdv_30 := corral_nondet();
    goto anon26_Then;
  ...
  anon26_Then:
    ...
    assume {:nonnull} in_Extension_4 != 0;
    assume in_Extension_4 > 0;
    call {:si_unique_call 676} out_vslice_dummy_var_13 := corral_nondet();
    goto anon26_Then_dummy;

  anon26_Then_dummy:
    call {:si_unique_call 677} {:si_old_unique_call 1} out_sdv_30, out_vslice_dummy_var_13 := VPI1Status_loop_L34(out_sdv_30, in_Extension_4, out_vslice_dummy_var_13);
    return;
}
...
implementation VPI1RestoreDrive_loop_L20(in_i_2: int, in_Tmp_63: int, in_Controller_1: int, in_sdv_34: int) returns (out_i_2: int, out_Tmp_63: int, out_sdv_34: int)
{
  ...
  anon5_Else:
    ...
    call {:si_unique_call 678} out_sdv_34 := corral_nondet();
...
implementation VPI1DataOut_loop_L13(in_ChunkSize_1: int, in_sdv_38: int, in_Status_5: int, in_BytesWritten: int, in_Extension_7: int) returns (out_ChunkSize_1: int, out_sdv_38: int, out_Status_5: int)
{
  ...
  anon28_Else:
    ...
    call {:si_unique_call 680} out_sdv_38 := VPI1GetPhase(in_Extension_7, vslice_dummy_var_1225);
    goto anon29_Else;
  ...
  L34:
    ...
    call {:si_unique_call 679} out_Status_5 := VPI1ParallelWrite(in_Extension_7, vslice_dummy_var_1224, out_ChunkSize_1, in_BytesWritten);
    assume {:nonnull} in_Extension_7 != 0;
    assume in_Extension_7 > 0;
    goto anon34_Then, anon34_Else;
  ...
  L_BAF_1:
    call {:si_unique_call 681} {:si_old_unique_call 1} out_ChunkSize_1, out_sdv_38, out_Status_5 := VPI1DataOut_loop_L13(out_ChunkSize_1, out_sdv_38, out_Status_5, in_BytesWritten, in_Extension_7);
    return;
...
implementation VPI1Command_loop_L10(in_i_3: int, in_Tmp_85: int, in_Tmp_87: int, in_Tmp_88: int, in_success_3: int, in_sdv_43: int, in_Status_7: int, in_BytesWritten_1: int, in_Tmp_89: int, in_Tmp_90: int, in_Extension_9: int) returns (out_i_3: int, out_Tmp_85: int, out_Tmp_87: int, out_Tmp_88: int, out_success_3: int, out_sdv_43: int, out_Status_7: int, out_Tmp_89: int, out_Tmp_90: int)
{
  ...
  anon27_Else:
    ...
    call {:si_unique_call 683} out_sdv_43 := VPI1GetPhase(in_Extension_9, vslice_dummy_var_1226);
    goto anon19_Else;
  ...
  anon23_Then:
    ...
    call {:si_unique_call 682} out_Status_7 := VPI1ParallelWrite(in_Extension_9, out_Tmp_87, 1, in_BytesWritten_1);
    assume {:nonnull} in_Extension_9 != 0;
    assume in_Extension_9 > 0;
    goto anon24_Then, anon24_Else;
  ...
  L36_dummy:
    call {:si_unique_call 684} {:si_old_unique_call 1} out_i_3, out_Tmp_85, out_Tmp_87, out_Tmp_88, out_success_3, out_sdv_43, out_Status_7, out_Tmp_89, out_Tmp_90 := VPI1Command_loop_L10(out_i_3, out_Tmp_85, out_Tmp_87, out_Tmp_88, out_success_3, out_sdv_43, out_Status_7, in_BytesWritten_1, out_Tmp_89, out_Tmp_90, in_Extension_9);
    return;
...
implementation VPI1GetPhase_loop_L18(in_i_4: int, in_Tmp_93: int, in_Tmp_96: int, in_sdv_45: int, in_Controller_3: int, in_sdv_46: int, in_EcrController_1: int, in_phase: int) returns (out_i_4: int, out_Tmp_93: int, out_Tmp_96: int, out_sdv_45: int, out_sdv_46: int)
{
  ...
  anon35_Else:
    ...
    call {:si_unique_call 686} out_sdv_45 := corral_nondet();
  ...
  anon30_Then:
    assume {:partition} in_phase == 2;
    call {:si_unique_call 685} out_sdv_46 := corral_nondet();
...
implementation VPI1GetPhase_loop_L63(in_i_4: int, in_Tmp_98: int, in_Controller_3: int, in_sdv_49: int) returns (out_i_4: int, out_Tmp_98: int, out_sdv_49: int)
{
  ...
  anon38_Else:
    assume {:partition} out_i_4 != 0;
    call {:si_unique_call 687} out_sdv_49 := corral_nondet();
...
implementation VPI1DataNibbleRead_loop_L14(in_sdv_74: int, in_CharBufPtr_2: int, in_ByteRead: int, in_sdv_75: int, in_xferCount_2: int, in_Controller_8: int, in_ChunkSize_4: int) returns (out_sdv_74: int, out_ByteRead: int, out_sdv_75: int, out_xferCount_2: int)
{
  ...
  L14:
    call {:si_unique_call 688} out_sdv_74 := corral_nondet();
    call {:si_unique_call 689} out_sdv_75 := corral_nondet();
    call {:si_unique_call 690} out_ByteRead := corral_nondet();
...
implementation PpaPhaseMan_loop_L65(in_i_5: int, in_sdv_153: int, in_CurrPhase: int, in_Extension_25: int) returns (out_i_5: int, out_sdv_153: int)
{

  entry:
    out_i_5, out_sdv_153 := in_i_5, in_sdv_153;
    goto L65, exit;
  ...
  anon45_Else:
    ...
    call {:si_unique_call 691} out_sdv_153 := VPI1GetPhase(in_Extension_25, 0);
    goto anon40_Else;
  ...
  anon41_Else_dummy:
    call {:si_unique_call 692} {:si_old_unique_call 1} out_i_5, out_sdv_153 := PpaPhaseMan_loop_L65(out_i_5, out_sdv_153, in_CurrPhase, in_Extension_25);
    return;
}



procedure {:LoopProcedure} PpaPhaseMan_loop_L65(in_i_5: int, in_sdv_153: int, in_CurrPhase: int, in_Extension_25: int) returns (out_i_5: int, out_sdv_153: int);
...
implementation PpaPhaseMan_loop_L8(in_i_5: int, in_Tmp_349: int, in_sdv_148: int, in_sdv_152: int, in_sdv_153: int, in_sdv_154: int, in_sdv_155: int, in_sdv_156: int, in_Tmp_357: int, in_CurrPhase: int, in_busBusy: int, in_Extension_25: int, in_vslice_dummy_var_69: int) returns (out_i_5: int, out_Tmp_349: int, out_sdv_148: int, out_sdv_152: int, out_sdv_153: int, out_sdv_154: int, out_sdv_155: int, out_sdv_156: int, out_Tmp_357: int, out_CurrPhase: int, out_busBusy: int, out_vslice_dummy_var_69: int)
{

  entry:
    out_i_5, out_Tmp_349, out_sdv_148, out_sdv_152, out_sdv_153, out_sdv_154, out_sdv_155, out_sdv_156, out_Tmp_357, out_CurrPhase, out_busBusy, out_vslice_dummy_var_69 := in_i_5, in_Tmp_349, in_sdv_148, in_sdv_152, in_sdv_153, in_sdv_154, in_sdv_155, in_sdv_156, in_Tmp_357, in_CurrPhase, in_busBusy, in_vslice_dummy_var_69;
    goto L8, exit;
  ...
  anon32_Else:
    call {:si_unique_call 696} out_sdv_148 := VPI1GetPhase(in_Extension_25, 0);
    goto anon33_Else;
  ...
  anon42_Else:
    call {:si_unique_call 693} out_sdv_156 := PpaStatus(in_Extension_25);
    goto anon35_Else;
  ...
  L_BAF_2:
    call {:si_unique_call 701} {:si_old_unique_call 1} out_i_5, out_Tmp_349, out_sdv_148, out_sdv_152, out_sdv_153, out_sdv_154, out_sdv_155, out_sdv_156, out_Tmp_357, out_CurrPhase, out_busBusy, out_vslice_dummy_var_69 := PpaPhaseMan_loop_L8(out_i_5, out_Tmp_349, out_sdv_148, out_sdv_152, out_sdv_153, out_sdv_154, out_sdv_155, out_sdv_156, out_Tmp_357, out_CurrPhase, out_busBusy, in_Extension_25, out_vslice_dummy_var_69);
    return;

  anon42_Then:
    out_busBusy := 0;
    call {:si_unique_call 697} out_vslice_dummy_var_69 := PpaResetBus(in_Extension_25);
    assume {:nonnull} in_Extension_25 != 0;
    assume in_Extension_25 > 0;
    havoc out_Tmp_357;
  ...
  anon43_Then:
    call {:si_unique_call 698} out_sdv_155 := PpaCommand(in_Extension_25);
    goto anon36_Then;
  ...
  anon44_Then:
    call {:si_unique_call 699} out_sdv_154 := PpaDataIn(in_Extension_25);
    goto anon37_Then;
  ...
  anon34_Then:
    call {:si_unique_call 700} out_sdv_152 := PpaDataOut(in_Extension_25);
    goto anon38_Then;
  ...
  L65:
    call {:si_unique_call 694} out_i_5, out_sdv_153 := PpaPhaseMan_loop_L65(out_i_5, out_sdv_153, out_CurrPhase, in_Extension_25);
    goto L65_last;
  ...
  anon45_Else:
    assume {:partition} out_i_5 != 0;
    call {:si_unique_call 695} out_sdv_153 := VPI1GetPhase(in_Extension_25, 0);
    goto anon40_Then, anon40_Else;
...
procedure {:LoopProcedure} PpaPhaseMan_loop_L8(in_i_5: int, in_Tmp_349: int, in_sdv_148: int, in_sdv_152: int, in_sdv_153: int, in_sdv_154: int, in_sdv_155: int, in_sdv_156: int, in_Tmp_357: int, in_CurrPhase: int, in_busBusy: int, in_Extension_25: int, in_vslice_dummy_var_69: int) returns (out_i_5: int, out_Tmp_349: int, out_sdv_148: int, out_sdv_152: int, out_sdv_153: int, out_sdv_154: int, out_sdv_155: int, out_sdv_156: int, out_Tmp_357: int, out_CurrPhase: int, out_busBusy: int, out_vslice_dummy_var_69: int);
  modifies alloc;
  free ensures {:va_keep} out_sdv_148 == 1 || out_sdv_148 == 0 || out_sdv_148 == in_sdv_148;
  ...
  free ensures {:va_keep} out_sdv_155 == 0 || out_sdv_155 == 1 || out_sdv_155 == in_sdv_155;
  ...
  free ensures {:va_keep} out_vslice_dummy_var_69 == 0 || out_vslice_dummy_var_69 == -1073741823 || out_vslice_dummy_var_69 == in_vslice_dummy_var_69;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);
...
implementation CheckPort_loop_L31(in_s_p_e_c_i_a_l_2: int, in_End: int)
{
  ...
  anon14_Then_dummy:
    call {:si_unique_call 702} {:si_old_unique_call 1} CheckPort_loop_L31(in_s_p_e_c_i_a_l_2, in_End);
    return;
}
...
implementation CheckPort_loop_L29(in_Tmp_370: int, in_Tmp_372: int, in_Wait_3: int, in_s_p_e_c_i_a_l_2: int, in_sdv_172: int, in_End: int, in_Start: int, in_dsr: int, in_bMask: int, in_bValue: int) returns (out_Tmp_370: int, out_Tmp_372: int, out_s_p_e_c_i_a_l_2: int, out_sdv_172: int, out_dsr: int)
{

  entry:
    out_Tmp_370, out_Tmp_372, out_s_p_e_c_i_a_l_2, out_sdv_172, out_dsr := in_Tmp_370, in_Tmp_372, in_s_p_e_c_i_a_l_2, in_sdv_172, in_dsr;
    goto L29, exit;
  ...
  L31:
    call {:si_unique_call 705} CheckPort_loop_L31(out_s_p_e_c_i_a_l_2, in_End);
    goto L31_last;
  ...
  anon14_Else:
    call {:si_unique_call 704} out_dsr := corral_nondet();
    out_Tmp_370 := BAND(out_dsr, in_bMask);
    goto anon15_Then;

  anon15_Then:
    assume {:partition} out_Tmp_370 != in_bValue;
    call {:si_unique_call 703} out_sdv_172 := corral_nondet();
    assume {:nonnull} in_End != 0;
    assume in_End > 0;
  ...
  anon11_Then_dummy:
    call {:si_unique_call 706} {:si_old_unique_call 1} out_Tmp_370, out_Tmp_372, out_s_p_e_c_i_a_l_2, out_sdv_172, out_dsr := CheckPort_loop_L29(out_Tmp_370, out_Tmp_372, in_Wait_3, out_s_p_e_c_i_a_l_2, out_sdv_172, in_End, in_Start, out_dsr, in_bMask, in_bValue);
    return;
...
procedure {:LoopProcedure} CheckPort_loop_L29(in_Tmp_370: int, in_Tmp_372: int, in_Wait_3: int, in_s_p_e_c_i_a_l_2: int, in_sdv_172: int, in_End: int, in_Start: int, in_dsr: int, in_bMask: int, in_bValue: int) returns (out_Tmp_370: int, out_Tmp_372: int, out_s_p_e_c_i_a_l_2: int, out_sdv_172: int, out_dsr: int);
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);
...
implementation CheckPort_loop_L21(in_s_p_e_c_i_a_l_1: int, in_Start: int)
{
  ...
  anon13_Then_dummy:
    call {:si_unique_call 707} {:si_old_unique_call 1} CheckPort_loop_L21(in_s_p_e_c_i_a_l_1, in_Start);
    return;
}
...
implementation PpaIssueInquiry_loop_L14(in_cdb: int, in_Tmp_393: int, in_Tmp_394: int, in_Tmp_395: int, in_srb_1: int, in_status_7: int, in_Tmp_397: int, in_retryCount: int, in_Extension_35: int) returns (out_cdb: int, out_Tmp_393: int, out_Tmp_394: int, out_Tmp_395: int, out_status_7: int, out_Tmp_397: int, out_retryCount: int)
{

  entry:
    out_cdb, out_Tmp_393, out_Tmp_394, out_Tmp_395, out_status_7, out_Tmp_397, out_retryCount := in_cdb, in_Tmp_393, in_Tmp_394, in_Tmp_395, in_status_7, in_Tmp_397, in_retryCount;
    goto L14, exit;
  ...
  L14:
    call {:si_unique_call 708} sdv_RtlZeroMemory(0, 64);
    ...
    assume {:nonnull} in_Extension_35 != 0;
    assume in_Extension_35 > 0;
    call {:si_unique_call 709} IoStartTimer(0);
    call {:si_unique_call 710} out_status_7 := PpaStartExecution(in_Extension_35);
    assume {:nonnull} in_Extension_35 != 0;
    assume in_Extension_35 > 0;
    call {:si_unique_call 711} IoStopTimer(0);
    goto anon19_Else;
  ...
  anon23_Else:
    assume {:partition} out_Tmp_394 != 1;
    assume {:nonnull} in_srb_1 != 0;
    assume in_srb_1 > 0;
    havoc out_Tmp_395;
    goto anon24_Then, anon24_Else;
  ...
  anon24_Else:
    assume {:partition} out_Tmp_395 == 18;
    out_status_7 := 0;
    goto L60;
  ...
  anon21_Then_dummy:
    call {:si_unique_call 712} {:si_old_unique_call 1} out_cdb, out_Tmp_393, out_Tmp_394, out_Tmp_395, out_status_7, out_Tmp_397, out_retryCount := PpaIssueInquiry_loop_L14(out_cdb, out_Tmp_393, out_Tmp_394, out_Tmp_395, in_srb_1, out_status_7, out_Tmp_397, out_retryCount, in_Extension_35);
    return;
  ...
  anon25_Else:
    assume {:partition} out_Tmp_393 == 10;
    goto L68;
  ...
  anon26_Else:
    assume {:partition} out_Tmp_397 != 8;
...
procedure {:LoopProcedure} PpaIssueInquiry_loop_L14(in_cdb: int, in_Tmp_393: int, in_Tmp_394: int, in_Tmp_395: int, in_srb_1: int, in_status_7: int, in_Tmp_397: int, in_retryCount: int, in_Extension_35: int) returns (out_cdb: int, out_Tmp_393: int, out_Tmp_394: int, out_Tmp_395: int, out_status_7: int, out_Tmp_397: int, out_retryCount: int);
  modifies alloc;
...
implementation PpaIssueRequestSense_loop_L18(in_Tmp_405: int, in_Tmp_406: int, in_Tmp_407: int, in_Tmp_408: int, in_Tmp_409: int, in_Tmp_411: int, in_pIrpStack_3: int, in_Tmp_412: int, in_Tmp_414: int, in_Tmp_415: int, in_srb_2: int, in_status_9: int, in_Tmp_416: int, in_Tmp_417: int, in_retryCount_1: int, in_Tmp_418: int, in_Tmp_419: int, in_Extension_38: int) returns (out_Tmp_405: int, out_Tmp_406: int, out_Tmp_407: int, out_Tmp_408: int, out_Tmp_409: int, out_Tmp_411: int, out_Tmp_412: int, out_Tmp_414: int, out_Tmp_415: int, out_status_9: int, out_Tmp_416: int, out_Tmp_417: int, out_retryCount_1: int, out_Tmp_418: int, out_Tmp_419: int)
{

  entry:
    out_Tmp_405, out_Tmp_406, out_Tmp_407, out_Tmp_408, out_Tmp_409, out_Tmp_411, out_Tmp_412, out_Tmp_414, out_Tmp_415, out_status_9, out_Tmp_416, out_Tmp_417, out_retryCount_1, out_Tmp_418, out_Tmp_419 := in_Tmp_405, in_Tmp_406, in_Tmp_407, in_Tmp_408, in_Tmp_409, in_Tmp_411, in_Tmp_412, in_Tmp_414, in_Tmp_415, in_status_9, in_Tmp_416, in_Tmp_417, in_retryCount_1, in_Tmp_418, in_Tmp_419;
    goto L18, exit;
  ...
  L18:
    call {:si_unique_call 713} sdv_RtlZeroMemory(0, 64);
    ...
    assume {:nonnull} in_Extension_38 != 0;
    assume in_Extension_38 > 0;
    call {:si_unique_call 714} IoStartTimer(0);
    call {:si_unique_call 715} out_status_9 := PpaStartExecution(in_Extension_38);
    assume {:nonnull} in_Extension_38 != 0;
    assume in_Extension_38 > 0;
    call {:si_unique_call 716} IoStopTimer(0);
    goto anon17_Else;
  ...
  anon21_Else:
    assume {:partition} out_Tmp_418 != 1;
    assume {:nonnull} in_srb_2 != 0;
    assume in_srb_2 > 0;
    havoc out_Tmp_408;
    goto anon22_Then, anon22_Else;
  ...
  anon22_Else:
    assume {:partition} out_Tmp_408 == 18;
    out_status_9 := 0;
    goto L62;
  ...
  anon19_Then_dummy:
    call {:si_unique_call 717} {:si_old_unique_call 1} out_Tmp_405, out_Tmp_406, out_Tmp_407, out_Tmp_408, out_Tmp_409, out_Tmp_411, out_Tmp_412, out_Tmp_414, out_Tmp_415, out_status_9, out_Tmp_416, out_Tmp_417, out_retryCount_1, out_Tmp_418, out_Tmp_419 := PpaIssueRequestSense_loop_L18(out_Tmp_405, out_Tmp_406, out_Tmp_407, out_Tmp_408, out_Tmp_409, out_Tmp_411, in_pIrpStack_3, out_Tmp_412, out_Tmp_414, out_Tmp_415, in_srb_2, out_status_9, out_Tmp_416, out_Tmp_417, out_retryCount_1, out_Tmp_418, out_Tmp_419, in_Extension_38);
    return;
  ...
  anon23_Else:
    assume {:partition} out_Tmp_415 != 10;
    assume {:nonnull} in_srb_2 != 0;
    assume in_srb_2 > 0;
    havoc out_Tmp_409;
    goto anon24_Then, anon24_Else;
  ...
  anon24_Else:
    assume {:partition} out_Tmp_409 != 8;
...
procedure {:LoopProcedure} PpaIssueRequestSense_loop_L18(in_Tmp_405: int, in_Tmp_406: int, in_Tmp_407: int, in_Tmp_408: int, in_Tmp_409: int, in_Tmp_411: int, in_pIrpStack_3: int, in_Tmp_412: int, in_Tmp_414: int, in_Tmp_415: int, in_srb_2: int, in_status_9: int, in_Tmp_416: int, in_Tmp_417: int, in_retryCount_1: int, in_Tmp_418: int, in_Tmp_419: int, in_Extension_38: int) returns (out_Tmp_405: int, out_Tmp_406: int, out_Tmp_407: int, out_Tmp_408: int, out_Tmp_409: int, out_Tmp_411: int, out_Tmp_412: int, out_Tmp_414: int, out_Tmp_415: int, out_status_9: int, out_Tmp_416: int, out_Tmp_417: int, out_retryCount_1: int, out_Tmp_418: int, out_Tmp_419: int);
  modifies alloc;
...
implementation PpaStartDevice_loop_L26(in_Status_27: int, in_Extension_41: int) returns (out_Status_27: int)
{
  ...
  anon18_Else:
    call {:si_unique_call 718} out_Status_27 := PpaIssueInquiry(in_Extension_41);
    goto anon19_Else;
  ...
  anon19_Else_dummy:
    call {:si_unique_call 719} {:si_old_unique_call 1} out_Status_27 := PpaStartDevice_loop_L26(out_Status_27, in_Extension_41);
    return;
}
...
implementation PpaStartDevice_loop_L20(in_Status_27: int, in_Extension_41: int, in_sdv_232: int) returns (out_Status_27: int, out_sdv_232: int)
{

  entry:
    out_Status_27, out_sdv_232 := in_Status_27, in_sdv_232;
    goto L20, exit;
  ...
  L20:
    call {:si_unique_call 720} PpaPortLock(in_Extension_41, 1, 0);
    assume {:nonnull} in_Extension_41 != 0;
    assume in_Extension_41 > 0;
    goto anon17_Else;
  ...
  L26:
    call {:si_unique_call 723} out_Status_27 := PpaStartDevice_loop_L26(out_Status_27, in_Extension_41);
    goto L26_last;
  ...
  anon18_Else:
    call {:si_unique_call 724} out_Status_27 := PpaIssueInquiry(in_Extension_41);
    goto anon19_Then, anon19_Else;
  ...
  L27:
    call {:si_unique_call 722} PpaPortUnlock#1(in_Extension_41, 1, 0);
    goto anon20_Else;

  anon20_Else:
    assume {:partition} out_Status_27 != 0;
    call {:si_unique_call 721} out_sdv_232 := PpaTrySlowerMode(in_Extension_41);
    goto anon21_Then;
  ...
  anon21_Then_dummy:
    call {:si_unique_call 725} {:si_old_unique_call 1} out_Status_27, out_sdv_232 := PpaStartDevice_loop_L20(out_Status_27, in_Extension_41, out_sdv_232);
    return;
...
procedure {:LoopProcedure} PpaStartDevice_loop_L20(in_Status_27: int, in_Extension_41: int, in_sdv_232: int) returns (out_Status_27: int, out_sdv_232: int);
  modifies alloc, Mem_T.CompletionRoutine__IO_STACK_LOCATION, sdv_compFset, sdv_invoke_on_success, sdv_invoke_on_error, sdv_invoke_on_cancel, Mem_T.Status__IO_STATUS_BLOCK;
  free ensures {:va_keep} out_Status_27 == 0 || out_Status_27 == -1073741823 || out_Status_27 == -1073741670 || out_Status_27 == in_Status_27;
...
procedure fakeMain() returns (Tmp_231: int, dup_assertVar: bool);
  modifies alloc, sdv_IoBuildDeviceIoControlRequest_IoStatusBlock, sdv_IoBuildSynchronousFsdRequest_IoStatusBlock, sdv_invoke_on_success, sdv_invoke_on_error, sdv_invoke_on_cancel, sdv_compFset, yogi_error, Mem_T.CompletionRoutine__IO_STACK_LOCATION, Mem_T.Status__IO_STATUS_BLOCK;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);
...
implementation {:entrypoint} fakeMain() returns (Tmp_231: int, dup_assertVar: bool)
{

  start:
    call Tmp_231, dup_assertVar := main();
