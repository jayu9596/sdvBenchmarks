...
implementation {:origName "VPI0DataIn"} VPI0DataIn(actual_Extension_2: int) returns (Tmp_19: int)
{
  ...
  L27:
    ...
    call {:si_unique_call 46} Status_2 := VPI0ParallelRead(Extension_2, vslice_dummy_var_144, ChunkSize, BytesRead);
    assume {:nonnull} Extension_2 != 0;
    assume Extension_2 > 0;
    goto anon29_Then, anon29_Else;
...
implementation {:origName "VPI0DataOut"} VPI0DataOut(actual_Extension_6: int) returns (Tmp_43: int)
{
  ...
  L27:
    ...
    call {:si_unique_call 57} Status_3 := VPI0ParallelWrite(Extension_6, vslice_dummy_var_145, ChunkSize_1, BytesWritten);
    assume {:nonnull} Extension_6 != 0;
    assume Extension_6 > 0;
    goto anon29_Then, anon29_Else;
...
implementation {:origName "VPI0RestoreDrive"} VPI0RestoreDrive(actual_Extension_7: int) returns (Tmp_49: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 59} VPI0Deselect(vslice_dummy_var_146);
    call {:si_unique_call 60} vslice_dummy_var_10 := VPI0TerminateMode(Extension_7);
    assume {:nonnull} Extension_7 != 0;
    assume Extension_7 > 0;
    havoc vslice_dummy_var_147;
    call {:si_unique_call 61} VPI0TrySelect(vslice_dummy_var_147, 143);
    Tmp_49 := 1;
    return;
}
...
implementation {:origName "VPI0NegotiateMode"} VPI0NegotiateMode(actual_Extension_14: int) returns (Tmp_93: int)
{
  ...
  anon13_Else:
    ...
    call {:si_unique_call 90} VPI0Deselect(vslice_dummy_var_148);
    assume {:nonnull} Extension_14 != 0;
    assume Extension_14 > 0;
    havoc vslice_dummy_var_149;
    call {:si_unique_call 91} VPI0TrySelect(vslice_dummy_var_149, 207);
    assume {:nonnull} Extension_14 != 0;
    assume Extension_14 > 0;
    havoc vslice_dummy_var_150;
    call {:si_unique_call 92} sdv_43 := VPI0CheckDevice(vslice_dummy_var_150);
    goto anon14_Then, anon14_Else;
...
implementation {:origName "VPI0ParallelWrite"} VPI0ParallelWrite(actual_Extension_15: int, actual_Buffer_2: int, actual_NumBytesToWrite: int, actual_BytesTransfered: int) returns (Tmp_101: int)
{
  ...
  L12:
    ...
    call {:si_unique_call 95} Status_10 := VPI0DataByteWrite(vslice_dummy_var_151, Buffer_2, NumBytesToWrite, BytesTransfered);
    goto L16;
...
implementation {:origName "VPI0ParallelRead"} VPI0ParallelRead(actual_Extension_16: int, actual_Buffer_4: int, actual_NumBytesToRead: int, actual_BytesTransfered_1: int) returns (Tmp_134: int)
{
  ...
  anon8_Else:
    ...
    call {:si_unique_call 109} Status_11 := VPI0DataNibbleRead(vslice_dummy_var_152, Buffer_4, NumBytesToRead, BytesTransfered_1);
    goto L16;
  ...
  anon9_Else:
    ...
    call {:si_unique_call 110} Status_11 := VPI0DataByteRead(vslice_dummy_var_153, Buffer_4, NumBytesToRead, BytesTransfered_1);
    goto L16;
...
implementation {:origName "PoCallDriver"} {:osmodel} PoCallDriver(actual_DeviceObject_1: int, actual_Irp: int) returns (Tmp_165: int)
{
  ...
  anon56_Then:
    ...
    call {:si_unique_call 124} sdv_61 := sdv_RunIoCompletionRoutines#1(sdv_p_devobj_fdo, Irp, vslice_dummy_var_154, completion);
    goto anon73_Then, anon73_Else;

  anon73_Else:
    assume Irp == SLAM_guard_S_0;
    assume SLAM_guard_S_0 != SLAM_guard_S_0_init;
    call {:si_unique_call 125} SLIC_sdv_RunIoCompletionRoutines_exit(0, completion, sdv_61);
    goto L29;
  ...
  anon68_Else:
    ...
    call {:si_unique_call 126} sdv_64 := sdv_RunIoCompletionRoutines#1(sdv_p_devobj_fdo, Irp, vslice_dummy_var_155, completion);
    goto anon74_Then, anon74_Else;

  anon74_Else:
    assume Irp == SLAM_guard_S_0;
    assume SLAM_guard_S_0 != SLAM_guard_S_0_init;
    call {:si_unique_call 127} SLIC_sdv_RunIoCompletionRoutines_exit(0, completion, sdv_64);
    goto L29;
  ...
  anon60_Else:
    ...
    call {:si_unique_call 128} sdv_62 := sdv_RunIoCompletionRoutines#1(sdv_p_devobj_fdo, Irp, vslice_dummy_var_156, completion);
    goto anon72_Then, anon72_Else;

  anon72_Else:
    assume Irp == SLAM_guard_S_0;
    assume SLAM_guard_S_0 != SLAM_guard_S_0_init;
    call {:si_unique_call 129} SLIC_sdv_RunIoCompletionRoutines_exit(0, completion, sdv_62);
    goto L29;
  ...
  anon64_Else:
    ...
    call {:si_unique_call 130} sdv_63 := sdv_RunIoCompletionRoutines#1(sdv_p_devobj_fdo, Irp, vslice_dummy_var_157, completion);
    goto anon71_Then, anon71_Else;

  anon71_Else:
    assume Irp == SLAM_guard_S_0;
    assume SLAM_guard_S_0 != SLAM_guard_S_0_init;
    call {:si_unique_call 131} SLIC_sdv_RunIoCompletionRoutines_exit(0, completion, sdv_63);
    goto L29;
...
implementation {:origName "sdv_IoSetCompletionRoutine"} {:osmodel} sdv_IoSetCompletionRoutine(actual_pirp_5: int, actual_CompletionRoutine: int, actual_Context_1: int, actual_InvokeOnSuccess: int, actual_InvokeOnError: int, actual_InvokeOnCancel: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 133} irpSp := sdv_IoGetNextIrpStackLocation(pirp_5);
...
implementation {:origName "PoStartNextPowerIrp"} {:osmodel} PoStartNextPowerIrp(actual_Irp_1: int)
{
  ...
  anon0:
    call {:si_unique_call 135} vslice_dummy_var_32 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "IoDeleteDevice"} {:osmodel} IoDeleteDevice(actual_DeviceObject_2: int)
{
  ...
  anon0:
    call {:si_unique_call 136} vslice_dummy_var_33 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "IoStartPacket"} {:osmodel} IoStartPacket(actual_DeviceObject_3: int, actual_Irp_2: int, actual_Key: int, actual_CancelFunction: int)
{
  ...
  anon0:
    call {:si_unique_call 137} vslice_dummy_var_34 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "main"} {:osmodel} main() returns (Tmp_189: int, dup_assertVar: bool)
{
  ...
  anon0:
    dup_assertVar := true;
    assume alloc > 0;
    call {:si_unique_call 138} WHEA_ERROR_PACKET_SECTION_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume WHEA_ERROR_PACKET_SECTION_GUID__Loc == WHEA_ERROR_PACKET_SECTION_GUID;
    assume WHEA_ERROR_PACKET_SECTION_GUID != 0;
    call {:si_unique_call 139} sdv_harnessStackLocation_next__Loc := __HAVOC_malloc_or_null(496);
    assume sdv_harnessStackLocation_next__Loc == sdv_harnessStackLocation_next;
    assume sdv_harnessStackLocation_next != 0;
    call {:si_unique_call 140} sdv_IoReadPartitionTableEx_DRIVE_LAYOUT_INFORMATION_EX__Loc := __HAVOC_malloc_or_null(76);
    assume sdv_IoReadPartitionTableEx_DRIVE_LAYOUT_INFORMATION_EX__Loc == sdv_IoReadPartitionTableEx_DRIVE_LAYOUT_INFORMATION_EX;
    assume sdv_IoReadPartitionTableEx_DRIVE_LAYOUT_INFORMATION_EX != 0;
    call {:si_unique_call 141} sdv_IoBuildAsynchronousFsdRequest_harnessIrp__Loc := __HAVOC_malloc_or_null(248);
    assume sdv_IoBuildAsynchronousFsdRequest_harnessIrp__Loc == sdv_IoBuildAsynchronousFsdRequest_harnessIrp;
    assume sdv_IoBuildAsynchronousFsdRequest_harnessIrp != 0;
    call {:si_unique_call 142} sdv_IoGetDeviceToVerify_DEVICE_OBJECT__Loc := __HAVOC_malloc_or_null(320);
    assume sdv_IoGetDeviceToVerify_DEVICE_OBJECT__Loc == sdv_IoGetDeviceToVerify_DEVICE_OBJECT;
    assume sdv_IoGetDeviceToVerify_DEVICE_OBJECT != 0;
    call {:si_unique_call 143} sdv_IoBuildDeviceIoControlRequest_harnessStackLocation_next__Loc := __HAVOC_malloc_or_null(496);
    assume sdv_IoBuildDeviceIoControlRequest_harnessStackLocation_next__Loc == sdv_IoBuildDeviceIoControlRequest_harnessStackLocation_next;
    assume sdv_IoBuildDeviceIoControlRequest_harnessStackLocation_next != 0;
    call {:si_unique_call 144} sdv_harness_IoBuildSynchronousFsdRequest_IoStatusBlock__Loc := __HAVOC_malloc_or_null(12);
    assume sdv_harness_IoBuildSynchronousFsdRequest_IoStatusBlock__Loc == sdv_harness_IoBuildSynchronousFsdRequest_IoStatusBlock;
    assume sdv_harness_IoBuildSynchronousFsdRequest_IoStatusBlock != 0;
    call {:si_unique_call 145} sdv_ControllerIrp__Loc := __HAVOC_malloc_or_null(248);
    assume sdv_ControllerIrp__Loc == sdv_ControllerIrp;
    assume sdv_ControllerIrp != 0;
    call {:si_unique_call 146} sdv_devobj_pdo__Loc := __HAVOC_malloc_or_null(320);
    assume sdv_devobj_pdo__Loc == sdv_devobj_pdo;
    assume sdv_devobj_pdo != 0;
    call {:si_unique_call 147} sdv_IoGetDmaAdapter_DMA_ADAPTER__Loc := __HAVOC_malloc_or_null(12);
    assume sdv_IoGetDmaAdapter_DMA_ADAPTER__Loc == sdv_IoGetDmaAdapter_DMA_ADAPTER;
    assume sdv_IoGetDmaAdapter_DMA_ADAPTER != 0;
    call {:si_unique_call 148} sdv_IoInitializeIrp_harnessIrp__Loc := __HAVOC_malloc_or_null(248);
    assume sdv_IoInitializeIrp_harnessIrp__Loc == sdv_IoInitializeIrp_harnessIrp;
    assume sdv_IoInitializeIrp_harnessIrp != 0;
    call {:si_unique_call 149} sdv_IoGetRelatedDeviceObject_DEVICE_OBJECT__Loc := __HAVOC_malloc_or_null(320);
    assume sdv_IoGetRelatedDeviceObject_DEVICE_OBJECT__Loc == sdv_IoGetRelatedDeviceObject_DEVICE_OBJECT;
    assume sdv_IoGetRelatedDeviceObject_DEVICE_OBJECT != 0;
    call {:si_unique_call 150} sdv_IoBuildSynchronousFsdRequest_harnessStackLocation_next__Loc := __HAVOC_malloc_or_null(496);
    assume sdv_IoBuildSynchronousFsdRequest_harnessStackLocation_next__Loc == sdv_IoBuildSynchronousFsdRequest_harnessStackLocation_next;
    assume sdv_IoBuildSynchronousFsdRequest_harnessStackLocation_next != 0;
    call {:si_unique_call 151} sdv_IoCreateSynchronizationEvent_KEVENT__Loc := __HAVOC_malloc_or_null(124);
    assume sdv_IoCreateSynchronizationEvent_KEVENT__Loc == sdv_IoCreateSynchronizationEvent_KEVENT;
    assume sdv_IoCreateSynchronizationEvent_KEVENT != 0;
    call {:si_unique_call 152} sdv_other_harnessStackLocation_next__Loc := __HAVOC_malloc_or_null(496);
    assume sdv_other_harnessStackLocation_next__Loc == sdv_other_harnessStackLocation_next;
    assume sdv_other_harnessStackLocation_next != 0;
    call {:si_unique_call 153} sdv_harnessStackLocation__Loc := __HAVOC_malloc_or_null(496);
    assume sdv_harnessStackLocation__Loc == sdv_harnessStackLocation;
    assume sdv_harnessStackLocation != 0;
    call {:si_unique_call 154} sdv_IoCreateController_CONTROLLER_OBJECT__Loc := __HAVOC_malloc_or_null(60);
    assume sdv_IoCreateController_CONTROLLER_OBJECT__Loc == sdv_IoCreateController_CONTROLLER_OBJECT;
    assume sdv_IoCreateController_CONTROLLER_OBJECT != 0;
    call {:si_unique_call 155} sdv_devobj_top__Loc := __HAVOC_malloc_or_null(320);
    assume sdv_devobj_top__Loc == sdv_devobj_top;
    assume sdv_devobj_top != 0;
    call {:si_unique_call 156} sdv_kdpc_val3__Loc := __HAVOC_malloc_or_null(40);
    assume sdv_kdpc_val3__Loc == sdv_kdpc_val3;
    assume sdv_kdpc_val3 != 0;
    call {:si_unique_call 157} sdv_IoBuildSynchronousFsdRequest_harnessIrp__Loc := __HAVOC_malloc_or_null(248);
    assume sdv_IoBuildSynchronousFsdRequest_harnessIrp__Loc == sdv_IoBuildSynchronousFsdRequest_harnessIrp;
    assume sdv_IoBuildSynchronousFsdRequest_harnessIrp != 0;
    call {:si_unique_call 158} sdv_IoGetDeviceObjectPointer_DEVICE_OBJECT__Loc := __HAVOC_malloc_or_null(320);
    assume sdv_IoGetDeviceObjectPointer_DEVICE_OBJECT__Loc == sdv_IoGetDeviceObjectPointer_DEVICE_OBJECT;
    assume sdv_IoGetDeviceObjectPointer_DEVICE_OBJECT != 0;
    call {:si_unique_call 159} sdv_MapRegisterBase_val__Loc := __HAVOC_malloc_or_null(4);
    assume sdv_MapRegisterBase_val__Loc == sdv_MapRegisterBase_val;
    assume sdv_MapRegisterBase_val != 0;
    call {:si_unique_call 160} sdv_IoGetFileObjectGenericMapping_GENERIC_MAPPING__Loc := __HAVOC_malloc_or_null(16);
    assume sdv_IoGetFileObjectGenericMapping_GENERIC_MAPPING__Loc == sdv_IoGetFileObjectGenericMapping_GENERIC_MAPPING;
    assume sdv_IoGetFileObjectGenericMapping_GENERIC_MAPPING != 0;
    call {:si_unique_call 161} sdv_IoMakeAssociatedIrp_harnessIrp__Loc := __HAVOC_malloc_or_null(248);
    assume sdv_IoMakeAssociatedIrp_harnessIrp__Loc == sdv_IoMakeAssociatedIrp_harnessIrp;
    assume sdv_IoMakeAssociatedIrp_harnessIrp != 0;
    call {:si_unique_call 162} sdv_devobj_child_pdo__Loc := __HAVOC_malloc_or_null(320);
    assume sdv_devobj_child_pdo__Loc == sdv_devobj_child_pdo;
    assume sdv_devobj_child_pdo != 0;
    call {:si_unique_call 163} sdv_harnessIrp__Loc := __HAVOC_malloc_or_null(248);
    assume sdv_harnessIrp__Loc == sdv_harnessIrp;
    assume sdv_harnessIrp != 0;
    call {:si_unique_call 164} sdv_IoBuildAsynchronousFsdRequest_harnessStackLocation_next__Loc := __HAVOC_malloc_or_null(496);
    assume sdv_IoBuildAsynchronousFsdRequest_harnessStackLocation_next__Loc == sdv_IoBuildAsynchronousFsdRequest_harnessStackLocation_next;
    assume sdv_IoBuildAsynchronousFsdRequest_harnessStackLocation_next != 0;
    call {:si_unique_call 165} sdv_harness_IoBuildDeviceIoControlRequest_IoStatusBlock__Loc := __HAVOC_malloc_or_null(12);
    assume sdv_harness_IoBuildDeviceIoControlRequest_IoStatusBlock__Loc == sdv_harness_IoBuildDeviceIoControlRequest_IoStatusBlock;
    assume sdv_harness_IoBuildDeviceIoControlRequest_IoStatusBlock != 0;
    call {:si_unique_call 166} sdv_kinterrupt_val__Loc := __HAVOC_malloc_or_null(0);
    assume sdv_kinterrupt_val__Loc == sdv_kinterrupt_val;
    assume sdv_kinterrupt_val != 0;
    call {:si_unique_call 167} sdv_devobj_fdo__Loc := __HAVOC_malloc_or_null(320);
    assume sdv_devobj_fdo__Loc == sdv_devobj_fdo;
    assume sdv_devobj_fdo != 0;
    call {:si_unique_call 168} sdv_StartIoIrp__Loc := __HAVOC_malloc_or_null(248);
    assume sdv_StartIoIrp__Loc == sdv_StartIoIrp;
    assume sdv_StartIoIrp != 0;
    call {:si_unique_call 169} sdv_harness_IoBuildAsynchronousFsdRequest_IoStatusBlock__Loc := __HAVOC_malloc_or_null(12);
    assume sdv_harness_IoBuildAsynchronousFsdRequest_IoStatusBlock__Loc == sdv_harness_IoBuildAsynchronousFsdRequest_IoStatusBlock;
    assume sdv_harness_IoBuildAsynchronousFsdRequest_IoStatusBlock != 0;
    call {:si_unique_call 170} sdv_PowerIrp__Loc := __HAVOC_malloc_or_null(248);
    assume sdv_PowerIrp__Loc == sdv_PowerIrp;
    assume sdv_PowerIrp != 0;
    call {:si_unique_call 171} sdv_IoBuildDeviceIoControlRequest_harnessIrp__Loc := __HAVOC_malloc_or_null(248);
    assume sdv_IoBuildDeviceIoControlRequest_harnessIrp__Loc == sdv_IoBuildDeviceIoControlRequest_harnessIrp;
    assume sdv_IoBuildDeviceIoControlRequest_harnessIrp != 0;
    call {:si_unique_call 172} sdv_other_harnessIrp__Loc := __HAVOC_malloc_or_null(248);
    assume sdv_other_harnessIrp__Loc == sdv_other_harnessIrp;
    assume sdv_other_harnessIrp != 0;
    call {:si_unique_call 173} sdv_IoCreateNotificationEvent_KEVENT__Loc := __HAVOC_malloc_or_null(124);
    assume sdv_IoCreateNotificationEvent_KEVENT__Loc == sdv_IoCreateNotificationEvent_KEVENT;
    assume sdv_IoCreateNotificationEvent_KEVENT != 0;
    call {:si_unique_call 174} sdv_other_harnessStackLocation__Loc := __HAVOC_malloc_or_null(496);
    assume sdv_other_harnessStackLocation__Loc == sdv_other_harnessStackLocation;
    assume sdv_other_harnessStackLocation != 0;
    call {:si_unique_call 175} SLAM_guard_S_0_init__Loc := __HAVOC_malloc_or_null(248);
    assume SLAM_guard_S_0_init__Loc == SLAM_guard_S_0_init;
    assume SLAM_guard_S_0_init != 0;
    call {:si_unique_call 176} KeTickCount__Loc := __HAVOC_malloc_or_null(12);
    ...
    call {:si_unique_call 188} boogieTmp := __HAVOC_malloc_or_null(248);
    ...
    call {:si_unique_call 199} vslice_dummy_var_104 := __HAVOC_malloc(4);
    call {:si_unique_call 200} vslice_dummy_var_158 := __HAVOC_malloc(28);
    call {:si_unique_call 201} vslice_dummy_var_105 := __HAVOC_malloc(4);
    call {:si_unique_call 202} vslice_dummy_var_106 := __HAVOC_malloc(4);
    call {:si_unique_call 203} vslice_dummy_var_107 := __HAVOC_malloc(4);
    call {:si_unique_call 204} vslice_dummy_var_108 := __HAVOC_malloc(4);
    call {:si_unique_call 205} vslice_dummy_var_159 := __HAVOC_malloc(12);
    call {:si_unique_call 206} vslice_dummy_var_109 := __HAVOC_malloc(4);
    call {:si_unique_call 207} vslice_dummy_var_160 := __HAVOC_malloc(28);
    call {:si_unique_call 208} vslice_dummy_var_110 := __HAVOC_malloc(4);
    call {:si_unique_call 209} vslice_dummy_var_111 := __HAVOC_malloc(4);
    call {:si_unique_call 210} vslice_dummy_var_112 := __HAVOC_malloc(4);
    call {:si_unique_call 211} vslice_dummy_var_113 := __HAVOC_malloc(4);
    call {:si_unique_call 212} vslice_dummy_var_161 := __HAVOC_malloc(12);
    call {:si_unique_call 213} vslice_dummy_var_114 := __HAVOC_malloc(4);
    call {:si_unique_call 214} vslice_dummy_var_162 := __HAVOC_malloc(28);
    call {:si_unique_call 215} vslice_dummy_var_115 := __HAVOC_malloc(4);
    call {:si_unique_call 216} vslice_dummy_var_116 := __HAVOC_malloc(4);
    call {:si_unique_call 217} vslice_dummy_var_117 := __HAVOC_malloc(4);
    call {:si_unique_call 218} vslice_dummy_var_118 := __HAVOC_malloc(4);
    call {:si_unique_call 219} vslice_dummy_var_163 := __HAVOC_malloc(12);
    call {:si_unique_call 220} vslice_dummy_var_119 := __HAVOC_malloc(4);
    call {:si_unique_call 221} vslice_dummy_var_120 := __HAVOC_malloc(4);
    call {:si_unique_call 222} vslice_dummy_var_121 := __HAVOC_malloc(4);
    call {:si_unique_call 223} vslice_dummy_var_122 := __HAVOC_malloc(4);
    call {:si_unique_call 224} vslice_dummy_var_123 := __HAVOC_malloc(4);
    call {:si_unique_call 225} vslice_dummy_var_124 := __HAVOC_malloc(4);
    call {:si_unique_call 226} vslice_dummy_var_164 := __HAVOC_malloc(28);
    call {:si_unique_call 227} vslice_dummy_var_125 := __HAVOC_malloc(4);
    call {:si_unique_call 228} vslice_dummy_var_126 := __HAVOC_malloc(4);
    call {:si_unique_call 229} vslice_dummy_var_127 := __HAVOC_malloc(4);
    call {:si_unique_call 230} vslice_dummy_var_128 := __HAVOC_malloc(4);
    call {:si_unique_call 231} vslice_dummy_var_165 := __HAVOC_malloc(12);
    call {:si_unique_call 232} vslice_dummy_var_129 := __HAVOC_malloc(4);
    call {:si_unique_call 233} vslice_dummy_var_166 := __HAVOC_malloc(28);
    call {:si_unique_call 234} vslice_dummy_var_130 := __HAVOC_malloc(4);
    call {:si_unique_call 235} vslice_dummy_var_131 := __HAVOC_malloc(4);
    call {:si_unique_call 236} vslice_dummy_var_132 := __HAVOC_malloc(4);
    call {:si_unique_call 237} vslice_dummy_var_133 := __HAVOC_malloc(4);
    call {:si_unique_call 238} vslice_dummy_var_167 := __HAVOC_malloc(12);
    call {:si_unique_call 239} vslice_dummy_var_134 := __HAVOC_malloc(4);
    call {:si_unique_call 240} vslice_dummy_var_168 := __HAVOC_malloc(28);
    call {:si_unique_call 241} vslice_dummy_var_135 := __HAVOC_malloc(4);
    call {:si_unique_call 242} vslice_dummy_var_136 := __HAVOC_malloc(4);
    call {:si_unique_call 243} vslice_dummy_var_137 := __HAVOC_malloc(4);
    call {:si_unique_call 244} vslice_dummy_var_138 := __HAVOC_malloc(4);
    call {:si_unique_call 245} vslice_dummy_var_169 := __HAVOC_malloc(12);
    call {:si_unique_call 246} vslice_dummy_var_139 := __HAVOC_malloc(4);
    call {:si_unique_call 247} vslice_dummy_var_170 := __HAVOC_malloc(28);
    call {:si_unique_call 248} vslice_dummy_var_140 := __HAVOC_malloc(4);
    call {:si_unique_call 249} vslice_dummy_var_141 := __HAVOC_malloc(4);
    call {:si_unique_call 250} vslice_dummy_var_142 := __HAVOC_malloc(4);
    call {:si_unique_call 251} vslice_dummy_var_143 := __HAVOC_malloc(4);
    call {:si_unique_call 252} vslice_dummy_var_171 := __HAVOC_malloc(12);
    call {:si_unique_call 253} vslice_dummy_var_144 := __HAVOC_malloc(4);
    call {:si_unique_call 254} vslice_dummy_var_172 := __HAVOC_malloc(28);
    call {:si_unique_call 255} vslice_dummy_var_145 := __HAVOC_malloc(4);
    call {:si_unique_call 256} vslice_dummy_var_146 := __HAVOC_malloc(4);
    call {:si_unique_call 257} vslice_dummy_var_147 := __HAVOC_malloc(4);
    call {:si_unique_call 258} vslice_dummy_var_148 := __HAVOC_malloc(4);
    call {:si_unique_call 259} vslice_dummy_var_173 := __HAVOC_malloc(12);
    assume {:mainInitDone} true;
    call {:si_unique_call 260} corralExtraInit();
    call {:si_unique_call 261} corralExplainErrorInit();
    call {:si_unique_call 262} _sdv_init11();
    call {:si_unique_call 263} _sdv_init1();
    call {:si_unique_call 264} _sdv_init4();
    call {:si_unique_call 265} _sdv_init5();
    call {:si_unique_call 266} _sdv_init3();
    call {:si_unique_call 267} _sdv_init6();
    call {:si_unique_call 268} _sdv_init9();
    call {:si_unique_call 269} _sdv_init7();
    call {:si_unique_call 270} _sdv_init8();
    call {:si_unique_call 271} _sdv_init2();
    goto anon9_Then, anon9_Else;
  ...
  L38:
    ...
    call {:si_unique_call 272} sdv_main();
    goto anon12_Then, anon12_Else;
...
implementation {:origName "sdv_IoSkipCurrentIrpStackLocation"} {:osmodel} sdv_IoSkipCurrentIrpStackLocation(actual_pirp_7: int)
{
  ...
  anon0:
    call {:si_unique_call 273} vslice_dummy_var_35 := __HAVOC_malloc(4);
...
implementation {:origName "RtlInitUnicodeString"} {:osmodel} RtlInitUnicodeString(actual_DestinationString: int, actual_SourceString: int)
{
  ...
  anon0:
    call {:si_unique_call 274} vslice_dummy_var_36 := __HAVOC_malloc(4);
...
implementation {:origName "sdv_RtlZeroMemory"} {:osmodel} sdv_RtlZeroMemory(actual_Destination: int, actual_Length: int)
{
  ...
  anon0:
    call {:si_unique_call 275} vslice_dummy_var_37 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "sdv_KeFlushIoBuffers"} {:osmodel} sdv_KeFlushIoBuffers(actual_Mdl_1: int, actual_ReadOperation: int, actual_DmaOperation: int)
{
  ...
  anon0:
    call {:si_unique_call 276} vslice_dummy_var_38 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "sdv_do_paged_code_check"} {:osmodel} sdv_do_paged_code_check()
{
  ...
  anon0:
    call {:si_unique_call 277} vslice_dummy_var_39 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "sdv_KeLowerIrql"} {:osmodel} sdv_KeLowerIrql(actual_NewIrql: int)
{
  ...
  anon0:
    call {:si_unique_call 278} vslice_dummy_var_40 := __HAVOC_malloc(4);
...
implementation {:origName "sdv_IoMarkIrpPending"} {:osmodel} sdv_IoMarkIrpPending(actual_pirp_8: int)
{
  ...
  anon0:
    call {:si_unique_call 279} vslice_dummy_var_41 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "sdv_RunDispatchFunction"} {:osmodel} sdv_RunDispatchFunction(actual_po: int, actual_pirp_9: int) returns (Tmp_209: int)
{
  ...
  anon0:
    ...
    assume {:nonnull} pirp_9 != 0;
    assume pirp_9 > 0;
    call {:si_unique_call 280} sdv_SetStatus(pirp_9);
    assume {:nonnull} pirp_9 != 0;
    assume pirp_9 > 0;
    assume {:nonnull} pirp_9 != 0;
    assume pirp_9 > 0;
    ...
    call {:si_unique_call 281} sdv_stub_dispatch_begin();
    goto anon59_Then, anon59_Else;
  ...
  L66:
    call {:si_unique_call 282} status_1 := PpaPnpDeviceControl(po, pirp_9);
  ...
  L72:
    call {:si_unique_call 283} sdv_stub_dispatch_end(status_1, 0);
    assume {:nonnull} pirp_9 != 0;
    assume pirp_9 > 0;
    Tmp_209 := status_1;
    goto LM2;
  ...
  anon64_Then:
    call {:si_unique_call 284} status_1 := sdv_DoNothing();
    goto L72;

  anon65_Then:
    assume {:nonnull} ps != 0;
    assume ps > 0;
    call {:si_unique_call 285} status_1 := PpaSystemControl(po, pirp_9);
  ...
  anon66_Then:
    assume {:nonnull} ps != 0;
    assume ps > 0;
    call {:si_unique_call 286} sdv_SetPowerIrpMinorFunction(pirp_9);
    call {:si_unique_call 287} status_1 := PpaPowerControl(po, pirp_9);
  ...
  anon67_Then:
    assume {:nonnull} ps != 0;
    assume ps > 0;
    call {:si_unique_call 288} status_1 := PpaCreateCleanupClose(po, pirp_9);
  ...
  anon68_Then:
    call {:si_unique_call 289} status_1 := sdv_DoNothing();
    goto L72;

  anon69_Then:
    assume {:nonnull} ps != 0;
    assume ps > 0;
    call {:si_unique_call 290} status_1 := sdv_DoNothing();
    goto L72;

  anon70_Then:
    assume {:nonnull} ps != 0;
    assume ps > 0;
    call {:si_unique_call 291} status_1 := PpaScsiRequests(po, pirp_9);
  ...
  anon71_Then:
    assume {:nonnull} ps != 0;
    assume ps > 0;
    call {:si_unique_call 292} status_1 := PpaDeviceControl(po, pirp_9);
  ...
  anon76_Then:
    assume {:nonnull} ps != 0;
    assume ps > 0;
    call {:si_unique_call 297} status_1 := sdv_DoNothing();
    goto L72;

  anon77_Then:
    assume {:nonnull} ps != 0;
    assume ps > 0;
    call {:si_unique_call 298} status_1 := sdv_DoNothing();
    goto L72;

  anon78_Then:
    assume {:nonnull} ps != 0;
    assume ps > 0;
    call {:si_unique_call 299} status_1 := PpaCreateCleanupClose(po, pirp_9);
  ...
  anon59_Then:
    assume {:nonnull} ps != 0;
    assume ps > 0;
    call {:si_unique_call 300} status_1 := PpaCreateCleanupClose(po, pirp_9);
...
implementation {:origName "RtlFreeUnicodeString"} {:osmodel} RtlFreeUnicodeString(actual_UnicodeString: int)
{
  ...
  anon0:
    call {:si_unique_call 301} vslice_dummy_var_42 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "sdv_KeReleaseSpinLock"} {:osmodel} sdv_KeReleaseSpinLock(actual_SpinLock_1: int, actual_new: int)
{
  ...
  anon0:
    call {:si_unique_call 302} vslice_dummy_var_43 := __HAVOC_malloc(4);
    new := actual_new;
    return;
}
...
implementation {:origName "IoReuseIrp"} {:osmodel} IoReuseIrp(actual_Irp_4: int, actual_Status_12: int)
{
  ...
  anon0:
    call {:si_unique_call 303} vslice_dummy_var_44 := __HAVOC_malloc(4);
    Irp_4 := actual_Irp_4;
...
implementation {:origName "sdv_IoCompleteRequest"} {:osmodel} sdv_IoCompleteRequest(actual_pirp_10: int, actual_PriorityBoost: int)
{
  ...
  anon0:
    call {:si_unique_call 304} vslice_dummy_var_45 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "sdv_RtlCopyMemory"} {:osmodel} sdv_RtlCopyMemory(actual_Destination_1: int, actual_Source: int, actual_Length_2: int)
{
  ...
  anon0:
    call {:si_unique_call 305} vslice_dummy_var_46 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "IoStopTimer"} {:osmodel} IoStopTimer(actual_DeviceObject_5: int)
{
  ...
  anon0:
    call {:si_unique_call 306} vslice_dummy_var_47 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "sdv_ExFreePool"} {:osmodel} sdv_ExFreePool(actual_P: int)
{
  ...
  anon0:
    call {:si_unique_call 307} vslice_dummy_var_48 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "IoAllocateIrp"} {:osmodel} IoAllocateIrp(actual_StackSize: int, actual_ChargeQuota: int) returns (Tmp_234: int)
{
  ...
  anon3_Else:
    assume {:nonnull} sdv_other_irp != 0;
    assume sdv_other_irp > 0;
    call {:si_unique_call 308} irpSp_1 := sdv_IoGetNextIrpStackLocation(sdv_other_irp);
...
implementation {:origName "IoFreeIrp"} {:osmodel} IoFreeIrp(actual_pirp_11: int)
{
  ...
  anon0:
    call {:si_unique_call 310} vslice_dummy_var_50 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "ExAllocatePoolWithTag"} {:osmodel} ExAllocatePoolWithTag(actual_PoolType: int, actual_NumberOfBytes: int, actual_Tag_2: int) returns (Tmp_250: int)
{
  ...
  anon3_Else:
    call {:si_unique_call 311} sdv_104 := __HAVOC_malloc(NumberOfBytes);
    Tmp_250 := sdv_104;
    goto L1;
...
implementation {:origName "sdv_stub_driver_init"} {:osmodel} sdv_stub_driver_init()
{
  ...
  anon0:
    call {:si_unique_call 312} vslice_dummy_var_51 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "sdv_stub_dispatch_begin"} {:osmodel} sdv_stub_dispatch_begin()
{
  ...
  anon0:
    call {:si_unique_call 313} vslice_dummy_var_52 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "IoStartTimer"} {:osmodel} IoStartTimer(actual_DeviceObject_11: int)
{
  ...
  anon0:
    call {:si_unique_call 314} vslice_dummy_var_53 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "SLIC_PpaPnpDeviceControl_exit"} {:osmodel} SLIC_PpaPnpDeviceControl_exit(actual_caller_1: int, actual_PpaPnpDeviceControl_1: int)
{
  ...
  anon8_Else:
    ...
    call {:si_unique_call 315} SLIC_ABORT_13_0(caller_1, PpaPnpDeviceControl_1);
    goto anon9_Then, anon9_Else;
...
implementation {:origName "SLIC_PpaDeviceControl_exit"} {:osmodel} SLIC_PpaDeviceControl_exit(actual_caller_2: int, actual_PpaDeviceControl_1: int)
{
  ...
  anon8_Else:
    ...
    call {:si_unique_call 316} SLIC_ABORT_19_0(caller_2, PpaDeviceControl_1);
    goto anon9_Then, anon9_Else;
...
implementation {:origName "SLIC_ABORT_19_0"} SLIC_ABORT_19_0(actual_caller_9: int, actual_PpaDeviceControl_2: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 317} SLIC_ERROR_ROUTINE(strConst__li2bpl9);
    return;
}
...
implementation {:origName "SLIC_sdv_IoCompleteRequest_entry"} {:osmodel} SLIC_sdv_IoCompleteRequest_entry(actual_caller_10: int)
{
  ...
  anon5_Then:
    assume {:partition} s == 1;
    call {:si_unique_call 319} SLIC_ABORT_6_0(caller_10);
    goto anon6_Then, anon6_Else;
...
implementation {:origName "SLIC_ABORT_15_0"} SLIC_ABORT_15_0(actual_caller_11: int, actual_PpaSystemControl_1: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 320} SLIC_ERROR_ROUTINE(strConst__li2bpl9);
    return;
}



procedure {:origName "SLIC_sdv_RunIoCompletionRoutines_exit"} {:osmodel} SLIC_sdv_RunIoCompletionRoutines_exit(actual_caller_12: int, actual_sdv_110: int, actual_sdv_111: int);
  modifies s;
...
implementation {:origName "SLIC_sdv_RunIoCompletionRoutines_exit"} {:osmodel} SLIC_sdv_RunIoCompletionRoutines_exit(actual_caller_12: int, actual_sdv_110: int, actual_sdv_111: int)
{
  ...
  anon7_Else:
    assume {:partition} sdv_111 != -1073741802;
    s := 1;
    goto L2;
  ...
  anon9_Then:
    call {:si_unique_call 321} SLIC_EXIT_ROUTINE(strConst__li2bpl10);
    goto L2;
...
implementation {:origName "SLIC_PpaSystemControl_exit"} {:osmodel} SLIC_PpaSystemControl_exit(actual_caller_13: int, actual_PpaSystemControl_2: int)
{
  ...
  anon8_Else:
    ...
    call {:si_unique_call 322} SLIC_ABORT_15_0(caller_13, PpaSystemControl_2);
    goto anon9_Then, anon9_Else;
...
implementation {:origName "SLIC_ABORT_11_0"} SLIC_ABORT_11_0(actual_caller_14: int, actual_PpaPowerControl_1: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 323} SLIC_ERROR_ROUTINE(strConst__li2bpl9);
    return;
}
...
implementation {:origName "SLIC_ABORT_17_0"} SLIC_ABORT_17_0(actual_caller_15: int, actual_PpaScsiRequests_1: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 324} SLIC_ERROR_ROUTINE(strConst__li2bpl9);
    return;
}
...
implementation {:origName "SLIC_ABORT_6_0"} SLIC_ABORT_6_0(actual_caller_18: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 325} SLIC_ERROR_ROUTINE(strConst__li2bpl11);
    return;
}
...
implementation {:origName "SLIC_PpaCreateCleanupClose_exit"} {:osmodel} SLIC_PpaCreateCleanupClose_exit(actual_caller_19: int, actual_PpaCreateCleanupClose_1: int)
{
  ...
  anon8_Else:
    ...
    call {:si_unique_call 326} SLIC_ABORT_21_0(caller_19, PpaCreateCleanupClose_1);
    goto anon9_Then, anon9_Else;
...
implementation {:origName "SLIC_PpaPowerControl_exit"} {:osmodel} SLIC_PpaPowerControl_exit(actual_caller_22: int, actual_PpaPowerControl_2: int)
{
  ...
  anon8_Else:
    ...
    call {:si_unique_call 327} SLIC_ABORT_11_0(caller_22, PpaPowerControl_2);
    goto anon9_Then, anon9_Else;
...
implementation {:origName "SLIC_PpaScsiRequests_exit"} {:osmodel} SLIC_PpaScsiRequests_exit(actual_caller_23: int, actual_PpaScsiRequests_2: int)
{
  ...
  anon8_Else:
    ...
    call {:si_unique_call 328} SLIC_ABORT_17_0(caller_23, PpaScsiRequests_2);
    goto anon9_Then, anon9_Else;
...
implementation {:origName "SLIC_ABORT_21_0"} SLIC_ABORT_21_0(actual_caller_25: int, actual_PpaCreateCleanupClose_2: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 329} SLIC_ERROR_ROUTINE(strConst__li2bpl9);
    return;
}
...
implementation {:origName "SLIC_ABORT_13_0"} SLIC_ABORT_13_0(actual_caller_26: int, actual_PpaPnpDeviceControl_2: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 330} SLIC_ERROR_ROUTINE(strConst__li2bpl9);
    return;
}
...
implementation {:origName "sdv_IoReleaseRemoveLock"} sdv_IoReleaseRemoveLock(actual_sdv_117: int, actual_sdv_118: int) returns (Tmp_268: int)
{
  ...
  anon0:
    call {:si_unique_call 331} Tmp_268 := __HAVOC_malloc(4);
    call {:si_unique_call 332} sdv_119 := __HAVOC_malloc(4);
...
implementation {:origName "PpaCommand"} PpaCommand(actual_Extension_17: int) returns (Tmp_278: int)
{
  ...
  anon3_Then:
    call {:si_unique_call 333} success_6 := VPI0Command(Extension_17);
    Tmp_278 := success_6;
    goto L1;
}
...
implementation {:origName "PpaPortLock"} PpaPortLock(actual_Extension_18: int, actual_Wait_1: int, actual_pDeviceObject: int)
{
  ...
  anon0:
    call {:si_unique_call 334} Event_4 := __HAVOC_malloc(124);
    call {:si_unique_call 335} vslice_dummy_var_54 := __HAVOC_malloc(4);
  ...
  anon13_Else:
    call {:si_unique_call 336} status_3 := sdv_IoAcquireRemoveLock(0, 0);
    goto anon14_Then, anon14_Else;

  anon14_Else:
    assume {:partition} status_3 >= 0;
    call {:si_unique_call 337} PpaInitializeLockIrp(Extension_18);
    goto anon15_Then, anon15_Else;

  anon15_Else:
    assume {:partition} Wait_1 != 0;
    call {:si_unique_call 338} KeInitializeEvent(Event_4, 0, 0);
    assume {:nonnull} Extension_18 != 0;
    assume Extension_18 > 0;
    havoc vslice_dummy_var_174;
    call {:si_unique_call 339} sdv_IoSetCompletionRoutine(vslice_dummy_var_174, li2bplFunctionConstant134, Event_4, 1, 1, 1);
    goto L26;
  ...
  L26:
    ...
    call {:si_unique_call 340} status_3 := sdv_IoCallDriver#1(vslice_dummy_var_175, vslice_dummy_var_176);
    goto anon16_Then, anon16_Else;
  ...
  anon17_Else:
    ...
    call {:si_unique_call 341} vslice_dummy_var_55 := KeWaitForSingleObject(0, 0, 0, 0, 0);
    goto L33;
  ...
  L37:
    assume {:nonnull} Extension_18 != 0;
    assume Extension_18 > 0;
    call {:si_unique_call 342} vslice_dummy_var_56 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(Extension_18), Extension_18);
    goto L1;
  ...
  anon15_Then:
    ...
    call {:si_unique_call 343} sdv_IoSetCompletionRoutine(vslice_dummy_var_177, li2bplFunctionConstant199, pDeviceObject, 1, 1, 1);
    goto L26;
...
implementation {:origName "PpaStatus"} PpaStatus(actual_Extension_20: int) returns (Tmp_286: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 344} Tmp_288 := __HAVOC_malloc(64);
    goto anon21_Then, anon21_Else;
  ...
  anon21_Then:
    call {:si_unique_call 345} endingStatus_1 := VPI0Status(Extension_20);
...
implementation {:origName "_sdv_init6"} _sdv_init6()
{
  ...
  anon0:
    call {:si_unique_call 346} vslice_dummy_var_57 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "PpaStartExecution"} PpaStartExecution(actual_Extension_21: int) returns (Tmp_295: int)
{
  ...
  anon12_Else:
    call {:si_unique_call 347} vslice_dummy_var_59 := PpaResetBus(Extension_21);
    goto L13;
  ...
  anon15_Then:
    call {:si_unique_call 348} vslice_dummy_var_58 := PpaContinueExecution(Extension_21);
    goto L13;
...
implementation {:origName "PpaContinueExecution"} PpaContinueExecution(actual_Extension_22: int) returns (Tmp_300: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 349} Tmp_304 := __HAVOC_malloc(64);
    call {:si_unique_call 350} Tmp_305 := __HAVOC_malloc(64);
    success_7 := 0;
    assume {:nonnull} Extension_22 != 0;
    assume Extension_22 > 0;
    call {:si_unique_call 351} success_7 := VPI0SetupDrive(Extension_22);
    goto anon5_Then, anon5_Else;
  ...
  L13:
    call {:si_unique_call 352} PpaPhaseMan(Extension_22);
    call {:si_unique_call 353} vslice_dummy_var_60 := VPI0RestoreDrive(Extension_22);
    assume {:nonnull} Extension_22 != 0;
    assume Extension_22 > 0;
    Tmp_300 := 0;
    goto L1;
...
implementation {:origName "PpaPhaseMan"} PpaPhaseMan(actual_Extension_23: int)
{
  ...
  anon0:
    call {:si_unique_call 354} vslice_dummy_var_61 := __HAVOC_malloc(4);
  ...
  L8:
    call {:si_unique_call 355} i_6, Tmp_306, sdv_145, sdv_149, sdv_150, sdv_151, sdv_152, sdv_153, Tmp_314, CurrPhase, busBusy, vslice_dummy_var_67 := PpaPhaseMan_loop_L8(i_6, Tmp_306, sdv_145, sdv_149, sdv_150, sdv_151, sdv_152, sdv_153, Tmp_314, CurrPhase, busBusy, Extension_23, vslice_dummy_var_67);
    goto L8_last;
  ...
  anon32_Else:
    call {:si_unique_call 356} sdv_145 := VPI0GetPhase(Extension_23);
    goto anon33_Then, anon33_Else;
  ...
  anon42_Else:
    call {:si_unique_call 357} sdv_153 := PpaStatus(Extension_23);
    goto anon35_Then, anon35_Else;
  ...
  anon35_Then:
    assume {:partition} sdv_153 == 0;
    call {:si_unique_call 358} vslice_dummy_var_62 := PpaResetBus(Extension_23);
    assume {:nonnull} Extension_23 != 0;
    assume Extension_23 > 0;
    havoc Tmp_310;
  ...
  anon42_Then:
    busBusy := 0;
    call {:si_unique_call 359} vslice_dummy_var_67 := PpaResetBus(Extension_23);
    assume {:nonnull} Extension_23 != 0;
    assume Extension_23 > 0;
    havoc Tmp_314;
  ...
  anon43_Then:
    call {:si_unique_call 360} sdv_152 := PpaCommand(Extension_23);
    goto anon36_Then, anon36_Else;

  anon36_Else:
    assume {:partition} sdv_152 == 0;
    call {:si_unique_call 361} vslice_dummy_var_63 := PpaResetBus(Extension_23);
    assume {:nonnull} Extension_23 != 0;
    assume Extension_23 > 0;
    havoc Tmp_312;
  ...
  anon44_Then:
    call {:si_unique_call 362} sdv_151 := PpaDataIn(Extension_23);
    goto anon37_Then, anon37_Else;

  anon37_Else:
    assume {:partition} sdv_151 == 0;
    call {:si_unique_call 363} vslice_dummy_var_64 := PpaResetBus(Extension_23);
    assume {:nonnull} Extension_23 != 0;
    assume Extension_23 > 0;
    havoc Tmp_315;
  ...
  anon34_Then:
    call {:si_unique_call 364} sdv_149 := PpaDataOut(Extension_23);
    goto anon38_Then, anon38_Else;

  anon38_Else:
    assume {:partition} sdv_149 == 0;
    call {:si_unique_call 365} vslice_dummy_var_65 := PpaResetBus(Extension_23);
    assume {:nonnull} Extension_23 != 0;
    assume Extension_23 > 0;
    havoc Tmp_309;
  ...
  L65:
    call {:si_unique_call 366} i_6, sdv_150 := PpaPhaseMan_loop_L65(i_6, sdv_150, CurrPhase, Extension_23);
    goto L65_last;
  ...
  anon45_Else:
    ...
    call {:si_unique_call 367} sdv_150 := VPI0GetPhase(Extension_23);
  ...
  anon39_Else:
    ...
    call {:si_unique_call 368} vslice_dummy_var_66 := PpaResetBus(Extension_23);
    assume {:nonnull} Extension_23 != 0;
    assume Extension_23 > 0;
    havoc Tmp_313;
...
implementation {:origName "PpaDataIn"} PpaDataIn(actual_Extension_24: int) returns (Tmp_316: int)
{
  ...
  anon6_Else:
    call {:si_unique_call 369} success_8 := VPI0DataIn(Extension_24);
    Tmp_316 := success_8;
    goto L1;
...
implementation {:origName "PpaResetBus"} PpaResetBus(actual_Extension_25: int) returns (Tmp_318: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 370} sdv_157 := VPI0ResetBus(Extension_25);
    goto anon3_Then, anon3_Else;
...
implementation {:origName "PpaDataOut"} PpaDataOut(actual_Extension_26: int) returns (Tmp_320: int)
{
  ...
  anon6_Else:
    call {:si_unique_call 371} success_9 := VPI0DataOut(Extension_26);
    Tmp_320 := success_9;
    goto L1;
...
implementation {:origName "PpaGetDeviceInfo"} PpaGetDeviceInfo(actual_Extension_27: int) returns (Tmp_322: int)
{
  ...
  anon0:
    call {:si_unique_call 372} kEvent := __HAVOC_malloc(124);
    call {:si_unique_call 373} ioStatus := __HAVOC_malloc(12);
  ...
  anon7_Then:
    call {:si_unique_call 374} KeInitializeEvent(kEvent, 0, 0);
    call {:si_unique_call 375} Irp_8 := IoBuildDeviceIoControlRequest(1441912, 0, 0, 0, 0, 64, 1, 0, ioStatus);
    goto anon8_Then, anon8_Else;
  ...
  anon8_Else:
    ...
    call {:si_unique_call 376} Status_15 := sdv_IoCallDriver#1(vslice_dummy_var_178, Irp_8);
    goto anon9_Then, anon9_Else;

  anon9_Else:
    assume {:partition} Status_15 == 259;
    call {:si_unique_call 377} vslice_dummy_var_68 := KeWaitForSingleObject(0, 0, 0, 0, 0);
...
implementation {:origName "PpaCloseToParclass"} PpaCloseToParclass(actual_Extension_28: int) returns (Tmp_324: int)
{
  ...
  anon0:
    call {:si_unique_call 378} kEvent_1 := __HAVOC_malloc(124);
    call {:si_unique_call 379} ioStatus_1 := __HAVOC_malloc(12);
    Extension_28 := actual_Extension_28;
    call {:si_unique_call 380} KeInitializeEvent(kEvent_1, 0, 0);
    call {:si_unique_call 381} Irp_9 := IoBuildSynchronousFsdRequest(27, 0, 0, 0, 0, 0, ioStatus_1);
    goto anon5_Then, anon5_Else;

  anon5_Else:
    assume {:partition} Irp_9 != 0;
    call {:si_unique_call 382} pIrpStack := sdv_IoGetNextIrpStackLocation(Irp_9);
    assume {:nonnull} pIrpStack != 0;
    assume pIrpStack > 0;
    assume {:nonnull} Extension_28 != 0;
    assume Extension_28 > 0;
    havoc vslice_dummy_var_179;
    call {:si_unique_call 383} Status_16 := sdv_IoCallDriver#1(vslice_dummy_var_179, Irp_9);
    goto anon6_Then, anon6_Else;

  anon6_Else:
    assume {:partition} Status_16 == 259;
    call {:si_unique_call 384} vslice_dummy_var_69 := KeWaitForSingleObject(0, 0, 0, 0, 0);
...
implementation {:origName "PpaCreateToParclass"} PpaCreateToParclass(actual_Extension_30: int) returns (Tmp_330: int)
{
  ...
  anon0:
    call {:si_unique_call 386} kEvent_2 := __HAVOC_malloc(124);
    call {:si_unique_call 387} ioStatus_2 := __HAVOC_malloc(12);
    Extension_30 := actual_Extension_30;
    call {:si_unique_call 388} KeInitializeEvent(kEvent_2, 0, 0);
    call {:si_unique_call 389} Irp_10 := IoBuildSynchronousFsdRequest(27, 0, 0, 0, 0, 0, ioStatus_2);
    goto anon5_Then, anon5_Else;

  anon5_Else:
    assume {:partition} Irp_10 != 0;
    call {:si_unique_call 390} pIrpStack_1 := sdv_IoGetNextIrpStackLocation(Irp_10);
    ...
    call {:si_unique_call 391} Status_18 := sdv_IoCallDriver#1(vslice_dummy_var_180, Irp_10);
    goto anon6_Then, anon6_Else;

  anon6_Else:
    assume {:partition} Status_18 == 259;
    call {:si_unique_call 392} vslice_dummy_var_71 := KeWaitForSingleObject(0, 0, 0, 0, 0);
...
implementation {:origName "PpaRequestCompletionRoutine"} PpaRequestCompletionRoutine(actual_DeviceObject_12: int, actual_Irp_11: int, actual_EventIn: int) returns (Tmp_332: int)
{
  ...
  anon0:
    ...
    Event_6 := EventIn;
    call {:si_unique_call 393} vslice_dummy_var_72 := KeSetEvent(Event_6, 1, 0);
    Tmp_332 := -1073741802;
    return;
}
...
implementation {:origName "PpaScsiSendPassThrough"} PpaScsiSendPassThrough(actual_Extension_31: int, actual_RequestIrp: int) returns (Tmp_334: int)
{
  ...
  anon0:
    call {:si_unique_call 394} startingOffset := __HAVOC_malloc(20);
    call {:si_unique_call 395} ioStatusBlock := __HAVOC_malloc(12);
    call {:si_unique_call 396} srb := __HAVOC_malloc(92);
    call {:si_unique_call 397} event := __HAVOC_malloc(124);
    Extension_31 := actual_Extension_31;
    RequestIrp := actual_RequestIrp;
    call {:si_unique_call 398} Tmp_340 := __HAVOC_malloc(64);
    call {:si_unique_call 399} Tmp_343 := __HAVOC_malloc(64);
    call {:si_unique_call 400} Tmp_346 := __HAVOC_malloc(64);
    call {:si_unique_call 401} sdv_do_paged_code_check();
    assume {:nonnull} startingOffset != 0;
    assume startingOffset > 0;
    call {:si_unique_call 402} irpStack := sdv_IoGetCurrentIrpStackLocation(RequestIrp);
  ...
  anon125_Else:
    ...
    assume srbControl > 0;
    havoc Tmp_344;
    call {:si_unique_call 403} senseBuffer := ExAllocatePoolWithTag(4, Tmp_344, 863134032);
  ...
  L87:
    call {:si_unique_call 404} KeInitializeEvent(event, 0, 0);
    Tmp_336 := majorCode;
    call {:si_unique_call 405} irp := IoBuildSynchronousFsdRequest(Tmp_336, 0, 0, length, 0, 0, ioStatusBlock);
    goto anon127_Then, anon127_Else;

  anon127_Else:
    assume {:partition} irp != 0;
    call {:si_unique_call 406} irpStack := sdv_IoGetNextIrpStackLocation(irp);
    assume {:nonnull} irpStack != 0;
    assume irpStack > 0;
    assume {:nonnull} irpStack != 0;
    assume irpStack > 0;
  ...
  anon131_Else:
    call {:si_unique_call 408} sdv_KeFlushIoBuffers(0, 0, 1);
    goto L135;
  ...
  L135:
    ...
    assume srbControl > 0;
    havoc Tmp_347;
    call {:si_unique_call 409} sdv_RtlCopyMemory(0, 0, Tmp_347);
  ...
  L146:
    ...
    call {:si_unique_call 410} status_6 := sdv_IoCallDriver#1(vslice_dummy_var_181, irp);
    goto anon133_Then, anon133_Else;

  anon133_Else:
    assume {:partition} status_6 == 259;
    call {:si_unique_call 411} vslice_dummy_var_73 := KeWaitForSingleObject(0, 0, 0, 0, 0);
    goto L151;
  ...
  anon154_Else:
    ...
    assume srb > 0;
    havoc Tmp_339;
    call {:si_unique_call 412} sdv_RtlCopyMemory(0, 0, Tmp_339);
    goto L164;
...
implementation {:origName "PpaCompleteRequest"} PpaCompleteRequest(actual_Extension_32: int, actual_pIrp: int, actual_Status_19: int)
{
  ...
  anon0:
    call {:si_unique_call 415} vslice_dummy_var_74 := __HAVOC_malloc(4);
    Extension_32 := actual_Extension_32;
    pIrp := actual_pIrp;
    Status_19 := actual_Status_19;
    call {:si_unique_call 416} pIrpStack_2 := sdv_IoGetCurrentIrpStackLocation(pIrp);
  ...
  anon21_Else:
    call {:si_unique_call 417} sdv_180 := sdv_MmGetMdlVirtualAddress(0);
    assume {:nonnull} srb_1 != 0;
    assume srb_1 > 0;
    assume {:nonnull} srb_1 != 0;
    assume srb_1 > 0;
  ...
  anon28_Else:
    call {:si_unique_call 418} sdv_KeFlushIoBuffers(0, 1, 0);
    goto L11;
  ...
  anon25_Else:
    call {:si_unique_call 419} sdv_182 := PpaIssueRequestSense(Extension_32, pIrp);
    goto anon26_Then, anon26_Else;
  ...
  anon26_Else:
    ...
    assume {:nonnull} pIrp != 0;
    assume pIrp > 0;
    call {:si_unique_call 420} boogieTmp := PpaInterpretSenseInfo(srb_1);
    goto L1;
  ...
  anon26_Then:
    ...
    assume {:nonnull} pIrp != 0;
    assume pIrp > 0;
    call {:si_unique_call 421} boogieTmp := PpaTranslateScsiStatus(srb_1);
    goto L1;
  ...
  L28:
    assume {:nonnull} pIrp != 0;
    assume pIrp > 0;
    call {:si_unique_call 422} boogieTmp := PpaTranslateScsiStatus(srb_1);
    goto L1;
...
implementation {:origName "_sdv_init5"} _sdv_init5()
{
  ...
  anon0:
    call {:si_unique_call 423} vslice_dummy_var_75 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "PpaScsiRequests"} PpaScsiRequests(actual_DeviceObject_13: int, actual_pIrp_1: int) returns (Tmp_355: int)
{
  ...
  anon0:
    ...
    pIrp_1 := actual_pIrp_1;
    call {:si_unique_call 424} pIrpStack_3 := sdv_IoGetCurrentIrpStackLocation(pIrp_1);
    assume {:nonnull} DeviceObject_13 != 0;
    assume DeviceObject_13 > 0;
    havoc Extension_33;
    call {:si_unique_call 425} Status_21 := sdv_IoAcquireRemoveLock(0, 0);
    goto anon35_Then, anon35_Else;
  ...
  anon48_Else:
    ...
    assume SLAM_guard_S_0 != SLAM_guard_S_0_init;
    call {:si_unique_call 426} SLIC_sdv_IoCompleteRequest_entry(strConst__li2bpl12);
    goto anon49_Then, anon49_Else;
  ...
  L142:
    ...
    call {:si_unique_call 428} vslice_dummy_var_76 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(Extension_33), pIrp_1);
    goto L20;

  L20:
    Tmp_355 := Status_21;
    call {:si_unique_call 429} SLIC_PpaScsiRequests_exit(strConst__li2bpl13, Tmp_355);
    goto anon50_Then, anon50_Else;
  ...
  anon41_Else:
    call {:si_unique_call 430} Tmp_356 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_356 != 0;
    assume Tmp_356 > 0;
    call {:si_unique_call 431} sdv_KeAcquireSpinLock(0, Tmp_356);
    assume {:nonnull} Tmp_356 != 0;
    assume Tmp_356 > 0;
    havoc cIrql;
    assume {:nonnull} Extension_33 != 0;
  ...
  anon42_Then:
    call {:si_unique_call 433} Tmp_356 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_356 != 0;
    assume Tmp_356 > 0;
    call {:si_unique_call 434} sdv_KeAcquireSpinLock(0, Tmp_356);
    assume {:nonnull} Tmp_356 != 0;
    assume Tmp_356 > 0;
    havoc cIrql;
    assume {:nonnull} Extension_33 != 0;
    assume Extension_33 > 0;
    call {:si_unique_call 435} sdv_KeReleaseSpinLock(0, cIrql);
    Status_21 := 0;
    assume {:nonnull} srb_2 != 0;
    assume srb_2 > 0;
    goto L19;
  ...
  anon43_Then:
    call {:si_unique_call 436} Tmp_356 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_356 != 0;
    assume Tmp_356 > 0;
    call {:si_unique_call 437} sdv_KeAcquireSpinLock(0, Tmp_356);
    assume {:nonnull} Tmp_356 != 0;
    assume Tmp_356 > 0;
    havoc cIrql;
    assume {:nonnull} Extension_33 != 0;
    assume Extension_33 > 0;
    call {:si_unique_call 438} sdv_KeReleaseSpinLock(0, cIrql);
    Status_21 := 0;
    assume {:nonnull} srb_2 != 0;
    assume srb_2 > 0;
    call {:si_unique_call 439} PpaInitializeQueueIrp(Extension_33);
    call {:si_unique_call 440} sdv_IoMarkIrpPending(0);
    call {:si_unique_call 441} IoStartPacket(0, 0, 0, 0);
    goto L19;
  ...
  anon46_Then:
    call {:si_unique_call 442} Tmp_356 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_356 != 0;
    assume Tmp_356 > 0;
    call {:si_unique_call 443} sdv_KeAcquireSpinLock(0, Tmp_356);
    assume {:nonnull} Tmp_356 != 0;
    assume Tmp_356 > 0;
    havoc cIrql;
    assume {:nonnull} Extension_33 != 0;
    assume Extension_33 > 0;
    call {:si_unique_call 444} sdv_KeReleaseSpinLock(0, cIrql);
    Status_21 := 0;
    assume {:nonnull} srb_2 != 0;
    assume srb_2 > 0;
    goto L19;
  ...
  anon47_Then:
    call {:si_unique_call 445} Tmp_356 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_356 != 0;
    assume Tmp_356 > 0;
    call {:si_unique_call 446} sdv_KeAcquireSpinLock(0, Tmp_356);
    assume {:nonnull} Tmp_356 != 0;
    assume Tmp_356 > 0;
    havoc cIrql;
    assume {:nonnull} Extension_33 != 0;
  ...
  anon40_Then:
    Status_21 := 259;
    call {:si_unique_call 448} sdv_IoMarkIrpPending(0);
    call {:si_unique_call 449} IoStartPacket(0, 0, 0, 0);
    goto L19;
}
...
implementation {:origName "PpaIssueInquiry"} PpaIssueInquiry(actual_Extension_34: int) returns (Tmp_357: int)
{
  ...
  anon0:
    ...
    retryCount := 0;
    call {:si_unique_call 450} sdv_186 := ExAllocatePoolWithTag(4, 64, 863134032);
    srb_3 := sdv_186;
    goto anon22_Then, anon22_Else;
  ...
  L14:
    call {:si_unique_call 451} cdb, Tmp_358, Tmp_359, Tmp_360, status_7, Tmp_362, retryCount := PpaIssueInquiry_loop_L14(cdb, Tmp_358, Tmp_359, Tmp_360, srb_3, status_7, Tmp_362, retryCount, Extension_34);
    goto L14_last;

  L14_last:
    call {:si_unique_call 453} sdv_RtlZeroMemory(0, 64);
    ...
    assume {:nonnull} Extension_34 != 0;
    assume Extension_34 > 0;
    call {:si_unique_call 454} IoStartTimer(0);
    call {:si_unique_call 455} status_7 := PpaStartExecution(Extension_34);
    assume {:nonnull} Extension_34 != 0;
    assume Extension_34 > 0;
    call {:si_unique_call 456} IoStopTimer(0);
    goto anon19_Then, anon19_Else;
...
implementation {:origName "PpaPortUnlockCompletionRoutine"} PpaPortUnlockCompletionRoutine(actual_pDeviceObject_2: int, actual_Irp_12: int, actual_ContextIn: int) returns (Tmp_363: int)
{
  ...
  L9:
    call {:si_unique_call 457} sdv_188 := sdv_KeGetCurrentIrql();
    goto anon5_Then, anon5_Else;

  anon5_Else:
    assume {:partition} 2 > sdv_188;
    call {:si_unique_call 458} oldIrql := KeRaiseIrqlToDpcLevel();
    call {:si_unique_call 459} IoStartNextPacket(0, 0);
  ...
  anon5_Then:
    ...
    call {:si_unique_call 461} IoStartNextPacket(0, 0);
    goto L27;
...
implementation {:origName "PpaIssueRequestSense"} PpaIssueRequestSense(actual_Extension_37: int, actual_pIrp_2: int) returns (Tmp_369: int)
{
  ...
  anon0:
    ...
    pIrp_2 := actual_pIrp_2;
    call {:si_unique_call 462} Tmp_370 := __HAVOC_malloc(64);
    call {:si_unique_call 463} Tmp_377 := __HAVOC_malloc(64);
    call {:si_unique_call 464} Tmp_379 := __HAVOC_malloc(64);
    call {:si_unique_call 465} Tmp_381 := __HAVOC_malloc(64);
    call {:si_unique_call 466} Tmp_382 := __HAVOC_malloc(64);
    call {:si_unique_call 467} Tmp_384 := __HAVOC_malloc(64);
    call {:si_unique_call 468} pIrpStack_4 := sdv_IoGetCurrentIrpStackLocation(pIrp_2);
    retryCount_1 := 0;
    call {:si_unique_call 469} sdv_194 := ExAllocatePoolWithTag(0, 68, 863134032);
    srb_4 := sdv_194;
    goto anon20_Then, anon20_Else;
  ...
  L18:
    call {:si_unique_call 470} Tmp_370, Tmp_371, Tmp_372, Tmp_373, Tmp_374, Tmp_376, Tmp_377, Tmp_379, Tmp_380, status_9, Tmp_381, Tmp_382, retryCount_1, Tmp_383, Tmp_384 := PpaIssueRequestSense_loop_L18(Tmp_370, Tmp_371, Tmp_372, Tmp_373, Tmp_374, Tmp_376, pIrpStack_4, Tmp_377, Tmp_379, Tmp_380, srb_4, status_9, Tmp_381, Tmp_382, retryCount_1, Tmp_383, Tmp_384, Extension_37);
    goto L18_last;
  ...
  L18_last:
    ...
    assume {:nonnull} Extension_37 != 0;
    assume Extension_37 > 0;
    call {:si_unique_call 473} IoStartTimer(0);
    call {:si_unique_call 474} status_9 := PpaStartExecution(Extension_37);
    assume {:nonnull} Extension_37 != 0;
    assume Extension_37 > 0;
    call {:si_unique_call 475} IoStopTimer(0);
    goto anon17_Then, anon17_Else;
...
implementation {:origName "PpaQueryProperty"} PpaQueryProperty(actual_pDeviceObject_4: int, actual_QueryIrp: int) returns (Tmp_387: int)
{
  ...
  anon0:
    call {:si_unique_call 476} queryLength := __HAVOC_malloc(4);
    pDeviceObject_4 := actual_pDeviceObject_4;
    QueryIrp := actual_QueryIrp;
    call {:si_unique_call 477} irpStack_1 := sdv_IoGetCurrentIrpStackLocation(QueryIrp);
  ...
  anon26_Else:
    ...
    assume SLAM_guard_S_0 != SLAM_guard_S_0_init;
    call {:si_unique_call 479} SLIC_sdv_IoCompleteRequest_entry(strConst__li2bpl12);
    goto anon27_Then, anon27_Else;
  ...
  anon28_Else:
    assume QueryIrp == SLAM_guard_S_0;
    assume SLAM_guard_S_0 != SLAM_guard_S_0_init;
    call {:si_unique_call 481} SLIC_sdv_IoCompleteRequest_entry(strConst__li2bpl12);
    goto anon29_Then, anon29_Else;
  ...
  L61:
    call {:si_unique_call 482} sdv_IoCompleteRequest(0, 1);
    goto L38;
  ...
  anon30_Then:
    ...
    call {:si_unique_call 483} Status_23 := PpaBuildAdapterDescriptor(pDeviceObject_4, vslice_dummy_var_182, queryLength);
    assume {:nonnull} QueryIrp != 0;
    assume QueryIrp > 0;
    assume {:nonnull} queryLength != 0;
    assume queryLength > 0;
  ...
  anon23_Then:
    ...
    call {:si_unique_call 484} Status_23 := PpaBuildDeviceDescriptor(pDeviceObject_4, vslice_dummy_var_183, queryLength);
    assume {:nonnull} QueryIrp != 0;
    assume QueryIrp > 0;
    assume {:nonnull} queryLength != 0;
    assume queryLength > 0;
...
implementation {:origName "PpaBuildAdapterDescriptor"} PpaBuildAdapterDescriptor(actual_pDeviceObject_5: int, actual_Descriptor: int, actual_DescriptorLength: int) returns (Tmp_391: int)
{
  ...
  anon0:
    call {:si_unique_call 485} tmp := __HAVOC_malloc(48);
  ...
  L24:
    call {:si_unique_call 487} sdv_RtlCopyMemory(0, 0, Tmp_394);
    assume {:nonnull} DescriptorLength != 0;
    assume DescriptorLength > 0;
    goto anon5_Then, anon5_Else;
...
implementation {:origName "_sdv_init4"} _sdv_init4()
{
  ...
  anon0:
    call {:si_unique_call 488} vslice_dummy_var_77 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "PpaBuildDeviceDescriptor"} PpaBuildDeviceDescriptor(actual_pDeviceObject_6: int, actual_Descriptor_1: int, actual_DescriptorLength_1: int) returns (Tmp_397: int)
{
  ...
  anon0:
    call {:si_unique_call 489} tmp_1 := __HAVOC_malloc(52);
  ...
  L22:
    ...
    call {:si_unique_call 491} sdv_RtlZeroMemory(0, vslice_dummy_var_184);
    call {:si_unique_call 492} sdv_RtlZeroMemory(0, 40);
  ...
  L42:
    call {:si_unique_call 493} sdv_RtlCopyMemory(0, 0, Tmp_399);
  ...
  L53:
    call {:si_unique_call 494} sdv_RtlCopyMemory(0, 0, Tmp_402);
  ...
  L66:
    call {:si_unique_call 495} sdv_RtlCopyMemory(0, 0, Tmp_401);
  ...
  L79:
    call {:si_unique_call 496} sdv_RtlCopyMemory(0, 0, Tmp_400);
...
implementation {:origName "PpaTrySlowerMode"} PpaTrySlowerMode(actual_Extension_41: int) returns (Tmp_403: int)
{
  ...
  anon14_Else:
    ...
    assume {:nonnull} Extension_41 != 0;
    assume Extension_41 > 0;
    call {:si_unique_call 497} vslice_dummy_var_78 := PpaWriteRegistryModeValue(Extension_41);
    goto L14;
  ...
  anon15_Else:
    ...
    assume {:nonnull} Extension_41 != 0;
    assume Extension_41 > 0;
    call {:si_unique_call 498} vslice_dummy_var_79 := PpaWriteRegistryModeValue(Extension_41);
    goto L14;
  ...
  anon15_Then:
    ...
    assume {:nonnull} Extension_41 != 0;
    assume Extension_41 > 0;
    call {:si_unique_call 499} vslice_dummy_var_80 := PpaWriteRegistryModeValue(Extension_41);
    goto L14;
  ...
  anon17_Else:
    ...
    assume {:nonnull} Extension_41 != 0;
    assume Extension_41 > 0;
    call {:si_unique_call 500} vslice_dummy_var_81 := PpaWriteRegistryModeValue(Extension_41);
    goto L34;
  ...
  anon17_Then:
    ...
    assume {:nonnull} Extension_41 != 0;
    assume Extension_41 > 0;
    call {:si_unique_call 501} vslice_dummy_var_82 := PpaWriteRegistryModeValue(Extension_41);
    goto L34;
  ...
  anon16_Else:
    ...
    assume {:nonnull} Extension_41 != 0;
    assume Extension_41 > 0;
    call {:si_unique_call 502} vslice_dummy_var_83 := PpaWriteRegistryModeValue(Extension_41);
    trySlowerMode := 1;
    goto L15;
...
implementation {:origName "PpaPnpDeviceControl"} PpaPnpDeviceControl(actual_pDeviceObject_7: int, actual_pIrp_3: int) returns (Tmp_405: int)
{
  ...
  anon0:
    call {:si_unique_call 503} Event_7 := __HAVOC_malloc(124);
  ...
  anon130_Else:
    ...
    call {:si_unique_call 510} Status_24 := sdv_IoCallDriver#1(vslice_dummy_var_185, pIrp_3);
    goto L66;

  L66:
    Tmp_405 := Status_24;
    call {:si_unique_call 511} SLIC_PpaPnpDeviceControl_exit(strConst__li2bpl13, Tmp_405);
    goto anon149_Then, anon149_Else;
  ...
  L21:
    ...
    call {:si_unique_call 513} Status_24 := sdv_IoCallDriver#1(vslice_dummy_var_186, pIrp_3);
    goto L66;
  ...
  anon134_Then:
    ...
    call {:si_unique_call 515} Status_24 := sdv_IoCallDriver#1(vslice_dummy_var_187, pIrp_3);
    goto L66;
  ...
  anon146_Else:
    ...
    assume SLAM_guard_S_0 != SLAM_guard_S_0_init;
    call {:si_unique_call 518} SLIC_sdv_IoSetCompletionRoutine_exit(0);
    goto L84;
  ...
  L84:
    ...
    call {:si_unique_call 519} Status_24 := sdv_IoCallDriver#1(vslice_dummy_var_188, pIrp_3);
    goto anon110_Then, anon110_Else;

  anon110_Else:
    assume {:partition} Status_24 == 259;
    call {:si_unique_call 520} vslice_dummy_var_84 := KeWaitForSingleObject(0, 0, 0, 0, 0);
    goto L89;
  ...
  anon161_Else:
    ...
    call {:si_unique_call 521} Tmp_406 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_406 != 0;
    assume Tmp_406 > 0;
    call {:si_unique_call 522} sdv_KeAcquireSpinLock(0, Tmp_406);
    assume {:nonnull} Tmp_406 != 0;
    assume Tmp_406 > 0;
    havoc cIrql_1;
    assume {:nonnull} Extension_42 != 0;
    assume Extension_42 > 0;
    call {:si_unique_call 523} sdv_KeReleaseSpinLock(0, cIrql_1);
    goto L94;
  ...
  anon111_Else:
    assume pIrp_3 == SLAM_guard_S_0;
    assume SLAM_guard_S_0 != SLAM_guard_S_0_init;
    call {:si_unique_call 524} SLIC_sdv_IoCompleteRequest_entry(strConst__li2bpl12);
  ...
  anon137_Then:
    ...
    call {:si_unique_call 527} sdv_IoSetCompletionRoutine(pIrp_3, li2bplFunctionConstant134, Event_7, 1, 1, 1);
    goto anon145_Then, anon145_Else;

  anon145_Else:
    assume pIrp_3 == SLAM_guard_S_0;
    assume SLAM_guard_S_0 != SLAM_guard_S_0_init;
    call {:si_unique_call 528} SLIC_sdv_IoSetCompletionRoutine_exit(0);
    goto L108;
  ...
  L108:
    ...
    call {:si_unique_call 529} Status_24 := sdv_IoCallDriver#1(vslice_dummy_var_189, pIrp_3);
    goto anon112_Then, anon112_Else;

  anon112_Else:
    assume {:partition} Status_24 == 259;
    call {:si_unique_call 530} vslice_dummy_var_85 := KeWaitForSingleObject(0, 0, 0, 0, 0);
    goto L113;
  ...
  anon159_Else:
    assume {:partition} Status_24 >= 0;
    call {:si_unique_call 531} Tmp_406 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_406 != 0;
    assume Tmp_406 > 0;
    call {:si_unique_call 532} sdv_KeAcquireSpinLock(0, Tmp_406);
    assume {:nonnull} Tmp_406 != 0;
    assume Tmp_406 > 0;
    havoc cIrql_1;
    assume {:nonnull} Extension_42 != 0;
    assume Extension_42 > 0;
    call {:si_unique_call 533} sdv_KeReleaseSpinLock(0, cIrql_1);
    goto L118;
  ...
  anon113_Else:
    assume pIrp_3 == SLAM_guard_S_0;
    assume SLAM_guard_S_0 != SLAM_guard_S_0_init;
    call {:si_unique_call 534} SLIC_sdv_IoCompleteRequest_entry(strConst__li2bpl12);
  ...
  anon138_Then:
    call {:si_unique_call 536} sdv_IoCopyCurrentIrpStackLocationToNext(pIrp_3);
    call {:si_unique_call 537} sdv_IoSetCompletionRoutine(pIrp_3, li2bplFunctionConstant134, Event_7, 1, 1, 1);
    goto anon144_Then, anon144_Else;

  anon144_Else:
    assume pIrp_3 == SLAM_guard_S_0;
    assume SLAM_guard_S_0 != SLAM_guard_S_0_init;
    call {:si_unique_call 538} SLIC_sdv_IoSetCompletionRoutine_exit(0);
    goto L132;
  ...
  L132:
    ...
    call {:si_unique_call 539} Status_24 := sdv_IoCallDriver#1(vslice_dummy_var_190, pIrp_3);
    goto anon114_Then, anon114_Else;

  anon114_Else:
    assume {:partition} Status_24 == 259;
    call {:si_unique_call 540} vslice_dummy_var_86 := KeWaitForSingleObject(0, 0, 0, 0, 0);
    goto L137;
  ...
  anon157_Else:
    assume {:partition} Status_24 >= 0;
    call {:si_unique_call 541} Tmp_406 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_406 != 0;
    assume Tmp_406 > 0;
    call {:si_unique_call 542} sdv_KeAcquireSpinLock(0, Tmp_406);
    assume {:nonnull} Tmp_406 != 0;
    assume Tmp_406 > 0;
    havoc cIrql_1;
    assume {:nonnull} Extension_42 != 0;
    assume Extension_42 > 0;
    call {:si_unique_call 543} sdv_KeReleaseSpinLock(0, cIrql_1);
    assume {:nonnull} pIrp_3 != 0;
    assume pIrp_3 > 0;
    assume {:nonnull} pIrp_3 != 0;
    assume pIrp_3 > 0;
  ...
  anon115_Else:
    assume pIrp_3 == SLAM_guard_S_0;
    assume SLAM_guard_S_0 != SLAM_guard_S_0_init;
    call {:si_unique_call 544} SLIC_sdv_IoCompleteRequest_entry(strConst__li2bpl12);
  ...
  anon139_Then:
    ...
    call {:si_unique_call 547} Status_24 := sdv_IoCallDriver#1(vslice_dummy_var_191, pIrp_3);
    goto anon116_Then, anon116_Else;

  anon116_Else:
    assume {:partition} Status_24 >= 0;
    call {:si_unique_call 548} Tmp_406 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_406 != 0;
    assume Tmp_406 > 0;
    call {:si_unique_call 549} sdv_KeAcquireSpinLock(0, Tmp_406);
    assume {:nonnull} Tmp_406 != 0;
    assume Tmp_406 > 0;
    havoc cIrql_1;
    assume {:nonnull} Extension_42 != 0;
    assume Extension_42 > 0;
    call {:si_unique_call 550} sdv_KeReleaseSpinLock(0, cIrql_1);
    assume {:nonnull} Extension_42 != 0;
    assume Extension_42 > 0;
    goto anon156_Then, anon156_Else;

  anon156_Else:
    call {:si_unique_call 551} Status_24 := PpaCreateToParclass(Extension_42);
    goto L171;
  ...
  anon140_Then:
    call {:si_unique_call 555} Status_24 := sdv_IoAcquireRemoveLock(0, 0);
    goto anon118_Then, anon118_Else;
  ...
  anon119_Else:
    call {:si_unique_call 556} vslice_dummy_var_87 := IoCancelIrp(0);
    goto L187;
  ...
  anon120_Else:
    call {:si_unique_call 557} Status_24 := PpaCloseToParclass(Extension_42);
    goto L196;
  ...
  anon121_Else:
    assume {:partition} Status_24 >= 0;
    call {:si_unique_call 558} Tmp_406 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_406 != 0;
    assume Tmp_406 > 0;
    call {:si_unique_call 559} sdv_KeAcquireSpinLock(0, Tmp_406);
    assume {:nonnull} Tmp_406 != 0;
    assume Tmp_406 > 0;
    havoc cIrql_1;
    assume {:nonnull} Extension_42 != 0;
    ...
    call {:si_unique_call 561} sdv_IoCopyCurrentIrpStackLocationToNext(pIrp_3);
    call {:si_unique_call 562} sdv_IoSetCompletionRoutine(pIrp_3, li2bplFunctionConstant134, Event_7, 1, 1, 1);
    goto anon143_Then, anon143_Else;

  anon143_Else:
    assume pIrp_3 == SLAM_guard_S_0;
    assume SLAM_guard_S_0 != SLAM_guard_S_0_init;
    call {:si_unique_call 563} SLIC_sdv_IoSetCompletionRoutine_exit(0);
    goto L215;
  ...
  L215:
    ...
    call {:si_unique_call 564} Status_24 := sdv_IoCallDriver#1(vslice_dummy_var_192, pIrp_3);
    goto anon123_Then, anon123_Else;

  anon123_Else:
    assume {:partition} Status_24 == 259;
    call {:si_unique_call 565} vslice_dummy_var_88 := KeWaitForSingleObject(0, 0, 0, 0, 0);
    goto L220;
  ...
  anon124_Else:
    ...
    call {:si_unique_call 566} sdv_IoReleaseRemoveLockAndWait(0, 0);
    goto L224;
  ...
  anon154_Else:
    assume {:partition} Status_24 >= 0;
    call {:si_unique_call 567} vslice_dummy_var_89 := KeCancelTimer(0);
    call {:si_unique_call 568} PpaCleanExtension(pDeviceObject_7, 1);
    call {:si_unique_call 569} IoDetachDevice(0);
    call {:si_unique_call 570} IoDeleteDevice(0);
    assume {:nonnull} pIrp_3 != 0;
    assume pIrp_3 > 0;
    goto L229;
  ...
  anon125_Else:
    assume pIrp_3 == SLAM_guard_S_0;
    assume SLAM_guard_S_0 != SLAM_guard_S_0_init;
    call {:si_unique_call 571} SLIC_sdv_IoCompleteRequest_entry(strConst__li2bpl12);
    goto anon155_Then, anon155_Else;
  ...
  anon122_Else:
    assume {:partition} gotRemoveLock != 0;
    call {:si_unique_call 573} sdv_IoReleaseRemoveLockAndWait(0, 0);
    goto L246;
  ...
  anon153_Then:
    call {:si_unique_call 574} Tmp_406 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_406 != 0;
    assume Tmp_406 > 0;
    call {:si_unique_call 575} sdv_KeAcquireSpinLock(0, Tmp_406);
    assume {:nonnull} Tmp_406 != 0;
    assume Tmp_406 > 0;
    havoc cIrql_1;
    assume {:nonnull} Extension_42 != 0;
  ...
  anon150_Else:
    call {:si_unique_call 577} Status_24 := PpaCloseToParclass(Extension_42);
    goto L256;
  ...
  anon126_Else:
    assume {:partition} Status_24 >= 0;
    call {:si_unique_call 578} Tmp_406 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_406 != 0;
    assume Tmp_406 > 0;
    call {:si_unique_call 579} sdv_KeAcquireSpinLock(0, Tmp_406);
    assume {:nonnull} Tmp_406 != 0;
    assume Tmp_406 > 0;
    havoc cIrql_1;
    assume {:nonnull} Extension_42 != 0;
    ...
    call {:si_unique_call 581} sdv_IoCopyCurrentIrpStackLocationToNext(pIrp_3);
    assume {:nonnull} Extension_42 != 0;
    assume Extension_42 > 0;
    havoc vslice_dummy_var_193;
    call {:si_unique_call 582} Status_24 := sdv_IoCallDriver#1(vslice_dummy_var_193, pIrp_3);
    goto anon127_Then, anon127_Else;

  anon127_Else:
    assume {:partition} Status_24 >= 0;
    call {:si_unique_call 583} Tmp_406 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_406 != 0;
    assume Tmp_406 > 0;
    call {:si_unique_call 584} sdv_KeAcquireSpinLock(0, Tmp_406);
    assume {:nonnull} Tmp_406 != 0;
    assume Tmp_406 > 0;
    havoc cIrql_1;
    assume {:nonnull} Extension_42 != 0;
    assume Extension_42 > 0;
    call {:si_unique_call 585} sdv_KeReleaseSpinLock(0, cIrql_1);
    goto L66;

  anon127_Then:
    assume {:partition} 0 > Status_24;
    call {:si_unique_call 586} Status_24 := PpaCreateToParclass(Extension_42);
    goto L66;
  ...
  anon151_Else:
    assume pIrp_3 == SLAM_guard_S_0;
    assume SLAM_guard_S_0 != SLAM_guard_S_0_init;
    call {:si_unique_call 587} SLIC_sdv_IoCompleteRequest_entry(strConst__li2bpl12);
    goto anon152_Then, anon152_Else;
  ...
  anon109_Then:
    call {:si_unique_call 589} sdv_IoCopyCurrentIrpStackLocationToNext(pIrp_3);
    call {:si_unique_call 590} sdv_IoSetCompletionRoutine(pIrp_3, li2bplFunctionConstant134, Event_7, 1, 1, 1);
    goto anon142_Then, anon142_Else;

  anon142_Else:
    assume pIrp_3 == SLAM_guard_S_0;
    assume SLAM_guard_S_0 != SLAM_guard_S_0_init;
    call {:si_unique_call 591} SLIC_sdv_IoSetCompletionRoutine_exit(0);
    goto L295;
  ...
  L295:
    ...
    call {:si_unique_call 592} Status_24 := sdv_IoCallDriver#1(vslice_dummy_var_194, pIrp_3);
    goto anon128_Then, anon128_Else;

  anon128_Else:
    assume {:partition} Status_24 == 259;
    call {:si_unique_call 593} vslice_dummy_var_90 := KeWaitForSingleObject(0, 0, 0, 0, 0);
    goto L300;
  ...
  anon147_Else:
    assume {:partition} Status_24 >= 0;
    call {:si_unique_call 594} Status_24 := PpaStartDevice(pDeviceObject_7);
    assume {:nonnull} pIrp_3 != 0;
    assume pIrp_3 > 0;
    assume {:nonnull} pIrp_3 != 0;
    assume pIrp_3 > 0;
  ...
  anon129_Else:
    assume pIrp_3 == SLAM_guard_S_0;
    assume SLAM_guard_S_0 != SLAM_guard_S_0_init;
    call {:si_unique_call 595} SLIC_sdv_IoCompleteRequest_entry(strConst__li2bpl12);
    goto anon148_Then, anon148_Else;
...
implementation {:origName "PpaCreateCleanupClose"} PpaCreateCleanupClose(actual_DeviceObject_14: int, actual_Irp_14: int) returns (Tmp_411: int)
{
  ...
  anon7_Else:
    ...
    assume SLAM_guard_S_0 != SLAM_guard_S_0_init;
    call {:si_unique_call 597} SLIC_sdv_IoCompleteRequest_entry(strConst__li2bpl12);
    goto anon8_Then, anon8_Else;
  ...
  L11:
    ...
    Tmp_411 := 0;
    call {:si_unique_call 599} SLIC_PpaCreateCleanupClose_exit(strConst__li2bpl13, Tmp_411);
    goto anon9_Then, anon9_Else;
...
implementation {:origName "PpaInitializeQueueIrp"} PpaInitializeQueueIrp(actual_Extension_43: int)
{
  ...
  anon0:
    call {:si_unique_call 600} vslice_dummy_var_91 := __HAVOC_malloc(4);
    Extension_43 := actual_Extension_43;
    assume {:nonnull} Extension_43 != 0;
    assume Extension_43 > 0;
    havoc vslice_dummy_var_195;
    call {:si_unique_call 601} IoReuseIrp(vslice_dummy_var_195, 0);
    assume {:nonnull} Extension_43 != 0;
    assume Extension_43 > 0;
    havoc vslice_dummy_var_196;
    call {:si_unique_call 602} pNextIrpStack := sdv_IoGetNextIrpStackLocation(vslice_dummy_var_196);
    call {:si_unique_call 603} sdv_RtlZeroMemory(0, 64);
    assume {:nonnull} Extension_43 != 0;
    assume Extension_43 > 0;
...
procedure {:origName "PpaSystemControl"} PpaSystemControl(actual_pDeviceObject_8: int, actual_pIrp_4: int) returns (Tmp_416: int);
  ...
  free ensures {:va_keep} s == 1 || s == 2 || s == old(s);
  free ensures {:va_keep} yogi_error == 1 || yogi_error == old(yogi_error);
  free ensures {:va_keep} Tmp_416 == 259;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} false || old(forward_state) == 1 || old(forward_state) == 0;
  free ensures {:va_keep} false || old(s) == 0 || old(s) == 2 || old(s) == 1;
  free ensures {:va_keep} alloc >= old(alloc);
...
implementation {:origName "PpaSystemControl"} PpaSystemControl(actual_pDeviceObject_8: int, actual_pIrp_4: int) returns (Tmp_416: int)
{
  ...
  anon0:
    ...
    havoc Extension_44;
    call {:si_unique_call 604} sdv_IoCopyCurrentIrpStackLocationToNext(pIrp_4);
    assume {:nonnull} Extension_44 != 0;
    assume Extension_44 > 0;
    havoc vslice_dummy_var_197;
    call {:si_unique_call 605} Tmp_416 := sdv_IoCallDriver#1(vslice_dummy_var_197, pIrp_4);
    call {:si_unique_call 606} SLIC_PpaSystemControl_exit(strConst__li2bpl13, Tmp_416);
    goto anon3_Then, anon3_Else;
...
implementation {:origName "PpaPowerControl"} PpaPowerControl(actual_pDeviceObject_9: int, actual_pIrp_5: int) returns (Tmp_418: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 607} sdv_IoCopyCurrentIrpStackLocationToNext(pIrp_5);
    call {:si_unique_call 608} PoStartNextPowerIrp(0);
    call {:si_unique_call 609} Tmp_418 := PoCallDriver(0, pIrp_5);
    call {:si_unique_call 610} SLIC_PpaPowerControl_exit(strConst__li2bpl13, Tmp_418);
    goto anon3_Then, anon3_Else;
...
implementation {:origName "_sdv_init1"} _sdv_init1()
{
  ...
  anon0:
    call {:si_unique_call 611} vslice_dummy_var_92 := __HAVOC_malloc(4);
...
implementation {:origName "PpaStartDevice"} PpaStartDevice(actual_pDeviceObject_10: int) returns (Tmp_422: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 612} Status_25 := PpaGetDeviceInfo(Extension_46);
    goto anon15_Then, anon15_Else;

  anon15_Else:
    assume {:partition} Status_25 >= 0;
    call {:si_unique_call 613} Status_25 := PpaInitializeExtension(Extension_46);
    goto anon16_Then, anon16_Else;
  ...
  L20:
    call {:si_unique_call 614} Status_25, sdv_235 := PpaStartDevice_loop_L20(Status_25, Extension_46, sdv_235);
    goto L20_last;

  L20_last:
    call {:si_unique_call 619} PpaPortLock(Extension_46, 1, 0);
    assume {:nonnull} Extension_46 != 0;
    assume Extension_46 > 0;
    goto anon17_Then, anon17_Else;
  ...
  L26:
    call {:si_unique_call 615} Status_25 := PpaStartDevice_loop_L26(Status_25, Extension_46);
    goto L26_last;
  ...
  anon18_Else:
    call {:si_unique_call 616} Status_25 := PpaIssueInquiry(Extension_46);
    goto anon19_Then, anon19_Else;
  ...
  L27:
    call {:si_unique_call 617} PpaPortUnlock#1(Extension_46, 1, 0);
    goto anon20_Then, anon20_Else;

  anon20_Else:
    assume {:partition} Status_25 != 0;
    call {:si_unique_call 618} sdv_235 := PpaTrySlowerMode(Extension_46);
    goto anon21_Then, anon21_Else;
...
implementation {:origName "PpaDeviceControl"} PpaDeviceControl(actual_pDeviceObject_11: int, actual_pIrp_6: int) returns (Tmp_424: int)
{
  ...
  anon0:
    ...
    pIrp_6 := actual_pIrp_6;
    call {:si_unique_call 620} pIrpStack_6 := sdv_IoGetCurrentIrpStackLocation(pIrp_6);
  ...
  anon94_Else:
    ...
    assume SLAM_guard_S_0 != SLAM_guard_S_0_init;
    call {:si_unique_call 621} SLIC_sdv_IoCompleteRequest_entry(strConst__li2bpl12);
  ...
  L1:
    call {:si_unique_call 623} SLIC_PpaDeviceControl_exit(strConst__li2bpl13, Tmp_424);
  ...
  anon98_Then:
    call {:si_unique_call 624} Status_26 := PpaQueryProperty(pDeviceObject_11, pIrp_6);
  ...
  L19:
    call {:si_unique_call 625} Status_26 := PpaScsiSendPassThrough(Extension_47, pIrp_6);
    goto L43;
...
implementation {:origName "PpaInitializeUnlockIrp"} PpaInitializeUnlockIrp(actual_Extension_48: int)
{
  ...
  anon0:
    call {:si_unique_call 626} vslice_dummy_var_93 := __HAVOC_malloc(4);
    Extension_48 := actual_Extension_48;
    assume {:nonnull} Extension_48 != 0;
    assume Extension_48 > 0;
    havoc vslice_dummy_var_198;
    call {:si_unique_call 627} IoReuseIrp(vslice_dummy_var_198, 0);
    assume {:nonnull} Extension_48 != 0;
    assume Extension_48 > 0;
    havoc vslice_dummy_var_199;
    call {:si_unique_call 628} pNextIrpStack_1 := sdv_IoGetNextIrpStackLocation(vslice_dummy_var_199);
    assume {:nonnull} Extension_48 != 0;
    assume Extension_48 > 0;
...
implementation {:origName "PpaInitializeExtension"} PpaInitializeExtension(actual_Extension_49: int) returns (Tmp_428: int)
{
  ...
  anon37_Else:
    call {:si_unique_call 629} Status_27 := PpaCreateToParclass(Extension_49);
    goto L13;
  ...
  anon27_Else:
    ...
    call {:si_unique_call 630} Tmp_432 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_432 != 0;
    assume Tmp_432 > 0;
    call {:si_unique_call 631} sdv_KeAcquireSpinLock(0, Tmp_432);
    assume {:nonnull} Tmp_432 != 0;
    assume Tmp_432 > 0;
    havoc cIrql_2;
    assume {:nonnull} Extension_49 != 0;
    assume Extension_49 > 0;
    call {:si_unique_call 632} sdv_KeReleaseSpinLock(0, cIrql_2);
    assume {:nonnull} Extension_49 != 0;
    assume Extension_49 > 0;
    goto anon28_Then, anon28_Else;
  ...
  anon28_Else:
    assume {:nonnull} Extension_49 != 0;
    assume Extension_49 > 0;
    call {:si_unique_call 633} sdv_244 := ExAllocatePoolWithTag(4, 36, 863134032);
    assume {:nonnull} Extension_49 != 0;
    assume Extension_49 > 0;
    assume {:nonnull} Extension_49 != 0;
    assume Extension_49 > 0;
  ...
  anon38_Else:
    call {:si_unique_call 634} sdv_245 := ExAllocatePoolWithTag(4, 64, 863134032);
    assume {:nonnull} Extension_49 != 0;
    assume Extension_49 > 0;
    assume {:nonnull} Extension_49 != 0;
    assume Extension_49 > 0;
  ...
  anon39_Else:
    assume {:nonnull} Extension_49 != 0;
    assume Extension_49 > 0;
    call {:si_unique_call 635} boogieTmp := IoAllocateIrp(1, 0);
    assume {:nonnull} Extension_49 != 0;
    assume Extension_49 > 0;
    goto anon29_Then, anon29_Else;
  ...
  anon29_Else:
    ...
    call {:si_unique_call 636} boogieTmp := IoAllocateIrp(vslice_dummy_var_200, 0);
    assume {:nonnull} Extension_49 != 0;
    assume Extension_49 > 0;
    goto anon30_Then, anon30_Else;
  ...
  anon30_Else:
    ...
    call {:si_unique_call 637} boogieTmp := IoAllocateIrp(vslice_dummy_var_201, 0);
    assume {:nonnull} Extension_49 != 0;
    assume Extension_49 > 0;
    goto anon31_Then, anon31_Else;
  ...
  L27:
    ...
    assume {:nonnull} Extension_49 != 0;
    assume Extension_49 > 0;
    call {:si_unique_call 638} vslice_dummy_var_95 := PpaGetRegistryParameters(Extension_49);
    call {:si_unique_call 639} Status_27 := PpaGetTransferMode(Extension_49);
    call {:si_unique_call 640} vslice_dummy_var_94 := PpaWriteRegistryModeValue(Extension_49);
    goto anon32_Then, anon32_Else;
  ...
  anon31_Then:
    ...
    call {:si_unique_call 646} IoFreeIrp(0);
    assume {:nonnull} Extension_49 != 0;
    assume Extension_49 > 0;
    assume {:nonnull} Extension_49 != 0;
    assume Extension_49 > 0;
...
implementation {:origName "PpaCleanExtension"} PpaCleanExtension(actual_pDeviceObject_13: int, actual_DeviceRemoved: int)
{
  ...
  anon18_Else:
    call {:si_unique_call 656} IoFreeIrp(0);
    assume {:nonnull} Extension_50 != 0;
    assume Extension_50 > 0;
    goto L16;
  ...
  anon19_Else:
    call {:si_unique_call 657} IoFreeIrp(0);
    assume {:nonnull} Extension_50 != 0;
    assume Extension_50 > 0;
    goto L21;
  ...
  anon22_Else:
    call {:si_unique_call 660} Status_28 := PpaCloseToParclass(Extension_50);
    goto anon24_Then, anon24_Else;

  anon24_Else:
    assume {:partition} Status_28 >= 0;
    call {:si_unique_call 661} Tmp_433 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_433 != 0;
    assume Tmp_433 > 0;
    call {:si_unique_call 662} sdv_KeAcquireSpinLock(0, Tmp_433);
    assume {:nonnull} Tmp_433 != 0;
    assume Tmp_433 > 0;
    havoc cIrql_3;
    assume {:nonnull} Extension_50 != 0;
    assume Extension_50 > 0;
    call {:si_unique_call 663} sdv_KeReleaseSpinLock(0, cIrql_3);
    goto L36;
...
implementation {:origName "PpaInitializeLockIrp"} PpaInitializeLockIrp(actual_Extension_51: int)
{
  ...
  anon0:
    call {:si_unique_call 665} vslice_dummy_var_97 := __HAVOC_malloc(4);
    Extension_51 := actual_Extension_51;
    assume {:nonnull} Extension_51 != 0;
    assume Extension_51 > 0;
    havoc vslice_dummy_var_202;
    call {:si_unique_call 666} IoReuseIrp(vslice_dummy_var_202, 0);
    assume {:nonnull} Extension_51 != 0;
    assume Extension_51 > 0;
    havoc vslice_dummy_var_203;
    call {:si_unique_call 667} pNextIrpStack_2 := sdv_IoGetNextIrpStackLocation(vslice_dummy_var_203);
    assume {:nonnull} Extension_51 != 0;
    assume Extension_51 > 0;
...
implementation {:origName "PpaPortLockCompletionRoutine"} PpaPortLockCompletionRoutine#0(actual_pDeviceObject_3: int, actual_Irp_13: int, actual_ContextIn_1: int) returns (Tmp_366: int)
{
  ...
  L10:
    call {:si_unique_call 668} status_8 := PpaStartExecution(Extension_36);
    assume {:nonnull} Extension_36 != 0;
    assume Extension_36 > 0;
    havoc vslice_dummy_var_204;
    call {:si_unique_call 669} PpaCompleteRequest(Extension_36, vslice_dummy_var_204, status_8);
    call {:si_unique_call 670} sdv_IoCompleteRequest(0, 0);
    assume {:nonnull} Extension_36 != 0;
    assume Extension_36 > 0;
    assume {:nonnull} Extension_36 != 0;
    assume Extension_36 > 0;
    call {:si_unique_call 671} vslice_dummy_var_98 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(Extension_36), Extension_36);
    goto anon7_Then, anon7_Else;

  anon7_Else:
    assume {:partition} status_8 < 0;
    call {:si_unique_call 672} sdv_191 := sdv_KeGetCurrentIrql();
    goto anon8_Then, anon8_Else;

  anon8_Else:
    assume {:partition} 2 > sdv_191;
    call {:si_unique_call 673} oldIrql_1 := KeRaiseIrqlToDpcLevel();
    call {:si_unique_call 674} IoStartNextPacket(0, 0);
    call {:si_unique_call 675} sdv_KeLowerIrql(oldIrql_1);
    goto L30;
  ...
  anon8_Then:
    ...
    call {:si_unique_call 676} IoStartNextPacket(0, 0);
    goto L30;
...
implementation {:origName "PpaPortLockCompletionRoutine"} PpaPortLockCompletionRoutine#1(actual_pDeviceObject_3: int, actual_Irp_13: int, actual_ContextIn_1: int) returns (Tmp_366: int)
{
  ...
  L10:
    call {:si_unique_call 677} status_8 := PpaStartExecution(Extension_36);
    assume {:nonnull} Extension_36 != 0;
    assume Extension_36 > 0;
    havoc vslice_dummy_var_205;
    call {:si_unique_call 678} PpaCompleteRequest(Extension_36, vslice_dummy_var_205, status_8);
    call {:si_unique_call 679} sdv_IoCompleteRequest(0, 0);
    assume {:nonnull} Extension_36 != 0;
    assume Extension_36 > 0;
    assume {:nonnull} Extension_36 != 0;
    assume Extension_36 > 0;
    call {:si_unique_call 680} vslice_dummy_var_99 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(Extension_36), Extension_36);
    goto anon7_Then, anon7_Else;

  anon7_Else:
    assume {:partition} status_8 < 0;
    call {:si_unique_call 681} sdv_191 := sdv_KeGetCurrentIrql();
    goto anon8_Then, anon8_Else;

  anon8_Else:
    assume {:partition} 2 > sdv_191;
    call {:si_unique_call 682} oldIrql_1 := KeRaiseIrqlToDpcLevel();
    call {:si_unique_call 683} IoStartNextPacket(0, 0);
    call {:si_unique_call 684} sdv_KeLowerIrql(oldIrql_1);
    goto L30;
  ...
  anon8_Then:
    assume {:partition} sdv_191 >= 2;
    call {:si_unique_call 685} IoStartNextPacket(0, 0);
    goto L30;

  anon7_Then:
    assume {:partition} 0 <= status_8;
    call {:si_unique_call 686} PpaPortUnlock#0(Extension_36, 0, Context_4);
    goto L30;
...
implementation {:origName "PpaPortUnlock"} PpaPortUnlock#0(actual_Extension_19: int, actual_Wait_2: int, actual_pDeviceObject_1: int)
{
  ...
  anon0:
    call {:si_unique_call 687} vslice_dummy_var_100 := __HAVOC_malloc(4);
    call {:si_unique_call 688} Event_5 := __HAVOC_malloc(124);
  ...
  anon11_Else:
    call {:si_unique_call 689} PpaInitializeUnlockIrp(Extension_19);
    goto anon12_Then, anon12_Else;

  anon12_Else:
    assume {:partition} Wait_2 != 0;
    call {:si_unique_call 690} KeInitializeEvent(Event_5, 0, 0);
    assume {:nonnull} Extension_19 != 0;
    assume Extension_19 > 0;
    havoc vslice_dummy_var_206;
    call {:si_unique_call 691} sdv_IoSetCompletionRoutine(vslice_dummy_var_206, li2bplFunctionConstant134, Event_5, 1, 1, 1);
    goto L20;
  ...
  L20:
    ...
    call {:si_unique_call 692} status_4 := sdv_IoCallDriver#0(vslice_dummy_var_207, vslice_dummy_var_208);
    goto anon13_Then, anon13_Else;
  ...
  anon14_Else:
    ...
    call {:si_unique_call 693} vslice_dummy_var_101 := KeWaitForSingleObject(0, 0, 0, 0, 0);
    goto L27;
  ...
  anon12_Then:
    ...
    call {:si_unique_call 694} sdv_IoSetCompletionRoutine(vslice_dummy_var_209, li2bplFunctionConstant200, pDeviceObject_1, 1, 1, 1);
    goto L20;
...
implementation {:origName "PpaPortUnlock"} PpaPortUnlock#1(actual_Extension_19: int, actual_Wait_2: int, actual_pDeviceObject_1: int)
{
  ...
  anon0:
    call {:si_unique_call 695} vslice_dummy_var_102 := __HAVOC_malloc(4);
    call {:si_unique_call 696} Event_5 := __HAVOC_malloc(124);
    Extension_19 := actual_Extension_19;
    Wait_2 := actual_Wait_2;
    pDeviceObject_1 := actual_pDeviceObject_1;
    assume {:nonnull} Extension_19 != 0;
  ...
  anon11_Else:
    call {:si_unique_call 697} PpaInitializeUnlockIrp(Extension_19);
    goto anon12_Then, anon12_Else;

  anon12_Else:
    assume {:partition} Wait_2 != 0;
    call {:si_unique_call 698} KeInitializeEvent(Event_5, 0, 0);
    assume {:nonnull} Extension_19 != 0;
    assume Extension_19 > 0;
    havoc vslice_dummy_var_210;
    call {:si_unique_call 699} sdv_IoSetCompletionRoutine(vslice_dummy_var_210, li2bplFunctionConstant134, Event_5, 1, 1, 1);
    goto L20;
  ...
  L20:
    ...
    call {:si_unique_call 700} status_4 := sdv_IoCallDriver#1(vslice_dummy_var_211, vslice_dummy_var_212);
    goto anon13_Then, anon13_Else;
  ...
  anon14_Else:
    assume {:partition} status_4 == 259;
    call {:si_unique_call 701} vslice_dummy_var_103 := KeWaitForSingleObject(0, 0, 0, 0, 0);
    goto L27;
  ...
  anon12_Then:
    ...
    call {:si_unique_call 702} sdv_IoSetCompletionRoutine(vslice_dummy_var_213, li2bplFunctionConstant200, pDeviceObject_1, 1, 1, 1);
    goto L20;
...
implementation {:origName "sdv_IoCallDriver"} {:osmodel} sdv_IoCallDriver#0(actual_DeviceObject_8: int, actual_Irp_7: int) returns (Tmp_242: int)
{
  ...
  anon0:
    Irp_7 := actual_Irp_7;
    call {:si_unique_call 703} Tmp_242 := IofCallDriver#0(0, Irp_7);
    return;
}
...
procedure {:origName "sdv_IoCallDriver"} {:osmodel} sdv_IoCallDriver#0(actual_DeviceObject_8: int, actual_Irp_7: int) returns (Tmp_242: int);
  ...
  free ensures {:va_keep} old(SLAM_guard_S_0) == old(SLAM_guard_S_0_init) ==> s == old(s);
  free ensures {:va_keep} s == 1 || s == 2 || s == old(s);
  free ensures {:va_keep} Tmp_242 == 259;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} false || old(forward_state) == 1 || old(forward_state) == 0;
  free ensures {:va_keep} false || old(s) == 0 || old(s) == 2 || old(s) == 1;
  free ensures {:va_keep} alloc >= old(alloc);
...
implementation {:origName "sdv_IoCallDriver"} {:osmodel} sdv_IoCallDriver#1(actual_DeviceObject_8: int, actual_Irp_7: int) returns (Tmp_242: int)
{
  ...
  anon0:
    Irp_7 := actual_Irp_7;
    call {:si_unique_call 704} Tmp_242 := IofCallDriver#1(0, Irp_7);
    return;
}
...
implementation {:origName "IofCallDriver"} {:osmodel} IofCallDriver#0(actual_DeviceObject_6: int, actual_Irp_5: int) returns (Tmp_236: int)
{
  ...
  anon0:
    call {:si_unique_call 705} completion_1 := __HAVOC_malloc(4);
    Irp_5 := actual_Irp_5;
  ...
  anon55_Then:
    ...
    call {:si_unique_call 706} sdv_93 := sdv_RunIoCompletionRoutines#0(sdv_p_devobj_fdo, Irp_5, vslice_dummy_var_214, completion_1);
    goto anon72_Then, anon72_Else;

  anon72_Else:
    assume Irp_5 == SLAM_guard_S_0;
    assume SLAM_guard_S_0 != SLAM_guard_S_0_init;
    call {:si_unique_call 707} SLIC_sdv_RunIoCompletionRoutines_exit(0, completion_1, sdv_93);
    goto L29;
  ...
  anon67_Else:
    ...
    call {:si_unique_call 708} sdv_96 := sdv_RunIoCompletionRoutines#0(sdv_p_devobj_fdo, Irp_5, vslice_dummy_var_215, completion_1);
    goto anon73_Then, anon73_Else;

  anon73_Else:
    assume Irp_5 == SLAM_guard_S_0;
    assume SLAM_guard_S_0 != SLAM_guard_S_0_init;
    call {:si_unique_call 709} SLIC_sdv_RunIoCompletionRoutines_exit(0, completion_1, sdv_96);
    goto L29;
  ...
  anon59_Else:
    ...
    call {:si_unique_call 710} sdv_94 := sdv_RunIoCompletionRoutines#0(sdv_p_devobj_fdo, Irp_5, vslice_dummy_var_216, completion_1);
    goto anon71_Then, anon71_Else;

  anon71_Else:
    assume Irp_5 == SLAM_guard_S_0;
    assume SLAM_guard_S_0 != SLAM_guard_S_0_init;
    call {:si_unique_call 711} SLIC_sdv_RunIoCompletionRoutines_exit(0, completion_1, sdv_94);
    goto L29;
  ...
  anon63_Else:
    ...
    call {:si_unique_call 712} sdv_95 := sdv_RunIoCompletionRoutines#0(sdv_p_devobj_fdo, Irp_5, vslice_dummy_var_217, completion_1);
    goto anon70_Then, anon70_Else;

  anon70_Else:
    assume Irp_5 == SLAM_guard_S_0;
    assume SLAM_guard_S_0 != SLAM_guard_S_0_init;
    call {:si_unique_call 713} SLIC_sdv_RunIoCompletionRoutines_exit(0, completion_1, sdv_95);
    goto L29;
...
procedure {:origName "IofCallDriver"} {:osmodel} IofCallDriver#0(actual_DeviceObject_6: int, actual_Irp_5: int) returns (Tmp_236: int);
  ...
  free ensures {:va_keep} old(SLAM_guard_S_0) == old(SLAM_guard_S_0_init) ==> s == old(s);
  free ensures {:va_keep} s == 1 || s == 2 || s == old(s);
  free ensures {:va_keep} Tmp_236 == 259;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} false || old(forward_state) == 1 || old(forward_state) == 0;
  free ensures {:va_keep} false || old(s) == 0 || old(s) == 2 || old(s) == 1;
  free ensures {:va_keep} alloc >= old(alloc);
...
implementation {:origName "IofCallDriver"} {:osmodel} IofCallDriver#1(actual_DeviceObject_6: int, actual_Irp_5: int) returns (Tmp_236: int)
{
  ...
  anon0:
    call {:si_unique_call 714} completion_1 := __HAVOC_malloc(4);
    Irp_5 := actual_Irp_5;
    assume {:nonnull} completion_1 != 0;
    assume completion_1 > 0;
    status_2 := 259;
  ...
  anon55_Then:
    ...
    call {:si_unique_call 715} sdv_93 := sdv_RunIoCompletionRoutines#1(sdv_p_devobj_fdo, Irp_5, vslice_dummy_var_218, completion_1);
    goto anon72_Then, anon72_Else;

  anon72_Else:
    assume Irp_5 == SLAM_guard_S_0;
    assume SLAM_guard_S_0 != SLAM_guard_S_0_init;
    call {:si_unique_call 716} SLIC_sdv_RunIoCompletionRoutines_exit(0, completion_1, sdv_93);
    goto L29;
  ...
  anon67_Else:
    ...
    call {:si_unique_call 717} sdv_96 := sdv_RunIoCompletionRoutines#1(sdv_p_devobj_fdo, Irp_5, vslice_dummy_var_219, completion_1);
    goto anon73_Then, anon73_Else;

  anon73_Else:
    assume Irp_5 == SLAM_guard_S_0;
    assume SLAM_guard_S_0 != SLAM_guard_S_0_init;
    call {:si_unique_call 718} SLIC_sdv_RunIoCompletionRoutines_exit(0, completion_1, sdv_96);
    goto L29;
  ...
  anon59_Else:
    ...
    call {:si_unique_call 719} sdv_94 := sdv_RunIoCompletionRoutines#1(sdv_p_devobj_fdo, Irp_5, vslice_dummy_var_220, completion_1);
    goto anon71_Then, anon71_Else;

  anon71_Else:
    assume Irp_5 == SLAM_guard_S_0;
    assume SLAM_guard_S_0 != SLAM_guard_S_0_init;
    call {:si_unique_call 720} SLIC_sdv_RunIoCompletionRoutines_exit(0, completion_1, sdv_94);
    goto L29;
  ...
  anon63_Else:
    ...
    call {:si_unique_call 721} sdv_95 := sdv_RunIoCompletionRoutines#1(sdv_p_devobj_fdo, Irp_5, vslice_dummy_var_221, completion_1);
    goto anon70_Then, anon70_Else;

  anon70_Else:
    assume Irp_5 == SLAM_guard_S_0;
    assume SLAM_guard_S_0 != SLAM_guard_S_0_init;
    call {:si_unique_call 722} SLIC_sdv_RunIoCompletionRoutines_exit(0, completion_1, sdv_95);
    goto L29;
...
implementation {:origName "sdv_RunIoCompletionRoutines"} {:osmodel} sdv_RunIoCompletionRoutines#0(actual_DeviceObject_7: int, actual_Irp_6: int, actual_Context_2: int, actual_Completion: int) returns (Tmp_238: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 723} irpsp := sdv_IoGetNextIrpStackLocation(Irp_6);
    Status_13 := 0;
    assume {:nonnull} irpsp != 0;
    assume irpsp > 0;
    goto anon9_Then, anon9_Else;
  ...
  anon9_Else:
    ...
    call {:si_unique_call 724} Status_13 := PpaPortLockCompletionRoutine#0(DeviceObject_7, Irp_6, Context_2);
    assume {:nonnull} Completion != 0;
    assume Completion > 0;
    goto L11;
  ...
  anon7_Else:
    ...
    call {:si_unique_call 725} Status_13 := PpaPortUnlockCompletionRoutine(DeviceObject_7, Irp_6, Context_2);
    assume {:nonnull} Completion != 0;
    assume Completion > 0;
    goto L28;
  ...
  anon8_Else:
    ...
    call {:si_unique_call 726} Status_13 := PpaRequestCompletionRoutine(DeviceObject_7, Irp_6, Context_2);
    assume {:nonnull} Completion != 0;
    assume Completion > 0;
    goto L45;
...
procedure {:origName "sdv_RunIoCompletionRoutines"} {:osmodel} sdv_RunIoCompletionRoutines#0(actual_DeviceObject_7: int, actual_Irp_6: int, actual_Context_2: int, actual_Completion: int) returns (Tmp_238: int);
  modifies alloc;
  free ensures {:va_keep} Tmp_238 == -1073741802 || Tmp_238 == 0;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} false || old(forward_state) == 1 || old(forward_state) == 0;
  free ensures {:va_keep} false || old(s) == 0 || old(s) == 2 || old(s) == 1;
  free ensures {:va_keep} alloc >= old(alloc);
...
implementation {:origName "sdv_RunIoCompletionRoutines"} {:osmodel} sdv_RunIoCompletionRoutines#1(actual_DeviceObject_7: int, actual_Irp_6: int, actual_Context_2: int, actual_Completion: int) returns (Tmp_238: int)
{
  ...
  anon0:
    ...
    Context_2 := actual_Context_2;
    Completion := actual_Completion;
    call {:si_unique_call 727} irpsp := sdv_IoGetNextIrpStackLocation(Irp_6);
    Status_13 := 0;
    assume {:nonnull} irpsp != 0;
    assume irpsp > 0;
    goto anon9_Then, anon9_Else;
  ...
  anon9_Else:
    assume {:partition} Mem_T.CompletionRoutine__IO_STACK_LOCATION[CompletionRoutine__IO_STACK_LOCATION(irpsp)] == li2bplFunctionConstant199;
    call {:si_unique_call 728} Status_13 := PpaPortLockCompletionRoutine#1(DeviceObject_7, Irp_6, Context_2);
    assume {:nonnull} Completion != 0;
    assume Completion > 0;
    goto L11;
  ...
  anon7_Else:
    assume {:partition} Mem_T.CompletionRoutine__IO_STACK_LOCATION[CompletionRoutine__IO_STACK_LOCATION(irpsp)] == li2bplFunctionConstant200;
    call {:si_unique_call 729} Status_13 := PpaPortUnlockCompletionRoutine(DeviceObject_7, Irp_6, Context_2);
    assume {:nonnull} Completion != 0;
    assume Completion > 0;
    goto L28;
  ...
  anon8_Else:
    assume {:partition} Mem_T.CompletionRoutine__IO_STACK_LOCATION[CompletionRoutine__IO_STACK_LOCATION(irpsp)] == li2bplFunctionConstant134;
    call {:si_unique_call 730} Status_13 := PpaRequestCompletionRoutine(DeviceObject_7, Irp_6, Context_2);
    assume {:nonnull} Completion != 0;
    assume Completion > 0;
    goto L45;
...
implementation {:SIextraRecBound 4} PpaGetRegistryParameters_loop_L56(in_i: int, in_Tmp_3: int, in_CheckMode: int, in_sdv_1: int, in_sdv_3: int, in_Tmp_6: int, in_sdv_6: int, in_sdv_8: int, in_Tmp_8: int, in_Tmp_9: int, in_Found: int, in_Extension: int) returns (out_i: int, out_Tmp_3: int, out_sdv_1: int, out_sdv_3: int, out_Tmp_6: int, out_sdv_6: int, out_sdv_8: int, out_Tmp_8: int, out_Tmp_9: int, out_Found: int)
{
  ...
  anon36_Else:
    ...
    call {:si_unique_call 737} RtlInitUnicodeString(in_CheckMode, out_Tmp_8);
    call {:si_unique_call 738} out_sdv_6 := corral_nondet();
    goto anon32_Then, anon32_Else;
  ...
  L62_dummy:
    call {:si_unique_call 739} {:si_old_unique_call 1} out_i, out_Tmp_3, out_sdv_1, out_sdv_3, out_Tmp_6, out_sdv_6, out_sdv_8, out_Tmp_8, out_Tmp_9, out_Found := PpaGetRegistryParameters_loop_L56(out_i, out_Tmp_3, in_CheckMode, out_sdv_1, out_sdv_3, out_Tmp_6, out_sdv_6, out_sdv_8, out_Tmp_8, out_Tmp_9, out_Found, in_Extension);
    return;
  ...
  anon37_Then:
    ...
    call {:si_unique_call 735} RtlInitUnicodeString(in_CheckMode, out_Tmp_9);
    call {:si_unique_call 736} out_sdv_1 := corral_nondet();
    goto anon33_Then, anon33_Else;
  ...
  anon38_Then:
    ...
    call {:si_unique_call 733} RtlInitUnicodeString(in_CheckMode, out_Tmp_3);
    call {:si_unique_call 734} out_sdv_8 := corral_nondet();
    goto anon34_Then, anon34_Else;
  ...
  anon31_Then:
    ...
    call {:si_unique_call 731} RtlInitUnicodeString(in_CheckMode, out_Tmp_6);
    call {:si_unique_call 732} out_sdv_3 := corral_nondet();
    goto anon35_Then, anon35_Else;
...
implementation VPI0DataIn_loop_L14(in_ChunkSize: int, in_sdv_13: int, in_Status_2: int, in_BytesRead: int, in_Extension_2: int) returns (out_ChunkSize: int, out_sdv_13: int, out_Status_2: int)
{
  ...
  anon24_Else:
    call {:si_unique_call 741} out_sdv_13 := VPI0GetPhase(in_Extension_2);
    goto anon25_Else;
  ...
  L27:
    ...
    call {:si_unique_call 740} out_Status_2 := VPI0ParallelRead(in_Extension_2, vslice_dummy_var_222, out_ChunkSize, in_BytesRead);
    assume {:nonnull} in_Extension_2 != 0;
    assume in_Extension_2 > 0;
    goto anon29_Else;
  ...
  L_BAF_0:
    call {:si_unique_call 742} {:si_old_unique_call 1} out_ChunkSize, out_sdv_13, out_Status_2 := VPI0DataIn_loop_L14(out_ChunkSize, out_sdv_13, out_Status_2, in_BytesRead, in_Extension_2);
    return;
...
implementation VPI0Selection_loop_L28(in_i_1: int, in_sdv_15: int, in_Controller: int, in_Tmp_32: int) returns (out_i_1: int, out_sdv_15: int, out_Tmp_32: int)
{
  ...
  anon5_Else:
    ...
    call {:si_unique_call 743} out_sdv_15 := corral_nondet();
...
implementation VPI0DataOut_loop_L14(in_ChunkSize_1: int, in_sdv_20: int, in_Status_3: int, in_BytesWritten: int, in_Extension_6: int) returns (out_ChunkSize_1: int, out_sdv_20: int, out_Status_3: int)
{
  ...
  anon24_Else:
    call {:si_unique_call 745} out_sdv_20 := VPI0GetPhase(in_Extension_6);
    goto anon25_Else;
  ...
  L27:
    ...
    call {:si_unique_call 744} out_Status_3 := VPI0ParallelWrite(in_Extension_6, vslice_dummy_var_223, out_ChunkSize_1, in_BytesWritten);
    assume {:nonnull} in_Extension_6 != 0;
    assume in_Extension_6 > 0;
    goto anon29_Else;
  ...
  L_BAF_1:
    call {:si_unique_call 746} {:si_old_unique_call 1} out_ChunkSize_1, out_sdv_20, out_Status_3 := VPI0DataOut_loop_L14(out_ChunkSize_1, out_sdv_20, out_Status_3, in_BytesWritten, in_Extension_6);
    return;
...
implementation VPI0GetPhase_loop_L55(in_i_2: int, in_Tmp_59: int, in_Controller_2: int, in_sdv_31: int, in_vslice_dummy_var_13: int) returns (out_i_2: int, out_Tmp_59: int, out_sdv_31: int, out_vslice_dummy_var_13: int)
{
  ...
  anon26_Else:
    ...
    call {:si_unique_call 748} out_sdv_31 := corral_nondet();
    out_Tmp_59 := BAND(out_sdv_31, BOR(64, 128));
    goto anon27_Then;

  anon27_Then:
    assume {:partition} out_Tmp_59 != 192;
    call {:si_unique_call 747} out_vslice_dummy_var_13 := KeDelayExecutionThread(0, 0, 0);
    goto anon27_Then_dummy;
...
implementation VPI0GetPhase_loop_L41(in_i_2: int, in_Tmp_60: int, in_Controller_2: int, in_sdv_32: int) returns (out_i_2: int, out_Tmp_60: int, out_sdv_32: int)
{
  ...
  anon24_Else:
    assume {:partition} out_i_2 != 0;
    call {:si_unique_call 749} out_sdv_32 := corral_nondet();
...
implementation VPI0GetPhase_loop_L13(in_i_2: int, in_Tmp_58: int, in_sdv_27: int, in_Controller_2: int) returns (out_i_2: int, out_Tmp_58: int, out_sdv_27: int)
{
  ...
  anon22_Else:
    assume {:partition} out_i_2 != 0;
    call {:si_unique_call 750} out_sdv_27 := corral_nondet();
...
implementation VPI0Command_loop_L10(in_i_3: int, in_Tmp_65: int, in_Tmp_67: int, in_Tmp_68: int, in_success_4: int, in_sdv_33: int, in_Status_5: int, in_BytesWritten_1: int, in_Tmp_71: int, in_Tmp_72: int, in_Extension_10: int) returns (out_i_3: int, out_Tmp_65: int, out_Tmp_67: int, out_Tmp_68: int, out_success_4: int, out_sdv_33: int, out_Status_5: int, out_Tmp_71: int, out_Tmp_72: int)
{
  ...
  anon18_Else:
    call {:si_unique_call 752} out_sdv_33 := VPI0GetPhase(in_Extension_10);
    goto anon13_Else;
  ...
  L20:
    ...
    call {:si_unique_call 751} out_Status_5 := VPI0ParallelWrite(in_Extension_10, out_Tmp_67, 1, in_BytesWritten_1);
    assume {:nonnull} in_Extension_10 != 0;
    assume in_Extension_10 > 0;
    goto anon16_Then, anon16_Else;
  ...
  L39_dummy:
    call {:si_unique_call 753} {:si_old_unique_call 1} out_i_3, out_Tmp_65, out_Tmp_67, out_Tmp_68, out_success_4, out_sdv_33, out_Status_5, out_Tmp_71, out_Tmp_72 := VPI0Command_loop_L10(out_i_3, out_Tmp_65, out_Tmp_67, out_Tmp_68, out_success_4, out_sdv_33, out_Status_5, in_BytesWritten_1, out_Tmp_71, out_Tmp_72, in_Extension_10);
    return;
...
implementation VPI0DataNibbleRead_loop_L14(in_sdv_36: int, in_CharBufPtr_1: int, in_ByteRead: int, in_sdv_37: int, in_xferCount_1: int, in_Controller_4: int, in_ChunkSize_3: int) returns (out_sdv_36: int, out_ByteRead: int, out_sdv_37: int, out_xferCount_1: int)
{
  ...
  L14:
    call {:si_unique_call 754} out_sdv_36 := corral_nondet();
    call {:si_unique_call 755} out_sdv_37 := corral_nondet();
    call {:si_unique_call 756} out_ByteRead := corral_nondet();
...
implementation VPI0TrySelect_loop_L5(in_i_4: int, in_Tmp_105: int, in_Tmp_107: int, in_Controller_6: int) returns (out_i_4: int, out_Tmp_105: int, out_Tmp_107: int)
{
  ...
  anon3_Else:
    ...
    out_Tmp_107 := out_i_4;
    havoc out_Tmp_105;
    call {:si_unique_call 757} VPI0ClockSelectByte(in_Controller_6, out_Tmp_105);
    out_i_4 := out_i_4 + 1;
    goto anon3_Else_dummy;
...
implementation VPI0Deselect_loop_L5(in_i_5: int, in_Tmp_130: int, in_Tmp_131: int, in_Controller_10: int) returns (out_i_5: int, out_Tmp_130: int, out_Tmp_131: int)
{
  ...
  anon3_Else:
    ...
    out_Tmp_131 := out_i_5;
    havoc out_Tmp_130;
    call {:si_unique_call 758} VPI0ClockDeselectByte(in_Controller_10, out_Tmp_130);
    out_i_5 := out_i_5 + 1;
    goto anon3_Else_dummy;
...
implementation PpaPhaseMan_loop_L65(in_i_6: int, in_sdv_150: int, in_CurrPhase: int, in_Extension_23: int) returns (out_i_6: int, out_sdv_150: int)
{
  ...
  anon45_Else:
    ...
    call {:si_unique_call 759} out_sdv_150 := VPI0GetPhase(in_Extension_23);
    goto anon40_Else;
  ...
  anon41_Else_dummy:
    call {:si_unique_call 760} {:si_old_unique_call 1} out_i_6, out_sdv_150 := PpaPhaseMan_loop_L65(out_i_6, out_sdv_150, in_CurrPhase, in_Extension_23);
    return;
}
...
implementation PpaPhaseMan_loop_L8(in_i_6: int, in_Tmp_306: int, in_sdv_145: int, in_sdv_149: int, in_sdv_150: int, in_sdv_151: int, in_sdv_152: int, in_sdv_153: int, in_Tmp_314: int, in_CurrPhase: int, in_busBusy: int, in_Extension_23: int, in_vslice_dummy_var_67: int) returns (out_i_6: int, out_Tmp_306: int, out_sdv_145: int, out_sdv_149: int, out_sdv_150: int, out_sdv_151: int, out_sdv_152: int, out_sdv_153: int, out_Tmp_314: int, out_CurrPhase: int, out_busBusy: int, out_vslice_dummy_var_67: int)
{

  entry:
    out_i_6, out_Tmp_306, out_sdv_145, out_sdv_149, out_sdv_150, out_sdv_151, out_sdv_152, out_sdv_153, out_Tmp_314, out_CurrPhase, out_busBusy, out_vslice_dummy_var_67 := in_i_6, in_Tmp_306, in_sdv_145, in_sdv_149, in_sdv_150, in_sdv_151, in_sdv_152, in_sdv_153, in_Tmp_314, in_CurrPhase, in_busBusy, in_vslice_dummy_var_67;
    goto L8, exit;
  ...
  anon32_Else:
    call {:si_unique_call 764} out_sdv_145 := VPI0GetPhase(in_Extension_23);
    goto anon33_Else;
  ...
  anon42_Else:
    call {:si_unique_call 761} out_sdv_153 := PpaStatus(in_Extension_23);
    goto anon35_Else;
  ...
  L_BAF_2:
    call {:si_unique_call 769} {:si_old_unique_call 1} out_i_6, out_Tmp_306, out_sdv_145, out_sdv_149, out_sdv_150, out_sdv_151, out_sdv_152, out_sdv_153, out_Tmp_314, out_CurrPhase, out_busBusy, out_vslice_dummy_var_67 := PpaPhaseMan_loop_L8(out_i_6, out_Tmp_306, out_sdv_145, out_sdv_149, out_sdv_150, out_sdv_151, out_sdv_152, out_sdv_153, out_Tmp_314, out_CurrPhase, out_busBusy, in_Extension_23, out_vslice_dummy_var_67);
    return;

  anon42_Then:
    out_busBusy := 0;
    call {:si_unique_call 765} out_vslice_dummy_var_67 := PpaResetBus(in_Extension_23);
    assume {:nonnull} in_Extension_23 != 0;
    assume in_Extension_23 > 0;
    havoc out_Tmp_314;
  ...
  anon43_Then:
    call {:si_unique_call 766} out_sdv_152 := PpaCommand(in_Extension_23);
    goto anon36_Then;
  ...
  anon44_Then:
    call {:si_unique_call 767} out_sdv_151 := PpaDataIn(in_Extension_23);
    goto anon37_Then;
  ...
  anon34_Then:
    call {:si_unique_call 768} out_sdv_149 := PpaDataOut(in_Extension_23);
    goto anon38_Then;
  ...
  L65:
    call {:si_unique_call 762} out_i_6, out_sdv_150 := PpaPhaseMan_loop_L65(out_i_6, out_sdv_150, out_CurrPhase, in_Extension_23);
    goto L65_last;
  ...
  anon45_Else:
    assume {:partition} out_i_6 != 0;
    call {:si_unique_call 763} out_sdv_150 := VPI0GetPhase(in_Extension_23);
    goto anon40_Then, anon40_Else;
...
procedure {:LoopProcedure} PpaPhaseMan_loop_L8(in_i_6: int, in_Tmp_306: int, in_sdv_145: int, in_sdv_149: int, in_sdv_150: int, in_sdv_151: int, in_sdv_152: int, in_sdv_153: int, in_Tmp_314: int, in_CurrPhase: int, in_busBusy: int, in_Extension_23: int, in_vslice_dummy_var_67: int) returns (out_i_6: int, out_Tmp_306: int, out_sdv_145: int, out_sdv_149: int, out_sdv_150: int, out_sdv_151: int, out_sdv_152: int, out_sdv_153: int, out_Tmp_314: int, out_CurrPhase: int, out_busBusy: int, out_vslice_dummy_var_67: int);
  ...
  free ensures {:va_keep} out_vslice_dummy_var_67 == 0 || out_vslice_dummy_var_67 == -1073741823 || out_vslice_dummy_var_67 == in_vslice_dummy_var_67;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} false || old(forward_state) == 1 || old(forward_state) == 0;
  free ensures {:va_keep} false || old(s) == 0 || old(s) == 2 || old(s) == 1;
  free ensures {:va_keep} alloc >= old(alloc);
...
implementation PpaIssueInquiry_loop_L14(in_cdb: int, in_Tmp_358: int, in_Tmp_359: int, in_Tmp_360: int, in_srb_3: int, in_status_7: int, in_Tmp_362: int, in_retryCount: int, in_Extension_34: int) returns (out_cdb: int, out_Tmp_358: int, out_Tmp_359: int, out_Tmp_360: int, out_status_7: int, out_Tmp_362: int, out_retryCount: int)
{
  ...
  L14:
    call {:si_unique_call 770} sdv_RtlZeroMemory(0, 64);
    ...
    assume {:nonnull} in_Extension_34 != 0;
    assume in_Extension_34 > 0;
    call {:si_unique_call 771} IoStartTimer(0);
    call {:si_unique_call 772} out_status_7 := PpaStartExecution(in_Extension_34);
    assume {:nonnull} in_Extension_34 != 0;
    assume in_Extension_34 > 0;
    call {:si_unique_call 773} IoStopTimer(0);
    goto anon19_Else;
  ...
  anon21_Then_dummy:
    call {:si_unique_call 774} {:si_old_unique_call 1} out_cdb, out_Tmp_358, out_Tmp_359, out_Tmp_360, out_status_7, out_Tmp_362, out_retryCount := PpaIssueInquiry_loop_L14(out_cdb, out_Tmp_358, out_Tmp_359, out_Tmp_360, in_srb_3, out_status_7, out_Tmp_362, out_retryCount, in_Extension_34);
    return;
...
implementation PpaIssueRequestSense_loop_L18(in_Tmp_370: int, in_Tmp_371: int, in_Tmp_372: int, in_Tmp_373: int, in_Tmp_374: int, in_Tmp_376: int, in_pIrpStack_4: int, in_Tmp_377: int, in_Tmp_379: int, in_Tmp_380: int, in_srb_4: int, in_status_9: int, in_Tmp_381: int, in_Tmp_382: int, in_retryCount_1: int, in_Tmp_383: int, in_Tmp_384: int, in_Extension_37: int) returns (out_Tmp_370: int, out_Tmp_371: int, out_Tmp_372: int, out_Tmp_373: int, out_Tmp_374: int, out_Tmp_376: int, out_Tmp_377: int, out_Tmp_379: int, out_Tmp_380: int, out_status_9: int, out_Tmp_381: int, out_Tmp_382: int, out_retryCount_1: int, out_Tmp_383: int, out_Tmp_384: int)
{
  ...
  L18:
    call {:si_unique_call 775} sdv_RtlZeroMemory(0, 64);
    ...
    assume {:nonnull} in_Extension_37 != 0;
    assume in_Extension_37 > 0;
    call {:si_unique_call 776} IoStartTimer(0);
    call {:si_unique_call 777} out_status_9 := PpaStartExecution(in_Extension_37);
    assume {:nonnull} in_Extension_37 != 0;
    assume in_Extension_37 > 0;
    call {:si_unique_call 778} IoStopTimer(0);
    goto anon17_Else;
...
implementation PpaStartDevice_loop_L26(in_Status_25: int, in_Extension_46: int) returns (out_Status_25: int)
{
  ...
  anon18_Else:
    call {:si_unique_call 780} out_Status_25 := PpaIssueInquiry(in_Extension_46);
    goto anon19_Else;
  ...
  anon19_Else_dummy:
    call {:si_unique_call 781} {:si_old_unique_call 1} out_Status_25 := PpaStartDevice_loop_L26(out_Status_25, in_Extension_46);
    return;
}
...
implementation PpaStartDevice_loop_L20(in_Status_25: int, in_Extension_46: int, in_sdv_235: int) returns (out_Status_25: int, out_sdv_235: int)
{
  ...
  L20:
    call {:si_unique_call 782} PpaPortLock(in_Extension_46, 1, 0);
    assume {:nonnull} in_Extension_46 != 0;
    assume in_Extension_46 > 0;
    goto anon17_Else;
  ...
  L26:
    call {:si_unique_call 785} out_Status_25 := PpaStartDevice_loop_L26(out_Status_25, in_Extension_46);
    goto L26_last;
  ...
  anon18_Else:
    call {:si_unique_call 786} out_Status_25 := PpaIssueInquiry(in_Extension_46);
    goto anon19_Then, anon19_Else;
  ...
  L27:
    call {:si_unique_call 784} PpaPortUnlock#1(in_Extension_46, 1, 0);
    goto anon20_Else;

  anon20_Else:
    assume {:partition} out_Status_25 != 0;
    call {:si_unique_call 783} out_sdv_235 := PpaTrySlowerMode(in_Extension_46);
    goto anon21_Then;
  ...
  anon21_Then_dummy:
    call {:si_unique_call 787} {:si_old_unique_call 1} out_Status_25, out_sdv_235 := PpaStartDevice_loop_L20(out_Status_25, in_Extension_46, out_sdv_235);
    return;
