...
procedure {:origName "_sdv_init2"} _sdv_init2();
  ...
  free ensures {:va_keep} false || old(handleState) == 1 || old(handleState) == 2 || old(handleState) == 0;
  free ensures {:va_keep} alloc >= old(alloc);
  free ensures {:va_keep} false || handleState == 1 || handleState == 2 || handleState == 0;
...
implementation {:origName "DoCallbackSamples"} DoCallbackSamples(actual_DeviceObject: int, actual_Irp: int) returns (Tmp_2: int)
{
  ...
  L103:
    call {:si_unique_call 46} vslice_dummy_var_3 := ZwClose(0);
    goto L19;
  ...
  anon47_Else:
    assume Mem_T.PVOID[g_RootKey] == SLAM_guard_O_0;
    assume SLAM_guard_O_0 != SLAM_guard_O_0_init;
    call {:si_unique_call 47} SLIC_ZwCreateKey_exit(strConst__li2bpl4, Status);
  ...
  anon46_Else:
    ...
    call {:si_unique_call 35} sdv_6 := PreNotificationBlockSample();
  ...
  anon53_Else:
    ...
    assume Tmp_6 > 0;
    call {:si_unique_call 36} sdv_18 := PreNotificationBypassSample();
  ...
  anon54_Else:
    ...
    assume Tmp_10 > 0;
    call {:si_unique_call 37} sdv_9 := PostNotificationOverrideSuccessSample();
  ...
  anon55_Else:
    ...
    assume Tmp_14 > 0;
    call {:si_unique_call 38} sdv := PostNotificationOverrideErrorSample();
  ...
  anon56_Else:
    ...
    assume Tmp_7 > 0;
    call {:si_unique_call 39} sdv_2 := TransactionEnlistSample();
  ...
  anon57_Else:
    ...
    assume Tmp_15 > 0;
    call {:si_unique_call 40} sdv_14 := TransactionReplaySample();
  ...
  anon58_Else:
    ...
    assume Tmp_17 > 0;
    call {:si_unique_call 41} sdv_15 := SetObjectContextSample();
  ...
  anon59_Else:
    ...
    assume Tmp_13 > 0;
    call {:si_unique_call 42} sdv_17 := SetCallContextSample();
  ...
  anon60_Else:
    ...
    assume Tmp_16 > 0;
    call {:si_unique_call 43} sdv_1 := MultipleAltitudeBlockDuringPreSample();
  ...
  anon61_Else:
    ...
    assume Tmp_5 > 0;
    call {:si_unique_call 44} sdv_4 := MultipleAltitudeInternalInvocationSample();
  ...
  anon62_Else:
    ...
    assume Tmp_23 > 0;
    call {:si_unique_call 45} sdv_10 := CreateOpenV1Sample();
  ...
  anon46_Then:
    ...
    call {:si_unique_call 34} vslice_dummy_var_15 := corral_nondet();
    Tmp_2 := Status;
    goto L1;
...
implementation {:origName "UnRegisterCallback"} UnRegisterCallback(actual_DeviceObject_1: int, actual_Irp_1: int) returns (Tmp_24: int)
{
  ...
  anon12_Then:
    ...
    call {:si_unique_call 58} Status_1 := CmUnRegisterCallback(vslice_dummy_var_121);
...
implementation {:origName "DeleteTestKeys"} DeleteTestKeys()
{
  ...
  anon71_Else:
    ...
    assume SLAM_guard_O_0 != SLAM_guard_O_0_init;
    call {:si_unique_call 115} SLIC_ZwOpenKey_exit(0, Status_2);
    goto L20;
  ...
  anon72_Else:
    ...
    assume SLAM_guard_O_0 != SLAM_guard_O_0_init;
    call {:si_unique_call 116} SLIC_ZwOpenKey_exit(0, Status_2);
    goto L36;
  ...
  anon73_Else:
    assume Mem_T.PVOID[ChildKey] == SLAM_guard_O_0;
    assume SLAM_guard_O_0 != SLAM_guard_O_0_init;
    call {:si_unique_call 117} SLIC_ZwOpenKey_exit(0, Status_2);
    goto L55;
  ...
  L64:
    ...
    assume {:nonnull} ChildKey != 0;
    assume ChildKey > 0;
    SLAM_guard_O_0 := Mem_T.PVOID[ChildKey];
    assume SLAM_guard_O_0 != 0;
    assume SLAM_guard_O_0 != SLAM_guard_O_0_init;
    call {:si_unique_call 106} SLIC_ZwOpenKey_exit(0, Status_2);
  ...
  anon67_Else:
    assume Mem_T.PVOID[ChildKey] == SLAM_guard_O_0;
    assume SLAM_guard_O_0 != SLAM_guard_O_0_init;
    call {:si_unique_call 108} SLIC_ZwDeleteKey_entry(strConst__li2bpl4);
  ...
  L127:
    call {:si_unique_call 109} vslice_dummy_var_34 := ZwDeleteKey(0);
    assume {:nonnull} ChildKey != 0;
    assume ChildKey > 0;
  ...
  anon68_Else:
    assume Mem_T.PVOID[ChildKey] == SLAM_guard_O_0;
    assume SLAM_guard_O_0 != SLAM_guard_O_0_init;
    call {:si_unique_call 110} SLIC_ZwClose_entry(strConst__li2bpl4);
  ...
  L130:
    call {:si_unique_call 111} vslice_dummy_var_35 := ZwClose(0);
    assume {:nonnull} ChildKey != 0;
    assume ChildKey > 0;
    Mem_T.PVOID[ChildKey] := 0;
    goto L83;
  ...
  anon69_Else:
    assume Mem_T.PVOID[RootKey] == SLAM_guard_O_0;
    assume SLAM_guard_O_0 != SLAM_guard_O_0_init;
    call {:si_unique_call 112} SLIC_ZwDeleteKey_entry(strConst__li2bpl4);
  ...
  L133:
    call {:si_unique_call 113} vslice_dummy_var_36 := ZwDeleteKey(0);
    assume {:nonnull} RootKey != 0;
    assume RootKey > 0;
  ...
  anon70_Else:
    assume Mem_T.PVOID[RootKey] == SLAM_guard_O_0;
    assume SLAM_guard_O_0 != SLAM_guard_O_0_init;
    call {:si_unique_call 114} SLIC_ZwClose_entry(strConst__li2bpl4);
  ...
  L136:
    call {:si_unique_call 118} vslice_dummy_var_37 := ZwClose(0);
    goto L1;
  ...
  anon66_Else:
    assume {:partition} Status_2 != -1073741772;
    call {:si_unique_call 107} vslice_dummy_var_49 := corral_nondet();
    goto L83;
...
implementation {:origName "RegisterCallback"} RegisterCallback(actual_DeviceObject_2: int, actual_Irp_2: int) returns (Tmp_51: int)
{
  ...
  anon0:
    ...
    Irp_2 := actual_Irp_2;
    call {:si_unique_call 119} vslice_dummy_var_53 := __HAVOC_malloc(184);
    call {:si_unique_call 120} vslice_dummy_var_54 := __HAVOC_malloc(128);
    call {:si_unique_call 121} vslice_dummy_var_55 := __HAVOC_malloc(192);
    call {:si_unique_call 122} vslice_dummy_var_56 := __HAVOC_malloc(32);
    call {:si_unique_call 123} vslice_dummy_var_57 := __HAVOC_malloc(32);
    call {:si_unique_call 124} vslice_dummy_var_58 := __HAVOC_malloc(32);
    Status_3 := 0;
    CallbackCtx := 0;
    call {:si_unique_call 125} IrpStack_2 := sdv_IoGetCurrentIrpStackLocation(Irp_2);
  ...
  anon12_Else:
    ...
    call {:si_unique_call 128} vslice_dummy_var_59 := corral_nondet();
    goto L29;
  ...
  anon12_Then:
    ...
    call {:si_unique_call 127} vslice_dummy_var_60 := corral_nondet();
    goto L29;
  ...
  anon11_Else:
    ...
    call {:si_unique_call 126} sdv_46 := CreateCallbackContext(vslice_dummy_var_122, vslice_dummy_var_123);
    CallbackCtx := sdv_46;
  ...
  anon15_Else:
    ...
    call {:si_unique_call 129} Status_3 := CmRegisterCallbackEx(li2bplFunctionConstant345, 0, vslice_dummy_var_124, 0, 0, 0);
  ...
  anon13_Then:
    assume {:partition} 0 > Status_3;
    call {:si_unique_call 130} vslice_dummy_var_61 := corral_nondet();
    goto L22;
...
implementation {:origName "GetCallbackVersion"} GetCallbackVersion(actual_DeviceObject_3: int, actual_Irp_3: int) returns (Tmp_59: int)
{
  ...
  anon0:
    Irp_3 := actual_Irp_3;
    call {:si_unique_call 131} vslice_dummy_var_62 := __HAVOC_malloc(32);
    call {:si_unique_call 132} vslice_dummy_var_63 := __HAVOC_malloc(32);
    call {:si_unique_call 133} vslice_dummy_var_64 := __HAVOC_malloc(192);
    call {:si_unique_call 134} vslice_dummy_var_65 := __HAVOC_malloc(136);
    Status_4 := 0;
    call {:si_unique_call 135} IrpStack_3 := sdv_IoGetCurrentIrpStackLocation(Irp_3);
  ...
  anon5_Else:
    ...
    call {:si_unique_call 137} vslice_dummy_var_66 := corral_nondet();
    goto L24;
  ...
  anon5_Then:
    ...
    call {:si_unique_call 136} vslice_dummy_var_67 := corral_nondet();
    goto L24;
...
implementation {:origName "SetCallContextSample"} SetCallContextSample() returns (Tmp_65: int)
{
  ...
  anon0:
    call {:si_unique_call 138} Key := __HAVOC_malloc(4);
    call {:si_unique_call 139} vslice_dummy_var_68 := __HAVOC_malloc(24);
    call {:si_unique_call 140} Name := __HAVOC_malloc(12);
    call {:si_unique_call 141} Tmp_66 := __HAVOC_malloc(28);
    call {:si_unique_call 142} vslice_dummy_var_72 := __HAVOC_malloc(32);
    call {:si_unique_call 143} vslice_dummy_var_73 := __HAVOC_malloc(164);
    call {:si_unique_call 144} vslice_dummy_var_74 := __HAVOC_malloc(32);
    call {:si_unique_call 145} vslice_dummy_var_75 := __HAVOC_malloc(32);
    call {:si_unique_call 146} vslice_dummy_var_76 := __HAVOC_malloc(32);
    call {:si_unique_call 147} Tmp_73 := __HAVOC_malloc(56);
    call {:si_unique_call 148} vslice_dummy_var_77 := __HAVOC_malloc(32);
    call {:si_unique_call 149} vslice_dummy_var_78 := __HAVOC_malloc(32);
    call {:si_unique_call 150} Tmp_76 := __HAVOC_malloc(48);
    call {:si_unique_call 151} vslice_dummy_var_79 := __HAVOC_malloc(32);
    call {:si_unique_call 152} vslice_dummy_var_80 := __HAVOC_malloc(164);
    call {:si_unique_call 153} vslice_dummy_var_81 := __HAVOC_malloc(192);
    call {:si_unique_call 154} vslice_dummy_var_82 := __HAVOC_malloc(252);
    call {:si_unique_call 155} vslice_dummy_var_83 := __HAVOC_malloc(172);
    call {:si_unique_call 156} vslice_dummy_var_84 := __HAVOC_malloc(32);
    call {:si_unique_call 157} vslice_dummy_var_85 := __HAVOC_malloc(160);
    call {:si_unique_call 158} vslice_dummy_var_86 := __HAVOC_malloc(24);
    call {:si_unique_call 159} vslice_dummy_var_87 := __HAVOC_malloc(200);
    call {:si_unique_call 160} vslice_dummy_var_88 := __HAVOC_malloc(160);
    call {:si_unique_call 161} vslice_dummy_var_89 := __HAVOC_malloc(32);
    call {:si_unique_call 162} Tmp_88 := __HAVOC_malloc(56);
    CallbackCtx_1 := 0;
    assume {:nonnull} Key != 0;
    assume Key > 0;
    Mem_T.PVOID[Key] := 0;
    Success := 0;
    call {:si_unique_call 163} vslice_dummy_var_90 := corral_nondet();
    call {:si_unique_call 164} vslice_dummy_var_91 := corral_nondet();
    Tmp_66 := strConst__li2bpl20;
    call {:si_unique_call 165} sdv_59 := CreateCallbackContext(9, Tmp_66);
  ...
  anon41_Else:
    ...
    call {:si_unique_call 180} vslice_dummy_var_93 := corral_nondet();
    goto L80;
  ...
  anon43_Else:
    ...
    assume SLAM_guard_O_0 != SLAM_guard_O_0_init;
    call {:si_unique_call 183} SLIC_ZwDeleteKey_entry(strConst__li2bpl4);
    goto anon50_Then, anon50_Else;
  ...
  L116:
    call {:si_unique_call 184} vslice_dummy_var_70 := ZwDeleteKey(0);
    assume {:nonnull} Key != 0;
    assume Key > 0;
    goto anon44_Then, anon44_Else;
  ...
  anon44_Else:
    assume Mem_T.PVOID[Key] == SLAM_guard_O_0;
    assume SLAM_guard_O_0 != SLAM_guard_O_0_init;
    call {:si_unique_call 185} SLIC_ZwClose_entry(strConst__li2bpl4);
    goto anon51_Then, anon51_Else;
  ...
  L119:
    call {:si_unique_call 188} vslice_dummy_var_71 := ZwClose(0);
    goto L81;

  L81:
    Tmp_73 := strConst__li2bpl21;
    call {:si_unique_call 181} RtlInitUnicodeString(Name, Tmp_73);
    call {:si_unique_call 182} vslice_dummy_var_69 := ZwDeleteValueKey(0, 0);
    goto anon45_Then, anon45_Else;

  anon45_Else:
    assume {:partition} CallbackCtx_1 != 0;
    call {:si_unique_call 186} ExFreePoolWithTag(0, 812934738);
    goto L94;
  ...
  anon41_Then:
    assume {:partition} Success != 1;
    call {:si_unique_call 179} vslice_dummy_var_94 := corral_nondet();
    goto L80;

  anon47_Then:
    assume {:partition} CallbackCtx_1 != 0;
    havoc vslice_dummy_var_125;
    call {:si_unique_call 166} Status_5 := CmRegisterCallbackEx(li2bplFunctionConstant345, 0, vslice_dummy_var_125, 0, 0, 0);
  ...
  anon35_Else:
    ...
    call {:si_unique_call 168} RtlInitUnicodeString(Name, Tmp_76);
    call {:si_unique_call 169} sdv_InitializeObjectAttributes(0, 0, 576, 0, 0);
    call {:si_unique_call 170} Status_5 := ZwCreateKey(Key, 983103, 0, 0, 0, 0, 0);
    assume {:nonnull} Key != 0;
    assume Key > 0;
    goto anon46_Then, anon46_Else;
  ...
  anon46_Else:
    assume Mem_T.PVOID[Key] == SLAM_guard_O_0;
    assume SLAM_guard_O_0 != SLAM_guard_O_0_init;
    call {:si_unique_call 187} SLIC_ZwCreateKey_exit(strConst__li2bpl4, Status_5);
    goto anon48_Then, anon48_Else;
  ...
  L49:
    ...
    call {:si_unique_call 172} RtlInitUnicodeString(Name, Tmp_88);
    goto anon37_Then, anon37_Else;

  anon37_Else:
    assume Mem_T.PVOID[g_RootKey] == SLAM_guard_O_0;
    assume SLAM_guard_O_0 != SLAM_guard_O_0_init;
    call {:si_unique_call 173} SLIC_ZwSetValueKey_entry(strConst__li2bpl4);
    goto anon49_Then, anon49_Else;
  ...
  L113:
    call {:si_unique_call 174} Status_5 := ZwSetValueKey(0, 0, 0, 4, 0, 4);
  ...
  L60:
    ...
    call {:si_unique_call 176} Status_5 := CmUnRegisterCallback(vslice_dummy_var_126);
  ...
  anon40_Else:
    call {:si_unique_call 178} vslice_dummy_var_92 := corral_nondet();
    Success := 0;
    goto L69;
  ...
  anon39_Then:
    ...
    call {:si_unique_call 177} vslice_dummy_var_95 := corral_nondet();
    Success := 0;
    goto L68;

  anon38_Then:
    assume {:partition} 0 > Status_5;
    call {:si_unique_call 175} vslice_dummy_var_96 := corral_nondet();
    Success := 0;
    goto L60;
  ...
  anon36_Then:
    assume {:partition} 0 > Status_5;
    call {:si_unique_call 171} vslice_dummy_var_97 := corral_nondet();
    Success := 0;
    goto L49;
  ...
  anon35_Then:
    assume {:partition} 0 > Status_5;
    call {:si_unique_call 167} vslice_dummy_var_98 := corral_nondet();
    goto L69;
}
...
implementation {:origName "SetObjectContextSample"} SetObjectContextSample() returns (Tmp_89: int)
{
  ...
  anon0:
    call {:si_unique_call 189} vslice_dummy_var_99 := __HAVOC_malloc(24);
    call {:si_unique_call 190} RootKeyWithContext := __HAVOC_malloc(4);
    call {:si_unique_call 191} Name_1 := __HAVOC_malloc(12);
    call {:si_unique_call 192} vslice_dummy_var_102 := __HAVOC_malloc(204);
    call {:si_unique_call 193} Tmp_91 := __HAVOC_malloc(160);
    call {:si_unique_call 194} vslice_dummy_var_103 := __HAVOC_malloc(32);
    call {:si_unique_call 195} vslice_dummy_var_104 := __HAVOC_malloc(32);
    call {:si_unique_call 196} vslice_dummy_var_105 := __HAVOC_malloc(300);
    call {:si_unique_call 197} vslice_dummy_var_106 := __HAVOC_malloc(32);
    call {:si_unique_call 198} vslice_dummy_var_107 := __HAVOC_malloc(160);
    call {:si_unique_call 199} vslice_dummy_var_108 := __HAVOC_malloc(32);
    call {:si_unique_call 200} vslice_dummy_var_109 := __HAVOC_malloc(32);
    call {:si_unique_call 201} vslice_dummy_var_110 := __HAVOC_malloc(32);
    call {:si_unique_call 202} vslice_dummy_var_111 := __HAVOC_malloc(160);
    call {:si_unique_call 203} vslice_dummy_var_112 := __HAVOC_malloc(24);
    call {:si_unique_call 204} vslice_dummy_var_113 := __HAVOC_malloc(160);
    call {:si_unique_call 205} vslice_dummy_var_114 := __HAVOC_malloc(280);
    call {:si_unique_call 206} Tmp_105 := __HAVOC_malloc(56);
    call {:si_unique_call 207} vslice_dummy_var_115 := __HAVOC_malloc(32);
    call {:si_unique_call 208} vslice_dummy_var_116 := __HAVOC_malloc(32);
    call {:si_unique_call 209} Tmp_108 := __HAVOC_malloc(28);
    call {:si_unique_call 210} vslice_dummy_var_117 := __HAVOC_malloc(172);
    call {:si_unique_call 211} vslice_dummy_var_118 := __HAVOC_malloc(192);
    call {:si_unique_call 212} vslice_dummy_var_119 := __HAVOC_malloc(32);
    call {:si_unique_call 213} Tmp_112 := __HAVOC_malloc(56);
    call {:si_unique_call 214} vslice_dummy_var_120 := __HAVOC_malloc(168);
    call {:si_unique_call 215} vslice_dummy_var_121 := __HAVOC_malloc(308);
    call {:si_unique_call 216} vslice_dummy_var_122 := __HAVOC_malloc(32);
    call {:si_unique_call 217} vslice_dummy_var_123 := __HAVOC_malloc(200);
    call {:si_unique_call 218} vslice_dummy_var_124 := __HAVOC_malloc(32);
    call {:si_unique_call 219} vslice_dummy_var_125 := __HAVOC_malloc(32);
    CallbackCtx_2 := 0;
    assume {:nonnull} RootKeyWithContext != 0;
    assume RootKeyWithContext > 0;
    Mem_T.PVOID[RootKeyWithContext] := 0;
    Success_1 := 0;
    call {:si_unique_call 220} vslice_dummy_var_126 := corral_nondet();
    call {:si_unique_call 221} vslice_dummy_var_127 := corral_nondet();
    Tmp_108 := strConst__li2bpl20;
    call {:si_unique_call 222} sdv_79 := CreateCallbackContext(10, Tmp_108);
  ...
  anon52_Else:
    ...
    call {:si_unique_call 242} vslice_dummy_var_131 := corral_nondet();
    goto L100;

  L100:
    Tmp_112 := strConst__li2bpl21;
    call {:si_unique_call 243} RtlInitUnicodeString(Name_1, Tmp_112);
    call {:si_unique_call 244} vslice_dummy_var_100 := ZwDeleteValueKey(0, 0);
    assume {:nonnull} RootKeyWithContext != 0;
    assume RootKeyWithContext > 0;
    goto anon53_Then, anon53_Else;
  ...
  anon55_Else:
    ...
    assume SLAM_guard_O_0 != SLAM_guard_O_0_init;
    call {:si_unique_call 246} SLIC_ZwClose_entry(strConst__li2bpl4);
    goto anon60_Then, anon60_Else;
  ...
  L139:
    call {:si_unique_call 248} vslice_dummy_var_101 := ZwClose(0);
    goto L107;
  ...
  anon54_Else:
    assume {:partition} CallbackCtx_2 != 0;
    call {:si_unique_call 245} ExFreePoolWithTag(0, 812934738);
    goto L111;
  ...
  anon52_Then:
    assume {:partition} Success_1 != 1;
    call {:si_unique_call 241} vslice_dummy_var_132 := corral_nondet();
    goto L100;

  anon57_Then:
    assume {:partition} CallbackCtx_2 != 0;
    havoc vslice_dummy_var_138;
    call {:si_unique_call 223} Status_6 := CmRegisterCallbackEx(li2bplFunctionConstant345, 0, vslice_dummy_var_138, 0, 0, 0);
    goto anon41_Then, anon41_Else;
  ...
  anon41_Else:
    ...
    call {:si_unique_call 225} RtlInitUnicodeString(Name_1, Tmp_91);
    call {:si_unique_call 226} sdv_InitializeObjectAttributes(0, 0, 576, 0, 0);
    call {:si_unique_call 227} Status_6 := ZwOpenKey(RootKeyWithContext, 983103, 0);
    assume {:nonnull} RootKeyWithContext != 0;
    assume RootKeyWithContext > 0;
    goto anon56_Then, anon56_Else;
  ...
  anon56_Else:
    assume Mem_T.PVOID[RootKeyWithContext] == SLAM_guard_O_0;
    assume SLAM_guard_O_0 != SLAM_guard_O_0_init;
    call {:si_unique_call 247} SLIC_ZwOpenKey_exit(0, Status_6);
    goto L45;
  ...
  L49:
    ...
    call {:si_unique_call 229} RtlInitUnicodeString(Name_1, Tmp_105);
    goto anon43_Then, anon43_Else;
  ...
  anon46_Else:
    assume Mem_T.PVOID[RootKeyWithContext] == SLAM_guard_O_0;
    assume SLAM_guard_O_0 != SLAM_guard_O_0_init;
    call {:si_unique_call 234} SLIC_ZwSetValueKey_entry(strConst__li2bpl4);
    goto anon59_Then, anon59_Else;
  ...
  L136:
    call {:si_unique_call 235} Status_6 := ZwSetValueKey(0, 0, 0, 4, 0, 4);
    goto anon47_Then, anon47_Else;

  anon47_Else:
    assume {:partition} Status_6 < 0;
    call {:si_unique_call 236} vslice_dummy_var_134 := corral_nondet();
    Success_1 := 0;
    goto L61;
  ...
  L61:
    ...
    call {:si_unique_call 233} Status_6 := CmUnRegisterCallback(vslice_dummy_var_139);
    goto anon48_Then, anon48_Else;
  ...
  anon49_Else:
    call {:si_unique_call 238} vslice_dummy_var_128 := corral_nondet();
    Success_1 := 0;
    goto L79;
  ...
  anon50_Else:
    call {:si_unique_call 239} vslice_dummy_var_129 := corral_nondet();
    Success_1 := 0;
    goto L84;
  ...
  anon51_Else:
    call {:si_unique_call 240} vslice_dummy_var_130 := corral_nondet();
    Success_1 := 0;
    goto L89;
  ...
  anon48_Then:
    ...
    call {:si_unique_call 237} vslice_dummy_var_133 := corral_nondet();
    goto L78;
  ...
  anon44_Then:
    assume {:partition} 0 > Status_6;
    call {:si_unique_call 232} vslice_dummy_var_135 := corral_nondet();
    Success_1 := 0;
    goto L60;
  ...
  anon42_Then:
    assume {:partition} 0 > Status_6;
    call {:si_unique_call 228} vslice_dummy_var_136 := corral_nondet();
    Success_1 := 0;
    goto L49;
  ...
  anon41_Then:
    assume {:partition} 0 > Status_6;
    call {:si_unique_call 224} vslice_dummy_var_137 := corral_nondet();
    goto L89;
}
...
implementation {:origName "_sdv_init8"} _sdv_init8()
{
  ...
  anon0:
    call {:si_unique_call 249} vslice_dummy_var_138 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "_sdv_init7"} _sdv_init7()
{
  ...
  anon0:
    call {:si_unique_call 250} vslice_dummy_var_139 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "CreateKTMResourceManager"} CreateKTMResourceManager(actual_CallbackRoutine: int, actual_RMKey: int) returns (Tmp_123: int)
{
  ...
  anon0:
    call {:si_unique_call 251} vslice_dummy_var_140 := __HAVOC_malloc(16);
    call {:si_unique_call 252} RMHandle := __HAVOC_malloc(4);
    call {:si_unique_call 253} vslice_dummy_var_141 := __HAVOC_malloc(24);
    call {:si_unique_call 254} TMHandle := __HAVOC_malloc(4);
    call {:si_unique_call 255} vslice_dummy_var_145 := __HAVOC_malloc(32);
    call {:si_unique_call 256} vslice_dummy_var_146 := __HAVOC_malloc(204);
    call {:si_unique_call 257} vslice_dummy_var_147 := __HAVOC_malloc(140);
    call {:si_unique_call 258} vslice_dummy_var_148 := __HAVOC_malloc(32);
    call {:si_unique_call 259} vslice_dummy_var_149 := __HAVOC_malloc(168);
    call {:si_unique_call 260} vslice_dummy_var_150 := __HAVOC_malloc(188);
    call {:si_unique_call 261} vslice_dummy_var_151 := __HAVOC_malloc(216);
    call {:si_unique_call 262} vslice_dummy_var_152 := __HAVOC_malloc(32);
    call {:si_unique_call 263} vslice_dummy_var_153 := __HAVOC_malloc(32);
    call {:si_unique_call 264} vslice_dummy_var_154 := __HAVOC_malloc(220);
    call {:si_unique_call 265} vslice_dummy_var_155 := __HAVOC_malloc(32);
    call {:si_unique_call 266} vslice_dummy_var_156 := __HAVOC_malloc(32);
    Status_7 := 0;
    ...
    call {:si_unique_call 267} vslice_dummy_var_157 := corral_nondet();
    call {:si_unique_call 268} sdv_InitializeObjectAttributes(0, 0, 512, 0, 0);
    call {:si_unique_call 269} Status_7 := ZwCreateTransactionManager(TMHandle, 983103, 0, 0, 1, 0);
    goto anon17_Then, anon17_Else;

  anon17_Else:
    assume {:partition} Status_7 >= 0;
    call {:si_unique_call 271} Status_7 := ExUuidCreate(0);
    goto anon18_Then, anon18_Else;

  anon18_Else:
    assume {:partition} Status_7 >= 0;
    call {:si_unique_call 273} sdv_InitializeObjectAttributes(0, 0, 512, 0, 0);
    call {:si_unique_call 274} Status_7 := ZwCreateResourceManager(RMHandle, 2031743, 0, 0, 0, 1, 0);
    goto anon19_Then, anon19_Else;

  anon19_Else:
    assume {:partition} Status_7 >= 0;
    call {:si_unique_call 276} Status_7 := ObReferenceObjectByHandle(0, 0, 0, 0, 0, 0);
    goto anon20_Then, anon20_Else;

  anon20_Else:
    assume {:partition} Status_7 >= 0;
    call {:si_unique_call 278} Status_7 := corral_nondet();
    call {:si_unique_call 279} vslice_dummy_var_142 := sdv_ObDereferenceObject(0);
  ...
  anon23_Else:
    ...
    call {:si_unique_call 281} vslice_dummy_var_143 := ZwClose(0);
    goto L69;
  ...
  anon24_Else:
    ...
    call {:si_unique_call 282} vslice_dummy_var_144 := ZwClose(0);
    goto L68;
  ...
  anon21_Then:
    assume {:partition} 0 > Status_7;
    call {:si_unique_call 280} vslice_dummy_var_158 := corral_nondet();
    goto L64;

  anon20_Then:
    assume {:partition} 0 > Status_7;
    call {:si_unique_call 277} vslice_dummy_var_159 := corral_nondet();
    goto L64;

  anon19_Then:
    assume {:partition} 0 > Status_7;
    call {:si_unique_call 275} vslice_dummy_var_160 := corral_nondet();
    goto L64;

  anon18_Then:
    assume {:partition} 0 > Status_7;
    call {:si_unique_call 272} vslice_dummy_var_161 := corral_nondet();
    goto L64;

  anon17_Then:
    assume {:partition} 0 > Status_7;
    call {:si_unique_call 270} vslice_dummy_var_162 := corral_nondet();
    goto L64;
}
...
implementation {:origName "DeleteKTMResourceManager"} DeleteKTMResourceManager()
{
  ...
  anon0:
    call {:si_unique_call 283} vslice_dummy_var_163 := __HAVOC_malloc(4);
    goto anon5_Then, anon5_Else;

  anon5_Else:
    call {:si_unique_call 284} vslice_dummy_var_164 := ZwClose(0);
    goto L4;
  ...
  anon6_Else:
    call {:si_unique_call 285} vslice_dummy_var_165 := ZwClose(0);
    goto L1;
...
implementation {:origName "ZwCreateResourceManager"} {:osmodel} ZwCreateResourceManager(actual_ResourceManagerHandle: int, actual_DesiredAccess: int, actual_TmHandle: int, actual_ResourceManagerGuid: int, actual_ObjectAttributes: int, actual_CreateOptions: int, actual_Description: int) returns (Tmp_149: int)
{
  ...
  anon3_Else:
    call {:si_unique_call 286} sdv_121 := __HAVOC_malloc(4);
...
implementation {:origName "sdv_stub_startio_end"} {:osmodel} sdv_stub_startio_end()
{
  ...
  anon0:
    call {:si_unique_call 287} vslice_dummy_var_166 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "ZwCreateTransactionManager"} {:osmodel} ZwCreateTransactionManager(actual_TmHandle_1: int, actual_DesiredAccess_1: int, actual_ObjectAttributes_1: int, actual_LogFileName: int, actual_CreateOptions_1: int, actual_CommitStrength: int) returns (Tmp_157: int)
{
  ...
  anon3_Else:
    call {:si_unique_call 288} sdv_124 := __HAVOC_malloc(4);
...
implementation {:origName "sdv_stub_dispatch_end"} {:osmodel} sdv_stub_dispatch_end(actual_s: int, actual_pirp: int)
{
  ...
  anon0:
    call {:si_unique_call 289} vslice_dummy_var_167 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "sdv_SetStatus"} {:osmodel} sdv_SetStatus(actual_pirp_1: int)
{
  ...
  anon0:
    call {:si_unique_call 290} vslice_dummy_var_168 := __HAVOC_malloc(4);
...
procedure {:nohoudini} {:origName "sdv_main"} {:osmodel} sdv_main();
  modifies alloc, Mem_T.PVOID, yogi_error, SLAM_guard_O_0, handleState;
  free ensures {:va_keep} handleState == 1 || handleState == 2 || handleState == old(handleState);
  free ensures {:va_keep} yogi_error == 1 || yogi_error == old(yogi_error);
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} false || old(handleState) == 1 || old(handleState) == 2 || old(handleState) == 0;
...
implementation {:origName "sdv_main"} {:osmodel} sdv_main()
{
  ...
  anon0:
    call {:si_unique_call 291} vslice_dummy_var_169 := __HAVOC_malloc(4);
    call {:si_unique_call 292} u := __HAVOC_malloc(12);
    call {:si_unique_call 293} sdv_144 := sdv_CheckDispatchRoutines();
    call {:si_unique_call 294} sdv_129 := sdv_CheckStartIoRoutines();
    call {:si_unique_call 295} vslice_dummy_var_170 := sdv_CheckDpcRoutines();
    call {:si_unique_call 296} vslice_dummy_var_171 := sdv_CheckIsrRoutines();
    call {:si_unique_call 297} vslice_dummy_var_172 := sdv_CheckCancelRoutines();
    call {:si_unique_call 298} vslice_dummy_var_173 := sdv_CheckIoDpcRoutines();
    call {:si_unique_call 299} vslice_dummy_var_174 := sdv_IoCompletionRoutines();
    call {:si_unique_call 300} vslice_dummy_var_175 := sdv_CheckWorkerRoutines();
    call {:si_unique_call 301} vslice_dummy_var_176 := sdv_CheckAddDevice();
    call {:si_unique_call 302} vslice_dummy_var_177 := sdv_CheckIrpMjPnp();
    call {:si_unique_call 303} vslice_dummy_var_178 := sdv_CheckIrpMjPower();
    call {:si_unique_call 304} vslice_dummy_var_179 := sdv_CheckDriverUnload();
  ...
  anon188_Else:
    call {:si_unique_call 310} sdv_RunUnload(sdv_driver_object);
  ...
  anon189_Then:
    call {:si_unique_call 309} vslice_dummy_var_181 := DriverEntry(sdv_driver_object, u);
  ...
  anon187_Else:
    ...
    call {:si_unique_call 307} sdv_stub_driver_init();
    call {:si_unique_call 308} sdv_RunStartIo(0, 0);
    goto L1;
  ...
  anon186_Else:
    ...
    call {:si_unique_call 305} sdv_stub_driver_init();
    call {:si_unique_call 306} vslice_dummy_var_180 := sdv_RunDispatchFunction(sdv_p_devobj_fdo, sdv_irp);
...
implementation {:origName "IoDeleteDevice"} {:osmodel} IoDeleteDevice(actual_DeviceObject_5: int)
{
  ...
  anon0:
    call {:si_unique_call 311} vslice_dummy_var_182 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "ZwCreateKeyTransacted"} {:osmodel} ZwCreateKeyTransacted(actual_KeyHandle_1: int, actual_DesiredAccess_3: int, actual_ObjectAttributes_2: int, actual_TitleIndex: int, actual_Class: int, actual_CreateOptions_2: int, actual_TransactionHandle_1: int, actual_Disposition: int) returns (Tmp_195: int)
{
  ...
  anon3_Else:
    call {:si_unique_call 312} sdv_161 := __HAVOC_malloc(4);
...
implementation {:origName "sdv_InitializeObjectAttributes"} {:osmodel} sdv_InitializeObjectAttributes(actual_p: int, actual_n: int, actual_a: int, actual_r: int, actual_s_1: int)
{
  ...
  anon0:
    call {:si_unique_call 313} vslice_dummy_var_183 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "main"} {:osmodel} main() returns (Tmp_199: int, dup_assertVar: bool)
{
  ...
  anon0:
    dup_assertVar := true;
    assume alloc > 0;
    call {:si_unique_call 314} WHEA_ERROR_PACKET_SECTION_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume WHEA_ERROR_PACKET_SECTION_GUID__Loc == WHEA_ERROR_PACKET_SECTION_GUID;
    assume WHEA_ERROR_PACKET_SECTION_GUID != 0;
    call {:si_unique_call 315} g_RootKey__Loc := __HAVOC_malloc_or_null(4);
    assume g_RootKey__Loc == g_RootKey;
    assume g_RootKey != 0;
    call {:si_unique_call 316} g_DeviceObj__Loc := __HAVOC_malloc_or_null(4);
    ...
    call {:si_unique_call 337} sdv_driver_object__Loc := __HAVOC_malloc_or_null(68);
    ...
    call {:si_unique_call 355} SLAM_guard_O_0_init__Loc := __HAVOC_malloc_or_null(4);
    ...
    call {:si_unique_call 357} boogieTmp := __HAVOC_malloc_or_null(380);
    ...
    call {:si_unique_call 367} _sdv_init14();
    ...
    call {:si_unique_call 372} _sdv_init6();
    call {:si_unique_call 373} _sdv_init10();
    call {:si_unique_call 374} _sdv_init11();
    call {:si_unique_call 375} _sdv_init9();
    call {:si_unique_call 376} _sdv_init12();
    call {:si_unique_call 377} _sdv_init7();
    call {:si_unique_call 378} _sdv_init8();
    call {:si_unique_call 379} _sdv_init2();
    goto anon9_Then, anon9_Else;
  ...
  L41:
    ...
    call {:si_unique_call 380} sdv_main();
    goto anon12_Then, anon12_Else;
...
implementation {:origName "RtlInitUnicodeString"} {:osmodel} RtlInitUnicodeString(actual_DestinationString: int, actual_SourceString: int)
{
  ...
  anon0:
    call {:si_unique_call 381} vslice_dummy_var_184 := __HAVOC_malloc(4);
...
implementation {:origName "sdv_RunStartIo"} {:osmodel} sdv_RunStartIo(actual_po: int, actual_pirp_3: int)
{
  ...
  anon0:
    call {:si_unique_call 382} vslice_dummy_var_185 := __HAVOC_malloc(4);
    call {:si_unique_call 383} sdv_stub_startio_begin();
    call {:si_unique_call 384} vslice_dummy_var_186 := sdv_DoNothing();
    call {:si_unique_call 385} sdv_stub_startio_end();
    return;
}
...
implementation {:origName "CmUnRegisterCallback"} {:osmodel} CmUnRegisterCallback(actual_structPtr888Cookie: int) returns (Tmp_209: int)
{
  ...
  anon0:
    call {:si_unique_call 386} Cookie := __HAVOC_malloc(20);
...
implementation {:origName "sdv_RtlZeroMemory"} {:osmodel} sdv_RtlZeroMemory(actual_Destination: int, actual_Length: int)
{
  ...
  anon0:
    call {:si_unique_call 387} vslice_dummy_var_187 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "sdv_stub_startio_begin"} {:osmodel} sdv_stub_startio_begin()
{
  ...
  anon0:
    call {:si_unique_call 388} vslice_dummy_var_188 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "ZwCreateKey"} {:osmodel} ZwCreateKey(actual_KeyHandle_4: int, actual_DesiredAccess_4: int, actual_ObjectAttributes_3: int, actual_TitleIndex_2: int, actual_Class_1: int, actual_CreateOptions_3: int, actual_Disposition_1: int) returns (Tmp_219: int)
{
  ...
  anon3_Else:
    call {:si_unique_call 389} sdv_167 := __HAVOC_malloc(4);
...
procedure {:origName "sdv_RunDispatchFunction"} {:osmodel} sdv_RunDispatchFunction(actual_po_1: int, actual_pirp_4: int) returns (Tmp_221: int);
  modifies alloc, yogi_error, Mem_T.PVOID, SLAM_guard_O_0, handleState;
  free ensures {:va_keep} old(handleState) == 1 ==> handleState != 0;
  free ensures {:va_keep} old(handleState) == 2 ==> handleState != 0;
  free ensures {:va_keep} handleState == 1 || handleState == 2 || handleState == old(handleState);
  free ensures {:va_keep} yogi_error == 1 || yogi_error == old(yogi_error);
...
implementation {:origName "sdv_RunDispatchFunction"} {:osmodel} sdv_RunDispatchFunction(actual_po_1: int, actual_pirp_4: int) returns (Tmp_221: int)
{
  ...
  anon0:
    ...
    assume {:nonnull} pirp_4 != 0;
    assume pirp_4 > 0;
    call {:si_unique_call 390} sdv_SetStatus(pirp_4);
    assume {:nonnull} pirp_4 != 0;
    assume pirp_4 > 0;
    assume {:nonnull} pirp_4 != 0;
    assume pirp_4 > 0;
  ...
  L66:
    call {:si_unique_call 408} status_1 := sdv_DoNothing();
    goto L72;

  L72:
    call {:si_unique_call 409} sdv_stub_dispatch_end(status_1, 0);
    assume {:nonnull} pirp_4 != 0;
    assume pirp_4 > 0;
    Tmp_221 := status_1;
    goto LM2;
  ...
  anon57_Then:
    assume {:nonnull} ps != 0;
    assume ps > 0;
    call {:si_unique_call 407} status_1 := sdv_DoNothing();
    goto L72;

  anon58_Then:
    assume {:nonnull} ps != 0;
    assume ps > 0;
    call {:si_unique_call 406} status_1 := sdv_DoNothing();
    goto L72;

  anon59_Then:
    assume {:nonnull} ps != 0;
    assume ps > 0;
    call {:si_unique_call 405} status_1 := DeviceCleanup(po_1, pirp_4);
    goto anon74_Then, anon74_Else;
  ...
  anon60_Then:
    call {:si_unique_call 404} status_1 := sdv_DoNothing();
    goto L72;
  ...
  anon63_Then:
    assume {:nonnull} ps != 0;
    assume ps > 0;
    call {:si_unique_call 401} status_1 := DeviceControl(po_1, pirp_4);
    goto anon73_Then, anon73_Else;
  ...
  anon64_Then:
    call {:si_unique_call 400} status_1 := sdv_DoNothing();
    goto L72;
  ...
  anon68_Then:
    assume {:nonnull} ps != 0;
    assume ps > 0;
    call {:si_unique_call 396} status_1 := sdv_DoNothing();
    goto L72;
  ...
  anon70_Then:
    assume {:nonnull} ps != 0;
    assume ps > 0;
    call {:si_unique_call 394} status_1 := DeviceClose(po_1, pirp_4);
    goto anon72_Then, anon72_Else;
  ...
  anon51_Then:
    assume {:nonnull} ps != 0;
    assume ps > 0;
    call {:si_unique_call 392} status_1 := DeviceCreate(po_1, pirp_4);
    goto anon71_Then, anon71_Else;
...
implementation {:origName "sdv_IoCompleteRequest"} {:osmodel} sdv_IoCompleteRequest(actual_pirp_5: int, actual_PriorityBoost: int)
{
  ...
  anon0:
    call {:si_unique_call 410} vslice_dummy_var_189 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "ExFreePoolWithTag"} {:osmodel} ExFreePoolWithTag(actual_P: int, actual_Tag: int)
{
  ...
  anon0:
    call {:si_unique_call 411} vslice_dummy_var_190 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "ZwCreateTransaction"} {:osmodel} ZwCreateTransaction(actual_TransactionHandle_2: int, actual_DesiredAccess_5: int, actual_ObjectAttributes_4: int, actual_Uow: int, actual_TmHandle_2: int, actual_CreateOptions_4: int, actual_IsolationLevel: int, actual_IsolationFlags: int, actual_Timeout: int, actual_Description_1: int) returns (Tmp_239: int)
{
  ...
  anon3_Else:
    call {:si_unique_call 412} sdv_188 := __HAVOC_malloc(4);
...
implementation {:origName "ZwOpenKey"} {:osmodel} ZwOpenKey(actual_KeyHandle_5: int, actual_DesiredAccess_6: int, actual_ObjectAttributes_5: int) returns (Tmp_243: int)
{
  ...
  anon3_Else:
    call {:si_unique_call 413} sdv_190 := __HAVOC_malloc(4);
...
implementation {:origName "ExAllocatePoolWithTag"} {:osmodel} ExAllocatePoolWithTag(actual_PoolType: int, actual_NumberOfBytes: int, actual_Tag_1: int) returns (Tmp_247: int)
{
  ...
  anon3_Else:
    call {:si_unique_call 414} sdv_193 := __HAVOC_malloc(NumberOfBytes);
    Tmp_247 := sdv_193;
    goto L1;
...
implementation {:origName "ZwOpenKeyTransacted"} {:osmodel} ZwOpenKeyTransacted(actual_KeyHandle_6: int, actual_DesiredAccess_7: int, actual_ObjectAttributes_6: int, actual_TransactionHandle_4: int) returns (Tmp_249: int)
{
  ...
  anon3_Else:
    call {:si_unique_call 415} sdv_195 := __HAVOC_malloc(4);
...
implementation {:origName "sdv_RunUnload"} {:osmodel} sdv_RunUnload(actual_pdrivo: int)
{
  ...
  anon0:
    call {:si_unique_call 416} vslice_dummy_var_191 := __HAVOC_malloc(4);
    pdrivo := actual_pdrivo;
    call {:si_unique_call 417} DeviceUnload(pdrivo);
    goto anon3_Then, anon3_Else;
...
implementation {:origName "sdv_stub_driver_init"} {:osmodel} sdv_stub_driver_init()
{
  ...
  anon0:
    call {:si_unique_call 418} vslice_dummy_var_192 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "sdv_stub_dispatch_begin"} {:osmodel} sdv_stub_dispatch_begin()
{
  ...
  anon0:
    call {:si_unique_call 419} vslice_dummy_var_193 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "_sdv_init12"} {:osmodel} _sdv_init12()
{
  ...
  anon0:
    call {:si_unique_call 420} vslice_dummy_var_194 := __HAVOC_malloc(4);
...
implementation {:origName "MultipleAltitudeBlockDuringPreSample"} MultipleAltitudeBlockDuringPreSample() returns (Tmp_265: int)
{
  ...
  anon0:
    call {:si_unique_call 421} Key_1 := __HAVOC_malloc(4);
    call {:si_unique_call 422} vslice_dummy_var_195 := __HAVOC_malloc(24);
    call {:si_unique_call 423} Name_2 := __HAVOC_malloc(12);
    call {:si_unique_call 424} vslice_dummy_var_198 := __HAVOC_malloc(200);
    call {:si_unique_call 425} Tmp_267 := __HAVOC_malloc(28);
    call {:si_unique_call 426} vslice_dummy_var_199 := __HAVOC_malloc(32);
    call {:si_unique_call 427} vslice_dummy_var_200 := __HAVOC_malloc(32);
    call {:si_unique_call 428} vslice_dummy_var_201 := __HAVOC_malloc(200);
    call {:si_unique_call 429} vslice_dummy_var_202 := __HAVOC_malloc(32);
    call {:si_unique_call 430} vslice_dummy_var_203 := __HAVOC_malloc(32);
    call {:si_unique_call 431} vslice_dummy_var_204 := __HAVOC_malloc(284);
    call {:si_unique_call 432} vslice_dummy_var_205 := __HAVOC_malloc(32);
    call {:si_unique_call 433} vslice_dummy_var_206 := __HAVOC_malloc(32);
    call {:si_unique_call 434} Tmp_277 := __HAVOC_malloc(28);
    call {:si_unique_call 435} vslice_dummy_var_207 := __HAVOC_malloc(32);
    call {:si_unique_call 436} vslice_dummy_var_208 := __HAVOC_malloc(32);
    call {:si_unique_call 437} vslice_dummy_var_209 := __HAVOC_malloc(32);
    call {:si_unique_call 438} vslice_dummy_var_210 := __HAVOC_malloc(280);
    call {:si_unique_call 439} vslice_dummy_var_211 := __HAVOC_malloc(276);
    call {:si_unique_call 440} vslice_dummy_var_212 := __HAVOC_malloc(32);
    call {:si_unique_call 441} vslice_dummy_var_213 := __HAVOC_malloc(32);
    call {:si_unique_call 442} vslice_dummy_var_214 := __HAVOC_malloc(224);
    call {:si_unique_call 443} vslice_dummy_var_215 := __HAVOC_malloc(284);
    call {:si_unique_call 444} Tmp_287 := __HAVOC_malloc(28);
    call {:si_unique_call 445} vslice_dummy_var_216 := __HAVOC_malloc(276);
    call {:si_unique_call 446} vslice_dummy_var_217 := __HAVOC_malloc(32);
    call {:si_unique_call 447} vslice_dummy_var_218 := __HAVOC_malloc(200);
    call {:si_unique_call 448} vslice_dummy_var_219 := __HAVOC_malloc(32);
    call {:si_unique_call 449} vslice_dummy_var_220 := __HAVOC_malloc(192);
    call {:si_unique_call 450} vslice_dummy_var_221 := __HAVOC_malloc(192);
    call {:si_unique_call 451} vslice_dummy_var_222 := __HAVOC_malloc(32);
    call {:si_unique_call 452} vslice_dummy_var_223 := __HAVOC_malloc(32);
    call {:si_unique_call 453} vslice_dummy_var_224 := __HAVOC_malloc(232);
    call {:si_unique_call 454} vslice_dummy_var_225 := __HAVOC_malloc(24);
    call {:si_unique_call 455} vslice_dummy_var_226 := __HAVOC_malloc(212);
    call {:si_unique_call 456} vslice_dummy_var_227 := __HAVOC_malloc(32);
    call {:si_unique_call 457} vslice_dummy_var_228 := __HAVOC_malloc(32);
    call {:si_unique_call 458} vslice_dummy_var_229 := __HAVOC_malloc(288);
    call {:si_unique_call 459} Tmp_302 := __HAVOC_malloc(48);
    call {:si_unique_call 460} vslice_dummy_var_230 := __HAVOC_malloc(192);
    call {:si_unique_call 461} vslice_dummy_var_231 := __HAVOC_malloc(236);
    CallbackCtxHigh := 0;
    CallbackCtxMid := 0;
    CallbackCtxLow := 0;
    ...
    Mem_T.PVOID[Key_1] := 0;
    Success_2 := 0;
    call {:si_unique_call 462} vslice_dummy_var_232 := corral_nondet();
    call {:si_unique_call 463} vslice_dummy_var_233 := corral_nondet();
    Tmp_267 := strConst__li2bpl40;
    call {:si_unique_call 464} sdv_214 := CreateCallbackContext(8, Tmp_267);
    CallbackCtxHigh := sdv_214;
    Tmp_287 := strConst__li2bpl20;
    call {:si_unique_call 465} sdv_216 := CreateCallbackContext(6, Tmp_287);
    CallbackCtxMid := sdv_216;
    Tmp_277 := strConst__li2bpl50;
    call {:si_unique_call 466} sdv_215 := CreateCallbackContext(8, Tmp_277);
  ...
  anon70_Else:
    ...
    call {:si_unique_call 490} vslice_dummy_var_241 := corral_nondet();
    goto L136;
  ...
  anon73_Else:
    ...
    assume SLAM_guard_O_0 != SLAM_guard_O_0_init;
    call {:si_unique_call 492} SLIC_ZwDeleteKey_entry(strConst__li2bpl4);
    goto anon80_Then, anon80_Else;
  ...
  L183:
    call {:si_unique_call 493} vslice_dummy_var_196 := ZwDeleteKey(0);
    assume {:nonnull} Key_1 != 0;
    assume Key_1 > 0;
    goto anon74_Then, anon74_Else;
  ...
  anon74_Else:
    assume Mem_T.PVOID[Key_1] == SLAM_guard_O_0;
    assume SLAM_guard_O_0 != SLAM_guard_O_0_init;
    call {:si_unique_call 494} SLIC_ZwClose_entry(strConst__li2bpl4);
    goto anon81_Then, anon81_Else;
  ...
  L186:
    call {:si_unique_call 498} vslice_dummy_var_197 := ZwClose(0);
    goto L137;
  ...
  anon75_Else:
    ...
    call {:si_unique_call 495} ExFreePoolWithTag(0, 812934738);
    goto L148;
  ...
  anon76_Else:
    ...
    call {:si_unique_call 496} ExFreePoolWithTag(0, 812934738);
    goto L152;
  ...
  anon70_Then:
    assume {:partition} Success_2 == 0;
    call {:si_unique_call 489} vslice_dummy_var_242 := corral_nondet();
    goto L136;
  ...
  anon56_Then:
    ...
    call {:si_unique_call 467} Status_8 := CmRegisterCallbackEx(li2bplFunctionConstant345, 0, vslice_dummy_var_140, 0, 0, 0);
    goto anon57_Then, anon57_Else;

  anon57_Else:
    assume {:partition} Status_8 >= 0;
    havoc vslice_dummy_var_141;
    call {:si_unique_call 469} Status_8 := CmRegisterCallbackEx(li2bplFunctionConstant345, 0, vslice_dummy_var_141, 0, 0, 0);
    goto anon58_Then, anon58_Else;

  anon58_Else:
    assume {:partition} Status_8 >= 0;
    havoc vslice_dummy_var_142;
    call {:si_unique_call 471} Status_8 := CmRegisterCallbackEx(li2bplFunctionConstant345, 0, vslice_dummy_var_142, 0, 0, 0);
    goto anon59_Then, anon59_Else;
  ...
  anon59_Else:
    ...
    call {:si_unique_call 473} RtlInitUnicodeString(Name_2, Tmp_302);
    call {:si_unique_call 474} sdv_InitializeObjectAttributes(0, 0, 576, 0, 0);
    call {:si_unique_call 475} Status_8 := ZwCreateKey(Key_1, 983103, 0, 0, 0, 0, 0);
    assume {:nonnull} Key_1 != 0;
    assume Key_1 > 0;
    goto anon77_Then, anon77_Else;
  ...
  anon77_Else:
    assume Mem_T.PVOID[Key_1] == SLAM_guard_O_0;
    assume SLAM_guard_O_0 != SLAM_guard_O_0_init;
    call {:si_unique_call 497} SLIC_ZwCreateKey_exit(strConst__li2bpl4, Status_8);
    goto anon79_Then, anon79_Else;
  ...
  anon60_Else:
    ...
    call {:si_unique_call 476} vslice_dummy_var_234 := corral_nondet();
    Success_2 := 0;
    goto L74;
  ...
  L74:
    ...
    call {:si_unique_call 477} Status_8 := CmUnRegisterCallback(vslice_dummy_var_143);
    goto anon61_Then, anon61_Else;
  ...
  L86:
    ...
    call {:si_unique_call 479} Status_8 := CmUnRegisterCallback(vslice_dummy_var_144);
    goto anon62_Then, anon62_Else;
  ...
  L94:
    ...
    call {:si_unique_call 481} Status_8 := CmUnRegisterCallback(vslice_dummy_var_145);
    goto anon63_Then, anon63_Else;
  ...
  L104:
    call {:si_unique_call 483} vslice_dummy_var_235 := corral_nondet();
    call {:si_unique_call 484} vslice_dummy_var_236 := corral_nondet();
    Success_2 := 0;
    goto L111;
  ...
  L113:
    call {:si_unique_call 485} vslice_dummy_var_237 := corral_nondet();
    call {:si_unique_call 486} vslice_dummy_var_238 := corral_nondet();
    Success_2 := 0;
    goto L120;
  ...
  L122:
    call {:si_unique_call 487} vslice_dummy_var_239 := corral_nondet();
    call {:si_unique_call 488} vslice_dummy_var_240 := corral_nondet();
    Success_2 := 0;
    goto L129;
  ...
  anon63_Then:
    ...
    call {:si_unique_call 482} vslice_dummy_var_243 := corral_nondet();
    goto L102;

  anon62_Then:
    assume {:partition} 0 > Status_8;
    call {:si_unique_call 480} vslice_dummy_var_244 := corral_nondet();
    goto L94;

  anon61_Then:
    assume {:partition} 0 > Status_8;
    call {:si_unique_call 478} vslice_dummy_var_245 := corral_nondet();
    goto L86;
  ...
  anon59_Then:
    assume {:partition} 0 > Status_8;
    call {:si_unique_call 472} vslice_dummy_var_246 := corral_nondet();
    goto L129;

  anon58_Then:
    assume {:partition} 0 > Status_8;
    call {:si_unique_call 470} vslice_dummy_var_247 := corral_nondet();
    goto L129;

  anon57_Then:
    assume {:partition} 0 > Status_8;
    call {:si_unique_call 468} vslice_dummy_var_248 := corral_nondet();
    goto L129;
}
...
implementation {:origName "MultipleAltitudeInternalInvocationSample"} MultipleAltitudeInternalInvocationSample() returns (Tmp_305: int)
{
  ...
  anon0:
    call {:si_unique_call 499} Key_2 := __HAVOC_malloc(4);
    call {:si_unique_call 500} vslice_dummy_var_249 := __HAVOC_malloc(24);
    call {:si_unique_call 501} Name_3 := __HAVOC_malloc(12);
    call {:si_unique_call 502} Tmp_306 := __HAVOC_malloc(28);
    call {:si_unique_call 503} vslice_dummy_var_252 := __HAVOC_malloc(32);
    call {:si_unique_call 504} vslice_dummy_var_253 := __HAVOC_malloc(276);
    call {:si_unique_call 505} vslice_dummy_var_254 := __HAVOC_malloc(200);
    call {:si_unique_call 506} vslice_dummy_var_255 := __HAVOC_malloc(32);
    call {:si_unique_call 507} vslice_dummy_var_256 := __HAVOC_malloc(192);
    call {:si_unique_call 508} vslice_dummy_var_257 := __HAVOC_malloc(280);
    call {:si_unique_call 509} vslice_dummy_var_258 := __HAVOC_malloc(32);
    call {:si_unique_call 510} vslice_dummy_var_259 := __HAVOC_malloc(32);
    call {:si_unique_call 511} Tmp_315 := __HAVOC_malloc(48);
    call {:si_unique_call 512} vslice_dummy_var_260 := __HAVOC_malloc(32);
    call {:si_unique_call 513} vslice_dummy_var_261 := __HAVOC_malloc(192);
    call {:si_unique_call 514} vslice_dummy_var_262 := __HAVOC_malloc(32);
    call {:si_unique_call 515} vslice_dummy_var_263 := __HAVOC_malloc(32);
    call {:si_unique_call 516} vslice_dummy_var_264 := __HAVOC_malloc(32);
    call {:si_unique_call 517} vslice_dummy_var_265 := __HAVOC_malloc(284);
    call {:si_unique_call 518} vslice_dummy_var_266 := __HAVOC_malloc(32);
    call {:si_unique_call 519} vslice_dummy_var_267 := __HAVOC_malloc(32);
    call {:si_unique_call 520} vslice_dummy_var_268 := __HAVOC_malloc(32);
    call {:si_unique_call 521} vslice_dummy_var_269 := __HAVOC_malloc(212);
    call {:si_unique_call 522} vslice_dummy_var_270 := __HAVOC_malloc(244);
    call {:si_unique_call 523} vslice_dummy_var_271 := __HAVOC_malloc(32);
    call {:si_unique_call 524} vslice_dummy_var_272 := __HAVOC_malloc(288);
    call {:si_unique_call 525} vslice_dummy_var_273 := __HAVOC_malloc(32);
    call {:si_unique_call 526} vslice_dummy_var_274 := __HAVOC_malloc(248);
    call {:si_unique_call 527} vslice_dummy_var_275 := __HAVOC_malloc(200);
    call {:si_unique_call 528} vslice_dummy_var_276 := __HAVOC_malloc(192);
    call {:si_unique_call 529} vslice_dummy_var_277 := __HAVOC_malloc(32);
    call {:si_unique_call 530} vslice_dummy_var_278 := __HAVOC_malloc(236);
    call {:si_unique_call 531} Tmp_335 := __HAVOC_malloc(28);
    call {:si_unique_call 532} vslice_dummy_var_279 := __HAVOC_malloc(32);
    call {:si_unique_call 533} vslice_dummy_var_280 := __HAVOC_malloc(32);
    call {:si_unique_call 534} vslice_dummy_var_281 := __HAVOC_malloc(284);
    call {:si_unique_call 535} Tmp_339 := __HAVOC_malloc(28);
    call {:si_unique_call 536} vslice_dummy_var_282 := __HAVOC_malloc(24);
    call {:si_unique_call 537} vslice_dummy_var_283 := __HAVOC_malloc(200);
    call {:si_unique_call 538} vslice_dummy_var_284 := __HAVOC_malloc(32);
    call {:si_unique_call 539} vslice_dummy_var_285 := __HAVOC_malloc(276);
    CallbackCtxHigh_1 := 0;
    CallbackCtxMid_1 := 0;
    CallbackCtxLow_1 := 0;
    ...
    Mem_T.PVOID[Key_2] := 0;
    Success_3 := 0;
    call {:si_unique_call 540} vslice_dummy_var_286 := corral_nondet();
    call {:si_unique_call 541} vslice_dummy_var_287 := corral_nondet();
    Tmp_306 := strConst__li2bpl40;
    call {:si_unique_call 542} sdv_243 := CreateCallbackContext(8, Tmp_306);
    CallbackCtxHigh_1 := sdv_243;
    Tmp_335 := strConst__li2bpl20;
    call {:si_unique_call 543} sdv_245 := CreateCallbackContext(7, Tmp_335);
    CallbackCtxMid_1 := sdv_245;
    Tmp_339 := strConst__li2bpl50;
    call {:si_unique_call 544} sdv_244 := CreateCallbackContext(8, Tmp_339);
  ...
  anon70_Else:
    ...
    call {:si_unique_call 568} vslice_dummy_var_294 := corral_nondet();
    goto L135;
  ...
  anon73_Else:
    ...
    assume SLAM_guard_O_0 != SLAM_guard_O_0_init;
    call {:si_unique_call 570} SLIC_ZwDeleteKey_entry(strConst__li2bpl4);
    goto anon80_Then, anon80_Else;
  ...
  L186:
    call {:si_unique_call 571} vslice_dummy_var_250 := ZwDeleteKey(0);
    assume {:nonnull} Key_2 != 0;
    assume Key_2 > 0;
    goto anon74_Then, anon74_Else;
  ...
  anon74_Else:
    assume Mem_T.PVOID[Key_2] == SLAM_guard_O_0;
    assume SLAM_guard_O_0 != SLAM_guard_O_0_init;
    call {:si_unique_call 572} SLIC_ZwClose_entry(strConst__li2bpl4);
    goto anon81_Then, anon81_Else;
  ...
  L189:
    call {:si_unique_call 576} vslice_dummy_var_251 := ZwClose(0);
    goto L136;
  ...
  anon75_Else:
    ...
    call {:si_unique_call 573} ExFreePoolWithTag(0, 812934738);
    goto L147;
  ...
  anon76_Else:
    ...
    call {:si_unique_call 574} ExFreePoolWithTag(0, 812934738);
    goto L151;
  ...
  anon70_Then:
    assume {:partition} Success_3 == 0;
    call {:si_unique_call 567} vslice_dummy_var_295 := corral_nondet();
    goto L135;
  ...
  anon56_Then:
    ...
    call {:si_unique_call 545} Status_9 := CmRegisterCallbackEx(li2bplFunctionConstant345, 0, vslice_dummy_var_146, 0, 0, 0);
    goto anon57_Then, anon57_Else;

  anon57_Else:
    assume {:partition} Status_9 >= 0;
    havoc vslice_dummy_var_147;
    call {:si_unique_call 547} Status_9 := CmRegisterCallbackEx(li2bplFunctionConstant345, 0, vslice_dummy_var_147, 0, 0, 0);
    goto anon58_Then, anon58_Else;

  anon58_Else:
    assume {:partition} Status_9 >= 0;
    havoc vslice_dummy_var_148;
    call {:si_unique_call 549} Status_9 := CmRegisterCallbackEx(li2bplFunctionConstant345, 0, vslice_dummy_var_148, 0, 0, 0);
    goto anon59_Then, anon59_Else;
  ...
  anon59_Else:
    ...
    call {:si_unique_call 551} RtlInitUnicodeString(Name_3, Tmp_315);
    call {:si_unique_call 552} sdv_InitializeObjectAttributes(0, 0, 576, 0, 0);
    call {:si_unique_call 553} Status_9 := ZwCreateKey(Key_2, 983103, 0, 0, 0, 0, 0);
    assume {:nonnull} Key_2 != 0;
    assume Key_2 > 0;
    goto anon77_Then, anon77_Else;
  ...
  anon77_Else:
    assume Mem_T.PVOID[Key_2] == SLAM_guard_O_0;
    assume SLAM_guard_O_0 != SLAM_guard_O_0_init;
    call {:si_unique_call 575} SLIC_ZwCreateKey_exit(strConst__li2bpl4, Status_9);
    goto anon79_Then, anon79_Else;
  ...
  L77:
    ...
    call {:si_unique_call 555} Status_9 := CmUnRegisterCallback(vslice_dummy_var_149);
    goto anon61_Then, anon61_Else;
  ...
  L85:
    ...
    call {:si_unique_call 557} Status_9 := CmUnRegisterCallback(vslice_dummy_var_150);
    goto anon62_Then, anon62_Else;
  ...
  L93:
    ...
    call {:si_unique_call 559} Status_9 := CmUnRegisterCallback(vslice_dummy_var_151);
    goto anon63_Then, anon63_Else;
  ...
  L103:
    call {:si_unique_call 561} vslice_dummy_var_288 := corral_nondet();
    call {:si_unique_call 562} vslice_dummy_var_289 := corral_nondet();
    Success_3 := 0;
    goto L110;
  ...
  L112:
    call {:si_unique_call 563} vslice_dummy_var_290 := corral_nondet();
    call {:si_unique_call 564} vslice_dummy_var_291 := corral_nondet();
    Success_3 := 0;
    goto L119;
  ...
  L121:
    call {:si_unique_call 565} vslice_dummy_var_292 := corral_nondet();
    call {:si_unique_call 566} vslice_dummy_var_293 := corral_nondet();
    Success_3 := 0;
    goto L128;
  ...
  anon63_Then:
    ...
    call {:si_unique_call 560} vslice_dummy_var_296 := corral_nondet();
    Success_3 := 0;
    goto L101;

  anon62_Then:
    assume {:partition} 0 > Status_9;
    call {:si_unique_call 558} vslice_dummy_var_297 := corral_nondet();
    Success_3 := 0;
    goto L93;

  anon61_Then:
    assume {:partition} 0 > Status_9;
    call {:si_unique_call 556} vslice_dummy_var_298 := corral_nondet();
    Success_3 := 0;
    goto L85;

  anon60_Then:
    assume {:partition} 0 > Status_9;
    call {:si_unique_call 554} vslice_dummy_var_299 := corral_nondet();
    Success_3 := 0;
    goto L77;
  ...
  anon59_Then:
    assume {:partition} 0 > Status_9;
    call {:si_unique_call 550} vslice_dummy_var_300 := corral_nondet();
    goto L128;

  anon58_Then:
    assume {:partition} 0 > Status_9;
    call {:si_unique_call 548} vslice_dummy_var_301 := corral_nondet();
    goto L128;

  anon57_Then:
    assume {:partition} 0 > Status_9;
    call {:si_unique_call 546} vslice_dummy_var_302 := corral_nondet();
    goto L128;
}
...
implementation {:origName "_sdv_init9"} _sdv_init9()
{
  ...
  anon0:
    call {:si_unique_call 577} vslice_dummy_var_303 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "_sdv_init11"} _sdv_init11()
{
  ...
  anon0:
    call {:si_unique_call 578} vslice_dummy_var_304 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "_sdv_init10"} _sdv_init10()
{
  ...
  anon0:
    call {:si_unique_call 579} vslice_dummy_var_305 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "CreateOpenV1Sample"} CreateOpenV1Sample() returns (Tmp_351: int)
{
  ...
  anon0:
    call {:si_unique_call 580} Key_3 := __HAVOC_malloc(4);
    call {:si_unique_call 581} vslice_dummy_var_306 := __HAVOC_malloc(24);
    call {:si_unique_call 582} Name_4 := __HAVOC_malloc(12);
    call {:si_unique_call 583} vslice_dummy_var_308 := __HAVOC_malloc(204);
    call {:si_unique_call 584} vslice_dummy_var_309 := __HAVOC_malloc(32);
    call {:si_unique_call 585} Tmp_354 := __HAVOC_malloc(28);
    call {:si_unique_call 586} vslice_dummy_var_310 := __HAVOC_malloc(156);
    call {:si_unique_call 587} vslice_dummy_var_311 := __HAVOC_malloc(144);
    call {:si_unique_call 588} vslice_dummy_var_312 := __HAVOC_malloc(32);
    call {:si_unique_call 589} vslice_dummy_var_313 := __HAVOC_malloc(200);
    call {:si_unique_call 590} vslice_dummy_var_314 := __HAVOC_malloc(32);
    call {:si_unique_call 591} vslice_dummy_var_315 := __HAVOC_malloc(152);
    call {:si_unique_call 592} NameBuffer := __HAVOC_malloc(192);
    call {:si_unique_call 593} vslice_dummy_var_316 := __HAVOC_malloc(24);
    call {:si_unique_call 594} vslice_dummy_var_317 := __HAVOC_malloc(192);
    call {:si_unique_call 595} vslice_dummy_var_318 := __HAVOC_malloc(32);
    call {:si_unique_call 596} vslice_dummy_var_319 := __HAVOC_malloc(32);
    call {:si_unique_call 597} vslice_dummy_var_320 := __HAVOC_malloc(32);
    call {:si_unique_call 598} vslice_dummy_var_321 := __HAVOC_malloc(32);
    CallbackCtx_3 := 0;
    ...
    Mem_T.PVOID[Key_3] := 0;
    Success_4 := 0;
    call {:si_unique_call 599} vslice_dummy_var_322 := corral_nondet();
    call {:si_unique_call 600} vslice_dummy_var_323 := corral_nondet();
    Tmp_354 := strConst__li2bpl20;
    call {:si_unique_call 601} sdv_262 := CreateCallbackContext(13, Tmp_354);
  ...
  anon26_Else:
    ...
    assume SLAM_guard_O_0 != SLAM_guard_O_0_init;
    call {:si_unique_call 611} SLIC_ZwClose_entry(strConst__li2bpl4);
  ...
  L85:
    call {:si_unique_call 615} vslice_dummy_var_307 := ZwClose(0);
    goto L59;
  ...
  anon25_Else:
    assume {:partition} CallbackCtx_3 != 0;
    call {:si_unique_call 610} ExFreePoolWithTag(0, 812934738);
    goto L63;
  ...
  anon27_Else:
    ...
    call {:si_unique_call 613} vslice_dummy_var_325 := corral_nondet();
    goto L73;
  ...
  anon27_Then:
    assume {:partition} Success_4 == 0;
    call {:si_unique_call 612} vslice_dummy_var_326 := corral_nondet();
    goto L73;
  ...
  anon29_Then:
    ...
    call {:si_unique_call 602} Status_10 := CmRegisterCallbackEx(li2bplFunctionConstant345, 0, vslice_dummy_var_152, 0, 0, 0);
    goto anon21_Then, anon21_Else;

  anon21_Else:
    assume {:partition} Status_10 >= 0;
    Success_4 := 1;
    call {:si_unique_call 604} RtlInitUnicodeString(Name_4, NameBuffer);
    call {:si_unique_call 605} sdv_InitializeObjectAttributes(0, 0, 1600, 0, 0);
    call {:si_unique_call 606} Status_10 := ZwOpenKey(Key_3, 65536, 0);
    assume {:nonnull} Key_3 != 0;
    assume Key_3 > 0;
  ...
  anon28_Else:
    assume Mem_T.PVOID[Key_3] == SLAM_guard_O_0;
    assume SLAM_guard_O_0 != SLAM_guard_O_0_init;
    call {:si_unique_call 614} SLIC_ZwOpenKey_exit(0, Status_10);
    goto L45;
  ...
  anon22_Else:
    ...
    call {:si_unique_call 607} vslice_dummy_var_324 := corral_nondet();
    Success_4 := 0;
    goto L46;
  ...
  L46:
    ...
    call {:si_unique_call 608} Status_10 := CmUnRegisterCallback(vslice_dummy_var_153);
    goto anon23_Then, anon23_Else;
  ...
  anon23_Then:
    ...
    call {:si_unique_call 609} vslice_dummy_var_327 := corral_nondet();
    Success_4 := 0;
    goto L58;
  ...
  anon21_Then:
    assume {:partition} 0 > Status_10;
    call {:si_unique_call 603} vslice_dummy_var_328 := corral_nondet();
    goto L58;
}
...
implementation {:origName "TransactionEnlistSample"} TransactionEnlistSample() returns (Tmp_368: int)
{
  ...
  anon0:
    call {:si_unique_call 616} vslice_dummy_var_329 := __HAVOC_malloc(24);
    call {:si_unique_call 617} Key_4 := __HAVOC_malloc(4);
    call {:si_unique_call 618} vslice_dummy_var_330 := __HAVOC_malloc(24);
    call {:si_unique_call 619} Transaction := __HAVOC_malloc(4);
    call {:si_unique_call 620} Name_5 := __HAVOC_malloc(12);
    call {:si_unique_call 621} vslice_dummy_var_335 := __HAVOC_malloc(204);
    call {:si_unique_call 622} vslice_dummy_var_336 := __HAVOC_malloc(24);
    call {:si_unique_call 623} vslice_dummy_var_337 := __HAVOC_malloc(160);
    call {:si_unique_call 624} vslice_dummy_var_338 := __HAVOC_malloc(32);
    call {:si_unique_call 625} vslice_dummy_var_339 := __HAVOC_malloc(32);
    call {:si_unique_call 626} vslice_dummy_var_340 := __HAVOC_malloc(248);
    call {:si_unique_call 627} vslice_dummy_var_341 := __HAVOC_malloc(160);
    call {:si_unique_call 628} vslice_dummy_var_342 := __HAVOC_malloc(196);
    call {:si_unique_call 629} vslice_dummy_var_343 := __HAVOC_malloc(164);
    call {:si_unique_call 630} vslice_dummy_var_344 := __HAVOC_malloc(32);
    call {:si_unique_call 631} Tmp_379 := __HAVOC_malloc(48);
    call {:si_unique_call 632} vslice_dummy_var_345 := __HAVOC_malloc(32);
    call {:si_unique_call 633} Tmp_381 := __HAVOC_malloc(28);
    call {:si_unique_call 634} vslice_dummy_var_346 := __HAVOC_malloc(340);
    call {:si_unique_call 635} vslice_dummy_var_347 := __HAVOC_malloc(192);
    call {:si_unique_call 636} vslice_dummy_var_348 := __HAVOC_malloc(32);
    call {:si_unique_call 637} vslice_dummy_var_349 := __HAVOC_malloc(32);
    call {:si_unique_call 638} vslice_dummy_var_350 := __HAVOC_malloc(200);
    call {:si_unique_call 639} vslice_dummy_var_351 := __HAVOC_malloc(32);
    call {:si_unique_call 640} Tmp_388 := __HAVOC_malloc(48);
    call {:si_unique_call 641} vslice_dummy_var_352 := __HAVOC_malloc(32);
    call {:si_unique_call 642} vslice_dummy_var_353 := __HAVOC_malloc(32);
    call {:si_unique_call 643} vslice_dummy_var_354 := __HAVOC_malloc(32);
    call {:si_unique_call 644} vslice_dummy_var_355 := __HAVOC_malloc(188);
    call {:si_unique_call 645} vslice_dummy_var_356 := __HAVOC_malloc(32);
    CallbackCtx_4 := 0;
    RMCallbackCtx := 0;
    ...
    Success_5 := 0;
    call {:si_unique_call 646} vslice_dummy_var_357 := corral_nondet();
    call {:si_unique_call 647} vslice_dummy_var_358 := corral_nondet();
    goto anon45_Then, anon45_Else;

  anon45_Else:
    Tmp_381 := strConst__li2bpl20;
    call {:si_unique_call 649} sdv_283 := CreateCallbackContext(5, Tmp_381);
  ...
  anon52_Else:
    ...
    call {:si_unique_call 666} vslice_dummy_var_331 := ZwClose(0);
    goto L99;
  ...
  anon54_Else:
    ...
    assume SLAM_guard_O_0 != SLAM_guard_O_0_init;
    call {:si_unique_call 670} SLIC_ZwClose_entry(strConst__li2bpl4);
    goto anon64_Then, anon64_Else;
  ...
  L158:
    call {:si_unique_call 671} vslice_dummy_var_332 := ZwClose(0);
    assume {:nonnull} Key_4 != 0;
    assume Key_4 > 0;
    Mem_T.PVOID[Key_4] := 0;
    goto L103;
  ...
  L103:
    ...
    call {:si_unique_call 667} RtlInitUnicodeString(Name_5, Tmp_379);
    call {:si_unique_call 668} sdv_InitializeObjectAttributes(0, 0, 576, 0, 0);
    call {:si_unique_call 669} sdv_280 := ZwOpenKey(Key_4, 983103, 0);
    assume {:nonnull} Key_4 != 0;
    assume Key_4 > 0;
    goto anon61_Then, anon61_Else;
  ...
  anon61_Else:
    assume Mem_T.PVOID[Key_4] == SLAM_guard_O_0;
    assume SLAM_guard_O_0 != SLAM_guard_O_0_init;
    call {:si_unique_call 679} SLIC_ZwOpenKey_exit(0, sdv_280);
    goto L116;
  ...
  anon57_Else:
    assume Mem_T.PVOID[Key_4] == SLAM_guard_O_0;
    assume SLAM_guard_O_0 != SLAM_guard_O_0_init;
    call {:si_unique_call 673} SLIC_ZwDeleteKey_entry(strConst__li2bpl4);
    goto anon65_Then, anon65_Else;
  ...
  L164:
    call {:si_unique_call 674} vslice_dummy_var_333 := ZwDeleteKey(0);
    assume {:nonnull} Key_4 != 0;
    assume Key_4 > 0;
    goto anon58_Then, anon58_Else;
  ...
  anon58_Else:
    assume Mem_T.PVOID[Key_4] == SLAM_guard_O_0;
    assume SLAM_guard_O_0 != SLAM_guard_O_0_init;
    call {:si_unique_call 675} SLIC_ZwClose_entry(strConst__li2bpl4);
    goto anon66_Then, anon66_Else;
  ...
  L167:
    call {:si_unique_call 680} vslice_dummy_var_334 := ZwClose(0);
    goto L117;
  ...
  anon56_Else:
    assume {:partition} CallbackCtx_4 != 0;
    call {:si_unique_call 672} ExFreePoolWithTag(0, 812934738);
    goto L124;
  ...
  anon59_Else:
    ...
    call {:si_unique_call 676} ExFreePoolWithTag(0, 812934738);
    goto L128;
  ...
  anon60_Else:
    ...
    call {:si_unique_call 678} vslice_dummy_var_360 := corral_nondet();
    goto L138;
  ...
  anon60_Then:
    assume {:partition} Success_5 == 0;
    call {:si_unique_call 677} vslice_dummy_var_361 := corral_nondet();
    goto L138;
  ...
  anon62_Then:
    assume {:partition} CallbackCtx_4 != 0;
    call {:si_unique_call 650} sdv_282 := ExAllocatePoolWithTag(1, 8, 812934738);
  ...
  anon63_Then:
    assume {:partition} RMCallbackCtx != 0;
    call {:si_unique_call 651} sdv_RtlZeroMemory(0, 8);
    assume {:nonnull} CallbackCtx_4 != 0;
    assume CallbackCtx_4 > 0;
    call {:si_unique_call 652} sdv_InitializeObjectAttributes(0, 0, 512, 0, 0);
    call {:si_unique_call 653} Status_11 := ZwCreateTransaction(Transaction, 2031679, 0, 0, 0, 0, 0, 0, 0, 0);
    goto anon46_Then, anon46_Else;

  anon46_Else:
    assume {:partition} Status_11 >= 0;
    havoc vslice_dummy_var_154;
    call {:si_unique_call 655} Status_11 := CmRegisterCallbackEx(li2bplFunctionConstant345, 0, vslice_dummy_var_154, 0, 0, 0);
    goto anon47_Then, anon47_Else;
  ...
  L62:
    ...
    call {:si_unique_call 657} RtlInitUnicodeString(Name_5, Tmp_388);
    call {:si_unique_call 658} sdv_InitializeObjectAttributes(0, 0, 576, 0, 0);
    call {:si_unique_call 659} Status_11 := ZwCreateKeyTransacted(Key_4, 983103, 0, 0, 0, 0, 0, 0);
    goto anon48_Then, anon48_Else;
  ...
  L77:
    call {:si_unique_call 661} Status_11 := ZwCommitTransaction(0, 1);
    goto anon49_Then, anon49_Else;
  ...
  L85:
    ...
    call {:si_unique_call 663} Status_11 := CmUnRegisterCallback(vslice_dummy_var_155);
    goto anon50_Then, anon50_Else;
  ...
  anon51_Else:
    call {:si_unique_call 665} vslice_dummy_var_359 := corral_nondet();
    Success_5 := 0;
    goto L94;
  ...
  anon50_Then:
    ...
    call {:si_unique_call 664} vslice_dummy_var_362 := corral_nondet();
    Success_5 := 0;
    goto L93;

  anon49_Then:
    assume {:partition} 0 > Status_11;
    call {:si_unique_call 662} vslice_dummy_var_363 := corral_nondet();
    Success_5 := 0;
    goto L85;

  anon48_Then:
    assume {:partition} 0 > Status_11;
    call {:si_unique_call 660} vslice_dummy_var_364 := corral_nondet();
    Success_5 := 0;
    goto L77;

  anon47_Then:
    assume {:partition} 0 > Status_11;
    call {:si_unique_call 656} vslice_dummy_var_365 := corral_nondet();
    Success_5 := 0;
    goto L62;

  anon46_Then:
    assume {:partition} 0 > Status_11;
    call {:si_unique_call 654} vslice_dummy_var_366 := corral_nondet();
    goto L94;
...
implementation {:origName "TransactionReplaySample"} TransactionReplaySample() returns (Tmp_395: int)
{
  ...
  anon0:
    call {:si_unique_call 681} Key_5 := __HAVOC_malloc(4);
    call {:si_unique_call 682} vslice_dummy_var_368 := __HAVOC_malloc(24);
    call {:si_unique_call 683} vslice_dummy_var_369 := __HAVOC_malloc(24);
    call {:si_unique_call 684} TransactedRoot := __HAVOC_malloc(4);
    call {:si_unique_call 685} Transaction_1 := __HAVOC_malloc(4);
    call {:si_unique_call 686} Name_6 := __HAVOC_malloc(12);
    call {:si_unique_call 687} vslice_dummy_var_380 := __HAVOC_malloc(196);
    call {:si_unique_call 688} vslice_dummy_var_381 := __HAVOC_malloc(32);
    call {:si_unique_call 689} vslice_dummy_var_382 := __HAVOC_malloc(32);
    call {:si_unique_call 690} Tmp_400 := __HAVOC_malloc(48);
    call {:si_unique_call 691} vslice_dummy_var_383 := __HAVOC_malloc(168);
    call {:si_unique_call 692} vslice_dummy_var_384 := __HAVOC_malloc(32);
    call {:si_unique_call 693} vslice_dummy_var_385 := __HAVOC_malloc(32);
    call {:si_unique_call 694} vslice_dummy_var_386 := __HAVOC_malloc(32);
    call {:si_unique_call 695} vslice_dummy_var_387 := __HAVOC_malloc(32);
    call {:si_unique_call 696} vslice_dummy_var_388 := __HAVOC_malloc(32);
    call {:si_unique_call 697} vslice_dummy_var_389 := __HAVOC_malloc(160);
    call {:si_unique_call 698} vslice_dummy_var_390 := __HAVOC_malloc(32);
    call {:si_unique_call 699} vslice_dummy_var_391 := __HAVOC_malloc(32);
    call {:si_unique_call 700} vslice_dummy_var_392 := __HAVOC_malloc(32);
    call {:si_unique_call 701} vslice_dummy_var_393 := __HAVOC_malloc(164);
    call {:si_unique_call 702} vslice_dummy_var_394 := __HAVOC_malloc(264);
    call {:si_unique_call 703} Tmp_413 := __HAVOC_malloc(28);
    call {:si_unique_call 704} vslice_dummy_var_395 := __HAVOC_malloc(32);
    call {:si_unique_call 705} Tmp_415 := __HAVOC_malloc(80);
    call {:si_unique_call 706} vslice_dummy_var_396 := __HAVOC_malloc(164);
    call {:si_unique_call 707} vslice_dummy_var_397 := __HAVOC_malloc(188);
    call {:si_unique_call 708} vslice_dummy_var_398 := __HAVOC_malloc(204);
    call {:si_unique_call 709} vslice_dummy_var_399 := __HAVOC_malloc(24);
    call {:si_unique_call 710} vslice_dummy_var_400 := __HAVOC_malloc(340);
    call {:si_unique_call 711} vslice_dummy_var_401 := __HAVOC_malloc(164);
    call {:si_unique_call 712} vslice_dummy_var_402 := __HAVOC_malloc(32);
    call {:si_unique_call 713} vslice_dummy_var_403 := __HAVOC_malloc(264);
    call {:si_unique_call 714} vslice_dummy_var_404 := __HAVOC_malloc(172);
    call {:si_unique_call 715} Tmp_425 := __HAVOC_malloc(48);
    call {:si_unique_call 716} Tmp_426 := __HAVOC_malloc(160);
    call {:si_unique_call 717} vslice_dummy_var_405 := __HAVOC_malloc(32);
    call {:si_unique_call 718} Tmp_428 := __HAVOC_malloc(80);
    call {:si_unique_call 719} vslice_dummy_var_406 := __HAVOC_malloc(192);
    call {:si_unique_call 720} vslice_dummy_var_407 := __HAVOC_malloc(32);
    call {:si_unique_call 721} vslice_dummy_var_408 := __HAVOC_malloc(32);
    call {:si_unique_call 722} vslice_dummy_var_409 := __HAVOC_malloc(200);
    CallbackCtx_5 := 0;
    ...
    bSuccess := 0;
    call {:si_unique_call 723} vslice_dummy_var_410 := corral_nondet();
    call {:si_unique_call 724} vslice_dummy_var_411 := corral_nondet();
    goto anon79_Then, anon79_Else;

  anon79_Else:
    Tmp_413 := strConst__li2bpl20;
    call {:si_unique_call 726} sdv_314 := CreateCallbackContext(4, Tmp_413);
  ...
  anon99_Else:
    ...
    assume SLAM_guard_O_0 != SLAM_guard_O_0_init;
    call {:si_unique_call 770} SLIC_ZwDeleteKey_entry(strConst__li2bpl4);
  ...
  L252:
    call {:si_unique_call 771} vslice_dummy_var_378 := ZwDeleteKey(0);
    assume {:nonnull} Key_5 != 0;
    assume Key_5 > 0;
  ...
  anon100_Else:
    assume Mem_T.PVOID[Key_5] == SLAM_guard_O_0;
    assume SLAM_guard_O_0 != SLAM_guard_O_0_init;
    call {:si_unique_call 772} SLIC_ZwClose_entry(strConst__li2bpl4);
  ...
  L255:
    call {:si_unique_call 782} vslice_dummy_var_379 := ZwClose(0);
    goto L171;
  ...
  anon98_Else:
    ...
    call {:si_unique_call 768} vslice_dummy_var_370 := ZwDeleteKey(0);
    call {:si_unique_call 769} vslice_dummy_var_371 := ZwClose(0);
    goto L178;
  ...
  anon101_Else:
    ...
    call {:si_unique_call 773} vslice_dummy_var_372 := ZwClose(0);
    goto L185;
  ...
  anon102_Else:
    assume {:partition} CallbackCtx_5 != 0;
    call {:si_unique_call 774} ExFreePoolWithTag(0, 812934738);
    goto L189;
  ...
  anon103_Else:
    ...
    call {:si_unique_call 776} vslice_dummy_var_414 := corral_nondet();
    goto L199;
  ...
  anon103_Then:
    assume {:partition} bSuccess == 0;
    call {:si_unique_call 775} vslice_dummy_var_415 := corral_nondet();
    goto L199;
  ...
  anon109_Then:
    assume {:partition} CallbackCtx_5 != 0;
    call {:si_unique_call 727} sdv_InitializeObjectAttributes(0, 0, 512, 0, 0);
    call {:si_unique_call 728} Status_12 := ZwCreateTransaction(Transaction_1, 2031679, 0, 0, 0, 0, 0, 0, 0, 0);
    goto anon80_Then, anon80_Else;

  anon80_Else:
    assume {:partition} Status_12 >= 0;
    Tmp_426 := strConst__li2bpl2;
    call {:si_unique_call 730} RtlInitUnicodeString(Name_6, Tmp_426);
    call {:si_unique_call 731} sdv_InitializeObjectAttributes(0, 0, 576, 0, 0);
    call {:si_unique_call 732} Status_12 := ZwOpenKeyTransacted(TransactedRoot, 983103, 0, 0);
    goto anon81_Then, anon81_Else;

  anon81_Else:
    assume {:partition} Status_12 >= 0;
    havoc vslice_dummy_var_156;
    call {:si_unique_call 734} Status_12 := CmRegisterCallbackEx(li2bplFunctionConstant345, 0, vslice_dummy_var_156, 0, 0, 0);
  ...
  anon82_Else:
    ...
    call {:si_unique_call 736} RtlInitUnicodeString(Name_6, Tmp_400);
    call {:si_unique_call 737} sdv_InitializeObjectAttributes(0, 0, 576, 0, 0);
    call {:si_unique_call 738} Status_12 := ZwCreateKey(Key_5, 983103, 0, 0, 0, 0, 0);
    assume {:nonnull} Key_5 != 0;
    assume Key_5 > 0;
  ...
  anon104_Else:
    assume Mem_T.PVOID[Key_5] == SLAM_guard_O_0;
    assume SLAM_guard_O_0 != SLAM_guard_O_0_init;
    call {:si_unique_call 777} SLIC_ZwCreateKey_exit(strConst__li2bpl4, Status_12);
  ...
  L81:
    ...
    call {:si_unique_call 740} Status_12 := CmUnRegisterCallback(vslice_dummy_var_157);
  ...
  anon86_Else:
    assume Mem_T.PVOID[Key_5] == SLAM_guard_O_0;
    assume SLAM_guard_O_0 != SLAM_guard_O_0_init;
    call {:si_unique_call 743} SLIC_ZwClose_entry(strConst__li2bpl4);
  ...
  L225:
    call {:si_unique_call 744} vslice_dummy_var_373 := ZwClose(0);
    assume {:nonnull} Key_5 != 0;
    assume Key_5 > 0;
    Mem_T.PVOID[Key_5] := 0;
    goto L90;
  ...
  L90:
    call {:si_unique_call 742} Status_12 := ZwOpenKey(Key_5, 983103, 0);
    assume {:nonnull} Key_5 != 0;
    assume Key_5 > 0;
  ...
  anon105_Else:
    assume Mem_T.PVOID[Key_5] == SLAM_guard_O_0;
    assume SLAM_guard_O_0 != SLAM_guard_O_0_init;
    call {:si_unique_call 778} SLIC_ZwOpenKey_exit(0, Status_12);
    goto L98;
  ...
  anon88_Else:
    assume Mem_T.PVOID[Key_5] == SLAM_guard_O_0;
    assume SLAM_guard_O_0 != SLAM_guard_O_0_init;
    call {:si_unique_call 746} SLIC_ZwClose_entry(strConst__li2bpl4);
  ...
  L231:
    call {:si_unique_call 747} vslice_dummy_var_374 := ZwClose(0);
    assume {:nonnull} Key_5 != 0;
    assume Key_5 > 0;
    Mem_T.PVOID[Key_5] := 0;
    goto L106;
  ...
  L106:
    ...
    call {:si_unique_call 748} RtlInitUnicodeString(Name_6, Tmp_428);
    call {:si_unique_call 749} sdv_InitializeObjectAttributes(0, 0, 576, 0, 0);
    call {:si_unique_call 750} Status_12 := ZwOpenKey(Key_5, 983103, 0);
    assume {:nonnull} Key_5 != 0;
    assume Key_5 > 0;
  ...
  anon106_Else:
    assume Mem_T.PVOID[Key_5] == SLAM_guard_O_0;
    assume SLAM_guard_O_0 != SLAM_guard_O_0_init;
    call {:si_unique_call 779} SLIC_ZwOpenKey_exit(0, Status_12);
    goto L116;
  ...
  anon90_Else:
    assume Mem_T.PVOID[Key_5] == SLAM_guard_O_0;
    assume SLAM_guard_O_0 != SLAM_guard_O_0_init;
    call {:si_unique_call 752} SLIC_ZwClose_entry(strConst__li2bpl4);
  ...
  L237:
    call {:si_unique_call 753} vslice_dummy_var_375 := ZwClose(0);
    assume {:nonnull} Key_5 != 0;
    assume Key_5 > 0;
    Mem_T.PVOID[Key_5] := 0;
    goto L124;
  ...
  L124:
    call {:si_unique_call 754} Status_12 := ZwRollbackTransaction(0, 1);
    goto anon91_Then, anon91_Else;

  anon91_Else:
    assume {:partition} Status_12 >= 0;
    Tmp_425 := strConst__li2bpl10;
    call {:si_unique_call 756} RtlInitUnicodeString(Name_6, Tmp_425);
    call {:si_unique_call 757} sdv_InitializeObjectAttributes(0, 0, 576, 0, 0);
    call {:si_unique_call 758} Status_12 := ZwOpenKey(Key_5, 983103, 0);
    assume {:nonnull} Key_5 != 0;
    assume Key_5 > 0;
  ...
  anon107_Else:
    assume Mem_T.PVOID[Key_5] == SLAM_guard_O_0;
    assume SLAM_guard_O_0 != SLAM_guard_O_0_init;
    call {:si_unique_call 780} SLIC_ZwOpenKey_exit(0, Status_12);
    goto L142;
  ...
  anon92_Else:
    ...
    call {:si_unique_call 759} vslice_dummy_var_412 := corral_nondet();
    bSuccess := 0;
    goto L143;
  ...
  L243:
    call {:si_unique_call 764} vslice_dummy_var_376 := ZwDeleteKey(0);
    assume {:nonnull} Key_5 != 0;
    assume Key_5 > 0;
  ...
  L246:
    call {:si_unique_call 766} vslice_dummy_var_377 := ZwClose(0);
    assume {:nonnull} Key_5 != 0;
    assume Key_5 > 0;
    Mem_T.PVOID[Key_5] := 0;
    goto L148;
  ...
  L148:
    ...
    call {:si_unique_call 760} RtlInitUnicodeString(Name_6, Tmp_415);
    call {:si_unique_call 761} sdv_InitializeObjectAttributes(0, 0, 576, 0, 0);
    call {:si_unique_call 762} Status_12 := ZwOpenKey(Key_5, 983103, 0);
    assume {:nonnull} Key_5 != 0;
    assume Key_5 > 0;
  ...
  anon108_Else:
    assume Mem_T.PVOID[Key_5] == SLAM_guard_O_0;
    assume SLAM_guard_O_0 != SLAM_guard_O_0_init;
    call {:si_unique_call 781} SLIC_ZwOpenKey_exit(0, Status_12);
    goto L165;
  ...
  anon96_Else:
    assume {:partition} Status_12 != -1073741772;
    call {:si_unique_call 767} vslice_dummy_var_413 := corral_nondet();
    bSuccess := 0;
    goto L166;
  ...
  anon91_Then:
    ...
    call {:si_unique_call 755} vslice_dummy_var_416 := corral_nondet();
    bSuccess := 0;
    goto L166;
  ...
  anon89_Then:
    assume {:partition} 0 > Status_12;
    call {:si_unique_call 751} vslice_dummy_var_417 := corral_nondet();
    bSuccess := 0;
    goto L124;
  ...
  anon87_Then:
    assume {:partition} 0 > Status_12;
    call {:si_unique_call 745} vslice_dummy_var_418 := corral_nondet();
    bSuccess := 0;
    goto L106;
  ...
  anon84_Then:
    assume {:partition} 0 > Status_12;
    call {:si_unique_call 741} vslice_dummy_var_419 := corral_nondet();
    bSuccess := 0;
    goto L89;

  anon83_Then:
    assume {:partition} 0 > Status_12;
    call {:si_unique_call 739} vslice_dummy_var_420 := corral_nondet();
    bSuccess := 0;
    goto L81;
  ...
  anon82_Then:
    assume {:partition} 0 > Status_12;
    call {:si_unique_call 735} vslice_dummy_var_421 := corral_nondet();
    goto L166;

  anon81_Then:
    assume {:partition} 0 > Status_12;
    call {:si_unique_call 733} vslice_dummy_var_422 := corral_nondet();
    goto L166;

  anon80_Then:
    assume {:partition} 0 > Status_12;
    call {:si_unique_call 729} vslice_dummy_var_423 := corral_nondet();
    goto L166;

  anon79_Then:
    call {:si_unique_call 725} vslice_dummy_var_424 := corral_nondet();
    goto L166;
}
...
implementation {:origName "_sdv_init6"} _sdv_init6()
{
  ...
  anon0:
    call {:si_unique_call 783} vslice_dummy_var_425 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "SLIC_ZwDeleteKey_entry"} {:osmodel} SLIC_ZwDeleteKey_entry(actual_caller: int)
{
  ...
  anon5_Else:
    ...
    call {:si_unique_call 784} SLIC_ABORT_18_0(caller);
    goto anon6_Then, anon6_Else;
...
procedure {:origName "SLIC_ZwOpenKey_exit"} {:osmodel} SLIC_ZwOpenKey_exit(actual_caller_1: int, actual_ZwOpenKey_1: int);
...
implementation {:origName "SLIC_ZwOpenKey_exit"} {:osmodel} SLIC_ZwOpenKey_exit(actual_caller_1: int, actual_ZwOpenKey_1: int)
{
  ...
  anon3_Else:
    ...
    call {:si_unique_call 785} SLIC_EXIT_ROUTINE(strConst__li2bpl75);
    goto L2;
...
procedure {:origName "SLIC_DriverEntry_exit"} {:osmodel} SLIC_DriverEntry_exit(actual_caller_2: int);
  modifies yogi_error;
  free ensures {:va_keep} old(handleState) == 1 ==> yogi_error == 1;
  free ensures {:va_keep} old(handleState) == 2 ==> yogi_error == 0;
  free ensures {:va_keep} old(handleState) == 0 ==> yogi_error == 0;
...
implementation {:origName "SLIC_DriverEntry_exit"} {:osmodel} SLIC_DriverEntry_exit(actual_caller_2: int)
{
  ...
  anon5_Else:
    assume {:partition} handleState == 1;
    call {:si_unique_call 786} SLIC_ABORT_22_0(caller_2);
    goto anon6_Then, anon6_Else;
...
procedure {:origName "SLIC_DeviceCreate_exit"} {:osmodel} SLIC_DeviceCreate_exit(actual_caller_3: int);
  modifies yogi_error;
  free ensures {:va_keep} old(handleState) == 1 ==> yogi_error == 1;
  free ensures {:va_keep} old(handleState) == 2 ==> yogi_error == 0;
  free ensures {:va_keep} old(handleState) == 0 ==> yogi_error == 0;
...
implementation {:origName "SLIC_DeviceCreate_exit"} {:osmodel} SLIC_DeviceCreate_exit(actual_caller_3: int)
{
  ...
  anon5_Else:
    assume {:partition} handleState == 1;
    call {:si_unique_call 787} SLIC_ABORT_30_0(caller_3);
    goto anon6_Then, anon6_Else;
...
procedure {:origName "SLIC_ABORT_26_0"} SLIC_ABORT_26_0(actual_caller_4: int);
  modifies yogi_error;
  free ensures {:va_keep} old(handleState) == 1 ==> yogi_error == 1;
  free ensures {:va_keep} old(handleState) == 2 ==> yogi_error == 1;
  free ensures {:va_keep} old(handleState) == 0 ==> yogi_error == 1;
...
implementation {:origName "SLIC_ABORT_26_0"} SLIC_ABORT_26_0(actual_caller_4: int)
{
  var {:pointer} caller_4: int;

  anon0:
    caller_4 := actual_caller_4;
    call {:si_unique_call 788} SLIC_ERROR_ROUTINE(strConst__li2bpl76);
    return;
}



procedure {:origName "SLIC_DeviceControl_exit"} {:osmodel} SLIC_DeviceControl_exit(actual_caller_5: int);
  modifies yogi_error;
  free ensures {:va_keep} old(handleState) == 1 ==> yogi_error == 1;
  free ensures {:va_keep} old(handleState) == 2 ==> yogi_error == 0;
  free ensures {:va_keep} old(handleState) == 0 ==> yogi_error == 0;
...
implementation {:origName "SLIC_DeviceControl_exit"} {:osmodel} SLIC_DeviceControl_exit(actual_caller_5: int)
{
  ...
  anon5_Else:
    assume {:partition} handleState == 1;
    call {:si_unique_call 789} SLIC_ABORT_26_0(caller_5);
    goto anon6_Then, anon6_Else;
...
procedure {:origName "SLIC_ABORT_14_0"} SLIC_ABORT_14_0(actual_caller_6: int);
  modifies yogi_error;
  free ensures {:va_keep} old(handleState) == 1 ==> yogi_error == 1;
  free ensures {:va_keep} old(handleState) == 2 ==> yogi_error == 1;
  free ensures {:va_keep} old(handleState) == 0 ==> yogi_error == 1;
...
implementation {:origName "SLIC_ABORT_14_0"} SLIC_ABORT_14_0(actual_caller_6: int)
{
  var {:pointer} caller_6: int;

  anon0:
    caller_6 := actual_caller_6;
    call {:si_unique_call 790} SLIC_ERROR_ROUTINE(strConst__li2bpl77);
    return;
}



procedure {:origName "SLIC_ZwClose_entry"} {:osmodel} SLIC_ZwClose_entry(actual_caller_7: int);
...
implementation {:origName "SLIC_ZwClose_entry"} {:osmodel} SLIC_ZwClose_entry(actual_caller_7: int)
{
  ...
  anon5_Then:
    assume {:partition} handleState != 1;
    call {:si_unique_call 791} SLIC_ABORT_16_0(caller_7);
    goto anon6_Then, anon6_Else;
...
procedure {:origName "SLIC_ABORT_20_0"} SLIC_ABORT_20_0(actual_caller_8: int);
  modifies yogi_error;
  free ensures {:va_keep} old(handleState) == 1 ==> yogi_error == 1;
  free ensures {:va_keep} old(handleState) == 2 ==> yogi_error == 1;
  free ensures {:va_keep} old(handleState) == 0 ==> yogi_error == 1;
...
implementation {:origName "SLIC_ABORT_20_0"} SLIC_ABORT_20_0(actual_caller_8: int)
{
  var {:pointer} caller_8: int;

  anon0:
    caller_8 := actual_caller_8;
    call {:si_unique_call 792} SLIC_ERROR_ROUTINE(strConst__li2bpl76);
    return;
}



procedure {:origName "SLIC_ZwSetValueKey_entry"} {:osmodel} SLIC_ZwSetValueKey_entry(actual_caller_9: int);
  modifies yogi_error;
  free ensures {:va_keep} old(handleState) == 1 ==> yogi_error == 0;
  free ensures {:va_keep} old(handleState) == 2 ==> yogi_error == 1;
  free ensures {:va_keep} old(handleState) == 0 ==> yogi_error == 1;
...
implementation {:origName "SLIC_ZwSetValueKey_entry"} {:osmodel} SLIC_ZwSetValueKey_entry(actual_caller_9: int)
{
  ...
  anon5_Else:
    assume {:partition} handleState != 1;
    call {:si_unique_call 793} SLIC_ABORT_14_0(caller_9);
    goto anon6_Then, anon6_Else;
...
implementation {:origName "SLIC_ABORT_24_0"} SLIC_ABORT_24_0(actual_caller_12: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 794} SLIC_ERROR_ROUTINE(strConst__li2bpl76);
    return;
}
...
implementation {:origName "SLIC_ABORT_16_0"} SLIC_ABORT_16_0(actual_caller_13: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 795} SLIC_ERROR_ROUTINE(strConst__li2bpl78);
    return;
}
...
implementation {:origName "SLIC_ABORT_18_0"} SLIC_ABORT_18_0(actual_caller_14: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 796} SLIC_ERROR_ROUTINE(strConst__li2bpl79);
    return;
}
...
implementation {:origName "SLIC_DeviceCleanup_exit"} {:osmodel} SLIC_DeviceCleanup_exit(actual_caller_16: int)
{
  ...
  anon5_Else:
    assume {:partition} handleState == 1;
    call {:si_unique_call 797} SLIC_ABORT_24_0(caller_16);
    goto anon6_Then, anon6_Else;
...
procedure {:origName "SLIC_ABORT_22_0"} SLIC_ABORT_22_0(actual_caller_17: int);
  modifies yogi_error;
  free ensures {:va_keep} old(handleState) == 1 ==> yogi_error == 1;
  free ensures {:va_keep} old(handleState) == 2 ==> yogi_error == 1;
  free ensures {:va_keep} old(handleState) == 0 ==> yogi_error == 1;
...
implementation {:origName "SLIC_ABORT_22_0"} SLIC_ABORT_22_0(actual_caller_17: int)
{
  var {:pointer} caller_17: int;

  anon0:
    caller_17 := actual_caller_17;
    call {:si_unique_call 798} SLIC_ERROR_ROUTINE(strConst__li2bpl76);
    return;
}



procedure {:origName "SLIC_DeviceUnload_exit"} {:osmodel} SLIC_DeviceUnload_exit(actual_caller_18: int);
  modifies yogi_error;
  free ensures {:va_keep} old(handleState) == 1 ==> yogi_error == 1;
  free ensures {:va_keep} old(handleState) == 2 ==> yogi_error == 0;
  free ensures {:va_keep} old(handleState) == 0 ==> yogi_error == 0;
...
implementation {:origName "SLIC_DeviceUnload_exit"} {:osmodel} SLIC_DeviceUnload_exit(actual_caller_18: int)
{
  ...
  anon5_Else:
    assume {:partition} handleState == 1;
    call {:si_unique_call 799} SLIC_ABORT_20_0(caller_18);
    goto anon6_Then, anon6_Else;
...
procedure {:origName "SLIC_ABORT_30_0"} SLIC_ABORT_30_0(actual_caller_22: int);
  modifies yogi_error;
  free ensures {:va_keep} old(handleState) == 1 ==> yogi_error == 1;
  free ensures {:va_keep} old(handleState) == 2 ==> yogi_error == 1;
  free ensures {:va_keep} old(handleState) == 0 ==> yogi_error == 1;
...
implementation {:origName "SLIC_ABORT_30_0"} SLIC_ABORT_30_0(actual_caller_22: int)
{
  var {:pointer} caller_22: int;

  anon0:
    caller_22 := actual_caller_22;
    call {:si_unique_call 800} SLIC_ERROR_ROUTINE(strConst__li2bpl76);
    return;
}



procedure {:origName "SLIC_ABORT_28_0"} SLIC_ABORT_28_0(actual_caller_23: int);
  modifies yogi_error;
  free ensures {:va_keep} old(handleState) == 1 ==> yogi_error == 1;
  free ensures {:va_keep} old(handleState) == 2 ==> yogi_error == 1;
  free ensures {:va_keep} old(handleState) == 0 ==> yogi_error == 1;
...
implementation {:origName "SLIC_ABORT_28_0"} SLIC_ABORT_28_0(actual_caller_23: int)
{
  var {:pointer} caller_23: int;

  anon0:
    caller_23 := actual_caller_23;
    call {:si_unique_call 801} SLIC_ERROR_ROUTINE(strConst__li2bpl76);
    return;
}



procedure {:origName "SLIC_ZwCreateKey_exit"} {:osmodel} SLIC_ZwCreateKey_exit(actual_caller_26: int, actual_ZwCreateKey_1: int);
  modifies handleState, yogi_error;
  free ensures {:va_keep} old(handleState) == 1 ==> handleState != 2;
  free ensures {:va_keep} old(handleState) == 1 ==> handleState != 0;
  free ensures {:va_keep} old(handleState) == 2 ==> handleState != 0;
  ...
  free ensures {:va_keep} old(handleState) == 2 ==> yogi_error == 0;
  free ensures {:va_keep} old(handleState) == 0 ==> yogi_error == 0;
  free ensures {:va_keep} handleState == 1 || handleState == old(handleState);
  free ensures {:va_keep} yogi_error == 1 || yogi_error == old(yogi_error);
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} false || old(handleState) == 1 || old(handleState) == 2 || old(handleState) == 0;
  free ensures {:va_keep} alloc >= old(alloc);
...
implementation {:origName "SLIC_ZwCreateKey_exit"} {:osmodel} SLIC_ZwCreateKey_exit(actual_caller_26: int, actual_ZwCreateKey_1: int)
{
  ...
  anon8_Then:
    assume {:partition} handleState == 1;
    call {:si_unique_call 802} SLIC_ABORT_2_0(caller_26, ZwCreateKey_1);
    goto anon9_Then, anon9_Else;
...
procedure {:origName "SLIC_ABORT_2_0"} SLIC_ABORT_2_0(actual_caller_28: int, actual_ZwCreateKey_2: int);
  modifies yogi_error;
  free ensures {:va_keep} old(handleState) == 1 ==> yogi_error == 1;
  free ensures {:va_keep} old(handleState) == 2 ==> yogi_error == 1;
  free ensures {:va_keep} old(handleState) == 0 ==> yogi_error == 1;
...
implementation {:origName "SLIC_ABORT_2_0"} SLIC_ABORT_2_0(actual_caller_28: int, actual_ZwCreateKey_2: int)
{
  var {:pointer} caller_28: int;
  var {:scalar} ZwCreateKey_2: int;

  anon0:
    caller_28 := actual_caller_28;
    ZwCreateKey_2 := actual_ZwCreateKey_2;
    call {:si_unique_call 803} SLIC_ERROR_ROUTINE(strConst__li2bpl84);
    return;
}
...
procedure {:origName "SLIC_DeviceClose_exit"} {:osmodel} SLIC_DeviceClose_exit(actual_caller_29: int);
  modifies yogi_error;
  free ensures {:va_keep} old(handleState) == 1 ==> yogi_error == 1;
  free ensures {:va_keep} old(handleState) == 2 ==> yogi_error == 0;
  free ensures {:va_keep} old(handleState) == 0 ==> yogi_error == 0;
...
implementation {:origName "SLIC_DeviceClose_exit"} {:osmodel} SLIC_DeviceClose_exit(actual_caller_29: int)
{
  ...
  anon5_Else:
    assume {:partition} handleState == 1;
    call {:si_unique_call 804} SLIC_ABORT_28_0(caller_29);
    goto anon6_Then, anon6_Else;
...
implementation {:origName "_sdv_init3"} _sdv_init3()
{
  ...
  anon0:
    call {:si_unique_call 805} vslice_dummy_var_426 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "CreateCallbackContext"} CreateCallbackContext(actual_CallbackMode: int, actual_AltitudeString: int) returns (Tmp_437: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 806} Tmp_438 := __HAVOC_malloc(12);
    call {:si_unique_call 807} vslice_dummy_var_427 := __HAVOC_malloc(32);
    call {:si_unique_call 808} vslice_dummy_var_428 := __HAVOC_malloc(32);
    call {:si_unique_call 809} vslice_dummy_var_429 := __HAVOC_malloc(276);
    call {:si_unique_call 810} vslice_dummy_var_430 := __HAVOC_malloc(292);
    CallbackCtx_6 := 0;
    Success_6 := 0;
    call {:si_unique_call 811} sdv_326 := ExAllocatePoolWithTag(1, 72, 812934738);
    CallbackCtx_6 := sdv_326;
    goto anon14_Then, anon14_Else;

  anon14_Else:
    assume {:partition} CallbackCtx_6 != 0;
    call {:si_unique_call 813} sdv_RtlZeroMemory(0, 72);
  ...
  L24:
    Tmp_438 := strConst__li2bpl87;
    assume {:nonnull} CallbackCtx_6 != 0;
    assume CallbackCtx_6 > 0;
    havoc vslice_dummy_var_158;
    call {:si_unique_call 814} Status_13 := RtlStringCbPrintfW(vslice_dummy_var_158, 20, Tmp_438);
    goto anon11_Then, anon11_Else;
  ...
  anon11_Else:
    ...
    call {:si_unique_call 816} RtlInitUnicodeString(Altitude__CALLBACK_CONTEXT(CallbackCtx_6), vslice_dummy_var_159);
    Success_6 := 1;
    goto L36;
  ...
  anon13_Else:
    assume {:partition} CallbackCtx_6 != 0;
    call {:si_unique_call 817} ExFreePoolWithTag(0, 812934738);
    CallbackCtx_6 := 0;
    goto L38;
  ...
  anon11_Then:
    ...
    call {:si_unique_call 815} vslice_dummy_var_431 := corral_nondet();
    goto L36;

  anon15_Then:
    assume {:nonnull} CallbackCtx_6 != 0;
    assume CallbackCtx_6 > 0;
    call {:si_unique_call 818} boogieTmp := __HAVOC_malloc(1);
    goto L24;

  anon14_Then:
    assume {:partition} CallbackCtx_6 == 0;
    call {:si_unique_call 812} vslice_dummy_var_432 := corral_nondet();
    goto L36;
}
...
implementation {:origName "PostNotificationOverrideSuccessSample"} PostNotificationOverrideSuccessSample() returns (Tmp_444: int)
{
  ...
  anon0:
    call {:si_unique_call 819} Key_6 := __HAVOC_malloc(4);
    call {:si_unique_call 820} vslice_dummy_var_433 := __HAVOC_malloc(24);
    call {:si_unique_call 821} NotModifiedKey := __HAVOC_malloc(4);
    call {:si_unique_call 822} Name_7 := __HAVOC_malloc(12);
    call {:si_unique_call 823} vslice_dummy_var_440 := __HAVOC_malloc(212);
    call {:si_unique_call 824} vslice_dummy_var_441 := __HAVOC_malloc(32);
    call {:si_unique_call 825} vslice_dummy_var_442 := __HAVOC_malloc(24);
    call {:si_unique_call 826} vslice_dummy_var_443 := __HAVOC_malloc(232);
    call {:si_unique_call 827} Tmp_449 := __HAVOC_malloc(48);
    call {:si_unique_call 828} Tmp_450 := __HAVOC_malloc(56);
    call {:si_unique_call 829} Tmp_451 := __HAVOC_malloc(56);
    call {:si_unique_call 830} vslice_dummy_var_444 := __HAVOC_malloc(224);
    call {:si_unique_call 831} vslice_dummy_var_445 := __HAVOC_malloc(32);
    call {:si_unique_call 832} Tmp_454 := __HAVOC_malloc(92);
    call {:si_unique_call 833} vslice_dummy_var_446 := __HAVOC_malloc(188);
    call {:si_unique_call 834} vslice_dummy_var_447 := __HAVOC_malloc(236);
    call {:si_unique_call 835} vslice_dummy_var_448 := __HAVOC_malloc(212);
    call {:si_unique_call 836} vslice_dummy_var_449 := __HAVOC_malloc(32);
    call {:si_unique_call 837} vslice_dummy_var_450 := __HAVOC_malloc(200);
    call {:si_unique_call 838} vslice_dummy_var_451 := __HAVOC_malloc(192);
    call {:si_unique_call 839} vslice_dummy_var_452 := __HAVOC_malloc(32);
    call {:si_unique_call 840} vslice_dummy_var_453 := __HAVOC_malloc(224);
    call {:si_unique_call 841} vslice_dummy_var_454 := __HAVOC_malloc(32);
    call {:si_unique_call 842} vslice_dummy_var_455 := __HAVOC_malloc(32);
    call {:si_unique_call 843} Tmp_466 := __HAVOC_malloc(56);
    call {:si_unique_call 844} Tmp_467 := __HAVOC_malloc(28);
    call {:si_unique_call 845} Tmp_468 := __HAVOC_malloc(104);
    call {:si_unique_call 846} vslice_dummy_var_456 := __HAVOC_malloc(200);
    call {:si_unique_call 847} Tmp_470 := __HAVOC_malloc(104);
    call {:si_unique_call 848} vslice_dummy_var_457 := __HAVOC_malloc(32);
    call {:si_unique_call 849} Tmp_472 := __HAVOC_malloc(48);
    call {:si_unique_call 850} vslice_dummy_var_458 := __HAVOC_malloc(32);
    call {:si_unique_call 851} vslice_dummy_var_459 := __HAVOC_malloc(32);
    call {:si_unique_call 852} vslice_dummy_var_460 := __HAVOC_malloc(200);
    call {:si_unique_call 853} vslice_dummy_var_461 := __HAVOC_malloc(32);
    call {:si_unique_call 854} vslice_dummy_var_462 := __HAVOC_malloc(32);
    call {:si_unique_call 855} vslice_dummy_var_463 := __HAVOC_malloc(32);
    CallbackCtx_7 := 0;
    ...
    Success_7 := 0;
    call {:si_unique_call 856} vslice_dummy_var_464 := corral_nondet();
    call {:si_unique_call 857} vslice_dummy_var_465 := corral_nondet();
    Tmp_467 := strConst__li2bpl20;
    call {:si_unique_call 858} sdv_346 := CreateCallbackContext(3, Tmp_467);
  ...
  anon73_Else:
    ...
    assume SLAM_guard_O_0 != SLAM_guard_O_0_init;
    call {:si_unique_call 886} SLIC_ZwDeleteKey_entry(strConst__li2bpl4);
    goto anon87_Then, anon87_Else;
  ...
  L193:
    call {:si_unique_call 887} vslice_dummy_var_436 := ZwDeleteKey(0);
    assume {:nonnull} Key_6 != 0;
    assume Key_6 > 0;
    goto anon74_Then, anon74_Else;
  ...
  anon74_Else:
    assume Mem_T.PVOID[Key_6] == SLAM_guard_O_0;
    assume SLAM_guard_O_0 != SLAM_guard_O_0_init;
    call {:si_unique_call 888} SLIC_ZwClose_entry(strConst__li2bpl4);
    goto anon88_Then, anon88_Else;
  ...
  L196:
    call {:si_unique_call 902} vslice_dummy_var_437 := ZwClose(0);
    goto L125;
  ...
  anon75_Else:
    ...
    assume SLAM_guard_O_0 != SLAM_guard_O_0_init;
    call {:si_unique_call 893} SLIC_ZwDeleteKey_entry(strConst__li2bpl4);
    goto anon89_Then, anon89_Else;
  ...
  L199:
    call {:si_unique_call 894} vslice_dummy_var_438 := ZwDeleteKey(0);
    assume {:nonnull} NotModifiedKey != 0;
    assume NotModifiedKey > 0;
    goto anon76_Then, anon76_Else;
  ...
  anon76_Else:
    assume Mem_T.PVOID[NotModifiedKey] == SLAM_guard_O_0;
    assume SLAM_guard_O_0 != SLAM_guard_O_0_init;
    call {:si_unique_call 895} SLIC_ZwClose_entry(strConst__li2bpl4);
    goto anon90_Then, anon90_Else;
  ...
  L202:
    call {:si_unique_call 903} vslice_dummy_var_439 := ZwClose(0);
    goto L132;

  L132:
    Tmp_451 := strConst__li2bpl21;
    call {:si_unique_call 889} RtlInitUnicodeString(Name_7, Tmp_451);
    call {:si_unique_call 890} vslice_dummy_var_434 := ZwDeleteValueKey(0, 0);
    Tmp_468 := strConst__li2bpl90;
    call {:si_unique_call 891} RtlInitUnicodeString(Name_7, Tmp_468);
    call {:si_unique_call 892} vslice_dummy_var_435 := ZwDeleteValueKey(0, 0);
    goto anon77_Then, anon77_Else;

  anon77_Else:
    assume {:partition} CallbackCtx_7 != 0;
    call {:si_unique_call 896} ExFreePoolWithTag(0, 812934738);
    goto L151;
  ...
  anon78_Else:
    ...
    call {:si_unique_call 898} vslice_dummy_var_470 := corral_nondet();
    goto L161;
  ...
  anon78_Then:
    assume {:partition} Success_7 == 0;
    call {:si_unique_call 897} vslice_dummy_var_471 := corral_nondet();
    goto L161;
  ...
  anon82_Then:
    ...
    call {:si_unique_call 859} Status_14 := CmRegisterCallbackEx(li2bplFunctionConstant345, 0, vslice_dummy_var_160, 0, 0, 0);
    goto anon61_Then, anon61_Else;
  ...
  anon61_Else:
    ...
    call {:si_unique_call 861} RtlInitUnicodeString(Name_7, Tmp_454);
    call {:si_unique_call 862} sdv_InitializeObjectAttributes(0, 0, 576, 0, 0);
    call {:si_unique_call 863} Status_14 := ZwCreateKey(NotModifiedKey, 983103, 0, 0, 0, 0, 0);
    assume {:nonnull} NotModifiedKey != 0;
    assume NotModifiedKey > 0;
    goto anon79_Then, anon79_Else;
  ...
  anon79_Else:
    assume Mem_T.PVOID[NotModifiedKey] == SLAM_guard_O_0;
    assume SLAM_guard_O_0 != SLAM_guard_O_0_init;
    call {:si_unique_call 899} SLIC_ZwCreateKey_exit(strConst__li2bpl4, Status_14);
    goto anon83_Then, anon83_Else;
  ...
  L51:
    ...
    call {:si_unique_call 865} RtlInitUnicodeString(Name_7, Tmp_472);
    call {:si_unique_call 866} sdv_InitializeObjectAttributes(0, 0, 576, 0, 0);
    call {:si_unique_call 867} Status_14 := ZwCreateKey(Key_6, 983103, 0, 0, 0, 0, 0);
    assume {:nonnull} Key_6 != 0;
    assume Key_6 > 0;
    goto anon80_Then, anon80_Else;
  ...
  anon80_Else:
    assume Mem_T.PVOID[Key_6] == SLAM_guard_O_0;
    assume SLAM_guard_O_0 != SLAM_guard_O_0_init;
    call {:si_unique_call 900} SLIC_ZwCreateKey_exit(strConst__li2bpl4, Status_14);
    goto anon84_Then, anon84_Else;
  ...
  anon63_Else:
    ...
    call {:si_unique_call 868} vslice_dummy_var_466 := corral_nondet();
    Success_7 := 0;
    goto L62;

  L62:
    Tmp_470 := strConst__li2bpl90;
    call {:si_unique_call 869} RtlInitUnicodeString(Name_7, Tmp_470);
    goto anon64_Then, anon64_Else;

  anon64_Else:
    assume Mem_T.PVOID[g_RootKey] == SLAM_guard_O_0;
    assume SLAM_guard_O_0 != SLAM_guard_O_0_init;
    call {:si_unique_call 870} SLIC_ZwSetValueKey_entry(strConst__li2bpl4);
    goto anon85_Then, anon85_Else;
  ...
  L184:
    call {:si_unique_call 871} Status_14 := ZwSetValueKey(0, 0, 0, 4, 0, 4);
    goto anon65_Then, anon65_Else;
  ...
  L77:
    ...
    call {:si_unique_call 873} RtlInitUnicodeString(Name_7, Tmp_450);
    goto anon66_Then, anon66_Else;

  anon66_Else:
    assume Mem_T.PVOID[g_RootKey] == SLAM_guard_O_0;
    assume SLAM_guard_O_0 != SLAM_guard_O_0_init;
    call {:si_unique_call 874} SLIC_ZwSetValueKey_entry(strConst__li2bpl4);
    goto anon86_Then, anon86_Else;
  ...
  L187:
    call {:si_unique_call 875} Status_14 := ZwSetValueKey(0, 0, 0, 4, 0, 4);
    goto anon67_Then, anon67_Else;

  anon67_Else:
    assume {:partition} Status_14 != -1073741790;
    call {:si_unique_call 876} vslice_dummy_var_467 := corral_nondet();
    Success_7 := 0;
    goto L85;
  ...
  L85:
    ...
    call {:si_unique_call 877} Status_14 := CmUnRegisterCallback(vslice_dummy_var_161);
    goto anon68_Then, anon68_Else;
  ...
  L97:
    ...
    call {:si_unique_call 879} RtlInitUnicodeString(Name_7, Tmp_449);
    call {:si_unique_call 880} sdv_InitializeObjectAttributes(0, 0, 576, 0, 0);
    call {:si_unique_call 881} Status_14 := ZwOpenKey(Key_6, 983103, 0);
    assume {:nonnull} Key_6 != 0;
    assume Key_6 > 0;
    goto anon81_Then, anon81_Else;
  ...
  anon81_Else:
    assume Mem_T.PVOID[Key_6] == SLAM_guard_O_0;
    assume SLAM_guard_O_0 != SLAM_guard_O_0_init;
    call {:si_unique_call 901} SLIC_ZwOpenKey_exit(0, Status_14);
    goto L107;
  ...
  anon69_Else:
    ...
    call {:si_unique_call 882} vslice_dummy_var_468 := corral_nondet();
    Success_7 := 0;
    goto L108;

  L108:
    Tmp_466 := strConst__li2bpl21;
    call {:si_unique_call 883} RtlInitUnicodeString(Name_7, Tmp_466);
    call {:si_unique_call 884} Status_14 := ZwDeleteValueKey(0, 0);
    goto anon70_Then, anon70_Else;

  anon70_Else:
    assume {:partition} Status_14 != -1073741772;
    call {:si_unique_call 885} vslice_dummy_var_469 := corral_nondet();
    Success_7 := 0;
    goto L120;
  ...
  anon68_Then:
    ...
    call {:si_unique_call 878} vslice_dummy_var_472 := corral_nondet();
    Success_7 := 0;
    goto L97;
  ...
  anon65_Then:
    assume {:partition} 0 > Status_14;
    call {:si_unique_call 872} vslice_dummy_var_473 := corral_nondet();
    Success_7 := 0;
    goto L77;
  ...
  anon62_Then:
    assume {:partition} 0 > Status_14;
    call {:si_unique_call 864} vslice_dummy_var_474 := corral_nondet();
    Success_7 := 0;
    goto L51;
  ...
  anon61_Then:
    assume {:partition} 0 > Status_14;
    call {:si_unique_call 860} vslice_dummy_var_475 := corral_nondet();
    goto L120;
}
...
implementation {:origName "_sdv_init5"} _sdv_init5()
{
  ...
  anon0:
    call {:si_unique_call 904} vslice_dummy_var_476 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "PostNotificationOverrideErrorSample"} PostNotificationOverrideErrorSample() returns (Tmp_481: int)
{
  ...
  anon0:
    call {:si_unique_call 905} Key_7 := __HAVOC_malloc(4);
    call {:si_unique_call 906} vslice_dummy_var_477 := __HAVOC_malloc(24);
    call {:si_unique_call 907} ModifiedKey := __HAVOC_malloc(4);
    call {:si_unique_call 908} Name_8 := __HAVOC_malloc(12);
    call {:si_unique_call 909} vslice_dummy_var_482 := __HAVOC_malloc(216);
    call {:si_unique_call 910} vslice_dummy_var_483 := __HAVOC_malloc(200);
    call {:si_unique_call 911} vslice_dummy_var_484 := __HAVOC_malloc(24);
    call {:si_unique_call 912} vslice_dummy_var_485 := __HAVOC_malloc(32);
    call {:si_unique_call 913} vslice_dummy_var_486 := __HAVOC_malloc(212);
    call {:si_unique_call 914} vslice_dummy_var_487 := __HAVOC_malloc(32);
    call {:si_unique_call 915} vslice_dummy_var_488 := __HAVOC_malloc(32);
    call {:si_unique_call 916} vslice_dummy_var_489 := __HAVOC_malloc(32);
    call {:si_unique_call 917} Tmp_490 := __HAVOC_malloc(48);
    call {:si_unique_call 918} vslice_dummy_var_490 := __HAVOC_malloc(32);
    call {:si_unique_call 919} vslice_dummy_var_491 := __HAVOC_malloc(192);
    call {:si_unique_call 920} vslice_dummy_var_492 := __HAVOC_malloc(228);
    call {:si_unique_call 921} vslice_dummy_var_493 := __HAVOC_malloc(208);
    call {:si_unique_call 922} Tmp_496 := __HAVOC_malloc(28);
    call {:si_unique_call 923} vslice_dummy_var_494 := __HAVOC_malloc(32);
    call {:si_unique_call 924} vslice_dummy_var_495 := __HAVOC_malloc(204);
    call {:si_unique_call 925} vslice_dummy_var_496 := __HAVOC_malloc(224);
    call {:si_unique_call 926} vslice_dummy_var_497 := __HAVOC_malloc(32);
    call {:si_unique_call 927} vslice_dummy_var_498 := __HAVOC_malloc(32);
    call {:si_unique_call 928} vslice_dummy_var_499 := __HAVOC_malloc(32);
    call {:si_unique_call 929} Tmp_503 := __HAVOC_malloc(80);
    CallbackCtx_8 := 0;
    Success_8 := 0;
    ...
    call {:si_unique_call 930} vslice_dummy_var_500 := corral_nondet();
    call {:si_unique_call 931} vslice_dummy_var_501 := corral_nondet();
    Tmp_496 := strConst__li2bpl20;
    call {:si_unique_call 932} sdv_369 := CreateCallbackContext(2, Tmp_496);
  ...
  anon49_Else:
    ...
    assume SLAM_guard_O_0 != SLAM_guard_O_0_init;
    call {:si_unique_call 942} SLIC_ZwDeleteKey_entry(strConst__li2bpl4);
    goto anon63_Then, anon63_Else;
  ...
  L123:
    call {:si_unique_call 943} vslice_dummy_var_478 := ZwDeleteKey(0);
    assume {:nonnull} Key_7 != 0;
    assume Key_7 > 0;
    goto anon50_Then, anon50_Else;
  ...
  anon50_Else:
    assume Mem_T.PVOID[Key_7] == SLAM_guard_O_0;
    assume SLAM_guard_O_0 != SLAM_guard_O_0_init;
    call {:si_unique_call 944} SLIC_ZwClose_entry(strConst__li2bpl4);
    goto anon64_Then, anon64_Else;
  ...
  L126:
    call {:si_unique_call 958} vslice_dummy_var_479 := ZwClose(0);
    goto L59;
  ...
  anon52_Else:
    ...
    assume SLAM_guard_O_0 != SLAM_guard_O_0_init;
    call {:si_unique_call 946} SLIC_ZwDeleteKey_entry(strConst__li2bpl4);
    goto anon65_Then, anon65_Else;
  ...
  L129:
    call {:si_unique_call 947} vslice_dummy_var_480 := ZwDeleteKey(0);
    assume {:nonnull} ModifiedKey != 0;
    assume ModifiedKey > 0;
    goto anon53_Then, anon53_Else;
  ...
  anon53_Else:
    assume Mem_T.PVOID[ModifiedKey] == SLAM_guard_O_0;
    assume SLAM_guard_O_0 != SLAM_guard_O_0_init;
    call {:si_unique_call 948} SLIC_ZwClose_entry(strConst__li2bpl4);
    goto anon66_Then, anon66_Else;
  ...
  L132:
    call {:si_unique_call 959} vslice_dummy_var_481 := ZwClose(0);
    goto L66;
  ...
  anon51_Else:
    assume {:partition} CallbackCtx_8 != 0;
    call {:si_unique_call 945} ExFreePoolWithTag(0, 812934738);
    goto L73;
  ...
  anon54_Else:
    ...
    call {:si_unique_call 950} vslice_dummy_var_503 := corral_nondet();
    goto L83;
  ...
  anon54_Then:
    assume {:partition} Success_8 == 0;
    call {:si_unique_call 949} vslice_dummy_var_504 := corral_nondet();
    goto L83;
  ...
  anon61_Then:
    ...
    call {:si_unique_call 933} RtlInitUnicodeString(Name_8, Tmp_503);
    call {:si_unique_call 934} sdv_InitializeObjectAttributes(0, 0, 576, 0, 0);
    call {:si_unique_call 935} Status_15 := ZwCreateKey(ModifiedKey, 983103, 0, 0, 0, 0, 0);
    assume {:nonnull} ModifiedKey != 0;
    assume ModifiedKey > 0;
    goto anon58_Then, anon58_Else;
  ...
  anon58_Else:
    assume Mem_T.PVOID[ModifiedKey] == SLAM_guard_O_0;
    assume SLAM_guard_O_0 != SLAM_guard_O_0_init;
    call {:si_unique_call 956} SLIC_ZwCreateKey_exit(strConst__li2bpl4, Status_15);
    goto anon62_Then, anon62_Else;
  ...
  anon45_Else:
    ...
    call {:si_unique_call 937} RtlInitUnicodeString(Name_8, Tmp_490);
    call {:si_unique_call 938} sdv_InitializeObjectAttributes(0, 0, 576, 0, 0);
    call {:si_unique_call 939} Status_15 := ZwOpenKey(Key_7, 983103, 0);
    assume {:nonnull} Key_7 != 0;
    assume Key_7 > 0;
    goto anon59_Then, anon59_Else;
  ...
  anon59_Else:
    assume Mem_T.PVOID[Key_7] == SLAM_guard_O_0;
    assume SLAM_guard_O_0 != SLAM_guard_O_0_init;
    call {:si_unique_call 957} SLIC_ZwOpenKey_exit(0, Status_15);
    goto L50;
  ...
  anon46_Else:
    ...
    call {:si_unique_call 941} vslice_dummy_var_502 := corral_nondet();
    goto L58;

  anon46_Then:
    assume {:partition} Status_15 == -1073741772;
    havoc vslice_dummy_var_162;
    call {:si_unique_call 940} Status_15 := CmRegisterCallbackEx(li2bplFunctionConstant345, 0, vslice_dummy_var_162, 0, 0, 0);
    goto anon55_Then, anon55_Else;

  anon55_Else:
    assume {:partition} Status_15 >= 0;
    Success_8 := 1;
    call {:si_unique_call 952} Status_15 := ZwOpenKey(Key_7, 983103, 0);
    assume {:nonnull} Key_7 != 0;
    assume Key_7 > 0;
    goto anon60_Then, anon60_Else;
  ...
  anon60_Else:
    assume Mem_T.PVOID[Key_7] == SLAM_guard_O_0;
    assume SLAM_guard_O_0 != SLAM_guard_O_0_init;
    call {:si_unique_call 960} SLIC_ZwOpenKey_exit(0, Status_15);
    goto L94;
  ...
  L98:
    ...
    call {:si_unique_call 954} Status_15 := CmUnRegisterCallback(vslice_dummy_var_163);
    goto anon57_Then, anon57_Else;

  anon57_Else:
    assume {:partition} Status_15 < 0;
    call {:si_unique_call 955} vslice_dummy_var_505 := corral_nondet();
    Success_8 := 0;
    goto L58;
  ...
  anon56_Then:
    assume {:partition} 0 > Status_15;
    call {:si_unique_call 953} vslice_dummy_var_506 := corral_nondet();
    Success_8 := 0;
    goto L98;
  ...
  anon55_Then:
    assume {:partition} 0 > Status_15;
    call {:si_unique_call 951} vslice_dummy_var_507 := corral_nondet();
    goto L58;
  ...
  anon45_Then:
    assume {:partition} 0 > Status_15;
    call {:si_unique_call 936} vslice_dummy_var_508 := corral_nondet();
    goto L58;
...
implementation {:origName "PreNotificationBypassSample"} PreNotificationBypassSample() returns (Tmp_504: int)
{
  ...
  anon0:
    call {:si_unique_call 961} Key_8 := __HAVOC_malloc(4);
    call {:si_unique_call 962} vslice_dummy_var_509 := __HAVOC_malloc(24);
    call {:si_unique_call 963} Name_9 := __HAVOC_malloc(12);
    call {:si_unique_call 964} vslice_dummy_var_515 := __HAVOC_malloc(192);
    call {:si_unique_call 965} vslice_dummy_var_516 := __HAVOC_malloc(308);
    call {:si_unique_call 966} vslice_dummy_var_517 := __HAVOC_malloc(32);
    call {:si_unique_call 967} vslice_dummy_var_518 := __HAVOC_malloc(244);
    call {:si_unique_call 968} vslice_dummy_var_519 := __HAVOC_malloc(32);
    call {:si_unique_call 969} vslice_dummy_var_520 := __HAVOC_malloc(32);
    call {:si_unique_call 970} vslice_dummy_var_521 := __HAVOC_malloc(180);
    call {:si_unique_call 971} vslice_dummy_var_522 := __HAVOC_malloc(32);
    call {:si_unique_call 972} vslice_dummy_var_523 := __HAVOC_malloc(160);
    call {:si_unique_call 973} vslice_dummy_var_524 := __HAVOC_malloc(24);
    call {:si_unique_call 974} Tmp_515 := __HAVOC_malloc(88);
    call {:si_unique_call 975} Tmp_516 := __HAVOC_malloc(80);
    call {:si_unique_call 976} vslice_dummy_var_525 := __HAVOC_malloc(32);
    call {:si_unique_call 977} vslice_dummy_var_526 := __HAVOC_malloc(260);
    call {:si_unique_call 978} vslice_dummy_var_527 := __HAVOC_malloc(164);
    call {:si_unique_call 979} Tmp_520 := __HAVOC_malloc(56);
    call {:si_unique_call 980} vslice_dummy_var_528 := __HAVOC_malloc(32);
    call {:si_unique_call 981} vslice_dummy_var_529 := __HAVOC_malloc(32);
    call {:si_unique_call 982} vslice_dummy_var_530 := __HAVOC_malloc(188);
    call {:si_unique_call 983} vslice_dummy_var_531 := __HAVOC_malloc(200);
    call {:si_unique_call 984} Tmp_525 := __HAVOC_malloc(56);
    call {:si_unique_call 985} vslice_dummy_var_532 := __HAVOC_malloc(192);
    call {:si_unique_call 986} Tmp_527 := __HAVOC_malloc(48);
    call {:si_unique_call 987} vslice_dummy_var_533 := __HAVOC_malloc(32);
    call {:si_unique_call 988} vslice_dummy_var_534 := __HAVOC_malloc(32);
    call {:si_unique_call 989} vslice_dummy_var_535 := __HAVOC_malloc(32);
    call {:si_unique_call 990} Tmp_531 := __HAVOC_malloc(48);
    call {:si_unique_call 991} vslice_dummy_var_536 := __HAVOC_malloc(32);
    call {:si_unique_call 992} vslice_dummy_var_537 := __HAVOC_malloc(32);
    call {:si_unique_call 993} vslice_dummy_var_538 := __HAVOC_malloc(236);
    call {:si_unique_call 994} Tmp_536 := __HAVOC_malloc(28);
    CallbackCtx_9 := 0;
    assume {:nonnull} Key_8 != 0;
    assume Key_8 > 0;
    Mem_T.PVOID[Key_8] := 0;
    Success_9 := 0;
    call {:si_unique_call 995} vslice_dummy_var_539 := corral_nondet();
    call {:si_unique_call 996} vslice_dummy_var_540 := corral_nondet();
    Tmp_536 := strConst__li2bpl20;
    call {:si_unique_call 997} sdv_392 := CreateCallbackContext(1, Tmp_536);
  ...
  anon77_Else:
    ...
    assume SLAM_guard_O_0 != SLAM_guard_O_0_init;
    call {:si_unique_call 1030} SLIC_ZwDeleteKey_entry(strConst__li2bpl4);
    goto anon89_Then, anon89_Else;
  ...
  L191:
    call {:si_unique_call 1031} vslice_dummy_var_513 := ZwDeleteKey(0);
    assume {:nonnull} Key_8 != 0;
    assume Key_8 > 0;
    goto anon78_Then, anon78_Else;
  ...
  anon78_Else:
    assume Mem_T.PVOID[Key_8] == SLAM_guard_O_0;
    assume SLAM_guard_O_0 != SLAM_guard_O_0_init;
    call {:si_unique_call 1032} SLIC_ZwClose_entry(strConst__li2bpl4);
    goto anon90_Then, anon90_Else;
  ...
  L194:
    call {:si_unique_call 1039} vslice_dummy_var_514 := ZwClose(0);
    goto L133;
  ...
  anon76_Else:
    assume {:partition} CallbackCtx_9 != 0;
    call {:si_unique_call 1029} ExFreePoolWithTag(0, 812934738);
    goto L140;
  ...
  anon79_Else:
    ...
    call {:si_unique_call 1034} vslice_dummy_var_543 := corral_nondet();
    goto L150;
  ...
  anon79_Then:
    assume {:partition} Success_9 == 0;
    call {:si_unique_call 1033} vslice_dummy_var_544 := corral_nondet();
    goto L150;
  ...
  anon83_Then:
    ...
    call {:si_unique_call 998} Status_16 := CmRegisterCallbackEx(li2bplFunctionConstant345, 0, vslice_dummy_var_164, 0, 0, 0);
    goto anon61_Then, anon61_Else;
  ...
  anon61_Else:
    ...
    call {:si_unique_call 1000} RtlInitUnicodeString(Name_9, Tmp_527);
    call {:si_unique_call 1001} sdv_InitializeObjectAttributes(0, 0, 576, 0, 0);
    call {:si_unique_call 1002} Status_16 := ZwCreateKey(Key_8, 983103, 0, 0, 0, 0, 0);
    assume {:nonnull} Key_8 != 0;
    assume Key_8 > 0;
    goto anon80_Then, anon80_Else;
  ...
  anon80_Else:
    assume Mem_T.PVOID[Key_8] == SLAM_guard_O_0;
    assume SLAM_guard_O_0 != SLAM_guard_O_0_init;
    call {:si_unique_call 1035} SLIC_ZwCreateKey_exit(strConst__li2bpl4, Status_16);
    goto anon84_Then, anon84_Else;
  ...
  L49:
    ...
    call {:si_unique_call 1004} RtlInitUnicodeString(Name_9, Tmp_520);
    goto anon63_Then, anon63_Else;

  anon63_Else:
    assume Mem_T.PVOID[g_RootKey] == SLAM_guard_O_0;
    assume SLAM_guard_O_0 != SLAM_guard_O_0_init;
    call {:si_unique_call 1005} SLIC_ZwSetValueKey_entry(strConst__li2bpl4);
    goto anon85_Then, anon85_Else;
  ...
  L173:
    call {:si_unique_call 1006} Status_16 := ZwSetValueKey(0, 0, 0, 4, 0, 4);
    goto anon64_Then, anon64_Else;
  ...
  L60:
    ...
    call {:si_unique_call 1008} Status_16 := CmUnRegisterCallback(vslice_dummy_var_165);
    goto anon65_Then, anon65_Else;
  ...
  anon67_Else:
    assume Mem_T.PVOID[Key_8] == SLAM_guard_O_0;
    assume SLAM_guard_O_0 != SLAM_guard_O_0_init;
    call {:si_unique_call 1013} SLIC_ZwClose_entry(strConst__li2bpl4);
    goto anon86_Then, anon86_Else;
  ...
  L176:
    call {:si_unique_call 1036} vslice_dummy_var_510 := ZwClose(0);
    goto L69;

  L69:
    Tmp_531 := strConst__li2bpl10;
    call {:si_unique_call 1010} RtlInitUnicodeString(Name_9, Tmp_531);
    call {:si_unique_call 1011} sdv_InitializeObjectAttributes(0, 0, 576, 0, 0);
    call {:si_unique_call 1012} Status_16 := ZwOpenKey(Key_8, 983103, 0);
    assume {:nonnull} Key_8 != 0;
    assume Key_8 > 0;
    goto anon81_Then, anon81_Else;
  ...
  anon81_Else:
    assume Mem_T.PVOID[Key_8] == SLAM_guard_O_0;
    assume SLAM_guard_O_0 != SLAM_guard_O_0_init;
    call {:si_unique_call 1037} SLIC_ZwOpenKey_exit(0, Status_16);
    goto L82;
  ...
  anon68_Else:
    ...
    call {:si_unique_call 1014} vslice_dummy_var_541 := corral_nondet();
    assume {:nonnull} Key_8 != 0;
    assume Key_8 > 0;
    goto anon69_Then, anon69_Else;
  ...
  anon70_Else:
    assume Mem_T.PVOID[Key_8] == SLAM_guard_O_0;
    assume SLAM_guard_O_0 != SLAM_guard_O_0_init;
    call {:si_unique_call 1018} SLIC_ZwDeleteKey_entry(strConst__li2bpl4);
    goto anon87_Then, anon87_Else;
  ...
  L182:
    call {:si_unique_call 1019} vslice_dummy_var_511 := ZwDeleteKey(0);
    assume {:nonnull} Key_8 != 0;
    assume Key_8 > 0;
    goto anon71_Then, anon71_Else;
  ...
  anon71_Else:
    assume Mem_T.PVOID[Key_8] == SLAM_guard_O_0;
    assume SLAM_guard_O_0 != SLAM_guard_O_0_init;
    call {:si_unique_call 1020} SLIC_ZwClose_entry(strConst__li2bpl4);
    goto anon88_Then, anon88_Else;
  ...
  L185:
    call {:si_unique_call 1021} vslice_dummy_var_512 := ZwClose(0);
    assume {:nonnull} Key_8 != 0;
    assume Key_8 > 0;
    Mem_T.PVOID[Key_8] := 0;
    goto L90;
  ...
  L83:
    ...
    call {:si_unique_call 1015} RtlInitUnicodeString(Name_9, Tmp_516);
    call {:si_unique_call 1016} sdv_InitializeObjectAttributes(0, 0, 576, 0, 0);
    call {:si_unique_call 1017} Status_16 := ZwOpenKey(Key_8, 983103, 0);
    assume {:nonnull} Key_8 != 0;
    assume Key_8 > 0;
    goto anon82_Then, anon82_Else;
  ...
  anon82_Else:
    assume Mem_T.PVOID[Key_8] == SLAM_guard_O_0;
    assume SLAM_guard_O_0 != SLAM_guard_O_0_init;
    call {:si_unique_call 1038} SLIC_ZwOpenKey_exit(0, Status_16);
    goto L105;
  ...
  L109:
    ...
    call {:si_unique_call 1023} RtlInitUnicodeString(Name_9, Tmp_525);
    call {:si_unique_call 1024} Status_16 := ZwDeleteValueKey(0, 0);
    goto anon73_Then, anon73_Else;

  anon73_Else:
    assume {:partition} Status_16 != -1073741772;
    call {:si_unique_call 1025} vslice_dummy_var_542 := corral_nondet();
    Success_9 := 0;
    goto L117;

  L117:
    Tmp_515 := strConst__li2bpl104;
    call {:si_unique_call 1026} RtlInitUnicodeString(Name_9, Tmp_515);
    call {:si_unique_call 1027} Status_16 := ZwDeleteValueKey(0, 0);
    goto anon74_Then, anon74_Else;
  ...
  anon74_Then:
    ...
    call {:si_unique_call 1028} vslice_dummy_var_545 := corral_nondet();
    Success_9 := 0;
    goto L132;
  ...
  anon72_Then:
    assume {:partition} 0 > Status_16;
    call {:si_unique_call 1022} vslice_dummy_var_546 := corral_nondet();
    Success_9 := 0;
    goto L109;
  ...
  anon65_Then:
    assume {:partition} 0 > Status_16;
    call {:si_unique_call 1009} vslice_dummy_var_547 := corral_nondet();
    Success_9 := 0;
    goto L68;

  anon64_Then:
    assume {:partition} 0 > Status_16;
    call {:si_unique_call 1007} vslice_dummy_var_548 := corral_nondet();
    Success_9 := 0;
    goto L60;
  ...
  anon62_Then:
    assume {:partition} 0 > Status_16;
    call {:si_unique_call 1003} vslice_dummy_var_549 := corral_nondet();
    Success_9 := 0;
    goto L49;
  ...
  anon61_Then:
    assume {:partition} 0 > Status_16;
    call {:si_unique_call 999} vslice_dummy_var_550 := corral_nondet();
    goto L132;
}
...
implementation {:origName "PreNotificationBlockSample"} PreNotificationBlockSample() returns (Tmp_537: int)
{
  ...
  anon0:
    call {:si_unique_call 1040} Key_9 := __HAVOC_malloc(4);
    call {:si_unique_call 1041} vslice_dummy_var_551 := __HAVOC_malloc(24);
    call {:si_unique_call 1042} NotModifiedKey_1 := __HAVOC_malloc(4);
    call {:si_unique_call 1043} Name_10 := __HAVOC_malloc(12);
    call {:si_unique_call 1044} Tmp_538 := __HAVOC_malloc(56);
    call {:si_unique_call 1045} Tmp_539 := __HAVOC_malloc(92);
    call {:si_unique_call 1046} vslice_dummy_var_558 := __HAVOC_malloc(212);
    call {:si_unique_call 1047} vslice_dummy_var_559 := __HAVOC_malloc(32);
    call {:si_unique_call 1048} Tmp_542 := __HAVOC_malloc(104);
    call {:si_unique_call 1049} Tmp_543 := __HAVOC_malloc(56);
    call {:si_unique_call 1050} vslice_dummy_var_560 := __HAVOC_malloc(32);
    call {:si_unique_call 1051} Tmp_545 := __HAVOC_malloc(48);
    call {:si_unique_call 1052} vslice_dummy_var_561 := __HAVOC_malloc(188);
    call {:si_unique_call 1053} vslice_dummy_var_562 := __HAVOC_malloc(32);
    call {:si_unique_call 1054} vslice_dummy_var_563 := __HAVOC_malloc(200);
    call {:si_unique_call 1055} vslice_dummy_var_564 := __HAVOC_malloc(32);
    call {:si_unique_call 1056} vslice_dummy_var_565 := __HAVOC_malloc(32);
    call {:si_unique_call 1057} vslice_dummy_var_566 := __HAVOC_malloc(200);
    call {:si_unique_call 1058} vslice_dummy_var_567 := __HAVOC_malloc(32);
    call {:si_unique_call 1059} vslice_dummy_var_568 := __HAVOC_malloc(184);
    call {:si_unique_call 1060} vslice_dummy_var_569 := __HAVOC_malloc(212);
    call {:si_unique_call 1061} vslice_dummy_var_570 := __HAVOC_malloc(32);
    call {:si_unique_call 1062} vslice_dummy_var_571 := __HAVOC_malloc(192);
    call {:si_unique_call 1063} Tmp_558 := __HAVOC_malloc(104);
    call {:si_unique_call 1064} vslice_dummy_var_572 := __HAVOC_malloc(24);
    call {:si_unique_call 1065} vslice_dummy_var_573 := __HAVOC_malloc(32);
    call {:si_unique_call 1066} vslice_dummy_var_574 := __HAVOC_malloc(200);
    call {:si_unique_call 1067} vslice_dummy_var_575 := __HAVOC_malloc(32);
    call {:si_unique_call 1068} vslice_dummy_var_576 := __HAVOC_malloc(176);
    call {:si_unique_call 1069} Tmp_564 := __HAVOC_malloc(28);
    call {:si_unique_call 1070} vslice_dummy_var_577 := __HAVOC_malloc(32);
    CallbackCtx_10 := 0;
    ...
    Success_10 := 0;
    call {:si_unique_call 1071} vslice_dummy_var_578 := corral_nondet();
    call {:si_unique_call 1072} vslice_dummy_var_579 := corral_nondet();
    Tmp_564 := strConst__li2bpl20;
    call {:si_unique_call 1073} sdv_417 := CreateCallbackContext(0, Tmp_564);
  ...
  anon65_Else:
    ...
    assume SLAM_guard_O_0 != SLAM_guard_O_0_init;
    call {:si_unique_call 1094} SLIC_ZwDeleteKey_entry(strConst__li2bpl4);
    goto anon78_Then, anon78_Else;
  ...
  L161:
    call {:si_unique_call 1095} vslice_dummy_var_554 := ZwDeleteKey(0);
    assume {:nonnull} Key_9 != 0;
    assume Key_9 > 0;
    goto anon66_Then, anon66_Else;
  ...
  anon66_Else:
    assume Mem_T.PVOID[Key_9] == SLAM_guard_O_0;
    assume SLAM_guard_O_0 != SLAM_guard_O_0_init;
    call {:si_unique_call 1096} SLIC_ZwClose_entry(strConst__li2bpl4);
    goto anon79_Then, anon79_Else;
  ...
  L164:
    call {:si_unique_call 1109} vslice_dummy_var_555 := ZwClose(0);
    goto L100;
  ...
  anon67_Else:
    ...
    assume SLAM_guard_O_0 != SLAM_guard_O_0_init;
    call {:si_unique_call 1101} SLIC_ZwDeleteKey_entry(strConst__li2bpl4);
    goto anon80_Then, anon80_Else;
  ...
  L167:
    call {:si_unique_call 1102} vslice_dummy_var_556 := ZwDeleteKey(0);
    assume {:nonnull} NotModifiedKey_1 != 0;
    assume NotModifiedKey_1 > 0;
    goto anon68_Then, anon68_Else;
  ...
  anon68_Else:
    assume Mem_T.PVOID[NotModifiedKey_1] == SLAM_guard_O_0;
    assume SLAM_guard_O_0 != SLAM_guard_O_0_init;
    call {:si_unique_call 1103} SLIC_ZwClose_entry(strConst__li2bpl4);
    goto anon81_Then, anon81_Else;
  ...
  L170:
    call {:si_unique_call 1110} vslice_dummy_var_557 := ZwClose(0);
    goto L107;

  L107:
    Tmp_543 := strConst__li2bpl21;
    call {:si_unique_call 1097} RtlInitUnicodeString(Name_10, Tmp_543);
    call {:si_unique_call 1098} vslice_dummy_var_552 := ZwDeleteValueKey(0, 0);
    Tmp_542 := strConst__li2bpl90;
    call {:si_unique_call 1099} RtlInitUnicodeString(Name_10, Tmp_542);
    call {:si_unique_call 1100} vslice_dummy_var_553 := ZwDeleteValueKey(0, 0);
    goto anon69_Then, anon69_Else;

  anon69_Else:
    assume {:partition} CallbackCtx_10 != 0;
    call {:si_unique_call 1104} ExFreePoolWithTag(0, 812934738);
    goto L126;
  ...
  anon70_Else:
    ...
    call {:si_unique_call 1106} vslice_dummy_var_584 := corral_nondet();
    goto L136;
  ...
  anon70_Then:
    assume {:partition} Success_10 == 0;
    call {:si_unique_call 1105} vslice_dummy_var_585 := corral_nondet();
    goto L136;
  ...
  anon73_Then:
    ...
    call {:si_unique_call 1074} Status_17 := CmRegisterCallbackEx(li2bplFunctionConstant345, 0, vslice_dummy_var_166, 0, 0, 0);
    goto anon55_Then, anon55_Else;
  ...
  anon55_Else:
    ...
    call {:si_unique_call 1076} RtlInitUnicodeString(Name_10, Tmp_539);
    call {:si_unique_call 1077} sdv_InitializeObjectAttributes(0, 0, 576, 0, 0);
    call {:si_unique_call 1078} Status_17 := ZwCreateKey(NotModifiedKey_1, 983103, 0, 0, 0, 0, 0);
    assume {:nonnull} NotModifiedKey_1 != 0;
    assume NotModifiedKey_1 > 0;
    goto anon71_Then, anon71_Else;
  ...
  anon71_Else:
    assume Mem_T.PVOID[NotModifiedKey_1] == SLAM_guard_O_0;
    assume SLAM_guard_O_0 != SLAM_guard_O_0_init;
    call {:si_unique_call 1107} SLIC_ZwCreateKey_exit(strConst__li2bpl4, Status_17);
    goto anon74_Then, anon74_Else;
  ...
  anon56_Else:
    assume {:partition} Status_17 != 0;
    call {:si_unique_call 1079} vslice_dummy_var_580 := corral_nondet();
    Success_10 := 0;
    goto L48;

  L48:
    Tmp_545 := strConst__li2bpl10;
    call {:si_unique_call 1080} RtlInitUnicodeString(Name_10, Tmp_545);
    call {:si_unique_call 1081} sdv_InitializeObjectAttributes(0, 0, 576, 0, 0);
    call {:si_unique_call 1082} Status_17 := ZwCreateKey(Key_9, 983103, 0, 0, 0, 0, 0);
    assume {:nonnull} Key_9 != 0;
    assume Key_9 > 0;
    goto anon72_Then, anon72_Else;
  ...
  anon72_Else:
    assume Mem_T.PVOID[Key_9] == SLAM_guard_O_0;
    assume SLAM_guard_O_0 != SLAM_guard_O_0_init;
    call {:si_unique_call 1108} SLIC_ZwCreateKey_exit(strConst__li2bpl4, Status_17);
    goto anon75_Then, anon75_Else;
  ...
  anon57_Else:
    ...
    call {:si_unique_call 1083} vslice_dummy_var_581 := corral_nondet();
    Success_10 := 0;
    goto L63;

  L63:
    Tmp_558 := strConst__li2bpl90;
    call {:si_unique_call 1084} RtlInitUnicodeString(Name_10, Tmp_558);
    goto anon58_Then, anon58_Else;

  anon58_Else:
    assume Mem_T.PVOID[g_RootKey] == SLAM_guard_O_0;
    assume SLAM_guard_O_0 != SLAM_guard_O_0_init;
    call {:si_unique_call 1085} SLIC_ZwSetValueKey_entry(strConst__li2bpl4);
    goto anon76_Then, anon76_Else;
  ...
  L155:
    call {:si_unique_call 1086} Status_17 := ZwSetValueKey(0, 0, 0, 4, 0, 4);
    goto anon59_Then, anon59_Else;

  anon59_Else:
    assume {:partition} Status_17 != 0;
    call {:si_unique_call 1087} vslice_dummy_var_582 := corral_nondet();
    Success_10 := 0;
    goto L75;

  L75:
    Tmp_538 := strConst__li2bpl21;
    call {:si_unique_call 1088} RtlInitUnicodeString(Name_10, Tmp_538);
    goto anon60_Then, anon60_Else;

  anon60_Else:
    assume Mem_T.PVOID[g_RootKey] == SLAM_guard_O_0;
    assume SLAM_guard_O_0 != SLAM_guard_O_0_init;
    call {:si_unique_call 1089} SLIC_ZwSetValueKey_entry(strConst__li2bpl4);
    goto anon77_Then, anon77_Else;
  ...
  L158:
    call {:si_unique_call 1090} Status_17 := ZwSetValueKey(0, 0, 0, 4, 0, 4);
    goto anon61_Then, anon61_Else;

  anon61_Else:
    assume {:partition} Status_17 != -1073741790;
    call {:si_unique_call 1091} vslice_dummy_var_583 := corral_nondet();
    Success_10 := 0;
    goto L87;
  ...
  L87:
    ...
    call {:si_unique_call 1092} Status_17 := CmUnRegisterCallback(vslice_dummy_var_167);
    goto anon62_Then, anon62_Else;
  ...
  anon62_Then:
    ...
    call {:si_unique_call 1093} vslice_dummy_var_586 := corral_nondet();
    Success_10 := 0;
    goto L99;
...
implementation {:origName "_sdv_init4"} _sdv_init4()
{
  ...
  anon0:
    call {:si_unique_call 1111} vslice_dummy_var_588 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "RtlStringVPrintfWorkerW_sdv_static_function_1"} RtlStringVPrintfWorkerW_sdv_static_function_1(actual_pszDest: int, actual_cchDest: int, actual_pcchNewDestLength: int, actual_pszFormat: int, actual_argList: int) returns (Tmp_568: int)
{
  ...
  anon0:
    ...
    cchNewDestLength := 0;
    cchMax := cchDest - 1;
    call {:si_unique_call 1112} iRet := corral_nondet();
    goto anon9_Then, anon9_Else;
...
implementation {:origName "DeviceControl"} DeviceControl(actual_DeviceObject_6: int, actual_Irp_4: int) returns (Tmp_570: int)
{
  ...
  anon0:
    ...
    Irp_4 := actual_Irp_4;
    call {:si_unique_call 1113} vslice_dummy_var_589 := __HAVOC_malloc(152);
    call {:si_unique_call 1114} vslice_dummy_var_590 := __HAVOC_malloc(32);
    Status_18 := 0;
    call {:si_unique_call 1115} IrpStack_4 := sdv_IoGetCurrentIrpStackLocation(Irp_4);
  ...
  anon13_Else:
    ...
    call {:si_unique_call 1120} Status_18 := GetCallbackVersion(DeviceObject_6, Irp_4);
    goto L30;
  ...
  L30:
    ...
    Tmp_570 := Status_18;
    call {:si_unique_call 1122} SLIC_DeviceControl_exit(strConst__li2bpl113);
    goto anon18_Then, anon18_Else;
  ...
  anon13_Then:
    assume {:partition} Ioctl != 2236428;
    call {:si_unique_call 1116} vslice_dummy_var_591 := corral_nondet();
    goto L30;

  anon14_Then:
    assume {:partition} Ioctl == 2236424;
    call {:si_unique_call 1119} Status_18 := UnRegisterCallback(DeviceObject_6, Irp_4);
    goto L30;

  anon15_Then:
    assume {:partition} Ioctl == 2236420;
    call {:si_unique_call 1118} Status_18 := RegisterCallback(DeviceObject_6, Irp_4);
    goto L30;

  anon16_Then:
    assume {:partition} Ioctl == 2236416;
    call {:si_unique_call 1117} Status_18 := DoCallbackSamples(DeviceObject_6, Irp_4);
    goto anon17_Then, anon17_Else;
...
implementation {:origName "DeviceClose"} DeviceClose(actual_DeviceObject_7: int, actual_Irp_5: int) returns (Tmp_576: int)
{
  ...
  anon0:
    ...
    Tmp_576 := 0;
    call {:si_unique_call 1124} SLIC_DeviceClose_exit(strConst__li2bpl113);
    goto anon3_Then, anon3_Else;
...
implementation {:origName "_sdv_init1"} _sdv_init1()
{
  ...
  anon0:
    call {:si_unique_call 1125} vslice_dummy_var_592 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "DeviceUnload"} DeviceUnload(actual_DriverObject_1: int)
{
  ...
  anon0:
    call {:si_unique_call 1126} vslice_dummy_var_593 := __HAVOC_malloc(4);
    call {:si_unique_call 1127} DosDevicesLinkName := __HAVOC_malloc(12);
    call {:si_unique_call 1128} vslice_dummy_var_595 := __HAVOC_malloc(92);
    call {:si_unique_call 1129} Tmp_583 := __HAVOC_malloc(80);
    call {:si_unique_call 1130} DeleteKTMResourceManager();
    Tmp_583 := strConst__li2bpl114;
    call {:si_unique_call 1131} RtlInitUnicodeString(DosDevicesLinkName, Tmp_583);
    call {:si_unique_call 1132} vslice_dummy_var_594 := IoDeleteSymbolicLink(0);
    call {:si_unique_call 1133} IoDeleteDevice(0);
    call {:si_unique_call 1134} vslice_dummy_var_596 := corral_nondet();
    call {:si_unique_call 1135} SLIC_DeviceUnload_exit(strConst__li2bpl113);
    goto anon3_Then, anon3_Else;
...
implementation {:origName "RtlStringCbPrintfW"} RtlStringCbPrintfW(actual_pszDest_2: int, actual_cbDest: int, actual_pszFormat_1: int) returns (Tmp_584: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 1136} pszFormat_1 := __HAVOC_malloc(4);
    cchDest_2 := INTDIV(cbDest, 2);
    call {:si_unique_call 1137} status_4 := RtlStringValidateDestW_sdv_static_function_1(pszDest_2, cchDest_2, -1);
    goto anon5_Then, anon5_Else;
  ...
  anon5_Else:
    ...
    call {:si_unique_call 1138} status_4 := RtlStringVPrintfWorkerW_sdv_static_function_1(pszDest_2, cchDest_2, 0, vslice_dummy_var_168, argList_1);
    argList_1 := 0;
    goto L19;
...
implementation {:origName "DeviceCreate"} DeviceCreate(actual_DeviceObject_8: int, actual_Irp_6: int) returns (Tmp_586: int)
{
  ...
  anon0:
    ...
    assume {:nonnull} Irp_6 != 0;
    assume Irp_6 > 0;
    call {:si_unique_call 1139} sdv_IoCompleteRequest(0, 0);
    Tmp_586 := 0;
    call {:si_unique_call 1140} SLIC_DeviceCreate_exit(strConst__li2bpl113);
    goto anon3_Then, anon3_Else;
...
implementation {:origName "DriverEntry"} DriverEntry(actual_DriverObject_2: int, actual_RegistryPath: int) returns (Tmp_588: int)
{
  ...
  anon0:
    call {:si_unique_call 1141} DosDevicesLinkName_1 := __HAVOC_malloc(12);
    call {:si_unique_call 1142} NtDeviceName := __HAVOC_malloc(12);
    DriverObject_2 := actual_DriverObject_2;
    call {:si_unique_call 1143} vslice_dummy_var_597 := __HAVOC_malloc(112);
    call {:si_unique_call 1144} Tmp_590 := __HAVOC_malloc(112);
    call {:si_unique_call 1145} Tmp_591 := __HAVOC_malloc(112);
    call {:si_unique_call 1146} Tmp_592 := __HAVOC_malloc(112);
    call {:si_unique_call 1147} Tmp_593 := __HAVOC_malloc(64);
    call {:si_unique_call 1148} Tmp_594 := __HAVOC_malloc(112);
    call {:si_unique_call 1149} Tmp_595 := __HAVOC_malloc(80);
    call {:si_unique_call 1150} vslice_dummy_var_598 := __HAVOC_malloc(96);
    call {:si_unique_call 1151} vslice_dummy_var_599 := __HAVOC_malloc(32);
    call {:si_unique_call 1152} vslice_dummy_var_600 := __HAVOC_malloc(296);
    call {:si_unique_call 1153} vslice_dummy_var_601 := corral_nondet();
    call {:si_unique_call 1154} vslice_dummy_var_602 := corral_nondet();
    Tmp_593 := strConst__li2bpl118;
    call {:si_unique_call 1155} RtlInitUnicodeString(NtDeviceName, Tmp_593);
    call {:si_unique_call 1156} Status_19 := IoCreateDevice(0, 0, 0, 34, 0, 0, g_DeviceObj);
    goto anon9_Then, anon9_Else;
  ...
  anon9_Else:
    ...
    assume {:nonnull} DriverObject_2 != 0;
    assume DriverObject_2 > 0;
    Tmp_595 := strConst__li2bpl114;
    call {:si_unique_call 1158} RtlInitUnicodeString(DosDevicesLinkName_1, Tmp_595);
    call {:si_unique_call 1159} Status_19 := IoCreateSymbolicLink(0, 0);
    goto anon10_Then, anon10_Else;

  anon10_Else:
    assume {:partition} Status_19 >= 0;
    call {:si_unique_call 1161} vslice_dummy_var_603 := corral_nondet();
    call {:si_unique_call 1162} Status_19 := CreateKTMResourceManager(li2bplFunctionConstant309, 0);
    goto anon11_Then, anon11_Else;
  ...
  L1:
    call {:si_unique_call 1157} SLIC_DriverEntry_exit(strConst__li2bpl113);
    goto anon12_Then, anon12_Else;
...
implementation {:origName "DeviceCleanup"} DeviceCleanup(actual_DeviceObject_9: int, actual_Irp_7: int) returns (Tmp_600: int)
{
  ...
  anon0:
    ...
    Tmp_600 := 0;
    call {:si_unique_call 1164} SLIC_DeviceCleanup_exit(strConst__li2bpl113);
    goto anon3_Then, anon3_Else;
...
const {:string "%s"} unique strConst__li2bpl87: int;
...
const {:string "The driver calls ZwCreateKey with a registry key that has been created already."} unique strConst__li2bpl84: int;

const {:string "The driver is returning without closing an open handle."} unique strConst__li2bpl76: int;

const {:string "The driver is trying to close an invalid handle."} unique strConst__li2bpl78: int;
...
const {:string "The driver is trying to delete a registry key with an invalid handle."} unique strConst__li2bpl79: int;

const {:string "The driver is trying to enumerate a registry key by calling ZwEnumerateKey with an invalid handle."} unique strConst__li2bpl85: int;

const {:string "The driver is trying to obtain information about a registry key and its subkeys by calling ZwQueryKey with an invalid handle."} unique strConst__li2bpl80: int;

const {:string "The driver is trying to obtain information about the value entries of a registry key by calling ZwEnumerateValueKey with an invalid handle."} unique strConst__li2bpl83: int;

const {:string "The driver is trying to obtain the the value entries for a registry key by calling ZwQueryValueKey with an invalid handle."} unique strConst__li2bpl82: int;

const {:string "The driver is trying to replace or create a value entry for a registry key by calling ZwSetValueKey with an invalid handle."} unique strConst__li2bpl77: int;

const {:string "\\Device\\RegFltr"} unique strConst__li2bpl118: int;

const {:string "\\DosDevices\\RegFltr"} unique strConst__li2bpl114: int;
...
const {:string "_RegFltrModifiedValue"} unique strConst__li2bpl104: int;

const {:string "_RegFltrNotModifiedKey"} unique strConst__li2bpl11: int;

const {:string "_RegFltrNotModifiedValue\r"} unique strConst__li2bpl90: int;

const {:string "_RegFltrValue"} unique strConst__li2bpl21: int;

const {:string "callee"} unique strConst__li2bpl113: int;

const {:string "caller"} unique strConst__li2bpl4: int;

const {:string "halt"} unique strConst__li2bpl75: int;
