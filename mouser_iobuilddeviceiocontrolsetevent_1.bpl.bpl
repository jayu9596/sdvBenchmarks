...
procedure {:origName "_sdv_init2"} _sdv_init2();
  ...
  free ensures {:va_keep} false || old(SignalState) == 1 || old(SignalState) == 2 || old(SignalState) == 0;
  free ensures {:va_keep} alloc >= old(alloc);
  free ensures {:va_keep} false || SignalState == 1 || SignalState == 2 || SignalState == 0;
...
procedure {:origName "SerialMouseSystemControl"} SerialMouseSystemControl(actual_DeviceObject: int, actual_Irp: int) returns (Tmp_30: int);
  modifies alloc, yogi_error, SignalState, SLAM_guard_O_0;
...
procedure {:origName "SLIC_KeClearEvent_entry"} SLIC_KeClearEvent_entry(actual_caller: int);
...
implementation {:origName "SLIC_KeClearEvent_entry"} SLIC_KeClearEvent_entry(actual_caller: int)
{
...
implementation {:origName "SLIC_IoBuildDeviceIoControlRequest_exit"} {:osmodel} SLIC_IoBuildDeviceIoControlRequest_exit(actual_caller_1: int, actual_IoBuildDeviceIoControlRequest_1: int)
{
  ...
  anon3_Then:
    assume {:partition} IoBuildDeviceIoControlRequest_1 == 0;
    call {:si_unique_call 15} SLIC_EXIT_ROUTINE(strConst__li2bpl0);
    goto L2;
}
...
implementation {:origName "SLIC_KeSetEvent_entry"} {:osmodel} SLIC_KeSetEvent_entry(actual_caller_2: int)
{
  ...
  anon5_Else:
    ...
    call {:si_unique_call 16} SLIC_EXIT_ROUTINE(strConst__li2bpl0);
    goto L2;
  ...
  anon5_Then:
    assume {:partition} SignalState == 1;
    call {:si_unique_call 17} SLIC_ABORT_4_0(caller_2);
    goto anon6_Then, anon6_Else;
...
implementation {:origName "SLIC_ABORT_4_0"} SLIC_ABORT_4_0(actual_caller_4: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 19} SLIC_ERROR_ROUTINE(strConst__li2bpl1);
    return;
}
...
procedure {:origName "sdv_IoReleaseRemoveLock"} sdv_IoReleaseRemoveLock(actual_sdv_53: int, actual_sdv_54: int) returns (Tmp_67: int);
  modifies alloc;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} false || old(SignalState) == 1 || old(SignalState) == 2 || old(SignalState) == 0;
  free ensures {:va_keep} alloc >= old(alloc);
...
implementation {:origName "sdv_IoReleaseRemoveLock"} sdv_IoReleaseRemoveLock(actual_sdv_53: int, actual_sdv_54: int) returns (Tmp_67: int)
{
  var {:scalar} sdv_55: int;

  anon0:
    call {:si_unique_call 21} Tmp_67 := __HAVOC_malloc(4);
    call {:si_unique_call 22} sdv_55 := __HAVOC_malloc(4);
...
implementation {:origName "IoFreeWorkItem"} {:osmodel} IoFreeWorkItem(actual_IoWorkItem: int)
{
  ...
  anon0:
    call {:si_unique_call 23} vslice_dummy_var_6 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "sdv_IoCopyCurrentIrpStackLocationToNext"} {:osmodel} sdv_IoCopyCurrentIrpStackLocationToNext(actual_pirp: int)
{
  ...
  anon0:
    call {:si_unique_call 24} vslice_dummy_var_7 := __HAVOC_malloc(4);
    pirp := actual_pirp;
    goto anon5_Then, anon5_Else;
...
implementation {:origName "KeSetTimer"} {:osmodel} KeSetTimer(actual_Timer: int, actual_structPtr888DueTime: int, actual_Dpc: int) returns (Tmp_75: int)
{
  ...
  anon0:
    call {:si_unique_call 26} DueTime := __HAVOC_malloc(20);
...
implementation {:origName "sdv_IoReleaseRemoveLockAndWait"} {:osmodel} sdv_IoReleaseRemoveLockAndWait(actual_RemoveLock: int, actual_Tag: int)
{
  ...
  anon0:
    call {:si_unique_call 27} vslice_dummy_var_9 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "sdv_SetPowerIrpMinorFunction"} {:osmodel} sdv_SetPowerIrpMinorFunction(actual_pirp_2: int)
{
  ...
  anon0:
    call {:si_unique_call 29} vslice_dummy_var_11 := __HAVOC_malloc(4);
...
procedure {:nohoudini} {:origName "sdv_main"} {:osmodel} sdv_main();
  modifies alloc, SignalState, SLAM_guard_O_0, yogi_error;
  free ensures {:va_keep} yogi_error == 1 || yogi_error == old(yogi_error);
  free ensures {:va_keep} SignalState == 1 || SignalState == 0 || SignalState == old(SignalState);
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} false || old(SignalState) == 1 || old(SignalState) == 2 || old(SignalState) == 0;
...
implementation {:origName "sdv_main"} {:osmodel} sdv_main()
{
  ...
  anon0:
    call {:si_unique_call 32} vslice_dummy_var_14 := __HAVOC_malloc(4);
    call {:si_unique_call 33} sdv_stub_driver_init();
    call {:si_unique_call 34} vslice_dummy_var_15 := sdv_RunDispatchFunction(sdv_p_devobj_fdo, sdv_irp);
    goto anon3_Then, anon3_Else;
...
implementation {:origName "IoAllocateErrorLogEntry"} {:osmodel} IoAllocateErrorLogEntry(actual_IoObject: int, actual_EntrySize: int) returns (Tmp_99: int)
{
  ...
  anon3_Else:
    call {:si_unique_call 35} sdv_64 := __HAVOC_malloc(1);
    Tmp_99 := sdv_64;
    goto L1;
...
implementation {:origName "PoCallDriver"} {:osmodel} PoCallDriver(actual_DeviceObject_3: int, actual_Irp_2: int) returns (Tmp_101: int)
{
  ...
  anon0:
    call {:si_unique_call 36} completion := __HAVOC_malloc(4);
    Irp_2 := actual_Irp_2;
...
implementation {:origName "sdv_IoSetCompletionRoutine"} {:osmodel} sdv_IoSetCompletionRoutine(actual_pirp_6: int, actual_CompletionRoutine: int, actual_Context_5: int, actual_InvokeOnSuccess: int, actual_InvokeOnError: int, actual_InvokeOnCancel: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 51} irpSp := sdv_IoGetNextIrpStackLocation(pirp_6);
...
implementation {:origName "PoStartNextPowerIrp"} {:osmodel} PoStartNextPowerIrp(actual_Irp_3: int)
{
  ...
  anon0:
    call {:si_unique_call 52} vslice_dummy_var_23 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "IoDeleteDevice"} {:osmodel} IoDeleteDevice(actual_DeviceObject_6: int)
{
  ...
  anon0:
    call {:si_unique_call 53} vslice_dummy_var_24 := __HAVOC_malloc(4);
    return;
}
...
procedure {:nohoudini} {:origName "main"} {:osmodel} {:entrypoint} main() returns (Tmp_124: int, dup_assertVar: bool);
  modifies alloc, SLAM_guard_O_0, SignalState, yogi_error;
...
implementation {:origName "main"} {:osmodel} main() returns (Tmp_124: int, dup_assertVar: bool)
{
  ...
  anon0:
    dup_assertVar := true;
    assume alloc > 0;
    call {:si_unique_call 54} WHEA_ERROR_PACKET_SECTION_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume WHEA_ERROR_PACKET_SECTION_GUID__Loc == WHEA_ERROR_PACKET_SECTION_GUID;
    assume WHEA_ERROR_PACKET_SECTION_GUID != 0;
    call {:si_unique_call 55} SerialMousePointerPortGuid__Loc := __HAVOC_malloc_or_null(16);
    assume SerialMousePointerPortGuid__Loc == SerialMousePointerPortGuid;
    assume SerialMousePointerPortGuid != 0;
    call {:si_unique_call 56} SLAM_guard_O_0_init__Loc := __HAVOC_malloc_or_null(156);
    assume SLAM_guard_O_0_init__Loc == SLAM_guard_O_0_init;
    assume SLAM_guard_O_0_init != 0;
    call {:si_unique_call 57} sdv_harnessStackLocation_next__Loc := __HAVOC_malloc_or_null(536);
    assume sdv_harnessStackLocation_next__Loc == sdv_harnessStackLocation_next;
    assume sdv_harnessStackLocation_next != 0;
    call {:si_unique_call 58} sdv_IoReadPartitionTableEx_DRIVE_LAYOUT_INFORMATION_EX__Loc := __HAVOC_malloc_or_null(76);
    assume sdv_IoReadPartitionTableEx_DRIVE_LAYOUT_INFORMATION_EX__Loc == sdv_IoReadPartitionTableEx_DRIVE_LAYOUT_INFORMATION_EX;
    assume sdv_IoReadPartitionTableEx_DRIVE_LAYOUT_INFORMATION_EX != 0;
    call {:si_unique_call 59} sdv_IoBuildAsynchronousFsdRequest_harnessIrp__Loc := __HAVOC_malloc_or_null(240);
    assume sdv_IoBuildAsynchronousFsdRequest_harnessIrp__Loc == sdv_IoBuildAsynchronousFsdRequest_harnessIrp;
    assume sdv_IoBuildAsynchronousFsdRequest_harnessIrp != 0;
    call {:si_unique_call 60} sdv_IoGetDeviceToVerify_DEVICE_OBJECT__Loc := __HAVOC_malloc_or_null(380);
    assume sdv_IoGetDeviceToVerify_DEVICE_OBJECT__Loc == sdv_IoGetDeviceToVerify_DEVICE_OBJECT;
    assume sdv_IoGetDeviceToVerify_DEVICE_OBJECT != 0;
    call {:si_unique_call 61} sdv_IoBuildDeviceIoControlRequest_harnessStackLocation_next__Loc := __HAVOC_malloc_or_null(536);
    assume sdv_IoBuildDeviceIoControlRequest_harnessStackLocation_next__Loc == sdv_IoBuildDeviceIoControlRequest_harnessStackLocation_next;
    assume sdv_IoBuildDeviceIoControlRequest_harnessStackLocation_next != 0;
    call {:si_unique_call 62} sdv_harness_IoBuildSynchronousFsdRequest_IoStatusBlock__Loc := __HAVOC_malloc_or_null(12);
    assume sdv_harness_IoBuildSynchronousFsdRequest_IoStatusBlock__Loc == sdv_harness_IoBuildSynchronousFsdRequest_IoStatusBlock;
    assume sdv_harness_IoBuildSynchronousFsdRequest_IoStatusBlock != 0;
    call {:si_unique_call 63} sdv_ControllerIrp__Loc := __HAVOC_malloc_or_null(240);
    assume sdv_ControllerIrp__Loc == sdv_ControllerIrp;
    assume sdv_ControllerIrp != 0;
    call {:si_unique_call 64} sdv_devobj_pdo__Loc := __HAVOC_malloc_or_null(380);
    assume sdv_devobj_pdo__Loc == sdv_devobj_pdo;
    assume sdv_devobj_pdo != 0;
    call {:si_unique_call 65} sdv_IoGetDmaAdapter_DMA_ADAPTER__Loc := __HAVOC_malloc_or_null(12);
    assume sdv_IoGetDmaAdapter_DMA_ADAPTER__Loc == sdv_IoGetDmaAdapter_DMA_ADAPTER;
    assume sdv_IoGetDmaAdapter_DMA_ADAPTER != 0;
    call {:si_unique_call 66} sdv_IoInitializeIrp_harnessIrp__Loc := __HAVOC_malloc_or_null(240);
    assume sdv_IoInitializeIrp_harnessIrp__Loc == sdv_IoInitializeIrp_harnessIrp;
    assume sdv_IoInitializeIrp_harnessIrp != 0;
    call {:si_unique_call 67} sdv_IoGetRelatedDeviceObject_DEVICE_OBJECT__Loc := __HAVOC_malloc_or_null(380);
    assume sdv_IoGetRelatedDeviceObject_DEVICE_OBJECT__Loc == sdv_IoGetRelatedDeviceObject_DEVICE_OBJECT;
    assume sdv_IoGetRelatedDeviceObject_DEVICE_OBJECT != 0;
    call {:si_unique_call 68} sdv_IoBuildSynchronousFsdRequest_harnessStackLocation_next__Loc := __HAVOC_malloc_or_null(536);
    assume sdv_IoBuildSynchronousFsdRequest_harnessStackLocation_next__Loc == sdv_IoBuildSynchronousFsdRequest_harnessStackLocation_next;
    assume sdv_IoBuildSynchronousFsdRequest_harnessStackLocation_next != 0;
    call {:si_unique_call 69} sdv_IoCreateSynchronizationEvent_KEVENT__Loc := __HAVOC_malloc_or_null(156);
    assume sdv_IoCreateSynchronizationEvent_KEVENT__Loc == sdv_IoCreateSynchronizationEvent_KEVENT;
    assume sdv_IoCreateSynchronizationEvent_KEVENT != 0;
    call {:si_unique_call 70} sdv_harnessStackLocation__Loc := __HAVOC_malloc_or_null(536);
    assume sdv_harnessStackLocation__Loc == sdv_harnessStackLocation;
    assume sdv_harnessStackLocation != 0;
    call {:si_unique_call 71} sdv_other_harnessStackLocation_next__Loc := __HAVOC_malloc_or_null(536);
    assume sdv_other_harnessStackLocation_next__Loc == sdv_other_harnessStackLocation_next;
    assume sdv_other_harnessStackLocation_next != 0;
    call {:si_unique_call 72} sdv_IoCreateController_CONTROLLER_OBJECT__Loc := __HAVOC_malloc_or_null(60);
    assume sdv_IoCreateController_CONTROLLER_OBJECT__Loc == sdv_IoCreateController_CONTROLLER_OBJECT;
    assume sdv_IoCreateController_CONTROLLER_OBJECT != 0;
    call {:si_unique_call 73} sdv_devobj_top__Loc := __HAVOC_malloc_or_null(380);
    assume sdv_devobj_top__Loc == sdv_devobj_top;
    assume sdv_devobj_top != 0;
    call {:si_unique_call 74} sdv_kdpc_val3__Loc := __HAVOC_malloc_or_null(44);
    assume sdv_kdpc_val3__Loc == sdv_kdpc_val3;
    assume sdv_kdpc_val3 != 0;
    call {:si_unique_call 75} sdv_IoBuildSynchronousFsdRequest_harnessIrp__Loc := __HAVOC_malloc_or_null(240);
    assume sdv_IoBuildSynchronousFsdRequest_harnessIrp__Loc == sdv_IoBuildSynchronousFsdRequest_harnessIrp;
    assume sdv_IoBuildSynchronousFsdRequest_harnessIrp != 0;
    call {:si_unique_call 76} sdv_IoGetDeviceObjectPointer_DEVICE_OBJECT__Loc := __HAVOC_malloc_or_null(380);
    assume sdv_IoGetDeviceObjectPointer_DEVICE_OBJECT__Loc == sdv_IoGetDeviceObjectPointer_DEVICE_OBJECT;
    assume sdv_IoGetDeviceObjectPointer_DEVICE_OBJECT != 0;
    call {:si_unique_call 77} sdv_MapRegisterBase_val__Loc := __HAVOC_malloc_or_null(4);
    assume sdv_MapRegisterBase_val__Loc == sdv_MapRegisterBase_val;
    assume sdv_MapRegisterBase_val != 0;
    call {:si_unique_call 78} sdv_IoGetFileObjectGenericMapping_GENERIC_MAPPING__Loc := __HAVOC_malloc_or_null(16);
    assume sdv_IoGetFileObjectGenericMapping_GENERIC_MAPPING__Loc == sdv_IoGetFileObjectGenericMapping_GENERIC_MAPPING;
    assume sdv_IoGetFileObjectGenericMapping_GENERIC_MAPPING != 0;
    call {:si_unique_call 79} sdv_IoMakeAssociatedIrp_harnessIrp__Loc := __HAVOC_malloc_or_null(240);
    assume sdv_IoMakeAssociatedIrp_harnessIrp__Loc == sdv_IoMakeAssociatedIrp_harnessIrp;
    assume sdv_IoMakeAssociatedIrp_harnessIrp != 0;
    call {:si_unique_call 80} sdv_devobj_child_pdo__Loc := __HAVOC_malloc_or_null(380);
    assume sdv_devobj_child_pdo__Loc == sdv_devobj_child_pdo;
    assume sdv_devobj_child_pdo != 0;
    call {:si_unique_call 81} sdv_harnessIrp__Loc := __HAVOC_malloc_or_null(240);
    assume sdv_harnessIrp__Loc == sdv_harnessIrp;
    assume sdv_harnessIrp != 0;
    call {:si_unique_call 82} sdv_IoBuildAsynchronousFsdRequest_harnessStackLocation_next__Loc := __HAVOC_malloc_or_null(536);
    assume sdv_IoBuildAsynchronousFsdRequest_harnessStackLocation_next__Loc == sdv_IoBuildAsynchronousFsdRequest_harnessStackLocation_next;
    assume sdv_IoBuildAsynchronousFsdRequest_harnessStackLocation_next != 0;
    call {:si_unique_call 83} sdv_harness_IoBuildDeviceIoControlRequest_IoStatusBlock__Loc := __HAVOC_malloc_or_null(12);
    assume sdv_harness_IoBuildDeviceIoControlRequest_IoStatusBlock__Loc == sdv_harness_IoBuildDeviceIoControlRequest_IoStatusBlock;
    assume sdv_harness_IoBuildDeviceIoControlRequest_IoStatusBlock != 0;
    call {:si_unique_call 84} sdv_kinterrupt_val__Loc := __HAVOC_malloc_or_null(0);
    assume sdv_kinterrupt_val__Loc == sdv_kinterrupt_val;
    assume sdv_kinterrupt_val != 0;
    call {:si_unique_call 85} sdv_fx_dev_object__Loc := __HAVOC_malloc_or_null(40);
    assume sdv_fx_dev_object__Loc == sdv_fx_dev_object;
    assume sdv_fx_dev_object != 0;
    call {:si_unique_call 86} sdv_devobj_fdo__Loc := __HAVOC_malloc_or_null(380);
    assume sdv_devobj_fdo__Loc == sdv_devobj_fdo;
    assume sdv_devobj_fdo != 0;
    call {:si_unique_call 87} sdv_StartIoIrp__Loc := __HAVOC_malloc_or_null(240);
    assume sdv_StartIoIrp__Loc == sdv_StartIoIrp;
    assume sdv_StartIoIrp != 0;
    call {:si_unique_call 88} sdv_harness_IoBuildAsynchronousFsdRequest_IoStatusBlock__Loc := __HAVOC_malloc_or_null(12);
    assume sdv_harness_IoBuildAsynchronousFsdRequest_IoStatusBlock__Loc == sdv_harness_IoBuildAsynchronousFsdRequest_IoStatusBlock;
    assume sdv_harness_IoBuildAsynchronousFsdRequest_IoStatusBlock != 0;
    call {:si_unique_call 89} sdv_PowerIrp__Loc := __HAVOC_malloc_or_null(240);
    assume sdv_PowerIrp__Loc == sdv_PowerIrp;
    assume sdv_PowerIrp != 0;
    call {:si_unique_call 90} sdv_IoBuildDeviceIoControlRequest_harnessIrp__Loc := __HAVOC_malloc_or_null(240);
    assume sdv_IoBuildDeviceIoControlRequest_harnessIrp__Loc == sdv_IoBuildDeviceIoControlRequest_harnessIrp;
    assume sdv_IoBuildDeviceIoControlRequest_harnessIrp != 0;
    call {:si_unique_call 91} sdv_other_harnessIrp__Loc := __HAVOC_malloc_or_null(240);
    assume sdv_other_harnessIrp__Loc == sdv_other_harnessIrp;
    assume sdv_other_harnessIrp != 0;
    call {:si_unique_call 92} sdv_IoCreateNotificationEvent_KEVENT__Loc := __HAVOC_malloc_or_null(156);
    assume sdv_IoCreateNotificationEvent_KEVENT__Loc == sdv_IoCreateNotificationEvent_KEVENT;
    assume sdv_IoCreateNotificationEvent_KEVENT != 0;
    call {:si_unique_call 93} sdv_other_harnessStackLocation__Loc := __HAVOC_malloc_or_null(536);
    assume sdv_other_harnessStackLocation__Loc == sdv_other_harnessStackLocation;
    assume sdv_other_harnessStackLocation != 0;
    call {:si_unique_call 94} boogieTmp := __HAVOC_malloc_or_null(8);
    call {:si_unique_call 95} boogieTmp := __HAVOC_malloc_or_null(8);
    call {:si_unique_call 96} boogieTmp := __HAVOC_malloc_or_null(4);
    call {:si_unique_call 97} boogieTmp := __HAVOC_malloc_or_null(20);
    call {:si_unique_call 98} boogieTmp := __HAVOC_malloc_or_null(12);
    call {:si_unique_call 99} boogieTmp := __HAVOC_malloc_or_null(4);
    ...
    call {:si_unique_call 104} boogieTmp := __HAVOC_malloc_or_null(240);
    assume sicrni == boogieTmp;
    call {:si_unique_call 105} boogieTmp := __HAVOC_malloc_or_null(20);
    call {:si_unique_call 106} vslice_dummy_var_6 := __HAVOC_malloc(32);
    call {:si_unique_call 107} vslice_dummy_var_7 := __HAVOC_malloc(72);
    call {:si_unique_call 108} vslice_dummy_var_8 := __HAVOC_malloc(16);
    call {:si_unique_call 109} vslice_dummy_var_9 := __HAVOC_malloc(120);
    call {:si_unique_call 110} vslice_dummy_var_221 := __HAVOC_malloc(12);
    call {:si_unique_call 111} vslice_dummy_var_10 := __HAVOC_malloc(48);
    call {:si_unique_call 112} vslice_dummy_var_222 := __HAVOC_malloc(12);
    assume {:mainInitDone} true;
    call {:si_unique_call 113} corralExtraInit();
    call {:si_unique_call 114} corralExplainErrorInit();
    call {:si_unique_call 115} _sdv_init12();
    call {:si_unique_call 116} _sdv_init1();
    call {:si_unique_call 117} _sdv_init4();
    call {:si_unique_call 118} _sdv_init5();
    call {:si_unique_call 119} _sdv_init3();
    call {:si_unique_call 120} _sdv_init6();
    call {:si_unique_call 121} _sdv_init10();
    call {:si_unique_call 122} _sdv_init9();
    call {:si_unique_call 123} _sdv_init7();
    call {:si_unique_call 124} _sdv_init8();
    call {:si_unique_call 125} _sdv_init2();
    goto anon9_Then, anon9_Else;
  ...
  L39:
    ...
    call {:si_unique_call 126} sdv_main();
    goto anon12_Then, anon12_Else;
...
implementation {:origName "sdv_KeLowerIrql"} {:osmodel} sdv_KeLowerIrql(actual_NewIrql: int)
{
  ...
  anon0:
    call {:si_unique_call 132} vslice_dummy_var_30 := __HAVOC_malloc(4);
...
implementation {:origName "sdv_stub_WmiIrpNotCompleted"} {:osmodel} sdv_stub_WmiIrpNotCompleted(actual_pirp_9: int)
{
  ...
  anon0:
    call {:si_unique_call 133} vslice_dummy_var_31 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "sdv_RunDispatchFunction"} {:osmodel} sdv_RunDispatchFunction(actual_po: int, actual_pirp_10: int) returns (Tmp_146: int)
{
  ...
  anon0:
    ...
    assume {:nonnull} pirp_10 != 0;
    assume pirp_10 > 0;
    call {:si_unique_call 134} sdv_SetStatus(pirp_10);
    assume {:nonnull} pirp_10 != 0;
    assume pirp_10 > 0;
    assume {:nonnull} pirp_10 != 0;
    assume pirp_10 > 0;
    ...
    assume {:nonnull} ps != 0;
    assume ps > 0;
    call {:si_unique_call 135} sdv_stub_dispatch_begin();
    goto anon55_Then, anon55_Else;
  ...
  L66:
    call {:si_unique_call 136} status_15 := SerialMousePnP(po, pirp_10);
  ...
  L72:
    call {:si_unique_call 137} sdv_stub_dispatch_end(status_15, 0);
    assume {:nonnull} pirp_10 != 0;
    assume pirp_10 > 0;
    Tmp_146 := status_15;
    goto LM2;
  ...
  anon60_Then:
    call {:si_unique_call 138} status_15 := sdv_DoNothing();
    goto L72;

  anon61_Then:
    assume {:nonnull} ps != 0;
    assume ps > 0;
    call {:si_unique_call 139} status_15 := SerialMouseSystemControl(po, pirp_10);
  ...
  anon62_Then:
    assume {:nonnull} ps != 0;
    assume ps > 0;
    call {:si_unique_call 140} sdv_SetPowerIrpMinorFunction(pirp_10);
    call {:si_unique_call 141} status_15 := SerialMousePower(po, pirp_10);
    goto anon78_Then, anon78_Else;
  ...
  anon63_Then:
    assume {:nonnull} ps != 0;
    assume ps > 0;
    call {:si_unique_call 142} status_15 := sdv_DoNothing();
    goto L72;
  ...
  anon66_Then:
    assume {:nonnull} ps != 0;
    assume ps > 0;
    call {:si_unique_call 145} status_15 := SerialMouseInternalDeviceControl(po, pirp_10);
    goto L72;

  anon67_Then:
    assume {:nonnull} ps != 0;
    assume ps > 0;
    call {:si_unique_call 146} status_15 := sdv_DoNothing();
    goto L72;
  ...
  anon69_Then:
    assume {:nonnull} ps != 0;
    assume ps > 0;
    call {:si_unique_call 148} status_15 := SerialMouseFlush(po, pirp_10);
    goto anon77_Then, anon77_Else;
  ...
  anon70_Then:
    assume {:nonnull} ps != 0;
    assume ps > 0;
    call {:si_unique_call 149} status_15 := sdv_DoNothing();
    goto L72;
  ...
  anon74_Then:
    assume {:nonnull} ps != 0;
    assume ps > 0;
    call {:si_unique_call 153} status_15 := SerialMouseClose(po, pirp_10);
    goto anon76_Then, anon76_Else;
  ...
  anon55_Then:
    assume {:nonnull} ps != 0;
    assume ps > 0;
    call {:si_unique_call 154} status_15 := SerialMouseCreate(po, pirp_10);
    goto anon75_Then, anon75_Else;
...
implementation {:origName "sdv_KeReleaseSpinLock"} {:osmodel} sdv_KeReleaseSpinLock(actual_SpinLock_1: int, actual_new_1: int)
{
  ...
  anon0:
    call {:si_unique_call 155} vslice_dummy_var_32 := __HAVOC_malloc(4);
    new_1 := actual_new_1;
    return;
}
...
implementation {:origName "IoReuseIrp"} {:osmodel} IoReuseIrp(actual_Irp_5: int, actual_Status: int)
{
  ...
  anon0:
    call {:si_unique_call 156} vslice_dummy_var_33 := __HAVOC_malloc(4);
    Irp_5 := actual_Irp_5;
...
implementation {:origName "sdv_IoCompleteRequest"} {:osmodel} sdv_IoCompleteRequest(actual_pirp_11: int, actual_PriorityBoost: int)
{
  ...
  anon0:
    call {:si_unique_call 157} vslice_dummy_var_34 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "sdv_stub_WmiIrpForward"} {:osmodel} sdv_stub_WmiIrpForward(actual_pirp_12: int)
{
  ...
  anon0:
    call {:si_unique_call 158} vslice_dummy_var_35 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "sdv_stub_WmiIrpProcessed"} {:osmodel} sdv_stub_WmiIrpProcessed(actual_pirp_13: int)
{
  ...
  anon0:
    call {:si_unique_call 160} vslice_dummy_var_37 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "IoAllocateIrp"} {:osmodel} IoAllocateIrp(actual_StackSize: int, actual_ChargeQuota: int) returns (Tmp_171: int)
{
  ...
  anon3_Else:
    assume {:nonnull} sdv_other_irp != 0;
    assume sdv_other_irp > 0;
    call {:si_unique_call 161} irpSp_1 := sdv_IoGetNextIrpStackLocation(sdv_other_irp);
...
implementation {:origName "ExAllocatePoolWithTag"} {:osmodel} ExAllocatePoolWithTag(actual_PoolType: int, actual_NumberOfBytes: int, actual_Tag_2: int) returns (Tmp_189: int)
{
  ...
  anon3_Else:
    call {:si_unique_call 165} sdv_111 := __HAVOC_malloc(NumberOfBytes);
    Tmp_189 := sdv_111;
    goto L1;
...
implementation {:origName "IoAllocateWorkItem"} {:osmodel} IoAllocateWorkItem(actual_DeviceObject_12: int) returns (Tmp_191: int)
{
  ...
  anon0:
    call {:si_unique_call 166} sdv_113 := __HAVOC_malloc(1);
    ioWorkItem := sdv_113;
    goto anon6_Then, anon6_Else;
...
implementation {:origName "sdv_stub_driver_init"} {:osmodel} sdv_stub_driver_init()
{
  ...
  anon0:
    call {:si_unique_call 167} vslice_dummy_var_41 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "sdv_stub_dispatch_begin"} {:osmodel} sdv_stub_dispatch_begin()
{
  ...
  anon0:
    call {:si_unique_call 168} vslice_dummy_var_42 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "KeClearEvent"} {:osmodel} KeClearEvent(actual_Event_4: int)
{
  ...
  anon0:
    call {:si_unique_call 169} vslice_dummy_var_43 := __HAVOC_malloc(4);
...
implementation {:origName "SerialMouseReadSerialPortComplete"} SerialMouseReadSerialPortComplete(actual_DeviceObject_15: int, actual_Irp_9: int, actual_Context_7: int) returns (Tmp_212: int)
{
  ...
  anon5_Else:
    assume Event_5 == SLAM_guard_O_0;
    assume SLAM_guard_O_0 != SLAM_guard_O_0_init;
    call {:si_unique_call 170} SLIC_KeSetEvent_entry(strConst__li2bpl2);
    goto anon6_Then, anon6_Else;
  ...
  L10:
    call {:si_unique_call 171} vslice_dummy_var_44 := KeSetEvent(Event_5, 0, 0);
    Tmp_212 := -1073741802;
    goto LM2;
  ...
  anon5_Then:
    assume !(Event_5 == SLAM_guard_O_0 && SLAM_guard_O_0 != SLAM_guard_O_0_init);
    goto L10;
}
...
implementation {:origName "_sdv_init6"} _sdv_init6()
{
  ...
  anon0:
    call {:si_unique_call 172} vslice_dummy_var_45 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "SerialMouseWait"} SerialMouseWait(actual_DeviceExtension_20: int, actual_Timeout_1: int) returns (Tmp_232: int)
{
  ...
  anon0:
    call {:si_unique_call 173} time := __HAVOC_malloc(20);
    Timeout_1 := actual_Timeout_1;
    assume {:nonnull} time != 0;
    assume time > 0;
    call {:si_unique_call 174} vslice_dummy_var_46 := KeSetTimer(0, time, 0);
    call {:si_unique_call 175} Tmp_232 := KeWaitForSingleObject(0, 0, 0, 0, 0);
    return;
}
...
implementation {:origName "_sdv_init5"} _sdv_init5()
{
  ...
  anon0:
    call {:si_unique_call 177} vslice_dummy_var_48 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "SerialMouseServiceParameters"} SerialMouseServiceParameters(actual_DeviceExtension_28: int, actual_Handle_1: int)
{
  ...
  anon0:
    call {:si_unique_call 178} prevNumberOfButtons := __HAVOC_malloc(4);
    call {:si_unique_call 179} sampleRate := __HAVOC_malloc(4);
    call {:si_unique_call 180} prevSampleRate := __HAVOC_malloc(4);
    call {:si_unique_call 181} defaultWaitEventMask := __HAVOC_malloc(4);
    call {:si_unique_call 182} defaultNumberOfButtons := __HAVOC_malloc(4);
    call {:si_unique_call 183} numberOfButtons := __HAVOC_malloc(4);
    call {:si_unique_call 184} vslice_dummy_var_49 := __HAVOC_malloc(4);
    call {:si_unique_call 185} defaultSampleRate := __HAVOC_malloc(4);
    call {:si_unique_call 186} parametersPath := __HAVOC_malloc(12);
    DeviceExtension_28 := actual_DeviceExtension_28;
    Handle_1 := actual_Handle_1;
    call {:si_unique_call 187} vslice_dummy_var_52 := __HAVOC_malloc(44);
    parameters := 0;
    status_29 := 0;
    ...
    call {:si_unique_call 189} RtlInitUnicodeString(parametersPath, 0);
    Tmp_302 := 28 * queriesPlusOne;
    call {:si_unique_call 190} sdv_181 := ExAllocatePoolWithTag(1, Tmp_302, -228232371);
    parameters := sdv_181;
  ...
  anon27_Else:
    ...
    call {:si_unique_call 191} sdv_RtlZeroMemory(0, Tmp_291);
    assume {:nonnull} DeviceExtension_28 != 0;
    assume DeviceExtension_28 > 0;
    call {:si_unique_call 192} sdv_184 := IoGetDriverObjectExtension(0, 0);
    regPath := sdv_184;
  ...
  anon23_Else:
    ...
    assume {:nonnull} parameters != 0;
    assume parameters > 0;
    call {:si_unique_call 193} status_29 := sdv_RtlQueryRegistryValues(-1073741824, 0, 0, 0, 0);
    goto L74;
  ...
  anon30_Else:
    call {:si_unique_call 194} sdv_ExFreePool(0);
    goto L107;
  ...
  anon21_Then:
    ...
    assume parametersPath > 0;
    havoc Tmp_301;
    call {:si_unique_call 196} sdv_186 := ExAllocatePoolWithTag(1, Tmp_301, -228232371);
    assume {:nonnull} parametersPath != 0;
    assume parametersPath > 0;
    assume {:nonnull} parametersPath != 0;
    assume parametersPath > 0;
  ...
  anon29_Else:
    ...
    assume parametersPath > 0;
    havoc Tmp_294;
    call {:si_unique_call 197} sdv_RtlZeroMemory(0, Tmp_294);
    call {:si_unique_call 198} vslice_dummy_var_50 := corral_nondet();
    call {:si_unique_call 199} vslice_dummy_var_51 := corral_nondet();
    assume {:nonnull} parametersPath != 0;
    assume parametersPath > 0;
  ...
  anon22_Then:
    ...
    assume {:nonnull} parameters != 0;
    assume parameters > 0;
    call {:si_unique_call 200} status_29 := sdv_RtlQueryRegistryValues(0, 0, 0, 0, 0);
...
implementation {:origName "SerialMouseCreate"} SerialMouseCreate(actual_DeviceObject_19: int, actual_Irp_13: int) returns (Tmp_316: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 202} irpSp_2 := sdv_IoGetCurrentIrpStackLocation(Irp_13);
  ...
  L23:
    ...
    assume {:nonnull} Irp_13 != 0;
    assume Irp_13 > 0;
    call {:si_unique_call 203} sdv_IoCompleteRequest(0, 0);
    Tmp_316 := status_33;
    goto LM2;
  ...
  anon22_Then:
    call {:si_unique_call 204} status_33 := sdv_IoAcquireRemoveLock(0, 0);
    goto anon17_Then, anon17_Else;
  ...
  anon18_Else:
    call {:si_unique_call 205} Tmp_317 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_317 != 0;
    assume Tmp_317 > 0;
    assume {:nonnull} deviceExtension_3 != 0;
    assume deviceExtension_3 > 0;
    call {:si_unique_call 206} sdv_204 := sdv_InterlockedIncrement(Tmp_317);
    assume {:nonnull} Tmp_317 != 0;
    assume Tmp_317 > 0;
    assume {:nonnull} deviceExtension_3 != 0;
    assume deviceExtension_3 > 0;
  ...
  anon19_Else:
    assume {:partition} 1 == sdv_204;
    assume {:nonnull} deviceExtension_3 != 0;
    assume deviceExtension_3 > 0;
    havoc vslice_dummy_var_11;
    call {:si_unique_call 207} status_33 := SerialMouseSendIrpSynchronously#1(vslice_dummy_var_11, Irp_13, 1);
    goto anon23_Then, anon23_Else;
  ...
  anon21_Else:
    call {:si_unique_call 208} status_33 := SerialMouseStartDevice#1(deviceExtension_3, Irp_13, 1);
    goto anon24_Then, anon24_Else;
  ...
  L52:
    assume {:nonnull} deviceExtension_3 != 0;
    assume deviceExtension_3 > 0;
    call {:si_unique_call 209} vslice_dummy_var_53 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(deviceExtension_3), Irp_13);
    goto L23;
  ...
  L44:
    call {:si_unique_call 210} Tmp_317 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_317 != 0;
    assume Tmp_317 > 0;
    assume {:nonnull} deviceExtension_3 != 0;
    assume deviceExtension_3 > 0;
    call {:si_unique_call 211} vslice_dummy_var_54 := sdv_InterlockedDecrement(Tmp_317);
    assume {:nonnull} Tmp_317 != 0;
    assume Tmp_317 > 0;
    assume {:nonnull} deviceExtension_3 != 0;
    assume deviceExtension_3 > 0;
...
implementation {:origName "SerialMouseInternalDeviceControl"} SerialMouseInternalDeviceControl(actual_DeviceObject_20: int, actual_Irp_14: int) returns (Tmp_319: int)
{
  ...
  anon0:
    ...
    assume Irp_14 > 0;
    call {:si_unique_call 212} irpSp_3 := sdv_IoGetCurrentIrpStackLocation(Irp_14);
    call {:si_unique_call 213} status_34 := sdv_IoAcquireRemoveLock(0, 0);
    goto anon19_Then, anon19_Else;
  ...
  L26:
    ...
    call {:si_unique_call 215} vslice_dummy_var_55 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(deviceExtension_4), Irp_14);
    Tmp_319 := status_34;
    goto L1;
  ...
  anon19_Then:
    ...
    assume {:nonnull} Irp_14 != 0;
    assume Irp_14 > 0;
    call {:si_unique_call 216} sdv_IoCompleteRequest(0, 0);
    Tmp_319 := status_34;
    goto L1;
}
...
implementation {:origName "_sdv_init4"} _sdv_init4()
{
  ...
  anon0:
    call {:si_unique_call 217} vslice_dummy_var_56 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "SerialMouseFlush"} SerialMouseFlush(actual_DeviceObject_21: int, actual_Irp_15: int) returns (Tmp_325: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 218} status_35 := sdv_IoAcquireRemoveLock(0, 0);
    goto anon5_Then, anon5_Else;

  anon5_Else:
    assume {:partition} status_35 >= 0;
    call {:si_unique_call 219} sdv_IoSkipCurrentIrpStackLocation(Irp_15);
    assume {:nonnull} deviceExtension_5 != 0;
    assume deviceExtension_5 > 0;
    havoc vslice_dummy_var_12;
    call {:si_unique_call 220} status_35 := sdv_IoCallDriver#1(vslice_dummy_var_12, Irp_15);
    goto anon6_Then, anon6_Else;
  ...
  anon6_Else:
    ...
    assume {:nonnull} deviceExtension_5 != 0;
    assume deviceExtension_5 > 0;
    call {:si_unique_call 221} vslice_dummy_var_57 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(deviceExtension_5), Irp_15);
    Tmp_325 := status_35;
    goto L1;
...
implementation {:origName "SerialMouseClose"} SerialMouseClose(actual_DeviceObject_22: int, actual_Irp_16: int) returns (Tmp_327: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 223} status_36 := sdv_IoAcquireRemoveLock(0, 0);
    goto anon9_Then, anon9_Else;
  ...
  L26:
    ...
    assume {:nonnull} Irp_16 != 0;
    assume Irp_16 > 0;
    call {:si_unique_call 224} sdv_IoCompleteRequest(0, 0);
    Tmp_327 := status_36;
    goto L1;
  ...
  anon9_Then:
    ...
    call {:si_unique_call 225} Tmp_328 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_328 != 0;
    assume Tmp_328 > 0;
    assume {:nonnull} deviceExtension_6 != 0;
    assume deviceExtension_6 > 0;
    call {:si_unique_call 226} sdv_212 := sdv_InterlockedDecrement(Tmp_328);
    assume {:nonnull} Tmp_328 != 0;
    assume Tmp_328 > 0;
    assume {:nonnull} deviceExtension_6 != 0;
    assume deviceExtension_6 > 0;
  ...
  anon10_Else:
    ...
    assume {:nonnull} deviceExtension_6 != 0;
    assume deviceExtension_6 > 0;
    call {:si_unique_call 227} vslice_dummy_var_60 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(deviceExtension_6), Irp_16);
    goto L26;

  anon10_Then:
    assume {:partition} sdv_212 == 0;
    call {:si_unique_call 228} vslice_dummy_var_58 := IoCancelIrp(0);
    call {:si_unique_call 229} SerialMouseStopDetection(deviceExtension_6);
    call {:si_unique_call 230} SerialMouseRestorePort#1(deviceExtension_6);
    goto anon11_Then, anon11_Else;
  ...
  anon11_Else:
    ...
    assume {:nonnull} deviceExtension_6 != 0;
    assume deviceExtension_6 > 0;
    call {:si_unique_call 231} vslice_dummy_var_59 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(deviceExtension_6), Irp_16);
    call {:si_unique_call 232} sdv_IoSkipCurrentIrpStackLocation(Irp_16);
    assume {:nonnull} deviceExtension_6 != 0;
    assume deviceExtension_6 > 0;
    havoc vslice_dummy_var_13;
    call {:si_unique_call 233} Tmp_327 := sdv_IoCallDriver#1(vslice_dummy_var_13, Irp_16);
    goto anon12_Then, anon12_Else;
...
implementation {:origName "_sdv_init1"} _sdv_init1()
{
  ...
  anon0:
    call {:si_unique_call 234} vslice_dummy_var_61 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "SerialMouseCompletionRoutine"} SerialMouseCompletionRoutine(actual_DeviceObject_24: int, actual_Irp_18: int, actual_Context_9: int) returns (Tmp_333: int)
{
  ...
  anon5_Else:
    assume Event_8 == SLAM_guard_O_0;
    assume SLAM_guard_O_0 != SLAM_guard_O_0_init;
    call {:si_unique_call 235} SLIC_KeSetEvent_entry(strConst__li2bpl2);
    goto anon6_Then, anon6_Else;
  ...
  anon5_Then:
    assume !(Event_8 == SLAM_guard_O_0 && SLAM_guard_O_0 != SLAM_guard_O_0_init);
    goto L10;
}
...
implementation {:origName "SerialMouseStopDevice"} SerialMouseStopDevice(actual_DeviceExtension_34: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 244} Tmp_341 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_341 != 0;
    assume Tmp_341 > 0;
    call {:si_unique_call 245} sdv_KeAcquireSpinLock(0, Tmp_341);
    assume {:nonnull} Tmp_341 != 0;
    assume Tmp_341 > 0;
    havoc irql_1;
  ...
  anon5_Else:
    ...
    call {:si_unique_call 248} sdv_223 := IoCancelIrp(0);
    goto anon6_Then, anon6_Else;
...
implementation {:origName "SerialMousePnP"} SerialMousePnP(actual_DeviceObject_26: int, actual_Irp_20: int) returns (Tmp_342: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 250} Tmp_344 := __HAVOC_malloc(28);
    call {:si_unique_call 251} Tmp_346 := __HAVOC_malloc(28);
    skipIt := 0;
  ...
  L88:
    call {:si_unique_call 262} i_4, Tmp_344, Tmp_345 := SerialMousePnP_loop_L88(i_4, devCaps, Tmp_344, Tmp_345);
    goto L88_last;
  ...
  anon108_Else:
    call {:si_unique_call 274} Tmp_343 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_343 != 0;
    assume Tmp_343 > 0;
    assume {:nonnull} deviceExtension_8 != 0;
    assume deviceExtension_8 > 0;
    call {:si_unique_call 275} sdv_230 := sdv_InterlockedIncrement(Tmp_343);
    assume {:nonnull} Tmp_343 != 0;
    assume Tmp_343 > 0;
    assume {:nonnull} deviceExtension_8 != 0;
    assume deviceExtension_8 > 0;
  ...
  anon134_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 284} Tmp_343 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_343 != 0;
    assume Tmp_343 > 0;
    assume {:nonnull} deviceExtension_8 != 0;
    assume deviceExtension_8 > 0;
    call {:si_unique_call 285} sdv_236 := sdv_InterlockedDecrement(Tmp_343);
    assume {:nonnull} Tmp_343 != 0;
    assume Tmp_343 > 0;
    assume {:nonnull} deviceExtension_8 != 0;
    assume deviceExtension_8 > 0;
...
implementation {:origName "SerialMousePower"} SerialMousePower(actual_DeviceObject_27: int, actual_Irp_21: int) returns (Tmp_347: int)
{
  ...
  anon55_Else:
    assume event_17 == SLAM_guard_O_0;
    assume SLAM_guard_O_0 != SLAM_guard_O_0_init;
    call {:si_unique_call 301} SLIC_KeInitializeEvent_entry(0, 0);
    goto L186;

  L186:
    call {:si_unique_call 302} KeInitializeEvent(event_17, 0, 0);
    assume {:nonnull} deviceExtension_9 != 0;
    assume deviceExtension_9 > 0;
    havoc vslice_dummy_var_20;
    call {:si_unique_call 303} status_40 := SerialMousepIoSyncIoctl#1(0, 1769524, vslice_dummy_var_20, event_17, iosb_16);
    goto anon71_Then, anon71_Else;
  ...
  anon56_Else:
    ...
    assume {:nonnull} li != 0;
    assume li > 0;
    call {:si_unique_call 304} vslice_dummy_var_77 := KeDelayExecutionThread(0, 0, 0);
    goto L62;
  ...
  L62:
    ...
    call {:si_unique_call 305} SD1 := PoSetPowerState(0, vslice_dummy_var_21, vslice_dummy_var_22);
    ...
    assume {:nonnull} deviceExtension_9 != 0;
    assume deviceExtension_9 > 0;
    call {:si_unique_call 306} vslice_dummy_var_70 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(deviceExtension_9), Irp_21);
    assume {:nonnull} Irp_21 != 0;
    assume Irp_21 > 0;
    call {:si_unique_call 307} sdv_IoCopyCurrentIrpStackLocationToNext(Irp_21);
    call {:si_unique_call 308} PoStartNextPowerIrp(0);
    call {:si_unique_call 309} Tmp_347 := PoCallDriver(0, Irp_21);
    goto anon72_Then, anon72_Else;
  ...
  anon55_Then:
    assume !(event_17 == SLAM_guard_O_0 && SLAM_guard_O_0 != SLAM_guard_O_0_init);
    goto L186;
  ...
  L32:
    call {:si_unique_call 310} PoStartNextPowerIrp(0);
    call {:si_unique_call 311} sdv_IoSkipCurrentIrpStackLocation(Irp_21);
    call {:si_unique_call 312} status_40 := PoCallDriver(0, Irp_21);
    goto anon66_Then, anon66_Else;
  ...
  anon66_Else:
    ...
    assume {:nonnull} deviceExtension_9 != 0;
    assume deviceExtension_9 > 0;
    call {:si_unique_call 313} vslice_dummy_var_74 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(deviceExtension_9), Irp_21);
    Tmp_347 := status_40;
    goto L1;
  ...
  anon54_Else:
    assume event_17 == SLAM_guard_O_0;
    assume SLAM_guard_O_0 != SLAM_guard_O_0_init;
    call {:si_unique_call 314} SLIC_KeInitializeEvent_entry(0, 0);
    goto L183;

  L183:
    call {:si_unique_call 315} KeInitializeEvent(event_17, 1, 0);
    assume {:nonnull} deviceExtension_9 != 0;
    assume deviceExtension_9 > 0;
    assume {:nonnull} deviceExtension_9 != 0;
    assume deviceExtension_9 > 0;
    assume {:nonnull} stack_3 != 0;
    assume stack_3 > 0;
    call {:si_unique_call 316} sdv_IoCopyCurrentIrpStackLocationToNext(Irp_21);
    call {:si_unique_call 317} sdv_IoSetCompletionRoutine(Irp_21, li2bplFunctionConstant188, event_17, 1, 1, 1);
    call {:si_unique_call 318} status_40 := PoCallDriver(0, Irp_21);
    goto anon67_Then, anon67_Else;
  ...
  anon57_Else:
    ...
    call {:si_unique_call 319} vslice_dummy_var_71 := KeWaitForSingleObject(0, 0, 0, 0, 0);
    assume {:nonnull} Irp_21 != 0;
    assume Irp_21 > 0;
    havoc status_40;
    goto L96;
  ...
  anon59_Else:
    call {:si_unique_call 320} structPtr888sdv := PoSetPowerState(0, powerType, powerState);
    ...
    assume {:nonnull} structPtr888sdv != 0;
    assume structPtr888sdv > 0;
    call {:si_unique_call 321} sdv_247 := sdv_IoAcquireRemoveLock(0, 0);
    goto anon60_Then, anon60_Else;

  anon60_Else:
    assume {:partition} sdv_247 >= 0;
    call {:si_unique_call 322} workItem := IoAllocateWorkItem(0);
    goto anon61_Then, anon61_Else;

  anon61_Else:
    assume {:partition} workItem != 0;
    call {:si_unique_call 323} sdv_241 := ExAllocatePoolWithTag(512, 8, -228232371);
    workItemContext := sdv_241;
    goto anon68_Then, anon68_Else;
  ...
  anon68_Else:
    ...
    assume {:nonnull} workItemContext != 0;
    assume workItemContext > 0;
    call {:si_unique_call 324} IoQueueWorkItem#1(workItem, li2bplFunctionConstant193, 1, workItemContext);
    goto anon69_Then, anon69_Else;
  ...
  L101:
    ...
    assume {:nonnull} deviceExtension_9 != 0;
    assume deviceExtension_9 > 0;
    call {:si_unique_call 325} vslice_dummy_var_75 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(deviceExtension_9), Irp_21);
  ...
  anon68_Then:
    assume {:partition} workItemContext == 0;
    call {:si_unique_call 328} IoFreeWorkItem(0);
    assume {:nonnull} deviceExtension_9 != 0;
    assume deviceExtension_9 > 0;
    call {:si_unique_call 329} vslice_dummy_var_73 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(deviceExtension_9), deviceExtension_9);
    goto L101;
  ...
  anon61_Then:
    ...
    assume {:nonnull} deviceExtension_9 != 0;
    assume deviceExtension_9 > 0;
    call {:si_unique_call 330} vslice_dummy_var_72 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(deviceExtension_9), deviceExtension_9);
    goto L101;

  anon60_Then:
    assume {:partition} 0 > sdv_247;
    goto L101;
  ...
  anon49_Then:
    assume {:partition} 0 > status_40;
    call {:si_unique_call 331} PoStartNextPowerIrp(0);
    assume {:nonnull} Irp_21 != 0;
    assume Irp_21 > 0;
    call {:si_unique_call 332} sdv_IoCompleteRequest(0, 0);
    Tmp_347 := status_40;
    goto L1;
}
...
implementation {:origName "SerialMouseHandleStartStopStart"} SerialMouseHandleStartStopStart(actual_DeviceExtension_35: int)
{
  ...
  anon0:
    call {:si_unique_call 333} vslice_dummy_var_78 := __HAVOC_malloc(4);
    DeviceExtension_35 := actual_DeviceExtension_35;
    call {:si_unique_call 334} Tmp_349 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_349 != 0;
    assume Tmp_349 > 0;
    call {:si_unique_call 335} sdv_KeAcquireSpinLock(0, Tmp_349);
    assume {:nonnull} Tmp_349 != 0;
    assume Tmp_349 > 0;
    havoc irql_2;
  ...
  anon3_Else:
    ...
    call {:si_unique_call 336} IoReuseIrp(vslice_dummy_var_23, 0);
    goto L8;

  L8:
    call {:si_unique_call 337} sdv_KeReleaseSpinLock(0, irql_2);
    return;
...
const {:string "KeSetEvent does not need to be called in the driver for this irp."} unique strConst__li2bpl1: int;
...
implementation {:origName "CSerPowerUp"} CSerPowerUp#0(actual_DeviceExtension: int) returns (Tmp_3: int)
{
  ...
  anon0:
    call {:si_unique_call 338} bits := __HAVOC_malloc(4);
    call {:si_unique_call 339} iosb := __HAVOC_malloc(12);
    call {:si_unique_call 340} event := __HAVOC_malloc(156);
  ...
  anon13_Else:
    ...
    assume SLAM_guard_O_0 != SLAM_guard_O_0_init;
    call {:si_unique_call 342} SLIC_KeInitializeEvent_entry(0, 0);
    goto L38;

  L38:
    call {:si_unique_call 343} KeInitializeEvent(event, 0, 0);
    assume {:nonnull} DeviceExtension != 0;
    assume DeviceExtension > 0;
    havoc vslice_dummy_var_24;
    call {:si_unique_call 344} status := SerialMousepIoSyncIoctl#0(0, 1769508, vslice_dummy_var_24, event, iosb);
    goto anon15_Then, anon15_Else;
  ...
  anon15_Else:
    ...
    call {:si_unique_call 345} status := SerialMousepIoSyncIoctl#0(0, 1769520, vslice_dummy_var_25, event, iosb);
    goto anon16_Then, anon16_Else;
  ...
  anon16_Else:
    ...
    call {:si_unique_call 346} status := SerialMousepIoSyncIoctlEx#0(0, 1769576, vslice_dummy_var_26, event, iosb, 0, 0, bits, 4);
    goto anon17_Then, anon17_Else;
  ...
  anon18_Else:
    ...
    call {:si_unique_call 347} vslice_dummy_var_79 := SerialMouseWait(DeviceExtension, -5000000);
    goto L29;
...
procedure {:origName "CSerPowerUp"} CSerPowerUp#0(actual_DeviceExtension: int) returns (Tmp_3: int);
  modifies alloc, SignalState, SLAM_guard_O_0;
  free ensures {:va_keep} old(SignalState) == 1 ==> SignalState != 1;
  free ensures {:va_keep} old(SignalState) == 1 ==> SignalState != 2;
  free ensures {:va_keep} old(SignalState) == 1 ==> SignalState != 0;
  free ensures {:va_keep} old(SignalState) == 2 ==> SignalState != 1;
...
implementation {:origName "CSerPowerUp"} CSerPowerUp#1(actual_DeviceExtension: int) returns (Tmp_3: int)
{
  ...
  anon0:
    call {:si_unique_call 348} bits := __HAVOC_malloc(4);
    call {:si_unique_call 349} iosb := __HAVOC_malloc(12);
  ...
  anon13_Else:
    assume event == SLAM_guard_O_0;
    assume SLAM_guard_O_0 != SLAM_guard_O_0_init;
    call {:si_unique_call 352} SLIC_KeInitializeEvent_entry(0, 0);
    goto L38;

  L38:
    call {:si_unique_call 353} KeInitializeEvent(event, 0, 0);
    assume {:nonnull} DeviceExtension != 0;
    assume DeviceExtension > 0;
    havoc vslice_dummy_var_27;
    call {:si_unique_call 354} status := SerialMousepIoSyncIoctl#1(0, 1769508, vslice_dummy_var_27, event, iosb);
    goto anon15_Then, anon15_Else;
  ...
  anon15_Else:
    ...
    call {:si_unique_call 355} status := SerialMousepIoSyncIoctl#1(0, 1769520, vslice_dummy_var_28, event, iosb);
    goto anon16_Then, anon16_Else;
  ...
  anon16_Else:
    ...
    call {:si_unique_call 356} status := SerialMousepIoSyncIoctlEx#1(0, 1769576, vslice_dummy_var_29, event, iosb, 0, 0, bits, 4);
    goto anon17_Then, anon17_Else;
  ...
  anon18_Else:
    assume {:partition} Tmp_4 == rtsDtr;
    call {:si_unique_call 357} vslice_dummy_var_80 := SerialMouseWait(DeviceExtension, -5000000);
    goto L29;
...
implementation {:origName "SerialMousepIoSyncIoctl"} SerialMousepIoSyncIoctl#0(actual_Internal: int, actual_Ioctl: int, actual_DeviceObject_16: int, actual_Event_6: int, actual_Iosb: int) returns (Tmp_218: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 359} Tmp_218 := SerialMousepIoSyncIoctlEx#0(Internal, Ioctl, DeviceObject_16, Event_6, Iosb, 0, 0, 0, 0);
    goto anon3_Then, anon3_Else;
...
procedure {:origName "SerialMousepIoSyncIoctl"} SerialMousepIoSyncIoctl#0(actual_Internal: int, actual_Ioctl: int, actual_DeviceObject_16: int, actual_Event_6: int, actual_Iosb: int) returns (Tmp_218: int);
  ...
  free ensures {:va_keep} old(SignalState) == 0 ==> SignalState != 0;
  free ensures {:va_keep} old(SLAM_guard_O_0) == old(SLAM_guard_O_0_init) ==> SignalState == old(SignalState);
  free ensures {:va_keep} SLAM_guard_O_0 == actual_Event_6;
  free ensures {:va_keep} SignalState == 1 || SignalState == old(SignalState);
...
implementation {:origName "SerialMousepIoSyncIoctl"} SerialMousepIoSyncIoctl#1(actual_Internal: int, actual_Ioctl: int, actual_DeviceObject_16: int, actual_Event_6: int, actual_Iosb: int) returns (Tmp_218: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 361} Tmp_218 := SerialMousepIoSyncIoctlEx#1(Internal, Ioctl, DeviceObject_16, Event_6, Iosb, 0, 0, 0, 0);
    goto anon3_Then, anon3_Else;
...
implementation {:origName "SerialMousepIoSyncIoctlEx"} SerialMousepIoSyncIoctlEx#0(actual_Internal_1: int, actual_Ioctl_1: int, actual_DeviceObject_17: int, actual_Event_7: int, actual_Iosb_1: int, actual_InBuffer: int, actual_InBufferLen: int, actual_OutBuffer: int, actual_OutBufferLen: int) returns (Tmp_222: int)
{
  ...
  anon13_Else:
    ...
    assume SLAM_guard_O_0 != SLAM_guard_O_0_init;
    call {:si_unique_call 363} SLIC_KeClearEvent_entry(strConst__li2bpl2);
    goto L32;

  L32:
    call {:si_unique_call 364} KeClearEvent(Event_7);
    SLAM_guard_O_0 := Event_7;
  ...
  anon17_Else:
    assume Event_7 == SLAM_guard_O_0;
    assume SLAM_guard_O_0 != SLAM_guard_O_0_init;
    call {:si_unique_call 366} SLIC_IoBuildDeviceIoControlRequest_exit(0, irp_5);
    goto L15;
...
procedure {:origName "SerialMousepIoSyncIoctlEx"} SerialMousepIoSyncIoctlEx#0(actual_Internal_1: int, actual_Ioctl_1: int, actual_DeviceObject_17: int, actual_Event_7: int, actual_Iosb_1: int, actual_InBuffer: int, actual_InBufferLen: int, actual_OutBuffer: int, actual_OutBufferLen: int) returns (Tmp_222: int);
  ...
  free ensures {:va_keep} old(SignalState) == 0 ==> SignalState != 0;
  free ensures {:va_keep} old(SLAM_guard_O_0) == old(SLAM_guard_O_0_init) ==> SignalState == old(SignalState);
  free ensures {:va_keep} SLAM_guard_O_0 == actual_Event_7;
  free ensures {:va_keep} SignalState == 1 || SignalState == old(SignalState);
...
implementation {:origName "SerialMousepIoSyncIoctlEx"} SerialMousepIoSyncIoctlEx#1(actual_Internal_1: int, actual_Ioctl_1: int, actual_DeviceObject_17: int, actual_Event_7: int, actual_Iosb_1: int, actual_InBuffer: int, actual_InBufferLen: int, actual_OutBuffer: int, actual_OutBufferLen: int) returns (Tmp_222: int)
{
  ...
  anon13_Else:
    assume Event_7 == SLAM_guard_O_0;
    assume SLAM_guard_O_0 != SLAM_guard_O_0_init;
    call {:si_unique_call 368} SLIC_KeClearEvent_entry(strConst__li2bpl2);
    goto L32;

  L32:
    call {:si_unique_call 369} KeClearEvent(Event_7);
    SLAM_guard_O_0 := Event_7;
    assume SLAM_guard_O_0 != 0;
    assume SLAM_guard_O_0 != SLAM_guard_O_0_init;
    call {:si_unique_call 370} irp_5 := IoBuildDeviceIoControlRequest(Ioctl_1, 0, 0, InBufferLen, 0, OutBufferLen, Internal_1, 0, Iosb_1);
    goto anon17_Then, anon17_Else;

  anon17_Else:
    assume Event_7 == SLAM_guard_O_0;
    assume SLAM_guard_O_0 != SLAM_guard_O_0_init;
    call {:si_unique_call 371} SLIC_IoBuildDeviceIoControlRequest_exit(0, irp_5);
    goto L15;
  ...
  anon14_Else:
    assume {:partition} irp_5 != 0;
    call {:si_unique_call 372} status_21 := sdv_IoCallDriver#0(DeviceObject_17, irp_5);
    goto anon18_Then, anon18_Else;
  ...
  anon15_Else:
    ...
    call {:si_unique_call 373} status_21 := KeWaitForSingleObject(0, 0, 0, 0, 0);
    goto anon16_Then, anon16_Else;
...
implementation {:origName "sdv_IoCallDriver"} {:osmodel} sdv_IoCallDriver#0(actual_DeviceObject_10: int, actual_Irp_8: int) returns (Tmp_179: int)
{
  ...
  anon0:
    Irp_8 := actual_Irp_8;
    call {:si_unique_call 374} Tmp_179 := IofCallDriver#0(0, Irp_8);
    goto anon3_Then, anon3_Else;
...
implementation {:origName "sdv_IoCallDriver"} {:osmodel} sdv_IoCallDriver#1(actual_DeviceObject_10: int, actual_Irp_8: int) returns (Tmp_179: int)
{
  ...
  anon0:
    Irp_8 := actual_Irp_8;
    call {:si_unique_call 375} Tmp_179 := IofCallDriver#1(0, Irp_8);
    goto anon3_Then, anon3_Else;
...
implementation {:origName "IofCallDriver"} {:osmodel} IofCallDriver#0(actual_DeviceObject_8: int, actual_Irp_6: int) returns (Tmp_173: int)
{
  ...
  anon0:
    call {:si_unique_call 376} completion_1 := __HAVOC_malloc(4);
    Irp_6 := actual_Irp_6;
  ...
  anon55_Then:
    ...
    call {:si_unique_call 377} vslice_dummy_var_81 := sdv_RunIoCompletionRoutines#0(sdv_p_devobj_fdo, Irp_6, vslice_dummy_var_30, completion_1);
    goto anon76_Then, anon76_Else;
  ...
  anon67_Else:
    ...
    call {:si_unique_call 378} vslice_dummy_var_84 := sdv_RunIoCompletionRoutines#0(sdv_p_devobj_fdo, Irp_6, vslice_dummy_var_31, completion_1);
    goto anon78_Then, anon78_Else;
  ...
  anon59_Else:
    ...
    call {:si_unique_call 379} vslice_dummy_var_82 := sdv_RunIoCompletionRoutines#0(sdv_p_devobj_fdo, Irp_6, vslice_dummy_var_32, completion_1);
    goto anon74_Then, anon74_Else;
  ...
  anon63_Else:
    ...
    call {:si_unique_call 380} vslice_dummy_var_83 := sdv_RunIoCompletionRoutines#0(sdv_p_devobj_fdo, Irp_6, vslice_dummy_var_33, completion_1);
    goto anon72_Then, anon72_Else;
...
implementation {:origName "IofCallDriver"} {:osmodel} IofCallDriver#1(actual_DeviceObject_8: int, actual_Irp_6: int) returns (Tmp_173: int)
{
  ...
  anon0:
    call {:si_unique_call 381} completion_1 := __HAVOC_malloc(4);
    Irp_6 := actual_Irp_6;
    assume {:nonnull} completion_1 != 0;
    assume completion_1 > 0;
    status_16 := 259;
  ...
  anon55_Then:
    ...
    call {:si_unique_call 382} vslice_dummy_var_85 := sdv_RunIoCompletionRoutines#1(sdv_p_devobj_fdo, Irp_6, vslice_dummy_var_34, completion_1);
    goto anon76_Then, anon76_Else;
  ...
  anon67_Else:
    ...
    call {:si_unique_call 383} vslice_dummy_var_88 := sdv_RunIoCompletionRoutines#1(sdv_p_devobj_fdo, Irp_6, vslice_dummy_var_35, completion_1);
    goto anon78_Then, anon78_Else;
  ...
  anon59_Else:
    ...
    call {:si_unique_call 384} vslice_dummy_var_86 := sdv_RunIoCompletionRoutines#1(sdv_p_devobj_fdo, Irp_6, vslice_dummy_var_36, completion_1);
    goto anon74_Then, anon74_Else;
  ...
  anon63_Else:
    ...
    call {:si_unique_call 385} vslice_dummy_var_87 := sdv_RunIoCompletionRoutines#1(sdv_p_devobj_fdo, Irp_6, vslice_dummy_var_37, completion_1);
    goto anon72_Then, anon72_Else;
...
implementation {:origName "sdv_RunIoCompletionRoutines"} {:osmodel} sdv_RunIoCompletionRoutines#0(actual_DeviceObject_9: int, actual_Irp_7: int, actual_Context_6: int, actual_Completion: int) returns (Tmp_175: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 386} irpsp := sdv_IoGetNextIrpStackLocation(Irp_7);
    Status_1 := 0;
    assume {:nonnull} irpsp != 0;
    assume irpsp > 0;
    goto anon20_Then, anon20_Else;
  ...
  anon20_Else:
    call {:si_unique_call 387} Status_1 := SerialMouseCompletionRoutine(DeviceObject_9, Irp_7, Context_6);
    goto anon21_Then, anon21_Else;
  ...
  anon17_Else:
    call {:si_unique_call 388} Status_1 := SerialMouseReadComplete#0(DeviceObject_9, Irp_7, Context_6);
    goto anon22_Then, anon22_Else;
  ...
  anon18_Else:
    call {:si_unique_call 389} Status_1 := SerialMouseReadSerialPortComplete(DeviceObject_9, Irp_7, Context_6);
    goto anon23_Then, anon23_Else;
  ...
  anon19_Else:
    call {:si_unique_call 390} Status_1 := SerialMouseSerialMaskEventComplete#0(DeviceObject_9, Irp_7, Context_6);
    goto anon24_Then, anon24_Else;
...
procedure {:origName "sdv_RunIoCompletionRoutines"} {:osmodel} sdv_RunIoCompletionRoutines#0(actual_DeviceObject_9: int, actual_Irp_7: int, actual_Context_6: int, actual_Completion: int) returns (Tmp_175: int);
  modifies yogi_error, alloc, SignalState, SLAM_guard_O_0;
  free ensures {:va_keep} old(SignalState) == 1 ==> SignalState != 2;
  free ensures {:va_keep} old(SignalState) == 2 ==> SignalState != 1;
  free ensures {:va_keep} old(SignalState) == 0 ==> SignalState != 1;
  free ensures {:va_keep} old(SignalState) == 0 ==> SignalState != 2;
...
implementation {:origName "sdv_RunIoCompletionRoutines"} {:osmodel} sdv_RunIoCompletionRoutines#1(actual_DeviceObject_9: int, actual_Irp_7: int, actual_Context_6: int, actual_Completion: int) returns (Tmp_175: int)
{
  ...
  anon0:
    ...
    Context_6 := actual_Context_6;
    Completion := actual_Completion;
    call {:si_unique_call 391} irpsp := sdv_IoGetNextIrpStackLocation(Irp_7);
    Status_1 := 0;
    assume {:nonnull} irpsp != 0;
    assume irpsp > 0;
    goto anon20_Then, anon20_Else;
  ...
  anon20_Else:
    call {:si_unique_call 392} Status_1 := SerialMouseCompletionRoutine(DeviceObject_9, Irp_7, Context_6);
    goto anon21_Then, anon21_Else;
  ...
  anon17_Else:
    call {:si_unique_call 393} Status_1 := SerialMouseReadComplete#1(DeviceObject_9, Irp_7, Context_6);
    goto anon22_Then, anon22_Else;
  ...
  anon18_Else:
    call {:si_unique_call 394} Status_1 := SerialMouseReadSerialPortComplete(DeviceObject_9, Irp_7, Context_6);
    goto anon23_Then, anon23_Else;
  ...
  anon19_Else:
    call {:si_unique_call 395} Status_1 := SerialMouseSerialMaskEventComplete#1(DeviceObject_9, Irp_7, Context_6);
    goto anon24_Then, anon24_Else;
...
implementation {:origName "SerialMouseReadComplete"} SerialMouseReadComplete#0(actual_DeviceObject_18: int, actual_Irp_10: int, actual_Context_8: int) returns (Tmp_226: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 396} Tmp_230 := __HAVOC_malloc(4);
  ...
  anon38_Else:
    call {:si_unique_call 397} buttonsDelta := corral_nondet();
    goto anon51_Then, anon51_Else;
  ...
  anon39_Else:
    call {:si_unique_call 398} Tmp_227 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_227 != 0;
    assume Tmp_227 > 0;
    call {:si_unique_call 399} sdv_KeRaiseIrql(2, Tmp_227);
    assume {:nonnull} Tmp_227 != 0;
    assume Tmp_227 > 0;
    havoc oldIrql;
    assume {:nonnull} DeviceExtension_19 != 0;
    ...
    assume {:nonnull} DeviceExtension_19 != 0;
    assume DeviceExtension_19 > 0;
    call {:si_unique_call 400} sdv_KeLowerIrql(oldIrql);
    goto L53;
  ...
  anon35_Else:
    ...
    call {:si_unique_call 401} vslice_dummy_var_91 := SerialMouseStartRead#0(DeviceExtension_19);
    goto anon50_Then, anon50_Else;
  ...
  anon46_Then:
    ...
    assume {:nonnull} DeviceExtension_19 != 0;
    assume DeviceExtension_19 > 0;
    call {:si_unique_call 402} vslice_dummy_var_90 := KeSetEvent(StopEvent__DEVICE_EXTENSION(DeviceExtension_19), 0, 0);
    goto L21;
  ...
  L21:
    ...
    call {:si_unique_call 403} vslice_dummy_var_89 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(DeviceExtension_19), vslice_dummy_var_38);
    startRead := 0;
    goto L20;
...
implementation {:origName "SerialMouseReadComplete"} SerialMouseReadComplete#1(actual_DeviceObject_18: int, actual_Irp_10: int, actual_Context_8: int) returns (Tmp_226: int)
{
  ...
  anon0:
    Irp_10 := actual_Irp_10;
    Context_8 := actual_Context_8;
    call {:si_unique_call 404} Tmp_230 := __HAVOC_malloc(4);
    DeviceExtension_19 := Context_8;
    buttonsDelta := 0;
    startRead := 1;
    assume {:nonnull} Irp_10 != 0;
  ...
  anon38_Else:
    call {:si_unique_call 405} buttonsDelta := corral_nondet();
    goto anon51_Then, anon51_Else;
  ...
  anon39_Else:
    call {:si_unique_call 406} Tmp_227 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_227 != 0;
    assume Tmp_227 > 0;
    call {:si_unique_call 407} sdv_KeRaiseIrql(2, Tmp_227);
    assume {:nonnull} Tmp_227 != 0;
    assume Tmp_227 > 0;
    havoc oldIrql;
    assume {:nonnull} DeviceExtension_19 != 0;
    ...
    assume {:nonnull} DeviceExtension_19 != 0;
    assume DeviceExtension_19 > 0;
    call {:si_unique_call 408} sdv_KeLowerIrql(oldIrql);
    goto L53;
  ...
  anon35_Else:
    assume {:partition} startRead != 0;
    call {:si_unique_call 409} vslice_dummy_var_94 := SerialMouseStartRead#1(DeviceExtension_19);
    goto anon50_Then, anon50_Else;
  ...
  anon46_Then:
    ...
    assume {:nonnull} DeviceExtension_19 != 0;
    assume DeviceExtension_19 > 0;
    call {:si_unique_call 410} vslice_dummy_var_93 := KeSetEvent(StopEvent__DEVICE_EXTENSION(DeviceExtension_19), 0, 0);
    goto L21;
  ...
  L21:
    ...
    call {:si_unique_call 411} vslice_dummy_var_92 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(DeviceExtension_19), vslice_dummy_var_39);
    startRead := 0;
    goto L20;
...
implementation {:origName "SerialMouseStartRead"} SerialMouseStartRead#0(actual_DeviceExtension_15: int) returns (Tmp_210: int)
{
  ...
  L13:
    assume {:nonnull} DeviceExtension_15 != 0;
    assume DeviceExtension_15 > 0;
    call {:si_unique_call 412} vslice_dummy_var_95 := KeSetEvent(StopEvent__DEVICE_EXTENSION(DeviceExtension_15), 0, 0);
    assume {:nonnull} DeviceExtension_15 != 0;
    assume DeviceExtension_15 > 0;
    havoc vslice_dummy_var_40;
    call {:si_unique_call 413} vslice_dummy_var_96 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(DeviceExtension_15), vslice_dummy_var_40);
    Tmp_210 := -1073741823;
    goto L1;
  ...
  anon15_Else:
    ...
    assume Tmp_211 > 0;
    call {:si_unique_call 415} sdv_KeAcquireSpinLock(0, Tmp_211);
    assume {:nonnull} Tmp_211 != 0;
    assume Tmp_211 > 0;
    havoc irql;
    assume {:nonnull} DeviceExtension_15 != 0;
  ...
  anon16_Else:
    call {:si_unique_call 416} sdv_KeReleaseSpinLock(0, irql);
    assume {:nonnull} DeviceExtension_15 != 0;
    assume DeviceExtension_15 > 0;
    call {:si_unique_call 417} vslice_dummy_var_97 := KeSetEvent(StopEvent__DEVICE_EXTENSION(DeviceExtension_15), 0, 0);
    assume {:nonnull} DeviceExtension_15 != 0;
    assume DeviceExtension_15 > 0;
    havoc vslice_dummy_var_41;
    call {:si_unique_call 418} vslice_dummy_var_98 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(DeviceExtension_15), vslice_dummy_var_41);
    Tmp_210 := 0;
    goto L1;

  anon16_Then:
    call {:si_unique_call 419} IoReuseIrp(irp_2, 0);
    call {:si_unique_call 420} sdv_KeReleaseSpinLock(0, irql);
    assume {:nonnull} DeviceExtension_15 != 0;
    assume DeviceExtension_15 > 0;
    assume {:nonnull} irp_2 != 0;
    assume irp_2 > 0;
    call {:si_unique_call 421} stack := sdv_IoGetNextIrpStackLocation(irp_2);
    ...
    assume {:nonnull} stack != 0;
    assume stack > 0;
    call {:si_unique_call 422} sdv_IoSetCompletionRoutine(irp_2, li2bplFunctionConstant251, DeviceExtension_15, 1, 1, 1);
    assume {:nonnull} DeviceExtension_15 != 0;
    assume DeviceExtension_15 > 0;
    assume false;
    return;
...
implementation {:origName "SerialMouseStartRead"} SerialMouseStartRead#1(actual_DeviceExtension_15: int) returns (Tmp_210: int)
{
  ...
  L11:
    call {:si_unique_call 423} Tmp_211, status_17, irql, stack := SerialMouseStartRead#1_loop_L11(sdv_118, Tmp_211, irp_2, status_17, irql, stack, DeviceExtension_15);
    goto L11_last;
  ...
  L13:
    assume {:nonnull} DeviceExtension_15 != 0;
    assume DeviceExtension_15 > 0;
    call {:si_unique_call 424} vslice_dummy_var_99 := KeSetEvent(StopEvent__DEVICE_EXTENSION(DeviceExtension_15), 0, 0);
    assume {:nonnull} DeviceExtension_15 != 0;
    assume DeviceExtension_15 > 0;
    havoc vslice_dummy_var_42;
    call {:si_unique_call 425} vslice_dummy_var_100 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(DeviceExtension_15), vslice_dummy_var_42);
    Tmp_210 := -1073741823;
    goto L1;
  ...
  anon15_Else:
    ...
    assume {:nonnull} Tmp_211 != 0;
    assume Tmp_211 > 0;
    call {:si_unique_call 427} sdv_KeAcquireSpinLock(0, Tmp_211);
    assume {:nonnull} Tmp_211 != 0;
    assume Tmp_211 > 0;
    havoc irql;
    assume {:nonnull} DeviceExtension_15 != 0;
  ...
  anon16_Else:
    call {:si_unique_call 428} sdv_KeReleaseSpinLock(0, irql);
    assume {:nonnull} DeviceExtension_15 != 0;
    assume DeviceExtension_15 > 0;
    call {:si_unique_call 429} vslice_dummy_var_101 := KeSetEvent(StopEvent__DEVICE_EXTENSION(DeviceExtension_15), 0, 0);
    assume {:nonnull} DeviceExtension_15 != 0;
    assume DeviceExtension_15 > 0;
    havoc vslice_dummy_var_43;
    call {:si_unique_call 430} vslice_dummy_var_102 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(DeviceExtension_15), vslice_dummy_var_43);
    Tmp_210 := 0;
    goto L1;

  anon16_Then:
    call {:si_unique_call 431} IoReuseIrp(irp_2, 0);
    call {:si_unique_call 432} sdv_KeReleaseSpinLock(0, irql);
    assume {:nonnull} DeviceExtension_15 != 0;
    assume DeviceExtension_15 > 0;
    assume {:nonnull} irp_2 != 0;
    assume irp_2 > 0;
    call {:si_unique_call 433} stack := sdv_IoGetNextIrpStackLocation(irp_2);
    assume {:nonnull} stack != 0;
    assume stack > 0;
    assume {:nonnull} stack != 0;
    assume stack > 0;
    assume {:nonnull} stack != 0;
    assume stack > 0;
    call {:si_unique_call 434} sdv_IoSetCompletionRoutine(irp_2, li2bplFunctionConstant251, DeviceExtension_15, 1, 1, 1);
    assume {:nonnull} DeviceExtension_15 != 0;
    assume DeviceExtension_15 > 0;
    havoc vslice_dummy_var_44;
    call {:si_unique_call 435} status_17 := sdv_IoCallDriver#0(vslice_dummy_var_44, irp_2);
    goto anon18_Then, anon18_Else;
...
implementation {:origName "SerialMouseSerialMaskEventComplete"} SerialMouseSerialMaskEventComplete#0(actual_DeviceObject_1: int, actual_Irp_1: int, actual_Context: int) returns (Tmp_38: int)
{
  ...
  anon14_Else:
    ...
    assume {:nonnull} deviceExtension_1 != 0;
    assume deviceExtension_1 > 0;
    call {:si_unique_call 436} IoInvalidateDeviceState(0);
    goto L12;
  ...
  L12:
    ...
    call {:si_unique_call 437} vslice_dummy_var_103 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(deviceExtension_1), vslice_dummy_var_45);
    Tmp_38 := -1073741802;
    goto LM2;
  ...
  anon13_Else:
    call {:si_unique_call 438} item := IoAllocateWorkItem(0);
    goto anon15_Then, anon15_Else;

  anon15_Else:
    assume {:partition} item != 0;
    call {:si_unique_call 439} status_4 := sdv_IoAcquireRemoveLock(0, 0);
    goto anon16_Then, anon16_Else;

  anon16_Else:
    assume {:partition} status_4 >= 0;
    call {:si_unique_call 440} IoQueueWorkItem#0(item, li2bplFunctionConstant271, 1, item);
    goto anon18_Then, anon18_Else;
...
implementation {:origName "SerialMouseSerialMaskEventComplete"} SerialMouseSerialMaskEventComplete#1(actual_DeviceObject_1: int, actual_Irp_1: int, actual_Context: int) returns (Tmp_38: int)
{
  ...
  anon14_Else:
    ...
    assume {:nonnull} deviceExtension_1 != 0;
    assume deviceExtension_1 > 0;
    call {:si_unique_call 441} IoInvalidateDeviceState(0);
    goto L12;
  ...
  L12:
    ...
    call {:si_unique_call 442} vslice_dummy_var_104 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(deviceExtension_1), vslice_dummy_var_46);
    Tmp_38 := -1073741802;
    goto LM2;
  ...
  anon13_Else:
    call {:si_unique_call 443} item := IoAllocateWorkItem(0);
    goto anon15_Then, anon15_Else;

  anon15_Else:
    assume {:partition} item != 0;
    call {:si_unique_call 444} status_4 := sdv_IoAcquireRemoveLock(0, 0);
    goto anon16_Then, anon16_Else;

  anon16_Else:
    assume {:partition} status_4 >= 0;
    call {:si_unique_call 445} IoQueueWorkItem#1(item, li2bplFunctionConstant271, 1, item);
    goto anon18_Then, anon18_Else;
...
implementation {:origName "IoQueueWorkItem"} {:osmodel} IoQueueWorkItem#0(actual_IoWorkItem_1: int, actual_WorkerRoutine: int, actual_QueueType: int, actual_Context_2: int)
{
  ...
  anon0:
    call {:si_unique_call 446} vslice_dummy_var_105 := __HAVOC_malloc(4);
    WorkerRoutine := actual_WorkerRoutine;
    QueueType := actual_QueueType;
    Context_2 := actual_Context_2;
    call {:si_unique_call 447} sdv_RunIoQueueWorkItems#0(0, WorkerRoutine, QueueType, Context_2);
    goto anon3_Then, anon3_Else;
...
implementation {:origName "IoQueueWorkItem"} {:osmodel} IoQueueWorkItem#1(actual_IoWorkItem_1: int, actual_WorkerRoutine: int, actual_QueueType: int, actual_Context_2: int)
{
  ...
  anon0:
    call {:si_unique_call 448} vslice_dummy_var_106 := __HAVOC_malloc(4);
    WorkerRoutine := actual_WorkerRoutine;
    QueueType := actual_QueueType;
    Context_2 := actual_Context_2;
    call {:si_unique_call 449} sdv_RunIoQueueWorkItems#1(0, WorkerRoutine, QueueType, Context_2);
    goto anon3_Then, anon3_Else;
...
implementation {:origName "sdv_RunIoQueueWorkItems"} {:osmodel} sdv_RunIoQueueWorkItems#0(actual_IoWorkItem_2: int, actual_WorkerRoutine_1: int, actual_QueueType_1: int, actual_Context_3: int)
{
  ...
  anon0:
    call {:si_unique_call 450} vslice_dummy_var_107 := __HAVOC_malloc(4);
  ...
  anon9_Else:
    ...
    call {:si_unique_call 451} SerialMouseSerialMaskEventWorker#0(sdv_p_devobj_fdo, Context_3);
    goto anon11_Then, anon11_Else;
  ...
  anon10_Else:
    ...
    call {:si_unique_call 452} StartDeviceWorker#0(sdv_p_devobj_fdo, Context_3);
    goto anon12_Then, anon12_Else;
...
implementation {:origName "sdv_RunIoQueueWorkItems"} {:osmodel} sdv_RunIoQueueWorkItems#1(actual_IoWorkItem_2: int, actual_WorkerRoutine_1: int, actual_QueueType_1: int, actual_Context_3: int)
{
  ...
  anon0:
    call {:si_unique_call 453} vslice_dummy_var_108 := __HAVOC_malloc(4);
    WorkerRoutine_1 := actual_WorkerRoutine_1;
    Context_3 := actual_Context_3;
    goto anon9_Then, anon9_Else;
  ...
  anon9_Else:
    assume {:partition} WorkerRoutine_1 == li2bplFunctionConstant271;
    call {:si_unique_call 454} SerialMouseSerialMaskEventWorker#1(sdv_p_devobj_fdo, Context_3);
    goto anon11_Then, anon11_Else;
  ...
  anon10_Else:
    assume {:partition} WorkerRoutine_1 == li2bplFunctionConstant193;
    call {:si_unique_call 455} StartDeviceWorker#1(sdv_p_devobj_fdo, Context_3);
    goto anon12_Then, anon12_Else;
...
implementation {:origName "SerialMouseSerialMaskEventWorker"} SerialMouseSerialMaskEventWorker#0(actual_DeviceObject_2: int, actual_Context_1: int)
{
  ...
  anon0:
    call {:si_unique_call 456} bits_1 := __HAVOC_malloc(4);
    call {:si_unique_call 457} iosb_1 := __HAVOC_malloc(12);
    call {:si_unique_call 458} vslice_dummy_var_109 := __HAVOC_malloc(4);
    call {:si_unique_call 459} event_1 := __HAVOC_malloc(156);
  ...
  anon24_Else:
    assume event_1 == SLAM_guard_O_0;
    assume SLAM_guard_O_0 != SLAM_guard_O_0_init;
    call {:si_unique_call 461} SLIC_KeInitializeEvent_entry(0, 0);
    goto L50;

  L50:
    call {:si_unique_call 462} KeInitializeEvent(event_1, 0, 0);
  ...
  anon23_Else:
    ...
    call {:si_unique_call 463} vslice_dummy_var_113 := SerialMousepIoSyncIoctlEx#0(0, 1769576, vslice_dummy_var_47, event_1, iosb_1, 0, 0, bits_1, 4);
    goto anon25_Then, anon25_Else;
  ...
  anon21_Else:
    call {:si_unique_call 464} vslice_dummy_var_112 := SerialMouseSendWaitMaskIrp#0(deviceExtension_2);
    goto anon26_Then, anon26_Else;
  ...
  L20:
    assume {:nonnull} deviceExtension_2 != 0;
    assume deviceExtension_2 > 0;
    call {:si_unique_call 465} vslice_dummy_var_110 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(deviceExtension_2), Item);
    call {:si_unique_call 466} IoFreeWorkItem(0);
    goto LM2;
  ...
  anon21_Then:
    ...
    call {:si_unique_call 467} vslice_dummy_var_111 := SerialMousepIoSyncIoctl#0(1, 3604999, vslice_dummy_var_48, event_1, iosb_1);
    goto anon27_Then, anon27_Else;
  ...
  anon24_Then:
    assume !(event_1 == SLAM_guard_O_0 && SLAM_guard_O_0 != SLAM_guard_O_0_init);
    goto L50;
}
...
implementation {:origName "SerialMouseSerialMaskEventWorker"} SerialMouseSerialMaskEventWorker#1(actual_DeviceObject_2: int, actual_Context_1: int)
{
  ...
  anon0:
    call {:si_unique_call 468} bits_1 := __HAVOC_malloc(4);
    call {:si_unique_call 469} iosb_1 := __HAVOC_malloc(12);
    call {:si_unique_call 470} vslice_dummy_var_114 := __HAVOC_malloc(4);
    call {:si_unique_call 471} event_1 := __HAVOC_malloc(156);
    DeviceObject_2 := actual_DeviceObject_2;
    Context_1 := actual_Context_1;
    assume {:nonnull} DeviceObject_2 != 0;
    assume DeviceObject_2 > 0;
    havoc deviceExtension_2;
    Item := Context_1;
    call {:si_unique_call 472} sdv_do_paged_code_check();
    assume {:nonnull} deviceExtension_2 != 0;
    assume deviceExtension_2 > 0;
    havoc irp_1;
    goto anon24_Then, anon24_Else;
  ...
  anon24_Else:
    assume event_1 == SLAM_guard_O_0;
    assume SLAM_guard_O_0 != SLAM_guard_O_0_init;
    call {:si_unique_call 473} SLIC_KeInitializeEvent_entry(0, 0);
    goto L50;

  L50:
    call {:si_unique_call 474} KeInitializeEvent(event_1, 0, 0);
    assume {:nonnull} irp_1 != 0;
    assume irp_1 > 0;
    goto anon19_Then, anon19_Else;
  ...
  anon23_Else:
    ...
    call {:si_unique_call 475} vslice_dummy_var_118 := SerialMousepIoSyncIoctlEx#1(0, 1769576, vslice_dummy_var_49, event_1, iosb_1, 0, 0, bits_1, 4);
    goto anon25_Then, anon25_Else;
  ...
  anon21_Else:
    call {:si_unique_call 476} vslice_dummy_var_117 := SerialMouseSendWaitMaskIrp#1(deviceExtension_2);
    goto anon26_Then, anon26_Else;
  ...
  L20:
    assume {:nonnull} deviceExtension_2 != 0;
    assume deviceExtension_2 > 0;
    call {:si_unique_call 477} vslice_dummy_var_115 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(deviceExtension_2), Item);
    call {:si_unique_call 478} IoFreeWorkItem(0);
    goto LM2;
  ...
  anon21_Then:
    ...
    call {:si_unique_call 479} vslice_dummy_var_116 := SerialMousepIoSyncIoctl#1(1, 3604999, vslice_dummy_var_50, event_1, iosb_1);
    goto anon27_Then, anon27_Else;
...
implementation {:origName "SerialMouseSendWaitMaskIrp"} SerialMouseSendWaitMaskIrp#1(actual_DeviceExtension_5: int) returns (Tmp_34: int)
{
  ...
  anon0:
    ...
    assume {:nonnull} DeviceExtension_5 != 0;
    assume DeviceExtension_5 > 0;
    call {:si_unique_call 486} status_3 := sdv_IoAcquireRemoveLock(0, 0);
    goto anon5_Then, anon5_Else;

  anon5_Else:
    assume {:partition} status_3 >= 0;
    call {:si_unique_call 487} IoReuseIrp(irp, 0);
    call {:si_unique_call 488} next := sdv_IoGetNextIrpStackLocation(irp);
    assume {:nonnull} next != 0;
    assume next > 0;
    assume {:nonnull} next != 0;
    assume next > 0;
    ...
    assume {:nonnull} irp != 0;
    assume irp > 0;
    call {:si_unique_call 489} sdv_IoSetCompletionRoutine(irp, li2bplFunctionConstant268, DeviceExtension_5, 1, 1, 1);
    assume {:nonnull} DeviceExtension_5 != 0;
    assume DeviceExtension_5 > 0;
    havoc vslice_dummy_var_51;
    call {:si_unique_call 490} Tmp_34 := sdv_IoCallDriver#0(vslice_dummy_var_51, irp);
    goto anon6_Then, anon6_Else;
...
implementation {:origName "StartDeviceWorker"} StartDeviceWorker#0(actual_DeviceObject_25: int, actual_Context_10: int)
{
  ...
  anon0:
    call {:si_unique_call 491} vslice_dummy_var_119 := __HAVOC_malloc(4);
    call {:si_unique_call 492} iosb_15 := __HAVOC_malloc(12);
    call {:si_unique_call 493} event_16 := __HAVOC_malloc(156);
  ...
  anon18_Else:
    ...
    call {:si_unique_call 494} irp_6 := IoAllocateIrp(vslice_dummy_var_52, 0);
    goto anon19_Then, anon19_Else;

  anon19_Else:
    assume {:partition} irp_6 != 0;
    call {:si_unique_call 495} status_38 := SerialMouseStartDevice#0(deviceExtension_7, irp_6, 0);
    goto anon23_Then, anon23_Else;
  ...
  anon21_Else:
    assume event_16 == SLAM_guard_O_0;
    assume SLAM_guard_O_0 != SLAM_guard_O_0_init;
    call {:si_unique_call 496} SLIC_KeInitializeEvent_entry(0, 0);
    goto L48;

  L48:
    call {:si_unique_call 497} KeInitializeEvent(event_16, 1, 0);
    assume {:nonnull} deviceExtension_7 != 0;
    assume deviceExtension_7 > 0;
    havoc vslice_dummy_var_53;
    call {:si_unique_call 498} vslice_dummy_var_120 := SerialMousepIoSyncIoctl#0(1, 3604999, vslice_dummy_var_53, event_16, iosb_15);
    goto anon24_Then, anon24_Else;
  ...
  L26:
    call {:si_unique_call 499} IoFreeIrp(0);
    goto L10;

  L10:
    call {:si_unique_call 500} IoFreeWorkItem(0);
    call {:si_unique_call 501} sdv_ExFreePool(0);
    assume {:nonnull} deviceExtension_7 != 0;
    assume deviceExtension_7 > 0;
    call {:si_unique_call 502} vslice_dummy_var_121 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(deviceExtension_7), deviceExtension_7);
    goto LM2;
  ...
  anon21_Then:
    assume !(event_16 == SLAM_guard_O_0 && SLAM_guard_O_0 != SLAM_guard_O_0_init);
    goto L48;
...
implementation {:origName "StartDeviceWorker"} StartDeviceWorker#1(actual_DeviceObject_25: int, actual_Context_10: int)
{
  ...
  anon0:
    call {:si_unique_call 503} vslice_dummy_var_122 := __HAVOC_malloc(4);
    call {:si_unique_call 504} iosb_15 := __HAVOC_malloc(12);
    call {:si_unique_call 505} event_16 := __HAVOC_malloc(156);
    Context_10 := actual_Context_10;
    WorkItemContext := Context_10;
    assume {:nonnull} WorkItemContext != 0;
    assume WorkItemContext > 0;
  ...
  anon18_Else:
    ...
    call {:si_unique_call 506} irp_6 := IoAllocateIrp(vslice_dummy_var_54, 0);
    goto anon19_Then, anon19_Else;

  anon19_Else:
    assume {:partition} irp_6 != 0;
    call {:si_unique_call 507} status_38 := SerialMouseStartDevice#1(deviceExtension_7, irp_6, 0);
    goto anon23_Then, anon23_Else;
  ...
  anon21_Else:
    assume event_16 == SLAM_guard_O_0;
    assume SLAM_guard_O_0 != SLAM_guard_O_0_init;
    call {:si_unique_call 508} SLIC_KeInitializeEvent_entry(0, 0);
    goto L48;

  L48:
    call {:si_unique_call 509} KeInitializeEvent(event_16, 1, 0);
    assume {:nonnull} deviceExtension_7 != 0;
    assume deviceExtension_7 > 0;
    havoc vslice_dummy_var_55;
    call {:si_unique_call 510} vslice_dummy_var_123 := SerialMousepIoSyncIoctl#1(1, 3604999, vslice_dummy_var_55, event_16, iosb_15);
    goto anon24_Then, anon24_Else;
  ...
  L26:
    call {:si_unique_call 511} IoFreeIrp(0);
    goto L10;

  L10:
    call {:si_unique_call 512} IoFreeWorkItem(0);
    call {:si_unique_call 513} sdv_ExFreePool(0);
    assume {:nonnull} deviceExtension_7 != 0;
    assume deviceExtension_7 > 0;
    call {:si_unique_call 514} vslice_dummy_var_124 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(deviceExtension_7), deviceExtension_7);
    goto LM2;
...
implementation {:origName "SerialMouseStartDevice"} SerialMouseStartDevice#0(actual_DeviceExtension_30: int, actual_Irp_11: int, actual_CloseOnFailure: int) returns (Tmp_305: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 516} status_31 := SerialMouseInitializeDevice#0(DeviceExtension_30);
    goto anon16_Then, anon16_Else;
  ...
  anon13_Else:
    ...
    call {:si_unique_call 517} status_31 := SerialMouseSpinUpRead#0(DeviceExtension_30);
    goto anon17_Then, anon17_Else;
  ...
  anon15_Else:
    ...
    call {:si_unique_call 518} SerialMouseClosePort#0(DeviceExtension_30, Irp_11);
    goto anon18_Then, anon18_Else;

  anon18_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 519} Tmp_306 := __HAVOC_malloc(4);
    assume {:nonnull} DeviceExtension_30 != 0;
    assume DeviceExtension_30 > 0;
    assume {:nonnull} Tmp_306 != 0;
    assume Tmp_306 > 0;
    call {:si_unique_call 520} vslice_dummy_var_125 := sdv_InterlockedDecrement(Tmp_306);
    assume {:nonnull} DeviceExtension_30 != 0;
    assume DeviceExtension_30 > 0;
    assume {:nonnull} Tmp_306 != 0;
    assume Tmp_306 > 0;
...
implementation {:origName "SerialMouseStartDevice"} SerialMouseStartDevice#1(actual_DeviceExtension_30: int, actual_Irp_11: int, actual_CloseOnFailure: int) returns (Tmp_305: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 522} status_31 := SerialMouseInitializeDevice#1(DeviceExtension_30);
    goto anon16_Then, anon16_Else;
  ...
  anon13_Else:
    assume {:partition} status_31 >= 0;
    call {:si_unique_call 523} status_31 := SerialMouseSpinUpRead#1(DeviceExtension_30);
    goto anon17_Then, anon17_Else;
  ...
  anon15_Else:
    assume {:partition} CloseOnFailure != 0;
    call {:si_unique_call 524} SerialMouseClosePort#1(DeviceExtension_30, Irp_11);
    goto anon18_Then, anon18_Else;

  anon18_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 525} Tmp_306 := __HAVOC_malloc(4);
    assume {:nonnull} DeviceExtension_30 != 0;
    assume DeviceExtension_30 > 0;
    assume {:nonnull} Tmp_306 != 0;
    assume Tmp_306 > 0;
    call {:si_unique_call 526} vslice_dummy_var_126 := sdv_InterlockedDecrement(Tmp_306);
    assume {:nonnull} DeviceExtension_30 != 0;
    assume DeviceExtension_30 > 0;
    assume {:nonnull} Tmp_306 != 0;
    assume Tmp_306 > 0;
...
implementation {:origName "SerialMouseInitializeDevice"} SerialMouseInitializeDevice#0(actual_DeviceExtension_32: int) returns (Tmp_309: int)
{
  ...
  anon0:
    call {:si_unique_call 527} iosb_14 := __HAVOC_malloc(12);
    call {:si_unique_call 528} waitMask_1 := __HAVOC_malloc(4);
    call {:si_unique_call 529} event_14 := __HAVOC_malloc(156);
    DeviceExtension_32 := actual_DeviceExtension_32;
    call {:si_unique_call 530} Tmp_314 := __HAVOC_malloc(4);
    call {:si_unique_call 531} dumpData := __HAVOC_malloc(16);
    status_32 := 0;
    dumpCount := 0;
    i_3 := 0;
    goto L14;
  ...
  L14:
    call {:si_unique_call 532} i_3, Tmp_310 := SerialMouseInitializeDevice#0_loop_L14(i_3, Tmp_310, dumpData);
    goto L14_last;
  ...
  anon26_Else:
    assume event_14 == SLAM_guard_O_0;
    assume SLAM_guard_O_0 != SLAM_guard_O_0_init;
    call {:si_unique_call 534} SLIC_KeInitializeEvent_entry(0, 0);
    goto L68;

  L68:
    call {:si_unique_call 535} KeInitializeEvent(event_14, 0, 0);
    assume {:nonnull} DeviceExtension_32 != 0;
    assume DeviceExtension_32 > 0;
    havoc vslice_dummy_var_56;
    call {:si_unique_call 536} vslice_dummy_var_127 := SerialMousepIoSyncIoctlEx#0(0, 1769540, vslice_dummy_var_56, event_14, iosb_14, waitMask_1, 4, 0, 0);
    goto anon27_Then, anon27_Else;

  anon27_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 537} status_32 := SerialMouseInitializeHardware#0(DeviceExtension_32);
    goto anon28_Then, anon28_Else;
  ...
  anon24_Else:
    ...
    call {:si_unique_call 538} sdv_200 := IoAllocateErrorLogEntry(0, Tmp_315);
    errorLogEntry := sdv_200;
    goto anon30_Then, anon30_Else;
  ...
  L57:
    call {:si_unique_call 539} i_3, Tmp_311, Tmp_313, Tmp_314 := SerialMouseInitializeDevice#0_loop_L57(i_3, Tmp_311, Tmp_313, errorLogEntry, Tmp_314, dumpData, dumpCount);
    goto L57_last;
  ...
  anon25_Then:
    ...
    call {:si_unique_call 540} IoWriteErrorLogEntry(0);
    goto L41;
  ...
  L36:
    assume {:nonnull} DeviceExtension_32 != 0;
    assume DeviceExtension_32 > 0;
    call {:si_unique_call 541} SerialMouseStartDetection#0(DeviceExtension_32);
    goto anon29_Then, anon29_Else;
  ...
  anon26_Then:
    assume !(event_14 == SLAM_guard_O_0 && SLAM_guard_O_0 != SLAM_guard_O_0_init);
    goto L68;
}
...
implementation {:origName "SerialMouseInitializeDevice"} SerialMouseInitializeDevice#1(actual_DeviceExtension_32: int) returns (Tmp_309: int)
{
  ...
  anon0:
    call {:si_unique_call 542} iosb_14 := __HAVOC_malloc(12);
    call {:si_unique_call 543} waitMask_1 := __HAVOC_malloc(4);
    call {:si_unique_call 544} event_14 := __HAVOC_malloc(156);
    DeviceExtension_32 := actual_DeviceExtension_32;
    call {:si_unique_call 545} Tmp_314 := __HAVOC_malloc(4);
    call {:si_unique_call 546} dumpData := __HAVOC_malloc(16);
    status_32 := 0;
    dumpCount := 0;
    i_3 := 0;
    goto L14;
  ...
  L14:
    call {:si_unique_call 547} i_3, Tmp_310 := SerialMouseInitializeDevice#1_loop_L14(i_3, Tmp_310, dumpData);
    goto L14_last;
  ...
  anon26_Else:
    assume event_14 == SLAM_guard_O_0;
    assume SLAM_guard_O_0 != SLAM_guard_O_0_init;
    call {:si_unique_call 549} SLIC_KeInitializeEvent_entry(0, 0);
    goto L68;

  L68:
    call {:si_unique_call 550} KeInitializeEvent(event_14, 0, 0);
    assume {:nonnull} DeviceExtension_32 != 0;
    assume DeviceExtension_32 > 0;
    havoc vslice_dummy_var_57;
    call {:si_unique_call 551} vslice_dummy_var_128 := SerialMousepIoSyncIoctlEx#1(0, 1769540, vslice_dummy_var_57, event_14, iosb_14, waitMask_1, 4, 0, 0);
    goto anon27_Then, anon27_Else;

  anon27_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 552} status_32 := SerialMouseInitializeHardware#1(DeviceExtension_32);
    goto anon28_Then, anon28_Else;
  ...
  anon24_Else:
    ...
    assume DeviceExtension_32 > 0;
    Tmp_315 := 48 + dumpCount * 4;
    call {:si_unique_call 553} sdv_200 := IoAllocateErrorLogEntry(0, Tmp_315);
    errorLogEntry := sdv_200;
    goto anon30_Then, anon30_Else;
  ...
  L57:
    call {:si_unique_call 554} i_3, Tmp_311, Tmp_313, Tmp_314 := SerialMouseInitializeDevice#1_loop_L57(i_3, Tmp_311, Tmp_313, errorLogEntry, Tmp_314, dumpData, dumpCount);
    goto L57_last;
  ...
  anon25_Then:
    assume {:partition} i_3 >= dumpCount;
    call {:si_unique_call 555} IoWriteErrorLogEntry(0);
    goto L41;
  ...
  L36:
    assume {:nonnull} DeviceExtension_32 != 0;
    assume DeviceExtension_32 > 0;
    call {:si_unique_call 556} SerialMouseStartDetection#1(DeviceExtension_32);
    goto anon29_Then, anon29_Else;
...
implementation {:origName "SerialMouseInitializeHardware"} SerialMouseInitializeHardware#0(actual_DeviceExtension_27: int) returns (Tmp_260: int)
{
  ...
  anon0:
    call {:si_unique_call 557} hardwareButtons := __HAVOC_malloc(4);
    DeviceExtension_27 := actual_DeviceExtension_27;
    assume {:nonnull} hardwareButtons != 0;
    assume hardwareButtons > 0;
    status_28 := -1073741823;
    call {:si_unique_call 558} sdv_do_paged_code_check();
    call {:si_unique_call 559} sdv_RtlZeroMemory(0, 20);
    call {:si_unique_call 560} mouseType_1 := MSerDetect#0(DeviceExtension_27);
    goto anon38_Then, anon38_Else;
  ...
  anon35_Else:
    ...
    call {:si_unique_call 561} boogieTmp := MSerSetProtocol#0(DeviceExtension_27, 2);
    goto anon46_Then, anon46_Else;
  ...
  anon41_Else:
    ...
    call {:si_unique_call 562} vslice_dummy_var_129 := SerialMouseSetFifo#0(DeviceExtension_27, 0);
    goto anon42_Then, anon42_Else;

  anon42_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 563} vslice_dummy_var_130 := SerialMouseFlushReadBuffer#0(DeviceExtension_27);
    goto anon43_Then, anon43_Else;
  ...
  anon36_Then:
    ...
    assume {:nonnull} DeviceExtension_27 != 0;
    assume DeviceExtension_27 > 0;
    call {:si_unique_call 564} boogieTmp := MSerSetProtocol#0(DeviceExtension_27, 1);
    goto anon45_Then, anon45_Else;
  ...
  anon37_Then:
    ...
    assume {:nonnull} DeviceExtension_27 != 0;
    assume DeviceExtension_27 > 0;
    call {:si_unique_call 565} boogieTmp := MSerSetProtocol#0(DeviceExtension_27, 0);
    goto anon44_Then, anon44_Else;
  ...
  anon39_Then:
    ...
    assume {:nonnull} DeviceExtension_27 != 0;
    assume DeviceExtension_27 > 0;
    call {:si_unique_call 566} boogieTmp := MSerSetProtocol#0(DeviceExtension_27, 0);
    goto anon40_Then, anon40_Else;
  ...
  anon33_Then:
    assume {:partition} mouseType_1 == 0;
    call {:si_unique_call 567} sdv_176 := CSerDetect#0(DeviceExtension_27, hardwareButtons);
    goto anon47_Then, anon47_Else;
  ...
  anon34_Else:
    ...
    assume {:nonnull} DeviceExtension_27 != 0;
    assume DeviceExtension_27 > 0;
    call {:si_unique_call 568} boogieTmp := CSerSetProtocol#0(DeviceExtension_27, 0);
    goto anon48_Then, anon48_Else;
...
implementation {:origName "SerialMouseInitializeHardware"} SerialMouseInitializeHardware#1(actual_DeviceExtension_27: int) returns (Tmp_260: int)
{
  ...
  anon0:
    call {:si_unique_call 569} hardwareButtons := __HAVOC_malloc(4);
    DeviceExtension_27 := actual_DeviceExtension_27;
    assume {:nonnull} hardwareButtons != 0;
    assume hardwareButtons > 0;
    status_28 := -1073741823;
    call {:si_unique_call 570} sdv_do_paged_code_check();
    call {:si_unique_call 571} sdv_RtlZeroMemory(0, 20);
    call {:si_unique_call 572} mouseType_1 := MSerDetect#1(DeviceExtension_27);
    goto anon38_Then, anon38_Else;
  ...
  anon35_Else:
    ...
    assume {:nonnull} DeviceExtension_27 != 0;
    assume DeviceExtension_27 > 0;
    call {:si_unique_call 573} boogieTmp := MSerSetProtocol#1(DeviceExtension_27, 2);
    goto anon46_Then, anon46_Else;
  ...
  anon41_Else:
    assume {:partition} status_28 >= 0;
    call {:si_unique_call 574} vslice_dummy_var_131 := SerialMouseSetFifo#1(DeviceExtension_27, 0);
    goto anon42_Then, anon42_Else;

  anon42_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 575} vslice_dummy_var_132 := SerialMouseFlushReadBuffer#1(DeviceExtension_27);
    goto anon43_Then, anon43_Else;
  ...
  anon36_Then:
    ...
    assume {:nonnull} DeviceExtension_27 != 0;
    assume DeviceExtension_27 > 0;
    call {:si_unique_call 576} boogieTmp := MSerSetProtocol#1(DeviceExtension_27, 1);
    goto anon45_Then, anon45_Else;
  ...
  anon37_Then:
    ...
    assume {:nonnull} DeviceExtension_27 != 0;
    assume DeviceExtension_27 > 0;
    call {:si_unique_call 577} boogieTmp := MSerSetProtocol#1(DeviceExtension_27, 0);
    goto anon44_Then, anon44_Else;
  ...
  anon39_Then:
    ...
    assume {:nonnull} DeviceExtension_27 != 0;
    assume DeviceExtension_27 > 0;
    call {:si_unique_call 578} boogieTmp := MSerSetProtocol#1(DeviceExtension_27, 0);
    goto anon40_Then, anon40_Else;
  ...
  anon33_Then:
    assume {:partition} mouseType_1 == 0;
    call {:si_unique_call 579} sdv_176 := CSerDetect#1(DeviceExtension_27, hardwareButtons);
    goto anon47_Then, anon47_Else;
  ...
  anon34_Else:
    ...
    assume {:nonnull} DeviceExtension_27 != 0;
    assume DeviceExtension_27 > 0;
    call {:si_unique_call 580} boogieTmp := CSerSetProtocol#1(DeviceExtension_27, 0);
    goto anon48_Then, anon48_Else;
...
implementation {:origName "MSerDetect"} MSerDetect#0(actual_DeviceExtension_25: int) returns (Tmp_247: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 581} receiveBuffer := __HAVOC_malloc(1024);
    count_3 := 0;
    mouseType := 0;
    call {:si_unique_call 582} sdv_do_paged_code_check();
    call {:si_unique_call 583} vslice_dummy_var_133 := SerialMouseInitializePort#0(DeviceExtension_25);
    goto anon55_Then, anon55_Else;

  anon55_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 584} vslice_dummy_var_134 := MSerPowerDown#0(DeviceExtension_25);
    goto anon56_Then, anon56_Else;

  anon56_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 585} vslice_dummy_var_135 := SerialMouseSetBaudRate#0(DeviceExtension_25, 1200);
    goto anon57_Then, anon57_Else;

  anon57_Else:
    assume {:partition} yogi_error != 1;
    havoc Tmp_249;
    call {:si_unique_call 586} vslice_dummy_var_141 := SerialMouseSetLineCtrl#0(DeviceExtension_25, Tmp_249);
    goto anon58_Then, anon58_Else;

  anon58_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 587} vslice_dummy_var_136 := SerialMouseFlushReadBuffer#0(DeviceExtension_25);
    goto anon59_Then, anon59_Else;

  anon59_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 588} vslice_dummy_var_137 := MSerPowerUp#0(DeviceExtension_25);
    goto anon60_Then, anon60_Else;

  anon60_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 589} vslice_dummy_var_138 := SerialMouseSetReadTimeouts#0(DeviceExtension_25, 200);
    goto anon61_Then, anon61_Else;
  ...
  anon61_Else:
    ...
    call {:si_unique_call 590} sdv_157 := SerialMouseReadChar#0(DeviceExtension_25, Tmp_256);
    goto anon62_Then, anon62_Else;
  ...
  anon47_Else:
    ...
    count_3 := count_3 + 1;
    call {:si_unique_call 591} vslice_dummy_var_142 := SerialMouseSetReadTimeouts#0(DeviceExtension_25, 100);
    goto anon63_Then, anon63_Else;
  ...
  L53:
    call {:si_unique_call 592} Tmp_248, count_3, Tmp_257, sdv_164 := MSerDetect#0_loop_L53(Tmp_248, count_3, receiveBuffer, Tmp_257, sdv_164, DeviceExtension_25);
    goto L53_last;
  ...
  anon48_Else:
    ...
    call {:si_unique_call 593} sdv_164 := SerialMouseReadChar#0(DeviceExtension_25, Tmp_248);
    goto anon64_Then, anon64_Else;
  ...
  L62:
    call {:si_unique_call 594} i_1 := MSerDetect#0_loop_L62(i_1, count_3);
    goto L62_last;
  ...
  L65:
    call {:si_unique_call 595} i_1, Tmp_250, Tmp_251 := MSerDetect#0_loop_L65(i_1, count_3, Tmp_250, Tmp_251, receiveBuffer);
    goto L65_last;
  ...
  anon54_Else:
    ...
    call {:si_unique_call 596} vslice_dummy_var_139 := SerialMouseWait(DeviceExtension_25, -5000000);
    goto L80;
  ...
  anon53_Else:
    ...
    call {:si_unique_call 597} vslice_dummy_var_140 := SerialMouseSetReadTimeouts#0(DeviceExtension_25, 0);
    goto anon67_Then, anon67_Else;
...
implementation {:origName "MSerDetect"} MSerDetect#1(actual_DeviceExtension_25: int) returns (Tmp_247: int)
{
  ...
  anon0:
    DeviceExtension_25 := actual_DeviceExtension_25;
    call {:si_unique_call 598} receiveBuffer := __HAVOC_malloc(1024);
    count_3 := 0;
    mouseType := 0;
    call {:si_unique_call 599} sdv_do_paged_code_check();
    call {:si_unique_call 600} vslice_dummy_var_143 := SerialMouseInitializePort#1(DeviceExtension_25);
    goto anon55_Then, anon55_Else;

  anon55_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 601} vslice_dummy_var_144 := MSerPowerDown#1(DeviceExtension_25);
    goto anon56_Then, anon56_Else;

  anon56_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 602} vslice_dummy_var_145 := SerialMouseSetBaudRate#1(DeviceExtension_25, 1200);
    goto anon57_Then, anon57_Else;

  anon57_Else:
    assume {:partition} yogi_error != 1;
    havoc Tmp_249;
    call {:si_unique_call 603} vslice_dummy_var_151 := SerialMouseSetLineCtrl#1(DeviceExtension_25, Tmp_249);
    goto anon58_Then, anon58_Else;

  anon58_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 604} vslice_dummy_var_146 := SerialMouseFlushReadBuffer#1(DeviceExtension_25);
    goto anon59_Then, anon59_Else;

  anon59_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 605} vslice_dummy_var_147 := MSerPowerUp#1(DeviceExtension_25);
    goto anon60_Then, anon60_Else;

  anon60_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 606} vslice_dummy_var_148 := SerialMouseSetReadTimeouts#1(DeviceExtension_25, 200);
    goto anon61_Then, anon61_Else;
  ...
  anon61_Else:
    ...
    Tmp_253 := count_3;
    Tmp_256 := receiveBuffer + Tmp_253 * 4;
    call {:si_unique_call 607} sdv_157 := SerialMouseReadChar#1(DeviceExtension_25, Tmp_256);
    goto anon62_Then, anon62_Else;
  ...
  anon47_Else:
    assume {:partition} sdv_157 >= 0;
    count_3 := count_3 + 1;
    call {:si_unique_call 608} vslice_dummy_var_152 := SerialMouseSetReadTimeouts#1(DeviceExtension_25, 100);
    goto anon63_Then, anon63_Else;
  ...
  L53:
    call {:si_unique_call 609} Tmp_248, count_3, Tmp_257, sdv_164 := MSerDetect#1_loop_L53(Tmp_248, count_3, receiveBuffer, Tmp_257, sdv_164, DeviceExtension_25);
    goto L53_last;
  ...
  anon48_Else:
    ...
    Tmp_257 := count_3;
    Tmp_248 := receiveBuffer + Tmp_257 * 4;
    call {:si_unique_call 610} sdv_164 := SerialMouseReadChar#1(DeviceExtension_25, Tmp_248);
    goto anon64_Then, anon64_Else;
  ...
  L62:
    call {:si_unique_call 611} i_1 := MSerDetect#1_loop_L62(i_1, count_3);
    goto L62_last;
  ...
  L65:
    call {:si_unique_call 612} i_1, Tmp_250, Tmp_251 := MSerDetect#1_loop_L65(i_1, count_3, Tmp_250, Tmp_251, receiveBuffer);
    goto L65_last;
  ...
  anon54_Else:
    assume {:partition} count_3 != 0;
    call {:si_unique_call 613} vslice_dummy_var_149 := SerialMouseWait(DeviceExtension_25, -5000000);
    goto L80;
  ...
  anon53_Else:
    assume {:partition} mouseType != 0;
    call {:si_unique_call 614} vslice_dummy_var_150 := SerialMouseSetReadTimeouts#1(DeviceExtension_25, 0);
    goto anon67_Then, anon67_Else;
...
implementation {:origName "SerialMouseInitializePort"} SerialMouseInitializePort#0(actual_DeviceExtension_21: int) returns (Tmp_234: int)
{
  ...
  anon0:
    call {:si_unique_call 615} serialHandFlow := __HAVOC_malloc(16);
    call {:si_unique_call 616} serialTimeouts := __HAVOC_malloc(20);
    call {:si_unique_call 617} iosb_10 := __HAVOC_malloc(12);
    call {:si_unique_call 618} event_10 := __HAVOC_malloc(156);
    DeviceExtension_21 := actual_DeviceExtension_21;
    goto anon15_Then, anon15_Else;

  anon15_Else:
    assume event_10 == SLAM_guard_O_0;
    assume SLAM_guard_O_0 != SLAM_guard_O_0_init;
    call {:si_unique_call 619} SLIC_KeInitializeEvent_entry(0, 0);
    goto L39;

  L39:
    call {:si_unique_call 620} KeInitializeEvent(event_10, 0, 0);
    assume {:nonnull} DeviceExtension_21 != 0;
    assume DeviceExtension_21 > 0;
    havoc vslice_dummy_var_58;
    call {:si_unique_call 621} status_23 := SerialMousepIoSyncIoctlEx#0(1, 1769484, vslice_dummy_var_58, event_10, iosb_10, 0, 0, SerialBasicSettings__DEVICE_EXTENSION(DeviceExtension_21), 44);
    goto anon17_Then, anon17_Else;
  ...
  anon16_Then:
    ...
    call {:si_unique_call 622} vslice_dummy_var_153 := SerialMousepIoSyncIoctlEx#0(0, 1769504, vslice_dummy_var_59, event_10, iosb_10, 0, 0, Timeouts__SERIAL_BASIC_SETTINGS(SerialBasicSettings__DEVICE_EXTENSION(DeviceExtension_21)), 20);
    goto anon18_Then, anon18_Else;

  anon18_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 623} sdv_RtlZeroMemory(0, 20);
    assume {:nonnull} DeviceExtension_21 != 0;
    assume DeviceExtension_21 > 0;
    havoc vslice_dummy_var_60;
    call {:si_unique_call 624} vslice_dummy_var_154 := SerialMousepIoSyncIoctlEx#0(0, 1769500, vslice_dummy_var_60, event_10, iosb_10, serialTimeouts, 20, 0, 0);
    goto anon19_Then, anon19_Else;
  ...
  anon19_Else:
    ...
    call {:si_unique_call 625} vslice_dummy_var_155 := SerialMousepIoSyncIoctlEx#0(0, 1769568, vslice_dummy_var_61, event_10, iosb_10, 0, 0, HandFlow__SERIAL_BASIC_SETTINGS(SerialBasicSettings__DEVICE_EXTENSION(DeviceExtension_21)), 16);
    goto anon20_Then, anon20_Else;
  ...
  anon20_Else:
    ...
    call {:si_unique_call 626} status_23 := SerialMousepIoSyncIoctlEx#0(0, 1769572, vslice_dummy_var_62, event_10, iosb_10, serialHandFlow, 16, 0, 0);
    goto anon21_Then, anon21_Else;
  ...
  anon15_Then:
    assume !(event_10 == SLAM_guard_O_0 && SLAM_guard_O_0 != SLAM_guard_O_0_init);
    goto L39;
}
...
implementation {:origName "SerialMouseInitializePort"} SerialMouseInitializePort#1(actual_DeviceExtension_21: int) returns (Tmp_234: int)
{
  ...
  anon0:
    call {:si_unique_call 627} serialHandFlow := __HAVOC_malloc(16);
    call {:si_unique_call 628} serialTimeouts := __HAVOC_malloc(20);
    call {:si_unique_call 629} iosb_10 := __HAVOC_malloc(12);
    call {:si_unique_call 630} event_10 := __HAVOC_malloc(156);
    DeviceExtension_21 := actual_DeviceExtension_21;
    goto anon15_Then, anon15_Else;
  ...
  anon15_Else:
    assume event_10 == SLAM_guard_O_0;
    assume SLAM_guard_O_0 != SLAM_guard_O_0_init;
    call {:si_unique_call 631} SLIC_KeInitializeEvent_entry(0, 0);
    goto L39;

  L39:
    call {:si_unique_call 632} KeInitializeEvent(event_10, 0, 0);
    assume {:nonnull} DeviceExtension_21 != 0;
    assume DeviceExtension_21 > 0;
    havoc vslice_dummy_var_63;
    call {:si_unique_call 633} status_23 := SerialMousepIoSyncIoctlEx#1(1, 1769484, vslice_dummy_var_63, event_10, iosb_10, 0, 0, SerialBasicSettings__DEVICE_EXTENSION(DeviceExtension_21), 44);
    goto anon17_Then, anon17_Else;
  ...
  anon16_Then:
    ...
    call {:si_unique_call 634} vslice_dummy_var_156 := SerialMousepIoSyncIoctlEx#1(0, 1769504, vslice_dummy_var_64, event_10, iosb_10, 0, 0, Timeouts__SERIAL_BASIC_SETTINGS(SerialBasicSettings__DEVICE_EXTENSION(DeviceExtension_21)), 20);
    goto anon18_Then, anon18_Else;

  anon18_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 635} sdv_RtlZeroMemory(0, 20);
    assume {:nonnull} DeviceExtension_21 != 0;
    assume DeviceExtension_21 > 0;
    havoc vslice_dummy_var_65;
    call {:si_unique_call 636} vslice_dummy_var_157 := SerialMousepIoSyncIoctlEx#1(0, 1769500, vslice_dummy_var_65, event_10, iosb_10, serialTimeouts, 20, 0, 0);
    goto anon19_Then, anon19_Else;
  ...
  anon19_Else:
    ...
    call {:si_unique_call 637} vslice_dummy_var_158 := SerialMousepIoSyncIoctlEx#1(0, 1769568, vslice_dummy_var_66, event_10, iosb_10, 0, 0, HandFlow__SERIAL_BASIC_SETTINGS(SerialBasicSettings__DEVICE_EXTENSION(DeviceExtension_21)), 16);
    goto anon20_Then, anon20_Else;
  ...
  anon20_Else:
    ...
    call {:si_unique_call 638} status_23 := SerialMousepIoSyncIoctlEx#1(0, 1769572, vslice_dummy_var_67, event_10, iosb_10, serialHandFlow, 16, 0, 0);
    goto anon21_Then, anon21_Else;
...
implementation {:origName "MSerPowerDown"} MSerPowerDown#0(actual_DeviceExtension_24: int) returns (Tmp_245: int)
{
  ...
  anon0:
    call {:si_unique_call 639} iosb_12 := __HAVOC_malloc(12);
  ...
  anon13_Else:
    assume event_12 == SLAM_guard_O_0;
    assume SLAM_guard_O_0 != SLAM_guard_O_0_init;
    call {:si_unique_call 642} SLIC_KeInitializeEvent_entry(0, 0);
    goto L32;

  L32:
    call {:si_unique_call 643} KeInitializeEvent(event_12, 0, 0);
    assume {:nonnull} DeviceExtension_24 != 0;
    assume DeviceExtension_24 > 0;
    havoc vslice_dummy_var_68;
    call {:si_unique_call 644} status_25 := SerialMousepIoSyncIoctl#0(0, 1769508, vslice_dummy_var_68, event_12, iosb_12);
    goto anon17_Then, anon17_Else;
  ...
  anon14_Else:
    ...
    call {:si_unique_call 645} status_25 := SerialMousepIoSyncIoctl#0(0, 1769524, vslice_dummy_var_69, event_12, iosb_12);
    goto anon18_Then, anon18_Else;
  ...
  anon15_Else:
    assume {:partition} status_25 >= 0;
    call {:si_unique_call 646} status_25 := SerialMouseWait(DeviceExtension_24, -2000000);
    goto anon16_Then, anon16_Else;
  ...
  anon13_Then:
    assume !(event_12 == SLAM_guard_O_0 && SLAM_guard_O_0 != SLAM_guard_O_0_init);
    goto L32;
}
...
implementation {:origName "MSerPowerDown"} MSerPowerDown#1(actual_DeviceExtension_24: int) returns (Tmp_245: int)
{
  ...
  anon13_Else:
    assume event_12 == SLAM_guard_O_0;
    assume SLAM_guard_O_0 != SLAM_guard_O_0_init;
    call {:si_unique_call 650} SLIC_KeInitializeEvent_entry(0, 0);
    goto L32;

  L32:
    call {:si_unique_call 651} KeInitializeEvent(event_12, 0, 0);
    assume {:nonnull} DeviceExtension_24 != 0;
    assume DeviceExtension_24 > 0;
    havoc vslice_dummy_var_70;
    call {:si_unique_call 652} status_25 := SerialMousepIoSyncIoctl#1(0, 1769508, vslice_dummy_var_70, event_12, iosb_12);
    goto anon17_Then, anon17_Else;
  ...
  anon14_Else:
    ...
    call {:si_unique_call 653} status_25 := SerialMousepIoSyncIoctl#1(0, 1769524, vslice_dummy_var_71, event_12, iosb_12);
    goto anon18_Then, anon18_Else;
  ...
  anon15_Else:
    assume {:partition} status_25 >= 0;
    call {:si_unique_call 654} status_25 := SerialMouseWait(DeviceExtension_24, -2000000);
    goto anon16_Then, anon16_Else;
...
implementation {:origName "SerialMouseSetBaudRate"} SerialMouseSetBaudRate#0(actual_DeviceExtension_9: int, actual_BaudRate_1: int) returns (Tmp_51: int)
{
  ...
  anon0:
    call {:si_unique_call 655} sbr := __HAVOC_malloc(4);
    call {:si_unique_call 656} iosb_3 := __HAVOC_malloc(12);
    call {:si_unique_call 657} event_3 := __HAVOC_malloc(156);
  ...
  anon5_Else:
    assume event_3 == SLAM_guard_O_0;
    assume SLAM_guard_O_0 != SLAM_guard_O_0_init;
    call {:si_unique_call 659} SLIC_KeInitializeEvent_entry(0, 0);
    goto L21;

  L21:
    call {:si_unique_call 660} KeInitializeEvent(event_3, 0, 0);
    assume {:nonnull} sbr != 0;
    assume sbr > 0;
    assume {:nonnull} DeviceExtension_9 != 0;
    assume DeviceExtension_9 > 0;
    havoc vslice_dummy_var_72;
    call {:si_unique_call 661} status_8 := SerialMousepIoSyncIoctlEx#0(0, 1769476, vslice_dummy_var_72, event_3, iosb_3, sbr, 4, 0, 0);
    goto anon6_Then, anon6_Else;
  ...
  anon5_Then:
    assume !(event_3 == SLAM_guard_O_0 && SLAM_guard_O_0 != SLAM_guard_O_0_init);
    goto L21;
}
...
implementation {:origName "SerialMouseSetBaudRate"} SerialMouseSetBaudRate#1(actual_DeviceExtension_9: int, actual_BaudRate_1: int) returns (Tmp_51: int)
{
  ...
  anon0:
    call {:si_unique_call 662} sbr := __HAVOC_malloc(4);
    call {:si_unique_call 663} iosb_3 := __HAVOC_malloc(12);
    call {:si_unique_call 664} event_3 := __HAVOC_malloc(156);
    DeviceExtension_9 := actual_DeviceExtension_9;
    BaudRate_1 := actual_BaudRate_1;
  ...
  anon5_Else:
    assume event_3 == SLAM_guard_O_0;
    assume SLAM_guard_O_0 != SLAM_guard_O_0_init;
    call {:si_unique_call 666} SLIC_KeInitializeEvent_entry(0, 0);
    goto L21;

  L21:
    call {:si_unique_call 667} KeInitializeEvent(event_3, 0, 0);
    assume {:nonnull} sbr != 0;
    assume sbr > 0;
    assume {:nonnull} DeviceExtension_9 != 0;
    assume DeviceExtension_9 > 0;
    havoc vslice_dummy_var_73;
    call {:si_unique_call 668} status_8 := SerialMousepIoSyncIoctlEx#1(0, 1769476, vslice_dummy_var_73, event_3, iosb_3, sbr, 4, 0, 0);
    goto anon6_Then, anon6_Else;
...
implementation {:origName "SerialMouseFlushReadBuffer"} SerialMouseFlushReadBuffer#0(actual_DeviceExtension_12: int) returns (Tmp_59: int)
{
  ...
  anon0:
    call {:si_unique_call 669} bits_3 := __HAVOC_malloc(4);
    call {:si_unique_call 670} iosb_6 := __HAVOC_malloc(12);
    call {:si_unique_call 671} event_4 := __HAVOC_malloc(156);
  ...
  anon5_Else:
    assume event_4 == SLAM_guard_O_0;
    assume SLAM_guard_O_0 != SLAM_guard_O_0_init;
    call {:si_unique_call 672} SLIC_KeInitializeEvent_entry(0, 0);
    goto L18;

  L18:
    call {:si_unique_call 673} KeInitializeEvent(event_4, 0, 0);
    assume {:nonnull} DeviceExtension_12 != 0;
    assume DeviceExtension_12 > 0;
    havoc vslice_dummy_var_74;
    call {:si_unique_call 674} status_11 := SerialMousepIoSyncIoctlEx#0(0, 1769548, vslice_dummy_var_74, event_4, iosb_6, bits_3, 4, 0, 0);
    goto anon6_Then, anon6_Else;
  ...
  anon5_Then:
    assume !(event_4 == SLAM_guard_O_0 && SLAM_guard_O_0 != SLAM_guard_O_0_init);
    goto L18;
}
...
implementation {:origName "SerialMouseFlushReadBuffer"} SerialMouseFlushReadBuffer#1(actual_DeviceExtension_12: int) returns (Tmp_59: int)
{
  ...
  anon0:
    call {:si_unique_call 675} bits_3 := __HAVOC_malloc(4);
    call {:si_unique_call 676} iosb_6 := __HAVOC_malloc(12);
    call {:si_unique_call 677} event_4 := __HAVOC_malloc(156);
    DeviceExtension_12 := actual_DeviceExtension_12;
    assume {:nonnull} bits_3 != 0;
    assume bits_3 > 0;
    goto anon5_Then, anon5_Else;
  ...
  anon5_Else:
    assume event_4 == SLAM_guard_O_0;
    assume SLAM_guard_O_0 != SLAM_guard_O_0_init;
    call {:si_unique_call 678} SLIC_KeInitializeEvent_entry(0, 0);
    goto L18;

  L18:
    call {:si_unique_call 679} KeInitializeEvent(event_4, 0, 0);
    assume {:nonnull} DeviceExtension_12 != 0;
    assume DeviceExtension_12 > 0;
    havoc vslice_dummy_var_75;
    call {:si_unique_call 680} status_11 := SerialMousepIoSyncIoctlEx#1(0, 1769548, vslice_dummy_var_75, event_4, iosb_6, bits_3, 4, 0, 0);
    goto anon6_Then, anon6_Else;
...
implementation {:origName "MSerPowerUp"} MSerPowerUp#0(actual_DeviceExtension_26: int) returns (Tmp_258: int)
{
  ...
  anon0:
    call {:si_unique_call 681} iosb_13 := __HAVOC_malloc(12);
    call {:si_unique_call 682} event_13 := __HAVOC_malloc(156);
    DeviceExtension_26 := actual_DeviceExtension_26;
    call {:si_unique_call 683} sdv_do_paged_code_check();
    goto anon23_Then, anon23_Else;

  anon23_Else:
    assume event_13 == SLAM_guard_O_0;
    assume SLAM_guard_O_0 != SLAM_guard_O_0_init;
    call {:si_unique_call 684} SLIC_KeInitializeEvent_entry(0, 0);
    goto L54;
  ...
  L54:
    ...
    call {:si_unique_call 686} status_27 := SerialMousepIoSyncIoctl#0(0, 1769512, vslice_dummy_var_76, event_13, iosb_13);
    goto anon30_Then, anon30_Else;
  ...
  anon24_Else:
    ...
    call {:si_unique_call 687} status_27 := SerialMousepIoSyncIoctl#0(0, 1769524, vslice_dummy_var_77, event_13, iosb_13);
  ...
  anon25_Else:
    assume {:partition} status_27 >= 0;
    call {:si_unique_call 688} status_27 := SerialMouseWait(DeviceExtension_26, -2000000);
    goto anon26_Then, anon26_Else;
  ...
  anon26_Else:
    ...
    call {:si_unique_call 689} status_27 := SerialMousepIoSyncIoctl#0(0, 1769508, vslice_dummy_var_78, event_13, iosb_13);
  ...
  anon27_Else:
    assume {:partition} status_27 >= 0;
    call {:si_unique_call 690} status_27 := SerialMouseWait(DeviceExtension_26, -2000000);
    goto anon28_Then, anon28_Else;
  ...
  anon28_Else:
    ...
    call {:si_unique_call 691} status_27 := SerialMousepIoSyncIoctl#0(0, 1769520, vslice_dummy_var_79, event_13, iosb_13);
    goto anon33_Then, anon33_Else;

  anon33_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 692} status_27 := SerialMouseWait(DeviceExtension_26, -1750000);
    goto anon29_Then, anon29_Else;
  ...
  anon23_Then:
    assume !(event_13 == SLAM_guard_O_0 && SLAM_guard_O_0 != SLAM_guard_O_0_init);
    goto L54;
}
...
implementation {:origName "MSerPowerUp"} MSerPowerUp#1(actual_DeviceExtension_26: int) returns (Tmp_258: int)
{
  ...
  anon0:
    call {:si_unique_call 693} iosb_13 := __HAVOC_malloc(12);
    call {:si_unique_call 694} event_13 := __HAVOC_malloc(156);
    DeviceExtension_26 := actual_DeviceExtension_26;
  ...
  anon23_Else:
    assume event_13 == SLAM_guard_O_0;
    assume SLAM_guard_O_0 != SLAM_guard_O_0_init;
    call {:si_unique_call 696} SLIC_KeInitializeEvent_entry(0, 0);
    goto L54;
...
implementation {:origName "SerialMouseSetReadTimeouts"} SerialMouseSetReadTimeouts#0(actual_DeviceExtension_22: int, actual_Timeout_2: int) returns (Tmp_236: int)
{
  ...
  anon7_Else:
    assume event_11 == SLAM_guard_O_0;
    assume SLAM_guard_O_0 != SLAM_guard_O_0_init;
    call {:si_unique_call 708} SLIC_KeInitializeEvent_entry(0, 0);
    goto L24;

  L24:
    call {:si_unique_call 709} KeInitializeEvent(event_11, 0, 0);
    call {:si_unique_call 710} sdv_RtlZeroMemory(0, 20);
    goto anon8_Then, anon8_Else;
  ...
  L14:
    ...
    call {:si_unique_call 711} status_24 := SerialMousepIoSyncIoctlEx#0(0, 1769500, vslice_dummy_var_84, event_11, iosb_11, serialTimeouts_1, 20, 0, 0);
    goto anon9_Then, anon9_Else;
  ...
  anon7_Then:
    assume !(event_11 == SLAM_guard_O_0 && SLAM_guard_O_0 != SLAM_guard_O_0_init);
    goto L24;
}
...
implementation {:origName "SerialMouseSetReadTimeouts"} SerialMouseSetReadTimeouts#1(actual_DeviceExtension_22: int, actual_Timeout_2: int) returns (Tmp_236: int)
{
  ...
  anon0:
    call {:si_unique_call 712} serialTimeouts_1 := __HAVOC_malloc(20);
    call {:si_unique_call 713} iosb_11 := __HAVOC_malloc(12);
    call {:si_unique_call 714} event_11 := __HAVOC_malloc(156);
    DeviceExtension_22 := actual_DeviceExtension_22;
    Timeout_2 := actual_Timeout_2;
    goto anon7_Then, anon7_Else;
  ...
  anon7_Else:
    assume event_11 == SLAM_guard_O_0;
    assume SLAM_guard_O_0 != SLAM_guard_O_0_init;
    call {:si_unique_call 715} SLIC_KeInitializeEvent_entry(0, 0);
    goto L24;

  L24:
    call {:si_unique_call 716} KeInitializeEvent(event_11, 0, 0);
    call {:si_unique_call 717} sdv_RtlZeroMemory(0, 20);
    goto anon8_Then, anon8_Else;
  ...
  L14:
    ...
    call {:si_unique_call 718} status_24 := SerialMousepIoSyncIoctlEx#1(0, 1769500, vslice_dummy_var_85, event_11, iosb_11, serialTimeouts_1, 20, 0, 0);
    goto anon9_Then, anon9_Else;
...
implementation {:origName "SerialMouseSetLineCtrl"} SerialMouseSetLineCtrl#0(actual_DeviceExtension_14: int, actual_SerialLineControl: int) returns (Tmp_63: int)
{
  ...
  anon0:
    call {:si_unique_call 719} iosb_8 := __HAVOC_malloc(12);
    call {:si_unique_call 720} event_6 := __HAVOC_malloc(156);
  ...
  anon5_Else:
    assume event_6 == SLAM_guard_O_0;
    assume SLAM_guard_O_0 != SLAM_guard_O_0_init;
    call {:si_unique_call 722} SLIC_KeInitializeEvent_entry(0, 0);
    goto L19;

  L19:
    call {:si_unique_call 723} KeInitializeEvent(event_6, 0, 0);
    assume {:nonnull} DeviceExtension_14 != 0;
    assume DeviceExtension_14 > 0;
    havoc vslice_dummy_var_86;
    call {:si_unique_call 724} status_13 := SerialMousepIoSyncIoctlEx#0(0, 1769484, vslice_dummy_var_86, event_6, iosb_8, SerialLineControl, 3, 0, 0);
    goto anon6_Then, anon6_Else;
  ...
  anon5_Then:
    assume !(event_6 == SLAM_guard_O_0 && SLAM_guard_O_0 != SLAM_guard_O_0_init);
    goto L19;
}
...
implementation {:origName "SerialMouseSetLineCtrl"} SerialMouseSetLineCtrl#1(actual_DeviceExtension_14: int, actual_SerialLineControl: int) returns (Tmp_63: int)
{
  ...
  anon0:
    call {:si_unique_call 725} iosb_8 := __HAVOC_malloc(12);
    call {:si_unique_call 726} event_6 := __HAVOC_malloc(156);
    DeviceExtension_14 := actual_DeviceExtension_14;
    SerialLineControl := actual_SerialLineControl;
  ...
  anon5_Else:
    assume event_6 == SLAM_guard_O_0;
    assume SLAM_guard_O_0 != SLAM_guard_O_0_init;
    call {:si_unique_call 728} SLIC_KeInitializeEvent_entry(0, 0);
    goto L19;

  L19:
    call {:si_unique_call 729} KeInitializeEvent(event_6, 0, 0);
    assume {:nonnull} DeviceExtension_14 != 0;
    assume DeviceExtension_14 > 0;
    havoc vslice_dummy_var_87;
    call {:si_unique_call 730} status_13 := SerialMousepIoSyncIoctlEx#1(0, 1769484, vslice_dummy_var_87, event_6, iosb_8, SerialLineControl, 3, 0, 0);
    goto anon6_Then, anon6_Else;
...
implementation {:origName "SerialMouseReadChar"} SerialMouseReadChar#0(actual_DeviceExtension_8: int, actual_Value: int) returns (Tmp_49: int)
{
  ...
  anon0:
    call {:si_unique_call 731} actual := __HAVOC_malloc(4);
    DeviceExtension_8 := actual_DeviceExtension_8;
    Value := actual_Value;
    call {:si_unique_call 732} sdv_do_paged_code_check();
    call {:si_unique_call 733} status_7 := SerialMouseReadSerialPort#0(DeviceExtension_8, Value, 1, actual);
    goto anon9_Then, anon9_Else;
...
implementation {:origName "SerialMouseReadChar"} SerialMouseReadChar#1(actual_DeviceExtension_8: int, actual_Value: int) returns (Tmp_49: int)
{
  ...
  anon0:
    call {:si_unique_call 734} actual := __HAVOC_malloc(4);
    DeviceExtension_8 := actual_DeviceExtension_8;
    Value := actual_Value;
    call {:si_unique_call 735} sdv_do_paged_code_check();
    call {:si_unique_call 736} status_7 := SerialMouseReadSerialPort#1(DeviceExtension_8, Value, 1, actual);
    goto anon9_Then, anon9_Else;
...
implementation {:origName "SerialMouseReadSerialPort"} SerialMouseReadSerialPort#0(actual_DeviceExtension_18: int, actual_ReadBuffer: int, actual_Buflen: int, actual_ActualBytesRead: int) returns (Tmp_220: int)
{
  ...
  anon0:
    call {:si_unique_call 737} event_9 := __HAVOC_malloc(156);
    ...
    status_20 := 0;
    call {:si_unique_call 738} KeInitializeEvent(event_9, 0, 0);
    goto anon15_Then, anon15_Else;
  ...
  anon16_Else:
    call {:si_unique_call 739} KeClearEvent(event_9);
    call {:si_unique_call 740} IoReuseIrp(irp_4, 0);
    assume {:nonnull} irp_4 != 0;
    assume irp_4 > 0;
    call {:si_unique_call 741} stack_1 := sdv_IoGetNextIrpStackLocation(irp_4);
    ...
    assume {:nonnull} stack_1 != 0;
    assume stack_1 > 0;
    call {:si_unique_call 742} sdv_IoSetCompletionRoutine(irp_4, li2bplFunctionConstant256, event_9, 1, 1, 1);
    assume {:nonnull} DeviceExtension_18 != 0;
    assume DeviceExtension_18 > 0;
    assume false;
    return;
...
implementation {:origName "SerialMouseReadSerialPort"} SerialMouseReadSerialPort#1(actual_DeviceExtension_18: int, actual_ReadBuffer: int, actual_Buflen: int, actual_ActualBytesRead: int) returns (Tmp_220: int)
{
  ...
  anon0:
    call {:si_unique_call 743} event_9 := __HAVOC_malloc(156);
    DeviceExtension_18 := actual_DeviceExtension_18;
    ReadBuffer := actual_ReadBuffer;
    Buflen := actual_Buflen;
    ActualBytesRead := actual_ActualBytesRead;
    status_20 := 0;
    call {:si_unique_call 744} KeInitializeEvent(event_9, 0, 0);
    goto anon15_Then, anon15_Else;
  ...
  L15:
    call {:si_unique_call 745} status_20, stack_1 := SerialMouseReadSerialPort#1_loop_L15(irp_4, status_20, event_9, stack_1, DeviceExtension_18, ReadBuffer, Buflen, ActualBytesRead);
    goto L15_last;
  ...
  anon16_Else:
    call {:si_unique_call 746} KeClearEvent(event_9);
    call {:si_unique_call 747} IoReuseIrp(irp_4, 0);
    assume {:nonnull} irp_4 != 0;
    assume irp_4 > 0;
    call {:si_unique_call 748} stack_1 := sdv_IoGetNextIrpStackLocation(irp_4);
    assume {:nonnull} stack_1 != 0;
    assume stack_1 > 0;
    assume {:nonnull} stack_1 != 0;
    assume stack_1 > 0;
    assume {:nonnull} stack_1 != 0;
    assume stack_1 > 0;
    call {:si_unique_call 749} sdv_IoSetCompletionRoutine(irp_4, li2bplFunctionConstant256, event_9, 1, 1, 1);
    assume {:nonnull} DeviceExtension_18 != 0;
    assume DeviceExtension_18 > 0;
    havoc vslice_dummy_var_88;
    call {:si_unique_call 750} status_20 := sdv_IoCallDriver#0(vslice_dummy_var_88, irp_4);
    goto anon21_Then, anon21_Else;
  ...
  anon17_Else:
    ...
    call {:si_unique_call 751} status_20 := KeWaitForSingleObject(0, 0, 0, 0, 0);
    goto anon19_Then, anon19_Else;
...
implementation {:origName "CSerDetect"} CSerDetect#0(actual_DeviceExtension_3: int, actual_HardwareButtons: int) returns (Tmp_18: int)
{
  ...
  anon0:
    call {:si_unique_call 752} numButtons := __HAVOC_malloc(4);
    call {:si_unique_call 753} status_1 := __HAVOC_malloc(4);
    ...
    call {:si_unique_call 755} vslice_dummy_var_159 := CSerPowerUp#0(DeviceExtension_3);
    goto anon53_Then, anon53_Else;

  anon53_Else:
    assume {:partition} yogi_error != 1;
    havoc Tmp_22;
    call {:si_unique_call 756} vslice_dummy_var_168 := SerialMouseSetLineCtrl#0(DeviceExtension_3, Tmp_22);
    goto anon54_Then, anon54_Else;
  ...
  L20:
    call {:si_unique_call 757} Tmp_19, count_1, Tmp_21, sdv_14, vslice_dummy_var_160, vslice_dummy_var_161, vslice_dummy_var_162, vslice_dummy_var_163, vslice_dummy_var_169 := CSerDetect#0_loop_L20(Tmp_19, count_1, Tmp_21, sdv_14, status_1, DeviceExtension_3, vslice_dummy_var_160, vslice_dummy_var_161, vslice_dummy_var_162, vslice_dummy_var_163, vslice_dummy_var_169);
    goto L20_last;
  ...
  anon47_Else:
    ...
    Tmp_19 := count_1;
    havoc Tmp_21;
    call {:si_unique_call 758} vslice_dummy_var_169 := SerialMouseSetBaudRate#0(DeviceExtension_3, Tmp_21);
    goto anon55_Then, anon55_Else;

  anon55_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 759} CSerSetReportRate#0(DeviceExtension_3, 0);
    goto anon56_Then, anon56_Else;

  anon56_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 760} vslice_dummy_var_160 := CSerSetProtocol#0(DeviceExtension_3, 0);
    goto anon57_Then, anon57_Else;

  anon57_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 761} vslice_dummy_var_161 := SerialMouseWriteChar#0(DeviceExtension_3, 115);
    goto anon58_Then, anon58_Else;

  anon58_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 762} vslice_dummy_var_162 := SerialMouseFlushReadBuffer#0(DeviceExtension_3);
    goto anon59_Then, anon59_Else;

  anon59_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 763} vslice_dummy_var_163 := SerialMouseSetReadTimeouts#0(DeviceExtension_3, 50);
    goto anon60_Then, anon60_Else;

  anon60_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 764} sdv_14 := SerialMouseReadChar#0(DeviceExtension_3, status_1);
    goto anon61_Then, anon61_Else;
  ...
  anon48_Else:
    ...
    call {:si_unique_call 765} vslice_dummy_var_164 := SerialMouseWriteChar#0(DeviceExtension_3, 107);
    goto anon62_Then, anon62_Else;

  anon62_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 766} vslice_dummy_var_165 := SerialMouseFlushReadBuffer#0(DeviceExtension_3);
    goto anon63_Then, anon63_Else;

  anon63_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 767} vslice_dummy_var_166 := SerialMouseSetReadTimeouts#0(DeviceExtension_3, 50);
    goto anon64_Then, anon64_Else;

  anon64_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 768} sdv_9 := SerialMouseReadChar#0(DeviceExtension_3, numButtons);
    goto anon65_Then, anon65_Else;
  ...
  L70:
    call {:si_unique_call 769} vslice_dummy_var_167 := SerialMouseSetReadTimeouts#0(DeviceExtension_3, 0);
    goto anon67_Then, anon67_Else;
  ...
  L49:
    call {:si_unique_call 770} CSerSetBaudRate#0(DeviceExtension_3, 1200);
    goto anon68_Then, anon68_Else;

  anon68_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 771} CSerSetReportRate#0(DeviceExtension_3, 150);
    goto anon69_Then, anon69_Else;
...
implementation {:origName "CSerDetect"} CSerDetect#1(actual_DeviceExtension_3: int, actual_HardwareButtons: int) returns (Tmp_18: int)
{
  ...
  anon0:
    call {:si_unique_call 772} numButtons := __HAVOC_malloc(4);
    call {:si_unique_call 773} status_1 := __HAVOC_malloc(4);
    DeviceExtension_3 := actual_DeviceExtension_3;
    HardwareButtons := actual_HardwareButtons;
    detected := 0;
    assume {:nonnull} status_1 != 0;
    ...
    call {:si_unique_call 775} vslice_dummy_var_170 := CSerPowerUp#1(DeviceExtension_3);
    goto anon53_Then, anon53_Else;

  anon53_Else:
    assume {:partition} yogi_error != 1;
    havoc Tmp_22;
    call {:si_unique_call 776} vslice_dummy_var_179 := SerialMouseSetLineCtrl#1(DeviceExtension_3, Tmp_22);
    goto anon54_Then, anon54_Else;
  ...
  anon47_Else:
    ...
    Tmp_19 := count_1;
    havoc Tmp_21;
    call {:si_unique_call 778} vslice_dummy_var_180 := SerialMouseSetBaudRate#1(DeviceExtension_3, Tmp_21);
    goto anon55_Then, anon55_Else;

  anon55_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 779} CSerSetReportRate#1(DeviceExtension_3, 0);
    goto anon56_Then, anon56_Else;

  anon56_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 780} vslice_dummy_var_171 := CSerSetProtocol#1(DeviceExtension_3, 0);
    goto anon57_Then, anon57_Else;

  anon57_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 781} vslice_dummy_var_172 := SerialMouseWriteChar#1(DeviceExtension_3, 115);
    goto anon58_Then, anon58_Else;

  anon58_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 782} vslice_dummy_var_173 := SerialMouseFlushReadBuffer#1(DeviceExtension_3);
    goto anon59_Then, anon59_Else;

  anon59_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 783} vslice_dummy_var_174 := SerialMouseSetReadTimeouts#1(DeviceExtension_3, 50);
    goto anon60_Then, anon60_Else;

  anon60_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 784} sdv_14 := SerialMouseReadChar#1(DeviceExtension_3, status_1);
    goto anon61_Then, anon61_Else;
  ...
  anon48_Else:
    assume {:partition} detected != 0;
    call {:si_unique_call 785} vslice_dummy_var_175 := SerialMouseWriteChar#1(DeviceExtension_3, 107);
    goto anon62_Then, anon62_Else;

  anon62_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 786} vslice_dummy_var_176 := SerialMouseFlushReadBuffer#1(DeviceExtension_3);
    goto anon63_Then, anon63_Else;

  anon63_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 787} vslice_dummy_var_177 := SerialMouseSetReadTimeouts#1(DeviceExtension_3, 50);
    goto anon64_Then, anon64_Else;

  anon64_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 788} sdv_9 := SerialMouseReadChar#1(DeviceExtension_3, numButtons);
    goto anon65_Then, anon65_Else;
  ...
  L70:
    call {:si_unique_call 789} vslice_dummy_var_178 := SerialMouseSetReadTimeouts#1(DeviceExtension_3, 0);
    goto anon67_Then, anon67_Else;
  ...
  L49:
    call {:si_unique_call 790} CSerSetBaudRate#1(DeviceExtension_3, 1200);
    goto anon68_Then, anon68_Else;

  anon68_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 791} CSerSetReportRate#1(DeviceExtension_3, 150);
    goto anon69_Then, anon69_Else;
...
implementation {:origName "CSerSetReportRate"} CSerSetReportRate#0(actual_DeviceExtension_1: int, actual_ReportRate: int)
{
  ...
  anon0:
    call {:si_unique_call 792} vslice_dummy_var_181 := __HAVOC_malloc(4);
  ...
  L8:
    call {:si_unique_call 794} count, Tmp_7 := CSerSetReportRate#0_loop_L8(count, Tmp_7, ReportRate);
    goto L8_last;
  ...
  anon8_Else:
    Tmp_9 := count;
    havoc Tmp_6;
    call {:si_unique_call 795} vslice_dummy_var_182 := SerialMouseWriteChar#0(DeviceExtension_1, Tmp_6);
    goto anon9_Then, anon9_Else;
...
implementation {:origName "CSerSetReportRate"} CSerSetReportRate#1(actual_DeviceExtension_1: int, actual_ReportRate: int)
{
  ...
  anon0:
    call {:si_unique_call 796} vslice_dummy_var_183 := __HAVOC_malloc(4);
    DeviceExtension_1 := actual_DeviceExtension_1;
    ReportRate := actual_ReportRate;
  ...
  L8:
    call {:si_unique_call 798} count, Tmp_7 := CSerSetReportRate#1_loop_L8(count, Tmp_7, ReportRate);
    goto L8_last;
  ...
  anon8_Else:
    Tmp_9 := count;
    havoc Tmp_6;
    call {:si_unique_call 799} vslice_dummy_var_184 := SerialMouseWriteChar#1(DeviceExtension_1, Tmp_6);
    goto anon9_Then, anon9_Else;
...
implementation {:origName "SerialMouseWriteChar"} SerialMouseWriteChar#0(actual_DeviceExtension_11: int, actual_Value_1: int) returns (Tmp_57: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 803} status_10 := SerialMouseWriteSerialPort#0(DeviceExtension_11, Value_1, 1, iosb_5);
    goto anon3_Then, anon3_Else;
...
implementation {:origName "SerialMouseWriteChar"} SerialMouseWriteChar#1(actual_DeviceExtension_11: int, actual_Value_1: int) returns (Tmp_57: int)
{
  ...
  anon0:
    call {:si_unique_call 804} iosb_5 := __HAVOC_malloc(12);
    DeviceExtension_11 := actual_DeviceExtension_11;
    call {:si_unique_call 805} Value_1 := __HAVOC_malloc(4);
    call {:si_unique_call 806} sdv_do_paged_code_check();
    call {:si_unique_call 807} status_10 := SerialMouseWriteSerialPort#1(DeviceExtension_11, Value_1, 1, iosb_5);
    goto anon3_Then, anon3_Else;
...
implementation {:origName "SerialMouseWriteSerialPort"} SerialMouseWriteSerialPort#1(actual_DeviceExtension_17: int, actual_WriteBuffer: int, actual_NumBytes: int, actual_IoStatusBlock_2: int) returns (Tmp_216: int)
{
  ...
  anon0:
    call {:si_unique_call 812} startingOffset := __HAVOC_malloc(20);
    call {:si_unique_call 813} event_8 := __HAVOC_malloc(156);
    DeviceExtension_17 := actual_DeviceExtension_17;
    NumBytes := actual_NumBytes;
    IoStatusBlock_2 := actual_IoStatusBlock_2;
    assume {:nonnull} startingOffset != 0;
    assume startingOffset > 0;
    call {:si_unique_call 814} KeInitializeEvent(event_8, 0, 0);
    call {:si_unique_call 815} irp_3 := IoBuildSynchronousFsdRequest(4, 0, 0, NumBytes, 0, 0, IoStatusBlock_2);
    goto anon7_Then, anon7_Else;
  ...
  anon7_Else:
    ...
    call {:si_unique_call 816} status_19 := sdv_IoCallDriver#0(vslice_dummy_var_89, irp_3);
    goto anon9_Then, anon9_Else;
  ...
  anon8_Else:
    ...
    call {:si_unique_call 817} vslice_dummy_var_186 := KeWaitForSingleObject(0, 0, 0, 0, 0);
    goto L22;
...
implementation {:origName "CSerSetProtocol"} CSerSetProtocol#0(actual_DeviceExtension_2: int, actual_NewProtocol: int) returns (Tmp_11: int)
{
  ...
  anon0:
    ...
    Tmp_16 := NewProtocol;
    havoc Tmp_12;
    call {:si_unique_call 819} vslice_dummy_var_187 := SerialMouseWriteChar#0(DeviceExtension_2, Tmp_12);
    goto anon5_Then, anon5_Else;
  ...
  anon5_Else:
    ...
    Tmp_15 := NewProtocol;
    havoc Tmp_14;
    call {:si_unique_call 820} vslice_dummy_var_188 := SerialMouseSetLineCtrl#0(DeviceExtension_2, Tmp_14);
    goto anon6_Then, anon6_Else;
...
implementation {:origName "CSerSetProtocol"} CSerSetProtocol#1(actual_DeviceExtension_2: int, actual_NewProtocol: int) returns (Tmp_11: int)
{
  ...
  anon0:
    ...
    Tmp_16 := NewProtocol;
    havoc Tmp_12;
    call {:si_unique_call 822} vslice_dummy_var_189 := SerialMouseWriteChar#1(DeviceExtension_2, Tmp_12);
    goto anon5_Then, anon5_Else;
  ...
  anon5_Else:
    ...
    Tmp_15 := NewProtocol;
    havoc Tmp_14;
    call {:si_unique_call 823} vslice_dummy_var_190 := SerialMouseSetLineCtrl#1(DeviceExtension_2, Tmp_14);
    goto anon6_Then, anon6_Else;
...
implementation {:origName "CSerSetBaudRate"} CSerSetBaudRate#0(actual_DeviceExtension_4: int, actual_BaudRate: int)
{
  ...
  anon0:
    call {:si_unique_call 824} vslice_dummy_var_191 := __HAVOC_malloc(4);
    DeviceExtension_4 := actual_DeviceExtension_4;
    BaudRate := actual_BaudRate;
    call {:si_unique_call 825} sdv_do_paged_code_check();
    call {:si_unique_call 826} CSerSetReportRate#0(DeviceExtension_4, 0);
    goto anon12_Then, anon12_Else;
  ...
  L11:
    call {:si_unique_call 827} count_2, Tmp_27 := CSerSetBaudRate#0_loop_L11(count_2, Tmp_27, BaudRate);
    goto L11_last;
  ...
  anon13_Else:
    Tmp_24 := count_2;
    havoc Tmp_29;
    call {:si_unique_call 828} vslice_dummy_var_193 := SerialMouseWriteString#0(DeviceExtension_4, Tmp_29);
    goto anon14_Then, anon14_Else;
  ...
  anon14_Else:
    ...
    Tmp_23 := count_2;
    havoc Tmp_28;
    call {:si_unique_call 829} vslice_dummy_var_194 := SerialMouseSetBaudRate#0(DeviceExtension_4, Tmp_28);
    goto anon15_Then, anon15_Else;

  anon15_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 830} vslice_dummy_var_192 := SerialMouseWait(DeviceExtension_4, -20000);
    goto L1;
...
implementation {:origName "CSerSetBaudRate"} CSerSetBaudRate#1(actual_DeviceExtension_4: int, actual_BaudRate: int)
{
  ...
  anon0:
    call {:si_unique_call 831} vslice_dummy_var_195 := __HAVOC_malloc(4);
    DeviceExtension_4 := actual_DeviceExtension_4;
    BaudRate := actual_BaudRate;
    call {:si_unique_call 832} sdv_do_paged_code_check();
    call {:si_unique_call 833} CSerSetReportRate#1(DeviceExtension_4, 0);
    goto anon12_Then, anon12_Else;
  ...
  L11:
    call {:si_unique_call 834} count_2, Tmp_27 := CSerSetBaudRate#1_loop_L11(count_2, Tmp_27, BaudRate);
    goto L11_last;
  ...
  anon13_Else:
    Tmp_24 := count_2;
    havoc Tmp_29;
    call {:si_unique_call 835} vslice_dummy_var_197 := SerialMouseWriteString#1(DeviceExtension_4, Tmp_29);
    goto anon14_Then, anon14_Else;
  ...
  anon14_Else:
    ...
    Tmp_23 := count_2;
    havoc Tmp_28;
    call {:si_unique_call 836} vslice_dummy_var_198 := SerialMouseSetBaudRate#1(DeviceExtension_4, Tmp_28);
    goto anon15_Then, anon15_Else;

  anon15_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 837} vslice_dummy_var_196 := SerialMouseWait(DeviceExtension_4, -20000);
    goto L1;
...
implementation {:origName "SerialMouseWriteString"} SerialMouseWriteString#0(actual_DeviceExtension_10: int, actual_Buffer: int) returns (Tmp_53: int)
{
  ...
  anon0:
    call {:si_unique_call 838} iosb_4 := __HAVOC_malloc(12);
    DeviceExtension_10 := actual_DeviceExtension_10;
    Buffer := actual_Buffer;
    call {:si_unique_call 839} sdv_do_paged_code_check();
    call {:si_unique_call 840} status_9 := SerialMouseWriteSerialPort#0(DeviceExtension_10, Buffer, sdv_44, iosb_4);
    goto anon3_Then, anon3_Else;
...
implementation {:origName "SerialMouseWriteString"} SerialMouseWriteString#1(actual_DeviceExtension_10: int, actual_Buffer: int) returns (Tmp_53: int)
{
  ...
  anon0:
    call {:si_unique_call 841} iosb_4 := __HAVOC_malloc(12);
    DeviceExtension_10 := actual_DeviceExtension_10;
    Buffer := actual_Buffer;
    call {:si_unique_call 842} sdv_do_paged_code_check();
    call {:si_unique_call 843} status_9 := SerialMouseWriteSerialPort#1(DeviceExtension_10, Buffer, sdv_44, iosb_4);
    goto anon3_Then, anon3_Else;
...
implementation {:origName "MSerSetProtocol"} MSerSetProtocol#0(actual_DeviceExtension_23: int, actual_NewProtocol_1: int) returns (Tmp_238: int)
{
  ...
  L7:
    ...
    havoc Tmp_240;
    call {:si_unique_call 845} vslice_dummy_var_199 := SerialMouseSetLineCtrl#0(DeviceExtension_23, Tmp_240);
    goto anon6_Then, anon6_Else;
...
implementation {:origName "MSerSetProtocol"} MSerSetProtocol#1(actual_DeviceExtension_23: int, actual_NewProtocol_1: int) returns (Tmp_238: int)
{
  ...
  L7:
    Tmp_242 := NewProtocol_1;
    havoc Tmp_240;
    call {:si_unique_call 847} vslice_dummy_var_200 := SerialMouseSetLineCtrl#1(DeviceExtension_23, Tmp_240);
    goto anon6_Then, anon6_Else;
...
implementation {:origName "SerialMouseSetFifo"} SerialMouseSetFifo#0(actual_DeviceExtension_13: int, actual_Value_2: int) returns (Tmp_61: int)
{
  ...
  anon0:
    call {:si_unique_call 848} fifo := __HAVOC_malloc(4);
    call {:si_unique_call 849} iosb_7 := __HAVOC_malloc(12);
    call {:si_unique_call 850} event_5 := __HAVOC_malloc(156);
  ...
  anon5_Else:
    assume event_5 == SLAM_guard_O_0;
    assume SLAM_guard_O_0 != SLAM_guard_O_0_init;
    call {:si_unique_call 852} SLIC_KeInitializeEvent_entry(0, 0);
    goto L21;

  L21:
    call {:si_unique_call 853} KeInitializeEvent(event_5, 0, 0);
    assume {:nonnull} DeviceExtension_13 != 0;
    assume DeviceExtension_13 > 0;
    havoc vslice_dummy_var_90;
    call {:si_unique_call 854} status_12 := SerialMousepIoSyncIoctlEx#0(0, 1769628, vslice_dummy_var_90, event_5, iosb_7, fifo, 4, 0, 0);
    goto anon6_Then, anon6_Else;
...
implementation {:origName "SerialMouseSetFifo"} SerialMouseSetFifo#1(actual_DeviceExtension_13: int, actual_Value_2: int) returns (Tmp_61: int)
{
  ...
  anon0:
    call {:si_unique_call 855} fifo := __HAVOC_malloc(4);
    call {:si_unique_call 856} iosb_7 := __HAVOC_malloc(12);
    call {:si_unique_call 857} event_5 := __HAVOC_malloc(156);
    DeviceExtension_13 := actual_DeviceExtension_13;
    Value_2 := actual_Value_2;
    assume {:nonnull} fifo != 0;
    assume fifo > 0;
    call {:si_unique_call 858} sdv_do_paged_code_check();
    goto anon5_Then, anon5_Else;

  anon5_Else:
    assume event_5 == SLAM_guard_O_0;
    assume SLAM_guard_O_0 != SLAM_guard_O_0_init;
    call {:si_unique_call 859} SLIC_KeInitializeEvent_entry(0, 0);
    goto L21;
  ...
  L21:
    ...
    call {:si_unique_call 861} status_12 := SerialMousepIoSyncIoctlEx#1(0, 1769628, vslice_dummy_var_91, event_5, iosb_7, fifo, 4, 0, 0);
    goto anon6_Then, anon6_Else;
...
implementation {:origName "SerialMouseStartDetection"} SerialMouseStartDetection#0(actual_DeviceExtension_6: int)
{
  ...
  anon0:
    call {:si_unique_call 862} vslice_dummy_var_201 := __HAVOC_malloc(4);
    call {:si_unique_call 863} bits_2 := __HAVOC_malloc(4);
    call {:si_unique_call 864} iosb_2 := __HAVOC_malloc(12);
    call {:si_unique_call 865} waitMask := __HAVOC_malloc(4);
    call {:si_unique_call 866} event_2 := __HAVOC_malloc(156);
    DeviceExtension_6 := actual_DeviceExtension_6;
    call {:si_unique_call 867} eventBits := __HAVOC_malloc(8);
    call {:si_unique_call 868} statusBits := __HAVOC_malloc(12);
    ...
    assume eventBits > 0;
    call {:si_unique_call 869} sdv_do_paged_code_check();
    assume {:nonnull} DeviceExtension_6 != 0;
    assume DeviceExtension_6 > 0;
    goto anon29_Then, anon29_Else;
  ...
  anon30_Else:
    assume event_2 == SLAM_guard_O_0;
    assume SLAM_guard_O_0 != SLAM_guard_O_0_init;
    call {:si_unique_call 870} SLIC_KeInitializeEvent_entry(0, 0);
    goto L75;

  L75:
    call {:si_unique_call 871} KeInitializeEvent(event_2, 0, 0);
    assume {:nonnull} DeviceExtension_6 != 0;
    assume DeviceExtension_6 > 0;
    goto anon31_Then, anon31_Else;
  ...
  L29:
    ...
    call {:si_unique_call 872} status_6 := SerialMousepIoSyncIoctlEx#0(0, 1769540, vslice_dummy_var_92, event_2, iosb_2, waitMask, 4, 0, 0);
    goto anon37_Then, anon37_Else;
  ...
  L40:
    call {:si_unique_call 873} status_6 := SerialMouseSendWaitMaskIrp#0(DeviceExtension_6);
    goto anon39_Then, anon39_Else;
  ...
  anon33_Then:
    ...
    call {:si_unique_call 874} vslice_dummy_var_202 := IoCancelIrp(0);
    assume {:nonnull} DeviceExtension_6 != 0;
    assume DeviceExtension_6 > 0;
    goto L1;
  ...
  anon38_Then:
    ...
    call {:si_unique_call 875} boogieTmp := IoAllocateIrp(vslice_dummy_var_93, 0);
    assume {:nonnull} DeviceExtension_6 != 0;
    assume DeviceExtension_6 > 0;
    goto anon34_Then, anon34_Else;
  ...
  anon31_Then:
    ...
    call {:si_unique_call 876} status_6 := SerialMousepIoSyncIoctlEx#0(0, 1769576, vslice_dummy_var_94, event_2, iosb_2, 0, 0, bits_2, 4);
    goto anon40_Then, anon40_Else;
  ...
  L62:
    call {:si_unique_call 877} i, Tmp_42, Tmp_45, Tmp_46 := SerialMouseStartDetection#0_loop_L62(i, Tmp_42, bits_2, eventBits, statusBits, Tmp_45, Tmp_46, waitMask);
    goto L62_last;
  ...
  anon30_Then:
    assume !(event_2 == SLAM_guard_O_0 && SLAM_guard_O_0 != SLAM_guard_O_0_init);
    goto L75;
}
...
implementation {:origName "SerialMouseStartDetection"} SerialMouseStartDetection#1(actual_DeviceExtension_6: int)
{
  ...
  anon0:
    call {:si_unique_call 878} vslice_dummy_var_203 := __HAVOC_malloc(4);
    call {:si_unique_call 879} bits_2 := __HAVOC_malloc(4);
    call {:si_unique_call 880} iosb_2 := __HAVOC_malloc(12);
    call {:si_unique_call 881} waitMask := __HAVOC_malloc(4);
    call {:si_unique_call 882} event_2 := __HAVOC_malloc(156);
    DeviceExtension_6 := actual_DeviceExtension_6;
    call {:si_unique_call 883} eventBits := __HAVOC_malloc(8);
    call {:si_unique_call 884} statusBits := __HAVOC_malloc(12);
    assume {:nonnull} bits_2 != 0;
    assume bits_2 > 0;
    assume {:nonnull} statusBits != 0;
    assume statusBits > 0;
  ...
  anon30_Else:
    assume event_2 == SLAM_guard_O_0;
    assume SLAM_guard_O_0 != SLAM_guard_O_0_init;
    call {:si_unique_call 886} SLIC_KeInitializeEvent_entry(0, 0);
    goto L75;

  L75:
    call {:si_unique_call 887} KeInitializeEvent(event_2, 0, 0);
    assume {:nonnull} DeviceExtension_6 != 0;
    assume DeviceExtension_6 > 0;
    goto anon31_Then, anon31_Else;
  ...
  L29:
    ...
    call {:si_unique_call 888} status_6 := SerialMousepIoSyncIoctlEx#1(0, 1769540, vslice_dummy_var_95, event_2, iosb_2, waitMask, 4, 0, 0);
    goto anon37_Then, anon37_Else;
  ...
  L40:
    call {:si_unique_call 889} status_6 := SerialMouseSendWaitMaskIrp#1(DeviceExtension_6);
    goto anon39_Then, anon39_Else;
  ...
  anon33_Then:
    assume {:partition} 0 > status_6;
    call {:si_unique_call 890} vslice_dummy_var_204 := IoCancelIrp(0);
    assume {:nonnull} DeviceExtension_6 != 0;
    assume DeviceExtension_6 > 0;
    goto L1;
  ...
  anon38_Then:
    ...
    call {:si_unique_call 891} boogieTmp := IoAllocateIrp(vslice_dummy_var_96, 0);
    assume {:nonnull} DeviceExtension_6 != 0;
    assume DeviceExtension_6 > 0;
    goto anon34_Then, anon34_Else;
  ...
  anon31_Then:
    ...
    call {:si_unique_call 892} status_6 := SerialMousepIoSyncIoctlEx#1(0, 1769576, vslice_dummy_var_97, event_2, iosb_2, 0, 0, bits_2, 4);
    goto anon40_Then, anon40_Else;
  ...
  L62:
    call {:si_unique_call 893} i, Tmp_42, Tmp_45, Tmp_46 := SerialMouseStartDetection#1_loop_L62(i, Tmp_42, bits_2, eventBits, statusBits, Tmp_45, Tmp_46, waitMask);
    goto L62_last;
...
implementation {:origName "SerialMouseSpinUpRead"} SerialMouseSpinUpRead#0(actual_DeviceExtension_29: int) returns (Tmp_303: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 895} vslice_dummy_var_205 := sdv_IoAcquireRemoveLock(0, 0);
    assume {:nonnull} DeviceExtension_29 != 0;
    assume DeviceExtension_29 > 0;
    call {:si_unique_call 896} status_30 := SerialMouseStartRead#0(DeviceExtension_29);
    goto anon9_Then, anon9_Else;
...
implementation {:origName "SerialMouseSpinUpRead"} SerialMouseSpinUpRead#1(actual_DeviceExtension_29: int) returns (Tmp_303: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 898} vslice_dummy_var_206 := sdv_IoAcquireRemoveLock(0, 0);
    assume {:nonnull} DeviceExtension_29 != 0;
    assume DeviceExtension_29 > 0;
    call {:si_unique_call 899} status_30 := SerialMouseStartRead#1(DeviceExtension_29);
    goto anon9_Then, anon9_Else;
...
implementation {:origName "SerialMouseClosePort"} SerialMouseClosePort#0(actual_DeviceExtension_31: int, actual_Irp_12: int)
{
  ...
  anon0:
    call {:si_unique_call 900} vslice_dummy_var_207 := __HAVOC_malloc(4);
    DeviceExtension_31 := actual_DeviceExtension_31;
    Irp_12 := actual_Irp_12;
    call {:si_unique_call 901} sdv_do_paged_code_check();
    call {:si_unique_call 902} SerialMouseRestorePort#0(DeviceExtension_31);
    goto anon7_Then, anon7_Else;

  anon7_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 903} next_1 := sdv_IoGetNextIrpStackLocation(Irp_12);
    call {:si_unique_call 904} sdv_RtlZeroMemory(0, 36);
    assume {:nonnull} next_1 != 0;
    assume next_1 > 0;
    assume {:nonnull} DeviceExtension_31 != 0;
    assume DeviceExtension_31 > 0;
    havoc vslice_dummy_var_98;
    call {:si_unique_call 905} vslice_dummy_var_208 := SerialMouseSendIrpSynchronously#0(vslice_dummy_var_98, Irp_12, 0);
    goto anon8_Then, anon8_Else;

  anon8_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 906} next_1 := sdv_IoGetNextIrpStackLocation(Irp_12);
    call {:si_unique_call 907} sdv_RtlZeroMemory(0, 36);
    assume {:nonnull} next_1 != 0;
    assume next_1 > 0;
    assume {:nonnull} DeviceExtension_31 != 0;
    assume DeviceExtension_31 > 0;
    havoc vslice_dummy_var_99;
    call {:si_unique_call 908} vslice_dummy_var_209 := SerialMouseSendIrpSynchronously#0(vslice_dummy_var_99, Irp_12, 0);
    goto anon9_Then, anon9_Else;
...
implementation {:origName "SerialMouseClosePort"} SerialMouseClosePort#1(actual_DeviceExtension_31: int, actual_Irp_12: int)
{
  ...
  anon0:
    call {:si_unique_call 909} vslice_dummy_var_210 := __HAVOC_malloc(4);
    DeviceExtension_31 := actual_DeviceExtension_31;
    Irp_12 := actual_Irp_12;
    call {:si_unique_call 910} sdv_do_paged_code_check();
    call {:si_unique_call 911} SerialMouseRestorePort#1(DeviceExtension_31);
    goto anon7_Then, anon7_Else;
  ...
  anon7_Else:
    ...
    call {:si_unique_call 914} vslice_dummy_var_211 := SerialMouseSendIrpSynchronously#1(vslice_dummy_var_100, Irp_12, 0);
    goto anon8_Then, anon8_Else;
  ...
  anon8_Else:
    ...
    call {:si_unique_call 917} vslice_dummy_var_212 := SerialMouseSendIrpSynchronously#1(vslice_dummy_var_101, Irp_12, 0);
    goto anon9_Then, anon9_Else;
...
implementation {:origName "SerialMouseRestorePort"} SerialMouseRestorePort#0(actual_DeviceExtension_16: int)
{
  ...
  anon0:
    call {:si_unique_call 918} vslice_dummy_var_213 := __HAVOC_malloc(4);
    call {:si_unique_call 919} iosb_9 := __HAVOC_malloc(12);
    call {:si_unique_call 920} event_7 := __HAVOC_malloc(156);
  ...
  anon11_Else:
    assume event_7 == SLAM_guard_O_0;
    assume SLAM_guard_O_0 != SLAM_guard_O_0_init;
    call {:si_unique_call 921} SLIC_KeInitializeEvent_entry(0, 0);
    goto L22;

  L22:
    call {:si_unique_call 922} KeInitializeEvent(event_7, 0, 0);
    assume {:nonnull} DeviceExtension_16 != 0;
    assume DeviceExtension_16 > 0;
    havoc vslice_dummy_var_102;
    call {:si_unique_call 923} status_18 := SerialMousepIoSyncIoctlEx#0(1, 1769488, vslice_dummy_var_102, event_7, iosb_9, SerialBasicSettings__DEVICE_EXTENSION(DeviceExtension_16), 44, 0, 0);
    goto anon13_Then, anon13_Else;
  ...
  anon12_Else:
    ...
    call {:si_unique_call 924} vslice_dummy_var_214 := SerialMousepIoSyncIoctlEx#0(0, 1769500, vslice_dummy_var_103, event_7, iosb_9, Timeouts__SERIAL_BASIC_SETTINGS(SerialBasicSettings__DEVICE_EXTENSION(DeviceExtension_16)), 20, 0, 0);
    goto anon14_Then, anon14_Else;
  ...
  anon14_Else:
    ...
    call {:si_unique_call 925} vslice_dummy_var_215 := SerialMousepIoSyncIoctlEx#0(0, 1769572, vslice_dummy_var_104, event_7, iosb_9, HandFlow__SERIAL_BASIC_SETTINGS(SerialBasicSettings__DEVICE_EXTENSION(DeviceExtension_16)), 16, 0, 0);
    goto anon15_Then, anon15_Else;
...
implementation {:origName "SerialMouseRestorePort"} SerialMouseRestorePort#1(actual_DeviceExtension_16: int)
{
  ...
  anon0:
    call {:si_unique_call 926} vslice_dummy_var_216 := __HAVOC_malloc(4);
    call {:si_unique_call 927} iosb_9 := __HAVOC_malloc(12);
    call {:si_unique_call 928} event_7 := __HAVOC_malloc(156);
    DeviceExtension_16 := actual_DeviceExtension_16;
    goto anon11_Then, anon11_Else;
  ...
  anon11_Else:
    assume event_7 == SLAM_guard_O_0;
    assume SLAM_guard_O_0 != SLAM_guard_O_0_init;
    call {:si_unique_call 929} SLIC_KeInitializeEvent_entry(0, 0);
    goto L22;
  ...
  L22:
    ...
    call {:si_unique_call 931} status_18 := SerialMousepIoSyncIoctlEx#1(1, 1769488, vslice_dummy_var_105, event_7, iosb_9, SerialBasicSettings__DEVICE_EXTENSION(DeviceExtension_16), 44, 0, 0);
    goto anon13_Then, anon13_Else;
  ...
  anon12_Else:
    ...
    call {:si_unique_call 932} vslice_dummy_var_217 := SerialMousepIoSyncIoctlEx#1(0, 1769500, vslice_dummy_var_106, event_7, iosb_9, Timeouts__SERIAL_BASIC_SETTINGS(SerialBasicSettings__DEVICE_EXTENSION(DeviceExtension_16)), 20, 0, 0);
    goto anon14_Then, anon14_Else;
  ...
  anon14_Else:
    ...
    call {:si_unique_call 933} vslice_dummy_var_218 := SerialMousepIoSyncIoctlEx#1(0, 1769572, vslice_dummy_var_107, event_7, iosb_9, HandFlow__SERIAL_BASIC_SETTINGS(SerialBasicSettings__DEVICE_EXTENSION(DeviceExtension_16)), 16, 0, 0);
    goto anon15_Then, anon15_Else;
...
implementation {:origName "SerialMouseSendIrpSynchronously"} SerialMouseSendIrpSynchronously#0(actual_DeviceObject_23: int, actual_Irp_17: int, actual_CopyToNext: int) returns (Tmp_329: int)
{
  ...
  L12:
    call {:si_unique_call 938} sdv_IoSetCompletionRoutine(Irp_17, li2bplFunctionConstant188, event_15, 1, 1, 1);
    assume false;
    return;
...
implementation {:origName "SerialMouseSendIrpSynchronously"} SerialMouseSendIrpSynchronously#1(actual_DeviceObject_23: int, actual_Irp_17: int, actual_CopyToNext: int) returns (Tmp_329: int)
{
  ...
  anon0:
    call {:si_unique_call 939} event_15 := __HAVOC_malloc(156);
    DeviceObject_23 := actual_DeviceObject_23;
    Irp_17 := actual_Irp_17;
    CopyToNext := actual_CopyToNext;
    call {:si_unique_call 940} sdv_do_paged_code_check();
    call {:si_unique_call 941} KeInitializeEvent(event_15, 1, 0);
    goto anon7_Then, anon7_Else;

  anon7_Else:
    assume {:partition} CopyToNext != 0;
    call {:si_unique_call 942} sdv_IoCopyCurrentIrpStackLocationToNext(Irp_17);
    goto L12;

  L12:
    call {:si_unique_call 943} sdv_IoSetCompletionRoutine(Irp_17, li2bplFunctionConstant188, event_15, 1, 1, 1);
    call {:si_unique_call 944} status_37 := sdv_IoCallDriver#0(DeviceObject_23, Irp_17);
    goto anon9_Then, anon9_Else;
  ...
  anon8_Else:
    ...
    call {:si_unique_call 945} vslice_dummy_var_220 := KeWaitForSingleObject(0, 0, 0, 0, 0);
...
implementation {:SIextraRecBound 5} SerialMousePnP_loop_L88(in_i_4: int, in_devCaps: int, in_Tmp_344: int, in_Tmp_345: int) returns (out_i_4: int, out_Tmp_344: int, out_Tmp_345: int)
{
  ...
  anon106_Else_dummy:
    call {:si_unique_call 946} {:si_old_unique_call 1} out_i_4, out_Tmp_344, out_Tmp_345 := SerialMousePnP_loop_L88(out_i_4, in_devCaps, out_Tmp_344, out_Tmp_345);
    return;
}
...
implementation SerialMouseStartRead#1_loop_L11(in_sdv_118: int, in_Tmp_211: int, in_irp_2: int, in_status_17: int, in_irql: int, in_stack: int, in_DeviceExtension_15: int) returns (out_Tmp_211: int, out_status_17: int, out_irql: int, out_stack: int)
{
  var vslice_dummy_var_108: int;
  ...
  anon15_Else:
    call {:si_unique_call 952} out_Tmp_211 := __HAVOC_malloc(4);
    assume {:nonnull} out_Tmp_211 != 0;
    assume out_Tmp_211 > 0;
    call {:si_unique_call 953} sdv_KeAcquireSpinLock(0, out_Tmp_211);
    assume {:nonnull} out_Tmp_211 != 0;
    assume out_Tmp_211 > 0;
    havoc out_irql;
    assume {:nonnull} in_DeviceExtension_15 != 0;
  ...
  anon16_Then:
    call {:si_unique_call 947} IoReuseIrp(in_irp_2, 0);
    call {:si_unique_call 948} sdv_KeReleaseSpinLock(0, out_irql);
    assume {:nonnull} in_DeviceExtension_15 != 0;
    assume in_DeviceExtension_15 > 0;
    assume {:nonnull} in_irp_2 != 0;
    assume in_irp_2 > 0;
    call {:si_unique_call 949} out_stack := sdv_IoGetNextIrpStackLocation(in_irp_2);
    ...
    assume {:nonnull} out_stack != 0;
    assume out_stack > 0;
    call {:si_unique_call 950} sdv_IoSetCompletionRoutine(in_irp_2, li2bplFunctionConstant251, in_DeviceExtension_15, 1, 1, 1);
    assume {:nonnull} in_DeviceExtension_15 != 0;
    assume in_DeviceExtension_15 > 0;
    havoc vslice_dummy_var_108;
    call {:si_unique_call 951} out_status_17 := sdv_IoCallDriver#0(vslice_dummy_var_108, in_irp_2);
    goto anon18_Else;
  ...
  anon17_Else:
    assume {:partition} in_sdv_118 == 3;
    goto anon17_Else_dummy;

  anon17_Else_dummy:
    call {:si_unique_call 954} {:si_old_unique_call 1} out_Tmp_211, out_status_17, out_irql, out_stack := SerialMouseStartRead#1_loop_L11(in_sdv_118, out_Tmp_211, in_irp_2, out_status_17, out_irql, out_stack, in_DeviceExtension_15);
    return;
}



procedure {:LoopProcedure} SerialMouseStartRead#1_loop_L11(in_sdv_118: int, in_Tmp_211: int, in_irp_2: int, in_status_17: int, in_irql: int, in_stack: int, in_DeviceExtension_15: int) returns (out_Tmp_211: int, out_status_17: int, out_irql: int, out_stack: int);
  modifies alloc, yogi_error, SignalState, SLAM_guard_O_0;
  free ensures {:va_keep} old(SignalState) == 1 ==> SignalState != 2;
  free ensures {:va_keep} old(SignalState) == 2 ==> SignalState != 1;
  free ensures {:va_keep} old(SignalState) == 0 ==> SignalState != 1;
...
implementation SerialMouseInitializeDevice#0_loop_L57(in_i_3: int, in_Tmp_311: int, in_Tmp_313: int, in_errorLogEntry: int, in_Tmp_314: int, in_dumpData: int, in_dumpCount: int) returns (out_i_3: int, out_Tmp_311: int, out_Tmp_313: int, out_Tmp_314: int)
{
  ...
  anon25_Else_dummy:
    call {:si_unique_call 955} {:si_old_unique_call 1} out_i_3, out_Tmp_311, out_Tmp_313, out_Tmp_314 := SerialMouseInitializeDevice#0_loop_L57(out_i_3, out_Tmp_311, out_Tmp_313, in_errorLogEntry, out_Tmp_314, in_dumpData, in_dumpCount);
    return;
}
...
implementation {:SIextraRecBound 4} SerialMouseInitializeDevice#0_loop_L14(in_i_3: int, in_Tmp_310: int, in_dumpData: int) returns (out_i_3: int, out_Tmp_310: int)
{
  ...
  anon21_Else_dummy:
    call {:si_unique_call 956} {:si_old_unique_call 1} out_i_3, out_Tmp_310 := SerialMouseInitializeDevice#0_loop_L14(out_i_3, out_Tmp_310, in_dumpData);
    return;
}
...
implementation SerialMouseInitializeDevice#1_loop_L57(in_i_3: int, in_Tmp_311: int, in_Tmp_313: int, in_errorLogEntry: int, in_Tmp_314: int, in_dumpData: int, in_dumpCount: int) returns (out_i_3: int, out_Tmp_311: int, out_Tmp_313: int, out_Tmp_314: int)
{
  ...
  anon25_Else_dummy:
    call {:si_unique_call 957} {:si_old_unique_call 1} out_i_3, out_Tmp_311, out_Tmp_313, out_Tmp_314 := SerialMouseInitializeDevice#1_loop_L57(out_i_3, out_Tmp_311, out_Tmp_313, in_errorLogEntry, out_Tmp_314, in_dumpData, in_dumpCount);
    return;
}
...
implementation {:SIextraRecBound 4} SerialMouseInitializeDevice#1_loop_L14(in_i_3: int, in_Tmp_310: int, in_dumpData: int) returns (out_i_3: int, out_Tmp_310: int)
{
  ...
  anon21_Else_dummy:
    call {:si_unique_call 958} {:si_old_unique_call 1} out_i_3, out_Tmp_310 := SerialMouseInitializeDevice#1_loop_L14(out_i_3, out_Tmp_310, in_dumpData);
    return;
}
...
implementation MSerDetect#0_loop_L53(in_Tmp_248: int, in_count_3: int, in_receiveBuffer: int, in_Tmp_257: int, in_sdv_164: int, in_DeviceExtension_25: int) returns (out_Tmp_248: int, out_count_3: int, out_Tmp_257: int, out_sdv_164: int)
{

  entry:
    out_Tmp_248, out_count_3, out_Tmp_257, out_sdv_164 := in_Tmp_248, in_count_3, in_Tmp_257, in_sdv_164;
    goto L53, exit;
  ...
  anon48_Else:
    ...
    call {:si_unique_call 959} out_sdv_164 := SerialMouseReadChar#0(in_DeviceExtension_25, out_Tmp_248);
    goto anon64_Else;
...
procedure {:LoopProcedure} MSerDetect#0_loop_L53(in_Tmp_248: int, in_count_3: int, in_receiveBuffer: int, in_Tmp_257: int, in_sdv_164: int, in_DeviceExtension_25: int) returns (out_Tmp_248: int, out_count_3: int, out_Tmp_257: int, out_sdv_164: int);
  modifies alloc;
...
implementation MSerDetect#1_loop_L53(in_Tmp_248: int, in_count_3: int, in_receiveBuffer: int, in_Tmp_257: int, in_sdv_164: int, in_DeviceExtension_25: int) returns (out_Tmp_248: int, out_count_3: int, out_Tmp_257: int, out_sdv_164: int)
{
  ...
  anon48_Else:
    ...
    out_Tmp_257 := out_count_3;
    out_Tmp_248 := in_receiveBuffer + out_Tmp_257 * 4;
    call {:si_unique_call 960} out_sdv_164 := SerialMouseReadChar#1(in_DeviceExtension_25, out_Tmp_248);
    goto anon64_Else;
  ...
  anon49_Else_dummy:
    call {:si_unique_call 961} {:si_old_unique_call 1} out_Tmp_248, out_count_3, out_Tmp_257, out_sdv_164 := MSerDetect#1_loop_L53(out_Tmp_248, out_count_3, in_receiveBuffer, out_Tmp_257, out_sdv_164, in_DeviceExtension_25);
    return;
}



procedure {:LoopProcedure} MSerDetect#1_loop_L53(in_Tmp_248: int, in_count_3: int, in_receiveBuffer: int, in_Tmp_257: int, in_sdv_164: int, in_DeviceExtension_25: int) returns (out_Tmp_248: int, out_count_3: int, out_Tmp_257: int, out_sdv_164: int);
  modifies alloc, yogi_error, SignalState, SLAM_guard_O_0;
  free ensures {:va_keep} old(SignalState) == 1 ==> SignalState != 2;
  free ensures {:va_keep} old(SignalState) == 2 ==> SignalState != 1;
  free ensures {:va_keep} old(SignalState) == 0 ==> SignalState != 1;
...
implementation SerialMouseReadSerialPort#1_loop_L15(in_irp_4: int, in_status_20: int, in_event_9: int, in_stack_1: int, in_DeviceExtension_18: int, in_ReadBuffer: int, in_Buflen: int, in_ActualBytesRead: int) returns (out_status_20: int, out_stack_1: int)
{
  ...
  anon16_Else:
    call {:si_unique_call 962} KeClearEvent(in_event_9);
    call {:si_unique_call 963} IoReuseIrp(in_irp_4, 0);
    assume {:nonnull} in_irp_4 != 0;
    assume in_irp_4 > 0;
    call {:si_unique_call 964} out_stack_1 := sdv_IoGetNextIrpStackLocation(in_irp_4);
    ...
    assume {:nonnull} out_stack_1 != 0;
    assume out_stack_1 > 0;
    call {:si_unique_call 965} sdv_IoSetCompletionRoutine(in_irp_4, li2bplFunctionConstant256, in_event_9, 1, 1, 1);
    assume {:nonnull} in_DeviceExtension_18 != 0;
    assume in_DeviceExtension_18 > 0;
    havoc vslice_dummy_var_109;
    call {:si_unique_call 966} out_status_20 := sdv_IoCallDriver#0(vslice_dummy_var_109, in_irp_4);
    goto anon21_Else;
  ...
  anon17_Else:
    ...
    call {:si_unique_call 967} out_status_20 := KeWaitForSingleObject(0, 0, 0, 0, 0);
    goto anon19_Then, anon19_Else;
  ...
  anon20_Else_dummy:
    call {:si_unique_call 968} {:si_old_unique_call 1} out_status_20, out_stack_1 := SerialMouseReadSerialPort#1_loop_L15(in_irp_4, out_status_20, in_event_9, out_stack_1, in_DeviceExtension_18, in_ReadBuffer, in_Buflen, in_ActualBytesRead);
    return;
...
implementation CSerDetect#0_loop_L20(in_Tmp_19: int, in_count_1: int, in_Tmp_21: int, in_sdv_14: int, in_status_1: int, in_DeviceExtension_3: int, in_vslice_dummy_var_160: int, in_vslice_dummy_var_161: int, in_vslice_dummy_var_162: int, in_vslice_dummy_var_163: int, in_vslice_dummy_var_169: int) returns (out_Tmp_19: int, out_count_1: int, out_Tmp_21: int, out_sdv_14: int, out_vslice_dummy_var_160: int, out_vslice_dummy_var_161: int, out_vslice_dummy_var_162: int, out_vslice_dummy_var_163: int, out_vslice_dummy_var_169: int)
{
  ...
  anon47_Else:
    ...
    havoc out_Tmp_21;
    call {:si_unique_call 975} out_vslice_dummy_var_169 := SerialMouseSetBaudRate#0(in_DeviceExtension_3, out_Tmp_21);
    goto anon55_Else;

  anon55_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 974} CSerSetReportRate#0(in_DeviceExtension_3, 0);
    goto anon56_Else;

  anon56_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 973} out_vslice_dummy_var_160 := CSerSetProtocol#0(in_DeviceExtension_3, 0);
    goto anon57_Else;

  anon57_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 972} out_vslice_dummy_var_161 := SerialMouseWriteChar#0(in_DeviceExtension_3, 115);
    goto anon58_Else;

  anon58_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 971} out_vslice_dummy_var_162 := SerialMouseFlushReadBuffer#0(in_DeviceExtension_3);
    goto anon59_Else;

  anon59_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 970} out_vslice_dummy_var_163 := SerialMouseSetReadTimeouts#0(in_DeviceExtension_3, 50);
    goto anon60_Else;

  anon60_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 969} out_sdv_14 := SerialMouseReadChar#0(in_DeviceExtension_3, in_status_1);
    goto anon61_Else;
...
implementation CSerDetect#1_loop_L20(in_Tmp_19: int, in_count_1: int, in_Tmp_21: int, in_sdv_14: int, in_status_1: int, in_DeviceExtension_3: int, in_vslice_dummy_var_171: int, in_vslice_dummy_var_172: int, in_vslice_dummy_var_173: int, in_vslice_dummy_var_174: int, in_vslice_dummy_var_180: int) returns (out_Tmp_19: int, out_count_1: int, out_Tmp_21: int, out_sdv_14: int, out_vslice_dummy_var_171: int, out_vslice_dummy_var_172: int, out_vslice_dummy_var_173: int, out_vslice_dummy_var_174: int, out_vslice_dummy_var_180: int)
{
  ...
  anon47_Else:
    ...
    out_Tmp_19 := out_count_1;
    havoc out_Tmp_21;
    call {:si_unique_call 983} out_vslice_dummy_var_180 := SerialMouseSetBaudRate#1(in_DeviceExtension_3, out_Tmp_21);
    goto anon55_Else;

  anon55_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 982} CSerSetReportRate#1(in_DeviceExtension_3, 0);
    goto anon56_Else;

  anon56_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 981} out_vslice_dummy_var_171 := CSerSetProtocol#1(in_DeviceExtension_3, 0);
    goto anon57_Else;

  anon57_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 980} out_vslice_dummy_var_172 := SerialMouseWriteChar#1(in_DeviceExtension_3, 115);
    goto anon58_Else;

  anon58_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 979} out_vslice_dummy_var_173 := SerialMouseFlushReadBuffer#1(in_DeviceExtension_3);
    goto anon59_Else;

  anon59_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 978} out_vslice_dummy_var_174 := SerialMouseSetReadTimeouts#1(in_DeviceExtension_3, 50);
    goto anon60_Else;

  anon60_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 977} out_sdv_14 := SerialMouseReadChar#1(in_DeviceExtension_3, in_status_1);
    goto anon61_Else;
...
implementation SerialMouseStartDetection#0_loop_L62(in_i: int, in_Tmp_42: int, in_bits_2: int, in_eventBits: int, in_statusBits: int, in_Tmp_45: int, in_Tmp_46: int, in_waitMask: int) returns (out_i: int, out_Tmp_42: int, out_Tmp_45: int, out_Tmp_46: int)
{
  ...
  L64_dummy:
    call {:si_unique_call 985} {:si_old_unique_call 1} out_i, out_Tmp_42, out_Tmp_45, out_Tmp_46 := SerialMouseStartDetection#0_loop_L62(out_i, out_Tmp_42, in_bits_2, in_eventBits, in_statusBits, out_Tmp_45, out_Tmp_46, in_waitMask);
    return;
...
implementation SerialMouseStartDetection#1_loop_L62(in_i: int, in_Tmp_42: int, in_bits_2: int, in_eventBits: int, in_statusBits: int, in_Tmp_45: int, in_Tmp_46: int, in_waitMask: int) returns (out_i: int, out_Tmp_42: int, out_Tmp_45: int, out_Tmp_46: int)
{
  ...
  L64_dummy:
    call {:si_unique_call 986} {:si_old_unique_call 1} out_i, out_Tmp_42, out_Tmp_45, out_Tmp_46 := SerialMouseStartDetection#1_loop_L62(out_i, out_Tmp_42, in_bits_2, in_eventBits, in_statusBits, out_Tmp_45, out_Tmp_46, in_waitMask);
    return;
