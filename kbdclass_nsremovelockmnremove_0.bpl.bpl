...
procedure {:origName "sdv_RunAddDevice"} {:osmodel} sdv_RunAddDevice(actual_p1: int, actual_p2: int) returns (Tmp_15: int);
  modifies alloc, sdv_inside_init_entrypoint, Mem_T.PINT4, Mem_T.Length_unnamed_tag_18, Mem_T.MaximumLength__UNICODE_STRING, Mem_T.Buffer__UNICODE_STRING, Mem_T.P_DEVICE_OBJECT, Mem_T.PnP__DEVICE_EXTENSION, Mem_T.InputData__DEVICE_EXTENSION, Mem_T.Status__IO_STATUS_BLOCK, sdv_compFset, sdv_invoke_on_success, sdv_invoke_on_error, sdv_invoke_on_cancel;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);
...
procedure {:origName "sdv_IoSetCancelRoutine"} {:osmodel} sdv_IoSetCancelRoutine(actual_pirp_3: int, actual_CancelRoutine: int) returns (Tmp_27: int);
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);



implementation {:origName "sdv_IoSetCancelRoutine"} {:osmodel} sdv_IoSetCancelRoutine(actual_pirp_3: int, actual_CancelRoutine: int) returns (Tmp_27: int)
{
  var {:scalar} r: int;
...
procedure {:origName "sdv_RtlQueryRegistryValues"} {:osmodel} sdv_RtlQueryRegistryValues(actual_RelativeTo: int, actual_Path: int, actual_QueryTable: int, actual_Context: int, actual_Environment: int) returns (Tmp_33: int);
...
implementation {:origName "sdv_RtlQueryRegistryValues"} {:osmodel} sdv_RtlQueryRegistryValues(actual_RelativeTo: int, actual_Path: int, actual_QueryTable: int, actual_Context: int, actual_Environment: int) returns (Tmp_33: int)
{
...
procedure {:nohoudini} {:origName "sdv_main"} {:osmodel} sdv_main();
  modifies alloc, sdv_inside_init_entrypoint, Mem_T.P_DEVICE_OBJECT, Mem_T.PINT4, Mem_T.MaximumLength__UNICODE_STRING, Mem_T.Buffer__UNICODE_STRING, Mem_T.Length_unnamed_tag_18, Mem_T.PnP__DEVICE_EXTENSION, Mem_T.InputData__DEVICE_EXTENSION, Mem_T.Status__IO_STATUS_BLOCK, sdv_compFset, sdv_invoke_on_success, sdv_invoke_on_error, sdv_invoke_on_cancel, yogi_error;
...
implementation {:origName "sdv_main"} {:osmodel} sdv_main()
{
  ...
  anon0:
    ...
    call {:si_unique_call 16} status_2 := DriverEntry(sdv_driver_object, u);
  ...
  L68:
    assume Tmp_39 != 0;
    call {:si_unique_call 17} status_2 := sdv_RunAddDevice(sdv_driver_object, sdv_p_devobj_pdo);
  ...
  L78:
    ...
    call {:si_unique_call 19} status_2 := sdv_RunSurpriseRemoveDevice(sdv_p_devobj_fdo, sdv_irp);
    call {:si_unique_call 20} status_2 := sdv_RunRemoveDevice(sdv_p_devobj_fdo, sdv_irp);
    goto anon9_Then, anon9_Else;
...
procedure {:origName "IoAllocateErrorLogEntry"} {:osmodel} IoAllocateErrorLogEntry(actual_IoObject: int, actual_EntrySize: int) returns (Tmp_41: int);
  modifies alloc;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);
...
implementation {:origName "IoAllocateErrorLogEntry"} {:osmodel} IoAllocateErrorLogEntry(actual_IoObject: int, actual_EntrySize: int) returns (Tmp_41: int)
{
...
implementation {:origName "PoSetPowerState"} {:osmodel} PoSetPowerState(actual_DeviceObject_2: int, actual_Type: int, actual_structPtr888State: int) returns (structPtr888Tmp: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 23} r_1 := __HAVOC_malloc(8);
...
implementation {:origName "IoWriteErrorLogEntry"} {:osmodel} IoWriteErrorLogEntry(actual_ElEntry: int)
{
  ...
  anon0:
    call {:si_unique_call 25} vslice_dummy_var_10 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "sdv_IoSetCompletionRoutine"} {:osmodel} sdv_IoSetCompletionRoutine(actual_pirp_6: int, actual_CompletionRoutine: int, actual_Context_1: int, actual_InvokeOnSuccess: int, actual_InvokeOnError: int, actual_InvokeOnCancel: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 27} irpSp := sdv_IoGetNextIrpStackLocation(pirp_6);
...
procedure {:origName "IoGetDeviceObjectPointer"} {:osmodel} IoGetDeviceObjectPointer(actual_ObjectName: int, actual_DesiredAccess: int, actual_FileObject: int, actual_DeviceObject_3: int) returns (Tmp_48: int);
  modifies Mem_T.P_DEVICE_OBJECT;
  free ensures {:va_keep} Tmp_48 == -1073741670 || Tmp_48 == -1073741773 || Tmp_48 == -1073741727 || Tmp_48 == -1073741811 || Tmp_48 == -1073741788 || Tmp_48 == 0;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);



implementation {:origName "IoGetDeviceObjectPointer"} {:osmodel} IoGetDeviceObjectPointer(actual_ObjectName: int, actual_DesiredAccess: int, actual_FileObject: int, actual_DeviceObject_3: int) returns (Tmp_48: int)
{
...
procedure {:origName "sdv_RemoveEntryList"} {:osmodel} sdv_RemoveEntryList(actual_Entry: int) returns (Tmp_54: int);
...
implementation {:origName "sdv_RemoveEntryList"} {:osmodel} sdv_RemoveEntryList(actual_Entry: int) returns (Tmp_54: int)
{
...
procedure {:origName "KeWaitForSingleObject"} {:osmodel} KeWaitForSingleObject(actual_Object: int, actual_WaitReason: int, actual_WaitMode: int, actual_Alertable: int, actual_Timeout: int) returns (Tmp_58: int);
  free ensures {:va_keep} Tmp_58 == 258 || Tmp_58 == 0;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);



implementation {:origName "KeWaitForSingleObject"} {:osmodel} KeWaitForSingleObject(actual_Object: int, actual_WaitReason: int, actual_WaitMode: int, actual_Alertable: int, actual_Timeout: int) returns (Tmp_58: int)
{
...
procedure {:origName "KeSetEvent"} {:osmodel} KeSetEvent(actual_Event: int, actual_Increment: int, actual_Wait: int) returns (Tmp_62: int);
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);



implementation {:origName "KeSetEvent"} {:osmodel} KeSetEvent(actual_Event: int, actual_Increment: int, actual_Wait: int) returns (Tmp_62: int)
{
...
procedure {:origName "sdv_IoGetCurrentIrpStackLocation"} {:osmodel} sdv_IoGetCurrentIrpStackLocation(actual_pirp_7: int) returns (Tmp_66: int);
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);



implementation {:origName "sdv_IoGetCurrentIrpStackLocation"} {:osmodel} sdv_IoGetCurrentIrpStackLocation(actual_pirp_7: int) returns (Tmp_66: int)
{
...
procedure {:origName "PoRequestPowerIrp"} {:osmodel} PoRequestPowerIrp(actual_DeviceObject_5: int, actual_MinorFunction: int, actual_structPtr888PowerState: int, actual_CompletionFunction: int, actual_Context_2: int, actual_Irp_1: int) returns (Tmp_72: int);
  modifies alloc, Mem_T.Status__IO_STATUS_BLOCK;
  free ensures {:va_keep} Tmp_72 == -1073741584 || Tmp_72 == 259 || Tmp_72 == -1073741670;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);



implementation {:origName "PoRequestPowerIrp"} {:osmodel} PoRequestPowerIrp(actual_DeviceObject_5: int, actual_MinorFunction: int, actual_structPtr888PowerState: int, actual_CompletionFunction: int, actual_Context_2: int, actual_Irp_1: int) returns (Tmp_72: int)
{
  ...
  anon0:
    call {:si_unique_call 34} PowerState := __HAVOC_malloc(8);
...
procedure {:nohoudini} {:origName "main"} {:osmodel} {:entrypoint} main() returns (Tmp_74: int, dup_assertVar: bool);
  modifies alloc, sdv_inside_init_entrypoint, sdv_invoke_on_success, sdv_invoke_on_error, sdv_invoke_on_cancel, sdv_compFset, Mem_T.DeviceExtension__DEVICE_OBJECT, yogi_error, Mem_T.P_DEVICE_OBJECT, Mem_T.PINT4, Mem_T.MaximumLength__UNICODE_STRING, Mem_T.Buffer__UNICODE_STRING, Mem_T.Length_unnamed_tag_18, Mem_T.PnP__DEVICE_EXTENSION, Mem_T.InputData__DEVICE_EXTENSION, Mem_T.Status__IO_STATUS_BLOCK;
  free ensures {:va_keep} yogi_error == 1;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);
...
implementation {:origName "main"} {:osmodel} main() returns (Tmp_74: int, dup_assertVar: bool)
{
  ...
  anon0:
    ...
    call {:si_unique_call 50} sdv_harnessStackLocation__Loc := __HAVOC_malloc_or_null(536);
    ...
    call {:si_unique_call 197} MSNdis_StatusProtocolBind_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_StatusProtocolBind_GUID__Loc == MSNdis_StatusProtocolBind_GUID;
    assume MSNdis_StatusProtocolBind_GUID != 0;
    call {:si_unique_call 198} MSNdis_TokenRingCurrentFunctional_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 199} GUID_PCC_INTERFACE_STANDARD__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_PCC_INTERFACE_STANDARD__Loc == GUID_PCC_INTERFACE_STANDARD;
    assume GUID_PCC_INTERFACE_STANDARD != 0;
    call {:si_unique_call 200} GUID_DEVINTERFACE_KEYBOARD__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_DEVINTERFACE_KEYBOARD__Loc == GUID_DEVINTERFACE_KEYBOARD;
    assume GUID_DEVINTERFACE_KEYBOARD != 0;
    call {:si_unique_call 201} GUID_BUS_INTERFACE_STANDARD__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_BUS_INTERFACE_STANDARD__Loc == GUID_BUS_INTERFACE_STANDARD;
    assume GUID_BUS_INTERFACE_STANDARD != 0;
    call {:si_unique_call 202} MSNdis_FddiFramesLost_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_FddiFramesLost_GUID__Loc == MSNdis_FddiFramesLost_GUID;
    assume MSNdis_FddiFramesLost_GUID != 0;
    call {:si_unique_call 203} GUID_DEVICE_LID__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_DEVICE_LID__Loc == GUID_DEVICE_LID;
    assume GUID_DEVICE_LID != 0;
    call {:si_unique_call 204} MSNdis_InterruptModerationParameters_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 205} KernelIdleStates_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume KernelIdleStates_GUID__Loc == KernelIdleStates_GUID;
    assume KernelIdleStates_GUID != 0;
    call {:si_unique_call 206} MSNdis_PMCapabilitiesParam_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_PMCapabilitiesParam_GUID__Loc == MSNdis_PMCapabilitiesParam_GUID;
    assume MSNdis_PMCapabilitiesParam_GUID != 0;
    call {:si_unique_call 207} MSVerifierIrpLogInformation_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSVerifierIrpLogInformation_GUID__Loc == MSVerifierIrpLogInformation_GUID;
    assume MSVerifierIrpLogInformation_GUID != 0;
    call {:si_unique_call 208} MSNdis_WmiTcpLargeSendOffloadV1_IPv4_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 209} MSNdis_HardwareStatus_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_HardwareStatus_GUID__Loc == MSNdis_HardwareStatus_GUID;
    assume MSNdis_HardwareStatus_GUID != 0;
    call {:si_unique_call 210} MSNdis_WmiTcpLargeSendOffloadV2_IPv4_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 211} MSNdis_PMAdminConfigParam_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_PMAdminConfigParam_GUID__Loc == MSNdis_PMAdminConfigParam_GUID;
    assume MSNdis_PMAdminConfigParam_GUID != 0;
    call {:si_unique_call 212} MSNdis_EthernetReceiveErrorAlignment_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 213} MSNdis_80211_TransmitPowerLevel_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 214} WmiMonitorBrightnessEvent_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume WmiMonitorBrightnessEvent_GUID__Loc == WmiMonitorBrightnessEvent_GUID;
    assume WmiMonitorBrightnessEvent_GUID != 0;
    call {:si_unique_call 215} GUID_ACPI_INTERFACE_STANDARD2__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_ACPI_INTERFACE_STANDARD2__Loc == GUID_ACPI_INTERFACE_STANDARD2;
    assume GUID_ACPI_INTERFACE_STANDARD2 != 0;
    call {:si_unique_call 216} MSNdis_80211_BaseServiceSetIdentifier_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 224} KernelPerfStates_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume KernelPerfStates_GUID__Loc == KernelPerfStates_GUID;
    assume KernelPerfStates_GUID != 0;
    call {:si_unique_call 225} GUID_POWER_DEVICE_TIMEOUTS__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 472} MSSmBios_SMBiosEventlog_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSSmBios_SMBiosEventlog_GUID__Loc == MSSmBios_SMBiosEventlog_GUID;
    assume MSSmBios_SMBiosEventlog_GUID != 0;
    call {:si_unique_call 473} MSNdis_PhysicalMediumType_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_PhysicalMediumType_GUID__Loc == MSNdis_PhysicalMediumType_GUID;
    assume MSNdis_PhysicalMediumType_GUID != 0;
    call {:si_unique_call 474} MSNdis_80211_PowerMode_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_80211_PowerMode_GUID__Loc == MSNdis_80211_PowerMode_GUID;
    assume MSNdis_80211_PowerMode_GUID != 0;
    call {:si_unique_call 475} MSNdis_StatusDot11AssociationStart_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 476} MSNdis_QueryPciDeviceCustomProperty_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 477} MSNdis_80211_ReceivedSignalStrength_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 478} MSSerial_CommProperties_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSSerial_CommProperties_GUID__Loc == MSSerial_CommProperties_GUID;
    assume MSSerial_CommProperties_GUID != 0;
    call {:si_unique_call 479} MSNdis_ReceiveError_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume MSNdis_ReceiveError_GUID__Loc == MSNdis_ReceiveError_GUID;
    assume MSNdis_ReceiveError_GUID != 0;
    call {:si_unique_call 480} MSNdis_80211_InfrastructureMode_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 481} MSNdis_80211_ReceiveAntennaSelected_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 482} MSNdis_StatusTaskOffloadChange_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 483} MSNdis_StatusDot11PhyStateChange_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 484} MSStorageDriver_FailurePredictThresholds_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 485} GUID_BUS_TYPE_USB__Loc := __HAVOC_malloc_or_null(16);
    assume GUID_BUS_TYPE_USB__Loc == GUID_BUS_TYPE_USB;
    assume GUID_BUS_TYPE_USB != 0;
    call {:si_unique_call 486} FrequencyRangeDescriptor_GUID__Loc := __HAVOC_malloc_or_null(16);
    assume FrequencyRangeDescriptor_GUID__Loc == FrequencyRangeDescriptor_GUID;
    assume FrequencyRangeDescriptor_GUID != 0;
    call {:si_unique_call 487} KeyboardClassGuid__Loc := __HAVOC_malloc_or_null(16);
    assume KeyboardClassGuid__Loc == KeyboardClassGuid;
    assume KeyboardClassGuid != 0;
    call {:si_unique_call 488} Globals__Loc := __HAVOC_malloc_or_null(648);
    ...
    call {:si_unique_call 510} MSNdis_FddiLongMulticastList_GUID__Loc := __HAVOC_malloc_or_null(16);
    ...
    call {:si_unique_call 521} boogieTmp := __HAVOC_malloc_or_null(240);
    assume sicrni == boogieTmp;
    call {:si_unique_call 522} boogieTmp := __HAVOC_malloc_or_null(12);
    call {:si_unique_call 523} vslice_dummy_var_1124 := __HAVOC_malloc(24);
    assume {:mainInitDone} true;
    call {:si_unique_call 524} corralExtraInit();
    call {:si_unique_call 525} corralExplainErrorInit();
    call {:si_unique_call 526} _sdv_init4();
    call {:si_unique_call 527} _sdv_init1();
    call {:si_unique_call 528} _sdv_init2();
    goto anon9_Then, anon9_Else;
  ...
  L31:
    ...
    call {:si_unique_call 529} sdv_main();
    goto anon12_Then, anon12_Else;
...
implementation {:origName "IoRegisterDriverReinitialization"} {:osmodel} IoRegisterDriverReinitialization(actual_DriverObject_1: int, actual_DriverReinitializationRoutine: int, actual_Context_3: int)
{
  ...
  anon0:
    call {:si_unique_call 530} vslice_dummy_var_18 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "sdv_IoSkipCurrentIrpStackLocation"} {:osmodel} sdv_IoSkipCurrentIrpStackLocation(actual_pirp_8: int)
{
  ...
  anon0:
    call {:si_unique_call 531} vslice_dummy_var_19 := __HAVOC_malloc(4);
...
procedure {:origName "IoCancelIrp"} {:osmodel} IoCancelIrp(actual_Irp_2: int) returns (Tmp_82: int);
  free ensures {:va_keep} Tmp_82 == 0 || Tmp_82 == 1;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);



implementation {:origName "IoCancelIrp"} {:osmodel} IoCancelIrp(actual_Irp_2: int) returns (Tmp_82: int)
{
...
procedure {:origName "sdv_RunRemoveDevice"} {:osmodel} sdv_RunRemoveDevice(actual_po_1: int, actual_pirp_9: int) returns (Tmp_84: int);
  modifies alloc, Mem_T.Status__IO_STATUS_BLOCK, sdv_compFset, sdv_invoke_on_success, sdv_invoke_on_error, sdv_invoke_on_cancel, Mem_T.Buffer__UNICODE_STRING, Mem_T.Length_unnamed_tag_18, Mem_T.MaximumLength__UNICODE_STRING, Mem_T.P_DEVICE_OBJECT, yogi_error;
  free ensures {:va_keep} yogi_error == 1;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);
...
implementation {:origName "sdv_RunRemoveDevice"} {:osmodel} sdv_RunRemoveDevice(actual_po_1: int, actual_pirp_9: int) returns (Tmp_84: int)
{
  ...
  anon0:
    ...
    assume {:nonnull} ps_1 != 0;
    assume ps_1 > 0;
    call {:si_unique_call 532} sdv_stub_dispatch_begin();
    call {:si_unique_call 533} sdv_SetStatus(pirp_9);
    call {:si_unique_call 534} status_4 := KeyboardPnP(po_1, pirp_9);
    call {:si_unique_call 535} sdv_stub_dispatch_end(status_4, 0);
    Tmp_84 := status_4;
    call {:si_unique_call 536} SLIC_sdv_RunRemoveDevice_exit(strConst__li2bpl0, pirp_9, Tmp_84);
    goto anon3_Then, anon3_Else;
...
procedure {:origName "IoAttachDeviceToDeviceStack"} {:osmodel} IoAttachDeviceToDeviceStack(actual_SourceDevice: int, actual_TargetDevice_1: int) returns (Tmp_90: int);
  free ensures {:va_keep} Tmp_90 == 0 || Tmp_90 == actual_TargetDevice_1;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);



implementation {:origName "IoAttachDeviceToDeviceStack"} {:osmodel} IoAttachDeviceToDeviceStack(actual_SourceDevice: int, actual_TargetDevice_1: int) returns (Tmp_90: int)
{
...
procedure {:origName "IoRegisterDeviceInterface"} {:osmodel} IoRegisterDeviceInterface(actual_PhysicalDeviceObject: int, actual_InterfaceClassGuid: int, actual_ReferenceString: int, actual_SymbolicLinkName: int) returns (Tmp_100: int);
  free ensures {:va_keep} Tmp_100 == -1073741823 || Tmp_100 == -1073741808 || Tmp_100 == 0;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);



implementation {:origName "IoRegisterDeviceInterface"} {:osmodel} IoRegisterDeviceInterface(actual_PhysicalDeviceObject: int, actual_InterfaceClassGuid: int, actual_ReferenceString: int, actual_SymbolicLinkName: int) returns (Tmp_100: int)
{
...
procedure {:origName "IoRegisterPlugPlayNotification"} {:osmodel} IoRegisterPlugPlayNotification(actual_EventCategory: int, actual_EventCategoryFlags: int, actual_EventCategoryData: int, actual_DriverObject_2: int, actual_CallbackRoutine: int, actual_Context_4: int, actual_NotificationEntry_1: int) returns (Tmp_103: int);
...
implementation {:origName "sdv_KeReleaseSpinLock"} {:osmodel} sdv_KeReleaseSpinLock(actual_SpinLock_1: int, actual_new: int)
{
  ...
  anon0:
    call {:si_unique_call 543} vslice_dummy_var_26 := __HAVOC_malloc(4);
    new := actual_new;
    return;
}
...
procedure {:origName "ZwQueryValueKey"} {:osmodel} ZwQueryValueKey(actual_KeyHandle: int, actual_ValueName: int, actual_KeyValueInformationClass: int, actual_KeyValueInformation: int, actual_Length_3: int, actual_ResultLength_1: int) returns (Tmp_111: int);
...
implementation {:origName "ZwQueryValueKey"} {:osmodel} ZwQueryValueKey(actual_KeyHandle: int, actual_ValueName: int, actual_KeyValueInformationClass: int, actual_KeyValueInformation: int, actual_Length_3: int, actual_ResultLength_1: int) returns (Tmp_111: int)
{
  var {:scalar} L_1: int;
...
procedure {:origName "sdv_IoAcquireRemoveLock"} {:osmodel} sdv_IoAcquireRemoveLock(actual_RemoveLock_1: int, actual_Tag_1: int) returns (Tmp_117: int);
  free ensures {:va_keep} Tmp_117 == -1073741823 || Tmp_117 == -1073741738 || Tmp_117 == 0;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);



implementation {:origName "sdv_IoAcquireRemoveLock"} {:osmodel} sdv_IoAcquireRemoveLock(actual_RemoveLock_1: int, actual_Tag_1: int) returns (Tmp_117: int)
{
  ...
  L1:
    call {:si_unique_call 547} SLIC_sdv_IoAcquireRemoveLock_exit(0, Tmp_117);
    return;
...
procedure {:origName "sdv_IsListEmpty"} {:osmodel} sdv_IsListEmpty(actual_ListHead: int) returns (Tmp_121: int);
...
implementation {:origName "sdv_IsListEmpty"} {:osmodel} sdv_IsListEmpty(actual_ListHead: int) returns (Tmp_121: int)
{
...
procedure {:origName "IoAllocateIrp"} {:osmodel} IoAllocateIrp(actual_StackSize: int, actual_ChargeQuota: int) returns (Tmp_123: int);
...
implementation {:origName "IoAllocateIrp"} {:osmodel} IoAllocateIrp(actual_StackSize: int, actual_ChargeQuota: int) returns (Tmp_123: int)
{
  ...
  anon3_Else:
    assume {:nonnull} sdv_other_irp != 0;
    assume sdv_other_irp > 0;
    call {:si_unique_call 549} irpSp_1 := sdv_IoGetNextIrpStackLocation(sdv_other_irp);
    assume {:nonnull} irpSp_1 != 0;
    assume irpSp_1 > 0;
    sdv_compFset := 0;
    Tmp_123 := sdv_other_irp;
    goto L1;
...
procedure {:origName "ZwOpenKey"} {:osmodel} ZwOpenKey(actual_KeyHandle_1: int, actual_DesiredAccess_1: int, actual_ObjectAttributes: int) returns (Tmp_127: int);
  modifies alloc;
  free ensures {:va_keep} Tmp_127 == 0 || Tmp_127 == -1073741727;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);



implementation {:origName "ZwOpenKey"} {:osmodel} ZwOpenKey(actual_KeyHandle_1: int, actual_DesiredAccess_1: int, actual_ObjectAttributes: int) returns (Tmp_127: int)
{
  ...
  anon3_Else:
    call {:si_unique_call 550} sdv_37 := __HAVOC_malloc(4);
...
implementation {:origName "KeInitializeEvent"} {:osmodel} KeInitializeEvent(actual_Event_1: int, actual_Type_1: int, actual_State_1: int)
{
  ...
  anon0:
    call {:si_unique_call 551} vslice_dummy_var_31 := __HAVOC_malloc(4);
...
procedure {:origName "IoBuildDeviceIoControlRequest"} {:osmodel} IoBuildDeviceIoControlRequest(actual_IoControlCode: int, actual_DeviceObject_9: int, actual_InputBuffer: int, actual_InputBufferLength: int, actual_OutputBuffer: int, actual_OutputBufferLength: int, actual_InternalDeviceIoControl: int, actual_Event_2: int, actual_IoStatusBlock: int) returns (Tmp_135: int);
...
implementation {:origName "IoFreeIrp"} {:osmodel} IoFreeIrp(actual_pirp_12: int)
{
  ...
  anon0:
    call {:si_unique_call 552} vslice_dummy_var_32 := __HAVOC_malloc(4);
    return;
}
...
implementation {:origName "sdv_KeInitializeSpinLock"} {:osmodel} sdv_KeInitializeSpinLock(actual_SpinLock_2: int)
{
  ...
  anon0:
    call {:si_unique_call 553} vslice_dummy_var_33 := __HAVOC_malloc(4);
...
procedure {:origName "ExAllocatePoolWithTag"} {:osmodel} ExAllocatePoolWithTag(actual_PoolType: int, actual_NumberOfBytes: int, actual_Tag_2: int) returns (Tmp_143: int);
  modifies alloc;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);
...
implementation {:origName "ExAllocatePoolWithTag"} {:osmodel} ExAllocatePoolWithTag(actual_PoolType: int, actual_NumberOfBytes: int, actual_Tag_2: int) returns (Tmp_143: int)
{
  ...
  anon3_Else:
    call {:si_unique_call 554} sdv_46 := __HAVOC_malloc(NumberOfBytes);
    Tmp_143 := sdv_46;
    goto L1;
...
procedure {:origName "RtlWriteRegistryValue"} {:osmodel} RtlWriteRegistryValue(actual_RelativeTo_1: int, actual_Path_1: int, actual_ValueName_1: int, actual_ValueType: int, actual_ValueData: int, actual_ValueLength: int) returns (Tmp_145: int);
  free ensures {:va_keep} Tmp_145 == 0 || Tmp_145 == -1073741823;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);



implementation {:origName "RtlWriteRegistryValue"} {:osmodel} RtlWriteRegistryValue(actual_RelativeTo_1: int, actual_Path_1: int, actual_ValueName_1: int, actual_ValueType: int, actual_ValueData: int, actual_ValueLength: int) returns (Tmp_145: int)
{
...
procedure {:origName "IoSetDeviceInterfaceState"} {:osmodel} IoSetDeviceInterfaceState(actual_SymbolicLinkName_1: int, actual_Enable: int) returns (Tmp_147: int);
  free ensures {:va_keep} Tmp_147 == -1073741772 || Tmp_147 == -1073741824 || Tmp_147 == -1073741789 || Tmp_147 == -1073741670 || Tmp_147 == -1073741808 || Tmp_147 == 0;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);



implementation {:origName "IoSetDeviceInterfaceState"} {:osmodel} IoSetDeviceInterfaceState(actual_SymbolicLinkName_1: int, actual_Enable: int) returns (Tmp_147: int)
{
...
procedure {:origName "IoOpenDeviceRegistryKey"} {:osmodel} IoOpenDeviceRegistryKey(actual_DeviceObject_10: int, actual_DevInstKeyType: int, actual_DesiredAccess_2: int, actual_DevInstRegKey: int) returns (Tmp_153: int);
...
implementation {:origName "IoOpenDeviceRegistryKey"} {:osmodel} IoOpenDeviceRegistryKey(actual_DeviceObject_10: int, actual_DevInstKeyType: int, actual_DesiredAccess_2: int, actual_DevInstRegKey: int) returns (Tmp_153: int)
{
...
procedure {:origName "IoWMIRegistrationControl"} {:osmodel} IoWMIRegistrationControl(actual_DeviceObject_11: int, actual_Action: int) returns (Tmp_159: int);
...
implementation {:origName "IoWMIRegistrationControl"} {:osmodel} IoWMIRegistrationControl(actual_DeviceObject_11: int, actual_Action: int) returns (Tmp_159: int)
{
...
procedure {:origName "sdv_IoReleaseRemoveLock"} sdv_IoReleaseRemoveLock(actual_sdv_55: int, actual_sdv_56: int) returns (Tmp_163: int);
  modifies alloc;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);
...
implementation {:origName "sdv_IoReleaseRemoveLock"} sdv_IoReleaseRemoveLock(actual_sdv_55: int, actual_sdv_56: int) returns (Tmp_163: int)
{
  var {:scalar} sdv_57: int;

  anon0:
    call {:si_unique_call 557} Tmp_163 := __HAVOC_malloc(4);
    call {:si_unique_call 558} sdv_57 := __HAVOC_malloc(4);
...
procedure {:origName "sdv_InsertTailList"} sdv_InsertTailList(actual_sdv_58: int, actual_sdv_59: int) returns (Tmp_165: int);
  modifies alloc;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);
...
implementation {:origName "sdv_InsertTailList"} sdv_InsertTailList(actual_sdv_58: int, actual_sdv_59: int) returns (Tmp_165: int)
{
  var {:scalar} sdv_60: int;

  anon0:
    call {:si_unique_call 559} Tmp_165 := __HAVOC_malloc(4);
    call {:si_unique_call 560} sdv_60 := __HAVOC_malloc(4);
...
procedure {:origName "SLIC_sdv_IoAcquireRemoveLock_exit"} {:osmodel} SLIC_sdv_IoAcquireRemoveLock_exit(actual_caller: int, actual_sdv_64: int);
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);



implementation {:origName "SLIC_sdv_IoAcquireRemoveLock_exit"} {:osmodel} SLIC_sdv_IoAcquireRemoveLock_exit(actual_caller: int, actual_sdv_64: int)
{
...
procedure {:origName "SLIC_sdv_RunRemoveDevice_exit"} {:osmodel} SLIC_sdv_RunRemoveDevice_exit(actual_caller_1: int, actual_sdv_65: int, actual_sdv_66: int);
  modifies yogi_error;
  free ensures {:va_keep} yogi_error == 1;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);
...
implementation {:origName "SLIC_sdv_RunRemoveDevice_exit"} {:osmodel} SLIC_sdv_RunRemoveDevice_exit(actual_caller_1: int, actual_sdv_65: int, actual_sdv_66: int)
{
  ...
  anon8_Else:
    assume {:partition} sdv_66 == -1073741637;
  ...
  anon7_Then:
    call {:si_unique_call 563} SLIC_ABORT_2_0(caller_1, sdv_65, sdv_66);
    goto anon9_Then, anon9_Else;
...
procedure {:origName "SLIC_ABORT_2_0"} SLIC_ABORT_2_0(actual_caller_2: int, actual_sdv_67: int, actual_sdv_68: int);
  modifies yogi_error;
  free ensures {:va_keep} yogi_error == 1;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);
...
implementation {:origName "SLIC_ABORT_2_0"} SLIC_ABORT_2_0(actual_caller_2: int, actual_sdv_67: int, actual_sdv_68: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 564} SLIC_ERROR_ROUTINE(strConst__li2bpl2);
    return;
}
...
implementation {:origName "KbdConfiguration"} KbdConfiguration()
{
  ...
  anon0:
    call {:si_unique_call 565} defaultConnectMultiplePorts := __HAVOC_malloc(4);
    call {:si_unique_call 566} defaultDataQueueSize := __HAVOC_malloc(4);
    call {:si_unique_call 567} defaultUnicodeName := __HAVOC_malloc(12);
    call {:si_unique_call 568} vslice_dummy_var_36 := __HAVOC_malloc(4);
    call {:si_unique_call 569} defaultSendOutputToAllPorts := __HAVOC_malloc(4);
    call {:si_unique_call 570} defaultMaximumPortsServiced := __HAVOC_malloc(4);
    call {:si_unique_call 571} parametersPath := __HAVOC_malloc(12);
    call {:si_unique_call 572} Tmp_170 := __HAVOC_malloc(56);
    call {:si_unique_call 573} vslice_dummy_var_38 := __HAVOC_malloc(48);
    parameters := 0;
    ...
    status_6 := 0;
    queriesPlusOne := 6;
    call {:si_unique_call 574} sdv_do_paged_code_check();
    ...
    Tmp_177 := 28 * queriesPlusOne;
    call {:si_unique_call 575} sdv_69 := ExAllocatePoolWithTag(1, Tmp_177, -1016831413);
    parameters := sdv_69;
    goto anon25_Then, anon25_Else;

  anon25_Else:
    assume {:partition} parameters != 0;
    Tmp_171 := 28 * queriesPlusOne;
    call {:si_unique_call 576} sdv_RtlZeroMemory(0, Tmp_171);
    call {:si_unique_call 577} RtlInitUnicodeString(parametersPath, 0);
    assume {:nonnull} parametersPath != 0;
    assume parametersPath > 0;
    ...
    assume {:nonnull} parametersPath != 0;
    assume parametersPath > 0;
    Tmp_175 := Mem_T.MaximumLength__UNICODE_STRING[MaximumLength__UNICODE_STRING(parametersPath)];
    call {:si_unique_call 578} sdv_70 := ExAllocatePoolWithTag(1, Tmp_175, -1016831413);
    assume {:nonnull} parametersPath != 0;
    assume parametersPath > 0;
    Mem_T.Buffer__UNICODE_STRING[Buffer__UNICODE_STRING(parametersPath)] := sdv_70;
    assume {:nonnull} parametersPath != 0;
    assume parametersPath > 0;
  ...
  anon19_Else:
    ...
    assume {:nonnull} parametersPath != 0;
    assume parametersPath > 0;
    Tmp_173 := Mem_T.MaximumLength__UNICODE_STRING[MaximumLength__UNICODE_STRING(parametersPath)];
    call {:si_unique_call 579} sdv_RtlZeroMemory(0, Tmp_173);
    call {:si_unique_call 580} vslice_dummy_var_37 := corral_nondet();
    call {:si_unique_call 581} vslice_dummy_var_39 := corral_nondet();
    Tmp_170 := strConst__li2bpl4;
    call {:si_unique_call 582} RtlInitUnicodeString(defaultUnicodeName, Tmp_170);
    ...
    assume {:nonnull} parameters != 0;
    assume parameters > 0;
    call {:si_unique_call 583} status_6 := sdv_RtlQueryRegistryValues(0, 0, 0, 0, 0);
    goto L49;
...
procedure {:origName "KeyboardClassDequeueReadByFileObject"} KeyboardClassDequeueReadByFileObject(actual_DeviceExtension: int, actual_FileObject_1: int) returns (Tmp_180: int);
  modifies alloc;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);
...
implementation {:origName "KeyboardClassDequeueReadByFileObject"} KeyboardClassDequeueReadByFileObject(actual_DeviceExtension: int, actual_FileObject_1: int) returns (Tmp_180: int)
{
  ...
  L14:
    call {:si_unique_call 587} oldCancelRoutine, sdv_75, irp, entry, stack, vslice_dummy_var_41 := KeyboardClassDequeueReadByFileObject_loop_L14(oldCancelRoutine, sdv_75, irp, entry, stack, FileObject_1, vslice_dummy_var_41);
    goto L14_last;
  ...
  anon9_Else:
    call {:si_unique_call 588} sdv_75 := sdv_containing_record(entry, 88);
    irp := sdv_75;
    call {:si_unique_call 589} stack := sdv_IoGetCurrentIrpStackLocation(irp);
    assume {:nonnull} stack != 0;
    assume stack > 0;
    goto anon10_Then, anon10_Else;

  anon10_Else:
    call {:si_unique_call 590} vslice_dummy_var_41 := sdv_RemoveEntryList(0);
    call {:si_unique_call 591} oldCancelRoutine := sdv_IoSetCancelRoutine(irp, 0);
    goto anon11_Then, anon11_Else;
  ...
  anon11_Then:
    ...
    assume irp > 0;
    call {:si_unique_call 592} InitializeListHead(ListEntry_unnamed_tag_6(Overlay_unnamed_tag_5(Tail__IRP(irp))));
    goto L25;
  ...
  anon12_Then:
    assume {:partition} FileObject_1 == 0;
    call {:si_unique_call 593} Tmp_180 := KeyboardClassDequeueRead(DeviceExtension);
    goto L1;
}



procedure {:origName "RemoveHeadList"} RemoveHeadList(actual_ListHead_1: int) returns (Tmp_182: int);
  modifies alloc;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);
...
implementation {:origName "RemoveHeadList"} RemoveHeadList(actual_ListHead_1: int) returns (Tmp_182: int)
{
  ...
  L9:
    call {:si_unique_call 594} FatalListEntryError(ListHead_1, Entry_1, NextEntry);
    goto L12;
...
procedure {:origName "KeyboardClassSetLedsComplete"} KeyboardClassSetLedsComplete(actual_DeviceObject_13: int, actual_Irp_8: int, actual_Context_7: int) returns (Tmp_199: int);
  modifies alloc;
  free ensures {:va_keep} Tmp_199 == -1073741802 || Tmp_199 == -1073741823;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);



implementation {:origName "KeyboardClassSetLedsComplete"} KeyboardClassSetLedsComplete(actual_DeviceObject_13: int, actual_Irp_8: int, actual_Context_7: int) returns (Tmp_199: int)
{
  ...
  anon3_Else:
    ...
    assume data_1 > 0;
    call {:si_unique_call 595} vslice_dummy_var_42 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(data_1), Irp_8);
...
procedure {:origName "DriverEntry"} DriverEntry(actual_DriverObject_3: int, actual_RegistryPath: int) returns (Tmp_201: int);
  modifies alloc, Mem_T.P_DEVICE_OBJECT, Mem_T.PINT4, Mem_T.MaximumLength__UNICODE_STRING, Mem_T.Buffer__UNICODE_STRING, Mem_T.Length_unnamed_tag_18, Mem_T.PnP__DEVICE_EXTENSION, Mem_T.InputData__DEVICE_EXTENSION, Mem_T.Status__IO_STATUS_BLOCK, sdv_compFset, sdv_invoke_on_success, sdv_invoke_on_error, sdv_invoke_on_cancel;
  free ensures {:va_keep} Tmp_201 == 0 || Tmp_201 == -1073741823 || Tmp_201 == -1073741824 || Tmp_201 == -1073741771 || Tmp_201 == -1073741670;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);



implementation {:origName "DriverEntry"} DriverEntry(actual_DriverObject_3: int, actual_RegistryPath: int) returns (Tmp_201: int)
{
  var {:scalar} i: int;
  ...
  anon0:
    call {:si_unique_call 597} classDeviceObject := __HAVOC_malloc(4);
    call {:si_unique_call 598} basePortName := __HAVOC_malloc(12);
    call {:si_unique_call 599} fullPortName := __HAVOC_malloc(12);
    call {:si_unique_call 600} fullClassName := __HAVOC_malloc(4);
    call {:si_unique_call 601} numPorts := __HAVOC_malloc(4);
    DriverObject_3 := actual_DriverObject_3;
    RegistryPath := actual_RegistryPath;
    call {:si_unique_call 602} basePortBuffer := __HAVOC_malloc(1024);
    call {:si_unique_call 603} Tmp_205 := __HAVOC_malloc(112);
    call {:si_unique_call 604} Tmp_206 := __HAVOC_malloc(112);
    call {:si_unique_call 605} vslice_dummy_var_47 := __HAVOC_malloc(36);
    call {:si_unique_call 606} Tmp_208 := __HAVOC_malloc(112);
    call {:si_unique_call 607} vslice_dummy_var_48 := __HAVOC_malloc(8);
    call {:si_unique_call 608} Tmp_212 := __HAVOC_malloc(112);
    call {:si_unique_call 609} Tmp_213 := __HAVOC_malloc(112);
    call {:si_unique_call 610} Tmp_215 := __HAVOC_malloc(112);
    call {:si_unique_call 611} vslice_dummy_var_49 := __HAVOC_malloc(20);
    call {:si_unique_call 612} Tmp_217 := __HAVOC_malloc(112);
    call {:si_unique_call 613} Tmp_218 := __HAVOC_malloc(112);
    call {:si_unique_call 614} dumpData := __HAVOC_malloc(16);
    call {:si_unique_call 615} Tmp_221 := __HAVOC_malloc(112);
    call {:si_unique_call 616} Tmp_223 := __HAVOC_malloc(112);
    status_9 := 0;
    deviceExtension := 0;
    ...
    call {:si_unique_call 617} sdv_RtlZeroMemory(0, 828);
    call {:si_unique_call 618} InitializeListHead(LegacyDeviceList__GLOBALS(Globals));
    ...
    call {:si_unique_call 619} sdv_ExInitializeFastMutex(0);
    havoc vslice_dummy_var_1125;
    Mem_T.Buffer__UNICODE_STRING[Buffer__UNICODE_STRING(BaseClassName__GLOBALS(Globals))] := vslice_dummy_var_1125;
    ...
    call {:si_unique_call 620} sdv_RtlZeroMemory(0, 512);
    ...
    Tmp_210 := Mem_T.MaximumLength__UNICODE_STRING[MaximumLength__UNICODE_STRING(RegistryPath__GLOBALS(Globals))];
    call {:si_unique_call 621} sdv_90 := ExAllocatePoolWithTag(512, Tmp_210, -1016831413);
    Mem_T.Buffer__UNICODE_STRING[Buffer__UNICODE_STRING(RegistryPath__GLOBALS(Globals))] := sdv_90;
  ...
  anon68_Else:
    ...
    assume {:nonnull} RegistryPath != 0;
    assume RegistryPath > 0;
    Tmp_225 := Mem_T.Length_unnamed_tag_18[Length_unnamed_tag_18(RegistryPath)];
    call {:si_unique_call 622} sdv_RtlMoveMemory(0, 0, Tmp_225);
    assume {:nonnull} RegistryPath != 0;
    assume RegistryPath > 0;
    Tmp_204 := INTDIV(Mem_T.Length_unnamed_tag_18[Length_unnamed_tag_18(RegistryPath)], 2);
    ...
    call {:si_unique_call 623} KbdConfiguration();
  ...
  L63:
    ...
    call {:si_unique_call 624} vslice_dummy_var_50 := corral_nondet();
    call {:si_unique_call 625} vslice_dummy_var_43 := KbdDeterminePortsServiced(basePortName, numPorts);
    call {:si_unique_call 626} RtlInitUnicodeString(fullPortName, 0);
    assume {:nonnull} basePortName != 0;
    assume basePortName > 0;
    assume {:nonnull} fullPortName != 0;
    assume fullPortName > 0;
    ...
    assume {:nonnull} fullPortName != 0;
    assume fullPortName > 0;
    Tmp_224 := Mem_T.MaximumLength__UNICODE_STRING[MaximumLength__UNICODE_STRING(fullPortName)];
    call {:si_unique_call 627} sdv_98 := ExAllocatePoolWithTag(1, Tmp_224, -1016831413);
    assume {:nonnull} fullPortName != 0;
    assume fullPortName > 0;
    Mem_T.Buffer__UNICODE_STRING[Buffer__UNICODE_STRING(fullPortName)] := sdv_98;
    assume {:nonnull} fullPortName != 0;
    assume fullPortName > 0;
  ...
  anon69_Else:
    ...
    assume {:nonnull} fullPortName != 0;
    assume fullPortName > 0;
    Tmp_219 := Mem_T.MaximumLength__UNICODE_STRING[MaximumLength__UNICODE_STRING(fullPortName)];
    call {:si_unique_call 628} sdv_RtlZeroMemory(0, Tmp_219);
    call {:si_unique_call 629} vslice_dummy_var_51 := corral_nondet();
    call {:si_unique_call 630} vslice_dummy_var_44 := corral_nondet();
    call {:si_unique_call 631} vslice_dummy_var_52 := corral_nondet();
    i := 0;
    goto L98;

  L98:
    call {:si_unique_call 632} i, Tmp_202, Tmp_203, file_1, Tmp_209, Tmp_214, Tmp_220, status_9, deviceExtension, Tmp_227, vslice_dummy_var_45, vslice_dummy_var_46 := DriverEntry_loop_L98(i, Tmp_202, Tmp_203, classDeviceObject, fullPortName, file_1, fullClassName, Tmp_209, Tmp_214, Tmp_220, numPorts, status_9, deviceExtension, Tmp_227, DriverObject_3, vslice_dummy_var_45, vslice_dummy_var_46);
    goto L98_last;
  ...
  anon49_Else:
    assume {:nonnull} fullPortName != 0;
    assume fullPortName > 0;
    Tmp_220 := INTDIV(Mem_T.Length_unnamed_tag_18[Length_unnamed_tag_18(fullPortName)], 2) - 1;
    ...
    assume {:nonnull} fullPortName != 0;
    assume fullPortName > 0;
    call {:si_unique_call 633} status_9 := KbdCreateClassObject(DriverObject_3, InitExtension__GLOBALS(Globals), classDeviceObject, fullClassName, 1);
  ...
  anon50_Else:
    ...
    assume {:nonnull} deviceExtension != 0;
    assume deviceExtension > 0;
    call {:si_unique_call 634} status_9 := IoGetDeviceObjectPointer(0, 128, 0, TopPort__DEVICE_EXTENSION(deviceExtension));
  ...
  anon51_Else:
    ...
    assume {:nonnull} deviceExtension != 0;
    assume deviceExtension > 0;
    Tmp_214 := Mem_T.P_DEVICE_OBJECT[TopPort__DEVICE_EXTENSION(deviceExtension)];
    assume {:nonnull} Mem_T.P_DEVICE_OBJECT[classDeviceObject] != 0;
    assume Mem_T.P_DEVICE_OBJECT[classDeviceObject] > 0;
    ...
    assume {:nonnull} fullClassName != 0;
    assume fullClassName > 0;
    call {:si_unique_call 635} status_9 := KeyboardAddDeviceEx(deviceExtension, Mem_T.PINT4[fullClassName], file_1);
    assume {:nonnull} fullClassName != 0;
    assume fullClassName > 0;
  ...
  anon54_Else:
    ...
    assume {:nonnull} deviceExtension != 0;
    assume deviceExtension > 0;
    call {:si_unique_call 637} vslice_dummy_var_45 := sdv_InsertTailList(LegacyDeviceList__GLOBALS(Globals), Link__DEVICE_EXTENSION(deviceExtension));
    goto L134;
  ...
  anon55_Else:
    call {:si_unique_call 638} ExAcquireFastMutex(0);
    assume {:nonnull} deviceExtension != 0;
    assume deviceExtension > 0;
    havoc Tmp_203;
    havoc file_1;
  ...
  anon57_Else:
    ...
    call {:si_unique_call 640} vslice_dummy_var_46 := sdv_ObDereferenceObject(0);
    goto L148;
  ...
  anon58_Else:
    ...
    Mem_T.InputData__DEVICE_EXTENSION[InputData__DEVICE_EXTENSION(deviceExtension)] := vslice_dummy_var_1126;
    goto L152;

  L152:
    call {:si_unique_call 642} IoDeleteDevice(0);
    deviceExtension := 0;
    goto L134;
  ...
  anon52_Else:
    ...
    Mem_T.InputData__DEVICE_EXTENSION[InputData__DEVICE_EXTENSION(deviceExtension)] := vslice_dummy_var_1127;
    goto L165;

  L165:
    call {:si_unique_call 644} IoDeleteDevice(0);
    deviceExtension := 0;
    goto L134;
  ...
  anon50_Then:
    assume {:partition} 0 > status_9;
    call {:si_unique_call 645} KeyboardClassLogError(li2bplFunctionConstant624, -1073414143, 10008, status_9, 0, 0, 0);
    goto L134;
  ...
  L178:
    call {:si_unique_call 646} entry_1 := DriverEntry_loop_L178(entry_1);
    goto L178_last;
  ...
  anon62_Else:
    assume {:partition} status_9 >= 0;
    call {:si_unique_call 649} IoRegisterDriverReinitialization(0, li2bplFunctionConstant625, 0);
  ...
  anon69_Then:
    ...
    assume {:nonnull} fullPortName != 0;
    assume fullPortName > 0;
    call {:si_unique_call 654} KeyboardClassLogError(DriverObject_3, -1073414143, 10006, status_9, 1, dumpData, 0);
    goto L179;

  anon47_Then:
    call {:si_unique_call 655} status_9 := KbdCreateClassObject(DriverObject_3, InitExtension__GLOBALS(Globals), classDeviceObject, fullClassName, 1);
  ...
  anon67_Else:
    ...
    assume {:nonnull} fullClassName != 0;
    assume fullClassName > 0;
    call {:si_unique_call 656} vslice_dummy_var_53 := KeyboardAddDeviceEx(deviceExtension, Mem_T.PINT4[fullClassName], 0);
  ...
  anon68_Then:
    ...
    assume {:nonnull} dumpData != 0;
    assume dumpData > 0;
    call {:si_unique_call 658} KeyboardClassLogError(DriverObject_3, -1073414143, 10002, -1073741823, 1, dumpData, 0);
    goto L179;
}



procedure {:origName "_InlineInterlockedExchangePointer"} _InlineInterlockedExchangePointer(actual_Destination_3: int, actual_Value: int) returns (Tmp_228: int);
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);



implementation {:origName "_InlineInterlockedExchangePointer"} _InlineInterlockedExchangePointer(actual_Destination_3: int, actual_Value: int) returns (Tmp_228: int)
{
...
procedure {:origName "KeyboardClassCleanupQueue"} KeyboardClassCleanupQueue(actual_DeviceObject_14: int, actual_DeviceExtension_1: int, actual_FileObject_2: int);
  modifies alloc, Mem_T.Status__IO_STATUS_BLOCK;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);
...
implementation {:origName "KeyboardClassCleanupQueue"} KeyboardClassCleanupQueue(actual_DeviceObject_14: int, actual_DeviceExtension_1: int, actual_FileObject_2: int)
{
  ...
  anon0:
    call {:si_unique_call 659} listHead := __HAVOC_malloc(8);
    call {:si_unique_call 660} vslice_dummy_var_54 := __HAVOC_malloc(4);
    DeviceExtension_1 := actual_DeviceExtension_1;
    FileObject_2 := actual_FileObject_2;
    call {:si_unique_call 661} InitializeListHead(listHead);
    call {:si_unique_call 662} Tmp_230 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_230 != 0;
    assume Tmp_230 > 0;
    call {:si_unique_call 663} sdv_KeAcquireSpinLock(0, Tmp_230);
    assume {:nonnull} Tmp_230 != 0;
    assume Tmp_230 > 0;
    havoc irql;
    goto L13;
  ...
  L13:
    call {:si_unique_call 664} irp_1, vslice_dummy_var_56 := KeyboardClassCleanupQueue_loop_L13(listHead, irp_1, DeviceExtension_1, FileObject_2, vslice_dummy_var_56);
    goto L13_last;

  L13_last:
    call {:si_unique_call 673} irp_1 := KeyboardClassDequeueReadByFileObject(DeviceExtension_1, FileObject_2);
    goto anon7_Then, anon7_Else;
  ...
  anon7_Else:
    ...
    assume {:nonnull} irp_1 != 0;
    assume irp_1 > 0;
    call {:si_unique_call 665} vslice_dummy_var_56 := sdv_InsertTailList(listHead, ListEntry_unnamed_tag_6(Overlay_unnamed_tag_5(Tail__IRP(irp_1))));
    goto L18;
  ...
  anon8_Else:
    assume {:partition} irp_1 == 0;
    call {:si_unique_call 666} sdv_KeReleaseSpinLock(0, irql);
    goto L27;

  L27:
    call {:si_unique_call 667} sdv_103, sdv_105, irp_1, entry_2, vslice_dummy_var_55 := KeyboardClassCleanupQueue_loop_L27(listHead, sdv_103, sdv_105, irp_1, entry_2, DeviceExtension_1, vslice_dummy_var_55);
    goto L27_last;

  L27_last:
    call {:si_unique_call 672} sdv_103 := sdv_IsListEmpty(0);
    goto anon9_Then, anon9_Else;

  anon9_Else:
    assume {:partition} sdv_103 == 0;
    call {:si_unique_call 668} entry_2 := RemoveHeadList(listHead);
    call {:si_unique_call 669} sdv_105 := sdv_containing_record(entry_2, 88);
    irp_1 := sdv_105;
    call {:si_unique_call 670} sdv_IoCompleteRequest(0, 0);
    assume {:nonnull} DeviceExtension_1 != 0;
    assume DeviceExtension_1 > 0;
    call {:si_unique_call 671} vslice_dummy_var_55 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(DeviceExtension_1), irp_1);
...
procedure {:origName "KeyboardAddDeviceEx"} KeyboardAddDeviceEx(actual_ClassData: int, actual_FullClassName: int, actual_File: int) returns (Tmp_232: int);
...
implementation {:origName "KeyboardAddDeviceEx"} KeyboardAddDeviceEx(actual_ClassData: int, actual_FullClassName: int, actual_File: int) returns (Tmp_232: int)
{
  var {:scalar} i_1: int;
  ...
  anon0:
    ...
    File := actual_File;
    call {:si_unique_call 674} Tmp_234 := __HAVOC_malloc(4);
    call {:si_unique_call 675} dumpData_1 := __HAVOC_malloc(16);
    errorCode := 0;
    status_10 := 0;
    uniqueErrorValue := 0;
    dumpCount_1 := 0;
    call {:si_unique_call 676} sdv_do_paged_code_check();
    call {:si_unique_call 677} Tmp_249 := __HAVOC_malloc(4);
    assume {:nonnull} ClassData != 0;
    assume ClassData > 0;
    assume {:nonnull} Tmp_249 != 0;
    assume Tmp_249 > 0;
    call {:si_unique_call 678} sdv_KeInitializeSpinLock(Tmp_249);
    assume {:nonnull} ClassData != 0;
    assume ClassData > 0;
    assume {:nonnull} Tmp_249 != 0;
    assume Tmp_249 > 0;
  ...
  anon35_Else:
    call {:si_unique_call 679} status_10 := KbdSendConnectRequest(ClassData, li2bplFunctionConstant640);
    call {:si_unique_call 680} ExAcquireFastMutex(0);
    i_1 := 0;
    goto L37;

  L37:
    call {:si_unique_call 681} i_1, Tmp_251 := KeyboardAddDeviceEx_loop_L37(i_1, Tmp_251);
    goto L37_last;
  ...
  anon37_Else:
    havoc Tmp_238;
    call {:si_unique_call 682} sdv_107 := ExAllocatePoolWithTag(512, Tmp_238, -1016831413);
    classDataList := sdv_107;
    goto anon46_Then, anon46_Else;

  anon46_Else:
    assume {:partition} classDataList != 0;
    havoc Tmp_240;
    call {:si_unique_call 683} sdv_RtlZeroMemory(0, Tmp_240);
    goto anon38_Then, anon38_Else;

  anon38_Else:
    havoc Tmp_236;
    call {:si_unique_call 684} sdv_RtlCopyMemory(0, 0, Tmp_236);
  ...
  L97:
    ...
    assume Tmp_245 > 0;
    call {:si_unique_call 686} ExReleaseFastMutex(0);
    goto L101;
  ...
  anon41_Else:
    ...
    Tmp_247 := Mem_T.Length_unnamed_tag_18[Length_unnamed_tag_18(RegistryPath__GLOBALS(Globals))] + 2;
    call {:si_unique_call 687} status_10 := RtlWriteRegistryValue(4, 0, 0, 1, 0, Tmp_247);
    goto anon42_Then, anon42_Else;

  anon42_Else:
    assume {:partition} status_10 < 0;
    call {:si_unique_call 688} KeyboardClassLogError(ClassData, 327685, 10014, status_10, 0, 0, 0);
    goto L102;
  ...
  anon39_Else:
    ...
    Tmp_239 := 48 + dumpCount_1 * 4;
    call {:si_unique_call 690} sdv_108 := IoAllocateErrorLogEntry(0, Tmp_239);
    errorLogEntry := sdv_108;
    goto anon48_Then, anon48_Else;
  ...
  L86:
    call {:si_unique_call 691} i_1, Tmp_234, Tmp_243, Tmp_248 := KeyboardAddDeviceEx_loop_L86(i_1, Tmp_234, errorLogEntry, dumpData_1, Tmp_243, dumpCount_1, Tmp_248);
    goto L86_last;
  ...
  anon40_Then:
    ...
    call {:si_unique_call 692} IoWriteErrorLogEntry(0);
    goto L70;
  ...
  anon43_Else:
    assume {:partition} ClassData == trueClassData;
    call {:si_unique_call 693} status_10 := KbdSendConnectRequest(ClassData, li2bplFunctionConstant640);
    goto L101;
...
implementation {:origName "KeyboardClassRemoveDevice"} KeyboardClassRemoveDevice(actual_Data: int)
{
  ...
  anon0:
    call {:si_unique_call 694} vslice_dummy_var_57 := __HAVOC_malloc(4);
    Data := actual_Data;
    assume {:nonnull} Data != 0;
    assume Data > 0;
    call {:si_unique_call 695} sdv_111 := _InlineInterlockedExchangePointer(WaitWakeIrp__DEVICE_EXTENSION(Data), 0);
    waitWakeIrp := sdv_111;
    goto anon24_Then, anon24_Else;

  anon24_Else:
    assume {:partition} waitWakeIrp != 0;
    call {:si_unique_call 696} vslice_dummy_var_59 := IoCancelIrp(0);
    goto L13;

  L13:
    call {:si_unique_call 697} vslice_dummy_var_58 := IoWMIRegistrationControl(0, 2);
    assume {:nonnull} Data != 0;
    assume Data > 0;
  ...
  anon20_Else:
    ...
    assume {:nonnull} Data != 0;
    assume Data > 0;
    call {:si_unique_call 700} notifyHandle := _InlineInterlockedExchangePointer(TargetNotifyHandle__DEVICE_EXTENSION(Data), 0);
    goto anon21_Then, anon21_Else;

  anon21_Else:
    assume {:partition} notifyHandle != 0;
    call {:si_unique_call 701} vslice_dummy_var_60 := IoUnregisterPlugPlayNotification(0);
    goto L20;
  ...
  anon18_Else:
    ...
    call {:si_unique_call 702} KeyboardClassCleanupQueue(vslice_dummy_var_1128, Data, 0);
    goto L1;
  ...
  anon20_Then:
    call {:si_unique_call 703} ExReleaseFastMutex(0);
    goto L20;
  ...
  anon23_Else:
    ...
    call {:si_unique_call 705} vslice_dummy_var_61 := IoSetDeviceInterfaceState(0, 0);
    goto L20;
...
implementation {:origName "RtlFailFast"} RtlFailFast(actual_Code: int)
{
  ...
  anon0:
    call {:si_unique_call 706} vslice_dummy_var_62 := __HAVOC_malloc(4);
    return;
}



procedure {:origName "KbdSyncComplete"} KbdSyncComplete(actual_DeviceObject_15: int, actual_Irp_9: int, actual_Context_8: int) returns (Tmp_257: int);
...
implementation {:origName "KbdSyncComplete"} KbdSyncComplete(actual_DeviceObject_15: int, actual_Irp_9: int, actual_Context_8: int) returns (Tmp_257: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 707} vslice_dummy_var_63 := KeSetEvent(Context_8, 0, 0);
    Tmp_257 := -1073741802;
    return;
}
...
procedure {:origName "KeyboardQueryDeviceKey"} KeyboardQueryDeviceKey(actual_Handle_1: int, actual_ValueNameString: int, actual_Data_1: int, actual_DataLength: int) returns (Tmp_259: int);
  modifies alloc, Mem_T.Buffer__UNICODE_STRING, Mem_T.Length_unnamed_tag_18, Mem_T.MaximumLength__UNICODE_STRING;
  free ensures {:va_keep} Tmp_259 == -1073741811 || Tmp_259 == -1073741823 || Tmp_259 == 0 || Tmp_259 == 5 || Tmp_259 == -1073741789 || Tmp_259 == -1073741801;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);



implementation {:origName "KeyboardQueryDeviceKey"} KeyboardQueryDeviceKey(actual_Handle_1: int, actual_ValueNameString: int, actual_Data_1: int, actual_DataLength: int) returns (Tmp_259: int)
{
  ...
  anon0:
    call {:si_unique_call 708} valueName := __HAVOC_malloc(12);
    ValueNameString := actual_ValueNameString;
    DataLength := actual_DataLength;
    call {:si_unique_call 709} sdv_do_paged_code_check();
    call {:si_unique_call 710} RtlInitUnicodeString(valueName, ValueNameString);
    ...
    call {:si_unique_call 711} sdv_118 := ExAllocatePoolWithTag(1, length, -1016831413);
    fullInfo := sdv_118;
    goto anon6_Then, anon6_Else;

  anon6_Else:
    assume {:partition} fullInfo != 0;
    call {:si_unique_call 712} Tmp_261 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_261 != 0;
    assume Tmp_261 > 0;
    call {:si_unique_call 713} status_11 := ZwQueryValueKey(0, 0, 1, 0, length, Tmp_261);
    assume {:nonnull} Tmp_261 != 0;
    assume Tmp_261 > 0;
    havoc length;
    goto anon5_Then, anon5_Else;
  ...
  anon5_Else:
    ...
    call {:si_unique_call 714} sdv_RtlCopyMemory(0, 0, vslice_dummy_var_1129);
    goto L25;
...
procedure {:origName "KeyboardSendIrpSynchronously"} KeyboardSendIrpSynchronously(actual_DeviceObject_16: int, actual_Irp_10: int, actual_CopyToNext: int) returns (Tmp_262: int);
...
implementation {:origName "KeyboardSendIrpSynchronously"} KeyboardSendIrpSynchronously(actual_DeviceObject_16: int, actual_Irp_10: int, actual_CopyToNext: int) returns (Tmp_262: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 718} KeInitializeEvent(event, 1, 0);
    goto anon3_Then, anon3_Else;

  anon3_Else:
    assume {:partition} CopyToNext != 0;
    call {:si_unique_call 719} sdv_IoCopyCurrentIrpStackLocationToNext(Irp_10);
    goto L12;

  L12:
    call {:si_unique_call 720} sdv_IoSetCompletionRoutine(Irp_10, li2bplFunctionConstant644, event, 1, 1, 1);
    call {:si_unique_call 721} vslice_dummy_var_64 := sdv_IoCallDriver#1(DeviceObject_16, Irp_10);
    call {:si_unique_call 722} vslice_dummy_var_65 := KeWaitForSingleObject(0, 0, 0, 0, 0);
    assume {:nonnull} Irp_10 != 0;
    assume Irp_10 > 0;
    status_12 := Mem_T.Status__IO_STATUS_BLOCK[Status__IO_STATUS_BLOCK(IoStatus__IRP(Irp_10))];
    Tmp_262 := status_12;
    return;
...
implementation {:origName "KeyboardClassLogError"} KeyboardClassLogError(actual_Object_2: int, actual_ErrorCode: int, actual_UniqueErrorValue: int, actual_FinalStatus: int, actual_DumpCount: int, actual_DumpData: int, actual_MajorFunction: int)
{
  ...
  anon0:
    call {:si_unique_call 723} vslice_dummy_var_66 := __HAVOC_malloc(4);
    ...
    call {:si_unique_call 724} Tmp_266 := __HAVOC_malloc(4);
    Tmp_265 := 48 + DumpCount * 4;
    call {:si_unique_call 725} sdv_122 := IoAllocateErrorLogEntry(0, Tmp_265);
    errorLogEntry_1 := sdv_122;
    goto anon6_Then, anon6_Else;
  ...
  L20:
    call {:si_unique_call 726} i_2, Tmp_264, Tmp_266, Tmp_267 := KeyboardClassLogError_loop_L20(i_2, Tmp_264, errorLogEntry_1, Tmp_266, Tmp_267, DumpCount, DumpData);
    goto L20_last;
...
procedure {:origName "KbdCreateClassObject"} KbdCreateClassObject(actual_DriverObject_4: int, actual_TmpDeviceExtension: int, actual_ClassDeviceObject: int, actual_FullDeviceName: int, actual_Legacy: int) returns (Tmp_270: int);
  modifies alloc, Mem_T.Length_unnamed_tag_18, Mem_T.MaximumLength__UNICODE_STRING, Mem_T.Buffer__UNICODE_STRING, Mem_T.P_DEVICE_OBJECT, Mem_T.PINT4, Mem_T.PnP__DEVICE_EXTENSION, Mem_T.InputData__DEVICE_EXTENSION;
  free ensures {:va_keep} Tmp_270 == -1073741824 || Tmp_270 == -1073741771 || Tmp_270 == -1073741670 || Tmp_270 == -1073741823 || Tmp_270 == 0;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);



implementation {:origName "KbdCreateClassObject"} KbdCreateClassObject(actual_DriverObject_4: int, actual_TmpDeviceExtension: int, actual_ClassDeviceObject: int, actual_FullDeviceName: int, actual_Legacy: int) returns (Tmp_270: int)
{
  ...
  anon0:
    call {:si_unique_call 728} fullClassName_1 := __HAVOC_malloc(12);
    ...
    call {:si_unique_call 729} vslice_dummy_var_68 := __HAVOC_malloc(36);
    call {:si_unique_call 730} vslice_dummy_var_69 := __HAVOC_malloc(28);
    call {:si_unique_call 731} dumpData_2 := __HAVOC_malloc(16);
    call {:si_unique_call 732} vslice_dummy_var_70 := __HAVOC_malloc(8);
    deviceExtension_1 := 0;
    errorCode_1 := 0;
  ...
  anon41_Else:
    ...
    call {:si_unique_call 736} status_13 := IoCreateDevice(0, 224, 0, 11, 0, 0, ClassDeviceObject);
  ...
  anon31_Else:
    ...
    assume {:nonnull} ClassDeviceObject != 0;
    assume ClassDeviceObject > 0;
    Tmp_277 := Mem_T.P_DEVICE_OBJECT[ClassDeviceObject];
    assume {:nonnull} ClassDeviceObject != 0;
    assume ClassDeviceObject > 0;
    Tmp_280 := Mem_T.P_DEVICE_OBJECT[ClassDeviceObject];
    ...
    assume {:nonnull} ClassDeviceObject != 0;
    assume ClassDeviceObject > 0;
    Tmp_271 := Mem_T.P_DEVICE_OBJECT[ClassDeviceObject];
    assume {:nonnull} Tmp_271 != 0;
    assume Tmp_271 > 0;
    deviceExtension_1 := Mem_T.DeviceExtension__DEVICE_OBJECT[DeviceExtension__DEVICE_OBJECT(Tmp_271)];
    ...
    assume {:nonnull} deviceExtension_1 != 0;
    assume deviceExtension_1 > 0;
    call {:si_unique_call 737} sdv_IoInitializeRemoveLock(0, -1016831413, 0, 0);
    call {:si_unique_call 738} Tmp_273 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_273 != 0;
    assume Tmp_273 > 0;
    assume {:nonnull} deviceExtension_1 != 0;
    assume deviceExtension_1 > 0;
    call {:si_unique_call 739} sdv_KeInitializeSpinLock(Tmp_273);
    assume {:nonnull} Tmp_273 != 0;
    assume Tmp_273 > 0;
    assume {:nonnull} deviceExtension_1 != 0;
    assume deviceExtension_1 > 0;
    assume {:nonnull} deviceExtension_1 != 0;
    assume deviceExtension_1 > 0;
    call {:si_unique_call 740} InitializeListHead(ReadQueue__DEVICE_EXTENSION(deviceExtension_1));
    assume {:nonnull} deviceExtension_1 != 0;
    assume deviceExtension_1 > 0;
    assume {:nonnull} deviceExtension_1 != 0;
    assume deviceExtension_1 > 0;
    havoc vslice_dummy_var_1130;
    call {:si_unique_call 741} sdv_126 := ExAllocatePoolWithTag(512, vslice_dummy_var_1130, -1016831413);
    assume {:nonnull} deviceExtension_1 != 0;
    assume deviceExtension_1 > 0;
  ...
  anon42_Else:
    ...
    call {:si_unique_call 742} KbdInitializeDataQueue(deviceExtension_1);
    goto L62;
  ...
  anon32_Else:
    assume {:partition} status_13 != 0;
    call {:si_unique_call 743} RtlFreeUnicodeString(0);
    assume {:nonnull} FullDeviceName != 0;
    assume FullDeviceName > 0;
    Mem_T.PINT4[FullDeviceName] := 0;
    goto anon43_Then, anon43_Else;
  ...
  anon34_Else:
    ...
    assume {:nonnull} ClassDeviceObject != 0;
    assume ClassDeviceObject > 0;
    Tmp_279 := Mem_T.P_DEVICE_OBJECT[ClassDeviceObject];
    goto L73;

  L73:
    call {:si_unique_call 744} KeyboardClassLogError(Tmp_279, errorCode_1, uniqueErrorValue_1, status_13, dumpCount_2, dumpData_2, 0);
    goto L69;
  ...
  anon35_Else:
    assume {:partition} Mem_T.P_DEVICE_OBJECT[ClassDeviceObject] != 0;
    call {:si_unique_call 746} IoDeleteDevice(0);
    assume {:nonnull} ClassDeviceObject != 0;
    assume ClassDeviceObject > 0;
    Mem_T.P_DEVICE_OBJECT[ClassDeviceObject] := 0;
    goto L63;
  ...
  L95:
    assume {:nonnull} fullClassName_1 != 0;
    assume fullClassName_1 > 0;
    Tmp_275 := Mem_T.MaximumLength__UNICODE_STRING[MaximumLength__UNICODE_STRING(fullClassName_1)];
    call {:si_unique_call 748} sdv_127 := ExAllocatePoolWithTag(1, Tmp_275, -1016831413);
    assume {:nonnull} fullClassName_1 != 0;
    assume fullClassName_1 > 0;
  ...
  anon45_Else:
    ...
    assume {:nonnull} fullClassName_1 != 0;
    assume fullClassName_1 > 0;
    Tmp_272 := Mem_T.MaximumLength__UNICODE_STRING[MaximumLength__UNICODE_STRING(fullClassName_1)];
    call {:si_unique_call 749} sdv_RtlZeroMemory(0, Tmp_272);
    call {:si_unique_call 750} vslice_dummy_var_71 := corral_nondet();
    call {:si_unique_call 751} vslice_dummy_var_67 := corral_nondet();
    goto anon38_Then, anon38_Else;
  ...
  anon39_Else:
    assume {:partition} Legacy != 0;
    call {:si_unique_call 752} vslice_dummy_var_72 := corral_nondet();
    goto L115;

  L115:
    call {:si_unique_call 753} vslice_dummy_var_73 := corral_nondet();
    nameIndex := 0;
    goto L123;

  L123:
    call {:si_unique_call 754} Tmp_274, nameIndex, status_13, Tmp_281 := KbdCreateClassObject_loop_L123(Tmp_274, fullClassName_1, nameIndex, status_13, Tmp_281, ClassDeviceObject);
    goto L123_last;

  L123_last:
    assume {:nonnull} fullClassName_1 != 0;
    assume fullClassName_1 > 0;
    Tmp_281 := INTDIV(Mem_T.Length_unnamed_tag_18[Length_unnamed_tag_18(fullClassName_1)], 2) - 1;
    Tmp_274 := nameIndex;
    ...
    assume {:nonnull} fullClassName_1 != 0;
    assume fullClassName_1 > 0;
    call {:si_unique_call 755} status_13 := IoCreateDevice(0, 224, 0, 11, 0, 0, ClassDeviceObject);
    goto anon40_Then, anon40_Else;
...
procedure {:origName "KeyboardAddDevice"} KeyboardAddDevice(actual_DriverObject_5: int, actual_PhysicalDeviceObject_1: int) returns (Tmp_283: int);
  modifies alloc, Mem_T.PINT4, Mem_T.Length_unnamed_tag_18, Mem_T.MaximumLength__UNICODE_STRING, Mem_T.Buffer__UNICODE_STRING, Mem_T.P_DEVICE_OBJECT, Mem_T.PnP__DEVICE_EXTENSION, Mem_T.InputData__DEVICE_EXTENSION, Mem_T.Status__IO_STATUS_BLOCK, sdv_compFset, sdv_invoke_on_success, sdv_invoke_on_error, sdv_invoke_on_cancel;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);



implementation {:origName "KeyboardAddDevice"} KeyboardAddDevice(actual_DriverObject_5: int, actual_PhysicalDeviceObject_1: int) returns (Tmp_283: int)
{
  ...
  anon0:
    call {:si_unique_call 756} fullClassName_2 := __HAVOC_malloc(4);
    call {:si_unique_call 757} hParameters := __HAVOC_malloc(4);
    call {:si_unique_call 758} vslice_dummy_var_74 := __HAVOC_malloc(24);
    call {:si_unique_call 759} sdv := __HAVOC_malloc(8);
    call {:si_unique_call 760} hService := __HAVOC_malloc(4);
    call {:si_unique_call 761} fdo := __HAVOC_malloc(4);
    call {:si_unique_call 762} parameters_1 := __HAVOC_malloc(12);
    ...
    call {:si_unique_call 765} Tmp_285 := __HAVOC_malloc(44);
    call {:si_unique_call 766} Tmp_287 := __HAVOC_malloc(52);
    ...
    call {:si_unique_call 768} status_14 := KbdCreateClassObject(DriverObject_5, InitExtension__GLOBALS(Globals), fdo, fullClassName_2, 0);
    goto anon19_Then, anon19_Else;
  ...
  anon19_Else:
    ...
    assume port_2 > 0;
    call {:si_unique_call 769} boogieTmp := IoAttachDeviceToDeviceStack(0, PhysicalDeviceObject_1);
  ...
  anon20_Else:
    ...
    call {:si_unique_call 770} sdv_136 := IoAllocateErrorLogEntry(0, 48);
    errorLogEntry_2 := sdv_136;
    goto anon27_Then, anon27_Else;
  ...
  L106:
    call {:si_unique_call 772} IoDeleteDevice(0);
    Tmp_283 := -1073741667;
    goto L1;
  ...
  anon20_Then:
    ...
    assume {:nonnull} state != 0;
    assume state > 0;
    call {:si_unique_call 773} structPtr888sdv := PoSetPowerState(0, 1, state);
    ...
    assume {:nonnull} port_2 != 0;
    assume port_2 > 0;
    call {:si_unique_call 774} sdv_InitializeObjectAttributes(0, 0, 64, 0, 0);
    call {:si_unique_call 775} status_14 := ZwOpenKey(hService, 983103, 0);
    goto anon21_Then, anon21_Else;

  anon21_Else:
    assume {:partition} status_14 >= 0;
    Tmp_285 := strConst__li2bpl14;
    call {:si_unique_call 776} RtlInitUnicodeString(parameters_1, Tmp_285);
    call {:si_unique_call 777} sdv_InitializeObjectAttributes(0, 0, 64, 0, 0);
    call {:si_unique_call 778} status_14 := ZwOpenKey(hParameters, 983103, 0);
    goto anon22_Then, anon22_Else;

  anon22_Else:
    assume {:partition} status_14 >= 0;
    Tmp_287 := strConst__li2bpl15;
    assume {:nonnull} hParameters != 0;
    assume hParameters > 0;
    havoc vslice_dummy_var_1131;
    call {:si_unique_call 779} status_14 := KeyboardQueryDeviceKey(vslice_dummy_var_1131, Tmp_287, tmp, 4);
    goto anon23_Then, anon23_Else;
  ...
  L71:
    call {:si_unique_call 780} vslice_dummy_var_76 := ZwClose(0);
    goto L63;

  L63:
    call {:si_unique_call 781} vslice_dummy_var_75 := ZwClose(0);
    goto L50;
  ...
  L50:
    ...
    assume {:nonnull} port_2 != 0;
    assume port_2 > 0;
    call {:si_unique_call 782} status_14 := IoRegisterDeviceInterface(0, 0, 0, SymbolicLinkName__DEVICE_EXTENSION(port_2));
    goto anon25_Then, anon25_Else;
  ...
  anon25_Else:
    ...
    assume {:nonnull} fullClassName_2 != 0;
    assume fullClassName_2 > 0;
    call {:si_unique_call 783} status_14 := KeyboardAddDeviceEx(port_2, Mem_T.PINT4[fullClassName_2], 0);
    goto L92;
  ...
  anon25_Then:
    ...
    call {:si_unique_call 785} IoDetachDevice(0);
    assume {:nonnull} port_2 != 0;
    assume port_2 > 0;
    Mem_T.P_DEVICE_OBJECT[TopPort__DEVICE_EXTENSION(port_2)] := 0;
    call {:si_unique_call 786} IoDeleteDevice(0);
    goto L92;
...
implementation {:origName "KeyboardClassGetWaitWakeEnableState"} KeyboardClassGetWaitWakeEnableState(actual_Data_2: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 788} tmp_1 := __HAVOC_malloc(4);
    Data_2 := actual_Data_2;
    call {:si_unique_call 789} Tmp_289 := __HAVOC_malloc(64);
    hKey := 0;
    call {:si_unique_call 790} status_15 := IoOpenDeviceRegistryKey(0, 1, 2031616, 0);
    goto anon7_Then, anon7_Else;

  anon7_Else:
    assume {:partition} status_15 >= 0;
    Tmp_289 := strConst__li2bpl16;
    call {:si_unique_call 791} status_15 := KeyboardQueryDeviceKey(hKey, Tmp_289, tmp_1, 4);
    goto anon8_Then, anon8_Else;
  ...
  L19:
    call {:si_unique_call 792} vslice_dummy_var_78 := ZwClose(0);
    hKey := 0;
    goto L1;
...
implementation {:origName "InitializeListHead"} InitializeListHead(actual_ListHead_2: int)
{
  ...
  anon0:
    call {:si_unique_call 793} vslice_dummy_var_79 := __HAVOC_malloc(4);
...
procedure {:origName "KeyboardClassDequeueRead"} KeyboardClassDequeueRead(actual_DeviceExtension_2: int) returns (Tmp_295: int);
  modifies alloc;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);
...
implementation {:origName "KeyboardClassDequeueRead"} KeyboardClassDequeueRead(actual_DeviceExtension_2: int) returns (Tmp_295: int)
{
  ...
  L6:
    call {:si_unique_call 794} sdv_144, listEntry, oldCancelRoutine_1, sdv_146, nextIrp := KeyboardClassDequeueRead_loop_L6(sdv_144, listEntry, oldCancelRoutine_1, sdv_146, nextIrp, DeviceExtension_2);
    goto L6_last;
  ...
  anon7_Then:
    assume {:partition} nextIrp == 0;
    call {:si_unique_call 795} sdv_144 := sdv_IsListEmpty(0);
    goto anon8_Then, anon8_Else;
  ...
  anon8_Else:
    ...
    call {:si_unique_call 796} listEntry := RemoveHeadList(ReadQueue__DEVICE_EXTENSION(DeviceExtension_2));
    call {:si_unique_call 797} sdv_146 := sdv_containing_record(listEntry, 88);
    nextIrp := sdv_146;
    call {:si_unique_call 798} oldCancelRoutine_1 := sdv_IoSetCancelRoutine(nextIrp, 0);
    goto anon9_Then, anon9_Else;
  ...
  anon9_Else:
    ...
    assume nextIrp > 0;
    call {:si_unique_call 799} InitializeListHead(ListEntry_unnamed_tag_6(Overlay_unnamed_tag_5(Tail__IRP(nextIrp))));
    nextIrp := 0;
    goto anon9_Else_dummy;
...
procedure {:origName "_InlineInterlockedCompareExchangePointer"} _InlineInterlockedCompareExchangePointer(actual_Destination_4: int, actual_ExChange: int, actual_Comperand: int) returns (Tmp_297: int);
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);



implementation {:origName "_InlineInterlockedCompareExchangePointer"} _InlineInterlockedCompareExchangePointer(actual_Destination_4: int, actual_ExChange: int, actual_Comperand: int) returns (Tmp_297: int)
{
...
implementation {:origName "FatalListEntryError"} FatalListEntryError(actual_p1_1: int, actual_p2_1: int, actual_p3: int)
{
  ...
  anon0:
    call {:si_unique_call 800} vslice_dummy_var_80 := __HAVOC_malloc(4);
    call {:si_unique_call 801} RtlFailFast(3);
    return;
}



procedure {:origName "KbdDeterminePortsServiced"} KbdDeterminePortsServiced(actual_BasePortName: int, actual_NumberPortsServiced: int) returns (Tmp_301: int);
  modifies alloc;
  free ensures {:va_keep} Tmp_301 == 0 || Tmp_301 == -1073741823;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);



implementation {:origName "KbdDeterminePortsServiced"} KbdDeterminePortsServiced(actual_BasePortName: int, actual_NumberPortsServiced: int) returns (Tmp_301: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 803} sdv_149 := ExAllocatePoolWithTag(1, Tmp_302, -1016831413);
    registryTable := sdv_149;
    goto anon3_Then, anon3_Else;

  anon3_Else:
    assume {:partition} registryTable != 0;
    Tmp_303 := 28 * queriesPlusOne_1;
    call {:si_unique_call 804} sdv_RtlZeroMemory(0, Tmp_303);
    assume {:nonnull} registryTable != 0;
    assume registryTable > 0;
    assume {:nonnull} registryTable != 0;
    assume registryTable > 0;
    call {:si_unique_call 805} status_16 := sdv_RtlQueryRegistryValues(4, 0, 0, 0, 0);
...
procedure {:origName "KeyboardClassCreateWaitWakeIrp"} KeyboardClassCreateWaitWakeIrp(actual_Data_3: int) returns (Tmp_305: int);
  modifies alloc, Mem_T.Status__IO_STATUS_BLOCK;
  free ensures {:va_keep} Tmp_305 == 0 || Tmp_305 == 1;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);



implementation {:origName "KeyboardClassCreateWaitWakeIrp"} KeyboardClassCreateWaitWakeIrp(actual_Data_3: int) returns (Tmp_305: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 809} status_17 := PoRequestPowerIrp(0, 0, powerState_1, li2bplFunctionConstant668, 0, 0);
    goto anon3_Then, anon3_Else;
...
procedure {:origName "KeyboardPnP"} KeyboardPnP(actual_DeviceObject_17: int, actual_Irp_11: int) returns (Tmp_307: int);
  modifies alloc, Mem_T.Status__IO_STATUS_BLOCK, sdv_compFset, sdv_invoke_on_success, sdv_invoke_on_error, sdv_invoke_on_cancel, Mem_T.Buffer__UNICODE_STRING, Mem_T.Length_unnamed_tag_18, Mem_T.MaximumLength__UNICODE_STRING, Mem_T.P_DEVICE_OBJECT;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);
...
implementation {:origName "KeyboardPnP"} KeyboardPnP(actual_DeviceObject_17: int, actual_Irp_11: int) returns (Tmp_307: int)
{
  ...
  anon0:
    ...
    data_2 := Mem_T.DeviceExtension__DEVICE_OBJECT[DeviceExtension__DEVICE_OBJECT(DeviceObject_17)];
    call {:si_unique_call 811} stack_2 := sdv_IoGetCurrentIrpStackLocation(Irp_11);
    assume {:nonnull} data_2 != 0;
    assume data_2 > 0;
    goto anon89_Then, anon89_Else;

  anon89_Else:
    assume {:partition} Mem_T.PnP__DEVICE_EXTENSION[PnP__DEVICE_EXTENSION(data_2)] != 0;
    call {:si_unique_call 812} status_18 := sdv_IoAcquireRemoveLock(0, 0);
  ...
  anon132_Else:
    assume {:partition} Mem_T.Buffer__UNICODE_STRING[Buffer__UNICODE_STRING(SymbolicLinkName__DEVICE_EXTENSION(data_2))] != 0;
    call {:si_unique_call 813} vslice_dummy_var_81 := IoSetDeviceInterfaceState(0, 0);
    goto L45;

  L45:
    call {:si_unique_call 814} sdv_IoSkipCurrentIrpStackLocation(Irp_11);
    assume {:nonnull} data_2 != 0;
    assume data_2 > 0;
    call {:si_unique_call 815} status_18 := sdv_IoCallDriver#1(Mem_T.P_DEVICE_OBJECT[TopPort__DEVICE_EXTENSION(data_2)], Irp_11);
    goto L56;

  L56:
    assume {:nonnull} data_2 != 0;
    assume data_2 > 0;
    call {:si_unique_call 816} vslice_dummy_var_82 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(data_2), Irp_11);
    Tmp_307 := status_18;
    goto L1;
  ...
  L32:
    call {:si_unique_call 817} sdv_IoCopyCurrentIrpStackLocationToNext(Irp_11);
    assume {:nonnull} data_2 != 0;
    assume data_2 > 0;
    call {:si_unique_call 818} status_18 := sdv_IoCallDriver#1(Mem_T.P_DEVICE_OBJECT[TopPort__DEVICE_EXTENSION(data_2)], Irp_11);
    goto L56;
  ...
  anon95_Else:
    ...
    assume {:nonnull} data_2 != 0;
    assume data_2 > 0;
    call {:si_unique_call 821} notifyHandle_1 := _InlineInterlockedExchangePointer(TargetNotifyHandle__DEVICE_EXTENSION(data_2), 0);
    goto anon96_Then, anon96_Else;

  anon96_Else:
    assume {:partition} notifyHandle_1 != 0;
    call {:si_unique_call 822} vslice_dummy_var_83 := IoUnregisterPlugPlayNotification(0);
    goto L87;

  L87:
    call {:si_unique_call 823} status_18 := KbdEnableDisablePort(0, Irp_11, data_2, file_3);
    goto L62;

  L62:
    assume {:nonnull} data_2 != 0;
    assume data_2 > 0;
    call {:si_unique_call 824} sdv_IoSkipCurrentIrpStackLocation(Irp_11);
    assume {:nonnull} data_2 != 0;
    assume data_2 > 0;
    call {:si_unique_call 825} status_18 := sdv_IoCallDriver#1(Mem_T.P_DEVICE_OBJECT[TopPort__DEVICE_EXTENSION(data_2)], Irp_11);
    goto L56;
  ...
  anon128_Then:
    call {:si_unique_call 828} KeyboardClassRemoveDevice(data_2);
    call {:si_unique_call 829} sdv_IoCopyCurrentIrpStackLocationToNext(Irp_11);
    assume {:nonnull} data_2 != 0;
    assume data_2 > 0;
    call {:si_unique_call 830} status_18 := sdv_IoCallDriver#1(Mem_T.P_DEVICE_OBJECT[TopPort__DEVICE_EXTENSION(data_2)], Irp_11);
  ...
  anon130_Then:
    assume {:nonnull} data_2 != 0;
    assume data_2 > 0;
    call {:si_unique_call 840} status_18 := KeyboardSendIrpSynchronously(Mem_T.P_DEVICE_OBJECT[TopPort__DEVICE_EXTENSION(data_2)], Irp_11, 1);
  ...
  anon100_Else:
    ...
    assume {:nonnull} devCaps != 0;
    assume devCaps > 0;
    call {:si_unique_call 842} stack_2 := sdv_IoGetNextIrpStackLocation(Irp_11);
    assume {:nonnull} stack_2 != 0;
    assume stack_2 > 0;
    assume {:nonnull} stack_2 != 0;
    assume stack_2 > 0;
    assume {:nonnull} data_2 != 0;
    assume data_2 > 0;
    call {:si_unique_call 843} status_18 := KeyboardSendIrpSynchronously(Mem_T.P_DEVICE_OBJECT[TopPort__DEVICE_EXTENSION(data_2)], Irp_11, 0);
  ...
  anon103_Else:
    assume {:nonnull} data_2 != 0;
    assume data_2 > 0;
    call {:si_unique_call 845} KeyboardClassGetWaitWakeEnableState(data_2);
    goto L187;
  ...
  L187:
    ...
    assume {:nonnull} data_2 != 0;
    assume data_2 > 0;
    call {:si_unique_call 846} vslice_dummy_var_85 := IoWMIRegistrationControl(0, 1);
  ...
  anon108_Else:
    assume {:nonnull} data_2 != 0;
    assume data_2 > 0;
    call {:si_unique_call 849} sdv_169 := _InlineInterlockedCompareExchangePointer(WaitWakeIrp__DEVICE_EXTENSION(data_2), 0, 0);
    goto anon109_Then, anon109_Else;

  anon109_Else:
    assume {:partition} sdv_169 == 0;
    call {:si_unique_call 850} sdv_171 := KeyboardClassCheckWaitWakeEnabled(data_2);
    goto anon110_Then, anon110_Else;

  anon110_Else:
    assume {:partition} sdv_171 != 0;
    call {:si_unique_call 851} vslice_dummy_var_84 := KeyboardClassCreateWaitWakeIrp(data_2);
    goto L146;

  L146:
    assume {:nonnull} Irp_11 != 0;
    assume Irp_11 > 0;
    Mem_T.Status__IO_STATUS_BLOCK[Status__IO_STATUS_BLOCK(IoStatus__IRP(Irp_11))] := status_18;
    assume {:nonnull} Irp_11 != 0;
    assume Irp_11 > 0;
  ...
  anon106_Then:
    assume {:partition} enabled_1 == 0;
    call {:si_unique_call 853} status_18 := KbdEnableDisablePort(1, Irp_11, data_2, file_3);
    goto anon111_Then, anon111_Else;

  anon111_Else:
    assume {:partition} status_18 >= 0;
    call {:si_unique_call 854} stack_2 := sdv_IoGetNextIrpStackLocation(Irp_11);
    assume {:nonnull} stack_2 != 0;
    assume stack_2 > 0;
    assume {:nonnull} stack_2 != 0;
    assume stack_2 > 0;
    ...
    assume {:nonnull} data_2 != 0;
    assume data_2 > 0;
    call {:si_unique_call 855} status_18 := KeyboardSendIrpSynchronously(Mem_T.P_DEVICE_OBJECT[TopPort__DEVICE_EXTENSION(data_2)], Irp_11, 0);
    status_18 := 0;
    assume {:nonnull} Irp_11 != 0;
    assume Irp_11 > 0;
    Mem_T.Status__IO_STATUS_BLOCK[Status__IO_STATUS_BLOCK(IoStatus__IRP(Irp_11))] := startStatus;
  ...
  anon104_Then:
    ...
    call {:si_unique_call 858} status_18 := IoSetDeviceInterfaceState(0, 1);
    goto L219;
...
procedure {:origName "KbdSendConnectRequest"} KbdSendConnectRequest(actual_ClassData_1: int, actual_ServiceCallback: int) returns (Tmp_315: int);
  modifies alloc, Mem_T.Status__IO_STATUS_BLOCK, sdv_compFset, sdv_invoke_on_success, sdv_invoke_on_error, sdv_invoke_on_cancel;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);
...
implementation {:origName "KbdSendConnectRequest"} KbdSendConnectRequest(actual_ClassData_1: int, actual_ServiceCallback: int) returns (Tmp_315: int)
{
  ...
  anon5_Else:
    ...
    assume {:nonnull} ClassData_1 != 0;
    assume ClassData_1 > 0;
    call {:si_unique_call 867} status_19 := sdv_IoCallDriver#1(Mem_T.P_DEVICE_OBJECT[TopPort__DEVICE_EXTENSION(ClassData_1)], irp_2);
    goto anon6_Then, anon6_Else;

  anon6_Else:
    assume {:partition} status_19 == 259;
    call {:si_unique_call 868} vslice_dummy_var_86 := KeWaitForSingleObject(0, 0, 0, 0, 0);
    assume {:nonnull} irp_2 != 0;
    assume irp_2 > 0;
    status_19 := Mem_T.Status__IO_STATUS_BLOCK[Status__IO_STATUS_BLOCK(IoStatus__IRP(irp_2))];
    goto L32;

  L32:
    assume {:nonnull} ioStatus != 0;
    assume ioStatus > 0;
    Tmp_315 := Mem_T.Status__IO_STATUS_BLOCK[Status__IO_STATUS_BLOCK(ioStatus)];
    return;
  ...
  anon6_Then:
    ...
    assume {:nonnull} ioStatus != 0;
    assume ioStatus > 0;
    Mem_T.Status__IO_STATUS_BLOCK[Status__IO_STATUS_BLOCK(ioStatus)] := status_19;
    goto L32;
...
procedure {:origName "KeyboardClassCheckWaitWakeEnabled"} KeyboardClassCheckWaitWakeEnabled(actual_Data_4: int) returns (Tmp_317: int);
  modifies alloc;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);
...
implementation {:origName "KeyboardClassCheckWaitWakeEnabled"} KeyboardClassCheckWaitWakeEnabled(actual_Data_4: int) returns (Tmp_317: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 869} Tmp_318 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_318 != 0;
    assume Tmp_318 > 0;
    call {:si_unique_call 870} sdv_KeAcquireSpinLock(0, Tmp_318);
    assume {:nonnull} Tmp_318 != 0;
    assume Tmp_318 > 0;
    havoc irql_1;
    ...
    assume Data_4 > 0;
    havoc enabled_2;
    call {:si_unique_call 871} sdv_KeReleaseSpinLock(0, irql_1);
    Tmp_317 := enabled_2;
    return;
}
...
implementation {:origName "KbdInitializeDataQueue"} KbdInitializeDataQueue(actual_Context_9: int)
{
  ...
  anon0:
    call {:si_unique_call 872} vslice_dummy_var_87 := __HAVOC_malloc(4);
    Context_9 := actual_Context_9;
    deviceExtension_2 := Context_9;
    call {:si_unique_call 873} Tmp_319 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_319 != 0;
    assume Tmp_319 > 0;
    call {:si_unique_call 874} sdv_KeAcquireSpinLock(0, Tmp_319);
    assume {:nonnull} Tmp_319 != 0;
    assume Tmp_319 > 0;
    havoc oldIrql;
    assume {:nonnull} deviceExtension_2 != 0;
    ...
    assume {:nonnull} deviceExtension_2 != 0;
    assume deviceExtension_2 > 0;
    call {:si_unique_call 875} sdv_KeReleaseSpinLock(0, oldIrql);
    return;
}



procedure {:origName "KbdEnableDisablePort"} KbdEnableDisablePort(actual_EnableFlag: int, actual_Irp_12: int, actual_Port: int, actual_File_1: int) returns (Tmp_321: int);
...
implementation {:origName "KbdEnableDisablePort"} KbdEnableDisablePort(actual_EnableFlag: int, actual_Irp_12: int, actual_Port: int, actual_File_1: int) returns (Tmp_321: int)
{
  var {:scalar} name: int;
  ...
  anon0:
    call {:si_unique_call 876} name := __HAVOC_malloc(12);
    call {:si_unique_call 877} device := __HAVOC_malloc(4);
  ...
  anon23_Else:
    ...
    call {:si_unique_call 879} sdv_IoCopyCurrentIrpStackLocationToNext(Irp_12);
    call {:si_unique_call 880} stack_3 := sdv_IoGetNextIrpStackLocation(Irp_12);
    goto anon24_Then, anon24_Else;
  ...
  L32:
    assume {:nonnull} Port != 0;
    assume Port > 0;
    call {:si_unique_call 881} status_20 := KeyboardSendIrpSynchronously(Mem_T.P_DEVICE_OBJECT[TopPort__DEVICE_EXTENSION(Port)], Irp_12, 0);
    goto L36;
  ...
  anon26_Else:
    assume {:partition} EnableFlag != 0;
    bufferLength := 0;
    call {:si_unique_call 882} Tmp_323 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_323 != 0;
    assume Tmp_323 > 0;
    call {:si_unique_call 883} status_20 := IoGetDeviceProperty(0, 4107, bufferLength, 0, Tmp_323);
    assume {:nonnull} Tmp_323 != 0;
    assume Tmp_323 > 0;
    havoc bufferLength;
    call {:si_unique_call 884} sdv_185 := ExAllocatePoolWithTag(1, bufferLength, -1016831413);
    buffer := sdv_185;
    goto anon29_Then, anon29_Else;

  anon29_Else:
    assume {:partition} buffer != 0;
    call {:si_unique_call 885} Tmp_323 := __HAVOC_malloc(4);
    assume {:nonnull} Tmp_323 != 0;
    assume Tmp_323 > 0;
    call {:si_unique_call 886} status_20 := IoGetDeviceProperty(0, 4107, bufferLength, 0, Tmp_323);
    assume {:nonnull} Tmp_323 != 0;
    assume Tmp_323 > 0;
    havoc bufferLength;
    assume {:nonnull} name != 0;
    ...
    call {:si_unique_call 887} status_20 := IoGetDeviceObjectPointer(0, 2032127, 0, device);
  ...
  anon28_Else:
    ...
    call {:si_unique_call 889} sdv_IoCopyCurrentIrpStackLocationToNext(Irp_12);
    call {:si_unique_call 890} stack_3 := sdv_IoGetNextIrpStackLocation(Irp_12);
    assume {:nonnull} stack_3 != 0;
    assume stack_3 > 0;
    assume {:nonnull} stack_3 != 0;
    assume stack_3 > 0;
    ...
    assume {:nonnull} Port != 0;
    assume Port > 0;
    call {:si_unique_call 891} status_20 := KeyboardSendIrpSynchronously(Mem_T.P_DEVICE_OBJECT[TopPort__DEVICE_EXTENSION(Port)], Irp_12, 0);
    assume {:nonnull} Irp_12 != 0;
    assume Irp_12 > 0;
    goto L71;
  ...
  L71:
    assume {:nonnull} Port != 0;
    assume Port > 0;
    call {:si_unique_call 892} status_20 := IoRegisterPlugPlayNotification(3, 0, 0, 0, li2bplFunctionConstant656, 0, 0);
    goto L36;
  ...
  anon26_Then:
    assume {:partition} EnableFlag == 0;
    call {:si_unique_call 893} vslice_dummy_var_88 := sdv_ObDereferenceObject(0);
    assume {:nonnull} File_1 != 0;
    assume File_1 > 0;
    goto L36;
  ...
  anon22_Then:
    ...
    assume {:nonnull} Port != 0;
    assume Port > 0;
    call {:si_unique_call 894} sdv_IoCopyCurrentIrpStackLocationToNext(Irp_12);
    call {:si_unique_call 895} stack_3 := sdv_IoGetNextIrpStackLocation(Irp_12);
    assume {:nonnull} stack_3 != 0;
    assume stack_3 > 0;
    assume {:nonnull} stack_3 != 0;
    assume stack_3 > 0;
  ...
  L107:
    ...
    assume {:nonnull} Port != 0;
    assume Port > 0;
    call {:si_unique_call 896} status_20 := KeyboardSendIrpSynchronously(Mem_T.P_DEVICE_OBJECT[TopPort__DEVICE_EXTENSION(Port)], Irp_12, 0);
    goto L36;
...
implementation {:origName "KeyboardCallAllPorts"} KeyboardCallAllPorts#0(actual_Device: int, actual_Irp_6: int, actual_CallAll: int) returns (Tmp_184: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 897} Tmp_186 := __HAVOC_malloc(4);
    call {:si_unique_call 898} Tmp_188 := __HAVOC_malloc(4);
    call {:si_unique_call 899} Tmp_189 := __HAVOC_malloc(4);
    call {:si_unique_call 900} Tmp_192 := __HAVOC_malloc(4);
  ...
  L56:
    call {:si_unique_call 901} nextSp := sdv_IoGetNextIrpStackLocation(Irp_6);
    call {:si_unique_call 902} sdv_IoCopyCurrentIrpStackLocationToNext(Irp_6);
    assume {:nonnull} nextSp != 0;
    assume nextSp > 0;
    goto L16;

  L16:
    call {:si_unique_call 903} Tmp_189, Tmp_191, Tmp_192, Tmp_193, Tmp_194, Tmp_195 := KeyboardCallAllPorts#0_loop_L16(Tmp_189, Tmp_191, Tmp_192, Tmp_193, Tmp_194, Tmp_195, CallAll);
    goto L16_last;
  ...
  anon17_Else:
    ...
    assume {:nonnull} CallAll != 0;
    assume CallAll > 0;
    call {:si_unique_call 904} sdv_IoSetCompletionRoutine(Irp_6, li2bplFunctionConstant643, CallAll, 1, 1, 1);
    assume {:nonnull} port != 0;
    assume port > 0;
    assume false;
    assume {:nonnull} port != 0;
    assume port > 0;
    call {:si_unique_call 905} vslice_dummy_var_89 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(port), Irp_6);
    return;
  ...
  L38:
    ...
    call {:si_unique_call 907} vslice_dummy_var_90 := sdv_IoReleaseRemoveLock(vslice_dummy_var_1132, Irp_6);
...
procedure {:origName "KeyboardCallAllPorts"} KeyboardCallAllPorts#0(actual_Device: int, actual_Irp_6: int, actual_CallAll: int) returns (Tmp_184: int);
  modifies alloc, sdv_compFset, sdv_invoke_on_success, sdv_invoke_on_error, sdv_invoke_on_cancel;
...
implementation {:origName "KeyboardCallAllPorts"} KeyboardCallAllPorts#1(actual_Device: int, actual_Irp_6: int, actual_CallAll: int) returns (Tmp_184: int)
{
  var {:pointer} nextSp: int;
  var {:pointer} Tmp_186: int;
  var {:scalar} Tmp_187: int;
  ...
  anon0:
    Irp_6 := actual_Irp_6;
    CallAll := actual_CallAll;
    call {:si_unique_call 909} Tmp_186 := __HAVOC_malloc(4);
    call {:si_unique_call 910} Tmp_188 := __HAVOC_malloc(4);
    call {:si_unique_call 911} Tmp_189 := __HAVOC_malloc(4);
    call {:si_unique_call 912} Tmp_192 := __HAVOC_malloc(4);
    assume {:nonnull} CallAll != 0;
    assume CallAll > 0;
    goto anon15_Then, anon15_Else;
  ...
  L56:
    call {:si_unique_call 913} nextSp := sdv_IoGetNextIrpStackLocation(Irp_6);
    call {:si_unique_call 914} sdv_IoCopyCurrentIrpStackLocationToNext(Irp_6);
    assume {:nonnull} nextSp != 0;
    assume nextSp > 0;
    goto L16;

  L16:
    call {:si_unique_call 915} Tmp_189, Tmp_191, Tmp_192, Tmp_193, Tmp_194, Tmp_195 := KeyboardCallAllPorts#1_loop_L16(Tmp_189, Tmp_191, Tmp_192, Tmp_193, Tmp_194, Tmp_195, CallAll);
    goto L16_last;
  ...
  anon17_Else:
    ...
    assume {:nonnull} CallAll != 0;
    assume CallAll > 0;
    call {:si_unique_call 916} sdv_IoSetCompletionRoutine(Irp_6, li2bplFunctionConstant643, CallAll, 1, 1, 1);
    assume {:nonnull} port != 0;
    assume port > 0;
    call {:si_unique_call 917} status_7 := sdv_IoCallDriver#0(Mem_T.P_DEVICE_OBJECT[TopPort__DEVICE_EXTENSION(port)], Irp_6);
    assume {:nonnull} port != 0;
    assume port > 0;
    call {:si_unique_call 918} vslice_dummy_var_91 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(port), Irp_6);
    goto anon19_Then, anon19_Else;
  ...
  anon18_Else:
    call {:si_unique_call 919} sdv_IoMarkIrpPending(0);
    goto L38;

  L38:
    havoc vslice_dummy_var_1133;
    call {:si_unique_call 920} vslice_dummy_var_92 := sdv_IoReleaseRemoveLock(vslice_dummy_var_1133, Irp_6);
...
procedure {:origName "KeyboardCallAllPorts"} KeyboardCallAllPorts#1(actual_Device: int, actual_Irp_6: int, actual_CallAll: int) returns (Tmp_184: int);
  modifies alloc, sdv_compFset, sdv_invoke_on_success, sdv_invoke_on_error, sdv_invoke_on_cancel, Mem_T.Status__IO_STATUS_BLOCK;
  free ensures {:va_keep} Tmp_184 == 259 || Tmp_184 == -1073741802 || Tmp_184 == 0;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);



implementation {:origName "sdv_IoCallDriver"} {:osmodel} sdv_IoCallDriver#0(actual_DeviceObject_8: int, actual_Irp_5: int) returns (Tmp_133: int)
{
  var {:pointer} Irp_5: int;

  anon0:
    Irp_5 := actual_Irp_5;
    call {:si_unique_call 922} Tmp_133 := IofCallDriver#0(0, Irp_5);
    return;
}



procedure {:origName "sdv_IoCallDriver"} {:osmodel} sdv_IoCallDriver#0(actual_DeviceObject_8: int, actual_Irp_5: int) returns (Tmp_133: int);
  modifies alloc, Mem_T.Status__IO_STATUS_BLOCK, sdv_compFset, sdv_invoke_on_success, sdv_invoke_on_error, sdv_invoke_on_cancel;
...
implementation {:origName "sdv_IoCallDriver"} {:osmodel} sdv_IoCallDriver#1(actual_DeviceObject_8: int, actual_Irp_5: int) returns (Tmp_133: int)
{
  var {:pointer} Irp_5: int;

  anon0:
    Irp_5 := actual_Irp_5;
    call {:si_unique_call 923} Tmp_133 := IofCallDriver#1(0, Irp_5);
    return;
}



procedure {:origName "sdv_IoCallDriver"} {:osmodel} sdv_IoCallDriver#1(actual_DeviceObject_8: int, actual_Irp_5: int) returns (Tmp_133: int);
  modifies alloc, Mem_T.Status__IO_STATUS_BLOCK, sdv_compFset, sdv_invoke_on_success, sdv_invoke_on_error, sdv_invoke_on_cancel;
  free ensures {:va_keep} Tmp_133 == 259;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);
...
implementation {:origName "IofCallDriver"} {:osmodel} IofCallDriver#0(actual_DeviceObject_6: int, actual_Irp_3: int) returns (Tmp_125: int)
{
  ...
  anon0:
    call {:si_unique_call 924} completion := __HAVOC_malloc(4);
    Irp_3 := actual_Irp_3;
  ...
  anon47_Then:
    ...
    call {:si_unique_call 925} vslice_dummy_var_93 := sdv_RunIoCompletionRoutines#0(sdv_p_devobj_fdo, Irp_3, vslice_dummy_var_1134, completion);
    goto L29;
  ...
  anon59_Else:
    ...
    call {:si_unique_call 926} vslice_dummy_var_96 := sdv_RunIoCompletionRoutines#0(sdv_p_devobj_fdo, Irp_3, vslice_dummy_var_1135, completion);
    goto L29;
  ...
  anon51_Else:
    ...
    call {:si_unique_call 927} vslice_dummy_var_94 := sdv_RunIoCompletionRoutines#0(sdv_p_devobj_fdo, Irp_3, vslice_dummy_var_1136, completion);
    goto L29;
  ...
  anon55_Else:
    ...
    call {:si_unique_call 928} vslice_dummy_var_95 := sdv_RunIoCompletionRoutines#0(sdv_p_devobj_fdo, Irp_3, vslice_dummy_var_1137, completion);
    goto L29;
...
procedure {:origName "IofCallDriver"} {:osmodel} IofCallDriver#0(actual_DeviceObject_6: int, actual_Irp_3: int) returns (Tmp_125: int);
  modifies alloc, Mem_T.Status__IO_STATUS_BLOCK, sdv_compFset, sdv_invoke_on_success, sdv_invoke_on_error, sdv_invoke_on_cancel;
  free ensures {:va_keep} Tmp_125 == 259;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);



implementation {:origName "IofCallDriver"} {:osmodel} IofCallDriver#1(actual_DeviceObject_6: int, actual_Irp_3: int) returns (Tmp_125: int)
{
  var {:dopa} {:scalar} completion: int;
  var {:scalar} status_5: int;
  var {:pointer} Irp_3: int;
  ...
  anon0:
    call {:si_unique_call 929} completion := __HAVOC_malloc(4);
    Irp_3 := actual_Irp_3;
    assume {:nonnull} completion != 0;
    assume completion > 0;
    status_5 := 259;
  ...
  anon47_Then:
    ...
    call {:si_unique_call 930} vslice_dummy_var_97 := sdv_RunIoCompletionRoutines#1(sdv_p_devobj_fdo, Irp_3, vslice_dummy_var_1138, completion);
    goto L29;
  ...
  anon59_Else:
    ...
    call {:si_unique_call 931} vslice_dummy_var_100 := sdv_RunIoCompletionRoutines#1(sdv_p_devobj_fdo, Irp_3, vslice_dummy_var_1139, completion);
    goto L29;
  ...
  anon51_Else:
    ...
    call {:si_unique_call 932} vslice_dummy_var_98 := sdv_RunIoCompletionRoutines#1(sdv_p_devobj_fdo, Irp_3, vslice_dummy_var_1140, completion);
    goto L29;
  ...
  anon55_Else:
    ...
    call {:si_unique_call 933} vslice_dummy_var_99 := sdv_RunIoCompletionRoutines#1(sdv_p_devobj_fdo, Irp_3, vslice_dummy_var_1141, completion);
    goto L29;
...
procedure {:origName "IofCallDriver"} {:osmodel} IofCallDriver#1(actual_DeviceObject_6: int, actual_Irp_3: int) returns (Tmp_125: int);
  modifies alloc, Mem_T.Status__IO_STATUS_BLOCK, sdv_compFset, sdv_invoke_on_success, sdv_invoke_on_error, sdv_invoke_on_cancel;
  free ensures {:va_keep} Tmp_125 == 259;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);
...
implementation {:origName "sdv_RunIoCompletionRoutines"} {:osmodel} sdv_RunIoCompletionRoutines#0(actual_DeviceObject_7: int, actual_Irp_4: int, actual_Context_5: int, actual_Completion: int) returns (Tmp_129: int)
{
  var {:scalar} Status: int;
  var {:pointer} irpsp: int;
  ...
  anon0:
    ...
    call {:si_unique_call 934} irpsp := sdv_IoGetNextIrpStackLocation(Irp_4);
    Status := 0;
    assume {:nonnull} irpsp != 0;
    assume irpsp > 0;
    goto anon12_Then, anon12_Else;
  ...
  anon12_Else:
    call {:si_unique_call 935} Status := KbdSyncComplete(DeviceObject_7, Irp_4, Context_5);
    assume {:nonnull} Completion != 0;
    assume Completion > 0;
    goto L11;
  ...
  anon9_Else:
    call {:si_unique_call 936} Status := KeyboardCallAllPorts#0(DeviceObject_7, Irp_4, Context_5);
    assume {:nonnull} Completion != 0;
    assume Completion > 0;
    goto L28;
  ...
  anon10_Else:
    call {:si_unique_call 937} Status := KeyboardClassPowerComplete#0(DeviceObject_7, Irp_4, Context_5);
    assume {:nonnull} Completion != 0;
    assume Completion > 0;
    goto L45;
  ...
  anon11_Else:
    call {:si_unique_call 938} Status := KeyboardClassSetLedsComplete(DeviceObject_7, Irp_4, Context_5);
    assume {:nonnull} Completion != 0;
    assume Completion > 0;
    goto L62;
...
procedure {:origName "sdv_RunIoCompletionRoutines"} {:osmodel} sdv_RunIoCompletionRoutines#0(actual_DeviceObject_7: int, actual_Irp_4: int, actual_Context_5: int, actual_Completion: int) returns (Tmp_129: int);
  modifies alloc, sdv_compFset, sdv_invoke_on_success, sdv_invoke_on_error, sdv_invoke_on_cancel, Mem_T.Status__IO_STATUS_BLOCK;
  free ensures {:va_keep} Tmp_129 == -1073741802 || Tmp_129 == -1073741823 || Tmp_129 == 0;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);



implementation {:origName "sdv_RunIoCompletionRoutines"} {:osmodel} sdv_RunIoCompletionRoutines#1(actual_DeviceObject_7: int, actual_Irp_4: int, actual_Context_5: int, actual_Completion: int) returns (Tmp_129: int)
{
  var {:scalar} Status: int;
  var {:pointer} irpsp: int;
  var {:pointer} DeviceObject_7: int;
  ...
  anon0:
    ...
    Context_5 := actual_Context_5;
    Completion := actual_Completion;
    call {:si_unique_call 939} irpsp := sdv_IoGetNextIrpStackLocation(Irp_4);
    Status := 0;
    assume {:nonnull} irpsp != 0;
    assume irpsp > 0;
    goto anon12_Then, anon12_Else;
  ...
  anon12_Else:
    call {:si_unique_call 940} Status := KbdSyncComplete(DeviceObject_7, Irp_4, Context_5);
    assume {:nonnull} Completion != 0;
    assume Completion > 0;
    goto L11;
  ...
  anon9_Else:
    call {:si_unique_call 941} Status := KeyboardCallAllPorts#1(DeviceObject_7, Irp_4, Context_5);
    assume {:nonnull} Completion != 0;
    assume Completion > 0;
    goto L28;
  ...
  anon10_Else:
    call {:si_unique_call 942} Status := KeyboardClassPowerComplete#1(DeviceObject_7, Irp_4, Context_5);
    assume {:nonnull} Completion != 0;
    assume Completion > 0;
    goto L45;
  ...
  anon11_Else:
    call {:si_unique_call 943} Status := KeyboardClassSetLedsComplete(DeviceObject_7, Irp_4, Context_5);
    assume {:nonnull} Completion != 0;
    assume Completion > 0;
    goto L62;
...
procedure {:origName "sdv_RunIoCompletionRoutines"} {:osmodel} sdv_RunIoCompletionRoutines#1(actual_DeviceObject_7: int, actual_Irp_4: int, actual_Context_5: int, actual_Completion: int) returns (Tmp_129: int);
  modifies alloc, sdv_compFset, sdv_invoke_on_success, sdv_invoke_on_error, sdv_invoke_on_cancel, Mem_T.Status__IO_STATUS_BLOCK;
  free ensures {:va_keep} Tmp_129 == -1073741802 || Tmp_129 == -1073741823 || Tmp_129 == 0 || Tmp_129 == 259;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);



implementation {:origName "KeyboardClassPowerComplete"} KeyboardClassPowerComplete#0(actual_DeviceObject_12: int, actual_Irp_7: int, actual_Context_6: int) returns (Tmp_196: int)
{
  var {:pointer} SD2: int;
  var {:pointer} SD1: int;
  var {:pointer} file: int;
  ...
  anon0:
    call {:si_unique_call 944} powerState := __HAVOC_malloc(8);
    call {:si_unique_call 945} sdv_1 := __HAVOC_malloc(8);
    call {:si_unique_call 946} sdv_2 := __HAVOC_malloc(8);
    DeviceObject_12 := actual_DeviceObject_12;
    Irp_7 := actual_Irp_7;
    assume {:nonnull} DeviceObject_12 != 0;
    assume DeviceObject_12 > 0;
    data := Mem_T.DeviceExtension__DEVICE_OBJECT[DeviceExtension__DEVICE_OBJECT(DeviceObject_12)];
    call {:si_unique_call 947} stack_1 := sdv_IoGetCurrentIrpStackLocation(Irp_7);
    call {:si_unique_call 948} next := sdv_IoGetNextIrpStackLocation(Irp_7);
  ...
  L79:
    ...
    assume {:nonnull} data != 0;
    assume data > 0;
    call {:si_unique_call 950} vslice_dummy_var_101 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(data), Irp_7);
    Tmp_196 := 0;
    return;
  ...
  anon20_Then:
    assume {:partition} powerType == 1;
    call {:si_unique_call 951} SD2 := PoSetPowerState(0, powerType, powerState);
    ...
    call {:si_unique_call 952} irpLeds := IoAllocateIrp(vslice_dummy_var_1142, 0);
    goto anon16_Then, anon16_Else;
  ...
  anon16_Then:
    assume {:partition} irpLeds != 0;
    call {:si_unique_call 953} status_8 := sdv_IoAcquireRemoveLock(0, 0);
    goto anon17_Then, anon17_Else;
  ...
  L53:
    call {:si_unique_call 954} next := sdv_IoGetNextIrpStackLocation(irpLeds);
    ...
    assume {:nonnull} next != 0;
    assume next > 0;
    call {:si_unique_call 955} sdv_IoSetCompletionRoutine(irpLeds, li2bplFunctionConstant675, data, 1, 1, 1);
  ...
  anon17_Then:
    ...
    call {:si_unique_call 956} IoFreeIrp(0);
    goto L79;

  anon15_Then:
    assume {:partition} powerType == 0;
    call {:si_unique_call 957} SD1 := PoSetPowerState(0, powerType, powerState);
    ...
    assume {:nonnull} powerState != 0;
    assume powerState > 0;
    call {:si_unique_call 958} status_8 := PoRequestPowerIrp(0, 2, powerState, li2bplFunctionConstant674, 0, 0);
    goto anon19_Then, anon19_Else;
  ...
  anon19_Then:
    ...
    assume Irp_7 > 0;
    Mem_T.Status__IO_STATUS_BLOCK[Status__IO_STATUS_BLOCK(IoStatus__IRP(Irp_7))] := status_8;
    goto L79;
}



procedure {:origName "KeyboardClassPowerComplete"} KeyboardClassPowerComplete#0(actual_DeviceObject_12: int, actual_Irp_7: int, actual_Context_6: int) returns (Tmp_196: int);
  modifies alloc, sdv_compFset, sdv_invoke_on_success, sdv_invoke_on_error, sdv_invoke_on_cancel, Mem_T.Status__IO_STATUS_BLOCK;
  free ensures {:va_keep} Tmp_196 == 0;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);



implementation {:origName "KeyboardClassPowerComplete"} KeyboardClassPowerComplete#1(actual_DeviceObject_12: int, actual_Irp_7: int, actual_Context_6: int) returns (Tmp_196: int)
{
  var {:pointer} SD2: int;
  var {:pointer} SD1: int;
  var {:pointer} file: int;
  ...
  anon0:
    call {:si_unique_call 959} powerState := __HAVOC_malloc(8);
    call {:si_unique_call 960} sdv_1 := __HAVOC_malloc(8);
    call {:si_unique_call 961} sdv_2 := __HAVOC_malloc(8);
    DeviceObject_12 := actual_DeviceObject_12;
    Irp_7 := actual_Irp_7;
    assume {:nonnull} DeviceObject_12 != 0;
    assume DeviceObject_12 > 0;
    data := Mem_T.DeviceExtension__DEVICE_OBJECT[DeviceExtension__DEVICE_OBJECT(DeviceObject_12)];
    call {:si_unique_call 962} stack_1 := sdv_IoGetCurrentIrpStackLocation(Irp_7);
    call {:si_unique_call 963} next := sdv_IoGetNextIrpStackLocation(Irp_7);
    assume {:nonnull} stack_1 != 0;
    assume stack_1 > 0;
    havoc powerType;
    assume {:nonnull} powerState != 0;
  ...
  L79:
    ...
    assume {:nonnull} data != 0;
    assume data > 0;
    call {:si_unique_call 965} vslice_dummy_var_102 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(data), Irp_7);
    Tmp_196 := 0;
    return;
  ...
  anon20_Then:
    assume {:partition} powerType == 1;
    call {:si_unique_call 966} SD2 := PoSetPowerState(0, powerType, powerState);
    assume {:nonnull} SD2 != 0;
    assume SD2 > 0;
    assume {:nonnull} sdv_2 != 0;
    assume sdv_2 > 0;
    ...
    call {:si_unique_call 967} irpLeds := IoAllocateIrp(vslice_dummy_var_1143, 0);
    goto anon16_Then, anon16_Else;
  ...
  anon16_Then:
    assume {:partition} irpLeds != 0;
    call {:si_unique_call 968} status_8 := sdv_IoAcquireRemoveLock(0, 0);
    goto anon17_Then, anon17_Else;
  ...
  L53:
    call {:si_unique_call 969} next := sdv_IoGetNextIrpStackLocation(irpLeds);
    assume {:nonnull} next != 0;
    assume next > 0;
    assume {:nonnull} next != 0;
    assume next > 0;
    ...
    assume {:nonnull} next != 0;
    assume next > 0;
    call {:si_unique_call 970} sdv_IoSetCompletionRoutine(irpLeds, li2bplFunctionConstant675, data, 1, 1, 1);
    assume {:nonnull} irpLeds != 0;
    assume irpLeds > 0;
    assume {:nonnull} data != 0;
    assume data > 0;
    call {:si_unique_call 971} vslice_dummy_var_103 := sdv_IoCallDriver#0(Mem_T.P_DEVICE_OBJECT[TopPort__DEVICE_EXTENSION(data)], irpLeds);
    goto L79;
  ...
  anon17_Then:
    assume {:partition} 0 > status_8;
    call {:si_unique_call 972} IoFreeIrp(0);
    goto L79;

  anon15_Then:
    assume {:partition} powerType == 0;
    call {:si_unique_call 973} SD1 := PoSetPowerState(0, powerType, powerState);
    assume {:nonnull} SD1 != 0;
    assume SD1 > 0;
    assume {:nonnull} sdv_1 != 0;
    assume sdv_1 > 0;
    ...
    assume {:nonnull} powerState != 0;
    assume powerState > 0;
    call {:si_unique_call 974} status_8 := PoRequestPowerIrp(0, 2, powerState, li2bplFunctionConstant674, 0, 0);
    goto anon19_Then, anon19_Else;
...
procedure {:origName "KeyboardClassPowerComplete"} KeyboardClassPowerComplete#1(actual_DeviceObject_12: int, actual_Irp_7: int, actual_Context_6: int) returns (Tmp_196: int);
  modifies alloc, sdv_compFset, sdv_invoke_on_success, sdv_invoke_on_error, sdv_invoke_on_cancel, Mem_T.Status__IO_STATUS_BLOCK;
  free ensures {:va_keep} Tmp_196 == 0;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);
...
implementation KeyboardClassDequeueReadByFileObject_loop_L14(in_oldCancelRoutine: int, in_sdv_75: int, in_irp: int, in_entry: int, in_stack: int, in_FileObject_1: int, in_vslice_dummy_var_41: int) returns (out_oldCancelRoutine: int, out_sdv_75: int, out_irp: int, out_entry: int, out_stack: int, out_vslice_dummy_var_41: int)
{

  entry:
    out_oldCancelRoutine, out_sdv_75, out_irp, out_entry, out_stack, out_vslice_dummy_var_41 := in_oldCancelRoutine, in_sdv_75, in_irp, in_entry, in_stack, in_vslice_dummy_var_41;
    goto L14, exit;
  ...
  anon9_Else:
    call {:si_unique_call 976} out_sdv_75 := sdv_containing_record(out_entry, 88);
    out_irp := out_sdv_75;
    call {:si_unique_call 977} out_stack := sdv_IoGetCurrentIrpStackLocation(out_irp);
    assume {:nonnull} out_stack != 0;
    assume out_stack > 0;
    goto anon10_Then, anon10_Else;

  anon10_Else:
    call {:si_unique_call 978} out_vslice_dummy_var_41 := sdv_RemoveEntryList(0);
    call {:si_unique_call 979} out_oldCancelRoutine := sdv_IoSetCancelRoutine(out_irp, 0);
    goto anon11_Then;
  ...
  anon11_Then:
    ...
    assume out_irp > 0;
    call {:si_unique_call 975} InitializeListHead(ListEntry_unnamed_tag_6(Overlay_unnamed_tag_5(Tail__IRP(out_irp))));
    goto L25;
  ...
  L25_dummy:
    call {:si_unique_call 980} {:si_old_unique_call 1} out_oldCancelRoutine, out_sdv_75, out_irp, out_entry, out_stack, out_vslice_dummy_var_41 := KeyboardClassDequeueReadByFileObject_loop_L14(out_oldCancelRoutine, out_sdv_75, out_irp, out_entry, out_stack, in_FileObject_1, out_vslice_dummy_var_41);
    return;
...
procedure {:LoopProcedure} KeyboardClassDequeueReadByFileObject_loop_L14(in_oldCancelRoutine: int, in_sdv_75: int, in_irp: int, in_entry: int, in_stack: int, in_FileObject_1: int, in_vslice_dummy_var_41: int) returns (out_oldCancelRoutine: int, out_sdv_75: int, out_irp: int, out_entry: int, out_stack: int, out_vslice_dummy_var_41: int);
  modifies alloc;
  free ensures {:va_keep} out_vslice_dummy_var_41 == 1 || out_vslice_dummy_var_41 == 0 || out_vslice_dummy_var_41 == in_vslice_dummy_var_41;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);
...
implementation DriverEntry_loop_L178(in_entry_1: int) returns (out_entry_1: int)
{
  ...
  anon59_Else_dummy:
    call {:si_unique_call 981} {:si_old_unique_call 1} out_entry_1 := DriverEntry_loop_L178(out_entry_1);
    return;
}
...
implementation DriverEntry_loop_L98(in_i: int, in_Tmp_202: int, in_Tmp_203: int, in_classDeviceObject: int, in_fullPortName: int, in_file_1: int, in_fullClassName: int, in_Tmp_209: int, in_Tmp_214: int, in_Tmp_220: int, in_numPorts: int, in_status_9: int, in_deviceExtension: int, in_Tmp_227: int, in_DriverObject_3: int, in_vslice_dummy_var_45: int, in_vslice_dummy_var_46: int) returns (out_i: int, out_Tmp_202: int, out_Tmp_203: int, out_file_1: int, out_Tmp_209: int, out_Tmp_214: int, out_Tmp_220: int, out_status_9: int, out_deviceExtension: int, out_Tmp_227: int, out_vslice_dummy_var_45: int, out_vslice_dummy_var_46: int)
{
  var vslice_dummy_var_1144: int;
  var vslice_dummy_var_1145: int;

  entry:
    out_i, out_Tmp_202, out_Tmp_203, out_file_1, out_Tmp_209, out_Tmp_214, out_Tmp_220, out_status_9, out_deviceExtension, out_Tmp_227, out_vslice_dummy_var_45, out_vslice_dummy_var_46 := in_i, in_Tmp_202, in_Tmp_203, in_file_1, in_Tmp_209, in_Tmp_214, in_Tmp_220, in_status_9, in_deviceExtension, in_Tmp_227, in_vslice_dummy_var_45, in_vslice_dummy_var_46;
    goto L98, exit;
  ...
  anon49_Else:
    ...
    out_Tmp_220 := INTDIV(Mem_T.Length_unnamed_tag_18[Length_unnamed_tag_18(in_fullPortName)], 2) - 1;
    ...
    assume {:nonnull} in_fullPortName != 0;
    assume in_fullPortName > 0;
    call {:si_unique_call 986} out_status_9 := KbdCreateClassObject(in_DriverObject_3, InitExtension__GLOBALS(Globals), in_classDeviceObject, in_fullClassName, 1);
    goto anon50_Then, anon50_Else;
  ...
  anon50_Else:
    ...
    assume {:nonnull} out_deviceExtension != 0;
    assume out_deviceExtension > 0;
    call {:si_unique_call 988} out_status_9 := IoGetDeviceObjectPointer(0, 128, 0, TopPort__DEVICE_EXTENSION(out_deviceExtension));
    goto anon51_Then, anon51_Else;
  ...
  anon51_Else:
    ...
    assume {:nonnull} out_deviceExtension != 0;
    assume out_deviceExtension > 0;
    out_Tmp_214 := Mem_T.P_DEVICE_OBJECT[TopPort__DEVICE_EXTENSION(out_deviceExtension)];
    assume {:nonnull} Mem_T.P_DEVICE_OBJECT[in_classDeviceObject] != 0;
    assume Mem_T.P_DEVICE_OBJECT[in_classDeviceObject] > 0;
    ...
    call {:si_unique_call 994} out_status_9 := KeyboardAddDeviceEx(out_deviceExtension, Mem_T.PINT4[in_fullClassName], out_file_1);
    assume {:nonnull} in_fullClassName != 0;
    assume in_fullClassName > 0;
    goto anon53_Then, anon53_Else;
  ...
  anon54_Else:
    ...
    assume {:nonnull} out_deviceExtension != 0;
    assume out_deviceExtension > 0;
    call {:si_unique_call 982} out_vslice_dummy_var_45 := sdv_InsertTailList(LegacyDeviceList__GLOBALS(Globals), Link__DEVICE_EXTENSION(out_deviceExtension));
    goto L134;
  ...
  L134_dummy:
    call {:si_unique_call 995} {:si_old_unique_call 1} out_i, out_Tmp_202, out_Tmp_203, out_file_1, out_Tmp_209, out_Tmp_214, out_Tmp_220, out_status_9, out_deviceExtension, out_Tmp_227, out_vslice_dummy_var_45, out_vslice_dummy_var_46 := DriverEntry_loop_L98(out_i, out_Tmp_202, out_Tmp_203, in_classDeviceObject, in_fullPortName, out_file_1, in_fullClassName, out_Tmp_209, out_Tmp_214, out_Tmp_220, in_numPorts, out_status_9, out_deviceExtension, out_Tmp_227, in_DriverObject_3, out_vslice_dummy_var_45, out_vslice_dummy_var_46);
    return;
  ...
  anon55_Else:
    call {:si_unique_call 991} ExAcquireFastMutex(0);
    assume {:nonnull} out_deviceExtension != 0;
    assume out_deviceExtension > 0;
    havoc out_Tmp_203;
    havoc out_file_1;
  ...
  anon57_Else:
    ...
    call {:si_unique_call 990} out_vslice_dummy_var_46 := sdv_ObDereferenceObject(0);
    goto L148;
  ...
  anon58_Else:
    ...
    Mem_T.InputData__DEVICE_EXTENSION[InputData__DEVICE_EXTENSION(out_deviceExtension)] := vslice_dummy_var_1145;
    goto L152;
  ...
  anon52_Else:
    ...
    Mem_T.InputData__DEVICE_EXTENSION[InputData__DEVICE_EXTENSION(out_deviceExtension)] := vslice_dummy_var_1144;
    goto L165;

  L165:
    call {:si_unique_call 984} IoDeleteDevice(0);
    out_deviceExtension := 0;
    goto L134;
  ...
  anon50_Then:
    assume {:partition} 0 > out_status_9;
    call {:si_unique_call 985} KeyboardClassLogError(li2bplFunctionConstant624, -1073414143, 10008, out_status_9, 0, 0, 0);
    goto L134;
}



procedure {:LoopProcedure} DriverEntry_loop_L98(in_i: int, in_Tmp_202: int, in_Tmp_203: int, in_classDeviceObject: int, in_fullPortName: int, in_file_1: int, in_fullClassName: int, in_Tmp_209: int, in_Tmp_214: int, in_Tmp_220: int, in_numPorts: int, in_status_9: int, in_deviceExtension: int, in_Tmp_227: int, in_DriverObject_3: int, in_vslice_dummy_var_45: int, in_vslice_dummy_var_46: int) returns (out_i: int, out_Tmp_202: int, out_Tmp_203: int, out_file_1: int, out_Tmp_209: int, out_Tmp_214: int, out_Tmp_220: int, out_status_9: int, out_deviceExtension: int, out_Tmp_227: int, out_vslice_dummy_var_45: int, out_vslice_dummy_var_46: int);
  modifies alloc, Mem_T.Length_unnamed_tag_18, Mem_T.MaximumLength__UNICODE_STRING, Mem_T.Buffer__UNICODE_STRING, Mem_T.P_DEVICE_OBJECT, Mem_T.PINT4, Mem_T.PnP__DEVICE_EXTENSION, Mem_T.InputData__DEVICE_EXTENSION, Mem_T.Status__IO_STATUS_BLOCK, sdv_compFset, sdv_invoke_on_success, sdv_invoke_on_error, sdv_invoke_on_cancel;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);
...
implementation KeyboardClassCleanupQueue_loop_L27(in_listHead: int, in_sdv_103: int, in_sdv_105: int, in_irp_1: int, in_entry_2: int, in_DeviceExtension_1: int, in_vslice_dummy_var_55: int) returns (out_sdv_103: int, out_sdv_105: int, out_irp_1: int, out_entry_2: int, out_vslice_dummy_var_55: int)
{

  entry:
    out_sdv_103, out_sdv_105, out_irp_1, out_entry_2, out_vslice_dummy_var_55 := in_sdv_103, in_sdv_105, in_irp_1, in_entry_2, in_vslice_dummy_var_55;
    goto L27, exit;
  ...
  L27:
    call {:si_unique_call 996} out_sdv_103 := sdv_IsListEmpty(0);
    goto anon9_Else;

  anon9_Else:
    assume {:partition} out_sdv_103 == 0;
    call {:si_unique_call 997} out_entry_2 := RemoveHeadList(in_listHead);
    call {:si_unique_call 998} out_sdv_105 := sdv_containing_record(out_entry_2, 88);
    out_irp_1 := out_sdv_105;
    call {:si_unique_call 999} sdv_IoCompleteRequest(0, 0);
    assume {:nonnull} in_DeviceExtension_1 != 0;
    assume in_DeviceExtension_1 > 0;
    call {:si_unique_call 1000} out_vslice_dummy_var_55 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(in_DeviceExtension_1), out_irp_1);
    goto anon9_Else_dummy;

  anon9_Else_dummy:
    call {:si_unique_call 1001} {:si_old_unique_call 1} out_sdv_103, out_sdv_105, out_irp_1, out_entry_2, out_vslice_dummy_var_55 := KeyboardClassCleanupQueue_loop_L27(in_listHead, out_sdv_103, out_sdv_105, out_irp_1, out_entry_2, in_DeviceExtension_1, out_vslice_dummy_var_55);
    return;
}



procedure {:LoopProcedure} KeyboardClassCleanupQueue_loop_L27(in_listHead: int, in_sdv_103: int, in_sdv_105: int, in_irp_1: int, in_entry_2: int, in_DeviceExtension_1: int, in_vslice_dummy_var_55: int) returns (out_sdv_103: int, out_sdv_105: int, out_irp_1: int, out_entry_2: int, out_vslice_dummy_var_55: int);
  modifies alloc;
  free ensures {:va_keep} out_sdv_103 == 1 || out_sdv_103 == 0 || out_sdv_103 == in_sdv_103;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);



implementation KeyboardClassCleanupQueue_loop_L13(in_listHead: int, in_irp_1: int, in_DeviceExtension_1: int, in_FileObject_2: int, in_vslice_dummy_var_56: int) returns (out_irp_1: int, out_vslice_dummy_var_56: int)
{

  entry:
    out_irp_1, out_vslice_dummy_var_56 := in_irp_1, in_vslice_dummy_var_56;
    goto L13, exit;
  ...
  L13:
    call {:si_unique_call 1002} out_irp_1 := KeyboardClassDequeueReadByFileObject(in_DeviceExtension_1, in_FileObject_2);
    goto anon7_Then, anon7_Else;
  ...
  anon7_Else:
    ...
    assume {:nonnull} out_irp_1 != 0;
    assume out_irp_1 > 0;
    call {:si_unique_call 1003} out_vslice_dummy_var_56 := sdv_InsertTailList(in_listHead, ListEntry_unnamed_tag_6(Overlay_unnamed_tag_5(Tail__IRP(out_irp_1))));
    goto L18;
  ...
  anon8_Then_dummy:
    call {:si_unique_call 1004} {:si_old_unique_call 1} out_irp_1, out_vslice_dummy_var_56 := KeyboardClassCleanupQueue_loop_L13(in_listHead, out_irp_1, in_DeviceExtension_1, in_FileObject_2, out_vslice_dummy_var_56);
    return;
...
procedure {:LoopProcedure} KeyboardClassCleanupQueue_loop_L13(in_listHead: int, in_irp_1: int, in_DeviceExtension_1: int, in_FileObject_2: int, in_vslice_dummy_var_56: int) returns (out_irp_1: int, out_vslice_dummy_var_56: int);
...
implementation KeyboardAddDeviceEx_loop_L86(in_i_1: int, in_Tmp_234: int, in_errorLogEntry: int, in_dumpData_1: int, in_Tmp_243: int, in_dumpCount_1: int, in_Tmp_248: int) returns (out_i_1: int, out_Tmp_234: int, out_Tmp_243: int, out_Tmp_248: int)
{

  entry:
    out_i_1, out_Tmp_234, out_Tmp_243, out_Tmp_248 := in_i_1, in_Tmp_234, in_Tmp_243, in_Tmp_248;
    goto L86, exit;
  ...
  anon40_Else_dummy:
    call {:si_unique_call 1005} {:si_old_unique_call 1} out_i_1, out_Tmp_234, out_Tmp_243, out_Tmp_248 := KeyboardAddDeviceEx_loop_L86(out_i_1, out_Tmp_234, in_errorLogEntry, in_dumpData_1, out_Tmp_243, in_dumpCount_1, out_Tmp_248);
    return;
}



procedure {:LoopProcedure} KeyboardAddDeviceEx_loop_L86(in_i_1: int, in_Tmp_234: int, in_errorLogEntry: int, in_dumpData_1: int, in_Tmp_243: int, in_dumpCount_1: int, in_Tmp_248: int) returns (out_i_1: int, out_Tmp_234: int, out_Tmp_243: int, out_Tmp_248: int);
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);



implementation KeyboardAddDeviceEx_loop_L37(in_i_1: int, in_Tmp_251: int) returns (out_i_1: int, out_Tmp_251: int)
{

  entry:
    out_i_1, out_Tmp_251 := in_i_1, in_Tmp_251;
    goto L37, exit;
...
procedure {:LoopProcedure} KeyboardAddDeviceEx_loop_L37(in_i_1: int, in_Tmp_251: int) returns (out_i_1: int, out_Tmp_251: int);
...
implementation KeyboardClassLogError_loop_L20(in_i_2: int, in_Tmp_264: int, in_errorLogEntry_1: int, in_Tmp_266: int, in_Tmp_267: int, in_DumpCount: int, in_DumpData: int) returns (out_i_2: int, out_Tmp_264: int, out_Tmp_266: int, out_Tmp_267: int)
{

  entry:
    out_i_2, out_Tmp_264, out_Tmp_266, out_Tmp_267 := in_i_2, in_Tmp_264, in_Tmp_266, in_Tmp_267;
    goto L20, exit;
  ...
  anon5_Else_dummy:
    call {:si_unique_call 1006} {:si_old_unique_call 1} out_i_2, out_Tmp_264, out_Tmp_266, out_Tmp_267 := KeyboardClassLogError_loop_L20(out_i_2, out_Tmp_264, in_errorLogEntry_1, out_Tmp_266, out_Tmp_267, in_DumpCount, in_DumpData);
    return;
}



procedure {:LoopProcedure} KeyboardClassLogError_loop_L20(in_i_2: int, in_Tmp_264: int, in_errorLogEntry_1: int, in_Tmp_266: int, in_Tmp_267: int, in_DumpCount: int, in_DumpData: int) returns (out_i_2: int, out_Tmp_264: int, out_Tmp_266: int, out_Tmp_267: int);
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);



implementation KbdCreateClassObject_loop_L123(in_Tmp_274: int, in_fullClassName_1: int, in_nameIndex: int, in_status_13: int, in_Tmp_281: int, in_ClassDeviceObject: int) returns (out_Tmp_274: int, out_nameIndex: int, out_status_13: int, out_Tmp_281: int)
{

  entry:
    out_Tmp_274, out_nameIndex, out_status_13, out_Tmp_281 := in_Tmp_274, in_nameIndex, in_status_13, in_Tmp_281;
    goto L123, exit;
  ...
  L123:
    ...
    out_Tmp_281 := INTDIV(Mem_T.Length_unnamed_tag_18[Length_unnamed_tag_18(in_fullClassName_1)], 2) - 1;
    out_Tmp_274 := out_nameIndex;
    ...
    assume {:nonnull} in_fullClassName_1 != 0;
    assume in_fullClassName_1 > 0;
    call {:si_unique_call 1007} out_status_13 := IoCreateDevice(0, 224, 0, 11, 0, 0, in_ClassDeviceObject);
    goto anon40_Then;
  ...
  anon40_Then_dummy:
    call {:si_unique_call 1008} {:si_old_unique_call 1} out_Tmp_274, out_nameIndex, out_status_13, out_Tmp_281 := KbdCreateClassObject_loop_L123(out_Tmp_274, in_fullClassName_1, out_nameIndex, out_status_13, out_Tmp_281, in_ClassDeviceObject);
    return;
}



procedure {:LoopProcedure} KbdCreateClassObject_loop_L123(in_Tmp_274: int, in_fullClassName_1: int, in_nameIndex: int, in_status_13: int, in_Tmp_281: int, in_ClassDeviceObject: int) returns (out_Tmp_274: int, out_nameIndex: int, out_status_13: int, out_Tmp_281: int);
  modifies Mem_T.P_DEVICE_OBJECT;
...
implementation KeyboardClassDequeueRead_loop_L6(in_sdv_144: int, in_listEntry: int, in_oldCancelRoutine_1: int, in_sdv_146: int, in_nextIrp: int, in_DeviceExtension_2: int) returns (out_sdv_144: int, out_listEntry: int, out_oldCancelRoutine_1: int, out_sdv_146: int, out_nextIrp: int)
{

  entry:
    out_sdv_144, out_listEntry, out_oldCancelRoutine_1, out_sdv_146, out_nextIrp := in_sdv_144, in_listEntry, in_oldCancelRoutine_1, in_sdv_146, in_nextIrp;
    goto L6, exit;
  ...
  anon7_Then:
    ...
    call {:si_unique_call 1013} out_sdv_144 := sdv_IsListEmpty(0);
    goto anon8_Else;
  ...
  anon8_Else:
    ...
    call {:si_unique_call 1010} out_listEntry := RemoveHeadList(ReadQueue__DEVICE_EXTENSION(in_DeviceExtension_2));
    call {:si_unique_call 1011} out_sdv_146 := sdv_containing_record(out_listEntry, 88);
    out_nextIrp := out_sdv_146;
    call {:si_unique_call 1012} out_oldCancelRoutine_1 := sdv_IoSetCancelRoutine(out_nextIrp, 0);
    goto anon9_Then, anon9_Else;
  ...
  anon9_Else:
    ...
    call {:si_unique_call 1009} InitializeListHead(ListEntry_unnamed_tag_6(Overlay_unnamed_tag_5(Tail__IRP(out_nextIrp))));
    out_nextIrp := 0;
    goto anon9_Else_dummy;
  ...
  L_BAF_0:
    call {:si_unique_call 1014} {:si_old_unique_call 1} out_sdv_144, out_listEntry, out_oldCancelRoutine_1, out_sdv_146, out_nextIrp := KeyboardClassDequeueRead_loop_L6(out_sdv_144, out_listEntry, out_oldCancelRoutine_1, out_sdv_146, out_nextIrp, in_DeviceExtension_2);
    return;
...
procedure {:LoopProcedure} KeyboardClassDequeueRead_loop_L6(in_sdv_144: int, in_listEntry: int, in_oldCancelRoutine_1: int, in_sdv_146: int, in_nextIrp: int, in_DeviceExtension_2: int) returns (out_sdv_144: int, out_listEntry: int, out_oldCancelRoutine_1: int, out_sdv_146: int, out_nextIrp: int);
  modifies alloc;
...
implementation KeyboardCallAllPorts#0_loop_L16(in_Tmp_189: int, in_Tmp_191: int, in_Tmp_192: int, in_Tmp_193: int, in_Tmp_194: int, in_Tmp_195: int, in_CallAll: int) returns (out_Tmp_189: int, out_Tmp_191: int, out_Tmp_192: int, out_Tmp_193: int, out_Tmp_194: int, out_Tmp_195: int)
{

  entry:
    out_Tmp_189, out_Tmp_191, out_Tmp_192, out_Tmp_193, out_Tmp_194, out_Tmp_195 := in_Tmp_189, in_Tmp_191, in_Tmp_192, in_Tmp_193, in_Tmp_194, in_Tmp_195;
    goto L16, exit;
  ...
  anon16_Else:
    ...
    assume in_CallAll > 0;
    havoc out_Tmp_192;
    out_Tmp_195 := out_Tmp_192 + out_Tmp_193 * 24;
  ...
  anon20_Else:
    ...
    assume in_CallAll > 0;
    havoc out_Tmp_189;
    out_Tmp_194 := out_Tmp_189 + out_Tmp_191 * 24;
  ...
  L19_dummy:
    call {:si_unique_call 1015} {:si_old_unique_call 1} out_Tmp_189, out_Tmp_191, out_Tmp_192, out_Tmp_193, out_Tmp_194, out_Tmp_195 := KeyboardCallAllPorts#0_loop_L16(out_Tmp_189, out_Tmp_191, out_Tmp_192, out_Tmp_193, out_Tmp_194, out_Tmp_195, in_CallAll);
    return;
...
procedure {:LoopProcedure} KeyboardCallAllPorts#0_loop_L16(in_Tmp_189: int, in_Tmp_191: int, in_Tmp_192: int, in_Tmp_193: int, in_Tmp_194: int, in_Tmp_195: int, in_CallAll: int) returns (out_Tmp_189: int, out_Tmp_191: int, out_Tmp_192: int, out_Tmp_193: int, out_Tmp_194: int, out_Tmp_195: int);
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);



implementation KeyboardCallAllPorts#1_loop_L16(in_Tmp_189: int, in_Tmp_191: int, in_Tmp_192: int, in_Tmp_193: int, in_Tmp_194: int, in_Tmp_195: int, in_CallAll: int) returns (out_Tmp_189: int, out_Tmp_191: int, out_Tmp_192: int, out_Tmp_193: int, out_Tmp_194: int, out_Tmp_195: int)
{
  ...
  L19_dummy:
    call {:si_unique_call 1016} {:si_old_unique_call 1} out_Tmp_189, out_Tmp_191, out_Tmp_192, out_Tmp_193, out_Tmp_194, out_Tmp_195 := KeyboardCallAllPorts#1_loop_L16(out_Tmp_189, out_Tmp_191, out_Tmp_192, out_Tmp_193, out_Tmp_194, out_Tmp_195, in_CallAll);
    return;
...
procedure {:LoopProcedure} KeyboardCallAllPorts#1_loop_L16(in_Tmp_189: int, in_Tmp_191: int, in_Tmp_192: int, in_Tmp_193: int, in_Tmp_194: int, in_Tmp_195: int, in_CallAll: int) returns (out_Tmp_189: int, out_Tmp_191: int, out_Tmp_192: int, out_Tmp_193: int, out_Tmp_194: int, out_Tmp_195: int);
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);
