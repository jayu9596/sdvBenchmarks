...
procedure {:origName "sdv_IoSetCompletionRoutine"} {:osmodel} sdv_IoSetCompletionRoutine(actual_pirp_4: int, actual_CompletionRoutine: int, actual_Context_4: int, actual_InvokeOnSuccess: int, actual_InvokeOnError: int, actual_InvokeOnCancel: int);
...
implementation {:origName "sdv_IoSetCompletionRoutine"} {:osmodel} sdv_IoSetCompletionRoutine(actual_pirp_4: int, actual_CompletionRoutine: int, actual_Context_4: int, actual_InvokeOnSuccess: int, actual_InvokeOnError: int, actual_InvokeOnCancel: int)
{
...
implementation {:origName "main"} {:osmodel} main() returns (Tmp_107: int, dup_assertVar: bool)
{
  ...
  anon0:
    ...
    call {:si_unique_call 83} vslice_dummy_var_115 := __HAVOC_malloc(32);
    call {:si_unique_call 84} vslice_dummy_var_116 := __HAVOC_malloc(72);
    call {:si_unique_call 85} vslice_dummy_var_117 := __HAVOC_malloc(16);
    call {:si_unique_call 86} vslice_dummy_var_118 := __HAVOC_malloc(120);
    call {:si_unique_call 87} vslice_dummy_var_162 := __HAVOC_malloc(12);
    call {:si_unique_call 88} vslice_dummy_var_119 := __HAVOC_malloc(48);
    call {:si_unique_call 89} vslice_dummy_var_163 := __HAVOC_malloc(12);
...
procedure {:origName "SerialMouseReadSerialPortComplete"} SerialMouseReadSerialPortComplete(actual_DeviceObject_8: int, actual_Irp_6: int, actual_Context_6: int) returns (Tmp_169: int);
...
implementation {:origName "SerialMouseReadSerialPortComplete"} SerialMouseReadSerialPortComplete(actual_DeviceObject_8: int, actual_Irp_6: int, actual_Context_6: int) returns (Tmp_169: int)
{
...
implementation {:origName "SerialMouseCreate"} SerialMouseCreate(actual_DeviceObject_12: int, actual_Irp_10: int) returns (Tmp_234: int)
{
  ...
  anon23_Else:
    ...
    call {:si_unique_call 135} status_30 := SerialMouseSendIrpSynchronously#1(vslice_dummy_var_120, Irp_10, 1);
...
procedure {:origName "SerialMouseCompletionRoutine"} SerialMouseCompletionRoutine(actual_DeviceObject_14: int, actual_Irp_12: int, actual_Context_8: int) returns (Tmp_243: int);
...
implementation {:origName "SerialMouseCompletionRoutine"} SerialMouseCompletionRoutine(actual_DeviceObject_14: int, actual_Irp_12: int, actual_Context_8: int) returns (Tmp_243: int)
{
...
implementation {:origName "CSerPowerUp"} CSerPowerUp#0(actual_DeviceExtension: int) returns (Tmp_2: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 148} status := SerialMousepIoSyncIoctl#0(0, 1769508, vslice_dummy_var_121, event, iosb);
    goto anon12_Then, anon12_Else;
  ...
  anon12_Else:
    ...
    call {:si_unique_call 149} status := SerialMousepIoSyncIoctl#0(0, 1769520, vslice_dummy_var_122, event, iosb);
  ...
  anon13_Else:
    ...
    call {:si_unique_call 150} status := SerialMousepIoSyncIoctlEx#0(0, 1769576, vslice_dummy_var_123, event, iosb, 0, 0, bits, 4);
...
implementation {:origName "CSerPowerUp"} CSerPowerUp#1(actual_DeviceExtension: int) returns (Tmp_2: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 157} status := SerialMousepIoSyncIoctl#1(0, 1769508, vslice_dummy_var_124, event, iosb);
    goto anon12_Then, anon12_Else;
  ...
  anon12_Else:
    ...
    call {:si_unique_call 158} status := SerialMousepIoSyncIoctl#1(0, 1769520, vslice_dummy_var_125, event, iosb);
    goto anon13_Then, anon13_Else;
  ...
  anon13_Else:
    ...
    call {:si_unique_call 159} status := SerialMousepIoSyncIoctlEx#1(0, 1769576, vslice_dummy_var_126, event, iosb, 0, 0, bits, 4);
    goto anon14_Then, anon14_Else;
...
implementation {:origName "IofCallDriver"} {:osmodel} IofCallDriver#0(actual_DeviceObject_3: int, actual_Irp_3: int) returns (Tmp_142: int)
{
  ...
  anon55_Then:
    ...
    call {:si_unique_call 175} vslice_dummy_var_40 := sdv_RunIoCompletionRoutines#0(sdv_p_devobj_fdo, Irp_3, vslice_dummy_var_127, completion);
  ...
  anon67_Else:
    ...
    call {:si_unique_call 176} vslice_dummy_var_43 := sdv_RunIoCompletionRoutines#0(sdv_p_devobj_fdo, Irp_3, vslice_dummy_var_128, completion);
  ...
  anon59_Else:
    ...
    call {:si_unique_call 177} vslice_dummy_var_41 := sdv_RunIoCompletionRoutines#0(sdv_p_devobj_fdo, Irp_3, vslice_dummy_var_129, completion);
  ...
  anon63_Else:
    ...
    call {:si_unique_call 178} vslice_dummy_var_42 := sdv_RunIoCompletionRoutines#0(sdv_p_devobj_fdo, Irp_3, vslice_dummy_var_130, completion);
...
implementation {:origName "sdv_RunIoCompletionRoutines"} {:osmodel} sdv_RunIoCompletionRoutines#0(actual_DeviceObject_4: int, actual_Irp_4: int, actual_Context_5: int, actual_Completion: int) returns (Tmp_144: int)
{
  ...
  anon16_Else:
    ...
    call {:si_unique_call 180} Status_1 := SerialMouseCompletionRoutine(DeviceObject_4, Irp_4, Context_5);
    assume {:nonnull} Completion != 0;
    assume Completion > 0;
    goto L11;
  ...
  anon13_Else:
    ...
    call {:si_unique_call 181} Status_1 := SerialMouseReadComplete#0(DeviceObject_4, Irp_4, Context_5);
  ...
  anon14_Else:
    ...
    call {:si_unique_call 182} Status_1 := SerialMouseReadSerialPortComplete(DeviceObject_4, Irp_4, Context_5);
    assume {:nonnull} Completion != 0;
    assume Completion > 0;
    goto L45;
  ...
  anon15_Else:
    ...
    call {:si_unique_call 183} Status_1 := SerialMouseSerialMaskEventComplete#0(DeviceObject_4, Irp_4, Context_5);
...
procedure {:origName "sdv_RunIoCompletionRoutines"} {:osmodel} sdv_RunIoCompletionRoutines#0(actual_DeviceObject_4: int, actual_Irp_4: int, actual_Context_5: int, actual_Completion: int) returns (Tmp_144: int);
  modifies alloc, LockDepth, Mem_T.CompletionRoutine__IO_STACK_LOCATION, yogi_error;
  free ensures {:va_keep} yogi_error == 1 || yogi_error == old(yogi_error);
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);
...
implementation {:origName "SerialMouseReadComplete"} SerialMouseReadComplete#0(actual_DeviceObject_11: int, actual_Irp_7: int, actual_Context_7: int) returns (Tmp_183: int)
{
  ...
  L21:
    ...
    call {:si_unique_call 192} vslice_dummy_var_44 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(DeviceExtension_18), vslice_dummy_var_131);
...
procedure {:origName "SerialMouseReadComplete"} SerialMouseReadComplete#0(actual_DeviceObject_11: int, actual_Irp_7: int, actual_Context_7: int) returns (Tmp_183: int);
  modifies alloc, LockDepth, Mem_T.CompletionRoutine__IO_STACK_LOCATION, yogi_error;
  free ensures {:va_keep} old(LockDepth) != 0 ==> yogi_error == 0;
  free ensures {:va_keep} LockDepth <= old(LockDepth);
  free ensures {:va_keep} old(LockDepth) > 0 ==> yogi_error == 0;
...
implementation {:origName "SerialMouseStartRead"} SerialMouseStartRead#0(actual_DeviceExtension_14: int) returns (Tmp_167: int)
{
  ...
  L13:
    ...
    call {:si_unique_call 194} vslice_dummy_var_48 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(DeviceExtension_14), vslice_dummy_var_132);
    goto anon22_Then, anon22_Else;
  ...
  anon20_Else:
    ...
    call {:si_unique_call 199} vslice_dummy_var_50 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(DeviceExtension_14), vslice_dummy_var_133);
    goto anon23_Then, anon23_Else;
...
implementation {:origName "SerialMouseStartRead"} SerialMouseStartRead#1(actual_DeviceExtension_14: int) returns (Tmp_167: int)
{
  ...
  L11:
    call {:si_unique_call 204} Tmp_168, status_15, irql, stack := SerialMouseStartRead#1_loop_L11(sdv_78, Tmp_168, irp_2, status_15, irql, stack, DeviceExtension_14);
    goto L11_last;
  ...
  L13:
    ...
    call {:si_unique_call 206} vslice_dummy_var_52 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(DeviceExtension_14), vslice_dummy_var_134);
    goto anon22_Then, anon22_Else;
  ...
  anon20_Else:
    ...
    call {:si_unique_call 211} vslice_dummy_var_54 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(DeviceExtension_14), vslice_dummy_var_135);
    goto anon23_Then, anon23_Else;
  ...
  anon20_Then:
    ...
    call {:si_unique_call 216} status_15 := sdv_IoCallDriver#0(vslice_dummy_var_136, irp_2);
    goto anon24_Then, anon24_Else;
...
implementation {:origName "SerialMouseSerialMaskEventComplete"} SerialMouseSerialMaskEventComplete#0(actual_DeviceObject: int, actual_Irp: int, actual_Context: int) returns (Tmp_35: int)
{
  ...
  L12:
    ...
    call {:si_unique_call 218} vslice_dummy_var_55 := sdv_IoReleaseRemoveLock(RemoveLock__DEVICE_EXTENSION(deviceExtension), vslice_dummy_var_137);
    goto anon20_Then, anon20_Else;
...
implementation {:origName "IoQueueWorkItem"} {:osmodel} IoQueueWorkItem#0(actual_IoWorkItem_1: int, actual_WorkerRoutine: int, actual_QueueType: int, actual_Context_2: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 223} sdv_RunIoQueueWorkItems#0(0, WorkerRoutine, QueueType, Context_2);
    goto anon3_Then, anon3_Else;
...
implementation {:origName "sdv_RunIoQueueWorkItems"} {:osmodel} sdv_RunIoQueueWorkItems#0(actual_IoWorkItem_2: int, actual_WorkerRoutine_1: int, actual_QueueType_1: int, actual_Context_3: int)
{
  ...
  anon9_Else:
    ...
    call {:si_unique_call 225} SerialMouseSerialMaskEventWorker#0(sdv_p_devobj_fdo, Context_3);
    goto anon11_Then, anon11_Else;
  ...
  anon10_Else:
    ...
    call {:si_unique_call 226} StartDeviceWorker#0(sdv_p_devobj_fdo, Context_3);
    goto anon12_Then, anon12_Else;
...
implementation {:origName "SerialMouseSerialMaskEventWorker"} SerialMouseSerialMaskEventWorker#0(actual_DeviceObject_1: int, actual_Context_1: int)
{
  ...
  anon23_Else:
    ...
    call {:si_unique_call 233} vslice_dummy_var_62 := SerialMousepIoSyncIoctlEx#0(0, 1769576, vslice_dummy_var_138, event_1, iosb_1, 0, 0, bits_1, 4);
    goto anon25_Then, anon25_Else;
  ...
  anon21_Then:
    ...
    call {:si_unique_call 237} vslice_dummy_var_60 := SerialMousepIoSyncIoctl#0(1, 3604999, vslice_dummy_var_139, event_1, iosb_1);
    goto anon27_Then, anon27_Else;
...
implementation {:origName "SerialMouseSendWaitMaskIrp"} SerialMouseSendWaitMaskIrp#1(actual_DeviceExtension_5: int) returns (Tmp_31: int)
{
  ...
  anon5_Else:
    ...
    call {:si_unique_call 248} Tmp_31 := sdv_IoCallDriver#0(vslice_dummy_var_140, irp);
    goto anon6_Then, anon6_Else;
...
implementation {:origName "StartDeviceWorker"} StartDeviceWorker#0(actual_DeviceObject_15: int, actual_Context_9: int)
{
  ...
  anon18_Else:
    ...
    call {:si_unique_call 252} irp_6 := IoAllocateIrp(vslice_dummy_var_141, 0);
    goto anon19_Then, anon19_Else;
  ...
  anon20_Else:
    ...
    call {:si_unique_call 255} vslice_dummy_var_64 := SerialMousepIoSyncIoctl#0(1, 3604999, vslice_dummy_var_142, event_16, iosb_15);
    goto anon24_Then, anon24_Else;
...
procedure {:origName "StartDeviceWorker"} StartDeviceWorker#0(actual_DeviceObject_15: int, actual_Context_9: int);
  modifies alloc, Mem_T.CompletionRoutine__IO_STACK_LOCATION, LockDepth, yogi_error;
  free ensures {:va_keep} yogi_error == 1 || yogi_error == old(yogi_error);
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);
...
implementation {:origName "SerialMouseInitializeDevice"} SerialMouseInitializeDevice#0(actual_DeviceExtension_30: int) returns (Tmp_227: int)
{
  ...
  L14:
    call {:si_unique_call 277} i_2, Tmp_228 := SerialMouseInitializeDevice#0_loop_L14(i_2, Tmp_228, dumpData);
    goto L14_last;
  ...
  anon19_Then:
    ...
    call {:si_unique_call 280} vslice_dummy_var_68 := SerialMousepIoSyncIoctlEx#0(0, 1769540, vslice_dummy_var_143, event_14, iosb_14, waitMask_1, 4, 0, 0);
    goto anon24_Then, anon24_Else;
  ...
  L57:
    call {:si_unique_call 283} i_2, Tmp_229, Tmp_231, Tmp_232 := SerialMouseInitializeDevice#0_loop_L57(i_2, Tmp_229, Tmp_231, errorLogEntry, Tmp_232, dumpData, dumpCount);
    goto L57_last;
...
implementation {:origName "SerialMouseInitializeDevice"} SerialMouseInitializeDevice#1(actual_DeviceExtension_30: int) returns (Tmp_227: int)
{
  ...
  L14:
    call {:si_unique_call 291} i_2, Tmp_228 := SerialMouseInitializeDevice#1_loop_L14(i_2, Tmp_228, dumpData);
    goto L14_last;
  ...
  anon19_Then:
    ...
    call {:si_unique_call 294} vslice_dummy_var_69 := SerialMousepIoSyncIoctlEx#1(0, 1769540, vslice_dummy_var_144, event_14, iosb_14, waitMask_1, 4, 0, 0);
    goto anon24_Then, anon24_Else;
  ...
  L57:
    call {:si_unique_call 297} i_2, Tmp_229, Tmp_231, Tmp_232 := SerialMouseInitializeDevice#1_loop_L57(i_2, Tmp_229, Tmp_231, errorLogEntry, Tmp_232, dumpData, dumpCount);
    goto L57_last;
...
implementation {:origName "MSerDetect"} MSerDetect#0(actual_DeviceExtension_24: int) returns (Tmp_204: int)
{
  ...
  L53:
    call {:si_unique_call 335} Tmp_205, count_3, Tmp_214, sdv_124 := MSerDetect#0_loop_L53(Tmp_205, count_3, receiveBuffer, Tmp_214, sdv_124, DeviceExtension_24);
    goto L53_last;
  ...
  L62:
    call {:si_unique_call 337} i_1 := MSerDetect#0_loop_L62(i_1, count_3);
    goto L62_last;
  ...
  L65:
    call {:si_unique_call 338} i_1, Tmp_207, Tmp_208 := MSerDetect#0_loop_L65(i_1, count_3, Tmp_207, Tmp_208, receiveBuffer);
    goto L65_last;
...
implementation {:origName "MSerDetect"} MSerDetect#1(actual_DeviceExtension_24: int) returns (Tmp_204: int)
{
  ...
  L53:
    call {:si_unique_call 352} Tmp_205, count_3, Tmp_214, sdv_124 := MSerDetect#1_loop_L53(Tmp_205, count_3, receiveBuffer, Tmp_214, sdv_124, DeviceExtension_24);
    goto L53_last;
  ...
  L62:
    call {:si_unique_call 354} i_1 := MSerDetect#1_loop_L62(i_1, count_3);
    goto L62_last;
  ...
  L65:
    call {:si_unique_call 355} i_1, Tmp_207, Tmp_208 := MSerDetect#1_loop_L65(i_1, count_3, Tmp_207, Tmp_208, receiveBuffer);
    goto L65_last;
...
implementation {:origName "SerialMouseInitializePort"} SerialMouseInitializePort#0(actual_DeviceExtension_20: int) returns (Tmp_191: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 363} status_21 := SerialMousepIoSyncIoctlEx#0(1, 1769484, vslice_dummy_var_145, event_10, iosb_10, 0, 0, SerialBasicSettings__DEVICE_EXTENSION(DeviceExtension_20), 44);
    goto anon14_Then, anon14_Else;
  ...
  anon13_Then:
    ...
    call {:si_unique_call 364} vslice_dummy_var_94 := SerialMousepIoSyncIoctlEx#0(0, 1769504, vslice_dummy_var_146, event_10, iosb_10, 0, 0, Timeouts__SERIAL_BASIC_SETTINGS(SerialBasicSettings__DEVICE_EXTENSION(DeviceExtension_20)), 20);
    goto anon15_Then, anon15_Else;
  ...
  anon15_Else:
    ...
    call {:si_unique_call 366} vslice_dummy_var_95 := SerialMousepIoSyncIoctlEx#0(0, 1769500, vslice_dummy_var_147, event_10, iosb_10, serialTimeouts, 20, 0, 0);
    goto anon16_Then, anon16_Else;
  ...
  anon16_Else:
    ...
    call {:si_unique_call 367} vslice_dummy_var_96 := SerialMousepIoSyncIoctlEx#0(0, 1769568, vslice_dummy_var_148, event_10, iosb_10, 0, 0, HandFlow__SERIAL_BASIC_SETTINGS(SerialBasicSettings__DEVICE_EXTENSION(DeviceExtension_20)), 16);
    goto anon17_Then, anon17_Else;
  ...
  anon17_Else:
    ...
    call {:si_unique_call 368} status_21 := SerialMousepIoSyncIoctlEx#0(0, 1769572, vslice_dummy_var_149, event_10, iosb_10, serialHandFlow, 16, 0, 0);
    goto anon18_Then, anon18_Else;
...
implementation {:origName "SerialMouseInitializePort"} SerialMouseInitializePort#1(actual_DeviceExtension_20: int) returns (Tmp_191: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 374} status_21 := SerialMousepIoSyncIoctlEx#1(1, 1769484, vslice_dummy_var_150, event_10, iosb_10, 0, 0, SerialBasicSettings__DEVICE_EXTENSION(DeviceExtension_20), 44);
    goto anon14_Then, anon14_Else;
  ...
  anon13_Then:
    ...
    call {:si_unique_call 375} vslice_dummy_var_97 := SerialMousepIoSyncIoctlEx#1(0, 1769504, vslice_dummy_var_151, event_10, iosb_10, 0, 0, Timeouts__SERIAL_BASIC_SETTINGS(SerialBasicSettings__DEVICE_EXTENSION(DeviceExtension_20)), 20);
    goto anon15_Then, anon15_Else;
  ...
  anon15_Else:
    ...
    call {:si_unique_call 377} vslice_dummy_var_98 := SerialMousepIoSyncIoctlEx#1(0, 1769500, vslice_dummy_var_152, event_10, iosb_10, serialTimeouts, 20, 0, 0);
    goto anon16_Then, anon16_Else;
  ...
  anon16_Else:
    ...
    call {:si_unique_call 378} vslice_dummy_var_99 := SerialMousepIoSyncIoctlEx#1(0, 1769568, vslice_dummy_var_153, event_10, iosb_10, 0, 0, HandFlow__SERIAL_BASIC_SETTINGS(SerialBasicSettings__DEVICE_EXTENSION(DeviceExtension_20)), 16);
    goto anon17_Then, anon17_Else;
  ...
  anon17_Else:
    ...
    call {:si_unique_call 379} status_21 := SerialMousepIoSyncIoctlEx#1(0, 1769572, vslice_dummy_var_154, event_10, iosb_10, serialHandFlow, 16, 0, 0);
    goto anon18_Then, anon18_Else;
...
implementation {:origName "MSerPowerDown"} MSerPowerDown#0(actual_DeviceExtension_23: int) returns (Tmp_202: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 384} status_23 := SerialMousepIoSyncIoctl#0(0, 1769508, vslice_dummy_var_155, event_12, iosb_12);
    goto anon14_Then, anon14_Else;
  ...
  anon11_Else:
    ...
    call {:si_unique_call 385} status_23 := SerialMousepIoSyncIoctl#0(0, 1769524, vslice_dummy_var_156, event_12, iosb_12);
    goto anon15_Then, anon15_Else;
...
implementation {:origName "MSerPowerDown"} MSerPowerDown#1(actual_DeviceExtension_23: int) returns (Tmp_202: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 391} status_23 := SerialMousepIoSyncIoctl#1(0, 1769508, vslice_dummy_var_157, event_12, iosb_12);
    goto anon14_Then, anon14_Else;
  ...
  anon11_Else:
    ...
    call {:si_unique_call 392} status_23 := SerialMousepIoSyncIoctl#1(0, 1769524, vslice_dummy_var_158, event_12, iosb_12);
    goto anon15_Then, anon15_Else;
...
implementation {:origName "SerialMouseSetBaudRate"} SerialMouseSetBaudRate#0(actual_DeviceExtension_8: int, actual_BaudRate_1: int) returns (Tmp_53: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 399} status_7 := SerialMousepIoSyncIoctlEx#0(0, 1769476, vslice_dummy_var_159, event_3, iosb_3, sbr, 4, 0, 0);
    goto anon3_Then, anon3_Else;
...
implementation {:origName "SerialMouseSetBaudRate"} SerialMouseSetBaudRate#1(actual_DeviceExtension_8: int, actual_BaudRate_1: int) returns (Tmp_53: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 405} status_7 := SerialMousepIoSyncIoctlEx#1(0, 1769476, vslice_dummy_var_160, event_3, iosb_3, sbr, 4, 0, 0);
    goto anon3_Then, anon3_Else;
...
implementation {:origName "SerialMouseFlushReadBuffer"} SerialMouseFlushReadBuffer#0(actual_DeviceExtension_11: int) returns (Tmp_61: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 410} status_10 := SerialMousepIoSyncIoctlEx#0(0, 1769548, vslice_dummy_var_161, event_4, iosb_6, bits_3, 4, 0, 0);
    goto anon3_Then, anon3_Else;
...
implementation {:origName "SerialMouseFlushReadBuffer"} SerialMouseFlushReadBuffer#1(actual_DeviceExtension_11: int) returns (Tmp_61: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 415} status_10 := SerialMousepIoSyncIoctlEx#1(0, 1769548, vslice_dummy_var_162, event_4, iosb_6, bits_3, 4, 0, 0);
    goto anon3_Then, anon3_Else;
...
implementation {:origName "MSerPowerUp"} MSerPowerUp#0(actual_DeviceExtension_25: int) returns (Tmp_215: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 420} status_25 := SerialMousepIoSyncIoctl#0(0, 1769512, vslice_dummy_var_163, event_13, iosb_13);
    goto anon27_Then, anon27_Else;
  ...
  anon21_Else:
    ...
    call {:si_unique_call 421} status_25 := SerialMousepIoSyncIoctl#0(0, 1769524, vslice_dummy_var_164, event_13, iosb_13);
    goto anon28_Then, anon28_Else;
  ...
  anon23_Else:
    ...
    call {:si_unique_call 423} status_25 := SerialMousepIoSyncIoctl#0(0, 1769508, vslice_dummy_var_165, event_13, iosb_13);
    goto anon29_Then, anon29_Else;
  ...
  anon25_Else:
    ...
    call {:si_unique_call 425} status_25 := SerialMousepIoSyncIoctl#0(0, 1769520, vslice_dummy_var_166, event_13, iosb_13);
    goto anon30_Then, anon30_Else;
...
implementation {:origName "MSerPowerUp"} MSerPowerUp#1(actual_DeviceExtension_25: int) returns (Tmp_215: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 431} status_25 := SerialMousepIoSyncIoctl#1(0, 1769512, vslice_dummy_var_167, event_13, iosb_13);
    goto anon27_Then, anon27_Else;
  ...
  anon21_Else:
    ...
    call {:si_unique_call 432} status_25 := SerialMousepIoSyncIoctl#1(0, 1769524, vslice_dummy_var_168, event_13, iosb_13);
    goto anon28_Then, anon28_Else;
  ...
  anon23_Else:
    ...
    call {:si_unique_call 434} status_25 := SerialMousepIoSyncIoctl#1(0, 1769508, vslice_dummy_var_169, event_13, iosb_13);
    goto anon29_Then, anon29_Else;
  ...
  anon25_Else:
    ...
    call {:si_unique_call 436} status_25 := SerialMousepIoSyncIoctl#1(0, 1769520, vslice_dummy_var_170, event_13, iosb_13);
    goto anon30_Then, anon30_Else;
...
implementation {:origName "SerialMouseSetReadTimeouts"} SerialMouseSetReadTimeouts#0(actual_DeviceExtension_21: int, actual_Timeout_2: int) returns (Tmp_193: int)
{
  ...
  L14:
    ...
    call {:si_unique_call 443} status_22 := SerialMousepIoSyncIoctlEx#0(0, 1769500, vslice_dummy_var_171, event_11, iosb_11, serialTimeouts_1, 20, 0, 0);
    goto anon6_Then, anon6_Else;
...
implementation {:origName "SerialMouseSetReadTimeouts"} SerialMouseSetReadTimeouts#1(actual_DeviceExtension_21: int, actual_Timeout_2: int) returns (Tmp_193: int)
{
  ...
  L14:
    ...
    call {:si_unique_call 449} status_22 := SerialMousepIoSyncIoctlEx#1(0, 1769500, vslice_dummy_var_172, event_11, iosb_11, serialTimeouts_1, 20, 0, 0);
    goto anon6_Then, anon6_Else;
...
implementation {:origName "SerialMouseSetLineCtrl"} SerialMouseSetLineCtrl#0(actual_DeviceExtension_13: int, actual_SerialLineControl: int) returns (Tmp_65: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 454} status_12 := SerialMousepIoSyncIoctlEx#0(0, 1769484, vslice_dummy_var_173, event_6, iosb_8, SerialLineControl, 3, 0, 0);
    goto anon3_Then, anon3_Else;
...
implementation {:origName "SerialMouseSetLineCtrl"} SerialMouseSetLineCtrl#1(actual_DeviceExtension_13: int, actual_SerialLineControl: int) returns (Tmp_65: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 459} status_12 := SerialMousepIoSyncIoctlEx#1(0, 1769484, vslice_dummy_var_174, event_6, iosb_8, SerialLineControl, 3, 0, 0);
    goto anon3_Then, anon3_Else;
...
implementation {:origName "SerialMouseReadSerialPort"} SerialMouseReadSerialPort#1(actual_DeviceExtension_17: int, actual_ReadBuffer: int, actual_Buflen: int, actual_ActualBytesRead: int) returns (Tmp_177: int)
{
  ...
  L15:
    call {:si_unique_call 474} status_18, stack_1 := SerialMouseReadSerialPort#1_loop_L15(irp_4, status_18, event_9, stack_1, DeviceExtension_17, ReadBuffer, Buflen, ActualBytesRead);
    goto L15_last;
  ...
  anon16_Else:
    ...
    call {:si_unique_call 479} status_18 := sdv_IoCallDriver#0(vslice_dummy_var_175, irp_4);
    goto anon21_Then, anon21_Else;
...
implementation {:origName "SerialMouseWriteSerialPort"} SerialMouseWriteSerialPort#1(actual_DeviceExtension_16: int, actual_WriteBuffer: int, actual_NumBytes: int, actual_IoStatusBlock_2: int) returns (Tmp_173: int)
{
  ...
  anon7_Else:
    ...
    call {:si_unique_call 545} status_17 := sdv_IoCallDriver#0(vslice_dummy_var_176, irp_3);
    goto anon9_Then, anon9_Else;
  ...
  anon8_Else:
    ...
    call {:si_unique_call 546} vslice_dummy_var_127 := KeWaitForSingleObject(0, 0, 0, 0, 0);
    goto L22;
...
implementation {:origName "CSerSetProtocol"} CSerSetProtocol#0(actual_DeviceExtension_2: int, actual_NewProtocol: int) returns (Tmp_10: int)
{
  ...
  anon0:
    ...
    Tmp_15 := NewProtocol;
    havoc Tmp_11;
    call {:si_unique_call 548} vslice_dummy_var_128 := SerialMouseWriteChar#0(DeviceExtension_2, Tmp_11);
    goto anon5_Then, anon5_Else;
  ...
  anon5_Else:
    ...
    Tmp_14 := NewProtocol;
    havoc Tmp_13;
    call {:si_unique_call 549} vslice_dummy_var_129 := SerialMouseSetLineCtrl#0(DeviceExtension_2, Tmp_13);
    goto anon6_Then, anon6_Else;
...
implementation {:origName "CSerSetProtocol"} CSerSetProtocol#1(actual_DeviceExtension_2: int, actual_NewProtocol: int) returns (Tmp_10: int)
{
  ...
  anon0:
    ...
    Tmp_15 := NewProtocol;
    havoc Tmp_11;
    call {:si_unique_call 551} vslice_dummy_var_130 := SerialMouseWriteChar#1(DeviceExtension_2, Tmp_11);
    goto anon5_Then, anon5_Else;
  ...
  anon5_Else:
    ...
    Tmp_14 := NewProtocol;
    havoc Tmp_13;
    call {:si_unique_call 552} vslice_dummy_var_131 := SerialMouseSetLineCtrl#1(DeviceExtension_2, Tmp_13);
    goto anon6_Then, anon6_Else;
...
implementation {:origName "CSerSetBaudRate"} CSerSetBaudRate#0(actual_DeviceExtension_4: int, actual_BaudRate: int)
{
  ...
  anon0:
    call {:si_unique_call 553} vslice_dummy_var_132 := __HAVOC_malloc(4);
  ...
  anon13_Else:
    Tmp_23 := count_2;
    havoc Tmp_28;
    call {:si_unique_call 557} vslice_dummy_var_134 := SerialMouseWriteString#0(DeviceExtension_4, Tmp_28);
    goto anon14_Then, anon14_Else;
  ...
  anon14_Else:
    ...
    Tmp_22 := count_2;
    havoc Tmp_27;
    call {:si_unique_call 558} vslice_dummy_var_135 := SerialMouseSetBaudRate#0(DeviceExtension_4, Tmp_27);
    goto anon15_Then, anon15_Else;

  anon15_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 559} vslice_dummy_var_133 := SerialMouseWait(DeviceExtension_4, -20000);
    goto L1;
...
implementation {:origName "CSerSetBaudRate"} CSerSetBaudRate#1(actual_DeviceExtension_4: int, actual_BaudRate: int)
{
  ...
  anon0:
    call {:si_unique_call 560} vslice_dummy_var_136 := __HAVOC_malloc(4);
    DeviceExtension_4 := actual_DeviceExtension_4;
    BaudRate := actual_BaudRate;
  ...
  anon13_Else:
    Tmp_23 := count_2;
    havoc Tmp_28;
    call {:si_unique_call 564} vslice_dummy_var_138 := SerialMouseWriteString#1(DeviceExtension_4, Tmp_28);
    goto anon14_Then, anon14_Else;
  ...
  anon14_Else:
    ...
    Tmp_22 := count_2;
    havoc Tmp_27;
    call {:si_unique_call 565} vslice_dummy_var_139 := SerialMouseSetBaudRate#1(DeviceExtension_4, Tmp_27);
    goto anon15_Then, anon15_Else;

  anon15_Else:
    assume {:partition} yogi_error != 1;
    call {:si_unique_call 566} vslice_dummy_var_137 := SerialMouseWait(DeviceExtension_4, -20000);
    goto L1;
...
implementation {:origName "MSerSetProtocol"} MSerSetProtocol#0(actual_DeviceExtension_22: int, actual_NewProtocol_1: int) returns (Tmp_195: int)
{
  ...
  L7:
    ...
    havoc Tmp_197;
    call {:si_unique_call 574} vslice_dummy_var_140 := SerialMouseSetLineCtrl#0(DeviceExtension_22, Tmp_197);
    goto anon6_Then, anon6_Else;
...
implementation {:origName "MSerSetProtocol"} MSerSetProtocol#1(actual_DeviceExtension_22: int, actual_NewProtocol_1: int) returns (Tmp_195: int)
{
  ...
  L7:
    Tmp_199 := NewProtocol_1;
    havoc Tmp_197;
    call {:si_unique_call 576} vslice_dummy_var_141 := SerialMouseSetLineCtrl#1(DeviceExtension_22, Tmp_197);
    goto anon6_Then, anon6_Else;
...
implementation {:origName "SerialMouseSetFifo"} SerialMouseSetFifo#0(actual_DeviceExtension_12: int, actual_Value_2: int) returns (Tmp_63: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 582} status_11 := SerialMousepIoSyncIoctlEx#0(0, 1769628, vslice_dummy_var_177, event_5, iosb_7, fifo, 4, 0, 0);
    goto anon3_Then, anon3_Else;
...
implementation {:origName "SerialMouseSetFifo"} SerialMouseSetFifo#1(actual_DeviceExtension_12: int, actual_Value_2: int) returns (Tmp_63: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 588} status_11 := SerialMousepIoSyncIoctlEx#1(0, 1769628, vslice_dummy_var_178, event_5, iosb_7, fifo, 4, 0, 0);
    goto anon3_Then, anon3_Else;
...
implementation {:origName "SerialMouseStartDetection"} SerialMouseStartDetection#0(actual_DeviceExtension_6: int)
{
  ...
  anon0:
    call {:si_unique_call 589} vslice_dummy_var_142 := __HAVOC_malloc(4);
  ...
  L29:
    ...
    call {:si_unique_call 598} status_5 := SerialMousepIoSyncIoctlEx#0(0, 1769540, vslice_dummy_var_179, event_2, iosb_2, waitMask, 4, 0, 0);
    goto anon34_Then, anon34_Else;
  ...
  anon30_Then:
    ...
    call {:si_unique_call 600} vslice_dummy_var_143 := IoCancelIrp(0);
    assume {:nonnull} DeviceExtension_6 != 0;
    assume DeviceExtension_6 > 0;
    goto L1;
  ...
  anon35_Then:
    ...
    call {:si_unique_call 601} boogieTmp := IoAllocateIrp(vslice_dummy_var_180, 0);
    assume {:nonnull} DeviceExtension_6 != 0;
    assume DeviceExtension_6 > 0;
  ...
  anon28_Then:
    ...
    call {:si_unique_call 602} status_5 := SerialMousepIoSyncIoctlEx#0(0, 1769576, vslice_dummy_var_181, event_2, iosb_2, 0, 0, bits_2, 4);
    goto anon37_Then, anon37_Else;
...
implementation {:origName "SerialMouseStartDetection"} SerialMouseStartDetection#1(actual_DeviceExtension_6: int)
{
  ...
  anon0:
    call {:si_unique_call 604} vslice_dummy_var_144 := __HAVOC_malloc(4);
  ...
  L29:
    ...
    call {:si_unique_call 613} status_5 := SerialMousepIoSyncIoctlEx#1(0, 1769540, vslice_dummy_var_182, event_2, iosb_2, waitMask, 4, 0, 0);
    goto anon34_Then, anon34_Else;
  ...
  anon30_Then:
    assume {:partition} 0 > status_5;
    call {:si_unique_call 615} vslice_dummy_var_145 := IoCancelIrp(0);
    assume {:nonnull} DeviceExtension_6 != 0;
    assume DeviceExtension_6 > 0;
    goto L1;
  ...
  anon35_Then:
    ...
    call {:si_unique_call 616} boogieTmp := IoAllocateIrp(vslice_dummy_var_183, 0);
    assume {:nonnull} DeviceExtension_6 != 0;
    assume DeviceExtension_6 > 0;
    goto anon31_Then, anon31_Else;
  ...
  anon28_Then:
    ...
    call {:si_unique_call 617} status_5 := SerialMousepIoSyncIoctlEx#1(0, 1769576, vslice_dummy_var_184, event_2, iosb_2, 0, 0, bits_2, 4);
    goto anon37_Then, anon37_Else;
...
implementation {:origName "SerialMouseSpinUpRead"} SerialMouseSpinUpRead#0(actual_DeviceExtension_27: int) returns (Tmp_221: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 620} vslice_dummy_var_146 := sdv_IoAcquireRemoveLock(0, 0);
...
implementation {:origName "SerialMouseSpinUpRead"} SerialMouseSpinUpRead#1(actual_DeviceExtension_27: int) returns (Tmp_221: int)
{
  ...
  anon0:
    ...
    call {:si_unique_call 623} vslice_dummy_var_147 := sdv_IoAcquireRemoveLock(0, 0);
    assume {:nonnull} DeviceExtension_27 != 0;
    assume DeviceExtension_27 > 0;
...
implementation {:origName "SerialMouseClosePort"} SerialMouseClosePort#0(actual_DeviceExtension_29: int, actual_Irp_9: int)
{
  ...
  anon0:
    call {:si_unique_call 625} vslice_dummy_var_148 := __HAVOC_malloc(4);
  ...
  anon7_Else:
    ...
    call {:si_unique_call 630} vslice_dummy_var_149 := SerialMouseSendIrpSynchronously#0(vslice_dummy_var_185, Irp_9, 0);
    goto anon8_Then, anon8_Else;
  ...
  anon8_Else:
    ...
    call {:si_unique_call 633} vslice_dummy_var_150 := SerialMouseSendIrpSynchronously#0(vslice_dummy_var_186, Irp_9, 0);
    goto anon9_Then, anon9_Else;
...
implementation {:origName "SerialMouseClosePort"} SerialMouseClosePort#1(actual_DeviceExtension_29: int, actual_Irp_9: int)
{
  ...
  anon0:
    call {:si_unique_call 634} vslice_dummy_var_151 := __HAVOC_malloc(4);
    DeviceExtension_29 := actual_DeviceExtension_29;
    Irp_9 := actual_Irp_9;
  ...
  anon7_Else:
    ...
    call {:si_unique_call 639} vslice_dummy_var_152 := SerialMouseSendIrpSynchronously#1(vslice_dummy_var_187, Irp_9, 0);
    goto anon8_Then, anon8_Else;
  ...
  anon8_Else:
    ...
    call {:si_unique_call 642} vslice_dummy_var_153 := SerialMouseSendIrpSynchronously#1(vslice_dummy_var_188, Irp_9, 0);
    goto anon9_Then, anon9_Else;
...
implementation {:origName "SerialMouseRestorePort"} SerialMouseRestorePort#0(actual_DeviceExtension_15: int)
{
  ...
  anon0:
    call {:si_unique_call 643} vslice_dummy_var_154 := __HAVOC_malloc(4);
    ...
    call {:si_unique_call 647} status_16 := SerialMousepIoSyncIoctlEx#0(1, 1769488, vslice_dummy_var_189, event_7, iosb_9, SerialBasicSettings__DEVICE_EXTENSION(DeviceExtension_15), 44, 0, 0);
    goto anon10_Then, anon10_Else;
  ...
  anon9_Else:
    ...
    call {:si_unique_call 648} vslice_dummy_var_155 := SerialMousepIoSyncIoctlEx#0(0, 1769500, vslice_dummy_var_190, event_7, iosb_9, Timeouts__SERIAL_BASIC_SETTINGS(SerialBasicSettings__DEVICE_EXTENSION(DeviceExtension_15)), 20, 0, 0);
    goto anon11_Then, anon11_Else;
  ...
  anon11_Else:
    ...
    call {:si_unique_call 649} vslice_dummy_var_156 := SerialMousepIoSyncIoctlEx#0(0, 1769572, vslice_dummy_var_191, event_7, iosb_9, HandFlow__SERIAL_BASIC_SETTINGS(SerialBasicSettings__DEVICE_EXTENSION(DeviceExtension_15)), 16, 0, 0);
    goto anon12_Then, anon12_Else;
...
implementation {:origName "SerialMouseRestorePort"} SerialMouseRestorePort#1(actual_DeviceExtension_15: int)
{
  ...
  anon0:
    call {:si_unique_call 650} vslice_dummy_var_157 := __HAVOC_malloc(4);
    ...
    call {:si_unique_call 654} status_16 := SerialMousepIoSyncIoctlEx#1(1, 1769488, vslice_dummy_var_192, event_7, iosb_9, SerialBasicSettings__DEVICE_EXTENSION(DeviceExtension_15), 44, 0, 0);
    goto anon10_Then, anon10_Else;
  ...
  anon9_Else:
    ...
    call {:si_unique_call 655} vslice_dummy_var_158 := SerialMousepIoSyncIoctlEx#1(0, 1769500, vslice_dummy_var_193, event_7, iosb_9, Timeouts__SERIAL_BASIC_SETTINGS(SerialBasicSettings__DEVICE_EXTENSION(DeviceExtension_15)), 20, 0, 0);
    goto anon11_Then, anon11_Else;
  ...
  anon11_Else:
    ...
    call {:si_unique_call 656} vslice_dummy_var_159 := SerialMousepIoSyncIoctlEx#1(0, 1769572, vslice_dummy_var_194, event_7, iosb_9, HandFlow__SERIAL_BASIC_SETTINGS(SerialBasicSettings__DEVICE_EXTENSION(DeviceExtension_15)), 16, 0, 0);
    goto anon12_Then, anon12_Else;
...
implementation {:origName "SerialMouseSendIrpSynchronously"} SerialMouseSendIrpSynchronously#1(actual_DeviceObject_13: int, actual_Irp_11: int, actual_CopyToNext: int) returns (Tmp_239: int)
{
  ...
  anon8_Else:
    ...
    call {:si_unique_call 668} vslice_dummy_var_161 := KeWaitForSingleObject(0, 0, 0, 0, 0);
...
implementation SerialMouseStartRead#1_loop_L11(in_sdv_78: int, in_Tmp_168: int, in_irp_2: int, in_status_15: int, in_irql: int, in_stack: int, in_DeviceExtension_14: int) returns (out_Tmp_168: int, out_status_15: int, out_irql: int, out_stack: int)
{
  ...
  anon20_Then:
    ...
    call {:si_unique_call 673} out_status_15 := sdv_IoCallDriver#0(vslice_dummy_var_195, in_irp_2);
    goto anon24_Else;
  ...
  anon21_Else_dummy:
    call {:si_unique_call 676} {:si_old_unique_call 1} out_Tmp_168, out_status_15, out_irql, out_stack := SerialMouseStartRead#1_loop_L11(in_sdv_78, out_Tmp_168, in_irp_2, out_status_15, out_irql, out_stack, in_DeviceExtension_14);
    return;
}



procedure {:LoopProcedure} SerialMouseStartRead#1_loop_L11(in_sdv_78: int, in_Tmp_168: int, in_irp_2: int, in_status_15: int, in_irql: int, in_stack: int, in_DeviceExtension_14: int) returns (out_Tmp_168: int, out_status_15: int, out_irql: int, out_stack: int);
  modifies alloc, Mem_T.CompletionRoutine__IO_STACK_LOCATION, LockDepth, yogi_error;
  free ensures {:va_keep} old(LockDepth) != 0 ==> yogi_error == 0;
  free ensures {:va_keep} old(LockDepth) == 0 ==> yogi_error == 0;
  free ensures {:va_keep} yogi_error == 0;
...
implementation SerialMouseInitializeDevice#0_loop_L57(in_i_2: int, in_Tmp_229: int, in_Tmp_231: int, in_errorLogEntry: int, in_Tmp_232: int, in_dumpData: int, in_dumpCount: int) returns (out_i_2: int, out_Tmp_229: int, out_Tmp_231: int, out_Tmp_232: int)
{
  ...
  anon23_Else_dummy:
    call {:si_unique_call 677} {:si_old_unique_call 1} out_i_2, out_Tmp_229, out_Tmp_231, out_Tmp_232 := SerialMouseInitializeDevice#0_loop_L57(out_i_2, out_Tmp_229, out_Tmp_231, in_errorLogEntry, out_Tmp_232, in_dumpData, in_dumpCount);
    return;
}



procedure {:LoopProcedure} SerialMouseInitializeDevice#0_loop_L57(in_i_2: int, in_Tmp_229: int, in_Tmp_231: int, in_errorLogEntry: int, in_Tmp_232: int, in_dumpData: int, in_dumpCount: int) returns (out_i_2: int, out_Tmp_229: int, out_Tmp_231: int, out_Tmp_232: int);
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);



implementation {:SIextraRecBound 4} SerialMouseInitializeDevice#0_loop_L14(in_i_2: int, in_Tmp_228: int, in_dumpData: int) returns (out_i_2: int, out_Tmp_228: int)
{
  ...
  anon19_Else_dummy:
    call {:si_unique_call 678} {:si_old_unique_call 1} out_i_2, out_Tmp_228 := SerialMouseInitializeDevice#0_loop_L14(out_i_2, out_Tmp_228, in_dumpData);
    return;
}



procedure {:LoopProcedure} SerialMouseInitializeDevice#0_loop_L14(in_i_2: int, in_Tmp_228: int, in_dumpData: int) returns (out_i_2: int, out_Tmp_228: int);
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);



implementation SerialMouseInitializeDevice#1_loop_L57(in_i_2: int, in_Tmp_229: int, in_Tmp_231: int, in_errorLogEntry: int, in_Tmp_232: int, in_dumpData: int, in_dumpCount: int) returns (out_i_2: int, out_Tmp_229: int, out_Tmp_231: int, out_Tmp_232: int)
{
  ...
  anon23_Else_dummy:
    call {:si_unique_call 679} {:si_old_unique_call 1} out_i_2, out_Tmp_229, out_Tmp_231, out_Tmp_232 := SerialMouseInitializeDevice#1_loop_L57(out_i_2, out_Tmp_229, out_Tmp_231, in_errorLogEntry, out_Tmp_232, in_dumpData, in_dumpCount);
    return;
}



procedure {:LoopProcedure} SerialMouseInitializeDevice#1_loop_L57(in_i_2: int, in_Tmp_229: int, in_Tmp_231: int, in_errorLogEntry: int, in_Tmp_232: int, in_dumpData: int, in_dumpCount: int) returns (out_i_2: int, out_Tmp_229: int, out_Tmp_231: int, out_Tmp_232: int);
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);



implementation {:SIextraRecBound 4} SerialMouseInitializeDevice#1_loop_L14(in_i_2: int, in_Tmp_228: int, in_dumpData: int) returns (out_i_2: int, out_Tmp_228: int)
{
  ...
  anon19_Else_dummy:
    call {:si_unique_call 680} {:si_old_unique_call 1} out_i_2, out_Tmp_228 := SerialMouseInitializeDevice#1_loop_L14(out_i_2, out_Tmp_228, in_dumpData);
    return;
}



procedure {:LoopProcedure} SerialMouseInitializeDevice#1_loop_L14(in_i_2: int, in_Tmp_228: int, in_dumpData: int) returns (out_i_2: int, out_Tmp_228: int);
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);



implementation MSerDetect#0_loop_L53(in_Tmp_205: int, in_count_3: int, in_receiveBuffer: int, in_Tmp_214: int, in_sdv_124: int, in_DeviceExtension_24: int) returns (out_Tmp_205: int, out_count_3: int, out_Tmp_214: int, out_sdv_124: int)
{
...
procedure {:LoopProcedure} MSerDetect#0_loop_L53(in_Tmp_205: int, in_count_3: int, in_receiveBuffer: int, in_Tmp_214: int, in_sdv_124: int, in_DeviceExtension_24: int) returns (out_Tmp_205: int, out_count_3: int, out_Tmp_214: int, out_sdv_124: int);
  modifies alloc, Mem_T.CompletionRoutine__IO_STACK_LOCATION;
...
implementation MSerDetect#0_loop_L65(in_i_1: int, in_count_3: int, in_Tmp_207: int, in_Tmp_208: int, in_receiveBuffer: int) returns (out_i_1: int, out_Tmp_207: int, out_Tmp_208: int)
{
...
procedure {:LoopProcedure} MSerDetect#0_loop_L65(in_i_1: int, in_count_3: int, in_Tmp_207: int, in_Tmp_208: int, in_receiveBuffer: int) returns (out_i_1: int, out_Tmp_207: int, out_Tmp_208: int);
...
implementation MSerDetect#1_loop_L53(in_Tmp_205: int, in_count_3: int, in_receiveBuffer: int, in_Tmp_214: int, in_sdv_124: int, in_DeviceExtension_24: int) returns (out_Tmp_205: int, out_count_3: int, out_Tmp_214: int, out_sdv_124: int)
{
  ...
  anon49_Else_dummy:
    call {:si_unique_call 683} {:si_old_unique_call 1} out_Tmp_205, out_count_3, out_Tmp_214, out_sdv_124 := MSerDetect#1_loop_L53(out_Tmp_205, out_count_3, in_receiveBuffer, out_Tmp_214, out_sdv_124, in_DeviceExtension_24);
    return;
}



procedure {:LoopProcedure} MSerDetect#1_loop_L53(in_Tmp_205: int, in_count_3: int, in_receiveBuffer: int, in_Tmp_214: int, in_sdv_124: int, in_DeviceExtension_24: int) returns (out_Tmp_205: int, out_count_3: int, out_Tmp_214: int, out_sdv_124: int);
  modifies alloc, Mem_T.CompletionRoutine__IO_STACK_LOCATION, LockDepth, yogi_error;
  free ensures {:va_keep} old(LockDepth) != 0 ==> yogi_error == 0;
  free ensures {:va_keep} old(LockDepth) == 0 ==> yogi_error == 0;
  free ensures {:va_keep} yogi_error == 0;
...
implementation MSerDetect#1_loop_L65(in_i_1: int, in_count_3: int, in_Tmp_207: int, in_Tmp_208: int, in_receiveBuffer: int) returns (out_i_1: int, out_Tmp_207: int, out_Tmp_208: int)
{
...
procedure {:LoopProcedure} MSerDetect#1_loop_L65(in_i_1: int, in_count_3: int, in_Tmp_207: int, in_Tmp_208: int, in_receiveBuffer: int) returns (out_i_1: int, out_Tmp_207: int, out_Tmp_208: int);
  free ensures {:va_keep} out_Tmp_207 == in_i_1 || out_Tmp_207 == in_Tmp_207;
  free ensures {:va_keep} out_Tmp_208 == in_i_1 || out_Tmp_208 == in_Tmp_208;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);
...
implementation SerialMouseReadSerialPort#1_loop_L15(in_irp_4: int, in_status_18: int, in_event_9: int, in_stack_1: int, in_DeviceExtension_17: int, in_ReadBuffer: int, in_Buflen: int, in_ActualBytesRead: int) returns (out_status_18: int, out_stack_1: int)
{
  ...
  anon16_Else:
    ...
    call {:si_unique_call 688} out_status_18 := sdv_IoCallDriver#0(vslice_dummy_var_196, in_irp_4);
    goto anon21_Else;
  ...
  anon20_Else_dummy:
    call {:si_unique_call 690} {:si_old_unique_call 1} out_status_18, out_stack_1 := SerialMouseReadSerialPort#1_loop_L15(in_irp_4, out_status_18, in_event_9, out_stack_1, in_DeviceExtension_17, in_ReadBuffer, in_Buflen, in_ActualBytesRead);
    return;
...
procedure {:LoopProcedure} SerialMouseReadSerialPort#1_loop_L15(in_irp_4: int, in_status_18: int, in_event_9: int, in_stack_1: int, in_DeviceExtension_17: int, in_ReadBuffer: int, in_Buflen: int, in_ActualBytesRead: int) returns (out_status_18: int, out_stack_1: int);
  modifies alloc, Mem_T.CompletionRoutine__IO_STACK_LOCATION, LockDepth, yogi_error;
  free ensures {:va_keep} old(LockDepth) != 0 ==> yogi_error == 0;
  free ensures {:va_keep} old(LockDepth) == 0 ==> yogi_error == 0;
  free ensures {:va_keep} yogi_error == 0;
...
implementation CSerDetect#0_loop_L20(in_Tmp_18: int, in_count_1: int, in_Tmp_20: int, in_sdv_12: int, in_status_1: int, in_DeviceExtension_3: int, in_vslice_dummy_var_101: int, in_vslice_dummy_var_102: int, in_vslice_dummy_var_103: int, in_vslice_dummy_var_104: int, in_vslice_dummy_var_110: int) returns (out_Tmp_18: int, out_count_1: int, out_Tmp_20: int, out_sdv_12: int, out_vslice_dummy_var_101: int, out_vslice_dummy_var_102: int, out_vslice_dummy_var_103: int, out_vslice_dummy_var_104: int, out_vslice_dummy_var_110: int)
{
  ...
  L45_dummy:
    call {:si_unique_call 698} {:si_old_unique_call 1} out_Tmp_18, out_count_1, out_Tmp_20, out_sdv_12, out_vslice_dummy_var_101, out_vslice_dummy_var_102, out_vslice_dummy_var_103, out_vslice_dummy_var_104, out_vslice_dummy_var_110 := CSerDetect#0_loop_L20(out_Tmp_18, out_count_1, out_Tmp_20, out_sdv_12, in_status_1, in_DeviceExtension_3, out_vslice_dummy_var_101, out_vslice_dummy_var_102, out_vslice_dummy_var_103, out_vslice_dummy_var_104, out_vslice_dummy_var_110);
    return;
...
procedure {:LoopProcedure} CSerDetect#0_loop_L20(in_Tmp_18: int, in_count_1: int, in_Tmp_20: int, in_sdv_12: int, in_status_1: int, in_DeviceExtension_3: int, in_vslice_dummy_var_101: int, in_vslice_dummy_var_102: int, in_vslice_dummy_var_103: int, in_vslice_dummy_var_104: int, in_vslice_dummy_var_110: int) returns (out_Tmp_18: int, out_count_1: int, out_Tmp_20: int, out_sdv_12: int, out_vslice_dummy_var_101: int, out_vslice_dummy_var_102: int, out_vslice_dummy_var_103: int, out_vslice_dummy_var_104: int, out_vslice_dummy_var_110: int);
  modifies alloc, Mem_T.CompletionRoutine__IO_STACK_LOCATION;
  free ensures {:va_keep} old(yogi_error) == 0;
  free ensures {:va_keep} alloc >= old(alloc);
...
implementation CSerDetect#1_loop_L20(in_Tmp_18: int, in_count_1: int, in_Tmp_20: int, in_sdv_12: int, in_status_1: int, in_DeviceExtension_3: int, in_vslice_dummy_var_112: int, in_vslice_dummy_var_113: int, in_vslice_dummy_var_114: int, in_vslice_dummy_var_115: int, in_vslice_dummy_var_121: int) returns (out_Tmp_18: int, out_count_1: int, out_Tmp_20: int, out_sdv_12: int, out_vslice_dummy_var_112: int, out_vslice_dummy_var_113: int, out_vslice_dummy_var_114: int, out_vslice_dummy_var_115: int, out_vslice_dummy_var_121: int)
{
  ...
  L45_dummy:
    call {:si_unique_call 706} {:si_old_unique_call 1} out_Tmp_18, out_count_1, out_Tmp_20, out_sdv_12, out_vslice_dummy_var_112, out_vslice_dummy_var_113, out_vslice_dummy_var_114, out_vslice_dummy_var_115, out_vslice_dummy_var_121 := CSerDetect#1_loop_L20(out_Tmp_18, out_count_1, out_Tmp_20, out_sdv_12, in_status_1, in_DeviceExtension_3, out_vslice_dummy_var_112, out_vslice_dummy_var_113, out_vslice_dummy_var_114, out_vslice_dummy_var_115, out_vslice_dummy_var_121);
    return;
...
procedure {:LoopProcedure} CSerDetect#1_loop_L20(in_Tmp_18: int, in_count_1: int, in_Tmp_20: int, in_sdv_12: int, in_status_1: int, in_DeviceExtension_3: int, in_vslice_dummy_var_112: int, in_vslice_dummy_var_113: int, in_vslice_dummy_var_114: int, in_vslice_dummy_var_115: int, in_vslice_dummy_var_121: int) returns (out_Tmp_18: int, out_count_1: int, out_Tmp_20: int, out_sdv_12: int, out_vslice_dummy_var_112: int, out_vslice_dummy_var_113: int, out_vslice_dummy_var_114: int, out_vslice_dummy_var_115: int, out_vslice_dummy_var_121: int);
  modifies alloc, Mem_T.CompletionRoutine__IO_STACK_LOCATION, LockDepth, yogi_error;
  free ensures {:va_keep} old(LockDepth) != 0 ==> yogi_error == 0;
  free ensures {:va_keep} old(LockDepth) == 0 ==> yogi_error == 0;
  free ensures {:va_keep} yogi_error == 0;
